...
Gauge32, TimeTicks, NotificationType, Counter64, Bits, Unsigned32, iso, enterprises, ObjectIdentity, ModuleIdentity, Counter32, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "NotificationType", "Counter64", "Bits", "Unsigned32", "iso", "enterprises", "ObjectIdentity", "ModuleIdentity", "Counter32", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumidity=npRelHumidity, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, npRelayN=npRelayN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapR=npCurLoopTrapR, npCurLoop=npCurLoop, npSmokeTrapStatus=npSmokeTrapStatus, npIoLevelOut=npIoLevelOut, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTable=npRelHumTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmTrap=npGsmTrap, npCurLoopTrapPower=npCurLoopTrapPower, npRelayEntry=npRelayEntry, npRelHumEntry=npRelHumEntry, npCurLoopR=npCurLoopR, npIoTrapPrefix=npIoTrapPrefix, npThermoHigh=npThermoHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapV=npCurLoopTrapV, npIoEntry=npIoEntry, npRelHumTrapData=npRelHumTrapData, npIoLineN=npIoLineN, npRelHumTempValue=npRelHumTempValue, npSmokeTable=npSmokeTable, npSoftReboot=npSoftReboot, npCurLoopTrap=npCurLoopTrap, npResetStack=npResetStack, npRelayStartReset=npRelayStartReset, FixedPoint1000=FixedPoint1000, npThermoTrap=npThermoTrap, npSmokeEntry=npSmokeEntry, npRelayState=npRelayState, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npTrapInfo=npTrapInfo, npRelHumValue=npRelHumValue, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoStatus=npThermoStatus, npSmokeTraps=npSmokeTraps, npCurLoopPower=npCurLoopPower, npCurLoopTrapN=npCurLoopTrapN, npIr=npIr, npRelHumTrapTempFail=npRelHumTrapTempFail, npForcedReboot=npForcedReboot, npRelHumTrapFail=npRelHumTrapFail, npRelay=npRelay, npThermoEntry=npThermoEntry, npReboot=npReboot, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrap=npRelHumTrap, npGsmFailed=npGsmFailed, npThermo=npThermo, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTable=npThermoTable, npThermoTraps=npThermoTraps, npRelHumTrapTemp=npRelHumTrapTemp, npIo=npIo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIrStatus=npIrStatus, npIrPlayCmd=npIrPlayCmd, npThermoTrapLow=npThermoTrapLow, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapMemo=npThermoTrapMemo, npSmokeTrap=npSmokeTrap, npCurLoopI=npCurLoopI, npRelHumStatus=npRelHumStatus, npThermoTrapValue=npThermoTrapValue, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapPrefix=npThermoTrapPrefix, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrap=npIoTrap, npIrReset=npIrReset, npCurLoopV=npCurLoopV, npRelHumTrapDataN=npRelHumTrapDataN, npSmoke=npSmoke, npSmokeReset=npSmokeReset, npIoPulseCounter=npIoPulseCounter, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmRegistration=npGsmRegistration, npCurLoopTable=npCurLoopTable, npRelHumN=npRelHumN, npIoTable=npIoTable, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapSensorN=npThermoTrapSensorN, lightcom=lightcom, npTrapEmailTo=npTrapEmailTo, npIoMemo=npIoMemo, npIoTrapMemo=npIoTrapMemo, npThermoLow=npThermoLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeStatus=npSmokeStatus, npCurLoopTrapI=npCurLoopTrapI, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoValue=npThermoValue, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrapHigh=npThermoTrapHigh, npRelHumMemo=npRelHumMemo, npIoTrapLineN=npIoTrapLineN, npRelayTable=npRelayTable, npCurLoopStatus=npCurLoopStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayMode=npRelayMode, npThermoSensorN=npThermoSensorN, npGsm=npGsm, npGsmTraps=npGsmTraps, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopN=npCurLoopN, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokePower=npSmokePower, npCurLoopTraps=npCurLoopTraps, npRelayMemo=npRelayMemo, npGsmInfo=npGsmInfo, npSmokeMemo=npSmokeMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIrCtrl=npIrCtrl, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoLevelIn=npIoLevelIn, npGsmStrength=npGsmStrength, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoMemo=npThermoMemo, npIoTraps=npIoTraps)
