...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, iso, Integer32, IpAddress, Counter32, TimeTicks, Bits, ModuleIdentity, ObjectIdentity, Gauge32, Unsigned32, MibIdentifier, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "iso", "Integer32", "IpAddress", "Counter32", "TimeTicks", "Bits", "ModuleIdentity", "ObjectIdentity", "Gauge32", "Unsigned32", "MibIdentifier", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayEntry=npRelayEntry, npRelHumTable=npRelHumTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, FixedPoint1000=FixedPoint1000, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapMemo=npThermoTrapMemo, npSmoke=npSmoke, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsm=npGsm, npGsmTrap=npGsmTrap, npGsmFailed=npGsmFailed, npRelayTable=npRelayTable, npSmokeSensorN=npSmokeSensorN, npIoLineN=npIoLineN, npThermoTrapPrefix=npThermoTrapPrefix, npRelayN=npRelayN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTraps=npCurLoopTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeEntry=npSmokeEntry, npRelHumValue=npRelHumValue, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoMemo=npThermoMemo, npRelayMemo=npRelayMemo, npThermoHigh=npThermoHigh, npCurLoopPower=npCurLoopPower, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTraps=npThermoTraps, npRelHumStatus=npRelHumStatus, npIoTable=npIoTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoStatus=npThermoStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIr=npIr, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataN=npRelHumTrapDataN, npThermoLow=npThermoLow, npCurLoopR=npCurLoopR, npSoftReboot=npSoftReboot, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrap=npCurLoopTrap, npThermoTrap=npThermoTrap, npIoTrap=npIoTrap, npCurLoopV=npCurLoopV, npRelHumN=npRelHumN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoValue=npThermoValue, npCurLoopI=npCurLoopI, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrReset=npIrReset, npForcedReboot=npForcedReboot, npThermoValuePrecise=npThermoValuePrecise, npIrPlayCmd=npIrPlayCmd, npSmokeReset=npSmokeReset, npIoMemo=npIoMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTable=npSmokeTable, npRelayStartReset=npRelayStartReset, npGsmInfo=npGsmInfo, npRelHumMemo=npRelHumMemo, npResetStack=npResetStack, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeMemo=npSmokeMemo, npIoTrapMemo=npIoTrapMemo, npThermoEntry=npThermoEntry, npRelHumTrapTemp=npRelHumTrapTemp, npIoLevelIn=npIoLevelIn, npThermo=npThermo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIo=npIo, npIoTrapPrefix=npIoTrapPrefix, npIrCtrl=npIrCtrl, npIoLevelOut=npIoLevelOut, npThermoTable=npThermoTable, npCurLoopTrapI=npCurLoopTrapI, npIoTraps=npIoTraps, npCurLoopTrapN=npCurLoopTrapN, npIoTrapLineN=npIoTrapLineN, npCurLoopTable=npCurLoopTable, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTraps=npSmokeTraps, npThermoSensorN=npThermoSensorN, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapV=npCurLoopTrapV, npIrStatus=npIrStatus, npThermoTrapHigh=npThermoTrapHigh, npIoPulseCounter=npIoPulseCounter, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayMode=npRelayMode, npCurLoopN=npCurLoopN, npRelHumEntry=npRelHumEntry, lightcom=lightcom, npGsmRegistration=npGsmRegistration, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumidity=npRelHumidity, npIoEntry=npIoEntry, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapData=npRelHumTrapData, npRelay=npRelay, npRelayState=npRelayState, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeStatus=npSmokeStatus, npGsmStrength=npGsmStrength, npTrapEmailTo=npTrapEmailTo, npThermoTrapStatus=npThermoTrapStatus, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmTraps=npGsmTraps, npSmokeTrap=npSmokeTrap, npSmokePower=npSmokePower, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopEntry=npCurLoopEntry, npCurLoop=npCurLoop, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrap=npRelHumTrap, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapValue=npThermoTrapValue, npReboot=npReboot, npTrapInfo=npTrapInfo)
