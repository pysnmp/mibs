...
# Produced by pysmi-1.1.10 at Thu Nov  9 13:50:39 2023
...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, IpAddress, Gauge32, Integer32, Bits, ObjectIdentity, Counter64, MibIdentifier, Counter32, iso, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "IpAddress", "Gauge32", "Integer32", "Bits", "ObjectIdentity", "Counter64", "MibIdentifier", "Counter32", "iso", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumN=npRelHumN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapHigh=npThermoTrapHigh, npRelHumStatus=npRelHumStatus, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsm=npGsm, npCurLoopTrapV=npCurLoopTrapV, npSmokeStatus=npSmokeStatus, npCurLoopTrap=npCurLoopTrap, npReboot=npReboot, lightcom=lightcom, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTraps=npCurLoopTraps, npForcedReboot=npForcedReboot, npThermoTrapValue=npThermoTrapValue, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmStrength=npGsmStrength, npThermoHigh=npThermoHigh, npTrapInfo=npTrapInfo, npGsmTrapPrefix=npGsmTrapPrefix, npIoTraps=npIoTraps, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataN=npRelHumTrapDataN, npIoLevelOut=npIoLevelOut, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapPrefix=npThermoTrapPrefix, npRelayEntry=npRelayEntry, npRelayMode=npRelayMode, npThermoTraps=npThermoTraps, npThermoTrapLow=npThermoTrapLow, npThermoTable=npThermoTable, npSmokeTrap=npSmokeTrap, npSmokeTable=npSmokeTable, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrap=npRelHumTrap, npRelHumTable=npRelHumTable, npGsmFailed=npGsmFailed, npSmokeReset=npSmokeReset, npGsmInfo=npGsmInfo, npResetStack=npResetStack, npRelay=npRelay, npCurLoopR=npCurLoopR, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npTrapEmailTo=npTrapEmailTo, npIrPlayCmd=npIrPlayCmd, npIoTrapMemo=npIoTrapMemo, npThermoValue=npThermoValue, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopStatus=npCurLoopStatus, npRelHumidity=npRelHumidity, npThermoTrapMemo=npThermoTrapMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapPrefix=npIoTrapPrefix, npCurLoopN=npCurLoopN, npRelHumTrapFail=npRelHumTrapFail, npRelHumValue=npRelHumValue, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTable=npIoTable, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIo=npIo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSoftReboot=npSoftReboot, npCurLoopTrapI=npCurLoopTrapI, npRelayTable=npRelayTable, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmTrap=npGsmTrap, npCurLoopI=npCurLoopI, npIoSinglePulseStart=npIoSinglePulseStart, npSmokePower=npSmokePower, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoStatus=npThermoStatus, npSmokeMemo=npSmokeMemo, npCurLoop=npCurLoop, npSmokeTraps=npSmokeTraps, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumMemo=npRelHumMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermo=npThermo, npThermoTrap=npThermoTrap, npSmoke=npSmoke, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoEntry=npIoEntry, npIoLineN=npIoLineN, npThermoMemo=npThermoMemo, npIr=npIr, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayState=npRelayState, npSmokeEntry=npSmokeEntry, npRelayN=npRelayN, npIrStatus=npIrStatus, npCurLoopV=npCurLoopV, npIoPulseCounter=npIoPulseCounter, npRelHumSafeRangeLow=npRelHumSafeRangeLow, FixedPoint1000=FixedPoint1000, npThermoEntry=npThermoEntry, npCurLoopTable=npCurLoopTable, npSmokeTrapStatus=npSmokeTrapStatus, npGsmTraps=npGsmTraps, npRelHumTempStatus=npRelHumTempStatus, npCurLoopPower=npCurLoopPower, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoLevelIn=npIoLevelIn, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoMemo=npIoMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapDataMemo=npRelHumTrapDataMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrap=npIoTrap, npIrReset=npIrReset, npIoTrapLineN=npIoTrapLineN, npGsmRegistration=npGsmRegistration, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoSensorN=npThermoSensorN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapStatus=npThermoTrapStatus, npRelayMemo=npRelayMemo, npThermoLow=npThermoLow, npThermoTrapSensorN=npThermoTrapSensorN, npRelayStartReset=npRelayStartReset, npIrCtrl=npIrCtrl, npRelHumEntry=npRelHumEntry)
