...
# Produced by pysmi-1.1.12 at Mon Jul  1 09:23:00 2024
...
iso, MibIdentifier, IpAddress, Counter32, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, Unsigned32, enterprises, NotificationType, Gauge32, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "IpAddress", "Counter32", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "Unsigned32", "enterprises", "NotificationType", "Gauge32", "Bits", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeSensorN=npSmokeSensorN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTable=npCurLoopTable, npSmokeTrap=npSmokeTrap, npGsmInfo=npGsmInfo, npRelHumTrap=npRelHumTrap, npIoTrapLineN=npIoTrapLineN, npSmokeStatus=npSmokeStatus, npRelHumN=npRelHumN, npThermoTraps=npThermoTraps, npCurLoopTrap=npCurLoopTrap, lightcom=lightcom, npCurLoopPower=npCurLoopPower, npIoTraps=npIoTraps, npCurLoopTrapV=npCurLoopTrapV, npIrReset=npIrReset, npRelayMode=npRelayMode, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumValue=npRelHumValue, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapMemo=npThermoTrapMemo, npIrCtrl=npIrCtrl, npThermoSensorN=npThermoSensorN, npTrapEmailTo=npTrapEmailTo, npGsmStrength=npGsmStrength, npRelayEntry=npRelayEntry, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeEntry=npSmokeEntry, npCurLoopI=npCurLoopI, npRelHumStatus=npRelHumStatus, npReboot=npReboot, npRelHumTable=npRelHumTable, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmTraps=npGsmTraps, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrapStatus=npSmokeTrapStatus, npIoPulseCounter=npIoPulseCounter, npRelayState=npRelayState, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSoftReboot=npSoftReboot, npIr=npIr, npRelHumidity=npRelHumidity, npRelHumMemo=npRelHumMemo, npCurLoopR=npCurLoopR, npGsmTrapPrefix=npGsmTrapPrefix, npGsm=npGsm, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapLow=npThermoTrapLow, npIoTable=npIoTable, FixedPoint1000=FixedPoint1000, npThermo=npThermo, npSmokeMemo=npSmokeMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrapLevelLegend=npIoTrapLevelLegend, npTrapInfo=npTrapInfo, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTrap=npIoTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrapMemo=npIoTrapMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoValue=npThermoValue, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapData=npRelHumTrapData, npRelHumEntry=npRelHumEntry, npSmokeTable=npSmokeTable, npGsmFailed=npGsmFailed, npRelayN=npRelayN, npIoLevelOut=npIoLevelOut, npThermoHigh=npThermoHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoop=npCurLoop, npThermoTrap=npThermoTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npResetStack=npResetStack, npThermoStatus=npThermoStatus, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoEntry=npThermoEntry, npThermoTrapSensorN=npThermoTrapSensorN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoLineN=npIoLineN, npGsmTrap=npGsmTrap, npSmokeTraps=npSmokeTraps, npForcedReboot=npForcedReboot, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoSinglePulseDuration=npIoSinglePulseDuration, npIrStatus=npIrStatus, npSmokeReset=npSmokeReset, npThermoTrapValue=npThermoTrapValue, npRelay=npRelay, npThermoTrapStatus=npThermoTrapStatus, npRelayTable=npRelayTable, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapN=npCurLoopTrapN, npGsmRegistration=npGsmRegistration, npThermoMemo=npThermoMemo, npThermoTable=npThermoTable, npIo=npIo, npIoMemo=npIoMemo, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTemp=npRelHumTrapTemp, npIrPlayCmd=npIrPlayCmd, npIoLevelIn=npIoLevelIn, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopN=npCurLoopN, npThermoLow=npThermoLow, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTempSafe=npRelHumTrapTempSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayStartReset=npRelayStartReset, npSmokePower=npSmokePower, npRelHumTempValue=npRelHumTempValue, npRelayMemo=npRelayMemo, npThermoTrapPrefix=npThermoTrapPrefix, npSmoke=npSmoke, npCurLoopV=npCurLoopV, npThermoTrapHigh=npThermoTrapHigh, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoEntry=npIoEntry, npRelHumTempStatus=npRelHumTempStatus)
