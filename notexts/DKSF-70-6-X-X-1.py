...
TimeTicks, Integer32, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises, Bits, Gauge32, IpAddress, Unsigned32, iso, ModuleIdentity, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises", "Bits", "Gauge32", "IpAddress", "Unsigned32", "iso", "ModuleIdentity", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeSensorN=npSmokeSensorN, npReboot=npReboot, npIo=npIo, npGsmTrap=npGsmTrap, npThermoValue=npThermoValue, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumStatus=npRelHumStatus, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoop=npCurLoop, npCurLoopPower=npCurLoopPower, npRelayMode=npRelayMode, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeEntry=npSmokeEntry, npSmokeTable=npSmokeTable, npRelHumidity=npRelHumidity, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokePower=npSmokePower, npRelHumTempValue=npRelHumTempValue, npThermoTraps=npThermoTraps, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrap=npThermoTrap, npRelHumValue=npRelHumValue, npRelHumMemo=npRelHumMemo, npThermoMemo=npThermoMemo, npGsmFailed=npGsmFailed, npThermoTrapValue=npThermoTrapValue, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTable=npIoTable, npThermo=npThermo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSoftReboot=npSoftReboot, npThermoTable=npThermoTable, npRelayStartReset=npRelayStartReset, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmoke=npSmoke, npCurLoopN=npCurLoopN, npCurLoopV=npCurLoopV, npThermoSensorN=npThermoSensorN, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoHigh=npThermoHigh, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoValuePrecise=npThermoValuePrecise, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmTrapPrefix=npGsmTrapPrefix, npIoLevelOut=npIoLevelOut, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelay=npRelay, npCurLoopTable=npCurLoopTable, npGsmStrength=npGsmStrength, npRelHumEntry=npRelHumEntry, npGsm=npGsm, FixedPoint1000=FixedPoint1000, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeStatus=npSmokeStatus, npIrCtrl=npIrCtrl, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopStatus=npCurLoopStatus, npThermoTrapLow=npThermoTrapLow, npThermoStatus=npThermoStatus, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTrapLevelIn=npIoTrapLevelIn, npRelayEntry=npRelayEntry, npCurLoopR=npCurLoopR, npGsmRegistration=npGsmRegistration, npRelHumN=npRelHumN, npIoTrapLevelLegend=npIoTrapLevelLegend, npIr=npIr, npRelayState=npRelayState, npSmokeReset=npSmokeReset, npResetStack=npResetStack, npRelayMemo=npRelayMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoLineN=npIoLineN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoLow=npThermoLow, npCurLoopTraps=npCurLoopTraps, npCurLoopI=npCurLoopI, npIrStatus=npIrStatus, npThermoTrapMemo=npThermoTrapMemo, npIoSinglePulseStart=npIoSinglePulseStart, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmInfo=npGsmInfo, npForcedReboot=npForcedReboot, npCurLoopTrap=npCurLoopTrap, npIoTrap=npIoTrap, npThermoEntry=npThermoEntry, npIoMemo=npIoMemo, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapData=npRelHumTrapData, npIoTrapMemo=npIoTrapMemo, npIoEntry=npIoEntry, npIoTraps=npIoTraps, npRelayTable=npRelayTable, npTrapInfo=npTrapInfo, npCurLoopTrapV=npCurLoopTrapV, npGsmTraps=npGsmTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeMemo=npSmokeMemo, npCurLoopTrapN=npCurLoopTrapN, lightcom=lightcom, npIrReset=npIrReset, npRelHumTrapFail=npRelHumTrapFail, npRelayN=npRelayN, npCurLoopTrapR=npCurLoopTrapR, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTraps=npSmokeTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIrPlayCmd=npIrPlayCmd, npRelHumTable=npRelHumTable, npIoTrapPrefix=npIoTrapPrefix, npIoLevelIn=npIoLevelIn, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrap=npRelHumTrap, npSmokeTrap=npSmokeTrap)
