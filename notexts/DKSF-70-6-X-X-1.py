...
iso, TimeTicks, NotificationType, Unsigned32, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, Bits, MibIdentifier, Counter64, ObjectIdentity, enterprises, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "NotificationType", "Unsigned32", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "Bits", "MibIdentifier", "Counter64", "ObjectIdentity", "enterprises", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoPulseCounter=npIoPulseCounter, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeEntry=npSmokeEntry, npThermoMemo=npThermoMemo, npResetStack=npResetStack, npThermoSensorN=npThermoSensorN, npGsmFailed=npGsmFailed, npRelayState=npRelayState, npRelHumStatus=npRelHumStatus, npRelay=npRelay, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapValue=npThermoTrapValue, npSmokeTable=npSmokeTable, npReboot=npReboot, npCurLoopR=npCurLoopR, npThermoEntry=npThermoEntry, npCurLoopStatus=npCurLoopStatus, npRelayEntry=npRelayEntry, FixedPoint1000=FixedPoint1000, npSmokeStatus=npSmokeStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmTrapPrefix=npGsmTrapPrefix, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopPower=npCurLoopPower, npIoLineN=npIoLineN, npRelHumEntry=npRelHumEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapV=npCurLoopTrapV, npForcedReboot=npForcedReboot, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapMemo=npIoTrapMemo, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumN=npRelHumN, npIo=npIo, npRelayN=npRelayN, npIrCtrl=npIrCtrl, npThermoHigh=npThermoHigh, npThermoTrap=npThermoTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayStartReset=npRelayStartReset, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapData=npRelHumTrapData, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrap=npIoTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayMemo=npRelayMemo, npRelHumValue=npRelHumValue, npCurLoopTrapI=npCurLoopTrapI, npIr=npIr, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTraps=npThermoTraps, npThermo=npThermo, npThermoValue=npThermoValue, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIrReset=npIrReset, npIoTrapLevelIn=npIoTrapLevelIn, npRelayTable=npRelayTable, npSmoke=npSmoke, npSmokeTrapMemo=npSmokeTrapMemo, npSoftReboot=npSoftReboot, npGsmRegistration=npGsmRegistration, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTraps=npCurLoopTraps, npRelHumTable=npRelHumTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeMemo=npSmokeMemo, npIoEntry=npIoEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTrap=npSmokeTrap, npRelHumMemo=npRelHumMemo, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapStatus=npThermoTrapStatus, npThermoValuePrecise=npThermoValuePrecise, npCurLoopV=npCurLoopV, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapSafe=npRelHumTrapSafe, npGsmTraps=npGsmTraps, npIoLevelIn=npIoLevelIn, npIoLevelOut=npIoLevelOut, npIoTraps=npIoTraps, npRelayMode=npRelayMode, npThermoTrapMemo=npThermoTrapMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumidity=npRelHumidity, npThermoStatus=npThermoStatus, npIrPlayCmd=npIrPlayCmd, npSmokeTraps=npSmokeTraps, npCurLoopN=npCurLoopN, npCurLoopTable=npCurLoopTable, npCurLoopEntry=npCurLoopEntry, npIoSinglePulseStart=npIoSinglePulseStart, npGsmInfo=npGsmInfo, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoop=npCurLoop, npThermoTrapSensorN=npThermoTrapSensorN, npThermoLow=npThermoLow, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTable=npIoTable, npSmokePower=npSmokePower, npTrapInfo=npTrapInfo, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrapLineN=npIoTrapLineN, npSmokeReset=npSmokeReset, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTable=npThermoTable, npGsm=npGsm, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoMemo=npIoMemo, lightcom=lightcom, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmStrength=npGsmStrength, npRelHumTrap=npRelHumTrap, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapN=npCurLoopTrapN, npCurLoopI=npCurLoopI, npThermoTrapHigh=npThermoTrapHigh, npIrStatus=npIrStatus, npGsmTrap=npGsmTrap)
