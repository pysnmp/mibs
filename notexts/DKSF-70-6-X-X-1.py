...
# Produced by pysmi-1.1.8 at Sat Jan 15 17:23:24 2022
...
enterprises, Gauge32, Integer32, NotificationType, MibIdentifier, Counter64, iso, Bits, ModuleIdentity, TimeTicks, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "Integer32", "NotificationType", "MibIdentifier", "Counter64", "iso", "Bits", "ModuleIdentity", "TimeTicks", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoLevelIn=npIoLevelIn, npThermoValue=npThermoValue, npTrapEmailTo=npTrapEmailTo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, FixedPoint1000=FixedPoint1000, npIoLevelOut=npIoLevelOut, npRelHumValue=npRelHumValue, npRelHumEntry=npRelHumEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopI=npCurLoopI, npThermoTable=npThermoTable, npCurLoopTrap=npCurLoopTrap, npGsmStrength=npGsmStrength, npGsmTraps=npGsmTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopR=npCurLoopR, npIoTraps=npIoTraps, npSmokeEntry=npSmokeEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoSinglePulseStart=npIoSinglePulseStart, npThermoLow=npThermoLow, npSmokeStatus=npSmokeStatus, npIrCtrl=npIrCtrl, npIoPulseCounter=npIoPulseCounter, npCurLoopTrapR=npCurLoopTrapR, npSmokeTrapMemo=npSmokeTrapMemo, npIrPlayCmd=npIrPlayCmd, npCurLoopPower=npCurLoopPower, npSmokeTrap=npSmokeTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapHigh=npThermoTrapHigh, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTraps=npThermoTraps, npRelayN=npRelayN, npIoLineN=npIoLineN, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapFail=npRelHumTrapFail, npCurLoopEntry=npCurLoopEntry, npGsmTrap=npGsmTrap, npSmokeTable=npSmokeTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopV=npCurLoopV, npRelHumStatus=npRelHumStatus, npGsmRegistration=npGsmRegistration, npSoftReboot=npSoftReboot, npRelayEntry=npRelayEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsm=npGsm, npForcedReboot=npForcedReboot, npThermoTrapMemo=npThermoTrapMemo, npCurLoopStatus=npCurLoopStatus, npCurLoop=npCurLoop, uniPingServerSolutionV3=uniPingServerSolutionV3, npIr=npIr, npRelayMemo=npRelayMemo, npRelHumMemo=npRelHumMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, lightcom=lightcom, npRelHumidity=npRelHumidity, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapData=npRelHumTrapData, npThermo=npThermo, npSmokeTrapStatus=npSmokeTrapStatus, npIrStatus=npIrStatus, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoValuePrecise=npThermoValuePrecise, npRelHumTable=npRelHumTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrap=npIoTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npTrapInfo=npTrapInfo, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeSensorN=npSmokeSensorN, npSmokePower=npSmokePower, npRelay=npRelay, npSmokeReset=npSmokeReset, npRelayTable=npRelayTable, npThermoMemo=npThermoMemo, npRelayStartReset=npRelayStartReset, npCurLoopTable=npCurLoopTable, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrapLineN=npIoTrapLineN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmInfo=npGsmInfo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeMemo=npSmokeMemo, npRelHumN=npRelHumN, npRelHumTrapDataN=npRelHumTrapDataN, npThermoHigh=npThermoHigh, npIoTrapMemo=npIoTrapMemo, npSmokeTraps=npSmokeTraps, npIrReset=npIrReset, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npReboot=npReboot, npCurLoopN=npCurLoopN, npThermoSensorN=npThermoSensorN, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrap=npRelHumTrap, npCurLoopTrapI=npCurLoopTrapI, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapPrefix=npIoTrapPrefix, npIoTable=npIoTable, npRelayMode=npRelayMode, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIo=npIo, npIoEntry=npIoEntry, npSmoke=npSmoke, npThermoStatus=npThermoStatus, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapPrefix=npThermoTrapPrefix, npRelayState=npRelayState, npGsmFailed=npGsmFailed, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoMemo=npIoMemo, npThermoTrap=npThermoTrap, npResetStack=npResetStack, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoEntry=npThermoEntry, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapValue=npThermoTrapValue, npThermoTrapLow=npThermoTrapLow)
