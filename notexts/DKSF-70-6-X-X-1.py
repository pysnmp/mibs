...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, NotificationType, Counter64, Unsigned32, IpAddress, Bits, Gauge32, MibIdentifier, iso, enterprises, ObjectIdentity, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "NotificationType", "Counter64", "Unsigned32", "IpAddress", "Bits", "Gauge32", "MibIdentifier", "iso", "enterprises", "ObjectIdentity", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTable=npSmokeTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopR=npCurLoopR, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npCurLoopPower=npCurLoopPower, npRelHumTrapData=npRelHumTrapData, npThermoSensorN=npThermoSensorN, npIo=npIo, npThermoTrap=npThermoTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTraps=npCurLoopTraps, npRelay=npRelay, npRelHumEntry=npRelHumEntry, npThermo=npThermo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoLevelIn=npIoLevelIn, npIoTrap=npIoTrap, npThermoEntry=npThermoEntry, npIrStatus=npIrStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeMemo=npSmokeMemo, npRelHumTable=npRelHumTable, npCurLoopStatus=npCurLoopStatus, npIoLineN=npIoLineN, npSmokeTrap=npSmokeTrap, npThermoTraps=npThermoTraps, npRelHumMemo=npRelHumMemo, FixedPoint1000=FixedPoint1000, npRelayMode=npRelayMode, npRelayStartReset=npRelayStartReset, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoEntry=npIoEntry, npRelHumTrapFail=npRelHumTrapFail, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumValue=npRelHumValue, npRelHumTempValue=npRelHumTempValue, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayEntry=npRelayEntry, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeReset=npSmokeReset, npSmokeEntry=npSmokeEntry, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoValue=npThermoValue, npCurLoopI=npCurLoopI, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrap=npCurLoopTrap, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmTrap=npGsmTrap, npForcedReboot=npForcedReboot, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTempStatus=npRelHumTempStatus, npIoTrapLevelIn=npIoTrapLevelIn, npIoTable=npIoTable, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapMemo=npIoTrapMemo, npIrPlayCmd=npIrPlayCmd, npIrCtrl=npIrCtrl, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataN=npRelHumTrapDataN, npGsmFailed=npGsmFailed, npGsmTraps=npGsmTraps, npThermoTable=npThermoTable, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrReset=npIrReset, npIr=npIr, npThermoMemo=npThermoMemo, npThermoTrapMemo=npThermoTrapMemo, npReboot=npReboot, npCurLoopTrapV=npCurLoopTrapV, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopV=npCurLoopV, npIoTraps=npIoTraps, lightcom=lightcom, npIoTrapLineN=npIoTrapLineN, npSmokeStatus=npSmokeStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoStatus=npThermoStatus, npSmoke=npSmoke, npRelHumTrap=npRelHumTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npResetStack=npResetStack, npCurLoopTrapR=npCurLoopTrapR, npGsm=npGsm, npThermoTrapLow=npThermoTrapLow, npIoLevelOut=npIoLevelOut, npCurLoopTrapN=npCurLoopTrapN, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmInfo=npGsmInfo, npGsmStrength=npGsmStrength, npThermoTrapValue=npThermoTrapValue, npSmokePower=npSmokePower, npGsmRegistration=npGsmRegistration, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopN=npCurLoopN, npRelayTable=npRelayTable, npRelHumStatus=npRelHumStatus, npThermoLow=npThermoLow, npIoMemo=npIoMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayMemo=npRelayMemo, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLevelLegend=npIoTrapLevelLegend, npTrapEmailTo=npTrapEmailTo, npSmokeTraps=npSmokeTraps, npRelayState=npRelayState, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npTrapInfo=npTrapInfo, npSoftReboot=npSoftReboot, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoHigh=npThermoHigh, npThermoTrapStatus=npThermoTrapStatus, npRelHumN=npRelHumN, npRelHumidity=npRelHumidity, npCurLoop=npCurLoop, npCurLoopTable=npCurLoopTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelayN=npRelayN)
