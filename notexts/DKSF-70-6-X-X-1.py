...
# Produced by pysmi-1.1.8 at Wed Sep 13 02:51:30 2023
...
enterprises, Gauge32, Integer32, TimeTicks, Counter32, Bits, NotificationType, MibIdentifier, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "Integer32", "TimeTicks", "Counter32", "Bits", "NotificationType", "MibIdentifier", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeEntry=npSmokeEntry, npSmokeStatus=npSmokeStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrap=npThermoTrap, npGsmInfo=npGsmInfo, npRelHumN=npRelHumN, npCurLoopR=npCurLoopR, npThermoLow=npThermoLow, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npForcedReboot=npForcedReboot, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTrap=npIoTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTable=npIoTable, npRelHumTrapFail=npRelHumTrapFail, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempValue=npRelHumTempValue, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIrPlayCmd=npIrPlayCmd, npSoftReboot=npSoftReboot, npThermoEntry=npThermoEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTable=npRelHumTable, npIoEntry=npIoEntry, npThermoTrapSensorN=npThermoTrapSensorN, npIoPulseCounter=npIoPulseCounter, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeReset=npSmokeReset, npThermoTrapMemo=npThermoTrapMemo, npTrapInfo=npTrapInfo, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTable=npCurLoopTable, npRelayN=npRelayN, npCurLoopStatus=npCurLoopStatus, npThermo=npThermo, npGsmTrap=npGsmTrap, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapData=npRelHumTrapData, npRelHumMemo=npRelHumMemo, npCurLoopI=npCurLoopI, npCurLoopV=npCurLoopV, npRelHumTrapDataN=npRelHumTrapDataN, npThermoMemo=npThermoMemo, npRelHumidity=npRelHumidity, npIrStatus=npIrStatus, npIoMemo=npIoMemo, npCurLoop=npCurLoop, npSmokeTrapPrefix=npSmokeTrapPrefix, npResetStack=npResetStack, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumValue=npRelHumValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapHigh=npThermoTrapHigh, npRelayStartReset=npRelayStartReset, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumStatus=npRelHumStatus, npThermoTrapLow=npThermoTrapLow, npIrReset=npIrReset, npThermoHigh=npThermoHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapValue=npThermoTrapValue, npGsmTrapPrefix=npGsmTrapPrefix, FixedPoint1000=FixedPoint1000, npThermoSensorN=npThermoSensorN, npRelHumTrapDataValue=npRelHumTrapDataValue, npIr=npIr, npThermoValue=npThermoValue, npSmokeMemo=npSmokeMemo, npRelayState=npRelayState, npRelayEntry=npRelayEntry, npSmokeTable=npSmokeTable, npRelHumEntry=npRelHumEntry, npGsmFailed=npGsmFailed, npIoTrapLineN=npIoTrapLineN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrap=npCurLoopTrap, npGsmRegistration=npGsmRegistration, npSmokeTrap=npSmokeTrap, npIoTrapPrefix=npIoTrapPrefix, npIoLineN=npIoLineN, npCurLoopN=npCurLoopN, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokePower=npSmokePower, npSmokeTraps=npSmokeTraps, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoStatus=npThermoStatus, npRelay=npRelay, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIrCtrl=npIrCtrl, npThermoValuePrecise=npThermoValuePrecise, lightcom=lightcom, npIoTrapMemo=npIoTrapMemo, npIoTraps=npIoTraps, npThermoTraps=npThermoTraps, npReboot=npReboot, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTable=npThermoTable, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npTrapEmailTo=npTrapEmailTo, npThermoTrapStatus=npThermoTrapStatus, npGsmTraps=npGsmTraps, npGsmStrength=npGsmStrength, npRelayMode=npRelayMode, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayMemo=npRelayMemo, npGsm=npGsm, npSmoke=npSmoke, npRelayTable=npRelayTable, npCurLoopPower=npCurLoopPower, npIo=npIo, npIoLevelOut=npIoLevelOut, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTraps=npCurLoopTraps, npSmokeSensorN=npSmokeSensorN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoLevelIn=npIoLevelIn, npRelHumTrap=npRelHumTrap, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTempStatus=npRelHumTempStatus, npIoTrapLevelIn=npIoTrapLevelIn)
