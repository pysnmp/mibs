...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:16:09 2024
...
iso, ObjectIdentity, Unsigned32, Gauge32, Integer32, NotificationType, IpAddress, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, ModuleIdentity, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "Unsigned32", "Gauge32", "Integer32", "NotificationType", "IpAddress", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "ModuleIdentity", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokePower=npSmokePower, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoPulseCounter=npIoPulseCounter, npRelayTable=npRelayTable, npIrStatus=npIrStatus, npRelHumTrap=npRelHumTrap, npThermo=npThermo, npCurLoopTrapV=npCurLoopTrapV, npSmokeReset=npSmokeReset, npCurLoopEntry=npCurLoopEntry, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeEntry=npSmokeEntry, npIoLevelOut=npIoLevelOut, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmRegistration=npGsmRegistration, npIoEntry=npIoEntry, npThermoEntry=npThermoEntry, FixedPoint1000=FixedPoint1000, npCurLoopTable=npCurLoopTable, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoMemo=npIoMemo, npThermoHigh=npThermoHigh, npCurLoopStatus=npCurLoopStatus, npThermoValue=npThermoValue, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTable=npSmokeTable, npTrapInfo=npTrapInfo, npRelHumMemo=npRelHumMemo, npThermoStatus=npThermoStatus, npCurLoopTraps=npCurLoopTraps, npThermoTrapStatus=npThermoTrapStatus, npGsmTraps=npGsmTraps, npRelHumEntry=npRelHumEntry, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapHigh=npThermoTrapHigh, lightcom=lightcom, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayN=npRelayN, npRelayMemo=npRelayMemo, npIoTraps=npIoTraps, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTraps=npSmokeTraps, npCurLoopR=npCurLoopR, npGsm=npGsm, npRelHumTrapData=npRelHumTrapData, npIrPlayCmd=npIrPlayCmd, npRelHumN=npRelHumN, npIoTrap=npIoTrap, npIrCtrl=npIrCtrl, npThermoLow=npThermoLow, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTable=npIoTable, npThermoTraps=npThermoTraps, npCurLoop=npCurLoop, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIrReset=npIrReset, npRelHumValue=npRelHumValue, npCurLoopI=npCurLoopI, npReboot=npReboot, npSmokeStatus=npSmokeStatus, npIo=npIo, npRelayState=npRelayState, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayEntry=npRelayEntry, npThermoTable=npThermoTable, npSmoke=npSmoke, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayMode=npRelayMode, npForcedReboot=npForcedReboot, npThermoSensorN=npThermoSensorN, npSmokeTrapSensorN=npSmokeTrapSensorN, npResetStack=npResetStack, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npGsmStrength=npGsmStrength, npRelayStartReset=npRelayStartReset, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoLineN=npIoLineN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmFailed=npGsmFailed, npIoLevelIn=npIoLevelIn, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmTrap=npGsmTrap, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopN=npCurLoopN, npTrapEmailTo=npTrapEmailTo, npRelHumTempStatus=npRelHumTempStatus, npRelHumidity=npRelHumidity, npGsmInfo=npGsmInfo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapLow=npThermoTrapLow, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeMemo=npSmokeMemo, npCurLoopV=npCurLoopV, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoMemo=npThermoMemo, npThermoTrapPrefix=npThermoTrapPrefix, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopPower=npCurLoopPower, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrap=npSmokeTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIr=npIr, npRelay=npRelay, npCurLoopTrapN=npCurLoopTrapN, npIoTrapMemo=npIoTrapMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumStatus=npRelHumStatus, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapValue=npThermoTrapValue, npRelHumTable=npRelHumTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrap=npCurLoopTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapI=npCurLoopTrapI, npThermoTrap=npThermoTrap, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeSensorN=npSmokeSensorN, npSoftReboot=npSoftReboot)
