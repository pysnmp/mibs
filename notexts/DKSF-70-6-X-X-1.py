...
Integer32, Gauge32, TimeTicks, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, IpAddress, ObjectIdentity, Bits, iso, enterprises, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "TimeTicks", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "IpAddress", "ObjectIdentity", "Bits", "iso", "enterprises", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoLevelOut=npIoLevelOut, npCurLoopI=npCurLoopI, npCurLoopTraps=npCurLoopTraps, npSmokeEntry=npSmokeEntry, npSmoke=npSmoke, npRelHumN=npRelHumN, npIrCtrl=npIrCtrl, npCurLoopR=npCurLoopR, npCurLoop=npCurLoop, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoSensorN=npThermoSensorN, npRelHumEntry=npRelHumEntry, npThermoHigh=npThermoHigh, npIoPulseCounter=npIoPulseCounter, npGsmRegistration=npGsmRegistration, npSmokeTrap=npSmokeTrap, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIrReset=npIrReset, npRelayMemo=npRelayMemo, npCurLoopTrap=npCurLoopTrap, npSmokePower=npSmokePower, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmFailed=npGsmFailed, npRelHumTrapData=npRelHumTrapData, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapDataN=npRelHumTrapDataN, npIoTrapMemo=npIoTrapMemo, npRelHumTrapSafe=npRelHumTrapSafe, npIoMemo=npIoMemo, npCurLoopV=npCurLoopV, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTrapLineN=npIoTrapLineN, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeReset=npSmokeReset, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapV=npCurLoopTrapV, npRelayEntry=npRelayEntry, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTraps=npSmokeTraps, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npReboot=npReboot, npRelHumMemo=npRelHumMemo, npRelHumTable=npRelHumTable, npRelHumTrapFail=npRelHumTrapFail, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrap=npIoTrap, npGsmStrength=npGsmStrength, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeSensorN=npSmokeSensorN, npIoTrapLevelIn=npIoTrapLevelIn, npRelayMode=npRelayMode, npCurLoopN=npCurLoopN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrap=npRelHumTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npTrapEmailTo=npTrapEmailTo, npCurLoopEntry=npCurLoopEntry, npThermoStatus=npThermoStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, FixedPoint1000=FixedPoint1000, npRelHumTempValue=npRelHumTempValue, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTable=npIoTable, npIoEntry=npIoEntry, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeMemo=npSmokeMemo, lightcom=lightcom, npThermoTrapHigh=npThermoTrapHigh, npCurLoopPower=npCurLoopPower, npThermoLow=npThermoLow, npCurLoopTable=npCurLoopTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoValue=npThermoValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmTraps=npGsmTraps, npSmokeStatus=npSmokeStatus, npThermo=npThermo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopStatus=npCurLoopStatus, npIoTraps=npIoTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIr=npIr, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTable=npThermoTable, npRelHumStatus=npRelHumStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npForcedReboot=npForcedReboot, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsm=npGsm, npIrStatus=npIrStatus, npThermoEntry=npThermoEntry, npSmokeTable=npSmokeTable, npRelayTable=npRelayTable, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npResetStack=npResetStack, npIrPlayCmd=npIrPlayCmd, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapValue=npThermoTrapValue, npThermoTrapStatus=npThermoTrapStatus, npRelHumValue=npRelHumValue, npCurLoopTrapR=npCurLoopTrapR, npTrapInfo=npTrapInfo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmInfo=npGsmInfo, npCurLoopTrapPower=npCurLoopTrapPower, npSoftReboot=npSoftReboot, npThermoTrapMemo=npThermoTrapMemo, npRelayStartReset=npRelayStartReset, npRelHumidity=npRelHumidity, npThermoTrapPrefix=npThermoTrapPrefix, npIoLevelIn=npIoLevelIn, npThermoTrapLow=npThermoTrapLow, npIo=npIo, npCurLoopTrapN=npCurLoopTrapN, npGsmTrap=npGsmTrap, npThermoMemo=npThermoMemo, npRelay=npRelay, npThermoTrap=npThermoTrap, npIoTrapPrefix=npIoTrapPrefix, npIoLineN=npIoLineN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoValuePrecise=npThermoValuePrecise, npRelayN=npRelayN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapI=npCurLoopTrapI, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTraps=npThermoTraps, npRelayState=npRelayState)
