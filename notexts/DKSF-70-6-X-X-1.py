...
# Produced by pysmi-1.1.12 at Tue May 21 06:59:04 2024
...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, MibIdentifier, NotificationType, Counter64, ObjectIdentity, Unsigned32, Bits, TimeTicks, iso, ModuleIdentity, enterprises, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "MibIdentifier", "NotificationType", "Counter64", "ObjectIdentity", "Unsigned32", "Bits", "TimeTicks", "iso", "ModuleIdentity", "enterprises", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIrStatus=npIrStatus, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTemp=npRelHumTrapTemp, npRelay=npRelay, npSmokeReset=npSmokeReset, npRelHumStatus=npRelHumStatus, npCurLoopTrapPower=npCurLoopTrapPower, npThermoStatus=npThermoStatus, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTable=npIoTable, npIoTrapLineN=npIoTrapLineN, npIrReset=npIrReset, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoValue=npThermoValue, npThermoTrap=npThermoTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npResetStack=npResetStack, npTrapInfo=npTrapInfo, npSmokeMemo=npSmokeMemo, npSmokeTrap=npSmokeTrap, npCurLoopTrap=npCurLoopTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npTrapEmailTo=npTrapEmailTo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoPulseCounter=npIoPulseCounter, npThermoTable=npThermoTable, npThermoEntry=npThermoEntry, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapR=npCurLoopTrapR, npRelayMemo=npRelayMemo, lightcom=lightcom, npRelayEntry=npRelayEntry, npThermoLow=npThermoLow, npThermoTrapLow=npThermoTrapLow, npCurLoopStatus=npCurLoopStatus, npCurLoopI=npCurLoopI, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTable=npCurLoopTable, npIoEntry=npIoEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmRegistration=npGsmRegistration, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoHigh=npThermoHigh, npThermoSensorN=npThermoSensorN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapValue=npThermoTrapValue, npRelayN=npRelayN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeStatus=npSmokeStatus, npIoTraps=npIoTraps, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopN=npCurLoopN, npRelHumTrap=npRelHumTrap, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapHigh=npThermoTrapHigh, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, uniPingServerSolutionV3=uniPingServerSolutionV3, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTraps=npThermoTraps, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npIoMemo=npIoMemo, npRelHumidity=npRelHumidity, npRelHumTable=npRelHumTable, npThermo=npThermo, npCurLoopTrapI=npCurLoopTrapI, npThermoValuePrecise=npThermoValuePrecise, npRelHumN=npRelHumN, FixedPoint1000=FixedPoint1000, npSmoke=npSmoke, npSmokeEntry=npSmokeEntry, npIo=npIo, npGsmInfo=npGsmInfo, npIrCtrl=npIrCtrl, npRelayMode=npRelayMode, npRelHumMemo=npRelHumMemo, npIoTrap=npIoTrap, npGsm=npGsm, npCurLoopTrapN=npCurLoopTrapN, npSmokeTable=npSmokeTable, npForcedReboot=npForcedReboot, npThermoMemo=npThermoMemo, npCurLoopPower=npCurLoopPower, npReboot=npReboot, npThermoTrapSensorN=npThermoTrapSensorN, npRelayStartReset=npRelayStartReset, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTempValue=npRelHumTempValue, npSmokeSensorN=npSmokeSensorN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmTraps=npGsmTraps, npCurLoopTrapV=npCurLoopTrapV, npGsmFailed=npGsmFailed, npSmokePower=npSmokePower, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapData=npRelHumTrapData, npGsmStrength=npGsmStrength, npSoftReboot=npSoftReboot, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumValue=npRelHumValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeTraps=npSmokeTraps, npIoLevelOut=npIoLevelOut, npGsmTrapPrefix=npGsmTrapPrefix, npRelayTable=npRelayTable, npCurLoop=npCurLoop, npIr=npIr, npIoLineN=npIoLineN, npThermoTrapMemo=npThermoTrapMemo, npIoLevelIn=npIoLevelIn, npRelHumTrapSafe=npRelHumTrapSafe, npRelayState=npRelayState, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrPlayCmd=npIrPlayCmd, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTraps=npCurLoopTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumEntry=npRelHumEntry, npCurLoopV=npCurLoopV, npCurLoopR=npCurLoopR, npGsmTrap=npGsmTrap)
