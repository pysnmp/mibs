...
Bits, IpAddress, Unsigned32, enterprises, TimeTicks, Gauge32, Counter32, ObjectIdentity, iso, NotificationType, Integer32, Counter64, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "Unsigned32", "enterprises", "TimeTicks", "Gauge32", "Counter32", "ObjectIdentity", "iso", "NotificationType", "Integer32", "Counter64", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmTrap=npGsmTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoop=npCurLoop, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapR=npCurLoopTrapR, npIoEntry=npIoEntry, npRelHumStatus=npRelHumStatus, npSmokeTrap=npSmokeTrap, npRelHumTempStatus=npRelHumTempStatus, npThermoStatus=npThermoStatus, npThermoTrapValue=npThermoTrapValue, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTrapLineN=npIoTrapLineN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumidity=npRelHumidity, npIoPulseCounter=npIoPulseCounter, npGsmFailed=npGsmFailed, npCurLoopTrapI=npCurLoopTrapI, npRelay=npRelay, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTraps=npThermoTraps, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoEntry=npThermoEntry, npRelayTable=npRelayTable, npRelHumTrapFail=npRelHumTrapFail, npIrCtrl=npIrCtrl, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopR=npCurLoopR, npThermo=npThermo, npThermoSensorN=npThermoSensorN, npCurLoopTable=npCurLoopTable, npThermoTrapMemo=npThermoTrapMemo, npThermoTrapLow=npThermoTrapLow, npTrapInfo=npTrapInfo, npIoTrap=npIoTrap, npCurLoopStatus=npCurLoopStatus, npGsmStrength=npGsmStrength, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npIoTable=npIoTable, npRelHumEntry=npRelHumEntry, npSmokeMemo=npSmokeMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIr=npIr, npThermoTrap=npThermoTrap, npCurLoopV=npCurLoopV, npThermoTable=npThermoTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopN=npCurLoopN, npCurLoopTrapV=npCurLoopTrapV, npSmokeSensorN=npSmokeSensorN, npIoTrapPrefix=npIoTrapPrefix, npRelHumValue=npRelHumValue, npGsmTraps=npGsmTraps, npThermoLow=npThermoLow, npThermoTrapStatus=npThermoTrapStatus, FixedPoint1000=FixedPoint1000, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeReset=npSmokeReset, npSmokePower=npSmokePower, npGsm=npGsm, npIoLevelIn=npIoLevelIn, npSmokeTable=npSmokeTable, npRelHumN=npRelHumN, npRelayStartReset=npRelayStartReset, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, lightcom=lightcom, npResetStack=npResetStack, npRelHumTable=npRelHumTable, npIoLevelOut=npIoLevelOut, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapHigh=npThermoTrapHigh, npThermoHigh=npThermoHigh, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapPrefix=npThermoTrapPrefix, npGsmTrapPrefix=npGsmTrapPrefix, npGsmInfo=npGsmInfo, npRelayEntry=npRelayEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSoftReboot=npSoftReboot, npRelHumTrap=npRelHumTrap, npIrPlayCmd=npIrPlayCmd, npIoLineN=npIoLineN, npCurLoopTrapN=npCurLoopTrapN, npRelayMode=npRelayMode, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTempValue=npRelHumTempValue, npCurLoopTraps=npCurLoopTraps, npSmoke=npSmoke, npRelHumTrapData=npRelHumTrapData, npReboot=npReboot, npRelayMemo=npRelayMemo, npCurLoopI=npCurLoopI, npIrStatus=npIrStatus, npSmokeTraps=npSmokeTraps, npForcedReboot=npForcedReboot, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapSensorN=npThermoTrapSensorN, npIoMemo=npIoMemo, npRelayState=npRelayState, npSmokeEntry=npSmokeEntry, npGsmRegistration=npGsmRegistration, npThermoMemo=npThermoMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeStatus=npSmokeStatus, npRelayN=npRelayN, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopPower=npCurLoopPower, npIo=npIo, npTrapEmailTo=npTrapEmailTo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTraps=npIoTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumMemo=npRelHumMemo, npCurLoopTrap=npCurLoopTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIrReset=npIrReset, npCurLoopEntry=npCurLoopEntry, npThermoValue=npThermoValue)
