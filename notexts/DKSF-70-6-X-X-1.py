...
# Produced by pysmi-1.1.12 at Wed Jul  3 13:32:26 2024
...
ModuleIdentity, enterprises, MibIdentifier, IpAddress, Unsigned32, Counter64, iso, Counter32, NotificationType, Gauge32, Integer32, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "MibIdentifier", "IpAddress", "Unsigned32", "Counter64", "iso", "Counter32", "NotificationType", "Gauge32", "Integer32", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoValuePrecise=npThermoValuePrecise, npSoftReboot=npSoftReboot, npIo=npIo, npRelayMemo=npRelayMemo, npCurLoopTrapV=npCurLoopTrapV, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumMemo=npRelHumMemo, npThermoTrapPrefix=npThermoTrapPrefix, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoPulseCounter=npIoPulseCounter, npCurLoopTrapR=npCurLoopTrapR, npRelHumidity=npRelHumidity, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoStatus=npThermoStatus, npIoTrapLineN=npIoTrapLineN, npIoTrapPrefix=npIoTrapPrefix, npCurLoopEntry=npCurLoopEntry, npGsmInfo=npGsmInfo, npCurLoop=npCurLoop, npRelHumN=npRelHumN, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumStatus=npRelHumStatus, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTraps=npIoTraps, npRelHumEntry=npRelHumEntry, npCurLoopTraps=npCurLoopTraps, npCurLoopStatus=npCurLoopStatus, npRelHumValue=npRelHumValue, npThermo=npThermo, npRelayState=npRelayState, npGsmRegistration=npGsmRegistration, npCurLoopTrapPower=npCurLoopTrapPower, npSmoke=npSmoke, npIoTrapMemo=npIoTrapMemo, npSmokeMemo=npSmokeMemo, npReboot=npReboot, npIoTrap=npIoTrap, npCurLoopPower=npCurLoopPower, npCurLoopI=npCurLoopI, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoEntry=npIoEntry, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTraps=npThermoTraps, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIrPlayCmd=npIrPlayCmd, npSmokeTraps=npSmokeTraps, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataN=npRelHumTrapDataN, npIoLineN=npIoLineN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoEntry=npThermoEntry, FixedPoint1000=FixedPoint1000, npRelayTable=npRelayTable, npRelHumTrap=npRelHumTrap, npTrapInfo=npTrapInfo, npCurLoopV=npCurLoopV, npThermoSensorN=npThermoSensorN, npGsmTrap=npGsmTrap, npThermoLow=npThermoLow, npGsmFailed=npGsmFailed, npGsmStrength=npGsmStrength, npIr=npIr, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIrCtrl=npIrCtrl, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeEntry=npSmokeEntry, npForcedReboot=npForcedReboot, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapData=npRelHumTrapData, npSmokePower=npSmokePower, npSmokeReset=npSmokeReset, npSmokeTrap=npSmokeTrap, npSmokeTrapMemo=npSmokeTrapMemo, npRelayEntry=npRelayEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTempValue=npRelHumTempValue, npResetStack=npResetStack, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTempStatus=npRelHumTempStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapValue=npThermoTrapValue, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopN=npCurLoopN, npIoTrapLevelIn=npIoTrapLevelIn, npGsmTraps=npGsmTraps, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapStatus=npCurLoopTrapStatus, npIrReset=npIrReset, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIrStatus=npIrStatus, npIoLevelOut=npIoLevelOut, npSmokeTable=npSmokeTable, npGsm=npGsm, npRelayMode=npRelayMode, npRelayStartReset=npRelayStartReset, npRelayN=npRelayN, npIoMemo=npIoMemo, npCurLoopTrap=npCurLoopTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTable=npRelHumTable, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoLevelIn=npIoLevelIn, npSmokeSensorN=npSmokeSensorN, npThermoTrapStatus=npThermoTrapStatus, npThermoValue=npThermoValue, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTable=npIoTable, npTrapEmailTo=npTrapEmailTo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeStatus=npSmokeStatus, npThermoTable=npThermoTable, lightcom=lightcom, npCurLoopTable=npCurLoopTable, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapFail=npRelHumTrapFail, npCurLoopR=npCurLoopR, npRelay=npRelay, npCurLoopTrapI=npCurLoopTrapI, npThermoHigh=npThermoHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapLow=npThermoTrapLow, npThermoTrap=npThermoTrap, npThermoMemo=npThermoMemo)
