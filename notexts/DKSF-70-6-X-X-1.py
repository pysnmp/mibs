...
# Produced by pysmi-1.1.12 at Tue May 28 13:44:20 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, enterprises, Bits, TimeTicks, MibIdentifier, ObjectIdentity, iso, NotificationType, Gauge32, Counter32, Integer32, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "enterprises", "Bits", "TimeTicks", "MibIdentifier", "ObjectIdentity", "iso", "NotificationType", "Gauge32", "Counter32", "Integer32", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTraps=npSmokeTraps, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokePower=npSmokePower, npRelayTable=npRelayTable, npRelayMemo=npRelayMemo, npThermoTrapLow=npThermoTrapLow, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapSafe=npRelHumTrapSafe, npRelay=npRelay, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeEntry=npSmokeEntry, npRelHumEntry=npRelHumEntry, npIoLineN=npIoLineN, npGsm=npGsm, npIr=npIr, npThermoSensorN=npThermoSensorN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTraps=npThermoTraps, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeStatus=npSmokeStatus, npIoMemo=npIoMemo, npIoTable=npIoTable, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrap=npThermoTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapMemo=npThermoTrapMemo, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapData=npRelHumTrapData, npRelHumTrap=npRelHumTrap, npIrPlayCmd=npIrPlayCmd, npIoLevelIn=npIoLevelIn, npSmokeTable=npSmokeTable, npThermoTable=npThermoTable, npCurLoopStatus=npCurLoopStatus, npCurLoopTraps=npCurLoopTraps, npRelHumidity=npRelHumidity, npForcedReboot=npForcedReboot, FixedPoint1000=FixedPoint1000, npCurLoopR=npCurLoopR, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoMemo=npThermoMemo, npGsmInfo=npGsmInfo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayState=npRelayState, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTempValue=npRelHumTempValue, npThermoTrapStatus=npThermoTrapStatus, npCurLoopV=npCurLoopV, npIoEntry=npIoEntry, npIoLevelOut=npIoLevelOut, npThermoHigh=npThermoHigh, npGsmTrap=npGsmTrap, npCurLoopPower=npCurLoopPower, npResetStack=npResetStack, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapPrefix=npThermoTrapPrefix, npThermoValue=npThermoValue, npIoTrapLevelIn=npIoTrapLevelIn, npRelayN=npRelayN, npGsmTraps=npGsmTraps, npCurLoopTrapN=npCurLoopTrapN, npRelHumStatus=npRelHumStatus, npIo=npIo, npIrReset=npIrReset, npSmokeMemo=npSmokeMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTrap=npSmokeTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopN=npCurLoopN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapR=npCurLoopTrapR, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopEntry=npCurLoopEntry, npSmoke=npSmoke, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopI=npCurLoopI, lightcom=lightcom, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmRegistration=npGsmRegistration, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayStartReset=npRelayStartReset, npIoTrapLineN=npIoTrapLineN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmStrength=npGsmStrength, npThermoTrapValue=npThermoTrapValue, npIoPulseCounter=npIoPulseCounter, npRelayEntry=npRelayEntry, npRelHumN=npRelHumN, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapSensorN=npThermoTrapSensorN, npThermoStatus=npThermoStatus, npIoTrapMemo=npIoTrapMemo, npGsmFailed=npGsmFailed, npRelayMode=npRelayMode, npSmokeReset=npSmokeReset, npCurLoopTrapI=npCurLoopTrapI, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoLow=npThermoLow, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoEntry=npThermoEntry, npCurLoopTrapV=npCurLoopTrapV, npIoTrapPrefix=npIoTrapPrefix, npTrapEmailTo=npTrapEmailTo, npReboot=npReboot, npCurLoop=npCurLoop, npRelHumValue=npRelHumValue, npThermo=npThermo, npCurLoopTable=npCurLoopTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSoftReboot=npSoftReboot, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTempStatus=npRelHumTempStatus, npIoTraps=npIoTraps, npSmokeTrapStatus=npSmokeTrapStatus, npIrCtrl=npIrCtrl, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npTrapInfo=npTrapInfo, npIoTrap=npIoTrap, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTable=npRelHumTable, npIrStatus=npIrStatus, npRelHumMemo=npRelHumMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe)
