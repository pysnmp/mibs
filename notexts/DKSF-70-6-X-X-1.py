...
# Produced by pysmi-1.1.3 at Wed Dec  8 20:46:50 2021
...
ModuleIdentity, enterprises, IpAddress, Integer32, MibIdentifier, Bits, Counter32, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, TimeTicks, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "IpAddress", "Integer32", "MibIdentifier", "Bits", "Counter32", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "TimeTicks", "iso", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoSensorN=npThermoSensorN, npCurLoopN=npCurLoopN, npIr=npIr, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapLow=npThermoTrapLow, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoEntry=npIoEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoLow=npThermoLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmFailed=npGsmFailed, npGsmRegistration=npGsmRegistration, npCurLoopTrapV=npCurLoopTrapV, npReboot=npReboot, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempFail=npRelHumTrapTempFail, npIo=npIo, npThermoEntry=npThermoEntry, npRelay=npRelay, npRelHumTrapDataN=npRelHumTrapDataN, npThermoStatus=npThermoStatus, npRelayEntry=npRelayEntry, npRelayStartReset=npRelayStartReset, npIrReset=npIrReset, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopPower=npCurLoopPower, npThermoTrap=npThermoTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTable=npRelHumTable, npIoTrap=npIoTrap, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayTable=npRelayTable, npGsmTraps=npGsmTraps, npSmokeStatus=npSmokeStatus, npThermoTrapHigh=npThermoTrapHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayMemo=npRelayMemo, npRelayN=npRelayN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeTrap=npSmokeTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTable=npThermoTable, npRelayState=npRelayState, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoMemo=npIoMemo, npRelHumEntry=npRelHumEntry, npRelHumValue=npRelHumValue, npIoTable=npIoTable, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoLineN=npIoLineN, npSmokeTrapMemo=npSmokeTrapMemo, npThermoMemo=npThermoMemo, npSmokeEntry=npSmokeEntry, npForcedReboot=npForcedReboot, npCurLoopTable=npCurLoopTable, npSmokeTraps=npSmokeTraps, npCurLoop=npCurLoop, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIrCtrl=npIrCtrl, npSmokeSensorN=npSmokeSensorN, npThermoTraps=npThermoTraps, npThermoTrapMemo=npThermoTrapMemo, npRelHumStatus=npRelHumStatus, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopR=npCurLoopR, npThermoValue=npThermoValue, npThermoTrapValue=npThermoTrapValue, npSmokeTable=npSmokeTable, npRelHumidity=npRelHumidity, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmTrap=npGsmTrap, npResetStack=npResetStack, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoLevelOut=npIoLevelOut, npCurLoopTraps=npCurLoopTraps, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrap=npRelHumTrap, npCurLoopTrapI=npCurLoopTrapI, npSmoke=npSmoke, npIoTraps=npIoTraps, npRelHumTrapData=npRelHumTrapData, npTrapEmailTo=npTrapEmailTo, npIoLevelIn=npIoLevelIn, npIoPulseCounter=npIoPulseCounter, npCurLoopTrapStatus=npCurLoopTrapStatus, npSoftReboot=npSoftReboot, npIrStatus=npIrStatus, npGsmStrength=npGsmStrength, npThermoHigh=npThermoHigh, npThermo=npThermo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsm=npGsm, npRelHumMemo=npRelHumMemo, npRelHumTempValue=npRelHumTempValue, npTrapInfo=npTrapInfo, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeMemo=npSmokeMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumN=npRelHumN, npCurLoopTrapN=npCurLoopTrapN, npCurLoopStatus=npCurLoopStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTempStatus=npRelHumTempStatus, npCurLoopV=npCurLoopV, npSmokePower=npSmokePower, npSmokeReset=npSmokeReset, npIoTrapPrefix=npIoTrapPrefix, lightcom=lightcom, npCurLoopI=npCurLoopI, npCurLoopTrapR=npCurLoopTrapR, npGsmInfo=npGsmInfo, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTrapMemo=npIoTrapMemo, npRelayMode=npRelayMode, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopEntry=npCurLoopEntry, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIrPlayCmd=npIrPlayCmd, FixedPoint1000=FixedPoint1000)
