...
# Produced by pysmi-1.1.12 at Wed May 29 02:46:52 2024
...
Integer32, NotificationType, Counter64, Counter32, ObjectIdentity, ModuleIdentity, enterprises, IpAddress, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, TimeTicks, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Counter64", "Counter32", "ObjectIdentity", "ModuleIdentity", "enterprises", "IpAddress", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "TimeTicks", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopN=npCurLoopN, npRelHumidity=npRelHumidity, npThermoHigh=npThermoHigh, npIoTrapMemo=npIoTrapMemo, npCurLoopStatus=npCurLoopStatus, npCurLoopEntry=npCurLoopEntry, npGsmFailed=npGsmFailed, npTrapInfo=npTrapInfo, npRelHumEntry=npRelHumEntry, npSmokeTable=npSmokeTable, npSmokePower=npSmokePower, npIoSinglePulseStart=npIoSinglePulseStart, npIrStatus=npIrStatus, npThermoSensorN=npThermoSensorN, npSmokeTrap=npSmokeTrap, npReboot=npReboot, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapValue=npThermoTrapValue, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, FixedPoint1000=FixedPoint1000, npRelHumTrap=npRelHumTrap, npThermoTrapHigh=npThermoTrapHigh, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npTrapEmailTo=npTrapEmailTo, npCurLoopR=npCurLoopR, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelayState=npRelayState, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapSensorN=npThermoTrapSensorN, npGsmTraps=npGsmTraps, npIrCtrl=npIrCtrl, npThermoEntry=npThermoEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapLineN=npIoTrapLineN, npIoTrap=npIoTrap, npCurLoopTrap=npCurLoopTrap, npCurLoopTraps=npCurLoopTraps, npGsmTrapPrefix=npGsmTrapPrefix, lightcom=lightcom, npCurLoopI=npCurLoopI, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmRegistration=npGsmRegistration, npIoEntry=npIoEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTable=npRelHumTable, npIoTraps=npIoTraps, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIrReset=npIrReset, npCurLoopTrapV=npCurLoopTrapV, npIoMemo=npIoMemo, npRelayMemo=npRelayMemo, npSmokeStatus=npSmokeStatus, npRelayStartReset=npRelayStartReset, npRelayEntry=npRelayEntry, npGsmTrap=npGsmTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumStatus=npRelHumStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npForcedReboot=npForcedReboot, npCurLoop=npCurLoop, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTraps=npThermoTraps, npCurLoopTrapR=npCurLoopTrapR, npSmokeReset=npSmokeReset, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoLow=npThermoLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIr=npIr, npCurLoopV=npCurLoopV, npSmokeTrapStatus=npSmokeTrapStatus, npGsm=npGsm, npThermo=npThermo, npSmoke=npSmoke, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoValuePrecise=npThermoValuePrecise, npIoLineN=npIoLineN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrapPrefix=npIoTrapPrefix, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayN=npRelayN, npCurLoopTrapN=npCurLoopTrapN, npGsmInfo=npGsmInfo, npThermoTrapLow=npThermoTrapLow, npRelayTable=npRelayTable, npIo=npIo, npIoTrapLevelIn=npIoTrapLevelIn, npResetStack=npResetStack, npRelHumMemo=npRelHumMemo, npSmokeEntry=npSmokeEntry, npRelHumValue=npRelHumValue, npIoPulseCounter=npIoPulseCounter, npThermoTable=npThermoTable, npCurLoopTable=npCurLoopTable, npThermoMemo=npThermoMemo, npSoftReboot=npSoftReboot, npThermoValue=npThermoValue, npThermoTrap=npThermoTrap, npIoLevelOut=npIoLevelOut, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeSensorN=npSmokeSensorN, npIoLevelIn=npIoLevelIn, npRelayMode=npRelayMode, npCurLoopPower=npCurLoopPower, npIoTable=npIoTable, npRelHumTrapFail=npRelHumTrapFail, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTraps=npSmokeTraps, npGsmStrength=npGsmStrength, npRelay=npRelay, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoStatus=npThermoStatus, npRelHumTempValue=npRelHumTempValue, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumN=npRelHumN, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeMemo=npSmokeMemo, npRelHumTrapData=npRelHumTrapData)
