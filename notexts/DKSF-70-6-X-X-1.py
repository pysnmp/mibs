...
Integer32, TimeTicks, IpAddress, Counter32, NotificationType, ObjectIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, Unsigned32, ModuleIdentity, Counter64, MibIdentifier, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "TimeTicks", "IpAddress", "Counter32", "NotificationType", "ObjectIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "Unsigned32", "ModuleIdentity", "Counter64", "MibIdentifier", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapFail=npRelHumTrapFail, npTrapEmailTo=npTrapEmailTo, npRelayMode=npRelayMode, npCurLoopN=npCurLoopN, npCurLoopTrap=npCurLoopTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrap=npThermoTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapData=npRelHumTrapData, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmTrapPrefix=npGsmTrapPrefix, npRelayMemo=npRelayMemo, npRelayStartReset=npRelayStartReset, npIrReset=npIrReset, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrapR=npCurLoopTrapR, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopStatus=npCurLoopStatus, npIrCtrl=npIrCtrl, npRelayEntry=npRelayEntry, npCurLoopI=npCurLoopI, npRelHumTrapAllEvents=npRelHumTrapAllEvents, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsm=npGsm, npIoMemo=npIoMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoMemo=npThermoMemo, npIoTable=npIoTable, npThermoEntry=npThermoEntry, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeStatus=npSmokeStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapHigh=npThermoTrapHigh, npIr=npIr, npThermoSensorN=npThermoSensorN, npSmokeReset=npSmokeReset, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmTrap=npGsmTrap, npGsmTraps=npGsmTraps, npIoTrapPrefix=npIoTrapPrefix, lightcom=lightcom, npCurLoopTrapI=npCurLoopTrapI, npThermoTraps=npThermoTraps, npThermoStatus=npThermoStatus, npIoLevelIn=npIoLevelIn, npTrapInfo=npTrapInfo, npSoftReboot=npSoftReboot, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumidity=npRelHumidity, npSmokePower=npSmokePower, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTempValue=npRelHumTempValue, npIoPulseCounter=npIoPulseCounter, npGsmInfo=npGsmInfo, npRelayN=npRelayN, npRelHumValue=npRelHumValue, npCurLoopPower=npCurLoopPower, npSmokeEntry=npSmokeEntry, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermo=npThermo, npRelHumN=npRelHumN, npCurLoopV=npCurLoopV, npThermoTrapStatus=npThermoTrapStatus, npRelayTable=npRelayTable, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeTable=npSmokeTable, npThermoTable=npThermoTable, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTrapLineN=npIoTrapLineN, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeMemo=npSmokeMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrap=npRelHumTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoValue=npThermoValue, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoEntry=npIoEntry, npSmokeSensorN=npSmokeSensorN, npRelHumTable=npRelHumTable, npIoTrap=npIoTrap, npIoTrapMemo=npIoTrapMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npResetStack=npResetStack, npIoTraps=npIoTraps, npCurLoopEntry=npCurLoopEntry, npIoLineN=npIoLineN, npCurLoopTraps=npCurLoopTraps, npIrStatus=npIrStatus, npReboot=npReboot, npCurLoopTrapV=npCurLoopTrapV, npCurLoop=npCurLoop, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapValue=npThermoTrapValue, npRelay=npRelay, npRelHumStatus=npRelHumStatus, npGsmStrength=npGsmStrength, npThermoLow=npThermoLow, npCurLoopR=npCurLoopR, npSmoke=npSmoke, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoHigh=npThermoHigh, npSmokeTrap=npSmokeTrap, npForcedReboot=npForcedReboot, npCurLoopTable=npCurLoopTable, npGsmRegistration=npGsmRegistration, npIo=npIo, npThermoTrapPrefix=npThermoTrapPrefix, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoLevelOut=npIoLevelOut, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapLow=npThermoTrapLow, FixedPoint1000=FixedPoint1000, npSmokeTraps=npSmokeTraps, npRelayState=npRelayState, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmFailed=npGsmFailed, npThermoTrapMemo=npThermoTrapMemo, npRelHumMemo=npRelHumMemo, npRelHumEntry=npRelHumEntry, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapDataN=npRelHumTrapDataN)
