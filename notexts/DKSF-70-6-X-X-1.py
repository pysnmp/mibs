...
enterprises, NotificationType, TimeTicks, Bits, ObjectIdentity, MibIdentifier, Counter32, Unsigned32, Gauge32, IpAddress, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "TimeTicks", "Bits", "ObjectIdentity", "MibIdentifier", "Counter32", "Unsigned32", "Gauge32", "IpAddress", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIrCtrl=npIrCtrl, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopN=npCurLoopN, npCurLoopTrapR=npCurLoopTrapR, npIoTraps=npIoTraps, npThermoTraps=npThermoTraps, npCurLoopTable=npCurLoopTable, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapHigh=npThermoTrapHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapStatus=npThermoTrapStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmFailed=npGsmFailed, npThermoTrapValue=npThermoTrapValue, npCurLoopTraps=npCurLoopTraps, npIoTrapMemo=npIoTrapMemo, npTrapInfo=npTrapInfo, npCurLoopTrap=npCurLoopTrap, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopPower=npCurLoopPower, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokePower=npSmokePower, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeReset=npSmokeReset, npRelayMode=npRelayMode, npIoLevelIn=npIoLevelIn, npCurLoopTrapI=npCurLoopTrapI, npRelayEntry=npRelayEntry, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTable=npThermoTable, npIr=npIr, npCurLoopEntry=npCurLoopEntry, npRelHumTrapFail=npRelHumTrapFail, npThermoStatus=npThermoStatus, npThermoLow=npThermoLow, npIoEntry=npIoEntry, npRelayTable=npRelayTable, npRelHumStatus=npRelHumStatus, npIoTrapLineN=npIoTrapLineN, npSmokeTable=npSmokeTable, npSmokeEntry=npSmokeEntry, npGsmRegistration=npGsmRegistration, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSoftReboot=npSoftReboot, npCurLoopR=npCurLoopR, npThermoEntry=npThermoEntry, npThermoMemo=npThermoMemo, npRelHumMemo=npRelHumMemo, npIrPlayCmd=npIrPlayCmd, npRelayMemo=npRelayMemo, npRelHumTable=npRelHumTable, npGsmTrap=npGsmTrap, npRelayState=npRelayState, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoMemo=npIoMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopI=npCurLoopI, npSmokeTrap=npSmokeTrap, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTable=npIoTable, npIrReset=npIrReset, npGsmTrapPrefix=npGsmTrapPrefix, npThermoValue=npThermoValue, npThermoHigh=npThermoHigh, npCurLoopTrapV=npCurLoopTrapV, npSmokeStatus=npSmokeStatus, npReboot=npReboot, npRelHumN=npRelHumN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoop=npCurLoop, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTraps=npSmokeTraps, npGsmSendSmsUtf8=npGsmSendSmsUtf8, lightcom=lightcom, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelay=npRelay, npSmokeMemo=npSmokeMemo, npRelHumTrapData=npRelHumTrapData, npRelHumTempValue=npRelHumTempValue, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoLineN=npIoLineN, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopV=npCurLoopV, npGsmTraps=npGsmTraps, npIoTrap=npIoTrap, npIoTrapPrefix=npIoTrapPrefix, npThermoSensorN=npThermoSensorN, npSmokeSensorN=npSmokeSensorN, npIoLevelOut=npIoLevelOut, npCurLoopTrapN=npCurLoopTrapN, npCurLoopStatus=npCurLoopStatus, npRelHumEntry=npRelHumEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermo=npThermo, npIo=npIo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrap=npThermoTrap, npRelHumValue=npRelHumValue, npIoSinglePulseStart=npIoSinglePulseStart, npRelayStartReset=npRelayStartReset, npSmoke=npSmoke, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmInfo=npGsmInfo, npIrStatus=npIrStatus, npThermoValuePrecise=npThermoValuePrecise, FixedPoint1000=FixedPoint1000, npThermoTrapSensorN=npThermoTrapSensorN, npGsmStrength=npGsmStrength, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTemp=npRelHumTrapTemp, npResetStack=npResetStack, npGsm=npGsm, npRelHumTrap=npRelHumTrap, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumidity=npRelHumidity, npRelayN=npRelayN, npForcedReboot=npForcedReboot)
