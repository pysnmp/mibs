...
ModuleIdentity, TimeTicks, NotificationType, ObjectIdentity, Counter64, iso, Unsigned32, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, Bits, Counter32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "NotificationType", "ObjectIdentity", "Counter64", "iso", "Unsigned32", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "Bits", "Counter32", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTrap=npSmokeTrap, npIrPlayCmd=npIrPlayCmd, npRelHumValue=npRelHumValue, npRelHumTempValue=npRelHumTempValue, npCurLoopN=npCurLoopN, npSmokeEntry=npSmokeEntry, npThermoTrapMemo=npThermoTrapMemo, npIoLineN=npIoLineN, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTraps=npCurLoopTraps, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoHigh=npThermoHigh, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayState=npRelayState, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapDataN=npRelHumTrapDataN, npReboot=npReboot, npIoTrapMemo=npIoTrapMemo, npIr=npIr, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapPrefix=npCurLoopTrapPrefix, lightcom=lightcom, npRelHumEntry=npRelHumEntry, npSmokeReset=npSmokeReset, npRelayEntry=npRelayEntry, npIoEntry=npIoEntry, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapData=npRelHumTrapData, npCurLoopTrap=npCurLoopTrap, npRelayN=npRelayN, npGsmFailed=npGsmFailed, npRelHumN=npRelHumN, npRelHumTempStatus=npRelHumTempStatus, npThermoStatus=npThermoStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumidity=npRelHumidity, npThermoEntry=npThermoEntry, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeSensorN=npSmokeSensorN, npSmokeStatus=npSmokeStatus, npRelayMemo=npRelayMemo, npCurLoopTrapR=npCurLoopTrapR, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermo=npThermo, npCurLoopI=npCurLoopI, npThermoTraps=npThermoTraps, npGsmTrap=npGsmTrap, npCurLoopPower=npCurLoopPower, npRelayMode=npRelayMode, npIrReset=npIrReset, npCurLoopTrapV=npCurLoopTrapV, npRelHumMemo=npRelHumMemo, npIoTrap=npIoTrap, npSmoke=npSmoke, npResetStack=npResetStack, npSmokeTable=npSmokeTable, npThermoTrapHigh=npThermoTrapHigh, npGsmInfo=npGsmInfo, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoMemo=npThermoMemo, npTrapEmailTo=npTrapEmailTo, npSmokeTrapStatus=npSmokeTrapStatus, npThermoValue=npThermoValue, npForcedReboot=npForcedReboot, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeTraps=npSmokeTraps, npRelHumTrapDataValue=npRelHumTrapDataValue, npIrStatus=npIrStatus, npThermoTrapStatus=npThermoTrapStatus, npIo=npIo, npCurLoopV=npCurLoopV, npThermoSensorN=npThermoSensorN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoMemo=npIoMemo, npThermoTrapValue=npThermoTrapValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsm=npGsm, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoValuePrecise=npThermoValuePrecise, npThermoTrap=npThermoTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopEntry=npCurLoopEntry, npThermoTable=npThermoTable, npCurLoopTable=npCurLoopTable, npTrapInfo=npTrapInfo, npRelHumStatus=npRelHumStatus, npIoTable=npIoTable, npIoTrapLineN=npIoTrapLineN, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopR=npCurLoopR, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapFail=npRelHumTrapFail, npThermoLow=npThermoLow, npRelHumTable=npRelHumTable, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrap=npRelHumTrap, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapPrefix=npIoTrapPrefix, npSmokeMemo=npSmokeMemo, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npIrCtrl=npIrCtrl, npIoPulseCounter=npIoPulseCounter, npGsmStrength=npGsmStrength, npRelHumTrapDataMemo=npRelHumTrapDataMemo, FixedPoint1000=FixedPoint1000, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelay=npRelay, npSmokePower=npSmokePower, npIoLevelIn=npIoLevelIn, npIoTrapLevelIn=npIoTrapLevelIn, npGsmTraps=npGsmTraps, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoLevelOut=npIoLevelOut, npGsmRegistration=npGsmRegistration, npCurLoopStatus=npCurLoopStatus, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayTable=npRelayTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayStartReset=npRelayStartReset, npSoftReboot=npSoftReboot, npIoTraps=npIoTraps, npCurLoop=npCurLoop)
