...
# Produced by pysmi-1.1.8 at Fri Jan  7 01:16:31 2022
...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32, Integer32, Counter64, IpAddress, iso, Bits, NotificationType, enterprises, Gauge32, TimeTicks, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32", "Integer32", "Counter64", "IpAddress", "iso", "Bits", "NotificationType", "enterprises", "Gauge32", "TimeTicks", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayState=npRelayState, npSmokeTrapStatus=npSmokeTrapStatus, npGsmTraps=npGsmTraps, npRelay=npRelay, lightcom=lightcom, npRelayMemo=npRelayMemo, npRelayStartReset=npRelayStartReset, npRelHumTrapDataN=npRelHumTrapDataN, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapPrefix=npIoTrapPrefix, npForcedReboot=npForcedReboot, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopN=npCurLoopN, npSmokeStatus=npSmokeStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTable=npThermoTable, npIoEntry=npIoEntry, npRelHumMemo=npRelHumMemo, npIoPulseCounter=npIoPulseCounter, npSmokeEntry=npSmokeEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTrapLineN=npIoTrapLineN, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopR=npCurLoopR, npTrapEmailTo=npTrapEmailTo, npIrPlayCmd=npIrPlayCmd, npIrReset=npIrReset, npSmokeSensorN=npSmokeSensorN, npReboot=npReboot, npThermoTrapLow=npThermoTrapLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapPower=npCurLoopTrapPower, npSmokePower=npSmokePower, npGsmFailed=npGsmFailed, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrap=npRelHumTrap, npIoTrapMemo=npIoTrapMemo, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrap=npCurLoopTrap, npThermoLow=npThermoLow, npSmoke=npSmoke, npCurLoopV=npCurLoopV, npCurLoopTable=npCurLoopTable, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeMemo=npSmokeMemo, npIr=npIr, npRelHumTrapData=npRelHumTrapData, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIo=npIo, npThermoEntry=npThermoEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrap=npThermoTrap, npResetStack=npResetStack, npGsmInfo=npGsmInfo, npSoftReboot=npSoftReboot, npIoLineN=npIoLineN, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoop=npCurLoop, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrap=npSmokeTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsm=npGsm, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopEntry=npCurLoopEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTable=npSmokeTable, npRelHumStatus=npRelHumStatus, npThermoSensorN=npThermoSensorN, FixedPoint1000=FixedPoint1000, npThermo=npThermo, npCurLoopI=npCurLoopI, npThermoHigh=npThermoHigh, npIoTrap=npIoTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrStatus=npIrStatus, npRelHumTempStatus=npRelHumTempStatus, npThermoMemo=npThermoMemo, npSmokeTraps=npSmokeTraps, npIoTraps=npIoTraps, npRelHumEntry=npRelHumEntry, npRelHumValue=npRelHumValue, npIoMemo=npIoMemo, npRelHumN=npRelHumN, npThermoStatus=npThermoStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTraps=npCurLoopTraps, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoLevelOut=npIoLevelOut, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmStrength=npGsmStrength, npRelayMode=npRelayMode, npCurLoopStatus=npCurLoopStatus, npRelHumTable=npRelHumTable, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapV=npCurLoopTrapV, npThermoValue=npThermoValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumidity=npRelHumidity, npRelayEntry=npRelayEntry, npIoTable=npIoTable, npCurLoopTrapI=npCurLoopTrapI, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoValuePrecise=npThermoValuePrecise, npGsmTrap=npGsmTrap, npThermoTraps=npThermoTraps, npRelayTable=npRelayTable, npIrCtrl=npIrCtrl, npGsmRegistration=npGsmRegistration, npSmokeReset=npSmokeReset, npSmokeTrapMemo=npSmokeTrapMemo, npTrapInfo=npTrapInfo, npThermoTrapMemo=npThermoTrapMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npIoLevelIn=npIoLevelIn, npCurLoopPower=npCurLoopPower, npThermoTrapValue=npThermoTrapValue, npRelayN=npRelayN)
