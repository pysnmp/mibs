...
TimeTicks, Counter64, Integer32, Bits, IpAddress, Gauge32, MibIdentifier, ObjectIdentity, Unsigned32, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "Integer32", "Bits", "IpAddress", "Gauge32", "MibIdentifier", "ObjectIdentity", "Unsigned32", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTraps=npCurLoopTraps, npSmokePower=npSmokePower, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIrPlayCmd=npIrPlayCmd, npSmokeEntry=npSmokeEntry, npTrapInfo=npTrapInfo, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmRegistration=npGsmRegistration, npCurLoop=npCurLoop, npCurLoopN=npCurLoopN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeSensorN=npSmokeSensorN, npSoftReboot=npSoftReboot, npSmokeMemo=npSmokeMemo, npThermoTrapMemo=npThermoTrapMemo, npRelayMemo=npRelayMemo, npSmokeTable=npSmokeTable, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTable=npIoTable, npIo=npIo, npResetStack=npResetStack, npThermoHigh=npThermoHigh, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayN=npRelayN, npGsmTraps=npGsmTraps, npThermoTrapStatus=npThermoTrapStatus, npIoEntry=npIoEntry, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapSafe=npRelHumTrapSafe, npRelay=npRelay, npCurLoopTrap=npCurLoopTrap, npGsmInfo=npGsmInfo, npRelHumTempValue=npRelHumTempValue, npThermoSensorN=npThermoSensorN, npRelHumTempStatus=npRelHumTempStatus, npIoLevelIn=npIoLevelIn, npThermoEntry=npThermoEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayMode=npRelayMode, npGsmStrength=npGsmStrength, npRelHumEntry=npRelHumEntry, npGsmFailed=npGsmFailed, npIrCtrl=npIrCtrl, npIoMemo=npIoMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumStatus=npRelHumStatus, npIoTrapLineN=npIoTrapLineN, npRelHumidity=npRelHumidity, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoLevelOut=npIoLevelOut, npIoPulseCounter=npIoPulseCounter, npGsm=npGsm, npCurLoopTrapR=npCurLoopTrapR, npCurLoopPower=npCurLoopPower, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoStatus=npThermoStatus, npIrReset=npIrReset, npRelHumTrapData=npRelHumTrapData, npGsmTrap=npGsmTrap, npReboot=npReboot, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapPower=npCurLoopTrapPower, npThermoMemo=npThermoMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapValue=npThermoTrapValue, npRelayEntry=npRelayEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTraps=npThermoTraps, npIoTraps=npIoTraps, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npTrapEmailTo=npTrapEmailTo, npSmokeTrap=npSmokeTrap, npForcedReboot=npForcedReboot, npCurLoopTrapV=npCurLoopTrapV, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumValue=npRelHumValue, npCurLoopV=npCurLoopV, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrap=npThermoTrap, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTraps=npSmokeTraps, npCurLoopI=npCurLoopI, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoLineN=npIoLineN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoLow=npThermoLow, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapN=npCurLoopTrapN, npCurLoopR=npCurLoopR, npRelHumTable=npRelHumTable, npThermo=npThermo, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapMemo=npIoTrapMemo, lightcom=lightcom, npCurLoopTable=npCurLoopTable, npSmokeReset=npSmokeReset, npRelHumTrapTemp=npRelHumTrapTemp, npIrStatus=npIrStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopEntry=npCurLoopEntry, npCurLoopStatus=npCurLoopStatus, npSmokeStatus=npSmokeStatus, npIr=npIr, npThermoTable=npThermoTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapLow=npThermoTrapLow, npThermoValue=npThermoValue, npSmoke=npSmoke, npRelayTable=npRelayTable, npRelHumN=npRelHumN, FixedPoint1000=FixedPoint1000, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrap=npRelHumTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapFail=npRelHumTrapFail, npRelayStartReset=npRelayStartReset, npRelayState=npRelayState, npRelHumMemo=npRelHumMemo, npIoTrap=npIoTrap)
