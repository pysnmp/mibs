...
MibIdentifier, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, ObjectIdentity, Unsigned32, IpAddress, ModuleIdentity, Counter32, enterprises, Counter64, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "ObjectIdentity", "Unsigned32", "IpAddress", "ModuleIdentity", "Counter32", "enterprises", "Counter64", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmTrap=npGsmTrap, npCurLoopI=npCurLoopI, npSmokeTraps=npSmokeTraps, npThermoStatus=npThermoStatus, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrap=npRelHumTrap, npThermoEntry=npThermoEntry, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopStatus=npCurLoopStatus, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeReset=npSmokeReset, npIrReset=npIrReset, npRelHumStatus=npRelHumStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayEntry=npRelayEntry, npSmokeStatus=npSmokeStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataValue=npRelHumTrapDataValue, FixedPoint1000=FixedPoint1000, npRelay=npRelay, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTempStatus=npRelHumTempStatus, npGsmStrength=npGsmStrength, npCurLoopTrapV=npCurLoopTrapV, npSmokeTable=npSmokeTable, npGsmRegistration=npGsmRegistration, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermo=npThermo, npIoLevelIn=npIoLevelIn, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumMemo=npRelHumMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayTable=npRelayTable, npRelHumTable=npRelHumTable, npRelayStartReset=npRelayStartReset, npCurLoopTrapI=npCurLoopTrapI, npForcedReboot=npForcedReboot, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapValue=npThermoTrapValue, npIr=npIr, npRelHumTrapData=npRelHumTrapData, npRelHumTempValue=npRelHumTempValue, npRelayN=npRelayN, npRelHumValue=npRelHumValue, npSmoke=npSmoke, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayState=npRelayState, npGsmTrapPrefix=npGsmTrapPrefix, npSmokePower=npSmokePower, npIoTable=npIoTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmTraps=npGsmTraps, npRelayMode=npRelayMode, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapSensorN=npThermoTrapSensorN, npIoEntry=npIoEntry, npThermoTrapMemo=npThermoTrapMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrap=npIoTrap, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTrap=npSmokeTrap, npCurLoopTrap=npCurLoopTrap, lightcom=lightcom, npRelayMemo=npRelayMemo, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeEntry=npSmokeEntry, npIrCtrl=npIrCtrl, npGsmInfo=npGsmInfo, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapN=npCurLoopTrapN, npCurLoopEntry=npCurLoopEntry, npReboot=npReboot, npCurLoopV=npCurLoopV, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npTrapInfo=npTrapInfo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumN=npRelHumN, npThermoMemo=npThermoMemo, npRelHumidity=npRelHumidity, npCurLoopR=npCurLoopR, npThermoTrapHigh=npThermoTrapHigh, npThermoSensorN=npThermoSensorN, npIoTraps=npIoTraps, npGsmFailed=npGsmFailed, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapFail=npRelHumTrapFail, npIoMemo=npIoMemo, npThermoTrapLow=npThermoTrapLow, npIoLineN=npIoLineN, npIo=npIo, npIoLevelOut=npIoLevelOut, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapLevelIn=npIoTrapLevelIn, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTraps=npCurLoopTraps, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSoftReboot=npSoftReboot, npThermoHigh=npThermoHigh, npRelHumEntry=npRelHumEntry, npThermoTable=npThermoTable, npCurLoopPower=npCurLoopPower, npIrStatus=npIrStatus, npThermoTraps=npThermoTraps, npIoPulseCounter=npIoPulseCounter, npCurLoopN=npCurLoopN, npThermoValue=npThermoValue, npResetStack=npResetStack, npThermoTrap=npThermoTrap, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTable=npCurLoopTable, npThermoLow=npThermoLow, npCurLoop=npCurLoop, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsm=npGsm, npIoTrapLineN=npIoTrapLineN, npSmokeMemo=npSmokeMemo, npRelHumTrapDataN=npRelHumTrapDataN, npIoTrapMemo=npIoTrapMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow)
