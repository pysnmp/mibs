...
# Produced by pysmi-1.1.8 at Mon Jan  9 14:18:50 2023
...
Counter32, NotificationType, Bits, IpAddress, MibIdentifier, Counter64, Unsigned32, Integer32, ModuleIdentity, enterprises, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "Bits", "IpAddress", "MibIdentifier", "Counter64", "Unsigned32", "Integer32", "ModuleIdentity", "enterprises", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", FixedPoint1000=FixedPoint1000, npThermoLow=npThermoLow, npIoLineN=npIoLineN, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoPulseCounter=npIoPulseCounter, npCurLoopR=npCurLoopR, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrap=npCurLoopTrap, npSmokeSensorN=npSmokeSensorN, npThermoTrapHigh=npThermoTrapHigh, npRelay=npRelay, npIoTrapLineN=npIoTrapLineN, npThermoTrap=npThermoTrap, npRelHumTrap=npRelHumTrap, npSmokeEntry=npSmokeEntry, npCurLoopTrapN=npCurLoopTrapN, npThermoValuePrecise=npThermoValuePrecise, uniPingServerSolutionV3=uniPingServerSolutionV3, npTrapInfo=npTrapInfo, npRelHumTempValue=npRelHumTempValue, npIrStatus=npIrStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoLevelIn=npIoLevelIn, npSmokeTraps=npSmokeTraps, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumMemo=npRelHumMemo, npIoTraps=npIoTraps, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTable=npIoTable, npCurLoopEntry=npCurLoopEntry, npIr=npIr, npCurLoopTable=npCurLoopTable, npIoTrap=npIoTrap, npTrapEmailTo=npTrapEmailTo, npRelayState=npRelayState, npRelayEntry=npRelayEntry, npRelHumN=npRelHumN, npGsmFailed=npGsmFailed, npRelayMemo=npRelayMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumidity=npRelHumidity, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIo=npIo, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapMemo=npThermoTrapMemo, npRelayTable=npRelayTable, npIrCtrl=npIrCtrl, npResetStack=npResetStack, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapValue=npThermoTrapValue, npSmokeTable=npSmokeTable, npCurLoopStatus=npCurLoopStatus, npCurLoopI=npCurLoopI, npThermoStatus=npThermoStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayStartReset=npRelayStartReset, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmoke=npSmoke, npCurLoop=npCurLoop, npCurLoopN=npCurLoopN, npIrPlayCmd=npIrPlayCmd, npForcedReboot=npForcedReboot, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapV=npCurLoopTrapV, npRelHumTable=npRelHumTable, npIoLevelOut=npIoLevelOut, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapLow=npThermoTrapLow, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapData=npRelHumTrapData, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoEntry=npIoEntry, npThermoValue=npThermoValue, npCurLoopV=npCurLoopV, npThermoSensorN=npThermoSensorN, npCurLoopPower=npCurLoopPower, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTemp=npRelHumTrapTemp, npGsm=npGsm, npRelHumTempStatus=npRelHumTempStatus, npGsmTraps=npGsmTraps, npIoMemo=npIoMemo, npCurLoopTrapPower=npCurLoopTrapPower, npGsmRegistration=npGsmRegistration, npCurLoopTrapI=npCurLoopTrapI, npRelHumStatus=npRelHumStatus, npThermo=npThermo, npSmokeTrap=npSmokeTrap, npGsmTrap=npGsmTrap, npSoftReboot=npSoftReboot, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrapMemo=npIoTrapMemo, npThermoMemo=npThermoMemo, npRelayN=npRelayN, npSmokePower=npSmokePower, npGsmInfo=npGsmInfo, npThermoTable=npThermoTable, npSmokeStatus=npSmokeStatus, npRelHumTrapDataN=npRelHumTrapDataN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeMemo=npSmokeMemo, npSmokeReset=npSmokeReset, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayMode=npRelayMode, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumEntry=npRelHumEntry, npThermoEntry=npThermoEntry, npThermoTrapSensorN=npThermoTrapSensorN, lightcom=lightcom, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTrapSensorN=npSmokeTrapSensorN, npIrReset=npIrReset, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoHigh=npThermoHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmStrength=npGsmStrength, npRelHumValue=npRelHumValue, npReboot=npReboot, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTraps=npThermoTraps)
