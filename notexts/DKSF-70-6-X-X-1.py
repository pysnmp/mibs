...
# Produced by pysmi-1.1.3 at Mon Nov 22 12:16:00 2021
...
Unsigned32, NotificationType, ObjectIdentity, MibIdentifier, Counter64, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, enterprises, Counter32, ModuleIdentity, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "ObjectIdentity", "MibIdentifier", "Counter64", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "enterprises", "Counter32", "ModuleIdentity", "Gauge32", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTraps=npThermoTraps, npSmokeStatus=npSmokeStatus, npGsmTraps=npGsmTraps, npSmokeMemo=npSmokeMemo, npCurLoopR=npCurLoopR, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTable=npThermoTable, npTrapEmailTo=npTrapEmailTo, npSmokeSensorN=npSmokeSensorN, npThermoTrap=npThermoTrap, npIoTraps=npIoTraps, npCurLoop=npCurLoop, npGsmTrap=npGsmTrap, npGsmTrapPrefix=npGsmTrapPrefix, npThermoMemo=npThermoMemo, npCurLoopTraps=npCurLoopTraps, npRelayN=npRelayN, npRelHumStatus=npRelHumStatus, npIoTrapLevelIn=npIoTrapLevelIn, npThermoStatus=npThermoStatus, npCurLoopStatus=npCurLoopStatus, npGsmRegistration=npGsmRegistration, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTable=npSmokeTable, npRelHumMemo=npRelHumMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopI=npCurLoopI, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapMemo=npThermoTrapMemo, npRelHumTempValue=npRelHumTempValue, npRelHumTrap=npRelHumTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoHigh=npThermoHigh, npTrapInfo=npTrapInfo, npIrPlayCmd=npIrPlayCmd, npIoLevelOut=npIoLevelOut, npRelay=npRelay, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapPrefix=npThermoTrapPrefix, npIr=npIr, npThermoValue=npThermoValue, npRelHumidity=npRelHumidity, npCurLoopN=npCurLoopN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrapMemo=npIoTrapMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapStatus=npThermoTrapStatus, npRelayState=npRelayState, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelayTable=npRelayTable, npRelayMode=npRelayMode, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTempStatus=npRelHumTempStatus, npIrCtrl=npIrCtrl, npRelHumValue=npRelHumValue, npCurLoopTrap=npCurLoopTrap, npGsmInfo=npGsmInfo, npRelayEntry=npRelayEntry, npGsmStrength=npGsmStrength, npForcedReboot=npForcedReboot, npIrStatus=npIrStatus, npThermoLow=npThermoLow, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTable=npRelHumTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapValue=npThermoTrapValue, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrap=npSmokeTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopV=npCurLoopV, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npReboot=npReboot, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumN=npRelHumN, npIrReset=npIrReset, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoEntry=npThermoEntry, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTrapStatus=npSmokeTrapStatus, npSmoke=npSmoke, npThermoTrapLow=npThermoTrapLow, npRelHumTrapData=npRelHumTrapData, npIoTrap=npIoTrap, npSmokeTraps=npSmokeTraps, lightcom=lightcom, npCurLoopTable=npCurLoopTable, npThermoTrapSensorN=npThermoTrapSensorN, npGsm=npGsm, npIoLineN=npIoLineN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTrapLineN=npIoTrapLineN, npRelayMemo=npRelayMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoPulseCounter=npIoPulseCounter, npGsmFailed=npGsmFailed, npSmokeEntry=npSmokeEntry, npRelHumEntry=npRelHumEntry, npIoEntry=npIoEntry, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapPower=npCurLoopTrapPower, npRelayStartReset=npRelayStartReset, npIo=npIo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopPower=npCurLoopPower, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSoftReboot=npSoftReboot, npIoMemo=npIoMemo, npIoTable=npIoTable, npRelHumTrapDataN=npRelHumTrapDataN, npThermoValuePrecise=npThermoValuePrecise, npThermo=npThermo, npThermoSensorN=npThermoSensorN, npSmokeReset=npSmokeReset, FixedPoint1000=FixedPoint1000, npResetStack=npResetStack, npIoLevelIn=npIoLevelIn, npCurLoopTrapI=npCurLoopTrapI, npSmokePower=npSmokePower, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopEntry=npCurLoopEntry, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh)
