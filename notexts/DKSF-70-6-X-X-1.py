...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumN=npRelHumN, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeSensorN=npSmokeSensorN, npCurLoopTrapV=npCurLoopTrapV, npThermoEntry=npThermoEntry, npRelHumTempStatus=npRelHumTempStatus, npIoTrapLineN=npIoTrapLineN, npSmoke=npSmoke, npIoMemo=npIoMemo, npSmokeMemo=npSmokeMemo, npRelayTable=npRelayTable, npIoSinglePulseDuration=npIoSinglePulseDuration, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTraps=npIoTraps, npCurLoopI=npCurLoopI, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayMemo=npRelayMemo, npCurLoop=npCurLoop, npRelHumValue=npRelHumValue, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapMemo=npThermoTrapMemo, npGsmFailed=npGsmFailed, npGsm=npGsm, npRelay=npRelay, npSmokeTrapStatus=npSmokeTrapStatus, npRelayN=npRelayN, npRelHumTrap=npRelHumTrap, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTraps=npThermoTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmTraps=npGsmTraps, npCurLoopR=npCurLoopR, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIr=npIr, npIrStatus=npIrStatus, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelayMode=npRelayMode, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapI=npCurLoopTrapI, npIoLevelIn=npIoLevelIn, npCurLoopTrapPower=npCurLoopTrapPower, npRelayEntry=npRelayEntry, npCurLoopTraps=npCurLoopTraps, npCurLoopN=npCurLoopN, npIoTable=npIoTable, npIoTrapMemo=npIoTrapMemo, npThermoTrapLow=npThermoTrapLow, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopEntry=npCurLoopEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrap=npThermoTrap, npRelHumidity=npRelHumidity, npCurLoopStatus=npCurLoopStatus, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoLow=npThermoLow, npSmokeTrap=npSmokeTrap, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapN=npCurLoopTrapN, npSmokeTraps=npSmokeTraps, npSmokeEntry=npSmokeEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTable=npThermoTable, npIoTrap=npIoTrap, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeStatus=npSmokeStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmInfo=npGsmInfo, npCurLoopTrap=npCurLoopTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempValue=npRelHumTempValue, npRelHumEntry=npRelHumEntry, npCurLoopV=npCurLoopV, npIoLineN=npIoLineN, npCurLoopTable=npCurLoopTable, npIoLevelOut=npIoLevelOut, npThermo=npThermo, npThermoHigh=npThermoHigh, npSoftReboot=npSoftReboot, npThermoValue=npThermoValue, npIrReset=npIrReset, npGsmRegistration=npGsmRegistration, npSmokeReset=npSmokeReset, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapHigh=npThermoTrapHigh, npSmokePower=npSmokePower, npThermoMemo=npThermoMemo, npSmokeTable=npSmokeTable, npTrapEmailTo=npTrapEmailTo, npCurLoopPower=npCurLoopPower, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIrCtrl=npIrCtrl, lightcom=lightcom, npRelayState=npRelayState, npGsmStrength=npGsmStrength, npRelHumStatus=npRelHumStatus, npThermoSensorN=npThermoSensorN, npRelHumTrapData=npRelHumTrapData, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayStartReset=npRelayStartReset, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIo=npIo, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTable=npRelHumTable, npCurLoopTrapR=npCurLoopTrapR, npTrapInfo=npTrapInfo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoPulseCounter=npIoPulseCounter, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapFail=npRelHumTrapFail, npRelHumMemo=npRelHumMemo, npThermoTrapStatus=npThermoTrapStatus, npIoEntry=npIoEntry, npGsmTrapPrefix=npGsmTrapPrefix, npReboot=npReboot, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npForcedReboot=npForcedReboot, npGsmTrap=npGsmTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoStatus=npThermoStatus, npThermoTrapValue=npThermoTrapValue, FixedPoint1000=FixedPoint1000, npResetStack=npResetStack, npCurLoopTrapStatus=npCurLoopTrapStatus)
