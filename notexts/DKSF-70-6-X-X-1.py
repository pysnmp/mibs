...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoLineN=npIoLineN, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapR=npCurLoopTrapR, npIoLevelOut=npIoLevelOut, npTrapInfo=npTrapInfo, npGsmFailed=npGsmFailed, npGsmInfo=npGsmInfo, npThermo=npThermo, npRelayState=npRelayState, npRelHumTrapSafe=npRelHumTrapSafe, npIoTable=npIoTable, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTable=npRelHumTable, npRelayMode=npRelayMode, npRelHumidity=npRelHumidity, npCurLoopTrapN=npCurLoopTrapN, npIoTrap=npIoTrap, npIrReset=npIrReset, npThermoTraps=npThermoTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTempStatus=npRelHumTempStatus, npCurLoopPower=npCurLoopPower, npSmokeReset=npSmokeReset, npReboot=npReboot, npResetStack=npResetStack, npIoMemo=npIoMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapHigh=npThermoTrapHigh, npIoLevelIn=npIoLevelIn, npIoTrapMemo=npIoTrapMemo, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeSensorN=npSmokeSensorN, npGsmTrap=npGsmTrap, npIoTrapPrefix=npIoTrapPrefix, npTrapEmailTo=npTrapEmailTo, npGsm=npGsm, npRelayTable=npRelayTable, npCurLoop=npCurLoop, npIoTraps=npIoTraps, npCurLoopTraps=npCurLoopTraps, npCurLoopEntry=npCurLoopEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapFail=npRelHumTrapFail, npSmokeTrapMemo=npSmokeTrapMemo, npRelayMemo=npRelayMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapDataN=npRelHumTrapDataN, lightcom=lightcom, npThermoValue=npThermoValue, npRelayN=npRelayN, npRelayEntry=npRelayEntry, npCurLoopV=npCurLoopV, npRelay=npRelay, npThermoTrapStatus=npThermoTrapStatus, npSmokeTraps=npSmokeTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopI=npCurLoopI, npThermoTable=npThermoTable, npCurLoopTrapI=npCurLoopTrapI, npThermoTrap=npThermoTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopR=npCurLoopR, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapData=npRelHumTrapData, npThermoValuePrecise=npThermoValuePrecise, npRelHumN=npRelHumN, npThermoHigh=npThermoHigh, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopN=npCurLoopN, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeEntry=npSmokeEntry, npForcedReboot=npForcedReboot, npIo=npIo, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrap=npCurLoopTrap, npCurLoopStatus=npCurLoopStatus, npSmoke=npSmoke, npIrCtrl=npIrCtrl, npRelHumTrap=npRelHumTrap, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeTable=npSmokeTable, npThermoEntry=npThermoEntry, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmRegistration=npGsmRegistration, npCurLoopTable=npCurLoopTable, npGsmTraps=npGsmTraps, npThermoTrapSensorN=npThermoTrapSensorN, npIoPulseCounter=npIoPulseCounter, npIrStatus=npIrStatus, npRelHumEntry=npRelHumEntry, npIrPlayCmd=npIrPlayCmd, npRelHumValue=npRelHumValue, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIr=npIr, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapLineN=npIoTrapLineN, npSmokeTrapStatus=npSmokeTrapStatus, npRelayStartReset=npRelayStartReset, npCurLoopTrapV=npCurLoopTrapV, npGsmStrength=npGsmStrength, FixedPoint1000=FixedPoint1000, npThermoTrapValue=npThermoTrapValue, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapPower=npCurLoopTrapPower, npThermoSensorN=npThermoSensorN, npThermoMemo=npThermoMemo, npRelHumTempValue=npRelHumTempValue, npThermoStatus=npThermoStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokePower=npSmokePower, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeStatus=npSmokeStatus, npSmokeMemo=npSmokeMemo, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSoftReboot=npSoftReboot, npRelHumMemo=npRelHumMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoEntry=npIoEntry, npSmokeTrap=npSmokeTrap, npThermoLow=npThermoLow, npRelHumStatus=npRelHumStatus)
