...
ModuleIdentity, Bits, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, MibIdentifier, ObjectIdentity, enterprises, TimeTicks, Integer32, Unsigned32, Counter64, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "MibIdentifier", "ObjectIdentity", "enterprises", "TimeTicks", "Integer32", "Unsigned32", "Counter64", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIrStatus=npIrStatus, npRelayN=npRelayN, npIoMemo=npIoMemo, npSmokeTable=npSmokeTable, npGsmRegistration=npGsmRegistration, npCurLoopTrap=npCurLoopTrap, npSmoke=npSmoke, npThermoTrapMemo=npThermoTrapMemo, npRelHumEntry=npRelHumEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrPlayCmd=npIrPlayCmd, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrap=npIoTrap, npCurLoopPower=npCurLoopPower, npIoTrapMemo=npIoTrapMemo, npThermoTrapHigh=npThermoTrapHigh, npRelHumTempValue=npRelHumTempValue, npSmokeStatus=npSmokeStatus, npForcedReboot=npForcedReboot, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapData=npRelHumTrapData, npIoPulseCounter=npIoPulseCounter, npRelay=npRelay, npIoSinglePulseStart=npIoSinglePulseStart, npRelayEntry=npRelayEntry, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeMemo=npSmokeMemo, npCurLoopEntry=npCurLoopEntry, npIrCtrl=npIrCtrl, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopI=npCurLoopI, npThermoTrap=npThermoTrap, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopN=npCurLoopN, npReboot=npReboot, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTable=npCurLoopTable, npSmokeTrapMemo=npSmokeTrapMemo, npThermo=npThermo, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapR=npCurLoopTrapR, npThermoHigh=npThermoHigh, npIoTrapPrefix=npIoTrapPrefix, npRelHumValue=npRelHumValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTraps=npSmokeTraps, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapFail=npRelHumTrapFail, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoValue=npThermoValue, npCurLoopV=npCurLoopV, npIoTrapLineN=npIoTrapLineN, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoStatus=npThermoStatus, npThermoTrapSensorN=npThermoTrapSensorN, npThermoLow=npThermoLow, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrap=npRelHumTrap, npCurLoopR=npCurLoopR, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmTraps=npGsmTraps, npGsmTrap=npGsmTrap, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoEntry=npIoEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTrap=npSmokeTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTraps=npThermoTraps, npSmokePower=npSmokePower, npCurLoop=npCurLoop, npRelHumStatus=npRelHumStatus, npThermoTrapPrefix=npThermoTrapPrefix, npGsmTrapPrefix=npGsmTrapPrefix, npGsmStrength=npGsmStrength, npTrapEmailTo=npTrapEmailTo, npCurLoopTraps=npCurLoopTraps, npThermoTrapStatus=npThermoTrapStatus, npRelHumMemo=npRelHumMemo, npRelHumTempStatus=npRelHumTempStatus, npResetStack=npResetStack, lightcom=lightcom, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoSensorN=npThermoSensorN, npGsm=npGsm, npIo=npIo, npIoLineN=npIoLineN, npIoLevelIn=npIoLevelIn, npIoLevelOut=npIoLevelOut, npTrapInfo=npTrapInfo, npThermoTable=npThermoTable, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, PYSNMP_MODULE_ID=uniPingServerSolutionV3, FixedPoint1000=FixedPoint1000, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapLow=npThermoTrapLow, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeEntry=npSmokeEntry, npGsmInfo=npGsmInfo, npIoTable=npIoTable, npIrReset=npIrReset, npRelayMode=npRelayMode, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIr=npIr, npRelHumidity=npRelHumidity, npGsmFailed=npGsmFailed, npIoTraps=npIoTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoEntry=npThermoEntry, npThermoValuePrecise=npThermoValuePrecise, npSoftReboot=npSoftReboot, npRelayState=npRelayState, npRelHumTrapDataN=npRelHumTrapDataN, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTrapStatus=npSmokeTrapStatus, npRelayStartReset=npRelayStartReset, npCurLoopTrapI=npCurLoopTrapI, npThermoMemo=npThermoMemo, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelayMemo=npRelayMemo, npRelHumTable=npRelHumTable, npRelHumN=npRelHumN, npSmokeReset=npSmokeReset, npRelayTable=npRelayTable)
