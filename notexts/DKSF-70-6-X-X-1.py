...
# Produced by pysmi-1.1.8 at Wed Sep  6 13:35:18 2023
...
NotificationType, ModuleIdentity, iso, Gauge32, Counter32, IpAddress, Bits, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, ObjectIdentity, TimeTicks, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "iso", "Gauge32", "Counter32", "IpAddress", "Bits", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "ObjectIdentity", "TimeTicks", "Counter64", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopV=npCurLoopV, npRelHumidity=npRelHumidity, npCurLoopTrapV=npCurLoopTrapV, npRelHumValue=npRelHumValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumN=npRelHumN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoEntry=npIoEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoMemo=npIoMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTraps=npSmokeTraps, npCurLoopR=npCurLoopR, npForcedReboot=npForcedReboot, npRelayStartReset=npRelayStartReset, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapMemo=npThermoTrapMemo, npThermoTraps=npThermoTraps, npGsmFailed=npGsmFailed, npThermo=npThermo, npSmokeStatus=npSmokeStatus, npTrapEmailTo=npTrapEmailTo, npIoLineN=npIoLineN, npSmokeReset=npSmokeReset, npRelHumTable=npRelHumTable, npCurLoopPower=npCurLoopPower, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayMemo=npRelayMemo, npIoTrapLevelIn=npIoTrapLevelIn, npIrCtrl=npIrCtrl, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoMemo=npThermoMemo, npIoTable=npIoTable, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, lightcom=lightcom, npThermoStatus=npThermoStatus, npThermoTrap=npThermoTrap, npCurLoopEntry=npCurLoopEntry, npCurLoopTraps=npCurLoopTraps, npThermoTable=npThermoTable, npThermoTrapLow=npThermoTrapLow, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapSensorN=npThermoTrapSensorN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npTrapInfo=npTrapInfo, npIoLevelOut=npIoLevelOut, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTrap=npSmokeTrap, npGsmInfo=npGsmInfo, npIrStatus=npIrStatus, npRelHumEntry=npRelHumEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmTraps=npGsmTraps, npThermoValue=npThermoValue, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoPulseCounter=npIoPulseCounter, npGsm=npGsm, npThermoTrapHigh=npThermoTrapHigh, npIoTrapMemo=npIoTrapMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeEntry=npSmokeEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayTable=npRelayTable, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoEntry=npThermoEntry, npThermoTrapValue=npThermoTrapValue, npThermoSensorN=npThermoSensorN, npRelHumTrapFail=npRelHumTrapFail, npCurLoop=npCurLoop, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmoke=npSmoke, npSmokeMemo=npSmokeMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopI=npCurLoopI, npIrReset=npIrReset, npIoTrapPrefix=npIoTrapPrefix, npIoLevelIn=npIoLevelIn, npIoTraps=npIoTraps, npRelHumTempStatus=npRelHumTempStatus, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTable=npSmokeTable, npSmokePower=npSmokePower, npRelayState=npRelayState, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrap=npRelHumTrap, npGsmTrap=npGsmTrap, npIrPlayCmd=npIrPlayCmd, npIr=npIr, npThermoValuePrecise=npThermoValuePrecise, npSoftReboot=npSoftReboot, npCurLoopTrapI=npCurLoopTrapI, npRelHumStatus=npRelHumStatus, npCurLoopN=npCurLoopN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayMode=npRelayMode, npCurLoopTrap=npCurLoopTrap, npThermoHigh=npThermoHigh, npGsmStrength=npGsmStrength, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapR=npCurLoopTrapR, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelay=npRelay, npSmokeSensorN=npSmokeSensorN, npIoTrap=npIoTrap, npThermoLow=npThermoLow, npCurLoopTable=npCurLoopTable, npIo=npIo, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataN=npRelHumTrapDataN, npGsmRegistration=npGsmRegistration, npReboot=npReboot, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayN=npRelayN, FixedPoint1000=FixedPoint1000, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapSafe=npRelHumTrapSafe, npRelayEntry=npRelayEntry, npCurLoopTrapPower=npCurLoopTrapPower, npResetStack=npResetStack, npRelHumMemo=npRelHumMemo, npRelHumTrapData=npRelHumTrapData)
