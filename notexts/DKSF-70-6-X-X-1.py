...
# Produced by pysmi-1.1.8 at Mon Jan  2 15:32:56 2023
...
Counter32, iso, ModuleIdentity, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, enterprises, Bits, TimeTicks, IpAddress, Gauge32, Counter64, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "ModuleIdentity", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "enterprises", "Bits", "TimeTicks", "IpAddress", "Gauge32", "Counter64", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumidity=npRelHumidity, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTable=npThermoTable, npForcedReboot=npForcedReboot, npThermoLow=npThermoLow, npRelHumTable=npRelHumTable, npThermo=npThermo, npSmokeReset=npSmokeReset, npRelHumTrap=npRelHumTrap, npRelayState=npRelayState, npCurLoopTraps=npCurLoopTraps, npSmokePower=npSmokePower, npIoLineN=npIoLineN, npSmokeTrapMemo=npSmokeTrapMemo, npThermoHigh=npThermoHigh, npGsmTraps=npGsmTraps, npRelHumTrapData=npRelHumTrapData, npRelay=npRelay, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopI=npCurLoopI, npThermoTrap=npThermoTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapPrefix=npThermoTrapPrefix, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTempValue=npRelHumTempValue, npThermoTrapValue=npThermoTrapValue, npSmokeTraps=npSmokeTraps, npTrapInfo=npTrapInfo, npCurLoopStatus=npCurLoopStatus, npIr=npIr, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayMode=npRelayMode, npTrapEmailTo=npTrapEmailTo, npIrPlayCmd=npIrPlayCmd, npSmokeSensorN=npSmokeSensorN, npRelayMemo=npRelayMemo, npThermoTrapHigh=npThermoTrapHigh, npCurLoopPower=npCurLoopPower, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopEntry=npCurLoopEntry, npRelHumEntry=npRelHumEntry, npThermoTraps=npThermoTraps, npCurLoopTrapV=npCurLoopTrapV, npIoLevelOut=npIoLevelOut, npIoLevelIn=npIoLevelIn, npThermoMemo=npThermoMemo, npRelHumTrapFail=npRelHumTrapFail, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTable=npCurLoopTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumValue=npRelHumValue, npResetStack=npResetStack, FixedPoint1000=FixedPoint1000, npCurLoopTrap=npCurLoopTrap, npSmoke=npSmoke, npGsmInfo=npGsmInfo, npGsmRegistration=npGsmRegistration, npRelHumTrapTemp=npRelHumTrapTemp, npRelayTable=npRelayTable, npRelayStartReset=npRelayStartReset, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeMemo=npSmokeMemo, npIoTrap=npIoTrap, npCurLoopV=npCurLoopV, npIoMemo=npIoMemo, npRelHumStatus=npRelHumStatus, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrStatus=npIrStatus, npRelayEntry=npRelayEntry, npSmokeEntry=npSmokeEntry, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoEntry=npIoEntry, npCurLoopTrapN=npCurLoopTrapN, npGsmTrap=npGsmTrap, npGsmFailed=npGsmFailed, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapSensorN=npThermoTrapSensorN, npIoTable=npIoTable, npThermoValue=npThermoValue, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrapPrefix=npSmokeTrapPrefix, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTrapStatus=npSmokeTrapStatus, npSoftReboot=npSoftReboot, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoSensorN=npThermoSensorN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoStatus=npThermoStatus, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataValue=npRelHumTrapDataValue, npIrReset=npIrReset, npSmokeTrap=npSmokeTrap, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopR=npCurLoopR, npIoPulseCounter=npIoPulseCounter, npSmokeTable=npSmokeTable, npSmokeStatus=npSmokeStatus, npCurLoop=npCurLoop, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopN=npCurLoopN, npGsm=npGsm, npThermoTrapStatus=npThermoTrapStatus, npIoTrapPrefix=npIoTrapPrefix, npReboot=npReboot, npIo=npIo, npIoTraps=npIoTraps, npRelayN=npRelayN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrCtrl=npIrCtrl, npThermoEntry=npThermoEntry, npRelHumN=npRelHumN, npGsmStrength=npGsmStrength, npRelHumMemo=npRelHumMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTrapLineN=npIoTrapLineN, lightcom=lightcom, npIoSinglePulseDuration=npIoSinglePulseDuration)
