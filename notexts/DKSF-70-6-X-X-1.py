...
# Produced by pysmi-1.1.8 at Thu Oct 26 10:18:48 2023
...
Bits, ObjectIdentity, NotificationType, Integer32, Gauge32, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, ModuleIdentity, enterprises, Unsigned32, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "NotificationType", "Integer32", "Gauge32", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "ModuleIdentity", "enterprises", "Unsigned32", "Counter32", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumEntry=npRelHumEntry, npRelayMode=npRelayMode, npTrapEmailTo=npTrapEmailTo, npRelayEntry=npRelayEntry, npThermoTrapLow=npThermoTrapLow, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npResetStack=npResetStack, npCurLoopN=npCurLoopN, lightcom=lightcom, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumValue=npRelHumValue, npRelHumTrapTemp=npRelHumTrapTemp, npThermoValuePrecise=npThermoValuePrecise, npSmokePower=npSmokePower, npSmokeTable=npSmokeTable, npIoTrap=npIoTrap, npSmokeTrap=npSmokeTrap, npIoTrapLineN=npIoTrapLineN, npIr=npIr, npIrPlayCmd=npIrPlayCmd, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumN=npRelHumN, npCurLoopStatus=npCurLoopStatus, npRelHumTable=npRelHumTable, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeSensorN=npSmokeSensorN, npCurLoop=npCurLoop, npCurLoopTrapI=npCurLoopTrapI, npCurLoopR=npCurLoopR, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npReboot=npReboot, npRelayTable=npRelayTable, npGsmStrength=npGsmStrength, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTraps=npIoTraps, npThermoTrapSensorN=npThermoTrapSensorN, npIrReset=npIrReset, npRelay=npRelay, npThermoEntry=npThermoEntry, npIoLineN=npIoLineN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoEntry=npIoEntry, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoSensorN=npThermoSensorN, npThermoTable=npThermoTable, npRelHumTrapSafe=npRelHumTrapSafe, npSmoke=npSmoke, npCurLoopTrapV=npCurLoopTrapV, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoLow=npThermoLow, npIrCtrl=npIrCtrl, npCurLoopTraps=npCurLoopTraps, npIoLevelOut=npIoLevelOut, npRelHumStatus=npRelHumStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapMemo=npThermoTrapMemo, npIoTable=npIoTable, npThermoHigh=npThermoHigh, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTable=npCurLoopTable, npIoPulseCounter=npIoPulseCounter, npRelayState=npRelayState, npCurLoopPower=npCurLoopPower, npRelHumMemo=npRelHumMemo, npIrStatus=npIrStatus, npThermoMemo=npThermoMemo, FixedPoint1000=FixedPoint1000, npSoftReboot=npSoftReboot, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeStatus=npSmokeStatus, npSmokeReset=npSmokeReset, npSmokeTrapStatus=npSmokeTrapStatus, npIoLevelIn=npIoLevelIn, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoMemo=npIoMemo, npForcedReboot=npForcedReboot, npCurLoopV=npCurLoopV, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmInfo=npGsmInfo, npRelHumTrapDataN=npRelHumTrapDataN, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapHigh=npThermoTrapHigh, npSmokeTraps=npSmokeTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeMemo=npSmokeMemo, npRelHumTrap=npRelHumTrap, npGsmTrapPrefix=npGsmTrapPrefix, npThermoValue=npThermoValue, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmTrap=npGsmTrap, npIoTrapMemo=npIoTrapMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsm=npGsm, npRelHumTrapData=npRelHumTrapData, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrap=npCurLoopTrap, npGsmTraps=npGsmTraps, npRelayN=npRelayN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopI=npCurLoopI, npRelayStartReset=npRelayStartReset, npThermoStatus=npThermoStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumidity=npRelHumidity, npTrapInfo=npTrapInfo, npThermoTraps=npThermoTraps, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeEntry=npSmokeEntry, npCurLoopTrapR=npCurLoopTrapR, npRelayMemo=npRelayMemo, npIo=npIo, npGsmFailed=npGsmFailed, npThermoTrapPrefix=npThermoTrapPrefix, npThermo=npThermo, npCurLoopEntry=npCurLoopEntry, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrap=npThermoTrap, npThermoTrapValue=npThermoTrapValue, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmRegistration=npGsmRegistration)
