...
TimeTicks, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, ModuleIdentity, Counter64, enterprises, iso, ObjectIdentity, Gauge32, NotificationType, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "ModuleIdentity", "Counter64", "enterprises", "iso", "ObjectIdentity", "Gauge32", "NotificationType", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapMemo=npThermoTrapMemo, npRelHumTrap=npRelHumTrap, npIoTrapMemo=npIoTrapMemo, npRelHumN=npRelHumN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapI=npCurLoopTrapI, npThermoMemo=npThermoMemo, npIoLineN=npIoLineN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, FixedPoint1000=FixedPoint1000, npCurLoop=npCurLoop, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapLow=npThermoTrapLow, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrap=npSmokeTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmStrength=npGsmStrength, npRelay=npRelay, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeStatus=npSmokeStatus, npCurLoopStatus=npCurLoopStatus, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTraps=npThermoTraps, npThermoValue=npThermoValue, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTraps=npCurLoopTraps, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokePower=npSmokePower, npSmokeEntry=npSmokeEntry, npIoLevelOut=npIoLevelOut, npCurLoopV=npCurLoopV, npRelHumEntry=npRelHumEntry, npCurLoopTable=npCurLoopTable, npResetStack=npResetStack, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayStartReset=npRelayStartReset, npGsmTraps=npGsmTraps, npCurLoopTrap=npCurLoopTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsm=npGsm, npSmokeMemo=npSmokeMemo, npThermo=npThermo, npRelayMode=npRelayMode, npIr=npIr, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapValue=npThermoTrapValue, npReboot=npReboot, npCurLoopPower=npCurLoopPower, npSmokeTraps=npSmokeTraps, npGsmFailed=npGsmFailed, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeSensorN=npSmokeSensorN, npRelayMemo=npRelayMemo, npRelayState=npRelayState, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoSensorN=npThermoSensorN, npSmokeTable=npSmokeTable, npRelHumTempStatus=npRelHumTempStatus, npGsmInfo=npGsmInfo, npForcedReboot=npForcedReboot, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopI=npCurLoopI, npIrReset=npIrReset, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumValue=npRelHumValue, npRelayEntry=npRelayEntry, npTrapInfo=npTrapInfo, npIo=npIo, npThermoLow=npThermoLow, npRelHumTempValue=npRelHumTempValue, npSmoke=npSmoke, npRelHumMemo=npRelHumMemo, npThermoTrapStatus=npThermoTrapStatus, npThermoTable=npThermoTable, npIrPlayCmd=npIrPlayCmd, npIoEntry=npIoEntry, npIoPulseCounter=npIoPulseCounter, npSmokeTrapMemo=npSmokeTrapMemo, npRelayTable=npRelayTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapSafe=npRelHumTrapSafe, npIrStatus=npIrStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTable=npIoTable, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTable=npRelHumTable, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTrapLevelIn=npIoTrapLevelIn, npIoTraps=npIoTraps, npThermoTrap=npThermoTrap, npCurLoopR=npCurLoopR, npRelayN=npRelayN, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapR=npCurLoopTrapR, npIoLevelIn=npIoLevelIn, npSmokeReset=npSmokeReset, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumStatus=npRelHumStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoStatus=npThermoStatus, npRelHumTrapData=npRelHumTrapData, npCurLoopEntry=npCurLoopEntry, npThermoValuePrecise=npThermoValuePrecise, npGsmTrap=npGsmTrap, npIoTrapLineN=npIoTrapLineN, npSoftReboot=npSoftReboot, npThermoTrapHigh=npThermoTrapHigh, npCurLoopN=npCurLoopN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoHigh=npThermoHigh, npIoMemo=npIoMemo, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoEntry=npThermoEntry, npRelHumidity=npRelHumidity, npTrapEmailTo=npTrapEmailTo, lightcom=lightcom, npGsmRegistration=npGsmRegistration, npIoTrap=npIoTrap, npSmokeTrapStatus=npSmokeTrapStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npIrCtrl=npIrCtrl, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus)
