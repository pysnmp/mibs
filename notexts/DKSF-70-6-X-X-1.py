...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, ObjectIdentity, Unsigned32, IpAddress, MibIdentifier, Gauge32, ModuleIdentity, Counter32, Integer32, NotificationType, iso, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "ObjectIdentity", "Unsigned32", "IpAddress", "MibIdentifier", "Gauge32", "ModuleIdentity", "Counter32", "Integer32", "NotificationType", "iso", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumStatus=npRelHumStatus, npForcedReboot=npForcedReboot, npThermoTrapValue=npThermoTrapValue, npSmokeTraps=npSmokeTraps, npCurLoopN=npCurLoopN, npThermoStatus=npThermoStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmFailed=npGsmFailed, npCurLoop=npCurLoop, npThermoHigh=npThermoHigh, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayTable=npRelayTable, npRelHumMemo=npRelHumMemo, npRelayEntry=npRelayEntry, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapR=npCurLoopTrapR, npGsmStrength=npGsmStrength, npCurLoopStatus=npCurLoopStatus, npGsm=npGsm, npRelay=npRelay, npIoEntry=npIoEntry, npSmokeReset=npSmokeReset, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapPower=npCurLoopTrapPower, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIo=npIo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSoftReboot=npSoftReboot, npRelHumTrapTemp=npRelHumTrapTemp, npReboot=npReboot, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTraps=npCurLoopTraps, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopEntry=npCurLoopEntry, npCurLoopPower=npCurLoopPower, npIrReset=npIrReset, npRelayN=npRelayN, npSmokePower=npSmokePower, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrap=npIoTrap, npTrapEmailTo=npTrapEmailTo, npGsmInfo=npGsmInfo, npThermoTable=npThermoTable, npGsmTraps=npGsmTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIrPlayCmd=npIrPlayCmd, npIr=npIr, npThermoTrapLow=npThermoTrapLow, npThermo=npThermo, npIoPulseCounter=npIoPulseCounter, npRelHumidity=npRelHumidity, npRelayState=npRelayState, npTrapInfo=npTrapInfo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopR=npCurLoopR, npRelHumTrapTempFail=npRelHumTrapTempFail, npIrCtrl=npIrCtrl, npThermoMemo=npThermoMemo, npIoTraps=npIoTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTable=npRelHumTable, npThermoEntry=npThermoEntry, npSmokeSensorN=npSmokeSensorN, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeMemo=npSmokeMemo, npIoLineN=npIoLineN, npRelayMode=npRelayMode, npIrStatus=npIrStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeEntry=npSmokeEntry, npRelHumValue=npRelHumValue, npThermoTrapPrefix=npThermoTrapPrefix, npIoTable=npIoTable, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayStartReset=npRelayStartReset, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npResetStack=npResetStack, npRelHumN=npRelHumN, npCurLoopV=npCurLoopV, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrapHigh=npThermoTrapHigh, npIoSinglePulseStart=npIoSinglePulseStart, npThermoValue=npThermoValue, lightcom=lightcom, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTrapStatus=npSmokeTrapStatus, npGsmTrapPrefix=npGsmTrapPrefix, npIoMemo=npIoMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrap=npRelHumTrap, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoLevelOut=npIoLevelOut, npCurLoopTrap=npCurLoopTrap, npThermoTraps=npThermoTraps, npIoLevelIn=npIoLevelIn, npCurLoopTable=npCurLoopTable, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTrap=npSmokeTrap, npThermoTrapStatus=npThermoTrapStatus, npThermoTrap=npThermoTrap, npSmoke=npSmoke, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeStatus=npSmokeStatus, npIoTrapPrefix=npIoTrapPrefix, npSmokeTable=npSmokeTable, npGsmRegistration=npGsmRegistration, FixedPoint1000=FixedPoint1000, npIoTrapMemo=npIoTrapMemo, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTempStatus=npRelHumTempStatus, npGsmTrap=npGsmTrap, npIoTrapLevelIn=npIoTrapLevelIn, npThermoSensorN=npThermoSensorN, npRelHumTrapFail=npRelHumTrapFail, npThermoLow=npThermoLow, npCurLoopI=npCurLoopI, npRelayMemo=npRelayMemo, npRelHumTempValue=npRelHumTempValue, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumEntry=npRelHumEntry, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrapLineN=npIoTrapLineN)
