...
ObjectIdentity, Counter32, Counter64, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, iso, IpAddress, Bits, MibIdentifier, TimeTicks, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "Counter64", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "iso", "IpAddress", "Bits", "MibIdentifier", "TimeTicks", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmStrength=npGsmStrength, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeReset=npSmokeReset, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayMode=npRelayMode, npSmokeTraps=npSmokeTraps, npCurLoopTrap=npCurLoopTrap, npGsmFailed=npGsmFailed, npReboot=npReboot, npRelayTable=npRelayTable, npSmokeStatus=npSmokeStatus, npRelHumMemo=npRelHumMemo, npGsmRegistration=npGsmRegistration, npThermoSensorN=npThermoSensorN, npThermoHigh=npThermoHigh, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npResetStack=npResetStack, npThermoStatus=npThermoStatus, npRelHumidity=npRelHumidity, npSmokeMemo=npSmokeMemo, npIoMemo=npIoMemo, npCurLoopTrapV=npCurLoopTrapV, npRelayEntry=npRelayEntry, npSmokeEntry=npSmokeEntry, npRelHumStatus=npRelHumStatus, npIoTrapPrefix=npIoTrapPrefix, npCurLoopN=npCurLoopN, npIrStatus=npIrStatus, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTraps=npCurLoopTraps, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopStatus=npCurLoopStatus, npRelHumEntry=npRelHumEntry, npRelHumValue=npRelHumValue, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTable=npSmokeTable, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npIrCtrl=npIrCtrl, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmTraps=npGsmTraps, npThermoTrapMemo=npThermoTrapMemo, npTrapInfo=npTrapInfo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, npSoftReboot=npSoftReboot, npIo=npIo, npSmokePower=npSmokePower, npCurLoop=npCurLoop, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoEntry=npIoEntry, npCurLoopTable=npCurLoopTable, npCurLoopI=npCurLoopI, npIrPlayCmd=npIrPlayCmd, npIoTable=npIoTable, npGsm=npGsm, npCurLoopTrapI=npCurLoopTrapI, npGsmTrap=npGsmTrap, npThermoTraps=npThermoTraps, npThermoLow=npThermoLow, npIoTrapLineN=npIoTrapLineN, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrap=npThermoTrap, npCurLoopR=npCurLoopR, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoLineN=npIoLineN, npIoTraps=npIoTraps, npThermoMemo=npThermoMemo, npIoPulseCounter=npIoPulseCounter, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTable=npThermoTable, npCurLoopTrapPower=npCurLoopTrapPower, npThermoEntry=npThermoEntry, npRelHumTrapData=npRelHumTrapData, npRelayStartReset=npRelayStartReset, npRelHumN=npRelHumN, npRelayMemo=npRelayMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIrReset=npIrReset, npCurLoopV=npCurLoopV, npCurLoopPower=npCurLoopPower, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npTrapEmailTo=npTrapEmailTo, npCurLoopEntry=npCurLoopEntry, npIr=npIr, npThermoTrapHigh=npThermoTrapHigh, npForcedReboot=npForcedReboot, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmTrapPrefix=npGsmTrapPrefix, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapFail=npRelHumTrapFail, npGsmInfo=npGsmInfo, npRelHumTable=npRelHumTable, npThermo=npThermo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTrapStatus=npSmokeTrapStatus, npRelayState=npRelayState, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoLevelOut=npIoLevelOut, lightcom=lightcom, npThermoValue=npThermoValue, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrap=npIoTrap, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTemp=npRelHumTrapTemp, npIoLevelIn=npIoLevelIn, npRelay=npRelay, npSmoke=npSmoke, npRelHumTempValue=npRelHumTempValue, FixedPoint1000=FixedPoint1000, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapValue=npThermoTrapValue, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapLow=npThermoTrapLow, npSmokeTrap=npSmokeTrap, npRelHumTrap=npRelHumTrap, npRelayN=npRelayN)
