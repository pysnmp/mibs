...
# Produced by pysmi-1.1.8 at Wed Oct 11 07:59:16 2023
...
ModuleIdentity, Bits, ObjectIdentity, Unsigned32, TimeTicks, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, Counter32, iso, NotificationType, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "ObjectIdentity", "Unsigned32", "TimeTicks", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "Counter32", "iso", "NotificationType", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopPower=npCurLoopPower, npSmokeTrapPrefix=npSmokeTrapPrefix, npReboot=npReboot, npIoLevelIn=npIoLevelIn, npCurLoopR=npCurLoopR, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrap=npThermoTrap, npRelHumTempValue=npRelHumTempValue, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapLineN=npIoTrapLineN, npSmokeStatus=npSmokeStatus, npSmokeTrapStatus=npSmokeTrapStatus, npRelayN=npRelayN, npTrapEmailTo=npTrapEmailTo, npIoSinglePulseStart=npIoSinglePulseStart, npGsmInfo=npGsmInfo, npIoTable=npIoTable, npCurLoopTrapPower=npCurLoopTrapPower, npResetStack=npResetStack, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoop=npCurLoop, npSmokeSensorN=npSmokeSensorN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopEntry=npCurLoopEntry, npIrPlayCmd=npIrPlayCmd, npTrapInfo=npTrapInfo, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTable=npThermoTable, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapSafe=npRelHumTrapSafe, npThermoLow=npThermoLow, npIo=npIo, npThermo=npThermo, npRelHumStatus=npRelHumStatus, npRelHumTable=npRelHumTable, npRelHumTrap=npRelHumTrap, npThermoStatus=npThermoStatus, npSmokeEntry=npSmokeEntry, npThermoTrapHigh=npThermoTrapHigh, npSmokeTraps=npSmokeTraps, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataN=npRelHumTrapDataN, npIr=npIr, npThermoValuePrecise=npThermoValuePrecise, npSmokeTable=npSmokeTable, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumValue=npRelHumValue, npCurLoopTrap=npCurLoopTrap, npRelHumMemo=npRelHumMemo, npRelayMode=npRelayMode, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapFail=npRelHumTrapFail, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayEntry=npRelayEntry, npIoTraps=npIoTraps, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayState=npRelayState, npThermoTraps=npThermoTraps, npCurLoopTable=npCurLoopTable, npCurLoopV=npCurLoopV, npRelayMemo=npRelayMemo, npRelayTable=npRelayTable, npThermoSensorN=npThermoSensorN, npSmokePower=npSmokePower, npCurLoopN=npCurLoopN, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapMemo=npThermoTrapMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoPulseCounter=npIoPulseCounter, npCurLoopTrapV=npCurLoopTrapV, npGsmStrength=npGsmStrength, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapLow=npThermoTrapLow, npThermoMemo=npThermoMemo, npThermoTrapValue=npThermoTrapValue, npIoLineN=npIoLineN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelay=npRelay, npRelHumTrapTempFail=npRelHumTrapTempFail, npSoftReboot=npSoftReboot, npRelHumidity=npRelHumidity, npIrCtrl=npIrCtrl, npRelHumN=npRelHumN, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoValue=npThermoValue, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, FixedPoint1000=FixedPoint1000, npSmokeMemo=npSmokeMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopStatus=npCurLoopStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTrap=npSmokeTrap, npThermoTrapSensorN=npThermoTrapSensorN, npThermoHigh=npThermoHigh, npGsmRegistration=npGsmRegistration, npIrReset=npIrReset, npForcedReboot=npForcedReboot, npIrStatus=npIrStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrap=npIoTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmFailed=npGsmFailed, npGsmTraps=npGsmTraps, npThermoEntry=npThermoEntry, npSmoke=npSmoke, npIoLevelOut=npIoLevelOut, npRelHumEntry=npRelHumEntry, lightcom=lightcom, npIoMemo=npIoMemo, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTraps=npCurLoopTraps, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayStartReset=npRelayStartReset, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapR=npCurLoopTrapR, npGsm=npGsm, npIoEntry=npIoEntry, npSmokeReset=npSmokeReset, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmTrapPrefix=npGsmTrapPrefix, npGsmTrap=npGsmTrap, npCurLoopI=npCurLoopI)
