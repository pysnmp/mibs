...
TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, Bits, IpAddress, Counter32, Unsigned32, ModuleIdentity, iso, ObjectIdentity, Counter64, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "Bits", "IpAddress", "Counter32", "Unsigned32", "ModuleIdentity", "iso", "ObjectIdentity", "Counter64", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrap=npCurLoopTrap, npRelayMode=npRelayMode, npCurLoopStatus=npCurLoopStatus, npRelHumTempValue=npRelHumTempValue, npSmoke=npSmoke, npCurLoopTrapPower=npCurLoopTrapPower, npIr=npIr, npTrapInfo=npTrapInfo, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmRegistration=npGsmRegistration, npRelayStartReset=npRelayStartReset, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapDataN=npRelHumTrapDataN, npGsmFailed=npGsmFailed, npSmokeStatus=npSmokeStatus, npRelHumTable=npRelHumTable, npCurLoopI=npCurLoopI, npIoMemo=npIoMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoLevelOut=npIoLevelOut, npThermoEntry=npThermoEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npResetStack=npResetStack, npCurLoopEntry=npCurLoopEntry, npSmokeTable=npSmokeTable, npSmokeSensorN=npSmokeSensorN, npRelHumTrapFail=npRelHumTrapFail, npSmokeReset=npSmokeReset, npCurLoopTrapR=npCurLoopTrapR, npSmokeTrap=npSmokeTrap, npRelHumTempStatus=npRelHumTempStatus, npRelHumEntry=npRelHumEntry, npIoEntry=npIoEntry, npIoTrap=npIoTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapN=npCurLoopTrapN, npIoLevelIn=npIoLevelIn, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoValuePrecise=npThermoValuePrecise, npIoTrapPrefix=npIoTrapPrefix, npIoTrapLineN=npIoTrapLineN, npIoTable=npIoTable, npIoLineN=npIoLineN, npIoPulseCounter=npIoPulseCounter, npCurLoopR=npCurLoopR, npRelayN=npRelayN, npIrReset=npIrReset, npForcedReboot=npForcedReboot, npThermoTrapSensorN=npThermoTrapSensorN, npRelayState=npRelayState, npThermoValue=npThermoValue, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayEntry=npRelayEntry, npRelHumidity=npRelHumidity, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapI=npCurLoopTrapI, npRelHumN=npRelHumN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayMemo=npRelayMemo, npTrapEmailTo=npTrapEmailTo, npGsm=npGsm, npSoftReboot=npSoftReboot, lightcom=lightcom, npIoTrapLevelIn=npIoTrapLevelIn, npThermoStatus=npThermoStatus, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTable=npCurLoopTable, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoHigh=npThermoHigh, npRelayTable=npRelayTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTrapStatus=npSmokeTrapStatus, FixedPoint1000=FixedPoint1000, npIoTraps=npIoTraps, npRelHumTrap=npRelHumTrap, npRelHumStatus=npRelHumStatus, npThermoMemo=npThermoMemo, npSmokeEntry=npSmokeEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapValue=npThermoTrapValue, npSmokeMemo=npSmokeMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopN=npCurLoopN, npCurLoopTrapV=npCurLoopTrapV, npGsmTraps=npGsmTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopV=npCurLoopV, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIrStatus=npIrStatus, npThermoTrapLow=npThermoTrapLow, npSmokePower=npSmokePower, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmInfo=npGsmInfo, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoop=npCurLoop, npThermoSensorN=npThermoSensorN, npThermoTable=npThermoTable, npThermoTrapMemo=npThermoTrapMemo, npGsmStrength=npGsmStrength, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoLow=npThermoLow, npSmokeTraps=npSmokeTraps, npThermoTrap=npThermoTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npReboot=npReboot, npRelHumTrapTempSafe=npRelHumTrapTempSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopPower=npCurLoopPower, npRelHumMemo=npRelHumMemo, npGsmTrapPrefix=npGsmTrapPrefix, npIrCtrl=npIrCtrl, npThermo=npThermo, npRelay=npRelay, npIrPlayCmd=npIrPlayCmd, npIo=npIo, npRelHumTrapSafe=npRelHumTrapSafe, npGsmTrap=npGsmTrap, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumValue=npRelHumValue, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTraps=npThermoTraps, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapAllChannels=npRelHumTrapAllChannels)
