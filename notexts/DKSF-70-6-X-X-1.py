...
# Produced by pysmi-1.1.8 at Thu Sep  7 12:04:56 2023
...
Counter64, TimeTicks, Bits, Unsigned32, ObjectIdentity, Gauge32, enterprises, ModuleIdentity, Counter32, iso, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "Bits", "Unsigned32", "ObjectIdentity", "Gauge32", "enterprises", "ModuleIdentity", "Counter32", "iso", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmTraps=npGsmTraps, npThermoTraps=npThermoTraps, npThermoTrapLow=npThermoTrapLow, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayN=npRelayN, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrapLineN=npIoTrapLineN, npRelayEntry=npRelayEntry, npSmokePower=npSmokePower, npThermoEntry=npThermoEntry, npRelHumTrapDataN=npRelHumTrapDataN, npTrapEmailTo=npTrapEmailTo, npCurLoopTrap=npCurLoopTrap, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoMemo=npIoMemo, npCurLoopEntry=npCurLoopEntry, npSmokeStatus=npSmokeStatus, npCurLoopStatus=npCurLoopStatus, npIrReset=npIrReset, npGsmInfo=npGsmInfo, npThermo=npThermo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapR=npCurLoopTrapR, npRelHumTempValue=npRelHumTempValue, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoValuePrecise=npThermoValuePrecise, npRelayStartReset=npRelayStartReset, npIoEntry=npIoEntry, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayState=npRelayState, npCurLoopN=npCurLoopN, npRelayMode=npRelayMode, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTraps=npIoTraps, npRelayMemo=npRelayMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapHigh=npThermoTrapHigh, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrapMemo=npSmokeTrapMemo, npIoSinglePulseStart=npIoSinglePulseStart, npSoftReboot=npSoftReboot, npIrPlayCmd=npIrPlayCmd, npSmokeTraps=npSmokeTraps, npCurLoopI=npCurLoopI, npReboot=npReboot, npTrapInfo=npTrapInfo, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoop=npCurLoop, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeReset=npSmokeReset, npThermoTrap=npThermoTrap, npRelayTable=npRelayTable, npSmokeEntry=npSmokeEntry, npRelHumN=npRelHumN, npThermoHigh=npThermoHigh, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelay=npRelay, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumEntry=npRelHumEntry, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoStatus=npThermoStatus, npIoPulseCounter=npIoPulseCounter, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoLineN=npIoLineN, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrap=npRelHumTrap, npRelHumTempStatus=npRelHumTempStatus, npGsmFailed=npGsmFailed, npThermoLow=npThermoLow, npIoLevelOut=npIoLevelOut, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmTrapPrefix=npGsmTrapPrefix, npThermoMemo=npThermoMemo, npThermoTrapValue=npThermoTrapValue, npCurLoopR=npCurLoopR, npThermoTrapStatus=npThermoTrapStatus, npForcedReboot=npForcedReboot, npRelHumTrapData=npRelHumTrapData, lightcom=lightcom, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTable=npRelHumTable, npGsmRegistration=npGsmRegistration, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIr=npIr, npCurLoopTrapPower=npCurLoopTrapPower, npIo=npIo, npCurLoopV=npCurLoopV, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTrap=npSmokeTrap, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTable=npCurLoopTable, npRelHumidity=npRelHumidity, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumMemo=npRelHumMemo, npRelHumValue=npRelHumValue, npGsmTrap=npGsmTrap, npRelHumTrapSafe=npRelHumTrapSafe, npIrStatus=npIrStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npIrCtrl=npIrCtrl, npResetStack=npResetStack, npThermoTable=npThermoTable, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTable=npIoTable, npSmokeMemo=npSmokeMemo, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrap=npIoTrap, npRelHumStatus=npRelHumStatus, npCurLoopPower=npCurLoopPower, npIoLevelIn=npIoLevelIn, npThermoSensorN=npThermoSensorN, npThermoValue=npThermoValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTable=npSmokeTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmStrength=npGsmStrength, FixedPoint1000=FixedPoint1000, npSmoke=npSmoke, npGsm=npGsm)
