...
# Produced by pysmi-1.1.8 at Thu Feb  9 14:03:16 2023
...
enterprises, NotificationType, MibIdentifier, ObjectIdentity, Integer32, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, Bits, ModuleIdentity, Counter64, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "MibIdentifier", "ObjectIdentity", "Integer32", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "Bits", "ModuleIdentity", "Counter64", "Gauge32", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmFailed=npGsmFailed, npIr=npIr, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayTable=npRelayTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoop=npCurLoop, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeSensorN=npSmokeSensorN, npIoLevelOut=npIoLevelOut, npSmokeTraps=npSmokeTraps, npThermoStatus=npThermoStatus, npSmokeMemo=npSmokeMemo, npThermoTrapValue=npThermoTrapValue, npThermoSensorN=npThermoSensorN, npIoLevelIn=npIoLevelIn, npIrPlayCmd=npIrPlayCmd, npIoTrapMemo=npIoTrapMemo, npSmokeReset=npSmokeReset, npIoEntry=npIoEntry, npThermoTrap=npThermoTrap, npIoTraps=npIoTraps, npIrCtrl=npIrCtrl, npCurLoopR=npCurLoopR, npCurLoopTrapR=npCurLoopTrapR, npThermoTable=npThermoTable, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopPower=npCurLoopPower, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIrReset=npIrReset, npSmoke=npSmoke, npIo=npIo, npRelHumTrapTemp=npRelHumTrapTemp, npSoftReboot=npSoftReboot, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrap=npIoTrap, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTable=npCurLoopTable, npCurLoopN=npCurLoopN, npCurLoopI=npCurLoopI, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrap=npRelHumTrap, npSmokeStatus=npSmokeStatus, npCurLoopTrapV=npCurLoopTrapV, npIoPulseCounter=npIoPulseCounter, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermo=npThermo, npTrapEmailTo=npTrapEmailTo, npIoTrapLineN=npIoTrapLineN, npGsmStrength=npGsmStrength, npThermoEntry=npThermoEntry, npRelHumN=npRelHumN, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapSensorN=npThermoTrapSensorN, npGsmInfo=npGsmInfo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapData=npRelHumTrapData, npRelHumTable=npRelHumTable, npForcedReboot=npForcedReboot, npCurLoopTrapPrefix=npCurLoopTrapPrefix, FixedPoint1000=FixedPoint1000, npRelHumStatus=npRelHumStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumidity=npRelHumidity, npRelayState=npRelayState, npIoTable=npIoTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIrStatus=npIrStatus, npCurLoopV=npCurLoopV, npCurLoopTraps=npCurLoopTraps, npRelayN=npRelayN, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTraps=npThermoTraps, npCurLoopStatus=npCurLoopStatus, npIoTrapLevelIn=npIoTrapLevelIn, npRelay=npRelay, npCurLoopTrap=npCurLoopTrap, npThermoLow=npThermoLow, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTempValue=npRelHumTempValue, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopEntry=npCurLoopEntry, npThermoValuePrecise=npThermoValuePrecise, npGsm=npGsm, npRelayEntry=npRelayEntry, npSmokeTrapMemo=npSmokeTrapMemo, npTrapInfo=npTrapInfo, npRelayMemo=npRelayMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeEntry=npSmokeEntry, npThermoValue=npThermoValue, npThermoMemo=npThermoMemo, npRelayStartReset=npRelayStartReset, npGsmRegistration=npGsmRegistration, npRelHumMemo=npRelHumMemo, npIoMemo=npIoMemo, npGsmTrap=npGsmTrap, npReboot=npReboot, npThermoTrapMemo=npThermoTrapMemo, npRelHumEntry=npRelHumEntry, npResetStack=npResetStack, npRelayMode=npRelayMode, npRelHumValue=npRelHumValue, npThermoHigh=npThermoHigh, npSmokeTable=npSmokeTable, npSmokeTrap=npSmokeTrap, npIoLineN=npIoLineN, npGsmTraps=npGsmTraps, npIoTrapPrefix=npIoTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapHigh=npThermoTrapHigh, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokePower=npSmokePower, lightcom=lightcom)
