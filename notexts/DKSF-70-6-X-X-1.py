...
Counter64, enterprises, ObjectIdentity, Bits, Counter32, Unsigned32, MibIdentifier, ModuleIdentity, NotificationType, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "enterprises", "ObjectIdentity", "Bits", "Counter32", "Unsigned32", "MibIdentifier", "ModuleIdentity", "NotificationType", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTable=npRelHumTable, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapPrefix=npThermoTrapPrefix, npRelay=npRelay, npIr=npIr, npIoPulseCounter=npIoPulseCounter, npReboot=npReboot, npIoTrapMemo=npIoTrapMemo, npIoEntry=npIoEntry, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTable=npIoTable, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTraps=npSmokeTraps, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapN=npCurLoopTrapN, npRelHumEntry=npRelHumEntry, npIoMemo=npIoMemo, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapLevelIn=npIoTrapLevelIn, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopN=npCurLoopN, npThermoTraps=npThermoTraps, npRelHumValue=npRelHumValue, npRelayTable=npRelayTable, npForcedReboot=npForcedReboot, FixedPoint1000=FixedPoint1000, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopEntry=npCurLoopEntry, npRelHumTrap=npRelHumTrap, npThermoEntry=npThermoEntry, npThermoTrapStatus=npThermoTrapStatus, npIoTrap=npIoTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTrapV=npCurLoopTrapV, npGsmStrength=npGsmStrength, npThermo=npThermo, npRelayMemo=npRelayMemo, npCurLoopI=npCurLoopI, lightcom=lightcom, npCurLoopTrapI=npCurLoopTrapI, npSmokePower=npSmokePower, npCurLoopTraps=npCurLoopTraps, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapR=npCurLoopTrapR, npIoSinglePulseDuration=npIoSinglePulseDuration, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumidity=npRelHumidity, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumMemo=npRelHumMemo, npCurLoopTrap=npCurLoopTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmoke=npSmoke, npIoTraps=npIoTraps, npThermoTrapLow=npThermoTrapLow, npResetStack=npResetStack, npGsm=npGsm, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoMemo=npThermoMemo, npIrStatus=npIrStatus, npThermoTable=npThermoTable, npThermoTrap=npThermoTrap, npCurLoopV=npCurLoopV, npGsmInfo=npGsmInfo, npThermoHigh=npThermoHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmTraps=npGsmTraps, npSoftReboot=npSoftReboot, npRelayStartReset=npRelayStartReset, npSmokeTrap=npSmokeTrap, npRelayMode=npRelayMode, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayN=npRelayN, npThermoTrapMemo=npThermoTrapMemo, npThermoTrapHigh=npThermoTrapHigh, npRelayEntry=npRelayEntry, npIoLevelOut=npIoLevelOut, npSmokeReset=npSmokeReset, npIoTrapLineN=npIoTrapLineN, npThermoValuePrecise=npThermoValuePrecise, npIrReset=npIrReset, npRelHumTempValue=npRelHumTempValue, npGsmFailed=npGsmFailed, npRelHumTrapTemp=npRelHumTrapTemp, npThermoLow=npThermoLow, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeEntry=npSmokeEntry, npGsmRegistration=npGsmRegistration, npRelHumStatus=npRelHumStatus, npCurLoopTable=npCurLoopTable, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeSensorN=npSmokeSensorN, npTrapInfo=npTrapInfo, npThermoSensorN=npThermoSensorN, npRelHumTrapData=npRelHumTrapData, npSmokeStatus=npSmokeStatus, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIrPlayCmd=npIrPlayCmd, npIoLevelIn=npIoLevelIn, npRelayState=npRelayState, npRelHumTempStatus=npRelHumTempStatus, npRelHumN=npRelHumN, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTable=npSmokeTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIrCtrl=npIrCtrl, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTrapPrefix=npIoTrapPrefix, npThermoStatus=npThermoStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoop=npCurLoop, npRelHumTrapFail=npRelHumTrapFail, npGsmTrapPrefix=npGsmTrapPrefix, npThermoValue=npThermoValue, npIo=npIo, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapValue=npThermoTrapValue, npGsmTrap=npGsmTrap, npIoLineN=npIoLineN, npCurLoopStatus=npCurLoopStatus, npCurLoopR=npCurLoopR, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopPower=npCurLoopPower, npSmokeMemo=npSmokeMemo, npIoSinglePulseStart=npIoSinglePulseStart, npGsmSendSmsWin1251=npGsmSendSmsWin1251)
