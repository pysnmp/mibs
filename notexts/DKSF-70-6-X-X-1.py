...
# Produced by pysmi-1.1.12 at Wed Oct  9 02:22:48 2024
...
Gauge32, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, NotificationType, Unsigned32, Counter32, TimeTicks, Integer32, IpAddress, Bits, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "NotificationType", "Unsigned32", "Counter32", "TimeTicks", "Integer32", "IpAddress", "Bits", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrap=npThermoTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayTable=npRelayTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoMemo=npIoMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapLow=npThermoTrapLow, npCurLoopTable=npCurLoopTable, npIoLineN=npIoLineN, npIrCtrl=npIrCtrl, npReboot=npReboot, npRelHumTrapTempFail=npRelHumTrapTempFail, npIrReset=npIrReset, npGsmInfo=npGsmInfo, npGsmFailed=npGsmFailed, npIoLevelIn=npIoLevelIn, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npForcedReboot=npForcedReboot, npCurLoopV=npCurLoopV, npSmokeReset=npSmokeReset, npSmokeTrapMemo=npSmokeTrapMemo, npRelayMode=npRelayMode, npCurLoopEntry=npCurLoopEntry, npThermoValue=npThermoValue, npRelHumTrap=npRelHumTrap, npSoftReboot=npSoftReboot, npIoSinglePulseStart=npIoSinglePulseStart, npGsmStrength=npGsmStrength, npRelHumTrapSafe=npRelHumTrapSafe, npResetStack=npResetStack, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTraps=npCurLoopTraps, npRelHumTrapFail=npRelHumTrapFail, npRelayState=npRelayState, npRelHumValue=npRelHumValue, npRelHumTempValue=npRelHumTempValue, npGsmTrap=npGsmTrap, npThermoEntry=npThermoEntry, npThermoMemo=npThermoMemo, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoStatus=npThermoStatus, npCurLoopR=npCurLoopR, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npTrapEmailTo=npTrapEmailTo, npRelHumEntry=npRelHumEntry, npGsm=npGsm, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoLow=npThermoLow, npRelHumMemo=npRelHumMemo, npIoTrapMemo=npIoTrapMemo, npRelHumTrapData=npRelHumTrapData, npCurLoopStatus=npCurLoopStatus, npSmokeStatus=npSmokeStatus, npIo=npIo, npIoSinglePulseDuration=npIoSinglePulseDuration, npIrStatus=npIrStatus, npCurLoopN=npCurLoopN, npRelayStartReset=npRelayStartReset, npThermoTable=npThermoTable, npCurLoopPower=npCurLoopPower, npCurLoopTrapI=npCurLoopTrapI, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapR=npCurLoopTrapR, npRelayEntry=npRelayEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoHigh=npThermoHigh, npCurLoopI=npCurLoopI, npGsmTraps=npGsmTraps, npSmokeMemo=npSmokeMemo, npIoLevelOut=npIoLevelOut, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapStatus=npThermoTrapStatus, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapV=npCurLoopTrapV, npSmokeTable=npSmokeTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTrap=npSmokeTrap, npIr=npIr, npRelay=npRelay, npSmokeTraps=npSmokeTraps, npRelHumTable=npRelHumTable, npIoTable=npIoTable, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoSensorN=npThermoSensorN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoPulseCounter=npIoPulseCounter, npRelHumidity=npRelHumidity, npSmokePower=npSmokePower, npThermoValuePrecise=npThermoValuePrecise, FixedPoint1000=FixedPoint1000, npIoEntry=npIoEntry, npCurLoop=npCurLoop, lightcom=lightcom, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npTrapInfo=npTrapInfo, npRelHumStatus=npRelHumStatus, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapHigh=npThermoTrapHigh, npRelHumTempStatus=npRelHumTempStatus, npThermo=npThermo, npSmokeEntry=npSmokeEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumN=npRelHumN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTraps=npIoTraps, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmoke=npSmoke, npGsmRegistration=npGsmRegistration, npRelayN=npRelayN, npRelHumTrapDataN=npRelHumTrapDataN, npRelayMemo=npRelayMemo, npIoTrap=npIoTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapLineN=npIoTrapLineN, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTraps=npThermoTraps, npIoTrapPrefix=npIoTrapPrefix, npSmokeSensorN=npSmokeSensorN, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents)
