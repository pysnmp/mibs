...
# Produced by pysmi-1.1.12 at Tue Jun  4 13:54:59 2024
...
Gauge32, MibIdentifier, IpAddress, Counter32, TimeTicks, iso, Unsigned32, Counter64, Integer32, NotificationType, ModuleIdentity, Bits, enterprises, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "IpAddress", "Counter32", "TimeTicks", "iso", "Unsigned32", "Counter64", "Integer32", "NotificationType", "ModuleIdentity", "Bits", "enterprises", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumValue=npRelHumValue, npIr=npIr, npThermoTraps=npThermoTraps, npSmokeTable=npSmokeTable, npIrStatus=npIrStatus, npGsmRegistration=npGsmRegistration, npThermoTable=npThermoTable, npForcedReboot=npForcedReboot, npRelayMemo=npRelayMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeStatus=npSmokeStatus, npGsmStrength=npGsmStrength, npThermoTrap=npThermoTrap, npRelHumEntry=npRelHumEntry, npIoTrap=npIoTrap, npGsmTrap=npGsmTrap, npRelHumStatus=npRelHumStatus, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeSensorN=npSmokeSensorN, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumMemo=npRelHumMemo, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapPrefix=npThermoTrapPrefix, npRelayTable=npRelayTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopEntry=npCurLoopEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoStatus=npThermoStatus, npRelayState=npRelayState, npResetStack=npResetStack, npRelHumTrap=npRelHumTrap, npIoEntry=npIoEntry, npIoTable=npIoTable, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoop=npCurLoop, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopStatus=npCurLoopStatus, npSmokeEntry=npSmokeEntry, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTable=npRelHumTable, npSmokeTraps=npSmokeTraps, npRelHumTempStatus=npRelHumTempStatus, npCurLoopV=npCurLoopV, npSmokePower=npSmokePower, npIrCtrl=npIrCtrl, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrapLineN=npIoTrapLineN, npSmokeMemo=npSmokeMemo, npRelayStartReset=npRelayStartReset, npThermoSensorN=npThermoSensorN, npTrapInfo=npTrapInfo, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTrap=npSmokeTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmFailed=npGsmFailed, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npThermoValue=npThermoValue, npCurLoopTraps=npCurLoopTraps, npCurLoopI=npCurLoopI, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoSinglePulseStart=npIoSinglePulseStart, npReboot=npReboot, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmInfo=npGsmInfo, npThermoTrapMemo=npThermoTrapMemo, npThermoLow=npThermoLow, npIoLineN=npIoLineN, npGsmTraps=npGsmTraps, npRelHumidity=npRelHumidity, npRelay=npRelay, npIoMemo=npIoMemo, npIoTraps=npIoTraps, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, FixedPoint1000=FixedPoint1000, npRelHumTrapData=npRelHumTrapData, npIrPlayCmd=npIrPlayCmd, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopN=npCurLoopN, npThermoEntry=npThermoEntry, npCurLoopPower=npCurLoopPower, npIoPulseCounter=npIoPulseCounter, npSmokeReset=npSmokeReset, npCurLoopTrap=npCurLoopTrap, npIoTrapLevelIn=npIoTrapLevelIn, npSmoke=npSmoke, npRelHumTempValue=npRelHumTempValue, npRelayEntry=npRelayEntry, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapHigh=npThermoTrapHigh, npSmokeTrapStatus=npSmokeTrapStatus, npRelayN=npRelayN, npCurLoopTable=npCurLoopTable, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoLevelIn=npIoLevelIn, npThermoMemo=npThermoMemo, npThermoTrapLow=npThermoTrapLow, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumN=npRelHumN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIo=npIo, npTrapEmailTo=npTrapEmailTo, npRelayMode=npRelayMode, npIrReset=npIrReset, npCurLoopR=npCurLoopR, npGsm=npGsm, npIoLevelOut=npIoLevelOut, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, lightcom=lightcom, npCurLoopTrapV=npCurLoopTrapV, npSoftReboot=npSoftReboot, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoHigh=npThermoHigh, npThermo=npThermo, npGsmTrapPrefix=npGsmTrapPrefix)
