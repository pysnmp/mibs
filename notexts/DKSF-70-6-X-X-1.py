...
# Produced by pysmi-1.1.12 at Tue May 28 12:15:47 2024
...
ModuleIdentity, TimeTicks, Counter32, Gauge32, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, enterprises, Unsigned32, MibIdentifier, NotificationType, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "Counter32", "Gauge32", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "enterprises", "Unsigned32", "MibIdentifier", "NotificationType", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTable=npSmokeTable, npIoTrap=npIoTrap, npRelayState=npRelayState, npRelHumTrap=npRelHumTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopEntry=npCurLoopEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoop=npCurLoop, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopN=npCurLoopN, npRelHumTempValue=npRelHumTempValue, npIr=npIr, npCurLoopTrapStatus=npCurLoopTrapStatus, npTrapInfo=npTrapInfo, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelay=npRelay, npCurLoopPower=npCurLoopPower, npSmokeReset=npSmokeReset, npRelHumEntry=npRelHumEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeEntry=npSmokeEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoEntry=npThermoEntry, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIrCtrl=npIrCtrl, npCurLoopV=npCurLoopV, npRelayMode=npRelayMode, npThermoHigh=npThermoHigh, npRelHumMemo=npRelHumMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayStartReset=npRelayStartReset, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrapLow=npThermoTrapLow, npThermoTable=npThermoTable, npCurLoopTrapPower=npCurLoopTrapPower, FixedPoint1000=FixedPoint1000, npThermoStatus=npThermoStatus, npThermoSensorN=npThermoSensorN, npRelHumTrapDataN=npRelHumTrapDataN, npThermoMemo=npThermoMemo, npIo=npIo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapV=npCurLoopTrapV, npThermoValue=npThermoValue, npSmoke=npSmoke, npSmokeStatus=npSmokeStatus, npIoTable=npIoTable, npRelayTable=npRelayTable, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmFailed=npGsmFailed, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrReset=npIrReset, npIoLineN=npIoLineN, npGsm=npGsm, npIoSinglePulseStart=npIoSinglePulseStart, npResetStack=npResetStack, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoLow=npThermoLow, npThermoTrap=npThermoTrap, npThermo=npThermo, npGsmStrength=npGsmStrength, lightcom=lightcom, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapMemo=npIoTrapMemo, npCurLoopR=npCurLoopR, npIoTraps=npIoTraps, npIrPlayCmd=npIrPlayCmd, npCurLoopTraps=npCurLoopTraps, npRelHumTable=npRelHumTable, npCurLoopTrap=npCurLoopTrap, npReboot=npReboot, npCurLoopTrapR=npCurLoopTrapR, npIoPulseCounter=npIoPulseCounter, npSoftReboot=npSoftReboot, npIoMemo=npIoMemo, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTraps=npThermoTraps, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapMemo=npThermoTrapMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapSafe=npRelHumTrapSafe, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTraps=npSmokeTraps, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTable=npCurLoopTable, npRelHumTrapData=npRelHumTrapData, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoValuePrecise=npThermoValuePrecise, npRelHumN=npRelHumN, npIoEntry=npIoEntry, npRelHumStatus=npRelHumStatus, npIoLevelIn=npIoLevelIn, npThermoTrapStatus=npThermoTrapStatus, npIrStatus=npIrStatus, npCurLoopTrapI=npCurLoopTrapI, npIoTrapPrefix=npIoTrapPrefix, npRelayMemo=npRelayMemo, npRelHumidity=npRelHumidity, npRelayEntry=npRelayEntry, npRelayN=npRelayN, npGsmRegistration=npGsmRegistration, npIoLevelOut=npIoLevelOut, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopI=npCurLoopI, npThermoTrapHigh=npThermoTrapHigh, npSmokeTrap=npSmokeTrap, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeMemo=npSmokeMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmTraps=npGsmTraps, npGsmInfo=npGsmInfo, npSmokeSensorN=npSmokeSensorN, npIoTrapLineN=npIoTrapLineN, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapN=npCurLoopTrapN, npForcedReboot=npForcedReboot, npSmokePower=npSmokePower, npGsmTrapPrefix=npGsmTrapPrefix, npGsmTrap=npGsmTrap, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumValue=npRelHumValue)
