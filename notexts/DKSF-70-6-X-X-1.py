...
ObjectIdentity, Unsigned32, Gauge32, Counter32, Integer32, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, enterprises, ModuleIdentity, NotificationType, Bits, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "Gauge32", "Counter32", "Integer32", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "enterprises", "ModuleIdentity", "NotificationType", "Bits", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopI=npCurLoopI, npRelayState=npRelayState, npSmokeTrap=npSmokeTrap, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumMemo=npRelHumMemo, npCurLoopTable=npCurLoopTable, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTrapLevelIn=npIoTrapLevelIn, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayN=npRelayN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIr=npIr, npRelayStartReset=npRelayStartReset, npCurLoopV=npCurLoopV, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSoftReboot=npSoftReboot, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmoke=npSmoke, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermo=npThermo, npCurLoopPower=npCurLoopPower, npThermoEntry=npThermoEntry, npGsmTrap=npGsmTrap, npSmokeStatus=npSmokeStatus, npThermoStatus=npThermoStatus, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoMemo=npThermoMemo, npSmokeReset=npSmokeReset, npSmokeTable=npSmokeTable, npThermoTable=npThermoTable, npCurLoopN=npCurLoopN, npThermoLow=npThermoLow, npRelHumTrapTemp=npRelHumTrapTemp, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumEntry=npRelHumEntry, npResetStack=npResetStack, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoValue=npThermoValue, npIrCtrl=npIrCtrl, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTraps=npCurLoopTraps, npForcedReboot=npForcedReboot, npRelayMemo=npRelayMemo, npCurLoopTrapN=npCurLoopTrapN, npGsmInfo=npGsmInfo, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTempSafe=npRelHumTrapTempSafe, FixedPoint1000=FixedPoint1000, npIoLevelOut=npIoLevelOut, npIrStatus=npIrStatus, npGsmRegistration=npGsmRegistration, npIoMemo=npIoMemo, npRelHumValue=npRelHumValue, npCurLoopTrap=npCurLoopTrap, npCurLoop=npCurLoop, npIoTrap=npIoTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokePower=npSmokePower, npRelHumStatus=npRelHumStatus, npRelHumidity=npRelHumidity, npIoTrapLineN=npIoTrapLineN, npIoTable=npIoTable, npThermoHigh=npThermoHigh, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTraps=npThermoTraps, npRelHumTable=npRelHumTable, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrap=npRelHumTrap, npThermoTrap=npThermoTrap, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmFailed=npGsmFailed, npRelHumTrapFail=npRelHumTrapFail, npReboot=npReboot, npIoTraps=npIoTraps, npGsm=npGsm, npRelHumTempStatus=npRelHumTempStatus, npIoPulseCounter=npIoPulseCounter, npThermoTrapStatus=npThermoTrapStatus, npSmokeMemo=npSmokeMemo, lightcom=lightcom, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmStrength=npGsmStrength, npCurLoopStatus=npCurLoopStatus, npIo=npIo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npTrapEmailTo=npTrapEmailTo, npIrReset=npIrReset, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopEntry=npCurLoopEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayTable=npRelayTable, npThermoSensorN=npThermoSensorN, npRelHumN=npRelHumN, npRelay=npRelay, npThermoTrapMemo=npThermoTrapMemo, npIoEntry=npIoEntry, npSmokeTrapMemo=npSmokeTrapMemo, npTrapInfo=npTrapInfo, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTrapMemo=npIoTrapMemo, npSmokeSensorN=npSmokeSensorN, npIoLevelIn=npIoLevelIn, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTraps=npSmokeTraps, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapValue=npThermoTrapValue, npIrPlayCmd=npIrPlayCmd, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopR=npCurLoopR, npIoLineN=npIoLineN, npRelayEntry=npRelayEntry, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapR=npCurLoopTrapR, npSmokeEntry=npSmokeEntry, npRelayMode=npRelayMode, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmTraps=npGsmTraps)
