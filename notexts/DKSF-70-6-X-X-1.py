...
iso, MibIdentifier, NotificationType, Counter32, Gauge32, Bits, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, ObjectIdentity, Unsigned32, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "NotificationType", "Counter32", "Gauge32", "Bits", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "ObjectIdentity", "Unsigned32", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmTrap=npGsmTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopPower=npCurLoopPower, npTrapInfo=npTrapInfo, npRelHumValue=npRelHumValue, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopI=npCurLoopI, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoPulseCounter=npIoPulseCounter, npRelayN=npRelayN, npIoTrapPrefix=npIoTrapPrefix, npCurLoopStatus=npCurLoopStatus, npThermoMemo=npThermoMemo, npGsmInfo=npGsmInfo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumMemo=npRelHumMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrapI=npCurLoopTrapI, npIoTraps=npIoTraps, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeTraps=npSmokeTraps, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopR=npCurLoopR, npSmokeTrap=npSmokeTrap, npThermoTraps=npThermoTraps, npRelHumStatus=npRelHumStatus, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapR=npCurLoopTrapR, npIoLevelIn=npIoLevelIn, npCurLoopTrapPower=npCurLoopTrapPower, npIo=npIo, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npIoTable=npIoTable, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayTable=npRelayTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoLow=npThermoLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapData=npRelHumTrapData, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoSensorN=npThermoSensorN, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoLevelOut=npIoLevelOut, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmRegistration=npGsmRegistration, npSmokeMemo=npSmokeMemo, npCurLoopV=npCurLoopV, npTrapEmailTo=npTrapEmailTo, npGsm=npGsm, npIrCtrl=npIrCtrl, npSmokeStatus=npSmokeStatus, npCurLoopTrapN=npCurLoopTrapN, npSmokePower=npSmokePower, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeEntry=npSmokeEntry, npCurLoopN=npCurLoopN, npRelay=npRelay, npRelayMemo=npRelayMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmFailed=npGsmFailed, npIrReset=npIrReset, npGsmStrength=npGsmStrength, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumidity=npRelHumidity, npRelayState=npRelayState, npThermoTrapHigh=npThermoTrapHigh, npGsmTraps=npGsmTraps, FixedPoint1000=FixedPoint1000, npThermo=npThermo, npThermoValuePrecise=npThermoValuePrecise, npIoLineN=npIoLineN, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTable=npThermoTable, npIr=npIr, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrap=npIoTrap, npRelHumEntry=npRelHumEntry, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoop=npCurLoop, npResetStack=npResetStack, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoStatus=npThermoStatus, npThermoTrapPrefix=npThermoTrapPrefix, npIoMemo=npIoMemo, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapV=npCurLoopTrapV, npIoEntry=npIoEntry, npReboot=npReboot, npIoTrapLineN=npIoTrapLineN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataN=npRelHumTrapDataN, lightcom=lightcom, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoValue=npThermoValue, npThermoEntry=npThermoEntry, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTable=npCurLoopTable, npRelHumN=npRelHumN, npRelayEntry=npRelayEntry, npCurLoopTrap=npCurLoopTrap, npIrPlayCmd=npIrPlayCmd, npRelayMode=npRelayMode, npRelayStartReset=npRelayStartReset, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npForcedReboot=npForcedReboot, npSoftReboot=npSoftReboot, npSmokeReset=npSmokeReset, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIrStatus=npIrStatus, npRelHumTempStatus=npRelHumTempStatus, npRelHumTable=npRelHumTable, npSmoke=npSmoke, npThermoHigh=npThermoHigh, npThermoTrap=npThermoTrap, npRelHumTrap=npRelHumTrap, npThermoTrapValue=npThermoTrapValue, npRelHumTempValue=npRelHumTempValue, npThermoTrapLow=npThermoTrapLow, npSmokeTable=npSmokeTable, npSmokeSensorN=npSmokeSensorN)
