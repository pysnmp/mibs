...
Counter64, Unsigned32, IpAddress, enterprises, Bits, ObjectIdentity, ModuleIdentity, Integer32, TimeTicks, Counter32, MibIdentifier, NotificationType, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Unsigned32", "IpAddress", "enterprises", "Bits", "ObjectIdentity", "ModuleIdentity", "Integer32", "TimeTicks", "Counter32", "MibIdentifier", "NotificationType", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapValue=npThermoTrapValue, npIoPulseCounter=npIoPulseCounter, npReboot=npReboot, npCurLoopTrapPower=npCurLoopTrapPower, npIoLineN=npIoLineN, npIoTrapLineN=npIoTrapLineN, npRelayStartReset=npRelayStartReset, npRelHumTrapFail=npRelHumTrapFail, npRelHumTempValue=npRelHumTempValue, npGsmTraps=npGsmTraps, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTable=npCurLoopTable, npCurLoopN=npCurLoopN, npRelHumMemo=npRelHumMemo, npGsmTrapPrefix=npGsmTrapPrefix, npRelayTable=npRelayTable, npThermoTraps=npThermoTraps, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapSensorN=npThermoTrapSensorN, npRelayN=npRelayN, npSmokePower=npSmokePower, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTraps=npSmokeTraps, npIoSinglePulseStart=npIoSinglePulseStart, npIoTable=npIoTable, npThermoTrapMemo=npThermoTrapMemo, npIoTrapMemo=npIoTrapMemo, npRelHumidity=npRelHumidity, npCurLoopR=npCurLoopR, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeSensorN=npSmokeSensorN, npCurLoopStatus=npCurLoopStatus, npCurLoopV=npCurLoopV, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapI=npCurLoopTrapI, npIoTraps=npIoTraps, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIrPlayCmd=npIrPlayCmd, npIrStatus=npIrStatus, npIoLevelOut=npIoLevelOut, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoStatus=npThermoStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeStatus=npSmokeStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTable=npRelHumTable, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermo=npThermo, npIoMemo=npIoMemo, npIrReset=npIrReset, npRelHumTrapSafe=npRelHumTrapSafe, npSoftReboot=npSoftReboot, npThermoValue=npThermoValue, npIoTrap=npIoTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmRegistration=npGsmRegistration, npCurLoopEntry=npCurLoopEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoHigh=npThermoHigh, npTrapInfo=npTrapInfo, npSmokeTable=npSmokeTable, npIo=npIo, npRelayMode=npRelayMode, npCurLoopTrapN=npCurLoopTrapN, npSmoke=npSmoke, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoop=npCurLoop, npThermoTable=npThermoTable, npGsmTrap=npGsmTrap, npIrCtrl=npIrCtrl, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npResetStack=npResetStack, npRelayState=npRelayState, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmFailed=npGsmFailed, npRelay=npRelay, lightcom=lightcom, npRelHumEntry=npRelHumEntry, npTrapEmailTo=npTrapEmailTo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmInfo=npGsmInfo, npIoLevelIn=npIoLevelIn, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumN=npRelHumN, npSmokeMemo=npSmokeMemo, npCurLoopTrapV=npCurLoopTrapV, npRelayEntry=npRelayEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumValue=npRelHumValue, npRelayMemo=npRelayMemo, npForcedReboot=npForcedReboot, npIr=npIr, npSmokeEntry=npSmokeEntry, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapR=npCurLoopTrapR, npSmokeReset=npSmokeReset, npRelHumTrap=npRelHumTrap, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapLow=npThermoTrapLow, FixedPoint1000=FixedPoint1000, npThermoTrap=npThermoTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTrap=npSmokeTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopPower=npCurLoopPower, npThermoMemo=npThermoMemo, npRelHumStatus=npRelHumStatus, npIoEntry=npIoEntry, npThermoEntry=npThermoEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopI=npCurLoopI, npCurLoopTrap=npCurLoopTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoLow=npThermoLow, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmStrength=npGsmStrength, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsm=npGsm, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoSensorN=npThermoSensorN)
