...
# Produced by pysmi-1.1.8 at Tue Jul 26 16:52:13 2022
...
iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, Bits, Counter64, MibIdentifier, TimeTicks, NotificationType, ObjectIdentity, IpAddress, Counter32, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "Bits", "Counter64", "MibIdentifier", "TimeTicks", "NotificationType", "ObjectIdentity", "IpAddress", "Counter32", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", lightcom=lightcom, npThermoSensorN=npThermoSensorN, npGsmFailed=npGsmFailed, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrReset=npIrReset, npRelayStartReset=npRelayStartReset, npRelayEntry=npRelayEntry, npThermoTraps=npThermoTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTrap=npSmokeTrap, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTable=npRelHumTable, npSmokeStatus=npSmokeStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmTrap=npGsmTrap, npIoEntry=npIoEntry, npGsmTraps=npGsmTraps, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapValue=npThermoTrapValue, npThermoTrapMemo=npThermoTrapMemo, npIoSinglePulseStart=npIoSinglePulseStart, npSmoke=npSmoke, npThermoHigh=npThermoHigh, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapHigh=npThermoTrapHigh, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumEntry=npRelHumEntry, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrap=npCurLoopTrap, npIo=npIo, npThermoMemo=npThermoMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumValue=npRelHumValue, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumStatus=npRelHumStatus, npIoTable=npIoTable, npRelHumTempValue=npRelHumTempValue, npIrPlayCmd=npIrPlayCmd, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapLineN=npIoTrapLineN, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIr=npIr, npSmokeTable=npSmokeTable, npCurLoopN=npCurLoopN, npIoTrapLevelIn=npIoTrapLevelIn, npThermoValuePrecise=npThermoValuePrecise, npCurLoopEntry=npCurLoopEntry, npCurLoopTable=npCurLoopTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTraps=npSmokeTraps, npRelayTable=npRelayTable, npIoLevelOut=npIoLevelOut, npIoMemo=npIoMemo, npRelHumTempStatus=npRelHumTempStatus, npIoLevelIn=npIoLevelIn, npForcedReboot=npForcedReboot, npTrapEmailTo=npTrapEmailTo, npGsmInfo=npGsmInfo, npRelayN=npRelayN, npRelay=npRelay, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumidity=npRelHumidity, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTable=npThermoTable, npIoPulseCounter=npIoPulseCounter, npSmokePower=npSmokePower, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeReset=npSmokeReset, npGsmTrapPrefix=npGsmTrapPrefix, npResetStack=npResetStack, npCurLoopR=npCurLoopR, npSmokeSensorN=npSmokeSensorN, npThermoLow=npThermoLow, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrap=npThermoTrap, npCurLoopI=npCurLoopI, npRelayMode=npRelayMode, npGsmStrength=npGsmStrength, npIoTrapMemo=npIoTrapMemo, npCurLoopV=npCurLoopV, npSoftReboot=npSoftReboot, npCurLoop=npCurLoop, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrap=npRelHumTrap, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTemp=npRelHumTrapTemp, npIoLineN=npIoLineN, npTrapInfo=npTrapInfo, npThermoStatus=npThermoStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsm=npGsm, npRelHumN=npRelHumN, npIoTraps=npIoTraps, FixedPoint1000=FixedPoint1000, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopPower=npCurLoopPower, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrapV=npCurLoopTrapV, npSmokeEntry=npSmokeEntry, npIrStatus=npIrStatus, npReboot=npReboot, npCurLoopStatus=npCurLoopStatus, npSmokeMemo=npSmokeMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapSensorN=npThermoTrapSensorN, npIrCtrl=npIrCtrl, npRelHumMemo=npRelHumMemo, npGsmRegistration=npGsmRegistration, npRelHumTrapData=npRelHumTrapData, npThermoValue=npThermoValue, npThermo=npThermo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayMemo=npRelayMemo, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapR=npCurLoopTrapR, npRelayState=npRelayState, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoEntry=npThermoEntry, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrap=npIoTrap)
