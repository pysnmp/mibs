...
ModuleIdentity, MibIdentifier, Integer32, IpAddress, TimeTicks, Counter32, NotificationType, enterprises, Counter64, iso, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "Integer32", "IpAddress", "TimeTicks", "Counter32", "NotificationType", "enterprises", "Counter64", "iso", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIr=npIr, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoValuePrecise=npThermoValuePrecise, npTrapEmailTo=npTrapEmailTo, npIoEntry=npIoEntry, npThermoTrapSensorN=npThermoTrapSensorN, npIoLevelIn=npIoLevelIn, npIoTrapPrefix=npIoTrapPrefix, npGsmRegistration=npGsmRegistration, npIrReset=npIrReset, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIrPlayCmd=npIrPlayCmd, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapStatus=npThermoTrapStatus, npRelayEntry=npRelayEntry, npThermoTable=npThermoTable, npCurLoopI=npCurLoopI, npGsmFailed=npGsmFailed, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapAllEvents=npRelHumTrapAllEvents, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTrapStatus=npSmokeTrapStatus, npRelayStartReset=npRelayStartReset, npCurLoopPower=npCurLoopPower, npRelHumTrapSafe=npRelHumTrapSafe, npGsmTrap=npGsmTrap, npThermoLow=npThermoLow, npRelHumTrapData=npRelHumTrapData, npThermoTrapLow=npThermoTrapLow, FixedPoint1000=FixedPoint1000, npThermoTraps=npThermoTraps, npSmokeTrap=npSmokeTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrap=npCurLoopTrap, npRelayMode=npRelayMode, npIo=npIo, npCurLoopTraps=npCurLoopTraps, npSmokeReset=npSmokeReset, npThermoTrap=npThermoTrap, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoSensorN=npThermoSensorN, npCurLoopEntry=npCurLoopEntry, npRelHumMemo=npRelHumMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTraps=npIoTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumN=npRelHumN, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapLineN=npIoTrapLineN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapI=npCurLoopTrapI, npForcedReboot=npForcedReboot, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoStatus=npThermoStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopN=npCurLoopN, npIoTrapMemo=npIoTrapMemo, npCurLoopTable=npCurLoopTable, npTrapInfo=npTrapInfo, npRelayN=npRelayN, npCurLoop=npCurLoop, npRelay=npRelay, npIoPulseCounter=npIoPulseCounter, lightcom=lightcom, npThermoTrapMemo=npThermoTrapMemo, npResetStack=npResetStack, npIoLineN=npIoLineN, npSoftReboot=npSoftReboot, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeMemo=npSmokeMemo, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapR=npCurLoopTrapR, npIrStatus=npIrStatus, npIoSinglePulseStart=npIoSinglePulseStart, npIoLevelOut=npIoLevelOut, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrap=npRelHumTrap, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumStatus=npRelHumStatus, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopR=npCurLoopR, npRelayState=npRelayState, npRelHumTempStatus=npRelHumTempStatus, npIoTrap=npIoTrap, npIoTable=npIoTable, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTable=npSmokeTable, npRelHumEntry=npRelHumEntry, npIoMemo=npIoMemo, npThermoEntry=npThermoEntry, npRelHumTempValue=npRelHumTempValue, npRelayMemo=npRelayMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npReboot=npReboot, npCurLoopV=npCurLoopV, npIrCtrl=npIrCtrl, npGsmStrength=npGsmStrength, npRelHumTable=npRelHumTable, npRelHumValue=npRelHumValue, npGsm=npGsm, npThermoHigh=npThermoHigh, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopStatus=npCurLoopStatus, npThermoTrapHigh=npThermoTrapHigh, npGsmInfo=npGsmInfo, npSmokePower=npSmokePower, npThermoValue=npThermoValue, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoMemo=npThermoMemo, npThermo=npThermo, npCurLoopTrapV=npCurLoopTrapV, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeEntry=npSmokeEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeStatus=npSmokeStatus, npSmokeSensorN=npSmokeSensorN, npSmokeTraps=npSmokeTraps, npRelayTable=npRelayTable, npSmoke=npSmoke, npRelHumidity=npRelHumidity, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmTraps=npGsmTraps)
