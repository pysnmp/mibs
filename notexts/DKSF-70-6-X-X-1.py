...
Gauge32, Counter32, IpAddress, TimeTicks, Unsigned32, NotificationType, Integer32, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, enterprises, MibIdentifier, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "IpAddress", "TimeTicks", "Unsigned32", "NotificationType", "Integer32", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "enterprises", "MibIdentifier", "ModuleIdentity", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeReset=npSmokeReset, npIo=npIo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapValue=npThermoTrapValue, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTraps=npThermoTraps, npRelayState=npRelayState, npThermoSensorN=npThermoSensorN, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapSafe=npRelHumTrapSafe, npGsm=npGsm, npIoTrapPrefix=npIoTrapPrefix, npForcedReboot=npForcedReboot, npThermoTable=npThermoTable, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmFailed=npGsmFailed, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrap=npSmokeTrap, npSmokeTraps=npSmokeTraps, npRelHumEntry=npRelHumEntry, npIoTraps=npIoTraps, npSoftReboot=npSoftReboot, npGsmTrap=npGsmTrap, npRelayEntry=npRelayEntry, npRelayMode=npRelayMode, npRelayTable=npRelayTable, npReboot=npReboot, npSmokeMemo=npSmokeMemo, npGsmInfo=npGsmInfo, npIr=npIr, npThermoValuePrecise=npThermoValuePrecise, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapMemo=npIoTrapMemo, npIrReset=npIrReset, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoMemo=npIoMemo, npCurLoopV=npCurLoopV, npTrapInfo=npTrapInfo, npSmokeStatus=npSmokeStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTable=npCurLoopTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeEntry=npSmokeEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopEntry=npCurLoopEntry, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapI=npCurLoopTrapI, npResetStack=npResetStack, npThermoTrap=npThermoTrap, npRelHumTable=npRelHumTable, npTrapEmailTo=npTrapEmailTo, npSmokeTrapStatus=npSmokeTrapStatus, npThermoHigh=npThermoHigh, npThermoTrapHigh=npThermoTrapHigh, npIoTrapLineN=npIoTrapLineN, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopStatus=npCurLoopStatus, npSmoke=npSmoke, npCurLoopI=npCurLoopI, npRelHumTempValue=npRelHumTempValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrap=npIoTrap, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopN=npCurLoopN, npThermoLow=npThermoLow, npThermoMemo=npThermoMemo, npRelay=npRelay, npThermoStatus=npThermoStatus, npCurLoopPower=npCurLoopPower, npIoLevelOut=npIoLevelOut, npThermoTrapStatus=npThermoTrapStatus, lightcom=lightcom, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTable=npSmokeTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapMemo=npThermoTrapMemo, npRelHumValue=npRelHumValue, npThermo=npThermo, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIrStatus=npIrStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrCtrl=npIrCtrl, npThermoTrapSensorN=npThermoTrapSensorN, npSmokePower=npSmokePower, npIoTable=npIoTable, npRelHumidity=npRelHumidity, npRelHumTrapData=npRelHumTrapData, npRelayN=npRelayN, npIoLineN=npIoLineN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoEntry=npThermoEntry, npThermoValue=npThermoValue, npCurLoop=npCurLoop, npRelHumTrap=npRelHumTrap, npGsmRegistration=npGsmRegistration, npGsmTraps=npGsmTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmStrength=npGsmStrength, npIrPlayCmd=npIrPlayCmd, npRelayMemo=npRelayMemo, npRelayStartReset=npRelayStartReset, npIoLevelIn=npIoLevelIn, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTraps=npCurLoopTraps, npRelHumStatus=npRelHumStatus, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoEntry=npIoEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopR=npCurLoopR, npIoPulseCounter=npIoPulseCounter, npSmokeSensorN=npSmokeSensorN, npRelHumN=npRelHumN, npRelHumTrapDataN=npRelHumTrapDataN, FixedPoint1000=FixedPoint1000, npRelHumMemo=npRelHumMemo)
