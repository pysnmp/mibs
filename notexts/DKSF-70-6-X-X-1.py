...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:07:16 2021
...
Counter32, iso, NotificationType, TimeTicks, ObjectIdentity, Gauge32, IpAddress, enterprises, Unsigned32, Bits, Counter64, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "NotificationType", "TimeTicks", "ObjectIdentity", "Gauge32", "IpAddress", "enterprises", "Unsigned32", "Bits", "Counter64", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmRegistration=npGsmRegistration, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npTrapEmailTo=npTrapEmailTo, npGsm=npGsm, npRelHumidity=npRelHumidity, npIrCtrl=npIrCtrl, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTraps=npSmokeTraps, npCurLoop=npCurLoop, npThermoValue=npThermoValue, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrap=npRelHumTrap, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIr=npIr, npThermoHigh=npThermoHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapFail=npRelHumTrapFail, npGsmTrapPrefix=npGsmTrapPrefix, npGsmTrap=npGsmTrap, npRelayMemo=npRelayMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, FixedPoint1000=FixedPoint1000, npSmokeTrap=npSmokeTrap, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoSinglePulseDuration=npIoSinglePulseDuration, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapLow=npThermoTrapLow, npIrReset=npIrReset, npRelayTable=npRelayTable, npIoLevelOut=npIoLevelOut, npThermoTable=npThermoTable, npCurLoopTrapR=npCurLoopTrapR, npRelHumTable=npRelHumTable, npCurLoopN=npCurLoopN, npThermoEntry=npThermoEntry, npRelHumTrapTemp=npRelHumTrapTemp, npIoTraps=npIoTraps, npRelayEntry=npRelayEntry, npIoTable=npIoTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npTrapInfo=npTrapInfo, npCurLoopV=npCurLoopV, npThermoTrapStatus=npThermoTrapStatus, npRelayN=npRelayN, npRelHumStatus=npRelHumStatus, npThermo=npThermo, npCurLoopTrap=npCurLoopTrap, npIrPlayCmd=npIrPlayCmd, npSmokeTable=npSmokeTable, npRelHumEntry=npRelHumEntry, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataN=npRelHumTrapDataN, lightcom=lightcom, npThermoTrapValue=npThermoTrapValue, npSmokeSensorN=npSmokeSensorN, npRelHumN=npRelHumN, npCurLoopI=npCurLoopI, npIoLineN=npIoLineN, npSmokeMemo=npSmokeMemo, npRelay=npRelay, npGsmInfo=npGsmInfo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokePower=npSmokePower, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSoftReboot=npSoftReboot, npRelayMode=npRelayMode, npIoTrapLineN=npIoTrapLineN, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayStartReset=npRelayStartReset, npThermoLow=npThermoLow, npCurLoopPower=npCurLoopPower, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapPower=npCurLoopTrapPower, npGsmTraps=npGsmTraps, npCurLoopTraps=npCurLoopTraps, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumValue=npRelHumValue, npSmokeEntry=npSmokeEntry, npSmokeReset=npSmokeReset, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapN=npCurLoopTrapN, npIrStatus=npIrStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoStatus=npThermoStatus, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTempStatus=npRelHumTempStatus, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIo=npIo, npGsmFailed=npGsmFailed, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelayState=npRelayState, npReboot=npReboot, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapSafe=npRelHumTrapSafe, npIoMemo=npIoMemo, npCurLoopStatus=npCurLoopStatus, npSmoke=npSmoke, npThermoTrap=npThermoTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapLevelIn=npIoTrapLevelIn, npIoLevelIn=npIoLevelIn, npIoEntry=npIoEntry, npIoTrap=npIoTrap, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapHigh=npThermoTrapHigh, npGsmStrength=npGsmStrength, npCurLoopR=npCurLoopR, npCurLoopTable=npCurLoopTable, npRelHumMemo=npRelHumMemo, npResetStack=npResetStack, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npForcedReboot=npForcedReboot, npThermoMemo=npThermoMemo, npThermoSensorN=npThermoSensorN, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapData=npRelHumTrapData, npThermoTraps=npThermoTraps, npSmokeStatus=npSmokeStatus, npSmokeTrapPrefix=npSmokeTrapPrefix)
