...
# Produced by pysmi-1.1.8 at Wed Sep  6 13:54:50 2023
...
TimeTicks, iso, enterprises, MibIdentifier, Integer32, Bits, ModuleIdentity, ObjectIdentity, NotificationType, Gauge32, Counter32, Counter64, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "enterprises", "MibIdentifier", "Integer32", "Bits", "ModuleIdentity", "ObjectIdentity", "NotificationType", "Gauge32", "Counter32", "Counter64", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapFail=npRelHumTrapFail, npSmokeEntry=npSmokeEntry, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTraps=npThermoTraps, npSmokeTrapMemo=npSmokeTrapMemo, npGsmStrength=npGsmStrength, npRelHumTrapTemp=npRelHumTrapTemp, npResetStack=npResetStack, npThermoTrapSensorN=npThermoTrapSensorN, npSmokePower=npSmokePower, npRelayStartReset=npRelayStartReset, npThermoLow=npThermoLow, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapAllEvents=npRelHumTrapAllEvents, uniPingServerSolutionV3=uniPingServerSolutionV3, lightcom=lightcom, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoPulseCounter=npIoPulseCounter, npIrStatus=npIrStatus, npRelHumN=npRelHumN, npSmokeStatus=npSmokeStatus, npRelayN=npRelayN, npGsmTraps=npGsmTraps, npThermoHigh=npThermoHigh, npGsmRegistration=npGsmRegistration, npIoLevelOut=npIoLevelOut, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, FixedPoint1000=FixedPoint1000, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmTrap=npGsmTrap, npThermoEntry=npThermoEntry, npRelHumEntry=npRelHumEntry, npThermo=npThermo, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npGsmTrapPrefix=npGsmTrapPrefix, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoValue=npThermoValue, npSmoke=npSmoke, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTrapStatus=npSmokeTrapStatus, npIoLineN=npIoLineN, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapData=npRelHumTrapData, npRelayMode=npRelayMode, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSoftReboot=npSoftReboot, npIr=npIr, npCurLoopEntry=npCurLoopEntry, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelay=npRelay, npThermoTrap=npThermoTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayMemo=npRelayMemo, npThermoTable=npThermoTable, npCurLoopV=npCurLoopV, npCurLoopTrapN=npCurLoopTrapN, npIrReset=npIrReset, npSmokeTable=npSmokeTable, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrap=npCurLoopTrap, npIoTrapPrefix=npIoTrapPrefix, npRelayState=npRelayState, npRelayEntry=npRelayEntry, npIrCtrl=npIrCtrl, npRelHumTable=npRelHumTable, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapSafe=npRelHumTrapSafe, npIoLevelIn=npIoLevelIn, npThermoValuePrecise=npThermoValuePrecise, npThermoSensorN=npThermoSensorN, npForcedReboot=npForcedReboot, npRelHumTrap=npRelHumTrap, npReboot=npReboot, npThermoTrapStatus=npThermoTrapStatus, npCurLoop=npCurLoop, npIoTable=npIoTable, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoEntry=npIoEntry, npIrPlayCmd=npIrPlayCmd, npTrapInfo=npTrapInfo, npCurLoopN=npCurLoopN, npCurLoopTrapI=npCurLoopTrapI, npRelHumStatus=npRelHumStatus, npIoTrapMemo=npIoTrapMemo, npIoTrapLineN=npIoTrapLineN, npGsm=npGsm, npGsmInfo=npGsmInfo, npCurLoopTraps=npCurLoopTraps, npGsmFailed=npGsmFailed, npRelHumMemo=npRelHumMemo, npSmokeReset=npSmokeReset, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTraps=npIoTraps, npCurLoopPower=npCurLoopPower, npCurLoopTable=npCurLoopTable, npSmokeTrap=npSmokeTrap, npSmokeSensorN=npSmokeSensorN, npCurLoopR=npCurLoopR, npRelayTable=npRelayTable, npThermoTrapMemo=npThermoTrapMemo, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapValue=npThermoTrapValue, npSmokeMemo=npSmokeMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumValue=npRelHumValue, npIoMemo=npIoMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTrap=npIoTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopI=npCurLoopI, npThermoMemo=npThermoMemo, npThermoStatus=npThermoStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIo=npIo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumidity=npRelHumidity, npSmokeTraps=npSmokeTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapPower=npCurLoopTrapPower)
