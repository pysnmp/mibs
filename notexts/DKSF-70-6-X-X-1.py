...
MibIdentifier, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, Integer32, iso, TimeTicks, Counter64, IpAddress, enterprises, ObjectIdentity, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "Integer32", "iso", "TimeTicks", "Counter64", "IpAddress", "enterprises", "ObjectIdentity", "Unsigned32", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopR=npCurLoopR, npIoEntry=npIoEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsm=npGsm, npThermoLow=npThermoLow, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapHigh=npThermoTrapHigh, npIoPulseCounter=npIoPulseCounter, npCurLoopV=npCurLoopV, npThermoEntry=npThermoEntry, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTraps=npCurLoopTraps, npRelayEntry=npRelayEntry, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapR=npCurLoopTrapR, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTable=npCurLoopTable, npTrapEmailTo=npTrapEmailTo, npSmokeTrapSensorN=npSmokeTrapSensorN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumValue=npRelHumValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTrapStatus=npSmokeTrapStatus, lightcom=lightcom, npCurLoopPower=npCurLoopPower, npRelayN=npRelayN, npSmokeTable=npSmokeTable, npRelHumTrapFail=npRelHumTrapFail, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTraps=npThermoTraps, npRelHumTrapData=npRelHumTrapData, npThermoTrap=npThermoTrap, npIoTrapLevelIn=npIoTrapLevelIn, npGsmRegistration=npGsmRegistration, npRelHumTempValue=npRelHumTempValue, npSmoke=npSmoke, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoLevelIn=npIoLevelIn, npGsmInfo=npGsmInfo, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopI=npCurLoopI, npGsmFailed=npGsmFailed, npIr=npIr, npGsmStrength=npGsmStrength, npThermoStatus=npThermoStatus, npGsmTraps=npGsmTraps, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoMemo=npIoMemo, npForcedReboot=npForcedReboot, npSmokePower=npSmokePower, npIoTrapLineN=npIoTrapLineN, npCurLoopN=npCurLoopN, npIoLevelOut=npIoLevelOut, npRelayMode=npRelayMode, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIrPlayCmd=npIrPlayCmd, npIoSinglePulseStart=npIoSinglePulseStart, npThermoHigh=npThermoHigh, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapN=npCurLoopTrapN, npSmokeMemo=npSmokeMemo, npSmokeStatus=npSmokeStatus, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeReset=npSmokeReset, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTable=npIoTable, npSoftReboot=npSoftReboot, FixedPoint1000=FixedPoint1000, npThermoMemo=npThermoMemo, npRelHumMemo=npRelHumMemo, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrap=npCurLoopTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayTable=npRelayTable, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIrStatus=npIrStatus, npThermoTrapMemo=npThermoTrapMemo, npRelHumStatus=npRelHumStatus, npRelHumTrapDataN=npRelHumTrapDataN, npRelayState=npRelayState, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapMemo=npIoTrapMemo, npRelHumTable=npRelHumTable, npIrCtrl=npIrCtrl, npRelHumEntry=npRelHumEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumN=npRelHumN, npThermoTable=npThermoTable, npIrReset=npIrReset, npRelayMemo=npRelayMemo, npCurLoop=npCurLoop, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrap=npRelHumTrap, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapStatus=npCurLoopTrapStatus, npReboot=npReboot, npIoTraps=npIoTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTraps=npSmokeTraps, npIo=npIo, npThermoTrapValue=npThermoTrapValue, npIoLineN=npIoLineN, npThermoValue=npThermoValue, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapV=npCurLoopTrapV, npTrapInfo=npTrapInfo, npThermoSensorN=npThermoSensorN, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapI=npCurLoopTrapI, npRelay=npRelay, npSmokeTrap=npSmokeTrap, npCurLoopStatus=npCurLoopStatus, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrap=npIoTrap, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermo=npThermo, npResetStack=npResetStack, npRelayStartReset=npRelayStartReset, npGsmTrap=npGsmTrap, npIoTrapPrefix=npIoTrapPrefix, npSmokeEntry=npSmokeEntry, npRelHumidity=npRelHumidity)
