...
TimeTicks, Counter32, ModuleIdentity, Integer32, Bits, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, MibIdentifier, Counter64, ObjectIdentity, NotificationType, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "ModuleIdentity", "Integer32", "Bits", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "MibIdentifier", "Counter64", "ObjectIdentity", "NotificationType", "Unsigned32", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIrReset=npIrReset, npIr=npIr, npIoTraps=npIoTraps, npCurLoop=npCurLoop, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrStatus=npIrStatus, npThermoStatus=npThermoStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npForcedReboot=npForcedReboot, npIoLineN=npIoLineN, npRelHumStatus=npRelHumStatus, npRelayState=npRelayState, npCurLoopTrapI=npCurLoopTrapI, npGsmInfo=npGsmInfo, npRelHumTrapFail=npRelHumTrapFail, npIoTrapLevelIn=npIoTrapLevelIn, npThermoSensorN=npThermoSensorN, npSmoke=npSmoke, npSmokeMemo=npSmokeMemo, npThermoLow=npThermoLow, npTrapEmailTo=npTrapEmailTo, npGsmTraps=npGsmTraps, npSmokeTraps=npSmokeTraps, npRelayStartReset=npRelayStartReset, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrap=npRelHumTrap, npResetStack=npResetStack, npCurLoopTraps=npCurLoopTraps, npSmokeReset=npSmokeReset, npRelHumTempValue=npRelHumTempValue, npSmokeTable=npSmokeTable, npSmokeSensorN=npSmokeSensorN, npRelayTable=npRelayTable, npGsmFailed=npGsmFailed, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsm=npGsm, npRelayMode=npRelayMode, lightcom=lightcom, npThermoValuePrecise=npThermoValuePrecise, npIoLevelIn=npIoLevelIn, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIrPlayCmd=npIrPlayCmd, npGsmTrap=npGsmTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayEntry=npRelayEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTemp=npRelHumTrapTemp, npThermoEntry=npThermoEntry, npIoTrap=npIoTrap, npGsmStrength=npGsmStrength, npRelHumTable=npRelHumTable, FixedPoint1000=FixedPoint1000, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npTrapInfo=npTrapInfo, npCurLoopTrap=npCurLoopTrap, npSmokeStatus=npSmokeStatus, npCurLoopI=npCurLoopI, npRelHumEntry=npRelHumEntry, npThermo=npThermo, npRelHumN=npRelHumN, npIoTable=npIoTable, npThermoTraps=npThermoTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoMemo=npThermoMemo, npRelHumMemo=npRelHumMemo, npIo=npIo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoLevelOut=npIoLevelOut, npThermoTrapLow=npThermoTrapLow, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTrapMemo=npSmokeTrapMemo, npReboot=npReboot, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokePower=npSmokePower, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoMemo=npIoMemo, npCurLoopN=npCurLoopN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapHigh=npThermoTrapHigh, npSoftReboot=npSoftReboot, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapStatus=npThermoTrapStatus, npGsmRegistration=npGsmRegistration, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapN=npCurLoopTrapN, npGsmTrapPrefix=npGsmTrapPrefix, npRelayN=npRelayN, npCurLoopV=npCurLoopV, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayMemo=npRelayMemo, npCurLoopStatus=npCurLoopStatus, npCurLoopPower=npCurLoopPower, npSmokeEntry=npSmokeEntry, npCurLoopTable=npCurLoopTable, npSmokeTrap=npSmokeTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrapMemo=npThermoTrapMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrap=npThermoTrap, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoEntry=npIoEntry, npIoTrapLineN=npIoTrapLineN, npRelHumTrapData=npRelHumTrapData, npIoPulseCounter=npIoPulseCounter, npRelHumidity=npRelHumidity, npRelHumValue=npRelHumValue, npThermoValue=npThermoValue, npCurLoopEntry=npCurLoopEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIrCtrl=npIrCtrl, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTable=npThermoTable, npRelay=npRelay, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoHigh=npThermoHigh, npRelHumTempStatus=npRelHumTempStatus, npCurLoopR=npCurLoopR)
