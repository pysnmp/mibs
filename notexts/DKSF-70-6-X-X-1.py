...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:38:03 2021
...
Bits, IpAddress, Unsigned32, TimeTicks, enterprises, Counter32, NotificationType, ModuleIdentity, iso, MibIdentifier, Counter64, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "Unsigned32", "TimeTicks", "enterprises", "Counter32", "NotificationType", "ModuleIdentity", "iso", "MibIdentifier", "Counter64", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataN=npRelHumTrapDataN, npThermoSensorN=npThermoSensorN, npRelayN=npRelayN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrap=npRelHumTrap, npRelHumTable=npRelHumTable, npReboot=npReboot, npCurLoopV=npCurLoopV, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeEntry=npSmokeEntry, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapV=npCurLoopTrapV, npSmokeTable=npSmokeTable, npCurLoopTrapN=npCurLoopTrapN, npSmokeReset=npSmokeReset, npRelHumMemo=npRelHumMemo, npRelay=npRelay, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrap=npCurLoopTrap, npThermoEntry=npThermoEntry, npGsm=npGsm, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrapLevelLegend=npIoTrapLevelLegend, npSoftReboot=npSoftReboot, npGsmTrap=npGsmTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataValue=npRelHumTrapDataValue, npResetStack=npResetStack, npCurLoopR=npCurLoopR, npRelayStartReset=npRelayStartReset, npIoLevelOut=npIoLevelOut, npRelHumN=npRelHumN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTable=npCurLoopTable, npSmokeTrap=npSmokeTrap, npCurLoopN=npCurLoopN, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapFail=npRelHumTrapFail, npSmokeMemo=npSmokeMemo, npIoTrapLevelIn=npIoTrapLevelIn, npIr=npIr, npForcedReboot=npForcedReboot, npIo=npIo, npGsmInfo=npGsmInfo, npThermoTrapPrefix=npThermoTrapPrefix, npIrReset=npIrReset, npIoTraps=npIoTraps, npRelHumValue=npRelHumValue, npRelHumStatus=npRelHumStatus, npThermoValue=npThermoValue, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIrCtrl=npIrCtrl, npThermoTrap=npThermoTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapSafe=npRelHumTrapSafe, npSmokePower=npSmokePower, npRelayState=npRelayState, npIoTrapLineN=npIoTrapLineN, npRelayMode=npRelayMode, npCurLoop=npCurLoop, npSmokeStatus=npSmokeStatus, npThermoLow=npThermoLow, npIoTable=npIoTable, npRelayEntry=npRelayEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopPower=npCurLoopPower, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTraps=npThermoTraps, npRelHumidity=npRelHumidity, npGsmFailed=npGsmFailed, npIoTrap=npIoTrap, npRelayMemo=npRelayMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrPlayCmd=npIrPlayCmd, npSmokeTraps=npSmokeTraps, npGsmRegistration=npGsmRegistration, npIoEntry=npIoEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTempStatus=npRelHumTempStatus, npGsmStrength=npGsmStrength, npGsmTrapPrefix=npGsmTrapPrefix, npThermoHigh=npThermoHigh, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopI=npCurLoopI, npIoLevelIn=npIoLevelIn, npCurLoopEntry=npCurLoopEntry, npThermoTrapLow=npThermoTrapLow, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapData=npRelHumTrapData, npTrapEmailTo=npTrapEmailTo, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempValue=npRelHumTempValue, npIrStatus=npIrStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelayTable=npRelayTable, lightcom=lightcom, npCurLoopTraps=npCurLoopTraps, npIoTrapMemo=npIoTrapMemo, npThermoTable=npThermoTable, npIoMemo=npIoMemo, FixedPoint1000=FixedPoint1000, npSmoke=npSmoke, npThermoMemo=npThermoMemo, npRelHumEntry=npRelHumEntry, npThermoTrapValue=npThermoTrapValue, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npTrapInfo=npTrapInfo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoPulseCounter=npIoPulseCounter, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoStatus=npThermoStatus, npGsmTraps=npGsmTraps, npThermo=npThermo, npIoLineN=npIoLineN, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapStatus=npThermoTrapStatus)
