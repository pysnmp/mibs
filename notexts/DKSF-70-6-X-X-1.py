...
# Produced by pysmi-1.1.8 at Thu Jan  5 14:50:55 2023
...
enterprises, IpAddress, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, Bits, ModuleIdentity, Unsigned32, MibIdentifier, Integer32, iso, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "IpAddress", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "Bits", "ModuleIdentity", "Unsigned32", "MibIdentifier", "Integer32", "iso", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", FixedPoint1000=FixedPoint1000, npRelHumidity=npRelHumidity, npGsmStrength=npGsmStrength, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopEntry=npCurLoopEntry, npGsmInfo=npGsmInfo, npIoTrapPrefix=npIoTrapPrefix, npRelayTable=npRelayTable, npThermoTraps=npThermoTraps, npSmokeTrapStatus=npSmokeTrapStatus, npRelayState=npRelayState, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayN=npRelayN, npSmokeEntry=npSmokeEntry, npCurLoopTable=npCurLoopTable, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIr=npIr, npGsmTrap=npGsmTrap, npThermoTrap=npThermoTrap, npCurLoopTrapN=npCurLoopTrapN, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapValue=npThermoTrapValue, npCurLoopR=npCurLoopR, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrap=npRelHumTrap, npForcedReboot=npForcedReboot, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermo=npThermo, npIoTrapMemo=npIoTrapMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopPower=npCurLoopPower, npIrStatus=npIrStatus, npTrapInfo=npTrapInfo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoEntry=npThermoEntry, npThermoTrapSensorN=npThermoTrapSensorN, npIoMemo=npIoMemo, npRelHumMemo=npRelHumMemo, npGsm=npGsm, npSmokeTable=npSmokeTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTable=npIoTable, npCurLoopI=npCurLoopI, npThermoTable=npThermoTable, npThermoValue=npThermoValue, npGsmTraps=npGsmTraps, npIoEntry=npIoEntry, npSmokeMemo=npSmokeMemo, npCurLoopV=npCurLoopV, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIo=npIo, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTraps=npSmokeTraps, npIoLevelIn=npIoLevelIn, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeReset=npSmokeReset, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopN=npCurLoopN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopStatus=npCurLoopStatus, npSmokeStatus=npSmokeStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTempStatus=npRelHumTempStatus, npSmoke=npSmoke, npCurLoopTrapV=npCurLoopTrapV, npThermoMemo=npThermoMemo, npIrCtrl=npIrCtrl, npThermoTrapMemo=npThermoTrapMemo, npGsmRegistration=npGsmRegistration, npSoftReboot=npSoftReboot, npIoLineN=npIoLineN, npRelHumN=npRelHumN, npRelayMode=npRelayMode, npCurLoop=npCurLoop, npRelHumEntry=npRelHumEntry, npIoPulseCounter=npIoPulseCounter, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumStatus=npRelHumStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapSafe=npRelHumTrapSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIrReset=npIrReset, npRelHumValue=npRelHumValue, npRelHumTempValue=npRelHumTempValue, npIoTrap=npIoTrap, npCurLoopTrap=npCurLoopTrap, npThermoTrapPrefix=npThermoTrapPrefix, npThermoLow=npThermoLow, npThermoHigh=npThermoHigh, npCurLoopTrapR=npCurLoopTrapR, npRelayEntry=npRelayEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmFailed=npGsmFailed, npRelHumTrapDataN=npRelHumTrapDataN, npRelay=npRelay, npResetStack=npResetStack, npIoTraps=npIoTraps, npCurLoopTrapPrefix=npCurLoopTrapPrefix, lightcom=lightcom, npThermoSensorN=npThermoSensorN, npIoLevelOut=npIoLevelOut, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npReboot=npReboot, npSmokePower=npSmokePower, npRelayMemo=npRelayMemo, npIrPlayCmd=npIrPlayCmd, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoStatus=npThermoStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoValuePrecise=npThermoValuePrecise, npIoSinglePulseDuration=npIoSinglePulseDuration, npTrapEmailTo=npTrapEmailTo, npSmokeTrap=npSmokeTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapStatus=npThermoTrapStatus, npRelHumTable=npRelHumTable, npRelHumTrapFail=npRelHumTrapFail, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelayStartReset=npRelayStartReset, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTraps=npCurLoopTraps)
