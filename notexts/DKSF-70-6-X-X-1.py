...
IpAddress, ModuleIdentity, Gauge32, Bits, iso, Integer32, NotificationType, ObjectIdentity, Unsigned32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "Gauge32", "Bits", "iso", "Integer32", "NotificationType", "ObjectIdentity", "Unsigned32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrap=npThermoTrap, npRelHumMemo=npRelHumMemo, npIoMemo=npIoMemo, FixedPoint1000=FixedPoint1000, npIoSinglePulseDuration=npIoSinglePulseDuration, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumN=npRelHumN, npSmokeTrapMemo=npSmokeTrapMemo, npIoLineN=npIoLineN, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapLow=npThermoTrapLow, npRelHumTrapData=npRelHumTrapData, npThermoTrapMemo=npThermoTrapMemo, npSmokeReset=npSmokeReset, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayTable=npRelayTable, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTraps=npThermoTraps, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrap=npRelHumTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapHigh=npThermoTrapHigh, npSmokeStatus=npSmokeStatus, npThermoLow=npThermoLow, npTrapEmailTo=npTrapEmailTo, npRelHumEntry=npRelHumEntry, npIr=npIr, npRelayStartReset=npRelayStartReset, npRelHumTrapTemp=npRelHumTrapTemp, npGsm=npGsm, npRelay=npRelay, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTable=npIoTable, npCurLoopN=npCurLoopN, npCurLoopV=npCurLoopV, npThermoValuePrecise=npThermoValuePrecise, npSmokePower=npSmokePower, npRelHumStatus=npRelHumStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrStatus=npIrStatus, npCurLoopTrap=npCurLoopTrap, npIoTraps=npIoTraps, npCurLoopTraps=npCurLoopTraps, npGsmInfo=npGsmInfo, npSmokeEntry=npSmokeEntry, npCurLoopTrapR=npCurLoopTrapR, npIrCtrl=npIrCtrl, npRelayMemo=npRelayMemo, lightcom=lightcom, npThermoTrapValue=npThermoTrapValue, npIoEntry=npIoEntry, npRelayEntry=npRelayEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmTrap=npGsmTrap, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTable=npThermoTable, npRelayMode=npRelayMode, npIo=npIo, npSmokeTraps=npSmokeTraps, npThermoValue=npThermoValue, npThermoHigh=npThermoHigh, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSoftReboot=npSoftReboot, npIoTrapLineN=npIoTrapLineN, npRelayState=npRelayState, npSmoke=npSmoke, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrapPrefix=npSmokeTrapPrefix, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumidity=npRelHumidity, npSmokeSensorN=npSmokeSensorN, npRelHumTable=npRelHumTable, npThermoMemo=npThermoMemo, npRelHumValue=npRelHumValue, npResetStack=npResetStack, npCurLoopEntry=npCurLoopEntry, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoop=npCurLoop, npThermo=npThermo, npCurLoopPower=npCurLoopPower, npTrapInfo=npTrapInfo, npGsmFailed=npGsmFailed, npRelHumTempValue=npRelHumTempValue, npSmokeTable=npSmokeTable, npSmokeMemo=npSmokeMemo, npSmokeTrap=npSmokeTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTable=npCurLoopTable, npIoPulseCounter=npIoPulseCounter, npThermoSensorN=npThermoSensorN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIrReset=npIrReset, npForcedReboot=npForcedReboot, npIoLevelOut=npIoLevelOut, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrapMemo=npIoTrapMemo, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTrap=npIoTrap, npIoLevelIn=npIoLevelIn, npThermoEntry=npThermoEntry, npThermoStatus=npThermoStatus, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTempStatus=npRelHumTempStatus, npGsmStrength=npGsmStrength, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapStatus=npThermoTrapStatus, npCurLoopR=npCurLoopR, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapV=npCurLoopTrapV, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopI=npCurLoopI, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapN=npCurLoopTrapN, npGsmRegistration=npGsmRegistration, npReboot=npReboot, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmTraps=npGsmTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopStatus=npCurLoopStatus, npRelayN=npRelayN)
