...
enterprises, Counter32, NotificationType, MibIdentifier, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Gauge32, Bits, Unsigned32, iso, Integer32, TimeTicks, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "NotificationType", "MibIdentifier", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Gauge32", "Bits", "Unsigned32", "iso", "Integer32", "TimeTicks", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmTraps=npGsmTraps, npCurLoopTraps=npCurLoopTraps, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIr=npIr, npCurLoopV=npCurLoopV, npTrapInfo=npTrapInfo, npGsm=npGsm, npIoMemo=npIoMemo, npThermoTrapMemo=npThermoTrapMemo, npThermoSensorN=npThermoSensorN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoMemo=npThermoMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayMemo=npRelayMemo, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapData=npRelHumTrapData, npRelay=npRelay, npIoLevelIn=npIoLevelIn, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopN=npCurLoopN, npIoTrapLineN=npIoTrapLineN, npRelayTable=npRelayTable, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrap=npIoTrap, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrap=npCurLoopTrap, npCurLoopTable=npCurLoopTable, npRelHumValue=npRelHumValue, npThermoValue=npThermoValue, npResetStack=npResetStack, npRelayStartReset=npRelayStartReset, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeEntry=npSmokeEntry, npIrCtrl=npIrCtrl, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmStrength=npGsmStrength, npCurLoopTrapN=npCurLoopTrapN, npGsmRegistration=npGsmRegistration, npIo=npIo, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoLevelOut=npIoLevelOut, npRelHumTempStatus=npRelHumTempStatus, npIoTrapMemo=npIoTrapMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumidity=npRelHumidity, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayMode=npRelayMode, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapV=npCurLoopTrapV, npRelHumN=npRelHumN, npThermoTrap=npThermoTrap, npSmokeTrapStatus=npSmokeTrapStatus, npGsmInfo=npGsmInfo, npIrStatus=npIrStatus, npIoTraps=npIoTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents, FixedPoint1000=FixedPoint1000, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmFailed=npGsmFailed, npThermoEntry=npThermoEntry, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTable=npRelHumTable, npRelHumTrap=npRelHumTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTable=npThermoTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrapR=npCurLoopTrapR, npRelayN=npRelayN, npThermoHigh=npThermoHigh, npRelHumTrapTemp=npRelHumTrapTemp, npIoTable=npIoTable, npSmokeReset=npSmokeReset, npSmokeMemo=npSmokeMemo, npCurLoopI=npCurLoopI, npCurLoopR=npCurLoopR, npRelHumEntry=npRelHumEntry, npSmokeTraps=npSmokeTraps, npThermoLow=npThermoLow, npSmokePower=npSmokePower, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapStatus=npThermoTrapStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapDataN=npRelHumTrapDataN, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopPower=npCurLoopPower, npSmokeSensorN=npSmokeSensorN, npThermoStatus=npThermoStatus, npSmokeTrap=npSmokeTrap, npSmoke=npSmoke, npCurLoop=npCurLoop, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapPrefix=npThermoTrapPrefix, npThermo=npThermo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayState=npRelayState, npThermoTrapLow=npThermoTrapLow, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapValue=npThermoTrapValue, npThermoTrapHigh=npThermoTrapHigh, npReboot=npReboot, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoEntry=npIoEntry, npGsmTrap=npGsmTrap, npIoTrapPrefix=npIoTrapPrefix, npSmokeTable=npSmokeTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, lightcom=lightcom, npRelHumMemo=npRelHumMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTempValue=npRelHumTempValue, npIrPlayCmd=npIrPlayCmd, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIrReset=npIrReset, npGsmTrapPrefix=npGsmTrapPrefix, npIoLineN=npIoLineN, npIoPulseCounter=npIoPulseCounter, npRelayEntry=npRelayEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeStatus=npSmokeStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapI=npCurLoopTrapI, npSoftReboot=npSoftReboot, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopEntry=npCurLoopEntry, npRelHumStatus=npRelHumStatus, npForcedReboot=npForcedReboot, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTraps=npThermoTraps)
