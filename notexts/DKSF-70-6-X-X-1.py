...
iso, Unsigned32, enterprises, Integer32, ModuleIdentity, Counter64, NotificationType, MibIdentifier, IpAddress, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "enterprises", "Integer32", "ModuleIdentity", "Counter64", "NotificationType", "MibIdentifier", "IpAddress", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTable=npRelHumTable, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumStatus=npRelHumStatus, npRelHumTrap=npRelHumTrap, npThermoEntry=npThermoEntry, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopPower=npCurLoopPower, npReboot=npReboot, npIoTrapLineN=npIoTrapLineN, npRelHumidity=npRelHumidity, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataStatus=npRelHumTrapDataStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapData=npRelHumTrapData, npThermoHigh=npThermoHigh, npThermoSensorN=npThermoSensorN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrCtrl=npIrCtrl, npThermoValue=npThermoValue, npRelHumEntry=npRelHumEntry, npSmokeSensorN=npSmokeSensorN, npThermoMemo=npThermoMemo, npRelHumMemo=npRelHumMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayTable=npRelayTable, npIoMemo=npIoMemo, npCurLoopR=npCurLoopR, npForcedReboot=npForcedReboot, npGsmTraps=npGsmTraps, lightcom=lightcom, npGsm=npGsm, npIr=npIr, npRelayN=npRelayN, npGsmStrength=npGsmStrength, npCurLoopN=npCurLoopN, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIrPlayCmd=npIrPlayCmd, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapLow=npThermoTrapLow, npThermoTrapHigh=npThermoTrapHigh, npThermoTraps=npThermoTraps, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapStatus=npThermoTrapStatus, npIrReset=npIrReset, npCurLoopTrapN=npCurLoopTrapN, FixedPoint1000=FixedPoint1000, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTable=npSmokeTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmRegistration=npGsmRegistration, npRelHumValue=npRelHumValue, npRelHumN=npRelHumN, npRelHumTrapSafe=npRelHumTrapSafe, npIoTraps=npIoTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayMode=npRelayMode, npGsmInfo=npGsmInfo, npCurLoopI=npCurLoopI, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeStatus=npSmokeStatus, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeTraps=npSmokeTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrap=npIoTrap, npThermoTrap=npThermoTrap, npSmokePower=npSmokePower, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermo=npThermo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTable=npThermoTable, npThermoLow=npThermoLow, npIrStatus=npIrStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIo=npIo, npGsmFailed=npGsmFailed, npTrapInfo=npTrapInfo, npRelayStartReset=npRelayStartReset, npRelHumTempValue=npRelHumTempValue, npIoEntry=npIoEntry, npThermoTrapMemo=npThermoTrapMemo, npThermoTrapValue=npThermoTrapValue, npSmokeMemo=npSmokeMemo, npSmokeTrapStatus=npSmokeTrapStatus, npRelayMemo=npRelayMemo, npSmokeReset=npSmokeReset, npResetStack=npResetStack, npRelHumTrapTemp=npRelHumTrapTemp, npRelayState=npRelayState, npIoTrapLevelIn=npIoTrapLevelIn, npGsmTrap=npGsmTrap, npIoLevelOut=npIoLevelOut, npRelayEntry=npRelayEntry, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoop=npCurLoop, npIoLineN=npIoLineN, npIoTrapMemo=npIoTrapMemo, npCurLoopTraps=npCurLoopTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoLevelIn=npIoLevelIn, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTable=npCurLoopTable, npSmokeEntry=npSmokeEntry, npIoPulseCounter=npIoPulseCounter, npCurLoopTrapR=npCurLoopTrapR, npCurLoopEntry=npCurLoopEntry, npSmoke=npSmoke, npThermoStatus=npThermoStatus, npCurLoopV=npCurLoopV, npThermoTrapSensorN=npThermoTrapSensorN, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTrap=npSmokeTrap, npCurLoopTrapV=npCurLoopTrapV, npIoTable=npIoTable, npRelay=npRelay, npThermoTrapPrefix=npThermoTrapPrefix, npSoftReboot=npSoftReboot, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapStatus=npCurLoopTrapStatus)
