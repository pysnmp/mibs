...
# Produced by pysmi-1.1.8 at Thu Oct 26 09:07:49 2023
...
Counter32, ModuleIdentity, TimeTicks, Bits, NotificationType, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, Integer32, ObjectIdentity, Counter64, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "TimeTicks", "Bits", "NotificationType", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "Integer32", "ObjectIdentity", "Counter64", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoop=npCurLoop, npIoSinglePulseStart=npIoSinglePulseStart, npThermoValuePrecise=npThermoValuePrecise, npIoLevelIn=npIoLevelIn, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeTrap=npSmokeTrap, npCurLoopN=npCurLoopN, npIoLevelOut=npIoLevelOut, npCurLoopV=npCurLoopV, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeReset=npSmokeReset, npThermoTrap=npThermoTrap, npRelHumMemo=npRelHumMemo, npRelHumTrap=npRelHumTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTraps=npSmokeTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayState=npRelayState, npSmokeTrapStatus=npSmokeTrapStatus, npSmokePower=npSmokePower, npThermoTable=npThermoTable, npRelayStartReset=npRelayStartReset, npIrStatus=npIrStatus, npSmokeTrapMemo=npSmokeTrapMemo, npRelayEntry=npRelayEntry, npThermoHigh=npThermoHigh, npRelayMode=npRelayMode, FixedPoint1000=FixedPoint1000, npRelHumValue=npRelHumValue, npThermoTraps=npThermoTraps, npRelHumN=npRelHumN, npRelHumTrapSafe=npRelHumTrapSafe, npThermoSensorN=npThermoSensorN, npIoTraps=npIoTraps, npThermoTrapPrefix=npThermoTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeSensorN=npSmokeSensorN, npIrCtrl=npIrCtrl, npTrapInfo=npTrapInfo, npCurLoopTraps=npCurLoopTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopR=npCurLoopR, npRelHumStatus=npRelHumStatus, npCurLoopStatus=npCurLoopStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopEntry=npCurLoopEntry, npSmokeTable=npSmokeTable, npRelayMemo=npRelayMemo, npCurLoopTrapR=npCurLoopTrapR, npThermoLow=npThermoLow, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopI=npCurLoopI, npThermoTrapStatus=npThermoTrapStatus, npIoEntry=npIoEntry, npIoTrap=npIoTrap, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayTable=npRelayTable, npSoftReboot=npSoftReboot, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataN=npRelHumTrapDataN, npForcedReboot=npForcedReboot, npSmoke=npSmoke, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrap=npCurLoopTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeEntry=npSmokeEntry, npCurLoopTrapN=npCurLoopTrapN, npResetStack=npResetStack, npGsmTrap=npGsmTrap, npCurLoopTrapV=npCurLoopTrapV, npThermoStatus=npThermoStatus, npReboot=npReboot, npSmokeStatus=npSmokeStatus, npGsm=npGsm, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTemp=npRelHumTrapTemp, npIoTable=npIoTable, npRelHumidity=npRelHumidity, npCurLoopTrapI=npCurLoopTrapI, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoMemo=npThermoMemo, npRelHumEntry=npRelHumEntry, npRelHumTrapData=npRelHumTrapData, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrapPrefix=npIoTrapPrefix, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmFailed=npGsmFailed, npIr=npIr, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTrapLineN=npIoTrapLineN, npGsmRegistration=npGsmRegistration, npThermo=npThermo, npThermoValue=npThermoValue, npIoTrapMemo=npIoTrapMemo, npRelay=npRelay, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmStrength=npGsmStrength, npIrReset=npIrReset, npIoPulseCounter=npIoPulseCounter, npIoLineN=npIoLineN, npIoMemo=npIoMemo, npCurLoopPower=npCurLoopPower, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoEntry=npThermoEntry, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, lightcom=lightcom, npTrapEmailTo=npTrapEmailTo, npRelHumTempStatus=npRelHumTempStatus, npRelHumTempValue=npRelHumTempValue, npGsmInfo=npGsmInfo, npThermoTrapValue=npThermoTrapValue, npRelayN=npRelayN, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npIo=npIo, npGsmTraps=npGsmTraps, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapLow=npThermoTrapLow, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapFail=npRelHumTrapFail, npSmokeMemo=npSmokeMemo, npRelHumTable=npRelHumTable, npCurLoopTable=npCurLoopTable)
