...
# Produced by pysmi-1.1.12 at Fri Jul 19 08:58:22 2024
...
Bits, IpAddress, Integer32, ModuleIdentity, Unsigned32, MibIdentifier, enterprises, Counter64, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "Integer32", "ModuleIdentity", "Unsigned32", "MibIdentifier", "enterprises", "Counter64", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npTrapInfo=npTrapInfo, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapLineN=npIoTrapLineN, npCurLoopTrap=npCurLoopTrap, npThermoTable=npThermoTable, npCurLoopI=npCurLoopI, npGsmInfo=npGsmInfo, npCurLoopTable=npCurLoopTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmTraps=npGsmTraps, npIrReset=npIrReset, npCurLoopEntry=npCurLoopEntry, npIoPulseCounter=npIoPulseCounter, npIoTrapLevelIn=npIoTrapLevelIn, npThermoHigh=npThermoHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeStatus=npSmokeStatus, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrap=npSmokeTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopPower=npCurLoopPower, npCurLoopTrapPower=npCurLoopTrapPower, npGsmRegistration=npGsmRegistration, lightcom=lightcom, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, FixedPoint1000=FixedPoint1000, npIoMemo=npIoMemo, npRelay=npRelay, npThermoMemo=npThermoMemo, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmTrap=npGsmTrap, npRelayStartReset=npRelayStartReset, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTrapStatus=npSmokeTrapStatus, npForcedReboot=npForcedReboot, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapI=npCurLoopTrapI, npResetStack=npResetStack, npRelayMemo=npRelayMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSoftReboot=npSoftReboot, npReboot=npReboot, npThermoTrap=npThermoTrap, npThermoTrapValue=npThermoTrapValue, npIoTable=npIoTable, npSmokeTraps=npSmokeTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapData=npRelHumTrapData, npThermoTrapMemo=npThermoTrapMemo, npCurLoopStatus=npCurLoopStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopR=npCurLoopR, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokePower=npSmokePower, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumEntry=npRelHumEntry, npThermo=npThermo, npThermoTrapLow=npThermoTrapLow, npRelHumidity=npRelHumidity, npRelayN=npRelayN, npIoEntry=npIoEntry, npIoLevelIn=npIoLevelIn, npCurLoopTraps=npCurLoopTraps, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrap=npRelHumTrap, npIoTraps=npIoTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapV=npCurLoopTrapV, npIoTrap=npIoTrap, npRelayMode=npRelayMode, npGsmStrength=npGsmStrength, npSmokeReset=npSmokeReset, npSmokeEntry=npSmokeEntry, npRelHumTrapDataN=npRelHumTrapDataN, npGsm=npGsm, npRelHumTrapSafe=npRelHumTrapSafe, npSmoke=npSmoke, npIoTrapPrefix=npIoTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeSensorN=npSmokeSensorN, npRelHumTrapFail=npRelHumTrapFail, npThermoTraps=npThermoTraps, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapR=npCurLoopTrapR, npThermoEntry=npThermoEntry, npIrPlayCmd=npIrPlayCmd, npThermoValue=npThermoValue, npIoTrapLevelLegend=npIoTrapLevelLegend, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumN=npRelHumN, npRelHumTrapTemp=npRelHumTrapTemp, npIoLevelOut=npIoLevelOut, npCurLoopV=npCurLoopV, npCurLoopN=npCurLoopN, npIoLineN=npIoLineN, npIoTrapMemo=npIoTrapMemo, npThermoStatus=npThermoStatus, npCurLoop=npCurLoop, npRelHumMemo=npRelHumMemo, npThermoTrapStatus=npThermoTrapStatus, npSmokeMemo=npSmokeMemo, npThermoSensorN=npThermoSensorN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTempValue=npRelHumTempValue, npGsmFailed=npGsmFailed, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumValue=npRelHumValue, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIr=npIr, npIrCtrl=npIrCtrl, npRelayState=npRelayState, npRelayEntry=npRelayEntry, npThermoLow=npThermoLow, npIrStatus=npIrStatus, npRelHumStatus=npRelHumStatus, npSmokeTable=npSmokeTable, npRelHumTempStatus=npRelHumTempStatus, npRelayTable=npRelayTable, npIo=npIo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTable=npRelHumTable, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapPrefix=npCurLoopTrapPrefix)
