...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIrStatus=npIrStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapI=npCurLoopTrapI, npCurLoopV=npCurLoopV, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrap=npCurLoopTrap, npTrapEmailTo=npTrapEmailTo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmRegistration=npGsmRegistration, npSoftReboot=npSoftReboot, npIoTrap=npIoTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, FixedPoint1000=FixedPoint1000, npThermo=npThermo, npIoMemo=npIoMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopI=npCurLoopI, npThermoValue=npThermoValue, npIoPulseCounter=npIoPulseCounter, npGsm=npGsm, npRelHumTable=npRelHumTable, npIrReset=npIrReset, npRelayStartReset=npRelayStartReset, npThermoSensorN=npThermoSensorN, npIoEntry=npIoEntry, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopR=npCurLoopR, npRelay=npRelay, npRelayTable=npRelayTable, npThermoTrapMemo=npThermoTrapMemo, npIo=npIo, npThermoTrapStatus=npThermoTrapStatus, npSmokePower=npSmokePower, npSmokeMemo=npSmokeMemo, npIoTrapLineN=npIoTrapLineN, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumN=npRelHumN, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayState=npRelayState, npSmokeStatus=npSmokeStatus, npIrCtrl=npIrCtrl, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmFailed=npGsmFailed, npRelHumValue=npRelHumValue, npThermoMemo=npThermoMemo, npThermoTrapHigh=npThermoTrapHigh, npThermoStatus=npThermoStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmTrapPrefix=npGsmTrapPrefix, npIoTraps=npIoTraps, npRelayEntry=npRelayEntry, npCurLoopN=npCurLoopN, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopStatus=npCurLoopStatus, npGsmTraps=npGsmTraps, npCurLoopPower=npCurLoopPower, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTraps=npSmokeTraps, npGsmInfo=npGsmInfo, npThermoTrapPrefix=npThermoTrapPrefix, npResetStack=npResetStack, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeReset=npSmokeReset, npThermoTraps=npThermoTraps, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTrapMemo=npIoTrapMemo, npSmokeEntry=npSmokeEntry, npCurLoop=npCurLoop, npRelHumidity=npRelHumidity, npRelHumEntry=npRelHumEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrap=npRelHumTrap, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTemp=npRelHumTrapTemp, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmoke=npSmoke, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoLineN=npIoLineN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopEntry=npCurLoopEntry, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npTrapInfo=npTrapInfo, npThermoHigh=npThermoHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapLow=npThermoTrapLow, npRelHumMemo=npRelHumMemo, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapPower=npCurLoopTrapPower, npIr=npIr, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTrap=npSmokeTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npForcedReboot=npForcedReboot, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayMode=npRelayMode, npThermoTrapValue=npThermoTrapValue, npThermoTrap=npThermoTrap, lightcom=lightcom, npThermoTrapSensorN=npThermoTrapSensorN, npGsmTrap=npGsmTrap, npThermoLow=npThermoLow, npRelHumTempStatus=npRelHumTempStatus, npThermoEntry=npThermoEntry, npRelayN=npRelayN, npSmokeTable=npSmokeTable, npIoLevelOut=npIoLevelOut, npRelHumStatus=npRelHumStatus, npRelHumTempValue=npRelHumTempValue, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapFail=npRelHumTrapFail, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTable=npCurLoopTable, npGsmStrength=npGsmStrength, npSmokeSensorN=npSmokeSensorN, npIoTable=npIoTable, npThermoTable=npThermoTable, npReboot=npReboot, npIoLevelIn=npIoLevelIn, npRelayMemo=npRelayMemo)
