...
# Produced by pysmi-1.1.8 at Fri Jul  8 07:41:40 2022
...
Counter32, TimeTicks, ModuleIdentity, Integer32, NotificationType, ObjectIdentity, enterprises, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, Bits, Counter64, MibIdentifier, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "ModuleIdentity", "Integer32", "NotificationType", "ObjectIdentity", "enterprises", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "Bits", "Counter64", "MibIdentifier", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIrStatus=npIrStatus, npIoTable=npIoTable, npIoMemo=npIoMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmTraps=npGsmTraps, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrap=npRelHumTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapSensorN=npThermoTrapSensorN, npThermo=npThermo, npThermoSensorN=npThermoSensorN, npSoftReboot=npSoftReboot, PYSNMP_MODULE_ID=uniPingServerSolutionV3, lightcom=lightcom, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumMemo=npRelHumMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmoke=npSmoke, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoLevelOut=npIoLevelOut, npThermoTable=npThermoTable, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapMemo=npThermoTrapMemo, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeReset=npSmokeReset, npRelHumidity=npRelHumidity, npGsmRegistration=npGsmRegistration, npRelayState=npRelayState, npCurLoopN=npCurLoopN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapI=npCurLoopTrapI, npIoTrap=npIoTrap, npCurLoopTraps=npCurLoopTraps, npRelHumTrapSafe=npRelHumTrapSafe, npThermoLow=npThermoLow, npForcedReboot=npForcedReboot, npRelayStartReset=npRelayStartReset, FixedPoint1000=FixedPoint1000, npThermoValue=npThermoValue, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataN=npRelHumTrapDataN, npIoEntry=npIoEntry, npSmokeEntry=npSmokeEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTraps=npIoTraps, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapFail=npRelHumTrapFail, npCurLoopPower=npCurLoopPower, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoStatus=npThermoStatus, npSmokeTable=npSmokeTable, npSmokeSensorN=npSmokeSensorN, npGsmTrap=npGsmTrap, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrapLineN=npIoTrapLineN, npSmokeTraps=npSmokeTraps, npCurLoopI=npCurLoopI, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTraps=npThermoTraps, npIoTrapLevelIn=npIoTrapLevelIn, npGsmFailed=npGsmFailed, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopV=npCurLoopV, npCurLoopR=npCurLoopR, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeStatus=npSmokeStatus, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumStatus=npRelHumStatus, npRelHumN=npRelHumN, npIoLevelIn=npIoLevelIn, npGsmSendSmsWin1251=npGsmSendSmsWin1251, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrap=npThermoTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmStrength=npGsmStrength, npRelHumValue=npRelHumValue, npIoLineN=npIoLineN, npTrapEmailTo=npTrapEmailTo, npRelHumEntry=npRelHumEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeMemo=npSmokeMemo, npRelHumTempStatus=npRelHumTempStatus, npReboot=npReboot, npSmokePower=npSmokePower, npRelayEntry=npRelayEntry, npRelayMode=npRelayMode, npThermoHigh=npThermoHigh, npIrReset=npIrReset, npCurLoop=npCurLoop, npThermoTrapHigh=npThermoTrapHigh, npGsmInfo=npGsmInfo, npThermoTrapLow=npThermoTrapLow, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTrap=npSmokeTrap, npRelayMemo=npRelayMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrCtrl=npIrCtrl, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelay=npRelay, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapMemo=npIoTrapMemo, npCurLoopTable=npCurLoopTable, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrap=npCurLoopTrap, npThermoTrapStatus=npThermoTrapStatus, npThermoEntry=npThermoEntry, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npTrapInfo=npTrapInfo, npIr=npIr, npResetStack=npResetStack, npSmokeTrapMemo=npSmokeTrapMemo, npThermoMemo=npThermoMemo, npCurLoopEntry=npCurLoopEntry, npRelHumTable=npRelHumTable, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayN=npRelayN, npIoTrapPrefix=npIoTrapPrefix, npIoPulseCounter=npIoPulseCounter, npRelayTable=npRelayTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTempValue=npRelHumTempValue, npGsm=npGsm, npIo=npIo, npIrPlayCmd=npIrPlayCmd, npGsmSendSmsUtf8=npGsmSendSmsUtf8)
