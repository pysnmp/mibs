...
Counter32, ModuleIdentity, Bits, Integer32, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, NotificationType, Unsigned32, enterprises, TimeTicks, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "Bits", "Integer32", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "NotificationType", "Unsigned32", "enterprises", "TimeTicks", "Gauge32", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTable=npSmokeTable, lightcom=lightcom, npSmokeReset=npSmokeReset, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayMemo=npRelayMemo, npRelHumTempStatus=npRelHumTempStatus, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTable=npRelHumTable, npCurLoopPower=npCurLoopPower, npTrapEmailTo=npTrapEmailTo, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoop=npCurLoop, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumEntry=npRelHumEntry, npGsmRegistration=npGsmRegistration, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrap=npCurLoopTrap, npRelayState=npRelayState, npRelHumStatus=npRelHumStatus, npThermoTrapValue=npThermoTrapValue, npGsmTrap=npGsmTrap, npThermoSensorN=npThermoSensorN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayN=npRelayN, npIrCtrl=npIrCtrl, npRelHumidity=npRelHumidity, npThermoLow=npThermoLow, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeEntry=npSmokeEntry, npSmokePower=npSmokePower, npSmokeTrap=npSmokeTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoMemo=npIoMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npResetStack=npResetStack, npSmokeTraps=npSmokeTraps, npIoTable=npIoTable, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayEntry=npRelayEntry, npCurLoopTraps=npCurLoopTraps, npCurLoopEntry=npCurLoopEntry, npCurLoopR=npCurLoopR, npRelHumTrap=npRelHumTrap, npIoTrapLevelIn=npIoTrapLevelIn, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapStatus=npThermoTrapStatus, npGsmStrength=npGsmStrength, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npReboot=npReboot, npThermoTrap=npThermoTrap, npGsmInfo=npGsmInfo, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTable=npCurLoopTable, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmoke=npSmoke, npGsm=npGsm, npThermoTraps=npThermoTraps, npIoTrap=npIoTrap, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoLineN=npIoLineN, npIrStatus=npIrStatus, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelay=npRelay, npThermoEntry=npThermoEntry, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTemp=npRelHumTrapTemp, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoHigh=npThermoHigh, npIoLevelIn=npIoLevelIn, npSoftReboot=npSoftReboot, npForcedReboot=npForcedReboot, npIoTraps=npIoTraps, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIr=npIr, npIoLevelOut=npIoLevelOut, npThermoMemo=npThermoMemo, npThermoStatus=npThermoStatus, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapI=npCurLoopTrapI, npRelHumValue=npRelHumValue, npSmokeMemo=npSmokeMemo, npRelHumMemo=npRelHumMemo, npRelHumTrapSafe=npRelHumTrapSafe, npRelayTable=npRelayTable, npIrPlayCmd=npIrPlayCmd, npThermoTrapHigh=npThermoTrapHigh, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrapR=npCurLoopTrapR, npIoTrapMemo=npIoTrapMemo, npGsmTraps=npGsmTraps, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeSensorN=npSmokeSensorN, npRelayMode=npRelayMode, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeStatus=npSmokeStatus, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumN=npRelHumN, npCurLoopV=npCurLoopV, npThermo=npThermo, npRelHumTrapData=npRelHumTrapData, npIo=npIo, npIoPulseCounter=npIoPulseCounter, npRelayStartReset=npRelayStartReset, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoEntry=npIoEntry, npThermoTable=npThermoTable, npIoTrapLineN=npIoTrapLineN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIrReset=npIrReset, npGsmFailed=npGsmFailed, FixedPoint1000=FixedPoint1000, npThermoValue=npThermoValue, npCurLoopN=npCurLoopN, npTrapInfo=npTrapInfo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopI=npCurLoopI, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapN=npCurLoopTrapN)
