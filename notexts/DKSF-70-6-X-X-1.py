...
# Produced by pysmi-1.1.8 at Sat Jan 15 05:36:46 2022
...
ModuleIdentity, TimeTicks, enterprises, MibIdentifier, Gauge32, Integer32, iso, IpAddress, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, Bits, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "enterprises", "MibIdentifier", "Gauge32", "Integer32", "iso", "IpAddress", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "Bits", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoMemo=npThermoMemo, npIoEntry=npIoEntry, npCurLoopTrapR=npCurLoopTrapR, npCurLoopN=npCurLoopN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npTrapInfo=npTrapInfo, npIoTable=npIoTable, npIoTraps=npIoTraps, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopEntry=npCurLoopEntry, npRelHumidity=npRelHumidity, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumN=npRelHumN, npGsm=npGsm, npIo=npIo, npThermoTrap=npThermoTrap, npGsmTraps=npGsmTraps, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmStrength=npGsmStrength, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeMemo=npSmokeMemo, npSmokeSensorN=npSmokeSensorN, npCurLoopTrap=npCurLoopTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrapLineN=npIoTrapLineN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTrap=npIoTrap, npSmokeTrapStatus=npSmokeTrapStatus, npGsmTrap=npGsmTrap, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrReset=npIrReset, npThermoTrapHigh=npThermoTrapHigh, npRelay=npRelay, npRelHumTempValue=npRelHumTempValue, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapPower=npCurLoopTrapPower, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeStatus=npSmokeStatus, npTrapEmailTo=npTrapEmailTo, npSmokeReset=npSmokeReset, npIoSinglePulseStart=npIoSinglePulseStart, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeEntry=npSmokeEntry, npResetStack=npResetStack, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopPower=npCurLoopPower, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTable=npRelHumTable, npRelayMemo=npRelayMemo, npCurLoop=npCurLoop, npGsmRegistration=npGsmRegistration, npRelHumMemo=npRelHumMemo, npIoMemo=npIoMemo, npThermoTable=npThermoTable, npIoPulseCounter=npIoPulseCounter, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoLevelOut=npIoLevelOut, npThermoTrapSensorN=npThermoTrapSensorN, npRelayEntry=npRelayEntry, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTable=npCurLoopTable, npRelHumValue=npRelHumValue, npThermoTrapLow=npThermoTrapLow, npSmoke=npSmoke, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoSensorN=npThermoSensorN, npThermoEntry=npThermoEntry, npRelayMode=npRelayMode, npThermo=npThermo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokePower=npSmokePower, npThermoTrapStatus=npThermoTrapStatus, npSoftReboot=npSoftReboot, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopStatus=npCurLoopStatus, npIrPlayCmd=npIrPlayCmd, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTraps=npSmokeTraps, npRelayStartReset=npRelayStartReset, npIoLevelIn=npIoLevelIn, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTrapPrefix=npIoTrapPrefix, npThermoLow=npThermoLow, npThermoValue=npThermoValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeTrap=npSmokeTrap, npCurLoopTraps=npCurLoopTraps, npThermoTraps=npThermoTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumStatus=npRelHumStatus, npThermoStatus=npThermoStatus, npCurLoopTrapI=npCurLoopTrapI, npRelayN=npRelayN, npThermoTrapMemo=npThermoTrapMemo, npIoTrapMemo=npIoTrapMemo, npCurLoopI=npCurLoopI, npReboot=npReboot, npRelayState=npRelayState, npGsmFailed=npGsmFailed, npThermoHigh=npThermoHigh, npRelayTable=npRelayTable, FixedPoint1000=FixedPoint1000, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoLineN=npIoLineN, npIr=npIr, npRelHumEntry=npRelHumEntry, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTrapSensorN=npSmokeTrapSensorN, lightcom=lightcom, npIrCtrl=npIrCtrl, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeTable=npSmokeTable, npGsmInfo=npGsmInfo, npForcedReboot=npForcedReboot, npRelHumTrapData=npRelHumTrapData, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopV=npCurLoopV, npThermoTrapValue=npThermoTrapValue, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrap=npRelHumTrap, npCurLoopR=npCurLoopR, npIrStatus=npIrStatus, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapV=npCurLoopTrapV)
