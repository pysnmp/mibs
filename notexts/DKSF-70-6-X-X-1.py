...
Counter32, Counter64, Bits, IpAddress, ModuleIdentity, Gauge32, enterprises, iso, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, MibIdentifier, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "Bits", "IpAddress", "ModuleIdentity", "Gauge32", "enterprises", "iso", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "MibIdentifier", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoStatus=npThermoStatus, npRelayN=npRelayN, npIrReset=npIrReset, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsm=npGsm, npCurLoopTraps=npCurLoopTraps, npRelHumTempStatus=npRelHumTempStatus, npIrStatus=npIrStatus, npCurLoopTable=npCurLoopTable, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapValue=npThermoTrapValue, npSmokeReset=npSmokeReset, npGsmTraps=npGsmTraps, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrap=npThermoTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoLevelIn=npIoLevelIn, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, uniPingServerSolutionV3=uniPingServerSolutionV3, npTrapInfo=npTrapInfo, npThermoSensorN=npThermoSensorN, npGsmStrength=npGsmStrength, npReboot=npReboot, npRelHumTrapData=npRelHumTrapData, npThermo=npThermo, npRelHumTable=npRelHumTable, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapMemo=npThermoTrapMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayMemo=npRelayMemo, npRelHumidity=npRelHumidity, npSmokeSensorN=npSmokeSensorN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumValue=npRelHumValue, npIrCtrl=npIrCtrl, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapPrefix=npThermoTrapPrefix, lightcom=lightcom, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumMemo=npRelHumMemo, npSmokeMemo=npSmokeMemo, npThermoTable=npThermoTable, FixedPoint1000=FixedPoint1000, npIrPlayCmd=npIrPlayCmd, npIoLevelOut=npIoLevelOut, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoValue=npThermoValue, npCurLoopV=npCurLoopV, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmTrap=npGsmTrap, npRelay=npRelay, npCurLoopTrapI=npCurLoopTrapI, npThermoHigh=npThermoHigh, npRelayStartReset=npRelayStartReset, npIoPulseCounter=npIoPulseCounter, npIoMemo=npIoMemo, npCurLoop=npCurLoop, npSmokeTable=npSmokeTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSoftReboot=npSoftReboot, npResetStack=npResetStack, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTemp=npRelHumTrapTemp, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmRegistration=npGsmRegistration, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTrap=npSmokeTrap, npThermoTrapHigh=npThermoTrapHigh, npThermoValuePrecise=npThermoValuePrecise, npCurLoopStatus=npCurLoopStatus, npSmokeTraps=npSmokeTraps, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokePower=npSmokePower, npForcedReboot=npForcedReboot, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTrap=npIoTrap, npSmokeStatus=npSmokeStatus, npSmoke=npSmoke, npIoEntry=npIoEntry, npIoTable=npIoTable, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataN=npRelHumTrapDataN, npIoTrapMemo=npIoTrapMemo, npIo=npIo, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTrapMemo=npSmokeTrapMemo, npIoTraps=npIoTraps, npRelHumStatus=npRelHumStatus, npRelayTable=npRelayTable, npThermoTraps=npThermoTraps, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoLineN=npIoLineN, npThermoMemo=npThermoMemo, npGsmTrapPrefix=npGsmTrapPrefix, npRelayEntry=npRelayEntry, npRelayState=npRelayState, npThermoTrapLow=npThermoTrapLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoLow=npThermoLow, npCurLoopR=npCurLoopR, npCurLoopEntry=npCurLoopEntry, npGsmFailed=npGsmFailed, npRelHumEntry=npRelHumEntry, npCurLoopTrap=npCurLoopTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopI=npCurLoopI, npThermoEntry=npThermoEntry, npRelHumTempValue=npRelHumTempValue, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrapLineN=npIoTrapLineN, npGsmInfo=npGsmInfo, npRelayMode=npRelayMode, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopN=npCurLoopN, npRelHumN=npRelHumN, npIr=npIr, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrap=npRelHumTrap, npCurLoopPower=npCurLoopPower, npSmokeEntry=npSmokeEntry, npCurLoopTrapR=npCurLoopTrapR)
