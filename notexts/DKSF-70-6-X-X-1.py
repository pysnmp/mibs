...
# Produced by pysmi-1.1.12 at Wed Dec  4 21:18:24 2024
...
iso, Counter64, Gauge32, TimeTicks, ModuleIdentity, MibIdentifier, IpAddress, Unsigned32, NotificationType, enterprises, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter64", "Gauge32", "TimeTicks", "ModuleIdentity", "MibIdentifier", "IpAddress", "Unsigned32", "NotificationType", "enterprises", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrapLineN=npIoTrapLineN, npCurLoopTrapN=npCurLoopTrapN, npCurLoopI=npCurLoopI, npSmokeEntry=npSmokeEntry, npSmokeSensorN=npSmokeSensorN, npCurLoopTrap=npCurLoopTrap, npRelHumTrapSafe=npRelHumTrapSafe, npThermo=npThermo, npSmokeMemo=npSmokeMemo, npRelHumN=npRelHumN, npIoLevelIn=npIoLevelIn, npSmokeTraps=npSmokeTraps, npThermoTrapLow=npThermoTrapLow, npThermoTable=npThermoTable, npCurLoopN=npCurLoopN, npCurLoopV=npCurLoopV, npThermoEntry=npThermoEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapV=npCurLoopTrapV, npCurLoopR=npCurLoopR, npCurLoopStatus=npCurLoopStatus, npRelay=npRelay, npGsmTrap=npGsmTrap, npRelHumEntry=npRelHumEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIrReset=npIrReset, npIoTrap=npIoTrap, npThermoValue=npThermoValue, npSmokePower=npSmokePower, npRelHumTrapFail=npRelHumTrapFail, npRelayMemo=npRelayMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npIr=npIr, lightcom=lightcom, npSmokeStatus=npSmokeStatus, npThermoTrapValue=npThermoTrapValue, npSmokeTrapStatus=npSmokeTrapStatus, npRelayState=npRelayState, uniPingServerSolutionV3=uniPingServerSolutionV3, npResetStack=npResetStack, npIoPulseCounter=npIoPulseCounter, npRelHumTrap=npRelHumTrap, npIoMemo=npIoMemo, npRelayStartReset=npRelayStartReset, npRelayEntry=npRelayEntry, npRelHumTrapDataN=npRelHumTrapDataN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTrap=npSmokeTrap, npTrapEmailTo=npTrapEmailTo, npThermoHigh=npThermoHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumValue=npRelHumValue, npThermoTrapMemo=npThermoTrapMemo, npCurLoopPower=npCurLoopPower, npGsmFailed=npGsmFailed, npSmokeTrapSensorN=npSmokeTrapSensorN, npIrStatus=npIrStatus, npThermoMemo=npThermoMemo, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapData=npRelHumTrapData, npRelHumTable=npRelHumTable, npRelayMode=npRelayMode, npIoEntry=npIoEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsm=npGsm, npGsmStrength=npGsmStrength, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSoftReboot=npSoftReboot, npCurLoopTable=npCurLoopTable, npThermoTrap=npThermoTrap, npRelHumTempValue=npRelHumTempValue, npIoLineN=npIoLineN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, FixedPoint1000=FixedPoint1000, npThermoTrapSensorN=npThermoTrapSensorN, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTraps=npIoTraps, npRelHumMemo=npRelHumMemo, npIoTrapMemo=npIoTrapMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoLow=npThermoLow, npSmoke=npSmoke, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeTrapMemo=npSmokeTrapMemo, npIo=npIo, npGsmTraps=npGsmTraps, npIoSinglePulseStart=npIoSinglePulseStart, npThermoValuePrecise=npThermoValuePrecise, npThermoStatus=npThermoStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapTemp=npRelHumTrapTemp, npGsmRegistration=npGsmRegistration, npIoLevelOut=npIoLevelOut, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTraps=npThermoTraps, npIrPlayCmd=npIrPlayCmd, npSmokeTable=npSmokeTable, npRelayN=npRelayN, npForcedReboot=npForcedReboot, npIrCtrl=npIrCtrl, npCurLoop=npCurLoop, npRelHumTempStatus=npRelHumTempStatus, npGsmInfo=npGsmInfo, npRelayTable=npRelayTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumStatus=npRelHumStatus, npIoTable=npIoTable, npCurLoopTraps=npCurLoopTraps, npRelHumidity=npRelHumidity, npCurLoopTrapPower=npCurLoopTrapPower, npThermoSensorN=npThermoSensorN, npTrapInfo=npTrapInfo, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeReset=npSmokeReset, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npReboot=npReboot, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapR=npCurLoopTrapR)
