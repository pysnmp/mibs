...
Counter64, ModuleIdentity, Unsigned32, MibIdentifier, enterprises, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, NotificationType, Integer32, Bits, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "Unsigned32", "MibIdentifier", "enterprises", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "NotificationType", "Integer32", "Bits", "Gauge32", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopEntry=npCurLoopEntry, npThermoTrapLow=npThermoTrapLow, npSmokeEntry=npSmokeEntry, npSoftReboot=npSoftReboot, npThermoTrapValue=npThermoTrapValue, npIrPlayCmd=npIrPlayCmd, npSmokeSensorN=npSmokeSensorN, npIrStatus=npIrStatus, npIr=npIr, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTable=npRelHumTable, npRelHumEntry=npRelHumEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrap=npIoTrap, npRelayTable=npRelayTable, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, FixedPoint1000=FixedPoint1000, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTraps=npCurLoopTraps, npThermoSensorN=npThermoSensorN, npCurLoopTrapPower=npCurLoopTrapPower, npThermoValue=npThermoValue, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTemp=npRelHumTrapTemp, npResetStack=npResetStack, npGsmInfo=npGsmInfo, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapLevelIn=npIoTrapLevelIn, npIo=npIo, npCurLoopTrapI=npCurLoopTrapI, npThermoTrap=npThermoTrap, npRelHumTrap=npRelHumTrap, npCurLoopStatus=npCurLoopStatus, npIoLevelOut=npIoLevelOut, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoPulseCounter=npIoPulseCounter, npCurLoopTrapR=npCurLoopTrapR, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopN=npCurLoopN, npThermoEntry=npThermoEntry, npIoTraps=npIoTraps, npSmokeMemo=npSmokeMemo, npRelay=npRelay, npRelayEntry=npRelayEntry, npIoLineN=npIoLineN, npThermoMemo=npThermoMemo, npIrReset=npIrReset, npThermoTrapMemo=npThermoTrapMemo, npRelayN=npRelayN, npSmokeStatus=npSmokeStatus, npGsmFailed=npGsmFailed, npIoTable=npIoTable, npCurLoopV=npCurLoopV, npTrapEmailTo=npTrapEmailTo, npThermoStatus=npThermoStatus, npRelHumTrapDataN=npRelHumTrapDataN, npRelayMode=npRelayMode, npCurLoopR=npCurLoopR, npThermoTraps=npThermoTraps, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmStrength=npGsmStrength, npRelHumStatus=npRelHumStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTrapLineN=npIoTrapLineN, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmoke=npSmoke, npSmokeTable=npSmokeTable, npThermoHigh=npThermoHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npReboot=npReboot, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTable=npCurLoopTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapData=npRelHumTrapData, npThermoLow=npThermoLow, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumidity=npRelHumidity, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayState=npRelayState, npIoTrapMemo=npIoTrapMemo, npRelHumTempValue=npRelHumTempValue, npCurLoopPower=npCurLoopPower, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokePower=npSmokePower, npSmokeTraps=npSmokeTraps, npForcedReboot=npForcedReboot, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopI=npCurLoopI, npIoTrapLevelLegend=npIoTrapLevelLegend, npTrapInfo=npTrapInfo, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTable=npThermoTable, npRelayStartReset=npRelayStartReset, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIrCtrl=npIrCtrl, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermo=npThermo, npGsmTraps=npGsmTraps, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapSensorN=npThermoTrapSensorN, npIoLevelIn=npIoLevelIn, npRelHumN=npRelHumN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTrapPrefix=npIoTrapPrefix, lightcom=lightcom, npCurLoopTrapN=npCurLoopTrapN, npIoMemo=npIoMemo, npGsm=npGsm, npIoEntry=npIoEntry, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTrap=npSmokeTrap, npRelayMemo=npRelayMemo, npThermoValuePrecise=npThermoValuePrecise, npRelHumValue=npRelHumValue, npGsmTrap=npGsmTrap, npSmokeReset=npSmokeReset, npRelHumTrapSafe=npRelHumTrapSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoop=npCurLoop, npGsmRegistration=npGsmRegistration, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumMemo=npRelHumMemo)
