...
# Produced by pysmi-1.1.8 at Sat Jan 15 17:30:33 2022
...
ObjectIdentity, NotificationType, TimeTicks, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, enterprises, Bits, Unsigned32, IpAddress, MibIdentifier, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "TimeTicks", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "enterprises", "Bits", "Unsigned32", "IpAddress", "MibIdentifier", "iso", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npTrapEmailTo=npTrapEmailTo, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoEntry=npThermoEntry, npCurLoopTable=npCurLoopTable, npThermoMemo=npThermoMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmStrength=npGsmStrength, npCurLoopStatus=npCurLoopStatus, npThermoTrap=npThermoTrap, npThermoTrapValue=npThermoTrapValue, npRelHumMemo=npRelHumMemo, npRelHumTrapData=npRelHumTrapData, npRelHumStatus=npRelHumStatus, npGsmFailed=npGsmFailed, npCurLoopN=npCurLoopN, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTrap=npIoTrap, npThermoValuePrecise=npThermoValuePrecise, npThermo=npThermo, npGsm=npGsm, npSoftReboot=npSoftReboot, npIrCtrl=npIrCtrl, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumEntry=npRelHumEntry, npGsmRegistration=npGsmRegistration, npIoTable=npIoTable, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopV=npCurLoopV, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayStartReset=npRelayStartReset, npCurLoopPower=npCurLoopPower, npRelHumTrapTempFail=npRelHumTrapTempFail, npIo=npIo, npRelayMode=npRelayMode, npRelHumN=npRelHumN, npCurLoopTrap=npCurLoopTrap, npIrPlayCmd=npIrPlayCmd, npIoLineN=npIoLineN, npSmokeTable=npSmokeTable, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapLineN=npIoTrapLineN, npThermoTable=npThermoTable, npIrReset=npIrReset, npForcedReboot=npForcedReboot, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapStatus=npThermoTrapStatus, npThermoLow=npThermoLow, npIoPulseCounter=npIoPulseCounter, npRelHumValue=npRelHumValue, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTrapPrefix=npIoTrapPrefix, npThermoTraps=npThermoTraps, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapPower=npCurLoopTrapPower, npRelay=npRelay, npRelHumTempStatus=npRelHumTempStatus, npTrapInfo=npTrapInfo, npCurLoop=npCurLoop, npResetStack=npResetStack, npRelayMemo=npRelayMemo, npSmokeSensorN=npSmokeSensorN, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumidity=npRelHumidity, npSmokeTrap=npSmokeTrap, npRelHumTrap=npRelHumTrap, npCurLoopTrapI=npCurLoopTrapI, npIoTraps=npIoTraps, npGsmInfo=npGsmInfo, npRelHumTable=npRelHumTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoMemo=npIoMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayN=npRelayN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmTrap=npGsmTrap, npIoTrapMemo=npIoTrapMemo, npGsmTraps=npGsmTraps, npSmokeEntry=npSmokeEntry, npIr=npIr, npThermoHigh=npThermoHigh, npReboot=npReboot, npCurLoopTrapR=npCurLoopTrapR, npIoEntry=npIoEntry, npSmokeStatus=npSmokeStatus, npIoLevelOut=npIoLevelOut, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapN=npCurLoopTrapN, npRelHumTempValue=npRelHumTempValue, npCurLoopR=npCurLoopR, npSmokeTraps=npSmokeTraps, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmoke=npSmoke, npRelHumTrapTemp=npRelHumTrapTemp, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokePower=npSmokePower, FixedPoint1000=FixedPoint1000, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayState=npRelayState, npRelHumTrapSafe=npRelHumTrapSafe, npRelayEntry=npRelayEntry, npSmokeMemo=npSmokeMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapFail=npRelHumTrapFail, npIrStatus=npIrStatus, npCurLoopI=npCurLoopI, lightcom=lightcom, npSmokeReset=npSmokeReset, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npThermoValue=npThermoValue, npThermoStatus=npThermoStatus, npIoLevelIn=npIoLevelIn, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayTable=npRelayTable, npThermoSensorN=npThermoSensorN, npThermoTrapMemo=npThermoTrapMemo)
