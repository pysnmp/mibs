...
iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Bits, MibIdentifier, NotificationType, Integer32, ObjectIdentity, ModuleIdentity, Counter64, TimeTicks, Gauge32, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Bits", "MibIdentifier", "NotificationType", "Integer32", "ObjectIdentity", "ModuleIdentity", "Counter64", "TimeTicks", "Gauge32", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTable=npThermoTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayMode=npRelayMode, npCurLoop=npCurLoop, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumValue=npRelHumValue, npTrapInfo=npTrapInfo, npThermoValue=npThermoValue, npResetStack=npResetStack, npIoTrapLevelLegend=npIoTrapLevelLegend, FixedPoint1000=FixedPoint1000, npSmoke=npSmoke, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapMemo=npThermoTrapMemo, npThermoStatus=npThermoStatus, npIoTraps=npIoTraps, npRelHumMemo=npRelHumMemo, npRelHumidity=npRelHumidity, npRelayEntry=npRelayEntry, npSmokeMemo=npSmokeMemo, npIrStatus=npIrStatus, npGsmInfo=npGsmInfo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrap=npRelHumTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTrap=npSmokeTrap, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapSensorN=npThermoTrapSensorN, npGsm=npGsm, npIrCtrl=npIrCtrl, npIrReset=npIrReset, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapValue=npThermoTrapValue, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoLevelIn=npIoLevelIn, npRelHumTempValue=npRelHumTempValue, npIoTable=npIoTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapStatus=npCurLoopTrapStatus, npTrapEmailTo=npTrapEmailTo, npIoLineN=npIoLineN, npThermoTrapHigh=npThermoTrapHigh, npForcedReboot=npForcedReboot, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumN=npRelHumN, npRelayN=npRelayN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapStatus=npThermoTrapStatus, npCurLoopEntry=npCurLoopEntry, npIoMemo=npIoMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapDataN=npRelHumTrapDataN, npRelayState=npRelayState, npThermoLow=npThermoLow, npThermoTrapLow=npThermoTrapLow, npIoEntry=npIoEntry, npThermoTraps=npThermoTraps, npCurLoopTrap=npCurLoopTrap, npGsmTrap=npGsmTrap, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapV=npCurLoopTrapV, npSmokePower=npSmokePower, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmTraps=npGsmTraps, npCurLoopTable=npCurLoopTable, npCurLoopStatus=npCurLoopStatus, npRelay=npRelay, npGsmTrapPrefix=npGsmTrapPrefix, npThermoValuePrecise=npThermoValuePrecise, npIrPlayCmd=npIrPlayCmd, npRelayMemo=npRelayMemo, npThermoHigh=npThermoHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoMemo=npThermoMemo, npSmokeTraps=npSmokeTraps, npRelHumTempStatus=npRelHumTempStatus, npIoLevelOut=npIoLevelOut, npCurLoopTraps=npCurLoopTraps, npRelayStartReset=npRelayStartReset, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTrapStatus=npSmokeTrapStatus, npIoTrap=npIoTrap, npSoftReboot=npSoftReboot, npThermoTrap=npThermoTrap, npReboot=npReboot, npSmokeReset=npSmokeReset, lightcom=lightcom, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapMemo=npIoTrapMemo, npGsmStrength=npGsmStrength, npIr=npIr, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTemp=npRelHumTrapTemp, npGsmFailed=npGsmFailed, npCurLoopTrapI=npCurLoopTrapI, npRelayTable=npRelayTable, npCurLoopV=npCurLoopV, npRelHumTable=npRelHumTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeSensorN=npSmokeSensorN, npCurLoopI=npCurLoopI, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoSensorN=npThermoSensorN, npCurLoopN=npCurLoopN, npIoTrapPrefix=npIoTrapPrefix, npSmokeTable=npSmokeTable, npSmokeEntry=npSmokeEntry, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermo=npThermo, npSmokeStatus=npSmokeStatus, npCurLoopPower=npCurLoopPower, npCurLoopR=npCurLoopR, npThermoEntry=npThermoEntry, npGsmRegistration=npGsmRegistration, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumEntry=npRelHumEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIo=npIo, npIoPulseCounter=npIoPulseCounter, npRelHumStatus=npRelHumStatus, npCurLoopTrapR=npCurLoopTrapR, npIoTrapLineN=npIoTrapLineN)
