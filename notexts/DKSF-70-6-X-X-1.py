...
# Produced by pysmi-1.1.8 at Tue Aug  9 15:48:46 2022
...
Unsigned32, ObjectIdentity, Bits, Counter64, MibIdentifier, IpAddress, ModuleIdentity, Counter32, iso, enterprises, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ObjectIdentity", "Bits", "Counter64", "MibIdentifier", "IpAddress", "ModuleIdentity", "Counter32", "iso", "enterprises", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopStatus=npCurLoopStatus, npTrapInfo=npTrapInfo, npRelayEntry=npRelayEntry, npSmokeTable=npSmokeTable, npCurLoopTraps=npCurLoopTraps, npThermoValue=npThermoValue, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapV=npCurLoopTrapV, npReboot=npReboot, npThermo=npThermo, npIoLevelIn=npIoLevelIn, npCurLoopV=npCurLoopV, npRelHumTrap=npRelHumTrap, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopI=npCurLoopI, npIo=npIo, npForcedReboot=npForcedReboot, npThermoStatus=npThermoStatus, npThermoTrapMemo=npThermoTrapMemo, npRelHumTable=npRelHumTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmoke=npSmoke, npCurLoopTrapPower=npCurLoopTrapPower, npGsmInfo=npGsmInfo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrap=npThermoTrap, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapR=npCurLoopTrapR, npThermoLow=npThermoLow, npThermoTraps=npThermoTraps, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsm=npGsm, npCurLoop=npCurLoop, npThermoTable=npThermoTable, npIoLevelOut=npIoLevelOut, npIr=npIr, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumStatus=npRelHumStatus, npThermoValuePrecise=npThermoValuePrecise, npSmokeSensorN=npSmokeSensorN, npSmokeMemo=npSmokeMemo, npSmokeReset=npSmokeReset, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTable=npCurLoopTable, npRelayTable=npRelayTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapSensorN=npThermoTrapSensorN, npGsmTrap=npGsmTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoMemo=npIoMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapN=npCurLoopTrapN, npIoTable=npIoTable, npSmokeTrap=npSmokeTrap, npRelHumTrapData=npRelHumTrapData, npIoPulseCounter=npIoPulseCounter, npRelayMode=npRelayMode, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeStatus=npSmokeStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayStartReset=npRelayStartReset, npCurLoopTrapI=npCurLoopTrapI, npThermoHigh=npThermoHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapTemp=npRelHumTrapTemp, npRelayN=npRelayN, npIoTraps=npIoTraps, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmFailed=npGsmFailed, npGsmStrength=npGsmStrength, npRelHumMemo=npRelHumMemo, npRelHumTrapFail=npRelHumTrapFail, npIoTrap=npIoTrap, npThermoTrapValue=npThermoTrapValue, npSmokeTrapMemo=npSmokeTrapMemo, npIrReset=npIrReset, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayState=npRelayState, npRelHumTempStatus=npRelHumTempStatus, npRelHumEntry=npRelHumEntry, npSmokeEntry=npSmokeEntry, npIoEntry=npIoEntry, npThermoEntry=npThermoEntry, npRelHumN=npRelHumN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrapLevelIn=npIoTrapLevelIn, npSoftReboot=npSoftReboot, npSmokeTraps=npSmokeTraps, npTrapEmailTo=npTrapEmailTo, npRelay=npRelay, npIoTrapLineN=npIoTrapLineN, npRelHumidity=npRelHumidity, FixedPoint1000=FixedPoint1000, npCurLoopR=npCurLoopR, lightcom=lightcom, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoSensorN=npThermoSensorN, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmTraps=npGsmTraps, npRelHumValue=npRelHumValue, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrPlayCmd=npIrPlayCmd, npSmokeTrapStatus=npSmokeTrapStatus, npSmokePower=npSmokePower, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmRegistration=npGsmRegistration, npIrCtrl=npIrCtrl, npCurLoopN=npCurLoopN, npThermoMemo=npThermoMemo, npRelayMemo=npRelayMemo, npCurLoopPower=npCurLoopPower, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapLow=npThermoTrapLow, npCurLoopEntry=npCurLoopEntry, npIrStatus=npIrStatus, npIoLineN=npIoLineN, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTempValue=npRelHumTempValue, npCurLoopTrap=npCurLoopTrap, npResetStack=npResetStack)
