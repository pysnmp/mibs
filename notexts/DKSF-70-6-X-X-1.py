...
enterprises, Counter32, Bits, Counter64, Unsigned32, MibIdentifier, IpAddress, iso, ModuleIdentity, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "Bits", "Counter64", "Unsigned32", "MibIdentifier", "IpAddress", "iso", "ModuleIdentity", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIrStatus=npIrStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayEntry=npRelayEntry, npGsmStrength=npGsmStrength, npSmokeMemo=npSmokeMemo, npIoLineN=npIoLineN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npTrapEmailTo=npTrapEmailTo, npThermoTrapSensorN=npThermoTrapSensorN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokePower=npSmokePower, npIoTable=npIoTable, npThermoMemo=npThermoMemo, npCurLoopTable=npCurLoopTable, npCurLoopR=npCurLoopR, npSmoke=npSmoke, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrap=npThermoTrap, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTrapMemo=npSmokeTrapMemo, npThermoSensorN=npThermoSensorN, npCurLoop=npCurLoop, npIrCtrl=npIrCtrl, npRelayN=npRelayN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopV=npCurLoopV, npGsmInfo=npGsmInfo, npGsmTraps=npGsmTraps, npRelayTable=npRelayTable, npRelHumN=npRelHumN, npRelHumTrapData=npRelHumTrapData, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapFail=npRelHumTrapFail, npRelHumStatus=npRelHumStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTraps=npIoTraps, npCurLoopTrapPower=npCurLoopTrapPower, npRelayStartReset=npRelayStartReset, npThermoTraps=npThermoTraps, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTrap=npSmokeTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoLevelIn=npIoLevelIn, npForcedReboot=npForcedReboot, npRelayMemo=npRelayMemo, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoLow=npThermoLow, npRelay=npRelay, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoEntry=npIoEntry, npRelHumidity=npRelHumidity, npRelayMode=npRelayMode, npThermoValue=npThermoValue, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoValuePrecise=npThermoValuePrecise, npSmokeReset=npSmokeReset, npCurLoopStatus=npCurLoopStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoHigh=npThermoHigh, npCurLoopPower=npCurLoopPower, npRelHumValue=npRelHumValue, npResetStack=npResetStack, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopN=npCurLoopN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTrapLineN=npIoTrapLineN, npRelHumTrap=npRelHumTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapI=npCurLoopTrapI, npThermoTable=npThermoTable, npSmokeTrapStatus=npSmokeTrapStatus, npIoTrap=npIoTrap, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTempStatus=npRelHumTempStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSoftReboot=npSoftReboot, npIr=npIr, npIrReset=npIrReset, npIoMemo=npIoMemo, npThermoStatus=npThermoStatus, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumEntry=npRelHumEntry, npRelHumTable=npRelHumTable, npReboot=npReboot, npCurLoopEntry=npCurLoopEntry, npCurLoopTrap=npCurLoopTrap, npThermoTrapValue=npThermoTrapValue, npThermoTrapLow=npThermoTrapLow, npRelHumTempValue=npRelHumTempValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapR=npCurLoopTrapR, npSmokeStatus=npSmokeStatus, lightcom=lightcom, npGsm=npGsm, npIrPlayCmd=npIrPlayCmd, npIo=npIo, npGsmFailed=npGsmFailed, npCurLoopI=npCurLoopI, npRelHumMemo=npRelHumMemo, npSmokeTable=npSmokeTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, FixedPoint1000=FixedPoint1000, npThermoEntry=npThermoEntry, npGsmRegistration=npGsmRegistration, npSmokeEntry=npSmokeEntry, npSmokeSensorN=npSmokeSensorN, npIoLevelOut=npIoLevelOut, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapN=npCurLoopTrapN, npThermo=npThermo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapMemo=npIoTrapMemo, npRelayState=npRelayState, npTrapInfo=npTrapInfo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTraps=npSmokeTraps, npGsmTrap=npGsmTrap, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapStatus=npThermoTrapStatus)
