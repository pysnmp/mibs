...
# Produced by pysmi-1.1.8 at Thu Sep 29 12:48:59 2022
...
IpAddress, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, Gauge32, TimeTicks, NotificationType, Counter32, ObjectIdentity, Bits, Unsigned32, Integer32, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "Gauge32", "TimeTicks", "NotificationType", "Counter32", "ObjectIdentity", "Bits", "Unsigned32", "Integer32", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmTraps=npGsmTraps, npIrPlayCmd=npIrPlayCmd, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayTable=npRelayTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTraps=npThermoTraps, npRelHumTrapData=npRelHumTrapData, npResetStack=npResetStack, npCurLoopI=npCurLoopI, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoop=npCurLoop, npSmokeTable=npSmokeTable, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTable=npThermoTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoHigh=npThermoHigh, npCurLoopTable=npCurLoopTable, npRelHumTrapDataStatus=npRelHumTrapDataStatus, FixedPoint1000=FixedPoint1000, npThermoTrapValue=npThermoTrapValue, npSmokeSensorN=npSmokeSensorN, npRelayEntry=npRelayEntry, lightcom=lightcom, npGsmStrength=npGsmStrength, npThermoValue=npThermoValue, npTrapEmailTo=npTrapEmailTo, npThermoMemo=npThermoMemo, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapV=npCurLoopTrapV, npIrStatus=npIrStatus, npIoPulseCounter=npIoPulseCounter, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npForcedReboot=npForcedReboot, npRelHumEntry=npRelHumEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoEntry=npIoEntry, npIoTrapPrefix=npIoTrapPrefix, npGsmFailed=npGsmFailed, npSmokeStatus=npSmokeStatus, npTrapInfo=npTrapInfo, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumValue=npRelHumValue, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIr=npIr, npGsmInfo=npGsmInfo, npSmokeTrapMemo=npSmokeTrapMemo, npRelay=npRelay, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapN=npCurLoopTrapN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayN=npRelayN, npIoTraps=npIoTraps, npRelHumTempStatus=npRelHumTempStatus, npIrReset=npIrReset, npIoTrap=npIoTrap, npIoLevelIn=npIoLevelIn, npRelHumStatus=npRelHumStatus, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTable=npIoTable, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTable=npRelHumTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapMemo=npThermoTrapMemo, npThermo=npThermo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoValuePrecise=npThermoValuePrecise, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapLow=npThermoTrapLow, npSmokeReset=npSmokeReset, npRelHumTrapTemp=npRelHumTrapTemp, npRelayMemo=npRelayMemo, npCurLoopR=npCurLoopR, npThermoStatus=npThermoStatus, npGsm=npGsm, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTrapPrefix=npSmokeTrapPrefix, npReboot=npReboot, npCurLoopTrapI=npCurLoopTrapI, npSmokePower=npSmokePower, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrapMemo=npIoTrapMemo, npIoLevelOut=npIoLevelOut, npThermoLow=npThermoLow, npIo=npIo, npSmokeTraps=npSmokeTraps, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrap=npRelHumTrap, npSmokeEntry=npSmokeEntry, npRelayStartReset=npRelayStartReset, npCurLoopV=npCurLoopV, npRelHumMemo=npRelHumMemo, npRelayMode=npRelayMode, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTempValue=npRelHumTempValue, npIrCtrl=npIrCtrl, npRelayState=npRelayState, npCurLoopN=npCurLoopN, npSmoke=npSmoke, npThermoSensorN=npThermoSensorN, npIoLineN=npIoLineN, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTraps=npCurLoopTraps, npIoMemo=npIoMemo, npRelHumidity=npRelHumidity, npThermoEntry=npThermoEntry, npIoSinglePulseStart=npIoSinglePulseStart, npGsmRegistration=npGsmRegistration, npCurLoopPower=npCurLoopPower, npGsmTrap=npGsmTrap, npSmokeTrap=npSmokeTrap, npRelHumN=npRelHumN, npIoTrapLineN=npIoTrapLineN, npThermoTrap=npThermoTrap, npCurLoopStatus=npCurLoopStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeMemo=npSmokeMemo, npSoftReboot=npSoftReboot)
