...
ObjectIdentity, TimeTicks, Unsigned32, Counter64, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, IpAddress, MibIdentifier, NotificationType, iso, Gauge32, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "Unsigned32", "Counter64", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "IpAddress", "MibIdentifier", "NotificationType", "iso", "Gauge32", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapHigh=npThermoTrapHigh, npSmokeEntry=npSmokeEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayN=npRelayN, npTrapInfo=npTrapInfo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoMemo=npThermoMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopN=npCurLoopN, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrapStatus=npSmokeTrapStatus, npIrPlayCmd=npIrPlayCmd, npRelHumTempValue=npRelHumTempValue, npRelayState=npRelayState, npRelHumValue=npRelHumValue, npThermoTable=npThermoTable, npRelHumTrap=npRelHumTrap, npThermoHigh=npThermoHigh, npIoLineN=npIoLineN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumEntry=npRelHumEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayMode=npRelayMode, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoStatus=npThermoStatus, npCurLoopTable=npCurLoopTable, npRelHumTrapTemp=npRelHumTrapTemp, lightcom=lightcom, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapData=npRelHumTrapData, npThermoTrapValue=npThermoTrapValue, npIoTable=npIoTable, npIr=npIr, npIrStatus=npIrStatus, npRelayEntry=npRelayEntry, npRelayStartReset=npRelayStartReset, npThermoLow=npThermoLow, npThermoTrap=npThermoTrap, npThermoTraps=npThermoTraps, npTrapEmailTo=npTrapEmailTo, npCurLoopR=npCurLoopR, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumMemo=npRelHumMemo, npThermoValue=npThermoValue, FixedPoint1000=FixedPoint1000, npRelHumidity=npRelHumidity, npIoTrapMemo=npIoTrapMemo, npCurLoopStatus=npCurLoopStatus, npThermoTrapStatus=npThermoTrapStatus, npGsmStrength=npGsmStrength, npRelHumTrapDataN=npRelHumTrapDataN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoEntry=npIoEntry, npIoPulseCounter=npIoPulseCounter, npRelHumTrapFail=npRelHumTrapFail, npIoLevelIn=npIoLevelIn, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIrCtrl=npIrCtrl, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoMemo=npIoMemo, npCurLoopEntry=npCurLoopEntry, npRelHumTable=npRelHumTable, npThermoSensorN=npThermoSensorN, npSmokeMemo=npSmokeMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoLevelOut=npIoLevelOut, npThermoTrapLow=npThermoTrapLow, npRelayTable=npRelayTable, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapMemo=npThermoTrapMemo, npIoTrap=npIoTrap, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopV=npCurLoopV, npGsm=npGsm, npThermo=npThermo, npCurLoopPower=npCurLoopPower, npSmokeSensorN=npSmokeSensorN, npReboot=npReboot, npSmokePower=npSmokePower, npResetStack=npResetStack, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmTrap=npGsmTrap, npIrReset=npIrReset, npCurLoopI=npCurLoopI, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrap=npCurLoopTrap, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoop=npCurLoop, npRelHumStatus=npRelHumStatus, npCurLoopTrapI=npCurLoopTrapI, npSmoke=npSmoke, npCurLoopTrapR=npCurLoopTrapR, npSmokeTrap=npSmokeTrap, npSmokeStatus=npSmokeStatus, npRelHumN=npRelHumN, npRelHumTempStatus=npRelHumTempStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelay=npRelay, npIo=npIo, npThermoValuePrecise=npThermoValuePrecise, npSoftReboot=npSoftReboot, npRelayMemo=npRelayMemo, npGsmFailed=npGsmFailed, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmInfo=npGsmInfo, npSmokeTraps=npSmokeTraps, npCurLoopTrapV=npCurLoopTrapV, npForcedReboot=npForcedReboot, npCurLoopTraps=npCurLoopTraps, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmRegistration=npGsmRegistration, npIoTraps=npIoTraps, npThermoEntry=npThermoEntry, npIoTrapLineN=npIoTrapLineN, npSmokeTable=npSmokeTable, npSmokeReset=npSmokeReset, npGsmTraps=npGsmTraps)
