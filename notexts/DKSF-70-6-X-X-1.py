...
# Produced by pysmi-1.1.12 at Thu Apr  4 13:17:38 2024
...
TimeTicks, ObjectIdentity, Integer32, Unsigned32, Bits, ModuleIdentity, NotificationType, Counter64, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Gauge32, Counter32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "Integer32", "Unsigned32", "Bits", "ModuleIdentity", "NotificationType", "Counter64", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Gauge32", "Counter32", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTrap=npCurLoopTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTable=npIoTable, npSoftReboot=npSoftReboot, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTemp=npRelHumTrapTemp, npThermoLow=npThermoLow, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeStatus=npSmokeStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopI=npCurLoopI, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoStatus=npThermoStatus, npSmokeTrapStatus=npSmokeTrapStatus, npIoLevelOut=npIoLevelOut, npCurLoopPower=npCurLoopPower, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoHigh=npThermoHigh, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopEntry=npCurLoopEntry, npReboot=npReboot, npCurLoopTrapV=npCurLoopTrapV, npRelHumValue=npRelHumValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokePower=npSmokePower, FixedPoint1000=FixedPoint1000, npSmokeTable=npSmokeTable, npIoMemo=npIoMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npTrapInfo=npTrapInfo, npIrPlayCmd=npIrPlayCmd, npGsmStrength=npGsmStrength, npThermoTable=npThermoTable, npThermoValue=npThermoValue, npCurLoopTraps=npCurLoopTraps, npThermoValuePrecise=npThermoValuePrecise, npGsmTrap=npGsmTrap, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapFail=npRelHumTrapFail, npRelHumEntry=npRelHumEntry, npCurLoopStatus=npCurLoopStatus, npSmokeMemo=npSmokeMemo, npRelHumTempStatus=npRelHumTempStatus, npRelayMemo=npRelayMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopR=npCurLoopR, npGsmRegistration=npGsmRegistration, npIoEntry=npIoEntry, npIrCtrl=npIrCtrl, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTrapMemo=npIoTrapMemo, npSmokeTrapMemo=npSmokeTrapMemo, npThermo=npThermo, npSmoke=npSmoke, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoLineN=npIoLineN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmInfo=npGsmInfo, npCurLoopTable=npCurLoopTable, npRelHumTable=npRelHumTable, npSmokeSensorN=npSmokeSensorN, npIrStatus=npIrStatus, npSmokeEntry=npSmokeEntry, npRelayEntry=npRelayEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTrap=npSmokeTrap, npRelHumTempValue=npRelHumTempValue, npCurLoop=npCurLoop, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTraps=npSmokeTraps, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumN=npRelHumN, npIoSinglePulseDuration=npIoSinglePulseDuration, npIrReset=npIrReset, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayStartReset=npRelayStartReset, npForcedReboot=npForcedReboot, npThermoMemo=npThermoMemo, npRelayState=npRelayState, npThermoEntry=npThermoEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsm=npGsm, npRelHumMemo=npRelHumMemo, npSmokeReset=npSmokeReset, npThermoTraps=npThermoTraps, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapValue=npThermoTrapValue, npRelayN=npRelayN, npThermoTrapStatus=npThermoTrapStatus, lightcom=lightcom, npIoTrapLevelLegend=npIoTrapLevelLegend, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopV=npCurLoopV, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapDataN=npRelHumTrapDataN, npGsmTraps=npGsmTraps, npCurLoopTrapN=npCurLoopTrapN, npIo=npIo, npRelHumidity=npRelHumidity, npRelHumTrap=npRelHumTrap, npRelHumStatus=npRelHumStatus, npThermoSensorN=npThermoSensorN, npIoTrap=npIoTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapData=npRelHumTrapData, npGsmTrapPrefix=npGsmTrapPrefix, npRelayTable=npRelayTable, npGsmFailed=npGsmFailed, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoLevelIn=npIoLevelIn, npThermoTrap=npThermoTrap, npResetStack=npResetStack, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapLow=npThermoTrapLow, npRelay=npRelay, npTrapEmailTo=npTrapEmailTo, npCurLoopN=npCurLoopN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIr=npIr, npIoTraps=npIoTraps, npIoPulseCounter=npIoPulseCounter, npIoSinglePulseStart=npIoSinglePulseStart, npRelayMode=npRelayMode)
