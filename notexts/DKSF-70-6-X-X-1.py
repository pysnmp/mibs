...
# Produced by pysmi-1.1.8 at Mon Jan 17 14:38:26 2022
...
Gauge32, Counter64, Bits, ModuleIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, IpAddress, Integer32, NotificationType, Counter32, TimeTicks, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "Bits", "ModuleIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "IpAddress", "Integer32", "NotificationType", "Counter32", "TimeTicks", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npReboot=npReboot, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIr=npIr, npCurLoopR=npCurLoopR, npTrapInfo=npTrapInfo, npSmokeTrapMemo=npSmokeTrapMemo, npGsmTrap=npGsmTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTemp=npRelHumTrapTemp, npIoEntry=npIoEntry, npRelHumN=npRelHumN, npIoTrapLineN=npIoTrapLineN, npCurLoopTraps=npCurLoopTraps, npResetStack=npResetStack, npThermoStatus=npThermoStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoMemo=npThermoMemo, npGsmFailed=npGsmFailed, npRelayStartReset=npRelayStartReset, npRelHumTrapDataValue=npRelHumTrapDataValue, npIrPlayCmd=npIrPlayCmd, npThermoEntry=npThermoEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrap=npThermoTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeReset=npSmokeReset, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayTable=npRelayTable, npIoLevelOut=npIoLevelOut, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoSinglePulseStart=npIoSinglePulseStart, npIo=npIo, npGsmRegistration=npGsmRegistration, npThermoTable=npThermoTable, npTrapEmailTo=npTrapEmailTo, npThermo=npThermo, npIoPulseCounter=npIoPulseCounter, npIrStatus=npIrStatus, npCurLoopV=npCurLoopV, npCurLoopTrapV=npCurLoopTrapV, npIoLevelIn=npIoLevelIn, npSmokePower=npSmokePower, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapDataStatus=npRelHumTrapDataStatus, FixedPoint1000=FixedPoint1000, npCurLoopI=npCurLoopI, npGsmStrength=npGsmStrength, npGsm=npGsm, npRelayMode=npRelayMode, npIoLineN=npIoLineN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTrapPrefix=npIoTrapPrefix, npCurLoopEntry=npCurLoopEntry, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumStatus=npRelHumStatus, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTraps=npThermoTraps, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmTraps=npGsmTraps, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumidity=npRelHumidity, npIrReset=npIrReset, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrap=npRelHumTrap, npThermoValuePrecise=npThermoValuePrecise, npRelHumTable=npRelHumTable, npSmokeEntry=npSmokeEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapPrefix=npThermoTrapPrefix, npIoTraps=npIoTraps, npThermoTrapHigh=npThermoTrapHigh, npRelHumMemo=npRelHumMemo, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeSensorN=npSmokeSensorN, npIrCtrl=npIrCtrl, npRelayN=npRelayN, npThermoSensorN=npThermoSensorN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTraps=npSmokeTraps, npCurLoopStatus=npCurLoopStatus, npThermoValue=npThermoValue, lightcom=lightcom, npCurLoopPower=npCurLoopPower, npThermoTrapValue=npThermoTrapValue, npRelHumValue=npRelHumValue, npCurLoopTrap=npCurLoopTrap, npSmokeStatus=npSmokeStatus, npIoTable=npIoTable, npSmoke=npSmoke, npRelHumEntry=npRelHumEntry, npIoTrapMemo=npIoTrapMemo, npThermoLow=npThermoLow, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempFail=npRelHumTrapTempFail, npForcedReboot=npForcedReboot, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSoftReboot=npSoftReboot, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTable=npSmokeTable, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTable=npCurLoopTable, npCurLoop=npCurLoop, npCurLoopN=npCurLoopN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeMemo=npSmokeMemo, npRelayMemo=npRelayMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayEntry=npRelayEntry, npRelHumTempValue=npRelHumTempValue, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTempStatus=npRelHumTempStatus, npRelay=npRelay, npRelayState=npRelayState, npThermoHigh=npThermoHigh, npThermoTrapStatus=npThermoTrapStatus, npGsmInfo=npGsmInfo, npIoTrap=npIoTrap, npRelHumTrapDataN=npRelHumTrapDataN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoMemo=npIoMemo, npSmokeTrap=npSmokeTrap)
