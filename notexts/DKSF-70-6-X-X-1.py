...
IpAddress, ObjectIdentity, enterprises, iso, TimeTicks, Counter64, ModuleIdentity, Bits, Counter32, Unsigned32, Integer32, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "enterprises", "iso", "TimeTicks", "Counter64", "ModuleIdentity", "Bits", "Counter32", "Unsigned32", "Integer32", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoLevelIn=npIoLevelIn, npSmokeReset=npSmokeReset, npCurLoopPower=npCurLoopPower, npRelayState=npRelayState, npRelHumMemo=npRelHumMemo, npRelayMode=npRelayMode, npRelay=npRelay, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopN=npCurLoopN, npThermoMemo=npThermoMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, FixedPoint1000=FixedPoint1000, npIrCtrl=npIrCtrl, npCurLoop=npCurLoop, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmTraps=npGsmTraps, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoSensorN=npThermoSensorN, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayMemo=npRelayMemo, npRelHumTrapFail=npRelHumTrapFail, npSmokeTraps=npSmokeTraps, npIoTrapPrefix=npIoTrapPrefix, npIoTrapMemo=npIoTrapMemo, npIo=npIo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapSafe=npRelHumTrapSafe, npRelayEntry=npRelayEntry, npIoSinglePulseStart=npIoSinglePulseStart, npRelayTable=npRelayTable, npCurLoopEntry=npCurLoopEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npTrapInfo=npTrapInfo, npCurLoopV=npCurLoopV, npThermoTrapStatus=npThermoTrapStatus, npSmoke=npSmoke, npThermoTrapValue=npThermoTrapValue, npRelHumTable=npRelHumTable, npRelHumN=npRelHumN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopI=npCurLoopI, npGsmInfo=npGsmInfo, npGsmTrapPrefix=npGsmTrapPrefix, npIoLineN=npIoLineN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIr=npIr, npIoTrapLevelIn=npIoTrapLevelIn, npThermo=npThermo, npThermoValue=npThermoValue, npRelayN=npRelayN, npThermoEntry=npThermoEntry, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapLow=npThermoTrapLow, npSoftReboot=npSoftReboot, npCurLoopTrap=npCurLoopTrap, npThermoTraps=npThermoTraps, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoLevelOut=npIoLevelOut, npIoMemo=npIoMemo, npRelayStartReset=npRelayStartReset, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrap=npRelHumTrap, npCurLoopTrapN=npCurLoopTrapN, npCurLoopR=npCurLoopR, npSmokeEntry=npSmokeEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrap=npIoTrap, npIoPulseCounter=npIoPulseCounter, npIoTraps=npIoTraps, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopStatus=npCurLoopStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapMemo=npThermoTrapMemo, npIrPlayCmd=npIrPlayCmd, lightcom=lightcom, npSmokeStatus=npSmokeStatus, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIrReset=npIrReset, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapDataN=npRelHumTrapDataN, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTable=npThermoTable, npSmokeTrap=npSmokeTrap, npThermoTrapHigh=npThermoTrapHigh, npThermoHigh=npThermoHigh, npResetStack=npResetStack, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTable=npIoTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapSensorN=npThermoTrapSensorN, npGsm=npGsm, npSmokeSensorN=npSmokeSensorN, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npForcedReboot=npForcedReboot, npRelHumEntry=npRelHumEntry, npGsmRegistration=npGsmRegistration, npSmokePower=npSmokePower, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTable=npCurLoopTable, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrStatus=npIrStatus, npSmokeMemo=npSmokeMemo, npRelHumTempStatus=npRelHumTempStatus, npRelHumStatus=npRelHumStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmFailed=npGsmFailed, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumidity=npRelHumidity, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoValuePrecise=npThermoValuePrecise, npSmokeTable=npSmokeTable, npRelHumTrapData=npRelHumTrapData, npCurLoopTraps=npCurLoopTraps, npThermoTrap=npThermoTrap, npReboot=npReboot, npThermoStatus=npThermoStatus, npGsmStrength=npGsmStrength, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoEntry=npIoEntry, npThermoLow=npThermoLow, npIoTrapLineN=npIoTrapLineN, npRelHumValue=npRelHumValue, npGsmTrap=npGsmTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe)
