...
# Produced by pysmi-1.1.3 at Sun Nov 28 17:10:15 2021
...
Counter32, Unsigned32, Integer32, ModuleIdentity, NotificationType, iso, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, enterprises, Counter64, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "Integer32", "ModuleIdentity", "NotificationType", "iso", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "enterprises", "Counter64", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTable=npCurLoopTable, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapI=npCurLoopTrapI, npRelHumMemo=npRelHumMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoLevelIn=npIoLevelIn, npThermo=npThermo, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapValue=npThermoTrapValue, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoLevelOut=npIoLevelOut, npRelayTable=npRelayTable, npRelHumEntry=npRelHumEntry, npIo=npIo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTraps=npThermoTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmStrength=npGsmStrength, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTraps=npSmokeTraps, npRelHumTrap=npRelHumTrap, npGsmInfo=npGsmInfo, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapR=npCurLoopTrapR, npIoTrap=npIoTrap, npCurLoopEntry=npCurLoopEntry, npIrStatus=npIrStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npTrapEmailTo=npTrapEmailTo, npGsmFailed=npGsmFailed, npSmokeStatus=npSmokeStatus, npIr=npIr, npSmoke=npSmoke, npCurLoopTrapV=npCurLoopTrapV, npRelHumN=npRelHumN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoStatus=npThermoStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoPulseCounter=npIoPulseCounter, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTable=npRelHumTable, npResetStack=npResetStack, npCurLoopStatus=npCurLoopStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npTrapInfo=npTrapInfo, npThermoTrap=npThermoTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTable=npSmokeTable, npSmokeMemo=npSmokeMemo, npRelayEntry=npRelayEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, lightcom=lightcom, npCurLoopPower=npCurLoopPower, npThermoTrapLow=npThermoTrapLow, npRelayMemo=npRelayMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npReboot=npReboot, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelay=npRelay, npIoTrapMemo=npIoTrapMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, FixedPoint1000=FixedPoint1000, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTable=npIoTable, npCurLoop=npCurLoop, npRelHumidity=npRelHumidity, npCurLoopTraps=npCurLoopTraps, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapData=npRelHumTrapData, npCurLoopN=npCurLoopN, npSmokePower=npSmokePower, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmRegistration=npGsmRegistration, npCurLoopTrapPower=npCurLoopTrapPower, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeSensorN=npSmokeSensorN, npGsmTraps=npGsmTraps, npForcedReboot=npForcedReboot, npThermoTrapMemo=npThermoTrapMemo, npRelayStartReset=npRelayStartReset, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrap=npCurLoopTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsm=npGsm, npThermoHigh=npThermoHigh, npThermoValue=npThermoValue, npIoEntry=npIoEntry, npIoMemo=npIoMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopI=npCurLoopI, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIrReset=npIrReset, npIrCtrl=npIrCtrl, npRelHumValue=npRelHumValue, npThermoTable=npThermoTable, npSmokeReset=npSmokeReset, npThermoTrapPrefix=npThermoTrapPrefix, npThermoSensorN=npThermoSensorN, npThermoMemo=npThermoMemo, npRelayMode=npRelayMode, npSmokeTrapStatus=npSmokeTrapStatus, npThermoLow=npThermoLow, npGsmTrap=npGsmTrap, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapN=npCurLoopTrapN, npThermoEntry=npThermoEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSoftReboot=npSoftReboot, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapHigh=npThermoTrapHigh, npCurLoopV=npCurLoopV, npSmokeTrap=npSmokeTrap, npSmokeEntry=npSmokeEntry, npRelHumTempValue=npRelHumTempValue, npCurLoopR=npCurLoopR, npThermoValuePrecise=npThermoValuePrecise, npIrPlayCmd=npIrPlayCmd, npRelayN=npRelayN, npIoTraps=npIoTraps, npRelayState=npRelayState, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumStatus=npRelHumStatus, npIoLineN=npIoLineN)
