...
# Produced by pysmi-1.1.8 at Tue Aug  9 15:19:42 2022
...
Integer32, NotificationType, Bits, ModuleIdentity, Gauge32, IpAddress, Counter32, iso, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Bits", "ModuleIdentity", "Gauge32", "IpAddress", "Counter32", "iso", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataValue=npRelHumTrapDataValue, npIoLineN=npIoLineN, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrapLineN=npIoTrapLineN, npGsmFailed=npGsmFailed, npSmokeTrapMemo=npSmokeTrapMemo, npThermoSensorN=npThermoSensorN, npThermoTrapLow=npThermoTrapLow, npRelay=npRelay, npForcedReboot=npForcedReboot, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoStatus=npThermoStatus, npRelayN=npRelayN, npCurLoopI=npCurLoopI, npThermoLow=npThermoLow, npCurLoopTrapI=npCurLoopTrapI, npRelayEntry=npRelayEntry, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTable=npCurLoopTable, lightcom=lightcom, npIoEntry=npIoEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermo=npThermo, npIoLevelIn=npIoLevelIn, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoSinglePulseStart=npIoSinglePulseStart, npIoTraps=npIoTraps, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokePower=npSmokePower, npResetStack=npResetStack, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapPrefix=npThermoTrapPrefix, npIoPulseCounter=npIoPulseCounter, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmTrapPrefix=npGsmTrapPrefix, npThermoEntry=npThermoEntry, npIrReset=npIrReset, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumN=npRelHumN, npCurLoopTrapR=npCurLoopTrapR, npReboot=npReboot, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrap=npRelHumTrap, npRelHumStatus=npRelHumStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapMemo=npThermoTrapMemo, npIoLevelOut=npIoLevelOut, npIrStatus=npIrStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeReset=npSmokeReset, npThermoHigh=npThermoHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npTrapInfo=npTrapInfo, npRelHumTempValue=npRelHumTempValue, npThermoTrap=npThermoTrap, npGsmTrap=npGsmTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTraps=npCurLoopTraps, npIo=npIo, npRelHumidity=npRelHumidity, npRelHumTrapTemp=npRelHumTrapTemp, npThermoValue=npThermoValue, npIoTrap=npIoTrap, npCurLoopStatus=npCurLoopStatus, npSmokeSensorN=npSmokeSensorN, npGsm=npGsm, npGsmRegistration=npGsmRegistration, npRelayMemo=npRelayMemo, npGsmInfo=npGsmInfo, npRelHumEntry=npRelHumEntry, npCurLoopV=npCurLoopV, npThermoTable=npThermoTable, npCurLoopPower=npCurLoopPower, npIr=npIr, npRelayStartReset=npRelayStartReset, npIrCtrl=npIrCtrl, npSmokeMemo=npSmokeMemo, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTempStatus=npRelHumTempStatus, npCurLoop=npCurLoop, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSoftReboot=npSoftReboot, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoMemo=npThermoMemo, npRelHumTable=npRelHumTable, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumMemo=npRelHumMemo, npRelHumTrapData=npRelHumTrapData, npCurLoopTrap=npCurLoopTrap, npSmokeTable=npSmokeTable, npSmokeTrap=npSmokeTrap, npTrapEmailTo=npTrapEmailTo, npSmokeEntry=npSmokeEntry, npThermoTrapValue=npThermoTrapValue, npRelayMode=npRelayMode, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTable=npIoTable, npThermoValuePrecise=npThermoValuePrecise, npCurLoopN=npCurLoopN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayState=npRelayState, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoMemo=npIoMemo, npThermoTraps=npThermoTraps, npRelHumValue=npRelHumValue, npSmokeStatus=npSmokeStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopR=npCurLoopR, npSmoke=npSmoke, npIoTrapMemo=npIoTrapMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTraps=npSmokeTraps, npCurLoopEntry=npCurLoopEntry, npGsmTraps=npGsmTraps, npIoTrapPrefix=npIoTrapPrefix, npRelayTable=npRelayTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmStrength=npGsmStrength, FixedPoint1000=FixedPoint1000, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIrPlayCmd=npIrPlayCmd)
