...
# Produced by pysmi-1.1.3 at Tue Nov 30 13:50:33 2021
...
NotificationType, ObjectIdentity, Counter32, Integer32, TimeTicks, ModuleIdentity, Gauge32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, MibIdentifier, enterprises, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "Counter32", "Integer32", "TimeTicks", "ModuleIdentity", "Gauge32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "MibIdentifier", "enterprises", "Bits", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmStrength=npGsmStrength, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTable=npThermoTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeReset=npSmokeReset, npIoLineN=npIoLineN, npIrStatus=npIrStatus, npSmokeStatus=npSmokeStatus, npThermoValue=npThermoValue, npCurLoopTraps=npCurLoopTraps, npThermoTrap=npThermoTrap, npSmokeEntry=npSmokeEntry, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapN=npCurLoopTrapN, npIrReset=npIrReset, npThermoTrapMemo=npThermoTrapMemo, npIoTrap=npIoTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataValue=npRelHumTrapDataValue, npIrCtrl=npIrCtrl, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, npCurLoopV=npCurLoopV, npRelHumTrapData=npRelHumTrapData, npSoftReboot=npSoftReboot, npSmokeTable=npSmokeTable, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapSafe=npRelHumTrapSafe, npTrapInfo=npTrapInfo, npThermo=npThermo, npCurLoopR=npCurLoopR, npIoTrapPrefix=npIoTrapPrefix, npIo=npIo, npRelHumidity=npRelHumidity, npIoMemo=npIoMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTempFail=npRelHumTrapTempFail, npReboot=npReboot, npGsmRegistration=npGsmRegistration, npRelHumTable=npRelHumTable, npRelHumTrap=npRelHumTrap, npGsmFailed=npGsmFailed, npRelay=npRelay, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeMemo=npSmokeMemo, npCurLoopPower=npCurLoopPower, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npResetStack=npResetStack, npCurLoop=npCurLoop, npCurLoopTrapI=npCurLoopTrapI, npGsm=npGsm, npIoLevelOut=npIoLevelOut, npCurLoopEntry=npCurLoopEntry, npIoLevelIn=npIoLevelIn, npSmokeTraps=npSmokeTraps, npRelayTable=npRelayTable, npThermoTrapStatus=npThermoTrapStatus, npThermoTraps=npThermoTraps, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrapLineN=npIoTrapLineN, npRelHumValue=npRelHumValue, npRelayN=npRelayN, npThermoEntry=npThermoEntry, npCurLoopTrapV=npCurLoopTrapV, npIoTrapMemo=npIoTrapMemo, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeSensorN=npSmokeSensorN, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoPulseCounter=npIoPulseCounter, npRelHumTrapFail=npRelHumTrapFail, npCurLoopStatus=npCurLoopStatus, npRelayMemo=npRelayMemo, npIoSinglePulseStart=npIoSinglePulseStart, npSmoke=npSmoke, npThermoMemo=npThermoMemo, lightcom=lightcom, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoEntry=npIoEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTable=npCurLoopTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapDataN=npRelHumTrapDataN, npSmokePower=npSmokePower, npRelayState=npRelayState, FixedPoint1000=FixedPoint1000, npIoTable=npIoTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumMemo=npRelHumMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapR=npCurLoopTrapR, npRelHumN=npRelHumN, npRelayEntry=npRelayEntry, npRelHumEntry=npRelHumEntry, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopN=npCurLoopN, npCurLoopI=npCurLoopI, npThermoLow=npThermoLow, npThermoSensorN=npThermoSensorN, npThermoValuePrecise=npThermoValuePrecise, npForcedReboot=npForcedReboot, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapPower=npCurLoopTrapPower, npGsmTrap=npGsmTrap, npGsmInfo=npGsmInfo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumStatus=npRelHumStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapValue=npThermoTrapValue, npSmokeTrap=npSmokeTrap, npRelHumTempValue=npRelHumTempValue, npRelayStartReset=npRelayStartReset, npThermoTrapSensorN=npThermoTrapSensorN, npGsmTraps=npGsmTraps, npRelayMode=npRelayMode, npThermoStatus=npThermoStatus, npThermoHigh=npThermoHigh, npIoTraps=npIoTraps, npIr=npIr, npRelHumTrapDataStatus=npRelHumTrapDataStatus)
