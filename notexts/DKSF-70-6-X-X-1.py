...
# Produced by pysmi-1.1.8 at Mon Jan 17 18:30:07 2022
...
Unsigned32, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, enterprises, TimeTicks, Gauge32, ModuleIdentity, iso, ObjectIdentity, IpAddress, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "enterprises", "TimeTicks", "Gauge32", "ModuleIdentity", "iso", "ObjectIdentity", "IpAddress", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrap=npIoTrap, npIr=npIr, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumValue=npRelHumValue, npSoftReboot=npSoftReboot, npCurLoopTrapPower=npCurLoopTrapPower, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoEntry=npIoEntry, npCurLoopTable=npCurLoopTable, npCurLoopR=npCurLoopR, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTraps=npCurLoopTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoSinglePulseStart=npIoSinglePulseStart, npIrStatus=npIrStatus, npGsmRegistration=npGsmRegistration, npGsmTraps=npGsmTraps, npThermoTraps=npThermoTraps, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTable=npThermoTable, npThermoTrapLow=npThermoTrapLow, npSmokeSensorN=npSmokeSensorN, npRelHumStatus=npRelHumStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTrapLineN=npIoTrapLineN, npRelHumTrapData=npRelHumTrapData, npSmokeMemo=npSmokeMemo, npThermoTrapMemo=npThermoTrapMemo, npThermoSensorN=npThermoSensorN, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrap=npSmokeTrap, npRelayEntry=npRelayEntry, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumN=npRelHumN, uniPingServerSolutionV3=uniPingServerSolutionV3, npIo=npIo, npRelayTable=npRelayTable, npThermoEntry=npThermoEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, FixedPoint1000=FixedPoint1000, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopV=npCurLoopV, npSmokeEntry=npSmokeEntry, npThermoHigh=npThermoHigh, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapN=npCurLoopTrapN, npSmokeStatus=npSmokeStatus, npThermoTrapHigh=npThermoTrapHigh, npCurLoop=npCurLoop, npIoTrapMemo=npIoTrapMemo, npIoLevelOut=npIoLevelOut, npRelHumidity=npRelHumidity, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmInfo=npGsmInfo, npGsmStrength=npGsmStrength, npThermoStatus=npThermoStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapSensorN=npThermoTrapSensorN, npTrapEmailTo=npTrapEmailTo, npIoMemo=npIoMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelay=npRelay, npRelayState=npRelayState, npRelHumTrapFail=npRelHumTrapFail, npIoLineN=npIoLineN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npTrapInfo=npTrapInfo, npCurLoopStatus=npCurLoopStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTempStatus=npRelHumTempStatus, npThermoTrap=npThermoTrap, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumEntry=npRelHumEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, lightcom=lightcom, npIoLevelIn=npIoLevelIn, npCurLoopTrapV=npCurLoopTrapV, npSmokeReset=npSmokeReset, npRelHumMemo=npRelHumMemo, npSmokeTraps=npSmokeTraps, npIrPlayCmd=npIrPlayCmd, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTable=npSmokeTable, npSmokePower=npSmokePower, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoValue=npThermoValue, npRelayN=npRelayN, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoPulseCounter=npIoPulseCounter, npIoTraps=npIoTraps, npRelayMemo=npRelayMemo, npSmoke=npSmoke, npIoTable=npIoTable, npGsm=npGsm, npRelHumTrapSafe=npRelHumTrapSafe, npRelayMode=npRelayMode, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npForcedReboot=npForcedReboot, npThermoMemo=npThermoMemo, npCurLoopN=npCurLoopN, npCurLoopI=npCurLoopI, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayStartReset=npRelayStartReset, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoLow=npThermoLow, npThermoTrapValue=npThermoTrapValue, npIrCtrl=npIrCtrl, npIrReset=npIrReset, npRelHumTempValue=npRelHumTempValue, npResetStack=npResetStack, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapStatus=npThermoTrapStatus, npReboot=npReboot, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmFailed=npGsmFailed, npThermoValuePrecise=npThermoValuePrecise, npCurLoopPower=npCurLoopPower, npThermo=npThermo, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmTrap=npGsmTrap, npCurLoopTrap=npCurLoopTrap, npRelHumTrap=npRelHumTrap, npRelHumTable=npRelHumTable)
