...
# Produced by pysmi-1.1.12 at Thu Apr  4 03:00:31 2024
...
NotificationType, Integer32, Gauge32, Counter64, IpAddress, MibIdentifier, Bits, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, iso, Counter32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "Gauge32", "Counter64", "IpAddress", "MibIdentifier", "Bits", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "iso", "Counter32", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopN=npCurLoopN, npThermoMemo=npThermoMemo, npIoMemo=npIoMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapLow=npThermoTrapLow, npThermoValuePrecise=npThermoValuePrecise, npIrReset=npIrReset, lightcom=lightcom, npGsmRegistration=npGsmRegistration, npThermoTable=npThermoTable, npCurLoopI=npCurLoopI, npRelHumStatus=npRelHumStatus, npRelayMode=npRelayMode, npIoLineN=npIoLineN, npSmoke=npSmoke, npCurLoopTrapI=npCurLoopTrapI, npThermoLow=npThermoLow, npRelHumTrap=npRelHumTrap, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrap=npThermoTrap, npIo=npIo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelay=npRelay, npCurLoopStatus=npCurLoopStatus, npGsmTrap=npGsmTrap, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrap=npSmokeTrap, npThermoValue=npThermoValue, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTempFail=npRelHumTrapTempFail, npReboot=npReboot, npRelayState=npRelayState, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTable=npIoTable, npRelHumValue=npRelHumValue, npGsmInfo=npGsmInfo, npThermoEntry=npThermoEntry, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoSinglePulseStart=npIoSinglePulseStart, npThermoSensorN=npThermoSensorN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapValue=npThermoTrapValue, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoLevelIn=npIoLevelIn, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoPulseCounter=npIoPulseCounter, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopV=npCurLoopV, npThermo=npThermo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrap=npIoTrap, npIoTrapLineN=npIoTrapLineN, npSmokeTraps=npSmokeTraps, npRelHumTempValue=npRelHumTempValue, npSmokeTable=npSmokeTable, npRelHumTrapSafe=npRelHumTrapSafe, npForcedReboot=npForcedReboot, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrap=npCurLoopTrap, npRelayTable=npRelayTable, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTraps=npThermoTraps, npTrapInfo=npTrapInfo, npIr=npIr, npRelHumidity=npRelHumidity, npThermoTrapHigh=npThermoTrapHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapR=npCurLoopTrapR, npIoLevelOut=npIoLevelOut, npThermoStatus=npThermoStatus, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapStatus=npCurLoopTrapStatus, npSoftReboot=npSoftReboot, npIoTraps=npIoTraps, npRelayStartReset=npRelayStartReset, npCurLoopEntry=npCurLoopEntry, npRelHumTrapData=npRelHumTrapData, npCurLoopTable=npCurLoopTable, npIrStatus=npIrStatus, npSmokeTrapStatus=npSmokeTrapStatus, npGsmFailed=npGsmFailed, npSmokeSensorN=npSmokeSensorN, npIoTrapPrefix=npIoTrapPrefix, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsm=npGsm, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTable=npRelHumTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoEntry=npIoEntry, npGsmTraps=npGsmTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTrapMemo=npIoTrapMemo, npRelayEntry=npRelayEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeMemo=npSmokeMemo, npThermoTrapMemo=npThermoTrapMemo, npSmokeEntry=npSmokeEntry, npSmokeStatus=npSmokeStatus, npResetStack=npResetStack, npCurLoop=npCurLoop, npSmokePower=npSmokePower, npRelHumEntry=npRelHumEntry, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopPower=npCurLoopPower, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopR=npCurLoopR, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayN=npRelayN, npRelHumN=npRelHumN, FixedPoint1000=FixedPoint1000, npThermoHigh=npThermoHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumMemo=npRelHumMemo, npGsmStrength=npGsmStrength, npIrPlayCmd=npIrPlayCmd, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayMemo=npRelayMemo, npSmokeReset=npSmokeReset, npIrCtrl=npIrCtrl, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, PYSNMP_MODULE_ID=uniPingServerSolutionV3)
