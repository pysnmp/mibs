...
# Produced by pysmi-1.1.8 at Tue Feb  1 21:09:13 2022
...
ModuleIdentity, Counter32, Gauge32, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, enterprises, ObjectIdentity, MibIdentifier, TimeTicks, Counter64, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "Gauge32", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "enterprises", "ObjectIdentity", "MibIdentifier", "TimeTicks", "Counter64", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoLineN=npIoLineN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmTrap=npGsmTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayState=npRelayState, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTraps=npCurLoopTraps, npGsm=npGsm, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrap=npThermoTrap, FixedPoint1000=FixedPoint1000, npThermoLow=npThermoLow, npThermoValue=npThermoValue, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapV=npCurLoopTrapV, npRelHumStatus=npRelHumStatus, npSmokeMemo=npSmokeMemo, npCurLoopPower=npCurLoopPower, npRelayMode=npRelayMode, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopEntry=npCurLoopEntry, npRelHumN=npRelHumN, npRelHumidity=npRelHumidity, npTrapEmailTo=npTrapEmailTo, npRelayN=npRelayN, npIrCtrl=npIrCtrl, npIoTrap=npIoTrap, npGsmFailed=npGsmFailed, npCurLoopTrapStatus=npCurLoopTrapStatus, npIrReset=npIrReset, npGsmTraps=npGsmTraps, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumEntry=npRelHumEntry, npRelHumTrap=npRelHumTrap, npSmokeTraps=npSmokeTraps, npIoTable=npIoTable, npReboot=npReboot, npIoSinglePulseStart=npIoSinglePulseStart, npRelayEntry=npRelayEntry, npIoPulseCounter=npIoPulseCounter, npIoEntry=npIoEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayStartReset=npRelayStartReset, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoLevelIn=npIoLevelIn, npGsmRegistration=npGsmRegistration, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmoke=npSmoke, npThermoEntry=npThermoEntry, npTrapInfo=npTrapInfo, npThermoTrapHigh=npThermoTrapHigh, npSmokeSensorN=npSmokeSensorN, npCurLoopTrapR=npCurLoopTrapR, npRelayTable=npRelayTable, npIrPlayCmd=npIrPlayCmd, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSoftReboot=npSoftReboot, npForcedReboot=npForcedReboot, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, lightcom=lightcom, npSmokeTrapMemo=npSmokeTrapMemo, npRelayMemo=npRelayMemo, npThermoTraps=npThermoTraps, npSmokeTrap=npSmokeTrap, npIoMemo=npIoMemo, npIoTrapLevelIn=npIoTrapLevelIn, npThermoValuePrecise=npThermoValuePrecise, npThermoSensorN=npThermoSensorN, npCurLoopV=npCurLoopV, npIr=npIr, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTrapPrefix=npIoTrapPrefix, npSmokeStatus=npSmokeStatus, npSmokePower=npSmokePower, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTable=npSmokeTable, npThermoTrapMemo=npThermoTrapMemo, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapStatus=npThermoTrapStatus, npRelHumTable=npRelHumTable, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopI=npCurLoopI, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumMemo=npRelHumMemo, npGsmInfo=npGsmInfo, npCurLoopN=npCurLoopN, npIrStatus=npIrStatus, npIo=npIo, npThermoTrapLow=npThermoTrapLow, npIoTrapMemo=npIoTrapMemo, npGsmStrength=npGsmStrength, npIoTraps=npIoTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoop=npCurLoop, npCurLoopR=npCurLoopR, npCurLoopStatus=npCurLoopStatus, npThermoHigh=npThermoHigh, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelay=npRelay, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeEntry=npSmokeEntry, npSmokeReset=npSmokeReset, npRelHumValue=npRelHumValue, npThermo=npThermo, npIoTrapLineN=npIoTrapLineN, npCurLoopTable=npCurLoopTable, npIoLevelOut=npIoLevelOut, npThermoStatus=npThermoStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTable=npThermoTable, npThermoMemo=npThermoMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npResetStack=npResetStack, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapValue=npThermoTrapValue, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTemp=npRelHumTrapTemp)
