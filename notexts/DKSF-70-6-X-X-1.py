...
# Produced by pysmi-1.1.8 at Tue Sep 12 13:38:48 2023
...
MibIdentifier, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, iso, IpAddress, ModuleIdentity, enterprises, Integer32, Bits, ObjectIdentity, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "iso", "IpAddress", "ModuleIdentity", "enterprises", "Integer32", "Bits", "ObjectIdentity", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npTrapEmailTo=npTrapEmailTo, npIoLineN=npIoLineN, npThermoMemo=npThermoMemo, npSmokeEntry=npSmokeEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTraps=npIoTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeStatus=npSmokeStatus, npIoTable=npIoTable, npIrCtrl=npIrCtrl, FixedPoint1000=FixedPoint1000, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeSensorN=npSmokeSensorN, npForcedReboot=npForcedReboot, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumStatus=npRelHumStatus, npSmokeTrap=npSmokeTrap, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopPower=npCurLoopPower, npGsm=npGsm, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIr=npIr, npRelayN=npRelayN, npThermoSensorN=npThermoSensorN, npCurLoopTrap=npCurLoopTrap, npThermoTrapValue=npThermoTrapValue, npSmokeTraps=npSmokeTraps, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapStatus=npThermoTrapStatus, npSmokePower=npSmokePower, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoLow=npThermoLow, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopI=npCurLoopI, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoStatus=npThermoStatus, npSmokeReset=npSmokeReset, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTempStatus=npRelHumTempStatus, npRelayTable=npRelayTable, npThermoHigh=npThermoHigh, npRelHumMemo=npRelHumMemo, npSmokeTable=npSmokeTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoValue=npThermoValue, npThermoEntry=npThermoEntry, npGsmRegistration=npGsmRegistration, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTraps=npCurLoopTraps, npRelHumTrapData=npRelHumTrapData, npCurLoop=npCurLoop, npCurLoopTable=npCurLoopTable, npRelHumTempValue=npRelHumTempValue, npTrapInfo=npTrapInfo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopEntry=npCurLoopEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermo=npThermo, npThermoTrapLow=npThermoTrapLow, npIoPulseCounter=npIoPulseCounter, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIrStatus=npIrStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumN=npRelHumN, npRelHumidity=npRelHumidity, npGsmTrap=npGsmTrap, npIoEntry=npIoEntry, npIoLevelOut=npIoLevelOut, npThermoTrapPrefix=npThermoTrapPrefix, npSoftReboot=npSoftReboot, npRelayEntry=npRelayEntry, npRelHumValue=npRelHumValue, npRelayMode=npRelayMode, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapR=npCurLoopTrapR, npIrPlayCmd=npIrPlayCmd, npRelayStartReset=npRelayStartReset, npRelayState=npRelayState, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrap=npThermoTrap, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopN=npCurLoopN, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopR=npCurLoopR, npThermoTraps=npThermoTraps, npIoMemo=npIoMemo, lightcom=lightcom, npSmokeMemo=npSmokeMemo, npIoTrapLineN=npIoTrapLineN, npResetStack=npResetStack, npReboot=npReboot, npGsmFailed=npGsmFailed, npGsmStrength=npGsmStrength, npGsmSendSmsWin1251=npGsmSendSmsWin1251, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrap=npRelHumTrap, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTable=npThermoTable, npCurLoopV=npCurLoopV, npSmokeTrapStatus=npSmokeTrapStatus, npIoTrapPrefix=npIoTrapPrefix, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrap=npIoTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTrapMemo=npIoTrapMemo, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapTemp=npRelHumTrapTemp, npGsmTraps=npGsmTraps, npGsmInfo=npGsmInfo, npIo=npIo, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapSafe=npRelHumTrapSafe, npRelay=npRelay, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmoke=npSmoke, npIrReset=npIrReset, npRelHumEntry=npRelHumEntry, npRelHumTable=npRelHumTable, npRelayMemo=npRelayMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTrapMemo=npSmokeTrapMemo, npIoLevelIn=npIoLevelIn)
