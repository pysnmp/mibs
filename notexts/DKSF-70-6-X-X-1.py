...
# Produced by pysmi-1.1.0 at Fri Nov 19 15:18:21 2021
...
Gauge32, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, Counter32, enterprises, Counter64, Integer32, NotificationType, TimeTicks, ModuleIdentity, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "Counter32", "enterprises", "Counter64", "Integer32", "NotificationType", "TimeTicks", "ModuleIdentity", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapLow=npThermoTrapLow, npSmokeTable=npSmokeTable, npCurLoop=npCurLoop, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokePower=npSmokePower, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapLineN=npIoTrapLineN, npRelHumValue=npRelHumValue, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmTraps=npGsmTraps, npRelHumTrapData=npRelHumTrapData, npCurLoopTrap=npCurLoopTrap, npRelayState=npRelayState, npCurLoopPower=npCurLoopPower, npRelay=npRelay, npIoTable=npIoTable, npCurLoopStatus=npCurLoopStatus, npIo=npIo, npIoTrap=npIoTrap, npGsmInfo=npGsmInfo, npThermoSensorN=npThermoSensorN, npThermoTrapStatus=npThermoTrapStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapI=npCurLoopTrapI, npForcedReboot=npForcedReboot, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoLineN=npIoLineN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapR=npCurLoopTrapR, npThermoTable=npThermoTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumN=npRelHumN, lightcom=lightcom, npRelHumTrap=npRelHumTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmRegistration=npGsmRegistration, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapV=npCurLoopTrapV, npThermoValue=npThermoValue, npCurLoopEntry=npCurLoopEntry, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTraps=npCurLoopTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTrap=npSmokeTrap, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapSensorN=npThermoTrapSensorN, npIoSinglePulseStart=npIoSinglePulseStart, FixedPoint1000=FixedPoint1000, npCurLoopTrapPower=npCurLoopTrapPower, npSoftReboot=npSoftReboot, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumidity=npRelHumidity, npIoEntry=npIoEntry, npThermoMemo=npThermoMemo, npIoLevelIn=npIoLevelIn, npCurLoopI=npCurLoopI, npIoTrapLevelIn=npIoTrapLevelIn, npThermoLow=npThermoLow, npThermoTrapValue=npThermoTrapValue, npIoMemo=npIoMemo, npCurLoopN=npCurLoopN, npSmokeStatus=npSmokeStatus, npIrReset=npIrReset, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoLevelOut=npIoLevelOut, npRelayEntry=npRelayEntry, npRelayTable=npRelayTable, npIrStatus=npIrStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapFail=npRelHumTrapFail, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTraps=npSmokeTraps, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayMemo=npRelayMemo, npThermoTraps=npThermoTraps, npThermoValuePrecise=npThermoValuePrecise, npThermoEntry=npThermoEntry, npGsmTrap=npGsmTrap, npRelayN=npRelayN, npIoTraps=npIoTraps, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsm=npGsm, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumMemo=npRelHumMemo, npRelHumTempValue=npRelHumTempValue, npRelayMode=npRelayMode, npRelHumTable=npRelHumTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeSensorN=npSmokeSensorN, npCurLoopTable=npCurLoopTable, npSmoke=npSmoke, npThermoStatus=npThermoStatus, npGsmStrength=npGsmStrength, npCurLoopR=npCurLoopR, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeReset=npSmokeReset, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrapLevelLegend=npIoTrapLevelLegend, npTrapInfo=npTrapInfo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npTrapEmailTo=npTrapEmailTo, npIrCtrl=npIrCtrl, npThermoHigh=npThermoHigh, npSmokeMemo=npSmokeMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopV=npCurLoopV, npRelHumStatus=npRelHumStatus, npRelayStartReset=npRelayStartReset, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataValue=npRelHumTrapDataValue, npIr=npIr, npReboot=npReboot, npIrPlayCmd=npIrPlayCmd, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrap=npThermoTrap, npGsmFailed=npGsmFailed, npIoPulseCounter=npIoPulseCounter, npThermo=npThermo, npRelHumTempStatus=npRelHumTempStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumEntry=npRelHumEntry, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npIoTrapMemo=npIoTrapMemo, npSmokeEntry=npSmokeEntry, npResetStack=npResetStack, npRelHumTrapTempSafe=npRelHumTrapTempSafe)
