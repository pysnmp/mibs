...
Gauge32, enterprises, Counter64, Unsigned32, IpAddress, TimeTicks, NotificationType, MibIdentifier, ObjectIdentity, ModuleIdentity, Counter32, Integer32, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "Counter64", "Unsigned32", "IpAddress", "TimeTicks", "NotificationType", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "Counter32", "Integer32", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoHigh=npThermoHigh, npGsmTrapPrefix=npGsmTrapPrefix, npThermoEntry=npThermoEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayStartReset=npRelayStartReset, npIoTrapLineN=npIoTrapLineN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIrCtrl=npIrCtrl, npGsmInfo=npGsmInfo, npGsmRegistration=npGsmRegistration, npIr=npIr, npSmoke=npSmoke, npTrapInfo=npTrapInfo, npIoTrapPrefix=npIoTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapPower=npCurLoopTrapPower, npIrPlayCmd=npIrPlayCmd, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTraps=npCurLoopTraps, npThermoSensorN=npThermoSensorN, npCurLoopTable=npCurLoopTable, npCurLoopTrapI=npCurLoopTrapI, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapStatus=npThermoTrapStatus, npIoTable=npIoTable, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapLow=npThermoTrapLow, npIo=npIo, npCurLoopEntry=npCurLoopEntry, npIoPulseCounter=npIoPulseCounter, npGsmStrength=npGsmStrength, npSmokeTable=npSmokeTable, npThermoMemo=npThermoMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrap=npIoTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeReset=npSmokeReset, npRelHumStatus=npRelHumStatus, npSmokeStatus=npSmokeStatus, npIoLevelOut=npIoLevelOut, npThermo=npThermo, npSmokeTrap=npSmokeTrap, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapMemo=npThermoTrapMemo, npRelHumEntry=npRelHumEntry, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIrReset=npIrReset, npRelHumTrap=npRelHumTrap, npThermoTable=npThermoTable, npSoftReboot=npSoftReboot, npIoLevelIn=npIoLevelIn, npRelHumTable=npRelHumTable, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayState=npRelayState, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoStatus=npThermoStatus, npCurLoopR=npCurLoopR, npThermoTrapValue=npThermoTrapValue, npCurLoopPower=npCurLoopPower, npGsmFailed=npGsmFailed, npRelHumTrapDataN=npRelHumTrapDataN, FixedPoint1000=FixedPoint1000, npCurLoopTrap=npCurLoopTrap, npRelayEntry=npRelayEntry, npThermoTraps=npThermoTraps, npGsmTraps=npGsmTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoMemo=npIoMemo, npThermoTrapHigh=npThermoTrapHigh, npRelayN=npRelayN, npCurLoopTrapStatus=npCurLoopTrapStatus, npTrapEmailTo=npTrapEmailTo, npThermoValue=npThermoValue, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npReboot=npReboot, npIoEntry=npIoEntry, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeEntry=npSmokeEntry, npRelHumTrapFail=npRelHumTrapFail, npRelHumMemo=npRelHumMemo, npRelHumN=npRelHumN, npResetStack=npResetStack, npGsm=npGsm, npRelHumValue=npRelHumValue, npRelHumTempStatus=npRelHumTempStatus, npCurLoopV=npCurLoopV, npIoTraps=npIoTraps, npForcedReboot=npForcedReboot, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmTrap=npGsmTrap, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapR=npCurLoopTrapR, npRelayMode=npRelayMode, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrap=npThermoTrap, npSmokePower=npSmokePower, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoLineN=npIoLineN, npCurLoopI=npCurLoopI, npRelayMemo=npRelayMemo, npSmokeSensorN=npSmokeSensorN, npRelHumidity=npRelHumidity, npRelayTable=npRelayTable, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopStatus=npCurLoopStatus, npSmokeTraps=npSmokeTraps, npCurLoopTrapV=npCurLoopTrapV, npCurLoopN=npCurLoopN, npIrStatus=npIrStatus, npSmokeMemo=npSmokeMemo, npRelHumTrapData=npRelHumTrapData, lightcom=lightcom, npThermoLow=npThermoLow, npThermoValuePrecise=npThermoValuePrecise, npCurLoop=npCurLoop, npRelay=npRelay, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn)
