...
ObjectIdentity, TimeTicks, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, enterprises, Bits, Gauge32, Unsigned32, IpAddress, ModuleIdentity, iso, MibIdentifier, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "enterprises", "Bits", "Gauge32", "Unsigned32", "IpAddress", "ModuleIdentity", "iso", "MibIdentifier", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumMemo=npRelHumMemo, npThermoSensorN=npThermoSensorN, npThermoTrapStatus=npThermoTrapStatus, npSmokeTable=npSmokeTable, npThermoMemo=npThermoMemo, npSmoke=npSmoke, npGsmFailed=npGsmFailed, npGsmStrength=npGsmStrength, npThermoTrapHigh=npThermoTrapHigh, npThermoHigh=npThermoHigh, npRelayN=npRelayN, npSoftReboot=npSoftReboot, npRelHumValue=npRelHumValue, npCurLoopI=npCurLoopI, npRelHumEntry=npRelHumEntry, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeStatus=npSmokeStatus, npRelayState=npRelayState, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapSafe=npRelHumTrapSafe, npRelayEntry=npRelayEntry, npSmokeSensorN=npSmokeSensorN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelay=npRelay, npThermoTrapMemo=npThermoTrapMemo, npCurLoopR=npCurLoopR, FixedPoint1000=FixedPoint1000, npGsm=npGsm, npRelHumStatus=npRelHumStatus, npThermoTrapValue=npThermoTrapValue, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTrapStatus=npSmokeTrapStatus, npRelayStartReset=npRelayStartReset, npSmokeTrapMemo=npSmokeTrapMemo, npThermoEntry=npThermoEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTable=npCurLoopTable, npCurLoopTrap=npCurLoopTrap, npRelHumTrap=npRelHumTrap, npIoEntry=npIoEntry, npThermoLow=npThermoLow, npCurLoopPower=npCurLoopPower, npThermoValue=npThermoValue, npIoTable=npIoTable, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoop=npCurLoop, npIoTrap=npIoTrap, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTable=npThermoTable, npRelayMemo=npRelayMemo, npCurLoopV=npCurLoopV, npRelHumTrapFail=npRelHumTrapFail, npIoTrapPrefix=npIoTrapPrefix, npRelHumTable=npRelHumTable, npGsmTrapPrefix=npGsmTrapPrefix, npReboot=npReboot, npSmokeTrap=npSmokeTrap, npIrCtrl=npIrCtrl, npRelayMode=npRelayMode, npIr=npIr, npThermoTraps=npThermoTraps, npSmokeTraps=npSmokeTraps, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermo=npThermo, npSmokeEntry=npSmokeEntry, npForcedReboot=npForcedReboot, npCurLoopEntry=npCurLoopEntry, npIo=npIo, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIrReset=npIrReset, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npTrapEmailTo=npTrapEmailTo, npThermoStatus=npThermoStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmTraps=npGsmTraps, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrap=npThermoTrap, npIoLevelOut=npIoLevelOut, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoPulseCounter=npIoPulseCounter, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapData=npRelHumTrapData, npGsmInfo=npGsmInfo, npSmokeReset=npSmokeReset, npGsmRegistration=npGsmRegistration, npGsmTrap=npGsmTrap, npThermoValuePrecise=npThermoValuePrecise, npRelayTable=npRelayTable, npRelHumTrapDataN=npRelHumTrapDataN, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapLineN=npIoTrapLineN, npCurLoopStatus=npCurLoopStatus, npCurLoopTraps=npCurLoopTraps, npIoLevelIn=npIoLevelIn, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, uniPingServerSolutionV3=uniPingServerSolutionV3, npResetStack=npResetStack, npIoLineN=npIoLineN, npTrapInfo=npTrapInfo, npSmokeTrapPrefix=npSmokeTrapPrefix, npIrStatus=npIrStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTraps=npIoTraps, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumidity=npRelHumidity, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopN=npCurLoopN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeMemo=npSmokeMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapV=npCurLoopTrapV, npRelHumN=npRelHumN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, lightcom=lightcom, npSmokePower=npSmokePower, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTempValue=npRelHumTempValue, npIrPlayCmd=npIrPlayCmd, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapN=npCurLoopTrapN, npIoMemo=npIoMemo)
