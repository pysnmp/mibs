...
Counter64, MibIdentifier, ObjectIdentity, Counter32, IpAddress, TimeTicks, enterprises, NotificationType, ModuleIdentity, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibIdentifier", "ObjectIdentity", "Counter32", "IpAddress", "TimeTicks", "enterprises", "NotificationType", "ModuleIdentity", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmTraps=npGsmTraps, npThermoTrapHigh=npThermoTrapHigh, npCurLoopEntry=npCurLoopEntry, npRelHumEntry=npRelHumEntry, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTraps=npThermoTraps, npCurLoopTable=npCurLoopTable, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopI=npCurLoopI, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapMemo=npThermoTrapMemo, npSmokePower=npSmokePower, npIrPlayCmd=npIrPlayCmd, npIoPulseCounter=npIoPulseCounter, npCurLoop=npCurLoop, npThermoEntry=npThermoEntry, npForcedReboot=npForcedReboot, npThermoTable=npThermoTable, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npTrapEmailTo=npTrapEmailTo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTraps=npSmokeTraps, npIrReset=npIrReset, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapN=npCurLoopTrapN, npRelayStartReset=npRelayStartReset, npIoEntry=npIoEntry, npIoTraps=npIoTraps, npRelHumN=npRelHumN, npSmokeTrapStatus=npSmokeTrapStatus, npGsmInfo=npGsmInfo, npIrCtrl=npIrCtrl, npThermoTrap=npThermoTrap, npSmokeStatus=npSmokeStatus, npThermoValuePrecise=npThermoValuePrecise, npIoTrapPrefix=npIoTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayN=npRelayN, npThermoSensorN=npThermoSensorN, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoLineN=npIoLineN, npSmokeTrap=npSmokeTrap, npRelHumidity=npRelHumidity, npGsmFailed=npGsmFailed, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmTrap=npGsmTrap, npThermoStatus=npThermoStatus, npThermoTrapValue=npThermoTrapValue, npThermoLow=npThermoLow, npCurLoopPower=npCurLoopPower, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTempValue=npRelHumTempValue, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npReboot=npReboot, npCurLoopStatus=npCurLoopStatus, npGsm=npGsm, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoLevelIn=npIoLevelIn, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapData=npRelHumTrapData, lightcom=lightcom, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrap=npRelHumTrap, npSmokeMemo=npSmokeMemo, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoHigh=npThermoHigh, npCurLoopR=npCurLoopR, npSmoke=npSmoke, npRelayState=npRelayState, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapSafe=npRelHumTrapSafe, npIoMemo=npIoMemo, FixedPoint1000=FixedPoint1000, npSmokeTrapMemo=npSmokeTrapMemo, npIoSinglePulseStart=npIoSinglePulseStart, npGsmRegistration=npGsmRegistration, npSmokeEntry=npSmokeEntry, npResetStack=npResetStack, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapI=npCurLoopTrapI, npIoTable=npIoTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrap=npIoTrap, npIoTrapLineN=npIoTrapLineN, npRelHumValue=npRelHumValue, npRelHumTable=npRelHumTable, npTrapInfo=npTrapInfo, npSmokeReset=npSmokeReset, npGsmStrength=npGsmStrength, npRelayMemo=npRelayMemo, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTraps=npCurLoopTraps, npRelayMode=npRelayMode, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIo=npIo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIr=npIr, npThermoValue=npThermoValue, npRelay=npRelay, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTable=npSmokeTable, npRelayTable=npRelayTable, npCurLoopV=npCurLoopV, npRelHumStatus=npRelHumStatus, npThermoMemo=npThermoMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoLevelOut=npIoLevelOut, npRelHumMemo=npRelHumMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npSoftReboot=npSoftReboot, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermo=npThermo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIrStatus=npIrStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopN=npCurLoopN, npRelayEntry=npRelayEntry, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrapMemo=npIoTrapMemo, npSmokeSensorN=npSmokeSensorN)
