...
# Produced by pysmi-1.1.3 at Sun Nov 21 13:51:18 2021
...
iso, Bits, ModuleIdentity, Unsigned32, ObjectIdentity, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, Gauge32, Integer32, Counter64, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "Gauge32", "Integer32", "Counter64", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoEntry=npThermoEntry, npIoTrap=npIoTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoMemo=npThermoMemo, npRelHumValue=npRelHumValue, npRelHumTrapSafe=npRelHumTrapSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoMemo=npIoMemo, npRelHumStatus=npRelHumStatus, npSmokeTraps=npSmokeTraps, npThermoHigh=npThermoHigh, npRelHumTrapAllEvents=npRelHumTrapAllEvents, FixedPoint1000=FixedPoint1000, npRelayEntry=npRelayEntry, npIoTrapMemo=npIoTrapMemo, npIoTrapLevelIn=npIoTrapLevelIn, npThermoValuePrecise=npThermoValuePrecise, npThermoSensorN=npThermoSensorN, npRelHumTrapData=npRelHumTrapData, npIrPlayCmd=npIrPlayCmd, npRelayMemo=npRelayMemo, npCurLoopI=npCurLoopI, npSmokeEntry=npSmokeEntry, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrap=npRelHumTrap, npTrapInfo=npTrapInfo, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayTable=npRelayTable, npThermoTrapHigh=npThermoTrapHigh, npCurLoopEntry=npCurLoopEntry, npIr=npIr, npRelay=npRelay, npRelayN=npRelayN, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmFailed=npGsmFailed, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumN=npRelHumN, npIrReset=npIrReset, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumidity=npRelHumidity, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopV=npCurLoopV, npIoLevelOut=npIoLevelOut, npThermoTrapValue=npThermoTrapValue, npCurLoopTrap=npCurLoopTrap, npSmokePower=npSmokePower, npSmoke=npSmoke, npRelHumTrapTemp=npRelHumTrapTemp, npGsmInfo=npGsmInfo, npRelHumTempValue=npRelHumTempValue, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTable=npIoTable, npReboot=npReboot, npIrCtrl=npIrCtrl, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmTrapPrefix=npGsmTrapPrefix, npIoLineN=npIoLineN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoLevelIn=npIoLevelIn, npCurLoopR=npCurLoopR, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSoftReboot=npSoftReboot, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayStartReset=npRelayStartReset, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumMemo=npRelHumMemo, lightcom=lightcom, npGsmTrap=npGsmTrap, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTrap=npSmokeTrap, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapFail=npRelHumTrapFail, npCurLoop=npCurLoop, npCurLoopTrapN=npCurLoopTrapN, npIo=npIo, npThermoStatus=npThermoStatus, npIoPulseCounter=npIoPulseCounter, npThermoValue=npThermoValue, npRelHumTempStatus=npRelHumTempStatus, npSmokeMemo=npSmokeMemo, npRelHumTable=npRelHumTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmStrength=npGsmStrength, npThermoLow=npThermoLow, npForcedReboot=npForcedReboot, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npTrapEmailTo=npTrapEmailTo, npCurLoopN=npCurLoopN, npCurLoopTable=npCurLoopTable, npCurLoopPower=npCurLoopPower, npThermoTrapLow=npThermoTrapLow, npIrStatus=npIrStatus, npSmokeReset=npSmokeReset, npRelayMode=npRelayMode, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npSmokeTable=npSmokeTable, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrap=npThermoTrap, npIoEntry=npIoEntry, npGsmTraps=npGsmTraps, npThermoTraps=npThermoTraps, npRelHumEntry=npRelHumEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsm=npGsm, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrapLineN=npIoTrapLineN, npThermoTrapMemo=npThermoTrapMemo, npIoSinglePulseStart=npIoSinglePulseStart, npThermo=npThermo, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopStatus=npCurLoopStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeStatus=npSmokeStatus, npThermoTable=npThermoTable, npResetStack=npResetStack, npGsmRegistration=npGsmRegistration, npIoTraps=npIoTraps, npCurLoopTraps=npCurLoopTraps, npRelayState=npRelayState)
