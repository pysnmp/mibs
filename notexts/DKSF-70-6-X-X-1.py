...
# Produced by pysmi-1.1.8 at Fri Jan 27 14:10:38 2023
...
Bits, Counter32, MibIdentifier, IpAddress, TimeTicks, Unsigned32, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, Counter64, Integer32, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "MibIdentifier", "IpAddress", "TimeTicks", "Unsigned32", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "Counter64", "Integer32", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTable=npThermoTable, npCurLoopN=npCurLoopN, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTable=npSmokeTable, npThermoSensorN=npThermoSensorN, npIrPlayCmd=npIrPlayCmd, npThermoTraps=npThermoTraps, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmStrength=npGsmStrength, npThermoValue=npThermoValue, npCurLoopV=npCurLoopV, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmTrap=npGsmTrap, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopI=npCurLoopI, npThermo=npThermo, npGsmFailed=npGsmFailed, npSmokePower=npSmokePower, npThermoTrapHigh=npThermoTrapHigh, npSmokeEntry=npSmokeEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoLevelOut=npIoLevelOut, npSoftReboot=npSoftReboot, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayMode=npRelayMode, npCurLoop=npCurLoop, npCurLoopStatus=npCurLoopStatus, npIoTable=npIoTable, npThermoLow=npThermoLow, npIoLineN=npIoLineN, npRelHumStatus=npRelHumStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayN=npRelayN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npGsmInfo=npGsmInfo, npIrStatus=npIrStatus, npTrapInfo=npTrapInfo, npSmoke=npSmoke, npRelayMemo=npRelayMemo, npIo=npIo, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrap=npRelHumTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumN=npRelHumN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrap=npThermoTrap, npCurLoopTraps=npCurLoopTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTrapLineN=npIoTrapLineN, npRelHumTrapFail=npRelHumTrapFail, npThermoHigh=npThermoHigh, npIr=npIr, npCurLoopTrapR=npCurLoopTrapR, npIrCtrl=npIrCtrl, npRelayTable=npRelayTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npResetStack=npResetStack, npRelayStartReset=npRelayStartReset, npReboot=npReboot, npRelHumEntry=npRelHumEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelay=npRelay, npThermoEntry=npThermoEntry, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopPower=npCurLoopPower, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumMemo=npRelHumMemo, npIoEntry=npIoEntry, npSmokeReset=npSmokeReset, npRelayEntry=npRelayEntry, npSmokeSensorN=npSmokeSensorN, npSmokeTrap=npSmokeTrap, npIoPulseCounter=npIoPulseCounter, npSmokeStatus=npSmokeStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopR=npCurLoopR, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsm=npGsm, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrReset=npIrReset, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumValue=npRelHumValue, npThermoMemo=npThermoMemo, npIoTrap=npIoTrap, npThermoStatus=npThermoStatus, npThermoTrapStatus=npThermoTrapStatus, npRelHumTempStatus=npRelHumTempStatus, npGsmTraps=npGsmTraps, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeMemo=npSmokeMemo, FixedPoint1000=FixedPoint1000, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmRegistration=npGsmRegistration, lightcom=lightcom, npCurLoopTable=npCurLoopTable, npIoMemo=npIoMemo, npIoTraps=npIoTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTable=npRelHumTable, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrap=npCurLoopTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npForcedReboot=npForcedReboot, npThermoTrapMemo=npThermoTrapMemo, npRelHumidity=npRelHumidity, npThermoValuePrecise=npThermoValuePrecise, npCurLoopEntry=npCurLoopEntry, npThermoTrapLow=npThermoTrapLow, npSmokeTraps=npSmokeTraps, npIoLevelIn=npIoLevelIn, npRelayState=npRelayState, npThermoTrapValue=npThermoTrapValue, npRelHumTrapData=npRelHumTrapData)
