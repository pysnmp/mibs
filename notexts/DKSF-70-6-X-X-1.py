...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapData=npRelHumTrapData, npIrStatus=npIrStatus, npRelayStartReset=npRelayStartReset, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayState=npRelayState, npThermoTrapHigh=npThermoTrapHigh, npSmokeTable=npSmokeTable, npGsmRegistration=npGsmRegistration, npIoTraps=npIoTraps, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumValue=npRelHumValue, npCurLoopN=npCurLoopN, npIoTrapLineN=npIoTrapLineN, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapMemo=npIoTrapMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTempStatus=npRelHumTempStatus, npThermoSensorN=npThermoSensorN, npRelayTable=npRelayTable, npThermoHigh=npThermoHigh, npSoftReboot=npSoftReboot, npRelHumTrap=npRelHumTrap, npSmokeSensorN=npSmokeSensorN, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapValue=npThermoTrapValue, npCurLoopR=npCurLoopR, npGsm=npGsm, npThermoTable=npThermoTable, npIo=npIo, npIoMemo=npIoMemo, npRelHumTrapFail=npRelHumTrapFail, npIr=npIr, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoLevelIn=npIoLevelIn, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumStatus=npRelHumStatus, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmTrapPrefix=npGsmTrapPrefix, npThermo=npThermo, npRelHumidity=npRelHumidity, npSmokeTrapMemo=npSmokeTrapMemo, npForcedReboot=npForcedReboot, npCurLoopPower=npCurLoopPower, npThermoMemo=npThermoMemo, npIrPlayCmd=npIrPlayCmd, npCurLoopV=npCurLoopV, npRelayN=npRelayN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTraps=npSmokeTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmTraps=npGsmTraps, npIoLevelOut=npIoLevelOut, npTrapEmailTo=npTrapEmailTo, npRelHumTable=npRelHumTable, npCurLoopI=npCurLoopI, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapLow=npThermoTrapLow, npRelHumTempValue=npRelHumTempValue, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokePower=npSmokePower, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapStatus=npThermoTrapStatus, npThermoTraps=npThermoTraps, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrap=npThermoTrap, npRelHumMemo=npRelHumMemo, npRelHumEntry=npRelHumEntry, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeTrap=npSmokeTrap, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, FixedPoint1000=FixedPoint1000, npSmokeEntry=npSmokeEntry, npIoLineN=npIoLineN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumN=npRelHumN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIrCtrl=npIrCtrl, npThermoStatus=npThermoStatus, npThermoValuePrecise=npThermoValuePrecise, npGsmFailed=npGsmFailed, npReboot=npReboot, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayEntry=npRelayEntry, lightcom=lightcom, npIoTrap=npIoTrap, npSmokeMemo=npSmokeMemo, npTrapInfo=npTrapInfo, npCurLoopTrapV=npCurLoopTrapV, npThermoLow=npThermoLow, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTable=npCurLoopTable, npSmokeStatus=npSmokeStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayMode=npRelayMode, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopStatus=npCurLoopStatus, npCurLoopEntry=npCurLoopEntry, npGsmTrap=npGsmTrap, npRelHumTrapSafe=npRelHumTrapSafe, npThermoValue=npThermoValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoop=npCurLoop, npThermoEntry=npThermoEntry, npIoPulseCounter=npIoPulseCounter, npSmoke=npSmoke, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTraps=npCurLoopTraps, npIoTable=npIoTable, npRelay=npRelay, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTrapStatus=npSmokeTrapStatus, npGsmInfo=npGsmInfo, npGsmStrength=npGsmStrength, npResetStack=npResetStack, npRelayMemo=npRelayMemo, npCurLoopTrapN=npCurLoopTrapN, npIoEntry=npIoEntry, npSmokeReset=npSmokeReset, npIrReset=npIrReset, npCurLoopTrapPower=npCurLoopTrapPower)
