...
Integer32, ObjectIdentity, Gauge32, Unsigned32, Counter64, NotificationType, MibIdentifier, enterprises, TimeTicks, iso, IpAddress, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "Gauge32", "Unsigned32", "Counter64", "NotificationType", "MibIdentifier", "enterprises", "TimeTicks", "iso", "IpAddress", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapLevelIn=npIoTrapLevelIn, npSmoke=npSmoke, npRelayState=npRelayState, npSmokeReset=npSmokeReset, npSmokeTrap=npSmokeTrap, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrap=npCurLoopTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapHigh=npThermoTrapHigh, npForcedReboot=npForcedReboot, npGsmTrap=npGsmTrap, npRelHumValue=npRelHumValue, npSmokeEntry=npSmokeEntry, npIoPulseCounter=npIoPulseCounter, npRelayMode=npRelayMode, npCurLoopR=npCurLoopR, npThermoStatus=npThermoStatus, npThermoTrapMemo=npThermoTrapMemo, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapSafe=npRelHumTrapSafe, npIoTraps=npIoTraps, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoSensorN=npThermoSensorN, npThermoValuePrecise=npThermoValuePrecise, npSmokeTraps=npSmokeTraps, npGsmFailed=npGsmFailed, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayMemo=npRelayMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTraps=npThermoTraps, npSmokeStatus=npSmokeStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIrPlayCmd=npIrPlayCmd, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoLow=npThermoLow, npRelHumTrapData=npRelHumTrapData, npCurLoopN=npCurLoopN, npThermo=npThermo, npIrReset=npIrReset, npRelHumTempStatus=npRelHumTempStatus, npIoMemo=npIoMemo, npIoTrap=npIoTrap, npCurLoopI=npCurLoopI, npThermoMemo=npThermoMemo, npIrCtrl=npIrCtrl, npTrapInfo=npTrapInfo, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumidity=npRelHumidity, npResetStack=npResetStack, npRelayTable=npRelayTable, npRelHumStatus=npRelHumStatus, npReboot=npReboot, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapV=npCurLoopTrapV, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopStatus=npCurLoopStatus, npGsmTrapPrefix=npGsmTrapPrefix, npSoftReboot=npSoftReboot, npRelayN=npRelayN, npCurLoopTraps=npCurLoopTraps, npGsm=npGsm, npSmokeTable=npSmokeTable, npGsmStrength=npGsmStrength, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumMemo=npRelHumMemo, npSmokeMemo=npSmokeMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokePower=npSmokePower, npRelHumTrapFail=npRelHumTrapFail, npSmokeTrapStatus=npSmokeTrapStatus, npGsmTraps=npGsmTraps, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopPower=npCurLoopPower, npThermoTrap=npThermoTrap, npThermoHigh=npThermoHigh, npThermoTrapLow=npThermoTrapLow, npCurLoopTable=npCurLoopTable, npIoEntry=npIoEntry, npRelHumN=npRelHumN, npCurLoopTrapR=npCurLoopTrapR, npGsmRegistration=npGsmRegistration, npCurLoopEntry=npCurLoopEntry, npIoLevelOut=npIoLevelOut, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTable=npThermoTable, npGsmInfo=npGsmInfo, npCurLoopV=npCurLoopV, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapI=npCurLoopTrapI, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoLineN=npIoLineN, npRelHumTrapTemp=npRelHumTrapTemp, FixedPoint1000=FixedPoint1000, npRelay=npRelay, npRelHumTrap=npRelHumTrap, npIoTrapMemo=npIoTrapMemo, npIoLevelIn=npIoLevelIn, npThermoValue=npThermoValue, npThermoEntry=npThermoEntry, npIoTrapPrefix=npIoTrapPrefix, npIoTrapLineN=npIoTrapLineN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapValue=npThermoTrapValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayEntry=npRelayEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, lightcom=lightcom, npIo=npIo, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayStartReset=npRelayStartReset, npCurLoop=npCurLoop, npRelHumEntry=npRelHumEntry, npIrStatus=npIrStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTable=npIoTable, npIr=npIr, npRelHumTable=npRelHumTable, npSmokeSensorN=npSmokeSensorN)
