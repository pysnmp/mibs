...
# Produced by pysmi-1.1.8 at Wed Oct 11 10:12:40 2023
...
ModuleIdentity, Integer32, iso, NotificationType, Gauge32, Unsigned32, Counter32, enterprises, IpAddress, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "iso", "NotificationType", "Gauge32", "Unsigned32", "Counter32", "enterprises", "IpAddress", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTrap=npSmokeTrap, npThermo=npThermo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTable=npCurLoopTable, npCurLoopTrapPower=npCurLoopTrapPower, npRelayTable=npRelayTable, npThermoValuePrecise=npThermoValuePrecise, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempValue=npRelHumTempValue, npThermoEntry=npThermoEntry, npSmoke=npSmoke, npRelayEntry=npRelayEntry, npSmokeSensorN=npSmokeSensorN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSoftReboot=npSoftReboot, npThermoTrapSensorN=npThermoTrapSensorN, npRelayState=npRelayState, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrReset=npIrReset, npSmokeTraps=npSmokeTraps, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npReboot=npReboot, npIoLevelIn=npIoLevelIn, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmStrength=npGsmStrength, npRelHumTempStatus=npRelHumTempStatus, npSmokeReset=npSmokeReset, npRelHumTrapData=npRelHumTrapData, npIoTraps=npIoTraps, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopStatus=npCurLoopStatus, npSmokeEntry=npSmokeEntry, npRelayN=npRelayN, npThermoTrapStatus=npThermoTrapStatus, npIoTrap=npIoTrap, npIoLevelOut=npIoLevelOut, npCurLoop=npCurLoop, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsm=npGsm, npThermoTrapMemo=npThermoTrapMemo, npIoSinglePulseStart=npIoSinglePulseStart, npThermoMemo=npThermoMemo, npGsmTrap=npGsmTrap, npSmokeMemo=npSmokeMemo, npIo=npIo, npGsmInfo=npGsmInfo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelay=npRelay, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTable=npSmokeTable, npThermoTable=npThermoTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrapMemo=npIoTrapMemo, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopI=npCurLoopI, npRelHumMemo=npRelHumMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumStatus=npRelHumStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrap=npCurLoopTrap, npIoLineN=npIoLineN, npRelHumValue=npRelHumValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTraps=npCurLoopTraps, npIrCtrl=npIrCtrl, npCurLoopR=npCurLoopR, npRelHumidity=npRelHumidity, npSmokeStatus=npSmokeStatus, npGsmTrapPrefix=npGsmTrapPrefix, npIoPulseCounter=npIoPulseCounter, npRelHumTrapSafe=npRelHumTrapSafe, npTrapInfo=npTrapInfo, npRelayMemo=npRelayMemo, npRelHumTrap=npRelHumTrap, npRelHumTrapFail=npRelHumTrapFail, npThermoHigh=npThermoHigh, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumEntry=npRelHumEntry, npRelHumN=npRelHumN, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoMemo=npIoMemo, npThermoLow=npThermoLow, FixedPoint1000=FixedPoint1000, npForcedReboot=npForcedReboot, npThermoValue=npThermoValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npResetStack=npResetStack, npIoEntry=npIoEntry, npCurLoopPower=npCurLoopPower, npThermoSensorN=npThermoSensorN, npSmokeTrapMemo=npSmokeTrapMemo, npGsmRegistration=npGsmRegistration, npThermoTraps=npThermoTraps, npThermoTrap=npThermoTrap, npIrStatus=npIrStatus, npSmokePower=npSmokePower, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapI=npCurLoopTrapI, npGsmFailed=npGsmFailed, npRelayMode=npRelayMode, npThermoStatus=npThermoStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopV=npCurLoopV, npCurLoopTrapN=npCurLoopTrapN, lightcom=lightcom, npCurLoopN=npCurLoopN, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempFail=npRelHumTrapTempFail, npIr=npIr, npRelHumTable=npRelHumTable, npTrapEmailTo=npTrapEmailTo, npRelayStartReset=npRelayStartReset, npCurLoopEntry=npCurLoopEntry, npIoTable=npIoTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmTraps=npGsmTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npIrPlayCmd=npIrPlayCmd, npRelHumTrapAllEvents=npRelHumTrapAllEvents)
