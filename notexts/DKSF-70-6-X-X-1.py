...
Unsigned32, MibIdentifier, enterprises, IpAddress, Counter64, Bits, Gauge32, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, iso, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibIdentifier", "enterprises", "IpAddress", "Counter64", "Bits", "Gauge32", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "iso", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokePower=npSmokePower, npCurLoop=npCurLoop, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopI=npCurLoopI, npThermoTrapValue=npThermoTrapValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTable=npRelHumTable, npRelHumTrap=npRelHumTrap, npSoftReboot=npSoftReboot, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumMemo=npRelHumMemo, npRelayTable=npRelayTable, npGsm=npGsm, npThermoLow=npThermoLow, npRelHumStatus=npRelHumStatus, npRelayState=npRelayState, npIrCtrl=npIrCtrl, npThermoMemo=npThermoMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmTraps=npGsmTraps, npRelayN=npRelayN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapLow=npThermoTrapLow, npIo=npIo, FixedPoint1000=FixedPoint1000, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npIrStatus=npIrStatus, npThermoTraps=npThermoTraps, npRelHumidity=npRelHumidity, npRelayMode=npRelayMode, npThermoEntry=npThermoEntry, npThermoStatus=npThermoStatus, npCurLoopN=npCurLoopN, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeSensorN=npSmokeSensorN, npSmokeReset=npSmokeReset, npResetStack=npResetStack, npIoLevelOut=npIoLevelOut, npSmokeStatus=npSmokeStatus, npGsmStrength=npGsmStrength, npReboot=npReboot, npThermoValue=npThermoValue, npCurLoopV=npCurLoopV, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmFailed=npGsmFailed, npThermoTable=npThermoTable, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTable=npSmokeTable, npRelHumTempValue=npRelHumTempValue, npRelHumTrapData=npRelHumTrapData, npRelayStartReset=npRelayStartReset, npCurLoopTrapN=npCurLoopTrapN, npIoTrapLineN=npIoTrapLineN, npRelHumEntry=npRelHumEntry, npIoLineN=npIoLineN, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, lightcom=lightcom, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIr=npIr, npIoTrap=npIoTrap, npSmokeEntry=npSmokeEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTable=npIoTable, npGsmTrap=npGsmTrap, npThermoTrap=npThermoTrap, npThermoTrapHigh=npThermoTrapHigh, npCurLoopEntry=npCurLoopEntry, npThermo=npThermo, npIrReset=npIrReset, npRelayEntry=npRelayEntry, npIoMemo=npIoMemo, npThermoTrapStatus=npThermoTrapStatus, npGsmInfo=npGsmInfo, npThermoSensorN=npThermoSensorN, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTrapMemo=npIoTrapMemo, npIrPlayCmd=npIrPlayCmd, npRelHumN=npRelHumN, npIoTrapLevelIn=npIoTrapLevelIn, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapMemo=npThermoTrapMemo, npRelHumValue=npRelHumValue, npCurLoopTrap=npCurLoopTrap, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeMemo=npSmokeMemo, npCurLoopPower=npCurLoopPower, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTrap=npSmokeTrap, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopR=npCurLoopR, npRelay=npRelay, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoEntry=npIoEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npForcedReboot=npForcedReboot, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapPrefix=npThermoTrapPrefix, npTrapInfo=npTrapInfo, npIoTrapPrefix=npIoTrapPrefix, npGsmRegistration=npGsmRegistration, npGsmTrapPrefix=npGsmTrapPrefix, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayMemo=npRelayMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoLevelIn=npIoLevelIn, npIoSinglePulseStart=npIoSinglePulseStart, npIoTraps=npIoTraps, npSmokeTraps=npSmokeTraps, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmoke=npSmoke, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTraps=npCurLoopTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoHigh=npThermoHigh, npTrapEmailTo=npTrapEmailTo, npCurLoopTable=npCurLoopTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapR=npCurLoopTrapR, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels)
