...
# Produced by pysmi-1.1.8 at Thu Jan  5 09:11:09 2023
...
IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, TimeTicks, Gauge32, Integer32, MibIdentifier, Counter64, NotificationType, enterprises, Bits, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "TimeTicks", "Gauge32", "Integer32", "MibIdentifier", "Counter64", "NotificationType", "enterprises", "Bits", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoStatus=npThermoStatus, npRelHumEntry=npRelHumEntry, npRelHumTable=npRelHumTable, npIoSinglePulseStart=npIoSinglePulseStart, npTrapEmailTo=npTrapEmailTo, npRelayTable=npRelayTable, npIoPulseCounter=npIoPulseCounter, npRelHumValue=npRelHumValue, npSmokeTrapStatus=npSmokeTrapStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIo=npIo, npGsmFailed=npGsmFailed, npSmokeTable=npSmokeTable, npSoftReboot=npSoftReboot, npThermoTrapLow=npThermoTrapLow, FixedPoint1000=FixedPoint1000, npRelayStartReset=npRelayStartReset, npRelayState=npRelayState, npSmokeTraps=npSmokeTraps, npIr=npIr, npIrStatus=npIrStatus, npRelay=npRelay, npIoLineN=npIoLineN, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayEntry=npRelayEntry, npRelHumStatus=npRelHumStatus, npRelHumTrapData=npRelHumTrapData, npRelHumMemo=npRelHumMemo, npThermoTraps=npThermoTraps, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npReboot=npReboot, npRelayN=npRelayN, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayMode=npRelayMode, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopEntry=npCurLoopEntry, npCurLoopI=npCurLoopI, npCurLoopTrapI=npCurLoopTrapI, npIoTrapLineN=npIoTrapLineN, npCurLoopPower=npCurLoopPower, lightcom=lightcom, npForcedReboot=npForcedReboot, npIrCtrl=npIrCtrl, npThermoTrapHigh=npThermoTrapHigh, npIoLevelIn=npIoLevelIn, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeStatus=npSmokeStatus, npThermoValuePrecise=npThermoValuePrecise, npThermoMemo=npThermoMemo, npIoTraps=npIoTraps, npSmokeMemo=npSmokeMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopR=npCurLoopR, npSmokeTrapMemo=npSmokeTrapMemo, npResetStack=npResetStack, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTable=npThermoTable, npCurLoopV=npCurLoopV, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTempStatus=npRelHumTempStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmTrapPrefix=npGsmTrapPrefix, npThermoValue=npThermoValue, npRelHumTrap=npRelHumTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmRegistration=npGsmRegistration, npSmokePower=npSmokePower, npIoTrapMemo=npIoTrapMemo, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataValue=npRelHumTrapDataValue, npIrPlayCmd=npIrPlayCmd, npThermoTrap=npThermoTrap, npIrReset=npIrReset, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTraps=npCurLoopTraps, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeSensorN=npSmokeSensorN, npIoMemo=npIoMemo, npCurLoopN=npCurLoopN, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoEntry=npThermoEntry, npRelHumN=npRelHumN, npCurLoop=npCurLoop, npCurLoopTrapV=npCurLoopTrapV, npThermo=npThermo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npTrapInfo=npTrapInfo, npIoTable=npIoTable, npThermoSensorN=npThermoSensorN, npIoTrapLevelIn=npIoTrapLevelIn, npRelayMemo=npRelayMemo, npGsm=npGsm, npRelHumTrapFail=npRelHumTrapFail, npGsmInfo=npGsmInfo, npSmoke=npSmoke, npThermoHigh=npThermoHigh, npRelHumTrapDataStatus=npRelHumTrapDataStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrap=npIoTrap, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmTrap=npGsmTrap, npSmokeEntry=npSmokeEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmStrength=npGsmStrength, npIoLevelOut=npIoLevelOut, npSmokeReset=npSmokeReset, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTable=npCurLoopTable, npThermoLow=npThermoLow, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumSafeRangeLow=npRelHumSafeRangeLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrap=npSmokeTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmTraps=npGsmTraps, npCurLoopTrapR=npCurLoopTrapR, npRelHumidity=npRelHumidity, npIoEntry=npIoEntry)
