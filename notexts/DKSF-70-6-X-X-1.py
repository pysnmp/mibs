...
# Produced by pysmi-1.1.8 at Fri Jan  7 17:13:28 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, ObjectIdentity, Integer32, Bits, MibIdentifier, ModuleIdentity, Counter32, IpAddress, enterprises, Unsigned32, NotificationType, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "ObjectIdentity", "Integer32", "Bits", "MibIdentifier", "ModuleIdentity", "Counter32", "IpAddress", "enterprises", "Unsigned32", "NotificationType", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIo=npIo, npRelHumValue=npRelHumValue, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapHigh=npThermoTrapHigh, npGsmTrapPrefix=npGsmTrapPrefix, npReboot=npReboot, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmRegistration=npGsmRegistration, npIoEntry=npIoEntry, npGsmStrength=npGsmStrength, npRelHumMemo=npRelHumMemo, npSmokeMemo=npSmokeMemo, npRelHumTable=npRelHumTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopStatus=npCurLoopStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIr=npIr, npThermoMemo=npThermoMemo, npIoTrap=npIoTrap, npThermoStatus=npThermoStatus, npRelayState=npRelayState, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTable=npCurLoopTable, npRelHumStatus=npRelHumStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapN=npCurLoopTrapN, npCurLoopR=npCurLoopR, npRelHumTrapData=npRelHumTrapData, npResetStack=npResetStack, npIoMemo=npIoMemo, npRelHumTrapFail=npRelHumTrapFail, npSmokeTrap=npSmokeTrap, npForcedReboot=npForcedReboot, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoValuePrecise=npThermoValuePrecise, npSmokeEntry=npSmokeEntry, npIoTrapMemo=npIoTrapMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTraps=npCurLoopTraps, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTrapMemo=npSmokeTrapMemo, npRelayN=npRelayN, npTrapInfo=npTrapInfo, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopI=npCurLoopI, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeStatus=npSmokeStatus, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopN=npCurLoopN, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapV=npCurLoopTrapV, npSmokeReset=npSmokeReset, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeSensorN=npSmokeSensorN, npRelayEntry=npRelayEntry, npThermo=npThermo, npGsmTrap=npGsmTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoLevelIn=npIoLevelIn, npIrReset=npIrReset, npRelHumidity=npRelHumidity, npSmokeTable=npSmokeTable, npThermoTrapStatus=npThermoTrapStatus, npTrapEmailTo=npTrapEmailTo, npThermoTraps=npThermoTraps, npRelHumTrapTemp=npRelHumTrapTemp, npRelayMode=npRelayMode, npGsmTraps=npGsmTraps, npSmoke=npSmoke, npRelayTable=npRelayTable, npIrStatus=npIrStatus, npCurLoopTrapPower=npCurLoopTrapPower, npSmokePower=npSmokePower, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoLineN=npIoLineN, npThermoHigh=npThermoHigh, npRelayStartReset=npRelayStartReset, npGsmInfo=npGsmInfo, npCurLoopV=npCurLoopV, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTable=npThermoTable, npIoTraps=npIoTraps, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmFailed=npGsmFailed, npIrPlayCmd=npIrPlayCmd, npRelHumTrapAllChannels=npRelHumTrapAllChannels, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrap=npCurLoopTrap, npIoTable=npIoTable, npSmokeTraps=npSmokeTraps, npRelayMemo=npRelayMemo, npThermoSensorN=npThermoSensorN, npIoTrapLineN=npIoTrapLineN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTempValue=npRelHumTempValue, npSoftReboot=npSoftReboot, npThermoValue=npThermoValue, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoLevelOut=npIoLevelOut, npCurLoopEntry=npCurLoopEntry, npRelHumEntry=npRelHumEntry, npRelHumTrap=npRelHumTrap, npCurLoopPower=npCurLoopPower, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrap=npThermoTrap, npGsm=npGsm, npIrCtrl=npIrCtrl, npIoPulseCounter=npIoPulseCounter, npRelay=npRelay, npThermoLow=npThermoLow, npRelHumTempStatus=npRelHumTempStatus, lightcom=lightcom, npThermoEntry=npThermoEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, FixedPoint1000=FixedPoint1000, npRelHumN=npRelHumN, npCurLoop=npCurLoop, npRelHumTrapAllEvents=npRelHumTrapAllEvents)
