...
# Produced by pysmi-1.1.10 at Thu Oct 26 13:45:27 2023
...
Integer32, iso, ModuleIdentity, MibIdentifier, ObjectIdentity, Gauge32, TimeTicks, Bits, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, Counter64, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "Gauge32", "TimeTicks", "Bits", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "Counter64", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIrCtrl=npIrCtrl, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npReboot=npReboot, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumValue=npRelHumValue, npIoTrapLineN=npIoTrapLineN, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopR=npCurLoopR, npSmokeMemo=npSmokeMemo, npSmokeEntry=npSmokeEntry, npCurLoopTrap=npCurLoopTrap, npSmokeSensorN=npSmokeSensorN, npIoEntry=npIoEntry, npCurLoopTrapR=npCurLoopTrapR, npSmokeTraps=npSmokeTraps, npGsmTraps=npGsmTraps, npIrReset=npIrReset, npGsmFailed=npGsmFailed, npCurLoopTable=npCurLoopTable, npRelHumTrapFail=npRelHumTrapFail, npIrPlayCmd=npIrPlayCmd, npCurLoopStatus=npCurLoopStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, FixedPoint1000=FixedPoint1000, npIoTrapLevelIn=npIoTrapLevelIn, npThermoMemo=npThermoMemo, npSmokeReset=npSmokeReset, npIoTable=npIoTable, npIoLineN=npIoLineN, npGsmInfo=npGsmInfo, npIr=npIr, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoHigh=npThermoHigh, npThermoTrapLow=npThermoTrapLow, npGsm=npGsm, npGsmSendSmsUtf8=npGsmSendSmsUtf8, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTrapSensorN=npSmokeTrapSensorN, lightcom=lightcom, npCurLoopTraps=npCurLoopTraps, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeStatus=npSmokeStatus, npRelHumEntry=npRelHumEntry, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapPower=npCurLoopTrapPower, npIoLevelOut=npIoLevelOut, npRelHumTempValue=npRelHumTempValue, npSmoke=npSmoke, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoop=npCurLoop, npIo=npIo, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrap=npSmokeTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapHigh=npThermoTrapHigh, npRelayTable=npRelayTable, npGsmStrength=npGsmStrength, npThermoTrapValue=npThermoTrapValue, npRelHumMemo=npRelHumMemo, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopN=npCurLoopN, npCurLoopPower=npCurLoopPower, npSmokeTrapPrefix=npSmokeTrapPrefix, npIrStatus=npIrStatus, npRelayMemo=npRelayMemo, npRelHumidity=npRelHumidity, npTrapInfo=npTrapInfo, npRelayStartReset=npRelayStartReset, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrap=npRelHumTrap, npCurLoopEntry=npCurLoopEntry, npThermoTrap=npThermoTrap, npSmokeTable=npSmokeTable, npThermoValue=npThermoValue, npThermoStatus=npThermoStatus, npCurLoopV=npCurLoopV, npRelayState=npRelayState, npRelHumTrapTemp=npRelHumTrapTemp, npGsmTrap=npGsmTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapStatus=npThermoTrapStatus, npIoLevelIn=npIoLevelIn, npIoTrap=npIoTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelay=npRelay, npThermoValuePrecise=npThermoValuePrecise, npThermoLow=npThermoLow, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npForcedReboot=npForcedReboot, npTrapEmailTo=npTrapEmailTo, npIoTrapMemo=npIoTrapMemo, npSoftReboot=npSoftReboot, npThermo=npThermo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTempStatus=npRelHumTempStatus, npSmokeTrapMemo=npSmokeTrapMemo, npIoPulseCounter=npIoPulseCounter, npThermoEntry=npThermoEntry, npCurLoopI=npCurLoopI, npThermoTable=npThermoTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npResetStack=npResetStack, npRelHumTable=npRelHumTable, npRelHumN=npRelHumN, npRelayN=npRelayN, npRelHumTrapData=npRelHumTrapData, npIoMemo=npIoMemo, npGsmRegistration=npGsmRegistration, npRelayMode=npRelayMode, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumStatus=npRelHumStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayEntry=npRelayEntry, npThermoSensorN=npThermoSensorN, npThermoTraps=npThermoTraps, npIoTraps=npIoTraps, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokePower=npSmokePower)
