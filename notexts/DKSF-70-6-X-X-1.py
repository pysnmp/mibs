...
# Produced by pysmi-1.1.3 at Wed Dec  8 18:56:26 2021
...
Unsigned32, Gauge32, TimeTicks, Bits, ModuleIdentity, Counter64, IpAddress, MibIdentifier, enterprises, ObjectIdentity, Integer32, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Gauge32", "TimeTicks", "Bits", "ModuleIdentity", "Counter64", "IpAddress", "MibIdentifier", "enterprises", "ObjectIdentity", "Integer32", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", lightcom=lightcom, npThermoValue=npThermoValue, npSmokePower=npSmokePower, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIrPlayCmd=npIrPlayCmd, npGsmTrapPrefix=npGsmTrapPrefix, npRelay=npRelay, npGsmInfo=npGsmInfo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIrReset=npIrReset, npSmokeReset=npSmokeReset, npIoLevelOut=npIoLevelOut, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeTrapSensorN=npSmokeTrapSensorN, npTrapEmailTo=npTrapEmailTo, npRelHumidity=npRelHumidity, npCurLoopStatus=npCurLoopStatus, npGsmFailed=npGsmFailed, npIoTrapLineN=npIoTrapLineN, npIoMemo=npIoMemo, npSmokeSensorN=npSmokeSensorN, npIoTrap=npIoTrap, npRelayStartReset=npRelayStartReset, npThermoHigh=npThermoHigh, npSmokeTable=npSmokeTable, npRelHumTable=npRelHumTable, npThermoTrapHigh=npThermoTrapHigh, npIrStatus=npIrStatus, npRelayMemo=npRelayMemo, npCurLoopEntry=npCurLoopEntry, npSmoke=npSmoke, npRelHumTrapData=npRelHumTrapData, npSmokeEntry=npSmokeEntry, npIo=npIo, npThermoMemo=npThermoMemo, npGsmRegistration=npGsmRegistration, npThermoTrapValue=npThermoTrapValue, npThermoLow=npThermoLow, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTrap=npSmokeTrap, npRelHumTrapFail=npRelHumTrapFail, FixedPoint1000=FixedPoint1000, npThermoTrapLow=npThermoTrapLow, npGsmTraps=npGsmTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapN=npCurLoopTrapN, npRelayMode=npRelayMode, npThermo=npThermo, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumMemo=npRelHumMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopI=npCurLoopI, npForcedReboot=npForcedReboot, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoPulseCounter=npIoPulseCounter, npThermoValuePrecise=npThermoValuePrecise, npIoTraps=npIoTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumValue=npRelHumValue, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrap=npThermoTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTrapMemo=npSmokeTrapMemo, npTrapInfo=npTrapInfo, npCurLoopTrapV=npCurLoopTrapV, npRelayN=npRelayN, npThermoTrapPrefix=npThermoTrapPrefix, npThermoStatus=npThermoStatus, npRelayEntry=npRelayEntry, npRelHumStatus=npRelHumStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoSensorN=npThermoSensorN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoLineN=npIoLineN, npSmokeMemo=npSmokeMemo, npRelayState=npRelayState, npGsmTrap=npGsmTrap, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumN=npRelHumN, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoop=npCurLoop, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopPower=npCurLoopPower, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrap=npRelHumTrap, npRelHumTrapTemp=npRelHumTrapTemp, npIoEntry=npIoEntry, npRelHumEntry=npRelHumEntry, npCurLoopN=npCurLoopN, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrap=npCurLoopTrap, npThermoTable=npThermoTable, npIoTrapMemo=npIoTrapMemo, npRelHumTempStatus=npRelHumTempStatus, npIoLevelIn=npIoLevelIn, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTable=npCurLoopTable, npRelHumTrapDataN=npRelHumTrapDataN, npIoTrapPrefix=npIoTrapPrefix, npIoTable=npIoTable, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npResetStack=npResetStack, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsm=npGsm, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapMemo=npThermoTrapMemo, npReboot=npReboot, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapI=npCurLoopTrapI, npRelayTable=npRelayTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoEntry=npThermoEntry, npGsmStrength=npGsmStrength, npIr=npIr, npCurLoopTraps=npCurLoopTraps, npSoftReboot=npSoftReboot, npCurLoopV=npCurLoopV, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeStatus=npSmokeStatus, npThermoTraps=npThermoTraps, npCurLoopR=npCurLoopR, npIrCtrl=npIrCtrl, npSmokeTraps=npSmokeTraps, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe)
