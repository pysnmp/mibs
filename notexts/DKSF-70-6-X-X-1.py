...
# Produced by pysmi-1.1.8 at Thu Jan 13 23:59:32 2022
...
enterprises, Counter64, Integer32, NotificationType, iso, Unsigned32, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32, Bits, Gauge32, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter64", "Integer32", "NotificationType", "iso", "Unsigned32", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32", "Bits", "Gauge32", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoSensorN=npThermoSensorN, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapFail=npRelHumTrapFail, npRelayState=npRelayState, npTrapInfo=npTrapInfo, npCurLoopTrap=npCurLoopTrap, npRelHumTable=npRelHumTable, FixedPoint1000=FixedPoint1000, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapPower=npCurLoopTrapPower, npThermoHigh=npThermoHigh, npSmokeEntry=npSmokeEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmRegistration=npGsmRegistration, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoValue=npThermoValue, npThermoTrapMemo=npThermoTrapMemo, npIoTrapMemo=npIoTrapMemo, npIr=npIr, npSmoke=npSmoke, npRelHumTrapDataN=npRelHumTrapDataN, npRelayMode=npRelayMode, npRelayMemo=npRelayMemo, npIoMemo=npIoMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTraps=npCurLoopTraps, npGsmSendSmsUtf8=npGsmSendSmsUtf8, lightcom=lightcom, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapPrefix=npThermoTrapPrefix, npRelayN=npRelayN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIrCtrl=npIrCtrl, npSmokeTraps=npSmokeTraps, npCurLoop=npCurLoop, npRelayTable=npRelayTable, npCurLoopN=npCurLoopN, npSmokeTrapMemo=npSmokeTrapMemo, npGsmTrapPrefix=npGsmTrapPrefix, npGsmTrap=npGsmTrap, npRelayEntry=npRelayEntry, npReboot=npReboot, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTrapStatus=npSmokeTrapStatus, npRelay=npRelay, npCurLoopTable=npCurLoopTable, npIoPulseCounter=npIoPulseCounter, npThermoTrapValue=npThermoTrapValue, npCurLoopV=npCurLoopV, npRelHumTempValue=npRelHumTempValue, npIoLevelIn=npIoLevelIn, npSmokePower=npSmokePower, npRelHumTrapAllEvents=npRelHumTrapAllEvents, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopPower=npCurLoopPower, npThermoTable=npThermoTable, npCurLoopR=npCurLoopR, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npResetStack=npResetStack, npThermoEntry=npThermoEntry, npSoftReboot=npSoftReboot, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoStatus=npThermoStatus, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapR=npCurLoopTrapR, npIrReset=npIrReset, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTable=npSmokeTable, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumEntry=npRelHumEntry, npThermoValuePrecise=npThermoValuePrecise, npRelHumidity=npRelHumidity, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapV=npCurLoopTrapV, npGsmFailed=npGsmFailed, npIoTrap=npIoTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrap=npThermoTrap, npRelHumValue=npRelHumValue, npIoLineN=npIoLineN, npIoTable=npIoTable, npRelHumTrap=npRelHumTrap, npRelHumTempStatus=npRelHumTempStatus, npCurLoopStatus=npCurLoopStatus, npGsmTraps=npGsmTraps, npIoTrapPrefix=npIoTrapPrefix, npRelayStartReset=npRelayStartReset, npThermoTrapLow=npThermoTrapLow, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoEntry=npIoEntry, npTrapEmailTo=npTrapEmailTo, npIoTrapLineN=npIoTrapLineN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoMemo=npThermoMemo, npRelHumMemo=npRelHumMemo, npSmokeSensorN=npSmokeSensorN, npThermoTraps=npThermoTraps, npIrPlayCmd=npIrPlayCmd, npIrStatus=npIrStatus, npIoTraps=npIoTraps, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumStatus=npRelHumStatus, npSmokeTrap=npSmokeTrap, npSmokeReset=npSmokeReset, npThermo=npThermo, npRelHumN=npRelHumN, npGsm=npGsm, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npForcedReboot=npForcedReboot, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapI=npCurLoopTrapI, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeStatus=npSmokeStatus, npGsmStrength=npGsmStrength, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoLow=npThermoLow, npIoLevelOut=npIoLevelOut, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopI=npCurLoopI, npGsmInfo=npGsmInfo, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapHigh=npThermoTrapHigh, npIo=npIo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeMemo=npSmokeMemo)
