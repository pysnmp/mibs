...
# Produced by pysmi-1.1.3 at Sun Nov 21 13:27:42 2021
...
ModuleIdentity, enterprises, NotificationType, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, Counter32, Gauge32, Counter64, iso, TimeTicks, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "NotificationType", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "Counter32", "Gauge32", "Counter64", "iso", "TimeTicks", "Unsigned32", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTraps=npSmokeTraps, npThermoTable=npThermoTable, npThermoTrapSensorN=npThermoTrapSensorN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTempStatus=npRelHumTempStatus, npSoftReboot=npSoftReboot, npIoTrap=npIoTrap, npSmokeStatus=npSmokeStatus, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapPower=npCurLoopTrapPower, npGsmInfo=npGsmInfo, npIo=npIo, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapHigh=npThermoTrapHigh, npIoSinglePulseStart=npIoSinglePulseStart, npTrapInfo=npTrapInfo, npCurLoopTrapR=npCurLoopTrapR, npCurLoopStatus=npCurLoopStatus, npThermoTraps=npThermoTraps, npCurLoopTrap=npCurLoopTrap, npCurLoopTable=npCurLoopTable, npResetStack=npResetStack, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTrapLineN=npIoTrapLineN, npThermoTrapMemo=npThermoTrapMemo, npRelayStartReset=npRelayStartReset, npRelHumMemo=npRelHumMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoMemo=npIoMemo, npRelayEntry=npRelayEntry, npRelHumidity=npRelHumidity, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTempValue=npRelHumTempValue, lightcom=lightcom, npRelHumEntry=npRelHumEntry, npThermoSensorN=npThermoSensorN, npIoEntry=npIoEntry, npSmokePower=npSmokePower, npThermoTrapStatus=npThermoTrapStatus, npRelay=npRelay, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapValue=npThermoTrapValue, npCurLoopPower=npCurLoopPower, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapV=npCurLoopTrapV, npIr=npIr, npIoTrapMemo=npIoTrapMemo, npCurLoopEntry=npCurLoopEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmStrength=npGsmStrength, npSmokeTrap=npSmokeTrap, npGsmFailed=npGsmFailed, npReboot=npReboot, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoEntry=npThermoEntry, npThermo=npThermo, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopV=npCurLoopV, npThermoValuePrecise=npThermoValuePrecise, npGsm=npGsm, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrapPrefix=npIoTrapPrefix, npCurLoopN=npCurLoopN, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTraps=npIoTraps, npCurLoopTrapN=npCurLoopTrapN, npIoLevelOut=npIoLevelOut, npSmoke=npSmoke, npCurLoop=npCurLoop, npRelHumTable=npRelHumTable, npRelayN=npRelayN, npSmokeTrapMemo=npSmokeTrapMemo, npIrReset=npIrReset, npSmokeMemo=npSmokeMemo, npGsmRegistration=npGsmRegistration, npIrPlayCmd=npIrPlayCmd, npTrapEmailTo=npTrapEmailTo, npIoTable=npIoTable, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelayMode=npRelayMode, npIoTrapLevelIn=npIoTrapLevelIn, FixedPoint1000=FixedPoint1000, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoLow=npThermoLow, npRelHumStatus=npRelHumStatus, npThermoStatus=npThermoStatus, npIoLineN=npIoLineN, npGsmTrap=npGsmTrap, npCurLoopR=npCurLoopR, npIrCtrl=npIrCtrl, npIrStatus=npIrStatus, npThermoHigh=npThermoHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumN=npRelHumN, npThermoMemo=npThermoMemo, npRelayState=npRelayState, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumValue=npRelHumValue, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeReset=npSmokeReset, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoPulseCounter=npIoPulseCounter, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrap=npRelHumTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayMemo=npRelayMemo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoValue=npThermoValue, npSmokeEntry=npSmokeEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npForcedReboot=npForcedReboot, npRelayTable=npRelayTable, npGsmTraps=npGsmTraps, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrap=npThermoTrap, npSmokeSensorN=npSmokeSensorN, npIoLevelIn=npIoLevelIn, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTraps=npCurLoopTraps, npCurLoopI=npCurLoopI, npThermoTrapLow=npThermoTrapLow, npSmokeTable=npSmokeTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe)
