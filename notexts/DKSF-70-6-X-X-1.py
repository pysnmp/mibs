...
# Produced by pysmi-1.1.10 at Mon Dec 11 02:40:39 2023
...
enterprises, Unsigned32, Gauge32, TimeTicks, Counter32, IpAddress, Bits, iso, ModuleIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Unsigned32", "Gauge32", "TimeTicks", "Counter32", "IpAddress", "Bits", "iso", "ModuleIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTable=npIoTable, npIoLevelIn=npIoLevelIn, npRelHumTrap=npRelHumTrap, npGsmTrap=npGsmTrap, npRelayStartReset=npRelayStartReset, npSmokeReset=npSmokeReset, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeSensorN=npSmokeSensorN, npSoftReboot=npSoftReboot, npThermoStatus=npThermoStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npResetStack=npResetStack, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermo=npThermo, npSmokeTrapPrefix=npSmokeTrapPrefix, lightcom=lightcom, npCurLoop=npCurLoop, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapSafe=npRelHumTrapSafe, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumEntry=npRelHumEntry, npIoLevelOut=npIoLevelOut, npSmoke=npSmoke, npThermoTrapMemo=npThermoTrapMemo, npThermoValue=npThermoValue, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopStatus=npCurLoopStatus, npRelayState=npRelayState, npIoTrap=npIoTrap, npCurLoopR=npCurLoopR, npGsm=npGsm, npIrReset=npIrReset, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopV=npCurLoopV, npThermoTrapValue=npThermoTrapValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTraps=npCurLoopTraps, npRelHumValue=npRelHumValue, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoSinglePulseDuration=npIoSinglePulseDuration, npIrStatus=npIrStatus, npIoLineN=npIoLineN, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTable=npCurLoopTable, npCurLoopEntry=npCurLoopEntry, npIrPlayCmd=npIrPlayCmd, npThermoHigh=npThermoHigh, npForcedReboot=npForcedReboot, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelayN=npRelayN, npThermoTraps=npThermoTraps, npThermoTrap=npThermoTrap, npGsmInfo=npGsmInfo, npSmokeTable=npSmokeTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopPower=npCurLoopPower, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrap=npCurLoopTrap, npThermoTrapHigh=npThermoTrapHigh, npIo=npIo, npThermoEntry=npThermoEntry, npCurLoopN=npCurLoopN, npSmokeTraps=npSmokeTraps, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTempValue=npRelHumTempValue, npRelHumidity=npRelHumidity, npThermoTrapStatus=npThermoTrapStatus, npGsmRegistration=npGsmRegistration, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumN=npRelHumN, npIoTrapLevelIn=npIoTrapLevelIn, npThermoSensorN=npThermoSensorN, npRelHumTable=npRelHumTable, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTable=npThermoTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmStrength=npGsmStrength, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayMemo=npRelayMemo, npRelHumMemo=npRelHumMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoValuePrecise=npThermoValuePrecise, npIoTrapMemo=npIoTrapMemo, npTrapEmailTo=npTrapEmailTo, npGsmFailed=npGsmFailed, npIoTrapLevelLegend=npIoTrapLevelLegend, npIr=npIr, npIoTraps=npIoTraps, npIoMemo=npIoMemo, npIoTrapLineN=npIoTrapLineN, npSmokePower=npSmokePower, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTrap=npSmokeTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoMemo=npThermoMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapLow=npThermoTrapLow, npSmokeEntry=npSmokeEntry, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npTrapInfo=npTrapInfo, npSmokeMemo=npSmokeMemo, npRelayMode=npRelayMode, npCurLoopTrapV=npCurLoopTrapV, npRelayTable=npRelayTable, npIoPulseCounter=npIoPulseCounter, npCurLoopI=npCurLoopI, npCurLoopTrapI=npCurLoopTrapI, npRelHumStatus=npRelHumStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoEntry=npIoEntry, npGsmTraps=npGsmTraps, npSmokeStatus=npSmokeStatus, npIrCtrl=npIrCtrl, npReboot=npReboot, npRelay=npRelay, FixedPoint1000=FixedPoint1000, npThermoLow=npThermoLow, npCurLoopTrapR=npCurLoopTrapR, npRelHumTempStatus=npRelHumTempStatus, npRelayEntry=npRelayEntry)
