...
# Produced by pysmi-1.1.8 at Mon Sep 19 08:33:19 2022
...
ObjectIdentity, TimeTicks, enterprises, Integer32, iso, Counter32, Unsigned32, IpAddress, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Gauge32, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "enterprises", "Integer32", "iso", "Counter32", "Unsigned32", "IpAddress", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Gauge32", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeMemo=npSmokeMemo, npRelHumTempStatus=npRelHumTempStatus, npSoftReboot=npSoftReboot, npThermoLow=npThermoLow, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapPower=npCurLoopTrapPower, npRelayStartReset=npRelayStartReset, npIrStatus=npIrStatus, npTrapEmailTo=npTrapEmailTo, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrapPrefix=npIoTrapPrefix, npRelHumidity=npRelHumidity, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmRegistration=npGsmRegistration, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopN=npCurLoopN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTable=npThermoTable, npGsmFailed=npGsmFailed, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmTrap=npGsmTrap, npIo=npIo, npSmokeTrap=npSmokeTrap, npSmokeSensorN=npSmokeSensorN, npRelHumTrapSafe=npRelHumTrapSafe, npIoLevelIn=npIoLevelIn, npIoPulseCounter=npIoPulseCounter, npIoTrap=npIoTrap, npCurLoopTable=npCurLoopTable, npThermoTraps=npThermoTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumEntry=npRelHumEntry, npIrReset=npIrReset, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, FixedPoint1000=FixedPoint1000, npRelHumTrapFail=npRelHumTrapFail, npCurLoopStatus=npCurLoopStatus, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIr=npIr, PYSNMP_MODULE_ID=uniPingServerSolutionV3, lightcom=lightcom, npCurLoop=npCurLoop, npThermoValuePrecise=npThermoValuePrecise, npSmokeTraps=npSmokeTraps, npCurLoopR=npCurLoopR, npThermoSensorN=npThermoSensorN, npIoTrapMemo=npIoTrapMemo, npIrPlayCmd=npIrPlayCmd, npCurLoopV=npCurLoopV, npRelayMemo=npRelayMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmoke=npSmoke, npThermoTrapValue=npThermoTrapValue, npSmokePower=npSmokePower, npCurLoopEntry=npCurLoopEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayEntry=npRelayEntry, npCurLoopTrapR=npCurLoopTrapR, npRelayTable=npRelayTable, npCurLoopTraps=npCurLoopTraps, npIoMemo=npIoMemo, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmTraps=npGsmTraps, npRelay=npRelay, npSmokeReset=npSmokeReset, npThermoTrapPrefix=npThermoTrapPrefix, npForcedReboot=npForcedReboot, npCurLoopTrap=npCurLoopTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoEntry=npIoEntry, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTable=npSmokeTable, npSmokeStatus=npSmokeStatus, npRelayMode=npRelayMode, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTable=npRelHumTable, npReboot=npReboot, npThermo=npThermo, npIoTrapLineN=npIoTrapLineN, npRelayState=npRelayState, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoHigh=npThermoHigh, npRelHumTrapTemp=npRelHumTrapTemp, npRelayN=npRelayN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npTrapInfo=npTrapInfo, npRelHumTempValue=npRelHumTempValue, npThermoValue=npThermoValue, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTraps=npIoTraps, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoLineN=npIoLineN, npRelHumN=npRelHumN, npThermoTrapLow=npThermoTrapLow, npRelHumTrap=npRelHumTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumValue=npRelHumValue, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTable=npIoTable, npRelHumStatus=npRelHumStatus, npThermoStatus=npThermoStatus, npSmokeEntry=npSmokeEntry, npCurLoopI=npCurLoopI, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npGsmInfo=npGsmInfo, npIrCtrl=npIrCtrl, npGsm=npGsm, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopPower=npCurLoopPower, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmStrength=npGsmStrength, npThermoTrap=npThermoTrap, npRelHumMemo=npRelHumMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoLevelOut=npIoLevelOut, npThermoMemo=npThermoMemo, npCurLoopTrapN=npCurLoopTrapN, npResetStack=npResetStack, npThermoTrapHigh=npThermoTrapHigh, npThermoEntry=npThermoEntry, npCurLoopTrapStatus=npCurLoopTrapStatus)
