...
IpAddress, MibIdentifier, Gauge32, Integer32, TimeTicks, ObjectIdentity, Unsigned32, Counter64, NotificationType, ModuleIdentity, Counter32, enterprises, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibIdentifier", "Gauge32", "Integer32", "TimeTicks", "ObjectIdentity", "Unsigned32", "Counter64", "NotificationType", "ModuleIdentity", "Counter32", "enterprises", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTrapI=npCurLoopTrapI, npCurLoopPower=npCurLoopPower, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapFail=npRelHumTrapFail, npThermoSensorN=npThermoSensorN, npRelayStartReset=npRelayStartReset, npRelayMode=npRelayMode, npIoTable=npIoTable, npIoTrap=npIoTrap, lightcom=lightcom, npThermoEntry=npThermoEntry, npRelHumValue=npRelHumValue, npCurLoopV=npCurLoopV, npSmokeTrapMemo=npSmokeTrapMemo, npIo=npIo, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrap=npRelHumTrap, npIoMemo=npIoMemo, npThermoTrap=npThermoTrap, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapN=npCurLoopTrapN, npSmokePower=npSmokePower, npRelayN=npRelayN, npRelayState=npRelayState, npSmokeSensorN=npSmokeSensorN, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeStatus=npSmokeStatus, npCurLoopTrapV=npCurLoopTrapV, npRelHumN=npRelHumN, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoStatus=npThermoStatus, npIoLevelOut=npIoLevelOut, npRelay=npRelay, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapLineN=npIoTrapLineN, npCurLoopStatus=npCurLoopStatus, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTable=npThermoTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapStatus=npThermoTrapStatus, npGsmTraps=npGsmTraps, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopR=npCurLoopR, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmStrength=npGsmStrength, npTrapInfo=npTrapInfo, npThermoTrapHigh=npThermoTrapHigh, npForcedReboot=npForcedReboot, npIoPulseCounter=npIoPulseCounter, npIoTrapPrefix=npIoTrapPrefix, npGsmTrapPrefix=npGsmTrapPrefix, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayTable=npRelayTable, npRelHumTempStatus=npRelHumTempStatus, npTrapEmailTo=npTrapEmailTo, npSmokeTable=npSmokeTable, npSmokeTraps=npSmokeTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoMemo=npThermoMemo, npRelHumMemo=npRelHumMemo, npRelayEntry=npRelayEntry, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeReset=npSmokeReset, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmInfo=npGsmInfo, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTraps=npThermoTraps, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoLow=npThermoLow, npThermoValuePrecise=npThermoValuePrecise, npThermo=npThermo, npThermoTrapPrefix=npThermoTrapPrefix, FixedPoint1000=FixedPoint1000, npCurLoopTraps=npCurLoopTraps, npRelHumidity=npRelHumidity, npIrCtrl=npIrCtrl, npSmokeEntry=npSmokeEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopN=npCurLoopN, npGsmFailed=npGsmFailed, npIoTraps=npIoTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapValue=npThermoTrapValue, npResetStack=npResetStack, npRelayMemo=npRelayMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmTrap=npGsmTrap, npSmokeTrap=npSmokeTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmRegistration=npGsmRegistration, npCurLoopI=npCurLoopI, npIr=npIr, npCurLoopTable=npCurLoopTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapLow=npThermoTrapLow, npIrPlayCmd=npIrPlayCmd, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSoftReboot=npSoftReboot, npIoLevelIn=npIoLevelIn, npReboot=npReboot, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoEntry=npIoEntry, npCurLoop=npCurLoop, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrap=npCurLoopTrap, npRelHumEntry=npRelHumEntry, npSmokeMemo=npSmokeMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoValue=npThermoValue, npGsm=npGsm, npRelHumStatus=npRelHumStatus, npRelHumTempValue=npRelHumTempValue, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataN=npRelHumTrapDataN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIrReset=npIrReset, npIoLineN=npIoLineN, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTable=npRelHumTable, npSmoke=npSmoke, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoHigh=npThermoHigh, npCurLoopEntry=npCurLoopEntry, npIrStatus=npIrStatus)
