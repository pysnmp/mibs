...
MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Integer32, ModuleIdentity, Gauge32, Unsigned32, iso, Counter32, ObjectIdentity, IpAddress, TimeTicks, Counter64, enterprises, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Integer32", "ModuleIdentity", "Gauge32", "Unsigned32", "iso", "Counter32", "ObjectIdentity", "IpAddress", "TimeTicks", "Counter64", "enterprises", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrap=npThermoTrap, npReboot=npReboot, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayEntry=npRelayEntry, FixedPoint1000=FixedPoint1000, npRelHumEntry=npRelHumEntry, npGsm=npGsm, npRelayMode=npRelayMode, npThermoEntry=npThermoEntry, npIoTrapLineN=npIoTrapLineN, npForcedReboot=npForcedReboot, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npResetStack=npResetStack, npThermoValue=npThermoValue, npIoLevelIn=npIoLevelIn, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayState=npRelayState, npCurLoopI=npCurLoopI, npRelHumTrapSafe=npRelHumTrapSafe, npSmoke=npSmoke, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTable=npCurLoopTable, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTemp=npRelHumTrapTemp, npIoLevelOut=npIoLevelOut, npIr=npIr, npThermo=npThermo, npIoTrapLevelIn=npIoTrapLevelIn, npThermoStatus=npThermoStatus, npSmokeStatus=npSmokeStatus, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapN=npCurLoopTrapN, npRelHumTable=npRelHumTable, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrap=npRelHumTrap, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrap=npCurLoopTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrapPrefix=npIoTrapPrefix, npThermoTraps=npThermoTraps, npRelHumN=npRelHumN, npThermoSensorN=npThermoSensorN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumStatus=npRelHumStatus, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeReset=npSmokeReset, npGsmTrap=npGsmTrap, npIrStatus=npIrStatus, npIoTrap=npIoTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopEntry=npCurLoopEntry, npIoPulseCounter=npIoPulseCounter, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeSensorN=npSmokeSensorN, npIrCtrl=npIrCtrl, npRelHumValue=npRelHumValue, npRelay=npRelay, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapHigh=npThermoTrapHigh, npSmokeTable=npSmokeTable, npRelHumMemo=npRelHumMemo, npRelayN=npRelayN, npGsmFailed=npGsmFailed, npThermoTrapSensorN=npThermoTrapSensorN, npIoTable=npIoTable, lightcom=lightcom, npCurLoopPower=npCurLoopPower, npCurLoopTraps=npCurLoopTraps, npIoTraps=npIoTraps, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoMemo=npIoMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopN=npCurLoopN, npGsmTraps=npGsmTraps, npThermoMemo=npThermoMemo, npThermoTrapLow=npThermoTrapLow, npSmokePower=npSmokePower, npSmokeMemo=npSmokeMemo, npGsmInfo=npGsmInfo, npGsmStrength=npGsmStrength, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTrapMemo=npSmokeTrapMemo, npSoftReboot=npSoftReboot, npCurLoopStatus=npCurLoopStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmRegistration=npGsmRegistration, npTrapInfo=npTrapInfo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayStartReset=npRelayStartReset, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapV=npCurLoopTrapV, npRelayMemo=npRelayMemo, npIoLineN=npIoLineN, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTable=npThermoTable, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayTable=npRelayTable, npCurLoopR=npCurLoopR, npSmokeTrap=npSmokeTrap, npIrReset=npIrReset, npThermoTrapValue=npThermoTrapValue, npRelHumidity=npRelHumidity, npIo=npIo, npThermoTrapMemo=npThermoTrapMemo, npCurLoopV=npCurLoopV, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeEntry=npSmokeEntry, npIoEntry=npIoEntry, npRelHumTempValue=npRelHumTempValue, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npThermoLow=npThermoLow, npSmokeTraps=npSmokeTraps, npTrapEmailTo=npTrapEmailTo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIrPlayCmd=npIrPlayCmd, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoHigh=npThermoHigh, npCurLoop=npCurLoop)
