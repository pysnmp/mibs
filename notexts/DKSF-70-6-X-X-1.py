...
# Produced by pysmi-1.1.8 at Fri Jan 27 14:01:59 2023
...
Counter64, Gauge32, ModuleIdentity, iso, Integer32, Unsigned32, TimeTicks, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, IpAddress, enterprises, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "ModuleIdentity", "iso", "Integer32", "Unsigned32", "TimeTicks", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "IpAddress", "enterprises", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeMemo=npSmokeMemo, npIoEntry=npIoEntry, npSmokeTable=npSmokeTable, npThermoSensorN=npThermoSensorN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTable=npRelHumTable, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapValue=npThermoTrapValue, npCurLoopV=npCurLoopV, npThermoHigh=npThermoHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmRegistration=npGsmRegistration, npGsmFailed=npGsmFailed, npSmokePower=npSmokePower, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrap=npCurLoopTrap, npIoLevelOut=npIoLevelOut, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumidity=npRelHumidity, npGsmTraps=npGsmTraps, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeReset=npSmokeReset, npIrStatus=npIrStatus, npThermoMemo=npThermoMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmoke=npSmoke, npRelHumEntry=npRelHumEntry, npRelayMemo=npRelayMemo, lightcom=lightcom, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapLow=npThermoTrapLow, npThermoValue=npThermoValue, npGsmStrength=npGsmStrength, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapFail=npRelHumTrapFail, npSmokeStatus=npSmokeStatus, npRelHumTempValue=npRelHumTempValue, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTraps=npThermoTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoStatus=npThermoStatus, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTraps=npSmokeTraps, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTrapPrefix=npIoTrapPrefix, npSoftReboot=npSoftReboot, npRelayEntry=npRelayEntry, npCurLoopI=npCurLoopI, npIoLineN=npIoLineN, npRelayTable=npRelayTable, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoPulseCounter=npIoPulseCounter, npIoLevelIn=npIoLevelIn, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoLow=npThermoLow, npThermoValuePrecise=npThermoValuePrecise, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapMemo=npThermoTrapMemo, npIoTrapLineN=npIoTrapLineN, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapR=npCurLoopTrapR, npGsmInfo=npGsmInfo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTable=npThermoTable, npRelayStartReset=npRelayStartReset, npSmokeTrap=npSmokeTrap, npCurLoopN=npCurLoopN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayState=npRelayState, npThermoTrapStatus=npThermoTrapStatus, npRelHumValue=npRelHumValue, npThermoTrap=npThermoTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumN=npRelHumN, npResetStack=npResetStack, npRelHumStatus=npRelHumStatus, npIrCtrl=npIrCtrl, npCurLoopTable=npCurLoopTable, npGsmTrap=npGsmTrap, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoop=npCurLoop, npThermoTrapHigh=npThermoTrapHigh, npCurLoopStatus=npCurLoopStatus, npRelHumTempStatus=npRelHumTempStatus, npForcedReboot=npForcedReboot, npRelHumTrap=npRelHumTrap, npRelHumTrapDataN=npRelHumTrapDataN, FixedPoint1000=FixedPoint1000, npCurLoopR=npCurLoopR, npCurLoopTraps=npCurLoopTraps, npThermoEntry=npThermoEntry, npIoTable=npIoTable, npTrapEmailTo=npTrapEmailTo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeEntry=npSmokeEntry, npIr=npIr, npIoTrap=npIoTrap, npIoTraps=npIoTraps, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayN=npRelayN, npRelay=npRelay, npIoTrapMemo=npIoTrapMemo, npRelayMode=npRelayMode, npThermo=npThermo, npRelHumTrapSafe=npRelHumTrapSafe, npTrapInfo=npTrapInfo, npIrReset=npIrReset, npReboot=npReboot, npRelHumMemo=npRelHumMemo, npCurLoopTrapN=npCurLoopTrapN, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapI=npCurLoopTrapI, npSmokeSensorN=npSmokeSensorN, npGsm=npGsm, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopPower=npCurLoopPower, npIo=npIo, npThermoTrapSensorN=npThermoTrapSensorN, npIoMemo=npIoMemo, npRelHumTrapData=npRelHumTrapData)
