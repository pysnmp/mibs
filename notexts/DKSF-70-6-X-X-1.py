...
# Produced by pysmi-1.1.3 at Sun Nov 28 17:07:00 2021
...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, Bits, Counter32, Gauge32, enterprises, ModuleIdentity, Integer32, NotificationType, Unsigned32, IpAddress, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "Bits", "Counter32", "Gauge32", "enterprises", "ModuleIdentity", "Integer32", "NotificationType", "Unsigned32", "IpAddress", "ObjectIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrapMemo=npSmokeTrapMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrap=npRelHumTrap, npIoTrap=npIoTrap, npIoEntry=npIoEntry, npSmokeTable=npSmokeTable, npThermoTrapHigh=npThermoTrapHigh, npIoMemo=npIoMemo, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelay=npRelay, npThermoSensorN=npThermoSensorN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapStatus=npCurLoopTrapStatus, lightcom=lightcom, npRelHumStatus=npRelHumStatus, npThermoHigh=npThermoHigh, npThermoEntry=npThermoEntry, npIoSinglePulseStart=npIoSinglePulseStart, npGsm=npGsm, npSmokeTraps=npSmokeTraps, npSmokeTrapStatus=npSmokeTrapStatus, npIoLevelIn=npIoLevelIn, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoop=npCurLoop, npRelHumTable=npRelHumTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIrReset=npIrReset, npThermoTraps=npThermoTraps, npIoTraps=npIoTraps, npGsmFailed=npGsmFailed, npSoftReboot=npSoftReboot, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoValuePrecise=npThermoValuePrecise, npSmokePower=npSmokePower, npIoLevelOut=npIoLevelOut, npSmokeEntry=npSmokeEntry, npCurLoopPower=npCurLoopPower, npSmokeTrap=npSmokeTrap, npSmokeSensorN=npSmokeSensorN, npRelayN=npRelayN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapSafe=npRelHumTrapSafe, npRelayStartReset=npRelayStartReset, npSmokeReset=npSmokeReset, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumidity=npRelHumidity, npRelHumTempStatus=npRelHumTempStatus, npIoTrapLineN=npIoTrapLineN, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayMemo=npRelayMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopV=npCurLoopV, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapPrefix=npIoTrapPrefix, npTrapInfo=npTrapInfo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoLineN=npIoLineN, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermo=npThermo, npCurLoopN=npCurLoopN, npIoTrapLevelIn=npIoTrapLevelIn, npForcedReboot=npForcedReboot, npRelHumN=npRelHumN, npCurLoopTrapN=npCurLoopTrapN, npSmokeMemo=npSmokeMemo, npThermoLow=npThermoLow, npThermoStatus=npThermoStatus, npSmoke=npSmoke, npTrapEmailTo=npTrapEmailTo, npRelHumTempValue=npRelHumTempValue, npThermoTrapStatus=npThermoTrapStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapPrefix=npThermoTrapPrefix, npIo=npIo, npIrCtrl=npIrCtrl, npThermoValue=npThermoValue, npThermoTrapLow=npThermoTrapLow, npRelHumValue=npRelHumValue, FixedPoint1000=FixedPoint1000, npThermoTrap=npThermoTrap, npIr=npIr, npIrStatus=npIrStatus, npGsmInfo=npGsmInfo, npRelHumTrapData=npRelHumTrapData, npCurLoopR=npCurLoopR, npThermoTrapValue=npThermoTrapValue, npRelayState=npRelayState, npRelayMode=npRelayMode, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npReboot=npReboot, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrap=npCurLoopTrap, npRelHumMemo=npRelHumMemo, npThermoTrapMemo=npThermoTrapMemo, npCurLoopEntry=npCurLoopEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopI=npCurLoopI, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTable=npThermoTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapR=npCurLoopTrapR, npGsmTrap=npGsmTrap, npRelHumTrapFail=npRelHumTrapFail, npGsmStrength=npGsmStrength, npCurLoopTable=npCurLoopTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeStatus=npSmokeStatus, npThermoMemo=npThermoMemo, npIoPulseCounter=npIoPulseCounter, npIoTrapMemo=npIoTrapMemo, npRelayTable=npRelayTable, npRelHumEntry=npRelHumEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTable=npIoTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npResetStack=npResetStack, npGsmTraps=npGsmTraps, npIrPlayCmd=npIrPlayCmd, npCurLoopTraps=npCurLoopTraps, npRelayEntry=npRelayEntry, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmTrapPrefix=npGsmTrapPrefix, npGsmRegistration=npGsmRegistration, npRelHumTrapDataMemo=npRelHumTrapDataMemo)
