...
# Produced by pysmi-1.1.8 at Thu Oct 12 09:11:03 2023
...
iso, IpAddress, Integer32, enterprises, NotificationType, ObjectIdentity, Counter64, Bits, MibIdentifier, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "Integer32", "enterprises", "NotificationType", "ObjectIdentity", "Counter64", "Bits", "MibIdentifier", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIrCtrl=npIrCtrl, npRelayTable=npRelayTable, npRelHumStatus=npRelHumStatus, npIoTrapMemo=npIoTrapMemo, npThermoEntry=npThermoEntry, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrap=npRelHumTrap, npCurLoopR=npCurLoopR, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeSensorN=npSmokeSensorN, npThermoLow=npThermoLow, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokePower=npSmokePower, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npResetStack=npResetStack, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeReset=npSmokeReset, npSmokeTraps=npSmokeTraps, npThermoValue=npThermoValue, npCurLoopTrap=npCurLoopTrap, npThermoTrap=npThermoTrap, npCurLoopTrapPower=npCurLoopTrapPower, npRelayN=npRelayN, npSmokeTable=npSmokeTable, npRelHumTrapData=npRelHumTrapData, npGsmTraps=npGsmTraps, npCurLoopTrapV=npCurLoopTrapV, npIoTrapLineN=npIoTrapLineN, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoMemo=npIoMemo, npRelayStartReset=npRelayStartReset, npSmokeEntry=npSmokeEntry, npSmokeMemo=npSmokeMemo, npCurLoopV=npCurLoopV, npSmokeTrap=npSmokeTrap, npIoLevelOut=npIoLevelOut, npCurLoopTable=npCurLoopTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoValuePrecise=npThermoValuePrecise, npThermoTable=npThermoTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermo=npThermo, npIrPlayCmd=npIrPlayCmd, npTrapEmailTo=npTrapEmailTo, npRelHumTable=npRelHumTable, npGsmRegistration=npGsmRegistration, npIoLevelIn=npIoLevelIn, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapMemo=npThermoTrapMemo, npThermoTrapHigh=npThermoTrapHigh, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelay=npRelay, npIoSinglePulseStart=npIoSinglePulseStart, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayState=npRelayState, npIoTrap=npIoTrap, npRelHumTempStatus=npRelHumTempStatus, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTraps=npThermoTraps, npRelHumTrapFail=npRelHumTrapFail, npIrReset=npIrReset, npRelayMode=npRelayMode, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrapMemo=npSmokeTrapMemo, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumEntry=npRelHumEntry, npIr=npIr, npIoTraps=npIoTraps, npRelHumValue=npRelHumValue, npIrStatus=npIrStatus, npRelayMemo=npRelayMemo, npIoTrapPrefix=npIoTrapPrefix, npThermoHigh=npThermoHigh, npThermoStatus=npThermoStatus, npRelHumMemo=npRelHumMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoLineN=npIoLineN, npThermoTrapValue=npThermoTrapValue, npReboot=npReboot, npTrapInfo=npTrapInfo, npThermoTrapLow=npThermoTrapLow, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopStatus=npCurLoopStatus, npGsmFailed=npGsmFailed, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopI=npCurLoopI, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeStatus=npSmokeStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmStrength=npGsmStrength, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapSensorN=npThermoTrapSensorN, npIoTable=npIoTable, npCurLoopTrapR=npCurLoopTrapR, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTemp=npRelHumTrapTemp, npIoSinglePulseDuration=npIoSinglePulseDuration, FixedPoint1000=FixedPoint1000, npIoPulseCounter=npIoPulseCounter, npSoftReboot=npSoftReboot, npRelHumN=npRelHumN, npRelayEntry=npRelayEntry, npCurLoopN=npCurLoopN, lightcom=lightcom, npGsmTrap=npGsmTrap, npThermoSensorN=npThermoSensorN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsm=npGsm, npThermoMemo=npThermoMemo, npIo=npIo, npCurLoopPower=npCurLoopPower, npRelHumidity=npRelHumidity, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoEntry=npIoEntry, npCurLoop=npCurLoop, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapI=npCurLoopTrapI, npSmoke=npSmoke, npForcedReboot=npForcedReboot, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTrapLevelIn=npIoTrapLevelIn, npGsmInfo=npGsmInfo, npCurLoopTraps=npCurLoopTraps)
