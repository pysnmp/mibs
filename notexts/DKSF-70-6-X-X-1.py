...
TimeTicks, iso, Counter32, ObjectIdentity, Gauge32, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, Bits, enterprises, Unsigned32, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "Counter32", "ObjectIdentity", "Gauge32", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "Bits", "enterprises", "Unsigned32", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmTraps=npGsmTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoLevelOut=npIoLevelOut, npSmoke=npSmoke, npThermoTrapHigh=npThermoTrapHigh, npThermoTraps=npThermoTraps, npRelHumTempStatus=npRelHumTempStatus, npIr=npIr, npThermoTrapSensorN=npThermoTrapSensorN, npResetStack=npResetStack, npThermoLow=npThermoLow, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapR=npCurLoopTrapR, npRelayTable=npRelayTable, npSmokeTraps=npSmokeTraps, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTempValue=npRelHumTempValue, npCurLoop=npCurLoop, npIoTrapLevelIn=npIoTrapLevelIn, npRelayEntry=npRelayEntry, npCurLoopN=npCurLoopN, npThermoTable=npThermoTable, npCurLoopStatus=npCurLoopStatus, npThermoTrapPrefix=npThermoTrapPrefix, npRelayN=npRelayN, npIoSinglePulseStart=npIoSinglePulseStart, npRelayState=npRelayState, npCurLoopTrap=npCurLoopTrap, npSoftReboot=npSoftReboot, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoEntry=npThermoEntry, npTrapEmailTo=npTrapEmailTo, npRelHumValue=npRelHumValue, npSmokePower=npSmokePower, npThermoTrapMemo=npThermoTrapMemo, npIoTrapLineN=npIoTrapLineN, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmStrength=npGsmStrength, npCurLoopI=npCurLoopI, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npTrapInfo=npTrapInfo, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapN=npCurLoopTrapN, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumStatus=npRelHumStatus, npGsmFailed=npGsmFailed, npThermoValue=npThermoValue, npSmokeEntry=npSmokeEntry, npSmokeTrap=npSmokeTrap, npRelHumTrap=npRelHumTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopV=npCurLoopV, npRelayStartReset=npRelayStartReset, npCurLoopPower=npCurLoopPower, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, lightcom=lightcom, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumMemo=npRelHumMemo, npGsmInfo=npGsmInfo, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTable=npSmokeTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapValue=npThermoTrapValue, npIoTrap=npIoTrap, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrap=npThermoTrap, npIrStatus=npIrStatus, npIoEntry=npIoEntry, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapLow=npThermoTrapLow, npRelHumEntry=npRelHumEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermo=npThermo, npCurLoopTrapPower=npCurLoopTrapPower, npIrReset=npIrReset, npCurLoopTable=npCurLoopTable, npIoMemo=npIoMemo, npRelHumN=npRelHumN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTable=npRelHumTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoValuePrecise=npThermoValuePrecise, npIrCtrl=npIrCtrl, npCurLoopTrapI=npCurLoopTrapI, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoMemo=npThermoMemo, npForcedReboot=npForcedReboot, npIoLevelIn=npIoLevelIn, npRelHumidity=npRelHumidity, npGsm=npGsm, npRelayMemo=npRelayMemo, npSmokeReset=npSmokeReset, npIoTraps=npIoTraps, npIoPulseCounter=npIoPulseCounter, npIoLineN=npIoLineN, npRelHumTrapDataN=npRelHumTrapDataN, npThermoSensorN=npThermoSensorN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTable=npIoTable, npIrPlayCmd=npIrPlayCmd, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayMode=npRelayMode, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapStatus=npCurLoopTrapStatus, npReboot=npReboot, npRelay=npRelay, npIo=npIo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmRegistration=npGsmRegistration, npGsmTrap=npGsmTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeStatus=npSmokeStatus, npThermoHigh=npThermoHigh, npSmokeSensorN=npSmokeSensorN, npThermoTrapStatus=npThermoTrapStatus, npSmokeMemo=npSmokeMemo, npCurLoopR=npCurLoopR, npIoTrapLevelLegend=npIoTrapLevelLegend, FixedPoint1000=FixedPoint1000, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoStatus=npThermoStatus)
