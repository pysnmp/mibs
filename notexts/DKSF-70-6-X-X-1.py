...
# Produced by pysmi-1.1.8 at Wed Jun 29 13:12:51 2022
...
NotificationType, ModuleIdentity, MibIdentifier, TimeTicks, ObjectIdentity, Unsigned32, Counter32, Gauge32, iso, Counter64, IpAddress, Bits, enterprises, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "MibIdentifier", "TimeTicks", "ObjectIdentity", "Unsigned32", "Counter32", "Gauge32", "iso", "Counter64", "IpAddress", "Bits", "enterprises", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopV=npCurLoopV, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmRegistration=npGsmRegistration, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIr=npIr, npIrCtrl=npIrCtrl, npSoftReboot=npSoftReboot, npThermoSensorN=npThermoSensorN, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapV=npCurLoopTrapV, npRelHumidity=npRelHumidity, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopPower=npCurLoopPower, npThermoTraps=npThermoTraps, npCurLoopStatus=npCurLoopStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTable=npRelHumTable, npReboot=npReboot, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTraps=npSmokeTraps, npCurLoopI=npCurLoopI, npGsmTrap=npGsmTrap, npSmokeReset=npSmokeReset, npRelHumTrapTempFail=npRelHumTrapTempFail, npTrapEmailTo=npTrapEmailTo, npRelHumN=npRelHumN, npGsmFailed=npGsmFailed, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTable=npIoTable, npRelayState=npRelayState, npIrPlayCmd=npIrPlayCmd, npCurLoopR=npCurLoopR, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrap=npThermoTrap, npRelHumTrapSafe=npRelHumTrapSafe, lightcom=lightcom, npSmokePower=npSmokePower, npIoTrapMemo=npIoTrapMemo, npRelHumTrap=npRelHumTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTable=npSmokeTable, npGsm=npGsm, npThermoValue=npThermoValue, npThermoStatus=npThermoStatus, npSmokeMemo=npSmokeMemo, FixedPoint1000=FixedPoint1000, npRelayMemo=npRelayMemo, npIoPulseCounter=npIoPulseCounter, npIoTrapPrefix=npIoTrapPrefix, npIoLevelOut=npIoLevelOut, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapMemo=npThermoTrapMemo, npThermo=npThermo, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumStatus=npRelHumStatus, npIo=npIo, npResetStack=npResetStack, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapPrefix=npThermoTrapPrefix, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayStartReset=npRelayStartReset, npRelHumTrapData=npRelHumTrapData, npThermoTrapStatus=npThermoTrapStatus, npIoTrap=npIoTrap, npCurLoopEntry=npCurLoopEntry, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoMemo=npIoMemo, npThermoEntry=npThermoEntry, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoop=npCurLoop, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoMemo=npThermoMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapI=npCurLoopTrapI, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumValue=npRelHumValue, npRelHumMemo=npRelHumMemo, npThermoTrapValue=npThermoTrapValue, npGsmTrapPrefix=npGsmTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrReset=npIrReset, npThermoTable=npThermoTable, npCurLoopTrap=npCurLoopTrap, npIoTraps=npIoTraps, npTrapInfo=npTrapInfo, npRelay=npRelay, npRelayTable=npRelayTable, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTable=npCurLoopTable, npThermoHigh=npThermoHigh, npSmoke=npSmoke, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapLow=npThermoTrapLow, npIrStatus=npIrStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoLineN=npIoLineN, npRelHumTempValue=npRelHumTempValue, npCurLoopN=npCurLoopN, npSmokeStatus=npSmokeStatus, npSmokeEntry=npSmokeEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTraps=npCurLoopTraps, npRelayEntry=npRelayEntry, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoValuePrecise=npThermoValuePrecise, npGsmStrength=npGsmStrength, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoEntry=npIoEntry, npIoTrapLineN=npIoTrapLineN, npThermoTrapHigh=npThermoTrapHigh, npGsmInfo=npGsmInfo, npIoLevelIn=npIoLevelIn, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoLow=npThermoLow, npRelayMode=npRelayMode, npRelHumEntry=npRelHumEntry, npForcedReboot=npForcedReboot, npSmokeTrap=npSmokeTrap, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeSensorN=npSmokeSensorN, npGsmTraps=npGsmTraps, npCurLoopTrapPower=npCurLoopTrapPower, npRelayN=npRelayN)
