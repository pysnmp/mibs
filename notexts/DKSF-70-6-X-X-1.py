...
Counter64, iso, Integer32, Gauge32, NotificationType, Unsigned32, Counter32, MibIdentifier, ModuleIdentity, IpAddress, enterprises, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "Integer32", "Gauge32", "NotificationType", "Unsigned32", "Counter32", "MibIdentifier", "ModuleIdentity", "IpAddress", "enterprises", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoStatus=npThermoStatus, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTraps=npThermoTraps, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrap=npCurLoopTrap, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeEntry=npSmokeEntry, npThermoTable=npThermoTable, npResetStack=npResetStack, npIrCtrl=npIrCtrl, npSmokeTable=npSmokeTable, npGsmRegistration=npGsmRegistration, lightcom=lightcom, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapSensorN=npThermoTrapSensorN, npIoTraps=npIoTraps, npThermoValue=npThermoValue, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoLevelIn=npIoLevelIn, npIoLevelOut=npIoLevelOut, npCurLoopStatus=npCurLoopStatus, npForcedReboot=npForcedReboot, npCurLoopEntry=npCurLoopEntry, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npTrapInfo=npTrapInfo, npThermoTrapMemo=npThermoTrapMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoMemo=npIoMemo, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, uniPingServerSolutionV3=uniPingServerSolutionV3, FixedPoint1000=FixedPoint1000, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayTable=npRelayTable, npThermoHigh=npThermoHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrap=npThermoTrap, npIoTrapLineN=npIoTrapLineN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTempValue=npRelHumTempValue, npIoTrap=npIoTrap, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapHigh=npThermoTrapHigh, npRelHumidity=npRelHumidity, npIr=npIr, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapR=npCurLoopTrapR, npSmokeMemo=npSmokeMemo, npSmokeTrap=npSmokeTrap, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopR=npCurLoopR, npThermoMemo=npThermoMemo, npTrapEmailTo=npTrapEmailTo, npRelHumTable=npRelHumTable, npRelHumTrap=npRelHumTrap, npCurLoopV=npCurLoopV, npCurLoopPower=npCurLoopPower, npGsmStrength=npGsmStrength, npSmokeReset=npSmokeReset, npCurLoopTable=npCurLoopTable, npIo=npIo, npCurLoopTrapPower=npCurLoopTrapPower, npGsmTraps=npGsmTraps, npCurLoopN=npCurLoopN, npRelHumTrapTempFail=npRelHumTrapTempFail, npIrStatus=npIrStatus, npIoPulseCounter=npIoPulseCounter, npRelHumStatus=npRelHumStatus, npThermoTrapStatus=npThermoTrapStatus, npThermo=npThermo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTable=npIoTable, npThermoLow=npThermoLow, npSmoke=npSmoke, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoEntry=npThermoEntry, npIoLineN=npIoLineN, npIoTrapMemo=npIoTrapMemo, npRelayStartReset=npRelayStartReset, npGsm=npGsm, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayN=npRelayN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayMemo=npRelayMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapN=npCurLoopTrapN, npSoftReboot=npSoftReboot, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapValue=npThermoTrapValue, npReboot=npReboot, npSmokePower=npSmokePower, npGsmInfo=npGsmInfo, npRelHumValue=npRelHumValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayState=npRelayState, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeStatus=npSmokeStatus, npRelayMode=npRelayMode, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoEntry=npIoEntry, npSmokeSensorN=npSmokeSensorN, npSmokeTrapMemo=npSmokeTrapMemo, npThermoSensorN=npThermoSensorN, npRelHumEntry=npRelHumEntry, npGsmFailed=npGsmFailed, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoop=npCurLoop, npCurLoopTraps=npCurLoopTraps, npRelay=npRelay, npThermoTrapLow=npThermoTrapLow, npRelHumMemo=npRelHumMemo, npGsmTrap=npGsmTrap, npRelHumN=npRelHumN, npCurLoopI=npCurLoopI, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayEntry=npRelayEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIrReset=npIrReset, npSmokeTraps=npSmokeTraps)
