...
# Produced by pysmi-1.1.8 at Tue Jul 26 15:47:07 2022
...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Gauge32, Integer32, TimeTicks, Unsigned32, NotificationType, iso, Counter64, Bits, MibIdentifier, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Gauge32", "Integer32", "TimeTicks", "Unsigned32", "NotificationType", "iso", "Counter64", "Bits", "MibIdentifier", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokePower=npSmokePower, npThermoLow=npThermoLow, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTable=npRelHumTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapI=npCurLoopTrapI, npThermoHigh=npThermoHigh, npCurLoopTraps=npCurLoopTraps, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapPrefix=npThermoTrapPrefix, npIr=npIr, npIoLevelIn=npIoLevelIn, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npReboot=npReboot, npThermoStatus=npThermoStatus, npIoMemo=npIoMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapMemo=npIoTrapMemo, npRelayEntry=npRelayEntry, npRelayStartReset=npRelayStartReset, npThermoEntry=npThermoEntry, npRelHumEntry=npRelHumEntry, npRelHumTempStatus=npRelHumTempStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrap=npThermoTrap, npCurLoopTrap=npCurLoopTrap, npSmokeTable=npSmokeTable, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermo=npThermo, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumidity=npRelHumidity, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopStatus=npCurLoopStatus, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeSensorN=npSmokeSensorN, npThermoValue=npThermoValue, npIrStatus=npIrStatus, npSoftReboot=npSoftReboot, npGsmTrap=npGsmTrap, npThermoValuePrecise=npThermoValuePrecise, npIrCtrl=npIrCtrl, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapLow=npThermoTrapLow, npSmokeTraps=npSmokeTraps, npRelayMode=npRelayMode, npCurLoopEntry=npCurLoopEntry, npIoSinglePulseStart=npIoSinglePulseStart, npIrPlayCmd=npIrPlayCmd, lightcom=lightcom, npRelHumTrap=npRelHumTrap, npRelHumValue=npRelHumValue, npGsmInfo=npGsmInfo, npSmokeReset=npSmokeReset, npForcedReboot=npForcedReboot, npSmokeMemo=npSmokeMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataN=npRelHumTrapDataN, npRelay=npRelay, npResetStack=npResetStack, npTrapEmailTo=npTrapEmailTo, npCurLoop=npCurLoop, npSmoke=npSmoke, npRelHumStatus=npRelHumStatus, npRelayState=npRelayState, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTable=npIoTable, npCurLoopTrapR=npCurLoopTrapR, npSmokeStatus=npSmokeStatus, npThermoTable=npThermoTable, npCurLoopN=npCurLoopN, FixedPoint1000=FixedPoint1000, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapMemo=npThermoTrapMemo, npIo=npIo, npIoTrapLineN=npIoTrapLineN, npCurLoopPower=npCurLoopPower, npIoEntry=npIoEntry, npRelayTable=npRelayTable, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumMemo=npRelHumMemo, npGsm=npGsm, npIoLevelOut=npIoLevelOut, npCurLoopV=npCurLoopV, npTrapInfo=npTrapInfo, npRelHumTempValue=npRelHumTempValue, npSmokeEntry=npSmokeEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmTraps=npGsmTraps, npThermoMemo=npThermoMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumN=npRelHumN, npGsmFailed=npGsmFailed, npIoTrap=npIoTrap, npCurLoopR=npCurLoopR, npThermoTraps=npThermoTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIrReset=npIrReset, npRelayMemo=npRelayMemo, npCurLoopI=npCurLoopI, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumSafeRangeLow=npRelHumSafeRangeLow, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmRegistration=npGsmRegistration, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayN=npRelayN, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrapPrefix=npIoTrapPrefix, npThermoSensorN=npThermoSensorN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmStrength=npGsmStrength, npIoTraps=npIoTraps, npSmokeTrap=npSmokeTrap, npIoPulseCounter=npIoPulseCounter, npCurLoopTable=npCurLoopTable, npIoLineN=npIoLineN, npRelHumTrapData=npRelHumTrapData, npGsmTrapPrefix=npGsmTrapPrefix)
