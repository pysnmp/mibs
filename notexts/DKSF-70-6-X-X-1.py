...
# Produced by pysmi-1.1.3 at Sun Nov 28 16:36:43 2021
...
Bits, Gauge32, iso, IpAddress, TimeTicks, MibIdentifier, enterprises, Counter32, NotificationType, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "iso", "IpAddress", "TimeTicks", "MibIdentifier", "enterprises", "Counter32", "NotificationType", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapMemo=npThermoTrapMemo, npThermoTrap=npThermoTrap, npIoPulseCounter=npIoPulseCounter, npSmoke=npSmoke, FixedPoint1000=FixedPoint1000, npRelHumTrapTemp=npRelHumTrapTemp, npGsmInfo=npGsmInfo, npCurLoopV=npCurLoopV, npRelHumValue=npRelHumValue, npRelHumN=npRelHumN, npSmokeStatus=npSmokeStatus, npSmokeTrap=npSmokeTrap, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmRegistration=npGsmRegistration, npRelHumTrap=npRelHumTrap, npIrReset=npIrReset, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTable=npIoTable, npCurLoopI=npCurLoopI, npCurLoopN=npCurLoopN, npIoMemo=npIoMemo, npRelayMemo=npRelayMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeEntry=npSmokeEntry, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeReset=npSmokeReset, npIo=npIo, npResetStack=npResetStack, npIrStatus=npIrStatus, npIoTraps=npIoTraps, lightcom=lightcom, npSoftReboot=npSoftReboot, npIoLevelIn=npIoLevelIn, npIrCtrl=npIrCtrl, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoValue=npThermoValue, npIoTrapPrefix=npIoTrapPrefix, npIoTrapMemo=npIoTrapMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTrapR=npCurLoopTrapR, npIoTrapLineN=npIoTrapLineN, npCurLoop=npCurLoop, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npReboot=npReboot, npSmokeTraps=npSmokeTraps, npRelHumTrapData=npRelHumTrapData, npSmokeTable=npSmokeTable, npForcedReboot=npForcedReboot, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapN=npCurLoopTrapN, npRelayEntry=npRelayEntry, npSmokePower=npSmokePower, npRelayTable=npRelayTable, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrap=npCurLoopTrap, npRelHumTable=npRelHumTable, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTraps=npThermoTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoStatus=npThermoStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapFail=npRelHumTrapFail, npCurLoopPower=npCurLoopPower, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoSensorN=npThermoSensorN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmStrength=npGsmStrength, npRelayN=npRelayN, npThermoTrapStatus=npThermoTrapStatus, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapHigh=npThermoTrapHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumidity=npRelHumidity, npThermo=npThermo, npGsmTraps=npGsmTraps, npCurLoopTrapV=npCurLoopTrapV, npIoTrap=npIoTrap, npCurLoopTable=npCurLoopTable, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapPower=npCurLoopTrapPower, npThermoMemo=npThermoMemo, npRelHumEntry=npRelHumEntry, npRelayState=npRelayState, npThermoEntry=npThermoEntry, npGsm=npGsm, npCurLoopTraps=npCurLoopTraps, npTrapInfo=npTrapInfo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTable=npThermoTable, npThermoLow=npThermoLow, npRelHumTempValue=npRelHumTempValue, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTempStatus=npRelHumTempStatus, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumStatus=npRelHumStatus, npIoEntry=npIoEntry, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeSensorN=npSmokeSensorN, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmFailed=npGsmFailed, npIr=npIr, npIrPlayCmd=npIrPlayCmd, npGsmTrap=npGsmTrap, npCurLoopEntry=npCurLoopEntry, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapValue=npThermoTrapValue, npTrapEmailTo=npTrapEmailTo, npSmokeMemo=npSmokeMemo, npRelayMode=npRelayMode, npIoLineN=npIoLineN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumMemo=npRelHumMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopR=npCurLoopR, npRelayStartReset=npRelayStartReset, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoHigh=npThermoHigh, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopStatus=npCurLoopStatus, npIoLevelOut=npIoLevelOut, npThermoTrapLow=npThermoTrapLow, npRelay=npRelay)
