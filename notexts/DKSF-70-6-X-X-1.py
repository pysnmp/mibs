...
# Produced by pysmi-1.1.12 at Mon Jun  3 03:06:55 2024
...
ObjectIdentity, Gauge32, enterprises, NotificationType, Integer32, ModuleIdentity, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, TimeTicks, IpAddress, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "enterprises", "NotificationType", "Integer32", "ModuleIdentity", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "TimeTicks", "IpAddress", "Counter32", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoHigh=npThermoHigh, npCurLoop=npCurLoop, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npResetStack=npResetStack, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopV=npCurLoopV, npCurLoopTrap=npCurLoopTrap, npTrapInfo=npTrapInfo, npRelayEntry=npRelayEntry, npGsmFailed=npGsmFailed, npThermoMemo=npThermoMemo, npSmokeStatus=npSmokeStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayMode=npRelayMode, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTraps=npIoTraps, npSmokePower=npSmokePower, npGsmTraps=npGsmTraps, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumStatus=npRelHumStatus, npIoTrap=npIoTrap, npRelHumTrap=npRelHumTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrap=npThermoTrap, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTraps=npThermoTraps, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTemp=npRelHumTrapTemp, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTrap=npSmokeTrap, npSmokeTraps=npSmokeTraps, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayState=npRelayState, npSmokeSensorN=npSmokeSensorN, npRelayN=npRelayN, npThermoValue=npThermoValue, npThermo=npThermo, npForcedReboot=npForcedReboot, npGsmTrap=npGsmTrap, npCurLoopEntry=npCurLoopEntry, npCurLoopPower=npCurLoopPower, npIoLevelIn=npIoLevelIn, npThermoEntry=npThermoEntry, npIrReset=npIrReset, npTrapEmailTo=npTrapEmailTo, npSmoke=npSmoke, npIoLineN=npIoLineN, npIoTrapLineN=npIoTrapLineN, npCurLoopTrapStatus=npCurLoopTrapStatus, npReboot=npReboot, npThermoTrapMemo=npThermoTrapMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npIrPlayCmd=npIrPlayCmd, npThermoTrapLow=npThermoTrapLow, npGsmInfo=npGsmInfo, npIrStatus=npIrStatus, npSmokeEntry=npSmokeEntry, npThermoSensorN=npThermoSensorN, FixedPoint1000=FixedPoint1000, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTrapStatus=npSmokeTrapStatus, npRelayStartReset=npRelayStartReset, npSoftReboot=npSoftReboot, npIo=npIo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTable=npIoTable, npThermoStatus=npThermoStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapFail=npRelHumTrapFail, npRelHumTempStatus=npRelHumTempStatus, npGsm=npGsm, uniPingServerSolutionV3=uniPingServerSolutionV3, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapI=npCurLoopTrapI, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopR=npCurLoopR, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopStatus=npCurLoopStatus, npRelHumidity=npRelHumidity, npSmokeReset=npSmokeReset, npCurLoopI=npCurLoopI, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumN=npRelHumN, npCurLoopN=npCurLoopN, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTable=npRelHumTable, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayMemo=npRelayMemo, npSmokeTable=npSmokeTable, npThermoLow=npThermoLow, npIoPulseCounter=npIoPulseCounter, npCurLoopTrapR=npCurLoopTrapR, npThermoValuePrecise=npThermoValuePrecise, npIoLevelOut=npIoLevelOut, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTraps=npCurLoopTraps, npRelay=npRelay, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapData=npRelHumTrapData, npThermoTable=npThermoTable, npIoMemo=npIoMemo, npRelHumEntry=npRelHumEntry, npGsmTrapPrefix=npGsmTrapPrefix, npIrCtrl=npIrCtrl, npSmokeMemo=npSmokeMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTable=npCurLoopTable, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapMemo=npIoTrapMemo, npGsmRegistration=npGsmRegistration, lightcom=lightcom, npIoEntry=npIoEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmStrength=npGsmStrength, npIr=npIr, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapValue=npThermoTrapValue, npRelHumMemo=npRelHumMemo, npRelayTable=npRelayTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumValue=npRelHumValue)
