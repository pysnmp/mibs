...
# Produced by pysmi-1.1.12 at Wed Jul  3 09:40:10 2024
...
ObjectIdentity, ModuleIdentity, Gauge32, Integer32, iso, enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, MibIdentifier, Counter64, Counter32, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "Gauge32", "Integer32", "iso", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "MibIdentifier", "Counter64", "Counter32", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrapMemo=npIoTrapMemo, npCurLoopTrap=npCurLoopTrap, npSmokeTraps=npSmokeTraps, npThermoLow=npThermoLow, npRelHumTrapDataN=npRelHumTrapDataN, npThermoValuePrecise=npThermoValuePrecise, npIoEntry=npIoEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeEntry=npSmokeEntry, npSmokePower=npSmokePower, npIoTrap=npIoTrap, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopR=npCurLoopR, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapValue=npThermoTrapValue, npThermoStatus=npThermoStatus, npSmokeTrap=npSmokeTrap, npGsmInfo=npGsmInfo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopI=npCurLoopI, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayMode=npRelayMode, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapV=npCurLoopTrapV, npThermo=npThermo, npSmokeTrapSensorN=npSmokeTrapSensorN, npIrCtrl=npIrCtrl, npCurLoopV=npCurLoopV, npRelayState=npRelayState, npThermoEntry=npThermoEntry, npCurLoopTrapN=npCurLoopTrapN, npRelHumStatus=npRelHumStatus, npRelHumidity=npRelHumidity, npRelHumTrapTemp=npRelHumTrapTemp, npIoLevelOut=npIoLevelOut, npIoTrapPrefix=npIoTrapPrefix, npSmoke=npSmoke, npSoftReboot=npSoftReboot, npCurLoop=npCurLoop, npCurLoopTrapR=npCurLoopTrapR, npSmokeTable=npSmokeTable, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapStatus=npThermoTrapStatus, npRelayN=npRelayN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeStatus=npSmokeStatus, npRelayTable=npRelayTable, npThermoSensorN=npThermoSensorN, npCurLoopTraps=npCurLoopTraps, npGsmTraps=npGsmTraps, npIoTrapLevelIn=npIoTrapLevelIn, npIrPlayCmd=npIrPlayCmd, npRelHumMemo=npRelHumMemo, npRelHumN=npRelHumN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, FixedPoint1000=FixedPoint1000, npCurLoopPower=npCurLoopPower, npGsmStrength=npGsmStrength, npReboot=npReboot, npRelHumEntry=npRelHumEntry, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelay=npRelay, npRelHumValue=npRelHumValue, npForcedReboot=npForcedReboot, npThermoHigh=npThermoHigh, npCurLoopEntry=npCurLoopEntry, npIoLevelIn=npIoLevelIn, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTable=npThermoTable, npSmokeTrapMemo=npSmokeTrapMemo, npIoTraps=npIoTraps, npRelHumTrap=npRelHumTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeReset=npSmokeReset, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrap=npThermoTrap, npCurLoopTable=npCurLoopTable, lightcom=lightcom, npThermoMemo=npThermoMemo, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapLow=npThermoTrapLow, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmRegistration=npGsmRegistration, npIoTrapLineN=npIoTrapLineN, npIo=npIo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIr=npIr, npRelHumTempStatus=npRelHumTempStatus, npRelayEntry=npRelayEntry, npGsm=npGsm, npRelHumTable=npRelHumTable, npTrapEmailTo=npTrapEmailTo, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoSinglePulseDuration=npIoSinglePulseDuration, npIrStatus=npIrStatus, npGsmFailed=npGsmFailed, npRelayMemo=npRelayMemo, npSmokeMemo=npSmokeMemo, npCurLoopN=npCurLoopN, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npResetStack=npResetStack, npThermoValue=npThermoValue, npRelayStartReset=npRelayStartReset, npIoMemo=npIoMemo, npCurLoopStatus=npCurLoopStatus, npTrapInfo=npTrapInfo, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapFail=npRelHumTrapFail, npSmokeSensorN=npSmokeSensorN, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTempValue=npRelHumTempValue, npThermoTrapHigh=npThermoTrapHigh, npIoTable=npIoTable, npThermoTraps=npThermoTraps, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmTrap=npGsmTrap, npIrReset=npIrReset, npIoLineN=npIoLineN)
