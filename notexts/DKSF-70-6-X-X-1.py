...
Counter64, NotificationType, IpAddress, Bits, TimeTicks, enterprises, Integer32, Gauge32, MibIdentifier, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "IpAddress", "Bits", "TimeTicks", "enterprises", "Integer32", "Gauge32", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayEntry=npRelayEntry, npResetStack=npResetStack, npRelayMode=npRelayMode, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmRegistration=npGsmRegistration, npThermoLow=npThermoLow, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrap=npCurLoopTrap, npSmokeTraps=npSmokeTraps, npGsmInfo=npGsmInfo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapData=npRelHumTrapData, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmTrap=npGsmTrap, npThermoMemo=npThermoMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapHigh=npThermoTrapHigh, npIrCtrl=npIrCtrl, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopPower=npCurLoopPower, npIoTrapMemo=npIoTrapMemo, npCurLoopStatus=npCurLoopStatus, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumValue=npRelHumValue, npRelHumMemo=npRelHumMemo, npSmokeEntry=npSmokeEntry, npRelayStartReset=npRelayStartReset, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumidity=npRelHumidity, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTable=npSmokeTable, npRelHumEntry=npRelHumEntry, uniPingServerSolutionV3=uniPingServerSolutionV3, npTrapEmailTo=npTrapEmailTo, npRelayN=npRelayN, npThermo=npThermo, npCurLoopR=npCurLoopR, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoValuePrecise=npThermoValuePrecise, FixedPoint1000=FixedPoint1000, npThermoTrap=npThermoTrap, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeMemo=npSmokeMemo, npCurLoopTrapI=npCurLoopTrapI, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapSensorN=npThermoTrapSensorN, npSoftReboot=npSoftReboot, npIoTable=npIoTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTable=npCurLoopTable, npForcedReboot=npForcedReboot, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmStrength=npGsmStrength, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoPulseCounter=npIoPulseCounter, npRelayMemo=npRelayMemo, npCurLoopTrapR=npCurLoopTrapR, npRelHumStatus=npRelHumStatus, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumN=npRelHumN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoValue=npThermoValue, npRelayState=npRelayState, npSmokePower=npSmokePower, npThermoHigh=npThermoHigh, npSmoke=npSmoke, npCurLoopN=npCurLoopN, npThermoEntry=npThermoEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoop=npCurLoop, npThermoTrapMemo=npThermoTrapMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapFail=npRelHumTrapFail, npIoTrapPrefix=npIoTrapPrefix, npIoTrap=npIoTrap, npRelayTable=npRelayTable, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoLevelOut=npIoLevelOut, npIoTraps=npIoTraps, npIoLineN=npIoLineN, npRelay=npRelay, npCurLoopEntry=npCurLoopEntry, npThermoTraps=npThermoTraps, npSmokeSensorN=npSmokeSensorN, npSmokeTrapStatus=npSmokeTrapStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTraps=npCurLoopTraps, npThermoSensorN=npThermoSensorN, npThermoTable=npThermoTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoMemo=npIoMemo, npIr=npIr, npIo=npIo, npTrapInfo=npTrapInfo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIrStatus=npIrStatus, npIoLevelIn=npIoLevelIn, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapPower=npCurLoopTrapPower, npGsmFailed=npGsmFailed, npCurLoopTrapV=npCurLoopTrapV, npSmokeStatus=npSmokeStatus, npSmokeTrap=npSmokeTrap, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopI=npCurLoopI, lightcom=lightcom, npIoEntry=npIoEntry, npGsm=npGsm, npThermoStatus=npThermoStatus, npRelHumTempValue=npRelHumTempValue, npRelHumTrap=npRelHumTrap, npCurLoopV=npCurLoopV, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTable=npRelHumTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmTrapPrefix=npGsmTrapPrefix, npReboot=npReboot, npGsmTraps=npGsmTraps, npSmokeReset=npSmokeReset, npIrReset=npIrReset, npThermoTrapValue=npThermoTrapValue)
