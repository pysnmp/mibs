...
NotificationType, Integer32, Gauge32, ModuleIdentity, enterprises, Counter64, Unsigned32, IpAddress, MibIdentifier, iso, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "Gauge32", "ModuleIdentity", "enterprises", "Counter64", "Unsigned32", "IpAddress", "MibIdentifier", "iso", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTrapN=npCurLoopTrapN, npIo=npIo, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTrap=npSmokeTrap, npGsmFailed=npGsmFailed, npCurLoopPower=npCurLoopPower, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeSensorN=npSmokeSensorN, npIoTraps=npIoTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoLevelOut=npIoLevelOut, npThermoTable=npThermoTable, npSmokeStatus=npSmokeStatus, npRelHumStatus=npRelHumStatus, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTable=npCurLoopTable, npThermoEntry=npThermoEntry, npRelHumTrap=npRelHumTrap, npIr=npIr, FixedPoint1000=FixedPoint1000, npGsmSendSmsUtf8=npGsmSendSmsUtf8, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayEntry=npRelayEntry, npGsmRegistration=npGsmRegistration, npSmokeTrapStatus=npSmokeTrapStatus, npResetStack=npResetStack, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumEntry=npRelHumEntry, npIoTrap=npIoTrap, npIrPlayCmd=npIrPlayCmd, npIoTrapLineN=npIoTrapLineN, npTrapInfo=npTrapInfo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTempValue=npRelHumTempValue, npCurLoopN=npCurLoopN, npRelay=npRelay, npIrCtrl=npIrCtrl, npRelayN=npRelayN, npRelHumMemo=npRelHumMemo, npTrapEmailTo=npTrapEmailTo, npThermoStatus=npThermoStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapPower=npCurLoopTrapPower, npGsmInfo=npGsmInfo, npIrStatus=npIrStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapStatus=npThermoTrapStatus, npGsm=npGsm, npSoftReboot=npSoftReboot, npIoTable=npIoTable, npThermoSensorN=npThermoSensorN, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapDataN=npRelHumTrapDataN, npRelayTable=npRelayTable, npCurLoopR=npCurLoopR, npCurLoopStatus=npCurLoopStatus, npSmokePower=npSmokePower, lightcom=lightcom, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrap=npThermoTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumidity=npRelHumidity, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoMemo=npThermoMemo, npThermoTrapMemo=npThermoTrapMemo, npRelayMemo=npRelayMemo, npSmokeEntry=npSmokeEntry, npRelHumTrapTemp=npRelHumTrapTemp, npRelayStartReset=npRelayStartReset, npThermoTrapHigh=npThermoTrapHigh, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapI=npCurLoopTrapI, npCurLoop=npCurLoop, npThermoTrapLow=npThermoTrapLow, npIoEntry=npIoEntry, npCurLoopEntry=npCurLoopEntry, npReboot=npReboot, npRelayState=npRelayState, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoLineN=npIoLineN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapSensorN=npThermoTrapSensorN, npRelayMode=npRelayMode, npThermo=npThermo, npSmokeMemo=npSmokeMemo, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmTraps=npGsmTraps, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTraps=npThermoTraps, npIoMemo=npIoMemo, npForcedReboot=npForcedReboot, npSmokeReset=npSmokeReset, npCurLoopV=npCurLoopV, npThermoTrapValue=npThermoTrapValue, npGsmStrength=npGsmStrength, npThermoValuePrecise=npThermoValuePrecise, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmTrap=npGsmTrap, npIoLevelIn=npIoLevelIn, npThermoLow=npThermoLow, npRelHumTempStatus=npRelHumTempStatus, npCurLoopI=npCurLoopI, npIoPulseCounter=npIoPulseCounter, npIrReset=npIrReset, npThermoHigh=npThermoHigh, npRelHumTrapData=npRelHumTrapData, npSmokeTraps=npSmokeTraps, npThermoValue=npThermoValue, npRelHumTable=npRelHumTable, npSmoke=npSmoke, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumValue=npRelHumValue, npRelHumTrapFail=npRelHumTrapFail, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTable=npSmokeTable, npRelHumN=npRelHumN)
