...
# Produced by pysmi-1.1.11 at Wed Dec  6 03:04:40 2023
...
enterprises, Bits, Counter64, Integer32, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, iso, IpAddress, Gauge32, Counter32, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "Counter64", "Integer32", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "iso", "IpAddress", "Gauge32", "Counter32", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoLineN=npIoLineN, npSmokeEntry=npSmokeEntry, npRelayMemo=npRelayMemo, npRelHumN=npRelHumN, npRelHumTrapData=npRelHumTrapData, npForcedReboot=npForcedReboot, npGsmRegistration=npGsmRegistration, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTable=npCurLoopTable, npIoTraps=npIoTraps, npThermoTrapMemo=npThermoTrapMemo, npRelHumidity=npRelHumidity, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrap=npCurLoopTrap, npIo=npIo, npThermoTable=npThermoTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, lightcom=lightcom, npIoMemo=npIoMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrap=npThermoTrap, npSmokeTraps=npSmokeTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npTrapEmailTo=npTrapEmailTo, npThermo=npThermo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayTable=npRelayTable, npThermoValue=npThermoValue, npCurLoopV=npCurLoopV, npCurLoopPower=npCurLoopPower, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoEntry=npThermoEntry, npRelHumValue=npRelHumValue, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmStrength=npGsmStrength, npThermoTrapValue=npThermoTrapValue, npRelayN=npRelayN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoop=npCurLoop, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopN=npCurLoopN, npRelay=npRelay, npGsmTraps=npGsmTraps, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeMemo=npSmokeMemo, npResetStack=npResetStack, npSmokeTrapStatus=npSmokeTrapStatus, npIrCtrl=npIrCtrl, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapDataStatus=npRelHumTrapDataStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataN=npRelHumTrapDataN, npThermoHigh=npThermoHigh, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTrapPrefix=npIoTrapPrefix, npCurLoopStatus=npCurLoopStatus, npRelHumStatus=npRelHumStatus, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeSensorN=npSmokeSensorN, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeReset=npSmokeReset, npIoTrapLevelLegend=npIoTrapLevelLegend, npTrapInfo=npTrapInfo, npRelHumTable=npRelHumTable, npIr=npIr, npThermoTrapLow=npThermoTrapLow, npIoLevelIn=npIoLevelIn, npThermoSensorN=npThermoSensorN, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmInfo=npGsmInfo, npThermoTraps=npThermoTraps, npSoftReboot=npSoftReboot, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopI=npCurLoopI, npIrPlayCmd=npIrPlayCmd, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoLevelOut=npIoLevelOut, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoMemo=npThermoMemo, npSmokePower=npSmokePower, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrapLevelIn=npIoTrapLevelIn, npGsmFailed=npGsmFailed, npIrStatus=npIrStatus, npReboot=npReboot, npRelayState=npRelayState, npCurLoopEntry=npCurLoopEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTempValue=npRelHumTempValue, npThermoValuePrecise=npThermoValuePrecise, npSmoke=npSmoke, npGsm=npGsm, npRelayEntry=npRelayEntry, npIoTrapLineN=npIoTrapLineN, npGsmTrap=npGsmTrap, npThermoLow=npThermoLow, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTrapMemo=npIoTrapMemo, npRelHumEntry=npRelHumEntry, npIoSinglePulseDuration=npIoSinglePulseDuration, npIrReset=npIrReset, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrap=npSmokeTrap, npRelayMode=npRelayMode, npIoEntry=npIoEntry, npCurLoopR=npCurLoopR, npRelHumMemo=npRelHumMemo, npSmokeStatus=npSmokeStatus, npIoPulseCounter=npIoPulseCounter, npRelayStartReset=npRelayStartReset, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTable=npIoTable, npThermoTrapHigh=npThermoTrapHigh, npSmokeTable=npSmokeTable, npRelHumTrap=npRelHumTrap, npThermoStatus=npThermoStatus, FixedPoint1000=FixedPoint1000, npGsmSendSmsWin1251=npGsmSendSmsWin1251, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapN=npCurLoopTrapN, npIoTrap=npIoTrap)
