...
# Produced by pysmi-1.1.3 at Wed Dec  8 21:24:05 2021
...
Gauge32, ModuleIdentity, Bits, Unsigned32, Integer32, IpAddress, iso, Counter64, TimeTicks, ObjectIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "Bits", "Unsigned32", "Integer32", "IpAddress", "iso", "Counter64", "TimeTicks", "ObjectIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeEntry=npSmokeEntry, npThermoStatus=npThermoStatus, npCurLoopEntry=npCurLoopEntry, npThermoSensorN=npThermoSensorN, npRelHumN=npRelHumN, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapV=npCurLoopTrapV, npIo=npIo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmStrength=npGsmStrength, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmTraps=npGsmTraps, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSoftReboot=npSoftReboot, npCurLoopTrapI=npCurLoopTrapI, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapR=npCurLoopTrapR, npThermoTrap=npThermoTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIrPlayCmd=npIrPlayCmd, npGsmInfo=npGsmInfo, npCurLoopR=npCurLoopR, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapPower=npCurLoopTrapPower, npGsmFailed=npGsmFailed, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTable=npRelHumTable, npRelHumTempStatus=npRelHumTempStatus, npSmokeStatus=npSmokeStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapHigh=npThermoTrapHigh, npSmokeMemo=npSmokeMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npForcedReboot=npForcedReboot, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempFail=npRelHumTrapTempFail, npResetStack=npResetStack, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayN=npRelayN, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayState=npRelayState, npThermoTrapMemo=npThermoTrapMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayMode=npRelayMode, npThermo=npThermo, npIoTraps=npIoTraps, npRelHumEntry=npRelHumEntry, npThermoTrapStatus=npThermoTrapStatus, lightcom=lightcom, npIoTrapLevelIn=npIoTrapLevelIn, npGsmTrap=npGsmTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayStartReset=npRelayStartReset, npGsmTrapPrefix=npGsmTrapPrefix, npReboot=npReboot, npThermoTraps=npThermoTraps, npCurLoopTraps=npCurLoopTraps, npThermoValue=npThermoValue, npSmokeReset=npSmokeReset, npCurLoopStatus=npCurLoopStatus, npIoTable=npIoTable, npTrapInfo=npTrapInfo, npRelHumidity=npRelHumidity, npThermoMemo=npThermoMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopPower=npCurLoopPower, npCurLoopI=npCurLoopI, npIoMemo=npIoMemo, npCurLoopV=npCurLoopV, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrCtrl=npIrCtrl, npRelayEntry=npRelayEntry, npRelHumMemo=npRelHumMemo, npGsm=npGsm, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIrReset=npIrReset, npThermoHigh=npThermoHigh, npThermoTable=npThermoTable, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumValue=npRelHumValue, npRelHumTrap=npRelHumTrap, npThermoLow=npThermoLow, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapMemo=npIoTrapMemo, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapValue=npThermoTrapValue, npIoEntry=npIoEntry, npRelay=npRelay, npSmokeTrapMemo=npSmokeTrapMemo, npSmoke=npSmoke, npRelHumStatus=npRelHumStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokePower=npSmokePower, npCurLoopTrap=npCurLoopTrap, npIr=npIr, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTrap=npSmokeTrap, npGsmRegistration=npGsmRegistration, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopN=npCurLoopN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoLineN=npIoLineN, npThermoTrapLow=npThermoTrapLow, npSmokeSensorN=npSmokeSensorN, npCurLoop=npCurLoop, npIoLevelOut=npIoLevelOut, npRelHumTempValue=npRelHumTempValue, npSmokeTable=npSmokeTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrap=npIoTrap, npRelayTable=npRelayTable, npIoSinglePulseStart=npIoSinglePulseStart, npIoPulseCounter=npIoPulseCounter, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapDataN=npRelHumTrapDataN, npIrStatus=npIrStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayMemo=npRelayMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoLevelIn=npIoLevelIn, npCurLoopTable=npCurLoopTable, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapData=npRelHumTrapData, FixedPoint1000=FixedPoint1000, npThermoEntry=npThermoEntry, npIoTrapLineN=npIoTrapLineN, npSmokeTraps=npSmokeTraps)
