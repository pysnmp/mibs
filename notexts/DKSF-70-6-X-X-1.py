...
# Produced by pysmi-1.1.8 at Tue Sep 12 07:03:10 2023
...
Gauge32, Counter32, IpAddress, enterprises, MibIdentifier, Counter64, Unsigned32, iso, Bits, Integer32, NotificationType, ObjectIdentity, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "IpAddress", "enterprises", "MibIdentifier", "Counter64", "Unsigned32", "iso", "Bits", "Integer32", "NotificationType", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoEntry=npIoEntry, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSoftReboot=npSoftReboot, npIrCtrl=npIrCtrl, npIoLevelOut=npIoLevelOut, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapLineN=npIoTrapLineN, npSmokePower=npSmokePower, npForcedReboot=npForcedReboot, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTable=npRelHumTable, npRelayStartReset=npRelayStartReset, npCurLoopTrapR=npCurLoopTrapR, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelayTable=npRelayTable, npThermoTrapStatus=npThermoTrapStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmTraps=npGsmTraps, npGsmFailed=npGsmFailed, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoLevelIn=npIoLevelIn, npCurLoopTrapN=npCurLoopTrapN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeStatus=npSmokeStatus, npThermoEntry=npThermoEntry, npIoLineN=npIoLineN, npRelHumValue=npRelHumValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrPlayCmd=npIrPlayCmd, npIoTable=npIoTable, npRelHumEntry=npRelHumEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmRegistration=npGsmRegistration, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayN=npRelayN, npRelHumTrapFail=npRelHumTrapFail, npRelayMode=npRelayMode, npThermoTrapValue=npThermoTrapValue, npIoMemo=npIoMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsm=npGsm, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopStatus=npCurLoopStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoSensorN=npThermoSensorN, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrap=npRelHumTrap, npThermoLow=npThermoLow, npIoTraps=npIoTraps, npReboot=npReboot, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumidity=npRelHumidity, npResetStack=npResetStack, npCurLoopTrapPower=npCurLoopTrapPower, npRelayMemo=npRelayMemo, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTable=npSmokeTable, npSmokeMemo=npSmokeMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelay=npRelay, npRelHumTempValue=npRelHumTempValue, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapI=npCurLoopTrapI, npIoTrapPrefix=npIoTrapPrefix, npCurLoopN=npCurLoopN, npCurLoopR=npCurLoopR, npCurLoopPower=npCurLoopPower, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTraps=npCurLoopTraps, npIr=npIr, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeEntry=npSmokeEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeSensorN=npSmokeSensorN, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataN=npRelHumTrapDataN, lightcom=lightcom, npGsmStrength=npGsmStrength, npTrapEmailTo=npTrapEmailTo, npIoTrap=npIoTrap, npGsmInfo=npGsmInfo, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopV=npCurLoopV, npThermoStatus=npThermoStatus, npCurLoopTable=npCurLoopTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmoke=npSmoke, npThermoValue=npThermoValue, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoop=npCurLoop, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumN=npRelHumN, npRelayState=npRelayState, npSmokeTraps=npSmokeTraps, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTrapMemo=npSmokeTrapMemo, npThermoHigh=npThermoHigh, npGsmTrap=npGsmTrap, npRelayEntry=npRelayEntry, npIoPulseCounter=npIoPulseCounter, FixedPoint1000=FixedPoint1000, npIrStatus=npIrStatus, npThermoTable=npThermoTable, npThermoMemo=npThermoMemo, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapData=npRelHumTrapData, npThermoTraps=npThermoTraps, npThermo=npThermo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapMemo=npThermoTrapMemo, npSmokeReset=npSmokeReset, npSmokeTrap=npSmokeTrap, npRelHumMemo=npRelHumMemo, npThermoTrap=npThermoTrap, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapLow=npThermoTrapLow, npIo=npIo, npTrapInfo=npTrapInfo, npCurLoopI=npCurLoopI, npRelHumStatus=npRelHumStatus, npIrReset=npIrReset)
