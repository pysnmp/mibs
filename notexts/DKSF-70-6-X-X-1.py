...
NotificationType, enterprises, Bits, Integer32, iso, Counter64, ModuleIdentity, MibIdentifier, ObjectIdentity, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "enterprises", "Bits", "Integer32", "iso", "Counter64", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayStartReset=npRelayStartReset, npIoTable=npIoTable, npIo=npIo, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumStatus=npRelHumStatus, npIrPlayCmd=npIrPlayCmd, npThermoEntry=npThermoEntry, npCurLoopTrapN=npCurLoopTrapN, npCurLoopStatus=npCurLoopStatus, npThermoTrapValue=npThermoTrapValue, npRelayMemo=npRelayMemo, npCurLoopN=npCurLoopN, npSmokePower=npSmokePower, npForcedReboot=npForcedReboot, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayEntry=npRelayEntry, npRelHumEntry=npRelHumEntry, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoop=npCurLoop, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTable=npCurLoopTable, npCurLoopV=npCurLoopV, npCurLoopEntry=npCurLoopEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npResetStack=npResetStack, npSmokeEntry=npSmokeEntry, npIoTrap=npIoTrap, npRelHumTrapData=npRelHumTrapData, npRelayN=npRelayN, npRelHumTrapTemp=npRelHumTrapTemp, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTraps=npCurLoopTraps, npRelHumValue=npRelHumValue, npIoLineN=npIoLineN, npGsmTrapPrefix=npGsmTrapPrefix, npRelay=npRelay, npThermoMemo=npThermoMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapLow=npThermoTrapLow, npIoEntry=npIoEntry, npRelHumTrapDataN=npRelHumTrapDataN, npIr=npIr, npCurLoopTrap=npCurLoopTrap, npThermoValue=npThermoValue, FixedPoint1000=FixedPoint1000, npSmokeStatus=npSmokeStatus, npRelHumTempValue=npRelHumTempValue, npThermo=npThermo, npSmokeMemo=npSmokeMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeSensorN=npSmokeSensorN, npRelHumTable=npRelHumTable, npGsmTraps=npGsmTraps, npIoLevelIn=npIoLevelIn, npCurLoopPower=npCurLoopPower, npThermoLow=npThermoLow, npGsmInfo=npGsmInfo, npSmokeTraps=npSmokeTraps, npSmokeTrap=npSmokeTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapPower=npCurLoopTrapPower, npRelayMode=npRelayMode, npTrapInfo=npTrapInfo, npSmoke=npSmoke, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayTable=npRelayTable, npThermoStatus=npThermoStatus, npThermoTable=npThermoTable, npGsmFailed=npGsmFailed, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoPulseCounter=npIoPulseCounter, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmRegistration=npGsmRegistration, npIrCtrl=npIrCtrl, npGsm=npGsm, npIoTraps=npIoTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSoftReboot=npSoftReboot, npCurLoopTrapI=npCurLoopTrapI, npThermoTraps=npThermoTraps, npRelHumMemo=npRelHumMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopI=npCurLoopI, npIoLevelOut=npIoLevelOut, npIoTrapLineN=npIoTrapLineN, npIoSinglePulseStart=npIoSinglePulseStart, npIrReset=npIrReset, npThermoSensorN=npThermoSensorN, npThermoTrapSensorN=npThermoTrapSensorN, npIrStatus=npIrStatus, npThermoTrapPrefix=npThermoTrapPrefix, npTrapEmailTo=npTrapEmailTo, npIoTrapMemo=npIoTrapMemo, npThermoHigh=npThermoHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumidity=npRelHumidity, npRelHumTrap=npRelHumTrap, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npReboot=npReboot, lightcom=lightcom, npCurLoopTrapV=npCurLoopTrapV, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapHigh=npThermoTrapHigh, npSmokeTable=npSmokeTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmTrap=npGsmTrap, npRelayState=npRelayState, npRelHumTrapFail=npRelHumTrapFail, npGsmStrength=npGsmStrength, npCurLoopR=npCurLoopR, npIoMemo=npIoMemo, npThermoTrap=npThermoTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeReset=npSmokeReset, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumN=npRelHumN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh)
