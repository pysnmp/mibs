...
enterprises, MibIdentifier, TimeTicks, IpAddress, NotificationType, ModuleIdentity, Unsigned32, Counter32, Integer32, iso, Counter64, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibIdentifier", "TimeTicks", "IpAddress", "NotificationType", "ModuleIdentity", "Unsigned32", "Counter32", "Integer32", "iso", "Counter64", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoValuePrecise=npThermoValuePrecise, npThermo=npThermo, npIoTrap=npIoTrap, npRelHumTempValue=npRelHumTempValue, npForcedReboot=npForcedReboot, npThermoTraps=npThermoTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTable=npRelHumTable, npIrStatus=npIrStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoop=npCurLoop, npCurLoopR=npCurLoopR, npRelayTable=npRelayTable, npSmokeEntry=npSmokeEntry, npRelHumidity=npRelHumidity, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapI=npCurLoopTrapI, npIrPlayCmd=npIrPlayCmd, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, FixedPoint1000=FixedPoint1000, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTraps=npSmokeTraps, npGsmFailed=npGsmFailed, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapMemo=npThermoTrapMemo, npSmokePower=npSmokePower, npSmokeTable=npSmokeTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoLevelOut=npIoLevelOut, npRelHumTrapSafe=npRelHumTrapSafe, npIoMemo=npIoMemo, npRelHumTrapFail=npRelHumTrapFail, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTable=npThermoTable, npThermoMemo=npThermoMemo, npCurLoopI=npCurLoopI, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapMemo=npIoTrapMemo, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTraps=npCurLoopTraps, npIr=npIr, npSmokeReset=npSmokeReset, npRelayStartReset=npRelayStartReset, npRelHumTrapData=npRelHumTrapData, npSmokeTrapStatus=npSmokeTrapStatus, npRelayMode=npRelayMode, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrap=npRelHumTrap, npGsmRegistration=npGsmRegistration, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapN=npCurLoopTrapN, npThermoValue=npThermoValue, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoPulseCounter=npIoPulseCounter, npThermoSensorN=npThermoSensorN, npGsmTrap=npGsmTrap, npCurLoopTrapV=npCurLoopTrapV, npThermoLow=npThermoLow, npSmoke=npSmoke, npRelayN=npRelayN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmTraps=npGsmTraps, npCurLoopN=npCurLoopN, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTempStatus=npRelHumTempStatus, npIoTraps=npIoTraps, npIoTrapPrefix=npIoTrapPrefix, npRelayEntry=npRelayEntry, npRelHumStatus=npRelHumStatus, npIoLineN=npIoLineN, npGsm=npGsm, npRelHumMemo=npRelHumMemo, npIoTable=npIoTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTable=npCurLoopTable, npRelayState=npRelayState, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapLineN=npIoTrapLineN, npSmokeSensorN=npSmokeSensorN, npCurLoopStatus=npCurLoopStatus, npCurLoopPower=npCurLoopPower, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapR=npCurLoopTrapR, npRelHumEntry=npRelHumEntry, npIoEntry=npIoEntry, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrap=npThermoTrap, npSmokeTrap=npSmokeTrap, npIoLevelIn=npIoLevelIn, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumN=npRelHumN, npRelHumValue=npRelHumValue, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoHigh=npThermoHigh, npCurLoopTrap=npCurLoopTrap, npGsmStrength=npGsmStrength, npThermoStatus=npThermoStatus, npRelay=npRelay, npIrCtrl=npIrCtrl, npSoftReboot=npSoftReboot, npRelayMemo=npRelayMemo, npResetStack=npResetStack, npSmokeMemo=npSmokeMemo, npThermoTrapHigh=npThermoTrapHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npIo=npIo, lightcom=lightcom, npThermoTrapValue=npThermoTrapValue, npSmokeStatus=npSmokeStatus, npCurLoopV=npCurLoopV, npCurLoopTrapPower=npCurLoopTrapPower, npGsmInfo=npGsmInfo, npReboot=npReboot, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npIrReset=npIrReset, npCurLoopEntry=npCurLoopEntry, npTrapInfo=npTrapInfo, npThermoEntry=npThermoEntry)
