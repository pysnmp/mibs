...
# Produced by pysmi-1.1.12 at Tue Dec  3 09:45:42 2024
...
Integer32, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, MibIdentifier, TimeTicks, Unsigned32, Bits, IpAddress, NotificationType, enterprises, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "MibIdentifier", "TimeTicks", "Unsigned32", "Bits", "IpAddress", "NotificationType", "enterprises", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopI=npCurLoopI, npTrapInfo=npTrapInfo, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIrCtrl=npIrCtrl, npRelay=npRelay, npCurLoopTraps=npCurLoopTraps, npSmokeReset=npSmokeReset, npCurLoopTrapPower=npCurLoopTrapPower, npIrReset=npIrReset, npCurLoopStatus=npCurLoopStatus, npGsmTraps=npGsmTraps, npCurLoopTrapN=npCurLoopTrapN, npSmokeSensorN=npSmokeSensorN, npCurLoopTrapV=npCurLoopTrapV, npSmoke=npSmoke, npCurLoopV=npCurLoopV, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumidity=npRelHumidity, npIoTrapLineN=npIoTrapLineN, npIoMemo=npIoMemo, npThermoTable=npThermoTable, npCurLoop=npCurLoop, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoLow=npThermoLow, npIoTable=npIoTable, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npResetStack=npResetStack, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoSinglePulseStart=npIoSinglePulseStart, npForcedReboot=npForcedReboot, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayEntry=npRelayEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoLevelOut=npIoLevelOut, npGsmRegistration=npGsmRegistration, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermo=npThermo, npIoTrap=npIoTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeTraps=npSmokeTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumMemo=npRelHumMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTrapMemo=npSmokeTrapMemo, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayMode=npRelayMode, npSmokeMemo=npSmokeMemo, npRelHumTrap=npRelHumTrap, npCurLoopTrap=npCurLoopTrap, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapR=npCurLoopTrapR, npIoLevelIn=npIoLevelIn, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumStatus=npRelHumStatus, npRelHumTrapTemp=npRelHumTrapTemp, npRelayMemo=npRelayMemo, npThermoTrapLow=npThermoTrapLow, npRelHumTable=npRelHumTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumN=npRelHumN, npCurLoopTable=npCurLoopTable, npRelHumTrapSafe=npRelHumTrapSafe, FixedPoint1000=FixedPoint1000, npCurLoopN=npCurLoopN, npThermoValue=npThermoValue, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayStartReset=npRelayStartReset, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIo=npIo, npIoLineN=npIoLineN, npThermoTrapValue=npThermoTrapValue, npGsmTrapPrefix=npGsmTrapPrefix, npIoPulseCounter=npIoPulseCounter, npSoftReboot=npSoftReboot, lightcom=lightcom, npIrStatus=npIrStatus, npRelayState=npRelayState, npRelHumTrapFail=npRelHumTrapFail, npThermoSensorN=npThermoSensorN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoEntry=npThermoEntry, npIr=npIr, npGsmFailed=npGsmFailed, npRelayTable=npRelayTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTraps=npIoTraps, npIoEntry=npIoEntry, npRelayN=npRelayN, npThermoStatus=npThermoStatus, npSmokeEntry=npSmokeEntry, npThermoTrapPrefix=npThermoTrapPrefix, npGsmStrength=npGsmStrength, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapData=npRelHumTrapData, npCurLoopPower=npCurLoopPower, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoHigh=npThermoHigh, npRelHumTempStatus=npRelHumTempStatus, npGsmInfo=npGsmInfo, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrap=npThermoTrap, npThermoMemo=npThermoMemo, npTrapEmailTo=npTrapEmailTo, npThermoTrapStatus=npThermoTrapStatus, npIoTrapMemo=npIoTrapMemo, npRelHumValue=npRelHumValue, npGsm=npGsm, npGsmTrap=npGsmTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeStatus=npSmokeStatus, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumEntry=npRelHumEntry, npIoTrapPrefix=npIoTrapPrefix, npSmokePower=npSmokePower, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTraps=npThermoTraps, npCurLoopR=npCurLoopR, npReboot=npReboot, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTrap=npSmokeTrap, npSmokeTable=npSmokeTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix)
