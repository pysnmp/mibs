...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:06:04 2022
...
NotificationType, Gauge32, Counter32, enterprises, IpAddress, Unsigned32, Bits, ObjectIdentity, TimeTicks, ModuleIdentity, Counter64, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "Counter32", "enterprises", "IpAddress", "Unsigned32", "Bits", "ObjectIdentity", "TimeTicks", "ModuleIdentity", "Counter64", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTraps=npCurLoopTraps, npSmokeReset=npSmokeReset, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapI=npCurLoopTrapI, npRelHumMemo=npRelHumMemo, npGsmInfo=npGsmInfo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapData=npRelHumTrapData, npIoSinglePulseStart=npIoSinglePulseStart, npIr=npIr, npCurLoopTrap=npCurLoopTrap, npThermoTrapPrefix=npThermoTrapPrefix, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTrap=npSmokeTrap, npRelHumTempStatus=npRelHumTempStatus, npRelayMode=npRelayMode, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeEntry=npSmokeEntry, npThermoTraps=npThermoTraps, npThermoTable=npThermoTable, npCurLoopEntry=npCurLoopEntry, npRelay=npRelay, npIoPulseCounter=npIoPulseCounter, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoLevelIn=npIoLevelIn, npSmokeTable=npSmokeTable, npCurLoopR=npCurLoopR, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTable=npRelHumTable, npIoTrapLevelIn=npIoTrapLevelIn, npRelayTable=npRelayTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapV=npCurLoopTrapV, npTrapEmailTo=npTrapEmailTo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumidity=npRelHumidity, npThermoMemo=npThermoMemo, npResetStack=npResetStack, npIrReset=npIrReset, npRelHumTrap=npRelHumTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmTraps=npGsmTraps, npCurLoopPower=npCurLoopPower, npRelHumEntry=npRelHumEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrapR=npCurLoopTrapR, npIoTrapMemo=npIoTrapMemo, npGsmRegistration=npGsmRegistration, npRelayState=npRelayState, npIoMemo=npIoMemo, npRelHumTrapTemp=npRelHumTrapTemp, npTrapInfo=npTrapInfo, npGsm=npGsm, npIoEntry=npIoEntry, npGsmTrap=npGsmTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeStatus=npSmokeStatus, npRelayN=npRelayN, npCurLoop=npCurLoop, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapStatus=npCurLoopTrapStatus, npForcedReboot=npForcedReboot, npThermoTrapValue=npThermoTrapValue, npThermoHigh=npThermoHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeMemo=npSmokeMemo, npRelHumStatus=npRelHumStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoValuePrecise=npThermoValuePrecise, npGsmFailed=npGsmFailed, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapFail=npRelHumTrapFail, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapHigh=npThermoTrapHigh, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapN=npCurLoopTrapN, npSoftReboot=npSoftReboot, npIoTraps=npIoTraps, FixedPoint1000=FixedPoint1000, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmoke=npSmoke, npThermo=npThermo, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopN=npCurLoopN, npIrCtrl=npIrCtrl, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumN=npRelHumN, npThermoTrapLow=npThermoTrapLow, npCurLoopI=npCurLoopI, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumValue=npRelHumValue, npCurLoopTable=npCurLoopTable, npGsmStrength=npGsmStrength, npIrStatus=npIrStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayStartReset=npRelayStartReset, npIo=npIo, npThermoTrap=npThermoTrap, npThermoStatus=npThermoStatus, npThermoTrapStatus=npThermoTrapStatus, npThermoValue=npThermoValue, npCurLoopStatus=npCurLoopStatus, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapMemo=npThermoTrapMemo, npIrPlayCmd=npIrPlayCmd, npIoTrapLineN=npIoTrapLineN, npThermoEntry=npThermoEntry, npCurLoopV=npCurLoopV, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, lightcom=lightcom, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npReboot=npReboot, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTrap=npIoTrap, npRelayEntry=npRelayEntry, npThermoLow=npThermoLow, npIoLineN=npIoLineN, npIoTable=npIoTable, npSmokePower=npSmokePower, npRelayMemo=npRelayMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoSensorN=npThermoSensorN, npRelHumTrapDataN=npRelHumTrapDataN, npIoLevelOut=npIoLevelOut, npSmokeTraps=npSmokeTraps, npSmokeSensorN=npSmokeSensorN)
