...
# Produced by pysmi-1.1.12 at Wed Jul  3 10:49:14 2024
...
Gauge32, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises, Counter32, ObjectIdentity, ModuleIdentity, TimeTicks, Bits, Unsigned32, IpAddress, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises", "Counter32", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "Bits", "Unsigned32", "IpAddress", "Counter64", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoValue=npThermoValue, npRelay=npRelay, npCurLoopN=npCurLoopN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayState=npRelayState, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopStatus=npCurLoopStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumMemo=npRelHumMemo, npThermoTraps=npThermoTraps, npRelHumidity=npRelHumidity, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmTrap=npGsmTrap, npThermoStatus=npThermoStatus, npThermoSensorN=npThermoSensorN, npIrCtrl=npIrCtrl, npIr=npIr, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapR=npCurLoopTrapR, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npTrapInfo=npTrapInfo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapLow=npThermoTrapLow, npRelayMode=npRelayMode, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumValue=npRelHumValue, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopV=npCurLoopV, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopPower=npCurLoopPower, npRelayMemo=npRelayMemo, npIoPulseCounter=npIoPulseCounter, npIrStatus=npIrStatus, npSmoke=npSmoke, npCurLoopTrapN=npCurLoopTrapN, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayEntry=npRelayEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeEntry=npSmokeEntry, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoLineN=npIoLineN, npThermoTrapValue=npThermoTrapValue, npIoEntry=npIoEntry, npSmokeTrapStatus=npSmokeTrapStatus, npRelayStartReset=npRelayStartReset, npReboot=npReboot, npThermoLow=npThermoLow, npThermoHigh=npThermoHigh, npCurLoopTrapV=npCurLoopTrapV, npSmokeMemo=npSmokeMemo, npIrPlayCmd=npIrPlayCmd, npGsmFailed=npGsmFailed, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermo=npThermo, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapData=npRelHumTrapData, npGsm=npGsm, npSmokeTrap=npSmokeTrap, npCurLoopTrapI=npCurLoopTrapI, npThermoTrapStatus=npThermoTrapStatus, npSmokeTable=npSmokeTable, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIrReset=npIrReset, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTempStatus=npRelHumTempStatus, npSmokeReset=npSmokeReset, npSmokeStatus=npSmokeStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopEntry=npCurLoopEntry, npGsmTraps=npGsmTraps, lightcom=lightcom, npTrapEmailTo=npTrapEmailTo, npThermoTrapHigh=npThermoTrapHigh, npRelHumTempValue=npRelHumTempValue, npIo=npIo, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoMemo=npThermoMemo, npCurLoopTable=npCurLoopTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npForcedReboot=npForcedReboot, npThermoEntry=npThermoEntry, npIoTable=npIoTable, npSmokeTraps=npSmokeTraps, npCurLoopR=npCurLoopR, npThermoTable=npThermoTable, npRelHumStatus=npRelHumStatus, npIoLevelIn=npIoLevelIn, npCurLoop=npCurLoop, npRelayN=npRelayN, npRelayTable=npRelayTable, npResetStack=npResetStack, npRelHumEntry=npRelHumEntry, FixedPoint1000=FixedPoint1000, npGsmRegistration=npGsmRegistration, npRelHumN=npRelHumN, npSmokePower=npSmokePower, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoMemo=npIoMemo, npRelHumTrapTemp=npRelHumTrapTemp, npIoLevelOut=npIoLevelOut, npIoTrapMemo=npIoTrapMemo, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTable=npRelHumTable, npGsmInfo=npGsmInfo, npSoftReboot=npSoftReboot, npIoTraps=npIoTraps, npThermoTrap=npThermoTrap, npRelHumTrap=npRelHumTrap, npIoTrap=npIoTrap, npGsmStrength=npGsmStrength, npRelHumTrapFail=npRelHumTrapFail, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopI=npCurLoopI, npThermoTrapMemo=npThermoTrapMemo)
