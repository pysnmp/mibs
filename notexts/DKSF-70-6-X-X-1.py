...
# Produced by pysmi-1.1.8 at Thu Jan  5 10:01:01 2023
...
Integer32, NotificationType, IpAddress, iso, MibIdentifier, enterprises, Gauge32, ModuleIdentity, ObjectIdentity, Counter64, Counter32, TimeTicks, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "IpAddress", "iso", "MibIdentifier", "enterprises", "Gauge32", "ModuleIdentity", "ObjectIdentity", "Counter64", "Counter32", "TimeTicks", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSoftReboot=npSoftReboot, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokePower=npSmokePower, npThermoSensorN=npThermoSensorN, npIo=npIo, npCurLoopPower=npCurLoopPower, npIoLevelIn=npIoLevelIn, npIoTable=npIoTable, npThermoTrapValue=npThermoTrapValue, npSmokeTrapStatus=npSmokeTrapStatus, npIrStatus=npIrStatus, npIoTrapMemo=npIoTrapMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoPulseCounter=npIoPulseCounter, npTrapEmailTo=npTrapEmailTo, npThermoValue=npThermoValue, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelayEntry=npRelayEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrap=npIoTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTempStatus=npRelHumTempStatus, npThermoHigh=npThermoHigh, npGsmStrength=npGsmStrength, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrapV=npCurLoopTrapV, lightcom=lightcom, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrap=npCurLoopTrap, npIoLevelOut=npIoLevelOut, npIoTrapLineN=npIoTrapLineN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumValue=npRelHumValue, npThermoMemo=npThermoMemo, npRelHumidity=npRelHumidity, npRelHumEntry=npRelHumEntry, npIoMemo=npIoMemo, npTrapInfo=npTrapInfo, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopI=npCurLoopI, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumStatus=npRelHumStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIr=npIr, npIoLineN=npIoLineN, npSmokeSensorN=npSmokeSensorN, npIrPlayCmd=npIrPlayCmd, npIrCtrl=npIrCtrl, npForcedReboot=npForcedReboot, npThermoTrapPrefix=npThermoTrapPrefix, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayN=npRelayN, npRelHumTable=npRelHumTable, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTable=npCurLoopTable, npRelHumTrapSafe=npRelHumTrapSafe, npGsm=npGsm, npIoEntry=npIoEntry, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTraps=npIoTraps, npGsmTrap=npGsmTrap, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapPower=npCurLoopTrapPower, npRelay=npRelay, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTrapMemo=npSmokeTrapMemo, npRelayMemo=npRelayMemo, npCurLoopEntry=npCurLoopEntry, npThermoTrapStatus=npThermoTrapStatus, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapData=npRelHumTrapData, npResetStack=npResetStack, npSmokeTraps=npSmokeTraps, npThermoTrap=npThermoTrap, npCurLoopTrapI=npCurLoopTrapI, npSmokeStatus=npSmokeStatus, npThermoEntry=npThermoEntry, npRelHumTrapTemp=npRelHumTrapTemp, npThermoLow=npThermoLow, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayState=npRelayState, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermo=npThermo, npCurLoopN=npCurLoopN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrap=npRelHumTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopR=npCurLoopR, npGsmFailed=npGsmFailed, npThermoTraps=npThermoTraps, npRelayStartReset=npRelayStartReset, npRelHumTrapFail=npRelHumTrapFail, npRelHumMemo=npRelHumMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTable=npSmokeTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapLow=npThermoTrapLow, FixedPoint1000=FixedPoint1000, npGsmTraps=npGsmTraps, npCurLoopV=npCurLoopV, npSmokeTrap=npSmokeTrap, npIrReset=npIrReset, npThermoTrapHigh=npThermoTrapHigh, npGsmInfo=npGsmInfo, npSmokeMemo=npSmokeMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoop=npCurLoop, npCurLoopTraps=npCurLoopTraps, npThermoTable=npThermoTable, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeEntry=npSmokeEntry, npCurLoopTrapR=npCurLoopTrapR, npSmoke=npSmoke, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeReset=npSmokeReset, npCurLoopTrapN=npCurLoopTrapN, npRelayMode=npRelayMode, npGsmRegistration=npGsmRegistration, npThermoTrapSensorN=npThermoTrapSensorN, npRelayTable=npRelayTable, npRelHumN=npRelHumN, npReboot=npReboot, npThermoStatus=npThermoStatus, npThermoTrapMemo=npThermoTrapMemo)
