...
# Produced by pysmi-1.1.3 at Mon Nov 22 11:48:54 2021
...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter32, Counter64, MibIdentifier, Unsigned32, Integer32, TimeTicks, iso, IpAddress, ModuleIdentity, Bits, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter32", "Counter64", "MibIdentifier", "Unsigned32", "Integer32", "TimeTicks", "iso", "IpAddress", "ModuleIdentity", "Bits", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumStatus=npRelHumStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npGsmRegistration=npGsmRegistration, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrap=npThermoTrap, npThermoTrapLow=npThermoTrapLow, npIrPlayCmd=npIrPlayCmd, npSmokeTraps=npSmokeTraps, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmTraps=npGsmTraps, npIrCtrl=npIrCtrl, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayMemo=npRelayMemo, npThermoTrapValue=npThermoTrapValue, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIrReset=npIrReset, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokePower=npSmokePower, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayTable=npRelayTable, npRelayMode=npRelayMode, npThermoTrapHigh=npThermoTrapHigh, npThermo=npThermo, npGsmTrap=npGsmTrap, npRelHumTable=npRelHumTable, npSmoke=npSmoke, npRelHumN=npRelHumN, npCurLoopEntry=npCurLoopEntry, npThermoValuePrecise=npThermoValuePrecise, npIoTraps=npIoTraps, npGsmStrength=npGsmStrength, npForcedReboot=npForcedReboot, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapV=npCurLoopTrapV, npCurLoopPower=npCurLoopPower, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTraps=npThermoTraps, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTrap=npSmokeTrap, npRelHumValue=npRelHumValue, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmInfo=npGsmInfo, npThermoTrapStatus=npThermoTrapStatus, npCurLoopV=npCurLoopV, npCurLoopStatus=npCurLoopStatus, npThermoSensorN=npThermoSensorN, lightcom=lightcom, npIoPulseCounter=npIoPulseCounter, npIoLevelIn=npIoLevelIn, npIoTrap=npIoTrap, npSmokeStatus=npSmokeStatus, npSmokeMemo=npSmokeMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIo=npIo, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoMemo=npThermoMemo, npThermoTrapMemo=npThermoTrapMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npResetStack=npResetStack, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumEntry=npRelHumEntry, npCurLoopI=npCurLoopI, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTrapMemo=npIoTrapMemo, npTrapEmailTo=npTrapEmailTo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoMemo=npIoMemo, npThermoValue=npThermoValue, npIoLevelOut=npIoLevelOut, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, FixedPoint1000=FixedPoint1000, npRelayEntry=npRelayEntry, npCurLoopTrapN=npCurLoopTrapN, npRelayState=npRelayState, npThermoTable=npThermoTable, npIoTrapLineN=npIoTrapLineN, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTempStatus=npRelHumTempStatus, npSmokeEntry=npSmokeEntry, npThermoHigh=npThermoHigh, npCurLoop=npCurLoop, npRelHumMemo=npRelHumMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTable=npCurLoopTable, npRelHumTempValue=npRelHumTempValue, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapFail=npRelHumTrapFail, npCurLoopR=npCurLoopR, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsm=npGsm, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoEntry=npThermoEntry, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapR=npCurLoopTrapR, npRelHumidity=npRelHumidity, npCurLoopTraps=npCurLoopTraps, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrap=npCurLoopTrap, npRelayStartReset=npRelayStartReset, npIoLineN=npIoLineN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrap=npRelHumTrap, npReboot=npReboot, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeReset=npSmokeReset, npGsmFailed=npGsmFailed, npIoTrapLevelIn=npIoTrapLevelIn, npTrapInfo=npTrapInfo, npIoEntry=npIoEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelay=npRelay, npCurLoopN=npCurLoopN, npRelHumTrapDataN=npRelHumTrapDataN, npRelayN=npRelayN, npIoTable=npIoTable, npThermoLow=npThermoLow, npIr=npIr, npSoftReboot=npSoftReboot, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeSensorN=npSmokeSensorN, npSmokeTable=npSmokeTable, npThermoStatus=npThermoStatus, npIrStatus=npIrStatus)
