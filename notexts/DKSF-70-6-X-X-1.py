...
IpAddress, Bits, Counter64, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, enterprises, Counter32, Integer32, MibIdentifier, ObjectIdentity, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "Counter64", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "enterprises", "Counter32", "Integer32", "MibIdentifier", "ObjectIdentity", "Unsigned32", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoHigh=npThermoHigh, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTable=npThermoTable, npRelHumTrapDataMemo=npRelHumTrapDataMemo, lightcom=lightcom, npCurLoopN=npCurLoopN, npReboot=npReboot, npCurLoopTrapN=npCurLoopTrapN, npIoTrap=npIoTrap, npGsmStrength=npGsmStrength, npSmokeReset=npSmokeReset, npRelayState=npRelayState, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTrapLineN=npIoTrapLineN, npForcedReboot=npForcedReboot, npResetStack=npResetStack, npIoEntry=npIoEntry, npCurLoopTrap=npCurLoopTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumN=npRelHumN, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmoke=npSmoke, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataN=npRelHumTrapDataN, npThermo=npThermo, npSmokeTable=npSmokeTable, npIoTraps=npIoTraps, npThermoTrapStatus=npThermoTrapStatus, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapLow=npThermoTrapLow, npRelHumValue=npRelHumValue, npSmokeTraps=npSmokeTraps, npRelHumMemo=npRelHumMemo, npRelayStartReset=npRelayStartReset, npSoftReboot=npSoftReboot, npGsmTrapPrefix=npGsmTrapPrefix, npThermoStatus=npThermoStatus, npIoTable=npIoTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokePower=npSmokePower, npGsmFailed=npGsmFailed, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayTable=npRelayTable, FixedPoint1000=FixedPoint1000, npRelayMode=npRelayMode, npCurLoopV=npCurLoopV, npRelHumTrapFail=npRelHumTrapFail, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmInfo=npGsmInfo, npIoTrapMemo=npIoTrapMemo, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapValue=npThermoTrapValue, npRelHumTempStatus=npRelHumTempStatus, npRelHumEntry=npRelHumEntry, npIo=npIo, npIrReset=npIrReset, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapPrefix=npThermoTrapPrefix, npIrStatus=npIrStatus, npThermoMemo=npThermoMemo, npCurLoopR=npCurLoopR, npRelayMemo=npRelayMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoPulseCounter=npIoPulseCounter, npRelayN=npRelayN, npIoLevelIn=npIoLevelIn, npSmokeTrap=npSmokeTrap, npSmokeMemo=npSmokeMemo, npSmokeSensorN=npSmokeSensorN, npGsmTrap=npGsmTrap, npIoLevelOut=npIoLevelOut, npCurLoop=npCurLoop, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapI=npCurLoopTrapI, npThermoLow=npThermoLow, npRelHumTrapSafe=npRelHumTrapSafe, npIoMemo=npIoMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeEntry=npSmokeEntry, npRelHumStatus=npRelHumStatus, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrap=npThermoTrap, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTable=npCurLoopTable, npRelHumTempValue=npRelHumTempValue, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmRegistration=npGsmRegistration, npThermoValue=npThermoValue, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoEntry=npThermoEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIrPlayCmd=npIrPlayCmd, npRelHumTrapData=npRelHumTrapData, npIrCtrl=npIrCtrl, npThermoTraps=npThermoTraps, npGsm=npGsm, npRelHumidity=npRelHumidity, npRelayEntry=npRelayEntry, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeStatus=npSmokeStatus, npGsmTraps=npGsmTraps, npTrapEmailTo=npTrapEmailTo, npCurLoopPower=npCurLoopPower, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTable=npRelHumTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopI=npCurLoopI, npIoLineN=npIoLineN, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoSensorN=npThermoSensorN, npCurLoopStatus=npCurLoopStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTraps=npCurLoopTraps, npRelHumTrap=npRelHumTrap, npIr=npIr, npTrapInfo=npTrapInfo, npRelay=npRelay)
