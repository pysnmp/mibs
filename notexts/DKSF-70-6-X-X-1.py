...
# Produced by pysmi-1.1.8 at Wed Oct 11 09:32:28 2023
...
ModuleIdentity, Integer32, TimeTicks, MibIdentifier, ObjectIdentity, IpAddress, iso, Gauge32, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "TimeTicks", "MibIdentifier", "ObjectIdentity", "IpAddress", "iso", "Gauge32", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopN=npCurLoopN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npReboot=npReboot, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTempValue=npRelHumTempValue, npSmokeReset=npSmokeReset, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmRegistration=npGsmRegistration, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTable=npIoTable, npCurLoopStatus=npCurLoopStatus, npThermoMemo=npThermoMemo, npTrapInfo=npTrapInfo, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumMemo=npRelHumMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapI=npCurLoopTrapI, npSmokeTraps=npSmokeTraps, npRelayMode=npRelayMode, npRelHumTable=npRelHumTable, npIoMemo=npIoMemo, npIrCtrl=npIrCtrl, npGsmStrength=npGsmStrength, npRelayN=npRelayN, npRelHumTrap=npRelHumTrap, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npTrapEmailTo=npTrapEmailTo, npIo=npIo, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapStatus=npThermoTrapStatus, npThermoTable=npThermoTable, npCurLoopTrapN=npCurLoopTrapN, npSmokeTable=npSmokeTable, npGsmFailed=npGsmFailed, npResetStack=npResetStack, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTrapR=npCurLoopTrapR, npRelayState=npRelayState, npGsmTrap=npGsmTrap, npRelHumTrapData=npRelHumTrapData, npGsmTraps=npGsmTraps, npThermoTrapValue=npThermoTrapValue, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapMemo=npThermoTrapMemo, npIoEntry=npIoEntry, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTemp=npRelHumTrapTemp, npIrReset=npIrReset, npGsmTrapPrefix=npGsmTrapPrefix, npGsm=npGsm, npIoLevelOut=npIoLevelOut, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumStatus=npRelHumStatus, npGsmInfo=npGsmInfo, npSmokePower=npSmokePower, npCurLoopV=npCurLoopV, lightcom=lightcom, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayMemo=npRelayMemo, npThermoLow=npThermoLow, npIoTrapPrefix=npIoTrapPrefix, npCurLoopI=npCurLoopI, npSmokeMemo=npSmokeMemo, npCurLoopTrapV=npCurLoopTrapV, npRelayTable=npRelayTable, npIoLevelIn=npIoLevelIn, npForcedReboot=npForcedReboot, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrapLineN=npIoTrapLineN, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapMemo=npIoTrapMemo, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIr=npIr, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTraps=npThermoTraps, npRelHumEntry=npRelHumEntry, npThermoTrap=npThermoTrap, npThermoValue=npThermoValue, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumidity=npRelHumidity, npThermoTrapLow=npThermoTrapLow, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoEntry=npThermoEntry, npCurLoopR=npCurLoopR, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTable=npCurLoopTable, npThermoHigh=npThermoHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopEntry=npCurLoopEntry, npRelayEntry=npRelayEntry, npThermoStatus=npThermoStatus, npIoLineN=npIoLineN, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoop=npCurLoop, npCurLoopTraps=npCurLoopTraps, npCurLoopTrap=npCurLoopTrap, npCurLoopPower=npCurLoopPower, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelay=npRelay, npSmokeSensorN=npSmokeSensorN, npIoPulseCounter=npIoPulseCounter, npRelHumTrapFail=npRelHumTrapFail, npIoTraps=npIoTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumN=npRelHumN, npIrStatus=npIrStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, FixedPoint1000=FixedPoint1000, npSmokeStatus=npSmokeStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmoke=npSmoke, npRelHumTrapDataN=npRelHumTrapDataN, npSoftReboot=npSoftReboot, npThermoTrapHigh=npThermoTrapHigh, npIoTrap=npIoTrap, npSmokeTrap=npSmokeTrap, npThermoSensorN=npThermoSensorN, npThermo=npThermo, npSmokeEntry=npSmokeEntry, npRelHumValue=npRelHumValue, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoValuePrecise=npThermoValuePrecise, npRelayStartReset=npRelayStartReset, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow)
