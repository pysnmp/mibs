...
# Produced by pysmi-1.1.3 at Sun Nov 28 21:17:16 2021
...
ObjectIdentity, Unsigned32, IpAddress, Integer32, MibIdentifier, NotificationType, Gauge32, enterprises, ModuleIdentity, TimeTicks, iso, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "IpAddress", "Integer32", "MibIdentifier", "NotificationType", "Gauge32", "enterprises", "ModuleIdentity", "TimeTicks", "iso", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapFail=npRelHumTrapFail, npSoftReboot=npSoftReboot, npIrReset=npIrReset, npIoLevelOut=npIoLevelOut, npGsm=npGsm, npIoEntry=npIoEntry, npSmokeTraps=npSmokeTraps, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npRelayStartReset=npRelayStartReset, npCurLoopN=npCurLoopN, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeMemo=npSmokeMemo, npCurLoopTrapV=npCurLoopTrapV, npCurLoopV=npCurLoopV, npThermoMemo=npThermoMemo, npResetStack=npResetStack, npIrStatus=npIrStatus, npRelHumTable=npRelHumTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeSensorN=npSmokeSensorN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmFailed=npGsmFailed, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTable=npCurLoopTable, npThermoTrapLow=npThermoTrapLow, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopPower=npCurLoopPower, npThermoLow=npThermoLow, npIoTraps=npIoTraps, npIoPulseCounter=npIoPulseCounter, npThermoStatus=npThermoStatus, npSmokeTrap=npSmokeTrap, npRelHumEntry=npRelHumEntry, npIoTrap=npIoTrap, npCurLoopTrapN=npCurLoopTrapN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeEntry=npSmokeEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmoke=npSmoke, npThermoTrapMemo=npThermoTrapMemo, npCurLoopStatus=npCurLoopStatus, npThermoTrap=npThermoTrap, npRelHumMemo=npRelHumMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapPrefix=npThermoTrapPrefix, npIoLineN=npIoLineN, npThermoValue=npThermoValue, npRelHumTrapTemp=npRelHumTrapTemp, lightcom=lightcom, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npForcedReboot=npForcedReboot, npThermoTable=npThermoTable, npCurLoop=npCurLoop, npRelayN=npRelayN, npRelayTable=npRelayTable, npIo=npIo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTable=npSmokeTable, npGsmTraps=npGsmTraps, npIr=npIr, npRelHumidity=npRelHumidity, npRelayEntry=npRelayEntry, npThermoHigh=npThermoHigh, npRelHumStatus=npRelHumStatus, npSmokeTrapStatus=npSmokeTrapStatus, npGsmTrap=npGsmTrap, npTrapInfo=npTrapInfo, npRelHumN=npRelHumN, npSmokeReset=npSmokeReset, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmInfo=npGsmInfo, npRelayMemo=npRelayMemo, npIoTrapLineN=npIoTrapLineN, npThermoTrapValue=npThermoTrapValue, npIrCtrl=npIrCtrl, npCurLoopEntry=npCurLoopEntry, npCurLoopR=npCurLoopR, npIoTable=npIoTable, npCurLoopTrap=npCurLoopTrap, npIoLevelIn=npIoLevelIn, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrap=npRelHumTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoEntry=npThermoEntry, npThermoSensorN=npThermoSensorN, npIrPlayCmd=npIrPlayCmd, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayMode=npRelayMode, npRelayState=npRelayState, npThermoValuePrecise=npThermoValuePrecise, npCurLoopI=npCurLoopI, npRelHumTrapTempSafe=npRelHumTrapTempSafe, FixedPoint1000=FixedPoint1000, npRelHumTrapData=npRelHumTrapData, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapPower=npCurLoopTrapPower, npGsmStrength=npGsmStrength, npIoMemo=npIoMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelay=npRelay, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmRegistration=npGsmRegistration, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeStatus=npSmokeStatus, npThermoTrapHigh=npThermoTrapHigh, npGsmTrapPrefix=npGsmTrapPrefix, npReboot=npReboot, npThermo=npThermo, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumValue=npRelHumValue, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTempStatus=npRelHumTempStatus, npThermoTraps=npThermoTraps, npRelHumTempValue=npRelHumTempValue, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokePower=npSmokePower, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapR=npCurLoopTrapR)
