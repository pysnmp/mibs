...
# Produced by pysmi-1.1.8 at Thu Oct 26 10:05:49 2023
...
Counter64, ObjectIdentity, Unsigned32, TimeTicks, enterprises, Integer32, iso, ModuleIdentity, Counter32, NotificationType, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "Unsigned32", "TimeTicks", "enterprises", "Integer32", "iso", "ModuleIdentity", "Counter32", "NotificationType", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsm=npGsm, npRelHumTrapData=npRelHumTrapData, npIoTrapMemo=npIoTrapMemo, npSmokeTrap=npSmokeTrap, npIoLineN=npIoLineN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoStatus=npThermoStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, lightcom=lightcom, npThermoTrapMemo=npThermoTrapMemo, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npCurLoopEntry=npCurLoopEntry, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTraps=npSmokeTraps, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeSensorN=npSmokeSensorN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapLineN=npIoTrapLineN, npRelayEntry=npRelayEntry, npRelHumidity=npRelHumidity, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapLow=npThermoTrapLow, npTrapInfo=npTrapInfo, npIoMemo=npIoMemo, npIr=npIr, npThermoValue=npThermoValue, npIrCtrl=npIrCtrl, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoEntry=npIoEntry, npSmokeTable=npSmokeTable, npCurLoopTable=npCurLoopTable, npSmokeStatus=npSmokeStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmInfo=npGsmInfo, npCurLoopPower=npCurLoopPower, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokePower=npSmokePower, npGsmStrength=npGsmStrength, npThermoSensorN=npThermoSensorN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayStartReset=npRelayStartReset, npReboot=npReboot, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmFailed=npGsmFailed, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumStatus=npRelHumStatus, npRelHumValue=npRelHumValue, npIoLevelOut=npIoLevelOut, npForcedReboot=npForcedReboot, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTable=npThermoTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmRegistration=npGsmRegistration, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapDataN=npRelHumTrapDataN, npIrReset=npIrReset, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopStatus=npCurLoopStatus, npRelayMode=npRelayMode, npRelHumMemo=npRelHumMemo, npThermoLow=npThermoLow, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapHigh=npThermoTrapHigh, npThermoTraps=npThermoTraps, npSmokeTrapMemo=npSmokeTrapMemo, npIrStatus=npIrStatus, npIoLevelIn=npIoLevelIn, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIo=npIo, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapV=npCurLoopTrapV, npGsmTraps=npGsmTraps, npTrapEmailTo=npTrapEmailTo, npRelHumTable=npRelHumTable, npIoTrapPrefix=npIoTrapPrefix, npResetStack=npResetStack, npIoTrapLevelIn=npIoTrapLevelIn, npRelayN=npRelayN, npCurLoopI=npCurLoopI, npGsmTrapPrefix=npGsmTrapPrefix, npRelayMemo=npRelayMemo, npGsmTrap=npGsmTrap, npCurLoopTrapR=npCurLoopTrapR, npRelayTable=npRelayTable, npRelHumEntry=npRelHumEntry, npSoftReboot=npSoftReboot, npCurLoopTraps=npCurLoopTraps, npSmoke=npSmoke, npThermoHigh=npThermoHigh, npCurLoopTrapI=npCurLoopTrapI, npThermo=npThermo, npSmokeReset=npSmokeReset, npIoTable=npIoTable, npRelHumTrapSafe=npRelHumTrapSafe, npRelayState=npRelayState, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelay=npRelay, npCurLoopR=npCurLoopR, npRelHumN=npRelHumN, npSmokeEntry=npSmokeEntry, FixedPoint1000=FixedPoint1000, npThermoTrapValue=npThermoTrapValue, npThermoTrap=npThermoTrap, npThermoEntry=npThermoEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoop=npCurLoop, npThermoMemo=npThermoMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTempStatus=npRelHumTempStatus, npSmokeMemo=npSmokeMemo, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIrPlayCmd=npIrPlayCmd, npRelHumTrapFail=npRelHumTrapFail, npCurLoopV=npCurLoopV, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrap=npRelHumTrap, npCurLoopN=npCurLoopN, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoPulseCounter=npIoPulseCounter, npIoTraps=npIoTraps, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrap=npCurLoopTrap, npIoTrap=npIoTrap)
