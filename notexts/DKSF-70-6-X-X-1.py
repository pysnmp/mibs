...
ModuleIdentity, MibIdentifier, Integer32, enterprises, TimeTicks, iso, Unsigned32, Counter64, IpAddress, Counter32, Gauge32, Bits, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "Integer32", "enterprises", "TimeTicks", "iso", "Unsigned32", "Counter64", "IpAddress", "Counter32", "Gauge32", "Bits", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTrapMemo=npSmokeTrapMemo, npSmokeReset=npSmokeReset, npSmokeTrap=npSmokeTrap, npRelHumTempStatus=npRelHumTempStatus, npThermoEntry=npThermoEntry, npThermoTrapValue=npThermoTrapValue, npCurLoop=npCurLoop, npRelayEntry=npRelayEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapStatus=npCurLoopTrapStatus, npForcedReboot=npForcedReboot, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopR=npCurLoopR, npRelHumN=npRelHumN, npCurLoopV=npCurLoopV, npThermoTrapMemo=npThermoTrapMemo, npRelHumTable=npRelHumTable, npSmokeMemo=npSmokeMemo, npIoLineN=npIoLineN, npRelayMode=npRelayMode, npSoftReboot=npSoftReboot, npSmokeTable=npSmokeTable, npIoLevelIn=npIoLevelIn, lightcom=lightcom, npIoTrap=npIoTrap, npCurLoopTable=npCurLoopTable, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeStatus=npSmokeStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmTraps=npGsmTraps, npThermoSensorN=npThermoSensorN, npIrPlayCmd=npIrPlayCmd, npRelHumEntry=npRelHumEntry, npCurLoopTrapV=npCurLoopTrapV, npRelayMemo=npRelayMemo, npIoTrapMemo=npIoTrapMemo, npReboot=npReboot, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoValue=npThermoValue, npRelayTable=npRelayTable, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapSensorN=npThermoTrapSensorN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumStatus=npRelHumStatus, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTemp=npRelHumTrapTemp, npIoEntry=npIoEntry, npRelHumTrapDataN=npRelHumTrapDataN, npRelayStartReset=npRelayStartReset, npGsmFailed=npGsmFailed, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapN=npCurLoopTrapN, npSmokeTraps=npSmokeTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoMemo=npThermoMemo, npThermo=npThermo, npGsmInfo=npGsmInfo, npGsmStrength=npGsmStrength, npIoTrapLineN=npIoTrapLineN, npCurLoopStatus=npCurLoopStatus, npGsmTrap=npGsmTrap, npIr=npIr, npRelHumTrapData=npRelHumTrapData, npIrCtrl=npIrCtrl, npThermoTrapPrefix=npThermoTrapPrefix, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTraps=npThermoTraps, npIoTraps=npIoTraps, npRelHumMemo=npRelHumMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokePower=npSmokePower, npIoTable=npIoTable, npIrStatus=npIrStatus, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrap=npRelHumTrap, npCurLoopN=npCurLoopN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmRegistration=npGsmRegistration, npRelayState=npRelayState, FixedPoint1000=FixedPoint1000, npThermoStatus=npThermoStatus, npThermoTrapLow=npThermoTrapLow, npCurLoopI=npCurLoopI, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoLevelOut=npIoLevelOut, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npSmokeEntry=npSmokeEntry, npTrapInfo=npTrapInfo, npCurLoopEntry=npCurLoopEntry, npIoPulseCounter=npIoPulseCounter, npCurLoopPower=npCurLoopPower, npCurLoopTraps=npCurLoopTraps, npIoTrapLevelIn=npIoTrapLevelIn, npResetStack=npResetStack, npRelHumTrapFail=npRelHumTrapFail, npGsm=npGsm, npRelay=npRelay, npRelHumValue=npRelHumValue, npRelHumidity=npRelHumidity, npGsmTrapPrefix=npGsmTrapPrefix, npTrapEmailTo=npTrapEmailTo, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrap=npThermoTrap, npSmoke=npSmoke, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrReset=npIrReset, npThermoTable=npThermoTable, npThermoValuePrecise=npThermoValuePrecise, npIo=npIo, npSmokeSensorN=npSmokeSensorN, npRelHumTempValue=npRelHumTempValue, npThermoHigh=npThermoHigh, npThermoLow=npThermoLow, npRelayN=npRelayN, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoMemo=npIoMemo, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow)
