...
# Produced by pysmi-1.1.8 at Thu Sep  8 10:22:08 2022
...
Counter32, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, Unsigned32, enterprises, Bits, NotificationType, ObjectIdentity, Gauge32, IpAddress, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "Unsigned32", "enterprises", "Bits", "NotificationType", "ObjectIdentity", "Gauge32", "IpAddress", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoValue=npThermoValue, npRelHumN=npRelHumN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumidity=npRelHumidity, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayMemo=npRelayMemo, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsm=npGsm, npRelayEntry=npRelayEntry, npRelHumStatus=npRelHumStatus, npIo=npIo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrStatus=npIrStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTemp=npRelHumTrapTemp, npIoEntry=npIoEntry, npSoftReboot=npSoftReboot, npIoLevelIn=npIoLevelIn, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeReset=npSmokeReset, npThermoTrapValue=npThermoTrapValue, npRelHumMemo=npRelHumMemo, npRelHumTrapDataN=npRelHumTrapDataN, npGsmRegistration=npGsmRegistration, npCurLoopTrapPower=npCurLoopTrapPower, npThermoValuePrecise=npThermoValuePrecise, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayStartReset=npRelayStartReset, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapI=npCurLoopTrapI, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoHigh=npThermoHigh, npCurLoopTable=npCurLoopTable, npGsmFailed=npGsmFailed, npIoLevelOut=npIoLevelOut, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopR=npCurLoopR, npSmokeStatus=npSmokeStatus, npCurLoopN=npCurLoopN, npCurLoopV=npCurLoopV, npRelayTable=npRelayTable, npSmokeTrap=npSmokeTrap, npCurLoopTrapR=npCurLoopTrapR, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npTrapInfo=npTrapInfo, npCurLoopTrapV=npCurLoopTrapV, npSmokeEntry=npSmokeEntry, npRelHumTrapSafe=npRelHumTrapSafe, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTraps=npSmokeTraps, npCurLoop=npCurLoop, npGsmTrap=npGsmTrap, npRelayMode=npRelayMode, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrap=npThermoTrap, npIrCtrl=npIrCtrl, npTrapEmailTo=npTrapEmailTo, npThermo=npThermo, npThermoTrapLow=npThermoTrapLow, npCurLoopEntry=npCurLoopEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTraps=npCurLoopTraps, npIoTrap=npIoTrap, npRelHumTrapData=npRelHumTrapData, npIoMemo=npIoMemo, npSmokeMemo=npSmokeMemo, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempValue=npRelHumTempValue, npThermoEntry=npThermoEntry, npResetStack=npResetStack, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmInfo=npGsmInfo, npCurLoopTrap=npCurLoopTrap, npIoLineN=npIoLineN, npThermoTrapMemo=npThermoTrapMemo, npRelHumTempStatus=npRelHumTempStatus, npCurLoopPower=npCurLoopPower, npSmokeTable=npSmokeTable, npCurLoopTrapN=npCurLoopTrapN, npGsmStrength=npGsmStrength, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumValue=npRelHumValue, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npForcedReboot=npForcedReboot, npRelay=npRelay, npGsmTraps=npGsmTraps, npThermoStatus=npThermoStatus, npIoTable=npIoTable, npThermoTraps=npThermoTraps, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoLow=npThermoLow, npIoPulseCounter=npIoPulseCounter, lightcom=lightcom, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTraps=npIoTraps, npSmokePower=npSmokePower, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIr=npIr, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapPrefix=npIoTrapPrefix, npIoSinglePulseStart=npIoSinglePulseStart, npThermoSensorN=npThermoSensorN, npSmoke=npSmoke, npRelayN=npRelayN, npRelHumEntry=npRelHumEntry, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayState=npRelayState, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTable=npRelHumTable, npSmokeSensorN=npSmokeSensorN, npThermoMemo=npThermoMemo, npReboot=npReboot, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrap=npRelHumTrap, npIrPlayCmd=npIrPlayCmd, npIoTrapLineN=npIoTrapLineN, npIoTrapMemo=npIoTrapMemo, FixedPoint1000=FixedPoint1000, npThermoTable=npThermoTable, npCurLoopI=npCurLoopI, npIrReset=npIrReset, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe)
