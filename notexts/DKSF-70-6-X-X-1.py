...
# Produced by pysmi-1.1.8 at Thu Sep 29 13:12:14 2022
...
enterprises, ObjectIdentity, Bits, NotificationType, Counter32, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, IpAddress, MibIdentifier, ModuleIdentity, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ObjectIdentity", "Bits", "NotificationType", "Counter32", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "IpAddress", "MibIdentifier", "ModuleIdentity", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoLevelIn=npIoLevelIn, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelay=npRelay, npRelHumTempValue=npRelHumTempValue, npIoTraps=npIoTraps, npTrapInfo=npTrapInfo, npCurLoopTrapR=npCurLoopTrapR, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumN=npRelHumN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTraps=npCurLoopTraps, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoPulseCounter=npIoPulseCounter, npThermoValue=npThermoValue, npGsmTrapPrefix=npGsmTrapPrefix, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoSensorN=npThermoSensorN, npThermoTraps=npThermoTraps, npRelHumMemo=npRelHumMemo, npSmokeTrap=npSmokeTrap, npRelayMemo=npRelayMemo, npForcedReboot=npForcedReboot, npThermoTrapLow=npThermoTrapLow, npIoEntry=npIoEntry, npRelHumEntry=npRelHumEntry, npThermoHigh=npThermoHigh, npRelHumTrap=npRelHumTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoLow=npThermoLow, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTable=npSmokeTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokePower=npSmokePower, npSmokeTraps=npSmokeTraps, npCurLoopTrapStatus=npCurLoopTrapStatus, npIrCtrl=npIrCtrl, npCurLoopPower=npCurLoopPower, npGsm=npGsm, npIoTrapLineN=npIoTrapLineN, npSoftReboot=npSoftReboot, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrap=npThermoTrap, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayState=npRelayState, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoEntry=npThermoEntry, npRelayMode=npRelayMode, npTrapEmailTo=npTrapEmailTo, npGsmStrength=npGsmStrength, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayN=npRelayN, npCurLoopR=npCurLoopR, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmTraps=npGsmTraps, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTempStatus=npRelHumTempStatus, FixedPoint1000=FixedPoint1000, npThermoTable=npThermoTable, npThermoTrapHigh=npThermoTrapHigh, npIrPlayCmd=npIrPlayCmd, npSmokeEntry=npSmokeEntry, npIoLevelOut=npIoLevelOut, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapStatus=npThermoTrapStatus, npSmokeStatus=npSmokeStatus, lightcom=lightcom, npIrStatus=npIrStatus, npIoTable=npIoTable, npGsmInfo=npGsmInfo, npIoTrap=npIoTrap, npResetStack=npResetStack, npIrReset=npIrReset, npSmokeReset=npSmokeReset, npThermo=npThermo, npSmoke=npSmoke, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTable=npCurLoopTable, npIoMemo=npIoMemo, npRelayEntry=npRelayEntry, npIr=npIr, npRelHumStatus=npRelHumStatus, npCurLoopTrapPower=npCurLoopTrapPower, npIoSinglePulseStart=npIoSinglePulseStart, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopI=npCurLoopI, npThermoStatus=npThermoStatus, npRelHumValue=npRelHumValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTable=npRelHumTable, npCurLoopTrap=npCurLoopTrap, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapMemo=npThermoTrapMemo, npCurLoopN=npCurLoopN, npGsmTrap=npGsmTrap, npCurLoopTrapV=npCurLoopTrapV, npCurLoopStatus=npCurLoopStatus, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoop=npCurLoop, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoMemo=npThermoMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayStartReset=npRelayStartReset, npIo=npIo, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrapMemo=npIoTrapMemo, npSmokeMemo=npSmokeMemo, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumidity=npRelHumidity, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayTable=npRelayTable, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoLineN=npIoLineN, npGsmRegistration=npGsmRegistration, npReboot=npReboot, npCurLoopTrapN=npCurLoopTrapN, npCurLoopV=npCurLoopV, npRelHumTrapData=npRelHumTrapData, npThermoTrapValue=npThermoTrapValue, npRelHumTrapFail=npRelHumTrapFail, npGsmFailed=npGsmFailed)
