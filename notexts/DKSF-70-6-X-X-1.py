...
# Produced by pysmi-1.1.8 at Wed Sep 13 07:30:35 2023
...
TimeTicks, IpAddress, Bits, MibIdentifier, ObjectIdentity, ModuleIdentity, Integer32, Counter32, Counter64, Unsigned32, NotificationType, iso, Gauge32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "Bits", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "Integer32", "Counter32", "Counter64", "Unsigned32", "NotificationType", "iso", "Gauge32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayState=npRelayState, npIoLevelOut=npIoLevelOut, npRelHumTempValue=npRelHumTempValue, npSmokeReset=npSmokeReset, npRelay=npRelay, npGsmFailed=npGsmFailed, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeStatus=npSmokeStatus, npTrapEmailTo=npTrapEmailTo, npSmokeTable=npSmokeTable, npSmokePower=npSmokePower, npRelayStartReset=npRelayStartReset, npIr=npIr, npSmoke=npSmoke, npRelHumTrapFail=npRelHumTrapFail, npThermo=npThermo, npSmokeTrap=npSmokeTrap, npThermoValue=npThermoValue, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumValue=npRelHumValue, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapR=npCurLoopTrapR, npThermoTable=npThermoTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayTable=npRelayTable, npIoTrapMemo=npIoTrapMemo, npGsmInfo=npGsmInfo, npCurLoopTable=npCurLoopTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoLow=npThermoLow, npThermoTrapLow=npThermoTrapLow, npIoTrapLineN=npIoTrapLineN, npIoPulseCounter=npIoPulseCounter, npCurLoopTrapI=npCurLoopTrapI, npIoTraps=npIoTraps, npCurLoopN=npCurLoopN, npCurLoopR=npCurLoopR, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmStrength=npGsmStrength, npIoMemo=npIoMemo, npCurLoopStatus=npCurLoopStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayEntry=npRelayEntry, npGsm=npGsm, npForcedReboot=npForcedReboot, FixedPoint1000=FixedPoint1000, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeSensorN=npSmokeSensorN, npCurLoopV=npCurLoopV, npRelHumTable=npRelHumTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTraps=npThermoTraps, npCurLoopTrapV=npCurLoopTrapV, npRelHumMemo=npRelHumMemo, npSmokeTraps=npSmokeTraps, lightcom=lightcom, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumN=npRelHumN, npRelHumidity=npRelHumidity, npSmokeEntry=npSmokeEntry, npIrStatus=npIrStatus, npGsmTraps=npGsmTraps, npThermoTrapHigh=npThermoTrapHigh, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumEntry=npRelHumEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTrapStatus=npSmokeTrapStatus, npGsmRegistration=npGsmRegistration, npRelayMemo=npRelayMemo, npTrapInfo=npTrapInfo, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoop=npCurLoop, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoEntry=npIoEntry, npIrReset=npIrReset, npThermoMemo=npThermoMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoLevelIn=npIoLevelIn, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npResetStack=npResetStack, npThermoSensorN=npThermoSensorN, npRelHumTrap=npRelHumTrap, npThermoEntry=npThermoEntry, npIoTrapPrefix=npIoTrapPrefix, npSoftReboot=npSoftReboot, npIrCtrl=npIrCtrl, npSmokeMemo=npSmokeMemo, npRelayN=npRelayN, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrap=npThermoTrap, npRelHumTempStatus=npRelHumTempStatus, npRelayMode=npRelayMode, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopPower=npCurLoopPower, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumStatus=npRelHumStatus, npReboot=npReboot, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapData=npRelHumTrapData, npIrPlayCmd=npIrPlayCmd, npCurLoopTrap=npCurLoopTrap, npThermoStatus=npThermoStatus, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTable=npIoTable, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmTrap=npGsmTrap, npThermoHigh=npThermoHigh, npIo=npIo, npIoTrap=npIoTrap, npCurLoopI=npCurLoopI, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapValue=npThermoTrapValue, npIoLineN=npIoLineN)
