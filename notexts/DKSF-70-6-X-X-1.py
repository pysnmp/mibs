...
# Produced by pysmi-1.1.8 at Thu Jan  5 10:25:55 2023
...
Unsigned32, Counter32, ObjectIdentity, Counter64, MibIdentifier, NotificationType, IpAddress, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, enterprises, iso, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "ObjectIdentity", "Counter64", "MibIdentifier", "NotificationType", "IpAddress", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "enterprises", "iso", "Gauge32", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopPower=npCurLoopPower, npCurLoopN=npCurLoopN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeMemo=npSmokeMemo, npRelHumTempValue=npRelHumTempValue, npCurLoopEntry=npCurLoopEntry, npRelayN=npRelayN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopV=npCurLoopV, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoLevelIn=npIoLevelIn, npThermoSensorN=npThermoSensorN, npThermoTrap=npThermoTrap, FixedPoint1000=FixedPoint1000, npRelayTable=npRelayTable, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopR=npCurLoopR, npCurLoopTrapV=npCurLoopTrapV, npIrPlayCmd=npIrPlayCmd, npReboot=npReboot, npIoTrapPrefix=npIoTrapPrefix, npRelHumN=npRelHumN, npIoEntry=npIoEntry, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapLow=npThermoTrapLow, npIoTraps=npIoTraps, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumMemo=npRelHumMemo, npThermoTable=npThermoTable, npRelHumStatus=npRelHumStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSoftReboot=npSoftReboot, npThermoTraps=npThermoTraps, npGsm=npGsm, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoValue=npThermoValue, npThermoTrapPrefix=npThermoTrapPrefix, npTrapInfo=npTrapInfo, npSmokeTable=npSmokeTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayStartReset=npRelayStartReset, npIoPulseCounter=npIoPulseCounter, npSmokeTrap=npSmokeTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopI=npCurLoopI, npSmoke=npSmoke, npIoSinglePulseStart=npIoSinglePulseStart, npSmokePower=npSmokePower, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoEntry=npThermoEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapSensorN=npThermoTrapSensorN, npIoMemo=npIoMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npIo=npIo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapMemo=npThermoTrapMemo, npIr=npIr, npIoLineN=npIoLineN, npCurLoop=npCurLoop, npIrStatus=npIrStatus, npGsmFailed=npGsmFailed, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmTrap=npGsmTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapLineN=npIoTrapLineN, npRelHumTrapData=npRelHumTrapData, npRelHumidity=npRelHumidity, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataN=npRelHumTrapDataN, npRelayMode=npRelayMode, npThermoValuePrecise=npThermoValuePrecise, npSmokeSensorN=npSmokeSensorN, npIoLevelOut=npIoLevelOut, npCurLoopStatus=npCurLoopStatus, npSmokeTraps=npSmokeTraps, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapFail=npRelHumTrapFail, npRelHumEntry=npRelHumEntry, npGsmTraps=npGsmTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeReset=npSmokeReset, npThermo=npThermo, npThermoMemo=npThermoMemo, npRelHumValue=npRelHumValue, npRelHumTable=npRelHumTable, npSmokeStatus=npSmokeStatus, lightcom=lightcom, npCurLoopTrapN=npCurLoopTrapN, npForcedReboot=npForcedReboot, npSmokeEntry=npSmokeEntry, npIrCtrl=npIrCtrl, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoHigh=npThermoHigh, npThermoStatus=npThermoStatus, npRelHumTrap=npRelHumTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrap=npIoTrap, npThermoLow=npThermoLow, npGsmRegistration=npGsmRegistration, npGsmStrength=npGsmStrength, npIoTable=npIoTable, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npTrapEmailTo=npTrapEmailTo, npResetStack=npResetStack, npRelayEntry=npRelayEntry, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTraps=npCurLoopTraps, npThermoTrapStatus=npThermoTrapStatus, npGsmInfo=npGsmInfo, npRelayState=npRelayState, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelayMemo=npRelayMemo, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapValue=npThermoTrapValue, npRelay=npRelay, npCurLoopTable=npCurLoopTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrReset=npIrReset, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrap=npCurLoopTrap)
