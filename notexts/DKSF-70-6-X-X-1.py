...
# Produced by pysmi-1.1.8 at Fri Jan  7 16:12:54 2022
...
iso, ObjectIdentity, ModuleIdentity, Unsigned32, Gauge32, Counter64, TimeTicks, Counter32, NotificationType, enterprises, Bits, MibIdentifier, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "Gauge32", "Counter64", "TimeTicks", "Counter32", "NotificationType", "enterprises", "Bits", "MibIdentifier", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmFailed=npGsmFailed, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumStatus=npRelHumStatus, npRelayMode=npRelayMode, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrapR=npCurLoopTrapR, npIrReset=npIrReset, npRelayEntry=npRelayEntry, npSmokeMemo=npSmokeMemo, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapStatus=npThermoTrapStatus, npIoTrapMemo=npIoTrapMemo, npSmokePower=npSmokePower, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrap=npCurLoopTrap, npCurLoopI=npCurLoopI, lightcom=lightcom, npThermoStatus=npThermoStatus, npSmokeEntry=npSmokeEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapHigh=npThermoTrapHigh, npSmokeReset=npSmokeReset, npCurLoopTable=npCurLoopTable, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoHigh=npThermoHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTrap=npSmokeTrap, FixedPoint1000=FixedPoint1000, npCurLoopV=npCurLoopV, npCurLoopTrapPower=npCurLoopTrapPower, npForcedReboot=npForcedReboot, npCurLoopTraps=npCurLoopTraps, npGsmInfo=npGsmInfo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoSensorN=npThermoSensorN, npRelayN=npRelayN, npRelayMemo=npRelayMemo, npTrapEmailTo=npTrapEmailTo, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapData=npRelHumTrapData, npIoLevelIn=npIoLevelIn, npCurLoopN=npCurLoopN, npRelayState=npRelayState, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTraps=npSmokeTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapSensorN=npThermoTrapSensorN, npRelayStartReset=npRelayStartReset, npCurLoopTrapV=npCurLoopTrapV, npThermoTraps=npThermoTraps, npRelHumMemo=npRelHumMemo, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeStatus=npSmokeStatus, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumidity=npRelHumidity, npCurLoopR=npCurLoopR, npIoSinglePulseStart=npIoSinglePulseStart, npIoTraps=npIoTraps, npThermoTrapLow=npThermoTrapLow, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopStatus=npCurLoopStatus, npThermoTrapValue=npThermoTrapValue, npIr=npIr, npCurLoopEntry=npCurLoopEntry, npIoTrap=npIoTrap, npThermoMemo=npThermoMemo, npRelHumTempStatus=npRelHumTempStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoValuePrecise=npThermoValuePrecise, npThermoLow=npThermoLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmTraps=npGsmTraps, npCurLoop=npCurLoop, npIoLineN=npIoLineN, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsm=npGsm, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumValue=npRelHumValue, npCurLoopTrapI=npCurLoopTrapI, npSmokeSensorN=npSmokeSensorN, npResetStack=npResetStack, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTable=npThermoTable, npRelHumTrap=npRelHumTrap, npTrapInfo=npTrapInfo, npGsmRegistration=npGsmRegistration, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumEntry=npRelHumEntry, npIo=npIo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoLevelOut=npIoLevelOut, npRelay=npRelay, npIoTrapLineN=npIoTrapLineN, npThermo=npThermo, npSoftReboot=npSoftReboot, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoValue=npThermoValue, npSmoke=npSmoke, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTempValue=npRelHumTempValue, npRelHumTable=npRelHumTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoMemo=npIoMemo, npCurLoopPower=npCurLoopPower, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapMemo=npThermoTrapMemo, npIoEntry=npIoEntry, npIrStatus=npIrStatus, npRelHumTrapFail=npRelHumTrapFail, npIrCtrl=npIrCtrl, npGsmTrap=npGsmTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTable=npIoTable, npReboot=npReboot, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumN=npRelHumN, npCurLoopTrapN=npCurLoopTrapN, npRelayTable=npRelayTable, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTable=npSmokeTable, npThermoTrap=npThermoTrap, npIrPlayCmd=npIrPlayCmd, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoEntry=npThermoEntry, npGsmStrength=npGsmStrength)
