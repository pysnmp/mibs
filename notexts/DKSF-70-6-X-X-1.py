...
# Produced by pysmi-1.1.8 at Thu Feb  9 13:29:11 2023
...
TimeTicks, iso, Integer32, NotificationType, ModuleIdentity, enterprises, Gauge32, Unsigned32, MibIdentifier, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "Integer32", "NotificationType", "ModuleIdentity", "enterprises", "Gauge32", "Unsigned32", "MibIdentifier", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayN=npRelayN, npThermoTrapMemo=npThermoTrapMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeMemo=npSmokeMemo, npGsmTraps=npGsmTraps, lightcom=lightcom, npRelHumValue=npRelHumValue, npCurLoopEntry=npCurLoopEntry, npIrStatus=npIrStatus, npRelayMode=npRelayMode, npThermoValue=npThermoValue, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapStatus=npThermoTrapStatus, npGsmRegistration=npGsmRegistration, npRelayState=npRelayState, npCurLoopTrapR=npCurLoopTrapR, npSmokeEntry=npSmokeEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelay=npRelay, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTable=npIoTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrap=npRelHumTrap, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsm=npGsm, npThermoMemo=npThermoMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrPlayCmd=npIrPlayCmd, npRelHumidity=npRelHumidity, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopI=npCurLoopI, npThermoTrapValue=npThermoTrapValue, npCurLoopPower=npCurLoopPower, npCurLoopTable=npCurLoopTable, npThermo=npThermo, npIoTrapPrefix=npIoTrapPrefix, npThermoSensorN=npThermoSensorN, npIo=npIo, npRelHumEntry=npRelHumEntry, npRelHumTable=npRelHumTable, npIrReset=npIrReset, npIoLevelIn=npIoLevelIn, npCurLoopV=npCurLoopV, npResetStack=npResetStack, npThermoTrapHigh=npThermoTrapHigh, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmFailed=npGsmFailed, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTraps=npSmokeTraps, npSmokeSensorN=npSmokeSensorN, npCurLoopTrapN=npCurLoopTrapN, npIr=npIr, npThermoEntry=npThermoEntry, npThermoTrapLow=npThermoTrapLow, npGsmTrapPrefix=npGsmTrapPrefix, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLineN=npIoTrapLineN, npRelHumTempStatus=npRelHumTempStatus, npRelayTable=npRelayTable, npSoftReboot=npSoftReboot, npSmokeTrap=npSmokeTrap, npRelayStartReset=npRelayStartReset, npThermoTrap=npThermoTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoLevelOut=npIoLevelOut, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumN=npRelHumN, npRelHumTrapDataN=npRelHumTrapDataN, npIoEntry=npIoEntry, npThermoLow=npThermoLow, npGsmStrength=npGsmStrength, npRelHumTrapData=npRelHumTrapData, npSmokeStatus=npSmokeStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeReset=npSmokeReset, npIoTrap=npIoTrap, npRelHumMemo=npRelHumMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npTrapInfo=npTrapInfo, npCurLoopStatus=npCurLoopStatus, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayEntry=npRelayEntry, npIoLineN=npIoLineN, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapPower=npCurLoopTrapPower, npIoMemo=npIoMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmTrap=npGsmTrap, npCurLoopN=npCurLoopN, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npReboot=npReboot, npCurLoopTrap=npCurLoopTrap, npForcedReboot=npForcedReboot, npCurLoop=npCurLoop, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoHigh=npThermoHigh, npRelHumTrapFail=npRelHumTrapFail, npTrapEmailTo=npTrapEmailTo, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTable=npThermoTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTrapMemo=npSmokeTrapMemo, FixedPoint1000=FixedPoint1000, npIoTraps=npIoTraps, npCurLoopR=npCurLoopR, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTraps=npThermoTraps, npRelHumStatus=npRelHumStatus, npSmokePower=npSmokePower, npSmoke=npSmoke, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrCtrl=npIrCtrl, npRelHumTempValue=npRelHumTempValue, npSmokeTable=npSmokeTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelayMemo=npRelayMemo, npThermoStatus=npThermoStatus, npCurLoopTraps=npCurLoopTraps, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmInfo=npGsmInfo)
