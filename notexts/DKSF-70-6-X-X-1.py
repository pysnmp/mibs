...
# Produced by pysmi-1.1.8 at Mon Jan 17 22:11:45 2022
...
Integer32, Gauge32, MibIdentifier, TimeTicks, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, Counter32, Bits, Unsigned32, iso, enterprises, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "MibIdentifier", "TimeTicks", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "Counter32", "Bits", "Unsigned32", "iso", "enterprises", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeSensorN=npSmokeSensorN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopN=npCurLoopN, npCurLoopTrapI=npCurLoopTrapI, npSmokeEntry=npSmokeEntry, npIoMemo=npIoMemo, npRelayState=npRelayState, npRelHumTempValue=npRelHumTempValue, npRelHumEntry=npRelHumEntry, npThermoTrapLow=npThermoTrapLow, npRelHumTrapFail=npRelHumTrapFail, npRelHumTable=npRelHumTable, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrStatus=npIrStatus, npThermoLow=npThermoLow, npRelay=npRelay, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTraps=npIoTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npTrapEmailTo=npTrapEmailTo, npIoTrapPrefix=npIoTrapPrefix, npCurLoopI=npCurLoopI, npCurLoopEntry=npCurLoopEntry, npIoTrapMemo=npIoTrapMemo, npCurLoopTraps=npCurLoopTraps, npCurLoop=npCurLoop, npRelayEntry=npRelayEntry, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayN=npRelayN, npRelHumTrapTemp=npRelHumTrapTemp, FixedPoint1000=FixedPoint1000, npCurLoopR=npCurLoopR, npCurLoopTrapPower=npCurLoopTrapPower, npIrPlayCmd=npIrPlayCmd, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoSinglePulseDuration=npIoSinglePulseDuration, npIr=npIr, npThermoMemo=npThermoMemo, npIoLineN=npIoLineN, npThermoHigh=npThermoHigh, npForcedReboot=npForcedReboot, npThermoStatus=npThermoStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermo=npThermo, npSmokeTrapMemo=npSmokeTrapMemo, npIrCtrl=npIrCtrl, npIrReset=npIrReset, npRelHumTrap=npRelHumTrap, npRelayTable=npRelayTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmTraps=npGsmTraps, npTrapInfo=npTrapInfo, npSmokeTraps=npSmokeTraps, npCurLoopTrap=npCurLoopTrap, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, lightcom=lightcom, npThermoTrapValue=npThermoTrapValue, npSmoke=npSmoke, npGsmFailed=npGsmFailed, npRelayMemo=npRelayMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopPower=npCurLoopPower, npSmokeReset=npSmokeReset, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoEntry=npThermoEntry, npReboot=npReboot, npCurLoopTrapV=npCurLoopTrapV, npThermoValue=npThermoValue, npRelHumN=npRelHumN, npGsm=npGsm, npThermoValuePrecise=npThermoValuePrecise, npSoftReboot=npSoftReboot, npThermoTrapStatus=npThermoTrapStatus, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapHigh=npThermoTrapHigh, npIoLevelOut=npIoLevelOut, npRelHumTrapData=npRelHumTrapData, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapR=npCurLoopTrapR, npRelHumidity=npRelHumidity, npThermoTrap=npThermoTrap, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTable=npThermoTable, npThermoSensorN=npThermoSensorN, npGsmInfo=npGsmInfo, npIoTrapLineN=npIoTrapLineN, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopStatus=npCurLoopStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmTrap=npGsmTrap, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoPulseCounter=npIoPulseCounter, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeStatus=npSmokeStatus, npSmokeTable=npSmokeTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmRegistration=npGsmRegistration, npSmokeTrapStatus=npSmokeTrapStatus, npRelayStartReset=npRelayStartReset, npRelayMode=npRelayMode, npRelHumStatus=npRelHumStatus, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumValue=npRelHumValue, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrap=npIoTrap, npIoTable=npIoTable, npIo=npIo, npSmokeTrap=npSmokeTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTraps=npThermoTraps, npGsmStrength=npGsmStrength, npCurLoopTable=npCurLoopTable, npSmokeMemo=npSmokeMemo, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npResetStack=npResetStack, npCurLoopV=npCurLoopV, npSmokePower=npSmokePower, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoLevelIn=npIoLevelIn, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumMemo=npRelHumMemo, npIoEntry=npIoEntry, npRelHumTrapAllChannels=npRelHumTrapAllChannels)
