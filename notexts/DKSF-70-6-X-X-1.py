...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoSinglePulseStart=npIoSinglePulseStart, npIoLevelOut=npIoLevelOut, npRelayN=npRelayN, npThermoValuePrecise=npThermoValuePrecise, npRelHumTempValue=npRelHumTempValue, npIrCtrl=npIrCtrl, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeReset=npSmokeReset, npCurLoop=npCurLoop, npRelHumTrap=npRelHumTrap, npTrapEmailTo=npTrapEmailTo, npRelHumMemo=npRelHumMemo, npRelHumTempStatus=npRelHumTempStatus, npCurLoopN=npCurLoopN, npRelHumEntry=npRelHumEntry, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapMemo=npThermoTrapMemo, npReboot=npReboot, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTrap=npSmokeTrap, npSmokeTable=npSmokeTable, npIrReset=npIrReset, npIoTrapPrefix=npIoTrapPrefix, npSmokeTraps=npSmokeTraps, npGsmInfo=npGsmInfo, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopPower=npCurLoopPower, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapSensorN=npThermoTrapSensorN, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrap=npIoTrap, npGsmRegistration=npGsmRegistration, npSmoke=npSmoke, npRelHumidity=npRelHumidity, npRelayEntry=npRelayEntry, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoLevelIn=npIoLevelIn, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayMemo=npRelayMemo, npSmokeTrapStatus=npSmokeTrapStatus, npRelayStartReset=npRelayStartReset, npCurLoopV=npCurLoopV, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoMemo=npThermoMemo, npIoTrapLineN=npIoTrapLineN, npSmokeMemo=npSmokeMemo, npCurLoopTraps=npCurLoopTraps, npIo=npIo, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapN=npCurLoopTrapN, npRelayMode=npRelayMode, lightcom=lightcom, npRelHumTable=npRelHumTable, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTable=npThermoTable, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempSafe=npRelHumTrapTempSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrap=npThermoTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayState=npRelayState, npSmokePower=npSmokePower, npCurLoopEntry=npCurLoopEntry, npThermoHigh=npThermoHigh, npThermoValue=npThermoValue, npCurLoopTable=npCurLoopTable, npGsmTrap=npGsmTrap, npIoTrapMemo=npIoTrapMemo, npGsmFailed=npGsmFailed, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTraps=npThermoTraps, npIoMemo=npIoMemo, npCurLoopTrapI=npCurLoopTrapI, npSmokeEntry=npSmokeEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapValue=npThermoTrapValue, npRelHumTrapSafe=npRelHumTrapSafe, npForcedReboot=npForcedReboot, npRelHumN=npRelHumN, npIoLineN=npIoLineN, npIoTraps=npIoTraps, npRelHumValue=npRelHumValue, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npTrapInfo=npTrapInfo, npSmokeTrapMemo=npSmokeTrapMemo, npResetStack=npResetStack, npGsmStrength=npGsmStrength, npIoTable=npIoTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoSensorN=npThermoSensorN, npIoEntry=npIoEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoPulseCounter=npIoPulseCounter, npSmokeStatus=npSmokeStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIr=npIr, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSoftReboot=npSoftReboot, npRelHumTrapFail=npRelHumTrapFail, npCurLoopR=npCurLoopR, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopStatus=npCurLoopStatus, npGsm=npGsm, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, FixedPoint1000=FixedPoint1000, npRelHumTrapTempFail=npRelHumTrapTempFail, npIrStatus=npIrStatus, npIrPlayCmd=npIrPlayCmd, npThermoEntry=npThermoEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapLow=npThermoTrapLow, npGsmTraps=npGsmTraps, npRelay=npRelay, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumStatus=npRelHumStatus, npThermo=npThermo, npThermoStatus=npThermoStatus, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapV=npCurLoopTrapV, npCurLoopI=npCurLoopI, npThermoLow=npThermoLow, npCurLoopTrap=npCurLoopTrap, npRelayTable=npRelayTable)
