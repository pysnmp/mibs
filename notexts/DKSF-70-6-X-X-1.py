...
# Produced by pysmi-1.1.8 at Tue Jul 26 16:46:41 2022
...
Gauge32, Counter32, MibIdentifier, enterprises, iso, ObjectIdentity, Unsigned32, IpAddress, Integer32, TimeTicks, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "MibIdentifier", "enterprises", "iso", "ObjectIdentity", "Unsigned32", "IpAddress", "Integer32", "TimeTicks", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTraps=npSmokeTraps, npIrStatus=npIrStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumValue=npRelHumValue, npRelHumTrapSafe=npRelHumTrapSafe, npTrapEmailTo=npTrapEmailTo, npThermoMemo=npThermoMemo, npRelayState=npRelayState, npThermoTable=npThermoTable, npSmokeTrap=npSmokeTrap, npCurLoopStatus=npCurLoopStatus, npRelay=npRelay, npThermoTrap=npThermoTrap, npRelayMemo=npRelayMemo, npIoTraps=npIoTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumN=npRelHumN, npThermoTrapValue=npThermoTrapValue, npRelHumTrapFail=npRelHumTrapFail, npCurLoopV=npCurLoopV, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoEntry=npIoEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npResetStack=npResetStack, npIoTrapMemo=npIoTrapMemo, npThermoTrapSensorN=npThermoTrapSensorN, FixedPoint1000=FixedPoint1000, npIoLevelOut=npIoLevelOut, npIoTrapPrefix=npIoTrapPrefix, npCurLoopPower=npCurLoopPower, lightcom=lightcom, npSmoke=npSmoke, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTempValue=npRelHumTempValue, npCurLoopR=npCurLoopR, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmRegistration=npGsmRegistration, npSmokePower=npSmokePower, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoLevelIn=npIoLevelIn, npThermoTrapMemo=npThermoTrapMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTable=npIoTable, npCurLoopTrapV=npCurLoopTrapV, npRelHumMemo=npRelHumMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npForcedReboot=npForcedReboot, npRelayStartReset=npRelayStartReset, npIoTrapLineN=npIoTrapLineN, npCurLoopTrap=npCurLoopTrap, npReboot=npReboot, npSmokeMemo=npSmokeMemo, npThermoTraps=npThermoTraps, npRelHumStatus=npRelHumStatus, npSoftReboot=npSoftReboot, npRelayEntry=npRelayEntry, npCurLoopEntry=npCurLoopEntry, npGsm=npGsm, npRelHumidity=npRelHumidity, npThermoStatus=npThermoStatus, npIoTrap=npIoTrap, npThermoValue=npThermoValue, npRelayTable=npRelayTable, npSmokeStatus=npSmokeStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTable=npRelHumTable, npCurLoopTrapI=npCurLoopTrapI, npGsmTrapPrefix=npGsmTrapPrefix, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTable=npCurLoopTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmFailed=npGsmFailed, npThermoTrapLow=npThermoTrapLow, npThermoTrapHigh=npThermoTrapHigh, npThermoEntry=npThermoEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopI=npCurLoopI, npIr=npIr, npCurLoopTrapPower=npCurLoopTrapPower, npIoTrapLevelIn=npIoTrapLevelIn, npThermo=npThermo, npCurLoopTraps=npCurLoopTraps, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoMemo=npIoMemo, npCurLoopN=npCurLoopN, npSmokeTrapSensorN=npSmokeTrapSensorN, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapStatus=npThermoTrapStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapData=npRelHumTrapData, npGsmInfo=npGsmInfo, npRelHumEntry=npRelHumEntry, npThermoLow=npThermoLow, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoHigh=npThermoHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeSensorN=npSmokeSensorN, npGsmStrength=npGsmStrength, npIoPulseCounter=npIoPulseCounter, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoLineN=npIoLineN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapN=npCurLoopTrapN, npSmokeReset=npSmokeReset, npRelayMode=npRelayMode, npRelHumTrap=npRelHumTrap, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapPrefix=npThermoTrapPrefix, npThermoValuePrecise=npThermoValuePrecise, npRelayN=npRelayN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmTraps=npGsmTraps, npRelHumTrapDataN=npRelHumTrapDataN, npIrCtrl=npIrCtrl, npGsmTrap=npGsmTrap, npThermoSensorN=npThermoSensorN, npIo=npIo, npIrReset=npIrReset, npSmokeEntry=npSmokeEntry, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npTrapInfo=npTrapInfo, npIoTrapLevelLegend=npIoTrapLevelLegend, npIrPlayCmd=npIrPlayCmd, npCurLoop=npCurLoop, npSmokeTable=npSmokeTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapR=npCurLoopTrapR)
