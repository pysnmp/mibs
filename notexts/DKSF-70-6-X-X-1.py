...
# Produced by pysmi-1.1.8 at Wed Oct 11 08:37:36 2023
...
ModuleIdentity, Gauge32, enterprises, iso, Bits, TimeTicks, Unsigned32, IpAddress, NotificationType, ObjectIdentity, MibIdentifier, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "enterprises", "iso", "Bits", "TimeTicks", "Unsigned32", "IpAddress", "NotificationType", "ObjectIdentity", "MibIdentifier", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoSensorN=npThermoSensorN, npThermoValue=npThermoValue, npRelHumidity=npRelHumidity, npGsmTraps=npGsmTraps, npRelHumValue=npRelHumValue, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmoke=npSmoke, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSoftReboot=npSoftReboot, npThermoTrapValue=npThermoTrapValue, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapV=npCurLoopTrapV, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopN=npCurLoopN, npIoLevelIn=npIoLevelIn, npCurLoopTrapR=npCurLoopTrapR, lightcom=lightcom, npRelayEntry=npRelayEntry, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoEntry=npIoEntry, npIoTrapLineN=npIoTrapLineN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npTrapInfo=npTrapInfo, npRelHumTrap=npRelHumTrap, npCurLoopTrapPower=npCurLoopTrapPower, npIoLineN=npIoLineN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopPower=npCurLoopPower, npRelayN=npRelayN, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayMemo=npRelayMemo, npGsmStrength=npGsmStrength, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeReset=npSmokeReset, npIoTrapMemo=npIoTrapMemo, npCurLoopR=npCurLoopR, npThermoTrap=npThermoTrap, npGsmFailed=npGsmFailed, npIoMemo=npIoMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopEntry=npCurLoopEntry, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTempValue=npRelHumTempValue, npSmokePower=npSmokePower, npThermoMemo=npThermoMemo, npRelHumEntry=npRelHumEntry, npRelHumTrapData=npRelHumTrapData, npSmokeTable=npSmokeTable, npIoLevelOut=npIoLevelOut, npCurLoopTable=npCurLoopTable, npThermoStatus=npThermoStatus, npCurLoopV=npCurLoopV, npReboot=npReboot, npThermoEntry=npThermoEntry, npIoTrapPrefix=npIoTrapPrefix, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTable=npThermoTable, FixedPoint1000=FixedPoint1000, npIoTraps=npIoTraps, npCurLoop=npCurLoop, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTraps=npSmokeTraps, npRelHumTrapDataN=npRelHumTrapDataN, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapFail=npRelHumTrapFail, npIr=npIr, npTrapEmailTo=npTrapEmailTo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmRegistration=npGsmRegistration, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapI=npCurLoopTrapI, npIrReset=npIrReset, npThermoTraps=npThermoTraps, npCurLoopTraps=npCurLoopTraps, npIrCtrl=npIrCtrl, npSmokeTrap=npSmokeTrap, npIoTable=npIoTable, npForcedReboot=npForcedReboot, npRelayMode=npRelayMode, npIo=npIo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeStatus=npSmokeStatus, npGsmInfo=npGsmInfo, npThermoTrapHigh=npThermoTrapHigh, npGsmTrap=npGsmTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIrPlayCmd=npIrPlayCmd, npSmokeSensorN=npSmokeSensorN, npCurLoopTrapN=npCurLoopTrapN, npRelayTable=npRelayTable, npThermoHigh=npThermoHigh, npThermoTrapLow=npThermoTrapLow, npCurLoopTrap=npCurLoopTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npIrStatus=npIrStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeEntry=npSmokeEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsm=npGsm, npThermoLow=npThermoLow, npThermoTrapStatus=npThermoTrapStatus, npIoTrap=npIoTrap, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeMemo=npSmokeMemo, npThermo=npThermo, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumN=npRelHumN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelay=npRelay, npRelayStartReset=npRelayStartReset, npRelHumTrapSafe=npRelHumTrapSafe, npResetStack=npResetStack, npCurLoopI=npCurLoopI, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoValuePrecise=npThermoValuePrecise, npRelHumTable=npRelHumTable, npRelayState=npRelayState, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoPulseCounter=npIoPulseCounter, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumMemo=npRelHumMemo, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumStatus=npRelHumStatus)
