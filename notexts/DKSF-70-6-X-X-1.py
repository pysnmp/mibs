...
ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, MibIdentifier, Gauge32, IpAddress, Counter32, iso, Integer32, ModuleIdentity, Bits, TimeTicks, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "MibIdentifier", "Gauge32", "IpAddress", "Counter32", "iso", "Integer32", "ModuleIdentity", "Bits", "TimeTicks", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopR=npCurLoopR, npSmokeTrapMemo=npSmokeTrapMemo, npIoLineN=npIoLineN, npIrStatus=npIrStatus, npRelHumEntry=npRelHumEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokePower=npSmokePower, npForcedReboot=npForcedReboot, npRelHumValue=npRelHumValue, npThermoMemo=npThermoMemo, npThermoTrapValue=npThermoTrapValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, FixedPoint1000=FixedPoint1000, npGsmTrap=npGsmTrap, npCurLoopPower=npCurLoopPower, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapStatus=npThermoTrapStatus, npIr=npIr, npGsmTraps=npGsmTraps, npRelay=npRelay, npCurLoop=npCurLoop, npResetStack=npResetStack, npRelHumTable=npRelHumTable, npRelayN=npRelayN, npTrapInfo=npTrapInfo, npGsmStrength=npGsmStrength, npRelayEntry=npRelayEntry, npRelHumidity=npRelHumidity, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoMemo=npIoMemo, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTraps=npIoTraps, npCurLoopN=npCurLoopN, npRelayStartReset=npRelayStartReset, npIoTable=npIoTable, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayMemo=npRelayMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayMode=npRelayMode, npIoLevelIn=npIoLevelIn, npCurLoopTrap=npCurLoopTrap, npCurLoopV=npCurLoopV, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoPulseCounter=npIoPulseCounter, npThermo=npThermo, npRelHumTempValue=npRelHumTempValue, npRelayTable=npRelayTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeSensorN=npSmokeSensorN, npTrapEmailTo=npTrapEmailTo, npRelHumTrap=npRelHumTrap, npRelayState=npRelayState, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTable=npCurLoopTable, npSmoke=npSmoke, npGsmRegistration=npGsmRegistration, npIoTrap=npIoTrap, lightcom=lightcom, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTraps=npThermoTraps, npIoLevelOut=npIoLevelOut, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoEntry=npThermoEntry, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapLow=npThermoTrapLow, npSmokeTrapPrefix=npSmokeTrapPrefix, npSoftReboot=npSoftReboot, npCurLoopI=npCurLoopI, npThermoValue=npThermoValue, npIoTrapMemo=npIoTrapMemo, npIrCtrl=npIrCtrl, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmInfo=npGsmInfo, npRelHumTrapDataValue=npRelHumTrapDataValue, npIo=npIo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrapStatus=npSmokeTrapStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapMemo=npThermoTrapMemo, npThermoHigh=npThermoHigh, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTable=npThermoTable, npGsm=npGsm, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIrReset=npIrReset, npThermoStatus=npThermoStatus, npSmokeStatus=npSmokeStatus, npIoTrapLineN=npIoTrapLineN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoLow=npThermoLow, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumN=npRelHumN, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapSensorN=npThermoTrapSensorN, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopStatus=npCurLoopStatus, npSmokeTable=npSmokeTable, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmFailed=npGsmFailed, npThermoTrap=npThermoTrap, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapData=npRelHumTrapData, npRelHumMemo=npRelHumMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeTraps=npSmokeTraps, npSmokeTrap=npSmokeTrap, npCurLoopTrapN=npCurLoopTrapN, npRelHumStatus=npRelHumStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapV=npCurLoopTrapV, npSmokeMemo=npSmokeMemo, npReboot=npReboot, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeReset=npSmokeReset, npGsmTrapPrefix=npGsmTrapPrefix, npThermoSensorN=npThermoSensorN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoEntry=npIoEntry, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeEntry=npSmokeEntry)
