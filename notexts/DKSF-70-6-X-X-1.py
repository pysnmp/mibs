...
# Produced by pysmi-1.1.3 at Sun Nov 28 19:24:20 2021
...
enterprises, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, iso, Counter64, TimeTicks, NotificationType, Bits, Unsigned32, Integer32, Counter32, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "iso", "Counter64", "TimeTicks", "NotificationType", "Bits", "Unsigned32", "Integer32", "Counter32", "ObjectIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIrReset=npIrReset, npRelHumTempValue=npRelHumTempValue, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npRelayEntry=npRelayEntry, npRelHumValue=npRelHumValue, npThermoHigh=npThermoHigh, npCurLoopI=npCurLoopI, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapPower=npCurLoopTrapPower, npIoTrap=npIoTrap, npThermoTrapMemo=npThermoTrapMemo, npGsmInfo=npGsmInfo, npRelHumTrapFail=npRelHumTrapFail, npRelayMemo=npRelayMemo, npRelHumTable=npRelHumTable, npThermoMemo=npThermoMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoop=npCurLoop, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeMemo=npSmokeMemo, npIrStatus=npIrStatus, npRelHumStatus=npRelHumStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npIrPlayCmd=npIrPlayCmd, npThermoTrapHigh=npThermoTrapHigh, npIoLevelIn=npIoLevelIn, npCurLoopTable=npCurLoopTable, npSmokePower=npSmokePower, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayTable=npRelayTable, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapValue=npThermoTrapValue, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoMemo=npIoMemo, npCurLoopV=npCurLoopV, npThermoTable=npThermoTable, npThermoTrapPrefix=npThermoTrapPrefix, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermo=npThermo, npIoTraps=npIoTraps, npThermoStatus=npThermoStatus, npIoTrapLineN=npIoTrapLineN, npIoTrapMemo=npIoTrapMemo, npIoEntry=npIoEntry, npRelayState=npRelayState, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoValue=npThermoValue, lightcom=lightcom, npCurLoopR=npCurLoopR, npThermoTraps=npThermoTraps, npCurLoopEntry=npCurLoopEntry, npSmoke=npSmoke, npCurLoopTrapN=npCurLoopTrapN, npRelayStartReset=npRelayStartReset, npForcedReboot=npForcedReboot, npIr=npIr, npResetStack=npResetStack, npCurLoopN=npCurLoopN, npRelHumEntry=npRelHumEntry, npCurLoopTraps=npCurLoopTraps, npGsmTrap=npGsmTrap, npRelHumidity=npRelHumidity, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmStrength=npGsmStrength, npSmokeTrapMemo=npSmokeTrapMemo, npSoftReboot=npSoftReboot, npThermoEntry=npThermoEntry, npSmokeSensorN=npSmokeSensorN, npSmokeTrap=npSmokeTrap, npCurLoopTrap=npCurLoopTrap, npReboot=npReboot, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIrCtrl=npIrCtrl, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrap=npRelHumTrap, npIo=npIo, npRelHumMemo=npRelHumMemo, npIoSinglePulseStart=npIoSinglePulseStart, npTrapInfo=npTrapInfo, npCurLoopTrapR=npCurLoopTrapR, npThermoValuePrecise=npThermoValuePrecise, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoPulseCounter=npIoPulseCounter, npIoTable=npIoTable, npRelayN=npRelayN, npCurLoopStatus=npCurLoopStatus, npSmokeEntry=npSmokeEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsm=npGsm, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npTrapEmailTo=npTrapEmailTo, npThermoTrapLow=npThermoTrapLow, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumN=npRelHumN, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTable=npSmokeTable, FixedPoint1000=FixedPoint1000, npIoLevelOut=npIoLevelOut, npThermoSensorN=npThermoSensorN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapV=npCurLoopTrapV, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npIoLineN=npIoLineN, npThermoTrap=npThermoTrap, npRelHumTrapDataN=npRelHumTrapDataN, npRelay=npRelay, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopPower=npCurLoopPower, npThermoLow=npThermoLow, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTempStatus=npRelHumTempStatus, npSmokeTraps=npSmokeTraps, npGsmFailed=npGsmFailed, npSmokeStatus=npSmokeStatus, npSmokeReset=npSmokeReset, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmRegistration=npGsmRegistration, npGsmTraps=npGsmTraps, npRelayMode=npRelayMode)
