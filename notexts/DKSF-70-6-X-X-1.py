...
# Produced by pysmi-1.1.3 at Sun Nov 28 13:54:43 2021
...
TimeTicks, Unsigned32, enterprises, Counter64, Integer32, ModuleIdentity, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, NotificationType, Bits, Gauge32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "enterprises", "Counter64", "Integer32", "ModuleIdentity", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "NotificationType", "Bits", "Gauge32", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTable=npSmokeTable, npIoEntry=npIoEntry, npGsmTrap=npGsmTrap, npCurLoopR=npCurLoopR, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumMemo=npRelHumMemo, npCurLoopV=npCurLoopV, npRelHumValue=npRelHumValue, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoPulseCounter=npIoPulseCounter, npSoftReboot=npSoftReboot, npRelHumTrapData=npRelHumTrapData, npThermoTrapStatus=npThermoTrapStatus, npThermoTraps=npThermoTraps, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapI=npCurLoopTrapI, npThermoTable=npThermoTable, npIoTrap=npIoTrap, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTempValue=npRelHumTempValue, npSmokeTraps=npSmokeTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumidity=npRelHumidity, npIo=npIo, npRelHumN=npRelHumN, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopStatus=npCurLoopStatus, npRelHumTable=npRelHumTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeMemo=npSmokeMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmTraps=npGsmTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrap=npRelHumTrap, npThermo=npThermo, npGsmTrapPrefix=npGsmTrapPrefix, npIoMemo=npIoMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npIr=npIr, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapV=npCurLoopTrapV, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayN=npRelayN, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoSensorN=npThermoSensorN, npSmoke=npSmoke, npSmokeEntry=npSmokeEntry, npGsm=npGsm, npIrReset=npIrReset, npRelayMode=npRelayMode, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrap=npSmokeTrap, npCurLoopTrapR=npCurLoopTrapR, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrCtrl=npIrCtrl, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapFail=npRelHumTrapFail, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrap=npCurLoopTrap, npSmokePower=npSmokePower, npTrapEmailTo=npTrapEmailTo, npThermoTrapHigh=npThermoTrapHigh, npCurLoop=npCurLoop, npThermoEntry=npThermoEntry, npCurLoopPower=npCurLoopPower, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopN=npCurLoopN, npRelay=npRelay, npRelayState=npRelayState, npGsmInfo=npGsmInfo, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoStatus=npThermoStatus, npCurLoopEntry=npCurLoopEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrapPrefix=npIoTrapPrefix, npGsmRegistration=npGsmRegistration, npIrStatus=npIrStatus, npSmokeStatus=npSmokeStatus, lightcom=lightcom, npGsmFailed=npGsmFailed, npIoLevelOut=npIoLevelOut, npRelHumStatus=npRelHumStatus, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npReboot=npReboot, npRelayEntry=npRelayEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrap=npThermoTrap, npRelHumTrapSafe=npRelHumTrapSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTable=npCurLoopTable, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoLevelIn=npIoLevelIn, npThermoTrapSensorN=npThermoTrapSensorN, npRelayTable=npRelayTable, npSmokeSensorN=npSmokeSensorN, npSmokeTrapStatus=npSmokeTrapStatus, npForcedReboot=npForcedReboot, npSmokeReset=npSmokeReset, npThermoMemo=npThermoMemo, npIrPlayCmd=npIrPlayCmd, npIoTrapLineN=npIoTrapLineN, npRelHumEntry=npRelHumEntry, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrapMemo=npIoTrapMemo, npResetStack=npResetStack, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayMemo=npRelayMemo, npIoLineN=npIoLineN, npCurLoopI=npCurLoopI, FixedPoint1000=FixedPoint1000, npRelayStartReset=npRelayStartReset, npThermoHigh=npThermoHigh, npGsmStrength=npGsmStrength, npTrapInfo=npTrapInfo, npIoTraps=npIoTraps, npIoTable=npIoTable, npThermoValue=npThermoValue, npThermoLow=npThermoLow, npRelHumTrapAllChannels=npRelHumTrapAllChannels)
