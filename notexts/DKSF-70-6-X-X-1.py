...
Bits, Counter64, iso, Integer32, IpAddress, Unsigned32, TimeTicks, MibIdentifier, ObjectIdentity, enterprises, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "iso", "Integer32", "IpAddress", "Unsigned32", "TimeTicks", "MibIdentifier", "ObjectIdentity", "enterprises", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapHigh=npThermoTrapHigh, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTable=npCurLoopTable, npSmoke=npSmoke, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTemp=npRelHumTrapTemp, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeTraps=npSmokeTraps, npSmokeEntry=npSmokeEntry, npRelayMode=npRelayMode, npRelHumTrapData=npRelHumTrapData, npIoPulseCounter=npIoPulseCounter, npThermoTrapStatus=npThermoTrapStatus, npGsmTrapPrefix=npGsmTrapPrefix, npGsmInfo=npGsmInfo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeStatus=npSmokeStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumidity=npRelHumidity, npSoftReboot=npSoftReboot, npGsmRegistration=npGsmRegistration, npIoTrapLevelIn=npIoTrapLevelIn, npRelayEntry=npRelayEntry, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrap=npThermoTrap, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrapLineN=npIoTrapLineN, npCurLoopEntry=npCurLoopEntry, npIoMemo=npIoMemo, npThermoTrapLow=npThermoTrapLow, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapI=npCurLoopTrapI, npSmokePower=npSmokePower, npIrPlayCmd=npIrPlayCmd, npThermoHigh=npThermoHigh, npCurLoopPower=npCurLoopPower, npIoEntry=npIoEntry, npRelHumTempValue=npRelHumTempValue, npReboot=npReboot, npThermoValuePrecise=npThermoValuePrecise, npCurLoopN=npCurLoopN, npGsmFailed=npGsmFailed, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTrap=npSmokeTrap, npIrCtrl=npIrCtrl, npRelHumTable=npRelHumTable, npCurLoopTraps=npCurLoopTraps, npSmokeTrapMemo=npSmokeTrapMemo, lightcom=lightcom, npIoLevelOut=npIoLevelOut, npIo=npIo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumValue=npRelHumValue, npRelayStartReset=npRelayStartReset, npGsmStrength=npGsmStrength, npSmokeTable=npSmokeTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopV=npCurLoopV, npThermoLow=npThermoLow, uniPingServerSolutionV3=uniPingServerSolutionV3, npIrReset=npIrReset, npThermoStatus=npThermoStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoValue=npThermoValue, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTrapPrefix=npSmokeTrapPrefix, FixedPoint1000=FixedPoint1000, npRelHumN=npRelHumN, npIr=npIr, npThermoTraps=npThermoTraps, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrap=npIoTrap, npRelayMemo=npRelayMemo, npForcedReboot=npForcedReboot, npThermo=npThermo, npRelayN=npRelayN, npIoTraps=npIoTraps, npThermoTrapSensorN=npThermoTrapSensorN, npGsmTraps=npGsmTraps, npCurLoopI=npCurLoopI, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapN=npCurLoopTrapN, npCurLoop=npCurLoop, npTrapEmailTo=npTrapEmailTo, npThermoMemo=npThermoMemo, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapR=npCurLoopTrapR, npThermoEntry=npThermoEntry, npCurLoopStatus=npCurLoopStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npResetStack=npResetStack, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrapPrefix=npIoTrapPrefix, npRelHumMemo=npRelHumMemo, npIoLineN=npIoLineN, npCurLoopR=npCurLoopR, npThermoTable=npThermoTable, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrap=npCurLoopTrap, npIoTable=npIoTable, npRelHumTrapFail=npRelHumTrapFail, npRelayTable=npRelayTable, npRelayState=npRelayState, npRelay=npRelay, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrap=npRelHumTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapV=npCurLoopTrapV, npRelHumStatus=npRelHumStatus, npThermoTrapValue=npThermoTrapValue, npRelHumTrapTempFail=npRelHumTrapTempFail, npIrStatus=npIrStatus, npThermoSensorN=npThermoSensorN, npIoLevelIn=npIoLevelIn, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsm=npGsm, npSmokeReset=npSmokeReset, npGsmTrap=npGsmTrap, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumEntry=npRelHumEntry, npTrapInfo=npTrapInfo, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeMemo=npSmokeMemo)
