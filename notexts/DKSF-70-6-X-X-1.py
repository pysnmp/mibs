...
enterprises, Counter64, Bits, Gauge32, IpAddress, MibIdentifier, Integer32, Counter32, ModuleIdentity, NotificationType, ObjectIdentity, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter64", "Bits", "Gauge32", "IpAddress", "MibIdentifier", "Integer32", "Counter32", "ModuleIdentity", "NotificationType", "ObjectIdentity", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataN=npRelHumTrapDataN, lightcom=lightcom, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoPulseCounter=npIoPulseCounter, npIoMemo=npIoMemo, npIoTable=npIoTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTable=npSmokeTable, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelay=npRelay, npRelHumN=npRelHumN, npCurLoopTraps=npCurLoopTraps, npGsmFailed=npGsmFailed, npCurLoopTrapR=npCurLoopTrapR, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoStatus=npThermoStatus, npSmokeTrap=npSmokeTrap, npRelHumEntry=npRelHumEntry, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapStatus=npThermoTrapStatus, npIoTrapMemo=npIoTrapMemo, npCurLoop=npCurLoop, npIoTraps=npIoTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmRegistration=npGsmRegistration, npIrStatus=npIrStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrPlayCmd=npIrPlayCmd, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrapLevelIn=npIoTrapLevelIn, npRelayMemo=npRelayMemo, npCurLoopEntry=npCurLoopEntry, npRelayMode=npRelayMode, npRelHumMemo=npRelHumMemo, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmInfo=npGsmInfo, FixedPoint1000=FixedPoint1000, npThermoTrapPrefix=npThermoTrapPrefix, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopV=npCurLoopV, npThermoTrapValue=npThermoTrapValue, npSmokePower=npSmokePower, npThermoTrapMemo=npThermoTrapMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeMemo=npSmokeMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrap=npIoTrap, npRelHumValue=npRelHumValue, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIo=npIo, npSoftReboot=npSoftReboot, npIoEntry=npIoEntry, npTrapInfo=npTrapInfo, npIoTrapLineN=npIoTrapLineN, npThermoTrapHigh=npThermoTrapHigh, npTrapEmailTo=npTrapEmailTo, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmTraps=npGsmTraps, npCurLoopStatus=npCurLoopStatus, npIrReset=npIrReset, npRelHumTable=npRelHumTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTable=npCurLoopTable, npResetStack=npResetStack, npSmoke=npSmoke, npRelHumTrapTemp=npRelHumTrapTemp, npGsm=npGsm, npThermoValuePrecise=npThermoValuePrecise, npRelHumStatus=npRelHumStatus, npCurLoopPower=npCurLoopPower, npIr=npIr, npThermoLow=npThermoLow, npThermoValue=npThermoValue, npRelayState=npRelayState, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayEntry=npRelayEntry, npRelHumTrapData=npRelHumTrapData, npThermoHigh=npThermoHigh, npForcedReboot=npForcedReboot, npCurLoopTrapPower=npCurLoopTrapPower, npGsmStrength=npGsmStrength, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermo=npThermo, npThermoTraps=npThermoTraps, npThermoTable=npThermoTable, npRelayStartReset=npRelayStartReset, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeEntry=npSmokeEntry, npThermoMemo=npThermoMemo, npCurLoopTrapN=npCurLoopTrapN, npSmokeTraps=npSmokeTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrap=npThermoTrap, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopI=npCurLoopI, npCurLoopR=npCurLoopR, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapLow=npThermoTrapLow, npRelHumTrap=npRelHumTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npReboot=npReboot, npSmokeStatus=npSmokeStatus, npIoLevelOut=npIoLevelOut, npSmokeSensorN=npSmokeSensorN, npRelayN=npRelayN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrap=npCurLoopTrap, npRelHumidity=npRelHumidity, npIoLineN=npIoLineN, npSmokeReset=npSmokeReset, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopN=npCurLoopN, npIrCtrl=npIrCtrl, npGsmTrap=npGsmTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayTable=npRelayTable, npThermoEntry=npThermoEntry, npThermoSensorN=npThermoSensorN, npIoLevelIn=npIoLevelIn, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapI=npCurLoopTrapI)
