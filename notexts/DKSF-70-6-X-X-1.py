...
# Produced by pysmi-1.1.8 at Tue Sep 12 07:29:53 2023
...
ModuleIdentity, Counter32, iso, IpAddress, Integer32, TimeTicks, Bits, ObjectIdentity, Gauge32, NotificationType, Counter64, Unsigned32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "iso", "IpAddress", "Integer32", "TimeTicks", "Bits", "ObjectIdentity", "Gauge32", "NotificationType", "Counter64", "Unsigned32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTraps=npCurLoopTraps, npThermoTrapHigh=npThermoTrapHigh, npCurLoopPower=npCurLoopPower, npSmokePower=npSmokePower, npCurLoopStatus=npCurLoopStatus, npRelHumTrapData=npRelHumTrapData, npSmokeTrapSensorN=npSmokeTrapSensorN, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmoke=npSmoke, npSmokeMemo=npSmokeMemo, npIoTraps=npIoTraps, npThermoHigh=npThermoHigh, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayStartReset=npRelayStartReset, npGsmTrapPrefix=npGsmTrapPrefix, npGsmTraps=npGsmTraps, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapFail=npRelHumTrapFail, npRelHumidity=npRelHumidity, npRelHumTable=npRelHumTable, npRelHumEntry=npRelHumEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSoftReboot=npSoftReboot, npRelHumTrap=npRelHumTrap, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTempStatus=npRelHumTempStatus, FixedPoint1000=FixedPoint1000, npGsmFailed=npGsmFailed, npRelayMemo=npRelayMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeStatus=npSmokeStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapV=npCurLoopTrapV, npRelHumValue=npRelHumValue, npIrReset=npIrReset, npRelayMode=npRelayMode, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoStatus=npThermoStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopI=npCurLoopI, npCurLoopTrapR=npCurLoopTrapR, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTable=npSmokeTable, npGsm=npGsm, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumMemo=npRelHumMemo, npIoTrap=npIoTrap, npSmokeTrap=npSmokeTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayState=npRelayState, npThermoLow=npThermoLow, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIr=npIr, npRelHumTempValue=npRelHumTempValue, npThermoValue=npThermoValue, npThermoMemo=npThermoMemo, npThermoTrapValue=npThermoTrapValue, npIoTrapLineN=npIoTrapLineN, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoop=npCurLoop, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoSensorN=npThermoSensorN, npIoPulseCounter=npIoPulseCounter, npGsmStrength=npGsmStrength, npSmokeTrapMemo=npSmokeTrapMemo, npIrPlayCmd=npIrPlayCmd, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmRegistration=npGsmRegistration, npSmokeTraps=npSmokeTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoEntry=npThermoEntry, npSmokeReset=npSmokeReset, npRelayEntry=npRelayEntry, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoLevelOut=npIoLevelOut, npThermoTable=npThermoTable, npIoEntry=npIoEntry, npThermoTrapLow=npThermoTrapLow, npForcedReboot=npForcedReboot, npCurLoopEntry=npCurLoopEntry, npCurLoopTrap=npCurLoopTrap, npReboot=npReboot, npGsmTrap=npGsmTrap, npSmokeSensorN=npSmokeSensorN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayN=npRelayN, npSmokeEntry=npSmokeEntry, npIoMemo=npIoMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelayTable=npRelayTable, npThermoTrap=npThermoTrap, npCurLoopN=npCurLoopN, npIrCtrl=npIrCtrl, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopV=npCurLoopV, npIoTable=npIoTable, npResetStack=npResetStack, npIoLevelIn=npIoLevelIn, npGsmInfo=npGsmInfo, npIoLineN=npIoLineN, npCurLoopR=npCurLoopR, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTraps=npThermoTraps, npIo=npIo, npThermo=npThermo, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumStatus=npRelHumStatus, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataN=npRelHumTrapDataN, lightcom=lightcom, npTrapInfo=npTrapInfo, npRelay=npRelay, npCurLoopTrapI=npCurLoopTrapI, npRelHumN=npRelHumN, npThermoValuePrecise=npThermoValuePrecise, npIrStatus=npIrStatus, npCurLoopTable=npCurLoopTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe)
