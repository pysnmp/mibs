...
# Produced by pysmi-1.1.12 at Wed Jul  3 09:59:20 2024
...
enterprises, ObjectIdentity, Unsigned32, Bits, NotificationType, Counter64, Counter32, Integer32, ModuleIdentity, Gauge32, TimeTicks, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ObjectIdentity", "Unsigned32", "Bits", "NotificationType", "Counter64", "Counter32", "Integer32", "ModuleIdentity", "Gauge32", "TimeTicks", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrap=npThermoTrap, npThermoTable=npThermoTable, npSmokeTable=npSmokeTable, npSmokeReset=npSmokeReset, npRelHumEntry=npRelHumEntry, npRelHumTrap=npRelHumTrap, npThermoSensorN=npThermoSensorN, npThermoTrapHigh=npThermoTrapHigh, npIoTable=npIoTable, npRelHumTempValue=npRelHumTempValue, npCurLoopTrap=npCurLoopTrap, npIr=npIr, npGsmStrength=npGsmStrength, npThermoTrapLow=npThermoTrapLow, npRelHumN=npRelHumN, npRelHumTrapSafe=npRelHumTrapSafe, npGsmTrap=npGsmTrap, npThermoMemo=npThermoMemo, npIoTraps=npIoTraps, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTempStatus=npRelHumTempStatus, npIoEntry=npIoEntry, npSmokeMemo=npSmokeMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, lightcom=lightcom, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumValue=npRelHumValue, npIoLevelIn=npIoLevelIn, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeStatus=npSmokeStatus, npThermoValue=npThermoValue, npGsm=npGsm, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrapStatus=npSmokeTrapStatus, npThermoLow=npThermoLow, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIrReset=npIrReset, npCurLoopN=npCurLoopN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumidity=npRelHumidity, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, FixedPoint1000=FixedPoint1000, npGsmTraps=npGsmTraps, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopI=npCurLoopI, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npIrPlayCmd=npIrPlayCmd, npIrStatus=npIrStatus, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopPower=npCurLoopPower, npThermo=npThermo, npGsmFailed=npGsmFailed, npSmokeEntry=npSmokeEntry, npCurLoopTrapPower=npCurLoopTrapPower, npRelayStartReset=npRelayStartReset, npIo=npIo, npThermoHigh=npThermoHigh, npTrapInfo=npTrapInfo, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokePower=npSmokePower, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapMemo=npThermoTrapMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumStatus=npRelHumStatus, npThermoEntry=npThermoEntry, npGsmTrapPrefix=npGsmTrapPrefix, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapR=npCurLoopTrapR, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapV=npCurLoopTrapV, npRelayMode=npRelayMode, npCurLoopTrapN=npCurLoopTrapN, npSmoke=npSmoke, npSoftReboot=npSoftReboot, npIoTrapLineN=npIoTrapLineN, npCurLoopR=npCurLoopR, npCurLoopTrapI=npCurLoopTrapI, npRelayN=npRelayN, npRelHumTrapFail=npRelHumTrapFail, npIoLevelOut=npIoLevelOut, npSmokeTrap=npSmokeTrap, npRelayEntry=npRelayEntry, npResetStack=npResetStack, npGsmInfo=npGsmInfo, npIoTrapMemo=npIoTrapMemo, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTraps=npSmokeTraps, npIoLineN=npIoLineN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTable=npCurLoopTable, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeSensorN=npSmokeSensorN, npCurLoopTraps=npCurLoopTraps, npRelHumTable=npRelHumTable, npThermoTrapValue=npThermoTrapValue, npThermoTraps=npThermoTraps, npRelay=npRelay, npThermoTrapSensorN=npThermoTrapSensorN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoStatus=npThermoStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopStatus=npCurLoopStatus, npThermoValuePrecise=npThermoValuePrecise, npRelayState=npRelayState, npForcedReboot=npForcedReboot, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayTable=npRelayTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmRegistration=npGsmRegistration, npIoMemo=npIoMemo, npCurLoopV=npCurLoopV, npRelHumMemo=npRelHumMemo, npIrCtrl=npIrCtrl, npRelayMemo=npRelayMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopEntry=npCurLoopEntry, npReboot=npReboot, npIoTrap=npIoTrap, npCurLoop=npCurLoop, npIoPulseCounter=npIoPulseCounter)
