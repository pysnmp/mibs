...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:03:25 2021
...
ObjectIdentity, iso, Counter32, TimeTicks, Unsigned32, NotificationType, ModuleIdentity, MibIdentifier, Counter64, Bits, IpAddress, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "Counter32", "TimeTicks", "Unsigned32", "NotificationType", "ModuleIdentity", "MibIdentifier", "Counter64", "Bits", "IpAddress", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoMemo=npIoMemo, npCurLoopTrapPower=npCurLoopTrapPower, npIoTrapLevelIn=npIoTrapLevelIn, npThermo=npThermo, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoLevelIn=npIoLevelIn, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapR=npCurLoopTrapR, npRelHumValue=npRelHumValue, npThermoTable=npThermoTable, npRelHumEntry=npRelHumEntry, npThermoTrapMemo=npThermoTrapMemo, npCurLoop=npCurLoop, npResetStack=npResetStack, npCurLoopTable=npCurLoopTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoValue=npThermoValue, npIoTrapLineN=npIoTrapLineN, npThermoTrapValue=npThermoTrapValue, npThermoSensorN=npThermoSensorN, npIrCtrl=npIrCtrl, npCurLoopTrap=npCurLoopTrap, npRelHumN=npRelHumN, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeEntry=npSmokeEntry, npCurLoopEntry=npCurLoopEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeSensorN=npSmokeSensorN, npRelayN=npRelayN, npThermoTrap=npThermoTrap, npRelHumMemo=npRelHumMemo, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrapHigh=npThermoTrapHigh, npReboot=npReboot, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTraps=npCurLoopTraps, npThermoStatus=npThermoStatus, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeReset=npSmokeReset, npTrapEmailTo=npTrapEmailTo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSoftReboot=npSoftReboot, npIrPlayCmd=npIrPlayCmd, npSmokeStatus=npSmokeStatus, npGsmInfo=npGsmInfo, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTable=npRelHumTable, npRelay=npRelay, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIo=npIo, npRelHumTrap=npRelHumTrap, npThermoHigh=npThermoHigh, npIoTrap=npIoTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopPower=npCurLoopPower, npRelHumTempStatus=npRelHumTempStatus, npRelHumidity=npRelHumidity, npGsmFailed=npGsmFailed, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTraps=npSmokeTraps, npIoTraps=npIoTraps, npThermoTraps=npThermoTraps, npGsmRegistration=npGsmRegistration, npRelayEntry=npRelayEntry, npTrapInfo=npTrapInfo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeMemo=npSmokeMemo, npGsmTraps=npGsmTraps, npThermoEntry=npThermoEntry, npRelHumTempValue=npRelHumTempValue, lightcom=lightcom, npIoLevelOut=npIoLevelOut, npSmoke=npSmoke, npRelHumTrapTemp=npRelHumTrapTemp, npIrStatus=npIrStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIr=npIr, npRelayTable=npRelayTable, npIoTable=npIoTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npIrReset=npIrReset, FixedPoint1000=FixedPoint1000, npGsm=npGsm, npThermoLow=npThermoLow, npCurLoopV=npCurLoopV, npThermoTrapStatus=npThermoTrapStatus, npGsmStrength=npGsmStrength, npRelayStartReset=npRelayStartReset, npThermoTrapLow=npThermoTrapLow, npIoTrapPrefix=npIoTrapPrefix, npSmokeTable=npSmokeTable, npRelayMode=npRelayMode, npRelayMemo=npRelayMemo, npForcedReboot=npForcedReboot, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumStatus=npRelHumStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayState=npRelayState, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmTrap=npGsmTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTrap=npSmokeTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapFail=npRelHumTrapFail, npIoPulseCounter=npIoPulseCounter, npIoTrapMemo=npIoTrapMemo, npSmokeTrapMemo=npSmokeTrapMemo, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopStatus=npCurLoopStatus, npIoLineN=npIoLineN, npCurLoopI=npCurLoopI, npCurLoopN=npCurLoopN, npIoEntry=npIoEntry, npCurLoopTrapV=npCurLoopTrapV, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoMemo=npThermoMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopR=npCurLoopR, npSmokePower=npSmokePower, npThermoTrapSensorN=npThermoTrapSensorN)
