...
enterprises, Gauge32, NotificationType, ObjectIdentity, MibIdentifier, Bits, IpAddress, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, Integer32, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "NotificationType", "ObjectIdentity", "MibIdentifier", "Bits", "IpAddress", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "Integer32", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoValue=npThermoValue, npCurLoopTable=npCurLoopTable, npIr=npIr, npThermoHigh=npThermoHigh, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapDataValue=npRelHumTrapDataValue, npSoftReboot=npSoftReboot, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapData=npRelHumTrapData, npSmokePower=npSmokePower, npRelHumEntry=npRelHumEntry, npIoLevelIn=npIoLevelIn, npSmokeReset=npSmokeReset, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrCtrl=npIrCtrl, npSmokeTraps=npSmokeTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIo=npIo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopPower=npCurLoopPower, npCurLoopV=npCurLoopV, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npReboot=npReboot, npRelayMemo=npRelayMemo, npIoPulseCounter=npIoPulseCounter, npSmokeTable=npSmokeTable, npSmokeMemo=npSmokeMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrap=npIoTrap, npIoTrapPrefix=npIoTrapPrefix, npThermoEntry=npThermoEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrapMemo=npIoTrapMemo, npThermoTrapStatus=npThermoTrapStatus, npThermoTrap=npThermoTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoLevelOut=npIoLevelOut, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopStatus=npCurLoopStatus, npThermoValuePrecise=npThermoValuePrecise, npThermoLow=npThermoLow, npCurLoopTrapPower=npCurLoopTrapPower, npIoTraps=npIoTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmTrap=npGsmTrap, npThermoTable=npThermoTable, npCurLoopTrapR=npCurLoopTrapR, npIoMemo=npIoMemo, npForcedReboot=npForcedReboot, npIrStatus=npIrStatus, npRelayMode=npRelayMode, npGsmTraps=npGsmTraps, npThermo=npThermo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsm=npGsm, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumidity=npRelHumidity, npSmokeStatus=npSmokeStatus, npRelayTable=npRelayTable, npRelHumValue=npRelHumValue, npCurLoop=npCurLoop, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapLow=npThermoTrapLow, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTrapStatus=npSmokeTrapStatus, npRelayEntry=npRelayEntry, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrap=npRelHumTrap, npThermoStatus=npThermoStatus, npRelayStartReset=npRelayStartReset, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoEntry=npIoEntry, npCurLoopR=npCurLoopR, npRelHumN=npRelHumN, npCurLoopN=npCurLoopN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTable=npRelHumTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopI=npCurLoopI, npGsmRegistration=npGsmRegistration, npResetStack=npResetStack, npRelay=npRelay, npIoTable=npIoTable, npSmokeTrap=npSmokeTrap, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrap=npCurLoopTrap, npGsmFailed=npGsmFailed, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapStatus=npCurLoopTrapStatus, npTrapEmailTo=npTrapEmailTo, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumMemo=npRelHumMemo, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapPrefix=npThermoTrapPrefix, lightcom=lightcom, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrapMemo=npSmokeTrapMemo, npThermoMemo=npThermoMemo, FixedPoint1000=FixedPoint1000, npRelHumStatus=npRelHumStatus, npThermoTraps=npThermoTraps, npGsmInfo=npGsmInfo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmStrength=npGsmStrength, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmoke=npSmoke, npGsmTrapPrefix=npGsmTrapPrefix, npTrapInfo=npTrapInfo, npCurLoopTrapI=npCurLoopTrapI, npIrReset=npIrReset, npRelayState=npRelayState, npRelayN=npRelayN, npSmokeEntry=npSmokeEntry, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapSafe=npRelHumTrapSafe, npIrPlayCmd=npIrPlayCmd, npThermoSensorN=npThermoSensorN, npCurLoopTraps=npCurLoopTraps, npIoLineN=npIoLineN)
