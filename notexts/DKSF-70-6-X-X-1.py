...
# Produced by pysmi-1.1.12 at Tue Jun  4 02:43:17 2024
...
Integer32, enterprises, MibIdentifier, Counter64, iso, Bits, Gauge32, Counter32, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "MibIdentifier", "Counter64", "iso", "Bits", "Gauge32", "Counter32", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayTable=npRelayTable, npRelayMemo=npRelayMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTraps=npCurLoopTraps, npThermoValuePrecise=npThermoValuePrecise, npRelHumTempStatus=npRelHumTempStatus, npTrapInfo=npTrapInfo, npIoTrap=npIoTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokePower=npSmokePower, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmInfo=npGsmInfo, npCurLoopI=npCurLoopI, npRelHumTable=npRelHumTable, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapValue=npThermoTrapValue, npRelayMode=npRelayMode, npThermoLow=npThermoLow, npIoLevelOut=npIoLevelOut, npCurLoop=npCurLoop, npSmokeTrap=npSmokeTrap, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapFail=npRelHumTrapFail, npSmokeTraps=npSmokeTraps, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopV=npCurLoopV, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npResetStack=npResetStack, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsm=npGsm, npRelHumMemo=npRelHumMemo, npThermoTrapMemo=npThermoTrapMemo, npReboot=npReboot, npThermoStatus=npThermoStatus, npThermoMemo=npThermoMemo, npCurLoopStatus=npCurLoopStatus, npCurLoopTrap=npCurLoopTrap, npThermoEntry=npThermoEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIrReset=npIrReset, npThermoSensorN=npThermoSensorN, npRelHumTrap=npRelHumTrap, npSoftReboot=npSoftReboot, npSmokeSensorN=npSmokeSensorN, npSmokeMemo=npSmokeMemo, npIrPlayCmd=npIrPlayCmd, npCurLoopTable=npCurLoopTable, npRelayEntry=npRelayEntry, npRelHumEntry=npRelHumEntry, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopPower=npCurLoopPower, npThermoValue=npThermoValue, FixedPoint1000=FixedPoint1000, npRelHumTempValue=npRelHumTempValue, npThermoTrapHigh=npThermoTrapHigh, npThermoTable=npThermoTable, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTraps=npIoTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumN=npRelHumN, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTraps=npThermoTraps, npIoPulseCounter=npIoPulseCounter, npIo=npIo, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapI=npCurLoopTrapI, npIoTrapMemo=npIoTrapMemo, npIoLineN=npIoLineN, lightcom=lightcom, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeStatus=npSmokeStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npTrapEmailTo=npTrapEmailTo, npThermoTrap=npThermoTrap, npCurLoopEntry=npCurLoopEntry, npRelayN=npRelayN, npIoSinglePulseStart=npIoSinglePulseStart, npSmoke=npSmoke, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTable=npSmokeTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermo=npThermo, npCurLoopTrapPower=npCurLoopTrapPower, npIoLevelIn=npIoLevelIn, npSmokeTrapSensorN=npSmokeTrapSensorN, npIrStatus=npIrStatus, npCurLoopTrapR=npCurLoopTrapR, npRelHumidity=npRelHumidity, npRelHumStatus=npRelHumStatus, npIoEntry=npIoEntry, npIoTable=npIoTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmStrength=npGsmStrength, npRelayStartReset=npRelayStartReset, npThermoTrapLow=npThermoTrapLow, npRelHumTrapData=npRelHumTrapData, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmRegistration=npGsmRegistration, npRelay=npRelay, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmFailed=npGsmFailed, npThermoHigh=npThermoHigh, npIr=npIr, npIoMemo=npIoMemo, npIrCtrl=npIrCtrl, npRelHumValue=npRelHumValue, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTrapPrefix=npIoTrapPrefix, npGsmTraps=npGsmTraps, npForcedReboot=npForcedReboot, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeReset=npSmokeReset, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopN=npCurLoopN, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayState=npRelayState, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopR=npCurLoopR, npGsmTrap=npGsmTrap, npSmokeEntry=npSmokeEntry, npGsmTrapPrefix=npGsmTrapPrefix)
