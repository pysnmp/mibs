...
Integer32, ObjectIdentity, Counter32, enterprises, Counter64, iso, TimeTicks, ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, MibIdentifier, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "Counter32", "enterprises", "Counter64", "iso", "TimeTicks", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "MibIdentifier", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapValue=npThermoTrapValue, npRelHumTempStatus=npRelHumTempStatus, npRelayStartReset=npRelayStartReset, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapN=npCurLoopTrapN, npThermoValuePrecise=npThermoValuePrecise, npSoftReboot=npSoftReboot, npThermoTrapLow=npThermoTrapLow, npThermoTraps=npThermoTraps, npIoTrapMemo=npIoTrapMemo, npRelHumTable=npRelHumTable, npSmokeStatus=npSmokeStatus, npThermoMemo=npThermoMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeReset=npSmokeReset, npSmokeMemo=npSmokeMemo, npIoTrap=npIoTrap, npGsm=npGsm, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npIrReset=npIrReset, npCurLoopPower=npCurLoopPower, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoHigh=npThermoHigh, npRelHumEntry=npRelHumEntry, npRelHumTrap=npRelHumTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumValue=npRelHumValue, npRelay=npRelay, npTrapInfo=npTrapInfo, npSmokeTrapStatus=npSmokeTrapStatus, npRelayState=npRelayState, npGsmTraps=npGsmTraps, npThermoTrap=npThermoTrap, npSmokeSensorN=npSmokeSensorN, npResetStack=npResetStack, npIo=npIo, npSmokeTrap=npSmokeTrap, npIrPlayCmd=npIrPlayCmd, npIoLevelIn=npIoLevelIn, npRelHumidity=npRelHumidity, lightcom=lightcom, npSmokeTraps=npSmokeTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTable=npThermoTable, npCurLoop=npCurLoop, npThermoTrapStatus=npThermoTrapStatus, npSmokeTable=npSmokeTable, npRelHumTrapData=npRelHumTrapData, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoEntry=npThermoEntry, npGsmInfo=npGsmInfo, npRelayN=npRelayN, npCurLoopTraps=npCurLoopTraps, npCurLoopV=npCurLoopV, npCurLoopTrapStatus=npCurLoopTrapStatus, npIr=npIr, npForcedReboot=npForcedReboot, npThermo=npThermo, npCurLoopStatus=npCurLoopStatus, npIoLineN=npIoLineN, npIoPulseCounter=npIoPulseCounter, npIoTable=npIoTable, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTempValue=npRelHumTempValue, npThermoSensorN=npThermoSensorN, npRelayMode=npRelayMode, npIoLevelOut=npIoLevelOut, npIoTrapLineN=npIoTrapLineN, npIoEntry=npIoEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoLow=npThermoLow, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumStatus=npRelHumStatus, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoSinglePulseStart=npIoSinglePulseStart, npGsmRegistration=npGsmRegistration, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapR=npCurLoopTrapR, npGsmSendSmsUtf8=npGsmSendSmsUtf8, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoStatus=npThermoStatus, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapFail=npRelHumTrapFail, npSmoke=npSmoke, npGsmStrength=npGsmStrength, FixedPoint1000=FixedPoint1000, npRelHumN=npRelHumN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npReboot=npReboot, npCurLoopI=npCurLoopI, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTraps=npIoTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopN=npCurLoopN, npGsmTrap=npGsmTrap, npCurLoopTable=npCurLoopTable, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayEntry=npRelayEntry, npIoMemo=npIoMemo, npSmokeEntry=npSmokeEntry, npCurLoopEntry=npCurLoopEntry, npRelayTable=npRelayTable, npSmokePower=npSmokePower, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapMemo=npThermoTrapMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopR=npCurLoopR, npRelHumMemo=npRelHumMemo, npThermoValue=npThermoValue, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapI=npCurLoopTrapI, npThermoTrapPrefix=npThermoTrapPrefix, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npTrapEmailTo=npTrapEmailTo, npRelayMemo=npRelayMemo, npGsmTrapPrefix=npGsmTrapPrefix, npIrCtrl=npIrCtrl, npIrStatus=npIrStatus, npThermoTrapSensorN=npThermoTrapSensorN, npGsmFailed=npGsmFailed)
