...
Gauge32, NotificationType, IpAddress, enterprises, ObjectIdentity, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, MibIdentifier, Counter32, TimeTicks, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "IpAddress", "enterprises", "ObjectIdentity", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "MibIdentifier", "Counter32", "TimeTicks", "Counter64", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIrReset=npIrReset, npThermoValuePrecise=npThermoValuePrecise, npIrStatus=npIrStatus, npThermoLow=npThermoLow, npGsmRegistration=npGsmRegistration, npCurLoopI=npCurLoopI, npIoTrapLineN=npIoTrapLineN, npGsmStrength=npGsmStrength, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayMode=npRelayMode, npSmokeStatus=npSmokeStatus, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrap=npRelHumTrap, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npForcedReboot=npForcedReboot, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapSensorN=npThermoTrapSensorN, npIoTable=npIoTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapData=npRelHumTrapData, npCurLoopTable=npCurLoopTable, npIrPlayCmd=npIrPlayCmd, npRelayMemo=npRelayMemo, npCurLoopR=npCurLoopR, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoMemo=npIoMemo, npRelHumValue=npRelHumValue, npRelHumidity=npRelHumidity, npSmokeTrapMemo=npSmokeTrapMemo, npSmokePower=npSmokePower, npCurLoopV=npCurLoopV, npCurLoopTrap=npCurLoopTrap, npSmoke=npSmoke, npThermoHigh=npThermoHigh, npRelHumMemo=npRelHumMemo, npGsmInfo=npGsmInfo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoLevelOut=npIoLevelOut, npCurLoopTrapV=npCurLoopTrapV, npRelHumEntry=npRelHumEntry, npThermoSensorN=npThermoSensorN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopPower=npCurLoopPower, npSmokeEntry=npSmokeEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayN=npRelayN, npSmokeReset=npSmokeReset, npIoSinglePulseStart=npIoSinglePulseStart, npGsmTrap=npGsmTrap, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTraps=npThermoTraps, npThermoTrapHigh=npThermoTrapHigh, npThermoMemo=npThermoMemo, npIrCtrl=npIrCtrl, npRelHumTable=npRelHumTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermo=npThermo, npThermoTrapLow=npThermoTrapLow, npCurLoop=npCurLoop, npSmokeTrap=npSmokeTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoEntry=npThermoEntry, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopStatus=npCurLoopStatus, npRelay=npRelay, npThermoStatus=npThermoStatus, npTrapInfo=npTrapInfo, npCurLoopEntry=npCurLoopEntry, npThermoTrap=npThermoTrap, npThermoTrapValue=npThermoTrapValue, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTable=npSmokeTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIr=npIr, npIoLineN=npIoLineN, npThermoValue=npThermoValue, npCurLoopTrapPower=npCurLoopTrapPower, npIoTrap=npIoTrap, npReboot=npReboot, npRelayState=npRelayState, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npTrapEmailTo=npTrapEmailTo, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapMemo=npThermoTrapMemo, npThermoTable=npThermoTable, npRelHumN=npRelHumN, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayEntry=npRelayEntry, npIoPulseCounter=npIoPulseCounter, npSmokeMemo=npSmokeMemo, npCurLoopTrapR=npCurLoopTrapR, npGsmFailed=npGsmFailed, npRelHumStatus=npRelHumStatus, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoEntry=npIoEntry, npCurLoopTraps=npCurLoopTraps, npSoftReboot=npSoftReboot, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTempValue=npRelHumTempValue, npGsm=npGsm, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTraps=npSmokeTraps, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIo=npIo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npResetStack=npResetStack, npRelayTable=npRelayTable, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTraps=npIoTraps, npRelHumTrapDataStatus=npRelHumTrapDataStatus, FixedPoint1000=FixedPoint1000, lightcom=lightcom, npRelayStartReset=npRelayStartReset, npGsmTraps=npGsmTraps, npIoTrapMemo=npIoTrapMemo, npSmokeSensorN=npSmokeSensorN, npIoLevelIn=npIoLevelIn, npCurLoopN=npCurLoopN)
