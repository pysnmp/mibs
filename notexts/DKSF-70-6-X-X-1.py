...
# Produced by pysmi-1.1.8 at Thu Jan 13 23:54:28 2022
...
Counter64, Bits, IpAddress, Unsigned32, NotificationType, Counter32, enterprises, Gauge32, Integer32, iso, TimeTicks, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Bits", "IpAddress", "Unsigned32", "NotificationType", "Counter32", "enterprises", "Gauge32", "Integer32", "iso", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopPower=npCurLoopPower, npThermoTrapValue=npThermoTrapValue, npGsmTrap=npGsmTrap, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrap=npSmokeTrap, npThermoValuePrecise=npThermoValuePrecise, npSmokeStatus=npSmokeStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumN=npRelHumN, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTraps=npSmokeTraps, npThermoEntry=npThermoEntry, npRelay=npRelay, npIoTraps=npIoTraps, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumValue=npRelHumValue, npRelayN=npRelayN, npCurLoopI=npCurLoopI, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTraps=npThermoTraps, npGsmStrength=npGsmStrength, npRelHumTrapFail=npRelHumTrapFail, npGsm=npGsm, npRelayTable=npRelayTable, npThermoTrapMemo=npThermoTrapMemo, npIoLevelIn=npIoLevelIn, npIoSinglePulseStart=npIoSinglePulseStart, npIrReset=npIrReset, npRelHumEntry=npRelHumEntry, npIoTable=npIoTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopV=npCurLoopV, npRelHumTable=npRelHumTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmTraps=npGsmTraps, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapR=npCurLoopTrapR, npSmokeReset=npSmokeReset, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapStatus=npThermoTrapStatus, npSmoke=npSmoke, npCurLoopTable=npCurLoopTable, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoMemo=npThermoMemo, npReboot=npReboot, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTemp=npRelHumTrapTemp, npTrapInfo=npTrapInfo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTempStatus=npRelHumTempStatus, npIoLevelOut=npIoLevelOut, npIo=npIo, npRelHumidity=npRelHumidity, npIrCtrl=npIrCtrl, npIoEntry=npIoEntry, npRelHumTrapData=npRelHumTrapData, npSmokeTable=npSmokeTable, npIrStatus=npIrStatus, npSmokeTrapStatus=npSmokeTrapStatus, npGsmInfo=npGsmInfo, npThermoTrapLow=npThermoTrapLow, npSoftReboot=npSoftReboot, npCurLoopN=npCurLoopN, npThermoTrapHigh=npThermoTrapHigh, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrap=npThermoTrap, npIoTrapMemo=npIoTrapMemo, npCurLoopTraps=npCurLoopTraps, npRelHumTrapSafe=npRelHumTrapSafe, FixedPoint1000=FixedPoint1000, npSmokeSensorN=npSmokeSensorN, npThermoStatus=npThermoStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTempValue=npRelHumTempValue, npRelayState=npRelayState, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopR=npCurLoopR, npThermoLow=npThermoLow, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeEntry=npSmokeEntry, npIrPlayCmd=npIrPlayCmd, npGsmRegistration=npGsmRegistration, npGsmFailed=npGsmFailed, npIoSinglePulseDuration=npIoSinglePulseDuration, npForcedReboot=npForcedReboot, npTrapEmailTo=npTrapEmailTo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumStatus=npRelHumStatus, npCurLoopTrapV=npCurLoopTrapV, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelayEntry=npRelayEntry, npIoTrapPrefix=npIoTrapPrefix, npIoTrapLineN=npIoTrapLineN, npRelHumTrap=npRelHumTrap, npThermoTable=npThermoTable, npCurLoopEntry=npCurLoopEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermo=npThermo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoLineN=npIoLineN, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoHigh=npThermoHigh, lightcom=lightcom, npRelayStartReset=npRelayStartReset, npSmokePower=npSmokePower, npRelayMemo=npRelayMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayMode=npRelayMode, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumMemo=npRelHumMemo, npIoTrap=npIoTrap, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npIoMemo=npIoMemo, npCurLoopTrap=npCurLoopTrap, npThermoTrapPrefix=npThermoTrapPrefix, npThermoSensorN=npThermoSensorN, npResetStack=npResetStack, npIr=npIr, npThermoValue=npThermoValue, npSmokeMemo=npSmokeMemo, npCurLoop=npCurLoop)
