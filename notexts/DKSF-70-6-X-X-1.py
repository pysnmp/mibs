...
Bits, ObjectIdentity, MibIdentifier, NotificationType, iso, enterprises, Integer32, Unsigned32, TimeTicks, IpAddress, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "MibIdentifier", "NotificationType", "iso", "enterprises", "Integer32", "Unsigned32", "TimeTicks", "IpAddress", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoEntry=npThermoEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmTraps=npGsmTraps, npSmokeTrapStatus=npSmokeTrapStatus, npTrapEmailTo=npTrapEmailTo, npThermoTrap=npThermoTrap, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeMemo=npSmokeMemo, npThermoTrapHigh=npThermoTrapHigh, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapLow=npThermoTrapLow, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIr=npIr, npThermoValue=npThermoValue, npResetStack=npResetStack, npCurLoopTraps=npCurLoopTraps, npRelayMode=npRelayMode, npIoTrap=npIoTrap, npRelayState=npRelayState, npIrPlayCmd=npIrPlayCmd, npThermoSensorN=npThermoSensorN, npRelHumTempStatus=npRelHumTempStatus, npIoEntry=npIoEntry, npCurLoopI=npCurLoopI, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataN=npRelHumTrapDataN, npThermo=npThermo, npRelHumTrapData=npRelHumTrapData, npIrReset=npIrReset, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTrap=npSmokeTrap, npThermoTable=npThermoTable, npGsmTrapPrefix=npGsmTrapPrefix, npRelayEntry=npRelayEntry, npThermoStatus=npThermoStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayMemo=npRelayMemo, npThermoMemo=npThermoMemo, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoLow=npThermoLow, npCurLoopStatus=npCurLoopStatus, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapPrefix=npThermoTrapPrefix, npGsmTrap=npGsmTrap, npSmokeEntry=npSmokeEntry, npSoftReboot=npSoftReboot, npRelHumTable=npRelHumTable, npRelHumN=npRelHumN, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopV=npCurLoopV, npThermoTrapMemo=npThermoTrapMemo, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeReset=npSmokeReset, npThermoTraps=npThermoTraps, npIoPulseCounter=npIoPulseCounter, npRelHumidity=npRelHumidity, npGsm=npGsm, npIoTrapPrefix=npIoTrapPrefix, npIoLineN=npIoLineN, npSmokeTrapMemo=npSmokeTrapMemo, npRelayN=npRelayN, npRelayStartReset=npRelayStartReset, npRelHumTrap=npRelHumTrap, npSmokeTable=npSmokeTable, npSmokePower=npSmokePower, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoHigh=npThermoHigh, npIoTable=npIoTable, npRelHumTrapDataValue=npRelHumTrapDataValue, FixedPoint1000=FixedPoint1000, npRelHumTrapFail=npRelHumTrapFail, npRelHumEntry=npRelHumEntry, npGsmRegistration=npGsmRegistration, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoop=npCurLoop, npCurLoopR=npCurLoopR, npRelHumTempValue=npRelHumTempValue, npIoTrapLineN=npIoTrapLineN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeStatus=npSmokeStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopN=npCurLoopN, npSmoke=npSmoke, npTrapInfo=npTrapInfo, npRelHumTrapTempFail=npRelHumTrapTempFail, npReboot=npReboot, npIoLevelOut=npIoLevelOut, npCurLoopTable=npCurLoopTable, npRelHumValue=npRelHumValue, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrCtrl=npIrCtrl, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapV=npCurLoopTrapV, npIoMemo=npIoMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, lightcom=lightcom, npRelayTable=npRelayTable, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumMemo=npRelHumMemo, npIoLevelIn=npIoLevelIn, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumStatus=npRelHumStatus, npSmokeTraps=npSmokeTraps, npCurLoopTrapI=npCurLoopTrapI, npIo=npIo, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopEntry=npCurLoopEntry, npIoTraps=npIoTraps, npIrStatus=npIrStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelay=npRelay, npThermoValuePrecise=npThermoValuePrecise, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmFailed=npGsmFailed, npGsmStrength=npGsmStrength, npGsmInfo=npGsmInfo, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopPower=npCurLoopPower, npForcedReboot=npForcedReboot)
