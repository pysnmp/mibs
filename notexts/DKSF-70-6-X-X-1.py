...
Integer32, Gauge32, iso, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, MibIdentifier, ModuleIdentity, Unsigned32, IpAddress, enterprises, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "iso", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "MibIdentifier", "ModuleIdentity", "Unsigned32", "IpAddress", "enterprises", "Counter32", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npTrapEmailTo=npTrapEmailTo, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeSensorN=npSmokeSensorN, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmFailed=npGsmFailed, npRelHumTempStatus=npRelHumTempStatus, npIoTable=npIoTable, npReboot=npReboot, npIoMemo=npIoMemo, npIoPulseCounter=npIoPulseCounter, npRelayStartReset=npRelayStartReset, npGsm=npGsm, npCurLoopPower=npCurLoopPower, npSmokeMemo=npSmokeMemo, npCurLoopStatus=npCurLoopStatus, npIoTrapLineN=npIoTrapLineN, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapHigh=npThermoTrapHigh, npGsmStrength=npGsmStrength, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapLow=npThermoTrapLow, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopV=npCurLoopV, npThermoEntry=npThermoEntry, npSmokePower=npSmokePower, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTraps=npSmokeTraps, npForcedReboot=npForcedReboot, npRelHumMemo=npRelHumMemo, npRelHumTrapData=npRelHumTrapData, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npRelayEntry=npRelayEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapValue=npThermoTrapValue, lightcom=lightcom, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoSensorN=npThermoSensorN, npIrCtrl=npIrCtrl, npCurLoopTrap=npCurLoopTrap, npCurLoopTraps=npCurLoopTraps, npThermoLow=npThermoLow, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrap=npSmokeTrap, npCurLoopN=npCurLoopN, npRelHumStatus=npRelHumStatus, npThermoStatus=npThermoStatus, npThermoTrap=npThermoTrap, npGsmRegistration=npGsmRegistration, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoLevelOut=npIoLevelOut, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTable=npSmokeTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumN=npRelHumN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapI=npCurLoopTrapI, npIrReset=npIrReset, npThermoMemo=npThermoMemo, npGsmTrap=npGsmTrap, FixedPoint1000=FixedPoint1000, npThermoHigh=npThermoHigh, npIoTrap=npIoTrap, npSmoke=npSmoke, npSmokeEntry=npSmokeEntry, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoEntry=npIoEntry, npRelayTable=npRelayTable, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTable=npThermoTable, npCurLoopTable=npCurLoopTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmTraps=npGsmTraps, npThermo=npThermo, npIoTraps=npIoTraps, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopR=npCurLoopR, npIoLevelIn=npIoLevelIn, npRelHumValue=npRelHumValue, npRelHumidity=npRelHumidity, npThermoTraps=npThermoTraps, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayN=npRelayN, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelay=npRelay, npIoLineN=npIoLineN, npCurLoop=npCurLoop, npSmokeStatus=npSmokeStatus, npRelayState=npRelayState, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeReset=npSmokeReset, npRelayMode=npRelayMode, npSoftReboot=npSoftReboot, npTrapInfo=npTrapInfo, uniPingServerSolutionV3=uniPingServerSolutionV3, npIrPlayCmd=npIrPlayCmd, npIo=npIo, npCurLoopTrapStatus=npCurLoopTrapStatus, npIrStatus=npIrStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumEntry=npRelHumEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIr=npIr, npCurLoopTrapV=npCurLoopTrapV, npCurLoopEntry=npCurLoopEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapMemo=npThermoTrapMemo, npResetStack=npResetStack, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrap=npRelHumTrap, npCurLoopI=npCurLoopI, npThermoValue=npThermoValue, npRelHumTable=npRelHumTable, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmInfo=npGsmInfo, npRelayMemo=npRelayMemo)
