...
# Produced by pysmi-1.1.12 at Wed May 29 10:25:25 2024
...
ObjectIdentity, Gauge32, Integer32, Counter64, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, MibIdentifier, iso, enterprises, ModuleIdentity, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "Integer32", "Counter64", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "MibIdentifier", "iso", "enterprises", "ModuleIdentity", "IpAddress", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSoftReboot=npSoftReboot, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTable=npRelHumTable, npCurLoopPower=npCurLoopPower, npRelayMode=npRelayMode, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumValue=npRelHumValue, npThermoLow=npThermoLow, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoEntry=npIoEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTable=npIoTable, npCurLoopTraps=npCurLoopTraps, npForcedReboot=npForcedReboot, npIr=npIr, npRelayMemo=npRelayMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoLineN=npIoLineN, npIoLevelOut=npIoLevelOut, npThermoStatus=npThermoStatus, npThermoTrap=npThermoTrap, npCurLoopI=npCurLoopI, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumidity=npRelHumidity, npRelayN=npRelayN, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapHigh=npThermoTrapHigh, npThermoTraps=npThermoTraps, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmInfo=npGsmInfo, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npResetStack=npResetStack, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapI=npCurLoopTrapI, npCurLoopEntry=npCurLoopEntry, npThermoTable=npThermoTable, npCurLoopTrapPower=npCurLoopTrapPower, npGsm=npGsm, npRelay=npRelay, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmTrap=npGsmTrap, npIrReset=npIrReset, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapSensorN=npThermoTrapSensorN, npSmokePower=npSmokePower, npThermoValue=npThermoValue, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeSensorN=npSmokeSensorN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIo=npIo, npThermoTrapLow=npThermoTrapLow, npSmokeTable=npSmokeTable, npIoTrap=npIoTrap, npCurLoopTrap=npCurLoopTrap, npIoLevelIn=npIoLevelIn, FixedPoint1000=FixedPoint1000, npRelHumTrapData=npRelHumTrapData, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayState=npRelayState, npRelHumTrapDataN=npRelHumTrapDataN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, lightcom=lightcom, npIoTrapMemo=npIoTrapMemo, npRelHumEntry=npRelHumEntry, npRelHumTempValue=npRelHumTempValue, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrapLineN=npIoTrapLineN, npSmokeStatus=npSmokeStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapR=npCurLoopTrapR, npThermoSensorN=npThermoSensorN, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayEntry=npRelayEntry, npIoMemo=npIoMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmFailed=npGsmFailed, npRelHumTrap=npRelHumTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmTraps=npGsmTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermo=npThermo, npThermoTrapValue=npThermoTrapValue, npRelHumN=npRelHumN, npRelHumStatus=npRelHumStatus, npCurLoopR=npCurLoopR, npReboot=npReboot, npThermoValuePrecise=npThermoValuePrecise, npIrStatus=npIrStatus, npTrapInfo=npTrapInfo, npRelHumMemo=npRelHumMemo, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTable=npCurLoopTable, npGsmStrength=npGsmStrength, npCurLoop=npCurLoop, npSmokeTrap=npSmokeTrap, npRelHumTrapSafe=npRelHumTrapSafe, npThermoHigh=npThermoHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoMemo=npThermoMemo, npSmoke=npSmoke, npGsmTrapPrefix=npGsmTrapPrefix, npGsmRegistration=npGsmRegistration, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopN=npCurLoopN, npIoTraps=npIoTraps, npThermoEntry=npThermoEntry, npRelayStartReset=npRelayStartReset, npIrCtrl=npIrCtrl, npSmokeEntry=npSmokeEntry, npSmokeReset=npSmokeReset, npIoTrapLevelIn=npIoTrapLevelIn, npTrapEmailTo=npTrapEmailTo, npCurLoopV=npCurLoopV, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTraps=npSmokeTraps, npIrPlayCmd=npIrPlayCmd, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeMemo=npSmokeMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelayTable=npRelayTable, npThermoTrapMemo=npThermoTrapMemo, npIoPulseCounter=npIoPulseCounter, npRelHumTrapFail=npRelHumTrapFail)
