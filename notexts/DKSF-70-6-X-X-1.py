...
# Produced by pysmi-1.1.8 at Wed Sep 13 14:31:42 2023
...
Integer32, MibIdentifier, Unsigned32, TimeTicks, iso, enterprises, IpAddress, ObjectIdentity, NotificationType, Counter64, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibIdentifier", "Unsigned32", "TimeTicks", "iso", "enterprises", "IpAddress", "ObjectIdentity", "NotificationType", "Counter64", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapAllChannels=npRelHumTrapAllChannels, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTemp=npRelHumTrapTemp, npThermoValuePrecise=npThermoValuePrecise, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIr=npIr, npGsmInfo=npGsmInfo, npIoTrapPrefix=npIoTrapPrefix, npThermoTraps=npThermoTraps, npGsmTraps=npGsmTraps, npRelHumTrapSafe=npRelHumTrapSafe, npRelayN=npRelayN, npRelayMemo=npRelayMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapValue=npThermoTrapValue, npIoTraps=npIoTraps, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataN=npRelHumTrapDataN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelay=npRelay, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoop=npCurLoop, npIrCtrl=npIrCtrl, npRelHumTempStatus=npRelHumTempStatus, npSmokeTrap=npSmokeTrap, npIrPlayCmd=npIrPlayCmd, npIoLineN=npIoLineN, npSmokeReset=npSmokeReset, npRelHumTrap=npRelHumTrap, npSmokePower=npSmokePower, npThermoEntry=npThermoEntry, npRelayEntry=npRelayEntry, npGsmFailed=npGsmFailed, npTrapEmailTo=npTrapEmailTo, npThermoTable=npThermoTable, npRelHumidity=npRelHumidity, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoMemo=npIoMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoStatus=npThermoStatus, npThermoMemo=npThermoMemo, npForcedReboot=npForcedReboot, npThermoHigh=npThermoHigh, npRelHumEntry=npRelHumEntry, npCurLoopTable=npCurLoopTable, npSmokeSensorN=npSmokeSensorN, lightcom=lightcom, npResetStack=npResetStack, npCurLoopPower=npCurLoopPower, npIoEntry=npIoEntry, npSmokeEntry=npSmokeEntry, npIoTrapMemo=npIoTrapMemo, npRelHumValue=npRelHumValue, npCurLoopI=npCurLoopI, npCurLoopN=npCurLoopN, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumStatus=npRelHumStatus, npThermoTrapSensorN=npThermoTrapSensorN, npIoLevelIn=npIoLevelIn, npThermoValue=npThermoValue, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsm=npGsm, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapR=npCurLoopTrapR, npReboot=npReboot, npRelayTable=npRelayTable, npCurLoopTrapPower=npCurLoopTrapPower, npIrStatus=npIrStatus, npSmokeTable=npSmokeTable, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapN=npCurLoopTrapN, npIoTrapLevelIn=npIoTrapLevelIn, npIoTable=npIoTable, npSmokeMemo=npSmokeMemo, npSmokeTraps=npSmokeTraps, npRelayMode=npRelayMode, npIrReset=npIrReset, npSoftReboot=npSoftReboot, npTrapInfo=npTrapInfo, npGsmTrap=npGsmTrap, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIo=npIo, npIoLevelOut=npIoLevelOut, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopR=npCurLoopR, npThermoSensorN=npThermoSensorN, npThermoTrapStatus=npThermoTrapStatus, npCurLoopStatus=npCurLoopStatus, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTrapLineN=npIoTrapLineN, npThermoTrapPrefix=npThermoTrapPrefix, npThermo=npThermo, npRelHumMemo=npRelHumMemo, npRelayState=npRelayState, npCurLoopV=npCurLoopV, npCurLoopTrap=npCurLoopTrap, npSmoke=npSmoke, npIoTrap=npIoTrap, npThermoTrapMemo=npThermoTrapMemo, npGsmRegistration=npGsmRegistration, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapHigh=npThermoTrapHigh, npCurLoopEntry=npCurLoopEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempValue=npRelHumTempValue, npSmokeStatus=npSmokeStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapFail=npRelHumTrapFail, npRelayStartReset=npRelayStartReset, FixedPoint1000=FixedPoint1000, npRelHumN=npRelHumN, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrap=npThermoTrap, npCurLoopTrapI=npCurLoopTrapI, npThermoLow=npThermoLow, npRelHumTable=npRelHumTable, npCurLoopTraps=npCurLoopTraps, npGsmStrength=npGsmStrength, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoSinglePulseStart=npIoSinglePulseStart)
