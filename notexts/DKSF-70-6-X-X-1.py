...
# Produced by pysmi-1.1.8 at Mon Jan 17 19:50:11 2022
...
TimeTicks, Integer32, iso, enterprises, IpAddress, Counter32, Counter64, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, MibIdentifier, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "iso", "enterprises", "IpAddress", "Counter32", "Counter64", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "MibIdentifier", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapSafe=npRelHumTrapSafe, npRelayMode=npRelayMode, npRelayStartReset=npRelayStartReset, npRelayMemo=npRelayMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoSinglePulseStart=npIoSinglePulseStart, FixedPoint1000=FixedPoint1000, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoValue=npThermoValue, uniPingServerSolutionV3=uniPingServerSolutionV3, npReboot=npReboot, npGsmTrap=npGsmTrap, npTrapEmailTo=npTrapEmailTo, npThermoTrapStatus=npThermoTrapStatus, npThermoEntry=npThermoEntry, npCurLoopN=npCurLoopN, npIoTable=npIoTable, npCurLoopEntry=npCurLoopEntry, npTrapInfo=npTrapInfo, npSmokeTrapStatus=npSmokeTrapStatus, npIrCtrl=npIrCtrl, npIoLineN=npIoLineN, npRelHumTrapData=npRelHumTrapData, npIoTrap=npIoTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrap=npRelHumTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapLow=npThermoTrapLow, npSmokeSensorN=npSmokeSensorN, npRelayN=npRelayN, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopV=npCurLoopV, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTraps=npSmokeTraps, npCurLoopTrapI=npCurLoopTrapI, npRelHumStatus=npRelHumStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoStatus=npThermoStatus, npGsmStrength=npGsmStrength, npThermoTable=npThermoTable, npRelHumTempValue=npRelHumTempValue, npGsm=npGsm, npThermoLow=npThermoLow, npThermoTrapSensorN=npThermoTrapSensorN, npRelay=npRelay, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoEntry=npIoEntry, npCurLoopTrapV=npCurLoopTrapV, npGsmTraps=npGsmTraps, npRelHumMemo=npRelHumMemo, npRelHumValue=npRelHumValue, npThermoTrapHigh=npThermoTrapHigh, npSmokeStatus=npSmokeStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npResetStack=npResetStack, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoLevelOut=npIoLevelOut, npRelHumEntry=npRelHumEntry, npIoLevelIn=npIoLevelIn, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopPower=npCurLoopPower, lightcom=lightcom, npRelHumidity=npRelHumidity, npCurLoopI=npCurLoopI, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoHigh=npThermoHigh, npCurLoopR=npCurLoopR, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeEntry=npSmokeEntry, npThermoMemo=npThermoMemo, npThermoSensorN=npThermoSensorN, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapN=npCurLoopTrapN, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermo=npThermo, npForcedReboot=npForcedReboot, npIrReset=npIrReset, npIoMemo=npIoMemo, npRelayTable=npRelayTable, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapPrefix=npIoTrapPrefix, npIrPlayCmd=npIrPlayCmd, npSoftReboot=npSoftReboot, npSmokeMemo=npSmokeMemo, npIo=npIo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTable=npRelHumTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapR=npCurLoopTrapR, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmFailed=npGsmFailed, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapFail=npRelHumTrapFail, npGsmRegistration=npGsmRegistration, npIoTraps=npIoTraps, npSmoke=npSmoke, npIoPulseCounter=npIoPulseCounter, npSmokeReset=npSmokeReset, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapValue=npThermoTrapValue, npSmokePower=npSmokePower, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrap=npCurLoopTrap, npThermoTraps=npThermoTraps, npSmokeTable=npSmokeTable, npRelHumN=npRelHumN, npCurLoopTraps=npCurLoopTraps, npCurLoop=npCurLoop, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrap=npThermoTrap, npRelayEntry=npRelayEntry, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTrapLineN=npIoTrapLineN, npRelayState=npRelayState, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIr=npIr, npCurLoopTable=npCurLoopTable, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopStatus=npCurLoopStatus, npIoTrapMemo=npIoTrapMemo, npSmokeTrap=npSmokeTrap, npGsmInfo=npGsmInfo, npIrStatus=npIrStatus)
