...
ModuleIdentity, Integer32, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ObjectIdentity, NotificationType, iso, IpAddress, Counter32, Gauge32, Bits, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ObjectIdentity", "NotificationType", "iso", "IpAddress", "Counter32", "Gauge32", "Bits", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIrStatus=npIrStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npResetStack=npResetStack, npThermoTrapHigh=npThermoTrapHigh, npRelHumTable=npRelHumTable, npThermoLow=npThermoLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmFailed=npGsmFailed, npRelHumMemo=npRelHumMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTable=npSmokeTable, npIoPulseCounter=npIoPulseCounter, npForcedReboot=npForcedReboot, npThermoTable=npThermoTable, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermo=npThermo, npCurLoopV=npCurLoopV, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapMemo=npThermoTrapMemo, npThermoTrapStatus=npThermoTrapStatus, npSoftReboot=npSoftReboot, npCurLoopTraps=npCurLoopTraps, npThermoTrapLow=npThermoTrapLow, npIoTrapLevelIn=npIoTrapLevelIn, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTraps=npThermoTraps, npGsmTrap=npGsmTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayMode=npRelayMode, npCurLoopTrapN=npCurLoopTrapN, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeStatus=npSmokeStatus, npCurLoopPower=npCurLoopPower, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopR=npCurLoopR, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTempValue=npRelHumTempValue, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmoke=npSmoke, npIr=npIr, npGsmRegistration=npGsmRegistration, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopI=npCurLoopI, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTempStatus=npRelHumTempStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoEntry=npThermoEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTrap=npIoTrap, npIoLineN=npIoLineN, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeTraps=npSmokeTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumStatus=npRelHumStatus, npIoTrapMemo=npIoTrapMemo, npThermoValue=npThermoValue, npRelayTable=npRelayTable, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoop=npCurLoop, npCurLoopTrapI=npCurLoopTrapI, npCurLoopN=npCurLoopN, npGsmInfo=npGsmInfo, npIoLevelOut=npIoLevelOut, npThermoStatus=npThermoStatus, npThermoTrap=npThermoTrap, npRelHumEntry=npRelHumEntry, npGsm=npGsm, npRelHumTrapTemp=npRelHumTrapTemp, FixedPoint1000=FixedPoint1000, npIoTrapPrefix=npIoTrapPrefix, npCurLoopStatus=npCurLoopStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npIrReset=npIrReset, npIoSinglePulseStart=npIoSinglePulseStart, npIrCtrl=npIrCtrl, npIo=npIo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumValue=npRelHumValue, lightcom=lightcom, npRelayEntry=npRelayEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTable=npIoTable, npCurLoopEntry=npCurLoopEntry, npThermoHigh=npThermoHigh, npIoTraps=npIoTraps, npThermoTrapValue=npThermoTrapValue, npGsmTraps=npGsmTraps, npRelHumTrapFail=npRelHumTrapFail, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapR=npCurLoopTrapR, npSmokeSensorN=npSmokeSensorN, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayMemo=npRelayMemo, npSmokeEntry=npSmokeEntry, npTrapInfo=npTrapInfo, npGsmStrength=npGsmStrength, npCurLoopTable=npCurLoopTable, npRelHumN=npRelHumN, npIoTrapLineN=npIoTrapLineN, npThermoSensorN=npThermoSensorN, npIoEntry=npIoEntry, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayN=npRelayN, npSmokeTrap=npSmokeTrap, npIoLevelIn=npIoLevelIn, npRelHumidity=npRelHumidity, npReboot=npReboot, npSmokeReset=npSmokeReset, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoMemo=npIoMemo, npSmokeMemo=npSmokeMemo, npRelayStartReset=npRelayStartReset, npRelayState=npRelayState, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrap=npRelHumTrap, npSmokePower=npSmokePower, npThermoMemo=npThermoMemo, npRelay=npRelay)
