...
Counter64, NotificationType, MibIdentifier, Counter32, Bits, Gauge32, iso, ModuleIdentity, Integer32, Unsigned32, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "MibIdentifier", "Counter32", "Bits", "Gauge32", "iso", "ModuleIdentity", "Integer32", "Unsigned32", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoValue=npThermoValue, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapFail=npRelHumTrapFail, npIrStatus=npIrStatus, npRelayTable=npRelayTable, npRelHumEntry=npRelHumEntry, npSmokeTrap=npSmokeTrap, npCurLoop=npCurLoop, npSmokeTable=npSmokeTable, npGsmRegistration=npGsmRegistration, npSmokeEntry=npSmokeEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayState=npRelayState, npCurLoopPower=npCurLoopPower, npCurLoopR=npCurLoopR, npRelHumTempStatus=npRelHumTempStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapStatus=npThermoTrapStatus, npSmokeStatus=npSmokeStatus, npGsmStrength=npGsmStrength, npIrPlayCmd=npIrPlayCmd, npIoMemo=npIoMemo, npRelay=npRelay, npGsm=npGsm, npThermoTrapMemo=npThermoTrapMemo, npSmokeTrapStatus=npSmokeTrapStatus, npGsmFailed=npGsmFailed, npIoLineN=npIoLineN, npRelayMode=npRelayMode, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoEntry=npThermoEntry, npSmokePower=npSmokePower, npRelHumStatus=npRelHumStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoMemo=npThermoMemo, npSmokeTraps=npSmokeTraps, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayMemo=npRelayMemo, npCurLoopV=npCurLoopV, npRelHumMemo=npRelHumMemo, npRelHumidity=npRelHumidity, npSoftReboot=npSoftReboot, npThermoTrapPrefix=npThermoTrapPrefix, npRelayEntry=npRelayEntry, npGsmTraps=npGsmTraps, npForcedReboot=npForcedReboot, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTable=npCurLoopTable, npSmokeMemo=npSmokeMemo, FixedPoint1000=FixedPoint1000, npRelHumTrapSafe=npRelHumTrapSafe, npThermoValuePrecise=npThermoValuePrecise, npThermoSensorN=npThermoSensorN, npIo=npIo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayStartReset=npRelayStartReset, npResetStack=npResetStack, npIr=npIr, npThermoTable=npThermoTable, npCurLoopTrap=npCurLoopTrap, npIoTrap=npIoTrap, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapR=npCurLoopTrapR, npIoLevelIn=npIoLevelIn, npIoPulseCounter=npIoPulseCounter, npCurLoopTrapN=npCurLoopTrapN, npSmoke=npSmoke, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTempValue=npRelHumTempValue, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrap=npThermoTrap, npTrapInfo=npTrapInfo, npCurLoopStatus=npCurLoopStatus, npIoEntry=npIoEntry, npGsmTrap=npGsmTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIrReset=npIrReset, npGsmInfo=npGsmInfo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrapMemo=npIoTrapMemo, npThermoTrapValue=npThermoTrapValue, npRelHumN=npRelHumN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapData=npRelHumTrapData, npIrCtrl=npIrCtrl, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopEntry=npCurLoopEntry, npRelHumValue=npRelHumValue, npRelHumTable=npRelHumTable, npCurLoopI=npCurLoopI, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayN=npRelayN, npThermoTraps=npThermoTraps, npReboot=npReboot, npThermo=npThermo, npSmokeSensorN=npSmokeSensorN, npIoTraps=npIoTraps, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapLow=npThermoTrapLow, lightcom=lightcom, npThermoStatus=npThermoStatus, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTraps=npCurLoopTraps, npThermoHigh=npThermoHigh, npThermoTrapSensorN=npThermoTrapSensorN, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTable=npIoTable, npCurLoopN=npCurLoopN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeReset=npSmokeReset, npIoLevelOut=npIoLevelOut, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoLow=npThermoLow, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTrapLineN=npIoTrapLineN, npRelHumTrap=npRelHumTrap, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLevelIn=npIoTrapLevelIn, uniPingServerSolutionV3=uniPingServerSolutionV3)
