...
# Produced by pysmi-1.1.3 at Mon Nov 22 19:25:53 2021
...
Counter32, MibIdentifier, NotificationType, ObjectIdentity, enterprises, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, iso, Unsigned32, TimeTicks, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "NotificationType", "ObjectIdentity", "enterprises", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "iso", "Unsigned32", "TimeTicks", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npForcedReboot=npForcedReboot, npGsmInfo=npGsmInfo, npGsmStrength=npGsmStrength, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapHigh=npThermoTrapHigh, npRelayN=npRelayN, npCurLoopTrapV=npCurLoopTrapV, npRelHumidity=npRelHumidity, npIoTrapPrefix=npIoTrapPrefix, npIrCtrl=npIrCtrl, npGsmRegistration=npGsmRegistration, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTrap=npIoTrap, npCurLoopTrapI=npCurLoopTrapI, npTrapEmailTo=npTrapEmailTo, npThermoTrapValue=npThermoTrapValue, npCurLoopI=npCurLoopI, npSmokeEntry=npSmokeEntry, npRelHumTrap=npRelHumTrap, npRelayEntry=npRelayEntry, npIoSinglePulseStart=npIoSinglePulseStart, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrapStatus=npSmokeTrapStatus, npIoPulseCounter=npIoPulseCounter, npCurLoopEntry=npCurLoopEntry, npRelHumN=npRelHumN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmTrap=npGsmTrap, npThermoEntry=npThermoEntry, npIoTrapLineN=npIoTrapLineN, npCurLoop=npCurLoop, npCurLoopTrapR=npCurLoopTrapR, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapStatus=npThermoTrapStatus, npSmokePower=npSmokePower, npRelayMemo=npRelayMemo, npIoTraps=npIoTraps, npCurLoopTrapPower=npCurLoopTrapPower, npIoLevelIn=npIoLevelIn, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoSensorN=npThermoSensorN, npRelHumTempStatus=npRelHumTempStatus, npIoEntry=npIoEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTable=npRelHumTable, npThermoTrap=npThermoTrap, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoValue=npThermoValue, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopR=npCurLoopR, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoMemo=npThermoMemo, npGsmTraps=npGsmTraps, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTempValue=npRelHumTempValue, npRelHumMemo=npRelHumMemo, npIrReset=npIrReset, npCurLoopN=npCurLoopN, npRelHumStatus=npRelHumStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmoke=npSmoke, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmFailed=npGsmFailed, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayTable=npRelayTable, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataN=npRelHumTrapDataN, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsm=npGsm, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoSinglePulseDuration=npIoSinglePulseDuration, npResetStack=npResetStack, npIoTable=npIoTable, FixedPoint1000=FixedPoint1000, npRelHumEntry=npRelHumEntry, npSmokeTrap=npSmokeTrap, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoLineN=npIoLineN, npIoLevelOut=npIoLevelOut, npIoMemo=npIoMemo, npIoTrapMemo=npIoTrapMemo, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npTrapInfo=npTrapInfo, npThermoTrapLow=npThermoTrapLow, npSmokeTable=npSmokeTable, npIrPlayCmd=npIrPlayCmd, npRelayState=npRelayState, npRelayStartReset=npRelayStartReset, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTraps=npCurLoopTraps, npSmokeSensorN=npSmokeSensorN, npThermoLow=npThermoLow, npCurLoopTrap=npCurLoopTrap, npThermoTable=npThermoTable, npSmokeTraps=npSmokeTraps, npIrStatus=npIrStatus, npRelayMode=npRelayMode, npSmokeReset=npSmokeReset, npCurLoopTable=npCurLoopTable, npIr=npIr, npThermoTrapMemo=npThermoTrapMemo, npCurLoopPower=npCurLoopPower, npRelHumTrapSafe=npRelHumTrapSafe, npThermo=npThermo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeStatus=npSmokeStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumValue=npRelHumValue, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeMemo=npSmokeMemo, npThermoHigh=npThermoHigh, npReboot=npReboot, npSoftReboot=npSoftReboot, npRelHumTrapFail=npRelHumTrapFail, npThermoStatus=npThermoStatus, npCurLoopTrapN=npCurLoopTrapN, npIoTrapLevelLegend=npIoTrapLevelLegend, lightcom=lightcom, npIoTrapLevelIn=npIoTrapLevelIn, npRelay=npRelay, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIo=npIo, npCurLoopV=npCurLoopV, npThermoTraps=npThermoTraps)
