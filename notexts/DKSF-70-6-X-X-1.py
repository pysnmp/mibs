...
# Produced by pysmi-1.1.8 at Tue Sep 12 08:10:28 2023
...
Gauge32, ObjectIdentity, NotificationType, enterprises, TimeTicks, ModuleIdentity, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Bits, Counter64, Counter32, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "NotificationType", "enterprises", "TimeTicks", "ModuleIdentity", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Bits", "Counter64", "Counter32", "iso", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoStatus=npThermoStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeStatus=npSmokeStatus, npThermoValuePrecise=npThermoValuePrecise, npTrapEmailTo=npTrapEmailTo, npRelayMemo=npRelayMemo, npIoLevelIn=npIoLevelIn, npCurLoopStatus=npCurLoopStatus, npThermoTable=npThermoTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrap=npIoTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmFailed=npGsmFailed, uniPingServerSolutionV3=uniPingServerSolutionV3, npIrStatus=npIrStatus, npRelayState=npRelayState, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumMemo=npRelHumMemo, npIrCtrl=npIrCtrl, npRelayStartReset=npRelayStartReset, npRelHumTrap=npRelHumTrap, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapData=npRelHumTrapData, npIoPulseCounter=npIoPulseCounter, npIoTrapLineN=npIoTrapLineN, npCurLoopEntry=npCurLoopEntry, npIoTrapLevelLegend=npIoTrapLevelLegend, npReboot=npReboot, npSmoke=npSmoke, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIrPlayCmd=npIrPlayCmd, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopI=npCurLoopI, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapSafe=npRelHumTrapSafe, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrap=npCurLoopTrap, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapPrefix=npIoTrapPrefix, npIrReset=npIrReset, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoMemo=npThermoMemo, npResetStack=npResetStack, npThermoValue=npThermoValue, npRelay=npRelay, npThermo=npThermo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoop=npCurLoop, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapFail=npRelHumTrapFail, npGsmTraps=npGsmTraps, npIoLineN=npIoLineN, npCurLoopTraps=npCurLoopTraps, npThermoSensorN=npThermoSensorN, npTrapInfo=npTrapInfo, lightcom=lightcom, npForcedReboot=npForcedReboot, npGsm=npGsm, npSoftReboot=npSoftReboot, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataN=npRelHumTrapDataN, npThermoHigh=npThermoHigh, npCurLoopN=npCurLoopN, npSmokeTrapPrefix=npSmokeTrapPrefix, npIo=npIo, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayN=npRelayN, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumStatus=npRelHumStatus, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrap=npSmokeTrap, npThermoEntry=npThermoEntry, npSmokeTable=npSmokeTable, npRelHumN=npRelHumN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokePower=npSmokePower, npRelHumTable=npRelHumTable, npSmokeReset=npSmokeReset, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIr=npIr, npCurLoopTrapI=npCurLoopTrapI, npThermoTrapValue=npThermoTrapValue, npThermoTrap=npThermoTrap, npRelHumidity=npRelHumidity, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeMemo=npSmokeMemo, npCurLoopV=npCurLoopV, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmRegistration=npGsmRegistration, npRelHumValue=npRelHumValue, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTraps=npThermoTraps, npIoLevelOut=npIoLevelOut, npRelayTable=npRelayTable, npIoMemo=npIoMemo, npCurLoopTable=npCurLoopTable, npGsmInfo=npGsmInfo, npIoTable=npIoTable, npSmokeSensorN=npSmokeSensorN, npIoEntry=npIoEntry, npRelayMode=npRelayMode, npSmokeTraps=npSmokeTraps, FixedPoint1000=FixedPoint1000, npThermoTrapStatus=npThermoTrapStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTraps=npIoTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelayEntry=npRelayEntry, npThermoTrapLow=npThermoTrapLow, npThermoLow=npThermoLow, npCurLoopR=npCurLoopR, npThermoTrapHigh=npThermoTrapHigh, npCurLoopPower=npCurLoopPower, npRelHumEntry=npRelHumEntry, npCurLoopTrapR=npCurLoopTrapR, npGsmTrap=npGsmTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeEntry=npSmokeEntry, npCurLoopTrapN=npCurLoopTrapN, npGsmStrength=npGsmStrength)
