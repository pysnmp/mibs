...
# Produced by pysmi-1.1.3 at Sun Nov 21 01:07:45 2021
...
Unsigned32, Integer32, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, Bits, MibIdentifier, Gauge32, TimeTicks, ObjectIdentity, ModuleIdentity, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "Bits", "MibIdentifier", "Gauge32", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "Counter32", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmSendSmsUtf8=npGsmSendSmsUtf8, npTrapEmailTo=npTrapEmailTo, npIoTrap=npIoTrap, npSmokeTrap=npSmokeTrap, npThermoSensorN=npThermoSensorN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopN=npCurLoopN, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumStatus=npRelHumStatus, npSoftReboot=npSoftReboot, npGsmStrength=npGsmStrength, npThermoTrapValue=npThermoTrapValue, npThermoTable=npThermoTable, npThermoTrap=npThermoTrap, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrPlayCmd=npIrPlayCmd, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIo=npIo, npRelHumTrap=npRelHumTrap, npRelayTable=npRelayTable, npRelayEntry=npRelayEntry, npSmokePower=npSmokePower, npIoTrapLineN=npIoTrapLineN, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapN=npCurLoopTrapN, npThermoEntry=npThermoEntry, lightcom=lightcom, npGsm=npGsm, npIoTable=npIoTable, npThermoMemo=npThermoMemo, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTempValue=npRelHumTempValue, npRelHumMemo=npRelHumMemo, npResetStack=npResetStack, npCurLoopTrapV=npCurLoopTrapV, npRelHumTable=npRelHumTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npReboot=npReboot, npRelayState=npRelayState, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayStartReset=npRelayStartReset, npThermoLow=npThermoLow, npRelHumValue=npRelHumValue, npForcedReboot=npForcedReboot, FixedPoint1000=FixedPoint1000, npSmokeTable=npSmokeTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmTrap=npGsmTrap, npCurLoopV=npCurLoopV, npThermoTrapMemo=npThermoTrapMemo, npRelay=npRelay, npCurLoopPower=npCurLoopPower, npThermoValue=npThermoValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoMemo=npIoMemo, npCurLoopTrapI=npCurLoopTrapI, npRelayMode=npRelayMode, npCurLoopStatus=npCurLoopStatus, npThermoHigh=npThermoHigh, npIoTraps=npIoTraps, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapStatus=npThermoTrapStatus, npGsmTraps=npGsmTraps, npIr=npIr, npThermo=npThermo, npCurLoopR=npCurLoopR, npThermoTrapHigh=npThermoTrapHigh, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayN=npRelayN, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeStatus=npSmokeStatus, npIrStatus=npIrStatus, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapLow=npThermoTrapLow, npTrapInfo=npTrapInfo, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTemp=npRelHumTrapTemp, npIrCtrl=npIrCtrl, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npIoLevelOut=npIoLevelOut, npSmokeTraps=npSmokeTraps, npSmokeMemo=npSmokeMemo, npIrReset=npIrReset, npSmoke=npSmoke, npCurLoopTable=npCurLoopTable, npThermoTraps=npThermoTraps, npSmokeEntry=npSmokeEntry, npIoEntry=npIoEntry, npIoLineN=npIoLineN, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumEntry=npRelHumEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeReset=npSmokeReset, npRelHumTrapFail=npRelHumTrapFail, npCurLoop=npCurLoop, npRelHumN=npRelHumN, npGsmInfo=npGsmInfo, npIoPulseCounter=npIoPulseCounter, npCurLoopTrap=npCurLoopTrap, npThermoStatus=npThermoStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumidity=npRelHumidity, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmRegistration=npGsmRegistration, npIoTrapMemo=npIoTrapMemo, npRelayMemo=npRelayMemo, npCurLoopI=npCurLoopI, npCurLoopEntry=npCurLoopEntry, npIoLevelIn=npIoLevelIn, npGsmFailed=npGsmFailed)
