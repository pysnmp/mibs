...
Bits, Counter64, IpAddress, ObjectIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, TimeTicks, Unsigned32, MibIdentifier, Integer32, NotificationType, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "IpAddress", "ObjectIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "TimeTicks", "Unsigned32", "MibIdentifier", "Integer32", "NotificationType", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeEntry=npSmokeEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumN=npRelHumN, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapR=npCurLoopTrapR, npThermoHigh=npThermoHigh, npRelHumTrapDataStatus=npRelHumTrapDataStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoEntry=npIoEntry, npCurLoopTable=npCurLoopTable, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrap=npIoTrap, npCurLoopEntry=npCurLoopEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoMemo=npThermoMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npTrapInfo=npTrapInfo, lightcom=lightcom, npRelHumValue=npRelHumValue, npSmokeTraps=npSmokeTraps, npRelHumidity=npRelHumidity, npRelHumEntry=npRelHumEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrap=npThermoTrap, npThermoSensorN=npThermoSensorN, FixedPoint1000=FixedPoint1000, npIrStatus=npIrStatus, npThermoStatus=npThermoStatus, npThermoTrapLow=npThermoTrapLow, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapPrefix=npThermoTrapPrefix, npGsmInfo=npGsmInfo, npRelHumTrap=npRelHumTrap, npThermo=npThermo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npTrapEmailTo=npTrapEmailTo, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoValue=npThermoValue, npIoTable=npIoTable, npGsm=npGsm, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrap=npCurLoopTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTrapStatus=npSmokeTrapStatus, npIrReset=npIrReset, npIoPulseCounter=npIoPulseCounter, npReboot=npReboot, npGsmStrength=npGsmStrength, npThermoEntry=npThermoEntry, npRelHumTrapData=npRelHumTrapData, npThermoTrapValue=npThermoTrapValue, npSmokeTable=npSmokeTable, npCurLoopR=npCurLoopR, npCurLoopV=npCurLoopV, npRelHumMemo=npRelHumMemo, npIoLevelIn=npIoLevelIn, npCurLoopN=npCurLoopN, npSmokeReset=npSmokeReset, npIr=npIr, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeStatus=npSmokeStatus, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSoftReboot=npSoftReboot, npSmokeTrap=npSmokeTrap, npRelayTable=npRelayTable, npIo=npIo, npIoTrapPrefix=npIoTrapPrefix, npCurLoopStatus=npCurLoopStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTraps=npThermoTraps, npIoTrapLevelIn=npIoTrapLevelIn, npRelayMemo=npRelayMemo, npRelayStartReset=npRelayStartReset, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoLevelOut=npIoLevelOut, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopPower=npCurLoopPower, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTemp=npRelHumTrapTemp, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelay=npRelay, npCurLoopTraps=npCurLoopTraps, npThermoTrapMemo=npThermoTrapMemo, npRelHumTable=npRelHumTable, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoLow=npThermoLow, npIoLineN=npIoLineN, npGsmTraps=npGsmTraps, npIoTrapMemo=npIoTrapMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopI=npCurLoopI, npSmoke=npSmoke, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapLineN=npIoTrapLineN, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapV=npCurLoopTrapV, npSmokePower=npSmokePower, npCurLoop=npCurLoop, npThermoTable=npThermoTable, npIrCtrl=npIrCtrl, npSmokeMemo=npSmokeMemo, npResetStack=npResetStack, npRelHumTrapFail=npRelHumTrapFail, npGsmTrap=npGsmTrap, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayState=npRelayState, npIrPlayCmd=npIrPlayCmd, npForcedReboot=npForcedReboot, npRelayN=npRelayN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelayMode=npRelayMode, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTempStatus=npRelHumTempStatus, npSmokeSensorN=npSmokeSensorN, npRelHumStatus=npRelHumStatus, npIoTraps=npIoTraps, npIoMemo=npIoMemo, npGsmFailed=npGsmFailed, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayEntry=npRelayEntry, npGsmRegistration=npGsmRegistration)
