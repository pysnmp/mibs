...
Bits, IpAddress, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, TimeTicks, NotificationType, Gauge32, ModuleIdentity, ObjectIdentity, enterprises, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "TimeTicks", "NotificationType", "Gauge32", "ModuleIdentity", "ObjectIdentity", "enterprises", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrap=npIoTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIr=npIr, lightcom=lightcom, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoLevelIn=npIoLevelIn, npTrapEmailTo=npTrapEmailTo, npThermoTrapValue=npThermoTrapValue, npIoLineN=npIoLineN, npSmokeMemo=npSmokeMemo, npCurLoopTrapR=npCurLoopTrapR, npGsmFailed=npGsmFailed, npRelHumEntry=npRelHumEntry, npRelHumMemo=npRelHumMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoMemo=npIoMemo, npIoTrapLevelIn=npIoTrapLevelIn, npThermo=npThermo, npSmokeReset=npSmokeReset, npGsmStrength=npGsmStrength, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapSensorN=npThermoTrapSensorN, npThermoStatus=npThermoStatus, npThermoEntry=npThermoEntry, npSmokeSensorN=npSmokeSensorN, npCurLoopTrapN=npCurLoopTrapN, npTrapInfo=npTrapInfo, npIoTrapLineN=npIoTrapLineN, npThermoTrapPrefix=npThermoTrapPrefix, npRelayStartReset=npRelayStartReset, npRelayMemo=npRelayMemo, npSmokePower=npSmokePower, npRelHumTrapData=npRelHumTrapData, npIoEntry=npIoEntry, npThermoTrap=npThermoTrap, npCurLoopEntry=npCurLoopEntry, npRelHumValue=npRelHumValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapMemo=npThermoTrapMemo, npCurLoopPower=npCurLoopPower, npRelHumSafeRangeLow=npRelHumSafeRangeLow, FixedPoint1000=FixedPoint1000, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTempStatus=npRelHumTempStatus, npGsmTraps=npGsmTraps, npCurLoopTrapI=npCurLoopTrapI, npGsmRegistration=npGsmRegistration, npSoftReboot=npSoftReboot, npRelHumStatus=npRelHumStatus, npIoPulseCounter=npIoPulseCounter, npGsm=npGsm, npSmokeTrap=npSmokeTrap, npIoTrapPrefix=npIoTrapPrefix, npRelHumTempValue=npRelHumTempValue, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapV=npCurLoopTrapV, npIoTable=npIoTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopI=npCurLoopI, npCurLoopTraps=npCurLoopTraps, npCurLoopR=npCurLoopR, npIrCtrl=npIrCtrl, npReboot=npReboot, npGsmInfo=npGsmInfo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTrapStatus=npSmokeTrapStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelay=npRelay, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapFail=npRelHumTrapFail, npThermoTable=npThermoTable, npRelHumTrapDataN=npRelHumTrapDataN, npRelayState=npRelayState, npIrReset=npIrReset, npIoLevelOut=npIoLevelOut, npRelHumTable=npRelHumTable, npSmokeEntry=npSmokeEntry, npRelayEntry=npRelayEntry, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTraps=npThermoTraps, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTraps=npIoTraps, npRelayN=npRelayN, npCurLoop=npCurLoop, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrap=npRelHumTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoSensorN=npThermoSensorN, npRelHumN=npRelHumN, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTrapMemo=npSmokeTrapMemo, npThermoLow=npThermoLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTable=npSmokeTable, npCurLoopN=npCurLoopN, npCurLoopTable=npCurLoopTable, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npForcedReboot=npForcedReboot, npThermoValue=npThermoValue, npIrStatus=npIrStatus, npSmoke=npSmoke, npThermoMemo=npThermoMemo, npGsmTrap=npGsmTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTraps=npSmokeTraps, npRelayMode=npRelayMode, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopV=npCurLoopV, npSmokeStatus=npSmokeStatus, npCurLoopTrap=npCurLoopTrap, npRelayTable=npRelayTable, npThermoHigh=npThermoHigh, npResetStack=npResetStack, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIo=npIo, npRelHumidity=npRelHumidity, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapMemo=npIoTrapMemo)
