...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, iso, Counter64, MibIdentifier, ModuleIdentity, Counter32, ObjectIdentity, IpAddress, Bits, TimeTicks, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "iso", "Counter64", "MibIdentifier", "ModuleIdentity", "Counter32", "ObjectIdentity", "IpAddress", "Bits", "TimeTicks", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopEntry=npCurLoopEntry, npIoLineN=npIoLineN, npRelHumTable=npRelHumTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapValue=npThermoTrapValue, npRelayMode=npRelayMode, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTrap=npSmokeTrap, npRelayMemo=npRelayMemo, npIrCtrl=npIrCtrl, npIo=npIo, npIoTrapLineN=npIoTrapLineN, npRelHumN=npRelHumN, npSmokeTrapStatus=npSmokeTrapStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoValuePrecise=npThermoValuePrecise, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeTrapMemo=npSmokeTrapMemo, npGsmTraps=npGsmTraps, npForcedReboot=npForcedReboot, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTable=npSmokeTable, npGsm=npGsm, npGsmInfo=npGsmInfo, npRelHumTempStatus=npRelHumTempStatus, npRelay=npRelay, npSmokeSensorN=npSmokeSensorN, npThermoTrap=npThermoTrap, npCurLoopTraps=npCurLoopTraps, npSmokeTraps=npSmokeTraps, npCurLoopTrapI=npCurLoopTrapI, npTrapInfo=npTrapInfo, npSmokeReset=npSmokeReset, npRelHumMemo=npRelHumMemo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npTrapEmailTo=npTrapEmailTo, npThermoTraps=npThermoTraps, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapData=npRelHumTrapData, npIoPulseCounter=npIoPulseCounter, npSmokeMemo=npSmokeMemo, npThermoHigh=npThermoHigh, npCurLoopPower=npCurLoopPower, npRelayStartReset=npRelayStartReset, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTrapMemo=npIoTrapMemo, npRelHumidity=npRelHumidity, npReboot=npReboot, npThermoTrapLow=npThermoTrapLow, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayState=npRelayState, npSoftReboot=npSoftReboot, npRelHumTrap=npRelHumTrap, npIoMemo=npIoMemo, npIoLevelIn=npIoLevelIn, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmTrap=npGsmTrap, npThermoLow=npThermoLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoSensorN=npThermoSensorN, npIoLevelOut=npIoLevelOut, npIrReset=npIrReset, npThermoEntry=npThermoEntry, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmRegistration=npGsmRegistration, npSmokeEntry=npSmokeEntry, npRelHumValue=npRelHumValue, npThermoTrapPrefix=npThermoTrapPrefix, npThermoValue=npThermoValue, npCurLoop=npCurLoop, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapStatus=npThermoTrapStatus, lightcom=lightcom, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTable=npIoTable, npIoEntry=npIoEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrap=npIoTrap, npThermoTable=npThermoTable, npSmoke=npSmoke, npCurLoopI=npCurLoopI, npThermoTrapMemo=npThermoTrapMemo, npSmokeStatus=npSmokeStatus, npCurLoopTrap=npCurLoopTrap, npResetStack=npResetStack, npRelayTable=npRelayTable, npSmokePower=npSmokePower, npGsmStrength=npGsmStrength, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumStatus=npRelHumStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayN=npRelayN, npSmokeTrapSensorN=npSmokeTrapSensorN, npIr=npIr, npCurLoopStatus=npCurLoopStatus, npRelHumTempValue=npRelHumTempValue, npIrStatus=npIrStatus, npIoTraps=npIoTraps, npGsmFailed=npGsmFailed, npCurLoopTable=npCurLoopTable, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumEntry=npRelHumEntry, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, FixedPoint1000=FixedPoint1000, npCurLoopN=npCurLoopN, npThermoMemo=npThermoMemo, npCurLoopV=npCurLoopV, npIoSinglePulseStart=npIoSinglePulseStart, npIrPlayCmd=npIrPlayCmd, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopR=npCurLoopR, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermo=npThermo, npThermoStatus=npThermoStatus, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapPower=npCurLoopTrapPower, npRelayEntry=npRelayEntry, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapSafe=npRelHumTrapSafe)
