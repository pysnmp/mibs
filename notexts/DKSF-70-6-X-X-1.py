...
# Produced by pysmi-1.1.8 at Tue Jan 18 14:10:12 2022
...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, Gauge32, iso, NotificationType, MibIdentifier, ObjectIdentity, Counter32, enterprises, ModuleIdentity, Integer32, TimeTicks, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "Gauge32", "iso", "NotificationType", "MibIdentifier", "ObjectIdentity", "Counter32", "enterprises", "ModuleIdentity", "Integer32", "TimeTicks", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermo=npThermo, npSmoke=npSmoke, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrStatus=npIrStatus, npIoLevelIn=npIoLevelIn, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTable=npIoTable, npRelHumTrapSafe=npRelHumTrapSafe, npIoTraps=npIoTraps, npGsmFailed=npGsmFailed, npReboot=npReboot, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTraps=npCurLoopTraps, npRelHumTrapData=npRelHumTrapData, npCurLoopN=npCurLoopN, npSoftReboot=npSoftReboot, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmTrap=npGsmTrap, npIoPulseCounter=npIoPulseCounter, npRelHumTable=npRelHumTable, npRelayState=npRelayState, npThermoLow=npThermoLow, npIoTrapLineN=npIoTrapLineN, npCurLoopPower=npCurLoopPower, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIrReset=npIrReset, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumN=npRelHumN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayMode=npRelayMode, npThermoTrap=npThermoTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapLow=npThermoTrapLow, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, FixedPoint1000=FixedPoint1000, npCurLoopTable=npCurLoopTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmInfo=npGsmInfo, npIrPlayCmd=npIrPlayCmd, npTrapInfo=npTrapInfo, npThermoTraps=npThermoTraps, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoop=npCurLoop, npSmokeMemo=npSmokeMemo, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapHigh=npThermoTrapHigh, npSmokePower=npSmokePower, npSmokeReset=npSmokeReset, npSmokeTraps=npSmokeTraps, npRelHumMemo=npRelHumMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmStrength=npGsmStrength, npRelHumValue=npRelHumValue, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapValue=npThermoTrapValue, npRelHumTempStatus=npRelHumTempStatus, npThermoEntry=npThermoEntry, npRelHumEntry=npRelHumEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrap=npCurLoopTrap, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopR=npCurLoopR, npIoMemo=npIoMemo, npIoLineN=npIoLineN, npRelHumStatus=npRelHumStatus, npRelayEntry=npRelayEntry, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopEntry=npCurLoopEntry, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapN=npCurLoopTrapN, npForcedReboot=npForcedReboot, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmTrapPrefix=npGsmTrapPrefix, lightcom=lightcom, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npSmokeSensorN=npSmokeSensorN, npThermoValue=npThermoValue, npSmokeTable=npSmokeTable, npThermoSensorN=npThermoSensorN, npRelayMemo=npRelayMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayStartReset=npRelayStartReset, npIoLevelOut=npIoLevelOut, npIoSinglePulseStart=npIoSinglePulseStart, npRelayTable=npRelayTable, npGsmTraps=npGsmTraps, npRelHumTrap=npRelHumTrap, npTrapEmailTo=npTrapEmailTo, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeStatus=npSmokeStatus, npIo=npIo, npIoEntry=npIoEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoHigh=npThermoHigh, npResetStack=npResetStack, npCurLoopV=npCurLoopV, npIoTrap=npIoTrap, npRelay=npRelay, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapLevelLegend=npIoTrapLevelLegend, uniPingServerSolutionV3=uniPingServerSolutionV3, npIr=npIr, npSmokeTrap=npSmokeTrap, npRelHumTrapFail=npRelHumTrapFail, npGsmRegistration=npGsmRegistration, npIrCtrl=npIrCtrl, npThermoStatus=npThermoStatus, npThermoTable=npThermoTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTrapMemo=npIoTrapMemo, npGsm=npGsm, npRelayN=npRelayN, npThermoTrapMemo=npThermoTrapMemo, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeEntry=npSmokeEntry, npThermoMemo=npThermoMemo, npRelHumidity=npRelHumidity, npCurLoopI=npCurLoopI)
