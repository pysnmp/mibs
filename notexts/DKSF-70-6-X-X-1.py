...
Bits, enterprises, TimeTicks, Integer32, Counter32, ObjectIdentity, IpAddress, Counter64, Gauge32, MibIdentifier, NotificationType, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "enterprises", "TimeTicks", "Integer32", "Counter32", "ObjectIdentity", "IpAddress", "Counter64", "Gauge32", "MibIdentifier", "NotificationType", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmoke=npSmoke, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIr=npIr, npThermoTraps=npThermoTraps, npSmokeTrap=npSmokeTrap, npCurLoop=npCurLoop, npCurLoopR=npCurLoopR, npRelHumTrapFail=npRelHumTrapFail, npThermoValue=npThermoValue, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapPrefix=npThermoTrapPrefix, npThermo=npThermo, npCurLoopN=npCurLoopN, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsm=npGsm, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapLineN=npIoTrapLineN, npCurLoopEntry=npCurLoopEntry, npThermoMemo=npThermoMemo, npGsmInfo=npGsmInfo, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumidity=npRelHumidity, npCurLoopTable=npCurLoopTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopPower=npCurLoopPower, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSoftReboot=npSoftReboot, npThermoSensorN=npThermoSensorN, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumStatus=npRelHumStatus, npThermoValuePrecise=npThermoValuePrecise, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, lightcom=lightcom, npIoTrapPrefix=npIoTrapPrefix, npGsmRegistration=npGsmRegistration, npIoTrapMemo=npIoTrapMemo, npSmokeEntry=npSmokeEntry, npRelayTable=npRelayTable, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrap=npCurLoopTrap, npIoTrap=npIoTrap, npResetStack=npResetStack, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTempValue=npRelHumTempValue, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayState=npRelayState, npTrapInfo=npTrapInfo, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTable=npThermoTable, npSmokeTable=npSmokeTable, npRelayN=npRelayN, npRelayStartReset=npRelayStartReset, npIoMemo=npIoMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeSensorN=npSmokeSensorN, npGsmTraps=npGsmTraps, npRelayEntry=npRelayEntry, npRelHumValue=npRelHumValue, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeReset=npSmokeReset, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmStrength=npGsmStrength, npIoTable=npIoTable, npRelHumN=npRelHumN, npRelHumTrapDataN=npRelHumTrapDataN, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIrReset=npIrReset, npIrPlayCmd=npIrPlayCmd, npThermoTrap=npThermoTrap, npReboot=npReboot, npCurLoopTrapN=npCurLoopTrapN, FixedPoint1000=FixedPoint1000, npThermoTrapMemo=npThermoTrapMemo, npRelHumEntry=npRelHumEntry, npRelHumTrap=npRelHumTrap, npIoTraps=npIoTraps, npIrStatus=npIrStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmTrap=npGsmTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelay=npRelay, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeStatus=npSmokeStatus, npIoPulseCounter=npIoPulseCounter, npIrCtrl=npIrCtrl, npThermoTrapStatus=npThermoTrapStatus, npSmokePower=npSmokePower, npRelHumTempStatus=npRelHumTempStatus, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeMemo=npSmokeMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTable=npRelHumTable, npCurLoopTrapV=npCurLoopTrapV, npRelHumMemo=npRelHumMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoStatus=npThermoStatus, npRelayMemo=npRelayMemo, npCurLoopTrapI=npCurLoopTrapI, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapValue=npThermoTrapValue, npIoSinglePulseStart=npIoSinglePulseStart, npIoEntry=npIoEntry, npCurLoopTraps=npCurLoopTraps, npIoLevelIn=npIoLevelIn, npCurLoopI=npCurLoopI, npIoLineN=npIoLineN, npSmokeTraps=npSmokeTraps, npCurLoopV=npCurLoopV, npThermoTrapLow=npThermoTrapLow, npTrapEmailTo=npTrapEmailTo, npThermoEntry=npThermoEntry, npRelayMode=npRelayMode, npGsmFailed=npGsmFailed, npThermoLow=npThermoLow, npIoLevelOut=npIoLevelOut, npCurLoopStatus=npCurLoopStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npForcedReboot=npForcedReboot, npThermoHigh=npThermoHigh, npIo=npIo)
