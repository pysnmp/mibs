...
TimeTicks, NotificationType, Integer32, Gauge32, iso, ObjectIdentity, Unsigned32, MibIdentifier, Bits, ModuleIdentity, IpAddress, enterprises, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "Integer32", "Gauge32", "iso", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Bits", "ModuleIdentity", "IpAddress", "enterprises", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayStartReset=npRelayStartReset, npRelHumN=npRelHumN, npIoTraps=npIoTraps, npRelayMemo=npRelayMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIr=npIr, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapN=npCurLoopTrapN, npGsmInfo=npGsmInfo, npSmokeStatus=npSmokeStatus, npRelayTable=npRelayTable, npIrCtrl=npIrCtrl, npGsmRegistration=npGsmRegistration, npCurLoopTable=npCurLoopTable, npRelHumTrapSafe=npRelHumTrapSafe, npIrReset=npIrReset, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoEntry=npThermoEntry, npRelayMode=npRelayMode, npSmokeTrapPrefix=npSmokeTrapPrefix, npResetStack=npResetStack, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumStatus=npRelHumStatus, npCurLoopTrapV=npCurLoopTrapV, npThermoValue=npThermoValue, npThermoTrapLow=npThermoTrapLow, npSmokePower=npSmokePower, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoMemo=npThermoMemo, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopR=npCurLoopR, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapI=npCurLoopTrapI, npSmokeEntry=npSmokeEntry, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTable=npRelHumTable, npRelHumTrap=npRelHumTrap, npCurLoop=npCurLoop, npRelHumEntry=npRelHumEntry, npThermoTrapValue=npThermoTrapValue, npRelayN=npRelayN, npIoLevelIn=npIoLevelIn, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumidity=npRelHumidity, npCurLoopPower=npCurLoopPower, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelayState=npRelayState, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempFail=npRelHumTrapTempFail, npTrapInfo=npTrapInfo, npThermoValuePrecise=npThermoValuePrecise, npGsmTrap=npGsmTrap, npCurLoopV=npCurLoopV, npCurLoopEntry=npCurLoopEntry, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npIoTrapMemo=npIoTrapMemo, npIoLevelOut=npIoLevelOut, npIo=npIo, npSmoke=npSmoke, npSmokeTraps=npSmokeTraps, npThermoTable=npThermoTable, npRelayEntry=npRelayEntry, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTrap=npSmokeTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopN=npCurLoopN, npThermoStatus=npThermoStatus, npRelHumTrapDataN=npRelHumTrapDataN, npThermoLow=npThermoLow, npTrapEmailTo=npTrapEmailTo, npCurLoopTrap=npCurLoopTrap, npThermo=npThermo, npIoMemo=npIoMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, lightcom=lightcom, npSmokeMemo=npSmokeMemo, npSmokeReset=npSmokeReset, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapR=npCurLoopTrapR, npGsmStrength=npGsmStrength, npIoTable=npIoTable, npRelHumValue=npRelHumValue, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npReboot=npReboot, npCurLoopI=npCurLoopI, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTraps=npCurLoopTraps, npRelay=npRelay, npIrPlayCmd=npIrPlayCmd, npIoTrap=npIoTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrap=npThermoTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoEntry=npIoEntry, npRelHumTrapData=npRelHumTrapData, npGsmFailed=npGsmFailed, FixedPoint1000=FixedPoint1000, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSoftReboot=npSoftReboot, npIrStatus=npIrStatus, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopStatus=npCurLoopStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoLineN=npIoLineN, npIoTrapLevelIn=npIoTrapLevelIn, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapLineN=npIoTrapLineN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTrapStatus=npSmokeTrapStatus, npThermoSensorN=npThermoSensorN, npRelHumMemo=npRelHumMemo, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTraps=npThermoTraps, npSmokeTable=npSmokeTable, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapMemo=npThermoTrapMemo, npThermoHigh=npThermoHigh, npThermoTrapSensorN=npThermoTrapSensorN, npGsmTraps=npGsmTraps, npGsm=npGsm, npForcedReboot=npForcedReboot)
