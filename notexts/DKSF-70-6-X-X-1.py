...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, ModuleIdentity, Counter32, Counter64, ObjectIdentity, Gauge32, Unsigned32, MibIdentifier, TimeTicks, enterprises, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "ModuleIdentity", "Counter32", "Counter64", "ObjectIdentity", "Gauge32", "Unsigned32", "MibIdentifier", "TimeTicks", "enterprises", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoValuePrecise=npThermoValuePrecise, npSmokeSensorN=npSmokeSensorN, npIoTrapPrefix=npIoTrapPrefix, npIrPlayCmd=npIrPlayCmd, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTable=npIoTable, npThermoValue=npThermoValue, npCurLoopTraps=npCurLoopTraps, npRelHumValue=npRelHumValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapFail=npRelHumTrapFail, npSmokeTrapSensorN=npSmokeTrapSensorN, npReboot=npReboot, npRelHumStatus=npRelHumStatus, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopV=npCurLoopV, npThermo=npThermo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopI=npCurLoopI, npRelHumMemo=npRelHumMemo, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopStatus=npCurLoopStatus, npIr=npIr, npRelay=npRelay, npTrapInfo=npTrapInfo, npThermoHigh=npThermoHigh, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmRegistration=npGsmRegistration, npGsmTrap=npGsmTrap, npCurLoopTrapR=npCurLoopTrapR, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoEntry=npIoEntry, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoop=npCurLoop, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopEntry=npCurLoopEntry, npSmokeStatus=npSmokeStatus, npThermoStatus=npThermoStatus, npThermoTraps=npThermoTraps, npThermoTrapLow=npThermoTrapLow, npSmokeTable=npSmokeTable, npSmokeReset=npSmokeReset, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmSendSmsWin1251=npGsmSendSmsWin1251, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIrReset=npIrReset, npRelayEntry=npRelayEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrap=npCurLoopTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopPower=npCurLoopPower, npRelHumidity=npRelHumidity, npRelHumN=npRelHumN, npIoMemo=npIoMemo, npRelayTable=npRelayTable, npCurLoopN=npCurLoopN, npRelayN=npRelayN, npSmoke=npSmoke, npSmokeEntry=npSmokeEntry, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTempStatus=npRelHumTempStatus, npGsm=npGsm, npGsmTraps=npGsmTraps, npThermoTrap=npThermoTrap, npSoftReboot=npSoftReboot, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoLevelIn=npIoLevelIn, npThermoSensorN=npThermoSensorN, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapMemo=npIoTrapMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayStartReset=npRelayStartReset, npGsmStrength=npGsmStrength, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeMemo=npSmokeMemo, npSmokePower=npSmokePower, npGsmFailed=npGsmFailed, npThermoTable=npThermoTable, npThermoTrapValue=npThermoTrapValue, npRelHumTrapData=npRelHumTrapData, npRelayMode=npRelayMode, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTemp=npRelHumTrapTemp, lightcom=lightcom, npIoPulseCounter=npIoPulseCounter, npIoTrap=npIoTrap, npCurLoopR=npCurLoopR, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapI=npCurLoopTrapI, npThermoTrapHigh=npThermoTrapHigh, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTable=npCurLoopTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoLow=npThermoLow, npIrStatus=npIrStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIrCtrl=npIrCtrl, npIoTraps=npIoTraps, npIoLevelOut=npIoLevelOut, FixedPoint1000=FixedPoint1000, npResetStack=npResetStack, npCurLoopTrapN=npCurLoopTrapN, npRelHumEntry=npRelHumEntry, npRelHumTrap=npRelHumTrap, npIo=npIo, npCurLoopTrapV=npCurLoopTrapV, npRelayState=npRelayState, npThermoMemo=npThermoMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTraps=npSmokeTraps, npIoSinglePulseStart=npIoSinglePulseStart, npRelayMemo=npRelayMemo, npIoTrapLineN=npIoTrapLineN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoLineN=npIoLineN, npGsmInfo=npGsmInfo, npForcedReboot=npForcedReboot, npTrapEmailTo=npTrapEmailTo, npRelHumTable=npRelHumTable, npRelHumTempValue=npRelHumTempValue, npThermoEntry=npThermoEntry, npSmokeTrap=npSmokeTrap)
