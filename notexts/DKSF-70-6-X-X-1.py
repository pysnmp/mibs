...
# Produced by pysmi-1.1.8 at Mon Jan  9 09:57:16 2023
...
TimeTicks, MibIdentifier, ObjectIdentity, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, NotificationType, Bits, Unsigned32, Counter32, IpAddress, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "NotificationType", "Bits", "Unsigned32", "Counter32", "IpAddress", "iso", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npForcedReboot=npForcedReboot, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmRegistration=npGsmRegistration, npGsmStrength=npGsmStrength, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTrap=npIoTrap, npCurLoop=npCurLoop, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumStatus=npRelHumStatus, npCurLoopV=npCurLoopV, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoEntry=npThermoEntry, npCurLoopTrapPower=npCurLoopTrapPower, npThermoMemo=npThermoMemo, npThermoTrapValue=npThermoTrapValue, npRelHumTrapData=npRelHumTrapData, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapSensorN=npThermoTrapSensorN, npRelay=npRelay, npRelayTable=npRelayTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npSoftReboot=npSoftReboot, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmoke=npSmoke, npIrPlayCmd=npIrPlayCmd, npThermoTable=npThermoTable, npSmokeTraps=npSmokeTraps, npRelHumTempValue=npRelHumTempValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopR=npCurLoopR, npRelHumTrap=npRelHumTrap, npIoTable=npIoTable, npCurLoopTable=npCurLoopTable, npGsmTrap=npGsmTrap, npIoPulseCounter=npIoPulseCounter, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumValue=npRelHumValue, npGsmTraps=npGsmTraps, npCurLoopTraps=npCurLoopTraps, npThermoValuePrecise=npThermoValuePrecise, npGsmFailed=npGsmFailed, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopPower=npCurLoopPower, npRelHumTrapDataValue=npRelHumTrapDataValue, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeStatus=npSmokeStatus, npSmokeSensorN=npSmokeSensorN, npRelayEntry=npRelayEntry, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoMemo=npIoMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoLow=npThermoLow, npIoTrapLineN=npIoTrapLineN, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapR=npCurLoopTrapR, npIoLineN=npIoLineN, npResetStack=npResetStack, npRelHumTempStatus=npRelHumTempStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapN=npCurLoopTrapN, npIr=npIr, npTrapInfo=npTrapInfo, npGsm=npGsm, npThermoTrap=npThermoTrap, npRelayMemo=npRelayMemo, npSmokeReset=npSmokeReset, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npReboot=npReboot, npIrCtrl=npIrCtrl, npIrReset=npIrReset, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapFail=npRelHumTrapFail, npCurLoopI=npCurLoopI, npRelayStartReset=npRelayStartReset, npRelHumMemo=npRelHumMemo, npIoTraps=npIoTraps, npIoLevelOut=npIoLevelOut, npCurLoopEntry=npCurLoopEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokePower=npSmokePower, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeMemo=npSmokeMemo, npRelHumTrapDataN=npRelHumTrapDataN, npTrapEmailTo=npTrapEmailTo, npRelHumEntry=npRelHumEntry, FixedPoint1000=FixedPoint1000, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoHigh=npThermoHigh, npRelayState=npRelayState, npRelHumN=npRelHumN, npGsmInfo=npGsmInfo, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapLevelIn=npIoTrapLevelIn, npIoLevelIn=npIoLevelIn, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTrap=npSmokeTrap, npCurLoopTrapV=npCurLoopTrapV, npThermoSensorN=npThermoSensorN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIo=npIo, npCurLoopTrap=npCurLoopTrap, npIoEntry=npIoEntry, npThermo=npThermo, npIrStatus=npIrStatus, npRelHumTrapSafe=npRelHumTrapSafe, lightcom=lightcom, npThermoValue=npThermoValue, npSmokeTrapStatus=npSmokeTrapStatus, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayMode=npRelayMode, npRelHumTable=npRelHumTable, npSmokeEntry=npSmokeEntry, npThermoTrapLow=npThermoTrapLow, npSmokeTable=npSmokeTable, npRelHumidity=npRelHumidity, npIoTrapMemo=npIoTrapMemo, npThermoTrapPrefix=npThermoTrapPrefix, npRelayN=npRelayN, npThermoTraps=npThermoTraps, npCurLoopN=npCurLoopN, npThermoStatus=npThermoStatus, npThermoTrapMemo=npThermoTrapMemo)
