...
iso, Unsigned32, NotificationType, MibIdentifier, Integer32, Counter64, ModuleIdentity, IpAddress, Bits, ObjectIdentity, enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "NotificationType", "MibIdentifier", "Integer32", "Counter64", "ModuleIdentity", "IpAddress", "Bits", "ObjectIdentity", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTraps=npCurLoopTraps, npCurLoopTrapN=npCurLoopTrapN, npGsmInfo=npGsmInfo, npIoTable=npIoTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTraps=npIoTraps, npThermoTrapPrefix=npThermoTrapPrefix, npThermoLow=npThermoLow, npIoMemo=npIoMemo, npThermoValue=npThermoValue, npThermoStatus=npThermoStatus, FixedPoint1000=FixedPoint1000, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmTrap=npGsmTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapI=npCurLoopTrapI, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapLow=npThermoTrapLow, npRelHumN=npRelHumN, npIoLevelIn=npIoLevelIn, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayTable=npRelayTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopI=npCurLoopI, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoHigh=npThermoHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoPulseCounter=npIoPulseCounter, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeMemo=npSmokeMemo, npRelayMemo=npRelayMemo, npRelayState=npRelayState, npSmokeSensorN=npSmokeSensorN, npThermoEntry=npThermoEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopPower=npCurLoopPower, npIrStatus=npIrStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTable=npThermoTable, npIoLevelOut=npIoLevelOut, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapValue=npThermoTrapValue, npRelayN=npRelayN, npTrapInfo=npTrapInfo, npCurLoopTrap=npCurLoopTrap, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapData=npRelHumTrapData, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmoke=npSmoke, npRelHumMemo=npRelHumMemo, npRelHumTrap=npRelHumTrap, npGsmFailed=npGsmFailed, npForcedReboot=npForcedReboot, npCurLoopEntry=npCurLoopEntry, npRelHumTable=npRelHumTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumStatus=npRelHumStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTraps=npThermoTraps, npGsmStrength=npGsmStrength, npIoTrapLineN=npIoTrapLineN, npRelHumValue=npRelHumValue, npResetStack=npResetStack, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermo=npThermo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoMemo=npThermoMemo, npThermoSensorN=npThermoSensorN, npCurLoopN=npCurLoopN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTemp=npRelHumTrapTemp, npIoLineN=npIoLineN, npCurLoopR=npCurLoopR, npSmokeReset=npSmokeReset, npSoftReboot=npSoftReboot, npIr=npIr, npGsmRegistration=npGsmRegistration, npThermoTrapMemo=npThermoTrapMemo, npSmokeTrap=npSmokeTrap, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayEntry=npRelayEntry, npThermoTrapSensorN=npThermoTrapSensorN, npIoSinglePulseStart=npIoSinglePulseStart, npTrapEmailTo=npTrapEmailTo, npThermoTrap=npThermoTrap, npCurLoopV=npCurLoopV, npRelHumTempStatus=npRelHumTempStatus, npCurLoopStatus=npCurLoopStatus, npReboot=npReboot, npSmokeTraps=npSmokeTraps, npSmokeTable=npSmokeTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoop=npCurLoop, npCurLoopTrapR=npCurLoopTrapR, npIoEntry=npIoEntry, npRelHumEntry=npRelHumEntry, npRelay=npRelay, npCurLoopTable=npCurLoopTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrap=npIoTrap, npGsm=npGsm, npRelayMode=npRelayMode, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapFail=npRelHumTrapFail, lightcom=lightcom, npIrCtrl=npIrCtrl, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeStatus=npSmokeStatus, npGsmTraps=npGsmTraps, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokePower=npSmokePower, npSmokeEntry=npSmokeEntry, npIo=npIo, npIoTrapPrefix=npIoTrapPrefix, npRelHumidity=npRelHumidity, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayStartReset=npRelayStartReset, npRelHumTempValue=npRelHumTempValue, npIrReset=npIrReset, npSmokeTrapMemo=npSmokeTrapMemo)
