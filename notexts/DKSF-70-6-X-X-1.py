...
ObjectIdentity, IpAddress, Unsigned32, ModuleIdentity, iso, Integer32, TimeTicks, Bits, NotificationType, Gauge32, Counter64, MibIdentifier, Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "Unsigned32", "ModuleIdentity", "iso", "Integer32", "TimeTicks", "Bits", "NotificationType", "Gauge32", "Counter64", "MibIdentifier", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, FixedPoint1000=FixedPoint1000, npIoTrapLineN=npIoTrapLineN, npGsmTrapPrefix=npGsmTrapPrefix, npGsmTraps=npGsmTraps, npThermoEntry=npThermoEntry, npTrapInfo=npTrapInfo, npSmokeReset=npSmokeReset, npSmokeEntry=npSmokeEntry, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopV=npCurLoopV, npReboot=npReboot, npThermoTrap=npThermoTrap, npCurLoopR=npCurLoopR, npThermoValuePrecise=npThermoValuePrecise, npIoEntry=npIoEntry, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSoftReboot=npSoftReboot, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTraps=npCurLoopTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIo=npIo, npIrCtrl=npIrCtrl, npIrReset=npIrReset, npCurLoopTrapR=npCurLoopTrapR, npGsm=npGsm, npIoTrapMemo=npIoTrapMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeStatus=npSmokeStatus, npThermoTraps=npThermoTraps, npRelHumTrap=npRelHumTrap, npRelayStartReset=npRelayStartReset, npRelayMemo=npRelayMemo, npCurLoopI=npCurLoopI, npIrStatus=npIrStatus, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmRegistration=npGsmRegistration, npSmokeTraps=npSmokeTraps, npRelayN=npRelayN, npRelayTable=npRelayTable, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapV=npCurLoopTrapV, npCurLoopStatus=npCurLoopStatus, npIoLineN=npIoLineN, npCurLoopEntry=npCurLoopEntry, npRelHumidity=npRelHumidity, npIoTrap=npIoTrap, npThermoHigh=npThermoHigh, npRelay=npRelay, npIoLevelIn=npIoLevelIn, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoStatus=npThermoStatus, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeMemo=npSmokeMemo, npIoTraps=npIoTraps, npRelHumTempValue=npRelHumTempValue, npThermoSensorN=npThermoSensorN, npRelHumTable=npRelHumTable, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTable=npSmokeTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapStatus=npThermoTrapStatus, npThermoLow=npThermoLow, npIoTable=npIoTable, npThermoValue=npThermoValue, npRelHumMemo=npRelHumMemo, npRelHumEntry=npRelHumEntry, npCurLoopPower=npCurLoopPower, npCurLoopTrap=npCurLoopTrap, npRelayState=npRelayState, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapValue=npThermoTrapValue, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTable=npCurLoopTable, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoMemo=npThermoMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npIr=npIr, npCurLoopN=npCurLoopN, npIoMemo=npIoMemo, npGsmInfo=npGsmInfo, npTrapEmailTo=npTrapEmailTo, npSmokePower=npSmokePower, npForcedReboot=npForcedReboot, npCurLoopTrapI=npCurLoopTrapI, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayMode=npRelayMode, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapData=npRelHumTrapData, npRelHumStatus=npRelHumStatus, npIoLevelOut=npIoLevelOut, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmSendSmsWin1251=npGsmSendSmsWin1251, lightcom=lightcom, npIrPlayCmd=npIrPlayCmd, npSmokeTrap=npSmokeTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npResetStack=npResetStack, npRelayEntry=npRelayEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumN=npRelHumN, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumValue=npRelHumValue, npThermo=npThermo, npSmoke=npSmoke, npCurLoop=npCurLoop, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTable=npThermoTable, npGsmFailed=npGsmFailed, npThermoTrapLow=npThermoTrapLow, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmStrength=npGsmStrength, npCurLoopTrapN=npCurLoopTrapN, npGsmTrap=npGsmTrap, npRelHumTempStatus=npRelHumTempStatus)
