...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, Unsigned32, Counter64, MibIdentifier, enterprises, Bits, ModuleIdentity, Gauge32, TimeTicks, iso, NotificationType, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "Unsigned32", "Counter64", "MibIdentifier", "enterprises", "Bits", "ModuleIdentity", "Gauge32", "TimeTicks", "iso", "NotificationType", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoSinglePulseStart=npIoSinglePulseStart, npGsmRegistration=npGsmRegistration, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumValue=npRelHumValue, npIoTrapLineN=npIoTrapLineN, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapHigh=npThermoTrapHigh, npRelHumStatus=npRelHumStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokePower=npSmokePower, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapSensorN=npThermoTrapSensorN, npIoLevelOut=npIoLevelOut, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrCtrl=npIrCtrl, npCurLoopV=npCurLoopV, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmFailed=npGsmFailed, npGsmTrapPrefix=npGsmTrapPrefix, FixedPoint1000=FixedPoint1000, npCurLoopTrapPower=npCurLoopTrapPower, npThermoLow=npThermoLow, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTable=npIoTable, npSmokeSensorN=npSmokeSensorN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumEntry=npRelHumEntry, npRelHumidity=npRelHumidity, npIo=npIo, npCurLoopPower=npCurLoopPower, npTrapEmailTo=npTrapEmailTo, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTrapMemo=npSmokeTrapMemo, npGsmTraps=npGsmTraps, npIoLevelIn=npIoLevelIn, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrap=npRelHumTrap, npThermoEntry=npThermoEntry, npResetStack=npResetStack, npSmokeTraps=npSmokeTraps, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumN=npRelHumN, npCurLoopEntry=npCurLoopEntry, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayStartReset=npRelayStartReset, npSmokeTrap=npSmokeTrap, npIrStatus=npIrStatus, npCurLoopTrapR=npCurLoopTrapR, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapData=npRelHumTrapData, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTemp=npRelHumTrapTemp, npThermoStatus=npThermoStatus, npThermoMemo=npThermoMemo, npRelHumTrapSafe=npRelHumTrapSafe, npRelay=npRelay, npIoPulseCounter=npIoPulseCounter, npSmokeTable=npSmokeTable, npIoTrapMemo=npIoTrapMemo, npRelayTable=npRelayTable, npRelayMode=npRelayMode, npTrapInfo=npTrapInfo, npIr=npIr, npCurLoop=npCurLoop, npSmokeMemo=npSmokeMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapI=npCurLoopTrapI, npIrReset=npIrReset, npThermoValuePrecise=npThermoValuePrecise, npRelHumTable=npRelHumTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoValue=npThermoValue, npReboot=npReboot, lightcom=lightcom, npRelayEntry=npRelayEntry, npGsmStrength=npGsmStrength, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapV=npCurLoopTrapV, npRelHumMemo=npRelHumMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapFail=npRelHumTrapFail, npGsm=npGsm, npIoLineN=npIoLineN, npThermoTrap=npThermoTrap, npCurLoopTable=npCurLoopTable, npCurLoopR=npCurLoopR, npGsmInfo=npGsmInfo, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapValue=npThermoTrapValue, npIoEntry=npIoEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayMemo=npRelayMemo, npSoftReboot=npSoftReboot, npCurLoopTraps=npCurLoopTraps, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapN=npCurLoopTrapN, npSmokeEntry=npSmokeEntry, npCurLoopI=npCurLoopI, npIoTrapPrefix=npIoTrapPrefix, npCurLoopN=npCurLoopN, npIoMemo=npIoMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoHigh=npThermoHigh, npThermoSensorN=npThermoSensorN, npSmoke=npSmoke, npRelayState=npRelayState, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeStatus=npSmokeStatus, npThermoTraps=npThermoTraps, npRelHumTempValue=npRelHumTempValue, npThermoTrapLow=npThermoTrapLow, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermo=npThermo, npSmokeReset=npSmokeReset, npForcedReboot=npForcedReboot, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTable=npThermoTable, npGsmTrap=npGsmTrap, npCurLoopTrap=npCurLoopTrap, npRelHumTempStatus=npRelHumTempStatus, npRelayN=npRelayN, npIoTrap=npIoTrap, npIoTraps=npIoTraps)
