...
# Produced by pysmi-1.1.8 at Sat Jan 15 23:29:41 2022
...
NotificationType, ObjectIdentity, Integer32, IpAddress, MibIdentifier, Bits, Counter64, Counter32, enterprises, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "Integer32", "IpAddress", "MibIdentifier", "Bits", "Counter64", "Counter32", "enterprises", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapSafe=npRelHumTrapSafe, npGsmTrap=npGsmTrap, npSoftReboot=npSoftReboot, npRelHumidity=npRelHumidity, npThermoValuePrecise=npThermoValuePrecise, npThermoTrap=npThermoTrap, npRelHumTempValue=npRelHumTempValue, npIo=npIo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapHigh=npThermoTrapHigh, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeEntry=npSmokeEntry, npReboot=npReboot, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoValue=npThermoValue, npGsmTrapPrefix=npGsmTrapPrefix, npTrapEmailTo=npTrapEmailTo, npRelHumMemo=npRelHumMemo, npThermoHigh=npThermoHigh, npThermoTraps=npThermoTraps, npIoMemo=npIoMemo, npRelHumTable=npRelHumTable, npRelHumN=npRelHumN, npIoEntry=npIoEntry, npIoTrapMemo=npIoTrapMemo, npRelHumValue=npRelHumValue, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTable=npThermoTable, npCurLoopTrapR=npCurLoopTrapR, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTrapStatus=npSmokeTrapStatus, npThermoStatus=npThermoStatus, npSmokeTrapMemo=npSmokeTrapMemo, npIoLevelIn=npIoLevelIn, npGsmStrength=npGsmStrength, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrap=npSmokeTrap, npIrStatus=npIrStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayTable=npRelayTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayStartReset=npRelayStartReset, npGsmTraps=npGsmTraps, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumEntry=npRelHumEntry, npRelHumTrapDataN=npRelHumTrapDataN, npIrReset=npIrReset, npRelHumTrap=npRelHumTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapV=npCurLoopTrapV, npSmokePower=npSmokePower, npSmoke=npSmoke, npRelayMemo=npRelayMemo, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoop=npCurLoop, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeMemo=npSmokeMemo, lightcom=lightcom, npSmokeReset=npSmokeReset, npCurLoopR=npCurLoopR, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTraps=npIoTraps, npIrPlayCmd=npIrPlayCmd, npIoTable=npIoTable, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopN=npCurLoopN, npGsm=npGsm, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTraps=npCurLoopTraps, npThermo=npThermo, npCurLoopPower=npCurLoopPower, npRelayState=npRelayState, npThermoTrapLow=npThermoTrapLow, npCurLoopTable=npCurLoopTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopI=npCurLoopI, npThermoMemo=npThermoMemo, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopV=npCurLoopV, npRelHumStatus=npRelHumStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npResetStack=npResetStack, npTrapInfo=npTrapInfo, npThermoLow=npThermoLow, npForcedReboot=npForcedReboot, npRelayEntry=npRelayEntry, npGsmInfo=npGsmInfo, FixedPoint1000=FixedPoint1000, npIoLevelOut=npIoLevelOut, npCurLoopTrap=npCurLoopTrap, npRelHumTrapFail=npRelHumTrapFail, npIoTrap=npIoTrap, npRelayMode=npRelayMode, npIrCtrl=npIrCtrl, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapData=npRelHumTrapData, npRelay=npRelay, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapMemo=npThermoTrapMemo, npSmokeTable=npSmokeTable, npIr=npIr, npSmokeStatus=npSmokeStatus, npThermoSensorN=npThermoSensorN, npRelayN=npRelayN, npIoPulseCounter=npIoPulseCounter, npThermoEntry=npThermoEntry, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmFailed=npGsmFailed, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapValue=npThermoTrapValue, npIoLineN=npIoLineN, npCurLoopTrapPower=npCurLoopTrapPower, npIoTrapLineN=npIoTrapLineN, npRelHumTempStatus=npRelHumTempStatus, npGsmRegistration=npGsmRegistration, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTraps=npSmokeTraps, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow)
