...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Bits, Unsigned32, Gauge32, Counter64, MibIdentifier, Counter32, TimeTicks, Integer32, NotificationType, ObjectIdentity, ModuleIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Bits", "Unsigned32", "Gauge32", "Counter64", "MibIdentifier", "Counter32", "TimeTicks", "Integer32", "NotificationType", "ObjectIdentity", "ModuleIdentity", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTable=npThermoTable, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTable=npRelHumTable, npCurLoopTrap=npCurLoopTrap, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumN=npRelHumN, npSmokeSensorN=npSmokeSensorN, npGsmRegistration=npGsmRegistration, npRelayN=npRelayN, npSmokeStatus=npSmokeStatus, npRelHumEntry=npRelHumEntry, npResetStack=npResetStack, npGsmSendSmsUtf8=npGsmSendSmsUtf8, FixedPoint1000=FixedPoint1000, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumMemo=npRelHumMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoLow=npThermoLow, npGsm=npGsm, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayEntry=npRelayEntry, npCurLoopTrapR=npCurLoopTrapR, npCurLoopPower=npCurLoopPower, npGsmTraps=npGsmTraps, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapSafe=npRelHumTrapSafe, npIoTraps=npIoTraps, npSmokeTrap=npSmokeTrap, npSmokeTable=npSmokeTable, npIoSinglePulseStart=npIoSinglePulseStart, npRelay=npRelay, npThermoMemo=npThermoMemo, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoSensorN=npThermoSensorN, npThermoEntry=npThermoEntry, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopR=npCurLoopR, npCurLoopV=npCurLoopV, npThermoHigh=npThermoHigh, npTrapInfo=npTrapInfo, npCurLoopTrapN=npCurLoopTrapN, npCurLoopI=npCurLoopI, npIr=npIr, npReboot=npReboot, npCurLoopStatus=npCurLoopStatus, npCurLoopEntry=npCurLoopEntry, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmFailed=npGsmFailed, npThermoTrapLow=npThermoTrapLow, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapMemo=npIoTrapMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapFail=npRelHumTrapFail, npThermoTraps=npThermoTraps, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapData=npRelHumTrapData, npCurLoopN=npCurLoopN, npThermo=npThermo, npCurLoop=npCurLoop, npIoTable=npIoTable, npCurLoopTable=npCurLoopTable, npSmokeReset=npSmokeReset, npIrReset=npIrReset, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrap=npRelHumTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmTrap=npGsmTrap, npRelHumTempStatus=npRelHumTempStatus, npRelHumidity=npRelHumidity, npRelayStartReset=npRelayStartReset, npThermoTrap=npThermoTrap, npIoLineN=npIoLineN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoValue=npThermoValue, npIoPulseCounter=npIoPulseCounter, npIoMemo=npIoMemo, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapV=npCurLoopTrapV, npIrCtrl=npIrCtrl, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIrPlayCmd=npIrPlayCmd, npTrapEmailTo=npTrapEmailTo, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeMemo=npSmokeMemo, npIrStatus=npIrStatus, npSmokeEntry=npSmokeEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoValuePrecise=npThermoValuePrecise, npRelHumStatus=npRelHumStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokePower=npSmokePower, npIoLevelOut=npIoLevelOut, npRelayTable=npRelayTable, npIo=npIo, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTraps=npCurLoopTraps, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapPrefix=npIoTrapPrefix, npSoftReboot=npSoftReboot, npThermoStatus=npThermoStatus, npIoLevelIn=npIoLevelIn, npRelHumTrapTempFail=npRelHumTrapTempFail, lightcom=lightcom, npThermoTrapSensorN=npThermoTrapSensorN, npGsmInfo=npGsmInfo, npThermoTrapPrefix=npThermoTrapPrefix, npGsmStrength=npGsmStrength, npRelayMemo=npRelayMemo, npRelHumValue=npRelHumValue, npIoTrap=npIoTrap, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapLevelLegend=npIoTrapLevelLegend, npForcedReboot=npForcedReboot, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoEntry=npIoEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTraps=npSmokeTraps, npIoTrapLineN=npIoTrapLineN, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmoke=npSmoke, npThermoTrapValue=npThermoTrapValue, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayMode=npRelayMode, npRelayState=npRelayState, npIoSinglePulseDuration=npIoSinglePulseDuration)
