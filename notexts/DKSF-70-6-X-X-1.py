...
enterprises, Counter64, TimeTicks, Integer32, ModuleIdentity, iso, Gauge32, NotificationType, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter64", "TimeTicks", "Integer32", "ModuleIdentity", "iso", "Gauge32", "NotificationType", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoSinglePulseDuration=npIoSinglePulseDuration, npIoEntry=npIoEntry, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmFailed=npGsmFailed, npRelHumTrapSafe=npRelHumTrapSafe, npThermoHigh=npThermoHigh, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumEntry=npRelHumEntry, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeReset=npSmokeReset, npGsmInfo=npGsmInfo, npRelHumidity=npRelHumidity, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTable=npSmokeTable, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopN=npCurLoopN, npRelHumTrapData=npRelHumTrapData, npGsmTrapPrefix=npGsmTrapPrefix, npThermoEntry=npThermoEntry, npIoLevelOut=npIoLevelOut, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapR=npCurLoopTrapR, npGsmTrap=npGsmTrap, npTrapInfo=npTrapInfo, npIr=npIr, npRelayEntry=npRelayEntry, npRelHumN=npRelHumN, npIoMemo=npIoMemo, npIoTrap=npIoTrap, npSmokeTrap=npSmokeTrap, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoLineN=npIoLineN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTraps=npSmokeTraps, npSmokeEntry=npSmokeEntry, npGsmStrength=npGsmStrength, npRelayTable=npRelayTable, npCurLoopPower=npCurLoopPower, npRelHumMemo=npRelHumMemo, npReboot=npReboot, npIoLevelIn=npIoLevelIn, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelay=npRelay, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayState=npRelayState, npIoTraps=npIoTraps, npSmoke=npSmoke, npRelayStartReset=npRelayStartReset, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayN=npRelayN, npResetStack=npResetStack, npCurLoopI=npCurLoopI, npThermoValuePrecise=npThermoValuePrecise, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npTrapEmailTo=npTrapEmailTo, npThermoTrapLow=npThermoTrapLow, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoLow=npThermoLow, npGsm=npGsm, npRelayMemo=npRelayMemo, npSmokeSensorN=npSmokeSensorN, npSmokeTrapPrefix=npSmokeTrapPrefix, npIrStatus=npIrStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapN=npCurLoopTrapN, lightcom=lightcom, npCurLoop=npCurLoop, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapStatus=npThermoTrapStatus, npIrReset=npIrReset, npSmokeStatus=npSmokeStatus, npThermoStatus=npThermoStatus, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrap=npThermoTrap, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopStatus=npCurLoopStatus, npThermoTraps=npThermoTraps, npIo=npIo, npThermoValue=npThermoValue, npSmokeMemo=npSmokeMemo, npCurLoopTrap=npCurLoopTrap, npThermoTable=npThermoTable, npIoPulseCounter=npIoPulseCounter, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopR=npCurLoopR, npRelHumStatus=npRelHumStatus, npRelHumTrapFail=npRelHumTrapFail, npRelHumTable=npRelHumTable, npCurLoopTable=npCurLoopTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIrPlayCmd=npIrPlayCmd, npSmokePower=npSmokePower, npIoTrapPrefix=npIoTrapPrefix, npIrCtrl=npIrCtrl, npRelHumTrapDataStatus=npRelHumTrapDataStatus, FixedPoint1000=FixedPoint1000, npIoTrapMemo=npIoTrapMemo, npCurLoopV=npCurLoopV, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapLineN=npIoTrapLineN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrap=npRelHumTrap, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoMemo=npThermoMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npForcedReboot=npForcedReboot, npThermoTrapPrefix=npThermoTrapPrefix, npThermoSensorN=npThermoSensorN, npThermoTrapMemo=npThermoTrapMemo, npThermo=npThermo, npRelHumValue=npRelHumValue, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapV=npCurLoopTrapV, npSoftReboot=npSoftReboot, npRelHumTrapDataN=npRelHumTrapDataN, npGsmRegistration=npGsmRegistration, npRelayMode=npRelayMode, npIoTable=npIoTable, npGsmTraps=npGsmTraps)
