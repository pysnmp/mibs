...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, ObjectIdentity, ModuleIdentity, Unsigned32, Counter64, Bits, NotificationType, iso, Counter32, MibIdentifier, enterprises, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "Counter64", "Bits", "NotificationType", "iso", "Counter32", "MibIdentifier", "enterprises", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrapMemo=npIoTrapMemo, npRelHumTrapData=npRelHumTrapData, npIoTrap=npIoTrap, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTemp=npRelHumTrapTemp, npTrapInfo=npTrapInfo, npRelHumTable=npRelHumTable, npThermoTable=npThermoTable, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoLineN=npIoLineN, npSmokeMemo=npSmokeMemo, npRelayN=npRelayN, npIoLevelOut=npIoLevelOut, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTrap=npSmokeTrap, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTempStatus=npRelHumTempStatus, npSmokeReset=npSmokeReset, npThermoTrapMemo=npThermoTrapMemo, npGsmTrap=npGsmTrap, npIr=npIr, npSmokeEntry=npSmokeEntry, npSoftReboot=npSoftReboot, npRelHumMemo=npRelHumMemo, npThermoMemo=npThermoMemo, npThermoLow=npThermoLow, npThermoHigh=npThermoHigh, npIoPulseCounter=npIoPulseCounter, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npIrReset=npIrReset, npRelayStartReset=npRelayStartReset, lightcom=lightcom, npSmoke=npSmoke, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopEntry=npCurLoopEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayMode=npRelayMode, npReboot=npReboot, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTraps=npCurLoopTraps, npSmokeSensorN=npSmokeSensorN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoop=npCurLoop, npThermoTrapStatus=npThermoTrapStatus, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapLow=npThermoTrapLow, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, FixedPoint1000=FixedPoint1000, npSmokeTraps=npSmokeTraps, npCurLoopTrapR=npCurLoopTrapR, npIoTable=npIoTable, npThermoTrap=npThermoTrap, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmTrapPrefix=npGsmTrapPrefix, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTempValue=npRelHumTempValue, npCurLoopV=npCurLoopV, npSmokePower=npSmokePower, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapLineN=npIoTrapLineN, npIrCtrl=npIrCtrl, npRelayState=npRelayState, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayMemo=npRelayMemo, npRelHumidity=npRelHumidity, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmTraps=npGsmTraps, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npResetStack=npResetStack, npThermoEntry=npThermoEntry, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoValue=npThermoValue, npIo=npIo, npRelHumTrap=npRelHumTrap, npGsmRegistration=npGsmRegistration, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopPower=npCurLoopPower, npCurLoopTable=npCurLoopTable, npIoTraps=npIoTraps, npSmokeTrapMemo=npSmokeTrapMemo, npRelayEntry=npRelayEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapV=npCurLoopTrapV, npIrPlayCmd=npIrPlayCmd, npCurLoopTrap=npCurLoopTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTable=npSmokeTable, npGsmStrength=npGsmStrength, npSmokeStatus=npSmokeStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelay=npRelay, npRelHumValue=npRelHumValue, npGsmInfo=npGsmInfo, npCurLoopI=npCurLoopI, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapPrefix=npIoTrapPrefix, npThermoSensorN=npThermoSensorN, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapFail=npRelHumTrapFail, npRelHumStatus=npRelHumStatus, npCurLoopTrapI=npCurLoopTrapI, npIrStatus=npIrStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapHigh=npThermoTrapHigh, npRelHumEntry=npRelHumEntry, npThermo=npThermo, npIoMemo=npIoMemo, npThermoStatus=npThermoStatus, npIoEntry=npIoEntry, npCurLoopN=npCurLoopN, npThermoTrapValue=npThermoTrapValue, npGsm=npGsm, npThermoTraps=npThermoTraps, npRelHumN=npRelHumN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoLevelIn=npIoLevelIn, npForcedReboot=npForcedReboot, npCurLoopR=npCurLoopR, npRelayTable=npRelayTable, npGsmFailed=npGsmFailed)
