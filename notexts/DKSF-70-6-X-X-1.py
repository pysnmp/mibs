...
Counter32, Gauge32, Bits, Counter64, NotificationType, MibIdentifier, Integer32, ModuleIdentity, IpAddress, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "Bits", "Counter64", "NotificationType", "MibIdentifier", "Integer32", "ModuleIdentity", "IpAddress", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTable=npRelHumTable, npIrCtrl=npIrCtrl, npThermoTrapMemo=npThermoTrapMemo, npForcedReboot=npForcedReboot, npIrStatus=npIrStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumEntry=npRelHumEntry, npSmokeMemo=npSmokeMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIrReset=npIrReset, npRelHumTrapSafe=npRelHumTrapSafe, npThermoValue=npThermoValue, npIo=npIo, npThermoTrap=npThermoTrap, npRelHumTrap=npRelHumTrap, npSmokeStatus=npSmokeStatus, npThermo=npThermo, npRelHumN=npRelHumN, npIrPlayCmd=npIrPlayCmd, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeSensorN=npSmokeSensorN, FixedPoint1000=FixedPoint1000, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapPower=npCurLoopTrapPower, npIoTrapLineN=npIoTrapLineN, npThermoTrapValue=npThermoTrapValue, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapR=npCurLoopTrapR, npGsmRegistration=npGsmRegistration, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayMemo=npRelayMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTrap=npSmokeTrap, npSoftReboot=npSoftReboot, npRelHumStatus=npRelHumStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapN=npCurLoopTrapN, npThermoHigh=npThermoHigh, npIoPulseCounter=npIoPulseCounter, npThermoTraps=npThermoTraps, npResetStack=npResetStack, npRelHumidity=npRelHumidity, npRelHumTempStatus=npRelHumTempStatus, npRelayEntry=npRelayEntry, npCurLoop=npCurLoop, npThermoSensorN=npThermoSensorN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTemp=npRelHumTrapTemp, npThermoEntry=npThermoEntry, npSmokePower=npSmokePower, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrap=npCurLoopTrap, npRelay=npRelay, npRelayState=npRelayState, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmTrap=npGsmTrap, npThermoTrapLow=npThermoTrapLow, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoLevelOut=npIoLevelOut, npThermoMemo=npThermoMemo, npIoTrap=npIoTrap, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTempValue=npRelHumTempValue, npRelayStartReset=npRelayStartReset, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapLevelIn=npIoTrapLevelIn, npIoEntry=npIoEntry, npThermoTable=npThermoTable, npSmokeReset=npSmokeReset, npRelHumTrapFail=npRelHumTrapFail, npGsmStrength=npGsmStrength, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmInfo=npGsmInfo, npRelayTable=npRelayTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopR=npCurLoopR, npGsmFailed=npGsmFailed, npIoSinglePulseStart=npIoSinglePulseStart, npSmoke=npSmoke, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTrapPrefix=npIoTrapPrefix, npIoLineN=npIoLineN, npIoTraps=npIoTraps, npReboot=npReboot, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoStatus=npThermoStatus, npRelHumTrapData=npRelHumTrapData, npTrapInfo=npTrapInfo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopN=npCurLoopN, npCurLoopTable=npCurLoopTable, npCurLoopI=npCurLoopI, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataN=npRelHumTrapDataN, lightcom=lightcom, npGsmTraps=npGsmTraps, npRelHumMemo=npRelHumMemo, npCurLoopTrapV=npCurLoopTrapV, npIr=npIr, npRelHumValue=npRelHumValue, npGsm=npGsm, npThermoLow=npThermoLow, npSmokeTrapStatus=npSmokeTrapStatus, npIoLevelIn=npIoLevelIn, npCurLoopStatus=npCurLoopStatus, npRelayN=npRelayN, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrapMemo=npSmokeTrapMemo, npRelayMode=npRelayMode, npThermoTrapHigh=npThermoTrapHigh, npSmokeTraps=npSmokeTraps, npCurLoopPower=npCurLoopPower, npThermoTrapStatus=npThermoTrapStatus, npIoTrapMemo=npIoTrapMemo, npSmokeEntry=npSmokeEntry, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapI=npCurLoopTrapI, npIoMemo=npIoMemo, npCurLoopV=npCurLoopV, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTable=npSmokeTable, npIoTable=npIoTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow)
