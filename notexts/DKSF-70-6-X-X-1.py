...
# Produced by pysmi-1.1.3 at Sun Nov 28 19:54:51 2021
...
Bits, TimeTicks, NotificationType, iso, MibIdentifier, enterprises, Gauge32, Counter64, ModuleIdentity, ObjectIdentity, Unsigned32, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "NotificationType", "iso", "MibIdentifier", "enterprises", "Gauge32", "Counter64", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoLevelIn=npIoLevelIn, npSmoke=npSmoke, npThermoMemo=npThermoMemo, npRelHumTrapData=npRelHumTrapData, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopPower=npCurLoopPower, npRelayN=npRelayN, npSmokePower=npSmokePower, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoStatus=npThermoStatus, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrap=npIoTrap, npRelayStartReset=npRelayStartReset, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumMemo=npRelHumMemo, npCurLoopEntry=npCurLoopEntry, npCurLoopStatus=npCurLoopStatus, npIoMemo=npIoMemo, npCurLoopI=npCurLoopI, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeEntry=npSmokeEntry, npIrPlayCmd=npIrPlayCmd, npThermoHigh=npThermoHigh, npGsm=npGsm, npReboot=npReboot, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumN=npRelHumN, npIrCtrl=npIrCtrl, npRelayTable=npRelayTable, npGsmTraps=npGsmTraps, npGsmTrap=npGsmTrap, npCurLoopN=npCurLoopN, npRelay=npRelay, npCurLoopTrapV=npCurLoopTrapV, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTraps=npIoTraps, npSmokeMemo=npSmokeMemo, npIoLineN=npIoLineN, lightcom=lightcom, npThermo=npThermo, npSmokeTrap=npSmokeTrap, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayMode=npRelayMode, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmStrength=npGsmStrength, npForcedReboot=npForcedReboot, npResetStack=npResetStack, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npTrapInfo=npTrapInfo, npCurLoopTrapR=npCurLoopTrapR, npRelHumStatus=npRelHumStatus, npThermoTable=npThermoTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTraps=npCurLoopTraps, FixedPoint1000=FixedPoint1000, npCurLoopR=npCurLoopR, npRelHumidity=npRelHumidity, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrapPrefix=npIoTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTable=npSmokeTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmInfo=npGsmInfo, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapFail=npRelHumTrapFail, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmRegistration=npGsmRegistration, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoValue=npThermoValue, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrap=npRelHumTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npTrapEmailTo=npTrapEmailTo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoop=npCurLoop, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTable=npRelHumTable, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopV=npCurLoopV, npSmokeStatus=npSmokeStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTable=npIoTable, npRelHumEntry=npRelHumEntry, npRelHumValue=npRelHumValue, npIoLevelOut=npIoLevelOut, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrapLineN=npIoTrapLineN, npSmokeReset=npSmokeReset, npIo=npIo, npThermoLow=npThermoLow, npSmokeTraps=npSmokeTraps, npRelayMemo=npRelayMemo, npThermoTraps=npThermoTraps, npIoEntry=npIoEntry, npCurLoopTable=npCurLoopTable, npCurLoopTrapI=npCurLoopTrapI, npIr=npIr, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoPulseCounter=npIoPulseCounter, npIrStatus=npIrStatus, npThermoTrapHigh=npThermoTrapHigh, npThermoTrap=npThermoTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npIrReset=npIrReset, npSmokeSensorN=npSmokeSensorN, npThermoSensorN=npThermoSensorN, npSoftReboot=npSoftReboot, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmFailed=npGsmFailed, npIoTrapMemo=npIoTrapMemo, npRelayState=npRelayState, npThermoEntry=npThermoEntry, npRelayEntry=npRelayEntry, npThermoTrapStatus=npThermoTrapStatus)
