...
# Produced by pysmi-1.1.10 at Fri Feb 16 02:39:47 2024
...
Gauge32, Counter32, Counter64, Bits, enterprises, TimeTicks, iso, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, MibIdentifier, NotificationType, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "Counter64", "Bits", "enterprises", "TimeTicks", "iso", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "MibIdentifier", "NotificationType", "ObjectIdentity", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeReset=npSmokeReset, npIrPlayCmd=npIrPlayCmd, npRelHumEntry=npRelHumEntry, npSmokeEntry=npSmokeEntry, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoStatus=npThermoStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayMemo=npRelayMemo, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrap=npSmokeTrap, npGsm=npGsm, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmStrength=npGsmStrength, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTraps=npThermoTraps, npIoEntry=npIoEntry, npRelay=npRelay, npThermoTrapHigh=npThermoTrapHigh, npRelHumidity=npRelHumidity, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmInfo=npGsmInfo, npIoPulseCounter=npIoPulseCounter, npIoSinglePulseStart=npIoSinglePulseStart, npGsmTrap=npGsmTrap, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapValue=npThermoTrapValue, npRelHumStatus=npRelHumStatus, npThermoSensorN=npThermoSensorN, npRelayState=npRelayState, npTrapInfo=npTrapInfo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTable=npIoTable, npRelHumTrapSafe=npRelHumTrapSafe, npIoMemo=npIoMemo, npSmokeTraps=npSmokeTraps, lightcom=lightcom, npThermoTrapMemo=npThermoTrapMemo, npRelayStartReset=npRelayStartReset, npThermoEntry=npThermoEntry, npCurLoop=npCurLoop, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopStatus=npCurLoopStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrap=npThermoTrap, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayTable=npRelayTable, npSmokeTable=npSmokeTable, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoLineN=npIoLineN, npCurLoopEntry=npCurLoopEntry, npRelayEntry=npRelayEntry, FixedPoint1000=FixedPoint1000, npSmokeMemo=npSmokeMemo, npCurLoopPower=npCurLoopPower, npGsmTraps=npGsmTraps, npRelHumTrap=npRelHumTrap, npCurLoopTraps=npCurLoopTraps, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumN=npRelHumN, npReboot=npReboot, npSmoke=npSmoke, npThermo=npThermo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapR=npCurLoopTrapR, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempFail=npRelHumTrapTempFail, npIrReset=npIrReset, npForcedReboot=npForcedReboot, npIr=npIr, npCurLoopR=npCurLoopR, npIoTrap=npIoTrap, npGsmFailed=npGsmFailed, npCurLoopTrapPower=npCurLoopTrapPower, npGsmRegistration=npGsmRegistration, npRelHumMemo=npRelHumMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTraps=npIoTraps, npIrStatus=npIrStatus, npRelayMode=npRelayMode, npRelHumTrapTemp=npRelHumTrapTemp, npIoLevelOut=npIoLevelOut, npCurLoopV=npCurLoopV, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapLow=npThermoTrapLow, npIoLevelIn=npIoLevelIn, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrCtrl=npIrCtrl, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoHigh=npThermoHigh, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayN=npRelayN, npSmokeStatus=npSmokeStatus, npCurLoopN=npCurLoopN, npResetStack=npResetStack, npRelHumTable=npRelHumTable, npThermoValue=npThermoValue, npCurLoopI=npCurLoopI, npIoTrapMemo=npIoTrapMemo, npRelHumTempStatus=npRelHumTempStatus, npThermoLow=npThermoLow, npRelHumValue=npRelHumValue, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapFail=npRelHumTrapFail, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokePower=npSmokePower, npCurLoopTable=npCurLoopTable, npIo=npIo, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoMemo=npThermoMemo, npCurLoopTrap=npCurLoopTrap, npSoftReboot=npSoftReboot, npThermoTable=npThermoTable, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapPrefix=npThermoTrapPrefix, PYSNMP_MODULE_ID=uniPingServerSolutionV3)
