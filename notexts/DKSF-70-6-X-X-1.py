...
# Produced by pysmi-1.1.8 at Mon Feb  6 15:04:13 2023
...
Gauge32, Counter64, IpAddress, enterprises, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, Unsigned32, iso, Bits, Integer32, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "IpAddress", "enterprises", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "Unsigned32", "iso", "Bits", "Integer32", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmoke=npSmoke, npForcedReboot=npForcedReboot, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapPower=npCurLoopTrapPower, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIo=npIo, npIrCtrl=npIrCtrl, npSmokeTraps=npSmokeTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrapPrefix=npIoTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapV=npCurLoopTrapV, npIoEntry=npIoEntry, npGsm=npGsm, npRelHumTrapTempFail=npRelHumTrapTempFail, npIrPlayCmd=npIrPlayCmd, npSmokeMemo=npSmokeMemo, npRelayTable=npRelayTable, npCurLoopTable=npCurLoopTable, npSmokeTrapMemo=npSmokeTrapMemo, npIoLineN=npIoLineN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmTrapPrefix=npGsmTrapPrefix, npThermoHigh=npThermoHigh, npGsmTrap=npGsmTrap, npThermoTrapHigh=npThermoTrapHigh, npRelayN=npRelayN, npThermoMemo=npThermoMemo, npSmokePower=npSmokePower, npRelHumTrapDataStatus=npRelHumTrapDataStatus, FixedPoint1000=FixedPoint1000, npThermoTrapPrefix=npThermoTrapPrefix, npIoLevelIn=npIoLevelIn, npThermoStatus=npThermoStatus, npRelHumValue=npRelHumValue, npIrStatus=npIrStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npTrapEmailTo=npTrapEmailTo, npTrapInfo=npTrapInfo, npIoTraps=npIoTraps, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeReset=npSmokeReset, npCurLoopEntry=npCurLoopEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTable=npRelHumTable, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrap=npIoTrap, npGsmStrength=npGsmStrength, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopStatus=npCurLoopStatus, npThermoTable=npThermoTable, npRelayStartReset=npRelayStartReset, npIoSinglePulseDuration=npIoSinglePulseDuration, npSoftReboot=npSoftReboot, npRelayEntry=npRelayEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrap=npRelHumTrap, npThermoTrapMemo=npThermoTrapMemo, npCurLoopI=npCurLoopI, npThermoTrap=npThermoTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoValuePrecise=npThermoValuePrecise, npIr=npIr, npSmokeStatus=npSmokeStatus, npRelHumTrapData=npRelHumTrapData, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTrapR=npCurLoopTrapR, npCurLoopR=npCurLoopR, npThermoValue=npThermoValue, npRelHumStatus=npRelHumStatus, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrap=npSmokeTrap, npCurLoopPower=npCurLoopPower, npGsmTraps=npGsmTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeSensorN=npSmokeSensorN, npThermoTrapLow=npThermoTrapLow, npRelHumTrapFail=npRelHumTrapFail, npRelHumidity=npRelHumidity, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermo=npThermo, npThermoTraps=npThermoTraps, npSmokeEntry=npSmokeEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIrReset=npIrReset, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoop=npCurLoop, npRelayState=npRelayState, npThermoSensorN=npThermoSensorN, npResetStack=npResetStack, npGsmRegistration=npGsmRegistration, npRelHumN=npRelHumN, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrap=npCurLoopTrap, npRelHumTempStatus=npRelHumTempStatus, npReboot=npReboot, npCurLoopTrapI=npCurLoopTrapI, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataN=npRelHumTrapDataN, lightcom=lightcom, npIoTrapLineN=npIoTrapLineN, npIoTable=npIoTable, npRelayMode=npRelayMode, npThermoTrapValue=npThermoTrapValue, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTraps=npCurLoopTraps, npRelHumEntry=npRelHumEntry, npRelHumMemo=npRelHumMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoEntry=npThermoEntry, npGsmInfo=npGsmInfo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopV=npCurLoopV, npIoMemo=npIoMemo, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTable=npSmokeTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmFailed=npGsmFailed, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelay=npRelay, npThermoLow=npThermoLow, npIoLevelOut=npIoLevelOut, npCurLoopN=npCurLoopN, npIoPulseCounter=npIoPulseCounter, npRelayMemo=npRelayMemo)
