...
# Produced by pysmi-1.1.8 at Fri Sep  8 07:37:35 2023
...
enterprises, Counter32, ModuleIdentity, Bits, ObjectIdentity, Unsigned32, MibIdentifier, TimeTicks, NotificationType, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "ModuleIdentity", "Bits", "ObjectIdentity", "Unsigned32", "MibIdentifier", "TimeTicks", "NotificationType", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopR=npCurLoopR, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapPower=npCurLoopTrapPower, npGsmTrap=npGsmTrap, npCurLoopEntry=npCurLoopEntry, npCurLoop=npCurLoop, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoEntry=npIoEntry, npRelayStartReset=npRelayStartReset, npRelHumStatus=npRelHumStatus, npGsm=npGsm, npRelHumValue=npRelHumValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeStatus=npSmokeStatus, npSmokePower=npSmokePower, npThermoHigh=npThermoHigh, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoStatus=npThermoStatus, npThermoEntry=npThermoEntry, FixedPoint1000=FixedPoint1000, npSmokeReset=npSmokeReset, npThermoTrapHigh=npThermoTrapHigh, npSmokeTrap=npSmokeTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrapLow=npThermoTrapLow, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapR=npCurLoopTrapR, npRelHumidity=npRelHumidity, npThermoTrapStatus=npThermoTrapStatus, npRelHumN=npRelHumN, npIoTrapPrefix=npIoTrapPrefix, npIoLineN=npIoLineN, npRelayN=npRelayN, npThermoTrapSensorN=npThermoTrapSensorN, npRelay=npRelay, lightcom=lightcom, npSmokeEntry=npSmokeEntry, npSmokeTable=npSmokeTable, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeSensorN=npSmokeSensorN, npIrStatus=npIrStatus, npRelayMemo=npRelayMemo, npThermo=npThermo, npResetStack=npResetStack, npSoftReboot=npSoftReboot, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrap=npRelHumTrap, npIoLevelIn=npIoLevelIn, npIoTrapLevelIn=npIoTrapLevelIn, npGsmStrength=npGsmStrength, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmoke=npSmoke, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopV=npCurLoopV, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopI=npCurLoopI, npThermoTable=npThermoTable, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayState=npRelayState, npIoTable=npIoTable, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTraps=npIoTraps, npIoLevelOut=npIoLevelOut, npRelHumTempStatus=npRelHumTempStatus, npThermoTrap=npThermoTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapMemo=npThermoTrapMemo, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoValue=npThermoValue, npIoPulseCounter=npIoPulseCounter, npIrReset=npIrReset, npTrapEmailTo=npTrapEmailTo, npRelayEntry=npRelayEntry, uniPingServerSolutionV3=uniPingServerSolutionV3, npIrCtrl=npIrCtrl, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIo=npIo, npThermoTraps=npThermoTraps, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapN=npCurLoopTrapN, npRelHumTable=npRelHumTable, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrapLineN=npIoTrapLineN, npThermoTrapPrefix=npThermoTrapPrefix, npRelayTable=npRelayTable, npRelHumTempValue=npRelHumTempValue, npThermoMemo=npThermoMemo, npGsmRegistration=npGsmRegistration, npGsmSendSmsUtf8=npGsmSendSmsUtf8, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrap=npIoTrap, npThermoSensorN=npThermoSensorN, npCurLoopPower=npCurLoopPower, npSmokeTrapStatus=npSmokeTrapStatus, npThermoLow=npThermoLow, npRelHumTrapDataN=npRelHumTrapDataN, npRelayMode=npRelayMode, npRelHumEntry=npRelHumEntry, npIr=npIr, npCurLoopTable=npCurLoopTable, npIrPlayCmd=npIrPlayCmd, npSmokeTraps=npSmokeTraps, npForcedReboot=npForcedReboot, npCurLoopN=npCurLoopN, npGsmFailed=npGsmFailed, npGsmTraps=npGsmTraps, npSmokeMemo=npSmokeMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npReboot=npReboot, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmInfo=npGsmInfo, npTrapInfo=npTrapInfo, npCurLoopStatus=npCurLoopStatus, npSmokeTrapMemo=npSmokeTrapMemo, npIoMemo=npIoMemo, npRelHumMemo=npRelHumMemo, npRelHumTrapData=npRelHumTrapData, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTemp=npRelHumTrapTemp)
