...
MibIdentifier, Integer32, Bits, ModuleIdentity, ObjectIdentity, Counter32, NotificationType, Counter64, iso, Gauge32, IpAddress, Unsigned32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "Bits", "ModuleIdentity", "ObjectIdentity", "Counter32", "NotificationType", "Counter64", "iso", "Gauge32", "IpAddress", "Unsigned32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoValue=npThermoValue, lightcom=lightcom, npForcedReboot=npForcedReboot, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrapLineN=npIoTrapLineN, npSmokeTraps=npSmokeTraps, npIo=npIo, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIrStatus=npIrStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npTrapInfo=npTrapInfo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoEntry=npThermoEntry, npGsm=npGsm, npSmokeEntry=npSmokeEntry, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapPrefix=npIoTrapPrefix, npThermoMemo=npThermoMemo, npRelayMode=npRelayMode, npRelayEntry=npRelayEntry, npIoTrapLevelLegend=npIoTrapLevelLegend, npIr=npIr, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrap=npIoTrap, npIoLevelIn=npIoLevelIn, npThermoLow=npThermoLow, npIoLineN=npIoLineN, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopI=npCurLoopI, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmTrapPrefix=npGsmTrapPrefix, npRelayMemo=npRelayMemo, npSmokeReset=npSmokeReset, npIoTrapLevelIn=npIoTrapLevelIn, npIoMemo=npIoMemo, npIoTable=npIoTable, npRelHumEntry=npRelHumEntry, npRelHumTrap=npRelHumTrap, npThermoSensorN=npThermoSensorN, npIrPlayCmd=npIrPlayCmd, npSoftReboot=npSoftReboot, npResetStack=npResetStack, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoop=npCurLoop, npRelHumStatus=npRelHumStatus, npIrCtrl=npIrCtrl, uniPingServerSolutionV3=uniPingServerSolutionV3, npTrapEmailTo=npTrapEmailTo, npThermo=npThermo, npIoLevelOut=npIoLevelOut, npCurLoopTrapR=npCurLoopTrapR, npCurLoopStatus=npCurLoopStatus, npThermoHigh=npThermoHigh, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrap=npCurLoopTrap, npIoTraps=npIoTraps, npSmokeTrap=npSmokeTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapI=npCurLoopTrapI, npGsmInfo=npGsmInfo, npThermoTrapStatus=npThermoTrapStatus, npSmoke=npSmoke, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, FixedPoint1000=FixedPoint1000, npReboot=npReboot, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapValue=npThermoTrapValue, npSmokeTable=npSmokeTable, npRelayState=npRelayState, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmRegistration=npGsmRegistration, npGsmFailed=npGsmFailed, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrReset=npIrReset, npRelHumValue=npRelHumValue, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTable=npCurLoopTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTraps=npThermoTraps, npSmokeSensorN=npSmokeSensorN, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopV=npCurLoopV, npRelHumN=npRelHumN, npCurLoopN=npCurLoopN, npGsmStrength=npGsmStrength, npRelHumidity=npRelHumidity, npThermoValuePrecise=npThermoValuePrecise, npRelHumTempStatus=npRelHumTempStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoStatus=npThermoStatus, npSmokeTrapMemo=npSmokeTrapMemo, npGsmTrap=npGsmTrap, npCurLoopR=npCurLoopR, npThermoTable=npThermoTable, npSmokeMemo=npSmokeMemo, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npCurLoopPower=npCurLoopPower, npSmokePower=npSmokePower, npRelayTable=npRelayTable, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelay=npRelay, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoPulseCounter=npIoPulseCounter, npRelHumMemo=npRelHumMemo, npGsmTraps=npGsmTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeStatus=npSmokeStatus, npRelHumTrapFail=npRelHumTrapFail, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayN=npRelayN, npRelHumTable=npRelHumTable, npIoEntry=npIoEntry, npRelayStartReset=npRelayStartReset, npCurLoopEntry=npCurLoopEntry, npThermoTrap=npThermoTrap)
