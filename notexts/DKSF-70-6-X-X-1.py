...
# Produced by pysmi-1.1.12 at Wed May 29 07:25:53 2024
...
Integer32, enterprises, Counter64, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Bits, MibIdentifier, IpAddress, Gauge32, ModuleIdentity, Counter32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "Counter64", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Bits", "MibIdentifier", "IpAddress", "Gauge32", "ModuleIdentity", "Counter32", "iso", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayN=npRelayN, npIoLineN=npIoLineN, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopStatus=npCurLoopStatus, npThermoTrapMemo=npThermoTrapMemo, npThermoEntry=npThermoEntry, npIoLevelOut=npIoLevelOut, npRelHumidity=npRelHumidity, npRelHumTrapTemp=npRelHumTrapTemp, npTrapInfo=npTrapInfo, npIoMemo=npIoMemo, npThermoMemo=npThermoMemo, npIoTrap=npIoTrap, npSmoke=npSmoke, npRelHumMemo=npRelHumMemo, npIrStatus=npIrStatus, npRelHumTable=npRelHumTable, npTrapEmailTo=npTrapEmailTo, npSmokeStatus=npSmokeStatus, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrap=npRelHumTrap, npSmokeMemo=npSmokeMemo, npGsm=npGsm, npRelHumTrapDataN=npRelHumTrapDataN, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTraps=npThermoTraps, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumValue=npRelHumValue, npThermoSensorN=npThermoSensorN, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTraps=npCurLoopTraps, npRelHumEntry=npRelHumEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapV=npCurLoopTrapV, npIoTrapMemo=npIoTrapMemo, npThermoTrapHigh=npThermoTrapHigh, npIrPlayCmd=npIrPlayCmd, npIoTraps=npIoTraps, npRelayEntry=npRelayEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmRegistration=npGsmRegistration, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmFailed=npGsmFailed, npGsmTrap=npGsmTrap, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapN=npCurLoopTrapN, npIoTable=npIoTable, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTempStatus=npRelHumTempStatus, npCurLoopN=npCurLoopN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npForcedReboot=npForcedReboot, npIoSinglePulseStart=npIoSinglePulseStart, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npSmokeTraps=npSmokeTraps, npRelayMode=npRelayMode, npCurLoopV=npCurLoopV, npIr=npIr, npIoTrapLineN=npIoTrapLineN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmTraps=npGsmTraps, npSmokePower=npSmokePower, npIoEntry=npIoEntry, npThermoLow=npThermoLow, npGsmInfo=npGsmInfo, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapLow=npThermoTrapLow, FixedPoint1000=FixedPoint1000, npThermoValue=npThermoValue, npCurLoop=npCurLoop, npIoLevelIn=npIoLevelIn, npThermoStatus=npThermoStatus, npRelayTable=npRelayTable, npIrReset=npIrReset, npCurLoopI=npCurLoopI, npIrCtrl=npIrCtrl, npRelHumN=npRelHumN, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelay=npRelay, npReboot=npReboot, npSmokeReset=npSmokeReset, npGsmStrength=npGsmStrength, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIo=npIo, npSoftReboot=npSoftReboot, npCurLoopTrapR=npCurLoopTrapR, npCurLoopEntry=npCurLoopEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTrap=npSmokeTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopR=npCurLoopR, npCurLoopTrap=npCurLoopTrap, npThermoTrap=npThermoTrap, npRelayStartReset=npRelayStartReset, lightcom=lightcom, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoHigh=npThermoHigh, npSmokeTable=npSmokeTable, npRelHumStatus=npRelHumStatus, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTable=npCurLoopTable, npThermo=npThermo, npThermoTable=npThermoTable, npResetStack=npResetStack, npRelHumTrapData=npRelHumTrapData, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeEntry=npSmokeEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeSensorN=npSmokeSensorN, npRelayState=npRelayState, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapPrefix=npThermoTrapPrefix, npThermoValuePrecise=npThermoValuePrecise, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopPower=npCurLoopPower, npRelayMemo=npRelayMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, uniPingServerSolutionV3=uniPingServerSolutionV3)
