...
ObjectIdentity, IpAddress, Integer32, Unsigned32, iso, Counter64, TimeTicks, NotificationType, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, enterprises, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "Integer32", "Unsigned32", "iso", "Counter64", "TimeTicks", "NotificationType", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "enterprises", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeEntry=npSmokeEntry, npThermoStatus=npThermoStatus, npRelHumEntry=npRelHumEntry, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermo=npThermo, npIoTrapLineN=npIoTrapLineN, npThermoTrapLow=npThermoTrapLow, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapN=npCurLoopTrapN, npIrPlayCmd=npIrPlayCmd, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapValue=npThermoTrapValue, npIo=npIo, npIrStatus=npIrStatus, npCurLoop=npCurLoop, npIoLevelIn=npIoLevelIn, npRelHumMemo=npRelHumMemo, npThermoHigh=npThermoHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npTrapInfo=npTrapInfo, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeSensorN=npSmokeSensorN, npRelayEntry=npRelayEntry, npRelHumTrapFail=npRelHumTrapFail, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoEntry=npThermoEntry, npCurLoopI=npCurLoopI, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrap=npSmokeTrap, npRelHumTable=npRelHumTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTable=npCurLoopTable, npThermoTrapMemo=npThermoTrapMemo, npIoMemo=npIoMemo, npRelHumStatus=npRelHumStatus, npRelHumValue=npRelHumValue, npRelayState=npRelayState, npRelayMemo=npRelayMemo, npRelHumN=npRelHumN, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTrapMemo=npSmokeTrapMemo, npRelayTable=npRelayTable, npRelHumTrap=npRelHumTrap, npGsm=npGsm, npIrReset=npIrReset, npGsmFailed=npGsmFailed, npCurLoopTrapPower=npCurLoopTrapPower, lightcom=lightcom, npGsmTraps=npGsmTraps, npRelHumTrapDataN=npRelHumTrapDataN, npIoLevelOut=npIoLevelOut, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokePower=npSmokePower, npRelHumTrapSafe=npRelHumTrapSafe, npTrapEmailTo=npTrapEmailTo, npIoLineN=npIoLineN, npThermoMemo=npThermoMemo, npSmokeTraps=npSmokeTraps, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrap=npCurLoopTrap, npThermoTrap=npThermoTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmRegistration=npGsmRegistration, npRelayN=npRelayN, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmTrap=npGsmTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIrCtrl=npIrCtrl, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrapMemo=npIoTrapMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTable=npSmokeTable, npSmokeTrapStatus=npSmokeTrapStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoValue=npThermoValue, npCurLoopR=npCurLoopR, npCurLoopStatus=npCurLoopStatus, npCurLoopV=npCurLoopV, npRelayStartReset=npRelayStartReset, npThermoTable=npThermoTable, npIoTraps=npIoTraps, npSmokeMemo=npSmokeMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npResetStack=npResetStack, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapHigh=npThermoTrapHigh, npRelHumidity=npRelHumidity, npThermoLow=npThermoLow, npThermoSensorN=npThermoSensorN, npThermoTraps=npThermoTraps, npCurLoopTrapR=npCurLoopTrapR, npSmokeReset=npSmokeReset, npRelHumTrapData=npRelHumTrapData, npGsmInfo=npGsmInfo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npForcedReboot=npForcedReboot, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopN=npCurLoopN, FixedPoint1000=FixedPoint1000, npGsmStrength=npGsmStrength, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTempValue=npRelHumTempValue, npSoftReboot=npSoftReboot, npRelay=npRelay, npIoTrap=npIoTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopPower=npCurLoopPower, npGsmTrapPrefix=npGsmTrapPrefix, npIoPulseCounter=npIoPulseCounter, npIr=npIr, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeStatus=npSmokeStatus, npReboot=npReboot, npSmoke=npSmoke, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoEntry=npIoEntry, npIoTable=npIoTable, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayMode=npRelayMode, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapPrefix=npCurLoopTrapPrefix)
