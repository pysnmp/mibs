...
# Produced by pysmi-1.1.8 at Mon Jan  2 13:19:31 2023
...
Integer32, Unsigned32, NotificationType, IpAddress, Bits, Counter32, enterprises, MibIdentifier, Counter64, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "NotificationType", "IpAddress", "Bits", "Counter32", "enterprises", "MibIdentifier", "Counter64", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTable=npSmokeTable, npSmokeEntry=npSmokeEntry, npRelHumTempValue=npRelHumTempValue, npThermoTraps=npThermoTraps, npRelHumMemo=npRelHumMemo, npGsmRegistration=npGsmRegistration, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrapLineN=npIoTrapLineN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapMemo=npThermoTrapMemo, npSmokeMemo=npSmokeMemo, npIoTrapLevelIn=npIoTrapLevelIn, npIoLineN=npIoLineN, npIo=npIo, npRelayN=npRelayN, npThermoStatus=npThermoStatus, npRelHumN=npRelHumN, npGsmInfo=npGsmInfo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapLow=npThermoTrapLow, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoHigh=npThermoHigh, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopN=npCurLoopN, npCurLoopTraps=npCurLoopTraps, npSmokeTrapMemo=npSmokeTrapMemo, npGsmFailed=npGsmFailed, npSmoke=npSmoke, npCurLoopR=npCurLoopR, npReboot=npReboot, npGsmStrength=npGsmStrength, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeReset=npSmokeReset, npTrapInfo=npTrapInfo, npRelayEntry=npRelayEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoValue=npThermoValue, npRelHumTrapSafe=npRelHumTrapSafe, npIrReset=npIrReset, npForcedReboot=npForcedReboot, npThermoLow=npThermoLow, npThermoEntry=npThermoEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopV=npCurLoopV, FixedPoint1000=FixedPoint1000, npIoEntry=npIoEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoPulseCounter=npIoPulseCounter, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, lightcom=lightcom, npIoMemo=npIoMemo, npSmokeStatus=npSmokeStatus, npThermo=npThermo, npCurLoopStatus=npCurLoopStatus, npRelHumStatus=npRelHumStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsm=npGsm, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTempStatus=npRelHumTempStatus, npThermoValuePrecise=npThermoValuePrecise, npThermoTable=npThermoTable, npRelHumTable=npRelHumTable, npCurLoopPower=npCurLoopPower, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTable=npCurLoopTable, npIoTraps=npIoTraps, npSoftReboot=npSoftReboot, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapFail=npRelHumTrapFail, npGsmTraps=npGsmTraps, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoLevelIn=npIoLevelIn, npIrStatus=npIrStatus, npRelay=npRelay, npRelayState=npRelayState, npCurLoopTrapN=npCurLoopTrapN, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrap=npRelHumTrap, npRelHumTrapData=npRelHumTrapData, npThermoTrapValue=npThermoTrapValue, npRelayMode=npRelayMode, npThermoMemo=npThermoMemo, npRelHumValue=npRelHumValue, npTrapEmailTo=npTrapEmailTo, npRelayStartReset=npRelayStartReset, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoop=npCurLoop, npCurLoopTrapStatus=npCurLoopTrapStatus, npIr=npIr, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrap=npCurLoopTrap, npCurLoopI=npCurLoopI, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTable=npIoTable, npRelHumidity=npRelHumidity, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeSensorN=npSmokeSensorN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTraps=npSmokeTraps, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapR=npCurLoopTrapR, npSmokeTrap=npSmokeTrap, npCurLoopEntry=npCurLoopEntry, npThermoTrap=npThermoTrap, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTrapStatus=npSmokeTrapStatus, npIoTrapPrefix=npIoTrapPrefix, npGsmTrap=npGsmTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumEntry=npRelHumEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npIrCtrl=npIrCtrl, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoSinglePulseStart=npIoSinglePulseStart, npThermoSensorN=npThermoSensorN, npThermoTrapStatus=npThermoTrapStatus, npRelayMemo=npRelayMemo, npIoLevelOut=npIoLevelOut, npIoTrap=npIoTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapPrefix=npThermoTrapPrefix, npResetStack=npResetStack, npSmokePower=npSmokePower, npRelayTable=npRelayTable, npRelHumSafeRangeLow=npRelHumSafeRangeLow)
