...
# Produced by pysmi-1.1.8 at Thu Sep 15 10:07:24 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, Counter32, iso, Unsigned32, ObjectIdentity, Counter64, Integer32, Bits, enterprises, MibIdentifier, TimeTicks, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "Counter32", "iso", "Unsigned32", "ObjectIdentity", "Counter64", "Integer32", "Bits", "enterprises", "MibIdentifier", "TimeTicks", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeEntry=npSmokeEntry, npRelHumEntry=npRelHumEntry, npThermoTrapMemo=npThermoTrapMemo, npIrStatus=npIrStatus, npIrCtrl=npIrCtrl, npIoTrap=npIoTrap, npRelay=npRelay, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokePower=npSmokePower, npRelHumTempStatus=npRelHumTempStatus, npThermoHigh=npThermoHigh, npThermo=npThermo, npRelHumStatus=npRelHumStatus, npIoLevelIn=npIoLevelIn, npSmokeTrapStatus=npSmokeTrapStatus, npIoMemo=npIoMemo, npRelHumTempValue=npRelHumTempValue, npCurLoopN=npCurLoopN, npIoPulseCounter=npIoPulseCounter, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTable=npIoTable, npRelayTable=npRelayTable, npRelayEntry=npRelayEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIr=npIr, npRelHumValue=npRelHumValue, npSmokeTrap=npSmokeTrap, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopEntry=npCurLoopEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrap=npRelHumTrap, npThermoTrapValue=npThermoTrapValue, npThermoTable=npThermoTable, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapI=npCurLoopTrapI, npCurLoop=npCurLoop, npThermoEntry=npThermoEntry, npGsmRegistration=npGsmRegistration, npIoTrapLineN=npIoTrapLineN, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrapMemo=npSmokeTrapMemo, npSmoke=npSmoke, npRelHumTrapFail=npRelHumTrapFail, npRelayMode=npRelayMode, npIoEntry=npIoEntry, npRelHumTrapSafe=npRelHumTrapSafe, npThermoLow=npThermoLow, npThermoMemo=npThermoMemo, npTrapInfo=npTrapInfo, npIoTrapPrefix=npIoTrapPrefix, npSmokeTraps=npSmokeTraps, npCurLoopTable=npCurLoopTable, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmStrength=npGsmStrength, npRelayStartReset=npRelayStartReset, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumidity=npRelHumidity, npGsmTrap=npGsmTrap, npCurLoopTrapN=npCurLoopTrapN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTable=npRelHumTable, npSoftReboot=npSoftReboot, FixedPoint1000=FixedPoint1000, npThermoSensorN=npThermoSensorN, npIoLineN=npIoLineN, npThermoTraps=npThermoTraps, npReboot=npReboot, npRelHumN=npRelHumN, npCurLoopR=npCurLoopR, npRelayMemo=npRelayMemo, npCurLoopPower=npCurLoopPower, npGsmTraps=npGsmTraps, npResetStack=npResetStack, npIoTraps=npIoTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmFailed=npGsmFailed, lightcom=lightcom, npIoSinglePulseDuration=npIoSinglePulseDuration, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapData=npRelHumTrapData, npIoTrapMemo=npIoTrapMemo, npIoLevelOut=npIoLevelOut, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npForcedReboot=npForcedReboot, npIo=npIo, npRelayState=npRelayState, npCurLoopI=npCurLoopI, npRelayN=npRelayN, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoStatus=npThermoStatus, npSmokeTable=npSmokeTable, npSmokeReset=npSmokeReset, npTrapEmailTo=npTrapEmailTo, npCurLoopV=npCurLoopV, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrap=npThermoTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeStatus=npSmokeStatus, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoValue=npThermoValue, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumMemo=npRelHumMemo, npIrReset=npIrReset, npSmokeSensorN=npSmokeSensorN, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopStatus=npCurLoopStatus, npSmokeMemo=npSmokeMemo, npGsmInfo=npGsmInfo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrPlayCmd=npIrPlayCmd, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapSensorN=npThermoTrapSensorN, npGsm=npGsm)
