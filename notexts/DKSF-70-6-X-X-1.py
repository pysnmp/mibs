...
# Produced by pysmi-1.1.12 at Tue Jun  4 07:52:27 2024
...
iso, ObjectIdentity, IpAddress, Counter32, Counter64, Gauge32, Integer32, Bits, TimeTicks, enterprises, MibIdentifier, NotificationType, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "IpAddress", "Counter32", "Counter64", "Gauge32", "Integer32", "Bits", "TimeTicks", "enterprises", "MibIdentifier", "NotificationType", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeReset=npSmokeReset, npRelHumTrapData=npRelHumTrapData, npRelHumStatus=npRelHumStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelayStartReset=npRelayStartReset, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopI=npCurLoopI, npThermoTrapStatus=npThermoTrapStatus, npIoTable=npIoTable, npIrPlayCmd=npIrPlayCmd, npIoLevelIn=npIoLevelIn, npReboot=npReboot, npCurLoopTrapR=npCurLoopTrapR, npRelayMemo=npRelayMemo, npRelayState=npRelayState, npCurLoopPower=npCurLoopPower, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoLow=npThermoLow, npCurLoopTrapPower=npCurLoopTrapPower, npThermo=npThermo, npRelHumTrap=npRelHumTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmFailed=npGsmFailed, lightcom=lightcom, npRelayMode=npRelayMode, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTempValue=npRelHumTempValue, npThermoSensorN=npThermoSensorN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeMemo=npSmokeMemo, npCurLoopR=npCurLoopR, npIoEntry=npIoEntry, npIoTrapLevelLegend=npIoTrapLevelLegend, npIrReset=npIrReset, npIo=npIo, npResetStack=npResetStack, npCurLoopV=npCurLoopV, npThermoTable=npThermoTable, npSoftReboot=npSoftReboot, npSmokeTable=npSmokeTable, npSmokeTrapMemo=npSmokeTrapMemo, npIr=npIr, npThermoStatus=npThermoStatus, npCurLoopEntry=npCurLoopEntry, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapHigh=npThermoTrapHigh, npIoMemo=npIoMemo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumEntry=npRelHumEntry, npSmoke=npSmoke, FixedPoint1000=FixedPoint1000, npIoTrapPrefix=npIoTrapPrefix, npRelHumN=npRelHumN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmStrength=npGsmStrength, npForcedReboot=npForcedReboot, npIoTrap=npIoTrap, npCurLoop=npCurLoop, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapMemo=npIoTrapMemo, npIoLevelOut=npIoLevelOut, npIoPulseCounter=npIoPulseCounter, npSmokeTraps=npSmokeTraps, npRelayN=npRelayN, npCurLoopN=npCurLoopN, npThermoTrapPrefix=npThermoTrapPrefix, npSmokePower=npSmokePower, npRelHumMemo=npRelHumMemo, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapN=npCurLoopTrapN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npTrapInfo=npTrapInfo, npThermoTrapLow=npThermoTrapLow, npGsmTraps=npGsmTraps, npThermoTraps=npThermoTraps, npIrStatus=npIrStatus, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTemp=npRelHumTrapTemp, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeSensorN=npSmokeSensorN, npRelHumValue=npRelHumValue, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayEntry=npRelayEntry, npCurLoopTable=npCurLoopTable, npThermoHigh=npThermoHigh, npRelHumTable=npRelHumTable, npIrCtrl=npIrCtrl, npRelayTable=npRelayTable, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTraps=npIoTraps, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsm=npGsm, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrap=npThermoTrap, npGsmTrap=npGsmTrap, npSmokeTrapStatus=npSmokeTrapStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapValue=npThermoTrapValue, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrap=npCurLoopTrap, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeStatus=npSmokeStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmInfo=npGsmInfo, npRelHumTempStatus=npRelHumTempStatus, npIoTrapLineN=npIoTrapLineN, npThermoMemo=npThermoMemo, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapV=npCurLoopTrapV, npThermoValue=npThermoValue, npGsmRegistration=npGsmRegistration, npThermoEntry=npThermoEntry, npRelay=npRelay, npSmokeTrap=npSmokeTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumidity=npRelHumidity, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeEntry=npSmokeEntry, npIoLineN=npIoLineN)
