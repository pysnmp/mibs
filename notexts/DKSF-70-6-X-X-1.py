...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, enterprises, ObjectIdentity, Bits, MibIdentifier, NotificationType, IpAddress, iso, Counter64, Integer32, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "enterprises", "ObjectIdentity", "Bits", "MibIdentifier", "NotificationType", "IpAddress", "iso", "Counter64", "Integer32", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayN=npRelayN, npGsmStrength=npGsmStrength, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npReboot=npReboot, npGsmFailed=npGsmFailed, npIoTraps=npIoTraps, npRelayMemo=npRelayMemo, npSmokeTrapStatus=npSmokeTrapStatus, npGsm=npGsm, npRelayTable=npRelayTable, npThermoTrapMemo=npThermoTrapMemo, npGsmRegistration=npGsmRegistration, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopPower=npCurLoopPower, npCurLoopI=npCurLoopI, npRelayMode=npRelayMode, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapHigh=npThermoTrapHigh, npSmokeMemo=npSmokeMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoEntry=npThermoEntry, npSmokeTrapMemo=npSmokeTrapMemo, npTrapInfo=npTrapInfo, npRelHumN=npRelHumN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumidity=npRelHumidity, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTempStatus=npRelHumTempStatus, npSmokeReset=npSmokeReset, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoLow=npThermoLow, npSmokeSensorN=npSmokeSensorN, npRelay=npRelay, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopStatus=npCurLoopStatus, npCurLoopV=npCurLoopV, npIoPulseCounter=npIoPulseCounter, npSmokePower=npSmokePower, npIoLevelOut=npIoLevelOut, npRelHumEntry=npRelHumEntry, npThermoHigh=npThermoHigh, npRelayStartReset=npRelayStartReset, npRelHumStatus=npRelHumStatus, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopN=npCurLoopN, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapData=npRelHumTrapData, npIoEntry=npIoEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeStatus=npSmokeStatus, npThermoStatus=npThermoStatus, npThermoTraps=npThermoTraps, lightcom=lightcom, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTraps=npSmokeTraps, npRelHumTrap=npRelHumTrap, npIo=npIo, npThermoTrapValue=npThermoTrapValue, npIoLineN=npIoLineN, npGsmInfo=npGsmInfo, npIr=npIr, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumMemo=npRelHumMemo, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapI=npCurLoopTrapI, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumValue=npRelHumValue, npIrPlayCmd=npIrPlayCmd, npIoSinglePulseStart=npIoSinglePulseStart, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapMemo=npIoTrapMemo, npThermo=npThermo, npRelHumTable=npRelHumTable, npSmokeTable=npSmokeTable, npIoTable=npIoTable, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoValue=npThermoValue, FixedPoint1000=FixedPoint1000, npIrCtrl=npIrCtrl, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTraps=npCurLoopTraps, npGsmTraps=npGsmTraps, npRelHumTempValue=npRelHumTempValue, npRelayEntry=npRelayEntry, npTrapEmailTo=npTrapEmailTo, npIrStatus=npIrStatus, npCurLoopTrapN=npCurLoopTrapN, npRelayState=npRelayState, npSmokeEntry=npSmokeEntry, npSmoke=npSmoke, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npForcedReboot=npForcedReboot, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmTrap=npGsmTrap, npThermoTrapLow=npThermoTrapLow, npIoTrap=npIoTrap, npSoftReboot=npSoftReboot, npThermoTrap=npThermoTrap, npIoTrapPrefix=npIoTrapPrefix, npResetStack=npResetStack, npIrReset=npIrReset, npIoMemo=npIoMemo, npIoTrapLineN=npIoTrapLineN, npThermoSensorN=npThermoSensorN, npCurLoopTable=npCurLoopTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTrap=npSmokeTrap, npCurLoopTrapR=npCurLoopTrapR, npCurLoopR=npCurLoopR, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapPower=npCurLoopTrapPower, npThermoMemo=npThermoMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapFail=npRelHumTrapFail, npIoTrapLevelIn=npIoTrapLevelIn, npIoLevelIn=npIoLevelIn, npThermoTable=npThermoTable, npCurLoop=npCurLoop, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapStatus=npCurLoopTrapStatus)
