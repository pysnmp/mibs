...
MibIdentifier, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, NotificationType, Bits, ObjectIdentity, Unsigned32, IpAddress, enterprises, Counter32, TimeTicks, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "NotificationType", "Bits", "ObjectIdentity", "Unsigned32", "IpAddress", "enterprises", "Counter32", "TimeTicks", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTraps=npThermoTraps, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumMemo=npRelHumMemo, npIoTrapPrefix=npIoTrapPrefix, npGsmFailed=npGsmFailed, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokePower=npSmokePower, npThermoStatus=npThermoStatus, npIoLevelOut=npIoLevelOut, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmSendSmsWin1251=npGsmSendSmsWin1251, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoSensorN=npThermoSensorN, npIoTrapMemo=npIoTrapMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoEntry=npIoEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTable=npSmokeTable, npIrReset=npIrReset, npThermoTrapMemo=npThermoTrapMemo, npTrapInfo=npTrapInfo, npRelay=npRelay, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeSensorN=npSmokeSensorN, npRelayEntry=npRelayEntry, npGsmTrap=npGsmTrap, npSmoke=npSmoke, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTrapMemo=npSmokeTrapMemo, npGsmTraps=npGsmTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayStartReset=npRelayStartReset, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapPrefix=npCurLoopTrapPrefix, lightcom=lightcom, npIoTraps=npIoTraps, npRelHumStatus=npRelHumStatus, npGsm=npGsm, npRelayMode=npRelayMode, npSmokeReset=npSmokeReset, npRelayState=npRelayState, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapValue=npThermoTrapValue, npGsmRegistration=npGsmRegistration, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrap=npThermoTrap, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrap=npCurLoopTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoHigh=npThermoHigh, npIoTrapLineN=npIoTrapLineN, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumN=npRelHumN, npCurLoopPower=npCurLoopPower, npThermoTrapStatus=npThermoTrapStatus, npIoLineN=npIoLineN, npIoSinglePulseStart=npIoSinglePulseStart, npIrStatus=npIrStatus, npCurLoopStatus=npCurLoopStatus, npRelayTable=npRelayTable, npCurLoopTrapPower=npCurLoopTrapPower, npRelayMemo=npRelayMemo, npSmokeEntry=npSmokeEntry, npIoTable=npIoTable, npCurLoopV=npCurLoopV, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapN=npCurLoopTrapN, npIoMemo=npIoMemo, npRelHumTrapSafe=npRelHumTrapSafe, npGsmInfo=npGsmInfo, npSmokeTrapStatus=npSmokeTrapStatus, npRelayN=npRelayN, npThermoEntry=npThermoEntry, npSmokeStatus=npSmokeStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIr=npIr, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrap=npSmokeTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoLevelIn=npIoLevelIn, npCurLoopN=npCurLoopN, npSoftReboot=npSoftReboot, npReboot=npReboot, npRelHumTrapData=npRelHumTrapData, npCurLoopI=npCurLoopI, npRelHumValue=npRelHumValue, npRelHumEntry=npRelHumEntry, npIoTrap=npIoTrap, npThermo=npThermo, npThermoLow=npThermoLow, npThermoTable=npThermoTable, npRelHumTrap=npRelHumTrap, npThermoMemo=npThermoMemo, npIoPulseCounter=npIoPulseCounter, npRelHumidity=npRelHumidity, FixedPoint1000=FixedPoint1000, npRelHumTempValue=npRelHumTempValue, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTable=npCurLoopTable, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTraps=npCurLoopTraps, npThermoTrapLow=npThermoTrapLow, npTrapEmailTo=npTrapEmailTo, npIrCtrl=npIrCtrl, npCurLoop=npCurLoop, npIrPlayCmd=npIrPlayCmd, npRelHumTable=npRelHumTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIo=npIo, npThermoValuePrecise=npThermoValuePrecise, npGsmStrength=npGsmStrength, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npForcedReboot=npForcedReboot, npCurLoopR=npCurLoopR, npResetStack=npResetStack, npRelHumTrapFail=npRelHumTrapFail, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeMemo=npSmokeMemo, npSmokeTraps=npSmokeTraps, npThermoValue=npThermoValue)
