...
Unsigned32, IpAddress, MibIdentifier, Counter64, ModuleIdentity, Bits, ObjectIdentity, enterprises, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "MibIdentifier", "Counter64", "ModuleIdentity", "Bits", "ObjectIdentity", "enterprises", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumEntry=npRelHumEntry, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTable=npRelHumTable, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapFail=npRelHumTrapFail, npSmokeSensorN=npSmokeSensorN, npThermoValuePrecise=npThermoValuePrecise, npCurLoopPower=npCurLoopPower, npIoMemo=npIoMemo, npRelHumStatus=npRelHumStatus, npThermoTraps=npThermoTraps, npThermoEntry=npThermoEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumValue=npRelHumValue, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempStatus=npRelHumTempStatus, npThermoValue=npThermoValue, npTrapInfo=npTrapInfo, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopV=npCurLoopV, npIoTrapLevelIn=npIoTrapLevelIn, npIoLevelIn=npIoLevelIn, npCurLoopTrap=npCurLoopTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoSinglePulseDuration=npIoSinglePulseDuration, npReboot=npReboot, npRelay=npRelay, lightcom=lightcom, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokePower=npSmokePower, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeMemo=npSmokeMemo, npSmokeTable=npSmokeTable, npThermoLow=npThermoLow, npIoTrapMemo=npIoTrapMemo, npSmokeStatus=npSmokeStatus, FixedPoint1000=FixedPoint1000, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmStrength=npGsmStrength, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopEntry=npCurLoopEntry, npRelayState=npRelayState, npRelayN=npRelayN, npCurLoopTable=npCurLoopTable, npGsm=npGsm, npIrCtrl=npIrCtrl, npCurLoopTrapN=npCurLoopTrapN, npSoftReboot=npSoftReboot, npCurLoopStatus=npCurLoopStatus, npIr=npIr, npIoLevelOut=npIoLevelOut, npRelayStartReset=npRelayStartReset, npSmoke=npSmoke, npRelayTable=npRelayTable, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapMemo=npThermoTrapMemo, npThermoHigh=npThermoHigh, npThermoSensorN=npThermoSensorN, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoStatus=npThermoStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeReset=npSmokeReset, npRelHumTrap=npRelHumTrap, npRelHumTempValue=npRelHumTempValue, npIoPulseCounter=npIoPulseCounter, npCurLoopTrapI=npCurLoopTrapI, npIoLineN=npIoLineN, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrap=npThermoTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumN=npRelHumN, npThermoMemo=npThermoMemo, npSmokeEntry=npSmokeEntry, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapV=npCurLoopTrapV, npTrapEmailTo=npTrapEmailTo, npGsmInfo=npGsmInfo, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataN=npRelHumTrapDataN, npResetStack=npResetStack, npGsmFailed=npGsmFailed, npThermoTrapValue=npThermoTrapValue, npCurLoopR=npCurLoopR, npRelayMemo=npRelayMemo, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTable=npThermoTable, npSmokeTrap=npSmokeTrap, npRelHumidity=npRelHumidity, npIo=npIo, npCurLoopN=npCurLoopN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIrStatus=npIrStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTraps=npSmokeTraps, npThermoTrapStatus=npThermoTrapStatus, npRelayMode=npRelayMode, npCurLoop=npCurLoop, npRelHumMemo=npRelHumMemo, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempFail=npRelHumTrapTempFail, npIrReset=npIrReset, npIoTable=npIoTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npForcedReboot=npForcedReboot, npRelayEntry=npRelayEntry, npCurLoopTraps=npCurLoopTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopI=npCurLoopI, npGsmTraps=npGsmTraps, npGsmRegistration=npGsmRegistration, npIoEntry=npIoEntry, npRelHumTrapData=npRelHumTrapData, npThermo=npThermo, npGsmTrap=npGsmTrap, npIoTraps=npIoTraps, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapLow=npThermoTrapLow, npIoTrap=npIoTrap)
