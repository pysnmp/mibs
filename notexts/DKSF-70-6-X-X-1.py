...
# Produced by pysmi-1.1.8 at Fri Jan 13 12:10:22 2023
...
IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, Gauge32, enterprises, iso, ModuleIdentity, Counter64, ObjectIdentity, MibIdentifier, NotificationType, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "Gauge32", "enterprises", "iso", "ModuleIdentity", "Counter64", "ObjectIdentity", "MibIdentifier", "NotificationType", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapMemo=npThermoTrapMemo, npRelayN=npRelayN, npThermoTrap=npThermoTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeMemo=npSmokeMemo, npCurLoopStatus=npCurLoopStatus, npCurLoopTable=npCurLoopTable, npCurLoopTrapV=npCurLoopTrapV, npThermoTable=npThermoTable, npIoSinglePulseStart=npIoSinglePulseStart, npSmokePower=npSmokePower, npRelHumTrapDataN=npRelHumTrapDataN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrapPrefix=npIoTrapPrefix, npIoTrapLineN=npIoTrapLineN, npCurLoopTrap=npCurLoopTrap, npGsmInfo=npGsmInfo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoMemo=npThermoMemo, npRelay=npRelay, npReboot=npReboot, npThermoTrapStatus=npThermoTrapStatus, npTrapInfo=npTrapInfo, npSmokeTable=npSmokeTable, npCurLoopTrapN=npCurLoopTrapN, npCurLoopR=npCurLoopR, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoEntry=npIoEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTraps=npIoTraps, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumN=npRelHumN, npSmoke=npSmoke, npSmokeEntry=npSmokeEntry, npIoLevelOut=npIoLevelOut, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayStartReset=npRelayStartReset, npThermoStatus=npThermoStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoLevelIn=npIoLevelIn, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopN=npCurLoopN, npCurLoopTraps=npCurLoopTraps, npCurLoopEntry=npCurLoopEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTraps=npSmokeTraps, npGsmFailed=npGsmFailed, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoHigh=npThermoHigh, npSmokeSensorN=npSmokeSensorN, npResetStack=npResetStack, npIrCtrl=npIrCtrl, npIoTrap=npIoTrap, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmRegistration=npGsmRegistration, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSoftReboot=npSoftReboot, npCurLoop=npCurLoop, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIrStatus=npIrStatus, npThermoSensorN=npThermoSensorN, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTable=npIoTable, npRelHumStatus=npRelHumStatus, npRelHumValue=npRelHumValue, npThermoTrapSensorN=npThermoTrapSensorN, npRelayEntry=npRelayEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapData=npRelHumTrapData, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopV=npCurLoopV, npThermoTrapLow=npThermoTrapLow, npRelayMemo=npRelayMemo, npSmokeStatus=npSmokeStatus, npIo=npIo, npRelHumTable=npRelHumTable, FixedPoint1000=FixedPoint1000, npGsmStrength=npGsmStrength, npForcedReboot=npForcedReboot, npRelayMode=npRelayMode, npThermoTraps=npThermoTraps, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayTable=npRelayTable, npSmokeTrap=npSmokeTrap, npIoLineN=npIoLineN, npThermoValue=npThermoValue, npIoTrapLevelIn=npIoTrapLevelIn, npTrapEmailTo=npTrapEmailTo, npIoTrapLevelLegend=npIoTrapLevelLegend, npIrPlayCmd=npIrPlayCmd, npThermoLow=npThermoLow, npGsm=npGsm, npCurLoopTrapI=npCurLoopTrapI, npRelHumMemo=npRelHumMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoEntry=npThermoEntry, npThermo=npThermo, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapR=npCurLoopTrapR, npRelHumidity=npRelHumidity, npRelHumEntry=npRelHumEntry, npRelHumTrapFail=npRelHumTrapFail, npSmokeReset=npSmokeReset, npRelHumTempValue=npRelHumTempValue, npThermoTrapHigh=npThermoTrapHigh, npGsmTrap=npGsmTrap, npCurLoopI=npCurLoopI, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIr=npIr, npRelayState=npRelayState, npIrReset=npIrReset, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapMemo=npIoTrapMemo, npThermoValuePrecise=npThermoValuePrecise, lightcom=lightcom, npGsmTraps=npGsmTraps, npRelHumTempStatus=npRelHumTempStatus, npIoPulseCounter=npIoPulseCounter, npRelHumTrap=npRelHumTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoMemo=npIoMemo, npCurLoopPower=npCurLoopPower)
