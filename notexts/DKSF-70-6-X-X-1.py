...
# Produced by pysmi-1.1.8 at Fri Jan  7 15:31:53 2022
...
TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, iso, NotificationType, Bits, enterprises, Unsigned32, MibIdentifier, Counter64, Gauge32, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "iso", "NotificationType", "Bits", "enterprises", "Unsigned32", "MibIdentifier", "Counter64", "Gauge32", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsm=npGsm, npIr=npIr, npCurLoopTable=npCurLoopTable, npIo=npIo, npRelHumTrapData=npRelHumTrapData, npIrReset=npIrReset, npSmokePower=npSmokePower, npIoLineN=npIoLineN, npThermoValue=npThermoValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoPulseCounter=npIoPulseCounter, npIoTrapMemo=npIoTrapMemo, npIrCtrl=npIrCtrl, npForcedReboot=npForcedReboot, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmFailed=npGsmFailed, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoop=npCurLoop, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTraps=npCurLoopTraps, npIrStatus=npIrStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapLow=npThermoTrapLow, npThermoLow=npThermoLow, npRelHumMemo=npRelHumMemo, npCurLoopTrapR=npCurLoopTrapR, FixedPoint1000=FixedPoint1000, npIoTrap=npIoTrap, npCurLoopR=npCurLoopR, npRelay=npRelay, npCurLoopTrapPower=npCurLoopTrapPower, npTrapInfo=npTrapInfo, npRelHumTrapFail=npRelHumTrapFail, npSmokeTable=npSmokeTable, npThermoTraps=npThermoTraps, npThermoStatus=npThermoStatus, npIoLevelOut=npIoLevelOut, npRelayTable=npRelayTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoSensorN=npThermoSensorN, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npCurLoopN=npCurLoopN, npSmokeEntry=npSmokeEntry, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrap=npSmokeTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npTrapEmailTo=npTrapEmailTo, npIoEntry=npIoEntry, npRelHumTable=npRelHumTable, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumidity=npRelHumidity, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapPrefix=npThermoTrapPrefix, lightcom=lightcom, npSmokeMemo=npSmokeMemo, npRelayEntry=npRelayEntry, npCurLoopTrap=npCurLoopTrap, npRelHumTempValue=npRelHumTempValue, npRelayStartReset=npRelayStartReset, npThermoTrapValue=npThermoTrapValue, npSoftReboot=npSoftReboot, npIoTrapPrefix=npIoTrapPrefix, npSmokeReset=npSmokeReset, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTable=npThermoTable, npIrPlayCmd=npIrPlayCmd, npCurLoopV=npCurLoopV, npRelayMode=npRelayMode, npThermoTrap=npThermoTrap, npCurLoopStatus=npCurLoopStatus, npRelayMemo=npRelayMemo, npThermoTrapSensorN=npThermoTrapSensorN, npIoTraps=npIoTraps, npResetStack=npResetStack, npIoLevelIn=npIoLevelIn, npGsmTraps=npGsmTraps, npThermoEntry=npThermoEntry, npIoMemo=npIoMemo, npCurLoopPower=npCurLoopPower, npRelHumValue=npRelHumValue, npThermo=npThermo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmoke=npSmoke, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopI=npCurLoopI, npGsmInfo=npGsmInfo, npCurLoopTrapI=npCurLoopTrapI, npIoTable=npIoTable, npRelHumTrapDataN=npRelHumTrapDataN, npIoTrapLineN=npIoTrapLineN, npThermoTrapHigh=npThermoTrapHigh, npRelayN=npRelayN, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoMemo=npThermoMemo, npGsmStrength=npGsmStrength, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapMemo=npThermoTrapMemo, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoHigh=npThermoHigh, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeTraps=npSmokeTraps, npRelHumTrapTemp=npRelHumTrapTemp, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapN=npCurLoopTrapN, npRelayState=npRelayState, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmRegistration=npGsmRegistration, npReboot=npReboot, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumN=npRelHumN, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeStatus=npSmokeStatus, npRelHumTrap=npRelHumTrap, npCurLoopEntry=npCurLoopEntry, npRelHumEntry=npRelHumEntry, npRelHumStatus=npRelHumStatus, npGsmTrap=npGsmTrap, npSmokeTrapMemo=npSmokeTrapMemo)
