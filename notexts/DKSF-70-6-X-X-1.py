...
Bits, enterprises, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, Counter32, Unsigned32, MibIdentifier, NotificationType, ModuleIdentity, iso, IpAddress, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "enterprises", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "Counter32", "Unsigned32", "MibIdentifier", "NotificationType", "ModuleIdentity", "iso", "IpAddress", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopR=npCurLoopR, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumValue=npRelHumValue, npGsmTrapPrefix=npGsmTrapPrefix, npIoTable=npIoTable, npRelHumTempStatus=npRelHumTempStatus, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrap=npCurLoopTrap, npSmokePower=npSmokePower, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapPrefix=npThermoTrapPrefix, npGsmFailed=npGsmFailed, FixedPoint1000=FixedPoint1000, npSmokeEntry=npSmokeEntry, npCurLoopTrapV=npCurLoopTrapV, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayEntry=npRelayEntry, npThermoTrapSensorN=npThermoTrapSensorN, npRelayMemo=npRelayMemo, npIr=npIr, npThermoTraps=npThermoTraps, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelay=npRelay, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayMode=npRelayMode, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTable=npSmokeTable, npGsmStrength=npGsmStrength, npRelayTable=npRelayTable, npReboot=npReboot, npTrapInfo=npTrapInfo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapN=npCurLoopTrapN, npCurLoopEntry=npCurLoopEntry, npRelHumMemo=npRelHumMemo, npGsm=npGsm, npCurLoopPower=npCurLoopPower, npSmoke=npSmoke, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayN=npRelayN, npThermoTrap=npThermoTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoEntry=npIoEntry, npCurLoopTable=npCurLoopTable, npSmokeSensorN=npSmokeSensorN, npRelHumidity=npRelHumidity, npThermoTrapValue=npThermoTrapValue, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoStatus=npThermoStatus, npSmokeTrapMemo=npSmokeTrapMemo, npThermoValuePrecise=npThermoValuePrecise, npIo=npIo, npThermoMemo=npThermoMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoLevelOut=npIoLevelOut, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapLow=npThermoTrapLow, npResetStack=npResetStack, npIrCtrl=npIrCtrl, npIoLevelIn=npIoLevelIn, npGsmTraps=npGsmTraps, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIrReset=npIrReset, npGsmTrap=npGsmTrap, npThermoEntry=npThermoEntry, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapData=npRelHumTrapData, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTraps=npCurLoopTraps, npGsmInfo=npGsmInfo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIrPlayCmd=npIrPlayCmd, npSmokeStatus=npSmokeStatus, npForcedReboot=npForcedReboot, lightcom=lightcom, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopN=npCurLoopN, npIoMemo=npIoMemo, npIoLineN=npIoLineN, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrapStatus=npSmokeTrapStatus, npThermoLow=npThermoLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrap=npRelHumTrap, npIoTraps=npIoTraps, npCurLoopTrapI=npCurLoopTrapI, npTrapEmailTo=npTrapEmailTo, npCurLoopStatus=npCurLoopStatus, npSoftReboot=npSoftReboot, npIoTrapLevelLegend=npIoTrapLevelLegend, npIrStatus=npIrStatus, npRelHumTrapFail=npRelHumTrapFail, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopI=npCurLoopI, npThermoTable=npThermoTable, npSmokeTrap=npSmokeTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrap=npIoTrap, npRelayStartReset=npRelayStartReset, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTrapLineN=npIoTrapLineN, npRelHumTable=npRelHumTable, npIoPulseCounter=npIoPulseCounter, npRelHumStatus=npRelHumStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeReset=npSmokeReset, npRelHumN=npRelHumN, npSmokeTraps=npSmokeTraps, npThermoTrapStatus=npThermoTrapStatus, npCurLoop=npCurLoop, npThermoHigh=npThermoHigh, npCurLoopV=npCurLoopV, npThermo=npThermo, npThermoSensorN=npThermoSensorN, npCurLoopTrapPower=npCurLoopTrapPower, npGsmRegistration=npGsmRegistration, npRelHumEntry=npRelHumEntry, npThermoValue=npThermoValue, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayState=npRelayState, npSmokeMemo=npSmokeMemo, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapMemo=npThermoTrapMemo)
