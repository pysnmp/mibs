...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:25:20 2022
...
Counter64, Unsigned32, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, Integer32, NotificationType, TimeTicks, MibIdentifier, Bits, Gauge32, enterprises, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Unsigned32", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "Integer32", "NotificationType", "TimeTicks", "MibIdentifier", "Bits", "Gauge32", "enterprises", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTrapR=npCurLoopTrapR, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrap=npThermoTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoEntry=npIoEntry, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelayN=npRelayN, npIoMemo=npIoMemo, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapLow=npThermoTrapLow, npThermoStatus=npThermoStatus, npRelHumTrap=npRelHumTrap, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapMemo=npThermoTrapMemo, npIoLineN=npIoLineN, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmInfo=npGsmInfo, npIoTrapLineN=npIoTrapLineN, npRelHumTable=npRelHumTable, npIoTraps=npIoTraps, npSmokeEntry=npSmokeEntry, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoop=npCurLoop, npTrapInfo=npTrapInfo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopV=npCurLoopV, npCurLoopTrapN=npCurLoopTrapN, npSmoke=npSmoke, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIrReset=npIrReset, npCurLoopTable=npCurLoopTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapData=npRelHumTrapData, npIoLevelOut=npIoLevelOut, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeStatus=npSmokeStatus, npSmokeReset=npSmokeReset, npCurLoopI=npCurLoopI, npCurLoopN=npCurLoopN, npRelHumValue=npRelHumValue, npSmokeTable=npSmokeTable, npIoTrap=npIoTrap, npCurLoopR=npCurLoopR, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrStatus=npIrStatus, npIoTrapPrefix=npIoTrapPrefix, npThermoLow=npThermoLow, npRelHumEntry=npRelHumEntry, npThermoMemo=npThermoMemo, npThermoTraps=npThermoTraps, npThermoTrapStatus=npThermoTrapStatus, npIoTable=npIoTable, npRelay=npRelay, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTempStatus=npRelHumTempStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayStartReset=npRelayStartReset, npThermoValue=npThermoValue, npThermoHigh=npThermoHigh, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapFail=npRelHumTrapFail, npRelHumMemo=npRelHumMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTable=npThermoTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopPower=npCurLoopPower, npRelayTable=npRelayTable, npRelHumTrapSafe=npRelHumTrapSafe, lightcom=lightcom, FixedPoint1000=FixedPoint1000, npSoftReboot=npSoftReboot, npRelayMemo=npRelayMemo, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumStatus=npRelHumStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayMode=npRelayMode, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoEntry=npThermoEntry, npSmokeTraps=npSmokeTraps, npGsmFailed=npGsmFailed, npIo=npIo, npSmokePower=npSmokePower, npGsm=npGsm, npReboot=npReboot, npIoTrapMemo=npIoTrapMemo, npSmokeMemo=npSmokeMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumN=npRelHumN, npThermo=npThermo, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npForcedReboot=npForcedReboot, npIoPulseCounter=npIoPulseCounter, npThermoTrapValue=npThermoTrapValue, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumidity=npRelHumidity, npCurLoopTraps=npCurLoopTraps, npGsmRegistration=npGsmRegistration, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmStrength=npGsmStrength, npGsmTraps=npGsmTraps, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayEntry=npRelayEntry, npIrPlayCmd=npIrPlayCmd, npIr=npIr, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapI=npCurLoopTrapI, npIoLevelIn=npIoLevelIn, npGsmTrap=npGsmTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayState=npRelayState, npCurLoopEntry=npCurLoopEntry, npSmokeTrap=npSmokeTrap, npIrCtrl=npIrCtrl, npResetStack=npResetStack, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeSensorN=npSmokeSensorN, npThermoSensorN=npThermoSensorN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopStatus=npCurLoopStatus)
