...
# Produced by pysmi-1.1.8 at Wed Sep 13 15:03:08 2023
...
enterprises, ObjectIdentity, Unsigned32, Bits, MibIdentifier, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, IpAddress, Integer32, Counter64, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ObjectIdentity", "Unsigned32", "Bits", "MibIdentifier", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "IpAddress", "Integer32", "Counter64", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoValue=npThermoValue, npThermoMemo=npThermoMemo, lightcom=lightcom, npIrStatus=npIrStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermo=npThermo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumValue=npRelHumValue, npSoftReboot=npSoftReboot, npCurLoopTrapN=npCurLoopTrapN, npCurLoopI=npCurLoopI, npTrapInfo=npTrapInfo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIrReset=npIrReset, npThermoTrapSensorN=npThermoTrapSensorN, npTrapEmailTo=npTrapEmailTo, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsm=npGsm, npIoMemo=npIoMemo, npRelay=npRelay, npThermoTrapLow=npThermoTrapLow, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTable=npThermoTable, npSmoke=npSmoke, npSmokeEntry=npSmokeEntry, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrapStatus=npSmokeTrapStatus, npReboot=npReboot, npThermoTraps=npThermoTraps, npThermoValuePrecise=npThermoValuePrecise, npThermoLow=npThermoLow, npRelHumMemo=npRelHumMemo, npRelHumidity=npRelHumidity, npRelayN=npRelayN, npIoTable=npIoTable, npGsmFailed=npGsmFailed, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTable=npRelHumTable, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrap=npIoTrap, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapR=npCurLoopTrapR, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrap=npRelHumTrap, npCurLoopEntry=npCurLoopEntry, npIoLineN=npIoLineN, npResetStack=npResetStack, npIrPlayCmd=npIrPlayCmd, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTable=npCurLoopTable, npSmokeReset=npSmokeReset, npThermoTrap=npThermoTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTraps=npIoTraps, npCurLoopN=npCurLoopN, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapPrefix=npThermoTrapPrefix, npIo=npIo, npRelayTable=npRelayTable, npRelayStartReset=npRelayStartReset, npGsmInfo=npGsmInfo, npCurLoopV=npCurLoopV, npIrCtrl=npIrCtrl, npCurLoopPower=npCurLoopPower, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmRegistration=npGsmRegistration, npForcedReboot=npForcedReboot, npSmokeTrap=npSmokeTrap, npThermoStatus=npThermoStatus, npSmokeTable=npSmokeTable, npCurLoopTrapPower=npCurLoopTrapPower, npIoPulseCounter=npIoPulseCounter, npRelHumN=npRelHumN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayEntry=npRelayEntry, npIoTrapLineN=npIoTrapLineN, npThermoSensorN=npThermoSensorN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayState=npRelayState, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmTrap=npGsmTrap, npThermoEntry=npThermoEntry, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoop=npCurLoop, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrap=npCurLoopTrap, npIoEntry=npIoEntry, npGsmStrength=npGsmStrength, npIr=npIr, npCurLoopR=npCurLoopR, npThermoTrapValue=npThermoTrapValue, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTempValue=npRelHumTempValue, npRelHumEntry=npRelHumEntry, npSmokePower=npSmokePower, npRelayMode=npRelayMode, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTraps=npSmokeTraps, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeSensorN=npSmokeSensorN, npThermoHigh=npThermoHigh, npIoLevelIn=npIoLevelIn, npRelHumStatus=npRelHumStatus, npIoLevelOut=npIoLevelOut, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, FixedPoint1000=FixedPoint1000, npCurLoopStatus=npCurLoopStatus, npSmokeStatus=npSmokeStatus, npGsmTraps=npGsmTraps, npThermoTrapHigh=npThermoTrapHigh, npIoTrapMemo=npIoTrapMemo, npSmokeMemo=npSmokeMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayMemo=npRelayMemo)
