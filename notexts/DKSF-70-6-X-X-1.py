...
IpAddress, Unsigned32, ObjectIdentity, Counter32, ModuleIdentity, NotificationType, Integer32, Gauge32, TimeTicks, Bits, enterprises, Counter64, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "ObjectIdentity", "Counter32", "ModuleIdentity", "NotificationType", "Integer32", "Gauge32", "TimeTicks", "Bits", "enterprises", "Counter64", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermo=npThermo, npThermoStatus=npThermoStatus, npIoLevelOut=npIoLevelOut, npRelHumMemo=npRelHumMemo, npIoTable=npIoTable, npSmokeSensorN=npSmokeSensorN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIrCtrl=npIrCtrl, npSmokeTrap=npSmokeTrap, npRelHumTempValue=npRelHumTempValue, npSmoke=npSmoke, lightcom=lightcom, npThermoHigh=npThermoHigh, npSoftReboot=npSoftReboot, npRelayTable=npRelayTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayMode=npRelayMode, npThermoValue=npThermoValue, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapValue=npThermoTrapValue, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapData=npRelHumTrapData, npIoTrapLevelIn=npIoTrapLevelIn, npGsmInfo=npGsmInfo, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumidity=npRelHumidity, npIoLineN=npIoLineN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapV=npCurLoopTrapV, npThermoSensorN=npThermoSensorN, npThermoTraps=npThermoTraps, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTable=npSmokeTable, npGsmTrap=npGsmTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmRegistration=npGsmRegistration, npCurLoopEntry=npCurLoopEntry, npRelHumStatus=npRelHumStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataN=npRelHumTrapDataN, npIrPlayCmd=npIrPlayCmd, npRelayN=npRelayN, npRelHumN=npRelHumN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeMemo=npSmokeMemo, npSmokeTraps=npSmokeTraps, npRelay=npRelay, npRelHumValue=npRelHumValue, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapI=npCurLoopTrapI, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopPower=npCurLoopPower, npIoTrap=npIoTrap, npCurLoopV=npCurLoopV, npGsmStrength=npGsmStrength, npIoTraps=npIoTraps, npCurLoopN=npCurLoopN, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrap=npRelHumTrap, npGsmTraps=npGsmTraps, npIoTrapLineN=npIoTrapLineN, npSmokeReset=npSmokeReset, npRelHumEntry=npRelHumEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npTrapEmailTo=npTrapEmailTo, npSmokeTrapStatus=npSmokeTrapStatus, npRelayEntry=npRelayEntry, npIoTrapMemo=npIoTrapMemo, npRelayStartReset=npRelayStartReset, npCurLoopI=npCurLoopI, npIr=npIr, npThermoTrap=npThermoTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTable=npCurLoopTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokePower=npSmokePower, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoEntry=npThermoEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npForcedReboot=npForcedReboot, npCurLoopStatus=npCurLoopStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTable=npThermoTable, npIoMemo=npIoMemo, npSmokeStatus=npSmokeStatus, npIoLevelIn=npIoLevelIn, npGsmFailed=npGsmFailed, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoop=npCurLoop, npThermoTrapPrefix=npThermoTrapPrefix, npIrStatus=npIrStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapFail=npRelHumTrapFail, npTrapInfo=npTrapInfo, npThermoTrapStatus=npThermoTrapStatus, npRelayMemo=npRelayMemo, npThermoMemo=npThermoMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npResetStack=npResetStack, npRelayState=npRelayState, npIoEntry=npIoEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIo=npIo, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopR=npCurLoopR, npRelHumTable=npRelHumTable, FixedPoint1000=FixedPoint1000, npReboot=npReboot, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIrReset=npIrReset, npSmokeEntry=npSmokeEntry, npThermoLow=npThermoLow, npGsm=npGsm, npThermoTrapMemo=npThermoTrapMemo)
