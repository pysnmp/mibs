...
ObjectIdentity, Integer32, Counter64, Counter32, Gauge32, iso, Bits, enterprises, NotificationType, MibIdentifier, Unsigned32, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "Counter64", "Counter32", "Gauge32", "iso", "Bits", "enterprises", "NotificationType", "MibIdentifier", "Unsigned32", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTable=npSmokeTable, npSmokeReset=npSmokeReset, npRelHumTrapFail=npRelHumTrapFail, npGsmTraps=npGsmTraps, npIoTrap=npIoTrap, npCurLoopV=npCurLoopV, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopEntry=npCurLoopEntry, npCurLoopTrap=npCurLoopTrap, npRelHumTable=npRelHumTable, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayTable=npRelayTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoEntry=npIoEntry, npIoLineN=npIoLineN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTraps=npIoTraps, npRelHumN=npRelHumN, npRelHumidity=npRelHumidity, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopR=npCurLoopR, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrapLineN=npIoTrapLineN, npRelHumTempValue=npRelHumTempValue, npIoTable=npIoTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayN=npRelayN, npThermoHigh=npThermoHigh, npCurLoop=npCurLoop, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelayMode=npRelayMode, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npResetStack=npResetStack, npCurLoopPower=npCurLoopPower, npTrapInfo=npTrapInfo, npThermo=npThermo, npSmokeTraps=npSmokeTraps, npSmokeSensorN=npSmokeSensorN, npIo=npIo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrap=npThermoTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmRegistration=npGsmRegistration, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapV=npCurLoopTrapV, npGsmTrap=npGsmTrap, npSmokeTrapStatus=npSmokeTrapStatus, npRelayStartReset=npRelayStartReset, npIoPulseCounter=npIoPulseCounter, npRelayState=npRelayState, npThermoTrapHigh=npThermoTrapHigh, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTraps=npCurLoopTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrapMemo=npIoTrapMemo, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrap=npRelHumTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npReboot=npReboot, npThermoSensorN=npThermoSensorN, npThermoValue=npThermoValue, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTable=npCurLoopTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTempStatus=npRelHumTempStatus, npGsmFailed=npGsmFailed, npForcedReboot=npForcedReboot, npRelHumStatus=npRelHumStatus, npIrReset=npIrReset, npSmoke=npSmoke, npGsm=npGsm, npGsmStrength=npGsmStrength, npThermoTraps=npThermoTraps, npThermoTrapPrefix=npThermoTrapPrefix, npIoMemo=npIoMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelay=npRelay, npCurLoopTrapN=npCurLoopTrapN, npIrStatus=npIrStatus, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumEntry=npRelHumEntry, npSmokeTrap=npSmokeTrap, npCurLoopI=npCurLoopI, npThermoTrapLow=npThermoTrapLow, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeStatus=npSmokeStatus, npCurLoopTrapI=npCurLoopTrapI, npIoLevelOut=npIoLevelOut, npIr=npIr, npSmokeTrapMemo=npSmokeTrapMemo, npIrCtrl=npIrCtrl, npThermoTable=npThermoTable, npSmokeEntry=npSmokeEntry, npThermoStatus=npThermoStatus, npIoTrapPrefix=npIoTrapPrefix, npRelHumMemo=npRelHumMemo, npRelayEntry=npRelayEntry, npCurLoopStatus=npCurLoopStatus, npIoLevelIn=npIoLevelIn, npRelHumValue=npRelHumValue, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmInfo=npGsmInfo, npSmokeMemo=npSmokeMemo, npSmokePower=npSmokePower, FixedPoint1000=FixedPoint1000, npThermoMemo=npThermoMemo, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapPower=npCurLoopTrapPower, npThermoEntry=npThermoEntry, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapValue=npThermoTrapValue, npSoftReboot=npSoftReboot, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopN=npCurLoopN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapR=npCurLoopTrapR, lightcom=lightcom, npRelayMemo=npRelayMemo, npThermoValuePrecise=npThermoValuePrecise, npThermoLow=npThermoLow)
