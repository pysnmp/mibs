...
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks, Bits, ObjectIdentity, Counter32, MibIdentifier, Unsigned32, NotificationType, iso, Integer32, IpAddress, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks", "Bits", "ObjectIdentity", "Counter32", "MibIdentifier", "Unsigned32", "NotificationType", "iso", "Integer32", "IpAddress", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrapLineN=npIoTrapLineN, npGsm=npGsm, npThermoStatus=npThermoStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapI=npCurLoopTrapI, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapFail=npRelHumTrapFail, npRelHumTable=npRelHumTable, npSmokeTrapStatus=npSmokeTrapStatus, npIoTrapMemo=npIoTrapMemo, npIoTraps=npIoTraps, npThermoLow=npThermoLow, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapStatus=npThermoTrapStatus, npSmokeReset=npSmokeReset, npCurLoopR=npCurLoopR, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npSoftReboot=npSoftReboot, npThermoHigh=npThermoHigh, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopN=npCurLoopN, npSmokeTrap=npSmokeTrap, npCurLoopPower=npCurLoopPower, npCurLoopTrap=npCurLoopTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayEntry=npRelayEntry, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeEntry=npSmokeEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIrReset=npIrReset, npCurLoopTable=npCurLoopTable, npRelHumStatus=npRelHumStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIr=npIr, npThermoTrapLow=npThermoTrapLow, npIrCtrl=npIrCtrl, npRelHumEntry=npRelHumEntry, npSmokeStatus=npSmokeStatus, npSmokeTraps=npSmokeTraps, npIoEntry=npIoEntry, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrap=npThermoTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTempValue=npRelHumTempValue, npGsmTrap=npGsmTrap, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmTrapPrefix=npGsmTrapPrefix, npSmoke=npSmoke, npCurLoopI=npCurLoopI, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapR=npCurLoopTrapR, npIrStatus=npIrStatus, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTraps=npCurLoopTraps, npSmokePower=npSmokePower, npIoTrapLevelLegend=npIoTrapLevelLegend, npReboot=npReboot, npRelayMemo=npRelayMemo, npForcedReboot=npForcedReboot, npSmokeMemo=npSmokeMemo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapData=npRelHumTrapData, lightcom=lightcom, npIoTrapLevelIn=npIoTrapLevelIn, npIoSinglePulseStart=npIoSinglePulseStart, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoLevelIn=npIoLevelIn, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTraps=npThermoTraps, npCurLoop=npCurLoop, npIoTable=npIoTable, npResetStack=npResetStack, npRelHumTempStatus=npRelHumTempStatus, npRelayTable=npRelayTable, npRelayStartReset=npRelayStartReset, npThermoTrapValue=npThermoTrapValue, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoSensorN=npThermoSensorN, npIoTrap=npIoTrap, npIoPulseCounter=npIoPulseCounter, npThermoMemo=npThermoMemo, npThermoTrapMemo=npThermoTrapMemo, npRelHumidity=npRelHumidity, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopEntry=npCurLoopEntry, npIo=npIo, npIoMemo=npIoMemo, npThermoValue=npThermoValue, npRelayN=npRelayN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npTrapInfo=npTrapInfo, npCurLoopTrapN=npCurLoopTrapN, npSmokeTable=npSmokeTable, npRelHumN=npRelHumN, npThermoEntry=npThermoEntry, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapHigh=npThermoTrapHigh, FixedPoint1000=FixedPoint1000, npThermo=npThermo, npThermoTable=npThermoTable, npRelayState=npRelayState, npGsmRegistration=npGsmRegistration, npRelayMode=npRelayMode, npCurLoopTrapV=npCurLoopTrapV, npIoLineN=npIoLineN, npGsmInfo=npGsmInfo, npGsmFailed=npGsmFailed, npIoLevelOut=npIoLevelOut, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmTraps=npGsmTraps, npRelay=npRelay, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumValue=npRelHumValue, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopV=npCurLoopV, npSmokeSensorN=npSmokeSensorN, npTrapEmailTo=npTrapEmailTo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumMemo=npRelHumMemo, npRelHumTrap=npRelHumTrap, npGsmStrength=npGsmStrength, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoValuePrecise=npThermoValuePrecise, npCurLoopStatus=npCurLoopStatus, npIrPlayCmd=npIrPlayCmd)
