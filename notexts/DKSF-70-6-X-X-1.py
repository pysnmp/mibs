...
# Produced by pysmi-1.1.8 at Fri Jan 27 15:51:21 2023
...
Gauge32, NotificationType, ModuleIdentity, MibIdentifier, enterprises, Bits, Integer32, Counter32, iso, Unsigned32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "ModuleIdentity", "MibIdentifier", "enterprises", "Bits", "Integer32", "Counter32", "iso", "Unsigned32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsm=npGsm, npSmokeStatus=npSmokeStatus, npSmokeTrap=npSmokeTrap, npRelHumTrapDataN=npRelHumTrapDataN, npIoTrapLineN=npIoTrapLineN, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTable=npSmokeTable, npRelHumStatus=npRelHumStatus, npThermoTable=npThermoTable, npCurLoopTrapR=npCurLoopTrapR, npThermoStatus=npThermoStatus, npCurLoop=npCurLoop, uniPingServerSolutionV3=uniPingServerSolutionV3, npResetStack=npResetStack, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopV=npCurLoopV, npThermoTrapStatus=npThermoTrapStatus, FixedPoint1000=FixedPoint1000, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTraps=npCurLoopTraps, npThermoEntry=npThermoEntry, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumidity=npRelHumidity, npThermoTrap=npThermoTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npForcedReboot=npForcedReboot, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapN=npCurLoopTrapN, npIrReset=npIrReset, npRelayTable=npRelayTable, npThermoTrapLow=npThermoTrapLow, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrap=npCurLoopTrap, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumEntry=npRelHumEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmTraps=npGsmTraps, npSmokeEntry=npSmokeEntry, npThermoTrapMemo=npThermoTrapMemo, npThermo=npThermo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTable=npRelHumTable, npIrStatus=npIrStatus, npIoLineN=npIoLineN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapI=npCurLoopTrapI, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopStatus=npCurLoopStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTraps=npIoTraps, npIoSinglePulseStart=npIoSinglePulseStart, npRelayEntry=npRelayEntry, npCurLoopTable=npCurLoopTable, npIr=npIr, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIrCtrl=npIrCtrl, npThermoMemo=npThermoMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapFail=npRelHumTrapFail, npRelayMode=npRelayMode, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTempStatus=npRelHumTempStatus, npTrapEmailTo=npTrapEmailTo, npIoPulseCounter=npIoPulseCounter, npRelHumTrap=npRelHumTrap, npCurLoopR=npCurLoopR, npThermoHigh=npThermoHigh, npThermoTraps=npThermoTraps, npIo=npIo, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapValue=npThermoTrapValue, npRelayN=npRelayN, npGsmRegistration=npGsmRegistration, npIoLevelIn=npIoLevelIn, npRelay=npRelay, npSmokeTraps=npSmokeTraps, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmStrength=npGsmStrength, npSmoke=npSmoke, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIrPlayCmd=npIrPlayCmd, npSmokeSensorN=npSmokeSensorN, npSmokeMemo=npSmokeMemo, npRelHumTrapData=npRelHumTrapData, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeReset=npSmokeReset, npRelayMemo=npRelayMemo, npIoTable=npIoTable, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTrapMemo=npSmokeTrapMemo, npThermoValue=npThermoValue, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumN=npRelHumN, npIoTrapMemo=npIoTrapMemo, npSoftReboot=npSoftReboot, npReboot=npReboot, npGsmFailed=npGsmFailed, npRelayStartReset=npRelayStartReset, npIoTrapPrefix=npIoTrapPrefix, npCurLoopN=npCurLoopN, npThermoSensorN=npThermoSensorN, npIoEntry=npIoEntry, npCurLoopPower=npCurLoopPower, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapAllEvents=npRelHumTrapAllEvents, lightcom=lightcom, npTrapInfo=npTrapInfo, npRelHumMemo=npRelHumMemo, npIoLevelOut=npIoLevelOut, npCurLoopI=npCurLoopI, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrap=npIoTrap, npCurLoopTrapV=npCurLoopTrapV, npRelayState=npRelayState, npThermoValuePrecise=npThermoValuePrecise, npGsmTrap=npGsmTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapSensorN=npThermoTrapSensorN, npSmokePower=npSmokePower, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoLow=npThermoLow, npGsmInfo=npGsmInfo, npRelHumValue=npRelHumValue, npIoMemo=npIoMemo, npGsmTrapPrefix=npGsmTrapPrefix)
