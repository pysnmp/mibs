...
# ASN.1 source BASIS-SHELF-MIB
# Source digest sha256:054dbc400c3f4815e25988fb493ca85dd5f8e4098fe94489eb45f4c87fd6f382
...
shelfTable = MibTable((1, 3, 6, 1, 4, 1, 351, 110, 1, 1, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: shelfTable.setStatus('mandatory')
shelfEntry = MibTableRow((1, 3, 6, 1, 4, 1, 351, 110, 1, 1, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "BASIS-SHELF-MIB", "shelfNum"), (0, "BASIS-SHELF-MIB", "shelfSlotNum"))
...
shelfTmZnGMTOff = MibScalar((1, 3, 6, 1, 4, 1, 351, 110, 1, 1, 7), Integer32().subtype(subtypeSpec=ValueRangeConstraint(-12, 12)).clone(0)).setMaxAccess("readwrite")
...
statsCollectionInterval = MibScalar((1, 3, 6, 1, 4, 1, 351, 110, 1, 1, 11), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 65535)).clone(0)).setMaxAccess("readonly")
if mibBuilder.loadTexts: statsCollectionInterval.setStatus('mandatory')
statsBucketInterval = MibScalar((1, 3, 6, 1, 4, 1, 351, 110, 1, 1, 12), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 65535)).clone(0)).setMaxAccess("readonly")
...
shelfAlarmCardBitMap = MibScalar((1, 3, 6, 1, 4, 1, 351, 110, 1, 1, 15), Integer32().clone(0)).setMaxAccess("readonly")
...
shelfCBClkRateTable = MibTable((1, 3, 6, 1, 4, 1, 351, 110, 1, 1, 22), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: shelfCBClkRateTable.setStatus('mandatory')
shelfCBClkRateEntry = MibTableRow((1, 3, 6, 1, 4, 1, 351, 110, 1, 1, 22, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "BASIS-SHELF-MIB", "cBNum"))
...
smRedMapTable = MibTable((1, 3, 6, 1, 4, 1, 351, 110, 1, 3, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: smRedMapTable.setStatus('mandatory')
smRedMapEntry = MibTableRow((1, 3, 6, 1, 4, 1, 351, 110, 1, 3, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "BASIS-SHELF-MIB", "redPrimarySlotNum"))
...
redPrimaryType = MibTableColumn((1, 3, 6, 1, 4, 1, 351, 110, 1, 3, 1, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 10, 20, 30, 31, 34, 35, 36, 37, 40, 41, 50, 51, 52, 53, 60, 61, 70, 71, 72, 73, 80, 90, 91, 100, 101, 130, 131, 132, 133, 134, 135, 136, 137, 140, 141, 110, 111, 120, 121, 150, 151, 1000, 1001, 1002, 1003, 2000, 2001))).clone(namedValues=NamedValues(("other", 1), ("bsc", 2), ("aum-T3", 10), ("tim", 20), ("frsm-4T1", 30), ("frsm-4E1", 31), ("frsm-hs1", 34), ("frsm-8T1", 35), ("frsm-8E1", 36), ("frsm-hs1b", 37), ("ausm-4T1", 40), ("ausm-4E1", 41), ("ausm-8T1", 50), ("ausm-8E1", 51), ("ausmB-8T1", 52), ("ausmB-8E1", 53), ("cesm-4T1", 60), ("cesm-4E1", 61), ("imatm-T3T1", 70), ("imatm-E3E1", 71), ("imatmB-T1", 72), ("imatmB-E1", 73), ("frasm-8T1", 80), ("cesm-8T1", 90), ("cesm-8E1", 91), ("bscsm-2", 100), ("bscsm-4", 101), ("frsm-2ct3", 130), ("frsm-2t3", 131), ("frsm-2e3", 132), ("frsm-hs2", 133), ("frsm-2t3b", 134), ("frsm-2e3b", 135), ("frsm-hs2b-hssi", 136), ("frsm-hs2b-12In1", 137), ("cesm-T3", 140), ("cesm-E3", 141), ("atmt-8T1", 110), ("atmt-8E1", 111), ("frt-8T1", 120), ("frt-8E1", 121), ("vism-8T1", 150), ("vism-8E1", 151), ("pxm1", 1000), ("pxm1-2t3e3", 1001), ("pxm1-4oc3", 1002), ("pxm1-oc12", 1003), ("rpm", 2000), ("rpm-pr", 2001)))).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("BASIS-SHELF-MIB", apsIpAddress=apsIpAddress, axisFeederTkNo=axisFeederTkNo, axisSvcBilling=axisSvcBilling, axisSvcBillingBucketInterval=axisSvcBillingBucketInterval, axisSvcBillingColInterval=axisSvcBillingColInterval, cBNum=cBNum, clkRate=clkRate, redCoveringSlot=redCoveringSlot, redFeature=redFeature, redLineModuleType=redLineModuleType, redPrimarySlotNum=redPrimarySlotNum, redPrimaryState=redPrimaryState, redPrimaryType=redPrimaryType, redRowStatus=redRowStatus, redSecondarySlotNum=redSecondarySlotNum, redSecondaryState=redSecondaryState, redSecondaryType=redSecondaryType, redType=redType, redundantApsIpAddress=redundantApsIpAddress, shelfAlarmCardBitMap=shelfAlarmCardBitMap, shelfBkPlnType=shelfBkPlnType, shelfBkplnSerialNum=shelfBkplnSerialNum, shelfBkplnSerialNumDeprecated=shelfBkplnSerialNumDeprecated, shelfCBClkRateEntry=shelfCBClkRateEntry, shelfCBClkRateTable=shelfCBClkRateTable, shelfDate=shelfDate, shelfEntry=shelfEntry, shelfFunctionModuleHoldReset=shelfFunctionModuleHoldReset, shelfFunctionModuleState=shelfFunctionModuleState, shelfFunctionModuleType=shelfFunctionModuleType, shelfIntegratedAlarm=shelfIntegratedAlarm, shelfNodeName=shelfNodeName, shelfNum=shelfNum, shelfNumOfValidEntries=shelfNumOfValidEntries, shelfPowerSupplyVoltage=shelfPowerSupplyVoltage, shelfSlotNum=shelfSlotNum, shelfTable=shelfTable, shelfTime=shelfTime, shelfTmZn=shelfTmZn, shelfTmZnGMTOff=shelfTmZnGMTOff, smRedMapEntry=smRedMapEntry, smRedMapTable=smRedMapTable, statsBucketInterval=statsBucketInterval, statsCollectionInterval=statsCollectionInterval, statsMasterIpAddress=statsMasterIpAddress, userName=userName)
