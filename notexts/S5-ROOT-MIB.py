...
mibBuilder.exportSymbols("S5-ROOT-MIB", bnLogMsg=bnLogMsg, s5EnMsTop=s5EnMsTop, remoteLoginTrap=remoteLoginTrap, s5reg=s5reg, s5RootMib=s5RootMib, s5IfExt=s5IfExt, s5FddTrap=s5FddTrap, atmTraps=atmTraps, s5Com=s5Com, s5AtmTop=s5AtmTop, s5Eth=s5Eth, stpChangeTrap=stpChangeTrap, PYSNMP_MODULE_ID=s5RootMib, s5Tok=s5Tok, s5FdTop=s5FdTop, s5TrTop=s5TrTop, s5Traps=s5Traps, s5EnTop=s5EnTop, s5EthTrap=s5EthTrap, s5Chassis=s5Chassis, s5Tcs=s5Tcs, s5EcellTrap=s5EcellTrap, s5Agent=s5Agent, s5ChaTrap=s5ChaTrap, s5ComTrap=s5ComTrap, s5Fddi=s5Fddi, s5TokTrap=s5TokTrap)
