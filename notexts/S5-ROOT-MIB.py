...
mibBuilder.exportSymbols("S5-ROOT-MIB", PYSNMP_MODULE_ID=s5RootMib, s5AtmTop=s5AtmTop, s5Chassis=s5Chassis, s5Eth=s5Eth, s5Agent=s5Agent, s5RootMib=s5RootMib, stpChangeTrap=stpChangeTrap, s5Fddi=s5Fddi, remoteLoginTrap=remoteLoginTrap, bnLogMsg=bnLogMsg, s5TrTop=s5TrTop, s5EcellTrap=s5EcellTrap, atmTraps=atmTraps, s5EnTop=s5EnTop, s5EnMsTop=s5EnMsTop, s5EthTrap=s5EthTrap, s5FdTop=s5FdTop, s5Tcs=s5Tcs, s5FddTrap=s5FddTrap, s5ComTrap=s5ComTrap, s5IfExt=s5IfExt, s5Tok=s5Tok, s5Traps=s5Traps, s5reg=s5reg, s5Com=s5Com, s5ChaTrap=s5ChaTrap, s5TokTrap=s5TokTrap)
