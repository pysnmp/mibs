...
mibBuilder.exportSymbols("S5-ROOT-MIB", PYSNMP_MODULE_ID=s5RootMib, stpChangeTrap=stpChangeTrap, s5ChaTrap=s5ChaTrap, s5Agent=s5Agent, s5EnTop=s5EnTop, atmTraps=atmTraps, s5FdTop=s5FdTop, s5TokTrap=s5TokTrap, bnLogMsg=bnLogMsg, s5Com=s5Com, s5FddTrap=s5FddTrap, s5RootMib=s5RootMib, s5Tok=s5Tok, s5Traps=s5Traps, s5Eth=s5Eth, s5Chassis=s5Chassis, s5AtmTop=s5AtmTop, s5EthTrap=s5EthTrap, s5EcellTrap=s5EcellTrap, s5ComTrap=s5ComTrap, s5TrTop=s5TrTop, s5IfExt=s5IfExt, s5EnMsTop=s5EnMsTop, remoteLoginTrap=remoteLoginTrap, s5Fddi=s5Fddi, s5reg=s5reg, s5Tcs=s5Tcs)
