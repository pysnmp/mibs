...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5TrTop=s5TrTop, atmTraps=atmTraps, s5Traps=s5Traps, s5RootMib=s5RootMib, s5Eth=s5Eth, s5Tcs=s5Tcs, s5Chassis=s5Chassis, s5EnMsTop=s5EnMsTop, s5ChaTrap=s5ChaTrap, s5FdTop=s5FdTop, s5Tok=s5Tok, s5ComTrap=s5ComTrap, bnLogMsg=bnLogMsg, PYSNMP_MODULE_ID=s5RootMib, s5reg=s5reg, s5Fddi=s5Fddi, stpChangeTrap=stpChangeTrap, s5Agent=s5Agent, s5TokTrap=s5TokTrap, s5FddTrap=s5FddTrap, s5Com=s5Com, s5EthTrap=s5EthTrap, remoteLoginTrap=remoteLoginTrap, s5EnTop=s5EnTop, s5AtmTop=s5AtmTop, s5EcellTrap=s5EcellTrap, s5IfExt=s5IfExt)
