...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5Tok=s5Tok, bnLogMsg=bnLogMsg, s5Com=s5Com, s5ComTrap=s5ComTrap, s5TokTrap=s5TokTrap, s5reg=s5reg, s5RootMib=s5RootMib, s5ChaTrap=s5ChaTrap, s5FddTrap=s5FddTrap, atmTraps=atmTraps, s5TrTop=s5TrTop, s5Agent=s5Agent, s5EcellTrap=s5EcellTrap, s5Traps=s5Traps, stpChangeTrap=stpChangeTrap, s5AtmTop=s5AtmTop, s5EnMsTop=s5EnMsTop, s5Chassis=s5Chassis, s5FdTop=s5FdTop, s5Eth=s5Eth, s5EnTop=s5EnTop, s5Fddi=s5Fddi, PYSNMP_MODULE_ID=s5RootMib, remoteLoginTrap=remoteLoginTrap, s5Tcs=s5Tcs, s5EthTrap=s5EthTrap, s5IfExt=s5IfExt)
