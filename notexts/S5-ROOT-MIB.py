...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5AtmTop=s5AtmTop, s5Agent=s5Agent, remoteLoginTrap=remoteLoginTrap, s5ChaTrap=s5ChaTrap, s5Chassis=s5Chassis, s5reg=s5reg, s5TrTop=s5TrTop, s5Tok=s5Tok, s5Eth=s5Eth, s5Traps=s5Traps, s5RootMib=s5RootMib, s5EthTrap=s5EthTrap, atmTraps=atmTraps, s5EnMsTop=s5EnMsTop, s5TokTrap=s5TokTrap, s5Tcs=s5Tcs, PYSNMP_MODULE_ID=s5RootMib, s5ComTrap=s5ComTrap, s5FddTrap=s5FddTrap, stpChangeTrap=stpChangeTrap, s5IfExt=s5IfExt, s5Com=s5Com, s5EcellTrap=s5EcellTrap, s5EnTop=s5EnTop, s5Fddi=s5Fddi, s5FdTop=s5FdTop, bnLogMsg=bnLogMsg)
