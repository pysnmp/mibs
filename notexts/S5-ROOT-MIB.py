...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5TokTrap=s5TokTrap, atmTraps=atmTraps, s5reg=s5reg, s5FdTop=s5FdTop, s5AtmTop=s5AtmTop, bnLogMsg=bnLogMsg, s5Eth=s5Eth, s5Chassis=s5Chassis, s5ChaTrap=s5ChaTrap, s5EcellTrap=s5EcellTrap, remoteLoginTrap=remoteLoginTrap, s5Tok=s5Tok, s5EthTrap=s5EthTrap, s5Agent=s5Agent, s5IfExt=s5IfExt, s5EnTop=s5EnTop, s5Fddi=s5Fddi, PYSNMP_MODULE_ID=s5RootMib, s5ComTrap=s5ComTrap, s5TrTop=s5TrTop, s5EnMsTop=s5EnMsTop, s5RootMib=s5RootMib, s5Tcs=s5Tcs, s5Traps=s5Traps, stpChangeTrap=stpChangeTrap, s5Com=s5Com, s5FddTrap=s5FddTrap)
