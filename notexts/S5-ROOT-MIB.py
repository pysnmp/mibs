...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5Com=s5Com, s5Chassis=s5Chassis, s5Traps=s5Traps, s5TokTrap=s5TokTrap, s5FddTrap=s5FddTrap, s5EthTrap=s5EthTrap, stpChangeTrap=stpChangeTrap, PYSNMP_MODULE_ID=s5RootMib, s5IfExt=s5IfExt, s5FdTop=s5FdTop, remoteLoginTrap=remoteLoginTrap, s5Eth=s5Eth, s5Agent=s5Agent, bnLogMsg=bnLogMsg, s5AtmTop=s5AtmTop, atmTraps=atmTraps, s5reg=s5reg, s5RootMib=s5RootMib, s5ChaTrap=s5ChaTrap, s5EnMsTop=s5EnMsTop, s5EnTop=s5EnTop, s5Tcs=s5Tcs, s5Fddi=s5Fddi, s5Tok=s5Tok, s5EcellTrap=s5EcellTrap, s5ComTrap=s5ComTrap, s5TrTop=s5TrTop)
