...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5TokTrap=s5TokTrap, s5ChaTrap=s5ChaTrap, s5Agent=s5Agent, s5Eth=s5Eth, s5Fddi=s5Fddi, remoteLoginTrap=remoteLoginTrap, s5reg=s5reg, s5Tcs=s5Tcs, stpChangeTrap=stpChangeTrap, s5EnMsTop=s5EnMsTop, PYSNMP_MODULE_ID=s5RootMib, s5EcellTrap=s5EcellTrap, s5RootMib=s5RootMib, s5Traps=s5Traps, s5Com=s5Com, s5TrTop=s5TrTop, s5FdTop=s5FdTop, s5Chassis=s5Chassis, s5ComTrap=s5ComTrap, s5EnTop=s5EnTop, s5FddTrap=s5FddTrap, s5EthTrap=s5EthTrap, bnLogMsg=bnLogMsg, atmTraps=atmTraps, s5IfExt=s5IfExt, s5AtmTop=s5AtmTop, s5Tok=s5Tok)
