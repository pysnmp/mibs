...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5ComTrap=s5ComTrap, s5Agent=s5Agent, s5TrTop=s5TrTop, s5Tok=s5Tok, stpChangeTrap=stpChangeTrap, remoteLoginTrap=remoteLoginTrap, PYSNMP_MODULE_ID=s5RootMib, s5Chassis=s5Chassis, s5EnTop=s5EnTop, s5reg=s5reg, s5Tcs=s5Tcs, s5EnMsTop=s5EnMsTop, s5FddTrap=s5FddTrap, s5ChaTrap=s5ChaTrap, s5Eth=s5Eth, s5Fddi=s5Fddi, s5Com=s5Com, s5Traps=s5Traps, s5IfExt=s5IfExt, s5FdTop=s5FdTop, atmTraps=atmTraps, s5RootMib=s5RootMib, s5EthTrap=s5EthTrap, bnLogMsg=bnLogMsg, s5EcellTrap=s5EcellTrap, s5AtmTop=s5AtmTop, s5TokTrap=s5TokTrap)
