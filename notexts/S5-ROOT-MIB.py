...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5ComTrap=s5ComTrap, PYSNMP_MODULE_ID=s5RootMib, s5EthTrap=s5EthTrap, s5FddTrap=s5FddTrap, s5Agent=s5Agent, remoteLoginTrap=remoteLoginTrap, s5Chassis=s5Chassis, stpChangeTrap=stpChangeTrap, s5reg=s5reg, s5AtmTop=s5AtmTop, bnLogMsg=bnLogMsg, s5Traps=s5Traps, s5ChaTrap=s5ChaTrap, s5Tcs=s5Tcs, s5RootMib=s5RootMib, atmTraps=atmTraps, s5IfExt=s5IfExt, s5Com=s5Com, s5TrTop=s5TrTop, s5Eth=s5Eth, s5EcellTrap=s5EcellTrap, s5FdTop=s5FdTop, s5TokTrap=s5TokTrap, s5EnTop=s5EnTop, s5Tok=s5Tok, s5Fddi=s5Fddi, s5EnMsTop=s5EnMsTop)
