...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5Fddi=s5Fddi, s5TokTrap=s5TokTrap, s5Tcs=s5Tcs, s5EnMsTop=s5EnMsTop, s5FddTrap=s5FddTrap, s5RootMib=s5RootMib, s5FdTop=s5FdTop, stpChangeTrap=stpChangeTrap, remoteLoginTrap=remoteLoginTrap, s5TrTop=s5TrTop, s5Traps=s5Traps, s5Tok=s5Tok, PYSNMP_MODULE_ID=s5RootMib, s5EthTrap=s5EthTrap, s5ComTrap=s5ComTrap, bnLogMsg=bnLogMsg, s5Agent=s5Agent, s5EnTop=s5EnTop, s5Chassis=s5Chassis, s5EcellTrap=s5EcellTrap, s5Eth=s5Eth, s5AtmTop=s5AtmTop, s5IfExt=s5IfExt, s5reg=s5reg, atmTraps=atmTraps, s5Com=s5Com, s5ChaTrap=s5ChaTrap)
