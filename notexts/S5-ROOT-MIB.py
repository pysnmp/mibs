...
mibBuilder.exportSymbols("S5-ROOT-MIB", bnLogMsg=bnLogMsg, stpChangeTrap=stpChangeTrap, s5AtmTop=s5AtmTop, s5TokTrap=s5TokTrap, s5Eth=s5Eth, s5Fddi=s5Fddi, PYSNMP_MODULE_ID=s5RootMib, s5Chassis=s5Chassis, s5IfExt=s5IfExt, s5Com=s5Com, s5TrTop=s5TrTop, s5ComTrap=s5ComTrap, remoteLoginTrap=remoteLoginTrap, s5RootMib=s5RootMib, atmTraps=atmTraps, s5FdTop=s5FdTop, s5ChaTrap=s5ChaTrap, s5EthTrap=s5EthTrap, s5FddTrap=s5FddTrap, s5EcellTrap=s5EcellTrap, s5Tok=s5Tok, s5reg=s5reg, s5Traps=s5Traps, s5Agent=s5Agent, s5EnMsTop=s5EnMsTop, s5Tcs=s5Tcs, s5EnTop=s5EnTop)
