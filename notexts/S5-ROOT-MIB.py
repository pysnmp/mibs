...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5Tcs=s5Tcs, s5EnTop=s5EnTop, s5reg=s5reg, s5ChaTrap=s5ChaTrap, s5ComTrap=s5ComTrap, s5Agent=s5Agent, s5Com=s5Com, remoteLoginTrap=remoteLoginTrap, s5Fddi=s5Fddi, atmTraps=atmTraps, s5Eth=s5Eth, s5TokTrap=s5TokTrap, s5TrTop=s5TrTop, s5EcellTrap=s5EcellTrap, s5RootMib=s5RootMib, s5EthTrap=s5EthTrap, bnLogMsg=bnLogMsg, s5Chassis=s5Chassis, s5IfExt=s5IfExt, s5Tok=s5Tok, s5AtmTop=s5AtmTop, s5Traps=s5Traps, PYSNMP_MODULE_ID=s5RootMib, stpChangeTrap=stpChangeTrap, s5FdTop=s5FdTop, s5FddTrap=s5FddTrap, s5EnMsTop=s5EnMsTop)
