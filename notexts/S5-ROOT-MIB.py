...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5EnTop=s5EnTop, atmTraps=atmTraps, s5IfExt=s5IfExt, s5Chassis=s5Chassis, s5EthTrap=s5EthTrap, s5Tok=s5Tok, PYSNMP_MODULE_ID=s5RootMib, s5Eth=s5Eth, s5EcellTrap=s5EcellTrap, s5Fddi=s5Fddi, s5FddTrap=s5FddTrap, s5Com=s5Com, s5Agent=s5Agent, remoteLoginTrap=remoteLoginTrap, s5ComTrap=s5ComTrap, s5FdTop=s5FdTop, s5Tcs=s5Tcs, s5RootMib=s5RootMib, s5AtmTop=s5AtmTop, bnLogMsg=bnLogMsg, s5TokTrap=s5TokTrap, stpChangeTrap=stpChangeTrap, s5EnMsTop=s5EnMsTop, s5ChaTrap=s5ChaTrap, s5Traps=s5Traps, s5TrTop=s5TrTop, s5reg=s5reg)
