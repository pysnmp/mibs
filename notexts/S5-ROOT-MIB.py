...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5Chassis=s5Chassis, s5EthTrap=s5EthTrap, s5ChaTrap=s5ChaTrap, bnLogMsg=bnLogMsg, s5Eth=s5Eth, s5EnTop=s5EnTop, s5TrTop=s5TrTop, s5AtmTop=s5AtmTop, s5EnMsTop=s5EnMsTop, s5IfExt=s5IfExt, s5Fddi=s5Fddi, s5reg=s5reg, remoteLoginTrap=remoteLoginTrap, stpChangeTrap=stpChangeTrap, s5ComTrap=s5ComTrap, s5Tcs=s5Tcs, PYSNMP_MODULE_ID=s5RootMib, s5Traps=s5Traps, s5FdTop=s5FdTop, s5EcellTrap=s5EcellTrap, s5RootMib=s5RootMib, s5Tok=s5Tok, s5TokTrap=s5TokTrap, s5FddTrap=s5FddTrap, s5Agent=s5Agent, atmTraps=atmTraps, s5Com=s5Com)
