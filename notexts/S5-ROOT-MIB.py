...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5TokTrap=s5TokTrap, s5reg=s5reg, s5EcellTrap=s5EcellTrap, s5EthTrap=s5EthTrap, s5EnMsTop=s5EnMsTop, s5Fddi=s5Fddi, s5Com=s5Com, s5IfExt=s5IfExt, s5ComTrap=s5ComTrap, s5Eth=s5Eth, s5RootMib=s5RootMib, bnLogMsg=bnLogMsg, s5Chassis=s5Chassis, s5Agent=s5Agent, s5Traps=s5Traps, s5Tok=s5Tok, s5ChaTrap=s5ChaTrap, atmTraps=atmTraps, remoteLoginTrap=remoteLoginTrap, s5FdTop=s5FdTop, s5EnTop=s5EnTop, s5TrTop=s5TrTop, s5Tcs=s5Tcs, PYSNMP_MODULE_ID=s5RootMib, s5AtmTop=s5AtmTop, s5FddTrap=s5FddTrap, stpChangeTrap=stpChangeTrap)
