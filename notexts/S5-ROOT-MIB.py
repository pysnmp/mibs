...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5EnMsTop=s5EnMsTop, s5Agent=s5Agent, s5AtmTop=s5AtmTop, s5ComTrap=s5ComTrap, s5FdTop=s5FdTop, s5ChaTrap=s5ChaTrap, stpChangeTrap=stpChangeTrap, s5TokTrap=s5TokTrap, s5Fddi=s5Fddi, s5EcellTrap=s5EcellTrap, s5FddTrap=s5FddTrap, atmTraps=atmTraps, s5Tok=s5Tok, s5Chassis=s5Chassis, s5TrTop=s5TrTop, s5reg=s5reg, s5IfExt=s5IfExt, bnLogMsg=bnLogMsg, s5Traps=s5Traps, s5EthTrap=s5EthTrap, PYSNMP_MODULE_ID=s5RootMib, s5EnTop=s5EnTop, s5Tcs=s5Tcs, s5RootMib=s5RootMib, s5Com=s5Com, remoteLoginTrap=remoteLoginTrap, s5Eth=s5Eth)
