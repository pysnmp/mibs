...
mibBuilder.exportSymbols("S5-ROOT-MIB", stpChangeTrap=stpChangeTrap, bnLogMsg=bnLogMsg, s5IfExt=s5IfExt, s5AtmTop=s5AtmTop, PYSNMP_MODULE_ID=s5RootMib, s5ComTrap=s5ComTrap, s5EthTrap=s5EthTrap, s5EcellTrap=s5EcellTrap, s5Traps=s5Traps, atmTraps=atmTraps, s5reg=s5reg, s5Chassis=s5Chassis, s5Tok=s5Tok, s5TokTrap=s5TokTrap, s5ChaTrap=s5ChaTrap, s5EnTop=s5EnTop, s5FdTop=s5FdTop, s5Agent=s5Agent, s5Com=s5Com, s5FddTrap=s5FddTrap, s5RootMib=s5RootMib, s5TrTop=s5TrTop, s5Fddi=s5Fddi, s5EnMsTop=s5EnMsTop, s5Tcs=s5Tcs, s5Eth=s5Eth, remoteLoginTrap=remoteLoginTrap)
