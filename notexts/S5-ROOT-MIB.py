...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5FdTop=s5FdTop, s5RootMib=s5RootMib, s5EcellTrap=s5EcellTrap, s5Fddi=s5Fddi, s5EnMsTop=s5EnMsTop, atmTraps=atmTraps, s5Agent=s5Agent, s5Tcs=s5Tcs, PYSNMP_MODULE_ID=s5RootMib, s5ChaTrap=s5ChaTrap, s5AtmTop=s5AtmTop, s5reg=s5reg, s5ComTrap=s5ComTrap, s5Com=s5Com, remoteLoginTrap=remoteLoginTrap, s5EnTop=s5EnTop, s5Chassis=s5Chassis, s5TrTop=s5TrTop, s5EthTrap=s5EthTrap, s5FddTrap=s5FddTrap, stpChangeTrap=stpChangeTrap, s5Tok=s5Tok, s5IfExt=s5IfExt, s5Traps=s5Traps, bnLogMsg=bnLogMsg, s5Eth=s5Eth, s5TokTrap=s5TokTrap)
