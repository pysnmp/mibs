...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5reg=s5reg, s5EthTrap=s5EthTrap, s5ComTrap=s5ComTrap, s5EnTop=s5EnTop, s5FdTop=s5FdTop, s5TrTop=s5TrTop, s5IfExt=s5IfExt, s5EcellTrap=s5EcellTrap, PYSNMP_MODULE_ID=s5RootMib, s5Tok=s5Tok, s5FddTrap=s5FddTrap, s5Chassis=s5Chassis, s5Traps=s5Traps, s5ChaTrap=s5ChaTrap, s5EnMsTop=s5EnMsTop, s5TokTrap=s5TokTrap, atmTraps=atmTraps, s5Tcs=s5Tcs, s5Eth=s5Eth, s5Agent=s5Agent, s5RootMib=s5RootMib, stpChangeTrap=stpChangeTrap, s5Fddi=s5Fddi, remoteLoginTrap=remoteLoginTrap, s5Com=s5Com, s5AtmTop=s5AtmTop, bnLogMsg=bnLogMsg)
