...
mibBuilder.exportSymbols("S5-ROOT-MIB", stpChangeTrap=stpChangeTrap, s5ChaTrap=s5ChaTrap, s5AtmTop=s5AtmTop, s5reg=s5reg, s5Com=s5Com, s5ComTrap=s5ComTrap, s5FdTop=s5FdTop, s5EthTrap=s5EthTrap, s5FddTrap=s5FddTrap, atmTraps=atmTraps, s5TrTop=s5TrTop, s5EnMsTop=s5EnMsTop, PYSNMP_MODULE_ID=s5RootMib, s5Eth=s5Eth, s5RootMib=s5RootMib, s5EnTop=s5EnTop, s5TokTrap=s5TokTrap, s5Tok=s5Tok, s5Chassis=s5Chassis, s5Tcs=s5Tcs, s5Traps=s5Traps, bnLogMsg=bnLogMsg, remoteLoginTrap=remoteLoginTrap, s5IfExt=s5IfExt, s5Agent=s5Agent, s5Fddi=s5Fddi, s5EcellTrap=s5EcellTrap)
