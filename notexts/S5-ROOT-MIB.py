...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5IfExt=s5IfExt, s5RootMib=s5RootMib, remoteLoginTrap=remoteLoginTrap, s5Tcs=s5Tcs, s5Traps=s5Traps, s5TrTop=s5TrTop, PYSNMP_MODULE_ID=s5RootMib, s5Chassis=s5Chassis, atmTraps=atmTraps, bnLogMsg=bnLogMsg, s5ComTrap=s5ComTrap, s5FdTop=s5FdTop, s5Tok=s5Tok, s5reg=s5reg, s5EthTrap=s5EthTrap, s5FddTrap=s5FddTrap, s5EnTop=s5EnTop, s5EnMsTop=s5EnMsTop, s5Eth=s5Eth, stpChangeTrap=stpChangeTrap, s5ChaTrap=s5ChaTrap, s5Agent=s5Agent, s5Fddi=s5Fddi, s5TokTrap=s5TokTrap, s5AtmTop=s5AtmTop, s5Com=s5Com, s5EcellTrap=s5EcellTrap)
