...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5IfExt=s5IfExt, s5Agent=s5Agent, s5Eth=s5Eth, PYSNMP_MODULE_ID=s5RootMib, stpChangeTrap=stpChangeTrap, s5Traps=s5Traps, s5FdTop=s5FdTop, s5Fddi=s5Fddi, s5TokTrap=s5TokTrap, s5ComTrap=s5ComTrap, atmTraps=atmTraps, s5EnTop=s5EnTop, s5AtmTop=s5AtmTop, s5TrTop=s5TrTop, s5Com=s5Com, s5EthTrap=s5EthTrap, s5ChaTrap=s5ChaTrap, bnLogMsg=bnLogMsg, remoteLoginTrap=remoteLoginTrap, s5Chassis=s5Chassis, s5reg=s5reg, s5EcellTrap=s5EcellTrap, s5EnMsTop=s5EnMsTop, s5Tok=s5Tok, s5RootMib=s5RootMib, s5Tcs=s5Tcs, s5FddTrap=s5FddTrap)
