...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5EnMsTop=s5EnMsTop, atmTraps=atmTraps, bnLogMsg=bnLogMsg, s5EthTrap=s5EthTrap, s5Agent=s5Agent, s5AtmTop=s5AtmTop, s5TrTop=s5TrTop, s5FddTrap=s5FddTrap, s5Eth=s5Eth, s5ComTrap=s5ComTrap, s5Tok=s5Tok, s5Tcs=s5Tcs, s5RootMib=s5RootMib, s5Traps=s5Traps, s5Chassis=s5Chassis, s5reg=s5reg, remoteLoginTrap=remoteLoginTrap, s5Fddi=s5Fddi, s5ChaTrap=s5ChaTrap, PYSNMP_MODULE_ID=s5RootMib, s5TokTrap=s5TokTrap, s5IfExt=s5IfExt, stpChangeTrap=stpChangeTrap, s5EnTop=s5EnTop, s5FdTop=s5FdTop, s5EcellTrap=s5EcellTrap, s5Com=s5Com)
