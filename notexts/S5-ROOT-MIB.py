...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5FddTrap=s5FddTrap, bnLogMsg=bnLogMsg, s5reg=s5reg, s5IfExt=s5IfExt, PYSNMP_MODULE_ID=s5RootMib, s5EthTrap=s5EthTrap, stpChangeTrap=stpChangeTrap, s5EnMsTop=s5EnMsTop, s5EnTop=s5EnTop, s5ComTrap=s5ComTrap, s5ChaTrap=s5ChaTrap, atmTraps=atmTraps, s5AtmTop=s5AtmTop, s5Fddi=s5Fddi, s5RootMib=s5RootMib, s5Traps=s5Traps, s5EcellTrap=s5EcellTrap, s5Tcs=s5Tcs, s5TrTop=s5TrTop, s5FdTop=s5FdTop, s5Agent=s5Agent, s5Chassis=s5Chassis, s5Tok=s5Tok, remoteLoginTrap=remoteLoginTrap, s5Eth=s5Eth, s5TokTrap=s5TokTrap, s5Com=s5Com)
