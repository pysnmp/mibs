...
mibBuilder.exportSymbols("S5-ROOT-MIB", bnLogMsg=bnLogMsg, PYSNMP_MODULE_ID=s5RootMib, stpChangeTrap=stpChangeTrap, s5EthTrap=s5EthTrap, remoteLoginTrap=remoteLoginTrap, s5Fddi=s5Fddi, s5ChaTrap=s5ChaTrap, s5Com=s5Com, s5reg=s5reg, s5TokTrap=s5TokTrap, s5TrTop=s5TrTop, s5FddTrap=s5FddTrap, s5RootMib=s5RootMib, s5Agent=s5Agent, atmTraps=atmTraps, s5Tok=s5Tok, s5Chassis=s5Chassis, s5AtmTop=s5AtmTop, s5Eth=s5Eth, s5ComTrap=s5ComTrap, s5EnTop=s5EnTop, s5EcellTrap=s5EcellTrap, s5EnMsTop=s5EnMsTop, s5Traps=s5Traps, s5FdTop=s5FdTop, s5Tcs=s5Tcs, s5IfExt=s5IfExt)
