...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5Com=s5Com, s5IfExt=s5IfExt, s5ChaTrap=s5ChaTrap, s5Eth=s5Eth, s5Tcs=s5Tcs, remoteLoginTrap=remoteLoginTrap, s5Traps=s5Traps, s5EnTop=s5EnTop, s5RootMib=s5RootMib, s5Fddi=s5Fddi, atmTraps=atmTraps, s5EthTrap=s5EthTrap, s5AtmTop=s5AtmTop, s5Tok=s5Tok, s5ComTrap=s5ComTrap, stpChangeTrap=stpChangeTrap, s5EcellTrap=s5EcellTrap, PYSNMP_MODULE_ID=s5RootMib, s5TokTrap=s5TokTrap, s5TrTop=s5TrTop, bnLogMsg=bnLogMsg, s5Chassis=s5Chassis, s5EnMsTop=s5EnMsTop, s5FdTop=s5FdTop, s5Agent=s5Agent, s5reg=s5reg, s5FddTrap=s5FddTrap)
