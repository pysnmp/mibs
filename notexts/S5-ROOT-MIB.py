...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5FdTop=s5FdTop, s5TrTop=s5TrTop, s5IfExt=s5IfExt, s5AtmTop=s5AtmTop, s5Fddi=s5Fddi, s5Traps=s5Traps, s5EthTrap=s5EthTrap, s5TokTrap=s5TokTrap, s5ComTrap=s5ComTrap, stpChangeTrap=stpChangeTrap, s5EnMsTop=s5EnMsTop, s5Agent=s5Agent, s5Com=s5Com, s5EcellTrap=s5EcellTrap, PYSNMP_MODULE_ID=s5RootMib, bnLogMsg=bnLogMsg, s5reg=s5reg, s5RootMib=s5RootMib, s5ChaTrap=s5ChaTrap, s5EnTop=s5EnTop, s5Tcs=s5Tcs, atmTraps=atmTraps, s5Eth=s5Eth, s5Tok=s5Tok, s5FddTrap=s5FddTrap, s5Chassis=s5Chassis, remoteLoginTrap=remoteLoginTrap)
