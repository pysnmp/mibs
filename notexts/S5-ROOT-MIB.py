...
mibBuilder.exportSymbols("S5-ROOT-MIB", bnLogMsg=bnLogMsg, s5reg=s5reg, s5EnMsTop=s5EnMsTop, s5EthTrap=s5EthTrap, s5TrTop=s5TrTop, s5ComTrap=s5ComTrap, PYSNMP_MODULE_ID=s5RootMib, s5Chassis=s5Chassis, s5Agent=s5Agent, s5Com=s5Com, remoteLoginTrap=remoteLoginTrap, s5EnTop=s5EnTop, s5TokTrap=s5TokTrap, s5Tcs=s5Tcs, s5ChaTrap=s5ChaTrap, s5Traps=s5Traps, s5Eth=s5Eth, s5RootMib=s5RootMib, atmTraps=atmTraps, s5IfExt=s5IfExt, stpChangeTrap=stpChangeTrap, s5Fddi=s5Fddi, s5AtmTop=s5AtmTop, s5FddTrap=s5FddTrap, s5Tok=s5Tok, s5FdTop=s5FdTop, s5EcellTrap=s5EcellTrap)
