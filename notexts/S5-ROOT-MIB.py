...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5EthTrap=s5EthTrap, s5Tcs=s5Tcs, s5EcellTrap=s5EcellTrap, s5ComTrap=s5ComTrap, s5FddTrap=s5FddTrap, s5ChaTrap=s5ChaTrap, stpChangeTrap=stpChangeTrap, s5Com=s5Com, s5TrTop=s5TrTop, s5FdTop=s5FdTop, s5RootMib=s5RootMib, atmTraps=atmTraps, s5TokTrap=s5TokTrap, s5EnMsTop=s5EnMsTop, s5Fddi=s5Fddi, bnLogMsg=bnLogMsg, s5Agent=s5Agent, s5Traps=s5Traps, s5Eth=s5Eth, s5EnTop=s5EnTop, s5AtmTop=s5AtmTop, s5reg=s5reg, remoteLoginTrap=remoteLoginTrap, PYSNMP_MODULE_ID=s5RootMib, s5Chassis=s5Chassis, s5IfExt=s5IfExt, s5Tok=s5Tok)
