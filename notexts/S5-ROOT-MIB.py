...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5Com=s5Com, s5Chassis=s5Chassis, stpChangeTrap=stpChangeTrap, s5EnTop=s5EnTop, s5Tok=s5Tok, s5Eth=s5Eth, s5EnMsTop=s5EnMsTop, s5FdTop=s5FdTop, s5IfExt=s5IfExt, s5Fddi=s5Fddi, atmTraps=atmTraps, PYSNMP_MODULE_ID=s5RootMib, remoteLoginTrap=remoteLoginTrap, s5ComTrap=s5ComTrap, s5RootMib=s5RootMib, s5Agent=s5Agent, s5TrTop=s5TrTop, bnLogMsg=bnLogMsg, s5AtmTop=s5AtmTop, s5FddTrap=s5FddTrap, s5Tcs=s5Tcs, s5reg=s5reg, s5ChaTrap=s5ChaTrap, s5EcellTrap=s5EcellTrap, s5TokTrap=s5TokTrap, s5EthTrap=s5EthTrap, s5Traps=s5Traps)
