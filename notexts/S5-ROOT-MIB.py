...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5TokTrap=s5TokTrap, s5ChaTrap=s5ChaTrap, s5Com=s5Com, s5TrTop=s5TrTop, s5reg=s5reg, bnLogMsg=bnLogMsg, s5EcellTrap=s5EcellTrap, s5ComTrap=s5ComTrap, stpChangeTrap=stpChangeTrap, s5Eth=s5Eth, s5RootMib=s5RootMib, remoteLoginTrap=remoteLoginTrap, s5Fddi=s5Fddi, s5Traps=s5Traps, s5Tok=s5Tok, s5Chassis=s5Chassis, s5EnMsTop=s5EnMsTop, s5FddTrap=s5FddTrap, PYSNMP_MODULE_ID=s5RootMib, s5FdTop=s5FdTop, atmTraps=atmTraps, s5AtmTop=s5AtmTop, s5IfExt=s5IfExt, s5EthTrap=s5EthTrap, s5Tcs=s5Tcs, s5EnTop=s5EnTop, s5Agent=s5Agent)
