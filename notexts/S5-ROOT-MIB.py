...
mibBuilder.exportSymbols("S5-ROOT-MIB", bnLogMsg=bnLogMsg, PYSNMP_MODULE_ID=s5RootMib, s5ComTrap=s5ComTrap, s5Traps=s5Traps, s5FdTop=s5FdTop, s5TrTop=s5TrTop, s5EthTrap=s5EthTrap, s5Com=s5Com, s5EnTop=s5EnTop, s5AtmTop=s5AtmTop, s5Agent=s5Agent, s5IfExt=s5IfExt, stpChangeTrap=stpChangeTrap, s5EnMsTop=s5EnMsTop, s5Tok=s5Tok, s5reg=s5reg, atmTraps=atmTraps, s5Chassis=s5Chassis, remoteLoginTrap=remoteLoginTrap, s5ChaTrap=s5ChaTrap, s5Fddi=s5Fddi, s5RootMib=s5RootMib, s5Eth=s5Eth, s5Tcs=s5Tcs, s5EcellTrap=s5EcellTrap, s5FddTrap=s5FddTrap, s5TokTrap=s5TokTrap)
