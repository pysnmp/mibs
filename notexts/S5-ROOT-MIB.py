...
mibBuilder.exportSymbols("S5-ROOT-MIB", remoteLoginTrap=remoteLoginTrap, s5TokTrap=s5TokTrap, PYSNMP_MODULE_ID=s5RootMib, s5reg=s5reg, s5EnMsTop=s5EnMsTop, s5Fddi=s5Fddi, s5Tok=s5Tok, s5IfExt=s5IfExt, s5ChaTrap=s5ChaTrap, atmTraps=atmTraps, s5Com=s5Com, stpChangeTrap=stpChangeTrap, s5EcellTrap=s5EcellTrap, s5AtmTop=s5AtmTop, s5Tcs=s5Tcs, s5ComTrap=s5ComTrap, s5EthTrap=s5EthTrap, s5FdTop=s5FdTop, bnLogMsg=bnLogMsg, s5Chassis=s5Chassis, s5Eth=s5Eth, s5FddTrap=s5FddTrap, s5TrTop=s5TrTop, s5Traps=s5Traps, s5EnTop=s5EnTop, s5RootMib=s5RootMib, s5Agent=s5Agent)
