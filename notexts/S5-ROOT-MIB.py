...
mibBuilder.exportSymbols("S5-ROOT-MIB", s5Tcs=s5Tcs, stpChangeTrap=stpChangeTrap, s5Com=s5Com, s5RootMib=s5RootMib, s5ComTrap=s5ComTrap, remoteLoginTrap=remoteLoginTrap, s5EnMsTop=s5EnMsTop, s5IfExt=s5IfExt, atmTraps=atmTraps, s5Fddi=s5Fddi, s5reg=s5reg, s5EthTrap=s5EthTrap, s5AtmTop=s5AtmTop, s5FdTop=s5FdTop, s5ChaTrap=s5ChaTrap, s5EnTop=s5EnTop, s5Eth=s5Eth, s5TrTop=s5TrTop, s5Agent=s5Agent, s5Chassis=s5Chassis, s5Traps=s5Traps, s5TokTrap=s5TokTrap, PYSNMP_MODULE_ID=s5RootMib, s5FddTrap=s5FddTrap, bnLogMsg=bnLogMsg, s5Tok=s5Tok, s5EcellTrap=s5EcellTrap)
