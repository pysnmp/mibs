...
# Produced by pysmi-1.1.8 at Mon Sep 19 07:25:27 2022
...
Bits, Counter64, enterprises, Integer32, ObjectIdentity, Unsigned32, MibIdentifier, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, NotificationType, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "enterprises", "Integer32", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "NotificationType", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("SFA-INFO", tempEntry=tempEntry, powerEncId=powerEncId, physDiskIndex=physDiskIndex, fanIndex=fanIndex, eventLogDescr=eventLogDescr, poolIndex=poolIndex, tempIndex=tempIndex, eventLogLevel=eventLogLevel, eventLogIndex=eventLogIndex, poolType=poolType, eventLogEntry=eventLogEntry, fanEntry=fanEntry, physicalDiskTable=physicalDiskTable, eventLogTrapLevel=eventLogTrapLevel, unit=unit, fanEncPos=fanEncPos, tempNumber=tempNumber, powerEntry=powerEntry, physDiskSlot=physDiskSlot, powerEncPos=powerEncPos, tempTable=tempTable, datadirect=datadirect, physDiskState=physDiskState, poolEntry=poolEntry, fanStatus=fanStatus, tempEncPos=tempEncPos, physDiskId=physDiskId, physDiskEnc=physDiskEnc, powerNumber=powerNumber, powerStatus=powerStatus, poolNumDisks=poolNumDisks, physDiskWWN=physDiskWWN, physicalDiskEntry=physicalDiskEntry, poolId=poolId, systemName=systemName, tempStatus=tempStatus, poolNumber=poolNumber, eventLogTable=eventLogTable, fanTable=fanTable, powerTable=powerTable, fanNumber=fanNumber, eventLogNumEntries=eventLogNumEntries, powerIndex=powerIndex, poolTable=poolTable, tempEncId=tempEncId, fanEncId=fanEncId, physDiskPoolId=physDiskPoolId, eventLog=eventLog, DisplayString=DisplayString)
