...
Gauge32, Unsigned32, ModuleIdentity, Counter64, Bits, IpAddress, Integer32, Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, iso, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "ModuleIdentity", "Counter64", "Bits", "IpAddress", "Integer32", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "iso", "ObjectIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("SFA-INFO", fanIndex=fanIndex, physicalDiskTable=physicalDiskTable, powerEntry=powerEntry, unit=unit, powerIndex=powerIndex, eventLogTrapLevel=eventLogTrapLevel, poolNumber=poolNumber, physDiskIndex=physDiskIndex, poolEntry=poolEntry, tempEncPos=tempEncPos, physDiskId=physDiskId, fanEncPos=fanEncPos, systemName=systemName, physDiskWWN=physDiskWWN, tempNumber=tempNumber, fanEncId=fanEncId, powerEncId=powerEncId, physDiskSlot=physDiskSlot, poolId=poolId, datadirect=datadirect, tempEncId=tempEncId, poolTable=poolTable, poolType=poolType, physDiskState=physDiskState, powerStatus=powerStatus, eventLogIndex=eventLogIndex, eventLogTable=eventLogTable, fanNumber=fanNumber, eventLogEntry=eventLogEntry, eventLogDescr=eventLogDescr, DisplayString=DisplayString, fanStatus=fanStatus, powerEncPos=powerEncPos, tempIndex=tempIndex, tempTable=tempTable, tempEntry=tempEntry, poolNumDisks=poolNumDisks, fanEntry=fanEntry, eventLogNumEntries=eventLogNumEntries, eventLogLevel=eventLogLevel, physicalDiskEntry=physicalDiskEntry, powerTable=powerTable, eventLog=eventLog, physDiskEnc=physDiskEnc, physDiskPoolId=physDiskPoolId, powerNumber=powerNumber, fanTable=fanTable, tempStatus=tempStatus, poolIndex=poolIndex)
