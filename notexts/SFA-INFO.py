...
# Produced by pysmi-1.1.3 at Sun Nov 28 21:25:03 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, IpAddress, ModuleIdentity, ObjectIdentity, Counter32, TimeTicks, NotificationType, Integer32, Gauge32, MibIdentifier, iso, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "IpAddress", "ModuleIdentity", "ObjectIdentity", "Counter32", "TimeTicks", "NotificationType", "Integer32", "Gauge32", "MibIdentifier", "iso", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("SFA-INFO", poolTable=poolTable, physDiskPoolId=physDiskPoolId, tempNumber=tempNumber, DisplayString=DisplayString, poolIndex=poolIndex, physDiskId=physDiskId, fanIndex=fanIndex, eventLogDescr=eventLogDescr, tempIndex=tempIndex, powerEncId=powerEncId, physDiskWWN=physDiskWWN, fanEncId=fanEncId, powerIndex=powerIndex, poolEntry=poolEntry, fanNumber=fanNumber, physicalDiskTable=physicalDiskTable, fanEntry=fanEntry, physDiskEnc=physDiskEnc, eventLogTrapLevel=eventLogTrapLevel, powerStatus=powerStatus, powerEntry=powerEntry, datadirect=datadirect, tempEntry=tempEntry, eventLogLevel=eventLogLevel, unit=unit, poolNumDisks=poolNumDisks, fanEncPos=fanEncPos, powerEncPos=powerEncPos, tempTable=tempTable, fanStatus=fanStatus, eventLogIndex=eventLogIndex, systemName=systemName, eventLog=eventLog, eventLogEntry=eventLogEntry, poolType=poolType, fanTable=fanTable, tempEncId=tempEncId, eventLogNumEntries=eventLogNumEntries, eventLogTable=eventLogTable, physDiskSlot=physDiskSlot, tempStatus=tempStatus, physicalDiskEntry=physicalDiskEntry, powerTable=powerTable, poolNumber=poolNumber, tempEncPos=tempEncPos, poolId=poolId, physDiskState=physDiskState, powerNumber=powerNumber, physDiskIndex=physDiskIndex)
