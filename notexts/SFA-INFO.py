...
# Produced by pysmi-1.1.8 at Thu Sep 15 09:38:25 2022
...
Integer32, Gauge32, NotificationType, IpAddress, enterprises, TimeTicks, ModuleIdentity, MibIdentifier, Bits, Unsigned32, Counter32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "NotificationType", "IpAddress", "enterprises", "TimeTicks", "ModuleIdentity", "MibIdentifier", "Bits", "Unsigned32", "Counter32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("SFA-INFO", eventLogLevel=eventLogLevel, powerTable=powerTable, poolIndex=poolIndex, poolNumDisks=poolNumDisks, powerEncPos=powerEncPos, powerStatus=powerStatus, physDiskPoolId=physDiskPoolId, tempIndex=tempIndex, tempEntry=tempEntry, eventLogIndex=eventLogIndex, tempEncId=tempEncId, eventLog=eventLog, eventLogDescr=eventLogDescr, unit=unit, fanNumber=fanNumber, powerIndex=powerIndex, physDiskWWN=physDiskWWN, fanTable=fanTable, poolType=poolType, datadirect=datadirect, physDiskEnc=physDiskEnc, powerEntry=powerEntry, powerEncId=powerEncId, physDiskState=physDiskState, tempEncPos=tempEncPos, physDiskId=physDiskId, physicalDiskEntry=physicalDiskEntry, poolId=poolId, fanIndex=fanIndex, physDiskSlot=physDiskSlot, fanStatus=fanStatus, poolTable=poolTable, physDiskIndex=physDiskIndex, tempStatus=tempStatus, fanEncId=fanEncId, systemName=systemName, eventLogTrapLevel=eventLogTrapLevel, tempTable=tempTable, eventLogNumEntries=eventLogNumEntries, fanEncPos=fanEncPos, fanEntry=fanEntry, DisplayString=DisplayString, powerNumber=powerNumber, poolNumber=poolNumber, poolEntry=poolEntry, physicalDiskTable=physicalDiskTable, eventLogTable=eventLogTable, eventLogEntry=eventLogEntry, tempNumber=tempNumber)
