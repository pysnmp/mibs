...
# Produced by pysmi-1.1.8 at Thu Oct 26 12:11:42 2023
...
NotificationType, Integer32, iso, Bits, TimeTicks, ObjectIdentity, enterprises, Unsigned32, IpAddress, MibIdentifier, Counter32, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "iso", "Bits", "TimeTicks", "ObjectIdentity", "enterprises", "Unsigned32", "IpAddress", "MibIdentifier", "Counter32", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("SFA-INFO", fanNumber=fanNumber, powerIndex=powerIndex, tempEntry=tempEntry, poolId=poolId, poolType=poolType, systemName=systemName, poolIndex=poolIndex, fanStatus=fanStatus, physDiskWWN=physDiskWWN, eventLogIndex=eventLogIndex, tempTable=tempTable, physDiskIndex=physDiskIndex, physDiskPoolId=physDiskPoolId, powerNumber=powerNumber, tempIndex=tempIndex, poolNumber=poolNumber, powerEncPos=powerEncPos, eventLogLevel=eventLogLevel, tempStatus=tempStatus, powerEntry=powerEntry, eventLog=eventLog, tempEncId=tempEncId, fanIndex=fanIndex, physDiskId=physDiskId, physDiskSlot=physDiskSlot, eventLogTrapLevel=eventLogTrapLevel, datadirect=datadirect, tempNumber=tempNumber, tempEncPos=tempEncPos, powerEncId=powerEncId, physDiskState=physDiskState, fanEncId=fanEncId, fanEntry=fanEntry, eventLogEntry=eventLogEntry, eventLogDescr=eventLogDescr, physicalDiskTable=physicalDiskTable, eventLogNumEntries=eventLogNumEntries, eventLogTable=eventLogTable, poolTable=poolTable, DisplayString=DisplayString, powerStatus=powerStatus, physicalDiskEntry=physicalDiskEntry, poolNumDisks=poolNumDisks, powerTable=powerTable, poolEntry=poolEntry, physDiskEnc=physDiskEnc, unit=unit, fanEncPos=fanEncPos, fanTable=fanTable)
