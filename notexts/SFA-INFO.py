...
# Produced by pysmi-1.1.3 at Sun Nov 28 19:29:32 2021
...
NotificationType, IpAddress, Counter64, Unsigned32, ModuleIdentity, Gauge32, Bits, ObjectIdentity, enterprises, Integer32, MibIdentifier, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "Counter64", "Unsigned32", "ModuleIdentity", "Gauge32", "Bits", "ObjectIdentity", "enterprises", "Integer32", "MibIdentifier", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("SFA-INFO", unit=unit, powerStatus=powerStatus, physDiskWWN=physDiskWWN, eventLogTable=eventLogTable, powerEncPos=powerEncPos, fanEntry=fanEntry, poolId=poolId, physDiskEnc=physDiskEnc, eventLogIndex=eventLogIndex, poolNumDisks=poolNumDisks, tempEncId=tempEncId, physicalDiskEntry=physicalDiskEntry, fanTable=fanTable, tempStatus=tempStatus, fanEncId=fanEncId, tempTable=tempTable, fanIndex=fanIndex, powerNumber=powerNumber, poolType=poolType, tempEncPos=tempEncPos, eventLogNumEntries=eventLogNumEntries, fanStatus=fanStatus, DisplayString=DisplayString, fanNumber=fanNumber, systemName=systemName, powerEntry=powerEntry, powerEncId=powerEncId, eventLogTrapLevel=eventLogTrapLevel, tempIndex=tempIndex, physDiskPoolId=physDiskPoolId, fanEncPos=fanEncPos, poolNumber=poolNumber, datadirect=datadirect, poolEntry=poolEntry, tempEntry=tempEntry, physDiskIndex=physDiskIndex, physDiskSlot=physDiskSlot, tempNumber=tempNumber, eventLogEntry=eventLogEntry, physDiskState=physDiskState, powerTable=powerTable, poolIndex=poolIndex, physicalDiskTable=physicalDiskTable, eventLogLevel=eventLogLevel, physDiskId=physDiskId, eventLog=eventLog, powerIndex=powerIndex, eventLogDescr=eventLogDescr, poolTable=poolTable)
