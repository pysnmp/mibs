...
# Produced by pysmi-1.1.10 at Fri Nov 10 08:43:17 2023
...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, ModuleIdentity, ObjectIdentity, TimeTicks, Bits, Unsigned32, NotificationType, IpAddress, Counter64, enterprises, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "Bits", "Unsigned32", "NotificationType", "IpAddress", "Counter64", "enterprises", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("SFA-INFO", powerNumber=powerNumber, poolType=poolType, systemName=systemName, powerEncId=powerEncId, fanTable=fanTable, fanEncId=fanEncId, physDiskPoolId=physDiskPoolId, unit=unit, fanEncPos=fanEncPos, powerEntry=powerEntry, physDiskId=physDiskId, physDiskEnc=physDiskEnc, eventLogTable=eventLogTable, physDiskWWN=physDiskWWN, fanStatus=fanStatus, tempEncId=tempEncId, powerTable=powerTable, tempNumber=tempNumber, poolEntry=poolEntry, poolId=poolId, poolIndex=poolIndex, physDiskSlot=physDiskSlot, poolTable=poolTable, fanEntry=fanEntry, physDiskState=physDiskState, eventLogDescr=eventLogDescr, poolNumDisks=poolNumDisks, physDiskIndex=physDiskIndex, tempIndex=tempIndex, tempEntry=tempEntry, tempTable=tempTable, eventLogTrapLevel=eventLogTrapLevel, powerStatus=powerStatus, eventLogIndex=eventLogIndex, fanIndex=fanIndex, physicalDiskTable=physicalDiskTable, powerIndex=powerIndex, poolNumber=poolNumber, tempStatus=tempStatus, tempEncPos=tempEncPos, eventLogEntry=eventLogEntry, eventLogLevel=eventLogLevel, fanNumber=fanNumber, DisplayString=DisplayString, datadirect=datadirect, physicalDiskEntry=physicalDiskEntry, powerEncPos=powerEncPos, eventLog=eventLog, eventLogNumEntries=eventLogNumEntries)
