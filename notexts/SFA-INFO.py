...
# Produced by pysmi-1.1.0 at Fri Nov 19 14:58:43 2021
...
Integer32, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, Gauge32, ObjectIdentity, NotificationType, enterprises, IpAddress, MibIdentifier, Bits, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "Gauge32", "ObjectIdentity", "NotificationType", "enterprises", "IpAddress", "MibIdentifier", "Bits", "Unsigned32", "iso")
...
mibBuilder.exportSymbols("SFA-INFO", physDiskIndex=physDiskIndex, eventLogLevel=eventLogLevel, physicalDiskTable=physicalDiskTable, physicalDiskEntry=physicalDiskEntry, powerStatus=powerStatus, fanEncId=fanEncId, tempTable=tempTable, fanIndex=fanIndex, eventLog=eventLog, fanTable=fanTable, powerEntry=powerEntry, powerEncId=powerEncId, tempEntry=tempEntry, tempEncPos=tempEncPos, powerTable=powerTable, eventLogTrapLevel=eventLogTrapLevel, powerNumber=powerNumber, physDiskSlot=physDiskSlot, eventLogDescr=eventLogDescr, datadirect=datadirect, poolIndex=poolIndex, eventLogNumEntries=eventLogNumEntries, powerIndex=powerIndex, poolType=poolType, physDiskEnc=physDiskEnc, tempIndex=tempIndex, fanEntry=fanEntry, poolTable=poolTable, poolNumber=poolNumber, physDiskWWN=physDiskWWN, tempNumber=tempNumber, powerEncPos=powerEncPos, fanEncPos=fanEncPos, poolEntry=poolEntry, fanNumber=fanNumber, physDiskPoolId=physDiskPoolId, fanStatus=fanStatus, physDiskId=physDiskId, eventLogIndex=eventLogIndex, tempEncId=tempEncId, eventLogTable=eventLogTable, unit=unit, poolNumDisks=poolNumDisks, physDiskState=physDiskState, systemName=systemName, eventLogEntry=eventLogEntry, DisplayString=DisplayString, tempStatus=tempStatus, poolId=poolId)
