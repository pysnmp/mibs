...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:33:58 2023
...
NotificationType, MibIdentifier, enterprises, ModuleIdentity, Counter64, Counter32, ObjectIdentity, IpAddress, TimeTicks, iso, Unsigned32, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "enterprises", "ModuleIdentity", "Counter64", "Counter32", "ObjectIdentity", "IpAddress", "TimeTicks", "iso", "Unsigned32", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("SFA-INFO", fanStatus=fanStatus, powerEncPos=powerEncPos, physicalDiskTable=physicalDiskTable, eventLogIndex=eventLogIndex, fanIndex=fanIndex, powerEntry=powerEntry, eventLogEntry=eventLogEntry, tempEntry=tempEntry, fanNumber=fanNumber, powerEncId=powerEncId, DisplayString=DisplayString, eventLogNumEntries=eventLogNumEntries, eventLogDescr=eventLogDescr, tempEncId=tempEncId, fanEncId=fanEncId, physDiskSlot=physDiskSlot, eventLogLevel=eventLogLevel, tempTable=tempTable, physDiskEnc=physDiskEnc, eventLogTrapLevel=eventLogTrapLevel, fanTable=fanTable, fanEntry=fanEntry, powerTable=powerTable, powerNumber=powerNumber, powerIndex=powerIndex, eventLog=eventLog, physDiskState=physDiskState, datadirect=datadirect, poolTable=poolTable, poolId=poolId, physDiskIndex=physDiskIndex, eventLogTable=eventLogTable, tempStatus=tempStatus, physDiskWWN=physDiskWWN, poolNumber=poolNumber, fanEncPos=fanEncPos, poolEntry=poolEntry, physDiskId=physDiskId, unit=unit, powerStatus=powerStatus, poolIndex=poolIndex, systemName=systemName, poolNumDisks=poolNumDisks, physicalDiskEntry=physicalDiskEntry, tempNumber=tempNumber, tempIndex=tempIndex, physDiskPoolId=physDiskPoolId, tempEncPos=tempEncPos, poolType=poolType)
