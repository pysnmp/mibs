...
ObjectIdentity, ModuleIdentity, Bits, Unsigned32, IpAddress, Counter32, NotificationType, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Integer32, TimeTicks, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "Bits", "Unsigned32", "IpAddress", "Counter32", "NotificationType", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Integer32", "TimeTicks", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("SFA-INFO", physDiskIndex=physDiskIndex, powerIndex=powerIndex, fanStatus=fanStatus, physDiskState=physDiskState, fanEncPos=fanEncPos, physDiskPoolId=physDiskPoolId, poolTable=poolTable, physicalDiskTable=physicalDiskTable, eventLogEntry=eventLogEntry, powerTable=powerTable, tempNumber=tempNumber, poolType=poolType, eventLogNumEntries=eventLogNumEntries, poolEntry=poolEntry, datadirect=datadirect, eventLogLevel=eventLogLevel, tempTable=tempTable, tempEncId=tempEncId, powerStatus=powerStatus, powerEncPos=powerEncPos, DisplayString=DisplayString, eventLogTable=eventLogTable, powerEncId=powerEncId, physDiskWWN=physDiskWWN, tempEntry=tempEntry, fanNumber=fanNumber, unit=unit, fanEntry=fanEntry, poolId=poolId, physDiskSlot=physDiskSlot, eventLogIndex=eventLogIndex, poolIndex=poolIndex, powerNumber=powerNumber, fanEncId=fanEncId, eventLog=eventLog, tempEncPos=tempEncPos, fanTable=fanTable, fanIndex=fanIndex, eventLogTrapLevel=eventLogTrapLevel, powerEntry=powerEntry, tempStatus=tempStatus, tempIndex=tempIndex, physDiskId=physDiskId, physicalDiskEntry=physicalDiskEntry, eventLogDescr=eventLogDescr, physDiskEnc=physDiskEnc, poolNumDisks=poolNumDisks, poolNumber=poolNumber, systemName=systemName)
