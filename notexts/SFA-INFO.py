...
mibBuilder.exportSymbols("SFA-INFO", systemName=systemName, eventLogEntry=eventLogEntry, tempEncPos=tempEncPos, powerEntry=powerEntry, poolTable=poolTable, poolNumber=poolNumber, eventLogDescr=eventLogDescr, tempTable=tempTable, poolId=poolId, eventLog=eventLog, eventLogLevel=eventLogLevel, physDiskEnc=physDiskEnc, tempEntry=tempEntry, poolType=poolType, tempIndex=tempIndex, eventLogTrapLevel=eventLogTrapLevel, powerStatus=powerStatus, fanNumber=fanNumber, powerNumber=powerNumber, eventLogNumEntries=eventLogNumEntries, physicalDiskEntry=physicalDiskEntry, physDiskSlot=physDiskSlot, tempNumber=tempNumber, fanTable=fanTable, poolNumDisks=poolNumDisks, DisplayString=DisplayString, fanIndex=fanIndex, powerTable=powerTable, physicalDiskTable=physicalDiskTable, tempEncId=tempEncId, powerIndex=powerIndex, tempStatus=tempStatus, physDiskWWN=physDiskWWN, unit=unit, eventLogTable=eventLogTable, fanStatus=fanStatus, fanEntry=fanEntry, powerEncPos=powerEncPos, physDiskId=physDiskId, physDiskPoolId=physDiskPoolId, poolEntry=poolEntry, physDiskIndex=physDiskIndex, datadirect=datadirect, eventLogIndex=eventLogIndex, powerEncId=powerEncId, fanEncPos=fanEncPos, poolIndex=poolIndex, fanEncId=fanEncId, physDiskState=physDiskState)
