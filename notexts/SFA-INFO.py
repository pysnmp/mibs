...
# Produced by pysmi-1.1.10 at Fri Nov 10 08:42:30 2023
...
TimeTicks, ModuleIdentity, Integer32, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Bits, Counter64, Gauge32, enterprises, ObjectIdentity, iso, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "Integer32", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Bits", "Counter64", "Gauge32", "enterprises", "ObjectIdentity", "iso", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("SFA-INFO", powerIndex=powerIndex, systemName=systemName, physDiskState=physDiskState, fanEncId=fanEncId, eventLogNumEntries=eventLogNumEntries, physDiskSlot=physDiskSlot, physicalDiskEntry=physicalDiskEntry, eventLogEntry=eventLogEntry, tempTable=tempTable, poolNumber=poolNumber, unit=unit, eventLogLevel=eventLogLevel, eventLogTable=eventLogTable, tempEntry=tempEntry, poolIndex=poolIndex, eventLogIndex=eventLogIndex, poolNumDisks=poolNumDisks, fanTable=fanTable, DisplayString=DisplayString, powerStatus=powerStatus, poolId=poolId, poolType=poolType, physDiskWWN=physDiskWWN, tempEncPos=tempEncPos, physDiskIndex=physDiskIndex, eventLog=eventLog, tempStatus=tempStatus, powerEntry=powerEntry, powerEncPos=powerEncPos, powerEncId=powerEncId, tempIndex=tempIndex, poolTable=poolTable, physicalDiskTable=physicalDiskTable, powerTable=powerTable, tempEncId=tempEncId, fanEncPos=fanEncPos, powerNumber=powerNumber, eventLogDescr=eventLogDescr, poolEntry=poolEntry, physDiskPoolId=physDiskPoolId, fanIndex=fanIndex, tempNumber=tempNumber, physDiskEnc=physDiskEnc, fanStatus=fanStatus, fanEntry=fanEntry, physDiskId=physDiskId, fanNumber=fanNumber, eventLogTrapLevel=eventLogTrapLevel, datadirect=datadirect)
