...
# Produced by pysmi-1.1.12 at Thu Nov 28 02:56:29 2024
...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, Unsigned32, Counter64, enterprises, ObjectIdentity, iso, MibIdentifier, Bits, Counter32, Integer32, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "Unsigned32", "Counter64", "enterprises", "ObjectIdentity", "iso", "MibIdentifier", "Bits", "Counter32", "Integer32", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("SFA-INFO", fanTable=fanTable, powerEncPos=powerEncPos, physDiskId=physDiskId, tempTable=tempTable, DisplayString=DisplayString, powerStatus=powerStatus, eventLogTable=eventLogTable, poolType=poolType, physicalDiskEntry=physicalDiskEntry, physDiskWWN=physDiskWWN, tempEncPos=tempEncPos, fanStatus=fanStatus, physDiskState=physDiskState, eventLogEntry=eventLogEntry, poolIndex=poolIndex, fanEncPos=fanEncPos, physDiskPoolId=physDiskPoolId, tempNumber=tempNumber, physDiskEnc=physDiskEnc, eventLogDescr=eventLogDescr, powerTable=powerTable, powerIndex=powerIndex, eventLogIndex=eventLogIndex, physicalDiskTable=physicalDiskTable, poolNumber=poolNumber, eventLog=eventLog, poolId=poolId, fanEncId=fanEncId, poolNumDisks=poolNumDisks, fanIndex=fanIndex, eventLogTrapLevel=eventLogTrapLevel, fanEntry=fanEntry, powerEncId=powerEncId, poolEntry=poolEntry, fanNumber=fanNumber, eventLogLevel=eventLogLevel, tempEntry=tempEntry, tempIndex=tempIndex, poolTable=poolTable, tempEncId=tempEncId, powerEntry=powerEntry, unit=unit, datadirect=datadirect, eventLogNumEntries=eventLogNumEntries, powerNumber=powerNumber, physDiskSlot=physDiskSlot, tempStatus=tempStatus, physDiskIndex=physDiskIndex, systemName=systemName)
