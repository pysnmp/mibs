...
# Produced by pysmi-1.1.3 at Tue Dec  7 14:15:40 2021
...
mibBuilder.exportSymbols("SFA-INFO", powerTable=powerTable, fanTable=fanTable, physDiskState=physDiskState, physicalDiskEntry=physicalDiskEntry, physDiskEnc=physDiskEnc, poolNumDisks=poolNumDisks, physDiskWWN=physDiskWWN, fanNumber=fanNumber, fanStatus=fanStatus, poolId=poolId, powerNumber=powerNumber, tempStatus=tempStatus, powerIndex=powerIndex, physDiskIndex=physDiskIndex, eventLogTable=eventLogTable, datadirect=datadirect, tempTable=tempTable, tempEntry=tempEntry, eventLogTrapLevel=eventLogTrapLevel, poolTable=poolTable, tempEncId=tempEncId, fanIndex=fanIndex, powerEncPos=powerEncPos, poolEntry=poolEntry, fanEncId=fanEncId, physDiskId=physDiskId, systemName=systemName, physicalDiskTable=physicalDiskTable, eventLogNumEntries=eventLogNumEntries, tempIndex=tempIndex, powerEntry=powerEntry, tempEncPos=tempEncPos, physDiskPoolId=physDiskPoolId, poolType=poolType, physDiskSlot=physDiskSlot, eventLogLevel=eventLogLevel, eventLogIndex=eventLogIndex, unit=unit, eventLogDescr=eventLogDescr, fanEncPos=fanEncPos, poolNumber=poolNumber, tempNumber=tempNumber, eventLog=eventLog, powerStatus=powerStatus, DisplayString=DisplayString, poolIndex=poolIndex, powerEncId=powerEncId, fanEntry=fanEntry, eventLogEntry=eventLogEntry)
