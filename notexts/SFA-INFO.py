...
Bits, NotificationType, Gauge32, ModuleIdentity, Unsigned32, MibIdentifier, TimeTicks, Counter32, ObjectIdentity, iso, enterprises, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "Gauge32", "ModuleIdentity", "Unsigned32", "MibIdentifier", "TimeTicks", "Counter32", "ObjectIdentity", "iso", "enterprises", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("SFA-INFO", eventLogDescr=eventLogDescr, fanEncId=fanEncId, physDiskIndex=physDiskIndex, physDiskPoolId=physDiskPoolId, powerNumber=powerNumber, poolIndex=poolIndex, eventLogEntry=eventLogEntry, fanIndex=fanIndex, tempEncPos=tempEncPos, poolEntry=poolEntry, powerEncPos=powerEncPos, poolType=poolType, poolId=poolId, physicalDiskEntry=physicalDiskEntry, eventLogLevel=eventLogLevel, poolNumDisks=poolNumDisks, tempNumber=tempNumber, tempStatus=tempStatus, tempEncId=tempEncId, fanTable=fanTable, eventLogTable=eventLogTable, unit=unit, powerIndex=powerIndex, poolTable=poolTable, powerTable=powerTable, DisplayString=DisplayString, eventLog=eventLog, tempEntry=tempEntry, tempIndex=tempIndex, poolNumber=poolNumber, physDiskWWN=physDiskWWN, physDiskSlot=physDiskSlot, systemName=systemName, powerEncId=powerEncId, fanStatus=fanStatus, physDiskId=physDiskId, fanEntry=fanEntry, powerEntry=powerEntry, eventLogIndex=eventLogIndex, powerStatus=powerStatus, physDiskState=physDiskState, physDiskEnc=physDiskEnc, physicalDiskTable=physicalDiskTable, eventLogNumEntries=eventLogNumEntries, fanEncPos=fanEncPos, tempTable=tempTable, datadirect=datadirect, fanNumber=fanNumber, eventLogTrapLevel=eventLogTrapLevel)
