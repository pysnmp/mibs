...
# Produced by pysmi-1.1.10 at Mon Oct 30 02:16:13 2023
...
Bits, ObjectIdentity, MibIdentifier, Gauge32, iso, TimeTicks, ModuleIdentity, enterprises, Counter32, IpAddress, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "MibIdentifier", "Gauge32", "iso", "TimeTicks", "ModuleIdentity", "enterprises", "Counter32", "IpAddress", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("SFA-INFO", poolNumDisks=poolNumDisks, physDiskWWN=physDiskWWN, physDiskEnc=physDiskEnc, powerStatus=powerStatus, eventLogDescr=eventLogDescr, fanNumber=fanNumber, tempTable=tempTable, eventLogLevel=eventLogLevel, eventLogTable=eventLogTable, tempStatus=tempStatus, physicalDiskTable=physicalDiskTable, fanEncPos=fanEncPos, physDiskIndex=physDiskIndex, fanStatus=fanStatus, eventLogTrapLevel=eventLogTrapLevel, poolEntry=poolEntry, DisplayString=DisplayString, fanEntry=fanEntry, poolNumber=poolNumber, eventLog=eventLog, tempNumber=tempNumber, tempEncPos=tempEncPos, powerEncPos=powerEncPos, fanIndex=fanIndex, datadirect=datadirect, tempEntry=tempEntry, powerNumber=powerNumber, unit=unit, fanEncId=fanEncId, physDiskPoolId=physDiskPoolId, tempEncId=tempEncId, poolId=poolId, fanTable=fanTable, physDiskId=physDiskId, eventLogEntry=eventLogEntry, physicalDiskEntry=physicalDiskEntry, powerEntry=powerEntry, powerEncId=powerEncId, poolType=poolType, poolIndex=poolIndex, systemName=systemName, physDiskSlot=physDiskSlot, physDiskState=physDiskState, powerTable=powerTable, eventLogIndex=eventLogIndex, eventLogNumEntries=eventLogNumEntries, powerIndex=powerIndex, poolTable=poolTable, tempIndex=tempIndex)
