...
# Produced by pysmi-1.1.8 at Fri Jan  7 16:00:58 2022
...
Counter32, Counter64, ObjectIdentity, enterprises, NotificationType, iso, ModuleIdentity, Gauge32, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "ObjectIdentity", "enterprises", "NotificationType", "iso", "ModuleIdentity", "Gauge32", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "IpAddress", "Unsigned32")
...
mibBuilder.exportSymbols("SFA-INFO", tempEncId=tempEncId, poolNumDisks=poolNumDisks, eventLogNumEntries=eventLogNumEntries, fanStatus=fanStatus, powerIndex=powerIndex, powerEncPos=powerEncPos, tempIndex=tempIndex, eventLogEntry=eventLogEntry, fanIndex=fanIndex, poolId=poolId, systemName=systemName, eventLogLevel=eventLogLevel, fanEntry=fanEntry, poolEntry=poolEntry, physDiskId=physDiskId, poolIndex=poolIndex, physDiskIndex=physDiskIndex, physicalDiskTable=physicalDiskTable, physDiskWWN=physDiskWWN, physDiskPoolId=physDiskPoolId, tempEntry=tempEntry, poolType=poolType, physDiskSlot=physDiskSlot, eventLogIndex=eventLogIndex, poolNumber=poolNumber, fanEncId=fanEncId, powerEntry=powerEntry, powerEncId=powerEncId, tempTable=tempTable, fanEncPos=fanEncPos, fanTable=fanTable, powerTable=powerTable, eventLogTrapLevel=eventLogTrapLevel, tempStatus=tempStatus, eventLogDescr=eventLogDescr, DisplayString=DisplayString, powerNumber=powerNumber, powerStatus=powerStatus, unit=unit, eventLogTable=eventLogTable, tempEncPos=tempEncPos, eventLog=eventLog, fanNumber=fanNumber, poolTable=poolTable, physDiskEnc=physDiskEnc, physDiskState=physDiskState, physicalDiskEntry=physicalDiskEntry, datadirect=datadirect, tempNumber=tempNumber)
