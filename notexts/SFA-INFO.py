...
# Produced by pysmi-1.1.12 at Wed Nov  6 08:29:05 2024
...
enterprises, Counter32, Gauge32, Unsigned32, NotificationType, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, Counter64, MibIdentifier, ObjectIdentity, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "Gauge32", "Unsigned32", "NotificationType", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "Counter64", "MibIdentifier", "ObjectIdentity", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("SFA-INFO", powerTable=powerTable, eventLogTable=eventLogTable, physDiskPoolId=physDiskPoolId, powerEntry=powerEntry, fanEncId=fanEncId, poolId=poolId, poolEntry=poolEntry, poolType=poolType, fanEncPos=fanEncPos, eventLogTrapLevel=eventLogTrapLevel, eventLogDescr=eventLogDescr, DisplayString=DisplayString, fanStatus=fanStatus, eventLogEntry=eventLogEntry, physicalDiskTable=physicalDiskTable, systemName=systemName, physDiskState=physDiskState, powerNumber=powerNumber, tempEntry=tempEntry, poolNumber=poolNumber, tempNumber=tempNumber, tempStatus=tempStatus, fanEntry=fanEntry, unit=unit, fanNumber=fanNumber, tempEncId=tempEncId, physDiskWWN=physDiskWWN, fanIndex=fanIndex, eventLog=eventLog, powerStatus=powerStatus, datadirect=datadirect, tempIndex=tempIndex, powerIndex=powerIndex, poolIndex=poolIndex, physicalDiskEntry=physicalDiskEntry, physDiskSlot=physDiskSlot, physDiskEnc=physDiskEnc, poolNumDisks=poolNumDisks, tempTable=tempTable, eventLogLevel=eventLogLevel, physDiskIndex=physDiskIndex, fanTable=fanTable, poolTable=poolTable, powerEncPos=powerEncPos, powerEncId=powerEncId, tempEncPos=tempEncPos, eventLogIndex=eventLogIndex, physDiskId=physDiskId, eventLogNumEntries=eventLogNumEntries)
