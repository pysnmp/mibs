...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:41:50 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, Integer32, Counter64, Bits, MibIdentifier, IpAddress, ModuleIdentity, TimeTicks, Gauge32, enterprises, Unsigned32, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "Integer32", "Counter64", "Bits", "MibIdentifier", "IpAddress", "ModuleIdentity", "TimeTicks", "Gauge32", "enterprises", "Unsigned32", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("SFA-INFO", fanEncId=fanEncId, eventLogTrapLevel=eventLogTrapLevel, eventLogNumEntries=eventLogNumEntries, poolTable=poolTable, eventLogEntry=eventLogEntry, powerIndex=powerIndex, DisplayString=DisplayString, datadirect=datadirect, physDiskIndex=physDiskIndex, powerEncPos=powerEncPos, powerNumber=powerNumber, eventLogDescr=eventLogDescr, fanEntry=fanEntry, poolId=poolId, fanIndex=fanIndex, tempNumber=tempNumber, poolIndex=poolIndex, physDiskSlot=physDiskSlot, powerEncId=powerEncId, eventLogIndex=eventLogIndex, poolEntry=poolEntry, systemName=systemName, eventLog=eventLog, physDiskEnc=physDiskEnc, fanEncPos=fanEncPos, eventLogTable=eventLogTable, physDiskState=physDiskState, poolNumber=poolNumber, fanTable=fanTable, fanStatus=fanStatus, eventLogLevel=eventLogLevel, physicalDiskTable=physicalDiskTable, powerTable=powerTable, physDiskWWN=physDiskWWN, tempEntry=tempEntry, physicalDiskEntry=physicalDiskEntry, fanNumber=fanNumber, powerStatus=powerStatus, physDiskPoolId=physDiskPoolId, physDiskId=physDiskId, powerEntry=powerEntry, tempStatus=tempStatus, poolType=poolType, tempEncId=tempEncId, tempEncPos=tempEncPos, poolNumDisks=poolNumDisks, tempTable=tempTable, tempIndex=tempIndex, unit=unit)
