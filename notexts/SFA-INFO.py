...
# Produced by pysmi-1.1.8 at Thu Sep 15 10:04:00 2022
...
TimeTicks, NotificationType, ObjectIdentity, Counter32, Gauge32, Integer32, enterprises, Counter64, IpAddress, Bits, Unsigned32, ModuleIdentity, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "ObjectIdentity", "Counter32", "Gauge32", "Integer32", "enterprises", "Counter64", "IpAddress", "Bits", "Unsigned32", "ModuleIdentity", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SFA-INFO", physicalDiskTable=physicalDiskTable, physicalDiskEntry=physicalDiskEntry, physDiskId=physDiskId, tempEncPos=tempEncPos, fanTable=fanTable, tempTable=tempTable, physDiskState=physDiskState, DisplayString=DisplayString, poolType=poolType, fanIndex=fanIndex, tempEncId=tempEncId, eventLogTrapLevel=eventLogTrapLevel, physDiskSlot=physDiskSlot, physDiskPoolId=physDiskPoolId, powerEncPos=powerEncPos, eventLog=eventLog, unit=unit, powerStatus=powerStatus, eventLogEntry=eventLogEntry, poolId=poolId, eventLogNumEntries=eventLogNumEntries, poolIndex=poolIndex, fanNumber=fanNumber, systemName=systemName, eventLogIndex=eventLogIndex, tempIndex=tempIndex, fanEncPos=fanEncPos, powerNumber=powerNumber, datadirect=datadirect, fanEntry=fanEntry, physDiskWWN=physDiskWWN, eventLogDescr=eventLogDescr, poolNumber=poolNumber, tempNumber=tempNumber, powerIndex=powerIndex, tempStatus=tempStatus, physDiskEnc=physDiskEnc, eventLogLevel=eventLogLevel, powerEntry=powerEntry, fanEncId=fanEncId, eventLogTable=eventLogTable, poolNumDisks=poolNumDisks, powerTable=powerTable, tempEntry=tempEntry, powerEncId=powerEncId, physDiskIndex=physDiskIndex, fanStatus=fanStatus, poolTable=poolTable, poolEntry=poolEntry)
