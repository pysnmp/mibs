...
Gauge32, iso, ModuleIdentity, Unsigned32, NotificationType, enterprises, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, ObjectIdentity, Counter32, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "ModuleIdentity", "Unsigned32", "NotificationType", "enterprises", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "ObjectIdentity", "Counter32", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("SFA-INFO", fanIndex=fanIndex, powerEntry=powerEntry, physDiskIndex=physDiskIndex, eventLogIndex=eventLogIndex, eventLogTrapLevel=eventLogTrapLevel, poolEntry=poolEntry, tempEncPos=tempEncPos, eventLogLevel=eventLogLevel, poolIndex=poolIndex, physicalDiskEntry=physicalDiskEntry, fanEntry=fanEntry, eventLogDescr=eventLogDescr, poolNumber=poolNumber, DisplayString=DisplayString, powerStatus=powerStatus, tempEncId=tempEncId, tempStatus=tempStatus, physDiskState=physDiskState, systemName=systemName, physDiskPoolId=physDiskPoolId, physDiskWWN=physDiskWWN, physDiskEnc=physDiskEnc, poolNumDisks=poolNumDisks, eventLogNumEntries=eventLogNumEntries, fanEncPos=fanEncPos, poolType=poolType, fanStatus=fanStatus, tempTable=tempTable, powerEncId=powerEncId, unit=unit, tempEntry=tempEntry, eventLogEntry=eventLogEntry, powerEncPos=powerEncPos, powerTable=powerTable, physDiskSlot=physDiskSlot, datadirect=datadirect, poolTable=poolTable, tempIndex=tempIndex, fanEncId=fanEncId, eventLog=eventLog, fanTable=fanTable, powerNumber=powerNumber, eventLogTable=eventLogTable, physDiskId=physDiskId, tempNumber=tempNumber, poolId=poolId, physicalDiskTable=physicalDiskTable, powerIndex=powerIndex, fanNumber=fanNumber)
