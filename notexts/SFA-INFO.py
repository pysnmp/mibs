...
# Produced by pysmi-1.1.11 at Wed Apr  3 13:43:16 2024
...
iso, MibIdentifier, Unsigned32, ObjectIdentity, NotificationType, Gauge32, Counter32, IpAddress, Bits, enterprises, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "Unsigned32", "ObjectIdentity", "NotificationType", "Gauge32", "Counter32", "IpAddress", "Bits", "enterprises", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("SFA-INFO", tempStatus=tempStatus, poolTable=poolTable, physicalDiskEntry=physicalDiskEntry, poolEntry=poolEntry, poolId=poolId, powerIndex=powerIndex, eventLogTable=eventLogTable, eventLogIndex=eventLogIndex, poolNumDisks=poolNumDisks, powerNumber=powerNumber, eventLogDescr=eventLogDescr, eventLogLevel=eventLogLevel, powerEncPos=powerEncPos, eventLogEntry=eventLogEntry, tempTable=tempTable, physDiskWWN=physDiskWWN, tempNumber=tempNumber, eventLog=eventLog, poolNumber=poolNumber, unit=unit, physDiskState=physDiskState, tempEncPos=tempEncPos, powerTable=powerTable, fanEncPos=fanEncPos, DisplayString=DisplayString, eventLogTrapLevel=eventLogTrapLevel, powerStatus=powerStatus, fanEncId=fanEncId, physDiskPoolId=physDiskPoolId, fanEntry=fanEntry, fanIndex=fanIndex, fanStatus=fanStatus, tempIndex=tempIndex, powerEntry=powerEntry, systemName=systemName, tempEncId=tempEncId, fanTable=fanTable, powerEncId=powerEncId, physDiskIndex=physDiskIndex, eventLogNumEntries=eventLogNumEntries, poolIndex=poolIndex, poolType=poolType, physDiskId=physDiskId, datadirect=datadirect, physicalDiskTable=physicalDiskTable, physDiskEnc=physDiskEnc, fanNumber=fanNumber, tempEntry=tempEntry, physDiskSlot=physDiskSlot)
