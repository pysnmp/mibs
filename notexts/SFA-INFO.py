...
# Produced by pysmi-1.1.12 at Tue Dec  3 09:41:04 2024
...
Gauge32, ObjectIdentity, MibIdentifier, ModuleIdentity, NotificationType, Counter64, enterprises, Bits, TimeTicks, Counter32, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "NotificationType", "Counter64", "enterprises", "Bits", "TimeTicks", "Counter32", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso")
...
mibBuilder.exportSymbols("SFA-INFO", tempEntry=tempEntry, fanEncId=fanEncId, poolNumber=poolNumber, fanIndex=fanIndex, physDiskSlot=physDiskSlot, eventLogEntry=eventLogEntry, DisplayString=DisplayString, powerEntry=powerEntry, powerEncPos=powerEncPos, physDiskIndex=physDiskIndex, physDiskId=physDiskId, eventLogTrapLevel=eventLogTrapLevel, fanStatus=fanStatus, eventLogIndex=eventLogIndex, poolEntry=poolEntry, physDiskState=physDiskState, poolNumDisks=poolNumDisks, physDiskWWN=physDiskWWN, physDiskEnc=physDiskEnc, eventLogDescr=eventLogDescr, poolId=poolId, unit=unit, powerStatus=powerStatus, tempEncId=tempEncId, fanEntry=fanEntry, eventLog=eventLog, powerEncId=powerEncId, tempStatus=tempStatus, poolType=poolType, powerIndex=powerIndex, tempEncPos=tempEncPos, eventLogTable=eventLogTable, eventLogLevel=eventLogLevel, physicalDiskEntry=physicalDiskEntry, physicalDiskTable=physicalDiskTable, datadirect=datadirect, fanNumber=fanNumber, tempNumber=tempNumber, poolTable=poolTable, tempIndex=tempIndex, tempTable=tempTable, systemName=systemName, powerNumber=powerNumber, fanEncPos=fanEncPos, physDiskPoolId=physDiskPoolId, fanTable=fanTable, powerTable=powerTable, eventLogNumEntries=eventLogNumEntries, poolIndex=poolIndex)
