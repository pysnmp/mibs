...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:37:52 2024
...
NotificationType, iso, Counter32, Bits, enterprises, Gauge32, Counter64, TimeTicks, MibIdentifier, ModuleIdentity, ObjectIdentity, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "Counter32", "Bits", "enterprises", "Gauge32", "Counter64", "TimeTicks", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("SFA-INFO", tempTable=tempTable, physDiskWWN=physDiskWWN, DisplayString=DisplayString, fanTable=fanTable, datadirect=datadirect, fanEncId=fanEncId, eventLogIndex=eventLogIndex, tempIndex=tempIndex, physicalDiskTable=physicalDiskTable, physDiskPoolId=physDiskPoolId, tempEncId=tempEncId, eventLogNumEntries=eventLogNumEntries, poolType=poolType, physicalDiskEntry=physicalDiskEntry, physDiskSlot=physDiskSlot, unit=unit, tempEntry=tempEntry, fanEncPos=fanEncPos, poolIndex=poolIndex, physDiskIndex=physDiskIndex, fanIndex=fanIndex, physDiskId=physDiskId, powerEncPos=powerEncPos, eventLogTrapLevel=eventLogTrapLevel, powerEntry=powerEntry, fanStatus=fanStatus, poolId=poolId, powerStatus=powerStatus, tempStatus=tempStatus, eventLogLevel=eventLogLevel, poolEntry=poolEntry, eventLogTable=eventLogTable, eventLogDescr=eventLogDescr, physDiskState=physDiskState, poolNumber=poolNumber, powerIndex=powerIndex, poolNumDisks=poolNumDisks, tempNumber=tempNumber, eventLog=eventLog, poolTable=poolTable, tempEncPos=tempEncPos, powerNumber=powerNumber, powerTable=powerTable, powerEncId=powerEncId, physDiskEnc=physDiskEnc, systemName=systemName, eventLogEntry=eventLogEntry, fanEntry=fanEntry, fanNumber=fanNumber)
