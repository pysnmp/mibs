...
# Produced by pysmi-1.1.3 at Sun Nov 28 16:42:23 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, Counter64, MibIdentifier, NotificationType, ObjectIdentity, IpAddress, Bits, iso, enterprises, ModuleIdentity, Counter32, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "Counter64", "MibIdentifier", "NotificationType", "ObjectIdentity", "IpAddress", "Bits", "iso", "enterprises", "ModuleIdentity", "Counter32", "Unsigned32", "Gauge32")
...
mibBuilder.exportSymbols("SFA-INFO", physicalDiskEntry=physicalDiskEntry, powerEncPos=powerEncPos, fanIndex=fanIndex, eventLogLevel=eventLogLevel, poolId=poolId, eventLogEntry=eventLogEntry, physDiskIndex=physDiskIndex, physDiskId=physDiskId, physDiskPoolId=physDiskPoolId, poolIndex=poolIndex, systemName=systemName, powerNumber=powerNumber, fanEntry=fanEntry, DisplayString=DisplayString, datadirect=datadirect, powerEntry=powerEntry, tempTable=tempTable, poolNumDisks=poolNumDisks, physicalDiskTable=physicalDiskTable, unit=unit, eventLog=eventLog, fanEncPos=fanEncPos, tempStatus=tempStatus, poolNumber=poolNumber, fanTable=fanTable, eventLogTable=eventLogTable, powerStatus=powerStatus, physDiskSlot=physDiskSlot, tempEncPos=tempEncPos, eventLogNumEntries=eventLogNumEntries, physDiskWWN=physDiskWWN, tempIndex=tempIndex, eventLogTrapLevel=eventLogTrapLevel, powerTable=powerTable, fanEncId=fanEncId, tempEncId=tempEncId, poolEntry=poolEntry, eventLogDescr=eventLogDescr, poolTable=poolTable, fanStatus=fanStatus, tempNumber=tempNumber, powerIndex=powerIndex, physDiskEnc=physDiskEnc, powerEncId=powerEncId, fanNumber=fanNumber, eventLogIndex=eventLogIndex, physDiskState=physDiskState, poolType=poolType, tempEntry=tempEntry)
