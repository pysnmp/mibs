...
# Produced by pysmi-1.1.8 at Thu Sep 15 10:02:04 2022
...
Gauge32, Counter32, enterprises, ModuleIdentity, ObjectIdentity, NotificationType, Unsigned32, iso, MibIdentifier, TimeTicks, Counter64, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "enterprises", "ModuleIdentity", "ObjectIdentity", "NotificationType", "Unsigned32", "iso", "MibIdentifier", "TimeTicks", "Counter64", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("SFA-INFO", powerEncPos=powerEncPos, poolTable=poolTable, datadirect=datadirect, fanStatus=fanStatus, physDiskId=physDiskId, poolNumber=poolNumber, tempEntry=tempEntry, eventLogIndex=eventLogIndex, fanNumber=fanNumber, systemName=systemName, physDiskEnc=physDiskEnc, tempTable=tempTable, unit=unit, powerTable=powerTable, poolId=poolId, eventLogEntry=eventLogEntry, poolEntry=poolEntry, powerEncId=powerEncId, eventLogTable=eventLogTable, tempEncId=tempEncId, eventLogNumEntries=eventLogNumEntries, eventLogDescr=eventLogDescr, eventLogLevel=eventLogLevel, fanIndex=fanIndex, poolNumDisks=poolNumDisks, physicalDiskTable=physicalDiskTable, fanEntry=fanEntry, tempEncPos=tempEncPos, physDiskPoolId=physDiskPoolId, powerNumber=powerNumber, physDiskIndex=physDiskIndex, poolType=poolType, physDiskSlot=physDiskSlot, DisplayString=DisplayString, eventLogTrapLevel=eventLogTrapLevel, tempIndex=tempIndex, powerIndex=powerIndex, powerEntry=powerEntry, fanEncId=fanEncId, poolIndex=poolIndex, fanEncPos=fanEncPos, tempNumber=tempNumber, tempStatus=tempStatus, fanTable=fanTable, powerStatus=powerStatus, eventLog=eventLog, physDiskWWN=physDiskWWN, physicalDiskEntry=physicalDiskEntry, physDiskState=physDiskState)
