...
# Produced by pysmi-1.1.8 at Thu Jan 27 21:34:36 2022
...
TimeTicks, Unsigned32, Bits, Counter32, MibIdentifier, enterprises, iso, IpAddress, Counter64, Gauge32, ObjectIdentity, NotificationType, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "Bits", "Counter32", "MibIdentifier", "enterprises", "iso", "IpAddress", "Counter64", "Gauge32", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SFA-INFO", powerIndex=powerIndex, tempNumber=tempNumber, tempStatus=tempStatus, eventLog=eventLog, poolTable=poolTable, tempEncId=tempEncId, physDiskIndex=physDiskIndex, powerTable=powerTable, eventLogLevel=eventLogLevel, unit=unit, physDiskWWN=physDiskWWN, powerNumber=powerNumber, powerEncId=powerEncId, powerStatus=powerStatus, physDiskId=physDiskId, tempTable=tempTable, poolIndex=poolIndex, eventLogTable=eventLogTable, tempIndex=tempIndex, fanEntry=fanEntry, tempEntry=tempEntry, poolId=poolId, tempEncPos=tempEncPos, physicalDiskTable=physicalDiskTable, physDiskSlot=physDiskSlot, physDiskPoolId=physDiskPoolId, fanEncPos=fanEncPos, eventLogNumEntries=eventLogNumEntries, fanNumber=fanNumber, eventLogIndex=eventLogIndex, poolNumDisks=poolNumDisks, physDiskState=physDiskState, poolEntry=poolEntry, fanStatus=fanStatus, powerEntry=powerEntry, poolType=poolType, DisplayString=DisplayString, poolNumber=poolNumber, datadirect=datadirect, fanIndex=fanIndex, systemName=systemName, eventLogTrapLevel=eventLogTrapLevel, eventLogEntry=eventLogEntry, eventLogDescr=eventLogDescr, fanEncId=fanEncId, physDiskEnc=physDiskEnc, physicalDiskEntry=physicalDiskEntry, fanTable=fanTable, powerEncPos=powerEncPos)
