...
# Produced by pysmi-1.1.0 at Mon Nov 15 20:05:10 2021
...
iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, Integer32, NotificationType, enterprises, Unsigned32, IpAddress, Bits, ObjectIdentity, Counter32, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "Integer32", "NotificationType", "enterprises", "Unsigned32", "IpAddress", "Bits", "ObjectIdentity", "Counter32", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("SFA-INFO", fanEncPos=fanEncPos, fanIndex=fanIndex, physDiskIndex=physDiskIndex, tempIndex=tempIndex, tempEncPos=tempEncPos, systemName=systemName, eventLogLevel=eventLogLevel, physDiskWWN=physDiskWWN, poolEntry=poolEntry, tempStatus=tempStatus, powerEncId=powerEncId, eventLogTrapLevel=eventLogTrapLevel, physDiskState=physDiskState, tempNumber=tempNumber, fanTable=fanTable, physDiskPoolId=physDiskPoolId, unit=unit, eventLogDescr=eventLogDescr, eventLogEntry=eventLogEntry, physicalDiskTable=physicalDiskTable, powerEntry=powerEntry, poolId=poolId, poolType=poolType, fanEntry=fanEntry, tempEntry=tempEntry, physDiskId=physDiskId, eventLogNumEntries=eventLogNumEntries, tempTable=tempTable, poolNumDisks=poolNumDisks, powerTable=powerTable, poolIndex=poolIndex, physDiskEnc=physDiskEnc, eventLogTable=eventLogTable, eventLogIndex=eventLogIndex, datadirect=datadirect, DisplayString=DisplayString, poolTable=poolTable, eventLog=eventLog, powerStatus=powerStatus, physicalDiskEntry=physicalDiskEntry, powerEncPos=powerEncPos, powerNumber=powerNumber, fanEncId=fanEncId, physDiskSlot=physDiskSlot, poolNumber=poolNumber, powerIndex=powerIndex, fanStatus=fanStatus, tempEncId=tempEncId, fanNumber=fanNumber)
