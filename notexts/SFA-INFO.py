...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:12:20 2021
...
iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, Counter64, ObjectIdentity, MibIdentifier, Integer32, Counter32, Unsigned32, Gauge32, enterprises, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "Counter64", "ObjectIdentity", "MibIdentifier", "Integer32", "Counter32", "Unsigned32", "Gauge32", "enterprises", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("SFA-INFO", tempNumber=tempNumber, datadirect=datadirect, tempEncPos=tempEncPos, poolIndex=poolIndex, poolId=poolId, physicalDiskEntry=physicalDiskEntry, powerEntry=powerEntry, physDiskIndex=physDiskIndex, eventLogLevel=eventLogLevel, fanEncId=fanEncId, tempEncId=tempEncId, physicalDiskTable=physicalDiskTable, eventLogTable=eventLogTable, tempTable=tempTable, powerTable=powerTable, eventLogDescr=eventLogDescr, powerEncPos=powerEncPos, eventLogNumEntries=eventLogNumEntries, fanEntry=fanEntry, fanStatus=fanStatus, systemName=systemName, physDiskWWN=physDiskWWN, eventLog=eventLog, powerEncId=powerEncId, poolType=poolType, unit=unit, fanNumber=fanNumber, powerStatus=powerStatus, fanEncPos=fanEncPos, eventLogEntry=eventLogEntry, fanIndex=fanIndex, poolNumber=poolNumber, poolNumDisks=poolNumDisks, eventLogTrapLevel=eventLogTrapLevel, eventLogIndex=eventLogIndex, physDiskId=physDiskId, DisplayString=DisplayString, physDiskState=physDiskState, tempStatus=tempStatus, powerNumber=powerNumber, powerIndex=powerIndex, physDiskEnc=physDiskEnc, physDiskSlot=physDiskSlot, poolEntry=poolEntry, physDiskPoolId=physDiskPoolId, tempEntry=tempEntry, poolTable=poolTable, tempIndex=tempIndex, fanTable=fanTable)
