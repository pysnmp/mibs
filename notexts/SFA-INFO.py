...
# Produced by pysmi-1.1.8 at Thu Apr 27 11:28:48 2023
...
Counter32, TimeTicks, enterprises, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, Bits, Integer32, NotificationType, MibIdentifier, Unsigned32, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "enterprises", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "Bits", "Integer32", "NotificationType", "MibIdentifier", "Unsigned32", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("SFA-INFO", systemName=systemName, poolNumber=poolNumber, datadirect=datadirect, DisplayString=DisplayString, physicalDiskEntry=physicalDiskEntry, fanEntry=fanEntry, tempEncId=tempEncId, tempNumber=tempNumber, tempEntry=tempEntry, fanNumber=fanNumber, physicalDiskTable=physicalDiskTable, physDiskIndex=physDiskIndex, physDiskEnc=physDiskEnc, fanTable=fanTable, tempIndex=tempIndex, poolTable=poolTable, poolType=poolType, powerEntry=powerEntry, tempStatus=tempStatus, unit=unit, powerEncId=powerEncId, powerTable=powerTable, physDiskId=physDiskId, poolId=poolId, physDiskSlot=physDiskSlot, eventLogEntry=eventLogEntry, physDiskPoolId=physDiskPoolId, eventLogLevel=eventLogLevel, fanStatus=fanStatus, physDiskState=physDiskState, tempEncPos=tempEncPos, eventLog=eventLog, poolEntry=poolEntry, physDiskWWN=physDiskWWN, eventLogTable=eventLogTable, powerNumber=powerNumber, powerIndex=powerIndex, eventLogTrapLevel=eventLogTrapLevel, eventLogIndex=eventLogIndex, eventLogNumEntries=eventLogNumEntries, fanEncPos=fanEncPos, fanIndex=fanIndex, powerStatus=powerStatus, poolIndex=poolIndex, eventLogDescr=eventLogDescr, poolNumDisks=poolNumDisks, tempTable=tempTable, powerEncPos=powerEncPos, fanEncId=fanEncId)
