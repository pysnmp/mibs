...
# Produced by pysmi-1.1.8 at Fri Jan  7 16:03:06 2022
...
ModuleIdentity, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, Counter64, NotificationType, Gauge32, MibIdentifier, TimeTicks, Integer32, iso, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "Counter64", "NotificationType", "Gauge32", "MibIdentifier", "TimeTicks", "Integer32", "iso", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("SFA-INFO", fanEncPos=fanEncPos, tempEncPos=tempEncPos, fanEntry=fanEntry, powerNumber=powerNumber, physDiskPoolId=physDiskPoolId, tempEncId=tempEncId, powerIndex=powerIndex, eventLog=eventLog, tempNumber=tempNumber, poolId=poolId, poolType=poolType, powerStatus=powerStatus, physDiskSlot=physDiskSlot, systemName=systemName, powerEntry=powerEntry, eventLogTrapLevel=eventLogTrapLevel, eventLogEntry=eventLogEntry, eventLogDescr=eventLogDescr, unit=unit, eventLogLevel=eventLogLevel, poolEntry=poolEntry, physDiskWWN=physDiskWWN, tempStatus=tempStatus, eventLogNumEntries=eventLogNumEntries, physDiskState=physDiskState, physDiskEnc=physDiskEnc, fanIndex=fanIndex, physicalDiskEntry=physicalDiskEntry, eventLogTable=eventLogTable, poolIndex=poolIndex, fanEncId=fanEncId, DisplayString=DisplayString, poolTable=poolTable, fanNumber=fanNumber, poolNumDisks=poolNumDisks, physDiskIndex=physDiskIndex, fanTable=fanTable, physicalDiskTable=physicalDiskTable, physDiskId=physDiskId, tempIndex=tempIndex, datadirect=datadirect, poolNumber=poolNumber, tempEntry=tempEntry, powerEncPos=powerEncPos, powerEncId=powerEncId, fanStatus=fanStatus, tempTable=tempTable, eventLogIndex=eventLogIndex, powerTable=powerTable)
