...
# Produced by pysmi-1.1.12 at Tue Jun 25 14:10:24 2024
...
Integer32, Counter32, Counter64, Gauge32, iso, enterprises, ObjectIdentity, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, TimeTicks, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "Counter64", "Gauge32", "iso", "enterprises", "ObjectIdentity", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "TimeTicks", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("SFA-INFO", physDiskWWN=physDiskWWN, powerTable=powerTable, physDiskIndex=physDiskIndex, fanStatus=fanStatus, unit=unit, physicalDiskTable=physicalDiskTable, DisplayString=DisplayString, tempStatus=tempStatus, poolTable=poolTable, datadirect=datadirect, tempTable=tempTable, poolType=poolType, physDiskEnc=physDiskEnc, physDiskSlot=physDiskSlot, physDiskState=physDiskState, eventLogTrapLevel=eventLogTrapLevel, powerEntry=powerEntry, eventLogIndex=eventLogIndex, fanTable=fanTable, fanEntry=fanEntry, eventLogEntry=eventLogEntry, poolNumber=poolNumber, powerEncPos=powerEncPos, poolIndex=poolIndex, powerNumber=powerNumber, fanIndex=fanIndex, physDiskPoolId=physDiskPoolId, eventLogDescr=eventLogDescr, powerStatus=powerStatus, powerIndex=powerIndex, powerEncId=powerEncId, tempIndex=tempIndex, poolId=poolId, eventLogNumEntries=eventLogNumEntries, fanNumber=fanNumber, poolNumDisks=poolNumDisks, physicalDiskEntry=physicalDiskEntry, poolEntry=poolEntry, systemName=systemName, physDiskId=physDiskId, fanEncPos=fanEncPos, eventLogTable=eventLogTable, tempNumber=tempNumber, tempEntry=tempEntry, eventLog=eventLog, eventLogLevel=eventLogLevel, fanEncId=fanEncId, tempEncPos=tempEncPos, tempEncId=tempEncId)
