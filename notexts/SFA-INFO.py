...
# Produced by pysmi-1.1.8 at Tue Aug  9 15:40:41 2022
...
Counter32, Bits, enterprises, IpAddress, NotificationType, Integer32, iso, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, ObjectIdentity, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "enterprises", "IpAddress", "NotificationType", "Integer32", "iso", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "ObjectIdentity", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("SFA-INFO", DisplayString=DisplayString, poolNumDisks=poolNumDisks, eventLog=eventLog, powerNumber=powerNumber, tempEncId=tempEncId, poolNumber=poolNumber, tempStatus=tempStatus, powerEncPos=powerEncPos, physDiskEnc=physDiskEnc, tempIndex=tempIndex, systemName=systemName, eventLogNumEntries=eventLogNumEntries, tempEncPos=tempEncPos, datadirect=datadirect, poolEntry=poolEntry, physDiskIndex=physDiskIndex, physDiskState=physDiskState, tempEntry=tempEntry, fanEncId=fanEncId, physDiskSlot=physDiskSlot, physDiskWWN=physDiskWWN, fanStatus=fanStatus, fanNumber=fanNumber, poolIndex=poolIndex, powerEntry=powerEntry, eventLogLevel=eventLogLevel, poolId=poolId, fanEncPos=fanEncPos, poolTable=poolTable, physDiskId=physDiskId, physicalDiskTable=physicalDiskTable, tempNumber=tempNumber, tempTable=tempTable, powerEncId=powerEncId, fanEntry=fanEntry, powerTable=powerTable, powerIndex=powerIndex, eventLogTrapLevel=eventLogTrapLevel, unit=unit, fanTable=fanTable, poolType=poolType, eventLogTable=eventLogTable, physDiskPoolId=physDiskPoolId, fanIndex=fanIndex, eventLogIndex=eventLogIndex, powerStatus=powerStatus, eventLogEntry=eventLogEntry, eventLogDescr=eventLogDescr, physicalDiskEntry=physicalDiskEntry)
