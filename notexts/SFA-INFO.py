...
# Produced by pysmi-1.1.8 at Thu Sep 29 12:42:37 2022
...
iso, Bits, Unsigned32, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, ModuleIdentity, IpAddress, TimeTicks, enterprises, Counter64, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "Unsigned32", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "ModuleIdentity", "IpAddress", "TimeTicks", "enterprises", "Counter64", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("SFA-INFO", eventLogTable=eventLogTable, tempStatus=tempStatus, fanStatus=fanStatus, tempEncId=tempEncId, systemName=systemName, fanTable=fanTable, poolNumber=poolNumber, powerTable=powerTable, eventLogDescr=eventLogDescr, tempTable=tempTable, physDiskId=physDiskId, physDiskPoolId=physDiskPoolId, tempEncPos=tempEncPos, poolType=poolType, powerNumber=powerNumber, physDiskWWN=physDiskWWN, eventLogLevel=eventLogLevel, physDiskEnc=physDiskEnc, physicalDiskTable=physicalDiskTable, fanEncId=fanEncId, fanEncPos=fanEncPos, DisplayString=DisplayString, physicalDiskEntry=physicalDiskEntry, poolEntry=poolEntry, tempIndex=tempIndex, poolId=poolId, physDiskSlot=physDiskSlot, poolTable=poolTable, fanEntry=fanEntry, powerIndex=powerIndex, eventLog=eventLog, poolIndex=poolIndex, powerStatus=powerStatus, eventLogEntry=eventLogEntry, datadirect=datadirect, eventLogIndex=eventLogIndex, eventLogNumEntries=eventLogNumEntries, powerEncId=powerEncId, physDiskState=physDiskState, tempEntry=tempEntry, unit=unit, fanNumber=fanNumber, powerEntry=powerEntry, poolNumDisks=poolNumDisks, tempNumber=tempNumber, physDiskIndex=physDiskIndex, eventLogTrapLevel=eventLogTrapLevel, fanIndex=fanIndex, powerEncPos=powerEncPos)
