...
# Produced by pysmi-1.1.10 at Fri Oct 27 06:59:56 2023
...
MibIdentifier, TimeTicks, IpAddress, enterprises, Bits, iso, Counter64, ObjectIdentity, Counter32, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "IpAddress", "enterprises", "Bits", "iso", "Counter64", "ObjectIdentity", "Counter32", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("SFA-INFO", physDiskSlot=physDiskSlot, fanEntry=fanEntry, powerEncId=powerEncId, physDiskId=physDiskId, powerIndex=powerIndex, powerTable=powerTable, eventLogIndex=eventLogIndex, eventLogDescr=eventLogDescr, tempStatus=tempStatus, poolTable=poolTable, eventLogTrapLevel=eventLogTrapLevel, eventLogTable=eventLogTable, fanEncId=fanEncId, physicalDiskTable=physicalDiskTable, physDiskIndex=physDiskIndex, physDiskPoolId=physDiskPoolId, DisplayString=DisplayString, physDiskWWN=physDiskWWN, eventLog=eventLog, eventLogEntry=eventLogEntry, poolType=poolType, poolIndex=poolIndex, systemName=systemName, physDiskState=physDiskState, powerNumber=powerNumber, eventLogNumEntries=eventLogNumEntries, fanTable=fanTable, powerEntry=powerEntry, tempIndex=tempIndex, tempEncId=tempEncId, powerStatus=powerStatus, poolNumber=poolNumber, poolEntry=poolEntry, tempNumber=tempNumber, eventLogLevel=eventLogLevel, tempEntry=tempEntry, fanEncPos=fanEncPos, unit=unit, tempEncPos=tempEncPos, fanNumber=fanNumber, powerEncPos=powerEncPos, fanIndex=fanIndex, tempTable=tempTable, poolId=poolId, physDiskEnc=physDiskEnc, physicalDiskEntry=physicalDiskEntry, datadirect=datadirect, poolNumDisks=poolNumDisks, fanStatus=fanStatus)
