...
# Produced by pysmi-1.1.8 at Sat Jan 15 17:13:51 2022
...
Counter32, ObjectIdentity, NotificationType, Counter64, Bits, enterprises, Gauge32, iso, ModuleIdentity, Unsigned32, IpAddress, MibIdentifier, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "NotificationType", "Counter64", "Bits", "enterprises", "Gauge32", "iso", "ModuleIdentity", "Unsigned32", "IpAddress", "MibIdentifier", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SFA-INFO", poolNumDisks=poolNumDisks, physDiskIndex=physDiskIndex, tempEntry=tempEntry, systemName=systemName, eventLogTable=eventLogTable, poolIndex=poolIndex, physDiskWWN=physDiskWWN, powerEncPos=powerEncPos, tempIndex=tempIndex, fanTable=fanTable, fanEncId=fanEncId, powerTable=powerTable, powerEncId=powerEncId, physicalDiskTable=physicalDiskTable, powerNumber=powerNumber, eventLog=eventLog, fanEntry=fanEntry, powerIndex=powerIndex, poolTable=poolTable, powerEntry=powerEntry, tempEncPos=tempEncPos, fanIndex=fanIndex, poolEntry=poolEntry, physDiskPoolId=physDiskPoolId, tempNumber=tempNumber, tempStatus=tempStatus, eventLogLevel=eventLogLevel, physDiskState=physDiskState, physDiskSlot=physDiskSlot, poolNumber=poolNumber, eventLogIndex=eventLogIndex, physicalDiskEntry=physicalDiskEntry, physDiskEnc=physDiskEnc, eventLogEntry=eventLogEntry, tempTable=tempTable, powerStatus=powerStatus, DisplayString=DisplayString, fanNumber=fanNumber, eventLogTrapLevel=eventLogTrapLevel, datadirect=datadirect, tempEncId=tempEncId, fanEncPos=fanEncPos, poolId=poolId, poolType=poolType, eventLogDescr=eventLogDescr, fanStatus=fanStatus, unit=unit, physDiskId=physDiskId, eventLogNumEntries=eventLogNumEntries)
