...
# Produced by pysmi-1.1.11 at Wed Dec  6 02:59:54 2023
...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, iso, enterprises, NotificationType, TimeTicks, ModuleIdentity, Unsigned32, Gauge32, ObjectIdentity, Counter64, Counter32, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "iso", "enterprises", "NotificationType", "TimeTicks", "ModuleIdentity", "Unsigned32", "Gauge32", "ObjectIdentity", "Counter64", "Counter32", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("SFA-INFO", physDiskWWN=physDiskWWN, eventLogDescr=eventLogDescr, physDiskPoolId=physDiskPoolId, physDiskIndex=physDiskIndex, fanTable=fanTable, unit=unit, powerEncPos=powerEncPos, poolEntry=poolEntry, eventLogTable=eventLogTable, eventLogIndex=eventLogIndex, tempEncId=tempEncId, fanNumber=fanNumber, eventLogEntry=eventLogEntry, tempEncPos=tempEncPos, fanIndex=fanIndex, physDiskState=physDiskState, physDiskSlot=physDiskSlot, powerEntry=powerEntry, physDiskEnc=physDiskEnc, physicalDiskTable=physicalDiskTable, poolId=poolId, tempTable=tempTable, fanStatus=fanStatus, eventLogLevel=eventLogLevel, DisplayString=DisplayString, powerNumber=powerNumber, poolType=poolType, physicalDiskEntry=physicalDiskEntry, tempEntry=tempEntry, eventLogTrapLevel=eventLogTrapLevel, poolTable=poolTable, poolNumDisks=poolNumDisks, eventLog=eventLog, tempNumber=tempNumber, powerTable=powerTable, powerStatus=powerStatus, fanEntry=fanEntry, systemName=systemName, eventLogNumEntries=eventLogNumEntries, physDiskId=physDiskId, powerEncId=powerEncId, poolNumber=poolNumber, powerIndex=powerIndex, fanEncId=fanEncId, tempStatus=tempStatus, tempIndex=tempIndex, poolIndex=poolIndex, fanEncPos=fanEncPos, datadirect=datadirect)
