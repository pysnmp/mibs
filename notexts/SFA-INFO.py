...
# Produced by pysmi-1.1.12 at Mon Jun  3 14:00:41 2024
...
IpAddress, Integer32, ObjectIdentity, iso, ModuleIdentity, Gauge32, TimeTicks, Counter32, Bits, Unsigned32, NotificationType, MibIdentifier, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Integer32", "ObjectIdentity", "iso", "ModuleIdentity", "Gauge32", "TimeTicks", "Counter32", "Bits", "Unsigned32", "NotificationType", "MibIdentifier", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("SFA-INFO", tempTable=tempTable, poolNumber=poolNumber, eventLogNumEntries=eventLogNumEntries, eventLogTable=eventLogTable, powerEncPos=powerEncPos, physDiskEnc=physDiskEnc, fanEncPos=fanEncPos, physDiskSlot=physDiskSlot, tempEncId=tempEncId, fanStatus=fanStatus, physicalDiskEntry=physicalDiskEntry, powerStatus=powerStatus, powerEntry=powerEntry, physDiskIndex=physDiskIndex, physDiskPoolId=physDiskPoolId, fanNumber=fanNumber, poolId=poolId, poolTable=poolTable, tempStatus=tempStatus, eventLogEntry=eventLogEntry, unit=unit, physDiskWWN=physDiskWWN, eventLogIndex=eventLogIndex, datadirect=datadirect, tempNumber=tempNumber, tempIndex=tempIndex, fanEntry=fanEntry, eventLogTrapLevel=eventLogTrapLevel, fanTable=fanTable, poolType=poolType, eventLog=eventLog, tempEntry=tempEntry, powerIndex=powerIndex, DisplayString=DisplayString, powerEncId=powerEncId, systemName=systemName, poolIndex=poolIndex, physDiskState=physDiskState, poolEntry=poolEntry, poolNumDisks=poolNumDisks, powerTable=powerTable, physDiskId=physDiskId, eventLogLevel=eventLogLevel, fanEncId=fanEncId, physicalDiskTable=physicalDiskTable, eventLogDescr=eventLogDescr, powerNumber=powerNumber, tempEncPos=tempEncPos, fanIndex=fanIndex)
