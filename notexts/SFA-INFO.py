...
# Produced by pysmi-1.1.8 at Thu Jan  5 11:27:39 2023
...
mibBuilder.exportSymbols("SFA-INFO", powerIndex=powerIndex, poolNumber=poolNumber, powerEncId=powerEncId, tempTable=tempTable, physDiskState=physDiskState, unit=unit, poolEntry=poolEntry, tempStatus=tempStatus, fanIndex=fanIndex, poolTable=poolTable, powerStatus=powerStatus, tempEntry=tempEntry, physDiskId=physDiskId, eventLogLevel=eventLogLevel, powerEntry=powerEntry, poolNumDisks=poolNumDisks, physDiskWWN=physDiskWWN, physDiskPoolId=physDiskPoolId, DisplayString=DisplayString, physDiskIndex=physDiskIndex, physicalDiskTable=physicalDiskTable, datadirect=datadirect, powerTable=powerTable, eventLogEntry=eventLogEntry, poolType=poolType, fanEncPos=fanEncPos, eventLogDescr=eventLogDescr, physDiskEnc=physDiskEnc, powerNumber=powerNumber, physDiskSlot=physDiskSlot, tempIndex=tempIndex, systemName=systemName, eventLogIndex=eventLogIndex, tempEncPos=tempEncPos, poolIndex=poolIndex, tempEncId=tempEncId, fanEntry=fanEntry, physicalDiskEntry=physicalDiskEntry, powerEncPos=powerEncPos, fanTable=fanTable, eventLogTable=eventLogTable, fanEncId=fanEncId, poolId=poolId, eventLog=eventLog, eventLogNumEntries=eventLogNumEntries, fanNumber=fanNumber, fanStatus=fanStatus, tempNumber=tempNumber, eventLogTrapLevel=eventLogTrapLevel)
