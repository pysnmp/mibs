...
# Produced by pysmi-1.1.12 at Mon Oct  7 02:25:29 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, MibIdentifier, NotificationType, Gauge32, Counter64, Integer32, Bits, ModuleIdentity, Unsigned32, TimeTicks, IpAddress, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "MibIdentifier", "NotificationType", "Gauge32", "Counter64", "Integer32", "Bits", "ModuleIdentity", "Unsigned32", "TimeTicks", "IpAddress", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("SFA-INFO", tempEncPos=tempEncPos, poolIndex=poolIndex, poolEntry=poolEntry, physicalDiskEntry=physicalDiskEntry, tempIndex=tempIndex, eventLog=eventLog, physDiskWWN=physDiskWWN, eventLogTrapLevel=eventLogTrapLevel, fanTable=fanTable, unit=unit, powerEntry=powerEntry, tempTable=tempTable, eventLogNumEntries=eventLogNumEntries, fanStatus=fanStatus, poolNumDisks=poolNumDisks, eventLogEntry=eventLogEntry, powerEncId=powerEncId, systemName=systemName, fanEncPos=fanEncPos, physDiskIndex=physDiskIndex, poolNumber=poolNumber, tempEntry=tempEntry, physDiskId=physDiskId, fanIndex=fanIndex, physDiskPoolId=physDiskPoolId, powerIndex=powerIndex, eventLogTable=eventLogTable, physDiskSlot=physDiskSlot, powerStatus=powerStatus, physDiskEnc=physDiskEnc, eventLogIndex=eventLogIndex, tempEncId=tempEncId, fanNumber=fanNumber, eventLogLevel=eventLogLevel, tempNumber=tempNumber, eventLogDescr=eventLogDescr, poolTable=poolTable, powerEncPos=powerEncPos, powerTable=powerTable, physicalDiskTable=physicalDiskTable, poolType=poolType, fanEntry=fanEntry, physDiskState=physDiskState, poolId=poolId, DisplayString=DisplayString, datadirect=datadirect, fanEncId=fanEncId, powerNumber=powerNumber, tempStatus=tempStatus)
