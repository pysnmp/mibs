...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:10:51 2021
...
Counter32, Counter64, Bits, Gauge32, ModuleIdentity, Integer32, iso, ObjectIdentity, IpAddress, NotificationType, enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "Bits", "Gauge32", "ModuleIdentity", "Integer32", "iso", "ObjectIdentity", "IpAddress", "NotificationType", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("SFA-INFO", tempEncPos=tempEncPos, physicalDiskTable=physicalDiskTable, physDiskIndex=physDiskIndex, eventLogIndex=eventLogIndex, eventLogLevel=eventLogLevel, physDiskId=physDiskId, eventLogEntry=eventLogEntry, powerEntry=powerEntry, tempIndex=tempIndex, fanTable=fanTable, powerEncPos=powerEncPos, eventLog=eventLog, powerTable=powerTable, fanEncId=fanEncId, poolIndex=poolIndex, fanNumber=fanNumber, fanIndex=fanIndex, poolNumDisks=poolNumDisks, fanEncPos=fanEncPos, fanEntry=fanEntry, physDiskWWN=physDiskWWN, eventLogTrapLevel=eventLogTrapLevel, DisplayString=DisplayString, poolType=poolType, tempNumber=tempNumber, fanStatus=fanStatus, unit=unit, powerNumber=powerNumber, physDiskState=physDiskState, eventLogDescr=eventLogDescr, tempEntry=tempEntry, powerStatus=powerStatus, physDiskPoolId=physDiskPoolId, tempTable=tempTable, eventLogNumEntries=eventLogNumEntries, datadirect=datadirect, powerEncId=powerEncId, physicalDiskEntry=physicalDiskEntry, physDiskSlot=physDiskSlot, tempStatus=tempStatus, physDiskEnc=physDiskEnc, eventLogTable=eventLogTable, poolEntry=poolEntry, poolTable=poolTable, powerIndex=powerIndex, systemName=systemName, poolId=poolId, poolNumber=poolNumber, tempEncId=tempEncId)
