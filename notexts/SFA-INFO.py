...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, Counter64, ModuleIdentity, enterprises, Unsigned32, TimeTicks, Counter32, ObjectIdentity, Bits, Gauge32, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "Counter64", "ModuleIdentity", "enterprises", "Unsigned32", "TimeTicks", "Counter32", "ObjectIdentity", "Bits", "Gauge32", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("SFA-INFO", eventLogLevel=eventLogLevel, eventLogNumEntries=eventLogNumEntries, fanTable=fanTable, poolId=poolId, poolNumber=poolNumber, physDiskPoolId=physDiskPoolId, physicalDiskEntry=physicalDiskEntry, poolTable=poolTable, physDiskEnc=physDiskEnc, eventLogEntry=eventLogEntry, tempTable=tempTable, physDiskSlot=physDiskSlot, systemName=systemName, powerEncId=powerEncId, poolIndex=poolIndex, eventLogTable=eventLogTable, fanIndex=fanIndex, eventLog=eventLog, datadirect=datadirect, fanEncId=fanEncId, fanStatus=fanStatus, poolNumDisks=poolNumDisks, tempEncId=tempEncId, powerIndex=powerIndex, physDiskId=physDiskId, powerNumber=powerNumber, physDiskIndex=physDiskIndex, DisplayString=DisplayString, fanEncPos=fanEncPos, powerEncPos=powerEncPos, eventLogTrapLevel=eventLogTrapLevel, tempStatus=tempStatus, powerStatus=powerStatus, tempIndex=tempIndex, physDiskState=physDiskState, fanEntry=fanEntry, tempEntry=tempEntry, powerTable=powerTable, eventLogIndex=eventLogIndex, fanNumber=fanNumber, tempEncPos=tempEncPos, powerEntry=powerEntry, eventLogDescr=eventLogDescr, tempNumber=tempNumber, physicalDiskTable=physicalDiskTable, physDiskWWN=physDiskWWN, unit=unit, poolEntry=poolEntry, poolType=poolType)
