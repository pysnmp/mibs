...
# Produced by pysmi-1.1.0 at Tue Nov 16 12:02:36 2021
...
NotificationType, iso, ModuleIdentity, Counter64, enterprises, Bits, Unsigned32, Integer32, Gauge32, ObjectIdentity, Counter32, IpAddress, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "ModuleIdentity", "Counter64", "enterprises", "Bits", "Unsigned32", "Integer32", "Gauge32", "ObjectIdentity", "Counter32", "IpAddress", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SFA-INFO", physicalDiskEntry=physicalDiskEntry, systemName=systemName, poolNumDisks=poolNumDisks, physDiskState=physDiskState, eventLogEntry=eventLogEntry, physDiskIndex=physDiskIndex, fanIndex=fanIndex, datadirect=datadirect, physDiskPoolId=physDiskPoolId, fanTable=fanTable, eventLogLevel=eventLogLevel, poolTable=poolTable, fanEncPos=fanEncPos, eventLogNumEntries=eventLogNumEntries, poolType=poolType, poolIndex=poolIndex, tempStatus=tempStatus, physDiskId=physDiskId, eventLogDescr=eventLogDescr, powerStatus=powerStatus, physicalDiskTable=physicalDiskTable, tempIndex=tempIndex, tempNumber=tempNumber, powerEncId=powerEncId, poolEntry=poolEntry, eventLogTable=eventLogTable, powerEntry=powerEntry, powerIndex=powerIndex, poolNumber=poolNumber, eventLogTrapLevel=eventLogTrapLevel, eventLog=eventLog, eventLogIndex=eventLogIndex, powerEncPos=powerEncPos, tempTable=tempTable, DisplayString=DisplayString, fanNumber=fanNumber, fanEncId=fanEncId, powerTable=powerTable, physDiskSlot=physDiskSlot, poolId=poolId, fanEntry=fanEntry, tempEncId=tempEncId, physDiskWWN=physDiskWWN, fanStatus=fanStatus, powerNumber=powerNumber, physDiskEnc=physDiskEnc, unit=unit, tempEntry=tempEntry, tempEncPos=tempEncPos)
