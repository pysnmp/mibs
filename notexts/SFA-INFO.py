...
# Produced by pysmi-1.1.8 at Wed Sep  6 13:46:29 2023
...
ModuleIdentity, Gauge32, Bits, enterprises, iso, Counter64, NotificationType, IpAddress, Unsigned32, ObjectIdentity, MibIdentifier, Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "Bits", "enterprises", "iso", "Counter64", "NotificationType", "IpAddress", "Unsigned32", "ObjectIdentity", "MibIdentifier", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("SFA-INFO", tempEncId=tempEncId, fanTable=fanTable, fanEncPos=fanEncPos, powerEncPos=powerEncPos, poolId=poolId, tempEntry=tempEntry, powerNumber=powerNumber, poolNumDisks=poolNumDisks, fanStatus=fanStatus, powerEntry=powerEntry, eventLog=eventLog, eventLogIndex=eventLogIndex, eventLogEntry=eventLogEntry, eventLogDescr=eventLogDescr, tempNumber=tempNumber, systemName=systemName, physDiskSlot=physDiskSlot, powerIndex=powerIndex, physDiskIndex=physDiskIndex, tempTable=tempTable, physicalDiskTable=physicalDiskTable, eventLogTrapLevel=eventLogTrapLevel, tempEncPos=tempEncPos, eventLogNumEntries=eventLogNumEntries, physDiskWWN=physDiskWWN, eventLogTable=eventLogTable, datadirect=datadirect, powerStatus=powerStatus, unit=unit, physDiskState=physDiskState, poolTable=poolTable, physDiskEnc=physDiskEnc, physicalDiskEntry=physicalDiskEntry, powerEncId=powerEncId, tempStatus=tempStatus, fanEntry=fanEntry, fanEncId=fanEncId, eventLogLevel=eventLogLevel, poolEntry=poolEntry, powerTable=powerTable, poolNumber=poolNumber, physDiskId=physDiskId, DisplayString=DisplayString, tempIndex=tempIndex, fanIndex=fanIndex, poolType=poolType, physDiskPoolId=physDiskPoolId, fanNumber=fanNumber, poolIndex=poolIndex)
