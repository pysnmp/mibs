...
Bits, Counter64, MibIdentifier, NotificationType, Counter32, enterprises, Integer32, ModuleIdentity, Unsigned32, ObjectIdentity, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "MibIdentifier", "NotificationType", "Counter32", "enterprises", "Integer32", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("SFA-INFO", eventLogDescr=eventLogDescr, poolType=poolType, eventLog=eventLog, powerEntry=powerEntry, fanEntry=fanEntry, physDiskEnc=physDiskEnc, poolIndex=poolIndex, fanEncPos=fanEncPos, physDiskState=physDiskState, eventLogEntry=eventLogEntry, systemName=systemName, powerEncId=powerEncId, datadirect=datadirect, tempEncId=tempEncId, poolEntry=poolEntry, physDiskWWN=physDiskWWN, powerNumber=powerNumber, physDiskSlot=physDiskSlot, tempStatus=tempStatus, fanStatus=fanStatus, fanTable=fanTable, poolNumber=poolNumber, eventLogIndex=eventLogIndex, poolId=poolId, unit=unit, powerStatus=powerStatus, physDiskId=physDiskId, tempTable=tempTable, physDiskPoolId=physDiskPoolId, powerIndex=powerIndex, fanEncId=fanEncId, poolNumDisks=poolNumDisks, physicalDiskEntry=physicalDiskEntry, fanIndex=fanIndex, eventLogTrapLevel=eventLogTrapLevel, DisplayString=DisplayString, tempEntry=tempEntry, tempIndex=tempIndex, fanNumber=fanNumber, physDiskIndex=physDiskIndex, eventLogLevel=eventLogLevel, tempNumber=tempNumber, powerEncPos=powerEncPos, powerTable=powerTable, eventLogNumEntries=eventLogNumEntries, physicalDiskTable=physicalDiskTable, eventLogTable=eventLogTable, tempEncPos=tempEncPos, poolTable=poolTable)
