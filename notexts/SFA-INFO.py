...
Unsigned32, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, ModuleIdentity, ObjectIdentity, TimeTicks, enterprises, Gauge32, Counter64, Bits, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "enterprises", "Gauge32", "Counter64", "Bits", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("SFA-INFO", fanStatus=fanStatus, powerEntry=powerEntry, fanEntry=fanEntry, eventLogEntry=eventLogEntry, tempEncId=tempEncId, fanIndex=fanIndex, physDiskWWN=physDiskWWN, poolNumber=poolNumber, unit=unit, powerNumber=powerNumber, tempNumber=tempNumber, poolIndex=poolIndex, powerIndex=powerIndex, powerStatus=powerStatus, eventLogTrapLevel=eventLogTrapLevel, tempIndex=tempIndex, tempEntry=tempEntry, powerTable=powerTable, physDiskState=physDiskState, physDiskSlot=physDiskSlot, eventLogTable=eventLogTable, poolId=poolId, eventLog=eventLog, fanEncId=fanEncId, physDiskEnc=physDiskEnc, eventLogIndex=eventLogIndex, tempEncPos=tempEncPos, powerEncPos=powerEncPos, poolNumDisks=poolNumDisks, datadirect=datadirect, poolEntry=poolEntry, physDiskId=physDiskId, eventLogNumEntries=eventLogNumEntries, DisplayString=DisplayString, systemName=systemName, eventLogDescr=eventLogDescr, tempTable=tempTable, physicalDiskEntry=physicalDiskEntry, powerEncId=powerEncId, poolType=poolType, physicalDiskTable=physicalDiskTable, eventLogLevel=eventLogLevel, physDiskPoolId=physDiskPoolId, tempStatus=tempStatus, fanEncPos=fanEncPos, fanTable=fanTable, poolTable=poolTable, fanNumber=fanNumber, physDiskIndex=physDiskIndex)
