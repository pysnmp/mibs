...
# Produced by pysmi-1.1.10 at Fri Nov 10 09:16:18 2023
...
NotificationType, enterprises, IpAddress, ModuleIdentity, TimeTicks, Counter32, Counter64, MibIdentifier, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "enterprises", "IpAddress", "ModuleIdentity", "TimeTicks", "Counter32", "Counter64", "MibIdentifier", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "iso", "ObjectIdentity")
...
mibBuilder.exportSymbols("SFA-INFO", DisplayString=DisplayString, eventLogLevel=eventLogLevel, eventLog=eventLog, tempEncId=tempEncId, tempEntry=tempEntry, fanTable=fanTable, poolNumDisks=poolNumDisks, datadirect=datadirect, tempNumber=tempNumber, eventLogNumEntries=eventLogNumEntries, powerStatus=powerStatus, poolNumber=poolNumber, poolIndex=poolIndex, poolEntry=poolEntry, eventLogTable=eventLogTable, physDiskEnc=physDiskEnc, fanEncPos=fanEncPos, eventLogTrapLevel=eventLogTrapLevel, powerTable=powerTable, tempEncPos=tempEncPos, poolId=poolId, eventLogIndex=eventLogIndex, tempIndex=tempIndex, poolType=poolType, physDiskId=physDiskId, tempStatus=tempStatus, physicalDiskEntry=physicalDiskEntry, physDiskState=physDiskState, physDiskIndex=physDiskIndex, fanStatus=fanStatus, unit=unit, tempTable=tempTable, physDiskWWN=physDiskWWN, fanIndex=fanIndex, powerNumber=powerNumber, physicalDiskTable=physicalDiskTable, poolTable=poolTable, physDiskPoolId=physDiskPoolId, systemName=systemName, fanEncId=fanEncId, physDiskSlot=physDiskSlot, fanEntry=fanEntry, powerIndex=powerIndex, eventLogDescr=eventLogDescr, fanNumber=fanNumber, powerEncPos=powerEncPos, powerEntry=powerEntry, powerEncId=powerEncId, eventLogEntry=eventLogEntry)
