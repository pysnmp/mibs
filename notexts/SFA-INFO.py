...
# Produced by pysmi-1.1.12 at Fri Nov 22 15:09:01 2024
...
MibIdentifier, ModuleIdentity, ObjectIdentity, Gauge32, IpAddress, enterprises, Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, Counter32, Integer32, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Gauge32", "IpAddress", "enterprises", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "Counter32", "Integer32", "Unsigned32", "iso")
...
mibBuilder.exportSymbols("SFA-INFO", tempEncPos=tempEncPos, fanEncId=fanEncId, physDiskPoolId=physDiskPoolId, physDiskWWN=physDiskWWN, poolNumber=poolNumber, tempEncId=tempEncId, eventLog=eventLog, eventLogTrapLevel=eventLogTrapLevel, physicalDiskTable=physicalDiskTable, poolType=poolType, powerStatus=powerStatus, eventLogIndex=eventLogIndex, tempStatus=tempStatus, physDiskSlot=physDiskSlot, physicalDiskEntry=physicalDiskEntry, fanEntry=fanEntry, tempEntry=tempEntry, physDiskIndex=physDiskIndex, eventLogDescr=eventLogDescr, poolNumDisks=poolNumDisks, powerNumber=powerNumber, eventLogEntry=eventLogEntry, DisplayString=DisplayString, physDiskEnc=physDiskEnc, fanNumber=fanNumber, physDiskState=physDiskState, fanTable=fanTable, fanIndex=fanIndex, tempNumber=tempNumber, poolTable=poolTable, datadirect=datadirect, powerEntry=powerEntry, fanEncPos=fanEncPos, physDiskId=physDiskId, tempIndex=tempIndex, powerTable=powerTable, tempTable=tempTable, unit=unit, powerEncId=powerEncId, eventLogLevel=eventLogLevel, fanStatus=fanStatus, powerEncPos=powerEncPos, eventLogTable=eventLogTable, poolEntry=poolEntry, poolIndex=poolIndex, eventLogNumEntries=eventLogNumEntries, powerIndex=powerIndex, systemName=systemName, poolId=poolId)
