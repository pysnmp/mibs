...
# Produced by pysmi-1.1.3 at Sun Nov 21 00:45:18 2021
...
enterprises, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, iso, MibIdentifier, Integer32, ObjectIdentity, Counter64, NotificationType, IpAddress, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "iso", "MibIdentifier", "Integer32", "ObjectIdentity", "Counter64", "NotificationType", "IpAddress", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("SFA-INFO", fanEntry=fanEntry, physDiskId=physDiskId, powerEncPos=powerEncPos, poolIndex=poolIndex, physDiskWWN=physDiskWWN, unit=unit, physDiskSlot=physDiskSlot, fanNumber=fanNumber, eventLogTrapLevel=eventLogTrapLevel, fanEncPos=fanEncPos, tempEntry=tempEntry, poolTable=poolTable, powerEncId=powerEncId, powerIndex=powerIndex, poolNumber=poolNumber, datadirect=datadirect, tempEncId=tempEncId, eventLogTable=eventLogTable, eventLogLevel=eventLogLevel, eventLogDescr=eventLogDescr, systemName=systemName, fanEncId=fanEncId, poolEntry=poolEntry, eventLogIndex=eventLogIndex, poolId=poolId, powerTable=powerTable, fanStatus=fanStatus, tempIndex=tempIndex, eventLogEntry=eventLogEntry, physicalDiskTable=physicalDiskTable, fanIndex=fanIndex, powerStatus=powerStatus, tempStatus=tempStatus, fanTable=fanTable, tempTable=tempTable, physDiskState=physDiskState, physDiskIndex=physDiskIndex, poolType=poolType, physicalDiskEntry=physicalDiskEntry, physDiskPoolId=physDiskPoolId, eventLogNumEntries=eventLogNumEntries, tempNumber=tempNumber, powerNumber=powerNumber, DisplayString=DisplayString, powerEntry=powerEntry, physDiskEnc=physDiskEnc, eventLog=eventLog, tempEncPos=tempEncPos, poolNumDisks=poolNumDisks)
