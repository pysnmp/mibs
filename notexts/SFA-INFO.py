...
mibBuilder.exportSymbols("SFA-INFO", poolNumDisks=poolNumDisks, tempIndex=tempIndex, physDiskPoolId=physDiskPoolId, eventLogEntry=eventLogEntry, eventLogLevel=eventLogLevel, powerEntry=powerEntry, tempTable=tempTable, fanStatus=fanStatus, eventLogTable=eventLogTable, physDiskEnc=physDiskEnc, powerEncPos=powerEncPos, fanEncId=fanEncId, eventLogDescr=eventLogDescr, unit=unit, poolNumber=poolNumber, powerEncId=powerEncId, powerTable=powerTable, physDiskSlot=physDiskSlot, datadirect=datadirect, eventLogTrapLevel=eventLogTrapLevel, fanEncPos=fanEncPos, poolIndex=poolIndex, fanIndex=fanIndex, powerIndex=powerIndex, poolTable=poolTable, poolEntry=poolEntry, eventLogIndex=eventLogIndex, powerStatus=powerStatus, physicalDiskEntry=physicalDiskEntry, fanTable=fanTable, fanEntry=fanEntry, poolType=poolType, physDiskId=physDiskId, tempEntry=tempEntry, systemName=systemName, tempEncPos=tempEncPos, tempNumber=tempNumber, tempEncId=tempEncId, physDiskIndex=physDiskIndex, powerNumber=powerNumber, eventLog=eventLog, physicalDiskTable=physicalDiskTable, tempStatus=tempStatus, eventLogNumEntries=eventLogNumEntries, poolId=poolId, physDiskState=physDiskState, DisplayString=DisplayString, physDiskWWN=physDiskWWN, fanNumber=fanNumber)
