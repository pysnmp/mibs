...
# Produced by pysmi-1.1.8 at Wed Sep 13 14:25:28 2023
...
Bits, iso, enterprises, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, Counter32, Integer32, Counter64, Gauge32, ModuleIdentity, ObjectIdentity, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "enterprises", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "Counter32", "Integer32", "Counter64", "Gauge32", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("SFA-INFO", powerEntry=powerEntry, eventLogNumEntries=eventLogNumEntries, physicalDiskEntry=physicalDiskEntry, eventLogTable=eventLogTable, physDiskEnc=physDiskEnc, physDiskPoolId=physDiskPoolId, eventLog=eventLog, fanEncId=fanEncId, DisplayString=DisplayString, systemName=systemName, physDiskSlot=physDiskSlot, powerStatus=powerStatus, unit=unit, eventLogLevel=eventLogLevel, poolTable=poolTable, fanIndex=fanIndex, tempTable=tempTable, tempEntry=tempEntry, powerTable=powerTable, poolNumDisks=poolNumDisks, fanTable=fanTable, poolId=poolId, tempEncId=tempEncId, poolNumber=poolNumber, physDiskIndex=physDiskIndex, tempIndex=tempIndex, tempStatus=tempStatus, powerEncPos=powerEncPos, physDiskState=physDiskState, fanNumber=fanNumber, powerIndex=powerIndex, poolType=poolType, eventLogDescr=eventLogDescr, tempNumber=tempNumber, powerEncId=powerEncId, tempEncPos=tempEncPos, physicalDiskTable=physicalDiskTable, fanStatus=fanStatus, physDiskId=physDiskId, fanEncPos=fanEncPos, eventLogTrapLevel=eventLogTrapLevel, physDiskWWN=physDiskWWN, eventLogIndex=eventLogIndex, poolEntry=poolEntry, powerNumber=powerNumber, eventLogEntry=eventLogEntry, poolIndex=poolIndex, datadirect=datadirect, fanEntry=fanEntry)
