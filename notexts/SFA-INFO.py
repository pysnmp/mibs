...
# Produced by pysmi-1.1.12 at Wed Jul  3 09:09:57 2024
...
TimeTicks, ModuleIdentity, enterprises, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, MibIdentifier, iso, Counter32, Gauge32, Integer32, Unsigned32, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "enterprises", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "MibIdentifier", "iso", "Counter32", "Gauge32", "Integer32", "Unsigned32", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("SFA-INFO", poolTable=poolTable, physDiskId=physDiskId, tempNumber=tempNumber, eventLog=eventLog, powerNumber=powerNumber, tempEncPos=tempEncPos, DisplayString=DisplayString, eventLogTable=eventLogTable, tempTable=tempTable, datadirect=datadirect, tempEntry=tempEntry, fanEncPos=fanEncPos, unit=unit, eventLogLevel=eventLogLevel, poolType=poolType, tempEncId=tempEncId, physicalDiskEntry=physicalDiskEntry, powerEntry=powerEntry, physDiskWWN=physDiskWWN, poolNumDisks=poolNumDisks, systemName=systemName, fanStatus=fanStatus, powerTable=powerTable, physDiskState=physDiskState, powerEncId=powerEncId, fanIndex=fanIndex, eventLogTrapLevel=eventLogTrapLevel, physDiskSlot=physDiskSlot, tempIndex=tempIndex, eventLogIndex=eventLogIndex, fanNumber=fanNumber, poolNumber=poolNumber, powerIndex=powerIndex, physicalDiskTable=physicalDiskTable, eventLogEntry=eventLogEntry, physDiskEnc=physDiskEnc, eventLogNumEntries=eventLogNumEntries, powerStatus=powerStatus, physDiskPoolId=physDiskPoolId, powerEncPos=powerEncPos, poolIndex=poolIndex, fanEntry=fanEntry, poolEntry=poolEntry, physDiskIndex=physDiskIndex, fanTable=fanTable, poolId=poolId, fanEncId=fanEncId, eventLogDescr=eventLogDescr, tempStatus=tempStatus)
