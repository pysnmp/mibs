...
# Produced by pysmi-1.1.8 at Thu Feb  9 13:20:41 2023
...
Counter64, MibIdentifier, iso, Bits, Integer32, ObjectIdentity, Counter32, NotificationType, enterprises, ModuleIdentity, Unsigned32, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibIdentifier", "iso", "Bits", "Integer32", "ObjectIdentity", "Counter32", "NotificationType", "enterprises", "ModuleIdentity", "Unsigned32", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("SFA-INFO", fanNumber=fanNumber, eventLogTrapLevel=eventLogTrapLevel, poolEntry=poolEntry, poolType=poolType, systemName=systemName, eventLogLevel=eventLogLevel, eventLogNumEntries=eventLogNumEntries, eventLogDescr=eventLogDescr, fanEntry=fanEntry, physDiskEnc=physDiskEnc, datadirect=datadirect, powerEncId=powerEncId, tempTable=tempTable, fanIndex=fanIndex, tempEntry=tempEntry, physDiskWWN=physDiskWWN, powerTable=powerTable, physDiskState=physDiskState, unit=unit, powerStatus=powerStatus, physicalDiskTable=physicalDiskTable, eventLogTable=eventLogTable, eventLog=eventLog, poolIndex=poolIndex, eventLogIndex=eventLogIndex, poolNumber=poolNumber, poolNumDisks=poolNumDisks, fanEncId=fanEncId, physicalDiskEntry=physicalDiskEntry, physDiskIndex=physDiskIndex, powerEntry=powerEntry, physDiskId=physDiskId, physDiskSlot=physDiskSlot, eventLogEntry=eventLogEntry, poolTable=poolTable, tempNumber=tempNumber, fanStatus=fanStatus, tempEncPos=tempEncPos, DisplayString=DisplayString, powerEncPos=powerEncPos, powerNumber=powerNumber, poolId=poolId, physDiskPoolId=physDiskPoolId, fanEncPos=fanEncPos, tempIndex=tempIndex, fanTable=fanTable, powerIndex=powerIndex, tempEncId=tempEncId, tempStatus=tempStatus)
