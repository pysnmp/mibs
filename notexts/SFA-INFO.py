...
# Produced by pysmi-1.1.8 at Mon Jan  9 13:35:09 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, IpAddress, NotificationType, MibIdentifier, iso, Gauge32, enterprises, Counter32, ModuleIdentity, Integer32, ObjectIdentity, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "IpAddress", "NotificationType", "MibIdentifier", "iso", "Gauge32", "enterprises", "Counter32", "ModuleIdentity", "Integer32", "ObjectIdentity", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("SFA-INFO", powerEntry=powerEntry, tempIndex=tempIndex, powerStatus=powerStatus, eventLogEntry=eventLogEntry, poolIndex=poolIndex, fanEncId=fanEncId, poolEntry=poolEntry, eventLogNumEntries=eventLogNumEntries, physDiskPoolId=physDiskPoolId, fanIndex=fanIndex, fanEncPos=fanEncPos, fanEntry=fanEntry, systemName=systemName, tempEntry=tempEntry, fanNumber=fanNumber, tempEncId=tempEncId, poolNumDisks=poolNumDisks, powerTable=powerTable, tempTable=tempTable, powerNumber=powerNumber, datadirect=datadirect, physicalDiskTable=physicalDiskTable, powerIndex=powerIndex, eventLogTable=eventLogTable, eventLog=eventLog, physDiskEnc=physDiskEnc, eventLogLevel=eventLogLevel, physDiskWWN=physDiskWWN, physicalDiskEntry=physicalDiskEntry, physDiskIndex=physDiskIndex, fanStatus=fanStatus, eventLogIndex=eventLogIndex, eventLogTrapLevel=eventLogTrapLevel, poolNumber=poolNumber, tempEncPos=tempEncPos, DisplayString=DisplayString, fanTable=fanTable, poolType=poolType, physDiskSlot=physDiskSlot, tempStatus=tempStatus, poolTable=poolTable, physDiskState=physDiskState, poolId=poolId, eventLogDescr=eventLogDescr, physDiskId=physDiskId, unit=unit, powerEncPos=powerEncPos, powerEncId=powerEncId, tempNumber=tempNumber)
