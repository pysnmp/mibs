...
# Produced by pysmi-1.1.10 at Fri Nov 10 09:18:37 2023
...
NotificationType, IpAddress, enterprises, ObjectIdentity, Unsigned32, TimeTicks, Counter32, Gauge32, Bits, MibIdentifier, iso, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "enterprises", "ObjectIdentity", "Unsigned32", "TimeTicks", "Counter32", "Gauge32", "Bits", "MibIdentifier", "iso", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("SFA-INFO", eventLogIndex=eventLogIndex, eventLog=eventLog, poolTable=poolTable, tempIndex=tempIndex, tempEncId=tempEncId, powerStatus=powerStatus, datadirect=datadirect, poolType=poolType, eventLogEntry=eventLogEntry, eventLogDescr=eventLogDescr, fanEncPos=fanEncPos, physicalDiskTable=physicalDiskTable, fanEntry=fanEntry, powerIndex=powerIndex, powerTable=powerTable, powerEncId=powerEncId, physDiskEnc=physDiskEnc, tempEncPos=tempEncPos, poolNumber=poolNumber, fanNumber=fanNumber, fanIndex=fanIndex, physDiskState=physDiskState, tempTable=tempTable, physDiskPoolId=physDiskPoolId, systemName=systemName, eventLogTable=eventLogTable, tempEntry=tempEntry, poolId=poolId, poolIndex=poolIndex, eventLogLevel=eventLogLevel, eventLogTrapLevel=eventLogTrapLevel, physDiskSlot=physDiskSlot, physDiskId=physDiskId, eventLogNumEntries=eventLogNumEntries, physDiskWWN=physDiskWWN, tempNumber=tempNumber, unit=unit, poolEntry=poolEntry, DisplayString=DisplayString, tempStatus=tempStatus, physDiskIndex=physDiskIndex, powerNumber=powerNumber, fanStatus=fanStatus, powerEncPos=powerEncPos, powerEntry=powerEntry, fanTable=fanTable, physicalDiskEntry=physicalDiskEntry, poolNumDisks=poolNumDisks, fanEncId=fanEncId)
