...
# Produced by pysmi-1.1.12 at Tue Dec  3 11:38:46 2024
...
Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, ObjectIdentity, IpAddress, enterprises, Unsigned32, Bits, Counter64, Counter32, iso, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "ObjectIdentity", "IpAddress", "enterprises", "Unsigned32", "Bits", "Counter64", "Counter32", "iso", "TimeTicks", "MibIdentifier")
...
mibBuilder.exportSymbols("SFA-INFO", poolEntry=poolEntry, physDiskEnc=physDiskEnc, unit=unit, eventLogNumEntries=eventLogNumEntries, fanIndex=fanIndex, poolIndex=poolIndex, physicalDiskTable=physicalDiskTable, poolNumber=poolNumber, tempEncId=tempEncId, powerIndex=powerIndex, powerStatus=powerStatus, fanEntry=fanEntry, physDiskPoolId=physDiskPoolId, eventLogTrapLevel=eventLogTrapLevel, poolType=poolType, eventLogDescr=eventLogDescr, fanNumber=fanNumber, physDiskWWN=physDiskWWN, tempIndex=tempIndex, tempEntry=tempEntry, eventLogEntry=eventLogEntry, eventLogLevel=eventLogLevel, powerTable=powerTable, physDiskId=physDiskId, tempTable=tempTable, physicalDiskEntry=physicalDiskEntry, fanStatus=fanStatus, poolId=poolId, powerEntry=powerEntry, physDiskState=physDiskState, poolTable=poolTable, physDiskIndex=physDiskIndex, tempNumber=tempNumber, eventLog=eventLog, fanTable=fanTable, fanEncId=fanEncId, powerNumber=powerNumber, powerEncPos=powerEncPos, datadirect=datadirect, physDiskSlot=physDiskSlot, DisplayString=DisplayString, fanEncPos=fanEncPos, powerEncId=powerEncId, tempEncPos=tempEncPos, eventLogTable=eventLogTable, systemName=systemName, eventLogIndex=eventLogIndex, poolNumDisks=poolNumDisks, tempStatus=tempStatus)
