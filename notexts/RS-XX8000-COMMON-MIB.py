...
mibBuilder.exportSymbols("RS-XX8000-COMMON-MIB", LogbookEntryMessagesExcDVB=LogbookEntryMessagesExcDVB, LogbookEntryMessagesNSU=LogbookEntryMessagesNSU, ntpLastSync=ntpLastSync, LogbookEntrySlope=LogbookEntrySlope, eventAlarmClass=eventAlarmClass, versionNumberSW=versionNumberSW, ntpSyncTimeInterval=ntpSyncTimeInterval, swUpdateStarted=swUpdateStarted, eventAlarmPriority=eventAlarmPriority, rsTrapsAllOn=rsTrapsAllOn, IndexAmplifier=IndexAmplifier, productInformation=productInformation, trapSinkUse=trapSinkUse, trapSinkInformTimeout=trapSinkInformTimeout, eventTxPriority=eventTxPriority, indexTransmitter=indexTransmitter, ReadableString=ReadableString, trapSinkInformRetry=trapSinkInformRetry, groupTransmitterConfig=groupTransmitterConfig, transmitterConfig=transmitterConfig, eventTxNameIdx=eventTxNameIdx, ntpServerAddress=ntpServerAddress, counterEvents=counterEvents, irtTrapsAllOff=irtTrapsAllOff, groupEventTest=groupEventTest, LockState=LockState, FailDelayStatus=FailDelayStatus, indexRack=indexRack, rsTrapsAllOff=rsTrapsAllOff, EventState=EventState, swUpdate=swUpdate, sendTestTrap=sendTestTrap, swUpdateDeviceName=swUpdateDeviceName, LogbookMaxEntryNumber=LogbookMaxEntryNumber, eventHistoryEvent=eventHistoryEvent, trapSinkAddress=trapSinkAddress, groupProductInformation=groupProductInformation, groupObsoletedObjects=groupObsoletedObjects, EventClass=EventClass, TvStandard=TvStandard, swMaintenance=swMaintenance, rsTrapsAllWarningsOn=rsTrapsAllWarningsOn, eventHistoryNumber=eventHistoryNumber, Sx801AmplifierState=Sx801AmplifierState, snmpConfig=snmpConfig, FloatingPoint=FloatingPoint, groupNTP=groupNTP, rsXx8000=rsXx8000, EventMaxEntryNumber=EventMaxEntryNumber, ntpServerAddrIdx=ntpServerAddrIdx, EventMask=EventMask, AtvStandard=AtvStandard, FailDelayMode=FailDelayMode, LogbookEntryMessagesOST=LogbookEntryMessagesOST, rsXx8000Common=rsXx8000Common, LogbookEntryMessagesExcATV=LogbookEntryMessagesExcATV, restart=restart, eventMapObjects=eventMapObjects, IndexAB=IndexAB, rsXx8000CommonObjs=rsXx8000CommonObjs, groupEventHistory=groupEventHistory, PYSNMP_MODULE_ID=rsXx8000MibModule, rsXx8000CommonConf=rsXx8000CommonConf, ProdInfoModuleNameNsu=ProdInfoModuleNameNsu, eventHistory=eventHistory, eventEvent=eventEvent, IndexRack=IndexRack, eventHistoryTx=eventHistoryTx, LogbookEntryMessagesXV703=LogbookEntryMessagesXV703, ntpServerAddrTable=ntpServerAddrTable, ntp=ntp, trapSinkEntry=trapSinkEntry, LogbookEntryMessagesExcFM=LogbookEntryMessagesExcFM, groupSwMaintenance=groupSwMaintenance, rsXx8000EventsV2=rsXx8000EventsV2, eventTx=eventTx, trapSinkInformUnacknowledged=trapSinkInformUnacknowledged, ntpState=ntpState, LogbookEntryMessagesExcTv=LogbookEntryMessagesExcTv, trapSinkTable=trapSinkTable, rsXx8000CommonEvents=rsXx8000CommonEvents, Trigger=Trigger, rsTrapsAllFaultsOff=rsTrapsAllFaultsOff, serialNumber=serialNumber, rsTrapsAllFaultsOn=rsTrapsAllFaultsOn, eventHistoryEventDate=eventHistoryEventDate, ProdInfoModuleNameFm=ProdInfoModuleNameFm, indexAmplifier=indexAmplifier, xx8000BasicCompliance=xx8000BasicCompliance, TimeOfDay=TimeOfDay, swUpdateMode=swUpdateMode, trapSinkNumber=trapSinkNumber, EventPriority=EventPriority, rsXx8000MibModule=rsXx8000MibModule, IndexProgram=IndexProgram, InputSource=InputSource, eventTxName=eventTxName, groupNotifyTest=groupNotifyTest, eventHistoryModule=eventHistoryModule, ntpServerAddrEntry=ntpServerAddrEntry, rsXx8000CommonGroups=rsXx8000CommonGroups, testTrap=testTrap, ntpMode=ntpMode, eventHistoryEntry=eventHistoryEntry, rsXx8000CommonCompls=rsXx8000CommonCompls, SwitchOnOff=SwitchOnOff, groupNotifyNTP=groupNotifyNTP, LogbookEntryMessagesNetCCU=LogbookEntryMessagesNetCCU, groupSnmpConfig=groupSnmpConfig, swUpdateDeviceGroup=swUpdateDeviceGroup, eventsTxV2=eventsTxV2, indexAB=indexAB, versionNumberHW=versionNumberHW, irtTrapsAllOn=irtTrapsAllOn, rsTrapsAllWarningsOff=rsTrapsAllWarningsOff, dateTime=dateTime, eventsTxTable=eventsTxTable, eventsTxEntry=eventsTxEntry, eventTxMask=eventTxMask, ntpSyncFailed=ntpSyncFailed, groupNotify=groupNotify, ProdInfoModuleNameTv=ProdInfoModuleNameTv, identNumberHW=identNumberHW, IndexTransmitter=IndexTransmitter, trapSinkCommunity=trapSinkCommunity, eventHistoryTable=eventHistoryTable, indexProgram=indexProgram, eventTxEvent=eventTxEvent, eventHistoryEventState=eventHistoryEventState, trapSinkPort=trapSinkPort, identNumberSW=identNumberSW, trapSinkVersion=trapSinkVersion, EqualizerCalibrationState=EqualizerCalibrationState, groupEventObjects=groupEventObjects, swUpdateStart=swUpdateStart)
