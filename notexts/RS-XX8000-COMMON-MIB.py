...
mibBuilder.exportSymbols("RS-XX8000-COMMON-MIB", EventMaxEntryNumber=EventMaxEntryNumber, eventHistoryNumber=eventHistoryNumber, LogbookEntryMessagesExcFM=LogbookEntryMessagesExcFM, rsXx8000Common=rsXx8000Common, Trigger=Trigger, TimeOfDay=TimeOfDay, groupProductInformation=groupProductInformation, eventEvent=eventEvent, indexProgram=indexProgram, ntpServerAddress=ntpServerAddress, groupNTP=groupNTP, trapSinkVersion=trapSinkVersion, xx8000BasicCompliance=xx8000BasicCompliance, versionNumberSW=versionNumberSW, groupTransmitterConfig=groupTransmitterConfig, ProdInfoModuleNameFm=ProdInfoModuleNameFm, restart=restart, IndexAmplifier=IndexAmplifier, rsTrapsAllOn=rsTrapsAllOn, dateTime=dateTime, LogbookMaxEntryNumber=LogbookMaxEntryNumber, groupNotify=groupNotify, ntpMode=ntpMode, rsTrapsAllOff=rsTrapsAllOff, IndexTransmitter=IndexTransmitter, indexAB=indexAB, LogbookEntrySlope=LogbookEntrySlope, serialNumber=serialNumber, eventHistoryEventState=eventHistoryEventState, swMaintenance=swMaintenance, IndexRack=IndexRack, rsTrapsAllWarningsOff=rsTrapsAllWarningsOff, ntpServerAddrIdx=ntpServerAddrIdx, LogbookEntryMessagesNSU=LogbookEntryMessagesNSU, irtTrapsAllOff=irtTrapsAllOff, rsXx8000EventsV2=rsXx8000EventsV2, identNumberSW=identNumberSW, IndexAB=IndexAB, EventMask=EventMask, ProdInfoModuleNameNsu=ProdInfoModuleNameNsu, EventState=EventState, swUpdateDeviceGroup=swUpdateDeviceGroup, FailDelayMode=FailDelayMode, trapSinkUse=trapSinkUse, trapSinkAddress=trapSinkAddress, LogbookEntryMessagesExcDVB=LogbookEntryMessagesExcDVB, indexRack=indexRack, eventsTxTable=eventsTxTable, groupNotifyTest=groupNotifyTest, rsTrapsAllFaultsOff=rsTrapsAllFaultsOff, eventTxNameIdx=eventTxNameIdx, rsXx8000CommonEvents=rsXx8000CommonEvents, indexAmplifier=indexAmplifier, eventHistory=eventHistory, eventsTxEntry=eventsTxEntry, eventHistoryEntry=eventHistoryEntry, groupEventObjects=groupEventObjects, rsXx8000MibModule=rsXx8000MibModule, ntpState=ntpState, sendTestTrap=sendTestTrap, rsXx8000CommonGroups=rsXx8000CommonGroups, eventHistoryModule=eventHistoryModule, groupSwMaintenance=groupSwMaintenance, ntpServerAddrEntry=ntpServerAddrEntry, ntpSyncFailed=ntpSyncFailed, groupNotifyNTP=groupNotifyNTP, PYSNMP_MODULE_ID=rsXx8000MibModule, trapSinkInformUnacknowledged=trapSinkInformUnacknowledged, ReadableString=ReadableString, LogbookEntryMessagesXV703=LogbookEntryMessagesXV703, irtTrapsAllOn=irtTrapsAllOn, ntpSyncTimeInterval=ntpSyncTimeInterval, transmitterConfig=transmitterConfig, LogbookEntryMessagesOST=LogbookEntryMessagesOST, ntp=ntp, eventTxPriority=eventTxPriority, LogbookEntryMessagesNetCCU=LogbookEntryMessagesNetCCU, LockState=LockState, eventTxName=eventTxName, versionNumberHW=versionNumberHW, eventHistoryTx=eventHistoryTx, LogbookEntryMessagesExcATV=LogbookEntryMessagesExcATV, trapSinkNumber=trapSinkNumber, FloatingPoint=FloatingPoint, rsXx8000CommonObjs=rsXx8000CommonObjs, snmpConfig=snmpConfig, trapSinkEntry=trapSinkEntry, eventHistoryEventDate=eventHistoryEventDate, InputSource=InputSource, eventTxMask=eventTxMask, testTrap=testTrap, ntpServerAddrTable=ntpServerAddrTable, indexTransmitter=indexTransmitter, identNumberHW=identNumberHW, groupEventHistory=groupEventHistory, TvStandard=TvStandard, ntpLastSync=ntpLastSync, EventClass=EventClass, groupEventTest=groupEventTest, Sx801AmplifierState=Sx801AmplifierState, swUpdateStarted=swUpdateStarted, EqualizerCalibrationState=EqualizerCalibrationState, trapSinkPort=trapSinkPort, rsXx8000=rsXx8000, productInformation=productInformation, trapSinkInformRetry=trapSinkInformRetry, SwitchOnOff=SwitchOnOff, eventAlarmClass=eventAlarmClass, rsTrapsAllWarningsOn=rsTrapsAllWarningsOn, eventTx=eventTx, rsXx8000CommonCompls=rsXx8000CommonCompls, EventPriority=EventPriority, eventMapObjects=eventMapObjects, LogbookEntryMessagesExcTv=LogbookEntryMessagesExcTv, ProdInfoModuleNameTv=ProdInfoModuleNameTv, eventHistoryEvent=eventHistoryEvent, swUpdateMode=swUpdateMode, eventAlarmPriority=eventAlarmPriority, IndexProgram=IndexProgram, swUpdateStart=swUpdateStart, AtvStandard=AtvStandard, groupObsoletedObjects=groupObsoletedObjects, trapSinkTable=trapSinkTable, rsXx8000CommonConf=rsXx8000CommonConf, trapSinkCommunity=trapSinkCommunity, groupSnmpConfig=groupSnmpConfig, eventsTxV2=eventsTxV2, trapSinkInformTimeout=trapSinkInformTimeout, eventHistoryTable=eventHistoryTable, eventTxEvent=eventTxEvent, swUpdateDeviceName=swUpdateDeviceName, swUpdate=swUpdate, counterEvents=counterEvents, FailDelayStatus=FailDelayStatus, rsTrapsAllFaultsOn=rsTrapsAllFaultsOn)
