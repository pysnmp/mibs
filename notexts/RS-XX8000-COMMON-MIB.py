...
mibBuilder.exportSymbols("RS-XX8000-COMMON-MIB", LogbookEntryMessagesNetCCU=LogbookEntryMessagesNetCCU, trapSinkPort=trapSinkPort, LogbookEntryMessagesExcDVB=LogbookEntryMessagesExcDVB, eventTxPriority=eventTxPriority, LogbookEntryMessagesOST=LogbookEntryMessagesOST, ntpSyncFailed=ntpSyncFailed, transmitterConfig=transmitterConfig, rsXx8000CommonCompls=rsXx8000CommonCompls, trapSinkAddress=trapSinkAddress, trapSinkCommunity=trapSinkCommunity, versionNumberSW=versionNumberSW, eventTxMask=eventTxMask, groupTransmitterConfig=groupTransmitterConfig, trapSinkUse=trapSinkUse, eventTxName=eventTxName, LogbookMaxEntryNumber=LogbookMaxEntryNumber, eventTxEvent=eventTxEvent, rsXx8000=rsXx8000, IndexRack=IndexRack, counterEvents=counterEvents, eventMapObjects=eventMapObjects, eventHistoryEntry=eventHistoryEntry, IndexAB=IndexAB, eventTx=eventTx, LogbookEntryMessagesExcATV=LogbookEntryMessagesExcATV, sendTestTrap=sendTestTrap, restart=restart, EventClass=EventClass, ntpServerAddrIdx=ntpServerAddrIdx, ntpServerAddress=ntpServerAddress, eventEvent=eventEvent, IndexAmplifier=IndexAmplifier, ntp=ntp, groupNotifyNTP=groupNotifyNTP, trapSinkEntry=trapSinkEntry, indexTransmitter=indexTransmitter, groupObsoletedObjects=groupObsoletedObjects, swMaintenance=swMaintenance, EventPriority=EventPriority, TvStandard=TvStandard, rsTrapsAllOff=rsTrapsAllOff, rsTrapsAllFaultsOn=rsTrapsAllFaultsOn, rsXx8000CommonObjs=rsXx8000CommonObjs, irtTrapsAllOn=irtTrapsAllOn, eventHistoryTx=eventHistoryTx, trapSinkInformUnacknowledged=trapSinkInformUnacknowledged, FailDelayStatus=FailDelayStatus, eventHistoryModule=eventHistoryModule, ProdInfoModuleNameTv=ProdInfoModuleNameTv, ntpMode=ntpMode, irtTrapsAllOff=irtTrapsAllOff, trapSinkInformRetry=trapSinkInformRetry, groupEventTest=groupEventTest, ntpLastSync=ntpLastSync, rsTrapsAllWarningsOn=rsTrapsAllWarningsOn, ntpServerAddrEntry=ntpServerAddrEntry, EventMask=EventMask, AtvStandard=AtvStandard, groupProductInformation=groupProductInformation, FailDelayMode=FailDelayMode, ReadableString=ReadableString, LockState=LockState, dateTime=dateTime, ProdInfoModuleNameFm=ProdInfoModuleNameFm, InputSource=InputSource, productInformation=productInformation, groupSnmpConfig=groupSnmpConfig, rsXx8000EventsV2=rsXx8000EventsV2, EventMaxEntryNumber=EventMaxEntryNumber, eventsTxV2=eventsTxV2, eventHistoryNumber=eventHistoryNumber, ProdInfoModuleNameNsu=ProdInfoModuleNameNsu, eventsTxEntry=eventsTxEntry, xx8000BasicCompliance=xx8000BasicCompliance, rsXx8000Common=rsXx8000Common, Sx801AmplifierState=Sx801AmplifierState, LogbookEntryMessagesExcTv=LogbookEntryMessagesExcTv, IndexTransmitter=IndexTransmitter, versionNumberHW=versionNumberHW, trapSinkVersion=trapSinkVersion, swUpdateMode=swUpdateMode, groupEventObjects=groupEventObjects, eventAlarmPriority=eventAlarmPriority, IndexProgram=IndexProgram, swUpdateStarted=swUpdateStarted, LogbookEntryMessagesExcFM=LogbookEntryMessagesExcFM, indexRack=indexRack, LogbookEntryMessagesXV703=LogbookEntryMessagesXV703, groupSwMaintenance=groupSwMaintenance, LogbookEntrySlope=LogbookEntrySlope, eventHistory=eventHistory, eventHistoryTable=eventHistoryTable, eventHistoryEvent=eventHistoryEvent, identNumberHW=identNumberHW, groupNotify=groupNotify, ntpServerAddrTable=ntpServerAddrTable, swUpdateDeviceGroup=swUpdateDeviceGroup, rsXx8000CommonEvents=rsXx8000CommonEvents, rsTrapsAllWarningsOff=rsTrapsAllWarningsOff, groupNotifyTest=groupNotifyTest, ntpState=ntpState, indexAmplifier=indexAmplifier, eventHistoryEventState=eventHistoryEventState, rsTrapsAllOn=rsTrapsAllOn, TimeOfDay=TimeOfDay, EqualizerCalibrationState=EqualizerCalibrationState, swUpdate=swUpdate, serialNumber=serialNumber, eventHistoryEventDate=eventHistoryEventDate, rsTrapsAllFaultsOff=rsTrapsAllFaultsOff, swUpdateStart=swUpdateStart, eventAlarmClass=eventAlarmClass, eventsTxTable=eventsTxTable, PYSNMP_MODULE_ID=rsXx8000MibModule, SwitchOnOff=SwitchOnOff, swUpdateDeviceName=swUpdateDeviceName, eventTxNameIdx=eventTxNameIdx, Trigger=Trigger, EventState=EventState, identNumberSW=identNumberSW, groupNTP=groupNTP, testTrap=testTrap, groupEventHistory=groupEventHistory, FloatingPoint=FloatingPoint, rsXx8000CommonConf=rsXx8000CommonConf, rsXx8000CommonGroups=rsXx8000CommonGroups, LogbookEntryMessagesNSU=LogbookEntryMessagesNSU, rsXx8000MibModule=rsXx8000MibModule, trapSinkNumber=trapSinkNumber, indexAB=indexAB, trapSinkInformTimeout=trapSinkInformTimeout, indexProgram=indexProgram, snmpConfig=snmpConfig, ntpSyncTimeInterval=ntpSyncTimeInterval, trapSinkTable=trapSinkTable)
