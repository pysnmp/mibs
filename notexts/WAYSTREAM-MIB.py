...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsPolicyCookie=wsPolicyCookie, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsPolicyName=wsPolicyName, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsPolicyIfName=wsPolicyIfName, wsNeighbourOSVersion=wsNeighbourOSVersion, wsXFPRXPower=wsXFPRXPower, wsNeighbourUptime=wsNeighbourUptime, wsSFPTXPower=wsSFPTXPower, wsFanEntry=wsFanEntry, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsFanTable=wsFanTable, wsTempTHYST=wsTempTHYST, wsTempStatus=wsTempStatus, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsPolicyInBytes=wsPolicyInBytes, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsTempSensor=wsTempSensor, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPCopperLen=wsSFPCopperLen, wsXFPConnector=wsXFPConnector, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsPolicyUsedCnt=wsPolicyUsedCnt, wsPFDP=wsPFDP, wsSFPPartNumber=wsSFPPartNumber, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourState=wsNeighbourState, wsSFPTable=wsSFPTable, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsXFPTransceiver=wsXFPTransceiver, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPConnector=wsSFPConnector, wsXFPEncoding=wsXFPEncoding, wsSFPTemp=wsSFPTemp, wsNeighbourCreated=wsNeighbourCreated, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPIndex=wsSFPIndex, wsXFPEntry=wsXFPEntry, wsFanRPM=wsFanRPM, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsVersion=wsVersion, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortState=wsNeighbourPortState, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPEntry=wsSFPEntry, wsTempTable=wsTempTable, wsWritedummy=wsWritedummy, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSystem=wsSystem, wsTempMeasured=wsTempMeasured, wsSFPVolt=wsSFPVolt, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsPolicyIfIndex=wsPolicyIfIndex, wsEnvironment=wsEnvironment, wsTempTOS=wsTempTOS, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsVoltChannel=wsVoltChannel, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsXFPTable=wsXFPTable, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsPolicyEntry=wsPolicyEntry, wsFanVoltage=wsFanVoltage, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPTransceiverExt=wsSFPTransceiverExt, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsAccounting=wsAccounting, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsVoltMeasured=wsVoltMeasured, wsTempThresholdLow=wsTempThresholdLow, wsVersionString=wsVersionString, PYSNMP_MODULE_ID=ibos, wsNeighbourIfIndex=wsNeighbourIfIndex, wsXFPTXPower=wsXFPTXPower, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourDBCount=wsNeighbourDBCount, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourSNPA=wsNeighbourSNPA, wsIbosTempHigh=wsIbosTempHigh, wsSFPTempNormalLow=wsSFPTempNormalLow, wsVoltTable=wsVoltTable, wsSFPRXPower=wsSFPRXPower, wsAsrRevision=wsAsrRevision, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPEncoding=wsSFPEncoding, wsFanNumber=wsFanNumber, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsTempEntry=wsTempEntry, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsReload=wsReload, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, ibos=ibos, wsSFPStatus=wsSFPStatus, wsSFPTempStatus=wsSFPTempStatus, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsVoltNominal=wsVoltNominal, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsPolicyInDrops=wsPolicyInDrops, wsIbosVoltHigh=wsIbosVoltHigh, wsPolicyTable=wsPolicyTable, wsXFPStatus=wsXFPStatus, wsNeighboursTable=wsNeighboursTable, wsSFPBitrate=wsSFPBitrate, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsVoltStatus=wsVoltStatus, wsPolicyInPkts=wsPolicyInPkts, wsXFPTempStatus=wsXFPTempStatus, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsXFPTemp=wsXFPTemp, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsXFPIndex=wsXFPIndex, wsIbosFanRPMLow=wsIbosFanRPMLow, wsVoltEntry=wsVoltEntry, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPBitrateMin=wsXFPBitrateMin, wsXFPCopperLen=wsXFPCopperLen)
