...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPVolt=wsSFPVolt, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, PYSNMP_MODULE_ID=ibos, wsSFPTable=wsSFPTable, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPConnector=wsXFPConnector, wsPFDP=wsPFDP, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPIndex=wsSFPIndex, wsXFPEntry=wsXFPEntry, wsVoltTable=wsVoltTable, wsVoltChannel=wsVoltChannel, wsFanNumber=wsFanNumber, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighboursTable=wsNeighboursTable, wsPolicyTable=wsPolicyTable, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, ibos=ibos, wsPolicyCookie=wsPolicyCookie, wsIbosTempLow=wsIbosTempLow, wsSFPStatus=wsSFPStatus, wsVoltNominal=wsVoltNominal, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPSingleModeLen=wsSFPSingleModeLen, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSystem=wsSystem, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsPolicyEntry=wsPolicyEntry, wsFanEntry=wsFanEntry, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPPartNumber=wsSFPPartNumber, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPTemp=wsSFPTemp, wsTempSensor=wsTempSensor, wsTempTHYST=wsTempTHYST, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsTempMeasured=wsTempMeasured, wsSFPBitrate=wsSFPBitrate, wsAccounting=wsAccounting, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsAsrRevision=wsAsrRevision, wsNeighbourDBCount=wsNeighbourDBCount, wsPolicyIfName=wsPolicyIfName, wsNeighbourHostname=wsNeighbourHostname, wsXFPTransceiver=wsXFPTransceiver, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsEnvironment=wsEnvironment, wsVoltStatus=wsVoltStatus, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPRXPower=wsSFPRXPower, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsXFPTXPower=wsXFPTXPower, wsSFPConnector=wsSFPConnector, wsPolicyName=wsPolicyName, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPEncoding=wsSFPEncoding, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsTempTOS=wsTempTOS, wsNeighbourIfIndex=wsNeighbourIfIndex, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPEntry=wsSFPEntry, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsTempStatus=wsTempStatus, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPCopperLen=wsSFPCopperLen, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPStatus=wsXFPStatus, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTXPower=wsSFPTXPower, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortState=wsNeighbourPortState, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighboursEntry=wsNeighboursEntry, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPEncoding=wsXFPEncoding, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourCreated=wsNeighbourCreated, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPBitrateMax=wsXFPBitrateMax, wsVersion=wsVersion, wsFanRPM=wsFanRPM, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsVersionString=wsVersionString, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPIndex=wsXFPIndex, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsVoltThresholdHigh=wsVoltThresholdHigh, wsWritedummy=wsWritedummy, wsVoltMeasured=wsVoltMeasured, wsXFPTable=wsXFPTable, wsNeighbourModel=wsNeighbourModel, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPVoltStatus=wsSFPVoltStatus, wsXFPRXPower=wsXFPRXPower, wsTempEntry=wsTempEntry, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsIbosTempHigh=wsIbosTempHigh, wsFanVoltage=wsFanVoltage, wsNeighbourUptime=wsNeighbourUptime, wsXFPTemp=wsXFPTemp, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourState=wsNeighbourState, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsTempTable=wsTempTable, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsFanTable=wsFanTable, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsReload=wsReload, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsTempThresholdLow=wsTempThresholdLow, wsVoltEntry=wsVoltEntry, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPTempWarningLow=wsSFPTempWarningLow)
