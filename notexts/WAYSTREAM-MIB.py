...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsVoltThresholdHigh=wsVoltThresholdHigh, wsIbosFanRPMLow=wsIbosFanRPMLow, wsWritedummy=wsWritedummy, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourState=wsNeighbourState, wsXFPTXPower=wsXFPTXPower, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsPolicyInDrops=wsPolicyInDrops, wsFanVoltage=wsFanVoltage, wsSFPConnector=wsSFPConnector, wsTempSensor=wsTempSensor, wsXFPIndex=wsXFPIndex, wsVersion=wsVersion, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPRXPower=wsSFPRXPower, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighboursTable=wsNeighboursTable, wsXFPTemp=wsXFPTemp, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, PYSNMP_MODULE_ID=ibos, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsTempStatus=wsTempStatus, wsPolicyInPkts=wsPolicyInPkts, wsVoltChannel=wsVoltChannel, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourCreated=wsNeighbourCreated, wsSFPEncoding=wsSFPEncoding, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPPartNumber=wsSFPPartNumber, wsSFPCopperLen=wsSFPCopperLen, wsPolicyTable=wsPolicyTable, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTemp=wsSFPTemp, wsTempMeasured=wsTempMeasured, wsNeighbourHostname=wsNeighbourHostname, wsFanNumber=wsFanNumber, wsPolicyIfName=wsPolicyIfName, wsTempTOS=wsTempTOS, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPBitrate=wsSFPBitrate, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortState=wsNeighbourPortState, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsVoltTable=wsVoltTable, wsIbosVoltLow=wsIbosVoltLow, wsPolicyInBytes=wsPolicyInBytes, wsXFPEntry=wsXFPEntry, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPTempNormalLow=wsSFPTempNormalLow, wsTempTable=wsTempTable, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourNIndex=wsNeighbourNIndex, wsVoltStatus=wsVoltStatus, wsIbosVoltHigh=wsIbosVoltHigh, wsXFPStatus=wsXFPStatus, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTXPower=wsSFPTXPower, wsPolicyName=wsPolicyName, wsVoltEntry=wsVoltEntry, wsIbosTempHigh=wsIbosTempHigh, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPTransceiver=wsSFPTransceiver, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourIfIndex=wsNeighbourIfIndex, wsXFPTable=wsXFPTable, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSystem=wsSystem, wsPolicyCookie=wsPolicyCookie, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsTempTHYST=wsTempTHYST, wsVoltNominal=wsVoltNominal, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsFanEntry=wsFanEntry, wsFanTable=wsFanTable, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsXFPTransceiver=wsXFPTransceiver, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsFanRPM=wsFanRPM, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsAsrRevision=wsAsrRevision, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPIndex=wsSFPIndex, wsXFPCopperLen=wsXFPCopperLen, wsReload=wsReload, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsPFDP=wsPFDP, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPEncoding=wsXFPEncoding, wsXFPConnector=wsXFPConnector, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsEnvironment=wsEnvironment, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsXFPTXCurrent=wsXFPTXCurrent, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsPolicyEntry=wsPolicyEntry, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPEntry=wsSFPEntry, wsSFPTable=wsSFPTable, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsXFPMultiMode50Len=wsXFPMultiMode50Len, ibos=ibos, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPStatus=wsSFPStatus, wsAccounting=wsAccounting, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPVolt=wsSFPVolt, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourUptime=wsNeighbourUptime, wsVersionString=wsVersionString, wsTempEntry=wsTempEntry)
