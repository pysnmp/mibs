...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPSingleModeLen=wsXFPSingleModeLen, wsEnvironment=wsEnvironment, wsPolicyName=wsPolicyName, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPRXdBmPower=wsSFPRXdBmPower, wsXFPEntry=wsXFPEntry, wsSFPTransceiverExt=wsSFPTransceiverExt, wsVersion=wsVersion, wsSFPIndex=wsSFPIndex, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTable=wsSFPTable, wsSFPStatus=wsSFPStatus, wsNeighbourUptime=wsNeighbourUptime, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPEntry=wsSFPEntry, wsNeighbourState=wsNeighbourState, wsXFPIndex=wsXFPIndex, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsVersionString=wsVersionString, wsSFPTempNormalLow=wsSFPTempNormalLow, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsTempTHYST=wsTempTHYST, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPConnector=wsSFPConnector, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortsTable=wsNeighbourPortsTable, wsAsrRevision=wsAsrRevision, wsXFPTransceiver=wsXFPTransceiver, wsXFPTXCurrent=wsXFPTXCurrent, wsSystem=wsSystem, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsVoltMeasured=wsVoltMeasured, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourNIndex=wsNeighbourNIndex, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsAccounting=wsAccounting, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsXFPEncoding=wsXFPEncoding, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsFanVoltage=wsFanVoltage, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsFanTable=wsFanTable, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortName=wsNeighbourPortName, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsPolicyInDrops=wsPolicyInDrops, wsSFPTempStatus=wsSFPTempStatus, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsPolicyEntry=wsPolicyEntry, wsPolicyTable=wsPolicyTable, wsTempTOS=wsTempTOS, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsFanRPM=wsFanRPM, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsPolicyOutPkts=wsPolicyOutPkts, wsTempStatus=wsTempStatus, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourLocalIf=wsNeighbourLocalIf, wsPolicyCookie=wsPolicyCookie, PYSNMP_MODULE_ID=ibos, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTemp=wsSFPTemp, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsFanEntry=wsFanEntry, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourHostname=wsNeighbourHostname, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPCopperLen=wsSFPCopperLen, wsWritedummy=wsWritedummy, wsPolicyIfName=wsPolicyIfName, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsXFPCopperLen=wsXFPCopperLen, wsIbosVoltHigh=wsIbosVoltHigh, wsTempMeasured=wsTempMeasured, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsTempThresholdLow=wsTempThresholdLow, wsSFPTXPower=wsSFPTXPower, wsSFPEncoding=wsSFPEncoding, wsReload=wsReload, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsFanNumber=wsFanNumber, wsTempTable=wsTempTable, wsSFPBitrate=wsSFPBitrate, wsXFPConnector=wsXFPConnector, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPRXPower=wsSFPRXPower, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPStatus=wsXFPStatus, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsVoltNominal=wsVoltNominal, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPPartNumber=wsSFPPartNumber, wsSFPTransceiver=wsSFPTransceiver, wsIbosTempLow=wsIbosTempLow, wsIbosTempHigh=wsIbosTempHigh, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPBitrateMax=wsXFPBitrateMax, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsPolicyInBytes=wsPolicyInBytes, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsXFPTable=wsXFPTable, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsPFDP=wsPFDP, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsVoltTable=wsVoltTable, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsPolicyInPkts=wsPolicyInPkts, wsVoltStatus=wsVoltStatus, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, ibos=ibos, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPTemp=wsXFPTemp, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsTempSensor=wsTempSensor, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsVoltChannel=wsVoltChannel, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPVolt=wsSFPVolt, wsSFPSingleModeLen=wsSFPSingleModeLen, wsVoltEntry=wsVoltEntry, wsXFPTXPower=wsXFPTXPower, wsTempEntry=wsTempEntry, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourModel=wsNeighbourModel)
