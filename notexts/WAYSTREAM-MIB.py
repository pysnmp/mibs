...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsXFPEntry=wsXFPEntry, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPConnector=wsXFPConnector, wsSFPVolt=wsSFPVolt, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsFanEntry=wsFanEntry, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsTempEntry=wsTempEntry, wsNeighbourState=wsNeighbourState, wsPolicyName=wsPolicyName, wsNeighbourCreated=wsNeighbourCreated, wsSystem=wsSystem, wsSFPConnector=wsSFPConnector, wsVersionString=wsVersionString, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPRXdBmPower=wsSFPRXdBmPower, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTemp=wsSFPTemp, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsXFPIndex=wsXFPIndex, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsFanVoltage=wsFanVoltage, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsFanNumber=wsFanNumber, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPEntry=wsSFPEntry, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsPolicyIfName=wsPolicyIfName, wsTempStatus=wsTempStatus, wsXFPTemp=wsXFPTemp, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPEncoding=wsSFPEncoding, wsAccounting=wsAccounting, wsPolicyOutDrops=wsPolicyOutDrops, wsTempTOS=wsTempTOS, wsSFPTransceiver=wsSFPTransceiver, wsVoltNominal=wsVoltNominal, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, PYSNMP_MODULE_ID=ibos, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTable=wsSFPTable, ibos=ibos, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsTempTable=wsTempTable, wsPFDP=wsPFDP, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPVoltStatus=wsSFPVoltStatus, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsTempMeasured=wsTempMeasured, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsTempTHYST=wsTempTHYST, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsReload=wsReload, wsSFPCopperLen=wsSFPCopperLen, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsXFPEncoding=wsXFPEncoding, wsSFPRXPower=wsSFPRXPower, wsXFPRXPower=wsXFPRXPower, wsNeighboursTable=wsNeighboursTable, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsEnvironment=wsEnvironment, wsAsrRevision=wsAsrRevision, wsVoltChannel=wsVoltChannel, wsVoltThresholdHigh=wsVoltThresholdHigh, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsIbosFanRPMLow=wsIbosFanRPMLow, wsIbosTempLow=wsIbosTempLow, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsVoltMeasured=wsVoltMeasured, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsVersion=wsVersion, wsSFPTempStatus=wsSFPTempStatus, wsIbosTempHigh=wsIbosTempHigh, wsXFPTransceiver=wsXFPTransceiver, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsWritedummy=wsWritedummy, wsIbosVoltLow=wsIbosVoltLow, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsVoltEntry=wsVoltEntry, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsPolicyTable=wsPolicyTable, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPIndex=wsSFPIndex, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsVoltStatus=wsVoltStatus, wsNeighbourPortState=wsNeighbourPortState, wsXFPTable=wsXFPTable, wsXFPTXPower=wsXFPTXPower, wsFanRPM=wsFanRPM, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsFanTable=wsFanTable, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPStatus=wsXFPStatus, wsSFPPartNumber=wsSFPPartNumber, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPStatus=wsSFPStatus, wsSFPTXCurrent=wsSFPTXCurrent, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsPolicyInPkts=wsPolicyInPkts, wsTempSensor=wsTempSensor, wsSFPTXPower=wsSFPTXPower, wsPolicyEntry=wsPolicyEntry, wsVoltTable=wsVoltTable)
