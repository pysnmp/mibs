...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighboursEntry=wsNeighboursEntry, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, ibos=ibos, wsSFPPartNumber=wsSFPPartNumber, wsVoltNominal=wsVoltNominal, wsTempSensor=wsTempSensor, wsTempThresholdHigh=wsTempThresholdHigh, wsFanTable=wsFanTable, wsPolicyInDrops=wsPolicyInDrops, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsTempTOS=wsTempTOS, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighboursTable=wsNeighboursTable, wsIbosVoltHigh=wsIbosVoltHigh, wsVersionString=wsVersionString, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPIndex=wsSFPIndex, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourIfIndex=wsNeighbourIfIndex, wsVoltChannel=wsVoltChannel, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsXFPBitrateMax=wsXFPBitrateMax, wsWritedummy=wsWritedummy, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsXFPCopperLen=wsXFPCopperLen, wsSFPTransceiver=wsSFPTransceiver, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsPolicyEntry=wsPolicyEntry, wsVersion=wsVersion, wsXFPTXPower=wsXFPTXPower, wsXFPTempStatus=wsXFPTempStatus, wsIbosVoltLow=wsIbosVoltLow, wsTempEntry=wsTempEntry, wsXFPTemp=wsXFPTemp, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTable=wsSFPTable, wsXFPEntry=wsXFPEntry, wsTempTHYST=wsTempTHYST, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourState=wsNeighbourState, wsVoltMeasured=wsVoltMeasured, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPEncoding=wsSFPEncoding, wsNeighbourModel=wsNeighbourModel, wsXFPTable=wsXFPTable, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsEnvironment=wsEnvironment, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPStatus=wsSFPStatus, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsXFPRXPower=wsXFPRXPower, wsXFPConnector=wsXFPConnector, wsSystem=wsSystem, wsNeighbourNIndex=wsNeighbourNIndex, wsPolicyInPkts=wsPolicyInPkts, wsPolicyInBytes=wsPolicyInBytes, wsSFPConnector=wsSFPConnector, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsPolicyTable=wsPolicyTable, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsVoltStatus=wsVoltStatus, wsXFPEncoding=wsXFPEncoding, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsVoltThresholdHigh=wsVoltThresholdHigh, wsPolicyIfName=wsPolicyIfName, wsTempMeasured=wsTempMeasured, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTemp=wsSFPTemp, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPBitrate=wsSFPBitrate, wsPolicyName=wsPolicyName, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourUptime=wsNeighbourUptime, wsFanVoltage=wsFanVoltage, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTransceiverExt=wsSFPTransceiverExt, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortState=wsNeighbourPortState, wsVoltTable=wsVoltTable, wsTempTable=wsTempTable, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPStatus=wsXFPStatus, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsPolicyCookie=wsPolicyCookie, wsNeighbourCreated=wsNeighbourCreated, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPRXPower=wsSFPRXPower, wsNeighbourDBCount=wsNeighbourDBCount, wsVoltEntry=wsVoltEntry, wsAsrRevision=wsAsrRevision, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPTempNormalLow=wsSFPTempNormalLow, wsAccounting=wsAccounting, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsPFDP=wsPFDP, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPIndex=wsXFPIndex, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPEntry=wsSFPEntry, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPTransceiver=wsXFPTransceiver, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPRXdBmPower=wsSFPRXdBmPower, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPVolt=wsSFPVolt, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsFanNumber=wsFanNumber, wsNeighbourHostname=wsNeighbourHostname, wsFanEntry=wsFanEntry, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsFanRPM=wsFanRPM, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsTempStatus=wsTempStatus, PYSNMP_MODULE_ID=ibos, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsIbosTempLow=wsIbosTempLow, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsTempThresholdLow=wsTempThresholdLow, wsSFPTempStatus=wsSFPTempStatus, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsReload=wsReload)
