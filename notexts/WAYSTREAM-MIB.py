...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTXdBmPower=wsSFPTXdBmPower, wsIbosTempHigh=wsIbosTempHigh, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsReload=wsReload, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsPolicyEntry=wsPolicyEntry, wsSystem=wsSystem, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPSerialNumber=wsSFPSerialNumber, wsPolicyIfIndex=wsPolicyIfIndex, wsPolicyName=wsPolicyName, wsXFPIndex=wsXFPIndex, wsVoltMeasured=wsVoltMeasured, wsNeighbourModel=wsNeighbourModel, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPTempStatus=wsXFPTempStatus, wsTempTable=wsTempTable, wsXFPTable=wsXFPTable, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPEncoding=wsXFPEncoding, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPEncoding=wsSFPEncoding, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsFanTable=wsFanTable, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPConnector=wsSFPConnector, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsXFPBitrateMin=wsXFPBitrateMin, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourLocalIf=wsNeighbourLocalIf, wsVoltEntry=wsVoltEntry, wsPolicyCookie=wsPolicyCookie, wsAsrRevision=wsAsrRevision, wsVoltNominal=wsVoltNominal, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPVolt=wsSFPVolt, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsVoltStatus=wsVoltStatus, wsSFPCopperLen=wsSFPCopperLen, wsNeighboursEntry=wsNeighboursEntry, wsTempTOS=wsTempTOS, wsNeighbourUptime=wsNeighbourUptime, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsTempSensor=wsTempSensor, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsVersion=wsVersion, wsSFPIndex=wsSFPIndex, wsXFPRXPower=wsXFPRXPower, wsTempMeasured=wsTempMeasured, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsIbosFanRPMLow=wsIbosFanRPMLow, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsVersionString=wsVersionString, wsVoltTable=wsVoltTable, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, ibos=ibos, wsTempStatus=wsTempStatus, wsPolicyOutBytes=wsPolicyOutBytes, wsFanVoltage=wsFanVoltage, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsFanNumber=wsFanNumber, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPRXPower=wsSFPRXPower, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsEnvironment=wsEnvironment, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPEntry=wsSFPEntry, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTable=wsSFPTable, wsWritedummy=wsWritedummy, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsPolicyOutPkts=wsPolicyOutPkts, PYSNMP_MODULE_ID=ibos, wsSFPTempWarningLow=wsSFPTempWarningLow, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortState=wsNeighbourPortState, wsXFPStatus=wsXFPStatus, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsVoltChannel=wsVoltChannel, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsIbosVoltLow=wsIbosVoltLow, wsTempEntry=wsTempEntry, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsPolicyTable=wsPolicyTable, wsXFPCopperLen=wsXFPCopperLen, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPStatus=wsSFPStatus, wsXFPConnector=wsXFPConnector, wsXFPTXPower=wsXFPTXPower, wsTempTHYST=wsTempTHYST, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourCreated=wsNeighbourCreated, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPBitrate=wsSFPBitrate, wsPolicyInPkts=wsPolicyInPkts, wsIbosTempLow=wsIbosTempLow, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourState=wsNeighbourState, wsFanEntry=wsFanEntry, wsFanRPM=wsFanRPM, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsAccounting=wsAccounting, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTransceiver=wsSFPTransceiver, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPEntry=wsXFPEntry, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsXFPTransceiver=wsXFPTransceiver, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPTemp=wsXFPTemp, wsSFPTemp=wsSFPTemp, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPTXPower=wsSFPTXPower, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsPFDP=wsPFDP, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError)
