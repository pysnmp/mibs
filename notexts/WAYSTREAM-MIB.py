...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsFanVoltage=wsFanVoltage, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsTempThresholdLow=wsTempThresholdLow, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsPolicyInBytes=wsPolicyInBytes, wsVersion=wsVersion, wsXFPRXPower=wsXFPRXPower, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPTemp=wsXFPTemp, wsNeighbourPortName=wsNeighbourPortName, wsIbosTempHigh=wsIbosTempHigh, wsSFPIndex=wsSFPIndex, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourLocalIf=wsNeighbourLocalIf, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTempWarningLow=wsSFPTempWarningLow, wsAccounting=wsAccounting, wsVoltEntry=wsVoltEntry, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortState=wsNeighbourPortState, wsPolicyOutDrops=wsPolicyOutDrops, wsTempMeasured=wsTempMeasured, wsSFPTable=wsSFPTable, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsVoltChannel=wsVoltChannel, wsVersionString=wsVersionString, wsTempTHYST=wsTempTHYST, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsXFPTXPower=wsXFPTXPower, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsFanTable=wsFanTable, wsPolicyTable=wsPolicyTable, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsPFDP=wsPFDP, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsPolicyIfName=wsPolicyIfName, wsNeighbourLastAct=wsNeighbourLastAct, wsVoltStatus=wsVoltStatus, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTXPower=wsSFPTXPower, wsWritedummy=wsWritedummy, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPBitrate=wsSFPBitrate, wsSFPTemp=wsSFPTemp, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSystem=wsSystem, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPStatus=wsSFPStatus, wsFanEntry=wsFanEntry, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPPartNumber=wsSFPPartNumber, wsSFPVolt=wsSFPVolt, wsIbosTempLow=wsIbosTempLow, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPStatus=wsXFPStatus, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourUptime=wsNeighbourUptime, wsXFPConnector=wsXFPConnector, wsTempSensor=wsTempSensor, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPEncoding=wsSFPEncoding, wsSFPMultiMode625Len=wsSFPMultiMode625Len, PYSNMP_MODULE_ID=ibos, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsTempThresholdHigh=wsTempThresholdHigh, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPTransceiver=wsXFPTransceiver, wsVoltMeasured=wsVoltMeasured, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsAsrRevision=wsAsrRevision, wsXFPCopperLen=wsXFPCopperLen, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsFanNumber=wsFanNumber, wsXFPEntry=wsXFPEntry, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsTempStatus=wsTempStatus, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsEnvironment=wsEnvironment, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsPolicyCookie=wsPolicyCookie, wsTempTable=wsTempTable, wsSFPEntry=wsSFPEntry, wsSFPConnector=wsSFPConnector, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, ibos=ibos, wsSFPRXPower=wsSFPRXPower, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsTempEntry=wsTempEntry, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsPolicyName=wsPolicyName, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourOSVersion=wsNeighbourOSVersion, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsReload=wsReload, wsSFPSingleModeLen=wsSFPSingleModeLen, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsFanRPM=wsFanRPM, wsXFPTable=wsXFPTable, wsSFPCopperLen=wsSFPCopperLen, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsPolicyEntry=wsPolicyEntry, wsVoltTable=wsVoltTable, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsPolicyInDrops=wsPolicyInDrops, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourState=wsNeighbourState, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsXFPIndex=wsXFPIndex, wsPolicyOutPkts=wsPolicyOutPkts, wsVoltNominal=wsVoltNominal, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsVoltThresholdLow=wsVoltThresholdLow, wsTempTOS=wsTempTOS, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsPolicyInPkts=wsPolicyInPkts, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTempStatus=wsSFPTempStatus)
