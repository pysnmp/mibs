...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsTempEntry=wsTempEntry, wsXFPTable=wsXFPTable, wsXFPEntry=wsXFPEntry, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPVolt=wsSFPVolt, PYSNMP_MODULE_ID=ibos, wsXFPTemp=wsXFPTemp, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPEncoding=wsSFPEncoding, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourCreated=wsNeighbourCreated, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourSNPA=wsNeighbourSNPA, wsTempTable=wsTempTable, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsTempSensor=wsTempSensor, wsXFPCopperLen=wsXFPCopperLen, wsVoltEntry=wsVoltEntry, wsSFPIndex=wsSFPIndex, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSystem=wsSystem, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortName=wsNeighbourPortName, wsVoltMeasured=wsVoltMeasured, wsPolicyTable=wsPolicyTable, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourOSVersion=wsNeighbourOSVersion, wsVoltStatus=wsVoltStatus, wsEnvironment=wsEnvironment, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPRXdBmPower=wsSFPRXdBmPower, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPCopperLen=wsSFPCopperLen, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsFanVoltage=wsFanVoltage, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourUptime=wsNeighbourUptime, wsVoltThresholdLow=wsVoltThresholdLow, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsVoltNominal=wsVoltNominal, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsVoltTable=wsVoltTable, wsFanEntry=wsFanEntry, wsVoltChannel=wsVoltChannel, wsTempTHYST=wsTempTHYST, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsVersion=wsVersion, wsVersionString=wsVersionString, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsAsrRevision=wsAsrRevision, wsPolicyCookie=wsPolicyCookie, wsSFPRXPower=wsSFPRXPower, wsFanNumber=wsFanNumber, wsFanRPM=wsFanRPM, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPConnector=wsXFPConnector, wsNeighbourState=wsNeighbourState, wsSFPTempStatus=wsSFPTempStatus, wsIbosVoltLow=wsIbosVoltLow, wsPolicyIfName=wsPolicyIfName, wsSFPStatus=wsSFPStatus, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTempWarningLow=wsSFPTempWarningLow, wsTempMeasured=wsTempMeasured, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTXdBmPower=wsSFPTXdBmPower, wsXFPIndex=wsXFPIndex, wsXFPTransceiver=wsXFPTransceiver, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsIbosTempHigh=wsIbosTempHigh, wsVoltThresholdHigh=wsVoltThresholdHigh, wsPolicyName=wsPolicyName, wsIbosTempLow=wsIbosTempLow, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsPFDP=wsPFDP, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortState=wsNeighbourPortState, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPEntry=wsSFPEntry, wsTempThresholdHigh=wsTempThresholdHigh, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTable=wsSFPTable, wsFanTable=wsFanTable, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPConnector=wsSFPConnector, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTransceiverExt=wsSFPTransceiverExt, wsXFPStatus=wsXFPStatus, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPSingleModeLen=wsXFPSingleModeLen, wsReload=wsReload, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourHostname=wsNeighbourHostname, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsTempTOS=wsTempTOS, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsIbosFanRPMLow=wsIbosFanRPMLow, wsAccounting=wsAccounting, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsXFPTempStatus=wsXFPTempStatus, wsTempStatus=wsTempStatus, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsWritedummy=wsWritedummy, ibos=ibos, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPPartNumber=wsSFPPartNumber, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPTemp=wsSFPTemp, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsPolicyEntry=wsPolicyEntry, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourNIndex=wsNeighbourNIndex, wsTempThresholdLow=wsTempThresholdLow, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsXFPEncoding=wsXFPEncoding)
