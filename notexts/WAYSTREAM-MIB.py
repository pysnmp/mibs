...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsPolicyIfName=wsPolicyIfName, wsVoltEntry=wsVoltEntry, wsTempSensor=wsTempSensor, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsPolicyInPkts=wsPolicyInPkts, wsPolicyOutDrops=wsPolicyOutDrops, wsVersionString=wsVersionString, wsNeighbourNIndex=wsNeighbourNIndex, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsPolicyEntry=wsPolicyEntry, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourLocalIf=wsNeighbourLocalIf, PYSNMP_MODULE_ID=ibos, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsXFPEncoding=wsXFPEncoding, wsReload=wsReload, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsXFPEntry=wsXFPEntry, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsPolicyInDrops=wsPolicyInDrops, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsXFPTable=wsXFPTable, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsXFPStatus=wsXFPStatus, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPSingleModeLen=wsXFPSingleModeLen, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTempNormalLow=wsSFPTempNormalLow, ibos=ibos, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortsTable=wsNeighbourPortsTable, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsVoltStatus=wsVoltStatus, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSystem=wsSystem, wsFanRPM=wsFanRPM, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsFanNumber=wsFanNumber, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsEnvironment=wsEnvironment, wsVoltChannel=wsVoltChannel, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsXFPIndex=wsXFPIndex, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsTempMeasured=wsTempMeasured, wsSFPEntry=wsSFPEntry, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsXFPTransceiver=wsXFPTransceiver, wsXFPConnector=wsXFPConnector, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsWritedummy=wsWritedummy, wsNeighbourUptime=wsNeighbourUptime, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTable=wsSFPTable, wsAccounting=wsAccounting, wsTempTable=wsTempTable, wsXFPRXPower=wsXFPRXPower, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsVoltMeasured=wsVoltMeasured, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPBitrate=wsSFPBitrate, wsSFPStatus=wsSFPStatus, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsXFPTemp=wsXFPTemp, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourCreated=wsNeighbourCreated, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPConnector=wsSFPConnector, wsPolicyOutBytes=wsPolicyOutBytes, wsTempThresholdLow=wsTempThresholdLow, wsFanTable=wsFanTable, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPIndex=wsSFPIndex, wsSFPTempStatus=wsSFPTempStatus, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPCopperLen=wsSFPCopperLen, wsFanEntry=wsFanEntry, wsPolicyName=wsPolicyName, wsIbosFanRPMLow=wsIbosFanRPMLow, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsVoltTable=wsVoltTable, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTemp=wsSFPTemp, wsFanVoltage=wsFanVoltage, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPVolt=wsSFPVolt, wsSFPTXPower=wsSFPTXPower, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourOSVersion=wsNeighbourOSVersion, wsTempTHYST=wsTempTHYST, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourState=wsNeighbourState, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsPolicyTable=wsPolicyTable, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsPFDP=wsPFDP, wsSFPTXdBmPower=wsSFPTXdBmPower, wsTempStatus=wsTempStatus, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighboursTable=wsNeighboursTable, wsSFPTXCurrent=wsSFPTXCurrent, wsTempTOS=wsTempTOS, wsSFPRXPower=wsSFPRXPower, wsTempEntry=wsTempEntry, wsVoltNominal=wsVoltNominal, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsAsrRevision=wsAsrRevision, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourIfIndex=wsNeighbourIfIndex, wsIbosTempLow=wsIbosTempLow, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsIbosTempHigh=wsIbosTempHigh, wsSFPTransceiver=wsSFPTransceiver, wsVersion=wsVersion, wsSFPEncoding=wsSFPEncoding)
