...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourNIndex=wsNeighbourNIndex, wsPolicyUsedCnt=wsPolicyUsedCnt, wsPolicyEntry=wsPolicyEntry, wsSFPIndex=wsSFPIndex, wsSFPPartNumber=wsSFPPartNumber, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighboursEntry=wsNeighboursEntry, wsFanEntry=wsFanEntry, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsTempTable=wsTempTable, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPCopperLen=wsSFPCopperLen, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPBitrate=wsSFPBitrate, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsPolicyInBytes=wsPolicyInBytes, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPConnector=wsXFPConnector, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourSNPA=wsNeighbourSNPA, wsAsrRevision=wsAsrRevision, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortName=wsNeighbourPortName, wsVersion=wsVersion, wsSFPRXdBmPower=wsSFPRXdBmPower, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsPolicyIfName=wsPolicyIfName, wsPolicyName=wsPolicyName, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsAccounting=wsAccounting, wsXFPSingleModeLen=wsXFPSingleModeLen, wsVoltThresholdLow=wsVoltThresholdLow, wsTempEntry=wsTempEntry, wsVoltStatus=wsVoltStatus, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsTempSensor=wsTempSensor, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsTempTHYST=wsTempTHYST, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTXCurrent=wsSFPTXCurrent, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsEnvironment=wsEnvironment, wsVoltNominal=wsVoltNominal, wsTempTOS=wsTempTOS, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsXFPEntry=wsXFPEntry, wsXFPIndex=wsXFPIndex, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsXFPStatus=wsXFPStatus, wsVoltMeasured=wsVoltMeasured, wsXFPBitrateMin=wsXFPBitrateMin, wsFanRPM=wsFanRPM, wsVoltTable=wsVoltTable, wsSFPSerialNumber=wsSFPSerialNumber, wsWritedummy=wsWritedummy, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourOSVersion=wsNeighbourOSVersion, wsIbosTempLow=wsIbosTempLow, wsReload=wsReload, wsVoltEntry=wsVoltEntry, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourCreated=wsNeighbourCreated, ibos=ibos, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsFanVoltage=wsFanVoltage, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourState=wsNeighbourState, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTransceiver=wsSFPTransceiver, PYSNMP_MODULE_ID=ibos, wsTempThresholdHigh=wsTempThresholdHigh, wsPolicyTable=wsPolicyTable, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTemp=wsSFPTemp, wsFanTable=wsFanTable, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTransceiverExt=wsSFPTransceiverExt, wsXFPCopperLen=wsXFPCopperLen, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPEncoding=wsSFPEncoding, wsSFPVolt=wsSFPVolt, wsIbosTempHigh=wsIbosTempHigh, wsXFPTable=wsXFPTable, wsPFDP=wsPFDP, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsPolicyCookie=wsPolicyCookie, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPStatus=wsSFPStatus, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPEntry=wsSFPEntry, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsVersionString=wsVersionString, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPConnector=wsSFPConnector, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsIbosFanRPMLow=wsIbosFanRPMLow, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSystem=wsSystem, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPTransceiver=wsXFPTransceiver, wsPolicyInDrops=wsPolicyInDrops, wsNeighboursTable=wsNeighboursTable, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortState=wsNeighbourPortState, wsXFPTemp=wsXFPTemp, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsTempMeasured=wsTempMeasured, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPVoltStatus=wsSFPVoltStatus, wsTempStatus=wsTempStatus, wsSFPRXPower=wsSFPRXPower, wsFanNumber=wsFanNumber, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsVoltChannel=wsVoltChannel, wsNeighbourUptime=wsNeighbourUptime, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPTable=wsSFPTable, wsXFPRXPower=wsXFPRXPower, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortsEntry=wsNeighbourPortsEntry)
