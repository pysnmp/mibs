...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsPolicyTable=wsPolicyTable, wsFanEntry=wsFanEntry, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTable=wsSFPTable, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsXFPTable=wsXFPTable, wsSFPEntry=wsSFPEntry, wsSFPVoltStatus=wsSFPVoltStatus, wsXFPTemp=wsXFPTemp, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsTempTable=wsTempTable, wsPolicyName=wsPolicyName, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPRXPower=wsSFPRXPower, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourNIndex=wsNeighbourNIndex, wsTempStatus=wsTempStatus, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsPolicyCookie=wsPolicyCookie, wsNeighbourUptime=wsNeighbourUptime, wsSystem=wsSystem, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPStatus=wsSFPStatus, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, PYSNMP_MODULE_ID=ibos, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPPartNumber=wsSFPPartNumber, wsXFPIndex=wsXFPIndex, wsPFDP=wsPFDP, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsIbosVoltHigh=wsIbosVoltHigh, wsFanVoltage=wsFanVoltage, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTempNormalLow=wsSFPTempNormalLow, wsXFPRXPower=wsXFPRXPower, wsTempMeasured=wsTempMeasured, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPVolt=wsSFPVolt, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourOSVersion=wsNeighbourOSVersion, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsFanNumber=wsFanNumber, wsVoltEntry=wsVoltEntry, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsEnvironment=wsEnvironment, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTempStatus=wsSFPTempStatus, wsVoltNominal=wsVoltNominal, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPTempWarningLow=wsSFPTempWarningLow, wsAccounting=wsAccounting, wsNeighbourPortName=wsNeighbourPortName, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsVoltChannel=wsVoltChannel, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsXFPStatus=wsXFPStatus, wsSFPTXdBmPower=wsSFPTXdBmPower, wsPolicyEntry=wsPolicyEntry, wsXFPTempStatus=wsXFPTempStatus, wsFanTable=wsFanTable, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsXFPEntry=wsXFPEntry, wsTempSensor=wsTempSensor, wsSFPTXCurrent=wsSFPTXCurrent, wsIbosTempLow=wsIbosTempLow, wsNeighboursTable=wsNeighboursTable, wsVersionString=wsVersionString, wsNeighbourState=wsNeighbourState, wsXFPCopperLen=wsXFPCopperLen, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsPolicyOutDrops=wsPolicyOutDrops, ibos=ibos, wsPolicyOutPkts=wsPolicyOutPkts, wsTempTOS=wsTempTOS, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsTempTHYST=wsTempTHYST, wsSFPIndex=wsSFPIndex, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourModel=wsNeighbourModel, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPEncoding=wsXFPEncoding, wsTempThresholdHigh=wsTempThresholdHigh, wsWritedummy=wsWritedummy, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsReload=wsReload, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsPolicyOutBytes=wsPolicyOutBytes, wsAsrRevision=wsAsrRevision, wsSFPEncoding=wsSFPEncoding, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourHostname=wsNeighbourHostname, wsTempEntry=wsTempEntry, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsIbosTempHigh=wsIbosTempHigh, wsPolicyInPkts=wsPolicyInPkts, wsSFPTemp=wsSFPTemp, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsXFPConnector=wsXFPConnector, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsPolicyIfName=wsPolicyIfName, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighboursEntry=wsNeighboursEntry, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsVersion=wsVersion, wsNeighbourCreated=wsNeighbourCreated, wsSFPTXPower=wsSFPTXPower, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsIbosVoltLow=wsIbosVoltLow, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPCopperLen=wsSFPCopperLen, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsFanRPM=wsFanRPM, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsPolicyInDrops=wsPolicyInDrops, wsSFPTransceiverExt=wsSFPTransceiverExt, wsVoltMeasured=wsVoltMeasured, wsSFPRXdBmPower=wsSFPRXdBmPower, wsVoltTable=wsVoltTable, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPConnector=wsSFPConnector, wsSFPTransceiver=wsSFPTransceiver, wsVoltStatus=wsVoltStatus, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments)
