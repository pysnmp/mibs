...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPEncoding=wsSFPEncoding, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsPolicyOutBytes=wsPolicyOutBytes, wsAsrRevision=wsAsrRevision, wsSFPIndex=wsSFPIndex, wsXFPTemp=wsXFPTemp, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSystem=wsSystem, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsXFPEntry=wsXFPEntry, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPConnector=wsXFPConnector, wsSFPTempStatus=wsSFPTempStatus, wsPolicyInBytes=wsPolicyInBytes, wsSFPSerialNumber=wsSFPSerialNumber, wsVersionString=wsVersionString, wsSFPTemp=wsSFPTemp, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPPartNumber=wsSFPPartNumber, wsXFPTable=wsXFPTable, wsWritedummy=wsWritedummy, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPRXPower=wsSFPRXPower, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighboursEntry=wsNeighboursEntry, wsPolicyIfName=wsPolicyIfName, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTempNormalLow=wsSFPTempNormalLow, wsTempStatus=wsTempStatus, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPCopperLen=wsSFPCopperLen, wsFanVoltage=wsFanVoltage, wsSFPSingleModeLen=wsSFPSingleModeLen, wsPolicyInPkts=wsPolicyInPkts, wsTempEntry=wsTempEntry, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPBitrate=wsSFPBitrate, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsXFPRXPower=wsXFPRXPower, wsNeighbourState=wsNeighbourState, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPRXdBmPower=wsSFPRXdBmPower, wsXFPIndex=wsXFPIndex, wsXFPTXPower=wsXFPTXPower, wsVoltThresholdHigh=wsVoltThresholdHigh, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsXFPTransceiver=wsXFPTransceiver, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsVersion=wsVersion, wsVoltChannel=wsVoltChannel, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPConnector=wsSFPConnector, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsPolicyIfIndex=wsPolicyIfIndex, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsPFDP=wsPFDP, wsVoltTable=wsVoltTable, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourCreated=wsNeighbourCreated, wsSFPStatus=wsSFPStatus, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourDBCount=wsNeighbourDBCount, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsReload=wsReload, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsIbosVoltLow=wsIbosVoltLow, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsPolicyTable=wsPolicyTable, wsIbosTempLow=wsIbosTempLow, wsSFPEntry=wsSFPEntry, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsTempMeasured=wsTempMeasured, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPVolt=wsSFPVolt, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsEnvironment=wsEnvironment, wsTempSensor=wsTempSensor, wsFanTable=wsFanTable, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsFanRPM=wsFanRPM, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsXFPTempStatus=wsXFPTempStatus, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsTempTable=wsTempTable, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsVoltNominal=wsVoltNominal, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsAccounting=wsAccounting, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsTempTOS=wsTempTOS, wsFanEntry=wsFanEntry, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsVoltEntry=wsVoltEntry, wsNeighbourSNPA=wsNeighbourSNPA, wsVoltMeasured=wsVoltMeasured, PYSNMP_MODULE_ID=ibos, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortName=wsNeighbourPortName, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTXdBmPower=wsSFPTXdBmPower, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsFanNumber=wsFanNumber, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsTempThresholdLow=wsTempThresholdLow, ibos=ibos, wsTempTHYST=wsTempTHYST, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsVoltStatus=wsVoltStatus, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsPolicyCookie=wsPolicyCookie, wsSFPTable=wsSFPTable, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsPolicyName=wsPolicyName, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsIbosTempHigh=wsIbosTempHigh, wsXFPStatus=wsXFPStatus, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts)
