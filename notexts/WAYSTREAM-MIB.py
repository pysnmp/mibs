...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourNIndex=wsNeighbourNIndex, wsXFPStatus=wsXFPStatus, wsAccounting=wsAccounting, wsTempSensor=wsTempSensor, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsVersion=wsVersion, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPEntry=wsSFPEntry, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPSingleModeLen=wsXFPSingleModeLen, wsTempEntry=wsTempEntry, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPTransceiver=wsXFPTransceiver, wsXFPTXPower=wsXFPTXPower, wsXFPTXCurrent=wsXFPTXCurrent, wsFanNumber=wsFanNumber, wsXFPRXPower=wsXFPRXPower, wsSFPRXPower=wsSFPRXPower, wsIbosTempHigh=wsIbosTempHigh, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPCopperLen=wsSFPCopperLen, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsAsrRevision=wsAsrRevision, wsXFPEntry=wsXFPEntry, wsSFPTXdBmPower=wsSFPTXdBmPower, wsIbosVoltLow=wsIbosVoltLow, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsVoltEntry=wsVoltEntry, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsPolicyCookie=wsPolicyCookie, wsSFPTransceiver=wsSFPTransceiver, PYSNMP_MODULE_ID=ibos, wsNeighbourState=wsNeighbourState, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsXFPCopperLen=wsXFPCopperLen, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPConnector=wsSFPConnector, wsNeighbourPortsTable=wsNeighbourPortsTable, wsPolicyEntry=wsPolicyEntry, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPStatus=wsSFPStatus, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsFanTable=wsFanTable, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsTempTOS=wsTempTOS, wsIbosFanRPMLow=wsIbosFanRPMLow, wsVoltThresholdHigh=wsVoltThresholdHigh, wsFanVoltage=wsFanVoltage, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPIndex=wsXFPIndex, wsReload=wsReload, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSystem=wsSystem, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsTempThresholdHigh=wsTempThresholdHigh, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortName=wsNeighbourPortName, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsPFDP=wsPFDP, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTable=wsSFPTable, wsPolicyTable=wsPolicyTable, wsVoltTable=wsVoltTable, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsPolicyInDrops=wsPolicyInDrops, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPSerialNumber=wsSFPSerialNumber, wsVoltNominal=wsVoltNominal, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsVoltMeasured=wsVoltMeasured, wsSFPTempNormalLow=wsSFPTempNormalLow, wsTempStatus=wsTempStatus, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPTemp=wsSFPTemp, wsXFPTable=wsXFPTable, wsSFPVolt=wsSFPVolt, wsXFPConnector=wsXFPConnector, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTXPower=wsSFPTXPower, wsSFPEncoding=wsSFPEncoding, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPTemp=wsXFPTemp, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsPolicyIfName=wsPolicyIfName, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighboursTable=wsNeighboursTable, wsTempTHYST=wsTempTHYST, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsVoltStatus=wsVoltStatus, wsWritedummy=wsWritedummy, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsVoltChannel=wsVoltChannel, wsTempMeasured=wsTempMeasured, wsFanRPM=wsFanRPM, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPVoltStatus=wsSFPVoltStatus, wsTempThresholdLow=wsTempThresholdLow, wsEnvironment=wsEnvironment, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsPolicyOutDrops=wsPolicyOutDrops, wsVersionString=wsVersionString, wsFanEntry=wsFanEntry, wsNeighbourCreated=wsNeighbourCreated, wsTempTable=wsTempTable, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, ibos=ibos, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPIndex=wsSFPIndex, wsSFPTempWarningLow=wsSFPTempWarningLow, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighboursEntry=wsNeighboursEntry, wsPolicyName=wsPolicyName, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourSNPA=wsNeighbourSNPA)
