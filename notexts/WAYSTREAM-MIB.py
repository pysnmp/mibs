...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsTempTable=wsTempTable, wsVoltEntry=wsVoltEntry, wsSFPConnector=wsSFPConnector, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPTXPower=wsSFPTXPower, wsXFPIndex=wsXFPIndex, wsNeighbourCreated=wsNeighbourCreated, wsXFPCopperLen=wsXFPCopperLen, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsTempTOS=wsTempTOS, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourState=wsNeighbourState, wsSystem=wsSystem, wsVersion=wsVersion, wsEnvironment=wsEnvironment, wsXFPTemp=wsXFPTemp, wsIbosTempLow=wsIbosTempLow, wsIbosTempHigh=wsIbosTempHigh, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPSingleModeLen=wsSFPSingleModeLen, wsAccounting=wsAccounting, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsPolicyInBytes=wsPolicyInBytes, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighboursTable=wsNeighboursTable, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsPolicyEntry=wsPolicyEntry, wsFanNumber=wsFanNumber, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighboursEntry=wsNeighboursEntry, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourModel=wsNeighbourModel, PYSNMP_MODULE_ID=ibos, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsVoltChannel=wsVoltChannel, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPStatus=wsXFPStatus, wsVoltNominal=wsVoltNominal, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourIfIndex=wsNeighbourIfIndex, wsFanTable=wsFanTable, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsAsrRevision=wsAsrRevision, wsVersionString=wsVersionString, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsFanVoltage=wsFanVoltage, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsPFDP=wsPFDP, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsXFPEntry=wsXFPEntry, wsSFPVolt=wsSFPVolt, wsSFPTXdBmPower=wsSFPTXdBmPower, wsXFPTransceiver=wsXFPTransceiver, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsXFPRXPower=wsXFPRXPower, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsPolicyInPkts=wsPolicyInPkts, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPRXPower=wsSFPRXPower, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPEncoding=wsXFPEncoding, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPTemp=wsSFPTemp, wsSFPTable=wsSFPTable, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsReload=wsReload, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsTempStatus=wsTempStatus, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsTempEntry=wsTempEntry, wsSFPStatus=wsSFPStatus, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortName=wsNeighbourPortName, wsSFPTXCurrent=wsSFPTXCurrent, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourLastAct=wsNeighbourLastAct, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsWritedummy=wsWritedummy, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPTable=wsXFPTable, wsNeighbourDBCount=wsNeighbourDBCount, wsIbosVoltLow=wsIbosVoltLow, wsSFPTransceiverExt=wsSFPTransceiverExt, wsVoltThresholdLow=wsVoltThresholdLow, wsFanEntry=wsFanEntry, wsTempThresholdHigh=wsTempThresholdHigh, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTransceiver=wsSFPTransceiver, wsFanRPM=wsFanRPM, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPMultiMode625Len=wsXFPMultiMode625Len, ibos=ibos, wsPolicyCookie=wsPolicyCookie, wsXFPTempStatus=wsXFPTempStatus, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsTempSensor=wsTempSensor, wsVoltThresholdHigh=wsVoltThresholdHigh, wsVoltMeasured=wsVoltMeasured, wsTempMeasured=wsTempMeasured, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsVoltStatus=wsVoltStatus, wsPolicyTable=wsPolicyTable, wsPolicyInDrops=wsPolicyInDrops, wsSFPBitrate=wsSFPBitrate, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsPolicyName=wsPolicyName, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsVoltTable=wsVoltTable, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPEncoding=wsSFPEncoding, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPConnector=wsXFPConnector, wsNeighbourPortState=wsNeighbourPortState, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPIndex=wsSFPIndex, wsSFPEntry=wsSFPEntry, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsPolicyIfName=wsPolicyIfName, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsTempTHYST=wsTempTHYST, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsPolicyUsedCnt=wsPolicyUsedCnt)
