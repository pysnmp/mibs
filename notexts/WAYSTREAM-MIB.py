...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourUptime=wsNeighbourUptime, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsTempTOS=wsTempTOS, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPStatus=wsXFPStatus, wsSFPIndex=wsSFPIndex, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsPolicyIfIndex=wsPolicyIfIndex, wsVoltChannel=wsVoltChannel, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTransceiverExt=wsSFPTransceiverExt, wsXFPBitrateMax=wsXFPBitrateMax, wsVoltThresholdHigh=wsVoltThresholdHigh, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPTemp=wsSFPTemp, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsVoltNominal=wsVoltNominal, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsAsrRevision=wsAsrRevision, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPStatus=wsSFPStatus, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsFanTable=wsFanTable, wsNeighbourHostname=wsNeighbourHostname, wsSFPTable=wsSFPTable, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsVersionString=wsVersionString, wsSFPTempNormalHigh=wsSFPTempNormalHigh, ibos=ibos, wsNeighbourModel=wsNeighbourModel, wsEnvironment=wsEnvironment, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPRXPower=wsSFPRXPower, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsFanEntry=wsFanEntry, wsSFPTempWarningLow=wsSFPTempWarningLow, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsFanNumber=wsFanNumber, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsTempMeasured=wsTempMeasured, wsSFPPartNumber=wsSFPPartNumber, wsPolicyOutDrops=wsPolicyOutDrops, wsPolicyInDrops=wsPolicyInDrops, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourCreated=wsNeighbourCreated, wsPFDP=wsPFDP, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourNIndex=wsNeighbourNIndex, wsXFPConnector=wsXFPConnector, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTXPower=wsSFPTXPower, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighboursEntry=wsNeighboursEntry, wsXFPTemp=wsXFPTemp, wsFanRPM=wsFanRPM, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsXFPTransceiver=wsXFPTransceiver, wsSFPEntry=wsSFPEntry, wsXFPTXPower=wsXFPTXPower, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourDBCount=wsNeighbourDBCount, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsTempTHYST=wsTempTHYST, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPRXPower=wsXFPRXPower, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourIfIndex=wsNeighbourIfIndex, wsPolicyInPkts=wsPolicyInPkts, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsTempStatus=wsTempStatus, wsTempThresholdLow=wsTempThresholdLow, wsVoltStatus=wsVoltStatus, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPConnector=wsSFPConnector, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsXFPEntry=wsXFPEntry, wsTempEntry=wsTempEntry, wsTempSensor=wsTempSensor, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPBitrate=wsSFPBitrate, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPVolt=wsSFPVolt, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsPolicyName=wsPolicyName, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsPolicyIfName=wsPolicyIfName, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourSNPA=wsNeighbourSNPA, wsIbosTempLow=wsIbosTempLow, wsSystem=wsSystem, wsWritedummy=wsWritedummy, wsVoltMeasured=wsVoltMeasured, wsSFPEncoding=wsSFPEncoding, wsSFPTempNormalLow=wsSFPTempNormalLow, wsFanVoltage=wsFanVoltage, wsIbosFanRPMLow=wsIbosFanRPMLow, wsVoltEntry=wsVoltEntry, wsSFPRXdBmPower=wsSFPRXdBmPower, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPTempStatus=wsXFPTempStatus, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsTempTable=wsTempTable, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsXFPEncoding=wsXFPEncoding, PYSNMP_MODULE_ID=ibos, wsNeighbourState=wsNeighbourState, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighboursTable=wsNeighboursTable, wsXFPIndex=wsXFPIndex, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsVersion=wsVersion, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsAccounting=wsAccounting, wsPolicyTable=wsPolicyTable, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsReload=wsReload, wsSFPTempStatus=wsSFPTempStatus, wsXFPTable=wsXFPTable, wsVoltTable=wsVoltTable, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors)
