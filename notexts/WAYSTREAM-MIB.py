...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsXFPCopperLen=wsXFPCopperLen, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsVersionString=wsVersionString, wsTempSensor=wsTempSensor, wsNeighbourModel=wsNeighbourModel, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortState=wsNeighbourPortState, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsXFPBitrateMax=wsXFPBitrateMax, wsPolicyName=wsPolicyName, wsIbosTempHigh=wsIbosTempHigh, wsIbosVoltHigh=wsIbosVoltHigh, wsVersion=wsVersion, wsXFPTable=wsXFPTable, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPIndex=wsSFPIndex, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourHostname=wsNeighbourHostname, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsPolicyInPkts=wsPolicyInPkts, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourDBCount=wsNeighbourDBCount, wsPolicyTable=wsPolicyTable, wsSFPTempStatus=wsSFPTempStatus, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsPolicyUsedCnt=wsPolicyUsedCnt, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsVoltThresholdLow=wsVoltThresholdLow, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortName=wsNeighbourPortName, wsVoltStatus=wsVoltStatus, wsNeighbourNIndex=wsNeighbourNIndex, wsPolicyOutBytes=wsPolicyOutBytes, wsPolicyInDrops=wsPolicyInDrops, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsTempTHYST=wsTempTHYST, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPPartNumber=wsSFPPartNumber, wsVoltTable=wsVoltTable, wsVoltNominal=wsVoltNominal, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsVoltMeasured=wsVoltMeasured, wsSFPStatus=wsSFPStatus, wsSFPTemp=wsSFPTemp, wsNeighbourState=wsNeighbourState, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourCreated=wsNeighbourCreated, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsFanTable=wsFanTable, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsXFPEntry=wsXFPEntry, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPSerialNumber=wsSFPSerialNumber, wsAccounting=wsAccounting, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsAsrRevision=wsAsrRevision, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourIfIndex=wsNeighbourIfIndex, wsReload=wsReload, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPVolt=wsSFPVolt, wsXFPTempStatus=wsXFPTempStatus, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsPFDP=wsPFDP, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsTempTable=wsTempTable, wsXFPConnector=wsXFPConnector, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPEntry=wsSFPEntry, wsIbosTempLow=wsIbosTempLow, wsSFPConnector=wsSFPConnector, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSystem=wsSystem, wsIbosFanRPMLow=wsIbosFanRPMLow, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPRXPower=wsSFPRXPower, wsXFPTemp=wsXFPTemp, wsXFPTXPower=wsXFPTXPower, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsEnvironment=wsEnvironment, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsXFPStatus=wsXFPStatus, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsXFPIndex=wsXFPIndex, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsVoltChannel=wsVoltChannel, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsPolicyOutDrops=wsPolicyOutDrops, wsTempStatus=wsTempStatus, wsPolicyInBytes=wsPolicyInBytes, wsPolicyIfName=wsPolicyIfName, wsFanNumber=wsFanNumber, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsPolicyCookie=wsPolicyCookie, wsVoltEntry=wsVoltEntry, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPTable=wsSFPTable, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, ibos=ibos, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsTempMeasured=wsTempMeasured, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPVoltStatus=wsSFPVoltStatus, wsWritedummy=wsWritedummy, wsTempEntry=wsTempEntry, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsFanRPM=wsFanRPM, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsTempThresholdLow=wsTempThresholdLow, wsTempTOS=wsTempTOS, wsFanVoltage=wsFanVoltage, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, PYSNMP_MODULE_ID=ibos, wsFanEntry=wsFanEntry, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPBitrate=wsSFPBitrate, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortNIndex=wsNeighbourPortNIndex)
