...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsPolicyIfName=wsPolicyIfName, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighboursTable=wsNeighboursTable, wsEnvironment=wsEnvironment, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsVoltEntry=wsVoltEntry, wsSFPCopperLen=wsSFPCopperLen, wsTempSensor=wsTempSensor, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSystem=wsSystem, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPConnector=wsSFPConnector, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsAccounting=wsAccounting, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, ibos=ibos, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPStatus=wsSFPStatus, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPRXPower=wsSFPRXPower, wsFanTable=wsFanTable, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPTemp=wsXFPTemp, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPTempNormalLow=wsSFPTempNormalLow, wsTempTHYST=wsTempTHYST, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsIbosTempLow=wsIbosTempLow, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPIndex=wsSFPIndex, wsTempMeasured=wsTempMeasured, wsFanNumber=wsFanNumber, wsVoltMeasured=wsVoltMeasured, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsTempStatus=wsTempStatus, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPTransceiver=wsXFPTransceiver, wsTempThresholdHigh=wsTempThresholdHigh, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsXFPConnector=wsXFPConnector, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPPartNumber=wsSFPPartNumber, wsVersionString=wsVersionString, wsPolicyInDrops=wsPolicyInDrops, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsVoltChannel=wsVoltChannel, wsPolicyEntry=wsPolicyEntry, wsXFPTable=wsXFPTable, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPIndex=wsXFPIndex, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsFanRPM=wsFanRPM, wsTempEntry=wsTempEntry, wsNeighbourHostname=wsNeighbourHostname, wsVoltTable=wsVoltTable, wsVoltNominal=wsVoltNominal, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourDBCount=wsNeighbourDBCount, wsReload=wsReload, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPVoltStatus=wsSFPVoltStatus, wsVoltStatus=wsVoltStatus, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsFanVoltage=wsFanVoltage, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPVolt=wsSFPVolt, wsXFPEntry=wsXFPEntry, wsNeighboursEntry=wsNeighboursEntry, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsTempThresholdLow=wsTempThresholdLow, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsIbosTempHigh=wsIbosTempHigh, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsWritedummy=wsWritedummy, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsPolicyCookie=wsPolicyCookie, wsSFPTable=wsSFPTable, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsPFDP=wsPFDP, wsNeighbourCreated=wsNeighbourCreated, wsXFPRXPower=wsXFPRXPower, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourUptime=wsNeighbourUptime, wsXFPStatus=wsXFPStatus, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsPolicyTable=wsPolicyTable, wsXFPTXPower=wsXFPTXPower, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourOSVersion=wsNeighbourOSVersion, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsTempTOS=wsTempTOS, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTemp=wsSFPTemp, wsXFPEncoding=wsXFPEncoding, wsPolicyInPkts=wsPolicyInPkts, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsFanEntry=wsFanEntry, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsVersion=wsVersion, wsNeighbourState=wsNeighbourState, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTempStatus=wsSFPTempStatus, wsSFPTXPower=wsSFPTXPower, wsXFPTXCurrent=wsXFPTXCurrent, wsPolicyName=wsPolicyName, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsTempTable=wsTempTable, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPEntry=wsSFPEntry, wsSFPBitrate=wsSFPBitrate, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortsTable=wsNeighbourPortsTable, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPRXPowerStatus=wsXFPRXPowerStatus, PYSNMP_MODULE_ID=ibos, wsXFPCopperLen=wsXFPCopperLen, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsAsrRevision=wsAsrRevision, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc)
