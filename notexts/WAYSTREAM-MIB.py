...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPRXdBmPower=wsSFPRXdBmPower, wsPolicyEntry=wsPolicyEntry, wsTempMeasured=wsTempMeasured, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPIndex=wsSFPIndex, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsVersion=wsVersion, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourUptime=wsNeighbourUptime, wsIbosVoltLow=wsIbosVoltLow, wsVoltChannel=wsVoltChannel, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPCopperLen=wsSFPCopperLen, wsSFPTXdBmPower=wsSFPTXdBmPower, wsVoltEntry=wsVoltEntry, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourHostname=wsNeighbourHostname, wsNeighboursEntry=wsNeighboursEntry, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsPolicyName=wsPolicyName, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsTempTHYST=wsTempTHYST, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourSNPA=wsNeighbourSNPA, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsVoltStatus=wsVoltStatus, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsPolicyOutDrops=wsPolicyOutDrops, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortName=wsNeighbourPortName, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourIfIndex=wsNeighbourIfIndex, wsTempTOS=wsTempTOS, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourLocalIf=wsNeighbourLocalIf, wsXFPConnector=wsXFPConnector, wsVersionString=wsVersionString, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTable=wsSFPTable, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPBitrateMin=wsXFPBitrateMin, wsIbosTempLow=wsIbosTempLow, wsPFDP=wsPFDP, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPVolt=wsSFPVolt, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsPolicyTable=wsPolicyTable, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTempNormalLow=wsSFPTempNormalLow, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourCreated=wsNeighbourCreated, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortsTable=wsNeighbourPortsTable, wsXFPTransceiver=wsXFPTransceiver, PYSNMP_MODULE_ID=ibos, wsAccounting=wsAccounting, wsNeighbourOSVersion=wsNeighbourOSVersion, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSystem=wsSystem, wsFanTable=wsFanTable, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPEntry=wsXFPEntry, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPEncoding=wsXFPEncoding, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighboursTable=wsNeighboursTable, wsNeighbourState=wsNeighbourState, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, ibos=ibos, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsPolicyIfIndex=wsPolicyIfIndex, wsWritedummy=wsWritedummy, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsReload=wsReload, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsVoltMeasured=wsVoltMeasured, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsFanNumber=wsFanNumber, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPEntry=wsSFPEntry, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsXFPTable=wsXFPTable, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortState=wsNeighbourPortState, wsSFPConnector=wsSFPConnector, wsXFPTemp=wsXFPTemp, wsTempTable=wsTempTable, wsSFPTemp=wsSFPTemp, wsTempStatus=wsTempStatus, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsXFPStatus=wsXFPStatus, wsXFPTXPower=wsXFPTXPower, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsVoltTable=wsVoltTable, wsSFPTempStatus=wsSFPTempStatus, wsAsrRevision=wsAsrRevision, wsVoltNominal=wsVoltNominal, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsFanVoltage=wsFanVoltage, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsFanRPM=wsFanRPM, wsPolicyCookie=wsPolicyCookie, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPStatus=wsSFPStatus, wsFanEntry=wsFanEntry, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPRXPower=wsSFPRXPower, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsTempSensor=wsTempSensor, wsTempThresholdLow=wsTempThresholdLow, wsEnvironment=wsEnvironment, wsSFPSingleModeLen=wsSFPSingleModeLen, wsTempEntry=wsTempEntry, wsPolicyIfName=wsPolicyIfName, wsXFPIndex=wsXFPIndex, wsSFPPartNumber=wsSFPPartNumber, wsIbosTempHigh=wsIbosTempHigh, wsXFPRXPower=wsXFPRXPower, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW)
