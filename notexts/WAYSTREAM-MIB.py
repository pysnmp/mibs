...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsTempTOS=wsTempTOS, wsVoltChannel=wsVoltChannel, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsEnvironment=wsEnvironment, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsPolicyName=wsPolicyName, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPEncoding=wsXFPEncoding, wsXFPTXPower=wsXFPTXPower, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourState=wsNeighbourState, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsPolicyEntry=wsPolicyEntry, wsSFPTempNormalLow=wsSFPTempNormalLow, wsTempThresholdHigh=wsTempThresholdHigh, wsXFPTable=wsXFPTable, wsVoltMeasured=wsVoltMeasured, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPEncoding=wsSFPEncoding, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPPartNumber=wsSFPPartNumber, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortState=wsNeighbourPortState, wsXFPTransceiver=wsXFPTransceiver, wsFanTable=wsFanTable, wsVoltEntry=wsVoltEntry, wsTempMeasured=wsTempMeasured, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsPolicyIfName=wsPolicyIfName, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourCreated=wsNeighbourCreated, wsSFPVolt=wsSFPVolt, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortName=wsNeighbourPortName, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPSingleModeLen=wsXFPSingleModeLen, wsVoltTable=wsVoltTable, wsTempSensor=wsTempSensor, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPConnector=wsSFPConnector, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPIndex=wsSFPIndex, wsNeighbourHostname=wsNeighbourHostname, wsPFDP=wsPFDP, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsAsrRevision=wsAsrRevision, wsPolicyCookie=wsPolicyCookie, wsXFPEntry=wsXFPEntry, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsTempEntry=wsTempEntry, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsVersion=wsVersion, PYSNMP_MODULE_ID=ibos, wsTempTHYST=wsTempTHYST, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortsTable=wsNeighbourPortsTable, wsXFPStatus=wsXFPStatus, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsVoltThresholdHigh=wsVoltThresholdHigh, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsPolicyInPkts=wsPolicyInPkts, wsSFPStatus=wsSFPStatus, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsAccounting=wsAccounting, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsPolicyInBytes=wsPolicyInBytes, wsPolicyInDrops=wsPolicyInDrops, wsSystem=wsSystem, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsVersionString=wsVersionString, wsReload=wsReload, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPBitrate=wsSFPBitrate, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPTXCurrent=wsXFPTXCurrent, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourModel=wsNeighbourModel, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPSingleModeLen=wsSFPSingleModeLen, wsFanVoltage=wsFanVoltage, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPSerialNumber=wsSFPSerialNumber, wsIbosTempLow=wsIbosTempLow, wsSFPEntry=wsSFPEntry, wsIbosVoltHigh=wsIbosVoltHigh, wsXFPBitrateMax=wsXFPBitrateMax, wsPolicyTable=wsPolicyTable, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPIndex=wsXFPIndex, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsWritedummy=wsWritedummy, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsTempStatus=wsTempStatus, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsFanNumber=wsFanNumber, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, ibos=ibos, wsXFPTemp=wsXFPTemp, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsFanRPM=wsFanRPM, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsTempTable=wsTempTable, wsSFPTransceiver=wsSFPTransceiver, wsSFPTable=wsSFPTable, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsXFPConnector=wsXFPConnector, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTemp=wsSFPTemp, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTXdBmPower=wsSFPTXdBmPower, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsVoltNominal=wsVoltNominal, wsFanEntry=wsFanEntry, wsVoltStatus=wsVoltStatus)
