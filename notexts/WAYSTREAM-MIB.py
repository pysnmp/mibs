...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourUptime=wsNeighbourUptime, wsXFPConnector=wsXFPConnector, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsVoltThresholdLow=wsVoltThresholdLow, wsTempTHYST=wsTempTHYST, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPStatus=wsXFPStatus, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortState=wsNeighbourPortState, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsVersion=wsVersion, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPCopperLen=wsSFPCopperLen, wsSFPBitrate=wsSFPBitrate, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPStatus=wsSFPStatus, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsVoltChannel=wsVoltChannel, wsFanRPM=wsFanRPM, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTransceiverExt=wsSFPTransceiverExt, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPPartNumber=wsSFPPartNumber, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsPolicyTable=wsPolicyTable, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourCreated=wsNeighbourCreated, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortsTable=wsNeighbourPortsTable, wsPolicyCookie=wsPolicyCookie, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTemp=wsSFPTemp, wsSFPIndex=wsSFPIndex, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsPolicyInPkts=wsPolicyInPkts, wsVoltThresholdHigh=wsVoltThresholdHigh, wsTempSensor=wsTempSensor, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPTemp=wsXFPTemp, wsXFPTransceiver=wsXFPTransceiver, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPIndex=wsXFPIndex, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsFanNumber=wsFanNumber, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsPolicyIfName=wsPolicyIfName, wsFanTable=wsFanTable, wsSFPTXPower=wsSFPTXPower, wsPolicyName=wsPolicyName, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPConnector=wsSFPConnector, wsNeighbourDBCount=wsNeighbourDBCount, wsWritedummy=wsWritedummy, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsFanVoltage=wsFanVoltage, wsNeighbourNIndex=wsNeighbourNIndex, wsVoltNominal=wsVoltNominal, wsVoltEntry=wsVoltEntry, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsXFPEntry=wsXFPEntry, wsPolicyInDrops=wsPolicyInDrops, wsSFPEntry=wsSFPEntry, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPBitrateMax=wsXFPBitrateMax, wsTempTable=wsTempTable, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsXFPTempStatus=wsXFPTempStatus, wsXFPTXCurrent=wsXFPTXCurrent, wsSystem=wsSystem, wsNeighbourHostname=wsNeighbourHostname, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTXCurrent=wsSFPTXCurrent, wsVoltTable=wsVoltTable, wsXFPEncoding=wsXFPEncoding, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsTempMeasured=wsTempMeasured, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsPolicyEntry=wsPolicyEntry, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsPolicyInBytes=wsPolicyInBytes, wsNeighboursEntry=wsNeighboursEntry, wsSFPTable=wsSFPTable, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsTempThresholdLow=wsTempThresholdLow, wsTempTOS=wsTempTOS, wsSFPTempNormalLow=wsSFPTempNormalLow, wsIbosTempLow=wsIbosTempLow, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourIfIndex=wsNeighbourIfIndex, wsTempStatus=wsTempStatus, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsVoltStatus=wsVoltStatus, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPTempStatus=wsSFPTempStatus, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourState=wsNeighbourState, wsReload=wsReload, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsIbosVoltHigh=wsIbosVoltHigh, wsEnvironment=wsEnvironment, wsTempEntry=wsTempEntry, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourOSVersion=wsNeighbourOSVersion, wsPolicyOutPkts=wsPolicyOutPkts, wsPFDP=wsPFDP, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsAsrRevision=wsAsrRevision, wsAccounting=wsAccounting, wsSFPVolt=wsSFPVolt, wsXFPRXPower=wsXFPRXPower, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPRXdBmPower=wsSFPRXdBmPower, wsXFPTable=wsXFPTable, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, PYSNMP_MODULE_ID=ibos, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsVoltMeasured=wsVoltMeasured, wsFanEntry=wsFanEntry, wsNeighbourModel=wsNeighbourModel, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPRXPower=wsSFPRXPower, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsVersionString=wsVersionString, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, ibos=ibos)
