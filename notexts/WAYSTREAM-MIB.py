...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsXFPCopperLen=wsXFPCopperLen, wsVoltTable=wsVoltTable, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPTempStatus=wsXFPTempStatus, wsSFPTransceiverExt=wsSFPTransceiverExt, wsPolicyEntry=wsPolicyEntry, wsNeighbourOSVersion=wsNeighbourOSVersion, wsVersion=wsVersion, wsNeighbourUptime=wsNeighbourUptime, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTable=wsSFPTable, wsXFPBitrateMax=wsXFPBitrateMax, wsVersionString=wsVersionString, wsSFPVoltWarningLow=wsSFPVoltWarningLow, PYSNMP_MODULE_ID=ibos, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsAsrRevision=wsAsrRevision, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsPolicyInDrops=wsPolicyInDrops, wsReload=wsReload, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPStatus=wsSFPStatus, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPTransceiver=wsXFPTransceiver, wsEnvironment=wsEnvironment, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsTempTOS=wsTempTOS, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsXFPBitrateMin=wsXFPBitrateMin, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourCreated=wsNeighbourCreated, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTempStatus=wsSFPTempStatus, wsPolicyIfIndex=wsPolicyIfIndex, wsSystem=wsSystem, wsNeighbourState=wsNeighbourState, wsPolicyName=wsPolicyName, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPConnector=wsXFPConnector, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortState=wsNeighbourPortState, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTemp=wsSFPTemp, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPBitrate=wsSFPBitrate, wsFanEntry=wsFanEntry, wsXFPTable=wsXFPTable, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPEncoding=wsSFPEncoding, wsSFPVolt=wsSFPVolt, wsIbosVoltHigh=wsIbosVoltHigh, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsXFPTXPower=wsXFPTXPower, wsFanVoltage=wsFanVoltage, wsTempTable=wsTempTable, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPVoltStatus=wsSFPVoltStatus, wsFanTable=wsFanTable, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsTempEntry=wsTempEntry, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsPFDP=wsPFDP, wsVoltStatus=wsVoltStatus, wsXFPTXCurrent=wsXFPTXCurrent, wsPolicyIfName=wsPolicyIfName, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsXFPEntry=wsXFPEntry, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsTempMeasured=wsTempMeasured, wsFanNumber=wsFanNumber, wsNeighbourModel=wsNeighbourModel, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsIbosTempLow=wsIbosTempLow, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPEntry=wsSFPEntry, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPEncoding=wsXFPEncoding, wsVoltChannel=wsVoltChannel, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, ibos=ibos, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsVoltNominal=wsVoltNominal, wsFanRPM=wsFanRPM, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPStatus=wsXFPStatus, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsPolicyOutBytes=wsPolicyOutBytes, wsPolicyOutDrops=wsPolicyOutDrops, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsPolicyCookie=wsPolicyCookie, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortName=wsNeighbourPortName, wsTempStatus=wsTempStatus, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsIbosVoltLow=wsIbosVoltLow, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsWritedummy=wsWritedummy, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPConnector=wsSFPConnector, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsVoltEntry=wsVoltEntry, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsPolicyTable=wsPolicyTable, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsPolicyInBytes=wsPolicyInBytes, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsTempTHYST=wsTempTHYST, wsIbosTempHigh=wsIbosTempHigh, wsNeighboursTable=wsNeighboursTable, wsSFPRXPower=wsSFPRXPower, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPTXPower=wsSFPTXPower, wsSFPIndex=wsSFPIndex, wsPolicyInPkts=wsPolicyInPkts, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPIndex=wsXFPIndex, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTempNormalLow=wsSFPTempNormalLow, wsTempSensor=wsTempSensor, wsSFPPartNumber=wsSFPPartNumber, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsXFPTemp=wsXFPTemp, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsAccounting=wsAccounting)
