...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPCopperLen=wsXFPCopperLen, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPTXPower=wsSFPTXPower, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPStatus=wsSFPStatus, wsXFPStatus=wsXFPStatus, wsPolicyInBytes=wsPolicyInBytes, wsTempTable=wsTempTable, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsAccounting=wsAccounting, wsFanEntry=wsFanEntry, wsTempEntry=wsTempEntry, wsIbosVoltLow=wsIbosVoltLow, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsTempMeasured=wsTempMeasured, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPConnector=wsXFPConnector, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsVoltChannel=wsVoltChannel, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsWritedummy=wsWritedummy, wsXFPEncoding=wsXFPEncoding, wsVoltNominal=wsVoltNominal, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTempWarningLow=wsSFPTempWarningLow, wsVersion=wsVersion, wsPolicyTable=wsPolicyTable, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsPolicyCookie=wsPolicyCookie, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsPolicyEntry=wsPolicyEntry, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPTable=wsSFPTable, wsXFPTempStatus=wsXFPTempStatus, wsIbosTempHigh=wsIbosTempHigh, wsVersionString=wsVersionString, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPPartNumber=wsSFPPartNumber, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPCopperLen=wsSFPCopperLen, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPRXPower=wsXFPRXPower, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPConnector=wsSFPConnector, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsIbosVoltHigh=wsIbosVoltHigh, ibos=ibos, wsFanTable=wsFanTable, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsXFPTransceiver=wsXFPTransceiver, wsTempStatus=wsTempStatus, wsTempTHYST=wsTempTHYST, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsXFPEntry=wsXFPEntry, wsFanRPM=wsFanRPM, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighboursEntry=wsNeighboursEntry, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourState=wsNeighbourState, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighboursTable=wsNeighboursTable, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPIndex=wsSFPIndex, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsTempTOS=wsTempTOS, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsPolicyInDrops=wsPolicyInDrops, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourModel=wsNeighbourModel, wsIbosTempLow=wsIbosTempLow, wsSFPTransceiver=wsSFPTransceiver, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsEnvironment=wsEnvironment, wsSFPTempStatus=wsSFPTempStatus, wsSFPRXPower=wsSFPRXPower, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsTempSensor=wsTempSensor, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTemp=wsSFPTemp, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSystem=wsSystem, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPEncoding=wsSFPEncoding, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPBitrate=wsSFPBitrate, wsSFPEntry=wsSFPEntry, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsTempThresholdLow=wsTempThresholdLow, wsReload=wsReload, wsSFPVolt=wsSFPVolt, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsXFPTemp=wsXFPTemp, wsNeighbourCreated=wsNeighbourCreated, wsFanVoltage=wsFanVoltage, wsVoltEntry=wsVoltEntry, wsPolicyOutBytes=wsPolicyOutBytes, wsPFDP=wsPFDP, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsPolicyName=wsPolicyName, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsPolicyInPkts=wsPolicyInPkts, wsXFPIndex=wsXFPIndex, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsVoltStatus=wsVoltStatus, wsXFPSingleModeLen=wsXFPSingleModeLen, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortState=wsNeighbourPortState, wsSFPVoltStatus=wsSFPVoltStatus, wsAsrRevision=wsAsrRevision, wsFanNumber=wsFanNumber, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, PYSNMP_MODULE_ID=ibos, wsXFPTable=wsXFPTable, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortName=wsNeighbourPortName, wsVoltTable=wsVoltTable, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets)
