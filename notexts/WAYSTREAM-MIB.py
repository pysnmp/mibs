...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPRXPower=wsXFPRXPower, wsPolicyName=wsPolicyName, wsAsrRevision=wsAsrRevision, wsNeighbourLastAct=wsNeighbourLastAct, wsVoltNominal=wsVoltNominal, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsXFPTempStatus=wsXFPTempStatus, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsXFPConnector=wsXFPConnector, wsFanRPM=wsFanRPM, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighboursEntry=wsNeighboursEntry, wsPFDP=wsPFDP, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPVoltStatus=wsSFPVoltStatus, wsXFPTemp=wsXFPTemp, wsVersion=wsVersion, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPIndex=wsSFPIndex, wsVoltChannel=wsVoltChannel, wsXFPStatus=wsXFPStatus, wsVoltTable=wsVoltTable, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTXPower=wsSFPTXPower, wsSFPConnector=wsSFPConnector, wsWritedummy=wsWritedummy, wsXFPBitrateMin=wsXFPBitrateMin, wsTempThresholdLow=wsTempThresholdLow, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsFanVoltage=wsFanVoltage, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTable=wsSFPTable, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsIbosVoltHigh=wsIbosVoltHigh, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, ibos=ibos, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSystem=wsSystem, wsNeighbourSNPA=wsNeighbourSNPA, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsPolicyUsedCnt=wsPolicyUsedCnt, wsVoltStatus=wsVoltStatus, wsXFPTable=wsXFPTable, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsPolicyIfName=wsPolicyIfName, PYSNMP_MODULE_ID=ibos, wsAccounting=wsAccounting, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPRXPower=wsSFPRXPower, wsSFPPartNumber=wsSFPPartNumber, wsPolicyInDrops=wsPolicyInDrops, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPVolt=wsSFPVolt, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsTempMeasured=wsTempMeasured, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPCopperLen=wsSFPCopperLen, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsFanTable=wsFanTable, wsNeighbourUptime=wsNeighbourUptime, wsVoltEntry=wsVoltEntry, wsNeighboursTable=wsNeighboursTable, wsVersionString=wsVersionString, wsXFPEntry=wsXFPEntry, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPEntry=wsSFPEntry, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsPolicyEntry=wsPolicyEntry, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsVoltThresholdLow=wsVoltThresholdLow, wsPolicyInPkts=wsPolicyInPkts, wsIbosVoltLow=wsIbosVoltLow, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTempStatus=wsSFPTempStatus, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsEnvironment=wsEnvironment, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPBitrate=wsSFPBitrate, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsXFPIndex=wsXFPIndex, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsTempEntry=wsTempEntry, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourState=wsNeighbourState, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsReload=wsReload, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTempWarningLow=wsSFPTempWarningLow, wsTempStatus=wsTempStatus, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPTXPower=wsXFPTXPower, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPStatus=wsSFPStatus, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourHostname=wsNeighbourHostname, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsXFPCopperLen=wsXFPCopperLen, wsTempTHYST=wsTempTHYST, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPSingleModeLen=wsXFPSingleModeLen, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsTempTable=wsTempTable, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTemp=wsSFPTemp, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsXFPBitrateMax=wsXFPBitrateMax, wsPolicyOutPkts=wsPolicyOutPkts, wsFanNumber=wsFanNumber, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsXFPEncoding=wsXFPEncoding, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsPolicyTable=wsPolicyTable, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortState=wsNeighbourPortState, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsFanEntry=wsFanEntry, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsTempSensor=wsTempSensor, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsTempTOS=wsTempTOS, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortsTable=wsNeighbourPortsTable)
