...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsPolicyInPkts=wsPolicyInPkts, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPRXPower=wsSFPRXPower, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPTempNormalLow=wsSFPTempNormalLow, wsXFPBitrateMax=wsXFPBitrateMax, wsFanVoltage=wsFanVoltage, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, PYSNMP_MODULE_ID=ibos, wsTempTHYST=wsTempTHYST, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTransceiver=wsSFPTransceiver, wsXFPCopperLen=wsXFPCopperLen, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPBitrateMin=wsXFPBitrateMin, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPTempStatus=wsSFPTempStatus, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsReload=wsReload, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSystem=wsSystem, wsNeighbourPortState=wsNeighbourPortState, wsTempMeasured=wsTempMeasured, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsPolicyInDrops=wsPolicyInDrops, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsFanTable=wsFanTable, wsTempTOS=wsTempTOS, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsVoltEntry=wsVoltEntry, wsNeighbourModel=wsNeighbourModel, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsFanEntry=wsFanEntry, wsNeighbourNIndex=wsNeighbourNIndex, wsAccounting=wsAccounting, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPTXPower=wsSFPTXPower, wsFanNumber=wsFanNumber, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTXdBmPower=wsSFPTXdBmPower, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPTemp=wsSFPTemp, wsNeighbourPortSNPA=wsNeighbourPortSNPA, ibos=ibos, wsSFPConnector=wsSFPConnector, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsXFPEncoding=wsXFPEncoding, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsVoltTable=wsVoltTable, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPIndex=wsSFPIndex, wsXFPConnector=wsXFPConnector, wsVoltNominal=wsVoltNominal, wsNeighbourLocalIf=wsNeighbourLocalIf, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsXFPTemp=wsXFPTemp, wsNeighbourHostname=wsNeighbourHostname, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPPartNumber=wsSFPPartNumber, wsPolicyName=wsPolicyName, wsNeighbourState=wsNeighbourState, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPTransceiver=wsXFPTransceiver, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPEntry=wsSFPEntry, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPEntry=wsXFPEntry, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortName=wsNeighbourPortName, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighboursEntry=wsNeighboursEntry, wsPolicyCookie=wsPolicyCookie, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourIfIndex=wsNeighbourIfIndex, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsTempSensor=wsTempSensor, wsVoltChannel=wsVoltChannel, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighboursTable=wsNeighboursTable, wsTempStatus=wsTempStatus, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPBitrate=wsSFPBitrate, wsFanRPM=wsFanRPM, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsXFPStatus=wsXFPStatus, wsXFPTable=wsXFPTable, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsXFPTXPower=wsXFPTXPower, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPVolt=wsSFPVolt, wsPolicyInBytes=wsPolicyInBytes, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsXFPRXPower=wsXFPRXPower, wsSFPStatus=wsSFPStatus, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsTempTable=wsTempTable, wsVersionString=wsVersionString, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPRXdBmPower=wsSFPRXdBmPower, wsXFPSingleModeLen=wsXFPSingleModeLen, wsVersion=wsVersion, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsAsrRevision=wsAsrRevision, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsTempEntry=wsTempEntry, wsSFPTable=wsSFPTable, wsSFPCopperLen=wsSFPCopperLen, wsXFPIndex=wsXFPIndex, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsPolicyTable=wsPolicyTable, wsPFDP=wsPFDP, wsWritedummy=wsWritedummy, wsTempThresholdHigh=wsTempThresholdHigh, wsEnvironment=wsEnvironment, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPEncoding=wsSFPEncoding, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsVoltStatus=wsVoltStatus)
