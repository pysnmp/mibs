...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsFanEntry=wsFanEntry, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPStatus=wsSFPStatus, wsXFPEncoding=wsXFPEncoding, wsFanTable=wsFanTable, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsTempTHYST=wsTempTHYST, wsNeighbourModel=wsNeighbourModel, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsTempTable=wsTempTable, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPEntry=wsSFPEntry, wsXFPTable=wsXFPTable, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsPolicyInDrops=wsPolicyInDrops, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsVoltNominal=wsVoltNominal, wsSystem=wsSystem, wsVoltTable=wsVoltTable, wsXFPTXCurrent=wsXFPTXCurrent, wsFanVoltage=wsFanVoltage, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsVoltMeasured=wsVoltMeasured, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsPolicyInBytes=wsPolicyInBytes, wsXFPConnector=wsXFPConnector, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsXFPStatus=wsXFPStatus, wsTempStatus=wsTempStatus, wsIbosFanRPMLow=wsIbosFanRPMLow, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsTempThresholdHigh=wsTempThresholdHigh, wsEnvironment=wsEnvironment, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourState=wsNeighbourState, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourNIndex=wsNeighbourNIndex, wsVoltEntry=wsVoltEntry, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTemp=wsSFPTemp, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsIbosTempLow=wsIbosTempLow, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPVolt=wsSFPVolt, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsAccounting=wsAccounting, wsNeighbourIfIndex=wsNeighbourIfIndex, wsPolicyName=wsPolicyName, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsFanRPM=wsFanRPM, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPIndex=wsSFPIndex, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsXFPEntry=wsXFPEntry, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsTempMeasured=wsTempMeasured, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortName=wsNeighbourPortName, wsReload=wsReload, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPIndex=wsXFPIndex, wsSFPPartNumber=wsSFPPartNumber, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTXPower=wsSFPTXPower, wsTempTOS=wsTempTOS, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsVersionString=wsVersionString, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsVoltStatus=wsVoltStatus, wsXFPTemp=wsXFPTemp, wsSFPTable=wsSFPTable, wsXFPSingleModeLen=wsXFPSingleModeLen, wsTempSensor=wsTempSensor, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsPolicyCookie=wsPolicyCookie, wsTempEntry=wsTempEntry, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPRXPower=wsSFPRXPower, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXCurrent=wsSFPTXCurrent, wsPolicyTable=wsPolicyTable, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourHostname=wsNeighbourHostname, wsPolicyEntry=wsPolicyEntry, wsFanNumber=wsFanNumber, wsXFPTransceiver=wsXFPTransceiver, wsNeighboursTable=wsNeighboursTable, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPCopperLen=wsSFPCopperLen, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsPolicyIfName=wsPolicyIfName, wsWritedummy=wsWritedummy, wsXFPTXPower=wsXFPTXPower, wsPFDP=wsPFDP, wsNeighboursEntry=wsNeighboursEntry, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPConnector=wsSFPConnector, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsPolicyOutBytes=wsPolicyOutBytes, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourUptime=wsNeighbourUptime, wsXFPRXPower=wsXFPRXPower, wsAsrRevision=wsAsrRevision, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsXFPTempStatus=wsXFPTempStatus, wsSFPBitrate=wsSFPBitrate, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsVersion=wsVersion, wsVoltChannel=wsVoltChannel, wsTempThresholdLow=wsTempThresholdLow, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPVoltStatus=wsSFPVoltStatus, PYSNMP_MODULE_ID=ibos, wsSFPSingleModeLen=wsSFPSingleModeLen, ibos=ibos, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex)
