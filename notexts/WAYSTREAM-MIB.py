...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPConnector=wsSFPConnector, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsVersion=wsVersion, wsPolicyEntry=wsPolicyEntry, wsPolicyName=wsPolicyName, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsTempTHYST=wsTempTHYST, wsReload=wsReload, wsVoltEntry=wsVoltEntry, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPRXPower=wsSFPRXPower, wsNeighbourDBCount=wsNeighbourDBCount, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPCopperLen=wsSFPCopperLen, wsSFPIndex=wsSFPIndex, wsSFPTempStatus=wsSFPTempStatus, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPTransceiverExt=wsSFPTransceiverExt, wsTempMeasured=wsTempMeasured, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsXFPStatus=wsXFPStatus, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPEntry=wsXFPEntry, wsTempTOS=wsTempTOS, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsPolicyUsedCnt=wsPolicyUsedCnt, wsAccounting=wsAccounting, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPEntry=wsSFPEntry, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourState=wsNeighbourState, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsIbosTempLow=wsIbosTempLow, wsSFPPartNumber=wsSFPPartNumber, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourModel=wsNeighbourModel, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPEncoding=wsSFPEncoding, wsXFPTable=wsXFPTable, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsFanVoltage=wsFanVoltage, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourSNPA=wsNeighbourSNPA, wsWritedummy=wsWritedummy, wsVoltNominal=wsVoltNominal, wsXFPCopperLen=wsXFPCopperLen, wsTempSensor=wsTempSensor, wsFanTable=wsFanTable, wsXFPRXPower=wsXFPRXPower, wsXFPEncoding=wsXFPEncoding, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPVolt=wsSFPVolt, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPTXPower=wsXFPTXPower, wsXFPTemp=wsXFPTemp, wsSFPVoltStatus=wsSFPVoltStatus, wsXFPSingleModeLen=wsXFPSingleModeLen, wsFanNumber=wsFanNumber, wsPFDP=wsPFDP, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsVoltStatus=wsVoltStatus, wsPolicyTable=wsPolicyTable, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsFanRPM=wsFanRPM, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourHostname=wsNeighbourHostname, wsSFPTable=wsSFPTable, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighboursTable=wsNeighboursTable, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPIndex=wsXFPIndex, wsNeighboursEntry=wsNeighboursEntry, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsTempTable=wsTempTable, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsPolicyIfName=wsPolicyIfName, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsVersionString=wsVersionString, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, PYSNMP_MODULE_ID=ibos, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourOSVersion=wsNeighbourOSVersion, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTemp=wsSFPTemp, wsSFPStatus=wsSFPStatus, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsPolicyCookie=wsPolicyCookie, wsVoltTable=wsVoltTable, wsFanEntry=wsFanEntry, wsSFPSerialNumber=wsSFPSerialNumber, wsEnvironment=wsEnvironment, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSystem=wsSystem, wsXFPTXCurrent=wsXFPTXCurrent, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsAsrRevision=wsAsrRevision, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsPolicyInPkts=wsPolicyInPkts, wsXFPConnector=wsXFPConnector, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourCreated=wsNeighbourCreated, wsPolicyInBytes=wsPolicyInBytes, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsVoltMeasured=wsVoltMeasured, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortName=wsNeighbourPortName, wsTempEntry=wsTempEntry, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourLastAct=wsNeighbourLastAct, wsVoltChannel=wsVoltChannel, ibos=ibos, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPTempStatus=wsXFPTempStatus, wsXFPTransceiver=wsXFPTransceiver, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortsTable=wsNeighbourPortsTable, wsTempStatus=wsTempStatus, wsSFPTXPower=wsSFPTXPower, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm)
