...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsPolicyOutPkts=wsPolicyOutPkts, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsPolicyInDrops=wsPolicyInDrops, wsFanRPM=wsFanRPM, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsIbosFanRPMLow=wsIbosFanRPMLow, PYSNMP_MODULE_ID=ibos, wsFanTable=wsFanTable, wsXFPTransceiver=wsXFPTransceiver, wsXFPTemp=wsXFPTemp, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPTable=wsSFPTable, wsPFDP=wsPFDP, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, ibos=ibos, wsXFPSingleModeLen=wsXFPSingleModeLen, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsTempTHYST=wsTempTHYST, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsWritedummy=wsWritedummy, wsPolicyEntry=wsPolicyEntry, wsSystem=wsSystem, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsAccounting=wsAccounting, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsVoltTable=wsVoltTable, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPTempStatus=wsSFPTempStatus, wsSFPStatus=wsSFPStatus, wsFanVoltage=wsFanVoltage, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsFanEntry=wsFanEntry, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsFanNumber=wsFanNumber, wsSFPConnector=wsSFPConnector, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTempWarningLow=wsSFPTempWarningLow, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourUptime=wsNeighbourUptime, wsSFPVolt=wsSFPVolt, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsTempSensor=wsTempSensor, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsVoltStatus=wsVoltStatus, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsEnvironment=wsEnvironment, wsNeighboursTable=wsNeighboursTable, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPIndex=wsSFPIndex, wsXFPTable=wsXFPTable, wsNeighbourModel=wsNeighbourModel, wsPolicyTable=wsPolicyTable, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPEncoding=wsSFPEncoding, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortState=wsNeighbourPortState, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsVoltChannel=wsVoltChannel, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPEntry=wsSFPEntry, wsPolicyInPkts=wsPolicyInPkts, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsVoltEntry=wsVoltEntry, wsIbosVoltLow=wsIbosVoltLow, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPConnector=wsXFPConnector, wsTempTOS=wsTempTOS, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsXFPTempStatus=wsXFPTempStatus, wsTempStatus=wsTempStatus, wsSFPTXPower=wsSFPTXPower, wsTempMeasured=wsTempMeasured, wsSFPTransceiver=wsSFPTransceiver, wsSFPRXPower=wsSFPRXPower, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsAsrRevision=wsAsrRevision, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsReload=wsReload, wsVoltMeasured=wsVoltMeasured, wsPolicyCookie=wsPolicyCookie, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourIfIndex=wsNeighbourIfIndex, wsXFPBitrateMin=wsXFPBitrateMin, wsXFPRXPower=wsXFPRXPower, wsVoltNominal=wsVoltNominal, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsPolicyName=wsPolicyName, wsXFPEntry=wsXFPEntry, wsIbosTempLow=wsIbosTempLow, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourState=wsNeighbourState, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPStatus=wsXFPStatus, wsNeighbourPortsTable=wsNeighbourPortsTable, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsTempEntry=wsTempEntry, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTemp=wsSFPTemp, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPBitrate=wsSFPBitrate, wsVoltThresholdLow=wsVoltThresholdLow, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourCreated=wsNeighbourCreated, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPIndex=wsXFPIndex, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsVersionString=wsVersionString, wsSFPSingleModeLen=wsSFPSingleModeLen, wsVersion=wsVersion, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortName=wsNeighbourPortName, wsSFPCopperLen=wsSFPCopperLen, wsTempTable=wsTempTable, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighboursEntry=wsNeighboursEntry, wsXFPMultiMode50Len=wsXFPMultiMode50Len)
