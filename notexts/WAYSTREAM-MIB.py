...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsPolicyTable=wsPolicyTable, wsVoltNominal=wsVoltNominal, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsVoltTable=wsVoltTable, wsNeighbourModel=wsNeighbourModel, wsFanTable=wsFanTable, wsTempTable=wsTempTable, wsSFPIndex=wsSFPIndex, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsFanRPM=wsFanRPM, wsNeighboursTable=wsNeighboursTable, wsXFPConnector=wsXFPConnector, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsPolicyIfIndex=wsPolicyIfIndex, wsPolicyCookie=wsPolicyCookie, wsVoltStatus=wsVoltStatus, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPTemp=wsSFPTemp, wsXFPIndex=wsXFPIndex, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsXFPRXPower=wsXFPRXPower, wsWritedummy=wsWritedummy, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsVersionString=wsVersionString, wsSFPBitrate=wsSFPBitrate, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPTable=wsSFPTable, wsTempTHYST=wsTempTHYST, wsSFPStatus=wsSFPStatus, wsSFPEntry=wsSFPEntry, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsTempEntry=wsTempEntry, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPTransceiver=wsXFPTransceiver, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsXFPStatus=wsXFPStatus, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPRXdBmPower=wsSFPRXdBmPower, wsFanNumber=wsFanNumber, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsVersion=wsVersion, wsPolicyUsedCnt=wsPolicyUsedCnt, ibos=ibos, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsTempTOS=wsTempTOS, wsReload=wsReload, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourNIndex=wsNeighbourNIndex, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsAsrRevision=wsAsrRevision, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSystem=wsSystem, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPTXPower=wsSFPTXPower, wsNeighbourState=wsNeighbourState, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsTempThresholdLow=wsTempThresholdLow, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsXFPSingleModeLen=wsXFPSingleModeLen, wsXFPTable=wsXFPTable, wsNeighbourPortState=wsNeighbourPortState, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsPolicyInDrops=wsPolicyInDrops, wsXFPBitrateMax=wsXFPBitrateMax, wsPolicyEntry=wsPolicyEntry, wsPolicyName=wsPolicyName, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsTempSensor=wsTempSensor, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourCreated=wsNeighbourCreated, wsVoltThresholdHigh=wsVoltThresholdHigh, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXdBmPower=wsSFPTXdBmPower, wsXFPCopperLen=wsXFPCopperLen, wsSFPVolt=wsSFPVolt, wsFanVoltage=wsFanVoltage, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPPartNumber=wsSFPPartNumber, wsSFPEncoding=wsSFPEncoding, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsPolicyInPkts=wsPolicyInPkts, wsIbosVoltLow=wsIbosVoltLow, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsXFPTempStatus=wsXFPTempStatus, wsFanEntry=wsFanEntry, wsIbosTempHigh=wsIbosTempHigh, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsVoltEntry=wsVoltEntry, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsIbosTempLow=wsIbosTempLow, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsXFPEncoding=wsXFPEncoding, wsIbosFanRPMLow=wsIbosFanRPMLow, wsPFDP=wsPFDP, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsAccounting=wsAccounting, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsPolicyInBytes=wsPolicyInBytes, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsTempStatus=wsTempStatus, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTempStatus=wsSFPTempStatus, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortsTable=wsNeighbourPortsTable, wsPolicyIfName=wsPolicyIfName, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPConnector=wsSFPConnector, wsPolicyOutDrops=wsPolicyOutDrops, wsEnvironment=wsEnvironment, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsVoltChannel=wsVoltChannel, wsXFPEntry=wsXFPEntry, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, PYSNMP_MODULE_ID=ibos, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsTempMeasured=wsTempMeasured, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPTemp=wsXFPTemp, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm)
