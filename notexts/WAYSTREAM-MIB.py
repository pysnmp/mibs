...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsFanVoltage=wsFanVoltage, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsPolicyInPkts=wsPolicyInPkts, wsNeighboursEntry=wsNeighboursEntry, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsReload=wsReload, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourIfIndex=wsNeighbourIfIndex, wsFanNumber=wsFanNumber, wsSFPRXPower=wsSFPRXPower, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPStatus=wsSFPStatus, wsSFPEntry=wsSFPEntry, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSystem=wsSystem, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsXFPRXPower=wsXFPRXPower, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourOSVersion=wsNeighbourOSVersion, wsTempMeasured=wsTempMeasured, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourUptime=wsNeighbourUptime, wsPolicyName=wsPolicyName, wsFanEntry=wsFanEntry, wsTempTOS=wsTempTOS, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsFanTable=wsFanTable, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPVolt=wsSFPVolt, wsIbosTempHigh=wsIbosTempHigh, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPIndex=wsSFPIndex, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsXFPConnector=wsXFPConnector, wsVoltEntry=wsVoltEntry, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPTransceiver=wsXFPTransceiver, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourLocalIf=wsNeighbourLocalIf, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsTempSensor=wsTempSensor, wsSFPVoltStatus=wsSFPVoltStatus, wsXFPEntry=wsXFPEntry, wsXFPTXCurrent=wsXFPTXCurrent, wsTempTable=wsTempTable, wsAsrRevision=wsAsrRevision, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTransceiver=wsSFPTransceiver, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsVoltChannel=wsVoltChannel, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPSingleModeLen=wsSFPSingleModeLen, wsFanRPM=wsFanRPM, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsTempStatus=wsTempStatus, wsXFPTempStatus=wsXFPTempStatus, wsXFPCopperLen=wsXFPCopperLen, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, ibos=ibos, PYSNMP_MODULE_ID=ibos, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsPFDP=wsPFDP, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsEnvironment=wsEnvironment, wsVoltTable=wsVoltTable, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsPolicyCookie=wsPolicyCookie, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsXFPTXPower=wsXFPTXPower, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsAccounting=wsAccounting, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortName=wsNeighbourPortName, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPTempStatus=wsSFPTempStatus, wsTempThresholdLow=wsTempThresholdLow, wsXFPTable=wsXFPTable, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsWritedummy=wsWritedummy, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPPartNumber=wsSFPPartNumber, wsVoltNominal=wsVoltNominal, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsTempTHYST=wsTempTHYST, wsTempThresholdHigh=wsTempThresholdHigh, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsPolicyEntry=wsPolicyEntry, wsNeighbourNIndex=wsNeighbourNIndex, wsXFPIndex=wsXFPIndex, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsPolicyInBytes=wsPolicyInBytes, wsVersion=wsVersion, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsIbosTempLow=wsIbosTempLow, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsIbosVoltHigh=wsIbosVoltHigh, wsTempEntry=wsTempEntry, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsVoltMeasured=wsVoltMeasured, wsVoltStatus=wsVoltStatus, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPCopperLen=wsSFPCopperLen, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourModel=wsNeighbourModel, wsVersionString=wsVersionString, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTemp=wsSFPTemp, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsPolicyTable=wsPolicyTable, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPTemp=wsXFPTemp, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPTable=wsSFPTable, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPConnector=wsSFPConnector, wsXFPStatus=wsXFPStatus, wsIbosFanRPMLow=wsIbosFanRPMLow, wsPolicyIfName=wsPolicyIfName, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPEncoding=wsSFPEncoding, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourState=wsNeighbourState, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighboursTable=wsNeighboursTable)
