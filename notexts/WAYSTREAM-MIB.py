...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsReload=wsReload, wsXFPTable=wsXFPTable, wsSFPVolt=wsSFPVolt, wsSFPIndex=wsSFPIndex, wsNeighbourUptime=wsNeighbourUptime, wsPFDP=wsPFDP, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsXFPTXCurrent=wsXFPTXCurrent, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPRXPower=wsXFPRXPower, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPTemp=wsXFPTemp, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsAsrRevision=wsAsrRevision, wsXFPCopperLen=wsXFPCopperLen, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsTempEntry=wsTempEntry, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsXFPIndex=wsXFPIndex, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsPolicyIfName=wsPolicyIfName, wsXFPTransceiver=wsXFPTransceiver, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsTempSensor=wsTempSensor, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPPartNumber=wsSFPPartNumber, wsXFPConnector=wsXFPConnector, wsEnvironment=wsEnvironment, wsTempMeasured=wsTempMeasured, wsFanTable=wsFanTable, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPStatus=wsSFPStatus, wsVoltStatus=wsVoltStatus, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPStatus=wsXFPStatus, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTempWarningLow=wsSFPTempWarningLow, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourOSVersion=wsNeighbourOSVersion, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTemp=wsSFPTemp, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPTXPower=wsXFPTXPower, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPBitrate=wsSFPBitrate, wsNeighbourDBCount=wsNeighbourDBCount, wsPolicyOutBytes=wsPolicyOutBytes, wsTempTable=wsTempTable, wsVoltNominal=wsVoltNominal, wsSFPRXdBmPower=wsSFPRXdBmPower, wsXFPBitrateMax=wsXFPBitrateMax, wsFanVoltage=wsFanVoltage, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourState=wsNeighbourState, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTable=wsSFPTable, wsFanRPM=wsFanRPM, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsVoltTable=wsVoltTable, wsSystem=wsSystem, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsTempThresholdLow=wsTempThresholdLow, wsTempTHYST=wsTempTHYST, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsIbosVoltHigh=wsIbosVoltHigh, wsVersion=wsVersion, wsPolicyTable=wsPolicyTable, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourModel=wsNeighbourModel, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPEntry=wsSFPEntry, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsXFPTempStatus=wsXFPTempStatus, wsSFPRXPower=wsSFPRXPower, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsVoltMeasured=wsVoltMeasured, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortName=wsNeighbourPortName, wsSFPTempNormalLow=wsSFPTempNormalLow, wsTempTOS=wsTempTOS, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPEntry=wsXFPEntry, wsVoltEntry=wsVoltEntry, wsFanNumber=wsFanNumber, wsPolicyInBytes=wsPolicyInBytes, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsVoltThresholdLow=wsVoltThresholdLow, ibos=ibos, wsNeighboursEntry=wsNeighboursEntry, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsVersionString=wsVersionString, wsFanEntry=wsFanEntry, wsSFPTXPower=wsSFPTXPower, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPCopperLen=wsSFPCopperLen, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPEncoding=wsSFPEncoding, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, PYSNMP_MODULE_ID=ibos, wsNeighbourSNPA=wsNeighbourSNPA, wsVoltChannel=wsVoltChannel, wsSFPConnector=wsSFPConnector, wsSFPTempStatus=wsSFPTempStatus, wsTempStatus=wsTempStatus, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsWritedummy=wsWritedummy, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsIbosTempLow=wsIbosTempLow, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsPolicyInPkts=wsPolicyInPkts, wsAccounting=wsAccounting, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsPolicyName=wsPolicyName)
