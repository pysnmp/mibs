...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPRXPower=wsXFPRXPower, wsNeighbourCreated=wsNeighbourCreated, wsPFDP=wsPFDP, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsXFPSingleModeLen=wsXFPSingleModeLen, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsXFPTemp=wsXFPTemp, wsPolicyCookie=wsPolicyCookie, wsFanEntry=wsFanEntry, wsPolicyEntry=wsPolicyEntry, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsPolicyName=wsPolicyName, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPTXPower=wsXFPTXPower, wsSystem=wsSystem, wsNeighbourModel=wsNeighbourModel, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPIndex=wsSFPIndex, wsReload=wsReload, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsWritedummy=wsWritedummy, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsXFPEncoding=wsXFPEncoding, wsAsrRevision=wsAsrRevision, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsPolicyInBytes=wsPolicyInBytes, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsXFPEntry=wsXFPEntry, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsVoltNominal=wsVoltNominal, wsPolicyOutPkts=wsPolicyOutPkts, wsFanVoltage=wsFanVoltage, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsFanRPM=wsFanRPM, wsNeighbourHostname=wsNeighbourHostname, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsPolicyInDrops=wsPolicyInDrops, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTemp=wsSFPTemp, wsPolicyIfName=wsPolicyIfName, wsIbosTempHigh=wsIbosTempHigh, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourSNPA=wsNeighbourSNPA, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourState=wsNeighbourState, wsSFPTempStatus=wsSFPTempStatus, ibos=ibos, wsSFPRXdBmPower=wsSFPRXdBmPower, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsAccounting=wsAccounting, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsTempTOS=wsTempTOS, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPBitrate=wsSFPBitrate, wsVoltChannel=wsVoltChannel, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourIfIndex=wsNeighbourIfIndex, wsXFPTransceiver=wsXFPTransceiver, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsTempEntry=wsTempEntry, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPTable=wsXFPTable, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPCopperLen=wsSFPCopperLen, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsTempSensor=wsTempSensor, wsVoltMeasured=wsVoltMeasured, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourUptime=wsNeighbourUptime, wsXFPConnector=wsXFPConnector, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsPolicyTable=wsPolicyTable, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsTempMeasured=wsTempMeasured, wsSFPEntry=wsSFPEntry, wsSFPConnector=wsSFPConnector, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsVoltEntry=wsVoltEntry, wsNeighbourOSVersion=wsNeighbourOSVersion, wsPolicyInPkts=wsPolicyInPkts, wsVoltStatus=wsVoltStatus, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTXPower=wsSFPTXPower, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTable=wsSFPTable, wsEnvironment=wsEnvironment, wsTempStatus=wsTempStatus, wsXFPStatus=wsXFPStatus, wsXFPTempStatus=wsXFPTempStatus, wsTempThresholdLow=wsTempThresholdLow, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPPartNumber=wsSFPPartNumber, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPStatus=wsSFPStatus, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPVolt=wsSFPVolt, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTXdBmPower=wsSFPTXdBmPower, wsTempTable=wsTempTable, wsVoltTable=wsVoltTable, wsSFPRXPower=wsSFPRXPower, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, PYSNMP_MODULE_ID=ibos, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTempNormalLow=wsSFPTempNormalLow, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsTempTHYST=wsTempTHYST, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsVersion=wsVersion, wsXFPIndex=wsXFPIndex, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsIbosTempLow=wsIbosTempLow, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsVersionString=wsVersionString, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsFanNumber=wsFanNumber, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsFanTable=wsFanTable)
