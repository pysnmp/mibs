...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourModel=wsNeighbourModel, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsXFPSingleModeLen=wsXFPSingleModeLen, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPTXPower=wsXFPTXPower, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPBitrateMax=wsXFPBitrateMax, wsAccounting=wsAccounting, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourUptime=wsNeighbourUptime, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsFanNumber=wsFanNumber, wsPolicyEntry=wsPolicyEntry, wsTempMeasured=wsTempMeasured, wsTempThresholdLow=wsTempThresholdLow, wsPolicyCookie=wsPolicyCookie, wsVoltTable=wsVoltTable, wsSystem=wsSystem, wsTempSensor=wsTempSensor, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPBitrate=wsSFPBitrate, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsPolicyInDrops=wsPolicyInDrops, wsXFPTransceiver=wsXFPTransceiver, wsVoltNominal=wsVoltNominal, wsPolicyUsedCnt=wsPolicyUsedCnt, wsTempTHYST=wsTempTHYST, wsIbosVoltLow=wsIbosVoltLow, ibos=ibos, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsVoltChannel=wsVoltChannel, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsPolicyTable=wsPolicyTable, wsVersionString=wsVersionString, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPConnector=wsSFPConnector, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPStatus=wsSFPStatus, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPPartNumber=wsSFPPartNumber, wsTempThresholdHigh=wsTempThresholdHigh, PYSNMP_MODULE_ID=ibos, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsVoltEntry=wsVoltEntry, wsFanEntry=wsFanEntry, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourState=wsNeighbourState, wsVersion=wsVersion, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsXFPBitrateMin=wsXFPBitrateMin, wsXFPRXPower=wsXFPRXPower, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsAsrRevision=wsAsrRevision, wsPFDP=wsPFDP, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsXFPIndex=wsXFPIndex, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPTemp=wsSFPTemp, wsReload=wsReload, wsSFPVolt=wsSFPVolt, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsTempStatus=wsTempStatus, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPEncoding=wsSFPEncoding, wsXFPCopperLen=wsXFPCopperLen, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsIbosVoltHigh=wsIbosVoltHigh, wsFanVoltage=wsFanVoltage, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsXFPConnector=wsXFPConnector, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsXFPEncoding=wsXFPEncoding, wsEnvironment=wsEnvironment, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsVoltThresholdLow=wsVoltThresholdLow, wsXFPStatus=wsXFPStatus, wsTempTable=wsTempTable, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsXFPTempStatus=wsXFPTempStatus, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsVoltStatus=wsVoltStatus, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsXFPTable=wsXFPTable, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsFanRPM=wsFanRPM, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighboursTable=wsNeighboursTable, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsIbosTempLow=wsIbosTempLow, wsPolicyInPkts=wsPolicyInPkts, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsXFPEntry=wsXFPEntry, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPTempStatus=wsSFPTempStatus, wsPolicyName=wsPolicyName, wsPolicyIfIndex=wsPolicyIfIndex, wsFanTable=wsFanTable, wsSFPRXPower=wsSFPRXPower, wsWritedummy=wsWritedummy, wsTempEntry=wsTempEntry, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPTable=wsSFPTable, wsTempTOS=wsTempTOS, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsPolicyIfName=wsPolicyIfName, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPIndex=wsSFPIndex, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPEntry=wsSFPEntry, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPTemp=wsXFPTemp, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex)
