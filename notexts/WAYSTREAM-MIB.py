...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsEnvironment=wsEnvironment, wsFanVoltage=wsFanVoltage, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsVoltMeasured=wsVoltMeasured, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPStatus=wsSFPStatus, wsXFPCopperLen=wsXFPCopperLen, wsFanTable=wsFanTable, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsPolicyTable=wsPolicyTable, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortName=wsNeighbourPortName, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSystem=wsSystem, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPTXPower=wsSFPTXPower, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourIfIndex=wsNeighbourIfIndex, wsPolicyInPkts=wsPolicyInPkts, wsTempSensor=wsTempSensor, wsNeighbourOSVersion=wsNeighbourOSVersion, wsTempThresholdHigh=wsTempThresholdHigh, wsVoltEntry=wsVoltEntry, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPStatus=wsXFPStatus, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsPolicyCookie=wsPolicyCookie, wsSFPTable=wsSFPTable, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsPolicyInDrops=wsPolicyInDrops, wsSFPTransceiverExt=wsSFPTransceiverExt, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPSingleModeLen=wsXFPSingleModeLen, wsIbosVoltHigh=wsIbosVoltHigh, wsXFPTransceiver=wsXFPTransceiver, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsTempEntry=wsTempEntry, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPVolt=wsSFPVolt, wsTempMeasured=wsTempMeasured, wsFanRPM=wsFanRPM, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsVersion=wsVersion, wsTempTHYST=wsTempTHYST, wsTempStatus=wsTempStatus, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsVoltTable=wsVoltTable, wsVoltStatus=wsVoltStatus, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPEncoding=wsXFPEncoding, wsSFPVoltStatus=wsSFPVoltStatus, wsAccounting=wsAccounting, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourModel=wsNeighbourModel, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPIndex=wsSFPIndex, wsPFDP=wsPFDP, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPRXPower=wsSFPRXPower, wsSFPTemp=wsSFPTemp, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPCopperLen=wsSFPCopperLen, wsXFPTempStatus=wsXFPTempStatus, wsXFPConnector=wsXFPConnector, wsAsrRevision=wsAsrRevision, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsVoltThresholdHigh=wsVoltThresholdHigh, wsVersionString=wsVersionString, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsXFPTable=wsXFPTable, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsFanEntry=wsFanEntry, wsSFPTempStatus=wsSFPTempStatus, wsXFPEntry=wsXFPEntry, wsTempThresholdLow=wsTempThresholdLow, wsSFPBitrate=wsSFPBitrate, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsPolicyName=wsPolicyName, wsFanNumber=wsFanNumber, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourCreated=wsNeighbourCreated, wsSFPEntry=wsSFPEntry, wsReload=wsReload, wsWritedummy=wsWritedummy, wsSFPTransceiver=wsSFPTransceiver, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPIndex=wsXFPIndex, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourDBCount=wsNeighbourDBCount, wsPolicyOutPkts=wsPolicyOutPkts, wsTempTable=wsTempTable, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourState=wsNeighbourState, wsXFPTXPower=wsXFPTXPower, wsNeighbourUptime=wsNeighbourUptime, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsIbosVoltLow=wsIbosVoltLow, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsVoltChannel=wsVoltChannel, wsXFPTemp=wsXFPTemp, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsVoltNominal=wsVoltNominal, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTXCurrent=wsSFPTXCurrent, wsTempTOS=wsTempTOS, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, PYSNMP_MODULE_ID=ibos, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighboursTable=wsNeighboursTable, wsSFPEncoding=wsSFPEncoding, wsPolicyIfName=wsPolicyIfName, wsVoltThresholdLow=wsVoltThresholdLow, wsIbosTempLow=wsIbosTempLow, ibos=ibos, wsSFPConnector=wsSFPConnector, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighboursEntry=wsNeighboursEntry, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable)
