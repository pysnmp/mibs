...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsIbosFanRPMLow=wsIbosFanRPMLow, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsAsrRevision=wsAsrRevision, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsVoltStatus=wsVoltStatus, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsXFPStatus=wsXFPStatus, wsVersion=wsVersion, wsWritedummy=wsWritedummy, wsTempThresholdHigh=wsTempThresholdHigh, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsPolicyCookie=wsPolicyCookie, wsXFPIndex=wsXFPIndex, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourState=wsNeighbourState, wsIbosVoltLow=wsIbosVoltLow, wsFanNumber=wsFanNumber, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsFanTable=wsFanTable, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsPolicyIfName=wsPolicyIfName, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsPolicyOutDrops=wsPolicyOutDrops, PYSNMP_MODULE_ID=ibos, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourCreated=wsNeighbourCreated, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPEntry=wsXFPEntry, wsSFPEncoding=wsSFPEncoding, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTable=wsSFPTable, wsNeighbourDBCount=wsNeighbourDBCount, wsXFPEncoding=wsXFPEncoding, wsSFPTXCurrent=wsSFPTXCurrent, wsPolicyTable=wsPolicyTable, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsFanRPM=wsFanRPM, wsIbosTempHigh=wsIbosTempHigh, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPConnector=wsSFPConnector, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPPartNumber=wsSFPPartNumber, wsVoltEntry=wsVoltEntry, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortState=wsNeighbourPortState, wsXFPTXPower=wsXFPTXPower, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsTempThresholdLow=wsTempThresholdLow, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsAccounting=wsAccounting, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsIbosTempLow=wsIbosTempLow, wsVoltMeasured=wsVoltMeasured, wsTempStatus=wsTempStatus, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortName=wsNeighbourPortName, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPTable=wsXFPTable, wsXFPSingleModeLen=wsXFPSingleModeLen, wsTempEntry=wsTempEntry, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighboursTable=wsNeighboursTable, wsSFPTemp=wsSFPTemp, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, ibos=ibos, wsTempTHYST=wsTempTHYST, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsVoltChannel=wsVoltChannel, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPBitrate=wsSFPBitrate, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsFanEntry=wsFanEntry, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighboursEntry=wsNeighboursEntry, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsEnvironment=wsEnvironment, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPConnector=wsXFPConnector, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTXPower=wsSFPTXPower, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPStatus=wsSFPStatus, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsTempMeasured=wsTempMeasured, wsSFPTempStatus=wsSFPTempStatus, wsSFPEntry=wsSFPEntry, wsFanVoltage=wsFanVoltage, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsPolicyName=wsPolicyName, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsTempSensor=wsTempSensor, wsSFPVolt=wsSFPVolt, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsReload=wsReload, wsVersionString=wsVersionString, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsVoltNominal=wsVoltNominal, wsXFPTemp=wsXFPTemp, wsSFPSerialNumber=wsSFPSerialNumber, wsPolicyEntry=wsPolicyEntry, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsTempTOS=wsTempTOS, wsPolicyInPkts=wsPolicyInPkts, wsSystem=wsSystem, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsVoltTable=wsVoltTable, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPIndex=wsSFPIndex, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsXFPRXPower=wsXFPRXPower, wsSFPRXPower=wsSFPRXPower, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsPFDP=wsPFDP, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsTempTable=wsTempTable)
