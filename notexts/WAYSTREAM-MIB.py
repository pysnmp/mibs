...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsEnvironment=wsEnvironment, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsTempTOS=wsTempTOS, wsPolicyName=wsPolicyName, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourOSVersion=wsNeighbourOSVersion, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourSNPA=wsNeighbourSNPA, wsSystem=wsSystem, wsPolicyCookie=wsPolicyCookie, wsTempEntry=wsTempEntry, wsFanVoltage=wsFanVoltage, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPEntry=wsXFPEntry, wsPolicyTable=wsPolicyTable, wsXFPConnector=wsXFPConnector, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsPolicyInPkts=wsPolicyInPkts, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTable=wsSFPTable, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsVoltTable=wsVoltTable, wsPFDP=wsPFDP, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsVersion=wsVersion, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortName=wsNeighbourPortName, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPEntry=wsSFPEntry, ibos=ibos, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourIfIndex=wsNeighbourIfIndex, wsTempTHYST=wsTempTHYST, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPVoltStatus=wsSFPVoltStatus, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPStatus=wsSFPStatus, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsAsrRevision=wsAsrRevision, wsVoltMeasured=wsVoltMeasured, wsVoltThresholdHigh=wsVoltThresholdHigh, wsFanTable=wsFanTable, wsFanEntry=wsFanEntry, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsTempThresholdLow=wsTempThresholdLow, wsPolicyIfName=wsPolicyIfName, wsNeighbourModel=wsNeighbourModel, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsFanNumber=wsFanNumber, wsNeighbourLocalIf=wsNeighbourLocalIf, wsXFPTemp=wsXFPTemp, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsXFPTable=wsXFPTable, wsSFPRXPower=wsSFPRXPower, PYSNMP_MODULE_ID=ibos, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsVoltEntry=wsVoltEntry, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPVolt=wsSFPVolt, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPConnector=wsSFPConnector, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsReload=wsReload, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourState=wsNeighbourState, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTemp=wsSFPTemp, wsIbosVoltLow=wsIbosVoltLow, wsPolicyUsedCnt=wsPolicyUsedCnt, wsVoltChannel=wsVoltChannel, wsSFPIndex=wsSFPIndex, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsTempTable=wsTempTable, wsSFPEncoding=wsSFPEncoding, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPPartNumber=wsSFPPartNumber, wsWritedummy=wsWritedummy, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsXFPTransceiver=wsXFPTransceiver, wsSFPBitrate=wsSFPBitrate, wsFanRPM=wsFanRPM, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsIbosTempHigh=wsIbosTempHigh, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsXFPCopperLen=wsXFPCopperLen, wsXFPTXCurrent=wsXFPTXCurrent, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighboursTable=wsNeighboursTable, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsXFPRXPower=wsXFPRXPower, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPTempStatus=wsSFPTempStatus, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPTXPower=wsXFPTXPower, wsNeighbourCreated=wsNeighbourCreated, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPIndex=wsXFPIndex, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsXFPEncoding=wsXFPEncoding, wsSFPTXPower=wsSFPTXPower, wsXFPStatus=wsXFPStatus, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsVoltNominal=wsVoltNominal, wsTempStatus=wsTempStatus, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsTempSensor=wsTempSensor, wsTempMeasured=wsTempMeasured, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsVoltStatus=wsVoltStatus, wsVersionString=wsVersionString, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortState=wsNeighbourPortState, wsAccounting=wsAccounting, wsPolicyInBytes=wsPolicyInBytes, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit)
