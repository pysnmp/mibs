...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortName=wsNeighbourPortName, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSystem=wsSystem, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPVolt=wsSFPVolt, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPTXPower=wsSFPTXPower, wsVoltMeasured=wsVoltMeasured, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPCopperLen=wsXFPCopperLen, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsPolicyInBytes=wsPolicyInBytes, wsXFPTable=wsXFPTable, wsXFPIndex=wsXFPIndex, wsPolicyCookie=wsPolicyCookie, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPEntry=wsXFPEntry, wsNeighbourCreated=wsNeighbourCreated, wsTempMeasured=wsTempMeasured, wsTempStatus=wsTempStatus, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourIfIndex=wsNeighbourIfIndex, wsTempEntry=wsTempEntry, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsXFPTemp=wsXFPTemp, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsIbosTempHigh=wsIbosTempHigh, wsFanEntry=wsFanEntry, wsEnvironment=wsEnvironment, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsPolicyInDrops=wsPolicyInDrops, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsFanVoltage=wsFanVoltage, wsTempTHYST=wsTempTHYST, wsTempThresholdHigh=wsTempThresholdHigh, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourState=wsNeighbourState, wsPolicyName=wsPolicyName, wsIbosVoltLow=wsIbosVoltLow, wsXFPStatus=wsXFPStatus, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPIndex=wsSFPIndex, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsAsrRevision=wsAsrRevision, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsPolicyInPkts=wsPolicyInPkts, wsXFPTXPower=wsXFPTXPower, wsPolicyIfIndex=wsPolicyIfIndex, wsVoltNominal=wsVoltNominal, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsPolicyEntry=wsPolicyEntry, wsSFPCopperLen=wsSFPCopperLen, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortState=wsNeighbourPortState, wsSFPPartNumber=wsSFPPartNumber, wsVoltTable=wsVoltTable, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsVoltEntry=wsVoltEntry, wsTempThresholdLow=wsTempThresholdLow, wsAccounting=wsAccounting, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsWritedummy=wsWritedummy, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPStatus=wsSFPStatus, wsTempTOS=wsTempTOS, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsVoltStatus=wsVoltStatus, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPRXPower=wsSFPRXPower, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPConnector=wsSFPConnector, wsSFPTemp=wsSFPTemp, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourNIndex=wsNeighbourNIndex, wsPolicyIfName=wsPolicyIfName, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTXdBmPower=wsSFPTXdBmPower, wsVoltChannel=wsVoltChannel, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsXFPTXCurrent=wsXFPTXCurrent, wsVoltThresholdHigh=wsVoltThresholdHigh, wsIbosVoltHigh=wsIbosVoltHigh, wsPolicyTable=wsPolicyTable, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsVersion=wsVersion, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsReload=wsReload, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsXFPTempStatus=wsXFPTempStatus, wsTempTable=wsTempTable, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, ibos=ibos, PYSNMP_MODULE_ID=ibos, wsTempSensor=wsTempSensor, wsFanRPM=wsFanRPM, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighboursEntry=wsNeighboursEntry, wsXFPConnector=wsXFPConnector, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPEntry=wsSFPEntry, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPBitrateMin=wsXFPBitrateMin, wsFanTable=wsFanTable, wsSFPTempNormalLow=wsSFPTempNormalLow, wsIbosTempLow=wsIbosTempLow, wsFanNumber=wsFanNumber, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsVersionString=wsVersionString, wsNeighboursTable=wsNeighboursTable, wsSFPBitrate=wsSFPBitrate, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTable=wsSFPTable, wsSFPEncoding=wsSFPEncoding, wsPolicyOutPkts=wsPolicyOutPkts, wsPFDP=wsPFDP, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPRXPower=wsXFPRXPower, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourModel=wsNeighbourModel, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourUptime=wsNeighbourUptime, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourLastAct=wsNeighbourLastAct, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTXCurrent=wsSFPTXCurrent)
