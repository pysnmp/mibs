...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsIbosVoltLow=wsIbosVoltLow, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourModel=wsNeighbourModel, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPEntry=wsXFPEntry, wsNeighbourState=wsNeighbourState, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsVoltMeasured=wsVoltMeasured, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPIndex=wsXFPIndex, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortName=wsNeighbourPortName, wsSFPStatus=wsSFPStatus, wsNeighbourCreated=wsNeighbourCreated, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsTempEntry=wsTempEntry, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, PYSNMP_MODULE_ID=ibos, wsVoltEntry=wsVoltEntry, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPVolt=wsSFPVolt, wsVoltChannel=wsVoltChannel, wsSFPIndex=wsSFPIndex, wsXFPSingleModeLen=wsXFPSingleModeLen, wsXFPEncoding=wsXFPEncoding, wsSFPTransceiver=wsSFPTransceiver, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPRXdBmPower=wsSFPRXdBmPower, wsXFPRXPower=wsXFPRXPower, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsPolicyInPkts=wsPolicyInPkts, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsVoltStatus=wsVoltStatus, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTempNormalLow=wsSFPTempNormalLow, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourIfIndex=wsNeighbourIfIndex, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsFanRPM=wsFanRPM, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPPartNumber=wsSFPPartNumber, wsAsrRevision=wsAsrRevision, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortState=wsNeighbourPortState, wsSFPVoltStatus=wsSFPVoltStatus, wsXFPConnector=wsXFPConnector, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsPolicyIfName=wsPolicyIfName, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsTempTHYST=wsTempTHYST, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPEntry=wsSFPEntry, wsSFPBitrate=wsSFPBitrate, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsTempThresholdHigh=wsTempThresholdHigh, wsPFDP=wsPFDP, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsEnvironment=wsEnvironment, wsNeighboursEntry=wsNeighboursEntry, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPTransceiver=wsXFPTransceiver, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsIbosTempHigh=wsIbosTempHigh, wsAccounting=wsAccounting, wsSFPTempStatus=wsSFPTempStatus, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPTemp=wsXFPTemp, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsXFPStatus=wsXFPStatus, wsFanTable=wsFanTable, wsPolicyName=wsPolicyName, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsPolicyCookie=wsPolicyCookie, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsFanNumber=wsFanNumber, wsVersion=wsVersion, wsIbosTempLow=wsIbosTempLow, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourSNPA=wsNeighbourSNPA, wsVoltTable=wsVoltTable, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPConnector=wsSFPConnector, wsTempStatus=wsTempStatus, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsTempMeasured=wsTempMeasured, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsPolicyInBytes=wsPolicyInBytes, wsTempSensor=wsTempSensor, wsPolicyUsedCnt=wsPolicyUsedCnt, wsTempTOS=wsTempTOS, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsFanVoltage=wsFanVoltage, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPRXPower=wsSFPRXPower, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsWritedummy=wsWritedummy, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourNIndex=wsNeighbourNIndex, wsXFPCopperLen=wsXFPCopperLen, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsReload=wsReload, wsPolicyInDrops=wsPolicyInDrops, wsFanEntry=wsFanEntry, wsIbosFanRPMLow=wsIbosFanRPMLow, wsVersionString=wsVersionString, wsTempThresholdLow=wsTempThresholdLow, wsVoltNominal=wsVoltNominal, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsPolicyTable=wsPolicyTable, wsSystem=wsSystem, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsXFPTable=wsXFPTable, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTable=wsSFPTable, wsSFPTXPower=wsSFPTXPower, wsSFPTemp=wsSFPTemp, wsTempTable=wsTempTable, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPTempStatus=wsXFPTempStatus, wsVoltThresholdLow=wsVoltThresholdLow, ibos=ibos)
