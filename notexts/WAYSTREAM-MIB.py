...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsFanTable=wsFanTable, wsXFPTemp=wsXFPTemp, wsVoltNominal=wsVoltNominal, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPStatus=wsSFPStatus, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsFanEntry=wsFanEntry, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsXFPBitrateMax=wsXFPBitrateMax, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPTable=wsSFPTable, wsSFPEntry=wsSFPEntry, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortState=wsNeighbourPortState, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPEntry=wsXFPEntry, wsSFPEncoding=wsSFPEncoding, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsVoltStatus=wsVoltStatus, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTempWarningLow=wsSFPTempWarningLow, PYSNMP_MODULE_ID=ibos, wsTempThresholdHigh=wsTempThresholdHigh, wsTempEntry=wsTempEntry, wsSFPTXCurrent=wsSFPTXCurrent, wsVoltEntry=wsVoltEntry, wsSFPTemp=wsSFPTemp, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPTempNormalLow=wsSFPTempNormalLow, wsPolicyTable=wsPolicyTable, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPPartNumber=wsSFPPartNumber, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourIfIndex=wsNeighbourIfIndex, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsIbosFanRPMLow=wsIbosFanRPMLow, wsVersion=wsVersion, wsSFPVolt=wsSFPVolt, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsVoltThresholdLow=wsVoltThresholdLow, wsXFPTable=wsXFPTable, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsAsrRevision=wsAsrRevision, wsNeighbourCreated=wsNeighbourCreated, wsTempTOS=wsTempTOS, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsIbosTempHigh=wsIbosTempHigh, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourOSVersion=wsNeighbourOSVersion, wsPolicyIfName=wsPolicyIfName, wsXFPStatus=wsXFPStatus, wsTempSensor=wsTempSensor, wsSFPRXPower=wsSFPRXPower, wsPolicyInPkts=wsPolicyInPkts, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSystem=wsSystem, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsIbosVoltLow=wsIbosVoltLow, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourState=wsNeighbourState, wsVersionString=wsVersionString, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsFanNumber=wsFanNumber, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsAccounting=wsAccounting, wsNeighbourUptime=wsNeighbourUptime, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsPolicyOutBytes=wsPolicyOutBytes, wsPolicyInDrops=wsPolicyInDrops, wsTempTHYST=wsTempTHYST, wsEnvironment=wsEnvironment, wsFanVoltage=wsFanVoltage, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighboursTable=wsNeighboursTable, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsVoltTable=wsVoltTable, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTempStatus=wsSFPTempStatus, wsXFPCopperLen=wsXFPCopperLen, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsWritedummy=wsWritedummy, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPTempStatus=wsXFPTempStatus, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPSingleModeLen=wsXFPSingleModeLen, ibos=ibos, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsVoltChannel=wsVoltChannel, wsTempMeasured=wsTempMeasured, wsXFPIndex=wsXFPIndex, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsPolicyIfIndex=wsPolicyIfIndex, wsPolicyUsedCnt=wsPolicyUsedCnt, wsReload=wsReload, wsPFDP=wsPFDP, wsTempStatus=wsTempStatus, wsXFPTransceiver=wsXFPTransceiver, wsVoltMeasured=wsVoltMeasured, wsSFPIndex=wsSFPIndex, wsSFPConnector=wsSFPConnector, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourModel=wsNeighbourModel, wsXFPConnector=wsXFPConnector, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsTempTable=wsTempTable, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsFanRPM=wsFanRPM, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsPolicyInBytes=wsPolicyInBytes, wsPolicyName=wsPolicyName, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourHostname=wsNeighbourHostname, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPCopperLen=wsSFPCopperLen)
