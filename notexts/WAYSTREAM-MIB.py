...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsPolicyInPkts=wsPolicyInPkts, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortState=wsNeighbourPortState, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsTempTOS=wsTempTOS, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsVoltEntry=wsVoltEntry, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsXFPConnector=wsXFPConnector, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortName=wsNeighbourPortName, wsXFPEntry=wsXFPEntry, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsTempStatus=wsTempStatus, wsVoltNominal=wsVoltNominal, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourState=wsNeighbourState, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsPolicyTable=wsPolicyTable, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsVoltChannel=wsVoltChannel, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourModel=wsNeighbourModel, wsPolicyName=wsPolicyName, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsPolicyIfIndex=wsPolicyIfIndex, wsTempThresholdLow=wsTempThresholdLow, wsAsrRevision=wsAsrRevision, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPRXPower=wsXFPRXPower, wsSFPTransceiver=wsSFPTransceiver, PYSNMP_MODULE_ID=ibos, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsIbosVoltLow=wsIbosVoltLow, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsTempSensor=wsTempSensor, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsXFPStatus=wsXFPStatus, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPIndex=wsSFPIndex, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPCopperLen=wsSFPCopperLen, wsXFPTable=wsXFPTable, wsPolicyUsedCnt=wsPolicyUsedCnt, wsFanVoltage=wsFanVoltage, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsXFPIndex=wsXFPIndex, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPEntry=wsSFPEntry, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsTempTable=wsTempTable, wsSFPTXdBmPower=wsSFPTXdBmPower, wsTempEntry=wsTempEntry, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPPartNumber=wsSFPPartNumber, wsSFPVolt=wsSFPVolt, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsVoltMeasured=wsVoltMeasured, wsSFPTable=wsSFPTable, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPTempStatus=wsSFPTempStatus, wsReload=wsReload, wsSFPBitrate=wsSFPBitrate, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsPFDP=wsPFDP, wsXFPTransceiver=wsXFPTransceiver, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsAccounting=wsAccounting, wsVoltThresholdHigh=wsVoltThresholdHigh, wsVoltTable=wsVoltTable, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighboursEntry=wsNeighboursEntry, wsSFPStatus=wsSFPStatus, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsTempTHYST=wsTempTHYST, wsPolicyIfName=wsPolicyIfName, wsXFPTemp=wsXFPTemp, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsFanNumber=wsFanNumber, wsXFPCopperLen=wsXFPCopperLen, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPConnector=wsSFPConnector, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourCreated=wsNeighbourCreated, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsFanEntry=wsFanEntry, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPTXPower=wsXFPTXPower, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourHostname=wsNeighbourHostname, wsPolicyInBytes=wsPolicyInBytes, wsSFPEncoding=wsSFPEncoding, wsSFPTemp=wsSFPTemp, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourUptime=wsNeighbourUptime, wsPolicyEntry=wsPolicyEntry, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTXPower=wsSFPTXPower, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsXFPSingleModeLen=wsXFPSingleModeLen, wsTempMeasured=wsTempMeasured, wsIbosFanRPMLow=wsIbosFanRPMLow, wsWritedummy=wsWritedummy, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSystem=wsSystem, wsFanTable=wsFanTable, wsXFPTempStatus=wsXFPTempStatus, wsVoltStatus=wsVoltStatus, wsSFPTransceiverExt=wsSFPTransceiverExt, wsPolicyOutBytes=wsPolicyOutBytes, wsVersion=wsVersion, wsFanRPM=wsFanRPM, wsNeighbourNIndex=wsNeighbourNIndex, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsEnvironment=wsEnvironment, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, ibos=ibos, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsVersionString=wsVersionString, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets)
