...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsTempTable=wsTempTable, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTXPower=wsSFPTXPower, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsPolicyOutDrops=wsPolicyOutDrops, wsTempThresholdLow=wsTempThresholdLow, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPPartNumber=wsSFPPartNumber, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourCreated=wsNeighbourCreated, wsXFPSingleModeLen=wsXFPSingleModeLen, wsFanRPM=wsFanRPM, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTempStatus=wsSFPTempStatus, wsXFPEncoding=wsXFPEncoding, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPRXPower=wsSFPRXPower, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsXFPEntry=wsXFPEntry, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPConnector=wsSFPConnector, wsTempTHYST=wsTempTHYST, wsFanEntry=wsFanEntry, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPIndex=wsSFPIndex, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourOSVersion=wsNeighbourOSVersion, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourHostname=wsNeighbourHostname, wsVoltTable=wsVoltTable, wsFanTable=wsFanTable, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourRemoteIf=wsNeighbourRemoteIf, ibos=ibos, wsTempEntry=wsTempEntry, wsXFPTable=wsXFPTable, wsVersion=wsVersion, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourUptime=wsNeighbourUptime, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsPFDP=wsPFDP, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsVoltThresholdHigh=wsVoltThresholdHigh, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsEnvironment=wsEnvironment, wsVoltChannel=wsVoltChannel, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsXFPTXCurrent=wsXFPTXCurrent, wsWritedummy=wsWritedummy, wsAsrRevision=wsAsrRevision, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourIfIndex=wsNeighbourIfIndex, wsTempMeasured=wsTempMeasured, wsFanNumber=wsFanNumber, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsXFPConnector=wsXFPConnector, wsIbosTempLow=wsIbosTempLow, wsVoltEntry=wsVoltEntry, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsFanVoltage=wsFanVoltage, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPTemp=wsXFPTemp, wsXFPIndex=wsXFPIndex, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsPolicyCookie=wsPolicyCookie, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourState=wsNeighbourState, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTransceiver=wsSFPTransceiver, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPStatus=wsSFPStatus, wsVersionString=wsVersionString, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsVoltStatus=wsVoltStatus, PYSNMP_MODULE_ID=ibos, wsXFPTempStatus=wsXFPTempStatus, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsXFPRXPower=wsXFPRXPower, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPEntry=wsSFPEntry, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsPolicyName=wsPolicyName, wsXFPStatus=wsXFPStatus, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPEncoding=wsSFPEncoding, wsSFPTransceiverExt=wsSFPTransceiverExt, wsTempTOS=wsTempTOS, wsSFPTemp=wsSFPTemp, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSystem=wsSystem, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsXFPTXPower=wsXFPTXPower, wsSFPBitrate=wsSFPBitrate, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsVoltNominal=wsVoltNominal, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPVolt=wsSFPVolt, wsAccounting=wsAccounting, wsPolicyOutBytes=wsPolicyOutBytes, wsTempSensor=wsTempSensor, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPTable=wsSFPTable, wsNeighboursEntry=wsNeighboursEntry, wsPolicyTable=wsPolicyTable, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsTempStatus=wsTempStatus, wsReload=wsReload, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsPolicyEntry=wsPolicyEntry, wsIbosTempHigh=wsIbosTempHigh, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable)
