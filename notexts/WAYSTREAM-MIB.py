...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourModel=wsNeighbourModel, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsIbosTempHigh=wsIbosTempHigh, wsFanEntry=wsFanEntry, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsTempTOS=wsTempTOS, wsTempTHYST=wsTempTHYST, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPEncoding=wsSFPEncoding, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsVoltStatus=wsVoltStatus, wsPolicyCookie=wsPolicyCookie, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsAsrRevision=wsAsrRevision, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPVolt=wsSFPVolt, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourOSVersion=wsNeighbourOSVersion, wsPolicyIfName=wsPolicyIfName, wsTempEntry=wsTempEntry, wsXFPEncoding=wsXFPEncoding, wsPolicyInBytes=wsPolicyInBytes, wsTempTable=wsTempTable, wsIbosVoltLow=wsIbosVoltLow, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourUptime=wsNeighbourUptime, wsVoltChannel=wsVoltChannel, wsXFPTXPower=wsXFPTXPower, wsNeighbourDBCount=wsNeighbourDBCount, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPTable=wsSFPTable, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsVoltTable=wsVoltTable, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPCopperLen=wsSFPCopperLen, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPEntry=wsSFPEntry, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsPolicyUsedCnt=wsPolicyUsedCnt, wsPolicyIfIndex=wsPolicyIfIndex, wsPolicyEntry=wsPolicyEntry, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighboursEntry=wsNeighboursEntry, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPTemp=wsXFPTemp, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPTransceiverExt=wsSFPTransceiverExt, wsPolicyInPkts=wsPolicyInPkts, wsSFPTempStatus=wsSFPTempStatus, wsXFPStatus=wsXFPStatus, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPStatus=wsSFPStatus, wsReload=wsReload, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortName=wsNeighbourPortName, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsVoltNominal=wsVoltNominal, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPBitrate=wsSFPBitrate, wsSFPTemp=wsSFPTemp, wsVoltEntry=wsVoltEntry, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPIndex=wsSFPIndex, wsVersionString=wsVersionString, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTXPower=wsSFPTXPower, wsXFPTable=wsXFPTable, wsSFPTransceiver=wsSFPTransceiver, wsVersion=wsVersion, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsPFDP=wsPFDP, wsFanTable=wsFanTable, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsAccounting=wsAccounting, wsIbosVoltHigh=wsIbosVoltHigh, wsPolicyName=wsPolicyName, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPPartNumber=wsSFPPartNumber, wsXFPTransceiver=wsXFPTransceiver, wsXFPEntry=wsXFPEntry, wsXFPBitrateMax=wsXFPBitrateMax, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsTempThresholdHigh=wsTempThresholdHigh, wsTempMeasured=wsTempMeasured, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, PYSNMP_MODULE_ID=ibos, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsTempStatus=wsTempStatus, wsPolicyTable=wsPolicyTable, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPRXPower=wsXFPRXPower, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourCreated=wsNeighbourCreated, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsXFPIndex=wsXFPIndex, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPConnector=wsSFPConnector, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSystem=wsSystem, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsFanRPM=wsFanRPM, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortState=wsNeighbourPortState, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourState=wsNeighbourState, ibos=ibos, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsTempSensor=wsTempSensor, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsFanNumber=wsFanNumber, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsFanVoltage=wsFanVoltage, wsXFPConnector=wsXFPConnector, wsWritedummy=wsWritedummy, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsEnvironment=wsEnvironment, wsXFPSingleModeLen=wsXFPSingleModeLen)
