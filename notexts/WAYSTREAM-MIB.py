...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsTempTable=wsTempTable, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsPolicyOutDrops=wsPolicyOutDrops, wsTempSensor=wsTempSensor, wsTempMeasured=wsTempMeasured, wsSFPTemp=wsSFPTemp, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsReload=wsReload, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsTempTOS=wsTempTOS, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsAsrRevision=wsAsrRevision, wsSFPTempNormalLow=wsSFPTempNormalLow, wsPolicyInDrops=wsPolicyInDrops, wsVoltNominal=wsVoltNominal, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsVersionString=wsVersionString, wsXFPEncoding=wsXFPEncoding, wsFanEntry=wsFanEntry, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTransceiver=wsSFPTransceiver, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsVersion=wsVersion, wsSFPEntry=wsSFPEntry, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPIndex=wsXFPIndex, wsNeighbourIfIndex=wsNeighbourIfIndex, wsXFPTXPower=wsXFPTXPower, wsSFPConnector=wsSFPConnector, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsFanVoltage=wsFanVoltage, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsPolicyIfIndex=wsPolicyIfIndex, wsEnvironment=wsEnvironment, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPIndex=wsSFPIndex, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsIbosFanRPMLow=wsIbosFanRPMLow, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsVoltStatus=wsVoltStatus, wsPolicyCookie=wsPolicyCookie, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsXFPConnector=wsXFPConnector, wsVoltMeasured=wsVoltMeasured, wsPolicyInBytes=wsPolicyInBytes, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsPFDP=wsPFDP, wsSFPRXdBmPower=wsSFPRXdBmPower, wsVoltTable=wsVoltTable, wsXFPTable=wsXFPTable, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPRXPower=wsSFPRXPower, PYSNMP_MODULE_ID=ibos, wsSFPEncoding=wsSFPEncoding, wsIbosVoltLow=wsIbosVoltLow, wsXFPTransceiver=wsXFPTransceiver, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsXFPStatus=wsXFPStatus, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortName=wsNeighbourPortName, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsTempTHYST=wsTempTHYST, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsPolicyOutPkts=wsPolicyOutPkts, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsWritedummy=wsWritedummy, wsNeighbourDBCount=wsNeighbourDBCount, wsFanNumber=wsFanNumber, wsTempStatus=wsTempStatus, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsVoltChannel=wsVoltChannel, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSystem=wsSystem, wsSFPTable=wsSFPTable, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsPolicyTable=wsPolicyTable, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTempStatus=wsSFPTempStatus, wsXFPEntry=wsXFPEntry, wsFanTable=wsFanTable, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsPolicyName=wsPolicyName, wsFanRPM=wsFanRPM, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsPolicyInPkts=wsPolicyInPkts, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsXFPRXPower=wsXFPRXPower, wsNeighbourState=wsNeighbourState, wsSFPSingleModeLen=wsSFPSingleModeLen, wsVoltEntry=wsVoltEntry, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourOSVersion=wsNeighbourOSVersion, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPStatus=wsSFPStatus, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsXFPTemp=wsXFPTemp, wsNeighboursTable=wsNeighboursTable, wsIbosVoltHigh=wsIbosVoltHigh, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPVolt=wsSFPVolt, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPCopperLen=wsSFPCopperLen, wsSFPTXPower=wsSFPTXPower, wsNeighbourModel=wsNeighbourModel, wsSFPMultiMode625Len=wsSFPMultiMode625Len, ibos=ibos, wsSFPBitrate=wsSFPBitrate, wsTempEntry=wsTempEntry, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortState=wsNeighbourPortState, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsAccounting=wsAccounting, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourLocalIf=wsNeighbourLocalIf)
