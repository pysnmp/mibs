...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourHostname=wsNeighbourHostname, wsWritedummy=wsWritedummy, wsSFPEntry=wsSFPEntry, wsPolicyOutDrops=wsPolicyOutDrops, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsFanNumber=wsFanNumber, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPBitrate=wsSFPBitrate, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsXFPTransceiver=wsXFPTransceiver, wsPolicyCookie=wsPolicyCookie, wsNeighbourState=wsNeighbourState, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsXFPIndex=wsXFPIndex, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsAccounting=wsAccounting, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsPolicyInDrops=wsPolicyInDrops, wsNeighboursEntry=wsNeighboursEntry, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsPolicyTable=wsPolicyTable, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPEncoding=wsSFPEncoding, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsPolicyUsedCnt=wsPolicyUsedCnt, wsVoltMeasured=wsVoltMeasured, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsTempTOS=wsTempTOS, wsFanEntry=wsFanEntry, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPSerialNumber=wsSFPSerialNumber, wsPFDP=wsPFDP, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPConnector=wsSFPConnector, wsTempThresholdHigh=wsTempThresholdHigh, wsIbosTempLow=wsIbosTempLow, wsXFPSingleModeLen=wsXFPSingleModeLen, wsXFPRXPower=wsXFPRXPower, wsSFPTable=wsSFPTable, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsTempSensor=wsTempSensor, wsNeighbourModel=wsNeighbourModel, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTransceiverExt=wsSFPTransceiverExt, wsFanTable=wsFanTable, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsVoltNominal=wsVoltNominal, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsXFPConnector=wsXFPConnector, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPStatus=wsSFPStatus, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPTempStatus=wsXFPTempStatus, wsReload=wsReload, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTempWarningLow=wsSFPTempWarningLow, wsTempStatus=wsTempStatus, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsXFPEncoding=wsXFPEncoding, wsXFPTable=wsXFPTable, wsEnvironment=wsEnvironment, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsVoltChannel=wsVoltChannel, wsSFPRXPower=wsSFPRXPower, wsFanVoltage=wsFanVoltage, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsVoltTable=wsVoltTable, wsPolicyName=wsPolicyName, wsNeighbourLocalIf=wsNeighbourLocalIf, wsXFPEntry=wsXFPEntry, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPIndex=wsSFPIndex, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsVersionString=wsVersionString, ibos=ibos, wsTempTHYST=wsTempTHYST, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourOSVersion=wsNeighbourOSVersion, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsVoltEntry=wsVoltEntry, wsSFPTXPower=wsSFPTXPower, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsXFPBitrateMin=wsXFPBitrateMin, PYSNMP_MODULE_ID=ibos, wsNeighbourUptime=wsNeighbourUptime, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPVolt=wsSFPVolt, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsVoltThresholdHigh=wsVoltThresholdHigh, wsAsrRevision=wsAsrRevision, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPVoltStatus=wsSFPVoltStatus, wsPolicyInPkts=wsPolicyInPkts, wsSFPTXCurrent=wsSFPTXCurrent, wsTempTable=wsTempTable, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsTempEntry=wsTempEntry, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsIbosTempHigh=wsIbosTempHigh, wsTempMeasured=wsTempMeasured, wsVoltStatus=wsVoltStatus, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortState=wsNeighbourPortState, wsXFPTemp=wsXFPTemp, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsFanRPM=wsFanRPM, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPCopperLen=wsSFPCopperLen, wsSystem=wsSystem, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPRXdBmPower=wsSFPRXdBmPower, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsXFPStatus=wsXFPStatus, wsNeighboursTable=wsNeighboursTable, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTemp=wsSFPTemp, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsPolicyInBytes=wsPolicyInBytes, wsVersion=wsVersion)
