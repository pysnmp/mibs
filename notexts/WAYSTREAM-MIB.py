...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPStatus=wsSFPStatus, wsSFPVolt=wsSFPVolt, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourState=wsNeighbourState, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsFanEntry=wsFanEntry, wsWritedummy=wsWritedummy, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsXFPTemp=wsXFPTemp, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsVoltEntry=wsVoltEntry, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighboursTable=wsNeighboursTable, wsPolicyIfName=wsPolicyIfName, wsSFPTXPower=wsSFPTXPower, wsFanVoltage=wsFanVoltage, wsTempTable=wsTempTable, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourLastAct=wsNeighbourLastAct, wsIbosVoltHigh=wsIbosVoltHigh, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPPartNumber=wsSFPPartNumber, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, ibos=ibos, wsSFPEncoding=wsSFPEncoding, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPCopperLen=wsXFPCopperLen, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPBitrate=wsSFPBitrate, wsVoltTable=wsVoltTable, wsSystem=wsSystem, wsVoltChannel=wsVoltChannel, wsXFPEntry=wsXFPEntry, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsXFPIndex=wsXFPIndex, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsVersionString=wsVersionString, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsVoltNominal=wsVoltNominal, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsPolicyInBytes=wsPolicyInBytes, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsPolicyCookie=wsPolicyCookie, wsXFPTable=wsXFPTable, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsAsrRevision=wsAsrRevision, wsTempTHYST=wsTempTHYST, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsPolicyTable=wsPolicyTable, wsXFPTXPower=wsXFPTXPower, wsNeighbourSNPA=wsNeighbourSNPA, wsPolicyInDrops=wsPolicyInDrops, wsXFPEncoding=wsXFPEncoding, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourDBCount=wsNeighbourDBCount, wsXFPRXPower=wsXFPRXPower, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsVoltMeasured=wsVoltMeasured, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsXFPConnector=wsXFPConnector, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsFanNumber=wsFanNumber, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourCreated=wsNeighbourCreated, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsXFPStatus=wsXFPStatus, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsEnvironment=wsEnvironment, wsSFPConnector=wsSFPConnector, wsNeighbourModel=wsNeighbourModel, wsSFPTXdBmPower=wsSFPTXdBmPower, wsPolicyName=wsPolicyName, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsReload=wsReload, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPEntry=wsSFPEntry, wsNeighbourHostname=wsNeighbourHostname, PYSNMP_MODULE_ID=ibos, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourLocalIf=wsNeighbourLocalIf, wsTempSensor=wsTempSensor, wsNeighboursEntry=wsNeighboursEntry, wsSFPTemp=wsSFPTemp, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPRXPower=wsSFPRXPower, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPSerialNumber=wsSFPSerialNumber, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsFanTable=wsFanTable, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsTempEntry=wsTempEntry, wsAccounting=wsAccounting, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsXFPTXCurrent=wsXFPTXCurrent, wsTempMeasured=wsTempMeasured, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsTempThresholdLow=wsTempThresholdLow, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsPolicyOutPkts=wsPolicyOutPkts, wsTempTOS=wsTempTOS, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTransceiverExt=wsSFPTransceiverExt, wsPolicyEntry=wsPolicyEntry, wsVoltStatus=wsVoltStatus, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPIndex=wsSFPIndex, wsSFPTempWarningLow=wsSFPTempWarningLow, wsPFDP=wsPFDP, wsTempStatus=wsTempStatus, wsFanRPM=wsFanRPM, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTable=wsSFPTable, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsVersion=wsVersion, wsSFPTempStatus=wsSFPTempStatus, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit)
