...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsEnvironment=wsEnvironment, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTXPower=wsSFPTXPower, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPTemp=wsXFPTemp, wsNeighbourHostname=wsNeighbourHostname, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourDBCount=wsNeighbourDBCount, wsXFPBitrateMin=wsXFPBitrateMin, wsFanVoltage=wsFanVoltage, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsXFPConnector=wsXFPConnector, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsFanRPM=wsFanRPM, wsNeighbourPortState=wsNeighbourPortState, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsVoltChannel=wsVoltChannel, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsVoltStatus=wsVoltStatus, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPTransceiver=wsSFPTransceiver, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsTempThresholdHigh=wsTempThresholdHigh, wsXFPEntry=wsXFPEntry, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsPolicyName=wsPolicyName, wsXFPTransceiver=wsXFPTransceiver, wsReload=wsReload, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPVolt=wsSFPVolt, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPEncoding=wsXFPEncoding, wsVoltThresholdLow=wsVoltThresholdLow, wsIbosVoltLow=wsIbosVoltLow, ibos=ibos, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsTempMeasured=wsTempMeasured, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourLastAct=wsNeighbourLastAct, wsVersion=wsVersion, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPIndex=wsSFPIndex, wsAsrRevision=wsAsrRevision, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPRXPower=wsSFPRXPower, wsFanNumber=wsFanNumber, wsVoltEntry=wsVoltEntry, wsPolicyInDrops=wsPolicyInDrops, wsAccounting=wsAccounting, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsTempTOS=wsTempTOS, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsXFPTempStatus=wsXFPTempStatus, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsXFPTable=wsXFPTable, wsPolicyInBytes=wsPolicyInBytes, wsSFPPartNumber=wsSFPPartNumber, wsXFPStatus=wsXFPStatus, wsNeighboursTable=wsNeighboursTable, wsSFPCopperLen=wsSFPCopperLen, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPEntry=wsSFPEntry, wsSFPVoltStatus=wsSFPVoltStatus, wsPolicyIfName=wsPolicyIfName, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsFanEntry=wsFanEntry, wsTempTable=wsTempTable, wsSFPStatus=wsSFPStatus, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTempStatus=wsSFPTempStatus, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsIbosFanRPMLow=wsIbosFanRPMLow, wsTempTHYST=wsTempTHYST, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPEncoding=wsSFPEncoding, wsTempStatus=wsTempStatus, wsPolicyEntry=wsPolicyEntry, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsVersionString=wsVersionString, wsVoltThresholdHigh=wsVoltThresholdHigh, wsPFDP=wsPFDP, wsSFPConnector=wsSFPConnector, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPBitrate=wsSFPBitrate, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsIbosTempLow=wsIbosTempLow, wsVoltNominal=wsVoltNominal, wsTempThresholdLow=wsTempThresholdLow, wsFanTable=wsFanTable, wsPolicyOutDrops=wsPolicyOutDrops, wsVoltMeasured=wsVoltMeasured, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourState=wsNeighbourState, wsVoltTable=wsVoltTable, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourUptime=wsNeighbourUptime, PYSNMP_MODULE_ID=ibos, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsWritedummy=wsWritedummy, wsPolicyTable=wsPolicyTable, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsPolicyInPkts=wsPolicyInPkts, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPTXCurrent=wsSFPTXCurrent, wsSystem=wsSystem, wsSFPTempWarningLow=wsSFPTempWarningLow, wsTempSensor=wsTempSensor, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPIndex=wsXFPIndex, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTable=wsSFPTable, wsSFPTemp=wsSFPTemp, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsTempEntry=wsTempEntry)
