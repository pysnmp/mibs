...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPIndex=wsSFPIndex, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsPolicyInPkts=wsPolicyInPkts, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsTempTOS=wsTempTOS, wsIbosTempLow=wsIbosTempLow, wsVoltEntry=wsVoltEntry, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsVoltStatus=wsVoltStatus, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, ibos=ibos, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPCopperLen=wsSFPCopperLen, wsAccounting=wsAccounting, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsFanNumber=wsFanNumber, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourHostname=wsNeighbourHostname, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighboursTable=wsNeighboursTable, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsReload=wsReload, wsNeighbourModel=wsNeighbourModel, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsVoltMeasured=wsVoltMeasured, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsVersionString=wsVersionString, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPEntry=wsSFPEntry, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPTemp=wsSFPTemp, wsSFPStatus=wsSFPStatus, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsTempStatus=wsTempStatus, wsSFPTXPower=wsSFPTXPower, wsVersion=wsVersion, wsTempEntry=wsTempEntry, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsPolicyName=wsPolicyName, wsNeighbourState=wsNeighbourState, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsPolicyOutBytes=wsPolicyOutBytes, wsIbosTempHigh=wsIbosTempHigh, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTable=wsSFPTable, wsPolicyInDrops=wsPolicyInDrops, wsSFPTransceiverExt=wsSFPTransceiverExt, wsPolicyCookie=wsPolicyCookie, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPRXPower=wsSFPRXPower, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsFanVoltage=wsFanVoltage, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourUptime=wsNeighbourUptime, wsXFPConnector=wsXFPConnector, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPPartNumber=wsSFPPartNumber, wsXFPEntry=wsXFPEntry, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPConnector=wsSFPConnector, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsTempTable=wsTempTable, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsXFPTable=wsXFPTable, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSystem=wsSystem, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsAsrRevision=wsAsrRevision, wsSFPVolt=wsSFPVolt, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPVoltStatus=wsSFPVoltStatus, wsIbosVoltHigh=wsIbosVoltHigh, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsTempSensor=wsTempSensor, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTXCurrent=wsSFPTXCurrent, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsXFPTXPower=wsXFPTXPower, wsVoltTable=wsVoltTable, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighboursEntry=wsNeighboursEntry, wsTempTHYST=wsTempTHYST, wsTempThresholdHigh=wsTempThresholdHigh, wsFanEntry=wsFanEntry, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPTemp=wsXFPTemp, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsFanTable=wsFanTable, wsPolicyInBytes=wsPolicyInBytes, wsPFDP=wsPFDP, wsTempMeasured=wsTempMeasured, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsXFPStatus=wsXFPStatus, wsNeighbourCreated=wsNeighbourCreated, PYSNMP_MODULE_ID=ibos, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortName=wsNeighbourPortName, wsFanRPM=wsFanRPM, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsVoltChannel=wsVoltChannel, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortState=wsNeighbourPortState, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPTXCurrent=wsXFPTXCurrent, wsVoltNominal=wsVoltNominal, wsSFPBitrate=wsSFPBitrate, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPEncoding=wsXFPEncoding, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsWritedummy=wsWritedummy, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsTempThresholdLow=wsTempThresholdLow, wsXFPIndex=wsXFPIndex, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsEnvironment=wsEnvironment, wsSFPEncoding=wsSFPEncoding, wsPolicyTable=wsPolicyTable, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors)
