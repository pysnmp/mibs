...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsIbosVoltLow=wsIbosVoltLow, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPSingleModeLen=wsSFPSingleModeLen, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsPFDP=wsPFDP, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsFanEntry=wsFanEntry, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsVoltTable=wsVoltTable, wsPolicyEntry=wsPolicyEntry, wsSFPRXPower=wsSFPRXPower, wsAsrRevision=wsAsrRevision, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsVoltEntry=wsVoltEntry, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPConnector=wsXFPConnector, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsVoltStatus=wsVoltStatus, wsNeighbourDBCount=wsNeighbourDBCount, wsSystem=wsSystem, wsEnvironment=wsEnvironment, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsVoltNominal=wsVoltNominal, wsPolicyInPkts=wsPolicyInPkts, wsVersionString=wsVersionString, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPPartNumber=wsSFPPartNumber, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsVoltMeasured=wsVoltMeasured, wsSFPEntry=wsSFPEntry, wsNeighboursEntry=wsNeighboursEntry, wsSFPTransceiverExt=wsSFPTransceiverExt, wsFanNumber=wsFanNumber, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourUptime=wsNeighbourUptime, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsFanRPM=wsFanRPM, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPCopperLen=wsSFPCopperLen, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsXFPEntry=wsXFPEntry, wsWritedummy=wsWritedummy, wsXFPStatus=wsXFPStatus, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsFanTable=wsFanTable, wsSFPStatus=wsSFPStatus, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsReload=wsReload, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsXFPCopperLen=wsXFPCopperLen, wsSFPTable=wsSFPTable, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsPolicyTable=wsPolicyTable, wsIbosTempLow=wsIbosTempLow, wsTempEntry=wsTempEntry, PYSNMP_MODULE_ID=ibos, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsAccounting=wsAccounting, wsPolicyInBytes=wsPolicyInBytes, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsTempTOS=wsTempTOS, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPConnector=wsSFPConnector, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXPower=wsSFPTXPower, wsSFPTXdBmPower=wsSFPTXdBmPower, wsXFPIndex=wsXFPIndex, wsSFPTemp=wsSFPTemp, wsSFPEncoding=wsSFPEncoding, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsXFPTempStatus=wsXFPTempStatus, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPBitrate=wsSFPBitrate, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsXFPTable=wsXFPTable, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsTempStatus=wsTempStatus, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortState=wsNeighbourPortState, wsPolicyIfName=wsPolicyIfName, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsTempMeasured=wsTempMeasured, wsSFPTransceiver=wsSFPTransceiver, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPBitrateMin=wsXFPBitrateMin, wsPolicyCookie=wsPolicyCookie, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsTempSensor=wsTempSensor, wsSFPVolt=wsSFPVolt, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPIndex=wsSFPIndex, wsTempTHYST=wsTempTHYST, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTempNormalLow=wsSFPTempNormalLow, wsXFPBitrateMax=wsXFPBitrateMax, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourIfIndex=wsNeighbourIfIndex, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsXFPEncoding=wsXFPEncoding, wsFanVoltage=wsFanVoltage, wsPolicyName=wsPolicyName, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsPolicyInDrops=wsPolicyInDrops, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsIbosVoltHigh=wsIbosVoltHigh, wsXFPSingleModeLen=wsXFPSingleModeLen, wsVersion=wsVersion, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsVoltChannel=wsVoltChannel, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourState=wsNeighbourState, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsXFPRXPower=wsXFPRXPower, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighboursTable=wsNeighboursTable, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourHostname=wsNeighbourHostname, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPTemp=wsXFPTemp, wsSFPTempWarningLow=wsSFPTempWarningLow, wsTempTable=wsTempTable, wsNeighbourSNPA=wsNeighbourSNPA, ibos=ibos)
