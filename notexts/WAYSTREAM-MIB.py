...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPVoltStatus=wsSFPVoltStatus, wsPolicyTable=wsPolicyTable, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsPolicyInDrops=wsPolicyInDrops, wsXFPBitrateMin=wsXFPBitrateMin, wsVoltChannel=wsVoltChannel, wsFanTable=wsFanTable, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPVolt=wsSFPVolt, wsXFPRXPower=wsXFPRXPower, wsNeighboursEntry=wsNeighboursEntry, wsTempMeasured=wsTempMeasured, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsEnvironment=wsEnvironment, wsSFPConnector=wsSFPConnector, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourState=wsNeighbourState, wsXFPTempStatus=wsXFPTempStatus, wsTempThresholdLow=wsTempThresholdLow, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsTempTable=wsTempTable, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, ibos=ibos, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsFanRPM=wsFanRPM, wsTempTOS=wsTempTOS, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPIndex=wsXFPIndex, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsFanEntry=wsFanEntry, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsPolicyInPkts=wsPolicyInPkts, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPEntry=wsSFPEntry, wsSFPTempNormalLow=wsSFPTempNormalLow, wsPolicyUsedCnt=wsPolicyUsedCnt, wsPolicyIfIndex=wsPolicyIfIndex, wsIbosFanRPMLow=wsIbosFanRPMLow, wsIbosTempLow=wsIbosTempLow, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTransceiver=wsSFPTransceiver, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSystem=wsSystem, wsSFPTXdBmPower=wsSFPTXdBmPower, wsXFPConnector=wsXFPConnector, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsIbosVoltLow=wsIbosVoltLow, wsVersion=wsVersion, wsReload=wsReload, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPBitrate=wsSFPBitrate, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsAsrRevision=wsAsrRevision, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsXFPSingleModeLen=wsXFPSingleModeLen, wsIbosVoltHigh=wsIbosVoltHigh, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTempStatus=wsSFPTempStatus, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortsTable=wsNeighbourPortsTable, wsXFPTable=wsXFPTable, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsTempTHYST=wsTempTHYST, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsFanVoltage=wsFanVoltage, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourModel=wsNeighbourModel, wsNeighbourHostname=wsNeighbourHostname, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsPolicyName=wsPolicyName, wsSFPCopperLen=wsSFPCopperLen, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourDBCount=wsNeighbourDBCount, wsTempEntry=wsTempEntry, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsAccounting=wsAccounting, wsPFDP=wsPFDP, wsXFPEntry=wsXFPEntry, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortName=wsNeighbourPortName, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsXFPTemp=wsXFPTemp, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourUptime=wsNeighbourUptime, wsSFPTable=wsSFPTable, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsPolicyCookie=wsPolicyCookie, wsSFPIndex=wsSFPIndex, wsTempThresholdHigh=wsTempThresholdHigh, wsVoltTable=wsVoltTable, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsPolicyIfName=wsPolicyIfName, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPTemp=wsSFPTemp, wsVoltEntry=wsVoltEntry, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsVoltStatus=wsVoltStatus, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPRXPower=wsSFPRXPower, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTXCurrent=wsSFPTXCurrent, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsFanNumber=wsFanNumber, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsWritedummy=wsWritedummy, wsTempSensor=wsTempSensor, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsXFPStatus=wsXFPStatus, wsTempStatus=wsTempStatus, PYSNMP_MODULE_ID=ibos, wsPolicyOutBytes=wsPolicyOutBytes, wsVersionString=wsVersionString, wsSFPStatus=wsSFPStatus, wsPolicyOutPkts=wsPolicyOutPkts, wsVoltNominal=wsVoltNominal, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTXPower=wsSFPTXPower, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsIbosTempHigh=wsIbosTempHigh)
