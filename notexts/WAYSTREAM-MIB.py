...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsVoltChannel=wsVoltChannel, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsPolicyEntry=wsPolicyEntry, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPIndex=wsSFPIndex, wsEnvironment=wsEnvironment, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPEntry=wsXFPEntry, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsVoltMeasured=wsVoltMeasured, wsNeighbourModel=wsNeighbourModel, wsWritedummy=wsWritedummy, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTransceiver=wsSFPTransceiver, wsSFPRXPower=wsSFPRXPower, wsSFPCopperLen=wsSFPCopperLen, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsPolicyName=wsPolicyName, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsXFPIndex=wsXFPIndex, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourLocalIf=wsNeighbourLocalIf, wsAsrRevision=wsAsrRevision, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsVoltEntry=wsVoltEntry, wsFanNumber=wsFanNumber, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsXFPConnector=wsXFPConnector, wsSFPTempNormalLow=wsSFPTempNormalLow, wsPolicyInDrops=wsPolicyInDrops, wsVersion=wsVersion, wsVoltTable=wsVoltTable, wsIbosTempHigh=wsIbosTempHigh, wsTempTOS=wsTempTOS, wsXFPTXCurrent=wsXFPTXCurrent, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsTempThresholdHigh=wsTempThresholdHigh, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsTempTable=wsTempTable, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourHostname=wsNeighbourHostname, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourUptime=wsNeighbourUptime, wsSFPVolt=wsSFPVolt, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsPolicyUsedCnt=wsPolicyUsedCnt, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSystem=wsSystem, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsFanTable=wsFanTable, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPPartNumber=wsSFPPartNumber, wsXFPTransceiver=wsXFPTransceiver, wsXFPTXPower=wsXFPTXPower, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsFanEntry=wsFanEntry, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPStatus=wsXFPStatus, wsTempStatus=wsTempStatus, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortState=wsNeighbourPortState, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTempStatus=wsSFPTempStatus, wsIbosFanRPMLow=wsIbosFanRPMLow, wsTempEntry=wsTempEntry, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsFanVoltage=wsFanVoltage, wsSFPTemp=wsSFPTemp, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsXFPRXPower=wsXFPRXPower, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPSingleModeLen=wsSFPSingleModeLen, ibos=ibos, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPEntry=wsSFPEntry, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPStatus=wsSFPStatus, wsNeighboursEntry=wsNeighboursEntry, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsAccounting=wsAccounting, wsSFPTable=wsSFPTable, wsXFPEncoding=wsXFPEncoding, PYSNMP_MODULE_ID=ibos, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsPFDP=wsPFDP, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortName=wsNeighbourPortName, wsSFPConnector=wsSFPConnector, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPTemp=wsXFPTemp, wsSFPBitrate=wsSFPBitrate, wsNeighbourOSVersion=wsNeighbourOSVersion, wsXFPBitrateMin=wsXFPBitrateMin, wsVoltStatus=wsVoltStatus, wsFanRPM=wsFanRPM, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPTable=wsXFPTable, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsPolicyIfName=wsPolicyIfName, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsPolicyTable=wsPolicyTable, wsIbosTempLow=wsIbosTempLow, wsPolicyCookie=wsPolicyCookie, wsSFPVoltStatus=wsSFPVoltStatus, wsTempSensor=wsTempSensor, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsTempMeasured=wsTempMeasured, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsVoltNominal=wsVoltNominal, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourState=wsNeighbourState, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsTempTHYST=wsTempTHYST, wsVersionString=wsVersionString, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPTempWarningLow=wsSFPTempWarningLow, wsReload=wsReload, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts)
