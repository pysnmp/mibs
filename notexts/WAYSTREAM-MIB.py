...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPSerialNumber=wsSFPSerialNumber, wsWritedummy=wsWritedummy, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsXFPEntry=wsXFPEntry, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsVoltTable=wsVoltTable, wsSFPTransceiver=wsSFPTransceiver, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTempStatus=wsSFPTempStatus, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsTempEntry=wsTempEntry, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsIbosTempLow=wsIbosTempLow, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsFanEntry=wsFanEntry, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsPolicyIfName=wsPolicyIfName, wsNeighbourState=wsNeighbourState, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsEnvironment=wsEnvironment, wsVersionString=wsVersionString, wsNeighbourLocalIf=wsNeighbourLocalIf, wsPolicyCookie=wsPolicyCookie, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsXFPTempStatus=wsXFPTempStatus, wsXFPSingleModeLen=wsXFPSingleModeLen, wsFanRPM=wsFanRPM, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTransceiverExt=wsSFPTransceiverExt, wsPFDP=wsPFDP, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsTempThresholdHigh=wsTempThresholdHigh, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourIfIndex=wsNeighbourIfIndex, ibos=ibos, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsVoltNominal=wsVoltNominal, wsSFPSingleModeLen=wsSFPSingleModeLen, wsPolicyName=wsPolicyName, wsXFPConnector=wsXFPConnector, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPCopperLen=wsXFPCopperLen, wsTempTHYST=wsTempTHYST, wsVoltChannel=wsVoltChannel, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighboursEntry=wsNeighboursEntry, wsFanTable=wsFanTable, wsVoltEntry=wsVoltEntry, wsAccounting=wsAccounting, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPEncoding=wsXFPEncoding, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsPolicyInDrops=wsPolicyInDrops, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourOSVersion=wsNeighbourOSVersion, wsVersion=wsVersion, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsTempTOS=wsTempTOS, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsTempTable=wsTempTable, wsVoltStatus=wsVoltStatus, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourUptime=wsNeighbourUptime, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsReload=wsReload, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsFanVoltage=wsFanVoltage, wsNeighbourCreated=wsNeighbourCreated, wsXFPIndex=wsXFPIndex, wsSFPIndex=wsSFPIndex, wsNeighbourModel=wsNeighbourModel, wsSFPStatus=wsSFPStatus, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTemp=wsSFPTemp, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, PYSNMP_MODULE_ID=ibos, wsSFPEntry=wsSFPEntry, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPBitrateMin=wsXFPBitrateMin, wsTempMeasured=wsTempMeasured, wsTempStatus=wsTempStatus, wsFanNumber=wsFanNumber, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsXFPTemp=wsXFPTemp, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsPolicyInPkts=wsPolicyInPkts, wsTempSensor=wsTempSensor, wsNeighbourPortState=wsNeighbourPortState, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourHostname=wsNeighbourHostname, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPVolt=wsSFPVolt, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSystem=wsSystem, wsIbosVoltLow=wsIbosVoltLow, wsSFPTXPower=wsSFPTXPower, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortName=wsNeighbourPortName, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsPolicyTable=wsPolicyTable, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsXFPTable=wsXFPTable, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighboursTable=wsNeighboursTable, wsSFPConnector=wsSFPConnector, wsSFPCopperLen=wsSFPCopperLen, wsXFPStatus=wsXFPStatus, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsXFPTXPower=wsXFPTXPower, wsAsrRevision=wsAsrRevision, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPEncoding=wsSFPEncoding, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTable=wsSFPTable, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsXFPTXCurrent=wsXFPTXCurrent, wsPolicyInBytes=wsPolicyInBytes, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm)
