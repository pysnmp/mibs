...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsPolicyUsedCnt=wsPolicyUsedCnt, wsTempTable=wsTempTable, wsTempSensor=wsTempSensor, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPBitrate=wsSFPBitrate, wsIbosTempLow=wsIbosTempLow, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPPartNumber=wsSFPPartNumber, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsXFPEntry=wsXFPEntry, ibos=ibos, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsVoltEntry=wsVoltEntry, wsNeighboursTable=wsNeighboursTable, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourUptime=wsNeighbourUptime, wsIbosVoltLow=wsIbosVoltLow, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourHostname=wsNeighbourHostname, wsFanTable=wsFanTable, wsEnvironment=wsEnvironment, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPEncoding=wsSFPEncoding, wsVoltStatus=wsVoltStatus, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsVersionString=wsVersionString, wsVoltTable=wsVoltTable, wsNeighboursEntry=wsNeighboursEntry, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTable=wsSFPTable, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortName=wsNeighbourPortName, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsFanRPM=wsFanRPM, wsTempTHYST=wsTempTHYST, PYSNMP_MODULE_ID=ibos, wsXFPStatus=wsXFPStatus, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPRXPower=wsSFPRXPower, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsPolicyTable=wsPolicyTable, wsFanEntry=wsFanEntry, wsTempThresholdLow=wsTempThresholdLow, wsSFPTemp=wsSFPTemp, wsSFPIndex=wsSFPIndex, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsTempTOS=wsTempTOS, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsVoltNominal=wsVoltNominal, wsAccounting=wsAccounting, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXPower=wsSFPTXPower, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsReload=wsReload, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourCreated=wsNeighbourCreated, wsVoltMeasured=wsVoltMeasured, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsPolicyEntry=wsPolicyEntry, wsPolicyCookie=wsPolicyCookie, wsPolicyInDrops=wsPolicyInDrops, wsSFPEntry=wsSFPEntry, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsVersion=wsVersion, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSystem=wsSystem, wsNeighbourModel=wsNeighbourModel, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsWritedummy=wsWritedummy, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourState=wsNeighbourState, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsPolicyName=wsPolicyName, wsVoltChannel=wsVoltChannel, wsPolicyOutBytes=wsPolicyOutBytes, wsFanNumber=wsFanNumber, wsAsrRevision=wsAsrRevision, wsNeighbourOSVersion=wsNeighbourOSVersion, wsXFPConnector=wsXFPConnector, wsIbosVoltHigh=wsIbosVoltHigh, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsFanVoltage=wsFanVoltage, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPTransceiver=wsXFPTransceiver, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsPFDP=wsPFDP, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsXFPCopperLen=wsXFPCopperLen, wsSFPVolt=wsSFPVolt, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourDBCount=wsNeighbourDBCount, wsXFPTable=wsXFPTable, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsPolicyIfName=wsPolicyIfName, wsXFPIndex=wsXFPIndex, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsTempStatus=wsTempStatus, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsTempMeasured=wsTempMeasured, wsXFPEncoding=wsXFPEncoding, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPConnector=wsSFPConnector, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPSerialNumber=wsSFPSerialNumber, wsPolicyInBytes=wsPolicyInBytes, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPTemp=wsXFPTemp, wsTempEntry=wsTempEntry, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTempStatus=wsSFPTempStatus, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPStatus=wsSFPStatus, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex)
