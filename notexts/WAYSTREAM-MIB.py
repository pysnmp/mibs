...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsPolicyEntry=wsPolicyEntry, wsXFPEntry=wsXFPEntry, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPVolt=wsSFPVolt, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsPolicyInBytes=wsPolicyInBytes, wsVoltStatus=wsVoltStatus, wsTempTable=wsTempTable, wsSFPTXPower=wsSFPTXPower, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsFanTable=wsFanTable, wsPolicyInDrops=wsPolicyInDrops, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsPolicyInPkts=wsPolicyInPkts, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPEncoding=wsSFPEncoding, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighboursEntry=wsNeighboursEntry, wsVersion=wsVersion, wsFanRPM=wsFanRPM, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsEnvironment=wsEnvironment, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsTempMeasured=wsTempMeasured, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPEntry=wsSFPEntry, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourState=wsNeighbourState, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsPolicyIfIndex=wsPolicyIfIndex, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourLocalIf=wsNeighbourLocalIf, wsXFPBitrateMax=wsXFPBitrateMax, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighboursTable=wsNeighboursTable, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsTempTOS=wsTempTOS, wsTempStatus=wsTempStatus, wsTempTHYST=wsTempTHYST, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourCreated=wsNeighbourCreated, wsSFPConnector=wsSFPConnector, wsSFPTemp=wsSFPTemp, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsPolicyIfName=wsPolicyIfName, wsXFPCopperLen=wsXFPCopperLen, wsSFPTempNormalLow=wsSFPTempNormalLow, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsXFPConnector=wsXFPConnector, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsVersionString=wsVersionString, wsXFPIndex=wsXFPIndex, wsFanVoltage=wsFanVoltage, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsVoltTable=wsVoltTable, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPPartNumber=wsSFPPartNumber, wsVoltThresholdHigh=wsVoltThresholdHigh, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourIfIndex=wsNeighbourIfIndex, wsXFPTempStatus=wsXFPTempStatus, wsSFPTable=wsSFPTable, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsPFDP=wsPFDP, ibos=ibos, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPTransceiver=wsXFPTransceiver, wsSFPStatus=wsSFPStatus, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPRXPower=wsSFPRXPower, wsVoltChannel=wsVoltChannel, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsAsrRevision=wsAsrRevision, wsTempSensor=wsTempSensor, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsFanEntry=wsFanEntry, wsPolicyOutDrops=wsPolicyOutDrops, wsVoltThresholdLow=wsVoltThresholdLow, wsXFPStatus=wsXFPStatus, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPIndex=wsSFPIndex, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourHostname=wsNeighbourHostname, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSystem=wsSystem, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsXFPEncoding=wsXFPEncoding, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsReload=wsReload, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsPolicyName=wsPolicyName, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsTempEntry=wsTempEntry, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPTransceiverExt=wsSFPTransceiverExt, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourUptime=wsNeighbourUptime, wsSFPBitrate=wsSFPBitrate, wsSFPCopperLen=wsSFPCopperLen, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsWritedummy=wsWritedummy, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsPolicyTable=wsPolicyTable, wsSFPTransceiver=wsSFPTransceiver, wsSFPVoltStatus=wsSFPVoltStatus, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourModel=wsNeighbourModel, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortState=wsNeighbourPortState, wsAccounting=wsAccounting, wsXFPTemp=wsXFPTemp, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsTempThresholdLow=wsTempThresholdLow, wsPolicyCookie=wsPolicyCookie, wsFanNumber=wsFanNumber, wsXFPRXPower=wsXFPRXPower, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, PYSNMP_MODULE_ID=ibos, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsVoltNominal=wsVoltNominal, wsXFPTable=wsXFPTable, wsVoltEntry=wsVoltEntry, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError)
