...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsIbosVoltLow=wsIbosVoltLow, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPTable=wsXFPTable, wsIbosTempLow=wsIbosTempLow, wsTempStatus=wsTempStatus, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsXFPTemp=wsXFPTemp, wsSFPStatus=wsSFPStatus, wsFanVoltage=wsFanVoltage, wsEnvironment=wsEnvironment, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortName=wsNeighbourPortName, wsSFPTXPower=wsSFPTXPower, wsXFPStatus=wsXFPStatus, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPRXdBmPower=wsSFPRXdBmPower, wsTempTOS=wsTempTOS, wsVoltNominal=wsVoltNominal, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsPolicyInPkts=wsPolicyInPkts, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPVolt=wsSFPVolt, wsSFPTXCurrent=wsSFPTXCurrent, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourNIndex=wsNeighbourNIndex, wsPolicyInBytes=wsPolicyInBytes, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPIndex=wsSFPIndex, wsPolicyCookie=wsPolicyCookie, wsXFPRXPower=wsXFPRXPower, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsWritedummy=wsWritedummy, wsXFPEntry=wsXFPEntry, wsNeighbourLastAct=wsNeighbourLastAct, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTable=wsSFPTable, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsPolicyEntry=wsPolicyEntry, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsVersion=wsVersion, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsFanTable=wsFanTable, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPPartNumber=wsSFPPartNumber, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourHostname=wsNeighbourHostname, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPRXPower=wsSFPRXPower, wsAccounting=wsAccounting, wsAsrRevision=wsAsrRevision, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTempStatus=wsSFPTempStatus, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsXFPBitrateMin=wsXFPBitrateMin, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPBitrateMax=wsXFPBitrateMax, wsFanRPM=wsFanRPM, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPEncoding=wsSFPEncoding, wsPolicyOutBytes=wsPolicyOutBytes, wsTempTable=wsTempTable, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsVoltEntry=wsVoltEntry, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourOSVersion=wsNeighbourOSVersion, wsTempSensor=wsTempSensor, wsNeighbourPortState=wsNeighbourPortState, wsNeighboursEntry=wsNeighboursEntry, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsXFPSingleModeLen=wsXFPSingleModeLen, wsIbosTempHigh=wsIbosTempHigh, wsTempThresholdLow=wsTempThresholdLow, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourUptime=wsNeighbourUptime, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsXFPIndex=wsXFPIndex, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPCopperLen=wsSFPCopperLen, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsPolicyIfName=wsPolicyIfName, wsReload=wsReload, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsVoltStatus=wsVoltStatus, wsNeighbourModel=wsNeighbourModel, wsSystem=wsSystem, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsPolicyTable=wsPolicyTable, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsTempTHYST=wsTempTHYST, wsNeighbourPortsTable=wsNeighbourPortsTable, wsVersionString=wsVersionString, wsVoltMeasured=wsVoltMeasured, wsXFPEncoding=wsXFPEncoding, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPEntry=wsSFPEntry, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPTransceiverExt=wsSFPTransceiverExt, wsVoltChannel=wsVoltChannel, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighboursTable=wsNeighboursTable, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsFanEntry=wsFanEntry, wsPolicyName=wsPolicyName, ibos=ibos, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTemp=wsSFPTemp, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPConnector=wsSFPConnector, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, PYSNMP_MODULE_ID=ibos, wsSFPVoltStatus=wsSFPVoltStatus, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsFanNumber=wsFanNumber, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourState=wsNeighbourState, wsTempThresholdHigh=wsTempThresholdHigh, wsTempEntry=wsTempEntry, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsVoltTable=wsVoltTable, wsPFDP=wsPFDP, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsXFPConnector=wsXFPConnector, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsVoltThresholdLow=wsVoltThresholdLow, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsTempMeasured=wsTempMeasured, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets)
