...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsXFPCopperLen=wsXFPCopperLen, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPCopperLen=wsSFPCopperLen, wsWritedummy=wsWritedummy, wsXFPEntry=wsXFPEntry, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsFanRPM=wsFanRPM, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPPartNumber=wsSFPPartNumber, wsSFPEntry=wsSFPEntry, wsSFPConnector=wsSFPConnector, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsTempMeasured=wsTempMeasured, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourCreated=wsNeighbourCreated, wsVersionString=wsVersionString, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighboursEntry=wsNeighboursEntry, wsSFPTempStatus=wsSFPTempStatus, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortName=wsNeighbourPortName, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsFanVoltage=wsFanVoltage, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourModel=wsNeighbourModel, wsIbosTempHigh=wsIbosTempHigh, wsXFPTemp=wsXFPTemp, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsVoltNominal=wsVoltNominal, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsPolicyInBytes=wsPolicyInBytes, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTemp=wsSFPTemp, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsPolicyCookie=wsPolicyCookie, wsEnvironment=wsEnvironment, wsPFDP=wsPFDP, wsAccounting=wsAccounting, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsTempTable=wsTempTable, wsXFPConnector=wsXFPConnector, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsXFPTempStatus=wsXFPTempStatus, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighboursTable=wsNeighboursTable, wsReload=wsReload, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsVoltTable=wsVoltTable, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsTempSensor=wsTempSensor, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsXFPTable=wsXFPTable, wsPolicyOutDrops=wsPolicyOutDrops, wsTempEntry=wsTempEntry, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsVoltMeasured=wsVoltMeasured, wsTempStatus=wsTempStatus, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsFanNumber=wsFanNumber, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPRXdBmPower=wsSFPRXdBmPower, wsFanTable=wsFanTable, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPEncoding=wsSFPEncoding, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourState=wsNeighbourState, wsSFPRXPower=wsSFPRXPower, wsTempThresholdLow=wsTempThresholdLow, PYSNMP_MODULE_ID=ibos, wsSFPStatus=wsSFPStatus, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsXFPEncoding=wsXFPEncoding, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsVersion=wsVersion, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, ibos=ibos, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsVoltStatus=wsVoltStatus, wsTempTOS=wsTempTOS, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsPolicyTable=wsPolicyTable, wsNeighbourLocalIf=wsNeighbourLocalIf, wsTempTHYST=wsTempTHYST, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPTempNormalLow=wsSFPTempNormalLow, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsPolicyOutPkts=wsPolicyOutPkts, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPStatus=wsXFPStatus, wsSFPIndex=wsSFPIndex, wsAsrRevision=wsAsrRevision, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPBitrate=wsSFPBitrate, wsVoltEntry=wsVoltEntry, wsSFPTransceiverExt=wsSFPTransceiverExt, wsIbosVoltHigh=wsIbosVoltHigh, wsSystem=wsSystem, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsPolicyIfName=wsPolicyIfName, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsFanEntry=wsFanEntry, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPTransceiver=wsXFPTransceiver, wsPolicyName=wsPolicyName, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsXFPSingleModeLen=wsXFPSingleModeLen, wsVoltChannel=wsVoltChannel, wsIbosTempLow=wsIbosTempLow, wsSFPVolt=wsSFPVolt, wsSFPTable=wsSFPTable, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPIndex=wsXFPIndex, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourUptime=wsNeighbourUptime, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers)
