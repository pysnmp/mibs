...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsPolicyInPkts=wsPolicyInPkts, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPPartNumber=wsSFPPartNumber, wsAsrRevision=wsAsrRevision, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsXFPTransceiver=wsXFPTransceiver, wsXFPTemp=wsXFPTemp, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourIfIndex=wsNeighbourIfIndex, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPSerialNumber=wsSFPSerialNumber, wsSystem=wsSystem, wsVersionString=wsVersionString, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTransceiver=wsSFPTransceiver, wsFanTable=wsFanTable, wsTempEntry=wsTempEntry, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsXFPEntry=wsXFPEntry, wsVoltNominal=wsVoltNominal, wsPolicyTable=wsPolicyTable, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsXFPEncoding=wsXFPEncoding, wsVoltChannel=wsVoltChannel, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPacketsIn=wsNeighbourPacketsIn, ibos=ibos, wsXFPTable=wsXFPTable, wsPolicyIfIndex=wsPolicyIfIndex, wsVoltTable=wsVoltTable, wsSFPStatus=wsSFPStatus, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPConnector=wsXFPConnector, wsIbosVoltLow=wsIbosVoltLow, wsXFPIndex=wsXFPIndex, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, PYSNMP_MODULE_ID=ibos, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPCopperLen=wsSFPCopperLen, wsSFPSingleModeLen=wsSFPSingleModeLen, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPIndex=wsSFPIndex, wsNeighbourState=wsNeighbourState, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsFanRPM=wsFanRPM, wsXFPRXPower=wsXFPRXPower, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTempNormalLow=wsSFPTempNormalLow, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTempWarningLow=wsSFPTempWarningLow, wsEnvironment=wsEnvironment, wsSFPVolt=wsSFPVolt, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourLastAct=wsNeighbourLastAct, wsPolicyIfName=wsPolicyIfName, wsXFPTXCurrent=wsXFPTXCurrent, wsTempMeasured=wsTempMeasured, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsTempTable=wsTempTable, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortsTable=wsNeighbourPortsTable, wsTempTOS=wsTempTOS, wsSFPTempStatus=wsSFPTempStatus, wsPolicyOutDrops=wsPolicyOutDrops, wsIbosTempLow=wsIbosTempLow, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTable=wsSFPTable, wsXFPBitrateMin=wsXFPBitrateMin, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighboursTable=wsNeighboursTable, wsAccounting=wsAccounting, wsNeighbourPortName=wsNeighbourPortName, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourCreated=wsNeighbourCreated, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsVoltEntry=wsVoltEntry, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPTXPower=wsXFPTXPower, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsTempTHYST=wsTempTHYST, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsFanVoltage=wsFanVoltage, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsWritedummy=wsWritedummy, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsTempSensor=wsTempSensor, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourLocalIf=wsNeighbourLocalIf, wsPolicyName=wsPolicyName, wsIbosTempHigh=wsIbosTempHigh, wsSFPEncoding=wsSFPEncoding, wsNeighbourUptime=wsNeighbourUptime, wsXFPSingleModeLen=wsXFPSingleModeLen, wsXFPCopperLen=wsXFPCopperLen, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPRXPower=wsSFPRXPower, wsSFPEntry=wsSFPEntry, wsTempThresholdLow=wsTempThresholdLow, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPConnector=wsSFPConnector, wsFanEntry=wsFanEntry, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsReload=wsReload, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsPolicyInDrops=wsPolicyInDrops, wsSFPTemp=wsSFPTemp, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsFanNumber=wsFanNumber, wsVersion=wsVersion, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsPolicyOutPkts=wsPolicyOutPkts, wsTempStatus=wsTempStatus, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourHostname=wsNeighbourHostname, wsXFPStatus=wsXFPStatus, wsVoltStatus=wsVoltStatus, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPBitrate=wsSFPBitrate, wsPolicyCookie=wsPolicyCookie, wsPFDP=wsPFDP, wsSFPVoltStatus=wsSFPVoltStatus)
