...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsTempMeasured=wsTempMeasured, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPEncoding=wsSFPEncoding, wsXFPTransceiver=wsXFPTransceiver, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTXPower=wsSFPTXPower, wsSFPTXCurrent=wsSFPTXCurrent, wsVoltStatus=wsVoltStatus, wsVoltMeasured=wsVoltMeasured, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTransceiver=wsSFPTransceiver, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsFanVoltage=wsFanVoltage, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsPolicyOutDrops=wsPolicyOutDrops, wsTempStatus=wsTempStatus, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPPartNumber=wsSFPPartNumber, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsVersion=wsVersion, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTempNormalLow=wsSFPTempNormalLow, wsEnvironment=wsEnvironment, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPTable=wsSFPTable, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourState=wsNeighbourState, wsXFPTempStatus=wsXFPTempStatus, wsSFPCopperLen=wsSFPCopperLen, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsXFPConnector=wsXFPConnector, wsSystem=wsSystem, wsXFPEncoding=wsXFPEncoding, wsPolicyCookie=wsPolicyCookie, wsTempThresholdLow=wsTempThresholdLow, wsTempEntry=wsTempEntry, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortsTable=wsNeighbourPortsTable, wsFanRPM=wsFanRPM, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsIbosFanRPMLow=wsIbosFanRPMLow, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsPolicyInPkts=wsPolicyInPkts, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsAccounting=wsAccounting, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsIbosVoltHigh=wsIbosVoltHigh, wsPFDP=wsPFDP, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPIndex=wsSFPIndex, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortState=wsNeighbourPortState, wsTempTOS=wsTempTOS, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourLocalIf=wsNeighbourLocalIf, wsFanTable=wsFanTable, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsTempTHYST=wsTempTHYST, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPStatus=wsSFPStatus, wsVoltChannel=wsVoltChannel, wsSFPTempStatus=wsSFPTempStatus, wsSFPTXdBmPower=wsSFPTXdBmPower, wsXFPTXPower=wsXFPTXPower, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourLastAct=wsNeighbourLastAct, wsAsrRevision=wsAsrRevision, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsIbosTempLow=wsIbosTempLow, wsTempSensor=wsTempSensor, wsPolicyName=wsPolicyName, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighboursEntry=wsNeighboursEntry, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsXFPTemp=wsXFPTemp, wsPolicyTable=wsPolicyTable, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourModel=wsNeighbourModel, wsSFPBitrate=wsSFPBitrate, wsReload=wsReload, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourOSVersion=wsNeighbourOSVersion, wsVoltNominal=wsVoltNominal, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsVersionString=wsVersionString, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsWritedummy=wsWritedummy, wsXFPIndex=wsXFPIndex, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsXFPTable=wsXFPTable, wsPolicyInDrops=wsPolicyInDrops, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPVolt=wsSFPVolt, wsTempTable=wsTempTable, wsIbosVoltLow=wsIbosVoltLow, wsFanEntry=wsFanEntry, ibos=ibos, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourNIndex=wsNeighbourNIndex, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, PYSNMP_MODULE_ID=ibos, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighboursTable=wsNeighboursTable, wsVoltTable=wsVoltTable, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsVoltEntry=wsVoltEntry, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsPolicyIfName=wsPolicyIfName, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTemp=wsSFPTemp, wsXFPEntry=wsXFPEntry, wsNeighbourPortName=wsNeighbourPortName, wsXFPStatus=wsXFPStatus, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPEntry=wsSFPEntry, wsSFPConnector=wsSFPConnector, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourSNPA=wsNeighbourSNPA, wsFanNumber=wsFanNumber)
