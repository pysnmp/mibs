...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPEncoding=wsSFPEncoding, wsNeighbourNIndex=wsNeighbourNIndex, wsTempThresholdLow=wsTempThresholdLow, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsIbosVoltLow=wsIbosVoltLow, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPConnector=wsXFPConnector, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsVoltChannel=wsVoltChannel, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTable=wsSFPTable, wsSystem=wsSystem, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsTempSensor=wsTempSensor, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsFanTable=wsFanTable, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsFanVoltage=wsFanVoltage, wsSFPEntry=wsSFPEntry, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsVoltStatus=wsVoltStatus, wsSFPSerialNumber=wsSFPSerialNumber, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsAsrRevision=wsAsrRevision, wsSFPCopperLen=wsSFPCopperLen, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsEnvironment=wsEnvironment, wsVoltThresholdHigh=wsVoltThresholdHigh, wsVoltNominal=wsVoltNominal, wsXFPTransceiver=wsXFPTransceiver, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPVolt=wsSFPVolt, wsSFPPartNumber=wsSFPPartNumber, wsVoltTable=wsVoltTable, wsPolicyTable=wsPolicyTable, wsSFPStatus=wsSFPStatus, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsWritedummy=wsWritedummy, ibos=ibos, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsPolicyInBytes=wsPolicyInBytes, wsTempTHYST=wsTempTHYST, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsFanRPM=wsFanRPM, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortSNPA=wsNeighbourPortSNPA, PYSNMP_MODULE_ID=ibos, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsTempMeasured=wsTempMeasured, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsPolicyInPkts=wsPolicyInPkts, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPIndex=wsSFPIndex, wsNeighbourCreated=wsNeighbourCreated, wsNeighboursEntry=wsNeighboursEntry, wsXFPTable=wsXFPTable, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsVoltEntry=wsVoltEntry, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsPFDP=wsPFDP, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsReload=wsReload, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsFanEntry=wsFanEntry, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTXPower=wsSFPTXPower, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortsTable=wsNeighbourPortsTable, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourState=wsNeighbourState, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPConnector=wsSFPConnector, wsAccounting=wsAccounting, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourModel=wsNeighbourModel, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsTempTOS=wsTempTOS, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsXFPEncoding=wsXFPEncoding, wsPolicyOutPkts=wsPolicyOutPkts, wsIbosTempHigh=wsIbosTempHigh, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTemp=wsSFPTemp, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPBitrate=wsSFPBitrate, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsXFPRXPower=wsXFPRXPower, wsNeighbourHostname=wsNeighbourHostname, wsXFPIndex=wsXFPIndex, wsNeighbourUptime=wsNeighbourUptime, wsPolicyUsedCnt=wsPolicyUsedCnt, wsIbosTempLow=wsIbosTempLow, wsPolicyIfName=wsPolicyIfName, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPRXPower=wsSFPRXPower, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsXFPTXCurrent=wsXFPTXCurrent, wsPolicyInDrops=wsPolicyInDrops, wsSFPTempStatus=wsSFPTempStatus, wsXFPStatus=wsXFPStatus, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsXFPBitrateMax=wsXFPBitrateMax, wsTempEntry=wsTempEntry, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourOSVersion=wsNeighbourOSVersion, wsVoltThresholdLow=wsVoltThresholdLow, wsPolicyEntry=wsPolicyEntry, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPTXCurrent=wsSFPTXCurrent, wsVersionString=wsVersionString, wsNeighbourPortName=wsNeighbourPortName, wsPolicyName=wsPolicyName, wsXFPTemp=wsXFPTemp, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsTempStatus=wsTempStatus, wsTempTable=wsTempTable, wsVersion=wsVersion, wsFanNumber=wsFanNumber, wsXFPEntry=wsXFPEntry, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets)
