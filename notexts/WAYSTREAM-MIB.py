...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsFanEntry=wsFanEntry, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsVersion=wsVersion, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortName=wsNeighbourPortName, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourOSVersion=wsNeighbourOSVersion, wsXFPStatus=wsXFPStatus, wsPFDP=wsPFDP, wsXFPTXPower=wsXFPTXPower, wsXFPIndex=wsXFPIndex, wsPolicyName=wsPolicyName, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsPolicyIfName=wsPolicyIfName, wsTempTable=wsTempTable, wsFanTable=wsFanTable, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsAccounting=wsAccounting, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPTemp=wsXFPTemp, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsVoltNominal=wsVoltNominal, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPStatus=wsSFPStatus, wsSFPIndex=wsSFPIndex, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsVersionString=wsVersionString, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPSingleModeLen=wsSFPSingleModeLen, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsTempThresholdLow=wsTempThresholdLow, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPVoltStatus=wsSFPVoltStatus, wsFanNumber=wsFanNumber, wsSystem=wsSystem, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsVoltStatus=wsVoltStatus, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTransceiverExt=wsSFPTransceiverExt, wsPolicyOutBytes=wsPolicyOutBytes, wsPolicyInBytes=wsPolicyInBytes, wsIbosTempLow=wsIbosTempLow, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighboursTable=wsNeighboursTable, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsFanRPM=wsFanRPM, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsTempEntry=wsTempEntry, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourIfIndex=wsNeighbourIfIndex, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPTempWarningLow=wsSFPTempWarningLow, wsPolicyInDrops=wsPolicyInDrops, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPConnector=wsXFPConnector, wsSFPTransceiver=wsSFPTransceiver, wsXFPTable=wsXFPTable, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsIbosTempHigh=wsIbosTempHigh, wsVoltEntry=wsVoltEntry, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsWritedummy=wsWritedummy, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPEntry=wsSFPEntry, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsTempSensor=wsTempSensor, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsTempTHYST=wsTempTHYST, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTXPower=wsSFPTXPower, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, ibos=ibos, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourUptime=wsNeighbourUptime, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsVoltMeasured=wsVoltMeasured, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsTempStatus=wsTempStatus, wsSFPConnector=wsSFPConnector, wsIbosVoltLow=wsIbosVoltLow, wsIbosFanRPMLow=wsIbosFanRPMLow, PYSNMP_MODULE_ID=ibos, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTable=wsSFPTable, wsXFPEntry=wsXFPEntry, wsXFPTransceiver=wsXFPTransceiver, wsPolicyTable=wsPolicyTable, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsPolicyIfIndex=wsPolicyIfIndex, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPEncoding=wsSFPEncoding, wsNeighbourSNPA=wsNeighbourSNPA, wsTempMeasured=wsTempMeasured, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsVoltTable=wsVoltTable, wsAsrRevision=wsAsrRevision, wsNeighbourCreated=wsNeighbourCreated, wsFanVoltage=wsFanVoltage, wsEnvironment=wsEnvironment, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsTempTOS=wsTempTOS, wsSFPVolt=wsSFPVolt, wsPolicyInPkts=wsPolicyInPkts, wsSFPTemp=wsSFPTemp, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourState=wsNeighbourState, wsNeighbourPortsTable=wsNeighbourPortsTable, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsTempThresholdHigh=wsTempThresholdHigh, wsVoltChannel=wsVoltChannel, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsReload=wsReload, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPRXPower=wsSFPRXPower, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPBitrate=wsSFPBitrate, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourModel=wsNeighbourModel, wsXFPRXPower=wsXFPRXPower)
