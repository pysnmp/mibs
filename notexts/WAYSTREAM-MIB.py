...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsTempThresholdHigh=wsTempThresholdHigh, wsVersion=wsVersion, wsXFPTransceiver=wsXFPTransceiver, wsPolicyInDrops=wsPolicyInDrops, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourOSVersion=wsNeighbourOSVersion, wsXFPIndex=wsXFPIndex, wsNeighbourPortName=wsNeighbourPortName, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsPolicyIfName=wsPolicyIfName, wsXFPStatus=wsXFPStatus, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsFanNumber=wsFanNumber, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsPolicyEntry=wsPolicyEntry, wsAccounting=wsAccounting, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsVoltThresholdHigh=wsVoltThresholdHigh, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsXFPTemp=wsXFPTemp, wsSFPRXPower=wsSFPRXPower, wsPolicyTable=wsPolicyTable, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsXFPBitrateMin=wsXFPBitrateMin, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSystem=wsSystem, wsEnvironment=wsEnvironment, wsSFPTempNormalLow=wsSFPTempNormalLow, wsFanVoltage=wsFanVoltage, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsTempStatus=wsTempStatus, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsFanRPM=wsFanRPM, wsXFPEntry=wsXFPEntry, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPConnector=wsSFPConnector, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsTempTOS=wsTempTOS, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsReload=wsReload, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPConnector=wsXFPConnector, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsPolicyName=wsPolicyName, wsNeighboursEntry=wsNeighboursEntry, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourDBCount=wsNeighbourDBCount, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsTempTHYST=wsTempTHYST, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPStatus=wsSFPStatus, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsTempSensor=wsTempSensor, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsVersionString=wsVersionString, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, PYSNMP_MODULE_ID=ibos, wsVoltEntry=wsVoltEntry, wsSFPTransceiver=wsSFPTransceiver, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsPFDP=wsPFDP, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPEntry=wsSFPEntry, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsPolicyOutDrops=wsPolicyOutDrops, wsTempTable=wsTempTable, wsAsrRevision=wsAsrRevision, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsPolicyInPkts=wsPolicyInPkts, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsVoltChannel=wsVoltChannel, wsXFPTXPower=wsXFPTXPower, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsFanEntry=wsFanEntry, wsTempEntry=wsTempEntry, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsIbosTempLow=wsIbosTempLow, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsXFPTempStatus=wsXFPTempStatus, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXPower=wsSFPTXPower, wsSFPSerialNumber=wsSFPSerialNumber, wsVoltStatus=wsVoltStatus, wsWritedummy=wsWritedummy, wsVoltTable=wsVoltTable, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTransceiverExt=wsSFPTransceiverExt, wsPolicyCookie=wsPolicyCookie, wsSFPPartNumber=wsSFPPartNumber, wsPolicyOutPkts=wsPolicyOutPkts, wsFanTable=wsFanTable, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTable=wsSFPTable, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPCopperLen=wsSFPCopperLen, wsXFPTable=wsXFPTable, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPIndex=wsSFPIndex, wsVoltMeasured=wsVoltMeasured, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourModel=wsNeighbourModel, wsSFPTempStatus=wsSFPTempStatus, wsSFPTemp=wsSFPTemp, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPVolt=wsSFPVolt, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourHostname=wsNeighbourHostname, wsVoltNominal=wsVoltNominal, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, ibos=ibos, wsTempMeasured=wsTempMeasured, wsNeighbourState=wsNeighbourState, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPEncoding=wsXFPEncoding, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets)
