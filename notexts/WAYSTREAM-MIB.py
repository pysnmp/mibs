...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsIbosTempLow=wsIbosTempLow, wsFanVoltage=wsFanVoltage, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortState=wsNeighbourPortState, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTransceiver=wsSFPTransceiver, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsAsrRevision=wsAsrRevision, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourState=wsNeighbourState, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsTempMeasured=wsTempMeasured, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourLocalIf=wsNeighbourLocalIf, wsPolicyIfName=wsPolicyIfName, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPEntry=wsXFPEntry, wsNeighbourOSVersion=wsNeighbourOSVersion, wsXFPTemp=wsXFPTemp, wsXFPTable=wsXFPTable, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsVoltMeasured=wsVoltMeasured, wsPolicyName=wsPolicyName, wsXFPEncoding=wsXFPEncoding, wsVersionString=wsVersionString, wsNeighbourIfIndex=wsNeighbourIfIndex, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsFanEntry=wsFanEntry, wsAccounting=wsAccounting, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPConnector=wsSFPConnector, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsXFPIndex=wsXFPIndex, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsXFPTransceiver=wsXFPTransceiver, wsXFPStatus=wsXFPStatus, wsSFPBitrate=wsSFPBitrate, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsWritedummy=wsWritedummy, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPPartNumber=wsSFPPartNumber, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourModel=wsNeighbourModel, wsSFPTransceiverExt=wsSFPTransceiverExt, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPStatus=wsSFPStatus, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourSNPA=wsNeighbourSNPA, wsPFDP=wsPFDP, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPRXdBmPower=wsSFPRXdBmPower, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsXFPConnector=wsXFPConnector, wsXFPCopperLen=wsXFPCopperLen, wsSFPVolt=wsSFPVolt, wsTempTHYST=wsTempTHYST, wsPolicyInDrops=wsPolicyInDrops, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsIbosTempHigh=wsIbosTempHigh, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsXFPTXPower=wsXFPTXPower, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsReload=wsReload, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSystem=wsSystem, wsNeighboursEntry=wsNeighboursEntry, wsVoltNominal=wsVoltNominal, wsSFPTXPower=wsSFPTXPower, wsVoltStatus=wsVoltStatus, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, PYSNMP_MODULE_ID=ibos, wsSFPEncoding=wsSFPEncoding, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, ibos=ibos, wsFanTable=wsFanTable, wsSFPTemp=wsSFPTemp, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsVoltEntry=wsVoltEntry, wsNeighbourNIndex=wsNeighbourNIndex, wsXFPTempStatus=wsXFPTempStatus, wsTempTOS=wsTempTOS, wsSFPEntry=wsSFPEntry, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPIndex=wsSFPIndex, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourUptime=wsNeighbourUptime, wsIbosFanRPMLow=wsIbosFanRPMLow, wsTempTable=wsTempTable, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsVoltTable=wsVoltTable, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsVoltChannel=wsVoltChannel, wsPolicyTable=wsPolicyTable, wsNeighbourHostname=wsNeighbourHostname, wsSFPTempWarningLow=wsSFPTempWarningLow, wsPolicyCookie=wsPolicyCookie, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPTempStatus=wsSFPTempStatus, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsFanNumber=wsFanNumber, wsFanRPM=wsFanRPM, wsNeighbourPortName=wsNeighbourPortName, wsSFPCopperLen=wsSFPCopperLen, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPTable=wsSFPTable, wsEnvironment=wsEnvironment, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsTempSensor=wsTempSensor, wsNeighbourCreated=wsNeighbourCreated, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPRXPower=wsSFPRXPower, wsTempStatus=wsTempStatus, wsIbosVoltHigh=wsIbosVoltHigh, wsTempEntry=wsTempEntry, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsPolicyInPkts=wsPolicyInPkts, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsXFPSingleModeLen=wsXFPSingleModeLen, wsVersion=wsVersion, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions)
