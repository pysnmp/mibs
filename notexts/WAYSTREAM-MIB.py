...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPRXPower=wsSFPRXPower, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPPartNumber=wsSFPPartNumber, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsEnvironment=wsEnvironment, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsVoltEntry=wsVoltEntry, wsVoltStatus=wsVoltStatus, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, PYSNMP_MODULE_ID=ibos, wsXFPCopperLen=wsXFPCopperLen, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSystem=wsSystem, wsVoltNominal=wsVoltNominal, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortName=wsNeighbourPortName, wsSFPTable=wsSFPTable, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsFanVoltage=wsFanVoltage, wsPolicyEntry=wsPolicyEntry, wsVoltTable=wsVoltTable, wsNeighbourState=wsNeighbourState, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighboursTable=wsNeighboursTable, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsPolicyCookie=wsPolicyCookie, wsNeighbourSNPA=wsNeighbourSNPA, wsPolicyInDrops=wsPolicyInDrops, wsFanRPM=wsFanRPM, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPIndex=wsSFPIndex, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsTempEntry=wsTempEntry, wsTempStatus=wsTempStatus, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsPolicyInBytes=wsPolicyInBytes, ibos=ibos, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsPolicyName=wsPolicyName, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPSerialNumber=wsSFPSerialNumber, wsIbosVoltLow=wsIbosVoltLow, wsXFPEntry=wsXFPEntry, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsFanTable=wsFanTable, wsVoltChannel=wsVoltChannel, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsIbosTempLow=wsIbosTempLow, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighboursEntry=wsNeighboursEntry, wsFanNumber=wsFanNumber, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsPFDP=wsPFDP, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTempNormalLow=wsSFPTempNormalLow, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPStatus=wsSFPStatus, wsXFPTXPower=wsXFPTXPower, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsXFPEncoding=wsXFPEncoding, wsXFPRXPower=wsXFPRXPower, wsReload=wsReload, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsTempTOS=wsTempTOS, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsXFPConnector=wsXFPConnector, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsXFPTemp=wsXFPTemp, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPCopperLen=wsSFPCopperLen, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsPolicyIfName=wsPolicyIfName, wsSFPTemp=wsSFPTemp, wsXFPIndex=wsXFPIndex, wsVersionString=wsVersionString, wsNeighbourPortState=wsNeighbourPortState, wsAccounting=wsAccounting, wsPolicyTable=wsPolicyTable, wsSFPEntry=wsSFPEntry, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsIbosTempHigh=wsIbosTempHigh, wsSFPVolt=wsSFPVolt, wsAsrRevision=wsAsrRevision, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsXFPTempStatus=wsXFPTempStatus, wsXFPTable=wsXFPTable, wsTempSensor=wsTempSensor, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourCreated=wsNeighbourCreated, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsWritedummy=wsWritedummy, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsVersion=wsVersion, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsTempMeasured=wsTempMeasured, wsNeighbourModel=wsNeighbourModel, wsSFPSingleModeLen=wsSFPSingleModeLen, wsVoltThresholdHigh=wsVoltThresholdHigh, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPConnector=wsSFPConnector, wsTempTable=wsTempTable, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsXFPStatus=wsXFPStatus, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsPolicyInPkts=wsPolicyInPkts, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourHostname=wsNeighbourHostname, wsSFPTempStatus=wsSFPTempStatus, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPBitrateMin=wsXFPBitrateMin, wsTempTHYST=wsTempTHYST, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsFanEntry=wsFanEntry, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsTempThresholdLow=wsTempThresholdLow, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPSingleModeLen=wsXFPSingleModeLen, wsVoltThresholdLow=wsVoltThresholdLow)
