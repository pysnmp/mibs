...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsVoltStatus=wsVoltStatus, wsSFPPartNumber=wsSFPPartNumber, wsXFPTransceiver=wsXFPTransceiver, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPEncoding=wsSFPEncoding, wsWritedummy=wsWritedummy, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsFanTable=wsFanTable, wsIbosVoltLow=wsIbosVoltLow, wsFanNumber=wsFanNumber, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsXFPTemp=wsXFPTemp, wsSFPTXdBmPower=wsSFPTXdBmPower, wsTempTOS=wsTempTOS, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsPolicyCookie=wsPolicyCookie, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourState=wsNeighbourState, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsAccounting=wsAccounting, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsPFDP=wsPFDP, wsNeighbourPortState=wsNeighbourPortState, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPEncoding=wsXFPEncoding, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPTXCurrent=wsSFPTXCurrent, wsPolicyEntry=wsPolicyEntry, wsXFPIndex=wsXFPIndex, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourNIndex=wsNeighbourNIndex, wsXFPEntry=wsXFPEntry, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsIbosTempLow=wsIbosTempLow, wsSFPTable=wsSFPTable, wsTempTable=wsTempTable, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsVoltTable=wsVoltTable, wsSFPTXPower=wsSFPTXPower, wsNeighbourHostname=wsNeighbourHostname, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTempNormalLow=wsSFPTempNormalLow, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourModel=wsNeighbourModel, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsPolicyIfIndex=wsPolicyIfIndex, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsPolicyInPkts=wsPolicyInPkts, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsFanEntry=wsFanEntry, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPEntry=wsSFPEntry, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPTempStatus=wsSFPTempStatus, wsSFPVolt=wsSFPVolt, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPBitrate=wsSFPBitrate, wsVersionString=wsVersionString, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsVoltNominal=wsVoltNominal, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, PYSNMP_MODULE_ID=ibos, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsReload=wsReload, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSystem=wsSystem, wsAsrRevision=wsAsrRevision, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsXFPTable=wsXFPTable, wsFanRPM=wsFanRPM, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPStatus=wsSFPStatus, wsPolicyName=wsPolicyName, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsPolicyInBytes=wsPolicyInBytes, ibos=ibos, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsPolicyOutBytes=wsPolicyOutBytes, wsVersion=wsVersion, wsTempTHYST=wsTempTHYST, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTemp=wsSFPTemp, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsPolicyIfName=wsPolicyIfName, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsTempEntry=wsTempEntry, wsTempMeasured=wsTempMeasured, wsVoltChannel=wsVoltChannel, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPIndex=wsSFPIndex, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPStatus=wsXFPStatus, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsPolicyTable=wsPolicyTable, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsXFPRXPower=wsXFPRXPower, wsSFPRXdBmPower=wsSFPRXdBmPower, wsTempSensor=wsTempSensor, wsNeighboursEntry=wsNeighboursEntry, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighboursTable=wsNeighboursTable, wsTempStatus=wsTempStatus, wsEnvironment=wsEnvironment, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsVoltEntry=wsVoltEntry, wsXFPConnector=wsXFPConnector, wsSFPConnector=wsSFPConnector, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsFanVoltage=wsFanVoltage, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsXFPCopperLen=wsXFPCopperLen)
