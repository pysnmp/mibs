...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourHostname=wsNeighbourHostname, wsSystem=wsSystem, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortsTable=wsNeighbourPortsTable, wsPolicyTable=wsPolicyTable, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, ibos=ibos, wsReload=wsReload, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsAccounting=wsAccounting, wsXFPEncoding=wsXFPEncoding, wsNeighbourUptime=wsNeighbourUptime, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsTempTOS=wsTempTOS, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsVoltChannel=wsVoltChannel, wsVersion=wsVersion, wsPolicyName=wsPolicyName, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPPartNumber=wsSFPPartNumber, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsPolicyOutPkts=wsPolicyOutPkts, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPVolt=wsSFPVolt, wsWritedummy=wsWritedummy, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsVoltTable=wsVoltTable, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsXFPConnector=wsXFPConnector, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTXPower=wsSFPTXPower, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPStatus=wsSFPStatus, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPEntry=wsSFPEntry, wsVersionString=wsVersionString, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsVoltThresholdHigh=wsVoltThresholdHigh, wsXFPTransceiver=wsXFPTransceiver, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsXFPTXPower=wsXFPTXPower, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourState=wsNeighbourState, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourModel=wsNeighbourModel, wsSFPConnector=wsSFPConnector, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsTempThresholdLow=wsTempThresholdLow, wsPolicyIfName=wsPolicyIfName, wsFanEntry=wsFanEntry, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsFanVoltage=wsFanVoltage, wsXFPStatus=wsXFPStatus, wsNeighbourPortName=wsNeighbourPortName, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, PYSNMP_MODULE_ID=ibos, wsFanNumber=wsFanNumber, wsSFPCopperLen=wsSFPCopperLen, wsVoltStatus=wsVoltStatus, wsSFPRXPower=wsSFPRXPower, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTransceiver=wsSFPTransceiver, wsPolicyInDrops=wsPolicyInDrops, wsVoltNominal=wsVoltNominal, wsPolicyOutBytes=wsPolicyOutBytes, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsVoltEntry=wsVoltEntry, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPBitrate=wsSFPBitrate, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPTemp=wsSFPTemp, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPTable=wsXFPTable, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourCreated=wsNeighbourCreated, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsEnvironment=wsEnvironment, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTransceiverExt=wsSFPTransceiverExt, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsPolicyInBytes=wsPolicyInBytes, wsIbosTempLow=wsIbosTempLow, wsXFPTempStatus=wsXFPTempStatus, wsSFPIndex=wsSFPIndex, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsIbosVoltLow=wsIbosVoltLow, wsAsrRevision=wsAsrRevision, wsFanTable=wsFanTable, wsTempTable=wsTempTable, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsTempStatus=wsTempStatus, wsSFPTable=wsSFPTable, wsTempMeasured=wsTempMeasured, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsPolicyInPkts=wsPolicyInPkts, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPEncoding=wsSFPEncoding, wsXFPBitrateMax=wsXFPBitrateMax, wsTempSensor=wsTempSensor, wsXFPIndex=wsXFPIndex, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsVoltThresholdLow=wsVoltThresholdLow, wsFanRPM=wsFanRPM, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPEntry=wsXFPEntry, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsVoltMeasured=wsVoltMeasured, wsTempTHYST=wsTempTHYST, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPTempStatus=wsSFPTempStatus, wsPFDP=wsPFDP, wsXFPTemp=wsXFPTemp, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsTempEntry=wsTempEntry)
