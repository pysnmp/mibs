...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsVoltEntry=wsVoltEntry, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPCopperLen=wsSFPCopperLen, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTransceiver=wsSFPTransceiver, PYSNMP_MODULE_ID=ibos, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourState=wsNeighbourState, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsVersion=wsVersion, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsTempMeasured=wsTempMeasured, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsXFPTransceiver=wsXFPTransceiver, wsPolicyEntry=wsPolicyEntry, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPStatus=wsSFPStatus, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsFanTable=wsFanTable, wsPolicyTable=wsPolicyTable, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsVoltChannel=wsVoltChannel, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPStatus=wsXFPStatus, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsAsrRevision=wsAsrRevision, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortsTable=wsNeighbourPortsTable, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourCreated=wsNeighbourCreated, wsVoltMeasured=wsVoltMeasured, wsVoltNominal=wsVoltNominal, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsPolicyInPkts=wsPolicyInPkts, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPIndex=wsSFPIndex, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsTempTHYST=wsTempTHYST, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourLastAct=wsNeighbourLastAct, wsIbosTempLow=wsIbosTempLow, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsVersionString=wsVersionString, wsFanVoltage=wsFanVoltage, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSystem=wsSystem, wsTempTOS=wsTempTOS, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsVoltThresholdHigh=wsVoltThresholdHigh, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPConnector=wsSFPConnector, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourUptime=wsNeighbourUptime, wsWritedummy=wsWritedummy, wsPFDP=wsPFDP, wsXFPTable=wsXFPTable, wsSFPVolt=wsSFPVolt, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPEntry=wsSFPEntry, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPPartNumber=wsSFPPartNumber, wsFanRPM=wsFanRPM, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTable=wsSFPTable, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPSerialNumber=wsSFPSerialNumber, wsPolicyName=wsPolicyName, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPTemp=wsXFPTemp, wsSFPTempStatus=wsSFPTempStatus, wsPolicyInDrops=wsPolicyInDrops, wsTempSensor=wsTempSensor, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsTempStatus=wsTempStatus, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsXFPBitrateMin=wsXFPBitrateMin, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsVoltStatus=wsVoltStatus, wsFanEntry=wsFanEntry, wsAccounting=wsAccounting, wsPolicyOutBytes=wsPolicyOutBytes, wsIbosVoltHigh=wsIbosVoltHigh, wsXFPMultiMode50Len=wsXFPMultiMode50Len, ibos=ibos, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsReload=wsReload, wsNeighbourModel=wsNeighbourModel, wsXFPConnector=wsXFPConnector, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsEnvironment=wsEnvironment, wsPolicyIfName=wsPolicyIfName, wsPolicyInBytes=wsPolicyInBytes, wsXFPTXPower=wsXFPTXPower, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPRXdBmPower=wsSFPRXdBmPower, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsTempThresholdLow=wsTempThresholdLow, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPTemp=wsSFPTemp, wsTempEntry=wsTempEntry, wsXFPTempStatus=wsXFPTempStatus, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPBitrateMax=wsXFPBitrateMax, wsTempTable=wsTempTable, wsXFPEntry=wsXFPEntry, wsXFPIndex=wsXFPIndex, wsFanNumber=wsFanNumber, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPRXPower=wsSFPRXPower, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighboursEntry=wsNeighboursEntry, wsVoltTable=wsVoltTable, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPEncoding=wsSFPEncoding, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortState=wsNeighbourPortState, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPEncoding=wsXFPEncoding, wsSFPBitrate=wsSFPBitrate)
