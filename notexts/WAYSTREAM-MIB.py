...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsPolicyInBytes=wsPolicyInBytes, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsVoltEntry=wsVoltEntry, wsTempStatus=wsTempStatus, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTable=wsSFPTable, wsXFPTempStatus=wsXFPTempStatus, wsXFPConnector=wsXFPConnector, wsIbosFanRPMLow=wsIbosFanRPMLow, wsTempMeasured=wsTempMeasured, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSystem=wsSystem, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortName=wsNeighbourPortName, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourUptime=wsNeighbourUptime, wsTempTOS=wsTempTOS, wsEnvironment=wsEnvironment, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsXFPTXPower=wsXFPTXPower, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsTempTHYST=wsTempTHYST, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourLocalIf=wsNeighbourLocalIf, wsFanTable=wsFanTable, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsTempTable=wsTempTable, wsPolicyName=wsPolicyName, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsVoltChannel=wsVoltChannel, wsNeighbourPortsTable=wsNeighbourPortsTable, wsFanRPM=wsFanRPM, wsSFPEncoding=wsSFPEncoding, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighboursTable=wsNeighboursTable, wsSFPVoltStatus=wsSFPVoltStatus, wsVoltNominal=wsVoltNominal, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPTXPower=wsSFPTXPower, wsNeighbourModel=wsNeighbourModel, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPRXPower=wsSFPRXPower, wsSFPTempStatus=wsSFPTempStatus, wsSFPIndex=wsSFPIndex, wsFanVoltage=wsFanVoltage, wsXFPEntry=wsXFPEntry, wsSFPTemp=wsSFPTemp, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsVersionString=wsVersionString, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsPolicyInPkts=wsPolicyInPkts, wsXFPEncoding=wsXFPEncoding, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPVolt=wsSFPVolt, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPStatus=wsSFPStatus, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighboursEntry=wsNeighboursEntry, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsPFDP=wsPFDP, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsPolicyIfName=wsPolicyIfName, wsXFPStatus=wsXFPStatus, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourDBCount=wsNeighbourDBCount, wsPolicyTable=wsPolicyTable, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourState=wsNeighbourState, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsXFPTable=wsXFPTable, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsWritedummy=wsWritedummy, wsXFPTemp=wsXFPTemp, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsTempThresholdHigh=wsTempThresholdHigh, PYSNMP_MODULE_ID=ibos, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsXFPIndex=wsXFPIndex, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPEntry=wsSFPEntry, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsXFPSingleModeLen=wsXFPSingleModeLen, wsXFPCopperLen=wsXFPCopperLen, wsAsrRevision=wsAsrRevision, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPTransceiver=wsSFPTransceiver, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsVoltTable=wsVoltTable, wsNeighbourIfIndex=wsNeighbourIfIndex, wsFanNumber=wsFanNumber, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsTempThresholdLow=wsTempThresholdLow, wsPolicyInDrops=wsPolicyInDrops, wsVoltMeasured=wsVoltMeasured, wsReload=wsReload, wsPolicyIfIndex=wsPolicyIfIndex, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsVersion=wsVersion, wsSFPCopperLen=wsSFPCopperLen, ibos=ibos, wsXFPTransceiver=wsXFPTransceiver, wsSFPBitrate=wsSFPBitrate, wsSFPSingleModeLen=wsSFPSingleModeLen, wsAccounting=wsAccounting, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsTempEntry=wsTempEntry, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsIbosVoltLow=wsIbosVoltLow, wsFanEntry=wsFanEntry, wsPolicyCookie=wsPolicyCookie, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTXCurrent=wsSFPTXCurrent, wsTempSensor=wsTempSensor, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPConnector=wsSFPConnector, wsPolicyEntry=wsPolicyEntry, wsIbosTempLow=wsIbosTempLow, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsVoltStatus=wsVoltStatus, wsSFPPartNumber=wsSFPPartNumber, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow)
