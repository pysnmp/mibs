...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPPartNumber=wsSFPPartNumber, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsPolicyInDrops=wsPolicyInDrops, wsIbosTempLow=wsIbosTempLow, wsNeighboursTable=wsNeighboursTable, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTable=wsSFPTable, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsVersionString=wsVersionString, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsVoltStatus=wsVoltStatus, wsNeighbourNIndex=wsNeighbourNIndex, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourState=wsNeighbourState, wsSFPIndex=wsSFPIndex, wsTempMeasured=wsTempMeasured, wsReload=wsReload, wsVoltNominal=wsVoltNominal, wsXFPEntry=wsXFPEntry, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPConnector=wsSFPConnector, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsVoltMeasured=wsVoltMeasured, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsFanEntry=wsFanEntry, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPRXPower=wsSFPRXPower, wsSFPTempStatus=wsSFPTempStatus, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourOSVersion=wsNeighbourOSVersion, wsVoltTable=wsVoltTable, wsFanTable=wsFanTable, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsEnvironment=wsEnvironment, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsTempEntry=wsTempEntry, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsPolicyInPkts=wsPolicyInPkts, wsSFPBitrate=wsSFPBitrate, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPVolt=wsSFPVolt, wsSystem=wsSystem, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsTempTOS=wsTempTOS, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPEntry=wsSFPEntry, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPEncoding=wsSFPEncoding, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsPolicyOutDrops=wsPolicyOutDrops, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsAsrRevision=wsAsrRevision, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsWritedummy=wsWritedummy, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTempNormalLow=wsSFPTempNormalLow, wsFanRPM=wsFanRPM, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPTemp=wsXFPTemp, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsXFPTable=wsXFPTable, wsTempSensor=wsTempSensor, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsXFPTXPower=wsXFPTXPower, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighboursEntry=wsNeighboursEntry, wsXFPStatus=wsXFPStatus, wsNeighbourModel=wsNeighbourModel, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPTempStatus=wsXFPTempStatus, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsVoltThresholdHigh=wsVoltThresholdHigh, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsPFDP=wsPFDP, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsVersion=wsVersion, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsFanNumber=wsFanNumber, wsVoltChannel=wsVoltChannel, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPIndex=wsXFPIndex, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsXFPConnector=wsXFPConnector, wsTempTable=wsTempTable, wsVoltEntry=wsVoltEntry, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsXFPEncoding=wsXFPEncoding, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, PYSNMP_MODULE_ID=ibos, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPStatus=wsSFPStatus, wsFanVoltage=wsFanVoltage, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsTempStatus=wsTempStatus, wsTempTHYST=wsTempTHYST, wsSFPTemp=wsSFPTemp, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPTransceiver=wsXFPTransceiver, wsAccounting=wsAccounting, wsTempThresholdLow=wsTempThresholdLow, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsPolicyOutPkts=wsPolicyOutPkts, wsPolicyName=wsPolicyName, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsPolicyTable=wsPolicyTable, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortState=wsNeighbourPortState, wsIbosVoltLow=wsIbosVoltLow, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourLastAct=wsNeighbourLastAct, ibos=ibos)
