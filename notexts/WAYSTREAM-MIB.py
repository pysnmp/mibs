...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsVoltEntry=wsVoltEntry, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourUptime=wsNeighbourUptime, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPTable=wsSFPTable, wsIbosTempHigh=wsIbosTempHigh, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPEntry=wsSFPEntry, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourState=wsNeighbourState, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourCreated=wsNeighbourCreated, wsVoltThresholdLow=wsVoltThresholdLow, wsXFPCopperLen=wsXFPCopperLen, wsSFPTemp=wsSFPTemp, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsReload=wsReload, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsVoltThresholdHigh=wsVoltThresholdHigh, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighboursEntry=wsNeighboursEntry, wsPolicyInDrops=wsPolicyInDrops, wsXFPEntry=wsXFPEntry, wsNeighbourHostname=wsNeighbourHostname, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPRXPower=wsXFPRXPower, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPEncoding=wsSFPEncoding, wsPolicyInBytes=wsPolicyInBytes, wsTempSensor=wsTempSensor, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPStatus=wsXFPStatus, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsAsrRevision=wsAsrRevision, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsTempTOS=wsTempTOS, wsFanNumber=wsFanNumber, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTransceiver=wsSFPTransceiver, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsPolicyTable=wsPolicyTable, wsSFPTransceiverExt=wsSFPTransceiverExt, wsPolicyInPkts=wsPolicyInPkts, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsXFPTempStatus=wsXFPTempStatus, wsSFPIndex=wsSFPIndex, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPPartNumber=wsSFPPartNumber, wsIbosVoltHigh=wsIbosVoltHigh, wsEnvironment=wsEnvironment, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPCopperLen=wsSFPCopperLen, wsSFPTempStatus=wsSFPTempStatus, wsTempTable=wsTempTable, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, ibos=ibos, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsXFPConnector=wsXFPConnector, wsVoltStatus=wsVoltStatus, wsFanTable=wsFanTable, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsFanEntry=wsFanEntry, wsVersion=wsVersion, wsIbosVoltLow=wsIbosVoltLow, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPRXdBmPower=wsSFPRXdBmPower, wsTempEntry=wsTempEntry, wsFanRPM=wsFanRPM, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsXFPTemp=wsXFPTemp, wsVersionString=wsVersionString, wsPFDP=wsPFDP, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsVoltChannel=wsVoltChannel, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsPolicyName=wsPolicyName, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPTXdBmPower=wsSFPTXdBmPower, wsVoltTable=wsVoltTable, wsXFPIndex=wsXFPIndex, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsPolicyOutDrops=wsPolicyOutDrops, wsTempMeasured=wsTempMeasured, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPVolt=wsSFPVolt, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsVoltMeasured=wsVoltMeasured, wsXFPTXPower=wsXFPTXPower, wsTempThresholdLow=wsTempThresholdLow, wsSystem=wsSystem, wsTempTHYST=wsTempTHYST, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPConnector=wsSFPConnector, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsVoltNominal=wsVoltNominal, wsAccounting=wsAccounting, wsPolicyIfName=wsPolicyIfName, wsSFPBitrate=wsSFPBitrate, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPVoltStatus=wsSFPVoltStatus, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsXFPTable=wsXFPTable, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsWritedummy=wsWritedummy, wsNeighbourLastAct=wsNeighbourLastAct, wsIbosFanRPMLow=wsIbosFanRPMLow, wsPolicyEntry=wsPolicyEntry, wsSFPStatus=wsSFPStatus, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsFanVoltage=wsFanVoltage, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsTempStatus=wsTempStatus, PYSNMP_MODULE_ID=ibos, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets)
