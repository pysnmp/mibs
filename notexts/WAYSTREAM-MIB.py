...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsFanVoltage=wsFanVoltage, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsXFPStatus=wsXFPStatus, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsPolicyName=wsPolicyName, wsIbosTempLow=wsIbosTempLow, ibos=ibos, wsNeighboursEntry=wsNeighboursEntry, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsPolicyIfIndex=wsPolicyIfIndex, wsAsrRevision=wsAsrRevision, wsSFPTransceiverExt=wsSFPTransceiverExt, wsVoltNominal=wsVoltNominal, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsXFPEncoding=wsXFPEncoding, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourNIndex=wsNeighbourNIndex, wsXFPSingleModeLen=wsXFPSingleModeLen, wsXFPTempStatus=wsXFPTempStatus, wsSFPTemp=wsSFPTemp, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsReload=wsReload, wsNeighbourPortName=wsNeighbourPortName, wsVoltChannel=wsVoltChannel, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPCopperLen=wsSFPCopperLen, wsFanTable=wsFanTable, wsPolicyCookie=wsPolicyCookie, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsXFPTable=wsXFPTable, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsPolicyOutBytes=wsPolicyOutBytes, wsTempEntry=wsTempEntry, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPIndex=wsSFPIndex, wsTempSensor=wsTempSensor, wsSFPVolt=wsSFPVolt, wsPolicyInBytes=wsPolicyInBytes, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPBitrate=wsSFPBitrate, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsTempStatus=wsTempStatus, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsPFDP=wsPFDP, wsVersion=wsVersion, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPTransceiver=wsXFPTransceiver, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsFanNumber=wsFanNumber, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPTempNormalLow=wsSFPTempNormalLow, wsTempTHYST=wsTempTHYST, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighboursTable=wsNeighboursTable, wsSFPEntry=wsSFPEntry, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsPolicyInPkts=wsPolicyInPkts, wsVoltEntry=wsVoltEntry, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsPolicyTable=wsPolicyTable, wsSFPRXPower=wsSFPRXPower, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTransceiver=wsSFPTransceiver, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPConnector=wsSFPConnector, wsVoltMeasured=wsVoltMeasured, wsXFPIndex=wsXFPIndex, wsSFPStatus=wsSFPStatus, wsFanEntry=wsFanEntry, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsVoltThresholdHigh=wsVoltThresholdHigh, wsPolicyInDrops=wsPolicyInDrops, wsSystem=wsSystem, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsXFPEntry=wsXFPEntry, wsTempTOS=wsTempTOS, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourIfIndex=wsNeighbourIfIndex, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourState=wsNeighbourState, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsXFPConnector=wsXFPConnector, wsVoltStatus=wsVoltStatus, wsTempTable=wsTempTable, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, PYSNMP_MODULE_ID=ibos, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsVersionString=wsVersionString, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPPartNumber=wsSFPPartNumber, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTable=wsSFPTable, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsAccounting=wsAccounting, wsIbosVoltLow=wsIbosVoltLow, wsTempMeasured=wsTempMeasured, wsXFPTemp=wsXFPTemp, wsXFPBitrateMax=wsXFPBitrateMax, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsWritedummy=wsWritedummy, wsPolicyOutPkts=wsPolicyOutPkts, wsFanRPM=wsFanRPM, wsEnvironment=wsEnvironment, wsSFPVoltStatus=wsSFPVoltStatus, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTXPower=wsSFPTXPower, wsVoltTable=wsVoltTable, wsIbosTempHigh=wsIbosTempHigh, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourModel=wsNeighbourModel, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTXdBmPower=wsSFPTXdBmPower)
