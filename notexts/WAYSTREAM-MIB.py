...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourHostname=wsNeighbourHostname, wsSFPIndex=wsSFPIndex, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPSingleModeLen=wsSFPSingleModeLen, wsIbosVoltLow=wsIbosVoltLow, wsXFPTable=wsXFPTable, wsNeighbourState=wsNeighbourState, wsTempTOS=wsTempTOS, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourCreated=wsNeighbourCreated, wsPolicyInBytes=wsPolicyInBytes, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsAsrRevision=wsAsrRevision, wsSFPEncoding=wsSFPEncoding, wsXFPStatus=wsXFPStatus, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPRXPower=wsSFPRXPower, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourIfIndex=wsNeighbourIfIndex, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsPolicyName=wsPolicyName, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsXFPEncoding=wsXFPEncoding, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPTransceiver=wsXFPTransceiver, wsVoltMeasured=wsVoltMeasured, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPConnector=wsSFPConnector, wsNeighbourPortPIndex=wsNeighbourPortPIndex, ibos=ibos, wsWritedummy=wsWritedummy, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsIbosVoltHigh=wsIbosVoltHigh, wsFanNumber=wsFanNumber, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsTempTable=wsTempTable, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourLocalIf=wsNeighbourLocalIf, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSystem=wsSystem, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPStatus=wsSFPStatus, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsXFPSingleModeLen=wsXFPSingleModeLen, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsXFPTempStatus=wsXFPTempStatus, wsFanEntry=wsFanEntry, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsXFPCopperLen=wsXFPCopperLen, wsSFPEntry=wsSFPEntry, wsPolicyOutPkts=wsPolicyOutPkts, wsTempTHYST=wsTempTHYST, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsXFPConnector=wsXFPConnector, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsIbosFanRPMLow=wsIbosFanRPMLow, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsTempThresholdLow=wsTempThresholdLow, wsSFPTempWarningLow=wsSFPTempWarningLow, wsVersionString=wsVersionString, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTable=wsSFPTable, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTempNormalLow=wsSFPTempNormalLow, wsEnvironment=wsEnvironment, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTemp=wsSFPTemp, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTXPower=wsSFPTXPower, wsPolicyEntry=wsPolicyEntry, wsPolicyOutDrops=wsPolicyOutDrops, wsReload=wsReload, wsVoltTable=wsVoltTable, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPTemp=wsXFPTemp, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPVolt=wsSFPVolt, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPRXPower=wsXFPRXPower, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsTempSensor=wsTempSensor, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighboursEntry=wsNeighboursEntry, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsXFPEntry=wsXFPEntry, wsNeighbourUptime=wsNeighbourUptime, wsIbosTempLow=wsIbosTempLow, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsFanTable=wsFanTable, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPCopperLen=wsSFPCopperLen, wsSFPBitrate=wsSFPBitrate, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsPolicyIfIndex=wsPolicyIfIndex, wsVoltNominal=wsVoltNominal, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsFanVoltage=wsFanVoltage, wsSFPTransceiver=wsSFPTransceiver, wsFanRPM=wsFanRPM, wsVoltChannel=wsVoltChannel, wsTempMeasured=wsTempMeasured, wsVoltEntry=wsVoltEntry, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourModel=wsNeighbourModel, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsPolicyInDrops=wsPolicyInDrops, wsVoltThresholdLow=wsVoltThresholdLow, wsPFDP=wsPFDP, PYSNMP_MODULE_ID=ibos, wsTempEntry=wsTempEntry, wsTempStatus=wsTempStatus, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTransceiverExt=wsSFPTransceiverExt, wsXFPIndex=wsXFPIndex, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPPartNumber=wsSFPPartNumber, wsPolicyCookie=wsPolicyCookie, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsVoltStatus=wsVoltStatus, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTXdBmPower=wsSFPTXdBmPower, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsVersion=wsVersion, wsXFPBitrateMin=wsXFPBitrateMin, wsAccounting=wsAccounting, wsPolicyTable=wsPolicyTable, wsNeighbourPortsEntry=wsNeighbourPortsEntry)
