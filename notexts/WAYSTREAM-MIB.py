...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsXFPEntry=wsXFPEntry, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, ibos=ibos, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsVersion=wsVersion, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPEncoding=wsSFPEncoding, wsSFPTemp=wsSFPTemp, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourModel=wsNeighbourModel, wsXFPTable=wsXFPTable, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPStatus=wsSFPStatus, wsVoltEntry=wsVoltEntry, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPIndex=wsSFPIndex, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsPolicyTable=wsPolicyTable, wsNeighbourLocalIf=wsNeighbourLocalIf, wsPolicyEntry=wsPolicyEntry, wsSFPRXPower=wsSFPRXPower, wsXFPEncoding=wsXFPEncoding, wsVoltTable=wsVoltTable, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPVolt=wsSFPVolt, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsFanRPM=wsFanRPM, wsIbosFanRPMLow=wsIbosFanRPMLow, wsVoltStatus=wsVoltStatus, wsVersionString=wsVersionString, wsSFPBitrate=wsSFPBitrate, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsTempTOS=wsTempTOS, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPRXdBmPower=wsSFPRXdBmPower, wsTempEntry=wsTempEntry, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsTempMeasured=wsTempMeasured, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourNIndex=wsNeighbourNIndex, wsPolicyInDrops=wsPolicyInDrops, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsVoltMeasured=wsVoltMeasured, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsTempTHYST=wsTempTHYST, wsVoltNominal=wsVoltNominal, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourHostname=wsNeighbourHostname, wsSystem=wsSystem, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsEnvironment=wsEnvironment, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsXFPTXPower=wsXFPTXPower, wsWritedummy=wsWritedummy, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsIbosTempLow=wsIbosTempLow, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPTemp=wsXFPTemp, wsXFPIndex=wsXFPIndex, wsXFPStatus=wsXFPStatus, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsVoltChannel=wsVoltChannel, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTempStatus=wsSFPTempStatus, wsTempTable=wsTempTable, wsNeighbourState=wsNeighbourState, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourCreated=wsNeighbourCreated, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTable=wsSFPTable, wsNeighbourPortName=wsNeighbourPortName, wsTempSensor=wsTempSensor, wsPFDP=wsPFDP, wsNeighboursTable=wsNeighboursTable, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsPolicyCookie=wsPolicyCookie, wsPolicyIfName=wsPolicyIfName, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPEntry=wsSFPEntry, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTempNormalLow=wsSFPTempNormalLow, PYSNMP_MODULE_ID=ibos, wsPolicyName=wsPolicyName, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTransceiver=wsSFPTransceiver, wsXFPTransceiver=wsXFPTransceiver, wsXFPTempStatus=wsXFPTempStatus, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPSingleModeLen=wsXFPSingleModeLen, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortState=wsNeighbourPortState, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPConnector=wsSFPConnector, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPCopperLen=wsSFPCopperLen, wsAsrRevision=wsAsrRevision, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsFanEntry=wsFanEntry, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPCopperLen=wsXFPCopperLen, wsSFPTXPower=wsSFPTXPower, wsAccounting=wsAccounting, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsFanTable=wsFanTable, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsPolicyInBytes=wsPolicyInBytes, wsIbosVoltLow=wsIbosVoltLow, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsXFPConnector=wsXFPConnector, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsReload=wsReload, wsTempStatus=wsTempStatus, wsXFPBitrateMax=wsXFPBitrateMax, wsFanVoltage=wsFanVoltage, wsFanNumber=wsFanNumber, wsSFPTXPowerStatus=wsSFPTXPowerStatus)
