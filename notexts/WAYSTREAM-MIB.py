...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsVoltTable=wsVoltTable, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsXFPTransceiver=wsXFPTransceiver, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPTable=wsSFPTable, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsXFPIndex=wsXFPIndex, wsVoltEntry=wsVoltEntry, wsPolicyEntry=wsPolicyEntry, wsTempThresholdLow=wsTempThresholdLow, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTemp=wsSFPTemp, wsPolicyName=wsPolicyName, wsSFPPartNumber=wsSFPPartNumber, wsSFPVolt=wsSFPVolt, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsPolicyIfName=wsPolicyIfName, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsEnvironment=wsEnvironment, wsNeighboursEntry=wsNeighboursEntry, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsTempTOS=wsTempTOS, wsFanNumber=wsFanNumber, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPEntry=wsXFPEntry, wsFanEntry=wsFanEntry, wsSFPSerialNumber=wsSFPSerialNumber, wsFanTable=wsFanTable, wsAsrRevision=wsAsrRevision, wsNeighbourState=wsNeighbourState, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPTransceiver=wsSFPTransceiver, wsXFPTable=wsXFPTable, wsXFPConnector=wsXFPConnector, wsTempTHYST=wsTempTHYST, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsXFPTXPower=wsXFPTXPower, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsPFDP=wsPFDP, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsIbosTempLow=wsIbosTempLow, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourModel=wsNeighbourModel, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourNIndex=wsNeighbourNIndex, wsXFPTemp=wsXFPTemp, wsTempMeasured=wsTempMeasured, wsSFPTempStatus=wsSFPTempStatus, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsVoltChannel=wsVoltChannel, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsXFPRXPower=wsXFPRXPower, wsPolicyTable=wsPolicyTable, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsPolicyInPkts=wsPolicyInPkts, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsPolicyInDrops=wsPolicyInDrops, wsFanVoltage=wsFanVoltage, wsSFPConnector=wsSFPConnector, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, ibos=ibos, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsPolicyOutPkts=wsPolicyOutPkts, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPCopperLen=wsXFPCopperLen, wsVersionString=wsVersionString, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsReload=wsReload, wsSFPStatus=wsSFPStatus, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsAccounting=wsAccounting, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPBitrate=wsSFPBitrate, wsXFPStatus=wsXFPStatus, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsIbosVoltLow=wsIbosVoltLow, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourUptime=wsNeighbourUptime, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPEntry=wsSFPEntry, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsTempTable=wsTempTable, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSystem=wsSystem, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsTempStatus=wsTempStatus, wsWritedummy=wsWritedummy, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPIndex=wsSFPIndex, wsVersion=wsVersion, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsTempSensor=wsTempSensor, wsPolicyInBytes=wsPolicyInBytes, wsXFPEncoding=wsXFPEncoding, wsIbosFanRPMLow=wsIbosFanRPMLow, wsVoltStatus=wsVoltStatus, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPRXPower=wsSFPRXPower, wsFanRPM=wsFanRPM, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortName=wsNeighbourPortName, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsVoltMeasured=wsVoltMeasured, wsSFPTransceiverExt=wsSFPTransceiverExt, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPEncoding=wsSFPEncoding, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, PYSNMP_MODULE_ID=ibos, wsNeighbourSNPA=wsNeighbourSNPA, wsVoltNominal=wsVoltNominal, wsSFPCopperLen=wsSFPCopperLen, wsTempEntry=wsTempEntry, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTXPower=wsSFPTXPower, wsNeighbourIfIndex=wsNeighbourIfIndex)
