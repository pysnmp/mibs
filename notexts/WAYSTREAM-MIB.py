...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsTempSensor=wsTempSensor, wsNeighbourNIndex=wsNeighbourNIndex, wsPolicyIfIndex=wsPolicyIfIndex, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPConnector=wsSFPConnector, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsIbosVoltLow=wsIbosVoltLow, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPRXPower=wsSFPRXPower, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsXFPTemp=wsXFPTemp, wsSFPIndex=wsSFPIndex, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPTempStatus=wsXFPTempStatus, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighboursTable=wsNeighboursTable, wsSFPBitrate=wsSFPBitrate, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsFanTable=wsFanTable, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsPolicyInBytes=wsPolicyInBytes, wsSFPRXdBmPower=wsSFPRXdBmPower, wsTempStatus=wsTempStatus, wsVersion=wsVersion, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSystem=wsSystem, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsTempMeasured=wsTempMeasured, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortName=wsNeighbourPortName, wsVoltEntry=wsVoltEntry, wsVoltTable=wsVoltTable, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsAsrRevision=wsAsrRevision, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourModel=wsNeighbourModel, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTransceiverExt=wsSFPTransceiverExt, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsTempTHYST=wsTempTHYST, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourHostname=wsNeighbourHostname, wsFanVoltage=wsFanVoltage, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsVoltChannel=wsVoltChannel, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPCopperLen=wsSFPCopperLen, wsPolicyTable=wsPolicyTable, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighboursEntry=wsNeighboursEntry, wsSFPPartNumber=wsSFPPartNumber, wsTempTable=wsTempTable, wsVoltStatus=wsVoltStatus, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPStatus=wsSFPStatus, wsXFPConnector=wsXFPConnector, wsNeighbourLocalIf=wsNeighbourLocalIf, wsVersionString=wsVersionString, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsIbosTempLow=wsIbosTempLow, wsPolicyInDrops=wsPolicyInDrops, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsAccounting=wsAccounting, wsXFPTransceiver=wsXFPTransceiver, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPStatus=wsXFPStatus, wsXFPBitrateMin=wsXFPBitrateMin, wsReload=wsReload, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPIndex=wsXFPIndex, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPVolt=wsSFPVolt, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsPolicyInPkts=wsPolicyInPkts, wsPFDP=wsPFDP, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourIfIndex=wsNeighbourIfIndex, wsXFPTable=wsXFPTable, wsEnvironment=wsEnvironment, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourCreated=wsNeighbourCreated, wsSFPTXPower=wsSFPTXPower, wsSFPEncoding=wsSFPEncoding, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPTXPower=wsXFPTXPower, wsFanNumber=wsFanNumber, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsTempThresholdLow=wsTempThresholdLow, wsTempEntry=wsTempEntry, wsSFPTemp=wsSFPTemp, wsNeighbourPortState=wsNeighbourPortState, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTable=wsSFPTable, wsTempTOS=wsTempTOS, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourState=wsNeighbourState, wsXFPSingleModeLen=wsXFPSingleModeLen, wsFanEntry=wsFanEntry, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsXFPEntry=wsXFPEntry, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPEntry=wsSFPEntry, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsPolicyIfName=wsPolicyIfName, ibos=ibos, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsPolicyName=wsPolicyName, wsFanRPM=wsFanRPM, wsVoltThresholdHigh=wsVoltThresholdHigh, PYSNMP_MODULE_ID=ibos, wsVoltNominal=wsVoltNominal, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsIbosTempHigh=wsIbosTempHigh, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourUptime=wsNeighbourUptime, wsWritedummy=wsWritedummy)
