...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsVersionString=wsVersionString, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPIndex=wsXFPIndex, wsNeighbourNIndex=wsNeighbourNIndex, wsAsrRevision=wsAsrRevision, wsSFPVolt=wsSFPVolt, wsNeighboursTable=wsNeighboursTable, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPRXPower=wsXFPRXPower, wsNeighbourState=wsNeighbourState, wsXFPCopperLen=wsXFPCopperLen, wsIbosFanRPMLow=wsIbosFanRPMLow, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsIbosVoltLow=wsIbosVoltLow, wsPolicyName=wsPolicyName, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsFanTable=wsFanTable, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsXFPStatus=wsXFPStatus, wsXFPConnector=wsXFPConnector, wsNeighboursEntry=wsNeighboursEntry, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPVoltStatus=wsSFPVoltStatus, wsAccounting=wsAccounting, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsVoltThresholdLow=wsVoltThresholdLow, wsFanRPM=wsFanRPM, wsVoltTable=wsVoltTable, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsIbosTempHigh=wsIbosTempHigh, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsVoltEntry=wsVoltEntry, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsReload=wsReload, wsSFPStatus=wsSFPStatus, wsSFPConnector=wsSFPConnector, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPBitrate=wsSFPBitrate, wsNeighbourUptime=wsNeighbourUptime, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPSerialNumber=wsSFPSerialNumber, wsPolicyInPkts=wsPolicyInPkts, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPEntry=wsSFPEntry, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsPolicyIfIndex=wsPolicyIfIndex, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsVoltChannel=wsVoltChannel, wsXFPEntry=wsXFPEntry, wsPolicyIfName=wsPolicyIfName, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsPFDP=wsPFDP, wsVoltNominal=wsVoltNominal, wsSystem=wsSystem, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsPolicyInDrops=wsPolicyInDrops, wsFanNumber=wsFanNumber, wsNeighbourIfIndex=wsNeighbourIfIndex, wsPolicyCookie=wsPolicyCookie, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsTempTOS=wsTempTOS, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsTempEntry=wsTempEntry, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsVoltStatus=wsVoltStatus, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsPolicyInBytes=wsPolicyInBytes, wsVersion=wsVersion, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsTempTable=wsTempTable, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsTempThresholdLow=wsTempThresholdLow, wsSFPTemp=wsSFPTemp, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPCopperLen=wsSFPCopperLen, wsFanEntry=wsFanEntry, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsPolicyEntry=wsPolicyEntry, wsEnvironment=wsEnvironment, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPRXdBmPower=wsSFPRXdBmPower, wsXFPTable=wsXFPTable, wsXFPEncoding=wsXFPEncoding, wsFanVoltage=wsFanVoltage, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPRXPower=wsSFPRXPower, wsSFPTable=wsSFPTable, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourHostname=wsNeighbourHostname, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsWritedummy=wsWritedummy, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPIndex=wsSFPIndex, wsTempSensor=wsTempSensor, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTempStatus=wsSFPTempStatus, wsIbosTempLow=wsIbosTempLow, wsPolicyTable=wsPolicyTable, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsXFPTempStatus=wsXFPTempStatus, wsTempMeasured=wsTempMeasured, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourModel=wsNeighbourModel, ibos=ibos, PYSNMP_MODULE_ID=ibos, wsSFPEncoding=wsSFPEncoding, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsTempTHYST=wsTempTHYST, wsNeighbourPortsTable=wsNeighbourPortsTable, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourDBCount=wsNeighbourDBCount, wsXFPTemp=wsXFPTemp, wsTempStatus=wsTempStatus, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsVoltThresholdHigh=wsVoltThresholdHigh, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTXPower=wsSFPTXPower, wsSFPRXPowerStatus=wsSFPRXPowerStatus)
