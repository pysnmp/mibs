...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPTempStatus=wsSFPTempStatus, wsSFPCopperLen=wsSFPCopperLen, wsSFPSerialNumber=wsSFPSerialNumber, wsPolicyIfName=wsPolicyIfName, wsSFPTable=wsSFPTable, wsTempTHYST=wsTempTHYST, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsTempEntry=wsTempEntry, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsVoltStatus=wsVoltStatus, wsSFPSingleModeLen=wsSFPSingleModeLen, wsIbosVoltHigh=wsIbosVoltHigh, wsXFPConnector=wsXFPConnector, wsNeighboursTable=wsNeighboursTable, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsIbosTempHigh=wsIbosTempHigh, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourNIndex=wsNeighbourNIndex, wsPolicyEntry=wsPolicyEntry, wsSFPBitrate=wsSFPBitrate, wsTempTOS=wsTempTOS, wsReload=wsReload, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourState=wsNeighbourState, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSystem=wsSystem, wsNeighbourDBCount=wsNeighbourDBCount, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsVoltNominal=wsVoltNominal, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsPolicyTable=wsPolicyTable, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsPolicyInBytes=wsPolicyInBytes, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsVoltMeasured=wsVoltMeasured, wsTempThresholdHigh=wsTempThresholdHigh, wsXFPEntry=wsXFPEntry, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsVoltChannel=wsVoltChannel, wsTempSensor=wsTempSensor, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsVoltThresholdLow=wsVoltThresholdLow, wsTempStatus=wsTempStatus, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPIndex=wsXFPIndex, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsAsrRevision=wsAsrRevision, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPIndex=wsSFPIndex, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourOSVersion=wsNeighbourOSVersion, wsVersion=wsVersion, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPTXPower=wsXFPTXPower, wsVoltTable=wsVoltTable, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsIbosTempLow=wsIbosTempLow, wsFanEntry=wsFanEntry, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsFanVoltage=wsFanVoltage, wsSFPEntry=wsSFPEntry, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsXFPRXPower=wsXFPRXPower, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsTempThresholdLow=wsTempThresholdLow, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortState=wsNeighbourPortState, wsXFPTempStatus=wsXFPTempStatus, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTXPower=wsSFPTXPower, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsPFDP=wsPFDP, ibos=ibos, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPTemp=wsXFPTemp, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourModel=wsNeighbourModel, PYSNMP_MODULE_ID=ibos, wsVersionString=wsVersionString, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsTempMeasured=wsTempMeasured, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPConnector=wsSFPConnector, wsPolicyIfIndex=wsPolicyIfIndex, wsEnvironment=wsEnvironment, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortName=wsNeighbourPortName, wsFanTable=wsFanTable, wsSFPEncoding=wsSFPEncoding, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPStatus=wsSFPStatus, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsAccounting=wsAccounting, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsPolicyOutPkts=wsPolicyOutPkts, wsTempTable=wsTempTable, wsVoltThresholdHigh=wsVoltThresholdHigh, wsFanRPM=wsFanRPM, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsPolicyUsedCnt=wsPolicyUsedCnt, wsPolicyName=wsPolicyName, wsXFPStatus=wsXFPStatus, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsWritedummy=wsWritedummy, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourLastAct=wsNeighbourLastAct, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsXFPSingleModeLen=wsXFPSingleModeLen, wsXFPTable=wsXFPTable, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsFanNumber=wsFanNumber, wsSFPVolt=wsSFPVolt, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsXFPCopperLen=wsXFPCopperLen, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsXFPEncoding=wsXFPEncoding, wsVoltEntry=wsVoltEntry, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTemp=wsSFPTemp)
