...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsIbosTempLow=wsIbosTempLow, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPTempStatus=wsXFPTempStatus, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPTempStatus=wsSFPTempStatus, wsSFPRXPower=wsSFPRXPower, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsFanEntry=wsFanEntry, wsXFPTable=wsXFPTable, wsTempEntry=wsTempEntry, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTXCurrent=wsSFPTXCurrent, wsPolicyTable=wsPolicyTable, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsVoltMeasured=wsVoltMeasured, wsWritedummy=wsWritedummy, wsXFPEntry=wsXFPEntry, wsPolicyOutPkts=wsPolicyOutPkts, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPSingleModeLen=wsSFPSingleModeLen, wsFanRPM=wsFanRPM, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourLocalIf=wsNeighbourLocalIf, wsPFDP=wsPFDP, wsSFPTemp=wsSFPTemp, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsVoltNominal=wsVoltNominal, wsXFPStatus=wsXFPStatus, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPStatus=wsSFPStatus, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsPolicyOutBytes=wsPolicyOutBytes, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPTransceiver=wsSFPTransceiver, wsAccounting=wsAccounting, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsPolicyName=wsPolicyName, wsNeighbourIfIndex=wsNeighbourIfIndex, wsPolicyCookie=wsPolicyCookie, wsNeighbourState=wsNeighbourState, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPVoltNormalLow=wsSFPVoltNormalLow, ibos=ibos, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourHostname=wsNeighbourHostname, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsTempTOS=wsTempTOS, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsTempTHYST=wsTempTHYST, wsXFPConnector=wsXFPConnector, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsTempStatus=wsTempStatus, wsVoltChannel=wsVoltChannel, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsVoltStatus=wsVoltStatus, wsVoltTable=wsVoltTable, wsEnvironment=wsEnvironment, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsReload=wsReload, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsFanTable=wsFanTable, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsVersionString=wsVersionString, wsSFPTempWarningLow=wsSFPTempWarningLow, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPIndex=wsXFPIndex, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPIndex=wsSFPIndex, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPBitrate=wsSFPBitrate, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsVersion=wsVersion, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsTempThresholdHigh=wsTempThresholdHigh, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourCreated=wsNeighbourCreated, wsFanNumber=wsFanNumber, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighboursEntry=wsNeighboursEntry, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsXFPEncoding=wsXFPEncoding, wsFanVoltage=wsFanVoltage, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsTempTable=wsTempTable, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsVoltEntry=wsVoltEntry, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPConnector=wsSFPConnector, wsPolicyInDrops=wsPolicyInDrops, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPRXPower=wsXFPRXPower, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourLastAct=wsNeighbourLastAct, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSystem=wsSystem, wsTempSensor=wsTempSensor, wsSFPEntry=wsSFPEntry, wsSFPEncoding=wsSFPEncoding, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsIbosVoltHigh=wsIbosVoltHigh, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPRXdBmPower=wsSFPRXdBmPower, wsXFPCopperLen=wsXFPCopperLen, wsIbosTempHigh=wsIbosTempHigh, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPTemp=wsXFPTemp, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsTempMeasured=wsTempMeasured, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortName=wsNeighbourPortName, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPTransceiver=wsXFPTransceiver, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTable=wsSFPTable, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortState=wsNeighbourPortState, wsSFPCopperLen=wsSFPCopperLen, wsPolicyInPkts=wsPolicyInPkts, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourModel=wsNeighbourModel, wsSFPTXdBmPower=wsSFPTXdBmPower, wsAsrRevision=wsAsrRevision, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, PYSNMP_MODULE_ID=ibos, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsIbosVoltLow=wsIbosVoltLow, wsSFPVolt=wsSFPVolt)
