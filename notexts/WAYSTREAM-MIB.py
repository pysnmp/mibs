...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsPolicyIfName=wsPolicyIfName, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, ibos=ibos, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPEntry=wsSFPEntry, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPVolt=wsSFPVolt, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsPolicyOutPkts=wsPolicyOutPkts, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsIbosTempLow=wsIbosTempLow, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPBitrateMax=wsXFPBitrateMax, wsIbosVoltLow=wsIbosVoltLow, wsXFPBitrateMin=wsXFPBitrateMin, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsTempEntry=wsTempEntry, wsVoltNominal=wsVoltNominal, wsFanNumber=wsFanNumber, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourState=wsNeighbourState, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsVoltStatus=wsVoltStatus, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPEncoding=wsXFPEncoding, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourDBCount=wsNeighbourDBCount, PYSNMP_MODULE_ID=ibos, wsTempTable=wsTempTable, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsXFPStatus=wsXFPStatus, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsReload=wsReload, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTempStatus=wsSFPTempStatus, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsTempTHYST=wsTempTHYST, wsNeighbourModel=wsNeighbourModel, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighboursEntry=wsNeighboursEntry, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsXFPTempStatus=wsXFPTempStatus, wsXFPConnector=wsXFPConnector, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsEnvironment=wsEnvironment, wsVoltMeasured=wsVoltMeasured, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsAccounting=wsAccounting, wsFanTable=wsFanTable, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsAsrRevision=wsAsrRevision, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsPolicyEntry=wsPolicyEntry, wsXFPEntry=wsXFPEntry, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsVoltChannel=wsVoltChannel, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsTempStatus=wsTempStatus, wsWritedummy=wsWritedummy, wsSFPIndex=wsSFPIndex, wsSFPEncoding=wsSFPEncoding, wsTempThresholdLow=wsTempThresholdLow, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsFanRPM=wsFanRPM, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSystem=wsSystem, wsSFPRXPower=wsSFPRXPower, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighboursTable=wsNeighboursTable, wsPolicyInBytes=wsPolicyInBytes, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourCreated=wsNeighbourCreated, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsXFPIndex=wsXFPIndex, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTempWarningLow=wsSFPTempWarningLow, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsPolicyName=wsPolicyName, wsPFDP=wsPFDP, wsXFPTemp=wsXFPTemp, wsVoltEntry=wsVoltEntry, wsSFPTable=wsSFPTable, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPCopperLen=wsSFPCopperLen, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsPolicyTable=wsPolicyTable, wsVoltTable=wsVoltTable, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortState=wsNeighbourPortState, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPTransceiver=wsSFPTransceiver, wsVersion=wsVersion, wsXFPTable=wsXFPTable, wsSFPTemp=wsSFPTemp, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourUptime=wsNeighbourUptime, wsSFPSerialNumber=wsSFPSerialNumber, wsVersionString=wsVersionString, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsPolicyCookie=wsPolicyCookie, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPSingleModeLen=wsSFPSingleModeLen, wsFanVoltage=wsFanVoltage, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortName=wsNeighbourPortName, wsSFPConnector=wsSFPConnector, wsFanEntry=wsFanEntry, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsTempTOS=wsTempTOS, wsSFPTXPower=wsSFPTXPower, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPCopperLen=wsXFPCopperLen, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsTempMeasured=wsTempMeasured, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsTempSensor=wsTempSensor, wsXFPTransceiver=wsXFPTransceiver, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPStatus=wsSFPStatus, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts)
