...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsPolicyTable=wsPolicyTable, wsPolicyInBytes=wsPolicyInBytes, wsIbosFanRPMLow=wsIbosFanRPMLow, wsVoltTable=wsVoltTable, wsFanTable=wsFanTable, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsXFPIndex=wsXFPIndex, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSystem=wsSystem, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsPolicyOutPkts=wsPolicyOutPkts, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsTempEntry=wsTempEntry, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPTXPower=wsSFPTXPower, wsSFPRXPower=wsSFPRXPower, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsTempTHYST=wsTempTHYST, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPVolt=wsSFPVolt, wsEnvironment=wsEnvironment, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTransceiver=wsSFPTransceiver, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsXFPEncoding=wsXFPEncoding, PYSNMP_MODULE_ID=ibos, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsXFPCopperLen=wsXFPCopperLen, wsSFPTempNormalLow=wsSFPTempNormalLow, wsVoltChannel=wsVoltChannel, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsIbosVoltLow=wsIbosVoltLow, wsWritedummy=wsWritedummy, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsVersionString=wsVersionString, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsAccounting=wsAccounting, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPConnector=wsSFPConnector, wsPolicyEntry=wsPolicyEntry, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPBitrateMin=wsXFPBitrateMin, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPPartNumber=wsSFPPartNumber, wsXFPConnector=wsXFPConnector, wsSFPSerialNumber=wsSFPSerialNumber, wsTempSensor=wsTempSensor, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourLastAct=wsNeighbourLastAct, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsIbosVoltHigh=wsIbosVoltHigh, wsVoltStatus=wsVoltStatus, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsVoltMeasured=wsVoltMeasured, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsVersion=wsVersion, wsTempTable=wsTempTable, wsVoltEntry=wsVoltEntry, wsFanRPM=wsFanRPM, wsSFPIndex=wsSFPIndex, wsXFPEntry=wsXFPEntry, wsNeighboursEntry=wsNeighboursEntry, ibos=ibos, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsXFPBitrateMax=wsXFPBitrateMax, wsTempStatus=wsTempStatus, wsFanVoltage=wsFanVoltage, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPBitrate=wsSFPBitrate, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsPolicyCookie=wsPolicyCookie, wsSFPTable=wsSFPTable, wsNeighbourState=wsNeighbourState, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsFanNumber=wsFanNumber, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighboursTable=wsNeighboursTable, wsXFPTable=wsXFPTable, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourModel=wsNeighbourModel, wsSFPTemp=wsSFPTemp, wsXFPRXPower=wsXFPRXPower, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsPFDP=wsPFDP, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPRXdBmPower=wsSFPRXdBmPower, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPStatus=wsXFPStatus, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsAsrRevision=wsAsrRevision, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsTempTOS=wsTempTOS, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPTXPower=wsXFPTXPower, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourUptime=wsNeighbourUptime, wsVoltNominal=wsVoltNominal, wsTempMeasured=wsTempMeasured, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPStatus=wsSFPStatus, wsXFPTempStatus=wsXFPTempStatus, wsIbosTempHigh=wsIbosTempHigh, wsReload=wsReload, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourLocalIf=wsNeighbourLocalIf, wsPolicyName=wsPolicyName, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPEntry=wsSFPEntry, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsFanEntry=wsFanEntry, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXdBmPower=wsSFPTXdBmPower, wsVoltThresholdHigh=wsVoltThresholdHigh, wsXFPTemp=wsXFPTemp, wsPolicyOutBytes=wsPolicyOutBytes, wsPolicyInDrops=wsPolicyInDrops)
