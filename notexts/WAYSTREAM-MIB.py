...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPRXPower=wsXFPRXPower, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsVersion=wsVersion, wsPFDP=wsPFDP, wsVoltTable=wsVoltTable, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTXPower=wsSFPTXPower, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPVolt=wsSFPVolt, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourOSVersion=wsNeighbourOSVersion, wsTempThresholdLow=wsTempThresholdLow, wsSFPBitrate=wsSFPBitrate, wsAccounting=wsAccounting, wsXFPEntry=wsXFPEntry, wsPolicyOutDrops=wsPolicyOutDrops, wsFanTable=wsFanTable, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsVoltStatus=wsVoltStatus, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPStatus=wsXFPStatus, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourCreated=wsNeighbourCreated, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortState=wsNeighbourPortState, wsSFPIndex=wsSFPIndex, wsSFPPartNumber=wsSFPPartNumber, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourModel=wsNeighbourModel, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsVersionString=wsVersionString, wsSFPConnector=wsSFPConnector, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPEncoding=wsSFPEncoding, wsSFPTable=wsSFPTable, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsFanVoltage=wsFanVoltage, wsTempSensor=wsTempSensor, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPCopperLen=wsXFPCopperLen, wsWritedummy=wsWritedummy, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPEntry=wsSFPEntry, wsPolicyUsedCnt=wsPolicyUsedCnt, wsAsrRevision=wsAsrRevision, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTXdBmPower=wsSFPTXdBmPower, wsTempTOS=wsTempTOS, wsNeighbourUptime=wsNeighbourUptime, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsIbosTempHigh=wsIbosTempHigh, wsXFPConnector=wsXFPConnector, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsXFPTXPower=wsXFPTXPower, wsTempStatus=wsTempStatus, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPTempStatus=wsXFPTempStatus, wsXFPTemp=wsXFPTemp, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsReload=wsReload, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPStatus=wsSFPStatus, wsXFPTransceiver=wsXFPTransceiver, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsVoltEntry=wsVoltEntry, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, ibos=ibos, wsTempTable=wsTempTable, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsFanRPM=wsFanRPM, wsNeighbourState=wsNeighbourState, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsFanNumber=wsFanNumber, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTransceiver=wsSFPTransceiver, wsPolicyInPkts=wsPolicyInPkts, wsSystem=wsSystem, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsEnvironment=wsEnvironment, wsXFPTable=wsXFPTable, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsVoltNominal=wsVoltNominal, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighboursTable=wsNeighboursTable, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsVoltMeasured=wsVoltMeasured, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPSingleModeLen=wsXFPSingleModeLen, wsXFPBitrateMin=wsXFPBitrateMin, wsXFPBitrateMax=wsXFPBitrateMax, wsPolicyEntry=wsPolicyEntry, wsPolicyInBytes=wsPolicyInBytes, wsVoltChannel=wsVoltChannel, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsTempMeasured=wsTempMeasured, wsFanEntry=wsFanEntry, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPRXPower=wsSFPRXPower, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourHostname=wsNeighbourHostname, wsTempTHYST=wsTempTHYST, wsPolicyTable=wsPolicyTable, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortsTable=wsNeighbourPortsTable, wsPolicyName=wsPolicyName, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighboursEntry=wsNeighboursEntry, wsSFPTemp=wsSFPTemp, PYSNMP_MODULE_ID=ibos, wsXFPIndex=wsXFPIndex, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPVoltStatus=wsSFPVoltStatus, wsIbosFanRPMLow=wsIbosFanRPMLow, wsXFPEncoding=wsXFPEncoding, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsTempEntry=wsTempEntry)
