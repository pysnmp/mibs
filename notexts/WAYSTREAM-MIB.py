...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPTransceiver=wsXFPTransceiver, wsPolicyInDrops=wsPolicyInDrops, wsIbosTempLow=wsIbosTempLow, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsVersionString=wsVersionString, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsXFPCopperLen=wsXFPCopperLen, wsSFPEntry=wsSFPEntry, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, PYSNMP_MODULE_ID=ibos, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTable=wsSFPTable, wsSFPBitrate=wsSFPBitrate, wsXFPTemp=wsXFPTemp, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourCreated=wsNeighbourCreated, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPCopperLen=wsSFPCopperLen, wsPolicyUsedCnt=wsPolicyUsedCnt, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSystem=wsSystem, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourModel=wsNeighbourModel, wsVoltMeasured=wsVoltMeasured, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourDBCount=wsNeighbourDBCount, wsTempTable=wsTempTable, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsXFPStatus=wsXFPStatus, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsPolicyInPkts=wsPolicyInPkts, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsXFPConnector=wsXFPConnector, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPTemp=wsSFPTemp, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsPolicyCookie=wsPolicyCookie, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsPolicyName=wsPolicyName, wsXFPIndex=wsXFPIndex, wsNeighbourHostname=wsNeighbourHostname, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXPower=wsSFPTXPower, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPIndex=wsSFPIndex, wsTempStatus=wsTempStatus, wsNeighboursEntry=wsNeighboursEntry, wsVoltTable=wsVoltTable, wsVoltEntry=wsVoltEntry, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourUptime=wsNeighbourUptime, wsXFPRXPower=wsXFPRXPower, wsXFPTempStatus=wsXFPTempStatus, wsEnvironment=wsEnvironment, wsVoltNominal=wsVoltNominal, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsTempSensor=wsTempSensor, wsSFPTransceiver=wsSFPTransceiver, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPVolt=wsSFPVolt, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsWritedummy=wsWritedummy, wsPolicyTable=wsPolicyTable, ibos=ibos, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsFanTable=wsFanTable, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsTempTOS=wsTempTOS, wsSFPEncoding=wsSFPEncoding, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsPolicyOutPkts=wsPolicyOutPkts, wsFanRPM=wsFanRPM, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsVoltChannel=wsVoltChannel, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsXFPTable=wsXFPTable, wsSFPStatus=wsSFPStatus, wsPFDP=wsPFDP, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPConnector=wsSFPConnector, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsAsrRevision=wsAsrRevision, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTempStatus=wsSFPTempStatus, wsIbosVoltLow=wsIbosVoltLow, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsXFPEntry=wsXFPEntry, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPSerialNumber=wsSFPSerialNumber, wsPolicyOutDrops=wsPolicyOutDrops, wsFanVoltage=wsFanVoltage, wsTempThresholdLow=wsTempThresholdLow, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsReload=wsReload, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPTXCurrent=wsSFPTXCurrent, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsVersion=wsVersion, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsTempTHYST=wsTempTHYST, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsFanEntry=wsFanEntry, wsPolicyInBytes=wsPolicyInBytes, wsTempMeasured=wsTempMeasured, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourState=wsNeighbourState, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsAccounting=wsAccounting, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsFanNumber=wsFanNumber, wsXFPBitrateMax=wsXFPBitrateMax, wsVoltStatus=wsVoltStatus, wsSFPRXdBmPower=wsSFPRXdBmPower, wsTempEntry=wsTempEntry, wsSFPPartNumber=wsSFPPartNumber, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts)
