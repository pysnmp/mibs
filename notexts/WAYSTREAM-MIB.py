...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPTempStatus=wsXFPTempStatus, wsSFPTXPower=wsSFPTXPower, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsPolicyInBytes=wsPolicyInBytes, wsReload=wsReload, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsAccounting=wsAccounting, wsSystem=wsSystem, PYSNMP_MODULE_ID=ibos, wsSFPTemp=wsSFPTemp, wsTempTable=wsTempTable, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsXFPTransceiver=wsXFPTransceiver, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPTable=wsSFPTable, wsSFPConnector=wsSFPConnector, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsXFPRXPower=wsXFPRXPower, wsTempTOS=wsTempTOS, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsVoltTable=wsVoltTable, wsNeighboursEntry=wsNeighboursEntry, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourUptime=wsNeighbourUptime, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsAsrRevision=wsAsrRevision, ibos=ibos, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPTable=wsXFPTable, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsPolicyName=wsPolicyName, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsXFPEntry=wsXFPEntry, wsIbosVoltLow=wsIbosVoltLow, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourSNPA=wsNeighbourSNPA, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsPolicyIfName=wsPolicyIfName, wsSFPTransceiver=wsSFPTransceiver, wsPFDP=wsPFDP, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPVolt=wsSFPVolt, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsXFPEncoding=wsXFPEncoding, wsNeighbourCreated=wsNeighbourCreated, wsIbosTempLow=wsIbosTempLow, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsFanVoltage=wsFanVoltage, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourHostname=wsNeighbourHostname, wsTempThresholdHigh=wsTempThresholdHigh, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPEntry=wsSFPEntry, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsPolicyIfIndex=wsPolicyIfIndex, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsXFPConnector=wsXFPConnector, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsWritedummy=wsWritedummy, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPTemp=wsXFPTemp, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortState=wsNeighbourPortState, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortName=wsNeighbourPortName, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsVersionString=wsVersionString, wsXFPStatus=wsXFPStatus, wsPolicyTable=wsPolicyTable, wsNeighbourOSVersion=wsNeighbourOSVersion, wsXFPBitrateMax=wsXFPBitrateMax, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsVoltEntry=wsVoltEntry, wsFanEntry=wsFanEntry, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsTempEntry=wsTempEntry, wsXFPIndex=wsXFPIndex, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPRXPower=wsSFPRXPower, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsTempSensor=wsTempSensor, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsTempTHYST=wsTempTHYST, wsIbosTempHigh=wsIbosTempHigh, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourModel=wsNeighbourModel, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPIndex=wsSFPIndex, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourState=wsNeighbourState, wsXFPTXPower=wsXFPTXPower, wsSFPPartNumber=wsSFPPartNumber, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPSingleModeLen=wsSFPSingleModeLen, wsPolicyCookie=wsPolicyCookie, wsVersion=wsVersion, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsTempStatus=wsTempStatus, wsVoltChannel=wsVoltChannel, wsFanNumber=wsFanNumber, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPBitrate=wsSFPBitrate, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsTempMeasured=wsTempMeasured, wsPolicyOutDrops=wsPolicyOutDrops, wsVoltNominal=wsVoltNominal, wsSFPStatus=wsSFPStatus, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsVoltStatus=wsVoltStatus, wsFanRPM=wsFanRPM, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsEnvironment=wsEnvironment, wsNeighboursTable=wsNeighboursTable, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPTempStatus=wsSFPTempStatus, wsFanTable=wsFanTable)
