...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsPolicyTable=wsPolicyTable, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPEntry=wsSFPEntry, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourState=wsNeighbourState, wsSFPTransceiverExt=wsSFPTransceiverExt, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPBitrateMin=wsXFPBitrateMin, wsPolicyCookie=wsPolicyCookie, wsSFPEncoding=wsSFPEncoding, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsPolicyIfName=wsPolicyIfName, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsXFPEncoding=wsXFPEncoding, wsSFPTempStatus=wsSFPTempStatus, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsIbosVoltLow=wsIbosVoltLow, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsWritedummy=wsWritedummy, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortState=wsNeighbourPortState, wsSystem=wsSystem, PYSNMP_MODULE_ID=ibos, wsSFPRXPower=wsSFPRXPower, wsPFDP=wsPFDP, wsFanEntry=wsFanEntry, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTemp=wsSFPTemp, wsXFPTable=wsXFPTable, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPTemp=wsXFPTemp, wsVoltNominal=wsVoltNominal, wsSFPTXPower=wsSFPTXPower, wsSFPConnector=wsSFPConnector, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsVoltThresholdLow=wsVoltThresholdLow, wsXFPTXPower=wsXFPTXPower, wsAsrRevision=wsAsrRevision, wsXFPEntry=wsXFPEntry, wsIbosTempLow=wsIbosTempLow, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsPolicyInBytes=wsPolicyInBytes, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsTempSensor=wsTempSensor, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsPolicyInDrops=wsPolicyInDrops, wsVersion=wsVersion, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsTempTOS=wsTempTOS, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsVoltChannel=wsVoltChannel, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsFanRPM=wsFanRPM, wsVoltEntry=wsVoltEntry, wsTempTHYST=wsTempTHYST, wsPolicyEntry=wsPolicyEntry, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsTempThresholdLow=wsTempThresholdLow, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsPolicyIfIndex=wsPolicyIfIndex, wsReload=wsReload, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsVoltMeasured=wsVoltMeasured, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsXFPIndex=wsXFPIndex, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsXFPConnector=wsXFPConnector, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPStatus=wsXFPStatus, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighboursEntry=wsNeighboursEntry, wsPolicyOutBytes=wsPolicyOutBytes, wsTempMeasured=wsTempMeasured, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPStatus=wsSFPStatus, wsSFPBitrate=wsSFPBitrate, wsSFPTable=wsSFPTable, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsEnvironment=wsEnvironment, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsFanNumber=wsFanNumber, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsPolicyOutDrops=wsPolicyOutDrops, wsVersionString=wsVersionString, wsXFPRXPower=wsXFPRXPower, wsVoltTable=wsVoltTable, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsTempStatus=wsTempStatus, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourUptime=wsNeighbourUptime, wsPolicyName=wsPolicyName, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourHostname=wsNeighbourHostname, wsSFPIndex=wsSFPIndex, wsAccounting=wsAccounting, wsSFPRXdBmPower=wsSFPRXdBmPower, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsVoltStatus=wsVoltStatus, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsFanTable=wsFanTable, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourIfIndex=wsNeighbourIfIndex, wsTempTable=wsTempTable, wsNeighbourCreated=wsNeighbourCreated, wsTempEntry=wsTempEntry, wsIbosFanRPMLow=wsIbosFanRPMLow, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPVolt=wsSFPVolt, ibos=ibos, wsFanVoltage=wsFanVoltage)
