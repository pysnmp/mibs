...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsVoltChannel=wsVoltChannel, wsTempTHYST=wsTempTHYST, wsVoltStatus=wsVoltStatus, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourUptime=wsNeighbourUptime, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPTempStatus=wsSFPTempStatus, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsTempTable=wsTempTable, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPPartNumber=wsSFPPartNumber, wsXFPEntry=wsXFPEntry, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPTXPower=wsXFPTXPower, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourCreated=wsNeighbourCreated, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPVoltStatus=wsSFPVoltStatus, wsTempStatus=wsTempStatus, wsNeighboursTable=wsNeighboursTable, wsSFPBitrate=wsSFPBitrate, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsVoltTable=wsVoltTable, wsIbosTempLow=wsIbosTempLow, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsXFPTemp=wsXFPTemp, wsWritedummy=wsWritedummy, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourState=wsNeighbourState, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsVoltThresholdLow=wsVoltThresholdLow, ibos=ibos, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsAsrRevision=wsAsrRevision, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTemp=wsSFPTemp, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsPolicyName=wsPolicyName, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPTable=wsXFPTable, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsPFDP=wsPFDP, wsIbosFanRPMLow=wsIbosFanRPMLow, wsVersionString=wsVersionString, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPTempStatus=wsXFPTempStatus, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsTempSensor=wsTempSensor, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsTempMeasured=wsTempMeasured, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTXPower=wsSFPTXPower, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsPolicyTable=wsPolicyTable, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsPolicyEntry=wsPolicyEntry, wsIbosVoltLow=wsIbosVoltLow, wsXFPEncoding=wsXFPEncoding, wsEnvironment=wsEnvironment, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsFanTable=wsFanTable, wsXFPIndex=wsXFPIndex, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsVersion=wsVersion, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTable=wsSFPTable, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPStatus=wsXFPStatus, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSystem=wsSystem, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPIndex=wsSFPIndex, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, PYSNMP_MODULE_ID=ibos, wsPolicyIfName=wsPolicyIfName, wsSFPEntry=wsSFPEntry, wsSFPStatus=wsSFPStatus, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsVoltNominal=wsVoltNominal, wsNeighbourSNPA=wsNeighbourSNPA, wsFanVoltage=wsFanVoltage, wsVoltEntry=wsVoltEntry, wsSFPTransceiver=wsSFPTransceiver, wsPolicyInDrops=wsPolicyInDrops, wsPolicyOutDrops=wsPolicyOutDrops, wsReload=wsReload, wsNeighbourModel=wsNeighbourModel, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsXFPTransceiver=wsXFPTransceiver, wsFanEntry=wsFanEntry, wsSFPCopperLen=wsSFPCopperLen, wsXFPConnector=wsXFPConnector, wsTempEntry=wsTempEntry, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPEncoding=wsSFPEncoding, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPConnector=wsSFPConnector, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPVolt=wsSFPVolt, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsTempTOS=wsTempTOS, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPTempNormalLow=wsSFPTempNormalLow, wsFanRPM=wsFanRPM, wsAccounting=wsAccounting, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsPolicyInPkts=wsPolicyInPkts, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortState=wsNeighbourPortState, wsSFPSerialNumber=wsSFPSerialNumber, wsPolicyInBytes=wsPolicyInBytes, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsFanNumber=wsFanNumber, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTXdBmPower=wsSFPTXdBmPower, wsXFPRXPower=wsXFPRXPower)
