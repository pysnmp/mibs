...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPTable=wsSFPTable, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsVoltNominal=wsVoltNominal, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsPolicyTable=wsPolicyTable, wsXFPRXPower=wsXFPRXPower, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortState=wsNeighbourPortState, wsIbosFanRPMLow=wsIbosFanRPMLow, wsTempTHYST=wsTempTHYST, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTXdBmPower=wsSFPTXdBmPower, wsXFPIndex=wsXFPIndex, wsFanTable=wsFanTable, wsAsrRevision=wsAsrRevision, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsTempEntry=wsTempEntry, wsPFDP=wsPFDP, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTransceiverExt=wsSFPTransceiverExt, wsFanNumber=wsFanNumber, wsPolicyName=wsPolicyName, wsXFPTemp=wsXFPTemp, wsPolicyInBytes=wsPolicyInBytes, wsPolicyEntry=wsPolicyEntry, wsTempMeasured=wsTempMeasured, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsXFPBitrateMax=wsXFPBitrateMax, wsPolicyInDrops=wsPolicyInDrops, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsVoltTable=wsVoltTable, wsSFPPartNumber=wsSFPPartNumber, wsVersion=wsVersion, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsXFPTXCurrent=wsXFPTXCurrent, wsPolicyInPkts=wsPolicyInPkts, wsNeighboursTable=wsNeighboursTable, wsTempStatus=wsTempStatus, wsTempTable=wsTempTable, wsVoltMeasured=wsVoltMeasured, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourHostname=wsNeighbourHostname, wsVoltThresholdLow=wsVoltThresholdLow, wsXFPTempStatus=wsXFPTempStatus, wsSFPConnector=wsSFPConnector, wsSFPEncoding=wsSFPEncoding, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPTable=wsXFPTable, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsIbosVoltHigh=wsIbosVoltHigh, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsIbosVoltLow=wsIbosVoltLow, wsFanVoltage=wsFanVoltage, wsNeighbourOSVersion=wsNeighbourOSVersion, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTransceiver=wsSFPTransceiver, wsXFPConnector=wsXFPConnector, wsNeighbourIfIndex=wsNeighbourIfIndex, wsVoltStatus=wsVoltStatus, wsNeighbourState=wsNeighbourState, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTemp=wsSFPTemp, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsTempTOS=wsTempTOS, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPIndex=wsSFPIndex, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsTempThresholdLow=wsTempThresholdLow, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortName=wsNeighbourPortName, wsSFPSerialNumber=wsSFPSerialNumber, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPVolt=wsSFPVolt, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsIbosTempLow=wsIbosTempLow, wsXFPEntry=wsXFPEntry, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSystem=wsSystem, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsFanEntry=wsFanEntry, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortsTable=wsNeighbourPortsTable, wsXFPTXPower=wsXFPTXPower, ibos=ibos, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsPolicyOutPkts=wsPolicyOutPkts, PYSNMP_MODULE_ID=ibos, wsXFPStatus=wsXFPStatus, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourNIndex=wsNeighbourNIndex, wsReload=wsReload, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsXFPTransceiver=wsXFPTransceiver, wsSFPTempStatus=wsSFPTempStatus, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsIbosTempHigh=wsIbosTempHigh, wsTempSensor=wsTempSensor, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsFanRPM=wsFanRPM, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsEnvironment=wsEnvironment, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPCopperLen=wsSFPCopperLen, wsXFPCopperLen=wsXFPCopperLen, wsVoltChannel=wsVoltChannel, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsVersionString=wsVersionString, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPStatus=wsSFPStatus, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTXPower=wsSFPTXPower, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsWritedummy=wsWritedummy, wsTempThresholdHigh=wsTempThresholdHigh, wsVoltEntry=wsVoltEntry, wsSFPEntry=wsSFPEntry, wsAccounting=wsAccounting, wsXFPEncoding=wsXFPEncoding, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsPolicyCookie=wsPolicyCookie, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTempNormalHigh=wsSFPTempNormalHigh)
