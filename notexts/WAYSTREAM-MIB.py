...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsPolicyOutDrops=wsPolicyOutDrops, wsPolicyName=wsPolicyName, wsTempMeasured=wsTempMeasured, wsAsrRevision=wsAsrRevision, wsSFPTXCurrent=wsSFPTXCurrent, wsFanNumber=wsFanNumber, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourLocalIf=wsNeighbourLocalIf, wsTempEntry=wsTempEntry, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsVoltNominal=wsVoltNominal, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPEntry=wsSFPEntry, wsSFPIndex=wsSFPIndex, wsPolicyUsedCnt=wsPolicyUsedCnt, wsFanRPM=wsFanRPM, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTransceiver=wsSFPTransceiver, wsTempTable=wsTempTable, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsVersionString=wsVersionString, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsIbosTempLow=wsIbosTempLow, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPConnector=wsXFPConnector, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsTempSensor=wsTempSensor, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsVoltMeasured=wsVoltMeasured, wsNeighbourState=wsNeighbourState, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsTempTHYST=wsTempTHYST, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsVoltChannel=wsVoltChannel, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTempNormalLow=wsSFPTempNormalLow, wsPolicyCookie=wsPolicyCookie, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, ibos=ibos, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsTempThresholdLow=wsTempThresholdLow, wsVersion=wsVersion, wsFanEntry=wsFanEntry, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPTable=wsXFPTable, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSystem=wsSystem, PYSNMP_MODULE_ID=ibos, wsPolicyInDrops=wsPolicyInDrops, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsPolicyInBytes=wsPolicyInBytes, wsSFPEncoding=wsSFPEncoding, wsXFPEntry=wsXFPEntry, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsAccounting=wsAccounting, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsPolicyEntry=wsPolicyEntry, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsVoltStatus=wsVoltStatus, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourOSVersion=wsNeighbourOSVersion, wsPolicyIfName=wsPolicyIfName, wsXFPTXPower=wsXFPTXPower, wsTempTOS=wsTempTOS, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsFanTable=wsFanTable, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPRXPower=wsXFPRXPower, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsIbosVoltHigh=wsIbosVoltHigh, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortState=wsNeighbourPortState, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPSingleModeLen=wsSFPSingleModeLen, wsPolicyTable=wsPolicyTable, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPCopperLen=wsSFPCopperLen, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPBitrate=wsSFPBitrate, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsIbosTempHigh=wsIbosTempHigh, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsEnvironment=wsEnvironment, wsXFPIndex=wsXFPIndex, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPStatus=wsSFPStatus, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsPolicyInPkts=wsPolicyInPkts, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsReload=wsReload, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPPartNumber=wsSFPPartNumber, wsWritedummy=wsWritedummy, wsXFPTemp=wsXFPTemp, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsTempStatus=wsTempStatus, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsPFDP=wsPFDP, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPBitrateMin=wsXFPBitrateMin, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTable=wsSFPTable, wsTempThresholdHigh=wsTempThresholdHigh, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPRXdBmPower=wsSFPRXdBmPower, wsVoltEntry=wsVoltEntry, wsSFPVolt=wsSFPVolt, wsXFPStatus=wsXFPStatus, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPConnector=wsSFPConnector, wsXFPEncoding=wsXFPEncoding, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighboursEntry=wsNeighboursEntry, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsFanVoltage=wsFanVoltage, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTemp=wsSFPTemp, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsIbosVoltLow=wsIbosVoltLow, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsVoltTable=wsVoltTable, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPRXPower=wsSFPRXPower)
