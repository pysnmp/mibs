...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighboursEntry=wsNeighboursEntry, wsFanNumber=wsFanNumber, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTemp=wsSFPTemp, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourCreated=wsNeighbourCreated, wsAccounting=wsAccounting, ibos=ibos, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourLocalIf=wsNeighbourLocalIf, wsXFPStatus=wsXFPStatus, wsFanRPM=wsFanRPM, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsPolicyName=wsPolicyName, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourState=wsNeighbourState, wsVoltStatus=wsVoltStatus, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsTempMeasured=wsTempMeasured, wsPolicyEntry=wsPolicyEntry, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortName=wsNeighbourPortName, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPVoltStatus=wsSFPVoltStatus, wsXFPTable=wsXFPTable, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourIfIndex=wsNeighbourIfIndex, wsWritedummy=wsWritedummy, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsXFPEncoding=wsXFPEncoding, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsXFPTemp=wsXFPTemp, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsReload=wsReload, wsSystem=wsSystem, wsVoltMeasured=wsVoltMeasured, wsSFPTempStatus=wsSFPTempStatus, wsPolicyCookie=wsPolicyCookie, wsSFPBitrate=wsSFPBitrate, wsSFPEncoding=wsSFPEncoding, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTXPower=wsSFPTXPower, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsIbosVoltHigh=wsIbosVoltHigh, wsPolicyInPkts=wsPolicyInPkts, wsSFPTable=wsSFPTable, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPEntry=wsSFPEntry, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourLastAct=wsNeighbourLastAct, wsTempTOS=wsTempTOS, wsXFPCopperLen=wsXFPCopperLen, wsPolicyInBytes=wsPolicyInBytes, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsAsrRevision=wsAsrRevision, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPCopperLen=wsSFPCopperLen, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsPolicyIfName=wsPolicyIfName, wsSFPSerialNumber=wsSFPSerialNumber, wsPolicyTable=wsPolicyTable, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsFanTable=wsFanTable, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsVoltNominal=wsVoltNominal, wsTempTHYST=wsTempTHYST, wsVoltChannel=wsVoltChannel, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsTempSensor=wsTempSensor, wsFanEntry=wsFanEntry, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsTempEntry=wsTempEntry, wsVoltTable=wsVoltTable, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPPartNumber=wsSFPPartNumber, wsSFPIndex=wsSFPIndex, wsVersion=wsVersion, wsXFPConnector=wsXFPConnector, wsFanVoltage=wsFanVoltage, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsXFPTXPower=wsXFPTXPower, wsPFDP=wsPFDP, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsIbosTempHigh=wsIbosTempHigh, wsSFPConnector=wsSFPConnector, wsEnvironment=wsEnvironment, wsNeighboursTable=wsNeighboursTable, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPVolt=wsSFPVolt, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPEntry=wsXFPEntry, wsIbosVoltLow=wsIbosVoltLow, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsIbosTempLow=wsIbosTempLow, wsNeighbourHostname=wsNeighbourHostname, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsTempStatus=wsTempStatus, wsVoltEntry=wsVoltEntry, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPSingleModeLen=wsSFPSingleModeLen, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsVersionString=wsVersionString, wsSFPStatus=wsSFPStatus, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPTransceiver=wsXFPTransceiver, wsTempTable=wsTempTable, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourSNPA=wsNeighbourSNPA, PYSNMP_MODULE_ID=ibos, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPRXPower=wsXFPRXPower, wsSFPTransceiverExt=wsSFPTransceiverExt, wsXFPIndex=wsXFPIndex)
