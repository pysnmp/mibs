...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsTempSensor=wsTempSensor, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPIndex=wsXFPIndex, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsXFPTable=wsXFPTable, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsVoltNominal=wsVoltNominal, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsVersion=wsVersion, wsXFPConnector=wsXFPConnector, wsIbosTempLow=wsIbosTempLow, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsReload=wsReload, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsPolicyName=wsPolicyName, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsFanEntry=wsFanEntry, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsVersionString=wsVersionString, wsSFPEncoding=wsSFPEncoding, wsSFPTransceiverExt=wsSFPTransceiverExt, wsTempMeasured=wsTempMeasured, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPSingleModeLen=wsXFPSingleModeLen, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsTempEntry=wsTempEntry, wsSFPStatus=wsSFPStatus, wsNeighboursTable=wsNeighboursTable, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTXdBmPower=wsSFPTXdBmPower, wsPolicyCookie=wsPolicyCookie, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsPolicyIfName=wsPolicyIfName, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsTempTable=wsTempTable, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourCreated=wsNeighbourCreated, wsSFPTransceiver=wsSFPTransceiver, wsSFPVolt=wsSFPVolt, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPEncoding=wsXFPEncoding, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourUptime=wsNeighbourUptime, wsPFDP=wsPFDP, wsIbosVoltLow=wsIbosVoltLow, wsVoltTable=wsVoltTable, wsPolicyTable=wsPolicyTable, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPEntry=wsXFPEntry, wsAsrRevision=wsAsrRevision, wsVoltChannel=wsVoltChannel, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPBitrateMax=wsXFPBitrateMax, wsTempThresholdHigh=wsTempThresholdHigh, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourHostname=wsNeighbourHostname, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsXFPTempStatus=wsXFPTempStatus, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsFanRPM=wsFanRPM, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPRXdBmPower=wsSFPRXdBmPower, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPConnector=wsSFPConnector, wsSFPTable=wsSFPTable, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsXFPTemp=wsXFPTemp, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsTempTHYST=wsTempTHYST, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsTempStatus=wsTempStatus, wsSFPEntry=wsSFPEntry, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsVoltEntry=wsVoltEntry, wsTempTOS=wsTempTOS, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSystem=wsSystem, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTempStatus=wsSFPTempStatus, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, PYSNMP_MODULE_ID=ibos, wsNeighbourState=wsNeighbourState, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTemp=wsSFPTemp, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPBitrate=wsSFPBitrate, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsWritedummy=wsWritedummy, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsXFPTXPower=wsXFPTXPower, ibos=ibos, wsFanVoltage=wsFanVoltage, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPStatus=wsXFPStatus, wsXFPCopperLen=wsXFPCopperLen, wsSFPRXPower=wsSFPRXPower, wsVoltMeasured=wsVoltMeasured, wsVoltStatus=wsVoltStatus, wsEnvironment=wsEnvironment, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPIndex=wsSFPIndex, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsAccounting=wsAccounting, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsIbosTempHigh=wsIbosTempHigh, wsNeighboursEntry=wsNeighboursEntry, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourModel=wsNeighbourModel, wsFanTable=wsFanTable, wsFanNumber=wsFanNumber, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortState=wsNeighbourPortState, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortsTable=wsNeighbourPortsTable)
