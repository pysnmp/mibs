...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsWritedummy=wsWritedummy, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourUptime=wsNeighbourUptime, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsFanRPM=wsFanRPM, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortName=wsNeighbourPortName, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPRXdBmPower=wsSFPRXdBmPower, wsTempTOS=wsTempTOS, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsVersion=wsVersion, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPVolt=wsSFPVolt, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPStatus=wsSFPStatus, wsAccounting=wsAccounting, wsXFPTXPower=wsXFPTXPower, wsTempSensor=wsTempSensor, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsPolicyEntry=wsPolicyEntry, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPTable=wsXFPTable, wsTempMeasured=wsTempMeasured, wsXFPConnector=wsXFPConnector, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsFanNumber=wsFanNumber, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTXCurrent=wsSFPTXCurrent, wsPolicyOutDrops=wsPolicyOutDrops, wsTempTable=wsTempTable, wsVoltTable=wsVoltTable, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsVoltNominal=wsVoltNominal, wsSFPBitrate=wsSFPBitrate, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPEncoding=wsSFPEncoding, wsNeighbourModel=wsNeighbourModel, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsFanEntry=wsFanEntry, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsVersionString=wsVersionString, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPRXPower=wsSFPRXPower, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsXFPTempStatus=wsXFPTempStatus, wsPolicyOutBytes=wsPolicyOutBytes, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTable=wsSFPTable, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsFanTable=wsFanTable, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTemp=wsSFPTemp, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTXPower=wsSFPTXPower, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourIfIndex=wsNeighbourIfIndex, wsVoltEntry=wsVoltEntry, PYSNMP_MODULE_ID=ibos, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPPartNumber=wsSFPPartNumber, wsEnvironment=wsEnvironment, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourHostname=wsNeighbourHostname, wsXFPRXPower=wsXFPRXPower, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPEntry=wsXFPEntry, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPIndex=wsXFPIndex, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourState=wsNeighbourState, wsSFPTempStatus=wsSFPTempStatus, wsPolicyCookie=wsPolicyCookie, wsSFPIndex=wsSFPIndex, wsReload=wsReload, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsXFPStatus=wsXFPStatus, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsTempStatus=wsTempStatus, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPTemp=wsXFPTemp, wsSFPEntry=wsSFPEntry, wsIbosTempLow=wsIbosTempLow, wsPolicyInBytes=wsPolicyInBytes, wsSFPConnector=wsSFPConnector, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsPolicyUsedCnt=wsPolicyUsedCnt, wsPolicyInDrops=wsPolicyInDrops, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsTempThresholdLow=wsTempThresholdLow, wsVoltChannel=wsVoltChannel, wsPolicyInPkts=wsPolicyInPkts, wsPolicyOutPkts=wsPolicyOutPkts, wsPolicyName=wsPolicyName, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourOSVersion=wsNeighbourOSVersion, wsVoltStatus=wsVoltStatus, wsNeighbourSNPA=wsNeighbourSNPA, wsPolicyTable=wsPolicyTable, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSystem=wsSystem, wsTempEntry=wsTempEntry, wsNeighbourPortState=wsNeighbourPortState, wsIbosTempHigh=wsIbosTempHigh, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsTempTHYST=wsTempTHYST, wsNeighbourPortsTable=wsNeighbourPortsTable, wsIbosVoltLow=wsIbosVoltLow, wsPolicyIfName=wsPolicyIfName, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsXFPEncoding=wsXFPEncoding, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsXFPTXCurrent=wsXFPTXCurrent, wsVoltMeasured=wsVoltMeasured, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsFanVoltage=wsFanVoltage, wsPFDP=wsPFDP, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPBitrateMin=wsXFPBitrateMin, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, ibos=ibos, wsAsrRevision=wsAsrRevision, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets)
