...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPEncoding=wsXFPEncoding, wsXFPIndex=wsXFPIndex, wsIbosVoltLow=wsIbosVoltLow, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, ibos=ibos, wsPolicyInBytes=wsPolicyInBytes, wsSFPVolt=wsSFPVolt, wsNeighboursEntry=wsNeighboursEntry, wsXFPCopperLen=wsXFPCopperLen, wsXFPTransceiver=wsXFPTransceiver, PYSNMP_MODULE_ID=ibos, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsReload=wsReload, wsAsrRevision=wsAsrRevision, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTransceiver=wsSFPTransceiver, wsSFPBitrate=wsSFPBitrate, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsPolicyOutPkts=wsPolicyOutPkts, wsVersion=wsVersion, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsFanTable=wsFanTable, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourSNPA=wsNeighbourSNPA, wsFanEntry=wsFanEntry, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTempStatus=wsSFPTempStatus, wsTempSensor=wsTempSensor, wsTempTable=wsTempTable, wsPolicyIfName=wsPolicyIfName, wsVoltChannel=wsVoltChannel, wsFanNumber=wsFanNumber, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPTXPower=wsXFPTXPower, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsFanRPM=wsFanRPM, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsXFPEntry=wsXFPEntry, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTable=wsSFPTable, wsTempTHYST=wsTempTHYST, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsPolicyTable=wsPolicyTable, wsXFPTXCurrent=wsXFPTXCurrent, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTemp=wsSFPTemp, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsIbosTempLow=wsIbosTempLow, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsFanVoltage=wsFanVoltage, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourState=wsNeighbourState, wsVoltEntry=wsVoltEntry, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsEnvironment=wsEnvironment, wsNeighbourPortName=wsNeighbourPortName, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsVoltTable=wsVoltTable, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPStatus=wsSFPStatus, wsTempTOS=wsTempTOS, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsVoltNominal=wsVoltNominal, wsSFPTempNormalLow=wsSFPTempNormalLow, wsXFPRXPower=wsXFPRXPower, wsSFPEntry=wsSFPEntry, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighboursTable=wsNeighboursTable, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourUptime=wsNeighbourUptime, wsPolicyInPkts=wsPolicyInPkts, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsXFPConnector=wsXFPConnector, wsWritedummy=wsWritedummy, wsXFPTempStatus=wsXFPTempStatus, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPConnector=wsSFPConnector, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTXPower=wsSFPTXPower, wsVoltMeasured=wsVoltMeasured, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsIbosTempHigh=wsIbosTempHigh, wsXFPTemp=wsXFPTemp, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPPartNumber=wsSFPPartNumber, wsPolicyInDrops=wsPolicyInDrops, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsPolicyEntry=wsPolicyEntry, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPIndex=wsSFPIndex, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsVoltStatus=wsVoltStatus, wsTempMeasured=wsTempMeasured, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSystem=wsSystem, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourCreated=wsNeighbourCreated, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPRXPower=wsSFPRXPower, wsPolicyCookie=wsPolicyCookie, wsTempStatus=wsTempStatus, wsSFPEncoding=wsSFPEncoding, wsNeighbourModel=wsNeighbourModel, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsAccounting=wsAccounting, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourHostname=wsNeighbourHostname, wsXFPTable=wsXFPTable, wsPFDP=wsPFDP, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPSerialNumber=wsSFPSerialNumber, wsPolicyUsedCnt=wsPolicyUsedCnt, wsVersionString=wsVersionString, wsTempEntry=wsTempEntry, wsPolicyName=wsPolicyName, wsXFPStatus=wsXFPStatus, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourIfIndex=wsNeighbourIfIndex)
