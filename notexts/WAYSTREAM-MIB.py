...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsFanEntry=wsFanEntry, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsPFDP=wsPFDP, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTempNormalLow=wsSFPTempNormalLow, wsVersionString=wsVersionString, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPStatus=wsXFPStatus, wsTempTOS=wsTempTOS, wsSFPConnector=wsSFPConnector, wsIbosTempLow=wsIbosTempLow, wsVoltTable=wsVoltTable, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsWritedummy=wsWritedummy, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPTransceiver=wsSFPTransceiver, wsPolicyUsedCnt=wsPolicyUsedCnt, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortName=wsNeighbourPortName, wsEnvironment=wsEnvironment, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsXFPTransceiver=wsXFPTransceiver, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsPolicyName=wsPolicyName, wsVoltStatus=wsVoltStatus, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourState=wsNeighbourState, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPTable=wsXFPTable, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsVoltNominal=wsVoltNominal, wsSFPTemp=wsSFPTemp, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsVersion=wsVersion, wsXFPEntry=wsXFPEntry, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourHostname=wsNeighbourHostname, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPTable=wsSFPTable, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsTempSensor=wsTempSensor, wsSFPTempStatus=wsSFPTempStatus, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPRXPower=wsSFPRXPower, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPEntry=wsSFPEntry, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsPolicyEntry=wsPolicyEntry, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPRXPower=wsXFPRXPower, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsXFPEncoding=wsXFPEncoding, wsXFPIndex=wsXFPIndex, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPSingleModeLen=wsXFPSingleModeLen, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPVolt=wsSFPVolt, wsPolicyTable=wsPolicyTable, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsTempEntry=wsTempEntry, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsFanNumber=wsFanNumber, wsAsrRevision=wsAsrRevision, wsReload=wsReload, wsPolicyInBytes=wsPolicyInBytes, PYSNMP_MODULE_ID=ibos, wsTempThresholdHigh=wsTempThresholdHigh, wsTempThresholdLow=wsTempThresholdLow, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsPolicyCookie=wsPolicyCookie, wsSystem=wsSystem, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsTempTHYST=wsTempTHYST, wsTempStatus=wsTempStatus, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, ibos=ibos, wsAccounting=wsAccounting, wsTempMeasured=wsTempMeasured, wsSFPTransceiverExt=wsSFPTransceiverExt, wsXFPConnector=wsXFPConnector, wsVoltEntry=wsVoltEntry, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsXFPBitrateMin=wsXFPBitrateMin, wsFanRPM=wsFanRPM, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsPolicyIfName=wsPolicyIfName, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPStatus=wsSFPStatus, wsNeighbourSNPA=wsNeighbourSNPA, wsIbosVoltLow=wsIbosVoltLow, wsFanVoltage=wsFanVoltage, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsXFPTemp=wsXFPTemp, wsFanTable=wsFanTable, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighboursTable=wsNeighboursTable, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPTempStatus=wsXFPTempStatus, wsTempTable=wsTempTable, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsPolicyInDrops=wsPolicyInDrops, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPIndex=wsSFPIndex, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsVoltChannel=wsVoltChannel, wsSFPMultiMode50Len=wsSFPMultiMode50Len)
