...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsFanTable=wsFanTable, wsSFPEntry=wsSFPEntry, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsIbosTempLow=wsIbosTempLow, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsXFPConnector=wsXFPConnector, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPTXdBmPower=wsSFPTXdBmPower, wsTempThresholdLow=wsTempThresholdLow, wsXFPTXPower=wsXFPTXPower, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPCopperLen=wsSFPCopperLen, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPEncoding=wsSFPEncoding, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsPolicyOutBytes=wsPolicyOutBytes, wsTempTOS=wsTempTOS, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsXFPIndex=wsXFPIndex, wsTempStatus=wsTempStatus, wsXFPSingleModeLen=wsXFPSingleModeLen, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTransceiver=wsSFPTransceiver, wsWritedummy=wsWritedummy, wsFanNumber=wsFanNumber, wsPFDP=wsPFDP, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPVolt=wsSFPVolt, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsXFPTable=wsXFPTable, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsVoltStatus=wsVoltStatus, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsPolicyName=wsPolicyName, wsNeighbourSNPA=wsNeighbourSNPA, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourState=wsNeighbourState, wsSFPBitrate=wsSFPBitrate, wsNeighbourIfIndex=wsNeighbourIfIndex, wsVersion=wsVersion, wsTempEntry=wsTempEntry, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourOSVersion=wsNeighbourOSVersion, wsFanEntry=wsFanEntry, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsXFPStatus=wsXFPStatus, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTemp=wsSFPTemp, wsSystem=wsSystem, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPTempStatus=wsXFPTempStatus, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsXFPTXCurrent=wsXFPTXCurrent, wsTempSensor=wsTempSensor, wsEnvironment=wsEnvironment, wsNeighbourNIndex=wsNeighbourNIndex, wsXFPTransceiver=wsXFPTransceiver, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourHostname=wsNeighbourHostname, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPRXdBmPower=wsSFPRXdBmPower, wsFanVoltage=wsFanVoltage, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPBitrateMin=wsXFPBitrateMin, wsAsrRevision=wsAsrRevision, wsAccounting=wsAccounting, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsVoltChannel=wsVoltChannel, wsTempTable=wsTempTable, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortsTable=wsNeighbourPortsTable, wsTempThresholdHigh=wsTempThresholdHigh, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsTempTHYST=wsTempTHYST, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, ibos=ibos, wsPolicyInBytes=wsPolicyInBytes, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsPolicyTable=wsPolicyTable, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourLocalIf=wsNeighbourLocalIf, wsXFPTemp=wsXFPTemp, wsIbosVoltLow=wsIbosVoltLow, wsSFPIndex=wsSFPIndex, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPConnector=wsSFPConnector, wsXFPRXPower=wsXFPRXPower, wsTempMeasured=wsTempMeasured, wsReload=wsReload, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourUptime=wsNeighbourUptime, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPPartNumber=wsSFPPartNumber, wsFanRPM=wsFanRPM, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourCreated=wsNeighbourCreated, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsIbosFanRPMLow=wsIbosFanRPMLow, PYSNMP_MODULE_ID=ibos, wsVoltNominal=wsVoltNominal, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTable=wsSFPTable, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPRXPower=wsSFPRXPower, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortState=wsNeighbourPortState, wsSFPStatus=wsSFPStatus, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPSerialNumber=wsSFPSerialNumber, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPTXPower=wsSFPTXPower, wsPolicyCookie=wsPolicyCookie, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPEntry=wsXFPEntry, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsVoltTable=wsVoltTable, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsVersionString=wsVersionString, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighboursTable=wsNeighboursTable, wsPolicyEntry=wsPolicyEntry, wsVoltEntry=wsVoltEntry, wsPolicyInDrops=wsPolicyInDrops)
