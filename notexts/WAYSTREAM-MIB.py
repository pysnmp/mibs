...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsVoltMeasured=wsVoltMeasured, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPEntry=wsSFPEntry, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPConnector=wsSFPConnector, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourCreated=wsNeighbourCreated, wsSFPVoltStatus=wsSFPVoltStatus, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsFanNumber=wsFanNumber, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsEnvironment=wsEnvironment, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourModel=wsNeighbourModel, wsIbosTempLow=wsIbosTempLow, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsVoltStatus=wsVoltStatus, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsPolicyUsedCnt=wsPolicyUsedCnt, wsVoltTable=wsVoltTable, wsTempMeasured=wsTempMeasured, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPStatus=wsSFPStatus, wsIbosFanRPMLow=wsIbosFanRPMLow, wsAsrRevision=wsAsrRevision, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsPolicyEntry=wsPolicyEntry, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsVoltNominal=wsVoltNominal, wsIbosVoltLow=wsIbosVoltLow, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPTable=wsSFPTable, wsNeighbourUptime=wsNeighbourUptime, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPEncoding=wsXFPEncoding, wsPFDP=wsPFDP, wsXFPConnector=wsXFPConnector, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsVersionString=wsVersionString, wsReload=wsReload, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourLocalIf=wsNeighbourLocalIf, wsPolicyInBytes=wsPolicyInBytes, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortName=wsNeighbourPortName, wsXFPTable=wsXFPTable, wsXFPIndex=wsXFPIndex, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPRXdBmPower=wsSFPRXdBmPower, wsPolicyCookie=wsPolicyCookie, wsSFPVolt=wsSFPVolt, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsFanRPM=wsFanRPM, wsTempTHYST=wsTempTHYST, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourState=wsNeighbourState, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, PYSNMP_MODULE_ID=ibos, ibos=ibos, wsTempStatus=wsTempStatus, wsFanTable=wsFanTable, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsPolicyTable=wsPolicyTable, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsTempEntry=wsTempEntry, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPSerialNumber=wsSFPSerialNumber, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsVoltThresholdLow=wsVoltThresholdLow, wsXFPTXCurrent=wsXFPTXCurrent, wsSystem=wsSystem, wsTempTable=wsTempTable, wsSFPPartNumber=wsSFPPartNumber, wsXFPTransceiver=wsXFPTransceiver, wsVoltEntry=wsVoltEntry, wsSFPIndex=wsSFPIndex, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortsTable=wsNeighbourPortsTable, wsPolicyIfName=wsPolicyIfName, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsTempSensor=wsTempSensor, wsTempThresholdLow=wsTempThresholdLow, wsNeighboursTable=wsNeighboursTable, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsXFPEntry=wsXFPEntry, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighboursEntry=wsNeighboursEntry, wsWritedummy=wsWritedummy, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPTempStatus=wsSFPTempStatus, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsFanEntry=wsFanEntry, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsVersion=wsVersion, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsPolicyName=wsPolicyName, wsSFPTemp=wsSFPTemp, wsNeighbourHostname=wsNeighbourHostname, wsPolicyInPkts=wsPolicyInPkts, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPEncoding=wsSFPEncoding, wsSFPCopperLen=wsSFPCopperLen, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPStatus=wsXFPStatus, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsPolicyIfIndex=wsPolicyIfIndex, wsVoltChannel=wsVoltChannel, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsXFPTXPower=wsXFPTXPower, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsTempTOS=wsTempTOS, wsTempThresholdHigh=wsTempThresholdHigh, wsAccounting=wsAccounting, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsIbosVoltHigh=wsIbosVoltHigh, wsXFPTemp=wsXFPTemp, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsFanVoltage=wsFanVoltage)
