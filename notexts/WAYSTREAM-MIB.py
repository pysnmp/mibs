...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTXPower=wsSFPTXPower, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsVoltTable=wsVoltTable, wsSFPVolt=wsSFPVolt, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPRXdBmPower=wsSFPRXdBmPower, wsXFPIndex=wsXFPIndex, wsSFPSerialNumber=wsSFPSerialNumber, wsIbosVoltHigh=wsIbosVoltHigh, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTable=wsSFPTable, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsIbosVoltLow=wsIbosVoltLow, wsFanRPM=wsFanRPM, wsSFPConnector=wsSFPConnector, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsWritedummy=wsWritedummy, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPTXPower=wsXFPTXPower, wsVersion=wsVersion, wsFanNumber=wsFanNumber, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsIbosTempHigh=wsIbosTempHigh, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsIbosTempLow=wsIbosTempLow, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsFanTable=wsFanTable, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsPolicyName=wsPolicyName, wsSFPBitrate=wsSFPBitrate, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTemp=wsSFPTemp, wsNeighbourState=wsNeighbourState, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsTempMeasured=wsTempMeasured, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSystem=wsSystem, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPCopperLen=wsXFPCopperLen, wsFanEntry=wsFanEntry, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPEntry=wsSFPEntry, wsNeighboursEntry=wsNeighboursEntry, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortName=wsNeighbourPortName, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsVersionString=wsVersionString, wsTempStatus=wsTempStatus, wsSFPVoltStatus=wsSFPVoltStatus, wsXFPTempStatus=wsXFPTempStatus, wsVoltMeasured=wsVoltMeasured, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsPolicyCookie=wsPolicyCookie, wsSFPPartNumber=wsSFPPartNumber, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsVoltThresholdHigh=wsVoltThresholdHigh, wsXFPConnector=wsXFPConnector, wsNeighbourOSVersion=wsNeighbourOSVersion, wsVoltEntry=wsVoltEntry, wsPolicyInPkts=wsPolicyInPkts, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPEncoding=wsXFPEncoding, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsAsrRevision=wsAsrRevision, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPTable=wsXFPTable, wsAccounting=wsAccounting, wsPFDP=wsPFDP, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPBitrateMax=wsXFPBitrateMax, wsPolicyEntry=wsPolicyEntry, wsEnvironment=wsEnvironment, wsFanVoltage=wsFanVoltage, wsSFPTempStatus=wsSFPTempStatus, wsSFPTransceiver=wsSFPTransceiver, wsXFPEntry=wsXFPEntry, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsTempTOS=wsTempTOS, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsXFPStatus=wsXFPStatus, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPIndex=wsSFPIndex, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsTempSensor=wsTempSensor, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsPolicyTable=wsPolicyTable, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPStatus=wsSFPStatus, ibos=ibos, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsXFPTemp=wsXFPTemp, wsTempThresholdLow=wsTempThresholdLow, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsReload=wsReload, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsVoltNominal=wsVoltNominal, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortState=wsNeighbourPortState, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsTempTHYST=wsTempTHYST, wsVoltChannel=wsVoltChannel, wsNeighbourSNPA=wsNeighbourSNPA, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, PYSNMP_MODULE_ID=ibos, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsXFPTransceiver=wsXFPTransceiver, wsVoltStatus=wsVoltStatus, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsTempEntry=wsTempEntry, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourUptime=wsNeighbourUptime, wsSFPEncoding=wsSFPEncoding, wsSFPTransceiverExt=wsSFPTransceiverExt, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourModel=wsNeighbourModel, wsTempThresholdHigh=wsTempThresholdHigh, wsTempTable=wsTempTable, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPBitrateMin=wsXFPBitrateMin, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortNIndex=wsNeighbourPortNIndex)
