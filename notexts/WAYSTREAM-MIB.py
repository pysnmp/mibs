...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTransceiverExt=wsSFPTransceiverExt, wsTempStatus=wsTempStatus, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsPolicyInDrops=wsPolicyInDrops, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPTemp=wsXFPTemp, wsIbosTempHigh=wsIbosTempHigh, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsVoltStatus=wsVoltStatus, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, ibos=ibos, wsXFPIndex=wsXFPIndex, wsVoltChannel=wsVoltChannel, wsSFPIndex=wsSFPIndex, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPBitrate=wsSFPBitrate, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourState=wsNeighbourState, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsTempTable=wsTempTable, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsTempTHYST=wsTempTHYST, wsPolicyName=wsPolicyName, wsXFPConnector=wsXFPConnector, wsVoltNominal=wsVoltNominal, wsSFPEncoding=wsSFPEncoding, wsTempThresholdHigh=wsTempThresholdHigh, wsFanVoltage=wsFanVoltage, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPPartNumber=wsSFPPartNumber, wsWritedummy=wsWritedummy, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPVolt=wsSFPVolt, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourLastAct=wsNeighbourLastAct, wsTempMeasured=wsTempMeasured, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourCreated=wsNeighbourCreated, wsXFPTable=wsXFPTable, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsReload=wsReload, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, PYSNMP_MODULE_ID=ibos, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsVoltThresholdLow=wsVoltThresholdLow, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighboursTable=wsNeighboursTable, wsSystem=wsSystem, wsSFPEntry=wsSFPEntry, wsXFPBitrateMin=wsXFPBitrateMin, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsIbosTempLow=wsIbosTempLow, wsSFPTempStatus=wsSFPTempStatus, wsVoltTable=wsVoltTable, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsPolicyIfName=wsPolicyIfName, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsFanNumber=wsFanNumber, wsXFPTXPower=wsXFPTXPower, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsVoltEntry=wsVoltEntry, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsVersion=wsVersion, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsXFPStatus=wsXFPStatus, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsFanTable=wsFanTable, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPTXdBmPower=wsSFPTXdBmPower, wsPolicyInPkts=wsPolicyInPkts, wsXFPTXCurrent=wsXFPTXCurrent, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourDBCount=wsNeighbourDBCount, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsPolicyUsedCnt=wsPolicyUsedCnt, wsVoltMeasured=wsVoltMeasured, wsNeighbourModel=wsNeighbourModel, wsSFPTXCurrent=wsSFPTXCurrent, wsPolicyTable=wsPolicyTable, wsSFPConnector=wsSFPConnector, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsXFPEncoding=wsXFPEncoding, wsAsrRevision=wsAsrRevision, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsTempTOS=wsTempTOS, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsPFDP=wsPFDP, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsVersionString=wsVersionString, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPCopperLen=wsSFPCopperLen, wsFanRPM=wsFanRPM, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortName=wsNeighbourPortName, wsSFPRXPower=wsSFPRXPower, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTXPower=wsSFPTXPower, wsXFPEntry=wsXFPEntry, wsFanEntry=wsFanEntry, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsAccounting=wsAccounting, wsNeighbourPortState=wsNeighbourPortState, wsPolicyEntry=wsPolicyEntry, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPStatus=wsSFPStatus, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPTempStatus=wsXFPTempStatus, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighboursEntry=wsNeighboursEntry, wsSFPTemp=wsSFPTemp, wsTempEntry=wsTempEntry, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsTempSensor=wsTempSensor, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsIbosVoltLow=wsIbosVoltLow, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPTable=wsSFPTable, wsEnvironment=wsEnvironment, wsXFPTransceiver=wsXFPTransceiver, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortsTable=wsNeighbourPortsTable, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm)
