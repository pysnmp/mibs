...
AdminState, VlanPriority, SecondaryState, CmPmBinAction, PerfCounter64, OperationalState = mibBuilder.importSymbols("CM-COMMON-MIB", "AdminState", "VlanPriority", "SecondaryState", "CmPmBinAction", "PerfCounter64", "OperationalState")
...
mibBuilder.exportSymbols("F3-CFM-MIB", cfmServerMepIndex=cfmServerMepIndex, cfmMepExcludedMepListEntry=cfmMepExcludedMepListEntry, CfmAisGenTriggerTypes=CfmAisGenTriggerTypes, cfmServerMepAisPriority=cfmServerMepAisPriority, cfmNetPortQosShaperCIR=cfmNetPortQosShaperCIR, cfmDownMEPQosShaperProfile=cfmDownMEPQosShaperProfile, cfmMepLlbPortLLEnabled=cfmMepLlbPortLLEnabled, cfmMaCompIndex=cfmMaCompIndex, cfmMepLlbMacAddressTable=cfmMepLlbMacAddressTable, cfmTrafficPortQosShaperBufSize=cfmTrafficPortQosShaperBufSize, cfmMepLmCountInProfileEnabled=cfmMepLmCountInProfileEnabled, cfmMepAdminState=cfmMepAdminState, cfmMacAddress=cfmMacAddress, cfmDownMEPQosShaperType=cfmDownMEPQosShaperType, cfmGenGroup=cfmGenGroup, cfmMepLmRxCountAllPriosEnabled=cfmMepLmRxCountAllPriosEnabled, cfmMepErrCCMs=cfmMepErrCCMs, cfmMepLbrTable=cfmMepLbrTable, cfmMaCompGroup=cfmMaCompGroup, cfmTrafficPortQosShaperAdminState=cfmTrafficPortQosShaperAdminState, cfmServerMepRowStatus=cfmServerMepRowStatus, cfmMepAssociatedObject=cfmMepAssociatedObject, cfmNetPortQosShaperAdminState=cfmNetPortQosShaperAdminState, cfmMaNetRemoteMepAutoDiscovery=cfmMaNetRemoteMepAutoDiscovery, cfmMepEntry=cfmMepEntry, cfmNetPortQosShaperTable=cfmNetPortQosShaperTable, cfmSignalFailTriggers=cfmSignalFailTriggers, cfmMepLlbResponderEnabled=cfmMepLlbResponderEnabled, cfmMepStatsAction=cfmMepStatsAction, cfmServerMepAdminState=cfmServerMepAdminState, cfmMepExcludedMepListRowStatus=cfmMepExcludedMepListRowStatus, cfmMaNetTable=cfmMaNetTable, cfmNetPortQosShaperTypeIndex=cfmNetPortQosShaperTypeIndex, cfmMepLbrMepId=cfmMepLbrMepId, cfmAccPortQosShaperAdminState=cfmAccPortQosShaperAdminState, cfmServerMepOperationalState=cfmServerMepOperationalState, cfmServerMepSecondaryState=cfmServerMepSecondaryState, cfmServerMepEntry=cfmServerMepEntry, CfmAisInterval=CfmAisInterval, cfmMepLbrInOrder=cfmMepLbrInOrder, cfmMepLbrOutOfOder=cfmMepLbrOutOfOder, cfmMaCompEntity=cfmMaCompEntity, cfmMaNetMepNumbers=cfmMaNetMepNumbers, cfmPortShaperGroup=cfmPortShaperGroup, cfmMepAisPriority=cfmMepAisPriority, cfmMaNetEntry=cfmMaNetEntry, cfmServerMepAisInterval=cfmServerMepAisInterval, cfmMepLbrEntry=cfmMepLbrEntry, cfmEthType=cfmEthType, cfmMepLbmInterval=cfmMepLbmInterval, cfmMepDmPriority=cfmMepDmPriority, slrOpcode=slrOpcode, cfmExtScalars=cfmExtScalars, CfmLLFTriggerTypes=CfmLLFTriggerTypes, cfmMepLmTxPriority=cfmMepLmTxPriority, cfmNetPortQosShaperBufSize=cfmNetPortQosShaperBufSize, cfmServerMepTable=cfmServerMepTable, cfmMepAisClientMdLevel=cfmMepAisClientMdLevel, cfmLlbMacAddress=cfmLlbMacAddress, cfmExtSvcObjects=cfmExtSvcObjects, cfmMepTable=cfmMepTable, cfmMepTagEtherType=cfmMepTagEtherType, cfmMepGroup=cfmMepGroup, cfmMepRxCCMs=cfmMepRxCCMs, cfmMepDefects=cfmMepDefects, cfmTrafficPortQosShaperTable=cfmTrafficPortQosShaperTable, cfmExtCompliance=cfmExtCompliance, cfmAccPortQosShaperBufSize=cfmAccPortQosShaperBufSize, cfmTrafficPortQosShaperCIR=cfmTrafficPortQosShaperCIR, cfmServerMepAssociatedPort=cfmServerMepAssociatedPort, slmOpcode=slmOpcode, CfmPduVersionType=CfmPduVersionType, cfmMepAisGenTriggerTypes=cfmMepAisGenTriggerTypes, cfmMepLmTxCountAllPriosEnabled=cfmMepLmTxCountAllPriosEnabled, cfmExtGroup=cfmExtGroup, cfmMepLbrMacAddress=cfmMepLbrMacAddress, cfmMaCompTable=cfmMaCompTable, cfmMepExcludedMepListIdentifier=cfmMepExcludedMepListIdentifier, cfmServerMepAisGenEnabled=cfmServerMepAisGenEnabled, cfmExtSvcCompliances=cfmExtSvcCompliances, cfmServerMepGroup=cfmServerMepGroup, cfmExtSvcConformance=cfmExtSvcConformance, cfmExtSvcGroups=cfmExtSvcGroups, CfmLmmDmmInterval=CfmLmmDmmInterval, slmMulticastMacAddress=slmMulticastMacAddress, cfmAccPortQosShaperIndex=cfmAccPortQosShaperIndex, cfmMepLLFTriggerTypes=cfmMepLLFTriggerTypes, cfmAccPortQosShaperTable=cfmAccPortQosShaperTable, CfmMepDefects=CfmMepDefects, CfmSlmEnabledTypes=CfmSlmEnabledTypes, cfmMepLmDualEndedCountAllPriosEnabled=cfmMepLmDualEndedCountAllPriosEnabled, cfmMepCcmInterfaceStatusTLVControl=cfmMepCcmInterfaceStatusTLVControl, cfmDownMEPQosShaperIndex=cfmDownMEPQosShaperIndex, cfmServerMepStorageType=cfmServerMepStorageType, cfmAccPortQosShaperCIR=cfmAccPortQosShaperCIR, cfmDownMEPQosShaperEntry=cfmDownMEPQosShaperEntry, cfmMaCompEntry=cfmMaCompEntry, cfmServerMepAisClientMdLevel=cfmServerMepAisClientMdLevel, cfmMepPduVersion=cfmMepPduVersion, cfmMepAisInterval=cfmMepAisInterval, cfmMepAisGenEnabled=cfmMepAisGenEnabled, CfmSignalFailTriggers=CfmSignalFailTriggers, cfmMepOperationalState=cfmMepOperationalState, cfmTrafficPortQosShaperIndex=cfmTrafficPortQosShaperIndex, cfmMepSlmEnabled=cfmMepSlmEnabled, cfmNetPortQosShaperEntry=cfmNetPortQosShaperEntry, PYSNMP_MODULE_ID=f3CfmMIB, f3CfmMIB=f3CfmMIB, cfmDownMEPQosShaperAdminState=cfmDownMEPQosShaperAdminState, cfmDownMEPQosShaperTable=cfmDownMEPQosShaperTable, cfmLlbMacAddressRowStatus=cfmLlbMacAddressRowStatus, cfmMepLlbVidList=cfmMepLlbVidList, cfmMepSecondaryState=cfmMepSecondaryState, cfmAccPortQosShaperEntry=cfmAccPortQosShaperEntry, cfmDownMEPQosShaperCIR=cfmDownMEPQosShaperCIR, cfmTrafficPortQosShaperEntry=cfmTrafficPortQosShaperEntry, cfmLlbMacAddressEntry=cfmLlbMacAddressEntry, cfmMepExcludedMepListTable=cfmMepExcludedMepListTable, cfmExtSvc=cfmExtSvc)
