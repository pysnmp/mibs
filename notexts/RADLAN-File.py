...
# ASN.1 source RADLAN-File
# Source digest sha256:944689f4dd940ac0db43dd4cd951567ed21e9adf3483cb5d8ff3bf10f60c610e
...
rlFileTable = MibTable((1, 3, 6, 1, 4, 1, 89, 96, 2), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: rlFileTable.setStatus('current')
rlFileEntry = MibTableRow((1, 3, 6, 1, 4, 1, 89, 96, 2, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "RADLAN-File", "rlFileName"))
...
rlFileActionTable = MibTable((1, 3, 6, 1, 4, 1, 89, 96, 3), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: rlFileActionTable.setStatus('current')
rlFileActionEntry = MibTableRow((1, 3, 6, 1, 4, 1, 89, 96, 3, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "RADLAN-File", "rlFileActionName"))
...
mibBuilder.exportSymbols("RADLAN-File", rlFileActionCommand=rlFileActionCommand, rlFileActionEntry=rlFileActionEntry, rlFileActionName=rlFileActionName, rlFileActionNewName=rlFileActionNewName, rlFileActionRowStatus=rlFileActionRowStatus, rlFileActionTable=rlFileActionTable, rlFileAuditingEnable=rlFileAuditingEnable, rlFileEntry=rlFileEntry, rlFileFlashSize=rlFileFlashSize, rlFileFreeSizeOfFlash=rlFileFreeSizeOfFlash, rlFileMibVersion=rlFileMibVersion, rlFileModificationDate=rlFileModificationDate, rlFileModificationTime=rlFileModificationTime, rlFileName=rlFileName, rlFilePermission=rlFilePermission, rlFileRowStatus=rlFileRowStatus, rlFileSize=rlFileSize, rlFileTable=rlFileTable, rlFileTotalSizeOfFlash=rlFileTotalSizeOfFlash)
