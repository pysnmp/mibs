...
mibBuilder.exportSymbols("SPRIF-MIB", debugTxK2Stat=debugTxK2Stat, debug3Line=debug3Line, debug3Table=debug3Table, debugNumber=debugNumber, debugNodeState=debugNodeState, SWITCHSTATUS=SWITCHSTATUS, debug3exr=debug3exr, debugRxK2Src=debugRxK2Src, debug3aun=debug3aun, PYSNMP_MODULE_ID=sprif, debugLogType=debugLogType, sprif=sprif, debugIndex=debugIndex, debugEntry=debugEntry, debugTxK2Path=debugTxK2Path, debugLine=debugLine, debug3=debug3, debugTrafficStatus=debugTrafficStatus, LOGTYPE=LOGTYPE, LOCALCOMMAND=LOCALCOMMAND, debugTable=debugTable, debug=debug, debugLastLocalCommand=debugLastLocalCommand, debugLastDetectedFailure=debugLastDetectedFailure, TIMER=TIMER, K2STAT=K2STAT, K1ASK=K1ASK, debugActivated=debugActivated, debug3mms=debug3mms, debug3Entry=debug3Entry, NodeId=NodeId, debugRxK2Path=debugRxK2Path, debug3Date=debug3Date, debugTxK1Dst=debugTxK1Dst, debug3ato=debug3ato, STATE=STATE, debugSwitchingState=debugSwitchingState, LINE=LINE, debugWtr=debugWtr, debugLastDistantCommand=debugLastDistantCommand, debugRxK1Ask=debugRxK1Ask, debugRxK2Stat=debugRxK2Stat, debugTimerAction=debugTimerAction, TrafficStatus=TrafficStatus, debugDate=debugDate, LOCALFAIL=LOCALFAIL, debug3ptm=debug3ptm, debugTxK2Src=debugTxK2Src, debug3arv=debug3arv, debugNodeID=debugNodeID, K2PATH=K2PATH, debugRxK1Dst=debugRxK1Dst, debugTxK1Ask=debugTxK1Ask)
