...
mibBuilder.exportSymbols("SPRIF-MIB", LOGTYPE=LOGTYPE, debug3ptm=debug3ptm, LINE=LINE, K2STAT=K2STAT, debugTxK1Dst=debugTxK1Dst, debugRxK2Stat=debugRxK2Stat, debug3Entry=debug3Entry, debugTimerAction=debugTimerAction, debugRxK1Ask=debugRxK1Ask, debug3mms=debug3mms, debugTxK2Path=debugTxK2Path, debugTxK2Stat=debugTxK2Stat, debugTxK1Ask=debugTxK1Ask, debugLastDistantCommand=debugLastDistantCommand, debug3aun=debug3aun, debugRxK2Src=debugRxK2Src, K1ASK=K1ASK, debugNodeID=debugNodeID, debug3exr=debug3exr, debugEntry=debugEntry, debugLastDetectedFailure=debugLastDetectedFailure, debugTrafficStatus=debugTrafficStatus, debug3Line=debug3Line, debugTxK2Src=debugTxK2Src, debug3=debug3, sprif=sprif, debugRxK2Path=debugRxK2Path, PYSNMP_MODULE_ID=sprif, debugLastLocalCommand=debugLastLocalCommand, debugLine=debugLine, SWITCHSTATUS=SWITCHSTATUS, debug=debug, debugLogType=debugLogType, STATE=STATE, debugTable=debugTable, debugActivated=debugActivated, K2PATH=K2PATH, LOCALCOMMAND=LOCALCOMMAND, debugDate=debugDate, debugNumber=debugNumber, debug3arv=debug3arv, NodeId=NodeId, TIMER=TIMER, debugRxK1Dst=debugRxK1Dst, TrafficStatus=TrafficStatus, debugIndex=debugIndex, debug3Table=debug3Table, debug3ato=debug3ato, debugSwitchingState=debugSwitchingState, debugNodeState=debugNodeState, debug3Date=debug3Date, debugWtr=debugWtr, LOCALFAIL=LOCALFAIL)
