...
mibBuilder.exportSymbols("SPRIF-MIB", debug3aun=debug3aun, NodeId=NodeId, debug=debug, debugSwitchingState=debugSwitchingState, debug3Line=debug3Line, debugNumber=debugNumber, debugActivated=debugActivated, debugRxK2Path=debugRxK2Path, debugTxK1Dst=debugTxK1Dst, debug3ato=debug3ato, PYSNMP_MODULE_ID=sprif, debug3ptm=debug3ptm, LOCALFAIL=LOCALFAIL, debugTxK2Src=debugTxK2Src, debugIndex=debugIndex, debugWtr=debugWtr, debugRxK1Ask=debugRxK1Ask, debugRxK2Src=debugRxK2Src, K2STAT=K2STAT, debugLastLocalCommand=debugLastLocalCommand, debugNodeID=debugNodeID, debug3Entry=debug3Entry, debugRxK2Stat=debugRxK2Stat, debug3Table=debug3Table, LINE=LINE, debugEntry=debugEntry, TIMER=TIMER, debugLogType=debugLogType, debugDate=debugDate, debug3mms=debug3mms, debugLastDetectedFailure=debugLastDetectedFailure, debugTimerAction=debugTimerAction, debugTxK1Ask=debugTxK1Ask, TrafficStatus=TrafficStatus, debugLine=debugLine, debugLastDistantCommand=debugLastDistantCommand, debug3Date=debug3Date, K1ASK=K1ASK, debugNodeState=debugNodeState, debugTxK2Stat=debugTxK2Stat, debugTrafficStatus=debugTrafficStatus, debug3exr=debug3exr, STATE=STATE, SWITCHSTATUS=SWITCHSTATUS, debug3arv=debug3arv, K2PATH=K2PATH, LOCALCOMMAND=LOCALCOMMAND, debugTable=debugTable, debugTxK2Path=debugTxK2Path, LOGTYPE=LOGTYPE, debug3=debug3, sprif=sprif, debugRxK1Dst=debugRxK1Dst)
