...
mibBuilder.exportSymbols("SPRIF-MIB", debugEntry=debugEntry, LOGTYPE=LOGTYPE, debugLastDistantCommand=debugLastDistantCommand, debug3arv=debug3arv, debugRxK2Src=debugRxK2Src, debugTxK1Dst=debugTxK1Dst, K1ASK=K1ASK, debug3=debug3, debugRxK1Ask=debugRxK1Ask, debugTxK2Src=debugTxK2Src, debug3Entry=debug3Entry, debugLastDetectedFailure=debugLastDetectedFailure, debugNodeState=debugNodeState, debug3exr=debug3exr, LINE=LINE, debugIndex=debugIndex, debug3aun=debug3aun, K2PATH=K2PATH, debug3Date=debug3Date, debug3Line=debug3Line, SWITCHSTATUS=SWITCHSTATUS, STATE=STATE, TrafficStatus=TrafficStatus, debugTable=debugTable, debugTrafficStatus=debugTrafficStatus, debugTxK2Path=debugTxK2Path, NodeId=NodeId, TIMER=TIMER, K2STAT=K2STAT, debugActivated=debugActivated, debugLogType=debugLogType, debugTxK1Ask=debugTxK1Ask, debugRxK1Dst=debugRxK1Dst, debug3mms=debug3mms, PYSNMP_MODULE_ID=sprif, LOCALFAIL=LOCALFAIL, debugSwitchingState=debugSwitchingState, debugRxK2Path=debugRxK2Path, debugTimerAction=debugTimerAction, debug3Table=debug3Table, debugTxK2Stat=debugTxK2Stat, debugWtr=debugWtr, debugNodeID=debugNodeID, debugNumber=debugNumber, debug3ptm=debug3ptm, sprif=sprif, debug=debug, debugDate=debugDate, debugLastLocalCommand=debugLastLocalCommand, LOCALCOMMAND=LOCALCOMMAND, debug3ato=debug3ato, debugRxK2Stat=debugRxK2Stat, debugLine=debugLine)
