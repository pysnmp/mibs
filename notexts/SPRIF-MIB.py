...
mibBuilder.exportSymbols("SPRIF-MIB", debugRxK1Dst=debugRxK1Dst, debugDate=debugDate, debugNumber=debugNumber, debugTxK2Path=debugTxK2Path, NodeId=NodeId, debugRxK2Stat=debugRxK2Stat, debugLastDetectedFailure=debugLastDetectedFailure, debugTxK1Dst=debugTxK1Dst, STATE=STATE, debugTimerAction=debugTimerAction, debug3Date=debug3Date, debug3Entry=debug3Entry, debug3aun=debug3aun, debugLogType=debugLogType, debugActivated=debugActivated, sprif=sprif, debugTxK2Stat=debugTxK2Stat, SWITCHSTATUS=SWITCHSTATUS, debugRxK2Src=debugRxK2Src, debug3ato=debug3ato, debugNodeID=debugNodeID, LOCALCOMMAND=LOCALCOMMAND, debug3Line=debug3Line, debugTxK2Src=debugTxK2Src, TIMER=TIMER, K1ASK=K1ASK, debugLine=debugLine, TrafficStatus=TrafficStatus, LINE=LINE, debugTrafficStatus=debugTrafficStatus, debug3Table=debug3Table, debug3arv=debug3arv, debug=debug, LOCALFAIL=LOCALFAIL, K2PATH=K2PATH, PYSNMP_MODULE_ID=sprif, debugIndex=debugIndex, debugLastDistantCommand=debugLastDistantCommand, K2STAT=K2STAT, debug3mms=debug3mms, debugEntry=debugEntry, debug3ptm=debug3ptm, debugTxK1Ask=debugTxK1Ask, debugRxK2Path=debugRxK2Path, debugNodeState=debugNodeState, debugSwitchingState=debugSwitchingState, debug3=debug3, debugWtr=debugWtr, debugLastLocalCommand=debugLastLocalCommand, debugTable=debugTable, debug3exr=debug3exr, LOGTYPE=LOGTYPE, debugRxK1Ask=debugRxK1Ask)
