...
# Produced by pysmi-1.1.8 at Fri Dec  2 17:04:07 2022
...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Bits, Counter64, Gauge32, Integer32, ModuleIdentity, ObjectIdentity, MibIdentifier, TimeTicks, IpAddress, NotificationType, Unsigned32, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Bits", "Counter64", "Gauge32", "Integer32", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "TimeTicks", "IpAddress", "NotificationType", "Unsigned32", "Counter32", "iso")
...
mibBuilder.exportSymbols("CXR-TS-MIB", portEntry=portEntry, slaveIPaddr=slaveIPaddr, bytesSendToV24=bytesSendToV24, radiusServer1=radiusServer1, modbusType=modbusType, txIdle=txIdle, resetByButton=resetByButton, nameServer2=nameServer2, radiusServer2=radiusServer2, system=system, mode=mode, snmpTrapAddr2=snmpTrapAddr2, authRad1=authRad1, afterSend=afterSend, radiusSecret2=radiusSecret2, timeoutPAD=timeoutPAD, acctRad2=acctRad2, aliasIpAddress=aliasIpAddress, radiusSecret1=radiusSecret1, portReset=portReset, flowControl=flowControl, modbusMode=modbusMode, httpdService=httpdService, portIndex=portIndex, ftpdService=ftpdService, baudRate=baudRate, nameResolution=nameResolution, ethernetAddress=ethernetAddress, sessionStopped=sessionStopped, dtrUp=dtrUp, acctRad1=acctRad1, slaveHexaAddress=slaveHexaAddress, terminalType=terminalType, version=version, bytesReceiveFromV24=bytesReceiveFromV24, sessionStarted=sessionStarted, ts=ts, secondGateway=secondGateway, formFeed=formFeed, snmpTrap=snmpTrap, snmpTrapAddr1=snmpTrapAddr1, modbusEntry=modbusEntry, dtrDown=dtrDown, ipGateway=ipGateway, authRad2=authRad2, nameServer1=nameServer1, authType=authType, aliasIpNetmask=aliasIpNetmask, bootp=bootp, endMsg=endMsg, cxr=cxr, secondTcpPort=secondTcpPort, reset=reset, remoteTcpPort=remoteTcpPort, nbParStop=nbParStop, statusDTR=statusDTR, siteName=siteName, portStatsEntry=portStatsEntry, snmpdService=snmpdService, ipNetmask=ipNetmask, telnetdService=telnetdService, remoteIpAddress=remoteIpAddress, ipServer=ipServer, interFrame=interFrame, mainIpAddress=mainIpAddress, tcpPort=tcpPort, beforeSend=beforeSend, portStatsTable=portStatsTable, slaveIPport=slaveIPport, productName=productName, secondIpAddress=secondIpAddress, modbusTable=modbusTable, gatewayToRemote=gatewayToRemote, multiSession=multiSession, timeoutRxTx=timeoutRxTx, portTable=portTable, rxIdle=rxIdle)
