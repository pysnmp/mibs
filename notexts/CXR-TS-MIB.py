...
Gauge32, IpAddress, TimeTicks, NotificationType, ModuleIdentity, ObjectIdentity, Unsigned32, Counter64, enterprises, MibIdentifier, iso, NotificationType, Counter32, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "IpAddress", "TimeTicks", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "Counter64", "enterprises", "MibIdentifier", "iso", "NotificationType", "Counter32", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CXR-TS-MIB", portTable=portTable, timeoutPAD=timeoutPAD, telnetdService=telnetdService, aliasIpNetmask=aliasIpNetmask, ipNetmask=ipNetmask, modbusTable=modbusTable, cxr=cxr, dtrDown=dtrDown, tcpPort=tcpPort, radiusServer1=radiusServer1, endMsg=endMsg, ts=ts, ipGateway=ipGateway, snmpTrapAddr2=snmpTrapAddr2, authType=authType, snmpTrap=snmpTrap, nameServer2=nameServer2, remoteIpAddress=remoteIpAddress, modbusMode=modbusMode, secondTcpPort=secondTcpPort, terminalType=terminalType, resetByButton=resetByButton, ipServer=ipServer, httpdService=httpdService, version=version, modbusType=modbusType, mode=mode, slaveIPaddr=slaveIPaddr, bytesSendToV24=bytesSendToV24, bootp=bootp, radiusServer2=radiusServer2, authRad1=authRad1, acctRad1=acctRad1, nameResolution=nameResolution, slaveHexaAddress=slaveHexaAddress, interFrame=interFrame, sessionStarted=sessionStarted, afterSend=afterSend, sessionStopped=sessionStopped, slaveIPport=slaveIPport, portReset=portReset, reset=reset, ethernetAddress=ethernetAddress, aliasIpAddress=aliasIpAddress, snmpTrapAddr1=snmpTrapAddr1, nbParStop=nbParStop, formFeed=formFeed, system=system, nameServer1=nameServer1, baudRate=baudRate, ftpdService=ftpdService, acctRad2=acctRad2, secondIpAddress=secondIpAddress, modbusEntry=modbusEntry, bytesReceiveFromV24=bytesReceiveFromV24, radiusSecret1=radiusSecret1, portStatsEntry=portStatsEntry, statusDTR=statusDTR, siteName=siteName, portEntry=portEntry, txIdle=txIdle, portIndex=portIndex, secondGateway=secondGateway, remoteTcpPort=remoteTcpPort, flowControl=flowControl, snmpdService=snmpdService, productName=productName, radiusSecret2=radiusSecret2, authRad2=authRad2, multiSession=multiSession, timeoutRxTx=timeoutRxTx, mainIpAddress=mainIpAddress, beforeSend=beforeSend, portStatsTable=portStatsTable, rxIdle=rxIdle, gatewayToRemote=gatewayToRemote, dtrUp=dtrUp)
