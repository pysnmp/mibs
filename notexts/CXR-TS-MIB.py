...
# Produced by pysmi-1.1.8 at Thu Sep  7 13:54:45 2023
...
TimeTicks, NotificationType, ModuleIdentity, iso, Bits, MibIdentifier, Counter32, Integer32, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, Gauge32, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "ModuleIdentity", "iso", "Bits", "MibIdentifier", "Counter32", "Integer32", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "Gauge32", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("CXR-TS-MIB", authType=authType, statusDTR=statusDTR, endMsg=endMsg, mode=mode, portTable=portTable, modbusType=modbusType, flowControl=flowControl, mainIpAddress=mainIpAddress, ipServer=ipServer, interFrame=interFrame, reset=reset, aliasIpAddress=aliasIpAddress, secondIpAddress=secondIpAddress, timeoutPAD=timeoutPAD, baudRate=baudRate, authRad1=authRad1, httpdService=httpdService, radiusSecret2=radiusSecret2, bytesSendToV24=bytesSendToV24, nameServer1=nameServer1, aliasIpNetmask=aliasIpNetmask, sessionStarted=sessionStarted, portReset=portReset, authRad2=authRad2, telnetdService=telnetdService, snmpTrap=snmpTrap, gatewayToRemote=gatewayToRemote, formFeed=formFeed, acctRad2=acctRad2, remoteTcpPort=remoteTcpPort, version=version, dtrUp=dtrUp, system=system, sessionStopped=sessionStopped, nameResolution=nameResolution, cxr=cxr, portEntry=portEntry, snmpTrapAddr2=snmpTrapAddr2, radiusSecret1=radiusSecret1, multiSession=multiSession, radiusServer1=radiusServer1, txIdle=txIdle, rxIdle=rxIdle, modbusEntry=modbusEntry, dtrDown=dtrDown, timeoutRxTx=timeoutRxTx, productName=productName, secondTcpPort=secondTcpPort, modbusTable=modbusTable, secondGateway=secondGateway, snmpTrapAddr1=snmpTrapAddr1, slaveHexaAddress=slaveHexaAddress, portIndex=portIndex, tcpPort=tcpPort, afterSend=afterSend, radiusServer2=radiusServer2, portStatsEntry=portStatsEntry, portStatsTable=portStatsTable, nbParStop=nbParStop, snmpdService=snmpdService, beforeSend=beforeSend, ftpdService=ftpdService, modbusMode=modbusMode, remoteIpAddress=remoteIpAddress, terminalType=terminalType, ethernetAddress=ethernetAddress, ts=ts, slaveIPaddr=slaveIPaddr, slaveIPport=slaveIPport, acctRad1=acctRad1, resetByButton=resetByButton, bytesReceiveFromV24=bytesReceiveFromV24, ipNetmask=ipNetmask, bootp=bootp, nameServer2=nameServer2, siteName=siteName, ipGateway=ipGateway)
