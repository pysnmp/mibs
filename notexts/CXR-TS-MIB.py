...
# Produced by pysmi-1.1.8 at Thu Jan  5 13:18:02 2023
...
Counter32, enterprises, Integer32, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, Bits, TimeTicks, ModuleIdentity, IpAddress, MibIdentifier, iso, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "enterprises", "Integer32", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "Bits", "TimeTicks", "ModuleIdentity", "IpAddress", "MibIdentifier", "iso", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("CXR-TS-MIB", mainIpAddress=mainIpAddress, baudRate=baudRate, dtrUp=dtrUp, slaveHexaAddress=slaveHexaAddress, statusDTR=statusDTR, radiusSecret1=radiusSecret1, secondGateway=secondGateway, ipGateway=ipGateway, sessionStarted=sessionStarted, portIndex=portIndex, ipServer=ipServer, remoteIpAddress=remoteIpAddress, system=system, ftpdService=ftpdService, portEntry=portEntry, nameResolution=nameResolution, reset=reset, radiusServer1=radiusServer1, authRad2=authRad2, radiusServer2=radiusServer2, snmpdService=snmpdService, secondTcpPort=secondTcpPort, afterSend=afterSend, portReset=portReset, snmpTrapAddr2=snmpTrapAddr2, acctRad2=acctRad2, modbusTable=modbusTable, portStatsTable=portStatsTable, aliasIpNetmask=aliasIpNetmask, ts=ts, tcpPort=tcpPort, resetByButton=resetByButton, mode=mode, endMsg=endMsg, rxIdle=rxIdle, httpdService=httpdService, remoteTcpPort=remoteTcpPort, portTable=portTable, snmpTrap=snmpTrap, authRad1=authRad1, nbParStop=nbParStop, version=version, slaveIPaddr=slaveIPaddr, timeoutPAD=timeoutPAD, formFeed=formFeed, cxr=cxr, sessionStopped=sessionStopped, bytesReceiveFromV24=bytesReceiveFromV24, nameServer2=nameServer2, timeoutRxTx=timeoutRxTx, modbusMode=modbusMode, ethernetAddress=ethernetAddress, gatewayToRemote=gatewayToRemote, portStatsEntry=portStatsEntry, productName=productName, authType=authType, slaveIPport=slaveIPport, radiusSecret2=radiusSecret2, aliasIpAddress=aliasIpAddress, acctRad1=acctRad1, flowControl=flowControl, interFrame=interFrame, secondIpAddress=secondIpAddress, siteName=siteName, dtrDown=dtrDown, terminalType=terminalType, nameServer1=nameServer1, bytesSendToV24=bytesSendToV24, ipNetmask=ipNetmask, modbusType=modbusType, telnetdService=telnetdService, snmpTrapAddr1=snmpTrapAddr1, txIdle=txIdle, bootp=bootp, modbusEntry=modbusEntry, multiSession=multiSession, beforeSend=beforeSend)
