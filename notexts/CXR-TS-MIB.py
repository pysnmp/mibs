...
iso, ModuleIdentity, MibIdentifier, IpAddress, Gauge32, enterprises, ObjectIdentity, Counter64, Unsigned32, NotificationType, Integer32, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "MibIdentifier", "IpAddress", "Gauge32", "enterprises", "ObjectIdentity", "Counter64", "Unsigned32", "NotificationType", "Integer32", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits")
...
mibBuilder.exportSymbols("CXR-TS-MIB", statusDTR=statusDTR, portStatsTable=portStatsTable, portEntry=portEntry, siteName=siteName, slaveIPport=slaveIPport, secondTcpPort=secondTcpPort, mode=mode, authRad2=authRad2, baudRate=baudRate, system=system, terminalType=terminalType, ipNetmask=ipNetmask, ts=ts, radiusServer1=radiusServer1, secondIpAddress=secondIpAddress, radiusServer2=radiusServer2, acctRad1=acctRad1, flowControl=flowControl, portTable=portTable, portStatsEntry=portStatsEntry, timeoutRxTx=timeoutRxTx, aliasIpAddress=aliasIpAddress, nameServer1=nameServer1, telnetdService=telnetdService, afterSend=afterSend, acctRad2=acctRad2, sessionStarted=sessionStarted, radiusSecret1=radiusSecret1, beforeSend=beforeSend, bytesSendToV24=bytesSendToV24, httpdService=httpdService, remoteIpAddress=remoteIpAddress, dtrDown=dtrDown, tcpPort=tcpPort, modbusTable=modbusTable, version=version, nameServer2=nameServer2, slaveHexaAddress=slaveHexaAddress, bootp=bootp, snmpTrapAddr2=snmpTrapAddr2, radiusSecret2=radiusSecret2, endMsg=endMsg, ipServer=ipServer, snmpdService=snmpdService, slaveIPaddr=slaveIPaddr, gatewayToRemote=gatewayToRemote, snmpTrapAddr1=snmpTrapAddr1, multiSession=multiSession, snmpTrap=snmpTrap, modbusEntry=modbusEntry, secondGateway=secondGateway, reset=reset, dtrUp=dtrUp, formFeed=formFeed, productName=productName, authRad1=authRad1, aliasIpNetmask=aliasIpNetmask, timeoutPAD=timeoutPAD, interFrame=interFrame, sessionStopped=sessionStopped, authType=authType, resetByButton=resetByButton, portIndex=portIndex, modbusType=modbusType, nameResolution=nameResolution, bytesReceiveFromV24=bytesReceiveFromV24, rxIdle=rxIdle, mainIpAddress=mainIpAddress, ethernetAddress=ethernetAddress, ipGateway=ipGateway, portReset=portReset, remoteTcpPort=remoteTcpPort, nbParStop=nbParStop, ftpdService=ftpdService, cxr=cxr, modbusMode=modbusMode, txIdle=txIdle)
