...
IpAddress, Bits, Integer32, MibIdentifier, NotificationType, Gauge32, ModuleIdentity, enterprises, iso, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "Integer32", "MibIdentifier", "NotificationType", "Gauge32", "ModuleIdentity", "enterprises", "iso", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("CXR-TS-MIB", productName=productName, ipGateway=ipGateway, secondGateway=secondGateway, cxr=cxr, authType=authType, reset=reset, telnetdService=telnetdService, ftpdService=ftpdService, modbusEntry=modbusEntry, modbusTable=modbusTable, flowControl=flowControl, ethernetAddress=ethernetAddress, modbusMode=modbusMode, multiSession=multiSession, radiusSecret2=radiusSecret2, portIndex=portIndex, dtrUp=dtrUp, nameServer1=nameServer1, portReset=portReset, terminalType=terminalType, mode=mode, portEntry=portEntry, nbParStop=nbParStop, snmpTrap=snmpTrap, gatewayToRemote=gatewayToRemote, bootp=bootp, slaveHexaAddress=slaveHexaAddress, afterSend=afterSend, radiusSecret1=radiusSecret1, acctRad2=acctRad2, acctRad1=acctRad1, snmpdService=snmpdService, tcpPort=tcpPort, timeoutRxTx=timeoutRxTx, ts=ts, modbusType=modbusType, authRad1=authRad1, aliasIpAddress=aliasIpAddress, resetByButton=resetByButton, nameServer2=nameServer2, sessionStarted=sessionStarted, endMsg=endMsg, dtrDown=dtrDown, portStatsEntry=portStatsEntry, rxIdle=rxIdle, txIdle=txIdle, radiusServer1=radiusServer1, system=system, secondTcpPort=secondTcpPort, bytesReceiveFromV24=bytesReceiveFromV24, ipServer=ipServer, portStatsTable=portStatsTable, slaveIPaddr=slaveIPaddr, formFeed=formFeed, portTable=portTable, remoteIpAddress=remoteIpAddress, beforeSend=beforeSend, remoteTcpPort=remoteTcpPort, snmpTrapAddr2=snmpTrapAddr2, statusDTR=statusDTR, ipNetmask=ipNetmask, slaveIPport=slaveIPport, version=version, aliasIpNetmask=aliasIpNetmask, nameResolution=nameResolution, siteName=siteName, timeoutPAD=timeoutPAD, mainIpAddress=mainIpAddress, sessionStopped=sessionStopped, bytesSendToV24=bytesSendToV24, snmpTrapAddr1=snmpTrapAddr1, baudRate=baudRate, radiusServer2=radiusServer2, authRad2=authRad2, httpdService=httpdService, interFrame=interFrame, secondIpAddress=secondIpAddress)
