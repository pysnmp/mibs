...
# Produced by pysmi-1.1.8 at Mon Feb  6 14:26:56 2023
...
MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, NotificationType, Bits, Gauge32, Unsigned32, IpAddress, NotificationType, TimeTicks, Counter32, enterprises, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "NotificationType", "Bits", "Gauge32", "Unsigned32", "IpAddress", "NotificationType", "TimeTicks", "Counter32", "enterprises", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("CXR-TS-MIB", acctRad2=acctRad2, nameResolution=nameResolution, dtrUp=dtrUp, multiSession=multiSession, formFeed=formFeed, resetByButton=resetByButton, portReset=portReset, radiusServer1=radiusServer1, radiusServer2=radiusServer2, remoteIpAddress=remoteIpAddress, httpdService=httpdService, portEntry=portEntry, ftpdService=ftpdService, reset=reset, endMsg=endMsg, secondGateway=secondGateway, tcpPort=tcpPort, timeoutRxTx=timeoutRxTx, rxIdle=rxIdle, authType=authType, timeoutPAD=timeoutPAD, mode=mode, modbusTable=modbusTable, statusDTR=statusDTR, slaveIPport=slaveIPport, ts=ts, portStatsEntry=portStatsEntry, ethernetAddress=ethernetAddress, aliasIpAddress=aliasIpAddress, acctRad1=acctRad1, version=version, siteName=siteName, bytesReceiveFromV24=bytesReceiveFromV24, flowControl=flowControl, terminalType=terminalType, baudRate=baudRate, snmpTrapAddr2=snmpTrapAddr2, bytesSendToV24=bytesSendToV24, cxr=cxr, portIndex=portIndex, sessionStarted=sessionStarted, authRad2=authRad2, telnetdService=telnetdService, nbParStop=nbParStop, gatewayToRemote=gatewayToRemote, authRad1=authRad1, radiusSecret2=radiusSecret2, interFrame=interFrame, modbusType=modbusType, nameServer1=nameServer1, snmpTrap=snmpTrap, aliasIpNetmask=aliasIpNetmask, secondTcpPort=secondTcpPort, slaveIPaddr=slaveIPaddr, ipNetmask=ipNetmask, modbusMode=modbusMode, portStatsTable=portStatsTable, productName=productName, portTable=portTable, bootp=bootp, mainIpAddress=mainIpAddress, snmpTrapAddr1=snmpTrapAddr1, slaveHexaAddress=slaveHexaAddress, afterSend=afterSend, modbusEntry=modbusEntry, dtrDown=dtrDown, radiusSecret1=radiusSecret1, beforeSend=beforeSend, sessionStopped=sessionStopped, system=system, nameServer2=nameServer2, remoteTcpPort=remoteTcpPort, txIdle=txIdle, secondIpAddress=secondIpAddress, ipGateway=ipGateway, snmpdService=snmpdService, ipServer=ipServer)
