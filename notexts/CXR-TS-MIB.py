...
# Produced by pysmi-1.1.8 at Wed Sep 13 12:47:38 2023
...
enterprises, Gauge32, ModuleIdentity, IpAddress, Integer32, Counter32, TimeTicks, Unsigned32, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, NotificationType, Counter64, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "ModuleIdentity", "IpAddress", "Integer32", "Counter32", "TimeTicks", "Unsigned32", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "NotificationType", "Counter64", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("CXR-TS-MIB", ipServer=ipServer, afterSend=afterSend, terminalType=terminalType, modbusMode=modbusMode, aliasIpNetmask=aliasIpNetmask, reset=reset, formFeed=formFeed, modbusEntry=modbusEntry, portEntry=portEntry, system=system, snmpdService=snmpdService, dtrDown=dtrDown, beforeSend=beforeSend, radiusServer2=radiusServer2, statusDTR=statusDTR, authRad1=authRad1, nbParStop=nbParStop, sessionStopped=sessionStopped, bytesReceiveFromV24=bytesReceiveFromV24, resetByButton=resetByButton, txIdle=txIdle, endMsg=endMsg, tcpPort=tcpPort, remoteIpAddress=remoteIpAddress, rxIdle=rxIdle, ts=ts, secondIpAddress=secondIpAddress, portIndex=portIndex, slaveHexaAddress=slaveHexaAddress, slaveIPport=slaveIPport, multiSession=multiSession, gatewayToRemote=gatewayToRemote, dtrUp=dtrUp, ftpdService=ftpdService, bootp=bootp, radiusServer1=radiusServer1, sessionStarted=sessionStarted, slaveIPaddr=slaveIPaddr, secondGateway=secondGateway, secondTcpPort=secondTcpPort, snmpTrapAddr2=snmpTrapAddr2, acctRad2=acctRad2, portReset=portReset, snmpTrap=snmpTrap, portStatsEntry=portStatsEntry, timeoutPAD=timeoutPAD, siteName=siteName, mainIpAddress=mainIpAddress, aliasIpAddress=aliasIpAddress, telnetdService=telnetdService, portTable=portTable, cxr=cxr, remoteTcpPort=remoteTcpPort, interFrame=interFrame, flowControl=flowControl, timeoutRxTx=timeoutRxTx, modbusTable=modbusTable, httpdService=httpdService, acctRad1=acctRad1, authType=authType, nameResolution=nameResolution, baudRate=baudRate, authRad2=authRad2, snmpTrapAddr1=snmpTrapAddr1, ipGateway=ipGateway, radiusSecret1=radiusSecret1, modbusType=modbusType, portStatsTable=portStatsTable, version=version, bytesSendToV24=bytesSendToV24, productName=productName, nameServer2=nameServer2, mode=mode, ipNetmask=ipNetmask, nameServer1=nameServer1, radiusSecret2=radiusSecret2, ethernetAddress=ethernetAddress)
