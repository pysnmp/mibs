...
# Produced by pysmi-1.1.12 at Tue Dec  3 10:54:00 2024
...
ObjectIdentity, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, Counter32, ModuleIdentity, Gauge32, IpAddress, NotificationType, Integer32, Counter64, Bits, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "Counter32", "ModuleIdentity", "Gauge32", "IpAddress", "NotificationType", "Integer32", "Counter64", "Bits", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("CXR-TS-MIB", slaveIPaddr=slaveIPaddr, timeoutRxTx=timeoutRxTx, ipGateway=ipGateway, acctRad1=acctRad1, secondTcpPort=secondTcpPort, slaveHexaAddress=slaveHexaAddress, ftpdService=ftpdService, slaveIPport=slaveIPport, snmpTrap=snmpTrap, portStatsEntry=portStatsEntry, rxIdle=rxIdle, interFrame=interFrame, mainIpAddress=mainIpAddress, telnetdService=telnetdService, snmpdService=snmpdService, portReset=portReset, radiusServer1=radiusServer1, timeoutPAD=timeoutPAD, portTable=portTable, ipServer=ipServer, portIndex=portIndex, modbusMode=modbusMode, portEntry=portEntry, endMsg=endMsg, terminalType=terminalType, reset=reset, ipNetmask=ipNetmask, txIdle=txIdle, gatewayToRemote=gatewayToRemote, authRad1=authRad1, aliasIpNetmask=aliasIpNetmask, radiusSecret1=radiusSecret1, nameResolution=nameResolution, modbusType=modbusType, baudRate=baudRate, nbParStop=nbParStop, afterSend=afterSend, dtrDown=dtrDown, ethernetAddress=ethernetAddress, flowControl=flowControl, sessionStopped=sessionStopped, formFeed=formFeed, authRad2=authRad2, version=version, ts=ts, acctRad2=acctRad2, radiusServer2=radiusServer2, remoteTcpPort=remoteTcpPort, bytesSendToV24=bytesSendToV24, bootp=bootp, beforeSend=beforeSend, nameServer2=nameServer2, modbusTable=modbusTable, snmpTrapAddr2=snmpTrapAddr2, authType=authType, bytesReceiveFromV24=bytesReceiveFromV24, cxr=cxr, nameServer1=nameServer1, multiSession=multiSession, modbusEntry=modbusEntry, productName=productName, siteName=siteName, resetByButton=resetByButton, httpdService=httpdService, aliasIpAddress=aliasIpAddress, radiusSecret2=radiusSecret2, tcpPort=tcpPort, system=system, remoteIpAddress=remoteIpAddress, secondGateway=secondGateway, sessionStarted=sessionStarted, dtrUp=dtrUp, statusDTR=statusDTR, portStatsTable=portStatsTable, secondIpAddress=secondIpAddress, mode=mode, snmpTrapAddr1=snmpTrapAddr1)
