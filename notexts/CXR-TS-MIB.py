...
# Produced by pysmi-1.1.12 at Thu Apr  4 13:12:06 2024
...
NotificationType, Integer32, Gauge32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, Unsigned32, Counter32, MibIdentifier, NotificationType, TimeTicks, IpAddress, ModuleIdentity, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "Gauge32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "Unsigned32", "Counter32", "MibIdentifier", "NotificationType", "TimeTicks", "IpAddress", "ModuleIdentity", "Counter64", "iso")
...
mibBuilder.exportSymbols("CXR-TS-MIB", modbusType=modbusType, nbParStop=nbParStop, slaveHexaAddress=slaveHexaAddress, portTable=portTable, afterSend=afterSend, modbusMode=modbusMode, ipGateway=ipGateway, tcpPort=tcpPort, authRad2=authRad2, cxr=cxr, snmpdService=snmpdService, portIndex=portIndex, portReset=portReset, mainIpAddress=mainIpAddress, snmpTrap=snmpTrap, timeoutPAD=timeoutPAD, authRad1=authRad1, secondIpAddress=secondIpAddress, resetByButton=resetByButton, statusDTR=statusDTR, nameServer2=nameServer2, beforeSend=beforeSend, flowControl=flowControl, acctRad2=acctRad2, sessionStarted=sessionStarted, rxIdle=rxIdle, radiusServer2=radiusServer2, multiSession=multiSession, productName=productName, interFrame=interFrame, modbusTable=modbusTable, timeoutRxTx=timeoutRxTx, slaveIPport=slaveIPport, nameServer1=nameServer1, remoteTcpPort=remoteTcpPort, radiusSecret2=radiusSecret2, ipServer=ipServer, authType=authType, txIdle=txIdle, httpdService=httpdService, secondGateway=secondGateway, secondTcpPort=secondTcpPort, radiusServer1=radiusServer1, aliasIpNetmask=aliasIpNetmask, gatewayToRemote=gatewayToRemote, ts=ts, portEntry=portEntry, dtrDown=dtrDown, portStatsTable=portStatsTable, baudRate=baudRate, aliasIpAddress=aliasIpAddress, terminalType=terminalType, acctRad1=acctRad1, remoteIpAddress=remoteIpAddress, portStatsEntry=portStatsEntry, ipNetmask=ipNetmask, system=system, bytesSendToV24=bytesSendToV24, slaveIPaddr=slaveIPaddr, radiusSecret1=radiusSecret1, siteName=siteName, nameResolution=nameResolution, bootp=bootp, ftpdService=ftpdService, formFeed=formFeed, bytesReceiveFromV24=bytesReceiveFromV24, snmpTrapAddr1=snmpTrapAddr1, telnetdService=telnetdService, version=version, endMsg=endMsg, dtrUp=dtrUp, snmpTrapAddr2=snmpTrapAddr2, mode=mode, modbusEntry=modbusEntry, reset=reset, ethernetAddress=ethernetAddress, sessionStopped=sessionStopped)
