...
# Produced by pysmi-1.1.12 at Wed Jul  3 09:54:22 2024
...
NotificationType, iso, Integer32, Bits, ObjectIdentity, Counter32, TimeTicks, Gauge32, enterprises, NotificationType, Unsigned32, Counter64, MibIdentifier, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "Integer32", "Bits", "ObjectIdentity", "Counter32", "TimeTicks", "Gauge32", "enterprises", "NotificationType", "Unsigned32", "Counter64", "MibIdentifier", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CXR-TS-MIB", sessionStopped=sessionStopped, terminalType=terminalType, aliasIpAddress=aliasIpAddress, acctRad2=acctRad2, afterSend=afterSend, mainIpAddress=mainIpAddress, dtrDown=dtrDown, slaveHexaAddress=slaveHexaAddress, sessionStarted=sessionStarted, radiusSecret2=radiusSecret2, ethernetAddress=ethernetAddress, secondIpAddress=secondIpAddress, endMsg=endMsg, siteName=siteName, acctRad1=acctRad1, remoteIpAddress=remoteIpAddress, mode=mode, secondTcpPort=secondTcpPort, gatewayToRemote=gatewayToRemote, bytesReceiveFromV24=bytesReceiveFromV24, beforeSend=beforeSend, dtrUp=dtrUp, modbusEntry=modbusEntry, ipServer=ipServer, authType=authType, slaveIPport=slaveIPport, portStatsTable=portStatsTable, ipNetmask=ipNetmask, modbusMode=modbusMode, rxIdle=rxIdle, radiusServer1=radiusServer1, remoteTcpPort=remoteTcpPort, nameServer2=nameServer2, modbusType=modbusType, ftpdService=ftpdService, portTable=portTable, baudRate=baudRate, portReset=portReset, statusDTR=statusDTR, httpdService=httpdService, telnetdService=telnetdService, timeoutRxTx=timeoutRxTx, authRad2=authRad2, formFeed=formFeed, bytesSendToV24=bytesSendToV24, slaveIPaddr=slaveIPaddr, version=version, portEntry=portEntry, flowControl=flowControl, aliasIpNetmask=aliasIpNetmask, ts=ts, bootp=bootp, snmpTrapAddr1=snmpTrapAddr1, snmpTrap=snmpTrap, portStatsEntry=portStatsEntry, multiSession=multiSession, radiusServer2=radiusServer2, portIndex=portIndex, snmpdService=snmpdService, interFrame=interFrame, timeoutPAD=timeoutPAD, nbParStop=nbParStop, nameServer1=nameServer1, nameResolution=nameResolution, authRad1=authRad1, tcpPort=tcpPort, snmpTrapAddr2=snmpTrapAddr2, ipGateway=ipGateway, secondGateway=secondGateway, productName=productName, reset=reset, modbusTable=modbusTable, txIdle=txIdle, resetByButton=resetByButton, cxr=cxr, radiusSecret1=radiusSecret1, system=system)
