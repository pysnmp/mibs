...
# Produced by pysmi-1.1.8 at Thu Oct 12 08:14:07 2023
...
Bits, enterprises, Integer32, Counter64, ModuleIdentity, ObjectIdentity, NotificationType, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, iso, IpAddress, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "enterprises", "Integer32", "Counter64", "ModuleIdentity", "ObjectIdentity", "NotificationType", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "iso", "IpAddress", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("CXR-TS-MIB", snmpTrapAddr1=snmpTrapAddr1, sessionStopped=sessionStopped, authRad2=authRad2, txIdle=txIdle, statusDTR=statusDTR, tcpPort=tcpPort, dtrUp=dtrUp, aliasIpAddress=aliasIpAddress, mode=mode, timeoutPAD=timeoutPAD, modbusType=modbusType, portEntry=portEntry, portIndex=portIndex, bootp=bootp, ipNetmask=ipNetmask, ipGateway=ipGateway, multiSession=multiSession, nameResolution=nameResolution, flowControl=flowControl, ftpdService=ftpdService, resetByButton=resetByButton, secondGateway=secondGateway, slaveIPport=slaveIPport, rxIdle=rxIdle, productName=productName, baudRate=baudRate, mainIpAddress=mainIpAddress, reset=reset, authRad1=authRad1, snmpTrapAddr2=snmpTrapAddr2, radiusServer2=radiusServer2, httpdService=httpdService, portReset=portReset, modbusTable=modbusTable, nameServer2=nameServer2, aliasIpNetmask=aliasIpNetmask, beforeSend=beforeSend, formFeed=formFeed, version=version, timeoutRxTx=timeoutRxTx, radiusSecret1=radiusSecret1, secondTcpPort=secondTcpPort, siteName=siteName, ipServer=ipServer, remoteTcpPort=remoteTcpPort, radiusSecret2=radiusSecret2, bytesSendToV24=bytesSendToV24, radiusServer1=radiusServer1, authType=authType, nameServer1=nameServer1, acctRad1=acctRad1, modbusMode=modbusMode, ethernetAddress=ethernetAddress, system=system, dtrDown=dtrDown, nbParStop=nbParStop, endMsg=endMsg, snmpdService=snmpdService, modbusEntry=modbusEntry, slaveIPaddr=slaveIPaddr, sessionStarted=sessionStarted, gatewayToRemote=gatewayToRemote, cxr=cxr, terminalType=terminalType, portStatsEntry=portStatsEntry, ts=ts, afterSend=afterSend, acctRad2=acctRad2, interFrame=interFrame, secondIpAddress=secondIpAddress, slaveHexaAddress=slaveHexaAddress, telnetdService=telnetdService, portStatsTable=portStatsTable, portTable=portTable, remoteIpAddress=remoteIpAddress, bytesReceiveFromV24=bytesReceiveFromV24, snmpTrap=snmpTrap)
