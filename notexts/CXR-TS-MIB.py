...
# Produced by pysmi-1.1.8 at Sat Jan 15 17:11:28 2022
...
TimeTicks, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, Counter32, NotificationType, Gauge32, ModuleIdentity, Unsigned32, MibIdentifier, iso, enterprises, NotificationType, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "Counter32", "NotificationType", "Gauge32", "ModuleIdentity", "Unsigned32", "MibIdentifier", "iso", "enterprises", "NotificationType", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("CXR-TS-MIB", remoteIpAddress=remoteIpAddress, timeoutPAD=timeoutPAD, mainIpAddress=mainIpAddress, slaveIPaddr=slaveIPaddr, mode=mode, telnetdService=telnetdService, dtrUp=dtrUp, snmpTrap=snmpTrap, modbusMode=modbusMode, slaveHexaAddress=slaveHexaAddress, formFeed=formFeed, acctRad2=acctRad2, slaveIPport=slaveIPport, terminalType=terminalType, ipServer=ipServer, radiusServer1=radiusServer1, portStatsEntry=portStatsEntry, dtrDown=dtrDown, afterSend=afterSend, portReset=portReset, nameResolution=nameResolution, baudRate=baudRate, multiSession=multiSession, portEntry=portEntry, reset=reset, sessionStarted=sessionStarted, remoteTcpPort=remoteTcpPort, rxIdle=rxIdle, flowControl=flowControl, bytesSendToV24=bytesSendToV24, ftpdService=ftpdService, httpdService=httpdService, authRad1=authRad1, system=system, productName=productName, snmpdService=snmpdService, statusDTR=statusDTR, aliasIpAddress=aliasIpAddress, snmpTrapAddr2=snmpTrapAddr2, interFrame=interFrame, modbusType=modbusType, nbParStop=nbParStop, authRad2=authRad2, secondGateway=secondGateway, portStatsTable=portStatsTable, secondTcpPort=secondTcpPort, radiusSecret1=radiusSecret1, ethernetAddress=ethernetAddress, nameServer2=nameServer2, gatewayToRemote=gatewayToRemote, ipNetmask=ipNetmask, sessionStopped=sessionStopped, secondIpAddress=secondIpAddress, ipGateway=ipGateway, tcpPort=tcpPort, version=version, acctRad1=acctRad1, siteName=siteName, aliasIpNetmask=aliasIpNetmask, authType=authType, modbusEntry=modbusEntry, nameServer1=nameServer1, snmpTrapAddr1=snmpTrapAddr1, txIdle=txIdle, portTable=portTable, portIndex=portIndex, modbusTable=modbusTable, endMsg=endMsg, radiusSecret2=radiusSecret2, bytesReceiveFromV24=bytesReceiveFromV24, timeoutRxTx=timeoutRxTx, resetByButton=resetByButton, radiusServer2=radiusServer2, cxr=cxr, beforeSend=beforeSend, ts=ts, bootp=bootp)
