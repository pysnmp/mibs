...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:32:22 2023
...
enterprises, ObjectIdentity, Gauge32, Unsigned32, ModuleIdentity, TimeTicks, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, Counter32, IpAddress, MibIdentifier, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ObjectIdentity", "Gauge32", "Unsigned32", "ModuleIdentity", "TimeTicks", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "Counter32", "IpAddress", "MibIdentifier", "NotificationType", "iso")
...
mibBuilder.exportSymbols("CXR-TS-MIB", nbParStop=nbParStop, remoteIpAddress=remoteIpAddress, reset=reset, ethernetAddress=ethernetAddress, bytesReceiveFromV24=bytesReceiveFromV24, slaveIPaddr=slaveIPaddr, siteName=siteName, radiusSecret2=radiusSecret2, ipNetmask=ipNetmask, secondTcpPort=secondTcpPort, modbusType=modbusType, endMsg=endMsg, ipGateway=ipGateway, snmpTrapAddr2=snmpTrapAddr2, afterSend=afterSend, authRad1=authRad1, authRad2=authRad2, flowControl=flowControl, mainIpAddress=mainIpAddress, terminalType=terminalType, portTable=portTable, secondIpAddress=secondIpAddress, nameServer1=nameServer1, ftpdService=ftpdService, slaveIPport=slaveIPport, radiusServer2=radiusServer2, cxr=cxr, txIdle=txIdle, modbusTable=modbusTable, slaveHexaAddress=slaveHexaAddress, dtrDown=dtrDown, remoteTcpPort=remoteTcpPort, acctRad2=acctRad2, ts=ts, gatewayToRemote=gatewayToRemote, authType=authType, radiusSecret1=radiusSecret1, interFrame=interFrame, baudRate=baudRate, productName=productName, snmpdService=snmpdService, httpdService=httpdService, aliasIpAddress=aliasIpAddress, rxIdle=rxIdle, portStatsTable=portStatsTable, telnetdService=telnetdService, timeoutPAD=timeoutPAD, modbusEntry=modbusEntry, tcpPort=tcpPort, sessionStarted=sessionStarted, mode=mode, bootp=bootp, radiusServer1=radiusServer1, nameResolution=nameResolution, resetByButton=resetByButton, beforeSend=beforeSend, timeoutRxTx=timeoutRxTx, portStatsEntry=portStatsEntry, sessionStopped=sessionStopped, nameServer2=nameServer2, multiSession=multiSession, formFeed=formFeed, portEntry=portEntry, portReset=portReset, portIndex=portIndex, dtrUp=dtrUp, ipServer=ipServer, modbusMode=modbusMode, version=version, system=system, snmpTrap=snmpTrap, statusDTR=statusDTR, snmpTrapAddr1=snmpTrapAddr1, secondGateway=secondGateway, acctRad1=acctRad1, aliasIpNetmask=aliasIpNetmask, bytesSendToV24=bytesSendToV24)
