...
# Produced by pysmi-1.1.8 at Tue Sep 12 09:34:58 2023
...
Counter32, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, MibIdentifier, Integer32, NotificationType, Bits, ModuleIdentity, Counter64, ObjectIdentity, NotificationType, TimeTicks, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "MibIdentifier", "Integer32", "NotificationType", "Bits", "ModuleIdentity", "Counter64", "ObjectIdentity", "NotificationType", "TimeTicks", "enterprises")
...
mibBuilder.exportSymbols("CXR-TS-MIB", radiusSecret1=radiusSecret1, mode=mode, ipServer=ipServer, secondTcpPort=secondTcpPort, slaveIPaddr=slaveIPaddr, baudRate=baudRate, snmpdService=snmpdService, remoteTcpPort=remoteTcpPort, rxIdle=rxIdle, portEntry=portEntry, radiusServer2=radiusServer2, nameServer1=nameServer1, statusDTR=statusDTR, ts=ts, snmpTrapAddr1=snmpTrapAddr1, dtrUp=dtrUp, sessionStopped=sessionStopped, ipGateway=ipGateway, aliasIpAddress=aliasIpAddress, multiSession=multiSession, bytesSendToV24=bytesSendToV24, radiusServer1=radiusServer1, remoteIpAddress=remoteIpAddress, ftpdService=ftpdService, flowControl=flowControl, bootp=bootp, version=version, telnetdService=telnetdService, terminalType=terminalType, tcpPort=tcpPort, portIndex=portIndex, timeoutRxTx=timeoutRxTx, sessionStarted=sessionStarted, beforeSend=beforeSend, authRad2=authRad2, afterSend=afterSend, formFeed=formFeed, endMsg=endMsg, secondIpAddress=secondIpAddress, productName=productName, slaveIPport=slaveIPport, portTable=portTable, portStatsTable=portStatsTable, modbusMode=modbusMode, nbParStop=nbParStop, acctRad2=acctRad2, slaveHexaAddress=slaveHexaAddress, siteName=siteName, resetByButton=resetByButton, secondGateway=secondGateway, nameServer2=nameServer2, httpdService=httpdService, portStatsEntry=portStatsEntry, gatewayToRemote=gatewayToRemote, reset=reset, txIdle=txIdle, modbusEntry=modbusEntry, acctRad1=acctRad1, authType=authType, modbusTable=modbusTable, cxr=cxr, snmpTrapAddr2=snmpTrapAddr2, snmpTrap=snmpTrap, mainIpAddress=mainIpAddress, authRad1=authRad1, ipNetmask=ipNetmask, bytesReceiveFromV24=bytesReceiveFromV24, modbusType=modbusType, interFrame=interFrame, ethernetAddress=ethernetAddress, aliasIpNetmask=aliasIpNetmask, dtrDown=dtrDown, radiusSecret2=radiusSecret2, portReset=portReset, system=system, nameResolution=nameResolution, timeoutPAD=timeoutPAD)
