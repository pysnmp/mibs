...
# Produced by pysmi-1.1.8 at Thu Sep  7 09:13:24 2023
...
TimeTicks, Gauge32, NotificationType, Integer32, IpAddress, Counter32, enterprises, Counter64, NotificationType, MibIdentifier, Bits, ModuleIdentity, iso, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "NotificationType", "Integer32", "IpAddress", "Counter32", "enterprises", "Counter64", "NotificationType", "MibIdentifier", "Bits", "ModuleIdentity", "iso", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CXR-TS-MIB", remoteIpAddress=remoteIpAddress, bytesReceiveFromV24=bytesReceiveFromV24, reset=reset, modbusEntry=modbusEntry, snmpTrap=snmpTrap, authType=authType, siteName=siteName, mode=mode, modbusMode=modbusMode, radiusSecret1=radiusSecret1, radiusServer1=radiusServer1, telnetdService=telnetdService, modbusType=modbusType, dtrDown=dtrDown, nameServer1=nameServer1, afterSend=afterSend, statusDTR=statusDTR, endMsg=endMsg, snmpdService=snmpdService, ipNetmask=ipNetmask, radiusServer2=radiusServer2, portIndex=portIndex, aliasIpNetmask=aliasIpNetmask, terminalType=terminalType, secondTcpPort=secondTcpPort, sessionStarted=sessionStarted, nameResolution=nameResolution, acctRad2=acctRad2, sessionStopped=sessionStopped, bytesSendToV24=bytesSendToV24, remoteTcpPort=remoteTcpPort, cxr=cxr, baudRate=baudRate, gatewayToRemote=gatewayToRemote, multiSession=multiSession, portTable=portTable, version=version, beforeSend=beforeSend, system=system, portReset=portReset, dtrUp=dtrUp, snmpTrapAddr1=snmpTrapAddr1, authRad1=authRad1, formFeed=formFeed, slaveIPport=slaveIPport, tcpPort=tcpPort, snmpTrapAddr2=snmpTrapAddr2, timeoutPAD=timeoutPAD, secondIpAddress=secondIpAddress, secondGateway=secondGateway, rxIdle=rxIdle, ftpdService=ftpdService, portStatsTable=portStatsTable, ipGateway=ipGateway, ts=ts, aliasIpAddress=aliasIpAddress, portStatsEntry=portStatsEntry, interFrame=interFrame, resetByButton=resetByButton, nbParStop=nbParStop, productName=productName, timeoutRxTx=timeoutRxTx, slaveHexaAddress=slaveHexaAddress, ethernetAddress=ethernetAddress, portEntry=portEntry, mainIpAddress=mainIpAddress, httpdService=httpdService, radiusSecret2=radiusSecret2, acctRad1=acctRad1, ipServer=ipServer, nameServer2=nameServer2, txIdle=txIdle, bootp=bootp, modbusTable=modbusTable, slaveIPaddr=slaveIPaddr, authRad2=authRad2, flowControl=flowControl)
