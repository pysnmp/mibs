...
# Produced by pysmi-1.1.8 at Sat Jan 15 16:33:16 2022
...
Gauge32, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Unsigned32, Integer32, TimeTicks, iso, NotificationType, Counter64, IpAddress, Counter32, ModuleIdentity, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Unsigned32", "Integer32", "TimeTicks", "iso", "NotificationType", "Counter64", "IpAddress", "Counter32", "ModuleIdentity", "ObjectIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("CXR-TS-MIB", ts=ts, mode=mode, baudRate=baudRate, acctRad2=acctRad2, siteName=siteName, radiusServer2=radiusServer2, secondTcpPort=secondTcpPort, ipGateway=ipGateway, modbusType=modbusType, mainIpAddress=mainIpAddress, aliasIpNetmask=aliasIpNetmask, dtrDown=dtrDown, modbusEntry=modbusEntry, productName=productName, ftpdService=ftpdService, nameServer2=nameServer2, beforeSend=beforeSend, sessionStopped=sessionStopped, snmpTrapAddr1=snmpTrapAddr1, radiusSecret2=radiusSecret2, snmpTrapAddr2=snmpTrapAddr2, portStatsTable=portStatsTable, nameResolution=nameResolution, flowControl=flowControl, radiusSecret1=radiusSecret1, timeoutRxTx=timeoutRxTx, cxr=cxr, ipNetmask=ipNetmask, bootp=bootp, secondGateway=secondGateway, modbusTable=modbusTable, slaveHexaAddress=slaveHexaAddress, resetByButton=resetByButton, interFrame=interFrame, nbParStop=nbParStop, aliasIpAddress=aliasIpAddress, multiSession=multiSession, dtrUp=dtrUp, portEntry=portEntry, version=version, portReset=portReset, txIdle=txIdle, bytesReceiveFromV24=bytesReceiveFromV24, modbusMode=modbusMode, acctRad1=acctRad1, sessionStarted=sessionStarted, snmpTrap=snmpTrap, authType=authType, remoteTcpPort=remoteTcpPort, endMsg=endMsg, ethernetAddress=ethernetAddress, statusDTR=statusDTR, portTable=portTable, formFeed=formFeed, system=system, gatewayToRemote=gatewayToRemote, slaveIPaddr=slaveIPaddr, timeoutPAD=timeoutPAD, nameServer1=nameServer1, slaveIPport=slaveIPport, reset=reset, radiusServer1=radiusServer1, terminalType=terminalType, rxIdle=rxIdle, secondIpAddress=secondIpAddress, portStatsEntry=portStatsEntry, authRad1=authRad1, authRad2=authRad2, remoteIpAddress=remoteIpAddress, bytesSendToV24=bytesSendToV24, portIndex=portIndex, tcpPort=tcpPort, ipServer=ipServer, afterSend=afterSend, telnetdService=telnetdService, snmpdService=snmpdService, httpdService=httpdService)
