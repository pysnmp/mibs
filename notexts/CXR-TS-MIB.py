...
# Produced by pysmi-1.1.10 at Thu Apr  4 03:04:53 2024
...
ModuleIdentity, ObjectIdentity, Gauge32, Unsigned32, Counter64, Bits, Integer32, NotificationType, MibIdentifier, IpAddress, NotificationType, TimeTicks, Counter32, enterprises, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "Gauge32", "Unsigned32", "Counter64", "Bits", "Integer32", "NotificationType", "MibIdentifier", "IpAddress", "NotificationType", "TimeTicks", "Counter32", "enterprises", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CXR-TS-MIB", ethernetAddress=ethernetAddress, nbParStop=nbParStop, secondIpAddress=secondIpAddress, bytesSendToV24=bytesSendToV24, ts=ts, ftpdService=ftpdService, beforeSend=beforeSend, portStatsEntry=portStatsEntry, secondGateway=secondGateway, httpdService=httpdService, ipNetmask=ipNetmask, dtrUp=dtrUp, sessionStopped=sessionStopped, mode=mode, portReset=portReset, sessionStarted=sessionStarted, nameResolution=nameResolution, bootp=bootp, timeoutRxTx=timeoutRxTx, flowControl=flowControl, snmpTrapAddr1=snmpTrapAddr1, secondTcpPort=secondTcpPort, gatewayToRemote=gatewayToRemote, snmpTrap=snmpTrap, acctRad2=acctRad2, siteName=siteName, snmpTrapAddr2=snmpTrapAddr2, slaveIPaddr=slaveIPaddr, multiSession=multiSession, ipServer=ipServer, txIdle=txIdle, telnetdService=telnetdService, portTable=portTable, remoteIpAddress=remoteIpAddress, acctRad1=acctRad1, modbusType=modbusType, authRad2=authRad2, productName=productName, endMsg=endMsg, dtrDown=dtrDown, interFrame=interFrame, afterSend=afterSend, cxr=cxr, radiusSecret1=radiusSecret1, portStatsTable=portStatsTable, formFeed=formFeed, timeoutPAD=timeoutPAD, mainIpAddress=mainIpAddress, system=system, resetByButton=resetByButton, nameServer2=nameServer2, radiusServer2=radiusServer2, statusDTR=statusDTR, modbusMode=modbusMode, authRad1=authRad1, slaveHexaAddress=slaveHexaAddress, nameServer1=nameServer1, modbusEntry=modbusEntry, modbusTable=modbusTable, aliasIpAddress=aliasIpAddress, portIndex=portIndex, baudRate=baudRate, radiusSecret2=radiusSecret2, portEntry=portEntry, remoteTcpPort=remoteTcpPort, bytesReceiveFromV24=bytesReceiveFromV24, radiusServer1=radiusServer1, tcpPort=tcpPort, rxIdle=rxIdle, snmpdService=snmpdService, ipGateway=ipGateway, authType=authType, version=version, slaveIPport=slaveIPport, aliasIpNetmask=aliasIpNetmask, reset=reset, terminalType=terminalType)
