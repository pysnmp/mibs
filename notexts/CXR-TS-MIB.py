...
# Produced by pysmi-1.1.8 at Mon Jan  2 13:18:10 2023
...
NotificationType, NotificationType, Gauge32, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, enterprises, Unsigned32, iso, Counter64, Counter32, TimeTicks, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "NotificationType", "Gauge32", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "enterprises", "Unsigned32", "iso", "Counter64", "Counter32", "TimeTicks", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("CXR-TS-MIB", system=system, telnetdService=telnetdService, radiusServer2=radiusServer2, statusDTR=statusDTR, tcpPort=tcpPort, version=version, formFeed=formFeed, secondIpAddress=secondIpAddress, radiusServer1=radiusServer1, dtrUp=dtrUp, slaveIPaddr=slaveIPaddr, endMsg=endMsg, modbusTable=modbusTable, authType=authType, remoteIpAddress=remoteIpAddress, snmpdService=snmpdService, timeoutRxTx=timeoutRxTx, modbusMode=modbusMode, ipNetmask=ipNetmask, gatewayToRemote=gatewayToRemote, ipServer=ipServer, baudRate=baudRate, afterSend=afterSend, snmpTrapAddr2=snmpTrapAddr2, reset=reset, bytesSendToV24=bytesSendToV24, portStatsEntry=portStatsEntry, bytesReceiveFromV24=bytesReceiveFromV24, aliasIpNetmask=aliasIpNetmask, snmpTrapAddr1=snmpTrapAddr1, multiSession=multiSession, nbParStop=nbParStop, acctRad1=acctRad1, interFrame=interFrame, flowControl=flowControl, productName=productName, authRad2=authRad2, portReset=portReset, mainIpAddress=mainIpAddress, slaveHexaAddress=slaveHexaAddress, cxr=cxr, portEntry=portEntry, ipGateway=ipGateway, modbusType=modbusType, modbusEntry=modbusEntry, nameServer1=nameServer1, radiusSecret2=radiusSecret2, secondGateway=secondGateway, resetByButton=resetByButton, siteName=siteName, terminalType=terminalType, rxIdle=rxIdle, bootp=bootp, ts=ts, ftpdService=ftpdService, acctRad2=acctRad2, authRad1=authRad1, aliasIpAddress=aliasIpAddress, ethernetAddress=ethernetAddress, portIndex=portIndex, secondTcpPort=secondTcpPort, portStatsTable=portStatsTable, httpdService=httpdService, slaveIPport=slaveIPport, radiusSecret1=radiusSecret1, mode=mode, nameServer2=nameServer2, nameResolution=nameResolution, sessionStopped=sessionStopped, sessionStarted=sessionStarted, portTable=portTable, snmpTrap=snmpTrap, dtrDown=dtrDown, beforeSend=beforeSend, timeoutPAD=timeoutPAD, txIdle=txIdle, remoteTcpPort=remoteTcpPort)
