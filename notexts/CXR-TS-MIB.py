...
# Produced by pysmi-1.1.8 at Thu Oct 26 12:10:06 2023
...
Gauge32, Counter64, MibIdentifier, iso, Bits, Counter32, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, IpAddress, ModuleIdentity, TimeTicks, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "MibIdentifier", "iso", "Bits", "Counter32", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "IpAddress", "ModuleIdentity", "TimeTicks", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("CXR-TS-MIB", nameServer1=nameServer1, tcpPort=tcpPort, snmpTrapAddr2=snmpTrapAddr2, gatewayToRemote=gatewayToRemote, mainIpAddress=mainIpAddress, ipGateway=ipGateway, timeoutRxTx=timeoutRxTx, nbParStop=nbParStop, radiusServer1=radiusServer1, radiusSecret1=radiusSecret1, ethernetAddress=ethernetAddress, authRad2=authRad2, endMsg=endMsg, sessionStopped=sessionStopped, dtrDown=dtrDown, baudRate=baudRate, modbusType=modbusType, ipServer=ipServer, version=version, timeoutPAD=timeoutPAD, afterSend=afterSend, portReset=portReset, secondTcpPort=secondTcpPort, statusDTR=statusDTR, telnetdService=telnetdService, mode=mode, bytesSendToV24=bytesSendToV24, resetByButton=resetByButton, modbusTable=modbusTable, ftpdService=ftpdService, system=system, siteName=siteName, flowControl=flowControl, remoteTcpPort=remoteTcpPort, httpdService=httpdService, dtrUp=dtrUp, remoteIpAddress=remoteIpAddress, nameServer2=nameServer2, secondIpAddress=secondIpAddress, snmpTrap=snmpTrap, radiusServer2=radiusServer2, formFeed=formFeed, interFrame=interFrame, ts=ts, slaveHexaAddress=slaveHexaAddress, bytesReceiveFromV24=bytesReceiveFromV24, portTable=portTable, nameResolution=nameResolution, terminalType=terminalType, portStatsTable=portStatsTable, aliasIpNetmask=aliasIpNetmask, portIndex=portIndex, authRad1=authRad1, productName=productName, rxIdle=rxIdle, modbusMode=modbusMode, txIdle=txIdle, radiusSecret2=radiusSecret2, aliasIpAddress=aliasIpAddress, acctRad1=acctRad1, reset=reset, secondGateway=secondGateway, beforeSend=beforeSend, bootp=bootp, slaveIPaddr=slaveIPaddr, snmpdService=snmpdService, cxr=cxr, snmpTrapAddr1=snmpTrapAddr1, portEntry=portEntry, acctRad2=acctRad2, ipNetmask=ipNetmask, modbusEntry=modbusEntry, multiSession=multiSession, sessionStarted=sessionStarted, slaveIPport=slaveIPport, authType=authType, portStatsEntry=portStatsEntry)
