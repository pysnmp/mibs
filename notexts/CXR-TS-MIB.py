...
# Produced by pysmi-1.1.8 at Sun Jan 16 00:56:41 2022
...
Bits, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, iso, Counter64, IpAddress, NotificationType, Integer32, ModuleIdentity, enterprises, MibIdentifier, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "iso", "Counter64", "IpAddress", "NotificationType", "Integer32", "ModuleIdentity", "enterprises", "MibIdentifier", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("CXR-TS-MIB", acctRad2=acctRad2, remoteTcpPort=remoteTcpPort, dtrUp=dtrUp, authRad2=authRad2, radiusServer2=radiusServer2, tcpPort=tcpPort, radiusSecret1=radiusSecret1, timeoutRxTx=timeoutRxTx, gatewayToRemote=gatewayToRemote, snmpTrap=snmpTrap, telnetdService=telnetdService, slaveHexaAddress=slaveHexaAddress, snmpTrapAddr2=snmpTrapAddr2, modbusTable=modbusTable, portTable=portTable, timeoutPAD=timeoutPAD, rxIdle=rxIdle, acctRad1=acctRad1, bytesReceiveFromV24=bytesReceiveFromV24, formFeed=formFeed, resetByButton=resetByButton, mode=mode, authRad1=authRad1, authType=authType, endMsg=endMsg, slaveIPaddr=slaveIPaddr, terminalType=terminalType, snmpdService=snmpdService, siteName=siteName, txIdle=txIdle, snmpTrapAddr1=snmpTrapAddr1, beforeSend=beforeSend, ethernetAddress=ethernetAddress, bootp=bootp, sessionStopped=sessionStopped, portStatsEntry=portStatsEntry, version=version, radiusSecret2=radiusSecret2, modbusType=modbusType, baudRate=baudRate, aliasIpAddress=aliasIpAddress, cxr=cxr, modbusMode=modbusMode, portStatsTable=portStatsTable, ts=ts, reset=reset, nbParStop=nbParStop, multiSession=multiSession, portReset=portReset, secondGateway=secondGateway, portIndex=portIndex, radiusServer1=radiusServer1, nameServer1=nameServer1, slaveIPport=slaveIPport, secondIpAddress=secondIpAddress, system=system, remoteIpAddress=remoteIpAddress, httpdService=httpdService, sessionStarted=sessionStarted, portEntry=portEntry, ipNetmask=ipNetmask, nameResolution=nameResolution, secondTcpPort=secondTcpPort, ipServer=ipServer, afterSend=afterSend, ftpdService=ftpdService, statusDTR=statusDTR, flowControl=flowControl, modbusEntry=modbusEntry, dtrDown=dtrDown, interFrame=interFrame, ipGateway=ipGateway, mainIpAddress=mainIpAddress, nameServer2=nameServer2, bytesSendToV24=bytesSendToV24, productName=productName, aliasIpNetmask=aliasIpNetmask)
