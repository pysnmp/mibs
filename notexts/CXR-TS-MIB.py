...
# Produced by pysmi-1.1.8 at Thu Jan  5 10:15:40 2023
...
MibIdentifier, iso, IpAddress, NotificationType, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, Gauge32, Unsigned32, ObjectIdentity, TimeTicks, enterprises, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "IpAddress", "NotificationType", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "Gauge32", "Unsigned32", "ObjectIdentity", "TimeTicks", "enterprises", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", snmpdService=snmpdService, dtrUp=dtrUp, dtrDown=dtrDown, nameServer1=nameServer1, ts=ts, ftpdService=ftpdService, ipNetmask=ipNetmask, txIdle=txIdle, aliasIpNetmask=aliasIpNetmask, rxIdle=rxIdle, resetByButton=resetByButton, beforeSend=beforeSend, radiusSecret1=radiusSecret1, snmpTrapAddr2=snmpTrapAddr2, secondGateway=secondGateway, snmpTrap=snmpTrap, acctRad2=acctRad2, portEntry=portEntry, system=system, portIndex=portIndex, nameServer2=nameServer2, modbusMode=modbusMode, slaveHexaAddress=slaveHexaAddress, sessionStarted=sessionStarted, bytesSendToV24=bytesSendToV24, acctRad1=acctRad1, mode=mode, radiusServer1=radiusServer1, authType=authType, radiusSecret2=radiusSecret2, mainIpAddress=mainIpAddress, endMsg=endMsg, cxr=cxr, portTable=portTable, aliasIpAddress=aliasIpAddress, formFeed=formFeed, authRad1=authRad1, bytesReceiveFromV24=bytesReceiveFromV24, portStatsTable=portStatsTable, remoteIpAddress=remoteIpAddress, multiSession=multiSession, nbParStop=nbParStop, authRad2=authRad2, radiusServer2=radiusServer2, version=version, flowControl=flowControl, slaveIPaddr=slaveIPaddr, timeoutRxTx=timeoutRxTx, ipGateway=ipGateway, siteName=siteName, ethernetAddress=ethernetAddress, secondTcpPort=secondTcpPort, interFrame=interFrame, nameResolution=nameResolution, bootp=bootp, reset=reset, timeoutPAD=timeoutPAD, snmpTrapAddr1=snmpTrapAddr1, modbusEntry=modbusEntry, productName=productName, slaveIPport=slaveIPport, remoteTcpPort=remoteTcpPort, gatewayToRemote=gatewayToRemote, afterSend=afterSend, portStatsEntry=portStatsEntry, modbusTable=modbusTable, ipServer=ipServer, baudRate=baudRate, httpdService=httpdService, terminalType=terminalType, secondIpAddress=secondIpAddress, sessionStopped=sessionStopped, modbusType=modbusType, tcpPort=tcpPort, statusDTR=statusDTR, portReset=portReset, telnetdService=telnetdService)
