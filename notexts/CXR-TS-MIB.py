...
# Produced by pysmi-1.1.8 at Tue Aug  9 15:10:41 2022
...
ObjectIdentity, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, enterprises, Counter32, IpAddress, Counter64, ModuleIdentity, Unsigned32, NotificationType, TimeTicks, MibIdentifier, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "enterprises", "Counter32", "IpAddress", "Counter64", "ModuleIdentity", "Unsigned32", "NotificationType", "TimeTicks", "MibIdentifier", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", sessionStopped=sessionStopped, remoteIpAddress=remoteIpAddress, nameResolution=nameResolution, portReset=portReset, ipNetmask=ipNetmask, ethernetAddress=ethernetAddress, acctRad2=acctRad2, nameServer1=nameServer1, endMsg=endMsg, portEntry=portEntry, ftpdService=ftpdService, portStatsEntry=portStatsEntry, bytesReceiveFromV24=bytesReceiveFromV24, radiusSecret1=radiusSecret1, secondIpAddress=secondIpAddress, modbusTable=modbusTable, telnetdService=telnetdService, nameServer2=nameServer2, snmpTrapAddr2=snmpTrapAddr2, portStatsTable=portStatsTable, secondGateway=secondGateway, portIndex=portIndex, modbusMode=modbusMode, formFeed=formFeed, baudRate=baudRate, aliasIpNetmask=aliasIpNetmask, resetByButton=resetByButton, ipServer=ipServer, radiusServer2=radiusServer2, modbusType=modbusType, reset=reset, nbParStop=nbParStop, tcpPort=tcpPort, terminalType=terminalType, secondTcpPort=secondTcpPort, statusDTR=statusDTR, slaveIPport=slaveIPport, timeoutRxTx=timeoutRxTx, authRad1=authRad1, txIdle=txIdle, modbusEntry=modbusEntry, mode=mode, dtrUp=dtrUp, snmpdService=snmpdService, productName=productName, ipGateway=ipGateway, afterSend=afterSend, bootp=bootp, cxr=cxr, interFrame=interFrame, multiSession=multiSession, siteName=siteName, beforeSend=beforeSend, dtrDown=dtrDown, acctRad1=acctRad1, slaveHexaAddress=slaveHexaAddress, aliasIpAddress=aliasIpAddress, sessionStarted=sessionStarted, radiusSecret2=radiusSecret2, system=system, gatewayToRemote=gatewayToRemote, httpdService=httpdService, remoteTcpPort=remoteTcpPort, radiusServer1=radiusServer1, version=version, portTable=portTable, snmpTrapAddr1=snmpTrapAddr1, rxIdle=rxIdle, slaveIPaddr=slaveIPaddr, timeoutPAD=timeoutPAD, mainIpAddress=mainIpAddress, authType=authType, authRad2=authRad2, snmpTrap=snmpTrap, flowControl=flowControl, ts=ts, bytesSendToV24=bytesSendToV24)
