...
# Produced by pysmi-1.1.8 at Mon Jan 17 09:57:23 2022
...
MibIdentifier, Bits, TimeTicks, ObjectIdentity, ModuleIdentity, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, NotificationType, IpAddress, enterprises, NotificationType, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "NotificationType", "IpAddress", "enterprises", "NotificationType", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("CXR-TS-MIB", portReset=portReset, portStatsTable=portStatsTable, tcpPort=tcpPort, modbusMode=modbusMode, secondGateway=secondGateway, aliasIpNetmask=aliasIpNetmask, dtrDown=dtrDown, remoteIpAddress=remoteIpAddress, acctRad1=acctRad1, beforeSend=beforeSend, timeoutRxTx=timeoutRxTx, resetByButton=resetByButton, productName=productName, radiusSecret1=radiusSecret1, dtrUp=dtrUp, ipNetmask=ipNetmask, authRad1=authRad1, slaveIPport=slaveIPport, authType=authType, mainIpAddress=mainIpAddress, version=version, bytesReceiveFromV24=bytesReceiveFromV24, multiSession=multiSession, snmpTrapAddr1=snmpTrapAddr1, ipServer=ipServer, endMsg=endMsg, terminalType=terminalType, modbusEntry=modbusEntry, snmpTrapAddr2=snmpTrapAddr2, siteName=siteName, nbParStop=nbParStop, timeoutPAD=timeoutPAD, formFeed=formFeed, radiusServer2=radiusServer2, authRad2=authRad2, nameServer2=nameServer2, txIdle=txIdle, modbusType=modbusType, nameServer1=nameServer1, reset=reset, httpdService=httpdService, baudRate=baudRate, telnetdService=telnetdService, ts=ts, sessionStarted=sessionStarted, ipGateway=ipGateway, radiusServer1=radiusServer1, interFrame=interFrame, snmpTrap=snmpTrap, system=system, afterSend=afterSend, modbusTable=modbusTable, portEntry=portEntry, acctRad2=acctRad2, bytesSendToV24=bytesSendToV24, snmpdService=snmpdService, ftpdService=ftpdService, sessionStopped=sessionStopped, secondTcpPort=secondTcpPort, ethernetAddress=ethernetAddress, portTable=portTable, portStatsEntry=portStatsEntry, statusDTR=statusDTR, slaveIPaddr=slaveIPaddr, mode=mode, portIndex=portIndex, slaveHexaAddress=slaveHexaAddress, aliasIpAddress=aliasIpAddress, nameResolution=nameResolution, flowControl=flowControl, bootp=bootp, cxr=cxr, radiusSecret2=radiusSecret2, gatewayToRemote=gatewayToRemote, remoteTcpPort=remoteTcpPort, rxIdle=rxIdle, secondIpAddress=secondIpAddress)
