...
# Produced by pysmi-1.1.8 at Fri Jul  8 07:35:41 2022
...
Integer32, Bits, enterprises, TimeTicks, Counter64, Gauge32, Counter32, MibIdentifier, Unsigned32, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, NotificationType, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "enterprises", "TimeTicks", "Counter64", "Gauge32", "Counter32", "MibIdentifier", "Unsigned32", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "NotificationType", "iso", "ObjectIdentity")
...
mibBuilder.exportSymbols("CXR-TS-MIB", radiusSecret1=radiusSecret1, telnetdService=telnetdService, remoteTcpPort=remoteTcpPort, portStatsEntry=portStatsEntry, rxIdle=rxIdle, radiusSecret2=radiusSecret2, secondTcpPort=secondTcpPort, portEntry=portEntry, bytesReceiveFromV24=bytesReceiveFromV24, ts=ts, radiusServer2=radiusServer2, modbusType=modbusType, resetByButton=resetByButton, modbusMode=modbusMode, slaveIPaddr=slaveIPaddr, afterSend=afterSend, dtrUp=dtrUp, slaveHexaAddress=slaveHexaAddress, gatewayToRemote=gatewayToRemote, ftpdService=ftpdService, endMsg=endMsg, bootp=bootp, secondIpAddress=secondIpAddress, acctRad1=acctRad1, snmpTrapAddr1=snmpTrapAddr1, slaveIPport=slaveIPport, multiSession=multiSession, mainIpAddress=mainIpAddress, snmpTrap=snmpTrap, acctRad2=acctRad2, aliasIpNetmask=aliasIpNetmask, cxr=cxr, system=system, radiusServer1=radiusServer1, dtrDown=dtrDown, ethernetAddress=ethernetAddress, txIdle=txIdle, siteName=siteName, nbParStop=nbParStop, sessionStarted=sessionStarted, terminalType=terminalType, tcpPort=tcpPort, baudRate=baudRate, portTable=portTable, aliasIpAddress=aliasIpAddress, sessionStopped=sessionStopped, nameResolution=nameResolution, timeoutPAD=timeoutPAD, remoteIpAddress=remoteIpAddress, reset=reset, authRad1=authRad1, ipServer=ipServer, portStatsTable=portStatsTable, httpdService=httpdService, portIndex=portIndex, nameServer1=nameServer1, snmpdService=snmpdService, interFrame=interFrame, timeoutRxTx=timeoutRxTx, portReset=portReset, ipNetmask=ipNetmask, modbusTable=modbusTable, authRad2=authRad2, formFeed=formFeed, productName=productName, ipGateway=ipGateway, flowControl=flowControl, snmpTrapAddr2=snmpTrapAddr2, authType=authType, mode=mode, beforeSend=beforeSend, modbusEntry=modbusEntry, nameServer2=nameServer2, secondGateway=secondGateway, bytesSendToV24=bytesSendToV24, version=version, statusDTR=statusDTR)
