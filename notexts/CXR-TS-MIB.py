...
# Produced by pysmi-1.1.8 at Tue Jul 26 16:40:29 2022
...
iso, MibIdentifier, Counter64, ModuleIdentity, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, NotificationType, IpAddress, NotificationType, ObjectIdentity, Counter32, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "Counter64", "ModuleIdentity", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "NotificationType", "IpAddress", "NotificationType", "ObjectIdentity", "Counter32", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", gatewayToRemote=gatewayToRemote, bootp=bootp, baudRate=baudRate, slaveIPport=slaveIPport, multiSession=multiSession, interFrame=interFrame, version=version, portTable=portTable, reset=reset, ipGateway=ipGateway, httpdService=httpdService, snmpTrap=snmpTrap, ftpdService=ftpdService, formFeed=formFeed, modbusEntry=modbusEntry, secondGateway=secondGateway, portStatsTable=portStatsTable, radiusSecret1=radiusSecret1, mainIpAddress=mainIpAddress, resetByButton=resetByButton, slaveIPaddr=slaveIPaddr, snmpdService=snmpdService, snmpTrapAddr2=snmpTrapAddr2, beforeSend=beforeSend, siteName=siteName, modbusMode=modbusMode, productName=productName, tcpPort=tcpPort, modbusTable=modbusTable, authRad2=authRad2, txIdle=txIdle, cxr=cxr, rxIdle=rxIdle, radiusServer2=radiusServer2, statusDTR=statusDTR, acctRad2=acctRad2, timeoutRxTx=timeoutRxTx, aliasIpNetmask=aliasIpNetmask, ipServer=ipServer, portIndex=portIndex, sessionStopped=sessionStopped, bytesReceiveFromV24=bytesReceiveFromV24, flowControl=flowControl, acctRad1=acctRad1, mode=mode, ts=ts, dtrUp=dtrUp, remoteTcpPort=remoteTcpPort, portEntry=portEntry, endMsg=endMsg, bytesSendToV24=bytesSendToV24, authRad1=authRad1, dtrDown=dtrDown, radiusSecret2=radiusSecret2, ethernetAddress=ethernetAddress, telnetdService=telnetdService, secondTcpPort=secondTcpPort, terminalType=terminalType, nbParStop=nbParStop, portReset=portReset, ipNetmask=ipNetmask, remoteIpAddress=remoteIpAddress, afterSend=afterSend, radiusServer1=radiusServer1, timeoutPAD=timeoutPAD, portStatsEntry=portStatsEntry, system=system, sessionStarted=sessionStarted, aliasIpAddress=aliasIpAddress, authType=authType, nameResolution=nameResolution, slaveHexaAddress=slaveHexaAddress, nameServer2=nameServer2, secondIpAddress=secondIpAddress, snmpTrapAddr1=snmpTrapAddr1, nameServer1=nameServer1, modbusType=modbusType)
