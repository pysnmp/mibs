...
# Produced by pysmi-1.1.12 at Wed Jul  3 13:27:23 2024
...
NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, Unsigned32, Gauge32, Counter32, NotificationType, Counter64, enterprises, MibIdentifier, Bits, TimeTicks, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "Gauge32", "Counter32", "NotificationType", "Counter64", "enterprises", "MibIdentifier", "Bits", "TimeTicks", "Integer32", "iso")
...
mibBuilder.exportSymbols("CXR-TS-MIB", portReset=portReset, bytesReceiveFromV24=bytesReceiveFromV24, aliasIpAddress=aliasIpAddress, terminalType=terminalType, reset=reset, nbParStop=nbParStop, acctRad2=acctRad2, nameServer2=nameServer2, secondGateway=secondGateway, portIndex=portIndex, resetByButton=resetByButton, aliasIpNetmask=aliasIpNetmask, beforeSend=beforeSend, endMsg=endMsg, radiusServer2=radiusServer2, productName=productName, radiusSecret1=radiusSecret1, gatewayToRemote=gatewayToRemote, ethernetAddress=ethernetAddress, sessionStarted=sessionStarted, tcpPort=tcpPort, authRad2=authRad2, secondTcpPort=secondTcpPort, statusDTR=statusDTR, ts=ts, afterSend=afterSend, authType=authType, timeoutRxTx=timeoutRxTx, siteName=siteName, ipNetmask=ipNetmask, mainIpAddress=mainIpAddress, slaveIPaddr=slaveIPaddr, cxr=cxr, interFrame=interFrame, snmpdService=snmpdService, dtrDown=dtrDown, ipServer=ipServer, mode=mode, nameServer1=nameServer1, bootp=bootp, acctRad1=acctRad1, ftpdService=ftpdService, snmpTrapAddr1=snmpTrapAddr1, dtrUp=dtrUp, radiusServer1=radiusServer1, system=system, snmpTrapAddr2=snmpTrapAddr2, baudRate=baudRate, sessionStopped=sessionStopped, flowControl=flowControl, modbusTable=modbusTable, nameResolution=nameResolution, portTable=portTable, portStatsTable=portStatsTable, ipGateway=ipGateway, version=version, httpdService=httpdService, formFeed=formFeed, portStatsEntry=portStatsEntry, slaveHexaAddress=slaveHexaAddress, modbusMode=modbusMode, bytesSendToV24=bytesSendToV24, remoteIpAddress=remoteIpAddress, snmpTrap=snmpTrap, rxIdle=rxIdle, portEntry=portEntry, modbusEntry=modbusEntry, remoteTcpPort=remoteTcpPort, txIdle=txIdle, radiusSecret2=radiusSecret2, timeoutPAD=timeoutPAD, telnetdService=telnetdService, authRad1=authRad1, secondIpAddress=secondIpAddress, modbusType=modbusType, slaveIPport=slaveIPport, multiSession=multiSession)
