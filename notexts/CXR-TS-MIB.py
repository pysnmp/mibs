...
# Produced by pysmi-1.1.8 at Thu Feb  9 13:55:02 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, Counter32, NotificationType, Unsigned32, NotificationType, Gauge32, IpAddress, enterprises, ModuleIdentity, Counter64, Integer32, ObjectIdentity, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "Counter32", "NotificationType", "Unsigned32", "NotificationType", "Gauge32", "IpAddress", "enterprises", "ModuleIdentity", "Counter64", "Integer32", "ObjectIdentity", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("CXR-TS-MIB", authRad2=authRad2, sessionStarted=sessionStarted, multiSession=multiSession, mode=mode, remoteIpAddress=remoteIpAddress, reset=reset, slaveIPaddr=slaveIPaddr, timeoutPAD=timeoutPAD, dtrUp=dtrUp, resetByButton=resetByButton, authRad1=authRad1, acctRad1=acctRad1, ipNetmask=ipNetmask, radiusServer1=radiusServer1, radiusSecret1=radiusSecret1, siteName=siteName, nameResolution=nameResolution, snmpTrap=snmpTrap, portIndex=portIndex, telnetdService=telnetdService, ftpdService=ftpdService, modbusTable=modbusTable, productName=productName, afterSend=afterSend, aliasIpAddress=aliasIpAddress, radiusSecret2=radiusSecret2, modbusType=modbusType, modbusMode=modbusMode, timeoutRxTx=timeoutRxTx, portReset=portReset, endMsg=endMsg, httpdService=httpdService, nbParStop=nbParStop, snmpTrapAddr2=snmpTrapAddr2, acctRad2=acctRad2, statusDTR=statusDTR, sessionStopped=sessionStopped, beforeSend=beforeSend, modbusEntry=modbusEntry, formFeed=formFeed, slaveIPport=slaveIPport, slaveHexaAddress=slaveHexaAddress, ipGateway=ipGateway, nameServer1=nameServer1, ipServer=ipServer, system=system, bytesSendToV24=bytesSendToV24, secondTcpPort=secondTcpPort, ts=ts, portStatsEntry=portStatsEntry, portTable=portTable, txIdle=txIdle, aliasIpNetmask=aliasIpNetmask, secondGateway=secondGateway, bootp=bootp, snmpdService=snmpdService, dtrDown=dtrDown, radiusServer2=radiusServer2, bytesReceiveFromV24=bytesReceiveFromV24, nameServer2=nameServer2, version=version, interFrame=interFrame, baudRate=baudRate, snmpTrapAddr1=snmpTrapAddr1, secondIpAddress=secondIpAddress, remoteTcpPort=remoteTcpPort, ethernetAddress=ethernetAddress, tcpPort=tcpPort, authType=authType, mainIpAddress=mainIpAddress, cxr=cxr, portEntry=portEntry, rxIdle=rxIdle, flowControl=flowControl, portStatsTable=portStatsTable, terminalType=terminalType, gatewayToRemote=gatewayToRemote)
