...
Bits, IpAddress, NotificationType, Gauge32, Counter64, ModuleIdentity, Unsigned32, iso, NotificationType, MibIdentifier, ObjectIdentity, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "NotificationType", "Gauge32", "Counter64", "ModuleIdentity", "Unsigned32", "iso", "NotificationType", "MibIdentifier", "ObjectIdentity", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("CXR-TS-MIB", nbParStop=nbParStop, nameServer1=nameServer1, slaveHexaAddress=slaveHexaAddress, radiusSecret2=radiusSecret2, remoteTcpPort=remoteTcpPort, acctRad2=acctRad2, radiusSecret1=radiusSecret1, secondIpAddress=secondIpAddress, afterSend=afterSend, httpdService=httpdService, multiSession=multiSession, sessionStarted=sessionStarted, txIdle=txIdle, siteName=siteName, ftpdService=ftpdService, system=system, modbusMode=modbusMode, aliasIpNetmask=aliasIpNetmask, rxIdle=rxIdle, dtrDown=dtrDown, terminalType=terminalType, portIndex=portIndex, modbusTable=modbusTable, dtrUp=dtrUp, resetByButton=resetByButton, remoteIpAddress=remoteIpAddress, portEntry=portEntry, modbusType=modbusType, gatewayToRemote=gatewayToRemote, version=version, timeoutPAD=timeoutPAD, timeoutRxTx=timeoutRxTx, portReset=portReset, productName=productName, ipGateway=ipGateway, secondGateway=secondGateway, acctRad1=acctRad1, mainIpAddress=mainIpAddress, modbusEntry=modbusEntry, authType=authType, slaveIPport=slaveIPport, endMsg=endMsg, nameResolution=nameResolution, bytesSendToV24=bytesSendToV24, radiusServer1=radiusServer1, portTable=portTable, statusDTR=statusDTR, bootp=bootp, ts=ts, tcpPort=tcpPort, reset=reset, ethernetAddress=ethernetAddress, baudRate=baudRate, telnetdService=telnetdService, snmpTrapAddr2=snmpTrapAddr2, authRad2=authRad2, formFeed=formFeed, secondTcpPort=secondTcpPort, sessionStopped=sessionStopped, snmpTrapAddr1=snmpTrapAddr1, mode=mode, portStatsTable=portStatsTable, flowControl=flowControl, portStatsEntry=portStatsEntry, slaveIPaddr=slaveIPaddr, aliasIpAddress=aliasIpAddress, nameServer2=nameServer2, interFrame=interFrame, ipNetmask=ipNetmask, beforeSend=beforeSend, authRad1=authRad1, snmpTrap=snmpTrap, radiusServer2=radiusServer2, cxr=cxr, ipServer=ipServer, bytesReceiveFromV24=bytesReceiveFromV24, snmpdService=snmpdService)
