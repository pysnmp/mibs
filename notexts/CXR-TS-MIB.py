...
# Produced by pysmi-1.1.12 at Mon Jul  1 09:17:42 2024
...
Gauge32, ModuleIdentity, Counter64, NotificationType, MibIdentifier, enterprises, Integer32, TimeTicks, IpAddress, Counter32, iso, ObjectIdentity, Unsigned32, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "Counter64", "NotificationType", "MibIdentifier", "enterprises", "Integer32", "TimeTicks", "IpAddress", "Counter32", "iso", "ObjectIdentity", "Unsigned32", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CXR-TS-MIB", radiusServer1=radiusServer1, nameResolution=nameResolution, interFrame=interFrame, gatewayToRemote=gatewayToRemote, portIndex=portIndex, radiusServer2=radiusServer2, rxIdle=rxIdle, bytesReceiveFromV24=bytesReceiveFromV24, ethernetAddress=ethernetAddress, remoteIpAddress=remoteIpAddress, cxr=cxr, siteName=siteName, resetByButton=resetByButton, portStatsEntry=portStatsEntry, modbusType=modbusType, dtrDown=dtrDown, snmpTrap=snmpTrap, version=version, nameServer2=nameServer2, aliasIpAddress=aliasIpAddress, ipNetmask=ipNetmask, tcpPort=tcpPort, modbusEntry=modbusEntry, slaveIPport=slaveIPport, sessionStopped=sessionStopped, secondTcpPort=secondTcpPort, acctRad2=acctRad2, timeoutPAD=timeoutPAD, modbusTable=modbusTable, bootp=bootp, sessionStarted=sessionStarted, portStatsTable=portStatsTable, slaveIPaddr=slaveIPaddr, authType=authType, aliasIpNetmask=aliasIpNetmask, radiusSecret1=radiusSecret1, system=system, timeoutRxTx=timeoutRxTx, ftpdService=ftpdService, baudRate=baudRate, dtrUp=dtrUp, portTable=portTable, remoteTcpPort=remoteTcpPort, httpdService=httpdService, multiSession=multiSession, snmpTrapAddr1=snmpTrapAddr1, secondIpAddress=secondIpAddress, slaveHexaAddress=slaveHexaAddress, beforeSend=beforeSend, telnetdService=telnetdService, reset=reset, authRad1=authRad1, productName=productName, nbParStop=nbParStop, mainIpAddress=mainIpAddress, formFeed=formFeed, ipServer=ipServer, afterSend=afterSend, ts=ts, nameServer1=nameServer1, ipGateway=ipGateway, authRad2=authRad2, bytesSendToV24=bytesSendToV24, radiusSecret2=radiusSecret2, snmpTrapAddr2=snmpTrapAddr2, mode=mode, statusDTR=statusDTR, acctRad1=acctRad1, txIdle=txIdle, snmpdService=snmpdService, terminalType=terminalType, endMsg=endMsg, portReset=portReset, flowControl=flowControl, modbusMode=modbusMode, portEntry=portEntry, secondGateway=secondGateway)
