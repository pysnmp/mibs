...
# Produced by pysmi-1.1.8 at Thu Sep 29 13:05:54 2022
...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, Counter32, iso, enterprises, TimeTicks, Unsigned32, NotificationType, Integer32, Gauge32, NotificationType, Bits, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "Counter32", "iso", "enterprises", "TimeTicks", "Unsigned32", "NotificationType", "Integer32", "Gauge32", "NotificationType", "Bits", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("CXR-TS-MIB", nameServer1=nameServer1, modbusTable=modbusTable, rxIdle=rxIdle, snmpTrap=snmpTrap, aliasIpAddress=aliasIpAddress, nameServer2=nameServer2, baudRate=baudRate, timeoutRxTx=timeoutRxTx, txIdle=txIdle, cxr=cxr, bootp=bootp, portIndex=portIndex, acctRad1=acctRad1, sessionStopped=sessionStopped, terminalType=terminalType, version=version, endMsg=endMsg, ethernetAddress=ethernetAddress, nbParStop=nbParStop, nameResolution=nameResolution, multiSession=multiSession, system=system, dtrUp=dtrUp, aliasIpNetmask=aliasIpNetmask, portEntry=portEntry, authType=authType, modbusEntry=modbusEntry, statusDTR=statusDTR, timeoutPAD=timeoutPAD, beforeSend=beforeSend, gatewayToRemote=gatewayToRemote, ipNetmask=ipNetmask, formFeed=formFeed, radiusSecret1=radiusSecret1, authRad2=authRad2, snmpdService=snmpdService, ts=ts, modbusType=modbusType, ipServer=ipServer, portReset=portReset, snmpTrapAddr2=snmpTrapAddr2, snmpTrapAddr1=snmpTrapAddr1, modbusMode=modbusMode, ipGateway=ipGateway, productName=productName, mode=mode, bytesSendToV24=bytesSendToV24, bytesReceiveFromV24=bytesReceiveFromV24, authRad1=authRad1, flowControl=flowControl, radiusSecret2=radiusSecret2, siteName=siteName, remoteTcpPort=remoteTcpPort, telnetdService=telnetdService, slaveIPport=slaveIPport, interFrame=interFrame, secondGateway=secondGateway, portStatsTable=portStatsTable, ftpdService=ftpdService, afterSend=afterSend, radiusServer2=radiusServer2, slaveHexaAddress=slaveHexaAddress, dtrDown=dtrDown, secondIpAddress=secondIpAddress, resetByButton=resetByButton, remoteIpAddress=remoteIpAddress, acctRad2=acctRad2, slaveIPaddr=slaveIPaddr, mainIpAddress=mainIpAddress, tcpPort=tcpPort, secondTcpPort=secondTcpPort, portTable=portTable, httpdService=httpdService, sessionStarted=sessionStarted, reset=reset, radiusServer1=radiusServer1, portStatsEntry=portStatsEntry)
