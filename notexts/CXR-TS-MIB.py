...
# Produced by pysmi-1.1.8 at Mon Jan  2 13:48:03 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, Unsigned32, Counter32, Integer32, Bits, Gauge32, ObjectIdentity, IpAddress, iso, MibIdentifier, NotificationType, enterprises, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "Unsigned32", "Counter32", "Integer32", "Bits", "Gauge32", "ObjectIdentity", "IpAddress", "iso", "MibIdentifier", "NotificationType", "enterprises", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("CXR-TS-MIB", mainIpAddress=mainIpAddress, ipServer=ipServer, dtrUp=dtrUp, nameResolution=nameResolution, reset=reset, txIdle=txIdle, rxIdle=rxIdle, secondTcpPort=secondTcpPort, modbusMode=modbusMode, bytesSendToV24=bytesSendToV24, snmpTrap=snmpTrap, version=version, modbusEntry=modbusEntry, modbusTable=modbusTable, flowControl=flowControl, timeoutRxTx=timeoutRxTx, productName=productName, tcpPort=tcpPort, ipNetmask=ipNetmask, formFeed=formFeed, sessionStarted=sessionStarted, remoteTcpPort=remoteTcpPort, terminalType=terminalType, radiusServer1=radiusServer1, secondIpAddress=secondIpAddress, nameServer2=nameServer2, authType=authType, baudRate=baudRate, statusDTR=statusDTR, authRad1=authRad1, afterSend=afterSend, dtrDown=dtrDown, acctRad1=acctRad1, portEntry=portEntry, gatewayToRemote=gatewayToRemote, portReset=portReset, ethernetAddress=ethernetAddress, snmpdService=snmpdService, resetByButton=resetByButton, snmpTrapAddr2=snmpTrapAddr2, radiusSecret2=radiusSecret2, nbParStop=nbParStop, slaveIPport=slaveIPport, bytesReceiveFromV24=bytesReceiveFromV24, ftpdService=ftpdService, aliasIpAddress=aliasIpAddress, acctRad2=acctRad2, telnetdService=telnetdService, remoteIpAddress=remoteIpAddress, ipGateway=ipGateway, aliasIpNetmask=aliasIpNetmask, slaveHexaAddress=slaveHexaAddress, nameServer1=nameServer1, timeoutPAD=timeoutPAD, portStatsEntry=portStatsEntry, siteName=siteName, portStatsTable=portStatsTable, ts=ts, portIndex=portIndex, authRad2=authRad2, cxr=cxr, bootp=bootp, radiusSecret1=radiusSecret1, interFrame=interFrame, radiusServer2=radiusServer2, sessionStopped=sessionStopped, beforeSend=beforeSend, modbusType=modbusType, mode=mode, httpdService=httpdService, portTable=portTable, snmpTrapAddr1=snmpTrapAddr1, endMsg=endMsg, multiSession=multiSession, system=system, slaveIPaddr=slaveIPaddr, secondGateway=secondGateway)
