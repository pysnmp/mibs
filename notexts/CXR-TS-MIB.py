...
# Produced by pysmi-1.1.8 at Sat Jan 15 23:22:32 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, enterprises, Counter64, NotificationType, Gauge32, Integer32, IpAddress, ModuleIdentity, iso, MibIdentifier, Counter32, NotificationType, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "enterprises", "Counter64", "NotificationType", "Gauge32", "Integer32", "IpAddress", "ModuleIdentity", "iso", "MibIdentifier", "Counter32", "NotificationType", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("CXR-TS-MIB", radiusSecret2=radiusSecret2, productName=productName, bootp=bootp, ts=ts, remoteIpAddress=remoteIpAddress, nameServer2=nameServer2, mode=mode, afterSend=afterSend, version=version, dtrDown=dtrDown, cxr=cxr, portStatsTable=portStatsTable, aliasIpAddress=aliasIpAddress, interFrame=interFrame, baudRate=baudRate, snmpdService=snmpdService, radiusServer2=radiusServer2, radiusServer1=radiusServer1, statusDTR=statusDTR, snmpTrapAddr1=snmpTrapAddr1, slaveIPaddr=slaveIPaddr, timeoutPAD=timeoutPAD, bytesReceiveFromV24=bytesReceiveFromV24, authRad2=authRad2, aliasIpNetmask=aliasIpNetmask, portTable=portTable, acctRad2=acctRad2, formFeed=formFeed, endMsg=endMsg, nameResolution=nameResolution, modbusEntry=modbusEntry, modbusTable=modbusTable, timeoutRxTx=timeoutRxTx, sessionStopped=sessionStopped, secondTcpPort=secondTcpPort, beforeSend=beforeSend, acctRad1=acctRad1, flowControl=flowControl, radiusSecret1=radiusSecret1, portReset=portReset, gatewayToRemote=gatewayToRemote, remoteTcpPort=remoteTcpPort, ipGateway=ipGateway, terminalType=terminalType, mainIpAddress=mainIpAddress, bytesSendToV24=bytesSendToV24, ipNetmask=ipNetmask, slaveIPport=slaveIPport, snmpTrap=snmpTrap, txIdle=txIdle, rxIdle=rxIdle, ftpdService=ftpdService, snmpTrapAddr2=snmpTrapAddr2, modbusMode=modbusMode, portIndex=portIndex, ethernetAddress=ethernetAddress, reset=reset, resetByButton=resetByButton, nameServer1=nameServer1, secondGateway=secondGateway, authRad1=authRad1, sessionStarted=sessionStarted, siteName=siteName, portStatsEntry=portStatsEntry, slaveHexaAddress=slaveHexaAddress, system=system, ipServer=ipServer, authType=authType, httpdService=httpdService, telnetdService=telnetdService, tcpPort=tcpPort, modbusType=modbusType, portEntry=portEntry, nbParStop=nbParStop, multiSession=multiSession, secondIpAddress=secondIpAddress, dtrUp=dtrUp)
