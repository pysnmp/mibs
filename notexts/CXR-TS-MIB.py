...
# Produced by pysmi-1.1.12 at Thu Apr  4 10:09:38 2024
...
ObjectIdentity, IpAddress, TimeTicks, Unsigned32, Counter64, MibIdentifier, iso, NotificationType, Counter32, NotificationType, Gauge32, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "TimeTicks", "Unsigned32", "Counter64", "MibIdentifier", "iso", "NotificationType", "Counter32", "NotificationType", "Gauge32", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", remoteIpAddress=remoteIpAddress, baudRate=baudRate, bootp=bootp, siteName=siteName, timeoutPAD=timeoutPAD, slaveHexaAddress=slaveHexaAddress, modbusEntry=modbusEntry, acctRad2=acctRad2, reset=reset, version=version, snmpTrapAddr1=snmpTrapAddr1, aliasIpAddress=aliasIpAddress, authRad1=authRad1, ftpdService=ftpdService, aliasIpNetmask=aliasIpNetmask, radiusServer2=radiusServer2, sessionStarted=sessionStarted, radiusSecret1=radiusSecret1, radiusServer1=radiusServer1, gatewayToRemote=gatewayToRemote, ipServer=ipServer, modbusTable=modbusTable, txIdle=txIdle, sessionStopped=sessionStopped, beforeSend=beforeSend, rxIdle=rxIdle, resetByButton=resetByButton, mode=mode, dtrUp=dtrUp, terminalType=terminalType, portStatsTable=portStatsTable, mainIpAddress=mainIpAddress, snmpTrapAddr2=snmpTrapAddr2, productName=productName, modbusType=modbusType, snmpTrap=snmpTrap, formFeed=formFeed, interFrame=interFrame, portEntry=portEntry, secondIpAddress=secondIpAddress, slaveIPaddr=slaveIPaddr, portTable=portTable, telnetdService=telnetdService, authType=authType, nameServer2=nameServer2, endMsg=endMsg, portStatsEntry=portStatsEntry, acctRad1=acctRad1, statusDTR=statusDTR, multiSession=multiSession, cxr=cxr, system=system, bytesSendToV24=bytesSendToV24, tcpPort=tcpPort, flowControl=flowControl, secondGateway=secondGateway, radiusSecret2=radiusSecret2, authRad2=authRad2, remoteTcpPort=remoteTcpPort, nameServer1=nameServer1, ts=ts, bytesReceiveFromV24=bytesReceiveFromV24, portReset=portReset, secondTcpPort=secondTcpPort, ethernetAddress=ethernetAddress, snmpdService=snmpdService, afterSend=afterSend, ipNetmask=ipNetmask, slaveIPport=slaveIPport, dtrDown=dtrDown, portIndex=portIndex, timeoutRxTx=timeoutRxTx, ipGateway=ipGateway, nameResolution=nameResolution, modbusMode=modbusMode, httpdService=httpdService, nbParStop=nbParStop)
