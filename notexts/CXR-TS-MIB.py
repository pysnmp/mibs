...
# Produced by pysmi-1.1.12 at Tue Jun  4 10:03:42 2024
...
NotificationType, NotificationType, ModuleIdentity, Counter32, MibIdentifier, iso, enterprises, Bits, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, Counter64, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "NotificationType", "ModuleIdentity", "Counter32", "MibIdentifier", "iso", "enterprises", "Bits", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "Counter64", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("CXR-TS-MIB", radiusSecret1=radiusSecret1, dtrDown=dtrDown, txIdle=txIdle, acctRad2=acctRad2, slaveHexaAddress=slaveHexaAddress, flowControl=flowControl, snmpTrap=snmpTrap, portStatsTable=portStatsTable, snmpTrapAddr2=snmpTrapAddr2, dtrUp=dtrUp, bytesReceiveFromV24=bytesReceiveFromV24, version=version, cxr=cxr, resetByButton=resetByButton, ipNetmask=ipNetmask, acctRad1=acctRad1, timeoutRxTx=timeoutRxTx, ts=ts, multiSession=multiSession, ftpdService=ftpdService, tcpPort=tcpPort, baudRate=baudRate, endMsg=endMsg, ipServer=ipServer, bootp=bootp, modbusMode=modbusMode, sessionStarted=sessionStarted, authRad1=authRad1, statusDTR=statusDTR, authType=authType, remoteIpAddress=remoteIpAddress, siteName=siteName, interFrame=interFrame, reset=reset, portEntry=portEntry, nameServer2=nameServer2, portReset=portReset, mainIpAddress=mainIpAddress, secondIpAddress=secondIpAddress, portIndex=portIndex, beforeSend=beforeSend, modbusType=modbusType, nbParStop=nbParStop, portStatsEntry=portStatsEntry, system=system, portTable=portTable, slaveIPport=slaveIPport, timeoutPAD=timeoutPAD, httpdService=httpdService, secondGateway=secondGateway, secondTcpPort=secondTcpPort, rxIdle=rxIdle, radiusServer1=radiusServer1, sessionStopped=sessionStopped, nameResolution=nameResolution, telnetdService=telnetdService, remoteTcpPort=remoteTcpPort, snmpTrapAddr1=snmpTrapAddr1, formFeed=formFeed, nameServer1=nameServer1, snmpdService=snmpdService, radiusSecret2=radiusSecret2, productName=productName, ipGateway=ipGateway, slaveIPaddr=slaveIPaddr, afterSend=afterSend, terminalType=terminalType, ethernetAddress=ethernetAddress, gatewayToRemote=gatewayToRemote, aliasIpNetmask=aliasIpNetmask, mode=mode, modbusTable=modbusTable, authRad2=authRad2, aliasIpAddress=aliasIpAddress, modbusEntry=modbusEntry, bytesSendToV24=bytesSendToV24, radiusServer2=radiusServer2)
