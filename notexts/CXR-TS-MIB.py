...
# Produced by pysmi-1.1.8 at Tue Jan 18 14:02:40 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, Unsigned32, iso, Counter64, Gauge32, ObjectIdentity, Integer32, NotificationType, MibIdentifier, enterprises, Bits, Counter32, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "Unsigned32", "iso", "Counter64", "Gauge32", "ObjectIdentity", "Integer32", "NotificationType", "MibIdentifier", "enterprises", "Bits", "Counter32", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("CXR-TS-MIB", bootp=bootp, remoteIpAddress=remoteIpAddress, radiusServer1=radiusServer1, timeoutRxTx=timeoutRxTx, nameResolution=nameResolution, remoteTcpPort=remoteTcpPort, bytesReceiveFromV24=bytesReceiveFromV24, ethernetAddress=ethernetAddress, afterSend=afterSend, version=version, modbusTable=modbusTable, cxr=cxr, nbParStop=nbParStop, ts=ts, gatewayToRemote=gatewayToRemote, portStatsTable=portStatsTable, dtrDown=dtrDown, resetByButton=resetByButton, interFrame=interFrame, ipGateway=ipGateway, slaveIPport=slaveIPport, authRad2=authRad2, radiusSecret2=radiusSecret2, ipServer=ipServer, ipNetmask=ipNetmask, statusDTR=statusDTR, timeoutPAD=timeoutPAD, mode=mode, radiusServer2=radiusServer2, secondIpAddress=secondIpAddress, portEntry=portEntry, slaveHexaAddress=slaveHexaAddress, dtrUp=dtrUp, snmpTrapAddr2=snmpTrapAddr2, snmpdService=snmpdService, mainIpAddress=mainIpAddress, txIdle=txIdle, sessionStopped=sessionStopped, radiusSecret1=radiusSecret1, formFeed=formFeed, terminalType=terminalType, acctRad2=acctRad2, productName=productName, aliasIpNetmask=aliasIpNetmask, secondGateway=secondGateway, siteName=siteName, ftpdService=ftpdService, portTable=portTable, httpdService=httpdService, snmpTrapAddr1=snmpTrapAddr1, acctRad1=acctRad1, authType=authType, portReset=portReset, rxIdle=rxIdle, modbusEntry=modbusEntry, secondTcpPort=secondTcpPort, nameServer2=nameServer2, sessionStarted=sessionStarted, tcpPort=tcpPort, endMsg=endMsg, authRad1=authRad1, telnetdService=telnetdService, reset=reset, baudRate=baudRate, system=system, modbusType=modbusType, flowControl=flowControl, slaveIPaddr=slaveIPaddr, aliasIpAddress=aliasIpAddress, nameServer1=nameServer1, modbusMode=modbusMode, snmpTrap=snmpTrap, bytesSendToV24=bytesSendToV24, portIndex=portIndex, portStatsEntry=portStatsEntry, multiSession=multiSession, beforeSend=beforeSend)
