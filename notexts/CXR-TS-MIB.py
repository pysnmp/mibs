...
# Produced by pysmi-1.1.8 at Fri Dec  2 16:42:07 2022
...
iso, NotificationType, NotificationType, Gauge32, ObjectIdentity, ModuleIdentity, Integer32, MibIdentifier, IpAddress, enterprises, Bits, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "NotificationType", "Gauge32", "ObjectIdentity", "ModuleIdentity", "Integer32", "MibIdentifier", "IpAddress", "enterprises", "Bits", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("CXR-TS-MIB", ethernetAddress=ethernetAddress, nameResolution=nameResolution, telnetdService=telnetdService, radiusServer2=radiusServer2, secondIpAddress=secondIpAddress, nameServer1=nameServer1, aliasIpNetmask=aliasIpNetmask, acctRad1=acctRad1, portIndex=portIndex, ipServer=ipServer, ts=ts, modbusEntry=modbusEntry, secondTcpPort=secondTcpPort, endMsg=endMsg, secondGateway=secondGateway, system=system, dtrUp=dtrUp, portTable=portTable, timeoutPAD=timeoutPAD, mode=mode, mainIpAddress=mainIpAddress, flowControl=flowControl, version=version, modbusMode=modbusMode, nameServer2=nameServer2, acctRad2=acctRad2, tcpPort=tcpPort, modbusType=modbusType, afterSend=afterSend, portReset=portReset, productName=productName, cxr=cxr, bytesReceiveFromV24=bytesReceiveFromV24, remoteTcpPort=remoteTcpPort, snmpTrapAddr1=snmpTrapAddr1, multiSession=multiSession, slaveIPaddr=slaveIPaddr, ftpdService=ftpdService, gatewayToRemote=gatewayToRemote, formFeed=formFeed, aliasIpAddress=aliasIpAddress, snmpdService=snmpdService, radiusSecret2=radiusSecret2, nbParStop=nbParStop, snmpTrapAddr2=snmpTrapAddr2, ipNetmask=ipNetmask, resetByButton=resetByButton, portStatsTable=portStatsTable, modbusTable=modbusTable, txIdle=txIdle, slaveIPport=slaveIPport, statusDTR=statusDTR, timeoutRxTx=timeoutRxTx, beforeSend=beforeSend, slaveHexaAddress=slaveHexaAddress, snmpTrap=snmpTrap, radiusServer1=radiusServer1, remoteIpAddress=remoteIpAddress, bootp=bootp, httpdService=httpdService, radiusSecret1=radiusSecret1, portEntry=portEntry, bytesSendToV24=bytesSendToV24, reset=reset, authRad1=authRad1, sessionStarted=sessionStarted, authRad2=authRad2, authType=authType, baudRate=baudRate, terminalType=terminalType, portStatsEntry=portStatsEntry, interFrame=interFrame, sessionStopped=sessionStopped, ipGateway=ipGateway, siteName=siteName, dtrDown=dtrDown, rxIdle=rxIdle)
