...
NotificationType, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, Gauge32, ObjectIdentity, Counter64, enterprises, ModuleIdentity, Bits, NotificationType, Counter32, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "Gauge32", "ObjectIdentity", "Counter64", "enterprises", "ModuleIdentity", "Bits", "NotificationType", "Counter32", "Unsigned32", "MibIdentifier")
...
mibBuilder.exportSymbols("CXR-TS-MIB", ftpdService=ftpdService, beforeSend=beforeSend, sessionStarted=sessionStarted, statusDTR=statusDTR, nameServer1=nameServer1, httpdService=httpdService, modbusType=modbusType, remoteIpAddress=remoteIpAddress, telnetdService=telnetdService, interFrame=interFrame, multiSession=multiSession, formFeed=formFeed, reset=reset, aliasIpNetmask=aliasIpNetmask, radiusSecret1=radiusSecret1, mode=mode, secondTcpPort=secondTcpPort, modbusMode=modbusMode, mainIpAddress=mainIpAddress, modbusEntry=modbusEntry, timeoutPAD=timeoutPAD, snmpdService=snmpdService, dtrUp=dtrUp, radiusServer2=radiusServer2, bytesSendToV24=bytesSendToV24, endMsg=endMsg, slaveIPaddr=slaveIPaddr, cxr=cxr, secondGateway=secondGateway, snmpTrapAddr1=snmpTrapAddr1, portEntry=portEntry, dtrDown=dtrDown, radiusServer1=radiusServer1, sessionStopped=sessionStopped, system=system, nbParStop=nbParStop, ipGateway=ipGateway, bytesReceiveFromV24=bytesReceiveFromV24, portTable=portTable, slaveIPport=slaveIPport, nameResolution=nameResolution, portIndex=portIndex, authType=authType, radiusSecret2=radiusSecret2, acctRad1=acctRad1, acctRad2=acctRad2, siteName=siteName, nameServer2=nameServer2, secondIpAddress=secondIpAddress, flowControl=flowControl, baudRate=baudRate, slaveHexaAddress=slaveHexaAddress, ipNetmask=ipNetmask, txIdle=txIdle, tcpPort=tcpPort, ipServer=ipServer, remoteTcpPort=remoteTcpPort, portStatsEntry=portStatsEntry, snmpTrap=snmpTrap, bootp=bootp, rxIdle=rxIdle, version=version, ts=ts, gatewayToRemote=gatewayToRemote, terminalType=terminalType, authRad1=authRad1, portStatsTable=portStatsTable, portReset=portReset, aliasIpAddress=aliasIpAddress, authRad2=authRad2, ethernetAddress=ethernetAddress, productName=productName, snmpTrapAddr2=snmpTrapAddr2, modbusTable=modbusTable, resetByButton=resetByButton, timeoutRxTx=timeoutRxTx, afterSend=afterSend)
