...
# Produced by pysmi-1.1.11 at Tue Dec  5 02:27:13 2023
...
Counter32, ModuleIdentity, NotificationType, Bits, Gauge32, enterprises, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, NotificationType, iso, Integer32, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "NotificationType", "Bits", "Gauge32", "enterprises", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "NotificationType", "iso", "Integer32", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("CXR-TS-MIB", slaveHexaAddress=slaveHexaAddress, tcpPort=tcpPort, modbusEntry=modbusEntry, radiusSecret2=radiusSecret2, mode=mode, snmpTrapAddr1=snmpTrapAddr1, endMsg=endMsg, aliasIpNetmask=aliasIpNetmask, txIdle=txIdle, statusDTR=statusDTR, portTable=portTable, cxr=cxr, httpdService=httpdService, ipNetmask=ipNetmask, snmpTrap=snmpTrap, aliasIpAddress=aliasIpAddress, portIndex=portIndex, radiusSecret1=radiusSecret1, nameServer1=nameServer1, reset=reset, telnetdService=telnetdService, sessionStopped=sessionStopped, bytesSendToV24=bytesSendToV24, nbParStop=nbParStop, authRad2=authRad2, gatewayToRemote=gatewayToRemote, bytesReceiveFromV24=bytesReceiveFromV24, system=system, secondTcpPort=secondTcpPort, portStatsTable=portStatsTable, slaveIPaddr=slaveIPaddr, portStatsEntry=portStatsEntry, formFeed=formFeed, version=version, modbusTable=modbusTable, secondGateway=secondGateway, ts=ts, portEntry=portEntry, slaveIPport=slaveIPport, baudRate=baudRate, ipServer=ipServer, remoteIpAddress=remoteIpAddress, radiusServer2=radiusServer2, nameServer2=nameServer2, secondIpAddress=secondIpAddress, acctRad2=acctRad2, siteName=siteName, portReset=portReset, dtrDown=dtrDown, multiSession=multiSession, modbusType=modbusType, timeoutPAD=timeoutPAD, authType=authType, bootp=bootp, snmpTrapAddr2=snmpTrapAddr2, radiusServer1=radiusServer1, dtrUp=dtrUp, mainIpAddress=mainIpAddress, remoteTcpPort=remoteTcpPort, ipGateway=ipGateway, flowControl=flowControl, ftpdService=ftpdService, nameResolution=nameResolution, sessionStarted=sessionStarted, acctRad1=acctRad1, authRad1=authRad1, snmpdService=snmpdService, terminalType=terminalType, resetByButton=resetByButton, rxIdle=rxIdle, beforeSend=beforeSend, productName=productName, timeoutRxTx=timeoutRxTx, afterSend=afterSend, interFrame=interFrame, ethernetAddress=ethernetAddress, modbusMode=modbusMode)
