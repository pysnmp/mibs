...
# Produced by pysmi-1.1.8 at Wed Jun 29 15:04:24 2022
...
ModuleIdentity, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, MibIdentifier, TimeTicks, Integer32, Unsigned32, IpAddress, enterprises, Counter64, NotificationType, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "MibIdentifier", "TimeTicks", "Integer32", "Unsigned32", "IpAddress", "enterprises", "Counter64", "NotificationType", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", ipGateway=ipGateway, snmpTrapAddr2=snmpTrapAddr2, portIndex=portIndex, radiusServer2=radiusServer2, siteName=siteName, radiusSecret2=radiusSecret2, portReset=portReset, modbusMode=modbusMode, secondGateway=secondGateway, bytesSendToV24=bytesSendToV24, timeoutRxTx=timeoutRxTx, dtrUp=dtrUp, snmpTrap=snmpTrap, txIdle=txIdle, remoteTcpPort=remoteTcpPort, snmpdService=snmpdService, statusDTR=statusDTR, sessionStarted=sessionStarted, aliasIpAddress=aliasIpAddress, modbusType=modbusType, acctRad2=acctRad2, gatewayToRemote=gatewayToRemote, nameServer2=nameServer2, afterSend=afterSend, mainIpAddress=mainIpAddress, resetByButton=resetByButton, remoteIpAddress=remoteIpAddress, version=version, ipNetmask=ipNetmask, ftpdService=ftpdService, mode=mode, multiSession=multiSession, timeoutPAD=timeoutPAD, beforeSend=beforeSend, nameResolution=nameResolution, nbParStop=nbParStop, modbusTable=modbusTable, cxr=cxr, authRad1=authRad1, portStatsTable=portStatsTable, secondIpAddress=secondIpAddress, productName=productName, authType=authType, modbusEntry=modbusEntry, terminalType=terminalType, dtrDown=dtrDown, authRad2=authRad2, radiusSecret1=radiusSecret1, secondTcpPort=secondTcpPort, endMsg=endMsg, slaveIPaddr=slaveIPaddr, httpdService=httpdService, portStatsEntry=portStatsEntry, formFeed=formFeed, snmpTrapAddr1=snmpTrapAddr1, radiusServer1=radiusServer1, ethernetAddress=ethernetAddress, portEntry=portEntry, sessionStopped=sessionStopped, rxIdle=rxIdle, nameServer1=nameServer1, interFrame=interFrame, portTable=portTable, system=system, ts=ts, ipServer=ipServer, acctRad1=acctRad1, flowControl=flowControl, bytesReceiveFromV24=bytesReceiveFromV24, baudRate=baudRate, reset=reset, bootp=bootp, slaveHexaAddress=slaveHexaAddress, telnetdService=telnetdService, slaveIPport=slaveIPport, aliasIpNetmask=aliasIpNetmask, tcpPort=tcpPort)
