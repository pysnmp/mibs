...
# Produced by pysmi-1.1.8 at Mon Jan  9 10:27:14 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, Counter64, enterprises, MibIdentifier, iso, Bits, NotificationType, Integer32, Unsigned32, IpAddress, TimeTicks, ObjectIdentity, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "Counter64", "enterprises", "MibIdentifier", "iso", "Bits", "NotificationType", "Integer32", "Unsigned32", "IpAddress", "TimeTicks", "ObjectIdentity", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("CXR-TS-MIB", portStatsTable=portStatsTable, acctRad1=acctRad1, nbParStop=nbParStop, timeoutPAD=timeoutPAD, remoteIpAddress=remoteIpAddress, mode=mode, portStatsEntry=portStatsEntry, slaveIPaddr=slaveIPaddr, dtrUp=dtrUp, radiusServer1=radiusServer1, nameServer1=nameServer1, snmpdService=snmpdService, nameServer2=nameServer2, ts=ts, beforeSend=beforeSend, telnetdService=telnetdService, system=system, txIdle=txIdle, flowControl=flowControl, multiSession=multiSession, authRad2=authRad2, snmpTrap=snmpTrap, radiusSecret1=radiusSecret1, ftpdService=ftpdService, portTable=portTable, interFrame=interFrame, cxr=cxr, mainIpAddress=mainIpAddress, snmpTrapAddr1=snmpTrapAddr1, bytesSendToV24=bytesSendToV24, httpdService=httpdService, bootp=bootp, portIndex=portIndex, dtrDown=dtrDown, sessionStarted=sessionStarted, endMsg=endMsg, rxIdle=rxIdle, secondGateway=secondGateway, reset=reset, siteName=siteName, gatewayToRemote=gatewayToRemote, terminalType=terminalType, nameResolution=nameResolution, modbusTable=modbusTable, remoteTcpPort=remoteTcpPort, modbusType=modbusType, secondTcpPort=secondTcpPort, acctRad2=acctRad2, aliasIpNetmask=aliasIpNetmask, aliasIpAddress=aliasIpAddress, baudRate=baudRate, radiusServer2=radiusServer2, radiusSecret2=radiusSecret2, modbusEntry=modbusEntry, slaveIPport=slaveIPport, timeoutRxTx=timeoutRxTx, version=version, resetByButton=resetByButton, ipServer=ipServer, ipGateway=ipGateway, formFeed=formFeed, portEntry=portEntry, productName=productName, modbusMode=modbusMode, sessionStopped=sessionStopped, authRad1=authRad1, portReset=portReset, bytesReceiveFromV24=bytesReceiveFromV24, afterSend=afterSend, snmpTrapAddr2=snmpTrapAddr2, ethernetAddress=ethernetAddress, slaveHexaAddress=slaveHexaAddress, authType=authType, ipNetmask=ipNetmask, statusDTR=statusDTR, secondIpAddress=secondIpAddress, tcpPort=tcpPort)
