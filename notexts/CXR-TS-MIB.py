...
# Produced by pysmi-1.1.8 at Sun Jan 16 15:28:08 2022
...
NotificationType, TimeTicks, Counter64, IpAddress, enterprises, Unsigned32, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, MibIdentifier, ModuleIdentity, Bits, iso, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "Counter64", "IpAddress", "enterprises", "Unsigned32", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "MibIdentifier", "ModuleIdentity", "Bits", "iso", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", nameServer2=nameServer2, terminalType=terminalType, nbParStop=nbParStop, slaveHexaAddress=slaveHexaAddress, snmpdService=snmpdService, portStatsTable=portStatsTable, modbusType=modbusType, portStatsEntry=portStatsEntry, bytesSendToV24=bytesSendToV24, resetByButton=resetByButton, timeoutRxTx=timeoutRxTx, mainIpAddress=mainIpAddress, statusDTR=statusDTR, endMsg=endMsg, acctRad2=acctRad2, secondIpAddress=secondIpAddress, modbusTable=modbusTable, modbusEntry=modbusEntry, remoteTcpPort=remoteTcpPort, radiusServer1=radiusServer1, ts=ts, reset=reset, nameResolution=nameResolution, ipGateway=ipGateway, ftpdService=ftpdService, snmpTrapAddr1=snmpTrapAddr1, productName=productName, telnetdService=telnetdService, modbusMode=modbusMode, sessionStarted=sessionStarted, acctRad1=acctRad1, bytesReceiveFromV24=bytesReceiveFromV24, authType=authType, bootp=bootp, slaveIPaddr=slaveIPaddr, portTable=portTable, cxr=cxr, tcpPort=tcpPort, system=system, afterSend=afterSend, portEntry=portEntry, mode=mode, snmpTrap=snmpTrap, nameServer1=nameServer1, timeoutPAD=timeoutPAD, authRad1=authRad1, gatewayToRemote=gatewayToRemote, ethernetAddress=ethernetAddress, siteName=siteName, remoteIpAddress=remoteIpAddress, txIdle=txIdle, beforeSend=beforeSend, interFrame=interFrame, httpdService=httpdService, rxIdle=rxIdle, slaveIPport=slaveIPport, portReset=portReset, sessionStopped=sessionStopped, portIndex=portIndex, authRad2=authRad2, aliasIpAddress=aliasIpAddress, dtrDown=dtrDown, radiusServer2=radiusServer2, dtrUp=dtrUp, secondTcpPort=secondTcpPort, snmpTrapAddr2=snmpTrapAddr2, version=version, aliasIpNetmask=aliasIpNetmask, multiSession=multiSession, flowControl=flowControl, radiusSecret2=radiusSecret2, radiusSecret1=radiusSecret1, baudRate=baudRate, formFeed=formFeed, secondGateway=secondGateway, ipServer=ipServer, ipNetmask=ipNetmask)
