...
# Produced by pysmi-1.1.8 at Tue Jan 18 15:07:18 2022
...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, Integer32, Counter32, NotificationType, ModuleIdentity, MibIdentifier, enterprises, Unsigned32, ObjectIdentity, Bits, Counter64, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "Integer32", "Counter32", "NotificationType", "ModuleIdentity", "MibIdentifier", "enterprises", "Unsigned32", "ObjectIdentity", "Bits", "Counter64", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("CXR-TS-MIB", productName=productName, remoteTcpPort=remoteTcpPort, nbParStop=nbParStop, acctRad2=acctRad2, interFrame=interFrame, portTable=portTable, ipGateway=ipGateway, aliasIpAddress=aliasIpAddress, modbusMode=modbusMode, timeoutRxTx=timeoutRxTx, afterSend=afterSend, ipNetmask=ipNetmask, snmpTrap=snmpTrap, portEntry=portEntry, slaveIPport=slaveIPport, portStatsTable=portStatsTable, cxr=cxr, authType=authType, flowControl=flowControl, secondIpAddress=secondIpAddress, aliasIpNetmask=aliasIpNetmask, snmpdService=snmpdService, beforeSend=beforeSend, secondGateway=secondGateway, version=version, modbusEntry=modbusEntry, secondTcpPort=secondTcpPort, baudRate=baudRate, mode=mode, modbusType=modbusType, ipServer=ipServer, rxIdle=rxIdle, mainIpAddress=mainIpAddress, slaveHexaAddress=slaveHexaAddress, ftpdService=ftpdService, endMsg=endMsg, gatewayToRemote=gatewayToRemote, authRad1=authRad1, radiusSecret2=radiusSecret2, nameResolution=nameResolution, reset=reset, portReset=portReset, portStatsEntry=portStatsEntry, terminalType=terminalType, tcpPort=tcpPort, sessionStarted=sessionStarted, dtrDown=dtrDown, portIndex=portIndex, siteName=siteName, authRad2=authRad2, telnetdService=telnetdService, bytesSendToV24=bytesSendToV24, sessionStopped=sessionStopped, snmpTrapAddr2=snmpTrapAddr2, radiusServer2=radiusServer2, bootp=bootp, modbusTable=modbusTable, dtrUp=dtrUp, nameServer1=nameServer1, snmpTrapAddr1=snmpTrapAddr1, ts=ts, nameServer2=nameServer2, formFeed=formFeed, system=system, statusDTR=statusDTR, httpdService=httpdService, multiSession=multiSession, radiusServer1=radiusServer1, slaveIPaddr=slaveIPaddr, acctRad1=acctRad1, ethernetAddress=ethernetAddress, bytesReceiveFromV24=bytesReceiveFromV24, timeoutPAD=timeoutPAD, resetByButton=resetByButton, remoteIpAddress=remoteIpAddress, radiusSecret1=radiusSecret1, txIdle=txIdle)
