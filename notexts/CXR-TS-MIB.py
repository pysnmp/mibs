...
# Produced by pysmi-1.1.8 at Sat Jan 15 20:15:03 2022
...
ObjectIdentity, Counter32, Integer32, ModuleIdentity, Gauge32, MibIdentifier, enterprises, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, Bits, Counter64, TimeTicks, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "Integer32", "ModuleIdentity", "Gauge32", "MibIdentifier", "enterprises", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "Bits", "Counter64", "TimeTicks", "iso", "NotificationType")
...
mibBuilder.exportSymbols("CXR-TS-MIB", nameServer1=nameServer1, multiSession=multiSession, tcpPort=tcpPort, ts=ts, bytesReceiveFromV24=bytesReceiveFromV24, snmpTrapAddr1=snmpTrapAddr1, aliasIpNetmask=aliasIpNetmask, ethernetAddress=ethernetAddress, secondIpAddress=secondIpAddress, productName=productName, acctRad1=acctRad1, mode=mode, interFrame=interFrame, flowControl=flowControl, portReset=portReset, endMsg=endMsg, version=version, snmpTrap=snmpTrap, acctRad2=acctRad2, txIdle=txIdle, resetByButton=resetByButton, mainIpAddress=mainIpAddress, aliasIpAddress=aliasIpAddress, slaveIPport=slaveIPport, snmpTrapAddr2=snmpTrapAddr2, statusDTR=statusDTR, authRad1=authRad1, slaveIPaddr=slaveIPaddr, radiusServer1=radiusServer1, bootp=bootp, snmpdService=snmpdService, sessionStopped=sessionStopped, portIndex=portIndex, ipServer=ipServer, cxr=cxr, portStatsTable=portStatsTable, formFeed=formFeed, httpdService=httpdService, modbusMode=modbusMode, radiusSecret2=radiusSecret2, modbusEntry=modbusEntry, ftpdService=ftpdService, system=system, portStatsEntry=portStatsEntry, telnetdService=telnetdService, reset=reset, rxIdle=rxIdle, portEntry=portEntry, timeoutPAD=timeoutPAD, radiusSecret1=radiusSecret1, siteName=siteName, authType=authType, nameResolution=nameResolution, remoteTcpPort=remoteTcpPort, slaveHexaAddress=slaveHexaAddress, modbusTable=modbusTable, baudRate=baudRate, modbusType=modbusType, beforeSend=beforeSend, sessionStarted=sessionStarted, secondTcpPort=secondTcpPort, gatewayToRemote=gatewayToRemote, ipNetmask=ipNetmask, timeoutRxTx=timeoutRxTx, portTable=portTable, dtrUp=dtrUp, nbParStop=nbParStop, afterSend=afterSend, ipGateway=ipGateway, authRad2=authRad2, terminalType=terminalType, radiusServer2=radiusServer2, secondGateway=secondGateway, remoteIpAddress=remoteIpAddress, bytesSendToV24=bytesSendToV24, dtrDown=dtrDown, nameServer2=nameServer2)
