...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises, Bits, ModuleIdentity, iso, NotificationType, Counter32, IpAddress, ObjectIdentity, Counter64, TimeTicks, Gauge32, Integer32, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises", "Bits", "ModuleIdentity", "iso", "NotificationType", "Counter32", "IpAddress", "ObjectIdentity", "Counter64", "TimeTicks", "Gauge32", "Integer32", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("CXR-TS-MIB", remoteTcpPort=remoteTcpPort, authRad1=authRad1, secondGateway=secondGateway, baudRate=baudRate, snmpTrapAddr2=snmpTrapAddr2, rxIdle=rxIdle, ipServer=ipServer, reset=reset, secondTcpPort=secondTcpPort, telnetdService=telnetdService, sessionStarted=sessionStarted, acctRad1=acctRad1, ipGateway=ipGateway, snmpTrap=snmpTrap, portStatsTable=portStatsTable, tcpPort=tcpPort, multiSession=multiSession, bytesSendToV24=bytesSendToV24, system=system, endMsg=endMsg, timeoutRxTx=timeoutRxTx, aliasIpNetmask=aliasIpNetmask, flowControl=flowControl, radiusServer2=radiusServer2, siteName=siteName, afterSend=afterSend, interFrame=interFrame, modbusMode=modbusMode, modbusType=modbusType, httpdService=httpdService, nbParStop=nbParStop, ethernetAddress=ethernetAddress, timeoutPAD=timeoutPAD, radiusSecret1=radiusSecret1, portStatsEntry=portStatsEntry, snmpdService=snmpdService, productName=productName, radiusSecret2=radiusSecret2, mode=mode, snmpTrapAddr1=snmpTrapAddr1, resetByButton=resetByButton, gatewayToRemote=gatewayToRemote, bytesReceiveFromV24=bytesReceiveFromV24, cxr=cxr, nameServer1=nameServer1, nameServer2=nameServer2, remoteIpAddress=remoteIpAddress, ftpdService=ftpdService, beforeSend=beforeSend, statusDTR=statusDTR, aliasIpAddress=aliasIpAddress, formFeed=formFeed, authRad2=authRad2, mainIpAddress=mainIpAddress, terminalType=terminalType, modbusTable=modbusTable, slaveHexaAddress=slaveHexaAddress, bootp=bootp, slaveIPport=slaveIPport, version=version, portTable=portTable, secondIpAddress=secondIpAddress, txIdle=txIdle, dtrUp=dtrUp, nameResolution=nameResolution, portIndex=portIndex, acctRad2=acctRad2, portEntry=portEntry, portReset=portReset, ts=ts, sessionStopped=sessionStopped, slaveIPaddr=slaveIPaddr, authType=authType, radiusServer1=radiusServer1, ipNetmask=ipNetmask, dtrDown=dtrDown, modbusEntry=modbusEntry)
