...
# Produced by pysmi-1.1.8 at Thu Sep 15 10:02:27 2022
...
Gauge32, enterprises, IpAddress, NotificationType, iso, MibIdentifier, ObjectIdentity, Counter64, Unsigned32, TimeTicks, ModuleIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "IpAddress", "NotificationType", "iso", "MibIdentifier", "ObjectIdentity", "Counter64", "Unsigned32", "TimeTicks", "ModuleIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "Integer32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", radiusServer1=radiusServer1, dtrDown=dtrDown, modbusTable=modbusTable, resetByButton=resetByButton, httpdService=httpdService, modbusEntry=modbusEntry, remoteTcpPort=remoteTcpPort, modbusType=modbusType, portEntry=portEntry, snmpdService=snmpdService, nameServer1=nameServer1, authType=authType, acctRad2=acctRad2, mainIpAddress=mainIpAddress, ftpdService=ftpdService, version=version, tcpPort=tcpPort, multiSession=multiSession, bytesReceiveFromV24=bytesReceiveFromV24, afterSend=afterSend, snmpTrapAddr2=snmpTrapAddr2, dtrUp=dtrUp, baudRate=baudRate, snmpTrapAddr1=snmpTrapAddr1, remoteIpAddress=remoteIpAddress, flowControl=flowControl, authRad1=authRad1, reset=reset, ipServer=ipServer, gatewayToRemote=gatewayToRemote, radiusSecret1=radiusSecret1, nameServer2=nameServer2, interFrame=interFrame, rxIdle=rxIdle, aliasIpAddress=aliasIpAddress, acctRad1=acctRad1, slaveIPport=slaveIPport, formFeed=formFeed, ts=ts, timeoutRxTx=timeoutRxTx, mode=mode, aliasIpNetmask=aliasIpNetmask, modbusMode=modbusMode, slaveIPaddr=slaveIPaddr, telnetdService=telnetdService, portTable=portTable, nameResolution=nameResolution, portStatsTable=portStatsTable, siteName=siteName, cxr=cxr, secondGateway=secondGateway, bytesSendToV24=bytesSendToV24, terminalType=terminalType, portReset=portReset, timeoutPAD=timeoutPAD, beforeSend=beforeSend, statusDTR=statusDTR, authRad2=authRad2, sessionStopped=sessionStopped, secondTcpPort=secondTcpPort, productName=productName, radiusSecret2=radiusSecret2, ipGateway=ipGateway, radiusServer2=radiusServer2, system=system, portStatsEntry=portStatsEntry, endMsg=endMsg, portIndex=portIndex, nbParStop=nbParStop, slaveHexaAddress=slaveHexaAddress, ipNetmask=ipNetmask, bootp=bootp, txIdle=txIdle, sessionStarted=sessionStarted, ethernetAddress=ethernetAddress, snmpTrap=snmpTrap, secondIpAddress=secondIpAddress)
