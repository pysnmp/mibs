...
# Produced by pysmi-1.1.8 at Thu Apr 27 09:19:37 2023
...
Counter32, MibIdentifier, Gauge32, ModuleIdentity, ObjectIdentity, NotificationType, NotificationType, Integer32, Unsigned32, TimeTicks, iso, IpAddress, Counter64, Bits, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "Gauge32", "ModuleIdentity", "ObjectIdentity", "NotificationType", "NotificationType", "Integer32", "Unsigned32", "TimeTicks", "iso", "IpAddress", "Counter64", "Bits", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CXR-TS-MIB", remoteTcpPort=remoteTcpPort, authRad1=authRad1, radiusSecret1=radiusSecret1, portReset=portReset, flowControl=flowControl, ts=ts, radiusServer1=radiusServer1, portStatsTable=portStatsTable, nameResolution=nameResolution, bytesReceiveFromV24=bytesReceiveFromV24, timeoutPAD=timeoutPAD, afterSend=afterSend, beforeSend=beforeSend, reset=reset, rxIdle=rxIdle, ipNetmask=ipNetmask, ethernetAddress=ethernetAddress, snmpTrapAddr1=snmpTrapAddr1, acctRad2=acctRad2, aliasIpNetmask=aliasIpNetmask, modbusType=modbusType, slaveIPaddr=slaveIPaddr, remoteIpAddress=remoteIpAddress, terminalType=terminalType, bytesSendToV24=bytesSendToV24, snmpTrap=snmpTrap, statusDTR=statusDTR, resetByButton=resetByButton, baudRate=baudRate, timeoutRxTx=timeoutRxTx, portIndex=portIndex, tcpPort=tcpPort, secondTcpPort=secondTcpPort, slaveIPport=slaveIPport, ftpdService=ftpdService, aliasIpAddress=aliasIpAddress, version=version, cxr=cxr, radiusServer2=radiusServer2, modbusEntry=modbusEntry, nameServer1=nameServer1, dtrUp=dtrUp, authType=authType, slaveHexaAddress=slaveHexaAddress, interFrame=interFrame, acctRad1=acctRad1, dtrDown=dtrDown, multiSession=multiSession, portStatsEntry=portStatsEntry, txIdle=txIdle, sessionStopped=sessionStopped, ipServer=ipServer, snmpdService=snmpdService, system=system, productName=productName, bootp=bootp, snmpTrapAddr2=snmpTrapAddr2, telnetdService=telnetdService, ipGateway=ipGateway, sessionStarted=sessionStarted, radiusSecret2=radiusSecret2, gatewayToRemote=gatewayToRemote, secondGateway=secondGateway, siteName=siteName, portTable=portTable, modbusTable=modbusTable, modbusMode=modbusMode, authRad2=authRad2, mode=mode, secondIpAddress=secondIpAddress, httpdService=httpdService, nbParStop=nbParStop, formFeed=formFeed, nameServer2=nameServer2, mainIpAddress=mainIpAddress, endMsg=endMsg, portEntry=portEntry)
