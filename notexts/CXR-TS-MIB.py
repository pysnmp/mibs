...
# Produced by pysmi-1.1.8 at Sat Jan 15 15:07:19 2022
...
Counter32, enterprises, ModuleIdentity, ObjectIdentity, TimeTicks, MibIdentifier, Integer32, Counter64, NotificationType, iso, IpAddress, Bits, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "enterprises", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "MibIdentifier", "Integer32", "Counter64", "NotificationType", "iso", "IpAddress", "Bits", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("CXR-TS-MIB", nameResolution=nameResolution, mainIpAddress=mainIpAddress, modbusType=modbusType, siteName=siteName, cxr=cxr, mode=mode, slaveHexaAddress=slaveHexaAddress, timeoutRxTx=timeoutRxTx, slaveIPport=slaveIPport, httpdService=httpdService, authType=authType, ipNetmask=ipNetmask, aliasIpAddress=aliasIpAddress, nbParStop=nbParStop, bytesReceiveFromV24=bytesReceiveFromV24, authRad1=authRad1, radiusServer1=radiusServer1, authRad2=authRad2, sessionStopped=sessionStopped, ethernetAddress=ethernetAddress, secondIpAddress=secondIpAddress, nameServer2=nameServer2, aliasIpNetmask=aliasIpNetmask, portStatsEntry=portStatsEntry, sessionStarted=sessionStarted, resetByButton=resetByButton, modbusMode=modbusMode, modbusTable=modbusTable, remoteIpAddress=remoteIpAddress, snmpTrap=snmpTrap, nameServer1=nameServer1, ipGateway=ipGateway, radiusSecret1=radiusSecret1, statusDTR=statusDTR, terminalType=terminalType, modbusEntry=modbusEntry, acctRad1=acctRad1, formFeed=formFeed, bootp=bootp, multiSession=multiSession, portReset=portReset, gatewayToRemote=gatewayToRemote, dtrUp=dtrUp, telnetdService=telnetdService, radiusServer2=radiusServer2, portEntry=portEntry, dtrDown=dtrDown, tcpPort=tcpPort, rxIdle=rxIdle, portIndex=portIndex, secondTcpPort=secondTcpPort, radiusSecret2=radiusSecret2, ipServer=ipServer, portStatsTable=portStatsTable, snmpTrapAddr2=snmpTrapAddr2, baudRate=baudRate, snmpdService=snmpdService, version=version, remoteTcpPort=remoteTcpPort, slaveIPaddr=slaveIPaddr, ftpdService=ftpdService, afterSend=afterSend, ts=ts, endMsg=endMsg, snmpTrapAddr1=snmpTrapAddr1, portTable=portTable, beforeSend=beforeSend, acctRad2=acctRad2, productName=productName, system=system, secondGateway=secondGateway, interFrame=interFrame, bytesSendToV24=bytesSendToV24, flowControl=flowControl, timeoutPAD=timeoutPAD, txIdle=txIdle, reset=reset)
