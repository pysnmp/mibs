...
# Produced by pysmi-1.1.8 at Fri Jan 27 15:43:08 2023
...
Counter32, iso, NotificationType, NotificationType, Unsigned32, TimeTicks, Counter64, Gauge32, ObjectIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, IpAddress, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "NotificationType", "NotificationType", "Unsigned32", "TimeTicks", "Counter64", "Gauge32", "ObjectIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "IpAddress", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("CXR-TS-MIB", radiusServer2=radiusServer2, aliasIpAddress=aliasIpAddress, radiusSecret1=radiusSecret1, slaveIPaddr=slaveIPaddr, snmpTrap=snmpTrap, portIndex=portIndex, system=system, nameResolution=nameResolution, nameServer2=nameServer2, acctRad1=acctRad1, sessionStopped=sessionStopped, slaveHexaAddress=slaveHexaAddress, modbusEntry=modbusEntry, secondIpAddress=secondIpAddress, nbParStop=nbParStop, reset=reset, modbusType=modbusType, siteName=siteName, dtrUp=dtrUp, productName=productName, rxIdle=rxIdle, snmpTrapAddr1=snmpTrapAddr1, ipGateway=ipGateway, radiusServer1=radiusServer1, slaveIPport=slaveIPport, authRad2=authRad2, bootp=bootp, portStatsTable=portStatsTable, multiSession=multiSession, ipServer=ipServer, secondTcpPort=secondTcpPort, statusDTR=statusDTR, flowControl=flowControl, tcpPort=tcpPort, telnetdService=telnetdService, version=version, terminalType=terminalType, ethernetAddress=ethernetAddress, authRad1=authRad1, baudRate=baudRate, authType=authType, beforeSend=beforeSend, snmpdService=snmpdService, dtrDown=dtrDown, cxr=cxr, nameServer1=nameServer1, aliasIpNetmask=aliasIpNetmask, remoteTcpPort=remoteTcpPort, modbusMode=modbusMode, portEntry=portEntry, timeoutPAD=timeoutPAD, radiusSecret2=radiusSecret2, remoteIpAddress=remoteIpAddress, afterSend=afterSend, endMsg=endMsg, ts=ts, sessionStarted=sessionStarted, bytesReceiveFromV24=bytesReceiveFromV24, gatewayToRemote=gatewayToRemote, ipNetmask=ipNetmask, timeoutRxTx=timeoutRxTx, resetByButton=resetByButton, portStatsEntry=portStatsEntry, portReset=portReset, httpdService=httpdService, mode=mode, ftpdService=ftpdService, snmpTrapAddr2=snmpTrapAddr2, formFeed=formFeed, bytesSendToV24=bytesSendToV24, modbusTable=modbusTable, mainIpAddress=mainIpAddress, secondGateway=secondGateway, portTable=portTable, interFrame=interFrame, txIdle=txIdle, acctRad2=acctRad2)
