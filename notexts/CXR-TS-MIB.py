...
# Produced by pysmi-1.1.8 at Thu Jan  5 09:20:11 2023
...
Bits, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, IpAddress, enterprises, Integer32, NotificationType, Counter32, NotificationType, ModuleIdentity, ObjectIdentity, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "IpAddress", "enterprises", "Integer32", "NotificationType", "Counter32", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("CXR-TS-MIB", statusDTR=statusDTR, secondTcpPort=secondTcpPort, siteName=siteName, snmpTrap=snmpTrap, aliasIpAddress=aliasIpAddress, modbusEntry=modbusEntry, beforeSend=beforeSend, httpdService=httpdService, ts=ts, slaveIPport=slaveIPport, dtrDown=dtrDown, nameServer2=nameServer2, multiSession=multiSession, system=system, bytesReceiveFromV24=bytesReceiveFromV24, radiusServer2=radiusServer2, acctRad1=acctRad1, cxr=cxr, snmpTrapAddr2=snmpTrapAddr2, modbusMode=modbusMode, productName=productName, secondIpAddress=secondIpAddress, acctRad2=acctRad2, mainIpAddress=mainIpAddress, endMsg=endMsg, bytesSendToV24=bytesSendToV24, telnetdService=telnetdService, baudRate=baudRate, bootp=bootp, interFrame=interFrame, nbParStop=nbParStop, nameServer1=nameServer1, authType=authType, radiusSecret2=radiusSecret2, timeoutRxTx=timeoutRxTx, afterSend=afterSend, portStatsEntry=portStatsEntry, timeoutPAD=timeoutPAD, portTable=portTable, portEntry=portEntry, slaveIPaddr=slaveIPaddr, snmpdService=snmpdService, modbusTable=modbusTable, rxIdle=rxIdle, txIdle=txIdle, formFeed=formFeed, terminalType=terminalType, tcpPort=tcpPort, dtrUp=dtrUp, authRad2=authRad2, remoteTcpPort=remoteTcpPort, mode=mode, ftpdService=ftpdService, sessionStopped=sessionStopped, ipNetmask=ipNetmask, portReset=portReset, radiusServer1=radiusServer1, slaveHexaAddress=slaveHexaAddress, ipGateway=ipGateway, sessionStarted=sessionStarted, remoteIpAddress=remoteIpAddress, gatewayToRemote=gatewayToRemote, portStatsTable=portStatsTable, ethernetAddress=ethernetAddress, portIndex=portIndex, reset=reset, aliasIpNetmask=aliasIpNetmask, ipServer=ipServer, version=version, secondGateway=secondGateway, nameResolution=nameResolution, radiusSecret1=radiusSecret1, authRad1=authRad1, modbusType=modbusType, resetByButton=resetByButton, flowControl=flowControl, snmpTrapAddr1=snmpTrapAddr1)
