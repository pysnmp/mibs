...
# Produced by pysmi-1.1.8 at Thu Sep  8 09:14:08 2022
...
Bits, Unsigned32, Integer32, IpAddress, enterprises, MibIdentifier, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, iso, ModuleIdentity, Counter64, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "Integer32", "IpAddress", "enterprises", "MibIdentifier", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "iso", "ModuleIdentity", "Counter64", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("CXR-TS-MIB", authRad2=authRad2, nbParStop=nbParStop, txIdle=txIdle, endMsg=endMsg, flowControl=flowControl, interFrame=interFrame, snmpTrap=snmpTrap, timeoutPAD=timeoutPAD, ftpdService=ftpdService, nameServer2=nameServer2, radiusServer2=radiusServer2, mode=mode, aliasIpAddress=aliasIpAddress, dtrDown=dtrDown, formFeed=formFeed, portReset=portReset, productName=productName, httpdService=httpdService, modbusTable=modbusTable, nameResolution=nameResolution, portStatsTable=portStatsTable, ethernetAddress=ethernetAddress, modbusType=modbusType, telnetdService=telnetdService, ipGateway=ipGateway, multiSession=multiSession, portIndex=portIndex, slaveIPaddr=slaveIPaddr, ts=ts, snmpTrapAddr1=snmpTrapAddr1, authRad1=authRad1, bytesSendToV24=bytesSendToV24, sessionStopped=sessionStopped, mainIpAddress=mainIpAddress, resetByButton=resetByButton, reset=reset, secondGateway=secondGateway, bootp=bootp, tcpPort=tcpPort, radiusSecret1=radiusSecret1, aliasIpNetmask=aliasIpNetmask, radiusSecret2=radiusSecret2, dtrUp=dtrUp, rxIdle=rxIdle, version=version, acctRad1=acctRad1, snmpTrapAddr2=snmpTrapAddr2, beforeSend=beforeSend, gatewayToRemote=gatewayToRemote, radiusServer1=radiusServer1, sessionStarted=sessionStarted, cxr=cxr, system=system, portEntry=portEntry, slaveHexaAddress=slaveHexaAddress, timeoutRxTx=timeoutRxTx, statusDTR=statusDTR, ipNetmask=ipNetmask, modbusMode=modbusMode, ipServer=ipServer, secondTcpPort=secondTcpPort, snmpdService=snmpdService, portTable=portTable, slaveIPport=slaveIPport, secondIpAddress=secondIpAddress, siteName=siteName, bytesReceiveFromV24=bytesReceiveFromV24, acctRad2=acctRad2, modbusEntry=modbusEntry, nameServer1=nameServer1, afterSend=afterSend, portStatsEntry=portStatsEntry, baudRate=baudRate, authType=authType, remoteTcpPort=remoteTcpPort, terminalType=terminalType, remoteIpAddress=remoteIpAddress)
