...
# Produced by pysmi-1.1.8 at Thu Sep 29 12:12:41 2022
...
Counter32, ObjectIdentity, NotificationType, IpAddress, NotificationType, Gauge32, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, enterprises, TimeTicks, Unsigned32, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "NotificationType", "IpAddress", "NotificationType", "Gauge32", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "enterprises", "TimeTicks", "Unsigned32", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("CXR-TS-MIB", sessionStopped=sessionStopped, afterSend=afterSend, version=version, acctRad2=acctRad2, authRad2=authRad2, secondGateway=secondGateway, flowControl=flowControl, statusDTR=statusDTR, portIndex=portIndex, nbParStop=nbParStop, radiusSecret2=radiusSecret2, tcpPort=tcpPort, remoteIpAddress=remoteIpAddress, portReset=portReset, telnetdService=telnetdService, slaveIPaddr=slaveIPaddr, baudRate=baudRate, productName=productName, acctRad1=acctRad1, snmpTrapAddr1=snmpTrapAddr1, ipServer=ipServer, portStatsTable=portStatsTable, terminalType=terminalType, aliasIpNetmask=aliasIpNetmask, beforeSend=beforeSend, timeoutPAD=timeoutPAD, timeoutRxTx=timeoutRxTx, sessionStarted=sessionStarted, snmpTrapAddr2=snmpTrapAddr2, secondTcpPort=secondTcpPort, bytesSendToV24=bytesSendToV24, portEntry=portEntry, formFeed=formFeed, modbusType=modbusType, slaveHexaAddress=slaveHexaAddress, aliasIpAddress=aliasIpAddress, ipGateway=ipGateway, cxr=cxr, endMsg=endMsg, snmpTrap=snmpTrap, modbusTable=modbusTable, ethernetAddress=ethernetAddress, snmpdService=snmpdService, modbusMode=modbusMode, secondIpAddress=secondIpAddress, dtrDown=dtrDown, bytesReceiveFromV24=bytesReceiveFromV24, reset=reset, ts=ts, gatewayToRemote=gatewayToRemote, multiSession=multiSession, bootp=bootp, nameServer1=nameServer1, radiusSecret1=radiusSecret1, ipNetmask=ipNetmask, portTable=portTable, radiusServer1=radiusServer1, nameResolution=nameResolution, siteName=siteName, authRad1=authRad1, remoteTcpPort=remoteTcpPort, modbusEntry=modbusEntry, authType=authType, interFrame=interFrame, slaveIPport=slaveIPport, portStatsEntry=portStatsEntry, mainIpAddress=mainIpAddress, httpdService=httpdService, mode=mode, rxIdle=rxIdle, txIdle=txIdle, resetByButton=resetByButton, radiusServer2=radiusServer2, ftpdService=ftpdService, nameServer2=nameServer2, dtrUp=dtrUp, system=system)
