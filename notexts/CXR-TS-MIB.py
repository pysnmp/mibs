...
# Produced by pysmi-1.1.8 at Fri Feb 11 19:37:28 2022
...
iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, ObjectIdentity, Gauge32, enterprises, MibIdentifier, Counter32, Integer32, ModuleIdentity, Unsigned32, NotificationType, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "ObjectIdentity", "Gauge32", "enterprises", "MibIdentifier", "Counter32", "Integer32", "ModuleIdentity", "Unsigned32", "NotificationType", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("CXR-TS-MIB", ethernetAddress=ethernetAddress, bootp=bootp, snmpTrapAddr2=snmpTrapAddr2, ipNetmask=ipNetmask, statusDTR=statusDTR, secondTcpPort=secondTcpPort, multiSession=multiSession, afterSend=afterSend, flowControl=flowControl, beforeSend=beforeSend, resetByButton=resetByButton, snmpTrapAddr1=snmpTrapAddr1, slaveIPaddr=slaveIPaddr, ts=ts, remoteIpAddress=remoteIpAddress, ftpdService=ftpdService, acctRad1=acctRad1, dtrDown=dtrDown, radiusSecret2=radiusSecret2, radiusServer2=radiusServer2, interFrame=interFrame, authType=authType, ipServer=ipServer, productName=productName, slaveIPport=slaveIPport, snmpTrap=snmpTrap, baudRate=baudRate, gatewayToRemote=gatewayToRemote, siteName=siteName, bytesReceiveFromV24=bytesReceiveFromV24, portStatsEntry=portStatsEntry, bytesSendToV24=bytesSendToV24, dtrUp=dtrUp, formFeed=formFeed, modbusType=modbusType, aliasIpNetmask=aliasIpNetmask, mode=mode, modbusEntry=modbusEntry, authRad2=authRad2, portStatsTable=portStatsTable, authRad1=authRad1, secondGateway=secondGateway, secondIpAddress=secondIpAddress, endMsg=endMsg, nameResolution=nameResolution, remoteTcpPort=remoteTcpPort, portEntry=portEntry, terminalType=terminalType, telnetdService=telnetdService, reset=reset, modbusTable=modbusTable, modbusMode=modbusMode, radiusServer1=radiusServer1, version=version, portTable=portTable, system=system, snmpdService=snmpdService, nameServer1=nameServer1, httpdService=httpdService, mainIpAddress=mainIpAddress, rxIdle=rxIdle, sessionStopped=sessionStopped, aliasIpAddress=aliasIpAddress, timeoutRxTx=timeoutRxTx, radiusSecret1=radiusSecret1, timeoutPAD=timeoutPAD, cxr=cxr, ipGateway=ipGateway, nbParStop=nbParStop, nameServer2=nameServer2, slaveHexaAddress=slaveHexaAddress, portIndex=portIndex, portReset=portReset, sessionStarted=sessionStarted, txIdle=txIdle, tcpPort=tcpPort, acctRad2=acctRad2)
