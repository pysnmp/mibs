...
# Produced by pysmi-1.1.8 at Fri Dec  2 17:03:19 2022
...
ModuleIdentity, Unsigned32, iso, Bits, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, TimeTicks, Counter64, Gauge32, Integer32, ObjectIdentity, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "iso", "Bits", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "TimeTicks", "Counter64", "Gauge32", "Integer32", "ObjectIdentity", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("CXR-TS-MIB", radiusSecret2=radiusSecret2, terminalType=terminalType, bytesReceiveFromV24=bytesReceiveFromV24, nbParStop=nbParStop, authRad1=authRad1, ethernetAddress=ethernetAddress, baudRate=baudRate, ipNetmask=ipNetmask, afterSend=afterSend, system=system, tcpPort=tcpPort, statusDTR=statusDTR, reset=reset, slaveHexaAddress=slaveHexaAddress, radiusServer2=radiusServer2, formFeed=formFeed, radiusSecret1=radiusSecret1, remoteIpAddress=remoteIpAddress, nameResolution=nameResolution, endMsg=endMsg, snmpdService=snmpdService, nameServer1=nameServer1, beforeSend=beforeSend, rxIdle=rxIdle, acctRad2=acctRad2, cxr=cxr, secondTcpPort=secondTcpPort, ipServer=ipServer, txIdle=txIdle, gatewayToRemote=gatewayToRemote, sessionStarted=sessionStarted, modbusType=modbusType, productName=productName, aliasIpAddress=aliasIpAddress, portStatsTable=portStatsTable, resetByButton=resetByButton, timeoutPAD=timeoutPAD, authType=authType, portReset=portReset, snmpTrapAddr2=snmpTrapAddr2, nameServer2=nameServer2, portTable=portTable, secondIpAddress=secondIpAddress, slaveIPaddr=slaveIPaddr, snmpTrapAddr1=snmpTrapAddr1, sessionStopped=sessionStopped, modbusTable=modbusTable, dtrDown=dtrDown, acctRad1=acctRad1, modbusEntry=modbusEntry, aliasIpNetmask=aliasIpNetmask, remoteTcpPort=remoteTcpPort, version=version, bootp=bootp, interFrame=interFrame, flowControl=flowControl, multiSession=multiSession, radiusServer1=radiusServer1, secondGateway=secondGateway, ftpdService=ftpdService, bytesSendToV24=bytesSendToV24, dtrUp=dtrUp, slaveIPport=slaveIPport, mainIpAddress=mainIpAddress, httpdService=httpdService, portIndex=portIndex, authRad2=authRad2, modbusMode=modbusMode, portEntry=portEntry, portStatsEntry=portStatsEntry, ipGateway=ipGateway, ts=ts, siteName=siteName, snmpTrap=snmpTrap, mode=mode, timeoutRxTx=timeoutRxTx, telnetdService=telnetdService)
