...
# Produced by pysmi-1.1.8 at Mon Jan  9 10:12:21 2023
...
NotificationType, MibIdentifier, enterprises, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, Unsigned32, NotificationType, TimeTicks, iso, Counter64, IpAddress, Counter32, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "enterprises", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "NotificationType", "TimeTicks", "iso", "Counter64", "IpAddress", "Counter32", "Bits", "Integer32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", radiusSecret1=radiusSecret1, snmpdService=snmpdService, terminalType=terminalType, nameServer1=nameServer1, nbParStop=nbParStop, endMsg=endMsg, ipServer=ipServer, telnetdService=telnetdService, secondIpAddress=secondIpAddress, rxIdle=rxIdle, multiSession=multiSession, portEntry=portEntry, aliasIpAddress=aliasIpAddress, snmpTrapAddr2=snmpTrapAddr2, modbusMode=modbusMode, authType=authType, acctRad2=acctRad2, sessionStopped=sessionStopped, portStatsTable=portStatsTable, siteName=siteName, beforeSend=beforeSend, formFeed=formFeed, modbusType=modbusType, authRad2=authRad2, secondGateway=secondGateway, gatewayToRemote=gatewayToRemote, system=system, bytesReceiveFromV24=bytesReceiveFromV24, snmpTrapAddr1=snmpTrapAddr1, ts=ts, radiusSecret2=radiusSecret2, resetByButton=resetByButton, slaveIPaddr=slaveIPaddr, modbusTable=modbusTable, nameResolution=nameResolution, flowControl=flowControl, acctRad1=acctRad1, slaveHexaAddress=slaveHexaAddress, snmpTrap=snmpTrap, mode=mode, bytesSendToV24=bytesSendToV24, ipNetmask=ipNetmask, bootp=bootp, modbusEntry=modbusEntry, sessionStarted=sessionStarted, radiusServer1=radiusServer1, ethernetAddress=ethernetAddress, timeoutPAD=timeoutPAD, nameServer2=nameServer2, reset=reset, tcpPort=tcpPort, productName=productName, radiusServer2=radiusServer2, version=version, secondTcpPort=secondTcpPort, statusDTR=statusDTR, cxr=cxr, interFrame=interFrame, aliasIpNetmask=aliasIpNetmask, ipGateway=ipGateway, dtrDown=dtrDown, txIdle=txIdle, authRad1=authRad1, portStatsEntry=portStatsEntry, dtrUp=dtrUp, timeoutRxTx=timeoutRxTx, portTable=portTable, httpdService=httpdService, remoteIpAddress=remoteIpAddress, remoteTcpPort=remoteTcpPort, afterSend=afterSend, mainIpAddress=mainIpAddress, slaveIPport=slaveIPport, portIndex=portIndex, baudRate=baudRate, ftpdService=ftpdService, portReset=portReset)
