...
# Produced by pysmi-1.1.11 at Wed Apr  3 13:56:50 2024
...
NotificationType, ModuleIdentity, Integer32, MibIdentifier, IpAddress, iso, Gauge32, Unsigned32, NotificationType, ObjectIdentity, enterprises, Counter32, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Integer32", "MibIdentifier", "IpAddress", "iso", "Gauge32", "Unsigned32", "NotificationType", "ObjectIdentity", "enterprises", "Counter32", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("CXR-TS-MIB", snmpTrapAddr2=snmpTrapAddr2, baudRate=baudRate, modbusType=modbusType, sessionStopped=sessionStopped, dtrUp=dtrUp, tcpPort=tcpPort, beforeSend=beforeSend, multiSession=multiSession, statusDTR=statusDTR, terminalType=terminalType, portTable=portTable, nameServer1=nameServer1, portReset=portReset, ts=ts, sessionStarted=sessionStarted, snmpTrap=snmpTrap, interFrame=interFrame, reset=reset, bootp=bootp, snmpdService=snmpdService, modbusMode=modbusMode, httpdService=httpdService, gatewayToRemote=gatewayToRemote, aliasIpAddress=aliasIpAddress, remoteTcpPort=remoteTcpPort, modbusEntry=modbusEntry, endMsg=endMsg, rxIdle=rxIdle, secondIpAddress=secondIpAddress, productName=productName, ethernetAddress=ethernetAddress, ftpdService=ftpdService, modbusTable=modbusTable, afterSend=afterSend, snmpTrapAddr1=snmpTrapAddr1, timeoutPAD=timeoutPAD, ipServer=ipServer, authRad2=authRad2, bytesSendToV24=bytesSendToV24, txIdle=txIdle, version=version, slaveHexaAddress=slaveHexaAddress, radiusServer2=radiusServer2, portEntry=portEntry, resetByButton=resetByButton, flowControl=flowControl, ipNetmask=ipNetmask, system=system, siteName=siteName, slaveIPport=slaveIPport, radiusServer1=radiusServer1, formFeed=formFeed, timeoutRxTx=timeoutRxTx, mainIpAddress=mainIpAddress, portStatsEntry=portStatsEntry, secondGateway=secondGateway, portStatsTable=portStatsTable, nameResolution=nameResolution, radiusSecret1=radiusSecret1, slaveIPaddr=slaveIPaddr, nameServer2=nameServer2, ipGateway=ipGateway, dtrDown=dtrDown, cxr=cxr, telnetdService=telnetdService, portIndex=portIndex, secondTcpPort=secondTcpPort, aliasIpNetmask=aliasIpNetmask, authRad1=authRad1, acctRad2=acctRad2, authType=authType, mode=mode, radiusSecret2=radiusSecret2, nbParStop=nbParStop, bytesReceiveFromV24=bytesReceiveFromV24, acctRad1=acctRad1, remoteIpAddress=remoteIpAddress)
