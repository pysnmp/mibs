...
# Produced by pysmi-1.1.8 at Mon Jan 17 17:50:13 2022
...
ModuleIdentity, iso, TimeTicks, Counter32, enterprises, Integer32, Counter64, NotificationType, ObjectIdentity, Unsigned32, NotificationType, IpAddress, Gauge32, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "TimeTicks", "Counter32", "enterprises", "Integer32", "Counter64", "NotificationType", "ObjectIdentity", "Unsigned32", "NotificationType", "IpAddress", "Gauge32", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CXR-TS-MIB", timeoutPAD=timeoutPAD, portIndex=portIndex, baudRate=baudRate, modbusEntry=modbusEntry, bytesSendToV24=bytesSendToV24, flowControl=flowControl, aliasIpAddress=aliasIpAddress, sessionStarted=sessionStarted, timeoutRxTx=timeoutRxTx, system=system, telnetdService=telnetdService, ipGateway=ipGateway, dtrDown=dtrDown, resetByButton=resetByButton, endMsg=endMsg, sessionStopped=sessionStopped, productName=productName, acctRad2=acctRad2, modbusMode=modbusMode, secondIpAddress=secondIpAddress, portTable=portTable, snmpTrap=snmpTrap, nameResolution=nameResolution, nameServer1=nameServer1, terminalType=terminalType, modbusTable=modbusTable, reset=reset, secondTcpPort=secondTcpPort, radiusServer1=radiusServer1, ethernetAddress=ethernetAddress, ipServer=ipServer, remoteIpAddress=remoteIpAddress, afterSend=afterSend, nameServer2=nameServer2, multiSession=multiSession, authRad2=authRad2, slaveHexaAddress=slaveHexaAddress, radiusSecret2=radiusSecret2, slaveIPport=slaveIPport, secondGateway=secondGateway, snmpdService=snmpdService, ipNetmask=ipNetmask, ts=ts, mainIpAddress=mainIpAddress, txIdle=txIdle, interFrame=interFrame, modbusType=modbusType, remoteTcpPort=remoteTcpPort, portEntry=portEntry, mode=mode, cxr=cxr, gatewayToRemote=gatewayToRemote, snmpTrapAddr1=snmpTrapAddr1, bytesReceiveFromV24=bytesReceiveFromV24, formFeed=formFeed, acctRad1=acctRad1, beforeSend=beforeSend, httpdService=httpdService, rxIdle=rxIdle, bootp=bootp, radiusSecret1=radiusSecret1, dtrUp=dtrUp, portStatsTable=portStatsTable, version=version, slaveIPaddr=slaveIPaddr, authRad1=authRad1, ftpdService=ftpdService, siteName=siteName, radiusServer2=radiusServer2, aliasIpNetmask=aliasIpNetmask, authType=authType, portStatsEntry=portStatsEntry, portReset=portReset, nbParStop=nbParStop, tcpPort=tcpPort, statusDTR=statusDTR, snmpTrapAddr2=snmpTrapAddr2)
