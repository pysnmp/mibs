...
# Produced by pysmi-1.1.8 at Thu Apr 27 12:08:14 2023
...
ModuleIdentity, ObjectIdentity, NotificationType, IpAddress, Unsigned32, MibIdentifier, Integer32, Counter64, iso, TimeTicks, NotificationType, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "NotificationType", "IpAddress", "Unsigned32", "MibIdentifier", "Integer32", "Counter64", "iso", "TimeTicks", "NotificationType", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "Bits")
...
mibBuilder.exportSymbols("CXR-TS-MIB", authRad1=authRad1, acctRad2=acctRad2, portReset=portReset, cxr=cxr, mainIpAddress=mainIpAddress, beforeSend=beforeSend, aliasIpAddress=aliasIpAddress, nbParStop=nbParStop, sessionStopped=sessionStopped, radiusSecret1=radiusSecret1, telnetdService=telnetdService, version=version, system=system, modbusEntry=modbusEntry, timeoutPAD=timeoutPAD, dtrDown=dtrDown, portStatsTable=portStatsTable, slaveHexaAddress=slaveHexaAddress, formFeed=formFeed, ts=ts, ftpdService=ftpdService, statusDTR=statusDTR, ethernetAddress=ethernetAddress, secondGateway=secondGateway, modbusTable=modbusTable, ipServer=ipServer, siteName=siteName, modbusMode=modbusMode, endMsg=endMsg, terminalType=terminalType, portIndex=portIndex, portStatsEntry=portStatsEntry, bytesReceiveFromV24=bytesReceiveFromV24, bootp=bootp, multiSession=multiSession, authRad2=authRad2, slaveIPport=slaveIPport, baudRate=baudRate, rxIdle=rxIdle, nameServer2=nameServer2, radiusSecret2=radiusSecret2, nameResolution=nameResolution, snmpdService=snmpdService, gatewayToRemote=gatewayToRemote, bytesSendToV24=bytesSendToV24, secondIpAddress=secondIpAddress, reset=reset, productName=productName, resetByButton=resetByButton, dtrUp=dtrUp, httpdService=httpdService, tcpPort=tcpPort, mode=mode, snmpTrapAddr2=snmpTrapAddr2, interFrame=interFrame, ipGateway=ipGateway, nameServer1=nameServer1, flowControl=flowControl, radiusServer2=radiusServer2, secondTcpPort=secondTcpPort, portTable=portTable, snmpTrapAddr1=snmpTrapAddr1, sessionStarted=sessionStarted, radiusServer1=radiusServer1, remoteTcpPort=remoteTcpPort, modbusType=modbusType, portEntry=portEntry, slaveIPaddr=slaveIPaddr, aliasIpNetmask=aliasIpNetmask, snmpTrap=snmpTrap, ipNetmask=ipNetmask, authType=authType, timeoutRxTx=timeoutRxTx, acctRad1=acctRad1, remoteIpAddress=remoteIpAddress, afterSend=afterSend, txIdle=txIdle)
