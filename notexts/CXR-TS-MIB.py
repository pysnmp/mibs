...
# Produced by pysmi-1.1.8 at Tue Sep 12 07:23:06 2023
...
Bits, enterprises, ModuleIdentity, ObjectIdentity, IpAddress, Counter32, Unsigned32, NotificationType, MibIdentifier, Counter64, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "enterprises", "ModuleIdentity", "ObjectIdentity", "IpAddress", "Counter32", "Unsigned32", "NotificationType", "MibIdentifier", "Counter64", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "Integer32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", secondGateway=secondGateway, sessionStarted=sessionStarted, productName=productName, cxr=cxr, dtrUp=dtrUp, afterSend=afterSend, timeoutRxTx=timeoutRxTx, statusDTR=statusDTR, snmpdService=snmpdService, mainIpAddress=mainIpAddress, formFeed=formFeed, secondTcpPort=secondTcpPort, ftpdService=ftpdService, sessionStopped=sessionStopped, txIdle=txIdle, beforeSend=beforeSend, terminalType=terminalType, ipServer=ipServer, authRad2=authRad2, snmpTrapAddr1=snmpTrapAddr1, bootp=bootp, authType=authType, timeoutPAD=timeoutPAD, authRad1=authRad1, modbusTable=modbusTable, ethernetAddress=ethernetAddress, system=system, rxIdle=rxIdle, radiusSecret1=radiusSecret1, gatewayToRemote=gatewayToRemote, remoteTcpPort=remoteTcpPort, acctRad2=acctRad2, snmpTrap=snmpTrap, slaveIPport=slaveIPport, ts=ts, multiSession=multiSession, nameServer1=nameServer1, aliasIpAddress=aliasIpAddress, modbusType=modbusType, radiusServer1=radiusServer1, acctRad1=acctRad1, interFrame=interFrame, flowControl=flowControl, portEntry=portEntry, telnetdService=telnetdService, snmpTrapAddr2=snmpTrapAddr2, bytesSendToV24=bytesSendToV24, modbusEntry=modbusEntry, secondIpAddress=secondIpAddress, portReset=portReset, bytesReceiveFromV24=bytesReceiveFromV24, resetByButton=resetByButton, radiusServer2=radiusServer2, slaveIPaddr=slaveIPaddr, nameResolution=nameResolution, portIndex=portIndex, reset=reset, radiusSecret2=radiusSecret2, portStatsTable=portStatsTable, version=version, ipGateway=ipGateway, slaveHexaAddress=slaveHexaAddress, modbusMode=modbusMode, dtrDown=dtrDown, nbParStop=nbParStop, siteName=siteName, portTable=portTable, baudRate=baudRate, aliasIpNetmask=aliasIpNetmask, mode=mode, remoteIpAddress=remoteIpAddress, endMsg=endMsg, tcpPort=tcpPort, ipNetmask=ipNetmask, nameServer2=nameServer2, portStatsEntry=portStatsEntry, httpdService=httpdService)
