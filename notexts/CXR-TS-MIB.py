...
# Produced by pysmi-1.1.8 at Fri Sep  8 11:04:33 2023
...
iso, ModuleIdentity, Unsigned32, Gauge32, Bits, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, NotificationType, Integer32, TimeTicks, enterprises, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "Unsigned32", "Gauge32", "Bits", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "NotificationType", "Integer32", "TimeTicks", "enterprises", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("CXR-TS-MIB", nameServer2=nameServer2, mainIpAddress=mainIpAddress, rxIdle=rxIdle, mode=mode, ipGateway=ipGateway, radiusServer1=radiusServer1, remoteIpAddress=remoteIpAddress, telnetdService=telnetdService, portIndex=portIndex, snmpTrapAddr1=snmpTrapAddr1, aliasIpNetmask=aliasIpNetmask, radiusServer2=radiusServer2, txIdle=txIdle, sessionStarted=sessionStarted, ipNetmask=ipNetmask, nameServer1=nameServer1, radiusSecret2=radiusSecret2, ftpdService=ftpdService, dtrDown=dtrDown, reset=reset, bytesReceiveFromV24=bytesReceiveFromV24, nameResolution=nameResolution, formFeed=formFeed, aliasIpAddress=aliasIpAddress, dtrUp=dtrUp, version=version, nbParStop=nbParStop, system=system, cxr=cxr, ethernetAddress=ethernetAddress, flowControl=flowControl, timeoutRxTx=timeoutRxTx, authRad2=authRad2, radiusSecret1=radiusSecret1, afterSend=afterSend, acctRad2=acctRad2, authRad1=authRad1, interFrame=interFrame, slaveHexaAddress=slaveHexaAddress, multiSession=multiSession, secondIpAddress=secondIpAddress, bytesSendToV24=bytesSendToV24, baudRate=baudRate, beforeSend=beforeSend, secondGateway=secondGateway, portTable=portTable, timeoutPAD=timeoutPAD, snmpdService=snmpdService, portEntry=portEntry, snmpTrapAddr2=snmpTrapAddr2, modbusType=modbusType, slaveIPaddr=slaveIPaddr, portStatsTable=portStatsTable, portReset=portReset, slaveIPport=slaveIPport, tcpPort=tcpPort, productName=productName, resetByButton=resetByButton, snmpTrap=snmpTrap, statusDTR=statusDTR, sessionStopped=sessionStopped, modbusTable=modbusTable, secondTcpPort=secondTcpPort, modbusEntry=modbusEntry, endMsg=endMsg, remoteTcpPort=remoteTcpPort, siteName=siteName, ts=ts, portStatsEntry=portStatsEntry, gatewayToRemote=gatewayToRemote, httpdService=httpdService, bootp=bootp, ipServer=ipServer, terminalType=terminalType, acctRad1=acctRad1, modbusMode=modbusMode, authType=authType)
