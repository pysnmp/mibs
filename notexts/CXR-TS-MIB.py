...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:51:54 2022
...
NotificationType, Counter32, ObjectIdentity, IpAddress, NotificationType, Gauge32, Unsigned32, Integer32, iso, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, MibIdentifier, Bits, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "ObjectIdentity", "IpAddress", "NotificationType", "Gauge32", "Unsigned32", "Integer32", "iso", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "MibIdentifier", "Bits", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("CXR-TS-MIB", nameServer1=nameServer1, statusDTR=statusDTR, radiusSecret1=radiusSecret1, siteName=siteName, beforeSend=beforeSend, bootp=bootp, radiusServer1=radiusServer1, terminalType=terminalType, multiSession=multiSession, productName=productName, slaveIPaddr=slaveIPaddr, endMsg=endMsg, bytesSendToV24=bytesSendToV24, formFeed=formFeed, flowControl=flowControl, authRad2=authRad2, aliasIpAddress=aliasIpAddress, modbusType=modbusType, interFrame=interFrame, ftpdService=ftpdService, modbusTable=modbusTable, portReset=portReset, ipNetmask=ipNetmask, txIdle=txIdle, version=version, acctRad2=acctRad2, gatewayToRemote=gatewayToRemote, sessionStopped=sessionStopped, portTable=portTable, sessionStarted=sessionStarted, modbusMode=modbusMode, timeoutPAD=timeoutPAD, modbusEntry=modbusEntry, nbParStop=nbParStop, dtrUp=dtrUp, timeoutRxTx=timeoutRxTx, telnetdService=telnetdService, aliasIpNetmask=aliasIpNetmask, nameResolution=nameResolution, mode=mode, slaveIPport=slaveIPport, tcpPort=tcpPort, secondTcpPort=secondTcpPort, portEntry=portEntry, portStatsEntry=portStatsEntry, secondIpAddress=secondIpAddress, rxIdle=rxIdle, ipGateway=ipGateway, resetByButton=resetByButton, mainIpAddress=mainIpAddress, reset=reset, authType=authType, ethernetAddress=ethernetAddress, system=system, dtrDown=dtrDown, snmpTrap=snmpTrap, radiusSecret2=radiusSecret2, portStatsTable=portStatsTable, remoteIpAddress=remoteIpAddress, authRad1=authRad1, httpdService=httpdService, slaveHexaAddress=slaveHexaAddress, snmpTrapAddr1=snmpTrapAddr1, acctRad1=acctRad1, radiusServer2=radiusServer2, secondGateway=secondGateway, cxr=cxr, bytesReceiveFromV24=bytesReceiveFromV24, baudRate=baudRate, ts=ts, nameServer2=nameServer2, remoteTcpPort=remoteTcpPort, snmpdService=snmpdService, snmpTrapAddr2=snmpTrapAddr2, ipServer=ipServer, portIndex=portIndex, afterSend=afterSend)
