...
# Produced by pysmi-1.1.8 at Mon Jan  9 09:49:11 2023
...
Counter32, iso, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, TimeTicks, ObjectIdentity, Integer32, ModuleIdentity, Unsigned32, NotificationType, Gauge32, Counter64, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "TimeTicks", "ObjectIdentity", "Integer32", "ModuleIdentity", "Unsigned32", "NotificationType", "Gauge32", "Counter64", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("CXR-TS-MIB", terminalType=terminalType, sessionStarted=sessionStarted, secondIpAddress=secondIpAddress, portStatsTable=portStatsTable, portTable=portTable, formFeed=formFeed, modbusEntry=modbusEntry, remoteIpAddress=remoteIpAddress, multiSession=multiSession, snmpTrapAddr2=snmpTrapAddr2, flowControl=flowControl, radiusServer1=radiusServer1, secondTcpPort=secondTcpPort, beforeSend=beforeSend, mainIpAddress=mainIpAddress, modbusType=modbusType, ipGateway=ipGateway, siteName=siteName, interFrame=interFrame, portReset=portReset, portStatsEntry=portStatsEntry, modbusMode=modbusMode, gatewayToRemote=gatewayToRemote, resetByButton=resetByButton, httpdService=httpdService, dtrDown=dtrDown, remoteTcpPort=remoteTcpPort, telnetdService=telnetdService, snmpdService=snmpdService, ethernetAddress=ethernetAddress, mode=mode, statusDTR=statusDTR, endMsg=endMsg, afterSend=afterSend, system=system, txIdle=txIdle, timeoutRxTx=timeoutRxTx, acctRad2=acctRad2, snmpTrapAddr1=snmpTrapAddr1, timeoutPAD=timeoutPAD, authRad1=authRad1, ipServer=ipServer, version=version, radiusServer2=radiusServer2, dtrUp=dtrUp, portEntry=portEntry, nameServer2=nameServer2, authRad2=authRad2, ts=ts, slaveIPaddr=slaveIPaddr, acctRad1=acctRad1, portIndex=portIndex, aliasIpAddress=aliasIpAddress, bytesReceiveFromV24=bytesReceiveFromV24, radiusSecret2=radiusSecret2, snmpTrap=snmpTrap, reset=reset, nbParStop=nbParStop, nameServer1=nameServer1, bytesSendToV24=bytesSendToV24, radiusSecret1=radiusSecret1, baudRate=baudRate, rxIdle=rxIdle, slaveIPport=slaveIPport, sessionStopped=sessionStopped, nameResolution=nameResolution, secondGateway=secondGateway, productName=productName, authType=authType, modbusTable=modbusTable, ftpdService=ftpdService, bootp=bootp, tcpPort=tcpPort, ipNetmask=ipNetmask, cxr=cxr, slaveHexaAddress=slaveHexaAddress, aliasIpNetmask=aliasIpNetmask)
