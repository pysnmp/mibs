...
# Produced by pysmi-1.1.8 at Thu Sep 15 10:01:04 2022
...
ObjectIdentity, Unsigned32, Counter64, MibIdentifier, IpAddress, Integer32, Gauge32, ModuleIdentity, iso, Bits, enterprises, NotificationType, Counter32, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "Counter64", "MibIdentifier", "IpAddress", "Integer32", "Gauge32", "ModuleIdentity", "iso", "Bits", "enterprises", "NotificationType", "Counter32", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CXR-TS-MIB", portTable=portTable, radiusSecret1=radiusSecret1, mainIpAddress=mainIpAddress, mode=mode, version=version, ipServer=ipServer, remoteTcpPort=remoteTcpPort, telnetdService=telnetdService, portReset=portReset, nameServer1=nameServer1, snmpTrapAddr1=snmpTrapAddr1, authRad2=authRad2, modbusTable=modbusTable, acctRad1=acctRad1, slaveHexaAddress=slaveHexaAddress, snmpTrap=snmpTrap, sessionStarted=sessionStarted, multiSession=multiSession, afterSend=afterSend, flowControl=flowControl, beforeSend=beforeSend, slaveIPaddr=slaveIPaddr, bootp=bootp, formFeed=formFeed, bytesReceiveFromV24=bytesReceiveFromV24, portIndex=portIndex, modbusType=modbusType, secondGateway=secondGateway, nbParStop=nbParStop, terminalType=terminalType, radiusServer1=radiusServer1, portEntry=portEntry, acctRad2=acctRad2, nameServer2=nameServer2, timeoutRxTx=timeoutRxTx, ipNetmask=ipNetmask, timeoutPAD=timeoutPAD, statusDTR=statusDTR, system=system, productName=productName, txIdle=txIdle, sessionStopped=sessionStopped, radiusSecret2=radiusSecret2, secondTcpPort=secondTcpPort, endMsg=endMsg, aliasIpNetmask=aliasIpNetmask, dtrUp=dtrUp, bytesSendToV24=bytesSendToV24, resetByButton=resetByButton, ts=ts, gatewayToRemote=gatewayToRemote, ipGateway=ipGateway, interFrame=interFrame, baudRate=baudRate, cxr=cxr, snmpTrapAddr2=snmpTrapAddr2, nameResolution=nameResolution, radiusServer2=radiusServer2, authRad1=authRad1, secondIpAddress=secondIpAddress, authType=authType, modbusMode=modbusMode, rxIdle=rxIdle, remoteIpAddress=remoteIpAddress, ftpdService=ftpdService, reset=reset, tcpPort=tcpPort, siteName=siteName, aliasIpAddress=aliasIpAddress, modbusEntry=modbusEntry, ethernetAddress=ethernetAddress, httpdService=httpdService, portStatsTable=portStatsTable, dtrDown=dtrDown, portStatsEntry=portStatsEntry, slaveIPport=slaveIPport, snmpdService=snmpdService)
