...
# Produced by pysmi-1.1.8 at Tue Jul 26 16:12:22 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, ModuleIdentity, IpAddress, Counter32, NotificationType, Gauge32, enterprises, Bits, TimeTicks, ObjectIdentity, Counter64, MibIdentifier, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "ModuleIdentity", "IpAddress", "Counter32", "NotificationType", "Gauge32", "enterprises", "Bits", "TimeTicks", "ObjectIdentity", "Counter64", "MibIdentifier", "iso", "NotificationType")
...
mibBuilder.exportSymbols("CXR-TS-MIB", txIdle=txIdle, terminalType=terminalType, bytesReceiveFromV24=bytesReceiveFromV24, snmpTrapAddr2=snmpTrapAddr2, beforeSend=beforeSend, portIndex=portIndex, baudRate=baudRate, snmpTrapAddr1=snmpTrapAddr1, gatewayToRemote=gatewayToRemote, cxr=cxr, snmpdService=snmpdService, ipGateway=ipGateway, portStatsEntry=portStatsEntry, portEntry=portEntry, dtrUp=dtrUp, formFeed=formFeed, statusDTR=statusDTR, mode=mode, slaveIPaddr=slaveIPaddr, sessionStopped=sessionStopped, acctRad2=acctRad2, aliasIpNetmask=aliasIpNetmask, acctRad1=acctRad1, timeoutRxTx=timeoutRxTx, aliasIpAddress=aliasIpAddress, interFrame=interFrame, bootp=bootp, ftpdService=ftpdService, authRad1=authRad1, ethernetAddress=ethernetAddress, nbParStop=nbParStop, timeoutPAD=timeoutPAD, nameServer2=nameServer2, endMsg=endMsg, authRad2=authRad2, httpdService=httpdService, siteName=siteName, modbusEntry=modbusEntry, resetByButton=resetByButton, secondGateway=secondGateway, radiusServer1=radiusServer1, ipServer=ipServer, telnetdService=telnetdService, modbusMode=modbusMode, system=system, secondIpAddress=secondIpAddress, ipNetmask=ipNetmask, flowControl=flowControl, modbusType=modbusType, rxIdle=rxIdle, modbusTable=modbusTable, nameServer1=nameServer1, reset=reset, portTable=portTable, sessionStarted=sessionStarted, ts=ts, version=version, remoteIpAddress=remoteIpAddress, snmpTrap=snmpTrap, radiusSecret1=radiusSecret1, tcpPort=tcpPort, multiSession=multiSession, radiusSecret2=radiusSecret2, afterSend=afterSend, secondTcpPort=secondTcpPort, bytesSendToV24=bytesSendToV24, dtrDown=dtrDown, mainIpAddress=mainIpAddress, authType=authType, portReset=portReset, nameResolution=nameResolution, productName=productName, slaveIPport=slaveIPport, radiusServer2=radiusServer2, remoteTcpPort=remoteTcpPort, slaveHexaAddress=slaveHexaAddress, portStatsTable=portStatsTable)
