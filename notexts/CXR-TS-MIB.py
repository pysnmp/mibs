...
# Produced by pysmi-1.1.12 at Tue Jun  4 08:16:31 2024
...
Counter32, MibIdentifier, iso, NotificationType, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, enterprises, ObjectIdentity, Unsigned32, ModuleIdentity, Gauge32, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "iso", "NotificationType", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "enterprises", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Gauge32", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("CXR-TS-MIB", portStatsTable=portStatsTable, snmpTrapAddr1=snmpTrapAddr1, mainIpAddress=mainIpAddress, beforeSend=beforeSend, portEntry=portEntry, bytesReceiveFromV24=bytesReceiveFromV24, afterSend=afterSend, nbParStop=nbParStop, sessionStarted=sessionStarted, nameServer1=nameServer1, portReset=portReset, baudRate=baudRate, portStatsEntry=portStatsEntry, acctRad2=acctRad2, aliasIpNetmask=aliasIpNetmask, modbusType=modbusType, dtrDown=dtrDown, slaveIPport=slaveIPport, remoteTcpPort=remoteTcpPort, secondTcpPort=secondTcpPort, txIdle=txIdle, snmpdService=snmpdService, sessionStopped=sessionStopped, siteName=siteName, portTable=portTable, tcpPort=tcpPort, remoteIpAddress=remoteIpAddress, interFrame=interFrame, modbusTable=modbusTable, mode=mode, acctRad1=acctRad1, ftpdService=ftpdService, radiusSecret2=radiusSecret2, httpdService=httpdService, timeoutPAD=timeoutPAD, slaveHexaAddress=slaveHexaAddress, modbusEntry=modbusEntry, authType=authType, dtrUp=dtrUp, gatewayToRemote=gatewayToRemote, cxr=cxr, slaveIPaddr=slaveIPaddr, portIndex=portIndex, authRad2=authRad2, flowControl=flowControl, ethernetAddress=ethernetAddress, ipNetmask=ipNetmask, reset=reset, aliasIpAddress=aliasIpAddress, modbusMode=modbusMode, ts=ts, multiSession=multiSession, nameResolution=nameResolution, system=system, endMsg=endMsg, radiusSecret1=radiusSecret1, version=version, secondGateway=secondGateway, bytesSendToV24=bytesSendToV24, ipGateway=ipGateway, nameServer2=nameServer2, radiusServer2=radiusServer2, rxIdle=rxIdle, bootp=bootp, resetByButton=resetByButton, authRad1=authRad1, telnetdService=telnetdService, snmpTrap=snmpTrap, snmpTrapAddr2=snmpTrapAddr2, secondIpAddress=secondIpAddress, productName=productName, timeoutRxTx=timeoutRxTx, statusDTR=statusDTR, radiusServer1=radiusServer1, ipServer=ipServer, formFeed=formFeed, terminalType=terminalType)
