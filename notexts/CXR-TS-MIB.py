...
ObjectIdentity, Unsigned32, NotificationType, NotificationType, Gauge32, MibIdentifier, Counter64, Counter32, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, enterprises, Integer32, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "NotificationType", "NotificationType", "Gauge32", "MibIdentifier", "Counter64", "Counter32", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "enterprises", "Integer32", "iso", "IpAddress")
...
mibBuilder.exportSymbols("CXR-TS-MIB", ipGateway=ipGateway, sessionStarted=sessionStarted, cxr=cxr, modbusType=modbusType, httpdService=httpdService, telnetdService=telnetdService, authRad2=authRad2, system=system, secondTcpPort=secondTcpPort, ethernetAddress=ethernetAddress, dtrDown=dtrDown, radiusSecret1=radiusSecret1, resetByButton=resetByButton, portReset=portReset, slaveIPaddr=slaveIPaddr, endMsg=endMsg, secondIpAddress=secondIpAddress, mode=mode, radiusServer1=radiusServer1, secondGateway=secondGateway, modbusMode=modbusMode, bytesReceiveFromV24=bytesReceiveFromV24, dtrUp=dtrUp, portEntry=portEntry, nameServer1=nameServer1, rxIdle=rxIdle, beforeSend=beforeSend, nameServer2=nameServer2, portStatsTable=portStatsTable, gatewayToRemote=gatewayToRemote, afterSend=afterSend, formFeed=formFeed, snmpTrapAddr1=snmpTrapAddr1, txIdle=txIdle, mainIpAddress=mainIpAddress, baudRate=baudRate, acctRad1=acctRad1, aliasIpAddress=aliasIpAddress, portTable=portTable, interFrame=interFrame, radiusSecret2=radiusSecret2, siteName=siteName, modbusEntry=modbusEntry, radiusServer2=radiusServer2, snmpdService=snmpdService, authType=authType, bytesSendToV24=bytesSendToV24, portStatsEntry=portStatsEntry, acctRad2=acctRad2, sessionStopped=sessionStopped, flowControl=flowControl, multiSession=multiSession, timeoutPAD=timeoutPAD, modbusTable=modbusTable, nameResolution=nameResolution, bootp=bootp, portIndex=portIndex, snmpTrap=snmpTrap, terminalType=terminalType, snmpTrapAddr2=snmpTrapAddr2, remoteIpAddress=remoteIpAddress, reset=reset, slaveHexaAddress=slaveHexaAddress, timeoutRxTx=timeoutRxTx, authRad1=authRad1, productName=productName, ipNetmask=ipNetmask, statusDTR=statusDTR, ts=ts, slaveIPport=slaveIPport, nbParStop=nbParStop, aliasIpNetmask=aliasIpNetmask, ftpdService=ftpdService, version=version, remoteTcpPort=remoteTcpPort, ipServer=ipServer, tcpPort=tcpPort)
