...
NotificationType, MibIdentifier, Unsigned32, Counter32, Bits, TimeTicks, iso, NotificationType, Gauge32, ModuleIdentity, Counter64, ObjectIdentity, IpAddress, Integer32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "Unsigned32", "Counter32", "Bits", "TimeTicks", "iso", "NotificationType", "Gauge32", "ModuleIdentity", "Counter64", "ObjectIdentity", "IpAddress", "Integer32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CXR-TS-MIB", system=system, acctRad2=acctRad2, nameResolution=nameResolution, cxr=cxr, snmpTrap=snmpTrap, ipGateway=ipGateway, authRad1=authRad1, modbusMode=modbusMode, mainIpAddress=mainIpAddress, bytesSendToV24=bytesSendToV24, portIndex=portIndex, aliasIpNetmask=aliasIpNetmask, ipServer=ipServer, ts=ts, acctRad1=acctRad1, portStatsEntry=portStatsEntry, nameServer2=nameServer2, slaveHexaAddress=slaveHexaAddress, timeoutPAD=timeoutPAD, telnetdService=telnetdService, bootp=bootp, radiusSecret1=radiusSecret1, endMsg=endMsg, beforeSend=beforeSend, productName=productName, ethernetAddress=ethernetAddress, radiusServer1=radiusServer1, modbusTable=modbusTable, dtrUp=dtrUp, terminalType=terminalType, bytesReceiveFromV24=bytesReceiveFromV24, ipNetmask=ipNetmask, statusDTR=statusDTR, interFrame=interFrame, snmpTrapAddr1=snmpTrapAddr1, multiSession=multiSession, version=version, sessionStarted=sessionStarted, secondGateway=secondGateway, formFeed=formFeed, remoteTcpPort=remoteTcpPort, baudRate=baudRate, authType=authType, dtrDown=dtrDown, siteName=siteName, slaveIPaddr=slaveIPaddr, portTable=portTable, slaveIPport=slaveIPport, nbParStop=nbParStop, gatewayToRemote=gatewayToRemote, remoteIpAddress=remoteIpAddress, flowControl=flowControl, afterSend=afterSend, portEntry=portEntry, snmpTrapAddr2=snmpTrapAddr2, ftpdService=ftpdService, aliasIpAddress=aliasIpAddress, httpdService=httpdService, reset=reset, timeoutRxTx=timeoutRxTx, portStatsTable=portStatsTable, mode=mode, nameServer1=nameServer1, resetByButton=resetByButton, radiusSecret2=radiusSecret2, radiusServer2=radiusServer2, portReset=portReset, txIdle=txIdle, secondTcpPort=secondTcpPort, authRad2=authRad2, modbusEntry=modbusEntry, tcpPort=tcpPort, secondIpAddress=secondIpAddress, snmpdService=snmpdService, rxIdle=rxIdle, modbusType=modbusType, sessionStopped=sessionStopped)
