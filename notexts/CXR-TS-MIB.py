...
# Produced by pysmi-1.1.12 at Tue Jun  4 10:06:52 2024
...
Unsigned32, NotificationType, IpAddress, Integer32, Bits, NotificationType, ModuleIdentity, TimeTicks, enterprises, iso, Gauge32, MibIdentifier, Counter64, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "IpAddress", "Integer32", "Bits", "NotificationType", "ModuleIdentity", "TimeTicks", "enterprises", "iso", "Gauge32", "MibIdentifier", "Counter64", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CXR-TS-MIB", flowControl=flowControl, timeoutRxTx=timeoutRxTx, version=version, portTable=portTable, dtrDown=dtrDown, baudRate=baudRate, authType=authType, multiSession=multiSession, statusDTR=statusDTR, remoteTcpPort=remoteTcpPort, secondGateway=secondGateway, secondTcpPort=secondTcpPort, nbParStop=nbParStop, httpdService=httpdService, modbusType=modbusType, ipServer=ipServer, authRad1=authRad1, acctRad1=acctRad1, sessionStarted=sessionStarted, cxr=cxr, resetByButton=resetByButton, snmpdService=snmpdService, siteName=siteName, ts=ts, slaveHexaAddress=slaveHexaAddress, sessionStopped=sessionStopped, ipNetmask=ipNetmask, slaveIPaddr=slaveIPaddr, radiusServer1=radiusServer1, modbusMode=modbusMode, reset=reset, authRad2=authRad2, nameResolution=nameResolution, formFeed=formFeed, secondIpAddress=secondIpAddress, radiusSecret2=radiusSecret2, bytesReceiveFromV24=bytesReceiveFromV24, modbusTable=modbusTable, txIdle=txIdle, remoteIpAddress=remoteIpAddress, interFrame=interFrame, snmpTrapAddr2=snmpTrapAddr2, mainIpAddress=mainIpAddress, system=system, radiusServer2=radiusServer2, afterSend=afterSend, telnetdService=telnetdService, terminalType=terminalType, slaveIPport=slaveIPport, dtrUp=dtrUp, acctRad2=acctRad2, portStatsEntry=portStatsEntry, portIndex=portIndex, portReset=portReset, aliasIpAddress=aliasIpAddress, snmpTrap=snmpTrap, productName=productName, portStatsTable=portStatsTable, rxIdle=rxIdle, ethernetAddress=ethernetAddress, bootp=bootp, ftpdService=ftpdService, timeoutPAD=timeoutPAD, snmpTrapAddr1=snmpTrapAddr1, modbusEntry=modbusEntry, beforeSend=beforeSend, bytesSendToV24=bytesSendToV24, endMsg=endMsg, ipGateway=ipGateway, gatewayToRemote=gatewayToRemote, nameServer1=nameServer1, radiusSecret1=radiusSecret1, aliasIpNetmask=aliasIpNetmask, mode=mode, nameServer2=nameServer2, tcpPort=tcpPort, portEntry=portEntry)
