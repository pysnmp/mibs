...
# Produced by pysmi-1.1.8 at Thu Sep 29 13:04:35 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, Gauge32, Counter32, IpAddress, Integer32, Unsigned32, MibIdentifier, NotificationType, TimeTicks, Bits, Counter64, NotificationType, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "Gauge32", "Counter32", "IpAddress", "Integer32", "Unsigned32", "MibIdentifier", "NotificationType", "TimeTicks", "Bits", "Counter64", "NotificationType", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("CXR-TS-MIB", mainIpAddress=mainIpAddress, statusDTR=statusDTR, portReset=portReset, radiusSecret1=radiusSecret1, slaveIPport=slaveIPport, portStatsEntry=portStatsEntry, interFrame=interFrame, version=version, radiusServer1=radiusServer1, modbusMode=modbusMode, productName=productName, portIndex=portIndex, ipNetmask=ipNetmask, dtrUp=dtrUp, terminalType=terminalType, authType=authType, nameResolution=nameResolution, ipGateway=ipGateway, dtrDown=dtrDown, httpdService=httpdService, remoteIpAddress=remoteIpAddress, sessionStarted=sessionStarted, secondGateway=secondGateway, timeoutPAD=timeoutPAD, slaveIPaddr=slaveIPaddr, modbusEntry=modbusEntry, multiSession=multiSession, modbusTable=modbusTable, ipServer=ipServer, slaveHexaAddress=slaveHexaAddress, authRad2=authRad2, sessionStopped=sessionStopped, aliasIpNetmask=aliasIpNetmask, snmpTrapAddr1=snmpTrapAddr1, bootp=bootp, endMsg=endMsg, snmpTrapAddr2=snmpTrapAddr2, tcpPort=tcpPort, radiusServer2=radiusServer2, nameServer1=nameServer1, acctRad2=acctRad2, nameServer2=nameServer2, portTable=portTable, baudRate=baudRate, ftpdService=ftpdService, snmpTrap=snmpTrap, txIdle=txIdle, secondIpAddress=secondIpAddress, formFeed=formFeed, portStatsTable=portStatsTable, modbusType=modbusType, ts=ts, afterSend=afterSend, bytesSendToV24=bytesSendToV24, nbParStop=nbParStop, secondTcpPort=secondTcpPort, portEntry=portEntry, acctRad1=acctRad1, rxIdle=rxIdle, snmpdService=snmpdService, bytesReceiveFromV24=bytesReceiveFromV24, authRad1=authRad1, aliasIpAddress=aliasIpAddress, telnetdService=telnetdService, gatewayToRemote=gatewayToRemote, siteName=siteName, flowControl=flowControl, system=system, beforeSend=beforeSend, ethernetAddress=ethernetAddress, remoteTcpPort=remoteTcpPort, radiusSecret2=radiusSecret2, timeoutRxTx=timeoutRxTx, mode=mode, resetByButton=resetByButton, cxr=cxr, reset=reset)
