...
# Produced by pysmi-1.1.12 at Tue Jun  4 12:00:52 2024
...
MibIdentifier, Counter64, Gauge32, ObjectIdentity, NotificationType, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, Counter32, NotificationType, Unsigned32, TimeTicks, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "Gauge32", "ObjectIdentity", "NotificationType", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "Counter32", "NotificationType", "Unsigned32", "TimeTicks", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", portReset=portReset, acctRad2=acctRad2, dtrDown=dtrDown, telnetdService=telnetdService, ethernetAddress=ethernetAddress, authType=authType, authRad2=authRad2, snmpTrap=snmpTrap, timeoutRxTx=timeoutRxTx, aliasIpAddress=aliasIpAddress, timeoutPAD=timeoutPAD, reset=reset, formFeed=formFeed, portTable=portTable, remoteIpAddress=remoteIpAddress, modbusType=modbusType, statusDTR=statusDTR, mainIpAddress=mainIpAddress, nbParStop=nbParStop, secondGateway=secondGateway, nameServer1=nameServer1, aliasIpNetmask=aliasIpNetmask, ftpdService=ftpdService, nameServer2=nameServer2, authRad1=authRad1, radiusSecret2=radiusSecret2, ipNetmask=ipNetmask, radiusServer1=radiusServer1, terminalType=terminalType, bytesReceiveFromV24=bytesReceiveFromV24, productName=productName, system=system, slaveHexaAddress=slaveHexaAddress, slaveIPport=slaveIPport, baudRate=baudRate, rxIdle=rxIdle, slaveIPaddr=slaveIPaddr, secondIpAddress=secondIpAddress, snmpTrapAddr1=snmpTrapAddr1, gatewayToRemote=gatewayToRemote, interFrame=interFrame, beforeSend=beforeSend, nameResolution=nameResolution, portEntry=portEntry, ipGateway=ipGateway, version=version, endMsg=endMsg, ts=ts, sessionStarted=sessionStarted, secondTcpPort=secondTcpPort, remoteTcpPort=remoteTcpPort, tcpPort=tcpPort, httpdService=httpdService, cxr=cxr, flowControl=flowControl, txIdle=txIdle, siteName=siteName, modbusMode=modbusMode, snmpTrapAddr2=snmpTrapAddr2, acctRad1=acctRad1, multiSession=multiSession, portStatsTable=portStatsTable, sessionStopped=sessionStopped, modbusTable=modbusTable, portStatsEntry=portStatsEntry, radiusSecret1=radiusSecret1, portIndex=portIndex, resetByButton=resetByButton, modbusEntry=modbusEntry, dtrUp=dtrUp, snmpdService=snmpdService, ipServer=ipServer, mode=mode, bootp=bootp, afterSend=afterSend, radiusServer2=radiusServer2, bytesSendToV24=bytesSendToV24)
