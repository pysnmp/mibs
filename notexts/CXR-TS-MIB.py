...
# Produced by pysmi-1.1.8 at Thu Feb  9 13:55:14 2023
...
ModuleIdentity, ObjectIdentity, MibIdentifier, Counter64, Unsigned32, NotificationType, Integer32, TimeTicks, enterprises, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, Gauge32, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "Counter64", "Unsigned32", "NotificationType", "Integer32", "TimeTicks", "enterprises", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "Gauge32", "NotificationType", "iso")
...
mibBuilder.exportSymbols("CXR-TS-MIB", bytesReceiveFromV24=bytesReceiveFromV24, radiusServer1=radiusServer1, ts=ts, ipGateway=ipGateway, mainIpAddress=mainIpAddress, portStatsEntry=portStatsEntry, ftpdService=ftpdService, resetByButton=resetByButton, ipNetmask=ipNetmask, snmpdService=snmpdService, radiusServer2=radiusServer2, remoteIpAddress=remoteIpAddress, terminalType=terminalType, modbusMode=modbusMode, radiusSecret1=radiusSecret1, snmpTrapAddr1=snmpTrapAddr1, remoteTcpPort=remoteTcpPort, baudRate=baudRate, authType=authType, acctRad2=acctRad2, sessionStarted=sessionStarted, formFeed=formFeed, timeoutRxTx=timeoutRxTx, multiSession=multiSession, aliasIpAddress=aliasIpAddress, siteName=siteName, flowControl=flowControl, slaveIPaddr=slaveIPaddr, timeoutPAD=timeoutPAD, nameServer1=nameServer1, nameResolution=nameResolution, gatewayToRemote=gatewayToRemote, acctRad1=acctRad1, radiusSecret2=radiusSecret2, mode=mode, interFrame=interFrame, portEntry=portEntry, endMsg=endMsg, snmpTrap=snmpTrap, modbusTable=modbusTable, snmpTrapAddr2=snmpTrapAddr2, secondGateway=secondGateway, afterSend=afterSend, txIdle=txIdle, beforeSend=beforeSend, cxr=cxr, ethernetAddress=ethernetAddress, statusDTR=statusDTR, system=system, slaveIPport=slaveIPport, bootp=bootp, dtrDown=dtrDown, version=version, dtrUp=dtrUp, portIndex=portIndex, tcpPort=tcpPort, modbusEntry=modbusEntry, aliasIpNetmask=aliasIpNetmask, reset=reset, productName=productName, httpdService=httpdService, modbusType=modbusType, nbParStop=nbParStop, portStatsTable=portStatsTable, rxIdle=rxIdle, bytesSendToV24=bytesSendToV24, portReset=portReset, slaveHexaAddress=slaveHexaAddress, sessionStopped=sessionStopped, authRad1=authRad1, authRad2=authRad2, secondTcpPort=secondTcpPort, ipServer=ipServer, telnetdService=telnetdService, nameServer2=nameServer2, secondIpAddress=secondIpAddress, portTable=portTable)
