...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, Integer32, IpAddress, iso, Bits, ModuleIdentity, MibIdentifier, Gauge32, TimeTicks, Unsigned32, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "Integer32", "IpAddress", "iso", "Bits", "ModuleIdentity", "MibIdentifier", "Gauge32", "TimeTicks", "Unsigned32", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwHBAEntry=vmwHBAEntry, vmwNetVMID=vmwNetVMID, vmwNetKbRx=vmwNetKbRx, vmkLoaded=vmkLoaded, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemVMID=vmwMemVMID, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetPktsTx=vmwNetPktsTx, vmwCpuTable=vmwCpuTable, vmwMemEntry=vmwMemEntry, vmSuspended=vmSuspended, vmwCpuShares=vmwCpuShares, vmwNetIfAddr=vmwNetIfAddr, vmwHbaIdx=vmwHbaIdx, vmwNetEntry=vmwNetEntry, vpxdObjValue=vpxdObjValue, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNumReads=vmwNumReads, vmwHbaVMID=vmwHbaVMID, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHbaName=vmwHbaName, vmwNetShares=vmwNetShares, vmwCpuVMID=vmwCpuVMID, vmwNetName=vmwNetName, vmPoweredOff=vmPoweredOff, vmwHBATable=vmwHBATable, vmwNetIdx=vmwNetIdx, vmHBDetected=vmHBDetected, vmwNetTable=vmwNetTable, vmwNetPktsRx=vmwNetPktsRx, vmwKbWritten=vmwKbWritten, vmwNetKbTx=vmwNetKbTx, vmwKbRead=vmwKbRead, vmPoweredOn=vmPoweredOn, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuUtil=vmwCpuUtil, vmwDiskShares=vmwDiskShares, vmwMemTable=vmwMemTable, vmwNetHCKbTx=vmwNetHCKbTx, vpxdOldStatus=vpxdOldStatus, vpxdTrapType=vpxdTrapType, vmwCpuEntry=vmwCpuEntry, vpxdVMName=vpxdVMName, vmHBLost=vmHBLost, vpxdNewStatus=vpxdNewStatus, vmwMemUtil=vmwMemUtil, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemShares=vmwMemShares, vmwNumWrites=vmwNumWrites, vpxdHostName=vpxdHostName, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsoleteMIB=vmwObsoleteMIB, vpxdTrap=vpxdTrap, vmwMemConfigured=vmwMemConfigured)
