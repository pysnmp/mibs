...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwDiskShares=vmwDiskShares, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdOldStatus=vpxdOldStatus, vmwNetEntry=vmwNetEntry, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemTable=vmwMemTable, vmwHbaName=vmwHbaName, vmwHbaVMID=vmwHbaVMID, vmHBDetected=vmHBDetected, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetKbRx=vmwNetKbRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdTrap=vpxdTrap, vmSuspended=vmSuspended, vmwMemVMID=vmwMemVMID, vmwNetKbTx=vmwNetKbTx, vpxdHostName=vpxdHostName, vmwHBAEntry=vmwHBAEntry, vmwNetPktsRx=vmwNetPktsRx, vmHBLost=vmHBLost, vmwMemShares=vmwMemShares, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetName=vmwNetName, vmwNetIdx=vmwNetIdx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdObjValue=vpxdObjValue, vmwCpuTable=vmwCpuTable, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetTable=vmwNetTable, vmwHbaIdx=vmwHbaIdx, vmwNetShares=vmwNetShares, vmPoweredOn=vmPoweredOn, vmwCpuUtil=vmwCpuUtil, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemUtil=vmwMemUtil, vpxdVMName=vpxdVMName, vmPoweredOff=vmPoweredOff, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNumWrites=vmwNumWrites, vmwNumReads=vmwNumReads, vmkLoaded=vmkLoaded, vmwNetIfAddr=vmwNetIfAddr, vmwKbRead=vmwKbRead, vmwNetPktsTx=vmwNetPktsTx, vmwKbWritten=vmwKbWritten, vmwMemEntry=vmwMemEntry, vpxdNewStatus=vpxdNewStatus, vmwCpuShares=vmwCpuShares, vmwCpuEntry=vmwCpuEntry, vmwCpuVMID=vmwCpuVMID, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetVMID=vmwNetVMID, vpxdTrapType=vpxdTrapType, vmwHBATable=vmwHBATable, vmwMemConfigured=vmwMemConfigured)
