...
Gauge32, ModuleIdentity, Counter32, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, Counter64, TimeTicks, Bits, ObjectIdentity, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "Counter32", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "Counter64", "TimeTicks", "Bits", "ObjectIdentity", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemVMID=vmwMemVMID, vmwCpuEntry=vmwCpuEntry, vmwNumWrites=vmwNumWrites, vmwHBATable=vmwHBATable, vmwNetIfAddr=vmwNetIfAddr, vmwNumReads=vmwNumReads, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemShares=vmwMemShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwDiskShares=vmwDiskShares, vpxdObjValue=vpxdObjValue, vmPoweredOn=vmPoweredOn, vmwKbWritten=vmwKbWritten, vmHBDetected=vmHBDetected, vpxdVMName=vpxdVMName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHBAEntry=vmwHBAEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetEntry=vmwNetEntry, vpxdNewStatus=vpxdNewStatus, vmwMemEntry=vmwMemEntry, vmwHbaIdx=vmwHbaIdx, vmwKbRead=vmwKbRead, vmwNetKbRx=vmwNetKbRx, vmPoweredOff=vmPoweredOff, vmwMemUtil=vmwMemUtil, vmwCpuVMID=vmwCpuVMID, vmkLoaded=vmkLoaded, vmwCpuTable=vmwCpuTable, vpxdHostName=vpxdHostName, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetKbTx=vmwNetKbTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetHCKbTx=vmwNetHCKbTx, vmwHbaVMID=vmwHbaVMID, vpxdTrap=vpxdTrap, vmwNetShares=vmwNetShares, vmSuspended=vmSuspended, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemConfigured=vmwMemConfigured, vmwNetTable=vmwNetTable, vmHBLost=vmHBLost, vmwNetVMID=vmwNetVMID, vmwNetIdx=vmwNetIdx, vmwHbaName=vmwHbaName, vpxdOldStatus=vpxdOldStatus, vpxdTrapType=vpxdTrapType, vmwNetPktsRx=vmwNetPktsRx, vmwMemTable=vmwMemTable, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuShares=vmwCpuShares, vmwNetName=vmwNetName, vmwCpuUtil=vmwCpuUtil)
