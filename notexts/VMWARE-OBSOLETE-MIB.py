...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuShares=vmwCpuShares, vmwDiskShares=vmwDiskShares, vmwKbRead=vmwKbRead, vmwMemEntry=vmwMemEntry, vmHBDetected=vmHBDetected, vmwNetName=vmwNetName, vmwHbaName=vmwHbaName, vmwHBATable=vmwHBATable, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetEntry=vmwNetEntry, vpxdOldStatus=vpxdOldStatus, vmwNetTable=vmwNetTable, vpxdTrap=vpxdTrap, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmPoweredOn=vmPoweredOn, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCKbRx=vmwNetHCKbRx, vmwKbWritten=vmwKbWritten, vmwMemTable=vmwMemTable, vmwCpuUtil=vmwCpuUtil, vpxdObjValue=vpxdObjValue, vmkLoaded=vmkLoaded, vmwNumReads=vmwNumReads, vmwNetPktsRx=vmwNetPktsRx, vmwNetKbTx=vmwNetKbTx, vmwMemConfigured=vmwMemConfigured, vmwMemShares=vmwMemShares, vmwMemUtil=vmwMemUtil, vmwHbaIdx=vmwHbaIdx, vmwNetIdx=vmwNetIdx, vmwCpuTable=vmwCpuTable, vmwHBAEntry=vmwHBAEntry, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemVMID=vmwMemVMID, vmwCpuVMID=vmwCpuVMID, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNumWrites=vmwNumWrites, vmwNetHCKbTx=vmwNetHCKbTx, vpxdHostName=vpxdHostName, vpxdVMName=vpxdVMName, vmPoweredOff=vmPoweredOff, vmwObsoleteGroup=vmwObsoleteGroup, vpxdNewStatus=vpxdNewStatus, vmwHbaVMID=vmwHbaVMID, vmwNetPktsTx=vmwNetPktsTx, vmSuspended=vmSuspended, vmwCpuEntry=vmwCpuEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vmHBLost=vmHBLost, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetKbRx=vmwNetKbRx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetShares=vmwNetShares, vpxdTrapType=vpxdTrapType, vmwNetVMID=vmwNetVMID)
