...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemConfigured=vmwMemConfigured, vmwNetVMID=vmwNetVMID, vpxdNewStatus=vpxdNewStatus, vmwCpuEntry=vmwCpuEntry, vmwDiskShares=vmwDiskShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHBATable=vmwHBATable, vpxdOldStatus=vpxdOldStatus, vmwNetHCKbRx=vmwNetHCKbRx, vmwHbaVMID=vmwHbaVMID, vmwCpuTable=vmwCpuTable, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemTable=vmwMemTable, vmwHBAEntry=vmwHBAEntry, vmwHbaName=vmwHbaName, vmwNumWrites=vmwNumWrites, vpxdObjValue=vpxdObjValue, vpxdHostName=vpxdHostName, vmwNetKbRx=vmwNetKbRx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetIdx=vmwNetIdx, vmwNumReads=vmwNumReads, vmwCpuShares=vmwCpuShares, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetTable=vmwNetTable, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetIfAddr=vmwNetIfAddr, vmHBDetected=vmHBDetected, vmHBLost=vmHBLost, vmwNetShares=vmwNetShares, vpxdTrapType=vpxdTrapType, vmwMemShares=vmwMemShares, vmwMemEntry=vmwMemEntry, vmwNetPktsRx=vmwNetPktsRx, vmPoweredOn=vmPoweredOn, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetName=vmwNetName, vpxdTrap=vpxdTrap, vmSuspended=vmSuspended, vmwMemVMID=vmwMemVMID, vmwHbaIdx=vmwHbaIdx, vmkLoaded=vmkLoaded, vmwCpuUtil=vmwCpuUtil, vmwKbWritten=vmwKbWritten, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetEntry=vmwNetEntry, vpxdVMName=vpxdVMName, vmPoweredOff=vmPoweredOff, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuVMID=vmwCpuVMID, vmwNetKbTx=vmwNetKbTx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemUtil=vmwMemUtil, vmwKbRead=vmwKbRead)
