...
Counter32, NotificationType, TimeTicks, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, Bits, MibIdentifier, Counter64, Integer32, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "TimeTicks", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "Bits", "MibIdentifier", "Counter64", "Integer32", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetIfAddr=vmwNetIfAddr, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsoleteMIB=vmwObsoleteMIB, vmwHbaIdx=vmwHbaIdx, vmwNetHCKbTx=vmwNetHCKbTx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuUtil=vmwCpuUtil, vpxdOldStatus=vpxdOldStatus, vmPoweredOn=vmPoweredOn, vmwMemEntry=vmwMemEntry, vmwHBATable=vmwHBATable, vmwMemConfigured=vmwMemConfigured, vmwMemTable=vmwMemTable, vmwObsMIBGroups=vmwObsMIBGroups, vmwDiskShares=vmwDiskShares, vmwCpuShares=vmwCpuShares, vpxdTrapType=vpxdTrapType, vmwNetIdx=vmwNetIdx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdHostName=vpxdHostName, vpxdVMName=vpxdVMName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetPktsRx=vmwNetPktsRx, vmwNetKbTx=vmwNetKbTx, vmwMemVMID=vmwMemVMID, vmwKbRead=vmwKbRead, vmSuspended=vmSuspended, vmwCpuVMID=vmwCpuVMID, vmHBDetected=vmHBDetected, vpxdTrap=vpxdTrap, vmwCpuEntry=vmwCpuEntry, vmwNumReads=vmwNumReads, vmwCpuTable=vmwCpuTable, vmwMemShares=vmwMemShares, vmwKbWritten=vmwKbWritten, vmwNetVMID=vmwNetVMID, vmwNetName=vmwNetName, vmwNetHCPktsRx=vmwNetHCPktsRx, vmHBLost=vmHBLost, vmwNetTable=vmwNetTable, vpxdNewStatus=vpxdNewStatus, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteGroup=vmwObsoleteGroup, vmwHbaName=vmwHbaName, vmwNetEntry=vmwNetEntry, vpxdObjValue=vpxdObjValue, vmwHbaVMID=vmwHbaVMID, vmwHBAEntry=vmwHBAEntry, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetPktsTx=vmwNetPktsTx, vmwNumWrites=vmwNumWrites, vmwNetKbRx=vmwNetKbRx, vmwNetHCKbRx=vmwNetHCKbRx, vmkLoaded=vmkLoaded, vmPoweredOff=vmPoweredOff, vmwMemUtil=vmwMemUtil, vmwNetShares=vmwNetShares)
