...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, Unsigned32, Counter64, IpAddress, Counter32, iso, TimeTicks, MibIdentifier, Integer32, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "Counter64", "IpAddress", "Counter32", "iso", "TimeTicks", "MibIdentifier", "Integer32", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuShares=vmwCpuShares, vmwMemVMID=vmwMemVMID, vmwHbaIdx=vmwHbaIdx, vmwHbaName=vmwHbaName, vpxdVMName=vpxdVMName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdTrapType=vpxdTrapType, vmkLoaded=vmkLoaded, vmwHBATable=vmwHBATable, vmwNetShares=vmwNetShares, vmwNetPktsTx=vmwNetPktsTx, vpxdOldStatus=vpxdOldStatus, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHBAEntry=vmwHBAEntry, vmwDiskShares=vmwDiskShares, vpxdTrap=vpxdTrap, vmwObsoleteGroup=vmwObsoleteGroup, vpxdHostName=vpxdHostName, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemTable=vmwMemTable, vmwHbaVMID=vmwHbaVMID, vmwNetIdx=vmwNetIdx, vmwNetKbTx=vmwNetKbTx, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetHCPktsTx=vmwNetHCPktsTx, vmPoweredOn=vmPoweredOn, vmwNetTable=vmwNetTable, vmwNumReads=vmwNumReads, vmwObsoleteMIB=vmwObsoleteMIB, vmwNumWrites=vmwNumWrites, vmwNetIfAddr=vmwNetIfAddr, vmHBDetected=vmHBDetected, vmPoweredOff=vmPoweredOff, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuUtil=vmwCpuUtil, vmwKbWritten=vmwKbWritten, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemEntry=vmwMemEntry, vmwMemConfigured=vmwMemConfigured, vmwNetName=vmwNetName, vmwNetKbRx=vmwNetKbRx, vmwNetVMID=vmwNetVMID, vmwCpuTable=vmwCpuTable, vmwKbRead=vmwKbRead, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuEntry=vmwCpuEntry, vmwNetEntry=vmwNetEntry, vmwMemUtil=vmwMemUtil, vmSuspended=vmSuspended, vmHBLost=vmHBLost, vmwMemShares=vmwMemShares, vmwNetPktsRx=vmwNetPktsRx, vmwCpuVMID=vmwCpuVMID, vpxdNewStatus=vpxdNewStatus, vpxdObjValue=vpxdObjValue, vmwNetHCKbRx=vmwNetHCKbRx)
