...
Gauge32, NotificationType, iso, MibIdentifier, Bits, Counter64, ModuleIdentity, TimeTicks, Unsigned32, IpAddress, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "iso", "MibIdentifier", "Bits", "Counter64", "ModuleIdentity", "TimeTicks", "Unsigned32", "IpAddress", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwKbWritten=vmwKbWritten, vmwHBATable=vmwHBATable, vmwNumWrites=vmwNumWrites, vmwMemVMID=vmwMemVMID, vmwNetShares=vmwNetShares, vpxdTrap=vpxdTrap, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNumReads=vmwNumReads, vmwNetKbTx=vmwNetKbTx, vmwObsoleteMIB=vmwObsoleteMIB, vmwDiskShares=vmwDiskShares, vpxdOldStatus=vpxdOldStatus, vmwCpuUtil=vmwCpuUtil, vpxdHostName=vpxdHostName, vmwHbaVMID=vmwHbaVMID, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemShares=vmwMemShares, vmwMemUtil=vmwMemUtil, vmwNetEntry=vmwNetEntry, vmPoweredOff=vmPoweredOff, vpxdTrapType=vpxdTrapType, vmwNetKbRx=vmwNetKbRx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemTable=vmwMemTable, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuVMID=vmwCpuVMID, vpxdVMName=vpxdVMName, vmwNetIfAddr=vmwNetIfAddr, vmHBDetected=vmHBDetected, vmSuspended=vmSuspended, vmwKbRead=vmwKbRead, vmwCpuTable=vmwCpuTable, vmwNetIdx=vmwNetIdx, vmwNetName=vmwNetName, vmwNetHCKbRx=vmwNetHCKbRx, vmHBLost=vmHBLost, vmwNetPktsRx=vmwNetPktsRx, vpxdNewStatus=vpxdNewStatus, vmwMemConfigured=vmwMemConfigured, vmwHBAEntry=vmwHBAEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemEntry=vmwMemEntry, vmwHbaIdx=vmwHbaIdx, vmwNetTable=vmwNetTable, vmPoweredOn=vmPoweredOn, vmwCpuShares=vmwCpuShares, vmwNetPktsTx=vmwNetPktsTx, vmwHbaName=vmwHbaName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdObjValue=vpxdObjValue, vmwCpuEntry=vmwCpuEntry, vmkLoaded=vmkLoaded, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetVMID=vmwNetVMID)
