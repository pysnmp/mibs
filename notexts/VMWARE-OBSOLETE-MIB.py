...
Bits, Unsigned32, NotificationType, TimeTicks, iso, ModuleIdentity, ObjectIdentity, Counter64, Gauge32, Integer32, MibIdentifier, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "NotificationType", "TimeTicks", "iso", "ModuleIdentity", "ObjectIdentity", "Counter64", "Gauge32", "Integer32", "MibIdentifier", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwHbaVMID=vmwHbaVMID, vmwMemVMID=vmwMemVMID, vmwNetEntry=vmwNetEntry, vmwNetKbTx=vmwNetKbTx, vpxdHostName=vpxdHostName, vmwCpuVMID=vmwCpuVMID, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdTrap=vpxdTrap, vmHBLost=vmHBLost, vmwCpuShares=vmwCpuShares, vmwNetIfAddr=vmwNetIfAddr, vpxdNewStatus=vpxdNewStatus, vmPoweredOn=vmPoweredOn, vmwCpuUtil=vmwCpuUtil, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemConfigured=vmwMemConfigured, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNumWrites=vmwNumWrites, vmwHbaName=vmwHbaName, vpxdObjValue=vpxdObjValue, vpxdVMName=vpxdVMName, vmwNetKbRx=vmwNetKbRx, vmwMemTable=vmwMemTable, vmwNetPktsRx=vmwNetPktsRx, vmwHbaIdx=vmwHbaIdx, vmwNetHCKbTx=vmwNetHCKbTx, vmSuspended=vmSuspended, vmwDiskShares=vmwDiskShares, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetHCKbRx=vmwNetHCKbRx, vmwHBAEntry=vmwHBAEntry, vmwNetIdx=vmwNetIdx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetShares=vmwNetShares, vmwKbRead=vmwKbRead, vmwMemUtil=vmwMemUtil, vmwCpuEntry=vmwCpuEntry, vmkLoaded=vmkLoaded, vmwNumReads=vmwNumReads, vmwObsoleteGroup=vmwObsoleteGroup, vmHBDetected=vmHBDetected, vmwObsMIBGroups=vmwObsMIBGroups, vmwKbWritten=vmwKbWritten, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemShares=vmwMemShares, vmwNetTable=vmwNetTable, vmwCpuTable=vmwCpuTable, vmwNetVMID=vmwNetVMID, vmwNetPktsTx=vmwNetPktsTx, vmwNetName=vmwNetName, vpxdOldStatus=vpxdOldStatus, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdTrapType=vpxdTrapType, vmwMemEntry=vmwMemEntry, vmPoweredOff=vmPoweredOff, vmwHBATable=vmwHBATable)
