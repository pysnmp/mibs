...
TimeTicks, Unsigned32, Bits, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, Counter64, ObjectIdentity, Integer32, MibIdentifier, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "Bits", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "Counter64", "ObjectIdentity", "Integer32", "MibIdentifier", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetTable=vmwNetTable, vmwNumReads=vmwNumReads, vmwMemUtil=vmwMemUtil, vmwMemTable=vmwMemTable, vmwNumWrites=vmwNumWrites, vpxdTrapType=vpxdTrapType, vmwNetIdx=vmwNetIdx, vpxdHostName=vpxdHostName, vmwMemConfigured=vmwMemConfigured, vmwNetIfAddr=vmwNetIfAddr, vmwNetKbRx=vmwNetKbRx, vpxdOldStatus=vpxdOldStatus, vmHBLost=vmHBLost, vmwCpuEntry=vmwCpuEntry, vmwNetName=vmwNetName, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdTrap=vpxdTrap, vmwCpuUtil=vmwCpuUtil, vpxdVMName=vpxdVMName, vmwHbaName=vmwHbaName, vmwNetKbTx=vmwNetKbTx, vmwHBAEntry=vmwHBAEntry, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetHCKbTx=vmwNetHCKbTx, vpxdNewStatus=vpxdNewStatus, vmwDiskShares=vmwDiskShares, vmwNetShares=vmwNetShares, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuVMID=vmwCpuVMID, vmwNetEntry=vmwNetEntry, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwKbRead=vmwKbRead, vmwKbWritten=vmwKbWritten, vmPoweredOff=vmPoweredOff, vmSuspended=vmSuspended, vmkLoaded=vmkLoaded, vmHBDetected=vmHBDetected, vmwMemVMID=vmwMemVMID, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuTable=vmwCpuTable, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetPktsRx=vmwNetPktsRx, vmwCpuShares=vmwCpuShares, vmwHBATable=vmwHBATable, vmwHbaIdx=vmwHbaIdx, vmwMemShares=vmwMemShares, vmwHbaVMID=vmwHbaVMID, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetVMID=vmwNetVMID, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemEntry=vmwMemEntry, vpxdObjValue=vpxdObjValue, vmPoweredOn=vmPoweredOn, vmwNetPktsTx=vmwNetPktsTx)
