...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuUtil=vmwCpuUtil, vpxdVMName=vpxdVMName, vmwMemTable=vmwMemTable, vpxdTrapType=vpxdTrapType, vpxdTrap=vpxdTrap, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdOldStatus=vpxdOldStatus, vpxdObjValue=vpxdObjValue, vmwNetHCKbRx=vmwNetHCKbRx, vmHBDetected=vmHBDetected, vmwCpuEntry=vmwCpuEntry, vmwNetVMID=vmwNetVMID, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetKbTx=vmwNetKbTx, vmwMemConfigured=vmwMemConfigured, vmPoweredOff=vmPoweredOff, vmwNetEntry=vmwNetEntry, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuVMID=vmwCpuVMID, vmwObsoleteMIB=vmwObsoleteMIB, vmwKbRead=vmwKbRead, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemUtil=vmwMemUtil, vmwNetIfAddr=vmwNetIfAddr, vmwNumReads=vmwNumReads, vmwHBATable=vmwHBATable, vmwHbaVMID=vmwHbaVMID, vmSuspended=vmSuspended, vmwNetTable=vmwNetTable, vpxdHostName=vpxdHostName, vmHBLost=vmHBLost, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteGroup=vmwObsoleteGroup, vmwKbWritten=vmwKbWritten, vmwHBAEntry=vmwHBAEntry, vmkLoaded=vmkLoaded, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuShares=vmwCpuShares, vmwNetKbRx=vmwNetKbRx, vpxdNewStatus=vpxdNewStatus, vmwNetShares=vmwNetShares, vmwNumWrites=vmwNumWrites, vmwCpuTable=vmwCpuTable, vmwMemVMID=vmwMemVMID, vmwDiskShares=vmwDiskShares, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemShares=vmwMemShares, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetIdx=vmwNetIdx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetPktsRx=vmwNetPktsRx, vmwHbaIdx=vmwHbaIdx, vmwNetPktsTx=vmwNetPktsTx, vmwHbaName=vmwHbaName, vmwMemEntry=vmwMemEntry, vmwNetName=vmwNetName, vmPoweredOn=vmPoweredOn)
