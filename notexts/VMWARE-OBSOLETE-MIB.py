...
Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, TimeTicks, Gauge32, Counter32, Bits, ObjectIdentity, IpAddress, iso, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "TimeTicks", "Gauge32", "Counter32", "Bits", "ObjectIdentity", "IpAddress", "iso", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdNewStatus=vpxdNewStatus, vmHBLost=vmHBLost, vmHBDetected=vmHBDetected, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuEntry=vmwCpuEntry, vmwNumReads=vmwNumReads, vpxdObjValue=vpxdObjValue, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteMIB=vmwObsoleteMIB, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHbaName=vmwHbaName, vmwMemShares=vmwMemShares, vmwCpuVMID=vmwCpuVMID, vmwKbRead=vmwKbRead, vmwNetHCKbRx=vmwNetHCKbRx, vmwNumWrites=vmwNumWrites, vmwNetKbTx=vmwNetKbTx, vmwNetIdx=vmwNetIdx, vmwNetVMID=vmwNetVMID, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuUtil=vmwCpuUtil, vpxdHostName=vpxdHostName, vmwNetTable=vmwNetTable, vmwNetIfAddr=vmwNetIfAddr, vpxdTrap=vpxdTrap, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetPktsTx=vmwNetPktsTx, vmwNetPktsRx=vmwNetPktsRx, vmwKbWritten=vmwKbWritten, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetName=vmwNetName, vpxdVMName=vpxdVMName, vmwHbaIdx=vmwHbaIdx, vmwMemTable=vmwMemTable, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetShares=vmwNetShares, vmwMemUtil=vmwMemUtil, vmwNetEntry=vmwNetEntry, vmPoweredOn=vmPoweredOn, vmPoweredOff=vmPoweredOff, vmwMemVMID=vmwMemVMID, vmSuspended=vmSuspended, vpxdOldStatus=vpxdOldStatus, vmwMemConfigured=vmwMemConfigured, vmwHBAEntry=vmwHBAEntry, vmwDiskShares=vmwDiskShares, vmwNetKbRx=vmwNetKbRx, vmkLoaded=vmkLoaded, vmwMemEntry=vmwMemEntry, vpxdTrapType=vpxdTrapType, vmwCpuTable=vmwCpuTable, vmwHbaVMID=vmwHbaVMID, vmwCpuShares=vmwCpuShares, vmwHBATable=vmwHBATable, vmwObsoleteGroup=vmwObsoleteGroup)
