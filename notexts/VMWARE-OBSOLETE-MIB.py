...
NotificationType, ObjectIdentity, IpAddress, Counter32, Gauge32, Counter64, TimeTicks, ModuleIdentity, Bits, MibIdentifier, Integer32, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "IpAddress", "Counter32", "Gauge32", "Counter64", "TimeTicks", "ModuleIdentity", "Bits", "MibIdentifier", "Integer32", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetTable=vmwNetTable, vmwNumReads=vmwNumReads, vpxdVMName=vpxdVMName, vmwCpuEntry=vmwCpuEntry, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHBATable=vmwHBATable, vmwKbRead=vmwKbRead, vpxdTrap=vpxdTrap, vpxdNewStatus=vpxdNewStatus, vmwMemConfigured=vmwMemConfigured, vmwHbaName=vmwHbaName, vmwCpuUtil=vmwCpuUtil, vmwNumWrites=vmwNumWrites, vpxdOldStatus=vpxdOldStatus, vmHBDetected=vmHBDetected, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemVMID=vmwMemVMID, vmwMemTable=vmwMemTable, vmwNetShares=vmwNetShares, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetIdx=vmwNetIdx, vmPoweredOff=vmPoweredOff, vmwHbaVMID=vmwHbaVMID, vmwDiskShares=vmwDiskShares, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCKbRx=vmwNetHCKbRx, vmSuspended=vmSuspended, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetPktsRx=vmwNetPktsRx, vmwNetKbRx=vmwNetKbRx, vmwNetPktsTx=vmwNetPktsTx, vpxdHostName=vpxdHostName, vmwNetName=vmwNetName, vmwMemShares=vmwMemShares, vmwKbWritten=vmwKbWritten, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmPoweredOn=vmPoweredOn, vmHBLost=vmHBLost, vmwCpuVMID=vmwCpuVMID, vmwMemUtil=vmwMemUtil, vmwNetKbTx=vmwNetKbTx, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuTable=vmwCpuTable, vmwObsMIBGroups=vmwObsMIBGroups, vmkLoaded=vmkLoaded, vmwNetEntry=vmwNetEntry, vmwNetVMID=vmwNetVMID, vpxdTrapType=vpxdTrapType, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemEntry=vmwMemEntry, vpxdObjValue=vpxdObjValue, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHbaIdx=vmwHbaIdx, vmwHBAEntry=vmwHBAEntry, vmwCpuShares=vmwCpuShares)
