...
Gauge32, Unsigned32, MibIdentifier, Integer32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, ModuleIdentity, Counter64, iso, Bits, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "MibIdentifier", "Integer32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "ModuleIdentity", "Counter64", "iso", "Bits", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetName=vmwNetName, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuShares=vmwCpuShares, vmwHbaIdx=vmwHbaIdx, vmwNetIfAddr=vmwNetIfAddr, vmwDiskShares=vmwDiskShares, vmkLoaded=vmkLoaded, vmHBLost=vmHBLost, vpxdObjValue=vpxdObjValue, vpxdTrapType=vpxdTrapType, vmPoweredOff=vmPoweredOff, vpxdOldStatus=vpxdOldStatus, vmwMemUtil=vmwMemUtil, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwCpuUtil=vmwCpuUtil, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemConfigured=vmwMemConfigured, vmwHBAEntry=vmwHBAEntry, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetEntry=vmwNetEntry, vpxdVMName=vpxdVMName, vmwNumReads=vmwNumReads, vmwMemVMID=vmwMemVMID, vmwNetIdx=vmwNetIdx, vpxdNewStatus=vpxdNewStatus, vmwNetKbRx=vmwNetKbRx, vmwHbaName=vmwHbaName, vmwNetTable=vmwNetTable, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdTrap=vpxdTrap, vmwNetKbTx=vmwNetKbTx, vmwMemShares=vmwMemShares, vmwNetPktsTx=vmwNetPktsTx, vmwCpuEntry=vmwCpuEntry, vmwNetPktsRx=vmwNetPktsRx, vmHBDetected=vmHBDetected, vmwKbWritten=vmwKbWritten, vmPoweredOn=vmPoweredOn, vmSuspended=vmSuspended, vmwCpuVMID=vmwCpuVMID, vpxdHostName=vpxdHostName, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetVMID=vmwNetVMID, vmwMemTable=vmwMemTable, vmwKbRead=vmwKbRead, vmwHBATable=vmwHBATable, vmwNetShares=vmwNetShares, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHbaVMID=vmwHbaVMID, vmwNumWrites=vmwNumWrites, vmwObsoleteGroup=vmwObsoleteGroup, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemEntry=vmwMemEntry, vmwCpuTable=vmwCpuTable)
