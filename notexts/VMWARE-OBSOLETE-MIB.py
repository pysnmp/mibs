...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNumReads=vmwNumReads, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdHostName=vpxdHostName, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteGroup=vmwObsoleteGroup, vmkLoaded=vmkLoaded, vpxdNewStatus=vpxdNewStatus, vmwMemConfigured=vmwMemConfigured, vmwNetName=vmwNetName, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuShares=vmwCpuShares, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetPktsTx=vmwNetPktsTx, vmwNumWrites=vmwNumWrites, vmwNetPktsRx=vmwNetPktsRx, vpxdOldStatus=vpxdOldStatus, vpxdObjValue=vpxdObjValue, vpxdTrap=vpxdTrap, vmwMemTable=vmwMemTable, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCPktsRx=vmwNetHCPktsRx, vmPoweredOn=vmPoweredOn, vmHBLost=vmHBLost, vmwDiskShares=vmwDiskShares, vmwMemUtil=vmwMemUtil, vmwKbRead=vmwKbRead, vmwObsoleteMIB=vmwObsoleteMIB, vmSuspended=vmSuspended, vpxdVMName=vpxdVMName, vmwHBATable=vmwHBATable, vmwNetKbRx=vmwNetKbRx, vmwCpuEntry=vmwCpuEntry, vmwKbWritten=vmwKbWritten, vmwCpuUtil=vmwCpuUtil, vmwCpuVMID=vmwCpuVMID, vmwNetIdx=vmwNetIdx, vmwHBAEntry=vmwHBAEntry, vmwNetTable=vmwNetTable, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHbaName=vmwHbaName, vmwNetKbTx=vmwNetKbTx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemVMID=vmwMemVMID, vmwMemEntry=vmwMemEntry, vmwNetVMID=vmwNetVMID, vmwNetShares=vmwNetShares, vmwHbaIdx=vmwHbaIdx, vmwCpuTable=vmwCpuTable, vmHBDetected=vmHBDetected, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmPoweredOff=vmPoweredOff, vmwMemShares=vmwMemShares, vmwHbaVMID=vmwHbaVMID, vmwObsMIBGroups=vmwObsMIBGroups, vpxdTrapType=vpxdTrapType, vmwNetEntry=vmwNetEntry)
