...
Gauge32, Integer32, NotificationType, Bits, ObjectIdentity, Unsigned32, IpAddress, iso, Counter32, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "NotificationType", "Bits", "ObjectIdentity", "Unsigned32", "IpAddress", "iso", "Counter32", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmkLoaded=vmkLoaded, vmwMemShares=vmwMemShares, vmwNetHCKbTx=vmwNetHCKbTx, vmHBDetected=vmHBDetected, vpxdOldStatus=vpxdOldStatus, vmwCpuShares=vmwCpuShares, vmwNetVMID=vmwNetVMID, vmwNetShares=vmwNetShares, vmwNetName=vmwNetName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemVMID=vmwMemVMID, vmPoweredOn=vmPoweredOn, vmwNumWrites=vmwNumWrites, vmwHBATable=vmwHBATable, vmwKbRead=vmwKbRead, vmwNetIdx=vmwNetIdx, vmwDiskShares=vmwDiskShares, vmwHBAEntry=vmwHBAEntry, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetPktsRx=vmwNetPktsRx, vpxdTrapType=vpxdTrapType, vmSuspended=vmSuspended, vmwNetIfAddr=vmwNetIfAddr, vmwMemEntry=vmwMemEntry, vmwNetHCKbRx=vmwNetHCKbRx, vmwKbWritten=vmwKbWritten, vmwObsoleteMIB=vmwObsoleteMIB, vpxdHostName=vpxdHostName, vmwMemTable=vmwMemTable, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuEntry=vmwCpuEntry, vmwCpuTable=vmwCpuTable, vmwMemConfigured=vmwMemConfigured, vmwNetHCPktsTx=vmwNetHCPktsTx, vmPoweredOff=vmPoweredOff, vmwNetPktsTx=vmwNetPktsTx, vmwNumReads=vmwNumReads, vmwHbaIdx=vmwHbaIdx, vmwObsoleteGroup=vmwObsoleteGroup, vpxdTrap=vpxdTrap, vpxdVMName=vpxdVMName, vpxdNewStatus=vpxdNewStatus, vmwCpuUtil=vmwCpuUtil, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetKbRx=vmwNetKbRx, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetTable=vmwNetTable, vmwMemUtil=vmwMemUtil, vmwNetKbTx=vmwNetKbTx, vmHBLost=vmHBLost, vmwCpuVMID=vmwCpuVMID, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetEntry=vmwNetEntry, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHbaName=vmwHbaName, vpxdObjValue=vpxdObjValue, vmwHbaVMID=vmwHbaVMID)
