...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetHCKbTx=vmwNetHCKbTx, vpxdOldStatus=vpxdOldStatus, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteMIB=vmwObsoleteMIB, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteGroup=vmwObsoleteGroup, vpxdHostName=vpxdHostName, vmwCpuVMID=vmwCpuVMID, vmwHbaIdx=vmwHbaIdx, vmwCpuEntry=vmwCpuEntry, vmwCpuShares=vmwCpuShares, vmwNumReads=vmwNumReads, vmHBDetected=vmHBDetected, vmwNetPktsTx=vmwNetPktsTx, vpxdVMName=vpxdVMName, vmwHBATable=vmwHBATable, vmwKbRead=vmwKbRead, vmwHBAEntry=vmwHBAEntry, vpxdTrapType=vpxdTrapType, vmwKbWritten=vmwKbWritten, vmwMemUtil=vmwMemUtil, vmwDiskShares=vmwDiskShares, vmwNetKbTx=vmwNetKbTx, vpxdTrap=vpxdTrap, vmHBLost=vmHBLost, vmwCpuTable=vmwCpuTable, vmwNetKbRx=vmwNetKbRx, vmwCpuUtil=vmwCpuUtil, vmwNetName=vmwNetName, vmkLoaded=vmkLoaded, vmPoweredOn=vmPoweredOn, vmwNetIdx=vmwNetIdx, vmwNetPktsRx=vmwNetPktsRx, vmPoweredOff=vmPoweredOff, vmwNetShares=vmwNetShares, vmwMemConfigured=vmwMemConfigured, vpxdNewStatus=vpxdNewStatus, vmwNumWrites=vmwNumWrites, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHbaName=vmwHbaName, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetIfAddr=vmwNetIfAddr, vmSuspended=vmSuspended, vmwHbaVMID=vmwHbaVMID, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdObjValue=vpxdObjValue, vmwMemTable=vmwMemTable, vmwMemVMID=vmwMemVMID, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemShares=vmwMemShares, vmwNetEntry=vmwNetEntry, vmwNetTable=vmwNetTable, vmwMemEntry=vmwMemEntry, vmwNetVMID=vmwNetVMID)
