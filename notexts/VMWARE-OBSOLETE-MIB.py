...
TimeTicks, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, Unsigned32, ModuleIdentity, ObjectIdentity, IpAddress, Counter32, Integer32, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "IpAddress", "Counter32", "Integer32", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHbaVMID=vmwHbaVMID, vmwNetKbTx=vmwNetKbTx, vmwNumWrites=vmwNumWrites, vpxdNewStatus=vpxdNewStatus, vmwHbaName=vmwHbaName, vpxdHostName=vpxdHostName, vmwHBAEntry=vmwHBAEntry, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetKbRx=vmwNetKbRx, vmwNumReads=vmwNumReads, vmwNetTable=vmwNetTable, vmwMemTable=vmwMemTable, vmwCpuTable=vmwCpuTable, vmPoweredOff=vmPoweredOff, vpxdOldStatus=vpxdOldStatus, vmwNetShares=vmwNetShares, vpxdObjValue=vpxdObjValue, vmPoweredOn=vmPoweredOn, vmwKbWritten=vmwKbWritten, vmwHBATable=vmwHBATable, vmkLoaded=vmkLoaded, vmwNetName=vmwNetName, vmwCpuVMID=vmwCpuVMID, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdTrap=vpxdTrap, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetEntry=vmwNetEntry, vmwDiskShares=vmwDiskShares, vmwMemUtil=vmwMemUtil, vmwNetPktsTx=vmwNetPktsTx, vmwCpuShares=vmwCpuShares, vmHBDetected=vmHBDetected, vmSuspended=vmSuspended, vmwNetIdx=vmwNetIdx, vmwCpuEntry=vmwCpuEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwKbRead=vmwKbRead, vmHBLost=vmHBLost, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemConfigured=vmwMemConfigured, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwCpuUtil=vmwCpuUtil, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteGroup=vmwObsoleteGroup, vmwObsoleteMIB=vmwObsoleteMIB, vpxdTrapType=vpxdTrapType, vpxdVMName=vpxdVMName, vmwMemEntry=vmwMemEntry, vmwMemVMID=vmwMemVMID, vmwMemShares=vmwMemShares, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHbaIdx=vmwHbaIdx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetPktsRx=vmwNetPktsRx, vmwNetVMID=vmwNetVMID, vmwNetIfAddr=vmwNetIfAddr)
