...
Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, NotificationType, ObjectIdentity, Counter64, iso, Counter32, Integer32, ModuleIdentity, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "NotificationType", "ObjectIdentity", "Counter64", "iso", "Counter32", "Integer32", "ModuleIdentity", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemUtil=vmwMemUtil, vmwMemEntry=vmwMemEntry, vmwCpuShares=vmwCpuShares, vmwMemShares=vmwMemShares, vmwMemConfigured=vmwMemConfigured, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetPktsRx=vmwNetPktsRx, vmwNumWrites=vmwNumWrites, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmSuspended=vmSuspended, vmwNetName=vmwNetName, vmwCpuVMID=vmwCpuVMID, vmHBLost=vmHBLost, vpxdHostName=vpxdHostName, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetVMID=vmwNetVMID, vmwNumReads=vmwNumReads, vmwCpuEntry=vmwCpuEntry, vmwNetKbTx=vmwNetKbTx, vmwNetHCKbTx=vmwNetHCKbTx, vmPoweredOff=vmPoweredOff, vmwObsoleteGroup=vmwObsoleteGroup, vmwHbaIdx=vmwHbaIdx, vmwNetPktsTx=vmwNetPktsTx, vpxdOldStatus=vpxdOldStatus, vmwNetShares=vmwNetShares, vmwKbWritten=vmwKbWritten, vmwNetTable=vmwNetTable, vpxdTrapType=vpxdTrapType, vmwMemVMID=vmwMemVMID, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwHbaVMID=vmwHbaVMID, vmwDiskShares=vmwDiskShares, vpxdObjValue=vpxdObjValue, vmwCpuTable=vmwCpuTable, vmwCpuUtil=vmwCpuUtil, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemTable=vmwMemTable, vmPoweredOn=vmPoweredOn, vpxdVMName=vpxdVMName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetEntry=vmwNetEntry, vmkLoaded=vmkLoaded, vpxdNewStatus=vpxdNewStatus, vmwHBATable=vmwHBATable, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdTrap=vpxdTrap, vmHBDetected=vmHBDetected, vmwHBAEntry=vmwHBAEntry, vmwHbaName=vmwHbaName, vmwNetIdx=vmwNetIdx, vmwKbRead=vmwKbRead, vmwNetKbRx=vmwNetKbRx, vmwNetIfAddr=vmwNetIfAddr)
