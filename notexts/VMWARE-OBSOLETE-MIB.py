...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNumWrites=vmwNumWrites, vmwMemShares=vmwMemShares, vpxdTrap=vpxdTrap, vmPoweredOn=vmPoweredOn, vmwKbRead=vmwKbRead, vmwMemConfigured=vmwMemConfigured, vpxdOldStatus=vpxdOldStatus, vmwHbaIdx=vmwHbaIdx, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwKbWritten=vmwKbWritten, vmHBDetected=vmHBDetected, vmwMemTable=vmwMemTable, vmwNetTable=vmwNetTable, vmPoweredOff=vmPoweredOff, vmwMemVMID=vmwMemVMID, vmwMemUtil=vmwMemUtil, vpxdHostName=vpxdHostName, vmwHBATable=vmwHBATable, vmHBLost=vmHBLost, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuTable=vmwCpuTable, vmwNetName=vmwNetName, vmwNetKbTx=vmwNetKbTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetKbRx=vmwNetKbRx, vmwCpuEntry=vmwCpuEntry, vmwNetHCKbTx=vmwNetHCKbTx, vmwDiskShares=vmwDiskShares, vpxdVMName=vpxdVMName, vmkLoaded=vmkLoaded, vpxdTrapType=vpxdTrapType, vmwNumReads=vmwNumReads, vmwNetVMID=vmwNetVMID, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemEntry=vmwMemEntry, vmwObsoleteGroup=vmwObsoleteGroup, vmwHbaName=vmwHbaName, vmwCpuUtil=vmwCpuUtil, vpxdObjValue=vpxdObjValue, vmSuspended=vmSuspended, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetIfAddr=vmwNetIfAddr, vmwNetShares=vmwNetShares, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetIdx=vmwNetIdx, vmwCpuShares=vmwCpuShares, vmwHBAEntry=vmwHBAEntry, vmwNetEntry=vmwNetEntry, vmwHbaVMID=vmwHbaVMID, vmwCpuVMID=vmwCpuVMID, vpxdNewStatus=vpxdNewStatus)
