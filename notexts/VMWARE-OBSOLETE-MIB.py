...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmkLoaded=vmkLoaded, vmwKbWritten=vmwKbWritten, vmwNetEntry=vmwNetEntry, vmwNetVMID=vmwNetVMID, vpxdHostName=vpxdHostName, vmHBLost=vmHBLost, vmwCpuUtil=vmwCpuUtil, vpxdObjValue=vpxdObjValue, vmwNetTable=vmwNetTable, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetShares=vmwNetShares, vmwCpuVMID=vmwCpuVMID, vpxdNewStatus=vpxdNewStatus, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuTable=vmwCpuTable, vmwObsMIBGroups=vmwObsMIBGroups, vpxdTrapType=vpxdTrapType, vmwHBAEntry=vmwHBAEntry, vmwHbaVMID=vmwHbaVMID, vmwNetIdx=vmwNetIdx, vmwMemTable=vmwMemTable, vmPoweredOn=vmPoweredOn, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemEntry=vmwMemEntry, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetKbTx=vmwNetKbTx, vmwMemVMID=vmwMemVMID, vmwNetPktsTx=vmwNetPktsTx, vmwHbaName=vmwHbaName, vmwCpuShares=vmwCpuShares, vmwNumReads=vmwNumReads, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetPktsRx=vmwNetPktsRx, vmwCpuEntry=vmwCpuEntry, vpxdOldStatus=vpxdOldStatus, vmHBDetected=vmHBDetected, vmwMemUtil=vmwMemUtil, vmwMemConfigured=vmwMemConfigured, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHBATable=vmwHBATable, vmwNetHCKbTx=vmwNetHCKbTx, vpxdTrap=vpxdTrap, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwHbaIdx=vmwHbaIdx, vmwNetKbRx=vmwNetKbRx, vmwNumWrites=vmwNumWrites, vmSuspended=vmSuspended, vmwDiskShares=vmwDiskShares, vmwKbRead=vmwKbRead, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetName=vmwNetName, vmwObsoleteGroup=vmwObsoleteGroup, vmPoweredOff=vmPoweredOff, vpxdVMName=vpxdVMName, vmwMemShares=vmwMemShares)
