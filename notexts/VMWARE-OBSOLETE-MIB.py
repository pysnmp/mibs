...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwKbWritten=vmwKbWritten, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemUtil=vmwMemUtil, vmwNumReads=vmwNumReads, vmwHBATable=vmwHBATable, vmwMemEntry=vmwMemEntry, vmwCpuTable=vmwCpuTable, vmwHbaIdx=vmwHbaIdx, vmwCpuShares=vmwCpuShares, vpxdTrap=vpxdTrap, vmwHBAEntry=vmwHBAEntry, vpxdHostName=vpxdHostName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuVMID=vmwCpuVMID, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwKbRead=vmwKbRead, vmwNetHCKbRx=vmwNetHCKbRx, vmPoweredOn=vmPoweredOn, vmwCpuUtil=vmwCpuUtil, vmwDiskShares=vmwDiskShares, vmwNetShares=vmwNetShares, vmwNetPktsRx=vmwNetPktsRx, vmwMemShares=vmwMemShares, vmwHbaVMID=vmwHbaVMID, vmwHbaName=vmwHbaName, vmPoweredOff=vmPoweredOff, vmwNetVMID=vmwNetVMID, vpxdTrapType=vpxdTrapType, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemVMID=vmwMemVMID, vmkLoaded=vmkLoaded, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuEntry=vmwCpuEntry, vmwNetIdx=vmwNetIdx, vmwNetIfAddr=vmwNetIfAddr, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetKbTx=vmwNetKbTx, vmwNetTable=vmwNetTable, vmHBDetected=vmHBDetected, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNumWrites=vmwNumWrites, vpxdOldStatus=vpxdOldStatus, vmHBLost=vmHBLost, vmwNetEntry=vmwNetEntry, vmwNetKbRx=vmwNetKbRx, vmwNetHCKbTx=vmwNetHCKbTx, vpxdNewStatus=vpxdNewStatus, vmwMemConfigured=vmwMemConfigured, vpxdVMName=vpxdVMName, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemTable=vmwMemTable, vmwNetName=vmwNetName, vpxdObjValue=vpxdObjValue, vmSuspended=vmSuspended)
