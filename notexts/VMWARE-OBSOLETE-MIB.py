...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetEntry=vmwNetEntry, vmwHBAEntry=vmwHBAEntry, vpxdVMName=vpxdVMName, vmwObsMIBGroups=vmwObsMIBGroups, vmwKbRead=vmwKbRead, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdNewStatus=vpxdNewStatus, vmPoweredOff=vmPoweredOff, vmwHbaIdx=vmwHbaIdx, vmwHbaVMID=vmwHbaVMID, vmwNetKbTx=vmwNetKbTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuUtil=vmwCpuUtil, vpxdTrap=vpxdTrap, vmwCpuVMID=vmwCpuVMID, vpxdOldStatus=vpxdOldStatus, vmwHBATable=vmwHBATable, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetPktsRx=vmwNetPktsRx, vmkLoaded=vmkLoaded, vmwKbWritten=vmwKbWritten, vmwNetTable=vmwNetTable, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetVMID=vmwNetVMID, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemVMID=vmwMemVMID, vmwDiskShares=vmwDiskShares, vmwMemTable=vmwMemTable, vmwCpuEntry=vmwCpuEntry, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemEntry=vmwMemEntry, vmwNetIdx=vmwNetIdx, vmwNumWrites=vmwNumWrites, vmwNetPktsTx=vmwNetPktsTx, vmwNetKbRx=vmwNetKbRx, vmwNetShares=vmwNetShares, vpxdTrapType=vpxdTrapType, vmHBLost=vmHBLost, vmwNetHCKbTx=vmwNetHCKbTx, vmPoweredOn=vmPoweredOn, vpxdObjValue=vpxdObjValue, vmwNetName=vmwNetName, vmwNetIfAddr=vmwNetIfAddr, vmwMemUtil=vmwMemUtil, vmwNumReads=vmwNumReads, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHbaName=vmwHbaName, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmHBDetected=vmHBDetected, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuShares=vmwCpuShares, vmSuspended=vmSuspended, vmwCpuTable=vmwCpuTable, vmwMemConfigured=vmwMemConfigured, vmwMemShares=vmwMemShares, vpxdHostName=vpxdHostName)
