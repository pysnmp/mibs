...
ObjectIdentity, Integer32, NotificationType, MibIdentifier, iso, ModuleIdentity, IpAddress, Counter32, Gauge32, Counter64, Bits, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "NotificationType", "MibIdentifier", "iso", "ModuleIdentity", "IpAddress", "Counter32", "Gauge32", "Counter64", "Bits", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemUtil=vmwMemUtil, vmwMemTable=vmwMemTable, vmwNetKbRx=vmwNetKbRx, vmwMemVMID=vmwMemVMID, vmwCpuEntry=vmwCpuEntry, vmwCpuVMID=vmwCpuVMID, vmwHbaName=vmwHbaName, vmwKbWritten=vmwKbWritten, vmwNetTable=vmwNetTable, vmwNetHCKbRx=vmwNetHCKbRx, vpxdVMName=vpxdVMName, vpxdObjValue=vpxdObjValue, vmHBDetected=vmHBDetected, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteGroup=vmwObsoleteGroup, vpxdTrap=vpxdTrap, vmwHbaVMID=vmwHbaVMID, vmkLoaded=vmkLoaded, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemEntry=vmwMemEntry, vmwNetVMID=vmwNetVMID, vmwNetShares=vmwNetShares, vmwNumReads=vmwNumReads, vpxdTrapType=vpxdTrapType, vmwNetEntry=vmwNetEntry, vmwHBAEntry=vmwHBAEntry, vmwCpuShares=vmwCpuShares, vmwMemConfigured=vmwMemConfigured, vmwNumWrites=vmwNumWrites, vmwNetIfAddr=vmwNetIfAddr, vmwNetKbTx=vmwNetKbTx, vmwMemShares=vmwMemShares, vmwDiskShares=vmwDiskShares, vmwNetName=vmwNetName, vmwCpuTable=vmwCpuTable, vpxdNewStatus=vpxdNewStatus, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetPktsTx=vmwNetPktsTx, vmwHbaIdx=vmwHbaIdx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdHostName=vpxdHostName, vmwKbRead=vmwKbRead, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdOldStatus=vpxdOldStatus, vmwObsoleteMIB=vmwObsoleteMIB, vmPoweredOn=vmPoweredOn, vmPoweredOff=vmPoweredOff, vmHBLost=vmHBLost, vmSuspended=vmSuspended, vmwNetIdx=vmwNetIdx, vmwNetHCKbTx=vmwNetHCKbTx, vmwHBATable=vmwHBATable, vmwCpuUtil=vmwCpuUtil, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance)
