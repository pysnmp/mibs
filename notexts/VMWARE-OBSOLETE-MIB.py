...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, Unsigned32, ObjectIdentity, Counter64, NotificationType, ModuleIdentity, Bits, Integer32, Counter32, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "Unsigned32", "ObjectIdentity", "Counter64", "NotificationType", "ModuleIdentity", "Bits", "Integer32", "Counter32", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdObjValue=vpxdObjValue, vpxdTrapType=vpxdTrapType, vmwNetVMID=vmwNetVMID, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdHostName=vpxdHostName, vmHBLost=vmHBLost, vpxdVMName=vpxdVMName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmPoweredOn=vmPoweredOn, vmwMemVMID=vmwMemVMID, vmwDiskShares=vmwDiskShares, vmwCpuVMID=vmwCpuVMID, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemConfigured=vmwMemConfigured, vmwNetIdx=vmwNetIdx, vpxdTrap=vpxdTrap, vmPoweredOff=vmPoweredOff, vmwNetKbRx=vmwNetKbRx, vmwCpuUtil=vmwCpuUtil, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetShares=vmwNetShares, vmwMemEntry=vmwMemEntry, vmHBDetected=vmHBDetected, vmwMemUtil=vmwMemUtil, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetPktsRx=vmwNetPktsRx, vmwNetTable=vmwNetTable, vmwKbRead=vmwKbRead, vmwObsMIBGroups=vmwObsMIBGroups, vmwHbaVMID=vmwHbaVMID, vmwNetKbTx=vmwNetKbTx, vmwHBATable=vmwHBATable, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNumWrites=vmwNumWrites, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuShares=vmwCpuShares, vmwNetEntry=vmwNetEntry, vmwMemShares=vmwMemShares, vmwCpuEntry=vmwCpuEntry, vmkLoaded=vmkLoaded, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHbaName=vmwHbaName, vpxdOldStatus=vpxdOldStatus, vmSuspended=vmSuspended, vmwCpuTable=vmwCpuTable, vmwKbWritten=vmwKbWritten, vmwNetIfAddr=vmwNetIfAddr, vmwNumReads=vmwNumReads, vmwNetName=vmwNetName, vmwMemTable=vmwMemTable, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetPktsTx=vmwNetPktsTx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHBAEntry=vmwHBAEntry, vmwHbaIdx=vmwHbaIdx, vpxdNewStatus=vpxdNewStatus)
