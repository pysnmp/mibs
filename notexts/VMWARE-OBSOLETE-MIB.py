...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemTable=vmwMemTable, vmwMemShares=vmwMemShares, vpxdTrapType=vpxdTrapType, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwKbRead=vmwKbRead, vmwMemConfigured=vmwMemConfigured, vmwMemVMID=vmwMemVMID, vmwMemUtil=vmwMemUtil, vpxdTrap=vpxdTrap, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetEntry=vmwNetEntry, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetVMID=vmwNetVMID, vmwHbaIdx=vmwHbaIdx, vmwNetPktsRx=vmwNetPktsRx, vmwCpuEntry=vmwCpuEntry, vmwNetShares=vmwNetShares, vmwNetKbRx=vmwNetKbRx, vmwNetName=vmwNetName, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdVMName=vpxdVMName, vpxdNewStatus=vpxdNewStatus, vmwNetTable=vmwNetTable, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetKbTx=vmwNetKbTx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdHostName=vpxdHostName, vmHBDetected=vmHBDetected, vmPoweredOn=vmPoweredOn, vpxdObjValue=vpxdObjValue, vmwCpuTable=vmwCpuTable, vmwNetPktsTx=vmwNetPktsTx, vmwCpuVMID=vmwCpuVMID, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmSuspended=vmSuspended, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuUtil=vmwCpuUtil, vmwHBAEntry=vmwHBAEntry, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwHbaName=vmwHbaName, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCKbTx=vmwNetHCKbTx, vmHBLost=vmHBLost, vmwCpuShares=vmwCpuShares, vmwObsoleteGroup=vmwObsoleteGroup, vmwNumReads=vmwNumReads, vmPoweredOff=vmPoweredOff, vpxdOldStatus=vpxdOldStatus, vmwDiskShares=vmwDiskShares, vmwNetIdx=vmwNetIdx, vmwKbWritten=vmwKbWritten, vmwNumWrites=vmwNumWrites, vmwMemEntry=vmwMemEntry, vmkLoaded=vmkLoaded, vmwObsMIBGroups=vmwObsMIBGroups, vmwHbaVMID=vmwHbaVMID, vmwHBATable=vmwHBATable)
