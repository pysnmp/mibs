...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmSuspended=vmSuspended, vmwCpuTable=vmwCpuTable, vmwNetEntry=vmwNetEntry, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemConfigured=vmwMemConfigured, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetShares=vmwNetShares, vmwMemUtil=vmwMemUtil, vmwHBAEntry=vmwHBAEntry, vpxdHostName=vpxdHostName, vmwKbRead=vmwKbRead, vmHBLost=vmHBLost, vmwHbaIdx=vmwHbaIdx, vmwCpuUtil=vmwCpuUtil, vmwDiskShares=vmwDiskShares, vmwNetHCKbTx=vmwNetHCKbTx, vpxdTrapType=vpxdTrapType, vpxdVMName=vpxdVMName, vmwObsoleteGroup=vmwObsoleteGroup, vmPoweredOn=vmPoweredOn, vmwNumReads=vmwNumReads, vmwHbaVMID=vmwHbaVMID, vmwNetPktsTx=vmwNetPktsTx, vmwNetKbRx=vmwNetKbRx, vmwNetTable=vmwNetTable, vmwMemVMID=vmwMemVMID, vmwNetVMID=vmwNetVMID, vmwHBATable=vmwHBATable, vpxdObjValue=vpxdObjValue, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuVMID=vmwCpuVMID, vmHBDetected=vmHBDetected, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetKbTx=vmwNetKbTx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmPoweredOff=vmPoweredOff, vmwCpuEntry=vmwCpuEntry, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetPktsRx=vmwNetPktsRx, vpxdNewStatus=vpxdNewStatus, vmwObsMIBGroups=vmwObsMIBGroups, vmwKbWritten=vmwKbWritten, vmwMemTable=vmwMemTable, vmwMemEntry=vmwMemEntry, vmkLoaded=vmkLoaded, vmwNumWrites=vmwNumWrites, vpxdTrap=vpxdTrap, vmwNetName=vmwNetName, vmwHbaName=vmwHbaName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetIfAddr=vmwNetIfAddr, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetIdx=vmwNetIdx, vmwMemShares=vmwMemShares, vpxdOldStatus=vpxdOldStatus, vmwCpuShares=vmwCpuShares)
