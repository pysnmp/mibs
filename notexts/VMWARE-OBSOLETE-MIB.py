...
NotificationType, IpAddress, Unsigned32, TimeTicks, Bits, Integer32, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32, ModuleIdentity, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "Unsigned32", "TimeTicks", "Bits", "Integer32", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32", "ModuleIdentity", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNumWrites=vmwNumWrites, vmwHbaName=vmwHbaName, vmwCpuEntry=vmwCpuEntry, vpxdTrap=vpxdTrap, vmwNetKbRx=vmwNetKbRx, vmwMemConfigured=vmwMemConfigured, vmwCpuVMID=vmwCpuVMID, vmwKbWritten=vmwKbWritten, vmwNetIdx=vmwNetIdx, vmwMemShares=vmwMemShares, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdHostName=vpxdHostName, vmHBDetected=vmHBDetected, vmwObsoleteGroup=vmwObsoleteGroup, vmPoweredOff=vmPoweredOff, vmwCpuTable=vmwCpuTable, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmSuspended=vmSuspended, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuShares=vmwCpuShares, vmHBLost=vmHBLost, vmwNumReads=vmwNumReads, vmkLoaded=vmkLoaded, vmwNetName=vmwNetName, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemUtil=vmwMemUtil, vmwObsoleteMIB=vmwObsoleteMIB, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetIfAddr=vmwNetIfAddr, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemEntry=vmwMemEntry, vpxdOldStatus=vpxdOldStatus, vpxdVMName=vpxdVMName, vpxdTrapType=vpxdTrapType, vmwMemVMID=vmwMemVMID, vmwNetShares=vmwNetShares, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHbaVMID=vmwHbaVMID, vmwNetKbTx=vmwNetKbTx, vmwHBATable=vmwHBATable, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCKbTx=vmwNetHCKbTx, vmwHBAEntry=vmwHBAEntry, vmwKbRead=vmwKbRead, vmwMemTable=vmwMemTable, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuUtil=vmwCpuUtil, vmwNetPktsTx=vmwNetPktsTx, vpxdObjValue=vpxdObjValue, vmwHbaIdx=vmwHbaIdx, vmwNetEntry=vmwNetEntry, vpxdNewStatus=vpxdNewStatus, vmwNetVMID=vmwNetVMID, vmPoweredOn=vmPoweredOn, vmwNetTable=vmwNetTable, vmwDiskShares=vmwDiskShares)
