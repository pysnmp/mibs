...
ModuleIdentity, iso, Gauge32, Counter32, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, TimeTicks, Counter64, Unsigned32, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "Gauge32", "Counter32", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "TimeTicks", "Counter64", "Unsigned32", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemEntry=vmwMemEntry, vmwMemUtil=vmwMemUtil, vpxdTrap=vpxdTrap, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemVMID=vmwMemVMID, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetKbTx=vmwNetKbTx, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetPktsTx=vmwNetPktsTx, vmwObsMIBGroups=vmwObsMIBGroups, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHbaVMID=vmwHbaVMID, vmkLoaded=vmkLoaded, vpxdNewStatus=vpxdNewStatus, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdVMName=vpxdVMName, vmwCpuVMID=vmwCpuVMID, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHbaIdx=vmwHbaIdx, vmwCpuTable=vmwCpuTable, vpxdOldStatus=vpxdOldStatus, vmHBLost=vmHBLost, vmwNetPktsRx=vmwNetPktsRx, vmwDiskShares=vmwDiskShares, vmwNetKbRx=vmwNetKbRx, vmwNumReads=vmwNumReads, vmwNetIdx=vmwNetIdx, vmwNetTable=vmwNetTable, vmwCpuEntry=vmwCpuEntry, vmwHbaName=vmwHbaName, vmwKbRead=vmwKbRead, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetIfAddr=vmwNetIfAddr, vmwNetShares=vmwNetShares, vmwNetName=vmwNetName, vmwHBATable=vmwHBATable, vmwNetEntry=vmwNetEntry, vpxdTrapType=vpxdTrapType, vmwNetVMID=vmwNetVMID, vmwHBAEntry=vmwHBAEntry, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmSuspended=vmSuspended, vmwCpuShares=vmwCpuShares, vmwMemShares=vmwMemShares, vmHBDetected=vmHBDetected, vpxdObjValue=vpxdObjValue, vmwNumWrites=vmwNumWrites, vmwNetHCKbTx=vmwNetHCKbTx, vmwKbWritten=vmwKbWritten, vmPoweredOn=vmPoweredOn, vmwMemConfigured=vmwMemConfigured, vmwObsoleteMIB=vmwObsoleteMIB, vmPoweredOff=vmPoweredOff, vmwMemTable=vmwMemTable, vmwCpuUtil=vmwCpuUtil, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdHostName=vpxdHostName)
