...
NotificationType, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, Integer32, Bits, ObjectIdentity, Unsigned32, Gauge32, Counter32, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "Integer32", "Bits", "ObjectIdentity", "Unsigned32", "Gauge32", "Counter32", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemTable=vmwMemTable, vmwHbaIdx=vmwHbaIdx, vmHBDetected=vmHBDetected, vmwKbWritten=vmwKbWritten, vmwMemUtil=vmwMemUtil, vmwObsoleteGroup=vmwObsoleteGroup, vpxdTrapType=vpxdTrapType, vpxdOldStatus=vpxdOldStatus, vmwNetIdx=vmwNetIdx, vmwMemEntry=vmwMemEntry, vmwNetPktsRx=vmwNetPktsRx, vmwNumWrites=vmwNumWrites, vmwCpuEntry=vmwCpuEntry, vmkLoaded=vmkLoaded, vmwHBAEntry=vmwHBAEntry, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdObjValue=vpxdObjValue, vmwMemShares=vmwMemShares, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetKbTx=vmwNetKbTx, vmPoweredOn=vmPoweredOn, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetVMID=vmwNetVMID, vmwNetName=vmwNetName, vmwCpuTable=vmwCpuTable, vmwCpuUtil=vmwCpuUtil, vpxdNewStatus=vpxdNewStatus, vmPoweredOff=vmPoweredOff, vmHBLost=vmHBLost, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuVMID=vmwCpuVMID, vmwHbaVMID=vmwHbaVMID, vmwNumReads=vmwNumReads, vmwNetIfAddr=vmwNetIfAddr, vpxdVMName=vpxdVMName, vmwCpuShares=vmwCpuShares, vmwHBATable=vmwHBATable, vpxdTrap=vpxdTrap, vmSuspended=vmSuspended, vmwNetPktsTx=vmwNetPktsTx, vmwHbaName=vmwHbaName, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetKbRx=vmwNetKbRx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetEntry=vmwNetEntry, vmwMemVMID=vmwMemVMID, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetTable=vmwNetTable, vpxdHostName=vpxdHostName, vmwDiskShares=vmwDiskShares, vmwKbRead=vmwKbRead, vmwMemConfigured=vmwMemConfigured, vmwNetShares=vmwNetShares, vmwObsoleteMIB=vmwObsoleteMIB)
