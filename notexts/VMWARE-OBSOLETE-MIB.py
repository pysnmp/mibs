...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmPoweredOn=vmPoweredOn, vmPoweredOff=vmPoweredOff, vmwNetTable=vmwNetTable, vmwNetKbRx=vmwNetKbRx, vmwHBAEntry=vmwHBAEntry, vmHBLost=vmHBLost, vmSuspended=vmSuspended, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmkLoaded=vmkLoaded, vmwNumWrites=vmwNumWrites, vmwCpuUtil=vmwCpuUtil, vpxdNewStatus=vpxdNewStatus, vmwNetName=vmwNetName, vmwObsoleteMIB=vmwObsoleteMIB, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuEntry=vmwCpuEntry, vmwHbaName=vmwHbaName, vmwNetKbTx=vmwNetKbTx, vmwDiskShares=vmwDiskShares, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemTable=vmwMemTable, vpxdTrap=vpxdTrap, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwHbaIdx=vmwHbaIdx, vmwHbaVMID=vmwHbaVMID, vmwNetShares=vmwNetShares, vmwCpuTable=vmwCpuTable, vmwMemEntry=vmwMemEntry, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsMIBGroups=vmwObsMIBGroups, vpxdObjValue=vpxdObjValue, vmwMemVMID=vmwMemVMID, vmwNetPktsRx=vmwNetPktsRx, vmwCpuVMID=vmwCpuVMID, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwKbWritten=vmwKbWritten, vmwMemUtil=vmwMemUtil, vmwNumReads=vmwNumReads, vmwHBATable=vmwHBATable, vpxdHostName=vpxdHostName, vpxdOldStatus=vpxdOldStatus, vmwKbRead=vmwKbRead, vmwNetIfAddr=vmwNetIfAddr, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemShares=vmwMemShares, vmwNetPktsTx=vmwNetPktsTx, vmHBDetected=vmHBDetected, vmwNetVMID=vmwNetVMID, vmwMemConfigured=vmwMemConfigured, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdVMName=vpxdVMName, vpxdTrapType=vpxdTrapType, vmwCpuShares=vmwCpuShares, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetEntry=vmwNetEntry, vmwNetIdx=vmwNetIdx)
