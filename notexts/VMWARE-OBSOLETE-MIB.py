...
Counter32, Integer32, ModuleIdentity, Gauge32, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, Counter64, Bits, TimeTicks, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "ModuleIdentity", "Gauge32", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "Counter64", "Bits", "TimeTicks", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmSuspended=vmSuspended, vmwCpuUtil=vmwCpuUtil, vmwNetPktsRx=vmwNetPktsRx, vmwNumWrites=vmwNumWrites, vmwNetKbTx=vmwNetKbTx, vmwMemConfigured=vmwMemConfigured, vmwNetKbRx=vmwNetKbRx, vmwCpuVMID=vmwCpuVMID, vmwNetShares=vmwNetShares, vpxdHostName=vpxdHostName, vmHBLost=vmHBLost, vmwHbaIdx=vmwHbaIdx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetPktsTx=vmwNetPktsTx, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetVMID=vmwNetVMID, vmwHBAEntry=vmwHBAEntry, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetTable=vmwNetTable, vmwMemVMID=vmwMemVMID, vmwCpuTable=vmwCpuTable, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwDiskShares=vmwDiskShares, vmwMemUtil=vmwMemUtil, vmHBDetected=vmHBDetected, vmwMemEntry=vmwMemEntry, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHbaVMID=vmwHbaVMID, vpxdOldStatus=vpxdOldStatus, vmwHbaName=vmwHbaName, vmwKbWritten=vmwKbWritten, vmwMemTable=vmwMemTable, vpxdObjValue=vpxdObjValue, vmPoweredOn=vmPoweredOn, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuShares=vmwCpuShares, vmwCpuEntry=vmwCpuEntry, vpxdVMName=vpxdVMName, vpxdTrap=vpxdTrap, vmwNumReads=vmwNumReads, vpxdTrapType=vpxdTrapType, vmPoweredOff=vmPoweredOff, vmwObsoleteMIB=vmwObsoleteMIB, vmwHBATable=vmwHBATable, vmwNetEntry=vmwNetEntry, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteGroup=vmwObsoleteGroup, vmwKbRead=vmwKbRead, vpxdNewStatus=vpxdNewStatus, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetIdx=vmwNetIdx, vmwMemShares=vmwMemShares, vmwNetIfAddr=vmwNetIfAddr, vmkLoaded=vmkLoaded, vmwNetName=vmwNetName)
