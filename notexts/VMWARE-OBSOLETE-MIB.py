...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwHBAEntry=vmwHBAEntry, vmwMemTable=vmwMemTable, vmwNetShares=vmwNetShares, vmwNetName=vmwNetName, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetTable=vmwNetTable, vpxdNewStatus=vpxdNewStatus, vmPoweredOff=vmPoweredOff, vmkLoaded=vmkLoaded, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdTrap=vpxdTrap, vmwDiskShares=vmwDiskShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHbaIdx=vmwHbaIdx, vpxdObjValue=vpxdObjValue, vmwNetIfAddr=vmwNetIfAddr, vpxdVMName=vpxdVMName, vmwMemUtil=vmwMemUtil, vmwNetPktsTx=vmwNetPktsTx, vmwMemShares=vmwMemShares, vmwCpuEntry=vmwCpuEntry, vmwCpuTable=vmwCpuTable, vmwKbWritten=vmwKbWritten, vmwMemConfigured=vmwMemConfigured, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemVMID=vmwMemVMID, vmwNetVMID=vmwNetVMID, vmwMemEntry=vmwMemEntry, vmwNumWrites=vmwNumWrites, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdHostName=vpxdHostName, vmHBLost=vmHBLost, vmwCpuShares=vmwCpuShares, vmPoweredOn=vmPoweredOn, vpxdTrapType=vpxdTrapType, vmwNetIdx=vmwNetIdx, vmwNumReads=vmwNumReads, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmHBDetected=vmHBDetected, vmwCpuUtil=vmwCpuUtil, vmwNetKbTx=vmwNetKbTx, vpxdOldStatus=vpxdOldStatus, vmSuspended=vmSuspended, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwHBATable=vmwHBATable, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHbaName=vmwHbaName, vmwNetKbRx=vmwNetKbRx, vmwKbRead=vmwKbRead, vmwCpuVMID=vmwCpuVMID, vmwNetEntry=vmwNetEntry, vmwHbaVMID=vmwHbaVMID)
