...
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, Integer32, ModuleIdentity, Bits, MibIdentifier, NotificationType, IpAddress, Counter32, Unsigned32, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "Integer32", "ModuleIdentity", "Bits", "MibIdentifier", "NotificationType", "IpAddress", "Counter32", "Unsigned32", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemUtil=vmwMemUtil, vmwObsMIBGroups=vmwObsMIBGroups, vmwKbRead=vmwKbRead, vmwKbWritten=vmwKbWritten, vmwMemEntry=vmwMemEntry, vmPoweredOn=vmPoweredOn, vmwNetPktsRx=vmwNetPktsRx, vmwNetKbTx=vmwNetKbTx, vmwHbaName=vmwHbaName, vmwHbaVMID=vmwHbaVMID, vmwMemConfigured=vmwMemConfigured, vmkLoaded=vmkLoaded, vpxdNewStatus=vpxdNewStatus, vmwNetTable=vmwNetTable, vpxdHostName=vpxdHostName, vmwCpuTable=vmwCpuTable, vpxdOldStatus=vpxdOldStatus, vmSuspended=vmSuspended, vmwHbaIdx=vmwHbaIdx, vmwCpuShares=vmwCpuShares, vmwMemTable=vmwMemTable, vmwCpuVMID=vmwCpuVMID, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuEntry=vmwCpuEntry, vmwNetPktsTx=vmwNetPktsTx, vmwNetVMID=vmwNetVMID, vpxdObjValue=vpxdObjValue, vmwHBATable=vmwHBATable, vmHBLost=vmHBLost, vpxdTrapType=vpxdTrapType, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetName=vmwNetName, vmwNetHCKbTx=vmwNetHCKbTx, vmHBDetected=vmHBDetected, vmPoweredOff=vmPoweredOff, vmwNumReads=vmwNumReads, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdTrap=vpxdTrap, vmwHBAEntry=vmwHBAEntry, vmwDiskShares=vmwDiskShares, vmwNetShares=vmwNetShares, vmwNumWrites=vmwNumWrites, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemShares=vmwMemShares, vmwCpuUtil=vmwCpuUtil, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetEntry=vmwNetEntry, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemVMID=vmwMemVMID, vpxdVMName=vpxdVMName, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetKbRx=vmwNetKbRx, vmwNetIdx=vmwNetIdx, vmwNetIfAddr=vmwNetIfAddr)
