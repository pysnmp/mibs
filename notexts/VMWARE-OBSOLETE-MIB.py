...
IpAddress, Gauge32, Bits, MibIdentifier, Unsigned32, Integer32, ModuleIdentity, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "Bits", "MibIdentifier", "Unsigned32", "Integer32", "ModuleIdentity", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwHBAEntry=vmwHBAEntry, vmwNetName=vmwNetName, vmwMemShares=vmwMemShares, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetVMID=vmwNetVMID, vmwNetKbRx=vmwNetKbRx, vmwMemEntry=vmwMemEntry, vpxdTrapType=vpxdTrapType, vpxdTrap=vpxdTrap, vpxdNewStatus=vpxdNewStatus, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetIdx=vmwNetIdx, vmwHbaIdx=vmwHbaIdx, vmwNetPktsTx=vmwNetPktsTx, vmwObsoleteGroup=vmwObsoleteGroup, vpxdObjValue=vpxdObjValue, vmwNetIfAddr=vmwNetIfAddr, vpxdHostName=vpxdHostName, vmHBLost=vmHBLost, vmwNetKbTx=vmwNetKbTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwNumWrites=vmwNumWrites, vmwNumReads=vmwNumReads, vmwNetEntry=vmwNetEntry, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetTable=vmwNetTable, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuEntry=vmwCpuEntry, vmwCpuUtil=vmwCpuUtil, vmwMemVMID=vmwMemVMID, vmwMemTable=vmwMemTable, vmHBDetected=vmHBDetected, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmPoweredOff=vmPoweredOff, vmwHBATable=vmwHBATable, vmwNetShares=vmwNetShares, vmwMemConfigured=vmwMemConfigured, vpxdVMName=vpxdVMName, vmSuspended=vmSuspended, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHbaVMID=vmwHbaVMID, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuVMID=vmwCpuVMID, vmwCpuTable=vmwCpuTable, vmwObsoleteMIB=vmwObsoleteMIB, vmPoweredOn=vmPoweredOn, vmwHbaName=vmwHbaName, vmwDiskShares=vmwDiskShares, vmwKbRead=vmwKbRead, vmkLoaded=vmkLoaded, vmwMemUtil=vmwMemUtil, vmwNetPktsRx=vmwNetPktsRx, vpxdOldStatus=vpxdOldStatus, vmwCpuShares=vmwCpuShares, vmwKbWritten=vmwKbWritten, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetHCPktsTx=vmwNetHCPktsTx)
