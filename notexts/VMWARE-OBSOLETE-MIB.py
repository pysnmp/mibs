...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, Unsigned32, iso, ModuleIdentity, Bits, MibIdentifier, Counter32, Integer32, ObjectIdentity, TimeTicks, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "Unsigned32", "iso", "ModuleIdentity", "Bits", "MibIdentifier", "Counter32", "Integer32", "ObjectIdentity", "TimeTicks", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemUtil=vmwMemUtil, vmwHbaIdx=vmwHbaIdx, vmwNetHCKbTx=vmwNetHCKbTx, vmwKbWritten=vmwKbWritten, vmwHBAEntry=vmwHBAEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetTable=vmwNetTable, vmwNetKbTx=vmwNetKbTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwKbRead=vmwKbRead, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdOldStatus=vpxdOldStatus, vmkLoaded=vmkLoaded, vmwObsoleteGroup=vmwObsoleteGroup, vmwHbaVMID=vmwHbaVMID, vmwHbaName=vmwHbaName, vmPoweredOff=vmPoweredOff, vmwMemShares=vmwMemShares, vmwMemConfigured=vmwMemConfigured, vmPoweredOn=vmPoweredOn, vmSuspended=vmSuspended, vmwNetPktsRx=vmwNetPktsRx, vpxdNewStatus=vpxdNewStatus, vmwNetEntry=vmwNetEntry, vpxdTrap=vpxdTrap, vmwObsMIBGroups=vmwObsMIBGroups, vpxdObjValue=vpxdObjValue, vmwNetPktsTx=vmwNetPktsTx, vpxdTrapType=vpxdTrapType, vmHBDetected=vmHBDetected, vmwCpuVMID=vmwCpuVMID, vpxdVMName=vpxdVMName, vmwNetShares=vmwNetShares, vmwMemEntry=vmwMemEntry, vmwDiskShares=vmwDiskShares, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetKbRx=vmwNetKbRx, vmwNumWrites=vmwNumWrites, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetIfAddr=vmwNetIfAddr, vmwNetName=vmwNetName, vmwMemTable=vmwMemTable, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHBATable=vmwHBATable, vmwCpuShares=vmwCpuShares, vmHBLost=vmHBLost, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwCpuTable=vmwCpuTable, vmwCpuEntry=vmwCpuEntry, vpxdHostName=vpxdHostName, vmwNumReads=vmwNumReads, vmwCpuUtil=vmwCpuUtil, vmwNetIdx=vmwNetIdx, vmwNetVMID=vmwNetVMID, vmwMemVMID=vmwMemVMID)
