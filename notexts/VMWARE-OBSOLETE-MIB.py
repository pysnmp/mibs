...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, Counter64, ModuleIdentity, TimeTicks, ObjectIdentity, Gauge32, iso, Unsigned32, Counter32, Integer32, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "Counter64", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "Gauge32", "iso", "Unsigned32", "Counter32", "Integer32", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuTable=vmwCpuTable, vmwNetTable=vmwNetTable, vmwNetHCKbRx=vmwNetHCKbRx, vmwHbaName=vmwHbaName, vpxdTrapType=vpxdTrapType, vmwNetPktsRx=vmwNetPktsRx, vpxdOldStatus=vpxdOldStatus, vmwCpuShares=vmwCpuShares, vmwNetEntry=vmwNetEntry, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetShares=vmwNetShares, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmkLoaded=vmkLoaded, vmwMemConfigured=vmwMemConfigured, vmwMemTable=vmwMemTable, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetName=vmwNetName, vmPoweredOn=vmPoweredOn, vpxdHostName=vpxdHostName, vmwNumReads=vmwNumReads, vpxdTrap=vpxdTrap, vmwMemEntry=vmwMemEntry, vmwKbWritten=vmwKbWritten, vmwHbaIdx=vmwHbaIdx, vmwNumWrites=vmwNumWrites, vmwHbaVMID=vmwHbaVMID, vpxdNewStatus=vpxdNewStatus, vmwNetKbTx=vmwNetKbTx, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetKbRx=vmwNetKbRx, vmHBLost=vmHBLost, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuVMID=vmwCpuVMID, vmwNetVMID=vmwNetVMID, vmwNetIfAddr=vmwNetIfAddr, vmwDiskShares=vmwDiskShares, vmwNetPktsTx=vmwNetPktsTx, vmwCpuEntry=vmwCpuEntry, vmHBDetected=vmHBDetected, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuUtil=vmwCpuUtil, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdObjValue=vpxdObjValue, vmwObsoleteMIB=vmwObsoleteMIB, vpxdVMName=vpxdVMName, vmSuspended=vmSuspended, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemVMID=vmwMemVMID, vmwMemShares=vmwMemShares, vmwMemUtil=vmwMemUtil, vmwNetIdx=vmwNetIdx, vmwKbRead=vmwKbRead, vmwHBATable=vmwHBATable, vmwHBAEntry=vmwHBAEntry, vmPoweredOff=vmPoweredOff)
