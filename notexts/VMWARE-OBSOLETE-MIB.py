...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuUtil=vmwCpuUtil, vpxdTrap=vpxdTrap, vmwObsoleteMIB=vmwObsoleteMIB, vpxdVMName=vpxdVMName, vmwNetEntry=vmwNetEntry, vpxdTrapType=vpxdTrapType, vpxdHostName=vpxdHostName, vmwMemEntry=vmwMemEntry, vmwCpuTable=vmwCpuTable, vmwCpuEntry=vmwCpuEntry, vmwMemVMID=vmwMemVMID, vmHBDetected=vmHBDetected, vmwDiskShares=vmwDiskShares, vmwMemConfigured=vmwMemConfigured, vmwNetTable=vmwNetTable, vmSuspended=vmSuspended, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmkLoaded=vmkLoaded, vmwNumWrites=vmwNumWrites, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdNewStatus=vpxdNewStatus, vmwNetIdx=vmwNetIdx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwKbWritten=vmwKbWritten, vmHBLost=vmHBLost, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetIfAddr=vmwNetIfAddr, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemUtil=vmwMemUtil, vmPoweredOff=vmPoweredOff, vmwHbaVMID=vmwHbaVMID, vmwCpuShares=vmwCpuShares, vmwMemTable=vmwMemTable, vmwMemShares=vmwMemShares, vmwNetShares=vmwNetShares, vmwHBAEntry=vmwHBAEntry, vmwNetHCKbRx=vmwNetHCKbRx, vpxdOldStatus=vpxdOldStatus, vmwCpuVMID=vmwCpuVMID, vmwNumReads=vmwNumReads, vmwHbaIdx=vmwHbaIdx, vmwKbRead=vmwKbRead, vmwNetPktsRx=vmwNetPktsRx, vpxdObjValue=vpxdObjValue, vmwObsoleteGroup=vmwObsoleteGroup, vmPoweredOn=vmPoweredOn, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHbaName=vmwHbaName, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetName=vmwNetName, vmwNetKbRx=vmwNetKbRx, vmwNetPktsTx=vmwNetPktsTx, vmwHBATable=vmwHBATable, vmwNetKbTx=vmwNetKbTx, vmwNetVMID=vmwNetVMID)
