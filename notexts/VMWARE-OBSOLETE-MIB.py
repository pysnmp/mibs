...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, Integer32, TimeTicks, ObjectIdentity, Unsigned32, Counter64, IpAddress, iso, Gauge32, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "Integer32", "TimeTicks", "ObjectIdentity", "Unsigned32", "Counter64", "IpAddress", "iso", "Gauge32", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemTable=vmwMemTable, vmwNetHCPktsTx=vmwNetHCPktsTx, vmSuspended=vmSuspended, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetPktsRx=vmwNetPktsRx, vmwNetEntry=vmwNetEntry, vpxdTrap=vpxdTrap, vmwHbaVMID=vmwHbaVMID, vmPoweredOn=vmPoweredOn, vmwCpuShares=vmwCpuShares, vmwCpuTable=vmwCpuTable, vmwKbWritten=vmwKbWritten, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemEntry=vmwMemEntry, vmwMemShares=vmwMemShares, vpxdTrapType=vpxdTrapType, vmwNumReads=vmwNumReads, vmwNetHCKbRx=vmwNetHCKbRx, vmwCpuVMID=vmwCpuVMID, vmwHbaIdx=vmwHbaIdx, vmwNetTable=vmwNetTable, vmHBDetected=vmHBDetected, vmwNetPktsTx=vmwNetPktsTx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHbaName=vmwHbaName, vmwNetHCPktsRx=vmwNetHCPktsRx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmHBLost=vmHBLost, vmwNetShares=vmwNetShares, vpxdHostName=vpxdHostName, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdOldStatus=vpxdOldStatus, vmwDiskShares=vmwDiskShares, vmwNetIdx=vmwNetIdx, vmwNetName=vmwNetName, vmwCpuEntry=vmwCpuEntry, vmwNumWrites=vmwNumWrites, vmwMemConfigured=vmwMemConfigured, vmPoweredOff=vmPoweredOff, vmwObsoleteGroup=vmwObsoleteGroup, vpxdObjValue=vpxdObjValue, vmkLoaded=vmkLoaded, vpxdNewStatus=vpxdNewStatus, vpxdVMName=vpxdVMName, vmwHBATable=vmwHBATable, vmwNetKbRx=vmwNetKbRx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetIfAddr=vmwNetIfAddr, vmwCpuUtil=vmwCpuUtil, vmwMemUtil=vmwMemUtil, vmwMemVMID=vmwMemVMID, vmwHBAEntry=vmwHBAEntry, vmwKbRead=vmwKbRead, vmwNetKbTx=vmwNetKbTx, vmwNetVMID=vmwNetVMID)
