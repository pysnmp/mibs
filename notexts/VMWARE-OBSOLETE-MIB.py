...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, ModuleIdentity, Integer32, Bits, Gauge32, iso, ObjectIdentity, IpAddress, Counter32, NotificationType, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "ModuleIdentity", "Integer32", "Bits", "Gauge32", "iso", "ObjectIdentity", "IpAddress", "Counter32", "NotificationType", "Unsigned32", "MibIdentifier")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdNewStatus=vpxdNewStatus, vmwNumReads=vmwNumReads, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwDiskShares=vmwDiskShares, vmwKbRead=vmwKbRead, vmwNetIfAddr=vmwNetIfAddr, vmwNetKbTx=vmwNetKbTx, vmwObsoleteMIB=vmwObsoleteMIB, vmwHBAEntry=vmwHBAEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwKbWritten=vmwKbWritten, vmwHbaName=vmwHbaName, vmwMemConfigured=vmwMemConfigured, vpxdTrapType=vpxdTrapType, vmwNetVMID=vmwNetVMID, vmPoweredOn=vmPoweredOn, vmwNetPktsRx=vmwNetPktsRx, vpxdObjValue=vpxdObjValue, vpxdHostName=vpxdHostName, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetShares=vmwNetShares, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetPktsTx=vmwNetPktsTx, vmwMemShares=vmwMemShares, vmwNetKbRx=vmwNetKbRx, vpxdTrap=vpxdTrap, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsoleteGroup=vmwObsoleteGroup, vmwHbaVMID=vmwHbaVMID, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemTable=vmwMemTable, vpxdOldStatus=vpxdOldStatus, vmwNetName=vmwNetName, vmHBLost=vmHBLost, vmSuspended=vmSuspended, vmwNetEntry=vmwNetEntry, vmwNetIdx=vmwNetIdx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuEntry=vmwCpuEntry, vmwMemEntry=vmwMemEntry, vmwCpuUtil=vmwCpuUtil, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuVMID=vmwCpuVMID, vmwCpuShares=vmwCpuShares, vpxdVMName=vpxdVMName, vmwNetTable=vmwNetTable, vmwHBATable=vmwHBATable, vmPoweredOff=vmPoweredOff, vmwCpuTable=vmwCpuTable, vmwHbaIdx=vmwHbaIdx, vmwMemVMID=vmwMemVMID, vmwMemUtil=vmwMemUtil, vmwNumWrites=vmwNumWrites, vmHBDetected=vmHBDetected, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmkLoaded=vmkLoaded)
