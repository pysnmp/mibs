...
MibIdentifier, ObjectIdentity, TimeTicks, iso, Bits, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, Gauge32, Counter32, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "TimeTicks", "iso", "Bits", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "Gauge32", "Counter32", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetHCKbTx=vmwNetHCKbTx, vpxdNewStatus=vpxdNewStatus, vmwMemShares=vmwMemShares, vmwHBAEntry=vmwHBAEntry, vmwCpuShares=vmwCpuShares, vmwNetVMID=vmwNetVMID, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNumWrites=vmwNumWrites, vmwDiskShares=vmwDiskShares, vmwObsoleteMIB=vmwObsoleteMIB, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmPoweredOff=vmPoweredOff, vmwMemTable=vmwMemTable, vpxdOldStatus=vpxdOldStatus, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemVMID=vmwMemVMID, vmwKbRead=vmwKbRead, vmHBDetected=vmHBDetected, vmwObsoleteGroup=vmwObsoleteGroup, vmSuspended=vmSuspended, vpxdTrap=vpxdTrap, vmwNetTable=vmwNetTable, vmwMemEntry=vmwMemEntry, vmwHbaIdx=vmwHbaIdx, vmwNetKbTx=vmwNetKbTx, vpxdTrapType=vpxdTrapType, vmwMemUtil=vmwMemUtil, vmwCpuUtil=vmwCpuUtil, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetEntry=vmwNetEntry, vmwNetName=vmwNetName, vmwCpuTable=vmwCpuTable, vmwCpuVMID=vmwCpuVMID, vpxdObjValue=vpxdObjValue, vmHBLost=vmHBLost, vmwNetPktsTx=vmwNetPktsTx, vmwMemConfigured=vmwMemConfigured, vmwKbWritten=vmwKbWritten, vmwNetIfAddr=vmwNetIfAddr, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmkLoaded=vmkLoaded, vmwNetShares=vmwNetShares, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmPoweredOn=vmPoweredOn, vmwHBATable=vmwHBATable, vmwHbaName=vmwHbaName, vpxdHostName=vpxdHostName, vmwHbaVMID=vmwHbaVMID, vmwNetIdx=vmwNetIdx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwCpuEntry=vmwCpuEntry, vmwNetPktsRx=vmwNetPktsRx, vpxdVMName=vpxdVMName, vmwNetKbRx=vmwNetKbRx, vmwNumReads=vmwNumReads)
