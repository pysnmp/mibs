...
NotificationType, ObjectIdentity, Bits, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, Unsigned32, Counter32, Integer32, TimeTicks, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "Bits", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "Unsigned32", "Counter32", "Integer32", "TimeTicks", "Counter64", "iso")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwKbRead=vmwKbRead, vmwHBAEntry=vmwHBAEntry, vmwMemEntry=vmwMemEntry, vmSuspended=vmSuspended, vpxdTrapType=vpxdTrapType, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetTable=vmwNetTable, vmwNetEntry=vmwNetEntry, vmkLoaded=vmkLoaded, vmwNetName=vmwNetName, vpxdTrap=vpxdTrap, vmwCpuEntry=vmwCpuEntry, vmwHbaIdx=vmwHbaIdx, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetShares=vmwNetShares, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdHostName=vpxdHostName, vmHBLost=vmHBLost, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdObjValue=vpxdObjValue, vmwNumWrites=vmwNumWrites, vpxdVMName=vpxdVMName, vmwCpuShares=vmwCpuShares, vmwNetPktsRx=vmwNetPktsRx, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetKbRx=vmwNetKbRx, vmwMemTable=vmwMemTable, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCKbTx=vmwNetHCKbTx, vmwDiskShares=vmwDiskShares, vmwMemVMID=vmwMemVMID, vmHBDetected=vmHBDetected, vmwCpuTable=vmwCpuTable, vmwHbaVMID=vmwHbaVMID, vmwNetKbTx=vmwNetKbTx, vmwMemUtil=vmwMemUtil, vmwHbaName=vmwHbaName, vmwCpuUtil=vmwCpuUtil, vmPoweredOff=vmPoweredOff, vpxdNewStatus=vpxdNewStatus, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwHBATable=vmwHBATable, vmwMemConfigured=vmwMemConfigured, vmwNumReads=vmwNumReads, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemShares=vmwMemShares, vmPoweredOn=vmPoweredOn, vmwCpuVMID=vmwCpuVMID, vmwNetVMID=vmwNetVMID, vmwNetIdx=vmwNetIdx, vmwKbWritten=vmwKbWritten, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdOldStatus=vpxdOldStatus)
