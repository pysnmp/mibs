...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwObsoleteMIB=vmwObsoleteMIB, vmwHbaIdx=vmwHbaIdx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetShares=vmwNetShares, vmwHbaVMID=vmwHbaVMID, vpxdNewStatus=vpxdNewStatus, vmHBLost=vmHBLost, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetKbRx=vmwNetKbRx, vmwHBATable=vmwHBATable, vmwCpuEntry=vmwCpuEntry, vmwCpuUtil=vmwCpuUtil, vmwMemShares=vmwMemShares, vmPoweredOff=vmPoweredOff, vmPoweredOn=vmPoweredOn, vmwCpuTable=vmwCpuTable, vmwCpuVMID=vmwCpuVMID, vmwNetTable=vmwNetTable, vmwCpuShares=vmwCpuShares, vmwNetKbTx=vmwNetKbTx, vmwNetIfAddr=vmwNetIfAddr, vpxdObjValue=vpxdObjValue, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetEntry=vmwNetEntry, vmSuspended=vmSuspended, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetIdx=vmwNetIdx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNumReads=vmwNumReads, vmwHBAEntry=vmwHBAEntry, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteGroup=vmwObsoleteGroup, vpxdHostName=vpxdHostName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwDiskShares=vmwDiskShares, vmwKbRead=vmwKbRead, vmwNetPktsTx=vmwNetPktsTx, vpxdTrap=vpxdTrap, vmwHbaName=vmwHbaName, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemUtil=vmwMemUtil, vmwMemTable=vmwMemTable, vmwMemVMID=vmwMemVMID, vpxdTrapType=vpxdTrapType, vmwNumWrites=vmwNumWrites, vmwNetPktsRx=vmwNetPktsRx, vmkLoaded=vmkLoaded, vmwMemConfigured=vmwMemConfigured, vmwMemEntry=vmwMemEntry, vmwNetHCKbRx=vmwNetHCKbRx, vpxdVMName=vpxdVMName, vmwNetName=vmwNetName, vmHBDetected=vmHBDetected, vmwNetVMID=vmwNetVMID, vmwNetHCKbTx=vmwNetHCKbTx, vmwKbWritten=vmwKbWritten, vpxdOldStatus=vpxdOldStatus)
