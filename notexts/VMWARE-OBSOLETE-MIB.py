...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, Integer32, Counter64, ModuleIdentity, iso, NotificationType, MibIdentifier, Bits, IpAddress, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "Integer32", "Counter64", "ModuleIdentity", "iso", "NotificationType", "MibIdentifier", "Bits", "IpAddress", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetPktsRx=vmwNetPktsRx, vmwHBAEntry=vmwHBAEntry, vpxdHostName=vpxdHostName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdOldStatus=vpxdOldStatus, vmwMemVMID=vmwMemVMID, vmwMemConfigured=vmwMemConfigured, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmkLoaded=vmkLoaded, vmPoweredOn=vmPoweredOn, vmwNetVMID=vmwNetVMID, vmwNetEntry=vmwNetEntry, vmwNetHCKbRx=vmwNetHCKbRx, vmwCpuEntry=vmwCpuEntry, vmwCpuShares=vmwCpuShares, vmwNetTable=vmwNetTable, vmwNetKbRx=vmwNetKbRx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdTrapType=vpxdTrapType, vpxdVMName=vpxdVMName, vmwMemUtil=vmwMemUtil, vmwNetIdx=vmwNetIdx, vmPoweredOff=vmPoweredOff, vmwNetKbTx=vmwNetKbTx, vmwMemShares=vmwMemShares, vmwNumWrites=vmwNumWrites, vmwCpuUtil=vmwCpuUtil, vmwHbaVMID=vmwHbaVMID, vmHBDetected=vmHBDetected, vpxdTrap=vpxdTrap, vmwMemEntry=vmwMemEntry, vmwObsoleteMIB=vmwObsoleteMIB, vmwHbaIdx=vmwHbaIdx, vmwNetHCKbTx=vmwNetHCKbTx, vpxdObjValue=vpxdObjValue, vmwCpuTable=vmwCpuTable, vmwNetShares=vmwNetShares, vmwMemTable=vmwMemTable, vmwNetPktsTx=vmwNetPktsTx, vmwNetName=vmwNetName, vpxdNewStatus=vpxdNewStatus, vmwHbaName=vmwHbaName, vmwHBATable=vmwHBATable, vmwDiskShares=vmwDiskShares, vmwCpuVMID=vmwCpuVMID, vmwKbRead=vmwKbRead, vmHBLost=vmHBLost, vmwNetIfAddr=vmwNetIfAddr, vmwNumReads=vmwNumReads, vmSuspended=vmSuspended, vmwObsoleteGroup=vmwObsoleteGroup, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwKbWritten=vmwKbWritten, PYSNMP_MODULE_ID=vmwObsoleteMIB)
