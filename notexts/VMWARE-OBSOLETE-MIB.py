...
ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, Integer32, Gauge32, Counter64, Unsigned32, ModuleIdentity, Counter32, Bits, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "Integer32", "Gauge32", "Counter64", "Unsigned32", "ModuleIdentity", "Counter32", "Bits", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemVMID=vmwMemVMID, vmwMemConfigured=vmwMemConfigured, vmwNetPktsRx=vmwNetPktsRx, vmwHBATable=vmwHBATable, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetPktsTx=vmwNetPktsTx, vmwNumReads=vmwNumReads, vmwNetShares=vmwNetShares, vpxdObjValue=vpxdObjValue, vmPoweredOff=vmPoweredOff, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwDiskShares=vmwDiskShares, vmwNetHCKbRx=vmwNetHCKbRx, vmwKbWritten=vmwKbWritten, vpxdHostName=vpxdHostName, vmwNumWrites=vmwNumWrites, vpxdNewStatus=vpxdNewStatus, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemTable=vmwMemTable, vmwNetEntry=vmwNetEntry, vmwNetKbTx=vmwNetKbTx, vmwNetName=vmwNetName, vmwNetKbRx=vmwNetKbRx, vmHBDetected=vmHBDetected, vmwCpuShares=vmwCpuShares, vmPoweredOn=vmPoweredOn, vmwNetIdx=vmwNetIdx, vmwMemShares=vmwMemShares, vmwHbaName=vmwHbaName, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdTrapType=vpxdTrapType, vmHBLost=vmHBLost, vmwNetVMID=vmwNetVMID, vmwMemUtil=vmwMemUtil, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuEntry=vmwCpuEntry, vmwCpuTable=vmwCpuTable, vmwMemEntry=vmwMemEntry, vmwKbRead=vmwKbRead, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsMIBGroups=vmwObsMIBGroups, vpxdOldStatus=vpxdOldStatus, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHBAEntry=vmwHBAEntry, vmwCpuVMID=vmwCpuVMID, vmwHbaVMID=vmwHbaVMID, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuUtil=vmwCpuUtil, vmwNetIfAddr=vmwNetIfAddr, vmkLoaded=vmkLoaded, vpxdVMName=vpxdVMName, vmwHbaIdx=vmwHbaIdx, vmSuspended=vmSuspended, vmwNetTable=vmwNetTable, vpxdTrap=vpxdTrap)
