...
TimeTicks, NotificationType, IpAddress, ModuleIdentity, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, Bits, Integer32, ObjectIdentity, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "IpAddress", "ModuleIdentity", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "Bits", "Integer32", "ObjectIdentity", "Counter64", "MibIdentifier")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuVMID=vmwCpuVMID, vpxdVMName=vpxdVMName, vmwCpuTable=vmwCpuTable, vmwMemTable=vmwMemTable, vmwMemEntry=vmwMemEntry, vmwHbaVMID=vmwHbaVMID, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemVMID=vmwMemVMID, vmwMemShares=vmwMemShares, vmwHbaName=vmwHbaName, vmwNetIdx=vmwNetIdx, vmwNetHCKbRx=vmwNetHCKbRx, vmwCpuEntry=vmwCpuEntry, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetShares=vmwNetShares, vmwNetHCPktsRx=vmwNetHCPktsRx, vmkLoaded=vmkLoaded, vmwKbWritten=vmwKbWritten, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetTable=vmwNetTable, vmwKbRead=vmwKbRead, vpxdObjValue=vpxdObjValue, vmwHBATable=vmwHBATable, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNumWrites=vmwNumWrites, vmwNetKbTx=vmwNetKbTx, vpxdTrapType=vpxdTrapType, vmwCpuUtil=vmwCpuUtil, vmwObsoleteGroup=vmwObsoleteGroup, vmwHbaIdx=vmwHbaIdx, vpxdNewStatus=vpxdNewStatus, vmwDiskShares=vmwDiskShares, vmwNumReads=vmwNumReads, vpxdTrap=vpxdTrap, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetIfAddr=vmwNetIfAddr, vpxdHostName=vpxdHostName, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdOldStatus=vpxdOldStatus, vmPoweredOff=vmPoweredOff, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetVMID=vmwNetVMID, vmHBDetected=vmHBDetected, vmwCpuShares=vmwCpuShares, vmwNetPktsRx=vmwNetPktsRx, vmwNetName=vmwNetName, vmwNetPktsTx=vmwNetPktsTx, vmwMemConfigured=vmwMemConfigured, vmHBLost=vmHBLost, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwHBAEntry=vmwHBAEntry, vmwNetKbRx=vmwNetKbRx, vmPoweredOn=vmPoweredOn, vmwNetEntry=vmwNetEntry, vmwMemUtil=vmwMemUtil, vmSuspended=vmSuspended)
