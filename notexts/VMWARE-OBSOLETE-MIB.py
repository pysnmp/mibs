...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwHbaIdx=vmwHbaIdx, vmSuspended=vmSuspended, vmwCpuShares=vmwCpuShares, vmwNetPktsRx=vmwNetPktsRx, vpxdHostName=vpxdHostName, vmwNumWrites=vmwNumWrites, vpxdTrapType=vpxdTrapType, vmwMemConfigured=vmwMemConfigured, vmwCpuVMID=vmwCpuVMID, vmwMemVMID=vmwMemVMID, vmwKbWritten=vmwKbWritten, vmwNetKbRx=vmwNetKbRx, vpxdObjValue=vpxdObjValue, vmPoweredOff=vmPoweredOff, vpxdTrap=vpxdTrap, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetVMID=vmwNetVMID, vpxdVMName=vpxdVMName, vmwDiskShares=vmwDiskShares, vpxdOldStatus=vpxdOldStatus, vmwNetEntry=vmwNetEntry, vmwNetPktsTx=vmwNetPktsTx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuTable=vmwCpuTable, vmwObsMIBGroups=vmwObsMIBGroups, vmwHBATable=vmwHBATable, vmHBDetected=vmHBDetected, vmwNetTable=vmwNetTable, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuUtil=vmwCpuUtil, vmwMemTable=vmwMemTable, vmwMemUtil=vmwMemUtil, vmwHBAEntry=vmwHBAEntry, vmwMemShares=vmwMemShares, vmwNetKbTx=vmwNetKbTx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHbaName=vmwHbaName, vmwHbaVMID=vmwHbaVMID, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNumReads=vmwNumReads, vmwMemEntry=vmwMemEntry, vmwNetIdx=vmwNetIdx, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetName=vmwNetName, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetHCKbTx=vmwNetHCKbTx, vmkLoaded=vmkLoaded, vpxdNewStatus=vpxdNewStatus, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwKbRead=vmwKbRead, vmPoweredOn=vmPoweredOn, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuEntry=vmwCpuEntry, vmwNetShares=vmwNetShares, vmHBLost=vmHBLost, vmwNetIfAddr=vmwNetIfAddr)
