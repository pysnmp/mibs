...
Integer32, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, Gauge32, NotificationType, ModuleIdentity, Unsigned32, Bits, ObjectIdentity, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "Gauge32", "NotificationType", "ModuleIdentity", "Unsigned32", "Bits", "ObjectIdentity", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetHCPktsRx=vmwNetHCPktsRx, vmSuspended=vmSuspended, vmwCpuEntry=vmwCpuEntry, vmwNetName=vmwNetName, vmwMemVMID=vmwMemVMID, vmwObsMIBGroups=vmwObsMIBGroups, vpxdTrap=vpxdTrap, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHbaIdx=vmwHbaIdx, vpxdTrapType=vpxdTrapType, vmwNetPktsTx=vmwNetPktsTx, vmwNetVMID=vmwNetVMID, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwDiskShares=vmwDiskShares, vmwHbaName=vmwHbaName, vmwNumReads=vmwNumReads, vmwNetPktsRx=vmwNetPktsRx, vpxdNewStatus=vpxdNewStatus, vmwHBATable=vmwHBATable, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetEntry=vmwNetEntry, vmwNumWrites=vmwNumWrites, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuUtil=vmwCpuUtil, vmPoweredOn=vmPoweredOn, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemEntry=vmwMemEntry, vmwNetKbTx=vmwNetKbTx, vpxdOldStatus=vpxdOldStatus, vmwMemUtil=vmwMemUtil, vmwNetIdx=vmwNetIdx, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemTable=vmwMemTable, vmwMemShares=vmwMemShares, vmwHBAEntry=vmwHBAEntry, vpxdVMName=vpxdVMName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmkLoaded=vmkLoaded, vmwKbRead=vmwKbRead, vmwKbWritten=vmwKbWritten, vmwCpuShares=vmwCpuShares, vmwHbaVMID=vmwHbaVMID, vmPoweredOff=vmPoweredOff, vmwNetIfAddr=vmwNetIfAddr, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemConfigured=vmwMemConfigured, vmwNetTable=vmwNetTable, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetKbRx=vmwNetKbRx, vmHBDetected=vmHBDetected, vmwCpuVMID=vmwCpuVMID, vpxdObjValue=vpxdObjValue, vmwCpuTable=vmwCpuTable, vmwNetShares=vmwNetShares, vpxdHostName=vpxdHostName, vmHBLost=vmHBLost)
