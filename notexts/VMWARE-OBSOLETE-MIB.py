...
IpAddress, Gauge32, ModuleIdentity, TimeTicks, ObjectIdentity, Counter32, Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, Integer32, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "Counter32", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "Integer32", "NotificationType", "MibIdentifier")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdTrapType=vpxdTrapType, vmwCpuVMID=vmwCpuVMID, vmwNetKbTx=vmwNetKbTx, vmwNumReads=vmwNumReads, vmwNetKbRx=vmwNetKbRx, vmwNetHCKbRx=vmwNetHCKbRx, vpxdTrap=vpxdTrap, vmwObsoleteGroup=vmwObsoleteGroup, vpxdHostName=vpxdHostName, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmPoweredOff=vmPoweredOff, vmwMemUtil=vmwMemUtil, vmwNetEntry=vmwNetEntry, vmwNetPktsTx=vmwNetPktsTx, vmPoweredOn=vmPoweredOn, vmwCpuTable=vmwCpuTable, vmwNetShares=vmwNetShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdNewStatus=vpxdNewStatus, vmwKbWritten=vmwKbWritten, vmwNumWrites=vmwNumWrites, vmwDiskShares=vmwDiskShares, vmwHBAEntry=vmwHBAEntry, vmwHbaName=vmwHbaName, vmwHbaVMID=vmwHbaVMID, vmwNetHCPktsRx=vmwNetHCPktsRx, vmkLoaded=vmkLoaded, vmwCpuShares=vmwCpuShares, vmwMemVMID=vmwMemVMID, vmwNetIfAddr=vmwNetIfAddr, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwKbRead=vmwKbRead, vpxdObjValue=vpxdObjValue, vmwObsMIBGroups=vmwObsMIBGroups, vmwHbaIdx=vmwHbaIdx, vmHBLost=vmHBLost, vmwMemEntry=vmwMemEntry, vmwMemConfigured=vmwMemConfigured, vmHBDetected=vmHBDetected, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetVMID=vmwNetVMID, vmwMemShares=vmwMemShares, vpxdOldStatus=vpxdOldStatus, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteMIB=vmwObsoleteMIB, vmwHBATable=vmwHBATable, vmwNetIdx=vmwNetIdx, vmwCpuEntry=vmwCpuEntry, vpxdVMName=vpxdVMName, vmSuspended=vmSuspended, vmwMemTable=vmwMemTable, vmwNetPktsRx=vmwNetPktsRx, vmwNetTable=vmwNetTable, vmwNetName=vmwNetName, vmwCpuUtil=vmwCpuUtil)
