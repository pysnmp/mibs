...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwHbaVMID=vmwHbaVMID, vmwNetKbTx=vmwNetKbTx, vpxdNewStatus=vpxdNewStatus, vmSuspended=vmSuspended, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwCpuTable=vmwCpuTable, vmwMemConfigured=vmwMemConfigured, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmPoweredOn=vmPoweredOn, vmwMemEntry=vmwMemEntry, vmwNetVMID=vmwNetVMID, vpxdVMName=vpxdVMName, vmHBLost=vmHBLost, vmwHbaIdx=vmwHbaIdx, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwDiskShares=vmwDiskShares, vmwNetTable=vmwNetTable, vmwNetHCKbRx=vmwNetHCKbRx, vmwNumWrites=vmwNumWrites, vmwNetKbRx=vmwNetKbRx, vpxdTrap=vpxdTrap, vmwNetIdx=vmwNetIdx, vmwHBAEntry=vmwHBAEntry, vmHBDetected=vmHBDetected, vmwHbaName=vmwHbaName, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemShares=vmwMemShares, vmwNetPktsRx=vmwNetPktsRx, vmPoweredOff=vmPoweredOff, vmwNetIfAddr=vmwNetIfAddr, vmwNetPktsTx=vmwNetPktsTx, vmwNumReads=vmwNumReads, vmwCpuUtil=vmwCpuUtil, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdHostName=vpxdHostName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetShares=vmwNetShares, vmwMemUtil=vmwMemUtil, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetEntry=vmwNetEntry, vmwCpuVMID=vmwCpuVMID, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdObjValue=vpxdObjValue, vmwKbWritten=vmwKbWritten, vmwObsoleteMIB=vmwObsoleteMIB, vmwKbRead=vmwKbRead, vmwNetName=vmwNetName, vpxdTrapType=vpxdTrapType, vmwCpuEntry=vmwCpuEntry, vmwHBATable=vmwHBATable, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemTable=vmwMemTable, vmwMemVMID=vmwMemVMID, vmwCpuShares=vmwCpuShares, vmkLoaded=vmkLoaded, vpxdOldStatus=vpxdOldStatus)
