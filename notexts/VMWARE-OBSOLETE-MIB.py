...
MibIdentifier, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Unsigned32, ModuleIdentity, Bits, Gauge32, Counter64, TimeTicks, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Bits", "Gauge32", "Counter64", "TimeTicks", "Integer32", "iso")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuVMID=vmwCpuVMID, vmwNumWrites=vmwNumWrites, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemUtil=vmwMemUtil, vmwHbaVMID=vmwHbaVMID, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetPktsRx=vmwNetPktsRx, vpxdTrapType=vpxdTrapType, vmwNetHCPktsRx=vmwNetHCPktsRx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemShares=vmwMemShares, vmwNetName=vmwNetName, vmwCpuUtil=vmwCpuUtil, vmwMemEntry=vmwMemEntry, vmwHbaName=vmwHbaName, vpxdVMName=vpxdVMName, vmwCpuTable=vmwCpuTable, vmPoweredOff=vmPoweredOff, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHbaIdx=vmwHbaIdx, vmwMemConfigured=vmwMemConfigured, vmwNetVMID=vmwNetVMID, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetKbTx=vmwNetKbTx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwDiskShares=vmwDiskShares, vmHBDetected=vmHBDetected, vmPoweredOn=vmPoweredOn, vmwMemVMID=vmwMemVMID, vmwNetEntry=vmwNetEntry, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetPktsTx=vmwNetPktsTx, vmwMemTable=vmwMemTable, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuEntry=vmwCpuEntry, vmwCpuShares=vmwCpuShares, vmwKbWritten=vmwKbWritten, vmwNumReads=vmwNumReads, vmkLoaded=vmkLoaded, vpxdHostName=vpxdHostName, vmwNetTable=vmwNetTable, vpxdOldStatus=vpxdOldStatus, vmSuspended=vmSuspended, vmwObsMIBGroups=vmwObsMIBGroups, vmwHBATable=vmwHBATable, vpxdObjValue=vpxdObjValue, vmwNetKbRx=vmwNetKbRx, vpxdTrap=vpxdTrap, vmHBLost=vmHBLost, vmwObsoleteMIB=vmwObsoleteMIB, vmwKbRead=vmwKbRead, vmwNetIdx=vmwNetIdx, vpxdNewStatus=vpxdNewStatus, vmwNetIfAddr=vmwNetIfAddr, vmwNetShares=vmwNetShares, vmwHBAEntry=vmwHBAEntry)
