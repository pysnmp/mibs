...
ModuleIdentity, Counter64, Integer32, iso, NotificationType, Gauge32, Unsigned32, Bits, ObjectIdentity, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Integer32", "iso", "NotificationType", "Gauge32", "Unsigned32", "Bits", "ObjectIdentity", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmSuspended=vmSuspended, vmPoweredOff=vmPoweredOff, vpxdOldStatus=vpxdOldStatus, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemVMID=vmwMemVMID, vmwNetKbRx=vmwNetKbRx, vmwHBAEntry=vmwHBAEntry, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdHostName=vpxdHostName, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmHBDetected=vmHBDetected, vmwMemShares=vmwMemShares, vmwNetIfAddr=vmwNetIfAddr, vmwMemUtil=vmwMemUtil, vmwHbaVMID=vmwHbaVMID, vmwCpuEntry=vmwCpuEntry, vmwDiskShares=vmwDiskShares, vmwKbRead=vmwKbRead, vmwHbaName=vmwHbaName, vpxdVMName=vpxdVMName, vmwCpuTable=vmwCpuTable, vmPoweredOn=vmPoweredOn, vmwNetKbTx=vmwNetKbTx, vmwHbaIdx=vmwHbaIdx, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemEntry=vmwMemEntry, vmwNetHCKbRx=vmwNetHCKbRx, vpxdObjValue=vpxdObjValue, vmwObsMIBGroups=vmwObsMIBGroups, vmwKbWritten=vmwKbWritten, vmwHBATable=vmwHBATable, vmkLoaded=vmkLoaded, vmwNetPktsRx=vmwNetPktsRx, vmwNetVMID=vmwNetVMID, vmwCpuVMID=vmwCpuVMID, vmwNetShares=vmwNetShares, vmwNumWrites=vmwNumWrites, vmwMemConfigured=vmwMemConfigured, vpxdNewStatus=vpxdNewStatus, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetEntry=vmwNetEntry, vmwNetIdx=vmwNetIdx, vmwNetPktsTx=vmwNetPktsTx, vmwMemTable=vmwMemTable, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNumReads=vmwNumReads, vmHBLost=vmHBLost, vmwCpuUtil=vmwCpuUtil, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdTrap=vpxdTrap, vmwNetTable=vmwNetTable, vpxdTrapType=vpxdTrapType, vmwNetName=vmwNetName, vmwCpuShares=vmwCpuShares, vmwObsoleteMIB=vmwObsoleteMIB)
