...
Unsigned32, Counter32, iso, ObjectIdentity, NotificationType, TimeTicks, Bits, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "iso", "ObjectIdentity", "NotificationType", "TimeTicks", "Bits", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "Counter64", "MibIdentifier")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwDiskShares=vmwDiskShares, vpxdObjValue=vpxdObjValue, vpxdVMName=vpxdVMName, vmkLoaded=vmkLoaded, vpxdNewStatus=vpxdNewStatus, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetIfAddr=vmwNetIfAddr, vmSuspended=vmSuspended, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemShares=vmwMemShares, vmwNetEntry=vmwNetEntry, vmwNetName=vmwNetName, vmwNetShares=vmwNetShares, vmwNetKbRx=vmwNetKbRx, vpxdHostName=vpxdHostName, vmwMemEntry=vmwMemEntry, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetIdx=vmwNetIdx, vmwObsoleteGroup=vmwObsoleteGroup, vmwKbRead=vmwKbRead, vmwHBATable=vmwHBATable, vmwHBAEntry=vmwHBAEntry, vmwNumWrites=vmwNumWrites, vmwHbaName=vmwHbaName, vpxdOldStatus=vpxdOldStatus, vmHBDetected=vmHBDetected, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwCpuShares=vmwCpuShares, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetTable=vmwNetTable, vpxdTrapType=vpxdTrapType, vmwMemVMID=vmwMemVMID, vmwMemConfigured=vmwMemConfigured, vmwKbWritten=vmwKbWritten, vmwNetPktsRx=vmwNetPktsRx, vmwMemTable=vmwMemTable, vmwMemUtil=vmwMemUtil, vmwNetVMID=vmwNetVMID, vpxdTrap=vpxdTrap, vmwCpuEntry=vmwCpuEntry, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetPktsTx=vmwNetPktsTx, vmwHbaVMID=vmwHbaVMID, vmPoweredOn=vmPoweredOn, vmwCpuUtil=vmwCpuUtil, vmHBLost=vmHBLost, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHbaIdx=vmwHbaIdx, vmPoweredOff=vmPoweredOff, vmwCpuTable=vmwCpuTable, vmwCpuVMID=vmwCpuVMID, vmwNetKbTx=vmwNetKbTx, vmwNumReads=vmwNumReads)
