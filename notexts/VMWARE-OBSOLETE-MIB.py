...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwDiskShares=vmwDiskShares, vmHBDetected=vmHBDetected, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmHBLost=vmHBLost, vmwNetName=vmwNetName, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetPktsRx=vmwNetPktsRx, vmwNetIdx=vmwNetIdx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuEntry=vmwCpuEntry, vmwNetShares=vmwNetShares, vmwNetKbRx=vmwNetKbRx, vpxdObjValue=vpxdObjValue, vmwMemTable=vmwMemTable, vpxdTrap=vpxdTrap, vpxdTrapType=vpxdTrapType, vmPoweredOff=vmPoweredOff, vmwCpuShares=vmwCpuShares, vmwMemVMID=vmwMemVMID, vpxdOldStatus=vpxdOldStatus, vmwCpuUtil=vmwCpuUtil, vmwNetPktsTx=vmwNetPktsTx, vmwKbRead=vmwKbRead, vmwNumReads=vmwNumReads, vmwHbaName=vmwHbaName, vmwNetKbTx=vmwNetKbTx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemUtil=vmwMemUtil, vmwHBATable=vmwHBATable, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemEntry=vmwMemEntry, vmwCpuTable=vmwCpuTable, vmwCpuVMID=vmwCpuVMID, vpxdVMName=vpxdVMName, vmkLoaded=vmkLoaded, vmwMemConfigured=vmwMemConfigured, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsMIBGroups=vmwObsMIBGroups, vpxdHostName=vpxdHostName, vmwNetVMID=vmwNetVMID, vmPoweredOn=vmPoweredOn, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdNewStatus=vpxdNewStatus, vmwNetIfAddr=vmwNetIfAddr, vmwHbaIdx=vmwHbaIdx, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetEntry=vmwNetEntry, vmwNetHCKbTx=vmwNetHCKbTx, vmwHBAEntry=vmwHBAEntry, vmwNetTable=vmwNetTable, vmSuspended=vmSuspended, vmwNumWrites=vmwNumWrites, vmwMemShares=vmwMemShares, vmwHbaVMID=vmwHbaVMID, vmwKbWritten=vmwKbWritten)
