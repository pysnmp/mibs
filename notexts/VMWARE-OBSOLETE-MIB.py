...
TimeTicks, ModuleIdentity, ObjectIdentity, MibIdentifier, iso, Counter32, Gauge32, Counter64, Bits, Unsigned32, NotificationType, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "iso", "Counter32", "Gauge32", "Counter64", "Bits", "Unsigned32", "NotificationType", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemVMID=vmwMemVMID, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuTable=vmwCpuTable, vmwNumWrites=vmwNumWrites, vmHBLost=vmHBLost, vmwNetShares=vmwNetShares, vpxdTrap=vpxdTrap, vmPoweredOn=vmPoweredOn, vpxdVMName=vpxdVMName, vmwNetVMID=vmwNetVMID, vmwHbaVMID=vmwHbaVMID, vmwMemUtil=vmwMemUtil, vmwObsoleteMIB=vmwObsoleteMIB, vmwDiskShares=vmwDiskShares, vmwNetPktsRx=vmwNetPktsRx, vmwKbWritten=vmwKbWritten, vpxdNewStatus=vpxdNewStatus, vmSuspended=vmSuspended, vmwNetTable=vmwNetTable, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetKbTx=vmwNetKbTx, vmwNetKbRx=vmwNetKbRx, vmwHbaName=vmwHbaName, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwHBATable=vmwHBATable, vmwMemEntry=vmwMemEntry, vpxdOldStatus=vpxdOldStatus, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHbaIdx=vmwHbaIdx, vpxdObjValue=vpxdObjValue, vmwNetPktsTx=vmwNetPktsTx, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuShares=vmwCpuShares, vmwHBAEntry=vmwHBAEntry, vmwMemConfigured=vmwMemConfigured, vmwNetEntry=vmwNetEntry, vmwMemShares=vmwMemShares, vmwMemTable=vmwMemTable, vpxdHostName=vpxdHostName, vmwCpuEntry=vmwCpuEntry, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmkLoaded=vmkLoaded, vmHBDetected=vmHBDetected, vmwNetIdx=vmwNetIdx, vmwNetIfAddr=vmwNetIfAddr, vmwKbRead=vmwKbRead, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuUtil=vmwCpuUtil, vmwNetName=vmwNetName, vmPoweredOff=vmPoweredOff, vmwNumReads=vmwNumReads, vpxdTrapType=vpxdTrapType, vmwCpuVMID=vmwCpuVMID)
