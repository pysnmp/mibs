...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemUtil=vmwMemUtil, vmPoweredOff=vmPoweredOff, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuUtil=vmwCpuUtil, vmkLoaded=vmkLoaded, vmwDiskShares=vmwDiskShares, vmwNetEntry=vmwNetEntry, vmwNetShares=vmwNetShares, vpxdObjValue=vpxdObjValue, vpxdNewStatus=vpxdNewStatus, vpxdTrapType=vpxdTrapType, vmwNetKbTx=vmwNetKbTx, vmwCpuVMID=vmwCpuVMID, vmwMemVMID=vmwMemVMID, vmwMemTable=vmwMemTable, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdOldStatus=vpxdOldStatus, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsMIBGroups=vmwObsMIBGroups, vmHBDetected=vmHBDetected, vmwNetName=vmwNetName, vmwNetPktsRx=vmwNetPktsRx, vmwCpuTable=vmwCpuTable, vmSuspended=vmSuspended, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHBATable=vmwHBATable, vmwHbaIdx=vmwHbaIdx, vmwNetIdx=vmwNetIdx, vmwNetVMID=vmwNetVMID, vmwObsoleteGroup=vmwObsoleteGroup, vpxdHostName=vpxdHostName, vmwMemConfigured=vmwMemConfigured, vmwMemShares=vmwMemShares, vmHBLost=vmHBLost, vpxdTrap=vpxdTrap, vmwNetHCKbRx=vmwNetHCKbRx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHbaName=vmwHbaName, vpxdVMName=vpxdVMName, vmwCpuShares=vmwCpuShares, vmwHBAEntry=vmwHBAEntry, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetIfAddr=vmwNetIfAddr, vmwNetPktsTx=vmwNetPktsTx, vmwNumWrites=vmwNumWrites, vmwMemEntry=vmwMemEntry, vmwNetTable=vmwNetTable, vmwNetKbRx=vmwNetKbRx, vmwCpuEntry=vmwCpuEntry, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwKbRead=vmwKbRead, vmwKbWritten=vmwKbWritten, vmPoweredOn=vmPoweredOn, vmwHbaVMID=vmwHbaVMID, vmwNumReads=vmwNumReads)
