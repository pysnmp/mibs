...
Counter32, MibIdentifier, Unsigned32, Counter64, Bits, NotificationType, IpAddress, TimeTicks, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "Unsigned32", "Counter64", "Bits", "NotificationType", "IpAddress", "TimeTicks", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetName=vmwNetName, vmkLoaded=vmkLoaded, vpxdTrapType=vpxdTrapType, vmwDiskShares=vmwDiskShares, vmwNetIfAddr=vmwNetIfAddr, vmwHbaIdx=vmwHbaIdx, vmwMemEntry=vmwMemEntry, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNumWrites=vmwNumWrites, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetKbTx=vmwNetKbTx, vmwCpuTable=vmwCpuTable, vmwCpuUtil=vmwCpuUtil, vpxdTrap=vpxdTrap, vmwCpuEntry=vmwCpuEntry, vmwHbaName=vmwHbaName, vmPoweredOff=vmPoweredOff, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdOldStatus=vpxdOldStatus, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemUtil=vmwMemUtil, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetVMID=vmwNetVMID, vmwNetIdx=vmwNetIdx, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemShares=vmwMemShares, vpxdObjValue=vpxdObjValue, vpxdVMName=vpxdVMName, vmHBLost=vmHBLost, vmwNetHCPktsTx=vmwNetHCPktsTx, vmHBDetected=vmHBDetected, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetKbRx=vmwNetKbRx, vmwNetPktsTx=vmwNetPktsTx, vmwNetShares=vmwNetShares, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemConfigured=vmwMemConfigured, vmwCpuVMID=vmwCpuVMID, vmwHbaVMID=vmwHbaVMID, vpxdNewStatus=vpxdNewStatus, vmwNetTable=vmwNetTable, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuShares=vmwCpuShares, vmwNetHCPktsRx=vmwNetHCPktsRx, vmSuspended=vmSuspended, vmwNumReads=vmwNumReads, vmwKbRead=vmwKbRead, vmwHBAEntry=vmwHBAEntry, vmwKbWritten=vmwKbWritten, vmwMemTable=vmwMemTable, vmwHBATable=vmwHBATable, vmwMemVMID=vmwMemVMID, vmwNetEntry=vmwNetEntry, vmwNetPktsRx=vmwNetPktsRx, vmPoweredOn=vmPoweredOn, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdHostName=vpxdHostName)
