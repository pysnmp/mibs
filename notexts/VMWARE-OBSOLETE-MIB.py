...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetHCKbRx=vmwNetHCKbRx, vpxdHostName=vpxdHostName, vmwCpuEntry=vmwCpuEntry, vmwNetName=vmwNetName, vmwNetKbRx=vmwNetKbRx, vmwNetIfAddr=vmwNetIfAddr, vmwObsoleteGroup=vmwObsoleteGroup, vmwNumWrites=vmwNumWrites, vmPoweredOff=vmPoweredOff, vmwMemEntry=vmwMemEntry, vpxdObjValue=vpxdObjValue, vmHBLost=vmHBLost, vmwNetVMID=vmwNetVMID, vpxdTrapType=vpxdTrapType, vmPoweredOn=vmPoweredOn, vmHBDetected=vmHBDetected, vmwMemUtil=vmwMemUtil, vmwCpuVMID=vmwCpuVMID, vmwMemTable=vmwMemTable, vmwKbRead=vmwKbRead, vmwHbaIdx=vmwHbaIdx, vpxdOldStatus=vpxdOldStatus, vmwMemConfigured=vmwMemConfigured, vmwNetPktsTx=vmwNetPktsTx, vmwMemShares=vmwMemShares, vmwNetIdx=vmwNetIdx, vmwNetEntry=vmwNetEntry, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwDiskShares=vmwDiskShares, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuUtil=vmwCpuUtil, vmwHBATable=vmwHBATable, vmwCpuTable=vmwCpuTable, vmwNetKbTx=vmwNetKbTx, vmwKbWritten=vmwKbWritten, vmwNetTable=vmwNetTable, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuShares=vmwCpuShares, vmwHBAEntry=vmwHBAEntry, vmwHbaVMID=vmwHbaVMID, vmwNetHCKbTx=vmwNetHCKbTx, vpxdVMName=vpxdVMName, vmwNetShares=vmwNetShares, vmwMemVMID=vmwMemVMID, vpxdNewStatus=vpxdNewStatus, vmwNumReads=vmwNumReads, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmkLoaded=vmkLoaded, vmwObsMIBGroups=vmwObsMIBGroups, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHbaName=vmwHbaName, vmwNetPktsRx=vmwNetPktsRx, vpxdTrap=vpxdTrap, vmSuspended=vmSuspended, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, PYSNMP_MODULE_ID=vmwObsoleteMIB)
