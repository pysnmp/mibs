...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuUtil=vmwCpuUtil, vpxdOldStatus=vpxdOldStatus, vmwNumWrites=vmwNumWrites, vmHBDetected=vmHBDetected, vmwCpuVMID=vmwCpuVMID, vmwMemUtil=vmwMemUtil, vmwNetTable=vmwNetTable, vmwNetEntry=vmwNetEntry, vmwNetHCKbTx=vmwNetHCKbTx, vmwKbWritten=vmwKbWritten, vpxdNewStatus=vpxdNewStatus, vmSuspended=vmSuspended, vmwHBATable=vmwHBATable, vpxdVMName=vpxdVMName, vmwHBAEntry=vmwHBAEntry, vmwNetIfAddr=vmwNetIfAddr, vmwCpuTable=vmwCpuTable, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetVMID=vmwNetVMID, vmwNetHCKbRx=vmwNetHCKbRx, vpxdTrapType=vpxdTrapType, vpxdTrap=vpxdTrap, vmwObsoleteGroup=vmwObsoleteGroup, vmHBLost=vmHBLost, vmwNetIdx=vmwNetIdx, vmwNetName=vmwNetName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdHostName=vpxdHostName, vpxdObjValue=vpxdObjValue, vmwCpuEntry=vmwCpuEntry, vmPoweredOn=vmPoweredOn, vmwHbaName=vmwHbaName, vmwNetPktsTx=vmwNetPktsTx, vmwHbaVMID=vmwHbaVMID, vmwHbaIdx=vmwHbaIdx, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwCpuShares=vmwCpuShares, vmwNetKbRx=vmwNetKbRx, vmwNetShares=vmwNetShares, vmwMemEntry=vmwMemEntry, vmkLoaded=vmkLoaded, vmwMemVMID=vmwMemVMID, vmwKbRead=vmwKbRead, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmPoweredOff=vmPoweredOff, vmwDiskShares=vmwDiskShares, vmwNetKbTx=vmwNetKbTx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNumReads=vmwNumReads, vmwMemTable=vmwMemTable, vmwMemConfigured=vmwMemConfigured, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetPktsRx=vmwNetPktsRx, vmwMemShares=vmwMemShares)
