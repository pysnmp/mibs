...
NotificationType, TimeTicks, Counter32, ModuleIdentity, Integer32, iso, MibIdentifier, IpAddress, Counter64, Unsigned32, Gauge32, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "Counter32", "ModuleIdentity", "Integer32", "iso", "MibIdentifier", "IpAddress", "Counter64", "Unsigned32", "Gauge32", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwDiskShares=vmwDiskShares, vmwNetTable=vmwNetTable, vmwMemEntry=vmwMemEntry, vmwNumWrites=vmwNumWrites, vmwNetShares=vmwNetShares, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHBAEntry=vmwHBAEntry, vmwCpuTable=vmwCpuTable, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetEntry=vmwNetEntry, vmwCpuEntry=vmwCpuEntry, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemUtil=vmwMemUtil, vmwNetPktsTx=vmwNetPktsTx, vmwHbaIdx=vmwHbaIdx, vmwHbaVMID=vmwHbaVMID, vmwMemConfigured=vmwMemConfigured, vmwMemVMID=vmwMemVMID, vmwKbWritten=vmwKbWritten, vmSuspended=vmSuspended, vmwObsMIBGroups=vmwObsMIBGroups, vpxdTrap=vpxdTrap, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwKbRead=vmwKbRead, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuShares=vmwCpuShares, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdOldStatus=vpxdOldStatus, vmwCpuVMID=vmwCpuVMID, vmwNetKbTx=vmwNetKbTx, vpxdNewStatus=vpxdNewStatus, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmPoweredOn=vmPoweredOn, vmwNetIdx=vmwNetIdx, vmPoweredOff=vmPoweredOff, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdVMName=vpxdVMName, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetPktsRx=vmwNetPktsRx, vmwNetVMID=vmwNetVMID, vmkLoaded=vmkLoaded, vpxdHostName=vpxdHostName, vmwNetIfAddr=vmwNetIfAddr, vmwHBATable=vmwHBATable, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwCpuUtil=vmwCpuUtil, vmwMemShares=vmwMemShares, vmwHbaName=vmwHbaName, vmwNumReads=vmwNumReads, vmwMemTable=vmwMemTable, vpxdTrapType=vpxdTrapType, vmHBLost=vmHBLost, vmwNetName=vmwNetName, vpxdObjValue=vpxdObjValue, vmHBDetected=vmHBDetected, vmwNetKbRx=vmwNetKbRx)
