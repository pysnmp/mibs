...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetEntry=vmwNetEntry, vmwNetHCKbRx=vmwNetHCKbRx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuShares=vmwCpuShares, vmPoweredOff=vmPoweredOff, vmHBLost=vmHBLost, vmwNetName=vmwNetName, vpxdVMName=vpxdVMName, vmkLoaded=vmkLoaded, vmwNetPktsTx=vmwNetPktsTx, vmwMemTable=vmwMemTable, vmwMemVMID=vmwMemVMID, vmwHbaVMID=vmwHbaVMID, vmwNetShares=vmwNetShares, vmwNetKbTx=vmwNetKbTx, vpxdTrapType=vpxdTrapType, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwCpuEntry=vmwCpuEntry, vpxdNewStatus=vpxdNewStatus, vpxdTrap=vpxdTrap, vmwDiskShares=vmwDiskShares, vmwNetIfAddr=vmwNetIfAddr, vmHBDetected=vmHBDetected, vmwNumReads=vmwNumReads, vmwHBAEntry=vmwHBAEntry, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetVMID=vmwNetVMID, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNumWrites=vmwNumWrites, vmPoweredOn=vmPoweredOn, vmwNetIdx=vmwNetIdx, vmwNetPktsRx=vmwNetPktsRx, vpxdObjValue=vpxdObjValue, vmwHBATable=vmwHBATable, vmwCpuUtil=vmwCpuUtil, vmwKbRead=vmwKbRead, vmSuspended=vmSuspended, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdOldStatus=vpxdOldStatus, vmwMemUtil=vmwMemUtil, vmwNetKbRx=vmwNetKbRx, vmwHbaName=vmwHbaName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetTable=vmwNetTable, vmwCpuVMID=vmwCpuVMID, vmwNetHCKbTx=vmwNetHCKbTx, vpxdHostName=vpxdHostName, vmwKbWritten=vmwKbWritten, vmwMemShares=vmwMemShares, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsMIBGroups=vmwObsMIBGroups, vmwHbaIdx=vmwHbaIdx, vmwMemConfigured=vmwMemConfigured, vmwCpuTable=vmwCpuTable, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemEntry=vmwMemEntry, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances)
