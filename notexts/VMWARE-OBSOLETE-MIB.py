...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, Integer32, Counter64, ModuleIdentity, Gauge32, TimeTicks, Bits, Counter32, iso, ObjectIdentity, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "Integer32", "Counter64", "ModuleIdentity", "Gauge32", "TimeTicks", "Bits", "Counter32", "iso", "ObjectIdentity", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuEntry=vmwCpuEntry, vmwMemUtil=vmwMemUtil, vmwKbRead=vmwKbRead, vmwMemConfigured=vmwMemConfigured, vmwNumReads=vmwNumReads, vmkLoaded=vmkLoaded, vmwCpuUtil=vmwCpuUtil, vmwCpuShares=vmwCpuShares, vpxdTrapType=vpxdTrapType, vmwNetPktsTx=vmwNetPktsTx, vmPoweredOn=vmPoweredOn, vmwNetIdx=vmwNetIdx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetIfAddr=vmwNetIfAddr, vmSuspended=vmSuspended, vmHBDetected=vmHBDetected, vmwHBATable=vmwHBATable, vmwNetName=vmwNetName, vmwMemEntry=vmwMemEntry, vmwNetKbTx=vmwNetKbTx, vmwNetHCKbTx=vmwNetHCKbTx, vmHBLost=vmHBLost, vpxdHostName=vpxdHostName, vpxdOldStatus=vpxdOldStatus, vmwNetPktsRx=vmwNetPktsRx, vmwKbWritten=vmwKbWritten, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHbaIdx=vmwHbaIdx, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemShares=vmwMemShares, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuVMID=vmwCpuVMID, vmwMemTable=vmwMemTable, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetVMID=vmwNetVMID, vmwNumWrites=vmwNumWrites, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetEntry=vmwNetEntry, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmPoweredOff=vmPoweredOff, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemVMID=vmwMemVMID, vmwHbaVMID=vmwHbaVMID, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuTable=vmwCpuTable, vmwNetTable=vmwNetTable, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHbaName=vmwHbaName, vpxdNewStatus=vpxdNewStatus, vmwHBAEntry=vmwHBAEntry, vpxdObjValue=vpxdObjValue, vpxdVMName=vpxdVMName, vmwNetShares=vmwNetShares, vmwDiskShares=vmwDiskShares, vmwNetKbRx=vmwNetKbRx, vpxdTrap=vpxdTrap)
