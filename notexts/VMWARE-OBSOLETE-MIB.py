...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetShares=vmwNetShares, vmwDiskShares=vmwDiskShares, vmwMemConfigured=vmwMemConfigured, vmwNetName=vmwNetName, vmwNetPktsTx=vmwNetPktsTx, vmwMemUtil=vmwMemUtil, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmSuspended=vmSuspended, vmwMemTable=vmwMemTable, vmwKbRead=vmwKbRead, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsMIBGroups=vmwObsMIBGroups, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdHostName=vpxdHostName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuVMID=vmwCpuVMID, vmwNumReads=vmwNumReads, vmwHBATable=vmwHBATable, vmPoweredOff=vmPoweredOff, vpxdObjValue=vpxdObjValue, vmwNetKbRx=vmwNetKbRx, vpxdNewStatus=vpxdNewStatus, vmwNetVMID=vmwNetVMID, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetIdx=vmwNetIdx, vmwNetEntry=vmwNetEntry, vmwMemEntry=vmwMemEntry, vmwHbaVMID=vmwHbaVMID, vmwCpuUtil=vmwCpuUtil, vmHBDetected=vmHBDetected, vpxdTrapType=vpxdTrapType, vmwCpuTable=vmwCpuTable, vmwHbaName=vmwHbaName, vmwNetKbTx=vmwNetKbTx, vpxdOldStatus=vpxdOldStatus, vmwHbaIdx=vmwHbaIdx, vmHBLost=vmHBLost, vmwMemVMID=vmwMemVMID, vmwNetTable=vmwNetTable, vmwMemShares=vmwMemShares, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwCpuEntry=vmwCpuEntry, vmwHBAEntry=vmwHBAEntry, vmwKbWritten=vmwKbWritten, vmwNetIfAddr=vmwNetIfAddr, vmwNumWrites=vmwNumWrites, vmkLoaded=vmkLoaded, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdTrap=vpxdTrap, vpxdVMName=vpxdVMName, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmPoweredOn=vmPoweredOn, vmwCpuShares=vmwCpuShares)
