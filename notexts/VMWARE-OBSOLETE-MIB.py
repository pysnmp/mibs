...
Counter64, NotificationType, Gauge32, ModuleIdentity, IpAddress, ObjectIdentity, Bits, iso, MibIdentifier, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "Gauge32", "ModuleIdentity", "IpAddress", "ObjectIdentity", "Bits", "iso", "MibIdentifier", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwHBATable=vmwHBATable, vmwNetHCKbRx=vmwNetHCKbRx, vmHBLost=vmHBLost, vmwMemUtil=vmwMemUtil, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemConfigured=vmwMemConfigured, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuUtil=vmwCpuUtil, vpxdTrap=vpxdTrap, vpxdOldStatus=vpxdOldStatus, vmwCpuEntry=vmwCpuEntry, vmwNetName=vmwNetName, vmwNetVMID=vmwNetVMID, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemVMID=vmwMemVMID, vmwNetKbTx=vmwNetKbTx, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmkLoaded=vmkLoaded, vmwKbWritten=vmwKbWritten, vmwMemEntry=vmwMemEntry, vpxdTrapType=vpxdTrapType, vmwNumReads=vmwNumReads, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuVMID=vmwCpuVMID, vmwHbaName=vmwHbaName, vmwNetPktsTx=vmwNetPktsTx, vmwHBAEntry=vmwHBAEntry, vmPoweredOff=vmPoweredOff, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemShares=vmwMemShares, vmwNumWrites=vmwNumWrites, vpxdObjValue=vpxdObjValue, vpxdNewStatus=vpxdNewStatus, vmwCpuTable=vmwCpuTable, vmwCpuShares=vmwCpuShares, vmwNetEntry=vmwNetEntry, vmwMemTable=vmwMemTable, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmHBDetected=vmHBDetected, vmwNetIdx=vmwNetIdx, vpxdHostName=vpxdHostName, vmwKbRead=vmwKbRead, vmwHbaIdx=vmwHbaIdx, vmwNetKbRx=vmwNetKbRx, vmSuspended=vmSuspended, vmwHbaVMID=vmwHbaVMID, vmwObsMIBGroups=vmwObsMIBGroups, vmwDiskShares=vmwDiskShares, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetShares=vmwNetShares, vmwNetPktsRx=vmwNetPktsRx, vmwNetTable=vmwNetTable, vpxdVMName=vpxdVMName, vmPoweredOn=vmPoweredOn)
