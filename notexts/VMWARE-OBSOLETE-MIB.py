...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, NotificationType, Gauge32, ModuleIdentity, Counter64, TimeTicks, Unsigned32, ObjectIdentity, iso, Counter32, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "NotificationType", "Gauge32", "ModuleIdentity", "Counter64", "TimeTicks", "Unsigned32", "ObjectIdentity", "iso", "Counter32", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetVMID=vmwNetVMID, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuUtil=vmwCpuUtil, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetHCKbRx=vmwNetHCKbRx, vmwHbaName=vmwHbaName, vmwHBAEntry=vmwHBAEntry, vmwCpuVMID=vmwCpuVMID, vmwHbaVMID=vmwHbaVMID, vmPoweredOn=vmPoweredOn, vmwKbWritten=vmwKbWritten, vmwNetKbTx=vmwNetKbTx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdObjValue=vpxdObjValue, vmwNumWrites=vmwNumWrites, vmwHbaIdx=vmwHbaIdx, vpxdVMName=vpxdVMName, vmHBDetected=vmHBDetected, vmwMemShares=vmwMemShares, vmkLoaded=vmkLoaded, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemConfigured=vmwMemConfigured, vmwMemUtil=vmwMemUtil, vmwNumReads=vmwNumReads, vpxdNewStatus=vpxdNewStatus, vmwNetTable=vmwNetTable, vpxdTrap=vpxdTrap, vmHBLost=vmHBLost, vmPoweredOff=vmPoweredOff, vmwMemTable=vmwMemTable, vmSuspended=vmSuspended, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdHostName=vpxdHostName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteGroup=vmwObsoleteGroup, vmwKbRead=vmwKbRead, vpxdOldStatus=vpxdOldStatus, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetIfAddr=vmwNetIfAddr, vmwNetEntry=vmwNetEntry, vpxdTrapType=vpxdTrapType, vmwCpuTable=vmwCpuTable, vmwNetKbRx=vmwNetKbRx, vmwCpuShares=vmwCpuShares, vmwCpuEntry=vmwCpuEntry, vmwMemVMID=vmwMemVMID, vmwHBATable=vmwHBATable, vmwDiskShares=vmwDiskShares, vmwNetIdx=vmwNetIdx, vmwNetName=vmwNetName, vmwNetShares=vmwNetShares, vmwMemEntry=vmwMemEntry, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteMIB=vmwObsoleteMIB)
