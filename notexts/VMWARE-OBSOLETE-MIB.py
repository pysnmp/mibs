...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemShares=vmwMemShares, vmSuspended=vmSuspended, vpxdObjValue=vpxdObjValue, vmwMemVMID=vmwMemVMID, vmwDiskShares=vmwDiskShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetVMID=vmwNetVMID, vmwMemTable=vmwMemTable, vmwNetShares=vmwNetShares, vmwMemConfigured=vmwMemConfigured, vpxdVMName=vpxdVMName, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetTable=vmwNetTable, vmwNetName=vmwNetName, vmwNetPktsTx=vmwNetPktsTx, vmwHbaName=vmwHbaName, vmPoweredOn=vmPoweredOn, vmHBDetected=vmHBDetected, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetIdx=vmwNetIdx, vmwObsoleteGroup=vmwObsoleteGroup, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdTrap=vpxdTrap, vmwCpuTable=vmwCpuTable, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetEntry=vmwNetEntry, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuEntry=vmwCpuEntry, vmwMemEntry=vmwMemEntry, vpxdHostName=vpxdHostName, vmHBLost=vmHBLost, vmwCpuShares=vmwCpuShares, vmwCpuUtil=vmwCpuUtil, vmwNetKbTx=vmwNetKbTx, vmwNumReads=vmwNumReads, vpxdOldStatus=vpxdOldStatus, vmwHbaIdx=vmwHbaIdx, vmwKbWritten=vmwKbWritten, vmwHBATable=vmwHBATable, vmwNetKbRx=vmwNetKbRx, vmwKbRead=vmwKbRead, vmwHbaVMID=vmwHbaVMID, vmPoweredOff=vmPoweredOff, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNumWrites=vmwNumWrites, vmwCpuVMID=vmwCpuVMID, vmwNetHCKbTx=vmwNetHCKbTx, vpxdNewStatus=vpxdNewStatus, vmkLoaded=vmkLoaded, vmwHBAEntry=vmwHBAEntry, vpxdTrapType=vpxdTrapType, vmwNetIfAddr=vmwNetIfAddr, vmwMemUtil=vmwMemUtil, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance)
