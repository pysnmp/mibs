...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, ModuleIdentity, Counter32, MibIdentifier, IpAddress, TimeTicks, Unsigned32, Gauge32, Counter64, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "ModuleIdentity", "Counter32", "MibIdentifier", "IpAddress", "TimeTicks", "Unsigned32", "Gauge32", "Counter64", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmHBLost=vmHBLost, vmPoweredOn=vmPoweredOn, vmwNetShares=vmwNetShares, vpxdVMName=vpxdVMName, vmwMemUtil=vmwMemUtil, vmwNetTable=vmwNetTable, vpxdTrapType=vpxdTrapType, vmwNetKbTx=vmwNetKbTx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuEntry=vmwCpuEntry, vmSuspended=vmSuspended, vmwNetIdx=vmwNetIdx, vmwHBAEntry=vmwHBAEntry, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetPktsRx=vmwNetPktsRx, vmwCpuShares=vmwCpuShares, vmwHbaName=vmwHbaName, vpxdOldStatus=vpxdOldStatus, vmwNetVMID=vmwNetVMID, vmPoweredOff=vmPoweredOff, vmwNetPktsTx=vmwNetPktsTx, vmwNumReads=vmwNumReads, vmwMemVMID=vmwMemVMID, vmwNumWrites=vmwNumWrites, vmkLoaded=vmkLoaded, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuTable=vmwCpuTable, vmwHbaVMID=vmwHbaVMID, vmwHbaIdx=vmwHbaIdx, vmwObsoleteGroup=vmwObsoleteGroup, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmHBDetected=vmHBDetected, vpxdObjValue=vpxdObjValue, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwKbRead=vmwKbRead, vmwKbWritten=vmwKbWritten, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetHCKbTx=vmwNetHCKbTx, vmwDiskShares=vmwDiskShares, vmwCpuVMID=vmwCpuVMID, vmwNetName=vmwNetName, vmwNetKbRx=vmwNetKbRx, vmwMemTable=vmwMemTable, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdNewStatus=vpxdNewStatus, vmwObsMIBGroups=vmwObsMIBGroups, vpxdTrap=vpxdTrap, vmwHBATable=vmwHBATable, vmwMemShares=vmwMemShares, vpxdHostName=vpxdHostName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuUtil=vmwCpuUtil, vmwMemConfigured=vmwMemConfigured, vmwMemEntry=vmwMemEntry, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetEntry=vmwNetEntry, vmwNetIfAddr=vmwNetIfAddr)
