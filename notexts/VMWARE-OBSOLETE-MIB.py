...
MibIdentifier, Bits, IpAddress, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, ObjectIdentity, Integer32, iso, Counter64, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "IpAddress", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "Integer32", "iso", "Counter64", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuUtil=vmwCpuUtil, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdNewStatus=vpxdNewStatus, vpxdHostName=vpxdHostName, vmPoweredOff=vmPoweredOff, vmwMemEntry=vmwMemEntry, vmwHbaVMID=vmwHbaVMID, vmwNetEntry=vmwNetEntry, vmwCpuShares=vmwCpuShares, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetName=vmwNetName, vmPoweredOn=vmPoweredOn, vmwNetIfAddr=vmwNetIfAddr, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemConfigured=vmwMemConfigured, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemTable=vmwMemTable, vpxdTrapType=vpxdTrapType, vmwHbaIdx=vmwHbaIdx, vmwHBATable=vmwHBATable, vpxdTrap=vpxdTrap, vmwKbRead=vmwKbRead, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHbaName=vmwHbaName, vmwNetIdx=vmwNetIdx, vmwKbWritten=vmwKbWritten, vmwHBAEntry=vmwHBAEntry, vmwCpuTable=vmwCpuTable, vmwCpuEntry=vmwCpuEntry, vmwNumWrites=vmwNumWrites, vmwNetShares=vmwNetShares, vmkLoaded=vmkLoaded, vmwMemUtil=vmwMemUtil, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemShares=vmwMemShares, vpxdObjValue=vpxdObjValue, vmHBDetected=vmHBDetected, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemVMID=vmwMemVMID, vmwNetKbTx=vmwNetKbTx, vmwDiskShares=vmwDiskShares, vmSuspended=vmSuspended, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetPktsTx=vmwNetPktsTx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetKbRx=vmwNetKbRx, vpxdOldStatus=vpxdOldStatus, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuVMID=vmwCpuVMID, vpxdVMName=vpxdVMName, vmHBLost=vmHBLost, vmwNumReads=vmwNumReads, vmwNetTable=vmwNetTable, vmwNetVMID=vmwNetVMID)
