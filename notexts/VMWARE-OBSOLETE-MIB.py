...
ObjectIdentity, Gauge32, Counter32, Counter64, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, Bits, ModuleIdentity, Unsigned32, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "Counter32", "Counter64", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "Bits", "ModuleIdentity", "Unsigned32", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmSuspended=vmSuspended, vmwMemTable=vmwMemTable, vmwHBAEntry=vmwHBAEntry, vmwMemShares=vmwMemShares, vmwNumReads=vmwNumReads, vmwNetTable=vmwNetTable, vmPoweredOn=vmPoweredOn, vpxdHostName=vpxdHostName, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsMIBGroups=vmwObsMIBGroups, vmwHbaName=vmwHbaName, vmwHbaIdx=vmwHbaIdx, vpxdVMName=vpxdVMName, vmwKbRead=vmwKbRead, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdObjValue=vpxdObjValue, vmwNetName=vmwNetName, vmwObsoleteGroup=vmwObsoleteGroup, vmPoweredOff=vmPoweredOff, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemVMID=vmwMemVMID, vmkLoaded=vmkLoaded, vpxdTrap=vpxdTrap, vmwCpuTable=vmwCpuTable, vmwCpuShares=vmwCpuShares, vmwMemConfigured=vmwMemConfigured, vmwCpuUtil=vmwCpuUtil, vmwNetKbRx=vmwNetKbRx, vmwNetIdx=vmwNetIdx, vpxdOldStatus=vpxdOldStatus, vpxdNewStatus=vpxdNewStatus, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwDiskShares=vmwDiskShares, vmwKbWritten=vmwKbWritten, vmwNetEntry=vmwNetEntry, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetIfAddr=vmwNetIfAddr, vmwCpuVMID=vmwCpuVMID, vpxdTrapType=vpxdTrapType, vmHBDetected=vmHBDetected, vmwNetPktsTx=vmwNetPktsTx, vmwCpuEntry=vmwCpuEntry, vmwNetKbTx=vmwNetKbTx, vmwNetVMID=vmwNetVMID, vmwNetShares=vmwNetShares, vmwMemEntry=vmwMemEntry, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwHBATable=vmwHBATable, vmwHbaVMID=vmwHbaVMID, vmHBLost=vmHBLost, vmwNumWrites=vmwNumWrites, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemUtil=vmwMemUtil)
