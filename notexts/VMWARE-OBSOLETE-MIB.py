...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmPoweredOn=vmPoweredOn, vmwKbRead=vmwKbRead, vmwNetKbRx=vmwNetKbRx, vpxdVMName=vpxdVMName, vmkLoaded=vmkLoaded, vmwHBAEntry=vmwHBAEntry, vpxdNewStatus=vpxdNewStatus, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vpxdObjValue=vpxdObjValue, vmwMemVMID=vmwMemVMID, vmwNetTable=vmwNetTable, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetVMID=vmwNetVMID, vmHBLost=vmHBLost, vmHBDetected=vmHBDetected, vmwHbaIdx=vmwHbaIdx, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuVMID=vmwCpuVMID, vmwMemConfigured=vmwMemConfigured, vmSuspended=vmSuspended, vmwCpuTable=vmwCpuTable, vmPoweredOff=vmPoweredOff, vmwHBATable=vmwHBATable, vmwObsMIBGroups=vmwObsMIBGroups, vmwNumReads=vmwNumReads, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetHCKbTx=vmwNetHCKbTx, vpxdHostName=vpxdHostName, vmwObsoleteMIB=vmwObsoleteMIB, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetName=vmwNetName, vmwCpuUtil=vmwCpuUtil, vmwCpuEntry=vmwCpuEntry, vmwNetShares=vmwNetShares, vmwHbaVMID=vmwHbaVMID, vmwNetHCKbRx=vmwNetHCKbRx, vmwDiskShares=vmwDiskShares, vmwMemUtil=vmwMemUtil, vmwMemEntry=vmwMemEntry, vmwNetIdx=vmwNetIdx, vmwNetKbTx=vmwNetKbTx, vmwNetEntry=vmwNetEntry, vmwNetIfAddr=vmwNetIfAddr, vmwCpuShares=vmwCpuShares, vmwHbaName=vmwHbaName, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdTrap=vpxdTrap, vmwMemTable=vmwMemTable, vmwMemShares=vmwMemShares, vmwNetPktsRx=vmwNetPktsRx, vmwNumWrites=vmwNumWrites, vpxdTrapType=vpxdTrapType, vpxdOldStatus=vpxdOldStatus, vmwKbWritten=vmwKbWritten)
