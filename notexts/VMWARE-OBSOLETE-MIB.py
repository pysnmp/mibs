...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, TimeTicks, Counter32, IpAddress, MibIdentifier, Counter64, NotificationType, ObjectIdentity, Integer32, iso, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "TimeTicks", "Counter32", "IpAddress", "MibIdentifier", "Counter64", "NotificationType", "ObjectIdentity", "Integer32", "iso", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuVMID=vmwCpuVMID, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemTable=vmwMemTable, vmwHbaVMID=vmwHbaVMID, vmwCpuEntry=vmwCpuEntry, vmwNetKbTx=vmwNetKbTx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdVMName=vpxdVMName, vmwMemShares=vmwMemShares, vmSuspended=vmSuspended, vmwObsoleteGroup=vmwObsoleteGroup, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetPktsRx=vmwNetPktsRx, vpxdHostName=vpxdHostName, vmkLoaded=vmkLoaded, vmwCpuShares=vmwCpuShares, vmwNumReads=vmwNumReads, vmwNumWrites=vmwNumWrites, vpxdTrap=vpxdTrap, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdNewStatus=vpxdNewStatus, vmHBDetected=vmHBDetected, vmwNetName=vmwNetName, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdTrapType=vpxdTrapType, vmwKbWritten=vmwKbWritten, vmwNetHCKbTx=vmwNetHCKbTx, vpxdObjValue=vpxdObjValue, vmwNetIdx=vmwNetIdx, vmwHBAEntry=vmwHBAEntry, vmwHBATable=vmwHBATable, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemEntry=vmwMemEntry, vmwNetTable=vmwNetTable, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHbaIdx=vmwHbaIdx, vmwCpuUtil=vmwCpuUtil, vmPoweredOn=vmPoweredOn, vmwKbRead=vmwKbRead, vmPoweredOff=vmPoweredOff, vmwNetIfAddr=vmwNetIfAddr, vmwMemUtil=vmwMemUtil, vmwHbaName=vmwHbaName, vmwCpuTable=vmwCpuTable, vmwNetEntry=vmwNetEntry, vmwMemConfigured=vmwMemConfigured, vmwNetKbRx=vmwNetKbRx, vmwNetShares=vmwNetShares, vpxdOldStatus=vpxdOldStatus, vmHBLost=vmHBLost, vmwDiskShares=vmwDiskShares, vmwNetPktsTx=vmwNetPktsTx, vmwNetVMID=vmwNetVMID, vmwMemVMID=vmwMemVMID, vmwObsoleteMIB=vmwObsoleteMIB)
