...
Unsigned32, Gauge32, Counter64, Integer32, IpAddress, MibIdentifier, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, ObjectIdentity, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Gauge32", "Counter64", "Integer32", "IpAddress", "MibIdentifier", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "ObjectIdentity", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemShares=vmwMemShares, vmwNetShares=vmwNetShares, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwKbRead=vmwKbRead, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetVMID=vmwNetVMID, vmwMemUtil=vmwMemUtil, vmkLoaded=vmkLoaded, vmwNetTable=vmwNetTable, vmwHBATable=vmwHBATable, vmwNetKbRx=vmwNetKbRx, vmwMemVMID=vmwMemVMID, vmwNetHCKbTx=vmwNetHCKbTx, vpxdTrapType=vpxdTrapType, vmwCpuTable=vmwCpuTable, vmwNetName=vmwNetName, vmwObsoleteMIB=vmwObsoleteMIB, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwKbWritten=vmwKbWritten, vmwDiskShares=vmwDiskShares, vpxdVMName=vpxdVMName, vmPoweredOff=vmPoweredOff, vpxdTrap=vpxdTrap, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmPoweredOn=vmPoweredOn, vmwHbaIdx=vmwHbaIdx, vmwNumWrites=vmwNumWrites, vmwNetIfAddr=vmwNetIfAddr, vpxdNewStatus=vpxdNewStatus, vmwNetPktsTx=vmwNetPktsTx, vmwCpuShares=vmwCpuShares, vmwNetKbTx=vmwNetKbTx, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetHCPktsRx=vmwNetHCPktsRx, vmSuspended=vmSuspended, vmwMemEntry=vmwMemEntry, vmwNetHCKbRx=vmwNetHCKbRx, vmwCpuVMID=vmwCpuVMID, vmwMemConfigured=vmwMemConfigured, vmwNetIdx=vmwNetIdx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteGroup=vmwObsoleteGroup, vmwHbaVMID=vmwHbaVMID, vmwHBAEntry=vmwHBAEntry, vpxdHostName=vpxdHostName, vpxdObjValue=vpxdObjValue, vmwCpuUtil=vmwCpuUtil, vpxdOldStatus=vpxdOldStatus, vmwNetPktsRx=vmwNetPktsRx, vmwNetEntry=vmwNetEntry, vmwNumReads=vmwNumReads, vmHBDetected=vmHBDetected, vmwCpuEntry=vmwCpuEntry, vmHBLost=vmHBLost, vmwHbaName=vmwHbaName, vmwMemTable=vmwMemTable)
