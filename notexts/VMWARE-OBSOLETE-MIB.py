...
ModuleIdentity, Counter32, Bits, Gauge32, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, MibIdentifier, Integer32, IpAddress, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "Bits", "Gauge32", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "MibIdentifier", "Integer32", "IpAddress", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuShares=vmwCpuShares, vpxdObjValue=vpxdObjValue, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemVMID=vmwMemVMID, vmwNumReads=vmwNumReads, vmwObsoleteGroup=vmwObsoleteGroup, vmwHbaVMID=vmwHbaVMID, vmwNetTable=vmwNetTable, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmHBLost=vmHBLost, vmwHBAEntry=vmwHBAEntry, vmwNetVMID=vmwNetVMID, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuEntry=vmwCpuEntry, vmwObsoleteMIB=vmwObsoleteMIB, vmwDiskShares=vmwDiskShares, vmwNetIdx=vmwNetIdx, vmwCpuUtil=vmwCpuUtil, vmPoweredOn=vmPoweredOn, vmwKbRead=vmwKbRead, vmwMemEntry=vmwMemEntry, vpxdHostName=vpxdHostName, vpxdTrapType=vpxdTrapType, vmwNetName=vmwNetName, vmwNetEntry=vmwNetEntry, vmwHbaIdx=vmwHbaIdx, vmwMemUtil=vmwMemUtil, vpxdVMName=vpxdVMName, vmSuspended=vmSuspended, vmwHbaName=vmwHbaName, vpxdTrap=vpxdTrap, vmwNetKbTx=vmwNetKbTx, vpxdNewStatus=vpxdNewStatus, vmkLoaded=vmkLoaded, vmwNetKbRx=vmwNetKbRx, vmPoweredOff=vmPoweredOff, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemShares=vmwMemShares, vmwKbWritten=vmwKbWritten, vmwMemConfigured=vmwMemConfigured, vmwCpuTable=vmwCpuTable, vmwNetShares=vmwNetShares, vmwNetHCPktsRx=vmwNetHCPktsRx, vmHBDetected=vmHBDetected, vmwNetIfAddr=vmwNetIfAddr, vmwMemTable=vmwMemTable, vmwHBATable=vmwHBATable, vpxdOldStatus=vpxdOldStatus, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetPktsTx=vmwNetPktsTx, vmwNumWrites=vmwNumWrites, vmwCpuVMID=vmwCpuVMID)
