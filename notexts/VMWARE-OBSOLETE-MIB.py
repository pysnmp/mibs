...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdTrapType=vpxdTrapType, vmwNetEntry=vmwNetEntry, vmwKbWritten=vmwKbWritten, vmPoweredOff=vmPoweredOff, vmwNetKbRx=vmwNetKbRx, vmwNetShares=vmwNetShares, vmwNetIdx=vmwNetIdx, vmwHBATable=vmwHBATable, vmwDiskShares=vmwDiskShares, vmHBDetected=vmHBDetected, vmwCpuEntry=vmwCpuEntry, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemTable=vmwMemTable, vmSuspended=vmSuspended, vmwKbRead=vmwKbRead, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetVMID=vmwNetVMID, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemShares=vmwMemShares, vmwMemEntry=vmwMemEntry, vpxdOldStatus=vpxdOldStatus, vmwCpuVMID=vmwCpuVMID, vmwNetIfAddr=vmwNetIfAddr, vmwNetTable=vmwNetTable, vpxdHostName=vpxdHostName, vmwObsoleteMIB=vmwObsoleteMIB, vmHBLost=vmHBLost, vmwMemConfigured=vmwMemConfigured, vmwHbaName=vmwHbaName, vmwHbaVMID=vmwHbaVMID, vmwMemUtil=vmwMemUtil, vmwNetKbTx=vmwNetKbTx, vmPoweredOn=vmPoweredOn, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdNewStatus=vpxdNewStatus, vmwHBAEntry=vmwHBAEntry, vmwCpuShares=vmwCpuShares, vmkLoaded=vmkLoaded, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuUtil=vmwCpuUtil, vpxdTrap=vpxdTrap, vmwHbaIdx=vmwHbaIdx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdVMName=vpxdVMName, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdObjValue=vpxdObjValue, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNumReads=vmwNumReads, vmwObsMIBGroups=vmwObsMIBGroups, vmwNumWrites=vmwNumWrites, vmwCpuTable=vmwCpuTable, vmwNetPktsRx=vmwNetPktsRx, vmwNetName=vmwNetName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemVMID=vmwMemVMID)
