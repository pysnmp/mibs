...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, ObjectIdentity, MibIdentifier, IpAddress, NotificationType, Gauge32, TimeTicks, Counter64, Counter32, Integer32, Unsigned32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "IpAddress", "NotificationType", "Gauge32", "TimeTicks", "Counter64", "Counter32", "Integer32", "Unsigned32", "Bits")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemTable=vmwMemTable, vmwNetIdx=vmwNetIdx, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemShares=vmwMemShares, vpxdNewStatus=vpxdNewStatus, vmwCpuEntry=vmwCpuEntry, vmwNetShares=vmwNetShares, vmwHbaVMID=vmwHbaVMID, vpxdOldStatus=vpxdOldStatus, vmwNetEntry=vmwNetEntry, vmwHBATable=vmwHBATable, vmwHBAEntry=vmwHBAEntry, vmwNetTable=vmwNetTable, vmPoweredOff=vmPoweredOff, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetName=vmwNetName, vmwNetKbTx=vmwNetKbTx, vmwNetPktsRx=vmwNetPktsRx, vmHBLost=vmHBLost, vmwMemConfigured=vmwMemConfigured, vpxdTrapType=vpxdTrapType, vmwObsoleteMIB=vmwObsoleteMIB, vmwNumWrites=vmwNumWrites, vmSuspended=vmSuspended, vpxdVMName=vpxdVMName, vmkLoaded=vmkLoaded, vmwNetKbRx=vmwNetKbRx, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuVMID=vmwCpuVMID, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuUtil=vmwCpuUtil, vmwNetIfAddr=vmwNetIfAddr, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetHCPktsTx=vmwNetHCPktsTx, vmHBDetected=vmHBDetected, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwHbaIdx=vmwHbaIdx, vmwNetVMID=vmwNetVMID, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuTable=vmwCpuTable, vmwDiskShares=vmwDiskShares, vmwMemEntry=vmwMemEntry, vmwMemVMID=vmwMemVMID, vmwCpuShares=vmwCpuShares, vmwNumReads=vmwNumReads, vpxdObjValue=vpxdObjValue, vmwNetPktsTx=vmwNetPktsTx, vmPoweredOn=vmPoweredOn, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdHostName=vpxdHostName, vpxdTrap=vpxdTrap, vmwHbaName=vmwHbaName, vmwMemUtil=vmwMemUtil, vmwKbWritten=vmwKbWritten, vmwKbRead=vmwKbRead)
