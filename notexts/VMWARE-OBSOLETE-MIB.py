...
MibIdentifier, Bits, IpAddress, Gauge32, Counter32, ModuleIdentity, Integer32, Counter64, iso, NotificationType, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "IpAddress", "Gauge32", "Counter32", "ModuleIdentity", "Integer32", "Counter64", "iso", "NotificationType", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmHBDetected=vmHBDetected, vmwMemTable=vmwMemTable, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemConfigured=vmwMemConfigured, vmkLoaded=vmkLoaded, vmwNetTable=vmwNetTable, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwKbRead=vmwKbRead, vpxdTrapType=vpxdTrapType, vmwHbaName=vmwHbaName, vmwNetIfAddr=vmwNetIfAddr, vmwHBAEntry=vmwHBAEntry, vmwNetKbRx=vmwNetKbRx, vmwMemUtil=vmwMemUtil, vpxdVMName=vpxdVMName, vmwCpuEntry=vmwCpuEntry, vmwNetEntry=vmwNetEntry, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemShares=vmwMemShares, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHBATable=vmwHBATable, vmPoweredOn=vmPoweredOn, vpxdOldStatus=vpxdOldStatus, vmwNumWrites=vmwNumWrites, vmwNetHCKbTx=vmwNetHCKbTx, vmPoweredOff=vmPoweredOff, vmwCpuShares=vmwCpuShares, vpxdHostName=vpxdHostName, vmwMemEntry=vmwMemEntry, vmwNetKbTx=vmwNetKbTx, vmwNetPktsTx=vmwNetPktsTx, vmwHbaVMID=vmwHbaVMID, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetName=vmwNetName, vmwObsoleteMIB=vmwObsoleteMIB, vmwDiskShares=vmwDiskShares, vmwCpuUtil=vmwCpuUtil, vmHBLost=vmHBLost, vpxdNewStatus=vpxdNewStatus, vmwObsMIBGroups=vmwObsMIBGroups, vmwHbaIdx=vmwHbaIdx, vmwNetIdx=vmwNetIdx, vmwMemVMID=vmwMemVMID, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdTrap=vpxdTrap, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNumReads=vmwNumReads, vmwNetShares=vmwNetShares, vmwNetHCKbRx=vmwNetHCKbRx, vmSuspended=vmSuspended, vmwKbWritten=vmwKbWritten, vmwNetVMID=vmwNetVMID, vmwCpuVMID=vmwCpuVMID, vmwCpuTable=vmwCpuTable, vpxdObjValue=vpxdObjValue)
