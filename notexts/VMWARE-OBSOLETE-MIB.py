...
Integer32, Counter64, NotificationType, ObjectIdentity, Gauge32, Bits, Unsigned32, IpAddress, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "NotificationType", "ObjectIdentity", "Gauge32", "Bits", "Unsigned32", "IpAddress", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdOldStatus=vpxdOldStatus, vmwCpuTable=vmwCpuTable, vmwDiskShares=vmwDiskShares, vmwNetIfAddr=vmwNetIfAddr, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetHCPktsRx=vmwNetHCPktsRx, vmHBDetected=vmHBDetected, vmwMemVMID=vmwMemVMID, vmwKbRead=vmwKbRead, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetHCKbTx=vmwNetHCKbTx, vmwHbaIdx=vmwHbaIdx, vmwKbWritten=vmwKbWritten, vmwNetKbRx=vmwNetKbRx, vpxdTrapType=vpxdTrapType, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetPktsTx=vmwNetPktsTx, vmwCpuShares=vmwCpuShares, vmwMemUtil=vmwMemUtil, vmwHBATable=vmwHBATable, vmPoweredOff=vmPoweredOff, vmwNetTable=vmwNetTable, vmSuspended=vmSuspended, vmwNetEntry=vmwNetEntry, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteGroup=vmwObsoleteGroup, vpxdVMName=vpxdVMName, vmwMemShares=vmwMemShares, vmwNetIdx=vmwNetIdx, vmwHBAEntry=vmwHBAEntry, vmwNumWrites=vmwNumWrites, vmwNetKbTx=vmwNetKbTx, vmwMemConfigured=vmwMemConfigured, vpxdNewStatus=vpxdNewStatus, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdHostName=vpxdHostName, vmwCpuEntry=vmwCpuEntry, vmwHbaName=vmwHbaName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmHBLost=vmHBLost, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetName=vmwNetName, vmwNumReads=vmwNumReads, vpxdObjValue=vpxdObjValue, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemTable=vmwMemTable, vmwMemEntry=vmwMemEntry, vmwNetVMID=vmwNetVMID, vmwNetShares=vmwNetShares, vmwNetHCKbRx=vmwNetHCKbRx, vmkLoaded=vmkLoaded, vmwCpuVMID=vmwCpuVMID, vmPoweredOn=vmPoweredOn, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuUtil=vmwCpuUtil, vmwHbaVMID=vmwHbaVMID, vpxdTrap=vpxdTrap)
