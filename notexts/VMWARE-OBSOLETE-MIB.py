...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwObsoleteMIB=vmwObsoleteMIB, vmwHbaVMID=vmwHbaVMID, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdTrapType=vpxdTrapType, vmwHbaIdx=vmwHbaIdx, vmwMemShares=vmwMemShares, vmwNetIfAddr=vmwNetIfAddr, vmPoweredOff=vmPoweredOff, vmHBLost=vmHBLost, vmwNetKbRx=vmwNetKbRx, vmwNumWrites=vmwNumWrites, vpxdVMName=vpxdVMName, vmwKbRead=vmwKbRead, vmwNetTable=vmwNetTable, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuTable=vmwCpuTable, vmwNetShares=vmwNetShares, vmwCpuEntry=vmwCpuEntry, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemEntry=vmwMemEntry, vmwNetPktsTx=vmwNetPktsTx, vmwNetName=vmwNetName, vmwHbaName=vmwHbaName, vpxdNewStatus=vpxdNewStatus, vmwCpuShares=vmwCpuShares, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetHCKbRx=vmwNetHCKbRx, vpxdOldStatus=vpxdOldStatus, vmwCpuVMID=vmwCpuVMID, vmwKbWritten=vmwKbWritten, vmwDiskShares=vmwDiskShares, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNumReads=vmwNumReads, vmwHBATable=vmwHBATable, vmwNetIdx=vmwNetIdx, vmwMemTable=vmwMemTable, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmkLoaded=vmkLoaded, vmwNetPktsRx=vmwNetPktsRx, vpxdObjValue=vpxdObjValue, vmHBDetected=vmHBDetected, vmwCpuUtil=vmwCpuUtil, vmwMemConfigured=vmwMemConfigured, vmwMemUtil=vmwMemUtil, vmPoweredOn=vmPoweredOn, vpxdTrap=vpxdTrap, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdHostName=vpxdHostName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetVMID=vmwNetVMID, vmwNetKbTx=vmwNetKbTx, vmwNetEntry=vmwNetEntry, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmSuspended=vmSuspended, vmwMemVMID=vmwMemVMID, vmwHBAEntry=vmwHBAEntry)
