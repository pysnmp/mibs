...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuShares=vmwCpuShares, vmwNumWrites=vmwNumWrites, vmwCpuTable=vmwCpuTable, vmPoweredOff=vmPoweredOff, vmwHbaVMID=vmwHbaVMID, vmwNumReads=vmwNumReads, vpxdOldStatus=vpxdOldStatus, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetKbTx=vmwNetKbTx, vmwMemEntry=vmwMemEntry, vmwDiskShares=vmwDiskShares, vmwNetEntry=vmwNetEntry, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemTable=vmwMemTable, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemConfigured=vmwMemConfigured, vmwHBATable=vmwHBATable, vmwNetTable=vmwNetTable, vpxdNewStatus=vpxdNewStatus, vmSuspended=vmSuspended, vmwNetShares=vmwNetShares, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemUtil=vmwMemUtil, vpxdTrapType=vpxdTrapType, vmHBDetected=vmHBDetected, vmwKbWritten=vmwKbWritten, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetVMID=vmwNetVMID, vmwNetKbRx=vmwNetKbRx, vmwNetIdx=vmwNetIdx, vmkLoaded=vmkLoaded, vmwHBAEntry=vmwHBAEntry, vmwCpuUtil=vmwCpuUtil, vmHBLost=vmHBLost, vmwNetPktsTx=vmwNetPktsTx, vpxdObjValue=vpxdObjValue, vmwNetIfAddr=vmwNetIfAddr, vmwNetName=vmwNetName, vmwMemShares=vmwMemShares, vmwHbaName=vmwHbaName, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdTrap=vpxdTrap, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmPoweredOn=vmPoweredOn, vmwCpuVMID=vmwCpuVMID, vmwNetHCKbRx=vmwNetHCKbRx, vpxdHostName=vpxdHostName, vmwObsoleteGroup=vmwObsoleteGroup, vmwHbaIdx=vmwHbaIdx, vmwCpuEntry=vmwCpuEntry, vmwMemVMID=vmwMemVMID, vmwKbRead=vmwKbRead, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdVMName=vpxdVMName, PYSNMP_MODULE_ID=vmwObsoleteMIB)
