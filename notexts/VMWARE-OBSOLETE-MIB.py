...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuEntry=vmwCpuEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetShares=vmwNetShares, vmwCpuShares=vmwCpuShares, vmwNumWrites=vmwNumWrites, vpxdNewStatus=vpxdNewStatus, vmwHBATable=vmwHBATable, vmSuspended=vmSuspended, vmwHBAEntry=vmwHBAEntry, vmwNetPktsRx=vmwNetPktsRx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuUtil=vmwCpuUtil, vmwKbWritten=vmwKbWritten, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemUtil=vmwMemUtil, vpxdObjValue=vpxdObjValue, vmwCpuVMID=vmwCpuVMID, vmwMemTable=vmwMemTable, vmPoweredOff=vmPoweredOff, vmwNetHCKbRx=vmwNetHCKbRx, vpxdTrapType=vpxdTrapType, vmwNetKbRx=vmwNetKbRx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdTrap=vpxdTrap, vmwKbRead=vmwKbRead, vmwNetIfAddr=vmwNetIfAddr, vmwNetTable=vmwNetTable, vmwNetHCKbTx=vmwNetHCKbTx, vpxdVMName=vpxdVMName, vmwDiskShares=vmwDiskShares, vmwNetVMID=vmwNetVMID, vmwObsMIBGroups=vmwObsMIBGroups, vmHBDetected=vmHBDetected, vmwNetName=vmwNetName, vmwNetIdx=vmwNetIdx, vmwObsoleteGroup=vmwObsoleteGroup, vmHBLost=vmHBLost, vmPoweredOn=vmPoweredOn, vmwNetEntry=vmwNetEntry, vmwNetKbTx=vmwNetKbTx, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetPktsTx=vmwNetPktsTx, vpxdOldStatus=vpxdOldStatus, vmkLoaded=vmkLoaded, vmwHbaName=vmwHbaName, vmwMemVMID=vmwMemVMID, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemConfigured=vmwMemConfigured, vmwHbaVMID=vmwHbaVMID, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNumReads=vmwNumReads, vmwCpuTable=vmwCpuTable, vmwMemShares=vmwMemShares, vmwHbaIdx=vmwHbaIdx, vmwMemEntry=vmwMemEntry, vpxdHostName=vpxdHostName)
