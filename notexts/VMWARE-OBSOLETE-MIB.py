...
Gauge32, iso, Counter32, Integer32, Counter64, Unsigned32, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, ModuleIdentity, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "Counter32", "Integer32", "Counter64", "Unsigned32", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "ModuleIdentity", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmkLoaded=vmkLoaded, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetIfAddr=vmwNetIfAddr, vmwMemUtil=vmwMemUtil, vmwHBATable=vmwHBATable, vmwHbaIdx=vmwHbaIdx, vmHBDetected=vmHBDetected, vmwCpuShares=vmwCpuShares, vmwCpuUtil=vmwCpuUtil, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuTable=vmwCpuTable, vmwDiskShares=vmwDiskShares, vmwNetTable=vmwNetTable, vmPoweredOff=vmPoweredOff, vmwNumReads=vmwNumReads, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdOldStatus=vpxdOldStatus, vmwHbaVMID=vmwHbaVMID, vmwNetIdx=vmwNetIdx, vpxdVMName=vpxdVMName, vmwObsoleteMIB=vmwObsoleteMIB, vpxdTrapType=vpxdTrapType, vmwKbWritten=vmwKbWritten, vmwNetEntry=vmwNetEntry, vpxdHostName=vpxdHostName, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemShares=vmwMemShares, vmwNumWrites=vmwNumWrites, vpxdObjValue=vpxdObjValue, vpxdNewStatus=vpxdNewStatus, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuEntry=vmwCpuEntry, vmwMemVMID=vmwMemVMID, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetKbTx=vmwNetKbTx, vmwMemTable=vmwMemTable, vmwHBAEntry=vmwHBAEntry, vmwNetShares=vmwNetShares, vmwCpuVMID=vmwCpuVMID, vmwMemEntry=vmwMemEntry, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCKbRx=vmwNetHCKbRx, vmHBLost=vmHBLost, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemConfigured=vmwMemConfigured, vmwNetName=vmwNetName, vmwNetHCPktsRx=vmwNetHCPktsRx, vpxdTrap=vpxdTrap, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetVMID=vmwNetVMID, vmwHbaName=vmwHbaName, vmwKbRead=vmwKbRead, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmSuspended=vmSuspended, vmwNetKbRx=vmwNetKbRx, vmPoweredOn=vmPoweredOn, vmwNetPktsRx=vmwNetPktsRx)
