...
iso, Counter32, Gauge32, Counter64, Integer32, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, Unsigned32, ObjectIdentity, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "Gauge32", "Counter64", "Integer32", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "Unsigned32", "ObjectIdentity", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetTable=vmwNetTable, vmwHbaName=vmwHbaName, vpxdTrapType=vpxdTrapType, vpxdObjValue=vpxdObjValue, vmwMemTable=vmwMemTable, vmSuspended=vmSuspended, vmwHBAEntry=vmwHBAEntry, vmwNetIfAddr=vmwNetIfAddr, vmwMemShares=vmwMemShares, vpxdTrap=vpxdTrap, vmPoweredOff=vmPoweredOff, vmwNetPktsTx=vmwNetPktsTx, vmwMemUtil=vmwMemUtil, vpxdVMName=vpxdVMName, vmwNetHCPktsRx=vmwNetHCPktsRx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemEntry=vmwMemEntry, vmwNetKbRx=vmwNetKbRx, vpxdOldStatus=vpxdOldStatus, vmwKbRead=vmwKbRead, vmHBDetected=vmHBDetected, vmwHBATable=vmwHBATable, vmwNetPktsRx=vmwNetPktsRx, vpxdNewStatus=vpxdNewStatus, vmwNetVMID=vmwNetVMID, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuVMID=vmwCpuVMID, vmwNetName=vmwNetName, vmPoweredOn=vmPoweredOn, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteGroup=vmwObsoleteGroup, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetKbTx=vmwNetKbTx, vmHBLost=vmHBLost, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetIdx=vmwNetIdx, vmwObsMIBGroups=vmwObsMIBGroups, vmwCpuShares=vmwCpuShares, vmwCpuEntry=vmwCpuEntry, vpxdHostName=vpxdHostName, vmwHbaVMID=vmwHbaVMID, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHbaIdx=vmwHbaIdx, vmwMemVMID=vmwMemVMID, vmwCpuTable=vmwCpuTable, vmwNumReads=vmwNumReads, vmwCpuUtil=vmwCpuUtil, vmwDiskShares=vmwDiskShares, vmwNetShares=vmwNetShares, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemConfigured=vmwMemConfigured, vmwNumWrites=vmwNumWrites, vmwKbWritten=vmwKbWritten, vmwNetEntry=vmwNetEntry, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmkLoaded=vmkLoaded)
