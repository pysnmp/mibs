...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, IpAddress, Gauge32, Integer32, Counter64, Counter32, Bits, iso, MibIdentifier, NotificationType, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "IpAddress", "Gauge32", "Integer32", "Counter64", "Counter32", "Bits", "iso", "MibIdentifier", "NotificationType", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetName=vmwNetName, vpxdVMName=vpxdVMName, vmwCpuTable=vmwCpuTable, vmwDiskShares=vmwDiskShares, vmHBDetected=vmHBDetected, vpxdNewStatus=vpxdNewStatus, vmwHBAEntry=vmwHBAEntry, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetIfAddr=vmwNetIfAddr, vmwCpuVMID=vmwCpuVMID, vmwNetPktsTx=vmwNetPktsTx, vmwMemUtil=vmwMemUtil, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemTable=vmwMemTable, vmwCpuEntry=vmwCpuEntry, vpxdHostName=vpxdHostName, vmwCpuUtil=vmwCpuUtil, vpxdTrapType=vpxdTrapType, vmwNetShares=vmwNetShares, vmwNetKbRx=vmwNetKbRx, vmwMemEntry=vmwMemEntry, vmwNetKbTx=vmwNetKbTx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemVMID=vmwMemVMID, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwCpuShares=vmwCpuShares, vmwHbaName=vmwHbaName, vpxdObjValue=vpxdObjValue, vmSuspended=vmSuspended, vmwNumWrites=vmwNumWrites, vmwNetHCKbTx=vmwNetHCKbTx, vmwNumReads=vmwNumReads, vmwMemConfigured=vmwMemConfigured, vmwNetHCPktsTx=vmwNetHCPktsTx, vmPoweredOn=vmPoweredOn, vmwNetPktsRx=vmwNetPktsRx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetHCPktsRx=vmwNetHCPktsRx, vmPoweredOff=vmPoweredOff, vpxdOldStatus=vpxdOldStatus, vmkLoaded=vmkLoaded, vmwNetTable=vmwNetTable, vmHBLost=vmHBLost, vmwNetIdx=vmwNetIdx, vpxdTrap=vpxdTrap, vmwHbaIdx=vmwHbaIdx, vmwNetVMID=vmwNetVMID, vmwMemShares=vmwMemShares, vmwKbWritten=vmwKbWritten, vmwKbRead=vmwKbRead, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwHBATable=vmwHBATable, vmwHbaVMID=vmwHbaVMID, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetEntry=vmwNetEntry)
