...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetEntry=vmwNetEntry, vmkLoaded=vmkLoaded, vmwNetHCKbRx=vmwNetHCKbRx, vpxdTrapType=vpxdTrapType, vmwHBAEntry=vmwHBAEntry, vmwNumWrites=vmwNumWrites, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmPoweredOn=vmPoweredOn, vpxdOldStatus=vpxdOldStatus, vmPoweredOff=vmPoweredOff, vmwNetKbTx=vmwNetKbTx, vmwNetPktsTx=vmwNetPktsTx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwNetVMID=vmwNetVMID, vpxdVMName=vpxdVMName, vmwNetKbRx=vmwNetKbRx, vmwCpuTable=vmwCpuTable, vmwNumReads=vmwNumReads, vpxdHostName=vpxdHostName, vpxdNewStatus=vpxdNewStatus, vmwMemShares=vmwMemShares, vmwCpuUtil=vmwCpuUtil, vmSuspended=vmSuspended, vpxdObjValue=vpxdObjValue, vmwKbRead=vmwKbRead, vmwObsMIBGroups=vmwObsMIBGroups, vmwHbaIdx=vmwHbaIdx, vmHBLost=vmHBLost, vmHBDetected=vmHBDetected, vmwDiskShares=vmwDiskShares, vmwMemTable=vmwMemTable, vmwHbaVMID=vmwHbaVMID, vmwNetIfAddr=vmwNetIfAddr, vmwNetTable=vmwNetTable, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemUtil=vmwMemUtil, vmwMemEntry=vmwMemEntry, vmwNetShares=vmwNetShares, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsoleteMIB=vmwObsoleteMIB, vmwMemVMID=vmwMemVMID, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuShares=vmwCpuShares, vmwNetIdx=vmwNetIdx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetPktsRx=vmwNetPktsRx, vmwCpuVMID=vmwCpuVMID, vmwHBATable=vmwHBATable, vmwKbWritten=vmwKbWritten, PYSNMP_MODULE_ID=vmwObsoleteMIB, vpxdTrap=vpxdTrap, vmwMemConfigured=vmwMemConfigured, vmwCpuEntry=vmwCpuEntry, vmwNetName=vmwNetName, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwHbaName=vmwHbaName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance)
