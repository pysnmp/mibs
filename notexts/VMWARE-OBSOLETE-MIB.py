...
Counter32, Bits, TimeTicks, IpAddress, Counter64, iso, Unsigned32, Gauge32, MibIdentifier, NotificationType, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "TimeTicks", "IpAddress", "Counter64", "iso", "Unsigned32", "Gauge32", "MibIdentifier", "NotificationType", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwCpuUtil=vmwCpuUtil, vmwNetShares=vmwNetShares, vmwNumReads=vmwNumReads, vmwNetEntry=vmwNetEntry, vmwMemTable=vmwMemTable, vpxdOldStatus=vpxdOldStatus, vmwMemShares=vmwMemShares, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmPoweredOff=vmPoweredOff, vpxdHostName=vpxdHostName, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwCpuEntry=vmwCpuEntry, vmwObsoleteGroup=vmwObsoleteGroup, vmwHbaVMID=vmwHbaVMID, vmwNetHCKbRx=vmwNetHCKbRx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdTrapType=vpxdTrapType, vpxdTrap=vpxdTrap, vpxdNewStatus=vpxdNewStatus, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuShares=vmwCpuShares, vmwNetIfAddr=vmwNetIfAddr, vmwNetVMID=vmwNetVMID, vpxdVMName=vpxdVMName, vmwKbRead=vmwKbRead, vmHBDetected=vmHBDetected, vmwNetTable=vmwNetTable, vmwNetHCPktsRx=vmwNetHCPktsRx, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHbaName=vmwHbaName, vmHBLost=vmHBLost, vmwCpuVMID=vmwCpuVMID, vmwNetPktsTx=vmwNetPktsTx, vmwCpuTable=vmwCpuTable, vmwMemConfigured=vmwMemConfigured, vmwNetName=vmwNetName, vmwNumWrites=vmwNumWrites, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemEntry=vmwMemEntry, vmwKbWritten=vmwKbWritten, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemVMID=vmwMemVMID, vmSuspended=vmSuspended, vmwHBAEntry=vmwHBAEntry, vmwDiskShares=vmwDiskShares, vmwNetKbTx=vmwNetKbTx, vmwNetKbRx=vmwNetKbRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetIdx=vmwNetIdx, vmPoweredOn=vmPoweredOn, vmwObsoleteMIB=vmwObsoleteMIB, vmwHBATable=vmwHBATable, vmwMemUtil=vmwMemUtil, vmwNetPktsRx=vmwNetPktsRx, vpxdObjValue=vpxdObjValue, vmwHbaIdx=vmwHbaIdx, vmkLoaded=vmkLoaded)
