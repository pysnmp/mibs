...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetIfAddr=vmwNetIfAddr, vpxdObjValue=vpxdObjValue, vmwNumReads=vmwNumReads, vmwCpuTable=vmwCpuTable, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemShares=vmwMemShares, vmwNetName=vmwNetName, vpxdNewStatus=vpxdNewStatus, vmPoweredOn=vmPoweredOn, vmwObsoleteGroup=vmwObsoleteGroup, vmwCpuEntry=vmwCpuEntry, vmwHbaIdx=vmwHbaIdx, vmwCpuUtil=vmwCpuUtil, vmwMemTable=vmwMemTable, vmwHBATable=vmwHBATable, vmwNetVMID=vmwNetVMID, vmHBDetected=vmHBDetected, vpxdHostName=vpxdHostName, vmwNetKbTx=vmwNetKbTx, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetIdx=vmwNetIdx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHbaName=vmwHbaName, vmwKbWritten=vmwKbWritten, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdOldStatus=vpxdOldStatus, vmkLoaded=vmkLoaded, vmwMemVMID=vmwMemVMID, vmwKbRead=vmwKbRead, vmwHBAEntry=vmwHBAEntry, vmwMemUtil=vmwMemUtil, vmwNetKbRx=vmwNetKbRx, vmwMemEntry=vmwMemEntry, vmHBLost=vmHBLost, vmwObsMIBGroups=vmwObsMIBGroups, vmwDiskShares=vmwDiskShares, vmwNetHCKbRx=vmwNetHCKbRx, vmwCpuShares=vmwCpuShares, vpxdTrap=vpxdTrap, vpxdTrapType=vpxdTrapType, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetEntry=vmwNetEntry, vmwNumWrites=vmwNumWrites, vmwNetTable=vmwNetTable, vmwObsoleteMIB=vmwObsoleteMIB, vmSuspended=vmSuspended, vmwMemConfigured=vmwMemConfigured, vmwCpuVMID=vmwCpuVMID, vmPoweredOff=vmPoweredOff, vmwNetShares=vmwNetShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHbaVMID=vmwHbaVMID, vpxdVMName=vpxdVMName)
