...
IpAddress, ObjectIdentity, ModuleIdentity, iso, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, MibIdentifier, Bits, Counter64, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "ModuleIdentity", "iso", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "MibIdentifier", "Bits", "Counter64", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemUtil=vmwMemUtil, vpxdVMName=vpxdVMName, vmwCpuVMID=vmwCpuVMID, vmwMemConfigured=vmwMemConfigured, vmwKbWritten=vmwKbWritten, vpxdTrap=vpxdTrap, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmHBLost=vmHBLost, vmwMemShares=vmwMemShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwHBATable=vmwHBATable, vmwNetEntry=vmwNetEntry, vmwCpuUtil=vmwCpuUtil, vmwNetName=vmwNetName, vmwNetShares=vmwNetShares, vmwNetPktsTx=vmwNetPktsTx, vmwNetKbTx=vmwNetKbTx, vpxdOldStatus=vpxdOldStatus, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwHBAEntry=vmwHBAEntry, vmwHbaVMID=vmwHbaVMID, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetTable=vmwNetTable, vmPoweredOn=vmPoweredOn, vpxdNewStatus=vpxdNewStatus, vmwHbaName=vmwHbaName, vmPoweredOff=vmPoweredOff, vmwKbRead=vmwKbRead, vmwCpuEntry=vmwCpuEntry, vmwCpuTable=vmwCpuTable, vpxdTrapType=vpxdTrapType, vmwMemEntry=vmwMemEntry, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwHbaIdx=vmwHbaIdx, vmwNetPktsRx=vmwNetPktsRx, vmHBDetected=vmHBDetected, vmwNumReads=vmwNumReads, vmkLoaded=vmkLoaded, vmwMemVMID=vmwMemVMID, vmwNetHCKbTx=vmwNetHCKbTx, vmSuspended=vmSuspended, vpxdObjValue=vpxdObjValue, vmwDiskShares=vmwDiskShares, vmwObsoleteGroup=vmwObsoleteGroup, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetHCKbRx=vmwNetHCKbRx, vmwMemTable=vmwMemTable, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetKbRx=vmwNetKbRx, vmwNumWrites=vmwNumWrites, vmwNetIfAddr=vmwNetIfAddr, vmwNetVMID=vmwNetVMID, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuShares=vmwCpuShares, vmwNetIdx=vmwNetIdx, vpxdHostName=vpxdHostName)
