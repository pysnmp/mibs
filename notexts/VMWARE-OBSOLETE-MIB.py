...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Unsigned32, Gauge32, MibIdentifier, IpAddress, Counter64, TimeTicks, ObjectIdentity, Integer32, Counter32, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Unsigned32", "Gauge32", "MibIdentifier", "IpAddress", "Counter64", "TimeTicks", "ObjectIdentity", "Integer32", "Counter32", "iso", "Bits")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwHbaName=vmwHbaName, vmwHbaIdx=vmwHbaIdx, vmwHBATable=vmwHBATable, vmwHBAEntry=vmwHBAEntry, vmwNumReads=vmwNumReads, vmwNetKbRx=vmwNetKbRx, vmwCpuTable=vmwCpuTable, vmwNetHCKbRx=vmwNetHCKbRx, vpxdVMName=vpxdVMName, vpxdObjValue=vpxdObjValue, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vpxdTrapType=vpxdTrapType, vmwNetKbTx=vmwNetKbTx, vmwMemVMID=vmwMemVMID, vmkLoaded=vmkLoaded, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuUtil=vmwCpuUtil, vmwMemUtil=vmwMemUtil, vmwNetShares=vmwNetShares, vmwNetIdx=vmwNetIdx, vmPoweredOff=vmPoweredOff, vmwCpuEntry=vmwCpuEntry, vmHBLost=vmHBLost, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetIfAddr=vmwNetIfAddr, vmPoweredOn=vmPoweredOn, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemConfigured=vmwMemConfigured, vmwKbWritten=vmwKbWritten, vpxdOldStatus=vpxdOldStatus, vmwDiskShares=vmwDiskShares, vpxdTrap=vpxdTrap, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemEntry=vmwMemEntry, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdHostName=vpxdHostName, vpxdNewStatus=vpxdNewStatus, vmwHbaVMID=vmwHbaVMID, vmwMemTable=vmwMemTable, vmHBDetected=vmHBDetected, vmwNetName=vmwNetName, vmwNetPktsTx=vmwNetPktsTx, vmSuspended=vmSuspended, vmwCpuShares=vmwCpuShares, vmwNetEntry=vmwNetEntry, vmwKbRead=vmwKbRead, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemShares=vmwMemShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwCpuVMID=vmwCpuVMID, vmwNetPktsRx=vmwNetPktsRx, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetVMID=vmwNetVMID, vmwNumWrites=vmwNumWrites, vmwNetTable=vmwNetTable)
