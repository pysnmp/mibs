...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmkLoaded=vmkLoaded, vmwMemEntry=vmwMemEntry, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetHCKbRx=vmwNetHCKbRx, vpxdOldStatus=vpxdOldStatus, vmwNetName=vmwNetName, vmwNetIfAddr=vmwNetIfAddr, vmwKbWritten=vmwKbWritten, vmwNetHCPktsTx=vmwNetHCPktsTx, vpxdVMName=vpxdVMName, vmwMemVMID=vmwMemVMID, vmwCpuTable=vmwCpuTable, vmwCpuVMID=vmwCpuVMID, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNumReads=vmwNumReads, vmwNetPktsRx=vmwNetPktsRx, vmwHBAEntry=vmwHBAEntry, vmwMemShares=vmwMemShares, vmwKbRead=vmwKbRead, vmwNetShares=vmwNetShares, vpxdObjValue=vpxdObjValue, vmwNetEntry=vmwNetEntry, vmwNetKbTx=vmwNetKbTx, vmwNetKbRx=vmwNetKbRx, vmwHbaName=vmwHbaName, vmwMemUtil=vmwMemUtil, vmHBLost=vmHBLost, vmPoweredOff=vmPoweredOff, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwDiskShares=vmwDiskShares, vmSuspended=vmSuspended, vmwNetIdx=vmwNetIdx, vmwHBATable=vmwHBATable, vmwNetTable=vmwNetTable, vmwMemConfigured=vmwMemConfigured, vmwCpuUtil=vmwCpuUtil, vpxdTrapType=vpxdTrapType, vmwObsMIBGroups=vmwObsMIBGroups, vpxdHostName=vpxdHostName, vmPoweredOn=vmPoweredOn, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHbaVMID=vmwHbaVMID, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwNumWrites=vmwNumWrites, vmHBDetected=vmHBDetected, vmwHbaIdx=vmwHbaIdx, vmwNetVMID=vmwNetVMID, vpxdTrap=vpxdTrap, vmwNetHCKbTx=vmwNetHCKbTx, vmwCpuShares=vmwCpuShares, vmwCpuEntry=vmwCpuEntry, vmwMemTable=vmwMemTable, vmwNetPktsTx=vmwNetPktsTx, vpxdNewStatus=vpxdNewStatus)
