...
ObjectIdentity, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, Gauge32, NotificationType, Counter32, Integer32, Counter64, TimeTicks, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "Gauge32", "NotificationType", "Counter32", "Integer32", "Counter64", "TimeTicks", "ModuleIdentity", "iso")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetHCKbRx=vmwNetHCKbRx, vmwMemShares=vmwMemShares, vmwCpuShares=vmwCpuShares, vmwNetKbTx=vmwNetKbTx, vmwHBAEntry=vmwHBAEntry, vmwHbaName=vmwHbaName, vmwCpuUtil=vmwCpuUtil, vmPoweredOff=vmPoweredOff, vmwCpuTable=vmwCpuTable, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetEntry=vmwNetEntry, vmwObsMIBGroups=vmwObsMIBGroups, vmkLoaded=vmkLoaded, vmSuspended=vmSuspended, vmwNetIdx=vmwNetIdx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemVMID=vmwMemVMID, vmHBLost=vmHBLost, vmwNumReads=vmwNumReads, vmwDiskShares=vmwDiskShares, vpxdNewStatus=vpxdNewStatus, vmPoweredOn=vmPoweredOn, vmHBDetected=vmHBDetected, vpxdTrap=vpxdTrap, vpxdOldStatus=vpxdOldStatus, vmwCpuEntry=vmwCpuEntry, vmwKbRead=vmwKbRead, vmwNumWrites=vmwNumWrites, vpxdObjValue=vpxdObjValue, vmwNetPktsTx=vmwNetPktsTx, vpxdVMName=vpxdVMName, vmwNetKbRx=vmwNetKbRx, vpxdTrapType=vpxdTrapType, vpxdHostName=vpxdHostName, vmwNetIfAddr=vmwNetIfAddr, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetPktsRx=vmwNetPktsRx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemTable=vmwMemTable, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuVMID=vmwCpuVMID, vmwHbaVMID=vmwHbaVMID, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemUtil=vmwMemUtil, vmwNetName=vmwNetName, vmwKbWritten=vmwKbWritten, vmwNetVMID=vmwNetVMID, vmwNetTable=vmwNetTable, vmwNetHCKbTx=vmwNetHCKbTx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwHbaIdx=vmwHbaIdx, vmwNetShares=vmwNetShares, vmwMemConfigured=vmwMemConfigured, vmwHBATable=vmwHBATable, vmwMemEntry=vmwMemEntry, vmwNetHCPktsTx=vmwNetHCPktsTx)
