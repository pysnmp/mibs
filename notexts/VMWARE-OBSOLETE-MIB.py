...
NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, Gauge32, Counter32, iso, MibIdentifier, Integer32, Unsigned32, Counter64, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "Gauge32", "Counter32", "iso", "MibIdentifier", "Integer32", "Unsigned32", "Counter64", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwMemVMID=vmwMemVMID, vmHBLost=vmHBLost, vmwNetPktsTx=vmwNetPktsTx, vmwMemTable=vmwMemTable, vmwMemShares=vmwMemShares, vmHBDetected=vmHBDetected, vmwHbaVMID=vmwHbaVMID, vpxdHostName=vpxdHostName, vmwCpuShares=vmwCpuShares, vmwNetIfAddr=vmwNetIfAddr, vmwNetKbRx=vmwNetKbRx, vmPoweredOff=vmPoweredOff, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemEntry=vmwMemEntry, vmwMemUtil=vmwMemUtil, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuUtil=vmwCpuUtil, vmwObsoleteGroup=vmwObsoleteGroup, vmwHBATable=vmwHBATable, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwNetShares=vmwNetShares, vpxdVMName=vpxdVMName, vpxdTrap=vpxdTrap, vmPoweredOn=vmPoweredOn, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetPktsRx=vmwNetPktsRx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetKbTx=vmwNetKbTx, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwDiskShares=vmwDiskShares, vmSuspended=vmSuspended, vpxdTrapType=vpxdTrapType, vmwHBAEntry=vmwHBAEntry, vmwHbaName=vmwHbaName, vmwObsMIBGroups=vmwObsMIBGroups, vmwNetVMID=vmwNetVMID, vmwNetTable=vmwNetTable, vpxdOldStatus=vpxdOldStatus, vmwNumReads=vmwNumReads, vmwKbWritten=vmwKbWritten, vmwNetIdx=vmwNetIdx, vpxdObjValue=vpxdObjValue, vmwNumWrites=vmwNumWrites, vmwMemConfigured=vmwMemConfigured, vmwKbRead=vmwKbRead, vpxdNewStatus=vpxdNewStatus, vmwCpuTable=vmwCpuTable, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuVMID=vmwCpuVMID, vmwNetName=vmwNetName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwCpuEntry=vmwCpuEntry, vmwObsoleteMIB=vmwObsoleteMIB, vmwNetEntry=vmwNetEntry, vmkLoaded=vmkLoaded, vmwHbaIdx=vmwHbaIdx)
