...
Gauge32, MibIdentifier, NotificationType, Bits, Counter64, ModuleIdentity, TimeTicks, IpAddress, Counter32, Integer32, Unsigned32, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "NotificationType", "Bits", "Counter64", "ModuleIdentity", "TimeTicks", "IpAddress", "Counter32", "Integer32", "Unsigned32", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwNetHCPktsTx=vmwNetHCPktsTx, vmwDiskShares=vmwDiskShares, vmwCpuShares=vmwCpuShares, vmwNetVMID=vmwNetVMID, vmwNetKbRx=vmwNetKbRx, vpxdTrapType=vpxdTrapType, vpxdNewStatus=vpxdNewStatus, vmwMemConfigured=vmwMemConfigured, vmHBLost=vmHBLost, vmwNetKbTx=vmwNetKbTx, vmwHbaName=vmwHbaName, vpxdTrap=vpxdTrap, vmPoweredOff=vmPoweredOff, vpxdOldStatus=vpxdOldStatus, vmwNetIdx=vmwNetIdx, vmHBDetected=vmHBDetected, vpxdVMName=vpxdVMName, vmwHbaVMID=vmwHbaVMID, vmwCpuEntry=vmwCpuEntry, vmwNetIfAddr=vmwNetIfAddr, vmwMemEntry=vmwMemEntry, vmwKbWritten=vmwKbWritten, vmwHBAEntry=vmwHBAEntry, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwObsMIBGroups=vmwObsMIBGroups, vmwMemTable=vmwMemTable, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmkLoaded=vmkLoaded, vmwNumReads=vmwNumReads, vpxdObjValue=vpxdObjValue, vmwKbRead=vmwKbRead, vmwMemUtil=vmwMemUtil, vmSuspended=vmSuspended, vmwNetTable=vmwNetTable, vmwHbaIdx=vmwHbaIdx, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwCpuVMID=vmwCpuVMID, vmwCpuTable=vmwCpuTable, vmwCpuUtil=vmwCpuUtil, vmwObsoleteMIB=vmwObsoleteMIB, vmwNumWrites=vmwNumWrites, vmwNetEntry=vmwNetEntry, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemVMID=vmwMemVMID, vmwHBATable=vmwHBATable, vmwNetShares=vmwNetShares, vmwObsoleteGroup=vmwObsoleteGroup, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwNetPktsRx=vmwNetPktsRx, vmPoweredOn=vmPoweredOn, vpxdHostName=vpxdHostName, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetName=vmwNetName, vmwMemShares=vmwMemShares, vmwNetHCKbTx=vmwNetHCKbTx)
