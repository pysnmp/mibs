...
NotificationType, Counter32, ObjectIdentity, IpAddress, Integer32, Gauge32, Unsigned32, MibIdentifier, Bits, Counter64, iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "ObjectIdentity", "IpAddress", "Integer32", "Gauge32", "Unsigned32", "MibIdentifier", "Bits", "Counter64", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmPoweredOn=vmPoweredOn, vmwCpuUtil=vmwCpuUtil, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwNetVMID=vmwNetVMID, vmwMemUtil=vmwMemUtil, vmkLoaded=vmkLoaded, vpxdTrapType=vpxdTrapType, vmwHbaVMID=vmwHbaVMID, vmwNetTable=vmwNetTable, vpxdTrap=vpxdTrap, vmwHbaIdx=vmwHbaIdx, vmwDiskShares=vmwDiskShares, vmwNetKbTx=vmwNetKbTx, vpxdVMName=vpxdVMName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwMemConfigured=vmwMemConfigured, vpxdObjValue=vpxdObjValue, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwCpuShares=vmwCpuShares, vmHBLost=vmHBLost, vmwNetIfAddr=vmwNetIfAddr, vmwMemShares=vmwMemShares, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwNetPktsTx=vmwNetPktsTx, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwObsMIBGroups=vmwObsMIBGroups, vmwHBAEntry=vmwHBAEntry, vmwNetName=vmwNetName, vmwHbaName=vmwHbaName, vmwNetPktsRx=vmwNetPktsRx, vmwNetKbRx=vmwNetKbRx, vpxdOldStatus=vpxdOldStatus, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwMemTable=vmwMemTable, vmwNumReads=vmwNumReads, vmwKbWritten=vmwKbWritten, vmwHBATable=vmwHBATable, vmHBDetected=vmHBDetected, vpxdNewStatus=vpxdNewStatus, vmwCpuEntry=vmwCpuEntry, vmwObsoleteGroup=vmwObsoleteGroup, vmwMemVMID=vmwMemVMID, vmwObsoleteMIB=vmwObsoleteMIB, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwMemEntry=vmwMemEntry, vmwKbRead=vmwKbRead, vmwCpuTable=vmwCpuTable, vmwNumWrites=vmwNumWrites, vmwNetHCKbTx=vmwNetHCKbTx, vmwNetIdx=vmwNetIdx, vmwNetHCKbRx=vmwNetHCKbRx, vmwNetShares=vmwNetShares, vpxdHostName=vpxdHostName, vmPoweredOff=vmPoweredOff, vmSuspended=vmSuspended, vmwNetEntry=vmwNetEntry, vmwCpuVMID=vmwCpuVMID)
