...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vmwKbWritten=vmwKbWritten, vmwMemConfigured=vmwMemConfigured, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwHBATable=vmwHBATable, vpxdHostName=vpxdHostName, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vpxdVMName=vpxdVMName, vmwCpuVMID=vmwCpuVMID, vmwMemUtil=vmwMemUtil, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmHBLost=vmHBLost, vmwHBAEntry=vmwHBAEntry, vmwNetEntry=vmwNetEntry, vmwNetKbTx=vmwNetKbTx, vpxdOldStatus=vpxdOldStatus, vmwHbaIdx=vmwHbaIdx, vmwDiskShares=vmwDiskShares, vmwNetVMID=vmwNetVMID, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteMIB=vmwObsoleteMIB, vmwCpuShares=vmwCpuShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwObsoleteGroup=vmwObsoleteGroup, vmwKbRead=vmwKbRead, vmwMemEntry=vmwMemEntry, vmwNumWrites=vmwNumWrites, vmwNetPktsRx=vmwNetPktsRx, vmwNetIfAddr=vmwNetIfAddr, vmSuspended=vmSuspended, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemShares=vmwMemShares, vmwCpuTable=vmwCpuTable, vmwHbaName=vmwHbaName, vmwMemVMID=vmwMemVMID, vmwHbaVMID=vmwHbaVMID, vmwNetIdx=vmwNetIdx, vmwNetName=vmwNetName, vpxdNewStatus=vpxdNewStatus, vmwNetShares=vmwNetShares, vmHBDetected=vmHBDetected, vmwNumReads=vmwNumReads, vpxdTrap=vpxdTrap, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemTable=vmwMemTable, vmwNetTable=vmwNetTable, vpxdObjValue=vpxdObjValue, vmwNetPktsTx=vmwNetPktsTx, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vpxdTrapType=vpxdTrapType, vmwNetKbRx=vmwNetKbRx, vmwNetHCKbRx=vmwNetHCKbRx, vmPoweredOn=vmPoweredOn, vmkLoaded=vmkLoaded, vmwNetHCPktsRx=vmwNetHCPktsRx, vmPoweredOff=vmPoweredOff, vmwCpuEntry=vmwCpuEntry, vmwCpuUtil=vmwCpuUtil)
