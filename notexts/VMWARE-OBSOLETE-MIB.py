...
mibBuilder.exportSymbols("VMWARE-OBSOLETE-MIB", vpxdHostName=vpxdHostName, vmwObsMIBGroups=vmwObsMIBGroups, vmwObsoleteMIBCompliances=vmwObsoleteMIBCompliances, vmwMemVMID=vmwMemVMID, vmwNetHCKbRx=vmwNetHCKbRx, vpxdOldStatus=vpxdOldStatus, vmkLoaded=vmkLoaded, vmwObsoleteGroup=vmwObsoleteGroup, vmwNetPktsTx=vmwNetPktsTx, vmPoweredOn=vmPoweredOn, vmwObsoleteMIB=vmwObsoleteMIB, vmwOldVCNotificationGroup=vmwOldVCNotificationGroup, vmwKbRead=vmwKbRead, vmwNetPktsRx=vmwNetPktsRx, vmwHbaVMID=vmwHbaVMID, vmwNetShares=vmwNetShares, vmHBDetected=vmHBDetected, vmwNetHCKbTx=vmwNetHCKbTx, vmwMemEntry=vmwMemEntry, vmwHBATable=vmwHBATable, vpxdObjValue=vpxdObjValue, vmwNetHCPktsTx=vmwNetHCPktsTx, vmwMemUtil=vmwMemUtil, vmwHbaName=vmwHbaName, vmwObsoleteMIBConformance=vmwObsoleteMIBConformance, vmwMemTable=vmwMemTable, vmwNetKbTx=vmwNetKbTx, vmwNetHCPktsRx=vmwNetHCPktsRx, vmwMemShares=vmwMemShares, vmwHbaIdx=vmwHbaIdx, vmwKbWritten=vmwKbWritten, vpxdNewStatus=vpxdNewStatus, vmwNetTable=vmwNetTable, vmwNetEntry=vmwNetEntry, vmwCpuVMID=vmwCpuVMID, vmwNumReads=vmwNumReads, vmwNetIfAddr=vmwNetIfAddr, vpxdVMName=vpxdVMName, vmwCpuEntry=vmwCpuEntry, vmwNetVMID=vmwNetVMID, vmwCpuUtil=vmwCpuUtil, vmHBLost=vmHBLost, vmwObsoleteObsoleteMIBCompliance=vmwObsoleteObsoleteMIBCompliance, vmwDiskShares=vmwDiskShares, vmwNetIdx=vmwNetIdx, vmPoweredOff=vmPoweredOff, vpxdTrap=vpxdTrap, vmwCpuTable=vmwCpuTable, vmwCpuShares=vmwCpuShares, PYSNMP_MODULE_ID=vmwObsoleteMIB, vmwNetName=vmwNetName, vpxdTrapType=vpxdTrapType, vmwHBAEntry=vmwHBAEntry, vmwMemConfigured=vmwMemConfigured, vmSuspended=vmSuspended, vmwNetKbRx=vmwNetKbRx, vmwNumWrites=vmwNumWrites)
