...
mibBuilder.exportSymbols("BASIS-MIB", rpmPort=rpmPort, axisDiagnostics=axisDiagnostics, axisSvc=axisSvc, frPortCnfX21PortGrp=frPortCnfX21PortGrp, cesmChan=cesmChan, bbIfCnfResPartGrp=bbIfCnfResPartGrp, bbChan=bbChan, plcp=plcp, virtualInterface=virtualInterface, atmAddressRegistration=atmAddressRegistration, frChan=frChan, rpmInterface=rpmInterface, bbChanCntGrp=bbChanCntGrp, bbInterface=bbInterface, bbChanCnfGrp=bbChanCnfGrp, ausmPortCnf=ausmPortCnf, basisShelf=basisShelf, basisAsm=basisAsm, PYSNMP_MODULE_ID=basisMIB, dsx0Vism=dsx0Vism, basisSystem=basisSystem, dsx1=dsx1, dsx1Framing=dsx1Framing, atmLmiSignaling=atmLmiSignaling, basisMIB=basisMIB, frPortCnfResPartGrp=frPortCnfResPartGrp, frPortCntSig=frPortCntSig, basisLines=basisLines, sna=sna, cardSpecific=cardSpecific, vismPort=vismPort, atmLineCnfGrp=atmLineCnfGrp, dsx3=dsx3, frPortCnf=frPortCnf, dsx1Line=dsx1Line, circuitEmulation=circuitEmulation, par=par, ausmPortCnt=ausmPortCnt, frPort=frPort, rpmChanGrp=rpmChanGrp, x21=x21, atm=atm, snaportCnfSig=snaportCnfSig, axisRedundancy=axisRedundancy, dsx1Plcp=dsx1Plcp, dsx3Line=dsx3Line, cardGeneric=cardGeneric, basisServices=basisServices, rpmChan=rpmChan, cwsonetObjects=cwsonetObjects, basis=basis, frameRelay=frameRelay, ausmPort=ausmPort, voice=voice, bbIfCnt=bbIfCnt, frPortCnfSig=frPortCnfSig, dsx3Framing=dsx3Framing, vismChanCnfGrp=vismChanCnfGrp, snaport=snaport, vismChanGrp=vismChanGrp, ausmChan=ausmChan, frPortServiceQueGrp=frPortServiceQueGrp, bbChanStateGrp=bbChanStateGrp, snaportCnt=snaportCnt, bbIfStateGrp=bbIfStateGrp, bbIfCnf=bbIfCnf, atmLineCntGrp=atmLineCntGrp, atmLines=atmLines, sonet=sonet, frPortCnt=frPortCnt, snaPortCntSig=snaPortCntSig, snaportCnf=snaportCnf)
