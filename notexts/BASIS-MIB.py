...
mibBuilder.exportSymbols("BASIS-MIB", axisRedundancy=axisRedundancy, axisSvc=axisSvc, frPortCnf=frPortCnf, frPortCnfResPartGrp=frPortCnfResPartGrp, cardGeneric=cardGeneric, circuitEmulation=circuitEmulation, cwsonetObjects=cwsonetObjects, dsx3Framing=dsx3Framing, frPortCntSig=frPortCntSig, atm=atm, ausmPortCnf=ausmPortCnf, basis=basis, snaportCnt=snaportCnt, frameRelay=frameRelay, rpmInterface=rpmInterface, dsx0Vism=dsx0Vism, bbChanCntGrp=bbChanCntGrp, atmLmiSignaling=atmLmiSignaling, snaPortCntSig=snaPortCntSig, frPortCnfSig=frPortCnfSig, snaport=snaport, frPort=frPort, snaportCnfSig=snaportCnfSig, dsx1Plcp=dsx1Plcp, atmLines=atmLines, axisDiagnostics=axisDiagnostics, dsx3=dsx3, atmAddressRegistration=atmAddressRegistration, bbChanCnfGrp=bbChanCnfGrp, cardSpecific=cardSpecific, vismChanGrp=vismChanGrp, bbChanStateGrp=bbChanStateGrp, dsx1Framing=dsx1Framing, atmLineCntGrp=atmLineCntGrp, snaportCnf=snaportCnf, virtualInterface=virtualInterface, atmLineCnfGrp=atmLineCnfGrp, bbIfCnfResPartGrp=bbIfCnfResPartGrp, bbIfCnt=bbIfCnt, par=par, basisAsm=basisAsm, basisLines=basisLines, ausmPortCnt=ausmPortCnt, sna=sna, dsx3Line=dsx3Line, frChan=frChan, frPortCnfX21PortGrp=frPortCnfX21PortGrp, voice=voice, vismPort=vismPort, bbIfCnf=bbIfCnf, basisSystem=basisSystem, sonet=sonet, plcp=plcp, rpmPort=rpmPort, ausmPort=ausmPort, rpmChan=rpmChan, PYSNMP_MODULE_ID=basisMIB, bbInterface=bbInterface, basisShelf=basisShelf, frPortCnt=frPortCnt, bbIfStateGrp=bbIfStateGrp, rpmChanGrp=rpmChanGrp, frPortServiceQueGrp=frPortServiceQueGrp, basisMIB=basisMIB, basisServices=basisServices, dsx1Line=dsx1Line, dsx1=dsx1, cesmChan=cesmChan, x21=x21, ausmChan=ausmChan, vismChanCnfGrp=vismChanCnfGrp, bbChan=bbChan)
