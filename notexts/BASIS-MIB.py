...
mibBuilder.exportSymbols("BASIS-MIB", dsx3=dsx3, frPortCnt=frPortCnt, vismPort=vismPort, atmLineCnfGrp=atmLineCnfGrp, frameRelay=frameRelay, frPort=frPort, basisAsm=basisAsm, ausmPort=ausmPort, atmLineCntGrp=atmLineCntGrp, dsx3Line=dsx3Line, basisMIB=basisMIB, frChan=frChan, frPortCntSig=frPortCntSig, x21=x21, ausmChan=ausmChan, axisSvc=axisSvc, frPortServiceQueGrp=frPortServiceQueGrp, basisLines=basisLines, dsx1Plcp=dsx1Plcp, cardSpecific=cardSpecific, rpmInterface=rpmInterface, dsx3Framing=dsx3Framing, bbChanStateGrp=bbChanStateGrp, rpmChan=rpmChan, frPortCnfX21PortGrp=frPortCnfX21PortGrp, plcp=plcp, virtualInterface=virtualInterface, bbChanCnfGrp=bbChanCnfGrp, rpmPort=rpmPort, cwsonetObjects=cwsonetObjects, dsx1Line=dsx1Line, bbIfCnfResPartGrp=bbIfCnfResPartGrp, PYSNMP_MODULE_ID=basisMIB, cardGeneric=cardGeneric, snaportCnf=snaportCnf, dsx0Vism=dsx0Vism, circuitEmulation=circuitEmulation, vismChanGrp=vismChanGrp, atmLmiSignaling=atmLmiSignaling, basisShelf=basisShelf, par=par, rpmChanGrp=rpmChanGrp, cesmChan=cesmChan, snaportCnfSig=snaportCnfSig, axisDiagnostics=axisDiagnostics, frPortCnf=frPortCnf, axisRedundancy=axisRedundancy, frPortCnfResPartGrp=frPortCnfResPartGrp, bbChan=bbChan, atmLines=atmLines, snaport=snaport, snaPortCntSig=snaPortCntSig, bbIfCnf=bbIfCnf, bbChanCntGrp=bbChanCntGrp, sonet=sonet, dsx1Framing=dsx1Framing, bbInterface=bbInterface, basisServices=basisServices, frPortCnfSig=frPortCnfSig, bbIfStateGrp=bbIfStateGrp, voice=voice, bbIfCnt=bbIfCnt, ausmPortCnt=ausmPortCnt, basis=basis, dsx1=dsx1, atmAddressRegistration=atmAddressRegistration, sna=sna, atm=atm, snaportCnt=snaportCnt, basisSystem=basisSystem, vismChanCnfGrp=vismChanCnfGrp, ausmPortCnf=ausmPortCnf)
