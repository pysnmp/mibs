...
mibBuilder.exportSymbols("BASIS-MIB", x21=x21, axisSvc=axisSvc, frPortCnfSig=frPortCnfSig, snaportCnt=snaportCnt, vismPort=vismPort, vismChanCnfGrp=vismChanCnfGrp, virtualInterface=virtualInterface, frPortCntSig=frPortCntSig, atmLineCntGrp=atmLineCntGrp, basisServices=basisServices, basisShelf=basisShelf, axisRedundancy=axisRedundancy, frPortCnfResPartGrp=frPortCnfResPartGrp, bbInterface=bbInterface, rpmInterface=rpmInterface, basis=basis, snaport=snaport, rpmChan=rpmChan, cardSpecific=cardSpecific, par=par, dsx1Framing=dsx1Framing, atmLmiSignaling=atmLmiSignaling, plcp=plcp, bbChan=bbChan, atm=atm, bbChanStateGrp=bbChanStateGrp, atmLineCnfGrp=atmLineCnfGrp, bbIfCnf=bbIfCnf, frPortCnf=frPortCnf, ausmPortCnt=ausmPortCnt, axisDiagnostics=axisDiagnostics, vismChanGrp=vismChanGrp, frChan=frChan, ausmChan=ausmChan, cesmChan=cesmChan, dsx0Vism=dsx0Vism, dsx3=dsx3, PYSNMP_MODULE_ID=basisMIB, basisLines=basisLines, dsx3Line=dsx3Line, basisSystem=basisSystem, bbIfStateGrp=bbIfStateGrp, frPortCnt=frPortCnt, dsx3Framing=dsx3Framing, cwsonetObjects=cwsonetObjects, frPortServiceQueGrp=frPortServiceQueGrp, rpmPort=rpmPort, circuitEmulation=circuitEmulation, bbIfCnt=bbIfCnt, bbIfCnfResPartGrp=bbIfCnfResPartGrp, ausmPortCnf=ausmPortCnf, ausmPort=ausmPort, sonet=sonet, dsx1Plcp=dsx1Plcp, basisMIB=basisMIB, frPort=frPort, frPortCnfX21PortGrp=frPortCnfX21PortGrp, snaportCnf=snaportCnf, basisAsm=basisAsm, snaPortCntSig=snaPortCntSig, atmAddressRegistration=atmAddressRegistration, dsx1Line=dsx1Line, snaportCnfSig=snaportCnfSig, rpmChanGrp=rpmChanGrp, atmLines=atmLines, bbChanCntGrp=bbChanCntGrp, bbChanCnfGrp=bbChanCnfGrp, frameRelay=frameRelay, sna=sna, voice=voice, cardGeneric=cardGeneric, dsx1=dsx1)
