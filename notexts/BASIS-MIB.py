...
mibBuilder.exportSymbols("BASIS-MIB", bbChanCnfGrp=bbChanCnfGrp, frPortCnt=frPortCnt, basisLines=basisLines, frPortServiceQueGrp=frPortServiceQueGrp, snaportCnf=snaportCnf, bbChan=bbChan, axisSvc=axisSvc, snaportCnfSig=snaportCnfSig, dsx3Line=dsx3Line, virtualInterface=virtualInterface, frPortCntSig=frPortCntSig, axisRedundancy=axisRedundancy, ausmPort=ausmPort, ausmPortCnt=ausmPortCnt, cwsonetObjects=cwsonetObjects, atmLineCnfGrp=atmLineCnfGrp, dsx1Plcp=dsx1Plcp, basisShelf=basisShelf, dsx3Framing=dsx3Framing, plcp=plcp, dsx0Vism=dsx0Vism, axisDiagnostics=axisDiagnostics, frPort=frPort, frPortCnfSig=frPortCnfSig, bbChanStateGrp=bbChanStateGrp, frPortCnf=frPortCnf, vismPort=vismPort, bbChanCntGrp=bbChanCntGrp, sonet=sonet, sna=sna, par=par, ausmChan=ausmChan, dsx1Line=dsx1Line, frChan=frChan, rpmInterface=rpmInterface, dsx1Framing=dsx1Framing, frPortCnfResPartGrp=frPortCnfResPartGrp, snaportCnt=snaportCnt, dsx3=dsx3, vismChanGrp=vismChanGrp, atmLines=atmLines, atmLmiSignaling=atmLmiSignaling, bbIfCnt=bbIfCnt, frameRelay=frameRelay, basisMIB=basisMIB, basisAsm=basisAsm, frPortCnfX21PortGrp=frPortCnfX21PortGrp, basisSystem=basisSystem, cesmChan=cesmChan, vismChanCnfGrp=vismChanCnfGrp, snaport=snaport, ausmPortCnf=ausmPortCnf, rpmChan=rpmChan, atmLineCntGrp=atmLineCntGrp, bbIfCnfResPartGrp=bbIfCnfResPartGrp, atm=atm, dsx1=dsx1, basis=basis, x21=x21, bbIfCnf=bbIfCnf, bbIfStateGrp=bbIfStateGrp, PYSNMP_MODULE_ID=basisMIB, cardSpecific=cardSpecific, basisServices=basisServices, cardGeneric=cardGeneric, circuitEmulation=circuitEmulation, voice=voice, rpmChanGrp=rpmChanGrp, bbInterface=bbInterface, snaPortCntSig=snaPortCntSig, atmAddressRegistration=atmAddressRegistration, rpmPort=rpmPort)
