...
mibBuilder.exportSymbols("BASIS-MIB", bbChanStateGrp=bbChanStateGrp, frPortCnfX21PortGrp=frPortCnfX21PortGrp, dsx1=dsx1, bbChanCnfGrp=bbChanCnfGrp, snaportCnt=snaportCnt, dsx1Plcp=dsx1Plcp, snaport=snaport, dsx0Vism=dsx0Vism, bbIfCnf=bbIfCnf, atmLineCnfGrp=atmLineCnfGrp, ausmPortCnf=ausmPortCnf, plcp=plcp, frPortCntSig=frPortCntSig, rpmPort=rpmPort, bbChan=bbChan, dsx3Framing=dsx3Framing, basisServices=basisServices, axisSvc=axisSvc, cardGeneric=cardGeneric, basisAsm=basisAsm, vismChanGrp=vismChanGrp, atmLineCntGrp=atmLineCntGrp, cardSpecific=cardSpecific, basis=basis, sna=sna, par=par, basisSystem=basisSystem, dsx1Line=dsx1Line, axisRedundancy=axisRedundancy, dsx1Framing=dsx1Framing, rpmChan=rpmChan, bbIfCnt=bbIfCnt, basisShelf=basisShelf, atm=atm, cwsonetObjects=cwsonetObjects, basisLines=basisLines, cesmChan=cesmChan, atmLmiSignaling=atmLmiSignaling, vismPort=vismPort, bbIfStateGrp=bbIfStateGrp, bbChanCntGrp=bbChanCntGrp, dsx3Line=dsx3Line, ausmChan=ausmChan, frameRelay=frameRelay, frPort=frPort, atmAddressRegistration=atmAddressRegistration, snaPortCntSig=snaPortCntSig, PYSNMP_MODULE_ID=basisMIB, frChan=frChan, bbInterface=bbInterface, bbIfCnfResPartGrp=bbIfCnfResPartGrp, circuitEmulation=circuitEmulation, x21=x21, snaportCnf=snaportCnf, frPortServiceQueGrp=frPortServiceQueGrp, frPortCnfSig=frPortCnfSig, sonet=sonet, rpmInterface=rpmInterface, frPortCnfResPartGrp=frPortCnfResPartGrp, vismChanCnfGrp=vismChanCnfGrp, ausmPort=ausmPort, frPortCnt=frPortCnt, ausmPortCnt=ausmPortCnt, basisMIB=basisMIB, voice=voice, dsx3=dsx3, rpmChanGrp=rpmChanGrp, snaportCnfSig=snaportCnfSig, frPortCnf=frPortCnf, virtualInterface=virtualInterface, axisDiagnostics=axisDiagnostics, atmLines=atmLines)
