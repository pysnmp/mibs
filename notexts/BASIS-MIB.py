...
mibBuilder.exportSymbols("BASIS-MIB", ausmPort=ausmPort, bbIfCnt=bbIfCnt, vismChanCnfGrp=vismChanCnfGrp, bbIfCnfResPartGrp=bbIfCnfResPartGrp, frPortCnt=frPortCnt, voice=voice, cardSpecific=cardSpecific, frPortCnfX21PortGrp=frPortCnfX21PortGrp, basisLines=basisLines, cwsonetObjects=cwsonetObjects, axisDiagnostics=axisDiagnostics, rpmInterface=rpmInterface, circuitEmulation=circuitEmulation, basisSystem=basisSystem, dsx1=dsx1, frPort=frPort, frPortCntSig=frPortCntSig, sna=sna, snaport=snaport, axisRedundancy=axisRedundancy, sonet=sonet, bbChan=bbChan, plcp=plcp, frPortCnfResPartGrp=frPortCnfResPartGrp, bbChanCnfGrp=bbChanCnfGrp, cesmChan=cesmChan, frPortServiceQueGrp=frPortServiceQueGrp, atmLines=atmLines, basis=basis, PYSNMP_MODULE_ID=basisMIB, snaPortCntSig=snaPortCntSig, axisSvc=axisSvc, atmLineCntGrp=atmLineCntGrp, basisMIB=basisMIB, ausmPortCnt=ausmPortCnt, par=par, atmAddressRegistration=atmAddressRegistration, rpmChan=rpmChan, rpmPort=rpmPort, vismChanGrp=vismChanGrp, virtualInterface=virtualInterface, dsx0Vism=dsx0Vism, dsx3=dsx3, atm=atm, snaportCnfSig=snaportCnfSig, basisServices=basisServices, bbInterface=bbInterface, bbChanStateGrp=bbChanStateGrp, bbChanCntGrp=bbChanCntGrp, atmLineCnfGrp=atmLineCnfGrp, rpmChanGrp=rpmChanGrp, frameRelay=frameRelay, frPortCnf=frPortCnf, basisAsm=basisAsm, basisShelf=basisShelf, x21=x21, dsx1Plcp=dsx1Plcp, atmLmiSignaling=atmLmiSignaling, dsx1Line=dsx1Line, snaportCnt=snaportCnt, cardGeneric=cardGeneric, dsx1Framing=dsx1Framing, dsx3Line=dsx3Line, frChan=frChan, ausmChan=ausmChan, snaportCnf=snaportCnf, vismPort=vismPort, frPortCnfSig=frPortCnfSig, ausmPortCnf=ausmPortCnf, bbIfCnf=bbIfCnf, bbIfStateGrp=bbIfStateGrp, dsx3Framing=dsx3Framing)
