...
mibBuilder.exportSymbols("BASIS-MIB", cardGeneric=cardGeneric, axisSvc=axisSvc, rpmPort=rpmPort, bbIfStateGrp=bbIfStateGrp, snaportCnt=snaportCnt, vismChanCnfGrp=vismChanCnfGrp, basisShelf=basisShelf, vismPort=vismPort, rpmChan=rpmChan, basisSystem=basisSystem, snaPortCntSig=snaPortCntSig, virtualInterface=virtualInterface, dsx3Line=dsx3Line, frPortCnfResPartGrp=frPortCnfResPartGrp, cardSpecific=cardSpecific, dsx1Framing=dsx1Framing, plcp=plcp, bbChanCnfGrp=bbChanCnfGrp, atmLines=atmLines, bbIfCnfResPartGrp=bbIfCnfResPartGrp, dsx1=dsx1, dsx1Line=dsx1Line, cwsonetObjects=cwsonetObjects, par=par, sonet=sonet, bbInterface=bbInterface, frChan=frChan, bbChanCntGrp=bbChanCntGrp, axisDiagnostics=axisDiagnostics, rpmChanGrp=rpmChanGrp, basisAsm=basisAsm, frPortCnfX21PortGrp=frPortCnfX21PortGrp, basisServices=basisServices, atmAddressRegistration=atmAddressRegistration, dsx0Vism=dsx0Vism, sna=sna, circuitEmulation=circuitEmulation, bbIfCnt=bbIfCnt, voice=voice, vismChanGrp=vismChanGrp, rpmInterface=rpmInterface, x21=x21, atm=atm, PYSNMP_MODULE_ID=basisMIB, basisMIB=basisMIB, frPortServiceQueGrp=frPortServiceQueGrp, bbIfCnf=bbIfCnf, basisLines=basisLines, dsx3=dsx3, cesmChan=cesmChan, ausmPortCnf=ausmPortCnf, bbChan=bbChan, frPortCnfSig=frPortCnfSig, frPort=frPort, snaportCnf=snaportCnf, ausmChan=ausmChan, bbChanStateGrp=bbChanStateGrp, dsx3Framing=dsx3Framing, frPortCnt=frPortCnt, ausmPortCnt=ausmPortCnt, atmLineCnfGrp=atmLineCnfGrp, frPortCnf=frPortCnf, atmLineCntGrp=atmLineCntGrp, snaport=snaport, atmLmiSignaling=atmLmiSignaling, dsx1Plcp=dsx1Plcp, axisRedundancy=axisRedundancy, basis=basis, frameRelay=frameRelay, ausmPort=ausmPort, snaportCnfSig=snaportCnfSig, frPortCntSig=frPortCntSig)
