...
mibBuilder.exportSymbols("BASIS-MIB", basis=basis, axisRedundancy=axisRedundancy, snaportCnt=snaportCnt, frPortCnfResPartGrp=frPortCnfResPartGrp, rpmInterface=rpmInterface, bbChanCntGrp=bbChanCntGrp, frPortServiceQueGrp=frPortServiceQueGrp, snaportCnf=snaportCnf, virtualInterface=virtualInterface, ausmPortCnt=ausmPortCnt, dsx0Vism=dsx0Vism, bbChanCnfGrp=bbChanCnfGrp, rpmPort=rpmPort, dsx3=dsx3, atmLmiSignaling=atmLmiSignaling, snaport=snaport, cardGeneric=cardGeneric, atmLineCnfGrp=atmLineCnfGrp, sonet=sonet, cesmChan=cesmChan, plcp=plcp, snaportCnfSig=snaportCnfSig, bbIfCnt=bbIfCnt, axisDiagnostics=axisDiagnostics, dsx3Framing=dsx3Framing, vismChanCnfGrp=vismChanCnfGrp, PYSNMP_MODULE_ID=basisMIB, basisAsm=basisAsm, basisShelf=basisShelf, dsx3Line=dsx3Line, frameRelay=frameRelay, frPort=frPort, basisMIB=basisMIB, cwsonetObjects=cwsonetObjects, ausmChan=ausmChan, bbIfCnfResPartGrp=bbIfCnfResPartGrp, ausmPort=ausmPort, axisSvc=axisSvc, basisLines=basisLines, bbInterface=bbInterface, bbChanStateGrp=bbChanStateGrp, x21=x21, dsx1Plcp=dsx1Plcp, frPortCnt=frPortCnt, vismPort=vismPort, atm=atm, rpmChan=rpmChan, basisSystem=basisSystem, dsx1Framing=dsx1Framing, snaPortCntSig=snaPortCntSig, bbChan=bbChan, voice=voice, atmLineCntGrp=atmLineCntGrp, par=par, frPortCnfX21PortGrp=frPortCnfX21PortGrp, rpmChanGrp=rpmChanGrp, frPortCnf=frPortCnf, frPortCnfSig=frPortCnfSig, ausmPortCnf=ausmPortCnf, frPortCntSig=frPortCntSig, dsx1=dsx1, atmAddressRegistration=atmAddressRegistration, cardSpecific=cardSpecific, circuitEmulation=circuitEmulation, sna=sna, basisServices=basisServices, vismChanGrp=vismChanGrp, atmLines=atmLines, bbIfCnf=bbIfCnf, frChan=frChan, bbIfStateGrp=bbIfStateGrp, dsx1Line=dsx1Line)
