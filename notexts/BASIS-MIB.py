...
mibBuilder.exportSymbols("BASIS-MIB", dsx1Plcp=dsx1Plcp, atm=atm, bbIfCnfResPartGrp=bbIfCnfResPartGrp, frPortCnfResPartGrp=frPortCnfResPartGrp, ausmChan=ausmChan, dsx1=dsx1, basisLines=basisLines, virtualInterface=virtualInterface, dsx0Vism=dsx0Vism, sna=sna, basisShelf=basisShelf, basisSystem=basisSystem, atmLineCnfGrp=atmLineCnfGrp, bbIfCnf=bbIfCnf, bbChanCnfGrp=bbChanCnfGrp, atmLmiSignaling=atmLmiSignaling, ausmPortCnf=ausmPortCnf, rpmChanGrp=rpmChanGrp, frPortCnfX21PortGrp=frPortCnfX21PortGrp, x21=x21, bbInterface=bbInterface, vismPort=vismPort, rpmChan=rpmChan, cardGeneric=cardGeneric, atmAddressRegistration=atmAddressRegistration, basisMIB=basisMIB, voice=voice, atmLineCntGrp=atmLineCntGrp, frChan=frChan, par=par, bbChan=bbChan, dsx1Line=dsx1Line, bbChanStateGrp=bbChanStateGrp, sonet=sonet, dsx1Framing=dsx1Framing, basisAsm=basisAsm, frPort=frPort, frPortCnf=frPortCnf, ausmPort=ausmPort, cesmChan=cesmChan, snaPortCntSig=snaPortCntSig, frameRelay=frameRelay, vismChanCnfGrp=vismChanCnfGrp, dsx3Line=dsx3Line, bbIfCnt=bbIfCnt, bbChanCntGrp=bbChanCntGrp, dsx3=dsx3, snaportCnf=snaportCnf, frPortServiceQueGrp=frPortServiceQueGrp, axisDiagnostics=axisDiagnostics, axisSvc=axisSvc, basis=basis, axisRedundancy=axisRedundancy, PYSNMP_MODULE_ID=basisMIB, cardSpecific=cardSpecific, basisServices=basisServices, frPortCnfSig=frPortCnfSig, frPortCnt=frPortCnt, ausmPortCnt=ausmPortCnt, snaport=snaport, vismChanGrp=vismChanGrp, cwsonetObjects=cwsonetObjects, circuitEmulation=circuitEmulation, frPortCntSig=frPortCntSig, atmLines=atmLines, bbIfStateGrp=bbIfStateGrp, plcp=plcp, rpmInterface=rpmInterface, dsx3Framing=dsx3Framing, rpmPort=rpmPort, snaportCnfSig=snaportCnfSig, snaportCnt=snaportCnt)
