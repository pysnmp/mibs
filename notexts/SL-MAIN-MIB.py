...
Gauge32, Opaque, NotificationType, ObjectIdentity, Counter32, ModuleIdentity, Integer32, Counter64, IpAddress, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Opaque", "NotificationType", "ObjectIdentity", "Counter32", "ModuleIdentity", "Integer32", "Counter64", "IpAddress", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "MibIdentifier")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmNetworkMode=slmNetworkMode, slmTrapLogParam2=slmTrapLogParam2, slmChPassLogin=slmChPassLogin, slmPmAvailable=slmPmAvailable, slmReadCommunity=slmReadCommunity, slmTrapLogParam1=slmTrapLogParam1, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysName=slmSysName, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseEntry=slmLicenseEntry, slmTrapDestAddress=slmTrapDestAddress, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysTrapFormat=slmSysTrapFormat, slmLogin=slmLogin, slmSysIpAddr=slmSysIpAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapEnable=slmTrapEnable, slmSyslogPort=slmSyslogPort, slmChPassOldPass=slmChPassOldPass, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuthEntry=slmAuthEntry, slmPortsNumber=slmPortsNumber, slmVcatDelay=slmVcatDelay, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmRebootDelay=slmRebootDelay, slmSnmpv3Password=slmSnmpv3Password, slmAdminRowStatus=slmAdminRowStatus, slmBoxSize=slmBoxSize, slmChPass=slmChPass, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmChPassTable=slmChPassTable, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogEntry=slmTrapLogEntry, slmSysAlmAct=slmSysAlmAct, slmTrapLogParam5=slmTrapLogParam5, slmAuth=slmAuth, slmConfigSysSignalType=slmConfigSysSignalType, slmSysMode=slmSysMode, slmTrapUserAccess=slmTrapUserAccess, slmAdminTable=slmAdminTable, slmTrapDestTable=slmTrapDestTable, slmSysLocation=slmSysLocation, slmTrapLogId=slmTrapLogId, UserPassword=UserPassword, slmSyslogLevel=slmSyslogLevel, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevDate=slmSwRevDate, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicense=slmLicense, slmSysActiveSwVersion=slmSysActiveSwVersion, UserCommunity=UserCommunity, slmSysUplinkRate=slmSysUplinkRate, slmLicenseIndex=slmLicenseIndex, slmMuxNumber=slmMuxNumber, slmTrap=slmTrap, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam6=slmTrapLogParam6, slmAdminEntry=slmAdminEntry, slm40GConf=slm40GConf, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTid=slmTid, slmChPassEntry=slmChPassEntry, slmSysResetPm=slmSysResetPm, slmAuthTable=slmAuthTable, slmConfigSysUptime=slmConfigSysUptime, slMain=slMain, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSwRevEntry=slmSwRevEntry, slmAdminPassword=slmAdminPassword, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, UserLogin=UserLogin, slmSysAdminStatus=slmSysAdminStatus, slmSwRevStatus=slmSwRevStatus, slmLicenseExpiration=slmLicenseExpiration, slmRstpEnabled=slmRstpEnabled, slmAdminAccess=slmAdminAccess, PYSNMP_MODULE_ID=slMain, slmSysTemperature=slmSysTemperature, slmAdminCommunity=slmAdminCommunity, slmChPassNewPass=slmChPassNewPass, slmTrapLogTable=slmTrapLogTable, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestEntry=slmTrapDestEntry, slmTrapUserLogin=slmTrapUserLogin, slmAdminLogin=slmAdminLogin, slmLogFile=slmLogFile, slmConfigFile=slmConfigFile, slmAuthPassword=slmAuthPassword, slmSysOperStatus=slmSysOperStatus, slmPsuNumber=slmPsuNumber, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestProtVersion=slmTrapDestProtVersion, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam4=slmTrapLogParam4, slmSysChassisId=slmSysChassisId, slmSys=slmSys, slmAdmin=slmAdmin, slmSysSnmpVersion=slmSysSnmpVersion, slmSysAlmDeact=slmSysAlmDeact, slmLicenseTable=slmLicenseTable, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestCommunity=slmTrapDestCommunity, slmLicenseId=slmLicenseId, slmSyslogDestAddress=slmSyslogDestAddress, slmSwRevName=slmSwRevName, slmSysLanIpAddr=slmSysLanIpAddr, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogName=slmTrapLogName, slmAuthLogin=slmAuthLogin, slmTrapCommunity=slmTrapCommunity, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSwRevTable=slmSwRevTable, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam3=slmTrapLogParam3, AdminAccess=AdminAccess, slmTrapPort=slmTrapPort, SoftwareRevision=SoftwareRevision, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSnmpv3Auth=slmSnmpv3Auth, slmOemType=slmOemType)
