...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogParam6=slmTrapLogParam6, slmEdfaNumber=slmEdfaNumber, slmLogin=slmLogin, slmChPassLogin=slmChPassLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminRowStatus=slmAdminRowStatus, slmSysAdminStatus=slmSysAdminStatus, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogParam5=slmTrapLogParam5, slmTrapEnable=slmTrapEnable, slmSyslogPort=slmSyslogPort, slmSysSnmpVersion=slmSysSnmpVersion, slmSysTrapFormat=slmSysTrapFormat, SoftwareRevision=SoftwareRevision, slmTrapLogEntry=slmTrapLogEntry, slmSysOperStatus=slmSysOperStatus, slmTrapDestCommunity=slmTrapDestCommunity, slmAdminCommunity=slmAdminCommunity, slmLicenseId=slmLicenseId, slmTrapLogName=slmTrapLogName, slmSysMode=slmSysMode, slmPmAvailable=slmPmAvailable, slmTrapLogParam3=slmTrapLogParam3, slMain=slMain, slmRstpEnabled=slmRstpEnabled, slmSysAlmAct=slmSysAlmAct, slmChPassTable=slmChPassTable, slmTrapPort=slmTrapPort, slmChPassNewPass=slmChPassNewPass, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapCommunity=slmTrapCommunity, slm40GConf=slm40GConf, slmSysIpAddr=slmSysIpAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmRebootDelay=slmRebootDelay, slmSysLocation=slmSysLocation, slmSysAlmDeact=slmSysAlmDeact, slmAuthTable=slmAuthTable, slmPsuNumber=slmPsuNumber, slmChPass=slmChPass, slmVcatDelay=slmVcatDelay, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTopologyEnabled=slmTopologyEnabled, slmSysUplinkRate=slmSysUplinkRate, slmAdmin=slmAdmin, slmSwRevDirectory=slmSwRevDirectory, slmSwRevEntry=slmSwRevEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogParam4=slmTrapLogParam4, slmAuth=slmAuth, slmLicenseTable=slmLicenseTable, slmSnmpv3Priv=slmSnmpv3Priv, slmSysGatewayAddr=slmSysGatewayAddr, slmSnmpv3Password=slmSnmpv3Password, slmSysResetPm=slmSysResetPm, slmLicenseIndex=slmLicenseIndex, slmSyslogLevel=slmSyslogLevel, slmReadCommunity=slmReadCommunity, slmTid=slmTid, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSwRevDate=slmSwRevDate, slmTrap=slmTrap, slmTrapUserAccess=slmTrapUserAccess, slmAuthCommunity=slmAuthCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapUserLogin=slmTrapUserLogin, slmSwRevStatus=slmSwRevStatus, slmPortsNumber=slmPortsNumber, slmSyslogDestAddress=slmSyslogDestAddress, slmAuthPassword=slmAuthPassword, slmSwRevName=slmSwRevName, slmSysSubnetMask=slmSysSubnetMask, UserPassword=UserPassword, slmTrapLogTimeStamp=slmTrapLogTimeStamp, UserCommunity=UserCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmBoxSize=slmBoxSize, slmAdminEntry=slmAdminEntry, slmSysChassisId=slmSysChassisId, slmTrapLogTable=slmTrapLogTable, slmChPassEntry=slmChPassEntry, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogId=slmTrapLogId, UserLogin=UserLogin, slmSysLanIpAddr=slmSysLanIpAddr, slmAdminTable=slmAdminTable, slmAuthEntry=slmAuthEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSys=slmSys, slmAdminAccess=slmAdminAccess, slmNetworkMode=slmNetworkMode, slmWriteCommunity=slmWriteCommunity, AdminAccess=AdminAccess, slmTrapDestAddress=slmTrapDestAddress, slmLicenseEntry=slmLicenseEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmChPassOldPass=slmChPassOldPass, slmLogFile=slmLogFile, slmConfigSysUptime=slmConfigSysUptime, slmLicenseExpiration=slmLicenseExpiration, slmAdminPassword=slmAdminPassword, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapDestTable=slmTrapDestTable, slmConfigFile=slmConfigFile, slmSysCalendarTime=slmSysCalendarTime, slmSysTemperature=slmSysTemperature, slmSysName=slmSysName, PYSNMP_MODULE_ID=slMain, slmAdminLogin=slmAdminLogin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuthLogin=slmAuthLogin, slmTrapLogParam1=slmTrapLogParam1, slmLicense=slmLicense, slmConfigSysSignalType=slmConfigSysSignalType, slmMuxNumber=slmMuxNumber, slmSyslogDestTable=slmSyslogDestTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestEntry=slmTrapDestEntry, slmSwRevTable=slmSwRevTable, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmOemType=slmOemType, slmTrapDestRowStatus=slmTrapDestRowStatus)
