...
ObjectIdentity, Unsigned32, Counter64, Counter32, Integer32, ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Gauge32, iso, NotificationType, Bits, TimeTicks, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "Counter64", "Counter32", "Integer32", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Gauge32", "iso", "NotificationType", "Bits", "TimeTicks", "Opaque")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicenseTable=slmLicenseTable, slmAuthEntry=slmAuthEntry, slmOemType=slmOemType, slmSyslogDestTable=slmSyslogDestTable, slmChPassLogin=slmChPassLogin, slmConfigFile=slmConfigFile, SoftwareRevision=SoftwareRevision, slmSysCalendarTime=slmSysCalendarTime, slmTid=slmTid, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogParam4=slmTrapLogParam4, slmSysSubnetMask=slmSysSubnetMask, slmAdmin=slmAdmin, slmTrapEnable=slmTrapEnable, slmBoxSize=slmBoxSize, slmEdfaNumber=slmEdfaNumber, slmSysTrapFormat=slmSysTrapFormat, slmSyslogDestRowStatus=slmSyslogDestRowStatus, UserCommunity=UserCommunity, slmSysAlmDeact=slmSysAlmDeact, slmAuthLogin=slmAuthLogin, slmChPassEntry=slmChPassEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminLogin=slmAdminLogin, slmSys=slmSys, slmSysGatewayAddr=slmSysGatewayAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmReadCommunity=slmReadCommunity, slmSyslogLevel=slmSyslogLevel, slmLogin=slmLogin, slmSwRevDate=slmSwRevDate, slmSysAdminStatus=slmSysAdminStatus, slmAdminCommunity=slmAdminCommunity, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestTable=slmTrapDestTable, slmAuthPassword=slmAuthPassword, slmSyslogDestAddress=slmSyslogDestAddress, slmTrap=slmTrap, slmMuxNumber=slmMuxNumber, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmRstpEnabled=slmRstpEnabled, slmVcatDelay=slmVcatDelay, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysUplinkRate=slmSysUplinkRate, slmLicenseId=slmLicenseId, slmSysLanIpAddr=slmSysLanIpAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmPmAvailable=slmPmAvailable, slmChPassOldPass=slmChPassOldPass, slmSysNetworkPrefix=slmSysNetworkPrefix, slmPortsNumber=slmPortsNumber, slmAdminEntry=slmAdminEntry, slmTrapDestAddress=slmTrapDestAddress, slmSysIpAddr=slmSysIpAddr, slmSysOperStatus=slmSysOperStatus, slmTrapLogName=slmTrapLogName, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogId=slmTrapLogId, AdminAccess=AdminAccess, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapUserAccess=slmTrapUserAccess, slmSysLocation=slmSysLocation, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLogFile=slmLogFile, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapCommunity=slmTrapCommunity, slmConfigSysUptime=slmConfigSysUptime, slm40GConf=slm40GConf, slmTrapLogParam2=slmTrapLogParam2, slmTrapSysNameChange=slmTrapSysNameChange, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysTemperature=slmSysTemperature, slmTrapLogEntry=slmTrapLogEntry, slmAuthTable=slmAuthTable, slmTrapDestProtVersion=slmTrapDestProtVersion, PYSNMP_MODULE_ID=slMain, slmSysMode=slmSysMode, slmLicenseExpiration=slmLicenseExpiration, slmTopologyEnabled=slmTopologyEnabled, slmSwRevEntry=slmSwRevEntry, slmSwRevStatus=slmSwRevStatus, slmTrapLogTable=slmTrapLogTable, UserPassword=UserPassword, slmTrapDestEntry=slmTrapDestEntry, slmLicenseEntry=slmLicenseEntry, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogParam5=slmTrapLogParam5, slmChPass=slmChPass, slmTrapLogParam3=slmTrapLogParam3, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevName=slmSwRevName, slmAuth=slmAuth, slmSysResetPm=slmSysResetPm, slmSysChassisId=slmSysChassisId, slmAdminPassword=slmAdminPassword, slmLicense=slmLicense, UserLogin=UserLogin, slmAdminAccess=slmAdminAccess, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdminTable=slmAdminTable, slmPsuNumber=slmPsuNumber, slmSnmpv3Password=slmSnmpv3Password, slmTrapPort=slmTrapPort, slmTrapLogParam6=slmTrapLogParam6, slmSysSnmpVersion=slmSysSnmpVersion, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysName=slmSysName, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmChPassNewPass=slmChPassNewPass, slmAuthCommunity=slmAuthCommunity, slmLicenseIndex=slmLicenseIndex, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPassTable=slmChPassTable, slmAdminRowStatus=slmAdminRowStatus, slmSysAlmAct=slmSysAlmAct, slmSwRevTable=slmSwRevTable, slmWriteCommunity=slmWriteCommunity, slMain=slMain, slmNetworkMode=slmNetworkMode, slmTrapDestCommunity=slmTrapDestCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogPort=slmSyslogPort, slmRebootDelay=slmRebootDelay)
