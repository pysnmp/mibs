...
Integer32, Bits, Counter64, Opaque, iso, Counter32, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, NotificationType, TimeTicks, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "Counter64", "Opaque", "iso", "Counter32", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "NotificationType", "TimeTicks", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysChassisId=slmSysChassisId, slmTrapLogParam2=slmTrapLogParam2, PYSNMP_MODULE_ID=slMain, slmTrapEnable=slmTrapEnable, slmAdminTable=slmAdminTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTopologyEnabled=slmTopologyEnabled, slmLicense=slmLicense, slmBoxSize=slmBoxSize, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapCommunity=slmTrapCommunity, slmConfigSysUptime=slmConfigSysUptime, slmConfigFile=slmConfigFile, slmSysResetPm=slmSysResetPm, slmSysTemperature=slmSysTemperature, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogDestEntry=slmSyslogDestEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam4=slmTrapLogParam4, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogLevel=slmSyslogLevel, slmLicenseTable=slmLicenseTable, slmAdminLogin=slmAdminLogin, slmSwRevEntry=slmSwRevEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysAlmAct=slmSysAlmAct, slmTrapLogParam3=slmTrapLogParam3, slmSwRevDirectory=slmSwRevDirectory, slmLicenseExpiration=slmLicenseExpiration, slmPmAvailable=slmPmAvailable, slmTrapDestTable=slmTrapDestTable, slmSysOperStatus=slmSysOperStatus, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAuthEntry=slmAuthEntry, slmSys=slmSys, slmAuthTable=slmAuthTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysLocation=slmSysLocation, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysUplinkRate=slmSysUplinkRate, slmAdminAccess=slmAdminAccess, slmPortsNumber=slmPortsNumber, SoftwareRevision=SoftwareRevision, slmTrapDestCommunity=slmTrapDestCommunity, slmChPassEntry=slmChPassEntry, slmSysMode=slmSysMode, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestTable=slmSyslogDestTable, slmChPassLogin=slmChPassLogin, slmTrapPort=slmTrapPort, slmLicenseEntry=slmLicenseEntry, slmOemType=slmOemType, UserPassword=UserPassword, slmRstpEnabled=slmRstpEnabled, slmSysName=slmSysName, slmTrapDestRowStatus=slmTrapDestRowStatus, slmNetworkMode=slmNetworkMode, slmAuthLogin=slmAuthLogin, slmTid=slmTid, slmAdminRowStatus=slmAdminRowStatus, slmWriteCommunity=slmWriteCommunity, slmSysIpAddr=slmSysIpAddr, slmSwRevDate=slmSwRevDate, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLicenseId=slmLicenseId, slmChPassOldPass=slmChPassOldPass, slmChPassNewPass=slmChPassNewPass, slmTrapLogTable=slmTrapLogTable, slMain=slMain, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSwRevName=slmSwRevName, slmConfigSysSignalType=slmConfigSysSignalType, UserLogin=UserLogin, slmAdminCommunity=slmAdminCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLogin=slmLogin, slmMuxNumber=slmMuxNumber, slmAdmin=slmAdmin, slmLicenseIndex=slmLicenseIndex, slmTrapLogParam1=slmTrapLogParam1, slmRebootDelay=slmRebootDelay, slmAdminPassword=slmAdminPassword, slmTrapLogName=slmTrapLogName, slmSysAdminStatus=slmSysAdminStatus, slmSysTrapFormat=slmSysTrapFormat, slmEdfaNumber=slmEdfaNumber, slmAdminEntry=slmAdminEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPass=slmChPass, slmVcatDelay=slmVcatDelay, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogEntry=slmTrapLogEntry, UserCommunity=UserCommunity, slmSyslogPort=slmSyslogPort, slmPsuNumber=slmPsuNumber, slmTrapUserAccess=slmTrapUserAccess, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevTable=slmSwRevTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAuthCommunity=slmAuthCommunity, slmSysCalendarTime=slmSysCalendarTime, slm40GConf=slm40GConf, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogId=slmTrapLogId, slmTrap=slmTrap, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestEntry=slmTrapDestEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmSysAlmDeact=slmSysAlmDeact, slmReadCommunity=slmReadCommunity, slmSysSubnetMask=slmSysSubnetMask, slmChPassTable=slmChPassTable, slmAuthPassword=slmAuthPassword, slmTrapLogParam6=slmTrapLogParam6, slmAuth=slmAuth, slmSysLanIpAddr=slmSysLanIpAddr, AdminAccess=AdminAccess, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLogFile=slmLogFile, slmSnmpv3Password=slmSnmpv3Password, slmSnmpv3Auth=slmSnmpv3Auth, slmSwRevStatus=slmSwRevStatus, slmSysSnmpVersion=slmSysSnmpVersion)
