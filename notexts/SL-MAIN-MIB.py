...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmNetworkMode=slmNetworkMode, slmReadCommunity=slmReadCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuthPassword=slmAuthPassword, slmSysActiveSwVersion=slmSysActiveSwVersion, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysEncryptionCapability=slmSysEncryptionCapability, slmPsuNumber=slmPsuNumber, slmChPassOldPass=slmChPassOldPass, slmTrapUserLogin=slmTrapUserLogin, slMain=slMain, slmSnmpv3Auth=slmSnmpv3Auth, slmRebootDelay=slmRebootDelay, slmLicenseId=slmLicenseId, slmPmAvailable=slmPmAvailable, slmAdminPassword=slmAdminPassword, slmSnmpv3Password=slmSnmpv3Password, slmSysAlmAct=slmSysAlmAct, slmTrapEnable=slmTrapEnable, slmSysCalendarTime=slmSysCalendarTime, slmTrapUserAccess=slmTrapUserAccess, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam4=slmTrapLogParam4, slmSyslogLevel=slmSyslogLevel, slmPortsNumber=slmPortsNumber, slmTrapSysLocationChange=slmTrapSysLocationChange, slmChPass=slmChPass, slmTrapPort=slmTrapPort, slmTrapLogParam3=slmTrapLogParam3, slmConfigFile=slmConfigFile, slmOemType=slmOemType, slmTrapDestAddress=slmTrapDestAddress, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogName=slmTrapLogName, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestProtVersion=slmTrapDestProtVersion, SoftwareRevision=SoftwareRevision, slmAuthEntry=slmAuthEntry, slmAdminAccess=slmAdminAccess, slmLogin=slmLogin, slmSysAlmDeact=slmSysAlmDeact, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicenseExpiration=slmLicenseExpiration, slmLicenseIndex=slmLicenseIndex, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam5=slmTrapLogParam5, slmVcatDelay=slmVcatDelay, slmSysTemperature=slmSysTemperature, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapDestCommunity=slmTrapDestCommunity, slmTid=slmTid, slmAdminRowStatus=slmAdminRowStatus, slmAuthLogin=slmAuthLogin, slmAdminTable=slmAdminTable, slmTrapLogTable=slmTrapLogTable, slmSysLocation=slmSysLocation, slmAdminLogin=slmAdminLogin, slmTrapLogParam2=slmTrapLogParam2, slmLicenseEntry=slmLicenseEntry, slmConfigSysUptime=slmConfigSysUptime, slmLicenseTable=slmLicenseTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysIpAddr=slmSysIpAddr, slmLogFile=slmLogFile, slmSyslogDestTable=slmSyslogDestTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmBoxSize=slmBoxSize, slmWriteCommunity=slmWriteCommunity, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestTable=slmTrapDestTable, slmEdfaNumber=slmEdfaNumber, slmTrapLogId=slmTrapLogId, slmSyslogPort=slmSyslogPort, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminCommunity=slmAdminCommunity, AdminAccess=AdminAccess, slmSysSnmpVersion=slmSysSnmpVersion, slmSysAdminStatus=slmSysAdminStatus, slmSyslogDestEntry=slmSyslogDestEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, PYSNMP_MODULE_ID=slMain, slmTrapSysNameChange=slmTrapSysNameChange, slmChPassLogin=slmChPassLogin, slmRstpEnabled=slmRstpEnabled, slmAuthTable=slmAuthTable, slmConfigSysSignalType=slmConfigSysSignalType, slmSysName=slmSysName, slmLicense=slmLicense, slmChPassEntry=slmChPassEntry, slmSwRevEntry=slmSwRevEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapCommunity=slmTrapCommunity, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSwRevTable=slmSwRevTable, slmMuxNumber=slmMuxNumber, slmTrapLogParam6=slmTrapLogParam6, slmSys=slmSys, UserCommunity=UserCommunity, slmChPassNewPass=slmChPassNewPass, slm40GConf=slm40GConf, slmSwRevName=slmSwRevName, slmAdminEntry=slmAdminEntry, UserPassword=UserPassword, slmTrapDestEntry=slmTrapDestEntry, slmChPassTable=slmChPassTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogDestRowStatus=slmSyslogDestRowStatus, UserLogin=UserLogin, slmTrapLogParam1=slmTrapLogParam1, slmAdmin=slmAdmin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysMode=slmSysMode, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogEntry=slmTrapLogEntry, slmSysChassisId=slmSysChassisId, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTopologyEnabled=slmTopologyEnabled, slmAuthCommunity=slmAuthCommunity, slmTrap=slmTrap, slmAuth=slmAuth, slmSwRevStatus=slmSwRevStatus, slmSysSubnetMask=slmSysSubnetMask, slmSysResetPm=slmSysResetPm, slmSwRevDate=slmSwRevDate, slmSysUplinkRate=slmSysUplinkRate)
