...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminTable=slmAdminTable, slmSysChassisId=slmSysChassisId, slmVcatDelay=slmVcatDelay, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseEntry=slmLicenseEntry, slmTrapDestTable=slmTrapDestTable, slmSysName=slmSysName, slmLicense=slmLicense, slmSyslogDestTable=slmSyslogDestTable, slmSysResetPm=slmSysResetPm, slmAuth=slmAuth, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSwRevEntry=slmSwRevEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmConfigFile=slmConfigFile, slmLogin=slmLogin, slmNetworkMode=slmNetworkMode, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam1=slmTrapLogParam1, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogParam5=slmTrapLogParam5, slmSwRevDirectory=slmSwRevDirectory, slmSysMode=slmSysMode, slmBoxSize=slmBoxSize, slmSnmpv3Priv=slmSnmpv3Priv, slmLicenseTable=slmLicenseTable, UserPassword=UserPassword, slmSysTrapFormat=slmSysTrapFormat, slmAdminLogin=slmAdminLogin, slmTrapLogEntry=slmTrapLogEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminEntry=slmAdminEntry, UserCommunity=UserCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPass=slmChPass, slmAdminRowStatus=slmAdminRowStatus, slmSysIpAddr=slmSysIpAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapUserAccess=slmTrapUserAccess, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapEnable=slmTrapEnable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slm40GConf=slm40GConf, slmSyslogLevel=slmSyslogLevel, slmOemType=slmOemType, slmAdminCommunity=slmAdminCommunity, slmSyslogPort=slmSyslogPort, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestAddress=slmTrapDestAddress, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapPort=slmTrapPort, slmLogFile=slmLogFile, slmTrapLogParam2=slmTrapLogParam2, slMain=slMain, slmSwRevDate=slmSwRevDate, slmTrapLogParam4=slmTrapLogParam4, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysTemperature=slmSysTemperature, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmChPassNewPass=slmChPassNewPass, slmSysGatewayAddr=slmSysGatewayAddr, slmTid=slmTid, slmSnmpv3Auth=slmSnmpv3Auth, slmSwRevName=slmSwRevName, slmSysAdminStatus=slmSysAdminStatus, slmSysAlmAct=slmSysAlmAct, UserLogin=UserLogin, slmPmAvailable=slmPmAvailable, slmChPassEntry=slmChPassEntry, slmEdfaNumber=slmEdfaNumber, slmSysPmStartOfDay=slmSysPmStartOfDay, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogParam3=slmTrapLogParam3, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassTable=slmChPassTable, slmRebootDelay=slmRebootDelay, slmMuxNumber=slmMuxNumber, slmAdminPassword=slmAdminPassword, slmSysLocation=slmSysLocation, slmPortsNumber=slmPortsNumber, slmSysLanIpAddr=slmSysLanIpAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapDestEntry=slmTrapDestEntry, slmLicenseId=slmLicenseId, slmSnmpv3Password=slmSnmpv3Password, slmPsuNumber=slmPsuNumber, SoftwareRevision=SoftwareRevision, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogId=slmTrapLogId, slmTrapLogName=slmTrapLogName, slmAuthEntry=slmAuthEntry, AdminAccess=AdminAccess, slmAuthPassword=slmAuthPassword, slmLicenseExpiration=slmLicenseExpiration, slmAuthTable=slmAuthTable, slmWriteCommunity=slmWriteCommunity, slmAuthCommunity=slmAuthCommunity, slmSwRevTable=slmSwRevTable, slmAdmin=slmAdmin, slmRstpEnabled=slmRstpEnabled, slmTrapLogTable=slmTrapLogTable, slmSysOperStatus=slmSysOperStatus, slmSwRevStatus=slmSwRevStatus, slmTrapCommunity=slmTrapCommunity, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPassOldPass=slmChPassOldPass, slmLicenseIndex=slmLicenseIndex, slmAdminAccess=slmAdminAccess, slmAuthLogin=slmAuthLogin, slmTrap=slmTrap, slmReadCommunity=slmReadCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapUserLogin=slmTrapUserLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSys=slmSys, slmChPassLogin=slmChPassLogin, PYSNMP_MODULE_ID=slMain, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam6=slmTrapLogParam6)
