...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapUserAccess=slmTrapUserAccess, slmAdminAccess=slmAdminAccess, slmSysName=slmSysName, slmAuthEntry=slmAuthEntry, slmSyslogDestTable=slmSyslogDestTable, slmLicense=slmLicense, slmLogin=slmLogin, slmTrapLogParam5=slmTrapLogParam5, slmOemType=slmOemType, slmSysCalendarTime=slmSysCalendarTime, slmEdfaNumber=slmEdfaNumber, slmTrapDestProtVersion=slmTrapDestProtVersion, slmPsuNumber=slmPsuNumber, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmRstpEnabled=slmRstpEnabled, slmSwRevStatus=slmSwRevStatus, slmLicenseTable=slmLicenseTable, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam3=slmTrapLogParam3, slMain=slMain, slmAdminRowStatus=slmAdminRowStatus, slmSysIpAddr=slmSysIpAddr, slmConfigFile=slmConfigFile, slmSnmpv3Priv=slmSnmpv3Priv, slmSysAlmAct=slmSysAlmAct, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapEnable=slmTrapEnable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, UserLogin=UserLogin, slm40GConf=slm40GConf, slmTrapDestIpAddress=slmTrapDestIpAddress, slmChPassEntry=slmChPassEntry, slmAdminLogin=slmAdminLogin, slmWriteCommunity=slmWriteCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysPmStartOfDay=slmSysPmStartOfDay, slmReadCommunity=slmReadCommunity, slmSysTemperature=slmSysTemperature, slmTrapLogName=slmTrapLogName, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogParam2=slmTrapLogParam2, slmSwRevDirectory=slmSwRevDirectory, slmSwRevTable=slmSwRevTable, slmTrapLogParam6=slmTrapLogParam6, PYSNMP_MODULE_ID=slMain, slmTopologyEnabled=slmTopologyEnabled, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysChassisId=slmSysChassisId, slmSwRevDate=slmSwRevDate, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseEntry=slmLicenseEntry, slmSnmpv3Password=slmSnmpv3Password, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogTable=slmTrapLogTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysAlmDeact=slmSysAlmDeact, slmChPassTable=slmChPassTable, UserPassword=UserPassword, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapDestTable=slmTrapDestTable, slmSysResetPm=slmSysResetPm, slmTrapDestAddress=slmTrapDestAddress, slmLicenseId=slmLicenseId, slmTrapDestEntry=slmTrapDestEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogDestAddress=slmSyslogDestAddress, slmAuthTable=slmAuthTable, slmAdminCommunity=slmAdminCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdmin=slmAdmin, slmSysMode=slmSysMode, slmTid=slmTid, slmChPassNewPass=slmChPassNewPass, slmTrap=slmTrap, slmSysOperStatus=slmSysOperStatus, slmPortsNumber=slmPortsNumber, slmMuxNumber=slmMuxNumber, slmAuthPassword=slmAuthPassword, slmChPassLogin=slmChPassLogin, slmNetworkMode=slmNetworkMode, slmSysLocation=slmSysLocation, slmAdminEntry=slmAdminEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogEntry=slmTrapLogEntry, slmVcatDelay=slmVcatDelay, slmAdminPassword=slmAdminPassword, slmSwRevName=slmSwRevName, UserCommunity=UserCommunity, slmTrapPort=slmTrapPort, slmAdminTable=slmAdminTable, slmLogFile=slmLogFile, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogParam4=slmTrapLogParam4, slmSnmpv3Auth=slmSnmpv3Auth, slmPmAvailable=slmPmAvailable, slmTrapDestCommunity=slmTrapDestCommunity, slmAuthLogin=slmAuthLogin, slmBoxSize=slmBoxSize, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysGatewayAddr=slmSysGatewayAddr, slmSysAdminStatus=slmSysAdminStatus, slmConfigSysUptime=slmConfigSysUptime, slmTrapCommunity=slmTrapCommunity, slmLicenseExpiration=slmLicenseExpiration, slmSysSubnetMask=slmSysSubnetMask, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassOldPass=slmChPassOldPass, slmLicenseIndex=slmLicenseIndex, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuthCommunity=slmAuthCommunity, slmSysSnmpVersion=slmSysSnmpVersion, slmSys=slmSys, slmTrapLogId=slmTrapLogId, slmSyslogLevel=slmSyslogLevel, slmSyslogPort=slmSyslogPort, slmChPass=slmChPass, slmRebootDelay=slmRebootDelay, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevEntry=slmSwRevEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, SoftwareRevision=SoftwareRevision, slmSysTrapFormat=slmSysTrapFormat, AdminAccess=AdminAccess, slmAuth=slmAuth)
