...
Counter32, Opaque, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, TimeTicks, Counter64, Unsigned32, MibIdentifier, ObjectIdentity, Gauge32, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Opaque", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "TimeTicks", "Counter64", "Unsigned32", "MibIdentifier", "ObjectIdentity", "Gauge32", "ModuleIdentity", "Bits")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicense=slmLicense, slmConfigFile=slmConfigFile, slmSysOperStatus=slmSysOperStatus, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminAccess=slmAdminAccess, slmSysAlmAct=slmSysAlmAct, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestTable=slmTrapDestTable, slmSysUplinkRate=slmSysUplinkRate, slmChPassNewPass=slmChPassNewPass, slmTrapLogName=slmTrapLogName, slmSysTrapFormat=slmSysTrapFormat, slmTrapCommunity=slmTrapCommunity, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestEntry=slmTrapDestEntry, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam1=slmTrapLogParam1, slmAdminPassword=slmAdminPassword, AdminAccess=AdminAccess, slmAuth=slmAuth, slmTrapUserLogin=slmTrapUserLogin, slmLogin=slmLogin, slmTrapDestAddress=slmTrapDestAddress, slmSwRevStatus=slmSwRevStatus, slmConfigSysSignalType=slmConfigSysSignalType, slmSysChassisId=slmSysChassisId, slmSysAdminStatus=slmSysAdminStatus, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmReadCommunity=slmReadCommunity, slmSyslogLevel=slmSyslogLevel, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapUserAccess=slmTrapUserAccess, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmLogFile=slmLogFile, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysName=slmSysName, slmEdfaNumber=slmEdfaNumber, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSwRevDate=slmSwRevDate, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminTable=slmAdminTable, slmChPassLogin=slmChPassLogin, slMain=slMain, slmSys=slmSys, slmChPassEntry=slmChPassEntry, slmOemType=slmOemType, slmTrapSysNameChange=slmTrapSysNameChange, slmNetworkMode=slmNetworkMode, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLicenseExpiration=slmLicenseExpiration, slmAdminRowStatus=slmAdminRowStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, UserPassword=UserPassword, slm40GConf=slm40GConf, slmTrapPort=slmTrapPort, slmSnmpv3Password=slmSnmpv3Password, slmBoxSize=slmBoxSize, PYSNMP_MODULE_ID=slMain, slmPmAvailable=slmPmAvailable, slmSnmpv3Auth=slmSnmpv3Auth, slmSwRevName=slmSwRevName, slmAuthLogin=slmAuthLogin, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysLocation=slmSysLocation, slmSysSubnetMask=slmSysSubnetMask, slmPsuNumber=slmPsuNumber, slmSwRevDirectory=slmSwRevDirectory, slmChPass=slmChPass, UserCommunity=UserCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam2=slmTrapLogParam2, slmAuthTable=slmAuthTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthPassword=slmAuthPassword, slmTrapDestProtVersion=slmTrapDestProtVersion, slmPortsNumber=slmPortsNumber, slmAuthCommunity=slmAuthCommunity, slmTrapEnable=slmTrapEnable, slmTrapLogParam5=slmTrapLogParam5, slmTid=slmTid, slmChPassOldPass=slmChPassOldPass, SoftwareRevision=SoftwareRevision, slmTrapSysLocationChange=slmTrapSysLocationChange, slmWriteCommunity=slmWriteCommunity, slmAdminCommunity=slmAdminCommunity, slmTrapLogId=slmTrapLogId, slmLicenseIndex=slmLicenseIndex, slmAdminLogin=slmAdminLogin, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam3=slmTrapLogParam3, UserLogin=UserLogin, slmSysAlmDeact=slmSysAlmDeact, slmSyslogDestTable=slmSyslogDestTable, slmTrap=slmTrap, slmSysLanIpAddr=slmSysLanIpAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam4=slmTrapLogParam4, slmLicenseTable=slmLicenseTable, slmRebootDelay=slmRebootDelay, slmVcatDelay=slmVcatDelay, slmMuxNumber=slmMuxNumber, slmAdminEntry=slmAdminEntry, slmLicenseEntry=slmLicenseEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogPort=slmSyslogPort, slmRstpEnabled=slmRstpEnabled, slmTopologyEnabled=slmTopologyEnabled, slmSwRevTable=slmSwRevTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysMode=slmSysMode, slmAuthEntry=slmAuthEntry, slmSysResetPm=slmSysResetPm, slmChPassTable=slmChPassTable, slmAdmin=slmAdmin, slmSysTemperature=slmSysTemperature, slmSnmpv3Priv=slmSnmpv3Priv, slmLicenseId=slmLicenseId, slmTrapDestCommunity=slmTrapDestCommunity)
