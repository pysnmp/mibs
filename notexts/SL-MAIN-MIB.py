...
NotificationType, Gauge32, TimeTicks, Opaque, Counter32, ModuleIdentity, Bits, Unsigned32, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "TimeTicks", "Opaque", "Counter32", "ModuleIdentity", "Bits", "Unsigned32", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSwRevDate=slmSwRevDate, slm40GConf=slm40GConf, slmChPassNewPass=slmChPassNewPass, slmTrapLogEntry=slmTrapLogEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSyslogLevel=slmSyslogLevel, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminCommunity=slmAdminCommunity, slmSysAdminStatus=slmSysAdminStatus, slmEdfaNumber=slmEdfaNumber, slmTrapDestEntry=slmTrapDestEntry, slmSyslogPort=slmSyslogPort, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSwRevStatus=slmSwRevStatus, slmAdminTable=slmAdminTable, slmTrapDestCommunity=slmTrapDestCommunity, slmSysCalendarTime=slmSysCalendarTime, slmConfigSysUptime=slmConfigSysUptime, slmLicenseTable=slmLicenseTable, slmAdminRowStatus=slmAdminRowStatus, slmSysIpAddr=slmSysIpAddr, slmTrapDestAddress=slmTrapDestAddress, slmSyslogDestAddress=slmSyslogDestAddress, slmPortsNumber=slmPortsNumber, slmLicenseId=slmLicenseId, slmSysOperStatus=slmSysOperStatus, slmTopologyEnabled=slmTopologyEnabled, slmTrapUserAccess=slmTrapUserAccess, slmSysAlmDeact=slmSysAlmDeact, slmRebootDelay=slmRebootDelay, slmMuxNumber=slmMuxNumber, slmTrapPort=slmTrapPort, slmSysSubnetMask=slmSysSubnetMask, slmSysLanIpAddr=slmSysLanIpAddr, slmSysChassisId=slmSysChassisId, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmSwRevName=slmSwRevName, slmAuthCommunity=slmAuthCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmBoxSize=slmBoxSize, slmTid=slmTid, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysGatewayAddr=slmSysGatewayAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmChPassTable=slmChPassTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLicenseExpiration=slmLicenseExpiration, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminLogin=slmAdminLogin, UserCommunity=UserCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSwRevTable=slmSwRevTable, slmWriteCommunity=slmWriteCommunity, slmSysSnmpVersion=slmSysSnmpVersion, slmAuthLogin=slmAuthLogin, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLicenseIndex=slmLicenseIndex, slmChPassLogin=slmChPassLogin, slmTrapLogTable=slmTrapLogTable, AdminAccess=AdminAccess, slmAdminAccess=slmAdminAccess, slmSysLocation=slmSysLocation, slmConfigSysSignalType=slmConfigSysSignalType, slmSys=slmSys, slmTrapUserLogin=slmTrapUserLogin, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassEntry=slmChPassEntry, slmChPassOldPass=slmChPassOldPass, UserPassword=UserPassword, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam3=slmTrapLogParam3, slmAuth=slmAuth, slMain=slMain, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysTrapFormat=slmSysTrapFormat, slmAuthPassword=slmAuthPassword, slmTrap=slmTrap, slmOemType=slmOemType, slmAdminPassword=slmAdminPassword, slmReadCommunity=slmReadCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogName=slmTrapLogName, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSnmpv3Password=slmSnmpv3Password, slmRstpEnabled=slmRstpEnabled, slmSwRevEntry=slmSwRevEntry, UserLogin=UserLogin, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogId=slmTrapLogId, slmAuthTable=slmAuthTable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysName=slmSysName, slmTrapDestTable=slmTrapDestTable, SoftwareRevision=SoftwareRevision, slmSysMode=slmSysMode, slmSyslogDestTable=slmSyslogDestTable, slmLicenseEntry=slmLicenseEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmPmAvailable=slmPmAvailable, PYSNMP_MODULE_ID=slMain, slmLicense=slmLicense, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam6=slmTrapLogParam6, slmSwRevDirectory=slmSwRevDirectory, slmTrapCommunity=slmTrapCommunity, slmVcatDelay=slmVcatDelay, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLogin=slmLogin, slmAdminEntry=slmAdminEntry, slmSysAlmAct=slmSysAlmAct, slmConfigFile=slmConfigFile, slmPsuNumber=slmPsuNumber, slmSysResetPm=slmSysResetPm, slmAuthEntry=slmAuthEntry, slmTrapLogParam2=slmTrapLogParam2, slmLogFile=slmLogFile, slmChPass=slmChPass, slmTrapEnable=slmTrapEnable, slmNetworkMode=slmNetworkMode, slmAdmin=slmAdmin, slmSysTemperature=slmSysTemperature)
