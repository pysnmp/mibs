...
NotificationType, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, Bits, ObjectIdentity, Unsigned32, Counter32, MibIdentifier, Opaque, Gauge32, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "Bits", "ObjectIdentity", "Unsigned32", "Counter32", "MibIdentifier", "Opaque", "Gauge32", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysUplinkRate=slmSysUplinkRate, UserCommunity=UserCommunity, slmAdminPassword=slmAdminPassword, slmSysResetPm=slmSysResetPm, slmSysCalendarTime=slmSysCalendarTime, slmSnmpv3Password=slmSnmpv3Password, slmBoxSize=slmBoxSize, slmOemType=slmOemType, slmMuxNumber=slmMuxNumber, slmRstpEnabled=slmRstpEnabled, slmTrapLogName=slmTrapLogName, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysAdminStatus=slmSysAdminStatus, slmAuthCommunity=slmAuthCommunity, slmLicenseExpiration=slmLicenseExpiration, slmPsuNumber=slmPsuNumber, SoftwareRevision=SoftwareRevision, slmTrapCommunity=slmTrapCommunity, slmLicenseTable=slmLicenseTable, slmLicenseId=slmLicenseId, slmAuthEntry=slmAuthEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam2=slmTrapLogParam2, slmReadCommunity=slmReadCommunity, slmSysIpAddr=slmSysIpAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevEntry=slmSwRevEntry, slmTrapPort=slmTrapPort, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAuth=slmAuth, slm40GConf=slm40GConf, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam1=slmTrapLogParam1, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestTable=slmSyslogDestTable, slmTrap=slmTrap, slmTrapLogParam4=slmTrapLogParam4, slMain=slMain, slmTrapLogParam5=slmTrapLogParam5, slmAuthLogin=slmAuthLogin, slmSys=slmSys, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysTrapFormat=slmSysTrapFormat, slmChPass=slmChPass, slmEdfaNumber=slmEdfaNumber, slmPortsNumber=slmPortsNumber, slmSysAlmAct=slmSysAlmAct, slmAdminEntry=slmAdminEntry, slmSysOperStatus=slmSysOperStatus, slmVcatDelay=slmVcatDelay, slmSysLocation=slmSysLocation, slmNetworkMode=slmNetworkMode, slmAuthPassword=slmAuthPassword, slmConfigSysUptime=slmConfigSysUptime, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogPort=slmSyslogPort, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestEntry=slmTrapDestEntry, slmTrapUserLogin=slmTrapUserLogin, slmLicenseIndex=slmLicenseIndex, slmAdmin=slmAdmin, slmChPassTable=slmChPassTable, slmSwRevDate=slmSwRevDate, slmAdminAccess=slmAdminAccess, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogLevel=slmSyslogLevel, slmSysSubnetMask=slmSysSubnetMask, slmSysAlmDeact=slmSysAlmDeact, slmTrapDestAddress=slmTrapDestAddress, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestTable=slmTrapDestTable, UserLogin=UserLogin, slmTrapLogTable=slmTrapLogTable, slmAuthTable=slmAuthTable, slmTid=slmTid, slmSysGatewayAddr=slmSysGatewayAddr, slmChPassLogin=slmChPassLogin, slmSyslogDestAddress=slmSyslogDestAddress, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogEntry=slmTrapLogEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmConfigFile=slmConfigFile, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSwRevTable=slmSwRevTable, slmWriteCommunity=slmWriteCommunity, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTopologyEnabled=slmTopologyEnabled, UserPassword=UserPassword, PYSNMP_MODULE_ID=slMain, slmTrapEnable=slmTrapEnable, slmAdminCommunity=slmAdminCommunity, slmTrapLogId=slmTrapLogId, slmLicenseEntry=slmLicenseEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassOldPass=slmChPassOldPass, slmChPassEntry=slmChPassEntry, slmLicense=slmLicense, slmAdminLogin=slmAdminLogin, slmRebootDelay=slmRebootDelay, slmLogin=slmLogin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPassNewPass=slmChPassNewPass, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmSysMode=slmSysMode, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogParam3=slmTrapLogParam3, slmSyslogDestEntry=slmSyslogDestEntry, slmPmAvailable=slmPmAvailable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminTable=slmAdminTable, slmSwRevStatus=slmSwRevStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysChassisId=slmSysChassisId, slmSwRevName=slmSwRevName, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysLanIpAddr=slmSysLanIpAddr, AdminAccess=AdminAccess, slmSysTemperature=slmSysTemperature, slmTrapUserAccess=slmTrapUserAccess, slmLogFile=slmLogFile, slmSysName=slmSysName)
