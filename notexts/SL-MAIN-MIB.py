...
ModuleIdentity, Gauge32, ObjectIdentity, TimeTicks, NotificationType, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, Integer32, Unsigned32, Counter64, Bits, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "ObjectIdentity", "TimeTicks", "NotificationType", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "Integer32", "Unsigned32", "Counter64", "Bits", "Opaque")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTid=slmTid, slmAuthCommunity=slmAuthCommunity, slmNetworkMode=slmNetworkMode, slmAuth=slmAuth, slmSnmpv3Auth=slmSnmpv3Auth, slmRstpEnabled=slmRstpEnabled, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogName=slmTrapLogName, slmSwRevTable=slmSwRevTable, slmSysTrapFormat=slmSysTrapFormat, slmSysPmStartOfDay=slmSysPmStartOfDay, slmOemType=slmOemType, PYSNMP_MODULE_ID=slMain, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestCommunity=slmTrapDestCommunity, slmSwRevDate=slmSwRevDate, slmSyslogDestEntry=slmSyslogDestEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmChPassTable=slmChPassTable, slmTrapCommunity=slmTrapCommunity, slmTrapEnable=slmTrapEnable, slmSysAlmDeact=slmSysAlmDeact, UserPassword=UserPassword, slmTrapPort=slmTrapPort, slmChPassLogin=slmChPassLogin, slmSysSnmpVersion=slmSysSnmpVersion, slmSys=slmSys, slmSysName=slmSysName, slmBoxSize=slmBoxSize, slmAdminCommunity=slmAdminCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLogFile=slmLogFile, slmWriteCommunity=slmWriteCommunity, slmAuthLogin=slmAuthLogin, slmSwRevStatus=slmSwRevStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slMain=slMain, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogTable=slmTrapLogTable, slmSysMode=slmSysMode, slmAdminLogin=slmAdminLogin, slmPortsNumber=slmPortsNumber, slmSysLocation=slmSysLocation, slmVcatDelay=slmVcatDelay, slmChPass=slmChPass, slmPsuNumber=slmPsuNumber, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam6=slmTrapLogParam6, slmLogin=slmLogin, AdminAccess=AdminAccess, slmPmAvailable=slmPmAvailable, slmSyslogDestTable=slmSyslogDestTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmRebootDelay=slmRebootDelay, slmAdminAccess=slmAdminAccess, slmAuthEntry=slmAuthEntry, UserCommunity=UserCommunity, slmTrapUserLogin=slmTrapUserLogin, slmLicenseIndex=slmLicenseIndex, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogPort=slmSyslogPort, slmSysCalendarTime=slmSysCalendarTime, slmAuthTable=slmAuthTable, slm40GConf=slm40GConf, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTopologyEnabled=slmTopologyEnabled, slmSwRevEntry=slmSwRevEntry, slmSyslogLevel=slmSyslogLevel, slmTrapDestEntry=slmTrapDestEntry, slmSnmpv3Password=slmSnmpv3Password, slmSysResetPm=slmSysResetPm, slmTrapLogParam1=slmTrapLogParam1, slmMuxNumber=slmMuxNumber, slmTrapLogParam4=slmTrapLogParam4, slmEdfaNumber=slmEdfaNumber, slmConfigFile=slmConfigFile, slmTrap=slmTrap, slmAdminPassword=slmAdminPassword, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseTable=slmLicenseTable, slmSysIpAddr=slmSysIpAddr, slmSysAlmAct=slmSysAlmAct, slmChPassEntry=slmChPassEntry, slmTrapDestAddress=slmTrapDestAddress, SoftwareRevision=SoftwareRevision, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmChPassOldPass=slmChPassOldPass, slmLicenseId=slmLicenseId, slmTrapLogId=slmTrapLogId, slmTrapLogEntry=slmTrapLogEntry, slmLicenseExpiration=slmLicenseExpiration, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmConfigSysUptime=slmConfigSysUptime, slmReadCommunity=slmReadCommunity, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSnmpv3Priv=slmSnmpv3Priv, slmChPassNewPass=slmChPassNewPass, UserLogin=UserLogin, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam5=slmTrapLogParam5, slmLicense=slmLicense, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAuthPassword=slmAuthPassword, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminEntry=slmAdminEntry, slmAdmin=slmAdmin, slmSysTemperature=slmSysTemperature, slmSysSubnetMask=slmSysSubnetMask, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogParam2=slmTrapLogParam2, slmAdminTable=slmAdminTable, slmSysChassisId=slmSysChassisId, slmSwRevName=slmSwRevName, slmTrapLogParam3=slmTrapLogParam3, slmLicenseEntry=slmLicenseEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus)
