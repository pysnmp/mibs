...
TimeTicks, Gauge32, Counter32, Opaque, Counter64, Bits, NotificationType, Integer32, ObjectIdentity, Unsigned32, iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "Counter32", "Opaque", "Counter64", "Bits", "NotificationType", "Integer32", "ObjectIdentity", "Unsigned32", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysTrapFormat=slmSysTrapFormat, slmSysTemperature=slmSysTemperature, slmTrapLogParam5=slmTrapLogParam5, slmLicenseEntry=slmLicenseEntry, slmAuthPassword=slmAuthPassword, slmTrapLogParam1=slmTrapLogParam1, slmPortsNumber=slmPortsNumber, slmAdminRowStatus=slmAdminRowStatus, slmChPass=slmChPass, UserLogin=UserLogin, slmLicense=slmLicense, slmAuth=slmAuth, slmPmAvailable=slmPmAvailable, slmRstpEnabled=slmRstpEnabled, slmSwRevName=slmSwRevName, slmWriteCommunity=slmWriteCommunity, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogDestEntry=slmSyslogDestEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapUserAccess=slmTrapUserAccess, slmSys=slmSys, slmSwRevStatus=slmSwRevStatus, slmTrapDestAddress=slmTrapDestAddress, slmAdminTable=slmAdminTable, slmTrapLogParam4=slmTrapLogParam4, slmTrapCommunity=slmTrapCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSwRevTable=slmSwRevTable, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestEntry=slmTrapDestEntry, slmAuthTable=slmAuthTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysCalendarTime=slmSysCalendarTime, slm40GConf=slm40GConf, slmTrapLogName=slmTrapLogName, slmAdminPassword=slmAdminPassword, slmLicenseIndex=slmLicenseIndex, slmTid=slmTid, PYSNMP_MODULE_ID=slMain, slmTrapSysNameChange=slmTrapSysNameChange, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogEntry=slmTrapLogEntry, slmRebootDelay=slmRebootDelay, slmSnmpv3Password=slmSnmpv3Password, slmChPassTable=slmChPassTable, slmSysAdminStatus=slmSysAdminStatus, slmAdminEntry=slmAdminEntry, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogParam6=slmTrapLogParam6, slmSysSnmpVersion=slmSysSnmpVersion, slmSnmpv3Priv=slmSnmpv3Priv, slmBoxSize=slmBoxSize, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogPort=slmSyslogPort, slmTrap=slmTrap, SoftwareRevision=SoftwareRevision, slMain=slMain, slmChPassNewPass=slmChPassNewPass, slmLicenseTable=slmLicenseTable, slmAuthCommunity=slmAuthCommunity, slmAuthLogin=slmAuthLogin, slmSysLocation=slmSysLocation, slmTrapEnable=slmTrapEnable, slmSyslogLevel=slmSyslogLevel, slmConfigFile=slmConfigFile, slmConfigSysSignalType=slmConfigSysSignalType, slmAdmin=slmAdmin, slmNetworkMode=slmNetworkMode, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysOperStatus=slmSysOperStatus, AdminAccess=AdminAccess, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysActiveSwVersion=slmSysActiveSwVersion, slmOemType=slmOemType, slmLogin=slmLogin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmConfigSysUptime=slmConfigSysUptime, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapUserLogin=slmTrapUserLogin, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestTable=slmTrapDestTable, slmSysMode=slmSysMode, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminAccess=slmAdminAccess, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSnmpv3Auth=slmSnmpv3Auth, slmAuthEntry=slmAuthEntry, slmTrapLogId=slmTrapLogId, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSwRevEntry=slmSwRevEntry, slmLogFile=slmLogFile, slmEdfaNumber=slmEdfaNumber, slmSwRevDate=slmSwRevDate, slmSyslogDestTable=slmSyslogDestTable, slmChPassEntry=slmChPassEntry, slmAdminLogin=slmAdminLogin, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogTable=slmTrapLogTable, slmSysUplinkRate=slmSysUplinkRate, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmReadCommunity=slmReadCommunity, slmTrapDestCommunity=slmTrapDestCommunity, slmSysAlmDeact=slmSysAlmDeact, slmChPassLogin=slmChPassLogin, slmSysResetPm=slmSysResetPm, slmSysName=slmSysName, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysChassisId=slmSysChassisId, slmLicenseExpiration=slmLicenseExpiration, slmSysIpAddr=slmSysIpAddr, slmSysAlmAct=slmSysAlmAct, slmVcatDelay=slmVcatDelay, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapPort=slmTrapPort, slmMuxNumber=slmMuxNumber, UserCommunity=UserCommunity, slmChPassOldPass=slmChPassOldPass, slmLicenseId=slmLicenseId, slmAdminCommunity=slmAdminCommunity, UserPassword=UserPassword, slmPsuNumber=slmPsuNumber, slmSysLanIpAddr=slmSysLanIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogParam2=slmTrapLogParam2)
