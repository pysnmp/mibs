...
ModuleIdentity, Counter32, MibIdentifier, Opaque, TimeTicks, Gauge32, Integer32, Unsigned32, Counter64, IpAddress, NotificationType, Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "MibIdentifier", "Opaque", "TimeTicks", "Gauge32", "Integer32", "Unsigned32", "Counter64", "IpAddress", "NotificationType", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAuthTable=slmAuthTable, slmTrapDestAddress=slmTrapDestAddress, slmAuthLogin=slmAuthLogin, slmVcatDelay=slmVcatDelay, slmRstpEnabled=slmRstpEnabled, slmAdmin=slmAdmin, slmSysName=slmSysName, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmLicenseId=slmLicenseId, slmSyslogPort=slmSyslogPort, slmChPassLogin=slmChPassLogin, slmLicenseExpiration=slmLicenseExpiration, slmChPassEntry=slmChPassEntry, UserPassword=UserPassword, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmReadCommunity=slmReadCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysAlmAct=slmSysAlmAct, slmSysNetworkPrefix=slmSysNetworkPrefix, slmEdfaNumber=slmEdfaNumber, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminPassword=slmAdminPassword, slmTrapDestCommunity=slmTrapDestCommunity, slmAdminEntry=slmAdminEntry, slmSwRevTable=slmSwRevTable, slmTrapCommunity=slmTrapCommunity, slmSysResetPm=slmSysResetPm, slmPmAvailable=slmPmAvailable, slmSwRevEntry=slmSwRevEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmPsuNumber=slmPsuNumber, slmTrap=slmTrap, slmOemType=slmOemType, slmLogin=slmLogin, UserLogin=UserLogin, slmChPassTable=slmChPassTable, slmSysSnmpVersion=slmSysSnmpVersion, slmChPass=slmChPass, PYSNMP_MODULE_ID=slMain, SoftwareRevision=SoftwareRevision, slmSysChassisId=slmSysChassisId, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLicense=slmLicense, slmTrapEnable=slmTrapEnable, slmTrapLogName=slmTrapLogName, slmSysSubnetMask=slmSysSubnetMask, slmSyslogLevel=slmSyslogLevel, slmAuth=slmAuth, slmPortsNumber=slmPortsNumber, slmSysTemperature=slmSysTemperature, slmTrapLogTable=slmTrapLogTable, slmMuxNumber=slmMuxNumber, slmTrapLogParam1=slmTrapLogParam1, slm40GConf=slm40GConf, slmLicenseIndex=slmLicenseIndex, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminRowStatus=slmAdminRowStatus, slmConfigFile=slmConfigFile, slmWriteCommunity=slmWriteCommunity, slmChPassOldPass=slmChPassOldPass, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassNewPass=slmChPassNewPass, slMain=slMain, slmAuthEntry=slmAuthEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapPort=slmTrapPort, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam6=slmTrapLogParam6, slmRebootDelay=slmRebootDelay, slmSnmpv3Password=slmSnmpv3Password, slmTrapUserLogin=slmTrapUserLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmBoxSize=slmBoxSize, slmSysCalendarTime=slmSysCalendarTime, slmNetworkMode=slmNetworkMode, slmAdminAccess=slmAdminAccess, slmSyslogDestTable=slmSyslogDestTable, slmSysUplinkRate=slmSysUplinkRate, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdminLogin=slmAdminLogin, slmSysLocation=slmSysLocation, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmConfigSysSignalType=slmConfigSysSignalType, slmAuthPassword=slmAuthPassword, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogParam2=slmTrapLogParam2, slmLicenseEntry=slmLicenseEntry, slmTrapLogEntry=slmTrapLogEntry, slmSys=slmSys, slmTrapUserAccess=slmTrapUserAccess, slmAdminCommunity=slmAdminCommunity, slmLicenseTable=slmLicenseTable, slmSwRevName=slmSwRevName, slmSnmpv3Priv=slmSnmpv3Priv, slmSysMode=slmSysMode, slmTopologyEnabled=slmTopologyEnabled, slmSwRevStatus=slmSwRevStatus, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam4=slmTrapLogParam4, UserCommunity=UserCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmConfigSysUptime=slmConfigSysUptime, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminTable=slmAdminTable, slmSysIpAddr=slmSysIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysAlmDeact=slmSysAlmDeact, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLogFile=slmLogFile, slmTid=slmTid, slmTrapLogId=slmTrapLogId, slmSwRevDate=slmSwRevDate, AdminAccess=AdminAccess, slmTrapLogParam5=slmTrapLogParam5, slmTrapDestTable=slmTrapDestTable, slmAuthCommunity=slmAuthCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogParam3=slmTrapLogParam3, slmSysAdminStatus=slmSysAdminStatus, slmTrapDestEntry=slmTrapDestEntry, slmSysOperStatus=slmSysOperStatus)
