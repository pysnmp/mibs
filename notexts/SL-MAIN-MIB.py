...
Counter32, ModuleIdentity, NotificationType, iso, MibIdentifier, Gauge32, Bits, Counter64, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, Opaque, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "NotificationType", "iso", "MibIdentifier", "Gauge32", "Bits", "Counter64", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "Opaque", "IpAddress")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTid=slmTid, slmSysLanIpAddr=slmSysLanIpAddr, slmSysChassisId=slmSysChassisId, slmTrapDestRowStatus=slmTrapDestRowStatus, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapUserAccess=slmTrapUserAccess, slmLicenseId=slmLicenseId, slmTrapLogTable=slmTrapLogTable, slmTrapUserLogin=slmTrapUserLogin, slmAdminCommunity=slmAdminCommunity, slmSysActiveSwVersion=slmSysActiveSwVersion, PYSNMP_MODULE_ID=slMain, UserPassword=UserPassword, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam5=slmTrapLogParam5, slm40GConf=slm40GConf, slmTrapLogParam2=slmTrapLogParam2, slmLicenseExpiration=slmLicenseExpiration, slmAuthEntry=slmAuthEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmRstpEnabled=slmRstpEnabled, slmAdminAccess=slmAdminAccess, slmSysOperStatus=slmSysOperStatus, slmTrapDestTable=slmTrapDestTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmWriteCommunity=slmWriteCommunity, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysEncryptionCapability=slmSysEncryptionCapability, slmVcatDelay=slmVcatDelay, slmTrap=slmTrap, slmLogFile=slmLogFile, slmRebootDelay=slmRebootDelay, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTopologyEnabled=slmTopologyEnabled, slmMuxNumber=slmMuxNumber, slmSysTrapFormat=slmSysTrapFormat, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestAddress=slmTrapDestAddress, slmTrapSysNameChange=slmTrapSysNameChange, slmConfigSysUptime=slmConfigSysUptime, slmAdminTable=slmAdminTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysName=slmSysName, slmSyslogDestTable=slmSyslogDestTable, slmSys=slmSys, slmSysSubnetMask=slmSysSubnetMask, slmSwRevEntry=slmSwRevEntry, slmChPassLogin=slmChPassLogin, slmSwRevDate=slmSwRevDate, slmChPassOldPass=slmChPassOldPass, slmSysAlmAct=slmSysAlmAct, slmSysIpAddr=slmSysIpAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmAuthCommunity=slmAuthCommunity, slmChPassTable=slmChPassTable, slmAuthTable=slmAuthTable, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogId=slmTrapLogId, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmPmAvailable=slmPmAvailable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminEntry=slmAdminEntry, slmSysResetPm=slmSysResetPm, slmTrapLogName=slmTrapLogName, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysUplinkRate=slmSysUplinkRate, slmSysLocation=slmSysLocation, slmChPassEntry=slmChPassEntry, slmSyslogPort=slmSyslogPort, slmAdmin=slmAdmin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogLevel=slmSyslogLevel, slmSysNetworkPrefix=slmSysNetworkPrefix, AdminAccess=AdminAccess, slmReadCommunity=slmReadCommunity, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogParam4=slmTrapLogParam4, slmTrapEnable=slmTrapEnable, slmSwRevStatus=slmSwRevStatus, slmChPass=slmChPass, slmBoxSize=slmBoxSize, slmPortsNumber=slmPortsNumber, slmNetworkMode=slmNetworkMode, slmTrapDestIpAddress=slmTrapDestIpAddress, slmChPassNewPass=slmChPassNewPass, slmTrapLogParam6=slmTrapLogParam6, slmTrapPort=slmTrapPort, slmLicense=slmLicense, slmLogin=slmLogin, SoftwareRevision=SoftwareRevision, slmLicenseTable=slmLicenseTable, slMain=slMain, slmSwRevName=slmSwRevName, slmPsuNumber=slmPsuNumber, slmEdfaNumber=slmEdfaNumber, slmSwRevDirectory=slmSwRevDirectory, slmAdminRowStatus=slmAdminRowStatus, slmAuth=slmAuth, slmAuthLogin=slmAuthLogin, slmAuthPassword=slmAuthPassword, slmSysSnmpVersion=slmSysSnmpVersion, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapDestCommunity=slmTrapDestCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysAdminStatus=slmSysAdminStatus, slmSysMode=slmSysMode, slmSnmpv3Auth=slmSnmpv3Auth, UserLogin=UserLogin, UserCommunity=UserCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmOemType=slmOemType, slmTrapDestEntry=slmTrapDestEntry, slmLicenseEntry=slmLicenseEntry, slmConfigFile=slmConfigFile, slmSwRevTable=slmSwRevTable, slmSysTemperature=slmSysTemperature, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicenseIndex=slmLicenseIndex, slmAdminLogin=slmAdminLogin, slmAdminPassword=slmAdminPassword)
