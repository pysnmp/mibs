...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysOperStatus=slmSysOperStatus, slmOemType=slmOemType, slmAuthTable=slmAuthTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapSysNameChange=slmTrapSysNameChange, slmLogFile=slmLogFile, slmTrapDestCommunity=slmTrapDestCommunity, slmChPass=slmChPass, slmSysAdminStatus=slmSysAdminStatus, slmNetworkMode=slmNetworkMode, slmAuthCommunity=slmAuthCommunity, slmAdmin=slmAdmin, slmSysMode=slmSysMode, slmSysGatewayAddr=slmSysGatewayAddr, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestTable=slmTrapDestTable, slmChPassLogin=slmChPassLogin, slmTrapDestAddress=slmTrapDestAddress, slmAdminCommunity=slmAdminCommunity, slmSysTemperature=slmSysTemperature, slmLicenseExpiration=slmLicenseExpiration, slmVcatDelay=slmVcatDelay, slmTrapLogParam1=slmTrapLogParam1, slmSysLanIpAddr=slmSysLanIpAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapEnable=slmTrapEnable, slmChPassEntry=slmChPassEntry, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam2=slmTrapLogParam2, slmSwRevName=slmSwRevName, slmTrapLogParam3=slmTrapLogParam3, slmAdminAccess=slmAdminAccess, slmTrapLogParam5=slmTrapLogParam5, slmOpticalSwitchExist=slmOpticalSwitchExist, slmReadCommunity=slmReadCommunity, slmRebootDelay=slmRebootDelay, slmTrapUserAccess=slmTrapUserAccess, slmAuthPassword=slmAuthPassword, slmLicenseId=slmLicenseId, slmSwRevTable=slmSwRevTable, slmTrapLogName=slmTrapLogName, slmPmAvailable=slmPmAvailable, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestAddress=slmSyslogDestAddress, slmSysResetPm=slmSysResetPm, slmMuxNumber=slmMuxNumber, slmConfigSysUptime=slmConfigSysUptime, SoftwareRevision=SoftwareRevision, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slMain=slMain, slmTrapLogEntry=slmTrapLogEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmSwRevEntry=slmSwRevEntry, slmSys=slmSys, slmBoxSize=slmBoxSize, slmChPassNewPass=slmChPassNewPass, slmSysPmStartOfDay=slmSysPmStartOfDay, slmChPassTable=slmChPassTable, slmLogin=slmLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmTid=slmTid, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicenseEntry=slmLicenseEntry, slmAdminLogin=slmAdminLogin, slm40GConf=slm40GConf, slmSysAlmDeact=slmSysAlmDeact, slmTrapSysLocationChange=slmTrapSysLocationChange, slmEdfaNumber=slmEdfaNumber, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapCommunity=slmTrapCommunity, slmTrapDestRowStatus=slmTrapDestRowStatus, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogId=slmTrapLogId, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminTable=slmAdminTable, slmSwRevDate=slmSwRevDate, slmSysIpAddr=slmSysIpAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysLocation=slmSysLocation, slmConfigFile=slmConfigFile, slmAuthLogin=slmAuthLogin, slmAdminEntry=slmAdminEntry, slmSysAlmAct=slmSysAlmAct, UserPassword=UserPassword, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogTable=slmTrapLogTable, UserLogin=UserLogin, slmTrapLogParam4=slmTrapLogParam4, slmSysChassisId=slmSysChassisId, slmWriteCommunity=slmWriteCommunity, slmSysSubnetMask=slmSysSubnetMask, slmPortsNumber=slmPortsNumber, slmLicenseTable=slmLicenseTable, slmLicense=slmLicense, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogPort=slmSyslogPort, slmPsuNumber=slmPsuNumber, slmTrapPort=slmTrapPort, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmAuthEntry=slmAuthEntry, slmRstpEnabled=slmRstpEnabled, slmChPassOldPass=slmChPassOldPass, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogLevel=slmSyslogLevel, slmSwRevStatus=slmSwRevStatus, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestEntry=slmTrapDestEntry, slmSysUplinkRate=slmSysUplinkRate, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogParam6=slmTrapLogParam6, slmSysTrapFormat=slmSysTrapFormat, slmLicenseIndex=slmLicenseIndex, slmAuth=slmAuth, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminPassword=slmAdminPassword, slmTrap=slmTrap, UserCommunity=UserCommunity, slmTopologyEnabled=slmTopologyEnabled, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, AdminAccess=AdminAccess, slmSysName=slmSysName, slmTrapDestProtVersion=slmTrapDestProtVersion, PYSNMP_MODULE_ID=slMain)
