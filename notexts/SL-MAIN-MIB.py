...
Opaque, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, Counter64, ObjectIdentity, Unsigned32, NotificationType, iso, Bits, Counter32, Integer32, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "Counter64", "ObjectIdentity", "Unsigned32", "NotificationType", "iso", "Bits", "Counter32", "Integer32", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slm40GConf=slm40GConf, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogId=slmTrapLogId, slmSwRevEntry=slmSwRevEntry, slmMuxNumber=slmMuxNumber, slmAuthTable=slmAuthTable, slmSysTemperature=slmSysTemperature, slmTrap=slmTrap, slmChPass=slmChPass, slmSysAlmAct=slmSysAlmAct, slmTrapDestAddress=slmTrapDestAddress, slmConfigSysUptime=slmConfigSysUptime, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogParam2=slmTrapLogParam2, slmLicenseId=slmLicenseId, slmTrapDestEntry=slmTrapDestEntry, slmOemType=slmOemType, slmNetworkMode=slmNetworkMode, slmSysCalendarTime=slmSysCalendarTime, slmAdminPassword=slmAdminPassword, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestAddress=slmSyslogDestAddress, slmPsuNumber=slmPsuNumber, slmSysMode=slmSysMode, slmTrapLogParam6=slmTrapLogParam6, slmLicense=slmLicense, slmSyslogDestTable=slmSyslogDestTable, slmAuthLogin=slmAuthLogin, PYSNMP_MODULE_ID=slMain, slmSwRevTable=slmSwRevTable, slmTrapCommunity=slmTrapCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogParam3=slmTrapLogParam3, slmLicenseIndex=slmLicenseIndex, slmLicenseExpiration=slmLicenseExpiration, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestTable=slmTrapDestTable, slmSysLanIpAddr=slmSysLanIpAddr, slmChPassLogin=slmChPassLogin, slmTrapLogName=slmTrapLogName, slmAuth=slmAuth, slmSwRevDate=slmSwRevDate, slmAdminCommunity=slmAdminCommunity, slmSysTrapFormat=slmSysTrapFormat, slmSwRevStatus=slmSwRevStatus, slmAdmin=slmAdmin, slmSysChassisId=slmSysChassisId, slmReadCommunity=slmReadCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestCommunity=slmTrapDestCommunity, slmAuthPassword=slmAuthPassword, slmPortsNumber=slmPortsNumber, slmSyslogDestEntry=slmSyslogDestEntry, slmSysAlmDeact=slmSysAlmDeact, slmRebootDelay=slmRebootDelay, slmChPassTable=slmChPassTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysUplinkRate=slmSysUplinkRate, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapUserLogin=slmTrapUserLogin, slmSyslogLevel=slmSyslogLevel, slmLogin=slmLogin, slMain=slMain, slmChPassOldPass=slmChPassOldPass, slmAdminLogin=slmAdminLogin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLogFile=slmLogFile, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysLocation=slmSysLocation, slmTrapLogTable=slmTrapLogTable, slmAdminTable=slmAdminTable, slmSysAdminStatus=slmSysAdminStatus, slmEdfaNumber=slmEdfaNumber, slmSysSnmpVersion=slmSysSnmpVersion, slmBoxSize=slmBoxSize, slmSysLanSubnetAddr=slmSysLanSubnetAddr, UserLogin=UserLogin, slmSyslogPort=slmSyslogPort, slmTrapEnable=slmTrapEnable, slmLicenseEntry=slmLicenseEntry, slmPmAvailable=slmPmAvailable, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTopologyEnabled=slmTopologyEnabled, UserPassword=UserPassword, slmLicenseTable=slmLicenseTable, slmAdminAccess=slmAdminAccess, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSys=slmSys, slmSysIpAddr=slmSysIpAddr, slmTid=slmTid, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam4=slmTrapLogParam4, slmSysOperStatus=slmSysOperStatus, slmTrapUserAccess=slmTrapUserAccess, slmAdminEntry=slmAdminEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysName=slmSysName, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapPort=slmTrapPort, slmRstpEnabled=slmRstpEnabled, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogParam5=slmTrapLogParam5, slmSysResetPm=slmSysResetPm, slmSysSubnetMask=slmSysSubnetMask, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam1=slmTrapLogParam1, slmSysPmStartOfDay=slmSysPmStartOfDay, slmConfigFile=slmConfigFile, AdminAccess=AdminAccess, UserCommunity=UserCommunity, slmChPassNewPass=slmChPassNewPass, slmAuthEntry=slmAuthEntry, slmAuthCommunity=slmAuthCommunity, slmVcatDelay=slmVcatDelay, slmSwRevName=slmSwRevName, slmChPassEntry=slmChPassEntry, SoftwareRevision=SoftwareRevision)
