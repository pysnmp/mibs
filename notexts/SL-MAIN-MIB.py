...
Gauge32, Opaque, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, NotificationType, Counter64, Unsigned32, TimeTicks, ObjectIdentity, IpAddress, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Opaque", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "NotificationType", "Counter64", "Unsigned32", "TimeTicks", "ObjectIdentity", "IpAddress", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slMain=slMain, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogParam5=slmTrapLogParam5, slmTrapCommunity=slmTrapCommunity, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminPassword=slmAdminPassword, slmSysMode=slmSysMode, slmSwRevStatus=slmSwRevStatus, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam4=slmTrapLogParam4, slmSyslogLevel=slmSyslogLevel, slmTrapSysNameChange=slmTrapSysNameChange, slmSysAdminStatus=slmSysAdminStatus, slmConfigFile=slmConfigFile, slmEdfaNumber=slmEdfaNumber, slmTrapDestIpAddress=slmTrapDestIpAddress, slmMuxNumber=slmMuxNumber, slmSysChassisId=slmSysChassisId, slmChPass=slmChPass, slmAdminTable=slmAdminTable, slmTrapLogParam3=slmTrapLogParam3, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysTrapFormat=slmSysTrapFormat, slmAuthPassword=slmAuthPassword, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysOperStatus=slmSysOperStatus, slmLicenseIndex=slmLicenseIndex, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLicenseExpiration=slmLicenseExpiration, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapUserLogin=slmTrapUserLogin, slmChPassOldPass=slmChPassOldPass, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysGatewayAddr=slmSysGatewayAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevEntry=slmSwRevEntry, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestTable=slmTrapDestTable, slmRstpEnabled=slmRstpEnabled, slmSysTemperature=slmSysTemperature, slmTrapUserAccess=slmTrapUserAccess, slmLicenseEntry=slmLicenseEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmWriteCommunity=slmWriteCommunity, slmSyslogPort=slmSyslogPort, slmTrapDestRowStatus=slmTrapDestRowStatus, slmConfigSysSignalType=slmConfigSysSignalType, slmSysUplinkRate=slmSysUplinkRate, slmSysLocation=slmSysLocation, slmAdminAccess=slmAdminAccess, PYSNMP_MODULE_ID=slMain, slmChPassEntry=slmChPassEntry, slmAdminCommunity=slmAdminCommunity, slmTrapDestAddress=slmTrapDestAddress, slmSyslogDestTable=slmSyslogDestTable, slmLicenseTable=slmLicenseTable, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmConfigSysUptime=slmConfigSysUptime, slmBoxSize=slmBoxSize, slmChPassNewPass=slmChPassNewPass, slmTrap=slmTrap, slmAuthTable=slmAuthTable, slmSysIpAddr=slmSysIpAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmPmAvailable=slmPmAvailable, slmPsuNumber=slmPsuNumber, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTid=slmTid, slmTrapLogName=slmTrapLogName, slmChPassLogin=slmChPassLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevName=slmSwRevName, slmSysCalendarTime=slmSysCalendarTime, UserPassword=UserPassword, slmSysSnmpVersion=slmSysSnmpVersion, slmLicense=slmLicense, UserCommunity=UserCommunity, slmTrapLogParam1=slmTrapLogParam1, slmRebootDelay=slmRebootDelay, slm40GConf=slm40GConf, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAuth=slmAuth, slmSyslogDestAddress=slmSyslogDestAddress, slmSysSubnetMask=slmSysSubnetMask, slmSwRevTable=slmSwRevTable, slmLogFile=slmLogFile, slmAdminEntry=slmAdminEntry, slmTrapLogTable=slmTrapLogTable, slmTrapLogEntry=slmTrapLogEntry, slmSys=slmSys, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapEnable=slmTrapEnable, slmAuthLogin=slmAuthLogin, slmAdmin=slmAdmin, slmSnmpv3Password=slmSnmpv3Password, slmAdminLogin=slmAdminLogin, slmAuthEntry=slmAuthEntry, AdminAccess=AdminAccess, slmAdminRowStatus=slmAdminRowStatus, slmTopologyEnabled=slmTopologyEnabled, slmSysLanIpAddr=slmSysLanIpAddr, slmPortsNumber=slmPortsNumber, slmVcatDelay=slmVcatDelay, slmTrapLogId=slmTrapLogId, slmSysResetPm=slmSysResetPm, slmTrapPort=slmTrapPort, slmTrapLogParam2=slmTrapLogParam2, slmSwRevDate=slmSwRevDate, slmLogin=slmLogin, slmChPassTable=slmChPassTable, slmSysName=slmSysName, SoftwareRevision=SoftwareRevision, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysAlmAct=slmSysAlmAct, slmSysAlmDeact=slmSysAlmDeact, slmReadCommunity=slmReadCommunity, slmTrapDestEntry=slmTrapDestEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, UserLogin=UserLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmOemType=slmOemType, slmNetworkMode=slmNetworkMode, slmLicenseId=slmLicenseId)
