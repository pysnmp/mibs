...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestEntry=slmTrapDestEntry, slmAuthLogin=slmAuthLogin, slmTrapLogParam3=slmTrapLogParam3, slmLogin=slmLogin, slmSysIpAddr=slmSysIpAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapPort=slmTrapPort, slmPortsNumber=slmPortsNumber, slmLicenseEntry=slmLicenseEntry, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogTable=slmTrapLogTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSys=slmSys, slmAdminTable=slmAdminTable, slmAuthEntry=slmAuthEntry, slmConfigFile=slmConfigFile, slmSysSubnetMask=slmSysSubnetMask, slmAdminAccess=slmAdminAccess, PYSNMP_MODULE_ID=slMain, slmLicenseIndex=slmLicenseIndex, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapUserLogin=slmTrapUserLogin, slmChPassEntry=slmChPassEntry, slmChPassLogin=slmChPassLogin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLicenseId=slmLicenseId, slMain=slMain, slmAuth=slmAuth, slmOemType=slmOemType, slmAuthCommunity=slmAuthCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysResetPm=slmSysResetPm, slmWriteCommunity=slmWriteCommunity, slmChPassNewPass=slmChPassNewPass, slmAdminCommunity=slmAdminCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestCommunity=slmTrapDestCommunity, slmSysAdminStatus=slmSysAdminStatus, slmLicenseTable=slmLicenseTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysAlmAct=slmSysAlmAct, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmMuxNumber=slmMuxNumber, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogEntry=slmTrapLogEntry, slmSwRevEntry=slmSwRevEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogName=slmTrapLogName, slmTrapLogParam2=slmTrapLogParam2, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam5=slmTrapLogParam5, slmReadCommunity=slmReadCommunity, slmChPassOldPass=slmChPassOldPass, slmSyslogDestAddress=slmSyslogDestAddress, slmSnmpv3Password=slmSnmpv3Password, slmSnmpv3Auth=slmSnmpv3Auth, slmSysAlmDeact=slmSysAlmDeact, slmAdminLogin=slmAdminLogin, slmSwRevTable=slmSwRevTable, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogParam6=slmTrapLogParam6, slmSysLocation=slmSysLocation, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysMode=slmSysMode, slmAdmin=slmAdmin, slmEdfaNumber=slmEdfaNumber, slmConfigSysUptime=slmConfigSysUptime, slmAuthPassword=slmAuthPassword, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogPort=slmSyslogPort, slmSysTrapFormat=slmSysTrapFormat, slmConfigSysSignalType=slmConfigSysSignalType, slmPmAvailable=slmPmAvailable, slmTrapUserAccess=slmTrapUserAccess, slmSysCalendarTime=slmSysCalendarTime, slmAdminEntry=slmAdminEntry, slmVcatDelay=slmVcatDelay, SoftwareRevision=SoftwareRevision, slmTrapCommunity=slmTrapCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrap=slmTrap, slmSwRevStatus=slmSwRevStatus, slmSysOperStatus=slmSysOperStatus, slmTid=slmTid, slmSwRevDirectory=slmSwRevDirectory, slmChPassTable=slmChPassTable, slmSysUplinkRate=slmSysUplinkRate, slmPsuNumber=slmPsuNumber, slmSyslogDestTable=slmSyslogDestTable, slmSysSnmpVersion=slmSysSnmpVersion, slmRstpEnabled=slmRstpEnabled, slmTrapEnable=slmTrapEnable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTopologyEnabled=slmTopologyEnabled, slmAdminPassword=slmAdminPassword, slmTrapDestAddress=slmTrapDestAddress, UserLogin=UserLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPass=slmChPass, slmTrapDestTable=slmTrapDestTable, slmLicense=slmLicense, slmTrapDestIpAddress=slmTrapDestIpAddress, UserPassword=UserPassword, slmTrapLogId=slmTrapLogId, slm40GConf=slm40GConf, slmAuthTable=slmAuthTable, slmSysName=slmSysName, UserCommunity=UserCommunity, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysTemperature=slmSysTemperature, slmSwRevName=slmSwRevName, slmNetworkMode=slmNetworkMode, slmSwRevDate=slmSwRevDate, AdminAccess=AdminAccess, slmBoxSize=slmBoxSize, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam4=slmTrapLogParam4, slmLogFile=slmLogFile, slmSysGatewayAddr=slmSysGatewayAddr, slmSyslogLevel=slmSyslogLevel, slmSysChassisId=slmSysChassisId, slmAdminRowStatus=slmAdminRowStatus, slmRebootDelay=slmRebootDelay, slmSyslogDestEntry=slmSyslogDestEntry)
