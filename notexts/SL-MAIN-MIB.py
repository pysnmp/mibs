...
Counter32, Counter64, Unsigned32, iso, ObjectIdentity, Gauge32, Opaque, Integer32, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "Unsigned32", "iso", "ObjectIdentity", "Gauge32", "Opaque", "Integer32", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmNetworkMode=slmNetworkMode, slmTrapLogParam6=slmTrapLogParam6, slmSyslogPort=slmSyslogPort, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysAdminStatus=slmSysAdminStatus, slmRebootDelay=slmRebootDelay, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam1=slmTrapLogParam1, slmConfigFile=slmConfigFile, UserCommunity=UserCommunity, slmSysChassisId=slmSysChassisId, slmPmAvailable=slmPmAvailable, slmTrapPort=slmTrapPort, slmSysSubnetMask=slmSysSubnetMask, slmSwRevEntry=slmSwRevEntry, slmSysCalendarTime=slmSysCalendarTime, slmSysSnmpVersion=slmSysSnmpVersion, slmLicenseIndex=slmLicenseIndex, slmLicenseId=slmLicenseId, UserLogin=UserLogin, slmChPassTable=slmChPassTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapUserAccess=slmTrapUserAccess, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSwRevDate=slmSwRevDate, slmSysIpAddr=slmSysIpAddr, slmRstpEnabled=slmRstpEnabled, slmChPass=slmChPass, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicense=slmLicense, slmTrapLogParam4=slmTrapLogParam4, slm40GConf=slm40GConf, slmLicenseEntry=slmLicenseEntry, slmTrapEnable=slmTrapEnable, slmLogin=slmLogin, slmChPassLogin=slmChPassLogin, slmTrapLogId=slmTrapLogId, slmAdminLogin=slmAdminLogin, slmSysName=slmSysName, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestTable=slmSyslogDestTable, slmTrap=slmTrap, slmSysTrapFormat=slmSysTrapFormat, slmAdminEntry=slmAdminEntry, slmSyslogLevel=slmSyslogLevel, PYSNMP_MODULE_ID=slMain, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam2=slmTrapLogParam2, slmSysEncryptionCapability=slmSysEncryptionCapability, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapSysNameChange=slmTrapSysNameChange, slmSysUplinkRate=slmSysUplinkRate, slmAdminCommunity=slmAdminCommunity, slmSysAlmDeact=slmSysAlmDeact, slmAuthLogin=slmAuthLogin, slmTrapLogName=slmTrapLogName, slmAuthPassword=slmAuthPassword, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminAccess=slmAdminAccess, slmTrapDestEntry=slmTrapDestEntry, slmLicenseExpiration=slmLicenseExpiration, slmSys=slmSys, slmReadCommunity=slmReadCommunity, slmSysTemperature=slmSysTemperature, slmAuth=slmAuth, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmPortsNumber=slmPortsNumber, slmTopologyEnabled=slmTopologyEnabled, slmSwRevTable=slmSwRevTable, slmSnmpv3Auth=slmSnmpv3Auth, slmSwRevName=slmSwRevName, slmAuthTable=slmAuthTable, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestCommunity=slmTrapDestCommunity, AdminAccess=AdminAccess, slmTid=slmTid, slmSysMode=slmSysMode, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysResetPm=slmSysResetPm, slmAdminPassword=slmAdminPassword, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmWriteCommunity=slmWriteCommunity, slmBoxSize=slmBoxSize, slmSnmpv3Password=slmSnmpv3Password, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestAddress=slmTrapDestAddress, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmVcatDelay=slmVcatDelay, slmTrapLogParam5=slmTrapLogParam5, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysLocation=slmSysLocation, slmSyslogDestEntry=slmSyslogDestEntry, slmChPassNewPass=slmChPassNewPass, slmLogFile=slmLogFile, UserPassword=UserPassword, SoftwareRevision=SoftwareRevision, slmPsuNumber=slmPsuNumber, slmSwRevStatus=slmSwRevStatus, slmAdminTable=slmAdminTable, slmAuthCommunity=slmAuthCommunity, slmChPassOldPass=slmChPassOldPass, slmAuthEntry=slmAuthEntry, slmMuxNumber=slmMuxNumber, slmTrapLogTable=slmTrapLogTable, slmTrapLogEntry=slmTrapLogEntry, slmOemType=slmOemType, slmSysAlmAct=slmSysAlmAct, slmChPassEntry=slmChPassEntry, slmLicenseTable=slmLicenseTable, slmTrapCommunity=slmTrapCommunity, slmSnmpv3Priv=slmSnmpv3Priv, slmAdmin=slmAdmin, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam3=slmTrapLogParam3, slMain=slMain, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmEdfaNumber=slmEdfaNumber, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr)
