...
Gauge32, Unsigned32, ObjectIdentity, iso, ModuleIdentity, Integer32, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Opaque, NotificationType, Counter32, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "ObjectIdentity", "iso", "ModuleIdentity", "Integer32", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Opaque", "NotificationType", "Counter32", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicenseEntry=slmLicenseEntry, slmSysIpAddr=slmSysIpAddr, slmTrapLogTable=slmTrapLogTable, slmSysOperStatus=slmSysOperStatus, slm40GConf=slm40GConf, slmAuthLogin=slmAuthLogin, slmSwRevDate=slmSwRevDate, slmTrapLogName=slmTrapLogName, slmRebootDelay=slmRebootDelay, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam2=slmTrapLogParam2, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevName=slmSwRevName, UserPassword=UserPassword, slmAdminTable=slmAdminTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminLogin=slmAdminLogin, slmTrapDestAddress=slmTrapDestAddress, slmSysName=slmSysName, slmConfigSysSignalType=slmConfigSysSignalType, slmAuthTable=slmAuthTable, slmSysGatewayAddr=slmSysGatewayAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTid=slmTid, slmTrapDestCommunity=slmTrapDestCommunity, slmLicenseId=slmLicenseId, slmAdminEntry=slmAdminEntry, slmSysTrapFormat=slmSysTrapFormat, slmRstpEnabled=slmRstpEnabled, slmNetworkMode=slmNetworkMode, AdminAccess=AdminAccess, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLogFile=slmLogFile, slmSnmpv3Auth=slmSnmpv3Auth, slmReadCommunity=slmReadCommunity, slmAdminCommunity=slmAdminCommunity, slmAdminPassword=slmAdminPassword, slmEdfaNumber=slmEdfaNumber, slmTrapEnable=slmTrapEnable, slmTrapLogParam1=slmTrapLogParam1, slmSysEncryptionCapability=slmSysEncryptionCapability, slmChPassNewPass=slmChPassNewPass, slmLicense=slmLicense, slmSysCalendarTime=slmSysCalendarTime, slmSysResetPm=slmSysResetPm, slmVcatDelay=slmVcatDelay, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slMain=slMain, slmSysSnmpVersion=slmSysSnmpVersion, slmSysTemperature=slmSysTemperature, slmAuthEntry=slmAuthEntry, slmSwRevTable=slmSwRevTable, PYSNMP_MODULE_ID=slMain, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseIndex=slmLicenseIndex, slmSysLocation=slmSysLocation, slmSyslogLevel=slmSyslogLevel, slmSysMode=slmSysMode, slmSys=slmSys, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSwRevDirectory=slmSwRevDirectory, slmLicenseTable=slmLicenseTable, slmTrapLogId=slmTrapLogId, slmTrapCommunity=slmTrapCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmOemType=slmOemType, slmLicenseExpiration=slmLicenseExpiration, SoftwareRevision=SoftwareRevision, slmConfigFile=slmConfigFile, slmTrapUserLogin=slmTrapUserLogin, slmConfigSysUptime=slmConfigSysUptime, UserCommunity=UserCommunity, UserLogin=UserLogin, slmPsuNumber=slmPsuNumber, slmSyslogDestAddress=slmSyslogDestAddress, slmSysAlmAct=slmSysAlmAct, slmSwRevStatus=slmSwRevStatus, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestRowStatus=slmTrapDestRowStatus, slmPmAvailable=slmPmAvailable, slmTrapDestTable=slmTrapDestTable, slmChPassTable=slmChPassTable, slmSysLanIpAddr=slmSysLanIpAddr, slmTrap=slmTrap, slmLogin=slmLogin, slmTrapUserAccess=slmTrapUserAccess, slmChPassOldPass=slmChPassOldPass, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminRowStatus=slmAdminRowStatus, slmSysSubnetMask=slmSysSubnetMask, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmChPassLogin=slmChPassLogin, slmChPass=slmChPass, slmSysAdminStatus=slmSysAdminStatus, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapPort=slmTrapPort, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdmin=slmAdmin, slmSyslogPort=slmSyslogPort, slmBoxSize=slmBoxSize, slmWriteCommunity=slmWriteCommunity, slmMuxNumber=slmMuxNumber, slmTrapDestEntry=slmTrapDestEntry, slmAuthCommunity=slmAuthCommunity, slmSysUplinkRate=slmSysUplinkRate, slmChPassEntry=slmChPassEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogParam4=slmTrapLogParam4, slmPortsNumber=slmPortsNumber, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam3=slmTrapLogParam3, slmTrapSysNameChange=slmTrapSysNameChange, slmSysAlmDeact=slmSysAlmDeact, slmTopologyEnabled=slmTopologyEnabled, slmSnmpv3Password=slmSnmpv3Password, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuthPassword=slmAuthPassword, slmAdminAccess=slmAdminAccess, slmSysChassisId=slmSysChassisId, slmSwRevEntry=slmSwRevEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogDestEntry=slmSyslogDestEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAuth=slmAuth)
