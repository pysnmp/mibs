...
ObjectIdentity, Counter64, TimeTicks, Gauge32, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, Unsigned32, Opaque, iso, Counter32, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "TimeTicks", "Gauge32", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "Unsigned32", "Opaque", "iso", "Counter32", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmReadCommunity=slmReadCommunity, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPassEntry=slmChPassEntry, slmSnmpv3Auth=slmSnmpv3Auth, SoftwareRevision=SoftwareRevision, slmBoxSize=slmBoxSize, slmTrapDestEntry=slmTrapDestEntry, slmSysIpAddr=slmSysIpAddr, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminLogin=slmAdminLogin, slmLogFile=slmLogFile, slmSysAlmDeact=slmSysAlmDeact, slmWriteCommunity=slmWriteCommunity, slmConfigSysUptime=slmConfigSysUptime, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysResetPm=slmSysResetPm, slmConfigSysSignalType=slmConfigSysSignalType, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapCommunity=slmTrapCommunity, slmVcatDelay=slmVcatDelay, slmSwRevEntry=slmSwRevEntry, slmAdminPassword=slmAdminPassword, slmLicenseId=slmLicenseId, slmPsuNumber=slmPsuNumber, slmAuth=slmAuth, slmTrapLogName=slmTrapLogName, slmTrapDestAddress=slmTrapDestAddress, AdminAccess=AdminAccess, slmSwRevTable=slmSwRevTable, slmLogin=slmLogin, slmAdminCommunity=slmAdminCommunity, slmSyslogLevel=slmSyslogLevel, slmSysSnmpVersion=slmSysSnmpVersion, slmSysSubnetMask=slmSysSubnetMask, slmSysCalendarTime=slmSysCalendarTime, UserCommunity=UserCommunity, slmSwRevName=slmSwRevName, slmTrapLogTable=slmTrapLogTable, slmSysAlmAct=slmSysAlmAct, slmAuthTable=slmAuthTable, slmSysTemperature=slmSysTemperature, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmSysLocation=slmSysLocation, slmSyslogDestAddress=slmSyslogDestAddress, slmTid=slmTid, slmTrapSysNameChange=slmTrapSysNameChange, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSwRevDate=slmSwRevDate, slmAuthPassword=slmAuthPassword, slmEdfaNumber=slmEdfaNumber, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam4=slmTrapLogParam4, slmTopologyEnabled=slmTopologyEnabled, slmConfigFile=slmConfigFile, slmSysUplinkRate=slmSysUplinkRate, slMain=slMain, slmSysGatewayAddr=slmSysGatewayAddr, slmSysMode=slmSysMode, slmAuthEntry=slmAuthEntry, slmTrapPort=slmTrapPort, slmChPassTable=slmChPassTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSys=slmSys, UserPassword=UserPassword, slmSysOperStatus=slmSysOperStatus, slmRebootDelay=slmRebootDelay, slmLicenseExpiration=slmLicenseExpiration, slmLicenseEntry=slmLicenseEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam2=slmTrapLogParam2, slmSysName=slmSysName, slmChPassNewPass=slmChPassNewPass, slmChPass=slmChPass, slmMuxNumber=slmMuxNumber, slmTrapEnable=slmTrapEnable, slmTrap=slmTrap, slmNetworkMode=slmNetworkMode, slmLicenseTable=slmLicenseTable, slmAdmin=slmAdmin, slmSwRevStatus=slmSwRevStatus, slmOpticalSwitchExist=slmOpticalSwitchExist, slmPmAvailable=slmPmAvailable, slmTrapUserAccess=slmTrapUserAccess, slmSysLanIpAddr=slmSysLanIpAddr, slmAuthLogin=slmAuthLogin, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapDestTable=slmTrapDestTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogDestTable=slmSyslogDestTable, slmChPassLogin=slmChPassLogin, slmSyslogPort=slmSyslogPort, slmTrapLogParam6=slmTrapLogParam6, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysChassisId=slmSysChassisId, slmLicenseIndex=slmLicenseIndex, slmOemType=slmOemType, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam3=slmTrapLogParam3, slmAdminAccess=slmAdminAccess, slmTrapLogParam1=slmTrapLogParam1, slmSnmpv3Priv=slmSnmpv3Priv, slmSysAdminStatus=slmSysAdminStatus, slmSwRevDirectory=slmSwRevDirectory, slmAdminRowStatus=slmAdminRowStatus, slmTrapUserLogin=slmTrapUserLogin, UserLogin=UserLogin, slmSnmpv3Password=slmSnmpv3Password, slmRstpEnabled=slmRstpEnabled, slmChPassOldPass=slmChPassOldPass, slmTrapLogId=slmTrapLogId, slmTrapSysLocationChange=slmTrapSysLocationChange, slm40GConf=slm40GConf, slmPortsNumber=slmPortsNumber, slmAdminEntry=slmAdminEntry, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam5=slmTrapLogParam5, PYSNMP_MODULE_ID=slMain, slmLicense=slmLicense, slmAdminTable=slmAdminTable)
