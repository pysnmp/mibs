...
MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, Unsigned32, TimeTicks, Integer32, NotificationType, Counter32, MibIdentifier, ModuleIdentity, Bits, iso, Gauge32, ObjectIdentity, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "Unsigned32", "TimeTicks", "Integer32", "NotificationType", "Counter32", "MibIdentifier", "ModuleIdentity", "Bits", "iso", "Gauge32", "ObjectIdentity", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPass=slmChPass, slmRebootDelay=slmRebootDelay, slmTid=slmTid, slmLicenseId=slmLicenseId, slmTrapLogParam6=slmTrapLogParam6, slmSysAlmAct=slmSysAlmAct, slmChPassEntry=slmChPassEntry, slmSyslogDestTable=slmSyslogDestTable, slmSysTrapFormat=slmSysTrapFormat, slmChPassOldPass=slmChPassOldPass, slmTrapDestCommunity=slmTrapDestCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogParam4=slmTrapLogParam4, slmAuthTable=slmAuthTable, slmTrapLogEntry=slmTrapLogEntry, slmAdmin=slmAdmin, slmBoxSize=slmBoxSize, slmTrapDestTable=slmTrapDestTable, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam2=slmTrapLogParam2, slmSysAdminStatus=slmSysAdminStatus, UserLogin=UserLogin, slmSysChassisId=slmSysChassisId, slmTrapLogParam3=slmTrapLogParam3, slmPsuNumber=slmPsuNumber, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysResetPm=slmSysResetPm, slmTrap=slmTrap, slmSwRevName=slmSwRevName, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicenseEntry=slmLicenseEntry, slmAuthLogin=slmAuthLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminRowStatus=slmAdminRowStatus, slMain=slMain, slmAdminCommunity=slmAdminCommunity, slmChPassLogin=slmChPassLogin, slmTrapLogParam5=slmTrapLogParam5, slmSwRevStatus=slmSwRevStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevEntry=slmSwRevEntry, slmPmAvailable=slmPmAvailable, PYSNMP_MODULE_ID=slMain, slmSysUplinkRate=slmSysUplinkRate, slmTopologyEnabled=slmTopologyEnabled, slmPortsNumber=slmPortsNumber, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSwRevTable=slmSwRevTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicenseExpiration=slmLicenseExpiration, slmMuxNumber=slmMuxNumber, slmSysName=slmSysName, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuthPassword=slmAuthPassword, slmSwRevDirectory=slmSwRevDirectory, SoftwareRevision=SoftwareRevision, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapPort=slmTrapPort, slm40GConf=slm40GConf, slmSysAlmDeact=slmSysAlmDeact, slmAdminAccess=slmAdminAccess, slmSysGatewayAddr=slmSysGatewayAddr, AdminAccess=AdminAccess, slmSysLocation=slmSysLocation, slmSysTemperature=slmSysTemperature, slmAuthEntry=slmAuthEntry, slmSysIpAddr=slmSysIpAddr, UserCommunity=UserCommunity, slmSysOperStatus=slmSysOperStatus, UserPassword=UserPassword, slmTrapLogParam1=slmTrapLogParam1, slmSysSnmpVersion=slmSysSnmpVersion, slmChPassNewPass=slmChPassNewPass, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminEntry=slmAdminEntry, slmVcatDelay=slmVcatDelay, slmOemType=slmOemType, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicenseTable=slmLicenseTable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmReadCommunity=slmReadCommunity, slmAuthCommunity=slmAuthCommunity, slmSysCalendarTime=slmSysCalendarTime, slmSyslogPort=slmSyslogPort, slmSysMode=slmSysMode, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysLanIpAddr=slmSysLanIpAddr, slmSnmpv3Password=slmSnmpv3Password, slmLogin=slmLogin, slmAuth=slmAuth, slmSyslogLevel=slmSyslogLevel, slmAdminTable=slmAdminTable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAdminPassword=slmAdminPassword, slmTrapUserLogin=slmTrapUserLogin, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogTable=slmTrapLogTable, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapSysNameChange=slmTrapSysNameChange, slmNetworkMode=slmNetworkMode, slmTrapLogId=slmTrapLogId, slmWriteCommunity=slmWriteCommunity, slmSnmpv3Priv=slmSnmpv3Priv, slmSys=slmSys, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogName=slmTrapLogName, slmTrapUserAccess=slmTrapUserAccess, slmTrapEnable=slmTrapEnable, slmConfigFile=slmConfigFile, slmSysSubnetMask=slmSysSubnetMask, slmRstpEnabled=slmRstpEnabled, slmSyslogDestEntry=slmSyslogDestEntry, slmLogFile=slmLogFile, slmChPassTable=slmChPassTable, slmSwRevDate=slmSwRevDate, slmLicenseIndex=slmLicenseIndex, slmAdminLogin=slmAdminLogin, slmEdfaNumber=slmEdfaNumber, slmTrapDestAddress=slmTrapDestAddress, slmTrapCommunity=slmTrapCommunity, slmLicense=slmLicense)
