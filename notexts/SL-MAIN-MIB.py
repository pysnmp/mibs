...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogName=slmTrapLogName, slmConfigSysSignalType=slmConfigSysSignalType, slmPmAvailable=slmPmAvailable, slmSwRevStatus=slmSwRevStatus, slmSysCalendarTime=slmSysCalendarTime, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slMain=slMain, slmSnmpv3Priv=slmSnmpv3Priv, slmSysResetPm=slmSysResetPm, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminEntry=slmAdminEntry, slmSysChassisId=slmSysChassisId, slmTrapLogParam1=slmTrapLogParam1, slmSysAlmAct=slmSysAlmAct, slmAdminRowStatus=slmAdminRowStatus, slmTrapCommunity=slmTrapCommunity, slmTopologyEnabled=slmTopologyEnabled, slmSyslogPort=slmSyslogPort, slmWriteCommunity=slmWriteCommunity, slmBoxSize=slmBoxSize, slmSyslogDestIpAddress=slmSyslogDestIpAddress, SoftwareRevision=SoftwareRevision, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysAlmDeact=slmSysAlmDeact, slmAuthTable=slmAuthTable, slmSysPmStartOfDay=slmSysPmStartOfDay, slmChPassNewPass=slmChPassNewPass, slmSwRevDate=slmSwRevDate, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogDestTable=slmSyslogDestTable, slmRebootDelay=slmRebootDelay, slmAuthLogin=slmAuthLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLogin=slmLogin, slmTrapLogTable=slmTrapLogTable, PYSNMP_MODULE_ID=slMain, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapDestTable=slmTrapDestTable, slmAdminLogin=slmAdminLogin, UserPassword=UserPassword, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAuthPassword=slmAuthPassword, slmLicenseEntry=slmLicenseEntry, slmLicenseId=slmLicenseId, slmAuthEntry=slmAuthEntry, slmLicense=slmLicense, slmChPassTable=slmChPassTable, slmChPass=slmChPass, slmTrapSysNameChange=slmTrapSysNameChange, slmPsuNumber=slmPsuNumber, slmTrapDestEntry=slmTrapDestEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysTrapFormat=slmSysTrapFormat, slmAuthCommunity=slmAuthCommunity, slmSysAdminStatus=slmSysAdminStatus, slmLogFile=slmLogFile, slmTrapDestCommunity=slmTrapDestCommunity, slmAdminCommunity=slmAdminCommunity, slmNetworkMode=slmNetworkMode, slmSysIpAddr=slmSysIpAddr, slmConfigFile=slmConfigFile, slmTrapLogParam4=slmTrapLogParam4, slmSysLocation=slmSysLocation, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysOperStatus=slmSysOperStatus, slmSwRevEntry=slmSwRevEntry, slmSysTemperature=slmSysTemperature, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLicenseIndex=slmLicenseIndex, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, UserCommunity=UserCommunity, slmTrapEnable=slmTrapEnable, slmSnmpv3Password=slmSnmpv3Password, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam3=slmTrapLogParam3, slmSysSubnetMask=slmSysSubnetMask, slmAdmin=slmAdmin, slmAuth=slmAuth, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmVcatDelay=slmVcatDelay, slmAdminAccess=slmAdminAccess, slmTrapLogParam5=slmTrapLogParam5, slmSysUplinkRate=slmSysUplinkRate, slmMuxNumber=slmMuxNumber, slmTrapLogId=slmTrapLogId, slmChPassLogin=slmChPassLogin, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmOemType=slmOemType, slmTid=slmTid, slmTrap=slmTrap, slmReadCommunity=slmReadCommunity, slmTrapLogParam6=slmTrapLogParam6, slmLicenseTable=slmLicenseTable, UserLogin=UserLogin, slmRstpEnabled=slmRstpEnabled, slmSyslogLevel=slmSyslogLevel, AdminAccess=AdminAccess, slmConfigSysUptime=slmConfigSysUptime, slmTrapPort=slmTrapPort, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogEntry=slmTrapLogEntry, slmSysName=slmSysName, slmSysLanIpAddr=slmSysLanIpAddr, slmAdminTable=slmAdminTable, slmSwRevDirectory=slmSwRevDirectory, slmChPassEntry=slmChPassEntry, slmTrapDestAddress=slmTrapDestAddress, slmSysMode=slmSysMode, slm40GConf=slm40GConf, slmSwRevName=slmSwRevName, slmAdminPassword=slmAdminPassword, slmTrapUserLogin=slmTrapUserLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogParam2=slmTrapLogParam2, slmSnmpv3Auth=slmSnmpv3Auth, slmSys=slmSys, slmLicenseExpiration=slmLicenseExpiration, slmChPassOldPass=slmChPassOldPass, slmPortsNumber=slmPortsNumber, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSwRevTable=slmSwRevTable)
