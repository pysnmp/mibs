...
Integer32, IpAddress, iso, Gauge32, ModuleIdentity, Counter32, Unsigned32, TimeTicks, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Bits, Opaque, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "iso", "Gauge32", "ModuleIdentity", "Counter32", "Unsigned32", "TimeTicks", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Bits", "Opaque", "NotificationType")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSwRevEntry=slmSwRevEntry, slmTrapUserAccess=slmTrapUserAccess, UserLogin=UserLogin, slmTrapDestTable=slmTrapDestTable, slmLicenseIndex=slmLicenseIndex, slmSysResetPm=slmSysResetPm, slmSysAdminStatus=slmSysAdminStatus, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuth=slmAuth, slmReadCommunity=slmReadCommunity, UserPassword=UserPassword, slmSysLanIpAddr=slmSysLanIpAddr, slmTid=slmTid, slmAuthCommunity=slmAuthCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLogFile=slmLogFile, slmTrapUserLogin=slmTrapUserLogin, slmChPassNewPass=slmChPassNewPass, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysLocation=slmSysLocation, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapEnable=slmTrapEnable, slmLicenseId=slmLicenseId, slmSysOperStatus=slmSysOperStatus, slmTrapLogName=slmTrapLogName, slmTrapCommunity=slmTrapCommunity, slmLogin=slmLogin, slmSnmpv3Password=slmSnmpv3Password, slmSwRevStatus=slmSwRevStatus, slmSnmpv3Priv=slmSnmpv3Priv, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogParam5=slmTrapLogParam5, slmSysName=slmSysName, slmAuthPassword=slmAuthPassword, slmTrapLogParam2=slmTrapLogParam2, slmAdminLogin=slmAdminLogin, UserCommunity=UserCommunity, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysAlmAct=slmSysAlmAct, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminAccess=slmAdminAccess, slmSysAlmDeact=slmSysAlmDeact, slmChPassTable=slmChPassTable, slmTrap=slmTrap, slmSyslogPort=slmSyslogPort, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysChassisId=slmSysChassisId, slmSyslogDestEntry=slmSyslogDestEntry, slmSyslogLevel=slmSyslogLevel, slmConfigFile=slmConfigFile, slmConfigSysSignalType=slmConfigSysSignalType, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestEntry=slmTrapDestEntry, slmRebootDelay=slmRebootDelay, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysGatewayAddr=slmSysGatewayAddr, slmChPass=slmChPass, slmSwRevName=slmSwRevName, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminEntry=slmAdminEntry, slmSwRevDate=slmSwRevDate, slmAuthLogin=slmAuthLogin, slmWriteCommunity=slmWriteCommunity, slm40GConf=slm40GConf, slmNetworkMode=slmNetworkMode, slmMuxNumber=slmMuxNumber, slmLicenseTable=slmLicenseTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysIpAddr=slmSysIpAddr, slmAdminCommunity=slmAdminCommunity, slmLicenseExpiration=slmLicenseExpiration, slmPmAvailable=slmPmAvailable, slmSnmpv3Auth=slmSnmpv3Auth, slmConfigSysUptime=slmConfigSysUptime, slmLicenseEntry=slmLicenseEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysSubnetMask=slmSysSubnetMask, slMain=slMain, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminTable=slmAdminTable, slmRstpEnabled=slmRstpEnabled, slmTrapDestAddress=slmTrapDestAddress, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicense=slmLicense, slmSwRevTable=slmSwRevTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapPort=slmTrapPort, slmSys=slmSys, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogId=slmTrapLogId, slmTrapSysNameChange=slmTrapSysNameChange, slmBoxSize=slmBoxSize, SoftwareRevision=SoftwareRevision, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestCommunity=slmTrapDestCommunity, slmSysMode=slmSysMode, slmAdmin=slmAdmin, slmTrapLogParam4=slmTrapLogParam4, slmOemType=slmOemType, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogParam1=slmTrapLogParam1, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogEntry=slmTrapLogEntry, slmAuthTable=slmAuthTable, slmChPassOldPass=slmChPassOldPass, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam3=slmTrapLogParam3, slmTopologyEnabled=slmTopologyEnabled, PYSNMP_MODULE_ID=slMain, slmSysTemperature=slmSysTemperature, slmChPassLogin=slmChPassLogin, AdminAccess=AdminAccess, slmEdfaNumber=slmEdfaNumber, slmTrapLogTable=slmTrapLogTable, slmChPassEntry=slmChPassEntry, slmPortsNumber=slmPortsNumber, slmSyslogDestTable=slmSyslogDestTable, slmPsuNumber=slmPsuNumber, slmVcatDelay=slmVcatDelay, slmAuthEntry=slmAuthEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysUplinkRate=slmSysUplinkRate, slmAdminPassword=slmAdminPassword)
