...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPassTable=slmChPassTable, slmLicense=slmLicense, slmSysGatewayAddr=slmSysGatewayAddr, SoftwareRevision=SoftwareRevision, slmTrapUserAccess=slmTrapUserAccess, slMain=slMain, slmReadCommunity=slmReadCommunity, slmSysTrapFormat=slmSysTrapFormat, slmAuthCommunity=slmAuthCommunity, slmSysIpAddr=slmSysIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysTemperature=slmSysTemperature, slmTrapCommunity=slmTrapCommunity, slmAdminPassword=slmAdminPassword, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestEntry=slmTrapDestEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminRowStatus=slmAdminRowStatus, slmSysSnmpVersion=slmSysSnmpVersion, slmSysLanIpAddr=slmSysLanIpAddr, slmAdminAccess=slmAdminAccess, slmSysSubnetMask=slmSysSubnetMask, slmAuthPassword=slmAuthPassword, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapSysNameChange=slmTrapSysNameChange, slmSysChassisId=slmSysChassisId, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevTable=slmSwRevTable, slmSysAlmDeact=slmSysAlmDeact, slmAuthEntry=slmAuthEntry, slmSys=slmSys, slmChPassLogin=slmChPassLogin, slmSwRevDirectory=slmSwRevDirectory, slmChPassEntry=slmChPassEntry, slmSwRevEntry=slmSwRevEntry, slmBoxSize=slmBoxSize, slmTrapLogParam6=slmTrapLogParam6, slmSysName=slmSysName, PYSNMP_MODULE_ID=slMain, slmSwRevDate=slmSwRevDate, slmTid=slmTid, slmAdminCommunity=slmAdminCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuth=slmAuth, slmSyslogPort=slmSyslogPort, slmConfigSysSignalType=slmConfigSysSignalType, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapUserLogin=slmTrapUserLogin, slmRebootDelay=slmRebootDelay, UserCommunity=UserCommunity, slmLogFile=slmLogFile, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysEncryptionCapability=slmSysEncryptionCapability, slmWriteCommunity=slmWriteCommunity, slmSnmpv3Password=slmSnmpv3Password, slmChPassOldPass=slmChPassOldPass, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapDestCommunity=slmTrapDestCommunity, slmSysAdminStatus=slmSysAdminStatus, slmSyslogDestTable=slmSyslogDestTable, slmConfigFile=slmConfigFile, slmAuthLogin=slmAuthLogin, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysCalendarTime=slmSysCalendarTime, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmOemType=slmOemType, slmSwRevStatus=slmSwRevStatus, slmLicenseId=slmLicenseId, slmLicenseEntry=slmLicenseEntry, slmTrapLogParam1=slmTrapLogParam1, slmChPass=slmChPass, slmTrapLogTable=slmTrapLogTable, slmSysOperStatus=slmSysOperStatus, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysResetPm=slmSysResetPm, slmChPassNewPass=slmChPassNewPass, slmSysLocation=slmSysLocation, slmTrapLogParam5=slmTrapLogParam5, slmEdfaNumber=slmEdfaNumber, slmLogin=slmLogin, slmSysNetworkPrefix=slmSysNetworkPrefix, slmPsuNumber=slmPsuNumber, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysUplinkRate=slmSysUplinkRate, UserLogin=UserLogin, slmVcatDelay=slmVcatDelay, slmAdminLogin=slmAdminLogin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicenseTable=slmLicenseTable, slmSwRevName=slmSwRevName, slmSysMode=slmSysMode, slmPmAvailable=slmPmAvailable, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogName=slmTrapLogName, slmAdminEntry=slmAdminEntry, slm40GConf=slm40GConf, slmAdmin=slmAdmin, UserPassword=UserPassword, slmLicenseExpiration=slmLicenseExpiration, slmTrapDestAddress=slmTrapDestAddress, slmPortsNumber=slmPortsNumber, slmTrap=slmTrap, slmTrapPort=slmTrapPort, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam3=slmTrapLogParam3, slmMuxNumber=slmMuxNumber, slmAdminTable=slmAdminTable, slmLicenseIndex=slmLicenseIndex, AdminAccess=AdminAccess, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogId=slmTrapLogId, slmRstpEnabled=slmRstpEnabled, slmTrapLogParam2=slmTrapLogParam2, slmAuthTable=slmAuthTable, slmConfigSysUptime=slmConfigSysUptime, slmSnmpv3Auth=slmSnmpv3Auth, slmNetworkMode=slmNetworkMode, slmTrapDestTable=slmTrapDestTable, slmSyslogLevel=slmSyslogLevel, slmTrapEnable=slmTrapEnable, slmSysAlmAct=slmSysAlmAct)
