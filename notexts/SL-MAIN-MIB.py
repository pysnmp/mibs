...
Integer32, Opaque, TimeTicks, MibIdentifier, ModuleIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, Counter32, Counter64, Gauge32, Unsigned32, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Opaque", "TimeTicks", "MibIdentifier", "ModuleIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "Counter32", "Counter64", "Gauge32", "Unsigned32", "iso", "IpAddress")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestAddress=slmTrapDestAddress, slmOpticalSwitchExist=slmOpticalSwitchExist, slmReadCommunity=slmReadCommunity, slmSysAlmAct=slmSysAlmAct, slmTrapLogParam2=slmTrapLogParam2, slmSysMode=slmSysMode, slmSysGatewayAddr=slmSysGatewayAddr, UserPassword=UserPassword, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmEdfaNumber=slmEdfaNumber, slmAuthEntry=slmAuthEntry, slmPsuNumber=slmPsuNumber, slmSysTrapFormat=slmSysTrapFormat, slmSysResetPm=slmSysResetPm, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogParam5=slmTrapLogParam5, slmAdminPassword=slmAdminPassword, slmLogin=slmLogin, slmRebootDelay=slmRebootDelay, slmPortsNumber=slmPortsNumber, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAuth=slmAuth, slmSysLocation=slmSysLocation, slmTrapCommunity=slmTrapCommunity, slmAdminTable=slmAdminTable, slmChPassEntry=slmChPassEntry, slmLicenseTable=slmLicenseTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysUplinkRate=slmSysUplinkRate, UserLogin=UserLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestTable=slmTrapDestTable, slmSnmpv3Priv=slmSnmpv3Priv, slmLicenseEntry=slmLicenseEntry, slmSnmpv3Password=slmSnmpv3Password, slmSysSnmpVersion=slmSysSnmpVersion, SoftwareRevision=SoftwareRevision, slmSysIpAddr=slmSysIpAddr, slmSys=slmSys, slmConfigSysSignalType=slmConfigSysSignalType, slmTid=slmTid, slmTrapDestCommunity=slmTrapDestCommunity, slmLicenseId=slmLicenseId, slmSysAdminStatus=slmSysAdminStatus, slmSwRevDate=slmSwRevDate, slmSwRevName=slmSwRevName, slmSyslogDestEntry=slmSyslogDestEntry, slmChPassNewPass=slmChPassNewPass, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminEntry=slmAdminEntry, slmAuthPassword=slmAuthPassword, slmAuthLogin=slmAuthLogin, slmAuthTable=slmAuthTable, slmTrapEnable=slmTrapEnable, slmTrapPort=slmTrapPort, slmTrapLogParam4=slmTrapLogParam4, slmRstpEnabled=slmRstpEnabled, slmLicenseExpiration=slmLicenseExpiration, slmSysTemperature=slmSysTemperature, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam3=slmTrapLogParam3, slmSyslogPort=slmSyslogPort, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicense=slmLicense, slmSnmpv3Auth=slmSnmpv3Auth, slmLicenseIndex=slmLicenseIndex, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSwRevEntry=slmSwRevEntry, slmSysName=slmSysName, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminRowStatus=slmAdminRowStatus, slmConfigSysUptime=slmConfigSysUptime, slmTrapUserAccess=slmTrapUserAccess, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPass=slmChPass, slmSwRevDirectory=slmSwRevDirectory, slmTopologyEnabled=slmTopologyEnabled, PYSNMP_MODULE_ID=slMain, slmTrapDestEntry=slmTrapDestEntry, slmSwRevTable=slmSwRevTable, slmSysAlmDeact=slmSysAlmDeact, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmMuxNumber=slmMuxNumber, slmWriteCommunity=slmWriteCommunity, slmAdmin=slmAdmin, slmTrapLogName=slmTrapLogName, slmTrapLogParam1=slmTrapLogParam1, slmAdminCommunity=slmAdminCommunity, slmSysLanIpAddr=slmSysLanIpAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmChPassOldPass=slmChPassOldPass, slmOemType=slmOemType, slmSwRevStatus=slmSwRevStatus, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slMain=slMain, slmConfigFile=slmConfigFile, slmSysOperStatus=slmSysOperStatus, slmPmAvailable=slmPmAvailable, slmAdminAccess=slmAdminAccess, slmChPassTable=slmChPassTable, slmVcatDelay=slmVcatDelay, slmTrapLogId=slmTrapLogId, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSyslogLevel=slmSyslogLevel, slmTrap=slmTrap, slmLogFile=slmLogFile, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, UserCommunity=UserCommunity, slmTrapLogTable=slmTrapLogTable, slmChPassLogin=slmChPassLogin, slmSyslogDestAddress=slmSyslogDestAddress, slmSysChassisId=slmSysChassisId, slmAdminLogin=slmAdminLogin, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysSubnetMask=slmSysSubnetMask, AdminAccess=AdminAccess, slmTrapDestRowStatus=slmTrapDestRowStatus, slm40GConf=slm40GConf, slmBoxSize=slmBoxSize, slmTrapLogParam6=slmTrapLogParam6, slmAuthCommunity=slmAuthCommunity, slmNetworkMode=slmNetworkMode)
