...
ObjectIdentity, Opaque, Bits, ModuleIdentity, Integer32, IpAddress, MibIdentifier, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, Counter32, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Opaque", "Bits", "ModuleIdentity", "Integer32", "IpAddress", "MibIdentifier", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "Counter32", "Unsigned32", "iso")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSnmpv3Password=slmSnmpv3Password, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminLogin=slmAdminLogin, slmSysOperStatus=slmSysOperStatus, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapUserLogin=slmTrapUserLogin, slmConfigFile=slmConfigFile, slmRebootDelay=slmRebootDelay, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAuthLogin=slmAuthLogin, slmAdminTable=slmAdminTable, slmSysChassisId=slmSysChassisId, slmChPassEntry=slmChPassEntry, slmChPassLogin=slmChPassLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmWriteCommunity=slmWriteCommunity, slmSyslogPort=slmSyslogPort, PYSNMP_MODULE_ID=slMain, slmSyslogLevel=slmSyslogLevel, slmTopologyEnabled=slmTopologyEnabled, slmSwRevDirectory=slmSwRevDirectory, slmConfigSysSignalType=slmConfigSysSignalType, slmOemType=slmOemType, slmAdmin=slmAdmin, slmAdminPassword=slmAdminPassword, slmSyslogDestEntry=slmSyslogDestEntry, slmSysAdminStatus=slmSysAdminStatus, slmChPassNewPass=slmChPassNewPass, slmSnmpv3Priv=slmSnmpv3Priv, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTid=slmTid, slmSysLocation=slmSysLocation, slmTrapDestAddress=slmTrapDestAddress, slmChPassOldPass=slmChPassOldPass, slmSnmpv3Auth=slmSnmpv3Auth, slmSwRevName=slmSwRevName, slmMuxNumber=slmMuxNumber, slmTrapLogParam3=slmTrapLogParam3, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogTable=slmTrapLogTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestRowStatus=slmTrapDestRowStatus, slmNetworkMode=slmNetworkMode, slmAuthCommunity=slmAuthCommunity, slmSysIpAddr=slmSysIpAddr, AdminAccess=AdminAccess, slmLogFile=slmLogFile, slmVcatDelay=slmVcatDelay, slmAuthEntry=slmAuthEntry, slmReadCommunity=slmReadCommunity, slmLogin=slmLogin, slmTrapDestCommunity=slmTrapDestCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysUplinkRate=slmSysUplinkRate, slmLicenseEntry=slmLicenseEntry, slmSyslogDestTable=slmSyslogDestTable, slmTrapPort=slmTrapPort, slmSysSubnetMask=slmSysSubnetMask, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthTable=slmAuthTable, slmAdminCommunity=slmAdminCommunity, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSwRevStatus=slmSwRevStatus, slmPsuNumber=slmPsuNumber, slmSys=slmSys, slmSysCalendarTime=slmSysCalendarTime, UserCommunity=UserCommunity, slmPortsNumber=slmPortsNumber, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPass=slmChPass, slmTrapLogParam5=slmTrapLogParam5, slmSysEncryptionCapability=slmSysEncryptionCapability, UserPassword=UserPassword, slmSysAlmDeact=slmSysAlmDeact, slmAdminEntry=slmAdminEntry, UserLogin=UserLogin, slmBoxSize=slmBoxSize, slmAuthPassword=slmAuthPassword, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam4=slmTrapLogParam4, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysAlmAct=slmSysAlmAct, slmTrapLogId=slmTrapLogId, slmSysTemperature=slmSysTemperature, slmTrapEnable=slmTrapEnable, slmSyslogDestAddress=slmSyslogDestAddress, slmSwRevEntry=slmSwRevEntry, slmTrap=slmTrap, slmTrapCommunity=slmTrapCommunity, slmSwRevDate=slmSwRevDate, slm40GConf=slm40GConf, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysMode=slmSysMode, slmTrapLogParam2=slmTrapLogParam2, slmLicense=slmLicense, slmSwRevTable=slmSwRevTable, slmChPassTable=slmChPassTable, slmSysSnmpVersion=slmSysSnmpVersion, slmPmAvailable=slmPmAvailable, slmEdfaNumber=slmEdfaNumber, slmSysResetPm=slmSysResetPm, slmSysTrapFormat=slmSysTrapFormat, slmLicenseTable=slmLicenseTable, slmRstpEnabled=slmRstpEnabled, SoftwareRevision=SoftwareRevision, slmTrapLogParam6=slmTrapLogParam6, slmLicenseIndex=slmLicenseIndex, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogEntry=slmTrapLogEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogName=slmTrapLogName, slmTrapDestEntry=slmTrapDestEntry, slmSysName=slmSysName, slmAdminAccess=slmAdminAccess, slmTrapLogParam1=slmTrapLogParam1, slmLicenseExpiration=slmLicenseExpiration, slmLicenseId=slmLicenseId, slmTrapDestTable=slmTrapDestTable, slmAuth=slmAuth, slMain=slMain)
