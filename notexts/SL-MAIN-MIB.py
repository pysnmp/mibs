...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAuth=slmAuth, slmChPassLogin=slmChPassLogin, slmAuthEntry=slmAuthEntry, slmWriteCommunity=slmWriteCommunity, slmLogin=slmLogin, slmTrapLogEntry=slmTrapLogEntry, slmSwRevDate=slmSwRevDate, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapUserLogin=slmTrapUserLogin, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAuthCommunity=slmAuthCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapUserAccess=slmTrapUserAccess, slmTrapPort=slmTrapPort, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminPassword=slmAdminPassword, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapCommunity=slmTrapCommunity, slmAdminAccess=slmAdminAccess, slmSwRevEntry=slmSwRevEntry, slMain=slMain, slmSysIpAddr=slmSysIpAddr, slmLicenseIndex=slmLicenseIndex, slmLicenseTable=slmLicenseTable, slmSysUplinkRate=slmSysUplinkRate, slmTopologyEnabled=slmTopologyEnabled, UserCommunity=UserCommunity, slmOemType=slmOemType, slmAdminRowStatus=slmAdminRowStatus, slmAdminEntry=slmAdminEntry, slmAuthPassword=slmAuthPassword, slmSyslogDestTable=slmSyslogDestTable, slmPmAvailable=slmPmAvailable, slmTrapLogTable=slmTrapLogTable, slmSnmpv3Auth=slmSnmpv3Auth, slmConfigFile=slmConfigFile, slmTrapLogParam2=slmTrapLogParam2, slmSysOperStatus=slmSysOperStatus, slmChPassOldPass=slmChPassOldPass, slmLicenseExpiration=slmLicenseExpiration, slmSysMode=slmSysMode, SoftwareRevision=SoftwareRevision, slmTrapLogParam5=slmTrapLogParam5, slmSysActiveSwVersion=slmSysActiveSwVersion, slmVcatDelay=slmVcatDelay, slmAdminCommunity=slmAdminCommunity, slmSysAlmAct=slmSysAlmAct, slmNetworkMode=slmNetworkMode, slmRstpEnabled=slmRstpEnabled, slmSysChassisId=slmSysChassisId, slmEdfaNumber=slmEdfaNumber, slmSwRevDirectory=slmSwRevDirectory, PYSNMP_MODULE_ID=slMain, slmPortsNumber=slmPortsNumber, slmTrapDestAddress=slmTrapDestAddress, slmChPassTable=slmChPassTable, slmSyslogLevel=slmSyslogLevel, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmReadCommunity=slmReadCommunity, slmSwRevTable=slmSwRevTable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmChPassNewPass=slmChPassNewPass, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSys=slmSys, slmSysTrapFormat=slmSysTrapFormat, slmSwRevName=slmSwRevName, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminLogin=slmAdminLogin, slmSysLocation=slmSysLocation, slmTrapDestIpAddress=slmTrapDestIpAddress, slmConfigSysUptime=slmConfigSysUptime, UserLogin=UserLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestTable=slmTrapDestTable, slmChPass=slmChPass, slmTrapDestCommunity=slmTrapDestCommunity, slmTrap=slmTrap, slm40GConf=slm40GConf, slmTrapLogParam1=slmTrapLogParam1, slmSysLanIpAddr=slmSysLanIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, UserPassword=UserPassword, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSnmpv3Password=slmSnmpv3Password, slmTid=slmTid, AdminAccess=AdminAccess, slmSyslogPort=slmSyslogPort, slmSysSubnetMask=slmSysSubnetMask, slmLicense=slmLicense, slmAuthTable=slmAuthTable, slmPsuNumber=slmPsuNumber, slmTrapEnable=slmTrapEnable, slmTrapLogParam4=slmTrapLogParam4, slmSysCalendarTime=slmSysCalendarTime, slmLicenseId=slmLicenseId, slmBoxSize=slmBoxSize, slmMuxNumber=slmMuxNumber, slmAdminTable=slmAdminTable, slmRebootDelay=slmRebootDelay, slmTrapDestEntry=slmTrapDestEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmAdmin=slmAdmin, slmLogFile=slmLogFile, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysName=slmSysName, slmAuthLogin=slmAuthLogin, slmLicenseEntry=slmLicenseEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevStatus=slmSwRevStatus, slmChPassEntry=slmChPassEntry, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogParam6=slmTrapLogParam6, slmSysAlmDeact=slmSysAlmDeact, slmSysResetPm=slmSysResetPm, slmTrapLogId=slmTrapLogId, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogParam3=slmTrapLogParam3, slmSysTemperature=slmSysTemperature, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogName=slmTrapLogName)
