...
MibIdentifier, TimeTicks, Integer32, Bits, ModuleIdentity, Gauge32, NotificationType, Opaque, Counter64, Unsigned32, ObjectIdentity, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "Integer32", "Bits", "ModuleIdentity", "Gauge32", "NotificationType", "Opaque", "Counter64", "Unsigned32", "ObjectIdentity", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicenseTable=slmLicenseTable, slmTrapLogParam5=slmTrapLogParam5, slmReadCommunity=slmReadCommunity, slmConfigSysUptime=slmConfigSysUptime, slmAuthEntry=slmAuthEntry, slmAuthPassword=slmAuthPassword, slmSysLocation=slmSysLocation, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogTable=slmTrapLogTable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicenseEntry=slmLicenseEntry, slmTrapLogEntry=slmTrapLogEntry, slmSysIpAddr=slmSysIpAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapEnable=slmTrapEnable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevEntry=slmSwRevEntry, slmSysOperStatus=slmSysOperStatus, slmLicenseIndex=slmLicenseIndex, slmSwRevStatus=slmSwRevStatus, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam3=slmTrapLogParam3, slmSysTrapFormat=slmSysTrapFormat, slmAuth=slmAuth, slmLogFile=slmLogFile, slmEdfaNumber=slmEdfaNumber, slmSysName=slmSysName, slmSysResetPm=slmSysResetPm, slmNetworkMode=slmNetworkMode, slmSnmpv3Priv=slmSnmpv3Priv, slmAdmin=slmAdmin, slmSwRevDirectory=slmSwRevDirectory, slmLicenseExpiration=slmLicenseExpiration, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassLogin=slmChPassLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapSysNameChange=slmTrapSysNameChange, slmSysMode=slmSysMode, slmAdminAccess=slmAdminAccess, slmTrapLogTimeStamp=slmTrapLogTimeStamp, SoftwareRevision=SoftwareRevision, slmTrapLogName=slmTrapLogName, slmTrapDestTable=slmTrapDestTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapDestAddress=slmTrapDestAddress, slmSyslogLevel=slmSyslogLevel, slmChPass=slmChPass, slmTid=slmTid, slmTrapLogId=slmTrapLogId, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminEntry=slmAdminEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminPassword=slmAdminPassword, slmRstpEnabled=slmRstpEnabled, slmTrapLogParam1=slmTrapLogParam1, UserPassword=UserPassword, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogParam4=slmTrapLogParam4, slmSyslogPort=slmSyslogPort, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam6=slmTrapLogParam6, slmAuthLogin=slmAuthLogin, slmPmAvailable=slmPmAvailable, slmChPassOldPass=slmChPassOldPass, slmWriteCommunity=slmWriteCommunity, slmSysAlmDeact=slmSysAlmDeact, slmConfigFile=slmConfigFile, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestEntry=slmTrapDestEntry, slmSwRevDate=slmSwRevDate, slmSysUplinkRate=slmSysUplinkRate, slmSysCalendarTime=slmSysCalendarTime, slmChPassEntry=slmChPassEntry, PYSNMP_MODULE_ID=slMain, slmTrapDestCommunity=slmTrapDestCommunity, AdminAccess=AdminAccess, slmSysTemperature=slmSysTemperature, slmSyslogDestEntry=slmSyslogDestEntry, slmSysChassisId=slmSysChassisId, slmSysLanIpAddr=slmSysLanIpAddr, slm40GConf=slm40GConf, slmTrapCommunity=slmTrapCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmChPassNewPass=slmChPassNewPass, slmPsuNumber=slmPsuNumber, slmSwRevTable=slmSwRevTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmRebootDelay=slmRebootDelay, slmSys=slmSys, slmSysAdminStatus=slmSysAdminStatus, slmAdminCommunity=slmAdminCommunity, slmChPassTable=slmChPassTable, slmSnmpv3Password=slmSnmpv3Password, UserLogin=UserLogin, slmOemType=slmOemType, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, UserCommunity=UserCommunity, slmLicenseId=slmLicenseId, slmTrap=slmTrap, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam2=slmTrapLogParam2, slmSwRevName=slmSwRevName, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminLogin=slmAdminLogin, slmPortsNumber=slmPortsNumber, slmVcatDelay=slmVcatDelay, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapPort=slmTrapPort, slmLogin=slmLogin, slmBoxSize=slmBoxSize, slmSysAlmAct=slmSysAlmAct, slmSysSnmpVersion=slmSysSnmpVersion, slmTopologyEnabled=slmTopologyEnabled, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminRowStatus=slmAdminRowStatus, slmAuthTable=slmAuthTable, slmTrapUserLogin=slmTrapUserLogin, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapUserAccess=slmTrapUserAccess, slMain=slMain, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicense=slmLicense, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminTable=slmAdminTable, slmMuxNumber=slmMuxNumber)
