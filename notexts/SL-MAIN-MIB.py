...
iso, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, ModuleIdentity, ObjectIdentity, NotificationType, TimeTicks, IpAddress, Counter64, Unsigned32, Integer32, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "ModuleIdentity", "ObjectIdentity", "NotificationType", "TimeTicks", "IpAddress", "Counter64", "Unsigned32", "Integer32", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogTable=slmTrapLogTable, slmNetworkMode=slmNetworkMode, slmAdminPassword=slmAdminPassword, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmEdfaNumber=slmEdfaNumber, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmAuthCommunity=slmAuthCommunity, slmTid=slmTid, slmOemType=slmOemType, slmSyslogLevel=slmSyslogLevel, slmSysIpAddr=slmSysIpAddr, slmSys=slmSys, slmSnmpv3Priv=slmSnmpv3Priv, slmLicenseEntry=slmLicenseEntry, slmSysChassisId=slmSysChassisId, slmSyslogDestEntry=slmSyslogDestEntry, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogEntry=slmTrapLogEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmChPassOldPass=slmChPassOldPass, SoftwareRevision=SoftwareRevision, slmSysLocation=slmSysLocation, slmSwRevDirectory=slmSwRevDirectory, slmPortsNumber=slmPortsNumber, slmConfigFile=slmConfigFile, slmTrapLogParam5=slmTrapLogParam5, slmSysTemperature=slmSysTemperature, slmAdminEntry=slmAdminEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam2=slmTrapLogParam2, slmLicenseId=slmLicenseId, slmLogin=slmLogin, slmTrapCommunity=slmTrapCommunity, slmAdminLogin=slmAdminLogin, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestCommunity=slmTrapDestCommunity, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicenseIndex=slmLicenseIndex, slmSysLanIpAddr=slmSysLanIpAddr, slmWriteCommunity=slmWriteCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevName=slmSwRevName, slmSysSubnetMask=slmSysSubnetMask, slmVcatDelay=slmVcatDelay, slmTrapPort=slmTrapPort, slmReadCommunity=slmReadCommunity, slmChPassLogin=slmChPassLogin, slmAdminTable=slmAdminTable, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestTable=slmSyslogDestTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmMuxNumber=slmMuxNumber, slmTrapLogParam3=slmTrapLogParam3, slmChPass=slmChPass, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmBoxSize=slmBoxSize, slmRstpEnabled=slmRstpEnabled, slmLicenseExpiration=slmLicenseExpiration, slmAuthLogin=slmAuthLogin, slmChPassNewPass=slmChPassNewPass, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapUserAccess=slmTrapUserAccess, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAuthTable=slmAuthTable, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestEntry=slmTrapDestEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevEntry=slmSwRevEntry, slmAuthEntry=slmAuthEntry, slmSyslogPort=slmSyslogPort, slmSysMode=slmSysMode, slmAdminAccess=slmAdminAccess, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmRebootDelay=slmRebootDelay, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slMain=slMain, slmChPassTable=slmChPassTable, slmAdminRowStatus=slmAdminRowStatus, slmTrapEnable=slmTrapEnable, slmAdmin=slmAdmin, slmLogFile=slmLogFile, slmChPassEntry=slmChPassEntry, UserLogin=UserLogin, slmAdminCommunity=slmAdminCommunity, slmLicense=slmLicense, slm40GConf=slm40GConf, slmSwRevDate=slmSwRevDate, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestTable=slmTrapDestTable, slmSysOperStatus=slmSysOperStatus, slmPmAvailable=slmPmAvailable, slmPsuNumber=slmPsuNumber, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogName=slmTrapLogName, UserCommunity=UserCommunity, slmTrapLogParam6=slmTrapLogParam6, PYSNMP_MODULE_ID=slMain, slmTopologyEnabled=slmTopologyEnabled, AdminAccess=AdminAccess, slmTrapDestAddress=slmTrapDestAddress, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseTable=slmLicenseTable, slmSwRevTable=slmSwRevTable, slmSysResetPm=slmSysResetPm, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogId=slmTrapLogId, slmAuthPassword=slmAuthPassword, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogParam4=slmTrapLogParam4, slmSysAlmAct=slmSysAlmAct, slmTrap=slmTrap, UserPassword=UserPassword, slmSysName=slmSysName, slmSwRevStatus=slmSwRevStatus, slmSnmpv3Password=slmSnmpv3Password, slmAuth=slmAuth, slmSysActiveSwVersion=slmSysActiveSwVersion)
