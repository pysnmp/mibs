...
Gauge32, MibIdentifier, ModuleIdentity, Integer32, NotificationType, TimeTicks, ObjectIdentity, Counter32, Unsigned32, Bits, IpAddress, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "ModuleIdentity", "Integer32", "NotificationType", "TimeTicks", "ObjectIdentity", "Counter32", "Unsigned32", "Bits", "IpAddress", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSyslogLevel=slmSyslogLevel, slmSysCalendarTime=slmSysCalendarTime, slmSwRevStatus=slmSwRevStatus, slmSwRevTable=slmSwRevTable, slmEdfaNumber=slmEdfaNumber, slmAuth=slmAuth, slmTrapSysNameChange=slmTrapSysNameChange, slmSysResetPm=slmSysResetPm, slmSysSnmpVersion=slmSysSnmpVersion, slmSysAlmDeact=slmSysAlmDeact, slmAuthCommunity=slmAuthCommunity, slmTid=slmTid, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseExpiration=slmLicenseExpiration, UserLogin=UserLogin, slmSysAdminStatus=slmSysAdminStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogDestTable=slmSyslogDestTable, PYSNMP_MODULE_ID=slMain, slmTrapUserAccess=slmTrapUserAccess, slmTopologyEnabled=slmTopologyEnabled, slmAdminRowStatus=slmAdminRowStatus, slmAdminEntry=slmAdminEntry, slmTrapUserLogin=slmTrapUserLogin, slmPortsNumber=slmPortsNumber, slmChPassNewPass=slmChPassNewPass, slmTrapLogParam5=slmTrapLogParam5, slmSyslogPort=slmSyslogPort, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmSwRevName=slmSwRevName, slmTrapLogParam3=slmTrapLogParam3, slmSnmpv3Password=slmSnmpv3Password, slmSyslogDestEntry=slmSyslogDestEntry, slmPmAvailable=slmPmAvailable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmChPassOldPass=slmChPassOldPass, slmLicenseId=slmLicenseId, slmSysLocation=slmSysLocation, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPassTable=slmChPassTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestAddress=slmTrapDestAddress, slmLicenseEntry=slmLicenseEntry, slmSysIpAddr=slmSysIpAddr, slmAdmin=slmAdmin, slmTrapLogParam2=slmTrapLogParam2, slmSysSubnetMask=slmSysSubnetMask, slmSysOperStatus=slmSysOperStatus, slmSwRevEntry=slmSwRevEntry, SoftwareRevision=SoftwareRevision, slmTrapLogName=slmTrapLogName, slmOpticalSwitchExist=slmOpticalSwitchExist, slmPsuNumber=slmPsuNumber, slmTrapPort=slmTrapPort, slmAuthLogin=slmAuthLogin, slmAuthPassword=slmAuthPassword, slmTrapLogParam4=slmTrapLogParam4, slmSysTrapFormat=slmSysTrapFormat, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrap=slmTrap, slmReadCommunity=slmReadCommunity, slmSysUplinkRate=slmSysUplinkRate, slmSysPmStartOfDay=slmSysPmStartOfDay, slmChPassLogin=slmChPassLogin, slmSwRevDate=slmSwRevDate, slmConfigSysUptime=slmConfigSysUptime, slmAuthEntry=slmAuthEntry, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogId=slmTrapLogId, slmConfigFile=slmConfigFile, slmTrapLogTable=slmTrapLogTable, slmConfigSysSignalType=slmConfigSysSignalType, slmRstpEnabled=slmRstpEnabled, slmTrapLogEntry=slmTrapLogEntry, slmOemType=slmOemType, slmSysChassisId=slmSysChassisId, slmNetworkMode=slmNetworkMode, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLogFile=slmLogFile, slmSysNetworkPrefix=slmSysNetworkPrefix, slmWriteCommunity=slmWriteCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmRebootDelay=slmRebootDelay, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapDestTable=slmTrapDestTable, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapEnable=slmTrapEnable, slmSysAlmAct=slmSysAlmAct, UserPassword=UserPassword, slmLicense=slmLicense, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminTable=slmAdminTable, slMain=slMain, slmLogin=slmLogin, slmSysName=slmSysName, slm40GConf=slm40GConf, slmAdminCommunity=slmAdminCommunity, slmSyslogDestAddress=slmSyslogDestAddress, slmSysLanIpAddr=slmSysLanIpAddr, slmBoxSize=slmBoxSize, slmSysTemperature=slmSysTemperature, slmAdminAccess=slmAdminAccess, AdminAccess=AdminAccess, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseIndex=slmLicenseIndex, UserCommunity=UserCommunity, slmSysActiveSwVersion=slmSysActiveSwVersion, slmMuxNumber=slmMuxNumber, slmLicenseTable=slmLicenseTable, slmSysMode=slmSysMode, slmChPassEntry=slmChPassEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSys=slmSys, slmAuthTable=slmAuthTable, slmTrapDestEntry=slmTrapDestEntry, slmTrapCommunity=slmTrapCommunity, slmAdminPassword=slmAdminPassword, slmVcatDelay=slmVcatDelay, slmAdminLogin=slmAdminLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmChPass=slmChPass)
