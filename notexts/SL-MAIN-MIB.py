...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSyslogDestAddress=slmSyslogDestAddress, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestAddress=slmTrapDestAddress, slmLicenseId=slmLicenseId, slmSysActiveSwVersion=slmSysActiveSwVersion, slmPmAvailable=slmPmAvailable, slmSysSubnetMask=slmSysSubnetMask, slmRebootDelay=slmRebootDelay, slmWriteCommunity=slmWriteCommunity, slmEdfaNumber=slmEdfaNumber, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogId=slmTrapLogId, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuth=slmAuth, slmAuthCommunity=slmAuthCommunity, slmChPassEntry=slmChPassEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysUplinkRate=slmSysUplinkRate, slmTrapPort=slmTrapPort, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLicenseIndex=slmLicenseIndex, slmRstpEnabled=slmRstpEnabled, slmLogin=slmLogin, AdminAccess=AdminAccess, slmSnmpv3Auth=slmSnmpv3Auth, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogParam1=slmTrapLogParam1, slmSysLocation=slmSysLocation, slmLicenseTable=slmLicenseTable, slmSwRevDirectory=slmSwRevDirectory, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestEntry=slmTrapDestEntry, slmLogFile=slmLogFile, slmTrap=slmTrap, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slMain=slMain, slmTrapUserLogin=slmTrapUserLogin, slmAuthPassword=slmAuthPassword, slmSnmpv3Password=slmSnmpv3Password, slmTrapEnable=slmTrapEnable, slmChPassLogin=slmChPassLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam4=slmTrapLogParam4, slmAuthLogin=slmAuthLogin, SoftwareRevision=SoftwareRevision, PYSNMP_MODULE_ID=slMain, slmSysCalendarTime=slmSysCalendarTime, slmVcatDelay=slmVcatDelay, slmTrapSysNameChange=slmTrapSysNameChange, slmConfigSysSignalType=slmConfigSysSignalType, slmConfigSysUptime=slmConfigSysUptime, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogTable=slmTrapLogTable, slmSysPmStartOfDay=slmSysPmStartOfDay, slmBoxSize=slmBoxSize, slmTid=slmTid, slmAdminCommunity=slmAdminCommunity, slmChPassTable=slmChPassTable, slmSwRevStatus=slmSwRevStatus, slmSnmpv3Priv=slmSnmpv3Priv, slmSysName=slmSysName, slmSysOperStatus=slmSysOperStatus, slmConfigFile=slmConfigFile, slmSwRevEntry=slmSwRevEntry, slmAdminAccess=slmAdminAccess, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminTable=slmAdminTable, UserLogin=UserLogin, slmNetworkMode=slmNetworkMode, slmSysLanIpAddr=slmSysLanIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapCommunity=slmTrapCommunity, slmAuthEntry=slmAuthEntry, slmPsuNumber=slmPsuNumber, slmSysSnmpVersion=slmSysSnmpVersion, slmSys=slmSys, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSwRevTable=slmSwRevTable, slmAdminEntry=slmAdminEntry, slm40GConf=slm40GConf, slmTrapLogParam5=slmTrapLogParam5, slmLicense=slmLicense, slmChPassNewPass=slmChPassNewPass, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSwRevDate=slmSwRevDate, slmTrapUserAccess=slmTrapUserAccess, slmSysGatewayAddr=slmSysGatewayAddr, slmReadCommunity=slmReadCommunity, slmTrapLogEntry=slmTrapLogEntry, slmSysAdminStatus=slmSysAdminStatus, slmSyslogLevel=slmSyslogLevel, slmTrapLogName=slmTrapLogName, slmTrapSysLocationChange=slmTrapSysLocationChange, slmOemType=slmOemType, slmSwRevName=slmSwRevName, slmSysChassisId=slmSysChassisId, slmAuthTable=slmAuthTable, slmTrapLogParam3=slmTrapLogParam3, slmSysTemperature=slmSysTemperature, slmSyslogPort=slmSyslogPort, slmSysMode=slmSysMode, slmSysIpAddr=slmSysIpAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminRowStatus=slmAdminRowStatus, slmSysAlmDeact=slmSysAlmDeact, UserCommunity=UserCommunity, slmChPassOldPass=slmChPassOldPass, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam2=slmTrapLogParam2, slmLicenseEntry=slmLicenseEntry, slmMuxNumber=slmMuxNumber, slmAdminPassword=slmAdminPassword, slmTrapDestRowStatus=slmTrapDestRowStatus, slmPortsNumber=slmPortsNumber, slmSysResetPm=slmSysResetPm, slmAdmin=slmAdmin, slmSysAlmAct=slmSysAlmAct, slmTrapDestTable=slmTrapDestTable, UserPassword=UserPassword, slmTrapLogParam6=slmTrapLogParam6, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicenseExpiration=slmLicenseExpiration, slmTopologyEnabled=slmTopologyEnabled, slmAdminLogin=slmAdminLogin, slmChPass=slmChPass)
