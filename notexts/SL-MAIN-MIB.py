...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysIpAddr=slmSysIpAddr, slmSwRevEntry=slmSwRevEntry, slmTrapDestAddress=slmTrapDestAddress, slmAuthPassword=slmAuthPassword, slm40GConf=slm40GConf, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestProtVersion=slmTrapDestProtVersion, slmChPassNewPass=slmChPassNewPass, slmTrapLogTable=slmTrapLogTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAuthTable=slmAuthTable, slmReadCommunity=slmReadCommunity, slmChPass=slmChPass, slmTopologyEnabled=slmTopologyEnabled, slmPmAvailable=slmPmAvailable, slmTrapLogParam2=slmTrapLogParam2, slmLicenseId=slmLicenseId, slmEdfaNumber=slmEdfaNumber, slmAdminTable=slmAdminTable, slmWriteCommunity=slmWriteCommunity, slmAdminPassword=slmAdminPassword, slmAdmin=slmAdmin, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSys=slmSys, slmTrapLogParam5=slmTrapLogParam5, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmPsuNumber=slmPsuNumber, slmRebootDelay=slmRebootDelay, slmAdminEntry=slmAdminEntry, slmPortsNumber=slmPortsNumber, slmLicenseEntry=slmLicenseEntry, UserPassword=UserPassword, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogDestEntry=slmSyslogDestEntry, slmConfigSysUptime=slmConfigSysUptime, slmSwRevDate=slmSwRevDate, slmSwRevName=slmSwRevName, UserCommunity=UserCommunity, AdminAccess=AdminAccess, slmSysChassisId=slmSysChassisId, slmAdminAccess=slmAdminAccess, slmTrapLogEntry=slmTrapLogEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSnmpv3Password=slmSnmpv3Password, slmChPassTable=slmChPassTable, slmTrapLogParam3=slmTrapLogParam3, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogName=slmTrapLogName, slmSysTemperature=slmSysTemperature, slmSysSubnetMask=slmSysSubnetMask, slmAuthCommunity=slmAuthCommunity, slmLicenseTable=slmLicenseTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmMuxNumber=slmMuxNumber, slmBoxSize=slmBoxSize, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam1=slmTrapLogParam1, slmSyslogLevel=slmSyslogLevel, slmTrapDestEntry=slmTrapDestEntry, slmAuth=slmAuth, slmAdminCommunity=slmAdminCommunity, slmSysUplinkRate=slmSysUplinkRate, slmSysAlmDeact=slmSysAlmDeact, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPassLogin=slmChPassLogin, SoftwareRevision=SoftwareRevision, slmSysLocation=slmSysLocation, slmTrapPort=slmTrapPort, slmAdminLogin=slmAdminLogin, slmSwRevStatus=slmSwRevStatus, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, PYSNMP_MODULE_ID=slMain, slmSysCalendarTime=slmSysCalendarTime, slmSysPmStartOfDay=slmSysPmStartOfDay, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapUserAccess=slmTrapUserAccess, slmTrap=slmTrap, slmTrapEnable=slmTrapEnable, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam4=slmTrapLogParam4, slmLogFile=slmLogFile, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapDestCommunity=slmTrapDestCommunity, slmLogin=slmLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysAlmAct=slmSysAlmAct, slmSysName=slmSysName, slmChPassEntry=slmChPassEntry, slmLicense=slmLicense, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogId=slmTrapLogId, slMain=slMain, slmTrapLogParam6=slmTrapLogParam6, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapUserLogin=slmTrapUserLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogDestTable=slmSyslogDestTable, slmSysResetPm=slmSysResetPm, slmSysAdminStatus=slmSysAdminStatus, slmAdminRowStatus=slmAdminRowStatus, slmAuthLogin=slmAuthLogin, slmLicenseIndex=slmLicenseIndex, slmSnmpv3Auth=slmSnmpv3Auth, slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPassOldPass=slmChPassOldPass, slmOemType=slmOemType, slmRstpEnabled=slmRstpEnabled, slmTrapCommunity=slmTrapCommunity, slmSwRevTable=slmSwRevTable, UserLogin=UserLogin, slmSyslogPort=slmSyslogPort, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysOperStatus=slmSysOperStatus, slmNetworkMode=slmNetworkMode, slmSysMode=slmSysMode, slmTrapDestTable=slmTrapDestTable, slmTid=slmTid, slmLicenseExpiration=slmLicenseExpiration, slmAuthEntry=slmAuthEntry, slmConfigFile=slmConfigFile, slmVcatDelay=slmVcatDelay)
