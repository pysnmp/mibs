...
Opaque, ObjectIdentity, Bits, Counter32, Unsigned32, NotificationType, ModuleIdentity, TimeTicks, IpAddress, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "ObjectIdentity", "Bits", "Counter32", "Unsigned32", "NotificationType", "ModuleIdentity", "TimeTicks", "IpAddress", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "Gauge32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestRowStatus=slmTrapDestRowStatus, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapDestEntry=slmTrapDestEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogId=slmTrapLogId, slmChPassOldPass=slmChPassOldPass, slmTrapUserLogin=slmTrapUserLogin, slmLicenseEntry=slmLicenseEntry, slmAuthCommunity=slmAuthCommunity, slmAdminEntry=slmAdminEntry, slmChPassNewPass=slmChPassNewPass, slmNetworkMode=slmNetworkMode, slmTrapCommunity=slmTrapCommunity, slmWriteCommunity=slmWriteCommunity, slmLicenseExpiration=slmLicenseExpiration, UserLogin=UserLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogParam4=slmTrapLogParam4, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicenseIndex=slmLicenseIndex, slmTrapUserAccess=slmTrapUserAccess, slmChPass=slmChPass, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLocation=slmSysLocation, slmAdminAccess=slmAdminAccess, slmAuthLogin=slmAuthLogin, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestCommunity=slmTrapDestCommunity, slmReadCommunity=slmReadCommunity, slmSwRevTable=slmSwRevTable, slmAdminCommunity=slmAdminCommunity, slmAuthPassword=slmAuthPassword, slmChPassEntry=slmChPassEntry, slmChPassTable=slmChPassTable, slmSysMode=slmSysMode, slmSwRevDate=slmSwRevDate, slmSysChassisId=slmSysChassisId, slmSysAlmDeact=slmSysAlmDeact, slmSysUplinkRate=slmSysUplinkRate, AdminAccess=AdminAccess, slmConfigSysUptime=slmConfigSysUptime, slmTrapEnable=slmTrapEnable, slmVcatDelay=slmVcatDelay, slmSnmpv3Auth=slmSnmpv3Auth, slmSys=slmSys, slmLogin=slmLogin, slmBoxSize=slmBoxSize, slmSwRevStatus=slmSwRevStatus, slmSysSubnetMask=slmSysSubnetMask, slmAdminTable=slmAdminTable, slmOemType=slmOemType, slm40GConf=slm40GConf, slmSysName=slmSysName, slmSysTemperature=slmSysTemperature, SoftwareRevision=SoftwareRevision, slmTrapLogTable=slmTrapLogTable, slmSysOperStatus=slmSysOperStatus, slmAdminLogin=slmAdminLogin, slmTrapDestTable=slmTrapDestTable, slmAdminPassword=slmAdminPassword, slmTrapLogParam3=slmTrapLogParam3, slmLicenseTable=slmLicenseTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogDestEntry=slmSyslogDestEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapPort=slmTrapPort, slmRstpEnabled=slmRstpEnabled, slmLicenseId=slmLicenseId, slmSysCalendarTime=slmSysCalendarTime, slmSysSnmpVersion=slmSysSnmpVersion, UserPassword=UserPassword, slmLicense=slmLicense, slmSyslogDestTable=slmSyslogDestTable, slmPsuNumber=slmPsuNumber, slmTid=slmTid, slmChPassLogin=slmChPassLogin, slmRebootDelay=slmRebootDelay, slmPmAvailable=slmPmAvailable, slmAuth=slmAuth, slmSyslogPort=slmSyslogPort, slmSysGatewayAddr=slmSysGatewayAddr, slmMuxNumber=slmMuxNumber, slmAuthTable=slmAuthTable, slmSysResetPm=slmSysResetPm, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminRowStatus=slmAdminRowStatus, slmSysAdminStatus=slmSysAdminStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slMain=slMain, slmTrap=slmTrap, slmTrapLogParam1=slmTrapLogParam1, slmAdmin=slmAdmin, slmPortsNumber=slmPortsNumber, slmEdfaNumber=slmEdfaNumber, slmSysPmStartOfDay=slmSysPmStartOfDay, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSyslogLevel=slmSyslogLevel, slmTrapLogParam6=slmTrapLogParam6, slmConfigSysSignalType=slmConfigSysSignalType, UserCommunity=UserCommunity, slmSnmpv3Password=slmSnmpv3Password, slmSysAlmAct=slmSysAlmAct, slmLogFile=slmLogFile, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogName=slmTrapLogName, slmTopologyEnabled=slmTopologyEnabled, PYSNMP_MODULE_ID=slMain, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam2=slmTrapLogParam2, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam5=slmTrapLogParam5, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmConfigFile=slmConfigFile, slmTrapDestAddress=slmTrapDestAddress, slmAuthEntry=slmAuthEntry, slmSysIpAddr=slmSysIpAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevDirectory=slmSwRevDirectory, slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevName=slmSwRevName)
