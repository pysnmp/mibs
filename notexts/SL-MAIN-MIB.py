...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmEdfaNumber=slmEdfaNumber, slmTrapLogName=slmTrapLogName, slmAdminLogin=slmAdminLogin, slmLicenseIndex=slmLicenseIndex, slmLogin=slmLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmConfigFile=slmConfigFile, slmTrapDestCommunity=slmTrapDestCommunity, slmTrap=slmTrap, slmTrapLogParam6=slmTrapLogParam6, slmVcatDelay=slmVcatDelay, slmPsuNumber=slmPsuNumber, slmNetworkMode=slmNetworkMode, slmSysChassisId=slmSysChassisId, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSwRevName=slmSwRevName, slmTrapLogParam4=slmTrapLogParam4, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicenseExpiration=slmLicenseExpiration, slmTrapCommunity=slmTrapCommunity, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogEntry=slmTrapLogEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysAlmAct=slmSysAlmAct, slmSnmpv3Priv=slmSnmpv3Priv, slmChPassTable=slmChPassTable, slmSyslogDestAddress=slmSyslogDestAddress, slmAuthEntry=slmAuthEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminAccess=slmAdminAccess, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevDirectory=slmSwRevDirectory, slmChPassLogin=slmChPassLogin, slmTrapPort=slmTrapPort, slmSysEncryptionCapability=slmSysEncryptionCapability, UserPassword=UserPassword, slmSysResetPm=slmSysResetPm, slmLicense=slmLicense, slmSysCalendarTime=slmSysCalendarTime, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTopologyEnabled=slmTopologyEnabled, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdmin=slmAdmin, slmSysIpAddr=slmSysIpAddr, slmSysMode=slmSysMode, slmAuthPassword=slmAuthPassword, slmSysSubnetMask=slmSysSubnetMask, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestIpAddress=slmTrapDestIpAddress, slmRstpEnabled=slmRstpEnabled, slmTrapLogParam1=slmTrapLogParam1, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassOldPass=slmChPassOldPass, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestTable=slmSyslogDestTable, slmAdminRowStatus=slmAdminRowStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapDestTable=slmTrapDestTable, slmOemType=slmOemType, slmTrapEnable=slmTrapEnable, slmAdminTable=slmAdminTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLicenseEntry=slmLicenseEntry, UserCommunity=UserCommunity, AdminAccess=AdminAccess, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysTemperature=slmSysTemperature, slmLicenseId=slmLicenseId, slmAdminEntry=slmAdminEntry, slmAuth=slmAuth, slmSwRevEntry=slmSwRevEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminPassword=slmAdminPassword, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam3=slmTrapLogParam3, slmSwRevDate=slmSwRevDate, slmTrapLogId=slmTrapLogId, slmSysLocation=slmSysLocation, slmTrapUserLogin=slmTrapUserLogin, slmSysSnmpVersion=slmSysSnmpVersion, slmLogFile=slmLogFile, slmSysGatewayAddr=slmSysGatewayAddr, slmSysName=slmSysName, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmMuxNumber=slmMuxNumber, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPassNewPass=slmChPassNewPass, SoftwareRevision=SoftwareRevision, slmSysUplinkRate=slmSysUplinkRate, slmAuthCommunity=slmAuthCommunity, slmTrapLogTable=slmTrapLogTable, slmConfigSysUptime=slmConfigSysUptime, slmChPassEntry=slmChPassEntry, slmSyslogPort=slmSyslogPort, slmLicenseTable=slmLicenseTable, UserLogin=UserLogin, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogLevel=slmSyslogLevel, slmSys=slmSys, slmPmAvailable=slmPmAvailable, slmRebootDelay=slmRebootDelay, slMain=slMain, slmSysOperStatus=slmSysOperStatus, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam2=slmTrapLogParam2, slmTid=slmTid, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysAdminStatus=slmSysAdminStatus, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevStatus=slmSwRevStatus, slmPortsNumber=slmPortsNumber, slmAuthTable=slmAuthTable, PYSNMP_MODULE_ID=slMain, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAuthLogin=slmAuthLogin, slmChPass=slmChPass, slmBoxSize=slmBoxSize, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestAddress=slmTrapDestAddress, slmReadCommunity=slmReadCommunity, slm40GConf=slm40GConf, slmAdminCommunity=slmAdminCommunity, slmSysTrapFormat=slmSysTrapFormat, slmSwRevTable=slmSwRevTable)
