...
ModuleIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, NotificationType, TimeTicks, Integer32, Gauge32, Counter32, MibIdentifier, iso, IpAddress, Bits, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "NotificationType", "TimeTicks", "Integer32", "Gauge32", "Counter32", "MibIdentifier", "iso", "IpAddress", "Bits", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogParam1=slmTrapLogParam1, slmSysTrapFormat=slmSysTrapFormat, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogParam2=slmTrapLogParam2, slmAdminCommunity=slmAdminCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLogFile=slmLogFile, slmSwRevDirectory=slmSwRevDirectory, AdminAccess=AdminAccess, slmSysMode=slmSysMode, slmSysOperStatus=slmSysOperStatus, slmPmAvailable=slmPmAvailable, slmAuthTable=slmAuthTable, slmLicenseExpiration=slmLicenseExpiration, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogEntry=slmTrapLogEntry, slmAuthPassword=slmAuthPassword, slmTrapPort=slmTrapPort, slmTrapUserAccess=slmTrapUserAccess, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogLevel=slmSyslogLevel, slmSwRevDate=slmSwRevDate, slmSysAdminStatus=slmSysAdminStatus, slmBoxSize=slmBoxSize, slmTrapLogTable=slmTrapLogTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSwRevEntry=slmSwRevEntry, slmSysAlmAct=slmSysAlmAct, slmTrapDestCommunity=slmTrapDestCommunity, slmPsuNumber=slmPsuNumber, slmSysSubnetMask=slmSysSubnetMask, slmReadCommunity=slmReadCommunity, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseTable=slmLicenseTable, slmConfigFile=slmConfigFile, slmSwRevStatus=slmSwRevStatus, slmRebootDelay=slmRebootDelay, slmLicense=slmLicense, slmSysGatewayAddr=slmSysGatewayAddr, slmMuxNumber=slmMuxNumber, UserCommunity=UserCommunity, slmAdminTable=slmAdminTable, slmChPass=slmChPass, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam3=slmTrapLogParam3, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLicenseEntry=slmLicenseEntry, slmSysResetPm=slmSysResetPm, slmSysSnmpVersion=slmSysSnmpVersion, slmRstpEnabled=slmRstpEnabled, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysCalendarTime=slmSysCalendarTime, slmPortsNumber=slmPortsNumber, slmWriteCommunity=slmWriteCommunity, slmChPassLogin=slmChPassLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapEnable=slmTrapEnable, slmLicenseIndex=slmLicenseIndex, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLogin=slmLogin, slmAdminLogin=slmAdminLogin, slmAdminAccess=slmAdminAccess, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdmin=slmAdmin, slmTid=slmTid, slmAuth=slmAuth, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam6=slmTrapLogParam6, slmAuthEntry=slmAuthEntry, UserLogin=UserLogin, slmSysAlmDeact=slmSysAlmDeact, slmTopologyEnabled=slmTopologyEnabled, PYSNMP_MODULE_ID=slMain, slmTrapLogParam5=slmTrapLogParam5, slmSwRevTable=slmSwRevTable, slmSnmpv3Password=slmSnmpv3Password, slmNetworkMode=slmNetworkMode, slmSysTemperature=slmSysTemperature, slmLicenseId=slmLicenseId, slmSysLocation=slmSysLocation, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmConfigSysUptime=slmConfigSysUptime, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestTable=slmTrapDestTable, slmSysLanIpAddr=slmSysLanIpAddr, slMain=slMain, slmTrapLogName=slmTrapLogName, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysUplinkRate=slmSysUplinkRate, SoftwareRevision=SoftwareRevision, slmTrapDestIpAddress=slmTrapDestIpAddress, slm40GConf=slm40GConf, slmTrapDestAddress=slmTrapDestAddress, slmOemType=slmOemType, slmSys=slmSys, slmAuthLogin=slmAuthLogin, slmSyslogDestAddress=slmSyslogDestAddress, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminRowStatus=slmAdminRowStatus, slmSyslogPort=slmSyslogPort, slmSyslogDestTable=slmSyslogDestTable, slmAuthCommunity=slmAuthCommunity, slmChPassTable=slmChPassTable, slmTrapLogId=slmTrapLogId, slmSysChassisId=slmSysChassisId, slmTrap=slmTrap, slmChPassOldPass=slmChPassOldPass, slmChPassNewPass=slmChPassNewPass, slmVcatDelay=slmVcatDelay, slmAdminPassword=slmAdminPassword, UserPassword=UserPassword, slmSyslogDestEntry=slmSyslogDestEntry, slmSysName=slmSysName, slmAdminEntry=slmAdminEntry, slmTrapLogParam4=slmTrapLogParam4, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysIpAddr=slmSysIpAddr, slmTrapCommunity=slmTrapCommunity, slmSwRevName=slmSwRevName, slmTrapDestEntry=slmTrapDestEntry, slmChPassEntry=slmChPassEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapDestProtVersion=slmTrapDestProtVersion, slmOpticalSwitchExist=slmOpticalSwitchExist)
