...
NotificationType, Counter32, Bits, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, MibIdentifier, Opaque, TimeTicks, ObjectIdentity, Integer32, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "Bits", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "MibIdentifier", "Opaque", "TimeTicks", "ObjectIdentity", "Integer32", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicenseId=slmLicenseId, slmChPassLogin=slmChPassLogin, slmSysLocation=slmSysLocation, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogName=slmTrapLogName, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLogin=slmLogin, slmTrapLogParam6=slmTrapLogParam6, slmSnmpv3Password=slmSnmpv3Password, slmLicenseTable=slmLicenseTable, slmAdminPassword=slmAdminPassword, slmOemType=slmOemType, slmConfigFile=slmConfigFile, slmTrapUserAccess=slmTrapUserAccess, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysSnmpVersion=slmSysSnmpVersion, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogId=slmTrapLogId, slmAuthEntry=slmAuthEntry, slmAdminCommunity=slmAdminCommunity, slmSysIpAddr=slmSysIpAddr, slmTrapCommunity=slmTrapCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, AdminAccess=AdminAccess, slmSysAlmAct=slmSysAlmAct, slmRstpEnabled=slmRstpEnabled, slmTrapUserLogin=slmTrapUserLogin, slmRebootDelay=slmRebootDelay, slmTrapLogParam1=slmTrapLogParam1, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseExpiration=slmLicenseExpiration, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLogFile=slmLogFile, PYSNMP_MODULE_ID=slMain, slmSysOperStatus=slmSysOperStatus, slmAdminAccess=slmAdminAccess, slmTrapLogEntry=slmTrapLogEntry, slmSysMode=slmSysMode, slmPmAvailable=slmPmAvailable, slmTrapEnable=slmTrapEnable, slmReadCommunity=slmReadCommunity, slmTrapDestAddress=slmTrapDestAddress, slmTrapSysNameChange=slmTrapSysNameChange, slmAuthTable=slmAuthTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogDestAddress=slmSyslogDestAddress, slmSysAlmDeact=slmSysAlmDeact, slmChPassNewPass=slmChPassNewPass, slmSysAdminStatus=slmSysAdminStatus, slmSysUplinkRate=slmSysUplinkRate, slmSysTemperature=slmSysTemperature, slmSys=slmSys, slmNetworkMode=slmNetworkMode, slmTid=slmTid, slmSwRevName=slmSwRevName, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicense=slmLicense, slmSwRevTable=slmSwRevTable, slmSysResetPm=slmSysResetPm, slmSysLanIpAddr=slmSysLanIpAddr, slmChPass=slmChPass, slmConfigSysUptime=slmConfigSysUptime, UserLogin=UserLogin, SoftwareRevision=SoftwareRevision, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapPort=slmTrapPort, slmTrapLogParam3=slmTrapLogParam3, slmLicenseEntry=slmLicenseEntry, slmSwRevStatus=slmSwRevStatus, slmTopologyEnabled=slmTopologyEnabled, slmAdminRowStatus=slmAdminRowStatus, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevDirectory=slmSwRevDirectory, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmSysName=slmSysName, UserPassword=UserPassword, slm40GConf=slm40GConf, slmSwRevEntry=slmSwRevEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam4=slmTrapLogParam4, slmSyslogPort=slmSyslogPort, slmAuth=slmAuth, slmAdminEntry=slmAdminEntry, UserCommunity=UserCommunity, slmAuthPassword=slmAuthPassword, slmSnmpv3Auth=slmSnmpv3Auth, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogParam2=slmTrapLogParam2, slmAdminLogin=slmAdminLogin, slmSnmpv3Priv=slmSnmpv3Priv, slmPsuNumber=slmPsuNumber, slmAuthCommunity=slmAuthCommunity, slmTrapDestRowStatus=slmTrapDestRowStatus, slmPortsNumber=slmPortsNumber, slmAdminTable=slmAdminTable, slmSyslogLevel=slmSyslogLevel, slmTrapDestTable=slmTrapDestTable, slmLicenseIndex=slmLicenseIndex, slmBoxSize=slmBoxSize, slmMuxNumber=slmMuxNumber, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysChassisId=slmSysChassisId, slmWriteCommunity=slmWriteCommunity, slmChPassTable=slmChPassTable, slmVcatDelay=slmVcatDelay, slmConfigSysSignalType=slmConfigSysSignalType, slMain=slMain, slmTrap=slmTrap, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPassOldPass=slmChPassOldPass, slmAdmin=slmAdmin, slmTrapLogTable=slmTrapLogTable, slmEdfaNumber=slmEdfaNumber, slmAuthLogin=slmAuthLogin, slmSysSubnetMask=slmSysSubnetMask, slmChPassEntry=slmChPassEntry, slmSysTrapFormat=slmSysTrapFormat, slmSwRevDate=slmSwRevDate, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp)
