...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmConfigSysUptime=slmConfigSysUptime, slmEdfaNumber=slmEdfaNumber, slmTid=slmTid, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestEntry=slmTrapDestEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminCommunity=slmAdminCommunity, slmTrapCommunity=slmTrapCommunity, slmSysAlmDeact=slmSysAlmDeact, slmSysIpAddr=slmSysIpAddr, slmAuth=slmAuth, slmTrapDestProtVersion=slmTrapDestProtVersion, slmPmAvailable=slmPmAvailable, slmChPassLogin=slmChPassLogin, slmLicenseId=slmLicenseId, slMain=slMain, slmTrapLogName=slmTrapLogName, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, UserLogin=UserLogin, slmSysTemperature=slmSysTemperature, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapUserLogin=slmTrapUserLogin, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestTable=slmSyslogDestTable, slmChPassOldPass=slmChPassOldPass, slmTrapLogId=slmTrapLogId, slmSwRevEntry=slmSwRevEntry, slmSys=slmSys, slmAuthTable=slmAuthTable, slmOemType=slmOemType, slmSwRevDate=slmSwRevDate, slmConfigFile=slmConfigFile, slmSysResetPm=slmSysResetPm, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestAddress=slmTrapDestAddress, slmLicenseIndex=slmLicenseIndex, slmSysLanIpAddr=slmSysLanIpAddr, slmVcatDelay=slmVcatDelay, slmNetworkMode=slmNetworkMode, slmSysAdminStatus=slmSysAdminStatus, slmTrapEnable=slmTrapEnable, slmBoxSize=slmBoxSize, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmPsuNumber=slmPsuNumber, slmChPassNewPass=slmChPassNewPass, slmSwRevName=slmSwRevName, slmTrapLogParam2=slmTrapLogParam2, slmSwRevStatus=slmSwRevStatus, slmSysEncryptionCapability=slmSysEncryptionCapability, slmWriteCommunity=slmWriteCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicenseExpiration=slmLicenseExpiration, slmSysSubnetMask=slmSysSubnetMask, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevTable=slmSwRevTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogEntry=slmTrapLogEntry, slm40GConf=slm40GConf, slmChPass=slmChPass, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminRowStatus=slmAdminRowStatus, UserPassword=UserPassword, slmTrapLogParam4=slmTrapLogParam4, slmSysPmStartOfDay=slmSysPmStartOfDay, slmChPassEntry=slmChPassEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicense=slmLicense, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysTrapFormat=slmSysTrapFormat, PYSNMP_MODULE_ID=slMain, slmSysGatewayAddr=slmSysGatewayAddr, SoftwareRevision=SoftwareRevision, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseTable=slmLicenseTable, slmSysAlmAct=slmSysAlmAct, UserCommunity=UserCommunity, slmReadCommunity=slmReadCommunity, slmTrapDestCommunity=slmTrapDestCommunity, slmSnmpv3Password=slmSnmpv3Password, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminAccess=slmAdminAccess, slmTrapLogTable=slmTrapLogTable, slmTrapPort=slmTrapPort, slmTrapLogParam5=slmTrapLogParam5, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminEntry=slmAdminEntry, slmSysCalendarTime=slmSysCalendarTime, slmSysLocation=slmSysLocation, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestTable=slmTrapDestTable, slmSysName=slmSysName, slmTrapLogParam6=slmTrapLogParam6, slmLicenseEntry=slmLicenseEntry, slmAuthPassword=slmAuthPassword, slmSyslogPort=slmSyslogPort, slmAdmin=slmAdmin, slmRebootDelay=slmRebootDelay, slmTrap=slmTrap, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminTable=slmAdminTable, slmSnmpv3Auth=slmSnmpv3Auth, slmAdminLogin=slmAdminLogin, slmAdminPassword=slmAdminPassword, slmTrapLogParam1=slmTrapLogParam1, slmSyslogLevel=slmSyslogLevel, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysOperStatus=slmSysOperStatus, slmChPassTable=slmChPassTable, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestAddress=slmSyslogDestAddress, slmMuxNumber=slmMuxNumber, slmSysChassisId=slmSysChassisId, slmSwRevDirectory=slmSwRevDirectory, AdminAccess=AdminAccess, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysMode=slmSysMode, slmTrapLogParam3=slmTrapLogParam3, slmAuthCommunity=slmAuthCommunity, slmLogFile=slmLogFile, slmRstpEnabled=slmRstpEnabled, slmAuthEntry=slmAuthEntry, slmPortsNumber=slmPortsNumber, slmLogin=slmLogin, slmAuthLogin=slmAuthLogin)
