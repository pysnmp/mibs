...
ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Opaque, NotificationType, Integer32, MibIdentifier, TimeTicks, iso, IpAddress, Gauge32, Bits, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Opaque", "NotificationType", "Integer32", "MibIdentifier", "TimeTicks", "iso", "IpAddress", "Gauge32", "Bits", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminCommunity=slmAdminCommunity, slmSnmpv3Password=slmSnmpv3Password, SoftwareRevision=SoftwareRevision, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminTable=slmAdminTable, slmSwRevEntry=slmSwRevEntry, slmOemType=slmOemType, slmSwRevStatus=slmSwRevStatus, slmSysAlmAct=slmSysAlmAct, slmConfigFile=slmConfigFile, slmChPassEntry=slmChPassEntry, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam5=slmTrapLogParam5, slmSysPmStartOfDay=slmSysPmStartOfDay, slMain=slMain, slmChPassNewPass=slmChPassNewPass, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapEnable=slmTrapEnable, slmSysLocation=slmSysLocation, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysName=slmSysName, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestProtVersion=slmTrapDestProtVersion, slmChPassOldPass=slmChPassOldPass, slmSwRevDate=slmSwRevDate, slmSys=slmSys, slmVcatDelay=slmVcatDelay, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAuthTable=slmAuthTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapSysNameChange=slmTrapSysNameChange, slmRebootDelay=slmRebootDelay, UserLogin=UserLogin, slmTrapLogTable=slmTrapLogTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogParam1=slmTrapLogParam1, slmAuth=slmAuth, PYSNMP_MODULE_ID=slMain, slmTopologyEnabled=slmTopologyEnabled, slmMuxNumber=slmMuxNumber, slmLicenseIndex=slmLicenseIndex, slmBoxSize=slmBoxSize, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevName=slmSwRevName, slmPmAvailable=slmPmAvailable, slm40GConf=slm40GConf, slmAdminRowStatus=slmAdminRowStatus, slmAuthCommunity=slmAuthCommunity, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysAdminStatus=slmSysAdminStatus, slmSysUplinkRate=slmSysUplinkRate, slmTrapDestAddress=slmTrapDestAddress, slmNetworkMode=slmNetworkMode, slmTid=slmTid, slmSnmpv3Priv=slmSnmpv3Priv, slmSysOperStatus=slmSysOperStatus, slmSyslogLevel=slmSyslogLevel, slmChPassTable=slmChPassTable, slmSysSnmpVersion=slmSysSnmpVersion, slmLicenseExpiration=slmLicenseExpiration, slmAdminEntry=slmAdminEntry, slmTrapDestTable=slmTrapDestTable, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminAccess=slmAdminAccess, slmConfigSysUptime=slmConfigSysUptime, slmReadCommunity=slmReadCommunity, slmSysIpAddr=slmSysIpAddr, slmTrapPort=slmTrapPort, slmPsuNumber=slmPsuNumber, slmLicenseId=slmLicenseId, slmLicenseEntry=slmLicenseEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogName=slmTrapLogName, slmTrapLogParam2=slmTrapLogParam2, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysResetPm=slmSysResetPm, slmSysChassisId=slmSysChassisId, slmAuthPassword=slmAuthPassword, slmLogin=slmLogin, UserCommunity=UserCommunity, slmTrapLogId=slmTrapLogId, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysTemperature=slmSysTemperature, slmRstpEnabled=slmRstpEnabled, slmSysMode=slmSysMode, slmSwRevDirectory=slmSwRevDirectory, slmSysAlmDeact=slmSysAlmDeact, slmAuthLogin=slmAuthLogin, slmChPassLogin=slmChPassLogin, slmTrapCommunity=slmTrapCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrap=slmTrap, slmSyslogPort=slmSyslogPort, slmSysLanIpAddr=slmSysLanIpAddr, slmEdfaNumber=slmEdfaNumber, slmWriteCommunity=slmWriteCommunity, slmLogFile=slmLogFile, slmTrapUserLogin=slmTrapUserLogin, slmAuthEntry=slmAuthEntry, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam6=slmTrapLogParam6, slmAdminLogin=slmAdminLogin, slmAdmin=slmAdmin, slmLicense=slmLicense, slmSwRevTable=slmSwRevTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSyslogDestTable=slmSyslogDestTable, slmSysSubnetMask=slmSysSubnetMask, AdminAccess=AdminAccess, slmTrapUserAccess=slmTrapUserAccess, UserPassword=UserPassword, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLicenseTable=slmLicenseTable, slmTrapLogEntry=slmTrapLogEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmChPass=slmChPass, slmAdminPassword=slmAdminPassword, slmSysTrapFormat=slmSysTrapFormat, slmPortsNumber=slmPortsNumber)
