...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, Opaque, Gauge32, IpAddress, ObjectIdentity, MibIdentifier, Integer32, ModuleIdentity, Counter64, Bits, NotificationType, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "Opaque", "Gauge32", "IpAddress", "ObjectIdentity", "MibIdentifier", "Integer32", "ModuleIdentity", "Counter64", "Bits", "NotificationType", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSnmpv3Auth=slmSnmpv3Auth, slmTopologyEnabled=slmTopologyEnabled, slmLogFile=slmLogFile, slmTrapLogTable=slmTrapLogTable, slmSysName=slmSysName, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminEntry=slmAdminEntry, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogId=slmTrapLogId, slmRstpEnabled=slmRstpEnabled, slmTrapLogParam6=slmTrapLogParam6, slmTrapUserLogin=slmTrapUserLogin, slmSysIpAddr=slmSysIpAddr, slmLicenseEntry=slmLicenseEntry, slmLicense=slmLicense, slmSysTrapFormat=slmSysTrapFormat, slmAuthEntry=slmAuthEntry, slmOemType=slmOemType, slmAuthTable=slmAuthTable, slmSys=slmSys, slmLicenseTable=slmLicenseTable, slmAdminRowStatus=slmAdminRowStatus, slmSysEncryptionCapability=slmSysEncryptionCapability, slmChPassEntry=slmChPassEntry, slmTrapLogParam3=slmTrapLogParam3, slmTrapSysLocationChange=slmTrapSysLocationChange, slmEdfaNumber=slmEdfaNumber, slmSnmpv3Priv=slmSnmpv3Priv, slmSysPmStartOfDay=slmSysPmStartOfDay, slmChPassLogin=slmChPassLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestEntry=slmTrapDestEntry, slmSwRevTable=slmSwRevTable, slmAdminTable=slmAdminTable, slmAuthPassword=slmAuthPassword, slmSyslogLevel=slmSyslogLevel, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysChassisId=slmSysChassisId, slmSysResetPm=slmSysResetPm, SoftwareRevision=SoftwareRevision, slmSwRevDate=slmSwRevDate, slmReadCommunity=slmReadCommunity, slmAdminPassword=slmAdminPassword, slmPmAvailable=slmPmAvailable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmPortsNumber=slmPortsNumber, slmTrapUserAccess=slmTrapUserAccess, UserLogin=UserLogin, UserCommunity=UserCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapPort=slmTrapPort, slmSnmpv3Password=slmSnmpv3Password, UserPassword=UserPassword, slmPsuNumber=slmPsuNumber, slmAuthCommunity=slmAuthCommunity, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogEntry=slmTrapLogEntry, slmAdminAccess=slmAdminAccess, slmConfigSysSignalType=slmConfigSysSignalType, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassOldPass=slmChPassOldPass, slmSysLanIpAddr=slmSysLanIpAddr, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapDestTable=slmTrapDestTable, slmLicenseExpiration=slmLicenseExpiration, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLicenseIndex=slmLicenseIndex, slmRebootDelay=slmRebootDelay, slmChPass=slmChPass, slmLicenseId=slmLicenseId, slmSwRevName=slmSwRevName, slmAdminLogin=slmAdminLogin, slmSwRevEntry=slmSwRevEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmSwRevDirectory=slmSwRevDirectory, slmSysOperStatus=slmSysOperStatus, slmAdmin=slmAdmin, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapCommunity=slmTrapCommunity, slmChPassTable=slmChPassTable, slmLogin=slmLogin, slmMuxNumber=slmMuxNumber, slmSyslogDestTable=slmSyslogDestTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysTemperature=slmSysTemperature, slmSysCalendarTime=slmSysCalendarTime, slmChPassNewPass=slmChPassNewPass, PYSNMP_MODULE_ID=slMain, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTid=slmTid, slmVcatDelay=slmVcatDelay, slmTrapLogParam4=slmTrapLogParam4, slmTrap=slmTrap, slmTrapLogName=slmTrapLogName, slmNetworkMode=slmNetworkMode, slmSysSubnetMask=slmSysSubnetMask, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapSysNameChange=slmTrapSysNameChange, slm40GConf=slm40GConf, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAuth=slmAuth, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogParam2=slmTrapLogParam2, slmWriteCommunity=slmWriteCommunity, slMain=slMain, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysAlmDeact=slmSysAlmDeact, slmConfigFile=slmConfigFile, slmSysAlmAct=slmSysAlmAct, slmSyslogPort=slmSyslogPort, slmSysMode=slmSysMode, slmConfigSysUptime=slmConfigSysUptime, slmSysLocation=slmSysLocation, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevStatus=slmSwRevStatus, slmTrapEnable=slmTrapEnable, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogParam1=slmTrapLogParam1, slmBoxSize=slmBoxSize, slmAdminCommunity=slmAdminCommunity, AdminAccess=AdminAccess, slmAuthLogin=slmAuthLogin)
