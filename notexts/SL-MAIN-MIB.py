...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminPassword=slmAdminPassword, slmChPassOldPass=slmChPassOldPass, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestEntry=slmTrapDestEntry, slmRebootDelay=slmRebootDelay, slmAuthEntry=slmAuthEntry, slMain=slMain, slmAuthCommunity=slmAuthCommunity, slmTrapUserAccess=slmTrapUserAccess, slmChPass=slmChPass, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogParam1=slmTrapLogParam1, slmPsuNumber=slmPsuNumber, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapSysLocationChange=slmTrapSysLocationChange, slmConfigSysSignalType=slmConfigSysSignalType, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam5=slmTrapLogParam5, slmAuthTable=slmAuthTable, slmMuxNumber=slmMuxNumber, slmAuthPassword=slmAuthPassword, slmSnmpv3Priv=slmSnmpv3Priv, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicenseId=slmLicenseId, slmChPassNewPass=slmChPassNewPass, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam3=slmTrapLogParam3, slmLogFile=slmLogFile, slmLicenseEntry=slmLicenseEntry, slmTrapUserLogin=slmTrapUserLogin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, UserCommunity=UserCommunity, slmSysAdminStatus=slmSysAdminStatus, slmLogin=slmLogin, slmVcatDelay=slmVcatDelay, slmAdminAccess=slmAdminAccess, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogPort=slmSyslogPort, slmWriteCommunity=slmWriteCommunity, AdminAccess=AdminAccess, slmSyslogDestEntry=slmSyslogDestEntry, slm40GConf=slm40GConf, slmRstpEnabled=slmRstpEnabled, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicenseIndex=slmLicenseIndex, slmSwRevDirectory=slmSwRevDirectory, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogTable=slmTrapLogTable, slmTrapLogId=slmTrapLogId, slmConfigFile=slmConfigFile, slmSysTrapFormat=slmSysTrapFormat, slmLicense=slmLicense, slmSyslogDestIpAddress=slmSyslogDestIpAddress, UserLogin=UserLogin, slmNetworkMode=slmNetworkMode, slmTrapLogName=slmTrapLogName, slmAdmin=slmAdmin, slmPortsNumber=slmPortsNumber, slmSysTemperature=slmSysTemperature, slmAdminLogin=slmAdminLogin, slmSys=slmSys, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTopologyEnabled=slmTopologyEnabled, slmTrapPort=slmTrapPort, slmSysResetPm=slmSysResetPm, slmTrapDestCommunity=slmTrapDestCommunity, slmTid=slmTid, slmSwRevStatus=slmSwRevStatus, slmAdminTable=slmAdminTable, UserPassword=UserPassword, slmBoxSize=slmBoxSize, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSwRevDate=slmSwRevDate, PYSNMP_MODULE_ID=slMain, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevTable=slmSwRevTable, slmSnmpv3Password=slmSnmpv3Password, slmSysGatewayAddr=slmSysGatewayAddr, SoftwareRevision=SoftwareRevision, slmAdminEntry=slmAdminEntry, slmTrapLogEntry=slmTrapLogEntry, slmSysLocation=slmSysLocation, slmOemType=slmOemType, slmTrapLogParam4=slmTrapLogParam4, slmTrap=slmTrap, slmSyslogDestTable=slmSyslogDestTable, slmSysAlmAct=slmSysAlmAct, slmConfigSysUptime=slmConfigSysUptime, slmSysMode=slmSysMode, slmPmAvailable=slmPmAvailable, slmSyslogLevel=slmSyslogLevel, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogParam2=slmTrapLogParam2, slmSysAlmDeact=slmSysAlmDeact, slmEdfaNumber=slmEdfaNumber, slmSysName=slmSysName, slmSysUplinkRate=slmSysUplinkRate, slmAdminCommunity=slmAdminCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapEnable=slmTrapEnable, slmLicenseExpiration=slmLicenseExpiration, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthLogin=slmAuthLogin, slmChPassTable=slmChPassTable, slmSysChassisId=slmSysChassisId, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysIpAddr=slmSysIpAddr, slmAuth=slmAuth, slmLicenseTable=slmLicenseTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmSwRevName=slmSwRevName, slmTrapLogParam6=slmTrapLogParam6, slmChPassEntry=slmChPassEntry, slmChPassLogin=slmChPassLogin, slmReadCommunity=slmReadCommunity, slmTrapDestTable=slmTrapDestTable, slmTrapCommunity=slmTrapCommunity, slmSysOperStatus=slmSysOperStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapDestAddress=slmTrapDestAddress)
