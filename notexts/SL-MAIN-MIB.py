...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSyslogPort=slmSyslogPort, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slMain=slMain, slmSysName=slmSysName, slmSnmpv3Auth=slmSnmpv3Auth, slmLogFile=slmLogFile, slmPortsNumber=slmPortsNumber, slmTrapLogParam1=slmTrapLogParam1, slmSysSubnetMask=slmSysSubnetMask, slmChPass=slmChPass, slmSwRevDate=slmSwRevDate, slmAdminTable=slmAdminTable, slmTrapDestCommunity=slmTrapDestCommunity, slmSysAlmDeact=slmSysAlmDeact, slmChPassTable=slmChPassTable, slmSys=slmSys, slmSysChassisId=slmSysChassisId, slmLicenseExpiration=slmLicenseExpiration, slmSysTemperature=slmSysTemperature, slmTrapLogName=slmTrapLogName, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevTable=slmSwRevTable, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevStatus=slmSwRevStatus, slmConfigFile=slmConfigFile, slmSwRevName=slmSwRevName, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmPmAvailable=slmPmAvailable, slmAdminCommunity=slmAdminCommunity, slmTrapPort=slmTrapPort, slmChPassEntry=slmChPassEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmAuthTable=slmAuthTable, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestTable=slmTrapDestTable, slmTrapLogEntry=slmTrapLogEntry, slmReadCommunity=slmReadCommunity, slmTrapLogParam5=slmTrapLogParam5, slmSwRevEntry=slmSwRevEntry, slmTrapDestEntry=slmTrapDestEntry, slmTrapEnable=slmTrapEnable, slmOemType=slmOemType, slmSysIpAddr=slmSysIpAddr, slmEdfaNumber=slmEdfaNumber, slmAdminEntry=slmAdminEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysOperStatus=slmSysOperStatus, slmLicenseId=slmLicenseId, slmTrapLogParam6=slmTrapLogParam6, slmSysAlmAct=slmSysAlmAct, slmConfigSysUptime=slmConfigSysUptime, slmTrap=slmTrap, slm40GConf=slm40GConf, slmAuthPassword=slmAuthPassword, slmSysUplinkRate=slmSysUplinkRate, slmTrapSysNameChange=slmTrapSysNameChange, slmPsuNumber=slmPsuNumber, UserPassword=UserPassword, slmTrapCommunity=slmTrapCommunity, slmSyslogLevel=slmSyslogLevel, slmTrapLogId=slmTrapLogId, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestRowStatus=slmTrapDestRowStatus, slmVcatDelay=slmVcatDelay, slmTrapLogParam2=slmTrapLogParam2, slmSwRevDirectory=slmSwRevDirectory, UserLogin=UserLogin, slmLicenseIndex=slmLicenseIndex, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmRstpEnabled=slmRstpEnabled, slmAdminRowStatus=slmAdminRowStatus, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLanIpAddr=slmSysLanIpAddr, slmMuxNumber=slmMuxNumber, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAuth=slmAuth, slmAdmin=slmAdmin, PYSNMP_MODULE_ID=slMain, slmRebootDelay=slmRebootDelay, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestTable=slmSyslogDestTable, slmTrapUserAccess=slmTrapUserAccess, slmAdminPassword=slmAdminPassword, slmSysTrapFormat=slmSysTrapFormat, slmAuthCommunity=slmAuthCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysMode=slmSysMode, slmTrapLogTable=slmTrapLogTable, slmSyslogDestAddress=slmSyslogDestAddress, slmTid=slmTid, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuthEntry=slmAuthEntry, slmBoxSize=slmBoxSize, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmChPassOldPass=slmChPassOldPass, UserCommunity=UserCommunity, AdminAccess=AdminAccess, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmLicenseTable=slmLicenseTable, slmTrapDestAddress=slmTrapDestAddress, slmAuthLogin=slmAuthLogin, slmLicense=slmLicense, SoftwareRevision=SoftwareRevision, slmNetworkMode=slmNetworkMode, slmSysLocation=slmSysLocation, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminLogin=slmAdminLogin, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogParam3=slmTrapLogParam3, slmLogin=slmLogin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmWriteCommunity=slmWriteCommunity, slmLicenseEntry=slmLicenseEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogParam4=slmTrapLogParam4, slmAdminAccess=slmAdminAccess, slmChPassLogin=slmChPassLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysResetPm=slmSysResetPm, slmChPassNewPass=slmChPassNewPass, slmSnmpv3Password=slmSnmpv3Password)
