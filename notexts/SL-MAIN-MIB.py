...
ModuleIdentity, Unsigned32, NotificationType, MibIdentifier, iso, Counter64, ObjectIdentity, TimeTicks, IpAddress, Gauge32, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "NotificationType", "MibIdentifier", "iso", "Counter64", "ObjectIdentity", "TimeTicks", "IpAddress", "Gauge32", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Opaque")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmPortsNumber=slmPortsNumber, slmLicense=slmLicense, slmSysChassisId=slmSysChassisId, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogEntry=slmTrapLogEntry, slmSys=slmSys, slmAdminTable=slmAdminTable, slmSysResetPm=slmSysResetPm, slmTrapLogParam1=slmTrapLogParam1, slmTrapDestAddress=slmTrapDestAddress, slmAuthTable=slmAuthTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminLogin=slmAdminLogin, slmAuthLogin=slmAuthLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogParam2=slmTrapLogParam2, slmChPassTable=slmChPassTable, slmSyslogLevel=slmSyslogLevel, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTid=slmTid, slmChPass=slmChPass, slmConfigSysUptime=slmConfigSysUptime, slmAuthPassword=slmAuthPassword, slmLicenseIndex=slmLicenseIndex, slmTrapUserLogin=slmTrapUserLogin, slmTrap=slmTrap, slmChPassLogin=slmChPassLogin, slmReadCommunity=slmReadCommunity, slmTrapLogParam4=slmTrapLogParam4, slmBoxSize=slmBoxSize, slmPsuNumber=slmPsuNumber, slmPmAvailable=slmPmAvailable, slmSwRevDirectory=slmSwRevDirectory, slmSysTemperature=slmSysTemperature, slmSwRevEntry=slmSwRevEntry, slmTrapEnable=slmTrapEnable, slmSysOperStatus=slmSysOperStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogId=slmTrapLogId, slmSysNetworkPrefix=slmSysNetworkPrefix, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminAccess=slmAdminAccess, slmTrapLogParam3=slmTrapLogParam3, slmLogin=slmLogin, slmSwRevTable=slmSwRevTable, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapUserAccess=slmTrapUserAccess, slmSysLocation=slmSysLocation, slmTrapCommunity=slmTrapCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestTable=slmTrapDestTable, slmAdminPassword=slmAdminPassword, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysCalendarTime=slmSysCalendarTime, slmAuthCommunity=slmAuthCommunity, slmAuthEntry=slmAuthEntry, slmTrapDestEntry=slmTrapDestEntry, slmRebootDelay=slmRebootDelay, slmTrapLogParam5=slmTrapLogParam5, SoftwareRevision=SoftwareRevision, slmSnmpv3Password=slmSnmpv3Password, slmSyslogPort=slmSyslogPort, slmSysName=slmSysName, slmOemType=slmOemType, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminEntry=slmAdminEntry, slmChPassOldPass=slmChPassOldPass, slmTrapLogName=slmTrapLogName, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassNewPass=slmChPassNewPass, slmAuth=slmAuth, slmTrapPort=slmTrapPort, slmSysAlmAct=slmSysAlmAct, slmSysSubnetMask=slmSysSubnetMask, slmSysIpAddr=slmSysIpAddr, slmSysAdminStatus=slmSysAdminStatus, slmLogFile=slmLogFile, slmVcatDelay=slmVcatDelay, slmAdminCommunity=slmAdminCommunity, slMain=slMain, UserPassword=UserPassword, slmTrapLogTable=slmTrapLogTable, slmTrapSysNameChange=slmTrapSysNameChange, slmEdfaNumber=slmEdfaNumber, slmSwRevName=slmSwRevName, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdmin=slmAdmin, slmSyslogDestAddress=slmSyslogDestAddress, slmLicenseExpiration=slmLicenseExpiration, slmSwRevStatus=slmSwRevStatus, UserLogin=UserLogin, slmSysSnmpVersion=slmSysSnmpVersion, UserCommunity=UserCommunity, slmAdminRowStatus=slmAdminRowStatus, slmNetworkMode=slmNetworkMode, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogParam6=slmTrapLogParam6, slmRstpEnabled=slmRstpEnabled, slm40GConf=slm40GConf, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLicenseTable=slmLicenseTable, slmLicenseId=slmLicenseId, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapDestRowStatus=slmTrapDestRowStatus, AdminAccess=AdminAccess, slmSwRevDate=slmSwRevDate, slmSysUplinkRate=slmSysUplinkRate, slmMuxNumber=slmMuxNumber, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmWriteCommunity=slmWriteCommunity, slmChPassEntry=slmChPassEntry, slmSysTrapFormat=slmSysTrapFormat, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestTable=slmSyslogDestTable, PYSNMP_MODULE_ID=slMain, slmSysAlmDeact=slmSysAlmDeact, slmConfigFile=slmConfigFile, slmSnmpv3Auth=slmSnmpv3Auth, slmLicenseEntry=slmLicenseEntry, slmSysMode=slmSysMode)
