...
Gauge32, NotificationType, TimeTicks, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Opaque, Bits, Counter64, Unsigned32, MibIdentifier, ObjectIdentity, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "TimeTicks", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Opaque", "Bits", "Counter64", "Unsigned32", "MibIdentifier", "ObjectIdentity", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicenseId=slmLicenseId, slmTrapLogEntry=slmTrapLogEntry, slmAuth=slmAuth, slmSysOperStatus=slmSysOperStatus, slmAdminRowStatus=slmAdminRowStatus, slmAuthCommunity=slmAuthCommunity, UserPassword=UserPassword, slmMuxNumber=slmMuxNumber, slmSysTrapFormat=slmSysTrapFormat, slmAuthEntry=slmAuthEntry, slmSysIpAddr=slmSysIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmSysName=slmSysName, slmSyslogLevel=slmSyslogLevel, slmSysTemperature=slmSysTemperature, slmSysAlmDeact=slmSysAlmDeact, slmSyslogPort=slmSyslogPort, slmVcatDelay=slmVcatDelay, slmTrapDestTable=slmTrapDestTable, slmSysLocation=slmSysLocation, slmTrapLogParam5=slmTrapLogParam5, slmSysLanIpAddr=slmSysLanIpAddr, slmLogFile=slmLogFile, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysCalendarTime=slmSysCalendarTime, slmSwRevDate=slmSwRevDate, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysChassisId=slmSysChassisId, slmAuthPassword=slmAuthPassword, slmOemType=slmOemType, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam1=slmTrapLogParam1, slmAdmin=slmAdmin, slmLicense=slmLicense, slmSwRevName=slmSwRevName, slmChPassTable=slmChPassTable, slmLicenseTable=slmLicenseTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapPort=slmTrapPort, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmPsuNumber=slmPsuNumber, SoftwareRevision=SoftwareRevision, slMain=slMain, slmTrapDestAddress=slmTrapDestAddress, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysMode=slmSysMode, slmConfigSysSignalType=slmConfigSysSignalType, slmTid=slmTid, slmAdminLogin=slmAdminLogin, slmNetworkMode=slmNetworkMode, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSnmpv3Auth=slmSnmpv3Auth, slmPmAvailable=slmPmAvailable, slmTrap=slmTrap, slmRebootDelay=slmRebootDelay, slmTrapUserLogin=slmTrapUserLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmSysSubnetMask=slmSysSubnetMask, PYSNMP_MODULE_ID=slMain, slmConfigFile=slmConfigFile, slmTrapDestEntry=slmTrapDestEntry, slmAdminTable=slmAdminTable, slmAdminPassword=slmAdminPassword, slmPortsNumber=slmPortsNumber, slmChPassOldPass=slmChPassOldPass, slmSysGatewayAddr=slmSysGatewayAddr, slmBoxSize=slmBoxSize, slmLogin=slmLogin, slmConfigSysUptime=slmConfigSysUptime, slmAdminCommunity=slmAdminCommunity, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam6=slmTrapLogParam6, AdminAccess=AdminAccess, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapCommunity=slmTrapCommunity, slmChPassLogin=slmChPassLogin, slm40GConf=slm40GConf, slmSysAdminStatus=slmSysAdminStatus, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassEntry=slmChPassEntry, slmSysAlmAct=slmSysAlmAct, slmReadCommunity=slmReadCommunity, slmTrapLogParam3=slmTrapLogParam3, slmLicenseEntry=slmLicenseEntry, slmSysResetPm=slmSysResetPm, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmWriteCommunity=slmWriteCommunity, slmTrapEnable=slmTrapEnable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSyslogDestTable=slmSyslogDestTable, slmAuthLogin=slmAuthLogin, slmRstpEnabled=slmRstpEnabled, slmTrapLogId=slmTrapLogId, slmSwRevTable=slmSwRevTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminAccess=slmAdminAccess, slmChPassNewPass=slmChPassNewPass, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevEntry=slmSwRevEntry, slmTrapLogName=slmTrapLogName, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuthTable=slmAuthTable, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmSysUplinkRate=slmSysUplinkRate, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogParam2=slmTrapLogParam2, slmSnmpv3Password=slmSnmpv3Password, slmAdminEntry=slmAdminEntry, slmLicenseIndex=slmLicenseIndex, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam4=slmTrapLogParam4, UserCommunity=UserCommunity, slmSwRevDirectory=slmSwRevDirectory, UserLogin=UserLogin, slmTrapUserAccess=slmTrapUserAccess, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmChPass=slmChPass, slmSwRevStatus=slmSwRevStatus, slmLicenseExpiration=slmLicenseExpiration, slmSys=slmSys)
