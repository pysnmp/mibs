...
TimeTicks, IpAddress, ModuleIdentity, iso, Bits, Counter64, ObjectIdentity, Counter32, Unsigned32, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Opaque, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "ModuleIdentity", "iso", "Bits", "Counter64", "ObjectIdentity", "Counter32", "Unsigned32", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Opaque", "NotificationType")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", UserPassword=UserPassword, slmSnmpv3Auth=slmSnmpv3Auth, slmLicense=slmLicense, slmEdfaNumber=slmEdfaNumber, slmAuth=slmAuth, slmSysName=slmSysName, PYSNMP_MODULE_ID=slMain, slmSysMode=slmSysMode, slmSwRevDate=slmSwRevDate, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmPortsNumber=slmPortsNumber, slmPmAvailable=slmPmAvailable, UserCommunity=UserCommunity, slmSysAlmAct=slmSysAlmAct, slmSyslogDestTable=slmSyslogDestTable, slmAdminTable=slmAdminTable, slmAdminCommunity=slmAdminCommunity, slmConfigSysUptime=slmConfigSysUptime, AdminAccess=AdminAccess, slmChPassLogin=slmChPassLogin, slmSyslogPort=slmSyslogPort, slmTrapDestEntry=slmTrapDestEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapPort=slmTrapPort, slmSysActiveSwVersion=slmSysActiveSwVersion, slMain=slMain, slmSysResetPm=slmSysResetPm, slmMuxNumber=slmMuxNumber, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapUserLogin=slmTrapUserLogin, slmAdminEntry=slmAdminEntry, slmTrapLogParam3=slmTrapLogParam3, slmTrapEnable=slmTrapEnable, slmLicenseIndex=slmLicenseIndex, slmTrap=slmTrap, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysLocation=slmSysLocation, slmSwRevEntry=slmSwRevEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogEntry=slmTrapLogEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogParam6=slmTrapLogParam6, slmNetworkMode=slmNetworkMode, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmChPassTable=slmChPassTable, slmAdmin=slmAdmin, slmConfigFile=slmConfigFile, UserLogin=UserLogin, SoftwareRevision=SoftwareRevision, slmAdminPassword=slmAdminPassword, slmSwRevStatus=slmSwRevStatus, slmRebootDelay=slmRebootDelay, slmTrapDestTable=slmTrapDestTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminRowStatus=slmAdminRowStatus, slmChPassNewPass=slmChPassNewPass, slmBoxSize=slmBoxSize, slmChPass=slmChPass, slmTrapLogParam5=slmTrapLogParam5, slmSnmpv3Password=slmSnmpv3Password, slmSwRevName=slmSwRevName, slmPsuNumber=slmPsuNumber, slmLogin=slmLogin, slmSyslogLevel=slmSyslogLevel, slmAuthLogin=slmAuthLogin, slmSysUplinkRate=slmSysUplinkRate, slm40GConf=slm40GConf, slmSysNetworkPrefix=slmSysNetworkPrefix, slmRstpEnabled=slmRstpEnabled, slmSwRevDirectory=slmSwRevDirectory, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapCommunity=slmTrapCommunity, slmVcatDelay=slmVcatDelay, slmSys=slmSys, slmTrapLogTable=slmTrapLogTable, slmTrapLogName=slmTrapLogName, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysAdminStatus=slmSysAdminStatus, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminAccess=slmAdminAccess, slmChPassEntry=slmChPassEntry, slmSysSubnetMask=slmSysSubnetMask, slmLicenseEntry=slmLicenseEntry, slmOemType=slmOemType, slmSwRevTable=slmSwRevTable, slmTopologyEnabled=slmTopologyEnabled, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLicenseId=slmLicenseId, slmLicenseTable=slmLicenseTable, slmTid=slmTid, slmSysTemperature=slmSysTemperature, slmAdminLogin=slmAdminLogin, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuthCommunity=slmAuthCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmWriteCommunity=slmWriteCommunity, slmTrapLogId=slmTrapLogId, slmSyslogDestEntry=slmSyslogDestEntry, slmLogFile=slmLogFile, slmReadCommunity=slmReadCommunity, slmLicenseExpiration=slmLicenseExpiration, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogParam2=slmTrapLogParam2, slmSysOperStatus=slmSysOperStatus, slmSysIpAddr=slmSysIpAddr, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam1=slmTrapLogParam1, slmAuthPassword=slmAuthPassword, slmConfigSysSignalType=slmConfigSysSignalType, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysTrapFormat=slmSysTrapFormat, slmAuthEntry=slmAuthEntry, slmSysChassisId=slmSysChassisId, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam4=slmTrapLogParam4, slmAuthTable=slmAuthTable)
