...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmNetworkMode=slmNetworkMode, slmTrapDestTable=slmTrapDestTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysIpAddr=slmSysIpAddr, AdminAccess=AdminAccess, slmSysSubnetMask=slmSysSubnetMask, slmSysTrapFormat=slmSysTrapFormat, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogDestRowStatus=slmSyslogDestRowStatus, UserLogin=UserLogin, slmTrapUserAccess=slmTrapUserAccess, slmSnmpv3Password=slmSnmpv3Password, slmChPassNewPass=slmChPassNewPass, slmAdminAccess=slmAdminAccess, slmSysAlmAct=slmSysAlmAct, slmSyslogDestAddress=slmSyslogDestAddress, UserCommunity=UserCommunity, slmSysTemperature=slmSysTemperature, slmTrapDestEntry=slmTrapDestEntry, slmSysName=slmSysName, slmTrapLogId=slmTrapLogId, slmTrapSysNameChange=slmTrapSysNameChange, slmSysResetPm=slmSysResetPm, slmWriteCommunity=slmWriteCommunity, slmTrapEnable=slmTrapEnable, slmConfigSysUptime=slmConfigSysUptime, slmChPassOldPass=slmChPassOldPass, slmTrapDestAddress=slmTrapDestAddress, slmSysAlmDeact=slmSysAlmDeact, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam2=slmTrapLogParam2, slmTrapCommunity=slmTrapCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysActiveSwVersion=slmSysActiveSwVersion, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevStatus=slmSwRevStatus, UserPassword=UserPassword, slmAuthTable=slmAuthTable, slmSysUplinkRate=slmSysUplinkRate, slmAdmin=slmAdmin, slmAdminRowStatus=slmAdminRowStatus, slmAdminCommunity=slmAdminCommunity, slmSysLocation=slmSysLocation, slmConfigFile=slmConfigFile, slmSysMode=slmSysMode, slmLicenseEntry=slmLicenseEntry, slmPsuNumber=slmPsuNumber, slmSwRevDate=slmSwRevDate, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapUserLogin=slmTrapUserLogin, slmSysPmStartOfDay=slmSysPmStartOfDay, slMain=slMain, slmSys=slmSys, slmSnmpv3Priv=slmSnmpv3Priv, slmPortsNumber=slmPortsNumber, slmSysAdminStatus=slmSysAdminStatus, slmChPassLogin=slmChPassLogin, slmTid=slmTid, slmLicenseTable=slmLicenseTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmBoxSize=slmBoxSize, slmSyslogPort=slmSyslogPort, slmSyslogLevel=slmSyslogLevel, slmAuthLogin=slmAuthLogin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAuthPassword=slmAuthPassword, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevTable=slmSwRevTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevEntry=slmSwRevEntry, slmReadCommunity=slmReadCommunity, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminLogin=slmAdminLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmMuxNumber=slmMuxNumber, slmSysGatewayAddr=slmSysGatewayAddr, slmLicenseId=slmLicenseId, slmSysChassisId=slmSysChassisId, slmTrapPort=slmTrapPort, slmLicense=slmLicense, SoftwareRevision=SoftwareRevision, slmTrapLogTable=slmTrapLogTable, slmAdminPassword=slmAdminPassword, slmTrapLogName=slmTrapLogName, slmPmAvailable=slmPmAvailable, slmVcatDelay=slmVcatDelay, slmLicenseIndex=slmLicenseIndex, slmRebootDelay=slmRebootDelay, slmAuth=slmAuth, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogEntry=slmTrapLogEntry, slmChPass=slmChPass, slmSwRevName=slmSwRevName, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam5=slmTrapLogParam5, slmSysLanIpAddr=slmSysLanIpAddr, slmRstpEnabled=slmRstpEnabled, slm40GConf=slm40GConf, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam1=slmTrapLogParam1, slmAdminEntry=slmAdminEntry, slmAdminTable=slmAdminTable, slmTrap=slmTrap, PYSNMP_MODULE_ID=slMain, slmTrapLogParam3=slmTrapLogParam3, slmAuthEntry=slmAuthEntry, slmSysOperStatus=slmSysOperStatus, slmSyslogDestTable=slmSyslogDestTable, slmLogin=slmLogin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicenseExpiration=slmLicenseExpiration, slmLogFile=slmLogFile, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam6=slmTrapLogParam6, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysCalendarTime=slmSysCalendarTime, slmEdfaNumber=slmEdfaNumber, slmChPassEntry=slmChPassEntry, slmOemType=slmOemType, slmAuthCommunity=slmAuthCommunity, slmChPassTable=slmChPassTable, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr)
