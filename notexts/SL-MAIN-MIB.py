...
ModuleIdentity, ObjectIdentity, Counter32, TimeTicks, MibIdentifier, Counter64, Gauge32, Opaque, Unsigned32, Integer32, iso, IpAddress, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "Counter32", "TimeTicks", "MibIdentifier", "Counter64", "Gauge32", "Opaque", "Unsigned32", "Integer32", "iso", "IpAddress", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmConfigSysUptime=slmConfigSysUptime, slmSysSubnetMask=slmSysSubnetMask, slmSysTemperature=slmSysTemperature, slmSysCalendarTime=slmSysCalendarTime, slmSysResetPm=slmSysResetPm, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogParam4=slmTrapLogParam4, slmAdminCommunity=slmAdminCommunity, slmSwRevDate=slmSwRevDate, slmPsuNumber=slmPsuNumber, slmTrapUserAccess=slmTrapUserAccess, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthEntry=slmAuthEntry, slmTrapEnable=slmTrapEnable, slmBoxSize=slmBoxSize, slmRstpEnabled=slmRstpEnabled, AdminAccess=AdminAccess, slmSysActiveSwVersion=slmSysActiveSwVersion, slmPortsNumber=slmPortsNumber, slmSwRevName=slmSwRevName, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPassTable=slmChPassTable, slmAdminPassword=slmAdminPassword, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam6=slmTrapLogParam6, slmTrapSysLocationChange=slmTrapSysLocationChange, SoftwareRevision=SoftwareRevision, slmTrapDestAddress=slmTrapDestAddress, slmAuth=slmAuth, slmSnmpv3Auth=slmSnmpv3Auth, slmOemType=slmOemType, slmMuxNumber=slmMuxNumber, slmSwRevStatus=slmSwRevStatus, slmChPass=slmChPass, slmSysChassisId=slmSysChassisId, slmLicenseId=slmLicenseId, slmVcatDelay=slmVcatDelay, slmTrapLogName=slmTrapLogName, slmRebootDelay=slmRebootDelay, slmTrapLogParam5=slmTrapLogParam5, slmLicenseEntry=slmLicenseEntry, slmChPassLogin=slmChPassLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevTable=slmSwRevTable, slmSyslogPort=slmSyslogPort, slm40GConf=slm40GConf, slmLicenseIndex=slmLicenseIndex, slmSysOperStatus=slmSysOperStatus, slmSyslogLevel=slmSyslogLevel, slmConfigSysSignalType=slmConfigSysSignalType, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicense=slmLicense, slmSysAlmAct=slmSysAlmAct, slmTrapCommunity=slmTrapCommunity, slmAuthTable=slmAuthTable, slmSys=slmSys, slmSysAdminStatus=slmSysAdminStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmSysIpAddr=slmSysIpAddr, slmTrapLogId=slmTrapLogId, slmLicenseExpiration=slmLicenseExpiration, slmTrapDestTable=slmTrapDestTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmPmAvailable=slmPmAvailable, slmTrapDestCommunity=slmTrapDestCommunity, slmSysTrapFormat=slmSysTrapFormat, slmSysName=slmSysName, slmSyslogDestTable=slmSyslogDestTable, slmAdmin=slmAdmin, slmAdminTable=slmAdminTable, slmSyslogDestAddress=slmSyslogDestAddress, slmLogin=slmLogin, UserPassword=UserPassword, slmSysSnmpVersion=slmSysSnmpVersion, slmWriteCommunity=slmWriteCommunity, slmNetworkMode=slmNetworkMode, slmAdminAccess=slmAdminAccess, slmChPassNewPass=slmChPassNewPass, slmSysAlmDeact=slmSysAlmDeact, slMain=slMain, slmLogFile=slmLogFile, slmAuthLogin=slmAuthLogin, slmChPassEntry=slmChPassEntry, slmReadCommunity=slmReadCommunity, UserCommunity=UserCommunity, slmTrapLogParam1=slmTrapLogParam1, slmSysMode=slmSysMode, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrap=slmTrap, slmChPassOldPass=slmChPassOldPass, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogEntry=slmTrapLogEntry, slmLicenseTable=slmLicenseTable, slmAuthCommunity=slmAuthCommunity, slmAdminRowStatus=slmAdminRowStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmTid=slmTid, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysUplinkRate=slmSysUplinkRate, slmSysLocation=slmSysLocation, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevDirectory=slmSwRevDirectory, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestEntry=slmTrapDestEntry, slmTrapPort=slmTrapPort, slmEdfaNumber=slmEdfaNumber, slmAuthPassword=slmAuthPassword, PYSNMP_MODULE_ID=slMain, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogParam3=slmTrapLogParam3, slmAdminLogin=slmAdminLogin, slmTrapLogTable=slmTrapLogTable, slmAdminEntry=slmAdminEntry, slmSwRevEntry=slmSwRevEntry, UserLogin=UserLogin, slmSnmpv3Password=slmSnmpv3Password, slmConfigFile=slmConfigFile, slmSnmpv3Priv=slmSnmpv3Priv)
