...
Counter32, ModuleIdentity, iso, Bits, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, Opaque, NotificationType, IpAddress, Unsigned32, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "iso", "Bits", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "Opaque", "NotificationType", "IpAddress", "Unsigned32", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmRebootDelay=slmRebootDelay, slmSysMode=slmSysMode, slmLogFile=slmLogFile, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapCommunity=slmTrapCommunity, slmSwRevName=slmSwRevName, slmPortsNumber=slmPortsNumber, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevTable=slmSwRevTable, slmTopologyEnabled=slmTopologyEnabled, slmChPassTable=slmChPassTable, slmSysSubnetMask=slmSysSubnetMask, slmSysLanIpAddr=slmSysLanIpAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogId=slmTrapLogId, slmTrapLogParam4=slmTrapLogParam4, slmLogin=slmLogin, slmSysResetPm=slmSysResetPm, slmSysCalendarTime=slmSysCalendarTime, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogTable=slmTrapLogTable, slmAuthPassword=slmAuthPassword, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogName=slmTrapLogName, slmVcatDelay=slmVcatDelay, slmAdminEntry=slmAdminEntry, slmAdminCommunity=slmAdminCommunity, slmSysAdminStatus=slmSysAdminStatus, slmReadCommunity=slmReadCommunity, slmSyslogLevel=slmSyslogLevel, slmLicense=slmLicense, slmSysTemperature=slmSysTemperature, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapUserAccess=slmTrapUserAccess, slMain=slMain, slmLicenseIndex=slmLicenseIndex, slmNetworkMode=slmNetworkMode, slmSwRevDirectory=slmSwRevDirectory, slmSwRevStatus=slmSwRevStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestIpAddress=slmTrapDestIpAddress, slmConfigFile=slmConfigFile, slmChPass=slmChPass, slmAdminTable=slmAdminTable, slmTrapDestTable=slmTrapDestTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLicenseId=slmLicenseId, slmSys=slmSys, slmSysName=slmSysName, slmAuthCommunity=slmAuthCommunity, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam5=slmTrapLogParam5, slmChPassLogin=slmChPassLogin, slmSysNetworkPrefix=slmSysNetworkPrefix, PYSNMP_MODULE_ID=slMain, UserCommunity=UserCommunity, slmLicenseTable=slmLicenseTable, slmLicenseEntry=slmLicenseEntry, slmTrapLogEntry=slmTrapLogEntry, slmChPassEntry=slmChPassEntry, slmTid=slmTid, slmAuthTable=slmAuthTable, slmLicenseExpiration=slmLicenseExpiration, slmSysIpAddr=slmSysIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdmin=slmAdmin, slmTrapLogParam1=slmTrapLogParam1, slmTrapUserLogin=slmTrapUserLogin, slmPsuNumber=slmPsuNumber, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slm40GConf=slm40GConf, slmAdminPassword=slmAdminPassword, slmTrapLogParam3=slmTrapLogParam3, AdminAccess=AdminAccess, slmAuthEntry=slmAuthEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPassNewPass=slmChPassNewPass, slmPmAvailable=slmPmAvailable, slmEdfaNumber=slmEdfaNumber, slmAuth=slmAuth, UserPassword=UserPassword, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogPort=slmSyslogPort, slmTrapEnable=slmTrapEnable, slmWriteCommunity=slmWriteCommunity, slmAdminAccess=slmAdminAccess, slmSnmpv3Priv=slmSnmpv3Priv, slmSysTrapFormat=slmSysTrapFormat, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogDestTable=slmSyslogDestTable, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapPort=slmTrapPort, slmOemType=slmOemType, slmChPassOldPass=slmChPassOldPass, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmSysLocation=slmSysLocation, UserLogin=UserLogin, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysUplinkRate=slmSysUplinkRate, slmSysChassisId=slmSysChassisId, SoftwareRevision=SoftwareRevision, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSnmpv3Password=slmSnmpv3Password, slmSwRevDate=slmSwRevDate, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestCommunity=slmTrapDestCommunity, slmAuthLogin=slmAuthLogin, slmTrapLogParam2=slmTrapLogParam2, slmSysOperStatus=slmSysOperStatus, slmTrapDestAddress=slmTrapDestAddress, slmSysAlmAct=slmSysAlmAct, slmBoxSize=slmBoxSize, slmSysAlmDeact=slmSysAlmDeact, slmRstpEnabled=slmRstpEnabled, slmTrap=slmTrap, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevEntry=slmSwRevEntry, slmAdminLogin=slmAdminLogin, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmConfigSysUptime=slmConfigSysUptime, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestEntry=slmTrapDestEntry, slmMuxNumber=slmMuxNumber)
