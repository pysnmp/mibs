...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, Counter32, Counter64, ObjectIdentity, Unsigned32, Gauge32, Opaque, MibIdentifier, IpAddress, NotificationType, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "Counter32", "Counter64", "ObjectIdentity", "Unsigned32", "Gauge32", "Opaque", "MibIdentifier", "IpAddress", "NotificationType", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminRowStatus=slmAdminRowStatus, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestCommunity=slmTrapDestCommunity, SoftwareRevision=SoftwareRevision, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicenseId=slmLicenseId, slmSysPmStartOfDay=slmSysPmStartOfDay, slmMuxNumber=slmMuxNumber, slmSnmpv3Auth=slmSnmpv3Auth, slmSwRevDirectory=slmSwRevDirectory, slmRstpEnabled=slmRstpEnabled, slmSnmpv3Password=slmSnmpv3Password, slmChPassLogin=slmChPassLogin, slmAdminCommunity=slmAdminCommunity, slmSys=slmSys, slmPsuNumber=slmPsuNumber, slmAdminEntry=slmAdminEntry, slmTrapLogName=slmTrapLogName, slmTrapLogParam1=slmTrapLogParam1, slmSysAlmAct=slmSysAlmAct, UserCommunity=UserCommunity, slmSysSnmpVersion=slmSysSnmpVersion, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogId=slmTrapLogId, slm40GConf=slm40GConf, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmSysChassisId=slmSysChassisId, slMain=slMain, slmSysGatewayAddr=slmSysGatewayAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevDate=slmSwRevDate, slmTrapEnable=slmTrapEnable, slmConfigSysUptime=slmConfigSysUptime, slmTrapCommunity=slmTrapCommunity, slmNetworkMode=slmNetworkMode, slmChPassOldPass=slmChPassOldPass, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam5=slmTrapLogParam5, slmTrapDestAddress=slmTrapDestAddress, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmConfigSysSignalType=slmConfigSysSignalType, slmVcatDelay=slmVcatDelay, slmAdminAccess=slmAdminAccess, slmSyslogDestTable=slmSyslogDestTable, slmSysAlmDeact=slmSysAlmDeact, PYSNMP_MODULE_ID=slMain, slmSyslogDestEntry=slmSyslogDestEntry, slmSysResetPm=slmSysResetPm, slmTrapLogEntry=slmTrapLogEntry, slmConfigFile=slmConfigFile, slmEdfaNumber=slmEdfaNumber, slmLicenseIndex=slmLicenseIndex, UserLogin=UserLogin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevTable=slmSwRevTable, slmPortsNumber=slmPortsNumber, slmSysName=slmSysName, slmChPassNewPass=slmChPassNewPass, slmAuthEntry=slmAuthEntry, slmAdminTable=slmAdminTable, slmAuthPassword=slmAuthPassword, slmTrapUserAccess=slmTrapUserAccess, slmBoxSize=slmBoxSize, slmAuth=slmAuth, slmLicense=slmLicense, slmSysLocation=slmSysLocation, slmSwRevEntry=slmSwRevEntry, slmAuthTable=slmAuthTable, slmTrapLogTable=slmTrapLogTable, slmTrap=slmTrap, slmSysMode=slmSysMode, slmChPass=slmChPass, slmTrapSysNameChange=slmTrapSysNameChange, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogPort=slmSyslogPort, slmSysSubnetMask=slmSysSubnetMask, slmLogFile=slmLogFile, slmSysIpAddr=slmSysIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTid=slmTid, slmTrapLogParam2=slmTrapLogParam2, slmAdmin=slmAdmin, slmSyslogLevel=slmSyslogLevel, slmAdminLogin=slmAdminLogin, slmTrapUserLogin=slmTrapUserLogin, slmSwRevStatus=slmSwRevStatus, slmRebootDelay=slmRebootDelay, slmSysAdminStatus=slmSysAdminStatus, slmLogin=slmLogin, slmTrapPort=slmTrapPort, slmOemType=slmOemType, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogParam3=slmTrapLogParam3, slmChPassEntry=slmChPassEntry, slmSysUplinkRate=slmSysUplinkRate, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthLogin=slmAuthLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevName=slmSwRevName, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmPmAvailable=slmPmAvailable, slmTopologyEnabled=slmTopologyEnabled, AdminAccess=AdminAccess, slmSysTemperature=slmSysTemperature, slmSysOperStatus=slmSysOperStatus, slmWriteCommunity=slmWriteCommunity, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLicenseExpiration=slmLicenseExpiration, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestEntry=slmTrapDestEntry, slmLicenseEntry=slmLicenseEntry, UserPassword=UserPassword, slmAdminPassword=slmAdminPassword, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmChPassTable=slmChPassTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestTable=slmTrapDestTable, slmReadCommunity=slmReadCommunity, slmLicenseTable=slmLicenseTable, slmTrapLogParam4=slmTrapLogParam4)
