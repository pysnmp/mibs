...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogId=slmTrapLogId, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPassOldPass=slmChPassOldPass, slmChPassNewPass=slmChPassNewPass, slmTrapUserLogin=slmTrapUserLogin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLicenseIndex=slmLicenseIndex, slmSyslogLevel=slmSyslogLevel, slmTrapLogParam5=slmTrapLogParam5, slmAdminTable=slmAdminTable, slmChPassEntry=slmChPassEntry, slmSwRevStatus=slmSwRevStatus, slmSysIpAddr=slmSysIpAddr, slmSwRevTable=slmSwRevTable, slmLicenseExpiration=slmLicenseExpiration, slmConfigFile=slmConfigFile, slmTrapLogName=slmTrapLogName, slm40GConf=slm40GConf, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmPmAvailable=slmPmAvailable, slmReadCommunity=slmReadCommunity, slmAdminCommunity=slmAdminCommunity, slmTrapLogEntry=slmTrapLogEntry, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam2=slmTrapLogParam2, slmEdfaNumber=slmEdfaNumber, slmSysAdminStatus=slmSysAdminStatus, slmNetworkMode=slmNetworkMode, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestEntry=slmTrapDestEntry, slmSysLocation=slmSysLocation, slmAuthPassword=slmAuthPassword, slmRebootDelay=slmRebootDelay, slmTrap=slmTrap, slmPortsNumber=slmPortsNumber, slmAdminLogin=slmAdminLogin, slmVcatDelay=slmVcatDelay, slmTrapDestTable=slmTrapDestTable, slmBoxSize=slmBoxSize, slmTrapSysNameChange=slmTrapSysNameChange, slmChPass=slmChPass, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapPort=slmTrapPort, slmSwRevDate=slmSwRevDate, slmTrapDestAddress=slmTrapDestAddress, slmTrapCommunity=slmTrapCommunity, slmWriteCommunity=slmWriteCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmChPassLogin=slmChPassLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSnmpv3Auth=slmSnmpv3Auth, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmSysAlmDeact=slmSysAlmDeact, UserCommunity=UserCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSnmpv3Priv=slmSnmpv3Priv, slmAuthCommunity=slmAuthCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAuth=slmAuth, SoftwareRevision=SoftwareRevision, slmTrapLogParam1=slmTrapLogParam1, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam4=slmTrapLogParam4, slmSnmpv3Password=slmSnmpv3Password, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysName=slmSysName, slmTid=slmTid, slmSysUplinkRate=slmSysUplinkRate, slmLicense=slmLicense, slmTrapLogParam6=slmTrapLogParam6, slmLicenseTable=slmLicenseTable, slmPsuNumber=slmPsuNumber, slmRstpEnabled=slmRstpEnabled, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysGatewayAddr=slmSysGatewayAddr, slmTopologyEnabled=slmTopologyEnabled, AdminAccess=AdminAccess, slmSysCalendarTime=slmSysCalendarTime, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminPassword=slmAdminPassword, slmSyslogDestAddress=slmSyslogDestAddress, slmSwRevName=slmSwRevName, slmSys=slmSys, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestIpAddress=slmSyslogDestIpAddress, UserLogin=UserLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevDirectory=slmSwRevDirectory, slmChPassTable=slmChPassTable, slmAuthLogin=slmAuthLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevEntry=slmSwRevEntry, slmSysMode=slmSysMode, UserPassword=UserPassword, PYSNMP_MODULE_ID=slMain, slmAuthEntry=slmAuthEntry, slmTrapUserAccess=slmTrapUserAccess, slmSyslogPort=slmSyslogPort, slmAdminAccess=slmAdminAccess, slmAdmin=slmAdmin, slmSysOperStatus=slmSysOperStatus, slmOemType=slmOemType, slmTrapDestCommunity=slmTrapDestCommunity, slmSysTrapFormat=slmSysTrapFormat, slMain=slMain, slmSysTemperature=slmSysTemperature, slmMuxNumber=slmMuxNumber, slmAuthTable=slmAuthTable, slmSyslogDestTable=slmSyslogDestTable, slmLogFile=slmLogFile, slmSysSubnetMask=slmSysSubnetMask, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminEntry=slmAdminEntry, slmTrapLogTable=slmTrapLogTable, slmSysChassisId=slmSysChassisId, slmTrapEnable=slmTrapEnable, slmLicenseId=slmLicenseId, slmLicenseEntry=slmLicenseEntry, slmTrapLogParam3=slmTrapLogParam3, slmSysAlmAct=slmSysAlmAct, slmLogin=slmLogin, slmSysResetPm=slmSysResetPm)
