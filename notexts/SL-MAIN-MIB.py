...
TimeTicks, ModuleIdentity, Integer32, Unsigned32, Gauge32, NotificationType, Bits, Opaque, Counter32, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "Integer32", "Unsigned32", "Gauge32", "NotificationType", "Bits", "Opaque", "Counter32", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "IpAddress")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAuthTable=slmAuthTable, slmSwRevEntry=slmSwRevEntry, slmChPass=slmChPass, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam5=slmTrapLogParam5, slmLicenseIndex=slmLicenseIndex, slmPortsNumber=slmPortsNumber, UserCommunity=UserCommunity, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestCommunity=slmTrapDestCommunity, slmAdmin=slmAdmin, slmConfigSysSignalType=slmConfigSysSignalType, AdminAccess=AdminAccess, slmAdminAccess=slmAdminAccess, slmTrapUserLogin=slmTrapUserLogin, slmSysResetPm=slmSysResetPm, slmSysCalendarTime=slmSysCalendarTime, slmAuthEntry=slmAuthEntry, slmAdminLogin=slmAdminLogin, slmAdminPassword=slmAdminPassword, slmTrapLogName=slmTrapLogName, slmSysAdminStatus=slmSysAdminStatus, slmSysTemperature=slmSysTemperature, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogParam3=slmTrapLogParam3, slmLicenseId=slmLicenseId, slmTrapCommunity=slmTrapCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, PYSNMP_MODULE_ID=slMain, UserLogin=UserLogin, slmTid=slmTid, slmAuthCommunity=slmAuthCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmWriteCommunity=slmWriteCommunity, slmReadCommunity=slmReadCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogId=slmTrapLogId, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysIpAddr=slmSysIpAddr, slmSys=slmSys, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysChassisId=slmSysChassisId, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLicense=slmLicense, slmLicenseEntry=slmLicenseEntry, slmSysSubnetMask=slmSysSubnetMask, slmPmAvailable=slmPmAvailable, slmChPassNewPass=slmChPassNewPass, slmAuthPassword=slmAuthPassword, slmSyslogLevel=slmSyslogLevel, slmLicenseTable=slmLicenseTable, slmSnmpv3Password=slmSnmpv3Password, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysAlmAct=slmSysAlmAct, slmSysName=slmSysName, slmConfigFile=slmConfigFile, slmTrapLogTable=slmTrapLogTable, slmLogin=slmLogin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevDate=slmSwRevDate, slmSysTrapFormat=slmSysTrapFormat, slmSwRevName=slmSwRevName, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestTable=slmSyslogDestTable, slmNetworkMode=slmNetworkMode, slmTrapDestTable=slmTrapDestTable, slmSnmpv3Auth=slmSnmpv3Auth, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestEntry=slmTrapDestEntry, slmAuth=slmAuth, slmSyslogPort=slmSyslogPort, slmTrapLogEntry=slmTrapLogEntry, slm40GConf=slm40GConf, slmSwRevTable=slmSwRevTable, slmSwRevStatus=slmSwRevStatus, slmTrapEnable=slmTrapEnable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmChPassEntry=slmChPassEntry, slmRebootDelay=slmRebootDelay, slmSysUplinkRate=slmSysUplinkRate, slmRstpEnabled=slmRstpEnabled, slmChPassLogin=slmChPassLogin, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSyslogDestAddress=slmSyslogDestAddress, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmConfigSysUptime=slmConfigSysUptime, UserPassword=UserPassword, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminRowStatus=slmAdminRowStatus, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapDestAddress=slmTrapDestAddress, slmTopologyEnabled=slmTopologyEnabled, slMain=slMain, slmSysSnmpVersion=slmSysSnmpVersion, slmSysNetworkPrefix=slmSysNetworkPrefix, SoftwareRevision=SoftwareRevision, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPassTable=slmChPassTable, slmPsuNumber=slmPsuNumber, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysAlmDeact=slmSysAlmDeact, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapPort=slmTrapPort, slmSyslogDestEntry=slmSyslogDestEntry, slmEdfaNumber=slmEdfaNumber, slmMuxNumber=slmMuxNumber, slmTrapUserAccess=slmTrapUserAccess, slmVcatDelay=slmVcatDelay, slmLogFile=slmLogFile, slmAuthLogin=slmAuthLogin, slmSysMode=slmSysMode, slmTrapLogParam1=slmTrapLogParam1, slmTrap=slmTrap, slmSysLocation=slmSysLocation, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam2=slmTrapLogParam2, slmAdminTable=slmAdminTable, slmSysOperStatus=slmSysOperStatus, slmSysGatewayAddr=slmSysGatewayAddr, slmBoxSize=slmBoxSize, slmOemType=slmOemType, slmAdminEntry=slmAdminEntry)
