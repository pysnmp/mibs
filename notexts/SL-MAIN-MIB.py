...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdmin=slmAdmin, slmTrapLogParam4=slmTrapLogParam4, UserLogin=UserLogin, slmSyslogPort=slmSyslogPort, slmAuthPassword=slmAuthPassword, slmBoxSize=slmBoxSize, slmOemType=slmOemType, slmReadCommunity=slmReadCommunity, slmNetworkMode=slmNetworkMode, slmTrapLogId=slmTrapLogId, slmTrapLogParam3=slmTrapLogParam3, slmSyslogLevel=slmSyslogLevel, slmAuthCommunity=slmAuthCommunity, slmChPassTable=slmChPassTable, slmSnmpv3Password=slmSnmpv3Password, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseExpiration=slmLicenseExpiration, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrap=slmTrap, slmTrapPort=slmTrapPort, UserCommunity=UserCommunity, slmSwRevStatus=slmSwRevStatus, slmSysAlmDeact=slmSysAlmDeact, slmTid=slmTid, slmTrapDestAddress=slmTrapDestAddress, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogEntry=slmTrapLogEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slmRebootDelay=slmRebootDelay, slmTrapLogParam6=slmTrapLogParam6, slmTrapEnable=slmTrapEnable, slmLicenseIndex=slmLicenseIndex, slmSysUplinkRate=slmSysUplinkRate, slmSysMode=slmSysMode, slmVcatDelay=slmVcatDelay, slmTrapDestTable=slmTrapDestTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestAddress=slmSyslogDestAddress, slmAuth=slmAuth, slmSyslogDestTable=slmSyslogDestTable, slmMuxNumber=slmMuxNumber, slmChPass=slmChPass, slmSysChassisId=slmSysChassisId, slmRstpEnabled=slmRstpEnabled, slmTrapUserLogin=slmTrapUserLogin, slmAdminPassword=slmAdminPassword, slmEdfaNumber=slmEdfaNumber, slmTrapLogTable=slmTrapLogTable, slmAuthEntry=slmAuthEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapCommunity=slmTrapCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmSnmpv3Priv=slmSnmpv3Priv, slmAuthTable=slmAuthTable, SoftwareRevision=SoftwareRevision, slmChPassLogin=slmChPassLogin, AdminAccess=AdminAccess, slmLicenseId=slmLicenseId, slmPortsNumber=slmPortsNumber, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseEntry=slmLicenseEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLogin=slmLogin, slmSysCalendarTime=slmSysCalendarTime, slmSysAlmAct=slmSysAlmAct, slmSysSnmpVersion=slmSysSnmpVersion, slmPsuNumber=slmPsuNumber, slmSwRevEntry=slmSwRevEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminCommunity=slmAdminCommunity, slmChPassNewPass=slmChPassNewPass, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevDate=slmSwRevDate, slmAdminLogin=slmAdminLogin, slmSwRevDirectory=slmSwRevDirectory, slmConfigSysUptime=slmConfigSysUptime, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestEntry=slmTrapDestEntry, slmLicense=slmLicense, slmLogFile=slmLogFile, slmSysTemperature=slmSysTemperature, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAuthLogin=slmAuthLogin, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogParam5=slmTrapLogParam5, slmSysIpAddr=slmSysIpAddr, slmLicenseTable=slmLicenseTable, slmSysOperStatus=slmSysOperStatus, slmSysAdminStatus=slmSysAdminStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLocation=slmSysLocation, slmTrapDestCommunity=slmTrapDestCommunity, slmConfigFile=slmConfigFile, slmSwRevName=slmSwRevName, slmWriteCommunity=slmWriteCommunity, slmSysLanIpAddr=slmSysLanIpAddr, PYSNMP_MODULE_ID=slMain, slMain=slMain, slmAdminTable=slmAdminTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmPmAvailable=slmPmAvailable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAdminEntry=slmAdminEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogName=slmTrapLogName, slmTrapUserAccess=slmTrapUserAccess, slmSwRevTable=slmSwRevTable, slmSys=slmSys, slmSysSubnetMask=slmSysSubnetMask, slmSyslogDestEntry=slmSyslogDestEntry, slmSysName=slmSysName, slmSysResetPm=slmSysResetPm, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminAccess=slmAdminAccess, UserPassword=UserPassword, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogParam1=slmTrapLogParam1, slmChPassOldPass=slmChPassOldPass, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slm40GConf=slm40GConf, slmChPassEntry=slmChPassEntry, slmSysTrapFormat=slmSysTrapFormat)
