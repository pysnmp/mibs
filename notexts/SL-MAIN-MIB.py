...
TimeTicks, ObjectIdentity, NotificationType, Gauge32, Integer32, Unsigned32, Opaque, ModuleIdentity, Counter32, iso, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "NotificationType", "Gauge32", "Integer32", "Unsigned32", "Opaque", "ModuleIdentity", "Counter32", "iso", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysUplinkRate=slmSysUplinkRate, slmLicenseId=slmLicenseId, slmChPassLogin=slmChPassLogin, slmLicenseTable=slmLicenseTable, slmSyslogDestEntry=slmSyslogDestEntry, slmEdfaNumber=slmEdfaNumber, slmTrapUserLogin=slmTrapUserLogin, slmSysCalendarTime=slmSysCalendarTime, slmConfigSysSignalType=slmConfigSysSignalType, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrap=slmTrap, slmSysAlmAct=slmSysAlmAct, slmChPassEntry=slmChPassEntry, slmPortsNumber=slmPortsNumber, slmAdmin=slmAdmin, slmOemType=slmOemType, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLogFile=slmLogFile, slmSysIpAddr=slmSysIpAddr, slMain=slMain, slmAdminPassword=slmAdminPassword, slmLogin=slmLogin, slmTrapDestCommunity=slmTrapDestCommunity, slmAdminCommunity=slmAdminCommunity, slmChPassTable=slmChPassTable, slmTrapLogParam6=slmTrapLogParam6, slmAdminRowStatus=slmAdminRowStatus, UserLogin=UserLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysAlmDeact=slmSysAlmDeact, PYSNMP_MODULE_ID=slMain, slmSysOperStatus=slmSysOperStatus, slmTrapDestTable=slmTrapDestTable, slmChPassNewPass=slmChPassNewPass, slmSnmpv3Priv=slmSnmpv3Priv, slmSnmpv3Password=slmSnmpv3Password, slmAuthEntry=slmAuthEntry, slmTrapLogId=slmTrapLogId, slmSysMode=slmSysMode, slmNetworkMode=slmNetworkMode, slmAuthPassword=slmAuthPassword, AdminAccess=AdminAccess, slmChPassOldPass=slmChPassOldPass, slmAuthTable=slmAuthTable, slmTrapDestAddress=slmTrapDestAddress, slmChPass=slmChPass, slmMuxNumber=slmMuxNumber, slmLicenseEntry=slmLicenseEntry, slmTrapPort=slmTrapPort, slmWriteCommunity=slmWriteCommunity, slmSysTrapFormat=slmSysTrapFormat, slmRstpEnabled=slmRstpEnabled, slmAuth=slmAuth, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevEntry=slmSwRevEntry, slmTid=slmTid, UserPassword=UserPassword, slmSysLanIpAddr=slmSysLanIpAddr, slmRebootDelay=slmRebootDelay, slmSysLocation=slmSysLocation, slmPsuNumber=slmPsuNumber, slmSys=slmSys, slmLicense=slmLicense, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam1=slmTrapLogParam1, slmSysSnmpVersion=slmSysSnmpVersion, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminAccess=slmAdminAccess, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysResetPm=slmSysResetPm, slmTrapLogName=slmTrapLogName, slmSyslogDestTable=slmSyslogDestTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSyslogPort=slmSyslogPort, slmAuthLogin=slmAuthLogin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminLogin=slmAdminLogin, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysChassisId=slmSysChassisId, slmTrapLogParam5=slmTrapLogParam5, slmTrapEnable=slmTrapEnable, slmSwRevTable=slmSwRevTable, slmConfigFile=slmConfigFile, slmSwRevStatus=slmSwRevStatus, slmTrapLogParam2=slmTrapLogParam2, slmSysPmStartOfDay=slmSysPmStartOfDay, slmVcatDelay=slmVcatDelay, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSnmpv3Auth=slmSnmpv3Auth, slmSwRevDirectory=slmSwRevDirectory, slmReadCommunity=slmReadCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slm40GConf=slm40GConf, slmBoxSize=slmBoxSize, slmTrapDestEntry=slmTrapDestEntry, UserCommunity=UserCommunity, slmTrapUserAccess=slmTrapUserAccess, slmSyslogDestAddress=slmSyslogDestAddress, slmSysAdminStatus=slmSysAdminStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmAuthCommunity=slmAuthCommunity, slmPmAvailable=slmPmAvailable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogParam3=slmTrapLogParam3, slmAdminEntry=slmAdminEntry, SoftwareRevision=SoftwareRevision, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevDate=slmSwRevDate, slmTrapLogTable=slmTrapLogTable, slmTopologyEnabled=slmTopologyEnabled, slmSysName=slmSysName, slmLicenseExpiration=slmLicenseExpiration, slmSysSubnetMask=slmSysSubnetMask, slmSyslogLevel=slmSyslogLevel, slmTrapCommunity=slmTrapCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmConfigSysUptime=slmConfigSysUptime, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicenseIndex=slmLicenseIndex, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysTemperature=slmSysTemperature, slmAdminTable=slmAdminTable, slmTrapLogEntry=slmTrapLogEntry, slmSwRevName=slmSwRevName)
