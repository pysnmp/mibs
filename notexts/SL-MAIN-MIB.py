...
ObjectIdentity, TimeTicks, IpAddress, Counter32, NotificationType, iso, Integer32, Opaque, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, Gauge32, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "IpAddress", "Counter32", "NotificationType", "iso", "Integer32", "Opaque", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "Gauge32", "Counter64", "MibIdentifier")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminAccess=slmAdminAccess, slmTrapLogParam1=slmTrapLogParam1, slmTrapSysNameChange=slmTrapSysNameChange, slmChPass=slmChPass, slmTopologyEnabled=slmTopologyEnabled, slmAuthEntry=slmAuthEntry, slmSysUplinkRate=slmSysUplinkRate, slmChPassLogin=slmChPassLogin, slmLicenseTable=slmLicenseTable, slmAuth=slmAuth, slmPmAvailable=slmPmAvailable, slmAuthLogin=slmAuthLogin, slmWriteCommunity=slmWriteCommunity, slmChPassTable=slmChPassTable, slmAuthTable=slmAuthTable, slmChPassNewPass=slmChPassNewPass, slmSysResetPm=slmSysResetPm, slmSwRevDirectory=slmSwRevDirectory, slmSysTemperature=slmSysTemperature, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysLocation=slmSysLocation, slmSnmpv3Password=slmSnmpv3Password, slmSysChassisId=slmSysChassisId, slmTrapLogTable=slmTrapLogTable, slMain=slMain, slmConfigSysUptime=slmConfigSysUptime, slmPsuNumber=slmPsuNumber, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminTable=slmAdminTable, slmSyslogDestTable=slmSyslogDestTable, PYSNMP_MODULE_ID=slMain, slmTrap=slmTrap, slmTrapLogName=slmTrapLogName, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSwRevStatus=slmSwRevStatus, slmSysName=slmSysName, slm40GConf=slm40GConf, slmSysTrapFormat=slmSysTrapFormat, slmSwRevTable=slmSwRevTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSwRevName=slmSwRevName, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestProtVersion=slmTrapDestProtVersion, slmPortsNumber=slmPortsNumber, slmSysSnmpVersion=slmSysSnmpVersion, slmMuxNumber=slmMuxNumber, slmAdminRowStatus=slmAdminRowStatus, slmTrapEnable=slmTrapEnable, slmLicenseExpiration=slmLicenseExpiration, slmLogFile=slmLogFile, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminPassword=slmAdminPassword, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapPort=slmTrapPort, slmAuthPassword=slmAuthPassword, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysAlmDeact=slmSysAlmDeact, slmSysAlmAct=slmSysAlmAct, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSys=slmSys, slmLicense=slmLicense, slmBoxSize=slmBoxSize, slmTrapCommunity=slmTrapCommunity, slmLicenseId=slmLicenseId, slmLogin=slmLogin, slmAdminLogin=slmAdminLogin, slmTrapDestTable=slmTrapDestTable, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminEntry=slmAdminEntry, slmChPassEntry=slmChPassEntry, slmSysCalendarTime=slmSysCalendarTime, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapUserAccess=slmTrapUserAccess, SoftwareRevision=SoftwareRevision, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestAddress=slmTrapDestAddress, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSnmpv3Auth=slmSnmpv3Auth, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapUserLogin=slmTrapUserLogin, slmRstpEnabled=slmRstpEnabled, slmAdmin=slmAdmin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogParam5=slmTrapLogParam5, slmReadCommunity=slmReadCommunity, UserPassword=UserPassword, slmSysSubnetMask=slmSysSubnetMask, slmVcatDelay=slmVcatDelay, slmRebootDelay=slmRebootDelay, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogParam3=slmTrapLogParam3, slmTid=slmTid, slmEdfaNumber=slmEdfaNumber, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestEntry=slmTrapDestEntry, UserLogin=UserLogin, slmAdminCommunity=slmAdminCommunity, slmTrapLogEntry=slmTrapLogEntry, slmAuthCommunity=slmAuthCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseEntry=slmLicenseEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmConfigFile=slmConfigFile, slmLicenseIndex=slmLicenseIndex, slmSysIpAddr=slmSysIpAddr, slmSwRevDate=slmSwRevDate, slmTrapLogParam4=slmTrapLogParam4, slmOemType=slmOemType, slmSysMode=slmSysMode, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPassOldPass=slmChPassOldPass, slmSyslogLevel=slmSyslogLevel, AdminAccess=AdminAccess, slmSysAdminStatus=slmSysAdminStatus, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysOperStatus=slmSysOperStatus, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam2=slmTrapLogParam2, slmSwRevEntry=slmSwRevEntry, slmSyslogPort=slmSyslogPort, UserCommunity=UserCommunity, slmTrapLogId=slmTrapLogId, slmTrapDestCommunity=slmTrapDestCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmNetworkMode=slmNetworkMode)
