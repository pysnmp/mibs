...
NotificationType, Integer32, iso, Bits, MibIdentifier, ModuleIdentity, Opaque, TimeTicks, Counter32, IpAddress, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "iso", "Bits", "MibIdentifier", "ModuleIdentity", "Opaque", "TimeTicks", "Counter32", "IpAddress", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSwRevTable=slmSwRevTable, slmSysSubnetMask=slmSysSubnetMask, slmTrapUserLogin=slmTrapUserLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLogFile=slmLogFile, UserCommunity=UserCommunity, slmAdminCommunity=slmAdminCommunity, AdminAccess=AdminAccess, slmSyslogLevel=slmSyslogLevel, slmSyslogDestTable=slmSyslogDestTable, slmChPass=slmChPass, slmChPassLogin=slmChPassLogin, slmAdminRowStatus=slmAdminRowStatus, slmOpticalSwitchExist=slmOpticalSwitchExist, slm40GConf=slm40GConf, slmSyslogDestAddress=slmSyslogDestAddress, slmChPassOldPass=slmChPassOldPass, slmAuthLogin=slmAuthLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLicenseEntry=slmLicenseEntry, slmTrapDestEntry=slmTrapDestEntry, slmSysAlmDeact=slmSysAlmDeact, slmAuthTable=slmAuthTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminAccess=slmAdminAccess, slMain=slMain, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogTable=slmTrapLogTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminTable=slmAdminTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogEntry=slmTrapLogEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmSysMode=slmSysMode, slmOemType=slmOemType, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseIndex=slmLicenseIndex, slmSysTemperature=slmSysTemperature, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminLogin=slmAdminLogin, slmTrapCommunity=slmTrapCommunity, slmSwRevStatus=slmSwRevStatus, slmTrapLogParam6=slmTrapLogParam6, slmSysCalendarTime=slmSysCalendarTime, slmPmAvailable=slmPmAvailable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevDate=slmSwRevDate, PYSNMP_MODULE_ID=slMain, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysName=slmSysName, slmSysGatewayAddr=slmSysGatewayAddr, slmTrap=slmTrap, slmTrapPort=slmTrapPort, slmSysResetPm=slmSysResetPm, slmAdminEntry=slmAdminEntry, slmEdfaNumber=slmEdfaNumber, slmBoxSize=slmBoxSize, slmSwRevEntry=slmSwRevEntry, slmTrapLogName=slmTrapLogName, slmMuxNumber=slmMuxNumber, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAuthPassword=slmAuthPassword, UserLogin=UserLogin, slmChPassNewPass=slmChPassNewPass, slmLicenseTable=slmLicenseTable, slmSysTrapFormat=slmSysTrapFormat, slmPortsNumber=slmPortsNumber, slmLogin=slmLogin, slmTopologyEnabled=slmTopologyEnabled, slmLicenseExpiration=slmLicenseExpiration, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam4=slmTrapLogParam4, slmWriteCommunity=slmWriteCommunity, slmConfigSysSignalType=slmConfigSysSignalType, slmTid=slmTid, slmNetworkMode=slmNetworkMode, slmChPassEntry=slmChPassEntry, slmLicenseId=slmLicenseId, slmRebootDelay=slmRebootDelay, slmAuthCommunity=slmAuthCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAuthEntry=slmAuthEntry, slmSwRevName=slmSwRevName, slmTrapLogParam2=slmTrapLogParam2, slmSwRevDirectory=slmSwRevDirectory, slmSysOperStatus=slmSysOperStatus, SoftwareRevision=SoftwareRevision, slmAuth=slmAuth, slmTrapDestAddress=slmTrapDestAddress, slmSnmpv3Password=slmSnmpv3Password, slmVcatDelay=slmVcatDelay, slmSysLocation=slmSysLocation, slmSysIpAddr=slmSysIpAddr, slmSysAdminStatus=slmSysAdminStatus, slmRstpEnabled=slmRstpEnabled, slmTrapLogParam5=slmTrapLogParam5, slmConfigFile=slmConfigFile, slmAdminPassword=slmAdminPassword, slmSys=slmSys, slmSyslogPort=slmSyslogPort, slmSysAlmAct=slmSysAlmAct, slmSysChassisId=slmSysChassisId, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmPsuNumber=slmPsuNumber, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogId=slmTrapLogId, slmAdmin=slmAdmin, slmSysUplinkRate=slmSysUplinkRate, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam1=slmTrapLogParam1, slmConfigSysUptime=slmConfigSysUptime, UserPassword=UserPassword, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmChPassTable=slmChPassTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmReadCommunity=slmReadCommunity, slmTrapEnable=slmTrapEnable, slmSnmpv3Auth=slmSnmpv3Auth, slmLicense=slmLicense)
