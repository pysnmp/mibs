...
MibIdentifier, iso, Gauge32, Integer32, ObjectIdentity, TimeTicks, Opaque, ModuleIdentity, Counter32, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "Gauge32", "Integer32", "ObjectIdentity", "TimeTicks", "Opaque", "ModuleIdentity", "Counter32", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "Bits")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPassEntry=slmChPassEntry, slmSysResetPm=slmSysResetPm, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminRowStatus=slmAdminRowStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevStatus=slmSwRevStatus, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slm40GConf=slm40GConf, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogEntry=slmTrapLogEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestAddress=slmTrapDestAddress, slmLogFile=slmLogFile, slmRebootDelay=slmRebootDelay, slmSyslogDestTable=slmSyslogDestTable, slmAuthLogin=slmAuthLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysAlmDeact=slmSysAlmDeact, slmEdfaNumber=slmEdfaNumber, slmLicenseTable=slmLicenseTable, slmChPassNewPass=slmChPassNewPass, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSnmpv3Priv=slmSnmpv3Priv, slmSysCalendarTime=slmSysCalendarTime, slmChPassTable=slmChPassTable, slmSysLanIpAddr=slmSysLanIpAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminTable=slmAdminTable, slmLogin=slmLogin, slmSysOperStatus=slmSysOperStatus, slmSysTrapFormat=slmSysTrapFormat, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, UserPassword=UserPassword, slmAdminPassword=slmAdminPassword, slmAuthPassword=slmAuthPassword, slmNetworkMode=slmNetworkMode, slmPmAvailable=slmPmAvailable, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogParam6=slmTrapLogParam6, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogParam1=slmTrapLogParam1, slmAdminEntry=slmAdminEntry, slmSysAdminStatus=slmSysAdminStatus, slmSysTemperature=slmSysTemperature, slmTrapPort=slmTrapPort, slMain=slMain, slmSnmpv3Auth=slmSnmpv3Auth, slmSwRevDirectory=slmSwRevDirectory, slmSysNetworkPrefix=slmSysNetworkPrefix, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam3=slmTrapLogParam3, slmSysSubnetMask=slmSysSubnetMask, slmTrapCommunity=slmTrapCommunity, slmTopologyEnabled=slmTopologyEnabled, slmSwRevName=slmSwRevName, slmTrapDestTable=slmTrapDestTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, SoftwareRevision=SoftwareRevision, slmChPass=slmChPass, slmConfigSysSignalType=slmConfigSysSignalType, slmSysUplinkRate=slmSysUplinkRate, slmSysChassisId=slmSysChassisId, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogName=slmTrapLogName, AdminAccess=AdminAccess, slmSyslogLevel=slmSyslogLevel, slmRstpEnabled=slmRstpEnabled, slmAuthTable=slmAuthTable, slmAdminLogin=slmAdminLogin, slmMuxNumber=slmMuxNumber, slmTrapLogParam5=slmTrapLogParam5, slmSnmpv3Password=slmSnmpv3Password, slmTrap=slmTrap, UserCommunity=UserCommunity, slmSwRevTable=slmSwRevTable, slmConfigFile=slmConfigFile, slmSys=slmSys, slmAdminCommunity=slmAdminCommunity, slmSysLocation=slmSysLocation, slmOemType=slmOemType, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysMode=slmSysMode, slmTrapUserLogin=slmTrapUserLogin, slmSwRevDate=slmSwRevDate, slmSyslogPort=slmSyslogPort, slmOpticalSwitchExist=slmOpticalSwitchExist, slmVcatDelay=slmVcatDelay, slmPortsNumber=slmPortsNumber, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogTable=slmTrapLogTable, slmLicenseIndex=slmLicenseIndex, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmBoxSize=slmBoxSize, slmSwRevEntry=slmSwRevEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAuth=slmAuth, slmAdminAccess=slmAdminAccess, slmTid=slmTid, slmLicenseEntry=slmLicenseEntry, PYSNMP_MODULE_ID=slMain, UserLogin=UserLogin, slmPsuNumber=slmPsuNumber, slmTrapEnable=slmTrapEnable, slmSysIpAddr=slmSysIpAddr, slmChPassLogin=slmChPassLogin, slmLicense=slmLicense, slmSyslogDestAddress=slmSyslogDestAddress, slmLicenseId=slmLicenseId, slmAuthCommunity=slmAuthCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapUserAccess=slmTrapUserAccess, slmSysName=slmSysName, slmWriteCommunity=slmWriteCommunity, slmChPassOldPass=slmChPassOldPass, slmSysAlmAct=slmSysAlmAct, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogId=slmTrapLogId, slmReadCommunity=slmReadCommunity, slmAdmin=slmAdmin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAuthEntry=slmAuthEntry)
