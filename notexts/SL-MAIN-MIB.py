...
Gauge32, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, NotificationType, IpAddress, Integer32, Bits, Counter32, Counter64, MibIdentifier, iso, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "NotificationType", "IpAddress", "Integer32", "Bits", "Counter32", "Counter64", "MibIdentifier", "iso", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmPmAvailable=slmPmAvailable, UserPassword=UserPassword, slmSnmpv3Priv=slmSnmpv3Priv, slmChPassNewPass=slmChPassNewPass, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysChassisId=slmSysChassisId, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam3=slmTrapLogParam3, slmTrap=slmTrap, slmSwRevTable=slmSwRevTable, slmSysTemperature=slmSysTemperature, slmChPassTable=slmChPassTable, slmTid=slmTid, slmSys=slmSys, slmNetworkMode=slmNetworkMode, slmAdminPassword=slmAdminPassword, slmLicenseEntry=slmLicenseEntry, slmLicenseIndex=slmLicenseIndex, slmSysLocation=slmSysLocation, slmSwRevDate=slmSwRevDate, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysLanIpAddr=slmSysLanIpAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthPassword=slmAuthPassword, SoftwareRevision=SoftwareRevision, slmChPassLogin=slmChPassLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmConfigFile=slmConfigFile, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdmin=slmAdmin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminCommunity=slmAdminCommunity, slmRebootDelay=slmRebootDelay, slmAuth=slmAuth, slmOemType=slmOemType, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapEnable=slmTrapEnable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapPort=slmTrapPort, PYSNMP_MODULE_ID=slMain, slmSysAlmDeact=slmSysAlmDeact, slmSyslogPort=slmSyslogPort, slmSysName=slmSysName, slmTrapDestCommunity=slmTrapDestCommunity, slmChPass=slmChPass, UserLogin=UserLogin, slmTrapLogParam5=slmTrapLogParam5, slmSwRevName=slmSwRevName, slmLicenseId=slmLicenseId, slmSysResetPm=slmSysResetPm, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogName=slmTrapLogName, slmTrapLogParam1=slmTrapLogParam1, slmAuthCommunity=slmAuthCommunity, slmAdminLogin=slmAdminLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmPortsNumber=slmPortsNumber, slmSysSnmpVersion=slmSysSnmpVersion, slmVcatDelay=slmVcatDelay, slmAuthTable=slmAuthTable, slmTrapDestEntry=slmTrapDestEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAuthLogin=slmAuthLogin, slmSwRevDirectory=slmSwRevDirectory, slmAuthEntry=slmAuthEntry, slmLogFile=slmLogFile, slmSysSubnetMask=slmSysSubnetMask, slmSyslogDestAddress=slmSyslogDestAddress, slmWriteCommunity=slmWriteCommunity, slmSysOperStatus=slmSysOperStatus, slmTrapLogId=slmTrapLogId, slmConfigSysUptime=slmConfigSysUptime, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysIpAddr=slmSysIpAddr, slmEdfaNumber=slmEdfaNumber, slmSyslogLevel=slmSyslogLevel, slmTrapDestRowStatus=slmTrapDestRowStatus, slmBoxSize=slmBoxSize, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmRstpEnabled=slmRstpEnabled, UserCommunity=UserCommunity, slmTrapCommunity=slmTrapCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogParam4=slmTrapLogParam4, slmLicense=slmLicense, slmSyslogDestTable=slmSyslogDestTable, slmSysCalendarTime=slmSysCalendarTime, slmChPassEntry=slmChPassEntry, slMain=slMain, slmSysMode=slmSysMode, slmLogin=slmLogin, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysTrapFormat=slmSysTrapFormat, slmSysUplinkRate=slmSysUplinkRate, AdminAccess=AdminAccess, slmSwRevStatus=slmSwRevStatus, slmReadCommunity=slmReadCommunity, slmTrapDestAddress=slmTrapDestAddress, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapUserLogin=slmTrapUserLogin, slmMuxNumber=slmMuxNumber, slmLicenseExpiration=slmLicenseExpiration, slmTopologyEnabled=slmTopologyEnabled, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestTable=slmTrapDestTable, slmPsuNumber=slmPsuNumber, slmAdminTable=slmAdminTable, slmSwRevEntry=slmSwRevEntry, slm40GConf=slm40GConf, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseTable=slmLicenseTable, slmSnmpv3Password=slmSnmpv3Password, slmAdminAccess=slmAdminAccess, slmSysEncryptionCapability=slmSysEncryptionCapability, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogTable=slmTrapLogTable, slmAdminEntry=slmAdminEntry, slmSysAlmAct=slmSysAlmAct, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogParam6=slmTrapLogParam6, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogParam2=slmTrapLogParam2)
