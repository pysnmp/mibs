...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapSysNameChange=slmTrapSysNameChange, slmEdfaNumber=slmEdfaNumber, UserLogin=UserLogin, slmTopologyEnabled=slmTopologyEnabled, UserPassword=UserPassword, slmTrapLogParam5=slmTrapLogParam5, slmLicenseIndex=slmLicenseIndex, PYSNMP_MODULE_ID=slMain, slmAdminAccess=slmAdminAccess, slmAuth=slmAuth, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogId=slmTrapLogId, slmReadCommunity=slmReadCommunity, slmTrapEnable=slmTrapEnable, slmLicenseId=slmLicenseId, slmSyslogDestTable=slmSyslogDestTable, slmSwRevStatus=slmSwRevStatus, slmSyslogDestEntry=slmSyslogDestEntry, slmSysLocation=slmSysLocation, slmLogin=slmLogin, slmVcatDelay=slmVcatDelay, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmSysAdminStatus=slmSysAdminStatus, slmSwRevEntry=slmSwRevEntry, slmSwRevTable=slmSwRevTable, slmChPassEntry=slmChPassEntry, slmTrap=slmTrap, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmPsuNumber=slmPsuNumber, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogParam1=slmTrapLogParam1, slmChPassOldPass=slmChPassOldPass, slmSysSnmpVersion=slmSysSnmpVersion, slmChPassTable=slmChPassTable, slmTrapDestEntry=slmTrapDestEntry, slmConfigSysUptime=slmConfigSysUptime, slmSyslogPort=slmSyslogPort, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam6=slmTrapLogParam6, slmAdminCommunity=slmAdminCommunity, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam3=slmTrapLogParam3, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysGatewayAddr=slmSysGatewayAddr, slmSysMode=slmSysMode, SoftwareRevision=SoftwareRevision, slmSysLanIpAddr=slmSysLanIpAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPass=slmChPass, slmSysResetPm=slmSysResetPm, slmSysAlmAct=slmSysAlmAct, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slm40GConf=slm40GConf, slmAdminEntry=slmAdminEntry, slmTrapLogName=slmTrapLogName, slmWriteCommunity=slmWriteCommunity, slmAdminRowStatus=slmAdminRowStatus, slmSwRevName=slmSwRevName, slmLicenseEntry=slmLicenseEntry, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAuthLogin=slmAuthLogin, slmPortsNumber=slmPortsNumber, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogParam4=slmTrapLogParam4, slmAdminLogin=slmAdminLogin, slmSysChassisId=slmSysChassisId, slmChPassLogin=slmChPassLogin, slmTrapLogTable=slmTrapLogTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmPmAvailable=slmPmAvailable, slmChPassNewPass=slmChPassNewPass, slmAdmin=slmAdmin, slmSysTemperature=slmSysTemperature, slmSys=slmSys, UserCommunity=UserCommunity, slmNetworkMode=slmNetworkMode, slmRstpEnabled=slmRstpEnabled, slmSysUplinkRate=slmSysUplinkRate, slmTrapDestTable=slmTrapDestTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmRebootDelay=slmRebootDelay, slmTid=slmTid, slmSysOperStatus=slmSysOperStatus, slmAdminPassword=slmAdminPassword, slmTrapPort=slmTrapPort, AdminAccess=AdminAccess, slmSwRevDirectory=slmSwRevDirectory, slmLicenseExpiration=slmLicenseExpiration, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSyslogLevel=slmSyslogLevel, slmBoxSize=slmBoxSize, slmLicense=slmLicense, slMain=slMain, slmMuxNumber=slmMuxNumber, slmConfigFile=slmConfigFile, slmLogFile=slmLogFile, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysName=slmSysName, slmTrapUserAccess=slmTrapUserAccess, slmAuthEntry=slmAuthEntry, slmAdminTable=slmAdminTable, slmTrapDestAddress=slmTrapDestAddress, slmSysIpAddr=slmSysIpAddr, slmTrapUserLogin=slmTrapUserLogin, slmSwRevDate=slmSwRevDate, slmSysTrapFormat=slmSysTrapFormat, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthTable=slmAuthTable, slmOemType=slmOemType, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysSubnetMask=slmSysSubnetMask, slmLicenseTable=slmLicenseTable, slmTrapDestCommunity=slmTrapDestCommunity, slmSysCalendarTime=slmSysCalendarTime, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSnmpv3Priv=slmSnmpv3Priv, slmAuthPassword=slmAuthPassword)
