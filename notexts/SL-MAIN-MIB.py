...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogPort=slmSyslogPort, slmTrapLogParam2=slmTrapLogParam2, slmSysLocation=slmSysLocation, slm40GConf=slm40GConf, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapUserLogin=slmTrapUserLogin, slMain=slMain, slmSnmpv3Password=slmSnmpv3Password, UserLogin=UserLogin, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLogFile=slmLogFile, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTid=slmTid, slmEdfaNumber=slmEdfaNumber, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, PYSNMP_MODULE_ID=slMain, slmAuthTable=slmAuthTable, slmAuthEntry=slmAuthEntry, slmConfigSysUptime=slmConfigSysUptime, slmOemType=slmOemType, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmSwRevTable=slmSwRevTable, slmLicenseId=slmLicenseId, slmPmAvailable=slmPmAvailable, slmTrapLogParam5=slmTrapLogParam5, slmChPassTable=slmChPassTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminLogin=slmAdminLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmSysTemperature=slmSysTemperature, slmSyslogDestAddress=slmSyslogDestAddress, slmSwRevDate=slmSwRevDate, slmRstpEnabled=slmRstpEnabled, slmSysChassisId=slmSysChassisId, slmTrapLogName=slmTrapLogName, slmMuxNumber=slmMuxNumber, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestTable=slmTrapDestTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysAlmDeact=slmSysAlmDeact, slmTrapDestIpAddress=slmTrapDestIpAddress, SoftwareRevision=SoftwareRevision, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthPassword=slmAuthPassword, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapCommunity=slmTrapCommunity, slmNetworkMode=slmNetworkMode, slmTrapDestAddress=slmTrapDestAddress, slmPortsNumber=slmPortsNumber, slmTrapUserAccess=slmTrapUserAccess, slmSysAdminStatus=slmSysAdminStatus, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogDestEntry=slmSyslogDestEntry, slmSysUplinkRate=slmSysUplinkRate, slmPsuNumber=slmPsuNumber, slmTrap=slmTrap, slmAdminPassword=slmAdminPassword, slmSysAlmAct=slmSysAlmAct, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysMode=slmSysMode, slmAuth=slmAuth, slmSyslogDestTable=slmSyslogDestTable, slmTrapPort=slmTrapPort, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapEnable=slmTrapEnable, slmSyslogLevel=slmSyslogLevel, slmTrapLogParam3=slmTrapLogParam3, slmAdminAccess=slmAdminAccess, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminRowStatus=slmAdminRowStatus, slmLogin=slmLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminTable=slmAdminTable, slmTrapDestEntry=slmTrapDestEntry, slmConfigFile=slmConfigFile, slmChPassOldPass=slmChPassOldPass, slmBoxSize=slmBoxSize, UserCommunity=UserCommunity, slmSysCalendarTime=slmSysCalendarTime, slmRebootDelay=slmRebootDelay, slmTopologyEnabled=slmTopologyEnabled, slmSwRevStatus=slmSwRevStatus, slmChPass=slmChPass, slmTrapLogId=slmTrapLogId, slmSwRevEntry=slmSwRevEntry, slmWriteCommunity=slmWriteCommunity, slmLicenseExpiration=slmLicenseExpiration, slmSysSubnetMask=slmSysSubnetMask, slmSysTrapFormat=slmSysTrapFormat, slmSwRevDirectory=slmSwRevDirectory, slmLicenseIndex=slmLicenseIndex, slmLicenseEntry=slmLicenseEntry, slmLicenseTable=slmLicenseTable, slmSysOperStatus=slmSysOperStatus, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogEntry=slmTrapLogEntry, slmAdmin=slmAdmin, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam1=slmTrapLogParam1, slmChPassNewPass=slmChPassNewPass, slmChPassLogin=slmChPassLogin, slmSwRevName=slmSwRevName, slmAdminCommunity=slmAdminCommunity, slmSysLanIpAddr=slmSysLanIpAddr, slmAuthCommunity=slmAuthCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAuthLogin=slmAuthLogin, slmLicense=slmLicense, AdminAccess=AdminAccess, slmReadCommunity=slmReadCommunity, slmSysResetPm=slmSysResetPm, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminEntry=slmAdminEntry, slmTrapLogTable=slmTrapLogTable, slmTrapDestCommunity=slmTrapDestCommunity, slmVcatDelay=slmVcatDelay, slmSys=slmSys, slmSysGatewayAddr=slmSysGatewayAddr, UserPassword=UserPassword, slmChPassEntry=slmChPassEntry, slmSysName=slmSysName)
