...
iso, TimeTicks, IpAddress, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, Counter32, Gauge32, ModuleIdentity, Counter64, MibIdentifier, Integer32, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "IpAddress", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "Counter32", "Gauge32", "ModuleIdentity", "Counter64", "MibIdentifier", "Integer32", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSyslogDestEntry=slmSyslogDestEntry, slmNetworkMode=slmNetworkMode, slm40GConf=slm40GConf, slmWriteCommunity=slmWriteCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapDestEntry=slmTrapDestEntry, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestTable=slmTrapDestTable, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevTable=slmSwRevTable, slmAdminRowStatus=slmAdminRowStatus, slmMuxNumber=slmMuxNumber, slmTrapUserAccess=slmTrapUserAccess, slmAdminTable=slmAdminTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSyslogDestAddress=slmSyslogDestAddress, slmSysGatewayAddr=slmSysGatewayAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogName=slmTrapLogName, slmSyslogDestTable=slmSyslogDestTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogParam4=slmTrapLogParam4, slmSyslogPort=slmSyslogPort, slmSysTrapFormat=slmSysTrapFormat, UserPassword=UserPassword, slmSwRevDirectory=slmSwRevDirectory, slmLicenseTable=slmLicenseTable, slmTrapEnable=slmTrapEnable, slmAuthPassword=slmAuthPassword, slmOemType=slmOemType, slmAdminPassword=slmAdminPassword, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestCommunity=slmTrapDestCommunity, slmAdminCommunity=slmAdminCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysLanIpAddr=slmSysLanIpAddr, slmLicenseExpiration=slmLicenseExpiration, slmChPassEntry=slmChPassEntry, slmSysIpAddr=slmSysIpAddr, slmTrapLogId=slmTrapLogId, slmTrap=slmTrap, slmSnmpv3Password=slmSnmpv3Password, slmConfigFile=slmConfigFile, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, SoftwareRevision=SoftwareRevision, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogParam6=slmTrapLogParam6, slmChPass=slmChPass, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysAdminStatus=slmSysAdminStatus, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysName=slmSysName, PYSNMP_MODULE_ID=slMain, slmAuthCommunity=slmAuthCommunity, slmSysAlmAct=slmSysAlmAct, slmSysLocation=slmSysLocation, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSwRevEntry=slmSwRevEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogParam5=slmTrapLogParam5, slmPmAvailable=slmPmAvailable, slmTrapCommunity=slmTrapCommunity, slmSysOperStatus=slmSysOperStatus, slmAuthEntry=slmAuthEntry, slmConfigSysUptime=slmConfigSysUptime, slmLicenseIndex=slmLicenseIndex, slmChPassNewPass=slmChPassNewPass, slmSys=slmSys, slmAdminAccess=slmAdminAccess, slmAuthTable=slmAuthTable, slmSnmpv3Auth=slmSnmpv3Auth, slmPsuNumber=slmPsuNumber, slmTopologyEnabled=slmTopologyEnabled, slmEdfaNumber=slmEdfaNumber, slMain=slMain, slmAdmin=slmAdmin, slmChPassOldPass=slmChPassOldPass, slmChPassTable=slmChPassTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogTable=slmTrapLogTable, slmSysChassisId=slmSysChassisId, UserLogin=UserLogin, slmLicense=slmLicense, slmLicenseId=slmLicenseId, slmSysAlmDeact=slmSysAlmDeact, slmAuthLogin=slmAuthLogin, slmAdminLogin=slmAdminLogin, slmTid=slmTid, slmBoxSize=slmBoxSize, slmRstpEnabled=slmRstpEnabled, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmRebootDelay=slmRebootDelay, slmSysResetPm=slmSysResetPm, AdminAccess=AdminAccess, slmSwRevStatus=slmSwRevStatus, slmPortsNumber=slmPortsNumber, slmSysTemperature=slmSysTemperature, slmSwRevName=slmSwRevName, UserCommunity=UserCommunity, slmAuth=slmAuth, slmVcatDelay=slmVcatDelay, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseEntry=slmLicenseEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmLogFile=slmLogFile, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam2=slmTrapLogParam2, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestAddress=slmTrapDestAddress, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapPort=slmTrapPort, slmAdminEntry=slmAdminEntry, slmTrapLogParam1=slmTrapLogParam1, slmSwRevDate=slmSwRevDate, slmSnmpv3Priv=slmSnmpv3Priv, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysUplinkRate=slmSysUplinkRate, slmReadCommunity=slmReadCommunity, slmSyslogLevel=slmSyslogLevel, slmLogin=slmLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysMode=slmSysMode, slmChPassLogin=slmChPassLogin, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam3=slmTrapLogParam3)
