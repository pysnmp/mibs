...
iso, TimeTicks, Integer32, Counter32, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, Unsigned32, NotificationType, Gauge32, Opaque, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "Integer32", "Counter32", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "Unsigned32", "NotificationType", "Gauge32", "Opaque", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminRowStatus=slmAdminRowStatus, slmSysMode=slmSysMode, slmSwRevDate=slmSwRevDate, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmChPassLogin=slmChPassLogin, slmSwRevTable=slmSwRevTable, slmTid=slmTid, slmPortsNumber=slmPortsNumber, slmPsuNumber=slmPsuNumber, slmTrapEnable=slmTrapEnable, slmTrapLogName=slmTrapLogName, slmAuthCommunity=slmAuthCommunity, slmAuthLogin=slmAuthLogin, slmSysOperStatus=slmSysOperStatus, slmSwRevStatus=slmSwRevStatus, slmSysResetPm=slmSysResetPm, slmLicense=slmLicense, slmSwRevEntry=slmSwRevEntry, AdminAccess=AdminAccess, slmTrapUserLogin=slmTrapUserLogin, slmAdminPassword=slmAdminPassword, slmTrapLogTable=slmTrapLogTable, slmAuthPassword=slmAuthPassword, slmLicenseTable=slmLicenseTable, slmSyslogLevel=slmSyslogLevel, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminLogin=slmAdminLogin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapDestTable=slmTrapDestTable, PYSNMP_MODULE_ID=slMain, slmPmAvailable=slmPmAvailable, slmSysLanIpAddr=slmSysLanIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevName=slmSwRevName, slmTopologyEnabled=slmTopologyEnabled, slmAuthTable=slmAuthTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysSubnetMask=slmSysSubnetMask, slmSyslogDestTable=slmSyslogDestTable, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmConfigSysUptime=slmConfigSysUptime, slmVcatDelay=slmVcatDelay, slmChPassTable=slmChPassTable, SoftwareRevision=SoftwareRevision, slmAdmin=slmAdmin, slmTrapLogParam1=slmTrapLogParam1, slmChPass=slmChPass, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysAdminStatus=slmSysAdminStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmMuxNumber=slmMuxNumber, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogParam6=slmTrapLogParam6, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassNewPass=slmChPassNewPass, slmTrapPort=slmTrapPort, slmSysName=slmSysName, slmSysChassisId=slmSysChassisId, slmLicenseId=slmLicenseId, slmSwRevDirectory=slmSwRevDirectory, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPassOldPass=slmChPassOldPass, slmChPassEntry=slmChPassEntry, slmLogin=slmLogin, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapCommunity=slmTrapCommunity, slm40GConf=slm40GConf, slmTrapLogParam3=slmTrapLogParam3, slmSnmpv3Password=slmSnmpv3Password, slmSysCalendarTime=slmSysCalendarTime, slmTrapSysNameChange=slmTrapSysNameChange, slmSysAlmDeact=slmSysAlmDeact, slmRebootDelay=slmRebootDelay, slmOemType=slmOemType, slmAdminEntry=slmAdminEntry, slmEdfaNumber=slmEdfaNumber, slmSnmpv3Priv=slmSnmpv3Priv, slmSys=slmSys, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestAddress=slmTrapDestAddress, slMain=slMain, slmBoxSize=slmBoxSize, slmSysIpAddr=slmSysIpAddr, slmAdminCommunity=slmAdminCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestEntry=slmTrapDestEntry, slmLicenseExpiration=slmLicenseExpiration, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthEntry=slmAuthEntry, slmAuth=slmAuth, slmSnmpv3Auth=slmSnmpv3Auth, slmSysGatewayAddr=slmSysGatewayAddr, slmTrap=slmTrap, slmSysTrapFormat=slmSysTrapFormat, slmAdminTable=slmAdminTable, UserPassword=UserPassword, slmSysAlmAct=slmSysAlmAct, slmReadCommunity=slmReadCommunity, slmTrapLogId=slmTrapLogId, slmSysLocation=slmSysLocation, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLicenseIndex=slmLicenseIndex, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogParam5=slmTrapLogParam5, UserLogin=UserLogin, slmWriteCommunity=slmWriteCommunity, slmSysTemperature=slmSysTemperature, slmSyslogPort=slmSyslogPort, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysUplinkRate=slmSysUplinkRate, slmConfigFile=slmConfigFile, slmRstpEnabled=slmRstpEnabled, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapUserAccess=slmTrapUserAccess, slmLicenseEntry=slmLicenseEntry, slmNetworkMode=slmNetworkMode, slmTrapLogEntry=slmTrapLogEntry, slmAdminAccess=slmAdminAccess, slmLogFile=slmLogFile, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam4=slmTrapLogParam4, UserCommunity=UserCommunity)
