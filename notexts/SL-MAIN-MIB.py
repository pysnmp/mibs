...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmReadCommunity=slmReadCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSnmpv3Password=slmSnmpv3Password, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam5=slmTrapLogParam5, slmTrapDestCommunity=slmTrapDestCommunity, slmSnmpv3Priv=slmSnmpv3Priv, slmSysSubnetMask=slmSysSubnetMask, slmAuthLogin=slmAuthLogin, slmChPassTable=slmChPassTable, slmAdminAccess=slmAdminAccess, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysAdminStatus=slmSysAdminStatus, slmMuxNumber=slmMuxNumber, SoftwareRevision=SoftwareRevision, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysCalendarTime=slmSysCalendarTime, slmSwRevDate=slmSwRevDate, slmChPassNewPass=slmChPassNewPass, slmTrapDestTable=slmTrapDestTable, slmSysLocation=slmSysLocation, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogDestTable=slmSyslogDestTable, slmSysOperStatus=slmSysOperStatus, slmTid=slmTid, slmAdminPassword=slmAdminPassword, slmVcatDelay=slmVcatDelay, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseExpiration=slmLicenseExpiration, slmTrapDestEntry=slmTrapDestEntry, slmLogFile=slmLogFile, slmLogin=slmLogin, slmAdminCommunity=slmAdminCommunity, slmLicenseId=slmLicenseId, slmSysResetPm=slmSysResetPm, slmSysAlmAct=slmSysAlmAct, slmLicenseIndex=slmLicenseIndex, slmSwRevName=slmSwRevName, slmSyslogDestAddress=slmSyslogDestAddress, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysAlmDeact=slmSysAlmDeact, slmSysPmStartOfDay=slmSysPmStartOfDay, slmPortsNumber=slmPortsNumber, slmAdmin=slmAdmin, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam2=slmTrapLogParam2, slmChPass=slmChPass, slm40GConf=slm40GConf, slmTrapLogEntry=slmTrapLogEntry, slmConfigSysUptime=slmConfigSysUptime, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapDestAddress=slmTrapDestAddress, slmChPassOldPass=slmChPassOldPass, slmLicense=slmLicense, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysIpAddr=slmSysIpAddr, slmLicenseEntry=slmLicenseEntry, slmTrapUserAccess=slmTrapUserAccess, slmAuthEntry=slmAuthEntry, slmAuthPassword=slmAuthPassword, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogTable=slmTrapLogTable, slmSysTemperature=slmSysTemperature, slmNetworkMode=slmNetworkMode, slmConfigFile=slmConfigFile, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestEntry=slmSyslogDestEntry, slmAuth=slmAuth, slmSwRevDirectory=slmSwRevDirectory, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmPsuNumber=slmPsuNumber, slmTrapLogParam1=slmTrapLogParam1, slmRstpEnabled=slmRstpEnabled, PYSNMP_MODULE_ID=slMain, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminLogin=slmAdminLogin, slmTrapPort=slmTrapPort, slmSys=slmSys, slmChPassEntry=slmChPassEntry, slmSysName=slmSysName, slmSwRevStatus=slmSwRevStatus, slmAuthCommunity=slmAuthCommunity, slmSysTrapFormat=slmSysTrapFormat, slmPmAvailable=slmPmAvailable, slmLicenseTable=slmLicenseTable, slmSwRevEntry=slmSwRevEntry, slmSysGatewayAddr=slmSysGatewayAddr, UserPassword=UserPassword, slmTrapLogName=slmTrapLogName, slmSyslogPort=slmSyslogPort, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, AdminAccess=AdminAccess, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapUserLogin=slmTrapUserLogin, slmAuthTable=slmAuthTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmSysUplinkRate=slmSysUplinkRate, slmSnmpv3Auth=slmSnmpv3Auth, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminEntry=slmAdminEntry, slmTrapLogParam6=slmTrapLogParam6, UserCommunity=UserCommunity, slmSwRevTable=slmSwRevTable, slmSysChassisId=slmSysChassisId, slmRebootDelay=slmRebootDelay, slmTopologyEnabled=slmTopologyEnabled, slmSysMode=slmSysMode, slmTrapEnable=slmTrapEnable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam4=slmTrapLogParam4, UserLogin=UserLogin, slmChPassLogin=slmChPassLogin, slmBoxSize=slmBoxSize, slmTrap=slmTrap, slmEdfaNumber=slmEdfaNumber, slmTrapLogId=slmTrapLogId, slmAdminTable=slmAdminTable, slmSyslogLevel=slmSyslogLevel, slmOemType=slmOemType, slMain=slMain)
