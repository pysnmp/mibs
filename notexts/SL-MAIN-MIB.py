...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicenseExpiration=slmLicenseExpiration, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysOperStatus=slmSysOperStatus, slmTrapCommunity=slmTrapCommunity, slmOemType=slmOemType, slmSysChassisId=slmSysChassisId, slmSysName=slmSysName, slmChPass=slmChPass, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogTable=slmTrapLogTable, slmSysLanIpAddr=slmSysLanIpAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogParam3=slmTrapLogParam3, slmAuthTable=slmAuthTable, slmSysTemperature=slmSysTemperature, slmPmAvailable=slmPmAvailable, slmLicenseEntry=slmLicenseEntry, slmReadCommunity=slmReadCommunity, UserLogin=UserLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysSubnetMask=slmSysSubnetMask, slmAuthCommunity=slmAuthCommunity, slmSysAlmDeact=slmSysAlmDeact, slmChPassTable=slmChPassTable, slmTopologyEnabled=slmTopologyEnabled, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmPortsNumber=slmPortsNumber, slmWriteCommunity=slmWriteCommunity, PYSNMP_MODULE_ID=slMain, slmRstpEnabled=slmRstpEnabled, slmRebootDelay=slmRebootDelay, slmAuthPassword=slmAuthPassword, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogParam1=slmTrapLogParam1, slmTrapDestEntry=slmTrapDestEntry, slmLogin=slmLogin, UserCommunity=UserCommunity, slmTrapLogName=slmTrapLogName, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSys=slmSys, slmAdminEntry=slmAdminEntry, slmSwRevName=slmSwRevName, slmChPassNewPass=slmChPassNewPass, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogEntry=slmTrapLogEntry, slmAdminRowStatus=slmAdminRowStatus, slmSnmpv3Priv=slmSnmpv3Priv, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmBoxSize=slmBoxSize, slmSysCalendarTime=slmSysCalendarTime, slmSysAdminStatus=slmSysAdminStatus, slmChPassLogin=slmChPassLogin, slmVcatDelay=slmVcatDelay, slmSnmpv3Auth=slmSnmpv3Auth, AdminAccess=AdminAccess, slmSwRevStatus=slmSwRevStatus, slmNetworkMode=slmNetworkMode, slmAdminLogin=slmAdminLogin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysLocation=slmSysLocation, slmSyslogLevel=slmSyslogLevel, slmConfigSysUptime=slmConfigSysUptime, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogDestEntry=slmSyslogDestEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogDestTable=slmSyslogDestTable, slmSysUplinkRate=slmSysUplinkRate, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogParam6=slmTrapLogParam6, slmAdminTable=slmAdminTable, slmLogFile=slmLogFile, slmSwRevDate=slmSwRevDate, slmAdminAccess=slmAdminAccess, slmConfigFile=slmConfigFile, slmAdminCommunity=slmAdminCommunity, slmSysResetPm=slmSysResetPm, slmSysTrapFormat=slmSysTrapFormat, slmSwRevDirectory=slmSwRevDirectory, slmSnmpv3Password=slmSnmpv3Password, slMain=slMain, slmAdminPassword=slmAdminPassword, slmTrapDestAddress=slmTrapDestAddress, slmSysMode=slmSysMode, slmMuxNumber=slmMuxNumber, slmTrapDestTable=slmTrapDestTable, slmAuthEntry=slmAuthEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLicenseIndex=slmLicenseIndex, slmAuthLogin=slmAuthLogin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassEntry=slmChPassEntry, slmAuth=slmAuth, UserPassword=UserPassword, SoftwareRevision=SoftwareRevision, slmEdfaNumber=slmEdfaNumber, slmSyslogDestAddress=slmSyslogDestAddress, slmSwRevEntry=slmSwRevEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTid=slmTid, slmTrapEnable=slmTrapEnable, slm40GConf=slm40GConf, slmSysIpAddr=slmSysIpAddr, slmLicenseId=slmLicenseId, slmTrapLogId=slmTrapLogId, slmSysAlmAct=slmSysAlmAct, slmTrapUserLogin=slmTrapUserLogin, slmSyslogPort=slmSyslogPort, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapUserAccess=slmTrapUserAccess, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapPort=slmTrapPort, slmLicenseTable=slmLicenseTable, slmSwRevTable=slmSwRevTable, slmChPassOldPass=slmChPassOldPass, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrap=slmTrap, slmTrapLogParam4=slmTrapLogParam4, slmLicense=slmLicense, slmAdmin=slmAdmin, slmPsuNumber=slmPsuNumber)
