...
MibIdentifier, Bits, Counter64, TimeTicks, Counter32, NotificationType, IpAddress, Integer32, iso, Unsigned32, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "Counter64", "TimeTicks", "Counter32", "NotificationType", "IpAddress", "Integer32", "iso", "Unsigned32", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Opaque")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmRstpEnabled=slmRstpEnabled, slmAdminPassword=slmAdminPassword, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysCalendarTime=slmSysCalendarTime, slmLicenseId=slmLicenseId, UserLogin=UserLogin, slmSysSubnetMask=slmSysSubnetMask, slmRebootDelay=slmRebootDelay, slmConfigSysUptime=slmConfigSysUptime, slmSysUplinkRate=slmSysUplinkRate, slmAdminCommunity=slmAdminCommunity, slmTrapDestEntry=slmTrapDestEntry, slmAuth=slmAuth, slmAuthTable=slmAuthTable, slmTid=slmTid, slmTrapLogParam3=slmTrapLogParam3, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam6=slmTrapLogParam6, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminTable=slmAdminTable, slmSys=slmSys, slmSysAlmDeact=slmSysAlmDeact, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminRowStatus=slmAdminRowStatus, slmConfigFile=slmConfigFile, slmSnmpv3Priv=slmSnmpv3Priv, slmPsuNumber=slmPsuNumber, slmLogFile=slmLogFile, slmSysPmStartOfDay=slmSysPmStartOfDay, slmBoxSize=slmBoxSize, slmChPassNewPass=slmChPassNewPass, slmSysLanIpAddr=slmSysLanIpAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSnmpv3Password=slmSnmpv3Password, slmTrapUserAccess=slmTrapUserAccess, slmLogin=slmLogin, slmChPassOldPass=slmChPassOldPass, slmAdmin=slmAdmin, slmSwRevDirectory=slmSwRevDirectory, slmAuthPassword=slmAuthPassword, slmSwRevStatus=slmSwRevStatus, slmChPassEntry=slmChPassEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestAddress=slmTrapDestAddress, slmTrap=slmTrap, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slMain=slMain, slmNetworkMode=slmNetworkMode, slmVcatDelay=slmVcatDelay, slmSysOperStatus=slmSysOperStatus, slmLicenseIndex=slmLicenseIndex, slmTrapLogParam1=slmTrapLogParam1, slmAuthCommunity=slmAuthCommunity, slmTrapLogId=slmTrapLogId, slmSyslogLevel=slmSyslogLevel, slmSysResetPm=slmSysResetPm, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminAccess=slmAdminAccess, slmLicenseTable=slmLicenseTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogTable=slmTrapLogTable, slmChPassTable=slmChPassTable, slm40GConf=slm40GConf, slmSysAdminStatus=slmSysAdminStatus, slmAuthLogin=slmAuthLogin, slmSysChassisId=slmSysChassisId, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysLocation=slmSysLocation, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmAuthEntry=slmAuthEntry, slmSysName=slmSysName, slmSyslogDestTable=slmSyslogDestTable, slmLicense=slmLicense, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevDate=slmSwRevDate, slmSysIpAddr=slmSysIpAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysAlmAct=slmSysAlmAct, UserCommunity=UserCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevTable=slmSwRevTable, slmPortsNumber=slmPortsNumber, slmSwRevName=slmSwRevName, slmMuxNumber=slmMuxNumber, SoftwareRevision=SoftwareRevision, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmOemType=slmOemType, slmAdminLogin=slmAdminLogin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, UserPassword=UserPassword, slmChPassLogin=slmChPassLogin, slmEdfaNumber=slmEdfaNumber, slmSysMode=slmSysMode, slmTrapCommunity=slmTrapCommunity, slmConfigSysSignalType=slmConfigSysSignalType, slmReadCommunity=slmReadCommunity, slmSwRevEntry=slmSwRevEntry, slmTrapPort=slmTrapPort, slmTrapUserLogin=slmTrapUserLogin, slmChPass=slmChPass, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogEntry=slmTrapLogEntry, slmAdminEntry=slmAdminEntry, slmSysTrapFormat=slmSysTrapFormat, AdminAccess=AdminAccess, slmTrapEnable=slmTrapEnable, slmWriteCommunity=slmWriteCommunity, slmSyslogDestAddress=slmSyslogDestAddress, PYSNMP_MODULE_ID=slMain, slmTrapLogName=slmTrapLogName, slmTrapLogParam5=slmTrapLogParam5, slmSysTemperature=slmSysTemperature, slmSyslogPort=slmSyslogPort, slmLicenseExpiration=slmLicenseExpiration, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseEntry=slmLicenseEntry, slmPmAvailable=slmPmAvailable)
