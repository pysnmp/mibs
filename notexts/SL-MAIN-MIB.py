...
Gauge32, TimeTicks, Opaque, Counter32, MibIdentifier, iso, Integer32, Bits, NotificationType, Counter64, IpAddress, ObjectIdentity, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "Opaque", "Counter32", "MibIdentifier", "iso", "Integer32", "Bits", "NotificationType", "Counter64", "IpAddress", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSyslogDestAddress=slmSyslogDestAddress, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestProtVersion=slmTrapDestProtVersion, UserLogin=UserLogin, slmSysSnmpVersion=slmSysSnmpVersion, slmChPassNewPass=slmChPassNewPass, slmTrapDestTable=slmTrapDestTable, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuthPassword=slmAuthPassword, slmTrapLogName=slmTrapLogName, slmSyslogLevel=slmSyslogLevel, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam1=slmTrapLogParam1, slmSysAdminStatus=slmSysAdminStatus, slmConfigSysSignalType=slmConfigSysSignalType, slmSysLocation=slmSysLocation, slmTrapSysNameChange=slmTrapSysNameChange, slmAuth=slmAuth, slmTid=slmTid, PYSNMP_MODULE_ID=slMain, slmAdmin=slmAdmin, slmTrapLogId=slmTrapLogId, slmEdfaNumber=slmEdfaNumber, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysGatewayAddr=slmSysGatewayAddr, slmLicenseIndex=slmLicenseIndex, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminPassword=slmAdminPassword, slmSysEncryptionCapability=slmSysEncryptionCapability, slmBoxSize=slmBoxSize, slmPsuNumber=slmPsuNumber, slmSysTrapFormat=slmSysTrapFormat, slmTrap=slmTrap, slmTrapLogParam2=slmTrapLogParam2, UserCommunity=UserCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicenseEntry=slmLicenseEntry, slmChPassLogin=slmChPassLogin, slmLicense=slmLicense, slmNetworkMode=slmNetworkMode, slmTrapDestCommunity=slmTrapDestCommunity, slmPortsNumber=slmPortsNumber, slmRstpEnabled=slmRstpEnabled, slmTrapDestAddress=slmTrapDestAddress, slmChPass=slmChPass, slmSwRevDirectory=slmSwRevDirectory, slmSysIpAddr=slmSysIpAddr, slmTrapLogTable=slmTrapLogTable, slmRebootDelay=slmRebootDelay, slmAdminCommunity=slmAdminCommunity, slmTrapCommunity=slmTrapCommunity, slmSnmpv3Password=slmSnmpv3Password, slmVcatDelay=slmVcatDelay, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevDate=slmSwRevDate, slmPmAvailable=slmPmAvailable, slmWriteCommunity=slmWriteCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysResetPm=slmSysResetPm, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmReadCommunity=slmReadCommunity, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysSubnetMask=slmSysSubnetMask, slmLicenseTable=slmLicenseTable, slmTopologyEnabled=slmTopologyEnabled, slmSysName=slmSysName, slmSwRevEntry=slmSwRevEntry, slmSysCalendarTime=slmSysCalendarTime, slmSysUplinkRate=slmSysUplinkRate, slmLogin=slmLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmConfigSysUptime=slmConfigSysUptime, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, SoftwareRevision=SoftwareRevision, slmSysMode=slmSysMode, slmAdminEntry=slmAdminEntry, slmSys=slmSys, slmSysChassisId=slmSysChassisId, slmTrapPort=slmTrapPort, slmLicenseExpiration=slmLicenseExpiration, slmConfigFile=slmConfigFile, slmTrapLogParam6=slmTrapLogParam6, slmTrapEnable=slmTrapEnable, slmSysAlmDeact=slmSysAlmDeact, slmLogFile=slmLogFile, slmSwRevStatus=slmSwRevStatus, slmAuthEntry=slmAuthEntry, AdminAccess=AdminAccess, slmAuthCommunity=slmAuthCommunity, slmTrapUserLogin=slmTrapUserLogin, slmSysAlmAct=slmSysAlmAct, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogParam4=slmTrapLogParam4, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassEntry=slmChPassEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSwRevTable=slmSwRevTable, slmSysTemperature=slmSysTemperature, slmAdminTable=slmAdminTable, slmLicenseId=slmLicenseId, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogEntry=slmTrapLogEntry, slmSyslogPort=slmSyslogPort, UserPassword=UserPassword, slmAuthLogin=slmAuthLogin, slMain=slMain, slmSysLanIpAddr=slmSysLanIpAddr, slm40GConf=slm40GConf, slmMuxNumber=slmMuxNumber, slmSnmpv3Priv=slmSnmpv3Priv, slmAuthTable=slmAuthTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevName=slmSwRevName, slmOpticalSwitchExist=slmOpticalSwitchExist, slmOemType=slmOemType, slmAdminLogin=slmAdminLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysOperStatus=slmSysOperStatus, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestEntry=slmTrapDestEntry, slmAdminAccess=slmAdminAccess, slmChPassTable=slmChPassTable)
