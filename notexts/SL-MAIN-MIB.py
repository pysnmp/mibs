...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysAlmDeact=slmSysAlmDeact, slmSysResetPm=slmSysResetPm, slmSysLocation=slmSysLocation, slmVcatDelay=slmVcatDelay, slmAdminAccess=slmAdminAccess, slmTid=slmTid, slmEdfaNumber=slmEdfaNumber, slmSysUplinkRate=slmSysUplinkRate, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmOemType=slmOemType, slmSnmpv3Priv=slmSnmpv3Priv, slmSysActiveSwVersion=slmSysActiveSwVersion, slmPortsNumber=slmPortsNumber, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysSnmpVersion=slmSysSnmpVersion, slmChPassTable=slmChPassTable, slmLicenseId=slmLicenseId, UserPassword=UserPassword, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPassEntry=slmChPassEntry, slmTrapLogParam4=slmTrapLogParam4, slmAdminTable=slmAdminTable, slmChPassOldPass=slmChPassOldPass, slmNetworkMode=slmNetworkMode, slmSysIpAddr=slmSysIpAddr, slmSwRevStatus=slmSwRevStatus, slmBoxSize=slmBoxSize, slmLogFile=slmLogFile, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestTable=slmTrapDestTable, AdminAccess=AdminAccess, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapPort=slmTrapPort, slmReadCommunity=slmReadCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminRowStatus=slmAdminRowStatus, slmTrapUserLogin=slmTrapUserLogin, slMain=slMain, slmAuthEntry=slmAuthEntry, slmAdminEntry=slmAdminEntry, slmLicenseIndex=slmLicenseIndex, slmSnmpv3Auth=slmSnmpv3Auth, slmAdmin=slmAdmin, slmSysName=slmSysName, slmChPassNewPass=slmChPassNewPass, slmTrapDestAddress=slmTrapDestAddress, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminLogin=slmAdminLogin, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam6=slmTrapLogParam6, slmSysOperStatus=slmSysOperStatus, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassLogin=slmChPassLogin, slmWriteCommunity=slmWriteCommunity, slmTrapDestEntry=slmTrapDestEntry, slmTrap=slmTrap, slmSysMode=slmSysMode, PYSNMP_MODULE_ID=slMain, slmRebootDelay=slmRebootDelay, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseTable=slmLicenseTable, slmSysCalendarTime=slmSysCalendarTime, slmConfigSysUptime=slmConfigSysUptime, slmSyslogDestTable=slmSyslogDestTable, slmMuxNumber=slmMuxNumber, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysGatewayAddr=slmSysGatewayAddr, slmAuthPassword=slmAuthPassword, slmTrapLogParam3=slmTrapLogParam3, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam2=slmTrapLogParam2, slmSysSubnetMask=slmSysSubnetMask, slmSysAlmAct=slmSysAlmAct, slmAuthLogin=slmAuthLogin, slmAuthCommunity=slmAuthCommunity, slmLogin=slmLogin, slmTrapLogParam1=slmTrapLogParam1, slmAdminPassword=slmAdminPassword, slmSysChassisId=slmSysChassisId, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogEntry=slmTrapLogEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmSysTrapFormat=slmSysTrapFormat, slmSyslogLevel=slmSyslogLevel, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam5=slmTrapLogParam5, slmSysTemperature=slmSysTemperature, slmTrapCommunity=slmTrapCommunity, slmConfigFile=slmConfigFile, slmLicense=slmLicense, UserCommunity=UserCommunity, slmSys=slmSys, slmPmAvailable=slmPmAvailable, slmSwRevDate=slmSwRevDate, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevTable=slmSwRevTable, slmTrapLogId=slmTrapLogId, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmPsuNumber=slmPsuNumber, slmSwRevName=slmSwRevName, slmSysAdminStatus=slmSysAdminStatus, slmAdminCommunity=slmAdminCommunity, slmAuthTable=slmAuthTable, SoftwareRevision=SoftwareRevision, slmTrapLogName=slmTrapLogName, slmLicenseExpiration=slmLicenseExpiration, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapEnable=slmTrapEnable, slmRstpEnabled=slmRstpEnabled, slmChPass=slmChPass, UserLogin=UserLogin, slmSyslogDestAddress=slmSyslogDestAddress, slmAuth=slmAuth, slmSyslogPort=slmSyslogPort, slmTopologyEnabled=slmTopologyEnabled, slmTrapUserAccess=slmTrapUserAccess, slmSnmpv3Password=slmSnmpv3Password, slmSwRevEntry=slmSwRevEntry, slmLicenseEntry=slmLicenseEntry, slmTrapSysNameChange=slmTrapSysNameChange, slm40GConf=slm40GConf, slmTrapDestRowStatus=slmTrapDestRowStatus)
