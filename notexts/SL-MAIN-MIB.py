...
Gauge32, ModuleIdentity, TimeTicks, Integer32, MibIdentifier, Bits, NotificationType, iso, Counter64, Opaque, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "TimeTicks", "Integer32", "MibIdentifier", "Bits", "NotificationType", "iso", "Counter64", "Opaque", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPassNewPass=slmChPassNewPass, slmChPassLogin=slmChPassLogin, slmSysOperStatus=slmSysOperStatus, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapUserAccess=slmTrapUserAccess, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSwRevDirectory=slmSwRevDirectory, slmTrapPort=slmTrapPort, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, UserPassword=UserPassword, slmAdmin=slmAdmin, slmAuth=slmAuth, slmSysMode=slmSysMode, slmSwRevDate=slmSwRevDate, slmLogin=slmLogin, slmTrapLogParam5=slmTrapLogParam5, slmPsuNumber=slmPsuNumber, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slm40GConf=slm40GConf, slmLicenseIndex=slmLicenseIndex, slmWriteCommunity=slmWriteCommunity, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogName=slmTrapLogName, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapEnable=slmTrapEnable, UserLogin=UserLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysTemperature=slmSysTemperature, slmTrapCommunity=slmTrapCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysResetPm=slmSysResetPm, slmRstpEnabled=slmRstpEnabled, slmSys=slmSys, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam2=slmTrapLogParam2, slmSwRevName=slmSwRevName, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapUserLogin=slmTrapUserLogin, slmAdminRowStatus=slmAdminRowStatus, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogParam1=slmTrapLogParam1, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrap=slmTrap, slmAdminAccess=slmAdminAccess, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestTable=slmSyslogDestTable, slmAuthPassword=slmAuthPassword, slmBoxSize=slmBoxSize, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseExpiration=slmLicenseExpiration, slmRebootDelay=slmRebootDelay, slmMuxNumber=slmMuxNumber, slmTrapLogTable=slmTrapLogTable, slmTrapLogId=slmTrapLogId, slmAdminEntry=slmAdminEntry, AdminAccess=AdminAccess, slmSysChassisId=slmSysChassisId, slmConfigSysSignalType=slmConfigSysSignalType, slmSysAlmAct=slmSysAlmAct, slmChPass=slmChPass, slmTrapDestEntry=slmTrapDestEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminLogin=slmAdminLogin, slmSwRevTable=slmSwRevTable, slmChPassOldPass=slmChPassOldPass, slmLogFile=slmLogFile, slmSysIpAddr=slmSysIpAddr, slmTid=slmTid, slmSysLanIpAddr=slmSysLanIpAddr, slmSysSubnetMask=slmSysSubnetMask, slmConfigFile=slmConfigFile, slMain=slMain, slmSysAdminStatus=slmSysAdminStatus, slmNetworkMode=slmNetworkMode, slmLicenseEntry=slmLicenseEntry, slmAuthCommunity=slmAuthCommunity, slmSwRevStatus=slmSwRevStatus, slmSwRevEntry=slmSwRevEntry, slmChPassEntry=slmChPassEntry, slmEdfaNumber=slmEdfaNumber, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestAddress=slmTrapDestAddress, slmVcatDelay=slmVcatDelay, PYSNMP_MODULE_ID=slMain, slmPortsNumber=slmPortsNumber, slmSysUplinkRate=slmSysUplinkRate, SoftwareRevision=SoftwareRevision, slmSysLocation=slmSysLocation, slmSyslogLevel=slmSyslogLevel, slmAuthLogin=slmAuthLogin, slmTrapLogParam4=slmTrapLogParam4, slmPmAvailable=slmPmAvailable, slmSyslogPort=slmSyslogPort, slmAuthEntry=slmAuthEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysGatewayAddr=slmSysGatewayAddr, slmSyslogDestAddress=slmSyslogDestAddress, UserCommunity=UserCommunity, slmAdminPassword=slmAdminPassword, slmTrapDestTable=slmTrapDestTable, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminCommunity=slmAdminCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicenseId=slmLicenseId, slmAuthTable=slmAuthTable, slmLicense=slmLicense, slmSysName=slmSysName, slmTrapLogParam3=slmTrapLogParam3, slmAdminTable=slmAdminTable, slmChPassTable=slmChPassTable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam6=slmTrapLogParam6, slmSnmpv3Password=slmSnmpv3Password, slmReadCommunity=slmReadCommunity, slmConfigSysUptime=slmConfigSysUptime, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmOemType=slmOemType, slmLicenseTable=slmLicenseTable, slmSysCalendarTime=slmSysCalendarTime)
