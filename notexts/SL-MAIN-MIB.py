...
Opaque, Gauge32, ModuleIdentity, Unsigned32, IpAddress, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, NotificationType, Integer32, TimeTicks, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "Gauge32", "ModuleIdentity", "Unsigned32", "IpAddress", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "NotificationType", "Integer32", "TimeTicks", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTid=slmTid, slmLicenseExpiration=slmLicenseExpiration, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapEnable=slmTrapEnable, slmRstpEnabled=slmRstpEnabled, slmTrapUserLogin=slmTrapUserLogin, slmSwRevDate=slmSwRevDate, slmTrapDestRowStatus=slmTrapDestRowStatus, slmPmAvailable=slmPmAvailable, slmSysLocation=slmSysLocation, slmSwRevDirectory=slmSwRevDirectory, slmSyslogPort=slmSyslogPort, slmTrapCommunity=slmTrapCommunity, slmConfigSysSignalType=slmConfigSysSignalType, slmChPass=slmChPass, slmTrapPort=slmTrapPort, slmMuxNumber=slmMuxNumber, slmAdminCommunity=slmAdminCommunity, slmTrapLogTable=slmTrapLogTable, slmPsuNumber=slmPsuNumber, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam3=slmTrapLogParam3, slmAdminPassword=slmAdminPassword, slmSysAlmAct=slmSysAlmAct, slmTrapDestAddress=slmTrapDestAddress, slmSysMode=slmSysMode, slmSysAdminStatus=slmSysAdminStatus, slmAuthPassword=slmAuthPassword, slmTrapLogParam5=slmTrapLogParam5, slmSysIpAddr=slmSysIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminRowStatus=slmAdminRowStatus, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysLanIpAddr=slmSysLanIpAddr, slmEdfaNumber=slmEdfaNumber, slmSwRevTable=slmSwRevTable, slmSyslogDestTable=slmSyslogDestTable, slmLogFile=slmLogFile, slmChPassOldPass=slmChPassOldPass, slmSysChassisId=slmSysChassisId, slmSysGatewayAddr=slmSysGatewayAddr, slmChPassLogin=slmChPassLogin, slmBoxSize=slmBoxSize, slmTrapLogId=slmTrapLogId, slmLicenseTable=slmLicenseTable, slmSnmpv3Password=slmSnmpv3Password, slmVcatDelay=slmVcatDelay, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysName=slmSysName, slmTrapLogParam6=slmTrapLogParam6, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAuth=slmAuth, slmTrapUserAccess=slmTrapUserAccess, slmAuthCommunity=slmAuthCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdminAccess=slmAdminAccess, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam2=slmTrapLogParam2, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevEntry=slmSwRevEntry, slmPortsNumber=slmPortsNumber, slmLogin=slmLogin, slmOemType=slmOemType, slmTrapLogEntry=slmTrapLogEntry, slmReadCommunity=slmReadCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminTable=slmAdminTable, AdminAccess=AdminAccess, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmRebootDelay=slmRebootDelay, slmTrapDestCommunity=slmTrapDestCommunity, PYSNMP_MODULE_ID=slMain, slmChPassTable=slmChPassTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmTrap=slmTrap, slmSwRevName=slmSwRevName, slmSysSubnetMask=slmSysSubnetMask, slmConfigSysUptime=slmConfigSysUptime, slmSys=slmSys, slmLicense=slmLicense, slmTrapLogName=slmTrapLogName, slmTrapDestTable=slmTrapDestTable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuthEntry=slmAuthEntry, slmSwRevStatus=slmSwRevStatus, slmAdminLogin=slmAdminLogin, slmLicenseId=slmLicenseId, slmAuthTable=slmAuthTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapSysLocationChange=slmTrapSysLocationChange, slmWriteCommunity=slmWriteCommunity, UserLogin=UserLogin, UserCommunity=UserCommunity, slmNetworkMode=slmNetworkMode, slmTopologyEnabled=slmTopologyEnabled, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogDestEntry=slmSyslogDestEntry, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogParam4=slmTrapLogParam4, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseEntry=slmLicenseEntry, slmChPassEntry=slmChPassEntry, UserPassword=UserPassword, slmTrapLogParam1=slmTrapLogParam1, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysTemperature=slmSysTemperature, slmSysSnmpVersion=slmSysSnmpVersion, SoftwareRevision=SoftwareRevision, slm40GConf=slm40GConf, slmLicenseIndex=slmLicenseIndex, slMain=slMain, slmAdmin=slmAdmin, slmSysAlmDeact=slmSysAlmDeact, slmAuthLogin=slmAuthLogin, slmSysResetPm=slmSysResetPm, slmAdminEntry=slmAdminEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmChPassNewPass=slmChPassNewPass, slmSyslogLevel=slmSyslogLevel, slmSysOperStatus=slmSysOperStatus, slmSnmpv3Priv=slmSnmpv3Priv, slmConfigFile=slmConfigFile, slmTrapDestEntry=slmTrapDestEntry)
