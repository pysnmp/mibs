...
Bits, Opaque, Gauge32, MibIdentifier, TimeTicks, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, IpAddress, Unsigned32, iso, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Opaque", "Gauge32", "MibIdentifier", "TimeTicks", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "IpAddress", "Unsigned32", "iso", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLogin=slmLogin, slmSysTrapFormat=slmSysTrapFormat, slmTrapSysNameChange=slmTrapSysNameChange, slmChPassEntry=slmChPassEntry, slmEdfaNumber=slmEdfaNumber, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminLogin=slmAdminLogin, slmSwRevDate=slmSwRevDate, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogParam3=slmTrapLogParam3, slmChPassLogin=slmChPassLogin, slmSysSubnetMask=slmSysSubnetMask, slmLicenseId=slmLicenseId, slmConfigSysUptime=slmConfigSysUptime, slmReadCommunity=slmReadCommunity, UserCommunity=UserCommunity, slmSwRevName=slmSwRevName, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminTable=slmAdminTable, slmLicenseEntry=slmLicenseEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmSys=slmSys, slmSysAdminStatus=slmSysAdminStatus, slmLicense=slmLicense, slmSnmpv3Auth=slmSnmpv3Auth, slmConfigFile=slmConfigFile, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam6=slmTrapLogParam6, slmPortsNumber=slmPortsNumber, slmTrapLogName=slmTrapLogName, slmSyslogDestTable=slmSyslogDestTable, slmAuth=slmAuth, slmSysTemperature=slmSysTemperature, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmWriteCommunity=slmWriteCommunity, slmAuthCommunity=slmAuthCommunity, UserPassword=UserPassword, slmLicenseExpiration=slmLicenseExpiration, slmAdminAccess=slmAdminAccess, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestEntry=slmSyslogDestEntry, slMain=slMain, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLogFile=slmLogFile, slmSysName=slmSysName, slmTrapDestEntry=slmTrapDestEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmConfigSysSignalType=slmConfigSysSignalType, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogParam4=slmTrapLogParam4, slmAuthEntry=slmAuthEntry, slmSwRevStatus=slmSwRevStatus, slmTrapLogParam2=slmTrapLogParam2, AdminAccess=AdminAccess, slmTrapLogParam1=slmTrapLogParam1, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogId=slmTrapLogId, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogPort=slmSyslogPort, slmSysMode=slmSysMode, slmSysLanIpAddr=slmSysLanIpAddr, slmOemType=slmOemType, slmTrapPort=slmTrapPort, slmSyslogLevel=slmSyslogLevel, slmBoxSize=slmBoxSize, slmTrapUserLogin=slmTrapUserLogin, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysLocation=slmSysLocation, slmAdminEntry=slmAdminEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAuthLogin=slmAuthLogin, slmAuthTable=slmAuthTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrap=slmTrap, SoftwareRevision=SoftwareRevision, slmTrapLogParam5=slmTrapLogParam5, slmVcatDelay=slmVcatDelay, slmSysResetPm=slmSysResetPm, slmLicenseIndex=slmLicenseIndex, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmRstpEnabled=slmRstpEnabled, slmAdmin=slmAdmin, UserLogin=UserLogin, slmTrapLogTable=slmTrapLogTable, slmSysChassisId=slmSysChassisId, slmSwRevEntry=slmSwRevEntry, slmSwRevDirectory=slmSwRevDirectory, slmMuxNumber=slmMuxNumber, slm40GConf=slm40GConf, slmChPassTable=slmChPassTable, slmSwRevTable=slmSwRevTable, slmChPassNewPass=slmChPassNewPass, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogEntry=slmTrapLogEntry, slmTid=slmTid, slmPsuNumber=slmPsuNumber, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapCommunity=slmTrapCommunity, slmLicenseTable=slmLicenseTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmNetworkMode=slmNetworkMode, PYSNMP_MODULE_ID=slMain, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthPassword=slmAuthPassword, slmChPass=slmChPass, slmChPassOldPass=slmChPassOldPass, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestTable=slmTrapDestTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysIpAddr=slmSysIpAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysOperStatus=slmSysOperStatus, slmTrapEnable=slmTrapEnable, slmRebootDelay=slmRebootDelay, slmAdminPassword=slmAdminPassword, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmPmAvailable=slmPmAvailable, slmSysAlmAct=slmSysAlmAct, slmAdminCommunity=slmAdminCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapUserAccess=slmTrapUserAccess)
