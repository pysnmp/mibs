...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, Counter32, Integer32, Bits, IpAddress, ModuleIdentity, Unsigned32, iso, Opaque, TimeTicks, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "Counter32", "Integer32", "Bits", "IpAddress", "ModuleIdentity", "Unsigned32", "iso", "Opaque", "TimeTicks", "Counter64", "MibIdentifier")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAuthPassword=slmAuthPassword, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLocation=slmSysLocation, slmSysMode=slmSysMode, slmSwRevDirectory=slmSwRevDirectory, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slm40GConf=slm40GConf, slmSwRevEntry=slmSwRevEntry, slmAdminAccess=slmAdminAccess, slmTrapDestTable=slmTrapDestTable, slmSysUplinkRate=slmSysUplinkRate, slmOemType=slmOemType, slmChPassTable=slmChPassTable, slmTrapUserLogin=slmTrapUserLogin, slmChPass=slmChPass, slmTrapEnable=slmTrapEnable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAuthEntry=slmAuthEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmWriteCommunity=slmWriteCommunity, slmLogFile=slmLogFile, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapCommunity=slmTrapCommunity, slmSysAlmAct=slmSysAlmAct, slmSysChassisId=slmSysChassisId, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSnmpv3Password=slmSnmpv3Password, slmChPassLogin=slmChPassLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogDestEntry=slmSyslogDestEntry, SoftwareRevision=SoftwareRevision, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogTable=slmTrapLogTable, slmTrap=slmTrap, slmSyslogDestTable=slmSyslogDestTable, slmAdminLogin=slmAdminLogin, slmAuthCommunity=slmAuthCommunity, UserCommunity=UserCommunity, slmTrapPort=slmTrapPort, slmSysPmStartOfDay=slmSysPmStartOfDay, PYSNMP_MODULE_ID=slMain, slmAdminPassword=slmAdminPassword, slmTrapDestCommunity=slmTrapDestCommunity, slmSysIpAddr=slmSysIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmSysActiveSwVersion=slmSysActiveSwVersion, slmConfigSysUptime=slmConfigSysUptime, slmRstpEnabled=slmRstpEnabled, slmVcatDelay=slmVcatDelay, slmSyslogPort=slmSyslogPort, slmEdfaNumber=slmEdfaNumber, slmSysName=slmSysName, slmSysTemperature=slmSysTemperature, slmPortsNumber=slmPortsNumber, slmSyslogLevel=slmSyslogLevel, slmSwRevStatus=slmSwRevStatus, slmRebootDelay=slmRebootDelay, slmLicenseEntry=slmLicenseEntry, slmTrapLogId=slmTrapLogId, slmChPassNewPass=slmChPassNewPass, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogName=slmTrapLogName, slmSysSnmpVersion=slmSysSnmpVersion, slmSysOperStatus=slmSysOperStatus, slmLicenseExpiration=slmLicenseExpiration, UserLogin=UserLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmSysAlmDeact=slmSysAlmDeact, slmTrapDestIpAddress=slmTrapDestIpAddress, slmBoxSize=slmBoxSize, slmConfigFile=slmConfigFile, slmSysResetPm=slmSysResetPm, UserPassword=UserPassword, slmLicenseIndex=slmLicenseIndex, slmTrapLogParam1=slmTrapLogParam1, slmAdminTable=slmAdminTable, slmAdmin=slmAdmin, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestAddress=slmTrapDestAddress, slmSysTrapFormat=slmSysTrapFormat, slmSysGatewayAddr=slmSysGatewayAddr, slmChPassOldPass=slmChPassOldPass, AdminAccess=AdminAccess, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam3=slmTrapLogParam3, slmLogin=slmLogin, slmSys=slmSys, slmNetworkMode=slmNetworkMode, slmPsuNumber=slmPsuNumber, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTid=slmTid, slmSwRevTable=slmSwRevTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAuthTable=slmAuthTable, slmLicenseTable=slmLicenseTable, slmSwRevName=slmSwRevName, slmLicense=slmLicense, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestAddress=slmSyslogDestAddress, slmReadCommunity=slmReadCommunity, slmLicenseId=slmLicenseId, slmAdminCommunity=slmAdminCommunity, slmChPassEntry=slmChPassEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogParam2=slmTrapLogParam2, slmPmAvailable=slmPmAvailable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogParam5=slmTrapLogParam5, slmSysCalendarTime=slmSysCalendarTime, slmSwRevDate=slmSwRevDate, slmAuthLogin=slmAuthLogin, slmTrapDestEntry=slmTrapDestEntry, slMain=slMain, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogParam4=slmTrapLogParam4, slmMuxNumber=slmMuxNumber, slmAdminEntry=slmAdminEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuth=slmAuth, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr)
