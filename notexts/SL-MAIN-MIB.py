...
TimeTicks, Unsigned32, IpAddress, ObjectIdentity, Counter64, Bits, ModuleIdentity, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, iso, Gauge32, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "IpAddress", "ObjectIdentity", "Counter64", "Bits", "ModuleIdentity", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "iso", "Gauge32", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysAlmAct=slmSysAlmAct, slmChPassNewPass=slmChPassNewPass, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminAccess=slmAdminAccess, slmAuthLogin=slmAuthLogin, slmLicenseTable=slmLicenseTable, slmPsuNumber=slmPsuNumber, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysCalendarTime=slmSysCalendarTime, SoftwareRevision=SoftwareRevision, UserLogin=UserLogin, slmSwRevTable=slmSwRevTable, slmConfigSysSignalType=slmConfigSysSignalType, slmNetworkMode=slmNetworkMode, slmLicenseEntry=slmLicenseEntry, slmChPassTable=slmChPassTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmRstpEnabled=slmRstpEnabled, slmLicense=slmLicense, slmAuthEntry=slmAuthEntry, slmAdminLogin=slmAdminLogin, slmTrapDestRowStatus=slmTrapDestRowStatus, slmConfigFile=slmConfigFile, slmTrapLogEntry=slmTrapLogEntry, slMain=slMain, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogParam5=slmTrapLogParam5, slmSysSnmpVersion=slmSysSnmpVersion, slmTopologyEnabled=slmTopologyEnabled, slmSysSubnetMask=slmSysSubnetMask, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapPort=slmTrapPort, slmTrapUserAccess=slmTrapUserAccess, slmAuthCommunity=slmAuthCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmReadCommunity=slmReadCommunity, AdminAccess=AdminAccess, slmTrapDestEntry=slmTrapDestEntry, slmSysLocation=slmSysLocation, slmSys=slmSys, slmSysName=slmSysName, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevEntry=slmSwRevEntry, slmChPassLogin=slmChPassLogin, slmSnmpv3Password=slmSnmpv3Password, slmAuthPassword=slmAuthPassword, slmMuxNumber=slmMuxNumber, slmSwRevName=slmSwRevName, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogLevel=slmSyslogLevel, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogTable=slmTrapLogTable, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogDestTable=slmSyslogDestTable, slmTrap=slmTrap, slmAuthTable=slmAuthTable, slmTrapUserLogin=slmTrapUserLogin, slmSyslogPort=slmSyslogPort, slmLogin=slmLogin, slmAdminRowStatus=slmAdminRowStatus, slmAdminEntry=slmAdminEntry, slmSysUplinkRate=slmSysUplinkRate, slmTrapEnable=slmTrapEnable, slmSyslogDestEntry=slmSyslogDestEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogId=slmTrapLogId, slmTrapLogParam1=slmTrapLogParam1, slmAdminTable=slmAdminTable, slmSwRevStatus=slmSwRevStatus, slmAdminPassword=slmAdminPassword, UserCommunity=UserCommunity, slmChPass=slmChPass, slmChPassOldPass=slmChPassOldPass, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestCommunity=slmTrapDestCommunity, slmSysAdminStatus=slmSysAdminStatus, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogParam2=slmTrapLogParam2, slmBoxSize=slmBoxSize, slmTrapLogParam6=slmTrapLogParam6, PYSNMP_MODULE_ID=slMain, slmRebootDelay=slmRebootDelay, slmPmAvailable=slmPmAvailable, slmWriteCommunity=slmWriteCommunity, UserPassword=UserPassword, slmVcatDelay=slmVcatDelay, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicenseId=slmLicenseId, slmTrapLogName=slmTrapLogName, slmPortsNumber=slmPortsNumber, slmTrapLogParam3=slmTrapLogParam3, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLicenseIndex=slmLicenseIndex, slmAuth=slmAuth, slm40GConf=slm40GConf, slmSysChassisId=slmSysChassisId, slmSysLanIpAddr=slmSysLanIpAddr, slmSysTemperature=slmSysTemperature, slmLogFile=slmLogFile, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevDirectory=slmSwRevDirectory, slmOemType=slmOemType, slmSysResetPm=slmSysResetPm, slmLicenseExpiration=slmLicenseExpiration, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapCommunity=slmTrapCommunity, slmTrapDestTable=slmTrapDestTable, slmAdmin=slmAdmin, slmSysMode=slmSysMode, slmAdminCommunity=slmAdminCommunity, slmChPassEntry=slmChPassEntry, slmConfigSysUptime=slmConfigSysUptime, slmSysIpAddr=slmSysIpAddr, slmSwRevDate=slmSwRevDate, slmTid=slmTid, slmEdfaNumber=slmEdfaNumber, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr)
