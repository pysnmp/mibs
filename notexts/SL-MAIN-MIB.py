...
Integer32, ModuleIdentity, Counter64, Gauge32, Unsigned32, Opaque, iso, TimeTicks, Counter32, IpAddress, ObjectIdentity, NotificationType, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "Counter64", "Gauge32", "Unsigned32", "Opaque", "iso", "TimeTicks", "Counter32", "IpAddress", "ObjectIdentity", "NotificationType", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseExpiration=slmLicenseExpiration, slmSysResetPm=slmSysResetPm, slmAuthTable=slmAuthTable, slmSwRevDate=slmSwRevDate, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogId=slmTrapLogId, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam3=slmTrapLogParam3, slmSysUplinkRate=slmSysUplinkRate, slmMuxNumber=slmMuxNumber, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminCommunity=slmAdminCommunity, slmLicenseEntry=slmLicenseEntry, UserCommunity=UserCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapEnable=slmTrapEnable, slmTrapPort=slmTrapPort, slmTrapSysNameChange=slmTrapSysNameChange, slmVcatDelay=slmVcatDelay, slm40GConf=slm40GConf, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminAccess=slmAdminAccess, slmTrap=slmTrap, slmTrapLogEntry=slmTrapLogEntry, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogName=slmTrapLogName, slmTrapLogParam2=slmTrapLogParam2, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam1=slmTrapLogParam1, slmPortsNumber=slmPortsNumber, slmRstpEnabled=slmRstpEnabled, slmSysAlmDeact=slmSysAlmDeact, slmSysLocation=slmSysLocation, slmBoxSize=slmBoxSize, slmTrapCommunity=slmTrapCommunity, AdminAccess=AdminAccess, slmAdminTable=slmAdminTable, slmSysGatewayAddr=slmSysGatewayAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmOemType=slmOemType, slmPmAvailable=slmPmAvailable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSnmpv3Auth=slmSnmpv3Auth, slmSysName=slmSysName, slmLogFile=slmLogFile, slmSysAlmAct=slmSysAlmAct, slmAuthLogin=slmAuthLogin, slmLicenseId=slmLicenseId, slMain=slMain, slmLogin=slmLogin, slmChPassEntry=slmChPassEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevTable=slmSwRevTable, slmPsuNumber=slmPsuNumber, slmConfigSysUptime=slmConfigSysUptime, slmSysChassisId=slmSysChassisId, slmSwRevName=slmSwRevName, slmTrapLogParam5=slmTrapLogParam5, slmLicense=slmLicense, slmEdfaNumber=slmEdfaNumber, slmChPassNewPass=slmChPassNewPass, slmAuth=slmAuth, slmSyslogDestAddress=slmSyslogDestAddress, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminPassword=slmAdminPassword, slmRebootDelay=slmRebootDelay, slmAuthCommunity=slmAuthCommunity, slmSysTemperature=slmSysTemperature, slmSysCalendarTime=slmSysCalendarTime, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogTable=slmTrapLogTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysIpAddr=slmSysIpAddr, slmAuthPassword=slmAuthPassword, slmSyslogLevel=slmSyslogLevel, slmLicenseIndex=slmLicenseIndex, slmSysAdminStatus=slmSysAdminStatus, SoftwareRevision=SoftwareRevision, slmConfigFile=slmConfigFile, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysMode=slmSysMode, slmSwRevDirectory=slmSwRevDirectory, slmChPassLogin=slmChPassLogin, slmWriteCommunity=slmWriteCommunity, slmAdmin=slmAdmin, slmTrapLogParam4=slmTrapLogParam4, slmSyslogDestTable=slmSyslogDestTable, slmSysSubnetMask=slmSysSubnetMask, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdminEntry=slmAdminEntry, slmAuthEntry=slmAuthEntry, slmTrapUserAccess=slmTrapUserAccess, UserLogin=UserLogin, slmLicenseTable=slmLicenseTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestCommunity=slmTrapDestCommunity, slmSysLanIpAddr=slmSysLanIpAddr, slmSys=slmSys, slmChPassTable=slmChPassTable, slmSyslogPort=slmSyslogPort, PYSNMP_MODULE_ID=slMain, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestAddress=slmTrapDestAddress, UserPassword=UserPassword, slmReadCommunity=slmReadCommunity, slmTrapDestTable=slmTrapDestTable, slmChPassOldPass=slmChPassOldPass, slmSysSnmpVersion=slmSysSnmpVersion, slmChPass=slmChPass, slmTrapLogParam6=slmTrapLogParam6, slmSwRevEntry=slmSwRevEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevStatus=slmSwRevStatus, slmAdminLogin=slmAdminLogin, slmTid=slmTid, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapUserLogin=slmTrapUserLogin, slmNetworkMode=slmNetworkMode, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysOperStatus=slmSysOperStatus, slmSnmpv3Priv=slmSnmpv3Priv)
