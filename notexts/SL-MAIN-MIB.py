...
Bits, MibIdentifier, Counter32, IpAddress, Unsigned32, Integer32, ModuleIdentity, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, Gauge32, NotificationType, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "Counter32", "IpAddress", "Unsigned32", "Integer32", "ModuleIdentity", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "Gauge32", "NotificationType", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysAlmDeact=slmSysAlmDeact, slmChPassOldPass=slmChPassOldPass, slmTrapCommunity=slmTrapCommunity, slmSysUplinkRate=slmSysUplinkRate, slmSysIpAddr=slmSysIpAddr, slmTrapLogId=slmTrapLogId, slmLicenseIndex=slmLicenseIndex, slmSyslogLevel=slmSyslogLevel, slmTrapUserAccess=slmTrapUserAccess, slmAuthLogin=slmAuthLogin, slmSwRevStatus=slmSwRevStatus, slmEdfaNumber=slmEdfaNumber, slmVcatDelay=slmVcatDelay, slmAuthCommunity=slmAuthCommunity, slmPsuNumber=slmPsuNumber, slmSysAlmAct=slmSysAlmAct, slmBoxSize=slmBoxSize, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicense=slmLicense, slmSysResetPm=slmSysResetPm, slmRstpEnabled=slmRstpEnabled, slmSysMode=slmSysMode, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLicenseId=slmLicenseId, slmSnmpv3Password=slmSnmpv3Password, slmAuthPassword=slmAuthPassword, slmConfigSysSignalType=slmConfigSysSignalType, slmSysGatewayAddr=slmSysGatewayAddr, slmPortsNumber=slmPortsNumber, slmTrapDestTable=slmTrapDestTable, slmTid=slmTid, slmChPass=slmChPass, slmLogFile=slmLogFile, slmSysChassisId=slmSysChassisId, slmTrapLogTable=slmTrapLogTable, SoftwareRevision=SoftwareRevision, slmPmAvailable=slmPmAvailable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam5=slmTrapLogParam5, slmMuxNumber=slmMuxNumber, slmSysTemperature=slmSysTemperature, slmTrapLogParam2=slmTrapLogParam2, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicenseTable=slmLicenseTable, slmTrap=slmTrap, slmTrapUserLogin=slmTrapUserLogin, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmConfigFile=slmConfigFile, slmTrapEnable=slmTrapEnable, slmSyslogDestAddress=slmSyslogDestAddress, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysTrapFormat=slmSysTrapFormat, slmChPassTable=slmChPassTable, slmSwRevName=slmSwRevName, slmSysLanIpAddr=slmSysLanIpAddr, slmAdminLogin=slmAdminLogin, slmSysSnmpVersion=slmSysSnmpVersion, slmLicenseExpiration=slmLicenseExpiration, slmSwRevDirectory=slmSwRevDirectory, slmSwRevEntry=slmSwRevEntry, slmSysLocation=slmSysLocation, UserCommunity=UserCommunity, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogEntry=slmTrapLogEntry, AdminAccess=AdminAccess, slmTrapLogName=slmTrapLogName, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminCommunity=slmAdminCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevDate=slmSwRevDate, slmChPassEntry=slmChPassEntry, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogParam6=slmTrapLogParam6, slmSysName=slmSysName, slmNetworkMode=slmNetworkMode, slm40GConf=slm40GConf, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogParam4=slmTrapLogParam4, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSyslogPort=slmSyslogPort, slmOemType=slmOemType, slmAdminPassword=slmAdminPassword, slmAuthTable=slmAuthTable, slmSysSubnetMask=slmSysSubnetMask, slmSysAdminStatus=slmSysAdminStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestEntry=slmTrapDestEntry, slmAuthEntry=slmAuthEntry, slmSys=slmSys, slmAdminRowStatus=slmAdminRowStatus, slmLogin=slmLogin, slmAdminEntry=slmAdminEntry, slmTrapPort=slmTrapPort, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestTable=slmSyslogDestTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseEntry=slmLicenseEntry, slmSysCalendarTime=slmSysCalendarTime, slmWriteCommunity=slmWriteCommunity, slmChPassNewPass=slmChPassNewPass, slmAdminTable=slmAdminTable, slmTrapLogParam1=slmTrapLogParam1, slmChPassLogin=slmChPassLogin, UserPassword=UserPassword, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestAddress=slmTrapDestAddress, slMain=slMain, slmSwRevTable=slmSwRevTable, slmReadCommunity=slmReadCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSnmpv3Priv=slmSnmpv3Priv, slmAuth=slmAuth, PYSNMP_MODULE_ID=slMain, slmTrapDestProtVersion=slmTrapDestProtVersion, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminAccess=slmAdminAccess, UserLogin=UserLogin, slmRebootDelay=slmRebootDelay, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogDestEntry=slmSyslogDestEntry, slmAdmin=slmAdmin)
