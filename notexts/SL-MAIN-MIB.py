...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, Counter64, Gauge32, ModuleIdentity, Integer32, iso, Opaque, IpAddress, TimeTicks, Counter32, Unsigned32, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "Counter64", "Gauge32", "ModuleIdentity", "Integer32", "iso", "Opaque", "IpAddress", "TimeTicks", "Counter32", "Unsigned32", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysEncryptionCapability=slmSysEncryptionCapability, slmNetworkMode=slmNetworkMode, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogEntry=slmTrapLogEntry, slmSysAlmDeact=slmSysAlmDeact, slmAuthLogin=slmAuthLogin, slmTrapDestEntry=slmTrapDestEntry, AdminAccess=AdminAccess, slmTrapDestCommunity=slmTrapDestCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAuthTable=slmAuthTable, slmMuxNumber=slmMuxNumber, slmTrapLogParam4=slmTrapLogParam4, slmSwRevDate=slmSwRevDate, UserLogin=UserLogin, slmSysSubnetMask=slmSysSubnetMask, slmAdminLogin=slmAdminLogin, slmPsuNumber=slmPsuNumber, slmTrapUserLogin=slmTrapUserLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicense=slmLicense, slmTrapLogParam1=slmTrapLogParam1, slmOemType=slmOemType, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapEnable=slmTrapEnable, slmSysTemperature=slmSysTemperature, slmSwRevStatus=slmSwRevStatus, slmConfigSysSignalType=slmConfigSysSignalType, UserPassword=UserPassword, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogDestTable=slmSyslogDestTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, PYSNMP_MODULE_ID=slMain, slmAuth=slmAuth, slmSysUplinkRate=slmSysUplinkRate, slmEdfaNumber=slmEdfaNumber, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLocation=slmSysLocation, slmSysResetPm=slmSysResetPm, slmSnmpv3Auth=slmSnmpv3Auth, slmAdminAccess=slmAdminAccess, SoftwareRevision=SoftwareRevision, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapDestIpAddress=slmTrapDestIpAddress, slmConfigSysUptime=slmConfigSysUptime, slmTrapUserAccess=slmTrapUserAccess, slmAuthCommunity=slmAuthCommunity, slmSysIpAddr=slmSysIpAddr, slmSwRevName=slmSwRevName, slmSysOperStatus=slmSysOperStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminEntry=slmAdminEntry, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogTable=slmTrapLogTable, slmChPass=slmChPass, slmAdminTable=slmAdminTable, slmSwRevTable=slmSwRevTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapCommunity=slmTrapCommunity, slmLicenseTable=slmLicenseTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, UserCommunity=UserCommunity, slmChPassLogin=slmChPassLogin, slmSys=slmSys, slmTrapLogName=slmTrapLogName, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogParam2=slmTrapLogParam2, slmSyslogDestEntry=slmSyslogDestEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevEntry=slmSwRevEntry, slmRstpEnabled=slmRstpEnabled, slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPassEntry=slmChPassEntry, slmSysAlmAct=slmSysAlmAct, slmSysMode=slmSysMode, slmSyslogPort=slmSyslogPort, slmAdminCommunity=slmAdminCommunity, slmReadCommunity=slmReadCommunity, slm40GConf=slm40GConf, slmTrapPort=slmTrapPort, slmBoxSize=slmBoxSize, slmPortsNumber=slmPortsNumber, slmTrapDestAddress=slmTrapDestAddress, slmAdminPassword=slmAdminPassword, slmAuthPassword=slmAuthPassword, slmSysTrapFormat=slmSysTrapFormat, slmSyslogDestAddress=slmSyslogDestAddress, slmChPassTable=slmChPassTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogId=slmTrapLogId, slmLogin=slmLogin, slmLogFile=slmLogFile, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestTable=slmTrapDestTable, slmAdminRowStatus=slmAdminRowStatus, slmPmAvailable=slmPmAvailable, slMain=slMain, slmAdmin=slmAdmin, slmSysChassisId=slmSysChassisId, slmSysAdminStatus=slmSysAdminStatus, slmSnmpv3Password=slmSnmpv3Password, slmChPassNewPass=slmChPassNewPass, slmTopologyEnabled=slmTopologyEnabled, slmAuthEntry=slmAuthEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicenseId=slmLicenseId, slmRebootDelay=slmRebootDelay, slmTid=slmTid, slmSysName=slmSysName, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogLevel=slmSyslogLevel, slmSysSnmpVersion=slmSysSnmpVersion, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam3=slmTrapLogParam3, slmLicenseEntry=slmLicenseEntry, slmTrapLogParam5=slmTrapLogParam5, slmSysCalendarTime=slmSysCalendarTime, slmConfigFile=slmConfigFile, slmWriteCommunity=slmWriteCommunity, slmTrap=slmTrap, slmVcatDelay=slmVcatDelay, slmLicenseIndex=slmLicenseIndex)
