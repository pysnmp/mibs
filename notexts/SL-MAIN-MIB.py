...
NotificationType, iso, ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, MibIdentifier, Integer32, Counter32, Unsigned32, Bits, TimeTicks, Counter64, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "MibIdentifier", "Integer32", "Counter32", "Unsigned32", "Bits", "TimeTicks", "Counter64", "Gauge32", "ObjectIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSwRevName=slmSwRevName, slmTopologyEnabled=slmTopologyEnabled, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmEdfaNumber=slmEdfaNumber, slmSwRevDirectory=slmSwRevDirectory, slmSysTemperature=slmSysTemperature, slmTrapLogParam4=slmTrapLogParam4, slmSysSnmpVersion=slmSysSnmpVersion, slmChPassOldPass=slmChPassOldPass, slmRebootDelay=slmRebootDelay, slmChPassTable=slmChPassTable, slmSysAlmDeact=slmSysAlmDeact, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLogin=slmLogin, slmOemType=slmOemType, slmChPassEntry=slmChPassEntry, slmLicenseExpiration=slmLicenseExpiration, slmTrapEnable=slmTrapEnable, slmSys=slmSys, slmSyslogDestIpAddress=slmSyslogDestIpAddress, AdminAccess=AdminAccess, slmAdminCommunity=slmAdminCommunity, slmChPassNewPass=slmChPassNewPass, slmAuthPassword=slmAuthPassword, slmSyslogDestAddress=slmSyslogDestAddress, slmLicenseIndex=slmLicenseIndex, slmAdminAccess=slmAdminAccess, slmTrapUserLogin=slmTrapUserLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminLogin=slmAdminLogin, slmSyslogDestTable=slmSyslogDestTable, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevTable=slmSwRevTable, slmTrapLogParam5=slmTrapLogParam5, slmPmAvailable=slmPmAvailable, slmAuthEntry=slmAuthEntry, slmAuthLogin=slmAuthLogin, slmConfigSysUptime=slmConfigSysUptime, slmSysAlmAct=slmSysAlmAct, slmTrapCommunity=slmTrapCommunity, slmAuthCommunity=slmAuthCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmTrap=slmTrap, slm40GConf=slm40GConf, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogTable=slmTrapLogTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmBoxSize=slmBoxSize, slmNetworkMode=slmNetworkMode, slmSwRevEntry=slmSwRevEntry, slmChPassLogin=slmChPassLogin, slmTrapUserAccess=slmTrapUserAccess, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysPmStartOfDay=slmSysPmStartOfDay, UserLogin=UserLogin, slmPsuNumber=slmPsuNumber, slmTrapDestProtVersion=slmTrapDestProtVersion, slmConfigFile=slmConfigFile, slmSysLocation=slmSysLocation, slMain=slMain, slmSysSubnetMask=slmSysSubnetMask, slmRstpEnabled=slmRstpEnabled, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminPassword=slmAdminPassword, UserCommunity=UserCommunity, slmAdminEntry=slmAdminEntry, slmSysOperStatus=slmSysOperStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam1=slmTrapLogParam1, slmPortsNumber=slmPortsNumber, slmAdminTable=slmAdminTable, slmTrapLogParam3=slmTrapLogParam3, slmSysMode=slmSysMode, slmTrapDestAddress=slmTrapDestAddress, slmTid=slmTid, slmTrapLogName=slmTrapLogName, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestEntry=slmTrapDestEntry, slmSysCalendarTime=slmSysCalendarTime, slmSysLanIpAddr=slmSysLanIpAddr, slmSysName=slmSysName, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmMuxNumber=slmMuxNumber, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicense=slmLicense, slmLogFile=slmLogFile, slmSyslogPort=slmSyslogPort, UserPassword=UserPassword, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysResetPm=slmSysResetPm, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogParam6=slmTrapLogParam6, slmSysIpAddr=slmSysIpAddr, slmVcatDelay=slmVcatDelay, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminRowStatus=slmAdminRowStatus, slmWriteCommunity=slmWriteCommunity, slmSysTrapFormat=slmSysTrapFormat, slmSwRevStatus=slmSwRevStatus, slmSysChassisId=slmSysChassisId, slmAuth=slmAuth, slmAuthTable=slmAuthTable, slmLicenseTable=slmLicenseTable, slmSnmpv3Password=slmSnmpv3Password, slmTrapPort=slmTrapPort, slmLicenseEntry=slmLicenseEntry, slmReadCommunity=slmReadCommunity, slmChPass=slmChPass, slmSwRevDate=slmSwRevDate, slmTrapLogEntry=slmTrapLogEntry, slmAdmin=slmAdmin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSyslogLevel=slmSyslogLevel, slmLicenseId=slmLicenseId, PYSNMP_MODULE_ID=slMain, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogId=slmTrapLogId, SoftwareRevision=SoftwareRevision)
