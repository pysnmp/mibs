...
mibBuilder.exportSymbols("SL-MAIN-MIB", SoftwareRevision=SoftwareRevision, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysAdminStatus=slmSysAdminStatus, slmSysTemperature=slmSysTemperature, slmLogFile=slmLogFile, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthCommunity=slmAuthCommunity, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam2=slmTrapLogParam2, slmBoxSize=slmBoxSize, slmTrapDestCommunity=slmTrapDestCommunity, slmSysLocation=slmSysLocation, slmRebootDelay=slmRebootDelay, slmSwRevEntry=slmSwRevEntry, slmAuthEntry=slmAuthEntry, slmTrapUserLogin=slmTrapUserLogin, slmLicense=slmLicense, slmLogin=slmLogin, slmTrapLogParam3=slmTrapLogParam3, slmAdminAccess=slmAdminAccess, UserLogin=UserLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmSysOperStatus=slmSysOperStatus, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLicenseIndex=slmLicenseIndex, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapSysNameChange=slmTrapSysNameChange, slmSysPmStartOfDay=slmSysPmStartOfDay, slmConfigFile=slmConfigFile, slmPmAvailable=slmPmAvailable, slmTrapDestAddress=slmTrapDestAddress, slmChPassOldPass=slmChPassOldPass, slmSwRevTable=slmSwRevTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestRowStatus=slmTrapDestRowStatus, PYSNMP_MODULE_ID=slMain, slmSwRevDirectory=slmSwRevDirectory, slmSysName=slmSysName, slmAdmin=slmAdmin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmPsuNumber=slmPsuNumber, slmSysResetPm=slmSysResetPm, slmSys=slmSys, slmTrapLogEntry=slmTrapLogEntry, slmSysUplinkRate=slmSysUplinkRate, slmSysSubnetMask=slmSysSubnetMask, slmChPassEntry=slmChPassEntry, slmRstpEnabled=slmRstpEnabled, slmSysActiveSwVersion=slmSysActiveSwVersion, slmNetworkMode=slmNetworkMode, AdminAccess=AdminAccess, slm40GConf=slm40GConf, slmSwRevName=slmSwRevName, slmAuthPassword=slmAuthPassword, slmTrap=slmTrap, slmAdminPassword=slmAdminPassword, slmSnmpv3Password=slmSnmpv3Password, slmChPassTable=slmChPassTable, slmTrapLogName=slmTrapLogName, slmSyslogPort=slmSyslogPort, slmSyslogDestTable=slmSyslogDestTable, slmTrapUserAccess=slmTrapUserAccess, slmAdminLogin=slmAdminLogin, slmAuth=slmAuth, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmPortsNumber=slmPortsNumber, slmTrapDestIpAddress=slmTrapDestIpAddress, slmVcatDelay=slmVcatDelay, slmSysCalendarTime=slmSysCalendarTime, slmLicenseTable=slmLicenseTable, slmTrapLogParam5=slmTrapLogParam5, slmOemType=slmOemType, slMain=slMain, slmWriteCommunity=slmWriteCommunity, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapDestEntry=slmTrapDestEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysAlmDeact=slmSysAlmDeact, slmLicenseEntry=slmLicenseEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, UserCommunity=UserCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmAdminTable=slmAdminTable, slmSysIpAddr=slmSysIpAddr, slmLicenseExpiration=slmLicenseExpiration, slmSysMode=slmSysMode, slmSysTrapFormat=slmSysTrapFormat, slmTrapSysLocationChange=slmTrapSysLocationChange, slmMuxNumber=slmMuxNumber, slmChPassNewPass=slmChPassNewPass, UserPassword=UserPassword, slmSysAlmAct=slmSysAlmAct, slmTrapLogTable=slmTrapLogTable, slmAuthLogin=slmAuthLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogId=slmTrapLogId, slmLicenseId=slmLicenseId, slmSysGatewayAddr=slmSysGatewayAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapCommunity=slmTrapCommunity, slmSwRevStatus=slmSwRevStatus, slmChPass=slmChPass, slmSysChassisId=slmSysChassisId, slmTrapPort=slmTrapPort, slmTopologyEnabled=slmTopologyEnabled, slmTrapEnable=slmTrapEnable, slmSnmpv3Priv=slmSnmpv3Priv, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogParam4=slmTrapLogParam4, slmSyslogLevel=slmSyslogLevel, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevDate=slmSwRevDate, slmChPassLogin=slmChPassLogin, slmAuthTable=slmAuthTable, slmReadCommunity=slmReadCommunity, slmAdminEntry=slmAdminEntry, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam6=slmTrapLogParam6, slmTid=slmTid, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestTable=slmTrapDestTable, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmConfigSysUptime=slmConfigSysUptime)
