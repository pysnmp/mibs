...
mibBuilder.exportSymbols("SL-MAIN-MIB", UserPassword=UserPassword, slmLicenseIndex=slmLicenseIndex, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicense=slmLicense, slmSysOperStatus=slmSysOperStatus, slmTrapLogName=slmTrapLogName, slmSysChassisId=slmSysChassisId, slmSysSubnetMask=slmSysSubnetMask, slmSwRevStatus=slmSwRevStatus, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapUserLogin=slmTrapUserLogin, slmConfigSysSignalType=slmConfigSysSignalType, slm40GConf=slm40GConf, slmAdminEntry=slmAdminEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmVcatDelay=slmVcatDelay, slmTrapLogEntry=slmTrapLogEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapPort=slmTrapPort, slmAdminTable=slmAdminTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicenseExpiration=slmLicenseExpiration, slmTopologyEnabled=slmTopologyEnabled, slmChPass=slmChPass, slmConfigFile=slmConfigFile, slmTrapUserAccess=slmTrapUserAccess, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogLevel=slmSyslogLevel, slmTrapCommunity=slmTrapCommunity, slmLogin=slmLogin, AdminAccess=AdminAccess, slmChPassLogin=slmChPassLogin, slmPsuNumber=slmPsuNumber, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogParam3=slmTrapLogParam3, UserLogin=UserLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicenseEntry=slmLicenseEntry, slmMuxNumber=slmMuxNumber, slmSysTemperature=slmSysTemperature, slmAuthEntry=slmAuthEntry, slmTrapLogParam1=slmTrapLogParam1, slmChPassEntry=slmChPassEntry, PYSNMP_MODULE_ID=slMain, slmSysAdminStatus=slmSysAdminStatus, slmSyslogDestTable=slmSyslogDestTable, slmTrapSysNameChange=slmTrapSysNameChange, UserCommunity=UserCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmRebootDelay=slmRebootDelay, slMain=slMain, slmSwRevName=slmSwRevName, slmAuthLogin=slmAuthLogin, slmChPassOldPass=slmChPassOldPass, slmChPassTable=slmChPassTable, slmAdminPassword=slmAdminPassword, slmSysLocation=slmSysLocation, slmSysLanIpAddr=slmSysLanIpAddr, slmAdmin=slmAdmin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminLogin=slmAdminLogin, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam6=slmTrapLogParam6, slmReadCommunity=slmReadCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdminAccess=slmAdminAccess, slmSys=slmSys, slmTrapLogTable=slmTrapLogTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysMode=slmSysMode, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAuthCommunity=slmAuthCommunity, slmPmAvailable=slmPmAvailable, slmSysUplinkRate=slmSysUplinkRate, slmSysAlmDeact=slmSysAlmDeact, slmAuth=slmAuth, slmEdfaNumber=slmEdfaNumber, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam2=slmTrapLogParam2, slmSysAlmAct=slmSysAlmAct, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTid=slmTid, slmSwRevTable=slmSwRevTable, slmSwRevDate=slmSwRevDate, slmSysIpAddr=slmSysIpAddr, slmConfigSysUptime=slmConfigSysUptime, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmPortsNumber=slmPortsNumber, slmAuthTable=slmAuthTable, slmChPassNewPass=slmChPassNewPass, slmLicenseId=slmLicenseId, slmSwRevEntry=slmSwRevEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmRstpEnabled=slmRstpEnabled, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestEntry=slmSyslogDestEntry, slmOemType=slmOemType, slmSysSnmpVersion=slmSysSnmpVersion, SoftwareRevision=SoftwareRevision, slmSnmpv3Auth=slmSnmpv3Auth, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuthPassword=slmAuthPassword, slmTrapEnable=slmTrapEnable, slmTrapLogId=slmTrapLogId, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestAddress=slmTrapDestAddress, slmTrap=slmTrap, slmSysResetPm=slmSysResetPm, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestTable=slmTrapDestTable, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogPort=slmSyslogPort, slmLogFile=slmLogFile, slmBoxSize=slmBoxSize, slmLicenseTable=slmLicenseTable, slmSysName=slmSysName, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam4=slmTrapLogParam4, slmNetworkMode=slmNetworkMode, slmTrapDestEntry=slmTrapDestEntry, slmSwRevDirectory=slmSwRevDirectory, slmSnmpv3Password=slmSnmpv3Password)
