...
mibBuilder.exportSymbols("SL-MAIN-MIB", UserCommunity=UserCommunity, slmAdminCommunity=slmAdminCommunity, slmTrapLogId=slmTrapLogId, slmSysChassisId=slmSysChassisId, slmSysGatewayAddr=slmSysGatewayAddr, slmLicenseEntry=slmLicenseEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmPsuNumber=slmPsuNumber, slmRstpEnabled=slmRstpEnabled, slmSysLocation=slmSysLocation, UserPassword=UserPassword, slmChPassLogin=slmChPassLogin, UserLogin=UserLogin, slmTrapLogParam5=slmTrapLogParam5, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrap=slmTrap, slmTrapDestCommunity=slmTrapDestCommunity, slmMuxNumber=slmMuxNumber, slmSyslogDestTable=slmSyslogDestTable, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseExpiration=slmLicenseExpiration, slmTrapUserAccess=slmTrapUserAccess, slmConfigSysUptime=slmConfigSysUptime, slmSysActiveSwVersion=slmSysActiveSwVersion, slMain=slMain, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestEntry=slmSyslogDestEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysLanIpAddr=slmSysLanIpAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, SoftwareRevision=SoftwareRevision, slmSysSubnetMask=slmSysSubnetMask, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthTable=slmAuthTable, slmTrapLogName=slmTrapLogName, slmTrapEnable=slmTrapEnable, slmTid=slmTid, slmSysUplinkRate=slmSysUplinkRate, slmAdminRowStatus=slmAdminRowStatus, slmLogin=slmLogin, slmSysIpAddr=slmSysIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLicenseId=slmLicenseId, slmAuthLogin=slmAuthLogin, slmSnmpv3Priv=slmSnmpv3Priv, slmAuth=slmAuth, slmSwRevStatus=slmSwRevStatus, slmTrapPort=slmTrapPort, slmChPassOldPass=slmChPassOldPass, slmChPassEntry=slmChPassEntry, slmSnmpv3Password=slmSnmpv3Password, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminAccess=slmAdminAccess, slmSys=slmSys, slmSyslogLevel=slmSyslogLevel, slmTrapSysLocationChange=slmTrapSysLocationChange, slmChPassNewPass=slmChPassNewPass, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam3=slmTrapLogParam3, slmAdminEntry=slmAdminEntry, slmEdfaNumber=slmEdfaNumber, slmTrapLogTable=slmTrapLogTable, slmNetworkMode=slmNetworkMode, slmChPass=slmChPass, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmChPassTable=slmChPassTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevTable=slmSwRevTable, slmSyslogDestAddress=slmSyslogDestAddress, slmLogFile=slmLogFile, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam4=slmTrapLogParam4, slmAdminLogin=slmAdminLogin, slmSyslogPort=slmSyslogPort, slmSysCalendarTime=slmSysCalendarTime, slmOemType=slmOemType, slmAdmin=slmAdmin, slmPmAvailable=slmPmAvailable, slmSysAlmDeact=slmSysAlmDeact, slmSnmpv3Auth=slmSnmpv3Auth, PYSNMP_MODULE_ID=slMain, slmAdminTable=slmAdminTable, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogParam6=slmTrapLogParam6, slmSwRevEntry=slmSwRevEntry, slmAuthEntry=slmAuthEntry, slmLicense=slmLicense, slmWriteCommunity=slmWriteCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmRebootDelay=slmRebootDelay, slmSysTrapFormat=slmSysTrapFormat, slm40GConf=slm40GConf, slmBoxSize=slmBoxSize, slmTrapDestTable=slmTrapDestTable, slmReadCommunity=slmReadCommunity, slmTrapUserLogin=slmTrapUserLogin, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicenseTable=slmLicenseTable, slmSysAlmAct=slmSysAlmAct, slmTopologyEnabled=slmTopologyEnabled, slmVcatDelay=slmVcatDelay, slmTrapDestAddress=slmTrapDestAddress, slmSysName=slmSysName, slmSysResetPm=slmSysResetPm, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAuthPassword=slmAuthPassword, slmSysAdminStatus=slmSysAdminStatus, slmAdminPassword=slmAdminPassword, slmConfigFile=slmConfigFile, slmTrapCommunity=slmTrapCommunity, slmLicenseIndex=slmLicenseIndex, slmSwRevDate=slmSwRevDate, slmTrapDestEntry=slmTrapDestEntry, slmSwRevName=slmSwRevName, slmTrapLogEntry=slmTrapLogEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogParam1=slmTrapLogParam1, AdminAccess=AdminAccess, slmSwRevDirectory=slmSwRevDirectory, slmSysMode=slmSysMode, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmPortsNumber=slmPortsNumber, slmSysTemperature=slmSysTemperature)
