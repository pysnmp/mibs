...
Opaque, Bits, MibIdentifier, TimeTicks, Integer32, ModuleIdentity, ObjectIdentity, IpAddress, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "Bits", "MibIdentifier", "TimeTicks", "Integer32", "ModuleIdentity", "ObjectIdentity", "IpAddress", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestProtVersion=slmTrapDestProtVersion, slmChPassNewPass=slmChPassNewPass, slmChPassLogin=slmChPassLogin, PYSNMP_MODULE_ID=slMain, slmAuthLogin=slmAuthLogin, slmTrapLogParam3=slmTrapLogParam3, slMain=slMain, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogParam6=slmTrapLogParam6, slmWriteCommunity=slmWriteCommunity, slmPsuNumber=slmPsuNumber, slmConfigSysSignalType=slmConfigSysSignalType, slmReadCommunity=slmReadCommunity, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogTable=slmTrapLogTable, slmAuth=slmAuth, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmPmAvailable=slmPmAvailable, slmLicenseEntry=slmLicenseEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSnmpv3Password=slmSnmpv3Password, slmOemType=slmOemType, slmAdmin=slmAdmin, slmSwRevStatus=slmSwRevStatus, slmLicenseId=slmLicenseId, slmSysTrapFormat=slmSysTrapFormat, UserCommunity=UserCommunity, slmAdminPassword=slmAdminPassword, SoftwareRevision=SoftwareRevision, AdminAccess=AdminAccess, slmRstpEnabled=slmRstpEnabled, slmSys=slmSys, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapPort=slmTrapPort, slmSyslogDestTable=slmSyslogDestTable, slmAdminCommunity=slmAdminCommunity, slmConfigSysUptime=slmConfigSysUptime, slmAdminRowStatus=slmAdminRowStatus, slmAdminTable=slmAdminTable, slmTrapSysNameChange=slmTrapSysNameChange, slmSnmpv3Priv=slmSnmpv3Priv, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestAddress=slmTrapDestAddress, slmSwRevName=slmSwRevName, slmSysAlmDeact=slmSysAlmDeact, slmBoxSize=slmBoxSize, slmNetworkMode=slmNetworkMode, UserLogin=UserLogin, UserPassword=UserPassword, slmTrapEnable=slmTrapEnable, slmTrapDestTable=slmTrapDestTable, slmSwRevDirectory=slmSwRevDirectory, slmSysOperStatus=slmSysOperStatus, slmRebootDelay=slmRebootDelay, slmTid=slmTid, slmSysChassisId=slmSysChassisId, slmSyslogLevel=slmSyslogLevel, slmChPassEntry=slmChPassEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmAuthEntry=slmAuthEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogParam5=slmTrapLogParam5, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogName=slmTrapLogName, slmChPassTable=slmChPassTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysMode=slmSysMode, slmChPass=slmChPass, slmPortsNumber=slmPortsNumber, slmAuthCommunity=slmAuthCommunity, slmSysSnmpVersion=slmSysSnmpVersion, slmAuthTable=slmAuthTable, slmTrapDestEntry=slmTrapDestEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysAlmAct=slmSysAlmAct, slmSwRevEntry=slmSwRevEntry, slmEdfaNumber=slmEdfaNumber, slmSwRevDate=slmSwRevDate, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSyslogPort=slmSyslogPort, slmSysName=slmSysName, slmLicenseTable=slmLicenseTable, slmSysTemperature=slmSysTemperature, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysAdminStatus=slmSysAdminStatus, slmMuxNumber=slmMuxNumber, slmSysCalendarTime=slmSysCalendarTime, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestCommunity=slmTrapDestCommunity, slmSysIpAddr=slmSysIpAddr, slmSysLocation=slmSysLocation, slmVcatDelay=slmVcatDelay, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminAccess=slmAdminAccess, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminLogin=slmAdminLogin, slmTrapLogId=slmTrapLogId, slmTrapCommunity=slmTrapCommunity, slmLogFile=slmLogFile, slmTrapLogParam4=slmTrapLogParam4, slmSysResetPm=slmSysResetPm, slmLicenseExpiration=slmLicenseExpiration, slmLicenseIndex=slmLicenseIndex, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSwRevTable=slmSwRevTable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLicense=slmLicense, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmConfigFile=slmConfigFile, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapUserLogin=slmTrapUserLogin, slmLogin=slmLogin, slmTrapLogParam1=slmTrapLogParam1, slmChPassOldPass=slmChPassOldPass, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysGatewayAddr=slmSysGatewayAddr, slm40GConf=slm40GConf, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminEntry=slmAdminEntry, slmTrap=slmTrap, slmTopologyEnabled=slmTopologyEnabled, slmTrapUserAccess=slmTrapUserAccess, slmAuthPassword=slmAuthPassword)
