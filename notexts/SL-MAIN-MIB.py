...
Bits, iso, Integer32, ObjectIdentity, Gauge32, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, TimeTicks, NotificationType, IpAddress, Counter64, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "Integer32", "ObjectIdentity", "Gauge32", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "TimeTicks", "NotificationType", "IpAddress", "Counter64", "Opaque")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysCalendarTime=slmSysCalendarTime, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLicenseEntry=slmLicenseEntry, slmSysTemperature=slmSysTemperature, UserCommunity=UserCommunity, slmAuthEntry=slmAuthEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam2=slmTrapLogParam2, slmSysMode=slmSysMode, slmSwRevEntry=slmSwRevEntry, slmAuthLogin=slmAuthLogin, slmChPass=slmChPass, slmSysAdminStatus=slmSysAdminStatus, AdminAccess=AdminAccess, slmTrapDestTable=slmTrapDestTable, slmEdfaNumber=slmEdfaNumber, slmSysGatewayAddr=slmSysGatewayAddr, slmChPassNewPass=slmChPassNewPass, slmTrapLogName=slmTrapLogName, slmLicense=slmLicense, slmSwRevDirectory=slmSwRevDirectory, slmAdminTable=slmAdminTable, slmSwRevStatus=slmSwRevStatus, slmSysLanIpAddr=slmSysLanIpAddr, SoftwareRevision=SoftwareRevision, slmAdminLogin=slmAdminLogin, slmVcatDelay=slmVcatDelay, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassTable=slmChPassTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmNetworkMode=slmNetworkMode, slmAdminAccess=slmAdminAccess, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapCommunity=slmTrapCommunity, slmSysLocation=slmSysLocation, slmLogin=slmLogin, slmTopologyEnabled=slmTopologyEnabled, slmLicenseTable=slmLicenseTable, slmChPassOldPass=slmChPassOldPass, slmConfigFile=slmConfigFile, slmTrapLogParam4=slmTrapLogParam4, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicenseIndex=slmLicenseIndex, slmSysSubnetMask=slmSysSubnetMask, slMain=slMain, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam3=slmTrapLogParam3, slmAuthPassword=slmAuthPassword, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogDestEntry=slmSyslogDestEntry, slmWriteCommunity=slmWriteCommunity, slmSysName=slmSysName, slmRstpEnabled=slmRstpEnabled, slmLicenseId=slmLicenseId, slmAuthCommunity=slmAuthCommunity, slmSwRevDate=slmSwRevDate, slmTrapDestCommunity=slmTrapDestCommunity, slmSysResetPm=slmSysResetPm, slmTrapDestAddress=slmTrapDestAddress, slmTrapEnable=slmTrapEnable, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestEntry=slmTrapDestEntry, slmAdminPassword=slmAdminPassword, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminEntry=slmAdminEntry, slmAuthTable=slmAuthTable, slmTrapUserAccess=slmTrapUserAccess, slm40GConf=slm40GConf, slmTrapPort=slmTrapPort, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestProtVersion=slmTrapDestProtVersion, slmBoxSize=slmBoxSize, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmPmAvailable=slmPmAvailable, slmSysAlmDeact=slmSysAlmDeact, slmSysPmStartOfDay=slmSysPmStartOfDay, slmChPassLogin=slmChPassLogin, slmSys=slmSys, slmPsuNumber=slmPsuNumber, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSnmpv3Auth=slmSnmpv3Auth, slmOemType=slmOemType, slmSyslogDestTable=slmSyslogDestTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAuth=slmAuth, slmSwRevTable=slmSwRevTable, slmRebootDelay=slmRebootDelay, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSnmpv3Priv=slmSnmpv3Priv, slmSysTrapFormat=slmSysTrapFormat, slmSysOperStatus=slmSysOperStatus, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam1=slmTrapLogParam1, slmSysAlmAct=slmSysAlmAct, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminCommunity=slmAdminCommunity, slmTid=slmTid, slmMuxNumber=slmMuxNumber, slmChPassEntry=slmChPassEntry, slmSnmpv3Password=slmSnmpv3Password, slmReadCommunity=slmReadCommunity, slmTrapUserLogin=slmTrapUserLogin, slmSyslogLevel=slmSyslogLevel, UserPassword=UserPassword, slmSysChassisId=slmSysChassisId, slmTrapLogParam5=slmTrapLogParam5, slmLogFile=slmLogFile, slmPortsNumber=slmPortsNumber, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminRowStatus=slmAdminRowStatus, UserLogin=UserLogin, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam6=slmTrapLogParam6, slmSyslogPort=slmSyslogPort, slmTrap=slmTrap, slmLicenseExpiration=slmLicenseExpiration, PYSNMP_MODULE_ID=slMain, slmTrapLogTable=slmTrapLogTable, slmTrapLogId=slmTrapLogId, slmAdmin=slmAdmin, slmSwRevName=slmSwRevName, slmSyslogDestIpAddress=slmSyslogDestIpAddress)
