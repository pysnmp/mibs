...
MibIdentifier, Bits, IpAddress, NotificationType, ObjectIdentity, TimeTicks, Gauge32, Counter32, iso, Integer32, Counter64, Unsigned32, ModuleIdentity, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "IpAddress", "NotificationType", "ObjectIdentity", "TimeTicks", "Gauge32", "Counter32", "iso", "Integer32", "Counter64", "Unsigned32", "ModuleIdentity", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminPassword=slmAdminPassword, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, PYSNMP_MODULE_ID=slMain, slmSysResetPm=slmSysResetPm, slmTrapEnable=slmTrapEnable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogParam1=slmTrapLogParam1, SoftwareRevision=SoftwareRevision, slmAdmin=slmAdmin, slmLicenseIndex=slmLicenseIndex, slmChPass=slmChPass, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysOperStatus=slmSysOperStatus, slmSysAlmDeact=slmSysAlmDeact, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestTable=slmSyslogDestTable, slmSysAdminStatus=slmSysAdminStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapUserAccess=slmTrapUserAccess, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSwRevEntry=slmSwRevEntry, slmSwRevDirectory=slmSwRevDirectory, slmAuthLogin=slmAuthLogin, slmEdfaNumber=slmEdfaNumber, slmAuthEntry=slmAuthEntry, slmRstpEnabled=slmRstpEnabled, slmOemType=slmOemType, slmChPassLogin=slmChPassLogin, slmTrapCommunity=slmTrapCommunity, slmLogin=slmLogin, slmSwRevStatus=slmSwRevStatus, slmChPassTable=slmChPassTable, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam4=slmTrapLogParam4, slmSysAlmAct=slmSysAlmAct, slmSyslogLevel=slmSyslogLevel, slmOpticalSwitchExist=slmOpticalSwitchExist, slmPmAvailable=slmPmAvailable, slmLicenseTable=slmLicenseTable, UserPassword=UserPassword, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLicense=slmLicense, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam5=slmTrapLogParam5, slmAdminLogin=slmAdminLogin, slmSysCalendarTime=slmSysCalendarTime, slmSysChassisId=slmSysChassisId, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestTable=slmTrapDestTable, slmSnmpv3Password=slmSnmpv3Password, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam3=slmTrapLogParam3, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicenseId=slmLicenseId, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogParam2=slmTrapLogParam2, slmPsuNumber=slmPsuNumber, slmLicenseEntry=slmLicenseEntry, slmSysUplinkRate=slmSysUplinkRate, slmRebootDelay=slmRebootDelay, slmTopologyEnabled=slmTopologyEnabled, slmSysTrapFormat=slmSysTrapFormat, AdminAccess=AdminAccess, slmNetworkMode=slmNetworkMode, slmTrapLogId=slmTrapLogId, slmAuthPassword=slmAuthPassword, slmChPassEntry=slmChPassEntry, slmMuxNumber=slmMuxNumber, slmAuth=slmAuth, slmReadCommunity=slmReadCommunity, slmTrapLogParam6=slmTrapLogParam6, slmAuthTable=slmAuthTable, slmSwRevDate=slmSwRevDate, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmConfigFile=slmConfigFile, slmTrapLogEntry=slmTrapLogEntry, slmSwRevName=slmSwRevName, slmTrapPort=slmTrapPort, slmSysName=slmSysName, slmPortsNumber=slmPortsNumber, slmTrapUserLogin=slmTrapUserLogin, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysLocation=slmSysLocation, UserCommunity=UserCommunity, slmTrap=slmTrap, slmTid=slmTid, slmTrapDestAddress=slmTrapDestAddress, slmSnmpv3Auth=slmSnmpv3Auth, slmSysIpAddr=slmSysIpAddr, slmAdminTable=slmAdminTable, slmTrapLogTable=slmTrapLogTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLogFile=slmLogFile, UserLogin=UserLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmSysSubnetMask=slmSysSubnetMask, slmConfigSysSignalType=slmConfigSysSignalType, slmSysMode=slmSysMode, slmAdminAccess=slmAdminAccess, slMain=slMain, slm40GConf=slm40GConf, slmAdminEntry=slmAdminEntry, slmTrapLogName=slmTrapLogName, slmChPassNewPass=slmChPassNewPass, slmBoxSize=slmBoxSize, slmTrapSysNameChange=slmTrapSysNameChange, slmSys=slmSys, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapDestEntry=slmTrapDestEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogPort=slmSyslogPort, slmChPassOldPass=slmChPassOldPass, slmWriteCommunity=slmWriteCommunity, slmAuthCommunity=slmAuthCommunity, slmConfigSysUptime=slmConfigSysUptime, slmLicenseExpiration=slmLicenseExpiration, slmSwRevTable=slmSwRevTable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestProtVersion=slmTrapDestProtVersion, slmVcatDelay=slmVcatDelay, slmSysTemperature=slmSysTemperature)
