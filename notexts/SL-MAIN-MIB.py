...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogId=slmTrapLogId, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogTable=slmTrapLogTable, slmLicenseId=slmLicenseId, slmLicenseTable=slmLicenseTable, slmSysSubnetMask=slmSysSubnetMask, slmSwRevStatus=slmSwRevStatus, slmChPassLogin=slmChPassLogin, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam2=slmTrapLogParam2, slmLicense=slmLicense, slmRebootDelay=slmRebootDelay, slmReadCommunity=slmReadCommunity, slmOemType=slmOemType, slmSysMode=slmSysMode, slmSysLanIpAddr=slmSysLanIpAddr, slmAdminAccess=slmAdminAccess, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysPmStartOfDay=slmSysPmStartOfDay, slmPsuNumber=slmPsuNumber, slmChPass=slmChPass, slmChPassTable=slmChPassTable, slmChPassNewPass=slmChPassNewPass, slmTrapLogParam4=slmTrapLogParam4, slmTrapCommunity=slmTrapCommunity, slmRstpEnabled=slmRstpEnabled, slmSnmpv3Priv=slmSnmpv3Priv, slmAuthTable=slmAuthTable, slmAuthCommunity=slmAuthCommunity, slmAdminPassword=slmAdminPassword, slmLogFile=slmLogFile, slmAuthEntry=slmAuthEntry, slmAdminTable=slmAdminTable, slmTrapLogParam1=slmTrapLogParam1, slmSyslogDestAddress=slmSyslogDestAddress, SoftwareRevision=SoftwareRevision, slmChPassOldPass=slmChPassOldPass, PYSNMP_MODULE_ID=slMain, slmConfigSysUptime=slmConfigSysUptime, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminEntry=slmAdminEntry, slmSysAlmDeact=slmSysAlmDeact, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysAlmAct=slmSysAlmAct, slmSysTemperature=slmSysTemperature, slmSysIpAddr=slmSysIpAddr, slmTid=slmTid, slmAdminCommunity=slmAdminCommunity, slmSysResetPm=slmSysResetPm, slmPortsNumber=slmPortsNumber, slmSnmpv3Password=slmSnmpv3Password, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam5=slmTrapLogParam5, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogParam6=slmTrapLogParam6, slmSyslogPort=slmSyslogPort, slmMuxNumber=slmMuxNumber, slmTrap=slmTrap, slmSysOperStatus=slmSysOperStatus, slmSysSnmpVersion=slmSysSnmpVersion, slmWriteCommunity=slmWriteCommunity, slmAuthLogin=slmAuthLogin, slmSyslogLevel=slmSyslogLevel, slmSysUplinkRate=slmSysUplinkRate, slmLicenseIndex=slmLicenseIndex, slmSnmpv3Auth=slmSnmpv3Auth, slmAdmin=slmAdmin, slmAdminLogin=slmAdminLogin, slmSysAdminStatus=slmSysAdminStatus, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapPort=slmTrapPort, slmLicenseExpiration=slmLicenseExpiration, slmTrapDestTable=slmTrapDestTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSyslogDestTable=slmSyslogDestTable, slmEdfaNumber=slmEdfaNumber, slmVcatDelay=slmVcatDelay, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevEntry=slmSwRevEntry, slmSysTrapFormat=slmSysTrapFormat, slmPmAvailable=slmPmAvailable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysLocation=slmSysLocation, UserCommunity=UserCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slm40GConf=slm40GConf, slmSysName=slmSysName, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAuthPassword=slmAuthPassword, UserPassword=UserPassword, slmConfigFile=slmConfigFile, slmAdminRowStatus=slmAdminRowStatus, slmNetworkMode=slmNetworkMode, slmLicenseEntry=slmLicenseEntry, slMain=slMain, slmTrapEnable=slmTrapEnable, slmTrapUserLogin=slmTrapUserLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSwRevTable=slmSwRevTable, slmSysChassisId=slmSysChassisId, slmTrapDestAddress=slmTrapDestAddress, slmSys=slmSys, AdminAccess=AdminAccess, slmTrapLogName=slmTrapLogName, UserLogin=UserLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmBoxSize=slmBoxSize, slmAuth=slmAuth, slmChPassEntry=slmChPassEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSwRevName=slmSwRevName, slmSyslogDestEntry=slmSyslogDestEntry, slmLogin=slmLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogEntry=slmTrapLogEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogParam3=slmTrapLogParam3, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevDate=slmSwRevDate, slmTopologyEnabled=slmTopologyEnabled)
