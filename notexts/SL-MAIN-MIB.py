...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminCommunity=slmAdminCommunity, slmPmAvailable=slmPmAvailable, slmTrapEnable=slmTrapEnable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminRowStatus=slmAdminRowStatus, slmRebootDelay=slmRebootDelay, slmAdminPassword=slmAdminPassword, AdminAccess=AdminAccess, slmConfigSysUptime=slmConfigSysUptime, slmPsuNumber=slmPsuNumber, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapCommunity=slmTrapCommunity, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestCommunity=slmTrapDestCommunity, UserLogin=UserLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogDestEntry=slmSyslogDestEntry, slmSyslogDestTable=slmSyslogDestTable, slm40GConf=slm40GConf, slmAdminEntry=slmAdminEntry, slmChPassNewPass=slmChPassNewPass, slmMuxNumber=slmMuxNumber, slmTrapPort=slmTrapPort, slmLicenseEntry=slmLicenseEntry, slmEdfaNumber=slmEdfaNumber, slmSysSnmpVersion=slmSysSnmpVersion, slmSysAdminStatus=slmSysAdminStatus, slmSnmpv3Priv=slmSnmpv3Priv, slmSysOperStatus=slmSysOperStatus, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogTable=slmTrapLogTable, slmLicense=slmLicense, slmLicenseTable=slmLicenseTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPassLogin=slmChPassLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmTopologyEnabled=slmTopologyEnabled, slmLogin=slmLogin, slmAuth=slmAuth, slmSysAlmAct=slmSysAlmAct, slmSnmpv3Auth=slmSnmpv3Auth, PYSNMP_MODULE_ID=slMain, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogParam6=slmTrapLogParam6, slmChPass=slmChPass, slmSyslogPort=slmSyslogPort, slmTrapUserAccess=slmTrapUserAccess, slmConfigFile=slmConfigFile, slmRstpEnabled=slmRstpEnabled, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSwRevStatus=slmSwRevStatus, slmTrap=slmTrap, slmLicenseExpiration=slmLicenseExpiration, slmAdmin=slmAdmin, slmChPassTable=slmChPassTable, slmSysResetPm=slmSysResetPm, slmReadCommunity=slmReadCommunity, slmSysTrapFormat=slmSysTrapFormat, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicenseIndex=slmLicenseIndex, slmLicenseId=slmLicenseId, slmBoxSize=slmBoxSize, slMain=slMain, UserCommunity=UserCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapSysNameChange=slmTrapSysNameChange, slmSysName=slmSysName, slmSysAlmDeact=slmSysAlmDeact, slmChPassOldPass=slmChPassOldPass, slmSyslogLevel=slmSyslogLevel, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogParam1=slmTrapLogParam1, slmSysTemperature=slmSysTemperature, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmNetworkMode=slmNetworkMode, slmSwRevTable=slmSwRevTable, slmAdminAccess=slmAdminAccess, slmTid=slmTid, slmAuthLogin=slmAuthLogin, slmSysIpAddr=slmSysIpAddr, slmTrapLogId=slmTrapLogId, slmSysCalendarTime=slmSysCalendarTime, slmAuthTable=slmAuthTable, slmSysLocation=slmSysLocation, slmSysUplinkRate=slmSysUplinkRate, slmSwRevDate=slmSwRevDate, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogParam4=slmTrapLogParam4, slmPortsNumber=slmPortsNumber, slmTrapLogName=slmTrapLogName, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSys=slmSys, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysMode=slmSysMode, slmVcatDelay=slmVcatDelay, slmTrapDestTable=slmTrapDestTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAuthEntry=slmAuthEntry, slmAuthPassword=slmAuthPassword, slmTrapUserLogin=slmTrapUserLogin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassEntry=slmChPassEntry, slmAuthCommunity=slmAuthCommunity, UserPassword=UserPassword, slmSwRevName=slmSwRevName, slmWriteCommunity=slmWriteCommunity, slmLogFile=slmLogFile, slmSwRevEntry=slmSwRevEntry, slmAdminTable=slmAdminTable, SoftwareRevision=SoftwareRevision, slmOemType=slmOemType, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestEntry=slmTrapDestEntry, slmSysChassisId=slmSysChassisId, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminLogin=slmAdminLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysGatewayAddr=slmSysGatewayAddr)
