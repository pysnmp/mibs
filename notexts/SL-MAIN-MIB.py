...
# ASN.1 source SL-MAIN-MIB
# Source digest sha256:4a88420175de668e4d1275adf21d51db883e100f742fa75bff198512e93152e6
...
if mibBuilder.loadTexts: slMain.setLastUpdated('2000-08-28 00:00')
...
slmSysPmStartOfDay = MibScalar((1, 3, 6, 1, 4, 1, 4515, 1, 3, 1, 10), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 23)).clone(0)).setMaxAccess("readwrite")
...
slmSwRevTable = MibTable((1, 3, 6, 1, 4, 1, 4515, 1, 3, 1, 12), ).setMaxAccess("notaccessible")
...
slmSwRevEntry = MibTableRow((1, 3, 6, 1, 4, 1, 4515, 1, 3, 1, 12, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "SL-MAIN-MIB", "slmSwRevDirectory"))
...
slmAdminTable = MibTable((1, 3, 6, 1, 4, 1, 4515, 1, 3, 2, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: slmAdminTable.setStatus('current')
slmAdminEntry = MibTableRow((1, 3, 6, 1, 4, 1, 4515, 1, 3, 2, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "SL-MAIN-MIB", "slmAdminLogin"))
...
slmAuthTable = MibTable((1, 3, 6, 1, 4, 1, 4515, 1, 3, 3, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: slmAuthTable.setStatus('current')
slmAuthEntry = MibTableRow((1, 3, 6, 1, 4, 1, 4515, 1, 3, 3, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "SL-MAIN-MIB", "slmAuthLogin"), (0, "SL-MAIN-MIB", "slmAuthPassword"))
if mibBuilder.loadTexts: slmAuthEntry.setStatus('current')
slmAuthLogin = MibTableColumn((1, 3, 6, 1, 4, 1, 4515, 1, 3, 3, 1, 1, 1), UserLogin()).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: slmAuthLogin.setStatus('current')
slmAuthPassword = MibTableColumn((1, 3, 6, 1, 4, 1, 4515, 1, 3, 3, 1, 1, 2), UserPassword()).setMaxAccess("notaccessible")
...
slmChPassTable = MibTable((1, 3, 6, 1, 4, 1, 4515, 1, 3, 12, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: slmChPassTable.setStatus('current')
slmChPassEntry = MibTableRow((1, 3, 6, 1, 4, 1, 4515, 1, 3, 12, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "SL-MAIN-MIB", "slmChPassLogin"), (0, "SL-MAIN-MIB", "slmChPassOldPass"))
if mibBuilder.loadTexts: slmChPassEntry.setStatus('current')
slmChPassLogin = MibTableColumn((1, 3, 6, 1, 4, 1, 4515, 1, 3, 12, 1, 1, 1), UserLogin()).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: slmChPassLogin.setStatus('current')
slmChPassOldPass = MibTableColumn((1, 3, 6, 1, 4, 1, 4515, 1, 3, 12, 1, 1, 2), UserPassword()).setMaxAccess("notaccessible")
...
slmTrapDestTable = MibTable((1, 3, 6, 1, 4, 1, 4515, 1, 3, 5, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: slmTrapDestTable.setStatus('current')
slmTrapDestEntry = MibTableRow((1, 3, 6, 1, 4, 1, 4515, 1, 3, 5, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "SL-MAIN-MIB", "slmTrapDestAddress"))
...
slmTrapLogTable = MibTable((1, 3, 6, 1, 4, 1, 4515, 1, 3, 5, 2), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: slmTrapLogTable.setStatus('current')
slmTrapLogEntry = MibTableRow((1, 3, 6, 1, 4, 1, 4515, 1, 3, 5, 2, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "SL-MAIN-MIB", "slmTrapLogId"))
...
slmSyslogDestTable = MibTable((1, 3, 6, 1, 4, 1, 4515, 1, 3, 5, 7), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: slmSyslogDestTable.setStatus('current')
slmSyslogDestEntry = MibTableRow((1, 3, 6, 1, 4, 1, 4515, 1, 3, 5, 7, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "SL-MAIN-MIB", "slmSyslogDestAddress"))
...
slmLicenseTable = MibTable((1, 3, 6, 1, 4, 1, 4515, 1, 3, 17, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: slmLicenseTable.setStatus('current')
slmLicenseEntry = MibTableRow((1, 3, 6, 1, 4, 1, 4515, 1, 3, 17, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "SL-MAIN-MIB", "slmLicenseIndex"))
...
mibBuilder.exportSymbols("SL-MAIN-MIB", AdminAccess=AdminAccess, PYSNMP_MODULE_ID=slMain, SoftwareRevision=SoftwareRevision, UserCommunity=UserCommunity, UserLogin=UserLogin, UserPassword=UserPassword, slMain=slMain, slm40GConf=slm40GConf, slmAdmin=slmAdmin, slmAdminAccess=slmAdminAccess, slmAdminCommunity=slmAdminCommunity, slmAdminEntry=slmAdminEntry, slmAdminLogin=slmAdminLogin, slmAdminPassword=slmAdminPassword, slmAdminRowStatus=slmAdminRowStatus, slmAdminTable=slmAdminTable, slmAuth=slmAuth, slmAuthCommunity=slmAuthCommunity, slmAuthEntry=slmAuthEntry, slmAuthLogin=slmAuthLogin, slmAuthPassword=slmAuthPassword, slmAuthTable=slmAuthTable, slmBoxSize=slmBoxSize, slmChPass=slmChPass, slmChPassEntry=slmChPassEntry, slmChPassLogin=slmChPassLogin, slmChPassNewPass=slmChPassNewPass, slmChPassOldPass=slmChPassOldPass, slmChPassTable=slmChPassTable, slmConfigFile=slmConfigFile, slmConfigSysSignalType=slmConfigSysSignalType, slmConfigSysUptime=slmConfigSysUptime, slmEdfaNumber=slmEdfaNumber, slmLicense=slmLicense, slmLicenseEntry=slmLicenseEntry, slmLicenseExpiration=slmLicenseExpiration, slmLicenseId=slmLicenseId, slmLicenseIndex=slmLicenseIndex, slmLicenseTable=slmLicenseTable, slmLogFile=slmLogFile, slmLogin=slmLogin, slmMuxNumber=slmMuxNumber, slmNetworkMode=slmNetworkMode, slmOemType=slmOemType, slmOpticalSwitchExist=slmOpticalSwitchExist, slmPmAvailable=slmPmAvailable, slmPortsNumber=slmPortsNumber, slmPsuNumber=slmPsuNumber, slmReadCommunity=slmReadCommunity, slmRebootDelay=slmRebootDelay, slmRstpEnabled=slmRstpEnabled, slmSnmpv3Auth=slmSnmpv3Auth, slmSnmpv3Password=slmSnmpv3Password, slmSnmpv3Priv=slmSnmpv3Priv, slmSwRevDate=slmSwRevDate, slmSwRevDirectory=slmSwRevDirectory, slmSwRevEntry=slmSwRevEntry, slmSwRevName=slmSwRevName, slmSwRevStatus=slmSwRevStatus, slmSwRevTable=slmSwRevTable, slmSys=slmSys, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysAdminStatus=slmSysAdminStatus, slmSysAlmAct=slmSysAlmAct, slmSysAlmDeact=slmSysAlmDeact, slmSysCalendarTime=slmSysCalendarTime, slmSysChassisId=slmSysChassisId, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysGatewayAddr=slmSysGatewayAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysIpAddr=slmSysIpAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysLocation=slmSysLocation, slmSysMode=slmSysMode, slmSysName=slmSysName, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysOperStatus=slmSysOperStatus, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysResetPm=slmSysResetPm, slmSysSnmpVersion=slmSysSnmpVersion, slmSysSubnetMask=slmSysSubnetMask, slmSysTemperature=slmSysTemperature, slmSysTrapFormat=slmSysTrapFormat, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogDestEntry=slmSyslogDestEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSyslogDestTable=slmSyslogDestTable, slmSyslogLevel=slmSyslogLevel, slmSyslogPort=slmSyslogPort, slmTid=slmTid, slmTopologyEnabled=slmTopologyEnabled, slmTrap=slmTrap, slmTrapCommunity=slmTrapCommunity, slmTrapDestAddress=slmTrapDestAddress, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapDestEntry=slmTrapDestEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestTable=slmTrapDestTable, slmTrapEnable=slmTrapEnable, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogId=slmTrapLogId, slmTrapLogName=slmTrapLogName, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogTable=slmTrapLogTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapPort=slmTrapPort, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapUserAccess=slmTrapUserAccess, slmTrapUserLogin=slmTrapUserLogin, slmVcatDelay=slmVcatDelay, slmWriteCommunity=slmWriteCommunity)
