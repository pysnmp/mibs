...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestAddress=slmTrapDestAddress, slmSysAdminStatus=slmSysAdminStatus, slmSyslogDestTable=slmSyslogDestTable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmNetworkMode=slmNetworkMode, UserLogin=UserLogin, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogId=slmTrapLogId, slmAuth=slmAuth, slmAdminLogin=slmAdminLogin, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminEntry=slmAdminEntry, slmSysIpAddr=slmSysIpAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, AdminAccess=AdminAccess, slmAuthPassword=slmAuthPassword, slmSysTrapFormat=slmSysTrapFormat, slmAdminCommunity=slmAdminCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysTemperature=slmSysTemperature, slmAuthTable=slmAuthTable, slmLicenseIndex=slmLicenseIndex, slmTrapLogParam6=slmTrapLogParam6, slmLicenseExpiration=slmLicenseExpiration, SoftwareRevision=SoftwareRevision, slmPsuNumber=slmPsuNumber, slmTopologyEnabled=slmTopologyEnabled, slmSnmpv3Priv=slmSnmpv3Priv, slmSnmpv3Password=slmSnmpv3Password, slmReadCommunity=slmReadCommunity, slmTrapDestRowStatus=slmTrapDestRowStatus, slmConfigSysUptime=slmConfigSysUptime, slmSwRevTable=slmSwRevTable, slmTrapLogParam1=slmTrapLogParam1, slmAdmin=slmAdmin, slmLogFile=slmLogFile, slmChPassTable=slmChPassTable, slmBoxSize=slmBoxSize, slmTrapEnable=slmTrapEnable, slmSysSubnetMask=slmSysSubnetMask, slmSyslogDestEntry=slmSyslogDestEntry, slmSysAlmDeact=slmSysAlmDeact, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTid=slmTid, slmAuthLogin=slmAuthLogin, slmPortsNumber=slmPortsNumber, slm40GConf=slm40GConf, slmAuthCommunity=slmAuthCommunity, slmSysMode=slmSysMode, slmLogin=slmLogin, slmSysOperStatus=slmSysOperStatus, slmSwRevStatus=slmSwRevStatus, slmTrapLogParam3=slmTrapLogParam3, slmSysAlmAct=slmSysAlmAct, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam2=slmTrapLogParam2, PYSNMP_MODULE_ID=slMain, slmSys=slmSys, slmAdminRowStatus=slmAdminRowStatus, slmSysLocation=slmSysLocation, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestProtVersion=slmTrapDestProtVersion, slmRstpEnabled=slmRstpEnabled, slmSwRevDate=slmSwRevDate, slmSwRevName=slmSwRevName, slmAuthEntry=slmAuthEntry, slmTrapLogParam4=slmTrapLogParam4, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmChPassEntry=slmChPassEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapCommunity=slmTrapCommunity, slmTrapDestCommunity=slmTrapDestCommunity, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogName=slmTrapLogName, slmChPassLogin=slmChPassLogin, slmSysUplinkRate=slmSysUplinkRate, slmOemType=slmOemType, slmTrap=slmTrap, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminTable=slmAdminTable, slmConfigFile=slmConfigFile, slmChPass=slmChPass, UserCommunity=UserCommunity, slmSysChassisId=slmSysChassisId, slmLicenseEntry=slmLicenseEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmMuxNumber=slmMuxNumber, slmWriteCommunity=slmWriteCommunity, slmTrapPort=slmTrapPort, slmTrapLogTable=slmTrapLogTable, slmSnmpv3Auth=slmSnmpv3Auth, slmChPassNewPass=slmChPassNewPass, slmEdfaNumber=slmEdfaNumber, slmPmAvailable=slmPmAvailable, slmChPassOldPass=slmChPassOldPass, slmLicense=slmLicense, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLicenseId=slmLicenseId, slmSwRevDirectory=slmSwRevDirectory, slmSysResetPm=slmSysResetPm, slmVcatDelay=slmVcatDelay, slmSyslogPort=slmSyslogPort, slmAdminAccess=slmAdminAccess, slmSysCalendarTime=slmSysCalendarTime, slmSyslogLevel=slmSyslogLevel, slmLicenseTable=slmLicenseTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysGatewayAddr=slmSysGatewayAddr, slmSysName=slmSysName, slmAdminPassword=slmAdminPassword, slmTrapUserLogin=slmTrapUserLogin, slmTrapUserAccess=slmTrapUserAccess, slMain=slMain, slmTrapDestEntry=slmTrapDestEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, UserPassword=UserPassword, slmTrapDestTable=slmTrapDestTable, slmTrapLogEntry=slmTrapLogEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogDestAddress=slmSyslogDestAddress, slmRebootDelay=slmRebootDelay)
