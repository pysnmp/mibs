...
Opaque, iso, Counter32, NotificationType, IpAddress, Integer32, Gauge32, TimeTicks, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ObjectIdentity, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "iso", "Counter32", "NotificationType", "IpAddress", "Integer32", "Gauge32", "TimeTicks", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ObjectIdentity", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmReadCommunity=slmReadCommunity, slmLicenseTable=slmLicenseTable, slmTrapLogParam5=slmTrapLogParam5, slmRstpEnabled=slmRstpEnabled, slmAuthCommunity=slmAuthCommunity, slmSysAlmDeact=slmSysAlmDeact, slmNetworkMode=slmNetworkMode, UserPassword=UserPassword, slmAdminAccess=slmAdminAccess, slmSysLocation=slmSysLocation, slmLicenseId=slmLicenseId, slmTopologyEnabled=slmTopologyEnabled, slmAuth=slmAuth, slmRebootDelay=slmRebootDelay, slmTrapDestIpAddress=slmTrapDestIpAddress, UserCommunity=UserCommunity, slmAdminRowStatus=slmAdminRowStatus, PYSNMP_MODULE_ID=slMain, slmLicenseEntry=slmLicenseEntry, slmTrapLogParam3=slmTrapLogParam3, slmSysName=slmSysName, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSys=slmSys, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLogFile=slmLogFile, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestAddress=slmTrapDestAddress, slmConfigFile=slmConfigFile, slmTrap=slmTrap, slmChPassTable=slmChPassTable, slmSysAlmAct=slmSysAlmAct, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSwRevDirectory=slmSwRevDirectory, slmSysResetPm=slmSysResetPm, slmSnmpv3Priv=slmSnmpv3Priv, slmSysChassisId=slmSysChassisId, slmPmAvailable=slmPmAvailable, slmOemType=slmOemType, slmPsuNumber=slmPsuNumber, slmSysAdminStatus=slmSysAdminStatus, slmChPassOldPass=slmChPassOldPass, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmEdfaNumber=slmEdfaNumber, slmSyslogDestEntry=slmSyslogDestEntry, slmAuthEntry=slmAuthEntry, slmMuxNumber=slmMuxNumber, slmTid=slmTid, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapEnable=slmTrapEnable, slmSwRevTable=slmSwRevTable, slmTrapUserLogin=slmTrapUserLogin, slmLicense=slmLicense, slmSysTrapFormat=slmSysTrapFormat, slmLogin=slmLogin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, AdminAccess=AdminAccess, slmTrapDestEntry=slmTrapDestEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmPortsNumber=slmPortsNumber, slmAdminLogin=slmAdminLogin, slmTrapDestCommunity=slmTrapDestCommunity, slmSwRevName=slmSwRevName, slmSysGatewayAddr=slmSysGatewayAddr, slmConfigSysUptime=slmConfigSysUptime, slmSwRevStatus=slmSwRevStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogId=slmTrapLogId, slmTrapLogName=slmTrapLogName, slmTrapLogParam4=slmTrapLogParam4, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestTable=slmTrapDestTable, slmChPassNewPass=slmChPassNewPass, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassLogin=slmChPassLogin, slmAuthTable=slmAuthTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminPassword=slmAdminPassword, slmAdminCommunity=slmAdminCommunity, slMain=slMain, slmSysTemperature=slmSysTemperature, slmSysUplinkRate=slmSysUplinkRate, slmAuthLogin=slmAuthLogin, slmSysIpAddr=slmSysIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapCommunity=slmTrapCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysMode=slmSysMode, slmSwRevDate=slmSwRevDate, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam2=slmTrapLogParam2, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysSubnetMask=slmSysSubnetMask, slmAdminTable=slmAdminTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogParam6=slmTrapLogParam6, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam1=slmTrapLogParam1, SoftwareRevision=SoftwareRevision, slmAdmin=slmAdmin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminEntry=slmAdminEntry, slmTrapLogEntry=slmTrapLogEntry, slmSyslogPort=slmSyslogPort, slmLicenseExpiration=slmLicenseExpiration, slmSysLanIpAddr=slmSysLanIpAddr, slmWriteCommunity=slmWriteCommunity, slmChPassEntry=slmChPassEntry, slmVcatDelay=slmVcatDelay, slmSwRevEntry=slmSwRevEntry, UserLogin=UserLogin, slmTrapPort=slmTrapPort, slmSnmpv3Auth=slmSnmpv3Auth, slmBoxSize=slmBoxSize, slmChPass=slmChPass, slmLicenseIndex=slmLicenseIndex, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysOperStatus=slmSysOperStatus, slmConfigSysSignalType=slmConfigSysSignalType, slmAuthPassword=slmAuthPassword, slmTrapUserAccess=slmTrapUserAccess, slm40GConf=slm40GConf, slmSyslogLevel=slmSyslogLevel, slmTrapLogTable=slmTrapLogTable)
