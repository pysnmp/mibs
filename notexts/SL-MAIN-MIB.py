...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAuthCommunity=slmAuthCommunity, slmSwRevDirectory=slmSwRevDirectory, slmSysResetPm=slmSysResetPm, slmSyslogDestTable=slmSyslogDestTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogPort=slmSyslogPort, slmLogFile=slmLogFile, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevStatus=slmSwRevStatus, slmTrapCommunity=slmTrapCommunity, slmTrapDestCommunity=slmTrapDestCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmRebootDelay=slmRebootDelay, slmSwRevName=slmSwRevName, slmSysAlmAct=slmSysAlmAct, slmTrap=slmTrap, UserLogin=UserLogin, slmTrapEnable=slmTrapEnable, slmSwRevTable=slmSwRevTable, slmSwRevDate=slmSwRevDate, slmTrapLogParam1=slmTrapLogParam1, slmLicense=slmLicense, slmLicenseId=slmLicenseId, slmMuxNumber=slmMuxNumber, slmAdminLogin=slmAdminLogin, slmSysAdminStatus=slmSysAdminStatus, slmSysUplinkRate=slmSysUplinkRate, slmLicenseEntry=slmLicenseEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassTable=slmChPassTable, UserPassword=UserPassword, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestTable=slmTrapDestTable, slmLogin=slmLogin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmReadCommunity=slmReadCommunity, slmAuthLogin=slmAuthLogin, slmAuthPassword=slmAuthPassword, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapDestAddress=slmTrapDestAddress, slmChPass=slmChPass, PYSNMP_MODULE_ID=slMain, slmConfigFile=slmConfigFile, slmAdminPassword=slmAdminPassword, slmTrapLogParam6=slmTrapLogParam6, slmChPassOldPass=slmChPassOldPass, slmConfigSysUptime=slmConfigSysUptime, slmAdminRowStatus=slmAdminRowStatus, slmPsuNumber=slmPsuNumber, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestEntry=slmTrapDestEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmSysOperStatus=slmSysOperStatus, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPassEntry=slmChPassEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminEntry=slmAdminEntry, slmSysChassisId=slmSysChassisId, slmEdfaNumber=slmEdfaNumber, slmSysGatewayAddr=slmSysGatewayAddr, slmRstpEnabled=slmRstpEnabled, slMain=slMain, slmSysLocation=slmSysLocation, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogParam2=slmTrapLogParam2, slmSysMode=slmSysMode, slmTrapUserAccess=slmTrapUserAccess, slmTid=slmTid, slmTrapUserLogin=slmTrapUserLogin, slmPortsNumber=slmPortsNumber, slmNetworkMode=slmNetworkMode, slmTrapLogEntry=slmTrapLogEntry, slmAuthEntry=slmAuthEntry, slmAdmin=slmAdmin, slmLicenseTable=slmLicenseTable, slmLicenseIndex=slmLicenseIndex, slmWriteCommunity=slmWriteCommunity, slmLicenseExpiration=slmLicenseExpiration, slmBoxSize=slmBoxSize, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogName=slmTrapLogName, slmSys=slmSys, slmSwRevEntry=slmSwRevEntry, slmAdminAccess=slmAdminAccess, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogId=slmTrapLogId, slm40GConf=slm40GConf, slmTrapLogParam4=slmTrapLogParam4, slmTrapPort=slmTrapPort, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSnmpv3Priv=slmSnmpv3Priv, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogTable=slmTrapLogTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSnmpv3Password=slmSnmpv3Password, slmSysTrapFormat=slmSysTrapFormat, slmChPassLogin=slmChPassLogin, slmSysTemperature=slmSysTemperature, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysAlmDeact=slmSysAlmDeact, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysName=slmSysName, slmChPassNewPass=slmChPassNewPass, slmPmAvailable=slmPmAvailable, slmAuth=slmAuth, slmVcatDelay=slmVcatDelay, SoftwareRevision=SoftwareRevision, slmSysCalendarTime=slmSysCalendarTime, UserCommunity=UserCommunity, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAuthTable=slmAuthTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLanIpAddr=slmSysLanIpAddr, slmSyslogLevel=slmSyslogLevel, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminTable=slmAdminTable, slmOemType=slmOemType, slmSysIpAddr=slmSysIpAddr, AdminAccess=AdminAccess)
