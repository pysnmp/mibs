...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSwRevEntry=slmSwRevEntry, slmAuthTable=slmAuthTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSwRevTable=slmSwRevTable, slmChPassTable=slmChPassTable, slmMuxNumber=slmMuxNumber, slmSwRevDirectory=slmSwRevDirectory, slmVcatDelay=slmVcatDelay, slmBoxSize=slmBoxSize, slmSysCalendarTime=slmSysCalendarTime, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSys=slmSys, slmSysResetPm=slmSysResetPm, slmAuth=slmAuth, slmTrapDestCommunity=slmTrapDestCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicenseIndex=slmLicenseIndex, slmTrapSysLocationChange=slmTrapSysLocationChange, slmReadCommunity=slmReadCommunity, slmOemType=slmOemType, slmAdminEntry=slmAdminEntry, slmAuthCommunity=slmAuthCommunity, AdminAccess=AdminAccess, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseExpiration=slmLicenseExpiration, slmSyslogDestAddress=slmSyslogDestAddress, slmSysChassisId=slmSysChassisId, slmRstpEnabled=slmRstpEnabled, slmLogFile=slmLogFile, slmSysAlmDeact=slmSysAlmDeact, slmSwRevStatus=slmSwRevStatus, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminLogin=slmAdminLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestTable=slmTrapDestTable, slmSyslogDestEntry=slmSyslogDestEntry, slmSysGatewayAddr=slmSysGatewayAddr, UserPassword=UserPassword, slmPmAvailable=slmPmAvailable, slmTrapUserLogin=slmTrapUserLogin, slmPortsNumber=slmPortsNumber, slmNetworkMode=slmNetworkMode, slmRebootDelay=slmRebootDelay, slmSysIpAddr=slmSysIpAddr, slmAdminCommunity=slmAdminCommunity, slmSyslogLevel=slmSyslogLevel, slmTrap=slmTrap, slmLicenseId=slmLicenseId, slmTrapLogParam5=slmTrapLogParam5, slmAuthEntry=slmAuthEntry, slmAdminPassword=slmAdminPassword, slmSnmpv3Priv=slmSnmpv3Priv, slMain=slMain, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysUplinkRate=slmSysUplinkRate, slmTopologyEnabled=slmTopologyEnabled, slmSysMode=slmSysMode, slmChPassNewPass=slmChPassNewPass, slmTid=slmTid, slmChPassLogin=slmChPassLogin, slmTrapEnable=slmTrapEnable, slmEdfaNumber=slmEdfaNumber, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, PYSNMP_MODULE_ID=slMain, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmConfigSysUptime=slmConfigSysUptime, slmAuthLogin=slmAuthLogin, slmSysLocation=slmSysLocation, slmSwRevName=slmSwRevName, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminAccess=slmAdminAccess, slmTrapLogParam4=slmTrapLogParam4, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLicense=slmLicense, slmChPass=slmChPass, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogName=slmTrapLogName, slmTrapLogParam3=slmTrapLogParam3, slmLicenseTable=slmLicenseTable, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogId=slmTrapLogId, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSnmpv3Auth=slmSnmpv3Auth, slmSysPmStartOfDay=slmSysPmStartOfDay, slmChPassEntry=slmChPassEntry, slmAdminTable=slmAdminTable, slmSyslogDestTable=slmSyslogDestTable, slmPsuNumber=slmPsuNumber, slmChPassOldPass=slmChPassOldPass, slmSysAdminStatus=slmSysAdminStatus, UserCommunity=UserCommunity, slmSysLanIpAddr=slmSysLanIpAddr, slmLogin=slmLogin, slmAdmin=slmAdmin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam1=slmTrapLogParam1, slmTrapDestEntry=slmTrapDestEntry, slmSysOperStatus=slmSysOperStatus, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogParam2=slmTrapLogParam2, slmSysSnmpVersion=slmSysSnmpVersion, slmLicenseEntry=slmLicenseEntry, slmSwRevDate=slmSwRevDate, slmTrapPort=slmTrapPort, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmConfigSysSignalType=slmConfigSysSignalType, slm40GConf=slm40GConf, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapUserAccess=slmTrapUserAccess, slmConfigFile=slmConfigFile, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogParam6=slmTrapLogParam6, slmWriteCommunity=slmWriteCommunity, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysAlmAct=slmSysAlmAct, slmTrapLogEntry=slmTrapLogEntry, slmSysTemperature=slmSysTemperature, slmSyslogPort=slmSyslogPort, slmTrapCommunity=slmTrapCommunity, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysName=slmSysName, SoftwareRevision=SoftwareRevision, slmSnmpv3Password=slmSnmpv3Password, slmAuthPassword=slmAuthPassword, UserLogin=UserLogin, slmTrapLogTable=slmTrapLogTable)
