...
TimeTicks, Counter64, IpAddress, Counter32, Bits, Integer32, Opaque, iso, ModuleIdentity, Unsigned32, Gauge32, NotificationType, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "IpAddress", "Counter32", "Bits", "Integer32", "Opaque", "iso", "ModuleIdentity", "Unsigned32", "Gauge32", "NotificationType", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapUserAccess=slmTrapUserAccess, slmSysTrapFormat=slmSysTrapFormat, slmLicenseExpiration=slmLicenseExpiration, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLicenseTable=slmLicenseTable, slmSysEncryptionCapability=slmSysEncryptionCapability, AdminAccess=AdminAccess, slmTrapDestTable=slmTrapDestTable, slmNetworkMode=slmNetworkMode, slmSnmpv3Password=slmSnmpv3Password, slmChPassTable=slmChPassTable, slmTrapPort=slmTrapPort, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogEntry=slmTrapLogEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmEdfaNumber=slmEdfaNumber, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slMain=slMain, slmTrapDestAddress=slmTrapDestAddress, slmAuthTable=slmAuthTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmRebootDelay=slmRebootDelay, slmTrapDestIpAddress=slmTrapDestIpAddress, UserLogin=UserLogin, slmSwRevName=slmSwRevName, slmReadCommunity=slmReadCommunity, slmAdmin=slmAdmin, slmLicense=slmLicense, slmSysName=slmSysName, slmSwRevDirectory=slmSwRevDirectory, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysAlmDeact=slmSysAlmDeact, slmChPassLogin=slmChPassLogin, slmSysChassisId=slmSysChassisId, slmAdminTable=slmAdminTable, slmVcatDelay=slmVcatDelay, slmSysAdminStatus=slmSysAdminStatus, slmOemType=slmOemType, slmSnmpv3Priv=slmSnmpv3Priv, slmAuthCommunity=slmAuthCommunity, slmConfigSysUptime=slmConfigSysUptime, slmChPassNewPass=slmChPassNewPass, slmAdminAccess=slmAdminAccess, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, SoftwareRevision=SoftwareRevision, slmTrapEnable=slmTrapEnable, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogTable=slmTrapLogTable, slmPortsNumber=slmPortsNumber, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam4=slmTrapLogParam4, slmAuthPassword=slmAuthPassword, slmLicenseIndex=slmLicenseIndex, slmTrapLogParam5=slmTrapLogParam5, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTopologyEnabled=slmTopologyEnabled, slmAuth=slmAuth, slmAuthLogin=slmAuthLogin, slmTrapCommunity=slmTrapCommunity, slmSysLocation=slmSysLocation, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam6=slmTrapLogParam6, slmAdminCommunity=slmAdminCommunity, slmPsuNumber=slmPsuNumber, slmConfigFile=slmConfigFile, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogName=slmTrapLogName, slmAuthEntry=slmAuthEntry, slmSwRevStatus=slmSwRevStatus, slmSysTemperature=slmSysTemperature, slmSysSnmpVersion=slmSysSnmpVersion, slmSysCalendarTime=slmSysCalendarTime, slmTid=slmTid, slmSyslogDestTable=slmSyslogDestTable, slmChPassEntry=slmChPassEntry, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam1=slmTrapLogParam1, slmAdminEntry=slmAdminEntry, slmTrapSysNameChange=slmTrapSysNameChange, PYSNMP_MODULE_ID=slMain, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysGatewayAddr=slmSysGatewayAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevDate=slmSwRevDate, slmSysOperStatus=slmSysOperStatus, slmLicenseEntry=slmLicenseEntry, slmSyslogLevel=slmSyslogLevel, slmTrapLogId=slmTrapLogId, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLogin=slmLogin, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysUplinkRate=slmSysUplinkRate, slmSysLanIpAddr=slmSysLanIpAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSwRevTable=slmSwRevTable, slmSys=slmSys, slmLogFile=slmLogFile, slmSyslogPort=slmSyslogPort, slmSysMode=slmSysMode, slmChPass=slmChPass, slmAdminPassword=slmAdminPassword, slmBoxSize=slmBoxSize, slmSysResetPm=slmSysResetPm, slmWriteCommunity=slmWriteCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogParam2=slmTrapLogParam2, slmSysAlmAct=slmSysAlmAct, slmRstpEnabled=slmRstpEnabled, UserCommunity=UserCommunity, slmPmAvailable=slmPmAvailable, slmTrapLogParam3=slmTrapLogParam3, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminLogin=slmAdminLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmTrap=slmTrap, slmSysIpAddr=slmSysIpAddr, slmMuxNumber=slmMuxNumber, slm40GConf=slm40GConf, slmChPassOldPass=slmChPassOldPass, slmLicenseId=slmLicenseId, slmSysSubnetMask=slmSysSubnetMask, UserPassword=UserPassword, slmSwRevEntry=slmSwRevEntry)
