...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAuthLogin=slmAuthLogin, slmAuth=slmAuth, slmSysAdminStatus=slmSysAdminStatus, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmBoxSize=slmBoxSize, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestIpAddress=slmTrapDestIpAddress, slmEdfaNumber=slmEdfaNumber, slmSysAlmAct=slmSysAlmAct, slmTrapLogName=slmTrapLogName, slmLogin=slmLogin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmChPass=slmChPass, slmTid=slmTid, slmTrapEnable=slmTrapEnable, slmSys=slmSys, slmTrapLogParam1=slmTrapLogParam1, slmTrap=slmTrap, slmSysLocation=slmSysLocation, slmTrapPort=slmTrapPort, slmSysCalendarTime=slmSysCalendarTime, UserCommunity=UserCommunity, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAuthEntry=slmAuthEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysResetPm=slmSysResetPm, slmConfigSysSignalType=slmConfigSysSignalType, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogLevel=slmSyslogLevel, slmAdminAccess=slmAdminAccess, slmTrapLogParam2=slmTrapLogParam2, slmAuthCommunity=slmAuthCommunity, slmSysAlmDeact=slmSysAlmDeact, slmLicenseIndex=slmLicenseIndex, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestAddress=slmTrapDestAddress, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysIpAddr=slmSysIpAddr, slmLicense=slmLicense, slmRebootDelay=slmRebootDelay, slmSyslogDestAddress=slmSyslogDestAddress, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestTable=slmTrapDestTable, slmTrapLogId=slmTrapLogId, slmVcatDelay=slmVcatDelay, slmSysGatewayAddr=slmSysGatewayAddr, SoftwareRevision=SoftwareRevision, slmSysTemperature=slmSysTemperature, slmSwRevStatus=slmSwRevStatus, slmSysTrapFormat=slmSysTrapFormat, slmAdminTable=slmAdminTable, slmConfigSysUptime=slmConfigSysUptime, slmSysMode=slmSysMode, slmPmAvailable=slmPmAvailable, slmTrapUserLogin=slmTrapUserLogin, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdmin=slmAdmin, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassTable=slmChPassTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmConfigFile=slmConfigFile, slmPsuNumber=slmPsuNumber, slmSwRevName=slmSwRevName, slmSysOperStatus=slmSysOperStatus, PYSNMP_MODULE_ID=slMain, slmAdminCommunity=slmAdminCommunity, slmTrapUserAccess=slmTrapUserAccess, UserPassword=UserPassword, slmTrapLogParam5=slmTrapLogParam5, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysSnmpVersion=slmSysSnmpVersion, slmSwRevDirectory=slmSwRevDirectory, slmNetworkMode=slmNetworkMode, slmChPassEntry=slmChPassEntry, slmRstpEnabled=slmRstpEnabled, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysSubnetMask=slmSysSubnetMask, slmOemType=slmOemType, slmWriteCommunity=slmWriteCommunity, slmLogFile=slmLogFile, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogTable=slmTrapLogTable, slmLicenseEntry=slmLicenseEntry, UserLogin=UserLogin, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminEntry=slmAdminEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmSnmpv3Password=slmSnmpv3Password, slmPortsNumber=slmPortsNumber, slmAuthTable=slmAuthTable, slmSyslogDestEntry=slmSyslogDestEntry, AdminAccess=AdminAccess, slmLicenseId=slmLicenseId, slmMuxNumber=slmMuxNumber, slmTrapLogParam3=slmTrapLogParam3, slmSysChassisId=slmSysChassisId, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSnmpv3Auth=slmSnmpv3Auth, slmChPassOldPass=slmChPassOldPass, slmAdminLogin=slmAdminLogin, slmLicenseExpiration=slmLicenseExpiration, slmSysUplinkRate=slmSysUplinkRate, slmTrapCommunity=slmTrapCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevDate=slmSwRevDate, slmSwRevTable=slmSwRevTable, slmSysName=slmSysName, slm40GConf=slm40GConf, slmSwRevEntry=slmSwRevEntry, slmAdminPassword=slmAdminPassword, slmSyslogDestTable=slmSyslogDestTable, slmChPassLogin=slmChPassLogin, slMain=slMain, slmReadCommunity=slmReadCommunity, slmAuthPassword=slmAuthPassword, slmTrapDestEntry=slmTrapDestEntry, slmLicenseTable=slmLicenseTable, slmSyslogPort=slmSyslogPort, slmChPassNewPass=slmChPassNewPass)
