...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogName=slmTrapLogName, slmLogin=slmLogin, slmOemType=slmOemType, slmSysLocation=slmSysLocation, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmSysIpAddr=slmSysIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminRowStatus=slmAdminRowStatus, slmSysResetPm=slmSysResetPm, slmTrapDestTable=slmTrapDestTable, slmRebootDelay=slmRebootDelay, slmConfigSysUptime=slmConfigSysUptime, slmAuthCommunity=slmAuthCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestEntry=slmTrapDestEntry, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam5=slmTrapLogParam5, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogParam4=slmTrapLogParam4, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicenseId=slmLicenseId, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSyslogDestTable=slmSyslogDestTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogLevel=slmSyslogLevel, slmTrapLogId=slmTrapLogId, slmLicense=slmLicense, slmTid=slmTid, slmTrapUserLogin=slmTrapUserLogin, slmRstpEnabled=slmRstpEnabled, slmTrapLogTable=slmTrapLogTable, slmSysTrapFormat=slmSysTrapFormat, slmSnmpv3Priv=slmSnmpv3Priv, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuthTable=slmAuthTable, AdminAccess=AdminAccess, slmBoxSize=slmBoxSize, slmAdminTable=slmAdminTable, slmTrapLogParam1=slmTrapLogParam1, slmLicenseTable=slmLicenseTable, slmAdminEntry=slmAdminEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogDestEntry=slmSyslogDestEntry, slmChPassOldPass=slmChPassOldPass, slmTrapEnable=slmTrapEnable, PYSNMP_MODULE_ID=slMain, slmTrap=slmTrap, slmVcatDelay=slmVcatDelay, slmAuthEntry=slmAuthEntry, slmSwRevDate=slmSwRevDate, UserCommunity=UserCommunity, slmPortsNumber=slmPortsNumber, slmWriteCommunity=slmWriteCommunity, slmLicenseExpiration=slmLicenseExpiration, slmSysAlmDeact=slmSysAlmDeact, slmSysOperStatus=slmSysOperStatus, slmChPassNewPass=slmChPassNewPass, slmLicenseEntry=slmLicenseEntry, slmSysAdminStatus=slmSysAdminStatus, slmSwRevTable=slmSwRevTable, slmSysChassisId=slmSysChassisId, slmSyslogPort=slmSyslogPort, slmTrapDestCommunity=slmTrapDestCommunity, slmChPassTable=slmChPassTable, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam3=slmTrapLogParam3, slmPsuNumber=slmPsuNumber, slmConfigFile=slmConfigFile, slmReadCommunity=slmReadCommunity, slmLogFile=slmLogFile, slmLicenseIndex=slmLicenseIndex, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, UserLogin=UserLogin, slmSnmpv3Password=slmSnmpv3Password, slmSysAlmAct=slmSysAlmAct, slmSysSubnetMask=slmSysSubnetMask, UserPassword=UserPassword, slmEdfaNumber=slmEdfaNumber, slmChPassLogin=slmChPassLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevName=slmSwRevName, slmSyslogDestAddress=slmSyslogDestAddress, slmSysUplinkRate=slmSysUplinkRate, slmPmAvailable=slmPmAvailable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysMode=slmSysMode, slm40GConf=slm40GConf, slmSysName=slmSysName, slmMuxNumber=slmMuxNumber, slmAdminPassword=slmAdminPassword, slmSysNetworkPrefix=slmSysNetworkPrefix, slmConfigSysSignalType=slmConfigSysSignalType, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapPort=slmTrapPort, slmAdminCommunity=slmAdminCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestAddress=slmTrapDestAddress, slmSys=slmSys, slmAdminLogin=slmAdminLogin, slmSwRevDirectory=slmSwRevDirectory, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogEntry=slmTrapLogEntry, SoftwareRevision=SoftwareRevision, slmSysTemperature=slmSysTemperature, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapDestProtVersion=slmTrapDestProtVersion, slmChPassEntry=slmChPassEntry, slmSysCalendarTime=slmSysCalendarTime, slMain=slMain, slmAdmin=slmAdmin, slmAuth=slmAuth, slmChPass=slmChPass, slmAuthPassword=slmAuthPassword, slmSysSnmpVersion=slmSysSnmpVersion, slmNetworkMode=slmNetworkMode, slmTrapUserAccess=slmTrapUserAccess, slmAuthLogin=slmAuthLogin, slmAdminAccess=slmAdminAccess, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevStatus=slmSwRevStatus)
