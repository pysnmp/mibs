...
Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, Counter64, ObjectIdentity, TimeTicks, Counter32, Opaque, Unsigned32, MibIdentifier, Gauge32, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "Counter64", "ObjectIdentity", "TimeTicks", "Counter32", "Opaque", "Unsigned32", "MibIdentifier", "Gauge32", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmPmAvailable=slmPmAvailable, slmTrapLogParam1=slmTrapLogParam1, slmTrapPort=slmTrapPort, slmTrapCommunity=slmTrapCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevName=slmSwRevName, slmSysActiveSwVersion=slmSysActiveSwVersion, slmNetworkMode=slmNetworkMode, slmSysIpAddr=slmSysIpAddr, slmSysTrapFormat=slmSysTrapFormat, slmLicenseEntry=slmLicenseEntry, slmSysResetPm=slmSysResetPm, slmLicenseIndex=slmLicenseIndex, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysCalendarTime=slmSysCalendarTime, slmRebootDelay=slmRebootDelay, UserCommunity=UserCommunity, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogLevel=slmSyslogLevel, slmTrapLogName=slmTrapLogName, slmOemType=slmOemType, UserPassword=UserPassword, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPassOldPass=slmChPassOldPass, slmLogin=slmLogin, slmTrapLogParam4=slmTrapLogParam4, slmChPassTable=slmChPassTable, slmTrapUserLogin=slmTrapUserLogin, slmLicenseTable=slmLicenseTable, slmTrapLogParam3=slmTrapLogParam3, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam6=slmTrapLogParam6, slmChPassEntry=slmChPassEntry, slmLicenseExpiration=slmLicenseExpiration, slm40GConf=slm40GConf, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysTemperature=slmSysTemperature, slmSysLanIpAddr=slmSysLanIpAddr, slmSysAlmAct=slmSysAlmAct, slmLicenseId=slmLicenseId, slmSnmpv3Password=slmSnmpv3Password, slmAdminCommunity=slmAdminCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmAuthCommunity=slmAuthCommunity, slmSwRevDate=slmSwRevDate, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogDestEntry=slmSyslogDestEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmSysChassisId=slmSysChassisId, slmPortsNumber=slmPortsNumber, slmWriteCommunity=slmWriteCommunity, slmSysUplinkRate=slmSysUplinkRate, slmAuthLogin=slmAuthLogin, slmSysLocation=slmSysLocation, slmTrapDestEntry=slmTrapDestEntry, slmMuxNumber=slmMuxNumber, slmSysAlmDeact=slmSysAlmDeact, AdminAccess=AdminAccess, slmSysOperStatus=slmSysOperStatus, slmAdminTable=slmAdminTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPassLogin=slmChPassLogin, slmLogFile=slmLogFile, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestCommunity=slmTrapDestCommunity, slmSysMode=slmSysMode, slmTrapLogEntry=slmTrapLogEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmChPassNewPass=slmChPassNewPass, SoftwareRevision=SoftwareRevision, PYSNMP_MODULE_ID=slMain, slmVcatDelay=slmVcatDelay, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam5=slmTrapLogParam5, slmSysName=slmSysName, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapUserAccess=slmTrapUserAccess, slmTrap=slmTrap, slmAuthTable=slmAuthTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogId=slmTrapLogId, slmTrapLogParam2=slmTrapLogParam2, UserLogin=UserLogin, slmChPass=slmChPass, slmTrapDestTable=slmTrapDestTable, slmSys=slmSys, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdmin=slmAdmin, slmAuth=slmAuth, slmTrapEnable=slmTrapEnable, slmTrapLogTable=slmTrapLogTable, slmLicense=slmLicense, slmConfigFile=slmConfigFile, slmPsuNumber=slmPsuNumber, slmAdminPassword=slmAdminPassword, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevStatus=slmSwRevStatus, slmSyslogDestTable=slmSyslogDestTable, slmAuthPassword=slmAuthPassword, slmSwRevTable=slmSwRevTable, slmTopologyEnabled=slmTopologyEnabled, slmSwRevEntry=slmSwRevEntry, slmBoxSize=slmBoxSize, slmAdminEntry=slmAdminEntry, slmAdminAccess=slmAdminAccess, slmSysSnmpVersion=slmSysSnmpVersion, slmReadCommunity=slmReadCommunity, slMain=slMain, slmSyslogPort=slmSyslogPort, slmSysSubnetMask=slmSysSubnetMask, slmConfigSysSignalType=slmConfigSysSignalType, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapSysNameChange=slmTrapSysNameChange, slmRstpEnabled=slmRstpEnabled, slmEdfaNumber=slmEdfaNumber, slmSysAdminStatus=slmSysAdminStatus, slmAdminLogin=slmAdminLogin, slmAuthEntry=slmAuthEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTid=slmTid, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminRowStatus=slmAdminRowStatus)
