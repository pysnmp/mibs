...
ObjectIdentity, NotificationType, Bits, Gauge32, Integer32, ModuleIdentity, Unsigned32, MibIdentifier, IpAddress, Opaque, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "Bits", "Gauge32", "Integer32", "ModuleIdentity", "Unsigned32", "MibIdentifier", "IpAddress", "Opaque", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmEdfaNumber=slmEdfaNumber, slmTrapDestTable=slmTrapDestTable, slmSysAlmAct=slmSysAlmAct, slmTrapLogParam6=slmTrapLogParam6, slmRebootDelay=slmRebootDelay, slmSwRevTable=slmSwRevTable, slmLicenseId=slmLicenseId, slmAuth=slmAuth, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestCommunity=slmTrapDestCommunity, slmChPassLogin=slmChPassLogin, slmPsuNumber=slmPsuNumber, SoftwareRevision=SoftwareRevision, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestEntry=slmTrapDestEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrap=slmTrap, slmLicenseEntry=slmLicenseEntry, PYSNMP_MODULE_ID=slMain, slmAdminAccess=slmAdminAccess, slmTrapUserAccess=slmTrapUserAccess, slmAdminLogin=slmAdminLogin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysLanIpAddr=slmSysLanIpAddr, UserPassword=UserPassword, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogParam1=slmTrapLogParam1, slmSyslogPort=slmSyslogPort, slmSysTrapFormat=slmSysTrapFormat, slmSyslogDestTable=slmSyslogDestTable, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevStatus=slmSwRevStatus, slmTrapUserLogin=slmTrapUserLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmOemType=slmOemType, slmSysTemperature=slmSysTemperature, slmSnmpv3Password=slmSnmpv3Password, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysIpAddr=slmSysIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAuthTable=slmAuthTable, slmChPassTable=slmChPassTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogParam2=slmTrapLogParam2, slmSysAlmDeact=slmSysAlmDeact, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapPort=slmTrapPort, slmTopologyEnabled=slmTopologyEnabled, slmSwRevDate=slmSwRevDate, slmLogFile=slmLogFile, slmAuthPassword=slmAuthPassword, AdminAccess=AdminAccess, slmConfigSysSignalType=slmConfigSysSignalType, slmAuthEntry=slmAuthEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminTable=slmAdminTable, slmChPassEntry=slmChPassEntry, slmLicenseIndex=slmLicenseIndex, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmRstpEnabled=slmRstpEnabled, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogTable=slmTrapLogTable, slmAdmin=slmAdmin, slmSysSnmpVersion=slmSysSnmpVersion, slmChPass=slmChPass, slmSnmpv3Priv=slmSnmpv3Priv, slmTid=slmTid, slmPmAvailable=slmPmAvailable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapSysNameChange=slmTrapSysNameChange, slmChPassOldPass=slmChPassOldPass, slmSysOperStatus=slmSysOperStatus, slm40GConf=slm40GConf, slmSwRevName=slmSwRevName, UserLogin=UserLogin, slmSyslogLevel=slmSyslogLevel, slmSysName=slmSysName, slmOpticalSwitchExist=slmOpticalSwitchExist, slmConfigFile=slmConfigFile, slmLicenseExpiration=slmLicenseExpiration, slmNetworkMode=slmNetworkMode, slmVcatDelay=slmVcatDelay, slmLicenseTable=slmLicenseTable, slmSwRevDirectory=slmSwRevDirectory, slmSys=slmSys, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogName=slmTrapLogName, slmSysCalendarTime=slmSysCalendarTime, slmReadCommunity=slmReadCommunity, slmAdminPassword=slmAdminPassword, slmWriteCommunity=slmWriteCommunity, slmSyslogDestAddress=slmSyslogDestAddress, slmMuxNumber=slmMuxNumber, slmSysChassisId=slmSysChassisId, slmLogin=slmLogin, slmAuthLogin=slmAuthLogin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmChPassNewPass=slmChPassNewPass, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam5=slmTrapLogParam5, UserCommunity=UserCommunity, slMain=slMain, slmSysLocation=slmSysLocation, slmSysUplinkRate=slmSysUplinkRate, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysResetPm=slmSysResetPm, slmBoxSize=slmBoxSize, slmAdminCommunity=slmAdminCommunity, slmSysMode=slmSysMode, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevEntry=slmSwRevEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmPortsNumber=slmPortsNumber, slmAuthCommunity=slmAuthCommunity, slmTrapCommunity=slmTrapCommunity, slmTrapLogEntry=slmTrapLogEntry, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogId=slmTrapLogId, slmTrapEnable=slmTrapEnable, slmAdminEntry=slmAdminEntry, slmLicense=slmLicense, slmTrapLogParam3=slmTrapLogParam3, slmSyslogDestEntry=slmSyslogDestEntry, slmSysActiveSwVersion=slmSysActiveSwVersion)
