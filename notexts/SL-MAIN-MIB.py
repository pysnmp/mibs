...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmOemType=slmOemType, slmAuthEntry=slmAuthEntry, slmSwRevStatus=slmSwRevStatus, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmRebootDelay=slmRebootDelay, slmLicense=slmLicense, slmLicenseExpiration=slmLicenseExpiration, slmAuthPassword=slmAuthPassword, slmTrapLogEntry=slmTrapLogEntry, slmAdminLogin=slmAdminLogin, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogId=slmTrapLogId, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLogin=slmLogin, slmConfigFile=slmConfigFile, slmTrapDestIpAddress=slmTrapDestIpAddress, slmNetworkMode=slmNetworkMode, slmLogFile=slmLogFile, slmAuthLogin=slmAuthLogin, slmAuth=slmAuth, slmConfigSysUptime=slmConfigSysUptime, slmOpticalSwitchExist=slmOpticalSwitchExist, slmPsuNumber=slmPsuNumber, slmChPassEntry=slmChPassEntry, slmPortsNumber=slmPortsNumber, slmSysChassisId=slmSysChassisId, AdminAccess=AdminAccess, slmTrapDestEntry=slmTrapDestEntry, slmWriteCommunity=slmWriteCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysNetworkPrefix=slmSysNetworkPrefix, slmRstpEnabled=slmRstpEnabled, slmTrapPort=slmTrapPort, slmSysLanIpAddr=slmSysLanIpAddr, slmReadCommunity=slmReadCommunity, slmSyslogPort=slmSyslogPort, UserLogin=UserLogin, slmTrapDestAddress=slmTrapDestAddress, slmSysActiveSwVersion=slmSysActiveSwVersion, slmEdfaNumber=slmEdfaNumber, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysOperStatus=slmSysOperStatus, UserPassword=UserPassword, UserCommunity=UserCommunity, slmTrapUserLogin=slmTrapUserLogin, slmPmAvailable=slmPmAvailable, slmChPassNewPass=slmChPassNewPass, slmTrapLogName=slmTrapLogName, slmSwRevDate=slmSwRevDate, slmTrapLogParam2=slmTrapLogParam2, slmSysTemperature=slmSysTemperature, SoftwareRevision=SoftwareRevision, slmTrapLogParam4=slmTrapLogParam4, slmSysTrapFormat=slmSysTrapFormat, slmAuthTable=slmAuthTable, slmChPassLogin=slmChPassLogin, slmSyslogDestAddress=slmSyslogDestAddress, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogLevel=slmSyslogLevel, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmTrapEnable=slmTrapEnable, slmChPass=slmChPass, slmTrapDestTable=slmTrapDestTable, slmSysResetPm=slmSysResetPm, slmTrap=slmTrap, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLicenseIndex=slmLicenseIndex, slmSys=slmSys, slmTrapLogParam3=slmTrapLogParam3, slmAdmin=slmAdmin, slmTrapLogTable=slmTrapLogTable, slmSysAdminStatus=slmSysAdminStatus, slmAuthCommunity=slmAuthCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLocation=slmSysLocation, slmBoxSize=slmBoxSize, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTid=slmTid, slmTrapLogParam1=slmTrapLogParam1, slmLicenseTable=slmLicenseTable, slmSwRevTable=slmSwRevTable, slmTopologyEnabled=slmTopologyEnabled, slmTrapCommunity=slmTrapCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPassOldPass=slmChPassOldPass, slmSysName=slmSysName, slMain=slMain, slmSysAlmAct=slmSysAlmAct, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysMode=slmSysMode, slmMuxNumber=slmMuxNumber, slmSwRevEntry=slmSwRevEntry, slmSysSubnetMask=slmSysSubnetMask, slmAdminEntry=slmAdminEntry, slmTrapUserAccess=slmTrapUserAccess, slmConfigSysSignalType=slmConfigSysSignalType, slmSnmpv3Priv=slmSnmpv3Priv, slmSysAlmDeact=slmSysAlmDeact, slmSyslogDestTable=slmSyslogDestTable, slmSysUplinkRate=slmSysUplinkRate, slm40GConf=slm40GConf, slmSwRevDirectory=slmSwRevDirectory, slmLicenseId=slmLicenseId, slmSyslogDestEntry=slmSyslogDestEntry, slmSysCalendarTime=slmSysCalendarTime, slmSwRevName=slmSwRevName, slmAdminPassword=slmAdminPassword, slmAdminTable=slmAdminTable, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam5=slmTrapLogParam5, slmSnmpv3Auth=slmSnmpv3Auth, slmChPassTable=slmChPassTable, slmLicenseEntry=slmLicenseEntry, slmSysIpAddr=slmSysIpAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmVcatDelay=slmVcatDelay, PYSNMP_MODULE_ID=slMain, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSnmpv3Password=slmSnmpv3Password, slmAdminAccess=slmAdminAccess, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange)
