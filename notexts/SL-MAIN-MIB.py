...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmOemType=slmOemType, slmSysAlmDeact=slmSysAlmDeact, slmTrapDestAddress=slmTrapDestAddress, slmSysCalendarTime=slmSysCalendarTime, slmSysTemperature=slmSysTemperature, slmTrapLogParam5=slmTrapLogParam5, slmEdfaNumber=slmEdfaNumber, slmAuthLogin=slmAuthLogin, slmTrapLogTable=slmTrapLogTable, slmSnmpv3Auth=slmSnmpv3Auth, slmLogFile=slmLogFile, slmLicenseEntry=slmLicenseEntry, slmAdminPassword=slmAdminPassword, slmSysLanIpAddr=slmSysLanIpAddr, slmLicenseId=slmLicenseId, slmAuth=slmAuth, slmTrap=slmTrap, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmConfigFile=slmConfigFile, slmChPassEntry=slmChPassEntry, slmSwRevName=slmSwRevName, slmTrapLogParam3=slmTrapLogParam3, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapSysLocationChange=slmTrapSysLocationChange, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysAdminStatus=slmSysAdminStatus, UserLogin=UserLogin, slmSysUplinkRate=slmSysUplinkRate, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLicenseTable=slmLicenseTable, slmSysResetPm=slmSysResetPm, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysIpAddr=slmSysIpAddr, slmPortsNumber=slmPortsNumber, AdminAccess=AdminAccess, slmSysGatewayAddr=slmSysGatewayAddr, slmSysLocation=slmSysLocation, slmLogin=slmLogin, slmAdminAccess=slmAdminAccess, slmChPassLogin=slmChPassLogin, slmChPass=slmChPass, slmTrapDestEntry=slmTrapDestEntry, slmSwRevDirectory=slmSwRevDirectory, slmBoxSize=slmBoxSize, slmPsuNumber=slmPsuNumber, slmTrapDestTable=slmTrapDestTable, slmReadCommunity=slmReadCommunity, slmSnmpv3Password=slmSnmpv3Password, slmLicenseIndex=slmLicenseIndex, slmSysChassisId=slmSysChassisId, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevStatus=slmSwRevStatus, slmChPassNewPass=slmChPassNewPass, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminRowStatus=slmAdminRowStatus, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmSwRevTable=slmSwRevTable, slmLicenseExpiration=slmLicenseExpiration, slmAdminTable=slmAdminTable, slmSyslogDestEntry=slmSyslogDestEntry, slmRebootDelay=slmRebootDelay, slmAdminLogin=slmAdminLogin, slmSys=slmSys, slmAuthPassword=slmAuthPassword, slmTrapLogParam4=slmTrapLogParam4, slmTid=slmTid, slmSyslogDestAddress=slmSyslogDestAddress, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSyslogPort=slmSyslogPort, slmTrapUserAccess=slmTrapUserAccess, slmTrapPort=slmTrapPort, SoftwareRevision=SoftwareRevision, slmTrapUserLogin=slmTrapUserLogin, slmLicense=slmLicense, slmTopologyEnabled=slmTopologyEnabled, slmVcatDelay=slmVcatDelay, slmSysOperStatus=slmSysOperStatus, slmSysEncryptionCapability=slmSysEncryptionCapability, slmRstpEnabled=slmRstpEnabled, slmChPassOldPass=slmChPassOldPass, slmSysMode=slmSysMode, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam6=slmTrapLogParam6, slMain=slMain, PYSNMP_MODULE_ID=slMain, slmPmAvailable=slmPmAvailable, slmAuthEntry=slmAuthEntry, slmChPassTable=slmChPassTable, slmTrapLogName=slmTrapLogName, slmConfigSysUptime=slmConfigSysUptime, slm40GConf=slm40GConf, slmWriteCommunity=slmWriteCommunity, slmAuthTable=slmAuthTable, slmTrapEnable=slmTrapEnable, slmAdmin=slmAdmin, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestCommunity=slmTrapDestCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestTable=slmSyslogDestTable, slmMuxNumber=slmMuxNumber, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAuthCommunity=slmAuthCommunity, slmNetworkMode=slmNetworkMode, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam1=slmTrapLogParam1, slmSysSubnetMask=slmSysSubnetMask, UserPassword=UserPassword, slmAdminEntry=slmAdminEntry, slmAdminCommunity=slmAdminCommunity, slmSyslogLevel=slmSyslogLevel, slmSysAlmAct=slmSysAlmAct, UserCommunity=UserCommunity, slmSwRevEntry=slmSwRevEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogId=slmTrapLogId, slmTrapLogParam2=slmTrapLogParam2, slmSysName=slmSysName, slmSwRevDate=slmSwRevDate)
