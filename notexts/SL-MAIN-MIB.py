...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysAlmDeact=slmSysAlmDeact, slmSwRevName=slmSwRevName, slmSyslogPort=slmSyslogPort, slmTrapLogParam1=slmTrapLogParam1, slmLicenseId=slmLicenseId, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam2=slmTrapLogParam2, slmSysMode=slmSysMode, slmTrapDestEntry=slmTrapDestEntry, slmTopologyEnabled=slmTopologyEnabled, slmAdminRowStatus=slmAdminRowStatus, slmTrapSysLocationChange=slmTrapSysLocationChange, slmConfigFile=slmConfigFile, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogParam3=slmTrapLogParam3, slmSysUplinkRate=slmSysUplinkRate, slmSysAlmAct=slmSysAlmAct, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminAccess=slmAdminAccess, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminTable=slmAdminTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLogFile=slmLogFile, slmAdminLogin=slmAdminLogin, slmRebootDelay=slmRebootDelay, slmSnmpv3Auth=slmSnmpv3Auth, slmEdfaNumber=slmEdfaNumber, slmSys=slmSys, slmWriteCommunity=slmWriteCommunity, slmSnmpv3Password=slmSnmpv3Password, slmAuthCommunity=slmAuthCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseExpiration=slmLicenseExpiration, UserCommunity=UserCommunity, PYSNMP_MODULE_ID=slMain, slmSyslogLevel=slmSyslogLevel, slmSysSubnetMask=slmSysSubnetMask, UserPassword=UserPassword, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam5=slmTrapLogParam5, slmTrapEnable=slmTrapEnable, slmSysChassisId=slmSysChassisId, slmChPassOldPass=slmChPassOldPass, slmTrapUserLogin=slmTrapUserLogin, slmChPassNewPass=slmChPassNewPass, slmAdmin=slmAdmin, slmMuxNumber=slmMuxNumber, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapPort=slmTrapPort, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysIpAddr=slmSysIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmChPassEntry=slmChPassEntry, slmTrapLogEntry=slmTrapLogEntry, slmSysResetPm=slmSysResetPm, slmOemType=slmOemType, slmSysTemperature=slmSysTemperature, slmSyslogDestAddress=slmSyslogDestAddress, slmSysTrapFormat=slmSysTrapFormat, slmTrapCommunity=slmTrapCommunity, slmTrapUserAccess=slmTrapUserAccess, slmChPass=slmChPass, slmTrapDestAddress=slmTrapDestAddress, slmAdminCommunity=slmAdminCommunity, slmPsuNumber=slmPsuNumber, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogDestTable=slmSyslogDestTable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuthPassword=slmAuthPassword, slmSysEncryptionCapability=slmSysEncryptionCapability, slMain=slMain, slmTrapLogParam6=slmTrapLogParam6, slmNetworkMode=slmNetworkMode, slmAuthLogin=slmAuthLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicense=slmLicense, slmTrapSysNameChange=slmTrapSysNameChange, slmConfigSysUptime=slmConfigSysUptime, slmLicenseIndex=slmLicenseIndex, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysName=slmSysName, slmSysOperStatus=slmSysOperStatus, slmAuthEntry=slmAuthEntry, slmTrapLogName=slmTrapLogName, slmTrapLogParam4=slmTrapLogParam4, UserLogin=UserLogin, slmAdminEntry=slmAdminEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysLocation=slmSysLocation, slmLogin=slmLogin, slmLicenseEntry=slmLicenseEntry, slmVcatDelay=slmVcatDelay, slmBoxSize=slmBoxSize, slmPortsNumber=slmPortsNumber, slmTrap=slmTrap, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestCommunity=slmTrapDestCommunity, SoftwareRevision=SoftwareRevision, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAuth=slmAuth, slmSysAdminStatus=slmSysAdminStatus, slmSwRevDate=slmSwRevDate, slmPmAvailable=slmPmAvailable, slmAdminPassword=slmAdminPassword, AdminAccess=AdminAccess, slmChPassTable=slmChPassTable, slmSwRevStatus=slmSwRevStatus, slm40GConf=slm40GConf, slmSwRevTable=slmSwRevTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysCalendarTime=slmSysCalendarTime, slmRstpEnabled=slmRstpEnabled, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogId=slmTrapLogId, slmLicenseTable=slmLicenseTable, slmAuthTable=slmAuthTable, slmReadCommunity=slmReadCommunity, slmChPassLogin=slmChPassLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTid=slmTid, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogTable=slmTrapLogTable)
