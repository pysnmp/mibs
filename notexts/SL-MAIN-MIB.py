...
Bits, IpAddress, Gauge32, Opaque, iso, Counter32, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, NotificationType, Counter64, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "Gauge32", "Opaque", "iso", "Counter32", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "NotificationType", "Counter64", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmRebootDelay=slmRebootDelay, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogParam4=slmTrapLogParam4, slm40GConf=slm40GConf, slmSys=slmSys, slmTrapLogParam3=slmTrapLogParam3, slmConfigSysSignalType=slmConfigSysSignalType, slmSysEncryptionCapability=slmSysEncryptionCapability, slmChPassEntry=slmChPassEntry, slmSysCalendarTime=slmSysCalendarTime, slmSyslogPort=slmSyslogPort, slmSysActiveSwVersion=slmSysActiveSwVersion, slmWriteCommunity=slmWriteCommunity, slmAdminLogin=slmAdminLogin, slmSysMode=slmSysMode, slmConfigFile=slmConfigFile, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmVcatDelay=slmVcatDelay, slmSyslogDestTable=slmSyslogDestTable, slmSyslogDestAddress=slmSyslogDestAddress, slmAdmin=slmAdmin, slmPsuNumber=slmPsuNumber, slmTrapDestCommunity=slmTrapDestCommunity, UserPassword=UserPassword, slmSwRevStatus=slmSwRevStatus, slmLicenseEntry=slmLicenseEntry, slmSysResetPm=slmSysResetPm, slmTrapLogParam6=slmTrapLogParam6, slmLicenseExpiration=slmLicenseExpiration, slMain=slMain, slmAuth=slmAuth, slmSysUplinkRate=slmSysUplinkRate, slmSysName=slmSysName, slmAuthEntry=slmAuthEntry, slmOemType=slmOemType, slmTrapLogTable=slmTrapLogTable, slmPmAvailable=slmPmAvailable, slmConfigSysUptime=slmConfigSysUptime, slmNetworkMode=slmNetworkMode, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSwRevEntry=slmSwRevEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAuthPassword=slmAuthPassword, slmAdminPassword=slmAdminPassword, slmTrapLogEntry=slmTrapLogEntry, slmTrap=slmTrap, slmAdminEntry=slmAdminEntry, slmSysOperStatus=slmSysOperStatus, slmSysSubnetMask=slmSysSubnetMask, slmSwRevDirectory=slmSwRevDirectory, UserCommunity=UserCommunity, slmSysLocation=slmSysLocation, slmSysAdminStatus=slmSysAdminStatus, slmTopologyEnabled=slmTopologyEnabled, slmTid=slmTid, slmChPassOldPass=slmChPassOldPass, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam2=slmTrapLogParam2, slmLicenseId=slmLicenseId, slmChPassNewPass=slmChPassNewPass, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestEntry=slmTrapDestEntry, slmSysChassisId=slmSysChassisId, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSyslogLevel=slmSyslogLevel, slmChPass=slmChPass, slmAdminTable=slmAdminTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysAlmDeact=slmSysAlmDeact, slmSwRevName=slmSwRevName, slmAdminCommunity=slmAdminCommunity, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestTable=slmTrapDestTable, slmLogFile=slmLogFile, slmPortsNumber=slmPortsNumber, slmSysSnmpVersion=slmSysSnmpVersion, slmSysTrapFormat=slmSysTrapFormat, PYSNMP_MODULE_ID=slMain, slmLicense=slmLicense, slmAuthLogin=slmAuthLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam5=slmTrapLogParam5, AdminAccess=AdminAccess, slmTrapLogParam1=slmTrapLogParam1, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapPort=slmTrapPort, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysIpAddr=slmSysIpAddr, slmTrapEnable=slmTrapEnable, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminAccess=slmAdminAccess, slmSwRevTable=slmSwRevTable, slmChPassTable=slmChPassTable, slmTrapLogName=slmTrapLogName, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestAddress=slmTrapDestAddress, slmRstpEnabled=slmRstpEnabled, UserLogin=UserLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevDate=slmSwRevDate, SoftwareRevision=SoftwareRevision, slmEdfaNumber=slmEdfaNumber, slmSnmpv3Password=slmSnmpv3Password, slmTrapCommunity=slmTrapCommunity, slmLicenseIndex=slmLicenseIndex, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmMuxNumber=slmMuxNumber, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysAlmAct=slmSysAlmAct, slmLicenseTable=slmLicenseTable, slmBoxSize=slmBoxSize, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysTemperature=slmSysTemperature, slmAuthCommunity=slmAuthCommunity, slmChPassLogin=slmChPassLogin, slmAuthTable=slmAuthTable, slmTrapLogId=slmTrapLogId, slmReadCommunity=slmReadCommunity, slmLogin=slmLogin, slmTrapSysNameChange=slmTrapSysNameChange)
