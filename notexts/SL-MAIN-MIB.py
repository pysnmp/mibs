...
Gauge32, ModuleIdentity, Opaque, Unsigned32, Counter32, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, iso, TimeTicks, MibIdentifier, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "Opaque", "Unsigned32", "Counter32", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "iso", "TimeTicks", "MibIdentifier", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogParam2=slmTrapLogParam2, slmTrapLogName=slmTrapLogName, slmReadCommunity=slmReadCommunity, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogId=slmTrapLogId, slmTrapSysLocationChange=slmTrapSysLocationChange, slmConfigFile=slmConfigFile, slmPmAvailable=slmPmAvailable, slmLicenseEntry=slmLicenseEntry, slmSysTemperature=slmSysTemperature, slmAdminAccess=slmAdminAccess, slmTopologyEnabled=slmTopologyEnabled, slmPsuNumber=slmPsuNumber, slmSysAlmDeact=slmSysAlmDeact, slmSysAdminStatus=slmSysAdminStatus, slmSysIpAddr=slmSysIpAddr, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestAddress=slmTrapDestAddress, slmSysSubnetMask=slmSysSubnetMask, slmLicenseExpiration=slmLicenseExpiration, slmSysAlmAct=slmSysAlmAct, slmTrap=slmTrap, slmSnmpv3Auth=slmSnmpv3Auth, slmChPassEntry=slmChPassEntry, slmAdminRowStatus=slmAdminRowStatus, slmLogin=slmLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slm40GConf=slm40GConf, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPassTable=slmChPassTable, slmConfigSysUptime=slmConfigSysUptime, slmRebootDelay=slmRebootDelay, slmTrapLogParam1=slmTrapLogParam1, slmSysCalendarTime=slmSysCalendarTime, slmAdminPassword=slmAdminPassword, slmTrapDestProtVersion=slmTrapDestProtVersion, slmChPassLogin=slmChPassLogin, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestEntry=slmTrapDestEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam3=slmTrapLogParam3, slmPortsNumber=slmPortsNumber, slmTrapPort=slmTrapPort, slmSyslogLevel=slmSyslogLevel, slmChPassOldPass=slmChPassOldPass, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSwRevDate=slmSwRevDate, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicenseId=slmLicenseId, slmVcatDelay=slmVcatDelay, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSwRevTable=slmSwRevTable, slmSysMode=slmSysMode, AdminAccess=AdminAccess, slmAuthTable=slmAuthTable, slmBoxSize=slmBoxSize, UserPassword=UserPassword, slmLicense=slmLicense, PYSNMP_MODULE_ID=slMain, slmAuthPassword=slmAuthPassword, slmSysChassisId=slmSysChassisId, slmSysLanIpAddr=slmSysLanIpAddr, slmSnmpv3Password=slmSnmpv3Password, slmWriteCommunity=slmWriteCommunity, slmNetworkMode=slmNetworkMode, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminTable=slmAdminTable, slmLogFile=slmLogFile, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestCommunity=slmTrapDestCommunity, slmAuth=slmAuth, slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPass=slmChPass, slMain=slMain, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuthCommunity=slmAuthCommunity, UserLogin=UserLogin, slmSysSnmpVersion=slmSysSnmpVersion, slmTid=slmTid, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminLogin=slmAdminLogin, slmLicenseTable=slmLicenseTable, UserCommunity=UserCommunity, slmChPassNewPass=slmChPassNewPass, slmSysUplinkRate=slmSysUplinkRate, slmMuxNumber=slmMuxNumber, slmSysGatewayAddr=slmSysGatewayAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevStatus=slmSwRevStatus, slmSwRevName=slmSwRevName, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSys=slmSys, slmEdfaNumber=slmEdfaNumber, slmAdmin=slmAdmin, slmTrapEnable=slmTrapEnable, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam5=slmTrapLogParam5, slmSysName=slmSysName, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysResetPm=slmSysResetPm, slmSyslogDestTable=slmSyslogDestTable, slmAuthEntry=slmAuthEntry, slmAdminEntry=slmAdminEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmRstpEnabled=slmRstpEnabled, SoftwareRevision=SoftwareRevision, slmTrapUserAccess=slmTrapUserAccess, slmSysOperStatus=slmSysOperStatus, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogPort=slmSyslogPort, slmSwRevEntry=slmSwRevEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysTrapFormat=slmSysTrapFormat, slmLicenseIndex=slmLicenseIndex, slmTrapLogParam4=slmTrapLogParam4, slmSysLocation=slmSysLocation, slmAuthLogin=slmAuthLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapCommunity=slmTrapCommunity, slmTrapDestTable=slmTrapDestTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmOemType=slmOemType, slmSnmpv3Priv=slmSnmpv3Priv)
