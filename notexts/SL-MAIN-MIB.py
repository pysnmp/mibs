...
TimeTicks, Unsigned32, Gauge32, Integer32, Counter32, MibIdentifier, IpAddress, Counter64, Bits, ModuleIdentity, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "Gauge32", "Integer32", "Counter32", "MibIdentifier", "IpAddress", "Counter64", "Bits", "ModuleIdentity", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Opaque")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmPmAvailable=slmPmAvailable, slmConfigSysSignalType=slmConfigSysSignalType, slmSysMode=slmSysMode, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevStatus=slmSwRevStatus, slmTrapDestAddress=slmTrapDestAddress, UserCommunity=UserCommunity, slmAuthEntry=slmAuthEntry, slmReadCommunity=slmReadCommunity, slmAdminTable=slmAdminTable, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestAddress=slmSyslogDestAddress, slmChPassEntry=slmChPassEntry, slmSwRevDirectory=slmSwRevDirectory, slmLicenseEntry=slmLicenseEntry, slmSyslogDestTable=slmSyslogDestTable, slmBoxSize=slmBoxSize, slmTrapDestIpAddress=slmTrapDestIpAddress, slmOemType=slmOemType, slm40GConf=slm40GConf, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmEdfaNumber=slmEdfaNumber, slmSysAlmDeact=slmSysAlmDeact, slmSysName=slmSysName, slmAdminEntry=slmAdminEntry, slmSnmpv3Password=slmSnmpv3Password, slmChPass=slmChPass, slmRstpEnabled=slmRstpEnabled, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogName=slmTrapLogName, slmTrapLogParam1=slmTrapLogParam1, slmSyslogPort=slmSyslogPort, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogTable=slmTrapLogTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAuth=slmAuth, slmChPassTable=slmChPassTable, slmPsuNumber=slmPsuNumber, slmLicenseTable=slmLicenseTable, slmSysLanIpAddr=slmSysLanIpAddr, slmAdminAccess=slmAdminAccess, UserPassword=UserPassword, slmSysAdminStatus=slmSysAdminStatus, slmChPassOldPass=slmChPassOldPass, slmSysActiveSwVersion=slmSysActiveSwVersion, SoftwareRevision=SoftwareRevision, slmChPassNewPass=slmChPassNewPass, slmLogFile=slmLogFile, slmLicense=slmLicense, slmTrapUserAccess=slmTrapUserAccess, slmSysChassisId=slmSysChassisId, slmAdminLogin=slmAdminLogin, slmTrapEnable=slmTrapEnable, slmSysOperStatus=slmSysOperStatus, slmSysIpAddr=slmSysIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, UserLogin=UserLogin, slmLicenseExpiration=slmLicenseExpiration, slmAuthPassword=slmAuthPassword, slmTrapLogEntry=slmTrapLogEntry, slmLicenseId=slmLicenseId, slmTrapCommunity=slmTrapCommunity, slmNetworkMode=slmNetworkMode, slmAdminCommunity=slmAdminCommunity, slmSyslogLevel=slmSyslogLevel, slmPortsNumber=slmPortsNumber, slmTrapSysNameChange=slmTrapSysNameChange, slmSysTrapFormat=slmSysTrapFormat, slmRebootDelay=slmRebootDelay, slmSysUplinkRate=slmSysUplinkRate, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSys=slmSys, slmAuthTable=slmAuthTable, slmSysTemperature=slmSysTemperature, slmVcatDelay=slmVcatDelay, slmTrapLogParam3=slmTrapLogParam3, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapPort=slmTrapPort, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestTable=slmTrapDestTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapUserLogin=slmTrapUserLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysSubnetMask=slmSysSubnetMask, AdminAccess=AdminAccess, slmTrapDestCommunity=slmTrapDestCommunity, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogId=slmTrapLogId, slmLogin=slmLogin, slmSwRevTable=slmSwRevTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysLocation=slmSysLocation, slmAdminPassword=slmAdminPassword, slmConfigSysUptime=slmConfigSysUptime, slmTid=slmTid, slmSwRevDate=slmSwRevDate, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestRowStatus=slmTrapDestRowStatus, slmMuxNumber=slmMuxNumber, slmTrapLogParam2=slmTrapLogParam2, slmAdmin=slmAdmin, slmSwRevName=slmSwRevName, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuthCommunity=slmAuthCommunity, slmTopologyEnabled=slmTopologyEnabled, slmSysGatewayAddr=slmSysGatewayAddr, slmConfigFile=slmConfigFile, slMain=slMain, slmChPassLogin=slmChPassLogin, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam6=slmTrapLogParam6, slmAuthLogin=slmAuthLogin, slmLicenseIndex=slmLicenseIndex, slmSwRevEntry=slmSwRevEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysResetPm=slmSysResetPm, slmTrap=slmTrap, slmTrapLogParam4=slmTrapLogParam4, slmSnmpv3Priv=slmSnmpv3Priv, PYSNMP_MODULE_ID=slMain, slmSysAlmAct=slmSysAlmAct, slmWriteCommunity=slmWriteCommunity)
