...
Counter32, MibIdentifier, Bits, ObjectIdentity, TimeTicks, NotificationType, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, Unsigned32, iso, Counter64, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "Bits", "ObjectIdentity", "TimeTicks", "NotificationType", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "Unsigned32", "iso", "Counter64", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestAddress=slmTrapDestAddress, slmSyslogLevel=slmSyslogLevel, slmTrapLogParam6=slmTrapLogParam6, slmSysPmStartOfDay=slmSysPmStartOfDay, slmMuxNumber=slmMuxNumber, slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPass=slmChPass, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogId=slmTrapLogId, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogTable=slmTrapLogTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysOperStatus=slmSysOperStatus, slmSysAlmAct=slmSysAlmAct, SoftwareRevision=SoftwareRevision, slmConfigSysUptime=slmConfigSysUptime, slmChPassTable=slmChPassTable, slmSysIpAddr=slmSysIpAddr, slmLicenseId=slmLicenseId, slmTrapLogParam3=slmTrapLogParam3, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmSysChassisId=slmSysChassisId, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLogin=slmLogin, slmEdfaNumber=slmEdfaNumber, slmRebootDelay=slmRebootDelay, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminLogin=slmAdminLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestTable=slmTrapDestTable, slmTrapUserAccess=slmTrapUserAccess, slmLicense=slmLicense, slmSnmpv3Auth=slmSnmpv3Auth, slmSysSubnetMask=slmSysSubnetMask, slmSysMode=slmSysMode, slmLogFile=slmLogFile, slmTrapPort=slmTrapPort, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogName=slmTrapLogName, PYSNMP_MODULE_ID=slMain, slmTrapSysNameChange=slmTrapSysNameChange, slmAuthPassword=slmAuthPassword, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapDestEntry=slmTrapDestEntry, slmLicenseExpiration=slmLicenseExpiration, slmTopologyEnabled=slmTopologyEnabled, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuth=slmAuth, slmTrapLogParam4=slmTrapLogParam4, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAuthEntry=slmAuthEntry, UserPassword=UserPassword, slmAuthTable=slmAuthTable, slmWriteCommunity=slmWriteCommunity, slmSys=slmSys, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTid=slmTid, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysAdminStatus=slmSysAdminStatus, slmSwRevDirectory=slmSwRevDirectory, slmLicenseTable=slmLicenseTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slm40GConf=slm40GConf, slmChPassLogin=slmChPassLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmChPassNewPass=slmChPassNewPass, slmSysTemperature=slmSysTemperature, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminAccess=slmAdminAccess, slmSwRevStatus=slmSwRevStatus, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminCommunity=slmAdminCommunity, slmSwRevName=slmSwRevName, slmSyslogDestTable=slmSyslogDestTable, slmLicenseEntry=slmLicenseEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysUplinkRate=slmSysUplinkRate, slmTrapEnable=slmTrapEnable, slmVcatDelay=slmVcatDelay, slmSysGatewayAddr=slmSysGatewayAddr, slmSysName=slmSysName, slmChPassOldPass=slmChPassOldPass, slmTrapDestRowStatus=slmTrapDestRowStatus, slmPsuNumber=slmPsuNumber, slmChPassEntry=slmChPassEntry, slmTrapLogParam1=slmTrapLogParam1, slmSwRevEntry=slmSwRevEntry, UserLogin=UserLogin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmRstpEnabled=slmRstpEnabled, slmSysAlmDeact=slmSysAlmDeact, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogParam2=slmTrapLogParam2, slmSysTrapFormat=slmSysTrapFormat, AdminAccess=AdminAccess, slmAdminTable=slmAdminTable, slmTrapLogEntry=slmTrapLogEntry, UserCommunity=UserCommunity, slmNetworkMode=slmNetworkMode, slmAuthLogin=slmAuthLogin, slmSysLocation=slmSysLocation, slmPortsNumber=slmPortsNumber, slMain=slMain, slmTrap=slmTrap, slmAdminPassword=slmAdminPassword, slmAdminEntry=slmAdminEntry, slmReadCommunity=slmReadCommunity, slmAdmin=slmAdmin, slmSyslogPort=slmSyslogPort, slmSysResetPm=slmSysResetPm, slmTrapLogParam5=slmTrapLogParam5, slmPmAvailable=slmPmAvailable, slmBoxSize=slmBoxSize, slmAuthCommunity=slmAuthCommunity, slmSwRevDate=slmSwRevDate, slmSysCalendarTime=slmSysCalendarTime, slmConfigFile=slmConfigFile, slmSwRevTable=slmSwRevTable, slmLicenseIndex=slmLicenseIndex, slmOemType=slmOemType, slmTrapCommunity=slmTrapCommunity)
