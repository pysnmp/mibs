...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, Opaque, ModuleIdentity, IpAddress, Integer32, Bits, Gauge32, MibIdentifier, Counter32, Counter64, NotificationType, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "Opaque", "ModuleIdentity", "IpAddress", "Integer32", "Bits", "Gauge32", "MibIdentifier", "Counter32", "Counter64", "NotificationType", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestEntry=slmTrapDestEntry, SoftwareRevision=SoftwareRevision, slmChPassNewPass=slmChPassNewPass, slmAuthPassword=slmAuthPassword, slMain=slMain, slmSysName=slmSysName, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapSysNameChange=slmTrapSysNameChange, UserLogin=UserLogin, slmNetworkMode=slmNetworkMode, slmBoxSize=slmBoxSize, slmConfigSysSignalType=slmConfigSysSignalType, slmChPassLogin=slmChPassLogin, AdminAccess=AdminAccess, slmMuxNumber=slmMuxNumber, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminTable=slmAdminTable, slmSys=slmSys, slmTrapUserLogin=slmTrapUserLogin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysSubnetMask=slmSysSubnetMask, slmSysLanIpAddr=slmSysLanIpAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmLicenseId=slmLicenseId, slmSyslogPort=slmSyslogPort, slmLogFile=slmLogFile, slmPsuNumber=slmPsuNumber, slmSysMode=slmSysMode, slmSnmpv3Auth=slmSnmpv3Auth, slmConfigFile=slmConfigFile, slmLicenseEntry=slmLicenseEntry, slmOemType=slmOemType, slmSwRevEntry=slmSwRevEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysTemperature=slmSysTemperature, slmRebootDelay=slmRebootDelay, slmAdmin=slmAdmin, slmLicenseIndex=slmLicenseIndex, slmAuth=slmAuth, slmPmAvailable=slmPmAvailable, slmLicenseTable=slmLicenseTable, slmSnmpv3Password=slmSnmpv3Password, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuthCommunity=slmAuthCommunity, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogId=slmTrapLogId, slmSysSnmpVersion=slmSysSnmpVersion, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysOperStatus=slmSysOperStatus, slmSyslogLevel=slmSyslogLevel, slmSysUplinkRate=slmSysUplinkRate, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam6=slmTrapLogParam6, slmSyslogDestTable=slmSyslogDestTable, slmChPassEntry=slmChPassEntry, slmAdminEntry=slmAdminEntry, UserPassword=UserPassword, slmChPass=slmChPass, UserCommunity=UserCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogParam4=slmTrapLogParam4, slmSwRevDate=slmSwRevDate, slmAuthTable=slmAuthTable, slmTrapLogName=slmTrapLogName, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrap=slmTrap, slmTrapDestTable=slmTrapDestTable, slmTrapLogEntry=slmTrapLogEntry, slmLicense=slmLicense, slmAdminAccess=slmAdminAccess, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapCommunity=slmTrapCommunity, slmEdfaNumber=slmEdfaNumber, slmAdminCommunity=slmAdminCommunity, slmTrapDestAddress=slmTrapDestAddress, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmReadCommunity=slmReadCommunity, slmSwRevDirectory=slmSwRevDirectory, slmSwRevStatus=slmSwRevStatus, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysChassisId=slmSysChassisId, slmTid=slmTid, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevTable=slmSwRevTable, slmTrapLogParam2=slmTrapLogParam2, slmChPassTable=slmChPassTable, slmAuthEntry=slmAuthEntry, slmPortsNumber=slmPortsNumber, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogParam1=slmTrapLogParam1, slmChPassOldPass=slmChPassOldPass, slmSysAlmDeact=slmSysAlmDeact, slmSysLocation=slmSysLocation, slmSysNetworkPrefix=slmSysNetworkPrefix, PYSNMP_MODULE_ID=slMain, slmAdminPassword=slmAdminPassword, slmSysIpAddr=slmSysIpAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLogin=slmLogin, slm40GConf=slm40GConf, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmRstpEnabled=slmRstpEnabled, slmAuthLogin=slmAuthLogin, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmWriteCommunity=slmWriteCommunity, slmConfigSysUptime=slmConfigSysUptime, slmSwRevName=slmSwRevName, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysResetPm=slmSysResetPm, slmTrapLogTable=slmTrapLogTable, slmTrapPort=slmTrapPort, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapUserAccess=slmTrapUserAccess, slmSysCalendarTime=slmSysCalendarTime, slmAdminLogin=slmAdminLogin, slmSyslogDestAddress=slmSyslogDestAddress, slmVcatDelay=slmVcatDelay, slmSysAlmAct=slmSysAlmAct, slmTopologyEnabled=slmTopologyEnabled, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapEnable=slmTrapEnable)
