...
Opaque, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, MibIdentifier, IpAddress, ModuleIdentity, Counter64, Unsigned32, Integer32, iso, ObjectIdentity, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "MibIdentifier", "IpAddress", "ModuleIdentity", "Counter64", "Unsigned32", "Integer32", "iso", "ObjectIdentity", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicenseId=slmLicenseId, slmOemType=slmOemType, SoftwareRevision=SoftwareRevision, slmSysTemperature=slmSysTemperature, slmEdfaNumber=slmEdfaNumber, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysTrapFormat=slmSysTrapFormat, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSnmpv3Password=slmSnmpv3Password, PYSNMP_MODULE_ID=slMain, slmSyslogPort=slmSyslogPort, slmAuthCommunity=slmAuthCommunity, slmAdminCommunity=slmAdminCommunity, slmTrapDestAddress=slmTrapDestAddress, slmConfigSysUptime=slmConfigSysUptime, slmAuthEntry=slmAuthEntry, slmTrapDestTable=slmTrapDestTable, slmTid=slmTid, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapPort=slmTrapPort, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuth=slmAuth, slmAuthTable=slmAuthTable, slmAdminAccess=slmAdminAccess, slmLogFile=slmLogFile, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdmin=slmAdmin, slmVcatDelay=slmVcatDelay, slmTrapDestEntry=slmTrapDestEntry, slmSwRevEntry=slmSwRevEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmSyslogLevel=slmSyslogLevel, slmTrapLogParam3=slmTrapLogParam3, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogId=slmTrapLogId, slmBoxSize=slmBoxSize, slmChPassOldPass=slmChPassOldPass, slmSyslogDestTable=slmSyslogDestTable, slmTrapSysNameChange=slmTrapSysNameChange, slmAuthLogin=slmAuthLogin, slmTrapLogParam4=slmTrapLogParam4, slmLicense=slmLicense, slmSysAlmDeact=slmSysAlmDeact, slmSysResetPm=slmSysResetPm, slmRebootDelay=slmRebootDelay, slmAdminPassword=slmAdminPassword, slmTrapUserAccess=slmTrapUserAccess, slmChPassEntry=slmChPassEntry, slmSwRevTable=slmSwRevTable, slmPortsNumber=slmPortsNumber, slmSwRevDirectory=slmSwRevDirectory, slmNetworkMode=slmNetworkMode, slmSyslogDestEntry=slmSyslogDestEntry, slmSysCalendarTime=slmSysCalendarTime, slmTrapUserLogin=slmTrapUserLogin, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam5=slmTrapLogParam5, slmChPassTable=slmChPassTable, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestRowStatus=slmTrapDestRowStatus, AdminAccess=AdminAccess, slmAdminEntry=slmAdminEntry, slmRstpEnabled=slmRstpEnabled, slmLogin=slmLogin, slmTrap=slmTrap, slmSysAdminStatus=slmSysAdminStatus, slMain=slMain, slmTrapEnable=slmTrapEnable, slmAdminTable=slmAdminTable, slmLicenseEntry=slmLicenseEntry, slmPmAvailable=slmPmAvailable, slmAuthPassword=slmAuthPassword, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmPsuNumber=slmPsuNumber, slmChPassNewPass=slmChPassNewPass, slmTrapDestCommunity=slmTrapDestCommunity, slmSysUplinkRate=slmSysUplinkRate, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSnmpv3Auth=slmSnmpv3Auth, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSwRevStatus=slmSwRevStatus, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmMuxNumber=slmMuxNumber, slmSyslogDestAddress=slmSyslogDestAddress, slmSysAlmAct=slmSysAlmAct, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevDate=slmSwRevDate, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmReadCommunity=slmReadCommunity, UserCommunity=UserCommunity, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseIndex=slmLicenseIndex, slmTrapLogName=slmTrapLogName, slmSysMode=slmSysMode, slmLicenseExpiration=slmLicenseExpiration, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogEntry=slmTrapLogEntry, slm40GConf=slm40GConf, slmSysChassisId=slmSysChassisId, slmConfigFile=slmConfigFile, slmTrapLogParam6=slmTrapLogParam6, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseTable=slmLicenseTable, slmTrapCommunity=slmTrapCommunity, slmChPass=slmChPass, UserPassword=UserPassword, slmTrapLogTable=slmTrapLogTable, slmSysName=slmSysName, UserLogin=UserLogin, slmSysSnmpVersion=slmSysSnmpVersion, slmSys=slmSys, slmSysIpAddr=slmSysIpAddr, slmSysLocation=slmSysLocation, slmAdminLogin=slmAdminLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmSysOperStatus=slmSysOperStatus, slmSysSubnetMask=slmSysSubnetMask, slmSwRevName=slmSwRevName, slmChPassLogin=slmChPassLogin, slmSysLanIpAddr=slmSysLanIpAddr)
