...
Opaque, TimeTicks, MibIdentifier, Unsigned32, ModuleIdentity, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, NotificationType, Integer32, Counter64, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "TimeTicks", "MibIdentifier", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "NotificationType", "Integer32", "Counter64", "Gauge32", "iso")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", UserCommunity=UserCommunity, slmPortsNumber=slmPortsNumber, slmLicenseEntry=slmLicenseEntry, slmTrapUserAccess=slmTrapUserAccess, slmTid=slmTid, slmSysLocation=slmSysLocation, slmVcatDelay=slmVcatDelay, slmMuxNumber=slmMuxNumber, slmLogin=slmLogin, slmSwRevDirectory=slmSwRevDirectory, slmSysSnmpVersion=slmSysSnmpVersion, slmLogFile=slmLogFile, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdmin=slmAdmin, slmSysName=slmSysName, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam4=slmTrapLogParam4, slmSnmpv3Password=slmSnmpv3Password, slmAuthTable=slmAuthTable, slmAuthEntry=slmAuthEntry, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam2=slmTrapLogParam2, slmTrapSysNameChange=slmTrapSysNameChange, slmEdfaNumber=slmEdfaNumber, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysIpAddr=slmSysIpAddr, slmTrapLogName=slmTrapLogName, slmAdminLogin=slmAdminLogin, slmLicenseIndex=slmLicenseIndex, slmSysChassisId=slmSysChassisId, SoftwareRevision=SoftwareRevision, slMain=slMain, slmTrapLogTable=slmTrapLogTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseId=slmLicenseId, slmSysGatewayAddr=slmSysGatewayAddr, slmPsuNumber=slmPsuNumber, slmTrapDestTable=slmTrapDestTable, slmSysUplinkRate=slmSysUplinkRate, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicenseTable=slmLicenseTable, slmSysSubnetMask=slmSysSubnetMask, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAuthPassword=slmAuthPassword, slmSysCalendarTime=slmSysCalendarTime, slmTrap=slmTrap, UserPassword=UserPassword, slmSysResetPm=slmSysResetPm, slmSysPmStartOfDay=slmSysPmStartOfDay, slmRebootDelay=slmRebootDelay, slmTrapCommunity=slmTrapCommunity, slmTrapLogEntry=slmTrapLogEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysAlmDeact=slmSysAlmDeact, slmTrapEnable=slmTrapEnable, slmAuthCommunity=slmAuthCommunity, slmChPassNewPass=slmChPassNewPass, slmAdminAccess=slmAdminAccess, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmNetworkMode=slmNetworkMode, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestAddress=slmTrapDestAddress, slmWriteCommunity=slmWriteCommunity, slmSys=slmSys, slmChPassLogin=slmChPassLogin, slmConfigFile=slmConfigFile, slmTrapPort=slmTrapPort, UserLogin=UserLogin, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevDate=slmSwRevDate, AdminAccess=AdminAccess, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminRowStatus=slmAdminRowStatus, slmSysAlmAct=slmSysAlmAct, slmAuthLogin=slmAuthLogin, slmLicenseExpiration=slmLicenseExpiration, PYSNMP_MODULE_ID=slMain, slmBoxSize=slmBoxSize, slmReadCommunity=slmReadCommunity, slmChPassOldPass=slmChPassOldPass, slmAuth=slmAuth, slmConfigSysUptime=slmConfigSysUptime, slmTopologyEnabled=slmTopologyEnabled, slm40GConf=slm40GConf, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysMode=slmSysMode, slmAdminPassword=slmAdminPassword, slmTrapLogId=slmTrapLogId, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam6=slmTrapLogParam6, slmAdminEntry=slmAdminEntry, slmRstpEnabled=slmRstpEnabled, slmSwRevEntry=slmSwRevEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSnmpv3Auth=slmSnmpv3Auth, slmOemType=slmOemType, slmAdminTable=slmAdminTable, slmSysAdminStatus=slmSysAdminStatus, slmSyslogLevel=slmSyslogLevel, slmSysLanIpAddr=slmSysLanIpAddr, slmAdminCommunity=slmAdminCommunity, slmChPassTable=slmChPassTable, slmSysTemperature=slmSysTemperature, slmSyslogPort=slmSyslogPort, slmChPass=slmChPass, slmTrapUserLogin=slmTrapUserLogin, slmSwRevStatus=slmSwRevStatus, slmTrapLogParam5=slmTrapLogParam5, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLicense=slmLicense, slmSwRevTable=slmSwRevTable, slmTrapLogParam1=slmTrapLogParam1, slmChPassEntry=slmChPassEntry, slmSysOperStatus=slmSysOperStatus, slmSwRevName=slmSwRevName, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestTable=slmSyslogDestTable, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmConfigSysSignalType=slmConfigSysSignalType, slmPmAvailable=slmPmAvailable)
