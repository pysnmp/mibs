...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, NotificationType, Opaque, Unsigned32, TimeTicks, Counter32, Counter64, Bits, MibIdentifier, Gauge32, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "NotificationType", "Opaque", "Unsigned32", "TimeTicks", "Counter32", "Counter64", "Bits", "MibIdentifier", "Gauge32", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmLogin=slmLogin, slmSnmpv3Password=slmSnmpv3Password, slmSysLocation=slmSysLocation, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestAddress=slmTrapDestAddress, slmLicense=slmLicense, slmTopologyEnabled=slmTopologyEnabled, slmTrapUserAccess=slmTrapUserAccess, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSwRevTable=slmSwRevTable, slmRebootDelay=slmRebootDelay, slmAuthLogin=slmAuthLogin, slmSysTemperature=slmSysTemperature, slmSysAlmDeact=slmSysAlmDeact, slmLogFile=slmLogFile, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogParam6=slmTrapLogParam6, slmSyslogLevel=slmSyslogLevel, slmAdminEntry=slmAdminEntry, slmChPassTable=slmChPassTable, slmRstpEnabled=slmRstpEnabled, slmLicenseExpiration=slmLicenseExpiration, slmAdminTable=slmAdminTable, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogId=slmTrapLogId, slmConfigFile=slmConfigFile, slmSysAlmAct=slmSysAlmAct, slmSysName=slmSysName, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAuthTable=slmAuthTable, slmSwRevName=slmSwRevName, slmReadCommunity=slmReadCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevDirectory=slmSwRevDirectory, slMain=slMain, slmSwRevStatus=slmSwRevStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slmBoxSize=slmBoxSize, UserCommunity=UserCommunity, slmSwRevDate=slmSwRevDate, slmTid=slmTid, slmSysGatewayAddr=slmSysGatewayAddr, slmChPass=slmChPass, slmTrapCommunity=slmTrapCommunity, slmMuxNumber=slmMuxNumber, slmLicenseId=slmLicenseId, slmTrap=slmTrap, slmAdminPassword=slmAdminPassword, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminAccess=slmAdminAccess, slmSysOperStatus=slmSysOperStatus, slmTrapUserLogin=slmTrapUserLogin, UserPassword=UserPassword, slmTrapLogName=slmTrapLogName, slmOemType=slmOemType, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmNetworkMode=slmNetworkMode, slmSys=slmSys, slmSwRevEntry=slmSwRevEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestEntry=slmTrapDestEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysIpAddr=slmSysIpAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapEnable=slmTrapEnable, slmLicenseTable=slmLicenseTable, slmSysSnmpVersion=slmSysSnmpVersion, slm40GConf=slm40GConf, slmConfigSysUptime=slmConfigSysUptime, slmAuthEntry=slmAuthEntry, SoftwareRevision=SoftwareRevision, slmTrapLogParam2=slmTrapLogParam2, slmAuthPassword=slmAuthPassword, slmPmAvailable=slmPmAvailable, slmChPassNewPass=slmChPassNewPass, slmChPassLogin=slmChPassLogin, slmVcatDelay=slmVcatDelay, slmAuth=slmAuth, slmChPassEntry=slmChPassEntry, slmAdmin=slmAdmin, slmSysEncryptionCapability=slmSysEncryptionCapability, PYSNMP_MODULE_ID=slMain, slmLicenseEntry=slmLicenseEntry, slmTrapPort=slmTrapPort, slmSysUplinkRate=slmSysUplinkRate, slmConfigSysSignalType=slmConfigSysSignalType, slmSysChassisId=slmSysChassisId, UserLogin=UserLogin, slmTrapDestTable=slmTrapDestTable, slmEdfaNumber=slmEdfaNumber, slmSysMode=slmSysMode, slmSysAdminStatus=slmSysAdminStatus, slmSysResetPm=slmSysResetPm, slmWriteCommunity=slmWriteCommunity, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysCalendarTime=slmSysCalendarTime, slmPsuNumber=slmPsuNumber, slmAdminLogin=slmAdminLogin, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogTable=slmTrapLogTable, slmPortsNumber=slmPortsNumber, slmAuthCommunity=slmAuthCommunity, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam3=slmTrapLogParam3, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPassOldPass=slmChPassOldPass, slmSyslogDestTable=slmSyslogDestTable, slmSyslogPort=slmSyslogPort, slmLicenseIndex=slmLicenseIndex, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminRowStatus=slmAdminRowStatus, slmSysTrapFormat=slmSysTrapFormat, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, AdminAccess=AdminAccess)
