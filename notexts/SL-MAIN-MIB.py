...
NotificationType, IpAddress, ObjectIdentity, Unsigned32, MibIdentifier, Opaque, Gauge32, Integer32, Counter64, ModuleIdentity, iso, Bits, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Opaque", "Gauge32", "Integer32", "Counter64", "ModuleIdentity", "iso", "Bits", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogName=slmTrapLogName, slmSysActiveSwVersion=slmSysActiveSwVersion, UserLogin=UserLogin, SoftwareRevision=SoftwareRevision, slmPmAvailable=slmPmAvailable, slmLicenseExpiration=slmLicenseExpiration, slmAdminAccess=slmAdminAccess, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevStatus=slmSwRevStatus, slmPsuNumber=slmPsuNumber, slmChPass=slmChPass, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysAdminStatus=slmSysAdminStatus, PYSNMP_MODULE_ID=slMain, AdminAccess=AdminAccess, slmAdminRowStatus=slmAdminRowStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogLevel=slmSyslogLevel, slmAdminCommunity=slmAdminCommunity, slmSysSubnetMask=slmSysSubnetMask, slmAuthPassword=slmAuthPassword, slmTrapDestAddress=slmTrapDestAddress, slmTrapDestTable=slmTrapDestTable, slmSysLocation=slmSysLocation, slmLicense=slmLicense, slmVcatDelay=slmVcatDelay, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLicenseId=slmLicenseId, slmTrapLogParam6=slmTrapLogParam6, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam5=slmTrapLogParam5, slmConfigSysUptime=slmConfigSysUptime, slmLogin=slmLogin, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogId=slmTrapLogId, slmAdminEntry=slmAdminEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLogFile=slmLogFile, slmSysOperStatus=slmSysOperStatus, slmAdminTable=slmAdminTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAuthEntry=slmAuthEntry, slmSysMode=slmSysMode, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysName=slmSysName, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogEntry=slmTrapLogEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSyslogDestTable=slmSyslogDestTable, slmSysTrapFormat=slmSysTrapFormat, slmSys=slmSys, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevDirectory=slmSwRevDirectory, slmSysGatewayAddr=slmSysGatewayAddr, slmChPassLogin=slmChPassLogin, slmSyslogPort=slmSyslogPort, slmTrapEnable=slmTrapEnable, slmAdmin=slmAdmin, slmSwRevName=slmSwRevName, slmTopologyEnabled=slmTopologyEnabled, slmLicenseEntry=slmLicenseEntry, slmSysAlmAct=slmSysAlmAct, slmSnmpv3Password=slmSnmpv3Password, slmAuthTable=slmAuthTable, slmAuthLogin=slmAuthLogin, slmLicenseTable=slmLicenseTable, slmTrap=slmTrap, slmTrapLogParam2=slmTrapLogParam2, slmNetworkMode=slmNetworkMode, slmTid=slmTid, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevDate=slmSwRevDate, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmLicenseIndex=slmLicenseIndex, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, UserCommunity=UserCommunity, slmChPassNewPass=slmChPassNewPass, slmSwRevEntry=slmSwRevEntry, slmRebootDelay=slmRebootDelay, slmTrapLogParam4=slmTrapLogParam4, slmSysUplinkRate=slmSysUplinkRate, slmSwRevTable=slmSwRevTable, slmConfigFile=slmConfigFile, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmEdfaNumber=slmEdfaNumber, slmSysTemperature=slmSysTemperature, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmMuxNumber=slmMuxNumber, slmTrapLogTable=slmTrapLogTable, slmSnmpv3Auth=slmSnmpv3Auth, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmWriteCommunity=slmWriteCommunity, slmTrapCommunity=slmTrapCommunity, slMain=slMain, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam1=slmTrapLogParam1, slmTrapDestEntry=slmTrapDestEntry, slmAuth=slmAuth, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapUserAccess=slmTrapUserAccess, slmAdminLogin=slmAdminLogin, slmSysIpAddr=slmSysIpAddr, UserPassword=UserPassword, slmSysChassisId=slmSysChassisId, slmPortsNumber=slmPortsNumber, slmChPassOldPass=slmChPassOldPass, slmTrapPort=slmTrapPort, slmSyslogDestAddress=slmSyslogDestAddress, slmChPassTable=slmChPassTable, slmBoxSize=slmBoxSize, slmRstpEnabled=slmRstpEnabled, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogParam3=slmTrapLogParam3, slmSnmpv3Priv=slmSnmpv3Priv, slmOemType=slmOemType, slmSysResetPm=slmSysResetPm, slm40GConf=slm40GConf, slmSysEncryptionCapability=slmSysEncryptionCapability, slmReadCommunity=slmReadCommunity, slmChPassEntry=slmChPassEntry, slmTrapUserLogin=slmTrapUserLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAdminPassword=slmAdminPassword, slmConfigSysSignalType=slmConfigSysSignalType)
