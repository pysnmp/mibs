...
Integer32, Counter32, Counter64, TimeTicks, Gauge32, MibIdentifier, Unsigned32, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, Opaque, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "Counter64", "TimeTicks", "Gauge32", "MibIdentifier", "Unsigned32", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "Opaque", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmPortsNumber=slmPortsNumber, slmOemType=slmOemType, slmSysActiveSwVersion=slmSysActiveSwVersion, SoftwareRevision=SoftwareRevision, slmTrapLogParam3=slmTrapLogParam3, slmSys=slmSys, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestTable=slmTrapDestTable, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam1=slmTrapLogParam1, slmLicense=slmLicense, slmSwRevName=slmSwRevName, slmLicenseIndex=slmLicenseIndex, slmChPass=slmChPass, slmTrapLogParam2=slmTrapLogParam2, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysNetworkPrefix=slmSysNetworkPrefix, UserLogin=UserLogin, slmSysIpAddr=slmSysIpAddr, slmTrapLogEntry=slmTrapLogEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSyslogLevel=slmSyslogLevel, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseExpiration=slmLicenseExpiration, slmTrapCommunity=slmTrapCommunity, slmChPassNewPass=slmChPassNewPass, slmSysTemperature=slmSysTemperature, slmSysChassisId=slmSysChassisId, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevEntry=slmSwRevEntry, slmChPassLogin=slmChPassLogin, slmSysSubnetMask=slmSysSubnetMask, slmSyslogDestTable=slmSyslogDestTable, slmSysOperStatus=slmSysOperStatus, slmSwRevTable=slmSwRevTable, slmEdfaNumber=slmEdfaNumber, slmAdminCommunity=slmAdminCommunity, slmAuthPassword=slmAuthPassword, slmSnmpv3Auth=slmSnmpv3Auth, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogId=slmTrapLogId, slmConfigSysSignalType=slmConfigSysSignalType, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTopologyEnabled=slmTopologyEnabled, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysAdminStatus=slmSysAdminStatus, slmSysName=slmSysName, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestCommunity=slmTrapDestCommunity, slmAdminAccess=slmAdminAccess, slmTrapUserLogin=slmTrapUserLogin, slmBoxSize=slmBoxSize, PYSNMP_MODULE_ID=slMain, slmSysAlmDeact=slmSysAlmDeact, slmSysGatewayAddr=slmSysGatewayAddr, slmAdmin=slmAdmin, slmChPassEntry=slmChPassEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmMuxNumber=slmMuxNumber, slmAuthTable=slmAuthTable, slmLicenseId=slmLicenseId, slmPsuNumber=slmPsuNumber, slmTrapEnable=slmTrapEnable, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminEntry=slmAdminEntry, slmSwRevDate=slmSwRevDate, slmTrapLogTable=slmTrapLogTable, slMain=slMain, slmAuthLogin=slmAuthLogin, slmLicenseEntry=slmLicenseEntry, slmLogFile=slmLogFile, slmAdminTable=slmAdminTable, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam5=slmTrapLogParam5, slmSysAlmAct=slmSysAlmAct, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmRstpEnabled=slmRstpEnabled, slmTrap=slmTrap, slmSysTrapFormat=slmSysTrapFormat, slmWriteCommunity=slmWriteCommunity, slmPmAvailable=slmPmAvailable, slmTrapDestAddress=slmTrapDestAddress, slmNetworkMode=slmNetworkMode, slmSysLocation=slmSysLocation, slmAdminLogin=slmAdminLogin, AdminAccess=AdminAccess, slmLogin=slmLogin, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminRowStatus=slmAdminRowStatus, slmChPassTable=slmChPassTable, slmAuth=slmAuth, slmTrapPort=slmTrapPort, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogName=slmTrapLogName, slmConfigSysUptime=slmConfigSysUptime, slmOpticalSwitchExist=slmOpticalSwitchExist, UserCommunity=UserCommunity, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogPort=slmSyslogPort, slmSysResetPm=slmSysResetPm, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, UserPassword=UserPassword, slmConfigFile=slmConfigFile, slmSysLanIpAddr=slmSysLanIpAddr, slmTid=slmTid, slmSyslogDestAddress=slmSyslogDestAddress, slmAuthCommunity=slmAuthCommunity, slmReadCommunity=slmReadCommunity, slmSysMode=slmSysMode, slmTrapDestEntry=slmTrapDestEntry, slmSysCalendarTime=slmSysCalendarTime, slmAdminPassword=slmAdminPassword, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAuthEntry=slmAuthEntry, slm40GConf=slm40GConf, slmSwRevStatus=slmSwRevStatus, slmRebootDelay=slmRebootDelay, slmChPassOldPass=slmChPassOldPass, slmVcatDelay=slmVcatDelay, slmLicenseTable=slmLicenseTable)
