...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysUplinkRate=slmSysUplinkRate, slmChPassOldPass=slmChPassOldPass, slmTrapUserLogin=slmTrapUserLogin, slmChPassTable=slmChPassTable, slmSwRevEntry=slmSwRevEntry, slmSwRevName=slmSwRevName, slmNetworkMode=slmNetworkMode, slmLicenseEntry=slmLicenseEntry, slmTrapPort=slmTrapPort, slmLogFile=slmLogFile, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminRowStatus=slmAdminRowStatus, AdminAccess=AdminAccess, slmLicenseTable=slmLicenseTable, slmTrapLogEntry=slmTrapLogEntry, slmTid=slmTid, slmSysIpAddr=slmSysIpAddr, slmAdminLogin=slmAdminLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapCommunity=slmTrapCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, UserCommunity=UserCommunity, slmConfigSysUptime=slmConfigSysUptime, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdmin=slmAdmin, slmConfigFile=slmConfigFile, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmVcatDelay=slmVcatDelay, slmMuxNumber=slmMuxNumber, slmAdminTable=slmAdminTable, slmAdminPassword=slmAdminPassword, slmTrapDestTable=slmTrapDestTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmRstpEnabled=slmRstpEnabled, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam5=slmTrapLogParam5, slmAuthTable=slmAuthTable, slmSysAlmDeact=slmSysAlmDeact, slmTopologyEnabled=slmTopologyEnabled, slmSyslogPort=slmSyslogPort, slmTrapLogParam1=slmTrapLogParam1, slmLicenseId=slmLicenseId, slmSyslogLevel=slmSyslogLevel, slmPmAvailable=slmPmAvailable, slmPsuNumber=slmPsuNumber, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthLogin=slmAuthLogin, slmSysAlmAct=slmSysAlmAct, slmSwRevStatus=slmSwRevStatus, slmChPass=slmChPass, slmPortsNumber=slmPortsNumber, slmAuthEntry=slmAuthEntry, PYSNMP_MODULE_ID=slMain, slmSyslogDestAddress=slmSyslogDestAddress, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysCalendarTime=slmSysCalendarTime, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestAddress=slmTrapDestAddress, slmTrap=slmTrap, slmSysTrapFormat=slmSysTrapFormat, slmConfigSysSignalType=slmConfigSysSignalType, slmLicenseIndex=slmLicenseIndex, slmTrapLogParam3=slmTrapLogParam3, UserPassword=UserPassword, slmTrapEnable=slmTrapEnable, slmSyslogDestTable=slmSyslogDestTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysTemperature=slmSysTemperature, slmAuthPassword=slmAuthPassword, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapDestEntry=slmTrapDestEntry, slmSysOperStatus=slmSysOperStatus, UserLogin=UserLogin, slm40GConf=slm40GConf, slmLicense=slmLicense, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSwRevTable=slmSwRevTable, slmChPassNewPass=slmChPassNewPass, slmLicenseExpiration=slmLicenseExpiration, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminCommunity=slmAdminCommunity, slmSysLanIpAddr=slmSysLanIpAddr, slmSysResetPm=slmSysResetPm, slmAdminEntry=slmAdminEntry, slmSysLocation=slmSysLocation, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogParam2=slmTrapLogParam2, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysMode=slmSysMode, slmTrapLogName=slmTrapLogName, slmSwRevDate=slmSwRevDate, slmTrapLogTable=slmTrapLogTable, slmSwRevDirectory=slmSwRevDirectory, slmBoxSize=slmBoxSize, slmWriteCommunity=slmWriteCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, slmOemType=slmOemType, slmTrapDestProtVersion=slmTrapDestProtVersion, SoftwareRevision=SoftwareRevision, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmSysName=slmSysName, slmSysChassisId=slmSysChassisId, slmChPassLogin=slmChPassLogin, slmTrapLogParam4=slmTrapLogParam4, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSnmpv3Password=slmSnmpv3Password, slmEdfaNumber=slmEdfaNumber, slmLogin=slmLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPassEntry=slmChPassEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysAdminStatus=slmSysAdminStatus, slmRebootDelay=slmRebootDelay, slmAuth=slmAuth, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogParam6=slmTrapLogParam6, slmAdminAccess=slmAdminAccess, slmReadCommunity=slmReadCommunity, slMain=slMain, slmSys=slmSys, slmTrapLogId=slmTrapLogId)
