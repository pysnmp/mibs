...
TimeTicks, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, ObjectIdentity, Counter64, Gauge32, ModuleIdentity, Opaque, Bits, Integer32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "ObjectIdentity", "Counter64", "Gauge32", "ModuleIdentity", "Opaque", "Bits", "Integer32", "iso", "NotificationType")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicenseIndex=slmLicenseIndex, slmAdminLogin=slmAdminLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysName=slmSysName, slmTrapLogName=slmTrapLogName, slmTrapCommunity=slmTrapCommunity, slmTrapLogEntry=slmTrapLogEntry, slmAuth=slmAuth, slmSysMode=slmSysMode, slmSyslogPort=slmSyslogPort, slmTrapLogParam6=slmTrapLogParam6, slmSysSnmpVersion=slmSysSnmpVersion, slmLicenseTable=slmLicenseTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmConfigSysSignalType=slmConfigSysSignalType, slmBoxSize=slmBoxSize, slmSysPmStartOfDay=slmSysPmStartOfDay, slmConfigSysUptime=slmConfigSysUptime, slmAdminRowStatus=slmAdminRowStatus, slm40GConf=slm40GConf, slmPsuNumber=slmPsuNumber, slmTrapDestEntry=slmTrapDestEntry, slmAdminAccess=slmAdminAccess, slmSnmpv3Auth=slmSnmpv3Auth, slmAdminPassword=slmAdminPassword, slmSwRevName=slmSwRevName, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogLevel=slmSyslogLevel, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestProtVersion=slmTrapDestProtVersion, slmChPassTable=slmChPassTable, AdminAccess=AdminAccess, slmSnmpv3Password=slmSnmpv3Password, slmAuthLogin=slmAuthLogin, slmSwRevDirectory=slmSwRevDirectory, slmTrapSysNameChange=slmTrapSysNameChange, slmRstpEnabled=slmRstpEnabled, slmAdminTable=slmAdminTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmConfigFile=slmConfigFile, slmSwRevTable=slmSwRevTable, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPassNewPass=slmChPassNewPass, slmAdminEntry=slmAdminEntry, slmTid=slmTid, UserLogin=UserLogin, slmTrapLogParam1=slmTrapLogParam1, slmChPassEntry=slmChPassEntry, UserCommunity=UserCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmLicense=slmLicense, SoftwareRevision=SoftwareRevision, slmAdminCommunity=slmAdminCommunity, slmSyslogDestTable=slmSyslogDestTable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapEnable=slmTrapEnable, slmReadCommunity=slmReadCommunity, slmLogFile=slmLogFile, slmChPass=slmChPass, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysAlmAct=slmSysAlmAct, slmAuthTable=slmAuthTable, slmAuthEntry=slmAuthEntry, slmTrapDestTable=slmTrapDestTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrap=slmTrap, slmSysAlmDeact=slmSysAlmDeact, slmVcatDelay=slmVcatDelay, slmSysNetworkPrefix=slmSysNetworkPrefix, slmPortsNumber=slmPortsNumber, slmMuxNumber=slmMuxNumber, slmChPassOldPass=slmChPassOldPass, slmSysLocation=slmSysLocation, slmSysLanIpAddr=slmSysLanIpAddr, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam4=slmTrapLogParam4, slmNetworkMode=slmNetworkMode, slmTrapDestAddress=slmTrapDestAddress, slmSysChassisId=slmSysChassisId, slmSysTrapFormat=slmSysTrapFormat, slmSwRevStatus=slmSwRevStatus, slmLogin=slmLogin, slmChPassLogin=slmChPassLogin, slmTrapLogParam5=slmTrapLogParam5, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapUserAccess=slmTrapUserAccess, slmEdfaNumber=slmEdfaNumber, slmSnmpv3Priv=slmSnmpv3Priv, slmWriteCommunity=slmWriteCommunity, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapPort=slmTrapPort, slmSys=slmSys, slmAdmin=slmAdmin, slmLicenseExpiration=slmLicenseExpiration, slmSysIpAddr=slmSysIpAddr, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseEntry=slmLicenseEntry, slmTrapLogParam3=slmTrapLogParam3, slmRebootDelay=slmRebootDelay, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmPmAvailable=slmPmAvailable, slmSysAdminStatus=slmSysAdminStatus, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogTable=slmTrapLogTable, slmLicenseId=slmLicenseId, slmSysSubnetMask=slmSysSubnetMask, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam2=slmTrapLogParam2, slMain=slMain, UserPassword=UserPassword, slmSwRevDate=slmSwRevDate, slmTrapLogId=slmTrapLogId, slmSysOperStatus=slmSysOperStatus, slmSysResetPm=slmSysResetPm, PYSNMP_MODULE_ID=slMain, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmOemType=slmOemType, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuthPassword=slmAuthPassword, slmTrapUserLogin=slmTrapUserLogin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAuthCommunity=slmAuthCommunity, slmSysTemperature=slmSysTemperature)
