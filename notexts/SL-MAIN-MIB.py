...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, NotificationType, Counter32, Integer32, ModuleIdentity, Gauge32, Bits, Counter64, MibIdentifier, TimeTicks, Opaque, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "NotificationType", "Counter32", "Integer32", "ModuleIdentity", "Gauge32", "Bits", "Counter64", "MibIdentifier", "TimeTicks", "Opaque", "Unsigned32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevTable=slmSwRevTable, slmChPassEntry=slmChPassEntry, slmTrapLogName=slmTrapLogName, slmRstpEnabled=slmRstpEnabled, slmRebootDelay=slmRebootDelay, slmEdfaNumber=slmEdfaNumber, slmAuthCommunity=slmAuthCommunity, slmAuth=slmAuth, slmSysGatewayAddr=slmSysGatewayAddr, slmSys=slmSys, slm40GConf=slm40GConf, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestEntry=slmTrapDestEntry, slmSysTemperature=slmSysTemperature, slmSysSubnetMask=slmSysSubnetMask, slmTid=slmTid, slmLicenseTable=slmLicenseTable, SoftwareRevision=SoftwareRevision, UserPassword=UserPassword, slmConfigSysUptime=slmConfigSysUptime, slmTrapPort=slmTrapPort, AdminAccess=AdminAccess, slmSysLanIpAddr=slmSysLanIpAddr, slmAdminEntry=slmAdminEntry, slmSysAlmDeact=slmSysAlmDeact, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogParam2=slmTrapLogParam2, slmSysChassisId=slmSysChassisId, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicenseEntry=slmLicenseEntry, slmChPassTable=slmChPassTable, slmSyslogLevel=slmSyslogLevel, slmPortsNumber=slmPortsNumber, slMain=slMain, slmAdminPassword=slmAdminPassword, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmPmAvailable=slmPmAvailable, slmSwRevEntry=slmSwRevEntry, slmAdminTable=slmAdminTable, slmBoxSize=slmBoxSize, slmAdminCommunity=slmAdminCommunity, slmTrapLogId=slmTrapLogId, slmSnmpv3Auth=slmSnmpv3Auth, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPassOldPass=slmChPassOldPass, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestEntry=slmSyslogDestEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmOemType=slmOemType, slmSwRevName=slmSwRevName, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLogin=slmLogin, slmTrapDestAddress=slmTrapDestAddress, slmWriteCommunity=slmWriteCommunity, slmLicenseIndex=slmLicenseIndex, slmPsuNumber=slmPsuNumber, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam3=slmTrapLogParam3, slmTopologyEnabled=slmTopologyEnabled, slmSysLocation=slmSysLocation, UserCommunity=UserCommunity, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysIpAddr=slmSysIpAddr, slmLicenseExpiration=slmLicenseExpiration, slmAuthPassword=slmAuthPassword, slmSysName=slmSysName, slmTrapDestTable=slmTrapDestTable, slmSwRevDate=slmSwRevDate, slmSyslogDestAddress=slmSyslogDestAddress, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogEntry=slmTrapLogEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapCommunity=slmTrapCommunity, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysResetPm=slmSysResetPm, slmSysOperStatus=slmSysOperStatus, slmChPassNewPass=slmChPassNewPass, slmVcatDelay=slmVcatDelay, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapSysNameChange=slmTrapSysNameChange, slmSysTrapFormat=slmSysTrapFormat, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogParam4=slmTrapLogParam4, slmAdminLogin=slmAdminLogin, slmTrapEnable=slmTrapEnable, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuthEntry=slmAuthEntry, slmTrapUserLogin=slmTrapUserLogin, slmLicenseId=slmLicenseId, slmSysAlmAct=slmSysAlmAct, slmChPassLogin=slmChPassLogin, slmChPass=slmChPass, slmMuxNumber=slmMuxNumber, slmSyslogDestTable=slmSyslogDestTable, slmNetworkMode=slmNetworkMode, slmConfigFile=slmConfigFile, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogParam6=slmTrapLogParam6, slmSysUplinkRate=slmSysUplinkRate, slmReadCommunity=slmReadCommunity, slmSnmpv3Priv=slmSnmpv3Priv, UserLogin=UserLogin, slmSwRevDirectory=slmSwRevDirectory, slmLogFile=slmLogFile, slmSyslogPort=slmSyslogPort, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysMode=slmSysMode, slmAuthTable=slmAuthTable, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogParam1=slmTrapLogParam1, slmTrap=slmTrap, slmSnmpv3Password=slmSnmpv3Password, slmAdminAccess=slmAdminAccess, slmAuthLogin=slmAuthLogin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLicense=slmLicense, PYSNMP_MODULE_ID=slMain, slmAdmin=slmAdmin, slmSwRevStatus=slmSwRevStatus, slmTrapLogTable=slmTrapLogTable)
