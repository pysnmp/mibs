...
Integer32, Gauge32, Bits, ObjectIdentity, MibIdentifier, Opaque, iso, Counter32, TimeTicks, Counter64, NotificationType, IpAddress, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "Bits", "ObjectIdentity", "MibIdentifier", "Opaque", "iso", "Counter32", "TimeTicks", "Counter64", "NotificationType", "IpAddress", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPassOldPass=slmChPassOldPass, UserPassword=UserPassword, slmTrapLogParam1=slmTrapLogParam1, slmMuxNumber=slmMuxNumber, slmTrapSysNameChange=slmTrapSysNameChange, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmOemType=slmOemType, slmSwRevDate=slmSwRevDate, slmNetworkMode=slmNetworkMode, slmTrapLogTable=slmTrapLogTable, slmLogFile=slmLogFile, slmPsuNumber=slmPsuNumber, slmAdminAccess=slmAdminAccess, slmAuthPassword=slmAuthPassword, slmTrapLogParam4=slmTrapLogParam4, slmChPassEntry=slmChPassEntry, slmAdminCommunity=slmAdminCommunity, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogId=slmTrapLogId, slmTrapEnable=slmTrapEnable, slmChPassNewPass=slmChPassNewPass, slmWriteCommunity=slmWriteCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmSyslogPort=slmSyslogPort, slm40GConf=slm40GConf, slmAdminTable=slmAdminTable, slmVcatDelay=slmVcatDelay, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysMode=slmSysMode, slmSysLanIpAddr=slmSysLanIpAddr, slmChPassTable=slmChPassTable, slmConfigSysUptime=slmConfigSysUptime, slmLicenseTable=slmLicenseTable, slmSysUplinkRate=slmSysUplinkRate, slmTrapPort=slmTrapPort, slmAuth=slmAuth, slmSwRevName=slmSwRevName, slmRebootDelay=slmRebootDelay, slmPortsNumber=slmPortsNumber, slmSnmpv3Priv=slmSnmpv3Priv, slmPmAvailable=slmPmAvailable, slmAuthLogin=slmAuthLogin, slmSysAdminStatus=slmSysAdminStatus, slmLicense=slmLicense, slmSysLocation=slmSysLocation, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLicenseExpiration=slmLicenseExpiration, slmReadCommunity=slmReadCommunity, slmLicenseId=slmLicenseId, UserLogin=UserLogin, slmSysChassisId=slmSysChassisId, slmAdminRowStatus=slmAdminRowStatus, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysName=slmSysName, slmSysGatewayAddr=slmSysGatewayAddr, slmSysResetPm=slmSysResetPm, slmSysTemperature=slmSysTemperature, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogParam2=slmTrapLogParam2, slmTrapUserLogin=slmTrapUserLogin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevStatus=slmSwRevStatus, slmSyslogDestTable=slmSyslogDestTable, slmTrap=slmTrap, slmSysCalendarTime=slmSysCalendarTime, AdminAccess=AdminAccess, slMain=slMain, slmRstpEnabled=slmRstpEnabled, UserCommunity=UserCommunity, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysIpAddr=slmSysIpAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestEntry=slmTrapDestEntry, slmTid=slmTid, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmAuthTable=slmAuthTable, slmLicenseEntry=slmLicenseEntry, slmLicenseIndex=slmLicenseIndex, slmConfigSysSignalType=slmConfigSysSignalType, slmEdfaNumber=slmEdfaNumber, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminPassword=slmAdminPassword, slmTrapLogParam5=slmTrapLogParam5, slmSyslogLevel=slmSyslogLevel, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapCommunity=slmTrapCommunity, slmTrapDestAddress=slmTrapDestAddress, slmLogin=slmLogin, slmSysAlmDeact=slmSysAlmDeact, slmSysAlmAct=slmSysAlmAct, slmSysTrapFormat=slmSysTrapFormat, slmAdmin=slmAdmin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogName=slmTrapLogName, slmChPass=slmChPass, slmAuthEntry=slmAuthEntry, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam3=slmTrapLogParam3, slmAdminEntry=slmAdminEntry, slmConfigFile=slmConfigFile, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAuthCommunity=slmAuthCommunity, slmSysOperStatus=slmSysOperStatus, slmTrapLogEntry=slmTrapLogEntry, slmSwRevEntry=slmSwRevEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSys=slmSys, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSwRevDirectory=slmSwRevDirectory, slmBoxSize=slmBoxSize, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminLogin=slmAdminLogin, slmSnmpv3Password=slmSnmpv3Password, slmChPassLogin=slmChPassLogin, PYSNMP_MODULE_ID=slMain, slmSysSnmpVersion=slmSysSnmpVersion, slmSnmpv3Auth=slmSnmpv3Auth, SoftwareRevision=SoftwareRevision, slmSwRevTable=slmSwRevTable)
