...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminPassword=slmAdminPassword, slmAuthCommunity=slmAuthCommunity, UserCommunity=UserCommunity, AdminAccess=AdminAccess, slmAdminRowStatus=slmAdminRowStatus, slmAdminEntry=slmAdminEntry, slmAuthTable=slmAuthTable, slmLogin=slmLogin, slmAuthEntry=slmAuthEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogParam4=slmTrapLogParam4, slmLicenseEntry=slmLicenseEntry, slmSysChassisId=slmSysChassisId, slmTid=slmTid, slmTrapLogParam5=slmTrapLogParam5, slmAuthPassword=slmAuthPassword, slmSwRevName=slmSwRevName, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmRebootDelay=slmRebootDelay, slmSyslogPort=slmSyslogPort, slmSwRevTable=slmSwRevTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmConfigFile=slmConfigFile, slmTrapUserAccess=slmTrapUserAccess, slmSysMode=slmSysMode, slmSys=slmSys, slmChPass=slmChPass, slmSysName=slmSysName, slmAdminCommunity=slmAdminCommunity, slmTrapDestRowStatus=slmTrapDestRowStatus, slmVcatDelay=slmVcatDelay, SoftwareRevision=SoftwareRevision, slmTrapLogId=slmTrapLogId, slmTrapLogParam3=slmTrapLogParam3, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysAlmDeact=slmSysAlmDeact, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogTable=slmTrapLogTable, slmAuthLogin=slmAuthLogin, slmLicenseExpiration=slmLicenseExpiration, slmSyslogDestEntry=slmSyslogDestEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLicenseId=slmLicenseId, slmSnmpv3Auth=slmSnmpv3Auth, slmPsuNumber=slmPsuNumber, slmTrapCommunity=slmTrapCommunity, slmWriteCommunity=slmWriteCommunity, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam1=slmTrapLogParam1, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapPort=slmTrapPort, slmEdfaNumber=slmEdfaNumber, slmPmAvailable=slmPmAvailable, slmSwRevDirectory=slmSwRevDirectory, slmSyslogDestAddress=slmSyslogDestAddress, slmLicense=slmLicense, slmLicenseTable=slmLicenseTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAdmin=slmAdmin, slmSnmpv3Password=slmSnmpv3Password, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuth=slmAuth, slmTrapDestProtVersion=slmTrapDestProtVersion, slmOemType=slmOemType, slmAdminAccess=slmAdminAccess, slmMuxNumber=slmMuxNumber, slmSwRevEntry=slmSwRevEntry, slmTrapEnable=slmTrapEnable, slmSysIpAddr=slmSysIpAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysAdminStatus=slmSysAdminStatus, UserLogin=UserLogin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmRstpEnabled=slmRstpEnabled, slmBoxSize=slmBoxSize, slmChPassLogin=slmChPassLogin, slmTrapLogName=slmTrapLogName, slmLicenseIndex=slmLicenseIndex, slmConfigSysSignalType=slmConfigSysSignalType, slmChPassOldPass=slmChPassOldPass, slmAdminTable=slmAdminTable, slmTrapDestTable=slmTrapDestTable, slmTrapDestAddress=slmTrapDestAddress, slmTrapDestEntry=slmTrapDestEntry, slmAdminLogin=slmAdminLogin, slmSysLocation=slmSysLocation, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysSnmpVersion=slmSysSnmpVersion, slmTrap=slmTrap, slmChPassNewPass=slmChPassNewPass, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmSysTemperature=slmSysTemperature, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slMain=slMain, UserPassword=UserPassword, slmChPassEntry=slmChPassEntry, slmSwRevDate=slmSwRevDate, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slm40GConf=slm40GConf, slmConfigSysUptime=slmConfigSysUptime, slmSysResetPm=slmSysResetPm, slmSysSubnetMask=slmSysSubnetMask, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmReadCommunity=slmReadCommunity, slmSysOperStatus=slmSysOperStatus, slmSysAlmAct=slmSysAlmAct, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSwRevStatus=slmSwRevStatus, slmTrapUserLogin=slmTrapUserLogin, slmSysTrapFormat=slmSysTrapFormat, slmSyslogLevel=slmSyslogLevel, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam2=slmTrapLogParam2, slmPortsNumber=slmPortsNumber, PYSNMP_MODULE_ID=slMain, slmTrapLogParam6=slmTrapLogParam6, slmChPassTable=slmChPassTable, slmTrapLogEntry=slmTrapLogEntry, slmNetworkMode=slmNetworkMode, slmLogFile=slmLogFile, slmSysPmStartOfDay=slmSysPmStartOfDay)
