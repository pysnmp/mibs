...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminPassword=slmAdminPassword, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmConfigFile=slmConfigFile, slmLicenseEntry=slmLicenseEntry, slmTrapCommunity=slmTrapCommunity, SoftwareRevision=SoftwareRevision, slmSwRevTable=slmSwRevTable, slm40GConf=slm40GConf, slmAdmin=slmAdmin, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmChPassOldPass=slmChPassOldPass, slmAuthPassword=slmAuthPassword, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminTable=slmAdminTable, slmChPassLogin=slmChPassLogin, slmTrapLogParam6=slmTrapLogParam6, slmSysGatewayAddr=slmSysGatewayAddr, slmSysLocation=slmSysLocation, slmTrapLogId=slmTrapLogId, slmTrapUserAccess=slmTrapUserAccess, slmLogin=slmLogin, slmSnmpv3Password=slmSnmpv3Password, slmTrapEnable=slmTrapEnable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminRowStatus=slmAdminRowStatus, slmWriteCommunity=slmWriteCommunity, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysLanIpAddr=slmSysLanIpAddr, slmSysTemperature=slmSysTemperature, slmSysMode=slmSysMode, slmLicenseTable=slmLicenseTable, slmSwRevEntry=slmSwRevEntry, slmLicenseId=slmLicenseId, UserPassword=UserPassword, slmMuxNumber=slmMuxNumber, slmAdminEntry=slmAdminEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmRebootDelay=slmRebootDelay, slmReadCommunity=slmReadCommunity, slmSysAlmDeact=slmSysAlmDeact, slmOemType=slmOemType, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevDate=slmSwRevDate, slmSysUplinkRate=slmSysUplinkRate, slmAuthCommunity=slmAuthCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmNetworkMode=slmNetworkMode, slmSysName=slmSysName, slmChPassTable=slmChPassTable, slmAuthTable=slmAuthTable, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogParam4=slmTrapLogParam4, UserCommunity=UserCommunity, slmTrapLogParam1=slmTrapLogParam1, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam2=slmTrapLogParam2, slmSwRevName=slmSwRevName, slmPsuNumber=slmPsuNumber, slmSysCalendarTime=slmSysCalendarTime, slmPortsNumber=slmPortsNumber, slmLicense=slmLicense, slmLicenseExpiration=slmLicenseExpiration, slmSysChassisId=slmSysChassisId, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogDestTable=slmSyslogDestTable, slmSyslogLevel=slmSyslogLevel, slmTrapDestAddress=slmTrapDestAddress, slmTrapDestTable=slmTrapDestTable, slmTrapPort=slmTrapPort, slmTrapLogEntry=slmTrapLogEntry, slmAuthEntry=slmAuthEntry, slmRstpEnabled=slmRstpEnabled, slmAuthLogin=slmAuthLogin, slmTrapUserLogin=slmTrapUserLogin, slmLogFile=slmLogFile, UserLogin=UserLogin, slmTrapDestEntry=slmTrapDestEntry, slmAuth=slmAuth, slmSysResetPm=slmSysResetPm, slmSysTrapFormat=slmSysTrapFormat, slmSysIpAddr=slmSysIpAddr, slmChPassNewPass=slmChPassNewPass, slmChPassEntry=slmChPassEntry, slmTrap=slmTrap, slmTrapLogParam5=slmTrapLogParam5, slmEdfaNumber=slmEdfaNumber, slmTrapLogTable=slmTrapLogTable, slmChPass=slmChPass, slmSysOperStatus=slmSysOperStatus, slmSysEncryptionCapability=slmSysEncryptionCapability, slmPmAvailable=slmPmAvailable, slMain=slMain, PYSNMP_MODULE_ID=slMain, slmTid=slmTid, AdminAccess=AdminAccess, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogName=slmTrapLogName, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSys=slmSys, slmSysAlmAct=slmSysAlmAct, slmSysSubnetMask=slmSysSubnetMask, slmVcatDelay=slmVcatDelay, slmSwRevStatus=slmSwRevStatus, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevDirectory=slmSwRevDirectory, slmSnmpv3Auth=slmSnmpv3Auth, slmBoxSize=slmBoxSize, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogPort=slmSyslogPort, slmAdminCommunity=slmAdminCommunity, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysAdminStatus=slmSysAdminStatus, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminAccess=slmAdminAccess, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseIndex=slmLicenseIndex, slmTrapDestCommunity=slmTrapDestCommunity, slmAdminLogin=slmAdminLogin, slmTrapLogParam3=slmTrapLogParam3)
