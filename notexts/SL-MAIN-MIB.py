...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, Gauge32, Bits, Counter32, Opaque, iso, Integer32, ObjectIdentity, Unsigned32, NotificationType, TimeTicks, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "Gauge32", "Bits", "Counter32", "Opaque", "iso", "Integer32", "ObjectIdentity", "Unsigned32", "NotificationType", "TimeTicks", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevTable=slmSwRevTable, slmSysTrapFormat=slmSysTrapFormat, slmSysSubnetMask=slmSysSubnetMask, slmSysCalendarTime=slmSysCalendarTime, slmChPassNewPass=slmChPassNewPass, slmLicenseExpiration=slmLicenseExpiration, slmAdminAccess=slmAdminAccess, slmSysIpAddr=slmSysIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmTid=slmTid, slmSysUplinkRate=slmSysUplinkRate, slmChPassTable=slmChPassTable, slmLicenseIndex=slmLicenseIndex, slmTrapDestCommunity=slmTrapDestCommunity, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmNetworkMode=slmNetworkMode, slmTrapDestEntry=slmTrapDestEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminTable=slmAdminTable, slmReadCommunity=slmReadCommunity, slmSysName=slmSysName, slm40GConf=slm40GConf, slmSwRevName=slmSwRevName, slmAuthTable=slmAuthTable, slmAdminPassword=slmAdminPassword, UserLogin=UserLogin, slmPortsNumber=slmPortsNumber, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmPsuNumber=slmPsuNumber, slmSysOperStatus=slmSysOperStatus, slmAdminEntry=slmAdminEntry, slmLicenseEntry=slmLicenseEntry, slmAdminCommunity=slmAdminCommunity, slmSysAlmAct=slmSysAlmAct, slmSwRevDate=slmSwRevDate, slmSysAdminStatus=slmSysAdminStatus, slmEdfaNumber=slmEdfaNumber, slmAuthEntry=slmAuthEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestAddress=slmTrapDestAddress, slmConfigSysUptime=slmConfigSysUptime, slmTrap=slmTrap, slmSysPmStartOfDay=slmSysPmStartOfDay, slmBoxSize=slmBoxSize, slmTrapDestIpAddress=slmTrapDestIpAddress, slmChPassLogin=slmChPassLogin, slmSwRevDirectory=slmSwRevDirectory, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogParam4=slmTrapLogParam4, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevEntry=slmSwRevEntry, slmConfigFile=slmConfigFile, slmTrapLogEntry=slmTrapLogEntry, AdminAccess=AdminAccess, slmTrapLogParam6=slmTrapLogParam6, slmSyslogLevel=slmSyslogLevel, slmMuxNumber=slmMuxNumber, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogTimeStamp=slmTrapLogTimeStamp, UserPassword=UserPassword, slmSys=slmSys, slmSysLocation=slmSysLocation, slmTrapLogParam3=slmTrapLogParam3, slmLicense=slmLicense, slmTrapPort=slmTrapPort, slmVcatDelay=slmVcatDelay, slmTrapUserLogin=slmTrapUserLogin, slmSysChassisId=slmSysChassisId, slmChPassOldPass=slmChPassOldPass, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogId=slmTrapLogId, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmChPassEntry=slmChPassEntry, slmOemType=slmOemType, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTopologyEnabled=slmTopologyEnabled, slmSyslogPort=slmSyslogPort, slMain=slMain, slmSwRevStatus=slmSwRevStatus, slmSysResetPm=slmSysResetPm, slmSyslogDestEntry=slmSyslogDestEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysSnmpVersion=slmSysSnmpVersion, slmAuth=slmAuth, slmTrapLogParam5=slmTrapLogParam5, PYSNMP_MODULE_ID=slMain, slmAuthCommunity=slmAuthCommunity, slmTrapLogTable=slmTrapLogTable, slmConfigSysSignalType=slmConfigSysSignalType, slmLicenseId=slmLicenseId, slmTrapUserAccess=slmTrapUserAccess, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam1=slmTrapLogParam1, slmLicenseTable=slmLicenseTable, slmSyslogDestTable=slmSyslogDestTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthLogin=slmAuthLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPass=slmChPass, slmTrapCommunity=slmTrapCommunity, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLogFile=slmLogFile, slmAdmin=slmAdmin, slmSysTemperature=slmSysTemperature, slmSnmpv3Auth=slmSnmpv3Auth, slmLogin=slmLogin, slmRebootDelay=slmRebootDelay, slmSysAlmDeact=slmSysAlmDeact, slmAuthPassword=slmAuthPassword, slmRstpEnabled=slmRstpEnabled, slmWriteCommunity=slmWriteCommunity, UserCommunity=UserCommunity, slmPmAvailable=slmPmAvailable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysMode=slmSysMode, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestTable=slmTrapDestTable, SoftwareRevision=SoftwareRevision, slmTrapLogName=slmTrapLogName, slmAdminLogin=slmAdminLogin, slmTrapEnable=slmTrapEnable)
