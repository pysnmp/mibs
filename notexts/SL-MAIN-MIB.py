...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmWriteCommunity=slmWriteCommunity, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysPmStartOfDay=slmSysPmStartOfDay, slmPortsNumber=slmPortsNumber, slmSysAdminStatus=slmSysAdminStatus, slmTrapUserAccess=slmTrapUserAccess, slmAuthLogin=slmAuthLogin, slmSysSnmpVersion=slmSysSnmpVersion, AdminAccess=AdminAccess, slmTrapDestAddress=slmTrapDestAddress, slmSysName=slmSysName, slmSwRevStatus=slmSwRevStatus, slmSys=slmSys, slmSysAlmAct=slmSysAlmAct, slmSwRevEntry=slmSwRevEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam1=slmTrapLogParam1, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestTable=slmTrapDestTable, slmLicense=slmLicense, slmAuthTable=slmAuthTable, slmSysUplinkRate=slmSysUplinkRate, slmPmAvailable=slmPmAvailable, slmTopologyEnabled=slmTopologyEnabled, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysChassisId=slmSysChassisId, slmTid=slmTid, slmNetworkMode=slmNetworkMode, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevDate=slmSwRevDate, slmLicenseEntry=slmLicenseEntry, slmAuthEntry=slmAuthEntry, slmVcatDelay=slmVcatDelay, slmSysTemperature=slmSysTemperature, slmTrapLogParam6=slmTrapLogParam6, slmRebootDelay=slmRebootDelay, slmSysIpAddr=slmSysIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam4=slmTrapLogParam4, slmChPassNewPass=slmChPassNewPass, slmAuthCommunity=slmAuthCommunity, slmSysCalendarTime=slmSysCalendarTime, slmSysMode=slmSysMode, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAuth=slmAuth, slmTrapLogName=slmTrapLogName, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAdminLogin=slmAdminLogin, slmLicenseIndex=slmLicenseIndex, SoftwareRevision=SoftwareRevision, slmOemType=slmOemType, slmTrapDestEntry=slmTrapDestEntry, slmSyslogDestTable=slmSyslogDestTable, slmSysResetPm=slmSysResetPm, slmAdminPassword=slmAdminPassword, slmLicenseId=slmLicenseId, slmSysOperStatus=slmSysOperStatus, slmSyslogPort=slmSyslogPort, slmSwRevName=slmSwRevName, slmTrapLogTable=slmTrapLogTable, slmLogFile=slmLogFile, slmMuxNumber=slmMuxNumber, slmSysLanIpAddr=slmSysLanIpAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogParam2=slmTrapLogParam2, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogDestEntry=slmSyslogDestEntry, slmChPassEntry=slmChPassEntry, slmAdminCommunity=slmAdminCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmPsuNumber=slmPsuNumber, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPassOldPass=slmChPassOldPass, PYSNMP_MODULE_ID=slMain, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmReadCommunity=slmReadCommunity, slmTrapLogParam3=slmTrapLogParam3, slmAdmin=slmAdmin, slmAdminTable=slmAdminTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevTable=slmSwRevTable, slmTrapLogEntry=slmTrapLogEntry, slmAdminEntry=slmAdminEntry, UserPassword=UserPassword, slmSysLocation=slmSysLocation, slmLogin=slmLogin, slmTrapEnable=slmTrapEnable, UserLogin=UserLogin, slmTrap=slmTrap, slm40GConf=slm40GConf, slmSysAlmDeact=slmSysAlmDeact, slmAuthPassword=slmAuthPassword, slmConfigSysSignalType=slmConfigSysSignalType, UserCommunity=UserCommunity, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassLogin=slmChPassLogin, slmChPass=slmChPass, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminRowStatus=slmAdminRowStatus, slMain=slMain, slmTrapDestCommunity=slmTrapDestCommunity, slmRstpEnabled=slmRstpEnabled, slmBoxSize=slmBoxSize, slmSnmpv3Password=slmSnmpv3Password, slmConfigFile=slmConfigFile, slmLicenseExpiration=slmLicenseExpiration, slmConfigSysUptime=slmConfigSysUptime, slmSysTrapFormat=slmSysTrapFormat, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapCommunity=slmTrapCommunity, slmAdminAccess=slmAdminAccess, slmTrapLogId=slmTrapLogId, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogParam5=slmTrapLogParam5, slmSyslogLevel=slmSyslogLevel, slmTrapPort=slmTrapPort, slmChPassTable=slmChPassTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseTable=slmLicenseTable, slmEdfaNumber=slmEdfaNumber, slmSysGatewayAddr=slmSysGatewayAddr, slmSnmpv3Auth=slmSnmpv3Auth)
