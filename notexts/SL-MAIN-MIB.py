...
NotificationType, Integer32, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, ModuleIdentity, Counter64, iso, Bits, Counter32, IpAddress, ObjectIdentity, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "ModuleIdentity", "Counter64", "iso", "Bits", "Counter32", "IpAddress", "ObjectIdentity", "Opaque")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLogFile=slmLogFile, slmChPassLogin=slmChPassLogin, slmSwRevName=slmSwRevName, slmSysCalendarTime=slmSysCalendarTime, slmAdminAccess=slmAdminAccess, slmAdminRowStatus=slmAdminRowStatus, slmSnmpv3Auth=slmSnmpv3Auth, slmLicenseTable=slmLicenseTable, SoftwareRevision=SoftwareRevision, slmSysTrapFormat=slmSysTrapFormat, slmNetworkMode=slmNetworkMode, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSwRevEntry=slmSwRevEntry, slmMuxNumber=slmMuxNumber, slmSysGatewayAddr=slmSysGatewayAddr, slmLogin=slmLogin, slmConfigFile=slmConfigFile, slmConfigSysUptime=slmConfigSysUptime, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam5=slmTrapLogParam5, slmSysEncryptionCapability=slmSysEncryptionCapability, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam2=slmTrapLogParam2, slmLicense=slmLicense, slmSyslogLevel=slmSyslogLevel, slmTrapDestAddress=slmTrapDestAddress, slmAdminPassword=slmAdminPassword, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestEntry=slmTrapDestEntry, slmTrap=slmTrap, slmSysSnmpVersion=slmSysSnmpVersion, slmSysChassisId=slmSysChassisId, slmChPass=slmChPass, slmSysLocation=slmSysLocation, slmVcatDelay=slmVcatDelay, slmChPassOldPass=slmChPassOldPass, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapPort=slmTrapPort, slmTopologyEnabled=slmTopologyEnabled, slmPortsNumber=slmPortsNumber, slmConfigSysSignalType=slmConfigSysSignalType, slmOemType=slmOemType, slmAdminEntry=slmAdminEntry, slmTrapLogParam3=slmTrapLogParam3, slmReadCommunity=slmReadCommunity, slmSysAlmDeact=slmSysAlmDeact, UserCommunity=UserCommunity, slmBoxSize=slmBoxSize, slmAuthPassword=slmAuthPassword, slmChPassNewPass=slmChPassNewPass, slmTrapLogParam1=slmTrapLogParam1, slmSyslogDestAddress=slmSyslogDestAddress, UserPassword=UserPassword, slmLicenseEntry=slmLicenseEntry, slmChPassEntry=slmChPassEntry, slmSwRevDate=slmSwRevDate, slmAuthTable=slmAuthTable, slmTrapDestTable=slmTrapDestTable, slmLicenseIndex=slmLicenseIndex, slMain=slMain, UserLogin=UserLogin, slmTrapLogParam6=slmTrapLogParam6, slmTrapCommunity=slmTrapCommunity, slmSwRevTable=slmSwRevTable, slmLicenseExpiration=slmLicenseExpiration, slmTid=slmTid, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSys=slmSys, slm40GConf=slm40GConf, slmTrapLogEntry=slmTrapLogEntry, slmAuthLogin=slmAuthLogin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapSysLocationChange=slmTrapSysLocationChange, slmRstpEnabled=slmRstpEnabled, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysTemperature=slmSysTemperature, slmSyslogPort=slmSyslogPort, slmAdmin=slmAdmin, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam4=slmTrapLogParam4, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminTable=slmAdminTable, slmSysUplinkRate=slmSysUplinkRate, slmSysMode=slmSysMode, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysIpAddr=slmSysIpAddr, slmTrapLogId=slmTrapLogId, PYSNMP_MODULE_ID=slMain, slmTrapLogTable=slmTrapLogTable, slmPmAvailable=slmPmAvailable, AdminAccess=AdminAccess, slmSysPmStartOfDay=slmSysPmStartOfDay, slmChPassTable=slmChPassTable, slmSysResetPm=slmSysResetPm, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmPsuNumber=slmPsuNumber, slmSyslogDestTable=slmSyslogDestTable, slmAuth=slmAuth, slmAdminCommunity=slmAdminCommunity, slmSysOperStatus=slmSysOperStatus, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogName=slmTrapLogName, slmSysAdminStatus=slmSysAdminStatus, slmSysName=slmSysName, slmRebootDelay=slmRebootDelay, slmWriteCommunity=slmWriteCommunity, slmSysAlmAct=slmSysAlmAct, slmTrapUserAccess=slmTrapUserAccess, slmSwRevDirectory=slmSwRevDirectory, slmAuthCommunity=slmAuthCommunity, slmLicenseId=slmLicenseId, slmSysSubnetMask=slmSysSubnetMask, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevStatus=slmSwRevStatus, slmAuthEntry=slmAuthEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapEnable=slmTrapEnable, slmAdminLogin=slmAdminLogin, slmSnmpv3Priv=slmSnmpv3Priv)
