...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmPsuNumber=slmPsuNumber, slmSysOperStatus=slmSysOperStatus, slmSwRevTable=slmSwRevTable, slmSnmpv3Password=slmSnmpv3Password, slmLogFile=slmLogFile, slmAdminPassword=slmAdminPassword, slMain=slMain, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysLanIpAddr=slmSysLanIpAddr, slmPmAvailable=slmPmAvailable, slmChPass=slmChPass, slmTid=slmTid, slmPortsNumber=slmPortsNumber, slmTopologyEnabled=slmTopologyEnabled, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapSysNameChange=slmTrapSysNameChange, slmSysAlmDeact=slmSysAlmDeact, slmWriteCommunity=slmWriteCommunity, slmChPassEntry=slmChPassEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmNetworkMode=slmNetworkMode, slmAuthCommunity=slmAuthCommunity, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam6=slmTrapLogParam6, slmTrapPort=slmTrapPort, slmLicenseExpiration=slmLicenseExpiration, slmTrapDestEntry=slmTrapDestEntry, slmSysChassisId=slmSysChassisId, slmSysTemperature=slmSysTemperature, slm40GConf=slm40GConf, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmMuxNumber=slmMuxNumber, slmAuthLogin=slmAuthLogin, slmConfigSysUptime=slmConfigSysUptime, slmConfigSysSignalType=slmConfigSysSignalType, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicenseId=slmLicenseId, slmTrapLogTable=slmTrapLogTable, slmSysTrapFormat=slmSysTrapFormat, slmTrap=slmTrap, slmSysMode=slmSysMode, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogPort=slmSyslogPort, UserCommunity=UserCommunity, slmSyslogLevel=slmSyslogLevel, slmConfigFile=slmConfigFile, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPassNewPass=slmChPassNewPass, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogParam5=slmTrapLogParam5, slmRstpEnabled=slmRstpEnabled, slmAdmin=slmAdmin, slmSysAdminStatus=slmSysAdminStatus, slmLicenseEntry=slmLicenseEntry, slmChPassOldPass=slmChPassOldPass, slmAdminLogin=slmAdminLogin, slmChPassTable=slmChPassTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSwRevDirectory=slmSwRevDirectory, slmSysLocation=slmSysLocation, slmAdminEntry=slmAdminEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogId=slmTrapLogId, slmSyslogDestTable=slmSyslogDestTable, slmSysGatewayAddr=slmSysGatewayAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLicense=slmLicense, UserPassword=UserPassword, slmSysIpAddr=slmSysIpAddr, slmTrapDestAddress=slmTrapDestAddress, slmSysUplinkRate=slmSysUplinkRate, slmLicenseIndex=slmLicenseIndex, slmAdminAccess=slmAdminAccess, AdminAccess=AdminAccess, PYSNMP_MODULE_ID=slMain, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogName=slmTrapLogName, slmReadCommunity=slmReadCommunity, slmAdminTable=slmAdminTable, slmSys=slmSys, slmSysName=slmSysName, slmChPassLogin=slmChPassLogin, slmAuth=slmAuth, slmSysCalendarTime=slmSysCalendarTime, slmRebootDelay=slmRebootDelay, slmAuthEntry=slmAuthEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogEntry=slmTrapLogEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam3=slmTrapLogParam3, slmSysSnmpVersion=slmSysSnmpVersion, SoftwareRevision=SoftwareRevision, slmSnmpv3Auth=slmSnmpv3Auth, slmSysSubnetMask=slmSysSubnetMask, slmSwRevDate=slmSwRevDate, slmSyslogDestAddress=slmSyslogDestAddress, slmSwRevEntry=slmSwRevEntry, slmVcatDelay=slmVcatDelay, slmEdfaNumber=slmEdfaNumber, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysResetPm=slmSysResetPm, slmTrapLogParam1=slmTrapLogParam1, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmBoxSize=slmBoxSize, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAuthPassword=slmAuthPassword, slmLicenseTable=slmLicenseTable, slmAdminRowStatus=slmAdminRowStatus, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapCommunity=slmTrapCommunity, slmSwRevStatus=slmSwRevStatus, slmTrapEnable=slmTrapEnable, slmSwRevName=slmSwRevName, slmTrapLogParam4=slmTrapLogParam4, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysAlmAct=slmSysAlmAct, slmLogin=slmLogin, UserLogin=UserLogin, slmOemType=slmOemType, slmTrapDestTable=slmTrapDestTable, slmAuthTable=slmAuthTable, slmTrapLogParam2=slmTrapLogParam2)
