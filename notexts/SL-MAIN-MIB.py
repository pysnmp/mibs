...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmPsuNumber=slmPsuNumber, slmSwRevStatus=slmSwRevStatus, slmPmAvailable=slmPmAvailable, slmEdfaNumber=slmEdfaNumber, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthTable=slmAuthTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysAlmAct=slmSysAlmAct, slmSnmpv3Auth=slmSnmpv3Auth, slmAdminEntry=slmAdminEntry, slmTrapLogParam2=slmTrapLogParam2, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuth=slmAuth, slmRebootDelay=slmRebootDelay, slmLogin=slmLogin, slmLicenseTable=slmLicenseTable, slmSnmpv3Priv=slmSnmpv3Priv, slmTid=slmTid, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicenseIndex=slmLicenseIndex, UserCommunity=UserCommunity, slmTrapLogName=slmTrapLogName, slmLicense=slmLicense, slmSysLocation=slmSysLocation, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminLogin=slmAdminLogin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogTable=slmTrapLogTable, slmSwRevName=slmSwRevName, slmLicenseId=slmLicenseId, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLogFile=slmLogFile, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmNetworkMode=slmNetworkMode, slmSwRevDate=slmSwRevDate, AdminAccess=AdminAccess, slmSysName=slmSysName, slm40GConf=slm40GConf, slmAuthCommunity=slmAuthCommunity, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminTable=slmAdminTable, slmSyslogDestAddress=slmSyslogDestAddress, slmSysCalendarTime=slmSysCalendarTime, slmTrap=slmTrap, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestEntry=slmTrapDestEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam5=slmTrapLogParam5, slmAdmin=slmAdmin, slmVcatDelay=slmVcatDelay, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysSubnetMask=slmSysSubnetMask, slmSyslogPort=slmSyslogPort, slmAuthLogin=slmAuthLogin, slmChPassTable=slmChPassTable, slmSysTrapFormat=slmSysTrapFormat, slmSysResetPm=slmSysResetPm, UserPassword=UserPassword, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogId=slmTrapLogId, slmTrapLogParam1=slmTrapLogParam1, slmSysMode=slmSysMode, slmSys=slmSys, SoftwareRevision=SoftwareRevision, slmSysAdminStatus=slmSysAdminStatus, slmMuxNumber=slmMuxNumber, slmWriteCommunity=slmWriteCommunity, slmTrapCommunity=slmTrapCommunity, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam4=slmTrapLogParam4, slmAdminCommunity=slmAdminCommunity, slmLicenseEntry=slmLicenseEntry, slmTrapDestTable=slmTrapDestTable, slmTrapEnable=slmTrapEnable, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam6=slmTrapLogParam6, slmConfigSysUptime=slmConfigSysUptime, slmSysTemperature=slmSysTemperature, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam3=slmTrapLogParam3, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSwRevTable=slmSwRevTable, slmSysSnmpVersion=slmSysSnmpVersion, slmConfigFile=slmConfigFile, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAuthPassword=slmAuthPassword, slmAdminPassword=slmAdminPassword, slmChPassLogin=slmChPassLogin, slmAdminAccess=slmAdminAccess, slMain=slMain, slmTrapLogEntry=slmTrapLogEntry, PYSNMP_MODULE_ID=slMain, slmSnmpv3Password=slmSnmpv3Password, slmLicenseExpiration=slmLicenseExpiration, slmChPassEntry=slmChPassEntry, slmAuthEntry=slmAuthEntry, slmSysAlmDeact=slmSysAlmDeact, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSwRevDirectory=slmSwRevDirectory, slmOemType=slmOemType, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapSysNameChange=slmTrapSysNameChange, UserLogin=UserLogin, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestAddress=slmTrapDestAddress, slmChPassNewPass=slmChPassNewPass, slmTrapPort=slmTrapPort, slmPortsNumber=slmPortsNumber, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSwRevEntry=slmSwRevEntry, slmTrapUserAccess=slmTrapUserAccess, slmSysUplinkRate=slmSysUplinkRate, slmSyslogLevel=slmSyslogLevel, slmChPass=slmChPass, slmRstpEnabled=slmRstpEnabled, slmReadCommunity=slmReadCommunity, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestTable=slmSyslogDestTable, slmBoxSize=slmBoxSize, slmSysOperStatus=slmSysOperStatus, slmTrapUserLogin=slmTrapUserLogin, slmSysChassisId=slmSysChassisId)
