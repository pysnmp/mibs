...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysAdminStatus=slmSysAdminStatus, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAuth=slmAuth, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogTable=slmTrapLogTable, slmSysChassisId=slmSysChassisId, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogParam5=slmTrapLogParam5, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseIndex=slmLicenseIndex, slmLicense=slmLicense, slmAuthPassword=slmAuthPassword, slmTrapLogId=slmTrapLogId, slmSysCalendarTime=slmSysCalendarTime, slmSysPmStartOfDay=slmSysPmStartOfDay, slmChPassTable=slmChPassTable, slmAdminTable=slmAdminTable, slmChPassNewPass=slmChPassNewPass, slmLogin=slmLogin, slmBoxSize=slmBoxSize, slmLicenseTable=slmLicenseTable, slmLicenseExpiration=slmLicenseExpiration, slmAuthCommunity=slmAuthCommunity, slmTrapUserAccess=slmTrapUserAccess, slmSyslogDestAddress=slmSyslogDestAddress, slmSysName=slmSysName, slmSwRevEntry=slmSwRevEntry, slmTrapPort=slmTrapPort, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam2=slmTrapLogParam2, slm40GConf=slm40GConf, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestEntry=slmTrapDestEntry, slmLicenseId=slmLicenseId, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogName=slmTrapLogName, slmTrapUserLogin=slmTrapUserLogin, slmPsuNumber=slmPsuNumber, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmReadCommunity=slmReadCommunity, slmAuthTable=slmAuthTable, slmSwRevTable=slmSwRevTable, slmChPass=slmChPass, slmSyslogLevel=slmSyslogLevel, slmTrapCommunity=slmTrapCommunity, slmSys=slmSys, slmTrapDestTable=slmTrapDestTable, slmWriteCommunity=slmWriteCommunity, slmSwRevDate=slmSwRevDate, slmNetworkMode=slmNetworkMode, slmChPassOldPass=slmChPassOldPass, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, AdminAccess=AdminAccess, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPassEntry=slmChPassEntry, UserPassword=UserPassword, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapEnable=slmTrapEnable, slmRstpEnabled=slmRstpEnabled, slmChPassLogin=slmChPassLogin, slmSysOperStatus=slmSysOperStatus, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam3=slmTrapLogParam3, slmSysEncryptionCapability=slmSysEncryptionCapability, slmMuxNumber=slmMuxNumber, slmLogFile=slmLogFile, slmAdminCommunity=slmAdminCommunity, slmPortsNumber=slmPortsNumber, slmAdminPassword=slmAdminPassword, slmAdminLogin=slmAdminLogin, slmAdminEntry=slmAdminEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmSysIpAddr=slmSysIpAddr, slmSyslogPort=slmSyslogPort, slmSysTemperature=slmSysTemperature, slmAuthLogin=slmAuthLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminRowStatus=slmAdminRowStatus, slmSnmpv3Password=slmSnmpv3Password, slmTrap=slmTrap, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSwRevName=slmSwRevName, slmOemType=slmOemType, slmSysTrapFormat=slmSysTrapFormat, slmSysGatewayAddr=slmSysGatewayAddr, slmRebootDelay=slmRebootDelay, slmSysLocation=slmSysLocation, slmVcatDelay=slmVcatDelay, slmSnmpv3Auth=slmSnmpv3Auth, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapDestAddress=slmTrapDestAddress, PYSNMP_MODULE_ID=slMain, slmSysAlmDeact=slmSysAlmDeact, slmAuthEntry=slmAuthEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, UserCommunity=UserCommunity, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevStatus=slmSwRevStatus, slmTrapLogParam6=slmTrapLogParam6, slmTid=slmTid, slmTrapLogEntry=slmTrapLogEntry, slmSysResetPm=slmSysResetPm, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmPmAvailable=slmPmAvailable, slmAdminAccess=slmAdminAccess, slmSysLanIpAddr=slmSysLanIpAddr, slmSysAlmAct=slmSysAlmAct, SoftwareRevision=SoftwareRevision, slmSyslogDestTable=slmSyslogDestTable, UserLogin=UserLogin, slMain=slMain, slmAdmin=slmAdmin, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogParam4=slmTrapLogParam4, slmSysMode=slmSysMode, slmConfigSysUptime=slmConfigSysUptime, slmConfigFile=slmConfigFile, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicenseEntry=slmLicenseEntry, slmSysSubnetMask=slmSysSubnetMask)
