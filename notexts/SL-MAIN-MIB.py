...
ModuleIdentity, iso, NotificationType, IpAddress, MibIdentifier, Opaque, Counter64, Gauge32, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "NotificationType", "IpAddress", "MibIdentifier", "Opaque", "Counter64", "Gauge32", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmWriteCommunity=slmWriteCommunity, slmAdminTable=slmAdminTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, UserPassword=UserPassword, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam2=slmTrapLogParam2, slmSysAlmDeact=slmSysAlmDeact, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestTable=slmTrapDestTable, slmSysPmStartOfDay=slmSysPmStartOfDay, slm40GConf=slm40GConf, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapUserAccess=slmTrapUserAccess, slmChPassEntry=slmChPassEntry, slmTrapLogName=slmTrapLogName, slmSysLanIpAddr=slmSysLanIpAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogParam6=slmTrapLogParam6, slmReadCommunity=slmReadCommunity, slmSyslogDestAddress=slmSyslogDestAddress, slmOemType=slmOemType, slmSwRevDate=slmSwRevDate, slmChPassNewPass=slmChPassNewPass, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapSysNameChange=slmTrapSysNameChange, slmAuthPassword=slmAuthPassword, slmConfigFile=slmConfigFile, slmLicenseTable=slmLicenseTable, slmRstpEnabled=slmRstpEnabled, slmNetworkMode=slmNetworkMode, slmSwRevName=slmSwRevName, slmTrap=slmTrap, slmSyslogDestTable=slmSyslogDestTable, slmSwRevTable=slmSwRevTable, slmSyslogLevel=slmSyslogLevel, slmChPassLogin=slmChPassLogin, slmAuthEntry=slmAuthEntry, slmLicenseExpiration=slmLicenseExpiration, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysLocation=slmSysLocation, slmSysEncryptionCapability=slmSysEncryptionCapability, slmMuxNumber=slmMuxNumber, slmVcatDelay=slmVcatDelay, slmAdminCommunity=slmAdminCommunity, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogParam1=slmTrapLogParam1, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAuthLogin=slmAuthLogin, SoftwareRevision=SoftwareRevision, slmTrapLogParam3=slmTrapLogParam3, slmSwRevEntry=slmSwRevEntry, slmAdminEntry=slmAdminEntry, slmAuthTable=slmAuthTable, slmAuthCommunity=slmAuthCommunity, slmAuth=slmAuth, slmSys=slmSys, slmSwRevStatus=slmSwRevStatus, slmLogFile=slmLogFile, slmChPassTable=slmChPassTable, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogEntry=slmTrapLogEntry, slmTrapDestAddress=slmTrapDestAddress, slmTid=slmTid, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestEntry=slmSyslogDestEntry, slmPsuNumber=slmPsuNumber, slmPortsNumber=slmPortsNumber, slmSysSubnetMask=slmSysSubnetMask, slmEdfaNumber=slmEdfaNumber, slmSyslogPort=slmSyslogPort, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmPmAvailable=slmPmAvailable, slmLogin=slmLogin, slmTrapEnable=slmTrapEnable, slmTrapLogTable=slmTrapLogTable, slmSwRevDirectory=slmSwRevDirectory, slmAdmin=slmAdmin, slmSysTemperature=slmSysTemperature, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysGatewayAddr=slmSysGatewayAddr, slmRebootDelay=slmRebootDelay, slmSysIpAddr=slmSysIpAddr, slmSysAdminStatus=slmSysAdminStatus, UserLogin=UserLogin, slmLicense=slmLicense, slmAdminPassword=slmAdminPassword, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam5=slmTrapLogParam5, slMain=slMain, slmSysResetPm=slmSysResetPm, slmAdminLogin=slmAdminLogin, slmTrapPort=slmTrapPort, slmLicenseIndex=slmLicenseIndex, slmBoxSize=slmBoxSize, slmSysMode=slmSysMode, slmSysOperStatus=slmSysOperStatus, slmAdminRowStatus=slmAdminRowStatus, slmTrapCommunity=slmTrapCommunity, PYSNMP_MODULE_ID=slMain, slmChPassOldPass=slmChPassOldPass, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmChPass=slmChPass, slmSysAlmAct=slmSysAlmAct, slmAdminAccess=slmAdminAccess, slmSysChassisId=slmSysChassisId, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicenseId=slmLicenseId, slmLicenseEntry=slmLicenseEntry, UserCommunity=UserCommunity, slmTrapDestEntry=slmTrapDestEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, AdminAccess=AdminAccess, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogId=slmTrapLogId, slmSysName=slmSysName, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysCalendarTime=slmSysCalendarTime, slmSysUplinkRate=slmSysUplinkRate, slmSnmpv3Password=slmSnmpv3Password)
