...
Integer32, Opaque, iso, Counter32, ObjectIdentity, MibIdentifier, Bits, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, TimeTicks, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Opaque", "iso", "Counter32", "ObjectIdentity", "MibIdentifier", "Bits", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "TimeTicks", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysOperStatus=slmSysOperStatus, slmAdminRowStatus=slmAdminRowStatus, slmSysTemperature=slmSysTemperature, UserCommunity=UserCommunity, slmAdmin=slmAdmin, slmAuthPassword=slmAuthPassword, slmSyslogDestTable=slmSyslogDestTable, slmSysAdminStatus=slmSysAdminStatus, slmRebootDelay=slmRebootDelay, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogLevel=slmSyslogLevel, UserPassword=UserPassword, slmLogin=slmLogin, slmSysUplinkRate=slmSysUplinkRate, slmEdfaNumber=slmEdfaNumber, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapSysNameChange=slmTrapSysNameChange, PYSNMP_MODULE_ID=slMain, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestAddress=slmTrapDestAddress, slmSyslogDestEntry=slmSyslogDestEntry, AdminAccess=AdminAccess, slmChPassEntry=slmChPassEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapUserLogin=slmTrapUserLogin, slmAdminAccess=slmAdminAccess, slmOemType=slmOemType, slmReadCommunity=slmReadCommunity, slmSysAlmDeact=slmSysAlmDeact, slmSysIpAddr=slmSysIpAddr, slmTrapPort=slmTrapPort, slmAdminEntry=slmAdminEntry, slmChPassTable=slmChPassTable, slmConfigSysSignalType=slmConfigSysSignalType, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogParam1=slmTrapLogParam1, slmPsuNumber=slmPsuNumber, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam5=slmTrapLogParam5, slmMuxNumber=slmMuxNumber, slmTrapLogId=slmTrapLogId, slmSysNetworkPrefix=slmSysNetworkPrefix, UserLogin=UserLogin, slmSys=slmSys, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogEntry=slmTrapLogEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapCommunity=slmTrapCommunity, slmConfigSysUptime=slmConfigSysUptime, slmLicenseIndex=slmLicenseIndex, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAuthTable=slmAuthTable, slm40GConf=slm40GConf, slmNetworkMode=slmNetworkMode, slmPmAvailable=slmPmAvailable, slmConfigFile=slmConfigFile, slmSyslogPort=slmSyslogPort, slmRstpEnabled=slmRstpEnabled, SoftwareRevision=SoftwareRevision, slmSysMode=slmSysMode, slmLicenseEntry=slmLicenseEntry, slmTrapLogParam4=slmTrapLogParam4, slmLicenseId=slmLicenseId, slmTrapEnable=slmTrapEnable, slmTrapDestTable=slmTrapDestTable, slmTrapLogName=slmTrapLogName, slMain=slMain, slmTrap=slmTrap, slmChPass=slmChPass, slmAdminPassword=slmAdminPassword, slmTid=slmTid, slmSysCalendarTime=slmSysCalendarTime, slmAdminCommunity=slmAdminCommunity, slmSysAlmAct=slmSysAlmAct, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLicenseTable=slmLicenseTable, slmSysTrapFormat=slmSysTrapFormat, slmLogFile=slmLogFile, slmSysEncryptionCapability=slmSysEncryptionCapability, slmBoxSize=slmBoxSize, slmChPassOldPass=slmChPassOldPass, slmVcatDelay=slmVcatDelay, slmWriteCommunity=slmWriteCommunity, slmAdminLogin=slmAdminLogin, slmSwRevDate=slmSwRevDate, slmChPassLogin=slmChPassLogin, slmSwRevTable=slmSwRevTable, slmChPassNewPass=slmChPassNewPass, slmAuthEntry=slmAuthEntry, slmAdminTable=slmAdminTable, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam6=slmTrapLogParam6, slmLicenseExpiration=slmLicenseExpiration, slmLicense=slmLicense, slmSnmpv3Password=slmSnmpv3Password, slmSysChassisId=slmSysChassisId, slmAuthLogin=slmAuthLogin, slmTrapLogParam3=slmTrapLogParam3, slmSnmpv3Auth=slmSnmpv3Auth, slmSysName=slmSysName, slmSwRevEntry=slmSwRevEntry, slmTopologyEnabled=slmTopologyEnabled, slmSwRevName=slmSwRevName, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevStatus=slmSwRevStatus, slmTrapDestEntry=slmTrapDestEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmPortsNumber=slmPortsNumber, slmTrapUserAccess=slmTrapUserAccess, slmAuth=slmAuth, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysSnmpVersion=slmSysSnmpVersion, slmSysLocation=slmSysLocation, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogTable=slmTrapLogTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysResetPm=slmSysResetPm, slmSwRevDirectory=slmSwRevDirectory)
