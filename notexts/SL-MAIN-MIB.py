...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmPortsNumber=slmPortsNumber, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLicenseEntry=slmLicenseEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogDestTable=slmSyslogDestTable, slmTid=slmTid, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapCommunity=slmTrapCommunity, UserCommunity=UserCommunity, slmTrapDestTable=slmTrapDestTable, slmChPassNewPass=slmChPassNewPass, slmConfigSysUptime=slmConfigSysUptime, slmTrapEnable=slmTrapEnable, slmSysCalendarTime=slmSysCalendarTime, slmSysTemperature=slmSysTemperature, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam6=slmTrapLogParam6, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogId=slmTrapLogId, slmReadCommunity=slmReadCommunity, slm40GConf=slm40GConf, slmAdminCommunity=slmAdminCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmVcatDelay=slmVcatDelay, slmLicenseIndex=slmLicenseIndex, slmLicense=slmLicense, slmAuthTable=slmAuthTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysAdminStatus=slmSysAdminStatus, slmLicenseTable=slmLicenseTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysSubnetMask=slmSysSubnetMask, slmLogin=slmLogin, slmLogFile=slmLogFile, slmTrapLogParam2=slmTrapLogParam2, slmAuthLogin=slmAuthLogin, slmRebootDelay=slmRebootDelay, slmSyslogDestEntry=slmSyslogDestEntry, slmAdmin=slmAdmin, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysChassisId=slmSysChassisId, SoftwareRevision=SoftwareRevision, slmSwRevStatus=slmSwRevStatus, slMain=slMain, slmSnmpv3Auth=slmSnmpv3Auth, slmSwRevName=slmSwRevName, slmTrapLogTable=slmTrapLogTable, slmTrapSysNameChange=slmTrapSysNameChange, slmSysOperStatus=slmSysOperStatus, slmSnmpv3Password=slmSnmpv3Password, slmSys=slmSys, slmChPass=slmChPass, AdminAccess=AdminAccess, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminEntry=slmAdminEntry, slmSwRevTable=slmSwRevTable, slmMuxNumber=slmMuxNumber, slmSwRevDate=slmSwRevDate, slmAdminRowStatus=slmAdminRowStatus, slmSysAlmDeact=slmSysAlmDeact, slmSwRevEntry=slmSwRevEntry, slmSyslogLevel=slmSyslogLevel, slmPsuNumber=slmPsuNumber, UserLogin=UserLogin, slmTrapLogEntry=slmTrapLogEntry, slmRstpEnabled=slmRstpEnabled, slmTrap=slmTrap, slmSysAlmAct=slmSysAlmAct, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysResetPm=slmSysResetPm, slmTrapLogParam5=slmTrapLogParam5, slmTrapUserAccess=slmTrapUserAccess, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmNetworkMode=slmNetworkMode, slmAdminPassword=slmAdminPassword, slmTrapUserLogin=slmTrapUserLogin, slmChPassOldPass=slmChPassOldPass, slmLicenseId=slmLicenseId, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminAccess=slmAdminAccess, slmSwRevDirectory=slmSwRevDirectory, slmSysName=slmSysName, slmConfigFile=slmConfigFile, slmSysIpAddr=slmSysIpAddr, slmAdminLogin=slmAdminLogin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLocation=slmSysLocation, slmSyslogPort=slmSyslogPort, slmTrapDestCommunity=slmTrapDestCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysMode=slmSysMode, slmOemType=slmOemType, slmAuth=slmAuth, slmChPassLogin=slmChPassLogin, slmWriteCommunity=slmWriteCommunity, slmChPassTable=slmChPassTable, slmAuthPassword=slmAuthPassword, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogName=slmTrapLogName, slmPmAvailable=slmPmAvailable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, PYSNMP_MODULE_ID=slMain, slmTrapPort=slmTrapPort, slmAuthEntry=slmAuthEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogParam1=slmTrapLogParam1, UserPassword=UserPassword, slmChPassEntry=slmChPassEntry, slmTrapDestEntry=slmTrapDestEntry, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam3=slmTrapLogParam3, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmBoxSize=slmBoxSize, slmAdminTable=slmAdminTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogParam4=slmTrapLogParam4, slmSysTrapFormat=slmSysTrapFormat, slmEdfaNumber=slmEdfaNumber)
