...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, Unsigned32, Integer32, NotificationType, ObjectIdentity, MibIdentifier, Opaque, Counter32, Gauge32, IpAddress, ModuleIdentity, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "Unsigned32", "Integer32", "NotificationType", "ObjectIdentity", "MibIdentifier", "Opaque", "Counter32", "Gauge32", "IpAddress", "ModuleIdentity", "Counter64", "iso")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAuthTable=slmAuthTable, slmConfigSysUptime=slmConfigSysUptime, slmChPassOldPass=slmChPassOldPass, slmTrapLogTable=slmTrapLogTable, slmTrapUserAccess=slmTrapUserAccess, slmAdminEntry=slmAdminEntry, slmVcatDelay=slmVcatDelay, slmLicenseExpiration=slmLicenseExpiration, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLogFile=slmLogFile, slmSysCalendarTime=slmSysCalendarTime, slmAuthCommunity=slmAuthCommunity, slmReadCommunity=slmReadCommunity, slmOemType=slmOemType, slmSwRevName=slmSwRevName, slmConfigFile=slmConfigFile, slmSysChassisId=slmSysChassisId, slmLicenseId=slmLicenseId, slmTrapEnable=slmTrapEnable, slmSwRevEntry=slmSwRevEntry, slmSwRevDirectory=slmSwRevDirectory, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam1=slmTrapLogParam1, slmSysNetworkPrefix=slmSysNetworkPrefix, AdminAccess=AdminAccess, slmTrapLogParam3=slmTrapLogParam3, slmTrap=slmTrap, slmSwRevTable=slmSwRevTable, slmAuthLogin=slmAuthLogin, slmTrapLogId=slmTrapLogId, slmPmAvailable=slmPmAvailable, slmChPassEntry=slmChPassEntry, slmChPass=slmChPass, slmSnmpv3Password=slmSnmpv3Password, slmNetworkMode=slmNetworkMode, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogParam5=slmTrapLogParam5, UserPassword=UserPassword, slmLicenseTable=slmLicenseTable, slmSysSubnetMask=slmSysSubnetMask, slmEdfaNumber=slmEdfaNumber, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicenseEntry=slmLicenseEntry, slmAdminRowStatus=slmAdminRowStatus, slmSysResetPm=slmSysResetPm, slmBoxSize=slmBoxSize, UserCommunity=UserCommunity, slmAuthEntry=slmAuthEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogDestTable=slmSyslogDestTable, slmWriteCommunity=slmWriteCommunity, slmChPassNewPass=slmChPassNewPass, slmAdminLogin=slmAdminLogin, slmLicenseIndex=slmLicenseIndex, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAuth=slmAuth, slmAdminAccess=slmAdminAccess, slmPortsNumber=slmPortsNumber, slmAdminTable=slmAdminTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmSysLocation=slmSysLocation, slmSwRevDate=slmSwRevDate, slmTrapLogParam4=slmTrapLogParam4, slmLogin=slmLogin, slmPsuNumber=slmPsuNumber, slmSwRevStatus=slmSwRevStatus, slmRebootDelay=slmRebootDelay, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTid=slmTid, slmSysName=slmSysName, PYSNMP_MODULE_ID=slMain, slm40GConf=slm40GConf, slmTrapPort=slmTrapPort, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogName=slmTrapLogName, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmRstpEnabled=slmRstpEnabled, slmTrapDestCommunity=slmTrapDestCommunity, slmTopologyEnabled=slmTopologyEnabled, slmAdminPassword=slmAdminPassword, slmMuxNumber=slmMuxNumber, UserLogin=UserLogin, slmSnmpv3Auth=slmSnmpv3Auth, slmLicense=slmLicense, slmTrapDestTable=slmTrapDestTable, slmSysGatewayAddr=slmSysGatewayAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysSnmpVersion=slmSysSnmpVersion, slmSysMode=slmSysMode, slmSysTrapFormat=slmSysTrapFormat, slMain=slMain, slmChPassTable=slmChPassTable, slmTrapDestAddress=slmTrapDestAddress, slmSysAdminStatus=slmSysAdminStatus, slmTrapCommunity=slmTrapCommunity, slmSysAlmAct=slmSysAlmAct, slmSysIpAddr=slmSysIpAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogLevel=slmSyslogLevel, slmAdmin=slmAdmin, slmSyslogPort=slmSyslogPort, slmChPassLogin=slmChPassLogin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSys=slmSys, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestEntry=slmTrapDestEntry, slmAdminCommunity=slmAdminCommunity, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmSysTemperature=slmSysTemperature, slmAuthPassword=slmAuthPassword, slmSysUplinkRate=slmSysUplinkRate, slmSysLanIpAddr=slmSysLanIpAddr, SoftwareRevision=SoftwareRevision, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogEntry=slmTrapLogEntry)
