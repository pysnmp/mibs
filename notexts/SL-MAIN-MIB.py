...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapUserLogin=slmTrapUserLogin, slmTrapLogName=slmTrapLogName, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysName=slmSysName, slmRstpEnabled=slmRstpEnabled, slmBoxSize=slmBoxSize, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSwRevDirectory=slmSwRevDirectory, slmSysAdminStatus=slmSysAdminStatus, slmVcatDelay=slmVcatDelay, slmSysAlmDeact=slmSysAlmDeact, slmSysChassisId=slmSysChassisId, slmMuxNumber=slmMuxNumber, slmSyslogDestEntry=slmSyslogDestEntry, slmWriteCommunity=slmWriteCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysOperStatus=slmSysOperStatus, slmTrapLogId=slmTrapLogId, slmLicenseId=slmLicenseId, slMain=slMain, slmChPass=slmChPass, slmChPassEntry=slmChPassEntry, slmSwRevName=slmSwRevName, slmTrapDestTable=slmTrapDestTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysLocation=slmSysLocation, slmSysTrapFormat=slmSysTrapFormat, slmSysMode=slmSysMode, slmTrapPort=slmTrapPort, slmChPassTable=slmChPassTable, slmSyslogPort=slmSyslogPort, slmSwRevStatus=slmSwRevStatus, slmSys=slmSys, slmTrapLogParam6=slmTrapLogParam6, slmAdminTable=slmAdminTable, slmSysUplinkRate=slmSysUplinkRate, SoftwareRevision=SoftwareRevision, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogParam2=slmTrapLogParam2, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapUserAccess=slmTrapUserAccess, slmRebootDelay=slmRebootDelay, UserCommunity=UserCommunity, slmTrapEnable=slmTrapEnable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapDestRowStatus=slmTrapDestRowStatus, slmReadCommunity=slmReadCommunity, slmAuthLogin=slmAuthLogin, AdminAccess=AdminAccess, slmTrapLogParam3=slmTrapLogParam3, slmAdmin=slmAdmin, slmTrapLogParam1=slmTrapLogParam1, PYSNMP_MODULE_ID=slMain, slmAuthPassword=slmAuthPassword, slmLicenseIndex=slmLicenseIndex, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysGatewayAddr=slmSysGatewayAddr, slmTid=slmTid, slmTrapLogTable=slmTrapLogTable, slmPsuNumber=slmPsuNumber, slmTopologyEnabled=slmTopologyEnabled, slmConfigSysSignalType=slmConfigSysSignalType, slmNetworkMode=slmNetworkMode, slmSnmpv3Auth=slmSnmpv3Auth, slmSysAlmAct=slmSysAlmAct, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuth=slmAuth, slmSysResetPm=slmSysResetPm, slmLicense=slmLicense, slmAdminCommunity=slmAdminCommunity, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLicenseTable=slmLicenseTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicenseEntry=slmLicenseEntry, slmSyslogDestTable=slmSyslogDestTable, slmSnmpv3Password=slmSnmpv3Password, slmSwRevEntry=slmSwRevEntry, slmAdminEntry=slmAdminEntry, slmTrapCommunity=slmTrapCommunity, slmTrap=slmTrap, slmLicenseExpiration=slmLicenseExpiration, slmPmAvailable=slmPmAvailable, slmLogin=slmLogin, slmPortsNumber=slmPortsNumber, slmLogFile=slmLogFile, slmAuthTable=slmAuthTable, slmTrapSysNameChange=slmTrapSysNameChange, slmConfigFile=slmConfigFile, slmSysCalendarTime=slmSysCalendarTime, slmOemType=slmOemType, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminAccess=slmAdminAccess, slmEdfaNumber=slmEdfaNumber, slmSwRevTable=slmSwRevTable, slmSyslogLevel=slmSyslogLevel, slmTrapDestCommunity=slmTrapDestCommunity, slmAdminLogin=slmAdminLogin, slmSwRevDate=slmSwRevDate, slmSysTemperature=slmSysTemperature, slmSysSubnetMask=slmSysSubnetMask, slmSysSnmpVersion=slmSysSnmpVersion, slm40GConf=slm40GConf, UserLogin=UserLogin, slmSysIpAddr=slmSysIpAddr, slmConfigSysUptime=slmConfigSysUptime, slmAuthCommunity=slmAuthCommunity, slmChPassOldPass=slmChPassOldPass, slmAdminRowStatus=slmAdminRowStatus, slmAuthEntry=slmAuthEntry, slmTrapLogEntry=slmTrapLogEntry, slmChPassNewPass=slmChPassNewPass, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogParam5=slmTrapLogParam5, UserPassword=UserPassword, slmTrapDestIpAddress=slmTrapDestIpAddress, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSnmpv3Priv=slmSnmpv3Priv, slmChPassLogin=slmChPassLogin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminPassword=slmAdminPassword, slmTrapLogParam4=slmTrapLogParam4, slmSyslogDestAddress=slmSyslogDestAddress, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLanIpAddr=slmSysLanIpAddr)
