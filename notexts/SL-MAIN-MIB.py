...
Counter32, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Opaque, IpAddress, ModuleIdentity, Bits, Counter64, Unsigned32, iso, Integer32, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Opaque", "IpAddress", "ModuleIdentity", "Bits", "Counter64", "Unsigned32", "iso", "Integer32", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdmin=slmAdmin, slmSyslogDestTable=slmSyslogDestTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevEntry=slmSwRevEntry, slmAuth=slmAuth, slmSysLocation=slmSysLocation, slmLicenseId=slmLicenseId, slmPsuNumber=slmPsuNumber, slmSyslogLevel=slmSyslogLevel, slmSysAlmAct=slmSysAlmAct, slmChPassNewPass=slmChPassNewPass, slmSysNetworkPrefix=slmSysNetworkPrefix, UserPassword=UserPassword, slmChPassOldPass=slmChPassOldPass, slmAdminRowStatus=slmAdminRowStatus, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestTable=slmTrapDestTable, slmLicense=slmLicense, slmSysGatewayAddr=slmSysGatewayAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, AdminAccess=AdminAccess, slmSysChassisId=slmSysChassisId, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam4=slmTrapLogParam4, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAuthPassword=slmAuthPassword, UserCommunity=UserCommunity, slmSwRevTable=slmSwRevTable, slmChPass=slmChPass, slmPortsNumber=slmPortsNumber, slmSwRevDirectory=slmSwRevDirectory, slmMuxNumber=slmMuxNumber, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapCommunity=slmTrapCommunity, slmSwRevName=slmSwRevName, slmWriteCommunity=slmWriteCommunity, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminAccess=slmAdminAccess, slmSysTemperature=slmSysTemperature, slmTrapUserAccess=slmTrapUserAccess, slmEdfaNumber=slmEdfaNumber, slmSysName=slmSysName, slmTrapLogEntry=slmTrapLogEntry, slmAuthEntry=slmAuthEntry, slmTrapDestEntry=slmTrapDestEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSnmpv3Priv=slmSnmpv3Priv, slmChPassEntry=slmChPassEntry, slmLicenseEntry=slmLicenseEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminPassword=slmAdminPassword, slmSysAlmDeact=slmSysAlmDeact, slmSysSnmpVersion=slmSysSnmpVersion, slmSys=slmSys, slmSysEncryptionCapability=slmSysEncryptionCapability, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogTable=slmTrapLogTable, PYSNMP_MODULE_ID=slMain, slmTrapLogId=slmTrapLogId, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestAddress=slmTrapDestAddress, slmTrap=slmTrap, slmTrapLogName=slmTrapLogName, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogPort=slmSyslogPort, slmBoxSize=slmBoxSize, slmSysCalendarTime=slmSysCalendarTime, slmTrapEnable=slmTrapEnable, slmChPassLogin=slmChPassLogin, slMain=slMain, slmTrapLogParam6=slmTrapLogParam6, slmAdminLogin=slmAdminLogin, slmSysOperStatus=slmSysOperStatus, slmTrapUserLogin=slmTrapUserLogin, slmOemType=slmOemType, slmTrapLogParam1=slmTrapLogParam1, slmSysLanIpAddr=slmSysLanIpAddr, slmSysResetPm=slmSysResetPm, slmTrapSysNameChange=slmTrapSysNameChange, slmTid=slmTid, slmAuthTable=slmAuthTable, slmSysSubnetMask=slmSysSubnetMask, slmAuthCommunity=slmAuthCommunity, slmSysIpAddr=slmSysIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmRebootDelay=slmRebootDelay, slmPmAvailable=slmPmAvailable, slm40GConf=slm40GConf, UserLogin=UserLogin, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam2=slmTrapLogParam2, slmConfigFile=slmConfigFile, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevDate=slmSwRevDate, slmTrapLogParam5=slmTrapLogParam5, slmSnmpv3Password=slmSnmpv3Password, slmVcatDelay=slmVcatDelay, slmTrapLogParam3=slmTrapLogParam3, slmSnmpv3Auth=slmSnmpv3Auth, slmLicenseIndex=slmLicenseIndex, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseTable=slmLicenseTable, slmSysAdminStatus=slmSysAdminStatus, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapPort=slmTrapPort, slmLogFile=slmLogFile, slmReadCommunity=slmReadCommunity, slmAdminEntry=slmAdminEntry, slmSysMode=slmSysMode, slmSysTrapFormat=slmSysTrapFormat, slmSwRevStatus=slmSwRevStatus, slmLogin=slmLogin, slmAdminTable=slmAdminTable, slmRstpEnabled=slmRstpEnabled, SoftwareRevision=SoftwareRevision, slmAuthLogin=slmAuthLogin, slmNetworkMode=slmNetworkMode, slmLicenseExpiration=slmLicenseExpiration, slmChPassTable=slmChPassTable, slmSysUplinkRate=slmSysUplinkRate)
