...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogEntry=slmTrapLogEntry, slmAuthCommunity=slmAuthCommunity, slmTopologyEnabled=slmTopologyEnabled, slmTid=slmTid, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogDestTable=slmSyslogDestTable, slmLicenseIndex=slmLicenseIndex, slmAdminEntry=slmAdminEntry, slmSnmpv3Password=slmSnmpv3Password, AdminAccess=AdminAccess, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPassEntry=slmChPassEntry, slmSysSubnetMask=slmSysSubnetMask, slmAdminLogin=slmAdminLogin, slmTrapDestTable=slmTrapDestTable, slmPsuNumber=slmPsuNumber, slmTrapUserLogin=slmTrapUserLogin, slmAuth=slmAuth, slmLogFile=slmLogFile, slmTrapPort=slmTrapPort, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapCommunity=slmTrapCommunity, slmTrapDestCommunity=slmTrapDestCommunity, slmChPassOldPass=slmChPassOldPass, slm40GConf=slm40GConf, slmSysLanIpAddr=slmSysLanIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogName=slmTrapLogName, slmTrapDestAddress=slmTrapDestAddress, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmRstpEnabled=slmRstpEnabled, slMain=slMain, slmSysSnmpVersion=slmSysSnmpVersion, slmSysAlmDeact=slmSysAlmDeact, slmVcatDelay=slmVcatDelay, slmTrapLogParam6=slmTrapLogParam6, slmSyslogDestEntry=slmSyslogDestEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSwRevEntry=slmSwRevEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestEntry=slmTrapDestEntry, SoftwareRevision=SoftwareRevision, slmTrapLogParam5=slmTrapLogParam5, slmSysChassisId=slmSysChassisId, slmSys=slmSys, slmSysLocation=slmSysLocation, slmAdmin=slmAdmin, slmMuxNumber=slmMuxNumber, slmOemType=slmOemType, slmSyslogLevel=slmSyslogLevel, slmTrapSysNameChange=slmTrapSysNameChange, slmAuthEntry=slmAuthEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevTable=slmSwRevTable, UserPassword=UserPassword, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAuthLogin=slmAuthLogin, UserLogin=UserLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmConfigSysUptime=slmConfigSysUptime, slmSyslogDestAddress=slmSyslogDestAddress, slmSysTemperature=slmSysTemperature, slmTrapLogParam2=slmTrapLogParam2, UserCommunity=UserCommunity, slmLicenseExpiration=slmLicenseExpiration, slmNetworkMode=slmNetworkMode, slmSwRevName=slmSwRevName, slmRebootDelay=slmRebootDelay, slmSysCalendarTime=slmSysCalendarTime, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSnmpv3Auth=slmSnmpv3Auth, slmPmAvailable=slmPmAvailable, slmEdfaNumber=slmEdfaNumber, slmSysResetPm=slmSysResetPm, slmAdminRowStatus=slmAdminRowStatus, slmLicenseTable=slmLicenseTable, slmTrapLogId=slmTrapLogId, slmLicense=slmLicense, slmBoxSize=slmBoxSize, slmSysUplinkRate=slmSysUplinkRate, slmChPassLogin=slmChPassLogin, slmTrapLogTable=slmTrapLogTable, slmSysTrapFormat=slmSysTrapFormat, slmChPass=slmChPass, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrap=slmTrap, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysName=slmSysName, slmLicenseEntry=slmLicenseEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysMode=slmSysMode, slmChPassNewPass=slmChPassNewPass, slmTrapLogParam3=slmTrapLogParam3, slmAdminAccess=slmAdminAccess, slmSwRevDirectory=slmSwRevDirectory, slmSysAdminStatus=slmSysAdminStatus, slmWriteCommunity=slmWriteCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmReadCommunity=slmReadCommunity, slmTrapUserAccess=slmTrapUserAccess, slmSwRevStatus=slmSwRevStatus, slmSyslogPort=slmSyslogPort, slmAdminCommunity=slmAdminCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminPassword=slmAdminPassword, slmSysIpAddr=slmSysIpAddr, slmLogin=slmLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmAuthPassword=slmAuthPassword, slmLicenseId=slmLicenseId, slmSwRevDate=slmSwRevDate, slmChPassTable=slmChPassTable, slmPortsNumber=slmPortsNumber, slmSysOperStatus=slmSysOperStatus, slmAdminTable=slmAdminTable, slmTrapEnable=slmTrapEnable, PYSNMP_MODULE_ID=slMain, slmAuthTable=slmAuthTable, slmConfigFile=slmConfigFile, slmSysAlmAct=slmSysAlmAct, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr)
