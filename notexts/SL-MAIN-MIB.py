...
mibBuilder.exportSymbols("SL-MAIN-MIB", PYSNMP_MODULE_ID=slMain, slmTrapLogParam2=slmTrapLogParam2, UserLogin=UserLogin, slmSyslogPort=slmSyslogPort, slmSwRevDate=slmSwRevDate, slmLicense=slmLicense, slmAdminLogin=slmAdminLogin, slmAdminPassword=slmAdminPassword, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminCommunity=slmAdminCommunity, slmSysSubnetMask=slmSysSubnetMask, slmLicenseTable=slmLicenseTable, slmLicenseExpiration=slmLicenseExpiration, slmChPassEntry=slmChPassEntry, slmTrapLogName=slmTrapLogName, slmLicenseId=slmLicenseId, slmTrapPort=slmTrapPort, slmSysActiveSwVersion=slmSysActiveSwVersion, slmReadCommunity=slmReadCommunity, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapDestTable=slmTrapDestTable, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogParam4=slmTrapLogParam4, slmMuxNumber=slmMuxNumber, slmTrapLogParam6=slmTrapLogParam6, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdmin=slmAdmin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTopologyEnabled=slmTopologyEnabled, slmBoxSize=slmBoxSize, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysName=slmSysName, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTid=slmTid, slmPortsNumber=slmPortsNumber, slmSysTemperature=slmSysTemperature, slmAuthCommunity=slmAuthCommunity, slmVcatDelay=slmVcatDelay, slmSnmpv3Auth=slmSnmpv3Auth, slmChPass=slmChPass, slmSysAlmDeact=slmSysAlmDeact, slmAuthTable=slmAuthTable, slmSwRevEntry=slmSwRevEntry, UserPassword=UserPassword, slmChPassLogin=slmChPassLogin, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmEdfaNumber=slmEdfaNumber, slmAuthPassword=slmAuthPassword, slmLicenseIndex=slmLicenseIndex, slmWriteCommunity=slmWriteCommunity, slmRebootDelay=slmRebootDelay, slmTrapDestAddress=slmTrapDestAddress, slmSysTrapFormat=slmSysTrapFormat, slmConfigFile=slmConfigFile, slmSysResetPm=slmSysResetPm, slmAdminEntry=slmAdminEntry, slmLogFile=slmLogFile, slmTrapUserAccess=slmTrapUserAccess, slmOemType=slmOemType, slmSwRevName=slmSwRevName, slmSysMode=slmSysMode, slm40GConf=slm40GConf, slmTrapLogEntry=slmTrapLogEntry, slmSys=slmSys, slmSysSnmpVersion=slmSysSnmpVersion, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminTable=slmAdminTable, slmSnmpv3Password=slmSnmpv3Password, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuthLogin=slmAuthLogin, slmSyslogDestEntry=slmSyslogDestEntry, UserCommunity=UserCommunity, slmChPassTable=slmChPassTable, slmAuthEntry=slmAuthEntry, slmAdminRowStatus=slmAdminRowStatus, slmTrapUserLogin=slmTrapUserLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogTable=slmTrapLogTable, slmSysLocation=slmSysLocation, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysOperStatus=slmSysOperStatus, slmSyslogDestAddress=slmSyslogDestAddress, SoftwareRevision=SoftwareRevision, AdminAccess=AdminAccess, slmChPassNewPass=slmChPassNewPass, slmSysIpAddr=slmSysIpAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmSysChassisId=slmSysChassisId, slmTrapCommunity=slmTrapCommunity, slmSyslogDestTable=slmSyslogDestTable, slmNetworkMode=slmNetworkMode, slmTrapEnable=slmTrapEnable, slMain=slMain, slmAuth=slmAuth, slmChPassOldPass=slmChPassOldPass, slmTrapLogId=slmTrapLogId, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevStatus=slmSwRevStatus, slmPsuNumber=slmPsuNumber, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogParam5=slmTrapLogParam5, slmTrapDestEntry=slmTrapDestEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysUplinkRate=slmSysUplinkRate, slmSysAlmAct=slmSysAlmAct, slmLicenseEntry=slmLicenseEntry, slmTrapLogParam3=slmTrapLogParam3, slmPmAvailable=slmPmAvailable, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestCommunity=slmTrapDestCommunity, slmTrap=slmTrap, slmSysAdminStatus=slmSysAdminStatus, slmAdminAccess=slmAdminAccess, slmSwRevDirectory=slmSwRevDirectory, slmRstpEnabled=slmRstpEnabled, slmLogin=slmLogin, slmSyslogLevel=slmSyslogLevel, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevTable=slmSwRevTable)
