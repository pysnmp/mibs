...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmRebootDelay=slmRebootDelay, slmSysTemperature=slmSysTemperature, slmLicenseIndex=slmLicenseIndex, slmLicenseId=slmLicenseId, slmSysMode=slmSysMode, slmTrapCommunity=slmTrapCommunity, slmSysAlmAct=slmSysAlmAct, slmAdminRowStatus=slmAdminRowStatus, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam3=slmTrapLogParam3, slmAdminAccess=slmAdminAccess, slmAdminTable=slmAdminTable, slmSysResetPm=slmSysResetPm, slmAuthPassword=slmAuthPassword, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysIpAddr=slmSysIpAddr, slmLicenseTable=slmLicenseTable, slmAuthTable=slmAuthTable, slmChPassEntry=slmChPassEntry, slmPortsNumber=slmPortsNumber, slmTrapEnable=slmTrapEnable, slmSysSnmpVersion=slmSysSnmpVersion, PYSNMP_MODULE_ID=slMain, slmTopologyEnabled=slmTopologyEnabled, slmChPassNewPass=slmChPassNewPass, slmRstpEnabled=slmRstpEnabled, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysEncryptionCapability=slmSysEncryptionCapability, slmChPassOldPass=slmChPassOldPass, slm40GConf=slm40GConf, slmAdminCommunity=slmAdminCommunity, slmPsuNumber=slmPsuNumber, slmTid=slmTid, slmSyslogPort=slmSyslogPort, slmLicense=slmLicense, slmWriteCommunity=slmWriteCommunity, slmSyslogDestTable=slmSyslogDestTable, slmOemType=slmOemType, slmChPassLogin=slmChPassLogin, slmLicenseEntry=slmLicenseEntry, slmChPassTable=slmChPassTable, slmTrapSysLocationChange=slmTrapSysLocationChange, UserLogin=UserLogin, slmSysChassisId=slmSysChassisId, slmSysName=slmSysName, slmSysLanIpAddr=slmSysLanIpAddr, slmAuthLogin=slmAuthLogin, slmSwRevName=slmSwRevName, slmSwRevTable=slmSwRevTable, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogParam4=slmTrapLogParam4, slmSwRevEntry=slmSwRevEntry, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestCommunity=slmTrapDestCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysLocation=slmSysLocation, slmTrapPort=slmTrapPort, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogParam1=slmTrapLogParam1, slmTrapDestEntry=slmTrapDestEntry, slmSysOperStatus=slmSysOperStatus, UserPassword=UserPassword, slmBoxSize=slmBoxSize, slmSnmpv3Auth=slmSnmpv3Auth, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestAddress=slmTrapDestAddress, slmReadCommunity=slmReadCommunity, slmSwRevStatus=slmSwRevStatus, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysGatewayAddr=slmSysGatewayAddr, slmNetworkMode=slmNetworkMode, slmAdmin=slmAdmin, slmTrapLogName=slmTrapLogName, slmLicenseExpiration=slmLicenseExpiration, slmSnmpv3Priv=slmSnmpv3Priv, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuth=slmAuth, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdminEntry=slmAdminEntry, slmAdminPassword=slmAdminPassword, slmLogin=slmLogin, slmSysSubnetMask=slmSysSubnetMask, slmSyslogDestAddress=slmSyslogDestAddress, slmPmAvailable=slmPmAvailable, slmSysAlmDeact=slmSysAlmDeact, slmTrapSysNameChange=slmTrapSysNameChange, SoftwareRevision=SoftwareRevision, slmTrapLogParam6=slmTrapLogParam6, slmChPass=slmChPass, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevDate=slmSwRevDate, slmTrapLogId=slmTrapLogId, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysActiveSwVersion=slmSysActiveSwVersion, slmConfigSysSignalType=slmConfigSysSignalType, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, AdminAccess=AdminAccess, slmTrapUserLogin=slmTrapUserLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slMain=slMain, slmSyslogLevel=slmSyslogLevel, slmLogFile=slmLogFile, slmTrap=slmTrap, slmTrapUserAccess=slmTrapUserAccess, slmAdminLogin=slmAdminLogin, slmSnmpv3Password=slmSnmpv3Password, slmAuthCommunity=slmAuthCommunity, slmSysAdminStatus=slmSysAdminStatus, slmConfigSysUptime=slmConfigSysUptime, slmSysNetworkPrefix=slmSysNetworkPrefix, slmEdfaNumber=slmEdfaNumber, slmMuxNumber=slmMuxNumber, slmTrapDestTable=slmTrapDestTable, slmConfigFile=slmConfigFile, slmTrapLogEntry=slmTrapLogEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, UserCommunity=UserCommunity, slmAuthEntry=slmAuthEntry, slmTrapLogTable=slmTrapLogTable, slmSwRevDirectory=slmSwRevDirectory, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSys=slmSys, slmVcatDelay=slmVcatDelay, slmSyslogDestIpAddress=slmSyslogDestIpAddress)
