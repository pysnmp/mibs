...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogParam4=slmTrapLogParam4, slmReadCommunity=slmReadCommunity, slmSysCalendarTime=slmSysCalendarTime, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slMain=slMain, slmTrapPort=slmTrapPort, slmSysName=slmSysName, slmSysIpAddr=slmSysIpAddr, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseEntry=slmLicenseEntry, slmAuthCommunity=slmAuthCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmChPass=slmChPass, slmTid=slmTid, PYSNMP_MODULE_ID=slMain, slmAuthTable=slmAuthTable, slmLicenseId=slmLicenseId, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapCommunity=slmTrapCommunity, slmSysMode=slmSysMode, slmMuxNumber=slmMuxNumber, slmSwRevDirectory=slmSwRevDirectory, slmAdminPassword=slmAdminPassword, slmSnmpv3Priv=slmSnmpv3Priv, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogEntry=slmTrapLogEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysChassisId=slmSysChassisId, slmSysUplinkRate=slmSysUplinkRate, slmEdfaNumber=slmEdfaNumber, slmTrapSysNameChange=slmTrapSysNameChange, slmChPassEntry=slmChPassEntry, slmTrapLogParam2=slmTrapLogParam2, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysResetPm=slmSysResetPm, slmTrap=slmTrap, slmTrapUserAccess=slmTrapUserAccess, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam5=slmTrapLogParam5, slmTrapDestProtVersion=slmTrapDestProtVersion, UserCommunity=UserCommunity, slmLicenseTable=slmLicenseTable, slmTrapLogName=slmTrapLogName, slmTrapDestEntry=slmTrapDestEntry, slmSysLocation=slmSysLocation, slmRstpEnabled=slmRstpEnabled, slmPsuNumber=slmPsuNumber, slmAdmin=slmAdmin, slmSyslogLevel=slmSyslogLevel, slmChPassTable=slmChPassTable, slmSysAlmAct=slmSysAlmAct, slmLicenseIndex=slmLicenseIndex, slmVcatDelay=slmVcatDelay, slmSysAdminStatus=slmSysAdminStatus, slmAdminEntry=slmAdminEntry, slmTrapLogParam6=slmTrapLogParam6, UserLogin=UserLogin, slmSyslogDestTable=slmSyslogDestTable, slmSyslogPort=slmSyslogPort, slmSysTrapFormat=slmSysTrapFormat, slmSnmpv3Password=slmSnmpv3Password, slmOemType=slmOemType, slmAdminRowStatus=slmAdminRowStatus, slmTopologyEnabled=slmTopologyEnabled, slmTrapEnable=slmTrapEnable, slmChPassNewPass=slmChPassNewPass, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogParam1=slmTrapLogParam1, slmSwRevDate=slmSwRevDate, slmTrapDestAddress=slmTrapDestAddress, slmAdminAccess=slmAdminAccess, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuth=slmAuth, UserPassword=UserPassword, slmAuthEntry=slmAuthEntry, slm40GConf=slm40GConf, slmSysOperStatus=slmSysOperStatus, slmTrapDestCommunity=slmTrapDestCommunity, slmSysLanIpAddr=slmSysLanIpAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSyslogDestIpAddress=slmSyslogDestIpAddress, AdminAccess=AdminAccess, SoftwareRevision=SoftwareRevision, slmSysAlmDeact=slmSysAlmDeact, slmConfigSysSignalType=slmConfigSysSignalType, slmChPassLogin=slmChPassLogin, slmTrapUserLogin=slmTrapUserLogin, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevEntry=slmSwRevEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmBoxSize=slmBoxSize, slmSysTemperature=slmSysTemperature, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLogin=slmLogin, slmAdminTable=slmAdminTable, slmRebootDelay=slmRebootDelay, slmSysSubnetMask=slmSysSubnetMask, slmPortsNumber=slmPortsNumber, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogTable=slmTrapLogTable, slmTrapDestTable=slmTrapDestTable, slmAdminCommunity=slmAdminCommunity, slmPmAvailable=slmPmAvailable, slmAuthLogin=slmAuthLogin, slmTrapLogId=slmTrapLogId, slmSwRevTable=slmSwRevTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmConfigSysUptime=slmConfigSysUptime, slmSwRevName=slmSwRevName, slmWriteCommunity=slmWriteCommunity, slmConfigFile=slmConfigFile, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuthPassword=slmAuthPassword, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSwRevStatus=slmSwRevStatus, slmTrapLogParam3=slmTrapLogParam3, slmLicense=slmLicense, slmNetworkMode=slmNetworkMode, slmLogFile=slmLogFile, slmAdminLogin=slmAdminLogin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmSys=slmSys)
