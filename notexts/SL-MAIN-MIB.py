...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysSnmpVersion=slmSysSnmpVersion, slmLicenseIndex=slmLicenseIndex, slmSysMode=slmSysMode, slmSysTrapFormat=slmSysTrapFormat, slmChPassTable=slmChPassTable, slmRebootDelay=slmRebootDelay, slmTrapUserLogin=slmTrapUserLogin, slmTopologyEnabled=slmTopologyEnabled, slmChPassLogin=slmChPassLogin, slmTrapDestCommunity=slmTrapDestCommunity, slmAuthTable=slmAuthTable, slmBoxSize=slmBoxSize, slmReadCommunity=slmReadCommunity, slmAuthEntry=slmAuthEntry, PYSNMP_MODULE_ID=slMain, slmChPass=slmChPass, slm40GConf=slm40GConf, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSwRevDate=slmSwRevDate, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevEntry=slmSwRevEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam4=slmTrapLogParam4, slmTrapPort=slmTrapPort, slmTrapCommunity=slmTrapCommunity, slmSysOperStatus=slmSysOperStatus, slmSysGatewayAddr=slmSysGatewayAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmSnmpv3Priv=slmSnmpv3Priv, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAuthLogin=slmAuthLogin, slmSwRevTable=slmSwRevTable, AdminAccess=AdminAccess, slmChPassEntry=slmChPassEntry, UserLogin=UserLogin, slmTrapSysNameChange=slmTrapSysNameChange, UserPassword=UserPassword, slmPsuNumber=slmPsuNumber, slmTrapLogParam2=slmTrapLogParam2, slmSyslogLevel=slmSyslogLevel, slmPortsNumber=slmPortsNumber, slmPmAvailable=slmPmAvailable, slmSnmpv3Password=slmSnmpv3Password, slmLicenseTable=slmLicenseTable, slmTrapEnable=slmTrapEnable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysTemperature=slmSysTemperature, slmAdminCommunity=slmAdminCommunity, slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevStatus=slmSwRevStatus, slmTrapLogParam5=slmTrapLogParam5, slmSysSubnetMask=slmSysSubnetMask, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam3=slmTrapLogParam3, slmConfigSysUptime=slmConfigSysUptime, slmChPassOldPass=slmChPassOldPass, slmSwRevDirectory=slmSwRevDirectory, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam1=slmTrapLogParam1, slmSysPmStartOfDay=slmSysPmStartOfDay, slmVcatDelay=slmVcatDelay, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLogin=slmLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrap=slmTrap, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSwRevName=slmSwRevName, slmAdmin=slmAdmin, slmSysCalendarTime=slmSysCalendarTime, slmAuthPassword=slmAuthPassword, slmSysChassisId=slmSysChassisId, slmSysLocation=slmSysLocation, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminTable=slmAdminTable, slmSyslogPort=slmSyslogPort, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogTable=slmTrapLogTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysResetPm=slmSysResetPm, slmLicense=slmLicense, slmSysAlmAct=slmSysAlmAct, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestEntry=slmTrapDestEntry, slmSysAlmDeact=slmSysAlmDeact, slmTrapDestAddress=slmTrapDestAddress, slmTrapSysLocationChange=slmTrapSysLocationChange, slmWriteCommunity=slmWriteCommunity, slmEdfaNumber=slmEdfaNumber, slmAdminLogin=slmAdminLogin, slmOemType=slmOemType, slmAdminPassword=slmAdminPassword, slmAuth=slmAuth, slmAuthCommunity=slmAuthCommunity, slmTrapLogName=slmTrapLogName, slmNetworkMode=slmNetworkMode, slmSysUplinkRate=slmSysUplinkRate, slMain=slMain, slmSysAdminStatus=slmSysAdminStatus, SoftwareRevision=SoftwareRevision, slmLicenseId=slmLicenseId, slmTid=slmTid, slmLogFile=slmLogFile, slmTrapLogParam6=slmTrapLogParam6, slmSyslogDestTable=slmSyslogDestTable, slmSysIpAddr=slmSysIpAddr, slmTrapDestTable=slmTrapDestTable, slmConfigFile=slmConfigFile, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogId=slmTrapLogId, slmAdminEntry=slmAdminEntry, slmAdminAccess=slmAdminAccess, slmLicenseExpiration=slmLicenseExpiration, slmTrapUserAccess=slmTrapUserAccess, UserCommunity=UserCommunity, slmAdminRowStatus=slmAdminRowStatus, slmSys=slmSys, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseEntry=slmLicenseEntry, slmMuxNumber=slmMuxNumber, slmRstpEnabled=slmRstpEnabled, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmChPassNewPass=slmChPassNewPass, slmSysName=slmSysName)
