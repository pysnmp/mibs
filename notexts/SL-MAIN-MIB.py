...
Integer32, IpAddress, NotificationType, TimeTicks, Opaque, Gauge32, iso, Counter32, Counter64, ObjectIdentity, Unsigned32, MibIdentifier, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "NotificationType", "TimeTicks", "Opaque", "Gauge32", "iso", "Counter32", "Counter64", "ObjectIdentity", "Unsigned32", "MibIdentifier", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysSubnetMask=slmSysSubnetMask, slmEdfaNumber=slmEdfaNumber, slmSwRevDate=slmSwRevDate, slmTrapLogParam4=slmTrapLogParam4, slmAuthEntry=slmAuthEntry, PYSNMP_MODULE_ID=slMain, slmOemType=slmOemType, slmSwRevStatus=slmSwRevStatus, slmAuthTable=slmAuthTable, slmSysTemperature=slmSysTemperature, slmSysSnmpVersion=slmSysSnmpVersion, slmTrap=slmTrap, slmSnmpv3Password=slmSnmpv3Password, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, UserLogin=UserLogin, AdminAccess=AdminAccess, slm40GConf=slm40GConf, slmTrapDestTable=slmTrapDestTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogParam5=slmTrapLogParam5, slmSysResetPm=slmSysResetPm, slmAuth=slmAuth, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestEntry=slmTrapDestEntry, slmAuthCommunity=slmAuthCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogParam2=slmTrapLogParam2, SoftwareRevision=SoftwareRevision, slmTrapLogParam6=slmTrapLogParam6, slmAdminTable=slmAdminTable, slmPsuNumber=slmPsuNumber, slmSysLocation=slmSysLocation, slmSysAlmAct=slmSysAlmAct, slmLogFile=slmLogFile, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmReadCommunity=slmReadCommunity, slmPmAvailable=slmPmAvailable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysChassisId=slmSysChassisId, slmTrapSysNameChange=slmTrapSysNameChange, slmSysCalendarTime=slmSysCalendarTime, slmNetworkMode=slmNetworkMode, slmChPassOldPass=slmChPassOldPass, slmSysLanIpAddr=slmSysLanIpAddr, slmWriteCommunity=slmWriteCommunity, slmLicenseEntry=slmLicenseEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAuthPassword=slmAuthPassword, slmRstpEnabled=slmRstpEnabled, slmLicenseExpiration=slmLicenseExpiration, slmSysAlmDeact=slmSysAlmDeact, slmLicenseTable=slmLicenseTable, slmAdminAccess=slmAdminAccess, slmSysUplinkRate=slmSysUplinkRate, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogId=slmTrapLogId, slmSysOperStatus=slmSysOperStatus, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPassLogin=slmChPassLogin, slmLogin=slmLogin, slmSysIpAddr=slmSysIpAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminEntry=slmAdminEntry, slmTid=slmTid, slmConfigFile=slmConfigFile, slmSys=slmSys, slmTrapDestAddress=slmTrapDestAddress, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogName=slmTrapLogName, slmTrapSysLocationChange=slmTrapSysLocationChange, slmRebootDelay=slmRebootDelay, slmPortsNumber=slmPortsNumber, slmTrapDestRowStatus=slmTrapDestRowStatus, UserCommunity=UserCommunity, slmAdminCommunity=slmAdminCommunity, slMain=slMain, slmSwRevEntry=slmSwRevEntry, slmConfigSysUptime=slmConfigSysUptime, slmAdminPassword=slmAdminPassword, slmChPass=slmChPass, UserPassword=UserPassword, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestTable=slmSyslogDestTable, slmBoxSize=slmBoxSize, slmLicenseIndex=slmLicenseIndex, slmAdminRowStatus=slmAdminRowStatus, slmTrapPort=slmTrapPort, slmVcatDelay=slmVcatDelay, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogEntry=slmTrapLogEntry, slmAdminLogin=slmAdminLogin, slmMuxNumber=slmMuxNumber, slmTrapLogTable=slmTrapLogTable, slmSwRevTable=slmSwRevTable, slmSysTrapFormat=slmSysTrapFormat, slmTrapCommunity=slmTrapCommunity, slmSyslogLevel=slmSyslogLevel, slmAuthLogin=slmAuthLogin, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapEnable=slmTrapEnable, slmTrapLogParam3=slmTrapLogParam3, slmChPassEntry=slmChPassEntry, slmLicense=slmLicense, slmTrapUserLogin=slmTrapUserLogin, slmSysName=slmSysName, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapUserAccess=slmTrapUserAccess, slmChPassNewPass=slmChPassNewPass, slmSwRevName=slmSwRevName, slmChPassTable=slmChPassTable, slmSysAdminStatus=slmSysAdminStatus, slmTopologyEnabled=slmTopologyEnabled, slmAdmin=slmAdmin, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogPort=slmSyslogPort, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLicenseId=slmLicenseId, slmSysMode=slmSysMode)
