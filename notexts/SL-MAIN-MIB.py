...
MibIdentifier, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, Bits, Opaque, ObjectIdentity, Unsigned32, ModuleIdentity, NotificationType, iso, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "Bits", "Opaque", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "NotificationType", "iso", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSnmpv3Auth=slmSnmpv3Auth, slmPsuNumber=slmPsuNumber, slmTrapSysLocationChange=slmTrapSysLocationChange, slmRebootDelay=slmRebootDelay, slmSwRevName=slmSwRevName, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminCommunity=slmAdminCommunity, slmMuxNumber=slmMuxNumber, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestEntry=slmSyslogDestEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmOemType=slmOemType, slmAuthEntry=slmAuthEntry, slmSwRevTable=slmSwRevTable, slmRstpEnabled=slmRstpEnabled, slmAuthCommunity=slmAuthCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, SoftwareRevision=SoftwareRevision, slmTrapSysNameChange=slmTrapSysNameChange, slmSysAlmDeact=slmSysAlmDeact, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogLevel=slmSyslogLevel, slmChPassOldPass=slmChPassOldPass, slmSwRevDirectory=slmSwRevDirectory, slmAuthLogin=slmAuthLogin, slmLicenseEntry=slmLicenseEntry, slmSysIpAddr=slmSysIpAddr, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogTable=slmTrapLogTable, slmSysCalendarTime=slmSysCalendarTime, slmTrapUserAccess=slmTrapUserAccess, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAuthTable=slmAuthTable, slmSysTrapFormat=slmSysTrapFormat, slmReadCommunity=slmReadCommunity, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapCommunity=slmTrapCommunity, slmAdminAccess=slmAdminAccess, PYSNMP_MODULE_ID=slMain, slmEdfaNumber=slmEdfaNumber, slmChPassNewPass=slmChPassNewPass, slmConfigSysUptime=slmConfigSysUptime, slmLicenseTable=slmLicenseTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysMode=slmSysMode, slmAdmin=slmAdmin, slmLicense=slmLicense, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogParam5=slmTrapLogParam5, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogParam4=slmTrapLogParam4, slmSysLocation=slmSysLocation, slmSwRevStatus=slmSwRevStatus, slmTrapDestCommunity=slmTrapDestCommunity, slmSysChassisId=slmSysChassisId, slmSysAdminStatus=slmSysAdminStatus, slmSysUplinkRate=slmSysUplinkRate, slmChPassTable=slmChPassTable, slmSysAlmAct=slmSysAlmAct, slmTrapDestTable=slmTrapDestTable, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapEnable=slmTrapEnable, slmTrapLogName=slmTrapLogName, slmTrapDestAddress=slmTrapDestAddress, slmChPass=slmChPass, slmAdminEntry=slmAdminEntry, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogParam3=slmTrapLogParam3, slmSysEncryptionCapability=slmSysEncryptionCapability, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysName=slmSysName, slMain=slMain, slmTopologyEnabled=slmTopologyEnabled, slmAdminPassword=slmAdminPassword, slmSys=slmSys, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmTid=slmTid, slmAuth=slmAuth, slm40GConf=slm40GConf, slmAdminLogin=slmAdminLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmPmAvailable=slmPmAvailable, slmSysOperStatus=slmSysOperStatus, slmAuthPassword=slmAuthPassword, slmNetworkMode=slmNetworkMode, slmSysSnmpVersion=slmSysSnmpVersion, slmSysResetPm=slmSysResetPm, slmSwRevDate=slmSwRevDate, slmLicenseIndex=slmLicenseIndex, slmSysTemperature=slmSysTemperature, slmLogin=slmLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassEntry=slmChPassEntry, slmTrapLogEntry=slmTrapLogEntry, slmChPassLogin=slmChPassLogin, slmLogFile=slmLogFile, slmTrap=slmTrap, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, UserPassword=UserPassword, slmTrapDestEntry=slmTrapDestEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmLicenseId=slmLicenseId, slmVcatDelay=slmVcatDelay, UserLogin=UserLogin, slmTrapLogId=slmTrapLogId, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapPort=slmTrapPort, slmPortsNumber=slmPortsNumber, slmSnmpv3Password=slmSnmpv3Password, slmBoxSize=slmBoxSize, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogDestTable=slmSyslogDestTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminTable=slmAdminTable, slmConfigFile=slmConfigFile, UserCommunity=UserCommunity, slmSysSubnetMask=slmSysSubnetMask, slmWriteCommunity=slmWriteCommunity, AdminAccess=AdminAccess, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogParam1=slmTrapLogParam1, slmSyslogPort=slmSyslogPort, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange)
