...
NotificationType, ModuleIdentity, Bits, Opaque, Unsigned32, MibIdentifier, Counter64, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Counter32, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Bits", "Opaque", "Unsigned32", "MibIdentifier", "Counter64", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Counter32", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmNetworkMode=slmNetworkMode, slmTrapLogParam5=slmTrapLogParam5, slmReadCommunity=slmReadCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapUserAccess=slmTrapUserAccess, UserLogin=UserLogin, slmChPassTable=slmChPassTable, slmAuthLogin=slmAuthLogin, slmTrapLogTable=slmTrapLogTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLogin=slmLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmChPass=slmChPass, slmAdminPassword=slmAdminPassword, slmAdminRowStatus=slmAdminRowStatus, slmTid=slmTid, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLocation=slmSysLocation, slmSnmpv3Password=slmSnmpv3Password, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestRowStatus=slmTrapDestRowStatus, PYSNMP_MODULE_ID=slMain, AdminAccess=AdminAccess, slmSysLanIpAddr=slmSysLanIpAddr, slmTopologyEnabled=slmTopologyEnabled, slmLicenseId=slmLicenseId, slmTrapLogEntry=slmTrapLogEntry, slmSysName=slmSysName, slmSysIpAddr=slmSysIpAddr, slmSysMode=slmSysMode, slmTrapLogParam2=slmTrapLogParam2, slmSwRevName=slmSwRevName, slmVcatDelay=slmVcatDelay, slmLicenseTable=slmLicenseTable, slmTrapLogId=slmTrapLogId, slmTrapLogParam4=slmTrapLogParam4, slmAdminCommunity=slmAdminCommunity, slmTrapCommunity=slmTrapCommunity, slmSysAdminStatus=slmSysAdminStatus, slmSysOperStatus=slmSysOperStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slMain=slMain, slmAdminEntry=slmAdminEntry, slmRstpEnabled=slmRstpEnabled, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam1=slmTrapLogParam1, slmSysAlmAct=slmSysAlmAct, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogPort=slmSyslogPort, slmSwRevStatus=slmSwRevStatus, slmAuthTable=slmAuthTable, slmLicenseExpiration=slmLicenseExpiration, slmSysAlmDeact=slmSysAlmDeact, slmConfigFile=slmConfigFile, slmPsuNumber=slmPsuNumber, UserPassword=UserPassword, slmAdminLogin=slmAdminLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmChPassNewPass=slmChPassNewPass, slmAuthPassword=slmAuthPassword, slmTrapDestCommunity=slmTrapDestCommunity, slmAuthCommunity=slmAuthCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysTemperature=slmSysTemperature, slmSysUplinkRate=slmSysUplinkRate, SoftwareRevision=SoftwareRevision, slmSwRevTable=slmSwRevTable, slmChPassEntry=slmChPassEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysChassisId=slmSysChassisId, slmTrapEnable=slmTrapEnable, slmSwRevEntry=slmSwRevEntry, slmSyslogDestTable=slmSyslogDestTable, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogLevel=slmSyslogLevel, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysSubnetMask=slmSysSubnetMask, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapUserLogin=slmTrapUserLogin, slmOemType=slmOemType, slmTrapDestEntry=slmTrapDestEntry, slmEdfaNumber=slmEdfaNumber, slmMuxNumber=slmMuxNumber, slmTrapLogName=slmTrapLogName, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmChPassLogin=slmChPassLogin, slmAdminTable=slmAdminTable, slmWriteCommunity=slmWriteCommunity, slmLicense=slmLicense, slmRebootDelay=slmRebootDelay, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysResetPm=slmSysResetPm, slmTrapDestTable=slmTrapDestTable, slmTrapPort=slmTrapPort, slmSys=slmSys, slmConfigSysUptime=slmConfigSysUptime, slmSwRevDirectory=slmSwRevDirectory, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLicenseIndex=slmLicenseIndex, slmPmAvailable=slmPmAvailable, slmTrap=slmTrap, slm40GConf=slm40GConf, slmSwRevDate=slmSwRevDate, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmPortsNumber=slmPortsNumber, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAuthEntry=slmAuthEntry, slmAuth=slmAuth, slmTrapDestAddress=slmTrapDestAddress, slmAdmin=slmAdmin, slmAdminAccess=slmAdminAccess, slmLogFile=slmLogFile, slmBoxSize=slmBoxSize, slmTrapLogParam6=slmTrapLogParam6, slmTrapSysNameChange=slmTrapSysNameChange, slmChPassOldPass=slmChPassOldPass, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogParam3=slmTrapLogParam3, slmLicenseEntry=slmLicenseEntry, UserCommunity=UserCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr)
