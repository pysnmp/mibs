...
NotificationType, Counter32, Bits, TimeTicks, Unsigned32, Counter64, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, Integer32, Gauge32, ModuleIdentity, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "Bits", "TimeTicks", "Unsigned32", "Counter64", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "Integer32", "Gauge32", "ModuleIdentity", "Opaque")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicenseExpiration=slmLicenseExpiration, slmChPass=slmChPass, slmSwRevName=slmSwRevName, slmSysResetPm=slmSysResetPm, slmLogFile=slmLogFile, slmSysTemperature=slmSysTemperature, slmTrapUserLogin=slmTrapUserLogin, slmLogin=slmLogin, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam3=slmTrapLogParam3, slmAdminRowStatus=slmAdminRowStatus, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogParam6=slmTrapLogParam6, slmTrapEnable=slmTrapEnable, slmSysLanIpAddr=slmSysLanIpAddr, slmSnmpv3Password=slmSnmpv3Password, slmBoxSize=slmBoxSize, slmAdminPassword=slmAdminPassword, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapUserAccess=slmTrapUserAccess, AdminAccess=AdminAccess, slmAdminLogin=slmAdminLogin, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogEntry=slmTrapLogEntry, slmSysAdminStatus=slmSysAdminStatus, slmLicenseId=slmLicenseId, slmAuthLogin=slmAuthLogin, slmTid=slmTid, slmChPassTable=slmChPassTable, slmTrap=slmTrap, slmTrapPort=slmTrapPort, slmSysIpAddr=slmSysIpAddr, slmSyslogDestEntry=slmSyslogDestEntry, slmSysLocation=slmSysLocation, slmPmAvailable=slmPmAvailable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevDate=slmSwRevDate, SoftwareRevision=SoftwareRevision, slmSys=slmSys, slmSyslogPort=slmSyslogPort, slmTrapDestTable=slmTrapDestTable, slmTrapDestEntry=slmTrapDestEntry, slmAuthPassword=slmAuthPassword, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdmin=slmAdmin, slmSwRevDirectory=slmSwRevDirectory, slmEdfaNumber=slmEdfaNumber, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevEntry=slmSwRevEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam1=slmTrapLogParam1, slmSysChassisId=slmSysChassisId, slmConfigSysSignalType=slmConfigSysSignalType, slmAuthCommunity=slmAuthCommunity, slmAuth=slmAuth, slmConfigFile=slmConfigFile, slmSysUplinkRate=slmSysUplinkRate, slmSysAlmDeact=slmSysAlmDeact, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapCommunity=slmTrapCommunity, slm40GConf=slm40GConf, slMain=slMain, slmSwRevTable=slmSwRevTable, slmAuthEntry=slmAuthEntry, slmSysName=slmSysName, PYSNMP_MODULE_ID=slMain, slmSwRevStatus=slmSwRevStatus, slmPortsNumber=slmPortsNumber, slmNetworkMode=slmNetworkMode, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam4=slmTrapLogParam4, slmSyslogDestAddress=slmSyslogDestAddress, UserCommunity=UserCommunity, slmRebootDelay=slmRebootDelay, slmLicense=slmLicense, slmSysMode=slmSysMode, UserPassword=UserPassword, slmTrapLogId=slmTrapLogId, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogLevel=slmSyslogLevel, slmAdminCommunity=slmAdminCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysSubnetMask=slmSysSubnetMask, slmSyslogDestTable=slmSyslogDestTable, slmAdminAccess=slmAdminAccess, slmRstpEnabled=slmRstpEnabled, slmMuxNumber=slmMuxNumber, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminEntry=slmAdminEntry, UserLogin=UserLogin, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminTable=slmAdminTable, slmAuthTable=slmAuthTable, slmLicenseTable=slmLicenseTable, slmChPassOldPass=slmChPassOldPass, slmLicenseIndex=slmLicenseIndex, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassEntry=slmChPassEntry, slmConfigSysUptime=slmConfigSysUptime, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogParam5=slmTrapLogParam5, slmReadCommunity=slmReadCommunity, slmChPassNewPass=slmChPassNewPass, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysEncryptionCapability=slmSysEncryptionCapability, slmWriteCommunity=slmWriteCommunity, slmSysAlmAct=slmSysAlmAct, slmSysTrapFormat=slmSysTrapFormat, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysGatewayAddr=slmSysGatewayAddr, slmSysCalendarTime=slmSysCalendarTime, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogName=slmTrapLogName, slmOemType=slmOemType, slmLicenseEntry=slmLicenseEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmChPassLogin=slmChPassLogin, slmVcatDelay=slmVcatDelay, slmTrapDestCommunity=slmTrapDestCommunity, slmPsuNumber=slmPsuNumber)
