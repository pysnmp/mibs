...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmNetworkMode=slmNetworkMode, slmChPassEntry=slmChPassEntry, slmAuthCommunity=slmAuthCommunity, slmSysUplinkRate=slmSysUplinkRate, slmAdminEntry=slmAdminEntry, slmPortsNumber=slmPortsNumber, slmLicenseExpiration=slmLicenseExpiration, slmSyslogDestAddress=slmSyslogDestAddress, slmBoxSize=slmBoxSize, slmReadCommunity=slmReadCommunity, slmAdminLogin=slmAdminLogin, slmAuthPassword=slmAuthPassword, slmTrapLogTimeStamp=slmTrapLogTimeStamp, AdminAccess=AdminAccess, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuthTable=slmAuthTable, slmLicenseIndex=slmLicenseIndex, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPassLogin=slmChPassLogin, slmAdminPassword=slmAdminPassword, slmSysEncryptionCapability=slmSysEncryptionCapability, slmWriteCommunity=slmWriteCommunity, slmSysAdminStatus=slmSysAdminStatus, slmSwRevDate=slmSwRevDate, slmTrapLogId=slmTrapLogId, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapEnable=slmTrapEnable, slmPmAvailable=slmPmAvailable, slmSysTemperature=slmSysTemperature, slmChPassNewPass=slmChPassNewPass, slmSyslogLevel=slmSyslogLevel, slmTid=slmTid, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysTrapFormat=slmSysTrapFormat, slmConfigSysUptime=slmConfigSysUptime, slmVcatDelay=slmVcatDelay, slmConfigFile=slmConfigFile, slmTrapLogParam3=slmTrapLogParam3, slmLogin=slmLogin, SoftwareRevision=SoftwareRevision, slmSys=slmSys, slmSysChassisId=slmSysChassisId, slmOemType=slmOemType, slmAdmin=slmAdmin, slmChPassTable=slmChPassTable, slmTopologyEnabled=slmTopologyEnabled, slmAuth=slmAuth, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam5=slmTrapLogParam5, slmTrapUserLogin=slmTrapUserLogin, slmSysIpAddr=slmSysIpAddr, slmTrapUserAccess=slmTrapUserAccess, slmSysGatewayAddr=slmSysGatewayAddr, slmRstpEnabled=slmRstpEnabled, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam1=slmTrapLogParam1, slmSysLocation=slmSysLocation, slmAdminAccess=slmAdminAccess, slmMuxNumber=slmMuxNumber, slmChPass=slmChPass, slmTrapLogParam2=slmTrapLogParam2, slmLicense=slmLicense, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogName=slmTrapLogName, slmSwRevDirectory=slmSwRevDirectory, slmTrapPort=slmTrapPort, slmLicenseEntry=slmLicenseEntry, slmLicenseTable=slmLicenseTable, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevStatus=slmSwRevStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, UserPassword=UserPassword, slmTrapDestTable=slmTrapDestTable, slmAdminRowStatus=slmAdminRowStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysResetPm=slmSysResetPm, slmEdfaNumber=slmEdfaNumber, slmAdminCommunity=slmAdminCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseId=slmLicenseId, slmSysAlmDeact=slmSysAlmDeact, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmPsuNumber=slmPsuNumber, slm40GConf=slm40GConf, slmSyslogPort=slmSyslogPort, slmSwRevName=slmSwRevName, slmTrapLogEntry=slmTrapLogEntry, slmSysOperStatus=slmSysOperStatus, slmAuthEntry=slmAuthEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogTable=slmTrapLogTable, slmSysCalendarTime=slmSysCalendarTime, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestCommunity=slmTrapDestCommunity, UserCommunity=UserCommunity, slMain=slMain, UserLogin=UserLogin, slmSyslogDestTable=slmSyslogDestTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthLogin=slmAuthLogin, slmSysMode=slmSysMode, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapCommunity=slmTrapCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSnmpv3Password=slmSnmpv3Password, slmChPassOldPass=slmChPassOldPass, PYSNMP_MODULE_ID=slMain, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLogFile=slmLogFile, slmRebootDelay=slmRebootDelay, slmSwRevTable=slmSwRevTable, slmAdminTable=slmAdminTable, slmTrapDestAddress=slmTrapDestAddress, slmTrapDestEntry=slmTrapDestEntry, slmSysName=slmSysName, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrap=slmTrap, slmSnmpv3Auth=slmSnmpv3Auth, slmSysSubnetMask=slmSysSubnetMask, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysAlmAct=slmSysAlmAct)
