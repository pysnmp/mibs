...
Integer32, NotificationType, ObjectIdentity, iso, Gauge32, Unsigned32, Counter64, IpAddress, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Opaque, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "ObjectIdentity", "iso", "Gauge32", "Unsigned32", "Counter64", "IpAddress", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Opaque", "TimeTicks", "MibIdentifier")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysEncryptionCapability=slmSysEncryptionCapability, slmSwRevStatus=slmSwRevStatus, slm40GConf=slm40GConf, slmSyslogDestAddress=slmSyslogDestAddress, slmOemType=slmOemType, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysMode=slmSysMode, slmAdmin=slmAdmin, slmTid=slmTid, slmChPass=slmChPass, AdminAccess=AdminAccess, slmRebootDelay=slmRebootDelay, SoftwareRevision=SoftwareRevision, slmConfigFile=slmConfigFile, slmAdminAccess=slmAdminAccess, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogTable=slmTrapLogTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam2=slmTrapLogParam2, slmSysTrapFormat=slmSysTrapFormat, slmSysAlmDeact=slmSysAlmDeact, slmVcatDelay=slmVcatDelay, slmSwRevEntry=slmSwRevEntry, slmSyslogPort=slmSyslogPort, UserPassword=UserPassword, slmAdminLogin=slmAdminLogin, slmAuthCommunity=slmAuthCommunity, slmLicenseEntry=slmLicenseEntry, slmAuthPassword=slmAuthPassword, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysTemperature=slmSysTemperature, slmConfigSysSignalType=slmConfigSysSignalType, slmConfigSysUptime=slmConfigSysUptime, slmTrapPort=slmTrapPort, slmSysAlmAct=slmSysAlmAct, slMain=slMain, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysOperStatus=slmSysOperStatus, slmTrapLogId=slmTrapLogId, slmPsuNumber=slmPsuNumber, slmTrapLogParam4=slmTrapLogParam4, slmSys=slmSys, slmLicenseTable=slmLicenseTable, slmSysSnmpVersion=slmSysSnmpVersion, slmWriteCommunity=slmWriteCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdminRowStatus=slmAdminRowStatus, slmSwRevTable=slmSwRevTable, slmLicense=slmLicense, slmTrapLogParam3=slmTrapLogParam3, slmSysGatewayAddr=slmSysGatewayAddr, slmPmAvailable=slmPmAvailable, slmTrapUserLogin=slmTrapUserLogin, slmChPassOldPass=slmChPassOldPass, slmAuthEntry=slmAuthEntry, slmChPassLogin=slmChPassLogin, slmReadCommunity=slmReadCommunity, slmChPassTable=slmChPassTable, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogParam5=slmTrapLogParam5, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, PYSNMP_MODULE_ID=slMain, slmTrapLogParam1=slmTrapLogParam1, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysResetPm=slmSysResetPm, slmAdminTable=slmAdminTable, slmSysName=slmSysName, slmChPassNewPass=slmChPassNewPass, slmTrapLogEntry=slmTrapLogEntry, UserLogin=UserLogin, slmSyslogLevel=slmSyslogLevel, slmChPassEntry=slmChPassEntry, slmSwRevName=slmSwRevName, UserCommunity=UserCommunity, slmTrapDestEntry=slmTrapDestEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicenseExpiration=slmLicenseExpiration, slmAdminEntry=slmAdminEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogName=slmTrapLogName, slmSysLanIpAddr=slmSysLanIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSwRevDirectory=slmSwRevDirectory, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAuthLogin=slmAuthLogin, slmTrap=slmTrap, slmAuth=slmAuth, slmSysCalendarTime=slmSysCalendarTime, slmAdminCommunity=slmAdminCommunity, slmEdfaNumber=slmEdfaNumber, slmLicenseId=slmLicenseId, slmSnmpv3Auth=slmSnmpv3Auth, slmSysChassisId=slmSysChassisId, slmSysAdminStatus=slmSysAdminStatus, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestCommunity=slmTrapDestCommunity, slmSysUplinkRate=slmSysUplinkRate, slmLogin=slmLogin, slmLicenseIndex=slmLicenseIndex, slmTrapCommunity=slmTrapCommunity, slmRstpEnabled=slmRstpEnabled, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysNetworkPrefix=slmSysNetworkPrefix, slmBoxSize=slmBoxSize, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapEnable=slmTrapEnable, slmSyslogDestEntry=slmSyslogDestEntry, slmSysLocation=slmSysLocation, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestTable=slmTrapDestTable, slmSysIpAddr=slmSysIpAddr, slmPortsNumber=slmPortsNumber, slmTrapDestAddress=slmTrapDestAddress, slmAdminPassword=slmAdminPassword, slmLogFile=slmLogFile, slmMuxNumber=slmMuxNumber, slmAuthTable=slmAuthTable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevDate=slmSwRevDate, slmSnmpv3Password=slmSnmpv3Password, slmNetworkMode=slmNetworkMode)
