...
Gauge32, iso, IpAddress, Integer32, ObjectIdentity, Opaque, Counter32, NotificationType, MibIdentifier, Unsigned32, Counter64, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "IpAddress", "Integer32", "ObjectIdentity", "Opaque", "Counter32", "NotificationType", "MibIdentifier", "Unsigned32", "Counter64", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAuthTable=slmAuthTable, slmTrapSysNameChange=slmTrapSysNameChange, slm40GConf=slm40GConf, slmTopologyEnabled=slmTopologyEnabled, slmLicenseIndex=slmLicenseIndex, slmSysName=slmSysName, slmAdminEntry=slmAdminEntry, slmSwRevName=slmSwRevName, slmSnmpv3Password=slmSnmpv3Password, slmAuthPassword=slmAuthPassword, slmSysGatewayAddr=slmSysGatewayAddr, slmEdfaNumber=slmEdfaNumber, slmTrapLogEntry=slmTrapLogEntry, slmAdminLogin=slmAdminLogin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapDestTable=slmTrapDestTable, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogParam1=slmTrapLogParam1, slmSyslogDestTable=slmSyslogDestTable, slmVcatDelay=slmVcatDelay, slmSysIpAddr=slmSysIpAddr, slmTrap=slmTrap, UserCommunity=UserCommunity, slmSyslogDestAddress=slmSyslogDestAddress, AdminAccess=AdminAccess, slmSwRevStatus=slmSwRevStatus, slmSyslogPort=slmSyslogPort, slmSysLocation=slmSysLocation, slmConfigSysUptime=slmConfigSysUptime, slmSysTrapFormat=slmSysTrapFormat, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmNetworkMode=slmNetworkMode, slmPortsNumber=slmPortsNumber, slmTrapCommunity=slmTrapCommunity, slmRebootDelay=slmRebootDelay, slmTrapLogName=slmTrapLogName, slmLicenseTable=slmLicenseTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAuthLogin=slmAuthLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPassEntry=slmChPassEntry, slmAdminPassword=slmAdminPassword, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogTimeStamp=slmTrapLogTimeStamp, SoftwareRevision=SoftwareRevision, slMain=slMain, slmChPassOldPass=slmChPassOldPass, slmSwRevDate=slmSwRevDate, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam3=slmTrapLogParam3, slmSysUplinkRate=slmSysUplinkRate, slmReadCommunity=slmReadCommunity, slmTrapLogParam6=slmTrapLogParam6, slmSysLanIpAddr=slmSysLanIpAddr, slmPsuNumber=slmPsuNumber, slmTrapSysLocationChange=slmTrapSysLocationChange, slmOemType=slmOemType, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminAccess=slmAdminAccess, slmAuth=slmAuth, slmTrapLogId=slmTrapLogId, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLogFile=slmLogFile, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLogin=slmLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthEntry=slmAuthEntry, slmBoxSize=slmBoxSize, slmTrapLogParam2=slmTrapLogParam2, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam4=slmTrapLogParam4, slmSyslogLevel=slmSyslogLevel, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicense=slmLicense, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogParam5=slmTrapLogParam5, slmTrapUserAccess=slmTrapUserAccess, slmMuxNumber=slmMuxNumber, slmSwRevTable=slmSwRevTable, slmConfigFile=slmConfigFile, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapUserLogin=slmTrapUserLogin, slmTid=slmTid, slmTrapEnable=slmTrapEnable, slmTrapLogTable=slmTrapLogTable, slmAdminTable=slmAdminTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminCommunity=slmAdminCommunity, slmSysOperStatus=slmSysOperStatus, slmChPassLogin=slmChPassLogin, slmAdminRowStatus=slmAdminRowStatus, slmSnmpv3Priv=slmSnmpv3Priv, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestAddress=slmTrapDestAddress, slmSysAlmDeact=slmSysAlmDeact, slmSysChassisId=slmSysChassisId, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseEntry=slmLicenseEntry, slmSysAlmAct=slmSysAlmAct, slmSysAdminStatus=slmSysAdminStatus, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestEntry=slmTrapDestEntry, slmChPass=slmChPass, slmChPassNewPass=slmChPassNewPass, slmPmAvailable=slmPmAvailable, slmLicenseId=slmLicenseId, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysResetPm=slmSysResetPm, slmSys=slmSys, slmAdmin=slmAdmin, slmSysTemperature=slmSysTemperature, slmSwRevDirectory=slmSwRevDirectory, slmSysMode=slmSysMode, UserPassword=UserPassword, UserLogin=UserLogin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapPort=slmTrapPort, slmSyslogDestIpAddress=slmSyslogDestIpAddress, PYSNMP_MODULE_ID=slMain, slmSysCalendarTime=slmSysCalendarTime, slmRstpEnabled=slmRstpEnabled, slmSnmpv3Auth=slmSnmpv3Auth, slmChPassTable=slmChPassTable, slmAuthCommunity=slmAuthCommunity, slmSwRevEntry=slmSwRevEntry)
