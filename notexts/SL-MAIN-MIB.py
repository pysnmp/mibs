...
ObjectIdentity, Unsigned32, NotificationType, TimeTicks, iso, Counter64, Bits, ModuleIdentity, IpAddress, Counter32, Opaque, Integer32, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "NotificationType", "TimeTicks", "iso", "Counter64", "Bits", "ModuleIdentity", "IpAddress", "Counter32", "Opaque", "Integer32", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam4=slmTrapLogParam4, slmSysResetPm=slmSysResetPm, slmAuthTable=slmAuthTable, slmSwRevName=slmSwRevName, slmTrapDestCommunity=slmTrapDestCommunity, slmRstpEnabled=slmRstpEnabled, slmLicense=slmLicense, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAuth=slmAuth, slm40GConf=slm40GConf, slmConfigFile=slmConfigFile, slmEdfaNumber=slmEdfaNumber, slmPortsNumber=slmPortsNumber, slmRebootDelay=slmRebootDelay, UserPassword=UserPassword, slmTrapLogId=slmTrapLogId, slmTrapLogTable=slmTrapLogTable, slmTid=slmTid, slmTrapCommunity=slmTrapCommunity, slmSysUplinkRate=slmSysUplinkRate, slmAdminTable=slmAdminTable, slmAuthLogin=slmAuthLogin, slmSys=slmSys, slmWriteCommunity=slmWriteCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSnmpv3Auth=slmSnmpv3Auth, slmLicenseId=slmLicenseId, slmSwRevTable=slmSwRevTable, slmTrapLogParam5=slmTrapLogParam5, AdminAccess=AdminAccess, slmConfigSysUptime=slmConfigSysUptime, slmLogFile=slmLogFile, slmSysLocation=slmSysLocation, slmTrapUserAccess=slmTrapUserAccess, slmChPassLogin=slmChPassLogin, slmTrapLogParam1=slmTrapLogParam1, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAuthEntry=slmAuthEntry, slmChPassTable=slmChPassTable, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogLevel=slmSyslogLevel, slmNetworkMode=slmNetworkMode, slmAuthCommunity=slmAuthCommunity, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam2=slmTrapLogParam2, slmLicenseExpiration=slmLicenseExpiration, slmSnmpv3Priv=slmSnmpv3Priv, slmSysAdminStatus=slmSysAdminStatus, SoftwareRevision=SoftwareRevision, slmTrapDestTable=slmTrapDestTable, slmSwRevStatus=slmSwRevStatus, slmPsuNumber=slmPsuNumber, slmSysGatewayAddr=slmSysGatewayAddr, slmSysOperStatus=slmSysOperStatus, slmSysTrapFormat=slmSysTrapFormat, slmAdminAccess=slmAdminAccess, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysMode=slmSysMode, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevDate=slmSwRevDate, slmSyslogDestTable=slmSyslogDestTable, slmSysAlmDeact=slmSysAlmDeact, slmSysIpAddr=slmSysIpAddr, slmTrapPort=slmTrapPort, slmConfigSysSignalType=slmConfigSysSignalType, slmSysChassisId=slmSysChassisId, slmAdminLogin=slmAdminLogin, slmLicenseIndex=slmLicenseIndex, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slMain=slMain, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogParam6=slmTrapLogParam6, UserCommunity=UserCommunity, slmTrapDestEntry=slmTrapDestEntry, slmSyslogPort=slmSyslogPort, slmChPassEntry=slmChPassEntry, slmSwRevEntry=slmSwRevEntry, slmLicenseEntry=slmLicenseEntry, slmSwRevDirectory=slmSwRevDirectory, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, PYSNMP_MODULE_ID=slMain, UserLogin=UserLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicenseTable=slmLicenseTable, slmTrapUserLogin=slmTrapUserLogin, slmAdminEntry=slmAdminEntry, slmSysName=slmSysName, slmChPassOldPass=slmChPassOldPass, slmReadCommunity=slmReadCommunity, slmTrapLogParam3=slmTrapLogParam3, slmSysAlmAct=slmSysAlmAct, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLanIpAddr=slmSysLanIpAddr, slmChPassNewPass=slmChPassNewPass, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPass=slmChPass, slmLogin=slmLogin, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestAddress=slmSyslogDestAddress, slmAdmin=slmAdmin, slmSysPmStartOfDay=slmSysPmStartOfDay, slmVcatDelay=slmVcatDelay, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAuthPassword=slmAuthPassword, slmTrapEnable=slmTrapEnable, slmTrapLogEntry=slmTrapLogEntry, slmOemType=slmOemType, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogName=slmTrapLogName, slmTrapDestAddress=slmTrapDestAddress, slmMuxNumber=slmMuxNumber, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysTemperature=slmSysTemperature, slmPmAvailable=slmPmAvailable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminPassword=slmAdminPassword, slmTopologyEnabled=slmTopologyEnabled, slmSysSnmpVersion=slmSysSnmpVersion, slmBoxSize=slmBoxSize, slmTrap=slmTrap, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysNetworkPrefix=slmSysNetworkPrefix)
