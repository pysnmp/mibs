...
iso, Gauge32, Bits, MibIdentifier, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, TimeTicks, Integer32, Counter64, Opaque, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "Bits", "MibIdentifier", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "TimeTicks", "Integer32", "Counter64", "Opaque", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysAlmDeact=slmSysAlmDeact, slmSysTrapFormat=slmSysTrapFormat, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestAddress=slmTrapDestAddress, slmAdminAccess=slmAdminAccess, slmTrapLogName=slmTrapLogName, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLocation=slmSysLocation, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLicenseIndex=slmLicenseIndex, slmSyslogLevel=slmSyslogLevel, slmTopologyEnabled=slmTopologyEnabled, slmAdminPassword=slmAdminPassword, slmSysUplinkRate=slmSysUplinkRate, slmSwRevName=slmSwRevName, slmSnmpv3Auth=slmSnmpv3Auth, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSys=slmSys, slmPortsNumber=slmPortsNumber, slmSysGatewayAddr=slmSysGatewayAddr, slmReadCommunity=slmReadCommunity, slmAdmin=slmAdmin, slmTrapCommunity=slmTrapCommunity, slmRebootDelay=slmRebootDelay, slmTrapUserAccess=slmTrapUserAccess, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapEnable=slmTrapEnable, slmTrapLogParam4=slmTrapLogParam4, UserPassword=UserPassword, slmSysSubnetMask=slmSysSubnetMask, slmSysLanIpAddr=slmSysLanIpAddr, slmLicenseTable=slmLicenseTable, slmAuthPassword=slmAuthPassword, slmChPassEntry=slmChPassEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmChPassTable=slmChPassTable, slmSwRevEntry=slmSwRevEntry, slmTrapUserLogin=slmTrapUserLogin, slmSyslogPort=slmSyslogPort, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicenseId=slmLicenseId, slm40GConf=slm40GConf, slmSysTemperature=slmSysTemperature, slmSysMode=slmSysMode, slmOemType=slmOemType, slmTid=slmTid, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, UserLogin=UserLogin, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogParam2=slmTrapLogParam2, slmOpticalSwitchExist=slmOpticalSwitchExist, slmEdfaNumber=slmEdfaNumber, slmSyslogDestTable=slmSyslogDestTable, slmAuth=slmAuth, slmTrapPort=slmTrapPort, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSwRevStatus=slmSwRevStatus, slmAdminCommunity=slmAdminCommunity, slmAdminRowStatus=slmAdminRowStatus, slmBoxSize=slmBoxSize, slmAuthLogin=slmAuthLogin, slmSysOperStatus=slmSysOperStatus, slmChPassLogin=slmChPassLogin, slmSysResetPm=slmSysResetPm, slmTrapDestTable=slmTrapDestTable, slmChPass=slmChPass, slmPmAvailable=slmPmAvailable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSnmpv3Password=slmSnmpv3Password, slmAdminLogin=slmAdminLogin, slmPsuNumber=slmPsuNumber, slmTrapLogEntry=slmTrapLogEntry, slmAuthEntry=slmAuthEntry, slmSysCalendarTime=slmSysCalendarTime, slmChPassNewPass=slmChPassNewPass, slmNetworkMode=slmNetworkMode, slmSysIpAddr=slmSysIpAddr, slmWriteCommunity=slmWriteCommunity, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPassOldPass=slmChPassOldPass, slmAuthCommunity=slmAuthCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminTable=slmAdminTable, slMain=slMain, slmSwRevTable=slmSwRevTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysAlmAct=slmSysAlmAct, slmMuxNumber=slmMuxNumber, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogTable=slmTrapLogTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, UserCommunity=UserCommunity, slmAuthTable=slmAuthTable, slmVcatDelay=slmVcatDelay, slmSysNetworkPrefix=slmSysNetworkPrefix, SoftwareRevision=SoftwareRevision, slmLicense=slmLicense, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam3=slmTrapLogParam3, slmLicenseEntry=slmLicenseEntry, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSwRevDate=slmSwRevDate, slmTrapLogParam6=slmTrapLogParam6, slmSysName=slmSysName, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminEntry=slmAdminEntry, slmLogFile=slmLogFile, slmConfigFile=slmConfigFile, slmTrapDestEntry=slmTrapDestEntry, slmRstpEnabled=slmRstpEnabled, slmConfigSysSignalType=slmConfigSysSignalType, slmSysChassisId=slmSysChassisId, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSnmpv3Priv=slmSnmpv3Priv, slmConfigSysUptime=slmConfigSysUptime, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogId=slmTrapLogId, slmTrap=slmTrap, slmLogin=slmLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseExpiration=slmLicenseExpiration, PYSNMP_MODULE_ID=slMain, AdminAccess=AdminAccess)
