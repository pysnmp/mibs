...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysChassisId=slmSysChassisId, slmSysNetworkPrefix=slmSysNetworkPrefix, AdminAccess=AdminAccess, slmSyslogDestEntry=slmSyslogDestEntry, slmAuthLogin=slmAuthLogin, slmConfigSysUptime=slmConfigSysUptime, slmTrapSysNameChange=slmTrapSysNameChange, UserCommunity=UserCommunity, slmLicense=slmLicense, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogParam1=slmTrapLogParam1, slmTopologyEnabled=slmTopologyEnabled, slmSysSubnetMask=slmSysSubnetMask, slmTrapUserAccess=slmTrapUserAccess, slmRstpEnabled=slmRstpEnabled, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, UserPassword=UserPassword, slmTrap=slmTrap, slmSysLocation=slmSysLocation, slmAuth=slmAuth, slmSysAdminStatus=slmSysAdminStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicenseExpiration=slmLicenseExpiration, slmLogin=slmLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmOemType=slmOemType, slmTrapCommunity=slmTrapCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmChPassEntry=slmChPassEntry, slmTrapLogName=slmTrapLogName, slmTrapLogParam5=slmTrapLogParam5, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmPsuNumber=slmPsuNumber, slmChPassOldPass=slmChPassOldPass, slmAdminTable=slmAdminTable, slmAuthPassword=slmAuthPassword, slmVcatDelay=slmVcatDelay, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam4=slmTrapLogParam4, SoftwareRevision=SoftwareRevision, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysIpAddr=slmSysIpAddr, slmAuthTable=slmAuthTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysCalendarTime=slmSysCalendarTime, UserLogin=UserLogin, slmSysOperStatus=slmSysOperStatus, slmSyslogDestTable=slmSyslogDestTable, slmSnmpv3Auth=slmSnmpv3Auth, slmBoxSize=slmBoxSize, slmNetworkMode=slmNetworkMode, slmSysMode=slmSysMode, slmWriteCommunity=slmWriteCommunity, slmChPassNewPass=slmChPassNewPass, slmSys=slmSys, slmAdminCommunity=slmAdminCommunity, slmAuthCommunity=slmAuthCommunity, slmTrapUserLogin=slmTrapUserLogin, slmTid=slmTid, slmMuxNumber=slmMuxNumber, slmAdmin=slmAdmin, slmSysResetPm=slmSysResetPm, slmSysLanIpAddr=slmSysLanIpAddr, slmLicenseEntry=slmLicenseEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmAuthEntry=slmAuthEntry, slmTrapLogEntry=slmTrapLogEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseIndex=slmLicenseIndex, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam3=slmTrapLogParam3, slmSwRevDirectory=slmSwRevDirectory, slMain=slMain, slmTrapLogParam6=slmTrapLogParam6, slmSysName=slmSysName, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogId=slmTrapLogId, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysTemperature=slmSysTemperature, slmTrapEnable=slmTrapEnable, slmPmAvailable=slmPmAvailable, slmSysGatewayAddr=slmSysGatewayAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestTable=slmTrapDestTable, slmAdminLogin=slmAdminLogin, slm40GConf=slm40GConf, slmSwRevName=slmSwRevName, slmSysAlmAct=slmSysAlmAct, slmSwRevEntry=slmSwRevEntry, slmReadCommunity=slmReadCommunity, slmTrapLogParam2=slmTrapLogParam2, slmSyslogLevel=slmSyslogLevel, slmTrapPort=slmTrapPort, slmLicenseTable=slmLicenseTable, slmLicenseId=slmLicenseId, slmAdminRowStatus=slmAdminRowStatus, slmSwRevTable=slmSwRevTable, slmTrapDestCommunity=slmTrapDestCommunity, slmLogFile=slmLogFile, slmConfigFile=slmConfigFile, slmTrapDestEntry=slmTrapDestEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminEntry=slmAdminEntry, slmSyslogPort=slmSyslogPort, slmPortsNumber=slmPortsNumber, slmSysSnmpVersion=slmSysSnmpVersion, slmChPass=slmChPass, slmAdminAccess=slmAdminAccess, slmChPassTable=slmChPassTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevDate=slmSwRevDate, slmSyslogDestAddress=slmSyslogDestAddress, slmRebootDelay=slmRebootDelay, slmChPassLogin=slmChPassLogin, slmSwRevStatus=slmSwRevStatus, slmAdminPassword=slmAdminPassword, PYSNMP_MODULE_ID=slMain, slmSysUplinkRate=slmSysUplinkRate, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestAddress=slmTrapDestAddress)
