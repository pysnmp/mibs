...
iso, TimeTicks, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, Counter32, Counter64, Opaque, MibIdentifier, NotificationType, ModuleIdentity, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "Counter32", "Counter64", "Opaque", "MibIdentifier", "NotificationType", "ModuleIdentity", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAuthLogin=slmAuthLogin, slmSyslogPort=slmSyslogPort, slmConfigFile=slmConfigFile, slmSyslogDestEntry=slmSyslogDestEntry, slmSysOperStatus=slmSysOperStatus, slmTrapLogId=slmTrapLogId, slMain=slMain, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmPsuNumber=slmPsuNumber, slmLicenseIndex=slmLicenseIndex, slmSysUplinkRate=slmSysUplinkRate, slmConfigSysSignalType=slmConfigSysSignalType, slmRebootDelay=slmRebootDelay, slmChPass=slmChPass, slmSwRevEntry=slmSwRevEntry, slmAdminAccess=slmAdminAccess, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicenseId=slmLicenseId, slmRstpEnabled=slmRstpEnabled, slmSyslogLevel=slmSyslogLevel, slmSysAlmDeact=slmSysAlmDeact, slmAdminLogin=slmAdminLogin, slmSwRevName=slmSwRevName, slmAuthCommunity=slmAuthCommunity, UserCommunity=UserCommunity, slmLogFile=slmLogFile, slmSys=slmSys, slmSyslogDestTable=slmSyslogDestTable, slmAuthPassword=slmAuthPassword, slmTrapUserLogin=slmTrapUserLogin, slmAdminPassword=slmAdminPassword, slmTrapLogName=slmTrapLogName, slmSysResetPm=slmSysResetPm, slmSysAlmAct=slmSysAlmAct, slmSysLocation=slmSysLocation, slmNetworkMode=slmNetworkMode, slmSnmpv3Auth=slmSnmpv3Auth, slmTopologyEnabled=slmTopologyEnabled, slmSysChassisId=slmSysChassisId, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapPort=slmTrapPort, UserLogin=UserLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrap=slmTrap, slmTrapSysNameChange=slmTrapSysNameChange, slmWriteCommunity=slmWriteCommunity, slmAuthTable=slmAuthTable, slmChPassOldPass=slmChPassOldPass, slmChPassTable=slmChPassTable, slmTrapLogParam3=slmTrapLogParam3, slmSnmpv3Password=slmSnmpv3Password, slmConfigSysUptime=slmConfigSysUptime, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapCommunity=slmTrapCommunity, slmSysTrapFormat=slmSysTrapFormat, slmReadCommunity=slmReadCommunity, slmTrapDestEntry=slmTrapDestEntry, slmSysMode=slmSysMode, slmSysCalendarTime=slmSysCalendarTime, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevTable=slmSwRevTable, slmChPassLogin=slmChPassLogin, SoftwareRevision=SoftwareRevision, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTid=slmTid, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogParam5=slmTrapLogParam5, slmSwRevDirectory=slmSwRevDirectory, slmAdminCommunity=slmAdminCommunity, slmMuxNumber=slmMuxNumber, slmAuthEntry=slmAuthEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassEntry=slmChPassEntry, slm40GConf=slm40GConf, slmSysGatewayAddr=slmSysGatewayAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, PYSNMP_MODULE_ID=slMain, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseExpiration=slmLicenseExpiration, slmSysSubnetMask=slmSysSubnetMask, slmLicense=slmLicense, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysName=slmSysName, slmSysNetworkPrefix=slmSysNetworkPrefix, slmPortsNumber=slmPortsNumber, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapDestAddress=slmTrapDestAddress, slmAdminTable=slmAdminTable, slmBoxSize=slmBoxSize, slmSnmpv3Priv=slmSnmpv3Priv, slmAdmin=slmAdmin, slmTrapLogParam4=slmTrapLogParam4, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmPmAvailable=slmPmAvailable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevDate=slmSwRevDate, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminEntry=slmAdminEntry, slmSysTemperature=slmSysTemperature, slmTrapLogTable=slmTrapLogTable, slmSwRevStatus=slmSwRevStatus, slmOemType=slmOemType, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapUserAccess=slmTrapUserAccess, AdminAccess=AdminAccess, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogParam1=slmTrapLogParam1, slmTrapDestTable=slmTrapDestTable, UserPassword=UserPassword, slmAuth=slmAuth, slmVcatDelay=slmVcatDelay, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogEntry=slmTrapLogEntry, slmSysIpAddr=slmSysIpAddr, slmLicenseEntry=slmLicenseEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysAdminStatus=slmSysAdminStatus, slmTrapEnable=slmTrapEnable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmEdfaNumber=slmEdfaNumber, slmLogin=slmLogin, slmChPassNewPass=slmChPassNewPass, slmLicenseTable=slmLicenseTable, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam6=slmTrapLogParam6)
