...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmPsuNumber=slmPsuNumber, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmSysTemperature=slmSysTemperature, UserCommunity=UserCommunity, slmLicenseEntry=slmLicenseEntry, UserLogin=UserLogin, slm40GConf=slm40GConf, slmTid=slmTid, slmLogin=slmLogin, slmLicense=slmLicense, slmReadCommunity=slmReadCommunity, slmChPassNewPass=slmChPassNewPass, slmAdminRowStatus=slmAdminRowStatus, slmSyslogLevel=slmSyslogLevel, slmTrapDestCommunity=slmTrapDestCommunity, UserPassword=UserPassword, slmAdminLogin=slmAdminLogin, slmSwRevStatus=slmSwRevStatus, slmSnmpv3Auth=slmSnmpv3Auth, slmRebootDelay=slmRebootDelay, slmSyslogDestTable=slmSyslogDestTable, slmTrapSysNameChange=slmTrapSysNameChange, slmSysOperStatus=slmSysOperStatus, slmAdminTable=slmAdminTable, slmTrapLogTable=slmTrapLogTable, slmMuxNumber=slmMuxNumber, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogParam6=slmTrapLogParam6, slmEdfaNumber=slmEdfaNumber, slmAdminEntry=slmAdminEntry, slmSysIpAddr=slmSysIpAddr, slmChPass=slmChPass, slmTrapPort=slmTrapPort, slmAdminAccess=slmAdminAccess, slmSwRevTable=slmSwRevTable, slmPortsNumber=slmPortsNumber, slmSysName=slmSysName, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogName=slmTrapLogName, slmSysAdminStatus=slmSysAdminStatus, slmTrapDestTable=slmTrapDestTable, slmSysTrapFormat=slmSysTrapFormat, slmChPassOldPass=slmChPassOldPass, slmTrapUserLogin=slmTrapUserLogin, slmWriteCommunity=slmWriteCommunity, slmTopologyEnabled=slmTopologyEnabled, slmConfigSysUptime=slmConfigSysUptime, slmAuthCommunity=slmAuthCommunity, slmAdmin=slmAdmin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmChPassTable=slmChPassTable, slmSysLanIpAddr=slmSysLanIpAddr, slmSnmpv3Password=slmSnmpv3Password, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseExpiration=slmLicenseExpiration, slmSysSnmpVersion=slmSysSnmpVersion, AdminAccess=AdminAccess, slmConfigFile=slmConfigFile, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogParam2=slmTrapLogParam2, slmLicenseIndex=slmLicenseIndex, slmSysLocation=slmSysLocation, slmTrapDestAddress=slmTrapDestAddress, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminCommunity=slmAdminCommunity, slmSysUplinkRate=slmSysUplinkRate, slmAuthLogin=slmAuthLogin, slmTrapLogParam1=slmTrapLogParam1, slmAdminPassword=slmAdminPassword, slmLicenseTable=slmLicenseTable, slMain=slMain, slmSysResetPm=slmSysResetPm, slmSysAlmDeact=slmSysAlmDeact, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysChassisId=slmSysChassisId, slmTrapLogId=slmTrapLogId, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam3=slmTrapLogParam3, slmChPassEntry=slmChPassEntry, slmAuthPassword=slmAuthPassword, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLogFile=slmLogFile, slmBoxSize=slmBoxSize, slmSwRevDate=slmSwRevDate, slmTrapLogParam4=slmTrapLogParam4, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapEnable=slmTrapEnable, slmRstpEnabled=slmRstpEnabled, slmLicenseId=slmLicenseId, SoftwareRevision=SoftwareRevision, slmSysNetworkPrefix=slmSysNetworkPrefix, slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPassLogin=slmChPassLogin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestEntry=slmTrapDestEntry, slmSysSubnetMask=slmSysSubnetMask, slmSwRevName=slmSwRevName, PYSNMP_MODULE_ID=slMain, slmSysMode=slmSysMode, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogEntry=slmTrapLogEntry, slmSys=slmSys, slmSwRevEntry=slmSwRevEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysCalendarTime=slmSysCalendarTime, slmTrap=slmTrap, slmTrapUserAccess=slmTrapUserAccess, slmNetworkMode=slmNetworkMode, slmTrapDestIpAddress=slmTrapDestIpAddress, slmVcatDelay=slmVcatDelay, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAuthEntry=slmAuthEntry, slmOemType=slmOemType, slmAuth=slmAuth, slmSwRevDirectory=slmSwRevDirectory, slmPmAvailable=slmPmAvailable, slmSysAlmAct=slmSysAlmAct, slmTrapCommunity=slmTrapCommunity, slmSnmpv3Priv=slmSnmpv3Priv, slmAuthTable=slmAuthTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSyslogPort=slmSyslogPort)
