...
Bits, NotificationType, IpAddress, Unsigned32, ObjectIdentity, ModuleIdentity, Gauge32, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, MibIdentifier, TimeTicks, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "IpAddress", "Unsigned32", "ObjectIdentity", "ModuleIdentity", "Gauge32", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "MibIdentifier", "TimeTicks", "iso", "Integer32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, AdminAccess=AdminAccess, slmRstpEnabled=slmRstpEnabled, slmAdmin=slmAdmin, slmTrap=slmTrap, slmSysTrapFormat=slmSysTrapFormat, slmChPassEntry=slmChPassEntry, slmAdminCommunity=slmAdminCommunity, slmSysSnmpVersion=slmSysSnmpVersion, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminEntry=slmAdminEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPassLogin=slmChPassLogin, slmLogFile=slmLogFile, slmTrapLogParam4=slmTrapLogParam4, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogTable=slmTrapLogTable, slmChPassTable=slmChPassTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSwRevTable=slmSwRevTable, slmEdfaNumber=slmEdfaNumber, slmMuxNumber=slmMuxNumber, slmPmAvailable=slmPmAvailable, slmLicenseId=slmLicenseId, slmSysMode=slmSysMode, slmSwRevDate=slmSwRevDate, slmWriteCommunity=slmWriteCommunity, slmAdminTable=slmAdminTable, slmSysOperStatus=slmSysOperStatus, slmSwRevStatus=slmSwRevStatus, slmAuthCommunity=slmAuthCommunity, slmSyslogPort=slmSyslogPort, slmLicenseEntry=slmLicenseEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLicenseIndex=slmLicenseIndex, slmSysName=slmSysName, slmPortsNumber=slmPortsNumber, slmAuth=slmAuth, slmSysChassisId=slmSysChassisId, slmSwRevDirectory=slmSwRevDirectory, slMain=slMain, slmTrapCommunity=slmTrapCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmOemType=slmOemType, slmAdminRowStatus=slmAdminRowStatus, slmLicenseTable=slmLicenseTable, slmSyslogDestAddress=slmSyslogDestAddress, slmReadCommunity=slmReadCommunity, slmChPassNewPass=slmChPassNewPass, slmAdminLogin=slmAdminLogin, slmLogin=slmLogin, slmSysLocation=slmSysLocation, slmVcatDelay=slmVcatDelay, slmLicenseExpiration=slmLicenseExpiration, slmTopologyEnabled=slmTopologyEnabled, slmPsuNumber=slmPsuNumber, slmLicense=slmLicense, slmBoxSize=slmBoxSize, slmChPassOldPass=slmChPassOldPass, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmRebootDelay=slmRebootDelay, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysTemperature=slmSysTemperature, slmSyslogDestEntry=slmSyslogDestEntry, slmAuthEntry=slmAuthEntry, UserLogin=UserLogin, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogName=slmTrapLogName, slmSysResetPm=slmSysResetPm, slmSysSubnetMask=slmSysSubnetMask, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogParam5=slmTrapLogParam5, slmTid=slmTid, slmSyslogDestTable=slmSyslogDestTable, slmSysUplinkRate=slmSysUplinkRate, slmSysIpAddr=slmSysIpAddr, PYSNMP_MODULE_ID=slMain, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapEnable=slmTrapEnable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogId=slmTrapLogId, slmSysAlmAct=slmSysAlmAct, slmSysLanIpAddr=slmSysLanIpAddr, slmAuthTable=slmAuthTable, slmConfigSysSignalType=slmConfigSysSignalType, slmConfigSysUptime=slmConfigSysUptime, slmNetworkMode=slmNetworkMode, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogLevel=slmSyslogLevel, slmChPass=slmChPass, slmSwRevName=slmSwRevName, slmAuthPassword=slmAuthPassword, slmSnmpv3Auth=slmSnmpv3Auth, slmSysCalendarTime=slmSysCalendarTime, slmAuthLogin=slmAuthLogin, slmSysAdminStatus=slmSysAdminStatus, slmSwRevEntry=slmSwRevEntry, slmTrapDestTable=slmTrapDestTable, slmTrapLogEntry=slmTrapLogEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmSysPmStartOfDay=slmSysPmStartOfDay, slm40GConf=slm40GConf, slmSnmpv3Password=slmSnmpv3Password, slmAdminAccess=slmAdminAccess, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogParam3=slmTrapLogParam3, slmTrapUserAccess=slmTrapUserAccess, slmConfigFile=slmConfigFile, slmTrapDestEntry=slmTrapDestEntry, UserCommunity=UserCommunity, slmSys=slmSys, slmAdminPassword=slmAdminPassword, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysAlmDeact=slmSysAlmDeact, slmSysGatewayAddr=slmSysGatewayAddr, UserPassword=UserPassword, slmTrapPort=slmTrapPort, slmTrapDestCommunity=slmTrapDestCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, SoftwareRevision=SoftwareRevision, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange)
