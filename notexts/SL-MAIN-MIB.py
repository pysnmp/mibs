...
Opaque, Counter64, Bits, NotificationType, ModuleIdentity, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, TimeTicks, MibIdentifier, Counter32, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "Counter64", "Bits", "NotificationType", "ModuleIdentity", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "TimeTicks", "MibIdentifier", "Counter32", "Integer32", "iso")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysLocation=slmSysLocation, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysMode=slmSysMode, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestAddress=slmTrapDestAddress, slmChPassOldPass=slmChPassOldPass, slmOemType=slmOemType, slmAuth=slmAuth, slmConfigFile=slmConfigFile, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTopologyEnabled=slmTopologyEnabled, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapCommunity=slmTrapCommunity, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestRowStatus=slmTrapDestRowStatus, slmPsuNumber=slmPsuNumber, slmSwRevTable=slmSwRevTable, slmTid=slmTid, slmSysSnmpVersion=slmSysSnmpVersion, slmSysChassisId=slmSysChassisId, slmSysName=slmSysName, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogParam4=slmTrapLogParam4, slmAdminCommunity=slmAdminCommunity, slmLicenseTable=slmLicenseTable, slmTrapDestTable=slmTrapDestTable, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapUserAccess=slmTrapUserAccess, slmSysUplinkRate=slmSysUplinkRate, slmAdminRowStatus=slmAdminRowStatus, slmNetworkMode=slmNetworkMode, slmTrapLogName=slmTrapLogName, slmReadCommunity=slmReadCommunity, slmSysSubnetMask=slmSysSubnetMask, slmChPassEntry=slmChPassEntry, slmTrapEnable=slmTrapEnable, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogDestTable=slmSyslogDestTable, slmSyslogPort=slmSyslogPort, slmTrapLogTable=slmTrapLogTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLogin=slmLogin, slmAuthTable=slmAuthTable, slmRstpEnabled=slmRstpEnabled, slmTrapLogId=slmTrapLogId, UserCommunity=UserCommunity, slmTrapDestCommunity=slmTrapDestCommunity, slmPortsNumber=slmPortsNumber, slmChPassNewPass=slmChPassNewPass, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapDestEntry=slmTrapDestEntry, slmAdminLogin=slmAdminLogin, slmLicenseIndex=slmLicenseIndex, slmSyslogLevel=slmSyslogLevel, slmSwRevDirectory=slmSwRevDirectory, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapPort=slmTrapPort, slmAdminPassword=slmAdminPassword, slmVcatDelay=slmVcatDelay, slmSysAlmDeact=slmSysAlmDeact, slmSyslogDestEntry=slmSyslogDestEntry, slmAuthLogin=slmAuthLogin, slmAdmin=slmAdmin, slmSysAlmAct=slmSysAlmAct, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogParam5=slmTrapLogParam5, slmChPassLogin=slmChPassLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminEntry=slmAdminEntry, slMain=slMain, slmTrapUserLogin=slmTrapUserLogin, slmWriteCommunity=slmWriteCommunity, slmSnmpv3Password=slmSnmpv3Password, slmLicenseEntry=slmLicenseEntry, slmLicenseExpiration=slmLicenseExpiration, slmSysCalendarTime=slmSysCalendarTime, slmConfigSysSignalType=slmConfigSysSignalType, slmPmAvailable=slmPmAvailable, slmChPassTable=slmChPassTable, slmTrapSysLocationChange=slmTrapSysLocationChange, UserLogin=UserLogin, slmSwRevEntry=slmSwRevEntry, slmTrap=slmTrap, AdminAccess=AdminAccess, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam1=slmTrapLogParam1, slmTrapLogEntry=slmTrapLogEntry, PYSNMP_MODULE_ID=slMain, slmTrapLogParam3=slmTrapLogParam3, slmAdminAccess=slmAdminAccess, slmAuthPassword=slmAuthPassword, slmSysAdminStatus=slmSysAdminStatus, slmLicenseId=slmLicenseId, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuthCommunity=slmAuthCommunity, slmSysResetPm=slmSysResetPm, slmEdfaNumber=slmEdfaNumber, slmLicense=slmLicense, slmSwRevDate=slmSwRevDate, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapSysNameChange=slmTrapSysNameChange, slmLogFile=slmLogFile, slmConfigSysUptime=slmConfigSysUptime, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuthEntry=slmAuthEntry, slmSwRevName=slmSwRevName, slmChPass=slmChPass, slmSys=slmSys, slmTrapLogParam2=slmTrapLogParam2, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSnmpv3Priv=slmSnmpv3Priv, slmSwRevStatus=slmSwRevStatus, SoftwareRevision=SoftwareRevision, slmSysTemperature=slmSysTemperature, UserPassword=UserPassword, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysNetworkPrefix=slmSysNetworkPrefix, slmMuxNumber=slmMuxNumber, slmSysOperStatus=slmSysOperStatus, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmBoxSize=slmBoxSize, slm40GConf=slm40GConf, slmAdminTable=slmAdminTable, slmRebootDelay=slmRebootDelay, slmTrapLogParam6=slmTrapLogParam6)
