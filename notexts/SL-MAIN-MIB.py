...
Bits, ModuleIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, Gauge32, iso, MibIdentifier, IpAddress, Opaque, NotificationType, TimeTicks, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "Gauge32", "iso", "MibIdentifier", "IpAddress", "Opaque", "NotificationType", "TimeTicks", "Counter32", "Unsigned32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysResetPm=slmSysResetPm, slmSyslogLevel=slmSyslogLevel, slmSysLocation=slmSysLocation, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthEntry=slmAuthEntry, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogName=slmTrapLogName, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapDestAddress=slmTrapDestAddress, slmEdfaNumber=slmEdfaNumber, slmAuthTable=slmAuthTable, slmSwRevTable=slmSwRevTable, slmAuthCommunity=slmAuthCommunity, slmSysActiveSwVersion=slmSysActiveSwVersion, slmNetworkMode=slmNetworkMode, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmSwRevName=slmSwRevName, slmLicenseExpiration=slmLicenseExpiration, slmSysTemperature=slmSysTemperature, slmLicense=slmLicense, slmSysSubnetMask=slmSysSubnetMask, slmVcatDelay=slmVcatDelay, slmTrapLogTable=slmTrapLogTable, slmAdmin=slmAdmin, slmSysLanIpAddr=slmSysLanIpAddr, slmSysMode=slmSysMode, PYSNMP_MODULE_ID=slMain, slmAdminEntry=slmAdminEntry, slmSys=slmSys, slmSnmpv3Password=slmSnmpv3Password, slmTopologyEnabled=slmTopologyEnabled, slmSysOperStatus=slmSysOperStatus, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmPsuNumber=slmPsuNumber, UserLogin=UserLogin, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam3=slmTrapLogParam3, slmSysAlmDeact=slmSysAlmDeact, slmChPassLogin=slmChPassLogin, slmSysCalendarTime=slmSysCalendarTime, slmSysUplinkRate=slmSysUplinkRate, slmTrapDestTable=slmTrapDestTable, slmAdminTable=slmAdminTable, slmTrapLogParam2=slmTrapLogParam2, slmBoxSize=slmBoxSize, slmSwRevEntry=slmSwRevEntry, slm40GConf=slm40GConf, SoftwareRevision=SoftwareRevision, slmAdminRowStatus=slmAdminRowStatus, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapPort=slmTrapPort, slmSwRevDate=slmSwRevDate, slmTrapLogId=slmTrapLogId, slmLogin=slmLogin, slmAuth=slmAuth, slmLogFile=slmLogFile, slmSysIpAddr=slmSysIpAddr, UserCommunity=UserCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysName=slmSysName, slmConfigSysSignalType=slmConfigSysSignalType, slmAuthLogin=slmAuthLogin, slmPortsNumber=slmPortsNumber, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogParam6=slmTrapLogParam6, slmAdminLogin=slmAdminLogin, slmLicenseEntry=slmLicenseEntry, slmLicenseId=slmLicenseId, slmSyslogDestTable=slmSyslogDestTable, slmSyslogDestAddress=slmSyslogDestAddress, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam1=slmTrapLogParam1, slmChPass=slmChPass, slMain=slMain, slmRebootDelay=slmRebootDelay, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmPmAvailable=slmPmAvailable, slmTrapLogEntry=slmTrapLogEntry, slmChPassNewPass=slmChPassNewPass, slmSysTrapFormat=slmSysTrapFormat, slmConfigFile=slmConfigFile, slmAdminAccess=slmAdminAccess, slmTrapCommunity=slmTrapCommunity, slmTrap=slmTrap, slmMuxNumber=slmMuxNumber, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLicenseIndex=slmLicenseIndex, slmOemType=slmOemType, slmSysAlmAct=slmSysAlmAct, slmWriteCommunity=slmWriteCommunity, slmSwRevStatus=slmSwRevStatus, slmTid=slmTid, slmAuthPassword=slmAuthPassword, slmTrapEnable=slmTrapEnable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysGatewayAddr=slmSysGatewayAddr, slmSyslogPort=slmSyslogPort, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPassOldPass=slmChPassOldPass, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestCommunity=slmTrapDestCommunity, slmChPassTable=slmChPassTable, slmLicenseTable=slmLicenseTable, slmConfigSysUptime=slmConfigSysUptime, slmSnmpv3Auth=slmSnmpv3Auth, UserPassword=UserPassword, slmSysChassisId=slmSysChassisId, slmReadCommunity=slmReadCommunity, slmTrapUserAccess=slmTrapUserAccess, slmRstpEnabled=slmRstpEnabled, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPassEntry=slmChPassEntry, slmSysAdminStatus=slmSysAdminStatus, slmAdminPassword=slmAdminPassword, AdminAccess=AdminAccess, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestEntry=slmTrapDestEntry)
