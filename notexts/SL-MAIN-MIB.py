...
Gauge32, Counter32, Opaque, Bits, TimeTicks, ModuleIdentity, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, Counter64, IpAddress, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "Opaque", "Bits", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "Counter64", "IpAddress", "Integer32", "iso")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysName=slmSysName, slmAdminEntry=slmAdminEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, AdminAccess=AdminAccess, slmNetworkMode=slmNetworkMode, slmSysAlmAct=slmSysAlmAct, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysMode=slmSysMode, slmRebootDelay=slmRebootDelay, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevName=slmSwRevName, slmAuth=slmAuth, slmMuxNumber=slmMuxNumber, slmAdminRowStatus=slmAdminRowStatus, slmTrapUserAccess=slmTrapUserAccess, slmAdmin=slmAdmin, slmOemType=slmOemType, slmTrapLogParam1=slmTrapLogParam1, slmConfigSysUptime=slmConfigSysUptime, slmSysResetPm=slmSysResetPm, slmLicenseTable=slmLicenseTable, PYSNMP_MODULE_ID=slMain, slmTrapDestAddress=slmTrapDestAddress, slmChPassEntry=slmChPassEntry, slMain=slMain, slmTrapLogParam5=slmTrapLogParam5, slmAdminLogin=slmAdminLogin, slmReadCommunity=slmReadCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysTemperature=slmSysTemperature, slmTrapLogParam6=slmTrapLogParam6, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogParam4=slmTrapLogParam4, slmSysOperStatus=slmSysOperStatus, slmTrap=slmTrap, slmSysUplinkRate=slmSysUplinkRate, slmTrapPort=slmTrapPort, slmSysSnmpVersion=slmSysSnmpVersion, slmAuthEntry=slmAuthEntry, slmLicense=slmLicense, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapEnable=slmTrapEnable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseIndex=slmLicenseIndex, slmSysLocation=slmSysLocation, UserPassword=UserPassword, slmTrapDestCommunity=slmTrapDestCommunity, slmPsuNumber=slmPsuNumber, UserLogin=UserLogin, slmLogFile=slmLogFile, slmLicenseEntry=slmLicenseEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogName=slmTrapLogName, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam2=slmTrapLogParam2, slmTrapUserLogin=slmTrapUserLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSwRevStatus=slmSwRevStatus, slmAuthLogin=slmAuthLogin, slmSnmpv3Auth=slmSnmpv3Auth, slmConfigFile=slmConfigFile, slmSysTrapFormat=slmSysTrapFormat, SoftwareRevision=SoftwareRevision, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevDate=slmSwRevDate, slmAuthTable=slmAuthTable, slmLogin=slmLogin, slmAdminAccess=slmAdminAccess, slmSysSubnetMask=slmSysSubnetMask, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmVcatDelay=slmVcatDelay, slmSysIpAddr=slmSysIpAddr, slmLicenseExpiration=slmLicenseExpiration, slmSysChassisId=slmSysChassisId, slmAdminPassword=slmAdminPassword, slmAuthPassword=slmAuthPassword, slmAdminCommunity=slmAdminCommunity, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestAddress=slmSyslogDestAddress, slmLicenseId=slmLicenseId, slmWriteCommunity=slmWriteCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevEntry=slmSwRevEntry, slmPmAvailable=slmPmAvailable, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestEntry=slmTrapDestEntry, slmSysAlmDeact=slmSysAlmDeact, slmChPassLogin=slmChPassLogin, slmSysAdminStatus=slmSysAdminStatus, slmPortsNumber=slmPortsNumber, slmTrapSysNameChange=slmTrapSysNameChange, slmChPassNewPass=slmChPassNewPass, slmChPass=slmChPass, slmSysGatewayAddr=slmSysGatewayAddr, slmBoxSize=slmBoxSize, slmSwRevTable=slmSwRevTable, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slm40GConf=slm40GConf, slmChPassTable=slmChPassTable, slmAuthCommunity=slmAuthCommunity, slmSyslogPort=slmSyslogPort, UserCommunity=UserCommunity, slmAdminTable=slmAdminTable, slmSysLanIpAddr=slmSysLanIpAddr, slmRstpEnabled=slmRstpEnabled, slmTrapLogTable=slmTrapLogTable, slmTrapCommunity=slmTrapCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogDestEntry=slmSyslogDestEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogId=slmTrapLogId, slmSyslogLevel=slmSyslogLevel, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestTable=slmTrapDestTable, slmSys=slmSys, slmSnmpv3Password=slmSnmpv3Password, slmTid=slmTid, slmChPassOldPass=slmChPassOldPass, slmEdfaNumber=slmEdfaNumber, slmTopologyEnabled=slmTopologyEnabled)
