...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, IpAddress, iso, Counter64, Unsigned32, ObjectIdentity, NotificationType, Integer32, Gauge32, Opaque, Counter32, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "IpAddress", "iso", "Counter64", "Unsigned32", "ObjectIdentity", "NotificationType", "Integer32", "Gauge32", "Opaque", "Counter32", "TimeTicks", "MibIdentifier")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmRstpEnabled=slmRstpEnabled, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam6=slmTrapLogParam6, slmSwRevDate=slmSwRevDate, slmChPassTable=slmChPassTable, slmLicenseIndex=slmLicenseIndex, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPassLogin=slmChPassLogin, slmLicenseExpiration=slmLicenseExpiration, slmTrapSysNameChange=slmTrapSysNameChange, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapUserAccess=slmTrapUserAccess, slmNetworkMode=slmNetworkMode, slmSysAdminStatus=slmSysAdminStatus, slmOemType=slmOemType, slmSyslogDestEntry=slmSyslogDestEntry, slmChPassEntry=slmChPassEntry, slmAdmin=slmAdmin, slmSnmpv3Password=slmSnmpv3Password, slmAuthEntry=slmAuthEntry, PYSNMP_MODULE_ID=slMain, slmTrapLogParam3=slmTrapLogParam3, slmTrapCommunity=slmTrapCommunity, slmSysUplinkRate=slmSysUplinkRate, slmSwRevStatus=slmSwRevStatus, slmSyslogDestAddress=slmSyslogDestAddress, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogDestTable=slmSyslogDestTable, slmSysAlmAct=slmSysAlmAct, slmConfigSysUptime=slmConfigSysUptime, slmSysResetPm=slmSysResetPm, slmTrapDestAddress=slmTrapDestAddress, UserPassword=UserPassword, slmLicense=slmLicense, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestCommunity=slmTrapDestCommunity, AdminAccess=AdminAccess, slmTid=slmTid, slm40GConf=slm40GConf, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevName=slmSwRevName, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysAlmDeact=slmSysAlmDeact, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapPort=slmTrapPort, slmSysIpAddr=slmSysIpAddr, slmSysTrapFormat=slmSysTrapFormat, slmPsuNumber=slmPsuNumber, slmTrap=slmTrap, slmSwRevEntry=slmSwRevEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmChPass=slmChPass, slmTrapDestTable=slmTrapDestTable, slmBoxSize=slmBoxSize, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysLocation=slmSysLocation, slmSysSnmpVersion=slmSysSnmpVersion, slmAuthLogin=slmAuthLogin, slmTrapLogParam2=slmTrapLogParam2, slmVcatDelay=slmVcatDelay, slmSysCalendarTime=slmSysCalendarTime, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLicenseId=slmLicenseId, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicenseTable=slmLicenseTable, UserCommunity=UserCommunity, UserLogin=UserLogin, slmChPassOldPass=slmChPassOldPass, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysName=slmSysName, slmAdminTable=slmAdminTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminAccess=slmAdminAccess, slmSyslogPort=slmSyslogPort, slmAdminEntry=slmAdminEntry, slmTrapLogParam4=slmTrapLogParam4, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam1=slmTrapLogParam1, slmAuthTable=slmAuthTable, slmAuthCommunity=slmAuthCommunity, slmSys=slmSys, slmConfigFile=slmConfigFile, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogName=slmTrapLogName, slmWriteCommunity=slmWriteCommunity, slmTopologyEnabled=slmTopologyEnabled, slmPmAvailable=slmPmAvailable, slmAdminPassword=slmAdminPassword, slmSwRevTable=slmSwRevTable, slmSysGatewayAddr=slmSysGatewayAddr, SoftwareRevision=SoftwareRevision, slmTrapLogParam5=slmTrapLogParam5, slmRebootDelay=slmRebootDelay, slmMuxNumber=slmMuxNumber, slmSysChassisId=slmSysChassisId, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLogFile=slmLogFile, slmSyslogLevel=slmSyslogLevel, slmReadCommunity=slmReadCommunity, slmChPassNewPass=slmChPassNewPass, slmSysTemperature=slmSysTemperature, slmLicenseEntry=slmLicenseEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapUserLogin=slmTrapUserLogin, slmSysOperStatus=slmSysOperStatus, slmLogin=slmLogin, slmTrapDestEntry=slmTrapDestEntry, slmAuth=slmAuth, slmSysMode=slmSysMode, slmAdminCommunity=slmAdminCommunity, slmTrapLogEntry=slmTrapLogEntry, slMain=slMain, slmTrapLogTable=slmTrapLogTable, slmTrapLogId=slmTrapLogId, slmEdfaNumber=slmEdfaNumber, slmSysSubnetMask=slmSysSubnetMask, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminLogin=slmAdminLogin, slmTrapEnable=slmTrapEnable, slmPortsNumber=slmPortsNumber, slmAuthPassword=slmAuthPassword, slmSwRevDirectory=slmSwRevDirectory)
