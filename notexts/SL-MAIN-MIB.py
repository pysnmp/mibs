...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicenseId=slmLicenseId, slmSysAdminStatus=slmSysAdminStatus, slmSyslogLevel=slmSyslogLevel, slmLicense=slmLicense, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogParam2=slmTrapLogParam2, slmPortsNumber=slmPortsNumber, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSnmpv3Password=slmSnmpv3Password, slmSysCalendarTime=slmSysCalendarTime, slmLicenseEntry=slmLicenseEntry, slmChPassEntry=slmChPassEntry, slmSysTemperature=slmSysTemperature, slmEdfaNumber=slmEdfaNumber, slmSysLanIpAddr=slmSysLanIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmReadCommunity=slmReadCommunity, slmTrapDestAddress=slmTrapDestAddress, slmNetworkMode=slmNetworkMode, slmBoxSize=slmBoxSize, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAuthLogin=slmAuthLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSyslogPort=slmSyslogPort, slmSysSubnetMask=slmSysSubnetMask, slmLogFile=slmLogFile, slmRstpEnabled=slmRstpEnabled, slmMuxNumber=slmMuxNumber, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapUserLogin=slmTrapUserLogin, slmSysUplinkRate=slmSysUplinkRate, slmTrapEnable=slmTrapEnable, slmSysMode=slmSysMode, slmSwRevName=slmSwRevName, PYSNMP_MODULE_ID=slMain, slmTrapCommunity=slmTrapCommunity, slmTrapDestCommunity=slmTrapDestCommunity, slmSys=slmSys, slmAdminAccess=slmAdminAccess, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slMain=slMain, slmSysAlmAct=slmSysAlmAct, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysOperStatus=slmSysOperStatus, slmOemType=slmOemType, slmTrapLogParam1=slmTrapLogParam1, slmAdmin=slmAdmin, slmChPass=slmChPass, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogParam3=slmTrapLogParam3, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam4=slmTrapLogParam4, slmTid=slmTid, slmAuthPassword=slmAuthPassword, slmTrap=slmTrap, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevTable=slmSwRevTable, slmSysChassisId=slmSysChassisId, slmAdminEntry=slmAdminEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLogin=slmLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysResetPm=slmSysResetPm, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPassLogin=slmChPassLogin, AdminAccess=AdminAccess, slmAuthEntry=slmAuthEntry, slmPmAvailable=slmPmAvailable, slmSyslogDestTable=slmSyslogDestTable, slmSysName=slmSysName, SoftwareRevision=SoftwareRevision, slmAdminPassword=slmAdminPassword, slmAuthTable=slmAuthTable, UserPassword=UserPassword, slmSysLocation=slmSysLocation, slmTrapSysNameChange=slmTrapSysNameChange, slmConfigSysUptime=slmConfigSysUptime, slmLicenseTable=slmLicenseTable, slmAdminRowStatus=slmAdminRowStatus, slmVcatDelay=slmVcatDelay, slmConfigFile=slmConfigFile, slm40GConf=slm40GConf, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevDirectory=slmSwRevDirectory, slmSysSnmpVersion=slmSysSnmpVersion, slmSwRevDate=slmSwRevDate, slmChPassTable=slmChPassTable, slmTrapDestEntry=slmTrapDestEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmAdminCommunity=slmAdminCommunity, slmSwRevStatus=slmSwRevStatus, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmWriteCommunity=slmWriteCommunity, slmAuthCommunity=slmAuthCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, UserLogin=UserLogin, UserCommunity=UserCommunity, slmTrapDestTable=slmTrapDestTable, slmLicenseIndex=slmLicenseIndex, slmTrapLogTable=slmTrapLogTable, slmSnmpv3Auth=slmSnmpv3Auth, slmChPassNewPass=slmChPassNewPass, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAdminLogin=slmAdminLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysIpAddr=slmSysIpAddr, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAuth=slmAuth, slmTrapLogId=slmTrapLogId, slmSwRevEntry=slmSwRevEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmPsuNumber=slmPsuNumber, slmConfigSysSignalType=slmConfigSysSignalType, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogName=slmTrapLogName, slmRebootDelay=slmRebootDelay, slmTrapPort=slmTrapPort, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminTable=slmAdminTable, slmTrapLogParam6=slmTrapLogParam6, slmLicenseExpiration=slmLicenseExpiration)
