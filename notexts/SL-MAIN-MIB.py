...
ObjectIdentity, Gauge32, NotificationType, Bits, TimeTicks, Counter64, iso, ModuleIdentity, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Opaque, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "NotificationType", "Bits", "TimeTicks", "Counter64", "iso", "ModuleIdentity", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Opaque", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmWriteCommunity=slmWriteCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminPassword=slmAdminPassword, slmLicenseIndex=slmLicenseIndex, slmBoxSize=slmBoxSize, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogId=slmTrapLogId, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestCommunity=slmTrapDestCommunity, slmSwRevEntry=slmSwRevEntry, slmLogFile=slmLogFile, slmTrapSysLocationChange=slmTrapSysLocationChange, slmPsuNumber=slmPsuNumber, slmLicenseEntry=slmLicenseEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmSnmpv3Priv=slmSnmpv3Priv, slmRstpEnabled=slmRstpEnabled, slmChPassEntry=slmChPassEntry, slmChPassTable=slmChPassTable, slmLicense=slmLicense, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdmin=slmAdmin, slmTopologyEnabled=slmTopologyEnabled, slmSysAlmDeact=slmSysAlmDeact, slmLicenseId=slmLicenseId, slmTid=slmTid, slmLicenseTable=slmLicenseTable, slmSyslogPort=slmSyslogPort, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPassLogin=slmChPassLogin, slmAdminEntry=slmAdminEntry, slmSysIpAddr=slmSysIpAddr, slm40GConf=slm40GConf, slmSysTemperature=slmSysTemperature, slmRebootDelay=slmRebootDelay, slmAuth=slmAuth, slmPmAvailable=slmPmAvailable, AdminAccess=AdminAccess, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAuthLogin=slmAuthLogin, slmEdfaNumber=slmEdfaNumber, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogParam4=slmTrapLogParam4, slmTrapUserAccess=slmTrapUserAccess, slmTrapEnable=slmTrapEnable, slmMuxNumber=slmMuxNumber, slmSysAdminStatus=slmSysAdminStatus, UserCommunity=UserCommunity, slmAuthCommunity=slmAuthCommunity, slmAdminTable=slmAdminTable, slmTrapLogParam1=slmTrapLogParam1, slmChPassOldPass=slmChPassOldPass, slMain=slMain, slmSysName=slmSysName, slmOemType=slmOemType, slmTrap=slmTrap, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminRowStatus=slmAdminRowStatus, slmSysMode=slmSysMode, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSys=slmSys, slmLicenseExpiration=slmLicenseExpiration, slmSysResetPm=slmSysResetPm, slmSysLocation=slmSysLocation, slmTrapLogTable=slmTrapLogTable, slmAdminAccess=slmAdminAccess, slmSwRevStatus=slmSwRevStatus, slmTrapPort=slmTrapPort, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogLevel=slmSyslogLevel, slmSysUplinkRate=slmSysUplinkRate, slmAuthTable=slmAuthTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapCommunity=slmTrapCommunity, slmAdminLogin=slmAdminLogin, slmConfigFile=slmConfigFile, slmTrapUserLogin=slmTrapUserLogin, slmSysCalendarTime=slmSysCalendarTime, slmAdminCommunity=slmAdminCommunity, slmSnmpv3Password=slmSnmpv3Password, slmVcatDelay=slmVcatDelay, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogParam5=slmTrapLogParam5, slmTrapDestTable=slmTrapDestTable, slmSwRevDirectory=slmSwRevDirectory, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestEntry=slmTrapDestEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysChassisId=slmSysChassisId, slmSyslogDestAddress=slmSyslogDestAddress, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysOperStatus=slmSysOperStatus, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam3=slmTrapLogParam3, UserPassword=UserPassword, slmSysAlmAct=slmSysAlmAct, slmChPassNewPass=slmChPassNewPass, slmNetworkMode=slmNetworkMode, slmSysTrapFormat=slmSysTrapFormat, slmSysEncryptionCapability=slmSysEncryptionCapability, SoftwareRevision=SoftwareRevision, slmTrapLogParam2=slmTrapLogParam2, slmSwRevName=slmSwRevName, PYSNMP_MODULE_ID=slMain, slmChPass=slmChPass, slmSwRevTable=slmSwRevTable, slmAuthEntry=slmAuthEntry, slmPortsNumber=slmPortsNumber, slmReadCommunity=slmReadCommunity, slmLogin=slmLogin, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysLanIpAddr=slmSysLanIpAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogName=slmTrapLogName, UserLogin=UserLogin, slmAuthPassword=slmAuthPassword, slmTrapLogEntry=slmTrapLogEntry, slmSwRevDate=slmSwRevDate)
