...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, Bits, ModuleIdentity, Integer32, IpAddress, Gauge32, MibIdentifier, TimeTicks, NotificationType, Counter64, Counter32, Opaque, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "Bits", "ModuleIdentity", "Integer32", "IpAddress", "Gauge32", "MibIdentifier", "TimeTicks", "NotificationType", "Counter64", "Counter32", "Opaque", "ObjectIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTopologyEnabled=slmTopologyEnabled, slmTrapLogParam6=slmTrapLogParam6, slmTrapSysLocationChange=slmTrapSysLocationChange, slmOemType=slmOemType, slmAuthTable=slmAuthTable, slmLicenseExpiration=slmLicenseExpiration, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysGatewayAddr=slmSysGatewayAddr, slmAuthCommunity=slmAuthCommunity, slmSys=slmSys, slmWriteCommunity=slmWriteCommunity, slmConfigFile=slmConfigFile, slmTrapDestRowStatus=slmTrapDestRowStatus, slmReadCommunity=slmReadCommunity, slmTrap=slmTrap, slmLicenseIndex=slmLicenseIndex, slmTrapLogParam3=slmTrapLogParam3, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmRebootDelay=slmRebootDelay, slmTrapCommunity=slmTrapCommunity, slmSysIpAddr=slmSysIpAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSwRevTable=slmSwRevTable, slmAdmin=slmAdmin, slmSwRevStatus=slmSwRevStatus, slmLicenseTable=slmLicenseTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevDirectory=slmSwRevDirectory, slmAuthPassword=slmAuthPassword, slmMuxNumber=slmMuxNumber, AdminAccess=AdminAccess, slmSysCalendarTime=slmSysCalendarTime, slmSysTrapFormat=slmSysTrapFormat, slmChPassNewPass=slmChPassNewPass, slmTrapDestEntry=slmTrapDestEntry, slmSysMode=slmSysMode, slmSyslogPort=slmSyslogPort, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminLogin=slmAdminLogin, slmSysChassisId=slmSysChassisId, slmAuthEntry=slmAuthEntry, slmSysUplinkRate=slmSysUplinkRate, slmTrapDestCommunity=slmTrapDestCommunity, UserLogin=UserLogin, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogTable=slmTrapLogTable, slmTrapSysNameChange=slmTrapSysNameChange, slmSysAdminStatus=slmSysAdminStatus, slmLicense=slmLicense, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, PYSNMP_MODULE_ID=slMain, slmSysResetPm=slmSysResetPm, slmSnmpv3Password=slmSnmpv3Password, slmRstpEnabled=slmRstpEnabled, slmTrapEnable=slmTrapEnable, slmTrapLogParam1=slmTrapLogParam1, slmAdminRowStatus=slmAdminRowStatus, slmAuthLogin=slmAuthLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmNetworkMode=slmNetworkMode, slMain=slMain, slmAdminAccess=slmAdminAccess, slmSnmpv3Priv=slmSnmpv3Priv, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevName=slmSwRevName, slmTrapLogParam2=slmTrapLogParam2, slmVcatDelay=slmVcatDelay, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLocation=slmSysLocation, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdminCommunity=slmAdminCommunity, slmAdminEntry=slmAdminEntry, slmChPassEntry=slmChPassEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysAlmDeact=slmSysAlmDeact, slmPmAvailable=slmPmAvailable, slmSysAlmAct=slmSysAlmAct, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminPassword=slmAdminPassword, slmChPassLogin=slmChPassLogin, slmTrapLogId=slmTrapLogId, slmChPassTable=slmChPassTable, slmSwRevDate=slmSwRevDate, slmLicenseId=slmLicenseId, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogParam4=slmTrapLogParam4, slmAdminTable=slmAdminTable, slmSysOperStatus=slmSysOperStatus, UserCommunity=UserCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogDestTable=slmSyslogDestTable, slmEdfaNumber=slmEdfaNumber, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogLevel=slmSyslogLevel, slmPsuNumber=slmPsuNumber, slmPortsNumber=slmPortsNumber, slmBoxSize=slmBoxSize, slmSwRevEntry=slmSwRevEntry, slmTrapLogEntry=slmTrapLogEntry, slmConfigSysUptime=slmConfigSysUptime, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapUserAccess=slmTrapUserAccess, slmTrapPort=slmTrapPort, slmChPassOldPass=slmChPassOldPass, SoftwareRevision=SoftwareRevision, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestAddress=slmTrapDestAddress, slmSysTemperature=slmSysTemperature, slmLogFile=slmLogFile, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestEntry=slmSyslogDestEntry, slm40GConf=slm40GConf, slmSnmpv3Auth=slmSnmpv3Auth, slmAuth=slmAuth, slmChPass=slmChPass, slmSysName=slmSysName, slmLicenseEntry=slmLicenseEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, UserPassword=UserPassword, slmSysSubnetMask=slmSysSubnetMask, slmTid=slmTid, slmTrapDestTable=slmTrapDestTable, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogName=slmTrapLogName, slmLogin=slmLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr)
