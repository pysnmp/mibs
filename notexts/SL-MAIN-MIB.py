...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, ModuleIdentity, iso, Unsigned32, Gauge32, MibIdentifier, Counter64, Counter32, NotificationType, Opaque, TimeTicks, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "ModuleIdentity", "iso", "Unsigned32", "Gauge32", "MibIdentifier", "Counter64", "Counter32", "NotificationType", "Opaque", "TimeTicks", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysTrapFormat=slmSysTrapFormat, slmSyslogDestAddress=slmSyslogDestAddress, slmTopologyEnabled=slmTopologyEnabled, slmAdminAccess=slmAdminAccess, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPassOldPass=slmChPassOldPass, slmOpticalSwitchExist=slmOpticalSwitchExist, slmVcatDelay=slmVcatDelay, slmTrapUserAccess=slmTrapUserAccess, slmChPass=slmChPass, slmSwRevName=slmSwRevName, slmTrapLogParam5=slmTrapLogParam5, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminPassword=slmAdminPassword, slmLicenseExpiration=slmLicenseExpiration, slmTrapPort=slmTrapPort, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogTable=slmTrapLogTable, slmAuthPassword=slmAuthPassword, slmLicense=slmLicense, slmAuthCommunity=slmAuthCommunity, slmSyslogLevel=slmSyslogLevel, slmTrapLogParam2=slmTrapLogParam2, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapDestTable=slmTrapDestTable, slmTrapDestCommunity=slmTrapDestCommunity, slmTrap=slmTrap, slmPmAvailable=slmPmAvailable, slmAdmin=slmAdmin, UserPassword=UserPassword, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmConfigSysUptime=slmConfigSysUptime, slmReadCommunity=slmReadCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestAddress=slmTrapDestAddress, slmSysSnmpVersion=slmSysSnmpVersion, slmSnmpv3Password=slmSnmpv3Password, slmAuthLogin=slmAuthLogin, SoftwareRevision=SoftwareRevision, slmLogin=slmLogin, UserCommunity=UserCommunity, slmSysUplinkRate=slmSysUplinkRate, slmRstpEnabled=slmRstpEnabled, slmWriteCommunity=slmWriteCommunity, slmSysAdminStatus=slmSysAdminStatus, slmNetworkMode=slmNetworkMode, slmTrapLogEntry=slmTrapLogEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuthEntry=slmAuthEntry, slmSwRevEntry=slmSwRevEntry, slmSysSubnetMask=slmSysSubnetMask, slmSnmpv3Auth=slmSnmpv3Auth, slmSysCalendarTime=slmSysCalendarTime, slmPsuNumber=slmPsuNumber, slmTid=slmTid, slmAuthTable=slmAuthTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysChassisId=slmSysChassisId, slmTrapSysNameChange=slmTrapSysNameChange, slmSysIpAddr=slmSysIpAddr, slmSwRevDate=slmSwRevDate, slmSysAlmDeact=slmSysAlmDeact, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapEnable=slmTrapEnable, slmLogFile=slmLogFile, slmTrapLogParam1=slmTrapLogParam1, slmLicenseId=slmLicenseId, slmAuth=slmAuth, slmSysGatewayAddr=slmSysGatewayAddr, slmRebootDelay=slmRebootDelay, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam4=slmTrapLogParam4, slm40GConf=slm40GConf, slmAdminEntry=slmAdminEntry, slmTrapLogName=slmTrapLogName, slmAdminTable=slmAdminTable, slmSysLocation=slmSysLocation, slmConfigFile=slmConfigFile, slmSysTemperature=slmSysTemperature, slmAdminCommunity=slmAdminCommunity, slmLicenseIndex=slmLicenseIndex, slmEdfaNumber=slmEdfaNumber, slmChPassEntry=slmChPassEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestEntry=slmTrapDestEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapSysLocationChange=slmTrapSysLocationChange, slmChPassNewPass=slmChPassNewPass, slmPortsNumber=slmPortsNumber, slmSysLanIpAddr=slmSysLanIpAddr, slmBoxSize=slmBoxSize, slmAdminLogin=slmAdminLogin, slmSysAlmAct=slmSysAlmAct, UserLogin=UserLogin, slmTrapLogId=slmTrapLogId, PYSNMP_MODULE_ID=slMain, AdminAccess=AdminAccess, slmMuxNumber=slmMuxNumber, slmTrapUserLogin=slmTrapUserLogin, slmTrapCommunity=slmTrapCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysName=slmSysName, slmSyslogDestTable=slmSyslogDestTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevTable=slmSwRevTable, slmSys=slmSys, slmLicenseTable=slmLicenseTable, slmChPassTable=slmChPassTable, slmChPassLogin=slmChPassLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slMain=slMain, slmSysMode=slmSysMode, slmSwRevStatus=slmSwRevStatus, slmLicenseEntry=slmLicenseEntry, slmOemType=slmOemType, slmSyslogPort=slmSyslogPort, slmSysResetPm=slmSysResetPm)
