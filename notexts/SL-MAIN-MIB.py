...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmWriteCommunity=slmWriteCommunity, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, SoftwareRevision=SoftwareRevision, slmSysSubnetMask=slmSysSubnetMask, slmConfigSysUptime=slmConfigSysUptime, slmPmAvailable=slmPmAvailable, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminTable=slmAdminTable, slmChPassTable=slmChPassTable, slmChPassLogin=slmChPassLogin, slmTrapDestEntry=slmTrapDestEntry, UserPassword=UserPassword, slmSysTrapFormat=slmSysTrapFormat, slmAdmin=slmAdmin, slmAdminLogin=slmAdminLogin, slmTrapLogEntry=slmTrapLogEntry, slmNetworkMode=slmNetworkMode, slm40GConf=slm40GConf, slmTrapLogParam4=slmTrapLogParam4, slMain=slMain, slmRebootDelay=slmRebootDelay, slmSyslogDestIpAddress=slmSyslogDestIpAddress, UserLogin=UserLogin, slmAuthTable=slmAuthTable, AdminAccess=AdminAccess, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmAdminEntry=slmAdminEntry, slmSysLocation=slmSysLocation, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicenseIndex=slmLicenseIndex, slmSysMode=slmSysMode, slmSysPmStartOfDay=slmSysPmStartOfDay, PYSNMP_MODULE_ID=slMain, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogParam5=slmTrapLogParam5, slmLicense=slmLicense, slmTopologyEnabled=slmTopologyEnabled, slmSysSnmpVersion=slmSysSnmpVersion, slmSwRevDate=slmSwRevDate, slmTrapEnable=slmTrapEnable, slmAdminCommunity=slmAdminCommunity, slmPortsNumber=slmPortsNumber, slmVcatDelay=slmVcatDelay, slmConfigFile=slmConfigFile, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminAccess=slmAdminAccess, slmTrapLogParam6=slmTrapLogParam6, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam3=slmTrapLogParam3, slmSyslogLevel=slmSyslogLevel, slmTrapDestCommunity=slmTrapDestCommunity, slmSysUplinkRate=slmSysUplinkRate, slmSwRevName=slmSwRevName, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysTemperature=slmSysTemperature, slmSwRevDirectory=slmSwRevDirectory, slmRstpEnabled=slmRstpEnabled, slmSwRevEntry=slmSwRevEntry, slmSysName=slmSysName, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysAlmAct=slmSysAlmAct, slmAuthPassword=slmAuthPassword, slmChPass=slmChPass, slmTrapLogId=slmTrapLogId, slmTid=slmTid, slmLicenseExpiration=slmLicenseExpiration, slmSysChassisId=slmSysChassisId, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmAuthCommunity=slmAuthCommunity, slmLicenseEntry=slmLicenseEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmSyslogDestEntry=slmSyslogDestEntry, slmSys=slmSys, slmTrapLogName=slmTrapLogName, slmBoxSize=slmBoxSize, slmTrapPort=slmTrapPort, slmAdminPassword=slmAdminPassword, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestTable=slmTrapDestTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminRowStatus=slmAdminRowStatus, UserCommunity=UserCommunity, slmConfigSysSignalType=slmConfigSysSignalType, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapCommunity=slmTrapCommunity, slmOemType=slmOemType, slmTrapLogParam1=slmTrapLogParam1, slmSnmpv3Password=slmSnmpv3Password, slmSysAlmDeact=slmSysAlmDeact, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLicenseTable=slmLicenseTable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPassOldPass=slmChPassOldPass, slmReadCommunity=slmReadCommunity, slmSysOperStatus=slmSysOperStatus, slmTrapUserAccess=slmTrapUserAccess, slmSysAdminStatus=slmSysAdminStatus, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSwRevTable=slmSwRevTable, slmMuxNumber=slmMuxNumber, slmAuthLogin=slmAuthLogin, slmAuth=slmAuth, slmLogFile=slmLogFile, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPassEntry=slmChPassEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAuthEntry=slmAuthEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestTable=slmSyslogDestTable, slmLicenseId=slmLicenseId, slmTrapLogTable=slmTrapLogTable, slmPsuNumber=slmPsuNumber, slmEdfaNumber=slmEdfaNumber, slmChPassNewPass=slmChPassNewPass, slmSyslogPort=slmSyslogPort, slmSysResetPm=slmSysResetPm, slmTrap=slmTrap, slmTrapDestAddress=slmTrapDestAddress, slmLogin=slmLogin, slmTrapLogParam2=slmTrapLogParam2, slmSwRevStatus=slmSwRevStatus)
