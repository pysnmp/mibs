...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminPassword=slmAdminPassword, slmTrapLogParam5=slmTrapLogParam5, slmMuxNumber=slmMuxNumber, slmAuthEntry=slmAuthEntry, slmPortsNumber=slmPortsNumber, slmAuthLogin=slmAuthLogin, slmTrap=slmTrap, slmAuthCommunity=slmAuthCommunity, slmAdminTable=slmAdminTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam1=slmTrapLogParam1, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam2=slmTrapLogParam2, UserLogin=UserLogin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmEdfaNumber=slmEdfaNumber, slmAuthTable=slmAuthTable, slmSysName=slmSysName, slmTrapLogParam4=slmTrapLogParam4, slmChPassOldPass=slmChPassOldPass, slmTrapLogEntry=slmTrapLogEntry, slmLicense=slmLicense, slmTrapEnable=slmTrapEnable, slmAdminLogin=slmAdminLogin, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevDirectory=slmSwRevDirectory, slmPmAvailable=slmPmAvailable, slmTrapSysNameChange=slmTrapSysNameChange, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSnmpv3Password=slmSnmpv3Password, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSys=slmSys, slmChPassEntry=slmChPassEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmLicenseExpiration=slmLicenseExpiration, slmSwRevStatus=slmSwRevStatus, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogId=slmTrapLogId, PYSNMP_MODULE_ID=slMain, slmTrapPort=slmTrapPort, slmTrapUserLogin=slmTrapUserLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevDate=slmSwRevDate, slmPsuNumber=slmPsuNumber, slmSysResetPm=slmSysResetPm, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLogFile=slmLogFile, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogTable=slmTrapLogTable, slmTrapDestAddress=slmTrapDestAddress, AdminAccess=AdminAccess, slmLicenseTable=slmLicenseTable, slmSysIpAddr=slmSysIpAddr, slmSysAdminStatus=slmSysAdminStatus, slmReadCommunity=slmReadCommunity, slmSwRevEntry=slmSwRevEntry, slmSyslogLevel=slmSyslogLevel, slmSyslogPort=slmSyslogPort, slmLogin=slmLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, SoftwareRevision=SoftwareRevision, slmSysLanIpAddr=slmSysLanIpAddr, slmSysSubnetMask=slmSysSubnetMask, slmConfigSysUptime=slmConfigSysUptime, slmNetworkMode=slmNetworkMode, slmAdminCommunity=slmAdminCommunity, slmWriteCommunity=slmWriteCommunity, slmVcatDelay=slmVcatDelay, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogParam6=slmTrapLogParam6, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicenseEntry=slmLicenseEntry, slMain=slMain, slmOemType=slmOemType, slmAdminAccess=slmAdminAccess, slmAuthPassword=slmAuthPassword, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysMode=slmSysMode, slmTrapLogParam3=slmTrapLogParam3, slmAdminEntry=slmAdminEntry, slmConfigFile=slmConfigFile, slmSwRevTable=slmSwRevTable, slmChPassLogin=slmChPassLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevName=slmSwRevName, slmBoxSize=slmBoxSize, slmSysChassisId=slmSysChassisId, UserPassword=UserPassword, slm40GConf=slm40GConf, slmSysAlmAct=slmSysAlmAct, slmTrapLogName=slmTrapLogName, slmAdminRowStatus=slmAdminRowStatus, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdmin=slmAdmin, slmSyslogDestAddress=slmSyslogDestAddress, slmAuth=slmAuth, slmSysCalendarTime=slmSysCalendarTime, slmChPassNewPass=slmChPassNewPass, slmChPassTable=slmChPassTable, slmSysTrapFormat=slmSysTrapFormat, slmSysAlmDeact=slmSysAlmDeact, slmChPass=slmChPass, slmTrapDestEntry=slmTrapDestEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapCommunity=slmTrapCommunity, UserCommunity=UserCommunity, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysTemperature=slmSysTemperature, slmLicenseIndex=slmLicenseIndex, slmSysOperStatus=slmSysOperStatus, slmRebootDelay=slmRebootDelay, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysLocation=slmSysLocation, slmRstpEnabled=slmRstpEnabled, slmSnmpv3Priv=slmSnmpv3Priv, slmTid=slmTid, slmTrapUserAccess=slmTrapUserAccess, slmSyslogDestTable=slmSyslogDestTable, slmLicenseId=slmLicenseId, slmSysEncryptionCapability=slmSysEncryptionCapability)
