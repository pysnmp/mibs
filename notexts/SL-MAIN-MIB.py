...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysLanIpAddr=slmSysLanIpAddr, slmSysUplinkRate=slmSysUplinkRate, slmAdminPassword=slmAdminPassword, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysAlmAct=slmSysAlmAct, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAuthTable=slmAuthTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapPort=slmTrapPort, slmPsuNumber=slmPsuNumber, slmChPassOldPass=slmChPassOldPass, slmTrapDestAddress=slmTrapDestAddress, slmChPassEntry=slmChPassEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmRebootDelay=slmRebootDelay, slmEdfaNumber=slmEdfaNumber, slmLicenseTable=slmLicenseTable, slmSyslogPort=slmSyslogPort, slmSwRevDirectory=slmSwRevDirectory, slmAdmin=slmAdmin, slmSyslogDestAddress=slmSyslogDestAddress, slmSysLocation=slmSysLocation, slmSysAlmDeact=slmSysAlmDeact, slmChPassNewPass=slmChPassNewPass, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam1=slmTrapLogParam1, slmSwRevEntry=slmSwRevEntry, slmTrapCommunity=slmTrapCommunity, AdminAccess=AdminAccess, slmLicenseExpiration=slmLicenseExpiration, UserLogin=UserLogin, slmSnmpv3Auth=slmSnmpv3Auth, slmSysEncryptionCapability=slmSysEncryptionCapability, PYSNMP_MODULE_ID=slMain, slmChPass=slmChPass, slmSysSubnetMask=slmSysSubnetMask, slmAdminCommunity=slmAdminCommunity, slmTrapLogName=slmTrapLogName, slm40GConf=slm40GConf, slmSysMode=slmSysMode, slmAdminTable=slmAdminTable, slmAuthCommunity=slmAuthCommunity, slmLogin=slmLogin, slmTrapLogParam2=slmTrapLogParam2, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicense=slmLicense, slmSwRevDate=slmSwRevDate, slmConfigSysSignalType=slmConfigSysSignalType, slmSys=slmSys, slmTrapEnable=slmTrapEnable, slmTrapDestCommunity=slmTrapDestCommunity, slmTid=slmTid, slmTrapDestTable=slmTrapDestTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAuth=slmAuth, slmChPassLogin=slmChPassLogin, slmTrapLogId=slmTrapLogId, slmTrapLogParam4=slmTrapLogParam4, slmAuthLogin=slmAuthLogin, slmChPassTable=slmChPassTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrap=slmTrap, slmLicenseId=slmLicenseId, slmSysTrapFormat=slmSysTrapFormat, slmSyslogDestTable=slmSyslogDestTable, slmConfigFile=slmConfigFile, slmWriteCommunity=slmWriteCommunity, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysTemperature=slmSysTemperature, UserCommunity=UserCommunity, slmBoxSize=slmBoxSize, slmSysResetPm=slmSysResetPm, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTopologyEnabled=slmTopologyEnabled, slmAuthEntry=slmAuthEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminRowStatus=slmAdminRowStatus, slmSwRevName=slmSwRevName, slmSysName=slmSysName, slmMuxNumber=slmMuxNumber, slmReadCommunity=slmReadCommunity, slMain=slMain, slmSysChassisId=slmSysChassisId, slmSysAdminStatus=slmSysAdminStatus, slmTrapDestEntry=slmTrapDestEntry, slmTrapUserLogin=slmTrapUserLogin, slmVcatDelay=slmVcatDelay, slmOemType=slmOemType, slmSysSnmpVersion=slmSysSnmpVersion, slmSnmpv3Priv=slmSnmpv3Priv, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogParam3=slmTrapLogParam3, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSwRevStatus=slmSwRevStatus, slmNetworkMode=slmNetworkMode, slmTrapUserAccess=slmTrapUserAccess, slmConfigSysUptime=slmConfigSysUptime, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysCalendarTime=slmSysCalendarTime, slmRstpEnabled=slmRstpEnabled, slmLicenseEntry=slmLicenseEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogTable=slmTrapLogTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthPassword=slmAuthPassword, slmAdminLogin=slmAdminLogin, slmTrapLogParam5=slmTrapLogParam5, slmAdminEntry=slmAdminEntry, slmLicenseIndex=slmLicenseIndex, SoftwareRevision=SoftwareRevision, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminAccess=slmAdminAccess, slmLogFile=slmLogFile, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogLevel=slmSyslogLevel, slmPortsNumber=slmPortsNumber, slmTrapLogParam6=slmTrapLogParam6, slmSnmpv3Password=slmSnmpv3Password, slmSwRevTable=slmSwRevTable, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmPmAvailable=slmPmAvailable, UserPassword=UserPassword, slmSysIpAddr=slmSysIpAddr)
