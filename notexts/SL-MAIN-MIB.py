...
iso, ModuleIdentity, Counter32, Counter64, IpAddress, MibIdentifier, NotificationType, TimeTicks, Bits, Unsigned32, ObjectIdentity, Integer32, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "Counter32", "Counter64", "IpAddress", "MibIdentifier", "NotificationType", "TimeTicks", "Bits", "Unsigned32", "ObjectIdentity", "Integer32", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapSysLocationChange=slmTrapSysLocationChange, UserLogin=UserLogin, slmChPass=slmChPass, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTid=slmTid, slmChPassTable=slmChPassTable, slmSyslogPort=slmSyslogPort, PYSNMP_MODULE_ID=slMain, slmSysOperStatus=slmSysOperStatus, slmSysAdminStatus=slmSysAdminStatus, slmSysChassisId=slmSysChassisId, slmSyslogLevel=slmSyslogLevel, slmTrapLogParam6=slmTrapLogParam6, slmAdminPassword=slmAdminPassword, slmWriteCommunity=slmWriteCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapUserLogin=slmTrapUserLogin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestTable=slmTrapDestTable, slmConfigFile=slmConfigFile, SoftwareRevision=SoftwareRevision, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysName=slmSysName, slmTrapLogParam3=slmTrapLogParam3, slmSwRevStatus=slmSwRevStatus, slmChPassEntry=slmChPassEntry, slmTrap=slmTrap, AdminAccess=AdminAccess, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogTable=slmTrapLogTable, slmOemType=slmOemType, slmLicenseId=slmLicenseId, slmSysIpAddr=slmSysIpAddr, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmMuxNumber=slmMuxNumber, slmSyslogDestTable=slmSyslogDestTable, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysTrapFormat=slmSysTrapFormat, slmChPassNewPass=slmChPassNewPass, slmNetworkMode=slmNetworkMode, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSwRevDate=slmSwRevDate, slmEdfaNumber=slmEdfaNumber, slmAdminRowStatus=slmAdminRowStatus, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassOldPass=slmChPassOldPass, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogName=slmTrapLogName, slmLicense=slmLicense, slmPmAvailable=slmPmAvailable, slmSysLocation=slmSysLocation, slmSysAlmDeact=slmSysAlmDeact, slmSnmpv3Priv=slmSnmpv3Priv, slmTopologyEnabled=slmTopologyEnabled, slmSwRevName=slmSwRevName, slmRebootDelay=slmRebootDelay, slmTrapUserAccess=slmTrapUserAccess, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogParam2=slmTrapLogParam2, slmAuthEntry=slmAuthEntry, slmSys=slmSys, slmVcatDelay=slmVcatDelay, slmPsuNumber=slmPsuNumber, slmAdminTable=slmAdminTable, slmPortsNumber=slmPortsNumber, slmTrapPort=slmTrapPort, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapEnable=slmTrapEnable, slmReadCommunity=slmReadCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLogin=slmLogin, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slMain=slMain, slmTrapLogParam4=slmTrapLogParam4, slmSysAlmAct=slmSysAlmAct, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPassLogin=slmChPassLogin, slmTrapLogParam1=slmTrapLogParam1, slmRstpEnabled=slmRstpEnabled, slmAuth=slmAuth, slmAdminCommunity=slmAdminCommunity, slmConfigSysUptime=slmConfigSysUptime, UserCommunity=UserCommunity, slmAuthLogin=slmAuthLogin, slmTrapDestCommunity=slmTrapDestCommunity, slmSysMode=slmSysMode, slmAuthTable=slmAuthTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminEntry=slmAdminEntry, slmLicenseIndex=slmLicenseIndex, slmSwRevEntry=slmSwRevEntry, slmSwRevDirectory=slmSwRevDirectory, slmLicenseExpiration=slmLicenseExpiration, slmLogFile=slmLogFile, slmAuthCommunity=slmAuthCommunity, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestAddress=slmTrapDestAddress, slmTrapCommunity=slmTrapCommunity, slmTrapLogId=slmTrapLogId, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminLogin=slmAdminLogin, slmTrapLogParam5=slmTrapLogParam5, slmSwRevTable=slmSwRevTable, slmLicenseTable=slmLicenseTable, slmLicenseEntry=slmLicenseEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmSysTemperature=slmSysTemperature, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestEntry=slmTrapDestEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuthPassword=slmAuthPassword, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSyslogDestAddress=slmSyslogDestAddress, slm40GConf=slm40GConf, slmBoxSize=slmBoxSize, slmAdminAccess=slmAdminAccess, UserPassword=UserPassword, slmSysUplinkRate=slmSysUplinkRate, slmAdmin=slmAdmin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysResetPm=slmSysResetPm)
