...
TimeTicks, ObjectIdentity, Bits, Unsigned32, IpAddress, NotificationType, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, iso, Counter64, Opaque, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "Bits", "Unsigned32", "IpAddress", "NotificationType", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "iso", "Counter64", "Opaque", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapUserAccess=slmTrapUserAccess, slmAdmin=slmAdmin, slmChPass=slmChPass, slmTrapLogParam4=slmTrapLogParam4, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminPassword=slmAdminPassword, slmTrapUserLogin=slmTrapUserLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmSysOperStatus=slmSysOperStatus, slmAuthEntry=slmAuthEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysAlmAct=slmSysAlmAct, slmSysLanIpAddr=slmSysLanIpAddr, slmLogFile=slmLogFile, slmSysMode=slmSysMode, slmSwRevDirectory=slmSwRevDirectory, slmSysAlmDeact=slmSysAlmDeact, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPassLogin=slmChPassLogin, UserCommunity=UserCommunity, slmNetworkMode=slmNetworkMode, slmReadCommunity=slmReadCommunity, slmRstpEnabled=slmRstpEnabled, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSys=slmSys, slmLogin=slmLogin, slmTrapLogId=slmTrapLogId, slmLicenseExpiration=slmLicenseExpiration, slmSwRevEntry=slmSwRevEntry, slmTrap=slmTrap, slmLicense=slmLicense, slmSyslogDestEntry=slmSyslogDestEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmEdfaNumber=slmEdfaNumber, slmWriteCommunity=slmWriteCommunity, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam3=slmTrapLogParam3, slmBoxSize=slmBoxSize, slmSysResetPm=slmSysResetPm, slmRebootDelay=slmRebootDelay, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogPort=slmSyslogPort, slmTrapLogName=slmTrapLogName, slMain=slMain, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestIpAddress=slmTrapDestIpAddress, slmPortsNumber=slmPortsNumber, slmChPassNewPass=slmChPassNewPass, slmSysUplinkRate=slmSysUplinkRate, slmTid=slmTid, slmTrapDestCommunity=slmTrapDestCommunity, slmChPassTable=slmChPassTable, slmSysSnmpVersion=slmSysSnmpVersion, slmPsuNumber=slmPsuNumber, slmSysName=slmSysName, slmSysAdminStatus=slmSysAdminStatus, slmAuthTable=slmAuthTable, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestEntry=slmTrapDestEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmVcatDelay=slmVcatDelay, slmSwRevDate=slmSwRevDate, PYSNMP_MODULE_ID=slMain, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapDestAddress=slmTrapDestAddress, AdminAccess=AdminAccess, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogParam6=slmTrapLogParam6, slmLicenseEntry=slmLicenseEntry, UserPassword=UserPassword, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogEntry=slmTrapLogEntry, slmSysCalendarTime=slmSysCalendarTime, SoftwareRevision=SoftwareRevision, slmMuxNumber=slmMuxNumber, slmAuthLogin=slmAuthLogin, slmAdminEntry=slmAdminEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogDestTable=slmSyslogDestTable, slm40GConf=slm40GConf, slmTrapLogTable=slmTrapLogTable, slmAuthPassword=slmAuthPassword, slmSwRevTable=slmSwRevTable, slmAdminTable=slmAdminTable, slmTopologyEnabled=slmTopologyEnabled, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysTrapFormat=slmSysTrapFormat, slmSysTemperature=slmSysTemperature, slmSwRevName=slmSwRevName, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapPort=slmTrapPort, slmSnmpv3Password=slmSnmpv3Password, slmSyslogLevel=slmSyslogLevel, slmSysLocation=slmSysLocation, slmTrapLogParam1=slmTrapLogParam1, slmLicenseId=slmLicenseId, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAuthCommunity=slmAuthCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmChPassEntry=slmChPassEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogParam5=slmTrapLogParam5, slmConfigFile=slmConfigFile, slmAdminLogin=slmAdminLogin, slmChPassOldPass=slmChPassOldPass, slmAdminAccess=slmAdminAccess, UserLogin=UserLogin, slmTrapEnable=slmTrapEnable, slmAdminCommunity=slmAdminCommunity, slmLicenseIndex=slmLicenseIndex, slmPmAvailable=slmPmAvailable, slmOemType=slmOemType, slmSysChassisId=slmSysChassisId, slmLicenseTable=slmLicenseTable, slmConfigSysUptime=slmConfigSysUptime, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSwRevStatus=slmSwRevStatus, slmSysSubnetMask=slmSysSubnetMask, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapCommunity=slmTrapCommunity, slmTrapDestTable=slmTrapDestTable, slmSyslogDestAddress=slmSyslogDestAddress, slmAuth=slmAuth)
