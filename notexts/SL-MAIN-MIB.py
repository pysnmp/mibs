...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestRowStatus=slmTrapDestRowStatus, slm40GConf=slm40GConf, slmSysSubnetMask=slmSysSubnetMask, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicenseExpiration=slmLicenseExpiration, slmSnmpv3Auth=slmSnmpv3Auth, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAuthLogin=slmAuthLogin, slmSwRevTable=slmSwRevTable, slmChPassOldPass=slmChPassOldPass, slmSysSnmpVersion=slmSysSnmpVersion, slmSysLanIpAddr=slmSysLanIpAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTid=slmTid, slmTrapDestEntry=slmTrapDestEntry, slmConfigFile=slmConfigFile, slmConfigSysUptime=slmConfigSysUptime, slmTrapPort=slmTrapPort, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseId=slmLicenseId, slmSysResetPm=slmSysResetPm, slmPsuNumber=slmPsuNumber, slmSyslogDestTable=slmSyslogDestTable, slmSyslogLevel=slmSyslogLevel, slmChPassNewPass=slmChPassNewPass, slmAdminLogin=slmAdminLogin, slmSnmpv3Password=slmSnmpv3Password, slmChPass=slmChPass, UserCommunity=UserCommunity, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseIndex=slmLicenseIndex, UserLogin=UserLogin, slmAuth=slmAuth, slmLogFile=slmLogFile, slmSysAlmDeact=slmSysAlmDeact, slmPmAvailable=slmPmAvailable, slmTrapDestAddress=slmTrapDestAddress, slmEdfaNumber=slmEdfaNumber, slmSysAdminStatus=slmSysAdminStatus, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogName=slmTrapLogName, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrap=slmTrap, slmAdminAccess=slmAdminAccess, slmSwRevName=slmSwRevName, AdminAccess=AdminAccess, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLicenseTable=slmLicenseTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestProtVersion=slmTrapDestProtVersion, slmReadCommunity=slmReadCommunity, slmSwRevDate=slmSwRevDate, slmAdmin=slmAdmin, slmAuthCommunity=slmAuthCommunity, slmAuthEntry=slmAuthEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysMode=slmSysMode, slmRebootDelay=slmRebootDelay, slmSysChassisId=slmSysChassisId, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, SoftwareRevision=SoftwareRevision, slmPortsNumber=slmPortsNumber, slmTrapLogParam1=slmTrapLogParam1, slmRstpEnabled=slmRstpEnabled, slmSyslogPort=slmSyslogPort, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmVcatDelay=slmVcatDelay, slmSysTrapFormat=slmSysTrapFormat, slmTrapCommunity=slmTrapCommunity, slmTrapUserLogin=slmTrapUserLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogDestAddress=slmSyslogDestAddress, UserPassword=UserPassword, slmTopologyEnabled=slmTopologyEnabled, slmBoxSize=slmBoxSize, slmLogin=slmLogin, slmLicense=slmLicense, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapDestTable=slmTrapDestTable, slmTrapLogTable=slmTrapLogTable, slmMuxNumber=slmMuxNumber, slmSwRevEntry=slmSwRevEntry, slmSys=slmSys, slmSysLocation=slmSysLocation, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPassEntry=slmChPassEntry, slmAdminCommunity=slmAdminCommunity, slmSysAlmAct=slmSysAlmAct, slMain=slMain, slmSysUplinkRate=slmSysUplinkRate, slmOemType=slmOemType, slmSysName=slmSysName, slmChPassTable=slmChPassTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogId=slmTrapLogId, slmTrapLogEntry=slmTrapLogEntry, slmTrapUserAccess=slmTrapUserAccess, slmAdminTable=slmAdminTable, slmSysTemperature=slmSysTemperature, slmSwRevDirectory=slmSwRevDirectory, slmAdminEntry=slmAdminEntry, slmAdminPassword=slmAdminPassword, slmTrapLogParam6=slmTrapLogParam6, slmLicenseEntry=slmLicenseEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysCalendarTime=slmSysCalendarTime, slmNetworkMode=slmNetworkMode, slmAdminRowStatus=slmAdminRowStatus, slmSwRevStatus=slmSwRevStatus, slmAuthPassword=slmAuthPassword, slmChPassLogin=slmChPassLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysIpAddr=slmSysIpAddr, PYSNMP_MODULE_ID=slMain, slmTrapEnable=slmTrapEnable, slmTrapLogParam3=slmTrapLogParam3, slmAuthTable=slmAuthTable)
