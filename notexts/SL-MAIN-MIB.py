...
Opaque, Gauge32, Bits, Unsigned32, ModuleIdentity, Integer32, NotificationType, Counter32, ObjectIdentity, iso, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "Gauge32", "Bits", "Unsigned32", "ModuleIdentity", "Integer32", "NotificationType", "Counter32", "ObjectIdentity", "iso", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminTable=slmAdminTable, slmSwRevTable=slmSwRevTable, slmChPassNewPass=slmChPassNewPass, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminRowStatus=slmAdminRowStatus, slmSysAlmAct=slmSysAlmAct, slmSwRevDate=slmSwRevDate, slmReadCommunity=slmReadCommunity, slmSwRevName=slmSwRevName, slmSysResetPm=slmSysResetPm, slmSyslogPort=slmSyslogPort, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestEntry=slmTrapDestEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogParam5=slmTrapLogParam5, slmSnmpv3Auth=slmSnmpv3Auth, slmAuth=slmAuth, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam1=slmTrapLogParam1, slmTrapCommunity=slmTrapCommunity, SoftwareRevision=SoftwareRevision, slmSysCalendarTime=slmSysCalendarTime, slmTid=slmTid, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapDestAddress=slmTrapDestAddress, slmLicense=slmLicense, slmSysChassisId=slmSysChassisId, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogEntry=slmTrapLogEntry, slmAuthLogin=slmAuthLogin, slmLicenseExpiration=slmLicenseExpiration, slmSwRevDirectory=slmSwRevDirectory, slmSysAdminStatus=slmSysAdminStatus, slmEdfaNumber=slmEdfaNumber, slmTrapDestTable=slmTrapDestTable, slMain=slMain, slmAdminCommunity=slmAdminCommunity, slmPsuNumber=slmPsuNumber, slmTrapLogTable=slmTrapLogTable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuthCommunity=slmAuthCommunity, AdminAccess=AdminAccess, slmRstpEnabled=slmRstpEnabled, slmSysAlmDeact=slmSysAlmDeact, slmSysGatewayAddr=slmSysGatewayAddr, slmAuthPassword=slmAuthPassword, slmNetworkMode=slmNetworkMode, slmAdminPassword=slmAdminPassword, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseEntry=slmLicenseEntry, slmTrapLogParam6=slmTrapLogParam6, slmSys=slmSys, slmOemType=slmOemType, slmAdmin=slmAdmin, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAuthTable=slmAuthTable, slmSysName=slmSysName, slmRebootDelay=slmRebootDelay, slmSysSubnetMask=slmSysSubnetMask, slmVcatDelay=slmVcatDelay, slmChPass=slmChPass, slmSysTemperature=slmSysTemperature, slmTopologyEnabled=slmTopologyEnabled, slmConfigSysSignalType=slmConfigSysSignalType, slmTrap=slmTrap, slmSwRevStatus=slmSwRevStatus, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPassLogin=slmChPassLogin, slmAdminAccess=slmAdminAccess, slmTrapLogParam2=slmTrapLogParam2, slmConfigFile=slmConfigFile, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLogFile=slmLogFile, slmTrapLogId=slmTrapLogId, slm40GConf=slm40GConf, slmSysLanIpAddr=slmSysLanIpAddr, slmChPassTable=slmChPassTable, slmSyslogDestAddress=slmSyslogDestAddress, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLocation=slmSysLocation, slmSysUplinkRate=slmSysUplinkRate, slmSysTrapFormat=slmSysTrapFormat, slmSysNetworkPrefix=slmSysNetworkPrefix, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam3=slmTrapLogParam3, slmSysOperStatus=slmSysOperStatus, PYSNMP_MODULE_ID=slMain, slmTrapLogName=slmTrapLogName, slmSyslogLevel=slmSyslogLevel, UserLogin=UserLogin, UserPassword=UserPassword, UserCommunity=UserCommunity, slmAdminEntry=slmAdminEntry, slmLicenseId=slmLicenseId, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysIpAddr=slmSysIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuthEntry=slmAuthEntry, slmTrapUserLogin=slmTrapUserLogin, slmChPassEntry=slmChPassEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmBoxSize=slmBoxSize, slmLogin=slmLogin, slmSnmpv3Password=slmSnmpv3Password, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapPort=slmTrapPort, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminLogin=slmAdminLogin, slmPmAvailable=slmPmAvailable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysMode=slmSysMode, slmLicenseIndex=slmLicenseIndex, slmSwRevEntry=slmSwRevEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmChPassOldPass=slmChPassOldPass, slmTrapUserAccess=slmTrapUserAccess, slmConfigSysUptime=slmConfigSysUptime, slmLicenseTable=slmLicenseTable, slmPortsNumber=slmPortsNumber, slmTrapEnable=slmTrapEnable, slmSyslogDestTable=slmSyslogDestTable, slmMuxNumber=slmMuxNumber)
