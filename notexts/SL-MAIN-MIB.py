...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Opaque, Unsigned32, IpAddress, ObjectIdentity, Counter32, Integer32, NotificationType, Gauge32, iso, Counter64, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Opaque", "Unsigned32", "IpAddress", "ObjectIdentity", "Counter32", "Integer32", "NotificationType", "Gauge32", "iso", "Counter64", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogParam1=slmTrapLogParam1, slmChPassOldPass=slmChPassOldPass, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestTable=slmTrapDestTable, slmSnmpv3Priv=slmSnmpv3Priv, slmAuthEntry=slmAuthEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmMuxNumber=slmMuxNumber, slmSwRevName=slmSwRevName, slmAdminEntry=slmAdminEntry, slmLicenseEntry=slmLicenseEntry, slmSysLocation=slmSysLocation, slmSysLanIpAddr=slmSysLanIpAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAuth=slmAuth, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapUserAccess=slmTrapUserAccess, slmTrapPort=slmTrapPort, slmChPassTable=slmChPassTable, slmSysAdminStatus=slmSysAdminStatus, slmAuthTable=slmAuthTable, AdminAccess=AdminAccess, slmSysIpAddr=slmSysIpAddr, slmTrapLogId=slmTrapLogId, slmSysPmStartOfDay=slmSysPmStartOfDay, slmConfigSysUptime=slmConfigSysUptime, slmBoxSize=slmBoxSize, slmAuthPassword=slmAuthPassword, slmTrapCommunity=slmTrapCommunity, slmSysUplinkRate=slmSysUplinkRate, slmAdminPassword=slmAdminPassword, slmTrapEnable=slmTrapEnable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogTable=slmTrapLogTable, slmChPassEntry=slmChPassEntry, slmSysOperStatus=slmSysOperStatus, slMain=slMain, slmSysMode=slmSysMode, slmLogFile=slmLogFile, slmLicenseId=slmLicenseId, slm40GConf=slm40GConf, slmVcatDelay=slmVcatDelay, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysTrapFormat=slmSysTrapFormat, slmConfigFile=slmConfigFile, slmSyslogPort=slmSyslogPort, slmTrapDestProtVersion=slmTrapDestProtVersion, UserCommunity=UserCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmPmAvailable=slmPmAvailable, slmRstpEnabled=slmRstpEnabled, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogDestEntry=slmSyslogDestEntry, slmChPassLogin=slmChPassLogin, slmSyslogDestAddress=slmSyslogDestAddress, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLogin=slmLogin, slmTrapLogName=slmTrapLogName, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam6=slmTrapLogParam6, slmAdmin=slmAdmin, slmSwRevDate=slmSwRevDate, slmSys=slmSys, slmChPass=slmChPass, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogDestTable=slmSyslogDestTable, slmWriteCommunity=slmWriteCommunity, slmSysAlmDeact=slmSysAlmDeact, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogParam5=slmTrapLogParam5, slmLicenseExpiration=slmLicenseExpiration, slmReadCommunity=slmReadCommunity, slmSyslogLevel=slmSyslogLevel, slmSysTemperature=slmSysTemperature, slmTrapDestEntry=slmTrapDestEntry, slmTrap=slmTrap, slmNetworkMode=slmNetworkMode, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestAddress=slmTrapDestAddress, slmSysChassisId=slmSysChassisId, UserPassword=UserPassword, PYSNMP_MODULE_ID=slMain, slmSysName=slmSysName, slmSysCalendarTime=slmSysCalendarTime, slmChPassNewPass=slmChPassNewPass, slmSwRevStatus=slmSwRevStatus, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSwRevDirectory=slmSwRevDirectory, SoftwareRevision=SoftwareRevision, slmTrapLogEntry=slmTrapLogEntry, slmAdminAccess=slmAdminAccess, slmSysAlmAct=slmSysAlmAct, slmTopologyEnabled=slmTopologyEnabled, slmAuthLogin=slmAuthLogin, slmOemType=slmOemType, slmLicenseTable=slmLicenseTable, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogParam3=slmTrapLogParam3, slmSysGatewayAddr=slmSysGatewayAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, UserLogin=UserLogin, slmAdminTable=slmAdminTable, slmSysResetPm=slmSysResetPm, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminLogin=slmAdminLogin, slmRebootDelay=slmRebootDelay, slmEdfaNumber=slmEdfaNumber, slmPsuNumber=slmPsuNumber, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLicense=slmLicense, slmSwRevTable=slmSwRevTable, slmAuthCommunity=slmAuthCommunity, slmAdminCommunity=slmAdminCommunity, slmSwRevEntry=slmSwRevEntry, slmLicenseIndex=slmLicenseIndex, slmTid=slmTid, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmPortsNumber=slmPortsNumber, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapSysNameChange=slmTrapSysNameChange)
