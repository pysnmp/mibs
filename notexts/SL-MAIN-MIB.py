...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminCommunity=slmAdminCommunity, slmPmAvailable=slmPmAvailable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminTable=slmAdminTable, slmTid=slmTid, slmSys=slmSys, slmSwRevDirectory=slmSwRevDirectory, UserCommunity=UserCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminPassword=slmAdminPassword, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevEntry=slmSwRevEntry, PYSNMP_MODULE_ID=slMain, slmAuthTable=slmAuthTable, slm40GConf=slm40GConf, UserPassword=UserPassword, slmLicenseIndex=slmLicenseIndex, slmTrapDestEntry=slmTrapDestEntry, slmSyslogDestTable=slmSyslogDestTable, slmTrapPort=slmTrapPort, slmTrapLogName=slmTrapLogName, slmSnmpv3Password=slmSnmpv3Password, slmPsuNumber=slmPsuNumber, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogEntry=slmTrapLogEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTopologyEnabled=slmTopologyEnabled, slmLicenseTable=slmLicenseTable, slmAuthPassword=slmAuthPassword, slmSnmpv3Auth=slmSnmpv3Auth, slmLicenseExpiration=slmLicenseExpiration, slmLicense=slmLicense, SoftwareRevision=SoftwareRevision, slmLogin=slmLogin, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAuth=slmAuth, slmSysOperStatus=slmSysOperStatus, slmConfigSysUptime=slmConfigSysUptime, slmSnmpv3Priv=slmSnmpv3Priv, slmLicenseEntry=slmLicenseEntry, slmSysLocation=slmSysLocation, slmSysActiveSwVersion=slmSysActiveSwVersion, slmNetworkMode=slmNetworkMode, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam3=slmTrapLogParam3, slmAdminEntry=slmAdminEntry, slmSysIpAddr=slmSysIpAddr, slmAuthEntry=slmAuthEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysAdminStatus=slmSysAdminStatus, AdminAccess=AdminAccess, slmConfigFile=slmConfigFile, slmChPassNewPass=slmChPassNewPass, slmBoxSize=slmBoxSize, slmSysName=slmSysName, slmAdminLogin=slmAdminLogin, slmSyslogLevel=slmSyslogLevel, slmSwRevTable=slmSwRevTable, slmSysResetPm=slmSysResetPm, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam4=slmTrapLogParam4, slmVcatDelay=slmVcatDelay, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmMuxNumber=slmMuxNumber, slmSysCalendarTime=slmSysCalendarTime, slmLicenseId=slmLicenseId, slMain=slMain, slmAuthLogin=slmAuthLogin, slmChPassTable=slmChPassTable, slmTrap=slmTrap, slmSysTemperature=slmSysTemperature, slmTrapSysLocationChange=slmTrapSysLocationChange, slmPortsNumber=slmPortsNumber, slmRebootDelay=slmRebootDelay, slmSysMode=slmSysMode, slmTrapEnable=slmTrapEnable, slmReadCommunity=slmReadCommunity, slmSyslogPort=slmSyslogPort, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysChassisId=slmSysChassisId, slmAdmin=slmAdmin, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLogFile=slmLogFile, slmTrapLogTable=slmTrapLogTable, slmChPassEntry=slmChPassEntry, slmTrapLogParam6=slmTrapLogParam6, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestTable=slmTrapDestTable, slmTrapDestAddress=slmTrapDestAddress, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapUserAccess=slmTrapUserAccess, slmSwRevDate=slmSwRevDate, slmEdfaNumber=slmEdfaNumber, slmChPassLogin=slmChPassLogin, slmSyslogDestEntry=slmSyslogDestEntry, UserLogin=UserLogin, slmTrapCommunity=slmTrapCommunity, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevName=slmSwRevName, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam5=slmTrapLogParam5, slmOemType=slmOemType, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSwRevStatus=slmSwRevStatus, slmSysUplinkRate=slmSysUplinkRate, slmSysAlmDeact=slmSysAlmDeact, slmAdminRowStatus=slmAdminRowStatus, slmAdminAccess=slmAdminAccess, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogId=slmTrapLogId, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysAlmAct=slmSysAlmAct, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestRowStatus=slmTrapDestRowStatus, slmRstpEnabled=slmRstpEnabled, slmSysLanIpAddr=slmSysLanIpAddr, slmChPassOldPass=slmChPassOldPass, slmSysSubnetMask=slmSysSubnetMask, slmChPass=slmChPass, slmTrapLogParam1=slmTrapLogParam1)
