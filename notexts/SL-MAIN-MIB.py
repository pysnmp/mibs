...
Opaque, iso, MibIdentifier, Counter64, Integer32, NotificationType, ObjectIdentity, Counter32, Unsigned32, ModuleIdentity, IpAddress, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "iso", "MibIdentifier", "Counter64", "Integer32", "NotificationType", "ObjectIdentity", "Counter32", "Unsigned32", "ModuleIdentity", "IpAddress", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAuthEntry=slmAuthEntry, slmSyslogDestTable=slmSyslogDestTable, slmEdfaNumber=slmEdfaNumber, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogName=slmTrapLogName, slmChPassLogin=slmChPassLogin, slmSysGatewayAddr=slmSysGatewayAddr, SoftwareRevision=SoftwareRevision, slmAuthCommunity=slmAuthCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogParam6=slmTrapLogParam6, slmLicenseExpiration=slmLicenseExpiration, slmChPassEntry=slmChPassEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, PYSNMP_MODULE_ID=slMain, slmOemType=slmOemType, slMain=slMain, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuth=slmAuth, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSnmpv3Priv=slmSnmpv3Priv, slm40GConf=slm40GConf, slmLicenseIndex=slmLicenseIndex, slmTrapUserLogin=slmTrapUserLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevDirectory=slmSwRevDirectory, slmAdminAccess=slmAdminAccess, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogParam5=slmTrapLogParam5, slmSnmpv3Auth=slmSnmpv3Auth, slmNetworkMode=slmNetworkMode, slmChPassNewPass=slmChPassNewPass, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogEntry=slmTrapLogEntry, slmTrapCommunity=slmTrapCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuthTable=slmAuthTable, slmConfigSysUptime=slmConfigSysUptime, slmSys=slmSys, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysAlmAct=slmSysAlmAct, slmSysTrapFormat=slmSysTrapFormat, slmSwRevStatus=slmSwRevStatus, slmLicense=slmLicense, slmSyslogLevel=slmSyslogLevel, slmWriteCommunity=slmWriteCommunity, slmSyslogPort=slmSyslogPort, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapEnable=slmTrapEnable, slmTrapLogParam2=slmTrapLogParam2, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapUserAccess=slmTrapUserAccess, slmChPass=slmChPass, slmReadCommunity=slmReadCommunity, UserCommunity=UserCommunity, slmAdminTable=slmAdminTable, slmAuthLogin=slmAuthLogin, slmPortsNumber=slmPortsNumber, slmTid=slmTid, slmAdminCommunity=slmAdminCommunity, slmTrapLogId=slmTrapLogId, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysIpAddr=slmSysIpAddr, UserPassword=UserPassword, slmVcatDelay=slmVcatDelay, slmChPassOldPass=slmChPassOldPass, slmTrapDestTable=slmTrapDestTable, slmPsuNumber=slmPsuNumber, slmRebootDelay=slmRebootDelay, slmSysAdminStatus=slmSysAdminStatus, slmAdminEntry=slmAdminEntry, slmConfigFile=slmConfigFile, slmSysMode=slmSysMode, slmChPassTable=slmChPassTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysTemperature=slmSysTemperature, slmSysName=slmSysName, slmLogFile=slmLogFile, slmSysUplinkRate=slmSysUplinkRate, slmAuthPassword=slmAuthPassword, slmTrapLogParam4=slmTrapLogParam4, slmTopologyEnabled=slmTopologyEnabled, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam1=slmTrapLogParam1, slmTrap=slmTrap, slmSysLocation=slmSysLocation, AdminAccess=AdminAccess, slmTrapSysNameChange=slmTrapSysNameChange, slmLogin=slmLogin, slmAdminLogin=slmAdminLogin, slmSysAlmDeact=slmSysAlmDeact, slmTrapDestEntry=slmTrapDestEntry, slmAdmin=slmAdmin, slmSwRevTable=slmSwRevTable, slmSwRevName=slmSwRevName, slmMuxNumber=slmMuxNumber, slmLicenseEntry=slmLicenseEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicenseId=slmLicenseId, slmTrapLogTable=slmTrapLogTable, slmSwRevDate=slmSwRevDate, slmRstpEnabled=slmRstpEnabled, slmTrapDestAddress=slmTrapDestAddress, slmLicenseTable=slmLicenseTable, slmSwRevEntry=slmSwRevEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmBoxSize=slmBoxSize, slmSysOperStatus=slmSysOperStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysSubnetMask=slmSysSubnetMask, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestCommunity=slmTrapDestCommunity, UserLogin=UserLogin, slmTrapPort=slmTrapPort, slmSysActiveSwVersion=slmSysActiveSwVersion, slmConfigSysSignalType=slmConfigSysSignalType, slmSysResetPm=slmSysResetPm, slmSysChassisId=slmSysChassisId, slmSysSnmpVersion=slmSysSnmpVersion, slmPmAvailable=slmPmAvailable, slmAdminPassword=slmAdminPassword)
