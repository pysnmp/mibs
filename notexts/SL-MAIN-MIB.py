...
iso, Integer32, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, Counter64, ObjectIdentity, Gauge32, TimeTicks, Counter32, Unsigned32, ModuleIdentity, MibIdentifier, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "Counter64", "ObjectIdentity", "Gauge32", "TimeTicks", "Counter32", "Unsigned32", "ModuleIdentity", "MibIdentifier", "Bits")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicenseEntry=slmLicenseEntry, slmConfigFile=slmConfigFile, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam2=slmTrapLogParam2, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogName=slmTrapLogName, slmTrapDestTable=slmTrapDestTable, slmAdminCommunity=slmAdminCommunity, slmPortsNumber=slmPortsNumber, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogEntry=slmTrapLogEntry, slmAdminEntry=slmAdminEntry, slmSwRevDate=slmSwRevDate, slmSyslogPort=slmSyslogPort, slmSysAlmDeact=slmSysAlmDeact, AdminAccess=AdminAccess, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogParam3=slmTrapLogParam3, slmAdminPassword=slmAdminPassword, slmSysTrapFormat=slmSysTrapFormat, slMain=slMain, slmSysResetPm=slmSysResetPm, slmLogin=slmLogin, slmTrapDestCommunity=slmTrapDestCommunity, UserCommunity=UserCommunity, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAuthTable=slmAuthTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminLogin=slmAdminLogin, slmSysCalendarTime=slmSysCalendarTime, slmTid=slmTid, slmWriteCommunity=slmWriteCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseTable=slmLicenseTable, UserLogin=UserLogin, slmSysOperStatus=slmSysOperStatus, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAuthLogin=slmAuthLogin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmPsuNumber=slmPsuNumber, slmReadCommunity=slmReadCommunity, slmAuth=slmAuth, slmSysMode=slmSysMode, slmSysSubnetMask=slmSysSubnetMask, slmPmAvailable=slmPmAvailable, slmAuthPassword=slmAuthPassword, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogTable=slmTrapLogTable, slmVcatDelay=slmVcatDelay, slmTrapDestProtVersion=slmTrapDestProtVersion, slmChPassLogin=slmChPassLogin, slmSyslogLevel=slmSyslogLevel, slmConfigSysUptime=slmConfigSysUptime, slmConfigSysSignalType=slmConfigSysSignalType, slmAdmin=slmAdmin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminAccess=slmAdminAccess, slmOemType=slmOemType, slmSysName=slmSysName, slmTrapLogParam4=slmTrapLogParam4, slmSwRevName=slmSwRevName, slmEdfaNumber=slmEdfaNumber, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam6=slmTrapLogParam6, slmChPassOldPass=slmChPassOldPass, slm40GConf=slm40GConf, slmSysIpAddr=slmSysIpAddr, slmSys=slmSys, slmSwRevDirectory=slmSwRevDirectory, PYSNMP_MODULE_ID=slMain, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSyslogDestEntry=slmSyslogDestEntry, slmChPassTable=slmChPassTable, slmTopologyEnabled=slmTopologyEnabled, slmSwRevEntry=slmSwRevEntry, slmTrap=slmTrap, slmTrapSysNameChange=slmTrapSysNameChange, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSwRevTable=slmSwRevTable, slmLicense=slmLicense, slmMuxNumber=slmMuxNumber, slmTrapUserLogin=slmTrapUserLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapCommunity=slmTrapCommunity, slmChPass=slmChPass, slmSysGatewayAddr=slmSysGatewayAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapUserAccess=slmTrapUserAccess, slmRstpEnabled=slmRstpEnabled, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogParam5=slmTrapLogParam5, slmAuthEntry=slmAuthEntry, slmSyslogDestTable=slmSyslogDestTable, slmSnmpv3Auth=slmSnmpv3Auth, slmLogFile=slmLogFile, slmSysChassisId=slmSysChassisId, SoftwareRevision=SoftwareRevision, UserPassword=UserPassword, slmTrapEnable=slmTrapEnable, slmRebootDelay=slmRebootDelay, slmSysLocation=slmSysLocation, slmAuthCommunity=slmAuthCommunity, slmLicenseId=slmLicenseId, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmNetworkMode=slmNetworkMode, slmChPassNewPass=slmChPassNewPass, slmSysAdminStatus=slmSysAdminStatus, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysTemperature=slmSysTemperature, slmTrapLogId=slmTrapLogId, slmSysAlmAct=slmSysAlmAct, slmSwRevStatus=slmSwRevStatus, slmAdminTable=slmAdminTable, slmTrapLogParam1=slmTrapLogParam1, slmTrapPort=slmTrapPort, slmBoxSize=slmBoxSize, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmSysUplinkRate=slmSysUplinkRate, slmLicenseIndex=slmLicenseIndex, slmSnmpv3Password=slmSnmpv3Password, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapSysLocationChange=slmTrapSysLocationChange, slmChPassEntry=slmChPassEntry)
