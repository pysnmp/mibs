...
Opaque, Bits, ObjectIdentity, TimeTicks, IpAddress, Integer32, iso, NotificationType, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "Bits", "ObjectIdentity", "TimeTicks", "IpAddress", "Integer32", "iso", "NotificationType", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysCalendarTime=slmSysCalendarTime, slmSysName=slmSysName, slmOpticalSwitchExist=slmOpticalSwitchExist, slmNetworkMode=slmNetworkMode, slmTrapLogParam6=slmTrapLogParam6, slmPortsNumber=slmPortsNumber, slmConfigFile=slmConfigFile, slmAdmin=slmAdmin, slmSyslogDestAddress=slmSyslogDestAddress, slmSwRevStatus=slmSwRevStatus, slmPsuNumber=slmPsuNumber, slmPmAvailable=slmPmAvailable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSyslogLevel=slmSyslogLevel, slmSysLocation=slmSysLocation, slmAdminLogin=slmAdminLogin, slmSwRevEntry=slmSwRevEntry, slmAuthPassword=slmAuthPassword, slmConfigSysUptime=slmConfigSysUptime, slmSwRevDate=slmSwRevDate, slmChPassLogin=slmChPassLogin, slmSysChassisId=slmSysChassisId, slmTrap=slmTrap, slmSysMode=slmSysMode, slmAuthEntry=slmAuthEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmSwRevName=slmSwRevName, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam2=slmTrapLogParam2, slmSnmpv3Priv=slmSnmpv3Priv, AdminAccess=AdminAccess, slmSysEncryptionCapability=slmSysEncryptionCapability, slmChPass=slmChPass, slmSysUplinkRate=slmSysUplinkRate, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSnmpv3Password=slmSnmpv3Password, slmSyslogDestEntry=slmSyslogDestEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapEnable=slmTrapEnable, slmAdminRowStatus=slmAdminRowStatus, UserPassword=UserPassword, slmTid=slmTid, slmSysTrapFormat=slmSysTrapFormat, slmSwRevTable=slmSwRevTable, slmEdfaNumber=slmEdfaNumber, slmSys=slmSys, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapPort=slmTrapPort, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestAddress=slmTrapDestAddress, PYSNMP_MODULE_ID=slMain, slmSyslogPort=slmSyslogPort, slmLicense=slmLicense, slmAuthLogin=slmAuthLogin, SoftwareRevision=SoftwareRevision, slmSyslogDestTable=slmSyslogDestTable, slmLicenseIndex=slmLicenseIndex, slmAdminPassword=slmAdminPassword, slmTrapLogEntry=slmTrapLogEntry, slmSysTemperature=slmSysTemperature, slmLogin=slmLogin, slmSysAlmDeact=slmSysAlmDeact, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicenseExpiration=slmLicenseExpiration, slmSysResetPm=slmSysResetPm, slmChPassOldPass=slmChPassOldPass, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogParam5=slmTrapLogParam5, slmSysAlmAct=slmSysAlmAct, slm40GConf=slm40GConf, slMain=slMain, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLogFile=slmLogFile, slmTrapDestCommunity=slmTrapDestCommunity, slmAdminTable=slmAdminTable, slmMuxNumber=slmMuxNumber, slmVcatDelay=slmVcatDelay, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminCommunity=slmAdminCommunity, slmAuthTable=slmAuthTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmRebootDelay=slmRebootDelay, slmChPassEntry=slmChPassEntry, slmAdminEntry=slmAdminEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestTable=slmTrapDestTable, slmReadCommunity=slmReadCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysSubnetMask=slmSysSubnetMask, slmSysIpAddr=slmSysIpAddr, slmTrapLogTable=slmTrapLogTable, slmTrapUserAccess=slmTrapUserAccess, slmLicenseEntry=slmLicenseEntry, slmTrapSysNameChange=slmTrapSysNameChange, UserCommunity=UserCommunity, slmChPassNewPass=slmChPassNewPass, slmTrapLogParam1=slmTrapLogParam1, slmSysLanIpAddr=slmSysLanIpAddr, slmLicenseTable=slmLicenseTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminAccess=slmAdminAccess, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuthCommunity=slmAuthCommunity, slmWriteCommunity=slmWriteCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmRstpEnabled=slmRstpEnabled, slmLicenseId=slmLicenseId, slmChPassTable=slmChPassTable, UserLogin=UserLogin, slmBoxSize=slmBoxSize, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmOemType=slmOemType, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuth=slmAuth, slmTrapLogParam4=slmTrapLogParam4, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogId=slmTrapLogId, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogName=slmTrapLogName, slmSysOperStatus=slmSysOperStatus, slmSwRevDirectory=slmSwRevDirectory, slmTrapCommunity=slmTrapCommunity, slmTrapDestEntry=slmTrapDestEntry, slmConfigSysSignalType=slmConfigSysSignalType)
