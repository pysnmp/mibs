...
NotificationType, ObjectIdentity, MibIdentifier, Counter32, Integer32, Opaque, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, Unsigned32, iso, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "MibIdentifier", "Counter32", "Integer32", "Opaque", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "Unsigned32", "iso", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmMuxNumber=slmMuxNumber, slmAdminTable=slmAdminTable, slmAdminRowStatus=slmAdminRowStatus, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLicenseTable=slmLicenseTable, slmSysOperStatus=slmSysOperStatus, slmAuth=slmAuth, slmSysSnmpVersion=slmSysSnmpVersion, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLogin=slmLogin, slmChPassOldPass=slmChPassOldPass, slmLicense=slmLicense, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogName=slmTrapLogName, UserPassword=UserPassword, slmLogFile=slmLogFile, slmSysTemperature=slmSysTemperature, slm40GConf=slm40GConf, slmSysLocation=slmSysLocation, slmReadCommunity=slmReadCommunity, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmRstpEnabled=slmRstpEnabled, slmSysResetPm=slmSysResetPm, slmAuthCommunity=slmAuthCommunity, slmSwRevDate=slmSwRevDate, slMain=slMain, slmAuthLogin=slmAuthLogin, slmSyslogPort=slmSyslogPort, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicenseExpiration=slmLicenseExpiration, slmAuthTable=slmAuthTable, slmAdminPassword=slmAdminPassword, slmAdminLogin=slmAdminLogin, slmLicenseEntry=slmLicenseEntry, slmTrapLogParam1=slmTrapLogParam1, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysAlmAct=slmSysAlmAct, slmChPassLogin=slmChPassLogin, slmTrapDestEntry=slmTrapDestEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmConfigFile=slmConfigFile, slmSnmpv3Auth=slmSnmpv3Auth, slmPsuNumber=slmPsuNumber, slmTrapCommunity=slmTrapCommunity, slmTrapPort=slmTrapPort, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseId=slmLicenseId, slmAuthEntry=slmAuthEntry, slmLicenseIndex=slmLicenseIndex, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogTable=slmTrapLogTable, slmTid=slmTid, slmTrapLogParam2=slmTrapLogParam2, slmChPassTable=slmChPassTable, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogParam5=slmTrapLogParam5, slmEdfaNumber=slmEdfaNumber, slmTrapLogEntry=slmTrapLogEntry, slmAuthPassword=slmAuthPassword, slmSysCalendarTime=slmSysCalendarTime, slmTrapUserLogin=slmTrapUserLogin, slmSysAlmDeact=slmSysAlmDeact, slmConfigSysSignalType=slmConfigSysSignalType, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestTable=slmTrapDestTable, slmAdminCommunity=slmAdminCommunity, slmSyslogDestAddress=slmSyslogDestAddress, slmOemType=slmOemType, slmSnmpv3Password=slmSnmpv3Password, slmAdminAccess=slmAdminAccess, slmTrapDestAddress=slmTrapDestAddress, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevName=slmSwRevName, slmAdminEntry=slmAdminEntry, slmTrapLogParam4=slmTrapLogParam4, slmSwRevEntry=slmSwRevEntry, slmSyslogLevel=slmSyslogLevel, PYSNMP_MODULE_ID=slMain, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPassEntry=slmChPassEntry, slmChPass=slmChPass, SoftwareRevision=SoftwareRevision, slmPortsNumber=slmPortsNumber, slmTrapLogId=slmTrapLogId, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapEnable=slmTrapEnable, AdminAccess=AdminAccess, slmChPassNewPass=slmChPassNewPass, slmSysSubnetMask=slmSysSubnetMask, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmNetworkMode=slmNetworkMode, slmBoxSize=slmBoxSize, slmSyslogDestEntry=slmSyslogDestEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmSysAdminStatus=slmSysAdminStatus, slmSysUplinkRate=slmSysUplinkRate, slmSysMode=slmSysMode, slmTrapUserAccess=slmTrapUserAccess, slmTopologyEnabled=slmTopologyEnabled, slmSysName=slmSysName, slmVcatDelay=slmVcatDelay, slmTrapDestCommunity=slmTrapDestCommunity, slmConfigSysUptime=slmConfigSysUptime, slmSys=slmSys, slmRebootDelay=slmRebootDelay, slmWriteCommunity=slmWriteCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrap=slmTrap, slmSysChassisId=slmSysChassisId, slmPmAvailable=slmPmAvailable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, UserLogin=UserLogin, slmAdmin=slmAdmin, UserCommunity=UserCommunity, slmSwRevTable=slmSwRevTable, slmSysLanIpAddr=slmSysLanIpAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSyslogDestTable=slmSyslogDestTable, slmSysIpAddr=slmSysIpAddr, slmSwRevStatus=slmSwRevStatus, slmTrapLogParam3=slmTrapLogParam3)
