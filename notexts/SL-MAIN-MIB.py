...
ObjectIdentity, Counter32, Gauge32, ModuleIdentity, Counter64, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, NotificationType, iso, Integer32, TimeTicks, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "Gauge32", "ModuleIdentity", "Counter64", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "NotificationType", "iso", "Integer32", "TimeTicks", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAuthLogin=slmAuthLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysResetPm=slmSysResetPm, slmSysLocation=slmSysLocation, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysMode=slmSysMode, slmSyslogLevel=slmSyslogLevel, slmTrapCommunity=slmTrapCommunity, UserLogin=UserLogin, slmSwRevEntry=slmSwRevEntry, slmAuth=slmAuth, slmPsuNumber=slmPsuNumber, slmChPassLogin=slmChPassLogin, slmLogin=slmLogin, slmSysName=slmSysName, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysTemperature=slmSysTemperature, slmChPassOldPass=slmChPassOldPass, slmSwRevDate=slmSwRevDate, slmPortsNumber=slmPortsNumber, slmSyslogPort=slmSyslogPort, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapPort=slmTrapPort, slmSysAlmDeact=slmSysAlmDeact, slmSwRevName=slmSwRevName, slmEdfaNumber=slmEdfaNumber, slmMuxNumber=slmMuxNumber, UserPassword=UserPassword, slmTrapDestTable=slmTrapDestTable, slmChPassNewPass=slmChPassNewPass, slmRstpEnabled=slmRstpEnabled, slmLicenseId=slmLicenseId, slmTrapLogParam6=slmTrapLogParam6, slmLicenseIndex=slmLicenseIndex, slmChPassEntry=slmChPassEntry, slmAuthPassword=slmAuthPassword, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogParam5=slmTrapLogParam5, slmChPass=slmChPass, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAdminRowStatus=slmAdminRowStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogParam2=slmTrapLogParam2, slmSysOperStatus=slmSysOperStatus, slmAdminEntry=slmAdminEntry, slmAuthTable=slmAuthTable, slmSysPmStartOfDay=slmSysPmStartOfDay, slmReadCommunity=slmReadCommunity, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmPmAvailable=slmPmAvailable, slmSysTrapFormat=slmSysTrapFormat, PYSNMP_MODULE_ID=slMain, slMain=slMain, slmVcatDelay=slmVcatDelay, slmLicense=slmLicense, slmAuthCommunity=slmAuthCommunity, slmSwRevStatus=slmSwRevStatus, slmConfigSysUptime=slmConfigSysUptime, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam1=slmTrapLogParam1, slmAdminCommunity=slmAdminCommunity, slmTrapLogId=slmTrapLogId, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapEnable=slmTrapEnable, slm40GConf=slm40GConf, slmAuthEntry=slmAuthEntry, slmSwRevTable=slmSwRevTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminLogin=slmAdminLogin, slmAdminTable=slmAdminTable, slmChPassTable=slmChPassTable, slmSysUplinkRate=slmSysUplinkRate, slmLicenseEntry=slmLicenseEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLogFile=slmLogFile, slmSysGatewayAddr=slmSysGatewayAddr, slmBoxSize=slmBoxSize, slmSysCalendarTime=slmSysCalendarTime, SoftwareRevision=SoftwareRevision, slmSysIpAddr=slmSysIpAddr, slmRebootDelay=slmRebootDelay, slmConfigFile=slmConfigFile, slmSysLanIpAddr=slmSysLanIpAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysChassisId=slmSysChassisId, slmAdminPassword=slmAdminPassword, slmLicenseTable=slmLicenseTable, slmSysSubnetMask=slmSysSubnetMask, slmNetworkMode=slmNetworkMode, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmSysAlmAct=slmSysAlmAct, slmTopologyEnabled=slmTopologyEnabled, slmOemType=slmOemType, slmLicenseExpiration=slmLicenseExpiration, slmSyslogDestTable=slmSyslogDestTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, UserCommunity=UserCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestAddress=slmTrapDestAddress, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogTable=slmTrapLogTable, AdminAccess=AdminAccess, slmTid=slmTid, slmTrap=slmTrap, slmTrapLogName=slmTrapLogName, slmAdmin=slmAdmin, slmTrapLogParam4=slmTrapLogParam4, slmSnmpv3Password=slmSnmpv3Password, slmSwRevDirectory=slmSwRevDirectory, slmTrapUserLogin=slmTrapUserLogin, slmSys=slmSys, slmAdminAccess=slmAdminAccess, slmConfigSysSignalType=slmConfigSysSignalType, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestEntry=slmTrapDestEntry)
