...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, Counter64, Bits, Counter32, Unsigned32, MibIdentifier, Integer32, Gauge32, TimeTicks, ModuleIdentity, IpAddress, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "Counter64", "Bits", "Counter32", "Unsigned32", "MibIdentifier", "Integer32", "Gauge32", "TimeTicks", "ModuleIdentity", "IpAddress", "NotificationType", "iso")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLogFile=slmLogFile, slmTrapDestCommunity=slmTrapDestCommunity, slmSysIpAddr=slmSysIpAddr, slmConfigFile=slmConfigFile, slmTrapDestTable=slmTrapDestTable, slmSysAlmAct=slmSysAlmAct, slmAdmin=slmAdmin, slmLicenseEntry=slmLicenseEntry, slmSysChassisId=slmSysChassisId, slmSysOperStatus=slmSysOperStatus, UserLogin=UserLogin, slmTid=slmTid, slmEdfaNumber=slmEdfaNumber, slmSysMode=slmSysMode, slmTrapLogParam5=slmTrapLogParam5, slmSwRevTable=slmSwRevTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminAccess=slmAdminAccess, slmTrapLogParam1=slmTrapLogParam1, slmAdminEntry=slmAdminEntry, slmChPassTable=slmChPassTable, slmLogin=slmLogin, slmMuxNumber=slmMuxNumber, slmSwRevDate=slmSwRevDate, slmLicenseIndex=slmLicenseIndex, slmSysSnmpVersion=slmSysSnmpVersion, slMain=slMain, slmChPassOldPass=slmChPassOldPass, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAuthCommunity=slmAuthCommunity, UserCommunity=UserCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminRowStatus=slmAdminRowStatus, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSwRevStatus=slmSwRevStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogId=slmTrapLogId, slmSwRevName=slmSwRevName, slmLicenseId=slmLicenseId, slmSysName=slmSysName, slmLicenseExpiration=slmLicenseExpiration, slmTrapCommunity=slmTrapCommunity, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam3=slmTrapLogParam3, slmAuthTable=slmAuthTable, slmChPassLogin=slmChPassLogin, slmSysResetPm=slmSysResetPm, slmVcatDelay=slmVcatDelay, slmChPassEntry=slmChPassEntry, slmReadCommunity=slmReadCommunity, slmTrapLogParam2=slmTrapLogParam2, slmSysTrapFormat=slmSysTrapFormat, AdminAccess=AdminAccess, slmLicense=slmLicense, slmPmAvailable=slmPmAvailable, slmSyslogPort=slmSyslogPort, slmAdminTable=slmAdminTable, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSnmpv3Auth=slmSnmpv3Auth, slmTopologyEnabled=slmTopologyEnabled, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuth=slmAuth, slmAuthPassword=slmAuthPassword, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmPortsNumber=slmPortsNumber, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysAdminStatus=slmSysAdminStatus, slmSnmpv3Password=slmSnmpv3Password, slmSyslogDestEntry=slmSyslogDestEntry, slmOemType=slmOemType, slmTrap=slmTrap, slmTrapLogName=slmTrapLogName, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmPsuNumber=slmPsuNumber, slmSyslogDestAddress=slmSyslogDestAddress, SoftwareRevision=SoftwareRevision, slmTrapPort=slmTrapPort, slmAdminCommunity=slmAdminCommunity, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestTable=slmSyslogDestTable, slmTrapEnable=slmTrapEnable, slmSysAlmDeact=slmSysAlmDeact, slmAuthEntry=slmAuthEntry, slmSysSubnetMask=slmSysSubnetMask, slmSwRevEntry=slmSwRevEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminPassword=slmAdminPassword, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam4=slmTrapLogParam4, slmSysLocation=slmSysLocation, UserPassword=UserPassword, slm40GConf=slm40GConf, slmSyslogLevel=slmSyslogLevel, slmNetworkMode=slmNetworkMode, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevDirectory=slmSwRevDirectory, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSys=slmSys, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPassNewPass=slmChPassNewPass, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestAddress=slmTrapDestAddress, slmSysTemperature=slmSysTemperature, slmTrapLogParam6=slmTrapLogParam6, slmRebootDelay=slmRebootDelay, slmAuthLogin=slmAuthLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPass=slmChPass, slmBoxSize=slmBoxSize, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseTable=slmLicenseTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminLogin=slmAdminLogin, slmTrapUserLogin=slmTrapUserLogin, slmTrapUserAccess=slmTrapUserAccess, slmWriteCommunity=slmWriteCommunity, slmTrapLogEntry=slmTrapLogEntry, slmRstpEnabled=slmRstpEnabled, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, PYSNMP_MODULE_ID=slMain, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestEntry=slmTrapDestEntry, slmConfigSysSignalType=slmConfigSysSignalType)
