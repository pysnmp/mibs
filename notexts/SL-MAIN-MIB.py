...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmRstpEnabled=slmRstpEnabled, UserPassword=UserPassword, slmAdminEntry=slmAdminEntry, slmChPassNewPass=slmChPassNewPass, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogName=slmTrapLogName, slmAuthCommunity=slmAuthCommunity, slmSysAdminStatus=slmSysAdminStatus, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestAddress=slmTrapDestAddress, AdminAccess=AdminAccess, slmAuthPassword=slmAuthPassword, slmSysUplinkRate=slmSysUplinkRate, slmTrapDestEntry=slmTrapDestEntry, slmChPassOldPass=slmChPassOldPass, slmChPass=slmChPass, slmAdmin=slmAdmin, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogEntry=slmTrapLogEntry, slmTrapPort=slmTrapPort, slmOemType=slmOemType, slmTrapLogTable=slmTrapLogTable, slmTrapLogId=slmTrapLogId, UserCommunity=UserCommunity, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestRowStatus=slmTrapDestRowStatus, PYSNMP_MODULE_ID=slMain, slmTrapCommunity=slmTrapCommunity, slmSnmpv3Password=slmSnmpv3Password, slmEdfaNumber=slmEdfaNumber, slmVcatDelay=slmVcatDelay, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLicenseTable=slmLicenseTable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmNetworkMode=slmNetworkMode, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicense=slmLicense, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapDestTable=slmTrapDestTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, UserLogin=UserLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmTrap=slmTrap, slmChPassEntry=slmChPassEntry, slMain=slMain, slmSwRevDirectory=slmSwRevDirectory, slmRebootDelay=slmRebootDelay, slmSwRevDate=slmSwRevDate, slmAdminPassword=slmAdminPassword, slmLicenseEntry=slmLicenseEntry, slmSyslogPort=slmSyslogPort, slmSysName=slmSysName, slmAdminAccess=slmAdminAccess, slmLicenseId=slmLicenseId, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLogin=slmLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysResetPm=slmSysResetPm, slmTrapLogParam2=slmTrapLogParam2, slmSwRevEntry=slmSwRevEntry, slmSysLocation=slmSysLocation, slmSwRevTable=slmSwRevTable, slmChPassTable=slmChPassTable, slmTrapDestCommunity=slmTrapDestCommunity, slm40GConf=slm40GConf, slmLogFile=slmLogFile, slmTrapUserAccess=slmTrapUserAccess, slmSwRevName=slmSwRevName, slmPmAvailable=slmPmAvailable, slmAdminRowStatus=slmAdminRowStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysIpAddr=slmSysIpAddr, slmSysTemperature=slmSysTemperature, slmAdminTable=slmAdminTable, slmTid=slmTid, slmAuthLogin=slmAuthLogin, slmConfigFile=slmConfigFile, slmSysChassisId=slmSysChassisId, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogParam1=slmTrapLogParam1, slmSysCalendarTime=slmSysCalendarTime, slmSys=slmSys, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapUserLogin=slmTrapUserLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogLevel=slmSyslogLevel, slmAdminLogin=slmAdminLogin, slmSyslogDestTable=slmSyslogDestTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam5=slmTrapLogParam5, slmSysTrapFormat=slmSysTrapFormat, slmConfigSysSignalType=slmConfigSysSignalType, slmSnmpv3Auth=slmSnmpv3Auth, slmSysAlmAct=slmSysAlmAct, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysSubnetMask=slmSysSubnetMask, slmMuxNumber=slmMuxNumber, slmTopologyEnabled=slmTopologyEnabled, slmSysSnmpVersion=slmSysSnmpVersion, slmSwRevStatus=slmSwRevStatus, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassLogin=slmChPassLogin, slmTrapLogParam3=slmTrapLogParam3, slmConfigSysUptime=slmConfigSysUptime, slmAdminCommunity=slmAdminCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmSysGatewayAddr=slmSysGatewayAddr, slmSysMode=slmSysMode, slmPsuNumber=slmPsuNumber, slmAuthEntry=slmAuthEntry, slmSysOperStatus=slmSysOperStatus, slmLicenseIndex=slmLicenseIndex, slmBoxSize=slmBoxSize, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmWriteCommunity=slmWriteCommunity, slmLicenseExpiration=slmLicenseExpiration, slmAuth=slmAuth, slmPortsNumber=slmPortsNumber, slmTrapEnable=slmTrapEnable, SoftwareRevision=SoftwareRevision, slmReadCommunity=slmReadCommunity, slmAuthTable=slmAuthTable)
