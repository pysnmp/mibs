...
Bits, Integer32, NotificationType, ObjectIdentity, Gauge32, Opaque, MibIdentifier, iso, ModuleIdentity, Unsigned32, TimeTicks, Counter32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "NotificationType", "ObjectIdentity", "Gauge32", "Opaque", "MibIdentifier", "iso", "ModuleIdentity", "Unsigned32", "TimeTicks", "Counter32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestCommunity=slmTrapDestCommunity, slmSysTrapFormat=slmSysTrapFormat, slmOpticalSwitchExist=slmOpticalSwitchExist, SoftwareRevision=SoftwareRevision, slmLicenseId=slmLicenseId, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminPassword=slmAdminPassword, slmSysLocation=slmSysLocation, slmPsuNumber=slmPsuNumber, slMain=slMain, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmRstpEnabled=slmRstpEnabled, slmSysCalendarTime=slmSysCalendarTime, slmTid=slmTid, AdminAccess=AdminAccess, slmSwRevName=slmSwRevName, slmSysChassisId=slmSysChassisId, slmNetworkMode=slmNetworkMode, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapPort=slmTrapPort, slmSys=slmSys, slmSnmpv3Priv=slmSnmpv3Priv, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam3=slmTrapLogParam3, slmAuthPassword=slmAuthPassword, slmSysAdminStatus=slmSysAdminStatus, slmSyslogLevel=slmSyslogLevel, slmLicenseEntry=slmLicenseEntry, UserPassword=UserPassword, slmEdfaNumber=slmEdfaNumber, slmSwRevTable=slmSwRevTable, slmAuthTable=slmAuthTable, slmAdmin=slmAdmin, slmSwRevDate=slmSwRevDate, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam2=slmTrapLogParam2, slmSyslogPort=slmSyslogPort, slmTrapLogId=slmTrapLogId, slmSysAlmAct=slmSysAlmAct, slmBoxSize=slmBoxSize, slmTrapSysNameChange=slmTrapSysNameChange, slmAuth=slmAuth, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicense=slmLicense, slmSysMode=slmSysMode, slmSnmpv3Auth=slmSnmpv3Auth, slmSysResetPm=slmSysResetPm, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, UserLogin=UserLogin, slmSysPmStartOfDay=slmSysPmStartOfDay, slm40GConf=slm40GConf, slmAuthCommunity=slmAuthCommunity, slmSwRevEntry=slmSwRevEntry, slmTrapUserLogin=slmTrapUserLogin, slmReadCommunity=slmReadCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestTable=slmTrapDestTable, slmSysIpAddr=slmSysIpAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmOemType=slmOemType, slmConfigSysSignalType=slmConfigSysSignalType, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam5=slmTrapLogParam5, slmRebootDelay=slmRebootDelay, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapDestAddress=slmTrapDestAddress, slmLicenseIndex=slmLicenseIndex, slmAuthLogin=slmAuthLogin, slmChPassLogin=slmChPassLogin, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrap=slmTrap, slmTrapLogParam6=slmTrapLogParam6, slmTopologyEnabled=slmTopologyEnabled, slmSwRevDirectory=slmSwRevDirectory, slmAdminLogin=slmAdminLogin, slmSwRevStatus=slmSwRevStatus, slmPmAvailable=slmPmAvailable, slmLogin=slmLogin, slmLicenseExpiration=slmLicenseExpiration, slmTrapUserAccess=slmTrapUserAccess, slmVcatDelay=slmVcatDelay, slmLicenseTable=slmLicenseTable, slmChPassEntry=slmChPassEntry, slmChPass=slmChPass, slmSysLanIpAddr=slmSysLanIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysUplinkRate=slmSysUplinkRate, slmAdminAccess=slmAdminAccess, slmTrapLogTable=slmTrapLogTable, slmPortsNumber=slmPortsNumber, slmConfigSysUptime=slmConfigSysUptime, slmSysTemperature=slmSysTemperature, slmConfigFile=slmConfigFile, slmSysAlmDeact=slmSysAlmDeact, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAuthEntry=slmAuthEntry, slmWriteCommunity=slmWriteCommunity, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogName=slmTrapLogName, slmTrapLogParam1=slmTrapLogParam1, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestEntry=slmTrapDestEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogEntry=slmTrapLogEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, PYSNMP_MODULE_ID=slMain, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogDestTable=slmSyslogDestTable, slmChPassTable=slmChPassTable, UserCommunity=UserCommunity, slmLogFile=slmLogFile, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysOperStatus=slmSysOperStatus, slmAdminRowStatus=slmAdminRowStatus, slmAdminEntry=slmAdminEntry, slmAdminTable=slmAdminTable, slmTrapEnable=slmTrapEnable, slmSysSubnetMask=slmSysSubnetMask, slmAdminCommunity=slmAdminCommunity, slmSysName=slmSysName, slmChPassNewPass=slmChPassNewPass, slmMuxNumber=slmMuxNumber, slmSyslogDestAddress=slmSyslogDestAddress)
