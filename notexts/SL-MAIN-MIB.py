...
mibBuilder.exportSymbols("SL-MAIN-MIB", slMain=slMain, slmSysAdminStatus=slmSysAdminStatus, slmAdmin=slmAdmin, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysEncryptionCapability=slmSysEncryptionCapability, slmChPassOldPass=slmChPassOldPass, slmSysCalendarTime=slmSysCalendarTime, slmPortsNumber=slmPortsNumber, slmTrapDestCommunity=slmTrapDestCommunity, AdminAccess=AdminAccess, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmRebootDelay=slmRebootDelay, slmSysUplinkRate=slmSysUplinkRate, UserCommunity=UserCommunity, slmSysName=slmSysName, slmTrapDestTable=slmTrapDestTable, slmReadCommunity=slmReadCommunity, slmLicenseIndex=slmLicenseIndex, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slm40GConf=slm40GConf, slmLicense=slmLicense, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogTable=slmTrapLogTable, slmTrapDestEntry=slmTrapDestEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysTrapFormat=slmSysTrapFormat, slmTrapUserAccess=slmTrapUserAccess, slmConfigSysUptime=slmConfigSysUptime, slmRstpEnabled=slmRstpEnabled, slmTrapLogId=slmTrapLogId, slmAuthTable=slmAuthTable, slmSysAlmAct=slmSysAlmAct, PYSNMP_MODULE_ID=slMain, slmSyslogPort=slmSyslogPort, SoftwareRevision=SoftwareRevision, slmChPassLogin=slmChPassLogin, slmTrapLogParam6=slmTrapLogParam6, slmNetworkMode=slmNetworkMode, slmTrapDestIpAddress=slmTrapDestIpAddress, slmVcatDelay=slmVcatDelay, slmSysTemperature=slmSysTemperature, slmAdminTable=slmAdminTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPass=slmChPass, UserLogin=UserLogin, slmLogin=slmLogin, slmAdminPassword=slmAdminPassword, slmSysMode=slmSysMode, slmTrapLogParam1=slmTrapLogParam1, slmSwRevTable=slmSwRevTable, slmSysLocation=slmSysLocation, slmAuthPassword=slmAuthPassword, slmAdminEntry=slmAdminEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicenseId=slmLicenseId, slmSyslogDestAddress=slmSyslogDestAddress, slmSnmpv3Password=slmSnmpv3Password, slmLicenseExpiration=slmLicenseExpiration, slmBoxSize=slmBoxSize, slmSyslogDestTable=slmSyslogDestTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmPsuNumber=slmPsuNumber, slmWriteCommunity=slmWriteCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmSys=slmSys, slmAdminAccess=slmAdminAccess, slmTrapSysNameChange=slmTrapSysNameChange, slmChPassTable=slmChPassTable, slmSwRevName=slmSwRevName, slmSwRevDate=slmSwRevDate, slmLicenseTable=slmLicenseTable, slmSysSnmpVersion=slmSysSnmpVersion, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogEntry=slmTrapLogEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmChPassNewPass=slmChPassNewPass, slmChPassEntry=slmChPassEntry, slmSyslogLevel=slmSyslogLevel, slmSnmpv3Priv=slmSnmpv3Priv, slmSysLanIpAddr=slmSysLanIpAddr, slmSysOperStatus=slmSysOperStatus, slmMuxNumber=slmMuxNumber, slmTid=slmTid, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam3=slmTrapLogParam3, slmSnmpv3Auth=slmSnmpv3Auth, slmTrap=slmTrap, slmAdminRowStatus=slmAdminRowStatus, slmEdfaNumber=slmEdfaNumber, slmOemType=slmOemType, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysChassisId=slmSysChassisId, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapUserLogin=slmTrapUserLogin, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam2=slmTrapLogParam2, slmLogFile=slmLogFile, slmAdminLogin=slmAdminLogin, slmAuthLogin=slmAuthLogin, slmPmAvailable=slmPmAvailable, UserPassword=UserPassword, slmTrapEnable=slmTrapEnable, slmSysAlmDeact=slmSysAlmDeact, slmSysSubnetMask=slmSysSubnetMask, slmTopologyEnabled=slmTopologyEnabled, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysResetPm=slmSysResetPm, slmSwRevEntry=slmSwRevEntry, slmSwRevStatus=slmSwRevStatus, slmConfigFile=slmConfigFile, slmTrapCommunity=slmTrapCommunity, slmTrapLogName=slmTrapLogName, slmConfigSysSignalType=slmConfigSysSignalType, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogParam5=slmTrapLogParam5, slmAuthEntry=slmAuthEntry, slmTrapDestAddress=slmTrapDestAddress, slmTrapPort=slmTrapPort, slmAuthCommunity=slmAuthCommunity, slmLicenseEntry=slmLicenseEntry, slmAuth=slmAuth)
