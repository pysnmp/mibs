...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestAddress=slmTrapDestAddress, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthEntry=slmAuthEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevTable=slmSwRevTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmRstpEnabled=slmRstpEnabled, slmSysAlmDeact=slmSysAlmDeact, slmTrapPort=slmTrapPort, slmBoxSize=slmBoxSize, UserCommunity=UserCommunity, slmSysOperStatus=slmSysOperStatus, slmTrapLogEntry=slmTrapLogEntry, slmAdminPassword=slmAdminPassword, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPassNewPass=slmChPassNewPass, slmSyslogDestAddress=slmSyslogDestAddress, slmAuthTable=slmAuthTable, slmLicenseExpiration=slmLicenseExpiration, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmNetworkMode=slmNetworkMode, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapDestCommunity=slmTrapDestCommunity, slmAdminRowStatus=slmAdminRowStatus, UserPassword=UserPassword, slmSwRevStatus=slmSwRevStatus, slmTopologyEnabled=slmTopologyEnabled, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSyslogPort=slmSyslogPort, slmTrapSysNameChange=slmTrapSysNameChange, slmAuthLogin=slmAuthLogin, slmSnmpv3Password=slmSnmpv3Password, PYSNMP_MODULE_ID=slMain, slmSysSubnetMask=slmSysSubnetMask, slmSys=slmSys, slmChPassTable=slmChPassTable, slmAdminEntry=slmAdminEntry, slmTrapDestTable=slmTrapDestTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogParam4=slmTrapLogParam4, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogParam6=slmTrapLogParam6, slMain=slMain, slmPortsNumber=slmPortsNumber, slmTrap=slmTrap, slmPsuNumber=slmPsuNumber, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogName=slmTrapLogName, slmChPassLogin=slmChPassLogin, slmLogin=slmLogin, slmLicenseId=slmLicenseId, slmLicenseIndex=slmLicenseIndex, slmSysGatewayAddr=slmSysGatewayAddr, slmAuthPassword=slmAuthPassword, slmSysSnmpVersion=slmSysSnmpVersion, slmSnmpv3Auth=slmSnmpv3Auth, slmSysLanIpAddr=slmSysLanIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogTable=slmTrapLogTable, slmAdminTable=slmAdminTable, slmTrapUserLogin=slmTrapUserLogin, slmConfigSysUptime=slmConfigSysUptime, slmSwRevDirectory=slmSwRevDirectory, slmOemType=slmOemType, slmSysMode=slmSysMode, slmSysTemperature=slmSysTemperature, slmRebootDelay=slmRebootDelay, slmEdfaNumber=slmEdfaNumber, UserLogin=UserLogin, slmTrapDestEntry=slmTrapDestEntry, slmMuxNumber=slmMuxNumber, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminAccess=slmAdminAccess, slmTrapLogParam2=slmTrapLogParam2, SoftwareRevision=SoftwareRevision, slmSysCalendarTime=slmSysCalendarTime, slmSysResetPm=slmSysResetPm, slmAuthCommunity=slmAuthCommunity, slmAdminCommunity=slmAdminCommunity, slmSnmpv3Priv=slmSnmpv3Priv, slmChPassEntry=slmChPassEntry, slmAuth=slmAuth, AdminAccess=AdminAccess, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogDestTable=slmSyslogDestTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSwRevName=slmSwRevName, slmLicenseTable=slmLicenseTable, slmVcatDelay=slmVcatDelay, slmSwRevDate=slmSwRevDate, slmTrapLogParam1=slmTrapLogParam1, slmSyslogLevel=slmSyslogLevel, slmSysTrapFormat=slmSysTrapFormat, slmLicense=slmLicense, slmLicenseEntry=slmLicenseEntry, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogId=slmTrapLogId, slmTrapLogParam5=slmTrapLogParam5, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSwRevEntry=slmSwRevEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmSysName=slmSysName, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmReadCommunity=slmReadCommunity, slmChPassOldPass=slmChPassOldPass, slmConfigFile=slmConfigFile, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLogFile=slmLogFile, slmWriteCommunity=slmWriteCommunity, slmTid=slmTid, slmChPass=slmChPass, slmSysIpAddr=slmSysIpAddr, slm40GConf=slm40GConf, slmSysAlmAct=slmSysAlmAct, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysChassisId=slmSysChassisId, slmTrapCommunity=slmTrapCommunity, slmTrapEnable=slmTrapEnable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdmin=slmAdmin, slmSysLocation=slmSysLocation, slmAdminLogin=slmAdminLogin, slmPmAvailable=slmPmAvailable)
