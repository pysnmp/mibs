...
Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ObjectIdentity, Unsigned32, TimeTicks, Integer32, IpAddress, Gauge32, Counter32, NotificationType, Counter64, ModuleIdentity, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ObjectIdentity", "Unsigned32", "TimeTicks", "Integer32", "IpAddress", "Gauge32", "Counter32", "NotificationType", "Counter64", "ModuleIdentity", "Opaque")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicenseId=slmLicenseId, slmSysIpAddr=slmSysIpAddr, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogParam2=slmTrapLogParam2, slmSysGatewayAddr=slmSysGatewayAddr, slm40GConf=slm40GConf, slmSysAlmAct=slmSysAlmAct, slmAdminAccess=slmAdminAccess, slmChPassEntry=slmChPassEntry, slmTid=slmTid, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogName=slmTrapLogName, slmTrapLogParam1=slmTrapLogParam1, slmSwRevDirectory=slmSwRevDirectory, slmLogFile=slmLogFile, slmTrapLogParam6=slmTrapLogParam6, slmSwRevEntry=slmSwRevEntry, slmSysTrapFormat=slmSysTrapFormat, slmTrapEnable=slmTrapEnable, slmAuthLogin=slmAuthLogin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogParam3=slmTrapLogParam3, slmAdminLogin=slmAdminLogin, slmTrapUserLogin=slmTrapUserLogin, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevTable=slmSwRevTable, slmChPassOldPass=slmChPassOldPass, slmAuthTable=slmAuthTable, slmRstpEnabled=slmRstpEnabled, slmPmAvailable=slmPmAvailable, slmAuthEntry=slmAuthEntry, slmSwRevStatus=slmSwRevStatus, UserPassword=UserPassword, slmSysActiveSwVersion=slmSysActiveSwVersion, slmOemType=slmOemType, slmLogin=slmLogin, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, AdminAccess=AdminAccess, slmSysSnmpVersion=slmSysSnmpVersion, slmRebootDelay=slmRebootDelay, slmTrapDestEntry=slmTrapDestEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmMuxNumber=slmMuxNumber, slmTrapLogParam4=slmTrapLogParam4, slmSyslogLevel=slmSyslogLevel, slmConfigFile=slmConfigFile, slmChPass=slmChPass, slmTrapLogParam5=slmTrapLogParam5, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminEntry=slmAdminEntry, slmTopologyEnabled=slmTopologyEnabled, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminRowStatus=slmAdminRowStatus, slmSysOperStatus=slmSysOperStatus, slmTrapLogEntry=slmTrapLogEntry, slmSysChassisId=slmSysChassisId, slmSyslogPort=slmSyslogPort, slmAuth=slmAuth, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmNetworkMode=slmNetworkMode, slmSysCalendarTime=slmSysCalendarTime, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSys=slmSys, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicense=slmLicense, slmSysAlmDeact=slmSysAlmDeact, slmSyslogDestAddress=slmSyslogDestAddress, slmLicenseEntry=slmLicenseEntry, slmSysTemperature=slmSysTemperature, slmSnmpv3Password=slmSnmpv3Password, slmVcatDelay=slmVcatDelay, UserLogin=UserLogin, slmPortsNumber=slmPortsNumber, UserCommunity=UserCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogTimeStamp=slmTrapLogTimeStamp, PYSNMP_MODULE_ID=slMain, slmTrapSysNameChange=slmTrapSysNameChange, slmReadCommunity=slmReadCommunity, slmTrapDestProtVersion=slmTrapDestProtVersion, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysResetPm=slmSysResetPm, slmChPassLogin=slmChPassLogin, slmSysName=slmSysName, slmSysUplinkRate=slmSysUplinkRate, slmTrapCommunity=slmTrapCommunity, slmTrapDestAddress=slmTrapDestAddress, slmTrapUserAccess=slmTrapUserAccess, slmChPassTable=slmChPassTable, slmLicenseIndex=slmLicenseIndex, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestTable=slmTrapDestTable, slmSwRevName=slmSwRevName, slmTrapLogTable=slmTrapLogTable, slmSysSubnetMask=slmSysSubnetMask, slmLicenseExpiration=slmLicenseExpiration, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapPort=slmTrapPort, slmTrap=slmTrap, slmAdminCommunity=slmAdminCommunity, slmSwRevDate=slmSwRevDate, slmPsuNumber=slmPsuNumber, slmBoxSize=slmBoxSize, SoftwareRevision=SoftwareRevision, slMain=slMain, slmWriteCommunity=slmWriteCommunity, slmTrapLogId=slmTrapLogId, slmSysLanIpAddr=slmSysLanIpAddr, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminTable=slmAdminTable, slmSysLocation=slmSysLocation, slmSyslogDestTable=slmSyslogDestTable, slmAdminPassword=slmAdminPassword, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuthPassword=slmAuthPassword, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAuthCommunity=slmAuthCommunity, slmChPassNewPass=slmChPassNewPass, slmSysMode=slmSysMode, slmEdfaNumber=slmEdfaNumber, slmLicenseTable=slmLicenseTable, slmAdmin=slmAdmin, slmConfigSysUptime=slmConfigSysUptime)
