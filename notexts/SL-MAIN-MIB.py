...
Counter32, ModuleIdentity, MibIdentifier, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, Opaque, iso, NotificationType, Bits, IpAddress, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "Opaque", "iso", "NotificationType", "Bits", "IpAddress", "Unsigned32", "Counter64")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysName=slmSysName, slmLogin=slmLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysUplinkRate=slmSysUplinkRate, slmAdminPassword=slmAdminPassword, slmTrap=slmTrap, slmSysTrapFormat=slmSysTrapFormat, UserLogin=UserLogin, slmSyslogPort=slmSyslogPort, slmLicenseEntry=slmLicenseEntry, slmSwRevEntry=slmSwRevEntry, slmSyslogDestTable=slmSyslogDestTable, slmSysGatewayAddr=slmSysGatewayAddr, slmMuxNumber=slmMuxNumber, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysOperStatus=slmSysOperStatus, slmTrapDestCommunity=slmTrapDestCommunity, slmSysSnmpVersion=slmSysSnmpVersion, slmNetworkMode=slmNetworkMode, slmTrapEnable=slmTrapEnable, slmOemType=slmOemType, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmChPassEntry=slmChPassEntry, slmBoxSize=slmBoxSize, slmPmAvailable=slmPmAvailable, slmSysCalendarTime=slmSysCalendarTime, slmAdmin=slmAdmin, slmLogFile=slmLogFile, slmAuthTable=slmAuthTable, slmLicense=slmLicense, slmConfigSysUptime=slmConfigSysUptime, slmSysAlmAct=slmSysAlmAct, slmSysAdminStatus=slmSysAdminStatus, slmSysAlmDeact=slmSysAlmDeact, slmAdminCommunity=slmAdminCommunity, slmAuthLogin=slmAuthLogin, slmLicenseIndex=slmLicenseIndex, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam3=slmTrapLogParam3, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPassOldPass=slmChPassOldPass, slmTrapDestTable=slmTrapDestTable, slmAuthCommunity=slmAuthCommunity, slmTrapLogParam6=slmTrapLogParam6, UserPassword=UserPassword, slmSysIpAddr=slmSysIpAddr, slmSwRevDate=slmSwRevDate, slmRstpEnabled=slmRstpEnabled, slmAdminTable=slmAdminTable, slmSysChassisId=slmSysChassisId, slmSysTemperature=slmSysTemperature, slmOpticalSwitchExist=slmOpticalSwitchExist, slmPortsNumber=slmPortsNumber, slmTrapLogTable=slmTrapLogTable, slmSys=slmSys, slmSnmpv3Priv=slmSnmpv3Priv, slmLicenseExpiration=slmLicenseExpiration, slmTid=slmTid, slmAuthPassword=slmAuthPassword, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicenseTable=slmLicenseTable, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam5=slmTrapLogParam5, slmTrapDestEntry=slmTrapDestEntry, slmAuthEntry=slmAuthEntry, slmAuth=slmAuth, slmSwRevTable=slmSwRevTable, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam4=slmTrapLogParam4, slmChPassNewPass=slmChPassNewPass, slmChPassTable=slmChPassTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogEntry=slmTrapLogEntry, slmVcatDelay=slmVcatDelay, slmConfigFile=slmConfigFile, slmSysMode=slmSysMode, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmPsuNumber=slmPsuNumber, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogName=slmTrapLogName, UserCommunity=UserCommunity, slmSwRevDirectory=slmSwRevDirectory, slmAdminLogin=slmAdminLogin, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysLocation=slmSysLocation, slmLicenseId=slmLicenseId, slmSysResetPm=slmSysResetPm, slmTrapSysNameChange=slmTrapSysNameChange, slmChPassLogin=slmChPassLogin, slmChPass=slmChPass, SoftwareRevision=SoftwareRevision, AdminAccess=AdminAccess, slmSwRevName=slmSwRevName, slmSwRevStatus=slmSwRevStatus, slmAdminAccess=slmAdminAccess, slmSyslogLevel=slmSyslogLevel, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogId=slmTrapLogId, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slMain=slMain, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestAddress=slmTrapDestAddress, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLanIpAddr=slmSysLanIpAddr, PYSNMP_MODULE_ID=slMain, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmRebootDelay=slmRebootDelay, slmWriteCommunity=slmWriteCommunity, slmTrapUserLogin=slmTrapUserLogin, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapCommunity=slmTrapCommunity, slmTrapDestProtVersion=slmTrapDestProtVersion, slmReadCommunity=slmReadCommunity, slmAdminEntry=slmAdminEntry, slmTrapPort=slmTrapPort, slm40GConf=slm40GConf, slmTrapLogParam1=slmTrapLogParam1, slmAdminRowStatus=slmAdminRowStatus, slmSysSubnetMask=slmSysSubnetMask)
