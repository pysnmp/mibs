...
Integer32, ModuleIdentity, MibIdentifier, ObjectIdentity, Unsigned32, Bits, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, Counter64, iso, IpAddress, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "Unsigned32", "Bits", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "Counter64", "iso", "IpAddress", "Opaque")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmWriteCommunity=slmWriteCommunity, slmTrapUserLogin=slmTrapUserLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminCommunity=slmAdminCommunity, slmChPassOldPass=slmChPassOldPass, slmAdminLogin=slmAdminLogin, slmSysAlmAct=slmSysAlmAct, slmTrapLogTable=slmTrapLogTable, slmSysSnmpVersion=slmSysSnmpVersion, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassEntry=slmChPassEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmChPassLogin=slmChPassLogin, slmLicenseIndex=slmLicenseIndex, slmLogFile=slmLogFile, slmAuth=slmAuth, slmSysGatewayAddr=slmSysGatewayAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogPort=slmSyslogPort, slmSysAdminStatus=slmSysAdminStatus, UserPassword=UserPassword, slmLogin=slmLogin, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysTemperature=slmSysTemperature, slmSyslogDestTable=slmSyslogDestTable, slmEdfaNumber=slmEdfaNumber, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseId=slmLicenseId, slmSysUplinkRate=slmSysUplinkRate, slmSys=slmSys, UserCommunity=UserCommunity, slmAdminEntry=slmAdminEntry, slmLicenseExpiration=slmLicenseExpiration, PYSNMP_MODULE_ID=slMain, slmTrapUserAccess=slmTrapUserAccess, slmAdminRowStatus=slmAdminRowStatus, slmSwRevDate=slmSwRevDate, slmPsuNumber=slmPsuNumber, slmAuthCommunity=slmAuthCommunity, slmLicenseTable=slmLicenseTable, slm40GConf=slm40GConf, slmChPassTable=slmChPassTable, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam2=slmTrapLogParam2, slmLicense=slmLicense, slmAdminTable=slmAdminTable, slmTrapDestCommunity=slmTrapDestCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysTrapFormat=slmSysTrapFormat, slmNetworkMode=slmNetworkMode, slmTrapPort=slmTrapPort, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSwRevDirectory=slmSwRevDirectory, slmAuthPassword=slmAuthPassword, slmVcatDelay=slmVcatDelay, slmSyslogLevel=slmSyslogLevel, slmPmAvailable=slmPmAvailable, AdminAccess=AdminAccess, slmConfigFile=slmConfigFile, slmAdminAccess=slmAdminAccess, slmSysAlmDeact=slmSysAlmDeact, UserLogin=UserLogin, slmSysName=slmSysName, slmTrapLogEntry=slmTrapLogEntry, slmSnmpv3Password=slmSnmpv3Password, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogName=slmTrapLogName, slmTrapLogParam6=slmTrapLogParam6, slmTrapCommunity=slmTrapCommunity, slmSysOperStatus=slmSysOperStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmRebootDelay=slmRebootDelay, slmSnmpv3Priv=slmSnmpv3Priv, slmSysLocation=slmSysLocation, slmTrap=slmTrap, slmMuxNumber=slmMuxNumber, SoftwareRevision=SoftwareRevision, slmAuthEntry=slmAuthEntry, slmSysResetPm=slmSysResetPm, slmReadCommunity=slmReadCommunity, slmTrapLogParam1=slmTrapLogParam1, slmSwRevName=slmSwRevName, slmAdmin=slmAdmin, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmPortsNumber=slmPortsNumber, slmTrapEnable=slmTrapEnable, slmChPassNewPass=slmChPassNewPass, slmAuthLogin=slmAuthLogin, slmTrapLogParam3=slmTrapLogParam3, slmRstpEnabled=slmRstpEnabled, slmTrapLogParam4=slmTrapLogParam4, slmSysLanIpAddr=slmSysLanIpAddr, slmSysChassisId=slmSysChassisId, slmTrapLogParam5=slmTrapLogParam5, slmChPass=slmChPass, slmTrapLogId=slmTrapLogId, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevTable=slmSwRevTable, slmSysMode=slmSysMode, slmSwRevEntry=slmSwRevEntry, slmConfigSysUptime=slmConfigSysUptime, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicenseEntry=slmLicenseEntry, slmTopologyEnabled=slmTopologyEnabled, slmOemType=slmOemType, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapDestTable=slmTrapDestTable, slmSysIpAddr=slmSysIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminPassword=slmAdminPassword, slMain=slMain, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAuthTable=slmAuthTable, slmTrapDestAddress=slmTrapDestAddress, slmBoxSize=slmBoxSize, slmSwRevStatus=slmSwRevStatus, slmTrapDestEntry=slmTrapDestEntry, slmTid=slmTid)
