...
Bits, NotificationType, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, Counter32, TimeTicks, IpAddress, Unsigned32, Gauge32, ModuleIdentity, MibIdentifier, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "Counter32", "TimeTicks", "IpAddress", "Unsigned32", "Gauge32", "ModuleIdentity", "MibIdentifier", "Opaque")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSwRevTable=slmSwRevTable, slmSysResetPm=slmSysResetPm, slmMuxNumber=slmMuxNumber, UserLogin=UserLogin, slMain=slMain, slmSysName=slmSysName, slmLogin=slmLogin, slmAuthPassword=slmAuthPassword, UserCommunity=UserCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSwRevEntry=slmSwRevEntry, slmLicenseEntry=slmLicenseEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmPsuNumber=slmPsuNumber, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogTable=slmTrapLogTable, slmChPassEntry=slmChPassEntry, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam5=slmTrapLogParam5, slmLogFile=slmLogFile, slmAdminRowStatus=slmAdminRowStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogLevel=slmSyslogLevel, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmOemType=slmOemType, slmTid=slmTid, slmSwRevDate=slmSwRevDate, slmTrapUserLogin=slmTrapUserLogin, slmSysMode=slmSysMode, slmSwRevStatus=slmSwRevStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSnmpv3Password=slmSnmpv3Password, slmSysUplinkRate=slmSysUplinkRate, slmRstpEnabled=slmRstpEnabled, slmConfigSysSignalType=slmConfigSysSignalType, slmChPassLogin=slmChPassLogin, slmSwRevDirectory=slmSwRevDirectory, slmNetworkMode=slmNetworkMode, PYSNMP_MODULE_ID=slMain, slmSysChassisId=slmSysChassisId, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestEntry=slmTrapDestEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmSysGatewayAddr=slmSysGatewayAddr, slmAuthEntry=slmAuthEntry, slmTrapCommunity=slmTrapCommunity, slmSyslogPort=slmSyslogPort, slmConfigSysUptime=slmConfigSysUptime, slmSys=slmSys, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam1=slmTrapLogParam1, slmSysAdminStatus=slmSysAdminStatus, slmSysSubnetMask=slmSysSubnetMask, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminAccess=slmAdminAccess, slmLicenseTable=slmLicenseTable, slmLicense=slmLicense, slmSyslogDestAddress=slmSyslogDestAddress, slmLicenseIndex=slmLicenseIndex, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseExpiration=slmLicenseExpiration, slmSysIpAddr=slmSysIpAddr, slmSysOperStatus=slmSysOperStatus, slmPmAvailable=slmPmAvailable, slmAdmin=slmAdmin, slmPortsNumber=slmPortsNumber, slmAuthCommunity=slmAuthCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogDestTable=slmSyslogDestTable, slmConfigFile=slmConfigFile, slmTrapLogId=slmTrapLogId, slmAuth=slmAuth, slmSysAlmDeact=slmSysAlmDeact, slmTrapEnable=slmTrapEnable, slmTrapLogParam3=slmTrapLogParam3, slmAdminLogin=slmAdminLogin, slmAdminTable=slmAdminTable, slmEdfaNumber=slmEdfaNumber, slmRebootDelay=slmRebootDelay, slmAdminEntry=slmAdminEntry, SoftwareRevision=SoftwareRevision, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSnmpv3Auth=slmSnmpv3Auth, AdminAccess=AdminAccess, slmLicenseId=slmLicenseId, slmSyslogDestEntry=slmSyslogDestEntry, slmTopologyEnabled=slmTopologyEnabled, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapUserAccess=slmTrapUserAccess, slmChPassTable=slmChPassTable, slmVcatDelay=slmVcatDelay, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogName=slmTrapLogName, slmAdminPassword=slmAdminPassword, slmAuthLogin=slmAuthLogin, slmAuthTable=slmAuthTable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrap=slmTrap, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysLocation=slmSysLocation, slmSysTemperature=slmSysTemperature, slmReadCommunity=slmReadCommunity, slmSysAlmAct=slmSysAlmAct, slmBoxSize=slmBoxSize, slmTrapDestAddress=slmTrapDestAddress, UserPassword=UserPassword, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassNewPass=slmChPassNewPass, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapPort=slmTrapPort, slmChPass=slmChPass, slmSwRevName=slmSwRevName, slm40GConf=slm40GConf, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam4=slmTrapLogParam4, slmAdminCommunity=slmAdminCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSnmpv3Priv=slmSnmpv3Priv, slmChPassOldPass=slmChPassOldPass)
