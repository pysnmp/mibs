...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogParam3=slmTrapLogParam3, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestEntry=slmTrapDestEntry, slmTrap=slmTrap, slmBoxSize=slmBoxSize, slmSnmpv3Password=slmSnmpv3Password, slMain=slMain, slmTrapLogParam5=slmTrapLogParam5, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam6=slmTrapLogParam6, slmAuthLogin=slmAuthLogin, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicenseIndex=slmLicenseIndex, slmAdminRowStatus=slmAdminRowStatus, PYSNMP_MODULE_ID=slMain, slmSysTemperature=slmSysTemperature, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysChassisId=slmSysChassisId, slmPortsNumber=slmPortsNumber, slmAdmin=slmAdmin, slmSysAlmDeact=slmSysAlmDeact, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogId=slmTrapLogId, slm40GConf=slm40GConf, slmLicenseTable=slmLicenseTable, slmTrapDestCommunity=slmTrapDestCommunity, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSwRevStatus=slmSwRevStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevName=slmSwRevName, slmAdminCommunity=slmAdminCommunity, slmOemType=slmOemType, slmTrapLogEntry=slmTrapLogEntry, slmNetworkMode=slmNetworkMode, slmTid=slmTid, slmWriteCommunity=slmWriteCommunity, slmSwRevDate=slmSwRevDate, slmLicenseEntry=slmLicenseEntry, slmAdminTable=slmAdminTable, slmTrapEnable=slmTrapEnable, slmAdminLogin=slmAdminLogin, slmAuthPassword=slmAuthPassword, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysName=slmSysName, slmSysLocation=slmSysLocation, slmRebootDelay=slmRebootDelay, slmTrapSysNameChange=slmTrapSysNameChange, SoftwareRevision=SoftwareRevision, slmSyslogPort=slmSyslogPort, slmSysIpAddr=slmSysIpAddr, UserLogin=UserLogin, slmChPassTable=slmChPassTable, slmSysUplinkRate=slmSysUplinkRate, slmAuthCommunity=slmAuthCommunity, slmAuthEntry=slmAuthEntry, slmTopologyEnabled=slmTopologyEnabled, slmLicenseExpiration=slmLicenseExpiration, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminEntry=slmAdminEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmLogFile=slmLogFile, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPassEntry=slmChPassEntry, slmSys=slmSys, slmVcatDelay=slmVcatDelay, slmLogin=slmLogin, slmLicenseId=slmLicenseId, slmSwRevDirectory=slmSwRevDirectory, slmOpticalSwitchExist=slmOpticalSwitchExist, slmConfigSysSignalType=slmConfigSysSignalType, slmSysPmStartOfDay=slmSysPmStartOfDay, slmReadCommunity=slmReadCommunity, slmTrapCommunity=slmTrapCommunity, slmTrapUserAccess=slmTrapUserAccess, UserCommunity=UserCommunity, slmRstpEnabled=slmRstpEnabled, slmChPassLogin=slmChPassLogin, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogParam1=slmTrapLogParam1, slmPmAvailable=slmPmAvailable, slmSyslogDestEntry=slmSyslogDestEntry, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam4=slmTrapLogParam4, slmChPassOldPass=slmChPassOldPass, slmSysLanIpAddr=slmSysLanIpAddr, slmPsuNumber=slmPsuNumber, slmSysAdminStatus=slmSysAdminStatus, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogTable=slmTrapLogTable, slmSysMode=slmSysMode, AdminAccess=AdminAccess, slmTrapLogParam2=slmTrapLogParam2, slmTrapPort=slmTrapPort, slmSyslogLevel=slmSyslogLevel, slmChPassNewPass=slmChPassNewPass, slmLicense=slmLicense, slmEdfaNumber=slmEdfaNumber, slmSysCalendarTime=slmSysCalendarTime, slmSnmpv3Auth=slmSnmpv3Auth, UserPassword=UserPassword, slmSysEncryptionCapability=slmSysEncryptionCapability, slmMuxNumber=slmMuxNumber, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminAccess=slmAdminAccess, slmConfigFile=slmConfigFile, slmSysResetPm=slmSysResetPm, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPass=slmChPass, slmTrapLogName=slmTrapLogName, slmSysAlmAct=slmSysAlmAct, slmAuthTable=slmAuthTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSyslogDestTable=slmSyslogDestTable, slmSysSubnetMask=slmSysSubnetMask, slmSysGatewayAddr=slmSysGatewayAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevTable=slmSwRevTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysOperStatus=slmSysOperStatus, slmAuth=slmAuth, slmAdminPassword=slmAdminPassword, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSwRevEntry=slmSwRevEntry, slmTrapUserLogin=slmTrapUserLogin)
