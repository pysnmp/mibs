...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogParam4=slmTrapLogParam4, slmSysOperStatus=slmSysOperStatus, slmTrapEnable=slmTrapEnable, slmAuthCommunity=slmAuthCommunity, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestEntry=slmTrapDestEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSnmpv3Auth=slmSnmpv3Auth, AdminAccess=AdminAccess, slmTrap=slmTrap, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestRowStatus=slmTrapDestRowStatus, UserPassword=UserPassword, slmOemType=slmOemType, slmSyslogDestTable=slmSyslogDestTable, slmLicenseTable=slmLicenseTable, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapDestAddress=slmTrapDestAddress, slmSysSnmpVersion=slmSysSnmpVersion, slmSysMode=slmSysMode, slmWriteCommunity=slmWriteCommunity, slmPmAvailable=slmPmAvailable, slmTrapDestTable=slmTrapDestTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmChPassLogin=slmChPassLogin, slmSwRevDate=slmSwRevDate, slmSnmpv3Priv=slmSnmpv3Priv, slmAuthPassword=slmAuthPassword, slmSysChassisId=slmSysChassisId, slmSwRevEntry=slmSwRevEntry, slmAdminEntry=slmAdminEntry, slmTrapLogParam5=slmTrapLogParam5, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapUserAccess=slmTrapUserAccess, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSyslogLevel=slmSyslogLevel, slmTrapLogName=slmTrapLogName, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogEntry=slmTrapLogEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, UserLogin=UserLogin, slmSysUplinkRate=slmSysUplinkRate, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuthTable=slmAuthTable, slmRstpEnabled=slmRstpEnabled, slmSyslogDestEntry=slmSyslogDestEntry, slmNetworkMode=slmNetworkMode, slmVcatDelay=slmVcatDelay, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuthEntry=slmAuthEntry, slmSysTemperature=slmSysTemperature, slmConfigSysSignalType=slmConfigSysSignalType, slmSysLocation=slmSysLocation, slmBoxSize=slmBoxSize, slmRebootDelay=slmRebootDelay, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminCommunity=slmAdminCommunity, slmChPassTable=slmChPassTable, slmSysCalendarTime=slmSysCalendarTime, slmSnmpv3Password=slmSnmpv3Password, slmAuth=slmAuth, slMain=slMain, slmLogin=slmLogin, slmLicenseIndex=slmLicenseIndex, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPass=slmChPass, slmPortsNumber=slmPortsNumber, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLicense=slmLicense, slmSyslogDestAddress=slmSyslogDestAddress, slmAuthLogin=slmAuthLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogParam3=slmTrapLogParam3, slmPsuNumber=slmPsuNumber, slmTrapCommunity=slmTrapCommunity, slmSysAdminStatus=slmSysAdminStatus, slmLicenseEntry=slmLicenseEntry, slmLicenseId=slmLicenseId, slmSwRevName=slmSwRevName, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slm40GConf=slm40GConf, slmTrapLogId=slmTrapLogId, slmReadCommunity=slmReadCommunity, slmSysResetPm=slmSysResetPm, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTid=slmTid, slmAdmin=slmAdmin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogTable=slmTrapLogTable, slmAdminLogin=slmAdminLogin, slmOpticalSwitchExist=slmOpticalSwitchExist, SoftwareRevision=SoftwareRevision, slmTrapLogParam1=slmTrapLogParam1, slmAdminAccess=slmAdminAccess, slmSysGatewayAddr=slmSysGatewayAddr, slmSyslogPort=slmSyslogPort, slmTrapLogParam6=slmTrapLogParam6, slmSysName=slmSysName, slmLicenseExpiration=slmLicenseExpiration, slmLogFile=slmLogFile, slmAdminTable=slmAdminTable, slmChPassNewPass=slmChPassNewPass, slmChPassEntry=slmChPassEntry, slmTopologyEnabled=slmTopologyEnabled, slmConfigFile=slmConfigFile, slmSwRevStatus=slmSwRevStatus, slmSwRevTable=slmSwRevTable, slmAdminPassword=slmAdminPassword, PYSNMP_MODULE_ID=slMain, slmSysAlmDeact=slmSysAlmDeact, slmTrapPort=slmTrapPort, slmTrapDestCommunity=slmTrapDestCommunity, slmChPassOldPass=slmChPassOldPass, slmSwRevDirectory=slmSwRevDirectory, UserCommunity=UserCommunity, slmAdminRowStatus=slmAdminRowStatus, slmSysAlmAct=slmSysAlmAct, slmMuxNumber=slmMuxNumber, slmTrapUserLogin=slmTrapUserLogin, slmSysIpAddr=slmSysIpAddr, slmSys=slmSys, slmSysTrapFormat=slmSysTrapFormat)
