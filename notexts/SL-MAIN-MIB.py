...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysMode=slmSysMode, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam4=slmTrapLogParam4, slmConfigSysSignalType=slmConfigSysSignalType, slmChPassTable=slmChPassTable, slmTrapLogParam2=slmTrapLogParam2, slmLicenseTable=slmLicenseTable, slmSysAlmAct=slmSysAlmAct, slmAdminLogin=slmAdminLogin, slmTrapLogId=slmTrapLogId, slmLicenseEntry=slmLicenseEntry, slmSwRevName=slmSwRevName, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogTable=slmTrapLogTable, slmLicenseId=slmLicenseId, slmSwRevDate=slmSwRevDate, slmChPassEntry=slmChPassEntry, slmSysName=slmSysName, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogParam3=slmTrapLogParam3, slmChPassOldPass=slmChPassOldPass, slmOemType=slmOemType, slmSysAlmDeact=slmSysAlmDeact, UserLogin=UserLogin, slmRebootDelay=slmRebootDelay, slmWriteCommunity=slmWriteCommunity, slmTrap=slmTrap, slmSysTemperature=slmSysTemperature, slmAuthTable=slmAuthTable, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogParam1=slmTrapLogParam1, slMain=slMain, slmTrapDestCommunity=slmTrapDestCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogPort=slmSyslogPort, slmReadCommunity=slmReadCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTid=slmTid, slmSysSubnetMask=slmSysSubnetMask, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogName=slmTrapLogName, slmEdfaNumber=slmEdfaNumber, SoftwareRevision=SoftwareRevision, slm40GConf=slm40GConf, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAuthLogin=slmAuthLogin, slmNetworkMode=slmNetworkMode, slmMuxNumber=slmMuxNumber, slmConfigFile=slmConfigFile, UserPassword=UserPassword, slmSysAdminStatus=slmSysAdminStatus, slmSysIpAddr=slmSysIpAddr, slmChPassNewPass=slmChPassNewPass, slmTrapLogParam6=slmTrapLogParam6, slmAdminCommunity=slmAdminCommunity, slmAdminTable=slmAdminTable, slmAdminEntry=slmAdminEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmAuthPassword=slmAuthPassword, slmSyslogDestEntry=slmSyslogDestEntry, slmSysLocation=slmSysLocation, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmBoxSize=slmBoxSize, slmLogin=slmLogin, UserCommunity=UserCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, slmChPass=slmChPass, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapUserLogin=slmTrapUserLogin, slmTrapEnable=slmTrapEnable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmPmAvailable=slmPmAvailable, slmAdminRowStatus=slmAdminRowStatus, slmOpticalSwitchExist=slmOpticalSwitchExist, PYSNMP_MODULE_ID=slMain, slmVcatDelay=slmVcatDelay, slmPortsNumber=slmPortsNumber, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAuthEntry=slmAuthEntry, slmTrapDestEntry=slmTrapDestEntry, slmSyslogLevel=slmSyslogLevel, slmSys=slmSys, slmAuthCommunity=slmAuthCommunity, slmTrapLogEntry=slmTrapLogEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminAccess=slmAdminAccess, slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevEntry=slmSwRevEntry, slmTrapPort=slmTrapPort, slmSnmpv3Password=slmSnmpv3Password, slmLogFile=slmLogFile, slmAdminPassword=slmAdminPassword, slmLicenseExpiration=slmLicenseExpiration, slmLicense=slmLicense, slmSwRevStatus=slmSwRevStatus, slmSnmpv3Auth=slmSnmpv3Auth, slmSysOperStatus=slmSysOperStatus, slmRstpEnabled=slmRstpEnabled, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysResetPm=slmSysResetPm, slmTopologyEnabled=slmTopologyEnabled, slmSysCalendarTime=slmSysCalendarTime, slmAdmin=slmAdmin, slmPsuNumber=slmPsuNumber, slmAuth=slmAuth, slmSyslogDestTable=slmSyslogDestTable, slmLicenseIndex=slmLicenseIndex, AdminAccess=AdminAccess, slmTrapDestAddress=slmTrapDestAddress, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysUplinkRate=slmSysUplinkRate, slmChPassLogin=slmChPassLogin, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapCommunity=slmTrapCommunity, slmConfigSysUptime=slmConfigSysUptime, slmSwRevDirectory=slmSwRevDirectory, slmSysChassisId=slmSysChassisId, slmSwRevTable=slmSwRevTable)
