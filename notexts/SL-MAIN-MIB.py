...
Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, Opaque, iso, ModuleIdentity, Counter64, Unsigned32, MibIdentifier, Counter32, Gauge32, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "Opaque", "iso", "ModuleIdentity", "Counter64", "Unsigned32", "MibIdentifier", "Counter32", "Gauge32", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSwRevName=slmSwRevName, SoftwareRevision=SoftwareRevision, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam3=slmTrapLogParam3, slmSysLanIpAddr=slmSysLanIpAddr, slmRebootDelay=slmRebootDelay, slmAuthLogin=slmAuthLogin, slmSwRevEntry=slmSwRevEntry, slmLogin=slmLogin, slmSysMode=slmSysMode, slmTrapLogId=slmTrapLogId, slmSwRevDirectory=slmSwRevDirectory, slm40GConf=slm40GConf, slmBoxSize=slmBoxSize, UserPassword=UserPassword, slmChPassLogin=slmChPassLogin, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestTable=slmTrapDestTable, slmAuthCommunity=slmAuthCommunity, slmTrapDestCommunity=slmTrapDestCommunity, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminAccess=slmAdminAccess, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysName=slmSysName, slmSysCalendarTime=slmSysCalendarTime, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam1=slmTrapLogParam1, slmTid=slmTid, slmAdminLogin=slmAdminLogin, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAuthEntry=slmAuthEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevDate=slmSwRevDate, slmReadCommunity=slmReadCommunity, slmEdfaNumber=slmEdfaNumber, slmSysTemperature=slmSysTemperature, slmSwRevTable=slmSwRevTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmPmAvailable=slmPmAvailable, slmConfigSysUptime=slmConfigSysUptime, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthTable=slmAuthTable, slmSysAlmDeact=slmSysAlmDeact, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapUserAccess=slmTrapUserAccess, slmLicenseExpiration=slmLicenseExpiration, PYSNMP_MODULE_ID=slMain, slmAuthPassword=slmAuthPassword, slmPsuNumber=slmPsuNumber, slmLicenseTable=slmLicenseTable, slmSysLocation=slmSysLocation, slmTrapLogParam4=slmTrapLogParam4, slmWriteCommunity=slmWriteCommunity, slmTrapLogName=slmTrapLogName, slmSysResetPm=slmSysResetPm, slmSyslogDestEntry=slmSyslogDestEntry, slmChPassEntry=slmChPassEntry, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogParam6=slmTrapLogParam6, slmSysGatewayAddr=slmSysGatewayAddr, slmChPass=slmChPass, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSnmpv3Priv=slmSnmpv3Priv, slmSysChassisId=slmSysChassisId, slmSysAlmAct=slmSysAlmAct, slmAdminEntry=slmAdminEntry, AdminAccess=AdminAccess, slmAuth=slmAuth, slmSysUplinkRate=slmSysUplinkRate, slmTrapDestEntry=slmTrapDestEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmLicense=slmLicense, slmSysAdminStatus=slmSysAdminStatus, slmSwRevStatus=slmSwRevStatus, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmVcatDelay=slmVcatDelay, slmTopologyEnabled=slmTopologyEnabled, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminCommunity=slmAdminCommunity, slmSyslogLevel=slmSyslogLevel, slmAdmin=slmAdmin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysOperStatus=slmSysOperStatus, slmAdminPassword=slmAdminPassword, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogEntry=slmTrapLogEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapPort=slmTrapPort, slmPortsNumber=slmPortsNumber, slmOpticalSwitchExist=slmOpticalSwitchExist, slmRstpEnabled=slmRstpEnabled, slmLicenseIndex=slmLicenseIndex, slmConfigFile=slmConfigFile, slmLicenseId=slmLicenseId, slmNetworkMode=slmNetworkMode, slMain=slMain, UserCommunity=UserCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSyslogDestAddress=slmSyslogDestAddress, slmMuxNumber=slmMuxNumber, slmTrapEnable=slmTrapEnable, slmTrapUserLogin=slmTrapUserLogin, slmSyslogPort=slmSyslogPort, slmTrapCommunity=slmTrapCommunity, slmSysIpAddr=slmSysIpAddr, slmChPassOldPass=slmChPassOldPass, slmLicenseEntry=slmLicenseEntry, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestTable=slmSyslogDestTable, UserLogin=UserLogin, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapSysNameChange=slmTrapSysNameChange, slmOemType=slmOemType, slmTrap=slmTrap, slmSysTrapFormat=slmSysTrapFormat, slmChPassNewPass=slmChPassNewPass, slmLogFile=slmLogFile, slmChPassTable=slmChPassTable, slmAdminTable=slmAdminTable, slmTrapLogParam5=slmTrapLogParam5, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSys=slmSys, slmSysSubnetMask=slmSysSubnetMask)
