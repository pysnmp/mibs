...
ObjectIdentity, Gauge32, Opaque, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, IpAddress, NotificationType, Counter32, TimeTicks, Unsigned32, ModuleIdentity, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "Opaque", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "IpAddress", "NotificationType", "Counter32", "TimeTicks", "Unsigned32", "ModuleIdentity", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLogin=slmLogin, slmVcatDelay=slmVcatDelay, slmChPassLogin=slmChPassLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseTable=slmLicenseTable, slmSysTrapFormat=slmSysTrapFormat, slmSysUplinkRate=slmSysUplinkRate, slmSwRevName=slmSwRevName, slmSnmpv3Password=slmSnmpv3Password, slmAuth=slmAuth, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAuthTable=slmAuthTable, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogParam5=slmTrapLogParam5, slmSwRevDirectory=slmSwRevDirectory, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmEdfaNumber=slmEdfaNumber, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysCalendarTime=slmSysCalendarTime, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysIpAddr=slmSysIpAddr, slmSysName=slmSysName, slmLicenseIndex=slmLicenseIndex, slmTrapEnable=slmTrapEnable, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogEntry=slmTrapLogEntry, slmLicense=slmLicense, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysLocation=slmSysLocation, slmChPassTable=slmChPassTable, slmOemType=slmOemType, slmTrapDestEntry=slmTrapDestEntry, slmAdminLogin=slmAdminLogin, slmAdminCommunity=slmAdminCommunity, UserPassword=UserPassword, slmTrapLogParam6=slmTrapLogParam6, slmTrap=slmTrap, slmSys=slmSys, slmRebootDelay=slmRebootDelay, SoftwareRevision=SoftwareRevision, slmAdminAccess=slmAdminAccess, slmAuthEntry=slmAuthEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAdmin=slmAdmin, slmSyslogDestEntry=slmSyslogDestEntry, slmBoxSize=slmBoxSize, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogTable=slmTrapLogTable, slmSyslogLevel=slmSyslogLevel, slmMuxNumber=slmMuxNumber, slMain=slMain, slmTrapLogParam3=slmTrapLogParam3, slmSysGatewayAddr=slmSysGatewayAddr, slmSyslogPort=slmSyslogPort, UserLogin=UserLogin, slmTrapPort=slmTrapPort, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLicenseId=slmLicenseId, slmNetworkMode=slmNetworkMode, slmTrapDestAddress=slmTrapDestAddress, slmAdminTable=slmAdminTable, slmConfigFile=slmConfigFile, UserCommunity=UserCommunity, slmAdminEntry=slmAdminEntry, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLicenseExpiration=slmLicenseExpiration, slmSysTemperature=slmSysTemperature, slmChPassEntry=slmChPassEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmWriteCommunity=slmWriteCommunity, slmTrapUserLogin=slmTrapUserLogin, slmChPassNewPass=slmChPassNewPass, slmSysOperStatus=slmSysOperStatus, slmTrapDestTable=slmTrapDestTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmRstpEnabled=slmRstpEnabled, PYSNMP_MODULE_ID=slMain, slmSysAlmDeact=slmSysAlmDeact, slmAuthLogin=slmAuthLogin, slmReadCommunity=slmReadCommunity, slmSyslogDestAddress=slmSyslogDestAddress, slmSwRevTable=slmSwRevTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAuthPassword=slmAuthPassword, slmAdminRowStatus=slmAdminRowStatus, slmLicenseEntry=slmLicenseEntry, slmSwRevStatus=slmSwRevStatus, slmSysEncryptionCapability=slmSysEncryptionCapability, slmChPassOldPass=slmChPassOldPass, slmChPass=slmChPass, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTid=slmTid, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapUserAccess=slmTrapUserAccess, slmAdminPassword=slmAdminPassword, slmSyslogDestTable=slmSyslogDestTable, slmSnmpv3Priv=slmSnmpv3Priv, slmSysResetPm=slmSysResetPm, slmSysMode=slmSysMode, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestCommunity=slmTrapDestCommunity, slmSysChassisId=slmSysChassisId, slmTrapLogId=slmTrapLogId, slmSysAlmAct=slmSysAlmAct, slmTrapLogName=slmTrapLogName, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam2=slmTrapLogParam2, slmPmAvailable=slmPmAvailable, slmTrapLogParam1=slmTrapLogParam1, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapCommunity=slmTrapCommunity, slmAuthCommunity=slmAuthCommunity, slmTopologyEnabled=slmTopologyEnabled, slmSysNetworkPrefix=slmSysNetworkPrefix, AdminAccess=AdminAccess, slm40GConf=slm40GConf, slmSwRevEntry=slmSwRevEntry, slmPsuNumber=slmPsuNumber, slmSysSubnetMask=slmSysSubnetMask, slmLogFile=slmLogFile, slmSwRevDate=slmSwRevDate, slmSysLanIpAddr=slmSysLanIpAddr, slmSysAdminStatus=slmSysAdminStatus, slmPortsNumber=slmPortsNumber)
