...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, TimeTicks, ObjectIdentity, Integer32, NotificationType, Opaque, Counter64, iso, Bits, Counter32, Unsigned32, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "Integer32", "NotificationType", "Opaque", "Counter64", "iso", "Bits", "Counter32", "Unsigned32", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPass=slmChPass, slmSysEncryptionCapability=slmSysEncryptionCapability, slmNetworkMode=slmNetworkMode, slmSnmpv3Password=slmSnmpv3Password, slmSwRevDirectory=slmSwRevDirectory, slmLicenseExpiration=slmLicenseExpiration, slmSnmpv3Auth=slmSnmpv3Auth, slmLogin=slmLogin, slmTrapDestTable=slmTrapDestTable, slmTrapLogName=slmTrapLogName, slmSyslogDestTable=slmSyslogDestTable, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestRowStatus=slmTrapDestRowStatus, slmChPassOldPass=slmChPassOldPass, slmTrapEnable=slmTrapEnable, slmLicenseId=slmLicenseId, slmChPassNewPass=slmChPassNewPass, slmTrapLogParam4=slmTrapLogParam4, slmAdminAccess=slmAdminAccess, slmSysTrapFormat=slmSysTrapFormat, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogEntry=slmTrapLogEntry, slmOemType=slmOemType, slmTrapLogParam3=slmTrapLogParam3, slmSyslogLevel=slmSyslogLevel, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevStatus=slmSwRevStatus, slmSysResetPm=slmSysResetPm, slmWriteCommunity=slmWriteCommunity, slmAuthPassword=slmAuthPassword, slmTrapLogParam1=slmTrapLogParam1, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysLanIpAddr=slmSysLanIpAddr, slmLicenseTable=slmLicenseTable, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogTable=slmTrapLogTable, UserLogin=UserLogin, slmSysTemperature=slmSysTemperature, slmTrap=slmTrap, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicense=slmLicense, slmSysOperStatus=slmSysOperStatus, slmAuthLogin=slmAuthLogin, slmTrapLogId=slmTrapLogId, slmReadCommunity=slmReadCommunity, slmPmAvailable=slmPmAvailable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysChassisId=slmSysChassisId, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysAdminStatus=slmSysAdminStatus, slmSys=slmSys, slmTrapCommunity=slmTrapCommunity, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmSysName=slmSysName, slmSnmpv3Priv=slmSnmpv3Priv, slmLicenseIndex=slmLicenseIndex, SoftwareRevision=SoftwareRevision, slmTrapLogParam6=slmTrapLogParam6, slmAdminRowStatus=slmAdminRowStatus, slmTrapUserAccess=slmTrapUserAccess, slmSyslogPort=slmSyslogPort, slmSwRevName=slmSwRevName, slmChPassTable=slmChPassTable, slmTrapLogParam5=slmTrapLogParam5, slmSwRevEntry=slmSwRevEntry, slmEdfaNumber=slmEdfaNumber, slmConfigSysUptime=slmConfigSysUptime, slmRstpEnabled=slmRstpEnabled, slm40GConf=slm40GConf, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminLogin=slmAdminLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAuth=slmAuth, slmTrapUserLogin=slmTrapUserLogin, slmAuthEntry=slmAuthEntry, slmAuthCommunity=slmAuthCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmRebootDelay=slmRebootDelay, slmChPassEntry=slmChPassEntry, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogDestEntry=slmSyslogDestEntry, slMain=slMain, slmAuthTable=slmAuthTable, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminCommunity=slmAdminCommunity, slmSysLocation=slmSysLocation, slmLicenseEntry=slmLicenseEntry, slmSwRevDate=slmSwRevDate, PYSNMP_MODULE_ID=slMain, slmSwRevTable=slmSwRevTable, slmSysGatewayAddr=slmSysGatewayAddr, slmTid=slmTid, slmSyslogDestRowStatus=slmSyslogDestRowStatus, UserPassword=UserPassword, slmTopologyEnabled=slmTopologyEnabled, slmAdminEntry=slmAdminEntry, AdminAccess=AdminAccess, UserCommunity=UserCommunity, slmSysAlmAct=slmSysAlmAct, slmAdminTable=slmAdminTable, slmTrapDestCommunity=slmTrapDestCommunity, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysMode=slmSysMode, slmConfigFile=slmConfigFile, slmSysCalendarTime=slmSysCalendarTime, slmBoxSize=slmBoxSize, slmMuxNumber=slmMuxNumber, slmVcatDelay=slmVcatDelay, slmLogFile=slmLogFile, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestAddress=slmTrapDestAddress, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdmin=slmAdmin, slmPsuNumber=slmPsuNumber, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPassLogin=slmChPassLogin, slmPortsNumber=slmPortsNumber, slmAdminPassword=slmAdminPassword, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysUplinkRate=slmSysUplinkRate, slmSysAlmDeact=slmSysAlmDeact, slmTrapPort=slmTrapPort)
