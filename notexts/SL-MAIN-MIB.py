...
TimeTicks, iso, Counter32, Opaque, ModuleIdentity, Integer32, IpAddress, MibIdentifier, Counter64, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "Counter32", "Opaque", "ModuleIdentity", "Integer32", "IpAddress", "MibIdentifier", "Counter64", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "Bits")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTopologyEnabled=slmTopologyEnabled, slMain=slMain, slmSwRevTable=slmSwRevTable, slmAdminAccess=slmAdminAccess, slmSys=slmSys, slmConfigSysSignalType=slmConfigSysSignalType, slmSysAlmAct=slmSysAlmAct, slmOemType=slmOemType, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestEntry=slmTrapDestEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapUserLogin=slmTrapUserLogin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLicenseEntry=slmLicenseEntry, UserCommunity=UserCommunity, slmSwRevName=slmSwRevName, slmChPassNewPass=slmChPassNewPass, SoftwareRevision=SoftwareRevision, PYSNMP_MODULE_ID=slMain, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSwRevEntry=slmSwRevEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmSysCalendarTime=slmSysCalendarTime, slmSnmpv3Password=slmSnmpv3Password, slmConfigFile=slmConfigFile, slm40GConf=slm40GConf, slmAuthLogin=slmAuthLogin, slmSysChassisId=slmSysChassisId, slmTrapDestCommunity=slmTrapDestCommunity, slmRebootDelay=slmRebootDelay, slmTrapLogParam5=slmTrapLogParam5, slmSysIpAddr=slmSysIpAddr, slmTrapLogName=slmTrapLogName, slmConfigSysUptime=slmConfigSysUptime, slmNetworkMode=slmNetworkMode, slmTrapCommunity=slmTrapCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogEntry=slmTrapLogEntry, slmSysTemperature=slmSysTemperature, slmSysUplinkRate=slmSysUplinkRate, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam1=slmTrapLogParam1, slmChPassTable=slmChPassTable, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysMode=slmSysMode, slmAuthTable=slmAuthTable, slmSyslogLevel=slmSyslogLevel, slmLicenseIndex=slmLicenseIndex, slmSysPmStartOfDay=slmSysPmStartOfDay, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminTable=slmAdminTable, slmTrapSysNameChange=slmTrapSysNameChange, slmSysAlmDeact=slmSysAlmDeact, slmTrapDestTable=slmTrapDestTable, slmSwRevStatus=slmSwRevStatus, slmAuth=slmAuth, slmEdfaNumber=slmEdfaNumber, slmLogFile=slmLogFile, slmMuxNumber=slmMuxNumber, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestProtVersion=slmTrapDestProtVersion, slmWriteCommunity=slmWriteCommunity, slmTrapLogTable=slmTrapLogTable, slmPsuNumber=slmPsuNumber, slmPortsNumber=slmPortsNumber, slmAuthPassword=slmAuthPassword, slmLicenseId=slmLicenseId, slmBoxSize=slmBoxSize, AdminAccess=AdminAccess, slmSyslogPort=slmSyslogPort, slmReadCommunity=slmReadCommunity, slmChPassLogin=slmChPassLogin, slmTrapLogParam2=slmTrapLogParam2, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevDate=slmSwRevDate, slmSysName=slmSysName, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminRowStatus=slmAdminRowStatus, slmSysLocation=slmSysLocation, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTid=slmTid, slmTrapUserAccess=slmTrapUserAccess, slmTrap=slmTrap, slmSysGatewayAddr=slmSysGatewayAddr, slmLicense=slmLicense, slmTrapLogParam6=slmTrapLogParam6, slmSwRevDirectory=slmSwRevDirectory, slmChPassOldPass=slmChPassOldPass, slmTrapEnable=slmTrapEnable, slmSyslogDestTable=slmSyslogDestTable, slmTrapDestAddress=slmTrapDestAddress, slmSysOperStatus=slmSysOperStatus, slmPmAvailable=slmPmAvailable, slmAuthEntry=slmAuthEntry, slmRstpEnabled=slmRstpEnabled, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmChPass=slmChPass, slmLicenseExpiration=slmLicenseExpiration, UserLogin=UserLogin, slmTrapLogId=slmTrapLogId, slmAdminPassword=slmAdminPassword, slmSysAdminStatus=slmSysAdminStatus, slmLogin=slmLogin, UserPassword=UserPassword, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmVcatDelay=slmVcatDelay, slmLicenseTable=slmLicenseTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminEntry=slmAdminEntry, slmAdminLogin=slmAdminLogin, slmAuthCommunity=slmAuthCommunity, slmSysResetPm=slmSysResetPm, slmAdminCommunity=slmAdminCommunity, slmChPassEntry=slmChPassEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapPort=slmTrapPort, slmTrapLogParam3=slmTrapLogParam3, slmSnmpv3Priv=slmSnmpv3Priv, slmAdmin=slmAdmin)
