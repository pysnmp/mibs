...
iso, Integer32, Gauge32, MibIdentifier, Unsigned32, NotificationType, ModuleIdentity, ObjectIdentity, Opaque, IpAddress, Bits, Counter32, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "Gauge32", "MibIdentifier", "Unsigned32", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Opaque", "IpAddress", "Bits", "Counter32", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminPassword=slmAdminPassword, slmSwRevDirectory=slmSwRevDirectory, slmLicenseId=slmLicenseId, slmSwRevStatus=slmSwRevStatus, slmAuthCommunity=slmAuthCommunity, slmSysName=slmSysName, slmSys=slmSys, slmSysSubnetMask=slmSysSubnetMask, slmAdminEntry=slmAdminEntry, UserLogin=UserLogin, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrap=slmTrap, slmLicenseIndex=slmLicenseIndex, slmAuthLogin=slmAuthLogin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysUplinkRate=slmSysUplinkRate, slmRstpEnabled=slmRstpEnabled, slmOemType=slmOemType, slmAdminAccess=slmAdminAccess, slmSysResetPm=slmSysResetPm, slmAuth=slmAuth, slmConfigFile=slmConfigFile, slmTrapUserAccess=slmTrapUserAccess, slmSysTemperature=slmSysTemperature, slmSysAlmAct=slmSysAlmAct, slmChPassOldPass=slmChPassOldPass, SoftwareRevision=SoftwareRevision, slmSysMode=slmSysMode, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestTable=slmTrapDestTable, slmTopologyEnabled=slmTopologyEnabled, slmChPassEntry=slmChPassEntry, slmSysAlmDeact=slmSysAlmDeact, slmSyslogDestAddress=slmSyslogDestAddress, slmConfigSysSignalType=slmConfigSysSignalType, slmSysOperStatus=slmSysOperStatus, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapDestEntry=slmTrapDestEntry, slmConfigSysUptime=slmConfigSysUptime, slmPmAvailable=slmPmAvailable, slmAdminTable=slmAdminTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminCommunity=slmAdminCommunity, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassLogin=slmChPassLogin, slmRebootDelay=slmRebootDelay, slmTrapCommunity=slmTrapCommunity, slmReadCommunity=slmReadCommunity, slmTrapLogParam2=slmTrapLogParam2, AdminAccess=AdminAccess, slmSysLocation=slmSysLocation, PYSNMP_MODULE_ID=slMain, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassNewPass=slmChPassNewPass, slmSyslogDestTable=slmSyslogDestTable, slmBoxSize=slmBoxSize, slmTrapLogName=slmTrapLogName, slmTrapLogParam5=slmTrapLogParam5, slmAuthPassword=slmAuthPassword, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapUserLogin=slmTrapUserLogin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysIpAddr=slmSysIpAddr, slmSyslogLevel=slmSyslogLevel, slmTrapLogId=slmTrapLogId, slmLicenseTable=slmLicenseTable, slmEdfaNumber=slmEdfaNumber, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogParam4=slmTrapLogParam4, slmSwRevDate=slmSwRevDate, slmAuthTable=slmAuthTable, slmChPass=slmChPass, slmSysTrapFormat=slmSysTrapFormat, slmPortsNumber=slmPortsNumber, slmTrapLogParam1=slmTrapLogParam1, slMain=slMain, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogPort=slmSyslogPort, slm40GConf=slm40GConf, slmTrapDestAddress=slmTrapDestAddress, UserPassword=UserPassword, slmAuthEntry=slmAuthEntry, slmNetworkMode=slmNetworkMode, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmSwRevTable=slmSwRevTable, slmTrapPort=slmTrapPort, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminRowStatus=slmAdminRowStatus, UserCommunity=UserCommunity, slmAdmin=slmAdmin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmChPassTable=slmChPassTable, slmTrapLogParam6=slmTrapLogParam6, slmTid=slmTid, slmSyslogDestEntry=slmSyslogDestEntry, slmLicense=slmLicense, slmVcatDelay=slmVcatDelay, slmAdminLogin=slmAdminLogin, slmWriteCommunity=slmWriteCommunity, slmTrapEnable=slmTrapEnable, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogTable=slmTrapLogTable, slmSysChassisId=slmSysChassisId, slmLicenseExpiration=slmLicenseExpiration, slmSwRevName=slmSwRevName, slmSysGatewayAddr=slmSysGatewayAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmMuxNumber=slmMuxNumber, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysNetworkPrefix=slmSysNetworkPrefix, slmLicenseEntry=slmLicenseEntry, slmSwRevEntry=slmSwRevEntry, slmSnmpv3Password=slmSnmpv3Password, slmLogin=slmLogin, slmLogFile=slmLogFile, slmPsuNumber=slmPsuNumber)
