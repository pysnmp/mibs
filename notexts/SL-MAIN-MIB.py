...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapDestEntry=slmTrapDestEntry, slmSyslogDestTable=slmSyslogDestTable, slmSwRevTable=slmSwRevTable, slmTrapLogEntry=slmTrapLogEntry, slmAdminPassword=slmAdminPassword, slmSysResetPm=slmSysResetPm, slmChPassOldPass=slmChPassOldPass, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassEntry=slmChPassEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmEdfaNumber=slmEdfaNumber, slmSysSubnetMask=slmSysSubnetMask, slmSnmpv3Priv=slmSnmpv3Priv, AdminAccess=AdminAccess, slmChPassNewPass=slmChPassNewPass, slmTrapCommunity=slmTrapCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmNetworkMode=slmNetworkMode, slmSysAlmDeact=slmSysAlmDeact, slmPortsNumber=slmPortsNumber, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysTemperature=slmSysTemperature, slmLicenseTable=slmLicenseTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseId=slmLicenseId, slmTrapLogParam5=slmTrapLogParam5, slmLogin=slmLogin, slmSysName=slmSysName, slmOemType=slmOemType, slmAdminCommunity=slmAdminCommunity, slmSysLocation=slmSysLocation, slmAuth=slmAuth, slmLicenseEntry=slmLicenseEntry, slmAuthLogin=slmAuthLogin, slmAuthPassword=slmAuthPassword, slmTrapLogParam6=slmTrapLogParam6, slmLogFile=slmLogFile, UserLogin=UserLogin, slmMuxNumber=slmMuxNumber, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminTable=slmAdminTable, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogName=slmTrapLogName, slmSwRevStatus=slmSwRevStatus, slmSwRevName=slmSwRevName, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogParam3=slmTrapLogParam3, slmTopologyEnabled=slmTopologyEnabled, slmLicenseIndex=slmLicenseIndex, slmSysAlmAct=slmSysAlmAct, slmAuthEntry=slmAuthEntry, slmLicense=slmLicense, slmSysTrapFormat=slmSysTrapFormat, slmTrapPort=slmTrapPort, slmAdminEntry=slmAdminEntry, slmSysLanIpAddr=slmSysLanIpAddr, UserPassword=UserPassword, slmTrapDestCommunity=slmTrapDestCommunity, slmPsuNumber=slmPsuNumber, slMain=slMain, slmBoxSize=slmBoxSize, slmAdminRowStatus=slmAdminRowStatus, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogLevel=slmSyslogLevel, slm40GConf=slm40GConf, slmSysCalendarTime=slmSysCalendarTime, slmSysSnmpVersion=slmSysSnmpVersion, slmSysMode=slmSysMode, slmSysOperStatus=slmSysOperStatus, slmSyslogDestAddress=slmSyslogDestAddress, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapUserAccess=slmTrapUserAccess, slmSwRevDate=slmSwRevDate, slmTid=slmTid, slmSyslogPort=slmSyslogPort, slmSysUplinkRate=slmSysUplinkRate, slmTrapDestIpAddress=slmTrapDestIpAddress, slmConfigFile=slmConfigFile, slmSysActiveSwVersion=slmSysActiveSwVersion, PYSNMP_MODULE_ID=slMain, slmConfigSysUptime=slmConfigSysUptime, slmTrapDestTable=slmTrapDestTable, slmSysAdminStatus=slmSysAdminStatus, slmSysChassisId=slmSysChassisId, slmSwRevDirectory=slmSwRevDirectory, slmTrapEnable=slmTrapEnable, SoftwareRevision=SoftwareRevision, slmTrapLogTable=slmTrapLogTable, slmAdminAccess=slmAdminAccess, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAuthCommunity=slmAuthCommunity, slmTrapUserLogin=slmTrapUserLogin, slmChPassLogin=slmChPassLogin, slmRstpEnabled=slmRstpEnabled, slmVcatDelay=slmVcatDelay, slmTrap=slmTrap, UserCommunity=UserCommunity, slmSys=slmSys, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSnmpv3Password=slmSnmpv3Password, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmPmAvailable=slmPmAvailable, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogParam2=slmTrapLogParam2, slmChPassTable=slmChPassTable, slmTrapLogParam4=slmTrapLogParam4, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdmin=slmAdmin, slmTrapLogParam1=slmTrapLogParam1, slmReadCommunity=slmReadCommunity, slmOpticalSwitchExist=slmOpticalSwitchExist, slmWriteCommunity=slmWriteCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmRebootDelay=slmRebootDelay, slmSwRevEntry=slmSwRevEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminLogin=slmAdminLogin, slmAuthTable=slmAuthTable, slmSysIpAddr=slmSysIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogId=slmTrapLogId, slmChPass=slmChPass)
