...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysGatewayAddr=slmSysGatewayAddr, PYSNMP_MODULE_ID=slMain, slmRebootDelay=slmRebootDelay, slmSysMode=slmSysMode, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam5=slmTrapLogParam5, slmAdminLogin=slmAdminLogin, slmRstpEnabled=slmRstpEnabled, slmLogin=slmLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapUserAccess=slmTrapUserAccess, slmTopologyEnabled=slmTopologyEnabled, slmChPassTable=slmChPassTable, slmSwRevDirectory=slmSwRevDirectory, slmLicenseExpiration=slmLicenseExpiration, slmLicenseId=slmLicenseId, slmSyslogPort=slmSyslogPort, slmSyslogDestTable=slmSyslogDestTable, slmPmAvailable=slmPmAvailable, slmSysSnmpVersion=slmSysSnmpVersion, slmSysAdminStatus=slmSysAdminStatus, slmSysNetworkPrefix=slmSysNetworkPrefix, slmChPassOldPass=slmChPassOldPass, slmSyslogDestIpAddress=slmSyslogDestIpAddress, SoftwareRevision=SoftwareRevision, slmPortsNumber=slmPortsNumber, slmSwRevStatus=slmSwRevStatus, slmSysOperStatus=slmSysOperStatus, slmSysCalendarTime=slmSysCalendarTime, slmOemType=slmOemType, slmWriteCommunity=slmWriteCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysIpAddr=slmSysIpAddr, slmSwRevEntry=slmSwRevEntry, slmSwRevName=slmSwRevName, slmLicense=slmLicense, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam6=slmTrapLogParam6, slmReadCommunity=slmReadCommunity, slmTrapLogParam1=slmTrapLogParam1, slmSyslogLevel=slmSyslogLevel, UserLogin=UserLogin, slmTrapPort=slmTrapPort, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogEntry=slmTrapLogEntry, slmChPassLogin=slmChPassLogin, slmSys=slmSys, slmAuthLogin=slmAuthLogin, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLicenseEntry=slmLicenseEntry, slmTrap=slmTrap, slmBoxSize=slmBoxSize, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseTable=slmLicenseTable, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogTable=slmTrapLogTable, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLocation=slmSysLocation, slmNetworkMode=slmNetworkMode, slmChPassEntry=slmChPassEntry, slmSyslogDestEntry=slmSyslogDestEntry, slMain=slMain, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminCommunity=slmAdminCommunity, slmAuthEntry=slmAuthEntry, slmMuxNumber=slmMuxNumber, slmSysAlmDeact=slmSysAlmDeact, slmAdminTable=slmAdminTable, slmSysChassisId=slmSysChassisId, slmVcatDelay=slmVcatDelay, slmSwRevDate=slmSwRevDate, slmSysAlmAct=slmSysAlmAct, slmSwRevTable=slmSwRevTable, slmTrapLogParam2=slmTrapLogParam2, slmSnmpv3Password=slmSnmpv3Password, slmEdfaNumber=slmEdfaNumber, slmAdminEntry=slmAdminEntry, slmAdminAccess=slmAdminAccess, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdmin=slmAdmin, slmLogFile=slmLogFile, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogName=slmTrapLogName, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapDestAddress=slmTrapDestAddress, slmAdminPassword=slmAdminPassword, slmChPass=slmChPass, slmAuthPassword=slmAuthPassword, slmTrapLogParam4=slmTrapLogParam4, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestTable=slmTrapDestTable, UserPassword=UserPassword, slmChPassNewPass=slmChPassNewPass, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapEnable=slmTrapEnable, slmConfigFile=slmConfigFile, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestCommunity=slmTrapDestCommunity, slmConfigSysUptime=slmConfigSysUptime, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuthTable=slmAuthTable, slmSysTemperature=slmSysTemperature, slmLicenseIndex=slmLicenseIndex, slmSysLanIpAddr=slmSysLanIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysSubnetMask=slmSysSubnetMask, slmTrapUserLogin=slmTrapUserLogin, slmPsuNumber=slmPsuNumber, slmTid=slmTid, UserCommunity=UserCommunity, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysName=slmSysName, slmTrapLogId=slmTrapLogId, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuth=slmAuth, AdminAccess=AdminAccess, slmSyslogDestAddress=slmSyslogDestAddress, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAuthCommunity=slmAuthCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slm40GConf=slm40GConf, slmSysResetPm=slmSysResetPm)
