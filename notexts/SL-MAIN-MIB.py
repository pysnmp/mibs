...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminPassword=slmAdminPassword, slmSysResetPm=slmSysResetPm, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmPmAvailable=slmPmAvailable, slmLicenseId=slmLicenseId, slmConfigFile=slmConfigFile, slmOemType=slmOemType, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmNetworkMode=slmNetworkMode, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestCommunity=slmTrapDestCommunity, slmLogFile=slmLogFile, slmTrapCommunity=slmTrapCommunity, slmTrapEnable=slmTrapEnable, slmChPassTable=slmChPassTable, slmTrap=slmTrap, slmAdminLogin=slmAdminLogin, slmPortsNumber=slmPortsNumber, slmTrapLogParam1=slmTrapLogParam1, slmAdmin=slmAdmin, slmAdminAccess=slmAdminAccess, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminRowStatus=slmAdminRowStatus, slmSysLocation=slmSysLocation, slmSysPmStartOfDay=slmSysPmStartOfDay, slmChPassLogin=slmChPassLogin, slmSwRevName=slmSwRevName, slmBoxSize=slmBoxSize, UserLogin=UserLogin, slmRebootDelay=slmRebootDelay, slmSysIpAddr=slmSysIpAddr, slmWriteCommunity=slmWriteCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseTable=slmLicenseTable, slmSwRevTable=slmSwRevTable, slmSys=slmSys, slmAdminCommunity=slmAdminCommunity, slmAuthTable=slmAuthTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysSubnetMask=slmSysSubnetMask, slmAuthCommunity=slmAuthCommunity, slmSysAlmAct=slmSysAlmAct, slmSysAlmDeact=slmSysAlmDeact, slmSwRevEntry=slmSwRevEntry, slmSwRevStatus=slmSwRevStatus, AdminAccess=AdminAccess, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogTable=slmTrapLogTable, slmVcatDelay=slmVcatDelay, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSnmpv3Password=slmSnmpv3Password, slmAuth=slmAuth, slmSysGatewayAddr=slmSysGatewayAddr, slMain=slMain, PYSNMP_MODULE_ID=slMain, slmChPass=slmChPass, slmChPassNewPass=slmChPassNewPass, slmTrapPort=slmTrapPort, slmSysOperStatus=slmSysOperStatus, slmSysTrapFormat=slmSysTrapFormat, slmChPassOldPass=slmChPassOldPass, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAuthEntry=slmAuthEntry, slmTrapLogEntry=slmTrapLogEntry, slmReadCommunity=slmReadCommunity, slmAuthLogin=slmAuthLogin, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam6=slmTrapLogParam6, slmLicenseExpiration=slmLicenseExpiration, slmSysTemperature=slmSysTemperature, slmTrapUserAccess=slmTrapUserAccess, slmLogin=slmLogin, slmTrapLogParam5=slmTrapLogParam5, slmChPassEntry=slmChPassEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmConfigSysSignalType=slmConfigSysSignalType, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminEntry=slmAdminEntry, UserPassword=UserPassword, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapSysNameChange=slmTrapSysNameChange, slmTopologyEnabled=slmTopologyEnabled, slmSwRevDate=slmSwRevDate, slmTrapDestTable=slmTrapDestTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slm40GConf=slm40GConf, slmAuthPassword=slmAuthPassword, UserCommunity=UserCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapUserLogin=slmTrapUserLogin, slmEdfaNumber=slmEdfaNumber, slmAdminTable=slmAdminTable, slmTrapLogParam2=slmTrapLogParam2, slmSysMode=slmSysMode, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestAddress=slmTrapDestAddress, slmSysLanIpAddr=slmSysLanIpAddr, slmSysName=slmSysName, slmSyslogLevel=slmSyslogLevel, slmMuxNumber=slmMuxNumber, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogName=slmTrapLogName, slmTid=slmTid, slmSysUplinkRate=slmSysUplinkRate, slmPsuNumber=slmPsuNumber, slmSysChassisId=slmSysChassisId, slmSyslogDestEntry=slmSyslogDestEntry, slmSyslogPort=slmSyslogPort, slmTrapLogParam4=slmTrapLogParam4, slmLicenseIndex=slmLicenseIndex, slmSysCalendarTime=slmSysCalendarTime, slmRstpEnabled=slmRstpEnabled, slmSyslogDestTable=slmSyslogDestTable, slmLicense=slmLicense, slmTrapLogId=slmTrapLogId, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSwRevDirectory=slmSwRevDirectory, slmLicenseEntry=slmLicenseEntry, SoftwareRevision=SoftwareRevision)
