...
ObjectIdentity, Gauge32, IpAddress, ModuleIdentity, NotificationType, TimeTicks, iso, Counter32, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, Integer32, Unsigned32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "IpAddress", "ModuleIdentity", "NotificationType", "TimeTicks", "iso", "Counter32", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "Integer32", "Unsigned32", "Bits")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysPmStartOfDay=slmSysPmStartOfDay, slmSwRevDate=slmSwRevDate, slmTrap=slmTrap, slmTrapDestEntry=slmTrapDestEntry, slmAuth=slmAuth, slmTrapDestTable=slmTrapDestTable, slmNetworkMode=slmNetworkMode, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam6=slmTrapLogParam6, slmConfigSysSignalType=slmConfigSysSignalType, UserCommunity=UserCommunity, slmTrapLogName=slmTrapLogName, slmSys=slmSys, slmMuxNumber=slmMuxNumber, slMain=slMain, slmLicenseEntry=slmLicenseEntry, slmSysAlmAct=slmSysAlmAct, slmTrapLogTable=slmTrapLogTable, slmConfigFile=slmConfigFile, slmTrapLogId=slmTrapLogId, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmRstpEnabled=slmRstpEnabled, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSnmpv3Auth=slmSnmpv3Auth, slmAdmin=slmAdmin, slmSwRevStatus=slmSwRevStatus, slmTrapCommunity=slmTrapCommunity, slmTrapLogEntry=slmTrapLogEntry, slmAuthLogin=slmAuthLogin, slmSysAlmDeact=slmSysAlmDeact, PYSNMP_MODULE_ID=slMain, slmSysUplinkRate=slmSysUplinkRate, slmChPassLogin=slmChPassLogin, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminTable=slmAdminTable, slmTrapPort=slmTrapPort, slmTrapLogParam1=slmTrapLogParam1, slmLicenseId=slmLicenseId, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAuthEntry=slmAuthEntry, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam2=slmTrapLogParam2, slmOemType=slmOemType, slmAdminPassword=slmAdminPassword, slmLogFile=slmLogFile, slmAdminRowStatus=slmAdminRowStatus, slmSysSnmpVersion=slmSysSnmpVersion, slmSwRevDirectory=slmSwRevDirectory, slmSwRevTable=slmSwRevTable, slmBoxSize=slmBoxSize, slmReadCommunity=slmReadCommunity, slmSwRevEntry=slmSwRevEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysCalendarTime=slmSysCalendarTime, slmAdminEntry=slmAdminEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmPortsNumber=slmPortsNumber, slmConfigSysUptime=slmConfigSysUptime, slmVcatDelay=slmVcatDelay, slmPsuNumber=slmPsuNumber, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmRebootDelay=slmRebootDelay, slmSyslogPort=slmSyslogPort, slmTrapEnable=slmTrapEnable, slmEdfaNumber=slmEdfaNumber, AdminAccess=AdminAccess, slmAdminLogin=slmAdminLogin, slmLicense=slmLicense, slmSwRevName=slmSwRevName, slmTrapUserAccess=slmTrapUserAccess, slmSysName=slmSysName, slmSysOperStatus=slmSysOperStatus, slmSysLocation=slmSysLocation, slmChPassNewPass=slmChPassNewPass, slmChPass=slmChPass, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogDestAddress=slmSyslogDestAddress, slmLicenseExpiration=slmLicenseExpiration, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLanIpAddr=slmSysLanIpAddr, UserPassword=UserPassword, slmAdminAccess=slmAdminAccess, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapDestCommunity=slmTrapDestCommunity, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slm40GConf=slm40GConf, slmTrapLogParam5=slmTrapLogParam5, slmAdminCommunity=slmAdminCommunity, slmTrapDestAddress=slmTrapDestAddress, slmPmAvailable=slmPmAvailable, slmSysChassisId=slmSysChassisId, SoftwareRevision=SoftwareRevision, UserLogin=UserLogin, slmChPassEntry=slmChPassEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmTid=slmTid, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysTemperature=slmSysTemperature, slmSysIpAddr=slmSysIpAddr, slmChPassOldPass=slmChPassOldPass, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTopologyEnabled=slmTopologyEnabled, slmLogin=slmLogin, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogParam4=slmTrapLogParam4, slmSyslogLevel=slmSyslogLevel, slmSysMode=slmSysMode, slmLicenseIndex=slmLicenseIndex, slmAuthPassword=slmAuthPassword, slmTrapLogParam3=slmTrapLogParam3, slmSysAdminStatus=slmSysAdminStatus, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysSubnetMask=slmSysSubnetMask, slmTrapUserLogin=slmTrapUserLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmWriteCommunity=slmWriteCommunity, slmLicenseTable=slmLicenseTable, slmAuthTable=slmAuthTable, slmSysResetPm=slmSysResetPm, slmAuthCommunity=slmAuthCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmChPassTable=slmChPassTable, slmSyslogDestTable=slmSyslogDestTable)
