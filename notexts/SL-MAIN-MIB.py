...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSwRevEntry=slmSwRevEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmAuthPassword=slmAuthPassword, slmLicenseIndex=slmLicenseIndex, slmTrapLogParam6=slmTrapLogParam6, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogParam5=slmTrapLogParam5, slmAdminTable=slmAdminTable, slmLicenseEntry=slmLicenseEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmSysCalendarTime=slmSysCalendarTime, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, PYSNMP_MODULE_ID=slMain, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLogin=slmLogin, UserLogin=UserLogin, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogName=slmTrapLogName, slmSysLocation=slmSysLocation, slmChPass=slmChPass, slmSysGatewayAddr=slmSysGatewayAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysName=slmSysName, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestRowStatus=slmTrapDestRowStatus, slmPsuNumber=slmPsuNumber, slmMuxNumber=slmMuxNumber, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogEntry=slmTrapLogEntry, slmAuthCommunity=slmAuthCommunity, slmChPassNewPass=slmChPassNewPass, slmRebootDelay=slmRebootDelay, slmSysMode=slmSysMode, slmSysChassisId=slmSysChassisId, slmRstpEnabled=slmRstpEnabled, slmConfigFile=slmConfigFile, slmVcatDelay=slmVcatDelay, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysSnmpVersion=slmSysSnmpVersion, slmSysIpAddr=slmSysIpAddr, slmTrapLogTable=slmTrapLogTable, slmLicenseExpiration=slmLicenseExpiration, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogParam1=slmTrapLogParam1, slmSysTemperature=slmSysTemperature, slmChPassEntry=slmChPassEntry, SoftwareRevision=SoftwareRevision, slmLogFile=slmLogFile, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysOperStatus=slmSysOperStatus, slmReadCommunity=slmReadCommunity, slmTrapUserAccess=slmTrapUserAccess, slmSyslogLevel=slmSyslogLevel, slmAdminPassword=slmAdminPassword, slmAdminEntry=slmAdminEntry, slmSyslogPort=slmSyslogPort, slmPortsNumber=slmPortsNumber, slmSwRevName=slmSwRevName, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmChPassTable=slmChPassTable, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapPort=slmTrapPort, slmAdminAccess=slmAdminAccess, slmAdminLogin=slmAdminLogin, slmSys=slmSys, slmSysAlmAct=slmSysAlmAct, slmTid=slmTid, slmAdminRowStatus=slmAdminRowStatus, slmTrapCommunity=slmTrapCommunity, UserPassword=UserPassword, slmTrapDestEntry=slmTrapDestEntry, slmLicense=slmLicense, slmSwRevTable=slmSwRevTable, slmTrap=slmTrap, slMain=slMain, slmTrapDestCommunity=slmTrapDestCommunity, slmChPassOldPass=slmChPassOldPass, slmSwRevDate=slmSwRevDate, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slm40GConf=slm40GConf, slmOemType=slmOemType, slmTrapEnable=slmTrapEnable, slmAuthLogin=slmAuthLogin, slmTrapLogParam2=slmTrapLogParam2, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapUserLogin=slmTrapUserLogin, UserCommunity=UserCommunity, slmAdminCommunity=slmAdminCommunity, slmWriteCommunity=slmWriteCommunity, slmEdfaNumber=slmEdfaNumber, slmSyslogDestAddress=slmSyslogDestAddress, slmAuth=slmAuth, slmSysUplinkRate=slmSysUplinkRate, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevDirectory=slmSwRevDirectory, slmChPassLogin=slmChPassLogin, slmSyslogDestEntry=slmSyslogDestEntry, AdminAccess=AdminAccess, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogParam4=slmTrapLogParam4, slmAdmin=slmAdmin, slmLicenseId=slmLicenseId, slmSyslogDestTable=slmSyslogDestTable, slmSysAdminStatus=slmSysAdminStatus, slmLicenseTable=slmLicenseTable, slmNetworkMode=slmNetworkMode, slmSysAlmDeact=slmSysAlmDeact, slmTrapSysNameChange=slmTrapSysNameChange, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuthEntry=slmAuthEntry, slmSysResetPm=slmSysResetPm, slmSwRevStatus=slmSwRevStatus, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogId=slmTrapLogId, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestProtVersion=slmTrapDestProtVersion, slmBoxSize=slmBoxSize, slmPmAvailable=slmPmAvailable, slmAuthTable=slmAuthTable, slmConfigSysUptime=slmConfigSysUptime)
