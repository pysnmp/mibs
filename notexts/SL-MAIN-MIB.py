...
Integer32, ModuleIdentity, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, NotificationType, ObjectIdentity, Opaque, Gauge32, Bits, iso, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "NotificationType", "ObjectIdentity", "Opaque", "Gauge32", "Bits", "iso", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", AdminAccess=AdminAccess, slmSwRevStatus=slmSwRevStatus, slmTrapDestTable=slmTrapDestTable, slmMuxNumber=slmMuxNumber, slmReadCommunity=slmReadCommunity, slmLicenseExpiration=slmLicenseExpiration, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysName=slmSysName, slmNetworkMode=slmNetworkMode, slmSys=slmSys, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogId=slmTrapLogId, slmSysOperStatus=slmSysOperStatus, UserPassword=UserPassword, slmSyslogLevel=slmSyslogLevel, slmLicense=slmLicense, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminCommunity=slmAdminCommunity, slmSysAlmAct=slmSysAlmAct, slmSyslogDestTable=slmSyslogDestTable, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAuth=slmAuth, slmAuthTable=slmAuthTable, slmSwRevName=slmSwRevName, slMain=slMain, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogParam6=slmTrapLogParam6, slmSwRevTable=slmSwRevTable, slmTid=slmTid, slmAdminEntry=slmAdminEntry, slmTrapDestEntry=slmTrapDestEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmOemType=slmOemType, slmAdminLogin=slmAdminLogin, slmTrapLogParam3=slmTrapLogParam3, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysChassisId=slmSysChassisId, slmChPassEntry=slmChPassEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmVcatDelay=slmVcatDelay, slmSysAdminStatus=slmSysAdminStatus, slmSysIpAddr=slmSysIpAddr, UserLogin=UserLogin, slmAdminAccess=slmAdminAccess, slmAdminPassword=slmAdminPassword, slmRebootDelay=slmRebootDelay, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogTable=slmTrapLogTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLogin=slmLogin, slmLicenseId=slmLicenseId, slmTrapLogParam4=slmTrapLogParam4, slmSnmpv3Auth=slmSnmpv3Auth, slmChPassLogin=slmChPassLogin, slmSwRevEntry=slmSwRevEntry, slmConfigFile=slmConfigFile, slmTrap=slmTrap, slmTrapLogName=slmTrapLogName, slmLicenseIndex=slmLicenseIndex, slmSysGatewayAddr=slmSysGatewayAddr, slmBoxSize=slmBoxSize, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevDirectory=slmSwRevDirectory, slmAdminRowStatus=slmAdminRowStatus, slmSysLocation=slmSysLocation, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTopologyEnabled=slmTopologyEnabled, slm40GConf=slm40GConf, slmSysTrapFormat=slmSysTrapFormat, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam1=slmTrapLogParam1, slmSysCalendarTime=slmSysCalendarTime, slmPortsNumber=slmPortsNumber, slmAdminTable=slmAdminTable, slmAdmin=slmAdmin, slmSysResetPm=slmSysResetPm, slmChPassNewPass=slmChPassNewPass, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmEdfaNumber=slmEdfaNumber, slmSysSnmpVersion=slmSysSnmpVersion, slmPmAvailable=slmPmAvailable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSnmpv3Password=slmSnmpv3Password, slmChPassOldPass=slmChPassOldPass, SoftwareRevision=SoftwareRevision, slmAuthEntry=slmAuthEntry, slmLicenseEntry=slmLicenseEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmAuthCommunity=slmAuthCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestAddress=slmTrapDestAddress, slmChPassTable=slmChPassTable, slmSwRevDate=slmSwRevDate, slmTrapPort=slmTrapPort, slmSysLanIpAddr=slmSysLanIpAddr, slmLogFile=slmLogFile, slmSysUplinkRate=slmSysUplinkRate, UserCommunity=UserCommunity, slmLicenseTable=slmLicenseTable, slmPsuNumber=slmPsuNumber, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogEntry=slmTrapLogEntry, slmTrapCommunity=slmTrapCommunity, slmSysAlmDeact=slmSysAlmDeact, PYSNMP_MODULE_ID=slMain, slmAuthPassword=slmAuthPassword, slmSyslogPort=slmSyslogPort, slmConfigSysUptime=slmConfigSysUptime, slmTrapEnable=slmTrapEnable, slmAuthLogin=slmAuthLogin, slmSysMode=slmSysMode, slmRstpEnabled=slmRstpEnabled, slmTrapUserLogin=slmTrapUserLogin, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapDestIpAddress=slmTrapDestIpAddress, slmChPass=slmChPass, slmSysTemperature=slmSysTemperature, slmTrapLogParam2=slmTrapLogParam2, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestCommunity=slmTrapDestCommunity)
