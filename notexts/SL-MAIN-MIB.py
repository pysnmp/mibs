...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPassLogin=slmChPassLogin, slmReadCommunity=slmReadCommunity, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSnmpv3Auth=slmSnmpv3Auth, slmSysResetPm=slmSysResetPm, slmSyslogPort=slmSyslogPort, slmSysMode=slmSysMode, slmTrapUserLogin=slmTrapUserLogin, slMain=slMain, UserCommunity=UserCommunity, slmMuxNumber=slmMuxNumber, slmWriteCommunity=slmWriteCommunity, slmTrapLogParam5=slmTrapLogParam5, slmChPassOldPass=slmChPassOldPass, AdminAccess=AdminAccess, slmSysGatewayAddr=slmSysGatewayAddr, slmAdminTable=slmAdminTable, slmTrapDestAddress=slmTrapDestAddress, slmAuthCommunity=slmAuthCommunity, slmLicenseId=slmLicenseId, slmSysEncryptionCapability=slmSysEncryptionCapability, slmConfigSysUptime=slmConfigSysUptime, slmAdminRowStatus=slmAdminRowStatus, slmAuth=slmAuth, slmPmAvailable=slmPmAvailable, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogTable=slmTrapLogTable, slmSysChassisId=slmSysChassisId, slmTrapLogParam3=slmTrapLogParam3, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapSysNameChange=slmTrapSysNameChange, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogId=slmTrapLogId, slmTid=slmTid, slmTrap=slmTrap, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminPassword=slmAdminPassword, slmAdminAccess=slmAdminAccess, slmTrapLogName=slmTrapLogName, slmSwRevTable=slmSwRevTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapDestTable=slmTrapDestTable, slmAuthPassword=slmAuthPassword, slmSwRevDate=slmSwRevDate, slmTrapLogParam4=slmTrapLogParam4, slmRebootDelay=slmRebootDelay, slmTrapLogParam6=slmTrapLogParam6, slmSysAlmAct=slmSysAlmAct, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysIpAddr=slmSysIpAddr, slmAdmin=slmAdmin, slmPsuNumber=slmPsuNumber, slmSysCalendarTime=slmSysCalendarTime, PYSNMP_MODULE_ID=slMain, slmSysOperStatus=slmSysOperStatus, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestProtVersion=slmTrapDestProtVersion, SoftwareRevision=SoftwareRevision, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysAdminStatus=slmSysAdminStatus, slmChPass=slmChPass, slmLicense=slmLicense, slmSwRevName=slmSwRevName, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapEnable=slmTrapEnable, slmSyslogDestAddress=slmSyslogDestAddress, slmOemType=slmOemType, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam1=slmTrapLogParam1, slmBoxSize=slmBoxSize, slmSysSnmpVersion=slmSysSnmpVersion, slmLogin=slmLogin, slmAuthLogin=slmAuthLogin, slmSysPmStartOfDay=slmSysPmStartOfDay, slmLicenseIndex=slmLicenseIndex, slmAuthEntry=slmAuthEntry, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogLevel=slmSyslogLevel, slmSysName=slmSysName, slmEdfaNumber=slmEdfaNumber, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysUplinkRate=slmSysUplinkRate, slmTrapPort=slmTrapPort, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevEntry=slmSwRevEntry, slmPortsNumber=slmPortsNumber, slmNetworkMode=slmNetworkMode, slmLicenseEntry=slmLicenseEntry, slmSyslogDestTable=slmSyslogDestTable, slmChPassTable=slmChPassTable, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogEntry=slmTrapLogEntry, slmTrapDestEntry=slmTrapDestEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysTrapFormat=slmSysTrapFormat, slmRstpEnabled=slmRstpEnabled, slmLicenseTable=slmLicenseTable, slmSysTemperature=slmSysTemperature, slmConfigSysSignalType=slmConfigSysSignalType, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminCommunity=slmAdminCommunity, slmSnmpv3Password=slmSnmpv3Password, slmAdminLogin=slmAdminLogin, UserLogin=UserLogin, slmChPassNewPass=slmChPassNewPass, slmTrapLogParam2=slmTrapLogParam2, slmVcatDelay=slmVcatDelay, slm40GConf=slm40GConf, slmLicenseExpiration=slmLicenseExpiration, slmSwRevStatus=slmSwRevStatus, slmTrapUserAccess=slmTrapUserAccess, UserPassword=UserPassword, slmConfigFile=slmConfigFile, slmSwRevDirectory=slmSwRevDirectory, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysLocation=slmSysLocation, slmSys=slmSys, slmLogFile=slmLogFile, slmAuthTable=slmAuthTable, slmAdminEntry=slmAdminEntry, slmChPassEntry=slmChPassEntry)
