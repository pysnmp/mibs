...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, Integer32, Bits, NotificationType, Gauge32, MibIdentifier, Counter32, IpAddress, TimeTicks, Unsigned32, Opaque, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "Integer32", "Bits", "NotificationType", "Gauge32", "MibIdentifier", "Counter32", "IpAddress", "TimeTicks", "Unsigned32", "Opaque", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogParam2=slmTrapLogParam2, UserPassword=UserPassword, slmSysMode=slmSysMode, slmTrapDestAddress=slmTrapDestAddress, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysAlmAct=slmSysAlmAct, slmTrapDestTable=slmTrapDestTable, slmChPass=slmChPass, PYSNMP_MODULE_ID=slMain, slmSyslogPort=slmSyslogPort, slmAuthEntry=slmAuthEntry, slmLicenseTable=slmLicenseTable, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevDirectory=slmSwRevDirectory, slmSysAdminStatus=slmSysAdminStatus, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapLogParam4=slmTrapLogParam4, slmSyslogDestEntry=slmSyslogDestEntry, slmSysTemperature=slmSysTemperature, slmAdminLogin=slmAdminLogin, slmSysNetworkPrefix=slmSysNetworkPrefix, slMain=slMain, slmTrapUserLogin=slmTrapUserLogin, slmAuthCommunity=slmAuthCommunity, slmTid=slmTid, slmSwRevStatus=slmSwRevStatus, slmWriteCommunity=slmWriteCommunity, slmAdminRowStatus=slmAdminRowStatus, slmReadCommunity=slmReadCommunity, slmSysUplinkRate=slmSysUplinkRate, slmSwRevName=slmSwRevName, slm40GConf=slm40GConf, slmConfigFile=slmConfigFile, slmAdminPassword=slmAdminPassword, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminEntry=slmAdminEntry, slmTrapLogTable=slmTrapLogTable, slmLogin=slmLogin, slmSwRevTable=slmSwRevTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysSnmpVersion=slmSysSnmpVersion, slmTopologyEnabled=slmTopologyEnabled, slmAuthLogin=slmAuthLogin, slmRstpEnabled=slmRstpEnabled, slmPsuNumber=slmPsuNumber, slmSys=slmSys, UserLogin=UserLogin, slmSysLocation=slmSysLocation, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogName=slmTrapLogName, slmTrapDestEntry=slmTrapDestEntry, slmSysGatewayAddr=slmSysGatewayAddr, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam6=slmTrapLogParam6, slmNetworkMode=slmNetworkMode, slmSysActiveSwVersion=slmSysActiveSwVersion, slmOemType=slmOemType, slmSysSubnetMask=slmSysSubnetMask, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmPmAvailable=slmPmAvailable, slmSysName=slmSysName, slmAdminAccess=slmAdminAccess, slmTrapLogEntry=slmTrapLogEntry, slmSysAlmDeact=slmSysAlmDeact, slmEdfaNumber=slmEdfaNumber, slmSysLanIpAddr=slmSysLanIpAddr, slmSysOperStatus=slmSysOperStatus, AdminAccess=AdminAccess, slmAdminCommunity=slmAdminCommunity, slmChPassLogin=slmChPassLogin, slmBoxSize=slmBoxSize, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapUserAccess=slmTrapUserAccess, slmChPassEntry=slmChPassEntry, slmSysResetPm=slmSysResetPm, slmLicenseEntry=slmLicenseEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAuthTable=slmAuthTable, slmSysIpAddr=slmSysIpAddr, slmLicense=slmLicense, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysChassisId=slmSysChassisId, slmAuthPassword=slmAuthPassword, slmTrapCommunity=slmTrapCommunity, slmRebootDelay=slmRebootDelay, slmAdmin=slmAdmin, slmLicenseIndex=slmLicenseIndex, slmMuxNumber=slmMuxNumber, slmChPassOldPass=slmChPassOldPass, slmChPassTable=slmChPassTable, SoftwareRevision=SoftwareRevision, slmChPassNewPass=slmChPassNewPass, slmSyslogDestTable=slmSyslogDestTable, slmAdminTable=slmAdminTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmVcatDelay=slmVcatDelay, slmPortsNumber=slmPortsNumber, slmSnmpv3Password=slmSnmpv3Password, slmSysTrapFormat=slmSysTrapFormat, slmAuth=slmAuth, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSwRevEntry=slmSwRevEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogLevel=slmSyslogLevel, slmTrapPort=slmTrapPort, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogId=slmTrapLogId, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogParam5=slmTrapLogParam5, slmSysCalendarTime=slmSysCalendarTime, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLogFile=slmLogFile, UserCommunity=UserCommunity, slmTrap=slmTrap, slmLicenseId=slmLicenseId, slmTrapEnable=slmTrapEnable, slmSwRevDate=slmSwRevDate, slmTrapLogParam1=slmTrapLogParam1)
