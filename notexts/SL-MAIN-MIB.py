...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmWriteCommunity=slmWriteCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevDate=slmSwRevDate, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSwRevEntry=slmSwRevEntry, slmChPassTable=slmChPassTable, slmTrapLogParam1=slmTrapLogParam1, slmLicense=slmLicense, slmSysActiveSwVersion=slmSysActiveSwVersion, slm40GConf=slm40GConf, slmTrapLogId=slmTrapLogId, slmSysChassisId=slmSysChassisId, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogDestTable=slmSyslogDestTable, slmLicenseEntry=slmLicenseEntry, slmSysIpAddr=slmSysIpAddr, slmTrapDestEntry=slmTrapDestEntry, slmAdmin=slmAdmin, slmRebootDelay=slmRebootDelay, slmSnmpv3Priv=slmSnmpv3Priv, AdminAccess=AdminAccess, slmAdminEntry=slmAdminEntry, slmTrapEnable=slmTrapEnable, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysMode=slmSysMode, slmSyslogDestRowStatus=slmSyslogDestRowStatus, UserPassword=UserPassword, slmTrapLogTable=slmTrapLogTable, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminPassword=slmAdminPassword, slmLogin=slmLogin, slmAuthCommunity=slmAuthCommunity, slmSysAdminStatus=slmSysAdminStatus, slmSysCalendarTime=slmSysCalendarTime, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam2=slmTrapLogParam2, slmSysAlmAct=slmSysAlmAct, slmAuthEntry=slmAuthEntry, slmTrapPort=slmTrapPort, UserCommunity=UserCommunity, slmSysLocation=slmSysLocation, slmPsuNumber=slmPsuNumber, slmRstpEnabled=slmRstpEnabled, slmOemType=slmOemType, slmSysTemperature=slmSysTemperature, slmTrapCommunity=slmTrapCommunity, slmBoxSize=slmBoxSize, slmTrapLogName=slmTrapLogName, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminRowStatus=slmAdminRowStatus, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSys=slmSys, slmChPassOldPass=slmChPassOldPass, slmAuthLogin=slmAuthLogin, slmNetworkMode=slmNetworkMode, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysOperStatus=slmSysOperStatus, slmChPassLogin=slmChPassLogin, slmLicenseExpiration=slmLicenseExpiration, UserLogin=UserLogin, slmReadCommunity=slmReadCommunity, slmAdminCommunity=slmAdminCommunity, slmAdminLogin=slmAdminLogin, slmLicenseId=slmLicenseId, slmSysTrapFormat=slmSysTrapFormat, slmLicenseTable=slmLicenseTable, slmLogFile=slmLogFile, slmSyslogLevel=slmSyslogLevel, slmPmAvailable=slmPmAvailable, slmConfigFile=slmConfigFile, slmTopologyEnabled=slmTopologyEnabled, slmVcatDelay=slmVcatDelay, slmSysName=slmSysName, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestEntry=slmSyslogDestEntry, slmAuthPassword=slmAuthPassword, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogParam6=slmTrapLogParam6, slmSyslogPort=slmSyslogPort, slmTrapSysNameChange=slmTrapSysNameChange, slmSysUplinkRate=slmSysUplinkRate, slmSwRevTable=slmSwRevTable, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestCommunity=slmTrapDestCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysLanIpAddr=slmSysLanIpAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmChPass=slmChPass, slmTrapUserAccess=slmTrapUserAccess, slmPortsNumber=slmPortsNumber, slMain=slMain, PYSNMP_MODULE_ID=slMain, slmTrapLogEntry=slmTrapLogEntry, slmConfigSysUptime=slmConfigSysUptime, slmTid=slmTid, slmAdminTable=slmAdminTable, slmTrapLogParam4=slmTrapLogParam4, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestAddress=slmTrapDestAddress, slmSnmpv3Password=slmSnmpv3Password, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogParam3=slmTrapLogParam3, slmConfigSysSignalType=slmConfigSysSignalType, slmAuthTable=slmAuthTable, slmChPassNewPass=slmChPassNewPass, slmSwRevStatus=slmSwRevStatus, slmTrap=slmTrap, slmChPassEntry=slmChPassEntry, slmAuth=slmAuth, SoftwareRevision=SoftwareRevision, slmSysAlmDeact=slmSysAlmDeact, slmSwRevName=slmSwRevName, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam5=slmTrapLogParam5, slmSysResetPm=slmSysResetPm, slmAdminAccess=slmAdminAccess, slmLicenseIndex=slmLicenseIndex, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestTable=slmTrapDestTable, slmMuxNumber=slmMuxNumber)
