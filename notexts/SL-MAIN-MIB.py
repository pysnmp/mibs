...
ModuleIdentity, iso, Gauge32, MibIdentifier, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Opaque, Integer32, NotificationType, Bits, Unsigned32, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "Gauge32", "MibIdentifier", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Opaque", "Integer32", "NotificationType", "Bits", "Unsigned32", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPassNewPass=slmChPassNewPass, slmAdminAccess=slmAdminAccess, slmSysMode=slmSysMode, slmAdminLogin=slmAdminLogin, slmTrapDestEntry=slmTrapDestEntry, slmOemType=slmOemType, slmBoxSize=slmBoxSize, slmSwRevEntry=slmSwRevEntry, slmTrapEnable=slmTrapEnable, slmAdmin=slmAdmin, slmVcatDelay=slmVcatDelay, UserCommunity=UserCommunity, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestTable=slmSyslogDestTable, slmSwRevName=slmSwRevName, slmSysSubnetMask=slmSysSubnetMask, slmLicenseEntry=slmLicenseEntry, slmEdfaNumber=slmEdfaNumber, slmLicenseTable=slmLicenseTable, slmAuthTable=slmAuthTable, slmAdminPassword=slmAdminPassword, slmAdminEntry=slmAdminEntry, slmSnmpv3Password=slmSnmpv3Password, PYSNMP_MODULE_ID=slMain, slmLicenseIndex=slmLicenseIndex, slmPortsNumber=slmPortsNumber, slmChPassLogin=slmChPassLogin, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogEntry=slmTrapLogEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogName=slmTrapLogName, slmWriteCommunity=slmWriteCommunity, slmSwRevDirectory=slmSwRevDirectory, slmTrapLogTable=slmTrapLogTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSwRevTable=slmSwRevTable, slmSnmpv3Priv=slmSnmpv3Priv, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysCalendarTime=slmSysCalendarTime, SoftwareRevision=SoftwareRevision, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogParam1=slmTrapLogParam1, UserLogin=UserLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmAuthLogin=slmAuthLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmLogin=slmLogin, slmSys=slmSys, slmSwRevDate=slmSwRevDate, slmSwRevStatus=slmSwRevStatus, slmTrapDestAddress=slmTrapDestAddress, slmSysName=slmSysName, slmLicense=slmLicense, slmSysTemperature=slmSysTemperature, slmRstpEnabled=slmRstpEnabled, slmTrapLogParam2=slmTrapLogParam2, slmReadCommunity=slmReadCommunity, slmTrapUserAccess=slmTrapUserAccess, slmTrapUserLogin=slmTrapUserLogin, slmNetworkMode=slmNetworkMode, slmTrapPort=slmTrapPort, slmLicenseId=slmLicenseId, AdminAccess=AdminAccess, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTid=slmTid, slmTopologyEnabled=slmTopologyEnabled, slmTrapCommunity=slmTrapCommunity, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmConfigFile=slmConfigFile, slmAdminTable=slmAdminTable, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam5=slmTrapLogParam5, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysAlmAct=slmSysAlmAct, slmSysPmStartOfDay=slmSysPmStartOfDay, slmConfigSysUptime=slmConfigSysUptime, slmRebootDelay=slmRebootDelay, slmChPassOldPass=slmChPassOldPass, slmSysActiveSwVersion=slmSysActiveSwVersion, slm40GConf=slm40GConf, slmSysAdminStatus=slmSysAdminStatus, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSyslogLevel=slmSyslogLevel, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSyslogPort=slmSyslogPort, slmAuthPassword=slmAuthPassword, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slMain=slMain, slmChPassTable=slmChPassTable, slmTrapDestCommunity=slmTrapDestCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseExpiration=slmLicenseExpiration, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogParam4=slmTrapLogParam4, slmSysOperStatus=slmSysOperStatus, slmAuthCommunity=slmAuthCommunity, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestTable=slmTrapDestTable, slmAdminCommunity=slmAdminCommunity, slmTrapLogParam6=slmTrapLogParam6, slmSysSnmpVersion=slmSysSnmpVersion, slmSysUplinkRate=slmSysUplinkRate, slmTrap=slmTrap, slmSysLocation=slmSysLocation, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysResetPm=slmSysResetPm, slmChPass=slmChPass, slmSnmpv3Auth=slmSnmpv3Auth, slmAuthEntry=slmAuthEntry, slmPmAvailable=slmPmAvailable, slmMuxNumber=slmMuxNumber, UserPassword=UserPassword, slmPsuNumber=slmPsuNumber, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysChassisId=slmSysChassisId, slmTrapLogParam3=slmTrapLogParam3, slmAuth=slmAuth, slmTrapSysNameChange=slmTrapSysNameChange, slmChPassEntry=slmChPassEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmLogFile=slmLogFile, slmTrapLogId=slmTrapLogId, slmSysIpAddr=slmSysIpAddr)
