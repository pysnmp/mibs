...
Opaque, Counter64, IpAddress, ObjectIdentity, ModuleIdentity, Counter32, Bits, NotificationType, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "Counter64", "IpAddress", "ObjectIdentity", "ModuleIdentity", "Counter32", "Bits", "NotificationType", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysIpAddr=slmSysIpAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysAdminStatus=slmSysAdminStatus, slmChPassLogin=slmChPassLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmAuthPassword=slmAuthPassword, slmMuxNumber=slmMuxNumber, slmTrapUserAccess=slmTrapUserAccess, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapDestIpAddress=slmTrapDestIpAddress, slmOemType=slmOemType, slmAdminPassword=slmAdminPassword, slmChPassTable=slmChPassTable, slmPmAvailable=slmPmAvailable, slmSnmpv3Auth=slmSnmpv3Auth, slmAdmin=slmAdmin, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam1=slmTrapLogParam1, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogEntry=slmTrapLogEntry, slmAuthCommunity=slmAuthCommunity, slmChPassNewPass=slmChPassNewPass, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapDestEntry=slmTrapDestEntry, slmAdminAccess=slmAdminAccess, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogParam2=slmTrapLogParam2, slmVcatDelay=slmVcatDelay, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogTable=slmTrapLogTable, slmWriteCommunity=slmWriteCommunity, slmSysCalendarTime=slmSysCalendarTime, slmAdminCommunity=slmAdminCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapPort=slmTrapPort, slmSys=slmSys, slmSyslogDestTable=slmSyslogDestTable, slmConfigSysUptime=slmConfigSysUptime, slMain=slMain, slmSwRevStatus=slmSwRevStatus, slmTid=slmTid, slmAuthLogin=slmAuthLogin, slmTrapLogName=slmTrapLogName, slmTrapLogParam4=slmTrapLogParam4, slmSwRevDate=slmSwRevDate, slmSysLocation=slmSysLocation, slmTrapLogParam6=slmTrapLogParam6, UserLogin=UserLogin, slmAuthEntry=slmAuthEntry, slmLicenseTable=slmLicenseTable, slmLicenseEntry=slmLicenseEntry, slmRebootDelay=slmRebootDelay, slmSysOperStatus=slmSysOperStatus, UserPassword=UserPassword, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSwRevTable=slmSwRevTable, slmTopologyEnabled=slmTopologyEnabled, slmSysName=slmSysName, slmReadCommunity=slmReadCommunity, slmPsuNumber=slmPsuNumber, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAdminEntry=slmAdminEntry, slmSysTrapFormat=slmSysTrapFormat, slmTrapSysNameChange=slmTrapSysNameChange, slmBoxSize=slmBoxSize, slmSysResetPm=slmSysResetPm, slmAdminTable=slmAdminTable, slmTrapDestCommunity=slmTrapDestCommunity, UserCommunity=UserCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slm40GConf=slm40GConf, PYSNMP_MODULE_ID=slMain, slmSysMode=slmSysMode, slmLogFile=slmLogFile, slmSysChassisId=slmSysChassisId, slmTrapEnable=slmTrapEnable, slmTrapDestRowStatus=slmTrapDestRowStatus, AdminAccess=AdminAccess, slmSwRevDirectory=slmSwRevDirectory, slmNetworkMode=slmNetworkMode, slmSysEncryptionCapability=slmSysEncryptionCapability, slmConfigFile=slmConfigFile, slmSwRevEntry=slmSwRevEntry, slmTrapLogId=slmTrapLogId, slmAdminRowStatus=slmAdminRowStatus, slmEdfaNumber=slmEdfaNumber, slmPortsNumber=slmPortsNumber, slmTrapLogParam5=slmTrapLogParam5, slmSysAlmAct=slmSysAlmAct, slmAdminLogin=slmAdminLogin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysAlmDeact=slmSysAlmDeact, slmAuthTable=slmAuthTable, slmSysSubnetMask=slmSysSubnetMask, slmLicense=slmLicense, slmSyslogDestAddress=slmSyslogDestAddress, slmTrap=slmTrap, slmSysTemperature=slmSysTemperature, slmTrapUserLogin=slmTrapUserLogin, slmSyslogLevel=slmSyslogLevel, slmTrapDestAddress=slmTrapDestAddress, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapCommunity=slmTrapCommunity, slmSyslogPort=slmSyslogPort, slmChPassEntry=slmChPassEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSnmpv3Password=slmSnmpv3Password, slmLicenseIndex=slmLicenseIndex, slmSwRevName=slmSwRevName, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmChPassOldPass=slmChPassOldPass, slmLogin=slmLogin, slmSysUplinkRate=slmSysUplinkRate, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysGatewayAddr=slmSysGatewayAddr, SoftwareRevision=SoftwareRevision, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuth=slmAuth, slmRstpEnabled=slmRstpEnabled, slmLicenseId=slmLicenseId, slmChPass=slmChPass)
