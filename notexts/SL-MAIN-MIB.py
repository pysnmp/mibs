...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, ModuleIdentity, NotificationType, iso, Bits, Counter32, ObjectIdentity, Gauge32, Opaque, MibIdentifier, Counter64, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "ModuleIdentity", "NotificationType", "iso", "Bits", "Counter32", "ObjectIdentity", "Gauge32", "Opaque", "MibIdentifier", "Counter64", "IpAddress", "Unsigned32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapSysLocationChange=slmTrapSysLocationChange, slmEdfaNumber=slmEdfaNumber, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogParam3=slmTrapLogParam3, slmSwRevDirectory=slmSwRevDirectory, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAuth=slmAuth, slmSysSubnetMask=slmSysSubnetMask, slmSysIpAddr=slmSysIpAddr, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestCommunity=slmTrapDestCommunity, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminPassword=slmAdminPassword, slmLicenseEntry=slmLicenseEntry, slmRstpEnabled=slmRstpEnabled, slmSysAlmDeact=slmSysAlmDeact, slmLicenseExpiration=slmLicenseExpiration, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogParam1=slmTrapLogParam1, slmSysGatewayAddr=slmSysGatewayAddr, slmSyslogDestTable=slmSyslogDestTable, slmTopologyEnabled=slmTopologyEnabled, slmTrapEnable=slmTrapEnable, slmLogin=slmLogin, UserCommunity=UserCommunity, slmSysSnmpVersion=slmSysSnmpVersion, slmSyslogPort=slmSyslogPort, slmSysCalendarTime=slmSysCalendarTime, slmTid=slmTid, slmTrapLogEntry=slmTrapLogEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmChPassLogin=slmChPassLogin, slmTrapUserLogin=slmTrapUserLogin, slmPsuNumber=slmPsuNumber, SoftwareRevision=SoftwareRevision, slmSysEncryptionCapability=slmSysEncryptionCapability, slmReadCommunity=slmReadCommunity, slmTrapLogName=slmTrapLogName, slmAdminCommunity=slmAdminCommunity, slmSysUplinkRate=slmSysUplinkRate, PYSNMP_MODULE_ID=slMain, slmAuthEntry=slmAuthEntry, slmLicenseTable=slmLicenseTable, slmLicenseIndex=slmLicenseIndex, slmSwRevName=slmSwRevName, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogTable=slmTrapLogTable, slmAdminRowStatus=slmAdminRowStatus, slmBoxSize=slmBoxSize, slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPassEntry=slmChPassEntry, UserLogin=UserLogin, slmSysTemperature=slmSysTemperature, slMain=slMain, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysChassisId=slmSysChassisId, slmSyslogLevel=slmSyslogLevel, slmSysAlmAct=slmSysAlmAct, slmSysName=slmSysName, slmSysOperStatus=slmSysOperStatus, slmSysTrapFormat=slmSysTrapFormat, slmLicenseId=slmLicenseId, slmSwRevStatus=slmSwRevStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmChPassNewPass=slmChPassNewPass, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmRebootDelay=slmRebootDelay, slmChPass=slmChPass, slmVcatDelay=slmVcatDelay, slmTrapDestTable=slmTrapDestTable, slmAuthTable=slmAuthTable, slmChPassTable=slmChPassTable, slmAdminTable=slmAdminTable, AdminAccess=AdminAccess, slmTrapLogId=slmTrapLogId, slmTrap=slmTrap, slmSysMode=slmSysMode, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmMuxNumber=slmMuxNumber, slmConfigSysUptime=slmConfigSysUptime, UserPassword=UserPassword, slmSwRevDate=slmSwRevDate, slmSysLocation=slmSysLocation, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysLanIpAddr=slmSysLanIpAddr, slmAdminEntry=slmAdminEntry, slmAuthPassword=slmAuthPassword, slmTrapLogParam6=slmTrapLogParam6, slmPortsNumber=slmPortsNumber, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysAdminStatus=slmSysAdminStatus, slmTrapPort=slmTrapPort, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam4=slmTrapLogParam4, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminAccess=slmAdminAccess, slmSnmpv3Auth=slmSnmpv3Auth, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAuthCommunity=slmAuthCommunity, slmTrapDestAddress=slmTrapDestAddress, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysResetPm=slmSysResetPm, slmLicense=slmLicense, slmSysNetworkPrefix=slmSysNetworkPrefix, slmConfigSysSignalType=slmConfigSysSignalType, slmAdmin=slmAdmin, slmLogFile=slmLogFile, slmConfigFile=slmConfigFile, slmOemType=slmOemType, slmChPassOldPass=slmChPassOldPass, slmSnmpv3Password=slmSnmpv3Password, slmNetworkMode=slmNetworkMode, slmTrapDestEntry=slmTrapDestEntry, slmPmAvailable=slmPmAvailable, slm40GConf=slm40GConf, slmSys=slmSys, slmTrapCommunity=slmTrapCommunity, slmAdminLogin=slmAdminLogin, slmTrapLogParam2=slmTrapLogParam2, slmWriteCommunity=slmWriteCommunity, slmSwRevTable=slmSwRevTable, slmSwRevEntry=slmSwRevEntry, slmAuthLogin=slmAuthLogin)
