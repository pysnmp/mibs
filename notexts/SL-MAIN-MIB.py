...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAuthTable=slmAuthTable, slmAuth=slmAuth, slmSysGatewayAddr=slmSysGatewayAddr, slmLogin=slmLogin, slmAdmin=slmAdmin, slmTrapLogParam3=slmTrapLogParam3, slmSysLanIpAddr=slmSysLanIpAddr, PYSNMP_MODULE_ID=slMain, UserLogin=UserLogin, slmSysTrapFormat=slmSysTrapFormat, slmSys=slmSys, UserCommunity=UserCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminEntry=slmAdminEntry, slmSwRevEntry=slmSwRevEntry, slmLicenseExpiration=slmLicenseExpiration, slmSyslogLevel=slmSyslogLevel, slmAuthEntry=slmAuthEntry, slmTopologyEnabled=slmTopologyEnabled, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestProtVersion=slmTrapDestProtVersion, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevDirectory=slmSwRevDirectory, slmRebootDelay=slmRebootDelay, slmTrapLogParam5=slmTrapLogParam5, slmTrapSysNameChange=slmTrapSysNameChange, slmSysAlmAct=slmSysAlmAct, slmSnmpv3Password=slmSnmpv3Password, slmSwRevDate=slmSwRevDate, slmConfigSysUptime=slmConfigSysUptime, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogParam4=slmTrapLogParam4, slmSysName=slmSysName, slmTrapEnable=slmTrapEnable, slmSwRevName=slmSwRevName, slmOemType=slmOemType, slmSysTemperature=slmSysTemperature, slmTrapDestRowStatus=slmTrapDestRowStatus, slmLicenseIndex=slmLicenseIndex, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysLocation=slmSysLocation, slmSnmpv3Priv=slmSnmpv3Priv, slmChPass=slmChPass, slmRstpEnabled=slmRstpEnabled, slmPmAvailable=slmPmAvailable, slmAdminAccess=slmAdminAccess, slm40GConf=slm40GConf, slmTrapLogParam1=slmTrapLogParam1, slmAuthPassword=slmAuthPassword, slmAdminCommunity=slmAdminCommunity, slmAuthCommunity=slmAuthCommunity, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestCommunity=slmTrapDestCommunity, slmTid=slmTid, slmChPassNewPass=slmChPassNewPass, slmTrapUserLogin=slmTrapUserLogin, slmAdminLogin=slmAdminLogin, slmPsuNumber=slmPsuNumber, slmTrapLogTable=slmTrapLogTable, slmLicenseEntry=slmLicenseEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysChassisId=slmSysChassisId, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrap=slmTrap, slmSysIpAddr=slmSysIpAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmChPassLogin=slmChPassLogin, slmSysMode=slmSysMode, slmTrapPort=slmTrapPort, slmChPassOldPass=slmChPassOldPass, slmLicense=slmLicense, AdminAccess=AdminAccess, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSnmpv3Auth=slmSnmpv3Auth, slmLogFile=slmLogFile, slmSysNetworkPrefix=slmSysNetworkPrefix, slMain=slMain, slmTrapCommunity=slmTrapCommunity, slmPortsNumber=slmPortsNumber, slmEdfaNumber=slmEdfaNumber, slmNetworkMode=slmNetworkMode, slmTrapDestIpAddress=slmTrapDestIpAddress, slmMuxNumber=slmMuxNumber, slmWriteCommunity=slmWriteCommunity, slmSysOperStatus=slmSysOperStatus, slmSyslogDestAddress=slmSyslogDestAddress, slmChPassTable=slmChPassTable, slmTrapLogId=slmTrapLogId, slmAdminTable=slmAdminTable, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLicenseId=slmLicenseId, slmSyslogPort=slmSyslogPort, slmBoxSize=slmBoxSize, slmSysUplinkRate=slmSysUplinkRate, slmSwRevStatus=slmSwRevStatus, slmReadCommunity=slmReadCommunity, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogEntry=slmTrapLogEntry, UserPassword=UserPassword, slmAuthLogin=slmAuthLogin, SoftwareRevision=SoftwareRevision, slmTrapLogParam2=slmTrapLogParam2, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysResetPm=slmSysResetPm, slmTrapLogName=slmTrapLogName, slmSyslogDestTable=slmSyslogDestTable, slmChPassEntry=slmChPassEntry, slmVcatDelay=slmVcatDelay, slmTrapDestAddress=slmTrapDestAddress, slmLicenseTable=slmLicenseTable, slmSwRevTable=slmSwRevTable, slmTrapDestEntry=slmTrapDestEntry, slmSysAlmDeact=slmSysAlmDeact, slmTrapDestTable=slmTrapDestTable, slmSyslogDestEntry=slmSyslogDestEntry, slmConfigFile=slmConfigFile, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminPassword=slmAdminPassword, slmTrapUserAccess=slmTrapUserAccess, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr)
