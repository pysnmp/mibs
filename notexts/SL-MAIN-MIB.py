...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapPort=slmTrapPort, slmChPass=slmChPass, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapCommunity=slmTrapCommunity, slmSysOperStatus=slmSysOperStatus, slmTrapLogTable=slmTrapLogTable, AdminAccess=AdminAccess, slmAuthLogin=slmAuthLogin, slmAuthEntry=slmAuthEntry, slmAdminPassword=slmAdminPassword, slmSyslogDestTable=slmSyslogDestTable, slmSyslogPort=slmSyslogPort, slmSwRevStatus=slmSwRevStatus, slmSnmpv3Password=slmSnmpv3Password, slmAuthPassword=slmAuthPassword, slmAdminRowStatus=slmAdminRowStatus, slmTopologyEnabled=slmTopologyEnabled, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSwRevDate=slmSwRevDate, slmLicenseExpiration=slmLicenseExpiration, SoftwareRevision=SoftwareRevision, slmSysMode=slmSysMode, slmSwRevEntry=slmSwRevEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysAlmDeact=slmSysAlmDeact, slmPortsNumber=slmPortsNumber, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogId=slmTrapLogId, slmSwRevTable=slmSwRevTable, UserCommunity=UserCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmWriteCommunity=slmWriteCommunity, slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapDestTable=slmTrapDestTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysAdminStatus=slmSysAdminStatus, slmSwRevDirectory=slmSwRevDirectory, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSys=slmSys, slmConfigSysSignalType=slmConfigSysSignalType, slmSysChassisId=slmSysChassisId, slmAuthTable=slmAuthTable, slmSysUplinkRate=slmSysUplinkRate, slmLicenseEntry=slmLicenseEntry, slmSysIpAddr=slmSysIpAddr, slmReadCommunity=slmReadCommunity, slmSysAlmAct=slmSysAlmAct, slmSysTrapFormat=slmSysTrapFormat, slmChPassNewPass=slmChPassNewPass, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapSysNameChange=slmTrapSysNameChange, slmAdminTable=slmAdminTable, slmTrapLogParam2=slmTrapLogParam2, slmMuxNumber=slmMuxNumber, UserPassword=UserPassword, slmOemType=slmOemType, slmTrapUserLogin=slmTrapUserLogin, slmChPassOldPass=slmChPassOldPass, slmLicense=slmLicense, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogEntry=slmTrapLogEntry, slmLicenseTable=slmLicenseTable, slmTrapDestCommunity=slmTrapDestCommunity, slmBoxSize=slmBoxSize, slmLogFile=slmLogFile, slmSysResetPm=slmSysResetPm, slmNetworkMode=slmNetworkMode, slmSysLocation=slmSysLocation, slmVcatDelay=slmVcatDelay, slmSysTemperature=slmSysTemperature, slmConfigSysUptime=slmConfigSysUptime, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapUserAccess=slmTrapUserAccess, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTid=slmTid, slmSyslogLevel=slmSyslogLevel, slmAuth=slmAuth, UserLogin=UserLogin, slmTrapEnable=slmTrapEnable, slmTrapLogParam5=slmTrapLogParam5, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogParam3=slmTrapLogParam3, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmEdfaNumber=slmEdfaNumber, slmSysSubnetMask=slmSysSubnetMask, slmTrapDestAddress=slmTrapDestAddress, slmLicenseId=slmLicenseId, slmTrapLogParam1=slmTrapLogParam1, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSwRevName=slmSwRevName, slmPmAvailable=slmPmAvailable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slMain=slMain, slmSnmpv3Priv=slmSnmpv3Priv, slmConfigFile=slmConfigFile, slmChPassLogin=slmChPassLogin, slmTrapLogName=slmTrapLogName, slmLicenseIndex=slmLicenseIndex, slmTrapLogParam6=slmTrapLogParam6, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysName=slmSysName, slmPsuNumber=slmPsuNumber, slm40GConf=slm40GConf, slmAdmin=slmAdmin, slmRstpEnabled=slmRstpEnabled, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminAccess=slmAdminAccess, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam4=slmTrapLogParam4, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLogin=slmLogin, slmTrap=slmTrap, slmAdminCommunity=slmAdminCommunity, slmSysCalendarTime=slmSysCalendarTime, slmChPassTable=slmChPassTable, slmSyslogDestAddress=slmSyslogDestAddress, PYSNMP_MODULE_ID=slMain, slmRebootDelay=slmRebootDelay, slmAuthCommunity=slmAuthCommunity, slmChPassEntry=slmChPassEntry, slmSnmpv3Auth=slmSnmpv3Auth, slmAdminLogin=slmAdminLogin, slmAdminEntry=slmAdminEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp)
