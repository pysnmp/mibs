...
Integer32, NotificationType, Bits, Gauge32, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Opaque, IpAddress, ModuleIdentity, Counter32, Unsigned32, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Bits", "Gauge32", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Opaque", "IpAddress", "ModuleIdentity", "Counter32", "Unsigned32", "iso", "ObjectIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysUplinkRate=slmSysUplinkRate, slmSysSnmpVersion=slmSysSnmpVersion, slmPortsNumber=slmPortsNumber, slmChPassNewPass=slmChPassNewPass, slmTrapDestTable=slmTrapDestTable, PYSNMP_MODULE_ID=slMain, slmTrapSysNameChange=slmTrapSysNameChange, slmTopologyEnabled=slmTopologyEnabled, slmSwRevEntry=slmSwRevEntry, slmSwRevName=slmSwRevName, slmVcatDelay=slmVcatDelay, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogId=slmTrapLogId, slmSwRevDate=slmSwRevDate, slmAuthLogin=slmAuthLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, UserCommunity=UserCommunity, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAuthCommunity=slmAuthCommunity, UserPassword=UserPassword, slmSwRevTable=slmSwRevTable, slmSnmpv3Password=slmSnmpv3Password, slmPsuNumber=slmPsuNumber, slmAdminPassword=slmAdminPassword, slmAuthPassword=slmAuthPassword, slmLicenseTable=slmLicenseTable, slmSysOperStatus=slmSysOperStatus, slmSysSubnetMask=slmSysSubnetMask, slmSysResetPm=slmSysResetPm, slmSysLanIpAddr=slmSysLanIpAddr, SoftwareRevision=SoftwareRevision, slmSyslogDestTable=slmSyslogDestTable, slmSysAlmAct=slmSysAlmAct, slmSysLocation=slmSysLocation, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminEntry=slmAdminEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAuth=slmAuth, slmSyslogDestEntry=slmSyslogDestEntry, slm40GConf=slm40GConf, slmAdmin=slmAdmin, slmTid=slmTid, slmSysGatewayAddr=slmSysGatewayAddr, slmSyslogDestAddress=slmSyslogDestAddress, slmSysCalendarTime=slmSysCalendarTime, AdminAccess=AdminAccess, slmSwRevDirectory=slmSwRevDirectory, slmAdminRowStatus=slmAdminRowStatus, slmTrapLogParam4=slmTrapLogParam4, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapUserAccess=slmTrapUserAccess, slMain=slMain, slmRstpEnabled=slmRstpEnabled, slmTrap=slmTrap, slmAuthTable=slmAuthTable, slmTrapDestCommunity=slmTrapDestCommunity, slmSyslogLevel=slmSyslogLevel, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam3=slmTrapLogParam3, slmRebootDelay=slmRebootDelay, UserLogin=UserLogin, slmSysChassisId=slmSysChassisId, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSnmpv3Auth=slmSnmpv3Auth, slmConfigFile=slmConfigFile, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmLicenseIndex=slmLicenseIndex, slmConfigSysSignalType=slmConfigSysSignalType, slmOemType=slmOemType, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysTemperature=slmSysTemperature, slmTrapDestAddress=slmTrapDestAddress, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmPmAvailable=slmPmAvailable, slmTrapLogParam2=slmTrapLogParam2, slmChPassOldPass=slmChPassOldPass, slmBoxSize=slmBoxSize, slmTrapDestEntry=slmTrapDestEntry, slmChPass=slmChPass, slmEdfaNumber=slmEdfaNumber, slmTrapLogTable=slmTrapLogTable, slmSysEncryptionCapability=slmSysEncryptionCapability, slmNetworkMode=slmNetworkMode, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam1=slmTrapLogParam1, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysIpAddr=slmSysIpAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLogin=slmLogin, slmAdminLogin=slmAdminLogin, slmSysAlmDeact=slmSysAlmDeact, slmAdminTable=slmAdminTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSys=slmSys, slmSysAdminStatus=slmSysAdminStatus, slmWriteCommunity=slmWriteCommunity, slmReadCommunity=slmReadCommunity, slmChPassEntry=slmChPassEntry, slmTrapLogParam5=slmTrapLogParam5, slmLicense=slmLicense, slmLicenseExpiration=slmLicenseExpiration, slmSnmpv3Priv=slmSnmpv3Priv, slmSysTrapFormat=slmSysTrapFormat, slmAdminCommunity=slmAdminCommunity, slmSyslogPort=slmSyslogPort, slmLicenseEntry=slmLicenseEntry, slmLogFile=slmLogFile, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSwRevStatus=slmSwRevStatus, slmChPassLogin=slmChPassLogin, slmTrapUserLogin=slmTrapUserLogin, slmConfigSysUptime=slmConfigSysUptime, slmAdminAccess=slmAdminAccess, slmTrapPort=slmTrapPort, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAuthEntry=slmAuthEntry, slmLicenseId=slmLicenseId, slmChPassTable=slmChPassTable, slmSysMode=slmSysMode, slmTrapEnable=slmTrapEnable, slmTrapLogName=slmTrapLogName, slmTrapCommunity=slmTrapCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmMuxNumber=slmMuxNumber, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysName=slmSysName)
