...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, MibIdentifier, ObjectIdentity, Unsigned32, Gauge32, NotificationType, IpAddress, Bits, Counter32, Integer32, iso, Opaque, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "MibIdentifier", "ObjectIdentity", "Unsigned32", "Gauge32", "NotificationType", "IpAddress", "Bits", "Counter32", "Integer32", "iso", "Opaque", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicenseIndex=slmLicenseIndex, SoftwareRevision=SoftwareRevision, slmAdminTable=slmAdminTable, slmMuxNumber=slmMuxNumber, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSwRevStatus=slmSwRevStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSnmpv3Priv=slmSnmpv3Priv, slmSysIpAddr=slmSysIpAddr, slmSysEncryptionCapability=slmSysEncryptionCapability, slmChPassTable=slmChPassTable, slmTrapUserLogin=slmTrapUserLogin, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmLogin=slmLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmTid=slmTid, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapLogParam6=slmTrapLogParam6, slMain=slMain, slmTrapLogId=slmTrapLogId, slmVcatDelay=slmVcatDelay, slmWriteCommunity=slmWriteCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmAdmin=slmAdmin, slmLicenseEntry=slmLicenseEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, UserPassword=UserPassword, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogEntry=slmTrapLogEntry, slmAdminLogin=slmAdminLogin, slmAuthLogin=slmAuthLogin, slmChPassEntry=slmChPassEntry, slmSysMode=slmSysMode, slmLicense=slmLicense, slmTrapDestAddress=slmTrapDestAddress, slmTopologyEnabled=slmTopologyEnabled, slmSys=slmSys, slmAuthEntry=slmAuthEntry, slmChPassNewPass=slmChPassNewPass, slmSysChassisId=slmSysChassisId, slmAuth=slmAuth, slmChPass=slmChPass, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSwRevEntry=slmSwRevEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmAuthTable=slmAuthTable, slmTrapUserAccess=slmTrapUserAccess, slmSwRevDate=slmSwRevDate, slmTrapLogParam5=slmTrapLogParam5, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAdminAccess=slmAdminAccess, slmReadCommunity=slmReadCommunity, slm40GConf=slm40GConf, slmSysAdminStatus=slmSysAdminStatus, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestTable=slmTrapDestTable, slmTrapLogName=slmTrapLogName, slmSyslogPort=slmSyslogPort, slmTrapEnable=slmTrapEnable, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSwRevName=slmSwRevName, slmTrapCommunity=slmTrapCommunity, slmEdfaNumber=slmEdfaNumber, slmTrapLogParam2=slmTrapLogParam2, slmSysAlmDeact=slmSysAlmDeact, slmAdminPassword=slmAdminPassword, slmSysOperStatus=slmSysOperStatus, slmOemType=slmOemType, slmSyslogDestTable=slmSyslogDestTable, slmPortsNumber=slmPortsNumber, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAuthCommunity=slmAuthCommunity, slmTrap=slmTrap, slmSysLanIpAddr=slmSysLanIpAddr, UserLogin=UserLogin, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminRowStatus=slmAdminRowStatus, PYSNMP_MODULE_ID=slMain, slmSysResetPm=slmSysResetPm, slmTrapLogParam3=slmTrapLogParam3, slmSysAlmAct=slmSysAlmAct, slmPmAvailable=slmPmAvailable, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLocation=slmSysLocation, slmTrapPort=slmTrapPort, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysSubnetMask=slmSysSubnetMask, slmSwRevTable=slmSwRevTable, slmRebootDelay=slmRebootDelay, slmTrapLogTable=slmTrapLogTable, slmConfigSysSignalType=slmConfigSysSignalType, slmBoxSize=slmBoxSize, slmSyslogDestAddress=slmSyslogDestAddress, slmSysName=slmSysName, slmSwRevDirectory=slmSwRevDirectory, slmChPassLogin=slmChPassLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmPsuNumber=slmPsuNumber, slmLicenseId=slmLicenseId, slmAdminEntry=slmAdminEntry, slmTrapDestEntry=slmTrapDestEntry, slmSysUplinkRate=slmSysUplinkRate, slmSysSnmpVersion=slmSysSnmpVersion, slmSnmpv3Auth=slmSnmpv3Auth, slmAuthPassword=slmAuthPassword, AdminAccess=AdminAccess, slmOpticalSwitchExist=slmOpticalSwitchExist, slmLogFile=slmLogFile, slmChPassOldPass=slmChPassOldPass, slmConfigFile=slmConfigFile, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogParam1=slmTrapLogParam1, slmSyslogLevel=slmSyslogLevel, slmNetworkMode=slmNetworkMode, slmRstpEnabled=slmRstpEnabled, UserCommunity=UserCommunity, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminCommunity=slmAdminCommunity, slmSysTemperature=slmSysTemperature, slmLicenseTable=slmLicenseTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmConfigSysUptime=slmConfigSysUptime, slmLicenseExpiration=slmLicenseExpiration)
