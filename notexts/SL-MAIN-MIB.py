...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminCommunity=slmAdminCommunity, slmTrapCommunity=slmTrapCommunity, slmVcatDelay=slmVcatDelay, slmTrapDestEntry=slmTrapDestEntry, slmAuthCommunity=slmAuthCommunity, slmTrapLogName=slmTrapLogName, slmLicenseId=slmLicenseId, slmLogin=slmLogin, slmAdminEntry=slmAdminEntry, slmSyslogDestTable=slmSyslogDestTable, slmTrapUserAccess=slmTrapUserAccess, slmSysLocation=slmSysLocation, slmTrapPort=slmTrapPort, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAuthEntry=slmAuthEntry, slmSysTrapFormat=slmSysTrapFormat, slmAuthPassword=slmAuthPassword, slmMuxNumber=slmMuxNumber, slmSysAlmAct=slmSysAlmAct, slmTrapLogTable=slmTrapLogTable, slmSysChassisId=slmSysChassisId, slmAdminRowStatus=slmAdminRowStatus, AdminAccess=AdminAccess, slmAdminAccess=slmAdminAccess, slmConfigFile=slmConfigFile, slm40GConf=slm40GConf, slmAuth=slmAuth, slmAdminPassword=slmAdminPassword, slmSwRevName=slmSwRevName, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slMain=slMain, slmSysMode=slmSysMode, slmAdmin=slmAdmin, UserPassword=UserPassword, slmSysOperStatus=slmSysOperStatus, slmSyslogPort=slmSyslogPort, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmEdfaNumber=slmEdfaNumber, slmSysIpAddr=slmSysIpAddr, slmTrapEnable=slmTrapEnable, slmSnmpv3Auth=slmSnmpv3Auth, slmBoxSize=slmBoxSize, slmPsuNumber=slmPsuNumber, slmSysSubnetMask=slmSysSubnetMask, slmChPassNewPass=slmChPassNewPass, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapUserLogin=slmTrapUserLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmSysName=slmSysName, slmSwRevStatus=slmSwRevStatus, slmLicenseIndex=slmLicenseIndex, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogParam1=slmTrapLogParam1, UserCommunity=UserCommunity, slmTrapSysNameChange=slmTrapSysNameChange, slmAuthTable=slmAuthTable, slmLicense=slmLicense, slmPortsNumber=slmPortsNumber, slmSwRevEntry=slmSwRevEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTid=slmTid, SoftwareRevision=SoftwareRevision, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogId=slmTrapLogId, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogParam2=slmTrapLogParam2, slmAuthLogin=slmAuthLogin, slmSysAdminStatus=slmSysAdminStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevTable=slmSwRevTable, slmSysCalendarTime=slmSysCalendarTime, slmConfigSysUptime=slmConfigSysUptime, slmRebootDelay=slmRebootDelay, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmSwRevDate=slmSwRevDate, slmSysEncryptionCapability=slmSysEncryptionCapability, slmRstpEnabled=slmRstpEnabled, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestAddress=slmSyslogDestAddress, slmNetworkMode=slmNetworkMode, slmLogFile=slmLogFile, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, slmChPassTable=slmChPassTable, slmChPassEntry=slmChPassEntry, PYSNMP_MODULE_ID=slMain, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrap=slmTrap, slmSysResetPm=slmSysResetPm, slmChPassLogin=slmChPassLogin, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestTable=slmTrapDestTable, slmWriteCommunity=slmWriteCommunity, slmLicenseTable=slmLicenseTable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmSysUplinkRate=slmSysUplinkRate, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogParam4=slmTrapLogParam4, slmSys=slmSys, slmPmAvailable=slmPmAvailable, slmAdminTable=slmAdminTable, slmLicenseExpiration=slmLicenseExpiration, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminLogin=slmAdminLogin, slmLicenseEntry=slmLicenseEntry, slmOemType=slmOemType, UserLogin=UserLogin, slmChPassOldPass=slmChPassOldPass, slmSnmpv3Password=slmSnmpv3Password, slmReadCommunity=slmReadCommunity, slmSysAlmDeact=slmSysAlmDeact, slmSysTemperature=slmSysTemperature, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogParam3=slmTrapLogParam3, slmSyslogLevel=slmSyslogLevel, slmChPass=slmChPass, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr)
