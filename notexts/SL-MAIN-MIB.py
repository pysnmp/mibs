...
Bits, ObjectIdentity, iso, Integer32, IpAddress, NotificationType, Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, Counter32, MibIdentifier, Opaque, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "iso", "Integer32", "IpAddress", "NotificationType", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "Counter32", "MibIdentifier", "Opaque", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPassLogin=slmChPassLogin, slmTrapSysNameChange=slmTrapSysNameChange, slmVcatDelay=slmVcatDelay, slmSwRevDirectory=slmSwRevDirectory, slmSysLocation=slmSysLocation, slmSysSubnetMask=slmSysSubnetMask, slmLicenseIndex=slmLicenseIndex, slmAdminPassword=slmAdminPassword, slmSysUplinkRate=slmSysUplinkRate, slmSyslogPort=slmSyslogPort, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapCommunity=slmTrapCommunity, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogTable=slmTrapLogTable, slmAuthPassword=slmAuthPassword, slmChPassOldPass=slmChPassOldPass, slmSysLanIpAddr=slmSysLanIpAddr, slmSysChassisId=slmSysChassisId, slmTrapDestCommunity=slmTrapDestCommunity, slmOemType=slmOemType, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapEnable=slmTrapEnable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysAlmDeact=slmSysAlmDeact, slmSysIpAddr=slmSysIpAddr, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAuthTable=slmAuthTable, slmSwRevDate=slmSwRevDate, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogName=slmTrapLogName, slmTrapDestIpAddress=slmTrapDestIpAddress, AdminAccess=AdminAccess, slmSysResetPm=slmSysResetPm, slmTopologyEnabled=slmTopologyEnabled, slmChPassTable=slmChPassTable, slmTid=slmTid, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogParam3=slmTrapLogParam3, slmRstpEnabled=slmRstpEnabled, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, PYSNMP_MODULE_ID=slMain, slmSnmpv3Password=slmSnmpv3Password, slmAdminLogin=slmAdminLogin, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogId=slmTrapLogId, slmAuth=slmAuth, slmSysCalendarTime=slmSysCalendarTime, slmSnmpv3Auth=slmSnmpv3Auth, slmLicenseExpiration=slmLicenseExpiration, slmChPassEntry=slmChPassEntry, slmSwRevName=slmSwRevName, slmTrapLogParam1=slmTrapLogParam1, slmSyslogDestTable=slmSyslogDestTable, slmLicenseTable=slmLicenseTable, slmSys=slmSys, slmNetworkMode=slmNetworkMode, slmReadCommunity=slmReadCommunity, slm40GConf=slm40GConf, slmSyslogLevel=slmSyslogLevel, slmSwRevTable=slmSwRevTable, slmLogFile=slmLogFile, slmMuxNumber=slmMuxNumber, UserCommunity=UserCommunity, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapUserAccess=slmTrapUserAccess, slMain=slMain, slmAdminRowStatus=slmAdminRowStatus, slmConfigSysUptime=slmConfigSysUptime, slmAdminTable=slmAdminTable, SoftwareRevision=SoftwareRevision, UserLogin=UserLogin, slmRebootDelay=slmRebootDelay, slmSwRevStatus=slmSwRevStatus, slmChPassNewPass=slmChPassNewPass, UserPassword=UserPassword, slmPmAvailable=slmPmAvailable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysOperStatus=slmSysOperStatus, slmAuthCommunity=slmAuthCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSyslogDestAddress=slmSyslogDestAddress, slmSysMode=slmSysMode, slmSnmpv3Priv=slmSnmpv3Priv, slmSwRevEntry=slmSwRevEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmWriteCommunity=slmWriteCommunity, slmAdminCommunity=slmAdminCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicense=slmLicense, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysSnmpVersion=slmSysSnmpVersion, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminEntry=slmAdminEntry, slmTrapLogParam4=slmTrapLogParam4, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAuthLogin=slmAuthLogin, slmEdfaNumber=slmEdfaNumber, slmPsuNumber=slmPsuNumber, slmLogin=slmLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysName=slmSysName, slmAdminAccess=slmAdminAccess, slmTrapLogParam6=slmTrapLogParam6, slmLicenseEntry=slmLicenseEntry, slmAdmin=slmAdmin, slmChPass=slmChPass, slmTrapLogEntry=slmTrapLogEntry, slmSysAlmAct=slmSysAlmAct, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam5=slmTrapLogParam5, slmConfigFile=slmConfigFile, slmBoxSize=slmBoxSize, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapPort=slmTrapPort, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmLicenseId=slmLicenseId, slmTrapUserLogin=slmTrapUserLogin, slmSysTrapFormat=slmSysTrapFormat, slmSysTemperature=slmSysTemperature, slmPortsNumber=slmPortsNumber, slmSyslogDestEntry=slmSyslogDestEntry, slmAuthEntry=slmAuthEntry, slmTrap=slmTrap)
