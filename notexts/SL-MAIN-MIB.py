...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, Unsigned32, MibIdentifier, TimeTicks, ObjectIdentity, Integer32, Gauge32, Counter64, Opaque, NotificationType, Counter32, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "Unsigned32", "MibIdentifier", "TimeTicks", "ObjectIdentity", "Integer32", "Gauge32", "Counter64", "Opaque", "NotificationType", "Counter32", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysCalendarTime=slmSysCalendarTime, slmSysSnmpVersion=slmSysSnmpVersion, slmSysChassisId=slmSysChassisId, slmSysName=slmSysName, slmTrapLogId=slmTrapLogId, UserPassword=UserPassword, slmAdminRowStatus=slmAdminRowStatus, slmSnmpv3Password=slmSnmpv3Password, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapCommunity=slmTrapCommunity, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAdminLogin=slmAdminLogin, slmLicenseEntry=slmLicenseEntry, slmAuthCommunity=slmAuthCommunity, AdminAccess=AdminAccess, slmAdminEntry=slmAdminEntry, slmLogin=slmLogin, slmTid=slmTid, slmTrapLogParam3=slmTrapLogParam3, slmSysNetworkPrefix=slmSysNetworkPrefix, slmRstpEnabled=slmRstpEnabled, slmPortsNumber=slmPortsNumber, slmAuthTable=slmAuthTable, slmSysResetPm=slmSysResetPm, slmRebootDelay=slmRebootDelay, slmEdfaNumber=slmEdfaNumber, slmNetworkMode=slmNetworkMode, slmTrapLogName=slmTrapLogName, slmSyslogDestEntry=slmSyslogDestEntry, slmSysLanIpAddr=slmSysLanIpAddr, slmConfigFile=slmConfigFile, slmSwRevStatus=slmSwRevStatus, slmChPassOldPass=slmChPassOldPass, slmSyslogDestAddress=slmSyslogDestAddress, slmAdmin=slmAdmin, UserLogin=UserLogin, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogParam2=slmTrapLogParam2, slmPsuNumber=slmPsuNumber, slmSwRevDate=slmSwRevDate, slmAuthPassword=slmAuthPassword, slmTrapDestIpAddress=slmTrapDestIpAddress, slmChPass=slmChPass, slmLicenseTable=slmLicenseTable, slmLicenseId=slmLicenseId, slmSysMode=slmSysMode, slmTrap=slmTrap, slmConfigSysUptime=slmConfigSysUptime, UserCommunity=UserCommunity, slmLicense=slmLicense, slmTrapLogParam5=slmTrapLogParam5, slMain=slMain, slmAuthLogin=slmAuthLogin, slmBoxSize=slmBoxSize, slmSwRevTable=slmSwRevTable, slmTrapDestAddress=slmTrapDestAddress, slmSysAlmDeact=slmSysAlmDeact, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysUplinkRate=slmSysUplinkRate, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestTable=slmTrapDestTable, slmTrapEnable=slmTrapEnable, slmWriteCommunity=slmWriteCommunity, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLocation=slmSysLocation, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, SoftwareRevision=SoftwareRevision, slmChPassNewPass=slmChPassNewPass, slmSwRevEntry=slmSwRevEntry, slmAdminTable=slmAdminTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmMuxNumber=slmMuxNumber, slmChPassTable=slmChPassTable, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSyslogPort=slmSyslogPort, slmTrapPort=slmTrapPort, slmSysAlmAct=slmSysAlmAct, PYSNMP_MODULE_ID=slMain, slmSysTrapFormat=slmSysTrapFormat, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSys=slmSys, slmAdminAccess=slmAdminAccess, slmSyslogDestTable=slmSyslogDestTable, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysSubnetMask=slmSysSubnetMask, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogTable=slmTrapLogTable, slmSwRevName=slmSwRevName, slmReadCommunity=slmReadCommunity, slmTrapLogParam6=slmTrapLogParam6, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapDestCommunity=slmTrapDestCommunity, slmAuth=slmAuth, slmChPassLogin=slmChPassLogin, slmAdminPassword=slmAdminPassword, slmSnmpv3Priv=slmSnmpv3Priv, slmOemType=slmOemType, slmLicenseIndex=slmLicenseIndex, slmChPassEntry=slmChPassEntry, slmSysTemperature=slmSysTemperature, slmPmAvailable=slmPmAvailable, slmTrapLogEntry=slmTrapLogEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestEntry=slmTrapDestEntry, slmAuthEntry=slmAuthEntry, slmTrapLogParam1=slmTrapLogParam1, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTopologyEnabled=slmTopologyEnabled, slmLicenseExpiration=slmLicenseExpiration, slmSnmpv3Auth=slmSnmpv3Auth, slmSyslogLevel=slmSyslogLevel, slmTrapUserLogin=slmTrapUserLogin, slmAdminCommunity=slmAdminCommunity, slm40GConf=slm40GConf, slmTrapLogParam4=slmTrapLogParam4, slmSysOperStatus=slmSysOperStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysIpAddr=slmSysIpAddr, slmVcatDelay=slmVcatDelay, slmLogFile=slmLogFile)
