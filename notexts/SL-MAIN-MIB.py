...
Integer32, iso, Gauge32, IpAddress, NotificationType, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, ObjectIdentity, Unsigned32, ModuleIdentity, Opaque, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "Gauge32", "IpAddress", "NotificationType", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Opaque", "MibIdentifier")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysActiveSwVersion=slmSysActiveSwVersion, slmTrapLogEntry=slmTrapLogEntry, slmLicenseTable=slmLicenseTable, slmAuthEntry=slmAuthEntry, slmOemType=slmOemType, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogName=slmTrapLogName, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysUplinkRate=slmSysUplinkRate, slmSysSubnetMask=slmSysSubnetMask, slmTrapLogParam6=slmTrapLogParam6, slmSysResetPm=slmSysResetPm, slmChPass=slmChPass, slmSysName=slmSysName, slmSyslogDestEntry=slmSyslogDestEntry, slmLogFile=slmLogFile, slmAdmin=slmAdmin, slmPortsNumber=slmPortsNumber, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogDestAddress=slmSyslogDestAddress, slmAuth=slmAuth, slmSysChassisId=slmSysChassisId, slmSwRevStatus=slmSwRevStatus, slmLicenseIndex=slmLicenseIndex, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmChPassLogin=slmChPassLogin, slmRstpEnabled=slmRstpEnabled, slmVcatDelay=slmVcatDelay, slmTrapLogTable=slmTrapLogTable, slmAuthPassword=slmAuthPassword, slmLicenseExpiration=slmLicenseExpiration, slmSysAlmAct=slmSysAlmAct, slmSysOperStatus=slmSysOperStatus, slmAdminAccess=slmAdminAccess, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapEnable=slmTrapEnable, slmSysLanIpAddr=slmSysLanIpAddr, slmSnmpv3Password=slmSnmpv3Password, slmTrap=slmTrap, slmNetworkMode=slmNetworkMode, slmSnmpv3Priv=slmSnmpv3Priv, slmConfigFile=slmConfigFile, slmLicenseId=slmLicenseId, UserLogin=UserLogin, slmTrapCommunity=slmTrapCommunity, slmEdfaNumber=slmEdfaNumber, slmWriteCommunity=slmWriteCommunity, slmSwRevEntry=slmSwRevEntry, slmAdminTable=slmAdminTable, slmTrapLogParam1=slmTrapLogParam1, slmPsuNumber=slmPsuNumber, slmSysGatewayAddr=slmSysGatewayAddr, slmAuthTable=slmAuthTable, slmSys=slmSys, slmSyslogDestTable=slmSyslogDestTable, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapPort=slmTrapPort, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmReadCommunity=slmReadCommunity, slmAdminCommunity=slmAdminCommunity, slmPmAvailable=slmPmAvailable, slmTrapSysNameChange=slmTrapSysNameChange, slmChPassNewPass=slmChPassNewPass, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogPort=slmSyslogPort, slmSysTrapFormat=slmSysTrapFormat, slmAdminPassword=slmAdminPassword, slmTrapLogParam3=slmTrapLogParam3, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmChPassTable=slmChPassTable, slmLicenseEntry=slmLicenseEntry, slmTrapLogParam5=slmTrapLogParam5, slmSwRevTable=slmSwRevTable, slmTrapLogId=slmTrapLogId, slmMuxNumber=slmMuxNumber, slmLogin=slmLogin, slmChPassEntry=slmChPassEntry, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminLogin=slmAdminLogin, slmSysTemperature=slmSysTemperature, slmTopologyEnabled=slmTopologyEnabled, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysAdminStatus=slmSysAdminStatus, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam2=slmTrapLogParam2, slmTrapUserLogin=slmTrapUserLogin, slmSwRevDirectory=slmSwRevDirectory, slm40GConf=slm40GConf, slmAuthCommunity=slmAuthCommunity, slmChPassOldPass=slmChPassOldPass, slmRebootDelay=slmRebootDelay, slmConfigSysUptime=slmConfigSysUptime, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicense=slmLicense, slmAuthLogin=slmAuthLogin, slmTrapLogParam4=slmTrapLogParam4, slmSysIpAddr=slmSysIpAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapUserAccess=slmTrapUserAccess, AdminAccess=AdminAccess, slmAdminEntry=slmAdminEntry, slmTrapDestTable=slmTrapDestTable, SoftwareRevision=SoftwareRevision, UserCommunity=UserCommunity, slmSysCalendarTime=slmSysCalendarTime, slmSwRevDate=slmSwRevDate, slmBoxSize=slmBoxSize, slmTid=slmTid, slmSwRevName=slmSwRevName, slmSysMode=slmSysMode, PYSNMP_MODULE_ID=slMain, slmAdminRowStatus=slmAdminRowStatus, UserPassword=UserPassword, slmSyslogLevel=slmSyslogLevel, slmSnmpv3Auth=slmSnmpv3Auth, slmSysLocation=slmSysLocation, slMain=slMain, slmOpticalSwitchExist=slmOpticalSwitchExist)
