...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPassLogin=slmChPassLogin, slmSwRevTable=slmSwRevTable, slmSysChassisId=slmSysChassisId, slmPmAvailable=slmPmAvailable, slmSysAlmDeact=slmSysAlmDeact, slmOpticalSwitchExist=slmOpticalSwitchExist, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysPmStartOfDay=slmSysPmStartOfDay, slmPortsNumber=slmPortsNumber, slmChPassTable=slmChPassTable, slmRstpEnabled=slmRstpEnabled, slmAdminRowStatus=slmAdminRowStatus, slmTrapCommunity=slmTrapCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSyslogDestAddress=slmSyslogDestAddress, UserCommunity=UserCommunity, slmAdminPassword=slmAdminPassword, slmTrapLogParam1=slmTrapLogParam1, slmAuthEntry=slmAuthEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysSnmpVersion=slmSysSnmpVersion, AdminAccess=AdminAccess, slmLicenseIndex=slmLicenseIndex, slmSysAlmAct=slmSysAlmAct, slmChPass=slmChPass, slmNetworkMode=slmNetworkMode, slmTrapDestTable=slmTrapDestTable, slmTrapLogName=slmTrapLogName, SoftwareRevision=SoftwareRevision, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSnmpv3Auth=slmSnmpv3Auth, slmSwRevEntry=slmSwRevEntry, PYSNMP_MODULE_ID=slMain, slmChPassEntry=slmChPassEntry, slmLogin=slmLogin, slmSysIpAddr=slmSysIpAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam6=slmTrapLogParam6, slmTrapLogParam5=slmTrapLogParam5, slmRebootDelay=slmRebootDelay, slmTrapEnable=slmTrapEnable, slmReadCommunity=slmReadCommunity, slmSysCalendarTime=slmSysCalendarTime, slmSysOperStatus=slmSysOperStatus, slmSysGatewayAddr=slmSysGatewayAddr, slmAuthPassword=slmAuthPassword, slmSyslogDestTable=slmSyslogDestTable, slmTrapSysNameChange=slmTrapSysNameChange, slmChPassOldPass=slmChPassOldPass, slmSyslogLevel=slmSyslogLevel, slmAdminTable=slmAdminTable, slmLicenseTable=slmLicenseTable, slmAuthLogin=slmAuthLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slm40GConf=slm40GConf, slmLicenseId=slmLicenseId, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSyslogPort=slmSyslogPort, slmAdminEntry=slmAdminEntry, slmSwRevName=slmSwRevName, slmAuth=slmAuth, slmSysMode=slmSysMode, slmSysSubnetMask=slmSysSubnetMask, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapPort=slmTrapPort, slmAuthCommunity=slmAuthCommunity, slmChPassNewPass=slmChPassNewPass, slmOemType=slmOemType, slmSysUplinkRate=slmSysUplinkRate, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdmin=slmAdmin, slmPsuNumber=slmPsuNumber, slmLicenseExpiration=slmLicenseExpiration, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTopologyEnabled=slmTopologyEnabled, UserPassword=UserPassword, slmWriteCommunity=slmWriteCommunity, slmConfigFile=slmConfigFile, slmSwRevStatus=slmSwRevStatus, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestAddress=slmTrapDestAddress, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogParam2=slmTrapLogParam2, slmSwRevDate=slmSwRevDate, slmTrapUserAccess=slmTrapUserAccess, slmAdminLogin=slmAdminLogin, slmAdminCommunity=slmAdminCommunity, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapUserLogin=slmTrapUserLogin, slmSysLocation=slmSysLocation, slmTrapDestEntry=slmTrapDestEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmEdfaNumber=slmEdfaNumber, slmSyslogDestEntry=slmSyslogDestEntry, slmTid=slmTid, slMain=slMain, slmSys=slmSys, slmSnmpv3Password=slmSnmpv3Password, slmSysResetPm=slmSysResetPm, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogTable=slmTrapLogTable, UserLogin=UserLogin, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysTemperature=slmSysTemperature, slmLicense=slmLicense, slmTrap=slmTrap, slmBoxSize=slmBoxSize, slmLogFile=slmLogFile, slmTrapLogEntry=slmTrapLogEntry, slmSysName=slmSysName, slmSysAdminStatus=slmSysAdminStatus, slmTrapLogId=slmTrapLogId, slmVcatDelay=slmVcatDelay, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminAccess=slmAdminAccess, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevDirectory=slmSwRevDirectory, slmLicenseEntry=slmLicenseEntry, slmMuxNumber=slmMuxNumber, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAuthTable=slmAuthTable, slmSysLanIpAddr=slmSysLanIpAddr)
