...
Gauge32, iso, IpAddress, NotificationType, Opaque, ModuleIdentity, Bits, ObjectIdentity, TimeTicks, Integer32, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "IpAddress", "NotificationType", "Opaque", "ModuleIdentity", "Bits", "ObjectIdentity", "TimeTicks", "Integer32", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSnmpv3Password=slmSnmpv3Password, slmSnmpv3Auth=slmSnmpv3Auth, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogName=slmTrapLogName, slmTrapLogTable=slmTrapLogTable, slmChPass=slmChPass, slmConfigFile=slmConfigFile, slmTrapEnable=slmTrapEnable, slmTrapDestAddress=slmTrapDestAddress, slmAdminTable=slmAdminTable, slmSysSubnetMask=slmSysSubnetMask, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam3=slmTrapLogParam3, slmChPassEntry=slmChPassEntry, slmTrapLogParam4=slmTrapLogParam4, slmSys=slmSys, slmAuthPassword=slmAuthPassword, slMain=slMain, slmRebootDelay=slmRebootDelay, slmAuthLogin=slmAuthLogin, slmLicenseIndex=slmLicenseIndex, slmTid=slmTid, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysSnmpVersion=slmSysSnmpVersion, slmTrap=slmTrap, slmSysChassisId=slmSysChassisId, slmAdminAccess=slmAdminAccess, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysLanIpAddr=slmSysLanIpAddr, UserPassword=UserPassword, PYSNMP_MODULE_ID=slMain, slmSysTrapFormat=slmSysTrapFormat, slmAuthTable=slmAuthTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmLicenseTable=slmLicenseTable, slmTrapCommunity=slmTrapCommunity, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysGatewayAddr=slmSysGatewayAddr, slmAuthEntry=slmAuthEntry, slmLicenseId=slmLicenseId, slm40GConf=slm40GConf, slmTrapLogId=slmTrapLogId, slmTrapDestEntry=slmTrapDestEntry, slmSysIpAddr=slmSysIpAddr, slmSysCalendarTime=slmSysCalendarTime, slmLicenseExpiration=slmLicenseExpiration, slmAuth=slmAuth, slmSyslogDestTable=slmSyslogDestTable, slmTopologyEnabled=slmTopologyEnabled, slmTrapUserAccess=slmTrapUserAccess, slmSysUplinkRate=slmSysUplinkRate, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminCommunity=slmAdminCommunity, slmTrapLogEntry=slmTrapLogEntry, slmReadCommunity=slmReadCommunity, slmLicense=slmLicense, slmEdfaNumber=slmEdfaNumber, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogParam2=slmTrapLogParam2, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapSysLocationChange=slmTrapSysLocationChange, SoftwareRevision=SoftwareRevision, slmAdminLogin=slmAdminLogin, slmSysTemperature=slmSysTemperature, slmLogFile=slmLogFile, UserCommunity=UserCommunity, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmPsuNumber=slmPsuNumber, slmSwRevEntry=slmSwRevEntry, UserLogin=UserLogin, slmTrapLogParam1=slmTrapLogParam1, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminEntry=slmAdminEntry, slmSwRevName=slmSwRevName, slmTrapPort=slmTrapPort, AdminAccess=AdminAccess, slmSwRevTable=slmSwRevTable, slmSwRevStatus=slmSwRevStatus, slmAdmin=slmAdmin, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmPortsNumber=slmPortsNumber, slmOemType=slmOemType, slmSysName=slmSysName, slmAuthCommunity=slmAuthCommunity, slmSwRevDate=slmSwRevDate, slmChPassLogin=slmChPassLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmNetworkMode=slmNetworkMode, slmTrapLogParam6=slmTrapLogParam6, slmSysActiveSwVersion=slmSysActiveSwVersion, slmMuxNumber=slmMuxNumber, slmSysLocation=slmSysLocation, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysAdminStatus=slmSysAdminStatus, slmAdminPassword=slmAdminPassword, slmSyslogPort=slmSyslogPort, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysMode=slmSysMode, slmRstpEnabled=slmRstpEnabled, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogDestAddress=slmSyslogDestAddress, slmChPassOldPass=slmChPassOldPass, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysAlmDeact=slmSysAlmDeact, slmSysOperStatus=slmSysOperStatus, slmPmAvailable=slmPmAvailable, slmBoxSize=slmBoxSize, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysAlmAct=slmSysAlmAct, slmChPassTable=slmChPassTable, slmLicenseEntry=slmLicenseEntry, slmVcatDelay=slmVcatDelay, slmSysResetPm=slmSysResetPm, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevDirectory=slmSwRevDirectory, slmSyslogLevel=slmSyslogLevel, slmLogin=slmLogin, slmAdminRowStatus=slmAdminRowStatus, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestCommunity=slmTrapDestCommunity, slmWriteCommunity=slmWriteCommunity, slmTrapDestTable=slmTrapDestTable, slmChPassNewPass=slmChPassNewPass)
