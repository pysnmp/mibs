...
iso, Bits, Gauge32, ObjectIdentity, TimeTicks, Integer32, ModuleIdentity, Opaque, NotificationType, Counter32, MibIdentifier, Unsigned32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "Gauge32", "ObjectIdentity", "TimeTicks", "Integer32", "ModuleIdentity", "Opaque", "NotificationType", "Counter32", "MibIdentifier", "Unsigned32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysOperStatus=slmSysOperStatus, slmTrapLogParam2=slmTrapLogParam2, slmNetworkMode=slmNetworkMode, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapDestEntry=slmTrapDestEntry, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmPsuNumber=slmPsuNumber, slmLicenseId=slmLicenseId, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestIpAddress=slmTrapDestIpAddress, slmChPassEntry=slmChPassEntry, slmTrapLogParam5=slmTrapLogParam5, slmAuthLogin=slmAuthLogin, slmSnmpv3Password=slmSnmpv3Password, slmRebootDelay=slmRebootDelay, slmSysIpAddr=slmSysIpAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogId=slmTrapLogId, slmTrapDestAddress=slmTrapDestAddress, SoftwareRevision=SoftwareRevision, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevTable=slmSwRevTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevStatus=slmSwRevStatus, AdminAccess=AdminAccess, slmSysCalendarTime=slmSysCalendarTime, slmTrapSysNameChange=slmTrapSysNameChange, slmSysAlmDeact=slmSysAlmDeact, slmChPassLogin=slmChPassLogin, slmChPassOldPass=slmChPassOldPass, slmSysUplinkRate=slmSysUplinkRate, slmTrapPort=slmTrapPort, slmSysPmStartOfDay=slmSysPmStartOfDay, slmAuthEntry=slmAuthEntry, slmLicense=slmLicense, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevEntry=slmSwRevEntry, slmSysTemperature=slmSysTemperature, slmSyslogDestAddress=slmSyslogDestAddress, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmChPassTable=slmChPassTable, slmMuxNumber=slmMuxNumber, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmLicenseEntry=slmLicenseEntry, slmAdminLogin=slmAdminLogin, slmChPassNewPass=slmChPassNewPass, slmLicenseIndex=slmLicenseIndex, slMain=slMain, slmBoxSize=slmBoxSize, slmSyslogPort=slmSyslogPort, slmTrapLogEntry=slmTrapLogEntry, PYSNMP_MODULE_ID=slMain, slmSysTrapFormat=slmSysTrapFormat, slmTrapLogParam3=slmTrapLogParam3, slmTrapLogParam4=slmTrapLogParam4, slmConfigFile=slmConfigFile, slmAdminRowStatus=slmAdminRowStatus, slmSysResetPm=slmSysResetPm, slmTrap=slmTrap, slmAuth=slmAuth, slmSysName=slmSysName, slmSysLocation=slmSysLocation, slmSyslogDestTable=slmSyslogDestTable, slmTopologyEnabled=slmTopologyEnabled, slmAdmin=slmAdmin, slmSwRevDate=slmSwRevDate, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysAlmAct=slmSysAlmAct, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmOemType=slmOemType, slmTid=slmTid, slmSysAdminStatus=slmSysAdminStatus, slm40GConf=slm40GConf, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapCommunity=slmTrapCommunity, slmSys=slmSys, slmTrapSysLocationChange=slmTrapSysLocationChange, UserPassword=UserPassword, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicenseTable=slmLicenseTable, slmLogFile=slmLogFile, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogName=slmTrapLogName, slmTrapUserAccess=slmTrapUserAccess, slmSnmpv3Priv=slmSnmpv3Priv, slmSysSnmpVersion=slmSysSnmpVersion, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmAdminPassword=slmAdminPassword, slmPortsNumber=slmPortsNumber, slmLicenseExpiration=slmLicenseExpiration, slmAdminTable=slmAdminTable, slmSwRevDirectory=slmSwRevDirectory, slmAdminEntry=slmAdminEntry, slmWriteCommunity=slmWriteCommunity, slmRstpEnabled=slmRstpEnabled, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam6=slmTrapLogParam6, slmConfigSysUptime=slmConfigSysUptime, slmTrapLogParam1=slmTrapLogParam1, slmPmAvailable=slmPmAvailable, slmSysMode=slmSysMode, UserLogin=UserLogin, slmAdminCommunity=slmAdminCommunity, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysChassisId=slmSysChassisId, slmVcatDelay=slmVcatDelay, slmTrapDestTable=slmTrapDestTable, slmAuthTable=slmAuthTable, slmAdminAccess=slmAdminAccess, slmTrapEnable=slmTrapEnable, slmLogin=slmLogin, slmChPass=slmChPass, slmAuthCommunity=slmAuthCommunity, slmReadCommunity=slmReadCommunity, slmSwRevName=slmSwRevName, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysLanIpAddr=slmSysLanIpAddr, slmSysSubnetMask=slmSysSubnetMask, UserCommunity=UserCommunity, slmAuthPassword=slmAuthPassword, slmEdfaNumber=slmEdfaNumber, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSyslogLevel=slmSyslogLevel, slmTrapUserLogin=slmTrapUserLogin, slmSyslogDestEntry=slmSyslogDestEntry)
