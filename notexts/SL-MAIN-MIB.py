...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysLanIpAddr=slmSysLanIpAddr, slmSysAdminStatus=slmSysAdminStatus, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slMain=slMain, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminLogin=slmAdminLogin, slmLogFile=slmLogFile, slmSwRevTable=slmSwRevTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapLogEntry=slmTrapLogEntry, slmAdminPassword=slmAdminPassword, slmTrapDestCommunity=slmTrapDestCommunity, slmSnmpv3Auth=slmSnmpv3Auth, slmAuthEntry=slmAuthEntry, slmTrap=slmTrap, slmSysGatewayAddr=slmSysGatewayAddr, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapDestEntry=slmTrapDestEntry, slmLicenseExpiration=slmLicenseExpiration, slmSyslogDestAddress=slmSyslogDestAddress, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminEntry=slmAdminEntry, slmSysAlmAct=slmSysAlmAct, slmSnmpv3Priv=slmSnmpv3Priv, slmTid=slmTid, slmSysIpAddr=slmSysIpAddr, slmTrapCommunity=slmTrapCommunity, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevDate=slmSwRevDate, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdmin=slmAdmin, slmSysResetPm=slmSysResetPm, slmRebootDelay=slmRebootDelay, slmAdminTable=slmAdminTable, slmSysAlmDeact=slmSysAlmDeact, slmSysUplinkRate=slmSysUplinkRate, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminRowStatus=slmAdminRowStatus, slmAuthCommunity=slmAuthCommunity, slmTrapLogId=slmTrapLogId, slmAdminCommunity=slmAdminCommunity, slmLicense=slmLicense, slmSysSnmpVersion=slmSysSnmpVersion, slmLicenseIndex=slmLicenseIndex, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestTable=slmSyslogDestTable, slmReadCommunity=slmReadCommunity, slmChPassOldPass=slmChPassOldPass, slmSysActiveSwVersion=slmSysActiveSwVersion, UserLogin=UserLogin, slmSwRevName=slmSwRevName, slmAuthTable=slmAuthTable, slmTrapLogName=slmTrapLogName, slmPmAvailable=slmPmAvailable, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestAddress=slmTrapDestAddress, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestEntry=slmSyslogDestEntry, slmAuthLogin=slmAuthLogin, slmVcatDelay=slmVcatDelay, slmConfigSysSignalType=slmConfigSysSignalType, slmLicenseEntry=slmLicenseEntry, slmTrapLogTable=slmTrapLogTable, slmSyslogLevel=slmSyslogLevel, slmLicenseTable=slmLicenseTable, slmSys=slmSys, AdminAccess=AdminAccess, slmMuxNumber=slmMuxNumber, slmRstpEnabled=slmRstpEnabled, slmAuth=slmAuth, slmSysTemperature=slmSysTemperature, slmSysSubnetMask=slmSysSubnetMask, slmSysName=slmSysName, slmSysCalendarTime=slmSysCalendarTime, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysChassisId=slmSysChassisId, slmChPassTable=slmChPassTable, slmOemType=slmOemType, SoftwareRevision=SoftwareRevision, slmSysOperStatus=slmSysOperStatus, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTopologyEnabled=slmTopologyEnabled, slmPortsNumber=slmPortsNumber, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmBoxSize=slmBoxSize, slmTrapEnable=slmTrapEnable, slmWriteCommunity=slmWriteCommunity, PYSNMP_MODULE_ID=slMain, slmChPassLogin=slmChPassLogin, slmTrapUserLogin=slmTrapUserLogin, UserPassword=UserPassword, slmNetworkMode=slmNetworkMode, slmAdminAccess=slmAdminAccess, slmSwRevDirectory=slmSwRevDirectory, slmConfigFile=slmConfigFile, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam1=slmTrapLogParam1, slmSysTrapFormat=slmSysTrapFormat, slmAuthPassword=slmAuthPassword, slmSysLocation=slmSysLocation, slmTrapLogParam2=slmTrapLogParam2, slmLogin=slmLogin, slm40GConf=slm40GConf, slmTrapLogParam3=slmTrapLogParam3, slmSyslogPort=slmSyslogPort, slmChPassEntry=slmChPassEntry, slmChPassNewPass=slmChPassNewPass, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmEdfaNumber=slmEdfaNumber, slmSwRevEntry=slmSwRevEntry, slmTrapDestProtVersion=slmTrapDestProtVersion, slmPsuNumber=slmPsuNumber, slmTrapUserAccess=slmTrapUserAccess, UserCommunity=UserCommunity, slmSwRevStatus=slmSwRevStatus, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmChPass=slmChPass, slmTrapLogParam4=slmTrapLogParam4, slmConfigSysUptime=slmConfigSysUptime, slmTrapPort=slmTrapPort, slmLicenseId=slmLicenseId, slmTrapLogParam6=slmTrapLogParam6, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysMode=slmSysMode)
