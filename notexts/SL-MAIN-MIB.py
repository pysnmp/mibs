...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysAlmAct=slmSysAlmAct, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestEntry=slmTrapDestEntry, slmSwRevDirectory=slmSwRevDirectory, slmLicenseTable=slmLicenseTable, slmRebootDelay=slmRebootDelay, slmSysSubnetMask=slmSysSubnetMask, PYSNMP_MODULE_ID=slMain, slmPsuNumber=slmPsuNumber, slmLogin=slmLogin, slmLogFile=slmLogFile, UserCommunity=UserCommunity, slmSwRevName=slmSwRevName, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysAdminStatus=slmSysAdminStatus, slmTrapUserLogin=slmTrapUserLogin, slmConfigSysUptime=slmConfigSysUptime, slmLicense=slmLicense, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevDate=slmSwRevDate, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestAddress=slmTrapDestAddress, slmSysIpAddr=slmSysIpAddr, slmPortsNumber=slmPortsNumber, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAdminRowStatus=slmAdminRowStatus, slmTid=slmTid, slmSysOperStatus=slmSysOperStatus, slmLicenseExpiration=slmLicenseExpiration, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapSysLocationChange=slmTrapSysLocationChange, slmChPassTable=slmChPassTable, slmConfigSysSignalType=slmConfigSysSignalType, slmTrap=slmTrap, slmAdminLogin=slmAdminLogin, slmSysAlmDeact=slmSysAlmDeact, slmWriteCommunity=slmWriteCommunity, slmAuthPassword=slmAuthPassword, slmTrapLogParam5=slmTrapLogParam5, slmMuxNumber=slmMuxNumber, slmSysLanIpAddr=slmSysLanIpAddr, slmNetworkMode=slmNetworkMode, slmRstpEnabled=slmRstpEnabled, slmChPassOldPass=slmChPassOldPass, slmSysTemperature=slmSysTemperature, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLicenseId=slmLicenseId, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLocation=slmSysLocation, slmChPassNewPass=slmChPassNewPass, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseEntry=slmLicenseEntry, slmSysCalendarTime=slmSysCalendarTime, slmTrapLogParam2=slmTrapLogParam2, slmSysUplinkRate=slmSysUplinkRate, slmAuth=slmAuth, slmSyslogLevel=slmSyslogLevel, slmSysTrapFormat=slmSysTrapFormat, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAuthCommunity=slmAuthCommunity, slmTrapCommunity=slmTrapCommunity, slmConfigFile=slmConfigFile, slmTrapPort=slmTrapPort, slmAdminPassword=slmAdminPassword, slmTrapLogParam3=slmTrapLogParam3, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSyslogPort=slmSyslogPort, slmSysChassisId=slmSysChassisId, slmLicenseIndex=slmLicenseIndex, slmSysMode=slmSysMode, slmBoxSize=slmBoxSize, slmAdminAccess=slmAdminAccess, slmSysGatewayAddr=slmSysGatewayAddr, slmSwRevStatus=slmSwRevStatus, slmEdfaNumber=slmEdfaNumber, slmTrapLogTable=slmTrapLogTable, slmTrapDestTable=slmTrapDestTable, slmSysSnmpVersion=slmSysSnmpVersion, SoftwareRevision=SoftwareRevision, slmAuthTable=slmAuthTable, slmTrapLogEntry=slmTrapLogEntry, slmPmAvailable=slmPmAvailable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAdminTable=slmAdminTable, slmSnmpv3Password=slmSnmpv3Password, slmSyslogDestAddress=slmSyslogDestAddress, UserLogin=UserLogin, slmSys=slmSys, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmAuthLogin=slmAuthLogin, slmSyslogDestEntry=slmSyslogDestEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, AdminAccess=AdminAccess, slmSnmpv3Priv=slmSnmpv3Priv, slMain=slMain, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam1=slmTrapLogParam1, slmSwRevEntry=slmSwRevEntry, slmChPass=slmChPass, slmOemType=slmOemType, slmSyslogDestTable=slmSyslogDestTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmAdmin=slmAdmin, slm40GConf=slm40GConf, slmVcatDelay=slmVcatDelay, slmTrapEnable=slmTrapEnable, slmSysName=slmSysName, slmAdminCommunity=slmAdminCommunity, slmChPassEntry=slmChPassEntry, slmChPassLogin=slmChPassLogin, UserPassword=UserPassword, slmAuthEntry=slmAuthEntry, slmSwRevTable=slmSwRevTable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogId=slmTrapLogId, slmSysResetPm=slmSysResetPm, slmTrapSysNameChange=slmTrapSysNameChange, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminEntry=slmAdminEntry, slmReadCommunity=slmReadCommunity, slmTrapLogName=slmTrapLogName)
