...
Counter32, iso, Unsigned32, Counter64, ObjectIdentity, NotificationType, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, MibIdentifier, IpAddress, Opaque, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "Unsigned32", "Counter64", "ObjectIdentity", "NotificationType", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "MibIdentifier", "IpAddress", "Opaque", "Integer32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdmin=slmAdmin, slmChPass=slmChPass, slmNetworkMode=slmNetworkMode, slmSysCalendarTime=slmSysCalendarTime, slmSysLanIpAddr=slmSysLanIpAddr, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevEntry=slmSwRevEntry, slmPsuNumber=slmPsuNumber, slmTrapLogName=slmTrapLogName, UserLogin=UserLogin, slmSysGatewayAddr=slmSysGatewayAddr, slmSysIpAddr=slmSysIpAddr, AdminAccess=AdminAccess, slmSyslogDestTable=slmSyslogDestTable, slmLicenseIndex=slmLicenseIndex, slmSyslogPort=slmSyslogPort, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSysTrapFormat=slmSysTrapFormat, slmAdminCommunity=slmAdminCommunity, slmAuth=slmAuth, slmSysPmStartOfDay=slmSysPmStartOfDay, slmOpticalSwitchExist=slmOpticalSwitchExist, slmPmAvailable=slmPmAvailable, slmSwRevStatus=slmSwRevStatus, slmTrapUserLogin=slmTrapUserLogin, slmTrapDestAddress=slmTrapDestAddress, slmSyslogDestEntry=slmSyslogDestEntry, slmLicense=slmLicense, slmSysAlmDeact=slmSysAlmDeact, slmSysSubnetMask=slmSysSubnetMask, slmAdminPassword=slmAdminPassword, slmAdminEntry=slmAdminEntry, slmTopologyEnabled=slmTopologyEnabled, slmSnmpv3Auth=slmSnmpv3Auth, slmChPassEntry=slmChPassEntry, slmLicenseExpiration=slmLicenseExpiration, slmAuthLogin=slmAuthLogin, slmAuthCommunity=slmAuthCommunity, slmSnmpv3Priv=slmSnmpv3Priv, SoftwareRevision=SoftwareRevision, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogParam6=slmTrapLogParam6, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogLevel=slmSyslogLevel, slmChPassTable=slmChPassTable, slmTrapLogTable=slmTrapLogTable, slmWriteCommunity=slmWriteCommunity, slm40GConf=slm40GConf, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapLogId=slmTrapLogId, slmSysTemperature=slmSysTemperature, slmLicenseEntry=slmLicenseEntry, slmLogFile=slmLogFile, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSwRevDirectory=slmSwRevDirectory, slmConfigSysSignalType=slmConfigSysSignalType, slmVcatDelay=slmVcatDelay, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAdminTable=slmAdminTable, slmTrapLogParam5=slmTrapLogParam5, slMain=slMain, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapCommunity=slmTrapCommunity, slmConfigSysUptime=slmConfigSysUptime, slmReadCommunity=slmReadCommunity, slmChPassNewPass=slmChPassNewPass, slmTrapLogParam2=slmTrapLogParam2, slmSysName=slmSysName, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmPortsNumber=slmPortsNumber, slmTrapSysNameChange=slmTrapSysNameChange, slmConfigFile=slmConfigFile, slmAdminLogin=slmAdminLogin, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAdminAccess=slmAdminAccess, slmBoxSize=slmBoxSize, slmSysMode=slmSysMode, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysUplinkRate=slmSysUplinkRate, slmRstpEnabled=slmRstpEnabled, UserPassword=UserPassword, PYSNMP_MODULE_ID=slMain, slmEdfaNumber=slmEdfaNumber, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapLogParam1=slmTrapLogParam1, slmSwRevName=slmSwRevName, slmTid=slmTid, slmSysAdminStatus=slmSysAdminStatus, UserCommunity=UserCommunity, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestTable=slmTrapDestTable, slmSysChassisId=slmSysChassisId, slmChPassOldPass=slmChPassOldPass, slmSnmpv3Password=slmSnmpv3Password, slmOemType=slmOemType, slmAuthEntry=slmAuthEntry, slmRebootDelay=slmRebootDelay, slmChPassLogin=slmChPassLogin, slmSysLocation=slmSysLocation, slmLicenseId=slmLicenseId, slmTrap=slmTrap, slmMuxNumber=slmMuxNumber, slmTrapEnable=slmTrapEnable, slmTrapLogParam3=slmTrapLogParam3, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuthTable=slmAuthTable, slmLogin=slmLogin, slmSysOperStatus=slmSysOperStatus, slmAuthPassword=slmAuthPassword, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestEntry=slmTrapDestEntry, slmSwRevTable=slmSwRevTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapPort=slmTrapPort, slmSysAlmAct=slmSysAlmAct, slmLicenseTable=slmLicenseTable, slmSwRevDate=slmSwRevDate, slmTrapUserAccess=slmTrapUserAccess, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSys=slmSys, slmSysResetPm=slmSysResetPm, slmTrapLogEntry=slmTrapLogEntry)
