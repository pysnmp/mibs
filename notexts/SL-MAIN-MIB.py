...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmPsuNumber=slmPsuNumber, slmAdminLogin=slmAdminLogin, slmAdminAccess=slmAdminAccess, slmRstpEnabled=slmRstpEnabled, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogTable=slmTrapLogTable, slmChPass=slmChPass, slmSwRevDirectory=slmSwRevDirectory, slmLicenseId=slmLicenseId, slmSysAlmAct=slmSysAlmAct, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam1=slmTrapLogParam1, slmAuthPassword=slmAuthPassword, slmSysSubnetMask=slmSysSubnetMask, slmSysSnmpVersion=slmSysSnmpVersion, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAdminPassword=slmAdminPassword, PYSNMP_MODULE_ID=slMain, slmChPassTable=slmChPassTable, slmEdfaNumber=slmEdfaNumber, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogParam3=slmTrapLogParam3, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuthLogin=slmAuthLogin, SoftwareRevision=SoftwareRevision, slmSwRevDate=slmSwRevDate, slmSwRevTable=slmSwRevTable, slmTrapUserAccess=slmTrapUserAccess, slmConfigFile=slmConfigFile, slmLicenseIndex=slmLicenseIndex, slmTrapDestEntry=slmTrapDestEntry, slmSyslogPort=slmSyslogPort, slmSwRevStatus=slmSwRevStatus, slmAuthCommunity=slmAuthCommunity, slmSysCalendarTime=slmSysCalendarTime, slmVcatDelay=slmVcatDelay, slmWriteCommunity=slmWriteCommunity, slmSnmpv3Priv=slmSnmpv3Priv, slmSys=slmSys, slmTrapLogId=slmTrapLogId, slmTrapLogParam6=slmTrapLogParam6, slmSysTemperature=slmSysTemperature, slmAdminEntry=slmAdminEntry, slmTrapUserLogin=slmTrapUserLogin, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmLicenseTable=slmLicenseTable, slmSnmpv3Auth=slmSnmpv3Auth, slmNetworkMode=slmNetworkMode, slmSnmpv3Password=slmSnmpv3Password, slmTrapDestAddress=slmTrapDestAddress, slmSysLanIpAddr=slmSysLanIpAddr, UserCommunity=UserCommunity, slmRebootDelay=slmRebootDelay, slmLicenseEntry=slmLicenseEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSyslogDestAddress=slmSyslogDestAddress, slmLicense=slmLicense, slmLogFile=slmLogFile, slmSysActiveSwVersion=slmSysActiveSwVersion, slmOemType=slmOemType, slmAuthTable=slmAuthTable, slmTid=slmTid, slmTopologyEnabled=slmTopologyEnabled, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminRowStatus=slmAdminRowStatus, slmTrapEnable=slmTrapEnable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPassOldPass=slmChPassOldPass, slmAuth=slmAuth, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminCommunity=slmAdminCommunity, slmSyslogLevel=slmSyslogLevel, slmSwRevName=slmSwRevName, slmSysChassisId=slmSysChassisId, slmSysUplinkRate=slmSysUplinkRate, slmReadCommunity=slmReadCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmChPassNewPass=slmChPassNewPass, slmSyslogDestTable=slmSyslogDestTable, slMain=slMain, slmTrapLogName=slmTrapLogName, slmChPassEntry=slmChPassEntry, slmTrapPort=slmTrapPort, UserLogin=UserLogin, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogEntry=slmTrapLogEntry, slmTrapDestTable=slmTrapDestTable, slmBoxSize=slmBoxSize, slmSysName=slmSysName, slmSysTrapFormat=slmSysTrapFormat, slmTrapCommunity=slmTrapCommunity, slmSyslogDestRowStatus=slmSyslogDestRowStatus, UserPassword=UserPassword, slmTrapLogParam2=slmTrapLogParam2, slmSysIpAddr=slmSysIpAddr, slmLogin=slmLogin, slmTrapLogParam5=slmTrapLogParam5, slmSysAdminStatus=slmSysAdminStatus, slmSysMode=slmSysMode, slmAdminTable=slmAdminTable, slmPortsNumber=slmPortsNumber, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmPmAvailable=slmPmAvailable, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysLocation=slmSysLocation, slmConfigSysUptime=slmConfigSysUptime, slmSysAlmDeact=slmSysAlmDeact, slmAuthEntry=slmAuthEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmSwRevEntry=slmSwRevEntry, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmMuxNumber=slmMuxNumber, slmChPassLogin=slmChPassLogin, slmTrapLogParam4=slmTrapLogParam4, slmTrap=slmTrap, slmAdmin=slmAdmin, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapDestProtVersion=slmTrapDestProtVersion, AdminAccess=AdminAccess, slm40GConf=slm40GConf, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysResetPm=slmSysResetPm, slmSysEncryptionCapability=slmSysEncryptionCapability)
