...
iso, MibIdentifier, Unsigned32, Integer32, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, Gauge32, ModuleIdentity, Counter32, Bits, NotificationType, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "Unsigned32", "Integer32", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "Gauge32", "ModuleIdentity", "Counter32", "Bits", "NotificationType", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysAdminStatus=slmSysAdminStatus, slmSysIpAddr=slmSysIpAddr, slmLogin=slmLogin, slmAdmin=slmAdmin, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapSysNameChange=slmTrapSysNameChange, slmAuthTable=slmAuthTable, slmAuth=slmAuth, slmSysMode=slmSysMode, slmSysOperStatus=slmSysOperStatus, slmChPassEntry=slmChPassEntry, slmLicenseIndex=slmLicenseIndex, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam3=slmTrapLogParam3, slmLicenseExpiration=slmLicenseExpiration, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogLevel=slmSyslogLevel, slmTopologyEnabled=slmTopologyEnabled, slmPmAvailable=slmPmAvailable, slmAdminRowStatus=slmAdminRowStatus, slmAdminLogin=slmAdminLogin, slmReadCommunity=slmReadCommunity, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseId=slmLicenseId, slmSysUplinkRate=slmSysUplinkRate, slmTrapPort=slmTrapPort, slmSyslogPort=slmSyslogPort, slmPsuNumber=slmPsuNumber, slmTrapLogParam2=slmTrapLogParam2, slmLicenseTable=slmLicenseTable, slmAuthLogin=slmAuthLogin, slm40GConf=slm40GConf, slmTrapLogEntry=slmTrapLogEntry, slmLicenseEntry=slmLicenseEntry, UserLogin=UserLogin, slmTrapLogTable=slmTrapLogTable, slmTid=slmTid, slmSwRevStatus=slmSwRevStatus, slmSysLanIpAddr=slmSysLanIpAddr, slmWriteCommunity=slmWriteCommunity, slmSysGatewayAddr=slmSysGatewayAddr, slmSysAlmAct=slmSysAlmAct, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminTable=slmAdminTable, slmAuthCommunity=slmAuthCommunity, slmLicense=slmLicense, slmPortsNumber=slmPortsNumber, slmSysLocation=slmSysLocation, slmTrapDestAddress=slmTrapDestAddress, slmRstpEnabled=slmRstpEnabled, slmSnmpv3Priv=slmSnmpv3Priv, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSwRevEntry=slmSwRevEntry, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapDestProtVersion=slmTrapDestProtVersion, slmChPass=slmChPass, slmTrap=slmTrap, slmAuthPassword=slmAuthPassword, slmVcatDelay=slmVcatDelay, slmSnmpv3Auth=slmSnmpv3Auth, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapUserAccess=slmTrapUserAccess, slmTrapCommunity=slmTrapCommunity, slmLogFile=slmLogFile, slmChPassNewPass=slmChPassNewPass, UserCommunity=UserCommunity, slmSysCalendarTime=slmSysCalendarTime, slmSnmpv3Password=slmSnmpv3Password, slmConfigFile=slmConfigFile, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevDate=slmSwRevDate, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSyslogDestEntry=slmSyslogDestEntry, slmSysName=slmSysName, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysSubnetMask=slmSysSubnetMask, slmSysTrapFormat=slmSysTrapFormat, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminEntry=slmAdminEntry, slmTrapDestEntry=slmTrapDestEntry, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmMuxNumber=slmMuxNumber, slmSysTemperature=slmSysTemperature, slmTrapDestRowStatus=slmTrapDestRowStatus, AdminAccess=AdminAccess, slmSwRevDirectory=slmSwRevDirectory, slmChPassOldPass=slmChPassOldPass, slmTrapLogId=slmTrapLogId, slmNetworkMode=slmNetworkMode, slmTrapLogParam6=slmTrapLogParam6, slmSysResetPm=slmSysResetPm, slmSysPmStartOfDay=slmSysPmStartOfDay, UserPassword=UserPassword, slmBoxSize=slmBoxSize, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapDestTable=slmTrapDestTable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapEnable=slmTrapEnable, slmTrapLogParam1=slmTrapLogParam1, slmAuthEntry=slmAuthEntry, slmSysAlmDeact=slmSysAlmDeact, slmAdminAccess=slmAdminAccess, slmAdminCommunity=slmAdminCommunity, slmChPassTable=slmChPassTable, slMain=slMain, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestCommunity=slmTrapDestCommunity, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSwRevTable=slmSwRevTable, slmSysChassisId=slmSysChassisId, PYSNMP_MODULE_ID=slMain, slmSys=slmSys, slmTrapLogName=slmTrapLogName, slmAdminPassword=slmAdminPassword, slmOemType=slmOemType, SoftwareRevision=SoftwareRevision, slmChPassLogin=slmChPassLogin, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSyslogDestTable=slmSyslogDestTable, slmSwRevName=slmSwRevName, slmEdfaNumber=slmEdfaNumber, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmRebootDelay=slmRebootDelay, slmConfigSysUptime=slmConfigSysUptime)
