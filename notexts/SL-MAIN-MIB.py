...
ObjectIdentity, Opaque, NotificationType, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, Unsigned32, IpAddress, iso, Integer32, Bits, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Opaque", "NotificationType", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "Unsigned32", "IpAddress", "iso", "Integer32", "Bits", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysGatewayAddr=slmSysGatewayAddr, slmSysSubnetMask=slmSysSubnetMask, slmLicense=slmLicense, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmLogFile=slmLogFile, slmSwRevEntry=slmSwRevEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrap=slmTrap, slmAdminEntry=slmAdminEntry, slmAuthPassword=slmAuthPassword, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam3=slmTrapLogParam3, slmSysIpAddr=slmSysIpAddr, slmTrapDestAddress=slmTrapDestAddress, slmOpticalSwitchExist=slmOpticalSwitchExist, PYSNMP_MODULE_ID=slMain, SoftwareRevision=SoftwareRevision, slmAdminAccess=slmAdminAccess, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmLicenseEntry=slmLicenseEntry, slmTrapLogParam5=slmTrapLogParam5, slmAdminPassword=slmAdminPassword, slmAuthTable=slmAuthTable, slmSysMode=slmSysMode, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysName=slmSysName, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestCommunity=slmTrapDestCommunity, slmPsuNumber=slmPsuNumber, slmTrapUserAccess=slmTrapUserAccess, slmAdmin=slmAdmin, slmSysTemperature=slmSysTemperature, slMain=slMain, slmAuthEntry=slmAuthEntry, slmSnmpv3Password=slmSnmpv3Password, slmChPassEntry=slmChPassEntry, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogParam4=slmTrapLogParam4, slmTopologyEnabled=slmTopologyEnabled, slmAuth=slmAuth, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmNetworkMode=slmNetworkMode, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogId=slmTrapLogId, slmSyslogDestTable=slmSyslogDestTable, slmTrapLogParam2=slmTrapLogParam2, slmTrapLogParam1=slmTrapLogParam1, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogPort=slmSyslogPort, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSys=slmSys, slmTid=slmTid, slmEdfaNumber=slmEdfaNumber, UserCommunity=UserCommunity, slmChPass=slmChPass, slmOemType=slmOemType, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapLogEntry=slmTrapLogEntry, slmSysLocation=slmSysLocation, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapEnable=slmTrapEnable, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmRebootDelay=slmRebootDelay, slmSyslogLevel=slmSyslogLevel, UserLogin=UserLogin, slmSysOperStatus=slmSysOperStatus, slmRstpEnabled=slmRstpEnabled, slmLicenseExpiration=slmLicenseExpiration, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapLogParam6=slmTrapLogParam6, slmConfigFile=slmConfigFile, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSwRevStatus=slmSwRevStatus, slmAuthCommunity=slmAuthCommunity, slmChPassOldPass=slmChPassOldPass, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmChPassTable=slmChPassTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysLanIpAddr=slmSysLanIpAddr, slmPmAvailable=slmPmAvailable, slmAdminTable=slmAdminTable, slmPortsNumber=slmPortsNumber, slmChPassNewPass=slmChPassNewPass, slmSysAlmAct=slmSysAlmAct, slmSysUplinkRate=slmSysUplinkRate, slmSwRevDate=slmSwRevDate, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapDestProtVersion=slmTrapDestProtVersion, slmLogin=slmLogin, slmTrapPort=slmTrapPort, slmLicenseIndex=slmLicenseIndex, slmSwRevDirectory=slmSwRevDirectory, slmSyslogDestEntry=slmSyslogDestEntry, slmVcatDelay=slmVcatDelay, slmTrapCommunity=slmTrapCommunity, slmWriteCommunity=slmWriteCommunity, slmAdminCommunity=slmAdminCommunity, UserPassword=UserPassword, slmLicenseTable=slmLicenseTable, slmChPassLogin=slmChPassLogin, slm40GConf=slm40GConf, slmTrapUserLogin=slmTrapUserLogin, slmSnmpv3Auth=slmSnmpv3Auth, slmSysCalendarTime=slmSysCalendarTime, slmSwRevTable=slmSwRevTable, slmBoxSize=slmBoxSize, slmAdminLogin=slmAdminLogin, slmSysAdminStatus=slmSysAdminStatus, slmLicenseId=slmLicenseId, slmSwRevName=slmSwRevName, slmTrapDestRowStatus=slmTrapDestRowStatus, slmReadCommunity=slmReadCommunity, slmSysChassisId=slmSysChassisId, slmTrapLogName=slmTrapLogName, slmSysSnmpVersion=slmSysSnmpVersion, slmSysTrapFormat=slmSysTrapFormat, slmMuxNumber=slmMuxNumber, slmAuthLogin=slmAuthLogin, slmConfigSysUptime=slmConfigSysUptime, slmSysResetPm=slmSysResetPm, slmTrapLogTable=slmTrapLogTable, AdminAccess=AdminAccess, slmTrapDestEntry=slmTrapDestEntry)
