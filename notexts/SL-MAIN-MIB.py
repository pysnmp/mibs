...
NotificationType, Counter32, iso, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, ModuleIdentity, Gauge32, Bits, MibIdentifier, IpAddress, TimeTicks, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "iso", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "ModuleIdentity", "Gauge32", "Bits", "MibIdentifier", "IpAddress", "TimeTicks", "Opaque")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSysTrapFormat=slmSysTrapFormat, slmSwRevDate=slmSwRevDate, slmAdminRowStatus=slmAdminRowStatus, slMain=slMain, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysSnmpVersion=slmSysSnmpVersion, slmSysCalendarTime=slmSysCalendarTime, slmSysLocation=slmSysLocation, slmSysAlmAct=slmSysAlmAct, UserPassword=UserPassword, slmTrapDestTable=slmTrapDestTable, slmSysIpAddr=slmSysIpAddr, slmSys=slmSys, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysAdminStatus=slmSysAdminStatus, slmAuthTable=slmAuthTable, slmAuthPassword=slmAuthPassword, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapEnable=slmTrapEnable, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapLogName=slmTrapLogName, slmChPassNewPass=slmChPassNewPass, slmTrapSysNameChange=slmTrapSysNameChange, slmAuthEntry=slmAuthEntry, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmPortsNumber=slmPortsNumber, slmTopologyEnabled=slmTopologyEnabled, slmChPassOldPass=slmChPassOldPass, slmRstpEnabled=slmRstpEnabled, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogDestEntry=slmSyslogDestEntry, slmLogin=slmLogin, slmAuthLogin=slmAuthLogin, slmSysChassisId=slmSysChassisId, slmTrapPort=slmTrapPort, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmEdfaNumber=slmEdfaNumber, slmSysLanIpAddr=slmSysLanIpAddr, slmSysName=slmSysName, slmSwRevName=slmSwRevName, slmAuth=slmAuth, slmSwRevStatus=slmSwRevStatus, slmTrapLogTable=slmTrapLogTable, slmSyslogDestTable=slmSyslogDestTable, slmSysOperStatus=slmSysOperStatus, slmTrapLogParam1=slmTrapLogParam1, slmRebootDelay=slmRebootDelay, slmTrapUserAccess=slmTrapUserAccess, slmChPassTable=slmChPassTable, slmConfigSysSignalType=slmConfigSysSignalType, slmSwRevDirectory=slmSwRevDirectory, slmOemType=slmOemType, slmTrapLogEntry=slmTrapLogEntry, slmAdminPassword=slmAdminPassword, slmLogFile=slmLogFile, slmSysGatewayAddr=slmSysGatewayAddr, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTid=slmTid, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSyslogLevel=slmSyslogLevel, slmTrapDestAddress=slmTrapDestAddress, UserLogin=UserLogin, slmLicenseExpiration=slmLicenseExpiration, slmLicenseId=slmLicenseId, slmSnmpv3Auth=slmSnmpv3Auth, slmAdmin=slmAdmin, slmAuthCommunity=slmAuthCommunity, UserCommunity=UserCommunity, slmTrapDestEntry=slmTrapDestEntry, slmSyslogPort=slmSyslogPort, slmTrap=slmTrap, slmTrapLogParam2=slmTrapLogParam2, slmWriteCommunity=slmWriteCommunity, slmSwRevTable=slmSwRevTable, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogParam6=slmTrapLogParam6, slm40GConf=slm40GConf, slmAdminTable=slmAdminTable, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapSysLocationChange=slmTrapSysLocationChange, slmPsuNumber=slmPsuNumber, slmAdminCommunity=slmAdminCommunity, slmSysTemperature=slmSysTemperature, slmAdminLogin=slmAdminLogin, slmPmAvailable=slmPmAvailable, slmLicenseIndex=slmLicenseIndex, slmTrapLogParam3=slmTrapLogParam3, slmLicense=slmLicense, slmChPassEntry=slmChPassEntry, slmSysAlmDeact=slmSysAlmDeact, slmSwRevEntry=slmSwRevEntry, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogParam5=slmTrapLogParam5, slmReadCommunity=slmReadCommunity, SoftwareRevision=SoftwareRevision, PYSNMP_MODULE_ID=slMain, slmSysMode=slmSysMode, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapUserLogin=slmTrapUserLogin, slmLicenseTable=slmLicenseTable, slmNetworkMode=slmNetworkMode, slmTrapCommunity=slmTrapCommunity, AdminAccess=AdminAccess, slmLicenseEntry=slmLicenseEntry, slmBoxSize=slmBoxSize, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminAccess=slmAdminAccess, slmChPass=slmChPass, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmMuxNumber=slmMuxNumber, slmSysResetPm=slmSysResetPm, slmTrapLogId=slmTrapLogId, slmConfigFile=slmConfigFile, slmSysSubnetMask=slmSysSubnetMask, slmVcatDelay=slmVcatDelay, slmChPassLogin=slmChPassLogin, slmSysUplinkRate=slmSysUplinkRate, slmAdminEntry=slmAdminEntry, slmTrapDestCommunity=slmTrapDestCommunity, slmConfigSysUptime=slmConfigSysUptime)
