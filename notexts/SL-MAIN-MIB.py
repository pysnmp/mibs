...
iso, Integer32, MibIdentifier, ObjectIdentity, Unsigned32, ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Opaque, NotificationType, TimeTicks, Counter32, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "MibIdentifier", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Opaque", "NotificationType", "TimeTicks", "Counter32", "Bits", "Counter64")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSnmpv3Password=slmSnmpv3Password, slmTrapDestEntry=slmTrapDestEntry, slmSysResetPm=slmSysResetPm, slmAuth=slmAuth, slmSwRevStatus=slmSwRevStatus, slmTrapPort=slmTrapPort, slmSysIpAddr=slmSysIpAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmSysCalendarTime=slmSysCalendarTime, SoftwareRevision=SoftwareRevision, slmAuthCommunity=slmAuthCommunity, slmChPassNewPass=slmChPassNewPass, slmAdminCommunity=slmAdminCommunity, slmSysName=slmSysName, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogTable=slmTrapLogTable, slmTrapLogParam3=slmTrapLogParam3, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSnmpv3Priv=slmSnmpv3Priv, slmAuthEntry=slmAuthEntry, slmRstpEnabled=slmRstpEnabled, slmLicenseTable=slmLicenseTable, slmAdminLogin=slmAdminLogin, slmTrapLogEntry=slmTrapLogEntry, slmSysOperStatus=slmSysOperStatus, slmAdmin=slmAdmin, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapLogParam5=slmTrapLogParam5, slmLogin=slmLogin, slmMuxNumber=slmMuxNumber, slmTrapLogParam1=slmTrapLogParam1, slmTrapSysNameChange=slmTrapSysNameChange, slmSys=slmSys, slmLicense=slmLicense, slmSwRevDirectory=slmSwRevDirectory, slmSysNetworkPrefix=slmSysNetworkPrefix, UserCommunity=UserCommunity, slmChPass=slmChPass, slmTrapLogId=slmTrapLogId, slmTrapLogParam4=slmTrapLogParam4, slmAdminRowStatus=slmAdminRowStatus, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSwRevEntry=slmSwRevEntry, slmSwRevTable=slmSwRevTable, slmAdminPassword=slmAdminPassword, slmAdminEntry=slmAdminEntry, slmConfigSysUptime=slmConfigSysUptime, slmSysChassisId=slmSysChassisId, slmSysMode=slmSysMode, slmSyslogLevel=slmSyslogLevel, slmSysPmStartOfDay=slmSysPmStartOfDay, UserLogin=UserLogin, slmSwRevDate=slmSwRevDate, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLogFile=slmLogFile, slmSysLocation=slmSysLocation, slmAuthPassword=slmAuthPassword, slmChPassLogin=slmChPassLogin, slmSysTrapFormat=slmSysTrapFormat, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapUserLogin=slmTrapUserLogin, slmSwRevName=slmSwRevName, slmTrapLogParam2=slmTrapLogParam2, slmTrapDestCommunity=slmTrapDestCommunity, slmTopologyEnabled=slmTopologyEnabled, slmConfigFile=slmConfigFile, slmTid=slmTid, slmPortsNumber=slmPortsNumber, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, AdminAccess=AdminAccess, slmOemType=slmOemType, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysAdminStatus=slmSysAdminStatus, slmAdminAccess=slmAdminAccess, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmChPassEntry=slmChPassEntry, slmBoxSize=slmBoxSize, slmEdfaNumber=slmEdfaNumber, slmLicenseExpiration=slmLicenseExpiration, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysLanIpAddr=slmSysLanIpAddr, slmRebootDelay=slmRebootDelay, slmSyslogDestAddress=slmSyslogDestAddress, slmNetworkMode=slmNetworkMode, slmSyslogPort=slmSyslogPort, slmSnmpv3Auth=slmSnmpv3Auth, slmSysSubnetMask=slmSysSubnetMask, slmSysTemperature=slmSysTemperature, slmAuthLogin=slmAuthLogin, slmPmAvailable=slmPmAvailable, slmWriteCommunity=slmWriteCommunity, slmConfigSysSignalType=slmConfigSysSignalType, slmVcatDelay=slmVcatDelay, slmSysAlmAct=slmSysAlmAct, slmLicenseId=slmLicenseId, slmTrapLogName=slmTrapLogName, slmChPassOldPass=slmChPassOldPass, UserPassword=UserPassword, slmTrap=slmTrap, PYSNMP_MODULE_ID=slMain, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysUplinkRate=slmSysUplinkRate, slmSysAlmDeact=slmSysAlmDeact, slmSyslogDestTable=slmSyslogDestTable, slmTrapEnable=slmTrapEnable, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapDestAddress=slmTrapDestAddress, slmTrapDestTable=slmTrapDestTable, slmLicenseIndex=slmLicenseIndex, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSyslogDestEntry=slmSyslogDestEntry, slmAdminTable=slmAdminTable, slMain=slMain, slmReadCommunity=slmReadCommunity, slmAuthTable=slmAuthTable, slmChPassTable=slmChPassTable, slm40GConf=slm40GConf, slmTrapLogParam6=slmTrapLogParam6, slmTrapCommunity=slmTrapCommunity, slmLicenseEntry=slmLicenseEntry, slmPsuNumber=slmPsuNumber)
