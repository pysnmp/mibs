...
MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, NotificationType, Counter64, Integer32, TimeTicks, Counter32, Unsigned32, Bits, ModuleIdentity, ObjectIdentity, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "NotificationType", "Counter64", "Integer32", "TimeTicks", "Counter32", "Unsigned32", "Bits", "ModuleIdentity", "ObjectIdentity", "Gauge32", "iso")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmLicense=slmLicense, slmAuthTable=slmAuthTable, slmSysSubnetMask=slmSysSubnetMask, slmAdmin=slmAdmin, slmTid=slmTid, UserPassword=UserPassword, slmTrapDestProtVersion=slmTrapDestProtVersion, slmAuthEntry=slmAuthEntry, SoftwareRevision=SoftwareRevision, slmWriteCommunity=slmWriteCommunity, UserCommunity=UserCommunity, slmChPassLogin=slmChPassLogin, slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevEntry=slmSwRevEntry, slmTrapLogEntry=slmTrapLogEntry, slmTrapUserLogin=slmTrapUserLogin, slmSyslogLevel=slmSyslogLevel, slmTrapLogParam5=slmTrapLogParam5, UserLogin=UserLogin, slmAdminLogin=slmAdminLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmConfigSysSignalType=slmConfigSysSignalType, slmVcatDelay=slmVcatDelay, slmSnmpv3Priv=slmSnmpv3Priv, slmAdminPassword=slmAdminPassword, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestAddress=slmTrapDestAddress, slmSwRevDirectory=slmSwRevDirectory, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogParam6=slmTrapLogParam6, slmSysSnmpVersion=slmSysSnmpVersion, slmSysGatewayAddr=slmSysGatewayAddr, slmLicenseEntry=slmLicenseEntry, slmChPassEntry=slmChPassEntry, slmPmAvailable=slmPmAvailable, slmSnmpv3Password=slmSnmpv3Password, slmSys=slmSys, slmSysIpAddr=slmSysIpAddr, slmTrap=slmTrap, slmSysMode=slmSysMode, slmTrapEnable=slmTrapEnable, slmSysActiveSwVersion=slmSysActiveSwVersion, slMain=slMain, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmRebootDelay=slmRebootDelay, slmAdminTable=slmAdminTable, slmTrapDestCommunity=slmTrapDestCommunity, slmAdminCommunity=slmAdminCommunity, slmSyslogPort=slmSyslogPort, slmSysLocation=slmSysLocation, slmTrapLogId=slmTrapLogId, PYSNMP_MODULE_ID=slMain, slmTrapLogParam1=slmTrapLogParam1, slmConfigFile=slmConfigFile, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapDestRowStatus=slmTrapDestRowStatus, slmTrapSysNameChange=slmTrapSysNameChange, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTopologyEnabled=slmTopologyEnabled, slmSysUplinkRate=slmSysUplinkRate, slmSysChassisId=slmSysChassisId, slmTrapLogParam4=slmTrapLogParam4, slmLicenseExpiration=slmLicenseExpiration, slmSwRevName=slmSwRevName, slmTrapDestTable=slmTrapDestTable, slmPortsNumber=slmPortsNumber, slmChPass=slmChPass, slmLicenseIndex=slmLicenseIndex, slmTrapPort=slmTrapPort, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmConfigSysUptime=slmConfigSysUptime, slmSyslogDestAddress=slmSyslogDestAddress, slmReadCommunity=slmReadCommunity, slmSwRevStatus=slmSwRevStatus, slmSwRevDate=slmSwRevDate, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogTable=slmTrapLogTable, slmAuthPassword=slmAuthPassword, slmOpticalSwitchExist=slmOpticalSwitchExist, slmAdminEntry=slmAdminEntry, slmChPassTable=slmChPassTable, slmTrapUserAccess=slmTrapUserAccess, slmSysOperStatus=slmSysOperStatus, slmChPassOldPass=slmChPassOldPass, slmSysTemperature=slmSysTemperature, slmAdminRowStatus=slmAdminRowStatus, slmNetworkMode=slmNetworkMode, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSysName=slmSysName, slmOemType=slmOemType, slmSysResetPm=slmSysResetPm, slmSysCalendarTime=slmSysCalendarTime, slmTrapCommunity=slmTrapCommunity, slmLicenseId=slmLicenseId, slmBoxSize=slmBoxSize, slmTrapDestIpAddress=slmTrapDestIpAddress, slmEdfaNumber=slmEdfaNumber, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmMuxNumber=slmMuxNumber, slmSysAlmDeact=slmSysAlmDeact, slmSysAdminStatus=slmSysAdminStatus, AdminAccess=AdminAccess, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysEncryptionCapability=slmSysEncryptionCapability, slm40GConf=slm40GConf, slmPsuNumber=slmPsuNumber, slmLicenseTable=slmLicenseTable, slmAdminAccess=slmAdminAccess, slmTrapLogParam2=slmTrapLogParam2, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLogFile=slmLogFile, slmSnmpv3Auth=slmSnmpv3Auth, slmChPassNewPass=slmChPassNewPass, slmSyslogDestTable=slmSyslogDestTable, slmAuthLogin=slmAuthLogin, slmSysAlmAct=slmSysAlmAct, slmAuth=slmAuth, slmTrapLogParam3=slmTrapLogParam3, slmAuthCommunity=slmAuthCommunity, slmSysTrapFormat=slmSysTrapFormat, slmRstpEnabled=slmRstpEnabled, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLogin=slmLogin, slmTrapLogName=slmTrapLogName, slmSwRevTable=slmSwRevTable)
