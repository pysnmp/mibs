...
Integer32, TimeTicks, Bits, Opaque, Gauge32, Unsigned32, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter64, iso, ObjectIdentity, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "TimeTicks", "Bits", "Opaque", "Gauge32", "Unsigned32", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter64", "iso", "ObjectIdentity", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapUserLogin=slmTrapUserLogin, slmSnmpv3Auth=slmSnmpv3Auth, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrap=slmTrap, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmRstpEnabled=slmRstpEnabled, slmTrapPort=slmTrapPort, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseId=slmLicenseId, slm40GConf=slm40GConf, slmSysLanIpAddr=slmSysLanIpAddr, SoftwareRevision=SoftwareRevision, slmAuthPassword=slmAuthPassword, slmChPassLogin=slmChPassLogin, slmTrapLogParam3=slmTrapLogParam3, slmOemType=slmOemType, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTid=slmTid, slmLicenseEntry=slmLicenseEntry, slmLicenseIndex=slmLicenseIndex, PYSNMP_MODULE_ID=slMain, slmSyslogLevel=slmSyslogLevel, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmAdminRowStatus=slmAdminRowStatus, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAuthCommunity=slmAuthCommunity, slmConfigSysUptime=slmConfigSysUptime, slmSysLocation=slmSysLocation, slmVcatDelay=slmVcatDelay, slmTrapLogParam4=slmTrapLogParam4, slmChPassNewPass=slmChPassNewPass, slmSysGatewayAddr=slmSysGatewayAddr, slmTopologyEnabled=slmTopologyEnabled, slmAuthTable=slmAuthTable, slmSyslogPort=slmSyslogPort, slmAdminAccess=slmAdminAccess, slmSwRevStatus=slmSwRevStatus, UserLogin=UserLogin, slmSysChassisId=slmSysChassisId, slmTrapLogTable=slmTrapLogTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSwRevName=slmSwRevName, slmTrapDestEntry=slmTrapDestEntry, slmAuthEntry=slmAuthEntry, slmTrapUserAccess=slmTrapUserAccess, slmTrapDestAddress=slmTrapDestAddress, slmSysIpAddr=slmSysIpAddr, slmEdfaNumber=slmEdfaNumber, slmReadCommunity=slmReadCommunity, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogParam1=slmTrapLogParam1, slmChPassTable=slmChPassTable, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmMuxNumber=slmMuxNumber, slmTrapCommunity=slmTrapCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogEntry=slmTrapLogEntry, slmTrapLogName=slmTrapLogName, slmSwRevDirectory=slmSwRevDirectory, slmSysCalendarTime=slmSysCalendarTime, slmAdminLogin=slmAdminLogin, slmSysResetPm=slmSysResetPm, slmSwRevEntry=slmSwRevEntry, slmLicense=slmLicense, slmTrapLogId=slmTrapLogId, slmAdmin=slmAdmin, slmSys=slmSys, slmPortsNumber=slmPortsNumber, slmTrapDestTable=slmTrapDestTable, slmSwRevDate=slmSwRevDate, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapLogParam2=slmTrapLogParam2, slmChPassEntry=slmChPassEntry, slmPsuNumber=slmPsuNumber, slmSysTemperature=slmSysTemperature, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogParam6=slmTrapLogParam6, slMain=slMain, slmSysOperStatus=slmSysOperStatus, slmRebootDelay=slmRebootDelay, slmChPassOldPass=slmChPassOldPass, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysAlmDeact=slmSysAlmDeact, slmAdminTable=slmAdminTable, slmLogFile=slmLogFile, slmLogin=slmLogin, slmSysMode=slmSysMode, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSyslogDestEntry=slmSyslogDestEntry, slmSysAlmAct=slmSysAlmAct, slmSysTrapFormat=slmSysTrapFormat, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminPassword=slmAdminPassword, slmAdminCommunity=slmAdminCommunity, slmSysName=slmSysName, slmLicenseTable=slmLicenseTable, slmChPass=slmChPass, slmTrapDestCommunity=slmTrapDestCommunity, slmWriteCommunity=slmWriteCommunity, AdminAccess=AdminAccess, slmSysSnmpVersion=slmSysSnmpVersion, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuth=slmAuth, slmTrapLogParam5=slmTrapLogParam5, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSysUplinkRate=slmSysUplinkRate, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSyslogDestTable=slmSyslogDestTable, slmSnmpv3Password=slmSnmpv3Password, slmSysAdminStatus=slmSysAdminStatus, slmAuthLogin=slmAuthLogin, slmLicenseExpiration=slmLicenseExpiration, UserPassword=UserPassword, slmConfigFile=slmConfigFile, slmNetworkMode=slmNetworkMode, slmAdminEntry=slmAdminEntry, slmPmAvailable=slmPmAvailable, UserCommunity=UserCommunity, slmBoxSize=slmBoxSize, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapEnable=slmTrapEnable, slmSnmpv3Priv=slmSnmpv3Priv, slmSwRevTable=slmSwRevTable, slmSysSubnetMask=slmSysSubnetMask)
