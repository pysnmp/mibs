...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapSysNameChange=slmTrapSysNameChange, slMain=slMain, slmSysAlmAct=slmSysAlmAct, slmAdminAccess=slmAdminAccess, slmSysSnmpVersion=slmSysSnmpVersion, slmSysPmStartOfDay=slmSysPmStartOfDay, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestCommunity=slmTrapDestCommunity, slmChPassLogin=slmChPassLogin, slmSysActiveSwVersion=slmSysActiveSwVersion, slmLicenseEntry=slmLicenseEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTrapLogParam1=slmTrapLogParam1, slmBoxSize=slmBoxSize, slmSys=slmSys, slmSysLocation=slmSysLocation, slmSwRevTable=slmSwRevTable, slmSwRevStatus=slmSwRevStatus, slmPsuNumber=slmPsuNumber, slmConfigFile=slmConfigFile, slmAuthEntry=slmAuthEntry, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSyslogLevel=slmSyslogLevel, slmAdminRowStatus=slmAdminRowStatus, slmSysLanIpAddr=slmSysLanIpAddr, AdminAccess=AdminAccess, slmPmAvailable=slmPmAvailable, slmChPassNewPass=slmChPassNewPass, UserPassword=UserPassword, slmSysCalendarTime=slmSysCalendarTime, slmChPassTable=slmChPassTable, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLogFile=slmLogFile, slmTopologyEnabled=slmTopologyEnabled, slmEdfaNumber=slmEdfaNumber, slmTrapDestIpAddress=slmTrapDestIpAddress, slmLicenseIndex=slmLicenseIndex, slmVcatDelay=slmVcatDelay, slmSysResetPm=slmSysResetPm, slmSysTrapFormat=slmSysTrapFormat, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogName=slmTrapLogName, slmSysMode=slmSysMode, slmSwRevEntry=slmSwRevEntry, slmSnmpv3Priv=slmSnmpv3Priv, slmSnmpv3Password=slmSnmpv3Password, slm40GConf=slm40GConf, slmTrap=slmTrap, slmTrapEnable=slmTrapEnable, slmTrapLogEntry=slmTrapLogEntry, PYSNMP_MODULE_ID=slMain, slmLogin=slmLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmSysGatewayAddr=slmSysGatewayAddr, slmChPassOldPass=slmChPassOldPass, slmSysSubnetMask=slmSysSubnetMask, slmSwRevDate=slmSwRevDate, slmAuthPassword=slmAuthPassword, slmRstpEnabled=slmRstpEnabled, slmTrapUserAccess=slmTrapUserAccess, slmTrapLogParam4=slmTrapLogParam4, slmSysUplinkRate=slmSysUplinkRate, slmAdminPassword=slmAdminPassword, slmRebootDelay=slmRebootDelay, slmTrapLogTable=slmTrapLogTable, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmWriteCommunity=slmWriteCommunity, slmTrapCommunity=slmTrapCommunity, slmTid=slmTid, slmAdminTable=slmAdminTable, slmSysIpAddr=slmSysIpAddr, slmTrapLogParam6=slmTrapLogParam6, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmAuthLogin=slmAuthLogin, slmSysChassisId=slmSysChassisId, slmSwRevDirectory=slmSwRevDirectory, slmSwRevName=slmSwRevName, UserLogin=UserLogin, slmLicense=slmLicense, slmSyslogDestTable=slmSyslogDestTable, slmSysOperStatus=slmSysOperStatus, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogId=slmTrapLogId, slmChPassEntry=slmChPassEntry, slmSysAdminStatus=slmSysAdminStatus, slmTrapDestTable=slmTrapDestTable, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapPort=slmTrapPort, slmReadCommunity=slmReadCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapLogParam3=slmTrapLogParam3, slmSysAlmDeact=slmSysAlmDeact, SoftwareRevision=SoftwareRevision, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmTrapDestAddress=slmTrapDestAddress, slmSysTemperature=slmSysTemperature, slmSysEncryptionCapability=slmSysEncryptionCapability, slmNetworkMode=slmNetworkMode, slmChPass=slmChPass, slmMuxNumber=slmMuxNumber, slmAdminCommunity=slmAdminCommunity, UserCommunity=UserCommunity, slmAdmin=slmAdmin, slmTrapLogParam2=slmTrapLogParam2, slmLicenseExpiration=slmLicenseExpiration, slmTrapUserLogin=slmTrapUserLogin, slmAdminLogin=slmAdminLogin, slmOemType=slmOemType, slmSysNetworkPrefix=slmSysNetworkPrefix, slmAuth=slmAuth, slmConfigSysUptime=slmConfigSysUptime, slmPortsNumber=slmPortsNumber, slmAuthTable=slmAuthTable, slmAdminEntry=slmAdminEntry, slmSyslogPort=slmSyslogPort, slmLicenseId=slmLicenseId, slmTrapLogParam5=slmTrapLogParam5, slmLicenseTable=slmLicenseTable, slmAuthCommunity=slmAuthCommunity, slmSysName=slmSysName, slmTrapDestEntry=slmTrapDestEntry)
