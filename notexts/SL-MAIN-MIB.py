...
TimeTicks, NotificationType, iso, MibIdentifier, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, Counter64, Opaque, Counter32, Integer32, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "iso", "MibIdentifier", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "Counter64", "Opaque", "Counter32", "Integer32", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminRowStatus=slmAdminRowStatus, slmSyslogDestTable=slmSyslogDestTable, slmSwRevEntry=slmSwRevEntry, slmTrapUserLogin=slmTrapUserLogin, slmSwRevDate=slmSwRevDate, slmLicenseId=slmLicenseId, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmOemType=slmOemType, SoftwareRevision=SoftwareRevision, slmTrapCommunity=slmTrapCommunity, slmLicenseTable=slmLicenseTable, slmSwRevStatus=slmSwRevStatus, slmChPassEntry=slmChPassEntry, slmSnmpv3Password=slmSnmpv3Password, slmAdminTable=slmAdminTable, slmRebootDelay=slmRebootDelay, slmSysNetworkPrefix=slmSysNetworkPrefix, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTrapLogId=slmTrapLogId, slmTrapLogTable=slmTrapLogTable, slmSyslogDestAddress=slmSyslogDestAddress, slmSnmpv3Priv=slmSnmpv3Priv, slmSysLanIpAddr=slmSysLanIpAddr, slmSysSnmpVersion=slmSysSnmpVersion, slmPmAvailable=slmPmAvailable, slmTrapUserAccess=slmTrapUserAccess, slmSyslogLevel=slmSyslogLevel, slmSysEncryptionCapability=slmSysEncryptionCapability, slmAdminEntry=slmAdminEntry, slmTrapSysLocationChange=slmTrapSysLocationChange, slmAuthEntry=slmAuthEntry, slmLicenseEntry=slmLicenseEntry, slmSys=slmSys, slmTrap=slmTrap, slmTrapDestCommunity=slmTrapDestCommunity, slmSwRevName=slmSwRevName, slmSysChassisId=slmSysChassisId, slmEdfaNumber=slmEdfaNumber, slmSwRevTable=slmSwRevTable, slmSysAdminStatus=slmSysAdminStatus, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmConfigSysSignalType=slmConfigSysSignalType, slmSysCalendarTime=slmSysCalendarTime, slmVcatDelay=slmVcatDelay, slmAdminCommunity=slmAdminCommunity, slmAuthPassword=slmAuthPassword, slmLicenseExpiration=slmLicenseExpiration, slmChPassTable=slmChPassTable, slmTrapSysNameChange=slmTrapSysNameChange, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmAdminLogin=slmAdminLogin, slmConfigFile=slmConfigFile, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPassLogin=slmChPassLogin, slmTrapLogParam5=slmTrapLogParam5, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapPort=slmTrapPort, slmSysLocation=slmSysLocation, slm40GConf=slm40GConf, slmLogFile=slmLogFile, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSyslogDestEntry=slmSyslogDestEntry, AdminAccess=AdminAccess, slmTrapLogParam2=slmTrapLogParam2, slmSysResetPm=slmSysResetPm, slmWriteCommunity=slmWriteCommunity, slmAdminAccess=slmAdminAccess, slmTrapLogParam6=slmTrapLogParam6, UserPassword=UserPassword, slmAdminPassword=slmAdminPassword, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysAlmDeact=slmSysAlmDeact, slmSysUplinkRate=slmSysUplinkRate, slmSysName=slmSysName, slmTrapDestAddress=slmTrapDestAddress, slmTrapLogEntry=slmTrapLogEntry, slmSysMode=slmSysMode, slmChPassOldPass=slmChPassOldPass, slmTid=slmTid, slmTrapEnable=slmTrapEnable, slmRstpEnabled=slmRstpEnabled, slmAuth=slmAuth, slmSysOperStatus=slmSysOperStatus, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapDestEntry=slmTrapDestEntry, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysSubnetMask=slmSysSubnetMask, PYSNMP_MODULE_ID=slMain, slmSysIpAddr=slmSysIpAddr, slmLicenseIndex=slmLicenseIndex, slmTrapLogParam1=slmTrapLogParam1, slmSwRevDirectory=slmSwRevDirectory, slmTrapDestTable=slmTrapDestTable, slMain=slMain, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAuthCommunity=slmAuthCommunity, slmSysTemperature=slmSysTemperature, UserCommunity=UserCommunity, slmSysTrapFormat=slmSysTrapFormat, slmAdmin=slmAdmin, slmChPass=slmChPass, slmPsuNumber=slmPsuNumber, slmReadCommunity=slmReadCommunity, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmPortsNumber=slmPortsNumber, slmSysAlmAct=slmSysAlmAct, slmConfigSysUptime=slmConfigSysUptime, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTopologyEnabled=slmTopologyEnabled, slmNetworkMode=slmNetworkMode, UserLogin=UserLogin, slmChPassNewPass=slmChPassNewPass, slmLogin=slmLogin, slmMuxNumber=slmMuxNumber, slmSysGatewayAddr=slmSysGatewayAddr, slmSyslogPort=slmSyslogPort, slmTrapLogName=slmTrapLogName, slmLicense=slmLicense, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAuthTable=slmAuthTable, slmSnmpv3Auth=slmSnmpv3Auth, slmAuthLogin=slmAuthLogin, slmBoxSize=slmBoxSize, slmTrapLogParam3=slmTrapLogParam3, slmTrapDestIpAddress=slmTrapDestIpAddress, slmTrapLogParam4=slmTrapLogParam4)
