...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmAuthLogin=slmAuthLogin, slmWriteCommunity=slmWriteCommunity, slmSysName=slmSysName, slmSysAdminStatus=slmSysAdminStatus, slmNetworkMode=slmNetworkMode, slmAuth=slmAuth, slmChPassTable=slmChPassTable, slmLicenseId=slmLicenseId, slmBoxSize=slmBoxSize, slmTrapLogEntry=slmTrapLogEntry, slmOemType=slmOemType, slmAuthEntry=slmAuthEntry, slMain=slMain, slm40GConf=slm40GConf, slmAdminLogin=slmAdminLogin, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmTrapLogParam4=slmTrapLogParam4, slmTrapDestIpAddress=slmTrapDestIpAddress, slmSysCalendarTime=slmSysCalendarTime, slmLogFile=slmLogFile, slmSwRevName=slmSwRevName, slmTopologyEnabled=slmTopologyEnabled, slmTrapLogTable=slmTrapLogTable, slmVcatDelay=slmVcatDelay, slmSyslogDestTable=slmSyslogDestTable, slmAdminTable=slmAdminTable, slmSwRevEntry=slmSwRevEntry, slmSysAlmDeact=slmSysAlmDeact, slmTrapUserLogin=slmTrapUserLogin, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapDestProtVersion=slmTrapDestProtVersion, UserLogin=UserLogin, slmChPassLogin=slmChPassLogin, slmSysEncryptionCapability=slmSysEncryptionCapability, slmLicenseEntry=slmLicenseEntry, slmSysChassisId=slmSysChassisId, slmTrapLogId=slmTrapLogId, slmAdminRowStatus=slmAdminRowStatus, slmSys=slmSys, slmLogin=slmLogin, slmAdminEntry=slmAdminEntry, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogParam5=slmTrapLogParam5, slmTrapLogParam2=slmTrapLogParam2, slmConfigSysUptime=slmConfigSysUptime, slmAuthPassword=slmAuthPassword, slmTrapLogParam6=slmTrapLogParam6, slmRstpEnabled=slmRstpEnabled, slmTrapPort=slmTrapPort, slmTrapDestTable=slmTrapDestTable, slmSnmpv3Password=slmSnmpv3Password, slmEdfaNumber=slmEdfaNumber, slmAdminAccess=slmAdminAccess, slmSwRevTable=slmSwRevTable, slmSysIpAddr=slmSysIpAddr, slmSwRevStatus=slmSwRevStatus, slmSysMode=slmSysMode, slmSnmpv3Priv=slmSnmpv3Priv, slmLicenseIndex=slmLicenseIndex, slmAuthTable=slmAuthTable, SoftwareRevision=SoftwareRevision, slmTrap=slmTrap, slmSysGatewayAddr=slmSysGatewayAddr, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSysSnmpVersion=slmSysSnmpVersion, slmRebootDelay=slmRebootDelay, slmAuthCommunity=slmAuthCommunity, slmSyslogDestEntry=slmSyslogDestEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapDestAddress=slmTrapDestAddress, slmSysResetPm=slmSysResetPm, slmPmAvailable=slmPmAvailable, slmAdminCommunity=slmAdminCommunity, slmSysTrapFormat=slmSysTrapFormat, slmPortsNumber=slmPortsNumber, slmTrapEnable=slmTrapEnable, slmTrapCommunity=slmTrapCommunity, slmReadCommunity=slmReadCommunity, slmChPassEntry=slmChPassEntry, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysTemperature=slmSysTemperature, slmSwRevDate=slmSwRevDate, slmTrapLogName=slmTrapLogName, slmChPassOldPass=slmChPassOldPass, slmAdminPassword=slmAdminPassword, UserCommunity=UserCommunity, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicense=slmLicense, slmLicenseExpiration=slmLicenseExpiration, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSysUplinkRate=slmSysUplinkRate, slmAdmin=slmAdmin, PYSNMP_MODULE_ID=slMain, slmSysAlmAct=slmSysAlmAct, slmChPassNewPass=slmChPassNewPass, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapSysNameChange=slmTrapSysNameChange, slmSyslogLevel=slmSyslogLevel, slmSyslogPort=slmSyslogPort, slmSyslogDestAddress=slmSyslogDestAddress, slmSysOperStatus=slmSysOperStatus, slmMuxNumber=slmMuxNumber, slmSysLanIpAddr=slmSysLanIpAddr, AdminAccess=AdminAccess, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysLocation=slmSysLocation, slmTrapUserAccess=slmTrapUserAccess, slmChPass=slmChPass, slmConfigFile=slmConfigFile, UserPassword=UserPassword, slmTid=slmTid, slmSwRevDirectory=slmSwRevDirectory, slmPsuNumber=slmPsuNumber, slmSysPmStartOfDay=slmSysPmStartOfDay, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam3=slmTrapLogParam3, slmLicenseTable=slmLicenseTable, slmTrapLogParam1=slmTrapLogParam1, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysSubnetMask=slmSysSubnetMask, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr)
