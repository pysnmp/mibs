...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmChPassLogin=slmChPassLogin, AdminAccess=AdminAccess, slmSwRevDate=slmSwRevDate, slmTrapLogParam3=slmTrapLogParam3, slmTrapUserLogin=slmTrapUserLogin, slmTrapLogName=slmTrapLogName, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmTrapLogId=slmTrapLogId, slmTrap=slmTrap, slmLicenseExpiration=slmLicenseExpiration, slmTrapDestProtVersion=slmTrapDestProtVersion, UserPassword=UserPassword, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmTrapLogParam4=slmTrapLogParam4, slmAuthTable=slmAuthTable, slmLicenseTable=slmLicenseTable, slm40GConf=slm40GConf, slmSysCalendarTime=slmSysCalendarTime, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSnmpv3Auth=slmSnmpv3Auth, slmSysChassisId=slmSysChassisId, slmOpticalSwitchExist=slmOpticalSwitchExist, slmTopologyEnabled=slmTopologyEnabled, slmSysTemperature=slmSysTemperature, slmRstpEnabled=slmRstpEnabled, slmAdmin=slmAdmin, slmSwRevStatus=slmSwRevStatus, slmTid=slmTid, slmAdminLogin=slmAdminLogin, slmTrapLogParam5=slmTrapLogParam5, slmSwRevName=slmSwRevName, slmAuthEntry=slmAuthEntry, slmSysSubnetMask=slmSysSubnetMask, SoftwareRevision=SoftwareRevision, slmSysLocation=slmSysLocation, UserLogin=UserLogin, slmTrapCommunity=slmTrapCommunity, PYSNMP_MODULE_ID=slMain, slmSwRevEntry=slmSwRevEntry, slmPortsNumber=slmPortsNumber, slmSnmpv3Password=slmSnmpv3Password, slmAuthLogin=slmAuthLogin, slmTrapSysLocationChange=slmTrapSysLocationChange, slmTrapDestTable=slmTrapDestTable, slmChPass=slmChPass, slmAdminAccess=slmAdminAccess, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmAuth=slmAuth, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapLogParam2=slmTrapLogParam2, slmMuxNumber=slmMuxNumber, slmSysMode=slmSysMode, slmSysTrapFormat=slmSysTrapFormat, slmAdminPassword=slmAdminPassword, slmTrapDestEntry=slmTrapDestEntry, slmPmAvailable=slmPmAvailable, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmChPassNewPass=slmChPassNewPass, UserCommunity=UserCommunity, slmAdminEntry=slmAdminEntry, slmTrapPort=slmTrapPort, slmSysNetworkPrefix=slmSysNetworkPrefix, slmNetworkMode=slmNetworkMode, slmOemType=slmOemType, slmLogFile=slmLogFile, slmSwRevDirectory=slmSwRevDirectory, slmSyslogDestAddress=slmSyslogDestAddress, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmLicenseId=slmLicenseId, slmSysIpAddr=slmSysIpAddr, slmConfigSysUptime=slmConfigSysUptime, slmLogin=slmLogin, slmTrapLogTable=slmTrapLogTable, slmSysLanIpAddr=slmSysLanIpAddr, slmSwRevTable=slmSwRevTable, slmWriteCommunity=slmWriteCommunity, slmBoxSize=slmBoxSize, slmTrapDestCommunity=slmTrapDestCommunity, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmSysActiveSwVersion=slmSysActiveSwVersion, slmAdminCommunity=slmAdminCommunity, slmSysAlmAct=slmSysAlmAct, slmChPassOldPass=slmChPassOldPass, slmReadCommunity=slmReadCommunity, slmVcatDelay=slmVcatDelay, slmSnmpv3Priv=slmSnmpv3Priv, slmTrapSysNameChange=slmTrapSysNameChange, slmTrapLogParam1=slmTrapLogParam1, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmAdminRowStatus=slmAdminRowStatus, slmSyslogLevel=slmSyslogLevel, slmAdminTable=slmAdminTable, slmChPassTable=slmChPassTable, slMain=slMain, slmAuthCommunity=slmAuthCommunity, slmConfigFile=slmConfigFile, slmSysSnmpVersion=slmSysSnmpVersion, slmChPassEntry=slmChPassEntry, slmAuthPassword=slmAuthPassword, slmSysGatewayAddr=slmSysGatewayAddr, slmRebootDelay=slmRebootDelay, slmSysOperStatus=slmSysOperStatus, slmSysAlmDeact=slmSysAlmDeact, slmSyslogDestEntry=slmSyslogDestEntry, slmSysResetPm=slmSysResetPm, slmTrapDestRowStatus=slmTrapDestRowStatus, slmSyslogDestTable=slmSyslogDestTable, slmSys=slmSys, slmTrapLogParam6=slmTrapLogParam6, slmSysAdminStatus=slmSysAdminStatus, slmTrapEnable=slmTrapEnable, slmPsuNumber=slmPsuNumber, slmConfigSysSignalType=slmConfigSysSignalType, slmSyslogPort=slmSyslogPort, slmLicenseIndex=slmLicenseIndex, slmSysName=slmSysName, slmTrapDestIpAddress=slmTrapDestIpAddress, slmEdfaNumber=slmEdfaNumber, slmTrapUserAccess=slmTrapUserAccess, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicenseEntry=slmLicenseEntry, slmSysUplinkRate=slmSysUplinkRate, slmTrapDestAddress=slmTrapDestAddress, slmLicense=slmLicense, slmTrapLogEntry=slmTrapLogEntry, slmSysPmStartOfDay=slmSysPmStartOfDay)
