...
# Produced by pysmi-1.1.3 at Sun Nov 28 16:44:14 2021
...
ObjectIdentity, IpAddress, Counter32, ModuleIdentity, MibIdentifier, Counter64, NotificationType, Gauge32, NotificationType, Bits, TimeTicks, Integer32, enterprises, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "Counter32", "ModuleIdentity", "MibIdentifier", "Counter64", "NotificationType", "Gauge32", "NotificationType", "Bits", "TimeTicks", "Integer32", "enterprises", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("QUIDOS-MIB", PositiveInteger=PositiveInteger, table_term=table_term, StatCit=StatCit, outTable=outTable, quido_var=quido_var, time=time, in_name=in_name, inTable=inTable, out_name=out_name, termEntry=termEntry, user_name=user_name, device_msg=device_msg, pysmi_in=pysmi_in, papouchProjekt=papouchProjekt, modeTerm=modeTerm, citrwS=citrwS, inEntry=inEntry, citrw=citrw, table_out=table_out, termTable=termTable, outEntry=outEntry, temp_msg=temp_msg, err=err, temperature_S_Reading=temperature_S_Reading, mezHi=mezHi, mezLo=mezLo, quidos=quidos, outTwr=outTwr, OnOff=OnOff, table_in=table_in, out=out, temperatureReading=temperatureReading)
