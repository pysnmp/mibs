...
Gauge32, ObjectIdentity, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, Integer32, Unsigned32, NotificationType, Counter32, TimeTicks, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "Integer32", "Unsigned32", "NotificationType", "Counter32", "TimeTicks", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("S5-CHASSIS-MIB", PYSNMP_MODULE_ID=s5ChasMib, s5ChasAttBrdIndx=s5ChasAttBrdIndx, s5ChasStoreUsedSize=s5ChasStoreUsedSize, s5ChasLocChanIndx=s5ChasLocChanIndx, s5ChasGrpMaxEnts=s5ChasGrpMaxEnts, s5ChasPsRpsuTable=s5ChasPsRpsuTable, s5ChasComIpv6MgmtNetMask=s5ChasComIpv6MgmtNetMask, s5ChasGblAttLstChng=s5ChasGblAttLstChng, s5ChasComSubIndx=s5ChasComSubIndx, s5ChasComIpMgmtGateway=s5ChasComIpMgmtGateway, s5ChasAttLstChng=s5ChasAttLstChng, s5ChasType=s5ChasType, s5ChasStore=s5ChasStore, s5ChasComUpTime=s5ChasComUpTime, s5ChasComIpv6NetMask=s5ChasComIpv6NetMask, s5ChasGbicInfoProductCode=s5ChasGbicInfoProductCode, s5ChasComAdminState=s5ChasComAdminState, s5ChasUtilMemoryMinAvailable=s5ChasUtilMemoryMinAvailable, s5ChasTmpSnrEntry=s5ChasTmpSnrEntry, s5ChasLocChanEntry=s5ChasLocChanEntry, s5ChasComTable=s5ChasComTable, s5ChasUtil=s5ChasUtil, s5ChasAttEntry=s5ChasAttEntry, s5ChasComOperState=s5ChasComOperState, s5ChasAttCurAtt=s5ChasAttCurAtt, s5ChasPsRpsuEntry=s5ChasPsRpsuEntry, s5ChasGblConfChngs=s5ChasGblConfChngs, s5ChasGbicInfoIfIndex=s5ChasGbicInfoIfIndex, s5ChasAttChngs=s5ChasAttChngs, s5ChasGrpType=s5ChasGrpType, s5ChasBrdCfgSrc=s5ChasBrdCfgSrc, s5ChasContact=s5ChasContact, s5ChasComMaxSubs=s5ChasComMaxSubs, s5ChasComTotalNumPorts=s5ChasComTotalNumPorts, s5ChasComIpMgmtNetMask=s5ChasComIpMgmtNetMask, s5ChasStoreIndx=s5ChasStoreIndx, s5ChasComDescr=s5ChasComDescr, s5ChasGblAttChngs=s5ChasGblAttChngs, s5ChasVer=s5ChasVer, s5ChasSmDateCode=s5ChasSmDateCode, s5ChasComIpv6MgmtAddress=s5ChasComIpv6MgmtAddress, s5ChasAttTable=s5ChasAttTable, s5ChasBrdEntry=s5ChasBrdEntry, s5ChasGrpTable=s5ChasGrpTable, s5ChasSmLeds=s5ChasSmLeds, s5ChasGbicInfoVendorName=s5ChasGbicInfoVendorName, s5ChasGbicInfoVendorRevision=s5ChasGbicInfoVendorRevision, s5ChasMib=s5ChasMib, s5ChasBrdFanLeds=s5ChasBrdFanLeds, s5ChasComIpMgmtAddress=s5ChasComIpMgmtAddress, s5ChasPsRpsuSubIndx=s5ChasPsRpsuSubIndx, s5ChasBrdLeds=s5ChasBrdLeds, s5ChasStoreDescription=s5ChasStoreDescription, s5ChasGrpDescr=s5ChasGrpDescr, s5ChasPsRpsuIndx=s5ChasPsRpsuIndx, s5ChasBrd=s5ChasBrd, s5ChasComLocation=s5ChasComLocation, s5ChasTmpSnrIndx=s5ChasTmpSnrIndx, s5ChasGbicInfoVendorSerial=s5ChasGbicInfoVendorSerial, s5ChasBrdStatusDsply=s5ChasBrdStatusDsply, s5ChasPsRpsuSourceConfig=s5ChasPsRpsuSourceConfig, s5ChasComBaseNumPorts=s5ChasComBaseNumPorts, s5ChasTmpSnrTable=s5ChasTmpSnrTable, s5ChasStoreComIndx=s5ChasStoreComIndx, s5ChasPsRpsuType=s5ChasPsRpsuType, s5ChasBrdNumAtt=s5ChasBrdNumAtt, s5ChasUtilTotalCPUUsage=s5ChasUtilTotalCPUUsage, s5ChasGbicInfoVendorPartNo=s5ChasGbicInfoVendorPartNo, s5ChasComNumSubs=s5ChasComNumSubs, s5ChasTmpSnr=s5ChasTmpSnr, s5ChasComVer=s5ChasComVer, s5ChasComGroupMap=s5ChasComGroupMap, s5ChasPs=s5ChasPs, s5ChasComType=s5ChasComType, s5ChasUtilEntry=s5ChasUtilEntry, s5ChasUtilCPUUsageLast1Minute=s5ChasUtilCPUUsageLast1Minute, s5ChasSm=s5ChasSm, s5ChasUtilMemoryAvailableMB=s5ChasUtilMemoryAvailableMB, s5ChasPsRpsuGrpIndx=s5ChasPsRpsuGrpIndx, s5ChasUtilMemoryAvailable=s5ChasUtilMemoryAvailable, s5ChasUtilCPUUsageLast24Hours=s5ChasUtilCPUUsageLast24Hours, s5ChasComRunningSoftwareVer=s5ChasComRunningSoftwareVer, s5ChasGrpPhysChngs=s5ChasGrpPhysChngs, s5ChasLocation=s5ChasLocation, s5ChasGrpPhysLstChng=s5ChasGrpPhysLstChng, s5ChasGblPhysChngs=s5ChasGblPhysChngs, s5ChasGbicInfoGbicType=s5ChasGbicInfoGbicType, s5ChasUtilSubIndx=s5ChasUtilSubIndx, s5ChasComIpMgmtTimeout=s5ChasComIpMgmtTimeout, s5ChasBrdIndx=s5ChasBrdIndx, s5ChasGbicInfoTable=s5ChasGbicInfoTable, s5ChasUtilCPUUsageLast10Minutes=s5ChasUtilCPUUsageLast10Minutes, s5ChasGbicInfoCleiCode=s5ChasGbicInfoCleiCode, s5ChasBrdAttChngs=s5ChasBrdAttChngs, s5ChasAttClusterConnCapability=s5ChasAttClusterConnCapability, s5ChasStoreType=s5ChasStoreType, s5ChasGblPhysLstChng=s5ChasGblPhysLstChng, s5ChasUtilGrpIndx=s5ChasUtilGrpIndx, s5ChasUtilIndx=s5ChasUtilIndx, s5ChasGrpIndx=s5ChasGrpIndx, s5ChasTmpSnrGrpIndx=s5ChasTmpSnrGrpIndx, s5ChasGrpEntry=s5ChasGrpEntry, s5ChasCom=s5ChasCom, s5ChasGbicInfoEntry=s5ChasGbicInfoEntry, s5ChasBrdTable=s5ChasBrdTable, s5ChasStoreCurSize=s5ChasStoreCurSize, s5ChasGrpNumEnts=s5ChasGrpNumEnts, s5ChasUtilCPUUsageLast1Hour=s5ChasUtilCPUUsageLast1Hour, s5ChasComIpv6Address=s5ChasComIpv6Address, s5ChasComIpMgmtShutdown=s5ChasComIpMgmtShutdown, s5ChasComLstChng=s5ChasComLstChng, s5ChasStoreGrpIndx=s5ChasStoreGrpIndx, s5ChasComIpAddress=s5ChasComIpAddress, s5ChasGblConfLstChng=s5ChasGblConfLstChng, s5ChasUtilMemoryTotalMB=s5ChasUtilMemoryTotalMB, s5ChasNotify=s5ChasNotify, s5ChasComIndx=s5ChasComIndx, s5ChasUtilCPUUsageLast10Seconds=s5ChasUtilCPUUsageLast10Seconds, s5ChasGbicInfoWavelength=s5ChasGbicInfoWavelength, s5ChasBrdAttLstChng=s5ChasBrdAttLstChng, s5ChasGbicInfoDateCode=s5ChasGbicInfoDateCode, s5ChasComRelPos=s5ChasComRelPos, s5ChasDescr=s5ChasDescr, s5ChasSerNum=s5ChasSerNum, s5ChasUtilTable=s5ChasUtilTable, s5ChasStoreCntntVer=s5ChasStoreCntntVer, s5ChasPluggables=s5ChasPluggables, s5ChasGrpEncodeFactor=s5ChasGrpEncodeFactor, s5ChasAttDfltAtt=s5ChasAttDfltAtt, s5ChasStoreAge=s5ChasStoreAge, s5ChasGbicInfoVendorOui=s5ChasGbicInfoVendorOui, s5ChasGbicInfoHwOptions=s5ChasGbicInfoHwOptions, s5ChasAttIndx=s5ChasAttIndx, s5ChasTmpSnrValue=s5ChasTmpSnrValue, s5ChasTmpSnrSubIndx=s5ChasTmpSnrSubIndx, s5ChasBrdCfgChngs=s5ChasBrdCfgChngs, s5ChasComEntry=s5ChasComEntry, s5ChasStoreSubIndx=s5ChasStoreSubIndx, s5ChasComSerNum=s5ChasComSerNum, s5ChasNotifyFanDirection=s5ChasNotifyFanDirection, s5ChasGrp=s5ChasGrp, s5ChasGen=s5ChasGen, s5ChasLocChanTable=s5ChasLocChanTable, s5ChasLocChanBrdIndx=s5ChasLocChanBrdIndx, s5ChasLocChanBkplMode=s5ChasLocChanBkplMode, s5ChasBrdDateCode=s5ChasBrdDateCode, s5ChasComIpMgmtLimit=s5ChasComIpMgmtLimit, s5ChasStoreFilename=s5ChasStoreFilename, s5ChasTmpSnrTmpValue=s5ChasTmpSnrTmpValue, s5ChasStoreEntry=s5ChasStoreEntry, s5ChasStoreTable=s5ChasStoreTable, s5ChasComGrpIndx=s5ChasComGrpIndx)
