...
Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, Bits, MibIdentifier, iso, IpAddress, Counter64, Unsigned32, TimeTicks, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "Bits", "MibIdentifier", "iso", "IpAddress", "Counter64", "Unsigned32", "TimeTicks", "ObjectIdentity", "Integer32")
...
mibBuilder.exportSymbols("S5-CHASSIS-MIB", s5ChasSmDateCode=s5ChasSmDateCode, s5ChasComEntry=s5ChasComEntry, s5ChasSmLeds=s5ChasSmLeds, s5ChasGbicInfoGbicType=s5ChasGbicInfoGbicType, s5ChasLocChanBrdIndx=s5ChasLocChanBrdIndx, s5ChasBrdNumAtt=s5ChasBrdNumAtt, PYSNMP_MODULE_ID=s5ChasMib, s5ChasGblConfChngs=s5ChasGblConfChngs, s5ChasGbicInfoIfIndex=s5ChasGbicInfoIfIndex, s5ChasStoreIndx=s5ChasStoreIndx, s5ChasContact=s5ChasContact, s5ChasUtilCPUUsageLast1Hour=s5ChasUtilCPUUsageLast1Hour, s5ChasGblConfLstChng=s5ChasGblConfLstChng, s5ChasAttBrdIndx=s5ChasAttBrdIndx, s5ChasComIpMgmtNetMask=s5ChasComIpMgmtNetMask, s5ChasTmpSnrTable=s5ChasTmpSnrTable, s5ChasUtilMemoryAvailable=s5ChasUtilMemoryAvailable, s5ChasBrdDateCode=s5ChasBrdDateCode, s5ChasStoreCurSize=s5ChasStoreCurSize, s5ChasComNumSubs=s5ChasComNumSubs, s5ChasUtilSubIndx=s5ChasUtilSubIndx, s5ChasStoreFilename=s5ChasStoreFilename, s5ChasCom=s5ChasCom, s5ChasComOperState=s5ChasComOperState, s5ChasGen=s5ChasGen, s5ChasComIpMgmtGateway=s5ChasComIpMgmtGateway, s5ChasComIpAddress=s5ChasComIpAddress, s5ChasNotify=s5ChasNotify, s5ChasSerNum=s5ChasSerNum, s5ChasBrdCfgSrc=s5ChasBrdCfgSrc, s5ChasComIndx=s5ChasComIndx, s5ChasAttIndx=s5ChasAttIndx, s5ChasUtilGrpIndx=s5ChasUtilGrpIndx, s5ChasComAdminState=s5ChasComAdminState, s5ChasGbicInfoHwOptions=s5ChasGbicInfoHwOptions, s5ChasStoreAge=s5ChasStoreAge, s5ChasStoreCntntVer=s5ChasStoreCntntVer, s5ChasGrpEntry=s5ChasGrpEntry, s5ChasUtilEntry=s5ChasUtilEntry, s5ChasComDescr=s5ChasComDescr, s5ChasComGrpIndx=s5ChasComGrpIndx, s5ChasBrdEntry=s5ChasBrdEntry, s5ChasComUpTime=s5ChasComUpTime, s5ChasBrdFanLeds=s5ChasBrdFanLeds, s5ChasSm=s5ChasSm, s5ChasGblAttLstChng=s5ChasGblAttLstChng, s5ChasBrdAttLstChng=s5ChasBrdAttLstChng, s5ChasStoreType=s5ChasStoreType, s5ChasGbicInfoVendorPartNo=s5ChasGbicInfoVendorPartNo, s5ChasGrpNumEnts=s5ChasGrpNumEnts, s5ChasTmpSnr=s5ChasTmpSnr, s5ChasComTotalNumPorts=s5ChasComTotalNumPorts, s5ChasTmpSnrEntry=s5ChasTmpSnrEntry, s5ChasStoreEntry=s5ChasStoreEntry, s5ChasBrdStatusDsply=s5ChasBrdStatusDsply, s5ChasGrpPhysLstChng=s5ChasGrpPhysLstChng, s5ChasAttLstChng=s5ChasAttLstChng, s5ChasPsRpsuGrpIndx=s5ChasPsRpsuGrpIndx, s5ChasGbicInfoVendorRevision=s5ChasGbicInfoVendorRevision, s5ChasGblPhysLstChng=s5ChasGblPhysLstChng, s5ChasComMaxSubs=s5ChasComMaxSubs, s5ChasComIpv6Address=s5ChasComIpv6Address, s5ChasTmpSnrTmpValue=s5ChasTmpSnrTmpValue, s5ChasGbicInfoWavelength=s5ChasGbicInfoWavelength, s5ChasGrpPhysChngs=s5ChasGrpPhysChngs, s5ChasAttTable=s5ChasAttTable, s5ChasBrd=s5ChasBrd, s5ChasComTable=s5ChasComTable, s5ChasUtilMemoryAvailableMB=s5ChasUtilMemoryAvailableMB, s5ChasStoreUsedSize=s5ChasStoreUsedSize, s5ChasUtilMemoryMinAvailable=s5ChasUtilMemoryMinAvailable, s5ChasVer=s5ChasVer, s5ChasBrdCfgChngs=s5ChasBrdCfgChngs, s5ChasNotifyFanDirection=s5ChasNotifyFanDirection, s5ChasGbicInfoCleiCode=s5ChasGbicInfoCleiCode, s5ChasGbicInfoEntry=s5ChasGbicInfoEntry, s5ChasGblAttChngs=s5ChasGblAttChngs, s5ChasGbicInfoTable=s5ChasGbicInfoTable, s5ChasComVer=s5ChasComVer, s5ChasGblPhysChngs=s5ChasGblPhysChngs, s5ChasComIpMgmtShutdown=s5ChasComIpMgmtShutdown, s5ChasLocChanTable=s5ChasLocChanTable, s5ChasGbicInfoVendorSerial=s5ChasGbicInfoVendorSerial, s5ChasUtilCPUUsageLast1Minute=s5ChasUtilCPUUsageLast1Minute, s5ChasPsRpsuSubIndx=s5ChasPsRpsuSubIndx, s5ChasComRunningSoftwareVer=s5ChasComRunningSoftwareVer, s5ChasPs=s5ChasPs, s5ChasAttClusterConnCapability=s5ChasAttClusterConnCapability, s5ChasLocChanEntry=s5ChasLocChanEntry, s5ChasGbicInfoProductCode=s5ChasGbicInfoProductCode, s5ChasTmpSnrValue=s5ChasTmpSnrValue, s5ChasType=s5ChasType, s5ChasStoreDescription=s5ChasStoreDescription, s5ChasTmpSnrGrpIndx=s5ChasTmpSnrGrpIndx, s5ChasGrpIndx=s5ChasGrpIndx, s5ChasGrpMaxEnts=s5ChasGrpMaxEnts, s5ChasGrp=s5ChasGrp, s5ChasBrdLeds=s5ChasBrdLeds, s5ChasBrdAttChngs=s5ChasBrdAttChngs, s5ChasGrpDescr=s5ChasGrpDescr, s5ChasUtilMemoryTotalMB=s5ChasUtilMemoryTotalMB, s5ChasComIpMgmtTimeout=s5ChasComIpMgmtTimeout, s5ChasUtilTotalCPUUsage=s5ChasUtilTotalCPUUsage, s5ChasComIpMgmtLimit=s5ChasComIpMgmtLimit, s5ChasComBaseNumPorts=s5ChasComBaseNumPorts, s5ChasTmpSnrSubIndx=s5ChasTmpSnrSubIndx, s5ChasComIpv6MgmtAddress=s5ChasComIpv6MgmtAddress, s5ChasComSerNum=s5ChasComSerNum, s5ChasUtilCPUUsageLast24Hours=s5ChasUtilCPUUsageLast24Hours, s5ChasComIpv6MgmtNetMask=s5ChasComIpv6MgmtNetMask, s5ChasGrpType=s5ChasGrpType, s5ChasUtilCPUUsageLast10Minutes=s5ChasUtilCPUUsageLast10Minutes, s5ChasGrpTable=s5ChasGrpTable, s5ChasComIpv6NetMask=s5ChasComIpv6NetMask, s5ChasStoreTable=s5ChasStoreTable, s5ChasLocation=s5ChasLocation, s5ChasPsRpsuIndx=s5ChasPsRpsuIndx, s5ChasAttEntry=s5ChasAttEntry, s5ChasPluggables=s5ChasPluggables, s5ChasStore=s5ChasStore, s5ChasUtil=s5ChasUtil, s5ChasLocChanBkplMode=s5ChasLocChanBkplMode, s5ChasComType=s5ChasComType, s5ChasComRelPos=s5ChasComRelPos, s5ChasGbicInfoVendorOui=s5ChasGbicInfoVendorOui, s5ChasPsRpsuEntry=s5ChasPsRpsuEntry, s5ChasGrpEncodeFactor=s5ChasGrpEncodeFactor, s5ChasMib=s5ChasMib, s5ChasPsRpsuSourceConfig=s5ChasPsRpsuSourceConfig, s5ChasBrdIndx=s5ChasBrdIndx, s5ChasBrdTable=s5ChasBrdTable, s5ChasComSubIndx=s5ChasComSubIndx, s5ChasGbicInfoDateCode=s5ChasGbicInfoDateCode, s5ChasComGroupMap=s5ChasComGroupMap, s5ChasUtilTable=s5ChasUtilTable, s5ChasPsRpsuTable=s5ChasPsRpsuTable, s5ChasDescr=s5ChasDescr, s5ChasLocChanIndx=s5ChasLocChanIndx, s5ChasAttCurAtt=s5ChasAttCurAtt, s5ChasStoreGrpIndx=s5ChasStoreGrpIndx, s5ChasGbicInfoVendorName=s5ChasGbicInfoVendorName, s5ChasComIpMgmtAddress=s5ChasComIpMgmtAddress, s5ChasStoreSubIndx=s5ChasStoreSubIndx, s5ChasTmpSnrIndx=s5ChasTmpSnrIndx, s5ChasUtilIndx=s5ChasUtilIndx, s5ChasStoreComIndx=s5ChasStoreComIndx, s5ChasComLocation=s5ChasComLocation, s5ChasAttDfltAtt=s5ChasAttDfltAtt, s5ChasAttChngs=s5ChasAttChngs, s5ChasUtilCPUUsageLast10Seconds=s5ChasUtilCPUUsageLast10Seconds, s5ChasPsRpsuType=s5ChasPsRpsuType, s5ChasComLstChng=s5ChasComLstChng)
