...
mibBuilder.exportSymbols("S5-CHASSIS-MIB", s5ChasGbicInfoProductCode=s5ChasGbicInfoProductCode, s5ChasAttDfltAtt=s5ChasAttDfltAtt, s5ChasTmpSnrValue=s5ChasTmpSnrValue, s5ChasPsRpsuSourceConfig=s5ChasPsRpsuSourceConfig, s5ChasPsRpsuSubIndx=s5ChasPsRpsuSubIndx, s5ChasGbicInfoVendorRevision=s5ChasGbicInfoVendorRevision, s5ChasGrpType=s5ChasGrpType, s5ChasPsRpsuIndx=s5ChasPsRpsuIndx, s5ChasPluggables=s5ChasPluggables, s5ChasAttChngs=s5ChasAttChngs, s5ChasBrdFanLeds=s5ChasBrdFanLeds, s5ChasBrdAttLstChng=s5ChasBrdAttLstChng, s5ChasStoreType=s5ChasStoreType, s5ChasComOperState=s5ChasComOperState, s5ChasGblAttChngs=s5ChasGblAttChngs, s5ChasUtilTotalCPUUsage=s5ChasUtilTotalCPUUsage, s5ChasComUpTime=s5ChasComUpTime, s5ChasStoreDescription=s5ChasStoreDescription, s5ChasGblConfLstChng=s5ChasGblConfLstChng, s5ChasBrdNumAtt=s5ChasBrdNumAtt, s5ChasUtilGrpIndx=s5ChasUtilGrpIndx, s5ChasPsRpsuEntry=s5ChasPsRpsuEntry, s5ChasAttEntry=s5ChasAttEntry, s5ChasGrpEncodeFactor=s5ChasGrpEncodeFactor, s5ChasLocChanBrdIndx=s5ChasLocChanBrdIndx, s5ChasLocChanTable=s5ChasLocChanTable, s5ChasComLstChng=s5ChasComLstChng, s5ChasComTotalNumPorts=s5ChasComTotalNumPorts, s5ChasUtilCPUUsageLast1Hour=s5ChasUtilCPUUsageLast1Hour, s5ChasPs=s5ChasPs, s5ChasBrdCfgChngs=s5ChasBrdCfgChngs, s5ChasLocChanIndx=s5ChasLocChanIndx, s5ChasGbicInfoCleiCode=s5ChasGbicInfoCleiCode, s5ChasPsRpsuType=s5ChasPsRpsuType, s5ChasAttCurAtt=s5ChasAttCurAtt, s5ChasSmDateCode=s5ChasSmDateCode, s5ChasStoreSubIndx=s5ChasStoreSubIndx, s5ChasUtilTable=s5ChasUtilTable, s5ChasComGrpIndx=s5ChasComGrpIndx, s5ChasBrdIndx=s5ChasBrdIndx, s5ChasBrdTable=s5ChasBrdTable, s5ChasTmpSnr=s5ChasTmpSnr, s5ChasBrdEntry=s5ChasBrdEntry, s5ChasStoreFilename=s5ChasStoreFilename, s5ChasUtilCPUUsageLast10Minutes=s5ChasUtilCPUUsageLast10Minutes, s5ChasStoreCurSize=s5ChasStoreCurSize, s5ChasStoreGrpIndx=s5ChasStoreGrpIndx, s5ChasGrpDescr=s5ChasGrpDescr, s5ChasNotifyFanDirection=s5ChasNotifyFanDirection, s5ChasGbicInfoVendorOui=s5ChasGbicInfoVendorOui, s5ChasComIpv6Address=s5ChasComIpv6Address, s5ChasTmpSnrTmpValue=s5ChasTmpSnrTmpValue, s5ChasGbicInfoVendorName=s5ChasGbicInfoVendorName, s5ChasUtilSubIndx=s5ChasUtilSubIndx, s5ChasPsRpsuGrpIndx=s5ChasPsRpsuGrpIndx, s5ChasStoreUsedSize=s5ChasStoreUsedSize, s5ChasLocation=s5ChasLocation, s5ChasGbicInfoVendorSerial=s5ChasGbicInfoVendorSerial, s5ChasGbicInfoWavelength=s5ChasGbicInfoWavelength, s5ChasStoreAge=s5ChasStoreAge, s5ChasGbicInfoDateCode=s5ChasGbicInfoDateCode, s5ChasLocChanBkplMode=s5ChasLocChanBkplMode, s5ChasComIpMgmtAddress=s5ChasComIpMgmtAddress, s5ChasUtilIndx=s5ChasUtilIndx, s5ChasPsRpsuTable=s5ChasPsRpsuTable, s5ChasBrdAttChngs=s5ChasBrdAttChngs, s5ChasGbicInfoTable=s5ChasGbicInfoTable, s5ChasComSerNum=s5ChasComSerNum, s5ChasComRelPos=s5ChasComRelPos, s5ChasComIpAddress=s5ChasComIpAddress, s5ChasComGroupMap=s5ChasComGroupMap, s5ChasComType=s5ChasComType, s5ChasContact=s5ChasContact, s5ChasTmpSnrSubIndx=s5ChasTmpSnrSubIndx, s5ChasUtilMemoryAvailableMB=s5ChasUtilMemoryAvailableMB, s5ChasVer=s5ChasVer, s5ChasTmpSnrTable=s5ChasTmpSnrTable, s5ChasGrpMaxEnts=s5ChasGrpMaxEnts, s5ChasComIndx=s5ChasComIndx, s5ChasComIpMgmtGateway=s5ChasComIpMgmtGateway, s5ChasSmLeds=s5ChasSmLeds, s5ChasComVer=s5ChasComVer, s5ChasComIpMgmtShutdown=s5ChasComIpMgmtShutdown, s5ChasGrpEntry=s5ChasGrpEntry, s5ChasStoreCntntVer=s5ChasStoreCntntVer, s5ChasAttBrdIndx=s5ChasAttBrdIndx, s5ChasAttTable=s5ChasAttTable, s5ChasComDescr=s5ChasComDescr, s5ChasUtilCPUUsageLast10Seconds=s5ChasUtilCPUUsageLast10Seconds, s5ChasComIpv6NetMask=s5ChasComIpv6NetMask, s5ChasComIpv6MgmtNetMask=s5ChasComIpv6MgmtNetMask, s5ChasComRunningSoftwareVer=s5ChasComRunningSoftwareVer, s5ChasComIpMgmtTimeout=s5ChasComIpMgmtTimeout, s5ChasCom=s5ChasCom, s5ChasNotify=s5ChasNotify, s5ChasGen=s5ChasGen, s5ChasUtilMemoryMinAvailable=s5ChasUtilMemoryMinAvailable, s5ChasTmpSnrEntry=s5ChasTmpSnrEntry, s5ChasBrd=s5ChasBrd, s5ChasGrpNumEnts=s5ChasGrpNumEnts, s5ChasGrp=s5ChasGrp, s5ChasBrdLeds=s5ChasBrdLeds, s5ChasLocChanEntry=s5ChasLocChanEntry, s5ChasTmpSnrIndx=s5ChasTmpSnrIndx, s5ChasComIpMgmtNetMask=s5ChasComIpMgmtNetMask, s5ChasMib=s5ChasMib, s5ChasGrpPhysLstChng=s5ChasGrpPhysLstChng, s5ChasUtilMemoryAvailable=s5ChasUtilMemoryAvailable, s5ChasUtilCPUUsageLast24Hours=s5ChasUtilCPUUsageLast24Hours, s5ChasSm=s5ChasSm, s5ChasGbicInfoIfIndex=s5ChasGbicInfoIfIndex, s5ChasBrdStatusDsply=s5ChasBrdStatusDsply, s5ChasComNumSubs=s5ChasComNumSubs, s5ChasDescr=s5ChasDescr, s5ChasGrpPhysChngs=s5ChasGrpPhysChngs, s5ChasGblPhysChngs=s5ChasGblPhysChngs, s5ChasUtilEntry=s5ChasUtilEntry, s5ChasComAdminState=s5ChasComAdminState, s5ChasComIpMgmtLimit=s5ChasComIpMgmtLimit, s5ChasGbicInfoVendorPartNo=s5ChasGbicInfoVendorPartNo, s5ChasComMaxSubs=s5ChasComMaxSubs, s5ChasGbicInfoHwOptions=s5ChasGbicInfoHwOptions, s5ChasStoreTable=s5ChasStoreTable, s5ChasComSubIndx=s5ChasComSubIndx, s5ChasAttLstChng=s5ChasAttLstChng, s5ChasStoreComIndx=s5ChasStoreComIndx, s5ChasComIpv6MgmtAddress=s5ChasComIpv6MgmtAddress, s5ChasTmpSnrGrpIndx=s5ChasTmpSnrGrpIndx, s5ChasUtilCPUUsageLast1Minute=s5ChasUtilCPUUsageLast1Minute, s5ChasGbicInfoGbicType=s5ChasGbicInfoGbicType, s5ChasGrpTable=s5ChasGrpTable, s5ChasComLocation=s5ChasComLocation, s5ChasType=s5ChasType, s5ChasGblConfChngs=s5ChasGblConfChngs, s5ChasAttClusterConnCapability=s5ChasAttClusterConnCapability, s5ChasSerNum=s5ChasSerNum, s5ChasAttIndx=s5ChasAttIndx, s5ChasStoreEntry=s5ChasStoreEntry, s5ChasGblAttLstChng=s5ChasGblAttLstChng, PYSNMP_MODULE_ID=s5ChasMib, s5ChasBrdDateCode=s5ChasBrdDateCode, s5ChasGrpIndx=s5ChasGrpIndx, s5ChasBrdCfgSrc=s5ChasBrdCfgSrc, s5ChasGbicInfoEntry=s5ChasGbicInfoEntry, s5ChasGblPhysLstChng=s5ChasGblPhysLstChng, s5ChasStore=s5ChasStore, s5ChasUtilMemoryTotalMB=s5ChasUtilMemoryTotalMB, s5ChasComTable=s5ChasComTable, s5ChasComEntry=s5ChasComEntry, s5ChasStoreIndx=s5ChasStoreIndx, s5ChasUtil=s5ChasUtil, s5ChasComBaseNumPorts=s5ChasComBaseNumPorts)
