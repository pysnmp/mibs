...
mibBuilder.exportSymbols("S5-CHASSIS-MIB", s5ChasComType=s5ChasComType, s5ChasUtilCPUUsageLast1Hour=s5ChasUtilCPUUsageLast1Hour, s5ChasGrpTable=s5ChasGrpTable, s5ChasGbicInfoEntry=s5ChasGbicInfoEntry, s5ChasComIndx=s5ChasComIndx, s5ChasComRunningSoftwareVer=s5ChasComRunningSoftwareVer, s5ChasBrdIndx=s5ChasBrdIndx, s5ChasComIpMgmtNetMask=s5ChasComIpMgmtNetMask, s5ChasGbicInfoVendorRevision=s5ChasGbicInfoVendorRevision, s5ChasUtilCPUUsageLast1Minute=s5ChasUtilCPUUsageLast1Minute, s5ChasTmpSnrIndx=s5ChasTmpSnrIndx, s5ChasComBaseNumPorts=s5ChasComBaseNumPorts, s5ChasComIpMgmtGateway=s5ChasComIpMgmtGateway, s5ChasVer=s5ChasVer, s5ChasUtilIndx=s5ChasUtilIndx, s5ChasType=s5ChasType, s5ChasBrdAttLstChng=s5ChasBrdAttLstChng, s5ChasContact=s5ChasContact, s5ChasGrpType=s5ChasGrpType, s5ChasAttLstChng=s5ChasAttLstChng, s5ChasPs=s5ChasPs, s5ChasUtilGrpIndx=s5ChasUtilGrpIndx, s5ChasUtilTable=s5ChasUtilTable, s5ChasStore=s5ChasStore, s5ChasPsRpsuType=s5ChasPsRpsuType, s5ChasUtilMemoryAvailableMB=s5ChasUtilMemoryAvailableMB, s5ChasBrdCfgSrc=s5ChasBrdCfgSrc, s5ChasGrp=s5ChasGrp, s5ChasComEntry=s5ChasComEntry, s5ChasComIpMgmtLimit=s5ChasComIpMgmtLimit, s5ChasStoreSubIndx=s5ChasStoreSubIndx, s5ChasTmpSnrValue=s5ChasTmpSnrValue, s5ChasSmDateCode=s5ChasSmDateCode, s5ChasAttIndx=s5ChasAttIndx, s5ChasGrpMaxEnts=s5ChasGrpMaxEnts, s5ChasComGrpIndx=s5ChasComGrpIndx, s5ChasStoreType=s5ChasStoreType, s5ChasStoreDescription=s5ChasStoreDescription, s5ChasComLocation=s5ChasComLocation, s5ChasComMaxSubs=s5ChasComMaxSubs, s5ChasAttCurAtt=s5ChasAttCurAtt, s5ChasBrdNumAtt=s5ChasBrdNumAtt, s5ChasUtilCPUUsageLast24Hours=s5ChasUtilCPUUsageLast24Hours, s5ChasComIpv6MgmtNetMask=s5ChasComIpv6MgmtNetMask, s5ChasComAdminState=s5ChasComAdminState, s5ChasStoreIndx=s5ChasStoreIndx, s5ChasUtilCPUUsageLast10Minutes=s5ChasUtilCPUUsageLast10Minutes, s5ChasNotify=s5ChasNotify, s5ChasMib=s5ChasMib, s5ChasComSubIndx=s5ChasComSubIndx, s5ChasUtil=s5ChasUtil, s5ChasBrdTable=s5ChasBrdTable, s5ChasComNumSubs=s5ChasComNumSubs, s5ChasUtilEntry=s5ChasUtilEntry, s5ChasGbicInfoIfIndex=s5ChasGbicInfoIfIndex, s5ChasStoreGrpIndx=s5ChasStoreGrpIndx, s5ChasBrdCfgChngs=s5ChasBrdCfgChngs, s5ChasBrdFanLeds=s5ChasBrdFanLeds, s5ChasGbicInfoVendorOui=s5ChasGbicInfoVendorOui, s5ChasGbicInfoProductCode=s5ChasGbicInfoProductCode, s5ChasComIpv6MgmtAddress=s5ChasComIpv6MgmtAddress, s5ChasStoreEntry=s5ChasStoreEntry, s5ChasGblAttLstChng=s5ChasGblAttLstChng, s5ChasBrdStatusDsply=s5ChasBrdStatusDsply, s5ChasBrdLeds=s5ChasBrdLeds, s5ChasComVer=s5ChasComVer, s5ChasComLstChng=s5ChasComLstChng, s5ChasStoreCntntVer=s5ChasStoreCntntVer, s5ChasStoreTable=s5ChasStoreTable, s5ChasGblAttChngs=s5ChasGblAttChngs, s5ChasComSerNum=s5ChasComSerNum, s5ChasLocChanIndx=s5ChasLocChanIndx, s5ChasUtilTotalCPUUsage=s5ChasUtilTotalCPUUsage, s5ChasSmLeds=s5ChasSmLeds, s5ChasComIpAddress=s5ChasComIpAddress, s5ChasTmpSnrTmpValue=s5ChasTmpSnrTmpValue, s5ChasGblConfLstChng=s5ChasGblConfLstChng, s5ChasLocChanBkplMode=s5ChasLocChanBkplMode, s5ChasComIpMgmtTimeout=s5ChasComIpMgmtTimeout, s5ChasPsRpsuIndx=s5ChasPsRpsuIndx, s5ChasTmpSnrSubIndx=s5ChasTmpSnrSubIndx, s5ChasDescr=s5ChasDescr, s5ChasPsRpsuGrpIndx=s5ChasPsRpsuGrpIndx, s5ChasAttDfltAtt=s5ChasAttDfltAtt, s5ChasLocChanBrdIndx=s5ChasLocChanBrdIndx, s5ChasAttEntry=s5ChasAttEntry, s5ChasGbicInfoVendorPartNo=s5ChasGbicInfoVendorPartNo, s5ChasAttChngs=s5ChasAttChngs, s5ChasComGroupMap=s5ChasComGroupMap, s5ChasGblPhysChngs=s5ChasGblPhysChngs, s5ChasAttBrdIndx=s5ChasAttBrdIndx, s5ChasGbicInfoVendorName=s5ChasGbicInfoVendorName, s5ChasGrpPhysChngs=s5ChasGrpPhysChngs, s5ChasNotifyFanDirection=s5ChasNotifyFanDirection, s5ChasComDescr=s5ChasComDescr, s5ChasComTotalNumPorts=s5ChasComTotalNumPorts, s5ChasGbicInfoHwOptions=s5ChasGbicInfoHwOptions, s5ChasUtilCPUUsageLast10Seconds=s5ChasUtilCPUUsageLast10Seconds, s5ChasComRelPos=s5ChasComRelPos, s5ChasBrdEntry=s5ChasBrdEntry, s5ChasTmpSnrGrpIndx=s5ChasTmpSnrGrpIndx, s5ChasGen=s5ChasGen, s5ChasLocation=s5ChasLocation, s5ChasUtilMemoryTotalMB=s5ChasUtilMemoryTotalMB, s5ChasComIpv6NetMask=s5ChasComIpv6NetMask, s5ChasComOperState=s5ChasComOperState, s5ChasStoreAge=s5ChasStoreAge, s5ChasPsRpsuSubIndx=s5ChasPsRpsuSubIndx, s5ChasGbicInfoDateCode=s5ChasGbicInfoDateCode, s5ChasPsRpsuEntry=s5ChasPsRpsuEntry, s5ChasTmpSnr=s5ChasTmpSnr, s5ChasGrpEncodeFactor=s5ChasGrpEncodeFactor, s5ChasComIpMgmtShutdown=s5ChasComIpMgmtShutdown, s5ChasAttTable=s5ChasAttTable, s5ChasStoreFilename=s5ChasStoreFilename, s5ChasStoreCurSize=s5ChasStoreCurSize, s5ChasSm=s5ChasSm, s5ChasPsRpsuTable=s5ChasPsRpsuTable, s5ChasUtilMemoryAvailable=s5ChasUtilMemoryAvailable, s5ChasGbicInfoVendorSerial=s5ChasGbicInfoVendorSerial, s5ChasBrdAttChngs=s5ChasBrdAttChngs, s5ChasPluggables=s5ChasPluggables, s5ChasGbicInfoCleiCode=s5ChasGbicInfoCleiCode, s5ChasLocChanEntry=s5ChasLocChanEntry, s5ChasCom=s5ChasCom, s5ChasComTable=s5ChasComTable, s5ChasSerNum=s5ChasSerNum, PYSNMP_MODULE_ID=s5ChasMib, s5ChasUtilMemoryMinAvailable=s5ChasUtilMemoryMinAvailable, s5ChasBrd=s5ChasBrd, s5ChasTmpSnrEntry=s5ChasTmpSnrEntry, s5ChasLocChanTable=s5ChasLocChanTable, s5ChasGrpEntry=s5ChasGrpEntry, s5ChasStoreUsedSize=s5ChasStoreUsedSize, s5ChasUtilSubIndx=s5ChasUtilSubIndx, s5ChasComIpv6Address=s5ChasComIpv6Address, s5ChasBrdDateCode=s5ChasBrdDateCode, s5ChasGrpDescr=s5ChasGrpDescr, s5ChasGbicInfoGbicType=s5ChasGbicInfoGbicType, s5ChasPsRpsuSourceConfig=s5ChasPsRpsuSourceConfig, s5ChasAttClusterConnCapability=s5ChasAttClusterConnCapability, s5ChasGbicInfoTable=s5ChasGbicInfoTable, s5ChasComIpMgmtAddress=s5ChasComIpMgmtAddress, s5ChasGbicInfoWavelength=s5ChasGbicInfoWavelength, s5ChasGrpPhysLstChng=s5ChasGrpPhysLstChng, s5ChasGblPhysLstChng=s5ChasGblPhysLstChng, s5ChasGrpIndx=s5ChasGrpIndx, s5ChasStoreComIndx=s5ChasStoreComIndx, s5ChasTmpSnrTable=s5ChasTmpSnrTable, s5ChasGblConfChngs=s5ChasGblConfChngs, s5ChasComUpTime=s5ChasComUpTime, s5ChasGrpNumEnts=s5ChasGrpNumEnts)
