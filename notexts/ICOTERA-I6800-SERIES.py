...
# ASN.1 source ICOTERA-I6800-SERIES
# Source digest sha256:6cc328b030a65633cb878582163a872628b4a83fda16f12a8a88915a77cb88c9
...
if mibBuilder.loadTexts: icotera.setLastUpdated('2016-03-11 13:07')
...
catvModuleAdminStatus = MibScalar((1, 3, 6, 1, 4, 1, 29865, 12, 3, 1, 1, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1))).clone(namedValues=NamedValues(("disabled", 0), ("enabled", 1))).clone(0)).setMaxAccess("readonly")
...
performFactoryReset = MibScalar((1, 3, 6, 1, 4, 1, 29865, 12, 5, 1, 1, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1, 3))).clone(namedValues=NamedValues(("noActionRequested", 0), ("makeFactoryreset", 1), ("someErrorOccured", 3))).clone(0)).setMaxAccess("readwrite")
...
performCpeReboot = MibScalar((1, 3, 6, 1, 4, 1, 29865, 12, 2, 1, 3, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1, 3))).clone(namedValues=NamedValues(("noActionRequested", 0), ("makeReboot", 1), ("someErrorOccured", 3))).clone(0)).setMaxAccess("readwrite")
if mibBuilder.loadTexts: performCpeReboot.setStatus('current')
ictDHCPsrv = MibTable((1, 3, 6, 1, 4, 1, 29865, 12, 6, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: ictDHCPsrv.setStatus('current')
ictDHCPsrvLeases = MibTableRow((1, 3, 6, 1, 4, 1, 29865, 12, 6, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "ICOTERA-I6800-SERIES", "ictDHCPsrvIndex"))
...
ifDuplexTable = MibTable((1, 3, 6, 1, 4, 1, 29865, 12, 4, 15, 1, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: ifDuplexTable.setStatus('current')
ifDuplexEntry = MibTableRow((1, 3, 6, 1, 4, 1, 29865, 12, 4, 15, 1, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "IF-MIB", "ifIndex"))
...
mibBuilder.exportSymbols("ICOTERA-I6800-SERIES", PYSNMP_MODULE_ID=icotera, catvModuleAdminStatus=catvModuleAdminStatus, catvModuleFilter=catvModuleFilter, catvModuleLowSignal=catvModuleLowSignal, catvModuleOmi=catvModuleOmi, catvModulePowerLevel=catvModulePowerLevel, catvModuleRfOutputLevel=catvModuleRfOutputLevel, catvModuleRflevel=catvModuleRflevel, catvModuleSignalDetected=catvModuleSignalDetected, cfgExecute=cfgExecute, cfgStatus=cfgStatus, cfgTftpPath=cfgTftpPath, duplexConfig=duplexConfig, icotera=icotera, ictCatv=ictCatv, ictCatvMib=ictCatvMib, ictCfgUpdate=ictCfgUpdate, ictDHCPsrv=ictDHCPsrv, ictDHCPsrvIndex=ictDHCPsrvIndex, ictDHCPsrvLeases=ictDHCPsrvLeases, ictDhcp=ictDhcp, ictDuplex=ictDuplex, ictDuplexMib=ictDuplexMib, ictExpire=ictExpire, ictFacRst=ictFacRst, ictFacRstMib=ictFacRstMib, ictFwUpg=ictFwUpg, ictHostName=ictHostName, ictIGW4k=ictIGW4k, ictIPaddress=ictIPaddress, ictMacAddress=ictMacAddress, ictMgmt=ictMgmt, ictMgmtMib=ictMgmtMib, ictReboot=ictReboot, ictReset=ictReset, ictServices=ictServices, ictVoip=ictVoip, ictVoipMib=ictVoipMib, ifDuplexEntry=ifDuplexEntry, ifDuplexIndex=ifDuplexIndex, ifDuplexStatus=ifDuplexStatus, ifDuplexTable=ifDuplexTable, performCpeReboot=performCpeReboot, performFactoryReset=performFactoryReset, upgExecute=upgExecute, upgStatus=upgStatus, upgUrl=upgUrl, voipFXSport1=voipFXSport1, voipFXSport2=voipFXSport2)
