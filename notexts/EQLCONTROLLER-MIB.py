...
mibBuilder.exportSymbols("EQLCONTROLLER-MIB", eqlChannelCardSerialNumber=eqlChannelCardSerialNumber, eqlBackplanePartNum=eqlBackplanePartNum, eqlDaughterCardRev=eqlDaughterCardRev, eqlChannelCardFirmwareRev=eqlChannelCardFirmwareRev, eqlControllerFullSwRevision=eqlControllerFullSwRevision, eqlChannelCardStatus=eqlChannelCardStatus, eqlControllerPrimaryFlashImageRev=eqlControllerPrimaryFlashImageRev, eqlcontrollerModule=eqlcontrollerModule, eqlEMMModel=eqlEMMModel, eqlControllerMinorVersion=eqlControllerMinorVersion, eqlSFPIfIndex=eqlSFPIfIndex, eqlBackplaneRev=eqlBackplaneRev, eqlControllerCMRevision=eqlControllerCMRevision, eqlSFPSerialNumber=eqlSFPSerialNumber, eqlControllerUpTime=eqlControllerUpTime, eqlBackplaneSN2=eqlBackplaneSN2, eqlControllerChipsetTemp=eqlControllerChipsetTemp, eqlEMMPartNum=eqlEMMPartNum, eqlSFPBitrate=eqlSFPBitrate, PYSNMP_MODULE_ID=eqlcontrollerModule, eqlDaughterCardSN=eqlDaughterCardSN, eqlControllerCPUfreq=eqlControllerCPUfreq, eqlcontrollerObjects=eqlcontrollerObjects, eqlControllerCPUPass=eqlControllerCPUPass, eqlControllerNVRAMBattery=eqlControllerNVRAMBattery, eqlDaughterCardTable=eqlDaughterCardTable, eqlSFPIndex=eqlSFPIndex, eqlSFPPartNumber=eqlSFPPartNumber, eqlDaughterCardDate=eqlDaughterCardDate, eqlBackplaneECO=eqlBackplaneECO, eqlcontrollerConformance=eqlcontrollerConformance, eqlControllerPhysRam=eqlControllerPhysRam, eqlControllerModel=eqlControllerModel, eqlEMMRev=eqlEMMRev, eqlSFPDateCode=eqlSFPDateCode, eqlSFPIdentifier=eqlSFPIdentifier, eqldaughtercardNotifications=eqldaughtercardNotifications, eqlBackplaneEEprom=eqlBackplaneEEprom, eqlControllerCPUrev=eqlControllerCPUrev, eqlBackplaneTable=eqlBackplaneTable, eqlControllerMajorVersion=eqlControllerMajorVersion, eqlControllerEntry=eqlControllerEntry, eqlChannelCardTable=eqlChannelCardTable, eqlSFPConnector=eqlSFPConnector, eqlbackplaneConformance=eqlbackplaneConformance, eqlEMMDate=eqlEMMDate, eqlControllerPlatformType=eqlControllerPlatformType, eqlDaughterCardEntry=eqlDaughterCardEntry, eqlEMMEEprom=eqlEMMEEprom, eqlDaughterCardEEprom=eqlDaughterCardEEprom, eqlChannelCardEntry=eqlChannelCardEntry, eqlControllerBootTime=eqlControllerBootTime, eqlSFPLength1=eqlSFPLength1, eqlControllerBootRomBuildDate=eqlControllerBootRomBuildDate, eqlemmNotifications=eqlemmNotifications, eqlControllerAthenaSataVersion=eqlControllerAthenaSataVersion, eqlBackplaneSN=eqlBackplaneSN, eqldaughtercardConformance=eqldaughtercardConformance, eqlControllerPrimaryOrSecondary=eqlControllerPrimaryOrSecondary, eqlControllerProcessorTemp=eqlControllerProcessorTemp, eqlDaughterCardModel=eqlDaughterCardModel, eqlSFPEntry=eqlSFPEntry, eqlsfpObjects=eqlsfpObjects, eqlEMMSN=eqlEMMSN, eqlBackplaneEntry=eqlBackplaneEntry, eqlChannelCardInitRev=eqlChannelCardInitRev, eqlControllerBootRomVersion=eqlControllerBootRomVersion, eqlControllerMaintenanceVersion=eqlControllerMaintenanceVersion, eqlSFPVendorName=eqlSFPVendorName, eqlSFPFirmwareRev=eqlSFPFirmwareRev, eqlControllerBatteryStatus=eqlControllerBatteryStatus, eqlControllerPlatformVersion=eqlControllerPlatformVersion, eqlDaughterCardPartNum=eqlDaughterCardPartNum, eqlEMMTable=eqlEMMTable, eqlDaughterCardECO=eqlDaughterCardECO, eqlEMMEntry=eqlEMMEntry, eqlEMMSN2=eqlEMMSN2, eqlControllerIndex=eqlControllerIndex, eqlControllerDate=eqlControllerDate, eqlSFPTable=eqlSFPTable, eqlbackplaneNotifications=eqlbackplaneNotifications, eqlchannelcardObjects=eqlchannelcardObjects, eqlemmConformance=eqlemmConformance, eqldaughtercardObjects=eqldaughtercardObjects, eqlControllerInfoMsg=eqlControllerInfoMsg, eqlbackplaneObjects=eqlbackplaneObjects, eqlBackplaneDate=eqlBackplaneDate, eqlControllerTable=eqlControllerTable, eqlEMMIndex=eqlEMMIndex, eqlControllerEEprom=eqlControllerEEprom, eqlBackplaneType=eqlBackplaneType, eqlChannelCardIndex=eqlChannelCardIndex, eqlcontrollerNotifications=eqlcontrollerNotifications, eqlBackplaneIndex=eqlBackplaneIndex, eqlControllerPLDrev=eqlControllerPLDrev, eqlControllerSecondaryFlashImageRev=eqlControllerSecondaryFlashImageRev, eqlemmObjects=eqlemmObjects, eqlControllerSWCompatibilityLevel=eqlControllerSWCompatibilityLevel, eqlControllerSerialNumber=eqlControllerSerialNumber, eqlBackplaneTypeId=eqlBackplaneTypeId, eqlControllerType=eqlControllerType, eqlControllerSerialNumber2=eqlControllerSerialNumber2, eqlSFPStatus=eqlSFPStatus, eqlSFPLength2=eqlSFPLength2, eqlDaughterCardIndex=eqlDaughterCardIndex, eqlControllerECO=eqlControllerECO, eqlControllerSwRevision=eqlControllerSwRevision, eqlSFPMode=eqlSFPMode, eqlEMMECO=eqlEMMECO)
