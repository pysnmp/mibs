...
mibBuilder.exportSymbols("EQLCONTROLLER-MIB", eqlControllerFullSwRevision=eqlControllerFullSwRevision, eqlBackplaneECO=eqlBackplaneECO, eqlSFPSerialNumber=eqlSFPSerialNumber, eqlChannelCardEntry=eqlChannelCardEntry, eqlControllerSWCompatibilityLevel=eqlControllerSWCompatibilityLevel, eqlControllerDate=eqlControllerDate, eqlChannelCardIndex=eqlChannelCardIndex, eqlControllerMinorVersion=eqlControllerMinorVersion, eqlControllerSerialNumber=eqlControllerSerialNumber, eqlDaughterCardECO=eqlDaughterCardECO, eqlChannelCardSerialNumber=eqlChannelCardSerialNumber, eqlChannelCardStatus=eqlChannelCardStatus, eqlControllerCMRevision=eqlControllerCMRevision, eqlSFPPartNumber=eqlSFPPartNumber, eqlControllerEEprom=eqlControllerEEprom, eqlControllerPhysRam=eqlControllerPhysRam, eqlControllerNVRAMBattery=eqlControllerNVRAMBattery, eqlControllerInfoMsg=eqlControllerInfoMsg, eqlChannelCardFirmwareRev=eqlChannelCardFirmwareRev, eqlBackplaneEEprom=eqlBackplaneEEprom, eqlBackplaneTable=eqlBackplaneTable, eqlControllerSwRevision=eqlControllerSwRevision, eqlDaughterCardEEprom=eqlDaughterCardEEprom, eqlSFPMode=eqlSFPMode, eqlChannelCardInitRev=eqlChannelCardInitRev, eqlControllerECO=eqlControllerECO, eqlEMMEEprom=eqlEMMEEprom, eqlControllerIndex=eqlControllerIndex, eqlControllerBootRomVersion=eqlControllerBootRomVersion, eqlBackplaneType=eqlBackplaneType, eqlEMMRev=eqlEMMRev, eqlControllerSerialNumber2=eqlControllerSerialNumber2, eqlsfpObjects=eqlsfpObjects, eqlControllerModel=eqlControllerModel, eqldaughtercardConformance=eqldaughtercardConformance, eqlchannelcardObjects=eqlchannelcardObjects, eqlBackplaneRev=eqlBackplaneRev, eqlControllerType=eqlControllerType, eqlEMMSN=eqlEMMSN, eqlBackplaneSN2=eqlBackplaneSN2, eqlSFPConnector=eqlSFPConnector, eqlBackplanePartNum=eqlBackplanePartNum, eqlControllerUpTime=eqlControllerUpTime, eqlControllerPrimaryOrSecondary=eqlControllerPrimaryOrSecondary, eqlemmConformance=eqlemmConformance, eqlEMMTable=eqlEMMTable, eqlDaughterCardModel=eqlDaughterCardModel, eqlEMMEntry=eqlEMMEntry, eqlEMMECO=eqlEMMECO, eqlControllerEntry=eqlControllerEntry, eqlSFPVendorName=eqlSFPVendorName, eqlControllerPlatformType=eqlControllerPlatformType, eqlChannelCardTable=eqlChannelCardTable, eqlControllerBootRomBuildDate=eqlControllerBootRomBuildDate, eqlemmNotifications=eqlemmNotifications, eqlControllerCPUrev=eqlControllerCPUrev, eqlControllerPrimaryFlashImageRev=eqlControllerPrimaryFlashImageRev, eqlcontrollerNotifications=eqlcontrollerNotifications, eqlDaughterCardIndex=eqlDaughterCardIndex, eqlSFPIfIndex=eqlSFPIfIndex, eqlcontrollerObjects=eqlcontrollerObjects, eqlControllerPlatformVersion=eqlControllerPlatformVersion, eqlControllerMaintenanceVersion=eqlControllerMaintenanceVersion, eqlEMMModel=eqlEMMModel, eqlControllerCPUfreq=eqlControllerCPUfreq, eqlSFPLength2=eqlSFPLength2, eqlControllerProcessorTemp=eqlControllerProcessorTemp, eqlBackplaneTypeId=eqlBackplaneTypeId, eqlbackplaneNotifications=eqlbackplaneNotifications, eqlSFPStatus=eqlSFPStatus, eqlbackplaneObjects=eqlbackplaneObjects, eqlEMMDate=eqlEMMDate, eqlSFPIndex=eqlSFPIndex, eqlSFPLength1=eqlSFPLength1, eqlDaughterCardEntry=eqlDaughterCardEntry, eqldaughtercardNotifications=eqldaughtercardNotifications, eqlDaughterCardRev=eqlDaughterCardRev, eqlControllerSecondaryFlashImageRev=eqlControllerSecondaryFlashImageRev, eqlSFPFirmwareRev=eqlSFPFirmwareRev, eqlbackplaneConformance=eqlbackplaneConformance, eqlcontrollerConformance=eqlcontrollerConformance, eqlControllerMajorVersion=eqlControllerMajorVersion, eqlEMMPartNum=eqlEMMPartNum, eqlControllerChipsetTemp=eqlControllerChipsetTemp, eqlSFPTable=eqlSFPTable, eqlBackplaneSN=eqlBackplaneSN, eqlDaughterCardSN=eqlDaughterCardSN, eqlControllerBatteryStatus=eqlControllerBatteryStatus, eqlSFPDateCode=eqlSFPDateCode, eqlBackplaneDate=eqlBackplaneDate, eqlemmObjects=eqlemmObjects, eqlDaughterCardTable=eqlDaughterCardTable, eqlSFPBitrate=eqlSFPBitrate, eqlEMMSN2=eqlEMMSN2, eqlDaughterCardDate=eqlDaughterCardDate, eqlBackplaneEntry=eqlBackplaneEntry, eqlcontrollerModule=eqlcontrollerModule, eqlDaughterCardPartNum=eqlDaughterCardPartNum, PYSNMP_MODULE_ID=eqlcontrollerModule, eqlEMMIndex=eqlEMMIndex, eqlControllerTable=eqlControllerTable, eqldaughtercardObjects=eqldaughtercardObjects, eqlControllerPLDrev=eqlControllerPLDrev, eqlBackplaneIndex=eqlBackplaneIndex, eqlControllerBootTime=eqlControllerBootTime, eqlControllerAthenaSataVersion=eqlControllerAthenaSataVersion, eqlSFPEntry=eqlSFPEntry, eqlSFPIdentifier=eqlSFPIdentifier, eqlControllerCPUPass=eqlControllerCPUPass)
