...
mibBuilder.exportSymbols("EQLCONTROLLER-MIB", eqlDaughterCardModel=eqlDaughterCardModel, eqlControllerBootRomBuildDate=eqlControllerBootRomBuildDate, eqlControllerPlatformType=eqlControllerPlatformType, eqlSFPLength1=eqlSFPLength1, eqlBackplaneTable=eqlBackplaneTable, eqlControllerPLDrev=eqlControllerPLDrev, eqlDaughterCardECO=eqlDaughterCardECO, eqlChannelCardIndex=eqlChannelCardIndex, eqlBackplaneEntry=eqlBackplaneEntry, eqldaughtercardObjects=eqldaughtercardObjects, eqlControllerCMRevision=eqlControllerCMRevision, eqlControllerAthenaSataVersion=eqlControllerAthenaSataVersion, eqlBackplaneIndex=eqlBackplaneIndex, eqlControllerBatteryStatus=eqlControllerBatteryStatus, eqlBackplaneECO=eqlBackplaneECO, eqlControllerMaintenanceVersion=eqlControllerMaintenanceVersion, eqlSFPMode=eqlSFPMode, eqlDaughterCardEEprom=eqlDaughterCardEEprom, eqlEMMPartNum=eqlEMMPartNum, eqlDaughterCardSN=eqlDaughterCardSN, eqlControllerFullSwRevision=eqlControllerFullSwRevision, eqlEMMSN2=eqlEMMSN2, eqlControllerSWCompatibilityLevel=eqlControllerSWCompatibilityLevel, eqlEMMDate=eqlEMMDate, eqlbackplaneNotifications=eqlbackplaneNotifications, eqlControllerSecondaryFlashImageRev=eqlControllerSecondaryFlashImageRev, eqlChannelCardInitRev=eqlChannelCardInitRev, eqlSFPConnector=eqlSFPConnector, eqlControllerIndex=eqlControllerIndex, eqlControllerUpTime=eqlControllerUpTime, eqlchannelcardObjects=eqlchannelcardObjects, eqlControllerECO=eqlControllerECO, eqlControllerMinorVersion=eqlControllerMinorVersion, eqlSFPEntry=eqlSFPEntry, eqlsfpObjects=eqlsfpObjects, eqlDaughterCardPartNum=eqlDaughterCardPartNum, eqlDaughterCardIndex=eqlDaughterCardIndex, eqlbackplaneConformance=eqlbackplaneConformance, eqlChannelCardStatus=eqlChannelCardStatus, eqldaughtercardNotifications=eqldaughtercardNotifications, eqlEMMEntry=eqlEMMEntry, eqlChannelCardFirmwareRev=eqlChannelCardFirmwareRev, eqlEMMEEprom=eqlEMMEEprom, eqlBackplaneTypeId=eqlBackplaneTypeId, eqlControllerSerialNumber2=eqlControllerSerialNumber2, eqlemmConformance=eqlemmConformance, eqlSFPSerialNumber=eqlSFPSerialNumber, eqlControllerSerialNumber=eqlControllerSerialNumber, eqlEMMRev=eqlEMMRev, eqlDaughterCardTable=eqlDaughterCardTable, eqlControllerPrimaryFlashImageRev=eqlControllerPrimaryFlashImageRev, eqlChannelCardSerialNumber=eqlChannelCardSerialNumber, eqlSFPDateCode=eqlSFPDateCode, eqlDaughterCardRev=eqlDaughterCardRev, eqlControllerModel=eqlControllerModel, eqlControllerBootRomVersion=eqlControllerBootRomVersion, eqlControllerCPUrev=eqlControllerCPUrev, eqlBackplaneDate=eqlBackplaneDate, eqlSFPIndex=eqlSFPIndex, PYSNMP_MODULE_ID=eqlcontrollerModule, eqlcontrollerConformance=eqlcontrollerConformance, eqlBackplaneEEprom=eqlBackplaneEEprom, eqlSFPIfIndex=eqlSFPIfIndex, eqldaughtercardConformance=eqldaughtercardConformance, eqlEMMTable=eqlEMMTable, eqlEMMSN=eqlEMMSN, eqlSFPStatus=eqlSFPStatus, eqlControllerPlatformVersion=eqlControllerPlatformVersion, eqlControllerEntry=eqlControllerEntry, eqlDaughterCardEntry=eqlDaughterCardEntry, eqlControllerNVRAMBattery=eqlControllerNVRAMBattery, eqlcontrollerNotifications=eqlcontrollerNotifications, eqlControllerMajorVersion=eqlControllerMajorVersion, eqlControllerPhysRam=eqlControllerPhysRam, eqlBackplaneType=eqlBackplaneType, eqlChannelCardTable=eqlChannelCardTable, eqlControllerSwRevision=eqlControllerSwRevision, eqlemmNotifications=eqlemmNotifications, eqlemmObjects=eqlemmObjects, eqlbackplaneObjects=eqlbackplaneObjects, eqlControllerChipsetTemp=eqlControllerChipsetTemp, eqlControllerDate=eqlControllerDate, eqlControllerCPUPass=eqlControllerCPUPass, eqlControllerBootTime=eqlControllerBootTime, eqlControllerInfoMsg=eqlControllerInfoMsg, eqlcontrollerObjects=eqlcontrollerObjects, eqlChannelCardEntry=eqlChannelCardEntry, eqlControllerCPUfreq=eqlControllerCPUfreq, eqlSFPLength2=eqlSFPLength2, eqlSFPIdentifier=eqlSFPIdentifier, eqlEMMECO=eqlEMMECO, eqlControllerType=eqlControllerType, eqlBackplaneSN=eqlBackplaneSN, eqlControllerTable=eqlControllerTable, eqlDaughterCardDate=eqlDaughterCardDate, eqlSFPVendorName=eqlSFPVendorName, eqlEMMModel=eqlEMMModel, eqlBackplanePartNum=eqlBackplanePartNum, eqlControllerPrimaryOrSecondary=eqlControllerPrimaryOrSecondary, eqlBackplaneRev=eqlBackplaneRev, eqlSFPTable=eqlSFPTable, eqlEMMIndex=eqlEMMIndex, eqlSFPBitrate=eqlSFPBitrate, eqlControllerEEprom=eqlControllerEEprom, eqlBackplaneSN2=eqlBackplaneSN2, eqlSFPFirmwareRev=eqlSFPFirmwareRev, eqlControllerProcessorTemp=eqlControllerProcessorTemp, eqlcontrollerModule=eqlcontrollerModule, eqlSFPPartNumber=eqlSFPPartNumber)
