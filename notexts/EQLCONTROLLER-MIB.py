...
mibBuilder.exportSymbols("EQLCONTROLLER-MIB", eqlEMMSN=eqlEMMSN, eqlControllerFullSwRevision=eqlControllerFullSwRevision, eqlEMMECO=eqlEMMECO, eqlControllerSerialNumber2=eqlControllerSerialNumber2, eqlSFPLength1=eqlSFPLength1, eqlbackplaneConformance=eqlbackplaneConformance, eqlControllerCPUPass=eqlControllerCPUPass, eqlControllerBootRomBuildDate=eqlControllerBootRomBuildDate, eqlcontrollerObjects=eqlcontrollerObjects, eqlChannelCardIndex=eqlChannelCardIndex, eqlSFPTable=eqlSFPTable, eqlEMMIndex=eqlEMMIndex, eqlChannelCardStatus=eqlChannelCardStatus, eqlControllerDate=eqlControllerDate, eqlcontrollerConformance=eqlcontrollerConformance, eqlControllerMajorVersion=eqlControllerMajorVersion, eqlEMMTable=eqlEMMTable, eqlSFPIfIndex=eqlSFPIfIndex, eqlBackplaneRev=eqlBackplaneRev, eqlControllerPlatformType=eqlControllerPlatformType, eqlControllerNVRAMBattery=eqlControllerNVRAMBattery, eqlemmNotifications=eqlemmNotifications, eqlControllerPrimaryOrSecondary=eqlControllerPrimaryOrSecondary, eqlemmConformance=eqlemmConformance, eqlControllerType=eqlControllerType, eqlControllerPLDrev=eqlControllerPLDrev, eqlBackplaneTypeId=eqlBackplaneTypeId, eqlBackplaneSN=eqlBackplaneSN, eqlControllerCPUfreq=eqlControllerCPUfreq, eqlControllerPrimaryFlashImageRev=eqlControllerPrimaryFlashImageRev, eqlEMMPartNum=eqlEMMPartNum, eqlSFPFirmwareRev=eqlSFPFirmwareRev, PYSNMP_MODULE_ID=eqlcontrollerModule, eqlControllerMinorVersion=eqlControllerMinorVersion, eqlDaughterCardIndex=eqlDaughterCardIndex, eqlDaughterCardDate=eqlDaughterCardDate, eqlChannelCardSerialNumber=eqlChannelCardSerialNumber, eqlBackplaneEEprom=eqlBackplaneEEprom, eqlChannelCardFirmwareRev=eqlChannelCardFirmwareRev, eqlDaughterCardModel=eqlDaughterCardModel, eqlControllerPlatformVersion=eqlControllerPlatformVersion, eqlsfpObjects=eqlsfpObjects, eqlSFPBitrate=eqlSFPBitrate, eqlcontrollerModule=eqlcontrollerModule, eqlEMMEntry=eqlEMMEntry, eqlControllerIndex=eqlControllerIndex, eqlSFPConnector=eqlSFPConnector, eqlemmObjects=eqlemmObjects, eqlControllerPhysRam=eqlControllerPhysRam, eqlControllerBatteryStatus=eqlControllerBatteryStatus, eqlControllerSwRevision=eqlControllerSwRevision, eqlEMMSN2=eqlEMMSN2, eqlDaughterCardTable=eqlDaughterCardTable, eqldaughtercardObjects=eqldaughtercardObjects, eqlBackplaneDate=eqlBackplaneDate, eqlControllerECO=eqlControllerECO, eqlBackplaneEntry=eqlBackplaneEntry, eqlBackplaneIndex=eqlBackplaneIndex, eqlBackplaneTable=eqlBackplaneTable, eqlControllerBootRomVersion=eqlControllerBootRomVersion, eqlSFPEntry=eqlSFPEntry, eqlDaughterCardRev=eqlDaughterCardRev, eqlDaughterCardPartNum=eqlDaughterCardPartNum, eqlControllerTable=eqlControllerTable, eqlControllerSecondaryFlashImageRev=eqlControllerSecondaryFlashImageRev, eqlControllerSWCompatibilityLevel=eqlControllerSWCompatibilityLevel, eqlDaughterCardSN=eqlDaughterCardSN, eqlSFPSerialNumber=eqlSFPSerialNumber, eqlControllerModel=eqlControllerModel, eqlSFPDateCode=eqlSFPDateCode, eqlDaughterCardEntry=eqlDaughterCardEntry, eqlSFPIndex=eqlSFPIndex, eqlEMMRev=eqlEMMRev, eqlbackplaneObjects=eqlbackplaneObjects, eqlbackplaneNotifications=eqlbackplaneNotifications, eqlControllerChipsetTemp=eqlControllerChipsetTemp, eqlDaughterCardECO=eqlDaughterCardECO, eqlChannelCardInitRev=eqlChannelCardInitRev, eqlBackplaneSN2=eqlBackplaneSN2, eqlSFPPartNumber=eqlSFPPartNumber, eqlSFPStatus=eqlSFPStatus, eqlEMMModel=eqlEMMModel, eqldaughtercardConformance=eqldaughtercardConformance, eqlBackplaneType=eqlBackplaneType, eqlSFPIdentifier=eqlSFPIdentifier, eqlControllerEEprom=eqlControllerEEprom, eqlControllerProcessorTemp=eqlControllerProcessorTemp, eqlEMMEEprom=eqlEMMEEprom, eqlcontrollerNotifications=eqlcontrollerNotifications, eqlControllerEntry=eqlControllerEntry, eqlControllerMaintenanceVersion=eqlControllerMaintenanceVersion, eqlDaughterCardEEprom=eqlDaughterCardEEprom, eqlBackplanePartNum=eqlBackplanePartNum, eqlControllerCMRevision=eqlControllerCMRevision, eqlControllerCPUrev=eqlControllerCPUrev, eqlControllerUpTime=eqlControllerUpTime, eqlControllerInfoMsg=eqlControllerInfoMsg, eqlChannelCardTable=eqlChannelCardTable, eqldaughtercardNotifications=eqldaughtercardNotifications, eqlControllerSerialNumber=eqlControllerSerialNumber, eqlChannelCardEntry=eqlChannelCardEntry, eqlBackplaneECO=eqlBackplaneECO, eqlSFPVendorName=eqlSFPVendorName, eqlSFPLength2=eqlSFPLength2, eqlControllerAthenaSataVersion=eqlControllerAthenaSataVersion, eqlEMMDate=eqlEMMDate, eqlchannelcardObjects=eqlchannelcardObjects, eqlSFPMode=eqlSFPMode, eqlControllerBootTime=eqlControllerBootTime)
