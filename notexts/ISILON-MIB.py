...
IpAddress, Counter32, enterprises, ModuleIdentity, Integer32, TimeTicks, Unsigned32, Counter64, Gauge32, NotificationType, iso, ObjectIdentity, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter32", "enterprises", "ModuleIdentity", "Integer32", "TimeTicks", "Unsigned32", "Counter64", "Gauge32", "NotificationType", "iso", "ObjectIdentity", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ISILON-MIB", tempSensorDescription=tempSensorDescription, quotaSoftThresholdDefined=quotaSoftThresholdDefined, tempSensorValue=tempSensorValue, snapshotSubdirAccessCIFS=snapshotSubdirAccessCIFS, nodeIfsOutBytes=nodeIfsOutBytes, nodeIfsPerfGroup=nodeIfsPerfGroup, quotaType=quotaType, licenseModuleName=licenseModuleName, fanSpeed=fanSpeed, nodeCPUPerf=nodeCPUPerf, nodeIfsPerf=nodeIfsPerf, nodeStatusGroup=nodeStatusGroup, tempSensorTableGroup=tempSensorTableGroup, licenseExpirationDate=licenseExpirationDate, tempSensorName=tempSensorName, quotaPath=quotaPath, snapshotSchedulePath=snapshotSchedulePath, snapshotRootAccessCIFS=snapshotRootAccessCIFS, nodePerCPUNice=nodePerCPUNice, diskModel=diskModel, outStdDevBytes=outStdDevBytes, cluster=cluster, ifsTotalBytes=ifsTotalBytes, snapshotLocked=snapshotLocked, snapshotSize=snapshotSize, inBitsPerSecond=inBitsPerSecond, powerSensorValue=powerSensorValue, nodeCPUPerfTable=nodeCPUPerfTable, nodePerCPUIdle=nodePerCPUIdle, powerSensorTable=powerSensorTable, snapshotExpires=snapshotExpires, inMinBytes=inMinBytes, PYSNMP_MODULE_ID=isilon, fanNumber=fanNumber, snapshotScheduleIndex=snapshotScheduleIndex, chassisEntry=chassisEntry, nodeCount=nodeCount, nodeNetworkOutBytes=nodeNetworkOutBytes, clusterGUID=clusterGUID, diskFirmwareVersion=diskFirmwareVersion, snapshotRootAccessNFS=snapshotRootAccessNFS, nodeNetworkInBytes=nodeNetworkInBytes, quotaInodeUsage=quotaInodeUsage, local=local, snapshotsGroup=snapshotsGroup, nodeNetworkPerfGroup=nodeNetworkPerfGroup, diskPerfBay=diskPerfBay, latencyMin=latencyMin, powerSensorName=powerSensorName, nodeNetworkPerf=nodeNetworkPerf, isilon=isilon, inStdDevBytes=inStdDevBytes, clusterIfsInBytes=clusterIfsInBytes, clusterName=clusterName, clusterIfsOutBitsPerSecond=clusterIfsOutBitsPerSecond, snapshotRootAccessLocal=snapshotRootAccessLocal, snapshotPath=snapshotPath, diskPerfInBitsPerSecond=diskPerfInBitsPerSecond, outMaxBytes=outMaxBytes, quotaID=quotaID, clusterNetworkPerfGroup=clusterNetworkPerfGroup, nodeCPUSystem=nodeCPUSystem, nodeCPUUser=nodeCPUUser, nodeCPUIdle=nodeCPUIdle, outAvgBytes=outAvgBytes, snapshotScheduleEntry=snapshotScheduleEntry, snapshotCreated=snapshotCreated, chassisConfigNumber=chassisConfigNumber, diskBay=diskBay, accessTimeGracePeriod=accessTimeGracePeriod, nodeCPUNice=nodeCPUNice, accessTimeEnabled=accessTimeEnabled, nodeGroups=nodeGroups, nodeCPUInterrupt=nodeCPUInterrupt, conformance=conformance, snapshotRootVisibilityNFS=snapshotRootVisibilityNFS, diskPerfOutBitsPerSecond=diskPerfOutBitsPerSecond, protocolName=protocolName, protocolOpsPerSecond=protocolOpsPerSecond, configuredNodes=configuredNodes, nodeIfsInBytes=nodeIfsInBytes, clusterPerformance=clusterPerformance, latencyStdDev=latencyStdDev, powerSensorDescription=powerSensorDescription, nodeName=nodeName, chassisSerialNumber=chassisSerialNumber, snapshotTable=snapshotTable, nodePerCPUSystem=nodePerCPUSystem, clusterIfsPerf=clusterIfsPerf, fanEntry=fanEntry, diskStatus=diskStatus, clusterNetworkInBytes=clusterNetworkInBytes, snapshotScheduleTable=snapshotScheduleTable, snapshotSettingsGroup=snapshotSettingsGroup, diskSizeBytes=diskSizeBytes, quotaHardThresholdDefined=quotaHardThresholdDefined, ifsUsedBytes=ifsUsedBytes, tempSensorTable=tempSensorTable, snapshotScheduledCreateEnabled=snapshotScheduledCreateEnabled, snapshotScheduleExpiration=snapshotScheduleExpiration, clusterCPUNice=clusterCPUNice, nodeCPUPerfEntry=nodeCPUPerfEntry, snapshotScheduleAlias=snapshotScheduleAlias, outMinBytes=outMinBytes, clusterNetworkOutBytes=clusterNetworkOutBytes, quotaAdvisoryThresholdDefined=quotaAdvisoryThresholdDefined, isilonCompliance=isilonCompliance, nodeCPUPerfGroup=nodeCPUPerfGroup, clusterNetworkPerf=clusterNetworkPerf, licenseStatus=licenseStatus, snapshotSettings=snapshotSettings, latencyMax=latencyMax, diskSerialNumber=diskSerialNumber, licenseEntry=licenseEntry, ifsFilesystem=ifsFilesystem, clusterNetworkOutBitsPerSecond=clusterNetworkOutBitsPerSecond, protocolOpCount=protocolOpCount, snapshotScheduleName=snapshotScheduleName, clusterStatus=clusterStatus, clusterIfsInBitsPerSecond=clusterIfsInBitsPerSecond, diskDeviceName=diskDeviceName, snapshotRootVisibilityCIFS=snapshotRootVisibilityCIFS, chassisUnitIDLEDOn=chassisUnitIDLEDOn, licenseTable=licenseTable, onlineNodes=onlineNodes, node=node, snapshotReservedPct=snapshotReservedPct, nodeIfsOutBitsPerSecond=nodeIfsOutBitsPerSecond, quotaTable=quotaTable, clusterCPUSystem=clusterCPUSystem, clusterCPUInterrupt=clusterCPUInterrupt, credentialBindings=credentialBindings, diskPerfTableGroup=diskPerfTableGroup, outBitsPerSecond=outBitsPerSecond, licensesGroup=licensesGroup, clusterPerformanceGroups=clusterPerformanceGroups, snapshots=snapshots, quotaIncludesOverhead=quotaIncludesOverhead, snapshotSubdirAccessLocal=snapshotSubdirAccessLocal, tempSensorNumber=tempSensorNumber, nodePerformance=nodePerformance, nodePerCPUInterrupt=nodePerCPUInterrupt, powerSensorEntry=powerSensorEntry, diskTableGroup=diskTableGroup, quotaDomainID=quotaDomainID, diskPerfDeviceName=diskPerfDeviceName, snapshotTableGroup=snapshotTableGroup, snapshotEntry=snapshotEntry, nodeProtocolPerfEntry=nodeProtocolPerfEntry, clusterCPUIdlePct=clusterCPUIdlePct, readOnly=readOnly, quotaHardThreshold=quotaHardThreshold, diskLogicalNumber=diskLogicalNumber, ifsFreeBytes=ifsFreeBytes, nodePerformanceGroup=nodePerformanceGroup, nodeHealth=nodeHealth, quotaUsageWithOverhead=quotaUsageWithOverhead, quotaAdvisoryThreshold=quotaAdvisoryThreshold, clusterCPUPerf=clusterCPUPerf, nodeIfsInBitsPerSecond=nodeIfsInBitsPerSecond, snapshotScheduledDeleteEnabled=snapshotScheduledDeleteEnabled, diskPerfTable=diskPerfTable, licenses=licenses, nodePerCPUUser=nodePerCPUUser, latencyAverage=latencyAverage, quotaGracePeriod=quotaGracePeriod, quotaUsage=quotaUsage, snapshotScheduleNamingPattern=snapshotScheduleNamingPattern, fanTable=fanTable, fanTableGroup=fanTableGroup, inMaxBytes=inMaxBytes, quotaEntry=quotaEntry, snapshotIndex=snapshotIndex, clusterIfsPerfGroup=clusterIfsPerfGroup, licenseIndex=licenseIndex, powerSensorNumber=powerSensorNumber, powerSensorTableGroup=powerSensorTableGroup, offlineNodes=offlineNodes, diskTable=diskTable, clusterCPUUser=clusterCPUUser, nodeNetworkInBitsPerSecond=nodeNetworkInBitsPerSecond, nodeStatus=nodeStatus, diskPerfEntry=diskPerfEntry, snapshotSubdirAccessNFS=snapshotSubdirAccessNFS, nodeProtocolPerfTableGroup=nodeProtocolPerfTableGroup, chassisNumber=chassisNumber, clusterIfsOutBytes=clusterIfsOutBytes, quotaSoftThreshold=quotaSoftThreshold, snapshotAliasFor=snapshotAliasFor, quotas=quotas, quotasGroup=quotasGroup, snapshotName=snapshotName, chassisTable=chassisTable, chassisTableGroup=chassisTableGroup, diskEntry=diskEntry, clusterStatusGroup=clusterStatusGroup, nodePerCPUID=nodePerCPUID, clusterGroups=clusterGroups, clusterCPUPerfGroup=clusterCPUPerfGroup, snapshotScheduleTableGroup=snapshotScheduleTableGroup, ifsFilesystemGroup=ifsFilesystemGroup, snapshotScheduleSchedule=snapshotScheduleSchedule, snapshotRootVisibilityLocal=snapshotRootVisibilityLocal, diskPerfOpsPerSecond=diskPerfOpsPerSecond, ifsAvailableBytes=ifsAvailableBytes, chassisModel=chassisModel, quotaIncludesSnapshotUsage=quotaIncludesSnapshotUsage, nodeNetworkOutBitsPerSecond=nodeNetworkOutBitsPerSecond, nodeProtocolPerfTable=nodeProtocolPerfTable, fanName=fanName, clusterHealth=clusterHealth, clusterNetworkInBitsPerSecond=clusterNetworkInBitsPerSecond, nodeType=nodeType, diskChassisNumber=diskChassisNumber, fanDescription=fanDescription, tempSensorEntry=tempSensorEntry, inAvgBytes=inAvgBytes)
