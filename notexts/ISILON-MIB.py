...
Integer32, Counter32, IpAddress, NotificationType, Unsigned32, iso, ModuleIdentity, Counter64, TimeTicks, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "IpAddress", "NotificationType", "Unsigned32", "iso", "ModuleIdentity", "Counter64", "TimeTicks", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "enterprises")
...
mibBuilder.exportSymbols("ISILON-MIB", inMaxBytes=inMaxBytes, chassisSerialNumber=chassisSerialNumber, clusterCPUPerf=clusterCPUPerf, latencyMax=latencyMax, diskPerfEntry=diskPerfEntry, latencyMin=latencyMin, nodeIfsPerfGroup=nodeIfsPerfGroup, conformance=conformance, protocolOpsPerSecond=protocolOpsPerSecond, quotaPath=quotaPath, nodeCPUInterrupt=nodeCPUInterrupt, nodeCPUIdle=nodeCPUIdle, ifsUsedBytes=ifsUsedBytes, nodeIfsOutBytes=nodeIfsOutBytes, snapshotSchedulePath=snapshotSchedulePath, diskPerfOutBitsPerSecond=diskPerfOutBitsPerSecond, chassisConfigNumber=chassisConfigNumber, nodeIfsInBitsPerSecond=nodeIfsInBitsPerSecond, latencyStdDev=latencyStdDev, clusterIfsInBitsPerSecond=clusterIfsInBitsPerSecond, quotas=quotas, tempSensorName=tempSensorName, snapshotAliasFor=snapshotAliasFor, snapshotScheduleNamingPattern=snapshotScheduleNamingPattern, snapshotRootAccessLocal=snapshotRootAccessLocal, diskPerfBay=diskPerfBay, local=local, outStdDevBytes=outStdDevBytes, quotaSoftThreshold=quotaSoftThreshold, snapshotEntry=snapshotEntry, ifsFilesystem=ifsFilesystem, cluster=cluster, quotaUsage=quotaUsage, quotaEntry=quotaEntry, clusterNetworkOutBitsPerSecond=clusterNetworkOutBitsPerSecond, tempSensorDescription=tempSensorDescription, nodeIfsInBytes=nodeIfsInBytes, snapshotScheduleTableGroup=snapshotScheduleTableGroup, clusterCPUInterrupt=clusterCPUInterrupt, diskPerfInBitsPerSecond=diskPerfInBitsPerSecond, snapshotScheduleExpiration=snapshotScheduleExpiration, clusterCPUSystem=clusterCPUSystem, fanNumber=fanNumber, chassisModel=chassisModel, clusterName=clusterName, quotaUsageWithOverhead=quotaUsageWithOverhead, snapshotsGroup=snapshotsGroup, nodePerformanceGroup=nodePerformanceGroup, snapshotScheduleIndex=snapshotScheduleIndex, diskPerfTable=diskPerfTable, outAvgBytes=outAvgBytes, diskBay=diskBay, ifsAvailableBytes=ifsAvailableBytes, nodeNetworkOutBitsPerSecond=nodeNetworkOutBitsPerSecond, chassisTableGroup=chassisTableGroup, clusterHealth=clusterHealth, offlineNodes=offlineNodes, quotaDomainID=quotaDomainID, snapshotLocked=snapshotLocked, nodeName=nodeName, diskPerfOpsPerSecond=diskPerfOpsPerSecond, licenseExpirationDate=licenseExpirationDate, inStdDevBytes=inStdDevBytes, clusterCPUUser=clusterCPUUser, readOnly=readOnly, tempSensorTable=tempSensorTable, isilonCompliance=isilonCompliance, nodeType=nodeType, outMaxBytes=outMaxBytes, fanTableGroup=fanTableGroup, fanEntry=fanEntry, quotaID=quotaID, accessTimeEnabled=accessTimeEnabled, chassisNumber=chassisNumber, quotaIncludesOverhead=quotaIncludesOverhead, tempSensorEntry=tempSensorEntry, nodeCPUNice=nodeCPUNice, snapshots=snapshots, clusterIfsPerf=clusterIfsPerf, licenseIndex=licenseIndex, quotaGracePeriod=quotaGracePeriod, quotasGroup=quotasGroup, quotaAdvisoryThresholdDefined=quotaAdvisoryThresholdDefined, snapshotSubdirAccessNFS=snapshotSubdirAccessNFS, accessTimeGracePeriod=accessTimeGracePeriod, snapshotPath=snapshotPath, diskTable=diskTable, PYSNMP_MODULE_ID=isilon, diskPerfTableGroup=diskPerfTableGroup, licenseEntry=licenseEntry, snapshotScheduledCreateEnabled=snapshotScheduledCreateEnabled, nodePerCPUInterrupt=nodePerCPUInterrupt, snapshotExpires=snapshotExpires, clusterStatusGroup=clusterStatusGroup, snapshotRootAccessNFS=snapshotRootAccessNFS, inBitsPerSecond=inBitsPerSecond, clusterIfsInBytes=clusterIfsInBytes, node=node, nodePerCPUUser=nodePerCPUUser, nodePerformance=nodePerformance, fanDescription=fanDescription, quotaHardThreshold=quotaHardThreshold, quotaIncludesSnapshotUsage=quotaIncludesSnapshotUsage, chassisEntry=chassisEntry, tempSensorValue=tempSensorValue, protocolOpCount=protocolOpCount, powerSensorDescription=powerSensorDescription, ifsFreeBytes=ifsFreeBytes, diskPerfDeviceName=diskPerfDeviceName, clusterGroups=clusterGroups, snapshotScheduledDeleteEnabled=snapshotScheduledDeleteEnabled, snapshotTable=snapshotTable, quotaType=quotaType, credentialBindings=credentialBindings, quotaTable=quotaTable, snapshotSubdirAccessCIFS=snapshotSubdirAccessCIFS, chassisTable=chassisTable, protocolName=protocolName, clusterStatus=clusterStatus, clusterNetworkPerfGroup=clusterNetworkPerfGroup, isilon=isilon, diskDeviceName=diskDeviceName, clusterIfsOutBitsPerSecond=clusterIfsOutBitsPerSecond, powerSensorNumber=powerSensorNumber, nodeNetworkPerf=nodeNetworkPerf, quotaAdvisoryThreshold=quotaAdvisoryThreshold, licenseModuleName=licenseModuleName, quotaSoftThresholdDefined=quotaSoftThresholdDefined, outBitsPerSecond=outBitsPerSecond, nodeCPUUser=nodeCPUUser, clusterNetworkOutBytes=clusterNetworkOutBytes, snapshotReservedPct=snapshotReservedPct, clusterPerformance=clusterPerformance, nodeProtocolPerfTableGroup=nodeProtocolPerfTableGroup, snapshotRootVisibilityNFS=snapshotRootVisibilityNFS, nodeGroups=nodeGroups, diskEntry=diskEntry, diskModel=diskModel, powerSensorEntry=powerSensorEntry, configuredNodes=configuredNodes, clusterGUID=clusterGUID, snapshotSize=snapshotSize, nodeIfsPerf=nodeIfsPerf, nodeCount=nodeCount, nodeCPUPerfTable=nodeCPUPerfTable, licenseStatus=licenseStatus, fanSpeed=fanSpeed, powerSensorName=powerSensorName, nodeNetworkInBytes=nodeNetworkInBytes, diskStatus=diskStatus, clusterPerformanceGroups=clusterPerformanceGroups, diskLogicalNumber=diskLogicalNumber, diskTableGroup=diskTableGroup, nodeNetworkOutBytes=nodeNetworkOutBytes, powerSensorTable=powerSensorTable, ifsFilesystemGroup=ifsFilesystemGroup, onlineNodes=onlineNodes, fanName=fanName, outMinBytes=outMinBytes, clusterNetworkInBytes=clusterNetworkInBytes, clusterNetworkInBitsPerSecond=clusterNetworkInBitsPerSecond, snapshotRootVisibilityLocal=snapshotRootVisibilityLocal, clusterCPUNice=clusterCPUNice, snapshotScheduleEntry=snapshotScheduleEntry, nodeProtocolPerfTable=nodeProtocolPerfTable, tempSensorNumber=tempSensorNumber, inAvgBytes=inAvgBytes, nodePerCPUNice=nodePerCPUNice, nodeCPUPerfGroup=nodeCPUPerfGroup, clusterIfsPerfGroup=clusterIfsPerfGroup, powerSensorTableGroup=powerSensorTableGroup, nodeCPUPerfEntry=nodeCPUPerfEntry, nodeNetworkPerfGroup=nodeNetworkPerfGroup, nodeProtocolPerfEntry=nodeProtocolPerfEntry, licensesGroup=licensesGroup, snapshotCreated=snapshotCreated, nodeHealth=nodeHealth, chassisUnitIDLEDOn=chassisUnitIDLEDOn, diskChassisNumber=diskChassisNumber, inMinBytes=inMinBytes, nodeIfsOutBitsPerSecond=nodeIfsOutBitsPerSecond, snapshotScheduleSchedule=snapshotScheduleSchedule, clusterIfsOutBytes=clusterIfsOutBytes, snapshotRootVisibilityCIFS=snapshotRootVisibilityCIFS, snapshotSettingsGroup=snapshotSettingsGroup, clusterNetworkPerf=clusterNetworkPerf, diskFirmwareVersion=diskFirmwareVersion, diskSerialNumber=diskSerialNumber, snapshotScheduleName=snapshotScheduleName, licenses=licenses, snapshotSubdirAccessLocal=snapshotSubdirAccessLocal, nodeCPUSystem=nodeCPUSystem, diskSizeBytes=diskSizeBytes, nodePerCPUID=nodePerCPUID, ifsTotalBytes=ifsTotalBytes, fanTable=fanTable, nodePerCPUSystem=nodePerCPUSystem, quotaHardThresholdDefined=quotaHardThresholdDefined, nodeStatus=nodeStatus, clusterCPUPerfGroup=clusterCPUPerfGroup, nodeStatusGroup=nodeStatusGroup, snapshotIndex=snapshotIndex, tempSensorTableGroup=tempSensorTableGroup, snapshotScheduleTable=snapshotScheduleTable, nodeNetworkInBitsPerSecond=nodeNetworkInBitsPerSecond, snapshotTableGroup=snapshotTableGroup, snapshotRootAccessCIFS=snapshotRootAccessCIFS, snapshotSettings=snapshotSettings, snapshotScheduleAlias=snapshotScheduleAlias, nodePerCPUIdle=nodePerCPUIdle, latencyAverage=latencyAverage, nodeCPUPerf=nodeCPUPerf, licenseTable=licenseTable, quotaInodeUsage=quotaInodeUsage, snapshotName=snapshotName, clusterCPUIdlePct=clusterCPUIdlePct, powerSensorValue=powerSensorValue)
