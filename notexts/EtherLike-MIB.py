...
# ASN.1 source EtherLike-MIB
# Source digest sha256:a54c81c7cd5abfd21d96e1753ec81bc720bae1a10cb0657227d0ee94a9dcecb7
...
if mibBuilder.loadTexts: etherMIB.setLastUpdated('2003-09-19 00:00')
...
dot3StatsEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 7, 2, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "EtherLike-MIB", "dot3StatsIndex"))
...
dot3CollEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 7, 5, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "IF-MIB", "ifIndex"), (0, "EtherLike-MIB", "dot3CollCount"))
if mibBuilder.loadTexts: dot3CollEntry.setStatus('current')
dot3CollCount = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 7, 5, 1, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 16))).setMaxAccess("notaccessible")
...
dot3ControlTable = MibTable((1, 3, 6, 1, 2, 1, 10, 7, 9), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: dot3ControlTable.setStatus('current')
dot3ControlEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 7, 9, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "EtherLike-MIB", "dot3StatsIndex"))
...
dot3PauseTable = MibTable((1, 3, 6, 1, 2, 1, 10, 7, 10), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: dot3PauseTable.setStatus('current')
dot3PauseEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 7, 10, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "EtherLike-MIB", "dot3StatsIndex"))
...
dot3HCStatsTable = MibTable((1, 3, 6, 1, 2, 1, 10, 7, 11), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: dot3HCStatsTable.setStatus('current')
dot3HCStatsEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 7, 11, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "EtherLike-MIB", "dot3StatsIndex"))
...
mibBuilder.exportSymbols("EtherLike-MIB", PYSNMP_MODULE_ID=etherMIB, dot3=dot3, dot3CollCount=dot3CollCount, dot3CollEntry=dot3CollEntry, dot3CollFrequencies=dot3CollFrequencies, dot3CollTable=dot3CollTable, dot3Compliance2=dot3Compliance2, dot3Compliance=dot3Compliance, dot3ControlEntry=dot3ControlEntry, dot3ControlFunctionsSupported=dot3ControlFunctionsSupported, dot3ControlInUnknownOpcodes=dot3ControlInUnknownOpcodes, dot3ControlTable=dot3ControlTable, dot3ErrorInitError=dot3ErrorInitError, dot3ErrorLoopbackError=dot3ErrorLoopbackError, dot3Errors=dot3Errors, dot3HCControlInUnknownOpcodes=dot3HCControlInUnknownOpcodes, dot3HCInPauseFrames=dot3HCInPauseFrames, dot3HCOutPauseFrames=dot3HCOutPauseFrames, dot3HCStatsAlignmentErrors=dot3HCStatsAlignmentErrors, dot3HCStatsEntry=dot3HCStatsEntry, dot3HCStatsFCSErrors=dot3HCStatsFCSErrors, dot3HCStatsFrameTooLongs=dot3HCStatsFrameTooLongs, dot3HCStatsInternalMacReceiveErrors=dot3HCStatsInternalMacReceiveErrors, dot3HCStatsInternalMacTransmitErrors=dot3HCStatsInternalMacTransmitErrors, dot3HCStatsSymbolErrors=dot3HCStatsSymbolErrors, dot3HCStatsTable=dot3HCStatsTable, dot3InPauseFrames=dot3InPauseFrames, dot3OutPauseFrames=dot3OutPauseFrames, dot3PauseAdminMode=dot3PauseAdminMode, dot3PauseEntry=dot3PauseEntry, dot3PauseOperMode=dot3PauseOperMode, dot3PauseTable=dot3PauseTable, dot3StatsAlignmentErrors=dot3StatsAlignmentErrors, dot3StatsCarrierSenseErrors=dot3StatsCarrierSenseErrors, dot3StatsDeferredTransmissions=dot3StatsDeferredTransmissions, dot3StatsDuplexStatus=dot3StatsDuplexStatus, dot3StatsEntry=dot3StatsEntry, dot3StatsEtherChipSet=dot3StatsEtherChipSet, dot3StatsExcessiveCollisions=dot3StatsExcessiveCollisions, dot3StatsFCSErrors=dot3StatsFCSErrors, dot3StatsFrameTooLongs=dot3StatsFrameTooLongs, dot3StatsIndex=dot3StatsIndex, dot3StatsInternalMacReceiveErrors=dot3StatsInternalMacReceiveErrors, dot3StatsInternalMacTransmitErrors=dot3StatsInternalMacTransmitErrors, dot3StatsLateCollisions=dot3StatsLateCollisions, dot3StatsMultipleCollisionFrames=dot3StatsMultipleCollisionFrames, dot3StatsRateControlAbility=dot3StatsRateControlAbility, dot3StatsRateControlStatus=dot3StatsRateControlStatus, dot3StatsSQETestErrors=dot3StatsSQETestErrors, dot3StatsSingleCollisionFrames=dot3StatsSingleCollisionFrames, dot3StatsSymbolErrors=dot3StatsSymbolErrors, dot3StatsTable=dot3StatsTable, dot3TestLoopBack=dot3TestLoopBack, dot3TestTdr=dot3TestTdr, dot3Tests=dot3Tests, ether100MbsCompliance=ether100MbsCompliance, etherCollisionTableGroup=etherCollisionTableGroup, etherCompliance=etherCompliance, etherCompliances=etherCompliances, etherConformance=etherConformance, etherControlGroup=etherControlGroup, etherControlPauseGroup=etherControlPauseGroup, etherDuplexGroup=etherDuplexGroup, etherGroups=etherGroups, etherHCControlGroup=etherHCControlGroup, etherHCControlPauseGroup=etherHCControlPauseGroup, etherHCStatsGroup=etherHCStatsGroup, etherMIB=etherMIB, etherMIBObjects=etherMIBObjects, etherRateControlGroup=etherRateControlGroup, etherStats100MbsGroup=etherStats100MbsGroup, etherStatsBaseGroup2=etherStatsBaseGroup2, etherStatsBaseGroup=etherStatsBaseGroup, etherStatsGroup=etherStatsGroup, etherStatsHalfDuplexGroup=etherStatsHalfDuplexGroup, etherStatsHighSpeedGroup=etherStatsHighSpeedGroup, etherStatsLowSpeedGroup=etherStatsLowSpeedGroup)
