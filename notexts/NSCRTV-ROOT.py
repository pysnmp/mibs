...
ModuleIdentity, Unsigned32, Gauge32, TimeTicks, Bits, NotificationType, IpAddress, Counter32, ObjectIdentity, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "Gauge32", "TimeTicks", "Bits", "NotificationType", "IpAddress", "Counter32", "ObjectIdentity", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("NSCRTV-ROOT", commonAdminUseRf=commonAdminUseRf, commonTrapCommunityString=commonTrapCommunityString, commonDeviceTamperStatus=commonDeviceTamperStatus, discretePropertyTable=discretePropertyTable, commonAgentGroup=commonAgentGroup, oaIdent=oaIdent, discreteAlarmState=discreteAlarmState, commonPhysAddress=commonPhysAddress, oaOutputOpticalPower=oaOutputOpticalPower, commonRfGroup=commonRfGroup, commonInternalTemperature=commonInternalTemperature, commonDeviceModelNumber=commonDeviceModelNumber, oaNumberDCPowerSupply=oaNumberDCPowerSupply, hfcWarmStart=hfcWarmStart, currentAlarmOID=currentAlarmOID, commonDeviceInfoEntry=commonDeviceInfoEntry, oaGainSet=oaGainSet, commonAdminGroup=commonAdminGroup, currentAlarmValue=currentAlarmValue, commonMacAddress=commonMacAddress, commonDeviceSerialNumber=commonDeviceSerialNumber, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, alarmLogEntry=alarmLogEntry, commonDeviceFW=commonDeviceFW, commonDeviceMFD=commonDeviceMFD, oaPumpTemp=oaPumpTemp, hfcColdStart=hfcColdStart, currentAlarmTable=currentAlarmTable, commonMaxReturnPower=commonMaxReturnPower, alarmLogLastIndex=alarmLogLastIndex, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonAlarmDetectionControl=commonAlarmDetectionControl, commonForwardPathLOSEvents=commonForwardPathLOSEvents, alarmLogTable=alarmLogTable, oaDCPowerIndex=oaDCPowerIndex, propertyIdent=propertyIdent, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, oaPumpBIAS=oaPumpBIAS, oaPumpEntry=oaPumpEntry, commonDevicesOID=commonDevicesOID, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonNEModelNumber=commonNEModelNumber, commonNetworkAddress=commonNetworkAddress, commonDeviceVendor=commonDeviceVendor, commonTrapAck=commonTrapAck, commonACKTimeoutWindow=commonACKTimeoutWindow, commonNESerialNumber=commonNESerialNumber, analogAlarmLOLO=analogAlarmLOLO, oaPumpIndex=oaPumpIndex, alarmEnable=alarmEnable, commonDeviceAcct=commonDeviceAcct, commonAgentReset=commonAgentReset, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonIdent=commonIdent, analogAlarmDeadband=analogAlarmDeadband, commondownload=commondownload, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonDeviceName=commonDeviceName, commonMulticastAddressNumber=commonMulticastAddressNumber, commonMulticastAddressTable=commonMulticastAddressTable, commonCheckCode=commonCheckCode, commonNEVendor=commonNEVendor, commonDeviceOID=commonDeviceOID, analogPropertyEntry=analogPropertyEntry, commonResetCause=commonResetCause, commonNEVendorInfo=commonNEVendorInfo, commonInvalidMacCmds=commonInvalidMacCmds, powerSupplyStatusA=powerSupplyStatusA, analogParameterOID=analogParameterOID, commonDeviceResetCause=commonDeviceResetCause, oaDCPowerName=oaDCPowerName, commonDevicesID=commonDevicesID, commonDeviceStatus=commonDeviceStatus, alarmText=alarmText, oaDCPowerVoltage=oaDCPowerVoltage, nscrtvHFCemsTree=nscrtvHFCemsTree, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonDeviceInfoTable=commonDeviceInfoTable, commonTamperStatus=commonTamperStatus, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonDeviceVendorInfo=commonDeviceVendorInfo, commonDeviceReset=commonDeviceReset, analogAlarmHIHI=analogAlarmHIHI, powerSupplyStatusB=powerSupplyStatusB, commonNELogicalID=commonNELogicalID, commonAgentTrapCommunity=commonAgentTrapCommunity, commonDeviceMACAddress=commonDeviceMACAddress, commonMaxPayloadSize=commonMaxPayloadSize, commonForwardPathFramingErrors=commonForwardPathFramingErrors, alarmsIdent=alarmsIdent, commonMacStats=commonMacStats, currentAlarmState=currentAlarmState, analogAlarmLO=analogAlarmLO, analogAlarmState=analogAlarmState, commonMulticastAddressEntry=commonMulticastAddressEntry, commonAgentTrapEntry=commonAgentTrapEntry, analogPropertyTable=analogPropertyTable, commonAgentTrapTable=commonAgentTrapTable, commonDeviceGroup=commonDeviceGroup, commonAgentTrapIndex=commonAgentTrapIndex, alarmLogIndex=alarmLogIndex, commonDeviceNum=commonDeviceNum, commonMACGroup=commonMACGroup, commonTime=commonTime, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonCraftStatus=commonCraftStatus, commonAgentMaxTraps=commonAgentMaxTraps, commonForwardPathFrequency=commonForwardPathFrequency, oaOutputOpticalPowerSet=oaOutputOpticalPowerSet, discreteAlarmValue=discreteAlarmValue, alarmLogNumberOfEntries=alarmLogNumberOfEntries, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, oaDCPowerEntry=oaDCPowerEntry, oaInputOpticalPower=oaInputOpticalPower, commonReturnPathFrequency=commonReturnPathFrequency, hfcAlarmEvent=hfcAlarmEvent, analogAlarmHI=analogAlarmHI, oaDCPowerCurrent=oaDCPowerCurrent, commonBackoffParams=commonBackoffParams, commonDeviceCraftStatus=commonDeviceCraftStatus, discreteAlarmEnable=discreteAlarmEnable, discreteParameterOID=discreteParameterOID, commonVarBindings=commonVarBindings, commonDeviceId=commonDeviceId, oaPumpTable=oaPumpTable, commonAdminUseEthernet=commonAdminUseEthernet, commonMulticastAddressIndex=commonMulticastAddressIndex, oaPumpTEC=oaPumpTEC, commonNEStatus=commonNEStatus, oaDCPowerTable=oaDCPowerTable, commonReset=commonReset, commonAgentBootWay=commonAgentBootWay, commonAgentTrapStatus=commonAgentTrapStatus, currentAlarmEntry=currentAlarmEntry, discretePropertyEntry=discretePropertyEntry, alarmLogInformation=alarmLogInformation, oaVendorOID=oaVendorOID, commonDeviceSlot=commonDeviceSlot, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonAgentTrapIP=commonAgentTrapIP, oaDCPowerSupplyMode=oaDCPowerSupplyMode, commonBackoffPeriod=commonBackoffPeriod, nscrtvRoot=nscrtvRoot)
