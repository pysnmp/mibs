...
TextualConvention, RowStatus, TruthValue, DisplayString, TimeStamp, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowStatus", "TruthValue", "DisplayString", "TimeStamp", "AutonomousType")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoCompliances=ptopoCompliances, PtopoChassisId=PtopoChassisId, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoGeneralGroup=ptopoGeneralGroup, PtopoPortIdType=PtopoPortIdType, ptopoConnTabDrops=ptopoConnTabDrops, ptopoGroups=ptopoGroups, ptopoConnTable=ptopoConnTable, ptopoConformance=ptopoConformance, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConnEntry=ptopoConnEntry, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoMIBNotifications=ptopoMIBNotifications, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoDataGroup=ptopoDataGroup, ptopoLastChangeTime=ptopoLastChangeTime, PtopoPortId=PtopoPortId, ptopoConfig=ptopoConfig, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, PtopoGenAddr=PtopoGenAddr, PYSNMP_MODULE_ID=ptopoMIB, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConfigChange=ptopoConfigChange, ptopoConnRowStatus=ptopoConnRowStatus, PtopoChassisIdType=PtopoChassisIdType, ptopoGeneral=ptopoGeneral, ptopoConfigGroup=ptopoConfigGroup, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoMIB=ptopoMIB, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoCompliance=ptopoCompliance, ptopoConnRemotePort=ptopoConnRemotePort, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoConnTabDeletes=ptopoConnTabDeletes, PtopoAddrSeenState=PtopoAddrSeenState, ptopoConnLocalPort=ptopoConnLocalPort, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoConnTabInserts=ptopoConnTabInserts, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoConnIndex=ptopoConnIndex, ptopoData=ptopoData, ptopoConnIsStatic=ptopoConnIsStatic, ptopoMIBObjects=ptopoMIBObjects)
