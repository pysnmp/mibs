...
AutonomousType, TruthValue, TextualConvention, RowStatus, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TruthValue", "TextualConvention", "RowStatus", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoConnTabDrops=ptopoConnTabDrops, ptopoMIBObjects=ptopoMIBObjects, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoConfigChange=ptopoConfigChange, PtopoChassisId=PtopoChassisId, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoConnEntry=ptopoConnEntry, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoConformance=ptopoConformance, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoConnLocalPort=ptopoConnLocalPort, ptopoCompliance=ptopoCompliance, ptopoConfig=ptopoConfig, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoConfigGroup=ptopoConfigGroup, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoConnTabInserts=ptopoConnTabInserts, ptopoConnTable=ptopoConnTable, ptopoGroups=ptopoGroups, PtopoPortId=PtopoPortId, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoCompliances=ptopoCompliances, ptopoConnRowStatus=ptopoConnRowStatus, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConnRemotePort=ptopoConnRemotePort, ptopoGeneral=ptopoGeneral, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoMIBNotifications=ptopoMIBNotifications, PtopoAddrSeenState=PtopoAddrSeenState, ptopoData=ptopoData, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoGeneralGroup=ptopoGeneralGroup, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, PtopoChassisIdType=PtopoChassisIdType, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, PtopoPortIdType=PtopoPortIdType, ptopoDataGroup=ptopoDataGroup, ptopoConnIndex=ptopoConnIndex, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoMIB=ptopoMIB, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, PYSNMP_MODULE_ID=ptopoMIB, PtopoGenAddr=PtopoGenAddr, ptopoConnIsStatic=ptopoConnIsStatic)
