...
TextualConvention, RowStatus, DisplayString, TimeStamp, TruthValue, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowStatus", "DisplayString", "TimeStamp", "TruthValue", "AutonomousType")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoGroups=ptopoGroups, ptopoConnRowStatus=ptopoConnRowStatus, ptopoConnLocalPort=ptopoConnLocalPort, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoConformance=ptopoConformance, ptopoConfig=ptopoConfig, PtopoChassisIdType=PtopoChassisIdType, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoConnTabInserts=ptopoConnTabInserts, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, PtopoChassisId=PtopoChassisId, ptopoMIB=ptopoMIB, ptopoGeneral=ptopoGeneral, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoData=ptopoData, ptopoConnRemotePort=ptopoConnRemotePort, PtopoAddrSeenState=PtopoAddrSeenState, ptopoDataGroup=ptopoDataGroup, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, PtopoPortId=PtopoPortId, ptopoGeneralGroup=ptopoGeneralGroup, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConfigGroup=ptopoConfigGroup, PtopoPortIdType=PtopoPortIdType, PtopoGenAddr=PtopoGenAddr, ptopoConnIndex=ptopoConnIndex, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoConnEntry=ptopoConnEntry, ptopoConnTabDrops=ptopoConnTabDrops, ptopoConnTable=ptopoConnTable, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoConfigChange=ptopoConfigChange, ptopoCompliance=ptopoCompliance, PYSNMP_MODULE_ID=ptopoMIB, ptopoCompliances=ptopoCompliances, ptopoMIBObjects=ptopoMIBObjects, ptopoMIBNotifications=ptopoMIBNotifications)
