...
TimeStamp, RowStatus, TruthValue, TextualConvention, AutonomousType, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "TruthValue", "TextualConvention", "AutonomousType", "DisplayString")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoMIB=ptopoMIB, ptopoData=ptopoData, ptopoLastChangeTime=ptopoLastChangeTime, PtopoPortId=PtopoPortId, PtopoPortIdType=PtopoPortIdType, ptopoConnTabInserts=ptopoConnTabInserts, ptopoConfigGroup=ptopoConfigGroup, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoConnRemotePort=ptopoConnRemotePort, ptopoGeneral=ptopoGeneral, ptopoMIBObjects=ptopoMIBObjects, PtopoChassisId=PtopoChassisId, ptopoConnIsStatic=ptopoConnIsStatic, ptopoMIBNotifications=ptopoMIBNotifications, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoCompliance=ptopoCompliance, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConnTable=ptopoConnTable, ptopoConfig=ptopoConfig, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoConnEntry=ptopoConnEntry, PtopoGenAddr=PtopoGenAddr, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoConformance=ptopoConformance, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConnRowStatus=ptopoConnRowStatus, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoCompliances=ptopoCompliances, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, PtopoAddrSeenState=PtopoAddrSeenState, ptopoGroups=ptopoGroups, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoConnLocalPort=ptopoConnLocalPort, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoGeneralGroup=ptopoGeneralGroup, PYSNMP_MODULE_ID=ptopoMIB, ptopoConfigChange=ptopoConfigChange, ptopoDataGroup=ptopoDataGroup, ptopoConnIndex=ptopoConnIndex, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoNotificationsGroup=ptopoNotificationsGroup, PtopoChassisIdType=PtopoChassisIdType, ptopoConnTabDrops=ptopoConnTabDrops)
