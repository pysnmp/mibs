...
TextualConvention, AutonomousType, TimeStamp, RowStatus, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "TimeStamp", "RowStatus", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoConnLocalPort=ptopoConnLocalPort, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoGroups=ptopoGroups, ptopoConfigTrapInterval=ptopoConfigTrapInterval, PtopoPortIdType=PtopoPortIdType, PtopoChassisId=PtopoChassisId, ptopoCompliances=ptopoCompliances, ptopoConfig=ptopoConfig, PtopoChassisIdType=PtopoChassisIdType, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoGeneralGroup=ptopoGeneralGroup, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConnTable=ptopoConnTable, ptopoConnTabAgeouts=ptopoConnTabAgeouts, PtopoAddrSeenState=PtopoAddrSeenState, ptopoDataGroup=ptopoDataGroup, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoMIBObjects=ptopoMIBObjects, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, PYSNMP_MODULE_ID=ptopoMIB, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoConfigChange=ptopoConfigChange, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoDiscoveryLocal=ptopoDiscoveryLocal, PtopoPortId=PtopoPortId, ptopoGeneral=ptopoGeneral, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoData=ptopoData, ptopoConnTabInserts=ptopoConnTabInserts, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoMIBNotifications=ptopoMIBNotifications, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoMIB=ptopoMIB, ptopoConnEntry=ptopoConnEntry, ptopoConnIndex=ptopoConnIndex, PtopoGenAddr=PtopoGenAddr, ptopoConnRowStatus=ptopoConnRowStatus, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoConformance=ptopoConformance, ptopoConnRemotePort=ptopoConnRemotePort, ptopoConfigGroup=ptopoConfigGroup, ptopoCompliance=ptopoCompliance, ptopoConnTabDrops=ptopoConnTabDrops)
