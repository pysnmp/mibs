...
TruthValue, AutonomousType, TimeStamp, TextualConvention, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "AutonomousType", "TimeStamp", "TextualConvention", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoConfigChange=ptopoConfigChange, ptopoConfig=ptopoConfig, ptopoDataGroup=ptopoDataGroup, PtopoPortIdType=PtopoPortIdType, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoGroups=ptopoGroups, ptopoConfigGroup=ptopoConfigGroup, PtopoPortId=PtopoPortId, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoConnTabDrops=ptopoConnTabDrops, ptopoConnRemotePort=ptopoConnRemotePort, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoGeneral=ptopoGeneral, PtopoChassisIdType=PtopoChassisIdType, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoConnTimeMark=ptopoConnTimeMark, ptopoData=ptopoData, ptopoConnTabInserts=ptopoConnTabInserts, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoConformance=ptopoConformance, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, PtopoChassisId=PtopoChassisId, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoCompliances=ptopoCompliances, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConnRemotePortType=ptopoConnRemotePortType, PtopoAddrSeenState=PtopoAddrSeenState, ptopoMIBNotifications=ptopoMIBNotifications, ptopoConnEntry=ptopoConnEntry, ptopoConnIndex=ptopoConnIndex, PYSNMP_MODULE_ID=ptopoMIB, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoLastChangeTime=ptopoLastChangeTime, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoCompliance=ptopoCompliance, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoConnTable=ptopoConnTable, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoMIBObjects=ptopoMIBObjects, ptopoConnRowStatus=ptopoConnRowStatus, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoGeneralGroup=ptopoGeneralGroup, ptopoMIB=ptopoMIB, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, PtopoGenAddr=PtopoGenAddr)
