...
TruthValue, AutonomousType, TextualConvention, RowStatus, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "AutonomousType", "TextualConvention", "RowStatus", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoGeneral=ptopoGeneral, ptopoMIB=ptopoMIB, PtopoChassisId=PtopoChassisId, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoConnTabAgeouts=ptopoConnTabAgeouts, PtopoGenAddr=PtopoGenAddr, PYSNMP_MODULE_ID=ptopoMIB, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoConfigGroup=ptopoConfigGroup, ptopoConnRemotePort=ptopoConnRemotePort, ptopoConnIndex=ptopoConnIndex, ptopoConnRowStatus=ptopoConnRowStatus, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConnTabInserts=ptopoConnTabInserts, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConnEntry=ptopoConnEntry, ptopoConnTabDrops=ptopoConnTabDrops, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoConfigChange=ptopoConfigChange, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConformance=ptopoConformance, ptopoDataGroup=ptopoDataGroup, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoConnLocalPort=ptopoConnLocalPort, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoMIBNotifications=ptopoMIBNotifications, ptopoCompliances=ptopoCompliances, PtopoPortId=PtopoPortId, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoGroups=ptopoGroups, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoMIBObjects=ptopoMIBObjects, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, PtopoChassisIdType=PtopoChassisIdType, ptopoGeneralGroup=ptopoGeneralGroup, PtopoAddrSeenState=PtopoAddrSeenState, ptopoCompliance=ptopoCompliance, ptopoConfig=ptopoConfig, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoData=ptopoData, ptopoConnTable=ptopoConnTable, PtopoPortIdType=PtopoPortIdType)
