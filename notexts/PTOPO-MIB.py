...
DisplayString, RowStatus, TimeStamp, TextualConvention, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "TimeStamp", "TextualConvention", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoConnTabDrops=ptopoConnTabDrops, PtopoAddrSeenState=PtopoAddrSeenState, ptopoGroups=ptopoGroups, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoMIBNotifications=ptopoMIBNotifications, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoGeneral=ptopoGeneral, ptopoConfigChange=ptopoConfigChange, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, PtopoPortIdType=PtopoPortIdType, ptopoDataGroup=ptopoDataGroup, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConnLocalChassis=ptopoConnLocalChassis, PtopoChassisIdType=PtopoChassisIdType, ptopoCompliances=ptopoCompliances, ptopoConnRowStatus=ptopoConnRowStatus, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoConnIsStatic=ptopoConnIsStatic, PtopoGenAddr=PtopoGenAddr, ptopoMIBObjects=ptopoMIBObjects, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, PYSNMP_MODULE_ID=ptopoMIB, ptopoConnTable=ptopoConnTable, ptopoConnIndex=ptopoConnIndex, ptopoConformance=ptopoConformance, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoGeneralGroup=ptopoGeneralGroup, ptopoConfigGroup=ptopoConfigGroup, ptopoLastChangeTime=ptopoLastChangeTime, PtopoChassisId=PtopoChassisId, ptopoCompliance=ptopoCompliance, ptopoConfig=ptopoConfig, PtopoPortId=PtopoPortId, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoConnRemotePort=ptopoConnRemotePort, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoMIB=ptopoMIB, ptopoConnEntry=ptopoConnEntry, ptopoConnTabInserts=ptopoConnTabInserts, ptopoData=ptopoData, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr)
