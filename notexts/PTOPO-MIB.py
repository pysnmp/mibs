...
TruthValue, TextualConvention, AutonomousType, TimeStamp, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "AutonomousType", "TimeStamp", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("PTOPO-MIB", PtopoGenAddr=PtopoGenAddr, PtopoAddrSeenState=PtopoAddrSeenState, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConnRowStatus=ptopoConnRowStatus, ptopoCompliance=ptopoCompliance, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoMIBNotifications=ptopoMIBNotifications, PtopoPortIdType=PtopoPortIdType, ptopoDataGroup=ptopoDataGroup, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoConnEntry=ptopoConnEntry, ptopoConfigChange=ptopoConfigChange, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConfig=ptopoConfig, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoGeneral=ptopoGeneral, PtopoChassisId=PtopoChassisId, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConnLocalPort=ptopoConnLocalPort, ptopoCompliances=ptopoCompliances, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoConnTable=ptopoConnTable, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoMIBObjects=ptopoMIBObjects, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConformance=ptopoConformance, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoConnTabDrops=ptopoConnTabDrops, ptopoGeneralGroup=ptopoGeneralGroup, ptopoData=ptopoData, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConfigGroup=ptopoConfigGroup, ptopoMIB=ptopoMIB, ptopoConnRemotePort=ptopoConnRemotePort, PtopoPortId=PtopoPortId, PtopoChassisIdType=PtopoChassisIdType, PYSNMP_MODULE_ID=ptopoMIB, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoGroups=ptopoGroups, ptopoConnTabInserts=ptopoConnTabInserts, ptopoConnIndex=ptopoConnIndex)
