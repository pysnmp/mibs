...
RowStatus, AutonomousType, DisplayString, TruthValue, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "AutonomousType", "DisplayString", "TruthValue", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoMIBNotifications=ptopoMIBNotifications, ptopoConnRemotePort=ptopoConnRemotePort, ptopoCompliance=ptopoCompliance, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConnTabInserts=ptopoConnTabInserts, ptopoRegistrationPoints=ptopoRegistrationPoints, PYSNMP_MODULE_ID=ptopoMIB, ptopoConnTabDrops=ptopoConnTabDrops, ptopoGeneral=ptopoGeneral, ptopoMIBObjects=ptopoMIBObjects, ptopoConnTimeMark=ptopoConnTimeMark, ptopoGeneralGroup=ptopoGeneralGroup, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoConfigGroup=ptopoConfigGroup, ptopoConformance=ptopoConformance, ptopoConnRowStatus=ptopoConnRowStatus, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoConfigChange=ptopoConfigChange, PtopoPortIdType=PtopoPortIdType, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoConnTable=ptopoConnTable, ptopoConnEntry=ptopoConnEntry, PtopoChassisIdType=PtopoChassisIdType, ptopoConfig=ptopoConfig, PtopoAddrSeenState=PtopoAddrSeenState, ptopoGroups=ptopoGroups, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoConnIndex=ptopoConnIndex, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, PtopoGenAddr=PtopoGenAddr, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoMIB=ptopoMIB, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoData=ptopoData, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoDataGroup=ptopoDataGroup, PtopoChassisId=PtopoChassisId, ptopoConnTabAgeouts=ptopoConnTabAgeouts, PtopoPortId=PtopoPortId, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoCompliances=ptopoCompliances)
