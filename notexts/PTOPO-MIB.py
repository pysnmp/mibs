...
AutonomousType, TextualConvention, TruthValue, TimeStamp, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TextualConvention", "TruthValue", "TimeStamp", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoGeneralGroup=ptopoGeneralGroup, ptopoGroups=ptopoGroups, ptopoConnRowStatus=ptopoConnRowStatus, ptopoLastChangeTime=ptopoLastChangeTime, PtopoGenAddr=PtopoGenAddr, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, PtopoChassisId=PtopoChassisId, ptopoMIBNotifications=ptopoMIBNotifications, ptopoConfigGroup=ptopoConfigGroup, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoMIBObjects=ptopoMIBObjects, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoCompliances=ptopoCompliances, ptopoConfig=ptopoConfig, ptopoConnTabInserts=ptopoConnTabInserts, ptopoMIB=ptopoMIB, ptopoConnIndex=ptopoConnIndex, PYSNMP_MODULE_ID=ptopoMIB, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, PtopoChassisIdType=PtopoChassisIdType, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoConnEntry=ptopoConnEntry, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoConnTable=ptopoConnTable, PtopoPortId=PtopoPortId, ptopoData=ptopoData, ptopoConnRemotePort=ptopoConnRemotePort, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConfigChange=ptopoConfigChange, PtopoAddrSeenState=PtopoAddrSeenState, ptopoGeneral=ptopoGeneral, ptopoDataGroup=ptopoDataGroup, PtopoPortIdType=PtopoPortIdType, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoCompliance=ptopoCompliance, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoConformance=ptopoConformance, ptopoConnTabDrops=ptopoConnTabDrops, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm)
