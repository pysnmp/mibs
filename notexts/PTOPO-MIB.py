...
TextualConvention, DisplayString, TruthValue, RowStatus, TimeStamp, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "TruthValue", "RowStatus", "TimeStamp", "AutonomousType")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoGroups=ptopoGroups, ptopoConfigGroup=ptopoConfigGroup, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConfigChange=ptopoConfigChange, ptopoCompliance=ptopoCompliance, PtopoChassisIdType=PtopoChassisIdType, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoConnLocalChassis=ptopoConnLocalChassis, PtopoGenAddr=PtopoGenAddr, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoData=ptopoData, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoConnRowStatus=ptopoConnRowStatus, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConnTabInserts=ptopoConnTabInserts, PtopoPortId=PtopoPortId, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, PtopoAddrSeenState=PtopoAddrSeenState, ptopoGeneral=ptopoGeneral, PYSNMP_MODULE_ID=ptopoMIB, ptopoConfigTrapInterval=ptopoConfigTrapInterval, PtopoChassisId=PtopoChassisId, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoDataGroup=ptopoDataGroup, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConnTimeMark=ptopoConnTimeMark, ptopoMIB=ptopoMIB, ptopoConnTabDrops=ptopoConnTabDrops, ptopoGeneralGroup=ptopoGeneralGroup, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConfig=ptopoConfig, ptopoConnIndex=ptopoConnIndex, ptopoConnTable=ptopoConnTable, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConformance=ptopoConformance, ptopoNotificationsGroup=ptopoNotificationsGroup, PtopoPortIdType=PtopoPortIdType, ptopoConnEntry=ptopoConnEntry, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoCompliances=ptopoCompliances, ptopoMIBObjects=ptopoMIBObjects, ptopoConnRemotePort=ptopoConnRemotePort, ptopoMIBNotifications=ptopoMIBNotifications)
