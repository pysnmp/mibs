...
RowStatus, TimeStamp, AutonomousType, DisplayString, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "AutonomousType", "DisplayString", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, PtopoAddrSeenState=PtopoAddrSeenState, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoGeneralGroup=ptopoGeneralGroup, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoConnTabDrops=ptopoConnTabDrops, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConfigChange=ptopoConfigChange, ptopoLastChangeTime=ptopoLastChangeTime, ptopoCompliance=ptopoCompliance, ptopoMIB=ptopoMIB, ptopoConnTable=ptopoConnTable, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConnRemoteChassis=ptopoConnRemoteChassis, PtopoChassisId=PtopoChassisId, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoConformance=ptopoConformance, PYSNMP_MODULE_ID=ptopoMIB, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoData=ptopoData, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoConfigGroup=ptopoConfigGroup, PtopoGenAddr=PtopoGenAddr, PtopoPortIdType=PtopoPortIdType, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoMIBObjects=ptopoMIBObjects, PtopoChassisIdType=PtopoChassisIdType, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoConfig=ptopoConfig, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoConnRowStatus=ptopoConnRowStatus, ptopoConnEntry=ptopoConnEntry, ptopoMIBNotifications=ptopoMIBNotifications, ptopoConnTabInserts=ptopoConnTabInserts, ptopoConnRemotePort=ptopoConnRemotePort, ptopoConnIndex=ptopoConnIndex, ptopoCompliances=ptopoCompliances, ptopoGeneral=ptopoGeneral, ptopoGroups=ptopoGroups, ptopoDataGroup=ptopoDataGroup, PtopoPortId=PtopoPortId)
