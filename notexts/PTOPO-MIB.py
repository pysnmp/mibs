...
TextualConvention, TimeStamp, TruthValue, DisplayString, AutonomousType, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "TruthValue", "DisplayString", "AutonomousType", "RowStatus")
...
mibBuilder.exportSymbols("PTOPO-MIB", PYSNMP_MODULE_ID=ptopoMIB, ptopoConnRemotePort=ptopoConnRemotePort, ptopoMIBNotifications=ptopoMIBNotifications, PtopoGenAddr=PtopoGenAddr, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoConnTabDrops=ptopoConnTabDrops, ptopoConnTabInserts=ptopoConnTabInserts, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoMIBObjects=ptopoMIBObjects, ptopoConformance=ptopoConformance, ptopoNotificationsGroup=ptopoNotificationsGroup, PtopoPortIdType=PtopoPortIdType, PtopoChassisId=PtopoChassisId, PtopoChassisIdType=PtopoChassisIdType, ptopoConfig=ptopoConfig, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoGeneralGroup=ptopoGeneralGroup, ptopoCompliances=ptopoCompliances, ptopoMIB=ptopoMIB, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, PtopoAddrSeenState=PtopoAddrSeenState, ptopoLastChangeTime=ptopoLastChangeTime, ptopoDataGroup=ptopoDataGroup, ptopoData=ptopoData, ptopoConnIndex=ptopoConnIndex, PtopoPortId=PtopoPortId, ptopoConnRowStatus=ptopoConnRowStatus, ptopoCompliance=ptopoCompliance, ptopoConfigGroup=ptopoConfigGroup, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoGeneral=ptopoGeneral, ptopoConnTable=ptopoConnTable, ptopoConnEntry=ptopoConnEntry, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoConfigChange=ptopoConfigChange, ptopoGroups=ptopoGroups, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoConnRemotePortType=ptopoConnRemotePortType)
