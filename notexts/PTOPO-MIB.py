...
DisplayString, TruthValue, TimeStamp, TextualConvention, AutonomousType, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "TimeStamp", "TextualConvention", "AutonomousType", "RowStatus")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoGeneralGroup=ptopoGeneralGroup, ptopoConfigGroup=ptopoConfigGroup, PtopoPortIdType=PtopoPortIdType, ptopoConnRemotePort=ptopoConnRemotePort, ptopoConnRowStatus=ptopoConnRowStatus, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, PtopoChassisId=PtopoChassisId, ptopoMIBNotifications=ptopoMIBNotifications, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoConnEntry=ptopoConnEntry, ptopoMIB=ptopoMIB, ptopoGeneral=ptopoGeneral, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoConnTabInserts=ptopoConnTabInserts, PYSNMP_MODULE_ID=ptopoMIB, ptopoConfig=ptopoConfig, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConfigChange=ptopoConfigChange, ptopoCompliance=ptopoCompliance, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoConformance=ptopoConformance, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, PtopoGenAddr=PtopoGenAddr, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoConnTabDrops=ptopoConnTabDrops, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoData=ptopoData, ptopoDataGroup=ptopoDataGroup, PtopoAddrSeenState=PtopoAddrSeenState, ptopoConfigTrapInterval=ptopoConfigTrapInterval, PtopoPortId=PtopoPortId, ptopoCompliances=ptopoCompliances, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoGroups=ptopoGroups, ptopoMIBObjects=ptopoMIBObjects, ptopoConnTable=ptopoConnTable, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConnIndex=ptopoConnIndex, ptopoConnTimeMark=ptopoConnTimeMark, PtopoChassisIdType=PtopoChassisIdType)
