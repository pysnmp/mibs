...
AutonomousType, TimeStamp, TruthValue, TextualConvention, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TimeStamp", "TruthValue", "TextualConvention", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoConfig=ptopoConfig, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoMIB=ptopoMIB, ptopoConnRemotePort=ptopoConnRemotePort, ptopoConnTable=ptopoConnTable, PtopoPortId=PtopoPortId, PtopoChassisId=PtopoChassisId, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoConfigChange=ptopoConfigChange, ptopoGeneral=ptopoGeneral, ptopoGeneralGroup=ptopoGeneralGroup, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoCompliances=ptopoCompliances, PYSNMP_MODULE_ID=ptopoMIB, ptopoConnTabDrops=ptopoConnTabDrops, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoData=ptopoData, PtopoPortIdType=PtopoPortIdType, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConnTabDeletes=ptopoConnTabDeletes, PtopoGenAddr=PtopoGenAddr, ptopoConnTabInserts=ptopoConnTabInserts, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoConnIndex=ptopoConnIndex, PtopoChassisIdType=PtopoChassisIdType, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConfigGroup=ptopoConfigGroup, ptopoMIBNotifications=ptopoMIBNotifications, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoConformance=ptopoConformance, ptopoMIBObjects=ptopoMIBObjects, PtopoAddrSeenState=PtopoAddrSeenState, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoGroups=ptopoGroups, ptopoDataGroup=ptopoDataGroup, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoConnRowStatus=ptopoConnRowStatus, ptopoConnTimeMark=ptopoConnTimeMark, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoCompliance=ptopoCompliance, ptopoConnEntry=ptopoConnEntry)
