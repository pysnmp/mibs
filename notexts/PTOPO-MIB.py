...
RowStatus, DisplayString, AutonomousType, TimeStamp, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "AutonomousType", "TimeStamp", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoLastChangeTime=ptopoLastChangeTime, ptopoConnLocalPort=ptopoConnLocalPort, PtopoPortId=PtopoPortId, ptopoCompliances=ptopoCompliances, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoCompliance=ptopoCompliance, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoConnEntry=ptopoConnEntry, ptopoConnRemoteChassis=ptopoConnRemoteChassis, PtopoAddrSeenState=PtopoAddrSeenState, ptopoConfigTrapInterval=ptopoConfigTrapInterval, PtopoChassisId=PtopoChassisId, ptopoConfigChange=ptopoConfigChange, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoConnTabDrops=ptopoConnTabDrops, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, PtopoPortIdType=PtopoPortIdType, ptopoConnTabInserts=ptopoConnTabInserts, ptopoConfig=ptopoConfig, ptopoMIBObjects=ptopoMIBObjects, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoConnTable=ptopoConnTable, ptopoMIB=ptopoMIB, PtopoGenAddr=PtopoGenAddr, ptopoDataGroup=ptopoDataGroup, ptopoGeneral=ptopoGeneral, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConfigGroup=ptopoConfigGroup, ptopoConnIndex=ptopoConnIndex, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoMIBNotifications=ptopoMIBNotifications, ptopoConformance=ptopoConformance, ptopoGeneralGroup=ptopoGeneralGroup, ptopoConnRemotePortType=ptopoConnRemotePortType, PYSNMP_MODULE_ID=ptopoMIB, ptopoConnIsStatic=ptopoConnIsStatic, PtopoChassisIdType=PtopoChassisIdType, ptopoConnRowStatus=ptopoConnRowStatus, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoConnRemotePort=ptopoConnRemotePort, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoGroups=ptopoGroups, ptopoData=ptopoData)
