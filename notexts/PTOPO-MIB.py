...
TextualConvention, DisplayString, TimeStamp, AutonomousType, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "TimeStamp", "AutonomousType", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoConnRemotePort=ptopoConnRemotePort, PtopoPortIdType=PtopoPortIdType, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, PtopoChassisId=PtopoChassisId, PtopoGenAddr=PtopoGenAddr, ptopoConnIndex=ptopoConnIndex, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoGroups=ptopoGroups, ptopoConnTable=ptopoConnTable, ptopoDataGroup=ptopoDataGroup, PtopoChassisIdType=PtopoChassisIdType, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoConfigChange=ptopoConfigChange, ptopoConfig=ptopoConfig, ptopoConnTabDrops=ptopoConnTabDrops, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, PtopoPortId=PtopoPortId, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConformance=ptopoConformance, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoCompliance=ptopoCompliance, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoConnTabInserts=ptopoConnTabInserts, ptopoConfigGroup=ptopoConfigGroup, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoGeneral=ptopoGeneral, ptopoConnEntry=ptopoConnEntry, ptopoCompliances=ptopoCompliances, ptopoMIBObjects=ptopoMIBObjects, ptopoMIBNotifications=ptopoMIBNotifications, PtopoAddrSeenState=PtopoAddrSeenState, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoRegistrationPoints=ptopoRegistrationPoints, PYSNMP_MODULE_ID=ptopoMIB, ptopoGeneralGroup=ptopoGeneralGroup, ptopoData=ptopoData, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConnRowStatus=ptopoConnRowStatus, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoMIB=ptopoMIB, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen)
