...
AutonomousType, RowStatus, DisplayString, TimeStamp, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowStatus", "DisplayString", "TimeStamp", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoDataGroup=ptopoDataGroup, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoConnIsStatic=ptopoConnIsStatic, ptopoCompliance=ptopoCompliance, ptopoConfigChange=ptopoConfigChange, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConnTimeMark=ptopoConnTimeMark, ptopoMIB=ptopoMIB, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoConnRemotePort=ptopoConnRemotePort, ptopoConnLocalPort=ptopoConnLocalPort, ptopoMIBNotifications=ptopoMIBNotifications, ptopoGeneral=ptopoGeneral, ptopoRegistrationPoints=ptopoRegistrationPoints, PtopoPortId=PtopoPortId, PtopoChassisId=PtopoChassisId, ptopoGeneralGroup=ptopoGeneralGroup, ptopoData=ptopoData, PtopoPortIdType=PtopoPortIdType, ptopoConnTabDeletes=ptopoConnTabDeletes, PtopoChassisIdType=PtopoChassisIdType, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, PtopoAddrSeenState=PtopoAddrSeenState, ptopoGroups=ptopoGroups, ptopoConformance=ptopoConformance, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoConnRowStatus=ptopoConnRowStatus, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConnTable=ptopoConnTable, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoConfig=ptopoConfig, ptopoCompliances=ptopoCompliances, ptopoConnIndex=ptopoConnIndex, ptopoConnTabInserts=ptopoConnTabInserts, ptopoConnEntry=ptopoConnEntry, ptopoMIBObjects=ptopoMIBObjects, ptopoConfigGroup=ptopoConfigGroup, PtopoGenAddr=PtopoGenAddr, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoConnTabDrops=ptopoConnTabDrops, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoLastChangeTime=ptopoLastChangeTime, PYSNMP_MODULE_ID=ptopoMIB)
