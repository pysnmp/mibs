...
TextualConvention, TimeStamp, AutonomousType, DisplayString, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "AutonomousType", "DisplayString", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoGeneralGroup=ptopoGeneralGroup, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoConnRemotePort=ptopoConnRemotePort, ptopoConnTabInserts=ptopoConnTabInserts, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoConnRowStatus=ptopoConnRowStatus, ptopoMIB=ptopoMIB, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, PtopoPortId=PtopoPortId, ptopoConnEntry=ptopoConnEntry, PYSNMP_MODULE_ID=ptopoMIB, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoConnIndex=ptopoConnIndex, ptopoCompliance=ptopoCompliance, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoConnTabDrops=ptopoConnTabDrops, PtopoChassisId=PtopoChassisId, ptopoLastChangeTime=ptopoLastChangeTime, ptopoMIBObjects=ptopoMIBObjects, PtopoAddrSeenState=PtopoAddrSeenState, ptopoGroups=ptopoGroups, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoDataGroup=ptopoDataGroup, PtopoGenAddr=PtopoGenAddr, ptopoData=ptopoData, PtopoPortIdType=PtopoPortIdType, ptopoConnTimeMark=ptopoConnTimeMark, ptopoGeneral=ptopoGeneral, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConformance=ptopoConformance, ptopoConfig=ptopoConfig, ptopoConfigChange=ptopoConfigChange, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoCompliances=ptopoCompliances, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoMIBNotifications=ptopoMIBNotifications, ptopoConnTable=ptopoConnTable, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoConfigGroup=ptopoConfigGroup, PtopoChassisIdType=PtopoChassisIdType)
