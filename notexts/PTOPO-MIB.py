...
DisplayString, RowStatus, AutonomousType, TruthValue, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "AutonomousType", "TruthValue", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoGeneral=ptopoGeneral, PtopoChassisId=PtopoChassisId, ptopoConnRowStatus=ptopoConnRowStatus, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoGroups=ptopoGroups, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoMIB=ptopoMIB, ptopoConnRemoteChassis=ptopoConnRemoteChassis, PtopoAddrSeenState=PtopoAddrSeenState, ptopoConnTable=ptopoConnTable, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoCompliance=ptopoCompliance, PtopoPortId=PtopoPortId, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoConfigChange=ptopoConfigChange, ptopoConnEntry=ptopoConnEntry, PYSNMP_MODULE_ID=ptopoMIB, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoConnRemotePort=ptopoConnRemotePort, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoConformance=ptopoConformance, ptopoConnTabInserts=ptopoConnTabInserts, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoMIBObjects=ptopoMIBObjects, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoDataGroup=ptopoDataGroup, PtopoGenAddr=PtopoGenAddr, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConfigGroup=ptopoConfigGroup, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoData=ptopoData, PtopoChassisIdType=PtopoChassisIdType, ptopoConnIndex=ptopoConnIndex, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoGeneralGroup=ptopoGeneralGroup, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoCompliances=ptopoCompliances, ptopoConnTabDrops=ptopoConnTabDrops, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConfig=ptopoConfig, PtopoPortIdType=PtopoPortIdType, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoMIBNotifications=ptopoMIBNotifications)
