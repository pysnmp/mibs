...
TextualConvention, DisplayString, RowStatus, TimeStamp, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "RowStatus", "TimeStamp", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoConnTabDrops=ptopoConnTabDrops, ptopoDataGroup=ptopoDataGroup, ptopoCompliance=ptopoCompliance, ptopoConfig=ptopoConfig, ptopoConnTabInserts=ptopoConnTabInserts, ptopoGeneral=ptopoGeneral, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoConnLocalChassis=ptopoConnLocalChassis, PYSNMP_MODULE_ID=ptopoMIB, ptopoConnTable=ptopoConnTable, ptopoConnRowStatus=ptopoConnRowStatus, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConnRemotePort=ptopoConnRemotePort, ptopoConformance=ptopoConformance, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoMIBObjects=ptopoMIBObjects, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoMIBNotifications=ptopoMIBNotifications, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoConfigChange=ptopoConfigChange, ptopoGeneralGroup=ptopoGeneralGroup, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoGroups=ptopoGroups, PtopoPortIdType=PtopoPortIdType, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConnEntry=ptopoConnEntry, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, PtopoGenAddr=PtopoGenAddr, ptopoCompliances=ptopoCompliances, ptopoData=ptopoData, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, PtopoAddrSeenState=PtopoAddrSeenState, PtopoChassisIdType=PtopoChassisIdType, ptopoConnRemoteChassis=ptopoConnRemoteChassis, PtopoChassisId=PtopoChassisId, ptopoConfigGroup=ptopoConfigGroup, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoConnIndex=ptopoConnIndex, ptopoLastChangeTime=ptopoLastChangeTime, PtopoPortId=PtopoPortId, ptopoMIB=ptopoMIB)
