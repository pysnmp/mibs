...
DisplayString, TruthValue, AutonomousType, TextualConvention, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "AutonomousType", "TextualConvention", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoConnRemotePort=ptopoConnRemotePort, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoConnRowStatus=ptopoConnRowStatus, ptopoConfigTrapInterval=ptopoConfigTrapInterval, PtopoAddrSeenState=PtopoAddrSeenState, ptopoCompliance=ptopoCompliance, ptopoDataGroup=ptopoDataGroup, ptopoConnEntry=ptopoConnEntry, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoConnIndex=ptopoConnIndex, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoConformance=ptopoConformance, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoGroups=ptopoGroups, PtopoGenAddr=PtopoGenAddr, PYSNMP_MODULE_ID=ptopoMIB, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoConfig=ptopoConfig, ptopoConfigChange=ptopoConfigChange, ptopoGeneral=ptopoGeneral, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, PtopoPortIdType=PtopoPortIdType, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoGeneralGroup=ptopoGeneralGroup, PtopoChassisIdType=PtopoChassisIdType, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConnTabDeletes=ptopoConnTabDeletes, PtopoChassisId=PtopoChassisId, ptopoConnTabDrops=ptopoConnTabDrops, ptopoMIBNotifications=ptopoMIBNotifications, ptopoCompliances=ptopoCompliances, ptopoMIB=ptopoMIB, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConfigGroup=ptopoConfigGroup, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoConnTable=ptopoConnTable, ptopoMIBObjects=ptopoMIBObjects, PtopoPortId=PtopoPortId, ptopoConnLocalPort=ptopoConnLocalPort, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoConnTimeMark=ptopoConnTimeMark, ptopoData=ptopoData, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConnTabInserts=ptopoConnTabInserts)
