...
TimeStamp, TruthValue, AutonomousType, RowStatus, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "AutonomousType", "RowStatus", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoConnTable=ptopoConnTable, PtopoAddrSeenState=PtopoAddrSeenState, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoConnIndex=ptopoConnIndex, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoConnTabInserts=ptopoConnTabInserts, ptopoConfigGroup=ptopoConfigGroup, PtopoChassisId=PtopoChassisId, ptopoConformance=ptopoConformance, ptopoCompliance=ptopoCompliance, PtopoPortIdType=PtopoPortIdType, ptopoMIBNotifications=ptopoMIBNotifications, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, PYSNMP_MODULE_ID=ptopoMIB, ptopoGeneralGroup=ptopoGeneralGroup, ptopoConnRowStatus=ptopoConnRowStatus, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConnEntry=ptopoConnEntry, ptopoConfigChange=ptopoConfigChange, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoConfig=ptopoConfig, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoConnRemotePort=ptopoConnRemotePort, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoGeneral=ptopoGeneral, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoGroups=ptopoGroups, PtopoPortId=PtopoPortId, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, PtopoGenAddr=PtopoGenAddr, ptopoConnTabDrops=ptopoConnTabDrops, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoCompliances=ptopoCompliances, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoDataGroup=ptopoDataGroup, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoMIB=ptopoMIB, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoNotificationsGroup=ptopoNotificationsGroup, PtopoChassisIdType=PtopoChassisIdType, ptopoData=ptopoData, ptopoMIBObjects=ptopoMIBObjects)
