...
TruthValue, AutonomousType, DisplayString, TextualConvention, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "AutonomousType", "DisplayString", "TextualConvention", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("PTOPO-MIB", PtopoGenAddr=PtopoGenAddr, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoConfigGroup=ptopoConfigGroup, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, PtopoAddrSeenState=PtopoAddrSeenState, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoGroups=ptopoGroups, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConnTabDrops=ptopoConnTabDrops, ptopoConnRemotePort=ptopoConnRemotePort, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, PtopoPortId=PtopoPortId, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoConfigChange=ptopoConfigChange, ptopoMIBObjects=ptopoMIBObjects, ptopoConfig=ptopoConfig, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoGeneral=ptopoGeneral, PtopoPortIdType=PtopoPortIdType, ptopoMIBNotifications=ptopoMIBNotifications, ptopoCompliances=ptopoCompliances, ptopoConnIndex=ptopoConnIndex, ptopoMIB=ptopoMIB, ptopoConnTable=ptopoConnTable, ptopoData=ptopoData, ptopoConformance=ptopoConformance, ptopoConnTabDeletes=ptopoConnTabDeletes, PYSNMP_MODULE_ID=ptopoMIB, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConnRowStatus=ptopoConnRowStatus, ptopoConnTabInserts=ptopoConnTabInserts, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoDataGroup=ptopoDataGroup, ptopoGeneralGroup=ptopoGeneralGroup, PtopoChassisIdType=PtopoChassisIdType, ptopoConnEntry=ptopoConnEntry, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoConnRemotePortType=ptopoConnRemotePortType, PtopoChassisId=PtopoChassisId, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoCompliance=ptopoCompliance, ptopoLastChangeTime=ptopoLastChangeTime, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime)
