...
AutonomousType, RowStatus, TruthValue, TextualConvention, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowStatus", "TruthValue", "TextualConvention", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoGeneralGroup=ptopoGeneralGroup, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConfigGroup=ptopoConfigGroup, ptopoConformance=ptopoConformance, ptopoConnTable=ptopoConnTable, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, PtopoPortId=PtopoPortId, ptopoConfigChange=ptopoConfigChange, ptopoConnRemotePort=ptopoConnRemotePort, ptopoMIBObjects=ptopoMIBObjects, ptopoCompliance=ptopoCompliance, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConnIndex=ptopoConnIndex, ptopoData=ptopoData, ptopoConnTabDrops=ptopoConnTabDrops, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoGroups=ptopoGroups, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoConnTabInserts=ptopoConnTabInserts, PtopoChassisIdType=PtopoChassisIdType, ptopoConfigTrapInterval=ptopoConfigTrapInterval, PtopoGenAddr=PtopoGenAddr, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoDataGroup=ptopoDataGroup, ptopoConnTimeMark=ptopoConnTimeMark, PYSNMP_MODULE_ID=ptopoMIB, ptopoGeneral=ptopoGeneral, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoConfig=ptopoConfig, ptopoMIB=ptopoMIB, ptopoConnEntry=ptopoConnEntry, PtopoPortIdType=PtopoPortIdType, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoConnRowStatus=ptopoConnRowStatus, ptopoLastChangeTime=ptopoLastChangeTime, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoMIBNotifications=ptopoMIBNotifications, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoCompliances=ptopoCompliances, ptopoConnLocalPort=ptopoConnLocalPort, PtopoAddrSeenState=PtopoAddrSeenState, ptopoConnTabDeletes=ptopoConnTabDeletes, PtopoChassisId=PtopoChassisId)
