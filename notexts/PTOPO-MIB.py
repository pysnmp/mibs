...
RowStatus, TruthValue, AutonomousType, DisplayString, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TruthValue", "AutonomousType", "DisplayString", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoCompliance=ptopoCompliance, PtopoGenAddr=PtopoGenAddr, ptopoConnTable=ptopoConnTable, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConnTabInserts=ptopoConnTabInserts, ptopoNotificationsGroup=ptopoNotificationsGroup, PtopoChassisId=PtopoChassisId, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConformance=ptopoConformance, PtopoChassisIdType=PtopoChassisIdType, PtopoAddrSeenState=PtopoAddrSeenState, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoDataGroup=ptopoDataGroup, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoConnEntry=ptopoConnEntry, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoGeneral=ptopoGeneral, ptopoConnTabDrops=ptopoConnTabDrops, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, PtopoPortIdType=PtopoPortIdType, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoGeneralGroup=ptopoGeneralGroup, ptopoCompliances=ptopoCompliances, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoConfigGroup=ptopoConfigGroup, ptopoConnIndex=ptopoConnIndex, ptopoMIB=ptopoMIB, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoConnTabAgeouts=ptopoConnTabAgeouts, PYSNMP_MODULE_ID=ptopoMIB, ptopoMIBObjects=ptopoMIBObjects, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConnRowStatus=ptopoConnRowStatus, ptopoGroups=ptopoGroups, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoMIBNotifications=ptopoMIBNotifications, ptopoConnRemotePort=ptopoConnRemotePort, ptopoConfig=ptopoConfig, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoConfigChange=ptopoConfigChange, ptopoData=ptopoData, PtopoPortId=PtopoPortId)
