...
AutonomousType, DisplayString, TextualConvention, RowStatus, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "DisplayString", "TextualConvention", "RowStatus", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoConformance=ptopoConformance, PYSNMP_MODULE_ID=ptopoMIB, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoMIB=ptopoMIB, ptopoDataGroup=ptopoDataGroup, PtopoPortId=PtopoPortId, ptopoConnRowStatus=ptopoConnRowStatus, ptopoConnTabDrops=ptopoConnTabDrops, ptopoConnIndex=ptopoConnIndex, PtopoChassisIdType=PtopoChassisIdType, ptopoData=ptopoData, ptopoCompliance=ptopoCompliance, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoConnTable=ptopoConnTable, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoCompliances=ptopoCompliances, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, PtopoPortIdType=PtopoPortIdType, ptopoMIBNotifications=ptopoMIBNotifications, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoGroups=ptopoGroups, ptopoConfigGroup=ptopoConfigGroup, PtopoAddrSeenState=PtopoAddrSeenState, ptopoConnTabInserts=ptopoConnTabInserts, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConnRemotePort=ptopoConnRemotePort, ptopoLastChangeTime=ptopoLastChangeTime, ptopoMIBObjects=ptopoMIBObjects, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoGeneralGroup=ptopoGeneralGroup, ptopoConnEntry=ptopoConnEntry, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoConfig=ptopoConfig, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConfigChange=ptopoConfigChange, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConnIsStatic=ptopoConnIsStatic, PtopoGenAddr=PtopoGenAddr, ptopoGeneral=ptopoGeneral, PtopoChassisId=PtopoChassisId, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoNotificationsGroup=ptopoNotificationsGroup)
