...
TruthValue, TextualConvention, RowStatus, TimeStamp, DisplayString, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "RowStatus", "TimeStamp", "DisplayString", "AutonomousType")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoConfigGroup=ptopoConfigGroup, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, PtopoAddrSeenState=PtopoAddrSeenState, ptopoDataGroup=ptopoDataGroup, PtopoGenAddr=PtopoGenAddr, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConnTabInserts=ptopoConnTabInserts, ptopoCompliance=ptopoCompliance, ptopoConfig=ptopoConfig, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoCompliances=ptopoCompliances, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoConnRowStatus=ptopoConnRowStatus, ptopoMIBNotifications=ptopoMIBNotifications, ptopoConnTable=ptopoConnTable, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConnRemotePort=ptopoConnRemotePort, PtopoChassisId=PtopoChassisId, ptopoConnTabDrops=ptopoConnTabDrops, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConfigChange=ptopoConfigChange, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoGeneralGroup=ptopoGeneralGroup, ptopoConnIndex=ptopoConnIndex, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoConnRemoteChassis=ptopoConnRemoteChassis, PtopoPortIdType=PtopoPortIdType, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoMIBObjects=ptopoMIBObjects, PtopoPortId=PtopoPortId, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConnTimeMark=ptopoConnTimeMark, ptopoData=ptopoData, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoConnEntry=ptopoConnEntry, ptopoGroups=ptopoGroups, ptopoRegistrationPoints=ptopoRegistrationPoints, PtopoChassisIdType=PtopoChassisIdType, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConformance=ptopoConformance, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoGeneral=ptopoGeneral, ptopoMIB=ptopoMIB, ptopoConnRemotePortType=ptopoConnRemotePortType, PYSNMP_MODULE_ID=ptopoMIB)
