...
DisplayString, AutonomousType, TimeStamp, RowStatus, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "AutonomousType", "TimeStamp", "RowStatus", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoDataGroup=ptopoDataGroup, ptopoGroups=ptopoGroups, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoCompliances=ptopoCompliances, PtopoGenAddr=PtopoGenAddr, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoConnTabDrops=ptopoConnTabDrops, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoConfigChange=ptopoConfigChange, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoConfigGroup=ptopoConfigGroup, ptopoRegistrationPoints=ptopoRegistrationPoints, PtopoAddrSeenState=PtopoAddrSeenState, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoData=ptopoData, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoMIB=ptopoMIB, PtopoPortId=PtopoPortId, ptopoConnLocalPort=ptopoConnLocalPort, ptopoMIBNotifications=ptopoMIBNotifications, PtopoPortIdType=PtopoPortIdType, ptopoGeneral=ptopoGeneral, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoConnTabInserts=ptopoConnTabInserts, ptopoConnTable=ptopoConnTable, ptopoConfig=ptopoConfig, ptopoConnRowStatus=ptopoConnRowStatus, PtopoChassisIdType=PtopoChassisIdType, ptopoConformance=ptopoConformance, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoMIBObjects=ptopoMIBObjects, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoConnRemotePort=ptopoConnRemotePort, ptopoGeneralGroup=ptopoGeneralGroup, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoCompliance=ptopoCompliance, PYSNMP_MODULE_ID=ptopoMIB, PtopoChassisId=PtopoChassisId, ptopoConnEntry=ptopoConnEntry, ptopoConnIndex=ptopoConnIndex)
