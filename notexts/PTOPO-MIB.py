...
TruthValue, RowStatus, TimeStamp, AutonomousType, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "TimeStamp", "AutonomousType", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoConnTabInserts=ptopoConnTabInserts, ptopoMIBNotifications=ptopoMIBNotifications, ptopoConnRemotePort=ptopoConnRemotePort, PtopoAddrSeenState=PtopoAddrSeenState, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoConfigGroup=ptopoConfigGroup, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConnIndex=ptopoConnIndex, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoCompliances=ptopoCompliances, PtopoPortId=PtopoPortId, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConnRowStatus=ptopoConnRowStatus, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoConnTable=ptopoConnTable, PtopoChassisIdType=PtopoChassisIdType, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConnEntry=ptopoConnEntry, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoDataGroup=ptopoDataGroup, PYSNMP_MODULE_ID=ptopoMIB, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoMIB=ptopoMIB, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoConnLocalPort=ptopoConnLocalPort, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoConfig=ptopoConfig, PtopoPortIdType=PtopoPortIdType, ptopoData=ptopoData, ptopoMIBObjects=ptopoMIBObjects, PtopoGenAddr=PtopoGenAddr, ptopoConfigChange=ptopoConfigChange, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoConformance=ptopoConformance, ptopoGroups=ptopoGroups, ptopoCompliance=ptopoCompliance, ptopoGeneral=ptopoGeneral, ptopoConnTabDrops=ptopoConnTabDrops, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoGeneralGroup=ptopoGeneralGroup, PtopoChassisId=PtopoChassisId)
