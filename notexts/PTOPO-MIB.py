...
TimeStamp, RowStatus, AutonomousType, TextualConvention, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "AutonomousType", "TextualConvention", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("PTOPO-MIB", PtopoPortId=PtopoPortId, ptopoConnRemotePort=ptopoConnRemotePort, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConfigGroup=ptopoConfigGroup, ptopoMIB=ptopoMIB, ptopoConnIndex=ptopoConnIndex, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoConformance=ptopoConformance, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoConfigChange=ptopoConfigChange, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, PtopoAddrSeenState=PtopoAddrSeenState, ptopoData=ptopoData, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoConnLocalPort=ptopoConnLocalPort, PtopoGenAddr=PtopoGenAddr, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConnEntry=ptopoConnEntry, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, PtopoChassisId=PtopoChassisId, ptopoDataGroup=ptopoDataGroup, ptopoMIBObjects=ptopoMIBObjects, ptopoConnIsStatic=ptopoConnIsStatic, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoCompliance=ptopoCompliance, ptopoConnRowStatus=ptopoConnRowStatus, ptopoMIBNotifications=ptopoMIBNotifications, ptopoGroups=ptopoGroups, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoCompliances=ptopoCompliances, PYSNMP_MODULE_ID=ptopoMIB, PtopoPortIdType=PtopoPortIdType, ptopoConnTabInserts=ptopoConnTabInserts, ptopoGeneralGroup=ptopoGeneralGroup, PtopoChassisIdType=PtopoChassisIdType, ptopoConnTable=ptopoConnTable, ptopoConfig=ptopoConfig, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoGeneral=ptopoGeneral, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoConnTabDrops=ptopoConnTabDrops)
