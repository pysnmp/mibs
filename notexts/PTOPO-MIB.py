...
AutonomousType, RowStatus, DisplayString, TimeStamp, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowStatus", "DisplayString", "TimeStamp", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoMIBNotifications=ptopoMIBNotifications, ptopoConnRemotePort=ptopoConnRemotePort, ptopoConfigChange=ptopoConfigChange, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConnIsStatic=ptopoConnIsStatic, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoConnTabDrops=ptopoConnTabDrops, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoConnEntry=ptopoConnEntry, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoConformance=ptopoConformance, PtopoGenAddr=PtopoGenAddr, PtopoAddrSeenState=PtopoAddrSeenState, ptopoConnTable=ptopoConnTable, ptopoConnRowStatus=ptopoConnRowStatus, ptopoGeneralGroup=ptopoGeneralGroup, ptopoConfig=ptopoConfig, ptopoMIB=ptopoMIB, ptopoConnTabInserts=ptopoConnTabInserts, PtopoChassisIdType=PtopoChassisIdType, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoMIBObjects=ptopoMIBObjects, PtopoChassisId=PtopoChassisId, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoGroups=ptopoGroups, ptopoConfigGroup=ptopoConfigGroup, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoConnLocalPort=ptopoConnLocalPort, PtopoPortId=PtopoPortId, ptopoCompliances=ptopoCompliances, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoGeneral=ptopoGeneral, PtopoPortIdType=PtopoPortIdType, ptopoData=ptopoData, PYSNMP_MODULE_ID=ptopoMIB, ptopoCompliance=ptopoCompliance, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoConnIndex=ptopoConnIndex, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoDataGroup=ptopoDataGroup, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType)
