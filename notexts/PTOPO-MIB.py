...
DisplayString, TextualConvention, AutonomousType, TimeStamp, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "AutonomousType", "TimeStamp", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConnTabDrops=ptopoConnTabDrops, ptopoConfig=ptopoConfig, PYSNMP_MODULE_ID=ptopoMIB, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoRegistrationPoints=ptopoRegistrationPoints, PtopoChassisIdType=PtopoChassisIdType, PtopoPortId=PtopoPortId, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoConnIndex=ptopoConnIndex, ptopoConnTabInserts=ptopoConnTabInserts, PtopoChassisId=PtopoChassisId, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConformance=ptopoConformance, PtopoGenAddr=PtopoGenAddr, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConnRowStatus=ptopoConnRowStatus, ptopoLastChangeTime=ptopoLastChangeTime, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoGeneral=ptopoGeneral, ptopoMIBNotifications=ptopoMIBNotifications, ptopoConfigChange=ptopoConfigChange, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoConnEntry=ptopoConnEntry, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoMIBObjects=ptopoMIBObjects, ptopoConnLocalPort=ptopoConnLocalPort, PtopoAddrSeenState=PtopoAddrSeenState, ptopoDataGroup=ptopoDataGroup, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoCompliances=ptopoCompliances, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoConnTable=ptopoConnTable, ptopoConnRemotePort=ptopoConnRemotePort, ptopoGroups=ptopoGroups, ptopoData=ptopoData, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoCompliance=ptopoCompliance, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoMIB=ptopoMIB, ptopoGeneralGroup=ptopoGeneralGroup, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoConfigGroup=ptopoConfigGroup, PtopoPortIdType=PtopoPortIdType)
