...
DisplayString, TruthValue, TextualConvention, RowStatus, AutonomousType, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "TextualConvention", "RowStatus", "AutonomousType", "TimeStamp")
...
mibBuilder.exportSymbols("PTOPO-MIB", PtopoChassisIdType=PtopoChassisIdType, ptopoConnTabInserts=ptopoConnTabInserts, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoConfigGroup=ptopoConfigGroup, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoConfig=ptopoConfig, PtopoAddrSeenState=PtopoAddrSeenState, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoMIBNotifications=ptopoMIBNotifications, PtopoGenAddr=PtopoGenAddr, ptopoConnRemotePort=ptopoConnRemotePort, PtopoPortIdType=PtopoPortIdType, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConnRowStatus=ptopoConnRowStatus, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoConformance=ptopoConformance, ptopoMIB=ptopoMIB, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoCompliance=ptopoCompliance, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoConfigChange=ptopoConfigChange, ptopoMIBObjects=ptopoMIBObjects, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoConnIndex=ptopoConnIndex, ptopoDataGroup=ptopoDataGroup, ptopoConnIsStatic=ptopoConnIsStatic, ptopoCompliances=ptopoCompliances, ptopoGeneral=ptopoGeneral, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConnTable=ptopoConnTable, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoData=ptopoData, ptopoConnTabDrops=ptopoConnTabDrops, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, PtopoPortId=PtopoPortId, ptopoGroups=ptopoGroups, ptopoConnEntry=ptopoConnEntry, PYSNMP_MODULE_ID=ptopoMIB, PtopoChassisId=PtopoChassisId, ptopoGeneralGroup=ptopoGeneralGroup)
