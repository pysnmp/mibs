...
TruthValue, DisplayString, TextualConvention, AutonomousType, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "TextualConvention", "AutonomousType", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoNotificationsGroup=ptopoNotificationsGroup, PtopoPortIdType=PtopoPortIdType, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConnTimeMark=ptopoConnTimeMark, PtopoChassisId=PtopoChassisId, ptopoCompliances=ptopoCompliances, ptopoConnTabDeletes=ptopoConnTabDeletes, PtopoChassisIdType=PtopoChassisIdType, ptopoConnRowStatus=ptopoConnRowStatus, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, PtopoAddrSeenState=PtopoAddrSeenState, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoConnRemotePort=ptopoConnRemotePort, ptopoGeneralGroup=ptopoGeneralGroup, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoConnEntry=ptopoConnEntry, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoGeneral=ptopoGeneral, ptopoConnIndex=ptopoConnIndex, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoConfigChange=ptopoConfigChange, ptopoMIBObjects=ptopoMIBObjects, ptopoMIBNotifications=ptopoMIBNotifications, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConnTabInserts=ptopoConnTabInserts, PtopoPortId=PtopoPortId, ptopoConnIsStatic=ptopoConnIsStatic, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoData=ptopoData, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoCompliance=ptopoCompliance, ptopoConfig=ptopoConfig, ptopoDataGroup=ptopoDataGroup, ptopoConfigGroup=ptopoConfigGroup, PYSNMP_MODULE_ID=ptopoMIB, ptopoMIB=ptopoMIB, ptopoConformance=ptopoConformance, PtopoGenAddr=PtopoGenAddr, ptopoConnTabDrops=ptopoConnTabDrops, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoConnTable=ptopoConnTable, ptopoGroups=ptopoGroups, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms)
