...
DisplayString, AutonomousType, TextualConvention, RowStatus, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "AutonomousType", "TextualConvention", "RowStatus", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoGeneral=ptopoGeneral, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoMIBObjects=ptopoMIBObjects, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoConfigGroup=ptopoConfigGroup, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoConnTabInserts=ptopoConnTabInserts, ptopoConnIsStatic=ptopoConnIsStatic, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoConnTable=ptopoConnTable, ptopoData=ptopoData, ptopoConnIndex=ptopoConnIndex, ptopoMIB=ptopoMIB, PtopoChassisId=PtopoChassisId, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoCompliances=ptopoCompliances, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoDataGroup=ptopoDataGroup, PtopoPortIdType=PtopoPortIdType, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConfigChange=ptopoConfigChange, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoGroups=ptopoGroups, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConnTabDrops=ptopoConnTabDrops, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoCompliance=ptopoCompliance, ptopoGeneralGroup=ptopoGeneralGroup, ptopoLastChangeTime=ptopoLastChangeTime, PtopoGenAddr=PtopoGenAddr, ptopoConnLocalChassis=ptopoConnLocalChassis, PtopoAddrSeenState=PtopoAddrSeenState, PtopoChassisIdType=PtopoChassisIdType, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoConnRemotePort=ptopoConnRemotePort, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoConnRowStatus=ptopoConnRowStatus, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, PYSNMP_MODULE_ID=ptopoMIB, ptopoMIBNotifications=ptopoMIBNotifications, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConformance=ptopoConformance, ptopoConfig=ptopoConfig, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, PtopoPortId=PtopoPortId, ptopoConnEntry=ptopoConnEntry)
