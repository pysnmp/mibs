...
TimeStamp, TruthValue, TextualConvention, RowStatus, DisplayString, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "TextualConvention", "RowStatus", "DisplayString", "AutonomousType")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoConnTabDrops=ptopoConnTabDrops, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, PtopoAddrSeenState=PtopoAddrSeenState, ptopoGroups=ptopoGroups, ptopoGeneral=ptopoGeneral, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoMIB=ptopoMIB, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoGeneralGroup=ptopoGeneralGroup, ptopoConnEntry=ptopoConnEntry, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoConnRowStatus=ptopoConnRowStatus, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoConfigGroup=ptopoConfigGroup, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoMIBNotifications=ptopoMIBNotifications, PtopoChassisIdType=PtopoChassisIdType, ptopoCompliances=ptopoCompliances, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, PtopoPortIdType=PtopoPortIdType, ptopoConnIndex=ptopoConnIndex, PtopoChassisId=PtopoChassisId, ptopoData=ptopoData, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoCompliance=ptopoCompliance, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoConnTable=ptopoConnTable, ptopoMIBObjects=ptopoMIBObjects, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoConnTabInserts=ptopoConnTabInserts, ptopoConfigChange=ptopoConfigChange, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoDataGroup=ptopoDataGroup, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoConformance=ptopoConformance, ptopoConfigTrapInterval=ptopoConfigTrapInterval, PYSNMP_MODULE_ID=ptopoMIB, PtopoPortId=PtopoPortId, ptopoConnLocalChassis=ptopoConnLocalChassis, PtopoGenAddr=PtopoGenAddr, ptopoConfig=ptopoConfig, ptopoConnRemotePort=ptopoConnRemotePort)
