...
TextualConvention, TimeStamp, AutonomousType, RowStatus, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "AutonomousType", "RowStatus", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoLastChangeTime=ptopoLastChangeTime, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, PtopoGenAddr=PtopoGenAddr, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoGeneralGroup=ptopoGeneralGroup, ptopoConnIndex=ptopoConnIndex, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoGroups=ptopoGroups, ptopoDataGroup=ptopoDataGroup, PtopoAddrSeenState=PtopoAddrSeenState, PtopoChassisId=PtopoChassisId, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoConfig=ptopoConfig, ptopoConnTabInserts=ptopoConnTabInserts, ptopoConnEntry=ptopoConnEntry, PtopoPortIdType=PtopoPortIdType, ptopoMIB=ptopoMIB, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConformance=ptopoConformance, ptopoCompliances=ptopoCompliances, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoConnTimeMark=ptopoConnTimeMark, ptopoData=ptopoData, ptopoConnRowStatus=ptopoConnRowStatus, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoMIBNotifications=ptopoMIBNotifications, PYSNMP_MODULE_ID=ptopoMIB, PtopoChassisIdType=PtopoChassisIdType, ptopoConnRemotePort=ptopoConnRemotePort, ptopoConfigGroup=ptopoConfigGroup, ptopoMIBObjects=ptopoMIBObjects, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoGeneral=ptopoGeneral, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoCompliance=ptopoCompliance, ptopoConnTabDrops=ptopoConnTabDrops, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConfigChange=ptopoConfigChange, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoConnTable=ptopoConnTable, ptopoConnRemoteChassis=ptopoConnRemoteChassis, PtopoPortId=PtopoPortId)
