...
TruthValue, DisplayString, AutonomousType, TextualConvention, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "AutonomousType", "TextualConvention", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("PTOPO-MIB", PtopoPortIdType=PtopoPortIdType, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoGeneral=ptopoGeneral, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConfigChange=ptopoConfigChange, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoCompliances=ptopoCompliances, ptopoConfig=ptopoConfig, PYSNMP_MODULE_ID=ptopoMIB, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoDataGroup=ptopoDataGroup, ptopoMIB=ptopoMIB, ptopoMIBObjects=ptopoMIBObjects, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoGeneralGroup=ptopoGeneralGroup, ptopoConformance=ptopoConformance, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoConnIndex=ptopoConnIndex, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoMIBNotifications=ptopoMIBNotifications, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoGroups=ptopoGroups, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoConnTabDrops=ptopoConnTabDrops, PtopoChassisId=PtopoChassisId, ptopoConnTimeMark=ptopoConnTimeMark, PtopoGenAddr=PtopoGenAddr, ptopoConnRemotePort=ptopoConnRemotePort, ptopoConnTabInserts=ptopoConnTabInserts, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoConnEntry=ptopoConnEntry, PtopoAddrSeenState=PtopoAddrSeenState, ptopoConnTable=ptopoConnTable, ptopoConfigGroup=ptopoConfigGroup, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoLastChangeTime=ptopoLastChangeTime, PtopoChassisIdType=PtopoChassisIdType, ptopoConnLocalPort=ptopoConnLocalPort, ptopoCompliance=ptopoCompliance, ptopoData=ptopoData, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, PtopoPortId=PtopoPortId, ptopoConnRowStatus=ptopoConnRowStatus, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoConnTabDeletes=ptopoConnTabDeletes)
