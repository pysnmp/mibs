...
DisplayString, TimeStamp, AutonomousType, TruthValue, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "AutonomousType", "TruthValue", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoConnIndex=ptopoConnIndex, ptopoCompliances=ptopoCompliances, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoConnEntry=ptopoConnEntry, PtopoPortId=PtopoPortId, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConnTable=ptopoConnTable, ptopoMIBNotifications=ptopoMIBNotifications, ptopoGroups=ptopoGroups, ptopoConnRemoteChassis=ptopoConnRemoteChassis, PtopoChassisIdType=PtopoChassisIdType, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, PYSNMP_MODULE_ID=ptopoMIB, ptopoConnRemotePort=ptopoConnRemotePort, PtopoGenAddr=PtopoGenAddr, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConnRowStatus=ptopoConnRowStatus, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoDataGroup=ptopoDataGroup, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoData=ptopoData, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoConfig=ptopoConfig, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, PtopoChassisId=PtopoChassisId, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConnTabInserts=ptopoConnTabInserts, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConnTabDrops=ptopoConnTabDrops, ptopoConnIsStatic=ptopoConnIsStatic, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoMIB=ptopoMIB, ptopoConfigChange=ptopoConfigChange, ptopoCompliance=ptopoCompliance, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoGeneralGroup=ptopoGeneralGroup, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoConformance=ptopoConformance, PtopoPortIdType=PtopoPortIdType, ptopoConfigGroup=ptopoConfigGroup, PtopoAddrSeenState=PtopoAddrSeenState, ptopoMIBObjects=ptopoMIBObjects, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoGeneral=ptopoGeneral)
