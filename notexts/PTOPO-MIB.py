...
TimeStamp, AutonomousType, RowStatus, TruthValue, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "AutonomousType", "RowStatus", "TruthValue", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoCompliance=ptopoCompliance, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConfigChange=ptopoConfigChange, ptopoCompliances=ptopoCompliances, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoGeneral=ptopoGeneral, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, PtopoGenAddr=PtopoGenAddr, ptopoConnTabDrops=ptopoConnTabDrops, PtopoChassisId=PtopoChassisId, ptopoGeneralGroup=ptopoGeneralGroup, ptopoConnTabInserts=ptopoConnTabInserts, ptopoMIBObjects=ptopoMIBObjects, PYSNMP_MODULE_ID=ptopoMIB, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConformance=ptopoConformance, ptopoConfigGroup=ptopoConfigGroup, PtopoPortIdType=PtopoPortIdType, ptopoConnEntry=ptopoConnEntry, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoMIB=ptopoMIB, ptopoGroups=ptopoGroups, ptopoConnTable=ptopoConnTable, ptopoData=ptopoData, ptopoMIBNotifications=ptopoMIBNotifications, ptopoConfig=ptopoConfig, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoConnIndex=ptopoConnIndex, PtopoChassisIdType=PtopoChassisIdType, ptopoDiscoveryLocal=ptopoDiscoveryLocal, PtopoPortId=PtopoPortId, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoConnRowStatus=ptopoConnRowStatus, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, PtopoAddrSeenState=PtopoAddrSeenState, ptopoDataGroup=ptopoDataGroup, ptopoConnRemotePort=ptopoConnRemotePort, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType)
