...
TimeStamp, TextualConvention, TruthValue, RowStatus, DisplayString, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "TruthValue", "RowStatus", "DisplayString", "AutonomousType")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoMIBNotifications=ptopoMIBNotifications, ptopoConnIsStatic=ptopoConnIsStatic, PYSNMP_MODULE_ID=ptopoMIB, ptopoConnTabInserts=ptopoConnTabInserts, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConfigChange=ptopoConfigChange, ptopoConnTable=ptopoConnTable, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoConnRowStatus=ptopoConnRowStatus, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoGeneral=ptopoGeneral, ptopoDataGroup=ptopoDataGroup, ptopoData=ptopoData, PtopoGenAddr=PtopoGenAddr, PtopoAddrSeenState=PtopoAddrSeenState, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoConnLocalPort=ptopoConnLocalPort, PtopoChassisIdType=PtopoChassisIdType, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoConnEntry=ptopoConnEntry, PtopoPortIdType=PtopoPortIdType, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoMIB=ptopoMIB, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoMIBObjects=ptopoMIBObjects, ptopoConfig=ptopoConfig, ptopoConnRemotePort=ptopoConnRemotePort, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoConformance=ptopoConformance, PtopoChassisId=PtopoChassisId, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoConnIndex=ptopoConnIndex, ptopoGroups=ptopoGroups, ptopoGeneralGroup=ptopoGeneralGroup, ptopoCompliances=ptopoCompliances, ptopoConfigGroup=ptopoConfigGroup, PtopoPortId=PtopoPortId, ptopoCompliance=ptopoCompliance, ptopoConnTabDrops=ptopoConnTabDrops)
