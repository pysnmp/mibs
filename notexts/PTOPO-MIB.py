...
AutonomousType, TruthValue, RowStatus, DisplayString, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TruthValue", "RowStatus", "DisplayString", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoConfig=ptopoConfig, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoConnIsStatic=ptopoConnIsStatic, ptopoMIBNotifications=ptopoMIBNotifications, ptopoMIBObjects=ptopoMIBObjects, PYSNMP_MODULE_ID=ptopoMIB, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, PtopoAddrSeenState=PtopoAddrSeenState, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoDataGroup=ptopoDataGroup, PtopoChassisId=PtopoChassisId, PtopoPortIdType=PtopoPortIdType, ptopoConnEntry=ptopoConnEntry, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoGeneral=ptopoGeneral, ptopoConnTabDrops=ptopoConnTabDrops, ptopoGroups=ptopoGroups, ptopoConfigGroup=ptopoConfigGroup, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoCompliance=ptopoCompliance, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoConnRowStatus=ptopoConnRowStatus, PtopoPortId=PtopoPortId, PtopoChassisIdType=PtopoChassisIdType, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoConnTable=ptopoConnTable, ptopoMIB=ptopoMIB, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoConformance=ptopoConformance, ptopoConnTabInserts=ptopoConnTabInserts, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, PtopoGenAddr=PtopoGenAddr, ptopoGeneralGroup=ptopoGeneralGroup, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConfigChange=ptopoConfigChange, ptopoCompliances=ptopoCompliances, ptopoConnIndex=ptopoConnIndex, ptopoData=ptopoData, ptopoConnRemotePort=ptopoConnRemotePort, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType)
