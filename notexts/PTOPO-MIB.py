...
TruthValue, TimeStamp, TextualConvention, RowStatus, DisplayString, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "TextualConvention", "RowStatus", "DisplayString", "AutonomousType")
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoConnIsStatic=ptopoConnIsStatic, ptopoGroups=ptopoGroups, ptopoMIBObjects=ptopoMIBObjects, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoCompliances=ptopoCompliances, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoGeneral=ptopoGeneral, ptopoConnRemotePort=ptopoConnRemotePort, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, PtopoAddrSeenState=PtopoAddrSeenState, ptopoNotificationsGroup=ptopoNotificationsGroup, PtopoGenAddr=PtopoGenAddr, PtopoPortId=PtopoPortId, ptopoConformance=ptopoConformance, ptopoConnIndex=ptopoConnIndex, ptopoMIB=ptopoMIB, ptopoConnTable=ptopoConnTable, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, PYSNMP_MODULE_ID=ptopoMIB, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoDataGroup=ptopoDataGroup, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoConnTabInserts=ptopoConnTabInserts, PtopoChassisId=PtopoChassisId, ptopoCompliance=ptopoCompliance, ptopoData=ptopoData, ptopoConnTabDrops=ptopoConnTabDrops, PtopoChassisIdType=PtopoChassisIdType, ptopoConnRowStatus=ptopoConnRowStatus, ptopoConfigGroup=ptopoConfigGroup, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, PtopoPortIdType=PtopoPortIdType, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoGeneralGroup=ptopoGeneralGroup, ptopoConfig=ptopoConfig, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoConnEntry=ptopoConnEntry, ptopoConnTimeMark=ptopoConnTimeMark, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoConfigChange=ptopoConfigChange, ptopoMIBNotifications=ptopoMIBNotifications)
