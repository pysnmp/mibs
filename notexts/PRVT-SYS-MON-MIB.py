...
reportsL2IfacePort, reportsL2IfaceUnit, prvt_products, reportsIfJackIndex, reportsL2IfaceSlot = mibBuilder.importSymbols("PRVT-SWITCH-MIB", "reportsL2IfacePort", "reportsL2IfaceUnit", "prvt-products", "reportsIfJackIndex", "reportsL2IfaceSlot")
...
mibBuilder.exportSymbols("PRVT-SYS-MON-MIB", sysMonMIBGroups=sysMonMIBGroups, laserRxPowerHighThreshold=laserRxPowerHighThreshold, laserRxPowerLowThreshold=laserRxPowerLowThreshold, laserPortThresholdTable=laserPortThresholdTable, laserRxPower=laserRxPower, laserTemperature=laserTemperature, sfpVendor=sfpVendor, portsRuntsThreshold=portsRuntsThreshold, sysMonIndicator=sysMonIndicator, sfpLenght=sfpLenght, ramBytesFreeThreshold=ramBytesFreeThreshold, sfpStatus=sfpStatus, sfpRevision=sfpRevision, sysMonDefaults=sysMonDefaults, prvtSysMonNotifications=prvtSysMonNotifications, PYSNMP_MODULE_ID=prvtSysMonMib, software=software, portsCRCErrExceeded=portsCRCErrExceeded, portsRuntsExceeded=portsRuntsExceeded, laserTemperatureThresholdCrossed=laserTemperatureThresholdCrossed, sysMonThreshold=sysMonThreshold, laserPortThresholdEntry=laserPortThresholdEntry, laserPortValueEntry=laserPortValueEntry, sysMonConfig=sysMonConfig, monPortsEntry=monPortsEntry, laserTxPower=laserTxPower, monPortsTable=monPortsTable, laserRxPowerThresholdCrossed=laserRxPowerThresholdCrossed, prvtSysMonMib=prvtSysMonMib, laserTemperatureLowThreshold=laserTemperatureLowThreshold, monPortRunts=monPortRunts, sfpPortManTable=sfpPortManTable, sysMonTrap=sysMonTrap, monPortErrors=monPortErrors, EnableStatus=EnableStatus, prvtSysMonConformance=prvtSysMonConformance, laserPortValueTable=laserPortValueTable, monPortOverSize=monPortOverSize, portsBroadcastThreshold=portsBroadcastThreshold, sfpMonStatusChanged=sfpMonStatusChanged, sysMonConfigEntry=sysMonConfigEntry, ramFreeSpaceExceeded=ramFreeSpaceExceeded, sysMonEnable=sysMonEnable, sfpConnector=sfpConnector, cpuUtilizationExceeded=cpuUtilizationExceeded, monPortCRCErr=monPortCRCErr, sysMonPeriod=sysMonPeriod, monRamBytesFree=monRamBytesFree, sysMonLog=sysMonLog, portsOverSizeExceeded=portsOverSizeExceeded, sfpMonStatus=sfpMonStatus, portsOverSizeThreshold=portsOverSizeThreshold, sysMonConfigTable=sysMonConfigTable, sysMonValues=sysMonValues, laserTxPowerThresholdCrossed=laserTxPowerThresholdCrossed, laserTxPowerHighThreshold=laserTxPowerHighThreshold, laserTxPowerLowThreshold=laserTxPowerLowThreshold, portsBroadcastExceeded=portsBroadcastExceeded, sfpPortManEntry=sfpPortManEntry, sysMonNotificationGroup=sysMonNotificationGroup, prvtSysMonObjects=prvtSysMonObjects, sfpPN=sfpPN, portErrorsExceeded=portErrorsExceeded, monCpuUtilization=monCpuUtilization, portsCRCErrThreshold=portsCRCErrThreshold, sysMonLed=sysMonLed, portErrorsThreshold=portErrorsThreshold, cpuUtilizationThreshold=cpuUtilizationThreshold, laserTemperatureHighThreshold=laserTemperatureHighThreshold, monPortBroadcast=monPortBroadcast)
