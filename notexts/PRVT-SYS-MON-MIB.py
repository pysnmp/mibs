...
reportsL2IfaceUnit, reportsL2IfacePort, reportsIfJackIndex, reportsL2IfaceSlot, prvt_products = mibBuilder.importSymbols("PRVT-SWITCH-MIB", "reportsL2IfaceUnit", "reportsL2IfacePort", "reportsIfJackIndex", "reportsL2IfaceSlot", "prvt-products")
...
mibBuilder.exportSymbols("PRVT-SYS-MON-MIB", portsCRCErrExceeded=portsCRCErrExceeded, laserRxPower=laserRxPower, software=software, sysMonEnable=sysMonEnable, sysMonPeriod=sysMonPeriod, monCpuUtilization=monCpuUtilization, sfpPortManTable=sfpPortManTable, laserPortValueTable=laserPortValueTable, sysMonThreshold=sysMonThreshold, laserRxPowerLowThreshold=laserRxPowerLowThreshold, monPortsEntry=monPortsEntry, prvtSysMonObjects=prvtSysMonObjects, sfpVendor=sfpVendor, laserTxPowerHighThreshold=laserTxPowerHighThreshold, laserTxPowerLowThreshold=laserTxPowerLowThreshold, laserTxPowerThresholdCrossed=laserTxPowerThresholdCrossed, portsCRCErrThreshold=portsCRCErrThreshold, cpuUtilizationThreshold=cpuUtilizationThreshold, ramBytesFreeThreshold=ramBytesFreeThreshold, sfpMonStatus=sfpMonStatus, sysMonNotificationGroup=sysMonNotificationGroup, prvtSysMonMib=prvtSysMonMib, cpuUtilizationExceeded=cpuUtilizationExceeded, laserRxPowerHighThreshold=laserRxPowerHighThreshold, ramFreeSpaceExceeded=ramFreeSpaceExceeded, monRamBytesFree=monRamBytesFree, portsBroadcastExceeded=portsBroadcastExceeded, sfpConnector=sfpConnector, laserTxPower=laserTxPower, laserPortThresholdEntry=laserPortThresholdEntry, portsRuntsExceeded=portsRuntsExceeded, sysMonMIBGroups=sysMonMIBGroups, sysMonDefaults=sysMonDefaults, monPortsTable=monPortsTable, sfpPortManEntry=sfpPortManEntry, portsOverSizeExceeded=portsOverSizeExceeded, sfpMonStatusChanged=sfpMonStatusChanged, sfpPN=sfpPN, portsRuntsThreshold=portsRuntsThreshold, laserTemperature=laserTemperature, sysMonLed=sysMonLed, portsBroadcastThreshold=portsBroadcastThreshold, prvtSysMonConformance=prvtSysMonConformance, sysMonValues=sysMonValues, monPortOverSize=monPortOverSize, monPortCRCErr=monPortCRCErr, portsOverSizeThreshold=portsOverSizeThreshold, EnableStatus=EnableStatus, laserRxPowerThresholdCrossed=laserRxPowerThresholdCrossed, sysMonConfigEntry=sysMonConfigEntry, sysMonTrap=sysMonTrap, portErrorsExceeded=portErrorsExceeded, laserTemperatureLowThreshold=laserTemperatureLowThreshold, laserTemperatureThresholdCrossed=laserTemperatureThresholdCrossed, laserPortThresholdTable=laserPortThresholdTable, PYSNMP_MODULE_ID=prvtSysMonMib, monPortErrors=monPortErrors, monPortBroadcast=monPortBroadcast, portErrorsThreshold=portErrorsThreshold, sfpRevision=sfpRevision, sfpStatus=sfpStatus, sysMonConfig=sysMonConfig, monPortRunts=monPortRunts, sysMonLog=sysMonLog, sysMonConfigTable=sysMonConfigTable, sysMonIndicator=sysMonIndicator, prvtSysMonNotifications=prvtSysMonNotifications, sfpLenght=sfpLenght, laserTemperatureHighThreshold=laserTemperatureHighThreshold, laserPortValueEntry=laserPortValueEntry)
