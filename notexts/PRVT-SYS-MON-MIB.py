...
reportsL2IfacePort, reportsIfJackIndex, reportsL2IfaceUnit, reportsL2IfaceSlot, prvt_products = mibBuilder.importSymbols("PRVT-SWITCH-MIB", "reportsL2IfacePort", "reportsIfJackIndex", "reportsL2IfaceUnit", "reportsL2IfaceSlot", "prvt-products")
...
mibBuilder.exportSymbols("PRVT-SYS-MON-MIB", sfpPN=sfpPN, sfpConnector=sfpConnector, sysMonIndicator=sysMonIndicator, portsRuntsThreshold=portsRuntsThreshold, laserPortThresholdTable=laserPortThresholdTable, laserTemperature=laserTemperature, prvtSysMonConformance=prvtSysMonConformance, laserRxPowerLowThreshold=laserRxPowerLowThreshold, portErrorsExceeded=portErrorsExceeded, sfpMonStatus=sfpMonStatus, monPortsEntry=monPortsEntry, sysMonThreshold=sysMonThreshold, ramFreeSpaceExceeded=ramFreeSpaceExceeded, monPortRunts=monPortRunts, sysMonEnable=sysMonEnable, laserTxPowerLowThreshold=laserTxPowerLowThreshold, monPortOverSize=monPortOverSize, portsOverSizeThreshold=portsOverSizeThreshold, sfpLenght=sfpLenght, software=software, monPortCRCErr=monPortCRCErr, monPortErrors=monPortErrors, sysMonConfig=sysMonConfig, laserTemperatureThresholdCrossed=laserTemperatureThresholdCrossed, sysMonConfigEntry=sysMonConfigEntry, sysMonMIBGroups=sysMonMIBGroups, sysMonLog=sysMonLog, sfpStatus=sfpStatus, sfpPortManTable=sfpPortManTable, portsBroadcastThreshold=portsBroadcastThreshold, laserPortThresholdEntry=laserPortThresholdEntry, laserTemperatureLowThreshold=laserTemperatureLowThreshold, sysMonValues=sysMonValues, sysMonDefaults=sysMonDefaults, sysMonTrap=sysMonTrap, prvtSysMonObjects=prvtSysMonObjects, monRamBytesFree=monRamBytesFree, monPortBroadcast=monPortBroadcast, cpuUtilizationExceeded=cpuUtilizationExceeded, laserTxPowerThresholdCrossed=laserTxPowerThresholdCrossed, sysMonLed=sysMonLed, sfpRevision=sfpRevision, ramBytesFreeThreshold=ramBytesFreeThreshold, portsRuntsExceeded=portsRuntsExceeded, portsCRCErrThreshold=portsCRCErrThreshold, cpuUtilizationThreshold=cpuUtilizationThreshold, sysMonNotificationGroup=sysMonNotificationGroup, laserRxPowerHighThreshold=laserRxPowerHighThreshold, PYSNMP_MODULE_ID=prvtSysMonMib, sfpVendor=sfpVendor, monCpuUtilization=monCpuUtilization, sfpMonStatusChanged=sfpMonStatusChanged, monPortsTable=monPortsTable, portErrorsThreshold=portErrorsThreshold, sysMonConfigTable=sysMonConfigTable, laserPortValueTable=laserPortValueTable, sysMonPeriod=sysMonPeriod, laserRxPower=laserRxPower, laserRxPowerThresholdCrossed=laserRxPowerThresholdCrossed, laserTxPowerHighThreshold=laserTxPowerHighThreshold, prvtSysMonNotifications=prvtSysMonNotifications, portsOverSizeExceeded=portsOverSizeExceeded, prvtSysMonMib=prvtSysMonMib, laserPortValueEntry=laserPortValueEntry, portsBroadcastExceeded=portsBroadcastExceeded, laserTxPower=laserTxPower, laserTemperatureHighThreshold=laserTemperatureHighThreshold, sfpPortManEntry=sfpPortManEntry, EnableStatus=EnableStatus, portsCRCErrExceeded=portsCRCErrExceeded)
