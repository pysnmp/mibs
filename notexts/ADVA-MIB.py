...
DateAndTime, TextualConvention, TestAndIncr, TimeStamp, MacAddress, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "TextualConvention", "TestAndIncr", "TimeStamp", "MacAddress", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("ADVA-MIB", snmpWriteAccessNmsName=snmpWriteAccessNmsName, oduSectionDataTraceReceivedSapi=oduSectionDataTraceReceivedSapi, sonetConfig=sonetConfig, controlPlaneEthEntityContainedIn=controlPlaneEthEntityContainedIn, neRestoreFileBackupDate=neRestoreFileBackupDate, oduTcmCDataEntry=oduTcmCDataEntry, neStorageCapacity=neStorageCapacity, sourceIpAddress=sourceIpAddress, EntityIndex=EntityIndex, vtpEntityType=vtpEntityType, neEventLogVarCounter64Val=neEventLogVarCounter64Val, vtpEntityTable=vtpEntityTable, OhTerminationLevelCaps=OhTerminationLevelCaps, oduTcmBConfigTcmLevel=oduTcmBConfigTcmLevel, neAutoBackupServerPasswd=neAutoBackupServerPasswd, FileType=FileType, sonetSectionConfigEntry=sonetSectionConfigEntry, VirtualContainerTypeCaps=VirtualContainerTypeCaps, fsp1500=fsp1500, swDbDataCapRestoreConfig=swDbDataCapRestoreConfig, SonetVcBundleAllocationCaps=SonetVcBundleAllocationCaps, TrapCounter=TrapCounter, swAdmin=swAdmin, inventoryGradeInventory=inventoryGradeInventory, oduTcmCConfigSignalDegradePeriod=oduTcmCConfigSignalDegradePeriod, oduTcmBDataEntry=oduTcmBDataEntry, coldRestartCapServiceAffectingCap=coldRestartCapServiceAffectingCap, neF7AutomaticRemoteBackupSrvDir=neF7AutomaticRemoteBackupSrvDir, provContainerEntry=provContainerEntry, EthDuplexMode=EthDuplexMode, neSwUpgradeRequest=neSwUpgradeRequest, ArcState=ArcState, updateBackupRestoreMib=updateBackupRestoreMib, fwDataStandbyFirmwareAvailable=fwDataStandbyFirmwareAvailable, NoYesNA=NoYesNA, neMemorySizeTotal=neMemorySizeTotal, controlPlaneOtnEntityClassInstanceNumber=controlPlaneOtnEntityClassInstanceNumber, LogicalIfTransportCaps=LogicalIfTransportCaps, swDbDataEntry=swDbDataEntry, swDbDataActivationTime=swDbDataActivationTime, snmpWriteAccessEntry=snmpWriteAccessEntry, oduTcmCDataTraceReceivedDapi=oduTcmCDataTraceReceivedDapi, vtpEntityContainedIn=vtpEntityContainedIn, OtnTcmLevel=OtnTcmLevel, config=config, controlPlaneEthContainsEntry=controlPlaneEthContainsEntry, fwDataFirmwareApproved=fwDataFirmwareApproved, EnableState=EnableState, inventoryMib=inventoryMib, snmpWriteAccessNmsAddress=snmpWriteAccessNmsAddress, controlPlaneEthEntityEntry=controlPlaneEthEntityEntry, neF7AutomaticBackupTable=neF7AutomaticBackupTable, oduTcmAConfigTimMode=oduTcmAConfigTimMode, provAssignmentState=provAssignmentState, oduTcmCConfigEntry=oduTcmCConfigEntry, inventoryUnitName=inventoryUnitName, vtpEntityReferencedTo=vtpEntityReferencedTo, swDbFileSize=swDbFileSize, RestoreActivationCaps=RestoreActivationCaps, snmpWriteAccessRestriction=snmpWriteAccessRestriction, fsp1000adm=fsp1000adm, neSwUpgradeTransferProtocol=neSwUpgradeTransferProtocol, SourceIpAddress=SourceIpAddress, oduTcmBConfigTimMode=oduTcmBConfigTimMode, inventoryCfSerialNum=inventoryCfSerialNum, entityContainedIn=entityContainedIn, NcuAutoActivation=NcuAutoActivation, neBackupPassword=neBackupPassword, oduTcmADataTable=oduTcmADataTable, otuSectionConfigStuffing=otuSectionConfigStuffing, eqpFwUpgradeRequest=eqpFwUpgradeRequest, software=software, controlPlaneOtnEntityTable=controlPlaneOtnEntityTable, oduSectionConfigSignalDegradePeriod=oduSectionConfigSignalDegradePeriod, BootState=BootState, snmpProxyEntrySingleTargetOutNodeAgentStatus=snmpProxyEntrySingleTargetOutNodeAgentStatus, otuSectionDataTable=otuSectionDataTable, controlPlaneWdmEntityTable=controlPlaneWdmEntityTable, otuSectionConfigSignalDegradePeriod=otuSectionConfigSignalDegradePeriod, neAutoBackupServerDirectory=neAutoBackupServerDirectory, swDbFileFileName=swDbFileFileName, sonetSectionDataTraceReceived=sonetSectionDataTraceReceived, controlPlaneOtnEntityIndex=controlPlaneOtnEntityIndex, controlPlaneWdmContainsEntry=controlPlaneWdmContainsEntry, swDbDataNumEqpt=swDbDataNumEqpt, neF7AutomaticBackupTimeStamp=neF7AutomaticBackupTimeStamp, oduConfig=oduConfig, controlPlaneOtnEntityContainedIn=controlPlaneOtnEntityContainedIn, controlPlaneWdmEntityIndex=controlPlaneWdmEntityIndex, fsp150=fsp150, oduTcmCConfigTraceTransmitSapi=oduTcmCConfigTraceTransmitSapi, swDbDataStandbyPartitionStatus=swDbDataStandbyPartitionStatus, neAutoBackup=neAutoBackup, updateEqpt=updateEqpt, sonetSectionConfigTraceTransmit=sonetSectionConfigTraceTransmit, NeSwUpgradeStatusType=NeSwUpgradeStatusType, controlPlaneWdmEntityContainedIn=controlPlaneWdmEntityContainedIn, sonetSectionConfigTimMode=sonetSectionConfigTimMode, fwDataStandbyServiceImpairment=fwDataStandbyServiceImpairment, oduTcmCConfigTcmLevel=oduTcmCConfigTcmLevel, controlPlaneOtnContainsIndex=controlPlaneOtnContainsIndex, ncuActivationDateUtc=ncuActivationDateUtc, controlPlaneEthEntityIndex=controlPlaneEthEntityIndex, entityAssignmentState=entityAssignmentState, swDbDataDatabaseVersion=swDbDataDatabaseVersion, inventoryFirmwarePackageRev=inventoryFirmwarePackageRev, fsp3000=fsp3000, entityClass=entityClass, fwDataNewVersion=fwDataNewVersion, containsTable=containsTable, ProtectionMechCaps=ProtectionMechCaps, swDbDataTable=swDbDataTable, swDbDataProgramVersion=swDbDataProgramVersion, swDbFilePgmType=swDbFilePgmType, controlPlaneOtnEntityEntry=controlPlaneOtnEntityEntry, swDbFileType=swDbFileType, oduTcmBDataTraceReceivedOpsp=oduTcmBDataTraceReceivedOpsp, oduSectionConfigTraceExpected=oduSectionConfigTraceExpected, swDbFileComment=swDbFileComment, YesNoNA=YesNoNA, neF7AutomaticBackupRunState=neF7AutomaticBackupRunState, oduTcmAConfigTcmLevel=oduTcmAConfigTcmLevel, neSwUpgradeServerPasswd=neSwUpgradeServerPasswd, oduTcmBConfigSignalDegradePeriod=oduTcmBConfigSignalDegradePeriod, eqpFwNextEqpForUpdate=eqpFwNextEqpForUpdate, LogicalIfTransport=LogicalIfTransport, eqpFwNcuServerBusy=eqpFwNcuServerBusy, snmpProxyEntrySingleTargetOutAdminState=snmpProxyEntrySingleTargetOutAdminState, EthDuplexModeCaps=EthDuplexModeCaps, oduTcmAConfigEntry=oduTcmAConfigEntry, controlPlaneEthEntityIndexAid=controlPlaneEthEntityIndexAid, neSwUpgradeServerDirectory=neSwUpgradeServerDirectory, FileArea=FileArea, inventoryUniversalSerialIdent=inventoryUniversalSerialIdent, aos=aos, ncuActivationDate=ncuActivationDate, controlPlaneWdmEntityAssignmentState=controlPlaneWdmEntityAssignmentState, neBackupRestore=neBackupRestore, oduTcmBConfigTable=oduTcmBConfigTable, vtpEntityIndexAid=vtpEntityIndexAid, entityClassInstanceNumber=entityClassInstanceNumber, coldRestartCapEntry=coldRestartCapEntry, FspR7EquipmentType=FspR7EquipmentType, KBytes=KBytes, swDbDataArea=swDbDataArea, PartitionStatus=PartitionStatus, swDbDataNumNativeNsaUpdate=swDbDataNumNativeNsaUpdate, sonet=sonet, TimMode=TimMode, neSwUpgradeState=neSwUpgradeState, neTrapsinkCommunity=neTrapsinkCommunity, neF7AutomaticRemoteBackupSrvIp=neF7AutomaticRemoteBackupSrvIp, swDbDataNcuSoftwareVersion=swDbDataNcuSoftwareVersion, oduSectionConfigTraceTransmitOpsp=oduSectionConfigTraceTransmitOpsp, oduTcmCDataTable=oduTcmCDataTable, ptpEntityClassInstanceNumber=ptpEntityClassInstanceNumber, neManufacturer=neManufacturer, neF7AutomaticRemoteBackupSrvLogin=neF7AutomaticRemoteBackupSrvLogin, oduTcmCDataTraceReceivedSapi=oduTcmCDataTraceReceivedSapi, neStorageTable=neStorageTable, neEventLogVarIndex=neEventLogVarIndex, oduSectionDataTable=oduSectionDataTable, inventorySoftwareRev=inventorySoftwareRev, swDbDataNumNsaNotReady=swDbDataNumNsaNotReady, ServiceAffecting=ServiceAffecting, oduTcmAConfigTable=oduTcmAConfigTable, oduSectionDataTraceReceivedOpsp=oduSectionDataTraceReceivedOpsp, controlPlaneOtnEntityAssignmentState=controlPlaneOtnEntityAssignmentState, neEventLogVarInteger32Val=neEventLogVarInteger32Val, otuSectionConfigTable=otuSectionConfigTable, ApsDirectionCaps=ApsDirectionCaps, transportStandards=transportStandards, fsp150cm=fsp150cm, neEventLogVarType=neEventLogVarType, inventoryType=inventoryType, inventoryTable=inventoryTable, CpWdmEntityClass=CpWdmEntityClass, aosCommon=aosCommon, Counter64String=Counter64String, sonetSectionConfigTraceExpected=sonetSectionConfigTraceExpected, oduTcmCConfigTraceExpected=oduTcmCConfigTraceExpected, swDbFileVersion=swDbFileVersion, FspR7EnableDisable=FspR7EnableDisable, ptpEntityReferencedTo=ptpEntityReferencedTo, oduSectionConfigSignalDegradeThres=oduSectionConfigSignalDegradeThres, neF7AutomaticRemoteBackupTimeStamp=neF7AutomaticRemoteBackupTimeStamp, neEventLogVarId=neEventLogVarId, SonetTraceForm=SonetTraceForm, SnmpProxySynchronizationStage=SnmpProxySynchronizationStage, swVersionInactiveOperatingSw=swVersionInactiveOperatingSw, entityIndex=entityIndex, vtpEntityClass=vtpEntityClass, inventorySerialNum=inventorySerialNum, otuSectionDataTraceReceivedSapi=otuSectionDataTraceReceivedSapi, ProtectionMech=ProtectionMech, containsIndex=containsIndex, snmpProxyEntrySingleTargetOutUserName=snmpProxyEntrySingleTargetOutUserName, controlPlaneOtnContainsEntry=controlPlaneOtnContainsEntry, neSwUpgradeServerAddress=neSwUpgradeServerAddress, FspR7YesNo=FspR7YesNo, ApsDirection=ApsDirection, fsp1000=fsp1000, oduTcmADataTraceReceivedSapi=oduTcmADataTraceReceivedSapi, inventoryCleiCode=inventoryCleiCode, ptpEntityType=ptpEntityType, neF7AutomaticRemoteBackupPassword=neF7AutomaticRemoteBackupPassword, snmpWriteAccessTable=snmpWriteAccessTable, products=products, inventoryHardwareRev=inventoryHardwareRev, oduTcmAConfigTraceTransmitOpsp=oduTcmAConfigTraceTransmitOpsp, swDbDataNumSaNotReady=swDbDataNumSaNotReady, snmpProxyEntrySingleTargetOutEntry=snmpProxyEntrySingleTargetOutEntry, ptpEntityEquipmentState=ptpEntityEquipmentState, neSwDownloadProgress=neSwDownloadProgress, neF7AutomaticBackupEntry=neF7AutomaticBackupEntry, vtpEntityClassInstanceNumber=vtpEntityClassInstanceNumber, otuSectionConfigTimMode=otuSectionConfigTimMode, RestoreActivation=RestoreActivation, neMemorySizeFree=neMemorySizeFree, oduSectionConfigTraceTransmitDapi=oduSectionConfigTraceTransmitDapi, snmpProxyEntrySingleTargetOutPort=snmpProxyEntrySingleTargetOutPort, EntityType=EntityType, TimModeCaps=TimModeCaps, snmpProxyEntrySingleTargetOutRowStatus=snmpProxyEntrySingleTargetOutRowStatus, otuSectionConfigTraceTransmitDapi=otuSectionConfigTraceTransmitDapi, snmpServerPort=snmpServerPort, ApsHoldoffTime=ApsHoldoffTime, inventoryFpgaRev=inventoryFpgaRev, neAutoBackupConfig=neAutoBackupConfig, fwDataFirmwareAvailable=fwDataFirmwareAvailable, neSwUpgradeCommonIpSrv=neSwUpgradeCommonIpSrv, controlPlaneEthEntityClassInstanceNumber=controlPlaneEthEntityClassInstanceNumber, controlPlaneOtnEntityIndexAid=controlPlaneOtnEntityIndexAid, neBackupUsers=neBackupUsers, eqpFwEqpServerBusy=eqpFwEqpServerBusy, swDbDataIndex=swDbDataIndex, swDbFileEntry=swDbFileEntry, neStorageEntry=neStorageEntry, oduTcmADataEntry=oduTcmADataEntry, oduTcmAConfigSignalDegradePeriod=oduTcmAConfigSignalDegradePeriod, fwDataBootStatus=fwDataBootStatus, fwDataProtectionPart=fwDataProtectionPart, neAlarmStatus=neAlarmStatus, controlPlaneWdmEntityClassInstanceNumber=controlPlaneWdmEntityClassInstanceNumber, coldRestartCapTable=coldRestartCapTable, oduTcmBConfigSignalDegradeThreshold=oduTcmBConfigSignalDegradeThreshold, controlPlaneOtnContainsTable=controlPlaneOtnContainsTable, vtpEntityEntry=vtpEntityEntry, ServiceImpairment=ServiceImpairment, SonetSectSigDegThresCaps=SonetSectSigDegThresCaps, oduTcmBConfigTraceTransmitOpsp=oduTcmBConfigTraceTransmitOpsp, oduTcmAConfigSignalDegradeThreshold=oduTcmAConfigSignalDegradeThreshold, LoopConfig=LoopConfig, swDbDataDefaultsEntry=swDbDataDefaultsEntry)
mibBuilder.exportSymbols("ADVA-MIB", neF7AutomaticBackupInterval=neF7AutomaticBackupInterval, swDbDataDefaultsUpgradeRequest=swDbDataDefaultsUpgradeRequest, SonetTimingSource=SonetTimingSource, inventoryEntry=inventoryEntry, oduSectionConfigEntry=oduSectionConfigEntry, swVersionActiveApplSw=swVersionActiveApplSw, sonetSectionConfigTable=sonetSectionConfigTable, fspR7=fspR7, FspTime=FspTime, EnableStateCaps=EnableStateCaps, OtnPayloadType=OtnPayloadType, ncuScheduledDbRestore=ncuScheduledDbRestore, neEventLogIndex=neEventLogIndex, snmpAgent=snmpAgent, vtpEntityAssignmentState=vtpEntityAssignmentState, swDbFileRowStatus=swDbFileRowStatus, neF7AutomaticRemoteBackupEncryption=neF7AutomaticRemoteBackupEncryption, neEventLogVarIpAddressVal=neEventLogVarIpAddressVal, neAutoBackupServerLogin=neAutoBackupServerLogin, F7FileTimeStamp=F7FileTimeStamp, neF7AutomaticRemoteBackupSrvPass=neF7AutomaticRemoteBackupSrvPass, oduSectionDataTraceReceivedDapi=oduSectionDataTraceReceivedDapi, fwDataFirmwarePackageRev=fwDataFirmwarePackageRev, FspR7Time=FspR7Time, OhTerminationLevel=OhTerminationLevel, inventoryMacAddress=inventoryMacAddress, snmpProxyServerPort=snmpProxyServerPort, otuSectionDataEntry=otuSectionDataEntry, PgmType=PgmType, ApsHoldoffTimeCaps=ApsHoldoffTimeCaps, controlPlaneEthContainsIndex=controlPlaneEthContainsIndex, installedEqpt=installedEqpt, otuSectionConfigTraceTransmitOpsp=otuSectionConfigTraceTransmitOpsp, ptpEntityTable=ptpEntityTable, SonetVcBundleAllocation=SonetVcBundleAllocation, oduTcmADataTraceReceivedDapi=oduTcmADataTraceReceivedDapi, fwDataServiceImpairment=fwDataServiceImpairment, IdentityTranslation=IdentityTranslation, controlPlaneWdmEntityEntry=controlPlaneWdmEntityEntry, swDbDataCapEntry=swDbDataCapEntry, oduTcmBConfigTraceExpected=oduTcmBConfigTraceExpected, neSwInstallState=neSwInstallState, snmpProxyServerSynchroState=snmpProxyServerSynchroState, fsp2000=fsp2000, clearRdiskRequest=clearRdiskRequest, Grade=Grade, oduTcmBDataTraceReceivedSapi=oduTcmBDataTraceReceivedSapi, sonetSectionConfigTraceForm=sonetSectionConfigTraceForm, neTrapsinkEntry=neTrapsinkEntry, sonetSectionDataTable=sonetSectionDataTable, neF7AutomaticBackupIndex=neF7AutomaticBackupIndex, encryptionFwpFile=encryptionFwpFile, neF7AutomaticRemoteBackupProtocol=neF7AutomaticRemoteBackupProtocol, ptpEntityIndexAid=ptpEntityIndexAid, fwDataReadyForActivation=fwDataReadyForActivation, snmpProxyServerSynchroStage=snmpProxyServerSynchroStage, vtpEntityEquipmentState=vtpEntityEquipmentState, controlPlaneWdmContainsIndex=controlPlaneWdmContainsIndex, SonetTimingSourceCaps=SonetTimingSourceCaps, oduTcmCConfigSignalDegradeThreshold=oduTcmCConfigSignalDegradeThreshold, sonetSectionDataEntry=sonetSectionDataEntry, controlPlaneEthEntityTable=controlPlaneEthEntityTable, fwDataEntry=fwDataEntry, SonetSectSigDegThres=SonetSectSigDegThres, otuSectionDataTraceReceivedDapi=otuSectionDataTraceReceivedDapi, snmpProxyEntrySingleTargetOutContext=snmpProxyEntrySingleTargetOutContext, AssignmentState=AssignmentState, neBackupRestoreFile=neBackupRestoreFile, neEventsLogged=neEventsLogged, oduSectionDataEntry=oduSectionDataEntry, oduTcmAConfigTraceTransmitSapi=oduTcmAConfigTraceTransmitSapi, fwDataFirmwarePackageRevBackup=fwDataFirmwarePackageRevBackup, ptpEntityClass=ptpEntityClass, neEventLogEntry=neEventLogEntry, neEventLogVarTable=neEventLogVarTable, neF7AutomaticBackupStartTime=neF7AutomaticBackupStartTime, otuSectionDataResultingTotalBitrate=otuSectionDataResultingTotalBitrate, ptpEntityAssignmentState=ptpEntityAssignmentState, fwDataTable=fwDataTable, swVersionTable=swVersionTable, fwDataForm=fwDataForm, oduTcmBDataTable=oduTcmBDataTable, inventoryVendorId=inventoryVendorId, neTrapsinkAddress=neTrapsinkAddress, neF7AutomaticRemoteBackupUsers=neF7AutomaticRemoteBackupUsers, DestinationNodeOrAgentState=DestinationNodeOrAgentState, containsEntry=containsEntry, ServiceAffectingCaps=ServiceAffectingCaps, otuSectionConfigTraceTransmitSapi=otuSectionConfigTraceTransmitSapi, ptpEntityContainedIn=ptpEntityContainedIn, fspNm=fspNm, swVersionEntry=swVersionEntry, AvailState=AvailState, neEventLogVarUnsigned32Val=neEventLogVarUnsigned32Val, snmpProxyServerAdminState=snmpProxyServerAdminState, swDbDataNumLegacyEqpt=swDbDataNumLegacyEqpt, EquipmentState=EquipmentState, controlPlaneEthEntityClass=controlPlaneEthEntityClass, oduTcmBDataTraceReceivedDapi=oduTcmBDataTraceReceivedDapi, NeSwInstallStatusType=NeSwInstallStatusType, oduTcmCConfigTraceTransmitDapi=oduTcmCConfigTraceTransmitDapi, neBackupRestoreRequest=neBackupRestoreRequest, oduTcmAConfigTraceExpected=oduTcmAConfigTraceExpected, neMibVariant=neMibVariant, swDbFileCreationTime=swDbFileCreationTime, oduTcmBConfigEntry=oduTcmBConfigEntry, fsp3000alm=fsp3000alm, neEventLogVarOctetStringVal=neEventLogVarOctetStringVal, swDbFileIndex=swDbFileIndex, otuConfig=otuConfig, swDbDataRestoreConfig=swDbDataRestoreConfig, LoopConfigCaps=LoopConfigCaps, neEventLogVarEntry=neEventLogVarEntry, provContainerTable=provContainerTable, entityType=entityType, swDbDataNumNativeSaUpdate=swDbDataNumNativeSaUpdate, swDbDataCapUpgradeRequest=swDbDataCapUpgradeRequest, FspR7FalseTrue=FspR7FalseTrue, oduTcmCConfigTable=oduTcmCConfigTable, neStorageIndex=neStorageIndex, entityEquipmentState=entityEquipmentState, ncuActivationTimeUtc=ncuActivationTimeUtc, swDbFileArea=swDbFileArea, FspR7Date=FspR7Date, neTrapsinkVersion=neTrapsinkVersion, neF7AutomaticBackupNextDate=neF7AutomaticBackupNextDate, FspR7TrapsinkLifetime=FspR7TrapsinkLifetime, OtnTcmLevelCaps=OtnTcmLevelCaps, inventoryPartnumber=inventoryPartnumber, neEventLogTable=neEventLogTable, fsp3000c=fsp3000c, oduTcmCConfigTimMode=oduTcmCConfigTimMode, ptpEntityIndex=ptpEntityIndex, controlPlaneWdmContainsTable=controlPlaneWdmContainsTable, ncuScheduledActivation=ncuScheduledActivation, controlPlaneOtnEntityClass=controlPlaneOtnEntityClass, dbAdmin=dbAdmin, EntityClass=EntityClass, controlPlaneEthEntityAssignmentState=controlPlaneEthEntityAssignmentState, neSoftwareUpgrade=neSoftwareUpgrade, neEventLogIdentityTranslation=neEventLogIdentityTranslation, controlPlaneWdmEntityClass=controlPlaneWdmEntityClass, neTrapsinkPort=neTrapsinkPort, events=events, sonetSectionConfigSignalDegradeThreshhold=sonetSectionConfigSignalDegradeThreshhold, VirtualContainerType=VirtualContainerType, neSwUpgradeNeDirectory=neSwUpgradeNeDirectory, neF7AutomaticRemoteBackupCommonIpSrv=neF7AutomaticRemoteBackupCommonIpSrv, PYSNMP_MODULE_ID=advaMIB, neF7AutomaticRemoteBackupSrcIp=neF7AutomaticRemoteBackupSrcIp, oduSectionConfigTraceTransmitSapi=oduSectionConfigTraceTransmitSapi, entityIndexAid=entityIndexAid, common=common, TrapAlarmSeverity=TrapAlarmSeverity, OtnPayloadTypeCaps=OtnPayloadTypeCaps, eqpFwServiceImpairment=eqpFwServiceImpairment, controlPlaneWdmEntityIndexAid=controlPlaneWdmEntityIndexAid, otuSectionConfigPayload=otuSectionConfigPayload, neDateAndTime=neDateAndTime, sonetSectionConfigTimingSource=sonetSectionConfigTimingSource, controlPlaneEthContainsTable=controlPlaneEthContainsTable, entityEntry=entityEntry, oduTcmAConfigTraceTransmitDapi=oduTcmAConfigTraceTransmitDapi, neAutoBackupNextActionAt=neAutoBackupNextActionAt, swDbDataCapTable=swDbDataCapTable, F7AutoBackupInterval=F7AutoBackupInterval, neTrapsinkUserName=neTrapsinkUserName, neEventLogTimeStamp=neEventLogTimeStamp, FspR7UsersDb=FspR7UsersDb, ncuActivationTime=ncuActivationTime, otuSectionConfigSignalDegradeThreshold=otuSectionConfigSignalDegradeThreshold, neAutoBackupInterval=neAutoBackupInterval, otn=otn, eqpFwEqpType=eqpFwEqpType, swDbDataDefaultsTable=swDbDataDefaultsTable, F7AutoBackupRunState=F7AutoBackupRunState, neInitialConnectionMode=neInitialConnectionMode, FspR7AdminStateSnmpProxyCaps=FspR7AdminStateSnmpProxyCaps, neInfo=neInfo, swVersionActiveOperatingSw=swVersionActiveOperatingSw, CommandEqpt=CommandEqpt, neBackupEncryption=neBackupEncryption, neF7AutomaticBackupStartDate=neF7AutomaticBackupStartDate, fwDataActivationReadyOnStandby=fwDataActivationReadyOnStandby, snmpProxyEntrySingleTargetOutAddress=snmpProxyEntrySingleTargetOutAddress, oduSectionConfigTable=oduSectionConfigTable, swDbFileTable=swDbFileTable, oduTcmBConfigTraceTransmitSapi=oduTcmBConfigTraceTransmitSapi, StandbyServiceAffecting=StandbyServiceAffecting, swVersionNextBoot=swVersionNextBoot, neSwUpgradeServerLogin=neSwUpgradeServerLogin, oduTcmCConfigTraceTransmitOpsp=oduTcmCConfigTraceTransmitOpsp, sonetSectionConfigSignalDegradePeriod=sonetSectionConfigSignalDegradePeriod, neStorageDescr=neStorageDescr, oduTcmADataTraceReceivedOpsp=oduTcmADataTraceReceivedOpsp, FspDate=FspDate, neStorageAvailable=neStorageAvailable, otuSectionDataTraceReceivedOpsp=otuSectionDataTraceReceivedOpsp, neSwUpgradeType=neSwUpgradeType, provEquipmentState=provEquipmentState, advaMIB=advaMIB, FspR7EquipmentTypeCaps=FspR7EquipmentTypeCaps, neTrapsinkTable=neTrapsinkTable, FileTransferProtocol=FileTransferProtocol, selectedFile=selectedFile, swVersionInactiveApplSw=swVersionInactiveApplSw, swDbDataDefaultsRestoreConfig=swDbDataDefaultsRestoreConfig, neEventLogVarOidVal=neEventLogVarOidVal, admin=admin, ptpEntityEntry=ptpEntityEntry, oduSectionConfigTimMode=oduSectionConfigTimMode, swDbDataNumLegacyUpdate=swDbDataNumLegacyUpdate, neAutoBackupServerAddress=neAutoBackupServerAddress, snmpProxyEntrySingleTargetOutTable=snmpProxyEntrySingleTargetOutTable, neTrapsinkRowStatus=neTrapsinkRowStatus, aosProducts=aosProducts, neTrapsinkType=neTrapsinkType, FspR7AdminStateSnmpProxy=FspR7AdminStateSnmpProxy, fwDataStandbyVersion=fwDataStandbyVersion, OnOff=OnOff, SonetTraceFormCaps=SonetTraceFormCaps, inventoryCfModel=inventoryCfModel, vtpEntityIndex=vtpEntityIndex, SnmpProxySynchronizationState=SnmpProxySynchronizationState, neEventLogNotificationOID=neEventLogNotificationOID, otuSectionConfigEntry=otuSectionConfigEntry, neBackupRestoreState=neBackupRestoreState, swDbFileGrade=swDbFileGrade, neSwUpgradeFileName=neSwUpgradeFileName, neRestoreConfig=neRestoreConfig, ModuleForm=ModuleForm, oduTcmCDataTraceReceivedOpsp=oduTcmCDataTraceReceivedOpsp, entityTable=entityTable, oduTcmBConfigTraceTransmitDapi=oduTcmBConfigTraceTransmitDapi, swDbDataFirmwareSetVersion=swDbDataFirmwareSetVersion, otuSectionConfigTraceExpected=otuSectionConfigTraceExpected)
