...
mibBuilder.exportSymbols("ADVA-MIB", oduTcmCConfigTraceTransmitSapi=oduTcmCConfigTraceTransmitSapi, FspR7AdminStateSnmpProxyCaps=FspR7AdminStateSnmpProxyCaps, swDbFileVersion=swDbFileVersion, oduConfig=oduConfig, FspR7Time=FspR7Time, eqpFwNextEqpForUpdate=eqpFwNextEqpForUpdate, FspR7UsersDb=FspR7UsersDb, fsp150cm=fsp150cm, ApsDirectionCaps=ApsDirectionCaps, FileTransferProtocol=FileTransferProtocol, snmpProxyEntrySingleTargetOutUserName=snmpProxyEntrySingleTargetOutUserName, SnmpProxySynchronizationState=SnmpProxySynchronizationState, ModuleForm=ModuleForm, ServiceAffecting=ServiceAffecting, inventoryMacAddress=inventoryMacAddress, OtnPayloadTypeCaps=OtnPayloadTypeCaps, products=products, dbAdmin=dbAdmin, otuSectionDataTraceReceivedOpsp=otuSectionDataTraceReceivedOpsp, sonetSectionConfigTimingSource=sonetSectionConfigTimingSource, oduTcmCConfigEntry=oduTcmCConfigEntry, entityClass=entityClass, oduTcmBConfigSignalDegradeThreshold=oduTcmBConfigSignalDegradeThreshold, fwDataReadyForActivation=fwDataReadyForActivation, F7AutoBackupInterval=F7AutoBackupInterval, neStorageCapacity=neStorageCapacity, oduSectionDataTraceReceivedSapi=oduSectionDataTraceReceivedSapi, oduTcmADataTraceReceivedOpsp=oduTcmADataTraceReceivedOpsp, neF7AutomaticBackupNextDate=neF7AutomaticBackupNextDate, vtpEntityEquipmentState=vtpEntityEquipmentState, neAutoBackup=neAutoBackup, sonet=sonet, OhTerminationLevelCaps=OhTerminationLevelCaps, coldRestartCapEntry=coldRestartCapEntry, swVersionNextBoot=swVersionNextBoot, LoopConfigCaps=LoopConfigCaps, otuSectionConfigTimMode=otuSectionConfigTimMode, inventoryEntry=inventoryEntry, sonetSectionConfigTraceForm=sonetSectionConfigTraceForm, sonetSectionConfigSignalDegradePeriod=sonetSectionConfigSignalDegradePeriod, fwDataForm=fwDataForm, oduSectionConfigTraceTransmitDapi=oduSectionConfigTraceTransmitDapi, admin=admin, PartitionStatus=PartitionStatus, neAutoBackupServerLogin=neAutoBackupServerLogin, fwDataFirmwareApproved=fwDataFirmwareApproved, inventoryUniversalSerialIdent=inventoryUniversalSerialIdent, vtpEntityEntry=vtpEntityEntry, TrapAlarmSeverity=TrapAlarmSeverity, aos=aos, controlPlaneWdmContainsTable=controlPlaneWdmContainsTable, neF7AutomaticRemoteBackupProtocol=neF7AutomaticRemoteBackupProtocol, fwDataNewVersion=fwDataNewVersion, oduSectionConfigSignalDegradePeriod=oduSectionConfigSignalDegradePeriod, otuSectionDataTraceReceivedDapi=otuSectionDataTraceReceivedDapi, BootState=BootState, swDbDataArea=swDbDataArea, swVersionActiveApplSw=swVersionActiveApplSw, neSwUpgradeServerAddress=neSwUpgradeServerAddress, neF7AutomaticRemoteBackupSrcIp=neF7AutomaticRemoteBackupSrcIp, neStorageEntry=neStorageEntry, common=common, neTrapsinkAddress=neTrapsinkAddress, ncuActivationDateUtc=ncuActivationDateUtc, controlPlaneEthContainsEntry=controlPlaneEthContainsEntry, otuSectionConfigTraceTransmitSapi=otuSectionConfigTraceTransmitSapi, oduTcmAConfigTraceTransmitDapi=oduTcmAConfigTraceTransmitDapi, LogicalIfTransport=LogicalIfTransport, vtpEntityTable=vtpEntityTable, ptpEntityType=ptpEntityType, neEventLogIndex=neEventLogIndex, neAutoBackupServerPasswd=neAutoBackupServerPasswd, sonetSectionConfigTraceExpected=sonetSectionConfigTraceExpected, oduTcmAConfigTimMode=oduTcmAConfigTimMode, neTrapsinkVersion=neTrapsinkVersion, oduTcmAConfigSignalDegradePeriod=oduTcmAConfigSignalDegradePeriod, oduTcmBConfigTable=oduTcmBConfigTable, NcuAutoActivation=NcuAutoActivation, controlPlaneWdmEntityClass=controlPlaneWdmEntityClass, SonetVcBundleAllocationCaps=SonetVcBundleAllocationCaps, neAutoBackupServerDirectory=neAutoBackupServerDirectory, neBackupRestore=neBackupRestore, vtpEntityContainedIn=vtpEntityContainedIn, CpWdmEntityClass=CpWdmEntityClass, FspR7AdminStateSnmpProxy=FspR7AdminStateSnmpProxy, neAutoBackupNextActionAt=neAutoBackupNextActionAt, snmpProxyEntrySingleTargetOutContext=snmpProxyEntrySingleTargetOutContext, neAlarmStatus=neAlarmStatus, oduTcmCConfigSignalDegradeThreshold=oduTcmCConfigSignalDegradeThreshold, controlPlaneWdmEntityEntry=controlPlaneWdmEntityEntry, controlPlaneOtnContainsIndex=controlPlaneOtnContainsIndex, RestoreActivationCaps=RestoreActivationCaps, snmpProxyEntrySingleTargetOutPort=snmpProxyEntrySingleTargetOutPort, sonetSectionDataTraceReceived=sonetSectionDataTraceReceived, SonetSectSigDegThres=SonetSectSigDegThres, updateEqpt=updateEqpt, otuSectionConfigTable=otuSectionConfigTable, entityEntry=entityEntry, swDbDataDatabaseVersion=swDbDataDatabaseVersion, neTrapsinkEntry=neTrapsinkEntry, neAutoBackupServerAddress=neAutoBackupServerAddress, controlPlaneEthEntityIndex=controlPlaneEthEntityIndex, neEventLogVarId=neEventLogVarId, FileType=FileType, sonetSectionDataEntry=sonetSectionDataEntry, otn=otn, neRestoreFileBackupDate=neRestoreFileBackupDate, SonetTraceForm=SonetTraceForm, snmpProxyEntrySingleTargetOutNodeAgentStatus=snmpProxyEntrySingleTargetOutNodeAgentStatus, otuSectionConfigSignalDegradePeriod=otuSectionConfigSignalDegradePeriod, oduSectionConfigEntry=oduSectionConfigEntry, otuSectionConfigStuffing=otuSectionConfigStuffing, FspR7EquipmentTypeCaps=FspR7EquipmentTypeCaps, FspTime=FspTime, snmpProxyServerAdminState=snmpProxyServerAdminState, neStorageTable=neStorageTable, EntityClass=EntityClass, inventoryFirmwarePackageRev=inventoryFirmwarePackageRev, FspR7EquipmentType=FspR7EquipmentType, vtpEntityClass=vtpEntityClass, ptpEntityIndexAid=ptpEntityIndexAid, neF7AutomaticBackupTimeStamp=neF7AutomaticBackupTimeStamp, swDbDataTable=swDbDataTable, snmpAgent=snmpAgent, swVersionEntry=swVersionEntry, inventoryCleiCode=inventoryCleiCode, F7AutoBackupRunState=F7AutoBackupRunState, neEventLogVarCounter64Val=neEventLogVarCounter64Val, swDbDataNumLegacyEqpt=swDbDataNumLegacyEqpt, neF7AutomaticBackupRunState=neF7AutomaticBackupRunState, neBackupPassword=neBackupPassword, swDbDataFirmwareSetVersion=swDbDataFirmwareSetVersion, neAutoBackupConfig=neAutoBackupConfig, snmpProxyEntrySingleTargetOutAdminState=snmpProxyEntrySingleTargetOutAdminState, sonetSectionConfigEntry=sonetSectionConfigEntry, snmpWriteAccessTable=snmpWriteAccessTable, swDbDataNumNativeSaUpdate=swDbDataNumNativeSaUpdate, controlPlaneWdmContainsEntry=controlPlaneWdmContainsEntry, OtnTcmLevel=OtnTcmLevel, swDbDataDefaultsEntry=swDbDataDefaultsEntry, SonetTimingSourceCaps=SonetTimingSourceCaps, OhTerminationLevel=OhTerminationLevel, provAssignmentState=provAssignmentState, sonetConfig=sonetConfig, SnmpProxySynchronizationStage=SnmpProxySynchronizationStage, neSwUpgradeRequest=neSwUpgradeRequest, snmpServerPort=snmpServerPort, fwDataBootStatus=fwDataBootStatus, OtnTcmLevelCaps=OtnTcmLevelCaps, fsp1500=fsp1500, neEventLogTimeStamp=neEventLogTimeStamp, fsp3000=fsp3000, swAdmin=swAdmin, swDbDataCapEntry=swDbDataCapEntry, swDbDataEntry=swDbDataEntry, neEventLogNotificationOID=neEventLogNotificationOID, neF7AutomaticRemoteBackupSrvPass=neF7AutomaticRemoteBackupSrvPass, snmpProxyEntrySingleTargetOutAddress=snmpProxyEntrySingleTargetOutAddress, neSwUpgradeTransferProtocol=neSwUpgradeTransferProtocol, fspNm=fspNm, neStorageDescr=neStorageDescr, oduTcmCConfigTraceTransmitOpsp=oduTcmCConfigTraceTransmitOpsp, sourceIpAddress=sourceIpAddress, EnableStateCaps=EnableStateCaps, neF7AutomaticRemoteBackupUsers=neF7AutomaticRemoteBackupUsers, controlPlaneWdmEntityIndexAid=controlPlaneWdmEntityIndexAid, neF7AutomaticRemoteBackupSrvDir=neF7AutomaticRemoteBackupSrvDir, neF7AutomaticBackupTable=neF7AutomaticBackupTable, YesNoNA=YesNoNA, IdentityTranslation=IdentityTranslation, fwDataProtectionPart=fwDataProtectionPart, TimMode=TimMode, oduTcmBDataTable=oduTcmBDataTable, oduSectionConfigSignalDegradeThres=oduSectionConfigSignalDegradeThres, oduSectionDataTable=oduSectionDataTable, swDbFileArea=swDbFileArea, ProtectionMechCaps=ProtectionMechCaps, clearRdiskRequest=clearRdiskRequest, oduTcmCDataTraceReceivedOpsp=oduTcmCDataTraceReceivedOpsp, neEventLogVarType=neEventLogVarType, neEventLogVarOctetStringVal=neEventLogVarOctetStringVal, oduTcmAConfigTraceTransmitSapi=oduTcmAConfigTraceTransmitSapi, entityIndex=entityIndex, EnableState=EnableState, otuConfig=otuConfig, containsEntry=containsEntry, StandbyServiceAffecting=StandbyServiceAffecting, controlPlaneEthEntityIndexAid=controlPlaneEthEntityIndexAid, snmpProxyServerPort=snmpProxyServerPort, EthDuplexModeCaps=EthDuplexModeCaps, ServiceImpairment=ServiceImpairment, oduTcmAConfigTraceExpected=oduTcmAConfigTraceExpected, neEventLogIdentityTranslation=neEventLogIdentityTranslation, oduTcmBConfigSignalDegradePeriod=oduTcmBConfigSignalDegradePeriod, DestinationNodeOrAgentState=DestinationNodeOrAgentState, oduTcmAConfigTcmLevel=oduTcmAConfigTcmLevel, events=events, controlPlaneOtnEntityIndex=controlPlaneOtnEntityIndex, neMemorySizeFree=neMemorySizeFree, FspDate=FspDate, containsIndex=containsIndex, vtpEntityClassInstanceNumber=vtpEntityClassInstanceNumber, neF7AutomaticRemoteBackupTimeStamp=neF7AutomaticRemoteBackupTimeStamp, neStorageAvailable=neStorageAvailable, inventoryVendorId=inventoryVendorId, swDbFileEntry=swDbFileEntry, oduTcmCDataTraceReceivedDapi=oduTcmCDataTraceReceivedDapi, config=config, controlPlaneEthEntityClass=controlPlaneEthEntityClass, neInfo=neInfo, provEquipmentState=provEquipmentState, oduTcmBConfigTraceExpected=oduTcmBConfigTraceExpected, coldRestartCapServiceAffectingCap=coldRestartCapServiceAffectingCap, LogicalIfTransportCaps=LogicalIfTransportCaps, fwDataEntry=fwDataEntry, inventoryPartnumber=inventoryPartnumber, entityType=entityType, swDbDataCapRestoreConfig=swDbDataCapRestoreConfig, entityContainedIn=entityContainedIn, fwDataServiceImpairment=fwDataServiceImpairment, swDbFilePgmType=swDbFilePgmType, encryptionFwpFile=encryptionFwpFile, swDbFileTable=swDbFileTable, oduTcmBConfigTraceTransmitDapi=oduTcmBConfigTraceTransmitDapi, oduSectionDataTraceReceivedDapi=oduSectionDataTraceReceivedDapi, neEventLogVarUnsigned32Val=neEventLogVarUnsigned32Val, neTrapsinkRowStatus=neTrapsinkRowStatus, neStorageIndex=neStorageIndex, SourceIpAddress=SourceIpAddress, fsp3000alm=fsp3000alm, sonetSectionConfigSignalDegradeThreshhold=sonetSectionConfigSignalDegradeThreshhold, oduTcmADataEntry=oduTcmADataEntry, ServiceAffectingCaps=ServiceAffectingCaps, SonetTimingSource=SonetTimingSource, fwDataFirmwarePackageRevBackup=fwDataFirmwarePackageRevBackup, neEventLogVarOidVal=neEventLogVarOidVal, neSwUpgradeState=neSwUpgradeState, Counter64String=Counter64String, aosCommon=aosCommon, neSwUpgradeType=neSwUpgradeType, ptpEntityClass=ptpEntityClass, eqpFwEqpType=eqpFwEqpType, ncuActivationTime=ncuActivationTime, oduTcmBConfigTraceTransmitSapi=oduTcmBConfigTraceTransmitSapi, entityClassInstanceNumber=entityClassInstanceNumber, oduTcmBDataTraceReceivedDapi=oduTcmBDataTraceReceivedDapi, eqpFwServiceImpairment=eqpFwServiceImpairment, entityIndexAid=entityIndexAid, fsp3000c=fsp3000c, neSwUpgradeNeDirectory=neSwUpgradeNeDirectory, fwDataActivationReadyOnStandby=fwDataActivationReadyOnStandby, vtpEntityType=vtpEntityType, oduTcmCConfigTimMode=oduTcmCConfigTimMode, otuSectionDataResultingTotalBitrate=otuSectionDataResultingTotalBitrate)
mibBuilder.exportSymbols("ADVA-MIB", neSwDownloadProgress=neSwDownloadProgress, controlPlaneEthEntityClassInstanceNumber=controlPlaneEthEntityClassInstanceNumber, swDbDataProgramVersion=swDbDataProgramVersion, fsp2000=fsp2000, ApsHoldoffTime=ApsHoldoffTime, containsTable=containsTable, neSwUpgradeServerPasswd=neSwUpgradeServerPasswd, fwDataStandbyServiceImpairment=fwDataStandbyServiceImpairment, oduSectionConfigTraceTransmitOpsp=oduSectionConfigTraceTransmitOpsp, AssignmentState=AssignmentState, oduTcmCConfigTraceTransmitDapi=oduTcmCConfigTraceTransmitDapi, oduTcmBDataEntry=oduTcmBDataEntry, neBackupRestoreState=neBackupRestoreState, transportStandards=transportStandards, provContainerEntry=provContainerEntry, PgmType=PgmType, entityTable=entityTable, fsp1000=fsp1000, NeSwInstallStatusType=NeSwInstallStatusType, NeSwUpgradeStatusType=NeSwUpgradeStatusType, swDbFileComment=swDbFileComment, LoopConfig=LoopConfig, otuSectionDataEntry=otuSectionDataEntry, swDbDataNumSaNotReady=swDbDataNumSaNotReady, FspR7Date=FspR7Date, snmpWriteAccessEntry=snmpWriteAccessEntry, neTrapsinkUserName=neTrapsinkUserName, vtpEntityIndexAid=vtpEntityIndexAid, neMemorySizeTotal=neMemorySizeTotal, VirtualContainerTypeCaps=VirtualContainerTypeCaps, oduSectionConfigTable=oduSectionConfigTable, controlPlaneWdmEntityAssignmentState=controlPlaneWdmEntityAssignmentState, swDbFileSize=swDbFileSize, neSoftwareUpgrade=neSoftwareUpgrade, neEventLogVarTable=neEventLogVarTable, VirtualContainerType=VirtualContainerType, coldRestartCapTable=coldRestartCapTable, software=software, neEventsLogged=neEventsLogged, controlPlaneWdmEntityClassInstanceNumber=controlPlaneWdmEntityClassInstanceNumber, EquipmentState=EquipmentState, oduTcmCConfigTable=oduTcmCConfigTable, controlPlaneOtnContainsTable=controlPlaneOtnContainsTable, controlPlaneOtnContainsEntry=controlPlaneOtnContainsEntry, snmpProxyServerSynchroStage=snmpProxyServerSynchroStage, fsp150=fsp150, FileArea=FileArea, swDbDataNumNativeNsaUpdate=swDbDataNumNativeNsaUpdate, swVersionInactiveOperatingSw=swVersionInactiveOperatingSw, eqpFwUpgradeRequest=eqpFwUpgradeRequest, eqpFwEqpServerBusy=eqpFwEqpServerBusy, neEventLogVarEntry=neEventLogVarEntry, neF7AutomaticRemoteBackupCommonIpSrv=neF7AutomaticRemoteBackupCommonIpSrv, inventoryMib=inventoryMib, swDbDataCapUpgradeRequest=swDbDataCapUpgradeRequest, oduTcmBConfigTimMode=oduTcmBConfigTimMode, oduSectionDataTraceReceivedOpsp=oduSectionDataTraceReceivedOpsp, swVersionInactiveApplSw=swVersionInactiveApplSw, AvailState=AvailState, neF7AutomaticBackupIndex=neF7AutomaticBackupIndex, FspR7TrapsinkLifetime=FspR7TrapsinkLifetime, controlPlaneOtnEntityTable=controlPlaneOtnEntityTable, PYSNMP_MODULE_ID=advaMIB, neEventLogEntry=neEventLogEntry, neManufacturer=neManufacturer, swDbDataStandbyPartitionStatus=swDbDataStandbyPartitionStatus, EntityType=EntityType, OnOff=OnOff, oduTcmAConfigTraceTransmitOpsp=oduTcmAConfigTraceTransmitOpsp, Grade=Grade, inventoryFpgaRev=inventoryFpgaRev, controlPlaneEthEntityAssignmentState=controlPlaneEthEntityAssignmentState, neInitialConnectionMode=neInitialConnectionMode, inventoryHardwareRev=inventoryHardwareRev, snmpWriteAccessRestriction=snmpWriteAccessRestriction, oduTcmBConfigTcmLevel=oduTcmBConfigTcmLevel, inventorySerialNum=inventorySerialNum, controlPlaneWdmEntityIndex=controlPlaneWdmEntityIndex, snmpProxyEntrySingleTargetOutTable=snmpProxyEntrySingleTargetOutTable, oduTcmCDataEntry=oduTcmCDataEntry, inventoryType=inventoryType, ncuActivationDate=ncuActivationDate, swDbDataRestoreConfig=swDbDataRestoreConfig, swDbFileFileName=swDbFileFileName, TimModeCaps=TimModeCaps, neTrapsinkType=neTrapsinkType, provContainerTable=provContainerTable, otuSectionConfigTraceTransmitDapi=otuSectionConfigTraceTransmitDapi, ptpEntityTable=ptpEntityTable, neTrapsinkCommunity=neTrapsinkCommunity, ArcState=ArcState, fwDataTable=fwDataTable, EthDuplexMode=EthDuplexMode, ncuScheduledActivation=ncuScheduledActivation, neAutoBackupInterval=neAutoBackupInterval, neEventLogVarIndex=neEventLogVarIndex, neF7AutomaticRemoteBackupSrvLogin=neF7AutomaticRemoteBackupSrvLogin, oduTcmCDataTable=oduTcmCDataTable, sonetSectionConfigTimMode=sonetSectionConfigTimMode, neBackupEncryption=neBackupEncryption, oduTcmBConfigTraceTransmitOpsp=oduTcmBConfigTraceTransmitOpsp, neEventLogVarInteger32Val=neEventLogVarInteger32Val, selectedFile=selectedFile, neSwUpgradeCommonIpSrv=neSwUpgradeCommonIpSrv, controlPlaneOtnEntityContainedIn=controlPlaneOtnEntityContainedIn, swDbDataDefaultsUpgradeRequest=swDbDataDefaultsUpgradeRequest, fspR7=fspR7, sonetSectionConfigTraceTransmit=sonetSectionConfigTraceTransmit, ptpEntityEquipmentState=ptpEntityEquipmentState, snmpProxyServerSynchroState=snmpProxyServerSynchroState, vtpEntityReferencedTo=vtpEntityReferencedTo, swDbDataNcuSoftwareVersion=swDbDataNcuSoftwareVersion, swDbDataActivationTime=swDbDataActivationTime, otuSectionConfigTraceExpected=otuSectionConfigTraceExpected, swVersionTable=swVersionTable, fsp1000adm=fsp1000adm, swDbDataNumEqpt=swDbDataNumEqpt, swDbDataCapTable=swDbDataCapTable, neF7AutomaticBackupStartTime=neF7AutomaticBackupStartTime, swDbDataIndex=swDbDataIndex, oduTcmCConfigTcmLevel=oduTcmCConfigTcmLevel, swDbDataNumNsaNotReady=swDbDataNumNsaNotReady, ptpEntityClassInstanceNumber=ptpEntityClassInstanceNumber, swDbFileGrade=swDbFileGrade, neBackupRestoreRequest=neBackupRestoreRequest, controlPlaneEthContainsIndex=controlPlaneEthContainsIndex, controlPlaneOtnEntityIndexAid=controlPlaneOtnEntityIndexAid, KBytes=KBytes, ptpEntityEntry=ptpEntityEntry, controlPlaneWdmEntityContainedIn=controlPlaneWdmEntityContainedIn, oduTcmADataTable=oduTcmADataTable, snmpWriteAccessNmsAddress=snmpWriteAccessNmsAddress, swDbFileCreationTime=swDbFileCreationTime, ApsDirection=ApsDirection, neSwUpgradeServerDirectory=neSwUpgradeServerDirectory, neSwUpgradeServerLogin=neSwUpgradeServerLogin, installedEqpt=installedEqpt, sonetSectionDataTable=sonetSectionDataTable, ProtectionMech=ProtectionMech, neF7AutomaticRemoteBackupSrvIp=neF7AutomaticRemoteBackupSrvIp, fwDataFirmwarePackageRev=fwDataFirmwarePackageRev, neTrapsinkTable=neTrapsinkTable, inventoryCfSerialNum=inventoryCfSerialNum, controlPlaneOtnEntityClassInstanceNumber=controlPlaneOtnEntityClassInstanceNumber, SonetTraceFormCaps=SonetTraceFormCaps, FspR7YesNo=FspR7YesNo, inventoryTable=inventoryTable, FspR7FalseTrue=FspR7FalseTrue, swDbFileIndex=swDbFileIndex, inventoryUnitName=inventoryUnitName, otuSectionConfigEntry=otuSectionConfigEntry, CommandEqpt=CommandEqpt, advaMIB=advaMIB, swDbFileType=swDbFileType, oduSectionDataEntry=oduSectionDataEntry, SonetVcBundleAllocation=SonetVcBundleAllocation, oduTcmCConfigSignalDegradePeriod=oduTcmCConfigSignalDegradePeriod, inventorySoftwareRev=inventorySoftwareRev, neTrapsinkPort=neTrapsinkPort, neF7AutomaticRemoteBackupEncryption=neF7AutomaticRemoteBackupEncryption, oduTcmAConfigTable=oduTcmAConfigTable, aosProducts=aosProducts, otuSectionDataTable=otuSectionDataTable, swDbDataDefaultsTable=swDbDataDefaultsTable, snmpProxyEntrySingleTargetOutEntry=snmpProxyEntrySingleTargetOutEntry, RestoreActivation=RestoreActivation, oduTcmCConfigTraceExpected=oduTcmCConfigTraceExpected, F7FileTimeStamp=F7FileTimeStamp, eqpFwNcuServerBusy=eqpFwNcuServerBusy, NoYesNA=NoYesNA, TrapCounter=TrapCounter, neF7AutomaticBackupStartDate=neF7AutomaticBackupStartDate, oduTcmBDataTraceReceivedSapi=oduTcmBDataTraceReceivedSapi, ncuActivationTimeUtc=ncuActivationTimeUtc, otuSectionDataTraceReceivedSapi=otuSectionDataTraceReceivedSapi, neSwUpgradeFileName=neSwUpgradeFileName, ncuScheduledDbRestore=ncuScheduledDbRestore, neF7AutomaticBackupEntry=neF7AutomaticBackupEntry, oduTcmAConfigSignalDegradeThreshold=oduTcmAConfigSignalDegradeThreshold, oduTcmADataTraceReceivedSapi=oduTcmADataTraceReceivedSapi, ptpEntityContainedIn=ptpEntityContainedIn, OtnPayloadType=OtnPayloadType, controlPlaneEthContainsTable=controlPlaneEthContainsTable, swDbDataNumLegacyUpdate=swDbDataNumLegacyUpdate, updateBackupRestoreMib=updateBackupRestoreMib, entityEquipmentState=entityEquipmentState, neMibVariant=neMibVariant, fwDataStandbyFirmwareAvailable=fwDataStandbyFirmwareAvailable, inventoryCfModel=inventoryCfModel, oduTcmBConfigEntry=oduTcmBConfigEntry, controlPlaneOtnEntityEntry=controlPlaneOtnEntityEntry, controlPlaneOtnEntityClass=controlPlaneOtnEntityClass, vtpEntityAssignmentState=vtpEntityAssignmentState, oduSectionConfigTimMode=oduSectionConfigTimMode, inventoryGradeInventory=inventoryGradeInventory, otuSectionConfigPayload=otuSectionConfigPayload, neF7AutomaticRemoteBackupPassword=neF7AutomaticRemoteBackupPassword, FspR7EnableDisable=FspR7EnableDisable, SonetSectSigDegThresCaps=SonetSectSigDegThresCaps, neBackupUsers=neBackupUsers, neF7AutomaticBackupInterval=neF7AutomaticBackupInterval, snmpProxyEntrySingleTargetOutRowStatus=snmpProxyEntrySingleTargetOutRowStatus, ApsHoldoffTimeCaps=ApsHoldoffTimeCaps, swVersionActiveOperatingSw=swVersionActiveOperatingSw, controlPlaneWdmEntityTable=controlPlaneWdmEntityTable, oduSectionConfigTraceTransmitSapi=oduSectionConfigTraceTransmitSapi, vtpEntityIndex=vtpEntityIndex, controlPlaneWdmContainsIndex=controlPlaneWdmContainsIndex, oduTcmAConfigEntry=oduTcmAConfigEntry, otuSectionConfigSignalDegradeThreshold=otuSectionConfigSignalDegradeThreshold, EntityIndex=EntityIndex, snmpWriteAccessNmsName=snmpWriteAccessNmsName, ptpEntityAssignmentState=ptpEntityAssignmentState, otuSectionConfigTraceTransmitOpsp=otuSectionConfigTraceTransmitOpsp, controlPlaneEthEntityTable=controlPlaneEthEntityTable, neEventLogTable=neEventLogTable, oduTcmCDataTraceReceivedSapi=oduTcmCDataTraceReceivedSapi, ptpEntityIndex=ptpEntityIndex, swDbFileRowStatus=swDbFileRowStatus, fwDataFirmwareAvailable=fwDataFirmwareAvailable, sonetSectionConfigTable=sonetSectionConfigTable, oduTcmADataTraceReceivedDapi=oduTcmADataTraceReceivedDapi, neDateAndTime=neDateAndTime, swDbDataDefaultsRestoreConfig=swDbDataDefaultsRestoreConfig, neBackupRestoreFile=neBackupRestoreFile, controlPlaneEthEntityContainedIn=controlPlaneEthEntityContainedIn, controlPlaneOtnEntityAssignmentState=controlPlaneOtnEntityAssignmentState, neEventLogVarIpAddressVal=neEventLogVarIpAddressVal, fwDataStandbyVersion=fwDataStandbyVersion, oduSectionConfigTraceExpected=oduSectionConfigTraceExpected, neSwInstallState=neSwInstallState, oduTcmBDataTraceReceivedOpsp=oduTcmBDataTraceReceivedOpsp, entityAssignmentState=entityAssignmentState, controlPlaneEthEntityEntry=controlPlaneEthEntityEntry, ptpEntityReferencedTo=ptpEntityReferencedTo, neRestoreConfig=neRestoreConfig)
