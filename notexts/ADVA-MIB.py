...
mibBuilder.exportSymbols("ADVA-MIB", swDbFileComment=swDbFileComment, swDbFileTable=swDbFileTable, otuSectionConfigTable=otuSectionConfigTable, SnmpProxySynchronizationStage=SnmpProxySynchronizationStage, AssignmentState=AssignmentState, oduTcmBConfigTimMode=oduTcmBConfigTimMode, controlPlaneWdmEntityAssignmentState=controlPlaneWdmEntityAssignmentState, fwDataNewVersion=fwDataNewVersion, fwDataForm=fwDataForm, swDbDataNumNativeSaUpdate=swDbDataNumNativeSaUpdate, neF7AutomaticRemoteBackupProtocol=neF7AutomaticRemoteBackupProtocol, sonetSectionConfigTimMode=sonetSectionConfigTimMode, otuSectionConfigSignalDegradeThreshold=otuSectionConfigSignalDegradeThreshold, EquipmentState=EquipmentState, neSwUpgradeNeDirectory=neSwUpgradeNeDirectory, aos=aos, eqpFwEqpType=eqpFwEqpType, ArcState=ArcState, neStorageCapacity=neStorageCapacity, common=common, swDbDataProgramVersion=swDbDataProgramVersion, oduTcmAConfigTimMode=oduTcmAConfigTimMode, oduTcmADataEntry=oduTcmADataEntry, controlPlaneWdmEntityContainedIn=controlPlaneWdmEntityContainedIn, neStorageTable=neStorageTable, FspR7YesNo=FspR7YesNo, fwDataTable=fwDataTable, swDbDataCapRestoreConfig=swDbDataCapRestoreConfig, updateEqpt=updateEqpt, fsp3000alm=fsp3000alm, ncuActivationDateUtc=ncuActivationDateUtc, fwDataBootStatus=fwDataBootStatus, IdentityTranslation=IdentityTranslation, VirtualContainerType=VirtualContainerType, FspR7Date=FspR7Date, inventoryMacAddress=inventoryMacAddress, snmpProxyEntrySingleTargetOutNodeAgentStatus=snmpProxyEntrySingleTargetOutNodeAgentStatus, swVersionEntry=swVersionEntry, LoopConfig=LoopConfig, controlPlaneWdmEntityEntry=controlPlaneWdmEntityEntry, snmpWriteAccessNmsName=snmpWriteAccessNmsName, vtpEntityReferencedTo=vtpEntityReferencedTo, sonetSectionDataEntry=sonetSectionDataEntry, FileArea=FileArea, oduTcmADataTable=oduTcmADataTable, fwDataStandbyServiceImpairment=fwDataStandbyServiceImpairment, swDbDataEntry=swDbDataEntry, neEventLogVarTable=neEventLogVarTable, snmpWriteAccessRestriction=snmpWriteAccessRestriction, snmpProxyEntrySingleTargetOutPort=snmpProxyEntrySingleTargetOutPort, inventoryGradeInventory=inventoryGradeInventory, neEventsLogged=neEventsLogged, neMemorySizeTotal=neMemorySizeTotal, eqpFwNextEqpForUpdate=eqpFwNextEqpForUpdate, BootState=BootState, neEventLogVarOidVal=neEventLogVarOidVal, snmpWriteAccessTable=snmpWriteAccessTable, OtnPayloadType=OtnPayloadType, F7AutoBackupInterval=F7AutoBackupInterval, neSwUpgradeType=neSwUpgradeType, oduTcmCDataTraceReceivedDapi=oduTcmCDataTraceReceivedDapi, controlPlaneOtnContainsIndex=controlPlaneOtnContainsIndex, neBackupPassword=neBackupPassword, swDbDataDefaultsEntry=swDbDataDefaultsEntry, neF7AutomaticBackupTimeStamp=neF7AutomaticBackupTimeStamp, fwDataStandbyVersion=fwDataStandbyVersion, fwDataFirmwarePackageRev=fwDataFirmwarePackageRev, PgmType=PgmType, swDbFileEntry=swDbFileEntry, SonetTimingSource=SonetTimingSource, PYSNMP_MODULE_ID=advaMIB, neF7AutomaticRemoteBackupEncryption=neF7AutomaticRemoteBackupEncryption, otuSectionDataEntry=otuSectionDataEntry, SonetTimingSourceCaps=SonetTimingSourceCaps, ncuScheduledDbRestore=ncuScheduledDbRestore, neStorageDescr=neStorageDescr, NeSwUpgradeStatusType=NeSwUpgradeStatusType, neInfo=neInfo, inventoryUniversalSerialIdent=inventoryUniversalSerialIdent, FspR7EnableDisable=FspR7EnableDisable, vtpEntityAssignmentState=vtpEntityAssignmentState, OnOff=OnOff, controlPlaneOtnEntityIndex=controlPlaneOtnEntityIndex, swDbDataTable=swDbDataTable, neTrapsinkEntry=neTrapsinkEntry, NoYesNA=NoYesNA, RestoreActivationCaps=RestoreActivationCaps, swDbDataDatabaseVersion=swDbDataDatabaseVersion, OtnTcmLevelCaps=OtnTcmLevelCaps, oduSectionConfigTraceTransmitOpsp=oduSectionConfigTraceTransmitOpsp, neBackupEncryption=neBackupEncryption, inventoryFirmwarePackageRev=inventoryFirmwarePackageRev, oduTcmBConfigTraceTransmitSapi=oduTcmBConfigTraceTransmitSapi, sonetSectionConfigTraceForm=sonetSectionConfigTraceForm, VirtualContainerTypeCaps=VirtualContainerTypeCaps, PartitionStatus=PartitionStatus, vtpEntityEntry=vtpEntityEntry, swDbDataNumNativeNsaUpdate=swDbDataNumNativeNsaUpdate, ProtectionMechCaps=ProtectionMechCaps, OtnPayloadTypeCaps=OtnPayloadTypeCaps, updateBackupRestoreMib=updateBackupRestoreMib, oduTcmCConfigTraceTransmitOpsp=oduTcmCConfigTraceTransmitOpsp, oduConfig=oduConfig, sonetSectionConfigTraceExpected=sonetSectionConfigTraceExpected, oduSectionDataTraceReceivedOpsp=oduSectionDataTraceReceivedOpsp, swDbDataCapTable=swDbDataCapTable, oduTcmCDataTraceReceivedOpsp=oduTcmCDataTraceReceivedOpsp, neMemorySizeFree=neMemorySizeFree, inventoryPartnumber=inventoryPartnumber, TimModeCaps=TimModeCaps, oduSectionConfigSignalDegradePeriod=oduSectionConfigSignalDegradePeriod, OtnTcmLevel=OtnTcmLevel, oduTcmBConfigSignalDegradePeriod=oduTcmBConfigSignalDegradePeriod, fwDataProtectionPart=fwDataProtectionPart, inventorySerialNum=inventorySerialNum, neRestoreFileBackupDate=neRestoreFileBackupDate, oduTcmAConfigTcmLevel=oduTcmAConfigTcmLevel, Counter64String=Counter64String, AvailState=AvailState, inventoryVendorId=inventoryVendorId, oduTcmAConfigTraceTransmitOpsp=oduTcmAConfigTraceTransmitOpsp, neTrapsinkUserName=neTrapsinkUserName, fsp150=fsp150, sonetSectionDataTraceReceived=sonetSectionDataTraceReceived, neF7AutomaticBackupInterval=neF7AutomaticBackupInterval, neF7AutomaticBackupRunState=neF7AutomaticBackupRunState, sonetSectionConfigTraceTransmit=sonetSectionConfigTraceTransmit, oduTcmBDataTraceReceivedOpsp=oduTcmBDataTraceReceivedOpsp, ptpEntityReferencedTo=ptpEntityReferencedTo, LogicalIfTransportCaps=LogicalIfTransportCaps, ptpEntityClassInstanceNumber=ptpEntityClassInstanceNumber, FspDate=FspDate, EthDuplexMode=EthDuplexMode, swDbDataRestoreConfig=swDbDataRestoreConfig, aosCommon=aosCommon, FspR7FalseTrue=FspR7FalseTrue, otn=otn, neSwUpgradeServerLogin=neSwUpgradeServerLogin, neAutoBackupServerAddress=neAutoBackupServerAddress, entityEntry=entityEntry, installedEqpt=installedEqpt, swDbFileGrade=swDbFileGrade, neF7AutomaticRemoteBackupSrcIp=neF7AutomaticRemoteBackupSrcIp, oduTcmBConfigSignalDegradeThreshold=oduTcmBConfigSignalDegradeThreshold, controlPlaneWdmEntityTable=controlPlaneWdmEntityTable, fsp1000adm=fsp1000adm, neEventLogIdentityTranslation=neEventLogIdentityTranslation, controlPlaneWdmContainsIndex=controlPlaneWdmContainsIndex, oduTcmBConfigTraceTransmitDapi=oduTcmBConfigTraceTransmitDapi, swDbFileVersion=swDbFileVersion, coldRestartCapEntry=coldRestartCapEntry, provContainerEntry=provContainerEntry, neSwUpgradeServerPasswd=neSwUpgradeServerPasswd, oduTcmCConfigTable=oduTcmCConfigTable, vtpEntityClassInstanceNumber=vtpEntityClassInstanceNumber, neStorageIndex=neStorageIndex, neF7AutomaticRemoteBackupSrvDir=neF7AutomaticRemoteBackupSrvDir, oduSectionDataTraceReceivedDapi=oduSectionDataTraceReceivedDapi, oduTcmCConfigSignalDegradeThreshold=oduTcmCConfigSignalDegradeThreshold, oduTcmBDataTraceReceivedDapi=oduTcmBDataTraceReceivedDapi, snmpProxyEntrySingleTargetOutTable=snmpProxyEntrySingleTargetOutTable, neAutoBackupInterval=neAutoBackupInterval, oduTcmCConfigEntry=oduTcmCConfigEntry, FspR7UsersDb=FspR7UsersDb, ptpEntityAssignmentState=ptpEntityAssignmentState, otuSectionDataTraceReceivedOpsp=otuSectionDataTraceReceivedOpsp, ProtectionMech=ProtectionMech, oduTcmCConfigSignalDegradePeriod=oduTcmCConfigSignalDegradePeriod, fsp2000=fsp2000, oduTcmBConfigTraceTransmitOpsp=oduTcmBConfigTraceTransmitOpsp, FspR7AdminStateSnmpProxy=FspR7AdminStateSnmpProxy, swVersionInactiveOperatingSw=swVersionInactiveOperatingSw, neSwUpgradeTransferProtocol=neSwUpgradeTransferProtocol, neEventLogVarInteger32Val=neEventLogVarInteger32Val, OhTerminationLevel=OhTerminationLevel, sonetSectionConfigTimingSource=sonetSectionConfigTimingSource, oduTcmCConfigTraceExpected=oduTcmCConfigTraceExpected, controlPlaneEthContainsEntry=controlPlaneEthContainsEntry, oduTcmAConfigEntry=oduTcmAConfigEntry, inventoryFpgaRev=inventoryFpgaRev, SnmpProxySynchronizationState=SnmpProxySynchronizationState, swDbFilePgmType=swDbFilePgmType, oduTcmCConfigTraceTransmitSapi=oduTcmCConfigTraceTransmitSapi, neSoftwareUpgrade=neSoftwareUpgrade, swVersionActiveOperatingSw=swVersionActiveOperatingSw, oduTcmAConfigSignalDegradeThreshold=oduTcmAConfigSignalDegradeThreshold, oduTcmCConfigTraceTransmitDapi=oduTcmCConfigTraceTransmitDapi, vtpEntityContainedIn=vtpEntityContainedIn, inventoryCfSerialNum=inventoryCfSerialNum, NcuAutoActivation=NcuAutoActivation, neF7AutomaticRemoteBackupSrvIp=neF7AutomaticRemoteBackupSrvIp, otuConfig=otuConfig, SonetTraceFormCaps=SonetTraceFormCaps, eqpFwUpgradeRequest=eqpFwUpgradeRequest, sonetSectionDataTable=sonetSectionDataTable, controlPlaneEthEntityClass=controlPlaneEthEntityClass, oduTcmAConfigTraceExpected=oduTcmAConfigTraceExpected, snmpProxyServerSynchroState=snmpProxyServerSynchroState, oduTcmCDataTraceReceivedSapi=oduTcmCDataTraceReceivedSapi, fsp3000=fsp3000, swDbDataActivationTime=swDbDataActivationTime, FspR7Time=FspR7Time, otuSectionConfigTraceTransmitDapi=otuSectionConfigTraceTransmitDapi, oduTcmCDataTable=oduTcmCDataTable, entityClass=entityClass, snmpProxyEntrySingleTargetOutRowStatus=snmpProxyEntrySingleTargetOutRowStatus, fsp1000=fsp1000, EthDuplexModeCaps=EthDuplexModeCaps, controlPlaneEthEntityTable=controlPlaneEthEntityTable, controlPlaneEthContainsIndex=controlPlaneEthContainsIndex, fwDataEntry=fwDataEntry, SonetVcBundleAllocationCaps=SonetVcBundleAllocationCaps, entityEquipmentState=entityEquipmentState, neStorageEntry=neStorageEntry, neTrapsinkType=neTrapsinkType, controlPlaneOtnEntityTable=controlPlaneOtnEntityTable, controlPlaneEthEntityClassInstanceNumber=controlPlaneEthEntityClassInstanceNumber, neAutoBackupNextActionAt=neAutoBackupNextActionAt, swDbDataIndex=swDbDataIndex, neAlarmStatus=neAlarmStatus, neTrapsinkCommunity=neTrapsinkCommunity, EntityClass=EntityClass, neF7AutomaticRemoteBackupTimeStamp=neF7AutomaticRemoteBackupTimeStamp, snmpProxyEntrySingleTargetOutAddress=snmpProxyEntrySingleTargetOutAddress, F7AutoBackupRunState=F7AutoBackupRunState, neSwUpgradeServerDirectory=neSwUpgradeServerDirectory, otuSectionConfigStuffing=otuSectionConfigStuffing, swDbDataDefaultsTable=swDbDataDefaultsTable, vtpEntityTable=vtpEntityTable, snmpWriteAccessEntry=snmpWriteAccessEntry, EntityType=EntityType, LoopConfigCaps=LoopConfigCaps, neDateAndTime=neDateAndTime, neEventLogVarOctetStringVal=neEventLogVarOctetStringVal, ncuActivationDate=ncuActivationDate, FspTime=FspTime, OhTerminationLevelCaps=OhTerminationLevelCaps, swDbFileArea=swDbFileArea, entityAssignmentState=entityAssignmentState, controlPlaneOtnContainsTable=controlPlaneOtnContainsTable, FileType=FileType, neStorageAvailable=neStorageAvailable, oduSectionConfigSignalDegradeThres=oduSectionConfigSignalDegradeThres, fwDataFirmwarePackageRevBackup=fwDataFirmwarePackageRevBackup, neF7AutomaticBackupIndex=neF7AutomaticBackupIndex, advaMIB=advaMIB, neBackupRestoreFile=neBackupRestoreFile, neSwUpgradeFileName=neSwUpgradeFileName, snmpAgent=snmpAgent, controlPlaneWdmContainsEntry=controlPlaneWdmContainsEntry, admin=admin, neF7AutomaticBackupStartTime=neF7AutomaticBackupStartTime, swDbDataNumEqpt=swDbDataNumEqpt, oduTcmADataTraceReceivedOpsp=oduTcmADataTraceReceivedOpsp)
mibBuilder.exportSymbols("ADVA-MIB", fwDataFirmwareApproved=fwDataFirmwareApproved, snmpProxyEntrySingleTargetOutUserName=snmpProxyEntrySingleTargetOutUserName, coldRestartCapServiceAffectingCap=coldRestartCapServiceAffectingCap, inventorySoftwareRev=inventorySoftwareRev, oduSectionConfigTable=oduSectionConfigTable, swDbDataCapUpgradeRequest=swDbDataCapUpgradeRequest, otuSectionConfigTraceTransmitOpsp=otuSectionConfigTraceTransmitOpsp, SonetSectSigDegThresCaps=SonetSectSigDegThresCaps, vtpEntityIndex=vtpEntityIndex, neF7AutomaticBackupStartDate=neF7AutomaticBackupStartDate, fspR7=fspR7, neEventLogVarType=neEventLogVarType, entityType=entityType, swDbFileFileName=swDbFileFileName, entityIndex=entityIndex, neEventLogNotificationOID=neEventLogNotificationOID, fwDataReadyForActivation=fwDataReadyForActivation, neEventLogTimeStamp=neEventLogTimeStamp, neBackupRestore=neBackupRestore, swDbDataDefaultsRestoreConfig=swDbDataDefaultsRestoreConfig, otuSectionConfigPayload=otuSectionConfigPayload, snmpProxyEntrySingleTargetOutAdminState=snmpProxyEntrySingleTargetOutAdminState, neEventLogVarCounter64Val=neEventLogVarCounter64Val, CommandEqpt=CommandEqpt, swDbDataStandbyPartitionStatus=swDbDataStandbyPartitionStatus, oduSectionConfigTimMode=oduSectionConfigTimMode, neF7AutomaticRemoteBackupSrvLogin=neF7AutomaticRemoteBackupSrvLogin, controlPlaneEthContainsTable=controlPlaneEthContainsTable, swDbFileCreationTime=swDbFileCreationTime, neSwInstallState=neSwInstallState, oduTcmCConfigTcmLevel=oduTcmCConfigTcmLevel, fwDataFirmwareAvailable=fwDataFirmwareAvailable, EnableState=EnableState, neSwUpgradeRequest=neSwUpgradeRequest, oduTcmCConfigTimMode=oduTcmCConfigTimMode, inventoryCleiCode=inventoryCleiCode, neTrapsinkPort=neTrapsinkPort, ptpEntityTable=ptpEntityTable, sonetSectionConfigTable=sonetSectionConfigTable, otuSectionConfigSignalDegradePeriod=otuSectionConfigSignalDegradePeriod, oduSectionConfigTraceTransmitDapi=oduSectionConfigTraceTransmitDapi, events=events, TimMode=TimMode, ptpEntityContainedIn=ptpEntityContainedIn, oduTcmBConfigTable=oduTcmBConfigTable, neF7AutomaticBackupEntry=neF7AutomaticBackupEntry, neF7AutomaticBackupTable=neF7AutomaticBackupTable, swDbDataNumNsaNotReady=swDbDataNumNsaNotReady, swDbFileType=swDbFileType, eqpFwNcuServerBusy=eqpFwNcuServerBusy, FileTransferProtocol=FileTransferProtocol, oduSectionDataTable=oduSectionDataTable, controlPlaneOtnEntityAssignmentState=controlPlaneOtnEntityAssignmentState, ptpEntityIndex=ptpEntityIndex, fsp150cm=fsp150cm, sourceIpAddress=sourceIpAddress, neInitialConnectionMode=neInitialConnectionMode, ApsDirection=ApsDirection, otuSectionDataTraceReceivedDapi=otuSectionDataTraceReceivedDapi, vtpEntityType=vtpEntityType, Grade=Grade, sonet=sonet, swDbDataFirmwareSetVersion=swDbDataFirmwareSetVersion, containsTable=containsTable, ApsHoldoffTimeCaps=ApsHoldoffTimeCaps, RestoreActivation=RestoreActivation, EntityIndex=EntityIndex, software=software, snmpProxyEntrySingleTargetOutContext=snmpProxyEntrySingleTargetOutContext, sonetSectionConfigEntry=sonetSectionConfigEntry, swDbFileIndex=swDbFileIndex, neAutoBackupConfig=neAutoBackupConfig, oduTcmAConfigTraceTransmitDapi=oduTcmAConfigTraceTransmitDapi, aosProducts=aosProducts, swDbDataNumSaNotReady=swDbDataNumSaNotReady, otuSectionConfigTraceExpected=otuSectionConfigTraceExpected, CpWdmEntityClass=CpWdmEntityClass, inventoryUnitName=inventoryUnitName, fspNm=fspNm, fwDataStandbyFirmwareAvailable=fwDataStandbyFirmwareAvailable, oduTcmBDataEntry=oduTcmBDataEntry, swVersionTable=swVersionTable, swVersionActiveApplSw=swVersionActiveApplSw, inventoryHardwareRev=inventoryHardwareRev, clearRdiskRequest=clearRdiskRequest, ncuActivationTime=ncuActivationTime, entityContainedIn=entityContainedIn, controlPlaneOtnEntityClass=controlPlaneOtnEntityClass, containsEntry=containsEntry, oduSectionDataEntry=oduSectionDataEntry, neEventLogIndex=neEventLogIndex, transportStandards=transportStandards, neAutoBackup=neAutoBackup, swAdmin=swAdmin, YesNoNA=YesNoNA, swDbFileSize=swDbFileSize, sonetSectionConfigSignalDegradePeriod=sonetSectionConfigSignalDegradePeriod, controlPlaneEthEntityContainedIn=controlPlaneEthEntityContainedIn, otuSectionConfigEntry=otuSectionConfigEntry, neManufacturer=neManufacturer, vtpEntityEquipmentState=vtpEntityEquipmentState, swVersionInactiveApplSw=swVersionInactiveApplSw, NeSwInstallStatusType=NeSwInstallStatusType, swVersionNextBoot=swVersionNextBoot, neEventLogEntry=neEventLogEntry, TrapCounter=TrapCounter, sonetSectionConfigSignalDegradeThreshhold=sonetSectionConfigSignalDegradeThreshhold, controlPlaneOtnEntityContainedIn=controlPlaneOtnEntityContainedIn, neF7AutomaticBackupNextDate=neF7AutomaticBackupNextDate, LogicalIfTransport=LogicalIfTransport, neTrapsinkTable=neTrapsinkTable, controlPlaneEthEntityAssignmentState=controlPlaneEthEntityAssignmentState, ptpEntityType=ptpEntityType, ptpEntityClass=ptpEntityClass, oduTcmAConfigSignalDegradePeriod=oduTcmAConfigSignalDegradePeriod, neSwDownloadProgress=neSwDownloadProgress, inventoryCfModel=inventoryCfModel, neF7AutomaticRemoteBackupSrvPass=neF7AutomaticRemoteBackupSrvPass, neF7AutomaticRemoteBackupUsers=neF7AutomaticRemoteBackupUsers, ncuActivationTimeUtc=ncuActivationTimeUtc, oduTcmADataTraceReceivedSapi=oduTcmADataTraceReceivedSapi, controlPlaneEthEntityIndexAid=controlPlaneEthEntityIndexAid, entityTable=entityTable, ServiceAffectingCaps=ServiceAffectingCaps, ptpEntityEntry=ptpEntityEntry, ApsHoldoffTime=ApsHoldoffTime, inventoryTable=inventoryTable, vtpEntityIndexAid=vtpEntityIndexAid, dbAdmin=dbAdmin, neSwUpgradeServerAddress=neSwUpgradeServerAddress, fsp1500=fsp1500, ptpEntityEquipmentState=ptpEntityEquipmentState, neF7AutomaticRemoteBackupCommonIpSrv=neF7AutomaticRemoteBackupCommonIpSrv, SonetVcBundleAllocation=SonetVcBundleAllocation, KBytes=KBytes, provEquipmentState=provEquipmentState, neAutoBackupServerDirectory=neAutoBackupServerDirectory, snmpProxyEntrySingleTargetOutEntry=snmpProxyEntrySingleTargetOutEntry, neTrapsinkVersion=neTrapsinkVersion, FspR7EquipmentTypeCaps=FspR7EquipmentTypeCaps, DestinationNodeOrAgentState=DestinationNodeOrAgentState, entityIndexAid=entityIndexAid, entityClassInstanceNumber=entityClassInstanceNumber, products=products, controlPlaneOtnContainsEntry=controlPlaneOtnContainsEntry, oduSectionDataTraceReceivedSapi=oduSectionDataTraceReceivedSapi, neTrapsinkAddress=neTrapsinkAddress, snmpProxyServerAdminState=snmpProxyServerAdminState, controlPlaneWdmContainsTable=controlPlaneWdmContainsTable, config=config, otuSectionDataTraceReceivedSapi=otuSectionDataTraceReceivedSapi, neAutoBackupServerLogin=neAutoBackupServerLogin, controlPlaneOtnEntityClassInstanceNumber=controlPlaneOtnEntityClassInstanceNumber, neEventLogVarId=neEventLogVarId, neTrapsinkRowStatus=neTrapsinkRowStatus, oduTcmBDataTraceReceivedSapi=oduTcmBDataTraceReceivedSapi, swDbDataNumLegacyUpdate=swDbDataNumLegacyUpdate, snmpProxyServerSynchroStage=snmpProxyServerSynchroStage, TrapAlarmSeverity=TrapAlarmSeverity, containsIndex=containsIndex, controlPlaneWdmEntityClassInstanceNumber=controlPlaneWdmEntityClassInstanceNumber, inventoryMib=inventoryMib, F7FileTimeStamp=F7FileTimeStamp, ptpEntityIndexAid=ptpEntityIndexAid, eqpFwServiceImpairment=eqpFwServiceImpairment, snmpServerPort=snmpServerPort, neSwUpgradeState=neSwUpgradeState, neEventLogVarEntry=neEventLogVarEntry, neMibVariant=neMibVariant, oduTcmBConfigTcmLevel=oduTcmBConfigTcmLevel, swDbDataArea=swDbDataArea, vtpEntityClass=vtpEntityClass, swDbDataNcuSoftwareVersion=swDbDataNcuSoftwareVersion, snmpWriteAccessNmsAddress=snmpWriteAccessNmsAddress, eqpFwEqpServerBusy=eqpFwEqpServerBusy, controlPlaneWdmEntityIndex=controlPlaneWdmEntityIndex, controlPlaneEthEntityEntry=controlPlaneEthEntityEntry, SourceIpAddress=SourceIpAddress, neEventLogVarIpAddressVal=neEventLogVarIpAddressVal, neAutoBackupServerPasswd=neAutoBackupServerPasswd, EnableStateCaps=EnableStateCaps, inventoryEntry=inventoryEntry, neBackupUsers=neBackupUsers, SonetTraceForm=SonetTraceForm, controlPlaneOtnEntityEntry=controlPlaneOtnEntityEntry, neEventLogVarIndex=neEventLogVarIndex, otuSectionConfigTimMode=otuSectionConfigTimMode, oduTcmAConfigTable=oduTcmAConfigTable, controlPlaneWdmEntityClass=controlPlaneWdmEntityClass, otuSectionConfigTraceTransmitSapi=otuSectionConfigTraceTransmitSapi, neBackupRestoreState=neBackupRestoreState, oduTcmAConfigTraceTransmitSapi=oduTcmAConfigTraceTransmitSapi, fwDataActivationReadyOnStandby=fwDataActivationReadyOnStandby, ncuScheduledActivation=ncuScheduledActivation, oduTcmCDataEntry=oduTcmCDataEntry, swDbFileRowStatus=swDbFileRowStatus, oduTcmBConfigEntry=oduTcmBConfigEntry, ApsDirectionCaps=ApsDirectionCaps, coldRestartCapTable=coldRestartCapTable, otuSectionDataTable=otuSectionDataTable, oduTcmBConfigTraceExpected=oduTcmBConfigTraceExpected, StandbyServiceAffecting=StandbyServiceAffecting, controlPlaneWdmEntityIndexAid=controlPlaneWdmEntityIndexAid, fwDataServiceImpairment=fwDataServiceImpairment, FspR7AdminStateSnmpProxyCaps=FspR7AdminStateSnmpProxyCaps, neF7AutomaticRemoteBackupPassword=neF7AutomaticRemoteBackupPassword, FspR7TrapsinkLifetime=FspR7TrapsinkLifetime, oduTcmADataTraceReceivedDapi=oduTcmADataTraceReceivedDapi, neEventLogVarUnsigned32Val=neEventLogVarUnsigned32Val, encryptionFwpFile=encryptionFwpFile, oduSectionConfigTraceExpected=oduSectionConfigTraceExpected, provContainerTable=provContainerTable, ServiceImpairment=ServiceImpairment, SonetSectSigDegThres=SonetSectSigDegThres, neRestoreConfig=neRestoreConfig, swDbDataDefaultsUpgradeRequest=swDbDataDefaultsUpgradeRequest, ModuleForm=ModuleForm, oduSectionConfigTraceTransmitSapi=oduSectionConfigTraceTransmitSapi, snmpProxyServerPort=snmpProxyServerPort, sonetConfig=sonetConfig, neBackupRestoreRequest=neBackupRestoreRequest, inventoryType=inventoryType, otuSectionDataResultingTotalBitrate=otuSectionDataResultingTotalBitrate, controlPlaneEthEntityIndex=controlPlaneEthEntityIndex, swDbDataNumLegacyEqpt=swDbDataNumLegacyEqpt, neEventLogTable=neEventLogTable, ServiceAffecting=ServiceAffecting, provAssignmentState=provAssignmentState, oduSectionConfigEntry=oduSectionConfigEntry, neSwUpgradeCommonIpSrv=neSwUpgradeCommonIpSrv, fsp3000c=fsp3000c, swDbDataCapEntry=swDbDataCapEntry, FspR7EquipmentType=FspR7EquipmentType, oduTcmBDataTable=oduTcmBDataTable, selectedFile=selectedFile, controlPlaneOtnEntityIndexAid=controlPlaneOtnEntityIndexAid)
