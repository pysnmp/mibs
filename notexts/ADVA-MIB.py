...
TextualConvention, TimeStamp, DateAndTime, RowStatus, MacAddress, DisplayString, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "DateAndTime", "RowStatus", "MacAddress", "DisplayString", "TestAndIncr")
...
mibBuilder.exportSymbols("ADVA-MIB", neSwUpgradeServerAddress=neSwUpgradeServerAddress, oduTcmCConfigSignalDegradeThreshold=oduTcmCConfigSignalDegradeThreshold, neF7AutomaticBackupEntry=neF7AutomaticBackupEntry, sonetConfig=sonetConfig, neSwUpgradeServerDirectory=neSwUpgradeServerDirectory, oduTcmBConfigTraceTransmitOpsp=oduTcmBConfigTraceTransmitOpsp, neTrapsinkType=neTrapsinkType, neF7AutomaticRemoteBackupProtocol=neF7AutomaticRemoteBackupProtocol, sonetSectionConfigTraceForm=sonetSectionConfigTraceForm, neEventLogTable=neEventLogTable, neStorageDescr=neStorageDescr, neF7AutomaticRemoteBackupSrvLogin=neF7AutomaticRemoteBackupSrvLogin, software=software, oduTcmCConfigTraceTransmitDapi=oduTcmCConfigTraceTransmitDapi, swDbFileTable=swDbFileTable, swDbDataCapTable=swDbDataCapTable, entityContainedIn=entityContainedIn, entityIndexAid=entityIndexAid, oduTcmCConfigTable=oduTcmCConfigTable, LoopConfigCaps=LoopConfigCaps, oduTcmCConfigTraceTransmitOpsp=oduTcmCConfigTraceTransmitOpsp, oduTcmCDataEntry=oduTcmCDataEntry, neF7AutomaticBackupIndex=neF7AutomaticBackupIndex, OtnPayloadTypeCaps=OtnPayloadTypeCaps, neMibVariant=neMibVariant, neF7AutomaticBackupTimeStamp=neF7AutomaticBackupTimeStamp, controlPlaneEthContainsEntry=controlPlaneEthContainsEntry, vtpEntityIndexAid=vtpEntityIndexAid, F7FileTimeStamp=F7FileTimeStamp, controlPlaneOtnContainsIndex=controlPlaneOtnContainsIndex, neF7AutomaticRemoteBackupSrvDir=neF7AutomaticRemoteBackupSrvDir, oduSectionDataTraceReceivedOpsp=oduSectionDataTraceReceivedOpsp, ptpEntityClass=ptpEntityClass, dbAdmin=dbAdmin, fwDataStandbyVersion=fwDataStandbyVersion, swDbDataNumSaNotReady=swDbDataNumSaNotReady, neTrapsinkRowStatus=neTrapsinkRowStatus, admin=admin, sonet=sonet, NoYesNA=NoYesNA, ptpEntityClassInstanceNumber=ptpEntityClassInstanceNumber, oduTcmCConfigEntry=oduTcmCConfigEntry, swDbFileEntry=swDbFileEntry, TrapAlarmSeverity=TrapAlarmSeverity, neManufacturer=neManufacturer, snmpProxyEntrySingleTargetOutUserName=snmpProxyEntrySingleTargetOutUserName, SourceIpAddress=SourceIpAddress, CommandEqpt=CommandEqpt, inventoryHardwareRev=inventoryHardwareRev, VirtualContainerType=VirtualContainerType, controlPlaneOtnEntityEntry=controlPlaneOtnEntityEntry, eqpFwUpgradeRequest=eqpFwUpgradeRequest, oduTcmAConfigTable=oduTcmAConfigTable, neMemorySizeFree=neMemorySizeFree, inventoryFirmwarePackageRev=inventoryFirmwarePackageRev, TimModeCaps=TimModeCaps, AvailState=AvailState, neBackupRestore=neBackupRestore, neF7AutomaticRemoteBackupSrcIp=neF7AutomaticRemoteBackupSrcIp, oduSectionDataTraceReceivedDapi=oduSectionDataTraceReceivedDapi, OtnTcmLevelCaps=OtnTcmLevelCaps, oduSectionDataTraceReceivedSapi=oduSectionDataTraceReceivedSapi, swDbDataDefaultsEntry=swDbDataDefaultsEntry, neBackupRestoreFile=neBackupRestoreFile, LogicalIfTransportCaps=LogicalIfTransportCaps, neStorageEntry=neStorageEntry, inventoryEntry=inventoryEntry, neSwUpgradeRequest=neSwUpgradeRequest, inventoryCleiCode=inventoryCleiCode, ptpEntityIndex=ptpEntityIndex, controlPlaneEthContainsIndex=controlPlaneEthContainsIndex, snmpProxyServerSynchroStage=snmpProxyServerSynchroStage, swDbFilePgmType=swDbFilePgmType, fsp3000alm=fsp3000alm, swDbDataProgramVersion=swDbDataProgramVersion, swDbFileArea=swDbFileArea, swDbFileGrade=swDbFileGrade, SonetTimingSourceCaps=SonetTimingSourceCaps, neF7AutomaticBackupTable=neF7AutomaticBackupTable, oduTcmBConfigTable=oduTcmBConfigTable, aosProducts=aosProducts, FspR7TrapsinkLifetime=FspR7TrapsinkLifetime, controlPlaneEthEntityClass=controlPlaneEthEntityClass, otuSectionConfigSignalDegradePeriod=otuSectionConfigSignalDegradePeriod, PgmType=PgmType, neF7AutomaticBackupInterval=neF7AutomaticBackupInterval, FspR7FalseTrue=FspR7FalseTrue, neEventLogNotificationOID=neEventLogNotificationOID, controlPlaneWdmEntityClass=controlPlaneWdmEntityClass, controlPlaneWdmEntityIndexAid=controlPlaneWdmEntityIndexAid, SonetVcBundleAllocation=SonetVcBundleAllocation, EntityClass=EntityClass, inventoryVendorId=inventoryVendorId, swDbFileIndex=swDbFileIndex, FileTransferProtocol=FileTransferProtocol, FspTime=FspTime, neInfo=neInfo, AssignmentState=AssignmentState, fwDataBootStatus=fwDataBootStatus, ncuActivationTime=ncuActivationTime, fwDataActivationReadyOnStandby=fwDataActivationReadyOnStandby, YesNoNA=YesNoNA, inventoryUnitName=inventoryUnitName, inventoryMib=inventoryMib, ProtectionMech=ProtectionMech, neSwInstallState=neSwInstallState, vtpEntityClassInstanceNumber=vtpEntityClassInstanceNumber, encryptionFwpFile=encryptionFwpFile, controlPlaneEthEntityEntry=controlPlaneEthEntityEntry, sonetSectionConfigTimMode=sonetSectionConfigTimMode, SonetTimingSource=SonetTimingSource, neAutoBackupInterval=neAutoBackupInterval, oduTcmBConfigTraceTransmitDapi=oduTcmBConfigTraceTransmitDapi, controlPlaneOtnEntityClassInstanceNumber=controlPlaneOtnEntityClassInstanceNumber, fsp1000adm=fsp1000adm, controlPlaneOtnEntityIndexAid=controlPlaneOtnEntityIndexAid, controlPlaneOtnEntityContainedIn=controlPlaneOtnEntityContainedIn, entityTable=entityTable, neEventLogVarOctetStringVal=neEventLogVarOctetStringVal, sonetSectionConfigTable=sonetSectionConfigTable, oduTcmBConfigSignalDegradeThreshold=oduTcmBConfigSignalDegradeThreshold, neEventsLogged=neEventsLogged, controlPlaneOtnContainsEntry=controlPlaneOtnContainsEntry, Grade=Grade, FileType=FileType, EthDuplexModeCaps=EthDuplexModeCaps, swDbDataArea=swDbDataArea, ptpEntityTable=ptpEntityTable, snmpProxyEntrySingleTargetOutNodeAgentStatus=snmpProxyEntrySingleTargetOutNodeAgentStatus, advaMIB=advaMIB, SnmpProxySynchronizationState=SnmpProxySynchronizationState, neTrapsinkEntry=neTrapsinkEntry, controlPlaneEthEntityClassInstanceNumber=controlPlaneEthEntityClassInstanceNumber, fwDataTable=fwDataTable, controlPlaneEthEntityTable=controlPlaneEthEntityTable, swDbDataCapRestoreConfig=swDbDataCapRestoreConfig, swVersionActiveOperatingSw=swVersionActiveOperatingSw, entityAssignmentState=entityAssignmentState, oduSectionDataEntry=oduSectionDataEntry, selectedFile=selectedFile, oduSectionConfigTraceTransmitDapi=oduSectionConfigTraceTransmitDapi, neF7AutomaticBackupStartDate=neF7AutomaticBackupStartDate, neF7AutomaticRemoteBackupEncryption=neF7AutomaticRemoteBackupEncryption, SnmpProxySynchronizationStage=SnmpProxySynchronizationStage, controlPlaneEthEntityIndex=controlPlaneEthEntityIndex, swDbDataTable=swDbDataTable, ptpEntityType=ptpEntityType, swDbDataCapUpgradeRequest=swDbDataCapUpgradeRequest, sourceIpAddress=sourceIpAddress, swDbDataStandbyPartitionStatus=swDbDataStandbyPartitionStatus, otuSectionConfigTable=otuSectionConfigTable, neSwUpgradeNeDirectory=neSwUpgradeNeDirectory, oduTcmBConfigTraceTransmitSapi=oduTcmBConfigTraceTransmitSapi, neF7AutomaticBackupStartTime=neF7AutomaticBackupStartTime, snmpAgent=snmpAgent, oduTcmBConfigEntry=oduTcmBConfigEntry, controlPlaneWdmEntityAssignmentState=controlPlaneWdmEntityAssignmentState, oduSectionConfigTimMode=oduSectionConfigTimMode, inventoryCfModel=inventoryCfModel, entityIndex=entityIndex, neEventLogIndex=neEventLogIndex, swDbDataIndex=swDbDataIndex, provContainerEntry=provContainerEntry, fsp3000c=fsp3000c, ncuActivationDateUtc=ncuActivationDateUtc, swDbDataNumLegacyUpdate=swDbDataNumLegacyUpdate, otuSectionConfigTimMode=otuSectionConfigTimMode, swDbDataDefaultsUpgradeRequest=swDbDataDefaultsUpgradeRequest, neAutoBackupConfig=neAutoBackupConfig, updateBackupRestoreMib=updateBackupRestoreMib, ApsDirectionCaps=ApsDirectionCaps, swDbDataNumEqpt=swDbDataNumEqpt, SonetTraceForm=SonetTraceForm, oduTcmBConfigTraceExpected=oduTcmBConfigTraceExpected, sonetSectionDataEntry=sonetSectionDataEntry, neF7AutomaticRemoteBackupSrvPass=neF7AutomaticRemoteBackupSrvPass, ncuActivationDate=ncuActivationDate, oduTcmBDataTraceReceivedDapi=oduTcmBDataTraceReceivedDapi, swDbDataNumNativeSaUpdate=swDbDataNumNativeSaUpdate, neEventLogVarId=neEventLogVarId, otuSectionConfigTraceTransmitDapi=otuSectionConfigTraceTransmitDapi, neDateAndTime=neDateAndTime, coldRestartCapTable=coldRestartCapTable, neTrapsinkVersion=neTrapsinkVersion, aosCommon=aosCommon, controlPlaneEthEntityContainedIn=controlPlaneEthEntityContainedIn, controlPlaneOtnEntityIndex=controlPlaneOtnEntityIndex, coldRestartCapEntry=coldRestartCapEntry, neEventLogVarEntry=neEventLogVarEntry, FspR7EquipmentTypeCaps=FspR7EquipmentTypeCaps, neInitialConnectionMode=neInitialConnectionMode, neEventLogVarCounter64Val=neEventLogVarCounter64Val, aos=aos, ncuScheduledDbRestore=ncuScheduledDbRestore, oduTcmAConfigSignalDegradePeriod=oduTcmAConfigSignalDegradePeriod, DestinationNodeOrAgentState=DestinationNodeOrAgentState, NcuAutoActivation=NcuAutoActivation, oduTcmBConfigTimMode=oduTcmBConfigTimMode, products=products, fwDataForm=fwDataForm, FspR7Time=FspR7Time, neStorageCapacity=neStorageCapacity, TrapCounter=TrapCounter, fwDataServiceImpairment=fwDataServiceImpairment, controlPlaneWdmEntityContainedIn=controlPlaneWdmEntityContainedIn, oduSectionDataTable=oduSectionDataTable, fwDataStandbyServiceImpairment=fwDataStandbyServiceImpairment, EnableState=EnableState, transportStandards=transportStandards, controlPlaneOtnEntityAssignmentState=controlPlaneOtnEntityAssignmentState, OhTerminationLevel=OhTerminationLevel, vtpEntityType=vtpEntityType, controlPlaneOtnEntityTable=controlPlaneOtnEntityTable, neTrapsinkTable=neTrapsinkTable, neF7AutomaticRemoteBackupPassword=neF7AutomaticRemoteBackupPassword, VirtualContainerTypeCaps=VirtualContainerTypeCaps, inventorySoftwareRev=inventorySoftwareRev, NeSwInstallStatusType=NeSwInstallStatusType, neEventLogVarInteger32Val=neEventLogVarInteger32Val, ServiceAffectingCaps=ServiceAffectingCaps, oduSectionConfigTraceTransmitOpsp=oduSectionConfigTraceTransmitOpsp, vtpEntityAssignmentState=vtpEntityAssignmentState, oduTcmAConfigTimMode=oduTcmAConfigTimMode, eqpFwNextEqpForUpdate=eqpFwNextEqpForUpdate, fwDataFirmwarePackageRev=fwDataFirmwarePackageRev, updateEqpt=updateEqpt, coldRestartCapServiceAffectingCap=coldRestartCapServiceAffectingCap, oduTcmADataTraceReceivedOpsp=oduTcmADataTraceReceivedOpsp, RestoreActivation=RestoreActivation, neBackupRestoreState=neBackupRestoreState, neEventLogTimeStamp=neEventLogTimeStamp, neF7AutomaticRemoteBackupCommonIpSrv=neF7AutomaticRemoteBackupCommonIpSrv, otuSectionConfigStuffing=otuSectionConfigStuffing, neAutoBackupNextActionAt=neAutoBackupNextActionAt, neF7AutomaticBackupRunState=neF7AutomaticBackupRunState, OhTerminationLevelCaps=OhTerminationLevelCaps, fsp1000=fsp1000, oduTcmADataTable=oduTcmADataTable, inventorySerialNum=inventorySerialNum, oduTcmAConfigSignalDegradeThreshold=oduTcmAConfigSignalDegradeThreshold, entityClassInstanceNumber=entityClassInstanceNumber, swDbFileRowStatus=swDbFileRowStatus, otuSectionDataTraceReceivedOpsp=otuSectionDataTraceReceivedOpsp, EthDuplexMode=EthDuplexMode, oduSectionConfigEntry=oduSectionConfigEntry, oduTcmBDataTraceReceivedSapi=oduTcmBDataTraceReceivedSapi, swDbDataDatabaseVersion=swDbDataDatabaseVersion, SonetVcBundleAllocationCaps=SonetVcBundleAllocationCaps, snmpServerPort=snmpServerPort, snmpProxyEntrySingleTargetOutAdminState=snmpProxyEntrySingleTargetOutAdminState, vtpEntityIndex=vtpEntityIndex, neF7AutomaticBackupNextDate=neF7AutomaticBackupNextDate, swDbDataCapEntry=swDbDataCapEntry, ptpEntityEntry=ptpEntityEntry)
mibBuilder.exportSymbols("ADVA-MIB", FspR7AdminStateSnmpProxyCaps=FspR7AdminStateSnmpProxyCaps, swVersionInactiveOperatingSw=swVersionInactiveOperatingSw, inventoryPartnumber=inventoryPartnumber, inventoryTable=inventoryTable, entityEquipmentState=entityEquipmentState, neSwUpgradeServerLogin=neSwUpgradeServerLogin, containsEntry=containsEntry, oduSectionConfigTraceExpected=oduSectionConfigTraceExpected, containsIndex=containsIndex, ApsHoldoffTime=ApsHoldoffTime, ptpEntityReferencedTo=ptpEntityReferencedTo, controlPlaneWdmEntityIndex=controlPlaneWdmEntityIndex, controlPlaneWdmEntityEntry=controlPlaneWdmEntityEntry, ApsDirection=ApsDirection, ptpEntityContainedIn=ptpEntityContainedIn, otuSectionDataEntry=otuSectionDataEntry, entityClass=entityClass, LoopConfig=LoopConfig, ptpEntityIndexAid=ptpEntityIndexAid, neAutoBackupServerAddress=neAutoBackupServerAddress, controlPlaneOtnContainsTable=controlPlaneOtnContainsTable, snmpWriteAccessNmsAddress=snmpWriteAccessNmsAddress, neStorageTable=neStorageTable, fwDataStandbyFirmwareAvailable=fwDataStandbyFirmwareAvailable, FspDate=FspDate, clearRdiskRequest=clearRdiskRequest, oduTcmCConfigSignalDegradePeriod=oduTcmCConfigSignalDegradePeriod, sonetSectionConfigTimingSource=sonetSectionConfigTimingSource, TimMode=TimMode, fwDataReadyForActivation=fwDataReadyForActivation, swDbFileCreationTime=swDbFileCreationTime, fsp2000=fsp2000, sonetSectionConfigTraceExpected=sonetSectionConfigTraceExpected, fwDataEntry=fwDataEntry, SonetSectSigDegThres=SonetSectSigDegThres, oduTcmAConfigTcmLevel=oduTcmAConfigTcmLevel, otuSectionConfigTraceTransmitSapi=otuSectionConfigTraceTransmitSapi, snmpWriteAccessTable=snmpWriteAccessTable, controlPlaneWdmEntityTable=controlPlaneWdmEntityTable, swDbDataActivationTime=swDbDataActivationTime, neBackupRestoreRequest=neBackupRestoreRequest, oduTcmBConfigTcmLevel=oduTcmBConfigTcmLevel, swAdmin=swAdmin, FspR7UsersDb=FspR7UsersDb, neAutoBackupServerLogin=neAutoBackupServerLogin, oduTcmCConfigTimMode=oduTcmCConfigTimMode, otuSectionDataTraceReceivedSapi=otuSectionDataTraceReceivedSapi, inventoryUniversalSerialIdent=inventoryUniversalSerialIdent, neEventLogVarOidVal=neEventLogVarOidVal, neF7AutomaticRemoteBackupSrvIp=neF7AutomaticRemoteBackupSrvIp, SonetSectSigDegThresCaps=SonetSectSigDegThresCaps, neBackupPassword=neBackupPassword, neAutoBackupServerPasswd=neAutoBackupServerPasswd, swDbFileComment=swDbFileComment, fsp3000=fsp3000, PartitionStatus=PartitionStatus, ServiceAffecting=ServiceAffecting, neSwUpgradeFileName=neSwUpgradeFileName, neEventLogVarUnsigned32Val=neEventLogVarUnsigned32Val, neEventLogIdentityTranslation=neEventLogIdentityTranslation, neSwUpgradeType=neSwUpgradeType, common=common, swVersionNextBoot=swVersionNextBoot, neAutoBackup=neAutoBackup, fwDataFirmwareAvailable=fwDataFirmwareAvailable, eqpFwEqpType=eqpFwEqpType, fspR7=fspR7, fsp150=fsp150, swDbDataFirmwareSetVersion=swDbDataFirmwareSetVersion, KBytes=KBytes, neAlarmStatus=neAlarmStatus, controlPlaneWdmEntityClassInstanceNumber=controlPlaneWdmEntityClassInstanceNumber, fwDataNewVersion=fwDataNewVersion, eqpFwEqpServerBusy=eqpFwEqpServerBusy, EntityType=EntityType, swDbFileFileName=swDbFileFileName, inventoryMacAddress=inventoryMacAddress, FspR7EnableDisable=FspR7EnableDisable, snmpProxyServerPort=snmpProxyServerPort, otuSectionConfigTraceExpected=otuSectionConfigTraceExpected, eqpFwNcuServerBusy=eqpFwNcuServerBusy, EntityIndex=EntityIndex, snmpWriteAccessNmsName=snmpWriteAccessNmsName, oduTcmAConfigTraceTransmitOpsp=oduTcmAConfigTraceTransmitOpsp, oduTcmCDataTable=oduTcmCDataTable, sonetSectionConfigEntry=sonetSectionConfigEntry, controlPlaneEthEntityAssignmentState=controlPlaneEthEntityAssignmentState, neSwUpgradeCommonIpSrv=neSwUpgradeCommonIpSrv, swDbFileSize=swDbFileSize, BootState=BootState, sonetSectionConfigSignalDegradePeriod=sonetSectionConfigSignalDegradePeriod, entityEntry=entityEntry, ModuleForm=ModuleForm, neTrapsinkPort=neTrapsinkPort, CpWdmEntityClass=CpWdmEntityClass, oduTcmBConfigSignalDegradePeriod=oduTcmBConfigSignalDegradePeriod, fwDataFirmwareApproved=fwDataFirmwareApproved, ncuActivationTimeUtc=ncuActivationTimeUtc, eqpFwServiceImpairment=eqpFwServiceImpairment, ArcState=ArcState, neTrapsinkCommunity=neTrapsinkCommunity, config=config, snmpProxyEntrySingleTargetOutContext=snmpProxyEntrySingleTargetOutContext, oduTcmCDataTraceReceivedSapi=oduTcmCDataTraceReceivedSapi, EnableStateCaps=EnableStateCaps, provEquipmentState=provEquipmentState, containsTable=containsTable, neAutoBackupServerDirectory=neAutoBackupServerDirectory, otuSectionConfigTraceTransmitOpsp=otuSectionConfigTraceTransmitOpsp, otuSectionConfigSignalDegradeThreshold=otuSectionConfigSignalDegradeThreshold, neEventLogVarTable=neEventLogVarTable, vtpEntityTable=vtpEntityTable, fsp1500=fsp1500, FspR7YesNo=FspR7YesNo, neStorageIndex=neStorageIndex, provContainerTable=provContainerTable, FspR7AdminStateSnmpProxy=FspR7AdminStateSnmpProxy, oduTcmAConfigTraceTransmitSapi=oduTcmAConfigTraceTransmitSapi, F7AutoBackupRunState=F7AutoBackupRunState, ncuScheduledActivation=ncuScheduledActivation, neEventLogEntry=neEventLogEntry, neSwUpgradeServerPasswd=neSwUpgradeServerPasswd, neSwUpgradeTransferProtocol=neSwUpgradeTransferProtocol, neSwDownloadProgress=neSwDownloadProgress, ServiceImpairment=ServiceImpairment, oduConfig=oduConfig, oduTcmAConfigTraceExpected=oduTcmAConfigTraceExpected, entityType=entityType, oduTcmBDataEntry=oduTcmBDataEntry, swVersionTable=swVersionTable, Counter64String=Counter64String, otuSectionConfigEntry=otuSectionConfigEntry, neBackupEncryption=neBackupEncryption, swVersionActiveApplSw=swVersionActiveApplSw, oduSectionConfigSignalDegradePeriod=oduSectionConfigSignalDegradePeriod, PYSNMP_MODULE_ID=advaMIB, OnOff=OnOff, neF7AutomaticRemoteBackupTimeStamp=neF7AutomaticRemoteBackupTimeStamp, FileArea=FileArea, controlPlaneOtnEntityClass=controlPlaneOtnEntityClass, neTrapsinkUserName=neTrapsinkUserName, sonetSectionConfigTraceTransmit=sonetSectionConfigTraceTransmit, fsp150cm=fsp150cm, oduTcmAConfigEntry=oduTcmAConfigEntry, provAssignmentState=provAssignmentState, inventoryCfSerialNum=inventoryCfSerialNum, neSoftwareUpgrade=neSoftwareUpgrade, sonetSectionDataTable=sonetSectionDataTable, swDbDataNumNativeNsaUpdate=swDbDataNumNativeNsaUpdate, FspR7Date=FspR7Date, F7AutoBackupInterval=F7AutoBackupInterval, sonetSectionDataTraceReceived=sonetSectionDataTraceReceived, neBackupUsers=neBackupUsers, swDbDataDefaultsRestoreConfig=swDbDataDefaultsRestoreConfig, controlPlaneEthEntityIndexAid=controlPlaneEthEntityIndexAid, snmpProxyEntrySingleTargetOutEntry=snmpProxyEntrySingleTargetOutEntry, events=events, otuSectionDataTraceReceivedDapi=otuSectionDataTraceReceivedDapi, controlPlaneWdmContainsEntry=controlPlaneWdmContainsEntry, otuSectionConfigPayload=otuSectionConfigPayload, FspR7EquipmentType=FspR7EquipmentType, snmpProxyServerSynchroState=snmpProxyServerSynchroState, oduTcmCConfigTcmLevel=oduTcmCConfigTcmLevel, neRestoreConfig=neRestoreConfig, RestoreActivationCaps=RestoreActivationCaps, neF7AutomaticRemoteBackupUsers=neF7AutomaticRemoteBackupUsers, snmpProxyEntrySingleTargetOutRowStatus=snmpProxyEntrySingleTargetOutRowStatus, fspNm=fspNm, swDbDataNumLegacyEqpt=swDbDataNumLegacyEqpt, oduSectionConfigSignalDegradeThres=oduSectionConfigSignalDegradeThres, oduTcmBDataTable=oduTcmBDataTable, oduTcmAConfigTraceTransmitDapi=oduTcmAConfigTraceTransmitDapi, controlPlaneWdmContainsIndex=controlPlaneWdmContainsIndex, swDbFileType=swDbFileType, snmpProxyServerAdminState=snmpProxyServerAdminState, otn=otn, swDbDataRestoreConfig=swDbDataRestoreConfig, fwDataFirmwarePackageRevBackup=fwDataFirmwarePackageRevBackup, neStorageAvailable=neStorageAvailable, snmpProxyEntrySingleTargetOutTable=snmpProxyEntrySingleTargetOutTable, vtpEntityClass=vtpEntityClass, oduTcmCDataTraceReceivedOpsp=oduTcmCDataTraceReceivedOpsp, controlPlaneEthContainsTable=controlPlaneEthContainsTable, ptpEntityAssignmentState=ptpEntityAssignmentState, oduTcmADataEntry=oduTcmADataEntry, ptpEntityEquipmentState=ptpEntityEquipmentState, neEventLogVarIpAddressVal=neEventLogVarIpAddressVal, inventoryType=inventoryType, vtpEntityEquipmentState=vtpEntityEquipmentState, otuSectionDataResultingTotalBitrate=otuSectionDataResultingTotalBitrate, oduSectionConfigTable=oduSectionConfigTable, oduTcmBDataTraceReceivedOpsp=oduTcmBDataTraceReceivedOpsp, oduTcmCDataTraceReceivedDapi=oduTcmCDataTraceReceivedDapi, inventoryGradeInventory=inventoryGradeInventory, snmpWriteAccessRestriction=snmpWriteAccessRestriction, otuSectionDataTable=otuSectionDataTable, vtpEntityEntry=vtpEntityEntry, swDbDataEntry=swDbDataEntry, SonetTraceFormCaps=SonetTraceFormCaps, OtnTcmLevel=OtnTcmLevel, swVersionEntry=swVersionEntry, sonetSectionConfigSignalDegradeThreshhold=sonetSectionConfigSignalDegradeThreshhold, NeSwUpgradeStatusType=NeSwUpgradeStatusType, ApsHoldoffTimeCaps=ApsHoldoffTimeCaps, OtnPayloadType=OtnPayloadType, StandbyServiceAffecting=StandbyServiceAffecting, snmpProxyEntrySingleTargetOutAddress=snmpProxyEntrySingleTargetOutAddress, inventoryFpgaRev=inventoryFpgaRev, fwDataProtectionPart=fwDataProtectionPart, vtpEntityReferencedTo=vtpEntityReferencedTo, IdentityTranslation=IdentityTranslation, neSwUpgradeState=neSwUpgradeState, snmpWriteAccessEntry=snmpWriteAccessEntry, EquipmentState=EquipmentState, vtpEntityContainedIn=vtpEntityContainedIn, installedEqpt=installedEqpt, oduTcmCConfigTraceExpected=oduTcmCConfigTraceExpected, swDbFileVersion=swDbFileVersion, neMemorySizeTotal=neMemorySizeTotal, oduSectionConfigTraceTransmitSapi=oduSectionConfigTraceTransmitSapi, oduTcmCConfigTraceTransmitSapi=oduTcmCConfigTraceTransmitSapi, swDbDataNcuSoftwareVersion=swDbDataNcuSoftwareVersion, swDbDataDefaultsTable=swDbDataDefaultsTable, neTrapsinkAddress=neTrapsinkAddress, neEventLogVarIndex=neEventLogVarIndex, swDbDataNumNsaNotReady=swDbDataNumNsaNotReady, otuConfig=otuConfig, controlPlaneWdmContainsTable=controlPlaneWdmContainsTable, swVersionInactiveApplSw=swVersionInactiveApplSw, oduTcmADataTraceReceivedSapi=oduTcmADataTraceReceivedSapi, ProtectionMechCaps=ProtectionMechCaps, LogicalIfTransport=LogicalIfTransport, neEventLogVarType=neEventLogVarType, oduTcmADataTraceReceivedDapi=oduTcmADataTraceReceivedDapi, neRestoreFileBackupDate=neRestoreFileBackupDate, snmpProxyEntrySingleTargetOutPort=snmpProxyEntrySingleTargetOutPort)
