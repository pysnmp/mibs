...
DisplayString, RowStatus, MacAddress, TestAndIncr, DateAndTime, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "MacAddress", "TestAndIncr", "DateAndTime", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("ADVA-MIB", sonetSectionConfigTable=sonetSectionConfigTable, oduTcmAConfigSignalDegradeThreshold=oduTcmAConfigSignalDegradeThreshold, neSwUpgradeType=neSwUpgradeType, oduTcmADataTraceReceivedOpsp=oduTcmADataTraceReceivedOpsp, containsIndex=containsIndex, neStorageAvailable=neStorageAvailable, swDbDataActivationTime=swDbDataActivationTime, inventoryCfModel=inventoryCfModel, IdentityTranslation=IdentityTranslation, neF7AutomaticRemoteBackupProtocol=neF7AutomaticRemoteBackupProtocol, OtnPayloadTypeCaps=OtnPayloadTypeCaps, ApsDirectionCaps=ApsDirectionCaps, FspR7UsersDb=FspR7UsersDb, oduSectionConfigTraceTransmitOpsp=oduSectionConfigTraceTransmitOpsp, OnOff=OnOff, neEventLogVarCounter64Val=neEventLogVarCounter64Val, entityTable=entityTable, FspR7EnableDisable=FspR7EnableDisable, neAutoBackupNextActionAt=neAutoBackupNextActionAt, NeSwUpgradeStatusType=NeSwUpgradeStatusType, sonetSectionConfigEntry=sonetSectionConfigEntry, neEventLogIdentityTranslation=neEventLogIdentityTranslation, otuSectionConfigStuffing=otuSectionConfigStuffing, swDbDataDefaultsRestoreConfig=swDbDataDefaultsRestoreConfig, sourceIpAddress=sourceIpAddress, neAutoBackup=neAutoBackup, inventoryFpgaRev=inventoryFpgaRev, otuSectionDataTraceReceivedSapi=otuSectionDataTraceReceivedSapi, inventoryFirmwarePackageRev=inventoryFirmwarePackageRev, neF7AutomaticBackupIndex=neF7AutomaticBackupIndex, updateBackupRestoreMib=updateBackupRestoreMib, EntityClass=EntityClass, snmpWriteAccessRestriction=snmpWriteAccessRestriction, fwDataFirmwareAvailable=fwDataFirmwareAvailable, neAlarmStatus=neAlarmStatus, vtpEntityType=vtpEntityType, vtpEntityClassInstanceNumber=vtpEntityClassInstanceNumber, ptpEntityTable=ptpEntityTable, FileTransferProtocol=FileTransferProtocol, otuSectionConfigTimMode=otuSectionConfigTimMode, TrapCounter=TrapCounter, FspR7TrapsinkLifetime=FspR7TrapsinkLifetime, SonetTimingSourceCaps=SonetTimingSourceCaps, ptpEntityContainedIn=ptpEntityContainedIn, swDbDataNcuSoftwareVersion=swDbDataNcuSoftwareVersion, EntityType=EntityType, neAutoBackupServerPasswd=neAutoBackupServerPasswd, ptpEntityIndex=ptpEntityIndex, vtpEntityTable=vtpEntityTable, dbAdmin=dbAdmin, fwDataFirmwarePackageRevBackup=fwDataFirmwarePackageRevBackup, swDbDataCapRestoreConfig=swDbDataCapRestoreConfig, oduTcmADataTable=oduTcmADataTable, inventoryEntry=inventoryEntry, neSoftwareUpgrade=neSoftwareUpgrade, coldRestartCapTable=coldRestartCapTable, swDbDataFirmwareSetVersion=swDbDataFirmwareSetVersion, CpWdmEntityClass=CpWdmEntityClass, otuConfig=otuConfig, neEventLogVarTable=neEventLogVarTable, oduTcmCDataTable=oduTcmCDataTable, LogicalIfTransportCaps=LogicalIfTransportCaps, oduSectionConfigTraceTransmitDapi=oduSectionConfigTraceTransmitDapi, swDbFileSize=swDbFileSize, oduSectionConfigTraceTransmitSapi=oduSectionConfigTraceTransmitSapi, BootState=BootState, controlPlaneEthContainsEntry=controlPlaneEthContainsEntry, oduSectionDataTraceReceivedOpsp=oduSectionDataTraceReceivedOpsp, neBackupUsers=neBackupUsers, sonetSectionDataTraceReceived=sonetSectionDataTraceReceived, otuSectionConfigTable=otuSectionConfigTable, swDbDataDefaultsEntry=swDbDataDefaultsEntry, TimMode=TimMode, OtnTcmLevel=OtnTcmLevel, AvailState=AvailState, neEventLogVarUnsigned32Val=neEventLogVarUnsigned32Val, swDbFileFileName=swDbFileFileName, oduTcmBDataTraceReceivedSapi=oduTcmBDataTraceReceivedSapi, fspNm=fspNm, oduConfig=oduConfig, sonet=sonet, oduSectionConfigSignalDegradePeriod=oduSectionConfigSignalDegradePeriod, oduSectionDataTraceReceivedSapi=oduSectionDataTraceReceivedSapi, neAutoBackupInterval=neAutoBackupInterval, neSwUpgradeServerDirectory=neSwUpgradeServerDirectory, otuSectionConfigEntry=otuSectionConfigEntry, controlPlaneEthContainsIndex=controlPlaneEthContainsIndex, swVersionNextBoot=swVersionNextBoot, EnableState=EnableState, swDbFileTable=swDbFileTable, neRestoreFileBackupDate=neRestoreFileBackupDate, controlPlaneOtnEntityContainedIn=controlPlaneOtnEntityContainedIn, swDbDataDefaultsTable=swDbDataDefaultsTable, sonetSectionConfigSignalDegradePeriod=sonetSectionConfigSignalDegradePeriod, ncuActivationTime=ncuActivationTime, ServiceAffectingCaps=ServiceAffectingCaps, neSwUpgradeServerPasswd=neSwUpgradeServerPasswd, neDateAndTime=neDateAndTime, neBackupRestoreRequest=neBackupRestoreRequest, ProtectionMech=ProtectionMech, sonetSectionConfigSignalDegradeThreshhold=sonetSectionConfigSignalDegradeThreshhold, vtpEntityContainedIn=vtpEntityContainedIn, provContainerEntry=provContainerEntry, containsEntry=containsEntry, SourceIpAddress=SourceIpAddress, inventorySerialNum=inventorySerialNum, oduTcmBConfigTable=oduTcmBConfigTable, entityType=entityType, oduTcmBDataEntry=oduTcmBDataEntry, swDbDataNumEqpt=swDbDataNumEqpt, snmpProxyEntrySingleTargetOutNodeAgentStatus=snmpProxyEntrySingleTargetOutNodeAgentStatus, otuSectionConfigPayload=otuSectionConfigPayload, eqpFwEqpServerBusy=eqpFwEqpServerBusy, snmpProxyEntrySingleTargetOutEntry=snmpProxyEntrySingleTargetOutEntry, controlPlaneOtnEntityClassInstanceNumber=controlPlaneOtnEntityClassInstanceNumber, ncuScheduledDbRestore=ncuScheduledDbRestore, snmpProxyEntrySingleTargetOutAddress=snmpProxyEntrySingleTargetOutAddress, neBackupRestoreState=neBackupRestoreState, neEventLogNotificationOID=neEventLogNotificationOID, controlPlaneWdmEntityClass=controlPlaneWdmEntityClass, controlPlaneOtnEntityIndex=controlPlaneOtnEntityIndex, eqpFwNextEqpForUpdate=eqpFwNextEqpForUpdate, swDbDataNumNativeSaUpdate=swDbDataNumNativeSaUpdate, controlPlaneOtnContainsIndex=controlPlaneOtnContainsIndex, ApsHoldoffTimeCaps=ApsHoldoffTimeCaps, ptpEntityClassInstanceNumber=ptpEntityClassInstanceNumber, swDbDataDatabaseVersion=swDbDataDatabaseVersion, sonetConfig=sonetConfig, oduTcmBConfigTcmLevel=oduTcmBConfigTcmLevel, oduTcmCConfigTimMode=oduTcmCConfigTimMode, controlPlaneWdmEntityClassInstanceNumber=controlPlaneWdmEntityClassInstanceNumber, fwDataTable=fwDataTable, fsp1000adm=fsp1000adm, controlPlaneWdmContainsEntry=controlPlaneWdmContainsEntry, oduTcmBDataTable=oduTcmBDataTable, neF7AutomaticRemoteBackupSrvDir=neF7AutomaticRemoteBackupSrvDir, ProtectionMechCaps=ProtectionMechCaps, SnmpProxySynchronizationState=SnmpProxySynchronizationState, Grade=Grade, entityClassInstanceNumber=entityClassInstanceNumber, controlPlaneWdmEntityContainedIn=controlPlaneWdmEntityContainedIn, FileArea=FileArea, neSwUpgradeServerLogin=neSwUpgradeServerLogin, oduTcmBConfigTraceTransmitDapi=oduTcmBConfigTraceTransmitDapi, snmpWriteAccessNmsAddress=snmpWriteAccessNmsAddress, neEventLogTable=neEventLogTable, VirtualContainerTypeCaps=VirtualContainerTypeCaps, oduTcmCConfigTraceTransmitSapi=oduTcmCConfigTraceTransmitSapi, fwDataFirmwarePackageRev=fwDataFirmwarePackageRev, neEventLogVarIndex=neEventLogVarIndex, oduTcmAConfigSignalDegradePeriod=oduTcmAConfigSignalDegradePeriod, oduTcmCConfigSignalDegradeThreshold=oduTcmCConfigSignalDegradeThreshold, ptpEntityEquipmentState=ptpEntityEquipmentState, neEventLogIndex=neEventLogIndex, ApsHoldoffTime=ApsHoldoffTime, fwDataReadyForActivation=fwDataReadyForActivation, ptpEntityType=ptpEntityType, fwDataEntry=fwDataEntry, oduTcmAConfigTcmLevel=oduTcmAConfigTcmLevel, advaMIB=advaMIB, vtpEntityIndexAid=vtpEntityIndexAid, entityEntry=entityEntry, ServiceAffecting=ServiceAffecting, RestoreActivation=RestoreActivation, neAutoBackupServerLogin=neAutoBackupServerLogin, FspR7EquipmentTypeCaps=FspR7EquipmentTypeCaps, vtpEntityEquipmentState=vtpEntityEquipmentState, snmpServerPort=snmpServerPort, otuSectionConfigTraceTransmitSapi=otuSectionConfigTraceTransmitSapi, swDbFileArea=swDbFileArea, FileType=FileType, fsp150cm=fsp150cm, swDbDataEntry=swDbDataEntry, oduTcmBConfigTraceExpected=oduTcmBConfigTraceExpected, oduTcmCConfigEntry=oduTcmCConfigEntry, controlPlaneEthEntityAssignmentState=controlPlaneEthEntityAssignmentState, swVersionInactiveOperatingSw=swVersionInactiveOperatingSw, swDbFileGrade=swDbFileGrade, neManufacturer=neManufacturer, products=products, controlPlaneEthEntityEntry=controlPlaneEthEntityEntry, ncuScheduledActivation=ncuScheduledActivation, neInitialConnectionMode=neInitialConnectionMode, VirtualContainerType=VirtualContainerType, AssignmentState=AssignmentState, neF7AutomaticBackupEntry=neF7AutomaticBackupEntry, ptpEntityIndexAid=ptpEntityIndexAid, fsp3000c=fsp3000c, sonetSectionDataTable=sonetSectionDataTable, snmpProxyServerPort=snmpProxyServerPort, swDbDataCapEntry=swDbDataCapEntry, neBackupRestore=neBackupRestore, fwDataStandbyFirmwareAvailable=fwDataStandbyFirmwareAvailable, swDbDataDefaultsUpgradeRequest=swDbDataDefaultsUpgradeRequest, swDbDataNumLegacyUpdate=swDbDataNumLegacyUpdate, inventoryHardwareRev=inventoryHardwareRev, oduTcmADataTraceReceivedSapi=oduTcmADataTraceReceivedSapi, swDbFileIndex=swDbFileIndex, swDbDataNumSaNotReady=swDbDataNumSaNotReady, snmpProxyEntrySingleTargetOutTable=snmpProxyEntrySingleTargetOutTable, oduSectionConfigTimMode=oduSectionConfigTimMode, neAutoBackupConfig=neAutoBackupConfig, controlPlaneEthEntityIndexAid=controlPlaneEthEntityIndexAid, neTrapsinkVersion=neTrapsinkVersion, FspR7FalseTrue=FspR7FalseTrue, ModuleForm=ModuleForm, oduTcmCDataTraceReceivedOpsp=oduTcmCDataTraceReceivedOpsp, controlPlaneOtnEntityEntry=controlPlaneOtnEntityEntry, neTrapsinkAddress=neTrapsinkAddress, snmpWriteAccessNmsName=snmpWriteAccessNmsName, neTrapsinkEntry=neTrapsinkEntry, PYSNMP_MODULE_ID=advaMIB, neSwUpgradeState=neSwUpgradeState, inventoryVendorId=inventoryVendorId, controlPlaneWdmEntityEntry=controlPlaneWdmEntityEntry, swDbFileType=swDbFileType, SonetTraceForm=SonetTraceForm, neSwDownloadProgress=neSwDownloadProgress, swVersionEntry=swVersionEntry, controlPlaneEthEntityClassInstanceNumber=controlPlaneEthEntityClassInstanceNumber, snmpWriteAccessEntry=snmpWriteAccessEntry, swDbFilePgmType=swDbFilePgmType, inventoryUniversalSerialIdent=inventoryUniversalSerialIdent, F7AutoBackupInterval=F7AutoBackupInterval, neF7AutomaticRemoteBackupTimeStamp=neF7AutomaticRemoteBackupTimeStamp, snmpProxyEntrySingleTargetOutPort=snmpProxyEntrySingleTargetOutPort, entityContainedIn=entityContainedIn, inventoryMib=inventoryMib, swVersionActiveOperatingSw=swVersionActiveOperatingSw, vtpEntityEntry=vtpEntityEntry, oduTcmCDataEntry=oduTcmCDataEntry, otuSectionDataTraceReceivedDapi=otuSectionDataTraceReceivedDapi, swDbDataNumNsaNotReady=swDbDataNumNsaNotReady, snmpProxyEntrySingleTargetOutRowStatus=snmpProxyEntrySingleTargetOutRowStatus, controlPlaneWdmEntityTable=controlPlaneWdmEntityTable, otuSectionConfigTraceExpected=otuSectionConfigTraceExpected, neInfo=neInfo, ncuActivationDateUtc=ncuActivationDateUtc, oduTcmBConfigTraceTransmitSapi=oduTcmBConfigTraceTransmitSapi, neF7AutomaticRemoteBackupPassword=neF7AutomaticRemoteBackupPassword, LogicalIfTransport=LogicalIfTransport, swDbDataCapTable=swDbDataCapTable, otuSectionConfigTraceTransmitOpsp=otuSectionConfigTraceTransmitOpsp, otuSectionDataEntry=otuSectionDataEntry, FspDate=FspDate, neStorageTable=neStorageTable, snmpWriteAccessTable=snmpWriteAccessTable, controlPlaneWdmEntityIndex=controlPlaneWdmEntityIndex, entityIndexAid=entityIndexAid, FspR7Time=FspR7Time, OhTerminationLevel=OhTerminationLevel, entityClass=entityClass, EthDuplexMode=EthDuplexMode, neEventLogVarId=neEventLogVarId)
mibBuilder.exportSymbols("ADVA-MIB", ServiceImpairment=ServiceImpairment, fsp1500=fsp1500, ArcState=ArcState, neEventLogVarIpAddressVal=neEventLogVarIpAddressVal, TrapAlarmSeverity=TrapAlarmSeverity, neEventLogVarInteger32Val=neEventLogVarInteger32Val, inventoryCleiCode=inventoryCleiCode, DestinationNodeOrAgentState=DestinationNodeOrAgentState, controlPlaneEthEntityClass=controlPlaneEthEntityClass, neAutoBackupServerAddress=neAutoBackupServerAddress, sonetSectionConfigTimingSource=sonetSectionConfigTimingSource, inventoryType=inventoryType, ptpEntityAssignmentState=ptpEntityAssignmentState, sonetSectionDataEntry=sonetSectionDataEntry, neTrapsinkUserName=neTrapsinkUserName, neEventLogVarEntry=neEventLogVarEntry, fsp2000=fsp2000, inventoryGradeInventory=inventoryGradeInventory, oduSectionDataEntry=oduSectionDataEntry, ncuActivationTimeUtc=ncuActivationTimeUtc, inventoryMacAddress=inventoryMacAddress, selectedFile=selectedFile, oduTcmAConfigTraceTransmitDapi=oduTcmAConfigTraceTransmitDapi, otn=otn, swVersionActiveApplSw=swVersionActiveApplSw, controlPlaneOtnEntityAssignmentState=controlPlaneOtnEntityAssignmentState, vtpEntityReferencedTo=vtpEntityReferencedTo, neF7AutomaticRemoteBackupSrvPass=neF7AutomaticRemoteBackupSrvPass, Counter64String=Counter64String, provAssignmentState=provAssignmentState, neAutoBackupServerDirectory=neAutoBackupServerDirectory, neTrapsinkCommunity=neTrapsinkCommunity, snmpProxyServerSynchroState=snmpProxyServerSynchroState, fsp1000=fsp1000, controlPlaneOtnEntityClass=controlPlaneOtnEntityClass, oduTcmAConfigTraceTransmitOpsp=oduTcmAConfigTraceTransmitOpsp, software=software, eqpFwUpgradeRequest=eqpFwUpgradeRequest, neSwUpgradeCommonIpSrv=neSwUpgradeCommonIpSrv, controlPlaneEthEntityIndex=controlPlaneEthEntityIndex, otuSectionConfigTraceTransmitDapi=otuSectionConfigTraceTransmitDapi, inventoryPartnumber=inventoryPartnumber, fspR7=fspR7, oduTcmAConfigTable=oduTcmAConfigTable, neSwUpgradeFileName=neSwUpgradeFileName, fwDataProtectionPart=fwDataProtectionPart, oduSectionConfigEntry=oduSectionConfigEntry, fsp3000=fsp3000, swDbFileCreationTime=swDbFileCreationTime, provContainerTable=provContainerTable, swDbDataNumNativeNsaUpdate=swDbDataNumNativeNsaUpdate, eqpFwServiceImpairment=eqpFwServiceImpairment, ApsDirection=ApsDirection, coldRestartCapEntry=coldRestartCapEntry, swDbDataIndex=swDbDataIndex, controlPlaneOtnEntityIndexAid=controlPlaneOtnEntityIndexAid, neF7AutomaticBackupTable=neF7AutomaticBackupTable, controlPlaneWdmContainsIndex=controlPlaneWdmContainsIndex, EquipmentState=EquipmentState, OtnPayloadType=OtnPayloadType, controlPlaneWdmContainsTable=controlPlaneWdmContainsTable, EnableStateCaps=EnableStateCaps, coldRestartCapServiceAffectingCap=coldRestartCapServiceAffectingCap, oduTcmAConfigEntry=oduTcmAConfigEntry, updateEqpt=updateEqpt, neStorageIndex=neStorageIndex, neF7AutomaticBackupTimeStamp=neF7AutomaticBackupTimeStamp, OtnTcmLevelCaps=OtnTcmLevelCaps, neEventLogTimeStamp=neEventLogTimeStamp, oduSectionDataTable=oduSectionDataTable, NcuAutoActivation=NcuAutoActivation, snmpAgent=snmpAgent, aosCommon=aosCommon, neTrapsinkPort=neTrapsinkPort, PgmType=PgmType, swDbFileVersion=swDbFileVersion, entityAssignmentState=entityAssignmentState, SonetSectSigDegThresCaps=SonetSectSigDegThresCaps, FspR7AdminStateSnmpProxyCaps=FspR7AdminStateSnmpProxyCaps, oduTcmCConfigTraceTransmitDapi=oduTcmCConfigTraceTransmitDapi, eqpFwEqpType=eqpFwEqpType, CommandEqpt=CommandEqpt, oduTcmADataEntry=oduTcmADataEntry, oduTcmCConfigTable=oduTcmCConfigTable, fsp150=fsp150, FspR7YesNo=FspR7YesNo, provEquipmentState=provEquipmentState, inventoryCfSerialNum=inventoryCfSerialNum, snmpProxyServerSynchroStage=snmpProxyServerSynchroStage, oduSectionConfigTraceExpected=oduSectionConfigTraceExpected, neF7AutomaticBackupStartTime=neF7AutomaticBackupStartTime, swAdmin=swAdmin, installedEqpt=installedEqpt, neBackupEncryption=neBackupEncryption, swDbDataTable=swDbDataTable, neMemorySizeFree=neMemorySizeFree, neF7AutomaticRemoteBackupSrvLogin=neF7AutomaticRemoteBackupSrvLogin, neEventLogVarOidVal=neEventLogVarOidVal, fwDataStandbyServiceImpairment=fwDataStandbyServiceImpairment, neMemorySizeTotal=neMemorySizeTotal, oduTcmBConfigTraceTransmitOpsp=oduTcmBConfigTraceTransmitOpsp, neTrapsinkType=neTrapsinkType, neF7AutomaticRemoteBackupSrvIp=neF7AutomaticRemoteBackupSrvIp, oduTcmADataTraceReceivedDapi=oduTcmADataTraceReceivedDapi, config=config, swDbFileEntry=swDbFileEntry, neF7AutomaticBackupRunState=neF7AutomaticBackupRunState, neSwUpgradeTransferProtocol=neSwUpgradeTransferProtocol, LoopConfigCaps=LoopConfigCaps, neRestoreConfig=neRestoreConfig, otuSectionConfigSignalDegradeThreshold=otuSectionConfigSignalDegradeThreshold, oduTcmAConfigTimMode=oduTcmAConfigTimMode, TimModeCaps=TimModeCaps, swDbDataCapUpgradeRequest=swDbDataCapUpgradeRequest, swDbDataArea=swDbDataArea, neBackupRestoreFile=neBackupRestoreFile, EntityIndex=EntityIndex, swDbFileComment=swDbFileComment, controlPlaneWdmEntityIndexAid=controlPlaneWdmEntityIndexAid, fwDataServiceImpairment=fwDataServiceImpairment, common=common, RestoreActivationCaps=RestoreActivationCaps, neStorageCapacity=neStorageCapacity, oduSectionDataTraceReceivedDapi=oduSectionDataTraceReceivedDapi, EthDuplexModeCaps=EthDuplexModeCaps, FspR7EquipmentType=FspR7EquipmentType, controlPlaneWdmEntityAssignmentState=controlPlaneWdmEntityAssignmentState, oduTcmBConfigSignalDegradePeriod=oduTcmBConfigSignalDegradePeriod, entityIndex=entityIndex, neF7AutomaticRemoteBackupUsers=neF7AutomaticRemoteBackupUsers, SonetTimingSource=SonetTimingSource, oduTcmBConfigSignalDegradeThreshold=oduTcmBConfigSignalDegradeThreshold, swDbDataNumLegacyEqpt=swDbDataNumLegacyEqpt, neEventLogVarType=neEventLogVarType, oduSectionConfigTable=oduSectionConfigTable, vtpEntityClass=vtpEntityClass, neF7AutomaticRemoteBackupCommonIpSrv=neF7AutomaticRemoteBackupCommonIpSrv, neEventLogEntry=neEventLogEntry, swVersionInactiveApplSw=swVersionInactiveApplSw, sonetSectionConfigTraceExpected=sonetSectionConfigTraceExpected, OhTerminationLevelCaps=OhTerminationLevelCaps, F7AutoBackupRunState=F7AutoBackupRunState, controlPlaneOtnEntityTable=controlPlaneOtnEntityTable, ptpEntityClass=ptpEntityClass, oduTcmAConfigTraceTransmitSapi=oduTcmAConfigTraceTransmitSapi, neMibVariant=neMibVariant, controlPlaneEthContainsTable=controlPlaneEthContainsTable, controlPlaneOtnContainsEntry=controlPlaneOtnContainsEntry, containsTable=containsTable, neF7AutomaticBackupNextDate=neF7AutomaticBackupNextDate, neEventLogVarOctetStringVal=neEventLogVarOctetStringVal, YesNoNA=YesNoNA, snmpProxyEntrySingleTargetOutUserName=snmpProxyEntrySingleTargetOutUserName, neStorageDescr=neStorageDescr, neStorageEntry=neStorageEntry, neBackupPassword=neBackupPassword, ptpEntityReferencedTo=ptpEntityReferencedTo, SnmpProxySynchronizationStage=SnmpProxySynchronizationStage, ncuActivationDate=ncuActivationDate, events=events, oduTcmBDataTraceReceivedDapi=oduTcmBDataTraceReceivedDapi, aos=aos, ptpEntityEntry=ptpEntityEntry, clearRdiskRequest=clearRdiskRequest, SonetVcBundleAllocationCaps=SonetVcBundleAllocationCaps, fwDataBootStatus=fwDataBootStatus, swDbDataStandbyPartitionStatus=swDbDataStandbyPartitionStatus, neEventsLogged=neEventsLogged, fsp3000alm=fsp3000alm, sonetSectionConfigTimMode=sonetSectionConfigTimMode, oduTcmAConfigTraceExpected=oduTcmAConfigTraceExpected, FspR7AdminStateSnmpProxy=FspR7AdminStateSnmpProxy, oduTcmBConfigEntry=oduTcmBConfigEntry, vtpEntityAssignmentState=vtpEntityAssignmentState, controlPlaneOtnContainsTable=controlPlaneOtnContainsTable, SonetTraceFormCaps=SonetTraceFormCaps, swVersionTable=swVersionTable, oduTcmCConfigTraceExpected=oduTcmCConfigTraceExpected, NoYesNA=NoYesNA, fwDataForm=fwDataForm, oduTcmCConfigTraceTransmitOpsp=oduTcmCConfigTraceTransmitOpsp, inventoryUnitName=inventoryUnitName, admin=admin, F7FileTimeStamp=F7FileTimeStamp, neTrapsinkRowStatus=neTrapsinkRowStatus, otuSectionDataResultingTotalBitrate=otuSectionDataResultingTotalBitrate, oduTcmCDataTraceReceivedSapi=oduTcmCDataTraceReceivedSapi, fwDataFirmwareApproved=fwDataFirmwareApproved, neF7AutomaticRemoteBackupEncryption=neF7AutomaticRemoteBackupEncryption, sonetSectionConfigTraceForm=sonetSectionConfigTraceForm, fwDataStandbyVersion=fwDataStandbyVersion, PartitionStatus=PartitionStatus, oduSectionConfigSignalDegradeThres=oduSectionConfigSignalDegradeThres, neF7AutomaticBackupInterval=neF7AutomaticBackupInterval, inventoryTable=inventoryTable, neF7AutomaticRemoteBackupSrcIp=neF7AutomaticRemoteBackupSrcIp, encryptionFwpFile=encryptionFwpFile, swDbDataRestoreConfig=swDbDataRestoreConfig, fwDataNewVersion=fwDataNewVersion, KBytes=KBytes, neSwInstallState=neSwInstallState, otuSectionConfigSignalDegradePeriod=otuSectionConfigSignalDegradePeriod, neSwUpgradeRequest=neSwUpgradeRequest, controlPlaneEthEntityTable=controlPlaneEthEntityTable, NeSwInstallStatusType=NeSwInstallStatusType, vtpEntityIndex=vtpEntityIndex, sonetSectionConfigTraceTransmit=sonetSectionConfigTraceTransmit, neTrapsinkTable=neTrapsinkTable, oduTcmBDataTraceReceivedOpsp=oduTcmBDataTraceReceivedOpsp, snmpProxyServerAdminState=snmpProxyServerAdminState, SonetVcBundleAllocation=SonetVcBundleAllocation, neSwUpgradeNeDirectory=neSwUpgradeNeDirectory, aosProducts=aosProducts, LoopConfig=LoopConfig, FspTime=FspTime, otuSectionDataTraceReceivedOpsp=otuSectionDataTraceReceivedOpsp, oduTcmCDataTraceReceivedDapi=oduTcmCDataTraceReceivedDapi, snmpProxyEntrySingleTargetOutContext=snmpProxyEntrySingleTargetOutContext, neF7AutomaticBackupStartDate=neF7AutomaticBackupStartDate, entityEquipmentState=entityEquipmentState, controlPlaneEthEntityContainedIn=controlPlaneEthEntityContainedIn, StandbyServiceAffecting=StandbyServiceAffecting, neSwUpgradeServerAddress=neSwUpgradeServerAddress, transportStandards=transportStandards, SonetSectSigDegThres=SonetSectSigDegThres, swDbDataProgramVersion=swDbDataProgramVersion, snmpProxyEntrySingleTargetOutAdminState=snmpProxyEntrySingleTargetOutAdminState, fwDataActivationReadyOnStandby=fwDataActivationReadyOnStandby, oduTcmCConfigTcmLevel=oduTcmCConfigTcmLevel, oduTcmCConfigSignalDegradePeriod=oduTcmCConfigSignalDegradePeriod, oduTcmBConfigTimMode=oduTcmBConfigTimMode, otuSectionDataTable=otuSectionDataTable, swDbFileRowStatus=swDbFileRowStatus, inventorySoftwareRev=inventorySoftwareRev, eqpFwNcuServerBusy=eqpFwNcuServerBusy, FspR7Date=FspR7Date)
