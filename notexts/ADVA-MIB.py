...
mibBuilder.exportSymbols("ADVA-MIB", oduSectionConfigTimMode=oduSectionConfigTimMode, ApsHoldoffTime=ApsHoldoffTime, neF7AutomaticBackupStartDate=neF7AutomaticBackupStartDate, snmpProxyEntrySingleTargetOutContext=snmpProxyEntrySingleTargetOutContext, OtnPayloadTypeCaps=OtnPayloadTypeCaps, neSwUpgradeServerDirectory=neSwUpgradeServerDirectory, EntityType=EntityType, oduSectionDataTraceReceivedSapi=oduSectionDataTraceReceivedSapi, swDbFileIndex=swDbFileIndex, fwDataStandbyVersion=fwDataStandbyVersion, oduSectionDataTraceReceivedOpsp=oduSectionDataTraceReceivedOpsp, controlPlaneOtnContainsIndex=controlPlaneOtnContainsIndex, neStorageIndex=neStorageIndex, sonetSectionConfigTimingSource=sonetSectionConfigTimingSource, FspR7TrapsinkLifetime=FspR7TrapsinkLifetime, swDbDataProgramVersion=swDbDataProgramVersion, ModuleForm=ModuleForm, neSoftwareUpgrade=neSoftwareUpgrade, neTrapsinkType=neTrapsinkType, ptpEntityEquipmentState=ptpEntityEquipmentState, TimMode=TimMode, snmpAgent=snmpAgent, NeSwInstallStatusType=NeSwInstallStatusType, snmpProxyServerSynchroState=snmpProxyServerSynchroState, oduTcmADataTraceReceivedOpsp=oduTcmADataTraceReceivedOpsp, ptpEntityReferencedTo=ptpEntityReferencedTo, neF7AutomaticRemoteBackupSrvLogin=neF7AutomaticRemoteBackupSrvLogin, controlPlaneEthContainsTable=controlPlaneEthContainsTable, otuSectionDataTraceReceivedOpsp=otuSectionDataTraceReceivedOpsp, fwDataNewVersion=fwDataNewVersion, swDbDataDatabaseVersion=swDbDataDatabaseVersion, swAdmin=swAdmin, vtpEntityClass=vtpEntityClass, oduTcmBConfigEntry=oduTcmBConfigEntry, ncuActivationTime=ncuActivationTime, otuSectionDataEntry=otuSectionDataEntry, neBackupUsers=neBackupUsers, inventoryMacAddress=inventoryMacAddress, neTrapsinkPort=neTrapsinkPort, controlPlaneWdmContainsIndex=controlPlaneWdmContainsIndex, vtpEntityReferencedTo=vtpEntityReferencedTo, neEventLogVarCounter64Val=neEventLogVarCounter64Val, SnmpProxySynchronizationState=SnmpProxySynchronizationState, ApsDirection=ApsDirection, fwDataFirmwareApproved=fwDataFirmwareApproved, oduTcmBConfigSignalDegradePeriod=oduTcmBConfigSignalDegradePeriod, eqpFwServiceImpairment=eqpFwServiceImpairment, fsp150=fsp150, snmpProxyEntrySingleTargetOutNodeAgentStatus=snmpProxyEntrySingleTargetOutNodeAgentStatus, swVersionTable=swVersionTable, oduSectionConfigEntry=oduSectionConfigEntry, EthDuplexMode=EthDuplexMode, neEventLogIndex=neEventLogIndex, otuSectionConfigTable=otuSectionConfigTable, oduTcmAConfigEntry=oduTcmAConfigEntry, dbAdmin=dbAdmin, neF7AutomaticRemoteBackupSrvDir=neF7AutomaticRemoteBackupSrvDir, neTrapsinkTable=neTrapsinkTable, encryptionFwpFile=encryptionFwpFile, neAutoBackupServerLogin=neAutoBackupServerLogin, SonetSectSigDegThresCaps=SonetSectSigDegThresCaps, inventoryFirmwarePackageRev=inventoryFirmwarePackageRev, swDbFileFileName=swDbFileFileName, updateEqpt=updateEqpt, oduTcmBConfigSignalDegradeThreshold=oduTcmBConfigSignalDegradeThreshold, LoopConfigCaps=LoopConfigCaps, sonetSectionConfigTraceExpected=sonetSectionConfigTraceExpected, ptpEntityClassInstanceNumber=ptpEntityClassInstanceNumber, snmpProxyEntrySingleTargetOutPort=snmpProxyEntrySingleTargetOutPort, oduTcmAConfigTimMode=oduTcmAConfigTimMode, neF7AutomaticRemoteBackupSrvIp=neF7AutomaticRemoteBackupSrvIp, SnmpProxySynchronizationStage=SnmpProxySynchronizationStage, neTrapsinkAddress=neTrapsinkAddress, oduSectionConfigTraceExpected=oduSectionConfigTraceExpected, neTrapsinkEntry=neTrapsinkEntry, neEventLogVarIpAddressVal=neEventLogVarIpAddressVal, neBackupRestore=neBackupRestore, ptpEntityClass=ptpEntityClass, oduTcmBConfigTraceExpected=oduTcmBConfigTraceExpected, oduTcmCConfigTable=oduTcmCConfigTable, entityAssignmentState=entityAssignmentState, neF7AutomaticRemoteBackupUsers=neF7AutomaticRemoteBackupUsers, neAutoBackupInterval=neAutoBackupInterval, neEventLogTable=neEventLogTable, neAutoBackupNextActionAt=neAutoBackupNextActionAt, neF7AutomaticRemoteBackupProtocol=neF7AutomaticRemoteBackupProtocol, swDbDataRestoreConfig=swDbDataRestoreConfig, swVersionActiveApplSw=swVersionActiveApplSw, oduTcmAConfigTable=oduTcmAConfigTable, controlPlaneWdmContainsEntry=controlPlaneWdmContainsEntry, snmpWriteAccessNmsName=snmpWriteAccessNmsName, neSwDownloadProgress=neSwDownloadProgress, FspR7UsersDb=FspR7UsersDb, oduTcmBDataTraceReceivedOpsp=oduTcmBDataTraceReceivedOpsp, swDbFileTable=swDbFileTable, ServiceAffecting=ServiceAffecting, entityClassInstanceNumber=entityClassInstanceNumber, swDbDataNumLegacyUpdate=swDbDataNumLegacyUpdate, swDbFileType=swDbFileType, swDbDataIndex=swDbDataIndex, inventoryUnitName=inventoryUnitName, swDbDataTable=swDbDataTable, swDbDataNumEqpt=swDbDataNumEqpt, neEventLogVarOidVal=neEventLogVarOidVal, KBytes=KBytes, controlPlaneWdmEntityIndexAid=controlPlaneWdmEntityIndexAid, TimModeCaps=TimModeCaps, OhTerminationLevelCaps=OhTerminationLevelCaps, SonetSectSigDegThres=SonetSectSigDegThres, events=events, snmpProxyEntrySingleTargetOutEntry=snmpProxyEntrySingleTargetOutEntry, neEventLogVarType=neEventLogVarType, NcuAutoActivation=NcuAutoActivation, oduTcmADataTraceReceivedSapi=oduTcmADataTraceReceivedSapi, RestoreActivation=RestoreActivation, controlPlaneWdmEntityClassInstanceNumber=controlPlaneWdmEntityClassInstanceNumber, controlPlaneEthEntityClass=controlPlaneEthEntityClass, LogicalIfTransportCaps=LogicalIfTransportCaps, neF7AutomaticRemoteBackupSrcIp=neF7AutomaticRemoteBackupSrcIp, oduTcmBConfigTraceTransmitDapi=oduTcmBConfigTraceTransmitDapi, ptpEntityType=ptpEntityType, ptpEntityIndexAid=ptpEntityIndexAid, sonetSectionDataEntry=sonetSectionDataEntry, OtnTcmLevelCaps=OtnTcmLevelCaps, swVersionNextBoot=swVersionNextBoot, oduSectionConfigTable=oduSectionConfigTable, OhTerminationLevel=OhTerminationLevel, oduTcmBDataTraceReceivedSapi=oduTcmBDataTraceReceivedSapi, sonetSectionDataTraceReceived=sonetSectionDataTraceReceived, containsEntry=containsEntry, oduTcmCConfigTraceTransmitDapi=oduTcmCConfigTraceTransmitDapi, PYSNMP_MODULE_ID=advaMIB, sonetSectionConfigTraceForm=sonetSectionConfigTraceForm, fwDataForm=fwDataForm, provContainerTable=provContainerTable, aos=aos, fwDataStandbyServiceImpairment=fwDataStandbyServiceImpairment, swDbFileGrade=swDbFileGrade, neTrapsinkRowStatus=neTrapsinkRowStatus, inventoryCfSerialNum=inventoryCfSerialNum, ptpEntityEntry=ptpEntityEntry, oduTcmCDataEntry=oduTcmCDataEntry, NeSwUpgradeStatusType=NeSwUpgradeStatusType, fwDataBootStatus=fwDataBootStatus, FileTransferProtocol=FileTransferProtocol, FileType=FileType, fwDataReadyForActivation=fwDataReadyForActivation, EthDuplexModeCaps=EthDuplexModeCaps, neStorageCapacity=neStorageCapacity, fwDataFirmwarePackageRevBackup=fwDataFirmwarePackageRevBackup, neF7AutomaticBackupInterval=neF7AutomaticBackupInterval, neMemorySizeFree=neMemorySizeFree, neF7AutomaticRemoteBackupPassword=neF7AutomaticRemoteBackupPassword, ptpEntityAssignmentState=ptpEntityAssignmentState, VirtualContainerType=VirtualContainerType, F7AutoBackupRunState=F7AutoBackupRunState, swDbDataActivationTime=swDbDataActivationTime, neAutoBackupServerPasswd=neAutoBackupServerPasswd, neBackupRestoreState=neBackupRestoreState, FspR7AdminStateSnmpProxyCaps=FspR7AdminStateSnmpProxyCaps, common=common, neManufacturer=neManufacturer, neSwUpgradeType=neSwUpgradeType, EnableStateCaps=EnableStateCaps, neF7AutomaticRemoteBackupSrvPass=neF7AutomaticRemoteBackupSrvPass, OnOff=OnOff, OtnTcmLevel=OtnTcmLevel, swDbDataDefaultsEntry=swDbDataDefaultsEntry, coldRestartCapEntry=coldRestartCapEntry, inventoryTable=inventoryTable, controlPlaneOtnEntityClassInstanceNumber=controlPlaneOtnEntityClassInstanceNumber, oduTcmCConfigTraceExpected=oduTcmCConfigTraceExpected, inventoryPartnumber=inventoryPartnumber, SourceIpAddress=SourceIpAddress, oduTcmAConfigTraceTransmitSapi=oduTcmAConfigTraceTransmitSapi, controlPlaneWdmEntityEntry=controlPlaneWdmEntityEntry, sonetConfig=sonetConfig, oduTcmBConfigTable=oduTcmBConfigTable, entityEquipmentState=entityEquipmentState, swVersionInactiveOperatingSw=swVersionInactiveOperatingSw, admin=admin, oduTcmAConfigTcmLevel=oduTcmAConfigTcmLevel, YesNoNA=YesNoNA, fsp3000=fsp3000, FspR7EquipmentTypeCaps=FspR7EquipmentTypeCaps, LoopConfig=LoopConfig, fwDataFirmwareAvailable=fwDataFirmwareAvailable, clearRdiskRequest=clearRdiskRequest, oduSectionConfigSignalDegradeThres=oduSectionConfigSignalDegradeThres, F7AutoBackupInterval=F7AutoBackupInterval, oduTcmADataTable=oduTcmADataTable, neBackupEncryption=neBackupEncryption, inventoryEntry=inventoryEntry, fsp1500=fsp1500, neF7AutomaticBackupNextDate=neF7AutomaticBackupNextDate, Counter64String=Counter64String, ncuScheduledDbRestore=ncuScheduledDbRestore, snmpWriteAccessRestriction=snmpWriteAccessRestriction, oduTcmBDataTraceReceivedDapi=oduTcmBDataTraceReceivedDapi, neEventLogVarUnsigned32Val=neEventLogVarUnsigned32Val, oduConfig=oduConfig, swDbDataNumNativeNsaUpdate=swDbDataNumNativeNsaUpdate, oduTcmCConfigTraceTransmitOpsp=oduTcmCConfigTraceTransmitOpsp, provContainerEntry=provContainerEntry, snmpProxyEntrySingleTargetOutAdminState=snmpProxyEntrySingleTargetOutAdminState, ServiceAffectingCaps=ServiceAffectingCaps, oduTcmCDataTraceReceivedDapi=oduTcmCDataTraceReceivedDapi, swDbFileRowStatus=swDbFileRowStatus, sonetSectionDataTable=sonetSectionDataTable, inventoryMib=inventoryMib, neSwInstallState=neSwInstallState, fwDataStandbyFirmwareAvailable=fwDataStandbyFirmwareAvailable, neStorageDescr=neStorageDescr, ServiceImpairment=ServiceImpairment, neDateAndTime=neDateAndTime, entityContainedIn=entityContainedIn, snmpProxyServerSynchroStage=snmpProxyServerSynchroStage, neInitialConnectionMode=neInitialConnectionMode, controlPlaneEthEntityTable=controlPlaneEthEntityTable, neSwUpgradeServerLogin=neSwUpgradeServerLogin, controlPlaneWdmEntityClass=controlPlaneWdmEntityClass, vtpEntityEntry=vtpEntityEntry, vtpEntityAssignmentState=vtpEntityAssignmentState, neEventsLogged=neEventsLogged, FspR7EnableDisable=FspR7EnableDisable, oduTcmCDataTable=oduTcmCDataTable, neSwUpgradeTransferProtocol=neSwUpgradeTransferProtocol, vtpEntityIndex=vtpEntityIndex, swDbFilePgmType=swDbFilePgmType, swDbDataStandbyPartitionStatus=swDbDataStandbyPartitionStatus, FspDate=FspDate, oduTcmBConfigTcmLevel=oduTcmBConfigTcmLevel, entityType=entityType, oduTcmCConfigTcmLevel=oduTcmCConfigTcmLevel, FspR7AdminStateSnmpProxy=FspR7AdminStateSnmpProxy, neAlarmStatus=neAlarmStatus, inventoryGradeInventory=inventoryGradeInventory, fsp1000=fsp1000, selectedFile=selectedFile, FspTime=FspTime, ncuActivationTimeUtc=ncuActivationTimeUtc, controlPlaneOtnContainsEntry=controlPlaneOtnContainsEntry, neSwUpgradeState=neSwUpgradeState, TrapCounter=TrapCounter, neEventLogVarOctetStringVal=neEventLogVarOctetStringVal, controlPlaneWdmEntityAssignmentState=controlPlaneWdmEntityAssignmentState, swDbDataEntry=swDbDataEntry, otuSectionConfigPayload=otuSectionConfigPayload, aosProducts=aosProducts, neBackupRestoreFile=neBackupRestoreFile, SonetTraceFormCaps=SonetTraceFormCaps, SonetTimingSource=SonetTimingSource, inventoryCfModel=inventoryCfModel, snmpWriteAccessNmsAddress=snmpWriteAccessNmsAddress)
mibBuilder.exportSymbols("ADVA-MIB", SonetTimingSourceCaps=SonetTimingSourceCaps, fwDataServiceImpairment=fwDataServiceImpairment, controlPlaneEthEntityClassInstanceNumber=controlPlaneEthEntityClassInstanceNumber, ptpEntityContainedIn=ptpEntityContainedIn, EquipmentState=EquipmentState, neTrapsinkUserName=neTrapsinkUserName, eqpFwNcuServerBusy=eqpFwNcuServerBusy, eqpFwUpgradeRequest=eqpFwUpgradeRequest, snmpProxyEntrySingleTargetOutTable=snmpProxyEntrySingleTargetOutTable, neAutoBackup=neAutoBackup, config=config, entityIndexAid=entityIndexAid, fwDataFirmwarePackageRev=fwDataFirmwarePackageRev, TrapAlarmSeverity=TrapAlarmSeverity, otuSectionConfigStuffing=otuSectionConfigStuffing, LogicalIfTransport=LogicalIfTransport, inventoryHardwareRev=inventoryHardwareRev, swDbDataCapUpgradeRequest=swDbDataCapUpgradeRequest, eqpFwEqpServerBusy=eqpFwEqpServerBusy, ptpEntityTable=ptpEntityTable, SonetTraceForm=SonetTraceForm, transportStandards=transportStandards, snmpWriteAccessTable=snmpWriteAccessTable, controlPlaneOtnEntityAssignmentState=controlPlaneOtnEntityAssignmentState, oduSectionConfigTraceTransmitSapi=oduSectionConfigTraceTransmitSapi, vtpEntityTable=vtpEntityTable, neSwUpgradeServerPasswd=neSwUpgradeServerPasswd, neAutoBackupServerDirectory=neAutoBackupServerDirectory, fsp150cm=fsp150cm, neEventLogVarIndex=neEventLogVarIndex, neF7AutomaticRemoteBackupCommonIpSrv=neF7AutomaticRemoteBackupCommonIpSrv, neMibVariant=neMibVariant, neStorageEntry=neStorageEntry, neF7AutomaticBackupTable=neF7AutomaticBackupTable, CommandEqpt=CommandEqpt, ApsDirectionCaps=ApsDirectionCaps, oduTcmCConfigSignalDegradePeriod=oduTcmCConfigSignalDegradePeriod, neEventLogEntry=neEventLogEntry, FspR7Date=FspR7Date, swDbFileCreationTime=swDbFileCreationTime, fspR7=fspR7, swDbDataCapTable=swDbDataCapTable, inventorySoftwareRev=inventorySoftwareRev, neRestoreFileBackupDate=neRestoreFileBackupDate, inventoryVendorId=inventoryVendorId, advaMIB=advaMIB, ptpEntityIndex=ptpEntityIndex, installedEqpt=installedEqpt, coldRestartCapServiceAffectingCap=coldRestartCapServiceAffectingCap, swDbDataDefaultsUpgradeRequest=swDbDataDefaultsUpgradeRequest, otuSectionConfigTimMode=otuSectionConfigTimMode, FspR7EquipmentType=FspR7EquipmentType, swDbFileArea=swDbFileArea, fsp2000=fsp2000, otn=otn, swDbDataCapRestoreConfig=swDbDataCapRestoreConfig, inventoryFpgaRev=inventoryFpgaRev, fwDataTable=fwDataTable, swDbDataDefaultsTable=swDbDataDefaultsTable, snmpProxyServerPort=snmpProxyServerPort, oduTcmAConfigTraceTransmitDapi=oduTcmAConfigTraceTransmitDapi, BootState=BootState, FspR7Time=FspR7Time, oduTcmAConfigTraceTransmitOpsp=oduTcmAConfigTraceTransmitOpsp, AvailState=AvailState, swDbDataNumNsaNotReady=swDbDataNumNsaNotReady, neF7AutomaticBackupStartTime=neF7AutomaticBackupStartTime, inventoryUniversalSerialIdent=inventoryUniversalSerialIdent, neF7AutomaticBackupTimeStamp=neF7AutomaticBackupTimeStamp, inventorySerialNum=inventorySerialNum, neEventLogVarInteger32Val=neEventLogVarInteger32Val, controlPlaneWdmEntityContainedIn=controlPlaneWdmEntityContainedIn, controlPlaneEthEntityAssignmentState=controlPlaneEthEntityAssignmentState, RestoreActivationCaps=RestoreActivationCaps, neEventLogVarId=neEventLogVarId, oduSectionConfigTraceTransmitDapi=oduSectionConfigTraceTransmitDapi, neTrapsinkVersion=neTrapsinkVersion, swVersionInactiveApplSw=swVersionInactiveApplSw, entityClass=entityClass, neF7AutomaticBackupRunState=neF7AutomaticBackupRunState, fwDataEntry=fwDataEntry, snmpProxyEntrySingleTargetOutRowStatus=snmpProxyEntrySingleTargetOutRowStatus, oduSectionDataTraceReceivedDapi=oduSectionDataTraceReceivedDapi, NoYesNA=NoYesNA, EnableState=EnableState, neSwUpgradeFileName=neSwUpgradeFileName, ncuActivationDate=ncuActivationDate, oduTcmCConfigEntry=oduTcmCConfigEntry, neBackupRestoreRequest=neBackupRestoreRequest, oduTcmBConfigTraceTransmitSapi=oduTcmBConfigTraceTransmitSapi, ncuScheduledActivation=ncuScheduledActivation, swDbDataNumSaNotReady=swDbDataNumSaNotReady, snmpProxyServerAdminState=snmpProxyServerAdminState, neAutoBackupServerAddress=neAutoBackupServerAddress, eqpFwEqpType=eqpFwEqpType, swDbDataCapEntry=swDbDataCapEntry, neF7AutomaticRemoteBackupEncryption=neF7AutomaticRemoteBackupEncryption, fsp1000adm=fsp1000adm, eqpFwNextEqpForUpdate=eqpFwNextEqpForUpdate, swDbFileVersion=swDbFileVersion, provAssignmentState=provAssignmentState, oduSectionConfigSignalDegradePeriod=oduSectionConfigSignalDegradePeriod, oduTcmAConfigSignalDegradeThreshold=oduTcmAConfigSignalDegradeThreshold, swVersionActiveOperatingSw=swVersionActiveOperatingSw, EntityIndex=EntityIndex, otuSectionConfigTraceExpected=otuSectionConfigTraceExpected, containsTable=containsTable, oduTcmADataTraceReceivedDapi=oduTcmADataTraceReceivedDapi, fwDataActivationReadyOnStandby=fwDataActivationReadyOnStandby, fwDataProtectionPart=fwDataProtectionPart, DestinationNodeOrAgentState=DestinationNodeOrAgentState, sonetSectionConfigEntry=sonetSectionConfigEntry, oduTcmBConfigTraceTransmitOpsp=oduTcmBConfigTraceTransmitOpsp, entityTable=entityTable, swDbDataNcuSoftwareVersion=swDbDataNcuSoftwareVersion, otuSectionDataTraceReceivedDapi=otuSectionDataTraceReceivedDapi, otuSectionConfigTraceTransmitOpsp=otuSectionConfigTraceTransmitOpsp, controlPlaneEthContainsIndex=controlPlaneEthContainsIndex, sonetSectionConfigSignalDegradeThreshhold=sonetSectionConfigSignalDegradeThreshhold, oduTcmADataEntry=oduTcmADataEntry, neRestoreConfig=neRestoreConfig, controlPlaneWdmContainsTable=controlPlaneWdmContainsTable, neAutoBackupConfig=neAutoBackupConfig, neSwUpgradeNeDirectory=neSwUpgradeNeDirectory, neEventLogNotificationOID=neEventLogNotificationOID, controlPlaneOtnEntityContainedIn=controlPlaneOtnEntityContainedIn, otuSectionDataTable=otuSectionDataTable, controlPlaneWdmEntityIndex=controlPlaneWdmEntityIndex, EntityClass=EntityClass, oduTcmBConfigTimMode=oduTcmBConfigTimMode, products=products, controlPlaneOtnEntityIndexAid=controlPlaneOtnEntityIndexAid, controlPlaneOtnEntityTable=controlPlaneOtnEntityTable, CpWdmEntityClass=CpWdmEntityClass, controlPlaneOtnEntityIndex=controlPlaneOtnEntityIndex, oduSectionDataTable=oduSectionDataTable, neMemorySizeTotal=neMemorySizeTotal, oduTcmBDataTable=oduTcmBDataTable, neSwUpgradeCommonIpSrv=neSwUpgradeCommonIpSrv, oduTcmBDataEntry=oduTcmBDataEntry, swDbDataFirmwareSetVersion=swDbDataFirmwareSetVersion, neBackupPassword=neBackupPassword, swDbDataArea=swDbDataArea, VirtualContainerTypeCaps=VirtualContainerTypeCaps, entityIndex=entityIndex, OtnPayloadType=OtnPayloadType, software=software, oduTcmAConfigTraceExpected=oduTcmAConfigTraceExpected, neEventLogIdentityTranslation=neEventLogIdentityTranslation, otuSectionConfigTraceTransmitSapi=otuSectionConfigTraceTransmitSapi, fsp3000alm=fsp3000alm, aosCommon=aosCommon, sonet=sonet, SonetVcBundleAllocation=SonetVcBundleAllocation, neEventLogVarEntry=neEventLogVarEntry, provEquipmentState=provEquipmentState, snmpProxyEntrySingleTargetOutUserName=snmpProxyEntrySingleTargetOutUserName, sonetSectionConfigSignalDegradePeriod=sonetSectionConfigSignalDegradePeriod, sonetSectionConfigTimMode=sonetSectionConfigTimMode, swDbDataNumLegacyEqpt=swDbDataNumLegacyEqpt, vtpEntityType=vtpEntityType, F7FileTimeStamp=F7FileTimeStamp, swDbDataNumNativeSaUpdate=swDbDataNumNativeSaUpdate, sonetSectionConfigTable=sonetSectionConfigTable, vtpEntityIndexAid=vtpEntityIndexAid, ApsHoldoffTimeCaps=ApsHoldoffTimeCaps, snmpProxyEntrySingleTargetOutAddress=snmpProxyEntrySingleTargetOutAddress, swVersionEntry=swVersionEntry, neF7AutomaticRemoteBackupTimeStamp=neF7AutomaticRemoteBackupTimeStamp, entityEntry=entityEntry, controlPlaneEthEntityContainedIn=controlPlaneEthEntityContainedIn, vtpEntityEquipmentState=vtpEntityEquipmentState, sourceIpAddress=sourceIpAddress, oduTcmCDataTraceReceivedSapi=oduTcmCDataTraceReceivedSapi, otuSectionConfigSignalDegradePeriod=otuSectionConfigSignalDegradePeriod, PgmType=PgmType, vtpEntityClassInstanceNumber=vtpEntityClassInstanceNumber, containsIndex=containsIndex, oduTcmAConfigSignalDegradePeriod=oduTcmAConfigSignalDegradePeriod, otuSectionConfigEntry=otuSectionConfigEntry, otuSectionConfigSignalDegradeThreshold=otuSectionConfigSignalDegradeThreshold, FileArea=FileArea, swDbFileComment=swDbFileComment, neSwUpgradeRequest=neSwUpgradeRequest, controlPlaneOtnEntityEntry=controlPlaneOtnEntityEntry, ncuActivationDateUtc=ncuActivationDateUtc, oduSectionConfigTraceTransmitOpsp=oduSectionConfigTraceTransmitOpsp, neEventLogTimeStamp=neEventLogTimeStamp, ArcState=ArcState, snmpServerPort=snmpServerPort, vtpEntityContainedIn=vtpEntityContainedIn, otuSectionDataTraceReceivedSapi=otuSectionDataTraceReceivedSapi, neEventLogVarTable=neEventLogVarTable, PartitionStatus=PartitionStatus, ProtectionMech=ProtectionMech, inventoryCleiCode=inventoryCleiCode, inventoryType=inventoryType, neStorageAvailable=neStorageAvailable, snmpWriteAccessEntry=snmpWriteAccessEntry, otuConfig=otuConfig, controlPlaneEthEntityEntry=controlPlaneEthEntityEntry, FspR7YesNo=FspR7YesNo, swDbFileEntry=swDbFileEntry, controlPlaneEthEntityIndexAid=controlPlaneEthEntityIndexAid, swDbFileSize=swDbFileSize, controlPlaneWdmEntityTable=controlPlaneWdmEntityTable, swDbDataDefaultsRestoreConfig=swDbDataDefaultsRestoreConfig, neTrapsinkCommunity=neTrapsinkCommunity, oduSectionDataEntry=oduSectionDataEntry, neStorageTable=neStorageTable, otuSectionConfigTraceTransmitDapi=otuSectionConfigTraceTransmitDapi, ProtectionMechCaps=ProtectionMechCaps, neInfo=neInfo, oduTcmCConfigSignalDegradeThreshold=oduTcmCConfigSignalDegradeThreshold, controlPlaneOtnEntityClass=controlPlaneOtnEntityClass, Grade=Grade, StandbyServiceAffecting=StandbyServiceAffecting, FspR7FalseTrue=FspR7FalseTrue, sonetSectionConfigTraceTransmit=sonetSectionConfigTraceTransmit, oduTcmCConfigTraceTransmitSapi=oduTcmCConfigTraceTransmitSapi, fspNm=fspNm, IdentityTranslation=IdentityTranslation, coldRestartCapTable=coldRestartCapTable, otuSectionDataResultingTotalBitrate=otuSectionDataResultingTotalBitrate, oduTcmCDataTraceReceivedOpsp=oduTcmCDataTraceReceivedOpsp, fsp3000c=fsp3000c, SonetVcBundleAllocationCaps=SonetVcBundleAllocationCaps, updateBackupRestoreMib=updateBackupRestoreMib, controlPlaneEthContainsEntry=controlPlaneEthContainsEntry, controlPlaneEthEntityIndex=controlPlaneEthEntityIndex, neSwUpgradeServerAddress=neSwUpgradeServerAddress, AssignmentState=AssignmentState, oduTcmCConfigTimMode=oduTcmCConfigTimMode, neF7AutomaticBackupEntry=neF7AutomaticBackupEntry, controlPlaneOtnContainsTable=controlPlaneOtnContainsTable, neF7AutomaticBackupIndex=neF7AutomaticBackupIndex)
