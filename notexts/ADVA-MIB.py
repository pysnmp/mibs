...
TestAndIncr, DisplayString, TimeStamp, DateAndTime, MacAddress, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "DisplayString", "TimeStamp", "DateAndTime", "MacAddress", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("ADVA-MIB", oduTcmBConfigTimMode=oduTcmBConfigTimMode, ptpEntityEntry=ptpEntityEntry, sonet=sonet, ApsDirection=ApsDirection, neSwUpgradeRequest=neSwUpgradeRequest, swDbFileFileName=swDbFileFileName, otuSectionConfigTraceExpected=otuSectionConfigTraceExpected, neEventLogVarOctetStringVal=neEventLogVarOctetStringVal, SnmpProxySynchronizationStage=SnmpProxySynchronizationStage, updateEqpt=updateEqpt, entityEquipmentState=entityEquipmentState, snmpProxyServerSynchroState=snmpProxyServerSynchroState, entityAssignmentState=entityAssignmentState, neTrapsinkType=neTrapsinkType, inventorySoftwareRev=inventorySoftwareRev, neEventLogVarId=neEventLogVarId, swDbFilePgmType=swDbFilePgmType, selectedFile=selectedFile, swDbDataNumLegacyUpdate=swDbDataNumLegacyUpdate, entityClass=entityClass, oduTcmAConfigSignalDegradeThreshold=oduTcmAConfigSignalDegradeThreshold, swVersionActiveOperatingSw=swVersionActiveOperatingSw, sonetSectionDataEntry=sonetSectionDataEntry, controlPlaneWdmEntityContainedIn=controlPlaneWdmEntityContainedIn, neAutoBackupConfig=neAutoBackupConfig, controlPlaneOtnContainsTable=controlPlaneOtnContainsTable, neEventLogNotificationOID=neEventLogNotificationOID, neEventLogVarOidVal=neEventLogVarOidVal, inventorySerialNum=inventorySerialNum, fspR7=fspR7, neBackupRestoreRequest=neBackupRestoreRequest, sonetSectionDataTraceReceived=sonetSectionDataTraceReceived, swDbDataTable=swDbDataTable, swDbDataCapEntry=swDbDataCapEntry, sonetSectionConfigTimingSource=sonetSectionConfigTimingSource, oduTcmBConfigTraceExpected=oduTcmBConfigTraceExpected, swDbDataNumEqpt=swDbDataNumEqpt, SonetTraceFormCaps=SonetTraceFormCaps, oduSectionDataTable=oduSectionDataTable, neEventsLogged=neEventsLogged, controlPlaneOtnEntityIndex=controlPlaneOtnEntityIndex, swDbDataDefaultsUpgradeRequest=swDbDataDefaultsUpgradeRequest, snmpWriteAccessEntry=snmpWriteAccessEntry, ncuScheduledDbRestore=ncuScheduledDbRestore, sonetConfig=sonetConfig, neEventLogVarCounter64Val=neEventLogVarCounter64Val, sonetSectionDataTable=sonetSectionDataTable, oduTcmAConfigTraceTransmitSapi=oduTcmAConfigTraceTransmitSapi, FileArea=FileArea, ArcState=ArcState, ptpEntityContainedIn=ptpEntityContainedIn, vtpEntityTable=vtpEntityTable, neEventLogEntry=neEventLogEntry, oduSectionConfigSignalDegradeThres=oduSectionConfigSignalDegradeThres, oduTcmAConfigTable=oduTcmAConfigTable, oduTcmAConfigTcmLevel=oduTcmAConfigTcmLevel, neTrapsinkCommunity=neTrapsinkCommunity, swDbDataDefaultsTable=swDbDataDefaultsTable, swDbFileComment=swDbFileComment, LoopConfig=LoopConfig, inventoryFpgaRev=inventoryFpgaRev, swDbFileGrade=swDbFileGrade, RestoreActivationCaps=RestoreActivationCaps, controlPlaneWdmEntityClassInstanceNumber=controlPlaneWdmEntityClassInstanceNumber, otuSectionDataEntry=otuSectionDataEntry, CommandEqpt=CommandEqpt, controlPlaneEthEntityTable=controlPlaneEthEntityTable, neF7AutomaticBackupStartTime=neF7AutomaticBackupStartTime, inventoryUniversalSerialIdent=inventoryUniversalSerialIdent, oduSectionConfigTraceTransmitSapi=oduSectionConfigTraceTransmitSapi, neSoftwareUpgrade=neSoftwareUpgrade, ServiceImpairment=ServiceImpairment, swDbDataIndex=swDbDataIndex, oduConfig=oduConfig, containsTable=containsTable, coldRestartCapServiceAffectingCap=coldRestartCapServiceAffectingCap, oduSectionConfigTimMode=oduSectionConfigTimMode, ptpEntityIndex=ptpEntityIndex, neEventLogVarEntry=neEventLogVarEntry, swDbDataNcuSoftwareVersion=swDbDataNcuSoftwareVersion, ptpEntityClass=ptpEntityClass, aosProducts=aosProducts, entityIndex=entityIndex, swDbFileIndex=swDbFileIndex, neAutoBackupServerLogin=neAutoBackupServerLogin, ApsHoldoffTime=ApsHoldoffTime, swDbDataRestoreConfig=swDbDataRestoreConfig, snmpWriteAccessNmsAddress=snmpWriteAccessNmsAddress, controlPlaneOtnEntityClassInstanceNumber=controlPlaneOtnEntityClassInstanceNumber, controlPlaneEthEntityAssignmentState=controlPlaneEthEntityAssignmentState, oduTcmCConfigSignalDegradeThreshold=oduTcmCConfigSignalDegradeThreshold, ptpEntityType=ptpEntityType, EntityIndex=EntityIndex, snmpProxyEntrySingleTargetOutPort=snmpProxyEntrySingleTargetOutPort, snmpWriteAccessRestriction=snmpWriteAccessRestriction, fsp1000=fsp1000, otuSectionConfigTraceTransmitOpsp=otuSectionConfigTraceTransmitOpsp, otuSectionConfigTraceTransmitSapi=otuSectionConfigTraceTransmitSapi, neEventLogVarIndex=neEventLogVarIndex, ServiceAffecting=ServiceAffecting, advaMIB=advaMIB, OtnPayloadType=OtnPayloadType, SourceIpAddress=SourceIpAddress, neBackupPassword=neBackupPassword, controlPlaneEthContainsIndex=controlPlaneEthContainsIndex, controlPlaneEthEntityIndexAid=controlPlaneEthEntityIndexAid, neTrapsinkRowStatus=neTrapsinkRowStatus, oduTcmBConfigSignalDegradePeriod=oduTcmBConfigSignalDegradePeriod, AvailState=AvailState, VirtualContainerType=VirtualContainerType, fwDataActivationReadyOnStandby=fwDataActivationReadyOnStandby, neF7AutomaticBackupTable=neF7AutomaticBackupTable, swDbFileSize=swDbFileSize, swVersionActiveApplSw=swVersionActiveApplSw, otuSectionConfigPayload=otuSectionConfigPayload, clearRdiskRequest=clearRdiskRequest, SonetSectSigDegThresCaps=SonetSectSigDegThresCaps, vtpEntityIndex=vtpEntityIndex, FspR7TrapsinkLifetime=FspR7TrapsinkLifetime, oduTcmCConfigTraceTransmitOpsp=oduTcmCConfigTraceTransmitOpsp, ptpEntityClassInstanceNumber=ptpEntityClassInstanceNumber, provContainerEntry=provContainerEntry, SonetVcBundleAllocation=SonetVcBundleAllocation, snmpWriteAccessTable=snmpWriteAccessTable, otuSectionDataTraceReceivedOpsp=otuSectionDataTraceReceivedOpsp, oduTcmAConfigTraceTransmitDapi=oduTcmAConfigTraceTransmitDapi, otuSectionConfigSignalDegradeThreshold=otuSectionConfigSignalDegradeThreshold, snmpProxyEntrySingleTargetOutEntry=snmpProxyEntrySingleTargetOutEntry, inventoryPartnumber=inventoryPartnumber, FspR7YesNo=FspR7YesNo, coldRestartCapEntry=coldRestartCapEntry, eqpFwNcuServerBusy=eqpFwNcuServerBusy, otuSectionConfigTable=otuSectionConfigTable, fwDataFirmwareAvailable=fwDataFirmwareAvailable, neF7AutomaticBackupTimeStamp=neF7AutomaticBackupTimeStamp, swDbFileTable=swDbFileTable, TrapAlarmSeverity=TrapAlarmSeverity, neStorageTable=neStorageTable, ptpEntityReferencedTo=ptpEntityReferencedTo, admin=admin, FspTime=FspTime, OhTerminationLevelCaps=OhTerminationLevelCaps, fwDataBootStatus=fwDataBootStatus, controlPlaneEthContainsTable=controlPlaneEthContainsTable, ptpEntityAssignmentState=ptpEntityAssignmentState, neF7AutomaticRemoteBackupSrvPass=neF7AutomaticRemoteBackupSrvPass, NeSwInstallStatusType=NeSwInstallStatusType, neAutoBackupNextActionAt=neAutoBackupNextActionAt, fwDataStandbyServiceImpairment=fwDataStandbyServiceImpairment, vtpEntityReferencedTo=vtpEntityReferencedTo, neMemorySizeFree=neMemorySizeFree, neF7AutomaticRemoteBackupEncryption=neF7AutomaticRemoteBackupEncryption, inventoryCleiCode=inventoryCleiCode, EnableStateCaps=EnableStateCaps, FspR7EquipmentType=FspR7EquipmentType, provAssignmentState=provAssignmentState, F7FileTimeStamp=F7FileTimeStamp, swDbDataNumLegacyEqpt=swDbDataNumLegacyEqpt, oduTcmBDataEntry=oduTcmBDataEntry, neAlarmStatus=neAlarmStatus, fwDataTable=fwDataTable, swVersionNextBoot=swVersionNextBoot, oduTcmBDataTraceReceivedOpsp=oduTcmBDataTraceReceivedOpsp, SonetTimingSourceCaps=SonetTimingSourceCaps, SonetVcBundleAllocationCaps=SonetVcBundleAllocationCaps, FspR7FalseTrue=FspR7FalseTrue, snmpWriteAccessNmsName=snmpWriteAccessNmsName, neDateAndTime=neDateAndTime, provEquipmentState=provEquipmentState, PartitionStatus=PartitionStatus, neSwInstallState=neSwInstallState, controlPlaneEthEntityClass=controlPlaneEthEntityClass, oduSectionDataTraceReceivedDapi=oduSectionDataTraceReceivedDapi, vtpEntityType=vtpEntityType, swDbFileArea=swDbFileArea, fwDataStandbyVersion=fwDataStandbyVersion, neRestoreConfig=neRestoreConfig, fwDataProtectionPart=fwDataProtectionPart, ModuleForm=ModuleForm, inventoryTable=inventoryTable, fsp3000alm=fsp3000alm, controlPlaneEthEntityClassInstanceNumber=controlPlaneEthEntityClassInstanceNumber, vtpEntityEquipmentState=vtpEntityEquipmentState, oduTcmBConfigEntry=oduTcmBConfigEntry, inventoryMib=inventoryMib, neEventLogVarTable=neEventLogVarTable, neEventLogTable=neEventLogTable, EthDuplexMode=EthDuplexMode, oduSectionDataTraceReceivedSapi=oduSectionDataTraceReceivedSapi, neF7AutomaticRemoteBackupProtocol=neF7AutomaticRemoteBackupProtocol, containsIndex=containsIndex, neF7AutomaticRemoteBackupUsers=neF7AutomaticRemoteBackupUsers, SnmpProxySynchronizationState=SnmpProxySynchronizationState, LogicalIfTransportCaps=LogicalIfTransportCaps, sonetSectionConfigTimMode=sonetSectionConfigTimMode, controlPlaneWdmEntityClass=controlPlaneWdmEntityClass, otuSectionDataTraceReceivedSapi=otuSectionDataTraceReceivedSapi, swDbDataNumNsaNotReady=swDbDataNumNsaNotReady, TimModeCaps=TimModeCaps, neSwUpgradeFileName=neSwUpgradeFileName, NeSwUpgradeStatusType=NeSwUpgradeStatusType, fwDataStandbyFirmwareAvailable=fwDataStandbyFirmwareAvailable, neAutoBackupServerPasswd=neAutoBackupServerPasswd, fwDataFirmwarePackageRevBackup=fwDataFirmwarePackageRevBackup, swDbDataNumNativeSaUpdate=swDbDataNumNativeSaUpdate, neSwUpgradeType=neSwUpgradeType, controlPlaneEthEntityEntry=controlPlaneEthEntityEntry, neF7AutomaticRemoteBackupSrvIp=neF7AutomaticRemoteBackupSrvIp, FileType=FileType, neF7AutomaticRemoteBackupSrvLogin=neF7AutomaticRemoteBackupSrvLogin, neTrapsinkTable=neTrapsinkTable, fwDataForm=fwDataForm, otn=otn, SonetTraceForm=SonetTraceForm, oduSectionConfigTraceTransmitDapi=oduSectionConfigTraceTransmitDapi, snmpProxyEntrySingleTargetOutAddress=snmpProxyEntrySingleTargetOutAddress, swDbDataCapRestoreConfig=swDbDataCapRestoreConfig, TimMode=TimMode, EntityClass=EntityClass, controlPlaneWdmContainsTable=controlPlaneWdmContainsTable, fsp3000=fsp3000, Counter64String=Counter64String, snmpProxyEntrySingleTargetOutUserName=snmpProxyEntrySingleTargetOutUserName, OtnPayloadTypeCaps=OtnPayloadTypeCaps, swDbDataNumSaNotReady=swDbDataNumSaNotReady, ncuActivationDateUtc=ncuActivationDateUtc, neF7AutomaticBackupIndex=neF7AutomaticBackupIndex, oduSectionConfigSignalDegradePeriod=oduSectionConfigSignalDegradePeriod, oduTcmADataTraceReceivedSapi=oduTcmADataTraceReceivedSapi, otuSectionConfigEntry=otuSectionConfigEntry, encryptionFwpFile=encryptionFwpFile, neTrapsinkEntry=neTrapsinkEntry, fsp1500=fsp1500, sonetSectionConfigSignalDegradeThreshhold=sonetSectionConfigSignalDegradeThreshhold, swDbDataCapTable=swDbDataCapTable, oduTcmBConfigTraceTransmitSapi=oduTcmBConfigTraceTransmitSapi, swDbFileCreationTime=swDbFileCreationTime, KBytes=KBytes, EquipmentState=EquipmentState, neTrapsinkVersion=neTrapsinkVersion, otuSectionConfigTraceTransmitDapi=otuSectionConfigTraceTransmitDapi, OhTerminationLevel=OhTerminationLevel, neEventLogVarUnsigned32Val=neEventLogVarUnsigned32Val, controlPlaneOtnEntityTable=controlPlaneOtnEntityTable, updateBackupRestoreMib=updateBackupRestoreMib, ApsDirectionCaps=ApsDirectionCaps, neStorageDescr=neStorageDescr, neEventLogIdentityTranslation=neEventLogIdentityTranslation, NoYesNA=NoYesNA, neF7AutomaticBackupRunState=neF7AutomaticBackupRunState, vtpEntityEntry=vtpEntityEntry, neSwUpgradeServerPasswd=neSwUpgradeServerPasswd, fsp1000adm=fsp1000adm, oduTcmBDataTraceReceivedDapi=oduTcmBDataTraceReceivedDapi)
mibBuilder.exportSymbols("ADVA-MIB", oduTcmBConfigTraceTransmitOpsp=oduTcmBConfigTraceTransmitOpsp, sonetSectionConfigTraceForm=sonetSectionConfigTraceForm, F7AutoBackupInterval=F7AutoBackupInterval, controlPlaneOtnEntityAssignmentState=controlPlaneOtnEntityAssignmentState, PgmType=PgmType, eqpFwEqpType=eqpFwEqpType, controlPlaneWdmEntityIndex=controlPlaneWdmEntityIndex, fspNm=fspNm, ptpEntityEquipmentState=ptpEntityEquipmentState, oduTcmBConfigSignalDegradeThreshold=oduTcmBConfigSignalDegradeThreshold, sonetSectionConfigEntry=sonetSectionConfigEntry, ncuActivationTime=ncuActivationTime, otuSectionDataResultingTotalBitrate=otuSectionDataResultingTotalBitrate, oduTcmAConfigTraceTransmitOpsp=oduTcmAConfigTraceTransmitOpsp, neF7AutomaticBackupInterval=neF7AutomaticBackupInterval, RestoreActivation=RestoreActivation, EthDuplexModeCaps=EthDuplexModeCaps, Grade=Grade, neEventLogVarIpAddressVal=neEventLogVarIpAddressVal, neF7AutomaticRemoteBackupPassword=neF7AutomaticRemoteBackupPassword, oduTcmCDataEntry=oduTcmCDataEntry, dbAdmin=dbAdmin, controlPlaneOtnEntityClass=controlPlaneOtnEntityClass, OtnTcmLevelCaps=OtnTcmLevelCaps, provContainerTable=provContainerTable, oduTcmBConfigTcmLevel=oduTcmBConfigTcmLevel, entityEntry=entityEntry, controlPlaneWdmEntityTable=controlPlaneWdmEntityTable, neF7AutomaticRemoteBackupSrcIp=neF7AutomaticRemoteBackupSrcIp, oduTcmCDataTraceReceivedDapi=oduTcmCDataTraceReceivedDapi, neAutoBackupServerAddress=neAutoBackupServerAddress, oduSectionDataTraceReceivedOpsp=oduSectionDataTraceReceivedOpsp, vtpEntityAssignmentState=vtpEntityAssignmentState, neBackupRestore=neBackupRestore, oduTcmCConfigTraceExpected=oduTcmCConfigTraceExpected, controlPlaneWdmEntityEntry=controlPlaneWdmEntityEntry, neMibVariant=neMibVariant, neF7AutomaticRemoteBackupSrvDir=neF7AutomaticRemoteBackupSrvDir, oduSectionConfigTraceExpected=oduSectionConfigTraceExpected, vtpEntityIndexAid=vtpEntityIndexAid, inventoryType=inventoryType, oduTcmCDataTable=oduTcmCDataTable, sonetSectionConfigSignalDegradePeriod=sonetSectionConfigSignalDegradePeriod, neEventLogTimeStamp=neEventLogTimeStamp, otuSectionDataTraceReceivedDapi=otuSectionDataTraceReceivedDapi, FileTransferProtocol=FileTransferProtocol, otuSectionConfigTimMode=otuSectionConfigTimMode, otuSectionDataTable=otuSectionDataTable, neSwUpgradeNeDirectory=neSwUpgradeNeDirectory, OtnTcmLevel=OtnTcmLevel, oduTcmCDataTraceReceivedOpsp=oduTcmCDataTraceReceivedOpsp, oduSectionConfigEntry=oduSectionConfigEntry, fsp150cm=fsp150cm, neAutoBackup=neAutoBackup, entityType=entityType, StandbyServiceAffecting=StandbyServiceAffecting, inventoryVendorId=inventoryVendorId, neMemorySizeTotal=neMemorySizeTotal, neInfo=neInfo, oduTcmBDataTraceReceivedSapi=oduTcmBDataTraceReceivedSapi, AssignmentState=AssignmentState, neF7AutomaticRemoteBackupTimeStamp=neF7AutomaticRemoteBackupTimeStamp, neSwUpgradeTransferProtocol=neSwUpgradeTransferProtocol, sonetSectionConfigTable=sonetSectionConfigTable, oduTcmBDataTable=oduTcmBDataTable, neAutoBackupServerDirectory=neAutoBackupServerDirectory, oduTcmAConfigSignalDegradePeriod=oduTcmAConfigSignalDegradePeriod, inventoryCfSerialNum=inventoryCfSerialNum, eqpFwNextEqpForUpdate=eqpFwNextEqpForUpdate, controlPlaneWdmEntityAssignmentState=controlPlaneWdmEntityAssignmentState, oduTcmCDataTraceReceivedSapi=oduTcmCDataTraceReceivedSapi, fwDataReadyForActivation=fwDataReadyForActivation, transportStandards=transportStandards, swVersionInactiveOperatingSw=swVersionInactiveOperatingSw, neStorageCapacity=neStorageCapacity, vtpEntityClass=vtpEntityClass, controlPlaneOtnContainsIndex=controlPlaneOtnContainsIndex, ncuScheduledActivation=ncuScheduledActivation, oduTcmAConfigEntry=oduTcmAConfigEntry, neBackupRestoreFile=neBackupRestoreFile, sonetSectionConfigTraceExpected=sonetSectionConfigTraceExpected, otuSectionConfigStuffing=otuSectionConfigStuffing, VirtualContainerTypeCaps=VirtualContainerTypeCaps, controlPlaneWdmContainsEntry=controlPlaneWdmContainsEntry, config=config, swVersionEntry=swVersionEntry, NcuAutoActivation=NcuAutoActivation, controlPlaneOtnContainsEntry=controlPlaneOtnContainsEntry, PYSNMP_MODULE_ID=advaMIB, SonetTimingSource=SonetTimingSource, fwDataFirmwarePackageRev=fwDataFirmwarePackageRev, fsp2000=fsp2000, oduTcmADataTraceReceivedOpsp=oduTcmADataTraceReceivedOpsp, snmpServerPort=snmpServerPort, events=events, FspR7AdminStateSnmpProxy=FspR7AdminStateSnmpProxy, neSwUpgradeServerDirectory=neSwUpgradeServerDirectory, ptpEntityIndexAid=ptpEntityIndexAid, fwDataNewVersion=fwDataNewVersion, snmpProxyEntrySingleTargetOutContext=snmpProxyEntrySingleTargetOutContext, swDbDataActivationTime=swDbDataActivationTime, containsEntry=containsEntry, oduSectionConfigTraceTransmitOpsp=oduSectionConfigTraceTransmitOpsp, vtpEntityContainedIn=vtpEntityContainedIn, swAdmin=swAdmin, oduTcmCConfigTraceTransmitDapi=oduTcmCConfigTraceTransmitDapi, inventoryMacAddress=inventoryMacAddress, snmpProxyServerAdminState=snmpProxyServerAdminState, neInitialConnectionMode=neInitialConnectionMode, ProtectionMech=ProtectionMech, swVersionInactiveApplSw=swVersionInactiveApplSw, oduTcmAConfigTraceExpected=oduTcmAConfigTraceExpected, controlPlaneEthEntityIndex=controlPlaneEthEntityIndex, snmpProxyServerPort=snmpProxyServerPort, neTrapsinkUserName=neTrapsinkUserName, eqpFwServiceImpairment=eqpFwServiceImpairment, snmpAgent=snmpAgent, neF7AutomaticBackupEntry=neF7AutomaticBackupEntry, controlPlaneWdmEntityIndexAid=controlPlaneWdmEntityIndexAid, swDbFileEntry=swDbFileEntry, swDbDataStandbyPartitionStatus=swDbDataStandbyPartitionStatus, eqpFwUpgradeRequest=eqpFwUpgradeRequest, FspR7UsersDb=FspR7UsersDb, oduSectionDataEntry=oduSectionDataEntry, FspDate=FspDate, products=products, ncuActivationTimeUtc=ncuActivationTimeUtc, F7AutoBackupRunState=F7AutoBackupRunState, neBackupUsers=neBackupUsers, fwDataServiceImpairment=fwDataServiceImpairment, aosCommon=aosCommon, controlPlaneOtnEntityIndexAid=controlPlaneOtnEntityIndexAid, swDbDataDefaultsEntry=swDbDataDefaultsEntry, FspR7Date=FspR7Date, ApsHoldoffTimeCaps=ApsHoldoffTimeCaps, software=software, oduTcmAConfigTimMode=oduTcmAConfigTimMode, neRestoreFileBackupDate=neRestoreFileBackupDate, neManufacturer=neManufacturer, controlPlaneOtnEntityEntry=controlPlaneOtnEntityEntry, EntityType=EntityType, neSwUpgradeServerAddress=neSwUpgradeServerAddress, neSwUpgradeCommonIpSrv=neSwUpgradeCommonIpSrv, snmpProxyEntrySingleTargetOutRowStatus=snmpProxyEntrySingleTargetOutRowStatus, oduTcmADataTraceReceivedDapi=oduTcmADataTraceReceivedDapi, oduTcmBConfigTable=oduTcmBConfigTable, neTrapsinkAddress=neTrapsinkAddress, neTrapsinkPort=neTrapsinkPort, swVersionTable=swVersionTable, ncuActivationDate=ncuActivationDate, TrapCounter=TrapCounter, swDbFileVersion=swDbFileVersion, entityIndexAid=entityIndexAid, IdentityTranslation=IdentityTranslation, snmpProxyEntrySingleTargetOutTable=snmpProxyEntrySingleTargetOutTable, YesNoNA=YesNoNA, ProtectionMechCaps=ProtectionMechCaps, fwDataEntry=fwDataEntry, inventoryEntry=inventoryEntry, inventoryCfModel=inventoryCfModel, snmpProxyServerSynchroStage=snmpProxyServerSynchroStage, inventoryUnitName=inventoryUnitName, controlPlaneEthEntityContainedIn=controlPlaneEthEntityContainedIn, neBackupEncryption=neBackupEncryption, FspR7EquipmentTypeCaps=FspR7EquipmentTypeCaps, oduTcmCConfigTcmLevel=oduTcmCConfigTcmLevel, neEventLogVarInteger32Val=neEventLogVarInteger32Val, neStorageEntry=neStorageEntry, oduTcmCConfigSignalDegradePeriod=oduTcmCConfigSignalDegradePeriod, fsp150=fsp150, entityTable=entityTable, CpWdmEntityClass=CpWdmEntityClass, neSwUpgradeState=neSwUpgradeState, snmpProxyEntrySingleTargetOutNodeAgentStatus=snmpProxyEntrySingleTargetOutNodeAgentStatus, oduSectionConfigTable=oduSectionConfigTable, oduTcmADataTable=oduTcmADataTable, swDbDataCapUpgradeRequest=swDbDataCapUpgradeRequest, sonetSectionConfigTraceTransmit=sonetSectionConfigTraceTransmit, oduTcmCConfigTimMode=oduTcmCConfigTimMode, swDbDataDefaultsRestoreConfig=swDbDataDefaultsRestoreConfig, fsp3000c=fsp3000c, neSwUpgradeServerLogin=neSwUpgradeServerLogin, entityClassInstanceNumber=entityClassInstanceNumber, neF7AutomaticRemoteBackupCommonIpSrv=neF7AutomaticRemoteBackupCommonIpSrv, FspR7Time=FspR7Time, neStorageAvailable=neStorageAvailable, swDbDataFirmwareSetVersion=swDbDataFirmwareSetVersion, SonetSectSigDegThres=SonetSectSigDegThres, neF7AutomaticBackupNextDate=neF7AutomaticBackupNextDate, LoopConfigCaps=LoopConfigCaps, inventoryFirmwarePackageRev=inventoryFirmwarePackageRev, swDbFileType=swDbFileType, eqpFwEqpServerBusy=eqpFwEqpServerBusy, swDbDataEntry=swDbDataEntry, oduTcmCConfigTraceTransmitSapi=oduTcmCConfigTraceTransmitSapi, neF7AutomaticBackupStartDate=neF7AutomaticBackupStartDate, oduTcmBConfigTraceTransmitDapi=oduTcmBConfigTraceTransmitDapi, controlPlaneOtnEntityContainedIn=controlPlaneOtnEntityContainedIn, swDbDataDatabaseVersion=swDbDataDatabaseVersion, controlPlaneEthContainsEntry=controlPlaneEthContainsEntry, LogicalIfTransport=LogicalIfTransport, neSwDownloadProgress=neSwDownloadProgress, fwDataFirmwareApproved=fwDataFirmwareApproved, neStorageIndex=neStorageIndex, common=common, DestinationNodeOrAgentState=DestinationNodeOrAgentState, coldRestartCapTable=coldRestartCapTable, swDbDataNumNativeNsaUpdate=swDbDataNumNativeNsaUpdate, otuConfig=otuConfig, neEventLogIndex=neEventLogIndex, installedEqpt=installedEqpt, swDbDataProgramVersion=swDbDataProgramVersion, aos=aos, otuSectionConfigSignalDegradePeriod=otuSectionConfigSignalDegradePeriod, neEventLogVarType=neEventLogVarType, swDbDataArea=swDbDataArea, oduTcmCConfigEntry=oduTcmCConfigEntry, inventoryHardwareRev=inventoryHardwareRev, snmpProxyEntrySingleTargetOutAdminState=snmpProxyEntrySingleTargetOutAdminState, controlPlaneWdmContainsIndex=controlPlaneWdmContainsIndex, inventoryGradeInventory=inventoryGradeInventory, swDbFileRowStatus=swDbFileRowStatus, BootState=BootState, OnOff=OnOff, sourceIpAddress=sourceIpAddress, ptpEntityTable=ptpEntityTable, ServiceAffectingCaps=ServiceAffectingCaps, FspR7EnableDisable=FspR7EnableDisable, vtpEntityClassInstanceNumber=vtpEntityClassInstanceNumber, oduTcmADataEntry=oduTcmADataEntry, EnableState=EnableState, neAutoBackupInterval=neAutoBackupInterval, neBackupRestoreState=neBackupRestoreState, FspR7AdminStateSnmpProxyCaps=FspR7AdminStateSnmpProxyCaps, entityContainedIn=entityContainedIn, oduTcmCConfigTable=oduTcmCConfigTable)
