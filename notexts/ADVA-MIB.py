...
TimeStamp, MacAddress, RowStatus, TextualConvention, DisplayString, TestAndIncr, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "MacAddress", "RowStatus", "TextualConvention", "DisplayString", "TestAndIncr", "DateAndTime")
...
mibBuilder.exportSymbols("ADVA-MIB", OtnTcmLevel=OtnTcmLevel, FspDate=FspDate, aosCommon=aosCommon, swVersionEntry=swVersionEntry, controlPlaneEthContainsTable=controlPlaneEthContainsTable, SonetTimingSource=SonetTimingSource, neEventLogTable=neEventLogTable, swDbDataNumLegacyUpdate=swDbDataNumLegacyUpdate, FileArea=FileArea, neAutoBackupServerLogin=neAutoBackupServerLogin, snmpProxyServerAdminState=snmpProxyServerAdminState, neF7AutomaticBackupTable=neF7AutomaticBackupTable, otuSectionDataEntry=otuSectionDataEntry, swDbFileEntry=swDbFileEntry, LoopConfigCaps=LoopConfigCaps, oduTcmAConfigTraceTransmitSapi=oduTcmAConfigTraceTransmitSapi, oduTcmBDataTraceReceivedOpsp=oduTcmBDataTraceReceivedOpsp, neSwUpgradeServerLogin=neSwUpgradeServerLogin, controlPlaneWdmEntityClass=controlPlaneWdmEntityClass, fsp1000=fsp1000, LogicalIfTransport=LogicalIfTransport, swDbDataNcuSoftwareVersion=swDbDataNcuSoftwareVersion, neSwUpgradeServerPasswd=neSwUpgradeServerPasswd, vtpEntityType=vtpEntityType, FspR7Date=FspR7Date, swDbFileArea=swDbFileArea, neEventLogVarIpAddressVal=neEventLogVarIpAddressVal, neAutoBackup=neAutoBackup, oduSectionDataTraceReceivedOpsp=oduSectionDataTraceReceivedOpsp, neTrapsinkEntry=neTrapsinkEntry, oduSectionConfigSignalDegradePeriod=oduSectionConfigSignalDegradePeriod, oduTcmAConfigTraceExpected=oduTcmAConfigTraceExpected, oduTcmBDataTraceReceivedDapi=oduTcmBDataTraceReceivedDapi, inventoryGradeInventory=inventoryGradeInventory, aosProducts=aosProducts, neF7AutomaticRemoteBackupSrcIp=neF7AutomaticRemoteBackupSrcIp, swDbFileRowStatus=swDbFileRowStatus, sonetSectionConfigSignalDegradePeriod=sonetSectionConfigSignalDegradePeriod, fsp150=fsp150, eqpFwUpgradeRequest=eqpFwUpgradeRequest, TimModeCaps=TimModeCaps, sonetSectionDataEntry=sonetSectionDataEntry, sonetSectionDataTraceReceived=sonetSectionDataTraceReceived, snmpWriteAccessNmsAddress=snmpWriteAccessNmsAddress, sonetSectionDataTable=sonetSectionDataTable, fwDataActivationReadyOnStandby=fwDataActivationReadyOnStandby, neEventLogVarOctetStringVal=neEventLogVarOctetStringVal, neF7AutomaticRemoteBackupCommonIpSrv=neF7AutomaticRemoteBackupCommonIpSrv, controlPlaneWdmEntityTable=controlPlaneWdmEntityTable, neBackupUsers=neBackupUsers, ServiceImpairment=ServiceImpairment, swDbDataCapEntry=swDbDataCapEntry, neSwInstallState=neSwInstallState, inventoryType=inventoryType, oduTcmCDataTable=oduTcmCDataTable, neAlarmStatus=neAlarmStatus, swDbFileSize=swDbFileSize, TrapAlarmSeverity=TrapAlarmSeverity, EntityClass=EntityClass, CpWdmEntityClass=CpWdmEntityClass, inventoryEntry=inventoryEntry, snmpWriteAccessEntry=snmpWriteAccessEntry, swVersionActiveApplSw=swVersionActiveApplSw, neF7AutomaticRemoteBackupSrvDir=neF7AutomaticRemoteBackupSrvDir, Grade=Grade, oduSectionConfigTraceTransmitDapi=oduSectionConfigTraceTransmitDapi, TrapCounter=TrapCounter, ncuActivationDate=ncuActivationDate, OtnPayloadTypeCaps=OtnPayloadTypeCaps, PYSNMP_MODULE_ID=advaMIB, IdentityTranslation=IdentityTranslation, swVersionNextBoot=swVersionNextBoot, EthDuplexMode=EthDuplexMode, controlPlaneWdmEntityAssignmentState=controlPlaneWdmEntityAssignmentState, otuConfig=otuConfig, swDbDataNumNsaNotReady=swDbDataNumNsaNotReady, neBackupRestoreFile=neBackupRestoreFile, snmpWriteAccessRestriction=snmpWriteAccessRestriction, PartitionStatus=PartitionStatus, SourceIpAddress=SourceIpAddress, fwDataServiceImpairment=fwDataServiceImpairment, otuSectionConfigEntry=otuSectionConfigEntry, EnableState=EnableState, RestoreActivationCaps=RestoreActivationCaps, neBackupRestoreState=neBackupRestoreState, oduTcmBDataTable=oduTcmBDataTable, otuSectionConfigSignalDegradeThreshold=otuSectionConfigSignalDegradeThreshold, swDbFileGrade=swDbFileGrade, sonet=sonet, oduTcmAConfigTraceTransmitOpsp=oduTcmAConfigTraceTransmitOpsp, FspR7TrapsinkLifetime=FspR7TrapsinkLifetime, neAutoBackupConfig=neAutoBackupConfig, inventoryHardwareRev=inventoryHardwareRev, FileTransferProtocol=FileTransferProtocol, ApsHoldoffTime=ApsHoldoffTime, neEventLogVarOidVal=neEventLogVarOidVal, oduTcmADataTraceReceivedOpsp=oduTcmADataTraceReceivedOpsp, OtnTcmLevelCaps=OtnTcmLevelCaps, FspR7AdminStateSnmpProxy=FspR7AdminStateSnmpProxy, SonetTraceForm=SonetTraceForm, DestinationNodeOrAgentState=DestinationNodeOrAgentState, neEventLogNotificationOID=neEventLogNotificationOID, controlPlaneWdmContainsTable=controlPlaneWdmContainsTable, controlPlaneWdmContainsEntry=controlPlaneWdmContainsEntry, inventoryUniversalSerialIdent=inventoryUniversalSerialIdent, ApsDirection=ApsDirection, ptpEntityEntry=ptpEntityEntry, neStorageAvailable=neStorageAvailable, sonetSectionConfigTraceExpected=sonetSectionConfigTraceExpected, ncuActivationDateUtc=ncuActivationDateUtc, fspNm=fspNm, neSwUpgradeServerDirectory=neSwUpgradeServerDirectory, otuSectionDataTable=otuSectionDataTable, neRestoreFileBackupDate=neRestoreFileBackupDate, oduTcmCConfigTcmLevel=oduTcmCConfigTcmLevel, inventoryFpgaRev=inventoryFpgaRev, neStorageIndex=neStorageIndex, ncuScheduledActivation=ncuScheduledActivation, fsp150cm=fsp150cm, neEventLogIdentityTranslation=neEventLogIdentityTranslation, common=common, VirtualContainerType=VirtualContainerType, oduSectionDataTraceReceivedDapi=oduSectionDataTraceReceivedDapi, oduTcmAConfigTraceTransmitDapi=oduTcmAConfigTraceTransmitDapi, FspR7EquipmentType=FspR7EquipmentType, fsp1000adm=fsp1000adm, neF7AutomaticRemoteBackupUsers=neF7AutomaticRemoteBackupUsers, vtpEntityContainedIn=vtpEntityContainedIn, otuSectionConfigTimMode=otuSectionConfigTimMode, SonetTimingSourceCaps=SonetTimingSourceCaps, controlPlaneEthEntityAssignmentState=controlPlaneEthEntityAssignmentState, fwDataStandbyFirmwareAvailable=fwDataStandbyFirmwareAvailable, controlPlaneEthContainsIndex=controlPlaneEthContainsIndex, F7AutoBackupInterval=F7AutoBackupInterval, swDbDataCapUpgradeRequest=swDbDataCapUpgradeRequest, neAutoBackupServerPasswd=neAutoBackupServerPasswd, neF7AutomaticRemoteBackupPassword=neF7AutomaticRemoteBackupPassword, neSwUpgradeType=neSwUpgradeType, FspR7EquipmentTypeCaps=FspR7EquipmentTypeCaps, F7FileTimeStamp=F7FileTimeStamp, sonetSectionConfigTraceForm=sonetSectionConfigTraceForm, neTrapsinkType=neTrapsinkType, sonetSectionConfigEntry=sonetSectionConfigEntry, containsEntry=containsEntry, fspR7=fspR7, neF7AutomaticBackupTimeStamp=neF7AutomaticBackupTimeStamp, entityIndexAid=entityIndexAid, controlPlaneWdmEntityContainedIn=controlPlaneWdmEntityContainedIn, swDbDataNumNativeSaUpdate=swDbDataNumNativeSaUpdate, neF7AutomaticRemoteBackupTimeStamp=neF7AutomaticRemoteBackupTimeStamp, fwDataReadyForActivation=fwDataReadyForActivation, swDbDataRestoreConfig=swDbDataRestoreConfig, fwDataFirmwarePackageRev=fwDataFirmwarePackageRev, inventoryFirmwarePackageRev=inventoryFirmwarePackageRev, neEventLogVarIndex=neEventLogVarIndex, neTrapsinkTable=neTrapsinkTable, ptpEntityContainedIn=ptpEntityContainedIn, EthDuplexModeCaps=EthDuplexModeCaps, neF7AutomaticBackupEntry=neF7AutomaticBackupEntry, controlPlaneWdmEntityEntry=controlPlaneWdmEntityEntry, inventorySoftwareRev=inventorySoftwareRev, NeSwUpgradeStatusType=NeSwUpgradeStatusType, ptpEntityType=ptpEntityType, fsp1500=fsp1500, swDbDataNumSaNotReady=swDbDataNumSaNotReady, neTrapsinkRowStatus=neTrapsinkRowStatus, neF7AutomaticBackupStartTime=neF7AutomaticBackupStartTime, eqpFwEqpType=eqpFwEqpType, NeSwInstallStatusType=NeSwInstallStatusType, oduTcmAConfigEntry=oduTcmAConfigEntry, oduSectionConfigTraceTransmitOpsp=oduSectionConfigTraceTransmitOpsp, oduSectionDataTable=oduSectionDataTable, oduTcmADataTraceReceivedSapi=oduTcmADataTraceReceivedSapi, swDbDataProgramVersion=swDbDataProgramVersion, neSwUpgradeRequest=neSwUpgradeRequest, swDbFileFileName=swDbFileFileName, software=software, oduTcmCDataTraceReceivedSapi=oduTcmCDataTraceReceivedSapi, ptpEntityAssignmentState=ptpEntityAssignmentState, AvailState=AvailState, controlPlaneEthEntityClassInstanceNumber=controlPlaneEthEntityClassInstanceNumber, oduTcmAConfigTable=oduTcmAConfigTable, fwDataProtectionPart=fwDataProtectionPart, neStorageTable=neStorageTable, neEventLogVarId=neEventLogVarId, entityEquipmentState=entityEquipmentState, LogicalIfTransportCaps=LogicalIfTransportCaps, oduTcmADataEntry=oduTcmADataEntry, EntityIndex=EntityIndex, snmpProxyEntrySingleTargetOutUserName=snmpProxyEntrySingleTargetOutUserName, oduTcmBConfigTraceTransmitDapi=oduTcmBConfigTraceTransmitDapi, YesNoNA=YesNoNA, swVersionInactiveApplSw=swVersionInactiveApplSw, sourceIpAddress=sourceIpAddress, fwDataNewVersion=fwDataNewVersion, controlPlaneOtnContainsIndex=controlPlaneOtnContainsIndex, swAdmin=swAdmin, neMemorySizeFree=neMemorySizeFree, swDbFileCreationTime=swDbFileCreationTime, SonetVcBundleAllocation=SonetVcBundleAllocation, oduTcmCConfigTraceExpected=oduTcmCConfigTraceExpected, neEventLogVarEntry=neEventLogVarEntry, oduTcmBConfigTcmLevel=oduTcmBConfigTcmLevel, oduSectionConfigTimMode=oduSectionConfigTimMode, swDbFileVersion=swDbFileVersion, neF7AutomaticBackupRunState=neF7AutomaticBackupRunState, snmpProxyEntrySingleTargetOutAddress=snmpProxyEntrySingleTargetOutAddress, oduTcmBDataEntry=oduTcmBDataEntry, oduSectionConfigSignalDegradeThres=oduSectionConfigSignalDegradeThres, vtpEntityIndex=vtpEntityIndex, controlPlaneOtnContainsEntry=controlPlaneOtnContainsEntry, admin=admin, swDbFileType=swDbFileType, neRestoreConfig=neRestoreConfig, snmpProxyEntrySingleTargetOutAdminState=snmpProxyEntrySingleTargetOutAdminState, oduTcmAConfigTimMode=oduTcmAConfigTimMode, swDbDataNumLegacyEqpt=swDbDataNumLegacyEqpt, EquipmentState=EquipmentState, fwDataFirmwarePackageRevBackup=fwDataFirmwarePackageRevBackup, controlPlaneWdmContainsIndex=controlPlaneWdmContainsIndex, swDbDataDefaultsEntry=swDbDataDefaultsEntry, controlPlaneOtnEntityTable=controlPlaneOtnEntityTable, neSwUpgradeTransferProtocol=neSwUpgradeTransferProtocol, oduTcmCDataTraceReceivedDapi=oduTcmCDataTraceReceivedDapi, FspR7FalseTrue=FspR7FalseTrue, VirtualContainerTypeCaps=VirtualContainerTypeCaps, TimMode=TimMode, sonetSectionConfigSignalDegradeThreshhold=sonetSectionConfigSignalDegradeThreshhold, neAutoBackupNextActionAt=neAutoBackupNextActionAt, oduTcmCConfigTimMode=oduTcmCConfigTimMode, swDbDataCapRestoreConfig=swDbDataCapRestoreConfig, ncuActivationTime=ncuActivationTime, controlPlaneOtnEntityContainedIn=controlPlaneOtnEntityContainedIn, swDbDataEntry=swDbDataEntry, neF7AutomaticBackupStartDate=neF7AutomaticBackupStartDate, oduTcmBConfigEntry=oduTcmBConfigEntry, provAssignmentState=provAssignmentState, ptpEntityEquipmentState=ptpEntityEquipmentState, fwDataForm=fwDataForm, swDbDataNumEqpt=swDbDataNumEqpt, snmpProxyEntrySingleTargetOutContext=snmpProxyEntrySingleTargetOutContext, neEventLogVarCounter64Val=neEventLogVarCounter64Val, eqpFwNextEqpForUpdate=eqpFwNextEqpForUpdate, provContainerEntry=provContainerEntry, oduTcmCConfigEntry=oduTcmCConfigEntry, sonetSectionConfigTraceTransmit=sonetSectionConfigTraceTransmit, encryptionFwpFile=encryptionFwpFile, neInfo=neInfo, ArcState=ArcState, ServiceAffectingCaps=ServiceAffectingCaps, swDbDataTable=swDbDataTable, inventorySerialNum=inventorySerialNum, neF7AutomaticBackupInterval=neF7AutomaticBackupInterval, otuSectionConfigPayload=otuSectionConfigPayload)
mibBuilder.exportSymbols("ADVA-MIB", ApsHoldoffTimeCaps=ApsHoldoffTimeCaps, eqpFwNcuServerBusy=eqpFwNcuServerBusy, entityAssignmentState=entityAssignmentState, ptpEntityIndexAid=ptpEntityIndexAid, neAutoBackupServerDirectory=neAutoBackupServerDirectory, controlPlaneEthContainsEntry=controlPlaneEthContainsEntry, oduTcmBConfigTable=oduTcmBConfigTable, swDbFileIndex=swDbFileIndex, otuSectionDataTraceReceivedDapi=otuSectionDataTraceReceivedDapi, updateEqpt=updateEqpt, vtpEntityAssignmentState=vtpEntityAssignmentState, ncuActivationTimeUtc=ncuActivationTimeUtc, controlPlaneEthEntityClass=controlPlaneEthEntityClass, AssignmentState=AssignmentState, swDbDataDefaultsTable=swDbDataDefaultsTable, snmpProxyServerSynchroStage=snmpProxyServerSynchroStage, sonetSectionConfigTable=sonetSectionConfigTable, snmpProxyServerPort=snmpProxyServerPort, containsIndex=containsIndex, transportStandards=transportStandards, ptpEntityClassInstanceNumber=ptpEntityClassInstanceNumber, OnOff=OnOff, oduTcmAConfigSignalDegradePeriod=oduTcmAConfigSignalDegradePeriod, vtpEntityEntry=vtpEntityEntry, snmpProxyServerSynchroState=snmpProxyServerSynchroState, controlPlaneOtnEntityIndexAid=controlPlaneOtnEntityIndexAid, RestoreActivation=RestoreActivation, ptpEntityReferencedTo=ptpEntityReferencedTo, snmpProxyEntrySingleTargetOutTable=snmpProxyEntrySingleTargetOutTable, otn=otn, swDbDataNumNativeNsaUpdate=swDbDataNumNativeNsaUpdate, oduTcmBConfigTraceTransmitOpsp=oduTcmBConfigTraceTransmitOpsp, neAutoBackupInterval=neAutoBackupInterval, neTrapsinkVersion=neTrapsinkVersion, fsp3000=fsp3000, neTrapsinkCommunity=neTrapsinkCommunity, controlPlaneWdmEntityClassInstanceNumber=controlPlaneWdmEntityClassInstanceNumber, neEventLogTimeStamp=neEventLogTimeStamp, oduConfig=oduConfig, controlPlaneEthEntityContainedIn=controlPlaneEthEntityContainedIn, dbAdmin=dbAdmin, swDbDataStandbyPartitionStatus=swDbDataStandbyPartitionStatus, FileType=FileType, fwDataEntry=fwDataEntry, inventoryUnitName=inventoryUnitName, entityClassInstanceNumber=entityClassInstanceNumber, controlPlaneOtnEntityClass=controlPlaneOtnEntityClass, coldRestartCapTable=coldRestartCapTable, FspR7YesNo=FspR7YesNo, oduSectionDataTraceReceivedSapi=oduSectionDataTraceReceivedSapi, fwDataFirmwareApproved=fwDataFirmwareApproved, snmpProxyEntrySingleTargetOutPort=snmpProxyEntrySingleTargetOutPort, inventoryCfModel=inventoryCfModel, neEventLogVarType=neEventLogVarType, neSwUpgradeCommonIpSrv=neSwUpgradeCommonIpSrv, controlPlaneOtnEntityClassInstanceNumber=controlPlaneOtnEntityClassInstanceNumber, neF7AutomaticBackupIndex=neF7AutomaticBackupIndex, controlPlaneEthEntityEntry=controlPlaneEthEntityEntry, OhTerminationLevel=OhTerminationLevel, SonetSectSigDegThres=SonetSectSigDegThres, inventoryVendorId=inventoryVendorId, EnableStateCaps=EnableStateCaps, vtpEntityEquipmentState=vtpEntityEquipmentState, neMemorySizeTotal=neMemorySizeTotal, swDbFileComment=swDbFileComment, neF7AutomaticRemoteBackupSrvLogin=neF7AutomaticRemoteBackupSrvLogin, fwDataFirmwareAvailable=fwDataFirmwareAvailable, ProtectionMech=ProtectionMech, neStorageEntry=neStorageEntry, entityClass=entityClass, neAutoBackupServerAddress=neAutoBackupServerAddress, selectedFile=selectedFile, neInitialConnectionMode=neInitialConnectionMode, swDbDataFirmwareSetVersion=swDbDataFirmwareSetVersion, fsp2000=fsp2000, otuSectionConfigTable=otuSectionConfigTable, otuSectionConfigStuffing=otuSectionConfigStuffing, otuSectionDataTraceReceivedSapi=otuSectionDataTraceReceivedSapi, oduSectionConfigEntry=oduSectionConfigEntry, ptpEntityClass=ptpEntityClass, FspR7EnableDisable=FspR7EnableDisable, inventoryCfSerialNum=inventoryCfSerialNum, controlPlaneOtnEntityEntry=controlPlaneOtnEntityEntry, neEventLogIndex=neEventLogIndex, oduTcmCConfigSignalDegradeThreshold=oduTcmCConfigSignalDegradeThreshold, oduTcmBConfigSignalDegradeThreshold=oduTcmBConfigSignalDegradeThreshold, oduTcmCConfigTraceTransmitOpsp=oduTcmCConfigTraceTransmitOpsp, otuSectionDataTraceReceivedOpsp=otuSectionDataTraceReceivedOpsp, neDateAndTime=neDateAndTime, neSoftwareUpgrade=neSoftwareUpgrade, oduSectionConfigTraceExpected=oduSectionConfigTraceExpected, swDbDataDefaultsRestoreConfig=swDbDataDefaultsRestoreConfig, updateBackupRestoreMib=updateBackupRestoreMib, neSwUpgradeFileName=neSwUpgradeFileName, oduTcmADataTraceReceivedDapi=oduTcmADataTraceReceivedDapi, OhTerminationLevelCaps=OhTerminationLevelCaps, snmpAgent=snmpAgent, neF7AutomaticRemoteBackupEncryption=neF7AutomaticRemoteBackupEncryption, neSwUpgradeNeDirectory=neSwUpgradeNeDirectory, vtpEntityIndexAid=vtpEntityIndexAid, F7AutoBackupRunState=F7AutoBackupRunState, neEventLogEntry=neEventLogEntry, vtpEntityTable=vtpEntityTable, FspR7AdminStateSnmpProxyCaps=FspR7AdminStateSnmpProxyCaps, swDbDataDefaultsUpgradeRequest=swDbDataDefaultsUpgradeRequest, oduSectionConfigTraceTransmitSapi=oduSectionConfigTraceTransmitSapi, advaMIB=advaMIB, neTrapsinkUserName=neTrapsinkUserName, swVersionTable=swVersionTable, neTrapsinkPort=neTrapsinkPort, ProtectionMechCaps=ProtectionMechCaps, NoYesNA=NoYesNA, neBackupRestore=neBackupRestore, Counter64String=Counter64String, oduTcmCConfigSignalDegradePeriod=oduTcmCConfigSignalDegradePeriod, neStorageCapacity=neStorageCapacity, coldRestartCapEntry=coldRestartCapEntry, ModuleForm=ModuleForm, entityType=entityType, entityTable=entityTable, ncuScheduledDbRestore=ncuScheduledDbRestore, otuSectionConfigTraceTransmitSapi=otuSectionConfigTraceTransmitSapi, swVersionInactiveOperatingSw=swVersionInactiveOperatingSw, oduTcmCDataEntry=oduTcmCDataEntry, LoopConfig=LoopConfig, oduSectionConfigTable=oduSectionConfigTable, ServiceAffecting=ServiceAffecting, products=products, oduTcmBConfigTraceExpected=oduTcmBConfigTraceExpected, neSwUpgradeServerAddress=neSwUpgradeServerAddress, oduTcmADataTable=oduTcmADataTable, CommandEqpt=CommandEqpt, ptpEntityTable=ptpEntityTable, oduTcmAConfigSignalDegradeThreshold=oduTcmAConfigSignalDegradeThreshold, config=config, BootState=BootState, controlPlaneOtnEntityAssignmentState=controlPlaneOtnEntityAssignmentState, otuSectionConfigTraceTransmitDapi=otuSectionConfigTraceTransmitDapi, controlPlaneWdmEntityIndex=controlPlaneWdmEntityIndex, coldRestartCapServiceAffectingCap=coldRestartCapServiceAffectingCap, FspR7UsersDb=FspR7UsersDb, neF7AutomaticRemoteBackupSrvIp=neF7AutomaticRemoteBackupSrvIp, oduTcmCConfigTable=oduTcmCConfigTable, eqpFwEqpServerBusy=eqpFwEqpServerBusy, swDbDataIndex=swDbDataIndex, installedEqpt=installedEqpt, events=events, fwDataTable=fwDataTable, neTrapsinkAddress=neTrapsinkAddress, FspR7Time=FspR7Time, fwDataStandbyServiceImpairment=fwDataStandbyServiceImpairment, neF7AutomaticRemoteBackupProtocol=neF7AutomaticRemoteBackupProtocol, neEventLogVarUnsigned32Val=neEventLogVarUnsigned32Val, OtnPayloadType=OtnPayloadType, oduTcmCDataTraceReceivedOpsp=oduTcmCDataTraceReceivedOpsp, controlPlaneEthEntityIndexAid=controlPlaneEthEntityIndexAid, neMibVariant=neMibVariant, vtpEntityClassInstanceNumber=vtpEntityClassInstanceNumber, SonetTraceFormCaps=SonetTraceFormCaps, inventoryPartnumber=inventoryPartnumber, otuSectionConfigSignalDegradePeriod=otuSectionConfigSignalDegradePeriod, controlPlaneOtnContainsTable=controlPlaneOtnContainsTable, oduTcmBConfigTraceTransmitSapi=oduTcmBConfigTraceTransmitSapi, neBackupPassword=neBackupPassword, oduTcmBConfigSignalDegradePeriod=oduTcmBConfigSignalDegradePeriod, snmpProxyEntrySingleTargetOutNodeAgentStatus=snmpProxyEntrySingleTargetOutNodeAgentStatus, ApsDirectionCaps=ApsDirectionCaps, SnmpProxySynchronizationState=SnmpProxySynchronizationState, EntityType=EntityType, inventoryMib=inventoryMib, controlPlaneEthEntityTable=controlPlaneEthEntityTable, neF7AutomaticRemoteBackupSrvPass=neF7AutomaticRemoteBackupSrvPass, controlPlaneEthEntityIndex=controlPlaneEthEntityIndex, clearRdiskRequest=clearRdiskRequest, otuSectionConfigTraceTransmitOpsp=otuSectionConfigTraceTransmitOpsp, swDbDataCapTable=swDbDataCapTable, otuSectionConfigTraceExpected=otuSectionConfigTraceExpected, neSwUpgradeState=neSwUpgradeState, otuSectionDataResultingTotalBitrate=otuSectionDataResultingTotalBitrate, provEquipmentState=provEquipmentState, inventoryCleiCode=inventoryCleiCode, neF7AutomaticBackupNextDate=neF7AutomaticBackupNextDate, controlPlaneOtnEntityIndex=controlPlaneOtnEntityIndex, fsp3000c=fsp3000c, inventoryTable=inventoryTable, controlPlaneWdmEntityIndexAid=controlPlaneWdmEntityIndexAid, vtpEntityReferencedTo=vtpEntityReferencedTo, fwDataStandbyVersion=fwDataStandbyVersion, eqpFwServiceImpairment=eqpFwServiceImpairment, snmpWriteAccessNmsName=snmpWriteAccessNmsName, neManufacturer=neManufacturer, entityEntry=entityEntry, SonetVcBundleAllocationCaps=SonetVcBundleAllocationCaps, sonetSectionConfigTimingSource=sonetSectionConfigTimingSource, KBytes=KBytes, oduTcmCConfigTraceTransmitDapi=oduTcmCConfigTraceTransmitDapi, fsp3000alm=fsp3000alm, snmpServerPort=snmpServerPort, NcuAutoActivation=NcuAutoActivation, aos=aos, neBackupRestoreRequest=neBackupRestoreRequest, oduTcmBDataTraceReceivedSapi=oduTcmBDataTraceReceivedSapi, SnmpProxySynchronizationStage=SnmpProxySynchronizationStage, provContainerTable=provContainerTable, entityContainedIn=entityContainedIn, swDbDataActivationTime=swDbDataActivationTime, PgmType=PgmType, oduTcmAConfigTcmLevel=oduTcmAConfigTcmLevel, fwDataBootStatus=fwDataBootStatus, neEventsLogged=neEventsLogged, oduTcmCConfigTraceTransmitSapi=oduTcmCConfigTraceTransmitSapi, vtpEntityClass=vtpEntityClass, swDbFilePgmType=swDbFilePgmType, ptpEntityIndex=ptpEntityIndex, SonetSectSigDegThresCaps=SonetSectSigDegThresCaps, StandbyServiceAffecting=StandbyServiceAffecting, oduTcmBConfigTimMode=oduTcmBConfigTimMode, containsTable=containsTable, neSwDownloadProgress=neSwDownloadProgress, swDbDataArea=swDbDataArea, sonetConfig=sonetConfig, oduSectionDataEntry=oduSectionDataEntry, neEventLogVarInteger32Val=neEventLogVarInteger32Val, snmpProxyEntrySingleTargetOutEntry=snmpProxyEntrySingleTargetOutEntry, FspTime=FspTime, inventoryMacAddress=inventoryMacAddress, swDbDataDatabaseVersion=swDbDataDatabaseVersion, neBackupEncryption=neBackupEncryption, neStorageDescr=neStorageDescr, swVersionActiveOperatingSw=swVersionActiveOperatingSw, entityIndex=entityIndex, neEventLogVarTable=neEventLogVarTable, snmpProxyEntrySingleTargetOutRowStatus=snmpProxyEntrySingleTargetOutRowStatus, snmpWriteAccessTable=snmpWriteAccessTable, swDbFileTable=swDbFileTable, sonetSectionConfigTimMode=sonetSectionConfigTimMode)
