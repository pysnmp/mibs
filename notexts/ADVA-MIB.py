...
TextualConvention, RowStatus, DisplayString, TimeStamp, DateAndTime, TestAndIncr, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowStatus", "DisplayString", "TimeStamp", "DateAndTime", "TestAndIncr", "MacAddress")
...
mibBuilder.exportSymbols("ADVA-MIB", neEventsLogged=neEventsLogged, snmpProxyEntrySingleTargetOutPort=snmpProxyEntrySingleTargetOutPort, entityClass=entityClass, EthDuplexModeCaps=EthDuplexModeCaps, neBackupUsers=neBackupUsers, snmpProxyServerAdminState=snmpProxyServerAdminState, sourceIpAddress=sourceIpAddress, ptpEntityTable=ptpEntityTable, controlPlaneOtnEntityClass=controlPlaneOtnEntityClass, otuSectionDataEntry=otuSectionDataEntry, FileTransferProtocol=FileTransferProtocol, neF7AutomaticBackupNextDate=neF7AutomaticBackupNextDate, ptpEntityType=ptpEntityType, neAutoBackupConfig=neAutoBackupConfig, fwDataTable=fwDataTable, swDbDataDefaultsRestoreConfig=swDbDataDefaultsRestoreConfig, oduTcmAConfigTable=oduTcmAConfigTable, inventoryMib=inventoryMib, controlPlaneOtnEntityTable=controlPlaneOtnEntityTable, otn=otn, FspTime=FspTime, neF7AutomaticBackupStartDate=neF7AutomaticBackupStartDate, AvailState=AvailState, controlPlaneEthEntityAssignmentState=controlPlaneEthEntityAssignmentState, controlPlaneOtnEntityIndexAid=controlPlaneOtnEntityIndexAid, controlPlaneEthEntityIndex=controlPlaneEthEntityIndex, oduSectionConfigSignalDegradeThres=oduSectionConfigSignalDegradeThres, sonetSectionDataEntry=sonetSectionDataEntry, entityIndex=entityIndex, ncuScheduledActivation=ncuScheduledActivation, EntityClass=EntityClass, oduSectionConfigTraceTransmitOpsp=oduSectionConfigTraceTransmitOpsp, controlPlaneWdmContainsTable=controlPlaneWdmContainsTable, swDbDataEntry=swDbDataEntry, neBackupEncryption=neBackupEncryption, otuSectionConfigStuffing=otuSectionConfigStuffing, swDbFileRowStatus=swDbFileRowStatus, ServiceAffectingCaps=ServiceAffectingCaps, SonetVcBundleAllocation=SonetVcBundleAllocation, neInitialConnectionMode=neInitialConnectionMode, swVersionEntry=swVersionEntry, neAutoBackupServerPasswd=neAutoBackupServerPasswd, EthDuplexMode=EthDuplexMode, oduTcmBConfigTimMode=oduTcmBConfigTimMode, neAutoBackupServerLogin=neAutoBackupServerLogin, swDbDataDatabaseVersion=swDbDataDatabaseVersion, PartitionStatus=PartitionStatus, controlPlaneWdmEntityEntry=controlPlaneWdmEntityEntry, neF7AutomaticRemoteBackupTimeStamp=neF7AutomaticRemoteBackupTimeStamp, OnOff=OnOff, inventoryGradeInventory=inventoryGradeInventory, neManufacturer=neManufacturer, ncuActivationDateUtc=ncuActivationDateUtc, fspR7=fspR7, snmpProxyEntrySingleTargetOutContext=snmpProxyEntrySingleTargetOutContext, swDbDataFirmwareSetVersion=swDbDataFirmwareSetVersion, swDbDataCapRestoreConfig=swDbDataCapRestoreConfig, oduTcmCConfigTraceTransmitDapi=oduTcmCConfigTraceTransmitDapi, config=config, neSwInstallState=neSwInstallState, ptpEntityClassInstanceNumber=ptpEntityClassInstanceNumber, oduTcmBDataTraceReceivedOpsp=oduTcmBDataTraceReceivedOpsp, oduTcmCDataTraceReceivedSapi=oduTcmCDataTraceReceivedSapi, otuSectionDataTable=otuSectionDataTable, encryptionFwpFile=encryptionFwpFile, controlPlaneEthEntityIndexAid=controlPlaneEthEntityIndexAid, oduTcmBDataTable=oduTcmBDataTable, oduTcmCDataTraceReceivedDapi=oduTcmCDataTraceReceivedDapi, inventoryCleiCode=inventoryCleiCode, vtpEntityEntry=vtpEntityEntry, neMibVariant=neMibVariant, controlPlaneEthContainsIndex=controlPlaneEthContainsIndex, EnableStateCaps=EnableStateCaps, LogicalIfTransportCaps=LogicalIfTransportCaps, FspR7AdminStateSnmpProxy=FspR7AdminStateSnmpProxy, fwDataBootStatus=fwDataBootStatus, inventoryPartnumber=inventoryPartnumber, FspR7EquipmentTypeCaps=FspR7EquipmentTypeCaps, neEventLogEntry=neEventLogEntry, neMemorySizeFree=neMemorySizeFree, ptpEntityIndex=ptpEntityIndex, ApsHoldoffTime=ApsHoldoffTime, controlPlaneOtnEntityEntry=controlPlaneOtnEntityEntry, neStorageTable=neStorageTable, YesNoNA=YesNoNA, neBackupRestoreFile=neBackupRestoreFile, controlPlaneOtnContainsEntry=controlPlaneOtnContainsEntry, entityContainedIn=entityContainedIn, oduTcmCConfigTcmLevel=oduTcmCConfigTcmLevel, neSwUpgradeNeDirectory=neSwUpgradeNeDirectory, neF7AutomaticRemoteBackupEncryption=neF7AutomaticRemoteBackupEncryption, FspR7EquipmentType=FspR7EquipmentType, swAdmin=swAdmin, neAutoBackupServerAddress=neAutoBackupServerAddress, neStorageDescr=neStorageDescr, ncuActivationTime=ncuActivationTime, swDbDataDefaultsUpgradeRequest=swDbDataDefaultsUpgradeRequest, controlPlaneWdmEntityTable=controlPlaneWdmEntityTable, otuSectionConfigTable=otuSectionConfigTable, neEventLogIndex=neEventLogIndex, entityEntry=entityEntry, controlPlaneWdmEntityAssignmentState=controlPlaneWdmEntityAssignmentState, controlPlaneEthEntityTable=controlPlaneEthEntityTable, vtpEntityAssignmentState=vtpEntityAssignmentState, swDbDataCapEntry=swDbDataCapEntry, CommandEqpt=CommandEqpt, inventorySoftwareRev=inventorySoftwareRev, swDbFileVersion=swDbFileVersion, swVersionInactiveApplSw=swVersionInactiveApplSw, neF7AutomaticBackupTimeStamp=neF7AutomaticBackupTimeStamp, ptpEntityEntry=ptpEntityEntry, controlPlaneOtnEntityContainedIn=controlPlaneOtnEntityContainedIn, neTrapsinkVersion=neTrapsinkVersion, neEventLogVarId=neEventLogVarId, oduSectionConfigTraceTransmitDapi=oduSectionConfigTraceTransmitDapi, fwDataEntry=fwDataEntry, oduTcmCConfigTraceTransmitOpsp=oduTcmCConfigTraceTransmitOpsp, swDbDataNumNativeSaUpdate=swDbDataNumNativeSaUpdate, oduTcmCConfigTraceTransmitSapi=oduTcmCConfigTraceTransmitSapi, neDateAndTime=neDateAndTime, fsp1000adm=fsp1000adm, oduSectionConfigTraceExpected=oduSectionConfigTraceExpected, controlPlaneWdmEntityClass=controlPlaneWdmEntityClass, neTrapsinkPort=neTrapsinkPort, sonetSectionConfigTraceExpected=sonetSectionConfigTraceExpected, controlPlaneOtnContainsTable=controlPlaneOtnContainsTable, oduTcmBConfigTraceExpected=oduTcmBConfigTraceExpected, otuSectionConfigTraceTransmitOpsp=otuSectionConfigTraceTransmitOpsp, oduTcmADataTraceReceivedSapi=oduTcmADataTraceReceivedSapi, AssignmentState=AssignmentState, neMemorySizeTotal=neMemorySizeTotal, fwDataFirmwarePackageRevBackup=fwDataFirmwarePackageRevBackup, swDbFileTable=swDbFileTable, EnableState=EnableState, oduTcmAConfigTraceExpected=oduTcmAConfigTraceExpected, fspNm=fspNm, LogicalIfTransport=LogicalIfTransport, VirtualContainerType=VirtualContainerType, NeSwInstallStatusType=NeSwInstallStatusType, vtpEntityTable=vtpEntityTable, selectedFile=selectedFile, controlPlaneWdmEntityClassInstanceNumber=controlPlaneWdmEntityClassInstanceNumber, snmpWriteAccessRestriction=snmpWriteAccessRestriction, oduTcmCDataTraceReceivedOpsp=oduTcmCDataTraceReceivedOpsp, eqpFwServiceImpairment=eqpFwServiceImpairment, inventoryFirmwarePackageRev=inventoryFirmwarePackageRev, eqpFwEqpServerBusy=eqpFwEqpServerBusy, swDbDataArea=swDbDataArea, ProtectionMech=ProtectionMech, SnmpProxySynchronizationState=SnmpProxySynchronizationState, neF7AutomaticRemoteBackupSrvDir=neF7AutomaticRemoteBackupSrvDir, ServiceImpairment=ServiceImpairment, TimModeCaps=TimModeCaps, swVersionActiveApplSw=swVersionActiveApplSw, neF7AutomaticBackupIndex=neF7AutomaticBackupIndex, controlPlaneWdmEntityIndex=controlPlaneWdmEntityIndex, oduTcmCDataTable=oduTcmCDataTable, neEventLogVarCounter64Val=neEventLogVarCounter64Val, LoopConfigCaps=LoopConfigCaps, oduTcmCConfigSignalDegradePeriod=oduTcmCConfigSignalDegradePeriod, oduTcmADataTraceReceivedDapi=oduTcmADataTraceReceivedDapi, fsp3000alm=fsp3000alm, neF7AutomaticRemoteBackupSrvPass=neF7AutomaticRemoteBackupSrvPass, ncuScheduledDbRestore=ncuScheduledDbRestore, vtpEntityClass=vtpEntityClass, oduTcmBConfigSignalDegradeThreshold=oduTcmBConfigSignalDegradeThreshold, neAlarmStatus=neAlarmStatus, neF7AutomaticRemoteBackupUsers=neF7AutomaticRemoteBackupUsers, common=common, products=products, neF7AutomaticRemoteBackupProtocol=neF7AutomaticRemoteBackupProtocol, sonet=sonet, snmpProxyServerSynchroState=snmpProxyServerSynchroState, swDbDataNumLegacyUpdate=swDbDataNumLegacyUpdate, fsp1000=fsp1000, otuSectionDataTraceReceivedDapi=otuSectionDataTraceReceivedDapi, ptpEntityReferencedTo=ptpEntityReferencedTo, snmpAgent=snmpAgent, oduTcmBConfigTraceTransmitOpsp=oduTcmBConfigTraceTransmitOpsp, FspR7EnableDisable=FspR7EnableDisable, neEventLogVarUnsigned32Val=neEventLogVarUnsigned32Val, oduTcmAConfigSignalDegradePeriod=oduTcmAConfigSignalDegradePeriod, swDbFileEntry=swDbFileEntry, NoYesNA=NoYesNA, FspR7TrapsinkLifetime=FspR7TrapsinkLifetime, DestinationNodeOrAgentState=DestinationNodeOrAgentState, provContainerTable=provContainerTable, neF7AutomaticRemoteBackupCommonIpSrv=neF7AutomaticRemoteBackupCommonIpSrv, controlPlaneWdmEntityContainedIn=controlPlaneWdmEntityContainedIn, eqpFwEqpType=eqpFwEqpType, swVersionActiveOperatingSw=swVersionActiveOperatingSw, swDbDataActivationTime=swDbDataActivationTime, eqpFwNextEqpForUpdate=eqpFwNextEqpForUpdate, entityClassInstanceNumber=entityClassInstanceNumber, neF7AutomaticRemoteBackupSrvLogin=neF7AutomaticRemoteBackupSrvLogin, controlPlaneEthEntityClass=controlPlaneEthEntityClass, FspR7Time=FspR7Time, oduTcmCConfigTable=oduTcmCConfigTable, swDbDataDefaultsTable=swDbDataDefaultsTable, neTrapsinkEntry=neTrapsinkEntry, inventoryUniversalSerialIdent=inventoryUniversalSerialIdent, aosProducts=aosProducts, snmpProxyEntrySingleTargetOutRowStatus=snmpProxyEntrySingleTargetOutRowStatus, swDbDataNumEqpt=swDbDataNumEqpt, swDbDataTable=swDbDataTable, oduTcmBDataTraceReceivedSapi=oduTcmBDataTraceReceivedSapi, SonetSectSigDegThresCaps=SonetSectSigDegThresCaps, neTrapsinkRowStatus=neTrapsinkRowStatus, ApsHoldoffTimeCaps=ApsHoldoffTimeCaps, inventorySerialNum=inventorySerialNum, vtpEntityContainedIn=vtpEntityContainedIn, ServiceAffecting=ServiceAffecting, swDbDataNumSaNotReady=swDbDataNumSaNotReady, neF7AutomaticRemoteBackupSrcIp=neF7AutomaticRemoteBackupSrcIp, oduSectionConfigSignalDegradePeriod=oduSectionConfigSignalDegradePeriod, fwDataServiceImpairment=fwDataServiceImpairment, inventoryMacAddress=inventoryMacAddress, FspR7UsersDb=FspR7UsersDb, oduTcmBConfigSignalDegradePeriod=oduTcmBConfigSignalDegradePeriod, neF7AutomaticBackupInterval=neF7AutomaticBackupInterval, otuSectionDataTraceReceivedOpsp=otuSectionDataTraceReceivedOpsp, BootState=BootState, swDbDataNcuSoftwareVersion=swDbDataNcuSoftwareVersion, ArcState=ArcState, neStorageAvailable=neStorageAvailable, fsp150=fsp150, OhTerminationLevelCaps=OhTerminationLevelCaps, neEventLogVarType=neEventLogVarType, fwDataReadyForActivation=fwDataReadyForActivation, inventoryTable=inventoryTable, StandbyServiceAffecting=StandbyServiceAffecting, swDbFileFileName=swDbFileFileName, fwDataStandbyServiceImpairment=fwDataStandbyServiceImpairment, snmpProxyEntrySingleTargetOutUserName=snmpProxyEntrySingleTargetOutUserName, sonetConfig=sonetConfig, controlPlaneEthEntityClassInstanceNumber=controlPlaneEthEntityClassInstanceNumber, oduTcmAConfigEntry=oduTcmAConfigEntry, controlPlaneEthContainsTable=controlPlaneEthContainsTable, inventoryCfModel=inventoryCfModel, controlPlaneWdmContainsEntry=controlPlaneWdmContainsEntry, fwDataFirmwareApproved=fwDataFirmwareApproved, swDbDataIndex=swDbDataIndex, swDbFileIndex=swDbFileIndex, controlPlaneEthEntityContainedIn=controlPlaneEthEntityContainedIn, oduTcmBDataEntry=oduTcmBDataEntry, F7FileTimeStamp=F7FileTimeStamp, neBackupRestoreState=neBackupRestoreState, controlPlaneOtnEntityAssignmentState=controlPlaneOtnEntityAssignmentState, KBytes=KBytes, containsTable=containsTable, oduConfig=oduConfig, EntityIndex=EntityIndex, sonetSectionConfigSignalDegradeThreshhold=sonetSectionConfigSignalDegradeThreshhold, F7AutoBackupInterval=F7AutoBackupInterval)
mibBuilder.exportSymbols("ADVA-MIB", vtpEntityReferencedTo=vtpEntityReferencedTo, FspR7FalseTrue=FspR7FalseTrue, neSwUpgradeFileName=neSwUpgradeFileName, snmpProxyServerPort=snmpProxyServerPort, oduTcmBDataTraceReceivedDapi=oduTcmBDataTraceReceivedDapi, neTrapsinkTable=neTrapsinkTable, oduTcmADataTraceReceivedOpsp=oduTcmADataTraceReceivedOpsp, OtnTcmLevelCaps=OtnTcmLevelCaps, snmpProxyEntrySingleTargetOutAddress=snmpProxyEntrySingleTargetOutAddress, neTrapsinkUserName=neTrapsinkUserName, swDbDataCapUpgradeRequest=swDbDataCapUpgradeRequest, neSwUpgradeServerAddress=neSwUpgradeServerAddress, fwDataFirmwareAvailable=fwDataFirmwareAvailable, controlPlaneEthContainsEntry=controlPlaneEthContainsEntry, SourceIpAddress=SourceIpAddress, swDbFileComment=swDbFileComment, otuSectionConfigTimMode=otuSectionConfigTimMode, inventoryFpgaRev=inventoryFpgaRev, otuSectionConfigSignalDegradePeriod=otuSectionConfigSignalDegradePeriod, swDbDataRestoreConfig=swDbDataRestoreConfig, neEventLogVarInteger32Val=neEventLogVarInteger32Val, vtpEntityIndexAid=vtpEntityIndexAid, F7AutoBackupRunState=F7AutoBackupRunState, ApsDirectionCaps=ApsDirectionCaps, oduSectionConfigTable=oduSectionConfigTable, oduSectionDataEntry=oduSectionDataEntry, swDbDataStandbyPartitionStatus=swDbDataStandbyPartitionStatus, fsp150cm=fsp150cm, aosCommon=aosCommon, eqpFwUpgradeRequest=eqpFwUpgradeRequest, RestoreActivationCaps=RestoreActivationCaps, coldRestartCapEntry=coldRestartCapEntry, snmpWriteAccessTable=snmpWriteAccessTable, oduTcmAConfigTraceTransmitDapi=oduTcmAConfigTraceTransmitDapi, otuSectionConfigSignalDegradeThreshold=otuSectionConfigSignalDegradeThreshold, neEventLogVarTable=neEventLogVarTable, neEventLogTimeStamp=neEventLogTimeStamp, PgmType=PgmType, updateEqpt=updateEqpt, oduTcmBConfigEntry=oduTcmBConfigEntry, snmpProxyServerSynchroStage=snmpProxyServerSynchroStage, neSwUpgradeServerDirectory=neSwUpgradeServerDirectory, neSwDownloadProgress=neSwDownloadProgress, IdentityTranslation=IdentityTranslation, advaMIB=advaMIB, sonetSectionDataTraceReceived=sonetSectionDataTraceReceived, sonetSectionConfigTraceTransmit=sonetSectionConfigTraceTransmit, oduTcmCConfigTimMode=oduTcmCConfigTimMode, entityIndexAid=entityIndexAid, SonetTraceForm=SonetTraceForm, fwDataActivationReadyOnStandby=fwDataActivationReadyOnStandby, LoopConfig=LoopConfig, snmpProxyEntrySingleTargetOutNodeAgentStatus=snmpProxyEntrySingleTargetOutNodeAgentStatus, neEventLogVarOidVal=neEventLogVarOidVal, EntityType=EntityType, neF7AutomaticBackupStartTime=neF7AutomaticBackupStartTime, SnmpProxySynchronizationStage=SnmpProxySynchronizationStage, snmpWriteAccessNmsName=snmpWriteAccessNmsName, neAutoBackupInterval=neAutoBackupInterval, neF7AutomaticRemoteBackupSrvIp=neF7AutomaticRemoteBackupSrvIp, snmpProxyEntrySingleTargetOutEntry=snmpProxyEntrySingleTargetOutEntry, swVersionTable=swVersionTable, oduSectionDataTraceReceivedDapi=oduSectionDataTraceReceivedDapi, swDbDataDefaultsEntry=swDbDataDefaultsEntry, oduSectionDataTable=oduSectionDataTable, ModuleForm=ModuleForm, sonetSectionConfigSignalDegradePeriod=sonetSectionConfigSignalDegradePeriod, NeSwUpgradeStatusType=NeSwUpgradeStatusType, TimMode=TimMode, OhTerminationLevel=OhTerminationLevel, snmpWriteAccessEntry=snmpWriteAccessEntry, swDbFileGrade=swDbFileGrade, neStorageEntry=neStorageEntry, neRestoreFileBackupDate=neRestoreFileBackupDate, fsp2000=fsp2000, oduTcmCConfigTraceExpected=oduTcmCConfigTraceExpected, VirtualContainerTypeCaps=VirtualContainerTypeCaps, FileArea=FileArea, entityAssignmentState=entityAssignmentState, CpWdmEntityClass=CpWdmEntityClass, provEquipmentState=provEquipmentState, neBackupRestore=neBackupRestore, neTrapsinkCommunity=neTrapsinkCommunity, SonetTimingSourceCaps=SonetTimingSourceCaps, snmpProxyEntrySingleTargetOutAdminState=snmpProxyEntrySingleTargetOutAdminState, neInfo=neInfo, controlPlaneOtnEntityIndex=controlPlaneOtnEntityIndex, fsp3000c=fsp3000c, clearRdiskRequest=clearRdiskRequest, Grade=Grade, ptpEntityContainedIn=ptpEntityContainedIn, neAutoBackupServerDirectory=neAutoBackupServerDirectory, otuConfig=otuConfig, SonetVcBundleAllocationCaps=SonetVcBundleAllocationCaps, otuSectionDataTraceReceivedSapi=otuSectionDataTraceReceivedSapi, controlPlaneOtnContainsIndex=controlPlaneOtnContainsIndex, inventoryType=inventoryType, neSwUpgradeRequest=neSwUpgradeRequest, neTrapsinkAddress=neTrapsinkAddress, controlPlaneWdmEntityIndexAid=controlPlaneWdmEntityIndexAid, swDbFileSize=swDbFileSize, RestoreActivation=RestoreActivation, neSoftwareUpgrade=neSoftwareUpgrade, neSwUpgradeCommonIpSrv=neSwUpgradeCommonIpSrv, otuSectionConfigTraceTransmitDapi=otuSectionConfigTraceTransmitDapi, sonetSectionConfigTimMode=sonetSectionConfigTimMode, otuSectionConfigEntry=otuSectionConfigEntry, TrapCounter=TrapCounter, oduTcmBConfigTcmLevel=oduTcmBConfigTcmLevel, entityType=entityType, SonetSectSigDegThres=SonetSectSigDegThres, sonetSectionDataTable=sonetSectionDataTable, oduTcmBConfigTraceTransmitSapi=oduTcmBConfigTraceTransmitSapi, FspR7AdminStateSnmpProxyCaps=FspR7AdminStateSnmpProxyCaps, oduTcmAConfigSignalDegradeThreshold=oduTcmAConfigSignalDegradeThreshold, neEventLogIdentityTranslation=neEventLogIdentityTranslation, swDbDataNumNativeNsaUpdate=swDbDataNumNativeNsaUpdate, neStorageIndex=neStorageIndex, swVersionNextBoot=swVersionNextBoot, swDbDataNumNsaNotReady=swDbDataNumNsaNotReady, dbAdmin=dbAdmin, FspR7Date=FspR7Date, oduSectionConfigTraceTransmitSapi=oduSectionConfigTraceTransmitSapi, FileType=FileType, provAssignmentState=provAssignmentState, entityTable=entityTable, fwDataStandbyVersion=fwDataStandbyVersion, neSwUpgradeTransferProtocol=neSwUpgradeTransferProtocol, neF7AutomaticBackupEntry=neF7AutomaticBackupEntry, swDbFileCreationTime=swDbFileCreationTime, TrapAlarmSeverity=TrapAlarmSeverity, neEventLogNotificationOID=neEventLogNotificationOID, oduSectionConfigEntry=oduSectionConfigEntry, oduSectionConfigTimMode=oduSectionConfigTimMode, provContainerEntry=provContainerEntry, transportStandards=transportStandards, inventoryHardwareRev=inventoryHardwareRev, inventoryCfSerialNum=inventoryCfSerialNum, SonetTimingSource=SonetTimingSource, neF7AutomaticBackupTable=neF7AutomaticBackupTable, sonetSectionConfigEntry=sonetSectionConfigEntry, oduTcmAConfigTraceTransmitOpsp=oduTcmAConfigTraceTransmitOpsp, vtpEntityIndex=vtpEntityIndex, inventoryVendorId=inventoryVendorId, eqpFwNcuServerBusy=eqpFwNcuServerBusy, swDbFileType=swDbFileType, neSwUpgradeType=neSwUpgradeType, otuSectionDataResultingTotalBitrate=otuSectionDataResultingTotalBitrate, coldRestartCapServiceAffectingCap=coldRestartCapServiceAffectingCap, fsp3000=fsp3000, oduSectionDataTraceReceivedOpsp=oduSectionDataTraceReceivedOpsp, ptpEntityIndexAid=ptpEntityIndexAid, oduTcmAConfigTcmLevel=oduTcmAConfigTcmLevel, neF7AutomaticRemoteBackupPassword=neF7AutomaticRemoteBackupPassword, ncuActivationDate=ncuActivationDate, oduTcmBConfigTable=oduTcmBConfigTable, sonetSectionConfigTimingSource=sonetSectionConfigTimingSource, fwDataProtectionPart=fwDataProtectionPart, neStorageCapacity=neStorageCapacity, ptpEntityClass=ptpEntityClass, software=software, containsIndex=containsIndex, OtnPayloadTypeCaps=OtnPayloadTypeCaps, swVersionInactiveOperatingSw=swVersionInactiveOperatingSw, vtpEntityClassInstanceNumber=vtpEntityClassInstanceNumber, controlPlaneEthEntityEntry=controlPlaneEthEntityEntry, FspR7YesNo=FspR7YesNo, swDbDataCapTable=swDbDataCapTable, inventoryEntry=inventoryEntry, neTrapsinkType=neTrapsinkType, swDbFilePgmType=swDbFilePgmType, swDbFileArea=swDbFileArea, oduSectionDataTraceReceivedSapi=oduSectionDataTraceReceivedSapi, snmpWriteAccessNmsAddress=snmpWriteAccessNmsAddress, controlPlaneOtnEntityClassInstanceNumber=controlPlaneOtnEntityClassInstanceNumber, otuSectionConfigTraceTransmitSapi=otuSectionConfigTraceTransmitSapi, neF7AutomaticBackupRunState=neF7AutomaticBackupRunState, otuSectionConfigTraceExpected=otuSectionConfigTraceExpected, entityEquipmentState=entityEquipmentState, snmpServerPort=snmpServerPort, OtnPayloadType=OtnPayloadType, oduTcmAConfigTimMode=oduTcmAConfigTimMode, aos=aos, vtpEntityType=vtpEntityType, neSwUpgradeState=neSwUpgradeState, coldRestartCapTable=coldRestartCapTable, fwDataFirmwarePackageRev=fwDataFirmwarePackageRev, fsp1500=fsp1500, neEventLogVarIndex=neEventLogVarIndex, oduTcmADataTable=oduTcmADataTable, admin=admin, ncuActivationTimeUtc=ncuActivationTimeUtc, Counter64String=Counter64String, oduTcmCDataEntry=oduTcmCDataEntry, installedEqpt=installedEqpt, NcuAutoActivation=NcuAutoActivation, neEventLogVarIpAddressVal=neEventLogVarIpAddressVal, neEventLogVarEntry=neEventLogVarEntry, vtpEntityEquipmentState=vtpEntityEquipmentState, neEventLogVarOctetStringVal=neEventLogVarOctetStringVal, neSwUpgradeServerPasswd=neSwUpgradeServerPasswd, oduTcmCConfigEntry=oduTcmCConfigEntry, neAutoBackupNextActionAt=neAutoBackupNextActionAt, oduTcmADataEntry=oduTcmADataEntry, PYSNMP_MODULE_ID=advaMIB, containsEntry=containsEntry, ptpEntityEquipmentState=ptpEntityEquipmentState, inventoryUnitName=inventoryUnitName, oduTcmBConfigTraceTransmitDapi=oduTcmBConfigTraceTransmitDapi, FspDate=FspDate, sonetSectionConfigTable=sonetSectionConfigTable, neEventLogTable=neEventLogTable, neAutoBackup=neAutoBackup, oduTcmAConfigTraceTransmitSapi=oduTcmAConfigTraceTransmitSapi, ProtectionMechCaps=ProtectionMechCaps, EquipmentState=EquipmentState, neBackupPassword=neBackupPassword, sonetSectionConfigTraceForm=sonetSectionConfigTraceForm, OtnTcmLevel=OtnTcmLevel, SonetTraceFormCaps=SonetTraceFormCaps, otuSectionConfigPayload=otuSectionConfigPayload, ApsDirection=ApsDirection, ptpEntityAssignmentState=ptpEntityAssignmentState, controlPlaneWdmContainsIndex=controlPlaneWdmContainsIndex, fwDataNewVersion=fwDataNewVersion, fwDataStandbyFirmwareAvailable=fwDataStandbyFirmwareAvailable, neRestoreConfig=neRestoreConfig, neBackupRestoreRequest=neBackupRestoreRequest, swDbDataProgramVersion=swDbDataProgramVersion, events=events, snmpProxyEntrySingleTargetOutTable=snmpProxyEntrySingleTargetOutTable, oduTcmCConfigSignalDegradeThreshold=oduTcmCConfigSignalDegradeThreshold, swDbDataNumLegacyEqpt=swDbDataNumLegacyEqpt, fwDataForm=fwDataForm, neSwUpgradeServerLogin=neSwUpgradeServerLogin, updateBackupRestoreMib=updateBackupRestoreMib)
