...
MacAddress, TimeStamp, DateAndTime, TextualConvention, DisplayString, RowStatus, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "TimeStamp", "DateAndTime", "TextualConvention", "DisplayString", "RowStatus", "TestAndIncr")
...
mibBuilder.exportSymbols("ADVA-MIB", swDbDataFirmwareSetVersion=swDbDataFirmwareSetVersion, oduTcmBConfigSignalDegradeThreshold=oduTcmBConfigSignalDegradeThreshold, swDbDataNumSaNotReady=swDbDataNumSaNotReady, ncuScheduledActivation=ncuScheduledActivation, neF7AutomaticRemoteBackupTimeStamp=neF7AutomaticRemoteBackupTimeStamp, RestoreActivationCaps=RestoreActivationCaps, aos=aos, neTrapsinkType=neTrapsinkType, snmpProxyEntrySingleTargetOutAdminState=snmpProxyEntrySingleTargetOutAdminState, swDbDataCapUpgradeRequest=swDbDataCapUpgradeRequest, controlPlaneEthContainsTable=controlPlaneEthContainsTable, neSwUpgradeCommonIpSrv=neSwUpgradeCommonIpSrv, controlPlaneEthEntityIndexAid=controlPlaneEthEntityIndexAid, eqpFwEqpType=eqpFwEqpType, oduSectionDataTraceReceivedDapi=oduSectionDataTraceReceivedDapi, neStorageIndex=neStorageIndex, vtpEntityEntry=vtpEntityEntry, updateBackupRestoreMib=updateBackupRestoreMib, ApsHoldoffTime=ApsHoldoffTime, inventoryHardwareRev=inventoryHardwareRev, FileArea=FileArea, oduConfig=oduConfig, swDbFileCreationTime=swDbFileCreationTime, neAutoBackupServerPasswd=neAutoBackupServerPasswd, neEventLogEntry=neEventLogEntry, FspR7YesNo=FspR7YesNo, neTrapsinkTable=neTrapsinkTable, controlPlaneWdmEntityClassInstanceNumber=controlPlaneWdmEntityClassInstanceNumber, inventoryCfModel=inventoryCfModel, admin=admin, swVersionActiveOperatingSw=swVersionActiveOperatingSw, neStorageEntry=neStorageEntry, controlPlaneEthEntityClassInstanceNumber=controlPlaneEthEntityClassInstanceNumber, ncuActivationTime=ncuActivationTime, swDbDataNumNsaNotReady=swDbDataNumNsaNotReady, neBackupRestoreRequest=neBackupRestoreRequest, neMibVariant=neMibVariant, otuSectionConfigSignalDegradePeriod=otuSectionConfigSignalDegradePeriod, neManufacturer=neManufacturer, sourceIpAddress=sourceIpAddress, SonetVcBundleAllocation=SonetVcBundleAllocation, PartitionStatus=PartitionStatus, neEventLogVarType=neEventLogVarType, oduTcmBConfigTraceTransmitSapi=oduTcmBConfigTraceTransmitSapi, ptpEntityEntry=ptpEntityEntry, NeSwUpgradeStatusType=NeSwUpgradeStatusType, inventoryCleiCode=inventoryCleiCode, swDbFileEntry=swDbFileEntry, transportStandards=transportStandards, controlPlaneOtnContainsEntry=controlPlaneOtnContainsEntry, oduTcmADataTraceReceivedDapi=oduTcmADataTraceReceivedDapi, neF7AutomaticRemoteBackupEncryption=neF7AutomaticRemoteBackupEncryption, Grade=Grade, eqpFwServiceImpairment=eqpFwServiceImpairment, inventoryMib=inventoryMib, neBackupUsers=neBackupUsers, ncuActivationDate=ncuActivationDate, neSwUpgradeState=neSwUpgradeState, oduTcmADataTraceReceivedOpsp=oduTcmADataTraceReceivedOpsp, oduSectionConfigTraceTransmitOpsp=oduSectionConfigTraceTransmitOpsp, neEventLogVarIndex=neEventLogVarIndex, swDbDataActivationTime=swDbDataActivationTime, EthDuplexMode=EthDuplexMode, vtpEntityTable=vtpEntityTable, swDbDataProgramVersion=swDbDataProgramVersion, controlPlaneOtnEntityTable=controlPlaneOtnEntityTable, oduTcmAConfigEntry=oduTcmAConfigEntry, otuSectionDataTraceReceivedDapi=otuSectionDataTraceReceivedDapi, oduTcmCConfigTraceExpected=oduTcmCConfigTraceExpected, oduSectionConfigEntry=oduSectionConfigEntry, neEventLogIdentityTranslation=neEventLogIdentityTranslation, swDbDataStandbyPartitionStatus=swDbDataStandbyPartitionStatus, snmpProxyEntrySingleTargetOutRowStatus=snmpProxyEntrySingleTargetOutRowStatus, FspR7Time=FspR7Time, swDbDataDefaultsTable=swDbDataDefaultsTable, neTrapsinkEntry=neTrapsinkEntry, vtpEntityContainedIn=vtpEntityContainedIn, PgmType=PgmType, oduTcmBConfigEntry=oduTcmBConfigEntry, vtpEntityReferencedTo=vtpEntityReferencedTo, fwDataFirmwareApproved=fwDataFirmwareApproved, SonetTraceFormCaps=SonetTraceFormCaps, neBackupEncryption=neBackupEncryption, SonetSectSigDegThresCaps=SonetSectSigDegThresCaps, NeSwInstallStatusType=NeSwInstallStatusType, snmpProxyEntrySingleTargetOutNodeAgentStatus=snmpProxyEntrySingleTargetOutNodeAgentStatus, neF7AutomaticBackupTable=neF7AutomaticBackupTable, DestinationNodeOrAgentState=DestinationNodeOrAgentState, FspDate=FspDate, swVersionInactiveOperatingSw=swVersionInactiveOperatingSw, sonetSectionConfigTraceExpected=sonetSectionConfigTraceExpected, ptpEntityClass=ptpEntityClass, swDbDataNumNativeSaUpdate=swDbDataNumNativeSaUpdate, controlPlaneOtnEntityIndex=controlPlaneOtnEntityIndex, oduTcmADataTable=oduTcmADataTable, fwDataStandbyFirmwareAvailable=fwDataStandbyFirmwareAvailable, controlPlaneOtnEntityEntry=controlPlaneOtnEntityEntry, oduTcmAConfigTraceTransmitDapi=oduTcmAConfigTraceTransmitDapi, fwDataActivationReadyOnStandby=fwDataActivationReadyOnStandby, swAdmin=swAdmin, EnableStateCaps=EnableStateCaps, ptpEntityTable=ptpEntityTable, snmpWriteAccessEntry=snmpWriteAccessEntry, F7AutoBackupInterval=F7AutoBackupInterval, swVersionActiveApplSw=swVersionActiveApplSw, entityIndexAid=entityIndexAid, snmpProxyEntrySingleTargetOutPort=snmpProxyEntrySingleTargetOutPort, snmpProxyServerPort=snmpProxyServerPort, YesNoNA=YesNoNA, vtpEntityType=vtpEntityType, KBytes=KBytes, events=events, neTrapsinkAddress=neTrapsinkAddress, ptpEntityReferencedTo=ptpEntityReferencedTo, neF7AutomaticBackupInterval=neF7AutomaticBackupInterval, IdentityTranslation=IdentityTranslation, inventoryGradeInventory=inventoryGradeInventory, ptpEntityClassInstanceNumber=ptpEntityClassInstanceNumber, FileType=FileType, swDbFileRowStatus=swDbFileRowStatus, neAutoBackupNextActionAt=neAutoBackupNextActionAt, products=products, oduTcmCDataTable=oduTcmCDataTable, snmpProxyEntrySingleTargetOutEntry=snmpProxyEntrySingleTargetOutEntry, fwDataFirmwareAvailable=fwDataFirmwareAvailable, ApsDirectionCaps=ApsDirectionCaps, fwDataFirmwarePackageRev=fwDataFirmwarePackageRev, sonetSectionDataTraceReceived=sonetSectionDataTraceReceived, controlPlaneWdmEntityIndexAid=controlPlaneWdmEntityIndexAid, snmpProxyEntrySingleTargetOutUserName=snmpProxyEntrySingleTargetOutUserName, otuConfig=otuConfig, oduTcmBConfigTraceTransmitDapi=oduTcmBConfigTraceTransmitDapi, entityTable=entityTable, otuSectionDataEntry=otuSectionDataEntry, controlPlaneWdmEntityAssignmentState=controlPlaneWdmEntityAssignmentState, oduTcmCConfigTcmLevel=oduTcmCConfigTcmLevel, controlPlaneWdmContainsTable=controlPlaneWdmContainsTable, neInitialConnectionMode=neInitialConnectionMode, oduTcmAConfigSignalDegradeThreshold=oduTcmAConfigSignalDegradeThreshold, EntityType=EntityType, vtpEntityClassInstanceNumber=vtpEntityClassInstanceNumber, controlPlaneEthEntityContainedIn=controlPlaneEthEntityContainedIn, controlPlaneEthEntityIndex=controlPlaneEthEntityIndex, oduTcmCConfigSignalDegradePeriod=oduTcmCConfigSignalDegradePeriod, otuSectionDataTraceReceivedOpsp=otuSectionDataTraceReceivedOpsp, controlPlaneWdmEntityTable=controlPlaneWdmEntityTable, swVersionEntry=swVersionEntry, neTrapsinkCommunity=neTrapsinkCommunity, sonetSectionConfigTimMode=sonetSectionConfigTimMode, swDbDataNcuSoftwareVersion=swDbDataNcuSoftwareVersion, neSwUpgradeServerAddress=neSwUpgradeServerAddress, neSwUpgradeNeDirectory=neSwUpgradeNeDirectory, ApsDirection=ApsDirection, coldRestartCapEntry=coldRestartCapEntry, oduTcmCConfigTraceTransmitSapi=oduTcmCConfigTraceTransmitSapi, neTrapsinkUserName=neTrapsinkUserName, coldRestartCapTable=coldRestartCapTable, FspR7EquipmentTypeCaps=FspR7EquipmentTypeCaps, oduSectionConfigTraceTransmitDapi=oduSectionConfigTraceTransmitDapi, neEventLogVarEntry=neEventLogVarEntry, otuSectionDataTable=otuSectionDataTable, oduTcmAConfigTcmLevel=oduTcmAConfigTcmLevel, neSwInstallState=neSwInstallState, dbAdmin=dbAdmin, snmpProxyServerSynchroStage=snmpProxyServerSynchroStage, neF7AutomaticRemoteBackupCommonIpSrv=neF7AutomaticRemoteBackupCommonIpSrv, oduTcmBConfigTimMode=oduTcmBConfigTimMode, oduSectionConfigTraceTransmitSapi=oduSectionConfigTraceTransmitSapi, controlPlaneOtnEntityIndexAid=controlPlaneOtnEntityIndexAid, inventoryVendorId=inventoryVendorId, VirtualContainerType=VirtualContainerType, otuSectionDataResultingTotalBitrate=otuSectionDataResultingTotalBitrate, containsIndex=containsIndex, otuSectionConfigTraceTransmitOpsp=otuSectionConfigTraceTransmitOpsp, oduTcmAConfigTraceTransmitOpsp=oduTcmAConfigTraceTransmitOpsp, inventoryFirmwarePackageRev=inventoryFirmwarePackageRev, LoopConfig=LoopConfig, OtnTcmLevelCaps=OtnTcmLevelCaps, inventoryPartnumber=inventoryPartnumber, controlPlaneWdmEntityClass=controlPlaneWdmEntityClass, OtnPayloadTypeCaps=OtnPayloadTypeCaps, swDbDataEntry=swDbDataEntry, FspR7AdminStateSnmpProxyCaps=FspR7AdminStateSnmpProxyCaps, FspR7FalseTrue=FspR7FalseTrue, ServiceImpairment=ServiceImpairment, otuSectionConfigTraceTransmitSapi=otuSectionConfigTraceTransmitSapi, software=software, neF7AutomaticBackupEntry=neF7AutomaticBackupEntry, entityIndex=entityIndex, OtnTcmLevel=OtnTcmLevel, neF7AutomaticRemoteBackupProtocol=neF7AutomaticRemoteBackupProtocol, sonetConfig=sonetConfig, F7FileTimeStamp=F7FileTimeStamp, swDbFileType=swDbFileType, FspR7TrapsinkLifetime=FspR7TrapsinkLifetime, SonetTraceForm=SonetTraceForm, neEventLogTable=neEventLogTable, neSwUpgradeRequest=neSwUpgradeRequest, TrapAlarmSeverity=TrapAlarmSeverity, SnmpProxySynchronizationStage=SnmpProxySynchronizationStage, entityType=entityType, swDbDataArea=swDbDataArea, TrapCounter=TrapCounter, oduTcmCConfigTraceTransmitDapi=oduTcmCConfigTraceTransmitDapi, sonetSectionDataTable=sonetSectionDataTable, vtpEntityIndexAid=vtpEntityIndexAid, swVersionInactiveApplSw=swVersionInactiveApplSw, FspR7Date=FspR7Date, oduTcmBDataEntry=oduTcmBDataEntry, ApsHoldoffTimeCaps=ApsHoldoffTimeCaps, swDbDataDefaultsEntry=swDbDataDefaultsEntry, fwDataProtectionPart=fwDataProtectionPart, SnmpProxySynchronizationState=SnmpProxySynchronizationState, snmpWriteAccessRestriction=snmpWriteAccessRestriction, neF7AutomaticBackupStartDate=neF7AutomaticBackupStartDate, oduTcmAConfigSignalDegradePeriod=oduTcmAConfigSignalDegradePeriod, swDbFileArea=swDbFileArea, snmpProxyServerAdminState=snmpProxyServerAdminState, NoYesNA=NoYesNA, fspNm=fspNm, RestoreActivation=RestoreActivation, neAutoBackupServerDirectory=neAutoBackupServerDirectory, neSwUpgradeTransferProtocol=neSwUpgradeTransferProtocol, NcuAutoActivation=NcuAutoActivation, eqpFwNextEqpForUpdate=eqpFwNextEqpForUpdate, neF7AutomaticBackupTimeStamp=neF7AutomaticBackupTimeStamp, inventoryEntry=inventoryEntry, ptpEntityType=ptpEntityType, controlPlaneOtnEntityClass=controlPlaneOtnEntityClass, fwDataFirmwarePackageRevBackup=fwDataFirmwarePackageRevBackup, neRestoreFileBackupDate=neRestoreFileBackupDate, sonetSectionConfigTraceForm=sonetSectionConfigTraceForm, aosProducts=aosProducts, selectedFile=selectedFile, neAutoBackupServerAddress=neAutoBackupServerAddress, LogicalIfTransport=LogicalIfTransport, inventoryTable=inventoryTable, otuSectionConfigPayload=otuSectionConfigPayload, oduTcmBConfigTcmLevel=oduTcmBConfigTcmLevel, FspR7AdminStateSnmpProxy=FspR7AdminStateSnmpProxy, fsp150cm=fsp150cm, neEventLogVarOidVal=neEventLogVarOidVal, BootState=BootState, oduTcmBDataTraceReceivedSapi=oduTcmBDataTraceReceivedSapi, oduTcmAConfigTimMode=oduTcmAConfigTimMode, provAssignmentState=provAssignmentState, oduTcmBConfigSignalDegradePeriod=oduTcmBConfigSignalDegradePeriod, oduTcmBConfigTraceTransmitOpsp=oduTcmBConfigTraceTransmitOpsp, oduTcmADataEntry=oduTcmADataEntry, neStorageDescr=neStorageDescr, controlPlaneEthEntityEntry=controlPlaneEthEntityEntry, neAlarmStatus=neAlarmStatus, controlPlaneOtnContainsTable=controlPlaneOtnContainsTable, ptpEntityIndex=ptpEntityIndex)
mibBuilder.exportSymbols("ADVA-MIB", swDbDataCapTable=swDbDataCapTable, neSwUpgradeFileName=neSwUpgradeFileName, neF7AutomaticBackupRunState=neF7AutomaticBackupRunState, vtpEntityAssignmentState=vtpEntityAssignmentState, neTrapsinkRowStatus=neTrapsinkRowStatus, neAutoBackupInterval=neAutoBackupInterval, oduSectionDataTraceReceivedSapi=oduSectionDataTraceReceivedSapi, fwDataTable=fwDataTable, ptpEntityAssignmentState=ptpEntityAssignmentState, swDbDataIndex=swDbDataIndex, EthDuplexModeCaps=EthDuplexModeCaps, oduTcmCDataTraceReceivedDapi=oduTcmCDataTraceReceivedDapi, snmpWriteAccessTable=snmpWriteAccessTable, snmpWriteAccessNmsName=snmpWriteAccessNmsName, oduSectionDataEntry=oduSectionDataEntry, oduTcmCConfigTraceTransmitOpsp=oduTcmCConfigTraceTransmitOpsp, sonetSectionConfigTable=sonetSectionConfigTable, neEventLogVarOctetStringVal=neEventLogVarOctetStringVal, fwDataForm=fwDataForm, oduSectionDataTable=oduSectionDataTable, encryptionFwpFile=encryptionFwpFile, snmpAgent=snmpAgent, fsp1000adm=fsp1000adm, neF7AutomaticBackupNextDate=neF7AutomaticBackupNextDate, swDbDataCapRestoreConfig=swDbDataCapRestoreConfig, neStorageCapacity=neStorageCapacity, OhTerminationLevel=OhTerminationLevel, ArcState=ArcState, ptpEntityContainedIn=ptpEntityContainedIn, neSoftwareUpgrade=neSoftwareUpgrade, neSwUpgradeType=neSwUpgradeType, controlPlaneWdmEntityContainedIn=controlPlaneWdmEntityContainedIn, fwDataNewVersion=fwDataNewVersion, OnOff=OnOff, aosCommon=aosCommon, oduSectionConfigSignalDegradeThres=oduSectionConfigSignalDegradeThres, fwDataEntry=fwDataEntry, neEventLogVarCounter64Val=neEventLogVarCounter64Val, controlPlaneWdmContainsEntry=controlPlaneWdmContainsEntry, neSwUpgradeServerPasswd=neSwUpgradeServerPasswd, oduTcmADataTraceReceivedSapi=oduTcmADataTraceReceivedSapi, swVersionTable=swVersionTable, fsp1500=fsp1500, neTrapsinkVersion=neTrapsinkVersion, neBackupPassword=neBackupPassword, neRestoreConfig=neRestoreConfig, FileTransferProtocol=FileTransferProtocol, ProtectionMechCaps=ProtectionMechCaps, neBackupRestoreState=neBackupRestoreState, inventoryFpgaRev=inventoryFpgaRev, StandbyServiceAffecting=StandbyServiceAffecting, neBackupRestoreFile=neBackupRestoreFile, Counter64String=Counter64String, ncuScheduledDbRestore=ncuScheduledDbRestore, ptpEntityEquipmentState=ptpEntityEquipmentState, FspR7EnableDisable=FspR7EnableDisable, neEventLogIndex=neEventLogIndex, TimModeCaps=TimModeCaps, provContainerTable=provContainerTable, oduTcmBDataTraceReceivedOpsp=oduTcmBDataTraceReceivedOpsp, inventoryUniversalSerialIdent=inventoryUniversalSerialIdent, provEquipmentState=provEquipmentState, entityAssignmentState=entityAssignmentState, SonetSectSigDegThres=SonetSectSigDegThres, swDbFileIndex=swDbFileIndex, ProtectionMech=ProtectionMech, SonetTimingSource=SonetTimingSource, fwDataServiceImpairment=fwDataServiceImpairment, oduTcmCDataTraceReceivedOpsp=oduTcmCDataTraceReceivedOpsp, fwDataReadyForActivation=fwDataReadyForActivation, otuSectionConfigTable=otuSectionConfigTable, SonetVcBundleAllocationCaps=SonetVcBundleAllocationCaps, oduTcmAConfigTable=oduTcmAConfigTable, neF7AutomaticRemoteBackupSrvLogin=neF7AutomaticRemoteBackupSrvLogin, oduTcmBConfigTable=oduTcmBConfigTable, oduSectionConfigSignalDegradePeriod=oduSectionConfigSignalDegradePeriod, neAutoBackupServerLogin=neAutoBackupServerLogin, EntityIndex=EntityIndex, ptpEntityIndexAid=ptpEntityIndexAid, swDbFileTable=swDbFileTable, controlPlaneOtnEntityContainedIn=controlPlaneOtnEntityContainedIn, sonet=sonet, oduTcmBDataTraceReceivedDapi=oduTcmBDataTraceReceivedDapi, otuSectionConfigEntry=otuSectionConfigEntry, neDateAndTime=neDateAndTime, swDbDataNumLegacyEqpt=swDbDataNumLegacyEqpt, sonetSectionDataEntry=sonetSectionDataEntry, inventoryMacAddress=inventoryMacAddress, fsp2000=fsp2000, oduSectionConfigTimMode=oduSectionConfigTimMode, LoopConfigCaps=LoopConfigCaps, fsp1000=fsp1000, entityEquipmentState=entityEquipmentState, controlPlaneOtnEntityAssignmentState=controlPlaneOtnEntityAssignmentState, neF7AutomaticRemoteBackupSrvPass=neF7AutomaticRemoteBackupSrvPass, neEventLogVarUnsigned32Val=neEventLogVarUnsigned32Val, oduTcmAConfigTraceTransmitSapi=oduTcmAConfigTraceTransmitSapi, fwDataStandbyVersion=fwDataStandbyVersion, AssignmentState=AssignmentState, fwDataBootStatus=fwDataBootStatus, fsp3000=fsp3000, neStorageAvailable=neStorageAvailable, swDbDataRestoreConfig=swDbDataRestoreConfig, fsp3000alm=fsp3000alm, VirtualContainerTypeCaps=VirtualContainerTypeCaps, entityClass=entityClass, ncuActivationDateUtc=ncuActivationDateUtc, neEventLogVarTable=neEventLogVarTable, inventorySerialNum=inventorySerialNum, neF7AutomaticBackupStartTime=neF7AutomaticBackupStartTime, snmpProxyEntrySingleTargetOutAddress=snmpProxyEntrySingleTargetOutAddress, inventoryType=inventoryType, sonetSectionConfigTimingSource=sonetSectionConfigTimingSource, otuSectionDataTraceReceivedSapi=otuSectionDataTraceReceivedSapi, swDbDataTable=swDbDataTable, otuSectionConfigTraceExpected=otuSectionConfigTraceExpected, EnableState=EnableState, OhTerminationLevelCaps=OhTerminationLevelCaps, swVersionNextBoot=swVersionNextBoot, ServiceAffecting=ServiceAffecting, otn=otn, neEventLogVarInteger32Val=neEventLogVarInteger32Val, fspR7=fspR7, neF7AutomaticRemoteBackupSrvIp=neF7AutomaticRemoteBackupSrvIp, CpWdmEntityClass=CpWdmEntityClass, oduTcmBConfigTraceExpected=oduTcmBConfigTraceExpected, swDbFileVersion=swDbFileVersion, neEventLogNotificationOID=neEventLogNotificationOID, oduTcmBDataTable=oduTcmBDataTable, AvailState=AvailState, swDbFileComment=swDbFileComment, updateEqpt=updateEqpt, fsp3000c=fsp3000c, FspR7EquipmentType=FspR7EquipmentType, entityClassInstanceNumber=entityClassInstanceNumber, sonetSectionConfigEntry=sonetSectionConfigEntry, EntityClass=EntityClass, neAutoBackup=neAutoBackup, controlPlaneEthContainsEntry=controlPlaneEthContainsEntry, swDbFileFileName=swDbFileFileName, oduTcmCDataEntry=oduTcmCDataEntry, neAutoBackupConfig=neAutoBackupConfig, oduSectionDataTraceReceivedOpsp=oduSectionDataTraceReceivedOpsp, common=common, oduTcmCConfigSignalDegradeThreshold=oduTcmCConfigSignalDegradeThreshold, otuSectionConfigTimMode=otuSectionConfigTimMode, snmpProxyEntrySingleTargetOutTable=snmpProxyEntrySingleTargetOutTable, config=config, FspTime=FspTime, controlPlaneWdmContainsIndex=controlPlaneWdmContainsIndex, containsTable=containsTable, neF7AutomaticRemoteBackupSrvDir=neF7AutomaticRemoteBackupSrvDir, swDbFileSize=swDbFileSize, oduSectionConfigTable=oduSectionConfigTable, neF7AutomaticBackupIndex=neF7AutomaticBackupIndex, controlPlaneWdmEntityEntry=controlPlaneWdmEntityEntry, controlPlaneEthEntityAssignmentState=controlPlaneEthEntityAssignmentState, coldRestartCapServiceAffectingCap=coldRestartCapServiceAffectingCap, vtpEntityClass=vtpEntityClass, snmpProxyServerSynchroState=snmpProxyServerSynchroState, oduTcmCConfigTimMode=oduTcmCConfigTimMode, swDbDataNumEqpt=swDbDataNumEqpt, sonetSectionConfigSignalDegradePeriod=sonetSectionConfigSignalDegradePeriod, swDbDataCapEntry=swDbDataCapEntry, entityEntry=entityEntry, neEventLogTimeStamp=neEventLogTimeStamp, otuSectionConfigSignalDegradeThreshold=otuSectionConfigSignalDegradeThreshold, TimMode=TimMode, SourceIpAddress=SourceIpAddress, snmpProxyEntrySingleTargetOutContext=snmpProxyEntrySingleTargetOutContext, controlPlaneOtnEntityClassInstanceNumber=controlPlaneOtnEntityClassInstanceNumber, snmpServerPort=snmpServerPort, neF7AutomaticRemoteBackupUsers=neF7AutomaticRemoteBackupUsers, PYSNMP_MODULE_ID=advaMIB, OtnPayloadType=OtnPayloadType, F7AutoBackupRunState=F7AutoBackupRunState, swDbDataNumNativeNsaUpdate=swDbDataNumNativeNsaUpdate, controlPlaneEthEntityClass=controlPlaneEthEntityClass, inventorySoftwareRev=inventorySoftwareRev, fsp150=fsp150, swDbFilePgmType=swDbFilePgmType, sonetSectionConfigSignalDegradeThreshhold=sonetSectionConfigSignalDegradeThreshhold, oduSectionConfigTraceExpected=oduSectionConfigTraceExpected, vtpEntityEquipmentState=vtpEntityEquipmentState, FspR7UsersDb=FspR7UsersDb, swDbDataDefaultsRestoreConfig=swDbDataDefaultsRestoreConfig, neEventLogVarId=neEventLogVarId, controlPlaneWdmEntityIndex=controlPlaneWdmEntityIndex, neEventsLogged=neEventsLogged, oduTcmCConfigEntry=oduTcmCConfigEntry, swDbDataDefaultsUpgradeRequest=swDbDataDefaultsUpgradeRequest, oduTcmCConfigTable=oduTcmCConfigTable, neBackupRestore=neBackupRestore, eqpFwUpgradeRequest=eqpFwUpgradeRequest, installedEqpt=installedEqpt, oduTcmAConfigTraceExpected=oduTcmAConfigTraceExpected, neEventLogVarIpAddressVal=neEventLogVarIpAddressVal, controlPlaneOtnContainsIndex=controlPlaneOtnContainsIndex, eqpFwNcuServerBusy=eqpFwNcuServerBusy, advaMIB=advaMIB, snmpWriteAccessNmsAddress=snmpWriteAccessNmsAddress, EquipmentState=EquipmentState, vtpEntityIndex=vtpEntityIndex, ModuleForm=ModuleForm, neSwUpgradeServerDirectory=neSwUpgradeServerDirectory, neF7AutomaticRemoteBackupPassword=neF7AutomaticRemoteBackupPassword, swDbFileGrade=swDbFileGrade, entityContainedIn=entityContainedIn, neSwDownloadProgress=neSwDownloadProgress, ncuActivationTimeUtc=ncuActivationTimeUtc, neInfo=neInfo, provContainerEntry=provContainerEntry, otuSectionConfigStuffing=otuSectionConfigStuffing, fwDataStandbyServiceImpairment=fwDataStandbyServiceImpairment, sonetSectionConfigTraceTransmit=sonetSectionConfigTraceTransmit, CommandEqpt=CommandEqpt, otuSectionConfigTraceTransmitDapi=otuSectionConfigTraceTransmitDapi, clearRdiskRequest=clearRdiskRequest, containsEntry=containsEntry, eqpFwEqpServerBusy=eqpFwEqpServerBusy, SonetTimingSourceCaps=SonetTimingSourceCaps, controlPlaneEthEntityTable=controlPlaneEthEntityTable, neStorageTable=neStorageTable, neSwUpgradeServerLogin=neSwUpgradeServerLogin, controlPlaneEthContainsIndex=controlPlaneEthContainsIndex, neTrapsinkPort=neTrapsinkPort, oduTcmCDataTraceReceivedSapi=oduTcmCDataTraceReceivedSapi, inventoryUnitName=inventoryUnitName, neF7AutomaticRemoteBackupSrcIp=neF7AutomaticRemoteBackupSrcIp, neMemorySizeTotal=neMemorySizeTotal, neMemorySizeFree=neMemorySizeFree, ServiceAffectingCaps=ServiceAffectingCaps, swDbDataDatabaseVersion=swDbDataDatabaseVersion, inventoryCfSerialNum=inventoryCfSerialNum, LogicalIfTransportCaps=LogicalIfTransportCaps, swDbDataNumLegacyUpdate=swDbDataNumLegacyUpdate)
