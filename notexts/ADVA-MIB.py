...
TestAndIncr, TextualConvention, RowStatus, MacAddress, TimeStamp, DisplayString, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "TextualConvention", "RowStatus", "MacAddress", "TimeStamp", "DisplayString", "DateAndTime")
...
mibBuilder.exportSymbols("ADVA-MIB", swDbFileGrade=swDbFileGrade, fwDataForm=fwDataForm, swDbDataIndex=swDbDataIndex, swAdmin=swAdmin, swDbFileFileName=swDbFileFileName, vtpEntityClassInstanceNumber=vtpEntityClassInstanceNumber, inventoryPartnumber=inventoryPartnumber, neEventLogVarCounter64Val=neEventLogVarCounter64Val, swDbDataProgramVersion=swDbDataProgramVersion, entityEquipmentState=entityEquipmentState, neMibVariant=neMibVariant, TimMode=TimMode, fsp1500=fsp1500, neAlarmStatus=neAlarmStatus, CommandEqpt=CommandEqpt, provAssignmentState=provAssignmentState, oduSectionConfigSignalDegradeThres=oduSectionConfigSignalDegradeThres, snmpAgent=snmpAgent, SonetTraceForm=SonetTraceForm, swDbDataRestoreConfig=swDbDataRestoreConfig, ProtectionMech=ProtectionMech, neF7AutomaticRemoteBackupSrvIp=neF7AutomaticRemoteBackupSrvIp, controlPlaneWdmEntityClass=controlPlaneWdmEntityClass, fwDataProtectionPart=fwDataProtectionPart, snmpWriteAccessRestriction=snmpWriteAccessRestriction, neSwUpgradeServerDirectory=neSwUpgradeServerDirectory, snmpProxyServerPort=snmpProxyServerPort, oduTcmAConfigSignalDegradeThreshold=oduTcmAConfigSignalDegradeThreshold, eqpFwNcuServerBusy=eqpFwNcuServerBusy, controlPlaneEthEntityIndex=controlPlaneEthEntityIndex, ptpEntityContainedIn=ptpEntityContainedIn, FspR7EnableDisable=FspR7EnableDisable, ncuActivationDate=ncuActivationDate, otuSectionDataTraceReceivedDapi=otuSectionDataTraceReceivedDapi, controlPlaneOtnContainsIndex=controlPlaneOtnContainsIndex, fsp150cm=fsp150cm, oduTcmBConfigTcmLevel=oduTcmBConfigTcmLevel, ArcState=ArcState, ptpEntityIndex=ptpEntityIndex, coldRestartCapTable=coldRestartCapTable, sonetSectionConfigSignalDegradeThreshhold=sonetSectionConfigSignalDegradeThreshhold, AssignmentState=AssignmentState, neEventLogVarOidVal=neEventLogVarOidVal, inventorySoftwareRev=inventorySoftwareRev, oduSectionDataTraceReceivedOpsp=oduSectionDataTraceReceivedOpsp, neTrapsinkTable=neTrapsinkTable, swVersionActiveApplSw=swVersionActiveApplSw, neSwUpgradeNeDirectory=neSwUpgradeNeDirectory, inventoryType=inventoryType, eqpFwServiceImpairment=eqpFwServiceImpairment, fwDataStandbyServiceImpairment=fwDataStandbyServiceImpairment, SonetVcBundleAllocationCaps=SonetVcBundleAllocationCaps, fwDataNewVersion=fwDataNewVersion, eqpFwEqpServerBusy=eqpFwEqpServerBusy, ApsHoldoffTime=ApsHoldoffTime, oduTcmADataTable=oduTcmADataTable, oduTcmBConfigTable=oduTcmBConfigTable, oduTcmBDataTable=oduTcmBDataTable, SonetTimingSource=SonetTimingSource, snmpProxyEntrySingleTargetOutAddress=snmpProxyEntrySingleTargetOutAddress, ncuScheduledDbRestore=ncuScheduledDbRestore, neF7AutomaticBackupStartTime=neF7AutomaticBackupStartTime, oduTcmCDataEntry=oduTcmCDataEntry, swVersionEntry=swVersionEntry, inventoryUnitName=inventoryUnitName, otn=otn, swDbDataNumLegacyUpdate=swDbDataNumLegacyUpdate, oduTcmBConfigTraceTransmitDapi=oduTcmBConfigTraceTransmitDapi, inventoryHardwareRev=inventoryHardwareRev, sonetSectionConfigTable=sonetSectionConfigTable, aosCommon=aosCommon, containsEntry=containsEntry, neEventsLogged=neEventsLogged, snmpProxyEntrySingleTargetOutAdminState=snmpProxyEntrySingleTargetOutAdminState, EquipmentState=EquipmentState, ApsHoldoffTimeCaps=ApsHoldoffTimeCaps, YesNoNA=YesNoNA, VirtualContainerType=VirtualContainerType, otuSectionDataTable=otuSectionDataTable, OhTerminationLevel=OhTerminationLevel, controlPlaneEthEntityAssignmentState=controlPlaneEthEntityAssignmentState, sonetSectionConfigTimingSource=sonetSectionConfigTimingSource, FspR7Time=FspR7Time, SonetVcBundleAllocation=SonetVcBundleAllocation, inventoryCleiCode=inventoryCleiCode, PartitionStatus=PartitionStatus, sonetSectionDataTable=sonetSectionDataTable, swDbFileIndex=swDbFileIndex, swDbDataArea=swDbDataArea, neF7AutomaticRemoteBackupProtocol=neF7AutomaticRemoteBackupProtocol, neF7AutomaticBackupStartDate=neF7AutomaticBackupStartDate, LogicalIfTransport=LogicalIfTransport, entityContainedIn=entityContainedIn, BootState=BootState, sonetSectionConfigTraceTransmit=sonetSectionConfigTraceTransmit, swVersionInactiveOperatingSw=swVersionInactiveOperatingSw, neAutoBackupConfig=neAutoBackupConfig, neStorageTable=neStorageTable, oduTcmBConfigSignalDegradeThreshold=oduTcmBConfigSignalDegradeThreshold, EnableStateCaps=EnableStateCaps, snmpProxyEntrySingleTargetOutTable=snmpProxyEntrySingleTargetOutTable, AvailState=AvailState, ServiceAffectingCaps=ServiceAffectingCaps, EntityClass=EntityClass, neTrapsinkCommunity=neTrapsinkCommunity, PgmType=PgmType, fwDataFirmwareAvailable=fwDataFirmwareAvailable, OtnTcmLevelCaps=OtnTcmLevelCaps, neF7AutomaticBackupRunState=neF7AutomaticBackupRunState, swDbFileType=swDbFileType, swDbDataNumNsaNotReady=swDbDataNumNsaNotReady, NcuAutoActivation=NcuAutoActivation, neSwUpgradeServerAddress=neSwUpgradeServerAddress, neStorageAvailable=neStorageAvailable, Counter64String=Counter64String, fwDataBootStatus=fwDataBootStatus, swDbDataFirmwareSetVersion=swDbDataFirmwareSetVersion, oduTcmBDataEntry=oduTcmBDataEntry, neEventLogIdentityTranslation=neEventLogIdentityTranslation, inventoryFpgaRev=inventoryFpgaRev, neEventLogVarOctetStringVal=neEventLogVarOctetStringVal, oduTcmBConfigTraceTransmitSapi=oduTcmBConfigTraceTransmitSapi, FspR7FalseTrue=FspR7FalseTrue, controlPlaneWdmEntityContainedIn=controlPlaneWdmEntityContainedIn, LogicalIfTransportCaps=LogicalIfTransportCaps, fspNm=fspNm, updateEqpt=updateEqpt, neStorageIndex=neStorageIndex, oduTcmCConfigSignalDegradePeriod=oduTcmCConfigSignalDegradePeriod, otuSectionConfigTraceTransmitDapi=otuSectionConfigTraceTransmitDapi, ServiceImpairment=ServiceImpairment, neSwUpgradeServerPasswd=neSwUpgradeServerPasswd, controlPlaneWdmEntityEntry=controlPlaneWdmEntityEntry, neInitialConnectionMode=neInitialConnectionMode, swDbFileTable=swDbFileTable, encryptionFwpFile=encryptionFwpFile, inventoryTable=inventoryTable, TrapCounter=TrapCounter, oduTcmCConfigTcmLevel=oduTcmCConfigTcmLevel, swDbDataDefaultsTable=swDbDataDefaultsTable, KBytes=KBytes, swDbDataNumSaNotReady=swDbDataNumSaNotReady, controlPlaneWdmEntityTable=controlPlaneWdmEntityTable, NoYesNA=NoYesNA, neBackupPassword=neBackupPassword, vtpEntityTable=vtpEntityTable, otuConfig=otuConfig, FspDate=FspDate, neSwInstallState=neSwInstallState, oduTcmCDataTraceReceivedOpsp=oduTcmCDataTraceReceivedOpsp, EntityIndex=EntityIndex, neEventLogVarInteger32Val=neEventLogVarInteger32Val, oduTcmBConfigEntry=oduTcmBConfigEntry, sonetSectionConfigTraceExpected=sonetSectionConfigTraceExpected, swDbDataDatabaseVersion=swDbDataDatabaseVersion, containsTable=containsTable, neAutoBackupInterval=neAutoBackupInterval, advaMIB=advaMIB, neStorageCapacity=neStorageCapacity, OtnTcmLevel=OtnTcmLevel, ncuActivationDateUtc=ncuActivationDateUtc, ptpEntityEntry=ptpEntityEntry, neSwUpgradeType=neSwUpgradeType, controlPlaneEthContainsEntry=controlPlaneEthContainsEntry, neEventLogVarIndex=neEventLogVarIndex, neTrapsinkPort=neTrapsinkPort, oduTcmBConfigTraceExpected=oduTcmBConfigTraceExpected, ptpEntityEquipmentState=ptpEntityEquipmentState, neSwUpgradeFileName=neSwUpgradeFileName, inventoryCfModel=inventoryCfModel, controlPlaneOtnContainsEntry=controlPlaneOtnContainsEntry, snmpProxyEntrySingleTargetOutPort=snmpProxyEntrySingleTargetOutPort, PYSNMP_MODULE_ID=advaMIB, OhTerminationLevelCaps=OhTerminationLevelCaps, ProtectionMechCaps=ProtectionMechCaps, neEventLogVarIpAddressVal=neEventLogVarIpAddressVal, neF7AutomaticRemoteBackupCommonIpSrv=neF7AutomaticRemoteBackupCommonIpSrv, oduSectionDataEntry=oduSectionDataEntry, swDbDataDefaultsUpgradeRequest=swDbDataDefaultsUpgradeRequest, controlPlaneOtnContainsTable=controlPlaneOtnContainsTable, snmpProxyEntrySingleTargetOutRowStatus=snmpProxyEntrySingleTargetOutRowStatus, DestinationNodeOrAgentState=DestinationNodeOrAgentState, OnOff=OnOff, fsp3000alm=fsp3000alm, sonetSectionDataEntry=sonetSectionDataEntry, inventoryUniversalSerialIdent=inventoryUniversalSerialIdent, neF7AutomaticRemoteBackupUsers=neF7AutomaticRemoteBackupUsers, neDateAndTime=neDateAndTime, eqpFwUpgradeRequest=eqpFwUpgradeRequest, oduTcmADataTraceReceivedDapi=oduTcmADataTraceReceivedDapi, swDbDataCapEntry=swDbDataCapEntry, oduTcmCDataTraceReceivedDapi=oduTcmCDataTraceReceivedDapi, dbAdmin=dbAdmin, neEventLogVarId=neEventLogVarId, fwDataStandbyFirmwareAvailable=fwDataStandbyFirmwareAvailable, neSwUpgradeCommonIpSrv=neSwUpgradeCommonIpSrv, F7AutoBackupInterval=F7AutoBackupInterval, neF7AutomaticRemoteBackupSrvDir=neF7AutomaticRemoteBackupSrvDir, OtnPayloadType=OtnPayloadType, entityIndexAid=entityIndexAid, TimModeCaps=TimModeCaps, oduTcmAConfigTraceTransmitDapi=oduTcmAConfigTraceTransmitDapi, LoopConfig=LoopConfig, neSwUpgradeTransferProtocol=neSwUpgradeTransferProtocol, F7AutoBackupRunState=F7AutoBackupRunState, oduSectionConfigEntry=oduSectionConfigEntry, controlPlaneWdmEntityClassInstanceNumber=controlPlaneWdmEntityClassInstanceNumber, neF7AutomaticRemoteBackupSrvPass=neF7AutomaticRemoteBackupSrvPass, snmpProxyServerSynchroState=snmpProxyServerSynchroState, neTrapsinkUserName=neTrapsinkUserName, FileTransferProtocol=FileTransferProtocol, snmpProxyEntrySingleTargetOutEntry=snmpProxyEntrySingleTargetOutEntry, CpWdmEntityClass=CpWdmEntityClass, SonetTimingSourceCaps=SonetTimingSourceCaps, sonetConfig=sonetConfig, FspR7AdminStateSnmpProxyCaps=FspR7AdminStateSnmpProxyCaps, FspR7Date=FspR7Date, controlPlaneEthEntityClass=controlPlaneEthEntityClass, neManufacturer=neManufacturer, neAutoBackupServerAddress=neAutoBackupServerAddress, inventoryMib=inventoryMib, oduSectionConfigTraceTransmitOpsp=oduSectionConfigTraceTransmitOpsp, swVersionActiveOperatingSw=swVersionActiveOperatingSw, entityEntry=entityEntry, vtpEntityReferencedTo=vtpEntityReferencedTo, oduTcmAConfigTimMode=oduTcmAConfigTimMode, controlPlaneOtnEntityIndexAid=controlPlaneOtnEntityIndexAid, neEventLogNotificationOID=neEventLogNotificationOID, controlPlaneEthContainsIndex=controlPlaneEthContainsIndex, EntityType=EntityType, fsp1000adm=fsp1000adm, neEventLogTimeStamp=neEventLogTimeStamp, otuSectionDataTraceReceivedOpsp=otuSectionDataTraceReceivedOpsp, oduConfig=oduConfig, ncuActivationTimeUtc=ncuActivationTimeUtc, fsp2000=fsp2000, controlPlaneEthEntityIndexAid=controlPlaneEthEntityIndexAid, fsp3000=fsp3000, provEquipmentState=provEquipmentState, swVersionInactiveApplSw=swVersionInactiveApplSw, neSwDownloadProgress=neSwDownloadProgress, neTrapsinkAddress=neTrapsinkAddress, neF7AutomaticRemoteBackupSrcIp=neF7AutomaticRemoteBackupSrcIp, neF7AutomaticBackupNextDate=neF7AutomaticBackupNextDate, FspTime=FspTime, swDbDataNumLegacyEqpt=swDbDataNumLegacyEqpt, oduTcmAConfigSignalDegradePeriod=oduTcmAConfigSignalDegradePeriod, inventoryFirmwarePackageRev=inventoryFirmwarePackageRev, oduTcmCConfigTimMode=oduTcmCConfigTimMode, fwDataFirmwarePackageRevBackup=fwDataFirmwarePackageRevBackup, ApsDirectionCaps=ApsDirectionCaps, neTrapsinkRowStatus=neTrapsinkRowStatus, oduTcmAConfigTable=oduTcmAConfigTable, ptpEntityIndexAid=ptpEntityIndexAid)
mibBuilder.exportSymbols("ADVA-MIB", swDbDataNumEqpt=swDbDataNumEqpt, admin=admin, config=config, fwDataServiceImpairment=fwDataServiceImpairment, neSwUpgradeState=neSwUpgradeState, inventoryVendorId=inventoryVendorId, oduTcmCConfigTraceExpected=oduTcmCConfigTraceExpected, controlPlaneEthEntityEntry=controlPlaneEthEntityEntry, neStorageDescr=neStorageDescr, FileType=FileType, vtpEntityClass=vtpEntityClass, otuSectionConfigTraceTransmitOpsp=otuSectionConfigTraceTransmitOpsp, neF7AutomaticBackupEntry=neF7AutomaticBackupEntry, TrapAlarmSeverity=TrapAlarmSeverity, controlPlaneWdmContainsEntry=controlPlaneWdmContainsEntry, oduSectionConfigTraceTransmitDapi=oduSectionConfigTraceTransmitDapi, otuSectionDataResultingTotalBitrate=otuSectionDataResultingTotalBitrate, snmpServerPort=snmpServerPort, vtpEntityType=vtpEntityType, ApsDirection=ApsDirection, sonetSectionConfigSignalDegradePeriod=sonetSectionConfigSignalDegradePeriod, SonetSectSigDegThres=SonetSectSigDegThres, vtpEntityIndex=vtpEntityIndex, selectedFile=selectedFile, oduTcmADataEntry=oduTcmADataEntry, fsp1000=fsp1000, swDbDataDefaultsRestoreConfig=swDbDataDefaultsRestoreConfig, FspR7AdminStateSnmpProxy=FspR7AdminStateSnmpProxy, installedEqpt=installedEqpt, ServiceAffecting=ServiceAffecting, neRestoreConfig=neRestoreConfig, ptpEntityType=ptpEntityType, fwDataFirmwareApproved=fwDataFirmwareApproved, oduTcmBDataTraceReceivedDapi=oduTcmBDataTraceReceivedDapi, ptpEntityClassInstanceNumber=ptpEntityClassInstanceNumber, swDbDataCapRestoreConfig=swDbDataCapRestoreConfig, ptpEntityTable=ptpEntityTable, SnmpProxySynchronizationStage=SnmpProxySynchronizationStage, neEventLogVarEntry=neEventLogVarEntry, ptpEntityClass=ptpEntityClass, vtpEntityAssignmentState=vtpEntityAssignmentState, vtpEntityContainedIn=vtpEntityContainedIn, neTrapsinkEntry=neTrapsinkEntry, swDbDataCapUpgradeRequest=swDbDataCapUpgradeRequest, oduSectionConfigTable=oduSectionConfigTable, vtpEntityEquipmentState=vtpEntityEquipmentState, swDbDataNumNativeNsaUpdate=swDbDataNumNativeNsaUpdate, fwDataEntry=fwDataEntry, swDbFileVersion=swDbFileVersion, oduTcmAConfigTraceTransmitOpsp=oduTcmAConfigTraceTransmitOpsp, SonetSectSigDegThresCaps=SonetSectSigDegThresCaps, entityClassInstanceNumber=entityClassInstanceNumber, entityTable=entityTable, neEventLogIndex=neEventLogIndex, LoopConfigCaps=LoopConfigCaps, neAutoBackupServerDirectory=neAutoBackupServerDirectory, neEventLogEntry=neEventLogEntry, NeSwInstallStatusType=NeSwInstallStatusType, inventorySerialNum=inventorySerialNum, ModuleForm=ModuleForm, controlPlaneOtnEntityEntry=controlPlaneOtnEntityEntry, controlPlaneOtnEntityClassInstanceNumber=controlPlaneOtnEntityClassInstanceNumber, swDbDataTable=swDbDataTable, fspR7=fspR7, neBackupUsers=neBackupUsers, neEventLogVarType=neEventLogVarType, oduTcmBDataTraceReceivedSapi=oduTcmBDataTraceReceivedSapi, controlPlaneEthEntityClassInstanceNumber=controlPlaneEthEntityClassInstanceNumber, fsp3000c=fsp3000c, SonetTraceFormCaps=SonetTraceFormCaps, oduSectionConfigTraceTransmitSapi=oduSectionConfigTraceTransmitSapi, sonetSectionConfigEntry=sonetSectionConfigEntry, otuSectionConfigSignalDegradeThreshold=otuSectionConfigSignalDegradeThreshold, F7FileTimeStamp=F7FileTimeStamp, oduTcmADataTraceReceivedOpsp=oduTcmADataTraceReceivedOpsp, aos=aos, neAutoBackupServerPasswd=neAutoBackupServerPasswd, otuSectionConfigTraceTransmitSapi=otuSectionConfigTraceTransmitSapi, neEventLogVarUnsigned32Val=neEventLogVarUnsigned32Val, oduTcmCConfigEntry=oduTcmCConfigEntry, entityIndex=entityIndex, oduTcmAConfigEntry=oduTcmAConfigEntry, oduTcmCDataTable=oduTcmCDataTable, snmpProxyEntrySingleTargetOutNodeAgentStatus=snmpProxyEntrySingleTargetOutNodeAgentStatus, FspR7UsersDb=FspR7UsersDb, oduSectionDataTable=oduSectionDataTable, neBackupRestoreState=neBackupRestoreState, swDbFileArea=swDbFileArea, controlPlaneWdmContainsIndex=controlPlaneWdmContainsIndex, events=events, controlPlaneWdmContainsTable=controlPlaneWdmContainsTable, otuSectionDataTraceReceivedSapi=otuSectionDataTraceReceivedSapi, otuSectionConfigTimMode=otuSectionConfigTimMode, FspR7EquipmentTypeCaps=FspR7EquipmentTypeCaps, otuSectionDataEntry=otuSectionDataEntry, controlPlaneWdmEntityIndexAid=controlPlaneWdmEntityIndexAid, otuSectionConfigPayload=otuSectionConfigPayload, oduTcmCConfigTraceTransmitOpsp=oduTcmCConfigTraceTransmitOpsp, clearRdiskRequest=clearRdiskRequest, vtpEntityEntry=vtpEntityEntry, controlPlaneOtnEntityAssignmentState=controlPlaneOtnEntityAssignmentState, ncuScheduledActivation=ncuScheduledActivation, oduTcmADataTraceReceivedSapi=oduTcmADataTraceReceivedSapi, snmpWriteAccessNmsAddress=snmpWriteAccessNmsAddress, otuSectionConfigTable=otuSectionConfigTable, neBackupEncryption=neBackupEncryption, neF7AutomaticBackupInterval=neF7AutomaticBackupInterval, neAutoBackupNextActionAt=neAutoBackupNextActionAt, oduTcmAConfigTraceTransmitSapi=oduTcmAConfigTraceTransmitSapi, swDbFileRowStatus=swDbFileRowStatus, neBackupRestoreRequest=neBackupRestoreRequest, neSwUpgradeRequest=neSwUpgradeRequest, IdentityTranslation=IdentityTranslation, controlPlaneEthEntityTable=controlPlaneEthEntityTable, products=products, RestoreActivation=RestoreActivation, swDbFileSize=swDbFileSize, eqpFwEqpType=eqpFwEqpType, OtnPayloadTypeCaps=OtnPayloadTypeCaps, oduTcmBConfigSignalDegradePeriod=oduTcmBConfigSignalDegradePeriod, oduTcmCDataTraceReceivedSapi=oduTcmCDataTraceReceivedSapi, inventoryGradeInventory=inventoryGradeInventory, neBackupRestore=neBackupRestore, coldRestartCapEntry=coldRestartCapEntry, neSwUpgradeServerLogin=neSwUpgradeServerLogin, neTrapsinkType=neTrapsinkType, sourceIpAddress=sourceIpAddress, containsIndex=containsIndex, inventoryEntry=inventoryEntry, provContainerEntry=provContainerEntry, coldRestartCapServiceAffectingCap=coldRestartCapServiceAffectingCap, Grade=Grade, neMemorySizeTotal=neMemorySizeTotal, fwDataReadyForActivation=fwDataReadyForActivation, StandbyServiceAffecting=StandbyServiceAffecting, oduTcmAConfigTcmLevel=oduTcmAConfigTcmLevel, aosProducts=aosProducts, swDbDataNumNativeSaUpdate=swDbDataNumNativeSaUpdate, swVersionTable=swVersionTable, inventoryMacAddress=inventoryMacAddress, FspR7EquipmentType=FspR7EquipmentType, controlPlaneWdmEntityAssignmentState=controlPlaneWdmEntityAssignmentState, neAutoBackup=neAutoBackup, neF7AutomaticBackupTable=neF7AutomaticBackupTable, oduSectionDataTraceReceivedSapi=oduSectionDataTraceReceivedSapi, swDbDataEntry=swDbDataEntry, otuSectionConfigEntry=otuSectionConfigEntry, oduTcmAConfigTraceExpected=oduTcmAConfigTraceExpected, snmpProxyServerAdminState=snmpProxyServerAdminState, entityClass=entityClass, neF7AutomaticBackupTimeStamp=neF7AutomaticBackupTimeStamp, neF7AutomaticBackupIndex=neF7AutomaticBackupIndex, oduTcmBConfigTraceTransmitOpsp=oduTcmBConfigTraceTransmitOpsp, RestoreActivationCaps=RestoreActivationCaps, fwDataTable=fwDataTable, oduSectionConfigSignalDegradePeriod=oduSectionConfigSignalDegradePeriod, inventoryCfSerialNum=inventoryCfSerialNum, updateBackupRestoreMib=updateBackupRestoreMib, neF7AutomaticRemoteBackupSrvLogin=neF7AutomaticRemoteBackupSrvLogin, oduTcmBConfigTimMode=oduTcmBConfigTimMode, fsp150=fsp150, ptpEntityReferencedTo=ptpEntityReferencedTo, EthDuplexModeCaps=EthDuplexModeCaps, swDbDataStandbyPartitionStatus=swDbDataStandbyPartitionStatus, fwDataFirmwarePackageRev=fwDataFirmwarePackageRev, FspR7TrapsinkLifetime=FspR7TrapsinkLifetime, oduTcmCConfigSignalDegradeThreshold=oduTcmCConfigSignalDegradeThreshold, swVersionNextBoot=swVersionNextBoot, neF7AutomaticRemoteBackupPassword=neF7AutomaticRemoteBackupPassword, FspR7YesNo=FspR7YesNo, snmpWriteAccessEntry=snmpWriteAccessEntry, SnmpProxySynchronizationState=SnmpProxySynchronizationState, oduTcmCConfigTable=oduTcmCConfigTable, fwDataActivationReadyOnStandby=fwDataActivationReadyOnStandby, swDbDataActivationTime=swDbDataActivationTime, eqpFwNextEqpForUpdate=eqpFwNextEqpForUpdate, transportStandards=transportStandards, swDbFileEntry=swDbFileEntry, VirtualContainerTypeCaps=VirtualContainerTypeCaps, neF7AutomaticRemoteBackupEncryption=neF7AutomaticRemoteBackupEncryption, sonet=sonet, sonetSectionConfigTimMode=sonetSectionConfigTimMode, entityType=entityType, entityAssignmentState=entityAssignmentState, controlPlaneOtnEntityContainedIn=controlPlaneOtnEntityContainedIn, controlPlaneWdmEntityIndex=controlPlaneWdmEntityIndex, neStorageEntry=neStorageEntry, otuSectionConfigTraceExpected=otuSectionConfigTraceExpected, oduSectionConfigTimMode=oduSectionConfigTimMode, fwDataStandbyVersion=fwDataStandbyVersion, ncuActivationTime=ncuActivationTime, snmpProxyServerSynchroStage=snmpProxyServerSynchroStage, neSoftwareUpgrade=neSoftwareUpgrade, neF7AutomaticRemoteBackupTimeStamp=neF7AutomaticRemoteBackupTimeStamp, EnableState=EnableState, NeSwUpgradeStatusType=NeSwUpgradeStatusType, ptpEntityAssignmentState=ptpEntityAssignmentState, neAutoBackupServerLogin=neAutoBackupServerLogin, swDbDataCapTable=swDbDataCapTable, neTrapsinkVersion=neTrapsinkVersion, neInfo=neInfo, otuSectionConfigStuffing=otuSectionConfigStuffing, controlPlaneOtnEntityClass=controlPlaneOtnEntityClass, common=common, swDbDataDefaultsEntry=swDbDataDefaultsEntry, swDbFileCreationTime=swDbFileCreationTime, vtpEntityIndexAid=vtpEntityIndexAid, neBackupRestoreFile=neBackupRestoreFile, sonetSectionDataTraceReceived=sonetSectionDataTraceReceived, oduTcmBDataTraceReceivedOpsp=oduTcmBDataTraceReceivedOpsp, FileArea=FileArea, swDbFilePgmType=swDbFilePgmType, swDbDataNcuSoftwareVersion=swDbDataNcuSoftwareVersion, swDbFileComment=swDbFileComment, oduTcmCConfigTraceTransmitDapi=oduTcmCConfigTraceTransmitDapi, controlPlaneEthContainsTable=controlPlaneEthContainsTable, neMemorySizeFree=neMemorySizeFree, controlPlaneOtnEntityIndex=controlPlaneOtnEntityIndex, software=software, sonetSectionConfigTraceForm=sonetSectionConfigTraceForm, snmpProxyEntrySingleTargetOutUserName=snmpProxyEntrySingleTargetOutUserName, otuSectionConfigSignalDegradePeriod=otuSectionConfigSignalDegradePeriod, controlPlaneOtnEntityTable=controlPlaneOtnEntityTable, neRestoreFileBackupDate=neRestoreFileBackupDate, oduSectionConfigTraceExpected=oduSectionConfigTraceExpected, oduTcmCConfigTraceTransmitSapi=oduTcmCConfigTraceTransmitSapi, neEventLogVarTable=neEventLogVarTable, controlPlaneEthEntityContainedIn=controlPlaneEthEntityContainedIn, snmpWriteAccessTable=snmpWriteAccessTable, EthDuplexMode=EthDuplexMode, oduSectionDataTraceReceivedDapi=oduSectionDataTraceReceivedDapi, neEventLogTable=neEventLogTable, provContainerTable=provContainerTable, snmpProxyEntrySingleTargetOutContext=snmpProxyEntrySingleTargetOutContext, SourceIpAddress=SourceIpAddress, snmpWriteAccessNmsName=snmpWriteAccessNmsName)
