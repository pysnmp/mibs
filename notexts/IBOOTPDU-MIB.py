...
# Produced by pysmi-1.1.8 at Mon Jan 16 15:33:07 2023
...
Gauge32, iso, enterprises, ModuleIdentity, NotificationType, Counter32, ObjectIdentity, Integer32, MibIdentifier, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "enterprises", "ModuleIdentity", "NotificationType", "Counter32", "ObjectIdentity", "Integer32", "MibIdentifier", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "TimeTicks")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", firmwareVersion=firmwareVersion, snmpEnabled=snmpEnabled, deviceTemperatureUnit=deviceTemperatureUnit, notifications=notifications, rebootSystem=rebootSystem, cloudServerAddress=cloudServerAddress, macAddress=macAddress, ipAddress=ipAddress, telnetPort=telnetPort, cloudUUID=cloudUUID, dataprobe=dataprobe, dnsServer1=dnsServer1, webEnabled=webEnabled, snmpReadCommunity=snmpReadCommunity, setFactoryDefaults=setFactoryDefaults, snmpManagerName=snmpManagerName, outletInitialState=outletInitialState, deviceNumberOfOutlets=deviceNumberOfOutlets, TC1=TC1, cloudServiceEnabled=cloudServiceEnabled, outletStatus=outletStatus, sshEnabled=sshEnabled, sensors=sensors, deviceCalibrated=deviceCalibrated, ipMode=ipMode, iBoot_PDU_Agent=iBoot_PDU_Agent, network=network, deviceName=deviceName, cloudActivationCode=cloudActivationCode, deviceMaxCurrent=deviceMaxCurrent, outletDelayTime=outletDelayTime, rebootRequired=rebootRequired, telnetEnabled=telnetEnabled, deviceTimeZone=deviceTimeZone, snmpTrapCommunity=snmpTrapCommunity, outletEntry=outletEntry, currentLC2=currentLC2, sslEnabled=sslEnabled, deviceConnector=deviceConnector, sshPort=sshPort, voltageLC1=voltageLC1, deviceModelName=deviceModelName, outletIndex=outletIndex, subnetMask=subnetMask, outletActualStatus=outletActualStatus, voltageLC2=voltageLC2, outletChange=outletChange, snmpManagerEntry=snmpManagerEntry, outletTable=outletTable, device=device, modemCountryCode=modemCountryCode, temperature1=temperature1, console=console, snmpManagerAddress=snmpManagerAddress, dnsServer2=dnsServer2, snmp=snmp, sslPort=sslPort, webPort=webPort, serialPortEnabled=serialPortEnabled, snmpWriteCommunity=snmpWriteCommunity, snmpManagerIndex=snmpManagerIndex, outletCycleTime=outletCycleTime, outletControl=outletControl, outletName=outletName, PYSNMP_MODULE_ID=iBoot_PDU_Agent, consoleTimeout=consoleTimeout, currentLC1=currentLC1, deviceFamily=deviceFamily, gateway=gateway, temperature2=temperature2, deviceNumberOfLineCords=deviceNumberOfLineCords, snmpManagerTable=snmpManagerTable)
