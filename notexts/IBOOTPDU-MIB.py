...
# Produced by pysmi-1.1.8 at Thu Apr 27 09:20:57 2023
...
iso, ModuleIdentity, enterprises, ObjectIdentity, MibIdentifier, Counter64, Integer32, Counter32, Bits, Gauge32, Unsigned32, TimeTicks, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "enterprises", "ObjectIdentity", "MibIdentifier", "Counter64", "Integer32", "Counter32", "Bits", "Gauge32", "Unsigned32", "TimeTicks", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", telnetEnabled=telnetEnabled, outletActualStatus=outletActualStatus, deviceTimeZone=deviceTimeZone, snmpManagerIndex=snmpManagerIndex, deviceTemperatureUnit=deviceTemperatureUnit, macAddress=macAddress, snmpManagerName=snmpManagerName, voltageLC2=voltageLC2, iBoot_PDU_Agent=iBoot_PDU_Agent, webPort=webPort, snmpWriteCommunity=snmpWriteCommunity, dataprobe=dataprobe, firmwareVersion=firmwareVersion, temperature1=temperature1, deviceNumberOfOutlets=deviceNumberOfOutlets, dnsServer1=dnsServer1, network=network, telnetPort=telnetPort, notifications=notifications, cloudUUID=cloudUUID, snmpManagerAddress=snmpManagerAddress, currentLC2=currentLC2, sensors=sensors, currentLC1=currentLC1, voltageLC1=voltageLC1, outletControl=outletControl, outletEntry=outletEntry, cloudServerAddress=cloudServerAddress, sshPort=sshPort, rebootRequired=rebootRequired, snmpEnabled=snmpEnabled, outletInitialState=outletInitialState, snmp=snmp, snmpTrapCommunity=snmpTrapCommunity, ipAddress=ipAddress, device=device, consoleTimeout=consoleTimeout, outletStatus=outletStatus, serialPortEnabled=serialPortEnabled, modemCountryCode=modemCountryCode, outletIndex=outletIndex, deviceModelName=deviceModelName, cloudActivationCode=cloudActivationCode, temperature2=temperature2, snmpReadCommunity=snmpReadCommunity, snmpManagerEntry=snmpManagerEntry, console=console, outletTable=outletTable, snmpManagerTable=snmpManagerTable, deviceMaxCurrent=deviceMaxCurrent, outletCycleTime=outletCycleTime, webEnabled=webEnabled, setFactoryDefaults=setFactoryDefaults, ipMode=ipMode, sslPort=sslPort, cloudServiceEnabled=cloudServiceEnabled, PYSNMP_MODULE_ID=iBoot_PDU_Agent, gateway=gateway, deviceConnector=deviceConnector, deviceNumberOfLineCords=deviceNumberOfLineCords, deviceFamily=deviceFamily, outletDelayTime=outletDelayTime, outletChange=outletChange, sshEnabled=sshEnabled, deviceName=deviceName, outletName=outletName, TC1=TC1, rebootSystem=rebootSystem, dnsServer2=dnsServer2, subnetMask=subnetMask, sslEnabled=sslEnabled, deviceCalibrated=deviceCalibrated)
