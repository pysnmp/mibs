...
# Produced by pysmi-1.1.8 at Tue Aug  9 16:06:47 2022
...
enterprises, iso, TimeTicks, ModuleIdentity, Counter32, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, Unsigned32, Gauge32, Counter64, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "iso", "TimeTicks", "ModuleIdentity", "Counter32", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "Unsigned32", "Gauge32", "Counter64", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", dnsServer2=dnsServer2, snmpManagerIndex=snmpManagerIndex, cloudServiceEnabled=cloudServiceEnabled, subnetMask=subnetMask, snmpTrapCommunity=snmpTrapCommunity, serialPortEnabled=serialPortEnabled, outletInitialState=outletInitialState, currentLC2=currentLC2, cloudUUID=cloudUUID, outletCycleTime=outletCycleTime, deviceNumberOfOutlets=deviceNumberOfOutlets, temperature2=temperature2, gateway=gateway, consoleTimeout=consoleTimeout, sshPort=sshPort, outletName=outletName, PYSNMP_MODULE_ID=iBoot_PDU_Agent, outletStatus=outletStatus, webPort=webPort, iBoot_PDU_Agent=iBoot_PDU_Agent, telnetPort=telnetPort, ipMode=ipMode, snmpManagerName=snmpManagerName, temperature1=temperature1, sensors=sensors, setFactoryDefaults=setFactoryDefaults, dnsServer1=dnsServer1, deviceFamily=deviceFamily, snmpManagerTable=snmpManagerTable, outletTable=outletTable, deviceModelName=deviceModelName, outletEntry=outletEntry, cloudServerAddress=cloudServerAddress, deviceNumberOfLineCords=deviceNumberOfLineCords, cloudActivationCode=cloudActivationCode, deviceConnector=deviceConnector, dataprobe=dataprobe, snmpEnabled=snmpEnabled, snmp=snmp, firmwareVersion=firmwareVersion, snmpManagerEntry=snmpManagerEntry, ipAddress=ipAddress, outletDelayTime=outletDelayTime, outletActualStatus=outletActualStatus, rebootSystem=rebootSystem, deviceCalibrated=deviceCalibrated, snmpReadCommunity=snmpReadCommunity, outletControl=outletControl, voltageLC1=voltageLC1, deviceTemperatureUnit=deviceTemperatureUnit, outletIndex=outletIndex, webEnabled=webEnabled, voltageLC2=voltageLC2, sshEnabled=sshEnabled, deviceTimeZone=deviceTimeZone, deviceName=deviceName, console=console, snmpManagerAddress=snmpManagerAddress, network=network, device=device, snmpWriteCommunity=snmpWriteCommunity, rebootRequired=rebootRequired, outletChange=outletChange, sslPort=sslPort, macAddress=macAddress, telnetEnabled=telnetEnabled, currentLC1=currentLC1, sslEnabled=sslEnabled, notifications=notifications, TC1=TC1, modemCountryCode=modemCountryCode, deviceMaxCurrent=deviceMaxCurrent)
