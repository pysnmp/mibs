...
# ASN.1 source IBOOTPDU-MIB
# Source digest sha256:9452f5ebe3c91ad730ca079c3104ab4d75adb8018054ff73fa6ef6b8a7058991
...
if mibBuilder.loadTexts: iBoot_PDU_Agent.setLastUpdated('2017-10-25 13:23')
...
snmpManagerTable = MibTable((1, 3, 6, 1, 4, 1, 1418, 6, 4, 4), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: snmpManagerTable.setStatus('current')
snmpManagerEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1418, 6, 4, 4, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "IBOOTPDU-MIB", "snmpManagerIndex"))
...
outletTable = MibTable((1, 3, 6, 1, 4, 1, 1418, 6, 5), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: outletTable.setStatus('current')
outletEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1418, 6, 5, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "IBOOTPDU-MIB", "outletIndex"))
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", PYSNMP_MODULE_ID=iBoot_PDU_Agent, TC1=TC1, cloudActivationCode=cloudActivationCode, cloudServerAddress=cloudServerAddress, cloudServiceEnabled=cloudServiceEnabled, cloudUUID=cloudUUID, console=console, consoleTimeout=consoleTimeout, currentLC1=currentLC1, currentLC2=currentLC2, dataprobe=dataprobe, device=device, deviceCalibrated=deviceCalibrated, deviceConnector=deviceConnector, deviceFamily=deviceFamily, deviceMaxCurrent=deviceMaxCurrent, deviceModelName=deviceModelName, deviceName=deviceName, deviceNumberOfLineCords=deviceNumberOfLineCords, deviceNumberOfOutlets=deviceNumberOfOutlets, deviceTemperatureUnit=deviceTemperatureUnit, deviceTimeZone=deviceTimeZone, dnsServer1=dnsServer1, dnsServer2=dnsServer2, firmwareVersion=firmwareVersion, gateway=gateway, iBoot_PDU_Agent=iBoot_PDU_Agent, ipAddress=ipAddress, ipMode=ipMode, macAddress=macAddress, modemCountryCode=modemCountryCode, network=network, notifications=notifications, outletActualStatus=outletActualStatus, outletChange=outletChange, outletControl=outletControl, outletCycleTime=outletCycleTime, outletDelayTime=outletDelayTime, outletEntry=outletEntry, outletIndex=outletIndex, outletInitialState=outletInitialState, outletName=outletName, outletStatus=outletStatus, outletTable=outletTable, rebootRequired=rebootRequired, rebootSystem=rebootSystem, sensors=sensors, serialPortEnabled=serialPortEnabled, setFactoryDefaults=setFactoryDefaults, snmp=snmp, snmpEnabled=snmpEnabled, snmpManagerAddress=snmpManagerAddress, snmpManagerEntry=snmpManagerEntry, snmpManagerIndex=snmpManagerIndex, snmpManagerName=snmpManagerName, snmpManagerTable=snmpManagerTable, snmpReadCommunity=snmpReadCommunity, snmpTrapCommunity=snmpTrapCommunity, snmpWriteCommunity=snmpWriteCommunity, sshEnabled=sshEnabled, sshPort=sshPort, sslEnabled=sslEnabled, sslPort=sslPort, subnetMask=subnetMask, telnetEnabled=telnetEnabled, telnetPort=telnetPort, temperature1=temperature1, temperature2=temperature2, voltageLC1=voltageLC1, voltageLC2=voltageLC2, webEnabled=webEnabled, webPort=webPort)
