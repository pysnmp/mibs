...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, TimeTicks, Counter64, ModuleIdentity, Counter32, Gauge32, Unsigned32, ObjectIdentity, NotificationType, Bits, iso, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "TimeTicks", "Counter64", "ModuleIdentity", "Counter32", "Gauge32", "Unsigned32", "ObjectIdentity", "NotificationType", "Bits", "iso", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", voltageLC2=voltageLC2, currentLC2=currentLC2, telnetEnabled=telnetEnabled, outletActualStatus=outletActualStatus, ipMode=ipMode, gateway=gateway, deviceMaxCurrent=deviceMaxCurrent, telnetPort=telnetPort, temperature2=temperature2, rebootRequired=rebootRequired, outletInitialState=outletInitialState, snmpManagerName=snmpManagerName, TC1=TC1, device=device, cloudUUID=cloudUUID, webPort=webPort, console=console, snmpReadCommunity=snmpReadCommunity, subnetMask=subnetMask, temperature1=temperature1, outletControl=outletControl, deviceTemperatureUnit=deviceTemperatureUnit, outletEntry=outletEntry, deviceNumberOfOutlets=deviceNumberOfOutlets, dnsServer1=dnsServer1, cloudServerAddress=cloudServerAddress, sshEnabled=sshEnabled, modemCountryCode=modemCountryCode, cloudServiceEnabled=cloudServiceEnabled, deviceTimeZone=deviceTimeZone, deviceCalibrated=deviceCalibrated, snmpManagerAddress=snmpManagerAddress, deviceModelName=deviceModelName, serialPortEnabled=serialPortEnabled, network=network, sslPort=sslPort, outletTable=outletTable, PYSNMP_MODULE_ID=iBoot_PDU_Agent, webEnabled=webEnabled, voltageLC1=voltageLC1, firmwareVersion=firmwareVersion, consoleTimeout=consoleTimeout, snmpWriteCommunity=snmpWriteCommunity, snmpManagerTable=snmpManagerTable, outletCycleTime=outletCycleTime, iBoot_PDU_Agent=iBoot_PDU_Agent, ipAddress=ipAddress, snmpManagerEntry=snmpManagerEntry, notifications=notifications, deviceConnector=deviceConnector, currentLC1=currentLC1, sensors=sensors, dataprobe=dataprobe, sshPort=sshPort, snmpManagerIndex=snmpManagerIndex, snmp=snmp, dnsServer2=dnsServer2, snmpTrapCommunity=snmpTrapCommunity, rebootSystem=rebootSystem, outletName=outletName, outletIndex=outletIndex, setFactoryDefaults=setFactoryDefaults, sslEnabled=sslEnabled, outletStatus=outletStatus, deviceName=deviceName, cloudActivationCode=cloudActivationCode, outletChange=outletChange, outletDelayTime=outletDelayTime, deviceFamily=deviceFamily, macAddress=macAddress, deviceNumberOfLineCords=deviceNumberOfLineCords, snmpEnabled=snmpEnabled)
