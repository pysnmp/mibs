...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, TimeTicks, NotificationType, enterprises, Counter32, Integer32, IpAddress, Counter64, Unsigned32, MibIdentifier, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "TimeTicks", "NotificationType", "enterprises", "Counter32", "Integer32", "IpAddress", "Counter64", "Unsigned32", "MibIdentifier", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", webEnabled=webEnabled, modemCountryCode=modemCountryCode, snmpManagerIndex=snmpManagerIndex, outletIndex=outletIndex, console=console, deviceModelName=deviceModelName, snmpReadCommunity=snmpReadCommunity, snmpEnabled=snmpEnabled, gateway=gateway, subnetMask=subnetMask, snmpManagerName=snmpManagerName, outletControl=outletControl, ipAddress=ipAddress, currentLC2=currentLC2, sshPort=sshPort, notifications=notifications, snmp=snmp, cloudServiceEnabled=cloudServiceEnabled, outletEntry=outletEntry, outletStatus=outletStatus, PYSNMP_MODULE_ID=iBoot_PDU_Agent, serialPortEnabled=serialPortEnabled, sensors=sensors, deviceName=deviceName, deviceFamily=deviceFamily, firmwareVersion=firmwareVersion, sslEnabled=sslEnabled, rebootRequired=rebootRequired, sslPort=sslPort, macAddress=macAddress, webPort=webPort, snmpWriteCommunity=snmpWriteCommunity, outletTable=outletTable, outletName=outletName, outletCycleTime=outletCycleTime, currentLC1=currentLC1, deviceConnector=deviceConnector, dnsServer2=dnsServer2, dnsServer1=dnsServer1, outletChange=outletChange, device=device, deviceTemperatureUnit=deviceTemperatureUnit, snmpManagerAddress=snmpManagerAddress, deviceMaxCurrent=deviceMaxCurrent, deviceTimeZone=deviceTimeZone, network=network, cloudUUID=cloudUUID, sshEnabled=sshEnabled, setFactoryDefaults=setFactoryDefaults, snmpManagerEntry=snmpManagerEntry, outletInitialState=outletInitialState, cloudServerAddress=cloudServerAddress, deviceNumberOfOutlets=deviceNumberOfOutlets, deviceCalibrated=deviceCalibrated, rebootSystem=rebootSystem, telnetEnabled=telnetEnabled, voltageLC1=voltageLC1, snmpManagerTable=snmpManagerTable, ipMode=ipMode, telnetPort=telnetPort, iBoot_PDU_Agent=iBoot_PDU_Agent, temperature2=temperature2, dataprobe=dataprobe, voltageLC2=voltageLC2, snmpTrapCommunity=snmpTrapCommunity, deviceNumberOfLineCords=deviceNumberOfLineCords, TC1=TC1, outletDelayTime=outletDelayTime, consoleTimeout=consoleTimeout, cloudActivationCode=cloudActivationCode, outletActualStatus=outletActualStatus, temperature1=temperature1)
