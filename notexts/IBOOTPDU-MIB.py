...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:33:42 2023
...
ModuleIdentity, Unsigned32, IpAddress, NotificationType, MibIdentifier, iso, Bits, Counter32, Counter64, Integer32, Gauge32, ObjectIdentity, TimeTicks, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "IpAddress", "NotificationType", "MibIdentifier", "iso", "Bits", "Counter32", "Counter64", "Integer32", "Gauge32", "ObjectIdentity", "TimeTicks", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", deviceNumberOfLineCords=deviceNumberOfLineCords, device=device, deviceConnector=deviceConnector, snmpManagerEntry=snmpManagerEntry, currentLC1=currentLC1, subnetMask=subnetMask, deviceModelName=deviceModelName, outletEntry=outletEntry, outletChange=outletChange, snmp=snmp, firmwareVersion=firmwareVersion, snmpManagerIndex=snmpManagerIndex, TC1=TC1, deviceCalibrated=deviceCalibrated, snmpManagerAddress=snmpManagerAddress, rebootSystem=rebootSystem, snmpManagerTable=snmpManagerTable, cloudServerAddress=cloudServerAddress, deviceFamily=deviceFamily, cloudServiceEnabled=cloudServiceEnabled, ipAddress=ipAddress, cloudActivationCode=cloudActivationCode, snmpReadCommunity=snmpReadCommunity, outletStatus=outletStatus, currentLC2=currentLC2, deviceMaxCurrent=deviceMaxCurrent, deviceTimeZone=deviceTimeZone, sslPort=sslPort, sshPort=sshPort, snmpEnabled=snmpEnabled, setFactoryDefaults=setFactoryDefaults, voltageLC2=voltageLC2, deviceNumberOfOutlets=deviceNumberOfOutlets, outletDelayTime=outletDelayTime, outletTable=outletTable, serialPortEnabled=serialPortEnabled, telnetPort=telnetPort, snmpManagerName=snmpManagerName, sshEnabled=sshEnabled, cloudUUID=cloudUUID, voltageLC1=voltageLC1, outletCycleTime=outletCycleTime, iBoot_PDU_Agent=iBoot_PDU_Agent, macAddress=macAddress, dataprobe=dataprobe, PYSNMP_MODULE_ID=iBoot_PDU_Agent, notifications=notifications, modemCountryCode=modemCountryCode, snmpTrapCommunity=snmpTrapCommunity, sslEnabled=sslEnabled, outletName=outletName, outletControl=outletControl, outletActualStatus=outletActualStatus, temperature2=temperature2, webPort=webPort, rebootRequired=rebootRequired, snmpWriteCommunity=snmpWriteCommunity, outletInitialState=outletInitialState, gateway=gateway, ipMode=ipMode, sensors=sensors, webEnabled=webEnabled, network=network, console=console, deviceName=deviceName, deviceTemperatureUnit=deviceTemperatureUnit, consoleTimeout=consoleTimeout, dnsServer2=dnsServer2, dnsServer1=dnsServer1, outletIndex=outletIndex, telnetEnabled=telnetEnabled, temperature1=temperature1)
