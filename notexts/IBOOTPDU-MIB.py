...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, MibIdentifier, Integer32, iso, ObjectIdentity, enterprises, Bits, Counter32, Gauge32, TimeTicks, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "MibIdentifier", "Integer32", "iso", "ObjectIdentity", "enterprises", "Bits", "Counter32", "Gauge32", "TimeTicks", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", notifications=notifications, TC1=TC1, outletControl=outletControl, deviceCalibrated=deviceCalibrated, serialPortEnabled=serialPortEnabled, device=device, telnetPort=telnetPort, snmpManagerEntry=snmpManagerEntry, snmpManagerAddress=snmpManagerAddress, snmpEnabled=snmpEnabled, outletInitialState=outletInitialState, outletCycleTime=outletCycleTime, deviceFamily=deviceFamily, cloudUUID=cloudUUID, snmpReadCommunity=snmpReadCommunity, snmpManagerTable=snmpManagerTable, ipAddress=ipAddress, outletEntry=outletEntry, outletIndex=outletIndex, snmpTrapCommunity=snmpTrapCommunity, rebootSystem=rebootSystem, outletChange=outletChange, deviceName=deviceName, voltageLC1=voltageLC1, PYSNMP_MODULE_ID=iBoot_PDU_Agent, console=console, snmpManagerIndex=snmpManagerIndex, outletName=outletName, iBoot_PDU_Agent=iBoot_PDU_Agent, deviceConnector=deviceConnector, dataprobe=dataprobe, webEnabled=webEnabled, deviceTimeZone=deviceTimeZone, outletStatus=outletStatus, ipMode=ipMode, outletActualStatus=outletActualStatus, rebootRequired=rebootRequired, cloudServiceEnabled=cloudServiceEnabled, snmp=snmp, deviceTemperatureUnit=deviceTemperatureUnit, dnsServer2=dnsServer2, sslPort=sslPort, deviceNumberOfLineCords=deviceNumberOfLineCords, webPort=webPort, voltageLC2=voltageLC2, cloudServerAddress=cloudServerAddress, temperature1=temperature1, dnsServer1=dnsServer1, sslEnabled=sslEnabled, subnetMask=subnetMask, modemCountryCode=modemCountryCode, temperature2=temperature2, deviceModelName=deviceModelName, currentLC1=currentLC1, firmwareVersion=firmwareVersion, snmpWriteCommunity=snmpWriteCommunity, snmpManagerName=snmpManagerName, telnetEnabled=telnetEnabled, cloudActivationCode=cloudActivationCode, macAddress=macAddress, outletTable=outletTable, network=network, deviceMaxCurrent=deviceMaxCurrent, sensors=sensors, sshPort=sshPort, sshEnabled=sshEnabled, outletDelayTime=outletDelayTime, setFactoryDefaults=setFactoryDefaults, gateway=gateway, currentLC2=currentLC2, deviceNumberOfOutlets=deviceNumberOfOutlets, consoleTimeout=consoleTimeout)
