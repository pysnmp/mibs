...
# Produced by pysmi-1.1.12 at Tue Dec  3 10:04:57 2024
...
MibIdentifier, Bits, IpAddress, Counter64, enterprises, TimeTicks, Gauge32, iso, ObjectIdentity, Counter32, ModuleIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "IpAddress", "Counter64", "enterprises", "TimeTicks", "Gauge32", "iso", "ObjectIdentity", "Counter32", "ModuleIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", snmpManagerName=snmpManagerName, temperature2=temperature2, TC1=TC1, snmp=snmp, firmwareVersion=firmwareVersion, snmpManagerIndex=snmpManagerIndex, cloudServiceEnabled=cloudServiceEnabled, notifications=notifications, console=console, modemCountryCode=modemCountryCode, telnetEnabled=telnetEnabled, sshPort=sshPort, cloudUUID=cloudUUID, cloudActivationCode=cloudActivationCode, ipAddress=ipAddress, deviceMaxCurrent=deviceMaxCurrent, gateway=gateway, webPort=webPort, deviceTemperatureUnit=deviceTemperatureUnit, deviceTimeZone=deviceTimeZone, ipMode=ipMode, sslPort=sslPort, dataprobe=dataprobe, webEnabled=webEnabled, snmpEnabled=snmpEnabled, snmpTrapCommunity=snmpTrapCommunity, voltageLC1=voltageLC1, sslEnabled=sslEnabled, snmpManagerAddress=snmpManagerAddress, device=device, outletEntry=outletEntry, outletActualStatus=outletActualStatus, outletDelayTime=outletDelayTime, sshEnabled=sshEnabled, snmpReadCommunity=snmpReadCommunity, temperature1=temperature1, subnetMask=subnetMask, deviceName=deviceName, PYSNMP_MODULE_ID=iBoot_PDU_Agent, deviceModelName=deviceModelName, dnsServer1=dnsServer1, cloudServerAddress=cloudServerAddress, deviceNumberOfLineCords=deviceNumberOfLineCords, dnsServer2=dnsServer2, outletControl=outletControl, currentLC1=currentLC1, deviceFamily=deviceFamily, deviceNumberOfOutlets=deviceNumberOfOutlets, snmpManagerEntry=snmpManagerEntry, snmpManagerTable=snmpManagerTable, iBoot_PDU_Agent=iBoot_PDU_Agent, rebootSystem=rebootSystem, outletIndex=outletIndex, outletStatus=outletStatus, deviceCalibrated=deviceCalibrated, outletName=outletName, currentLC2=currentLC2, setFactoryDefaults=setFactoryDefaults, consoleTimeout=consoleTimeout, snmpWriteCommunity=snmpWriteCommunity, outletTable=outletTable, sensors=sensors, network=network, rebootRequired=rebootRequired, voltageLC2=voltageLC2, deviceConnector=deviceConnector, outletInitialState=outletInitialState, outletChange=outletChange, macAddress=macAddress, outletCycleTime=outletCycleTime, serialPortEnabled=serialPortEnabled, telnetPort=telnetPort)
