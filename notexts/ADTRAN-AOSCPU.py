...
Counter32, Bits, NotificationType, ObjectIdentity, ModuleIdentity, Counter64, Gauge32, iso, Integer32, MibIdentifier, Unsigned32, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "NotificationType", "ObjectIdentity", "ModuleIdentity", "Counter64", "Gauge32", "iso", "Integer32", "MibIdentifier", "Unsigned32", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADTRAN-AOSCPU", adGenAOSMaxCpuUtil=adGenAOSMaxCpuUtil, adGenAOSProcRunTime=adGenAOSProcRunTime, adGenAOSMemPool=adGenAOSMemPool, adGenAOSHeapSize=adGenAOSHeapSize, adAOSCompliance=adAOSCompliance, adGenAOSResType=adGenAOSResType, adGenAOSCurrentCpuUtil=adGenAOSCurrentCpuUtil, adAOSCpuCompliances=adAOSCpuCompliances, adGenAOSProcCount=adGenAOSProcCount, adGenAOSResUtilThreshRowStatus=adGenAOSResUtilThreshRowStatus, adGenAOSResUtilThreshEntry=adGenAOSResUtilThreshEntry, adGenAOSProcExecTime=adGenAOSProcExecTime, adGenAOSProcState=adGenAOSProcState, adGenAOSResUtilThreshNormal=adGenAOSResUtilThreshNormal, adGenAOS5MinCpuUtil=adGenAOS5MinCpuUtil, adAOSCpuGroups=adAOSCpuGroups, adGenAOSResUtilThreshTimestamp=adGenAOSResUtilThreshTimestamp, adGenAOSCpuGroup=adGenAOSCpuGroup, adGenAOS1MinCpuUtil=adGenAOS1MinCpuUtil, adGenAOSHeapFree=adGenAOSHeapFree, adGenAOSResUtilThresh=adGenAOSResUtilThresh, adGenAOSResUtilThreshTraps=adGenAOSResUtilThreshTraps, adGenAOSCpuUtil=adGenAOSCpuUtil, adGenAOSResUtilThreshAlarm=adGenAOSResUtilThreshAlarm, adGenAOSThresholdTrapGroup=adGenAOSThresholdTrapGroup, adGenAOSCpuUtilMib=adGenAOSCpuUtilMib, adGenAOSProcID=adGenAOSProcID, adGenAOSClearUtilizationStats=adGenAOSClearUtilizationStats, adGenAOSProc1SecLd=adGenAOSProc1SecLd, adGenAOSProcessEntry=adGenAOSProcessEntry, adGenAOSProcName=adGenAOSProcName, adGenAOSProcessTable=adGenAOSProcessTable, adGenAOSThresholdGroup=adGenAOSThresholdGroup, adGenAOSResUtilTimeInterval=adGenAOSResUtilTimeInterval, adGenAOSResUtilThreshTable=adGenAOSResUtilThreshTable, adGenAOSCpuConformance=adGenAOSCpuConformance, PYSNMP_MODULE_ID=adGenAOSCpuUtilMib, adGenAOSProcessGroup=adGenAOSProcessGroup, adGenAOSProcPriority=adGenAOSProcPriority)
