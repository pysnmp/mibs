...
mibBuilder.exportSymbols("NAT-MIB", natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, NatPoolId=NatPoolId, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natSessionOutTranslates=natSessionOutTranslates, natLimitFragments=natLimitFragments, natMappingPool=natMappingPool, natAddrPortBindEntry=natAddrPortBindEntry, natResourceErrors=natResourceErrors, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, NatAssociationType=NatAssociationType, natSessionPublicAddrType=natSessionPublicAddrType, natMapIntAddrIntType=natMapIntAddrIntType, natAddrBindEntry=natAddrBindEntry, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natMappingIntAddressType=natMappingIntAddressType, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natSessionDirection=natSessionDirection, natMIBNotifications=natMIBNotifications, natMapIntAddrExtType=natMapIntAddrExtType, natMappingFilterBehavior=natMappingFilterBehavior, natSubscriberIndex=natSubscriberIndex, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natMappingProto=natMappingProto, natSubscriberRealm=natSubscriberRealm, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natCountersEntry=natCountersEntry, natPoolIndex=natPoolIndex, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, VlanIndexOrZero=VlanIndexOrZero, natSessionPublicDstPort=natSessionPublicDstPort, natGroupAddrMapObjects=natGroupAddrMapObjects, natNotifCtrl=natNotifCtrl, natAddrPortBindSessions=natAddrPortBindSessions, natInterfaceRealm=natInterfaceRealm, natMappingExtAddress=natMappingExtAddress, natStatsProtocolGroup=natStatsProtocolGroup, natMappingAddressPooling=natMappingAddressPooling, natAddrMapEntryType=natAddrMapEntryType, natAddrMapStorageType=natAddrMapStorageType, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natSessionUpTime=natSessionUpTime, natTranslations=natTranslations, natProtocolTable=natProtocolTable, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natSessionProtocolType=natSessionProtocolType, NatAddrMapId=NatAddrMapId, natMIBConformance=natMIBConformance, natAddrMapEntry=natAddrMapEntry, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natPoolRangeEnd=natPoolRangeEnd, natSubscriberResourceErrors=natSubscriberResourceErrors, natSubscriberTranslations=natSubscriberTranslations, natInterfaceInTranslates=natInterfaceInTranslates, natAddrMapTable=natAddrMapTable, natLimitAddressMappings=natLimitAddressMappings, natSubscriberIntPrefix=natSubscriberIntPrefix, natSessionIndex=natSessionIndex, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natSessionPrivateDstAddr=natSessionPrivateDstAddr, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natMIBCompliances=natMIBCompliances, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natInterfaceStorageType=natInterfaceStorageType, natSubscribersEntry=natSubscribersEntry, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natFragmentsCompliance=natFragmentsCompliance, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natSessionEntry=natSessionEntry, NatProtocolMap=NatProtocolMap, natAddrBindSessions=natAddrBindSessions, natAddrBindTable=natAddrBindTable, natSessionPublicSrcPort=natSessionPublicSrcPort, natBindDefIdleTimeout=natBindDefIdleTimeout, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natAddrMapProtocol=natAddrMapProtocol, natPacketDiscard=natPacketDiscard, natMappingIntRealm=natMappingIntRealm, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natAddrMapRowStatus=natAddrMapRowStatus, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natLimitMappings=natLimitMappings, SubscriberIndex=SubscriberIndex, natAddrBindId=natAddrBindId, natInterfaceServiceType=natInterfaceServiceType, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natPoolRangeDeallocations=natPoolRangeDeallocations, natInterfaceTable=natInterfaceTable, natSubscribersTable=natSubscribersTable, natNotifSubscriberMappings=natNotifSubscriberMappings, natMappingCreations=natMappingCreations, PYSNMP_MODULE_ID=natMIB, natLimitSubscribers=natLimitSubscribers, natCGNCompliance=natCGNCompliance, ProtocolNumber=ProtocolNumber, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natGroupStatelessObjects=natGroupStatelessObjects, NatBindIdOrZero=NatBindIdOrZero, natGroupSubscriberObjects=natGroupSubscriberObjects, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natAddrBindOutTranslates=natAddrBindOutTranslates, natMapIntAddrExt=natMapIntAddrExt, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natSubsInterfaceIndex=natSubsInterfaceIndex, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natMappingIntAddress=natMappingIntAddress, natSessionAddrMapIndex=natSessionAddrMapIndex, natMappingRemovals=natMappingRemovals, natGroupBasicNotifications=natGroupBasicNotifications, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natMappingSubsIndex=natMappingSubsIndex, natBasicStatefulCompliance=natBasicStatefulCompliance, NatProtocolType=NatProtocolType, natMIBGroups=natMIBGroups, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natDefTimeouts=natDefTimeouts, natProtocol=natProtocol, natPoolRangeType=natPoolRangeType, natSessionMaxIdleTime=natSessionMaxIdleTime, natSessionTable=natSessionTable, natPoolObjects=natPoolObjects, natGroupStatefulObjects=natGroupStatefulObjects, natPoolRangePoolIndex=natPoolRangePoolIndex, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natProtocolInTranslates=natProtocolInTranslates, natStatsAddrMapGroup=natStatsAddrMapGroup, natCounters=natCounters, natPoolPortMin=natPoolPortMin, natCountersTable=natCountersTable, natPoolRangeEntry=natPoolRangeEntry, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natPoolWatermarkLow=natPoolWatermarkLow, NatPoolingType=NatPoolingType, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natInstanceTable=natInstanceTable, NatTranslationEntity=NatTranslationEntity, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natPoolRangeBegin=natPoolRangeBegin, natBasicStatelessCompliance=natBasicStatelessCompliance, natMappingTable=natMappingTable, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natL4ProtocolNumber=natL4ProtocolNumber, natProtocolEntry=natProtocolEntry, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, NatSessionId=NatSessionId, natGroupFragmentObjects=natGroupFragmentObjects, natSubscriberIdentifierType=natSubscriberIdentifierType, natAddrPortBindId=natAddrPortBindId, natAddrPortBindProtocol=natAddrPortBindProtocol, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natPoolWatermarkHigh=natPoolWatermarkHigh, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natInstanceEntry=natInstanceEntry, natL4ProtocolTable=natL4ProtocolTable, natAddrBindInTranslates=natAddrBindInTranslates, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natPoolRangeTable=natPoolRangeTable, natAddrMapName=natAddrMapName, natSessionInTranslates=natSessionInTranslates, natMappingExtAddressType=natMappingExtAddressType, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natLimitsEntry=natLimitsEntry, natMappingExtRealm=natMappingExtRealm, NatBindMode=NatBindMode, natAddrBindLocalAddr=natAddrBindLocalAddr, natMIBFullCompliance=natMIBFullCompliance, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natAddrMapIndex=natAddrMapIndex, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natConfigGroup=natConfigGroup, natOutOfPortErrors=natOutOfPortErrors, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natAddrPortBindTable=natAddrPortBindTable, natInstanceIndex=natInstanceIndex, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natAddrMapOutTranslates=natAddrMapOutTranslates, natL4ProtocolTranslations=natL4ProtocolTranslations, natSubscriberMappingCreations=natSubscriberMappingCreations, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natNotifMappings=natNotifMappings, natMapObjects=natMapObjects, natMIBObjects=natMIBObjects, NatBindId=NatBindId, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natMapIntAddrTable=natMapIntAddrTable, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natMapIntAddrEntry=natMapIntAddrEntry, natMIB=natMIB, natAddrBindType=natAddrBindType, natTcpDefNegTimeout=natTcpDefNegTimeout, natPoolEntry=natPoolEntry, natNotifAddrMappings=natNotifAddrMappings, natProtocolDiscards=natProtocolDiscards, natAddrPortBindType=natAddrPortBindType, natQuotaDrops=natQuotaDrops, natPoolTable=natPoolTable, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natInterfaceOutTranslates=natInterfaceOutTranslates, NatBehaviorType=NatBehaviorType, natSessionPublicDstAddr=natSessionPublicDstAddr, natPoolPortMax=natPoolPortMax, natSubscriberLimitMappings=natSubscriberLimitMappings, natSessionPrivateDstPort=natSessionPrivateDstPort, natNotifThrottlingInterval=natNotifThrottlingInterval, natMapIntAddrInt=natMapIntAddrInt, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natLimitsTable=natLimitsTable, natAddrMapInTranslates=natAddrMapInTranslates, natPoolRealm=natPoolRealm, natAddressMappingRemovals=natAddressMappingRemovals, natMIBNotificationGroup=natMIBNotificationGroup, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natAddrMapDiscards=natAddrMapDiscards, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natInterfaceDiscards=natInterfaceDiscards, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natMappingEntry=natMappingEntry, natInstanceAlias=natInstanceAlias, natStatsInterfaceGroup=natStatsInterfaceGroup, natAddrMapAddrUsed=natAddrMapAddrUsed, natTranslationGroup=natTranslationGroup, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natMappingMapBehavior=natMappingMapBehavior, natInterfaceRowStatus=natInterfaceRowStatus, natAddrMapCompliance=natAddrMapCompliance, natSubscribers=natSubscribers, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natAddrBindLocalAddrType=natAddrBindLocalAddrType, SubscriberIdentifierType=SubscriberIdentifierType, natProtocolOutTranslates=natProtocolOutTranslates, natL4ProtocolEntry=natL4ProtocolEntry, natMappingIntPort=natMappingIntPort, natAddressMappingCreations=natAddressMappingCreations, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natInterfaceEntry=natInterfaceEntry)
mibBuilder.exportSymbols("NAT-MIB", natAddrPortBindMapIndex=natAddrPortBindMapIndex, natMappingExtPort=natMappingExtPort, natPoolRangeAllocations=natPoolRangeAllocations, natAddrBindMapIndex=natAddrBindMapIndex, natSessionPrivateAddrType=natSessionPrivateAddrType)
