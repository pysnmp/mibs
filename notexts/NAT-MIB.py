...
mibBuilder.exportSymbols("NAT-MIB", natAddrPortBindMapIndex=natAddrPortBindMapIndex, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natInterfaceTable=natInterfaceTable, natAddrMapName=natAddrMapName, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natMappingExtAddress=natMappingExtAddress, natNotifSubscriberMappings=natNotifSubscriberMappings, NatBindIdOrZero=NatBindIdOrZero, natAddrMapStorageType=natAddrMapStorageType, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natMappingIntAddressType=natMappingIntAddressType, natSubscriberLimitMappings=natSubscriberLimitMappings, natSessionPublicSrcPort=natSessionPublicSrcPort, NatPoolingType=NatPoolingType, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natAddressMappingRemovals=natAddressMappingRemovals, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natGroupStatefulObjects=natGroupStatefulObjects, natTcpDefNegTimeout=natTcpDefNegTimeout, NatProtocolType=NatProtocolType, natSessionEntry=natSessionEntry, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, SubscriberIdentifierType=SubscriberIdentifierType, natMappingIntAddress=natMappingIntAddress, natSessionOutTranslates=natSessionOutTranslates, natMappingIntPort=natMappingIntPort, natMapObjects=natMapObjects, natSubscriberRealm=natSubscriberRealm, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natLimitSubscribers=natLimitSubscribers, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natPoolRangeBegin=natPoolRangeBegin, natSubscriberIntPrefix=natSubscriberIntPrefix, natBasicStatefulCompliance=natBasicStatefulCompliance, natSessionUpTime=natSessionUpTime, natLimitAddressMappings=natLimitAddressMappings, natSessionProtocolType=natSessionProtocolType, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natAddrMapIndex=natAddrMapIndex, natMappingFilterBehavior=natMappingFilterBehavior, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natMIBFullCompliance=natMIBFullCompliance, natLimitsEntry=natLimitsEntry, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natMappingProto=natMappingProto, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natInterfaceInTranslates=natInterfaceInTranslates, ProtocolNumber=ProtocolNumber, natCountersEntry=natCountersEntry, natPoolRangeAllocations=natPoolRangeAllocations, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natL4ProtocolNumber=natL4ProtocolNumber, natLimitFragments=natLimitFragments, natSubscribersTable=natSubscribersTable, natMapIntAddrEntry=natMapIntAddrEntry, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natAddrPortBindType=natAddrPortBindType, natMappingCreations=natMappingCreations, NatSessionId=NatSessionId, natProtocol=natProtocol, natSessionMaxIdleTime=natSessionMaxIdleTime, natL4ProtocolTranslations=natL4ProtocolTranslations, natGroupSubscriberObjects=natGroupSubscriberObjects, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natPoolRangePoolIndex=natPoolRangePoolIndex, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natSessionPrivateDstPort=natSessionPrivateDstPort, natPoolRangeEnd=natPoolRangeEnd, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natFragmentsCompliance=natFragmentsCompliance, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natProtocolEntry=natProtocolEntry, natAddrMapInTranslates=natAddrMapInTranslates, natCGNCompliance=natCGNCompliance, natSubscriberIndex=natSubscriberIndex, natSessionPublicDstAddr=natSessionPublicDstAddr, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natNotifCtrl=natNotifCtrl, natGroupAddrMapObjects=natGroupAddrMapObjects, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natAddrBindMapIndex=natAddrBindMapIndex, natAddrBindType=natAddrBindType, natDefTimeouts=natDefTimeouts, VlanIndexOrZero=VlanIndexOrZero, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natSessionIndex=natSessionIndex, natSessionInTranslates=natSessionInTranslates, natInterfaceRealm=natInterfaceRealm, natInstanceTable=natInstanceTable, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natMappingIntRealm=natMappingIntRealm, natMIBObjects=natMIBObjects, natSubscriberResourceErrors=natSubscriberResourceErrors, natAddrMapCompliance=natAddrMapCompliance, natMIB=natMIB, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natTranslations=natTranslations, natInterfaceRowStatus=natInterfaceRowStatus, natSessionAddrMapIndex=natSessionAddrMapIndex, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natPoolPortMax=natPoolPortMax, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natProtocolTable=natProtocolTable, natLimitsTable=natLimitsTable, natAddrBindOutTranslates=natAddrBindOutTranslates, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natQuotaDrops=natQuotaDrops, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natGroupStatelessObjects=natGroupStatelessObjects, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natSessionTable=natSessionTable, natMappingTable=natMappingTable, natCountersTable=natCountersTable, natSubscriberTranslations=natSubscriberTranslations, natPoolRangeTable=natPoolRangeTable, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natGroupFragmentObjects=natGroupFragmentObjects, NatBehaviorType=NatBehaviorType, natL4ProtocolEntry=natL4ProtocolEntry, natPoolTable=natPoolTable, NatBindId=NatBindId, natResourceErrors=natResourceErrors, natMIBCompliances=natMIBCompliances, natAddressMappingCreations=natAddressMappingCreations, natOutOfPortErrors=natOutOfPortErrors, natPoolRangeDeallocations=natPoolRangeDeallocations, NatAddrMapId=NatAddrMapId, natAddrMapTable=natAddrMapTable, natAddrBindId=natAddrBindId, natSubscribers=natSubscribers, natSessionPrivateAddrType=natSessionPrivateAddrType, natProtocolOutTranslates=natProtocolOutTranslates, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natNotifAddrMappings=natNotifAddrMappings, natMIBConformance=natMIBConformance, natMappingExtAddressType=natMappingExtAddressType, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natMappingMapBehavior=natMappingMapBehavior, natMapIntAddrIntType=natMapIntAddrIntType, natInstanceAlias=natInstanceAlias, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natSubsInterfaceIndex=natSubsInterfaceIndex, NatAssociationType=NatAssociationType, natStatsInterfaceGroup=natStatsInterfaceGroup, natPoolIndex=natPoolIndex, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natAddrBindSessions=natAddrBindSessions, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natCounters=natCounters, natTranslationGroup=natTranslationGroup, natPoolEntry=natPoolEntry, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, SubscriberIndex=SubscriberIndex, natGroupAddrMapNotifications=natGroupAddrMapNotifications, NatPoolId=NatPoolId, natAddrBindInTranslates=natAddrBindInTranslates, natMapIntAddrInt=natMapIntAddrInt, natMapIntAddrTable=natMapIntAddrTable, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natPoolRealm=natPoolRealm, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natPoolObjects=natPoolObjects, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natAddrPortBindProtocol=natAddrPortBindProtocol, natStatsProtocolGroup=natStatsProtocolGroup, natBasicStatelessCompliance=natBasicStatelessCompliance, natAddrPortBindSessions=natAddrPortBindSessions, NatBindMode=NatBindMode, natInterfaceStorageType=natInterfaceStorageType, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natInterfaceDiscards=natInterfaceDiscards, PYSNMP_MODULE_ID=natMIB, natSessionPublicDstPort=natSessionPublicDstPort, natSessionDirection=natSessionDirection, natInterfaceEntry=natInterfaceEntry, natInstanceEntry=natInstanceEntry, natAddrMapOutTranslates=natAddrMapOutTranslates, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natMIBNotificationGroup=natMIBNotificationGroup, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natPoolWatermarkHigh=natPoolWatermarkHigh, natPoolWatermarkLow=natPoolWatermarkLow, natAddrMapRowStatus=natAddrMapRowStatus, natProtocolDiscards=natProtocolDiscards, natMappingSubsIndex=natMappingSubsIndex, natMappingPool=natMappingPool, natLimitMappings=natLimitMappings, natInstanceIndex=natInstanceIndex, natAddrBindLocalAddr=natAddrBindLocalAddr, natSubscriberMappingCreations=natSubscriberMappingCreations, natMapIntAddrExt=natMapIntAddrExt, natMIBNotifications=natMIBNotifications, natStatsAddrMapGroup=natStatsAddrMapGroup, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natMappingExtRealm=natMappingExtRealm, natSubscribersEntry=natSubscribersEntry, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natAddrMapAddrUsed=natAddrMapAddrUsed, natMappingAddressPooling=natMappingAddressPooling, natNotifThrottlingInterval=natNotifThrottlingInterval, natPoolPortMin=natPoolPortMin, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natInterfaceServiceType=natInterfaceServiceType, natMappingRemovals=natMappingRemovals, NatTranslationEntity=NatTranslationEntity, natAddrMapEntry=natAddrMapEntry, natAddrPortBindId=natAddrPortBindId, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natBindDefIdleTimeout=natBindDefIdleTimeout, natAddrMapDiscards=natAddrMapDiscards, natL4ProtocolTable=natL4ProtocolTable, natMIBGroups=natMIBGroups, natNotifMappings=natNotifMappings, natAddrBindEntry=natAddrBindEntry, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natAddrPortBindEntry=natAddrPortBindEntry, natMapIntAddrExtType=natMapIntAddrExtType, natMappingExtPort=natMappingExtPort, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natSubscriberIdentifierType=natSubscriberIdentifierType, NatProtocolMap=NatProtocolMap, natAddrPortBindTable=natAddrPortBindTable, natSessionPublicAddrType=natSessionPublicAddrType, natAddrMapEntryType=natAddrMapEntryType, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natPoolRangeEntry=natPoolRangeEntry, natMappingEntry=natMappingEntry, natInterfaceOutTranslates=natInterfaceOutTranslates, natPacketDiscard=natPacketDiscard, natConfigGroup=natConfigGroup, natGroupBasicNotifications=natGroupBasicNotifications, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance)
mibBuilder.exportSymbols("NAT-MIB", natPoolRangeType=natPoolRangeType, natAddrBindTable=natAddrBindTable, natProtocolInTranslates=natProtocolInTranslates, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natAddrMapProtocol=natAddrMapProtocol)
