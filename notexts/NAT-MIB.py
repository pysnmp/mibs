...
mibBuilder.exportSymbols("NAT-MIB", natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natSubscriberIdentifierType=natSubscriberIdentifierType, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natAddrMapIndex=natAddrMapIndex, natBasicStatelessCompliance=natBasicStatelessCompliance, natCounters=natCounters, natAddressMappingRemovals=natAddressMappingRemovals, natSessionPrivateDstPort=natSessionPrivateDstPort, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natCountersTable=natCountersTable, natInstanceTable=natInstanceTable, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natMapIntAddrExt=natMapIntAddrExt, natQuotaDrops=natQuotaDrops, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natPoolRangeAllocations=natPoolRangeAllocations, natAddrPortBindEntry=natAddrPortBindEntry, natAddrMapProtocol=natAddrMapProtocol, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natInterfaceDiscards=natInterfaceDiscards, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natNotifAddrMappings=natNotifAddrMappings, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, NatBindIdOrZero=NatBindIdOrZero, natAddrPortBindSessions=natAddrPortBindSessions, natSessionProtocolType=natSessionProtocolType, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natProtocolEntry=natProtocolEntry, natPoolEntry=natPoolEntry, natAddrPortBindTable=natAddrPortBindTable, natSubsInterfaceIndex=natSubsInterfaceIndex, natMappingIntAddress=natMappingIntAddress, natMIBNotificationGroup=natMIBNotificationGroup, natMapIntAddrEntry=natMapIntAddrEntry, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natMappingExtPort=natMappingExtPort, natPoolPortMax=natPoolPortMax, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natAddrMapStorageType=natAddrMapStorageType, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natSessionInTranslates=natSessionInTranslates, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natAddrBindType=natAddrBindType, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natSubscriberIndex=natSubscriberIndex, natPacketDiscard=natPacketDiscard, natAddrBindId=natAddrBindId, NatProtocolMap=NatProtocolMap, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natSubscriberLimitMappings=natSubscriberLimitMappings, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natMIBNotifications=natMIBNotifications, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natFragmentsCompliance=natFragmentsCompliance, natAddrMapName=natAddrMapName, natProtocol=natProtocol, natAddrMapEntryType=natAddrMapEntryType, natPoolRangeType=natPoolRangeType, natSubscriberRealm=natSubscriberRealm, natLimitsEntry=natLimitsEntry, natTcpDefNegTimeout=natTcpDefNegTimeout, natCountersEntry=natCountersEntry, natSessionDirection=natSessionDirection, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natPoolObjects=natPoolObjects, natSubscriberIntPrefix=natSubscriberIntPrefix, natLimitSubscribers=natLimitSubscribers, natMappingPool=natMappingPool, natMappingIntAddressType=natMappingIntAddressType, natConfigGroup=natConfigGroup, natInterfaceInTranslates=natInterfaceInTranslates, PYSNMP_MODULE_ID=natMIB, natProtocolInTranslates=natProtocolInTranslates, natPoolRangeEntry=natPoolRangeEntry, natProtocolOutTranslates=natProtocolOutTranslates, SubscriberIdentifierType=SubscriberIdentifierType, NatBindId=NatBindId, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natGroupStatefulObjects=natGroupStatefulObjects, natMapIntAddrIntType=natMapIntAddrIntType, natAddressMappingCreations=natAddressMappingCreations, natSessionPublicDstAddr=natSessionPublicDstAddr, natMappingIntRealm=natMappingIntRealm, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natTranslationGroup=natTranslationGroup, natL4ProtocolNumber=natL4ProtocolNumber, natCGNCompliance=natCGNCompliance, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natInterfaceStorageType=natInterfaceStorageType, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natDefTimeouts=natDefTimeouts, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natL4ProtocolTable=natL4ProtocolTable, natMappingCreations=natMappingCreations, natSessionMaxIdleTime=natSessionMaxIdleTime, natSessionPublicDstPort=natSessionPublicDstPort, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natNotifMappings=natNotifMappings, natAddrMapDiscards=natAddrMapDiscards, natMIBCompliances=natMIBCompliances, natPoolWatermarkLow=natPoolWatermarkLow, natAddrBindEntry=natAddrBindEntry, natGroupBasicNotifications=natGroupBasicNotifications, natSubscribersEntry=natSubscribersEntry, natBasicStatefulCompliance=natBasicStatefulCompliance, natPoolRangeBegin=natPoolRangeBegin, natMIBConformance=natMIBConformance, natMappingFilterBehavior=natMappingFilterBehavior, natMappingIntPort=natMappingIntPort, natLimitsTable=natLimitsTable, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natGroupSubscriberObjects=natGroupSubscriberObjects, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natAddrMapOutTranslates=natAddrMapOutTranslates, natInstanceEntry=natInstanceEntry, NatSessionId=NatSessionId, natMapIntAddrExtType=natMapIntAddrExtType, natAddrMapInTranslates=natAddrMapInTranslates, NatPoolId=NatPoolId, natSessionPrivateAddrType=natSessionPrivateAddrType, natMIB=natMIB, NatAssociationType=NatAssociationType, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, NatPoolingType=NatPoolingType, natAddrBindMapIndex=natAddrBindMapIndex, natPoolPortMin=natPoolPortMin, natMappingExtAddress=natMappingExtAddress, natLimitAddressMappings=natLimitAddressMappings, NatBehaviorType=NatBehaviorType, natInterfaceEntry=natInterfaceEntry, natMappingTable=natMappingTable, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natMappingProto=natMappingProto, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natAddrMapEntry=natAddrMapEntry, natMappingEntry=natMappingEntry, natLimitMappings=natLimitMappings, ProtocolNumber=ProtocolNumber, natStatsAddrMapGroup=natStatsAddrMapGroup, natMapIntAddrInt=natMapIntAddrInt, natMappingExtAddressType=natMappingExtAddressType, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natOutOfPortErrors=natOutOfPortErrors, natMIBObjects=natMIBObjects, natInterfaceRowStatus=natInterfaceRowStatus, natAddrPortBindType=natAddrPortBindType, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natSubscriberResourceErrors=natSubscriberResourceErrors, natAddrMapCompliance=natAddrMapCompliance, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natSubscribers=natSubscribers, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natL4ProtocolEntry=natL4ProtocolEntry, natMapObjects=natMapObjects, natNotifCtrl=natNotifCtrl, natSubscriberMappingCreations=natSubscriberMappingCreations, SubscriberIndex=SubscriberIndex, natGroupStatelessObjects=natGroupStatelessObjects, natPoolIndex=natPoolIndex, natPoolRangeTable=natPoolRangeTable, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natProtocolTable=natProtocolTable, natProtocolDiscards=natProtocolDiscards, natAddrMapAddrUsed=natAddrMapAddrUsed, natMapIntAddrTable=natMapIntAddrTable, natInterfaceTable=natInterfaceTable, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natGroupFragmentObjects=natGroupFragmentObjects, natPoolRealm=natPoolRealm, natAddrBindTable=natAddrBindTable, natInstanceIndex=natInstanceIndex, natMappingRemovals=natMappingRemovals, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natAddrPortBindProtocol=natAddrPortBindProtocol, natSessionAddrMapIndex=natSessionAddrMapIndex, natAddrBindInTranslates=natAddrBindInTranslates, natGroupAddrMapObjects=natGroupAddrMapObjects, natAddrPortBindId=natAddrPortBindId, natL4ProtocolTranslations=natL4ProtocolTranslations, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natStatsProtocolGroup=natStatsProtocolGroup, natMIBFullCompliance=natMIBFullCompliance, NatTranslationEntity=NatTranslationEntity, natSessionPublicSrcPort=natSessionPublicSrcPort, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natMappingAddressPooling=natMappingAddressPooling, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natBindDefIdleTimeout=natBindDefIdleTimeout, natAddrBindLocalAddr=natAddrBindLocalAddr, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natAddrBindOutTranslates=natAddrBindOutTranslates, natInterfaceRealm=natInterfaceRealm, natSessionPublicAddrType=natSessionPublicAddrType, natMIBGroups=natMIBGroups, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natAddrBindTranslationEntity=natAddrBindTranslationEntity, NatProtocolType=NatProtocolType, natSessionEntry=natSessionEntry, natSessionOutTranslates=natSessionOutTranslates, natTranslations=natTranslations, natAddrBindSessions=natAddrBindSessions, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natStatsInterfaceGroup=natStatsInterfaceGroup, natNotifThrottlingInterval=natNotifThrottlingInterval, natPoolWatermarkHigh=natPoolWatermarkHigh, natMappingSubsIndex=natMappingSubsIndex, natPoolTable=natPoolTable, natSessionUpTime=natSessionUpTime, natPoolRangePoolIndex=natPoolRangePoolIndex, VlanIndexOrZero=VlanIndexOrZero, natMappingMapBehavior=natMappingMapBehavior, natResourceErrors=natResourceErrors, natSubscribersTable=natSubscribersTable, natAddrMapRowStatus=natAddrMapRowStatus, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natPoolRangeDeallocations=natPoolRangeDeallocations, natSubscriberTranslations=natSubscriberTranslations, natInterfaceOutTranslates=natInterfaceOutTranslates, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natPoolRangeEnd=natPoolRangeEnd, natInterfaceServiceType=natInterfaceServiceType, NatAddrMapId=NatAddrMapId, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natAddrMapTable=natAddrMapTable, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natSessionTable=natSessionTable, natLimitFragments=natLimitFragments, natSessionIndex=natSessionIndex, natMappingExtRealm=natMappingExtRealm, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, NatBindMode=NatBindMode, natNotifSubscriberMappings=natNotifSubscriberMappings)
mibBuilder.exportSymbols("NAT-MIB", natMapIntAddrExtRealm=natMapIntAddrExtRealm, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natInstanceAlias=natInstanceAlias, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance)
