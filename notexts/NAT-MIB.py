...
mibBuilder.exportSymbols("NAT-MIB", natMapIntAddrIntType=natMapIntAddrIntType, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natAddrBindLocalAddr=natAddrBindLocalAddr, natAddrPortBindType=natAddrPortBindType, natMappingPool=natMappingPool, NatTranslationEntity=NatTranslationEntity, natTcpDefNegTimeout=natTcpDefNegTimeout, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natAddrMapStorageType=natAddrMapStorageType, natSessionPrivateDstPort=natSessionPrivateDstPort, natAddrBindTable=natAddrBindTable, NatBindIdOrZero=NatBindIdOrZero, natL4ProtocolEntry=natL4ProtocolEntry, PYSNMP_MODULE_ID=natMIB, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natInterfaceRowStatus=natInterfaceRowStatus, natOutOfPortErrors=natOutOfPortErrors, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natSessionAddrMapIndex=natSessionAddrMapIndex, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natSessionMaxIdleTime=natSessionMaxIdleTime, natMapIntAddrExt=natMapIntAddrExt, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natInterfaceOutTranslates=natInterfaceOutTranslates, natLimitFragments=natLimitFragments, natSubscriberResourceErrors=natSubscriberResourceErrors, natMappingExtPort=natMappingExtPort, natL4ProtocolNumber=natL4ProtocolNumber, natLimitSubscribers=natLimitSubscribers, natInstanceAlias=natInstanceAlias, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natPoolRangeType=natPoolRangeType, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natSubscriberIndex=natSubscriberIndex, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natAddrPortBindTable=natAddrPortBindTable, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natBasicStatelessCompliance=natBasicStatelessCompliance, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natSessionUpTime=natSessionUpTime, natTranslations=natTranslations, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natSessionIndex=natSessionIndex, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natNotifMappings=natNotifMappings, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natPoolRangeEntry=natPoolRangeEntry, natSubscriberLimitMappings=natSubscriberLimitMappings, natSessionTable=natSessionTable, natPoolPortMax=natPoolPortMax, natPacketDiscard=natPacketDiscard, natInterfaceServiceType=natInterfaceServiceType, natSubscribersEntry=natSubscribersEntry, natGroupStatefulObjects=natGroupStatefulObjects, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, NatAssociationType=NatAssociationType, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natSubscriberTranslations=natSubscriberTranslations, VlanIndexOrZero=VlanIndexOrZero, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natMappingIntPort=natMappingIntPort, natMappingFilterBehavior=natMappingFilterBehavior, natMappingExtAddressType=natMappingExtAddressType, natSubscriberIntPrefix=natSubscriberIntPrefix, natAddrMapCompliance=natAddrMapCompliance, natMapIntAddrExtType=natMapIntAddrExtType, natInterfaceDiscards=natInterfaceDiscards, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natStatsInterfaceGroup=natStatsInterfaceGroup, natNotifSubscriberMappings=natNotifSubscriberMappings, natGroupFragmentObjects=natGroupFragmentObjects, natLimitMappings=natLimitMappings, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natAddrMapDiscards=natAddrMapDiscards, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natSessionInTranslates=natSessionInTranslates, natAddrBindEntry=natAddrBindEntry, natMappingTable=natMappingTable, natAddrMapEntry=natAddrMapEntry, natPoolRangeEnd=natPoolRangeEnd, natInterfaceTable=natInterfaceTable, natSubscribersTable=natSubscribersTable, natAddressMappingCreations=natAddressMappingCreations, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natAddrBindLocalAddrType=natAddrBindLocalAddrType, NatPoolingType=NatPoolingType, natProtocolTable=natProtocolTable, natSubscriberIdentifierType=natSubscriberIdentifierType, ProtocolNumber=ProtocolNumber, natMappingAddressPooling=natMappingAddressPooling, natProtocolInTranslates=natProtocolInTranslates, natMappingCreations=natMappingCreations, natSubscriberRealm=natSubscriberRealm, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natSubscriberMappingCreations=natSubscriberMappingCreations, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natSessionOutTranslates=natSessionOutTranslates, natAddrMapInTranslates=natAddrMapInTranslates, natTranslationGroup=natTranslationGroup, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natAddrPortBindProtocol=natAddrPortBindProtocol, natAddrPortBindSessions=natAddrPortBindSessions, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natMappingRemovals=natMappingRemovals, natPoolRangeTable=natPoolRangeTable, natMIBObjects=natMIBObjects, natResourceErrors=natResourceErrors, natSessionPublicSrcPort=natSessionPublicSrcPort, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natAddrMapEntryType=natAddrMapEntryType, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natAddrPortBindId=natAddrPortBindId, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natFragmentsCompliance=natFragmentsCompliance, natInterfaceStorageType=natInterfaceStorageType, natAddrBindId=natAddrBindId, natAddrPortBindEntry=natAddrPortBindEntry, natMappingExtAddress=natMappingExtAddress, natLimitAddressMappings=natLimitAddressMappings, natStatsProtocolGroup=natStatsProtocolGroup, natGroupBasicNotifications=natGroupBasicNotifications, natInstanceEntry=natInstanceEntry, natAddrMapTable=natAddrMapTable, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natPoolWatermarkLow=natPoolWatermarkLow, natMIBConformance=natMIBConformance, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natMIBNotifications=natMIBNotifications, natAddrMapAddrUsed=natAddrMapAddrUsed, natInstanceTable=natInstanceTable, natProtocolOutTranslates=natProtocolOutTranslates, natMappingSubsIndex=natMappingSubsIndex, natAddrBindMapIndex=natAddrBindMapIndex, natMIBCompliances=natMIBCompliances, natMappingExtRealm=natMappingExtRealm, natGroupStatelessObjects=natGroupStatelessObjects, natLimitsTable=natLimitsTable, natAddrBindInTranslates=natAddrBindInTranslates, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natMIBNotificationGroup=natMIBNotificationGroup, natCounters=natCounters, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natAddrBindSessions=natAddrBindSessions, natAddrBindOutTranslates=natAddrBindOutTranslates, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natPoolRangeBegin=natPoolRangeBegin, natSubscribers=natSubscribers, natCountersTable=natCountersTable, natInstanceIndex=natInstanceIndex, natMapIntAddrExtRealm=natMapIntAddrExtRealm, SubscriberIdentifierType=SubscriberIdentifierType, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natMIBFullCompliance=natMIBFullCompliance, natPoolRealm=natPoolRealm, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natCountersEntry=natCountersEntry, natLimitsEntry=natLimitsEntry, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, NatProtocolMap=NatProtocolMap, natAddrMapRowStatus=natAddrMapRowStatus, natPoolEntry=natPoolEntry, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natProtocol=natProtocol, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natBasicStatefulCompliance=natBasicStatefulCompliance, natNotifCtrl=natNotifCtrl, natAddrMapName=natAddrMapName, natPoolRangePoolIndex=natPoolRangePoolIndex, SubscriberIndex=SubscriberIndex, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natNotifThrottlingInterval=natNotifThrottlingInterval, natAddrMapOutTranslates=natAddrMapOutTranslates, natSessionProtocolType=natSessionProtocolType, natPoolTable=natPoolTable, natPoolIndex=natPoolIndex, natPoolRangeDeallocations=natPoolRangeDeallocations, natPoolPortMin=natPoolPortMin, natInterfaceInTranslates=natInterfaceInTranslates, natMappingIntRealm=natMappingIntRealm, natSessionPublicDstPort=natSessionPublicDstPort, natL4ProtocolTable=natL4ProtocolTable, natProtocolEntry=natProtocolEntry, natMappingMapBehavior=natMappingMapBehavior, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natMIB=natMIB, natGroupSubscriberObjects=natGroupSubscriberObjects, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natSessionPublicAddrType=natSessionPublicAddrType, natMappingIntAddress=natMappingIntAddress, natL4ProtocolTranslations=natL4ProtocolTranslations, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natMIBGroups=natMIBGroups, NatBindMode=NatBindMode, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natMapIntAddrEntry=natMapIntAddrEntry, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natSessionPublicDstAddr=natSessionPublicDstAddr, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natMappingProto=natMappingProto, natAddrMapIndex=natAddrMapIndex, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natAddrBindType=natAddrBindType, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natQuotaDrops=natQuotaDrops, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natAddrMapProtocol=natAddrMapProtocol, natSessionPrivateAddrType=natSessionPrivateAddrType, natProtocolDiscards=natProtocolDiscards, natMappingEntry=natMappingEntry, natMappingIntAddressType=natMappingIntAddressType, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, NatProtocolType=NatProtocolType, NatBehaviorType=NatBehaviorType, natMapIntAddrInt=natMapIntAddrInt, natStatsAddrMapGroup=natStatsAddrMapGroup, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natPoolObjects=natPoolObjects, natPoolWatermarkHigh=natPoolWatermarkHigh, natInterfaceEntry=natInterfaceEntry, natPoolRangeAllocations=natPoolRangeAllocations, natDefTimeouts=natDefTimeouts, natSessionEntry=natSessionEntry, natConfigGroup=natConfigGroup, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, NatPoolId=NatPoolId, natMapIntAddrTable=natMapIntAddrTable, natSubsInterfaceIndex=natSubsInterfaceIndex, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natGroupAddrMapObjects=natGroupAddrMapObjects, natAddrPortBindMapIndex=natAddrPortBindMapIndex, NatAddrMapId=NatAddrMapId, natMapObjects=natMapObjects, natAddressMappingRemovals=natAddressMappingRemovals, natSessionDirection=natSessionDirection, natNotifAddrMappings=natNotifAddrMappings, natBindDefIdleTimeout=natBindDefIdleTimeout, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo)
mibBuilder.exportSymbols("NAT-MIB", NatSessionId=NatSessionId, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, NatBindId=NatBindId, natCGNCompliance=natCGNCompliance, natInterfaceRealm=natInterfaceRealm)
