...
mibBuilder.exportSymbols("NAT-MIB", natSubscriberTranslations=natSubscriberTranslations, natAddrBindSessions=natAddrBindSessions, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natSubscriberIntPrefix=natSubscriberIntPrefix, natInstanceTable=natInstanceTable, natInterfaceEntry=natInterfaceEntry, natInterfaceOutTranslates=natInterfaceOutTranslates, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natSubscriberMappingCreations=natSubscriberMappingCreations, natMappingCreations=natMappingCreations, natAddrMapInTranslates=natAddrMapInTranslates, natLimitsTable=natLimitsTable, natStatsProtocolGroup=natStatsProtocolGroup, natNotifMappings=natNotifMappings, natPoolIndex=natPoolIndex, natPacketDiscard=natPacketDiscard, natNotifThrottlingInterval=natNotifThrottlingInterval, natMapObjects=natMapObjects, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natAddrMapOutTranslates=natAddrMapOutTranslates, natPoolEntry=natPoolEntry, natMappingExtPort=natMappingExtPort, natSessionAddrMapIndex=natSessionAddrMapIndex, natAddrBindInTranslates=natAddrBindInTranslates, natPoolTable=natPoolTable, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natPoolRangeBegin=natPoolRangeBegin, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natPoolRangeType=natPoolRangeType, natGroupFragmentObjects=natGroupFragmentObjects, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natL4ProtocolTable=natL4ProtocolTable, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natMappingAddressPooling=natMappingAddressPooling, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natAddrMapDiscards=natAddrMapDiscards, natPoolWatermarkHigh=natPoolWatermarkHigh, natAddressMappingCreations=natAddressMappingCreations, natAddrPortBindSessions=natAddrPortBindSessions, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natSubscribers=natSubscribers, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natAddrMapRowStatus=natAddrMapRowStatus, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natPoolRangeEntry=natPoolRangeEntry, natSubscriberIndex=natSubscriberIndex, natAddrMapEntry=natAddrMapEntry, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natResourceErrors=natResourceErrors, natInterfaceRealm=natInterfaceRealm, natSessionPublicDstAddr=natSessionPublicDstAddr, natMappingMapBehavior=natMappingMapBehavior, natMapIntAddrIntType=natMapIntAddrIntType, natBindDefIdleTimeout=natBindDefIdleTimeout, natInterfaceDiscards=natInterfaceDiscards, natCounters=natCounters, natMIBObjects=natMIBObjects, natSessionPublicDstPort=natSessionPublicDstPort, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natSessionEntry=natSessionEntry, natMIBGroups=natMIBGroups, natPoolRangeAllocations=natPoolRangeAllocations, natProtocolTable=natProtocolTable, natTcpDefNegTimeout=natTcpDefNegTimeout, natAddrBindLocalAddr=natAddrBindLocalAddr, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natSessionTable=natSessionTable, natSessionPrivateDstPort=natSessionPrivateDstPort, natAddrPortBindType=natAddrPortBindType, natAddrPortBindEntry=natAddrPortBindEntry, natAddrMapTable=natAddrMapTable, natInterfaceRowStatus=natInterfaceRowStatus, NatProtocolType=NatProtocolType, ProtocolNumber=ProtocolNumber, natSubscriberResourceErrors=natSubscriberResourceErrors, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natMappingIntAddress=natMappingIntAddress, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, NatAddrMapId=NatAddrMapId, natAddrMapEntryType=natAddrMapEntryType, natStatsInterfaceGroup=natStatsInterfaceGroup, natSessionPrivateAddrType=natSessionPrivateAddrType, natSessionProtocolType=natSessionProtocolType, natPoolRangeDeallocations=natPoolRangeDeallocations, natBasicStatefulCompliance=natBasicStatefulCompliance, natGroupSubscriberNotifications=natGroupSubscriberNotifications, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natOutOfPortErrors=natOutOfPortErrors, natMappingIntPort=natMappingIntPort, natPoolPortMax=natPoolPortMax, NatBehaviorType=NatBehaviorType, natLimitFragments=natLimitFragments, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natProtocolOutTranslates=natProtocolOutTranslates, natPoolRangeEnd=natPoolRangeEnd, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natConfigGroup=natConfigGroup, natTranslations=natTranslations, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natNotifSubscriberMappings=natNotifSubscriberMappings, natSessionIndex=natSessionIndex, natAddrMapStorageType=natAddrMapStorageType, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natSessionInTranslates=natSessionInTranslates, natMIBConformance=natMIBConformance, natAddrPortBindProtocol=natAddrPortBindProtocol, natLimitAddressMappings=natLimitAddressMappings, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natAddrMapIndex=natAddrMapIndex, natQuotaDrops=natQuotaDrops, natTranslationGroup=natTranslationGroup, natAddrMapProtocol=natAddrMapProtocol, NatPoolingType=NatPoolingType, natSubscriberRealm=natSubscriberRealm, natFragmentsCompliance=natFragmentsCompliance, natOtherDefIdleTimeout=natOtherDefIdleTimeout, NatProtocolMap=NatProtocolMap, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natCountersTable=natCountersTable, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natInterfaceInTranslates=natInterfaceInTranslates, natMIB=natMIB, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natAddrBindType=natAddrBindType, natPoolObjects=natPoolObjects, natSessionPublicSrcPort=natSessionPublicSrcPort, natAddrPortBindId=natAddrPortBindId, natDefTimeouts=natDefTimeouts, natPoolPortMin=natPoolPortMin, natNotifCtrl=natNotifCtrl, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, NatBindIdOrZero=NatBindIdOrZero, natGroupStatefulObjects=natGroupStatefulObjects, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natProtocol=natProtocol, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natGroupStatelessObjects=natGroupStatelessObjects, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natSessionMaxIdleTime=natSessionMaxIdleTime, natAddrBindOutTranslates=natAddrBindOutTranslates, natSessionDirection=natSessionDirection, natMappingRemovals=natMappingRemovals, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natBasicStatelessCompliance=natBasicStatelessCompliance, natMappingFilterBehavior=natMappingFilterBehavior, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natInstanceEntry=natInstanceEntry, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natCGNCompliance=natCGNCompliance, natProtocolInTranslates=natProtocolInTranslates, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natMappingSubsIndex=natMappingSubsIndex, natL4ProtocolNumber=natL4ProtocolNumber, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natMapIntAddrInt=natMapIntAddrInt, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natAddrMapAddrUsed=natAddrMapAddrUsed, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natMappingEntry=natMappingEntry, natMappingProto=natMappingProto, PYSNMP_MODULE_ID=natMIB, natMIBCompliances=natMIBCompliances, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natMIBNotificationGroup=natMIBNotificationGroup, natMappingPool=natMappingPool, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natSubscriberIdentifierType=natSubscriberIdentifierType, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natPoolRangeTable=natPoolRangeTable, natAddrBindTable=natAddrBindTable, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natL4ProtocolTranslations=natL4ProtocolTranslations, natPoolRangePoolIndex=natPoolRangePoolIndex, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natNotifAddrMappings=natNotifAddrMappings, natMappingIntRealm=natMappingIntRealm, NatBindId=NatBindId, natProtocolEntry=natProtocolEntry, VlanIndexOrZero=VlanIndexOrZero, natPoolRealm=natPoolRealm, NatSessionId=NatSessionId, natSessionUpTime=natSessionUpTime, natPoolWatermarkLow=natPoolWatermarkLow, natAddrBindMapIndex=natAddrBindMapIndex, natAddrPortBindTable=natAddrPortBindTable, natSubscriberLimitMappings=natSubscriberLimitMappings, SubscriberIdentifierType=SubscriberIdentifierType, natInterfaceTable=natInterfaceTable, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natMapIntAddrExtType=natMapIntAddrExtType, natAddressMappingRemovals=natAddressMappingRemovals, natMappingIntAddressType=natMappingIntAddressType, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natMappingExtAddress=natMappingExtAddress, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, SubscriberIndex=SubscriberIndex, natInstanceIndex=natInstanceIndex, natInterfaceServiceType=natInterfaceServiceType, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natCountersEntry=natCountersEntry, natL4ProtocolEntry=natL4ProtocolEntry, natLimitMappings=natLimitMappings, natSubscribersEntry=natSubscribersEntry, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, NatTranslationEntity=NatTranslationEntity, natMapIntAddrEntry=natMapIntAddrEntry, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natAddrMapCompliance=natAddrMapCompliance, natMapIntAddrTable=natMapIntAddrTable, natSessionPublicAddrType=natSessionPublicAddrType, natMappingExtAddressType=natMappingExtAddressType, natMIBFullCompliance=natMIBFullCompliance, natMIBNotifications=natMIBNotifications, NatBindMode=NatBindMode, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natInstanceAlias=natInstanceAlias, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natGroupAddrMapObjects=natGroupAddrMapObjects, natSubscribersTable=natSubscribersTable, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, NatPoolId=NatPoolId, natMappingExtRealm=natMappingExtRealm, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natLimitsEntry=natLimitsEntry, NatAssociationType=NatAssociationType, natGroupBasicNotifications=natGroupBasicNotifications, natProtocolDiscards=natProtocolDiscards, natAddrBindId=natAddrBindId, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natStatsAddrMapGroup=natStatsAddrMapGroup, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natInterfaceStorageType=natInterfaceStorageType, natAddrBindEntry=natAddrBindEntry, natLimitSubscribers=natLimitSubscribers, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natMapIntAddrExt=natMapIntAddrExt, natSubsInterfaceIndex=natSubsInterfaceIndex)
mibBuilder.exportSymbols("NAT-MIB", natMappingTable=natMappingTable, natGroupSubscriberObjects=natGroupSubscriberObjects, natSessionOutTranslates=natSessionOutTranslates, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natAddrMapName=natAddrMapName)
