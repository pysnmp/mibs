...
mibBuilder.exportSymbols("NAT-MIB", natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natPoolRangeEnd=natPoolRangeEnd, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natGroupStatefulObjects=natGroupStatefulObjects, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natLimitFragments=natLimitFragments, NatAssociationType=NatAssociationType, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natSessionPublicDstAddr=natSessionPublicDstAddr, NatPoolId=NatPoolId, natMIBNotifications=natMIBNotifications, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natPacketDiscard=natPacketDiscard, natMIB=natMIB, natAddrMapRowStatus=natAddrMapRowStatus, natAddrBindOutTranslates=natAddrBindOutTranslates, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natSubscribers=natSubscribers, natPoolPortMax=natPoolPortMax, natMappingRemovals=natMappingRemovals, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natSessionPublicDstPort=natSessionPublicDstPort, natAddrBindInTranslates=natAddrBindInTranslates, natPoolRangeBegin=natPoolRangeBegin, natStatsInterfaceGroup=natStatsInterfaceGroup, natGroupFragmentObjects=natGroupFragmentObjects, natNotifMappings=natNotifMappings, natAddrBindType=natAddrBindType, ProtocolNumber=ProtocolNumber, natProtocolTable=natProtocolTable, natMappingExtRealm=natMappingExtRealm, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natNotifThrottlingInterval=natNotifThrottlingInterval, natAddrPortBindType=natAddrPortBindType, natSubscriberTranslations=natSubscriberTranslations, natPoolRangeEntry=natPoolRangeEntry, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natInterfaceStorageType=natInterfaceStorageType, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natSessionTable=natSessionTable, natInstanceTable=natInstanceTable, natMappingAddressPooling=natMappingAddressPooling, natMIBNotificationGroup=natMIBNotificationGroup, natGroupSubscriberObjects=natGroupSubscriberObjects, natAddrMapCompliance=natAddrMapCompliance, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natSubscriberMappingCreations=natSubscriberMappingCreations, natInterfaceOutTranslates=natInterfaceOutTranslates, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natAddrMapName=natAddrMapName, natResourceErrors=natResourceErrors, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natMappingCreations=natMappingCreations, natSessionAddrMapIndex=natSessionAddrMapIndex, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natMapIntAddrInt=natMapIntAddrInt, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natGroupAddrMapObjects=natGroupAddrMapObjects, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natAddrMapIndex=natAddrMapIndex, NatBehaviorType=NatBehaviorType, natMapIntAddrExt=natMapIntAddrExt, natSubscriberResourceErrors=natSubscriberResourceErrors, NatPoolingType=NatPoolingType, natLimitsEntry=natLimitsEntry, natMappingProto=natMappingProto, natPoolEntry=natPoolEntry, natDefTimeouts=natDefTimeouts, natAddrBindEntry=natAddrBindEntry, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natMapIntAddrEntry=natMapIntAddrEntry, natMappingMapBehavior=natMappingMapBehavior, natStatsAddrMapGroup=natStatsAddrMapGroup, natCGNCompliance=natCGNCompliance, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natLimitSubscribers=natLimitSubscribers, natInterfaceEntry=natInterfaceEntry, natLimitAddressMappings=natLimitAddressMappings, natAddrBindTable=natAddrBindTable, NatBindMode=NatBindMode, natMapIntAddrExtType=natMapIntAddrExtType, natMappingSubsIndex=natMappingSubsIndex, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natInstanceAlias=natInstanceAlias, natPoolRangePoolIndex=natPoolRangePoolIndex, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natMappingPool=natMappingPool, natSubscriberRealm=natSubscriberRealm, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natMappingIntAddress=natMappingIntAddress, natMIBObjects=natMIBObjects, natBasicStatelessCompliance=natBasicStatelessCompliance, natInstanceEntry=natInstanceEntry, natInterfaceInTranslates=natInterfaceInTranslates, natSubscriberLimitMappings=natSubscriberLimitMappings, natProtocolOutTranslates=natProtocolOutTranslates, natInterfaceServiceType=natInterfaceServiceType, natAddrMapTable=natAddrMapTable, NatTranslationEntity=NatTranslationEntity, natMappingIntAddressType=natMappingIntAddressType, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natSessionPrivateAddrType=natSessionPrivateAddrType, natInterfaceRowStatus=natInterfaceRowStatus, NatBindIdOrZero=NatBindIdOrZero, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natAddrMapOutTranslates=natAddrMapOutTranslates, NatSessionId=NatSessionId, natSessionPublicSrcPort=natSessionPublicSrcPort, natAddrPortBindTable=natAddrPortBindTable, natSessionInTranslates=natSessionInTranslates, natOutOfPortErrors=natOutOfPortErrors, natCountersTable=natCountersTable, natPoolRangeDeallocations=natPoolRangeDeallocations, NatProtocolType=NatProtocolType, natMIBCompliances=natMIBCompliances, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natStatsProtocolGroup=natStatsProtocolGroup, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natProtocolEntry=natProtocolEntry, natL4ProtocolNumber=natL4ProtocolNumber, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natConfigGroup=natConfigGroup, natBasicStatefulCompliance=natBasicStatefulCompliance, natMappingIntPort=natMappingIntPort, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natInterfaceRealm=natInterfaceRealm, natPoolWatermarkLow=natPoolWatermarkLow, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natSessionMaxIdleTime=natSessionMaxIdleTime, natPoolObjects=natPoolObjects, natTcpDefNegTimeout=natTcpDefNegTimeout, SubscriberIdentifierType=SubscriberIdentifierType, natPoolPortMin=natPoolPortMin, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natMappingEntry=natMappingEntry, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natSubscribersEntry=natSubscribersEntry, natSubscriberIntPrefix=natSubscriberIntPrefix, natSessionEntry=natSessionEntry, natAddrMapAddrUsed=natAddrMapAddrUsed, SubscriberIndex=SubscriberIndex, natL4ProtocolEntry=natL4ProtocolEntry, natLimitsTable=natLimitsTable, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natMapIntAddrIntType=natMapIntAddrIntType, natL4ProtocolTable=natL4ProtocolTable, natGroupStatelessObjects=natGroupStatelessObjects, natGroupBasicNotifications=natGroupBasicNotifications, natInterfaceDiscards=natInterfaceDiscards, natSessionPrivateDstPort=natSessionPrivateDstPort, natSessionOutTranslates=natSessionOutTranslates, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natAddrBindSessions=natAddrBindSessions, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natProtocol=natProtocol, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natSubscriberIdentifierType=natSubscriberIdentifierType, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natAddrPortBindInTranslates=natAddrPortBindInTranslates, NatAddrMapId=NatAddrMapId, natLimitMappings=natLimitMappings, natNotifSubscriberMappings=natNotifSubscriberMappings, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natFragmentsCompliance=natFragmentsCompliance, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natPoolRangeAllocations=natPoolRangeAllocations, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, NatProtocolMap=NatProtocolMap, natAddrMapInTranslates=natAddrMapInTranslates, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natSessionProtocolType=natSessionProtocolType, natProtocolDiscards=natProtocolDiscards, natMIBConformance=natMIBConformance, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natSessionUpTime=natSessionUpTime, natSessionPublicAddrType=natSessionPublicAddrType, natInterfaceTable=natInterfaceTable, natAddrBindLocalAddr=natAddrBindLocalAddr, natTranslationGroup=natTranslationGroup, natAddrMapEntryType=natAddrMapEntryType, natQuotaDrops=natQuotaDrops, natPoolRangeTable=natPoolRangeTable, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natSessionPrivateDstAddr=natSessionPrivateDstAddr, PYSNMP_MODULE_ID=natMIB, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natNotifAddrMappings=natNotifAddrMappings, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natAddrMapStorageType=natAddrMapStorageType, natPoolIndex=natPoolIndex, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natMappingExtPort=natMappingExtPort, natMapIntAddrTable=natMapIntAddrTable, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natAddrBindId=natAddrBindId, natSubsInterfaceIndex=natSubsInterfaceIndex, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natTranslations=natTranslations, VlanIndexOrZero=VlanIndexOrZero, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natNotifCtrl=natNotifCtrl, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natAddrMapDiscards=natAddrMapDiscards, natAddrMapEntry=natAddrMapEntry, natSessionDirection=natSessionDirection, natMIBFullCompliance=natMIBFullCompliance, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natBindDefIdleTimeout=natBindDefIdleTimeout, natPoolRealm=natPoolRealm, natSubscriberIndex=natSubscriberIndex, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natAddressMappingCreations=natAddressMappingCreations, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natAddrPortBindId=natAddrPortBindId, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natMappingFilterBehavior=natMappingFilterBehavior, natInstanceIndex=natInstanceIndex, natAddressMappingRemovals=natAddressMappingRemovals, natAddrPortBindProtocol=natAddrPortBindProtocol, natPoolRangeType=natPoolRangeType, natMIBGroups=natMIBGroups, natSessionIndex=natSessionIndex, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natCountersEntry=natCountersEntry, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natAddrBindMapIndex=natAddrBindMapIndex, natMapObjects=natMapObjects, natSubscribersTable=natSubscribersTable, natAddrPortBindEntry=natAddrPortBindEntry, natAddrMapProtocol=natAddrMapProtocol, natPoolWatermarkHigh=natPoolWatermarkHigh, natMappingExtAddress=natMappingExtAddress, natMappingTable=natMappingTable, natProtocolInTranslates=natProtocolInTranslates, natAddrPortBindSessions=natAddrPortBindSessions, natMappingIntRealm=natMappingIntRealm, NatBindId=NatBindId, natMappingExtAddressType=natMappingExtAddressType)
mibBuilder.exportSymbols("NAT-MIB", natPoolTable=natPoolTable, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natCounters=natCounters, natL4ProtocolTranslations=natL4ProtocolTranslations, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom)
