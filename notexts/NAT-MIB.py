...
mibBuilder.exportSymbols("NAT-MIB", natAddressMappingCreations=natAddressMappingCreations, natInterfaceDiscards=natInterfaceDiscards, natMappingIntAddressType=natMappingIntAddressType, natSubscriberIndex=natSubscriberIndex, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natMappingTable=natMappingTable, natMappingPool=natMappingPool, natAddrBindInTranslates=natAddrBindInTranslates, natConfigGroup=natConfigGroup, natNotifSubscriberMappings=natNotifSubscriberMappings, natMIBFullCompliance=natMIBFullCompliance, natAddrMapStorageType=natAddrMapStorageType, natSessionPrivateDstPort=natSessionPrivateDstPort, natMapObjects=natMapObjects, natAddrPortBindTable=natAddrPortBindTable, natMappingCreations=natMappingCreations, natSessionAddrMapIndex=natSessionAddrMapIndex, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natMappingAddressPooling=natMappingAddressPooling, natCountersEntry=natCountersEntry, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natAddrPortBindId=natAddrPortBindId, natMappingIntPort=natMappingIntPort, natAddrBindEntry=natAddrBindEntry, natTcpDefNegTimeout=natTcpDefNegTimeout, natMIBNotificationGroup=natMIBNotificationGroup, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natAddrBindType=natAddrBindType, natSubscribersTable=natSubscribersTable, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natLimitMappings=natLimitMappings, natMappingExtAddressType=natMappingExtAddressType, natSubscriberResourceErrors=natSubscriberResourceErrors, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natAddrMapDiscards=natAddrMapDiscards, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natBindDefIdleTimeout=natBindDefIdleTimeout, natAddrPortBindProtocol=natAddrPortBindProtocol, natMapIntAddrTable=natMapIntAddrTable, natPoolWatermarkLow=natPoolWatermarkLow, NatTranslationEntity=NatTranslationEntity, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natPoolWatermarkHigh=natPoolWatermarkHigh, natInstanceAlias=natInstanceAlias, natNotifMappings=natNotifMappings, natPoolTable=natPoolTable, NatBindMode=NatBindMode, natMapIntAddrExtType=natMapIntAddrExtType, NatAddrMapId=NatAddrMapId, natSubsInterfaceIndex=natSubsInterfaceIndex, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natPoolRangeAllocations=natPoolRangeAllocations, natMapIntAddrEntry=natMapIntAddrEntry, natSubscribers=natSubscribers, natSubscriberTranslations=natSubscriberTranslations, NatPoolId=NatPoolId, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, NatProtocolMap=NatProtocolMap, natAddrMapOutTranslates=natAddrMapOutTranslates, natAddrMapTable=natAddrMapTable, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natPoolPortMax=natPoolPortMax, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natInterfaceInTranslates=natInterfaceInTranslates, natQuotaDrops=natQuotaDrops, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natTranslationGroup=natTranslationGroup, natNotifAddrMappings=natNotifAddrMappings, natL4ProtocolNumber=natL4ProtocolNumber, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natL4ProtocolTranslations=natL4ProtocolTranslations, natMappingMapBehavior=natMappingMapBehavior, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natProtocolOutTranslates=natProtocolOutTranslates, natStatsInterfaceGroup=natStatsInterfaceGroup, natInterfaceTable=natInterfaceTable, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natAddrBindOutTranslates=natAddrBindOutTranslates, natSessionPublicSrcPort=natSessionPublicSrcPort, natMIBConformance=natMIBConformance, natSubscriberIntPrefix=natSubscriberIntPrefix, natSubscribersEntry=natSubscribersEntry, natPoolEntry=natPoolEntry, natGroupSubscriberObjects=natGroupSubscriberObjects, natAddrBindLocalAddr=natAddrBindLocalAddr, natMIB=natMIB, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natAddrPortBindSessions=natAddrPortBindSessions, natSessionOutTranslates=natSessionOutTranslates, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natBasicStatelessCompliance=natBasicStatelessCompliance, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natSubscriberQuotaDrops=natSubscriberQuotaDrops, NatBindId=NatBindId, natInterfaceStorageType=natInterfaceStorageType, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natSessionProtocolType=natSessionProtocolType, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natAddrMapRowStatus=natAddrMapRowStatus, natOutOfPortErrors=natOutOfPortErrors, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natLimitsTable=natLimitsTable, ProtocolNumber=ProtocolNumber, natPoolPortMin=natPoolPortMin, natInterfaceRowStatus=natInterfaceRowStatus, NatPoolingType=NatPoolingType, natNotifThrottlingInterval=natNotifThrottlingInterval, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natFragmentsCompliance=natFragmentsCompliance, natSessionUpTime=natSessionUpTime, natInterfaceServiceType=natInterfaceServiceType, natStatsAddrMapGroup=natStatsAddrMapGroup, natAddrBindSessions=natAddrBindSessions, natSessionDirection=natSessionDirection, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natProtocol=natProtocol, natNotifCtrl=natNotifCtrl, natPoolRangeTable=natPoolRangeTable, natCounters=natCounters, natSessionPublicAddrType=natSessionPublicAddrType, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, SubscriberIdentifierType=SubscriberIdentifierType, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natSessionPublicDstAddr=natSessionPublicDstAddr, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natAddrPortBindType=natAddrPortBindType, natStatsProtocolGroup=natStatsProtocolGroup, natMIBCompliances=natMIBCompliances, natMappingRemovals=natMappingRemovals, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natInterfaceRealm=natInterfaceRealm, natMIBGroups=natMIBGroups, natSessionTable=natSessionTable, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, NatBindIdOrZero=NatBindIdOrZero, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natProtocolDiscards=natProtocolDiscards, natLimitsEntry=natLimitsEntry, natSubscriberLimitMappings=natSubscriberLimitMappings, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natL4ProtocolTable=natL4ProtocolTable, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natAddrMapCompliance=natAddrMapCompliance, natResourceErrors=natResourceErrors, natProtocolTable=natProtocolTable, NatBehaviorType=NatBehaviorType, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natPacketDiscard=natPacketDiscard, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natSessionEntry=natSessionEntry, natAddrMapEntry=natAddrMapEntry, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natAddrMapProtocol=natAddrMapProtocol, natAddrBindMapIndex=natAddrBindMapIndex, natProtocolEntry=natProtocolEntry, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natAddrMapEntryType=natAddrMapEntryType, natPoolIndex=natPoolIndex, natMappingIntAddress=natMappingIntAddress, natSubscriberRealm=natSubscriberRealm, natInterfaceOutTranslates=natInterfaceOutTranslates, natAddrMapIndex=natAddrMapIndex, natGroupAddrMapObjects=natGroupAddrMapObjects, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natSubscriberIdentifierType=natSubscriberIdentifierType, VlanIndexOrZero=VlanIndexOrZero, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natPoolObjects=natPoolObjects, natPoolRangeDeallocations=natPoolRangeDeallocations, natMappingFilterBehavior=natMappingFilterBehavior, natPoolRangeEnd=natPoolRangeEnd, natPoolRangeEntry=natPoolRangeEntry, natMappingSubsIndex=natMappingSubsIndex, natMapIntAddrIntType=natMapIntAddrIntType, natSessionInTranslates=natSessionInTranslates, natSessionPublicDstPort=natSessionPublicDstPort, natAddrBindId=natAddrBindId, natMappingEntry=natMappingEntry, natLimitSubscribers=natLimitSubscribers, natAddrBindTable=natAddrBindTable, NatProtocolType=NatProtocolType, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natAddressMappingRemovals=natAddressMappingRemovals, natMIBObjects=natMIBObjects, natL4ProtocolEntry=natL4ProtocolEntry, natSessionPrivateAddrType=natSessionPrivateAddrType, natMIBNotifications=natMIBNotifications, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, PYSNMP_MODULE_ID=natMIB, natMappingExtRealm=natMappingExtRealm, natMappingProto=natMappingProto, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natMappingExtPort=natMappingExtPort, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natInstanceTable=natInstanceTable, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, SubscriberIndex=SubscriberIndex, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natCGNCompliance=natCGNCompliance, natMappingIntRealm=natMappingIntRealm, natSessionMaxIdleTime=natSessionMaxIdleTime, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natDefTimeouts=natDefTimeouts, natTranslations=natTranslations, NatAssociationType=NatAssociationType, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natAddrBindGlobalAddr=natAddrBindGlobalAddr, NatSessionId=NatSessionId, natAddrMapName=natAddrMapName, natGroupBasicNotifications=natGroupBasicNotifications, natGroupStatefulObjects=natGroupStatefulObjects, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natAddrPortBindEntry=natAddrPortBindEntry, natMapIntAddrInt=natMapIntAddrInt, natInstanceIndex=natInstanceIndex, natGroupFragmentObjects=natGroupFragmentObjects, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natMapIntAddrExt=natMapIntAddrExt, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natAddrMapAddrUsed=natAddrMapAddrUsed, natAddrMapInTranslates=natAddrMapInTranslates, natLimitFragments=natLimitFragments, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natInstanceEntry=natInstanceEntry, natPoolRangePoolIndex=natPoolRangePoolIndex, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natProtocolInTranslates=natProtocolInTranslates, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natBasicStatefulCompliance=natBasicStatefulCompliance, natPoolRangeBegin=natPoolRangeBegin, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natPoolRangeType=natPoolRangeType, natLimitAddressMappings=natLimitAddressMappings, natMappingExtAddress=natMappingExtAddress, natInterfaceEntry=natInterfaceEntry, natCountersTable=natCountersTable)
mibBuilder.exportSymbols("NAT-MIB", natPoolRealm=natPoolRealm, natSubscriberMappingCreations=natSubscriberMappingCreations, natGroupStatelessObjects=natGroupStatelessObjects, natSessionIndex=natSessionIndex, natSessionPrivateSrcPort=natSessionPrivateSrcPort)
