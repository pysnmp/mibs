...
mibBuilder.exportSymbols("NAT-MIB", NatPoolId=NatPoolId, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, NatProtocolMap=NatProtocolMap, natAddressMappingCreations=natAddressMappingCreations, natMappingIntPort=natMappingIntPort, natAddrMapStorageType=natAddrMapStorageType, natCountersEntry=natCountersEntry, natMappingFilterBehavior=natMappingFilterBehavior, natSubscriberIndex=natSubscriberIndex, natMappingIntRealm=natMappingIntRealm, natQuotaDrops=natQuotaDrops, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natMappingIntAddressType=natMappingIntAddressType, natMapIntAddrEntry=natMapIntAddrEntry, natAddrPortBindSessions=natAddrPortBindSessions, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natMapIntAddrIntType=natMapIntAddrIntType, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natInstanceEntry=natInstanceEntry, natInterfaceServiceType=natInterfaceServiceType, natInterfaceEntry=natInterfaceEntry, NatAddrMapId=NatAddrMapId, natAddrMapEntry=natAddrMapEntry, natAddrBindType=natAddrBindType, natAddrBindMapIndex=natAddrBindMapIndex, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natPoolWatermarkLow=natPoolWatermarkLow, natAddrPortBindId=natAddrPortBindId, natAddrPortBindEntry=natAddrPortBindEntry, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natSessionTable=natSessionTable, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natMIBConformance=natMIBConformance, natSubscriberLimitMappings=natSubscriberLimitMappings, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natGroupStatefulObjects=natGroupStatefulObjects, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natMIBGroups=natMIBGroups, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natPoolRangeTable=natPoolRangeTable, natMapIntAddrExtType=natMapIntAddrExtType, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natInstanceIndex=natInstanceIndex, natTcpDefNegTimeout=natTcpDefNegTimeout, natStatsAddrMapGroup=natStatsAddrMapGroup, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natSessionPublicDstPort=natSessionPublicDstPort, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natMappingPool=natMappingPool, natCGNCompliance=natCGNCompliance, natAddrMapOutTranslates=natAddrMapOutTranslates, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natPoolTable=natPoolTable, natAddrBindSessions=natAddrBindSessions, natMIB=natMIB, NatPoolingType=NatPoolingType, natMappingRemovals=natMappingRemovals, natInterfaceInTranslates=natInterfaceInTranslates, natCounters=natCounters, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natAddrBindLocalAddr=natAddrBindLocalAddr, natMappingTable=natMappingTable, natResourceErrors=natResourceErrors, natGroupFragmentObjects=natGroupFragmentObjects, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natInterfaceRowStatus=natInterfaceRowStatus, natMappingIntAddress=natMappingIntAddress, natL4ProtocolNumber=natL4ProtocolNumber, natTranslations=natTranslations, natL4ProtocolTranslations=natL4ProtocolTranslations, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natNotifSubscriberMappings=natNotifSubscriberMappings, PYSNMP_MODULE_ID=natMIB, natInterfaceOutTranslates=natInterfaceOutTranslates, natAddrMapAddrUsed=natAddrMapAddrUsed, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natMIBFullCompliance=natMIBFullCompliance, natProtocolOutTranslates=natProtocolOutTranslates, natMIBObjects=natMIBObjects, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natMIBNotificationGroup=natMIBNotificationGroup, natUdpDefIdleTimeout=natUdpDefIdleTimeout, NatBindId=NatBindId, SubscriberIndex=SubscriberIndex, natSessionEntry=natSessionEntry, natMapIntAddrExt=natMapIntAddrExt, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natMappingExtAddress=natMappingExtAddress, natCountersTable=natCountersTable, natSubscribersTable=natSubscribersTable, natDefTimeouts=natDefTimeouts, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natSessionUpTime=natSessionUpTime, natAddrPortBindType=natAddrPortBindType, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natMapObjects=natMapObjects, natMappingSubsIndex=natMappingSubsIndex, natFragmentsCompliance=natFragmentsCompliance, NatBindIdOrZero=NatBindIdOrZero, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natNotifAddrMappings=natNotifAddrMappings, natLimitsTable=natLimitsTable, natInstanceTable=natInstanceTable, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natSessionPublicAddrType=natSessionPublicAddrType, natL4ProtocolEntry=natL4ProtocolEntry, natPoolPortMin=natPoolPortMin, natPoolRangeEnd=natPoolRangeEnd, natSessionIndex=natSessionIndex, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natSessionPrivateDstPort=natSessionPrivateDstPort, natProtocol=natProtocol, natMapIntAddrInt=natMapIntAddrInt, natSubscriberMappingCreations=natSubscriberMappingCreations, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natNotifCtrl=natNotifCtrl, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natSessionPublicSrcPort=natSessionPublicSrcPort, natBindDefIdleTimeout=natBindDefIdleTimeout, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natNotifMappings=natNotifMappings, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natAddrMapIndex=natAddrMapIndex, natSubscriberTranslations=natSubscriberTranslations, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natTcpDefIdleTimeout=natTcpDefIdleTimeout, NatAssociationType=NatAssociationType, natSessionPrivateAddrType=natSessionPrivateAddrType, natProtocolInTranslates=natProtocolInTranslates, natAddrPortBindProtocol=natAddrPortBindProtocol, natMappingAddressPooling=natMappingAddressPooling, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natLimitSubscribers=natLimitSubscribers, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natSessionDirection=natSessionDirection, natSessionPublicDstAddr=natSessionPublicDstAddr, natSubscribersEntry=natSubscribersEntry, natAddrBindId=natAddrBindId, natBasicStatefulCompliance=natBasicStatefulCompliance, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natSessionInTranslates=natSessionInTranslates, natProtocolTable=natProtocolTable, natProtocolEntry=natProtocolEntry, natAddrMapProtocol=natAddrMapProtocol, natProtocolDiscards=natProtocolDiscards, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natLimitFragments=natLimitFragments, natMappingExtAddressType=natMappingExtAddressType, NatBindMode=NatBindMode, natPoolPortMax=natPoolPortMax, natAddressMappingRemovals=natAddressMappingRemovals, natMappingProto=natMappingProto, NatSessionId=NatSessionId, natGroupStatelessObjects=natGroupStatelessObjects, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natStatsProtocolGroup=natStatsProtocolGroup, natLimitMappings=natLimitMappings, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natInterfaceStorageType=natInterfaceStorageType, natMIBNotifications=natMIBNotifications, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natInterfaceDiscards=natInterfaceDiscards, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natAddrMapEntryType=natAddrMapEntryType, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natInstanceAlias=natInstanceAlias, natSubscribers=natSubscribers, natGroupBasicNotifications=natGroupBasicNotifications, natPoolEntry=natPoolEntry, natPoolRangePoolIndex=natPoolRangePoolIndex, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natSubscriberIntPrefix=natSubscriberIntPrefix, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, VlanIndexOrZero=VlanIndexOrZero, natTranslationGroup=natTranslationGroup, natPoolRangeAllocations=natPoolRangeAllocations, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natL4ProtocolTable=natL4ProtocolTable, natSubscriberResourceErrors=natSubscriberResourceErrors, natAddrMapCompliance=natAddrMapCompliance, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natAddrPortBindInTranslates=natAddrPortBindInTranslates, ProtocolNumber=ProtocolNumber, NatTranslationEntity=NatTranslationEntity, natInterfaceRealm=natInterfaceRealm, natSessionProtocolType=natSessionProtocolType, natMIBCompliances=natMIBCompliances, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natMapIntAddrTable=natMapIntAddrTable, natSubscriberIdentifierType=natSubscriberIdentifierType, natAddrMapName=natAddrMapName, natAddrBindEntry=natAddrBindEntry, natAddrMapTable=natAddrMapTable, natLimitAddressMappings=natLimitAddressMappings, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natMappingEntry=natMappingEntry, natPoolRangeType=natPoolRangeType, natPacketDiscard=natPacketDiscard, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natPoolObjects=natPoolObjects, natGroupSubscriberObjects=natGroupSubscriberObjects, natMappingMapBehavior=natMappingMapBehavior, natAddrBindInTranslates=natAddrBindInTranslates, natSubscriberRealm=natSubscriberRealm, natPoolIndex=natPoolIndex, natStatsInterfaceGroup=natStatsInterfaceGroup, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natSessionMaxIdleTime=natSessionMaxIdleTime, natInterfaceTable=natInterfaceTable, natConfigGroup=natConfigGroup, natAddrPortBindTable=natAddrPortBindTable, natMappingCreations=natMappingCreations, NatBehaviorType=NatBehaviorType, natNotifThrottlingInterval=natNotifThrottlingInterval, natSessionOutTranslates=natSessionOutTranslates, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natPoolWatermarkHigh=natPoolWatermarkHigh, natSubsInterfaceIndex=natSubsInterfaceIndex, NatProtocolType=NatProtocolType, natPoolRangeEntry=natPoolRangeEntry, natBasicStatelessCompliance=natBasicStatelessCompliance, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natAddrBindTable=natAddrBindTable, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natSessionAddrMapIndex=natSessionAddrMapIndex, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natAddrBindOutTranslates=natAddrBindOutTranslates, natPoolRangeDeallocations=natPoolRangeDeallocations, natAddrMapInTranslates=natAddrMapInTranslates, natAddrMapRowStatus=natAddrMapRowStatus, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natPoolRangeBegin=natPoolRangeBegin, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, SubscriberIdentifierType=SubscriberIdentifierType, natMappingExtPort=natMappingExtPort, natGroupAddrMapObjects=natGroupAddrMapObjects, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natLimitsEntry=natLimitsEntry, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime)
mibBuilder.exportSymbols("NAT-MIB", natPoolRealm=natPoolRealm, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natOutOfPortErrors=natOutOfPortErrors, natAddrMapDiscards=natAddrMapDiscards, natMappingExtRealm=natMappingExtRealm)
