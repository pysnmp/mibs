...
mibBuilder.exportSymbols("NAT-MIB", natAddressMappingCreations=natAddressMappingCreations, natAddrMapEntry=natAddrMapEntry, natTranslationGroup=natTranslationGroup, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natLimitsEntry=natLimitsEntry, natPoolRangeBegin=natPoolRangeBegin, natSessionPublicSrcPort=natSessionPublicSrcPort, natPoolPortMax=natPoolPortMax, natL4ProtocolNumber=natL4ProtocolNumber, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natCountersTable=natCountersTable, NatTranslationEntity=NatTranslationEntity, natAddrPortBindId=natAddrPortBindId, natPoolRangeEntry=natPoolRangeEntry, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natAddressMappingRemovals=natAddressMappingRemovals, NatPoolId=NatPoolId, natLimitFragments=natLimitFragments, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natSubscribersTable=natSubscribersTable, natSessionPublicDstAddr=natSessionPublicDstAddr, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natSubscriberTranslations=natSubscriberTranslations, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natAddrBindLocalAddr=natAddrBindLocalAddr, natBasicStatelessCompliance=natBasicStatelessCompliance, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natMIBNotifications=natMIBNotifications, natQuotaDrops=natQuotaDrops, NatBindMode=NatBindMode, natAddrMapTable=natAddrMapTable, natAddrPortBindSessions=natAddrPortBindSessions, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natNotifAddrMappings=natNotifAddrMappings, natMappingExtRealm=natMappingExtRealm, natGroupStatelessObjects=natGroupStatelessObjects, natCGNCompliance=natCGNCompliance, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natInstanceEntry=natInstanceEntry, natProtocolDiscards=natProtocolDiscards, natInterfaceInTranslates=natInterfaceInTranslates, natSessionPublicAddrType=natSessionPublicAddrType, natMappingRemovals=natMappingRemovals, natSessionPublicDstPort=natSessionPublicDstPort, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natProtocol=natProtocol, natAddrMapRowStatus=natAddrMapRowStatus, natSubscriberRealm=natSubscriberRealm, natInterfaceStorageType=natInterfaceStorageType, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natMappingFilterBehavior=natMappingFilterBehavior, natMIBNotificationGroup=natMIBNotificationGroup, PYSNMP_MODULE_ID=natMIB, SubscriberIndex=SubscriberIndex, natMapIntAddrTable=natMapIntAddrTable, natMapIntAddrInt=natMapIntAddrInt, natAddrMapEntryType=natAddrMapEntryType, natAddrBindSessions=natAddrBindSessions, natGroupSubscriberObjects=natGroupSubscriberObjects, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natPoolWatermarkHigh=natPoolWatermarkHigh, natAddrMapStorageType=natAddrMapStorageType, natMapIntAddrEntry=natMapIntAddrEntry, natSubscriberIndex=natSubscriberIndex, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, NatBindIdOrZero=NatBindIdOrZero, natAddrPortBindProtocol=natAddrPortBindProtocol, natPoolRangeTable=natPoolRangeTable, NatBehaviorType=NatBehaviorType, NatBindId=NatBindId, natGroupBasicNotifications=natGroupBasicNotifications, natPoolRangeEnd=natPoolRangeEnd, natAddrMapIndex=natAddrMapIndex, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natPoolEntry=natPoolEntry, natSessionTable=natSessionTable, natMappingPool=natMappingPool, natStatsAddrMapGroup=natStatsAddrMapGroup, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natSessionPrivateAddrType=natSessionPrivateAddrType, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natMIBFullCompliance=natMIBFullCompliance, natAddrPortBindType=natAddrPortBindType, natLimitMappings=natLimitMappings, natGroupFragmentObjects=natGroupFragmentObjects, natMappingIntAddressType=natMappingIntAddressType, NatAssociationType=NatAssociationType, natInstanceTable=natInstanceTable, natMapObjects=natMapObjects, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natMappingMapBehavior=natMappingMapBehavior, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natMappingIntRealm=natMappingIntRealm, natPoolPortMin=natPoolPortMin, natMIB=natMIB, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natResourceErrors=natResourceErrors, natAddrPortBindTable=natAddrPortBindTable, natSubscriberResourceErrors=natSubscriberResourceErrors, natInterfaceTable=natInterfaceTable, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natSubscriberMappingCreations=natSubscriberMappingCreations, natBindDefIdleTimeout=natBindDefIdleTimeout, natStatsInterfaceGroup=natStatsInterfaceGroup, natSubscribersEntry=natSubscribersEntry, natNotifCtrl=natNotifCtrl, natProtocolEntry=natProtocolEntry, natL4ProtocolTable=natL4ProtocolTable, NatAddrMapId=NatAddrMapId, natAddrBindEntry=natAddrBindEntry, natMIBCompliances=natMIBCompliances, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natTranslations=natTranslations, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natInterfaceRowStatus=natInterfaceRowStatus, natAddrBindTable=natAddrBindTable, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, VlanIndexOrZero=VlanIndexOrZero, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natProtocolOutTranslates=natProtocolOutTranslates, natAddrBindOutTranslates=natAddrBindOutTranslates, natInterfaceOutTranslates=natInterfaceOutTranslates, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natSessionPrivateDstPort=natSessionPrivateDstPort, natAddrMapAddrUsed=natAddrMapAddrUsed, natPoolRangeDeallocations=natPoolRangeDeallocations, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natAddrMapDiscards=natAddrMapDiscards, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natInstanceAlias=natInstanceAlias, natMIBObjects=natMIBObjects, natAddrMapProtocol=natAddrMapProtocol, natCountersEntry=natCountersEntry, natOutOfPortErrors=natOutOfPortErrors, natInstanceIndex=natInstanceIndex, natMappingTable=natMappingTable, natMapIntAddrExtType=natMapIntAddrExtType, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natAddrMapOutTranslates=natAddrMapOutTranslates, ProtocolNumber=ProtocolNumber, natAddrBindId=natAddrBindId, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natSessionEntry=natSessionEntry, natMIBGroups=natMIBGroups, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natMapIntAddrIntType=natMapIntAddrIntType, NatSessionId=NatSessionId, natPoolWatermarkLow=natPoolWatermarkLow, natSubscribers=natSubscribers, natAddrMapCompliance=natAddrMapCompliance, natSubscriberLimitMappings=natSubscriberLimitMappings, NatProtocolType=NatProtocolType, natAddrBindInTranslates=natAddrBindInTranslates, natPoolObjects=natPoolObjects, natPoolRangePoolIndex=natPoolRangePoolIndex, natSessionOutTranslates=natSessionOutTranslates, natMappingEntry=natMappingEntry, NatProtocolMap=NatProtocolMap, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natMappingIntAddress=natMappingIntAddress, natSessionIndex=natSessionIndex, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natSubscriberIntPrefix=natSubscriberIntPrefix, natMappingAddressPooling=natMappingAddressPooling, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natGroupAddrMapObjects=natGroupAddrMapObjects, natBasicStatefulCompliance=natBasicStatefulCompliance, NatPoolingType=NatPoolingType, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natSessionDirection=natSessionDirection, natDefTimeouts=natDefTimeouts, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natNotifMappings=natNotifMappings, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natSessionInTranslates=natSessionInTranslates, natMIBConformance=natMIBConformance, natFragmentsCompliance=natFragmentsCompliance, natMappingSubsIndex=natMappingSubsIndex, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natInterfaceDiscards=natInterfaceDiscards, natL4ProtocolTranslations=natL4ProtocolTranslations, natConfigGroup=natConfigGroup, natAddrBindType=natAddrBindType, natMappingCreations=natMappingCreations, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natLimitsTable=natLimitsTable, natAddrMapName=natAddrMapName, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natAddrMapInTranslates=natAddrMapInTranslates, natStatsProtocolGroup=natStatsProtocolGroup, natPoolTable=natPoolTable, natInterfaceServiceType=natInterfaceServiceType, natSubsInterfaceIndex=natSubsInterfaceIndex, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natMappingExtAddressType=natMappingExtAddressType, natSessionProtocolType=natSessionProtocolType, natNotifThrottlingInterval=natNotifThrottlingInterval, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natTcpDefNegTimeout=natTcpDefNegTimeout, natProtocolTable=natProtocolTable, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natPoolRangeType=natPoolRangeType, natNotifSubscriberMappings=natNotifSubscriberMappings, natInterfaceEntry=natInterfaceEntry, natPoolIndex=natPoolIndex, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natAddrPortBindEntry=natAddrPortBindEntry, natProtocolInTranslates=natProtocolInTranslates, natMappingExtAddress=natMappingExtAddress, natSessionUpTime=natSessionUpTime, natPoolRealm=natPoolRealm, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natMappingProto=natMappingProto, natMappingIntPort=natMappingIntPort, natSubscriberIdentifierType=natSubscriberIdentifierType, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natPacketDiscard=natPacketDiscard, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natAddrBindMapIndex=natAddrBindMapIndex, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natInterfaceRealm=natInterfaceRealm, natLimitAddressMappings=natLimitAddressMappings, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natMapIntAddrExt=natMapIntAddrExt, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natCounters=natCounters, natGroupStatefulObjects=natGroupStatefulObjects, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natSessionAddrMapIndex=natSessionAddrMapIndex, natL4ProtocolEntry=natL4ProtocolEntry, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natPoolRangeAllocations=natPoolRangeAllocations, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natLimitSubscribers=natLimitSubscribers)
mibBuilder.exportSymbols("NAT-MIB", natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natSessionMaxIdleTime=natSessionMaxIdleTime, natMappingExtPort=natMappingExtPort, SubscriberIdentifierType=SubscriberIdentifierType, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex)
