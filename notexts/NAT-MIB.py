...
mibBuilder.exportSymbols("NAT-MIB", natAddrBindTranslationEntity=natAddrBindTranslationEntity, natPoolRangeType=natPoolRangeType, NatPoolingType=NatPoolingType, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natMapIntAddrIntType=natMapIntAddrIntType, natInstanceEntry=natInstanceEntry, natProtocolDiscards=natProtocolDiscards, natAddrBindOutTranslates=natAddrBindOutTranslates, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natNotifThrottlingInterval=natNotifThrottlingInterval, natAddrBindTable=natAddrBindTable, natPoolRangeEnd=natPoolRangeEnd, natStatsProtocolGroup=natStatsProtocolGroup, natInstanceIndex=natInstanceIndex, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natTcpDefNegTimeout=natTcpDefNegTimeout, natBasicStatelessCompliance=natBasicStatelessCompliance, natTranslations=natTranslations, natSubscriberMappingRemovals=natSubscriberMappingRemovals, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natL4ProtocolTranslations=natL4ProtocolTranslations, natAddrPortBindType=natAddrPortBindType, natL4ProtocolEntry=natL4ProtocolEntry, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natAddrMapOutTranslates=natAddrMapOutTranslates, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natAddrPortBindEntry=natAddrPortBindEntry, PYSNMP_MODULE_ID=natMIB, natMappingAddressPooling=natMappingAddressPooling, natSubsInterfaceIndex=natSubsInterfaceIndex, natMappingExtAddressType=natMappingExtAddressType, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natInterfaceOutTranslates=natInterfaceOutTranslates, natL4ProtocolTable=natL4ProtocolTable, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natSubscriberLimitMappings=natSubscriberLimitMappings, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natMIBConformance=natMIBConformance, natBasicStatefulCompliance=natBasicStatefulCompliance, natSessionPrivateAddrType=natSessionPrivateAddrType, natMIBNotificationGroup=natMIBNotificationGroup, natLimitsTable=natLimitsTable, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natNotifMappings=natNotifMappings, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natSubscriberTranslations=natSubscriberTranslations, natAddrBindInTranslates=natAddrBindInTranslates, natAddrPortBindProtocol=natAddrPortBindProtocol, natAddrMapTable=natAddrMapTable, natSessionInTranslates=natSessionInTranslates, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natLimitSubscribers=natLimitSubscribers, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natLimitFragments=natLimitFragments, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natMappingCreations=natMappingCreations, natMIBGroups=natMIBGroups, natMappingTable=natMappingTable, natSubscribers=natSubscribers, natLimitAddressMappings=natLimitAddressMappings, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natSubscriberIntPrefix=natSubscriberIntPrefix, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natPoolRealm=natPoolRealm, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natGroupStatelessObjects=natGroupStatelessObjects, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natAddrMapRowStatus=natAddrMapRowStatus, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natAddressMappingCreations=natAddressMappingCreations, natPoolIndex=natPoolIndex, natSubscribersEntry=natSubscribersEntry, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natPoolPortMax=natPoolPortMax, natMappingIntAddressType=natMappingIntAddressType, natBindDefIdleTimeout=natBindDefIdleTimeout, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natAddrMapAddrUsed=natAddrMapAddrUsed, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natMapIntAddrExt=natMapIntAddrExt, natMapIntAddrInt=natMapIntAddrInt, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natMappingExtPort=natMappingExtPort, natMapIntAddrTable=natMapIntAddrTable, NatProtocolMap=NatProtocolMap, natSessionIndex=natSessionIndex, natInterfaceStorageType=natInterfaceStorageType, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natNotifCtrl=natNotifCtrl, natInterfaceRealm=natInterfaceRealm, natAddrPortBindId=natAddrPortBindId, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natProtocolOutTranslates=natProtocolOutTranslates, natStatsInterfaceGroup=natStatsInterfaceGroup, NatBehaviorType=NatBehaviorType, natMappingEntry=natMappingEntry, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natMappingMapBehavior=natMappingMapBehavior, natInterfaceDiscards=natInterfaceDiscards, natMIBFullCompliance=natMIBFullCompliance, natL4ProtocolNumber=natL4ProtocolNumber, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natMIBNotifications=natMIBNotifications, natPoolRangeEntry=natPoolRangeEntry, natSubscriberResourceErrors=natSubscriberResourceErrors, natSubscriberMappingCreations=natSubscriberMappingCreations, natMIBObjects=natMIBObjects, natCountersEntry=natCountersEntry, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natProtocolEntry=natProtocolEntry, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, VlanIndexOrZero=VlanIndexOrZero, natAddrBindSessions=natAddrBindSessions, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natInstanceAlias=natInstanceAlias, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natProtocolTable=natProtocolTable, natPoolEntry=natPoolEntry, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natPoolTable=natPoolTable, natPacketDiscard=natPacketDiscard, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natAddrPortBindTable=natAddrPortBindTable, natSessionProtocolType=natSessionProtocolType, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natSessionUpTime=natSessionUpTime, natMappingSubsIndex=natMappingSubsIndex, natSubscriberIndex=natSubscriberIndex, natCounters=natCounters, natPoolPortMin=natPoolPortMin, natInterfaceRowStatus=natInterfaceRowStatus, natInterfaceInTranslates=natInterfaceInTranslates, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natPoolRangePoolIndex=natPoolRangePoolIndex, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natPoolRangeBegin=natPoolRangeBegin, natMappingPool=natMappingPool, natPoolRangeTable=natPoolRangeTable, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natMappingFilterBehavior=natMappingFilterBehavior, natSessionPublicDstPort=natSessionPublicDstPort, natAddrMapIndex=natAddrMapIndex, natMappingIntPort=natMappingIntPort, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natAddrBindType=natAddrBindType, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natAddrPortBindSessions=natAddrPortBindSessions, natGroupStatefulObjects=natGroupStatefulObjects, natSessionPublicAddrType=natSessionPublicAddrType, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natAddrBindMapIndex=natAddrBindMapIndex, natMappingExtRealm=natMappingExtRealm, natMIBCompliances=natMIBCompliances, natMappingProto=natMappingProto, natInterfaceServiceType=natInterfaceServiceType, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natTranslationGroup=natTranslationGroup, natAddrMapInTranslates=natAddrMapInTranslates, natSessionPublicDstAddr=natSessionPublicDstAddr, SubscriberIdentifierType=SubscriberIdentifierType, natMapIntAddrExtType=natMapIntAddrExtType, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natSubscribersTable=natSubscribersTable, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natFragmentsCompliance=natFragmentsCompliance, natProtocolInTranslates=natProtocolInTranslates, natMappingIntAddress=natMappingIntAddress, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natSessionPrivateDstPort=natSessionPrivateDstPort, NatBindIdOrZero=NatBindIdOrZero, natSessionMaxIdleTime=natSessionMaxIdleTime, NatTranslationEntity=NatTranslationEntity, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natStatsAddrMapGroup=natStatsAddrMapGroup, natAddrBindLocalAddr=natAddrBindLocalAddr, natAddrMapDiscards=natAddrMapDiscards, NatBindMode=NatBindMode, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natPoolWatermarkHigh=natPoolWatermarkHigh, natGroupBasicNotifications=natGroupBasicNotifications, natGroupSubscriberObjects=natGroupSubscriberObjects, natConfigGroup=natConfigGroup, natGroupAddrMapObjects=natGroupAddrMapObjects, natMapIntAddrEntry=natMapIntAddrEntry, natAddrMapProtocol=natAddrMapProtocol, natLimitMappings=natLimitMappings, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natMappingExtAddress=natMappingExtAddress, natPoolObjects=natPoolObjects, natMappingIntRealm=natMappingIntRealm, natMapObjects=natMapObjects, natDefTimeouts=natDefTimeouts, natCountersTable=natCountersTable, NatSessionId=NatSessionId, natAddrBindId=natAddrBindId, natLimitsEntry=natLimitsEntry, natSessionAddrMapIndex=natSessionAddrMapIndex, natNotifSubscriberMappings=natNotifSubscriberMappings, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, NatBindId=NatBindId, natAddrMapEntryType=natAddrMapEntryType, natProtocol=natProtocol, natAddrMapStorageType=natAddrMapStorageType, natPoolWatermarkLow=natPoolWatermarkLow, natAddrMapTranslationEntity=natAddrMapTranslationEntity, NatProtocolType=NatProtocolType, NatAssociationType=NatAssociationType, SubscriberIndex=SubscriberIndex, natOutOfPortErrors=natOutOfPortErrors, natAddrMapEntry=natAddrMapEntry, natAddressMappingRemovals=natAddressMappingRemovals, NatAddrMapId=NatAddrMapId, NatPoolId=NatPoolId, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natSubscriberRealm=natSubscriberRealm, natGroupFragmentObjects=natGroupFragmentObjects, natSessionDirection=natSessionDirection, natCGNCompliance=natCGNCompliance, natSessionPublicSrcPort=natSessionPublicSrcPort, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natInterfaceTable=natInterfaceTable, natMIB=natMIB, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natPoolRangeDeallocations=natPoolRangeDeallocations, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natSessionTable=natSessionTable, natSessionOutTranslates=natSessionOutTranslates, natQuotaDrops=natQuotaDrops, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natResourceErrors=natResourceErrors, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natInterfaceEntry=natInterfaceEntry, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natSessionEntry=natSessionEntry, natMappingRemovals=natMappingRemovals, natPoolRangeAllocations=natPoolRangeAllocations, natAddrBindEntry=natAddrBindEntry, natInstanceTable=natInstanceTable)
mibBuilder.exportSymbols("NAT-MIB", natAddrMapCompliance=natAddrMapCompliance, natNotifAddrMappings=natNotifAddrMappings, ProtocolNumber=ProtocolNumber, natAddrMapName=natAddrMapName, natSubscriberIdentifierType=natSubscriberIdentifierType)
