...
mibBuilder.exportSymbols("NAT-MIB", natAddressMappingCreations=natAddressMappingCreations, natSessionTable=natSessionTable, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natBasicStatelessCompliance=natBasicStatelessCompliance, natAddrBindTable=natAddrBindTable, natAddrPortBindType=natAddrPortBindType, NatSessionId=NatSessionId, natMappingProto=natMappingProto, natMIB=natMIB, natAddrPortBindEntry=natAddrPortBindEntry, natSessionDirection=natSessionDirection, natMappingCreations=natMappingCreations, NatBindIdOrZero=NatBindIdOrZero, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natMappingTable=natMappingTable, natNotifSubscriberMappings=natNotifSubscriberMappings, natFragmentsCompliance=natFragmentsCompliance, NatTranslationEntity=NatTranslationEntity, natSubsInterfaceIndex=natSubsInterfaceIndex, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natInterfaceDiscards=natInterfaceDiscards, natInterfaceStorageType=natInterfaceStorageType, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natMappingMapBehavior=natMappingMapBehavior, natLimitsEntry=natLimitsEntry, SubscriberIdentifierType=SubscriberIdentifierType, natAddrMapCompliance=natAddrMapCompliance, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natSessionPrivateDstPort=natSessionPrivateDstPort, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natAddrMapEntry=natAddrMapEntry, natAddrBindEntry=natAddrBindEntry, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natL4ProtocolEntry=natL4ProtocolEntry, natAddrPortBindTable=natAddrPortBindTable, natTranslations=natTranslations, natResourceErrors=natResourceErrors, natGroupAddrMapObjects=natGroupAddrMapObjects, VlanIndexOrZero=VlanIndexOrZero, natSubscribersTable=natSubscribersTable, natProtocolEntry=natProtocolEntry, natInterfaceServiceType=natInterfaceServiceType, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natInstanceAlias=natInstanceAlias, natInterfaceInTranslates=natInterfaceInTranslates, natAddrMapAddrUsed=natAddrMapAddrUsed, natBindDefIdleTimeout=natBindDefIdleTimeout, natMappingSubsIndex=natMappingSubsIndex, NatBindMode=NatBindMode, natPoolWatermarkLow=natPoolWatermarkLow, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natMappingFilterBehavior=natMappingFilterBehavior, natPoolEntry=natPoolEntry, natNotifMappings=natNotifMappings, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natMapIntAddrIntType=natMapIntAddrIntType, natSessionIndex=natSessionIndex, natMappingExtPort=natMappingExtPort, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natAddrBindSessions=natAddrBindSessions, natPoolRangeBegin=natPoolRangeBegin, natMapIntAddrExtType=natMapIntAddrExtType, natConfigGroup=natConfigGroup, natPoolRangePoolIndex=natPoolRangePoolIndex, natMIBObjects=natMIBObjects, NatBehaviorType=NatBehaviorType, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natMapIntAddrEntry=natMapIntAddrEntry, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natAddrMapTable=natAddrMapTable, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natMappingExtAddressType=natMappingExtAddressType, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natSubscriberRealm=natSubscriberRealm, natSubscriberTranslations=natSubscriberTranslations, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natLimitsTable=natLimitsTable, natPoolRangeType=natPoolRangeType, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natLimitAddressMappings=natLimitAddressMappings, natGroupSubscriberObjects=natGroupSubscriberObjects, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, NatBindId=NatBindId, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natSessionPublicSrcPort=natSessionPublicSrcPort, natPoolWatermarkHigh=natPoolWatermarkHigh, natSubscriberIntPrefixType=natSubscriberIntPrefixType, SubscriberIndex=SubscriberIndex, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natSessionPublicDstPort=natSessionPublicDstPort, natGroupBasicNotifications=natGroupBasicNotifications, natMappingEntry=natMappingEntry, natAddrBindMapIndex=natAddrBindMapIndex, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natCountersEntry=natCountersEntry, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natAddrMapIndex=natAddrMapIndex, natSessionUpTime=natSessionUpTime, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natProtocolTable=natProtocolTable, natCountersTable=natCountersTable, natAddrMapProtocol=natAddrMapProtocol, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natMappingIntAddressType=natMappingIntAddressType, NatProtocolType=NatProtocolType, natAddrPortBindId=natAddrPortBindId, natAddrBindType=natAddrBindType, natAddrMapInTranslates=natAddrMapInTranslates, natSubscribersEntry=natSubscribersEntry, natMIBNotifications=natMIBNotifications, natLimitSubscribers=natLimitSubscribers, natSessionOutTranslates=natSessionOutTranslates, PYSNMP_MODULE_ID=natMIB, ProtocolNumber=ProtocolNumber, natMappingIntPort=natMappingIntPort, natSessionPrivateAddrType=natSessionPrivateAddrType, natGroupStatefulObjects=natGroupStatefulObjects, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natSessionInTranslates=natSessionInTranslates, natMapObjects=natMapObjects, natSessionAddrMapIndex=natSessionAddrMapIndex, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natStatsProtocolGroup=natStatsProtocolGroup, natAddrMapOutTranslates=natAddrMapOutTranslates, natAddrMapStorageType=natAddrMapStorageType, natPoolRangeTable=natPoolRangeTable, natPoolRangeEntry=natPoolRangeEntry, natDefTimeouts=natDefTimeouts, natPoolPortMin=natPoolPortMin, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natPoolPortMax=natPoolPortMax, natAddrBindId=natAddrBindId, natQuotaDrops=natQuotaDrops, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natL4ProtocolNumber=natL4ProtocolNumber, natPoolIndex=natPoolIndex, natSubscriberLimitMappings=natSubscriberLimitMappings, natGroupStatelessObjects=natGroupStatelessObjects, natL4ProtocolTranslations=natL4ProtocolTranslations, natAddrBindOutTranslates=natAddrBindOutTranslates, natMappingPool=natMappingPool, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natStatsInterfaceGroup=natStatsInterfaceGroup, natPoolRangeAllocations=natPoolRangeAllocations, natInterfaceRowStatus=natInterfaceRowStatus, natInterfaceEntry=natInterfaceEntry, natAddrBindLocalAddr=natAddrBindLocalAddr, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natInterfaceRealm=natInterfaceRealm, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natMapIntAddrExt=natMapIntAddrExt, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natMappingIntAddress=natMappingIntAddress, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natAddrMapDiscards=natAddrMapDiscards, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natSessionEntry=natSessionEntry, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natProtocolDiscards=natProtocolDiscards, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natLimitFragments=natLimitFragments, natMIBNotificationGroup=natMIBNotificationGroup, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natSessionPublicAddrType=natSessionPublicAddrType, natMIBGroups=natMIBGroups, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natTranslationGroup=natTranslationGroup, natInstanceTable=natInstanceTable, natLimitMappings=natLimitMappings, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natNotifAddrMappings=natNotifAddrMappings, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natSessionProtocolType=natSessionProtocolType, NatPoolId=NatPoolId, natMIBCompliances=natMIBCompliances, natSubscriberIndex=natSubscriberIndex, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natPoolTable=natPoolTable, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natNotifThrottlingInterval=natNotifThrottlingInterval, natOutOfPortErrors=natOutOfPortErrors, natMappingExtRealm=natMappingExtRealm, natCounters=natCounters, natMappingIntRealm=natMappingIntRealm, natPoolObjects=natPoolObjects, natMappingExtAddress=natMappingExtAddress, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natAddrMapRowStatus=natAddrMapRowStatus, natL4ProtocolTable=natL4ProtocolTable, natSubscriberResourceErrors=natSubscriberResourceErrors, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natSessionMaxIdleTime=natSessionMaxIdleTime, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natPoolRangeEnd=natPoolRangeEnd, natSubscriberMappingCreations=natSubscriberMappingCreations, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natMapIntAddrTable=natMapIntAddrTable, natMapIntAddrInt=natMapIntAddrInt, NatProtocolMap=NatProtocolMap, natSubscriberIntPrefix=natSubscriberIntPrefix, NatPoolingType=NatPoolingType, natMIBFullCompliance=natMIBFullCompliance, natMappingRemovals=natMappingRemovals, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natBasicStatefulCompliance=natBasicStatefulCompliance, natPoolRealm=natPoolRealm, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natMappingAddressPooling=natMappingAddressPooling, natInstanceEntry=natInstanceEntry, natPoolRangeDeallocations=natPoolRangeDeallocations, natAddrPortBindSessions=natAddrPortBindSessions, natInterfaceOutTranslates=natInterfaceOutTranslates, NatAssociationType=NatAssociationType, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natAddrMapEntryType=natAddrMapEntryType, natAddrBindInTranslates=natAddrBindInTranslates, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natNotifCtrl=natNotifCtrl, natTcpDefNegTimeout=natTcpDefNegTimeout, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natCGNCompliance=natCGNCompliance, natAddrMapName=natAddrMapName, natPacketDiscard=natPacketDiscard, natProtocolInTranslates=natProtocolInTranslates, NatAddrMapId=NatAddrMapId, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natAddrPortBindProtocol=natAddrPortBindProtocol, natInterfaceTable=natInterfaceTable, natSessionPublicDstAddr=natSessionPublicDstAddr, natProtocol=natProtocol, natAddressMappingRemovals=natAddressMappingRemovals, natSubscriberIdentifierType=natSubscriberIdentifierType, natMIBConformance=natMIBConformance)
mibBuilder.exportSymbols("NAT-MIB", natInstanceIndex=natInstanceIndex, natStatsAddrMapGroup=natStatsAddrMapGroup, natSubscribers=natSubscribers, natGroupFragmentObjects=natGroupFragmentObjects, natProtocolOutTranslates=natProtocolOutTranslates)
