...
ifIndex, ifCounterDiscontinuityGroup, InterfaceIndex = mibBuilder.importSymbols("IF-MIB", "ifIndex", "ifCounterDiscontinuityGroup", "InterfaceIndex")
...
mibBuilder.exportSymbols("NAT-MIB", natSessionPrivateDstPort=natSessionPrivateDstPort, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natPoolRangeTable=natPoolRangeTable, natInstanceEntry=natInstanceEntry, natMappingExtAddressType=natMappingExtAddressType, natQuotaDrops=natQuotaDrops, natMappingIntRealm=natMappingIntRealm, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natSubscriberTranslations=natSubscriberTranslations, natCounters=natCounters, natMIBGroups=natMIBGroups, natNotifMappings=natNotifMappings, natMapIntAddrIntType=natMapIntAddrIntType, natPacketDiscard=natPacketDiscard, natAddrPortBindEntry=natAddrPortBindEntry, natStatsAddrMapGroup=natStatsAddrMapGroup, natSubscriberRealm=natSubscriberRealm, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natDefTimeouts=natDefTimeouts, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, SubscriberIndex=SubscriberIndex, natLimitMappings=natLimitMappings, natGroupStatelessObjects=natGroupStatelessObjects, natLimitFragments=natLimitFragments, natMappingCreations=natMappingCreations, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natProtocolDiscards=natProtocolDiscards, natAddrMapEntryType=natAddrMapEntryType, natSessionOutTranslates=natSessionOutTranslates, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natNotifThrottlingInterval=natNotifThrottlingInterval, natAddressMappingRemovals=natAddressMappingRemovals, natMapIntAddrInt=natMapIntAddrInt, NatBindIdOrZero=NatBindIdOrZero, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natL4ProtocolEntry=natL4ProtocolEntry, natMIBConformance=natMIBConformance, natPoolRangeBegin=natPoolRangeBegin, natPoolRangePoolIndex=natPoolRangePoolIndex, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natAddrPortBindProtocol=natAddrPortBindProtocol, ProtocolNumber=ProtocolNumber, natAddrMapEntry=natAddrMapEntry, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natMappingPool=natMappingPool, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natInstanceAlias=natInstanceAlias, natAddrPortBindInTranslates=natAddrPortBindInTranslates, NatTranslationEntity=NatTranslationEntity, natSubscriberIntPrefix=natSubscriberIntPrefix, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natMappingAddressPooling=natMappingAddressPooling, natLimitsTable=natLimitsTable, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natMappingEntry=natMappingEntry, natSubsInterfaceIndex=natSubsInterfaceIndex, natAddrMapDiscards=natAddrMapDiscards, natAddrPortBindTable=natAddrPortBindTable, natSessionPublicSrcPort=natSessionPublicSrcPort, natSessionTable=natSessionTable, natOutOfPortErrors=natOutOfPortErrors, natMappingRemovals=natMappingRemovals, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, NatPoolId=NatPoolId, natL4ProtocolTranslations=natL4ProtocolTranslations, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natGroupBasicNotifications=natGroupBasicNotifications, natL4ProtocolNumber=natL4ProtocolNumber, natPoolIndex=natPoolIndex, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natMappingMapBehavior=natMappingMapBehavior, natSessionPublicAddrType=natSessionPublicAddrType, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natInterfaceInTranslates=natInterfaceInTranslates, natPoolObjects=natPoolObjects, natAddrBindSessions=natAddrBindSessions, natPoolPortMax=natPoolPortMax, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natMappingExtPort=natMappingExtPort, natPoolRangeAllocations=natPoolRangeAllocations, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natMIBNotifications=natMIBNotifications, natAddrMapStorageType=natAddrMapStorageType, natTranslationGroup=natTranslationGroup, natInterfaceServiceType=natInterfaceServiceType, natResourceErrors=natResourceErrors, natSessionIndex=natSessionIndex, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natMappingIntPort=natMappingIntPort, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natStatsProtocolGroup=natStatsProtocolGroup, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natNotifAddrMappings=natNotifAddrMappings, natNotifCtrl=natNotifCtrl, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natPoolWatermarkLow=natPoolWatermarkLow, natAddrBindLocalAddr=natAddrBindLocalAddr, natSessionDirection=natSessionDirection, natConfigGroup=natConfigGroup, natInterfaceRealm=natInterfaceRealm, NatBehaviorType=NatBehaviorType, natAddrBindMapIndex=natAddrBindMapIndex, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natAddrMapOutTranslates=natAddrMapOutTranslates, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natPoolRangeDeallocations=natPoolRangeDeallocations, natMappingExtRealm=natMappingExtRealm, natMappingSubsIndex=natMappingSubsIndex, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natBasicStatelessCompliance=natBasicStatelessCompliance, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, VlanIndexOrZero=VlanIndexOrZero, NatAssociationType=NatAssociationType, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natStatsInterfaceGroup=natStatsInterfaceGroup, SubscriberIdentifierType=SubscriberIdentifierType, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, NatProtocolMap=NatProtocolMap, natSessionPrivateAddrType=natSessionPrivateAddrType, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natProtocolTable=natProtocolTable, natSubscribersEntry=natSubscribersEntry, natMapIntAddrEntry=natMapIntAddrEntry, natAddrMapIndex=natAddrMapIndex, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natPoolRealm=natPoolRealm, natMapObjects=natMapObjects, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natGroupStatefulObjects=natGroupStatefulObjects, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natMapIntAddrTable=natMapIntAddrTable, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natGroupAddrMapObjects=natGroupAddrMapObjects, natProtocolInTranslates=natProtocolInTranslates, natAddressMappingCreations=natAddressMappingCreations, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natNotifSubscriberMappings=natNotifSubscriberMappings, natPoolWatermarkHigh=natPoolWatermarkHigh, natInterfaceStorageType=natInterfaceStorageType, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natMappingIntAddressType=natMappingIntAddressType, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natBindDefIdleTimeout=natBindDefIdleTimeout, natSubscriberMappingCreations=natSubscriberMappingCreations, natAddrPortBindType=natAddrPortBindType, natMIBObjects=natMIBObjects, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natSubscriberLimitMappings=natSubscriberLimitMappings, natMappingTable=natMappingTable, natPoolRangeEnd=natPoolRangeEnd, natGroupSubscriberObjects=natGroupSubscriberObjects, natInterfaceOutTranslates=natInterfaceOutTranslates, NatSessionId=NatSessionId, natMIB=natMIB, natMIBNotificationGroup=natMIBNotificationGroup, natSessionMaxIdleTime=natSessionMaxIdleTime, natInterfaceEntry=natInterfaceEntry, natInstanceTable=natInstanceTable, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natFragmentsCompliance=natFragmentsCompliance, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natAddrMapName=natAddrMapName, natPoolRangeEntry=natPoolRangeEntry, natPoolPortMin=natPoolPortMin, natMappingIntAddress=natMappingIntAddress, natProtocolEntry=natProtocolEntry, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natLimitAddressMappings=natLimitAddressMappings, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natAddrMapTable=natAddrMapTable, natAddrMapInTranslates=natAddrMapInTranslates, natSubscribers=natSubscribers, natSubscriberIdentifierType=natSubscriberIdentifierType, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natSessionPublicDstPort=natSessionPublicDstPort, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natPoolTable=natPoolTable, natMapIntAddrExtType=natMapIntAddrExtType, natTranslations=natTranslations, natAddrBindId=natAddrBindId, NatAddrMapId=NatAddrMapId, natSessionInTranslates=natSessionInTranslates, PYSNMP_MODULE_ID=natMIB, natPoolRangeType=natPoolRangeType, natCountersTable=natCountersTable, natSessionEntry=natSessionEntry, natAddrBindTable=natAddrBindTable, natL4ProtocolTable=natL4ProtocolTable, natInterfaceRowStatus=natInterfaceRowStatus, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natAddrMapAddrUsed=natAddrMapAddrUsed, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natInterfaceDiscards=natInterfaceDiscards, natAddrBindEntry=natAddrBindEntry, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natAddrBindInTranslates=natAddrBindInTranslates, natMappingFilterBehavior=natMappingFilterBehavior, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natInterfaceTable=natInterfaceTable, natAddrMapProtocol=natAddrMapProtocol, natCGNCompliance=natCGNCompliance, natSessionPublicDstAddr=natSessionPublicDstAddr, natSubscribersTable=natSubscribersTable, natSessionAddrMapIndex=natSessionAddrMapIndex, natProtocol=natProtocol, natMappingExtAddress=natMappingExtAddress, natBasicStatefulCompliance=natBasicStatefulCompliance, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, NatPoolingType=NatPoolingType, natMappingProto=natMappingProto, natSessionProtocolType=natSessionProtocolType, natAddrMapLocalPortTo=natAddrMapLocalPortTo, NatProtocolType=NatProtocolType, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natMIBCompliances=natMIBCompliances, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natSessionUpTime=natSessionUpTime, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natMIBFullCompliance=natMIBFullCompliance, natInstanceIndex=natInstanceIndex, natSubscriberResourceErrors=natSubscriberResourceErrors, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natAddrPortBindId=natAddrPortBindId, NatBindId=NatBindId, natCountersEntry=natCountersEntry, natAddrBindOutTranslates=natAddrBindOutTranslates, natPoolEntry=natPoolEntry, natSubscriberIndex=natSubscriberIndex, natGroupFragmentObjects=natGroupFragmentObjects, natTcpDefNegTimeout=natTcpDefNegTimeout, natMapIntAddrExt=natMapIntAddrExt, natLimitsEntry=natLimitsEntry, NatBindMode=NatBindMode, natAddrPortBindSessions=natAddrPortBindSessions)
mibBuilder.exportSymbols("NAT-MIB", natAddrBindType=natAddrBindType, natLimitSubscribers=natLimitSubscribers, natAddrMapCompliance=natAddrMapCompliance, natProtocolOutTranslates=natProtocolOutTranslates, natAddrMapRowStatus=natAddrMapRowStatus)
