...
mibBuilder.exportSymbols("NAT-MIB", natMappingProto=natMappingProto, natAddrPortBindProtocol=natAddrPortBindProtocol, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natInterfaceOutTranslates=natInterfaceOutTranslates, natSubscriberResourceErrors=natSubscriberResourceErrors, natAddrMapInTranslates=natAddrMapInTranslates, natAddrBindId=natAddrBindId, natSessionProtocolType=natSessionProtocolType, natAddrMapStorageType=natAddrMapStorageType, natBindDefIdleTimeout=natBindDefIdleTimeout, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natStatsAddrMapGroup=natStatsAddrMapGroup, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natSessionIndex=natSessionIndex, natSubscriberTranslations=natSubscriberTranslations, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natSubsInterfaceIndex=natSubsInterfaceIndex, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natSessionUpTime=natSessionUpTime, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natMappingCreations=natMappingCreations, natAddrMapEntryType=natAddrMapEntryType, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natCounters=natCounters, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natInstanceTable=natInstanceTable, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natMapIntAddrExt=natMapIntAddrExt, natMIBCompliances=natMIBCompliances, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natL4ProtocolNumber=natL4ProtocolNumber, natPoolRangePoolIndex=natPoolRangePoolIndex, natMappingIntPort=natMappingIntPort, natAddrBindTable=natAddrBindTable, natAddrPortBindEntry=natAddrPortBindEntry, natPoolEntry=natPoolEntry, natMappingIntRealm=natMappingIntRealm, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natTranslations=natTranslations, natMappingExtRealm=natMappingExtRealm, natFragmentsCompliance=natFragmentsCompliance, natAddrMapOutTranslates=natAddrMapOutTranslates, natSubscriberIndex=natSubscriberIndex, natMIBGroups=natMIBGroups, natInterfaceStorageType=natInterfaceStorageType, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natSubscriberLimitMappings=natSubscriberLimitMappings, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natLimitMappings=natLimitMappings, natMappingEntry=natMappingEntry, natMappingExtAddress=natMappingExtAddress, natCGNCompliance=natCGNCompliance, natGroupFragmentObjects=natGroupFragmentObjects, natSubscriberMappingCreations=natSubscriberMappingCreations, natPoolPortMin=natPoolPortMin, natAddrMapDiscards=natAddrMapDiscards, natAddrMapRowStatus=natAddrMapRowStatus, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natInterfaceDiscards=natInterfaceDiscards, natMappingFilterBehavior=natMappingFilterBehavior, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natTcpDefNegTimeout=natTcpDefNegTimeout, natSessionMaxIdleTime=natSessionMaxIdleTime, natInstanceEntry=natInstanceEntry, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natSessionPrivateAddrType=natSessionPrivateAddrType, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natPoolRangeAllocations=natPoolRangeAllocations, natPoolRangeTable=natPoolRangeTable, natSubscribersTable=natSubscribersTable, NatAssociationType=NatAssociationType, natPoolRangeBegin=natPoolRangeBegin, natLimitAddressMappings=natLimitAddressMappings, natLimitsTable=natLimitsTable, natPoolRangeDeallocations=natPoolRangeDeallocations, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natAddrPortBindSessions=natAddrPortBindSessions, natPoolRangeType=natPoolRangeType, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natCountersEntry=natCountersEntry, natOutOfPortErrors=natOutOfPortErrors, natSessionPublicDstAddr=natSessionPublicDstAddr, natGroupAddrMapObjects=natGroupAddrMapObjects, natSubscribers=natSubscribers, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, NatSessionId=NatSessionId, natSessionTable=natSessionTable, natPoolPortMax=natPoolPortMax, SubscriberIdentifierType=SubscriberIdentifierType, natMappingIntAddressType=natMappingIntAddressType, NatTranslationEntity=NatTranslationEntity, NatBehaviorType=NatBehaviorType, natPoolWatermarkLow=natPoolWatermarkLow, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natMapObjects=natMapObjects, natMapIntAddrEntry=natMapIntAddrEntry, natMappingExtPort=natMappingExtPort, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natAddrPortBindTable=natAddrPortBindTable, VlanIndexOrZero=VlanIndexOrZero, natInterfaceRealm=natInterfaceRealm, natAddrMapTable=natAddrMapTable, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natPoolRealm=natPoolRealm, natGroupSubscriberObjects=natGroupSubscriberObjects, NatProtocolMap=NatProtocolMap, natLimitsEntry=natLimitsEntry, NatBindIdOrZero=NatBindIdOrZero, natAddrBindOutTranslates=natAddrBindOutTranslates, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natSessionPublicSrcPort=natSessionPublicSrcPort, natCountersTable=natCountersTable, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natAddrBindSessions=natAddrBindSessions, natMapIntAddrInt=natMapIntAddrInt, natNotifThrottlingInterval=natNotifThrottlingInterval, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, PYSNMP_MODULE_ID=natMIB, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natL4ProtocolTranslations=natL4ProtocolTranslations, NatAddrMapId=NatAddrMapId, natL4ProtocolEntry=natL4ProtocolEntry, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natSubscribersEntry=natSubscribersEntry, natAddrMapName=natAddrMapName, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natSessionEntry=natSessionEntry, natLimitFragments=natLimitFragments, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natPoolTable=natPoolTable, natGroupStatelessObjects=natGroupStatelessObjects, natInterfaceTable=natInterfaceTable, natMappingExtAddressType=natMappingExtAddressType, NatProtocolType=NatProtocolType, natAddrMapEntry=natAddrMapEntry, natAddrMapIndex=natAddrMapIndex, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natAddressMappingCreations=natAddressMappingCreations, natBasicStatefulCompliance=natBasicStatefulCompliance, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, NatBindMode=NatBindMode, natInterfaceServiceType=natInterfaceServiceType, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natL4ProtocolTable=natL4ProtocolTable, natProtocolDiscards=natProtocolDiscards, natMapIntAddrExtType=natMapIntAddrExtType, natProtocolInTranslates=natProtocolInTranslates, natNotifCtrl=natNotifCtrl, natAddrPortBindId=natAddrPortBindId, natNotifMappings=natNotifMappings, SubscriberIndex=SubscriberIndex, natSessionPrivateDstPort=natSessionPrivateDstPort, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natAddressMappingRemovals=natAddressMappingRemovals, natSessionPublicAddrType=natSessionPublicAddrType, natQuotaDrops=natQuotaDrops, natLimitSubscribers=natLimitSubscribers, natSubscriberIntPrefix=natSubscriberIntPrefix, natGroupBasicNotifications=natGroupBasicNotifications, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natMIBNotifications=natMIBNotifications, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natInterfaceEntry=natInterfaceEntry, natAddrBindType=natAddrBindType, natMappingAddressPooling=natMappingAddressPooling, natInterfaceRowStatus=natInterfaceRowStatus, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natAddrMapProtocol=natAddrMapProtocol, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natSessionDirection=natSessionDirection, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natStatsProtocolGroup=natStatsProtocolGroup, natPoolIndex=natPoolIndex, natMappingIntAddress=natMappingIntAddress, natSessionPublicDstPort=natSessionPublicDstPort, natMIBFullCompliance=natMIBFullCompliance, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natGroupStatefulObjects=natGroupStatefulObjects, natBasicStatelessCompliance=natBasicStatelessCompliance, natTranslationGroup=natTranslationGroup, natConfigGroup=natConfigGroup, NatPoolId=NatPoolId, natMapIntAddrIntType=natMapIntAddrIntType, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natResourceErrors=natResourceErrors, natAddrMapAddrUsed=natAddrMapAddrUsed, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natSessionInTranslates=natSessionInTranslates, natProtocolTable=natProtocolTable, natSessionAddrMapIndex=natSessionAddrMapIndex, natPacketDiscard=natPacketDiscard, ProtocolNumber=ProtocolNumber, natNotifAddrMappings=natNotifAddrMappings, natPoolWatermarkHigh=natPoolWatermarkHigh, natMappingRemovals=natMappingRemovals, natAddrBindMapIndex=natAddrBindMapIndex, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natPoolRangeEnd=natPoolRangeEnd, natProtocol=natProtocol, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natNotifSubscriberMappings=natNotifSubscriberMappings, natMappingMapBehavior=natMappingMapBehavior, natMappingSubsIndex=natMappingSubsIndex, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natMIBConformance=natMIBConformance, natInstanceAlias=natInstanceAlias, natProtocolEntry=natProtocolEntry, natMIBNotificationGroup=natMIBNotificationGroup, natStatsInterfaceGroup=natStatsInterfaceGroup, natAddrBindEntry=natAddrBindEntry, natPoolObjects=natPoolObjects, natAddrPortBindType=natAddrPortBindType, natMIB=natMIB, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natMappingPool=natMappingPool, NatPoolingType=NatPoolingType, natMappingTable=natMappingTable, natPoolRangeEntry=natPoolRangeEntry, natSubscriberIdentifierType=natSubscriberIdentifierType, NatBindId=NatBindId, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natSubscriberRealm=natSubscriberRealm, natInstanceIndex=natInstanceIndex, natDefTimeouts=natDefTimeouts, natProtocolOutTranslates=natProtocolOutTranslates, natMIBObjects=natMIBObjects, natAddrBindLocalAddr=natAddrBindLocalAddr, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natMapIntAddrTable=natMapIntAddrTable, natSessionOutTranslates=natSessionOutTranslates, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier)
mibBuilder.exportSymbols("NAT-MIB", natAddrBindInTranslates=natAddrBindInTranslates, natAddrMapCompliance=natAddrMapCompliance, natInterfaceInTranslates=natInterfaceInTranslates, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals)
