...
InterfaceIndex, ifCounterDiscontinuityGroup, ifIndex = mibBuilder.importSymbols("IF-MIB", "InterfaceIndex", "ifCounterDiscontinuityGroup", "ifIndex")
...
mibBuilder.exportSymbols("NAT-MIB", natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natMIBFullCompliance=natMIBFullCompliance, VlanIndexOrZero=VlanIndexOrZero, natNotifSubscriberMappings=natNotifSubscriberMappings, NatPoolingType=NatPoolingType, natSubscriberResourceErrors=natSubscriberResourceErrors, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natSubscribersEntry=natSubscribersEntry, NatSessionId=NatSessionId, natAddrPortBindType=natAddrPortBindType, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natConfigGroup=natConfigGroup, natInstanceEntry=natInstanceEntry, natL4ProtocolTable=natL4ProtocolTable, NatTranslationEntity=NatTranslationEntity, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natMappingIntRealm=natMappingIntRealm, NatBindId=NatBindId, natMappingRemovals=natMappingRemovals, natSubsInterfaceIndex=natSubsInterfaceIndex, natInterfaceOutTranslates=natInterfaceOutTranslates, natSubscriberMappingCreations=natSubscriberMappingCreations, natTranslationGroup=natTranslationGroup, natAddrMapStorageType=natAddrMapStorageType, natAddrMapProtocol=natAddrMapProtocol, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natSessionUpTime=natSessionUpTime, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natMIBCompliances=natMIBCompliances, natMappingExtAddressType=natMappingExtAddressType, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natBasicStatefulCompliance=natBasicStatefulCompliance, natLimitSubscribers=natLimitSubscribers, natAddrMapInTranslates=natAddrMapInTranslates, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natInterfaceRowStatus=natInterfaceRowStatus, natMappingIntPort=natMappingIntPort, natLimitFragments=natLimitFragments, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natSessionAddrMapIndex=natSessionAddrMapIndex, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natCountersTable=natCountersTable, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natAddrBindEntry=natAddrBindEntry, natL4ProtocolEntry=natL4ProtocolEntry, natMIBConformance=natMIBConformance, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natSubscriberIndex=natSubscriberIndex, natPoolWatermarkHigh=natPoolWatermarkHigh, natAddrBindSessions=natAddrBindSessions, natSessionPublicDstPort=natSessionPublicDstPort, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natSessionTable=natSessionTable, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natMappingFilterBehavior=natMappingFilterBehavior, natLimitsEntry=natLimitsEntry, natMIBObjects=natMIBObjects, natAddrBindTable=natAddrBindTable, natPoolRangeEnd=natPoolRangeEnd, NatBehaviorType=NatBehaviorType, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natPacketDiscard=natPacketDiscard, natMappingMapBehavior=natMappingMapBehavior, natOutOfPortErrors=natOutOfPortErrors, natSubscriberLimitMappings=natSubscriberLimitMappings, natAddrBindType=natAddrBindType, natMappingAddressPooling=natMappingAddressPooling, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, NatAssociationType=NatAssociationType, natMapIntAddrExt=natMapIntAddrExt, natSubscriberIdentifierType=natSubscriberIdentifierType, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natAddrMapDiscards=natAddrMapDiscards, natCounters=natCounters, natAddrBindId=natAddrBindId, natMapIntAddrEntry=natMapIntAddrEntry, natMappingPool=natMappingPool, natPoolRangeAllocations=natPoolRangeAllocations, NatProtocolMap=NatProtocolMap, natProtocolOutTranslates=natProtocolOutTranslates, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natAddrMapIndex=natAddrMapIndex, natSubscribers=natSubscribers, natSessionPublicAddrType=natSessionPublicAddrType, natMappingIntAddress=natMappingIntAddress, natGroupStatelessObjects=natGroupStatelessObjects, natAddrPortBindTable=natAddrPortBindTable, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natMappingTable=natMappingTable, NatProtocolType=NatProtocolType, natNotifMappings=natNotifMappings, natInstanceTable=natInstanceTable, natAddrBindInTranslates=natAddrBindInTranslates, natMIBGroups=natMIBGroups, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natPoolRangeType=natPoolRangeType, natGroupBasicNotifications=natGroupBasicNotifications, natInterfaceRealm=natInterfaceRealm, natAddrPortBindEntry=natAddrPortBindEntry, natCGNCompliance=natCGNCompliance, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natAddrMapTable=natAddrMapTable, SubscriberIdentifierType=SubscriberIdentifierType, natAddrMapRowStatus=natAddrMapRowStatus, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natMappingCreations=natMappingCreations, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natLimitAddressMappings=natLimitAddressMappings, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natSessionProtocolType=natSessionProtocolType, natPoolPortMax=natPoolPortMax, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natPoolRealm=natPoolRealm, natInterfaceTable=natInterfaceTable, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natProtocolDiscards=natProtocolDiscards, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natAddrMapEntryType=natAddrMapEntryType, natAddrPortBindProtocol=natAddrPortBindProtocol, natSessionDirection=natSessionDirection, natSessionOutTranslates=natSessionOutTranslates, natStatsInterfaceGroup=natStatsInterfaceGroup, natMapIntAddrTable=natMapIntAddrTable, natMappingSubsIndex=natMappingSubsIndex, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natSessionInTranslates=natSessionInTranslates, natSubscriberTranslations=natSubscriberTranslations, natSessionPrivateAddrType=natSessionPrivateAddrType, natAddrMapOutTranslates=natAddrMapOutTranslates, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natInterfaceDiscards=natInterfaceDiscards, natStatsAddrMapGroup=natStatsAddrMapGroup, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natPoolIndex=natPoolIndex, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, NatBindMode=NatBindMode, natDefTimeouts=natDefTimeouts, ProtocolNumber=ProtocolNumber, natAddrMapCompliance=natAddrMapCompliance, natPoolObjects=natPoolObjects, natAddrMapAddrUsed=natAddrMapAddrUsed, natNotifCtrl=natNotifCtrl, natSubscriberIntPrefix=natSubscriberIntPrefix, natMapIntAddrInt=natMapIntAddrInt, natAddressMappingRemovals=natAddressMappingRemovals, natPoolRangeTable=natPoolRangeTable, SubscriberIndex=SubscriberIndex, natAddressMappingCreations=natAddressMappingCreations, natGroupSubscriberObjects=natGroupSubscriberObjects, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natSessionEntry=natSessionEntry, natAddrBindLocalAddr=natAddrBindLocalAddr, natLimitsTable=natLimitsTable, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natGroupFragmentObjects=natGroupFragmentObjects, natResourceErrors=natResourceErrors, natSessionMaxIdleTime=natSessionMaxIdleTime, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natInstanceIndex=natInstanceIndex, natSessionPrivateDstPort=natSessionPrivateDstPort, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natL4ProtocolNumber=natL4ProtocolNumber, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natFragmentsCompliance=natFragmentsCompliance, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natProtocolEntry=natProtocolEntry, natSubscribersTable=natSubscribersTable, natInterfaceInTranslates=natInterfaceInTranslates, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natQuotaDrops=natQuotaDrops, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natAddrPortBindId=natAddrPortBindId, natProtocolInTranslates=natProtocolInTranslates, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natPoolRangeBegin=natPoolRangeBegin, natMapIntAddrIntType=natMapIntAddrIntType, natMappingExtRealm=natMappingExtRealm, natL4ProtocolTranslations=natL4ProtocolTranslations, natProtocolTable=natProtocolTable, natInterfaceStorageType=natInterfaceStorageType, natInstanceAlias=natInstanceAlias, natStatsProtocolGroup=natStatsProtocolGroup, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natProtocol=natProtocol, natPoolRangeEntry=natPoolRangeEntry, natBasicStatelessCompliance=natBasicStatelessCompliance, natSubscriberRealm=natSubscriberRealm, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natSessionPublicSrcPort=natSessionPublicSrcPort, natMappingProto=natMappingProto, NatAddrMapId=NatAddrMapId, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natPoolEntry=natPoolEntry, natMappingExtAddress=natMappingExtAddress, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natAddrMapName=natAddrMapName, NatBindIdOrZero=NatBindIdOrZero, natTranslations=natTranslations, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natMappingEntry=natMappingEntry, natMIBNotificationGroup=natMIBNotificationGroup, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natTcpDefNegTimeout=natTcpDefNegTimeout, natInterfaceEntry=natInterfaceEntry, NatPoolId=NatPoolId, natPoolRangePoolIndex=natPoolRangePoolIndex, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natNotifAddrMappings=natNotifAddrMappings, natLimitMappings=natLimitMappings, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natMappingExtPort=natMappingExtPort, natMappingIntAddressType=natMappingIntAddressType, natCountersEntry=natCountersEntry, natPoolPortMin=natPoolPortMin, natGroupAddrMapObjects=natGroupAddrMapObjects, PYSNMP_MODULE_ID=natMIB, natNotifThrottlingInterval=natNotifThrottlingInterval, natPoolTable=natPoolTable, natPoolWatermarkLow=natPoolWatermarkLow, natAddrBindMapIndex=natAddrBindMapIndex, natAddrBindOutTranslates=natAddrBindOutTranslates, natGroupStatefulObjects=natGroupStatefulObjects, natMIBNotifications=natMIBNotifications, natMapIntAddrExtType=natMapIntAddrExtType, natInterfaceServiceType=natInterfaceServiceType, natBindDefIdleTimeout=natBindDefIdleTimeout, natAddrMapEntry=natAddrMapEntry, natSessionIndex=natSessionIndex, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natSessionPublicDstAddr=natSessionPublicDstAddr, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natPoolRangeDeallocations=natPoolRangeDeallocations, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr)
mibBuilder.exportSymbols("NAT-MIB", natMIB=natMIB, natMapObjects=natMapObjects, natAddrPortBindSessions=natAddrPortBindSessions, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType)
