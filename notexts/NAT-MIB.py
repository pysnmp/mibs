...
mibBuilder.exportSymbols("NAT-MIB", NatBindId=NatBindId, natAddrMapName=natAddrMapName, natSessionEntry=natSessionEntry, natSessionUpTime=natSessionUpTime, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, NatBehaviorType=NatBehaviorType, natSessionAddrMapIndex=natSessionAddrMapIndex, natMapIntAddrExtType=natMapIntAddrExtType, natAddrPortBindType=natAddrPortBindType, natProtocol=natProtocol, natMIBFullCompliance=natMIBFullCompliance, PYSNMP_MODULE_ID=natMIB, NatTranslationEntity=NatTranslationEntity, natAddrBindSessions=natAddrBindSessions, natQuotaDrops=natQuotaDrops, natGroupStatefulObjects=natGroupStatefulObjects, natMappingIntRealm=natMappingIntRealm, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natAddrBindType=natAddrBindType, natPoolWatermarkHigh=natPoolWatermarkHigh, natMapIntAddrEntry=natMapIntAddrEntry, natLimitMappings=natLimitMappings, natSubsInterfaceIndex=natSubsInterfaceIndex, natSessionPublicDstPort=natSessionPublicDstPort, natProtocolDiscards=natProtocolDiscards, natSubscriberResourceErrors=natSubscriberResourceErrors, natCounters=natCounters, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natSubscriberIdentifierType=natSubscriberIdentifierType, natLimitsTable=natLimitsTable, natMappingPool=natMappingPool, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natSubscriberRealm=natSubscriberRealm, natProtocolInTranslates=natProtocolInTranslates, natTranslations=natTranslations, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natPoolPortMax=natPoolPortMax, natGroupFragmentObjects=natGroupFragmentObjects, natStatsInterfaceGroup=natStatsInterfaceGroup, natMIBConformance=natMIBConformance, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natSessionPrivateDstPort=natSessionPrivateDstPort, natMIBObjects=natMIBObjects, natSessionPublicSrcPort=natSessionPublicSrcPort, natResourceErrors=natResourceErrors, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natSubscribersTable=natSubscribersTable, natGroupSubscriberObjects=natGroupSubscriberObjects, natAddrPortBindId=natAddrPortBindId, natPoolEntry=natPoolEntry, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natProtocolTable=natProtocolTable, natSubscribers=natSubscribers, natGroupStatelessObjects=natGroupStatelessObjects, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natSessionTable=natSessionTable, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natMappingRemovals=natMappingRemovals, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natMappingTable=natMappingTable, natSessionMaxIdleTime=natSessionMaxIdleTime, natPoolWatermarkLow=natPoolWatermarkLow, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natMappingIntAddressType=natMappingIntAddressType, natInterfaceTable=natInterfaceTable, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natNotifAddrMappings=natNotifAddrMappings, natProtocolOutTranslates=natProtocolOutTranslates, natOutOfPortErrors=natOutOfPortErrors, natInterfaceDiscards=natInterfaceDiscards, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natMappingExtPort=natMappingExtPort, natAddrMapDiscards=natAddrMapDiscards, natMappingProto=natMappingProto, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, NatSessionId=NatSessionId, natAddressMappingCreations=natAddressMappingCreations, natCGNCompliance=natCGNCompliance, natAddrMapAddrUsed=natAddrMapAddrUsed, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natPoolRangeAllocations=natPoolRangeAllocations, natAddrPortBindEntry=natAddrPortBindEntry, NatPoolId=NatPoolId, natAddrBindId=natAddrBindId, natBindDefIdleTimeout=natBindDefIdleTimeout, natMappingExtAddress=natMappingExtAddress, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natAddrPortBindSessions=natAddrPortBindSessions, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natMIB=natMIB, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natAddrBindEntry=natAddrBindEntry, NatProtocolMap=NatProtocolMap, natL4ProtocolTable=natL4ProtocolTable, natAddrBindOutTranslates=natAddrBindOutTranslates, natPoolRangeTable=natPoolRangeTable, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natGroupBasicNotifications=natGroupBasicNotifications, natInterfaceRealm=natInterfaceRealm, natAddrMapEntryType=natAddrMapEntryType, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natGroupAddrMapObjects=natGroupAddrMapObjects, natBasicStatelessCompliance=natBasicStatelessCompliance, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natInterfaceRowStatus=natInterfaceRowStatus, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, NatAddrMapId=NatAddrMapId, natMapIntAddrIntType=natMapIntAddrIntType, natInstanceEntry=natInstanceEntry, SubscriberIndex=SubscriberIndex, natProtocolEntry=natProtocolEntry, natL4ProtocolNumber=natL4ProtocolNumber, natAddrBindInTranslates=natAddrBindInTranslates, natSessionPublicDstAddr=natSessionPublicDstAddr, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natMappingIntPort=natMappingIntPort, natAddrBindMapIndex=natAddrBindMapIndex, natSessionDirection=natSessionDirection, natStatsAddrMapGroup=natStatsAddrMapGroup, natSessionInTranslates=natSessionInTranslates, natAddrMapIndex=natAddrMapIndex, natAddrBindTable=natAddrBindTable, natAddrPortBindProtocol=natAddrPortBindProtocol, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natSubscriberIntPrefix=natSubscriberIntPrefix, natBasicStatefulCompliance=natBasicStatefulCompliance, natCountersEntry=natCountersEntry, ProtocolNumber=ProtocolNumber, natCountersTable=natCountersTable, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natMIBCompliances=natMIBCompliances, natMappingExtAddressType=natMappingExtAddressType, natAddrMapInTranslates=natAddrMapInTranslates, natSubscribersEntry=natSubscribersEntry, natAddressMappingRemovals=natAddressMappingRemovals, natL4ProtocolTranslations=natL4ProtocolTranslations, NatPoolingType=NatPoolingType, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natMappingSubsIndex=natMappingSubsIndex, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natSubscriberMappingCreations=natSubscriberMappingCreations, NatProtocolType=NatProtocolType, NatAssociationType=NatAssociationType, natTcpDefNegTimeout=natTcpDefNegTimeout, natInterfaceStorageType=natInterfaceStorageType, natAddrMapProtocol=natAddrMapProtocol, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natPoolRangeDeallocations=natPoolRangeDeallocations, natLimitAddressMappings=natLimitAddressMappings, natNotifMappings=natNotifMappings, NatBindMode=NatBindMode, natSessionOutTranslates=natSessionOutTranslates, natAddrMapCompliance=natAddrMapCompliance, natSessionPrivateAddrType=natSessionPrivateAddrType, natLimitSubscribers=natLimitSubscribers, natPoolRealm=natPoolRealm, natSessionPublicAddrType=natSessionPublicAddrType, natSubscriberIndex=natSubscriberIndex, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natSessionProtocolType=natSessionProtocolType, natL4ProtocolEntry=natL4ProtocolEntry, natPoolTable=natPoolTable, natMappingCreations=natMappingCreations, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, NatBindIdOrZero=NatBindIdOrZero, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natMapIntAddrTable=natMapIntAddrTable, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natMIBNotificationGroup=natMIBNotificationGroup, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natSessionIndex=natSessionIndex, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natInterfaceServiceType=natInterfaceServiceType, natPoolObjects=natPoolObjects, natMapObjects=natMapObjects, natInterfaceOutTranslates=natInterfaceOutTranslates, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natInstanceAlias=natInstanceAlias, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natAddrMapStorageType=natAddrMapStorageType, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natMappingFilterBehavior=natMappingFilterBehavior, natPoolIndex=natPoolIndex, natNotifSubscriberMappings=natNotifSubscriberMappings, natPoolRangeEnd=natPoolRangeEnd, natPoolRangeEntry=natPoolRangeEntry, natAddrMapEntry=natAddrMapEntry, natPoolRangeType=natPoolRangeType, natInterfaceInTranslates=natInterfaceInTranslates, natSubscriberLimitMappings=natSubscriberLimitMappings, natMappingIntAddress=natMappingIntAddress, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natLimitFragments=natLimitFragments, natConfigGroup=natConfigGroup, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natMappingMapBehavior=natMappingMapBehavior, natLimitsEntry=natLimitsEntry, SubscriberIdentifierType=SubscriberIdentifierType, natAddrMapRowStatus=natAddrMapRowStatus, natNotifThrottlingInterval=natNotifThrottlingInterval, natMappingEntry=natMappingEntry, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natPacketDiscard=natPacketDiscard, natPoolRangeBegin=natPoolRangeBegin, natInstanceTable=natInstanceTable, natTranslationGroup=natTranslationGroup, natDefTimeouts=natDefTimeouts, natMIBNotifications=natMIBNotifications, natMapIntAddrInt=natMapIntAddrInt, natNotifCtrl=natNotifCtrl, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natAddrMapOutTranslates=natAddrMapOutTranslates, natPoolRangePoolIndex=natPoolRangePoolIndex, natAddrMapTable=natAddrMapTable, natPoolPortMin=natPoolPortMin, natFragmentsCompliance=natFragmentsCompliance, natStatsProtocolGroup=natStatsProtocolGroup, VlanIndexOrZero=VlanIndexOrZero, natAddrBindLocalAddr=natAddrBindLocalAddr, natSubscriberTranslations=natSubscriberTranslations, natAddrPortBindTable=natAddrPortBindTable, natMappingAddressPooling=natMappingAddressPooling, natInstanceIndex=natInstanceIndex, natMapIntAddrExt=natMapIntAddrExt)
mibBuilder.exportSymbols("NAT-MIB", natMIBGroups=natMIBGroups, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natInterfaceEntry=natInterfaceEntry, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natMappingExtRealm=natMappingExtRealm)
