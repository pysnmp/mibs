...
mibBuilder.exportSymbols("NAT-MIB", natGroupStatefulObjects=natGroupStatefulObjects, natInstanceAlias=natInstanceAlias, natInstanceEntry=natInstanceEntry, natLimitAddressMappings=natLimitAddressMappings, natAddrPortBindId=natAddrPortBindId, natLimitMappings=natLimitMappings, natLimitsEntry=natLimitsEntry, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natSessionMaxIdleTime=natSessionMaxIdleTime, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natSessionPublicDstAddr=natSessionPublicDstAddr, natSessionPublicDstPort=natSessionPublicDstPort, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natNotifThrottlingInterval=natNotifThrottlingInterval, natStatsInterfaceGroup=natStatsInterfaceGroup, natMIBFullCompliance=natMIBFullCompliance, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natPoolRangeType=natPoolRangeType, natCounters=natCounters, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natInterfaceOutTranslates=natInterfaceOutTranslates, natAddrMapIndex=natAddrMapIndex, natMappingIntPort=natMappingIntPort, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, NatProtocolType=NatProtocolType, natAddrBindInTranslates=natAddrBindInTranslates, natCountersTable=natCountersTable, natGroupSubscriberObjects=natGroupSubscriberObjects, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natAddrMapTable=natAddrMapTable, natProtocolOutTranslates=natProtocolOutTranslates, natAddrBindOutTranslates=natAddrBindOutTranslates, natAddrPortBindSessions=natAddrPortBindSessions, natMIB=natMIB, NatProtocolMap=NatProtocolMap, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, NatBehaviorType=NatBehaviorType, natMapIntAddrIntType=natMapIntAddrIntType, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natInterfaceStorageType=natInterfaceStorageType, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natMappingEntry=natMappingEntry, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natPoolRangeAllocations=natPoolRangeAllocations, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natMapIntAddrExt=natMapIntAddrExt, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natSessionDirection=natSessionDirection, natMappingExtAddressType=natMappingExtAddressType, natTranslationGroup=natTranslationGroup, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natCountersEntry=natCountersEntry, NatBindMode=NatBindMode, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natTcpDefNegTimeout=natTcpDefNegTimeout, natAddrBindEntry=natAddrBindEntry, natInterfaceInTranslates=natInterfaceInTranslates, natSessionInTranslates=natSessionInTranslates, natPoolRealm=natPoolRealm, natAddrBindSessions=natAddrBindSessions, natInterfaceRealm=natInterfaceRealm, natBindDefIdleTimeout=natBindDefIdleTimeout, NatBindId=NatBindId, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, NatAddrMapId=NatAddrMapId, natInterfaceRowStatus=natInterfaceRowStatus, VlanIndexOrZero=VlanIndexOrZero, natAddrMapCompliance=natAddrMapCompliance, natSubscriberRealm=natSubscriberRealm, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natSessionPrivateDstPort=natSessionPrivateDstPort, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natPacketDiscard=natPacketDiscard, natInterfaceEntry=natInterfaceEntry, natNotifMappings=natNotifMappings, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natStatsProtocolGroup=natStatsProtocolGroup, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natMappingIntAddress=natMappingIntAddress, natAddrPortBindEntry=natAddrPortBindEntry, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natMappingIntAddressType=natMappingIntAddressType, natSessionAddrMapIndex=natSessionAddrMapIndex, natProtocolDiscards=natProtocolDiscards, natGroupBasicNotifications=natGroupBasicNotifications, natMappingMapBehavior=natMappingMapBehavior, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natQuotaDrops=natQuotaDrops, natPoolRangeDeallocations=natPoolRangeDeallocations, natSubscribersTable=natSubscribersTable, natPoolEntry=natPoolEntry, natAddrPortBindTable=natAddrPortBindTable, natSessionIndex=natSessionIndex, natNotifAddrMappings=natNotifAddrMappings, natSubsInterfaceIndex=natSubsInterfaceIndex, natOutOfPortErrors=natOutOfPortErrors, natLimitSubscribers=natLimitSubscribers, natGroupStatelessObjects=natGroupStatelessObjects, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natSessionEntry=natSessionEntry, natAddrBindTable=natAddrBindTable, natAddrMapEntryType=natAddrMapEntryType, natPoolIndex=natPoolIndex, ProtocolNumber=ProtocolNumber, natPoolPortMax=natPoolPortMax, natMappingTable=natMappingTable, natMapIntAddrTable=natMapIntAddrTable, natMappingAddressPooling=natMappingAddressPooling, natMappingSubsIndex=natMappingSubsIndex, natSubscribers=natSubscribers, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natSubscriberLimitMappings=natSubscriberLimitMappings, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natSubscriberIdentifierType=natSubscriberIdentifierType, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natMappingExtAddress=natMappingExtAddress, NatAssociationType=NatAssociationType, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natSessionTable=natSessionTable, NatPoolingType=NatPoolingType, natNotifCtrl=natNotifCtrl, natPoolObjects=natPoolObjects, natMappingExtPort=natMappingExtPort, natMIBConformance=natMIBConformance, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natProtocol=natProtocol, natPoolPortMin=natPoolPortMin, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natSessionProtocolType=natSessionProtocolType, natProtocolEntry=natProtocolEntry, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, NatSessionId=NatSessionId, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, PYSNMP_MODULE_ID=natMIB, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natL4ProtocolTable=natL4ProtocolTable, natFragmentsCompliance=natFragmentsCompliance, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natInstanceIndex=natInstanceIndex, natAddrBindLocalAddr=natAddrBindLocalAddr, natMIBObjects=natMIBObjects, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natCGNCompliance=natCGNCompliance, natMappingIntRealm=natMappingIntRealm, natPoolRangeEntry=natPoolRangeEntry, natMappingCreations=natMappingCreations, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natMIBCompliances=natMIBCompliances, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natResourceErrors=natResourceErrors, natPoolTable=natPoolTable, natMapIntAddrEntry=natMapIntAddrEntry, natAddrBindType=natAddrBindType, natMIBNotifications=natMIBNotifications, natAddrMapStorageType=natAddrMapStorageType, natSessionPrivateAddrType=natSessionPrivateAddrType, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natAddrPortBindProtocol=natAddrPortBindProtocol, natInstanceTable=natInstanceTable, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natSubscriberIndex=natSubscriberIndex, natSubscriberTranslations=natSubscriberTranslations, NatBindIdOrZero=NatBindIdOrZero, natMIBGroups=natMIBGroups, SubscriberIndex=SubscriberIndex, natMapIntAddrExtType=natMapIntAddrExtType, natGroupAddrMapObjects=natGroupAddrMapObjects, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, SubscriberIdentifierType=SubscriberIdentifierType, natMappingRemovals=natMappingRemovals, natInterfaceServiceType=natInterfaceServiceType, natMapIntAddrInt=natMapIntAddrInt, NatPoolId=NatPoolId, natGroupFragmentObjects=natGroupFragmentObjects, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natSubscribersEntry=natSubscribersEntry, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natAddrMapEntry=natAddrMapEntry, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, NatTranslationEntity=NatTranslationEntity, natInterfaceDiscards=natInterfaceDiscards, natL4ProtocolTranslations=natL4ProtocolTranslations, natAddrPortBindType=natAddrPortBindType, natSessionUpTime=natSessionUpTime, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natConfigGroup=natConfigGroup, natSubscriberMappingCreations=natSubscriberMappingCreations, natPoolWatermarkHigh=natPoolWatermarkHigh, natAddrBindMapIndex=natAddrBindMapIndex, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natAddrMapProtocol=natAddrMapProtocol, natAddrMapName=natAddrMapName, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natMappingExtRealm=natMappingExtRealm, natMappingPool=natMappingPool, natStatsAddrMapGroup=natStatsAddrMapGroup, natAddressMappingCreations=natAddressMappingCreations, natL4ProtocolNumber=natL4ProtocolNumber, natLimitsTable=natLimitsTable, natPoolRangeEnd=natPoolRangeEnd, natMapObjects=natMapObjects, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natAddrBindId=natAddrBindId, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natPoolRangePoolIndex=natPoolRangePoolIndex, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natSessionPublicAddrType=natSessionPublicAddrType, natAddressMappingRemovals=natAddressMappingRemovals, natL4ProtocolEntry=natL4ProtocolEntry, natMappingFilterBehavior=natMappingFilterBehavior, natSubscriberIntPrefix=natSubscriberIntPrefix, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natPoolWatermarkLow=natPoolWatermarkLow, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natNotifSubscriberMappings=natNotifSubscriberMappings, natInterfaceTable=natInterfaceTable, natAddrMapInTranslates=natAddrMapInTranslates, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natLimitFragments=natLimitFragments, natSubscriberResourceErrors=natSubscriberResourceErrors, natPoolRangeTable=natPoolRangeTable, natSessionPublicSrcPort=natSessionPublicSrcPort, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natAddrMapRowStatus=natAddrMapRowStatus, natDefTimeouts=natDefTimeouts, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natSessionOutTranslates=natSessionOutTranslates, natProtocolTable=natProtocolTable, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natPoolRangeBegin=natPoolRangeBegin, natBasicStatelessCompliance=natBasicStatelessCompliance, natMappingProto=natMappingProto, natBasicStatefulCompliance=natBasicStatefulCompliance, natAddrMapDiscards=natAddrMapDiscards)
mibBuilder.exportSymbols("NAT-MIB", natTranslations=natTranslations, natMIBNotificationGroup=natMIBNotificationGroup, natProtocolInTranslates=natProtocolInTranslates, natAddrMapAddrUsed=natAddrMapAddrUsed, natAddrMapOutTranslates=natAddrMapOutTranslates)
