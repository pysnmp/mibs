...
mibBuilder.exportSymbols("NAT-MIB", natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natLimitFragments=natLimitFragments, natAddrMapTable=natAddrMapTable, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natSessionProtocolType=natSessionProtocolType, natAddrMapDiscards=natAddrMapDiscards, natMIB=natMIB, natProtocolEntry=natProtocolEntry, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natInterfaceOutTranslates=natInterfaceOutTranslates, natAddressMappingRemovals=natAddressMappingRemovals, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natProtocolTable=natProtocolTable, natL4ProtocolNumber=natL4ProtocolNumber, natMappingFilterBehavior=natMappingFilterBehavior, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natSessionDirection=natSessionDirection, natConfigGroup=natConfigGroup, natLimitsTable=natLimitsTable, natLimitSubscribers=natLimitSubscribers, natPoolRangeDeallocations=natPoolRangeDeallocations, natBasicStatefulCompliance=natBasicStatefulCompliance, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natMapIntAddrExt=natMapIntAddrExt, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natGroupStatefulObjects=natGroupStatefulObjects, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, VlanIndexOrZero=VlanIndexOrZero, natMapIntAddrTable=natMapIntAddrTable, natSubscriberIndex=natSubscriberIndex, natMappingTable=natMappingTable, natNotifAddrMappings=natNotifAddrMappings, natPoolPortMin=natPoolPortMin, natCounters=natCounters, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natMappingSubsIndex=natMappingSubsIndex, natL4ProtocolTable=natL4ProtocolTable, natMappingIntRealm=natMappingIntRealm, natAddrBindId=natAddrBindId, natAddrBindOutTranslates=natAddrBindOutTranslates, natPoolTable=natPoolTable, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natAddrBindLocalAddr=natAddrBindLocalAddr, natMappingAddressPooling=natMappingAddressPooling, natMappingExtAddress=natMappingExtAddress, natPoolWatermarkHigh=natPoolWatermarkHigh, natGroupSubscriberObjects=natGroupSubscriberObjects, natAddrBindMapIndex=natAddrBindMapIndex, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natPoolRangeEntry=natPoolRangeEntry, natAddrPortBindTable=natAddrPortBindTable, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, NatProtocolMap=NatProtocolMap, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, NatBindIdOrZero=NatBindIdOrZero, natTranslations=natTranslations, natAddrPortBindEntry=natAddrPortBindEntry, natMIBObjects=natMIBObjects, natSessionTable=natSessionTable, natOutOfPortErrors=natOutOfPortErrors, natPoolRangeTable=natPoolRangeTable, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natNotifThrottlingInterval=natNotifThrottlingInterval, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natNotifCtrl=natNotifCtrl, natMappingIntPort=natMappingIntPort, NatSessionId=NatSessionId, natSubscriberTranslations=natSubscriberTranslations, natMIBNotificationGroup=natMIBNotificationGroup, natAddrPortBindType=natAddrPortBindType, natMIBConformance=natMIBConformance, natSessionMaxIdleTime=natSessionMaxIdleTime, natInstanceTable=natInstanceTable, natL4ProtocolEntry=natL4ProtocolEntry, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natL4ProtocolTranslations=natL4ProtocolTranslations, natMappingMapBehavior=natMappingMapBehavior, natSessionPrivateDstPort=natSessionPrivateDstPort, SubscriberIdentifierType=SubscriberIdentifierType, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natSubscriberRealm=natSubscriberRealm, natAddrMapEntryType=natAddrMapEntryType, natPoolRealm=natPoolRealm, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natTcpDefNegTimeout=natTcpDefNegTimeout, natSessionPrivateAddrType=natSessionPrivateAddrType, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natPoolRangeBegin=natPoolRangeBegin, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natGroupStatelessObjects=natGroupStatelessObjects, natInterfaceTable=natInterfaceTable, NatBindId=NatBindId, natAddressMappingCreations=natAddressMappingCreations, natPoolPortMax=natPoolPortMax, natProtocolInTranslates=natProtocolInTranslates, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natSessionPublicSrcPort=natSessionPublicSrcPort, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natAddrMapInTranslates=natAddrMapInTranslates, natSessionPublicAddrType=natSessionPublicAddrType, natMappingPool=natMappingPool, natSubscriberIdentifierType=natSubscriberIdentifierType, NatTranslationEntity=NatTranslationEntity, natMappingCreations=natMappingCreations, natInterfaceStorageType=natInterfaceStorageType, natNotifMappings=natNotifMappings, natAddrBindTable=natAddrBindTable, natPoolEntry=natPoolEntry, natPoolWatermarkLow=natPoolWatermarkLow, natMappingExtRealm=natMappingExtRealm, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natMappingExtPort=natMappingExtPort, natMappingRemovals=natMappingRemovals, natSessionPublicDstPort=natSessionPublicDstPort, natSubscriberLimitMappings=natSubscriberLimitMappings, SubscriberIndex=SubscriberIndex, natQuotaDrops=natQuotaDrops, natLimitsEntry=natLimitsEntry, natSubscribersEntry=natSubscribersEntry, natSubscriberResourceErrors=natSubscriberResourceErrors, natInterfaceDiscards=natInterfaceDiscards, natAddrMapOutTranslates=natAddrMapOutTranslates, natSessionInTranslates=natSessionInTranslates, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natMapObjects=natMapObjects, natPoolRangeAllocations=natPoolRangeAllocations, PYSNMP_MODULE_ID=natMIB, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natAddrPortBindId=natAddrPortBindId, natInstanceAlias=natInstanceAlias, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natMIBFullCompliance=natMIBFullCompliance, natAddrPortBindProtocol=natAddrPortBindProtocol, natMIBCompliances=natMIBCompliances, natSessionIndex=natSessionIndex, natGroupBasicNotifications=natGroupBasicNotifications, natAddrBindSessions=natAddrBindSessions, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natSessionPrivateDstAddr=natSessionPrivateDstAddr, NatAssociationType=NatAssociationType, natAddrPortBindSessions=natAddrPortBindSessions, natSessionUpTime=natSessionUpTime, natPoolRangeType=natPoolRangeType, natTranslationGroup=natTranslationGroup, natInterfaceServiceType=natInterfaceServiceType, natMapIntAddrInt=natMapIntAddrInt, natPoolIndex=natPoolIndex, natDefTimeouts=natDefTimeouts, natInterfaceRowStatus=natInterfaceRowStatus, natMIBNotifications=natMIBNotifications, natAddrMapEntry=natAddrMapEntry, natInstanceEntry=natInstanceEntry, natResourceErrors=natResourceErrors, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natMappingExtAddressType=natMappingExtAddressType, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natSubscriberIntPrefix=natSubscriberIntPrefix, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natSessionPrivateSrcPort=natSessionPrivateSrcPort, NatPoolId=NatPoolId, natInstanceIndex=natInstanceIndex, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natPoolObjects=natPoolObjects, natAddrMapName=natAddrMapName, natSessionAddrMapIndex=natSessionAddrMapIndex, natCountersEntry=natCountersEntry, natLimitAddressMappings=natLimitAddressMappings, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natInterfaceRealm=natInterfaceRealm, natInterfaceInTranslates=natInterfaceInTranslates, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natSubscriberMappingCreations=natSubscriberMappingCreations, natBasicStatelessCompliance=natBasicStatelessCompliance, natStatsInterfaceGroup=natStatsInterfaceGroup, natProtocolOutTranslates=natProtocolOutTranslates, NatPoolingType=NatPoolingType, natSessionOutTranslates=natSessionOutTranslates, natSubscribers=natSubscribers, natMapIntAddrIntType=natMapIntAddrIntType, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natGroupFragmentObjects=natGroupFragmentObjects, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natProtocolDiscards=natProtocolDiscards, natNotifSubscriberMappings=natNotifSubscriberMappings, natSubsInterfaceIndex=natSubsInterfaceIndex, NatBindMode=NatBindMode, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natMappingProto=natMappingProto, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, NatBehaviorType=NatBehaviorType, natFragmentsCompliance=natFragmentsCompliance, natBindDefIdleTimeout=natBindDefIdleTimeout, natLimitMappings=natLimitMappings, natPacketDiscard=natPacketDiscard, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natStatsAddrMapGroup=natStatsAddrMapGroup, natAddrMapRowStatus=natAddrMapRowStatus, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natStatsProtocolGroup=natStatsProtocolGroup, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natAddrMapIndex=natAddrMapIndex, natAddrMapProtocol=natAddrMapProtocol, natAddrBindEntry=natAddrBindEntry, natAddrMapAddrUsed=natAddrMapAddrUsed, natInterfaceEntry=natInterfaceEntry, natMappingEntry=natMappingEntry, ProtocolNumber=ProtocolNumber, natAddrMapStorageType=natAddrMapStorageType, natAddrMapCompliance=natAddrMapCompliance, NatProtocolType=NatProtocolType, natSubscribersTable=natSubscribersTable, natSessionEntry=natSessionEntry, natMIBGroups=natMIBGroups, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natMapIntAddrExtType=natMapIntAddrExtType, NatAddrMapId=NatAddrMapId, natCGNCompliance=natCGNCompliance, natPoolRangeEnd=natPoolRangeEnd, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natAddrBindInTranslates=natAddrBindInTranslates, natMappingIntAddress=natMappingIntAddress, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natGroupAddrMapObjects=natGroupAddrMapObjects, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natMappingIntAddressType=natMappingIntAddressType, natCountersTable=natCountersTable, natSessionPublicDstAddr=natSessionPublicDstAddr, natPoolRangePoolIndex=natPoolRangePoolIndex)
mibBuilder.exportSymbols("NAT-MIB", natMapIntAddrEntry=natMapIntAddrEntry, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natProtocol=natProtocol, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natAddrBindType=natAddrBindType)
