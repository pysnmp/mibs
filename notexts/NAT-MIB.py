...
ifCounterDiscontinuityGroup, InterfaceIndex, ifIndex = mibBuilder.importSymbols("IF-MIB", "ifCounterDiscontinuityGroup", "InterfaceIndex", "ifIndex")
...
mibBuilder.exportSymbols("NAT-MIB", natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natSubscriberIntPrefix=natSubscriberIntPrefix, natLimitsEntry=natLimitsEntry, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natBasicStatelessCompliance=natBasicStatelessCompliance, natMappingRemovals=natMappingRemovals, natMIBNotifications=natMIBNotifications, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natAddrMapEntry=natAddrMapEntry, natProtocol=natProtocol, natMappingSubsIndex=natMappingSubsIndex, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natInterfaceStorageType=natInterfaceStorageType, natSubscriberResourceErrors=natSubscriberResourceErrors, natSessionPrivateAddrType=natSessionPrivateAddrType, natAddrBindType=natAddrBindType, natMappingFilterBehavior=natMappingFilterBehavior, natStatsAddrMapGroup=natStatsAddrMapGroup, natMappingExtRealm=natMappingExtRealm, natMappingExtAddress=natMappingExtAddress, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natFragmentsCompliance=natFragmentsCompliance, natCGNCompliance=natCGNCompliance, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, ProtocolNumber=ProtocolNumber, natSessionAddrMapIndex=natSessionAddrMapIndex, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natPoolWatermarkLow=natPoolWatermarkLow, natAddrBindMapIndex=natAddrBindMapIndex, natSessionIndex=natSessionIndex, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natProtocolTable=natProtocolTable, natMIB=natMIB, SubscriberIndex=SubscriberIndex, NatAssociationType=NatAssociationType, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natAddrPortBindType=natAddrPortBindType, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natPoolRangeDeallocations=natPoolRangeDeallocations, NatBindIdOrZero=NatBindIdOrZero, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natMIBObjects=natMIBObjects, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natGroupStatefulObjects=natGroupStatefulObjects, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natConfigGroup=natConfigGroup, natMappingMapBehavior=natMappingMapBehavior, natSubscriberIdentifierType=natSubscriberIdentifierType, natInterfaceRealm=natInterfaceRealm, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natAddrMapAddrUsed=natAddrMapAddrUsed, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natInterfaceEntry=natInterfaceEntry, natSessionPrivateDstPort=natSessionPrivateDstPort, natL4ProtocolTranslations=natL4ProtocolTranslations, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natPoolWatermarkHigh=natPoolWatermarkHigh, natNotifAddrMappings=natNotifAddrMappings, natSubscriberIndex=natSubscriberIndex, natNotifCtrl=natNotifCtrl, natMapIntAddrInt=natMapIntAddrInt, natInterfaceServiceType=natInterfaceServiceType, natAddrMapCompliance=natAddrMapCompliance, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natInterfaceDiscards=natInterfaceDiscards, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natGroupAddrMapObjects=natGroupAddrMapObjects, natInstanceIndex=natInstanceIndex, natAddrMapInTranslates=natAddrMapInTranslates, natL4ProtocolTable=natL4ProtocolTable, natSessionPublicAddrType=natSessionPublicAddrType, natInterfaceRowStatus=natInterfaceRowStatus, natProtocolDiscards=natProtocolDiscards, natMapIntAddrExtType=natMapIntAddrExtType, natMIBGroups=natMIBGroups, natSubscriberLimitMappings=natSubscriberLimitMappings, natSubscribersTable=natSubscribersTable, natGroupBasicNotifications=natGroupBasicNotifications, natMappingCreations=natMappingCreations, natTcpDefNegTimeout=natTcpDefNegTimeout, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natMappingEntry=natMappingEntry, natAddressMappingCreations=natAddressMappingCreations, natPoolEntry=natPoolEntry, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natSessionDirection=natSessionDirection, natNotifSubscriberMappings=natNotifSubscriberMappings, natStatsInterfaceGroup=natStatsInterfaceGroup, natAddrBindTable=natAddrBindTable, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natInstanceEntry=natInstanceEntry, natNotifMappings=natNotifMappings, natSubscribers=natSubscribers, natProtocolOutTranslates=natProtocolOutTranslates, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natMIBConformance=natMIBConformance, natInstanceAlias=natInstanceAlias, natLimitsTable=natLimitsTable, natPoolRangeBegin=natPoolRangeBegin, natAddrMapOutTranslates=natAddrMapOutTranslates, NatProtocolType=NatProtocolType, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natSubsInterfaceIndex=natSubsInterfaceIndex, natBindDefIdleTimeout=natBindDefIdleTimeout, natPoolRangeEntry=natPoolRangeEntry, natMappingIntAddressType=natMappingIntAddressType, natSessionTable=natSessionTable, natPoolRangeType=natPoolRangeType, natAddrMapStorageType=natAddrMapStorageType, natSessionUpTime=natSessionUpTime, natMIBFullCompliance=natMIBFullCompliance, natL4ProtocolEntry=natL4ProtocolEntry, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natMappingExtAddressType=natMappingExtAddressType, natMapIntAddrTable=natMapIntAddrTable, natPoolObjects=natPoolObjects, natProtocolEntry=natProtocolEntry, natGroupSubscriberObjects=natGroupSubscriberObjects, NatProtocolMap=NatProtocolMap, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natCounters=natCounters, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natMapObjects=natMapObjects, natInterfaceOutTranslates=natInterfaceOutTranslates, natAddrMapIndex=natAddrMapIndex, natCountersTable=natCountersTable, natPoolIndex=natPoolIndex, natSessionProtocolType=natSessionProtocolType, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natMIBCompliances=natMIBCompliances, NatBindMode=NatBindMode, natInstanceTable=natInstanceTable, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natMappingIntAddress=natMappingIntAddress, natAddrMapRowStatus=natAddrMapRowStatus, natCountersEntry=natCountersEntry, natPoolRangeAllocations=natPoolRangeAllocations, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natAddrPortBindProtocol=natAddrPortBindProtocol, natSessionPublicDstAddr=natSessionPublicDstAddr, natMappingIntPort=natMappingIntPort, natAddrPortBindTable=natAddrPortBindTable, natAddrPortBindId=natAddrPortBindId, NatPoolId=NatPoolId, natAddrBindEntry=natAddrBindEntry, natPacketDiscard=natPacketDiscard, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natAddrMapTable=natAddrMapTable, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natTranslations=natTranslations, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natSessionPublicSrcPort=natSessionPublicSrcPort, natAddrMapProtocol=natAddrMapProtocol, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natSessionInTranslates=natSessionInTranslates, natPoolRangeEnd=natPoolRangeEnd, natMapIntAddrIntType=natMapIntAddrIntType, natGroupFragmentObjects=natGroupFragmentObjects, natSessionOutTranslates=natSessionOutTranslates, natSessionPublicDstPort=natSessionPublicDstPort, VlanIndexOrZero=VlanIndexOrZero, natAddressMappingRemovals=natAddressMappingRemovals, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natLimitAddressMappings=natLimitAddressMappings, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natResourceErrors=natResourceErrors, natMappingTable=natMappingTable, natPoolRangePoolIndex=natPoolRangePoolIndex, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natInterfaceInTranslates=natInterfaceInTranslates, natMappingIntRealm=natMappingIntRealm, NatSessionId=NatSessionId, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natAddrBindInTranslates=natAddrBindInTranslates, natSubscriberRealm=natSubscriberRealm, NatTranslationEntity=NatTranslationEntity, natStatsProtocolGroup=natStatsProtocolGroup, natLimitFragments=natLimitFragments, natProtocolInTranslates=natProtocolInTranslates, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natAddrMapEntryType=natAddrMapEntryType, natQuotaDrops=natQuotaDrops, natAddrMapDiscards=natAddrMapDiscards, PYSNMP_MODULE_ID=natMIB, natAddrBindSessions=natAddrBindSessions, natSubscriberMappingCreations=natSubscriberMappingCreations, natMapIntAddrEntry=natMapIntAddrEntry, NatBindId=NatBindId, natAddrMapName=natAddrMapName, natAddrBindLocalAddr=natAddrBindLocalAddr, natSessionEntry=natSessionEntry, natMappingPool=natMappingPool, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natAddrPortBindSessions=natAddrPortBindSessions, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, NatBehaviorType=NatBehaviorType, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natMapIntAddrExt=natMapIntAddrExt, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natTranslationGroup=natTranslationGroup, natMappingProto=natMappingProto, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natInterfaceTable=natInterfaceTable, natAddrPortBindEntry=natAddrPortBindEntry, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natSubscriberTranslations=natSubscriberTranslations, natAddrBindOutTranslates=natAddrBindOutTranslates, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natLimitMappings=natLimitMappings, natL4ProtocolNumber=natL4ProtocolNumber, natPoolRealm=natPoolRealm, natPoolRangeTable=natPoolRangeTable, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natBasicStatefulCompliance=natBasicStatefulCompliance, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natPoolPortMax=natPoolPortMax, natAddrPortBindMapIndex=natAddrPortBindMapIndex, NatAddrMapId=NatAddrMapId, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natMIBNotificationGroup=natMIBNotificationGroup, natPoolPortMin=natPoolPortMin, natMappingExtPort=natMappingExtPort, natMappingAddressPooling=natMappingAddressPooling, NatPoolingType=NatPoolingType, natSubscribersEntry=natSubscribersEntry, SubscriberIdentifierType=SubscriberIdentifierType, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natLimitSubscribers=natLimitSubscribers, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natGroupStatelessObjects=natGroupStatelessObjects, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natOutOfPortErrors=natOutOfPortErrors, natAddrBindId=natAddrBindId, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natPoolTable=natPoolTable)
mibBuilder.exportSymbols("NAT-MIB", natNotifThrottlingInterval=natNotifThrottlingInterval, natDefTimeouts=natDefTimeouts, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natSessionMaxIdleTime=natSessionMaxIdleTime)
