...
mibBuilder.exportSymbols("NAT-MIB", natPoolWatermarkLow=natPoolWatermarkLow, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natL4ProtocolNumber=natL4ProtocolNumber, NatSessionId=NatSessionId, natSubscribersEntry=natSubscribersEntry, natCounters=natCounters, natSessionOutTranslates=natSessionOutTranslates, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natSessionPrivateAddrType=natSessionPrivateAddrType, natAddrPortBindId=natAddrPortBindId, natBindDefIdleTimeout=natBindDefIdleTimeout, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natProtocolEntry=natProtocolEntry, natInterfaceInTranslates=natInterfaceInTranslates, natMapIntAddrExt=natMapIntAddrExt, natMappingAddressPooling=natMappingAddressPooling, natNotifSubscriberMappings=natNotifSubscriberMappings, natMappingExtAddress=natMappingExtAddress, natMappingProto=natMappingProto, natPoolRangeBegin=natPoolRangeBegin, natMapIntAddrInt=natMapIntAddrInt, natAddrBindOutTranslates=natAddrBindOutTranslates, natResourceErrors=natResourceErrors, natAddrMapCompliance=natAddrMapCompliance, natAddrPortBindProtocol=natAddrPortBindProtocol, natAddrMapInTranslates=natAddrMapInTranslates, natAddrBindInTranslates=natAddrBindInTranslates, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natProtocolOutTranslates=natProtocolOutTranslates, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natMappingEntry=natMappingEntry, natAddrBindType=natAddrBindType, natAddrMapEntryType=natAddrMapEntryType, natMappingTable=natMappingTable, natLimitFragments=natLimitFragments, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natSessionUpTime=natSessionUpTime, natStatsProtocolGroup=natStatsProtocolGroup, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natAddrBindLocalAddr=natAddrBindLocalAddr, natSessionPrivateDstAddr=natSessionPrivateDstAddr, SubscriberIdentifierType=SubscriberIdentifierType, natConfigGroup=natConfigGroup, natPoolRangeDeallocations=natPoolRangeDeallocations, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natNotifAddrMappings=natNotifAddrMappings, natMappingExtPort=natMappingExtPort, natInterfaceDiscards=natInterfaceDiscards, natLimitsTable=natLimitsTable, natInterfaceServiceType=natInterfaceServiceType, natBasicStatefulCompliance=natBasicStatefulCompliance, natInterfaceRealm=natInterfaceRealm, natSubscriberIntPrefix=natSubscriberIntPrefix, natQuotaDrops=natQuotaDrops, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natDefTimeouts=natDefTimeouts, natMappingIntAddressType=natMappingIntAddressType, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natSubscriberIndex=natSubscriberIndex, natGroupSubscriberObjects=natGroupSubscriberObjects, natAddrBindMapIndex=natAddrBindMapIndex, natGroupBasicNotifications=natGroupBasicNotifications, natSessionDirection=natSessionDirection, natBasicStatelessCompliance=natBasicStatelessCompliance, natProtocolTable=natProtocolTable, PYSNMP_MODULE_ID=natMIB, natInstanceIndex=natInstanceIndex, natSessionAddrMapIndex=natSessionAddrMapIndex, natSubscriberLimitMappings=natSubscriberLimitMappings, natGroupStatefulObjects=natGroupStatefulObjects, natLimitsEntry=natLimitsEntry, natMappingIntPort=natMappingIntPort, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natCountersTable=natCountersTable, natCountersEntry=natCountersEntry, natSessionPublicSrcPort=natSessionPublicSrcPort, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natSubscriberQuotaDrops=natSubscriberQuotaDrops, NatBindIdOrZero=NatBindIdOrZero, natPoolRealm=natPoolRealm, natSubscribers=natSubscribers, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natMIBObjects=natMIBObjects, natSessionIndex=natSessionIndex, natPoolObjects=natPoolObjects, natPoolEntry=natPoolEntry, natSessionCurrentIdleTime=natSessionCurrentIdleTime, NatTranslationEntity=NatTranslationEntity, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natMIB=natMIB, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natMapIntAddrEntry=natMapIntAddrEntry, natAddrMapOutTranslates=natAddrMapOutTranslates, natSessionPrivateDstPort=natSessionPrivateDstPort, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natNotifThrottlingInterval=natNotifThrottlingInterval, natMapIntAddrTable=natMapIntAddrTable, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natSubscriberIdentifierType=natSubscriberIdentifierType, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natSessionPublicSrcAddr=natSessionPublicSrcAddr, VlanIndexOrZero=VlanIndexOrZero, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natL4ProtocolEntry=natL4ProtocolEntry, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natSessionInTranslates=natSessionInTranslates, natFragmentsCompliance=natFragmentsCompliance, natSessionPublicAddrType=natSessionPublicAddrType, natPoolRangeTable=natPoolRangeTable, natMapIntAddrIntType=natMapIntAddrIntType, natGroupAddrMapObjects=natGroupAddrMapObjects, natSubsInterfaceIndex=natSubsInterfaceIndex, natOutOfPortErrors=natOutOfPortErrors, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natPoolTable=natPoolTable, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natAddrMapName=natAddrMapName, natMappingExtAddressType=natMappingExtAddressType, natGroupStatelessObjects=natGroupStatelessObjects, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natMappingMapBehavior=natMappingMapBehavior, natAddrMapStorageType=natAddrMapStorageType, natNotifMappings=natNotifMappings, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natMIBConformance=natMIBConformance, NatPoolId=NatPoolId, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natLimitSubscribers=natLimitSubscribers, natInstanceTable=natInstanceTable, natAddrMapEntry=natAddrMapEntry, natMappingRemovals=natMappingRemovals, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natInterfaceStorageType=natInterfaceStorageType, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natGroupAddrMapNotifications=natGroupAddrMapNotifications, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natAddrMapIndex=natAddrMapIndex, natAddrBindId=natAddrBindId, natMappingSubsIndex=natMappingSubsIndex, natTcpDefNegTimeout=natTcpDefNegTimeout, natProtocolInTranslates=natProtocolInTranslates, natMappingIntAddress=natMappingIntAddress, natAddrMapRowStatus=natAddrMapRowStatus, natPoolRangeAllocations=natPoolRangeAllocations, natMIBCompliances=natMIBCompliances, natStatsAddrMapGroup=natStatsAddrMapGroup, natPoolWatermarkHigh=natPoolWatermarkHigh, natSubscriberTranslations=natSubscriberTranslations, natAddrPortBindType=natAddrPortBindType, natAddrBindTable=natAddrBindTable, natSessionProtocolType=natSessionProtocolType, natPoolRangeType=natPoolRangeType, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natInterfaceRowStatus=natInterfaceRowStatus, ProtocolNumber=ProtocolNumber, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natMIBNotificationGroup=natMIBNotificationGroup, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natL4ProtocolTable=natL4ProtocolTable, natPoolPortMax=natPoolPortMax, natPoolRangeEntry=natPoolRangeEntry, natPoolPortMin=natPoolPortMin, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natNotifCtrl=natNotifCtrl, natMappingCreations=natMappingCreations, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natSessionMaxIdleTime=natSessionMaxIdleTime, natAddrMapTable=natAddrMapTable, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natAddrMapAddrUsed=natAddrMapAddrUsed, natL4ProtocolTranslations=natL4ProtocolTranslations, natMappingPool=natMappingPool, natSessionPublicDstAddr=natSessionPublicDstAddr, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natTranslationGroup=natTranslationGroup, NatProtocolMap=NatProtocolMap, natTcpDefIdleTimeout=natTcpDefIdleTimeout, NatPoolingType=NatPoolingType, SubscriberIndex=SubscriberIndex, natMappingExtRealm=natMappingExtRealm, natGroupFragmentObjects=natGroupFragmentObjects, natPoolRangePoolIndex=natPoolRangePoolIndex, natSessionEntry=natSessionEntry, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natTranslations=natTranslations, NatAddrMapId=NatAddrMapId, natLimitMappings=natLimitMappings, NatBehaviorType=NatBehaviorType, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natProtocolDiscards=natProtocolDiscards, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natPoolIndex=natPoolIndex, natInterfaceEntry=natInterfaceEntry, natLimitAddressMappings=natLimitAddressMappings, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natSubscribersTable=natSubscribersTable, natAddrPortBindSessions=natAddrPortBindSessions, natCGNCompliance=natCGNCompliance, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natAddrPortBindTable=natAddrPortBindTable, NatAssociationType=NatAssociationType, natMIBNotifications=natMIBNotifications, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natPoolRangeEnd=natPoolRangeEnd, natSubscriberMappingCreations=natSubscriberMappingCreations, natMapIntAddrExtType=natMapIntAddrExtType, natAddressMappingCreations=natAddressMappingCreations, natInterfaceTable=natInterfaceTable, natAddrPortBindEntry=natAddrPortBindEntry, natProtocol=natProtocol, natInstanceEntry=natInstanceEntry, natMappingIntRealm=natMappingIntRealm, natInterfaceOutTranslates=natInterfaceOutTranslates, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natPacketDiscard=natPacketDiscard, natAddressMappingRemovals=natAddressMappingRemovals, natMappingFilterBehavior=natMappingFilterBehavior, natAddrBindSessions=natAddrBindSessions, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natAddrMapDiscards=natAddrMapDiscards, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natMIBGroups=natMIBGroups, natMIBFullCompliance=natMIBFullCompliance, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natSessionTable=natSessionTable, NatBindId=NatBindId, natInstanceAlias=natInstanceAlias, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natSessionPublicDstPort=natSessionPublicDstPort, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natAddrMapProtocol=natAddrMapProtocol, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natSubscriberResourceErrors=natSubscriberResourceErrors, natSubscriberRealm=natSubscriberRealm, natStatsInterfaceGroup=natStatsInterfaceGroup)
mibBuilder.exportSymbols("NAT-MIB", natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natMapObjects=natMapObjects, NatProtocolType=NatProtocolType, natAddrBindEntry=natAddrBindEntry, NatBindMode=NatBindMode)
