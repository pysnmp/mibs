...
mibBuilder.exportSymbols("NAT-MIB", natGroupStatefulObjects=natGroupStatefulObjects, natMIBObjects=natMIBObjects, natInterfaceTable=natInterfaceTable, natSessionMaxIdleTime=natSessionMaxIdleTime, natMappingExtAddressType=natMappingExtAddressType, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, NatTranslationEntity=NatTranslationEntity, natLimitsTable=natLimitsTable, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natQuotaDrops=natQuotaDrops, natAddrBindEntry=natAddrBindEntry, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natMapIntAddrExt=natMapIntAddrExt, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natProtocolInTranslates=natProtocolInTranslates, natSubscribers=natSubscribers, natInterfaceOutTranslates=natInterfaceOutTranslates, natLimitSubscribers=natLimitSubscribers, natBasicStatelessCompliance=natBasicStatelessCompliance, natAddrMapRowStatus=natAddrMapRowStatus, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natMappingFilterBehavior=natMappingFilterBehavior, natSubscriberIdentifierType=natSubscriberIdentifierType, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natDefTimeouts=natDefTimeouts, natSessionEntry=natSessionEntry, natMappingIntAddress=natMappingIntAddress, natAddrMapEntry=natAddrMapEntry, natCountersTable=natCountersTable, natPoolEntry=natPoolEntry, natSubscriberIntPrefix=natSubscriberIntPrefix, natSessionPublicDstAddr=natSessionPublicDstAddr, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natGroupSubscriberObjects=natGroupSubscriberObjects, natPacketDiscard=natPacketDiscard, natSubscriberMappingCreations=natSubscriberMappingCreations, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, NatBindIdOrZero=NatBindIdOrZero, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natMIBCompliances=natMIBCompliances, natSubscriberRealm=natSubscriberRealm, natSubscriberTranslations=natSubscriberTranslations, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natAddrMapStorageType=natAddrMapStorageType, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natGroupStatelessObjects=natGroupStatelessObjects, natMIBNotifications=natMIBNotifications, natPoolRangeTable=natPoolRangeTable, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natMappingIntPort=natMappingIntPort, natAddrBindTable=natAddrBindTable, NatAddrMapId=NatAddrMapId, natMappingEntry=natMappingEntry, natMappingProto=natMappingProto, natProtocolOutTranslates=natProtocolOutTranslates, NatBindMode=NatBindMode, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natAddrPortBindType=natAddrPortBindType, natMappingIntRealm=natMappingIntRealm, natPoolTable=natPoolTable, natAddrMapInTranslates=natAddrMapInTranslates, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natStatsInterfaceGroup=natStatsInterfaceGroup, natSessionPublicDstPort=natSessionPublicDstPort, natAddrMapProtocol=natAddrMapProtocol, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natPoolObjects=natPoolObjects, natMIBNotificationGroup=natMIBNotificationGroup, natMappingExtAddress=natMappingExtAddress, NatBindId=NatBindId, natAddrMapIndex=natAddrMapIndex, natSubscriberLimitMappings=natSubscriberLimitMappings, natBasicStatefulCompliance=natBasicStatefulCompliance, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natNotifThrottlingInterval=natNotifThrottlingInterval, natTcpDefNegTimeout=natTcpDefNegTimeout, natMIB=natMIB, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natGroupFragmentObjects=natGroupFragmentObjects, natLimitFragments=natLimitFragments, natSessionProtocolType=natSessionProtocolType, natPoolRangeBegin=natPoolRangeBegin, natPoolRangeDeallocations=natPoolRangeDeallocations, natPoolRealm=natPoolRealm, natTranslations=natTranslations, natMapIntAddrTable=natMapIntAddrTable, natPoolIndex=natPoolIndex, NatPoolingType=NatPoolingType, natPoolWatermarkLow=natPoolWatermarkLow, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natNotifMappings=natNotifMappings, natMappingMapBehavior=natMappingMapBehavior, natProtocolEntry=natProtocolEntry, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natInterfaceEntry=natInterfaceEntry, natAddrBindLocalAddr=natAddrBindLocalAddr, natAddrMapCompliance=natAddrMapCompliance, natPoolRangeAllocations=natPoolRangeAllocations, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natMIBConformance=natMIBConformance, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natLimitsEntry=natLimitsEntry, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natMapObjects=natMapObjects, natSubscribersEntry=natSubscribersEntry, natFragmentsCompliance=natFragmentsCompliance, natAddrBindId=natAddrBindId, natMappingRemovals=natMappingRemovals, natSessionPrivateAddrType=natSessionPrivateAddrType, natAddrPortBindTable=natAddrPortBindTable, natAddrMapTable=natAddrMapTable, natAddrMapOutTranslates=natAddrMapOutTranslates, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natMapIntAddrExtType=natMapIntAddrExtType, natSubsInterfaceIndex=natSubsInterfaceIndex, natMappingExtPort=natMappingExtPort, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natInstanceEntry=natInstanceEntry, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natAddrMapEntryType=natAddrMapEntryType, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natAddrBindInTranslates=natAddrBindInTranslates, natLimitAddressMappings=natLimitAddressMappings, natSubscriberResourceErrors=natSubscriberResourceErrors, natAddressMappingRemovals=natAddressMappingRemovals, natConfigGroup=natConfigGroup, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natAddrPortBindId=natAddrPortBindId, natNotifSubscriberMappings=natNotifSubscriberMappings, natGroupAddrMapObjects=natGroupAddrMapObjects, natInterfaceStorageType=natInterfaceStorageType, natCGNCompliance=natCGNCompliance, natMappingExtRealm=natMappingExtRealm, natAddrMapDiscards=natAddrMapDiscards, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natInterfaceRowStatus=natInterfaceRowStatus, natPoolPortMax=natPoolPortMax, natMIBGroups=natMIBGroups, natPoolPortMin=natPoolPortMin, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natProtocolDiscards=natProtocolDiscards, natCountersEntry=natCountersEntry, natMapIntAddrIntType=natMapIntAddrIntType, natNotifCtrl=natNotifCtrl, natSessionPublicSrcPort=natSessionPublicSrcPort, natAddrPortBindSessions=natAddrPortBindSessions, natProtocol=natProtocol, NatProtocolType=NatProtocolType, natL4ProtocolEntry=natL4ProtocolEntry, natPoolWatermarkHigh=natPoolWatermarkHigh, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natNotifAddrMappings=natNotifAddrMappings, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natSubscribersTable=natSubscribersTable, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natSessionAddrMapIndex=natSessionAddrMapIndex, SubscriberIdentifierType=SubscriberIdentifierType, natProtocolTable=natProtocolTable, natInstanceAlias=natInstanceAlias, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natAddrBindMapIndex=natAddrBindMapIndex, PYSNMP_MODULE_ID=natMIB, natGroupBasicNotifications=natGroupBasicNotifications, natL4ProtocolTable=natL4ProtocolTable, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natAddrBindSessions=natAddrBindSessions, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, SubscriberIndex=SubscriberIndex, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natSessionIndex=natSessionIndex, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, NatProtocolMap=NatProtocolMap, NatAssociationType=NatAssociationType, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natSessionOutTranslates=natSessionOutTranslates, natAddrBindGlobalAddr=natAddrBindGlobalAddr, NatPoolId=NatPoolId, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natL4ProtocolNumber=natL4ProtocolNumber, natMIBFullCompliance=natMIBFullCompliance, natTranslationGroup=natTranslationGroup, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natPoolRangeEnd=natPoolRangeEnd, natLimitMappings=natLimitMappings, natInterfaceServiceType=natInterfaceServiceType, natSessionTable=natSessionTable, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natStatsProtocolGroup=natStatsProtocolGroup, natPoolRangeType=natPoolRangeType, natAddressMappingCreations=natAddressMappingCreations, natPoolRangePoolIndex=natPoolRangePoolIndex, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natInstanceTable=natInstanceTable, natInstanceIndex=natInstanceIndex, natAddrPortBindEntry=natAddrPortBindEntry, natAddrBindType=natAddrBindType, NatSessionId=NatSessionId, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natMapIntAddrEntry=natMapIntAddrEntry, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natMappingIntAddressType=natMappingIntAddressType, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natSessionDirection=natSessionDirection, natSessionPrivateDstPort=natSessionPrivateDstPort, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natInterfaceDiscards=natInterfaceDiscards, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natMappingSubsIndex=natMappingSubsIndex, natL4ProtocolTranslations=natL4ProtocolTranslations, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natAddrPortBindProtocol=natAddrPortBindProtocol, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natResourceErrors=natResourceErrors, natMapIntAddrInt=natMapIntAddrInt, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natAddrBindOutTranslates=natAddrBindOutTranslates, natSessionUpTime=natSessionUpTime, natInterfaceRealm=natInterfaceRealm, natAddrMapName=natAddrMapName, natMappingCreations=natMappingCreations, natSubscriberIndex=natSubscriberIndex, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natCounters=natCounters, natInterfaceInTranslates=natInterfaceInTranslates, natMappingAddressPooling=natMappingAddressPooling, natPoolRangeEntry=natPoolRangeEntry, natMappingPool=natMappingPool, natStatsAddrMapGroup=natStatsAddrMapGroup, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natSessionPublicAddrType=natSessionPublicAddrType, ProtocolNumber=ProtocolNumber, VlanIndexOrZero=VlanIndexOrZero, natOutOfPortErrors=natOutOfPortErrors, natBindDefIdleTimeout=natBindDefIdleTimeout, natSessionInTranslates=natSessionInTranslates)
mibBuilder.exportSymbols("NAT-MIB", natAddrMapLocalPortTo=natAddrMapLocalPortTo, natMappingTable=natMappingTable, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natAddrMapAddrUsed=natAddrMapAddrUsed, NatBehaviorType=NatBehaviorType)
