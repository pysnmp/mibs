...
mibBuilder.exportSymbols("NAT-MIB", natDefTimeouts=natDefTimeouts, natAddrMapEntry=natAddrMapEntry, natMappingAddressPooling=natMappingAddressPooling, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natProtocolOutTranslates=natProtocolOutTranslates, natMIBNotifications=natMIBNotifications, natMappingRemovals=natMappingRemovals, natSubscriberLimitMappings=natSubscriberLimitMappings, natSessionDirection=natSessionDirection, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natInstanceIndex=natInstanceIndex, PYSNMP_MODULE_ID=natMIB, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natCountersEntry=natCountersEntry, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natMIBObjects=natMIBObjects, natAddrMapInTranslates=natAddrMapInTranslates, natInterfaceDiscards=natInterfaceDiscards, natSessionIndex=natSessionIndex, NatSessionId=NatSessionId, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natInstanceTable=natInstanceTable, natMappingIntAddress=natMappingIntAddress, natInterfaceServiceType=natInterfaceServiceType, natL4ProtocolTranslations=natL4ProtocolTranslations, natInterfaceRealm=natInterfaceRealm, natAddressMappingRemovals=natAddressMappingRemovals, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natPoolRangeTable=natPoolRangeTable, natStatsProtocolGroup=natStatsProtocolGroup, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natSessionPrivateDstPort=natSessionPrivateDstPort, natTranslationGroup=natTranslationGroup, natSessionAddrMapIndex=natSessionAddrMapIndex, natCounters=natCounters, natLimitFragments=natLimitFragments, natMapIntAddrExt=natMapIntAddrExt, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natAddrMapTable=natAddrMapTable, natNotifAddrMappings=natNotifAddrMappings, natMappingProto=natMappingProto, natMIB=natMIB, natL4ProtocolNumber=natL4ProtocolNumber, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natLimitAddressMappings=natLimitAddressMappings, natStatsAddrMapGroup=natStatsAddrMapGroup, natSessionPublicAddrType=natSessionPublicAddrType, natSessionPublicSrcPort=natSessionPublicSrcPort, natSessionPublicDstAddr=natSessionPublicDstAddr, natSessionPrivateAddrType=natSessionPrivateAddrType, natAddrBindInTranslates=natAddrBindInTranslates, natAddrMapAddrUsed=natAddrMapAddrUsed, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natSubscriberMappingCreations=natSubscriberMappingCreations, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natPoolObjects=natPoolObjects, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natSubscribersEntry=natSubscribersEntry, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natQuotaDrops=natQuotaDrops, natMappingSubsIndex=natMappingSubsIndex, natProtocolInTranslates=natProtocolInTranslates, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natMappingIntRealm=natMappingIntRealm, natGroupBasicNotifications=natGroupBasicNotifications, natAddrBindTranslationEntity=natAddrBindTranslationEntity, NatBindId=NatBindId, natPoolRangeEnd=natPoolRangeEnd, natSessionProtocolType=natSessionProtocolType, natSessionMaxIdleTime=natSessionMaxIdleTime, natGroupSubscriberObjects=natGroupSubscriberObjects, natMapObjects=natMapObjects, ProtocolNumber=ProtocolNumber, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natCountersTable=natCountersTable, natAddrMapIndex=natAddrMapIndex, natMIBGroups=natMIBGroups, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natPoolPortMin=natPoolPortMin, natMappingIntPort=natMappingIntPort, natAddrMapStorageType=natAddrMapStorageType, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natProtocolDiscards=natProtocolDiscards, natSubscriberIndex=natSubscriberIndex, natAddrMapLocalPortTo=natAddrMapLocalPortTo, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natSubscriberResourceErrors=natSubscriberResourceErrors, natAddrPortBindId=natAddrPortBindId, natSubscribersTable=natSubscribersTable, natAddrPortBindType=natAddrPortBindType, natFragmentsCompliance=natFragmentsCompliance, natInstanceAlias=natInstanceAlias, natStatsInterfaceGroup=natStatsInterfaceGroup, natL4ProtocolTable=natL4ProtocolTable, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natMapIntAddrIntType=natMapIntAddrIntType, natMappingExtRealm=natMappingExtRealm, NatBindMode=NatBindMode, natGroupAddrMapObjects=natGroupAddrMapObjects, natSubsInterfaceIndex=natSubsInterfaceIndex, natPoolRangeBegin=natPoolRangeBegin, natAddrBindSessions=natAddrBindSessions, natMapIntAddrInt=natMapIntAddrInt, NatBindIdOrZero=NatBindIdOrZero, natPoolWatermarkHigh=natPoolWatermarkHigh, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natAddrPortBindSessions=natAddrPortBindSessions, natTranslations=natTranslations, natNotifSubscriberMappings=natNotifSubscriberMappings, natAddrBindType=natAddrBindType, natBasicStatelessCompliance=natBasicStatelessCompliance, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natSubscriberIdentifierType=natSubscriberIdentifierType, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natPoolRangeEntry=natPoolRangeEntry, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natAddrPortBindProtocol=natAddrPortBindProtocol, NatProtocolMap=NatProtocolMap, natAddrMapEntryType=natAddrMapEntryType, natAddrMapRowStatus=natAddrMapRowStatus, SubscriberIndex=SubscriberIndex, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natL4ProtocolEntry=natL4ProtocolEntry, natInterfaceRowStatus=natInterfaceRowStatus, natAddrBindOutTranslates=natAddrBindOutTranslates, natMappingExtAddress=natMappingExtAddress, natMappingMapBehavior=natMappingMapBehavior, natAddrBindLocalAddr=natAddrBindLocalAddr, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natAddrMapName=natAddrMapName, natAddrBindId=natAddrBindId, natMIBCompliances=natMIBCompliances, natLimitsTable=natLimitsTable, natMapIntAddrExtType=natMapIntAddrExtType, natAddrBindEntry=natAddrBindEntry, natOutOfPortErrors=natOutOfPortErrors, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natPacketDiscard=natPacketDiscard, natNotifMappings=natNotifMappings, natProtocolEntry=natProtocolEntry, natPoolTable=natPoolTable, natCGNCompliance=natCGNCompliance, natSessionOutTranslates=natSessionOutTranslates, natMapIntAddrTable=natMapIntAddrTable, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natPoolRealm=natPoolRealm, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natAddrMapDiscards=natAddrMapDiscards, natMappingIntAddressType=natMappingIntAddressType, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natSubscribers=natSubscribers, natAddrMapCompliance=natAddrMapCompliance, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natMapIntAddrEntry=natMapIntAddrEntry, natInstanceEntry=natInstanceEntry, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, NatAssociationType=NatAssociationType, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natConfigGroup=natConfigGroup, NatTranslationEntity=NatTranslationEntity, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natMappingExtPort=natMappingExtPort, natSessionEntry=natSessionEntry, natAddrPortBindTable=natAddrPortBindTable, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, NatProtocolType=NatProtocolType, natProtocol=natProtocol, natAddrBindTable=natAddrBindTable, natInterfaceOutTranslates=natInterfaceOutTranslates, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natSessionInTranslates=natSessionInTranslates, natTcpDefNegTimeout=natTcpDefNegTimeout, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natAddrMapOutTranslates=natAddrMapOutTranslates, natSubscriberTranslations=natSubscriberTranslations, VlanIndexOrZero=VlanIndexOrZero, natMappingCreations=natMappingCreations, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natPoolIndex=natPoolIndex, natMappingExtAddressType=natMappingExtAddressType, natResourceErrors=natResourceErrors, natNotifThrottlingInterval=natNotifThrottlingInterval, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natMappingTable=natMappingTable, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natGroupStatelessObjects=natGroupStatelessObjects, natBasicStatefulCompliance=natBasicStatefulCompliance, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natPoolRangeType=natPoolRangeType, natAddrMapProtocol=natAddrMapProtocol, natInterfaceTable=natInterfaceTable, natPoolEntry=natPoolEntry, natSessionTable=natSessionTable, natSessionPublicDstPort=natSessionPublicDstPort, natMappingFilterBehavior=natMappingFilterBehavior, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, NatAddrMapId=NatAddrMapId, natLimitsEntry=natLimitsEntry, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natLimitSubscribers=natLimitSubscribers, natSubscriberIntPrefix=natSubscriberIntPrefix, natPoolRangePoolIndex=natPoolRangePoolIndex, natGroupFragmentObjects=natGroupFragmentObjects, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natPoolPortMax=natPoolPortMax, natSessionUpTime=natSessionUpTime, NatPoolId=NatPoolId, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natInterfaceEntry=natInterfaceEntry, natAddrPortBindEntry=natAddrPortBindEntry, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natInterfaceInTranslates=natInterfaceInTranslates, natPoolRangeAllocations=natPoolRangeAllocations, natInterfaceStorageType=natInterfaceStorageType, SubscriberIdentifierType=SubscriberIdentifierType, natAddressMappingCreations=natAddressMappingCreations, natSubscriberRealm=natSubscriberRealm, natMappingEntry=natMappingEntry, natNotifCtrl=natNotifCtrl, natPoolRangeDeallocations=natPoolRangeDeallocations, natGroupStatefulObjects=natGroupStatefulObjects, natMIBFullCompliance=natMIBFullCompliance, natMIBNotificationGroup=natMIBNotificationGroup, NatBehaviorType=NatBehaviorType, natLimitMappings=natLimitMappings, natPoolWatermarkLow=natPoolWatermarkLow, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natMappingPool=natMappingPool, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, NatPoolingType=NatPoolingType, natBindDefIdleTimeout=natBindDefIdleTimeout)
mibBuilder.exportSymbols("NAT-MIB", natMIBConformance=natMIBConformance, natProtocolTable=natProtocolTable, natAddrBindMapIndex=natAddrBindMapIndex, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natSessionPrivateSrcPort=natSessionPrivateSrcPort)
