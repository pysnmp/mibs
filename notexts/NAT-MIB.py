...
mibBuilder.exportSymbols("NAT-MIB", natMapObjects=natMapObjects, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, SubscriberIndex=SubscriberIndex, natBindDefIdleTimeout=natBindDefIdleTimeout, natLimitsTable=natLimitsTable, natNotifAddrMappings=natNotifAddrMappings, natInterfaceOutTranslates=natInterfaceOutTranslates, natPoolRangeType=natPoolRangeType, natMappingExtRealm=natMappingExtRealm, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natCGNCompliance=natCGNCompliance, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natAddrPortBindSessions=natAddrPortBindSessions, natAddrMapInTranslates=natAddrMapInTranslates, natAddrBindLocalAddrType=natAddrBindLocalAddrType, NatBindMode=NatBindMode, natMappingPool=natMappingPool, natAddrPortBindType=natAddrPortBindType, NatAssociationType=NatAssociationType, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natInterfaceRealm=natInterfaceRealm, natSessionProtocolType=natSessionProtocolType, natSessionPublicDstAddr=natSessionPublicDstAddr, natSessionTable=natSessionTable, VlanIndexOrZero=VlanIndexOrZero, natAddrPortBindEntry=natAddrPortBindEntry, natMapIntAddrEntry=natMapIntAddrEntry, natSubscriberTranslations=natSubscriberTranslations, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natL4ProtocolEntry=natL4ProtocolEntry, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natPoolEntry=natPoolEntry, NatTranslationEntity=NatTranslationEntity, natAddressMappingCreations=natAddressMappingCreations, natInstanceAlias=natInstanceAlias, natPoolRangeTable=natPoolRangeTable, natMappingIntAddressType=natMappingIntAddressType, natAddrMapEntryType=natAddrMapEntryType, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natMIBNotificationGroup=natMIBNotificationGroup, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natMappingIntAddress=natMappingIntAddress, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natPoolRangeEnd=natPoolRangeEnd, natAddrBindSessions=natAddrBindSessions, natMappingTable=natMappingTable, natSubscribers=natSubscribers, NatProtocolType=NatProtocolType, natTcpDefNegTimeout=natTcpDefNegTimeout, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natProtocolOutTranslates=natProtocolOutTranslates, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natSubscriberRealm=natSubscriberRealm, natSessionIndex=natSessionIndex, natGroupStatelessObjects=natGroupStatelessObjects, natInterfaceInTranslates=natInterfaceInTranslates, natSubscribersEntry=natSubscribersEntry, natTranslationGroup=natTranslationGroup, natNotifThrottlingInterval=natNotifThrottlingInterval, natSessionPublicSrcPort=natSessionPublicSrcPort, natSessionInTranslates=natSessionInTranslates, natInstanceTable=natInstanceTable, natPoolRangePoolIndex=natPoolRangePoolIndex, ProtocolNumber=ProtocolNumber, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natL4ProtocolTable=natL4ProtocolTable, natMappingAddressPooling=natMappingAddressPooling, natMappingProto=natMappingProto, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natOutOfPortErrors=natOutOfPortErrors, natL4ProtocolNumber=natL4ProtocolNumber, natPoolRangeEntry=natPoolRangeEntry, natAddrMapEntry=natAddrMapEntry, natSessionAddrMapIndex=natSessionAddrMapIndex, natProtocolInTranslates=natProtocolInTranslates, natNotifCtrl=natNotifCtrl, natAddrBindInTranslates=natAddrBindInTranslates, natAddrMapStorageType=natAddrMapStorageType, natBasicStatelessCompliance=natBasicStatelessCompliance, natPoolPortMax=natPoolPortMax, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natInterfaceEntry=natInterfaceEntry, natAddrMapTable=natAddrMapTable, natPoolRealm=natPoolRealm, natPoolRangeAllocations=natPoolRangeAllocations, natMappingIntRealm=natMappingIntRealm, natAddressMappingRemovals=natAddressMappingRemovals, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natMapIntAddrExt=natMapIntAddrExt, natAddrMapOutTranslates=natAddrMapOutTranslates, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natInterfaceStorageType=natInterfaceStorageType, NatSessionId=NatSessionId, natInterfaceDiscards=natInterfaceDiscards, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natSessionOutTranslates=natSessionOutTranslates, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natProtocolDiscards=natProtocolDiscards, NatBehaviorType=NatBehaviorType, natMapIntAddrIntType=natMapIntAddrIntType, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natMappingExtAddress=natMappingExtAddress, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natGroupStatefulObjects=natGroupStatefulObjects, natInstanceEntry=natInstanceEntry, natSubscriberIndex=natSubscriberIndex, natAddrPortBindId=natAddrPortBindId, natSessionUpTime=natSessionUpTime, natSubscriberMappingCreations=natSubscriberMappingCreations, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natGroupFragmentObjects=natGroupFragmentObjects, natSubscriberResourceErrors=natSubscriberResourceErrors, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natAddrMapCompliance=natAddrMapCompliance, natAddrMapIndex=natAddrMapIndex, natCountersTable=natCountersTable, natBasicStatefulCompliance=natBasicStatefulCompliance, natAddrBindType=natAddrBindType, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natMIBFullCompliance=natMIBFullCompliance, natPoolTable=natPoolTable, NatBindId=NatBindId, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natMappingExtAddressType=natMappingExtAddressType, natMIBGroups=natMIBGroups, natMIBConformance=natMIBConformance, natGroupAddrMapObjects=natGroupAddrMapObjects, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natFragmentsCompliance=natFragmentsCompliance, natMappingIntPort=natMappingIntPort, natGroupSubscriberObjects=natGroupSubscriberObjects, natLimitMappings=natLimitMappings, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natMappingSubsIndex=natMappingSubsIndex, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natSessionPrivateDstPort=natSessionPrivateDstPort, natProtocolEntry=natProtocolEntry, natPoolIndex=natPoolIndex, natPoolRangeDeallocations=natPoolRangeDeallocations, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natCountersEntry=natCountersEntry, natPoolWatermarkHigh=natPoolWatermarkHigh, natAddrPortBindProtocol=natAddrPortBindProtocol, natNotifMappings=natNotifMappings, natInstanceIndex=natInstanceIndex, natSessionDirection=natSessionDirection, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natSubscribersTable=natSubscribersTable, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natTranslations=natTranslations, natInterfaceTable=natInterfaceTable, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natSubsInterfaceIndex=natSubsInterfaceIndex, natAddrMapProtocol=natAddrMapProtocol, natAddrMapDiscards=natAddrMapDiscards, natLimitFragments=natLimitFragments, natMappingEntry=natMappingEntry, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natProtocol=natProtocol, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natLimitsEntry=natLimitsEntry, natMappingMapBehavior=natMappingMapBehavior, natMIBObjects=natMIBObjects, natAddrBindLocalAddr=natAddrBindLocalAddr, SubscriberIdentifierType=SubscriberIdentifierType, natSessionPublicDstPort=natSessionPublicDstPort, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natCounters=natCounters, natProtocolTable=natProtocolTable, natMappingFilterBehavior=natMappingFilterBehavior, natPoolWatermarkLow=natPoolWatermarkLow, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natAddrBindOutTranslates=natAddrBindOutTranslates, NatBindIdOrZero=NatBindIdOrZero, natConfigGroup=natConfigGroup, natAddrPortBindTable=natAddrPortBindTable, natPoolRangeBegin=natPoolRangeBegin, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natAddrBindTable=natAddrBindTable, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natMappingExtPort=natMappingExtPort, natInterfaceServiceType=natInterfaceServiceType, natAddrMapAddrUsed=natAddrMapAddrUsed, natDefTimeouts=natDefTimeouts, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natAddrBindId=natAddrBindId, NatPoolId=NatPoolId, natStatsInterfaceGroup=natStatsInterfaceGroup, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natAddrBindEntry=natAddrBindEntry, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natAddrMapName=natAddrMapName, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natGroupBasicNotifications=natGroupBasicNotifications, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natMapIntAddrTable=natMapIntAddrTable, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natL4ProtocolTranslations=natL4ProtocolTranslations, natMIBNotifications=natMIBNotifications, natPacketDiscard=natPacketDiscard, natAddrMapRowStatus=natAddrMapRowStatus, natSessionMaxIdleTime=natSessionMaxIdleTime, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natMapIntAddrExtType=natMapIntAddrExtType, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natSubscriberLimitMappings=natSubscriberLimitMappings, natQuotaDrops=natQuotaDrops, natStatsProtocolGroup=natStatsProtocolGroup, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natLimitAddressMappings=natLimitAddressMappings, natAddrBindMapIndex=natAddrBindMapIndex, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natPoolPortMin=natPoolPortMin, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natLimitSubscribers=natLimitSubscribers, natInterfaceRowStatus=natInterfaceRowStatus, natMappingCreations=natMappingCreations, natMIBCompliances=natMIBCompliances, natNotifSubscriberMappings=natNotifSubscriberMappings, natMappingRemovals=natMappingRemovals, PYSNMP_MODULE_ID=natMIB, natSessionEntry=natSessionEntry, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natSubscriberIntPrefix=natSubscriberIntPrefix, natAddrBindGlobalAddr=natAddrBindGlobalAddr, NatAddrMapId=NatAddrMapId, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natStatsAddrMapGroup=natStatsAddrMapGroup, natMapIntAddrInt=natMapIntAddrInt, natResourceErrors=natResourceErrors, NatProtocolMap=NatProtocolMap, NatPoolingType=NatPoolingType, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natSubscriberIdentifierType=natSubscriberIdentifierType)
mibBuilder.exportSymbols("NAT-MIB", natSessionPublicAddrType=natSessionPublicAddrType, natMIB=natMIB, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natPoolObjects=natPoolObjects, natSessionPrivateAddrType=natSessionPrivateAddrType)
