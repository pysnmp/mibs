...
mibBuilder.exportSymbols("NAT-MIB", natLimitFragments=natLimitFragments, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natNotifAddrMappings=natNotifAddrMappings, natMappingFilterBehavior=natMappingFilterBehavior, natSubscriberRealm=natSubscriberRealm, NatAddrMapId=NatAddrMapId, natSubscriberTranslations=natSubscriberTranslations, natAddrMapInTranslates=natAddrMapInTranslates, natPoolRangeEntry=natPoolRangeEntry, natMappingIntPort=natMappingIntPort, natAddrBindInTranslates=natAddrBindInTranslates, natAddrPortBindTable=natAddrPortBindTable, natMappingCreations=natMappingCreations, natSubscriberIdentifierType=natSubscriberIdentifierType, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natPoolRealm=natPoolRealm, natPoolIndex=natPoolIndex, NatTranslationEntity=NatTranslationEntity, natCountersEntry=natCountersEntry, natAddrMapDiscards=natAddrMapDiscards, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natMapObjects=natMapObjects, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natSubscribers=natSubscribers, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natAddrPortBindProtocol=natAddrPortBindProtocol, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natMappingSubsIndex=natMappingSubsIndex, natCGNCompliance=natCGNCompliance, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natBasicStatefulCompliance=natBasicStatefulCompliance, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natPoolPortMax=natPoolPortMax, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natSessionPublicDstAddr=natSessionPublicDstAddr, natPoolTable=natPoolTable, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natPacketDiscard=natPacketDiscard, natSessionMaxIdleTime=natSessionMaxIdleTime, natAddrMapCompliance=natAddrMapCompliance, PYSNMP_MODULE_ID=natMIB, natAddrBindLocalAddr=natAddrBindLocalAddr, natSessionPrivateAddrType=natSessionPrivateAddrType, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natMappingRemovals=natMappingRemovals, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natAddrMapAddrUsed=natAddrMapAddrUsed, natGroupBasicNotifications=natGroupBasicNotifications, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natAddrMapEntry=natAddrMapEntry, natAddrMapStorageType=natAddrMapStorageType, natMappingProto=natMappingProto, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natSessionOutTranslates=natSessionOutTranslates, natAddrBindSessions=natAddrBindSessions, natMIBGroups=natMIBGroups, natInterfaceStorageType=natInterfaceStorageType, natBasicStatelessCompliance=natBasicStatelessCompliance, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natMappingExtPort=natMappingExtPort, NatPoolId=NatPoolId, natGroupStatelessObjects=natGroupStatelessObjects, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natPoolObjects=natPoolObjects, natConfigGroup=natConfigGroup, natTcpDefNegTimeout=natTcpDefNegTimeout, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natLimitsTable=natLimitsTable, natMapIntAddrExtType=natMapIntAddrExtType, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natAddrPortBindId=natAddrPortBindId, natSubscriberIndex=natSubscriberIndex, natSubscriberLimitMappings=natSubscriberLimitMappings, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natAddrMapLocalAddrType=natAddrMapLocalAddrType, NatAssociationType=NatAssociationType, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natDefTimeouts=natDefTimeouts, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natAddrPortBindSessions=natAddrPortBindSessions, natLimitMappings=natLimitMappings, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natAddrPortBindEntry=natAddrPortBindEntry, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natInstanceEntry=natInstanceEntry, natAddrPortBindType=natAddrPortBindType, natProtocolTable=natProtocolTable, natSessionProtocolType=natSessionProtocolType, natNotifCtrl=natNotifCtrl, natAddrBindEntry=natAddrBindEntry, natPoolRangePoolIndex=natPoolRangePoolIndex, NatProtocolType=NatProtocolType, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natMapIntAddrIntType=natMapIntAddrIntType, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natSessionPublicAddrType=natSessionPublicAddrType, natPoolRangeBegin=natPoolRangeBegin, SubscriberIdentifierType=SubscriberIdentifierType, natSessionPublicSrcPort=natSessionPublicSrcPort, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natMapIntAddrInt=natMapIntAddrInt, natAddrBindMapIndex=natAddrBindMapIndex, natInterfaceRealm=natInterfaceRealm, natAddrBindTable=natAddrBindTable, NatBindIdOrZero=NatBindIdOrZero, NatBehaviorType=NatBehaviorType, VlanIndexOrZero=VlanIndexOrZero, natOutOfPortErrors=natOutOfPortErrors, NatProtocolMap=NatProtocolMap, natQuotaDrops=natQuotaDrops, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natMappingIntRealm=natMappingIntRealm, natTranslationGroup=natTranslationGroup, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natPoolWatermarkHigh=natPoolWatermarkHigh, natPoolRangeEnd=natPoolRangeEnd, natAddrMapOutTranslates=natAddrMapOutTranslates, SubscriberIndex=SubscriberIndex, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natAddrMapRowStatus=natAddrMapRowStatus, natAddrBindId=natAddrBindId, ProtocolNumber=ProtocolNumber, natInstanceTable=natInstanceTable, natInterfaceDiscards=natInterfaceDiscards, natInstanceAlias=natInstanceAlias, natMIBFullCompliance=natMIBFullCompliance, natSubscriberMappingCreations=natSubscriberMappingCreations, natBindDefIdleTimeout=natBindDefIdleTimeout, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natPoolRangeType=natPoolRangeType, natAddrMapProtocol=natAddrMapProtocol, natAddrMapIndex=natAddrMapIndex, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natInterfaceInTranslates=natInterfaceInTranslates, natSessionInTranslates=natSessionInTranslates, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natL4ProtocolNumber=natL4ProtocolNumber, natSubscribersEntry=natSubscribersEntry, natFragmentsCompliance=natFragmentsCompliance, natSubsInterfaceIndex=natSubsInterfaceIndex, natMappingIntAddress=natMappingIntAddress, natMapIntAddrExt=natMapIntAddrExt, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natMappingExtAddressType=natMappingExtAddressType, natSessionDirection=natSessionDirection, natMIBNotificationGroup=natMIBNotificationGroup, natLimitAddressMappings=natLimitAddressMappings, natMappingTable=natMappingTable, NatBindMode=NatBindMode, natL4ProtocolTranslations=natL4ProtocolTranslations, natSubscriberResourceErrors=natSubscriberResourceErrors, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natProtocolEntry=natProtocolEntry, natSessionTable=natSessionTable, natCountersTable=natCountersTable, natMappingEntry=natMappingEntry, natMappingAddressPooling=natMappingAddressPooling, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natNotifThrottlingInterval=natNotifThrottlingInterval, natSessionAddrMapIndex=natSessionAddrMapIndex, natPoolRangeAllocations=natPoolRangeAllocations, natInterfaceEntry=natInterfaceEntry, natSessionUpTime=natSessionUpTime, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natSessionIndex=natSessionIndex, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natGroupAddrMapObjects=natGroupAddrMapObjects, natStatsAddrMapGroup=natStatsAddrMapGroup, natPoolRangeTable=natPoolRangeTable, NatBindId=NatBindId, natSessionPrivateDstPort=natSessionPrivateDstPort, natMapIntAddrTable=natMapIntAddrTable, natStatsInterfaceGroup=natStatsInterfaceGroup, natMIBObjects=natMIBObjects, natInstanceIndex=natInstanceIndex, natSubscribersTable=natSubscribersTable, natProtocolDiscards=natProtocolDiscards, natSessionEntry=natSessionEntry, natMIBConformance=natMIBConformance, natResourceErrors=natResourceErrors, natMIBCompliances=natMIBCompliances, natPoolRangeDeallocations=natPoolRangeDeallocations, natGroupFragmentObjects=natGroupFragmentObjects, natMIBNotifications=natMIBNotifications, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natL4ProtocolEntry=natL4ProtocolEntry, natLimitSubscribers=natLimitSubscribers, natMappingPool=natMappingPool, natStatsProtocolGroup=natStatsProtocolGroup, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natAddrMapTable=natAddrMapTable, natProtocol=natProtocol, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natPoolWatermarkLow=natPoolWatermarkLow, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natAddrBindType=natAddrBindType, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natTranslations=natTranslations, natInterfaceServiceType=natInterfaceServiceType, natAddressMappingRemovals=natAddressMappingRemovals, NatSessionId=NatSessionId, natAddrMapName=natAddrMapName, natAddrBindOutTranslates=natAddrBindOutTranslates, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, NatPoolingType=NatPoolingType, natMapIntAddrEntry=natMapIntAddrEntry, natMappingIntAddressType=natMappingIntAddressType, natCounters=natCounters, natInterfaceTable=natInterfaceTable, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natGroupSubscriberObjects=natGroupSubscriberObjects, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natNotifMappings=natNotifMappings, natMIB=natMIB, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natProtocolOutTranslates=natProtocolOutTranslates, natInterfaceOutTranslates=natInterfaceOutTranslates, natL4ProtocolTable=natL4ProtocolTable, natLimitsEntry=natLimitsEntry, natPoolPortMin=natPoolPortMin, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natMappingExtRealm=natMappingExtRealm, natMappingMapBehavior=natMappingMapBehavior, natSubscriberIntPrefix=natSubscriberIntPrefix, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natNotifSubscriberMappings=natNotifSubscriberMappings, natPoolEntry=natPoolEntry, natProtocolInTranslates=natProtocolInTranslates, natSessionPublicDstPort=natSessionPublicDstPort, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natAddrMapEntryType=natAddrMapEntryType, natMappingExtAddress=natMappingExtAddress, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natAddressMappingCreations=natAddressMappingCreations)
mibBuilder.exportSymbols("NAT-MIB", natAddrPortBindMapIndex=natAddrPortBindMapIndex, natInterfaceRowStatus=natInterfaceRowStatus, natGroupStatefulObjects=natGroupStatefulObjects, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime)
