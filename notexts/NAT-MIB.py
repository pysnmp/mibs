...
mibBuilder.exportSymbols("NAT-MIB", natAddrPortBindLocalPort=natAddrPortBindLocalPort, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, NatPoolId=NatPoolId, natAddrBindLocalAddr=natAddrBindLocalAddr, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natSessionMaxIdleTime=natSessionMaxIdleTime, natOutOfPortErrors=natOutOfPortErrors, natMIBFullCompliance=natMIBFullCompliance, natTranslationGroup=natTranslationGroup, PYSNMP_MODULE_ID=natMIB, natResourceErrors=natResourceErrors, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natSubsInterfaceIndex=natSubsInterfaceIndex, natAddrMapEntry=natAddrMapEntry, natSessionProtocolType=natSessionProtocolType, NatBindMode=NatBindMode, natMIBNotificationGroup=natMIBNotificationGroup, natMapIntAddrInt=natMapIntAddrInt, NatBehaviorType=NatBehaviorType, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natMappingIntPort=natMappingIntPort, natStatsInterfaceGroup=natStatsInterfaceGroup, natMIBCompliances=natMIBCompliances, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natMappingTable=natMappingTable, natAddrBindSessions=natAddrBindSessions, natMappingFilterBehavior=natMappingFilterBehavior, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natAddrBindMapIndex=natAddrBindMapIndex, natPoolRangePoolIndex=natPoolRangePoolIndex, natInterfaceEntry=natInterfaceEntry, natL4ProtocolNumber=natL4ProtocolNumber, natGroupFragmentObjects=natGroupFragmentObjects, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natCGNCompliance=natCGNCompliance, natMappingEntry=natMappingEntry, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natInterfaceDiscards=natInterfaceDiscards, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natInterfaceRealm=natInterfaceRealm, natTcpDefNegTimeout=natTcpDefNegTimeout, natFragmentsCompliance=natFragmentsCompliance, natInterfaceInTranslates=natInterfaceInTranslates, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natPoolTable=natPoolTable, natMIBObjects=natMIBObjects, natMappingExtAddressType=natMappingExtAddressType, VlanIndexOrZero=VlanIndexOrZero, natSessionPublicDstPort=natSessionPublicDstPort, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natPoolRangeAllocations=natPoolRangeAllocations, NatBindId=NatBindId, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natMappingExtPort=natMappingExtPort, NatTranslationEntity=NatTranslationEntity, natInstanceTable=natInstanceTable, NatSessionId=NatSessionId, natProtocolEntry=natProtocolEntry, natNotifThrottlingInterval=natNotifThrottlingInterval, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natAddrBindOutTranslates=natAddrBindOutTranslates, natSessionInTranslates=natSessionInTranslates, natCounters=natCounters, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natCountersTable=natCountersTable, natSessionUpTime=natSessionUpTime, natBindDefIdleTimeout=natBindDefIdleTimeout, natPoolRangeBegin=natPoolRangeBegin, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natProtocolDiscards=natProtocolDiscards, natInterfaceStorageType=natInterfaceStorageType, natMappingExtRealm=natMappingExtRealm, natSubscriberIdentifierType=natSubscriberIdentifierType, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natAddrBindTable=natAddrBindTable, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natAddrMapName=natAddrMapName, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natSessionIndex=natSessionIndex, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natAddrMapRowStatus=natAddrMapRowStatus, natSessionPrivateDstPort=natSessionPrivateDstPort, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natAddrPortBindProtocol=natAddrPortBindProtocol, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natPoolRangeEnd=natPoolRangeEnd, natProtocolTable=natProtocolTable, natAddrMapAddrUsed=natAddrMapAddrUsed, natAddrMapIndex=natAddrMapIndex, natLimitFragments=natLimitFragments, natNotifCtrl=natNotifCtrl, NatProtocolMap=NatProtocolMap, natPoolRangeTable=natPoolRangeTable, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natPoolPortMin=natPoolPortMin, NatAddrMapId=NatAddrMapId, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natAddrMapTable=natAddrMapTable, natProtocolOutTranslates=natProtocolOutTranslates, natMappingRemovals=natMappingRemovals, natLimitSubscribers=natLimitSubscribers, natMapIntAddrEntry=natMapIntAddrEntry, natInstanceIndex=natInstanceIndex, natBasicStatelessCompliance=natBasicStatelessCompliance, natSubscriberIntPrefix=natSubscriberIntPrefix, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natMappingIntAddress=natMappingIntAddress, natMIB=natMIB, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natSessionTable=natSessionTable, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natLimitsTable=natLimitsTable, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natLimitAddressMappings=natLimitAddressMappings, natLimitMappings=natLimitMappings, natGroupBasicNotifications=natGroupBasicNotifications, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natMapIntAddrExt=natMapIntAddrExt, natAddressMappingCreations=natAddressMappingCreations, natPoolRangeEntry=natPoolRangeEntry, natLimitsEntry=natLimitsEntry, natSessionPublicAddrType=natSessionPublicAddrType, natBasicStatefulCompliance=natBasicStatefulCompliance, natAddressMappingRemovals=natAddressMappingRemovals, natAddrPortBindEntry=natAddrPortBindEntry, natMappingAddressPooling=natMappingAddressPooling, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natInterfaceOutTranslates=natInterfaceOutTranslates, natSubscriberLimitMappings=natSubscriberLimitMappings, natAddrMapOutTranslates=natAddrMapOutTranslates, natPoolPortMax=natPoolPortMax, natSessionEntry=natSessionEntry, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natGroupSubscriberObjects=natGroupSubscriberObjects, natAddrBindId=natAddrBindId, natSubscriberMappingCreations=natSubscriberMappingCreations, natMappingMapBehavior=natMappingMapBehavior, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natSessionPublicDstAddr=natSessionPublicDstAddr, natSubscribersEntry=natSubscribersEntry, natNotifSubscriberMappings=natNotifSubscriberMappings, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natStatsAddrMapGroup=natStatsAddrMapGroup, natInstanceEntry=natInstanceEntry, natProtocol=natProtocol, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natSubscriberIndex=natSubscriberIndex, natPoolIndex=natPoolIndex, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natPoolRealm=natPoolRealm, NatAssociationType=NatAssociationType, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natMapIntAddrIntType=natMapIntAddrIntType, natMapIntAddrExtType=natMapIntAddrExtType, natPoolEntry=natPoolEntry, SubscriberIndex=SubscriberIndex, natSessionOutTranslates=natSessionOutTranslates, natAddrBindType=natAddrBindType, NatBindIdOrZero=NatBindIdOrZero, natAddrPortBindType=natAddrPortBindType, natCountersEntry=natCountersEntry, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natPoolWatermarkHigh=natPoolWatermarkHigh, natSubscribers=natSubscribers, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natPacketDiscard=natPacketDiscard, natSubscribersTable=natSubscribersTable, natSessionDirection=natSessionDirection, natAddrPortBindSessions=natAddrPortBindSessions, natSessionAddrMapIndex=natSessionAddrMapIndex, natPoolObjects=natPoolObjects, natMappingSubsIndex=natMappingSubsIndex, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natInterfaceRowStatus=natInterfaceRowStatus, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natGroupStatelessObjects=natGroupStatelessObjects, natPoolWatermarkLow=natPoolWatermarkLow, natSubscriberRealm=natSubscriberRealm, natAddrPortBindId=natAddrPortBindId, natAddrMapCompliance=natAddrMapCompliance, natMIBGroups=natMIBGroups, natAddrMapProtocol=natAddrMapProtocol, natAddrMapInTranslates=natAddrMapInTranslates, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natConfigGroup=natConfigGroup, natGroupAddrMapObjects=natGroupAddrMapObjects, natSessionPublicSrcPort=natSessionPublicSrcPort, NatProtocolType=NatProtocolType, natInterfaceTable=natInterfaceTable, natInterfaceServiceType=natInterfaceServiceType, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natAddrMapEntryType=natAddrMapEntryType, natNotifAddrMappings=natNotifAddrMappings, natDefTimeouts=natDefTimeouts, natMappingExtAddress=natMappingExtAddress, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natL4ProtocolEntry=natL4ProtocolEntry, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natNotifMappings=natNotifMappings, natPoolRangeType=natPoolRangeType, natSubscriberTranslations=natSubscriberTranslations, natMapIntAddrTable=natMapIntAddrTable, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natStatsProtocolGroup=natStatsProtocolGroup, natMIBConformance=natMIBConformance, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natGroupStatefulObjects=natGroupStatefulObjects, natAddrBindInTranslates=natAddrBindInTranslates, natL4ProtocolTable=natL4ProtocolTable, natMappingIntAddressType=natMappingIntAddressType, natProtocolInTranslates=natProtocolInTranslates, NatPoolingType=NatPoolingType, natPoolRangeDeallocations=natPoolRangeDeallocations, natMapObjects=natMapObjects, natMIBNotifications=natMIBNotifications, ProtocolNumber=ProtocolNumber, natQuotaDrops=natQuotaDrops, natL4ProtocolTranslations=natL4ProtocolTranslations, natTranslations=natTranslations, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natAddrMapStorageType=natAddrMapStorageType, natSessionPrivateSrcPort=natSessionPrivateSrcPort, SubscriberIdentifierType=SubscriberIdentifierType, natSubscriberResourceErrors=natSubscriberResourceErrors, natMappingIntRealm=natMappingIntRealm, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natMappingCreations=natMappingCreations, natAddrPortBindTable=natAddrPortBindTable, natAddrMapDiscards=natAddrMapDiscards, natMappingProto=natMappingProto)
mibBuilder.exportSymbols("NAT-MIB", natMappingPool=natMappingPool, natAddrBindEntry=natAddrBindEntry, natSessionPrivateAddrType=natSessionPrivateAddrType, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natInstanceAlias=natInstanceAlias)
