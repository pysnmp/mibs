...
mibBuilder.exportSymbols("NAT-MIB", natSessionTable=natSessionTable, natLimitsEntry=natLimitsEntry, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natSubscribersTable=natSubscribersTable, natSessionPublicSrcPort=natSessionPublicSrcPort, natMappingExtAddress=natMappingExtAddress, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natAddrBindSessions=natAddrBindSessions, natInterfaceRowStatus=natInterfaceRowStatus, natMapIntAddrExtType=natMapIntAddrExtType, natAddrBindId=natAddrBindId, natSubscriberRealm=natSubscriberRealm, natLimitAddressMappings=natLimitAddressMappings, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natAddrBindTable=natAddrBindTable, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, NatBindMode=NatBindMode, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natProtocol=natProtocol, natResourceErrors=natResourceErrors, natMapIntAddrInt=natMapIntAddrInt, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natMappingProto=natMappingProto, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natLimitSubscribers=natLimitSubscribers, natAddrPortBindType=natAddrPortBindType, natConfigGroup=natConfigGroup, natAddrBindOutTranslates=natAddrBindOutTranslates, natTranslations=natTranslations, natPoolRangeEnd=natPoolRangeEnd, natAddrPortBindProtocol=natAddrPortBindProtocol, natAddrMapLocalAddrType=natAddrMapLocalAddrType, ProtocolNumber=ProtocolNumber, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natSessionMaxIdleTime=natSessionMaxIdleTime, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natSessionDirection=natSessionDirection, natMIBObjects=natMIBObjects, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natAddrMapStorageType=natAddrMapStorageType, natMappingPool=natMappingPool, natGroupBasicNotifications=natGroupBasicNotifications, natInterfaceStorageType=natInterfaceStorageType, natNotifAddrMappings=natNotifAddrMappings, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natMapIntAddrIntType=natMapIntAddrIntType, natNotifCtrl=natNotifCtrl, natGroupFragmentObjects=natGroupFragmentObjects, natMappingExtAddressType=natMappingExtAddressType, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natInstanceIndex=natInstanceIndex, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natProtocolDiscards=natProtocolDiscards, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natAddrMapName=natAddrMapName, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natMapIntAddrExt=natMapIntAddrExt, natAddrBindEntry=natAddrBindEntry, natMapIntAddrTable=natMapIntAddrTable, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natMIBFullCompliance=natMIBFullCompliance, natAddrBindMapIndex=natAddrBindMapIndex, natLimitFragments=natLimitFragments, natLimitsTable=natLimitsTable, natL4ProtocolNumber=natL4ProtocolNumber, natPoolRangeBegin=natPoolRangeBegin, natMappingIntAddressType=natMappingIntAddressType, natGroupStatefulObjects=natGroupStatefulObjects, natInterfaceInTranslates=natInterfaceInTranslates, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natAddrMapAddrUsed=natAddrMapAddrUsed, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natMappingExtPort=natMappingExtPort, natAddrMapInTranslates=natAddrMapInTranslates, natAddrMapRowStatus=natAddrMapRowStatus, natPoolIndex=natPoolIndex, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, NatAddrMapId=NatAddrMapId, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natInstanceEntry=natInstanceEntry, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natSubscriberLimitMappings=natSubscriberLimitMappings, SubscriberIndex=SubscriberIndex, natAddrBindLocalAddr=natAddrBindLocalAddr, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natPoolRangeTable=natPoolRangeTable, natPoolTable=natPoolTable, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natTranslationGroup=natTranslationGroup, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natStatsProtocolGroup=natStatsProtocolGroup, natPoolPortMin=natPoolPortMin, natProtocolTable=natProtocolTable, VlanIndexOrZero=VlanIndexOrZero, natSessionPrivateAddrType=natSessionPrivateAddrType, natDefTimeouts=natDefTimeouts, natAddrMapProtocol=natAddrMapProtocol, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natAddrMapEntryType=natAddrMapEntryType, natInstanceAlias=natInstanceAlias, natOutOfPortErrors=natOutOfPortErrors, natPoolRangeType=natPoolRangeType, natSubscribersEntry=natSubscribersEntry, natSessionPublicAddrType=natSessionPublicAddrType, natPoolRangeAllocations=natPoolRangeAllocations, natSessionInTranslates=natSessionInTranslates, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natBasicStatelessCompliance=natBasicStatelessCompliance, natSubscriberIdentifierType=natSubscriberIdentifierType, natProtocolOutTranslates=natProtocolOutTranslates, natAddrBindInTranslates=natAddrBindInTranslates, natInstanceTable=natInstanceTable, natPoolRangeDeallocations=natPoolRangeDeallocations, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natAddrMapCompliance=natAddrMapCompliance, natMappingFilterBehavior=natMappingFilterBehavior, natSubscriberIntPrefix=natSubscriberIntPrefix, natSessionEntry=natSessionEntry, natSessionAddrMapIndex=natSessionAddrMapIndex, natSessionPrivateDstPort=natSessionPrivateDstPort, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natAddressMappingCreations=natAddressMappingCreations, natSessionIndex=natSessionIndex, natSessionUpTime=natSessionUpTime, NatBehaviorType=NatBehaviorType, natPoolWatermarkLow=natPoolWatermarkLow, natSubsInterfaceIndex=natSubsInterfaceIndex, natNotifThrottlingInterval=natNotifThrottlingInterval, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natMappingIntAddress=natMappingIntAddress, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natNotifSubscriberMappings=natNotifSubscriberMappings, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natPoolRangePoolIndex=natPoolRangePoolIndex, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natSubscriberResourceErrors=natSubscriberResourceErrors, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, NatSessionId=NatSessionId, natAddressMappingRemovals=natAddressMappingRemovals, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, PYSNMP_MODULE_ID=natMIB, natBindDefIdleTimeout=natBindDefIdleTimeout, natL4ProtocolEntry=natL4ProtocolEntry, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natSessionOutTranslates=natSessionOutTranslates, natFragmentsCompliance=natFragmentsCompliance, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natL4ProtocolTable=natL4ProtocolTable, NatPoolId=NatPoolId, natPoolWatermarkHigh=natPoolWatermarkHigh, natAddrMapDiscards=natAddrMapDiscards, natPoolPortMax=natPoolPortMax, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natMappingIntRealm=natMappingIntRealm, natInterfaceDiscards=natInterfaceDiscards, natProtocolInTranslates=natProtocolInTranslates, natMappingRemovals=natMappingRemovals, natSubscribers=natSubscribers, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natAddrMapTable=natAddrMapTable, natStatsInterfaceGroup=natStatsInterfaceGroup, natStatsAddrMapGroup=natStatsAddrMapGroup, natSubscriberTranslations=natSubscriberTranslations, natAddrPortBindSessions=natAddrPortBindSessions, natPoolRealm=natPoolRealm, natSubscriberMappingCreations=natSubscriberMappingCreations, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natCountersTable=natCountersTable, natInterfaceOutTranslates=natInterfaceOutTranslates, natMIB=natMIB, natInterfaceRealm=natInterfaceRealm, natMIBNotificationGroup=natMIBNotificationGroup, SubscriberIdentifierType=SubscriberIdentifierType, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natPacketDiscard=natPacketDiscard, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natAddrBindType=natAddrBindType, natAddrMapEntry=natAddrMapEntry, natMappingTable=natMappingTable, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natAddrPortBindEntry=natAddrPortBindEntry, NatTranslationEntity=NatTranslationEntity, natMapIntAddrEntry=natMapIntAddrEntry, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natMappingIntPort=natMappingIntPort, natInterfaceTable=natInterfaceTable, natInterfaceServiceType=natInterfaceServiceType, natProtocolEntry=natProtocolEntry, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, NatAssociationType=NatAssociationType, natMappingSubsIndex=natMappingSubsIndex, natGroupSubscriberObjects=natGroupSubscriberObjects, natMappingAddressPooling=natMappingAddressPooling, natCounters=natCounters, natCountersEntry=natCountersEntry, natMapObjects=natMapObjects, natGroupStatelessObjects=natGroupStatelessObjects, natAddrPortBindTable=natAddrPortBindTable, natCGNCompliance=natCGNCompliance, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natMIBCompliances=natMIBCompliances, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natLimitMappings=natLimitMappings, natAddrMapOutTranslates=natAddrMapOutTranslates, natMIBNotifications=natMIBNotifications, natMIBGroups=natMIBGroups, natPoolEntry=natPoolEntry, natAddrMapIndex=natAddrMapIndex, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natMappingExtRealm=natMappingExtRealm, NatProtocolMap=NatProtocolMap, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natInterfaceEntry=natInterfaceEntry, natSessionPublicDstAddr=natSessionPublicDstAddr, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natAddrPortBindId=natAddrPortBindId, natPoolObjects=natPoolObjects, natNotifMappings=natNotifMappings, NatBindId=NatBindId, natQuotaDrops=natQuotaDrops, natMappingMapBehavior=natMappingMapBehavior, natSubscriberIndex=natSubscriberIndex, natGroupAddrMapObjects=natGroupAddrMapObjects, natL4ProtocolTranslations=natL4ProtocolTranslations, natTcpDefNegTimeout=natTcpDefNegTimeout, natSessionPublicDstPort=natSessionPublicDstPort, NatProtocolType=NatProtocolType, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natBasicStatefulCompliance=natBasicStatefulCompliance, natSessionProtocolType=natSessionProtocolType, NatPoolingType=NatPoolingType)
mibBuilder.exportSymbols("NAT-MIB", natMappingEntry=natMappingEntry, natPoolRangeEntry=natPoolRangeEntry, natMappingCreations=natMappingCreations, NatBindIdOrZero=NatBindIdOrZero, natMIBConformance=natMIBConformance)
