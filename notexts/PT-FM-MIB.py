...
Integer32, iso, IpAddress, Gauge32, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, ObjectIdentity, NotificationType, Counter32, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "IpAddress", "Gauge32", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "ObjectIdentity", "NotificationType", "Counter32", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("PT-FM-MIB", category=category, moClass=moClass, switchLogNotificationId=switchLogNotificationId, alarmLogAdditionalText=alarmLogAdditionalText, onFilter=onFilter, probableCause=probableCause, lCASExtendedAlarms=lCASExtendedAlarms, alarmLogLayerRate=alarmLogLayerRate, sequenceNumber=sequenceNumber, nIMAlarms=nIMAlarms, alarmLogNotificationId=alarmLogNotificationId, SwitchTypeTC=SwitchTypeTC, maxNumOfEntriesForEvent=maxNumOfEntriesForEvent, NotificationIdTC=NotificationIdTC, maxNumOfEntriesForTMN=maxNumOfEntriesForTMN, tmnNotificationLog=tmnNotificationLog, SeverityTC=SeverityTC, switchReason=switchReason, lastSeqNumForAlarm=lastSeqNumForAlarm, currentAlarmNotificationId=currentAlarmNotificationId, switchLogSequenceNumber=switchLogSequenceNumber, tmnNotificationId=tmnNotificationId, eventLogAdditionalText=eventLogAdditionalText, alarm=alarm, ptFM=ptFM, EnableStatusTypeTC=EnableStatusTypeTC, currentAlarmSeverity=currentAlarmSeverity, EventCauseTC=EventCauseTC, alarmPersistencyConfigEntry=alarmPersistencyConfigEntry, eventLogNotificationId=eventLogNotificationId, eventLogSequenceNumber=eventLogSequenceNumber, alarmPersistencyConfigTable=alarmPersistencyConfigTable, currentAlarmAdditionalText=currentAlarmAdditionalText, eventLogTimeStamp=eventLogTimeStamp, switchType=switchType, PYSNMP_MODULE_ID=ptFM, currentAlarmProbableCauseQualifier=currentAlarmProbableCauseQualifier, protectionSwitchLogTable=protectionSwitchLogTable, pJEAlarms=pJEAlarms, lastSeqNumForTMN=lastSeqNumForTMN, tmnNotificationLogTable=tmnNotificationLogTable, switchLogAdditionalText=switchLogAdditionalText, tmnSequenceNumber=tmnSequenceNumber, ptFMGroups=ptFMGroups, notificationConfig=notificationConfig, currentAlarmProbableCause=currentAlarmProbableCause, probableCauseQualifier=probableCauseQualifier, CategoryTC=CategoryTC, ClearableTC=ClearableTC, persistencyConfigcategory=persistencyConfigcategory, maxNumOfEntriesForAlarm=maxNumOfEntriesForAlarm, offFilter=offFilter, currentAlarmsTable=currentAlarmsTable, alarmLogSequenceNumber=alarmLogSequenceNumber, tmnAdditionalText=tmnAdditionalText, currentAlarmLayerRate=currentAlarmLayerRate, currentAlarmsEntry=currentAlarmsEntry, severity=severity, config=config, alarmConfigTable=alarmConfigTable, alarmLog=alarmLog, eventLogEntry=eventLogEntry, ptFMCompliances=ptFMCompliances, lastSeqNumForSwitch=lastSeqNumForSwitch, maxNumOfEntriesForSwitch=maxNumOfEntriesForSwitch, alarmLogSeverity=alarmLogSeverity, protectionSwitchLogEntry=protectionSwitchLogEntry, MoClassTC=MoClassTC, LayerRateTC=LayerRateTC, notificationReporting=notificationReporting, ptFMConformance=ptFMConformance, switchLogTimeStamp=switchLogTimeStamp, ptFMCompleteGroup=ptFMCompleteGroup, currentAlarmTimeStamp=currentAlarmTimeStamp, alarmLogEntry=alarmLogEntry, alarmConfigEntry=alarmConfigEntry, alarmLogTable=alarmLogTable, tmnTimeStamp=tmnTimeStamp, notificationId=notificationId, alarmLogProbableCause=alarmLogProbableCause, EventTypeTC=EventTypeTC, ProbableCauseTC=ProbableCauseTC, currentAlarmReferenceObjectId=currentAlarmReferenceObjectId, eventType=eventType, SwitchReasonTC=SwitchReasonTC, alarmLogTimeStamp=alarmLogTimeStamp, alarmLogProbableCauseQualifier=alarmLogProbableCauseQualifier, ptFMFullCompliance=ptFMFullCompliance, eventCause=eventCause, eventLog=eventLog, log=log, lastSeqNumForEvent=lastSeqNumForEvent, eventLogTable=eventLogTable, clearable=clearable, protectionSwitchLog=protectionSwitchLog, currentAlarmManagedObjectId=currentAlarmManagedObjectId, tmnNotificationLogEntry=tmnNotificationLogEntry)
