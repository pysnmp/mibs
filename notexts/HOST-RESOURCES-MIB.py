...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrDeviceEntry=hrDeviceEntry, hrFSMountPoint=hrFSMountPoint, hrSWInstalledGroup=hrSWInstalledGroup, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrFSEntry=hrFSEntry, hrPartitionTable=hrPartitionTable, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrSWInstalledLastChange=hrSWInstalledLastChange, hrSWInstalledName=hrSWInstalledName, hrSWRunGroup=hrSWRunGroup, hrSWRunPerfCPU=hrSWRunPerfCPU, hrSWInstalled=hrSWInstalled, hrSWRunPath=hrSWRunPath, hrDeviceStatus=hrDeviceStatus, hrDiskStorageTable=hrDiskStorageTable, hrDeviceGroup=hrDeviceGroup, hrPrinterStatus=hrPrinterStatus, hostResourcesMibModule=hostResourcesMibModule, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrDiskStorageEntry=hrDiskStorageEntry, hrFSBootable=hrFSBootable, hrSWRunParameters=hrSWRunParameters, hrSWRunTable=hrSWRunTable, hrSWInstalledIndex=hrSWInstalledIndex, hrSWInstalledDate=hrSWInstalledDate, hrSystemGroup=hrSystemGroup, hrPartitionLabel=hrPartitionLabel, hrSWRunPerfGroup=hrSWRunPerfGroup, hrFSTypes=hrFSTypes, hrMIBCompliance=hrMIBCompliance, InternationalDisplayString=InternationalDisplayString, hrSWRunPerf=hrSWRunPerf, hrSWRunStatus=hrSWRunStatus, hrProcessorLoad=hrProcessorLoad, hrPartitionIndex=hrPartitionIndex, hrStorageUsed=hrStorageUsed, hrSWRunPerfTable=hrSWRunPerfTable, hrFSStorageIndex=hrFSStorageIndex, hrNetworkEntry=hrNetworkEntry, hrProcessorTable=hrProcessorTable, hrSystemProcesses=hrSystemProcesses, hrPartitionEntry=hrPartitionEntry, hrPartitionID=hrPartitionID, hrSWRunID=hrSWRunID, hrStorage=hrStorage, hrSWInstalledTable=hrSWInstalledTable, hrFSAccess=hrFSAccess, hrSWInstalledID=hrSWInstalledID, hrSystemUptime=hrSystemUptime, hrNetworkTable=hrNetworkTable, hrPrinterEntry=hrPrinterEntry, hrDeviceTable=hrDeviceTable, hrStorageTypes=hrStorageTypes, hrPartitionFSIndex=hrPartitionFSIndex, hrDeviceType=hrDeviceType, hrDiskStorageAccess=hrDiskStorageAccess, hrSWInstalledType=hrSWInstalledType, hrStorageAllocationUnits=hrStorageAllocationUnits, hrStorageSize=hrStorageSize, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrMemorySize=hrMemorySize, hrStorageGroup=hrStorageGroup, hrSWInstalledEntry=hrSWInstalledEntry, hrPartitionSize=hrPartitionSize, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrFSType=hrFSType, hrSystemMaxProcesses=hrSystemMaxProcesses, hrStorageEntry=hrStorageEntry, hrSWRunEntry=hrSWRunEntry, hrStorageDescr=hrStorageDescr, hrDeviceTypes=hrDeviceTypes, hrSWRunType=hrSWRunType, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrProcessorEntry=hrProcessorEntry, hrNetworkIfIndex=hrNetworkIfIndex, hrDeviceID=hrDeviceID, hrSWRunName=hrSWRunName, hrStorageType=hrStorageType, ProductID=ProductID, hrDeviceDescr=hrDeviceDescr, hrSWRunPerfMem=hrSWRunPerfMem, hrSystem=hrSystem, hrMIBGroups=hrMIBGroups, hrMIBAdminInfo=hrMIBAdminInfo, KBytes=KBytes, hrSystemNumUsers=hrSystemNumUsers, hrDeviceIndex=hrDeviceIndex, hrStorageTable=hrStorageTable, hrDeviceErrors=hrDeviceErrors, hrPrinterTable=hrPrinterTable, hrSWRunIndex=hrSWRunIndex, hrSystemDate=hrSystemDate, hrFSIndex=hrFSIndex, hrSWRunPerfEntry=hrSWRunPerfEntry, hrDiskStorageRemoveble=hrDiskStorageRemoveble, host=host, hrProcessorFrwID=hrProcessorFrwID, hrMIBCompliances=hrMIBCompliances, hrSWRun=hrSWRun, hrDiskStorageMedia=hrDiskStorageMedia, hrDiskStorageCapacity=hrDiskStorageCapacity, hrSWOSIndex=hrSWOSIndex, hrDevice=hrDevice, hrStorageIndex=hrStorageIndex, hrStorageAllocationFailures=hrStorageAllocationFailures, PYSNMP_MODULE_ID=hostResourcesMibModule, hrFSTable=hrFSTable)
