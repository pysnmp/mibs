...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrSWRunPerfTable=hrSWRunPerfTable, hrMemorySize=hrMemorySize, hrProcessorLoad=hrProcessorLoad, hrFSIndex=hrFSIndex, InternationalDisplayString=InternationalDisplayString, hrSWRunTable=hrSWRunTable, hrPartitionID=hrPartitionID, hrSystem=hrSystem, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrFSAccess=hrFSAccess, hrPartitionFSIndex=hrPartitionFSIndex, hrDeviceDescr=hrDeviceDescr, hrSystemMaxProcesses=hrSystemMaxProcesses, hrFSStorageIndex=hrFSStorageIndex, hrSWInstalledLastChange=hrSWInstalledLastChange, hrNetworkIfIndex=hrNetworkIfIndex, hrSWOSIndex=hrSWOSIndex, ProductID=ProductID, hrDevice=hrDevice, hrPartitionSize=hrPartitionSize, hrFSMountPoint=hrFSMountPoint, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrSWRun=hrSWRun, hrStorageIndex=hrStorageIndex, host=host, hrMIBCompliances=hrMIBCompliances, hostResourcesMibModule=hostResourcesMibModule, hrSWRunPath=hrSWRunPath, hrSWInstalledIndex=hrSWInstalledIndex, hrDeviceTypes=hrDeviceTypes, hrStorageTypes=hrStorageTypes, hrProcessorTable=hrProcessorTable, hrStorageDescr=hrStorageDescr, hrSWInstalledName=hrSWInstalledName, hrStorageUsed=hrStorageUsed, hrPartitionTable=hrPartitionTable, hrPartitionIndex=hrPartitionIndex, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrSWInstalledType=hrSWInstalledType, hrDeviceIndex=hrDeviceIndex, hrFSTypes=hrFSTypes, hrSWRunType=hrSWRunType, hrSWInstalled=hrSWInstalled, hrSWInstalledGroup=hrSWInstalledGroup, hrSystemUptime=hrSystemUptime, hrDeviceEntry=hrDeviceEntry, hrDiskStorageTable=hrDiskStorageTable, PYSNMP_MODULE_ID=hostResourcesMibModule, hrPrinterStatus=hrPrinterStatus, hrSWRunName=hrSWRunName, hrSWInstalledID=hrSWInstalledID, hrSWRunIndex=hrSWRunIndex, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrStorageAllocationFailures=hrStorageAllocationFailures, hrSystemNumUsers=hrSystemNumUsers, hrSWRunPerfGroup=hrSWRunPerfGroup, hrStorage=hrStorage, hrSWRunParameters=hrSWRunParameters, hrMIBCompliance=hrMIBCompliance, hrSWInstalledEntry=hrSWInstalledEntry, hrSWRunGroup=hrSWRunGroup, hrDiskStorageMedia=hrDiskStorageMedia, hrFSType=hrFSType, hrSWRunPerfMem=hrSWRunPerfMem, hrSWInstalledTable=hrSWInstalledTable, hrDeviceTable=hrDeviceTable, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrSWRunPerfEntry=hrSWRunPerfEntry, hrStorageAllocationUnits=hrStorageAllocationUnits, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrDeviceErrors=hrDeviceErrors, hrSWRunStatus=hrSWRunStatus, hrMIBAdminInfo=hrMIBAdminInfo, hrStorageGroup=hrStorageGroup, hrStorageType=hrStorageType, hrPrinterTable=hrPrinterTable, hrSWRunID=hrSWRunID, hrDiskStorageCapacity=hrDiskStorageCapacity, hrNetworkTable=hrNetworkTable, hrDeviceID=hrDeviceID, hrPrinterEntry=hrPrinterEntry, hrSWRunPerfCPU=hrSWRunPerfCPU, hrSWInstalledDate=hrSWInstalledDate, hrFSBootable=hrFSBootable, hrDiskStorageAccess=hrDiskStorageAccess, hrDeviceGroup=hrDeviceGroup, hrSystemGroup=hrSystemGroup, hrProcessorFrwID=hrProcessorFrwID, hrStorageEntry=hrStorageEntry, hrPartitionLabel=hrPartitionLabel, hrStorageSize=hrStorageSize, hrFSTable=hrFSTable, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrNetworkEntry=hrNetworkEntry, hrSystemDate=hrSystemDate, hrFSEntry=hrFSEntry, hrDeviceType=hrDeviceType, hrProcessorEntry=hrProcessorEntry, hrMIBGroups=hrMIBGroups, hrDiskStorageEntry=hrDiskStorageEntry, KBytes=KBytes, hrDeviceStatus=hrDeviceStatus, hrSWRunPerf=hrSWRunPerf, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrSWRunEntry=hrSWRunEntry, hrStorageTable=hrStorageTable, hrSystemProcesses=hrSystemProcesses, hrPartitionEntry=hrPartitionEntry)
