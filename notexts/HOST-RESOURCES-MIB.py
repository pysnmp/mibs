...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrStorage=hrStorage, hrDiskStorageCapacity=hrDiskStorageCapacity, hrStorageUsed=hrStorageUsed, hrDiskStorageAccess=hrDiskStorageAccess, hrStorageSize=hrStorageSize, hrSWInstalledEntry=hrSWInstalledEntry, hrDeviceIndex=hrDeviceIndex, hrSWInstalledDate=hrSWInstalledDate, hrFSTypes=hrFSTypes, hrDeviceType=hrDeviceType, hrFSStorageIndex=hrFSStorageIndex, hrSystem=hrSystem, hrSWRunEntry=hrSWRunEntry, hrStorageGroup=hrStorageGroup, hrSWInstalledName=hrSWInstalledName, hrSWRunPath=hrSWRunPath, hrPartitionFSIndex=hrPartitionFSIndex, hrStorageAllocationUnits=hrStorageAllocationUnits, hrSWRunPerfEntry=hrSWRunPerfEntry, hrDiskStorageTable=hrDiskStorageTable, hrNetworkEntry=hrNetworkEntry, hrSWRunParameters=hrSWRunParameters, hrDeviceGroup=hrDeviceGroup, hrSWRunPerf=hrSWRunPerf, hrStorageTypes=hrStorageTypes, hrStorageTable=hrStorageTable, hrSWRunType=hrSWRunType, hrPrinterStatus=hrPrinterStatus, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrSWRunID=hrSWRunID, hrSWInstalledIndex=hrSWInstalledIndex, hrDeviceErrors=hrDeviceErrors, hrDeviceTypes=hrDeviceTypes, hrDiskStorageEntry=hrDiskStorageEntry, hrSWInstalledType=hrSWInstalledType, hrFSAccess=hrFSAccess, hrSWRunPerfCPU=hrSWRunPerfCPU, hrSWRunIndex=hrSWRunIndex, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrSWInstalledTable=hrSWInstalledTable, hrProcessorFrwID=hrProcessorFrwID, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrSWRunName=hrSWRunName, hrDiskStorageMedia=hrDiskStorageMedia, host=host, hrSWRunTable=hrSWRunTable, ProductID=ProductID, hrFSIndex=hrFSIndex, hrSystemUptime=hrSystemUptime, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrFSBootable=hrFSBootable, hrSWInstalled=hrSWInstalled, hrSystemNumUsers=hrSystemNumUsers, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrSWRunPerfMem=hrSWRunPerfMem, hrSystemGroup=hrSystemGroup, hrPartitionID=hrPartitionID, hrProcessorEntry=hrProcessorEntry, hrMIBCompliances=hrMIBCompliances, hrSWRunPerfGroup=hrSWRunPerfGroup, hrFSTable=hrFSTable, hrSWInstalledLastChange=hrSWInstalledLastChange, hrMemorySize=hrMemorySize, hrPartitionLabel=hrPartitionLabel, hrDevice=hrDevice, hrPartitionSize=hrPartitionSize, hrFSType=hrFSType, hrSystemDate=hrSystemDate, hrSWRunGroup=hrSWRunGroup, hrSystemMaxProcesses=hrSystemMaxProcesses, hrProcessorTable=hrProcessorTable, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrFSEntry=hrFSEntry, hrStorageEntry=hrStorageEntry, hrDeviceStatus=hrDeviceStatus, hrNetworkTable=hrNetworkTable, hrPrinterEntry=hrPrinterEntry, hrSWInstalledGroup=hrSWInstalledGroup, hrSystemProcesses=hrSystemProcesses, hrNetworkIfIndex=hrNetworkIfIndex, InternationalDisplayString=InternationalDisplayString, hrStorageAllocationFailures=hrStorageAllocationFailures, PYSNMP_MODULE_ID=hostResourcesMibModule, hrDeviceID=hrDeviceID, hrDeviceTable=hrDeviceTable, hrSWInstalledID=hrSWInstalledID, hrStorageDescr=hrStorageDescr, hrDeviceDescr=hrDeviceDescr, hrMIBGroups=hrMIBGroups, hrPartitionTable=hrPartitionTable, hrStorageIndex=hrStorageIndex, hrPartitionIndex=hrPartitionIndex, hrSWRunPerfTable=hrSWRunPerfTable, hrSWRunStatus=hrSWRunStatus, hrStorageType=hrStorageType, hrDeviceEntry=hrDeviceEntry, hrSWOSIndex=hrSWOSIndex, hostResourcesMibModule=hostResourcesMibModule, hrPartitionEntry=hrPartitionEntry, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, KBytes=KBytes, hrProcessorLoad=hrProcessorLoad, hrSWRun=hrSWRun, hrMIBAdminInfo=hrMIBAdminInfo, hrMIBCompliance=hrMIBCompliance, hrFSMountPoint=hrFSMountPoint, hrPrinterTable=hrPrinterTable)
