...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrSWInstalledID=hrSWInstalledID, hrSystemProcesses=hrSystemProcesses, hrDeviceGroup=hrDeviceGroup, hrSWInstalledIndex=hrSWInstalledIndex, hrDeviceType=hrDeviceType, hrSystem=hrSystem, hrSWRunEntry=hrSWRunEntry, hrSWRunParameters=hrSWRunParameters, hrNetworkIfIndex=hrNetworkIfIndex, hrDeviceID=hrDeviceID, hrStorageAllocationUnits=hrStorageAllocationUnits, hrMIBCompliance=hrMIBCompliance, hrSWRunIndex=hrSWRunIndex, hrSWRunPerfGroup=hrSWRunPerfGroup, hrPartitionEntry=hrPartitionEntry, hrSWRunPerf=hrSWRunPerf, hrSWInstalledTable=hrSWInstalledTable, hrPartitionTable=hrPartitionTable, hrProcessorTable=hrProcessorTable, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrStorageEntry=hrStorageEntry, hrDevice=hrDevice, hrDeviceTypes=hrDeviceTypes, hrNetworkTable=hrNetworkTable, hrSWRunType=hrSWRunType, hrSWRun=hrSWRun, hrSWInstalledGroup=hrSWInstalledGroup, hrSWRunPerfCPU=hrSWRunPerfCPU, hrFSAccess=hrFSAccess, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrSWInstalledName=hrSWInstalledName, hrMIBAdminInfo=hrMIBAdminInfo, hrPartitionSize=hrPartitionSize, hrSystemGroup=hrSystemGroup, hrStorageGroup=hrStorageGroup, hrDiskStorageMedia=hrDiskStorageMedia, hrFSBootable=hrFSBootable, hrSWRunGroup=hrSWRunGroup, hrPartitionIndex=hrPartitionIndex, hrDeviceStatus=hrDeviceStatus, hrFSStorageIndex=hrFSStorageIndex, hrSWRunTable=hrSWRunTable, hrSystemNumUsers=hrSystemNumUsers, hrStorageTypes=hrStorageTypes, hrStorageUsed=hrStorageUsed, hrProcessorFrwID=hrProcessorFrwID, hrSWRunPerfMem=hrSWRunPerfMem, hrSWInstalledEntry=hrSWInstalledEntry, hrDeviceTable=hrDeviceTable, hrDiskStorageCapacity=hrDiskStorageCapacity, hrFSIndex=hrFSIndex, hrSWRunID=hrSWRunID, hrDiskStorageAccess=hrDiskStorageAccess, hrSystemMaxProcesses=hrSystemMaxProcesses, hrStorageDescr=hrStorageDescr, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrPrinterEntry=hrPrinterEntry, hrDeviceDescr=hrDeviceDescr, hrSWRunPerfEntry=hrSWRunPerfEntry, hrSWInstalled=hrSWInstalled, hrDeviceIndex=hrDeviceIndex, hrPartitionID=hrPartitionID, host=host, hrStorage=hrStorage, PYSNMP_MODULE_ID=hostResourcesMibModule, InternationalDisplayString=InternationalDisplayString, hrPrinterTable=hrPrinterTable, hrSWInstalledLastChange=hrSWInstalledLastChange, ProductID=ProductID, hrDeviceEntry=hrDeviceEntry, hrFSTable=hrFSTable, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrSWRunPerfTable=hrSWRunPerfTable, hostResourcesMibModule=hostResourcesMibModule, hrSystemDate=hrSystemDate, hrFSEntry=hrFSEntry, hrMemorySize=hrMemorySize, hrDeviceErrors=hrDeviceErrors, hrStorageTable=hrStorageTable, hrMIBGroups=hrMIBGroups, hrSWRunName=hrSWRunName, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrDiskStorageTable=hrDiskStorageTable, hrNetworkEntry=hrNetworkEntry, hrStorageIndex=hrStorageIndex, hrProcessorEntry=hrProcessorEntry, hrFSType=hrFSType, hrStorageType=hrStorageType, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrPartitionFSIndex=hrPartitionFSIndex, hrFSTypes=hrFSTypes, hrSystemUptime=hrSystemUptime, hrStorageAllocationFailures=hrStorageAllocationFailures, hrSWRunPath=hrSWRunPath, hrSWInstalledType=hrSWInstalledType, KBytes=KBytes, hrStorageSize=hrStorageSize, hrFSMountPoint=hrFSMountPoint, hrMIBCompliances=hrMIBCompliances, hrPrinterStatus=hrPrinterStatus, hrPartitionLabel=hrPartitionLabel, hrSWInstalledDate=hrSWInstalledDate, hrDiskStorageEntry=hrDiskStorageEntry, hrProcessorLoad=hrProcessorLoad, hrSWOSIndex=hrSWOSIndex, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrSWRunStatus=hrSWRunStatus)
