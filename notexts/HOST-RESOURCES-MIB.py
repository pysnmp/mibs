...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrDeviceErrors=hrDeviceErrors, hrSWRunName=hrSWRunName, hrFSBootable=hrFSBootable, hrSWRunPath=hrSWRunPath, hrSWInstalled=hrSWInstalled, hrPrinterTable=hrPrinterTable, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrSWRunParameters=hrSWRunParameters, KBytes=KBytes, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrDeviceEntry=hrDeviceEntry, hrSystemGroup=hrSystemGroup, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrSystemUptime=hrSystemUptime, hrSWRunStatus=hrSWRunStatus, hrStorageIndex=hrStorageIndex, hrSWInstalledIndex=hrSWInstalledIndex, hrDeviceGroup=hrDeviceGroup, hrSWRun=hrSWRun, hrStorageTable=hrStorageTable, hrSWInstalledType=hrSWInstalledType, hrDiskStorageTable=hrDiskStorageTable, hrStorageAllocationUnits=hrStorageAllocationUnits, hrPartitionTable=hrPartitionTable, hrStorageType=hrStorageType, hrDeviceIndex=hrDeviceIndex, hrStorageEntry=hrStorageEntry, hrDeviceStatus=hrDeviceStatus, hrProcessorLoad=hrProcessorLoad, hrStorageUsed=hrStorageUsed, PYSNMP_MODULE_ID=hostResourcesMibModule, hrPartitionSize=hrPartitionSize, hrSWRunIndex=hrSWRunIndex, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrSWInstalledLastChange=hrSWInstalledLastChange, hrDevice=hrDevice, hrPartitionIndex=hrPartitionIndex, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrFSType=hrFSType, hrFSEntry=hrFSEntry, hrSystem=hrSystem, hrDeviceID=hrDeviceID, hrFSIndex=hrFSIndex, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrStorageDescr=hrStorageDescr, hrFSStorageIndex=hrFSStorageIndex, hostResourcesMibModule=hostResourcesMibModule, hrDiskStorageEntry=hrDiskStorageEntry, hrDiskStorageMedia=hrDiskStorageMedia, hrSWRunPerfGroup=hrSWRunPerfGroup, hrSWRunGroup=hrSWRunGroup, hrFSMountPoint=hrFSMountPoint, hrPartitionEntry=hrPartitionEntry, hrSWInstalledGroup=hrSWInstalledGroup, hrSWInstalledEntry=hrSWInstalledEntry, hrStorageAllocationFailures=hrStorageAllocationFailures, hrSWRunPerfCPU=hrSWRunPerfCPU, hrDeviceTypes=hrDeviceTypes, hrSWInstalledID=hrSWInstalledID, hrFSAccess=hrFSAccess, hrPartitionLabel=hrPartitionLabel, hrDeviceTable=hrDeviceTable, hrDiskStorageAccess=hrDiskStorageAccess, hrStorageGroup=hrStorageGroup, hrMemorySize=hrMemorySize, hrProcessorFrwID=hrProcessorFrwID, hrSWRunPerfTable=hrSWRunPerfTable, hrStorage=hrStorage, hrSWInstalledTable=hrSWInstalledTable, hrNetworkTable=hrNetworkTable, hrPartitionID=hrPartitionID, ProductID=ProductID, hrSWRunTable=hrSWRunTable, hrPrinterEntry=hrPrinterEntry, hrSystemProcesses=hrSystemProcesses, hrPrinterStatus=hrPrinterStatus, hrMIBAdminInfo=hrMIBAdminInfo, hrStorageTypes=hrStorageTypes, hrMIBCompliance=hrMIBCompliance, hrNetworkIfIndex=hrNetworkIfIndex, hrDeviceDescr=hrDeviceDescr, hrStorageSize=hrStorageSize, hrDiskStorageCapacity=hrDiskStorageCapacity, hrSWRunPerf=hrSWRunPerf, hrSWInstalledDate=hrSWInstalledDate, hrSWOSIndex=hrSWOSIndex, hrSWRunPerfMem=hrSWRunPerfMem, hrMIBCompliances=hrMIBCompliances, hrSWRunPerfEntry=hrSWRunPerfEntry, hrSystemMaxProcesses=hrSystemMaxProcesses, hrProcessorEntry=hrProcessorEntry, hrNetworkEntry=hrNetworkEntry, hrMIBGroups=hrMIBGroups, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrDeviceType=hrDeviceType, hrProcessorTable=hrProcessorTable, hrSWRunType=hrSWRunType, hrPartitionFSIndex=hrPartitionFSIndex, hrFSTable=hrFSTable, hrSystemDate=hrSystemDate, hrFSTypes=hrFSTypes, hrSystemNumUsers=hrSystemNumUsers, hrSWRunID=hrSWRunID, hrSWRunEntry=hrSWRunEntry, InternationalDisplayString=InternationalDisplayString, hrFSLastFullBackupDate=hrFSLastFullBackupDate, host=host, hrSWInstalledName=hrSWInstalledName)
