...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hostResourcesMibModule=hostResourcesMibModule, hrFSIndex=hrFSIndex, hrSWInstalledIndex=hrSWInstalledIndex, hrSystem=hrSystem, hrPartitionSize=hrPartitionSize, hrSystemNumUsers=hrSystemNumUsers, hrPartitionID=hrPartitionID, host=host, hrDeviceTypes=hrDeviceTypes, hrMIBGroups=hrMIBGroups, hrFSStorageIndex=hrFSStorageIndex, hrSWRunIndex=hrSWRunIndex, hrFSType=hrFSType, hrDeviceIndex=hrDeviceIndex, hrDeviceType=hrDeviceType, hrSystemMaxProcesses=hrSystemMaxProcesses, hrStorageType=hrStorageType, hrSWRunName=hrSWRunName, hrPartitionLabel=hrPartitionLabel, hrSystemProcesses=hrSystemProcesses, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrSWRun=hrSWRun, hrMIBCompliances=hrMIBCompliances, hrSWInstalledLastChange=hrSWInstalledLastChange, hrDeviceEntry=hrDeviceEntry, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrSWRunEntry=hrSWRunEntry, hrDiskStorageMedia=hrDiskStorageMedia, hrSWInstalledEntry=hrSWInstalledEntry, hrSystemGroup=hrSystemGroup, hrStorage=hrStorage, hrDiskStorageAccess=hrDiskStorageAccess, hrSWRunPerfCPU=hrSWRunPerfCPU, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrSWRunStatus=hrSWRunStatus, hrSWInstalledGroup=hrSWInstalledGroup, hrFSBootable=hrFSBootable, hrPartitionTable=hrPartitionTable, hrPrinterTable=hrPrinterTable, hrSWRunPerfEntry=hrSWRunPerfEntry, hrSWOSIndex=hrSWOSIndex, hrSWRunGroup=hrSWRunGroup, hrNetworkIfIndex=hrNetworkIfIndex, hrNetworkTable=hrNetworkTable, hrFSMountPoint=hrFSMountPoint, hrProcessorEntry=hrProcessorEntry, hrMemorySize=hrMemorySize, hrNetworkEntry=hrNetworkEntry, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrDevice=hrDevice, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrStorageDescr=hrStorageDescr, hrStorageEntry=hrStorageEntry, hrFSTable=hrFSTable, hrStorageIndex=hrStorageIndex, hrSWInstalledType=hrSWInstalledType, InternationalDisplayString=InternationalDisplayString, hrProcessorTable=hrProcessorTable, hrStorageSize=hrStorageSize, hrPartitionEntry=hrPartitionEntry, hrDeviceErrors=hrDeviceErrors, KBytes=KBytes, hrSystemDate=hrSystemDate, hrSWRunPerfTable=hrSWRunPerfTable, hrMIBCompliance=hrMIBCompliance, hrStorageAllocationUnits=hrStorageAllocationUnits, hrFSTypes=hrFSTypes, hrSWRunPerfMem=hrSWRunPerfMem, hrSWRunType=hrSWRunType, hrFSAccess=hrFSAccess, hrDiskStorageTable=hrDiskStorageTable, hrDeviceTable=hrDeviceTable, hrSWInstalled=hrSWInstalled, hrDiskStorageEntry=hrDiskStorageEntry, hrPartitionFSIndex=hrPartitionFSIndex, hrSWInstalledDate=hrSWInstalledDate, hrDeviceStatus=hrDeviceStatus, hrSWInstalledID=hrSWInstalledID, hrPrinterEntry=hrPrinterEntry, hrDeviceGroup=hrDeviceGroup, hrStorageUsed=hrStorageUsed, hrSWRunTable=hrSWRunTable, hrProcessorFrwID=hrProcessorFrwID, hrStorageTable=hrStorageTable, hrDiskStorageCapacity=hrDiskStorageCapacity, hrSystemUptime=hrSystemUptime, hrStorageAllocationFailures=hrStorageAllocationFailures, hrDeviceID=hrDeviceID, hrMIBAdminInfo=hrMIBAdminInfo, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrPrinterStatus=hrPrinterStatus, hrDeviceDescr=hrDeviceDescr, hrSWInstalledTable=hrSWInstalledTable, hrSWRunID=hrSWRunID, PYSNMP_MODULE_ID=hostResourcesMibModule, hrStorageGroup=hrStorageGroup, hrSWRunPath=hrSWRunPath, hrProcessorLoad=hrProcessorLoad, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, ProductID=ProductID, hrSWInstalledName=hrSWInstalledName, hrSWRunPerf=hrSWRunPerf, hrFSEntry=hrFSEntry, hrStorageTypes=hrStorageTypes, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrSWRunPerfGroup=hrSWRunPerfGroup, hrSWRunParameters=hrSWRunParameters, hrPartitionIndex=hrPartitionIndex)
