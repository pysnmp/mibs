...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrFSTable=hrFSTable, hrSWRunName=hrSWRunName, hrSWRunGroup=hrSWRunGroup, hrPartitionID=hrPartitionID, hrSWInstalledID=hrSWInstalledID, hrPartitionLabel=hrPartitionLabel, hrDiskStorageCapacity=hrDiskStorageCapacity, hrSystemGroup=hrSystemGroup, hrSWRunPerfEntry=hrSWRunPerfEntry, hrFSEntry=hrFSEntry, hrFSBootable=hrFSBootable, hrStorageAllocationFailures=hrStorageAllocationFailures, hrDiskStorageEntry=hrDiskStorageEntry, hrDeviceGroup=hrDeviceGroup, hrFSStorageIndex=hrFSStorageIndex, hrSWRunPerfGroup=hrSWRunPerfGroup, hostResourcesMibModule=hostResourcesMibModule, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrPrinterTable=hrPrinterTable, hrDiskStorageTable=hrDiskStorageTable, hrStorageIndex=hrStorageIndex, hrSWRunParameters=hrSWRunParameters, hrSWInstalledGroup=hrSWInstalledGroup, hrSWRunIndex=hrSWRunIndex, hrMIBGroups=hrMIBGroups, hrDiskStorageMedia=hrDiskStorageMedia, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrStorageSize=hrStorageSize, hrDeviceType=hrDeviceType, hrPartitionIndex=hrPartitionIndex, hrStorageUsed=hrStorageUsed, hrSWOSIndex=hrSWOSIndex, hrSWInstalledDate=hrSWInstalledDate, hrProcessorEntry=hrProcessorEntry, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrStorageEntry=hrStorageEntry, hrSystem=hrSystem, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrDeviceErrors=hrDeviceErrors, hrPartitionEntry=hrPartitionEntry, hrSWInstalledIndex=hrSWInstalledIndex, hrFSTypes=hrFSTypes, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrProcessorFrwID=hrProcessorFrwID, hrFSMountPoint=hrFSMountPoint, hrDiskStorageAccess=hrDiskStorageAccess, hrSWRunPerfTable=hrSWRunPerfTable, hrSystemUptime=hrSystemUptime, hrSWRunPerf=hrSWRunPerf, hrSWInstalledName=hrSWInstalledName, hrStorageTypes=hrStorageTypes, hrStorageGroup=hrStorageGroup, hrMemorySize=hrMemorySize, KBytes=KBytes, host=host, hrSWInstalledLastChange=hrSWInstalledLastChange, hrMIBAdminInfo=hrMIBAdminInfo, hrSystemDate=hrSystemDate, hrSWInstalled=hrSWInstalled, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrStorage=hrStorage, hrNetworkIfIndex=hrNetworkIfIndex, hrFSType=hrFSType, hrDeviceTypes=hrDeviceTypes, hrSWRunPerfMem=hrSWRunPerfMem, hrSWInstalledType=hrSWInstalledType, hrStorageAllocationUnits=hrStorageAllocationUnits, InternationalDisplayString=InternationalDisplayString, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrFSAccess=hrFSAccess, hrSWRun=hrSWRun, hrMIBCompliances=hrMIBCompliances, hrFSIndex=hrFSIndex, hrSWRunTable=hrSWRunTable, hrMIBCompliance=hrMIBCompliance, hrSWInstalledTable=hrSWInstalledTable, hrNetworkEntry=hrNetworkEntry, hrDeviceStatus=hrDeviceStatus, hrSWRunPath=hrSWRunPath, hrProcessorTable=hrProcessorTable, hrSWInstalledEntry=hrSWInstalledEntry, hrStorageType=hrStorageType, hrSWRunType=hrSWRunType, hrDeviceEntry=hrDeviceEntry, PYSNMP_MODULE_ID=hostResourcesMibModule, hrNetworkTable=hrNetworkTable, hrStorageDescr=hrStorageDescr, hrPartitionTable=hrPartitionTable, hrSWRunPerfCPU=hrSWRunPerfCPU, hrDevice=hrDevice, ProductID=ProductID, hrDeviceIndex=hrDeviceIndex, hrDeviceDescr=hrDeviceDescr, hrPrinterEntry=hrPrinterEntry, hrSWRunEntry=hrSWRunEntry, hrStorageTable=hrStorageTable, hrSWRunStatus=hrSWRunStatus, hrPartitionFSIndex=hrPartitionFSIndex, hrSystemMaxProcesses=hrSystemMaxProcesses, hrDeviceTable=hrDeviceTable, hrSystemProcesses=hrSystemProcesses, hrPartitionSize=hrPartitionSize, hrProcessorLoad=hrProcessorLoad, hrSWRunID=hrSWRunID, hrSystemNumUsers=hrSystemNumUsers, hrPrinterStatus=hrPrinterStatus, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrDeviceID=hrDeviceID)
