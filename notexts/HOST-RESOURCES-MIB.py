...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrDeviceEntry=hrDeviceEntry, hrStorageAllocationUnits=hrStorageAllocationUnits, hrSWRunPerf=hrSWRunPerf, hrPartitionIndex=hrPartitionIndex, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrDeviceDescr=hrDeviceDescr, hrSWInstalledID=hrSWInstalledID, hrStorageTypes=hrStorageTypes, hrStorageDescr=hrStorageDescr, hrPartitionEntry=hrPartitionEntry, hostResourcesMibModule=hostResourcesMibModule, hrSWInstalled=hrSWInstalled, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrPrinterTable=hrPrinterTable, hrStorageGroup=hrStorageGroup, hrPartitionSize=hrPartitionSize, hrSWInstalledTable=hrSWInstalledTable, hrFSStorageIndex=hrFSStorageIndex, hrProcessorTable=hrProcessorTable, hrProcessorLoad=hrProcessorLoad, hrSWRun=hrSWRun, hrSWInstalledName=hrSWInstalledName, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrSWRunEntry=hrSWRunEntry, hrFSEntry=hrFSEntry, hrSystemProcesses=hrSystemProcesses, hrMIBCompliances=hrMIBCompliances, hrStorageSize=hrStorageSize, hrSystemNumUsers=hrSystemNumUsers, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrNetworkIfIndex=hrNetworkIfIndex, hrSystemDate=hrSystemDate, hrPartitionLabel=hrPartitionLabel, hrSWInstalledType=hrSWInstalledType, PYSNMP_MODULE_ID=hostResourcesMibModule, hrDeviceType=hrDeviceType, host=host, hrDeviceID=hrDeviceID, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrSWInstalledLastChange=hrSWInstalledLastChange, hrDevice=hrDevice, hrStorageIndex=hrStorageIndex, hrSWRunPerfCPU=hrSWRunPerfCPU, hrStorageType=hrStorageType, hrMIBAdminInfo=hrMIBAdminInfo, hrStorage=hrStorage, hrMIBGroups=hrMIBGroups, hrSystemUptime=hrSystemUptime, hrFSTable=hrFSTable, hrPrinterEntry=hrPrinterEntry, hrFSMountPoint=hrFSMountPoint, hrSWInstalledDate=hrSWInstalledDate, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrSWOSIndex=hrSWOSIndex, hrDeviceIndex=hrDeviceIndex, hrSystemGroup=hrSystemGroup, hrDeviceGroup=hrDeviceGroup, hrDeviceStatus=hrDeviceStatus, hrDiskStorageAccess=hrDiskStorageAccess, hrDeviceErrors=hrDeviceErrors, hrSWRunIndex=hrSWRunIndex, hrDiskStorageMedia=hrDiskStorageMedia, hrStorageEntry=hrStorageEntry, hrPartitionID=hrPartitionID, hrFSAccess=hrFSAccess, hrMemorySize=hrMemorySize, hrFSType=hrFSType, hrNetworkEntry=hrNetworkEntry, hrSWInstalledEntry=hrSWInstalledEntry, hrDiskStorageCapacity=hrDiskStorageCapacity, hrPartitionTable=hrPartitionTable, hrProcessorEntry=hrProcessorEntry, hrSWInstalledIndex=hrSWInstalledIndex, hrSystem=hrSystem, hrSWRunTable=hrSWRunTable, hrPrinterStatus=hrPrinterStatus, hrStorageAllocationFailures=hrStorageAllocationFailures, hrSWRunPath=hrSWRunPath, hrSWRunID=hrSWRunID, hrSWRunPerfTable=hrSWRunPerfTable, hrMIBCompliance=hrMIBCompliance, hrSWRunParameters=hrSWRunParameters, hrSWInstalledGroup=hrSWInstalledGroup, hrDiskStorageEntry=hrDiskStorageEntry, hrNetworkTable=hrNetworkTable, hrDiskStorageTable=hrDiskStorageTable, hrSWRunName=hrSWRunName, hrDeviceTable=hrDeviceTable, hrSystemMaxProcesses=hrSystemMaxProcesses, ProductID=ProductID, InternationalDisplayString=InternationalDisplayString, hrFSBootable=hrFSBootable, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrFSTypes=hrFSTypes, hrSWRunPerfMem=hrSWRunPerfMem, hrProcessorFrwID=hrProcessorFrwID, KBytes=KBytes, hrSWRunPerfEntry=hrSWRunPerfEntry, hrPartitionFSIndex=hrPartitionFSIndex, hrFSIndex=hrFSIndex, hrStorageUsed=hrStorageUsed, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrDeviceTypes=hrDeviceTypes, hrSWRunStatus=hrSWRunStatus, hrSWRunPerfGroup=hrSWRunPerfGroup, hrSWRunGroup=hrSWRunGroup, hrSWRunType=hrSWRunType, hrStorageTable=hrStorageTable)
