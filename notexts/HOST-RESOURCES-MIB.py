...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrFSEntry=hrFSEntry, hrDeviceErrors=hrDeviceErrors, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrStorageGroup=hrStorageGroup, hrMIBAdminInfo=hrMIBAdminInfo, hrSystemGroup=hrSystemGroup, hrSWRunGroup=hrSWRunGroup, hrDiskStorageAccess=hrDiskStorageAccess, hrSWInstalledDate=hrSWInstalledDate, hrSystemNumUsers=hrSystemNumUsers, hrSWInstalledID=hrSWInstalledID, hrDiskStorageTable=hrDiskStorageTable, hrSWRunPerfTable=hrSWRunPerfTable, hrSWInstalledTable=hrSWInstalledTable, hrFSTypes=hrFSTypes, hrSWInstalledGroup=hrSWInstalledGroup, hrSWRunTable=hrSWRunTable, hrSWInstalledType=hrSWInstalledType, InternationalDisplayString=InternationalDisplayString, hrSWRunPerfEntry=hrSWRunPerfEntry, hrPartitionLabel=hrPartitionLabel, hrFSBootable=hrFSBootable, hrFSMountPoint=hrFSMountPoint, hrStorage=hrStorage, hrDeviceTable=hrDeviceTable, hrFSStorageIndex=hrFSStorageIndex, hrPrinterStatus=hrPrinterStatus, hrSWInstalledName=hrSWInstalledName, hrProcessorTable=hrProcessorTable, hostResourcesMibModule=hostResourcesMibModule, hrMIBCompliance=hrMIBCompliance, hrFSType=hrFSType, hrNetworkIfIndex=hrNetworkIfIndex, ProductID=ProductID, hrPrinterTable=hrPrinterTable, hrMIBCompliances=hrMIBCompliances, hrPrinterEntry=hrPrinterEntry, hrSWRunIndex=hrSWRunIndex, KBytes=KBytes, hrStorageDescr=hrStorageDescr, hrDeviceDescr=hrDeviceDescr, hrPartitionEntry=hrPartitionEntry, hrMIBGroups=hrMIBGroups, hrStorageAllocationUnits=hrStorageAllocationUnits, hrSystemUptime=hrSystemUptime, hrStorageTable=hrStorageTable, hrDeviceStatus=hrDeviceStatus, hrSystem=hrSystem, hrSystemDate=hrSystemDate, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrSWRunPerfCPU=hrSWRunPerfCPU, hrMemorySize=hrMemorySize, hrSystemProcesses=hrSystemProcesses, hrDeviceIndex=hrDeviceIndex, hrSWRunPerfGroup=hrSWRunPerfGroup, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrDiskStorageEntry=hrDiskStorageEntry, hrSWInstalledLastChange=hrSWInstalledLastChange, hrDeviceGroup=hrDeviceGroup, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrSWRun=hrSWRun, hrSWRunType=hrSWRunType, hrPartitionIndex=hrPartitionIndex, hrStorageSize=hrStorageSize, hrPartitionFSIndex=hrPartitionFSIndex, hrNetworkTable=hrNetworkTable, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrNetworkEntry=hrNetworkEntry, hrDeviceType=hrDeviceType, hrProcessorFrwID=hrProcessorFrwID, hrPartitionID=hrPartitionID, hrStorageAllocationFailures=hrStorageAllocationFailures, hrSWRunPath=hrSWRunPath, hrSWInstalled=hrSWInstalled, hrStorageIndex=hrStorageIndex, hrStorageEntry=hrStorageEntry, hrStorageTypes=hrStorageTypes, hrStorageUsed=hrStorageUsed, hrStorageType=hrStorageType, hrProcessorLoad=hrProcessorLoad, hrSWRunEntry=hrSWRunEntry, hrDeviceEntry=hrDeviceEntry, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrPartitionSize=hrPartitionSize, PYSNMP_MODULE_ID=hostResourcesMibModule, hrSWInstalledEntry=hrSWInstalledEntry, hrDiskStorageCapacity=hrDiskStorageCapacity, hrSWRunPerf=hrSWRunPerf, hrDevice=hrDevice, hrProcessorEntry=hrProcessorEntry, hrSystemMaxProcesses=hrSystemMaxProcesses, hrDeviceTypes=hrDeviceTypes, hrFSTable=hrFSTable, hrSWRunStatus=hrSWRunStatus, hrSWRunID=hrSWRunID, hrFSIndex=hrFSIndex, hrSWRunPerfMem=hrSWRunPerfMem, hrSWInstalledIndex=hrSWInstalledIndex, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrSWRunName=hrSWRunName, host=host, hrPartitionTable=hrPartitionTable, hrSWRunParameters=hrSWRunParameters, hrDiskStorageMedia=hrDiskStorageMedia, hrSWOSIndex=hrSWOSIndex, hrDeviceID=hrDeviceID, hrFSAccess=hrFSAccess)
