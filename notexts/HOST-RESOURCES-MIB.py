...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrDeviceStatus=hrDeviceStatus, hrSWInstalledDate=hrSWInstalledDate, hrPartitionID=hrPartitionID, hrFSTable=hrFSTable, hrMIBGroups=hrMIBGroups, hrFSAccess=hrFSAccess, hrSWInstalledEntry=hrSWInstalledEntry, hrProcessorEntry=hrProcessorEntry, hrStorageIndex=hrStorageIndex, hrPartitionEntry=hrPartitionEntry, hrDeviceID=hrDeviceID, hrSystem=hrSystem, hrDiskStorageTable=hrDiskStorageTable, hrProcessorFrwID=hrProcessorFrwID, hrFSMountPoint=hrFSMountPoint, hrSWRunPerfTable=hrSWRunPerfTable, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrSWRunParameters=hrSWRunParameters, ProductID=ProductID, hrNetworkTable=hrNetworkTable, KBytes=KBytes, hostResourcesMibModule=hostResourcesMibModule, hrDeviceType=hrDeviceType, hrDeviceTypes=hrDeviceTypes, hrStorageTypes=hrStorageTypes, hrSWRunID=hrSWRunID, hrStorageUsed=hrStorageUsed, hrNetworkIfIndex=hrNetworkIfIndex, hrDeviceGroup=hrDeviceGroup, hrSWRunTable=hrSWRunTable, hrStorageTable=hrStorageTable, hrSWInstalledLastChange=hrSWInstalledLastChange, hrSWRunEntry=hrSWRunEntry, hrSWOSIndex=hrSWOSIndex, hrDiskStorageMedia=hrDiskStorageMedia, hrFSTypes=hrFSTypes, hrDeviceTable=hrDeviceTable, hrDeviceDescr=hrDeviceDescr, hrDeviceEntry=hrDeviceEntry, hrSWRunStatus=hrSWRunStatus, hrStorageAllocationUnits=hrStorageAllocationUnits, hrFSEntry=hrFSEntry, InternationalDisplayString=InternationalDisplayString, hrDevice=hrDevice, hrStorageEntry=hrStorageEntry, hrSWRunName=hrSWRunName, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrSystemMaxProcesses=hrSystemMaxProcesses, hrFSBootable=hrFSBootable, hrPartitionLabel=hrPartitionLabel, hrProcessorTable=hrProcessorTable, hrMIBAdminInfo=hrMIBAdminInfo, hrMIBCompliances=hrMIBCompliances, hrPrinterTable=hrPrinterTable, hrSystemGroup=hrSystemGroup, hrSWRunGroup=hrSWRunGroup, hrSWRunPerfCPU=hrSWRunPerfCPU, hrPrinterStatus=hrPrinterStatus, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrMIBCompliance=hrMIBCompliance, hrDeviceErrors=hrDeviceErrors, hrSWInstalledTable=hrSWInstalledTable, hrDiskStorageEntry=hrDiskStorageEntry, hrSWRunPerfMem=hrSWRunPerfMem, hrProcessorLoad=hrProcessorLoad, hrDiskStorageCapacity=hrDiskStorageCapacity, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrStorage=hrStorage, hrSWRunPath=hrSWRunPath, hrSWRunType=hrSWRunType, hrFSStorageIndex=hrFSStorageIndex, hrPrinterEntry=hrPrinterEntry, hrSystemProcesses=hrSystemProcesses, hrSWRunIndex=hrSWRunIndex, hrPartitionSize=hrPartitionSize, hrSWRunPerfEntry=hrSWRunPerfEntry, hrFSType=hrFSType, hrNetworkEntry=hrNetworkEntry, hrSystemNumUsers=hrSystemNumUsers, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrSWInstalledGroup=hrSWInstalledGroup, hrSWInstalledType=hrSWInstalledType, PYSNMP_MODULE_ID=hostResourcesMibModule, hrSWRunPerfGroup=hrSWRunPerfGroup, hrSWRunPerf=hrSWRunPerf, hrPartitionTable=hrPartitionTable, hrSWInstalledID=hrSWInstalledID, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrPartitionFSIndex=hrPartitionFSIndex, hrDiskStorageAccess=hrDiskStorageAccess, hrStorageSize=hrStorageSize, hrStorageDescr=hrStorageDescr, hrDeviceIndex=hrDeviceIndex, hrSWInstalledIndex=hrSWInstalledIndex, hrSWInstalledName=hrSWInstalledName, hrSystemUptime=hrSystemUptime, hrFSIndex=hrFSIndex, hrSystemDate=hrSystemDate, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, host=host, hrSWInstalled=hrSWInstalled, hrPartitionIndex=hrPartitionIndex, hrStorageAllocationFailures=hrStorageAllocationFailures, hrStorageType=hrStorageType, hrMemorySize=hrMemorySize, hrSWRun=hrSWRun, hrStorageGroup=hrStorageGroup)
