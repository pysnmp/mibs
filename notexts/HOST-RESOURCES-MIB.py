...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrSWRunParameters=hrSWRunParameters, hrSWInstalledDate=hrSWInstalledDate, hrStorage=hrStorage, hrSystemDate=hrSystemDate, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrProcessorLoad=hrProcessorLoad, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrSWRun=hrSWRun, hrSWRunPerfEntry=hrSWRunPerfEntry, hrSWRunPerfTable=hrSWRunPerfTable, hrSWRunTable=hrSWRunTable, hrPrinterTable=hrPrinterTable, hrFSAccess=hrFSAccess, hrStorageTypes=hrStorageTypes, hrSWInstalledType=hrSWInstalledType, hrSWRunPerfMem=hrSWRunPerfMem, hrPrinterStatus=hrPrinterStatus, hrStorageAllocationUnits=hrStorageAllocationUnits, hrDeviceStatus=hrDeviceStatus, hrNetworkIfIndex=hrNetworkIfIndex, hrStorageGroup=hrStorageGroup, hrSWInstalled=hrSWInstalled, hrDiskStorageMedia=hrDiskStorageMedia, hrDiskStorageCapacity=hrDiskStorageCapacity, host=host, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrSWRunStatus=hrSWRunStatus, hrStorageDescr=hrStorageDescr, hrDeviceTable=hrDeviceTable, InternationalDisplayString=InternationalDisplayString, ProductID=ProductID, hrDeviceErrors=hrDeviceErrors, hrSWInstalledGroup=hrSWInstalledGroup, hrDeviceEntry=hrDeviceEntry, hrDiskStorageAccess=hrDiskStorageAccess, KBytes=KBytes, hrSystem=hrSystem, hrStorageTable=hrStorageTable, hrNetworkEntry=hrNetworkEntry, hrPartitionID=hrPartitionID, hostResourcesMibModule=hostResourcesMibModule, hrPartitionEntry=hrPartitionEntry, hrSystemMaxProcesses=hrSystemMaxProcesses, hrDeviceGroup=hrDeviceGroup, hrSWRunType=hrSWRunType, hrSWInstalledID=hrSWInstalledID, hrFSEntry=hrFSEntry, hrSystemNumUsers=hrSystemNumUsers, hrFSTable=hrFSTable, hrStorageSize=hrStorageSize, hrSWInstalledName=hrSWInstalledName, hrSWInstalledEntry=hrSWInstalledEntry, hrSystemProcesses=hrSystemProcesses, hrPartitionFSIndex=hrPartitionFSIndex, hrSWRunPerf=hrSWRunPerf, hrSWRunIndex=hrSWRunIndex, hrFSStorageIndex=hrFSStorageIndex, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrFSType=hrFSType, hrSWRunPerfCPU=hrSWRunPerfCPU, hrSWRunName=hrSWRunName, hrStorageUsed=hrStorageUsed, hrSWOSIndex=hrSWOSIndex, hrSystemUptime=hrSystemUptime, hrDeviceType=hrDeviceType, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrMIBGroups=hrMIBGroups, hrMemorySize=hrMemorySize, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrMIBAdminInfo=hrMIBAdminInfo, hrStorageType=hrStorageType, hrStorageIndex=hrStorageIndex, hrSWInstalledTable=hrSWInstalledTable, PYSNMP_MODULE_ID=hostResourcesMibModule, hrSWInstalledLastChange=hrSWInstalledLastChange, hrSystemGroup=hrSystemGroup, hrSWRunID=hrSWRunID, hrSWRunGroup=hrSWRunGroup, hrDeviceIndex=hrDeviceIndex, hrMIBCompliances=hrMIBCompliances, hrDiskStorageEntry=hrDiskStorageEntry, hrPartitionLabel=hrPartitionLabel, hrDeviceID=hrDeviceID, hrProcessorEntry=hrProcessorEntry, hrNetworkTable=hrNetworkTable, hrFSBootable=hrFSBootable, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrFSMountPoint=hrFSMountPoint, hrStorageEntry=hrStorageEntry, hrProcessorTable=hrProcessorTable, hrPartitionSize=hrPartitionSize, hrSWRunEntry=hrSWRunEntry, hrStorageAllocationFailures=hrStorageAllocationFailures, hrFSTypes=hrFSTypes, hrDiskStorageTable=hrDiskStorageTable, hrSWRunPath=hrSWRunPath, hrProcessorFrwID=hrProcessorFrwID, hrDeviceTypes=hrDeviceTypes, hrDeviceDescr=hrDeviceDescr, hrPrinterEntry=hrPrinterEntry, hrPartitionIndex=hrPartitionIndex, hrFSIndex=hrFSIndex, hrMIBCompliance=hrMIBCompliance, hrSWInstalledIndex=hrSWInstalledIndex, hrPartitionTable=hrPartitionTable, hrSWRunPerfGroup=hrSWRunPerfGroup, hrDevice=hrDevice)
