...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrDeviceType=hrDeviceType, hrStorageEntry=hrStorageEntry, hrStorageTable=hrStorageTable, hrSWInstalledLastChange=hrSWInstalledLastChange, hrStorageSize=hrStorageSize, hrProcessorEntry=hrProcessorEntry, hrSWRun=hrSWRun, hrProcessorLoad=hrProcessorLoad, hrDeviceDescr=hrDeviceDescr, hrPrinterStatus=hrPrinterStatus, hrDeviceGroup=hrDeviceGroup, hrNetworkTable=hrNetworkTable, hrProcessorTable=hrProcessorTable, hrDeviceTable=hrDeviceTable, hrDiskStorageAccess=hrDiskStorageAccess, host=host, hrProcessorFrwID=hrProcessorFrwID, hrDiskStorageCapacity=hrDiskStorageCapacity, hrSWRunTable=hrSWRunTable, hrStorageAllocationUnits=hrStorageAllocationUnits, hrMemorySize=hrMemorySize, hrStorageAllocationFailures=hrStorageAllocationFailures, hrSWInstalledIndex=hrSWInstalledIndex, hrSWInstalledID=hrSWInstalledID, hrSystemGroup=hrSystemGroup, hrSWRunPath=hrSWRunPath, hrSWRunID=hrSWRunID, hrStorageGroup=hrStorageGroup, hrFSIndex=hrFSIndex, hrSWInstalled=hrSWInstalled, hrNetworkEntry=hrNetworkEntry, hrPartitionIndex=hrPartitionIndex, hrSystemDate=hrSystemDate, hrDeviceEntry=hrDeviceEntry, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrSWRunPerfGroup=hrSWRunPerfGroup, KBytes=KBytes, hrSWRunName=hrSWRunName, hrSystemUptime=hrSystemUptime, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, ProductID=ProductID, hrPartitionFSIndex=hrPartitionFSIndex, hrSWInstalledEntry=hrSWInstalledEntry, hrDiskStorageMedia=hrDiskStorageMedia, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrSystem=hrSystem, hrDiskStorageTable=hrDiskStorageTable, hrStorageType=hrStorageType, hrPrinterTable=hrPrinterTable, hrFSTable=hrFSTable, hrFSType=hrFSType, hrSWRunIndex=hrSWRunIndex, hrPartitionTable=hrPartitionTable, hrSystemProcesses=hrSystemProcesses, hrStorageIndex=hrStorageIndex, hrNetworkIfIndex=hrNetworkIfIndex, hrSWRunStatus=hrSWRunStatus, hrStorageTypes=hrStorageTypes, hrSWInstalledType=hrSWInstalledType, hrSWRunPerfMem=hrSWRunPerfMem, hrSystemNumUsers=hrSystemNumUsers, hrFSBootable=hrFSBootable, InternationalDisplayString=InternationalDisplayString, hrStorageDescr=hrStorageDescr, hrSWRunPerfTable=hrSWRunPerfTable, hrDeviceIndex=hrDeviceIndex, hrSWRunEntry=hrSWRunEntry, hrMIBCompliances=hrMIBCompliances, hrMIBCompliance=hrMIBCompliance, hrPartitionID=hrPartitionID, hrDeviceID=hrDeviceID, hrMIBAdminInfo=hrMIBAdminInfo, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrDeviceErrors=hrDeviceErrors, hrSWRunPerfEntry=hrSWRunPerfEntry, hrDeviceTypes=hrDeviceTypes, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrSWRunGroup=hrSWRunGroup, hrSWOSIndex=hrSWOSIndex, hrDeviceStatus=hrDeviceStatus, hrSWInstalledTable=hrSWInstalledTable, hrFSAccess=hrFSAccess, hrDevice=hrDevice, hrPartitionEntry=hrPartitionEntry, hrPartitionLabel=hrPartitionLabel, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hostResourcesMibModule=hostResourcesMibModule, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrFSStorageIndex=hrFSStorageIndex, hrMIBGroups=hrMIBGroups, hrDiskStorageEntry=hrDiskStorageEntry, hrFSEntry=hrFSEntry, hrSWInstalledName=hrSWInstalledName, hrSWInstalledDate=hrSWInstalledDate, hrSWRunType=hrSWRunType, hrStorage=hrStorage, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrSWRunParameters=hrSWRunParameters, hrPartitionSize=hrPartitionSize, hrFSMountPoint=hrFSMountPoint, hrPrinterEntry=hrPrinterEntry, hrSWInstalledGroup=hrSWInstalledGroup, PYSNMP_MODULE_ID=hostResourcesMibModule, hrSWRunPerfCPU=hrSWRunPerfCPU, hrSystemMaxProcesses=hrSystemMaxProcesses, hrSWRunPerf=hrSWRunPerf, hrFSTypes=hrFSTypes, hrStorageUsed=hrStorageUsed)
