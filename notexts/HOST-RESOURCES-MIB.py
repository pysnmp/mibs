...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrSWRunIndex=hrSWRunIndex, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrStorageDescr=hrStorageDescr, hrSWRunStatus=hrSWRunStatus, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrDiskStorageCapacity=hrDiskStorageCapacity, hrSWRunParameters=hrSWRunParameters, hrDeviceGroup=hrDeviceGroup, hrFSTable=hrFSTable, hrSWInstalledDate=hrSWInstalledDate, hrDiskStorageEntry=hrDiskStorageEntry, hrSystemDate=hrSystemDate, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrFSStorageIndex=hrFSStorageIndex, hrPartitionIndex=hrPartitionIndex, hrSystemGroup=hrSystemGroup, hrSWRunEntry=hrSWRunEntry, ProductID=ProductID, hrSystem=hrSystem, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrSWRunPerf=hrSWRunPerf, hrDeviceType=hrDeviceType, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrSWRunPerfTable=hrSWRunPerfTable, hrSWRunType=hrSWRunType, hrFSIndex=hrFSIndex, hrDiskStorageAccess=hrDiskStorageAccess, hrFSBootable=hrFSBootable, hrProcessorFrwID=hrProcessorFrwID, hrDeviceTable=hrDeviceTable, hrSWRunPerfCPU=hrSWRunPerfCPU, host=host, hrDiskStorageMedia=hrDiskStorageMedia, hrStorageTable=hrStorageTable, hrStorageIndex=hrStorageIndex, hrSWRunTable=hrSWRunTable, hrSWRunGroup=hrSWRunGroup, hrFSType=hrFSType, hrStorageEntry=hrStorageEntry, hrStorageType=hrStorageType, hrSWRunPerfMem=hrSWRunPerfMem, hrSWInstalledName=hrSWInstalledName, hrDeviceErrors=hrDeviceErrors, hrSWInstalledTable=hrSWInstalledTable, hrDiskStorageRemoveble=hrDiskStorageRemoveble, PYSNMP_MODULE_ID=hostResourcesMibModule, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrPrinterStatus=hrPrinterStatus, hrSystemUptime=hrSystemUptime, hrDevice=hrDevice, hrMemorySize=hrMemorySize, hrDiskStorageTable=hrDiskStorageTable, hrFSAccess=hrFSAccess, hrDeviceTypes=hrDeviceTypes, hrStorage=hrStorage, hostResourcesMibModule=hostResourcesMibModule, hrSWRun=hrSWRun, hrPartitionTable=hrPartitionTable, hrSWOSIndex=hrSWOSIndex, hrSWInstalledEntry=hrSWInstalledEntry, hrMIBCompliances=hrMIBCompliances, hrPartitionID=hrPartitionID, hrProcessorLoad=hrProcessorLoad, hrMIBCompliance=hrMIBCompliance, hrDeviceEntry=hrDeviceEntry, InternationalDisplayString=InternationalDisplayString, hrNetworkEntry=hrNetworkEntry, hrSystemProcesses=hrSystemProcesses, hrMIBGroups=hrMIBGroups, hrSWInstalled=hrSWInstalled, hrSWInstalledLastChange=hrSWInstalledLastChange, hrPartitionEntry=hrPartitionEntry, hrStorageAllocationFailures=hrStorageAllocationFailures, hrPrinterTable=hrPrinterTable, hrProcessorEntry=hrProcessorEntry, hrPartitionFSIndex=hrPartitionFSIndex, hrDeviceDescr=hrDeviceDescr, hrMIBAdminInfo=hrMIBAdminInfo, hrSWInstalledType=hrSWInstalledType, hrNetworkTable=hrNetworkTable, hrNetworkIfIndex=hrNetworkIfIndex, hrStorageSize=hrStorageSize, hrFSEntry=hrFSEntry, hrSWRunID=hrSWRunID, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrDeviceID=hrDeviceID, hrSWInstalledGroup=hrSWInstalledGroup, hrSWRunPath=hrSWRunPath, hrStorageAllocationUnits=hrStorageAllocationUnits, hrSWRunPerfGroup=hrSWRunPerfGroup, hrFSTypes=hrFSTypes, hrDeviceIndex=hrDeviceIndex, hrPartitionLabel=hrPartitionLabel, hrSWRunPerfEntry=hrSWRunPerfEntry, hrFSMountPoint=hrFSMountPoint, hrPrinterEntry=hrPrinterEntry, hrSWRunName=hrSWRunName, hrStorageUsed=hrStorageUsed, hrSystemNumUsers=hrSystemNumUsers, hrSystemMaxProcesses=hrSystemMaxProcesses, hrStorageGroup=hrStorageGroup, hrSWInstalledIndex=hrSWInstalledIndex, hrProcessorTable=hrProcessorTable, hrPartitionSize=hrPartitionSize, hrSWInstalledID=hrSWInstalledID, KBytes=KBytes, hrDeviceStatus=hrDeviceStatus, hrStorageTypes=hrStorageTypes)
