...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrFSAccess=hrFSAccess, hostResourcesMibModule=hostResourcesMibModule, hrFSEntry=hrFSEntry, hrSWInstalledDate=hrSWInstalledDate, hrSWOSIndex=hrSWOSIndex, hrFSType=hrFSType, hrSWRunIndex=hrSWRunIndex, hrSWInstalledID=hrSWInstalledID, hrPartitionSize=hrPartitionSize, hrDeviceDescr=hrDeviceDescr, hrSWRunStatus=hrSWRunStatus, hrMIBAdminInfo=hrMIBAdminInfo, ProductID=ProductID, hrSWRunPerfTable=hrSWRunPerfTable, hrSWInstalledTable=hrSWInstalledTable, hrSWRunEntry=hrSWRunEntry, hrPartitionTable=hrPartitionTable, hrPartitionID=hrPartitionID, hrSystemDate=hrSystemDate, hrSWRunPerfEntry=hrSWRunPerfEntry, hrDiskStorageEntry=hrDiskStorageEntry, hrStorageGroup=hrStorageGroup, hrProcessorEntry=hrProcessorEntry, hrSWRunPerfGroup=hrSWRunPerfGroup, hrStorageAllocationFailures=hrStorageAllocationFailures, hrSWInstalledGroup=hrSWInstalledGroup, hrSWInstalledLastChange=hrSWInstalledLastChange, hrSystemNumUsers=hrSystemNumUsers, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrDevice=hrDevice, hrSWRunTable=hrSWRunTable, hrPartitionLabel=hrPartitionLabel, hrSWRunGroup=hrSWRunGroup, hrSWRunName=hrSWRunName, hrSWRun=hrSWRun, hrPrinterEntry=hrPrinterEntry, hrSWInstalledType=hrSWInstalledType, hrFSStorageIndex=hrFSStorageIndex, hrSystemGroup=hrSystemGroup, hrStorageEntry=hrStorageEntry, hrSystemProcesses=hrSystemProcesses, hrMemorySize=hrMemorySize, hrSWRunPerfMem=hrSWRunPerfMem, hrFSMountPoint=hrFSMountPoint, hrStorageUsed=hrStorageUsed, hrSWRunID=hrSWRunID, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrStorageTypes=hrStorageTypes, hrDiskStorageAccess=hrDiskStorageAccess, hrDiskStorageMedia=hrDiskStorageMedia, hrDeviceIndex=hrDeviceIndex, hrStorageTable=hrStorageTable, host=host, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrNetworkIfIndex=hrNetworkIfIndex, hrProcessorTable=hrProcessorTable, hrStorageType=hrStorageType, hrDeviceStatus=hrDeviceStatus, hrDiskStorageCapacity=hrDiskStorageCapacity, hrPrinterStatus=hrPrinterStatus, PYSNMP_MODULE_ID=hostResourcesMibModule, hrSWRunParameters=hrSWRunParameters, hrDeviceGroup=hrDeviceGroup, hrPrinterTable=hrPrinterTable, InternationalDisplayString=InternationalDisplayString, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrMIBGroups=hrMIBGroups, hrDiskStorageTable=hrDiskStorageTable, KBytes=KBytes, hrStorageDescr=hrStorageDescr, hrSWInstalledName=hrSWInstalledName, hrSWInstalledIndex=hrSWInstalledIndex, hrDeviceEntry=hrDeviceEntry, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrDeviceTypes=hrDeviceTypes, hrNetworkEntry=hrNetworkEntry, hrSWRunType=hrSWRunType, hrFSTable=hrFSTable, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrMIBCompliances=hrMIBCompliances, hrStorageIndex=hrStorageIndex, hrFSIndex=hrFSIndex, hrStorageSize=hrStorageSize, hrSWRunPerf=hrSWRunPerf, hrNetworkTable=hrNetworkTable, hrDeviceErrors=hrDeviceErrors, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrPartitionFSIndex=hrPartitionFSIndex, hrDeviceTable=hrDeviceTable, hrMIBCompliance=hrMIBCompliance, hrFSTypes=hrFSTypes, hrSWInstalled=hrSWInstalled, hrSystemMaxProcesses=hrSystemMaxProcesses, hrSystemUptime=hrSystemUptime, hrDeviceID=hrDeviceID, hrPartitionEntry=hrPartitionEntry, hrStorage=hrStorage, hrSystem=hrSystem, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrFSBootable=hrFSBootable, hrSWInstalledEntry=hrSWInstalledEntry, hrProcessorFrwID=hrProcessorFrwID, hrSWRunPath=hrSWRunPath, hrProcessorLoad=hrProcessorLoad, hrStorageAllocationUnits=hrStorageAllocationUnits, hrSWRunPerfCPU=hrSWRunPerfCPU, hrDeviceType=hrDeviceType, hrPartitionIndex=hrPartitionIndex)
