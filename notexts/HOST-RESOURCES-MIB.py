...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", PYSNMP_MODULE_ID=hostResourcesMibModule, hrSWInstalledID=hrSWInstalledID, hrSWInstalledGroup=hrSWInstalledGroup, hrDevice=hrDevice, hrPrinterTable=hrPrinterTable, hrDeviceDescr=hrDeviceDescr, hrStorageGroup=hrStorageGroup, hrDiskStorageEntry=hrDiskStorageEntry, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrSWInstalled=hrSWInstalled, hrMIBAdminInfo=hrMIBAdminInfo, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrFSEntry=hrFSEntry, hrProcessorFrwID=hrProcessorFrwID, hrSWRunEntry=hrSWRunEntry, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrDeviceTable=hrDeviceTable, hrSWRunPerfMem=hrSWRunPerfMem, hrSWRunParameters=hrSWRunParameters, hrPrinterEntry=hrPrinterEntry, hrFSStorageIndex=hrFSStorageIndex, hrDiskStorageAccess=hrDiskStorageAccess, hrStorageUsed=hrStorageUsed, hrMemorySize=hrMemorySize, hrSystemGroup=hrSystemGroup, hrSWOSIndex=hrSWOSIndex, hrPartitionFSIndex=hrPartitionFSIndex, hrPartitionTable=hrPartitionTable, hrNetworkEntry=hrNetworkEntry, hrStorageEntry=hrStorageEntry, hrDiskStorageCapacity=hrDiskStorageCapacity, hrMIBCompliance=hrMIBCompliance, hrProcessorLoad=hrProcessorLoad, hrStorageAllocationFailures=hrStorageAllocationFailures, hrSWRunPerf=hrSWRunPerf, hrStorageType=hrStorageType, hrSWRun=hrSWRun, hrSWRunPerfEntry=hrSWRunPerfEntry, hrMIBGroups=hrMIBGroups, InternationalDisplayString=InternationalDisplayString, hrSWRunPerfCPU=hrSWRunPerfCPU, hostResourcesMibModule=hostResourcesMibModule, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrProcessorEntry=hrProcessorEntry, hrNetworkIfIndex=hrNetworkIfIndex, hrFSMountPoint=hrFSMountPoint, host=host, ProductID=ProductID, hrSWInstalledIndex=hrSWInstalledIndex, hrNetworkTable=hrNetworkTable, hrPartitionIndex=hrPartitionIndex, hrSWRunIndex=hrSWRunIndex, hrPrinterStatus=hrPrinterStatus, hrSWInstalledLastChange=hrSWInstalledLastChange, hrDiskStorageMedia=hrDiskStorageMedia, hrMIBCompliances=hrMIBCompliances, hrSystemUptime=hrSystemUptime, hrDeviceID=hrDeviceID, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrDeviceTypes=hrDeviceTypes, hrDeviceGroup=hrDeviceGroup, hrSWRunPerfTable=hrSWRunPerfTable, hrSWInstalledName=hrSWInstalledName, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrPartitionLabel=hrPartitionLabel, hrSystem=hrSystem, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrDeviceErrors=hrDeviceErrors, hrDeviceIndex=hrDeviceIndex, hrStorageTypes=hrStorageTypes, hrStorageIndex=hrStorageIndex, hrSWRunType=hrSWRunType, hrFSAccess=hrFSAccess, hrSWRunStatus=hrSWRunStatus, hrSystemProcesses=hrSystemProcesses, KBytes=KBytes, hrFSIndex=hrFSIndex, hrPartitionSize=hrPartitionSize, hrStorageSize=hrStorageSize, hrDeviceType=hrDeviceType, hrPartitionID=hrPartitionID, hrFSTypes=hrFSTypes, hrSWInstalledType=hrSWInstalledType, hrSystemDate=hrSystemDate, hrSWRunPath=hrSWRunPath, hrSystemNumUsers=hrSystemNumUsers, hrDeviceEntry=hrDeviceEntry, hrSWInstalledEntry=hrSWInstalledEntry, hrSWRunID=hrSWRunID, hrFSType=hrFSType, hrStorage=hrStorage, hrFSBootable=hrFSBootable, hrFSTable=hrFSTable, hrSWRunTable=hrSWRunTable, hrSWRunName=hrSWRunName, hrSWRunPerfGroup=hrSWRunPerfGroup, hrDiskStorageTable=hrDiskStorageTable, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrStorageAllocationUnits=hrStorageAllocationUnits, hrSWInstalledTable=hrSWInstalledTable, hrSWRunGroup=hrSWRunGroup, hrPartitionEntry=hrPartitionEntry, hrProcessorTable=hrProcessorTable, hrSWInstalledDate=hrSWInstalledDate, hrStorageTable=hrStorageTable, hrSystemMaxProcesses=hrSystemMaxProcesses, hrStorageDescr=hrStorageDescr, hrDeviceStatus=hrDeviceStatus)
