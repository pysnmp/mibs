...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrDeviceType=hrDeviceType, hrDeviceIndex=hrDeviceIndex, hrFSType=hrFSType, hrPartitionIndex=hrPartitionIndex, hrFSIndex=hrFSIndex, hrNetworkIfIndex=hrNetworkIfIndex, hrSWRun=hrSWRun, hrProcessorFrwID=hrProcessorFrwID, hrPrinterEntry=hrPrinterEntry, hrSWRunPath=hrSWRunPath, hrMIBCompliance=hrMIBCompliance, hrSWRunStatus=hrSWRunStatus, hrStorageEntry=hrStorageEntry, hrSystemNumUsers=hrSystemNumUsers, hrStorageAllocationUnits=hrStorageAllocationUnits, hrStorageIndex=hrStorageIndex, hrPartitionLabel=hrPartitionLabel, hrSWInstalledID=hrSWInstalledID, hrPrinterTable=hrPrinterTable, hrStorageAllocationFailures=hrStorageAllocationFailures, hrDiskStorageAccess=hrDiskStorageAccess, hrSystem=hrSystem, hrMIBCompliances=hrMIBCompliances, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrNetworkTable=hrNetworkTable, hrSystemDate=hrSystemDate, hrSystemMaxProcesses=hrSystemMaxProcesses, hrSWInstalledName=hrSWInstalledName, hostResourcesMibModule=hostResourcesMibModule, hrStorage=hrStorage, hrProcessorEntry=hrProcessorEntry, hrSWRunPerfMem=hrSWRunPerfMem, host=host, ProductID=ProductID, hrStorageTypes=hrStorageTypes, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrSWInstalledTable=hrSWInstalledTable, PYSNMP_MODULE_ID=hostResourcesMibModule, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrSystemUptime=hrSystemUptime, hrSWRunTable=hrSWRunTable, hrMIBAdminInfo=hrMIBAdminInfo, hrStorageUsed=hrStorageUsed, hrDeviceTypes=hrDeviceTypes, hrDevice=hrDevice, hrDeviceErrors=hrDeviceErrors, hrSWRunID=hrSWRunID, hrSWInstalledLastChange=hrSWInstalledLastChange, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrSWInstalled=hrSWInstalled, KBytes=KBytes, hrProcessorLoad=hrProcessorLoad, hrFSStorageIndex=hrFSStorageIndex, hrNetworkEntry=hrNetworkEntry, hrMIBGroups=hrMIBGroups, hrFSBootable=hrFSBootable, hrSWRunIndex=hrSWRunIndex, hrPrinterStatus=hrPrinterStatus, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrDeviceDescr=hrDeviceDescr, hrSWRunPerfCPU=hrSWRunPerfCPU, hrPartitionSize=hrPartitionSize, hrStorageDescr=hrStorageDescr, hrDeviceTable=hrDeviceTable, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrFSMountPoint=hrFSMountPoint, hrFSTable=hrFSTable, hrStorageGroup=hrStorageGroup, hrStorageSize=hrStorageSize, hrDiskStorageTable=hrDiskStorageTable, hrPartitionFSIndex=hrPartitionFSIndex, hrSystemGroup=hrSystemGroup, hrFSTypes=hrFSTypes, hrFSAccess=hrFSAccess, hrSWRunType=hrSWRunType, hrPartitionEntry=hrPartitionEntry, hrSWOSIndex=hrSWOSIndex, hrSWInstalledGroup=hrSWInstalledGroup, hrSystemProcesses=hrSystemProcesses, hrDeviceEntry=hrDeviceEntry, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrFSEntry=hrFSEntry, hrDiskStorageCapacity=hrDiskStorageCapacity, hrDeviceStatus=hrDeviceStatus, hrSWRunPerf=hrSWRunPerf, hrDiskStorageMedia=hrDiskStorageMedia, hrPartitionID=hrPartitionID, hrSWRunPerfEntry=hrSWRunPerfEntry, hrSWInstalledType=hrSWInstalledType, hrDeviceID=hrDeviceID, hrMemorySize=hrMemorySize, hrSWRunPerfTable=hrSWRunPerfTable, hrSWInstalledEntry=hrSWInstalledEntry, hrSWRunGroup=hrSWRunGroup, hrSWRunParameters=hrSWRunParameters, hrProcessorTable=hrProcessorTable, hrStorageTable=hrStorageTable, hrSWRunName=hrSWRunName, InternationalDisplayString=InternationalDisplayString, hrSWInstalledDate=hrSWInstalledDate, hrDeviceGroup=hrDeviceGroup, hrSWInstalledIndex=hrSWInstalledIndex, hrSWRunPerfGroup=hrSWRunPerfGroup, hrDiskStorageEntry=hrDiskStorageEntry, hrPartitionTable=hrPartitionTable, hrStorageType=hrStorageType, hrSWRunEntry=hrSWRunEntry)
