...
# ASN.1 source CISCO-METRO-PHY-MIB
# Source digest sha256:c31c484f565b8c22acce17c470d217edeaf1f43d1e1f60c43ff234694bc0bc1b
...
if mibBuilder.loadTexts: ciscoMetroPhyMIB.setLastUpdated('2005-09-02 00:00')
...
cmPhyIfTable = MibTable((1, 3, 6, 1, 4, 1, 9, 10, 69, 1, 1, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: cmPhyIfTable.setStatus('current')
cmPhyIfEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 10, 69, 1, 1, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "IF-MIB", "ifIndex"))
...
cmPhyIfClientSubrate = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 10, 69, 1, 1, 1, 1, 15), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(0, 4240)).clone(0)).setUnits('mega-bytes-per-second').setMaxAccess("readwrite")
...
cmPhyStatisticsTable = MibTable((1, 3, 6, 1, 4, 1, 9, 10, 69, 1, 2, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: cmPhyStatisticsTable.setStatus('current')
cmPhyStatisticsEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 10, 69, 1, 2, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "IF-MIB", "ifIndex"))
...
cmPhySonetSectionTraceTable = MibTable((1, 3, 6, 1, 4, 1, 9, 10, 69, 1, 3, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: cmPhySonetSectionTraceTable.setStatus('current')
cmPhySonetSectionTraceEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 10, 69, 1, 3, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "IF-MIB", "ifIndex"))
...
mibBuilder.exportSymbols("CISCO-METRO-PHY-MIB", CmNegotiatedRateType=CmNegotiatedRateType, CmRateType=CmRateType, PYSNMP_MODULE_ID=ciscoMetroPhyMIB, ProtocolType=ProtocolType, TransmissionType=TransmissionType, TriValue=TriValue, ciscoMetroPhyMIB=ciscoMetroPhyMIB, ciscoMetroPhyMIBCompliances=ciscoMetroPhyMIBCompliances, ciscoMetroPhyMIBConformance=ciscoMetroPhyMIBConformance, ciscoMetroPhyMIBGroups=ciscoMetroPhyMIBGroups, ciscoMetroPhyMIBObjects=ciscoMetroPhyMIBObjects, cmPhyCRCErrorsGroup=cmPhyCRCErrorsGroup, cmPhyCVRDErrorsGroup=cmPhyCVRDErrorsGroup, cmPhyEncapFarEndPktErrorsGroup=cmPhyEncapFarEndPktErrorsGroup, cmPhyHCRxCRC=cmPhyHCRxCRC, cmPhyHCRxCVRD=cmPhyHCRxCVRD, cmPhyHCRxHEC=cmPhyHCRxHEC, cmPhyHCTxEncapFarEndPktErrors=cmPhyHCTxEncapFarEndPktErrors, cmPhyIf2Group=cmPhyIf2Group, cmPhyIf=cmPhyIf, cmPhyIfAutoNegGroup=cmPhyIfAutoNegGroup, cmPhyIfAutoNegotiation=cmPhyIfAutoNegotiation, cmPhyIfClientOvsGroup=cmPhyIfClientOvsGroup, cmPhyIfClientSubrate=cmPhyIfClientSubrate, cmPhyIfClientSubrateGroup=cmPhyIfClientSubrateGroup, cmPhyIfClientSubrateLock=cmPhyIfClientSubrateLock, cmPhyIfClockRate=cmPhyIfClockRate, cmPhyIfEntry=cmPhyIfEntry, cmPhyIfForwardLaserControl=cmPhyIfForwardLaserControl, cmPhyIfGroup=cmPhyIfGroup, cmPhyIfGroupSup1=cmPhyIfGroupSup1, cmPhyIfLaserSafetyControl=cmPhyIfLaserSafetyControl, cmPhyIfLoopback=cmPhyIfLoopback, cmPhyIfMode=cmPhyIfMode, cmPhyIfMonitor=cmPhyIfMonitor, cmPhyIfNegotiatedRate=cmPhyIfNegotiatedRate, cmPhyIfOFC=cmPhyIfOFC, cmPhyIfOverSubscription=cmPhyIfOverSubscription, cmPhyIfProtocol=cmPhyIfProtocol, cmPhyIfRate=cmPhyIfRate, cmPhyIfRateGroup=cmPhyIfRateGroup, cmPhyIfTable=cmPhyIfTable, cmPhyIfTransType=cmPhyIfTransType, cmPhyIfTxBufferSize=cmPhyIfTxBufferSize, cmPhyIfTxBufferSizeGroup=cmPhyIfTxBufferSizeGroup, cmPhyMIBCompliance2=cmPhyMIBCompliance2, cmPhyMIBCompliance3=cmPhyMIBCompliance3, cmPhyMIBCompliance=cmPhyMIBCompliance, cmPhyMIBComplianceRev4=cmPhyMIBComplianceRev4, cmPhyMIBComplianceRev5=cmPhyMIBComplianceRev5, cmPhyMIBComplianceRev6=cmPhyMIBComplianceRev6, cmPhyRxCRC=cmPhyRxCRC, cmPhyRxCRCOverflow=cmPhyRxCRCOverflow, cmPhyRxCVRD=cmPhyRxCVRD, cmPhyRxCVRDOverflow=cmPhyRxCVRDOverflow, cmPhyRxHEC=cmPhyRxHEC, cmPhyRxHECOverflow=cmPhyRxHECOverflow, cmPhyRxPower=cmPhyRxPower, cmPhySonetSectionTrace=cmPhySonetSectionTrace, cmPhySonetSectionTraceEntry=cmPhySonetSectionTraceEntry, cmPhySonetSectionTraceExpected=cmPhySonetSectionTraceExpected, cmPhySonetSectionTraceGroup=cmPhySonetSectionTraceGroup, cmPhySonetSectionTraceReceived=cmPhySonetSectionTraceReceived, cmPhySonetSectionTraceTable=cmPhySonetSectionTraceTable, cmPhyStatistics=cmPhyStatistics, cmPhyStatisticsEntry=cmPhyStatisticsEntry, cmPhyStatisticsGroup=cmPhyStatisticsGroup, cmPhyStatisticsTable=cmPhyStatisticsTable, cmPhyTxEncapFarEndPktErrOverflow=cmPhyTxEncapFarEndPktErrOverflow, cmPhyTxEncapFarEndPktErrors=cmPhyTxEncapFarEndPktErrors)
