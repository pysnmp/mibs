...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCurCfgAreaId=ospfCurCfgAreaId, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfGeneral=ospfGeneral, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfLoop=ospfIntfLoop, ripConfig=ripConfig, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfGeneralInfo=ospfGeneralInfo, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ip_info=ip_info, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, arpStatMaxEntries=arpStatMaxEntries, routeStats=routeStats, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfTotalTransitAreas=ospfTotalTransitAreas, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaTxPkts=ospfAreaTxPkts, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgGwEntry=ipCurCfgGwEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfHello=ospfIntfHello, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ripCurCfgSupply=ripCurCfgSupply, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfNbrInFullState=ospfNbrInFullState, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgIntfState=ipCurCfgIntfState, vrrpStats=vrrpStats, ipInterfaceTableMax=ipInterfaceTableMax, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfRxDatabase=ospfIntfRxDatabase, ripNewCfgVip=ripNewCfgVip, vrrp=vrrp, ospfCumIntfBackup=ospfCumIntfBackup, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ripNewCfgDefListen=ripNewCfgDefListen, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumNbrStart=ospfCumNbrStart, ipGatewayTableMax=ipGatewayTableMax, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfGeneralStats=ospfGeneralStats, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaInfoTable=ospfAreaInfoTable, arpInfoFlag=arpInfoFlag, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCfg=ospfCfg, routeStatMaxEntries=routeStatMaxEntries, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, routerLSAId=routerLSAId, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, dnsStats=dnsStats, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumTxPkts=ospfCumTxPkts, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpGeneral=vrrpGeneral, vrrp_info=vrrp_info, arpInfoMacAddr=arpInfoMacAddr, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgGwVlan=ipNewCfgGwVlan, ipRouteInfoDestIp=ipRouteInfoDestIp, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgGwAddr=ipCurCfgGwAddr, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ripNewCfgListen=ripNewCfgListen, ospfCumRxPkts=ospfCumRxPkts, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumNbrN1way=ospfCumNbrN1way, ospfProcessUptime=ospfProcessUptime, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgGwState=ipCurCfgGwState, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaNbrStart=ospfAreaNbrStart, arpInfoVLAN=arpInfoVLAN, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipNewCfgIntfMask=ipNewCfgIntfMask, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfNbrInExchState=ospfNbrInExchState, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgIntfState=ipNewCfgIntfState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", routerLSALinkData=routerLSALinkData, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, routeStatHighWater=routeStatHighWater, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfTotalAreas=ospfTotalAreas, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, routerLSALinkID=routerLSALinkID, arpInfoEntry=arpInfoEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, routerLSALinkIndex=routerLSALinkIndex, ipForward=ipForward, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, arpStatHighWater=arpStatHighWater, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfUnloop=ospfIntfUnloop, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ripCurCfgState=ripCurCfgState, ospfAreaIntfHello=ospfAreaIntfHello, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaIntfLoop=ospfAreaIntfLoop, iprouting=iprouting, ospfIntfTxHello=ospfIntfTxHello, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgGwArp=ipNewCfgGwArp, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumNbrhello=ospfCumNbrhello, ospfIntfIndex=ospfIntfIndex, ospfArea=ospfArea, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaRxDatabase=ospfAreaRxDatabase, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumRxDatabase=ospfCumRxDatabase, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfBackup=ospfIntfBackup, ospfStats=ospfStats, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ripNewCfgState=ripNewCfgState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumTxlsAcks=ospfCumTxlsAcks, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpStatInAdvers=vrrpStatInAdvers, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpOper=vrrpOper, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, arpInfoSrcPort=arpInfoSrcPort, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfInterface=ospfInterface, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgGwEntry=ipNewCfgGwEntry, ripStatInPkts=ripStatInPkts, ospfCumRxHello=ospfCumRxHello, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ripNewCfgSupply=ripNewCfgSupply, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumTxHello=ospfCumTxHello, ospfIfInfoIndex=ospfIfInfoIndex, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ripCurCfgListen=ripCurCfgListen, ospfIntfNbrDown=ospfIntfNbrDown, ospfinfo=ospfinfo, ospfAreaInfoId=ospfAreaInfoId, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfRxHello=ospfIntfRxHello, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, arpStats=arpStats, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfTxPkts=ospfIntfTxPkts, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, routeStatEntries=routeStatEntries, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumTxDatabase=ospfCumTxDatabase, ipRouteInfoType=ipRouteInfoType, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, routerLSAAreaIndex=routerLSAAreaIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfDown=ospfIntfDown, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaIntfBackup=ospfAreaIntfBackup, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumNbrDown=ospfCumNbrDown, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ripStats=ripStats, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr)
