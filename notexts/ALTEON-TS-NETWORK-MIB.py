...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumTxPkts=ospfCumTxPkts, routerLSALinkData=routerLSALinkData, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, dnsStats=dnsStats, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaTxDatabase=ospfAreaTxDatabase, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, arpInfoDestIp=arpInfoDestIp, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumIntfDown=ospfCumIntfDown, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfNbrInExchState=ospfNbrInExchState, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrp=vrrp, arpInfoMacAddr=arpInfoMacAddr, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, arpStatMaxEntries=arpStatMaxEntries, vrrpStatInAdvers=vrrpStatInAdvers, ripNewCfgListen=ripNewCfgListen, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, routerLSALinkIndex=routerLSALinkIndex, ospfIntfUnloop=ospfIntfUnloop, arpStatEntries=arpStatEntries, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfTxHello=ospfIntfTxHello, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ripNewCfgState=ripNewCfgState, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipGatewayTableMax=ipGatewayTableMax, ospfAreaIntfBackup=ospfAreaIntfBackup, routeStatMaxEntries=routeStatMaxEntries, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumNbrhello=ospfCumNbrhello, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumRxPkts=ospfCumRxPkts, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpStats=vrrpStats, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfInfoEntry=ospfIntfInfoEntry, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfLsTypesSupported=ospfLsTypesSupported, ospfGeneral=ospfGeneral, ospfAreaRxPkts=ospfAreaRxPkts, vrrpGeneral=vrrpGeneral, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, arpInfoRefPorts=arpInfoRefPorts, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIfInfoIndex=ospfIfInfoIndex, ip_info=ip_info, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfIndex=ospfIntfIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpOper=vrrpOper, ripCurCfgState=ripCurCfgState, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfinfo=ospfinfo, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaRxHello=ospfAreaRxHello, routeStats=routeStats, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripCurCfgVip=ripCurCfgVip, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfHostTableMaxSize=ospfHostTableMaxSize, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumRxHello=ospfCumRxHello, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaNbrStart=ospfAreaNbrStart, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgGwMetric=ipNewCfgGwMetric, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfTotalNeighbours=ospfTotalNeighbours, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfLoop=ospfIntfLoop, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfGeneralInfo=ospfGeneralInfo, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, arpInfoEntry=arpInfoEntry, ipCurCfgGwState=ipCurCfgGwState, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipInterfaceTableMax=ipInterfaceTableMax, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfInfoTable=ospfIntfInfoTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, routeStatHighWater=routeStatHighWater, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfArea=ospfArea, arpInfoTable=arpInfoTable, ipCurCfgGwArp=ipCurCfgGwArp, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfTimersKickOffStats=ospfTimersKickOffStats, ripStatInPkts=ripStatInPkts, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgBootpState=ipCurCfgBootpState, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ripStats=ripStats, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, arpInfoFlag=arpInfoFlag, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgGwArp=ipNewCfgGwArp, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfRxPkts=ospfIntfRxPkts, arpInfoVLAN=arpInfoVLAN, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfNbrInInitState=ospfNbrInInitState, ospfNbrInFullState=ospfNbrInFullState, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, routerLSAId=routerLSAId, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfTxPkts=ospfIntfTxPkts, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ripStatInErrorPkts=ripStatInErrorPkts, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaTxPkts=ospfAreaTxPkts, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfStats=ospfStats, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrp_info=vrrp_info, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumTxHello=ospfCumTxHello, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ripConfig=ripConfig, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipRouteInfoType=ipRouteInfoType, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfGeneralStats=ospfGeneralStats, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, arpStatHighWater=arpStatHighWater, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipForward=ipForward, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfStartTime=ospfStartTime, routerLSALinkIfIndex=routerLSALinkIfIndex, ipRouteInfoEntry=ipRouteInfoEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ripCurCfgListen=ripCurCfgListen, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfDown=ospfIntfDown, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaIntfIndex=ospfAreaIntfIndex, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumTxDatabase=ospfCumTxDatabase, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, iprouting=iprouting, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaRxTxStats=ospfAreaRxTxStats, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaIntfDown=ospfAreaIntfDown, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfRxHello=ospfIntfRxHello, ospfCumTxlsAcks=ospfCumTxlsAcks, ripNewCfgVip=ripNewCfgVip, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaTxHello=ospfAreaTxHello, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCfg=ospfCfg, arpStats=arpStats, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumNbrStart=ospfCumNbrStart, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfTotalAreas=ospfTotalAreas, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipRouteInfoTable=ipRouteInfoTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry)
