...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumIntfHello=ospfCumIntfHello, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, ripCurCfgDefListen=ripCurCfgDefListen, arpStats=arpStats, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaInfoId=ospfAreaInfoId, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCfg=ospfCfg, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipRouteInfoEntry=ipRouteInfoEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ripCurCfgState=ripCurCfgState, ripStatInPkts=ripStatInPkts, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaNbrhello=ospfAreaNbrhello, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipRouteInfoMask=ipRouteInfoMask, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipNewCfgIntfAddr=ipNewCfgIntfAddr, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripCurCfgVip=ripCurCfgVip, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfArea=ospfArea, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipRouteInfoInterface=ipRouteInfoInterface, ripStatOutPkts=ripStatOutPkts, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfNbrInInitState=ospfNbrInInitState, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, iprouting=iprouting, ospfAreaRxPkts=ospfAreaRxPkts, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, routerLSAId=routerLSAId, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, ripCurCfgListen=ripCurCfgListen, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaRxHello=ospfAreaRxHello, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumNbrhello=ospfCumNbrhello, ripNewCfgSupply=ripNewCfgSupply, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, arpInfoSrcPort=arpInfoSrcPort, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumTxPkts=ospfCumTxPkts, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaInfoEntry=ospfAreaInfoEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumNbrStart=ospfCumNbrStart, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfUnloop=ospfIntfUnloop, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipCurCfgGwTable=ipCurCfgGwTable, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfNbrN1way=ospfIntfNbrN1way, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, dnsStats=dnsStats, ospfIntfWaitTimer=ospfIntfWaitTimer, arpStatMaxEntries=arpStatMaxEntries, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipRouteInfoTable=ipRouteInfoTable, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgGwState=ipNewCfgGwState, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, arpInfoRefPorts=arpInfoRefPorts, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdNewCfgState=ipFwdNewCfgState, routerLSALinkData=routerLSALinkData, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgGwInterval=ipNewCfgGwInterval, ripNewCfgVip=ripNewCfgVip, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfHello=ospfIntfHello, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, arpInfoVLAN=arpInfoVLAN, ipRouteInfoIndx=ipRouteInfoIndx, ipRouteInfoTag=ipRouteInfoTag, ospfStats=ospfStats, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfRxlsReqs=ospfIntfRxlsReqs, routeStatEntries=routeStatEntries, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfTxPkts=ospfIntfTxPkts, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCumRxTxStats=ospfCumRxTxStats, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaTxHello=ospfAreaTxHello, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfLoop=ospfIntfLoop, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfNbrInFullState=ospfNbrInFullState, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipRouteInfoType=ipRouteInfoType, arpInfoTable=arpInfoTable, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfInterface=ospfInterface, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumNbrDown=ospfCumNbrDown, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ripStats=ripStats, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, routeStats=routeStats, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipInterfaceTableMax=ipInterfaceTableMax, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgIntfState=ipNewCfgIntfState, ipForward=ipForward, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpOper=vrrpOper, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrp_info=vrrp_info, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfDown=ospfIntfDown, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ripCurCfgSupply=ripCurCfgSupply, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumRxHello=ospfCumRxHello, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfIndex=ospfIntfIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfBackup=ospfIntfBackup, ripConfig=ripConfig, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipFwdCurCfgState=ipFwdCurCfgState, ip_info=ip_info, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, arpInfoEntry=arpInfoEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrp=vrrp, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, routeStatHighWater=routeStatHighWater, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripNewCfgListen=ripNewCfgListen, ospfCumRxPkts=ospfCumRxPkts, ospfGeneralStats=ospfGeneralStats, ipCurCfgIntfIndex=ipCurCfgIntfIndex, arpInfoFlag=arpInfoFlag, ipNewCfgIntfMask=ipNewCfgIntfMask, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpGeneral=vrrpGeneral, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, arpInfoMacAddr=arpInfoMacAddr, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ripNewCfgState=ripNewCfgState, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ripStatInErrorPkts=ripStatInErrorPkts, ipGatewayTableMax=ipGatewayTableMax, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfinfo=ospfinfo, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfInfoEntry=ospfIntfInfoEntry, arpStatHighWater=arpStatHighWater, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpStats=vrrpStats, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry)
