...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, iprouting=iprouting, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpStats=vrrpStats, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgIntfMask=ipNewCfgIntfMask, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfNbrChange=ospfIntfNbrChange, ospfStats=ospfStats, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumNbrhello=ospfCumNbrhello, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgGwState=ipCurCfgGwState, ospfCumIntfDown=ospfCumIntfDown, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfGeneralStats=ospfGeneralStats, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfTxDatabase=ospfIntfTxDatabase, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCumIntfHello=ospfCumIntfHello, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, routeStatHighWater=routeStatHighWater, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrp=vrrp, ospfCumNbrDown=ospfCumNbrDown, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfGeneralInfo=ospfGeneralInfo, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfBackup=ospfIntfBackup, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ripCurCfgSupply=ripCurCfgSupply, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfIndex=ospfIntfIndex, ospfCumTxHello=ospfCumTxHello, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfNbrInExchState=ospfNbrInExchState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgGwRetry=ipCurCfgGwRetry, ipFwdCurCfgState=ipFwdCurCfgState, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfGeneral=ospfGeneral, ospfIfWaitInterval=ospfIfWaitInterval, arpInfoRefPorts=arpInfoRefPorts, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumRxTxStats=ospfCumRxTxStats, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumNbrStart=ospfCumNbrStart, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpOper=vrrpOper, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, arpStatHighWater=arpStatHighWater, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumIntfBackup=ospfCumIntfBackup, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, routerLSALinkData=routerLSALinkData, ipCurCfgIntfMask=ipCurCfgIntfMask, dnsStats=dnsStats, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumTxDatabase=ospfCumTxDatabase, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfProcessUptime=ospfProcessUptime, ospfCurCfgAreaId=ospfCurCfgAreaId, routerLSALinkID=routerLSALinkID, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfDown=ospfIntfDown, ospfIntfLoop=ospfIntfLoop, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgIntfTable=ipNewCfgIntfTable, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfinfo=ospfinfo, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfChangeStats=ospfIntfChangeStats, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfStartTime=ospfStartTime, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfNbrStart=ospfIntfNbrStart, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipGatewayTableMax=ipGatewayTableMax, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripNewCfgVip=ripNewCfgVip, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ripStats=ripStats, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfInterface=ospfInterface, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpGeneral=vrrpGeneral, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumNbrBadSequence=ospfCumNbrBadSequence, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumTxPkts=ospfCumTxPkts, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ripConfig=ripConfig, ipRouteInfoIndx=ipRouteInfoIndx, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ripCurCfgVip=ripCurCfgVip, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumTxlsReqs=ospfCumTxlsReqs, routeStats=routeStats, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumRxHello=ospfCumRxHello, ospfAreaChangeStats=ospfAreaChangeStats, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumRxlsUpdates=ospfCumRxlsUpdates, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfArea=ospfArea, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgBootpState=ipCurCfgBootpState, routeStatEntries=routeStatEntries, ripNewCfgListen=ripNewCfgListen, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaTxHello=ospfAreaTxHello, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfRxlsReqs=ospfIntfRxlsReqs, routerLSAId=routerLSAId, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipRouteInfoGateway=ipRouteInfoGateway, ripStatOutPkts=ripStatOutPkts, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfNbrDown=ospfIntfNbrDown, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpStatInAdvers=vrrpStatInAdvers, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, arpInfoDestIp=arpInfoDestIp, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, routerLSAAreaIndex=routerLSAAreaIndex, ipForward=ipForward, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ripNewCfgState=ripNewCfgState, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIfInfoIndex=ospfIfInfoIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfUnloop=ospfIntfUnloop, ipRouteInfoMask=ipRouteInfoMask, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaIntfHello=ospfAreaIntfHello, ripCurCfgState=ripCurCfgState, arpStats=arpStats, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgGwTable=ipCurCfgGwTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipRouteInfoTag=ipRouteInfoTag, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpStatOutAdvers=vrrpStatOutAdvers, ip_info=ip_info, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumRxDatabase=ospfCumRxDatabase, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaRxHello=ospfAreaRxHello, ospfAreaInfoEntry=ospfAreaInfoEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfTableMaxSize=ospfIntfTableMaxSize, arpInfoFlag=arpInfoFlag, ripCurCfgListen=ripCurCfgListen, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipRouteInfoDestIp=ipRouteInfoDestIp, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfNbrInFullState=ospfNbrInFullState, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgGwState=ipNewCfgGwState, ipFwdNewCfgState=ipFwdNewCfgState, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ripStatInPkts=ripStatInPkts, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates)
