...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfTxHello=ospfIntfTxHello, arpInfoRefPorts=arpInfoRefPorts, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgGwArp=ipNewCfgGwArp, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfRxHello=ospfIntfRxHello, vrrpOper=vrrpOper, arpInfoVLAN=arpInfoVLAN, ipInterfaceTableMax=ipInterfaceTableMax, arpStatHighWater=arpStatHighWater, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgGwMetric=ipCurCfgGwMetric, ipRouteInfoType=ipRouteInfoType, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumRxHello=ospfCumRxHello, arpInfoEntry=arpInfoEntry, arpInfoDestIp=arpInfoDestIp, vrrp=vrrp, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, arpInfoTable=arpInfoTable, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipRouteInfoDestIp=ipRouteInfoDestIp, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgGwRetry=ipCurCfgGwRetry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfArea=ospfArea, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgIntfState=ipNewCfgIntfState, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgGwInterval=ipNewCfgGwInterval, ipForward=ipForward, ospfCumIntfLoop=ospfCumIntfLoop, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumIntfDown=ospfCumIntfDown, ipFwdNewCfgState=ipFwdNewCfgState, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaRxPkts=ospfAreaRxPkts, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaIntfDown=ospfAreaIntfDown, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfGeneral=ospfGeneral, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfInterface=ospfInterface, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ripStatInErrorPkts=ripStatInErrorPkts, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipCurCfgGwVlan=ipCurCfgGwVlan, routerLSALinkData=routerLSALinkData, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumTxlsAcks=ospfCumTxlsAcks, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaTxDatabase=ospfAreaTxDatabase, ipRouteInfoTag=ipRouteInfoTag, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpStats=vrrpStats, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfTotalAreas=ospfTotalAreas, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ripCurCfgSupply=ripCurCfgSupply, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, routerLSALinkID=routerLSALinkID, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfProcessUptime=ospfProcessUptime, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfUnloop=ospfIntfUnloop, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripStatInPkts=ripStatInPkts, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, routeStats=routeStats, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgIntfTable=ipCurCfgIntfTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumTxDatabase=ospfCumTxDatabase, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfNbrStart=ospfIntfNbrStart, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgIntfMask=ipNewCfgIntfMask, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfTxPkts=ospfIntfTxPkts, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfNewCfgAreaId=ospfNewCfgAreaId, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ripNewCfgDefListen=ripNewCfgDefListen, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaInfoId=ospfAreaInfoId)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, routeStatEntries=routeStatEntries, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, arpStats=arpStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaRxHello=ospfAreaRxHello, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfStartTime=ospfStartTime, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipCurCfgGwArp=ipCurCfgGwArp, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgGwRetry=ipNewCfgGwRetry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, arpInfoSrcPort=arpInfoSrcPort, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ripNewCfgVip=ripNewCfgVip, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdCurCfgState=ipFwdCurCfgState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfNbrInFullState=ospfNbrInFullState, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ripStatOutPkts=ripStatOutPkts, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfCountForRouter=ospfIntfCountForRouter, ripConfig=ripConfig, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ip_info=ip_info, ospfIntfChangeStats=ospfIntfChangeStats, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgGwState=ipCurCfgGwState, routeStatMaxEntries=routeStatMaxEntries, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumRxTxStats=ospfCumRxTxStats, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ripStats=ripStats, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgIntfState=ipCurCfgIntfState, ospfNbrInExchState=ospfNbrInExchState, routeStatHighWater=routeStatHighWater, ipCurCfgGwTable=ipCurCfgGwTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ripCurCfgListen=ripCurCfgListen, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfInfoTable=ospfIntfInfoTable, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgGwIndex=ipCurCfgGwIndex, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, dnsStats=dnsStats, arpStatMaxEntries=arpStatMaxEntries, arpStatEntries=arpStatEntries, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfLoop=ospfIntfLoop, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfBackup=ospfIntfBackup, iprouting=iprouting, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfinfo=ospfinfo, ospfAreaTxPkts=ospfAreaTxPkts, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipRouteInfoMask=ipRouteInfoMask, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ripCurCfgState=ripCurCfgState, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, routerLSAId=routerLSAId, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfStats=ospfStats, ospfGeneralStats=ospfGeneralStats, ipNewCfgGwState=ipNewCfgGwState, ospfIntfTxDatabase=ospfIntfTxDatabase, ipRouteInfoTable=ipRouteInfoTable, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCurCfgAreaId=ospfCurCfgAreaId, ripNewCfgSupply=ripNewCfgSupply, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumNbrStart=ospfCumNbrStart, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumNbrDown=ospfCumNbrDown, arpInfoFlag=arpInfoFlag, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfHello=ospfIntfHello, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaNbrDown=ospfAreaNbrDown)
