...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfRxTxStats=ospfIntfRxTxStats, ripConfig=ripConfig, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaIntfIndex=ospfAreaIntfIndex, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumIntfBackup=ospfCumIntfBackup, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumNbrhello=ospfCumNbrhello, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfLoop=ospfIntfLoop, ospfCumTxDatabase=ospfCumTxDatabase, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfNbrChange=ospfIntfNbrChange, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ripCurCfgDefListen=ripCurCfgDefListen, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaNbrStart=ospfAreaNbrStart, ospfTotalAreas=ospfTotalAreas, ipGatewayTableMax=ipGatewayTableMax, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ripStats=ripStats, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumIntfHello=ospfCumIntfHello, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ripStatInPkts=ripStatInPkts, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfNbrInFullState=ospfNbrInFullState, ospfNewCfgAreaId=ospfNewCfgAreaId, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaInfoId=ospfAreaInfoId, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrp=vrrp, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaIntfDown=ospfAreaIntfDown, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaRxHello=ospfAreaRxHello, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, arpStatEntries=arpStatEntries, ospfCfg=ospfCfg, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ripCurCfgState=ripCurCfgState, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdCurCfgPortState=ipFwdCurCfgPortState, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, iprouting=iprouting, ipRouteInfoIndx=ipRouteInfoIndx, routerLSALinkIndex=routerLSALinkIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipRouteInfoGateway=ipRouteInfoGateway, arpStatHighWater=arpStatHighWater, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipCurCfgGwTable=ipCurCfgGwTable, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfIndex=ospfIntfIndex, ipForward=ipForward, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumNbrStart=ospfCumNbrStart, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, arpInfoDestIp=arpInfoDestIp, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaTxHello=ospfAreaTxHello, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgGwState=ipNewCfgGwState, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, arpInfoRefPorts=arpInfoRefPorts, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumTxHello=ospfCumTxHello, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfVlinkCountForRouter=ospfVlinkCountForRouter, routerLSALinkID=routerLSALinkID, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIfTotalNeighbours=ospfIfTotalNeighbours, routeStatEntries=routeStatEntries, routeStatMaxEntries=routeStatMaxEntries, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaRxTxStats=ospfAreaRxTxStats, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfTxlsAcks=ospfIntfTxlsAcks, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, arpStatMaxEntries=arpStatMaxEntries, ripCurCfgSupply=ripCurCfgSupply, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaNbrIndex=ospfAreaNbrIndex, ipRouteInfoTag=ipRouteInfoTag, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ripCurCfgVip=ripCurCfgVip, ripNewCfgListen=ripNewCfgListen, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, arpInfoFlag=arpInfoFlag, ospfNbrInExchState=ospfNbrInExchState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, routeStatHighWater=routeStatHighWater, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrp_info=vrrp_info)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ripCurCfgListen=ripCurCfgListen, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaNbrDown=ospfAreaNbrDown, routerLSAId=routerLSAId, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfTxHello=ospfIntfTxHello, routerLSAAreaIndex=routerLSAAreaIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfNbrDown=ospfIntfNbrDown, ripStatInErrorPkts=ripStatInErrorPkts, ospfStartTime=ospfStartTime, ospfAreaIntfLoop=ospfAreaIntfLoop, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaIntfHello=ospfAreaIntfHello, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfProcessUptime=ospfProcessUptime, ospfAreaNbrhello=ospfAreaNbrhello, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgGwState=ipCurCfgGwState, ip_info=ip_info, ospfIntfDown=ospfIntfDown, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, dnsStats=dnsStats, ospfCumRxPkts=ospfCumRxPkts, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, routeStats=routeStats, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaRxPkts=ospfAreaRxPkts, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipInterfaceTableMax=ipInterfaceTableMax, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, arpStats=arpStats, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, routerLSALinkData=routerLSALinkData, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfBackup=ospfIntfBackup, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaInfoTable=ospfAreaInfoTable, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfStats=ospfStats, ipRouteInfoType=ipRouteInfoType, ospfInterface=ospfInterface, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfinfo=ospfinfo, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgIntfEntry=ipCurCfgIntfEntry, arpInfoEntry=arpInfoEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipRouteInfoInterface=ipRouteInfoInterface, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfTxPkts=ospfIntfTxPkts, ripNewCfgSupply=ripNewCfgSupply, ospfArea=ospfArea, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgIntfMask=ipCurCfgIntfMask)
