...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripCurCfgSupply=ripCurCfgSupply, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfNbrStart=ospfIntfNbrStart, ip_info=ip_info, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfBackup=ospfIntfBackup, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, iprouting=iprouting, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCfg=ospfCfg, ipInterfaceTableMax=ipInterfaceTableMax, ospfProcessUptime=ospfProcessUptime, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfNbrInExchState=ospfNbrInExchState, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipRouteInfoType=ipRouteInfoType, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfArea=ospfArea, ospfIntfIndex=ospfIntfIndex, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfHostTableMaxSize=ospfHostTableMaxSize, routerLSAId=routerLSAId, ospfCumTxDatabase=ospfCumTxDatabase, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfNbrIndex=ospfIntfNbrIndex, arpStatMaxEntries=arpStatMaxEntries, routeStatEntries=routeStatEntries, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdCurCfgState=ipFwdCurCfgState, ospfGeneralInfo=ospfGeneralInfo, ospfCumIntfBackup=ospfCumIntfBackup, ipGatewayTableMax=ipGatewayTableMax, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipRouteInfoMask=ipRouteInfoMask, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfUnloop=ospfIntfUnloop, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaTxDatabase=ospfAreaTxDatabase, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaRxPkts=ospfAreaRxPkts, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgGwVlan=ipCurCfgGwVlan, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ripStatInPkts=ripStatInPkts, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaNbrhello=ospfAreaNbrhello, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfTotalNssaAreas=ospfTotalNssaAreas, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIfWaitInterval=ospfIfWaitInterval, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfHello=ospfIntfHello, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipForward=ipForward, ospfIntfDown=ospfIntfDown, ospfAreaNbrN1way=ospfAreaNbrN1way, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ripStats=ripStats, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrp_info=vrrp_info, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipRouteInfoTag=ipRouteInfoTag, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfTimersKickOffStats=ospfTimersKickOffStats, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, dnsStats=dnsStats, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrp=vrrp, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfNbrhello=ospfIntfNbrhello, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, arpStats=arpStats, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgIntfState=ipNewCfgIntfState, ripNewCfgState=ripNewCfgState, ipNewCfgGwIndex=ipNewCfgGwIndex, ipRouteInfoTable=ipRouteInfoTable, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, arpInfoSrcPort=arpInfoSrcPort, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaIntfDown=ospfAreaIntfDown, vrrpStats=vrrpStats, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfStartTime=ospfStartTime, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfChangeStats=ospfIntfChangeStats)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfInterface=ospfInterface, routeStats=routeStats, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ripConfig=ripConfig, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ripStatOutPkts=ripStatOutPkts, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfStats=ospfStats, ospfIntfCountForRouter=ospfIntfCountForRouter, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ripCurCfgListen=ripCurCfgListen, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgGwMetric=ipNewCfgGwMetric, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgBootpState=ipCurCfgBootpState, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfGeneral=ospfGeneral, ospfIntfTxDatabase=ospfIntfTxDatabase, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipRouteInfoGateway=ipRouteInfoGateway, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfTotalNeighbours=ospfTotalNeighbours, vrrpGeneral=vrrpGeneral, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfRxPkts=ospfIntfRxPkts, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaChangeStats=ospfAreaChangeStats, ipNewCfgGwEntry=ipNewCfgGwEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfNbrInInitState=ospfNbrInInitState, ripCurCfgDefListen=ripCurCfgDefListen, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, arpStatHighWater=arpStatHighWater, routerLSALinkData=routerLSALinkData, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaIntfBackup=ospfAreaIntfBackup, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgGwTable=ipCurCfgGwTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpOper=vrrpOper, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumNbrhello=ospfCumNbrhello, ospfCumTxHello=ospfCumTxHello, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ripCurCfgVip=ripCurCfgVip, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfTotalAreas=ospfTotalAreas, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgGwRetry=ipNewCfgGwRetry, arpInfoMacAddr=arpInfoMacAddr, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfinfo=ospfinfo, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ripCurCfgState=ripCurCfgState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfRxHello=ospfIntfRxHello, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, routerLSALinkID=routerLSALinkID, arpStatEntries=arpStatEntries, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType)
