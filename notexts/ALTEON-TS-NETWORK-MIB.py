...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, arpInfoFlag=arpInfoFlag, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, arpInfoMacAddr=arpInfoMacAddr, ipForward=ipForward, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgGwMetric=ipNewCfgGwMetric, ripNewCfgSupply=ripNewCfgSupply, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ripNewCfgState=ripNewCfgState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfTxHello=ospfIntfTxHello, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgGwInterval=ipNewCfgGwInterval, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, routerLSALinkID=routerLSALinkID, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgGwState=ipNewCfgGwState, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfChangeStats=ospfIntfChangeStats, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfProcessUptime=ospfProcessUptime, iprouting=iprouting, ipCurCfgIntfAddr=ipCurCfgIntfAddr, routerLSAId=routerLSAId, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripStatInPkts=ripStatInPkts, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfTxlsAcks=ospfIntfTxlsAcks, arpStats=arpStats, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfRxPkts=ospfIntfRxPkts, routeStatEntries=routeStatEntries, ipNewCfgGwArp=ipNewCfgGwArp, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfNewCfgAreaId=ospfNewCfgAreaId, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfinfo=ospfinfo, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripCurCfgDefListen=ripCurCfgDefListen, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCumRxHello=ospfCumRxHello, ospfAreaIntfHello=ospfAreaIntfHello, ripCurCfgState=ripCurCfgState, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, dnsStats=dnsStats, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrp=vrrp, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumRxPkts=ospfCumRxPkts, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, arpInfoSrcPort=arpInfoSrcPort, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpOper=vrrpOper, vrrp_info=vrrp_info, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ip_info=ip_info, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumIntfHello=ospfCumIntfHello, ripNewCfgVip=ripNewCfgVip, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfDown=ospfIntfDown, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgGwTable=ipCurCfgGwTable, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfRxTxStats=ospfIntfRxTxStats, ipRouteInfoIndx=ipRouteInfoIndx, routeStats=routeStats, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfRxlsAcks=ospfIntfRxlsAcks, routerLSALinkIndex=routerLSALinkIndex, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumNbrDown=ospfCumNbrDown, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ripStatInErrorPkts=ripStatInErrorPkts, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfUnloop=ospfIntfUnloop, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaNbrStart=ospfAreaNbrStart, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfArea=ospfArea, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgGwInterval=ipCurCfgGwInterval, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaNbrDown=ospfAreaNbrDown, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfBackup=ospfIntfBackup, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfStartTime=ospfStartTime, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIfTotalNeighbours=ospfIfTotalNeighbours)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpStats=vrrpStats, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipInterfaceTableMax=ipInterfaceTableMax, ripStatOutPkts=ripStatOutPkts, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgGenState=vrrpCurCfgGenState, ipCurCfgGwEntry=ipCurCfgGwEntry, ipRouteInfoTag=ipRouteInfoTag, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfInterface=ospfInterface, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaRxHello=ospfAreaRxHello, ospfCumIntfBackup=ospfCumIntfBackup, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, ipFwdCurCfgState=ipFwdCurCfgState, routerLSALinkIfIndex=routerLSALinkIfIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, arpInfoEntry=arpInfoEntry, routeStatHighWater=routeStatHighWater, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumTxHello=ospfCumTxHello, ospfStats=ospfStats, vrrpGeneral=vrrpGeneral, ipRouteInfoTable=ipRouteInfoTable, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfGeneralStats=ospfGeneralStats, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgBootpState=ipNewCfgBootpState, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgIntfMask=ipCurCfgIntfMask, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfGeneralInfo=ospfGeneralInfo, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfRangeTableMaxSize=ospfRangeTableMaxSize, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumNbrStart=ospfCumNbrStart, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumNbrhello=ospfCumNbrhello, ripConfig=ripConfig, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ripStats=ripStats, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumTxDatabase=ospfCumTxDatabase, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaRxPkts=ospfAreaRxPkts, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipCurCfgGwState=ipCurCfgGwState, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgGwTable=ipNewCfgGwTable, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfNbrhello=ospfIntfNbrhello, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfTotalAreas=ospfTotalAreas, ospfIntfRxHello=ospfIntfRxHello, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfIndex=ospfIntfIndex, ospfIntfLoop=ospfIntfLoop, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipRouteInfoType=ipRouteInfoType, arpStatHighWater=arpStatHighWater, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCfg=ospfCfg, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ripNewCfgListen=ripNewCfgListen, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaRxTxStats=ospfAreaRxTxStats, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgGwIndex=ipNewCfgGwIndex)
