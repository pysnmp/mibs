...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfNbrChange=ospfIntfNbrChange, vrrp=vrrp, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ripConfig=ripConfig, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgIntfTable=ipCurCfgIntfTable, ipGatewayTableMax=ipGatewayTableMax, vrrpStatInAdvers=vrrpStatInAdvers, ospfTotalAreas=ospfTotalAreas, vrrpStats=vrrpStats, ipFwdCurCfgState=ipFwdCurCfgState, ospfCfg=ospfCfg, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrp_info=vrrp_info, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfRxPkts=ospfIntfRxPkts, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpGeneral=vrrpGeneral, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, routerLSAId=routerLSAId, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfNbrInInitState=ospfNbrInInitState, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpOper=vrrpOper, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ripStatInErrorPkts=ripStatInErrorPkts, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfTotalTransitAreas=ospfTotalTransitAreas, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, arpInfoRefPorts=arpInfoRefPorts, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfNbrN1way=ospfIntfNbrN1way, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfArea=ospfArea, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumTxPkts=ospfCumTxPkts, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaIntfBackup=ospfAreaIntfBackup, arpInfoDestIp=arpInfoDestIp, ospfGeneral=ospfGeneral, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfNbrInExchState=ospfNbrInExchState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, routeStats=routeStats, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfDown=ospfIntfDown, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgGwArp=ipCurCfgGwArp, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipRouteInfoTable=ipRouteInfoTable, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfNbrDown=ospfIntfNbrDown, iprouting=iprouting, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgGwIndex=ipCurCfgGwIndex, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgIntfAddr=ipCurCfgIntfAddr, routerLSALinkID=routerLSALinkID, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipRouteInfoIndx=ipRouteInfoIndx, ipInterfaceTableMax=ipInterfaceTableMax, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfUnloop=ospfIntfUnloop, ospfCumIntfBackup=ospfCumIntfBackup, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaRxPkts=ospfAreaRxPkts, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ripNewCfgVip=ripNewCfgVip, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfLoop=ospfIntfLoop, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIfWaitInterval=ospfIfWaitInterval, arpInfoFlag=arpInfoFlag, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripCurCfgVip=ripCurCfgVip, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaIntfHello=ospfAreaIntfHello, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ip_info=ip_info, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, routeStatHighWater=routeStatHighWater, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, arpInfoTable=arpInfoTable, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfInfoTable=ospfIntfInfoTable, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfHello=ospfIntfHello, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfGeneralInfo=ospfGeneralInfo, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, arpStats=arpStats, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumIntfHello=ospfCumIntfHello, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfinfo=ospfinfo, ipRouteInfoType=ipRouteInfoType, ipRouteInfoMask=ipRouteInfoMask, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipCurCfgGwEntry=ipCurCfgGwEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfStats=ospfStats, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaTxPkts=ospfAreaTxPkts, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumNbrStart=ospfCumNbrStart, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfProcessUptime=ospfProcessUptime, ospfCumRxTxStats=ospfCumRxTxStats, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, routeStatEntries=routeStatEntries, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ripStatInPkts=ripStatInPkts, ospfIntfBackup=ospfIntfBackup, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfGeneralStats=ospfGeneralStats, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfTimersKickOffStats=ospfTimersKickOffStats, ipNewCfgGwVlan=ipNewCfgGwVlan, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, arpStatEntries=arpStatEntries, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ripStats=ripStats, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripNewCfgListen=ripNewCfgListen, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, arpInfoSrcPort=arpInfoSrcPort, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, ipForward=ipForward, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfTxHello=ospfIntfTxHello, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, dnsStats=dnsStats, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, routerLSALinkData=routerLSALinkData, ospfCumIntfDown=ospfCumIntfDown, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, arpInfoEntry=arpInfoEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfRxHello=ospfIntfRxHello, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipRouteInfoTag=ipRouteInfoTag, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaNbrhello=ospfAreaNbrhello, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaNbrStart=ospfAreaNbrStart, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ripCurCfgListen=ripCurCfgListen, ripNewCfgSupply=ripNewCfgSupply, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaChangeStats=ospfAreaChangeStats, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfTotalNeighbours=ospfTotalNeighbours, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfIndex=ospfIntfIndex, ospfCumTxHello=ospfCumTxHello, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpStatOutAdvers=vrrpStatOutAdvers, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgGwState=ipCurCfgGwState, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry)
