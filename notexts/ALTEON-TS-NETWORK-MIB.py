...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCumNbrStart=ospfCumNbrStart, vrrpStatOutAdvers=vrrpStatOutAdvers, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumNbrhello=ospfCumNbrhello, ospfTotalNssaAreas=ospfTotalNssaAreas, ipGatewayTableMax=ipGatewayTableMax, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfNbrDown=ospfIntfNbrDown, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfCountForRouter=ospfIntfCountForRouter, routerLSALinkID=routerLSALinkID, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipRouteInfoGateway=ipRouteInfoGateway, ipRouteInfoEntry=ipRouteInfoEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ripNewCfgDefListen=ripNewCfgDefListen, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgGwArp=ipCurCfgGwArp, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfinfo=ospfinfo, ospfCumTxPkts=ospfCumTxPkts, ripCurCfgListen=ripCurCfgListen, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfNbrInInitState=ospfNbrInInitState, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, routeStats=routeStats, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipNewCfgIntfDelete=ipNewCfgIntfDelete, arpStatMaxEntries=arpStatMaxEntries, ospfCumRxTxStats=ospfCumRxTxStats, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, routeStatHighWater=routeStatHighWater, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ripStatInPkts=ripStatInPkts, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgBootpState=ipCurCfgBootpState, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipRouteInfoMask=ipRouteInfoMask, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, arpStats=arpStats, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, routerLSAAreaIndex=routerLSAAreaIndex, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipNewCfgGwState=ipNewCfgGwState, ospfAreaNbrhello=ospfAreaNbrhello, ipRouteInfoType=ipRouteInfoType, ipNewCfgGwDelete=ipNewCfgGwDelete, ipRouteInfoTable=ipRouteInfoTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfNbrInExchState=ospfNbrInExchState, ospfIntfTxHello=ospfIntfTxHello, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrp=vrrp, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfRxHello=ospfIntfRxHello, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfUnloop=ospfIntfUnloop, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, routeStatMaxEntries=routeStatMaxEntries, ripCurCfgSupply=ripCurCfgSupply, arpInfoTable=arpInfoTable, ospfAreaNbrDown=ospfAreaNbrDown, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfGeneralStats=ospfGeneralStats, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumTxHello=ospfCumTxHello, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgGwArp=ipNewCfgGwArp, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, dnsStats=dnsStats, ospfTotalAreas=ospfTotalAreas, ospfGeneral=ospfGeneral, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ripConfig=ripConfig, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaRxDatabase=ospfAreaRxDatabase, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfBackup=ospfIntfBackup, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, arpStatEntries=arpStatEntries, ospfStartTime=ospfStartTime, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpOper=vrrpOper, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfStats=ospfStats, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgIntfVlan=ipCurCfgIntfVlan, routerLSAId=routerLSAId, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ripNewCfgState=ripNewCfgState, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfArea=ospfArea, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfLoop=ospfIntfLoop, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, arpInfoFlag=arpInfoFlag, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ripNewCfgSupply=ripNewCfgSupply, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ripCurCfgVip=ripCurCfgVip, ipFwdCurCfgState=ipFwdCurCfgState, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, iprouting=iprouting, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfChangeStats=ospfIntfChangeStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgGwTable=ipCurCfgGwTable, arpInfoMacAddr=arpInfoMacAddr, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfNbrChange=ospfIntfNbrChange, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumRxDatabase=ospfCumRxDatabase, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipForward=ipForward, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfProcessUptime=ospfProcessUptime, ipRouteInfoTag=ipRouteInfoTag, ospfTotalTransitAreas=ospfTotalTransitAreas, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCumRxlsAcks=ospfCumRxlsAcks, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgGwState=ipCurCfgGwState, ripStatOutPkts=ripStatOutPkts, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, routerLSALinkIndex=routerLSALinkIndex, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumRxHello=ospfCumRxHello, ripStatInErrorPkts=ripStatInErrorPkts, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, routerLSALinkData=routerLSALinkData, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumIntfDown=ospfCumIntfDown, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ripNewCfgVip=ripNewCfgVip, arpStatHighWater=arpStatHighWater, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCfg=ospfCfg, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripStats=ripStats, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgGwInterval=ipNewCfgGwInterval, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaRxHello=ospfAreaRxHello, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaInfoId=ospfAreaInfoId, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ripCurCfgState=ripCurCfgState, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ip_info=ip_info, arpInfoSrcPort=arpInfoSrcPort, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumTxlsAcks=ospfCumTxlsAcks, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfNbrInFullState=ospfNbrInFullState, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipRouteInfoDestIp=ipRouteInfoDestIp, routeStatEntries=routeStatEntries, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfIndex=ospfIntfIndex, vrrp_info=vrrp_info, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize)
