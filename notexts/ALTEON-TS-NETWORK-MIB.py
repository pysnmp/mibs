...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipRouteInfoType=ipRouteInfoType, ospfCumIntfHello=ospfCumIntfHello, dnsStats=dnsStats, ospfNbrInFullState=ospfNbrInFullState, ospfIntfUnloop=ospfIntfUnloop, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ripNewCfgSupply=ripNewCfgSupply, vrrpGeneral=vrrpGeneral, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfTotalAreas=ospfTotalAreas, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipRouteInfoInterface=ipRouteInfoInterface, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaInfoEntry=ospfAreaInfoEntry, routerLSAId=routerLSAId, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipCurCfgGwMetric=ipCurCfgGwMetric, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIfWaitInterval=ospfIfWaitInterval, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdNewCfgState=ipFwdNewCfgState, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ripConfig=ripConfig, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgGwRetry=ipNewCfgGwRetry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfInfoTable=ospfIntfInfoTable, arpInfoDestIp=arpInfoDestIp, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ripCurCfgState=ripCurCfgState, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, routeStatEntries=routeStatEntries, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumTxHello=ospfCumTxHello, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumNbrStart=ospfCumNbrStart, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfNbrInExchState=ospfNbrInExchState, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaRxHello=ospfAreaRxHello, ipCurCfgGwTable=ipCurCfgGwTable, vrrp_info=vrrp_info, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumRxPkts=ospfCumRxPkts, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpStats=vrrpStats, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfBackup=ospfIntfBackup, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumRxDatabase=ospfCumRxDatabase, arpInfoRefPorts=arpInfoRefPorts, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripNewCfgState=ripNewCfgState, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfNbrInInitState=ospfNbrInInitState, ripStatInErrorPkts=ripStatInErrorPkts, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfNbrDown=ospfIntfNbrDown, ipRouteInfoMask=ipRouteInfoMask, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfGeneral=ospfGeneral, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfGeneralStats=ospfGeneralStats, vrrp=vrrp, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ripStats=ripStats, ripNewCfgVip=ripNewCfgVip, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumRxTxStats=ospfCumRxTxStats, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgGwIndex=ipCurCfgGwIndex, ripStatOutPkts=ripStatOutPkts, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfNbrChange=ospfIntfNbrChange, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, iprouting=iprouting, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgIntfState=ipNewCfgIntfState, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaChangeStats=ospfAreaChangeStats, ripCurCfgSupply=ripCurCfgSupply, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfInterface=ospfInterface, ospfCumNbrDown=ospfCumNbrDown)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgGenState=vrrpCurCfgGenState, arpInfoEntry=arpInfoEntry, arpStats=arpStats, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfRxHello=ospfIntfRxHello, arpInfoVLAN=arpInfoVLAN, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfIndex=ospfIntfIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfNbrIndex=ospfIntfNbrIndex, ripCurCfgVip=ripCurCfgVip, ipRouteInfoEntry=ipRouteInfoEntry, ospfCumRxHello=ospfCumRxHello, arpStatEntries=arpStatEntries, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaInfoTable=ospfAreaInfoTable, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgGwState=ipNewCfgGwState, ospfTotalNeighbours=ospfTotalNeighbours, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumIntfDown=ospfCumIntfDown, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaRxlsAcks=ospfAreaRxlsAcks, arpInfoTable=arpInfoTable, ospfinfo=ospfinfo, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaNbrDown=ospfAreaNbrDown, ospfIfInfoIpAddress=ospfIfInfoIpAddress, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfRxPkts=ospfIntfRxPkts, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaInfoId=ospfAreaInfoId, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumIntfUnloop=ospfCumIntfUnloop, ipCurCfgIntfState=ipCurCfgIntfState, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, routerLSALinkIndex=routerLSALinkIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ip_info=ip_info, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ripNewCfgListen=ripNewCfgListen, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ripStatInPkts=ripStatInPkts, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfWaitTimer=ospfIntfWaitTimer, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipForward=ipForward, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfStartTime=ospfStartTime, vrrpNewCfgGenState=vrrpNewCfgGenState, routeStatMaxEntries=routeStatMaxEntries, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfStats=ospfStats, ospfArea=ospfArea, ripCurCfgListen=ripCurCfgListen, vrrpStatInAdvers=vrrpStatInAdvers, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgBootpState=ipCurCfgBootpState, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripNewCfgDefListen=ripNewCfgDefListen, arpStatMaxEntries=arpStatMaxEntries, ospfIntfNbrStart=ospfIntfNbrStart, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfTmrsKckOffHello=ospfTmrsKckOffHello, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgGwState=ipCurCfgGwState, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaTxHello=ospfAreaTxHello, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumIntfBackup=ospfCumIntfBackup, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumNbrhello=ospfCumNbrhello, arpInfoMacAddr=arpInfoMacAddr, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfTxHello=ospfIntfTxHello, ospfVlinkCountForRouter=ospfVlinkCountForRouter, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, routeStats=routeStats, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, routerLSALinkID=routerLSALinkID, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfHello=ospfIntfHello, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipRouteInfoGateway=ipRouteInfoGateway, routerLSALinkData=routerLSALinkData, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr)
