...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipInterfaceTableMax=ipInterfaceTableMax, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, arpStats=arpStats, vrrpNewCfgGenState=vrrpNewCfgGenState, arpInfoVLAN=arpInfoVLAN, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfBackup=ospfIntfBackup, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfDown=ospfIntfDown, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipFwdNewCfgState=ipFwdNewCfgState, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrp=vrrp, ospfCumNbrhello=ospfCumNbrhello, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumIntfHello=ospfCumIntfHello, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCumTxPkts=ospfCumTxPkts, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumIntfDown=ospfCumIntfDown, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ripCurCfgListen=ripCurCfgListen, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfArea=ospfArea, ipCurCfgGwAddr=ipCurCfgGwAddr, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaTxlsReqs=ospfAreaTxlsReqs, arpInfoEntry=arpInfoEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, routerLSAAreaIndex=routerLSAAreaIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumRxHello=ospfCumRxHello, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ripCurCfgSupply=ripCurCfgSupply, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgGwState=ipCurCfgGwState, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfGeneral=ospfGeneral, ipForward=ipForward, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ripCurCfgVip=ripCurCfgVip, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfInterface=ospfInterface, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipRouteInfoInterface=ipRouteInfoInterface, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfTimersKickOffStats=ospfTimersKickOffStats, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ripCurCfgState=ripCurCfgState, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpOper=vrrpOper, ipNewCfgGwInterval=ipNewCfgGwInterval, iprouting=iprouting, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipRouteInfoType=ipRouteInfoType, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfHello=ospfIntfHello, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ip_info=ip_info, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfTotalNeighbours=ospfTotalNeighbours, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgGwTable=ipNewCfgGwTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfNewCfgAreaId=ospfNewCfgAreaId, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfinfo=ospfinfo, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgGwEntry=ipCurCfgGwEntry, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, arpStatEntries=arpStatEntries, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfProcessUptime=ospfProcessUptime, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfTxHello=ospfIntfTxHello, dnsStats=dnsStats, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ripNewCfgState=ripNewCfgState, ospfStartTime=ospfStartTime, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripStatInPkts=ripStatInPkts, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaRxHello=ospfAreaRxHello, ospfIntfTxPkts=ospfIntfTxPkts, routerLSALinkData=routerLSALinkData, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, routerLSALinkID=routerLSALinkID, ripNewCfgSupply=ripNewCfgSupply, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaTxDatabase=ospfAreaTxDatabase, arpInfoSrcPort=arpInfoSrcPort, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, routeStatEntries=routeStatEntries, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumTxHello=ospfCumTxHello, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfRxHello=ospfIntfRxHello, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumRxDatabase=ospfCumRxDatabase, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ripConfig=ripConfig, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpStatInAdvers=vrrpStatInAdvers, routeStats=routeStats, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCumRxPkts=ospfCumRxPkts, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, arpInfoFlag=arpInfoFlag, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaIntfLoop=ospfAreaIntfLoop, ipRouteInfoTag=ipRouteInfoTag, ripStatOutPkts=ripStatOutPkts, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ripStats=ripStats, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, arpStatMaxEntries=arpStatMaxEntries, ospfNbrInFullState=ospfNbrInFullState, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfLsTypesSupported=ospfLsTypesSupported, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaTxPkts=ospfAreaTxPkts, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfNbrDown=ospfIntfNbrDown, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfStats=ospfStats, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfNbrInExchState=ospfNbrInExchState, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfLoop=ospfIntfLoop, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, routeStatHighWater=routeStatHighWater, ospfAreaInfoId=ospfAreaInfoId, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumNbrN1way=ospfCumNbrN1way, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumNbrStart=ospfCumNbrStart, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgGwArp=ipNewCfgGwArp, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaInfoTable=ospfAreaInfoTable, ipRouteInfoEntry=ipRouteInfoEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgGwVlan=ipCurCfgGwVlan, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfGeneralStats=ospfGeneralStats, ripCurCfgDefListen=ripCurCfgDefListen, routeStatMaxEntries=routeStatMaxEntries, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaRxTxStats=ospfAreaRxTxStats, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipRouteInfoTable=ipRouteInfoTable, ospfCfg=ospfCfg, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgGwInterval=ipCurCfgGwInterval, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, arpInfoTable=arpInfoTable, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrp_info=vrrp_info, ospfCurCfgAreaId=ospfCurCfgAreaId, ipCurCfgIntfTable=ipCurCfgIntfTable, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaRxDatabase=ospfAreaRxDatabase)
