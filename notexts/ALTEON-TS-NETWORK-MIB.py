...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfRxHello=ospfIntfRxHello, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, arpInfoDestIp=arpInfoDestIp, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfChangeStats=ospfIntfChangeStats, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumNbrStart=ospfCumNbrStart, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfStartTime=ospfStartTime, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, arpInfoMacAddr=arpInfoMacAddr, ospfGeneralInfo=ospfGeneralInfo, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, routerLSALinkData=routerLSALinkData, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, arpInfoEntry=arpInfoEntry, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgGwArp=ipCurCfgGwArp, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumTxHello=ospfCumTxHello, routerLSALinkID=routerLSALinkID, ospfIfTotalNeighbours=ospfIfTotalNeighbours, arpInfoRefPorts=arpInfoRefPorts, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumRxHello=ospfCumRxHello, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfHello=ospfIntfHello, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripCurCfgVip=ripCurCfgVip, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ripStatOutPkts=ripStatOutPkts, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfGeneralStats=ospfGeneralStats, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgGwState=ipNewCfgGwState, routeStatHighWater=routeStatHighWater, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgGwState=ipCurCfgGwState, ospfIntfNbrN1way=ospfIntfNbrN1way, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfArea=ospfArea, ospfAreaTxHello=ospfAreaTxHello, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ip_info=ip_info, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfNbrInFullState=ospfNbrInFullState, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfNbrDown=ospfIntfNbrDown, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfTotalAreas=ospfTotalAreas, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaNbrIndex=ospfAreaNbrIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumIntfDown=ospfCumIntfDown, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripConfig=ripConfig, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, arpInfoFlag=arpInfoFlag, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfTotalNeighbours=ospfTotalNeighbours, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCfg=ospfCfg, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpOper=vrrpOper, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumIntfHello=ospfCumIntfHello, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfGeneral=ospfGeneral, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpGeneral=vrrpGeneral, arpStats=arpStats, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, routerLSALinkIndex=routerLSALinkIndex, dnsStats=dnsStats, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfProcessUptime=ospfProcessUptime, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgGenState=vrrpCurCfgGenState, routerLSAId=routerLSAId, ipGatewayTableMax=ipGatewayTableMax, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgGwIndex=ipCurCfgGwIndex, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaInfoTable=ospfAreaInfoTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIfInfoIndex=ospfIfInfoIndex)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgIntfTable=ipCurCfgIntfTable, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumRxDatabase=ospfCumRxDatabase, ipFwdNewCfgState=ipFwdNewCfgState, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaInfoId=ospfAreaInfoId, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgBootpState=ipCurCfgBootpState, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ripCurCfgSupply=ripCurCfgSupply, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ripCurCfgState=ripCurCfgState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfNbrhello=ospfIntfNbrhello, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfInterface=ospfInterface, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipForward=ipForward, ripStatInPkts=ripStatInPkts, ipNewCfgIntfState=ipNewCfgIntfState, arpStatHighWater=arpStatHighWater, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfTotalTransitAreas=ospfTotalTransitAreas, ripNewCfgListen=ripNewCfgListen, ipCurCfgIntfVlan=ipCurCfgIntfVlan, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipRouteInfoGateway=ipRouteInfoGateway, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfBackup=ospfIntfBackup, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, arpInfoVLAN=arpInfoVLAN, ipNewCfgGwEntry=ipNewCfgGwEntry, iprouting=iprouting, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ripNewCfgState=ripNewCfgState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfinfo=ospfinfo, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ripNewCfgSupply=ripNewCfgSupply, vrrp=vrrp, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfLoop=ospfIntfLoop, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, routeStatEntries=routeStatEntries, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfCountForRouter=ospfIntfCountForRouter, ripCurCfgDefListen=ripCurCfgDefListen, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaNbrhello=ospfAreaNbrhello, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipRouteInfoInterface=ipRouteInfoInterface, ospfStats=ospfStats, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfUnloop=ospfIntfUnloop, vrrp_info=vrrp_info, ipCurCfgIntfMask=ipCurCfgIntfMask, ipRouteInfoTag=ipRouteInfoTag, ospfIntfTxHello=ospfIntfTxHello, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumTxPkts=ospfCumTxPkts, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaRxTxStats=ospfAreaRxTxStats, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfDown=ospfIntfDown, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgGwMetric=ipNewCfgGwMetric, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ripStats=ripStats, routeStats=routeStats, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc)
