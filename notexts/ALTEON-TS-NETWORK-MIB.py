...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfNbrInInitState=ospfNbrInInitState, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfNbrhello=ospfIntfNbrhello, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, routerLSAId=routerLSAId, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrp_info=vrrp_info, ospfinfo=ospfinfo, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumIntfBackup=ospfCumIntfBackup, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaRxPkts=ospfAreaRxPkts, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfUnloop=ospfIntfUnloop, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumIntfHello=ospfCumIntfHello, ospfAreaTxDatabase=ospfAreaTxDatabase, routeStats=routeStats, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, arpInfoMacAddr=arpInfoMacAddr, ospfCumNbrRstAd=ospfCumNbrRstAd, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ripCurCfgSupply=ripCurCfgSupply, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ip_info=ip_info, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfStats=ospfStats, ospfIntfRxTxStats=ospfIntfRxTxStats, ripStatOutPkts=ripStatOutPkts, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfLoop=ospfIntfLoop, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgGwVlan=ipCurCfgGwVlan, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfTotalAreas=ospfTotalAreas, ripNewCfgListen=ripNewCfgListen, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgIntfTable=ipNewCfgIntfTable, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ripCurCfgVip=ripCurCfgVip, arpInfoTable=arpInfoTable, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfArea=ospfArea, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfLsTypesSupported=ospfLsTypesSupported, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipRouteInfoType=ipRouteInfoType, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, arpStats=arpStats, ospfAreaInfoEntry=ospfAreaInfoEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfChangeStats=ospfIntfChangeStats, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfHello=ospfIntfHello, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaRxHello=ospfAreaRxHello, iprouting=iprouting, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumTxHello=ospfCumTxHello, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ripNewCfgVip=ripNewCfgVip, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipCurCfgIntfState=ipCurCfgIntfState, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfNbrInFullState=ospfNbrInFullState, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumRxlsReqs=ospfCumRxlsReqs, ipRouteInfoTable=ipRouteInfoTable, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpOper=vrrpOper, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaInfoId=ospfAreaInfoId, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpStatInAdvers=vrrpStatInAdvers, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipRouteInfoDestIp=ipRouteInfoDestIp, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumTxDatabase=ospfCumTxDatabase, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, routeStatHighWater=routeStatHighWater, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIfWaitInterval=ospfIfWaitInterval, arpStatHighWater=arpStatHighWater, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgGwArp=ipCurCfgGwArp, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfNbrInExchState=ospfNbrInExchState, ospfCumRxPkts=ospfCumRxPkts, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipRouteInfoInterface=ipRouteInfoInterface, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgIntfMask=ipNewCfgIntfMask)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumNbrStart=ospfCumNbrStart, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfNbrN1way=ospfIntfNbrN1way, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ripNewCfgDefListen=ripNewCfgDefListen, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaNbrhello=ospfAreaNbrhello, routeStatEntries=routeStatEntries, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgGwState=ipCurCfgGwState, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfGeneralInfo=ospfGeneralInfo, vrrp=vrrp, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ripConfig=ripConfig, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfIndex=ospfIntfIndex, ospfStartTime=ospfStartTime, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, arpInfoEntry=arpInfoEntry, ospfAreaInfoTable=ospfAreaInfoTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripStats=ripStats, ospfIntfBackup=ospfIntfBackup, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCurCfgAreaId=ospfCurCfgAreaId, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfTxDatabase=ospfIntfTxDatabase, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipForward=ipForward, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumTxlsReqs=ospfCumTxlsReqs, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, dnsStats=dnsStats, ospfIntfNbrChange=ospfIntfNbrChange, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, arpInfoDestIp=arpInfoDestIp, ospfIntfTxHello=ospfIntfTxHello, ospfAreaTxHello=ospfAreaTxHello, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfRxHello=ospfIntfRxHello, ripNewCfgState=ripNewCfgState, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpGeneral=vrrpGeneral, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, routerLSALinkIndex=routerLSALinkIndex, ospfAreaIntfDown=ospfAreaIntfDown, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, arpInfoFlag=arpInfoFlag, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgIntfMask=ipCurCfgIntfMask, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfDown=ospfIntfDown, arpStatEntries=arpStatEntries, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfProcessUptime=ospfProcessUptime, ripStatInPkts=ripStatInPkts, ospfGeneralStats=ospfGeneralStats, ospfCumTxlsAcks=ospfCumTxlsAcks, routerLSALinkData=routerLSALinkData, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfRxPkts=ospfIntfRxPkts, ospfCfg=ospfCfg, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipRouteInfoMask=ipRouteInfoMask, ospfAreaNbrStart=ospfAreaNbrStart, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpStats=vrrpStats, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, arpStatMaxEntries=arpStatMaxEntries, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipFwdCurCfgState=ipFwdCurCfgState, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumRxTxStats=ospfCumRxTxStats, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumRxHello=ospfCumRxHello, ospfInterface=ospfInterface, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfTableMaxSize=ospfIntfTableMaxSize)
