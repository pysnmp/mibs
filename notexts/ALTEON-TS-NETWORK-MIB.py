...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgGwAddr=ipCurCfgGwAddr, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumTxDatabase=ospfCumTxDatabase, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumTxHello=ospfCumTxHello, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCfg=ospfCfg, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfRxTxStats=ospfIntfRxTxStats, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipGatewayTableMax=ipGatewayTableMax, routerLSALinkIndex=routerLSALinkIndex, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfDown=ospfIntfDown, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, arpInfoVLAN=arpInfoVLAN, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, arpInfoMacAddr=arpInfoMacAddr, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumRxHello=ospfCumRxHello, ospfGeneral=ospfGeneral, vrrp_info=vrrp_info, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, ripNewCfgState=ripNewCfgState, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripCurCfgListen=ripCurCfgListen, ospfIntfUnloop=ospfIntfUnloop, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumIntfDown=ospfCumIntfDown, ospfNbrInInitState=ospfNbrInInitState, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfBackup=ospfIntfBackup, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumRxTxStats=ospfCumRxTxStats, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ripNewCfgDefListen=ripNewCfgDefListen, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, routerLSAId=routerLSAId, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfNbrInExchState=ospfNbrInExchState, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrp=vrrp, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfGeneralInfo=ospfGeneralInfo, arpInfoEntry=arpInfoEntry, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaIntfDown=ospfAreaIntfDown, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ripStats=ripStats, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaInfoId=ospfAreaInfoId, ospfAreaTxlsReqs=ospfAreaTxlsReqs, routeStatMaxEntries=routeStatMaxEntries, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaTxHello=ospfAreaTxHello, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, routeStatEntries=routeStatEntries, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ripStatInPkts=ripStatInPkts, ospfAreaRxPkts=ospfAreaRxPkts, ipRouteInfoType=ipRouteInfoType, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfStartTime=ospfStartTime, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpGeneral=vrrpGeneral, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfTotalNssaAreas=ospfTotalNssaAreas, arpInfoSrcPort=arpInfoSrcPort, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, arpStats=arpStats, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIfTotalNeighbours=ospfIfTotalNeighbours, iprouting=iprouting, routerLSALinkID=routerLSALinkID, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfHello=ospfIntfHello, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgGwTable=ipCurCfgGwTable, ospfIfInfoIndex=ospfIfInfoIndex, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumNbrhello=ospfCumNbrhello, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, arpStatMaxEntries=arpStatMaxEntries, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfInterface=ospfInterface, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfTotalAreas=ospfTotalAreas, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgGenState=vrrpNewCfgGenState, routerLSALinkData=routerLSALinkData, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfIndex=ospfIntfIndex, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaRxHello=ospfAreaRxHello, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpOper=vrrpOper, arpStatHighWater=arpStatHighWater, ipRouteInfoDestIp=ipRouteInfoDestIp, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaIntfHello=ospfAreaIntfHello, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfLoop=ospfIntfLoop, ospfinfo=ospfinfo, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, arpInfoTable=arpInfoTable, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfVlinkCountForRouter=ospfVlinkCountForRouter, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ripConfig=ripConfig, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfStats=ospfStats, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ripCurCfgDefListen=ripCurCfgDefListen, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfGeneralStats=ospfGeneralStats, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpStats=vrrpStats, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ripCurCfgState=ripCurCfgState, ospfCumTxlsUpdates=ospfCumTxlsUpdates, routeStatHighWater=routeStatHighWater, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripStatInErrorPkts=ripStatInErrorPkts, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgGwState=ipCurCfgGwState, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, dnsStats=dnsStats, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfTimersKickOffStats=ospfTimersKickOffStats, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ip_info=ip_info, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgGwState=ipNewCfgGwState, arpInfoDestIp=arpInfoDestIp, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipRouteInfoEntry=ipRouteInfoEntry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCurCfgAreaId=ospfCurCfgAreaId, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfRxHello=ospfIntfRxHello, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumRxlsAcks=ospfCumRxlsAcks, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ripNewCfgListen=ripNewCfgListen, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipForward=ipForward, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, routeStats=routeStats, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumNbrDown=ospfCumNbrDown, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfArea=ospfArea, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex)
