...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaNbrDown=ospfAreaNbrDown, ipRouteInfoGateway=ipRouteInfoGateway, ospfTotalNeighbours=ospfTotalNeighbours, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumTxDatabase=ospfCumTxDatabase, ipRouteInfoTable=ipRouteInfoTable, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, arpInfoVLAN=arpInfoVLAN, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpStats=vrrpStats, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripConfig=ripConfig, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfTxPkts=ospfIntfTxPkts, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfArea=ospfArea, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ip_info=ip_info, ospfTimersKickOffStats=ospfTimersKickOffStats, ipGatewayTableMax=ipGatewayTableMax, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ripStatOutPkts=ripStatOutPkts, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaRxHello=ospfAreaRxHello, ospfIntfRxPkts=ospfIntfRxPkts, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfNewCfgAreaId=ospfNewCfgAreaId, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ripNewCfgSupply=ripNewCfgSupply, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, routeStats=routeStats, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfHello=ospfIntfHello, ospfCumNbrhello=ospfCumNbrhello, arpInfoEntry=arpInfoEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipCurCfgGwState=ipCurCfgGwState, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfInterface=ospfInterface, routerLSALinkID=routerLSALinkID, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfTxHello=ospfIntfTxHello, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfLoop=ospfIntfLoop, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfStats=ospfStats, routeStatMaxEntries=routeStatMaxEntries, ipRouteInfoMask=ipRouteInfoMask, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaIntfHello=ospfAreaIntfHello, ripCurCfgListen=ripCurCfgListen, ospfAreaIntfDown=ospfAreaIntfDown, routeStatEntries=routeStatEntries, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfNbrRstAd=ospfIntfNbrRstAd, routerLSAId=routerLSAId, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfStartTime=ospfStartTime, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrStart=ospfAreaNbrStart, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripNewCfgState=ripNewCfgState, arpInfoSrcPort=arpInfoSrcPort, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, arpInfoTable=arpInfoTable, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfCurCfgAreaId=ospfCurCfgAreaId, ripCurCfgVip=ripCurCfgVip, ipRouteInfoTag=ipRouteInfoTag, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfDown=ospfIntfDown, ospfCumRxHello=ospfCumRxHello, ospfCumIntfDown=ospfCumIntfDown, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfInfoTable=ospfIntfInfoTable, ripNewCfgListen=ripNewCfgListen, dnsStats=dnsStats, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIfInfoIndex=ospfIfInfoIndex, vrrpGeneral=vrrpGeneral, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, routerLSALinkData=routerLSALinkData, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumRxTxStats=ospfCumRxTxStats, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfUnloop=ospfIntfUnloop, ipRouteInfoType=ipRouteInfoType, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumNbrStart=ospfCumNbrStart, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfNbrStart=ospfIntfNbrStart, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaRxlsReqs=ospfAreaRxlsReqs, routerLSALinkIfIndex=routerLSALinkIfIndex, arpStatHighWater=arpStatHighWater, ipNewCfgGwState=ipNewCfgGwState, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCfg=ospfCfg, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgBootpState=ipCurCfgBootpState, iprouting=iprouting, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipCurCfgGwTable=ipCurCfgGwTable, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfWaitTimer=ospfIntfWaitTimer, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaRxPkts=ospfAreaRxPkts, ipFwdNewCfgState=ipFwdNewCfgState, arpStatEntries=arpStatEntries, ipCurCfgGwAddr=ipCurCfgGwAddr)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumRxPkts=ospfCumRxPkts, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfHostTableMaxSize=ospfHostTableMaxSize, arpStats=arpStats, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfCountForRouter=ospfIntfCountForRouter, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripCurCfgState=ripCurCfgState, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, arpInfoRefPorts=arpInfoRefPorts, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCumNbrRstAd=ospfCumNbrRstAd, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumNbrN1way=ospfCumNbrN1way, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumNbrDown=ospfCumNbrDown, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipRouteInfoDestIp=ipRouteInfoDestIp, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ripNewCfgVip=ripNewCfgVip, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipForward=ipForward, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfProcessUptime=ospfProcessUptime, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfIndex=ospfIntfIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumTxHello=ospfCumTxHello, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, routeStatHighWater=routeStatHighWater, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgGwArp=ipNewCfgGwArp, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ripStatInErrorPkts=ripStatInErrorPkts, vrrpStatInAdvers=vrrpStatInAdvers, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgGwRetry=ipNewCfgGwRetry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfinfo=ospfinfo, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaTxHello=ospfAreaTxHello, ripStatInPkts=ripStatInPkts, ospfIntfBackup=ospfIntfBackup, ospfCumIntfBackup=ospfCumIntfBackup, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumIntfHello=ospfCumIntfHello, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfNbrInExchState=ospfNbrInExchState, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaChangeStats=ospfAreaChangeStats, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgGwArp=ipCurCfgGwArp, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumTxPkts=ospfCumTxPkts, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ripStats=ripStats, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrp=vrrp, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaTxDatabase=ospfAreaTxDatabase, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry)
