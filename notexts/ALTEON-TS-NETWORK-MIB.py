...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", routeStatHighWater=routeStatHighWater, ospfCumRxlsAcks=ospfCumRxlsAcks, ipRouteInfoDestIp=ipRouteInfoDestIp, ipCurCfgGwMetric=ipCurCfgGwMetric, iprouting=iprouting, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ripStatInErrorPkts=ripStatInErrorPkts, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfHello=ospfIntfHello, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIfInfoIndex=ospfIfInfoIndex, ospfGeneralInfo=ospfGeneralInfo, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgGwArp=ipNewCfgGwArp, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpStatInAdvers=vrrpStatInAdvers, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpStats=vrrpStats, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumIntfDown=ospfCumIntfDown, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfLsTypesSupported=ospfLsTypesSupported, ripConfig=ripConfig, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipRouteInfoMask=ipRouteInfoMask, ospfCumRxPkts=ospfCumRxPkts, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgGwState=ipNewCfgGwState, ospfTotalNssaAreas=ospfTotalNssaAreas, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, routeStatMaxEntries=routeStatMaxEntries, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipForward=ipForward, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgIntfEntry=ipNewCfgIntfEntry, routerLSALinkIndex=routerLSALinkIndex, vrrp_info=vrrp_info, ipNewCfgGwInterval=ipNewCfgGwInterval, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumIntfHello=ospfCumIntfHello, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, arpInfoSrcPort=arpInfoSrcPort, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpGeneral=vrrpGeneral, arpStats=arpStats, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgIfTable=vrrpNewCfgIfTable, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfProcessUptime=ospfProcessUptime, arpInfoEntry=arpInfoEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIfWaitInterval=ospfIfWaitInterval, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfUnloop=ospfIntfUnloop, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipRouteInfoTable=ipRouteInfoTable, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfGeneral=ospfGeneral, ospfAreaNbrDown=ospfAreaNbrDown, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ripCurCfgVip=ripCurCfgVip, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfNbrStart=ospfIntfNbrStart, routerLSALinkID=routerLSALinkID, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipRouteInfoTag=ipRouteInfoTag, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaInfoId=ospfAreaInfoId, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgGwEntry=ipNewCfgGwEntry, routeStats=routeStats, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfTmrsKckOffHello=ospfTmrsKckOffHello, dnsStats=dnsStats, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipRouteInfoType=ipRouteInfoType, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfDown=ospfIntfDown, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, arpInfoRefPorts=arpInfoRefPorts, ospfIntfRxDatabase=ospfIntfRxDatabase, arpInfoDestIp=arpInfoDestIp, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfStartTime=ospfStartTime, ripNewCfgSupply=ripNewCfgSupply, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipRouteInfoEntry=ipRouteInfoEntry, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfInfoTable=ospfIntfInfoTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ripStatOutPkts=ripStatOutPkts, ipRouteInfoInterface=ipRouteInfoInterface)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfIndex=ospfIntfIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipRouteInfoGateway=ipRouteInfoGateway, ospfArea=ospfArea, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipNewCfgGwAddr=ipNewCfgGwAddr, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgGwTable=ipCurCfgGwTable, routeStatEntries=routeStatEntries, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfNbrInExchState=ospfNbrInExchState, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaChangeStats=ospfAreaChangeStats, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripStats=ripStats, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumTxHello=ospfCumTxHello, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipGatewayTableMax=ipGatewayTableMax, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaNbrhello=ospfAreaNbrhello, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, arpStatHighWater=arpStatHighWater, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfNbrInFullState=ospfNbrInFullState, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumIntfLoop=ospfCumIntfLoop, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgIntfTable=ipNewCfgIntfTable, ripCurCfgDefListen=ripCurCfgDefListen, ripNewCfgState=ripNewCfgState, vrrpOper=vrrpOper, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, routerLSALinkData=routerLSALinkData, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfinfo=ospfinfo, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ripStatInPkts=ripStatInPkts, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ip_info=ip_info, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgGwArp=ipCurCfgGwArp, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrp=vrrp, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, arpStatEntries=arpStatEntries, ipNewCfgIntfState=ipNewCfgIntfState, arpInfoVLAN=arpInfoVLAN, ripNewCfgListen=ripNewCfgListen, ospfIntfTxPkts=ospfIntfTxPkts, ripCurCfgState=ripCurCfgState, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, arpStatMaxEntries=arpStatMaxEntries, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumNbrDown=ospfCumNbrDown, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfChangeStats=ospfIntfChangeStats, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfStats=ospfStats, ospfInterface=ospfInterface, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCfg=ospfCfg, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaIntfHello=ospfAreaIntfHello, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfNbrhello=ospfIntfNbrhello, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfTotalNeighbours=ospfTotalNeighbours, routerLSAId=routerLSAId, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgGwState=ipCurCfgGwState, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, routerLSAAreaIndex=routerLSAAreaIndex)
