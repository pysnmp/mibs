...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfArea=ospfArea, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgGwTable=ipCurCfgGwTable, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ripCurCfgState=ripCurCfgState, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipRouteInfoType=ipRouteInfoType, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaTxHello=ospfAreaTxHello, ospfAreaInfoId=ospfAreaInfoId, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, routerLSAId=routerLSAId, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfDown=ospfIntfDown, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfLoop=ospfIntfLoop, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfNbrDown=ospfIntfNbrDown, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdCurCfgState=ipFwdCurCfgState, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCfg=ospfCfg, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ripConfig=ripConfig, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripCurCfgDefListen=ripCurCfgDefListen, routeStats=routeStats, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumTxHello=ospfCumTxHello, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ip_info=ip_info, ripNewCfgVip=ripNewCfgVip, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfLsTypesSupported=ospfLsTypesSupported, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, dnsStats=dnsStats, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipCurCfgIntfIndex=ipCurCfgIntfIndex, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfTxHello=ospfIntfTxHello, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfHostTableMaxSize=ospfHostTableMaxSize, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaRxDatabase=ospfAreaRxDatabase, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrp_info=vrrp_info, ospfCumNbrStart=ospfCumNbrStart, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumRxHello=ospfCumRxHello, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, arpInfoMacAddr=arpInfoMacAddr, ospfGeneral=ospfGeneral, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfTotalNeighbours=ospfTotalNeighbours, arpInfoFlag=arpInfoFlag, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfProcessUptime=ospfProcessUptime, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, routeStatMaxEntries=routeStatMaxEntries, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, iprouting=iprouting, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfinfo=ospfinfo, ospfAreaInfoIndex=ospfAreaInfoIndex, ripCurCfgVip=ripCurCfgVip, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripNewCfgState=ripNewCfgState, ospfAreaNbrStart=ospfAreaNbrStart, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumRxlsAcks=ospfCumRxlsAcks, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumIntfDown=ospfCumIntfDown, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgGwMetric=ipCurCfgGwMetric, ipForward=ipForward, ipNewCfgGwState=ipNewCfgGwState, ospfCumRxTxStats=ospfCumRxTxStats, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfNewCfgAreaId=ospfNewCfgAreaId, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumNbrRstAd=ospfCumNbrRstAd, ipRouteInfoInterface=ipRouteInfoInterface, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfHello=ospfIntfHello, ipNewCfgGwInterval=ipNewCfgGwInterval)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, routerLSAAreaIndex=routerLSAAreaIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumTxPkts=ospfCumTxPkts, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaRxHello=ospfAreaRxHello, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfIndex=ospfIntfIndex, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfTotalAreas=ospfTotalAreas, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgGwArp=ipNewCfgGwArp, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, arpInfoSrcPort=arpInfoSrcPort, ospfStats=ospfStats, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfNbrInInitState=ospfNbrInInitState, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpGeneral=vrrpGeneral, routerLSALinkID=routerLSALinkID, arpInfoRefPorts=arpInfoRefPorts, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, arpInfoDestIp=arpInfoDestIp, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaRxPkts=ospfAreaRxPkts, ripStatInPkts=ripStatInPkts, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfNbrStart=ospfIntfNbrStart, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, routerLSALinkIndex=routerLSALinkIndex, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumTxDatabase=ospfCumTxDatabase, ipInterfaceTableMax=ipInterfaceTableMax, vrrpOper=vrrpOper, ospfGeneralInfo=ospfGeneralInfo, ripStatOutPkts=ripStatOutPkts, ospfCumIntfBackup=ospfCumIntfBackup, ripStats=ripStats, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfStartTime=ospfStartTime, ipCurCfgGwInterval=ipCurCfgGwInterval, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipCurCfgGwState=ipCurCfgGwState, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpStats=vrrpStats, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ripNewCfgSupply=ripNewCfgSupply, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ripStatRoutesAgedOut=ripStatRoutesAgedOut, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, arpStatMaxEntries=arpStatMaxEntries, arpStats=arpStats, arpInfoTable=arpInfoTable, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ripNewCfgDefListen=ripNewCfgDefListen, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrp=vrrp, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, arpStatEntries=arpStatEntries, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfGeneralStats=ospfGeneralStats, ipCurCfgGwIndex=ipCurCfgGwIndex, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgBootpAddr=ipNewCfgBootpAddr, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaTxPkts=ospfAreaTxPkts, ospfInterface=ospfInterface, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc)
