...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfHello=ospfIntfHello, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgIntfState=ipCurCfgIntfState, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgGwArp=ipNewCfgGwArp, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfNbrChange=ospfIntfNbrChange, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpOper=vrrpOper, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumRxHello=ospfCumRxHello, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfLoop=ospfIntfLoop, ospfAreaInfoEntry=ospfAreaInfoEntry, arpInfoRefPorts=arpInfoRefPorts, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumIntfLoop=ospfCumIntfLoop, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipGatewayTableMax=ipGatewayTableMax, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfStartTime=ospfStartTime, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipRouteInfoMask=ipRouteInfoMask, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipFwdNewCfgState=ipFwdNewCfgState, routerLSALinkID=routerLSALinkID, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaIntfHello=ospfAreaIntfHello, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgIntfState=ipNewCfgIntfState, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumRxPkts=ospfCumRxPkts, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgBootpState=ipNewCfgBootpState, routeStatEntries=routeStatEntries, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfUnloop=ospfIntfUnloop, ospfCumNbrDown=ospfCumNbrDown, ospfIntfTxPkts=ospfIntfTxPkts, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgIfTable=vrrpCurCfgIfTable, dnsStats=dnsStats, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfNbrInFullState=ospfNbrInFullState, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaNbrStart=ospfAreaNbrStart, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfStats=ospfStats, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, routeStatHighWater=routeStatHighWater, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumNbrhello=ospfCumNbrhello, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, routerLSALinkData=routerLSALinkData, ospfIntfIndex=ospfIntfIndex, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipForward=ipForward, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumNbrBadSequence=ospfCumNbrBadSequence, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ripNewCfgState=ripNewCfgState, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgGwIndex=ipCurCfgGwIndex, ripStatOutPkts=ripStatOutPkts, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumTxPkts=ospfCumTxPkts, vrrp_info=vrrp_info, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumNbrStart=ospfCumNbrStart, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfCountForRouter=ospfIntfCountForRouter, ripStatInPkts=ripStatInPkts, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipCurCfgGwState=ipCurCfgGwState, ospfInterface=ospfInterface, ipRouteInfoGateway=ipRouteInfoGateway, ipRouteInfoTag=ipRouteInfoTag, routeStatMaxEntries=routeStatMaxEntries, ospfIntfWaitTimer=ospfIntfWaitTimer, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripStats=ripStats, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfinfo=ospfinfo, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCurCfgAreaTable=ospfCurCfgAreaTable, arpStats=arpStats, arpInfoEntry=arpInfoEntry, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfDown=ospfIntfDown)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaNbrN1way=ospfAreaNbrN1way, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfRxHello=ospfIntfRxHello, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumIntfHello=ospfCumIntfHello, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumNbrRstAd=ospfCumNbrRstAd, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ripConfig=ripConfig, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfTotalAreas=ospfTotalAreas, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfInfoTable=ospfIntfInfoTable, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaRxPkts=ospfAreaRxPkts, iprouting=iprouting, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripCurCfgVip=ripCurCfgVip, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripNewCfgDefListen=ripNewCfgDefListen, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfTxHello=ospfIntfTxHello, vrrpGeneral=vrrpGeneral, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, arpStatEntries=arpStatEntries, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfNbrInInitState=ospfNbrInInitState, ospfProcessUptime=ospfProcessUptime, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaTxHello=ospfAreaTxHello, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipRouteInfoInterface=ipRouteInfoInterface, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ripCurCfgListen=ripCurCfgListen, ospfAreaNbrIndex=ospfAreaNbrIndex, arpInfoMacAddr=arpInfoMacAddr, routerLSAId=routerLSAId, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumIntfBackup=ospfCumIntfBackup, ospfLsTypesSupported=ospfLsTypesSupported, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfNbrhello=ospfIntfNbrhello, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaInfoId=ospfAreaInfoId, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, arpInfoTable=arpInfoTable, ip_info=ip_info, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCfg=ospfCfg, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipRouteInfoType=ipRouteInfoType, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpStats=vrrpStats, ripNewCfgVip=ripNewCfgVip, ospfGeneral=ospfGeneral, ospfIfInfoIndex=ospfIfInfoIndex, ospfGeneralInfo=ospfGeneralInfo, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, arpInfoFlag=arpInfoFlag, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, routerLSALinkIndex=routerLSALinkIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumTxHello=ospfCumTxHello, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumRxDatabase=ospfCumRxDatabase, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, arpInfoVLAN=arpInfoVLAN, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipFwdCurCfgState=ipFwdCurCfgState, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, routeStats=routeStats, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrp=vrrp, ipRouteInfoTable=ipRouteInfoTable, ospfArea=ospfArea, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfNbrN1way=ospfIntfNbrN1way, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaTxDatabase=ospfAreaTxDatabase, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ripCurCfgState=ripCurCfgState)
