...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgGwMetric=ipNewCfgGwMetric, routerLSALinkID=routerLSALinkID, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaChangeStats=ospfAreaChangeStats, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ripCurCfgListen=ripCurCfgListen, ospfIntfInfoTable=ospfIntfInfoTable, ripCurCfgVip=ripCurCfgVip, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIfInfoIndex=ospfIfInfoIndex, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfHello=ospfIntfHello, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrp_info=vrrp_info, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumTxDatabase=ospfCumTxDatabase, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfDown=ospfIntfDown, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipRouteInfoGateway=ipRouteInfoGateway, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ripNewCfgListen=ripNewCfgListen, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIfInfoIpAddress=ospfIfInfoIpAddress, routerLSALinkData=routerLSALinkData, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumIntfHello=ospfCumIntfHello, ospfNbrInInitState=ospfNbrInInitState, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumNbrDown=ospfCumNbrDown, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaIntfDown=ospfAreaIntfDown, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfBackup=ospfIntfBackup, routeStatEntries=routeStatEntries, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumNbrhello=ospfCumNbrhello, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfTotalAreas=ospfTotalAreas, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaNbrIndex=ospfAreaNbrIndex, arpInfoTable=arpInfoTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgIntfState=ipNewCfgIntfState, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfProcessUptime=ospfProcessUptime, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCurCfgAreaId=ospfCurCfgAreaId, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfInterface=ospfInterface, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfGeneral=ospfGeneral, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, arpInfoDestIp=arpInfoDestIp, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, routeStatMaxEntries=routeStatMaxEntries, ospfCumNbrN1way=ospfCumNbrN1way, iprouting=iprouting, ipNewCfgIntfEntry=ipNewCfgIntfEntry, arpStatMaxEntries=arpStatMaxEntries, ospfCumRxPkts=ospfCumRxPkts, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIfWaitInterval=ospfIfWaitInterval, vrrpGeneral=vrrpGeneral, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripStats=ripStats, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCfg=ospfCfg, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, arpStats=arpStats, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfRxPkts=ospfIntfRxPkts, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfNbrInExchState=ospfNbrInExchState, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfRxHello=ospfIntfRxHello, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfUnloop=ospfIntfUnloop, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ripConfig=ripConfig, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, routerLSAAreaIndex=routerLSAAreaIndex, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumRxHello=ospfCumRxHello, routeStatHighWater=routeStatHighWater, ripNewCfgSupply=ripNewCfgSupply, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfTotalNssaAreas=ospfTotalNssaAreas, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, arpStatEntries=arpStatEntries, ipRouteInfoEntry=ipRouteInfoEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgGwState=ipCurCfgGwState, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfArea=ospfArea, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgIntfState=ipCurCfgIntfState)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipRouteInfoType=ipRouteInfoType, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfLsTypesSupported=ospfLsTypesSupported, arpInfoEntry=arpInfoEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ripCurCfgState=ripCurCfgState, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfinfo=ospfinfo, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgGwArp=ipNewCfgGwArp, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpOper=vrrpOper, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, arpInfoFlag=arpInfoFlag, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfRxDatabase=ospfIntfRxDatabase, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaTxHello=ospfAreaTxHello, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaNbrN1way=ospfAreaNbrN1way, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfGeneralStats=ospfGeneralStats, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgGenState=vrrpNewCfgGenState, ipCurCfgGwInterval=ipCurCfgGwInterval, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpStatInAdvers=vrrpStatInAdvers, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfStats=ospfStats, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaRxlsAcks=ospfAreaRxlsAcks, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, arpInfoVLAN=arpInfoVLAN, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfTxHello=ospfIntfTxHello, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipRouteInfoIndx=ipRouteInfoIndx, dnsStats=dnsStats, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgBootpState=ipCurCfgBootpState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaRxHello=ospfAreaRxHello, ripCurCfgDefListen=ripCurCfgDefListen, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpStats=vrrpStats, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipForward=ipForward, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipGatewayTableMax=ipGatewayTableMax, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, routeStats=routeStats, ospfIntfNbrChange=ospfIntfNbrChange, ripStatOutPkts=ripStatOutPkts, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumNbrStart=ospfCumNbrStart, ripNewCfgDefListen=ripNewCfgDefListen, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgGwArp=ipCurCfgGwArp, ip_info=ip_info, ipRouteInfoTag=ipRouteInfoTag, ospfAreaNbrDown=ospfAreaNbrDown, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipRouteInfoMask=ipRouteInfoMask, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrp=vrrp, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumTxPkts=ospfCumTxPkts, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaInfoId=ospfAreaInfoId, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaNbrStart=ospfAreaNbrStart, ripNewCfgState=ripNewCfgState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumIntfDown=ospfCumIntfDown)
