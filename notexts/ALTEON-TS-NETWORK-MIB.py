...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripCurCfgListen=ripCurCfgListen, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ripCurCfgVip=ripCurCfgVip, ripNewCfgVip=ripNewCfgVip, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfGeneral=ospfGeneral, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrp=vrrp, ospfCumRxPkts=ospfCumRxPkts, routeStatMaxEntries=routeStatMaxEntries, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCurCfgAreaTable=ospfCurCfgAreaTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, routeStats=routeStats, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumNbrStart=ospfCumNbrStart, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpOper=vrrpOper, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ripCurCfgSupply=ripCurCfgSupply, ospfCumIntfBackup=ospfCumIntfBackup, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfBackup=ospfIntfBackup, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, arpInfoDestIp=arpInfoDestIp, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipRouteInfoTable=ipRouteInfoTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumNbrN1way=ospfCumNbrN1way, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripCurCfgState=ripCurCfgState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgGwState=ipNewCfgGwState, routeStatHighWater=routeStatHighWater, ospfAreaIntfHello=ospfAreaIntfHello, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaIntfIndex=ospfAreaIntfIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaRxDatabase=ospfAreaRxDatabase, ip_info=ip_info, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ripCurCfgDefListen=ripCurCfgDefListen, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpGeneral=vrrpGeneral, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfTxHello=ospfIntfTxHello, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfNbrhello=ospfIntfNbrhello, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfDown=ospfIntfDown, ospfCumIntfDown=ospfCumIntfDown, ospfInterface=ospfInterface, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfNbrInExchState=ospfNbrInExchState, ipForward=ipForward, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaIntfBackup=ospfAreaIntfBackup, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfLsTypesSupported=ospfLsTypesSupported, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfLoop=ospfIntfLoop, ripStatInPkts=ripStatInPkts, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaInfoEntry=ospfAreaInfoEntry, ipGatewayTableMax=ipGatewayTableMax, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfNbrInFullState=ospfNbrInFullState, arpInfoVLAN=arpInfoVLAN, ospfCumIntfLoop=ospfCumIntfLoop, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipRouteInfoTag=ipRouteInfoTag, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpStats=vrrpStats, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaNbrDown=ospfAreaNbrDown, ospfIfInfoIndex=ospfIfInfoIndex, dnsStats=dnsStats, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, arpInfoEntry=arpInfoEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipRouteInfoEntry=ipRouteInfoEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfTxPkts=ospfIntfTxPkts, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipNewCfgIntfMask=ipNewCfgIntfMask, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, ipCurCfgGwState=ipCurCfgGwState, ospfIntfNbrChange=ospfIntfNbrChange, vrrpStatInAdvers=vrrpStatInAdvers, ipFwdCurCfgPortState=ipFwdCurCfgPortState, arpInfoSrcPort=arpInfoSrcPort, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, arpInfoFlag=arpInfoFlag, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumTxlsAcks=ospfCumTxlsAcks, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgIntfEntry=ipCurCfgIntfEntry, routerLSALinkData=routerLSALinkData, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipNewCfgIntfDelete=ipNewCfgIntfDelete, arpStats=arpStats, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrp_info=vrrp_info, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, routeStatEntries=routeStatEntries, ospfIntfNbrDown=ospfIntfNbrDown, ospfArea=ospfArea, ospfCfg=ospfCfg, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, arpStatHighWater=arpStatHighWater, routerLSAId=routerLSAId, ospfTotalAreas=ospfTotalAreas, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfRxHello=ospfIntfRxHello, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipRouteInfoGateway=ipRouteInfoGateway, ospfGeneralStats=ospfGeneralStats, ospfIntfNbrN1way=ospfIntfNbrN1way, ripStats=ripStats, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, arpStatMaxEntries=arpStatMaxEntries, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, iprouting=iprouting, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripConfig=ripConfig, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipRouteInfoType=ipRouteInfoType, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, routerLSALinkID=routerLSALinkID, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfProcessUptime=ospfProcessUptime, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfRxPkts=ospfIntfRxPkts, ipRouteInfoMask=ipRouteInfoMask, ripStatOutPkts=ripStatOutPkts, ospfCumIntfHello=ospfCumIntfHello, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, arpInfoTable=arpInfoTable, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgIntfIndex=ipNewCfgIntfIndex, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfStats=ospfStats, ospfCumRxHello=ospfCumRxHello, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfGeneralInfo=ospfGeneralInfo, ospfCumTxHello=ospfCumTxHello, ospfIntfUnloop=ospfIntfUnloop, ospfNbrInInitState=ospfNbrInInitState, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfIndex=ospfIntfIndex, ospfCumTxPkts=ospfCumTxPkts, arpStatEntries=arpStatEntries, ospfinfo=ospfinfo, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, arpInfoMacAddr=arpInfoMacAddr)
