...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgGwRetry=ipCurCfgGwRetry, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, ipRouteInfoMask=ipRouteInfoMask, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, arpInfoVLAN=arpInfoVLAN, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfNbrDown=ospfIntfNbrDown, iprouting=iprouting, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpStatOutAdvers=vrrpStatOutAdvers, ripStatInPkts=ripStatInPkts, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipNewCfgGwState=ipNewCfgGwState, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfStartTime=ospfStartTime, routerLSALinkIndex=routerLSALinkIndex, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfInfoEntry=ospfIntfInfoEntry, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaTxHello=ospfAreaTxHello, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIfTotalNeighbours=ospfIfTotalNeighbours, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumRxHello=ospfCumRxHello, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ripNewCfgStaticSupply=ripNewCfgStaticSupply, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, arpInfoRefPorts=arpInfoRefPorts, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumNbrStart=ospfCumNbrStart, routerLSALinkID=routerLSALinkID, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfUnloop=ospfIntfUnloop, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipInterfaceTableMax=ipInterfaceTableMax, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipRouteInfoTable=ipRouteInfoTable, ipForward=ipForward, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpGeneral=vrrpGeneral, vrrp=vrrp, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfDown=ospfIntfDown, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfNbrChange=ospfIntfNbrChange, arpInfoFlag=arpInfoFlag, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfGeneral=ospfGeneral, ipFwdNewCfgState=ipFwdNewCfgState, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfHello=ospfIntfHello, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, arpStats=arpStats, ospfCumTxlsReqs=ospfCumTxlsReqs, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfBackup=ospfIntfBackup, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfLoop=ospfIntfLoop, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipCurCfgGwState=ipCurCfgGwState, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ripNewCfgVip=ripNewCfgVip, routerLSALinkData=routerLSALinkData, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfTotalTransitAreas=ospfTotalTransitAreas, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgGwArp=ipNewCfgGwArp, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfArea=ospfArea, ospfAreaRxTxStats=ospfAreaRxTxStats, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ripStats=ripStats, ripNewCfgSupply=ripNewCfgSupply, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaRxHello=ospfAreaRxHello, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfNbrStart=ospfIntfNbrStart, ip_info=ip_info, ospfIntfTxPkts=ospfIntfTxPkts, ospfNewCfgAreaId=ospfNewCfgAreaId)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfNbrInExchState=ospfNbrInExchState, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumNbrN1way=ospfCumNbrN1way, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, arpInfoTable=arpInfoTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ripCurCfgState=ripCurCfgState, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIfInfoIndex=ospfIfInfoIndex, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfNbrInInitState=ospfNbrInInitState, ospfAreaInfoId=ospfAreaInfoId, ospfinfo=ospfinfo, ospfCumRxTxStats=ospfCumRxTxStats, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripStatOutPkts=ripStatOutPkts, ospfGeneralStats=ospfGeneralStats, ospfCumIntfHello=ospfCumIntfHello, routeStatHighWater=routeStatHighWater, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipCurCfgGwTable=ipCurCfgGwTable, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfStats=ospfStats, ospfAreaNbrhello=ospfAreaNbrhello, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, routeStatEntries=routeStatEntries, ospfIntfRxTxIndex=ospfIntfRxTxIndex, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, routeStatMaxEntries=routeStatMaxEntries, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ripCurCfgVip=ripCurCfgVip, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgGwAddr=ipNewCfgGwAddr, arpStatHighWater=arpStatHighWater, ospfIntfIndex=ospfIntfIndex, ospfAreaIntfDown=ospfAreaIntfDown, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipRouteInfoTag=ipRouteInfoTag, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, routeStats=routeStats, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumTxHello=ospfCumTxHello, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipRouteInfoType=ipRouteInfoType, ospfIntfCountForRouter=ospfIntfCountForRouter, ripNewCfgListen=ripNewCfgListen, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfTotalAreas=ospfTotalAreas, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaTxPkts=ospfAreaTxPkts, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgGwArp=ipCurCfgGwArp, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgIntfMask=ipNewCfgIntfMask, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumIntfLoop=ospfCumIntfLoop, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpOper=vrrpOper, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgGwEntry=ipCurCfgGwEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, arpInfoSrcPort=arpInfoSrcPort, ipNewCfgGwEntry=ipNewCfgGwEntry, ripConfig=ripConfig, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, dnsStats=dnsStats, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaNbrDown=ospfAreaNbrDown, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipRouteInfoDestIp=ipRouteInfoDestIp, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, routerLSAId=routerLSAId, ospfGeneralInfo=ospfGeneralInfo, arpStatEntries=arpStatEntries, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrp_info=vrrp_info, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry)
