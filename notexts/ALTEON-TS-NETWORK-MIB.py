...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumTxHello=ospfCumTxHello, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripConfig=ripConfig, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfNbrStart=ospfIntfNbrStart, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgIfTable=vrrpCurCfgIfTable, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaTableMaxSize=ospfAreaTableMaxSize, iprouting=iprouting, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfDown=ospfIntfDown, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, arpStatEntries=arpStatEntries, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfTotalAreas=ospfTotalAreas, ripCurCfgDefListen=ripCurCfgDefListen, vrrpOper=vrrpOper, arpInfoEntry=arpInfoEntry, arpInfoSrcPort=arpInfoSrcPort, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgGwInterval=ipNewCfgGwInterval, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgGwArp=ipCurCfgGwArp, arpInfoDestIp=arpInfoDestIp, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ripCurCfgSupply=ripCurCfgSupply, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfLoop=ospfIntfLoop, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, arpStatHighWater=arpStatHighWater, ospfArea=ospfArea, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, routeStatMaxEntries=routeStatMaxEntries, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrp_info=vrrp_info, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaTxDatabase=ospfAreaTxDatabase, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ripNewCfgSupply=ripNewCfgSupply, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumIntfUnloop=ospfCumIntfUnloop, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ip_info=ip_info, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfInterface=ospfInterface, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ripNewCfgState=ripNewCfgState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfTxHello=ospfIntfTxHello, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfNbrInInitState=ospfNbrInInitState, routerLSALinkID=routerLSALinkID, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ripCurCfgState=ripCurCfgState, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfUnloop=ospfIntfUnloop, ospfAreaInfoId=ospfAreaInfoId, arpInfoVLAN=arpInfoVLAN, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, routerLSALinkData=routerLSALinkData, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfNbrInExchState=ospfNbrInExchState, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfRxHello=ospfIntfRxHello, ospfGeneralStats=ospfGeneralStats, ospfIntfRxTxStats=ospfIntfRxTxStats, routeStats=routeStats, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgGenState=vrrpCurCfgGenState)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipForward=ipForward, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaRxHello=ospfAreaRxHello, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumRxHello=ospfCumRxHello, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfWaitTimer=ospfIntfWaitTimer, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfProcessUptime=ospfProcessUptime, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfBackup=ospfIntfBackup, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, routerLSAId=routerLSAId, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaNbrIndex=ospfAreaNbrIndex, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgGwAddr=ipCurCfgGwAddr, routeStatEntries=routeStatEntries, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipRouteInfoType=ipRouteInfoType, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, arpInfoRefPorts=arpInfoRefPorts, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCumRxPkts=ospfCumRxPkts, ripCurCfgListen=ripCurCfgListen, ipGatewayTableMax=ipGatewayTableMax, ospfAreaIntfBackup=ospfAreaIntfBackup, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipRouteInfoIndx=ipRouteInfoIndx, vrrpStats=vrrpStats, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfHello=ospfIntfHello, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ripNewCfgListen=ripNewCfgListen, arpInfoMacAddr=arpInfoMacAddr, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ripStatInPkts=ripStatInPkts, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ripNewCfgVip=ripNewCfgVip, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, arpStats=arpStats, ospfStartTime=ospfStartTime, routeStatHighWater=routeStatHighWater, ospfCumRxTxStats=ospfCumRxTxStats, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, arpInfoFlag=arpInfoFlag, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaTxHello=ospfAreaTxHello, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumTxPkts=ospfCumTxPkts, ipCurCfgIntfState=ipCurCfgIntfState, dnsStats=dnsStats, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumIntfHello=ospfCumIntfHello, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripNewCfgDefListen=ripNewCfgDefListen, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripStats=ripStats, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgGwTable=ipCurCfgGwTable, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfGeneral=ospfGeneral, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipRouteInfoInterface=ipRouteInfoInterface, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumNbrhello=ospfCumNbrhello, vrrpGeneral=vrrpGeneral, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfStats=ospfStats, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipInterfaceTableMax=ipInterfaceTableMax, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrp=vrrp)
