...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfinfo=ospfinfo, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgBootpState=ipCurCfgBootpState, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfGeneralStats=ospfGeneralStats, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ripStatOutPkts=ripStatOutPkts, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfNbrInFullState=ospfNbrInFullState, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumTxHello=ospfCumTxHello, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumIntfHello=ospfCumIntfHello, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumTxDatabase=ospfCumTxDatabase, vrrp_info=vrrp_info, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipRouteInfoGateway=ipRouteInfoGateway, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, routerLSALinkData=routerLSALinkData, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, dnsStats=dnsStats, ipNewCfgIntfIndex=ipNewCfgIntfIndex, arpInfoFlag=arpInfoFlag, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgGwArp=ipNewCfgGwArp, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumRxTxStats=ospfCumRxTxStats, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgGwTable=ipNewCfgGwTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ripNewCfgSupply=ripNewCfgSupply, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaIntfDown=ospfAreaIntfDown, ipGatewayTableMax=ipGatewayTableMax, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpStatInAdvers=vrrpStatInAdvers, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgGwVlan=ipNewCfgGwVlan, ripNewCfgVip=ripNewCfgVip, ripCurCfgVip=ripCurCfgVip, ipRouteInfoEntry=ipRouteInfoEntry, ripCurCfgState=ripCurCfgState, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipInterfaceTableMax=ipInterfaceTableMax, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaTxPkts=ospfAreaTxPkts, routeStatHighWater=routeStatHighWater, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, arpInfoDestIp=arpInfoDestIp, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfLoop=ospfIntfLoop, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfNbrChange=ospfIntfNbrChange, ospfTotalTransitAreas=ospfTotalTransitAreas, arpInfoVLAN=arpInfoVLAN, ospfLsTypesSupported=ospfLsTypesSupported, ripCurCfgSupply=ripCurCfgSupply, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfNbrDown=ospfIntfNbrDown, ipRouteInfoTable=ipRouteInfoTable, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfNbrN1way=ospfIntfNbrN1way, arpInfoSrcPort=arpInfoSrcPort, ospfAreaTxHello=ospfAreaTxHello, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumRxHello=ospfCumRxHello, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfTotalAreas=ospfTotalAreas, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgGwEntry=ipCurCfgGwEntry, arpStats=arpStats, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, arpInfoTable=arpInfoTable, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumNbrhello=ospfCumNbrhello, ospfIntfNbrhello=ospfIntfNbrhello, arpStatEntries=arpStatEntries, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, ripNewCfgListen=ripNewCfgListen, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipForward=ipForward, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfGeneral=ospfGeneral, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ip_info=ip_info, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfGeneralInfo=ospfGeneralInfo, vrrpOper=vrrpOper, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ripStats=ripStats, ospfArea=ospfArea, arpStatHighWater=arpStatHighWater, ripConfig=ripConfig, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgGwAddr=ipNewCfgGwAddr, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, iprouting=iprouting, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpGeneral=vrrpGeneral, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfTxHello=ospfIntfTxHello, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfNbrStart=ospfIntfNbrStart, ipRouteInfoMask=ipRouteInfoMask, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCurCfgAreaId=ospfCurCfgAreaId, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, arpInfoRefPorts=arpInfoRefPorts, ripStatInPkts=ripStatInPkts, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, routerLSALinkIndex=routerLSALinkIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, arpInfoEntry=arpInfoEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipNewCfgGwIndex=ipNewCfgGwIndex, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipRouteInfoType=ipRouteInfoType, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfStats=ospfStats, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfStartTime=ospfStartTime, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCfg=ospfCfg, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumRxlsReqs=ospfCumRxlsReqs, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumNbrN1way=ospfCumNbrN1way, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumRxPkts=ospfCumRxPkts, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfHello=ospfIntfHello, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpStats=vrrpStats, vrrp=vrrp, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumNbrDown=ospfCumNbrDown, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCumTxPkts=ospfCumTxPkts, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaNbrhello=ospfAreaNbrhello, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, arpStatMaxEntries=arpStatMaxEntries, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumIntfLoop=ospfCumIntfLoop, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ripNewCfgState=ripNewCfgState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfRxHello=ospfIntfRxHello, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipNewCfgGwInterval=ipNewCfgGwInterval, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaTableMaxSize=ospfAreaTableMaxSize, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, arpInfoMacAddr=arpInfoMacAddr, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumNbrStart=ospfCumNbrStart, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ripCurCfgDefListen=ripCurCfgDefListen, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaInfoId=ospfAreaInfoId, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumIntfDown=ospfCumIntfDown, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgGwState=ipNewCfgGwState, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripCurCfgListen=ripCurCfgListen, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfDown=ospfIntfDown, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfBackup=ospfIntfBackup, ipFwdCurCfgState=ipFwdCurCfgState, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfNbrInInitState=ospfNbrInInitState, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, routeStats=routeStats)
