...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipCurCfgBootpState=ipCurCfgBootpState, ospfInterface=ospfInterface, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumNbrStart=ospfCumNbrStart, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ripNewCfgVip=ripNewCfgVip, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumTxlsAcks=ospfCumTxlsAcks, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfDown=ospfIntfDown, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipRouteInfoTag=ipRouteInfoTag, ospfNbrInFullState=ospfNbrInFullState, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ripCurCfgState=ripCurCfgState, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfLoop=ospfIntfLoop, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaTxHello=ospfAreaTxHello, vrrp=vrrp, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfNbrInExchState=ospfNbrInExchState, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfStats=ospfStats, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumNbrDown=ospfCumNbrDown, ospfArea=ospfArea, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, arpInfoRefPorts=arpInfoRefPorts, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfTxDatabase=ospfIntfTxDatabase, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfTotalTransitAreas=ospfTotalTransitAreas, dnsStats=dnsStats, routerLSALinkIndex=routerLSALinkIndex, routeStats=routeStats, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfinfo=ospfinfo, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfIndex=ospfIntfIndex, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfRxHello=ospfIntfRxHello, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, arpInfoTable=arpInfoTable, ripStats=ripStats, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgBootpState=ipNewCfgBootpState, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumIntfNbrChange=ospfCumIntfNbrChange, arpStats=arpStats, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCfg=ospfCfg, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgGwState=ipCurCfgGwState, ospfAreaRxHello=ospfAreaRxHello, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaRxDatabase=ospfAreaRxDatabase, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ripStatOutPkts=ripStatOutPkts, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIfInfoIndex=ospfIfInfoIndex, ipRouteInfoType=ipRouteInfoType, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfUnloop=ospfIntfUnloop, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumIntfHello=ospfCumIntfHello, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, routerLSALinkID=routerLSALinkID, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, routeStatHighWater=routeStatHighWater, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfTxlsAcks=ospfIntfTxlsAcks, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumRxDatabase=ospfCumRxDatabase, ospfGeneralInfo=ospfGeneralInfo, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpGeneral=vrrpGeneral, ospfTotalAreas=ospfTotalAreas, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, routerLSAId=routerLSAId, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgGwMetric=ipNewCfgGwMetric, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpStatInAdvers=vrrpStatInAdvers, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ripConfig=ripConfig, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfLsTypesSupported=ospfLsTypesSupported, ospfGeneral=ospfGeneral, ipForward=ipForward, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumIntfBackup=ospfCumIntfBackup, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ripStatInPkts=ripStatInPkts, arpInfoEntry=arpInfoEntry, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ip_info=ip_info, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfGeneralStats=ospfGeneralStats, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaInfoId=ospfAreaInfoId, ospfProcessUptime=ospfProcessUptime, ospfStartTime=ospfStartTime, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgIntfTable=ipNewCfgIntfTable, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgGwAddr=ipNewCfgGwAddr, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumTxHello=ospfCumTxHello, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfHello=ospfIntfHello, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, arpInfoFlag=arpInfoFlag, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfBackup=ospfIntfBackup, ipNewCfgGwEntry=ipNewCfgGwEntry, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfTxHello=ospfIntfTxHello, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ripCurCfgListen=ripCurCfgListen, ospfCumRxHello=ospfCumRxHello, ripNewCfgListen=ripNewCfgListen, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumTxlsUpdates=ospfCumTxlsUpdates, arpStatMaxEntries=arpStatMaxEntries, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ripNewCfgState=ripNewCfgState, ripCurCfgSupply=ripCurCfgSupply, arpInfoMacAddr=arpInfoMacAddr, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumRxTxStats=ospfCumRxTxStats, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpOper=vrrpOper, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumTxPkts=ospfCumTxPkts, ripCurCfgVip=ripCurCfgVip, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgGwInterval=ipCurCfgGwInterval, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrp_info=vrrp_info, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, arpInfoSrcPort=arpInfoSrcPort, routeStatEntries=routeStatEntries, ospfIntfRxPkts=ospfIntfRxPkts, arpInfoDestIp=arpInfoDestIp, iprouting=iprouting, ospfAreaNbrhello=ospfAreaNbrhello, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaInfoTable=ospfAreaInfoTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfNbrInInitState=ospfNbrInInitState, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipRouteInfoDestIp=ipRouteInfoDestIp, ipRouteInfoEntry=ipRouteInfoEntry, ripNewCfgSupply=ripNewCfgSupply)
