...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaTxPkts=ospfAreaTxPkts, ospfCfg=ospfCfg, ospfIntfTxHello=ospfIntfTxHello, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfNbrN1way=ospfIntfNbrN1way, dnsStats=dnsStats, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfLoop=ospfIntfLoop, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipForward=ipForward, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripStatInPkts=ripStatInPkts, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumNbrStart=ospfCumNbrStart, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaNbrhello=ospfAreaNbrhello, routerLSAId=routerLSAId, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, arpInfoVLAN=arpInfoVLAN, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumTxPkts=ospfCumTxPkts, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfChangeStats=ospfIntfChangeStats, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrp=vrrp, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripCurCfgVip=ripCurCfgVip, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, arpInfoEntry=arpInfoEntry, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfGeneralInfo=ospfGeneralInfo, ospfCumIntfUnloop=ospfCumIntfUnloop, arpInfoTable=arpInfoTable, ipCurCfgIntfTable=ipCurCfgIntfTable, arpStatEntries=arpStatEntries, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, routeStatMaxEntries=routeStatMaxEntries, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgGwIndex=ipCurCfgGwIndex, arpStatMaxEntries=arpStatMaxEntries, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgGwRetry=ipNewCfgGwRetry, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ip_info=ip_info, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfRxPkts=ospfIntfRxPkts, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfNbrInExchState=ospfNbrInExchState, ospfIntfTxPkts=ospfIntfTxPkts, ripNewCfgListen=ripNewCfgListen, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfGeneral=ospfGeneral, ospfLsTypesSupported=ospfLsTypesSupported, vrrpOper=vrrpOper, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpStatInAdvers=vrrpStatInAdvers, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, routeStatEntries=routeStatEntries, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumTxlsReqs=ospfCumTxlsReqs, ipRouteInfoType=ipRouteInfoType, ipFwdNewCfgState=ipFwdNewCfgState, ospfStartTime=ospfStartTime, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfIndex=ospfIntfIndex, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfArea=ospfArea, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgGwMetric=ipNewCfgGwMetric, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgIntfMask=ipNewCfgIntfMask, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgGwState=ipNewCfgGwState, ospfIntfDown=ospfIntfDown, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripStats=ripStats, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfInterface=ospfInterface, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumRxHello=ospfCumRxHello, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipRouteInfoTable=ipRouteInfoTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgGwArp=ipNewCfgGwArp, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfUnloop=ospfIntfUnloop, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfProcessUptime=ospfProcessUptime, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumTxHello=ospfCumTxHello, routerLSALinkData=routerLSALinkData, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgGwState=ipCurCfgGwState, ospfIntfBackup=ospfIntfBackup, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumIntfHello=ospfCumIntfHello, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumRxPkts=ospfCumRxPkts, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumNbrhello=ospfCumNbrhello, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripCurCfgListen=ripCurCfgListen, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipGatewayTableMax=ipGatewayTableMax, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfRxTxStats=ospfIntfRxTxStats, ipInterfaceTableMax=ipInterfaceTableMax, arpStatHighWater=arpStatHighWater, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgIfTable=vrrpCurCfgIfTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ripConfig=ripConfig, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpStats=vrrpStats, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipRouteInfoGateway=ipRouteInfoGateway, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumIntfBackup=ospfCumIntfBackup, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, arpInfoDestIp=arpInfoDestIp, ripNewCfgVip=ripNewCfgVip, vrrpGeneral=vrrpGeneral, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipRouteInfoEntry=ipRouteInfoEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaTxHello=ospfAreaTxHello, ospfinfo=ospfinfo, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaNbrStart=ospfAreaNbrStart, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ripNewCfgState=ripNewCfgState, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfRxHello=ospfIntfRxHello, ipRouteInfoIndx=ipRouteInfoIndx, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaInfoTable=ospfAreaInfoTable, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaRxHello=ospfAreaRxHello, ospfNbrInFullState=ospfNbrInFullState, routeStats=routeStats, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgGwArp=ipCurCfgGwArp, ipRouteInfoTag=ipRouteInfoTag, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, arpStats=arpStats, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgGwAddr=ipCurCfgGwAddr, routeStatHighWater=routeStatHighWater, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumNbrDown=ospfCumNbrDown, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfGeneralStats=ospfGeneralStats, iprouting=iprouting, ipFwdCurCfgState=ipFwdCurCfgState, ipRouteInfoMask=ipRouteInfoMask, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfStats=ospfStats, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet)
