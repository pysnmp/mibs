...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgGwVlan=ipNewCfgGwVlan, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumNbrStart=ospfCumNbrStart, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumRxlsAcks=ospfCumRxlsAcks, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, routeStatMaxEntries=routeStatMaxEntries, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipCurCfgGwArp=ipCurCfgGwArp, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, arpInfoVLAN=arpInfoVLAN, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumIntfDown=ospfCumIntfDown, ospfCumNbrhello=ospfCumNbrhello, ospfGeneralStats=ospfGeneralStats, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, routeStats=routeStats, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, arpInfoMacAddr=arpInfoMacAddr, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaIntfBackup=ospfAreaIntfBackup, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripCurCfgDefListen=ripCurCfgDefListen, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgBootpState=ipCurCfgBootpState, ipRouteInfoDestIp=ipRouteInfoDestIp, ipRouteInfoGateway=ipRouteInfoGateway, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaNbrStart=ospfAreaNbrStart, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumRxHello=ospfCumRxHello, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumTxPkts=ospfCumTxPkts, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfHello=ospfIntfHello, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ripNewCfgSupply=ripNewCfgSupply, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ripStatInPkts=ripStatInPkts, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaInfoId=ospfAreaInfoId, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaRxHello=ospfAreaRxHello, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipRouteInfoType=ipRouteInfoType, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripNewCfgDefListen=ripNewCfgDefListen, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumRxPkts=ospfCumRxPkts, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCfg=ospfCfg, ipForward=ipForward, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfDown=ospfIntfDown, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripStatOutPkts=ripStatOutPkts, vrrp_info=vrrp_info, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, iprouting=iprouting, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, arpInfoFlag=arpInfoFlag, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpOper=vrrpOper, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfNewCfgAreaId=ospfNewCfgAreaId, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgGwInterval=ipCurCfgGwInterval, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfStats=ospfStats, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaInfoEntry=ospfAreaInfoEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfProcessUptime=ospfProcessUptime, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfNbrInExchState=ospfNbrInExchState, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumIntfHello=ospfCumIntfHello, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfLoop=ospfIntfLoop, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfArea=ospfArea, routerLSAAreaIndex=routerLSAAreaIndex, dnsStats=dnsStats, vrrpStats=vrrpStats)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, arpStats=arpStats, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ip_info=ip_info, ospfAreaChangeStats=ospfAreaChangeStats, ripCurCfgListen=ripCurCfgListen, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripCurCfgSupply=ripCurCfgSupply, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrp=vrrp, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripNewCfgVip=ripNewCfgVip, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ripStats=ripStats, routeStatEntries=routeStatEntries, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfIndex=ospfIntfIndex, ospfTotalAreas=ospfTotalAreas, ospfAreaInfoIndex=ospfAreaInfoIndex, ripCurCfgState=ripCurCfgState, ripConfig=ripConfig, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, arpStatEntries=arpStatEntries, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumNbrDown=ospfCumNbrDown, ospfHostTableMaxSize=ospfHostTableMaxSize, arpInfoDestIp=arpInfoDestIp, ospfIfInfoIndex=ospfIfInfoIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfBackup=ospfIntfBackup, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumRxDatabase=ospfCumRxDatabase, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaTxHello=ospfAreaTxHello, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfGeneralInfo=ospfGeneralInfo, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfNbrInFullState=ospfNbrInFullState, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipRouteInfoIndx=ipRouteInfoIndx, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfTxHello=ospfIntfTxHello, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgGwEntry=ipNewCfgGwEntry, routerLSAId=routerLSAId, ospfGeneral=ospfGeneral, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgBootpState=ipNewCfgBootpState, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgIntfState=ipCurCfgIntfState, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, routerLSALinkData=routerLSALinkData, ripCurCfgVip=ripCurCfgVip, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfTableMaxSize=ospfIntfTableMaxSize, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaNbrhello=ospfAreaNbrhello, ipRouteInfoTag=ipRouteInfoTag, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, arpInfoTable=arpInfoTable, ospfCumRxTxStats=ospfCumRxTxStats, routerLSALinkIndex=routerLSALinkIndex, arpInfoEntry=arpInfoEntry, ipGatewayTableMax=ipGatewayTableMax, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaTxlsReqs=ospfAreaTxlsReqs, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ripNewCfgState=ripNewCfgState)
