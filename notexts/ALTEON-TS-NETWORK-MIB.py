...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumIntfHello=ospfCumIntfHello, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfBackup=ospfIntfBackup, arpStatEntries=arpStatEntries, ospfAreaRxDatabase=ospfAreaRxDatabase, ipRouteInfoEntry=ipRouteInfoEntry, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, arpInfoFlag=arpInfoFlag, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, dnsStats=dnsStats, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumRxHello=ospfCumRxHello, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpOper=vrrpOper, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, routerLSALinkData=routerLSALinkData, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfIndex=ospfIntfIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfDown=ospfIntfDown, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumNbrDown=ospfCumNbrDown, ipForward=ipForward, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfinfo=ospfinfo, ripCurCfgState=ripCurCfgState, ospfProcessUptime=ospfProcessUptime, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipCurCfgGwEntry=ipCurCfgGwEntry, ripNewCfgState=ripNewCfgState, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfInfoTable=ospfIntfInfoTable, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaNbrStart=ospfAreaNbrStart, ripCurCfgVip=ripCurCfgVip, ospfStartTime=ospfStartTime, arpInfoSrcPort=arpInfoSrcPort, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgGwTable=ipNewCfgGwTable, routeStatHighWater=routeStatHighWater, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, routeStatEntries=routeStatEntries, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfNbrN1way=ospfIntfNbrN1way, arpStats=arpStats, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaNbrDown=ospfAreaNbrDown, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfArea=ospfArea, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumTxlsReqs=ospfCumTxlsReqs, ipRouteInfoIndx=ipRouteInfoIndx, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgIntfTable=ipNewCfgIntfTable, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgGwArp=ipCurCfgGwArp, ospfCurCfgAreaId=ospfCurCfgAreaId, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, iprouting=iprouting, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ripStats=ripStats, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumTxlsAcks=ospfCumTxlsAcks, arpStatMaxEntries=arpStatMaxEntries, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipCurCfgGwTable=ipCurCfgGwTable, ripNewCfgDefListen=ripNewCfgDefListen, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumTxHello=ospfCumTxHello, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumNbrStart=ospfCumNbrStart, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfNbrInExchState=ospfNbrInExchState, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrp=vrrp, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ip_info=ip_info, ripConfig=ripConfig, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ripStatOutPkts=ripStatOutPkts, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, arpStatHighWater=arpStatHighWater, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpStats=vrrpStats, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfNbrInFullState=ospfNbrInFullState, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfNbrDown=ospfIntfNbrDown)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumNbrN1way=ospfCumNbrN1way, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ripCurCfgListen=ripCurCfgListen, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipNewCfgIntfState=ipNewCfgIntfState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfStats=ospfStats, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, routerLSAId=routerLSAId, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ripNewCfgVip=ripNewCfgVip, ripStatInPkts=ripStatInPkts, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpStatInAdvers=vrrpStatInAdvers, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumIntfDown=ospfCumIntfDown, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, arpInfoDestIp=arpInfoDestIp, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumTxDatabase=ospfCumTxDatabase, routerLSALinkIndex=routerLSALinkIndex, arpInfoTable=arpInfoTable, ospfTotalAreas=ospfTotalAreas, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfLoop=ospfIntfLoop, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfNbrInInitState=ospfNbrInInitState, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumTxPkts=ospfCumTxPkts, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripNewCfgSupply=ripNewCfgSupply, ospfInterface=ospfInterface, ospfAreaRxTxStats=ospfAreaRxTxStats, ipRouteInfoInterface=ipRouteInfoInterface, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripNewCfgListen=ripNewCfgListen, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, arpInfoEntry=arpInfoEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipRouteInfoMask=ipRouteInfoMask, ipFwdNewCfgState=ipFwdNewCfgState, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfGeneralStats=ospfGeneralStats, ipNewCfgGwState=ipNewCfgGwState, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumRxlsAcks=ospfCumRxlsAcks, routerLSALinkID=routerLSALinkID, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfUnloop=ospfIntfUnloop, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, arpInfoRefPorts=arpInfoRefPorts, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgIntfMask=ipNewCfgIntfMask, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipRouteInfoTag=ipRouteInfoTag, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipCurCfgIntfIndex=ipCurCfgIntfIndex, routeStats=routeStats, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaNbrhello=ospfAreaNbrhello, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfGeneral=ospfGeneral, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCfg=ospfCfg, ipNewCfgGwRetry=ipNewCfgGwRetry)
