...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpGeneral=vrrpGeneral, ripCurCfgListen=ripCurCfgListen, ospfNbrInInitState=ospfNbrInInitState, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ripNewCfgDefListen=ripNewCfgDefListen, arpStatMaxEntries=arpStatMaxEntries, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ripCurCfgVip=ripCurCfgVip, ospfCumIntfBackup=ospfCumIntfBackup, ipCurCfgIntfIndex=ipCurCfgIntfIndex, arpInfoVLAN=arpInfoVLAN, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaInfoIndex=ospfAreaInfoIndex, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfGeneral=ospfGeneral, ospfCumNbrN1way=ospfCumNbrN1way, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, routeStatEntries=routeStatEntries, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumTxlsReqs=ospfCumTxlsReqs, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfBackup=ospfIntfBackup, ospfAreaTxDatabase=ospfAreaTxDatabase, ipCurCfgGwMetric=ipCurCfgGwMetric, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, dnsStats=dnsStats, ospfTotalNeighbours=ospfTotalNeighbours, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, ripStatOutPkts=ripStatOutPkts, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfNbrhello=ospfIntfNbrhello, ospfArea=ospfArea, vrrp_info=vrrp_info, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumRxPkts=ospfCumRxPkts, ipRouteInfoIndx=ipRouteInfoIndx, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, arpInfoRefPorts=arpInfoRefPorts, ospfIntfDown=ospfIntfDown, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCumIntfHello=ospfCumIntfHello, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfRxHello=ospfIntfRxHello, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ripNewCfgVip=ripNewCfgVip, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfIndex=ospfIntfIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, arpStatHighWater=arpStatHighWater, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaTxPkts=ospfAreaTxPkts, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdNewCfgState=ipFwdNewCfgState, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumIntfChangeStats=ospfCumIntfChangeStats, iprouting=iprouting, routerLSAId=routerLSAId, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumIntfUnloop=ospfCumIntfUnloop, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpStats=vrrpStats, arpInfoTable=arpInfoTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaTxHello=ospfAreaTxHello, ospfGeneralInfo=ospfGeneralInfo, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfInfoEntry=ospfIntfInfoEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ripStatInPkts=ripStatInPkts, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, arpInfoDestIp=arpInfoDestIp, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpOper=vrrpOper, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaRxPkts=ospfAreaRxPkts, ipRouteInfoTag=ipRouteInfoTag, ip_info=ip_info, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipRouteInfoEntry=ipRouteInfoEntry, ripConfig=ripConfig, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaInfoId=ospfAreaInfoId, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfGeneralStats=ospfGeneralStats, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, arpStats=arpStats, ipNewCfgIntfState=ipNewCfgIntfState, ripNewCfgSupply=ripNewCfgSupply, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaNbrDown=ospfAreaNbrDown)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumTxPkts=ospfCumTxPkts, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfinfo=ospfinfo, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgGwRetry=ipNewCfgGwRetry, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfTxPkts=ospfIntfTxPkts, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCumRxHello=ospfCumRxHello, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfUnloop=ospfIntfUnloop, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgGwTable=ipCurCfgGwTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumNbrChangeStats=ospfCumNbrChangeStats, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaChangeStats=ospfAreaChangeStats, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfStartTime=ospfStartTime, arpInfoFlag=arpInfoFlag, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumTxDatabase=ospfCumTxDatabase, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgGwState=ipCurCfgGwState, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, routeStatHighWater=routeStatHighWater, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumIntfNbrChange=ospfCumIntfNbrChange, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripStats=ripStats, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfCumRxlsReqs=ospfCumRxlsReqs, routerLSALinkData=routerLSALinkData, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgGwArp=ipCurCfgGwArp, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfTotalAreas=ospfTotalAreas, vrrp=vrrp, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumTxHello=ospfCumTxHello, ipInterfaceTableMax=ipInterfaceTableMax, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaTxlsAcks=ospfAreaTxlsAcks, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCfg=ospfCfg, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, routeStatMaxEntries=routeStatMaxEntries, ospfIntfHello=ospfIntfHello, ospfCumRxTxStats=ospfCumRxTxStats, routeStats=routeStats, ospfProcessUptime=ospfProcessUptime, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfStats=ospfStats, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipForward=ipForward, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumTxlsUpdates=ospfCumTxlsUpdates, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics)
