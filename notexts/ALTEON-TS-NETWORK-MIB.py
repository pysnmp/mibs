...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaIntfIndex=ospfAreaIntfIndex, ripStats=ripStats, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumNbrDown=ospfCumNbrDown, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumRxPkts=ospfCumRxPkts, ripConfig=ripConfig, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgIntfIndex=ipCurCfgIntfIndex, routerLSALinkIndex=routerLSALinkIndex, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumTxDatabase=ospfCumTxDatabase, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipRouteInfoType=ipRouteInfoType, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfTxHello=ospfIntfTxHello, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ip_info=ip_info, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ripNewCfgSupply=ripNewCfgSupply, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, ipForward=ipForward, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgGwIndex=ipNewCfgGwIndex, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpGeneral=vrrpGeneral, ripCurCfgSupply=ripCurCfgSupply, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfUnloop=ospfIntfUnloop, ospfArea=ospfArea, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumTxHello=ospfCumTxHello, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfLoop=ospfIntfLoop, ospfCumNbrRstAd=ospfCumNbrRstAd, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfGeneral=ospfGeneral, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrp=vrrp, arpInfoRefPorts=arpInfoRefPorts, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgGwState=ipCurCfgGwState, ospfAreaRxPkts=ospfAreaRxPkts, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaIntfHello=ospfAreaIntfHello, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfRxHello=ospfIntfRxHello, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ripNewCfgVip=ripNewCfgVip, arpInfoVLAN=arpInfoVLAN, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, routeStats=routeStats, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfTotalNssaAreas=ospfTotalNssaAreas, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfGeneralInfo=ospfGeneralInfo, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipFwdCurCfgState=ipFwdCurCfgState, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfTxlsReqs=ospfIntfTxlsReqs, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfStats=ospfStats, ipNewCfgBootpAddr=ipNewCfgBootpAddr, arpStats=arpStats, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipRouteInfoMask=ipRouteInfoMask, ospfIntfNbrChange=ospfIntfNbrChange, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumIntfHello=ospfCumIntfHello, ospfGeneralStats=ospfGeneralStats, ipFwdNewCfgState=ipFwdNewCfgState, arpInfoEntry=arpInfoEntry, ospfStartTime=ospfStartTime, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaIntfBackup=ospfAreaIntfBackup, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ripCurCfgListen=ripCurCfgListen, ripStatInPkts=ripStatInPkts, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, routerLSAId=routerLSAId, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ripNewCfgState=ripNewCfgState, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, arpInfoFlag=arpInfoFlag, dnsStats=dnsStats, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, routeStatEntries=routeStatEntries, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpStatMaxEntries=arpStatMaxEntries, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfInterface=ospfInterface, ripStatOutPkts=ripStatOutPkts, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, routerLSALinkData=routerLSALinkData, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaRxHello=ospfAreaRxHello, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, arpInfoMacAddr=arpInfoMacAddr, ripNewCfgListen=ripNewCfgListen, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, arpInfoDestIp=arpInfoDestIp, ospfAreaNbrhello=ospfAreaNbrhello, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumNbrhello=ospfCumNbrhello, ospfCumIntfChangeStats=ospfCumIntfChangeStats, arpInfoTable=arpInfoTable, ospfIntfDown=ospfIntfDown, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpStatInAdvers=vrrpStatInAdvers, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripCurCfgState=ripCurCfgState, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgGwState=ipNewCfgGwState, ospfCfg=ospfCfg, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCumTxPkts=ospfCumTxPkts, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgGwDelete=ipNewCfgGwDelete, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgIntfState=ipCurCfgIntfState, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpOper=vrrpOper, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, iprouting=iprouting, routeStatHighWater=routeStatHighWater, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCumRxDatabase=ospfCumRxDatabase, ospfIfInfoIndex=ospfIfInfoIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumNbrStart=ospfCumNbrStart, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfIndex=ospfIntfIndex, ipNewCfgIntfVlan=ipNewCfgIntfVlan, arpStatHighWater=arpStatHighWater, ipNewCfgGwMetric=ipNewCfgGwMetric, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaChangeStats=ospfAreaChangeStats, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaTxHello=ospfAreaTxHello, ospfCurCfgAreaId=ospfCurCfgAreaId, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, routerLSALinkID=routerLSALinkID, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaIntfDown=ospfAreaIntfDown, ripNewCfgDefListen=ripNewCfgDefListen, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipRouteInfoGateway=ipRouteInfoGateway, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfNbrInFullState=ospfNbrInFullState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumRxHello=ospfCumRxHello, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaNbrStart=ospfAreaNbrStart, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpStats=vrrpStats, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfNbrInInitState=ospfNbrInInitState, ospfTotalAreas=ospfTotalAreas, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfHello=ospfIntfHello, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry)
