...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumRxDatabase=ospfCumRxDatabase, ripCurCfgVip=ripCurCfgVip, vrrpStats=vrrpStats, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfGeneralStats=ospfGeneralStats, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgGwArp=ipNewCfgGwArp, vrrpOper=vrrpOper, vrrpStatOutAdvers=vrrpStatOutAdvers, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfChangeStats=ospfIntfChangeStats, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfNbrInExchState=ospfNbrInExchState, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ripConfig=ripConfig, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgGwRetry=ipNewCfgGwRetry, routerLSALinkID=routerLSALinkID, ospfIntfLoop=ospfIntfLoop, ripNewCfgSupply=ripNewCfgSupply, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripNewCfgDefListen=ripNewCfgDefListen, routeStatEntries=routeStatEntries, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, dnsStats=dnsStats, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaNbrhello=ospfAreaNbrhello, arpInfoMacAddr=arpInfoMacAddr, ospfIntfRxHello=ospfIntfRxHello, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaRxHello=ospfAreaRxHello, ospfIntfHello=ospfIntfHello, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumRxPkts=ospfCumRxPkts, ospfCumTxHello=ospfCumTxHello, vrrp_info=vrrp_info, ospfProcessUptime=ospfProcessUptime, ipCurCfgBootpState=ipCurCfgBootpState, ospfCfg=ospfCfg, ospfAreaTxPkts=ospfAreaTxPkts, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, routeStatHighWater=routeStatHighWater, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumNbrhello=ospfCumNbrhello, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfTxHello=ospfIntfTxHello, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrp=vrrp, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfNbrChange=ospfIntfNbrChange, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipRouteInfoMask=ipRouteInfoMask, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, arpInfoFlag=arpInfoFlag, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, arpStatMaxEntries=arpStatMaxEntries, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaIntfBackup=ospfAreaIntfBackup, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumIntfHello=ospfCumIntfHello, ospfInterface=ospfInterface, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipGatewayTableMax=ipGatewayTableMax, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ripNewCfgListen=ripNewCfgListen, ospfIntfTxPkts=ospfIntfTxPkts, ripStats=ripStats, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, routeStats=routeStats, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaTxHello=ospfAreaTxHello, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ip_info=ip_info, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, routeStatMaxEntries=routeStatMaxEntries, ospfAreaInfoTable=ospfAreaInfoTable, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumTxDatabase=ospfCumTxDatabase, ripCurCfgListen=ripCurCfgListen, ospfAreaInfoEntry=ospfAreaInfoEntry, arpInfoVLAN=arpInfoVLAN, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, arpStatEntries=arpStatEntries, ospfIntfNbrIndex=ospfIntfNbrIndex, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIfWaitInterval=ospfIfWaitInterval, ospfStats=ospfStats, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ripCurCfgState=ripCurCfgState, ospfAreaIntfIndex=ospfAreaIntfIndex, arpInfoSrcPort=arpInfoSrcPort)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgIntfMask=ipNewCfgIntfMask, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipRouteInfoTag=ipRouteInfoTag, routerLSAId=routerLSAId, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfUnloop=ospfIntfUnloop, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfGeneralInfo=ospfGeneralInfo, ospfIntfCountForRouter=ospfIntfCountForRouter, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipForward=ipForward, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfGeneral=ospfGeneral, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfIndex=ospfIntfIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, arpStats=arpStats, ospfArea=ospfArea, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfStartTime=ospfStartTime, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgGwTable=ipNewCfgGwTable, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgBootpState=ipNewCfgBootpState, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfTotalNeighbours=ospfTotalNeighbours, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaInfoId=ospfAreaInfoId, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaIntfHello=ospfAreaIntfHello, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfLsTypesSupported=ospfLsTypesSupported, ospfIfInfoIndex=ospfIfInfoIndex, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgGwState=ipNewCfgGwState, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaTxDatabase=ospfAreaTxDatabase, iprouting=iprouting, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgGwState=ipCurCfgGwState, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdCurCfgPortState=ipFwdCurCfgPortState, arpStatHighWater=arpStatHighWater, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipRouteInfoType=ipRouteInfoType, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfDown=ospfIntfDown, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfinfo=ospfinfo, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumIntfDown=ospfCumIntfDown, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, routerLSALinkIndex=routerLSALinkIndex, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfNbrInInitState=ospfNbrInInitState, arpInfoDestIp=arpInfoDestIp, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipRouteInfoTable=ipRouteInfoTable, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipCurCfgGwTable=ipCurCfgGwTable)
