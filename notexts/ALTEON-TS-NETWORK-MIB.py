...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpGeneral=vrrpGeneral, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ripCurCfgVip=ripCurCfgVip, ripStats=ripStats, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ripNewCfgState=ripNewCfgState, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgGenState=vrrpNewCfgGenState, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgGwState=ipCurCfgGwState, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfCumRxlsAcks=ospfCumRxlsAcks, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfNbrhello=ospfIntfNbrhello, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpStats=vrrpStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfArea=ospfArea, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ripNewCfgListen=ripNewCfgListen, routeStats=routeStats, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfLoop=ospfIntfLoop, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrp=vrrp, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumNbrStart=ospfCumNbrStart, ospfIntfDown=ospfIntfDown, ospfNewCfgAreaId=ospfNewCfgAreaId, routeStatHighWater=routeStatHighWater, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCfg=ospfCfg, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaNbrStart=ospfAreaNbrStart, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgBootpState=ipNewCfgBootpState, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfStartTime=ospfStartTime, ospfIntfHello=ospfIntfHello, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, routerLSALinkID=routerLSALinkID, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipCurCfgIntfIndex=ipCurCfgIntfIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaRxTxStats=ospfAreaRxTxStats, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCumIntfHello=ospfCumIntfHello, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfRxPkts=ospfIntfRxPkts, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfTotalAreas=ospfTotalAreas, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ripStatInPkts=ripStatInPkts, ospfIntfNbrChange=ospfIntfNbrChange, routerLSAId=routerLSAId, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfGeneralInfo=ospfGeneralInfo, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumNbrhello=ospfCumNbrhello, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfNbrN1way=ospfIntfNbrN1way, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaTxHello=ospfAreaTxHello, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfRxTxIndex=ospfIntfRxTxIndex, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumNbrN1way=ospfCumNbrN1way, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCurCfgAreaId=ospfCurCfgAreaId, ipRouteInfoTag=ipRouteInfoTag, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfLsTypesSupported=ospfLsTypesSupported, ospfinfo=ospfinfo, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaNbrDown=ospfAreaNbrDown, arpStatMaxEntries=arpStatMaxEntries, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfRxHello=ospfIntfRxHello, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, routeStatEntries=routeStatEntries, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfBackup=ospfIntfBackup, ospfTotalTransitAreas=ospfTotalTransitAreas, ipRouteInfoType=ipRouteInfoType, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ripCurCfgState=ripCurCfgState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgIntfState=ipNewCfgIntfState, iprouting=iprouting, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ip_info=ip_info, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumIntfLoop=ospfCumIntfLoop, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgGwAddr=ipCurCfgGwAddr, ripNewCfgVip=ripNewCfgVip, ospfIntfCountForRouter=ospfIntfCountForRouter, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfStats=ospfStats, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipGatewayTableMax=ipGatewayTableMax, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCumRxHello=ospfCumRxHello, ospfAreaRxPkts=ospfAreaRxPkts, ripCurCfgDefListen=ripCurCfgDefListen, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumTxPkts=ospfCumTxPkts, ripCurCfgListen=ripCurCfgListen, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ripNewCfgSupply=ripNewCfgSupply, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipRouteInfoInterface=ipRouteInfoInterface, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgIntfMask=ipCurCfgIntfMask, dnsStats=dnsStats, arpStats=arpStats, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfUnloop=ospfIntfUnloop, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfTxHello=ospfIntfTxHello, ospfIntfRxTxStats=ospfIntfRxTxStats, ripConfig=ripConfig, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfNbrInInitState=ospfNbrInInitState, ospfCumIntfDown=ospfCumIntfDown, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfRxlsAcks=ospfIntfRxlsAcks, arpStatEntries=arpStatEntries, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfGeneralStats=ospfGeneralStats, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrp_info=vrrp_info, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpOper=vrrpOper, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaRxHello=ospfAreaRxHello, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipNewCfgGwArp=ipNewCfgGwArp, ipForward=ipForward, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgGwState=ipNewCfgGwState, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, arpInfoFlag=arpInfoFlag, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, arpInfoSrcPort=arpInfoSrcPort, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaChangeStats=ospfAreaChangeStats, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumIntfBackup=ospfCumIntfBackup, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaIntfDown=ospfAreaIntfDown, ospfInterface=ospfInterface, arpInfoVLAN=arpInfoVLAN, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipRouteInfoIndx=ipRouteInfoIndx, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipRouteInfoTable=ipRouteInfoTable, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumRxDatabase=ospfCumRxDatabase, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumRxPkts=ospfCumRxPkts, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc)
