...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfProcessUptime=ospfProcessUptime, ospfTotalAreas=ospfTotalAreas, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfTmrsKckOffHello=ospfTmrsKckOffHello, arpInfoMacAddr=arpInfoMacAddr, ospfCumNbrhello=ospfCumNbrhello, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpGeneral=vrrpGeneral, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipRouteInfoInterface=ipRouteInfoInterface, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfIndex=ospfIntfIndex, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, routerLSALinkData=routerLSALinkData, ipRouteInfoType=ipRouteInfoType, ripStatInPkts=ripStatInPkts, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfNbrInExchState=ospfNbrInExchState, arpInfoVLAN=arpInfoVLAN, ipForward=ipForward, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, arpInfoFlag=arpInfoFlag, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ripNewCfgState=ripNewCfgState, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumRxTxStats=ospfCumRxTxStats, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, routeStatEntries=routeStatEntries, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumNbrN1way=ospfCumNbrN1way, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ip_info=ip_info, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ripStats=ripStats, ripConfig=ripConfig, ipRouteInfoTag=ipRouteInfoTag, ospfGeneralInfo=ospfGeneralInfo, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfTxHello=ospfIntfTxHello, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipRouteInfoMask=ipRouteInfoMask, routeStats=routeStats, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfBackup=ospfIntfBackup, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaRxHello=ospfAreaRxHello, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, routeStatHighWater=routeStatHighWater, iprouting=iprouting, ospfIntfRxHello=ospfIntfRxHello, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumRxDatabase=ospfCumRxDatabase, vrrp_info=vrrp_info, ospfCumIntfBackup=ospfCumIntfBackup, ospfCfg=ospfCfg, ospfCumRxPkts=ospfCumRxPkts, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ripStatOutPkts=ripStatOutPkts, ospfNbrInFullState=ospfNbrInFullState, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ripCurCfgVip=ripCurCfgVip, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfDown=ospfIntfDown, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfArea=ospfArea, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ripNewCfgSupply=ripNewCfgSupply, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, routerLSAAreaIndex=routerLSAAreaIndex, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrp=vrrp, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdNewCfgState=ipFwdNewCfgState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfinfo=ospfinfo, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipRouteInfoDestIp=ipRouteInfoDestIp, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaTxHello=ospfAreaTxHello, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfStats=ospfStats, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumIntfDown=ospfCumIntfDown, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfHello=ospfIntfHello, ipGatewayTableMax=ipGatewayTableMax, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgBootpState=ipNewCfgBootpState, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, arpStats=arpStats, ospfIntfNbrStart=ospfIntfNbrStart, routerLSALinkID=routerLSALinkID, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumNbrStart=ospfCumNbrStart, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ripNewCfgListen=ripNewCfgListen, ipNewCfgGwState=ipNewCfgGwState, dnsStats=dnsStats, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgIntfState=ipNewCfgIntfState, ospfStartTime=ospfStartTime, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfNbrDown=ospfIntfNbrDown, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgGwRetry=ipCurCfgGwRetry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ripNewCfgDefListen=ripNewCfgDefListen, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, arpInfoRefPorts=arpInfoRefPorts, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, arpStatHighWater=arpStatHighWater, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfNewCfgAreaId=ospfNewCfgAreaId, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, ipRouteInfoGateway=ipRouteInfoGateway, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, routeStatMaxEntries=routeStatMaxEntries, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ripCurCfgState=ripCurCfgState, vrrpOper=vrrpOper, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, arpInfoDestIp=arpInfoDestIp, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, routerLSAId=routerLSAId, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfHostTableMaxSize=ospfHostTableMaxSize, routerLSALinkIndex=routerLSALinkIndex, ospfCumTxlsReqs=ospfCumTxlsReqs, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumRxlsReqs=ospfCumRxlsReqs, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIfWaitInterval=ospfIfWaitInterval, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, arpInfoSrcPort=arpInfoSrcPort, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfUnloop=ospfIntfUnloop, ospfGeneral=ospfGeneral, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpStatInAdvers=vrrpStatInAdvers, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumTxPkts=ospfCumTxPkts, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfNbrhello=ospfIntfNbrhello, arpInfoEntry=arpInfoEntry, ipRouteInfoIndx=ipRouteInfoIndx)
