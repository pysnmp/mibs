...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ripNewCfgListen=ripNewCfgListen, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaNbrN1way=ospfAreaNbrN1way, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumRxDatabase=ospfCumRxDatabase, routerLSALinkData=routerLSALinkData, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, arpInfoDestIp=arpInfoDestIp, ospfCumTxPkts=ospfCumTxPkts, ospfCumNbrDown=ospfCumNbrDown, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgBootpAddr=ipCurCfgBootpAddr, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, arpStatHighWater=arpStatHighWater, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, routeStatEntries=routeStatEntries, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfTxHello=ospfIntfTxHello, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfNbrInExchState=ospfNbrInExchState, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfLsTypesSupported=ospfLsTypesSupported, ripStats=ripStats, ospfTotalAreas=ospfTotalAreas, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, arpInfoFlag=arpInfoFlag, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, arpStats=arpStats, ospfIfWaitInterval=ospfIfWaitInterval, routerLSAId=routerLSAId, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaRxTxStats=ospfAreaRxTxStats, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ripStatInPkts=ripStatInPkts, ospfNbrInInitState=ospfNbrInInitState, ripNewCfgState=ripNewCfgState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgGwArp=ipCurCfgGwArp, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaInfoId=ospfAreaInfoId, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ip_info=ip_info, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, routeStats=routeStats, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfInfoEntry=ospfIntfInfoEntry, ripCurCfgListen=ripCurCfgListen, ripCurCfgDefListen=ripCurCfgDefListen, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipForward=ipForward, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfUnloop=ospfIntfUnloop, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfStats=ospfStats, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ripNewCfgVip=ripNewCfgVip, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCumTxlsReqs=ospfCumTxlsReqs, ipInterfaceTableMax=ipInterfaceTableMax, arpInfoEntry=arpInfoEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ripNewCfgSupply=ripNewCfgSupply, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgGwTable=ipNewCfgGwTable, routerLSALinkID=routerLSALinkID, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpStatInAdvers=vrrpStatInAdvers, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfArea=ospfArea, ospfCumIntfDown=ospfCumIntfDown, ospfCumIntfLoop=ospfCumIntfLoop, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgGwEntry=ipNewCfgGwEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpStats=vrrpStats, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaIntfLoop=ospfAreaIntfLoop, ipRouteInfoMask=ipRouteInfoMask, ospfIntfRxTxStats=ospfIntfRxTxStats, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfInterface=ospfInterface, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, dnsStats=dnsStats, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, iprouting=iprouting, ospfCumNbrStart=ospfCumNbrStart, ospfAreaTxHello=ospfAreaTxHello, ospfGeneralStats=ospfGeneralStats, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfNbrStart=ospfIntfNbrStart, ripCurCfgState=ripCurCfgState, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumRxHello=ospfCumRxHello, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpOper=vrrpOper, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipRouteInfoInterface=ipRouteInfoInterface, ripConfig=ripConfig, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaInfoEntry=ospfAreaInfoEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfinfo=ospfinfo, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgGwState=ipCurCfgGwState, ripStatOutPkts=ripStatOutPkts, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaNbrDown=ospfAreaNbrDown, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfHello=ospfIntfHello, ospfCumRxPkts=ospfCumRxPkts, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgGwState=ipNewCfgGwState, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipRouteInfoDestIp=ipRouteInfoDestIp, ipCurCfgIntfTable=ipCurCfgIntfTable, arpInfoSrcPort=arpInfoSrcPort, ipRouteInfoTable=ipRouteInfoTable, ripCurCfgVip=ripCurCfgVip, ospfCumRxTxStats=ospfCumRxTxStats, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfProcessUptime=ospfProcessUptime, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, arpInfoVLAN=arpInfoVLAN, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, arpInfoRefPorts=arpInfoRefPorts, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrp=vrrp, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfChangeStats=ospfIntfChangeStats, vrrpGeneral=vrrpGeneral, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfInfoTable=ospfIntfInfoTable, ipRouteInfoType=ipRouteInfoType, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgIntfState=ipNewCfgIntfState, ripCurCfgSupply=ripCurCfgSupply, arpInfoTable=arpInfoTable, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfIndex=ospfIntfIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfRxHello=ospfIntfRxHello, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfRxPkts=ospfIntfRxPkts, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfBackup=ospfIntfBackup, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCumIntfHello=ospfCumIntfHello, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgGwMetric=ipNewCfgGwMetric, ipRouteInfoGateway=ipRouteInfoGateway, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, arpStatEntries=arpStatEntries, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, routeStatHighWater=routeStatHighWater, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrp_info=vrrp_info, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfLoop=ospfIntfLoop, ospfNbrInFullState=ospfNbrInFullState, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIfInfoIndex=ospfIfInfoIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfGeneral=ospfGeneral)
