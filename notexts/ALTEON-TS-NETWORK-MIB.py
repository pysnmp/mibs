...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumRxPkts=ospfCumRxPkts, ospfIntfChangeStats=ospfIntfChangeStats, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaIntfDown=ospfAreaIntfDown, ospfStats=ospfStats, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIfTotalNeighbours=ospfIfTotalNeighbours, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipInterfaceTableMax=ipInterfaceTableMax, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumNbrN1way=ospfCumNbrN1way, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIfWaitInterval=ospfIfWaitInterval, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ripCurCfgListen=ripCurCfgListen, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgState=ipFwdCurCfgState, vrrp_info=vrrp_info, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipRouteInfoTag=ipRouteInfoTag, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfUnloop=ospfIntfUnloop, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumTxPkts=ospfCumTxPkts, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrp=vrrp, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumNbrStart=ospfCumNbrStart, ospfLsTypesSupported=ospfLsTypesSupported, ospfProcessUptime=ospfProcessUptime, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ip_info=ip_info, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, arpInfoDestIp=arpInfoDestIp, arpStatEntries=arpStatEntries, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ripCurCfgState=ripCurCfgState, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfLoop=ospfIntfLoop, ospfIfInfoIndex=ospfIfInfoIndex, routeStats=routeStats, ripNewCfgDefListen=ripNewCfgDefListen, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, arpStatHighWater=arpStatHighWater, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfTotalAreas=ospfTotalAreas, ospfGeneralInfo=ospfGeneralInfo, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipRouteInfoType=ipRouteInfoType, ospfIntfBackup=ospfIntfBackup, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ripCurCfgVip=ripCurCfgVip, ospfIntfRxTxStats=ospfIntfRxTxStats, routerLSAId=routerLSAId, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaRxHello=ospfAreaRxHello, ospfCumRxTxStats=ospfCumRxTxStats, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, arpInfoMacAddr=arpInfoMacAddr, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfNbrDown=ospfIntfNbrDown, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfNbrhello=ospfIntfNbrhello, arpStats=arpStats, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfinfo=ospfinfo, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipRouteInfoEntry=ipRouteInfoEntry, ospfCumNbrhello=ospfCumNbrhello, ospfAreaInfoTable=ospfAreaInfoTable, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfGeneral=ospfGeneral, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ripNewCfgSupply=ripNewCfgSupply, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgIntfDelete=ipNewCfgIntfDelete, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, routeStatHighWater=routeStatHighWater, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, arpInfoEntry=arpInfoEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfArea=ospfArea, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipRouteInfoInterface=ipRouteInfoInterface, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ripNewCfgState=ripNewCfgState, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCfg=ospfCfg, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfTotalNeighbours=ospfTotalNeighbours, ipRouteInfoIndx=ipRouteInfoIndx, iprouting=iprouting, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumIntfLoop=ospfCumIntfLoop, ospfStartTime=ospfStartTime, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, routeStatEntries=routeStatEntries, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgGwArp=ipCurCfgGwArp, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgIntfMask=ipCurCfgIntfMask, ipRouteInfoTable=ipRouteInfoTable, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCumRxHello=ospfCumRxHello, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaInfoId=ospfAreaInfoId, ospfIntfRxHello=ospfIntfRxHello, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, routerLSALinkID=routerLSALinkID, vrrpOper=vrrpOper, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgGwState=ipNewCfgGwState, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripStats=ripStats, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ripConfig=ripConfig, ospfIntfInfoEntry=ospfIntfInfoEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, routerLSALinkIndex=routerLSALinkIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipCurCfgGwEntry=ipCurCfgGwEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, routeStatMaxEntries=routeStatMaxEntries, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpGeneral=vrrpGeneral, ipForward=ipForward, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCumIntfDown=ospfCumIntfDown, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, dnsStats=dnsStats, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfDown=ospfIntfDown, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgGwState=ipCurCfgGwState, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfNbrInInitState=ospfNbrInInitState, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfInterface=ospfInterface, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpStatInAdvers=vrrpStatInAdvers, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfHello=ospfIntfHello, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ripStatInPkts=ripStatInPkts, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaTxHello=ospfAreaTxHello, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, arpInfoVLAN=arpInfoVLAN, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfTxDatabase=ospfIntfTxDatabase)
