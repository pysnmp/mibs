...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumTxPkts=ospfCumTxPkts, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgGwArp=ipCurCfgGwArp, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpStatInAdvers=vrrpStatInAdvers, ospfIfWaitInterval=ospfIfWaitInterval, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfIndex=ospfIntfIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfArea=ospfArea, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipGatewayTableMax=ipGatewayTableMax, ospfAreaRxTxStats=ospfAreaRxTxStats, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ripNewCfgVip=ripNewCfgVip, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfGeneral=ospfGeneral, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, arpInfoVLAN=arpInfoVLAN, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, routerLSALinkData=routerLSALinkData, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaInfoEntry=ospfAreaInfoEntry, routeStatMaxEntries=routeStatMaxEntries, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpOper=vrrpOper, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfHello=ospfIntfHello, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumRxHello=ospfCumRxHello, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, routeStats=routeStats, ripCurCfgListen=ripCurCfgListen, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipCurCfgIntfVlan=ipCurCfgIntfVlan, arpInfoEntry=arpInfoEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfStartTime=ospfStartTime, ospfAreaNbrIndex=ospfAreaNbrIndex, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaNbrStart=ospfAreaNbrStart, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgGwArp=ipNewCfgGwArp, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfNbrInExchState=ospfNbrInExchState, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgIntfEntry=ipCurCfgIntfEntry, arpInfoMacAddr=arpInfoMacAddr, ipRouteInfoType=ipRouteInfoType, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipCurCfgIntfAddr=ipCurCfgIntfAddr, arpStatEntries=arpStatEntries, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, arpStats=arpStats, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, routerLSALinkID=routerLSALinkID, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfTimersKickOffStats=ospfTimersKickOffStats, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipRouteInfoIndx=ipRouteInfoIndx, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, routerLSALinkIndex=routerLSALinkIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, arpInfoRefPorts=arpInfoRefPorts, ospfTotalNssaAreas=ospfTotalNssaAreas, ip_info=ip_info, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfNbrChange=ospfIntfNbrChange, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumNbrDown=ospfCumNbrDown, ipRouteInfoMask=ipRouteInfoMask, routerLSAId=routerLSAId, ospfCumRxPkts=ospfCumRxPkts, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfInterface=ospfInterface, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumTxDatabase=ospfCumTxDatabase, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaInfoId=ospfAreaInfoId, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, dnsStats=dnsStats, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfStats=ospfStats, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfGeneralInfo=ospfGeneralInfo, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipNewCfgGwState=ipNewCfgGwState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumRxTxStats=ospfCumRxTxStats, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaChangeStats=ospfAreaChangeStats, ospfinfo=ospfinfo, ospfAreaIntfBackup=ospfAreaIntfBackup, arpStatHighWater=arpStatHighWater, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaTxHello=ospfAreaTxHello, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaTxPkts=ospfAreaTxPkts, ripStatInPkts=ripStatInPkts, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfLsTypesSupported=ospfLsTypesSupported, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaRxTxIndex=ospfAreaRxTxIndex)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ripNewCfgListen=ripNewCfgListen, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCfg=ospfCfg, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, arpInfoFlag=arpInfoFlag, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaNbrN1way=ospfAreaNbrN1way, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrp=vrrp, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfLoop=ospfIntfLoop, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfDown=ospfIntfDown, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripCurCfgSupply=ripCurCfgSupply, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumNbrN1way=ospfCumNbrN1way, ospfNbrInFullState=ospfNbrInFullState, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripStats=ripStats, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ripCurCfgState=ripCurCfgState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, iprouting=iprouting, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumNbrStart=ospfCumNbrStart, ripNewCfgDefListen=ripNewCfgDefListen, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ripStatOutPkts=ripStatOutPkts, arpInfoTable=arpInfoTable, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpGeneral=vrrpGeneral, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfUnloop=ospfIntfUnloop, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, arpInfoDestIp=arpInfoDestIp, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumNbrhello=ospfCumNbrhello, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipForward=ipForward, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdCurCfgState=ipFwdCurCfgState, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgIntfTable=ipNewCfgIntfTable, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrp_info=vrrp_info, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumIntfUnloop=ospfCumIntfUnloop, ipCurCfgBootpState=ipCurCfgBootpState, ospfHostTableMaxSize=ospfHostTableMaxSize, ripNewCfgState=ripNewCfgState, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, arpInfoSrcPort=arpInfoSrcPort, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumIntfChangeStats=ospfCumIntfChangeStats, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfTxPkts=ospfIntfTxPkts, ripConfig=ripConfig, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumIntfLoop=ospfCumIntfLoop, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumRxDatabase=ospfCumRxDatabase, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaRxHello=ospfAreaRxHello, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfBackup=ospfIntfBackup, ipCurCfgIntfState=ipCurCfgIntfState, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpStats=vrrpStats, ipRouteInfoDestIp=ipRouteInfoDestIp)
