...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgGwState=ipCurCfgGwState, arpInfoEntry=arpInfoEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipInterfaceTableMax=ipInterfaceTableMax, ospfNbrInInitState=ospfNbrInInitState, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgBootpAddr=ipCurCfgBootpAddr, arpStatHighWater=arpStatHighWater, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumIntfNbrChange=ospfCumIntfNbrChange, routerLSAAreaIndex=routerLSAAreaIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, routeStats=routeStats, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, arpInfoDestIp=arpInfoDestIp, ripNewCfgSupply=ripNewCfgSupply, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipGatewayTableMax=ipGatewayTableMax, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaRxHello=ospfAreaRxHello, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIfWaitInterval=ospfIfWaitInterval, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfUnloop=ospfIntfUnloop, routeStatMaxEntries=routeStatMaxEntries, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfRxTxStats=ospfIntfRxTxStats, ipForward=ipForward, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaNbrStart=ospfAreaNbrStart, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaInfoId=ospfAreaInfoId, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipRouteInfoInterface=ipRouteInfoInterface, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfDown=ospfIntfDown, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumIntfDown=ospfCumIntfDown, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfinfo=ospfinfo, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfChangeStats=ospfIntfChangeStats, ipRouteInfoIndx=ipRouteInfoIndx, routeStatEntries=routeStatEntries, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaChangeStats=ospfAreaChangeStats, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfStats=ospfStats, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgGwAddr=ipNewCfgGwAddr, arpStats=arpStats, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpStats=vrrpStats, routerLSAId=routerLSAId, ipRouteInfoType=ipRouteInfoType, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripCurCfgSupply=ripCurCfgSupply, ospfCumNbrhello=ospfCumNbrhello, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaTxDatabase=ospfAreaTxDatabase, dnsStats=dnsStats, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpGeneral=vrrpGeneral, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipRouteInfoMask=ipRouteInfoMask, ospfIntfRxHello=ospfIntfRxHello, ospfIntfTxHello=ospfIntfTxHello, ospfGeneralStats=ospfGeneralStats, ripCurCfgDefListen=ripCurCfgDefListen, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipCurCfgGwArp=ipCurCfgGwArp, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumTxPkts=ospfCumTxPkts, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ip_info=ip_info, ripCurCfgVip=ripCurCfgVip, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumNbrStart=ospfCumNbrStart, ospfCumIntfHello=ospfCumIntfHello, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaRxPkts=ospfAreaRxPkts, ospfTotalAreas=ospfTotalAreas, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgIntfAddr=ipNewCfgIntfAddr, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ripStats=ripStats, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumIntfBackup=ospfCumIntfBackup, routeStatHighWater=routeStatHighWater)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, arpInfoSrcPort=arpInfoSrcPort, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpOper=vrrpOper, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, arpInfoTable=arpInfoTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripNewCfgStaticSupply=ripNewCfgStaticSupply, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, arpStatEntries=arpStatEntries, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfNbrStart=ospfIntfNbrStart, ripStatInPkts=ripStatInPkts, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumNbrDown=ospfCumNbrDown, ospfGeneralInfo=ospfGeneralInfo, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ripNewCfgListen=ripNewCfgListen, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, arpInfoFlag=arpInfoFlag, ospfIntfNbrChange=ospfIntfNbrChange, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgGenState=vrrpNewCfgGenState, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaNbrDown=ospfAreaNbrDown, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumRxPkts=ospfCumRxPkts, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfLoop=ospfIntfLoop, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfArea=ospfArea, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaTxlsReqs=ospfAreaTxlsReqs, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfStartTime=ospfStartTime, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumRxHello=ospfCumRxHello, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfHello=ospfIntfHello, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfBackup=ospfIntfBackup, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipRouteInfoDestIp=ipRouteInfoDestIp, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgBootpState=ipCurCfgBootpState, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ripStatOutPkts=ripStatOutPkts, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCfg=ospfCfg, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipNewCfgIntfDelete=ipNewCfgIntfDelete, arpInfoMacAddr=arpInfoMacAddr, iprouting=iprouting, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrp=vrrp, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrp_info=vrrp_info, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ripNewCfgState=ripNewCfgState, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipRouteInfoTable=ipRouteInfoTable, ripConfig=ripConfig, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry)
