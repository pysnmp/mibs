...
Gauge32, iso, IpAddress, Integer32, Counter64, ModuleIdentity, TimeTicks, NotificationType, MibIdentifier, Bits, Unsigned32, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "IpAddress", "Integer32", "Counter64", "ModuleIdentity", "TimeTicks", "NotificationType", "MibIdentifier", "Bits", "Unsigned32", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, arpStatHighWater=arpStatHighWater, ospfIntfNbrhello=ospfIntfNbrhello, arpInfoRefPorts=arpInfoRefPorts, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgIfTable=vrrpNewCfgIfTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipForward=ipForward, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfInterface=ospfInterface, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumNbrStart=ospfCumNbrStart, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, routeStats=routeStats, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfChangeStats=ospfIntfChangeStats, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumRxHello=ospfCumRxHello, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpOper=vrrpOper, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrp_info=vrrp_info, ipCurCfgGwMetric=ipCurCfgGwMetric, ripStats=ripStats, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfIndex=ospfIntfIndex, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ripStatInErrorPkts=ripStatInErrorPkts, ospfIfInfoIndex=ospfIfInfoIndex, dnsStats=dnsStats, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgBootpState=ipCurCfgBootpState, arpInfoVLAN=arpInfoVLAN, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaRxDatabase=ospfAreaRxDatabase, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumTxlsAcks=ospfCumTxlsAcks, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumTxDatabase=ospfCumTxDatabase, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, arpStatEntries=arpStatEntries, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ip_info=ip_info, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfStats=ospfStats, ospfIntfLoop=ospfIntfLoop, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaTxHello=ospfAreaTxHello, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipRouteInfoMask=ipRouteInfoMask, ripCurCfgVip=ripCurCfgVip, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, arpInfoFlag=arpInfoFlag, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfArea=ospfArea, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumIntfHello=ospfCumIntfHello, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfTxHello=ospfIntfTxHello, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaNbrIndex=ospfAreaNbrIndex, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaNbrStart=ospfAreaNbrStart, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ripCurCfgState=ripCurCfgState, vrrp=vrrp, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfinfo=ospfinfo, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, routeStatHighWater=routeStatHighWater, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ripNewCfgState=ripNewCfgState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfStartTime=ospfStartTime, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, arpStats=arpStats, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfBackup=ospfIntfBackup, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, arpInfoEntry=arpInfoEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfNbrChange=ospfIntfNbrChange, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpStatInAdvers=vrrpStatInAdvers, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgGwRetry=ipNewCfgGwRetry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfProcessUptime=ospfProcessUptime, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumRxTxStats=ospfCumRxTxStats, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipFwdNewCfgState=ipFwdNewCfgState, arpInfoTable=arpInfoTable, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaRxHello=ospfAreaRxHello, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgIntfState=ipCurCfgIntfState, ospfTotalNssaAreas=ospfTotalNssaAreas, arpStatMaxEntries=arpStatMaxEntries, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpStatOutAdvers=vrrpStatOutAdvers, ipRouteInfoType=ipRouteInfoType, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfGeneralStats=ospfGeneralStats, ospfCumNbrhello=ospfCumNbrhello, ospfIfWaitInterval=ospfIfWaitInterval, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdCurCfgState=ipFwdCurCfgState, ipRouteInfoTag=ipRouteInfoTag, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumTxPkts=ospfCumTxPkts, arpInfoSrcPort=arpInfoSrcPort, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipRouteInfoTable=ipRouteInfoTable, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, routeStatMaxEntries=routeStatMaxEntries, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfDown=ospfIntfDown, ripCurCfgDefListen=ripCurCfgDefListen, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCfg=ospfCfg, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ripStatOutPkts=ripStatOutPkts, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfUnloop=ospfIntfUnloop, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaInfoId=ospfAreaInfoId, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, arpInfoDestIp=arpInfoDestIp, ipNewCfgIntfMask=ipNewCfgIntfMask, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfTotalAreas=ospfTotalAreas, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaRxPkts=ospfAreaRxPkts, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpGeneral=vrrpGeneral, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaRxlsAcks=ospfAreaRxlsAcks, iprouting=iprouting, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumNbrN1way=ospfCumNbrN1way, ripConfig=ripConfig, routerLSALinkData=routerLSALinkData, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ripStatInPkts=ripStatInPkts, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfGeneral=ospfGeneral, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaInfoEntry=ospfAreaInfoEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, routeStatEntries=routeStatEntries, ospfAreaIntfHello=ospfAreaIntfHello, vrrpStats=vrrpStats, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfWaitTimer=ospfIntfWaitTimer)
