...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumRxDatabase=ospfCumRxDatabase, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, arpInfoSrcPort=arpInfoSrcPort, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, routerLSALinkID=routerLSALinkID, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripCurCfgVip=ripCurCfgVip, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfRxlsReqs=ospfIntfRxlsReqs, arpInfoMacAddr=arpInfoMacAddr, ripCurCfgListen=ripCurCfgListen, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCurCfgAreaId=ospfCurCfgAreaId, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ripNewCfgListen=ripNewCfgListen, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfTxDatabase=ospfIntfTxDatabase, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaRxTxStats=ospfAreaRxTxStats, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipCurCfgGwState=ipCurCfgGwState, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ripCurCfgSupply=ripCurCfgSupply, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumIntfHello=ospfCumIntfHello, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ripConfig=ripConfig, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrp=vrrp, ospfIntfBackup=ospfIntfBackup, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCfg=ospfCfg, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaTxPkts=ospfAreaTxPkts, arpInfoDestIp=arpInfoDestIp, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipInterfaceTableMax=ipInterfaceTableMax, ipForward=ipForward, ripStatInErrorPkts=ripStatInErrorPkts, routerLSAId=routerLSAId, ipCurCfgBootpState=ipCurCfgBootpState, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaRxHello=ospfAreaRxHello, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripNewCfgDefListen=ripNewCfgDefListen, ipCurCfgGwArp=ipCurCfgGwArp, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgGenState=vrrpNewCfgGenState, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumTxHello=ospfCumTxHello, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfNbrInFullState=ospfNbrInFullState, arpInfoEntry=arpInfoEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfInterface=ospfInterface, ospfCumNbrDown=ospfCumNbrDown, ospfinfo=ospfinfo, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpOper=vrrpOper, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, routerLSALinkIndex=routerLSALinkIndex, arpInfoTable=arpInfoTable, ipRouteInfoIndx=ipRouteInfoIndx, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipNewCfgGwAddr=ipNewCfgGwAddr, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumRxPkts=ospfCumRxPkts, ospfProcessUptime=ospfProcessUptime, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, routeStats=routeStats, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgGwVlan=ipNewCfgGwVlan, ripStats=ripStats, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumTxPkts=ospfCumTxPkts, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, routerLSALinkData=routerLSALinkData, vrrpStats=vrrpStats, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ip_info=ip_info, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipRouteInfoMask=ipRouteInfoMask, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipRouteInfoEntry=ipRouteInfoEntry, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdCurCfgState=ipFwdCurCfgState, routeStatHighWater=routeStatHighWater, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfStats=ospfStats, ospfIntfRxPkts=ospfIntfRxPkts, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaChangeStats=ospfAreaChangeStats, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfTxHello=ospfIntfTxHello, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipRouteInfoTag=ipRouteInfoTag, ospfIntfIndex=ospfIntfIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfNewCfgAreaId=ospfNewCfgAreaId, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgGwState=ipNewCfgGwState, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfTxlsAcks=ospfIntfTxlsAcks, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ripNewCfgVip=ripNewCfgVip, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpStatInAdvers=vrrpStatInAdvers, vrrpGeneral=vrrpGeneral, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumNbrStart=ospfCumNbrStart, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, iprouting=iprouting, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfTimersKickOffStats=ospfTimersKickOffStats, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipGatewayTableMax=ipGatewayTableMax, arpStats=arpStats, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfStartTime=ospfStartTime, ospfCumIntfDown=ospfCumIntfDown, routeStatEntries=routeStatEntries, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfArea=ospfArea, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumIntfBackup=ospfCumIntfBackup, ripCurCfgDefListen=ripCurCfgDefListen, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgIntfState=ipNewCfgIntfState, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgIntfVlan=ipCurCfgIntfVlan, arpInfoRefPorts=arpInfoRefPorts, ripStatInPkts=ripStatInPkts, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, arpStatMaxEntries=arpStatMaxEntries, ospfAreaNbrDown=ospfAreaNbrDown, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumTxlsReqs=ospfCumTxlsReqs, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfDown=ospfIntfDown, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgGwTable=ipNewCfgGwTable, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumRxHello=ospfCumRxHello, ospfGeneralStats=ospfGeneralStats, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgGwAddr=ipCurCfgGwAddr, ripCurCfgState=ripCurCfgState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaInfoId=ospfAreaInfoId, ospfIntfLoop=ospfIntfLoop, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, arpInfoFlag=arpInfoFlag, ospfIntfNbrStart=ospfIntfNbrStart, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfRxHello=ospfIntfRxHello, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfInfoTable=ospfIntfInfoTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfGeneral=ospfGeneral, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, dnsStats=dnsStats, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, arpStatHighWater=arpStatHighWater, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ripStatOutPkts=ripStatOutPkts, arpStatEntries=arpStatEntries, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripNewCfgState=ripNewCfgState, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod)
