...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfNbrStart=ospfIntfNbrStart, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ripCurCfgSupply=ripCurCfgSupply, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumNbrhello=ospfCumNbrhello, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumTxHello=ospfCumTxHello, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaInfoTable=ospfAreaInfoTable, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpStats=vrrpStats, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipCurCfgGwState=ipCurCfgGwState, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfArea=ospfArea, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumTxDatabase=ospfCumTxDatabase, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaIntfHello=ospfAreaIntfHello, arpInfoMacAddr=arpInfoMacAddr, routerLSALinkData=routerLSALinkData, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumRxTxStats=ospfCumRxTxStats, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgIntfAddr=ipNewCfgIntfAddr, dnsStats=dnsStats, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaRxDatabase=ospfAreaRxDatabase, ipRouteInfoInterface=ipRouteInfoInterface, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIfInfoIndex=ospfIfInfoIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfIndex=ospfIntfIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, arpInfoEntry=arpInfoEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumIntfHello=ospfCumIntfHello, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaChangeStats=ospfAreaChangeStats, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfTxPkts=ospfIntfTxPkts, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumTxPkts=ospfCumTxPkts, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaNbrhello=ospfAreaNbrhello, ospfNewCfgAreaId=ospfNewCfgAreaId, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, arpInfoDestIp=arpInfoDestIp, vrrpOper=vrrpOper, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaTxHello=ospfAreaTxHello, ospfGeneralInfo=ospfGeneralInfo, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ripCurCfgListen=ripCurCfgListen, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ripNewCfgListen=ripNewCfgListen, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrp=vrrp, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, arpStatEntries=arpStatEntries, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipCurCfgBootpState=ipCurCfgBootpState, routerLSALinkID=routerLSALinkID, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpGeneral=vrrpGeneral, ripCurCfgState=ripCurCfgState, ospfCumRxHello=ospfCumRxHello, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaInfoIndex=ospfAreaInfoIndex, routeStatMaxEntries=routeStatMaxEntries, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripNewCfgSupply=ripNewCfgSupply, iprouting=iprouting, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaIntfDown=ospfAreaIntfDown, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaRxHello=ospfAreaRxHello, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfTotalAreas=ospfTotalAreas, ipInterfaceTableMax=ipInterfaceTableMax, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfRxDatabase=ospfIntfRxDatabase, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgGwTable=ipCurCfgGwTable, routeStatHighWater=routeStatHighWater, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaInfoId=ospfAreaInfoId, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfinfo=ospfinfo, ospfCumNbrStart=ospfCumNbrStart, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumTxlsReqs=ospfCumTxlsReqs, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgBootpState=ipNewCfgBootpState, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, arpStats=arpStats, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ripNewCfgVip=ripNewCfgVip, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgIntfEntry=ipCurCfgIntfEntry, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumIntfDown=ospfCumIntfDown, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfBackup=ospfIntfBackup, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfUnloop=ospfIntfUnloop, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ripStats=ripStats, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, routeStatEntries=routeStatEntries, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfStats=ospfStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfRxPkts=ospfIntfRxPkts, ospfNbrInInitState=ospfNbrInInitState, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, routerLSAId=routerLSAId, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfDown=ospfIntfDown, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgGwTable=ipNewCfgGwTable, ospfNbrInExchState=ospfNbrInExchState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfHello=ospfIntfHello, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ip_info=ip_info, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfNbrDown=ospfIntfNbrDown, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipForward=ipForward, ospfInterface=ospfInterface, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripConfig=ripConfig, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIfWaitInterval=ospfIfWaitInterval, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, arpStatMaxEntries=arpStatMaxEntries, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumNbrDown=ospfCumNbrDown, ripNewCfgState=ripNewCfgState, ipFwdCurCfgState=ipFwdCurCfgState, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipRouteInfoTable=ipRouteInfoTable, ospfGeneral=ospfGeneral, vrrpNewCfgGenState=vrrpNewCfgGenState, ripCurCfgVip=ripCurCfgVip, ospfStartTime=ospfStartTime, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipNewCfgGwEntry=ipNewCfgGwEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, arpStatHighWater=arpStatHighWater, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgIntfDelete=ipNewCfgIntfDelete, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, routeStats=routeStats, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIfInfoIpAddress=ospfIfInfoIpAddress, arpInfoVLAN=arpInfoVLAN, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ripStatInPkts=ripStatInPkts, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ripStatOutPkts=ripStatOutPkts, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaRxlsAcks=ospfAreaRxlsAcks, arpInfoFlag=arpInfoFlag, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize)
