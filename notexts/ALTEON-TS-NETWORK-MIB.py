...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumIntfHello=ospfCumIntfHello, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgBootpState=ipCurCfgBootpState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipRouteInfoDestIp=ipRouteInfoDestIp, routerLSAId=routerLSAId, arpInfoTable=arpInfoTable, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaChangeStats=ospfAreaChangeStats, ripStatInPkts=ripStatInPkts, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaRxTxIndex=ospfAreaRxTxIndex, routeStats=routeStats, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipRouteInfoTag=ipRouteInfoTag, ripNewCfgListen=ripNewCfgListen, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipRouteInfoMask=ipRouteInfoMask, ospfNbrInInitState=ospfNbrInInitState, ospfIntfBackup=ospfIntfBackup, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipCurCfgGwTable=ipCurCfgGwTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgIntfTable=ipCurCfgIntfTable, arpStatMaxEntries=arpStatMaxEntries, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumNbrhello=ospfCumNbrhello, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfChangeStats=ospfIntfChangeStats, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfDown=ospfIntfDown, ospfProcessUptime=ospfProcessUptime, ipRouteInfoGateway=ipRouteInfoGateway, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ip_info=ip_info, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumIntfDown=ospfCumIntfDown, dnsStats=dnsStats, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumTxDatabase=ospfCumTxDatabase, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfNbrN1way=ospfIntfNbrN1way, arpStatHighWater=arpStatHighWater, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfGeneralStats=ospfGeneralStats, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaRxHello=ospfAreaRxHello, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ripNewCfgSupply=ripNewCfgSupply, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ripStatOutPkts=ripStatOutPkts, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipNewCfgIntfState=ipNewCfgIntfState, ospfTotalAreas=ospfTotalAreas, ripStats=ripStats, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaTxHello=ospfAreaTxHello, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfTxDatabase=ospfIntfTxDatabase, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumRxTxStats=ospfCumRxTxStats, routerLSALinkData=routerLSALinkData, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfLsTypesSupported=ospfLsTypesSupported, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, arpStats=arpStats, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumRxlsAcks=ospfCumRxlsAcks, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumTxHello=ospfCumTxHello, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumNbrDown=ospfCumNbrDown, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumRxPkts=ospfCumRxPkts, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfNbrInExchState=ospfNbrInExchState, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfUnloop=ospfIntfUnloop, ospfStartTime=ospfStartTime, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfInfoEntry=ospfIntfInfoEntry, arpInfoRefPorts=arpInfoRefPorts, routerLSAAreaIndex=routerLSAAreaIndex, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumTxlsUpdates=ospfCumTxlsUpdates, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrDown=ospfIntfNbrDown, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumRxDatabase=ospfCumRxDatabase, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumRxHello=ospfCumRxHello, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfinfo=ospfinfo, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, routerLSALinkID=routerLSALinkID)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfTotalNeighbours=ospfTotalNeighbours, ripConfig=ripConfig, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfTxHello=ospfIntfTxHello, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, routeStatEntries=routeStatEntries, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgGwArp=ipCurCfgGwArp, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, routeStatHighWater=routeStatHighWater, arpInfoVLAN=arpInfoVLAN, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipNewCfgGwTable=ipNewCfgGwTable, ospfGeneral=ospfGeneral, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, arpInfoDestIp=arpInfoDestIp, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfIndex=ospfIntfIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipRouteInfoType=ipRouteInfoType, ospfAreaNbrDown=ospfAreaNbrDown, iprouting=iprouting, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfInterface=ospfInterface, ipCurCfgGwMetric=ipCurCfgGwMetric, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrp_info=vrrp_info, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ripCurCfgListen=ripCurCfgListen, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumTxPkts=ospfCumTxPkts, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumIntfBackup=ospfCumIntfBackup, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgGwState=ipCurCfgGwState, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfTotalTransitAreas=ospfTotalTransitAreas, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipForward=ipForward, ospfStats=ospfStats, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumNbrStart=ospfCumNbrStart, ospfCumNbrN1way=ospfCumNbrN1way, arpInfoEntry=arpInfoEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaNbrhello=ospfAreaNbrhello, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaRxPkts=ospfAreaRxPkts, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipFwdNewCfgPortState=ipFwdNewCfgPortState, arpStatEntries=arpStatEntries, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpOper=vrrpOper, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrp=vrrp, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfRxHello=ospfIntfRxHello, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ripCurCfgState=ripCurCfgState, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfArea=ospfArea, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ripNewCfgVip=ripNewCfgVip, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv)
