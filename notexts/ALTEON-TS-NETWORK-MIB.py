...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfTxPkts=ospfIntfTxPkts, arpInfoSrcPort=arpInfoSrcPort, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, routeStatHighWater=routeStatHighWater, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumRxPkts=ospfCumRxPkts, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipRouteInfoType=ipRouteInfoType, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfGeneralInfo=ospfGeneralInfo, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumRxHello=ospfCumRxHello, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipRouteInfoTag=ipRouteInfoTag, dnsStats=dnsStats, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumNbrhello=ospfCumNbrhello, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfNbrhello=ospfIntfNbrhello, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumNbrN1way=ospfCumNbrN1way, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaInfoTable=ospfAreaInfoTable, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, routerLSAId=routerLSAId, ripStatRoutesAgedOut=ripStatRoutesAgedOut, routeStats=routeStats, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfRxlsAcks=ospfIntfRxlsAcks, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgGwAddr=ipCurCfgGwAddr, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfProcessUptime=ospfProcessUptime, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaNbrhello=ospfAreaNbrhello, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaRxHello=ospfAreaRxHello, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfNbrInExchState=ospfNbrInExchState, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfTxlsReqs=ospfIntfTxlsReqs, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpStatInAdvers=vrrpStatInAdvers, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpGeneral=vrrpGeneral, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaRxPkts=ospfAreaRxPkts, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumIntfHello=ospfCumIntfHello, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgGwAddr=ipNewCfgGwAddr, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgIntfMask=ipNewCfgIntfMask, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfStartTime=ospfStartTime, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, routerLSALinkData=routerLSALinkData, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgGenState=vrrpCurCfgGenState, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipCurCfgBootpState=ipCurCfgBootpState, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ripStatOutPkts=ripStatOutPkts, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfTotalAreas=ospfTotalAreas, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfGeneralStats=ospfGeneralStats, vrrp=vrrp, ripStatInPkts=ripStatInPkts, ip_info=ip_info, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfDown=ospfIntfDown, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgGwTable=ipNewCfgGwTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, iprouting=iprouting, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipFwdNewCfgPortState=ipFwdNewCfgPortState, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfinfo=ospfinfo)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgGwMetric=ipCurCfgGwMetric, ripNewCfgVip=ripNewCfgVip, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIfWaitInterval=ospfIfWaitInterval, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfHello=ospfIntfHello, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, arpInfoVLAN=arpInfoVLAN, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ripStats=ripStats, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfUnloop=ospfIntfUnloop, ripNewCfgState=ripNewCfgState, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ripNewCfgSupply=ripNewCfgSupply, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaInfoEntry=ospfAreaInfoEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, arpInfoMacAddr=arpInfoMacAddr, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfRxDatabase=ospfIntfRxDatabase, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipNewCfgGwState=ipNewCfgGwState, arpInfoEntry=arpInfoEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, arpStats=arpStats, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfRxHello=ospfIntfRxHello, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfStats=ospfStats, ripConfig=ripConfig, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfInterface=ospfInterface, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfRxPkts=ospfIntfRxPkts, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, routerLSALinkID=routerLSALinkID, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumIntfBackup=ospfCumIntfBackup, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipRouteInfoEntry=ipRouteInfoEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumRxlsUpdates=ospfCumRxlsUpdates, routeStatEntries=routeStatEntries, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipCurCfgGwState=ipCurCfgGwState, ipForward=ipForward, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumNbrDown=ospfCumNbrDown, ospfCumIntfDown=ospfCumIntfDown, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, arpInfoDestIp=arpInfoDestIp, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgIfTable=vrrpCurCfgIfTable, arpStatEntries=arpStatEntries, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCumTxPkts=ospfCumTxPkts, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfInfoTable=ospfIntfInfoTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrp_info=vrrp_info, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ripCurCfgVip=ripCurCfgVip, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipGatewayTableMax=ipGatewayTableMax, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpOper=vrrpOper, ripNewCfgListen=ripNewCfgListen, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumTxlsReqs=ospfCumTxlsReqs, ripCurCfgListen=ripCurCfgListen, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfBackup=ospfIntfBackup, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfArea=ospfArea, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumRxDatabase=ospfCumRxDatabase, ospfGeneral=ospfGeneral, vrrpStats=vrrpStats)
