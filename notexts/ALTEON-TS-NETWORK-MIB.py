...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, routeStatEntries=routeStatEntries, ospfTotalNssaAreas=ospfTotalNssaAreas, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, routerLSALinkData=routerLSALinkData, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, arpInfoDestIp=arpInfoDestIp, ipNewCfgGwDelete=ipNewCfgGwDelete, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpGeneral=vrrpGeneral, ospfIntfLoop=ospfIntfLoop, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaNbrDown=ospfAreaNbrDown, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumIntfBackup=ospfCumIntfBackup, arpInfoRefPorts=arpInfoRefPorts, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIfWaitInterval=ospfIfWaitInterval, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ripNewCfgVip=ripNewCfgVip, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfChangeStats=ospfIntfChangeStats, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfinfo=ospfinfo, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipRouteInfoTag=ipRouteInfoTag, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ripCurCfgSupply=ripCurCfgSupply, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, routeStats=routeStats, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfRxHello=ospfIntfRxHello, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfProcessUptime=ospfProcessUptime, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, arpStatEntries=arpStatEntries, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumTxPkts=ospfCumTxPkts, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumRxPkts=ospfCumRxPkts, ospfIntfHello=ospfIntfHello, ospfIntfIndex=ospfIntfIndex, arpInfoMacAddr=arpInfoMacAddr, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfStats=ospfStats, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfGeneral=ospfGeneral, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, routeStatHighWater=routeStatHighWater, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ripNewCfgDefListen=ripNewCfgDefListen, ip_info=ip_info, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipRouteInfoEntry=ipRouteInfoEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, iprouting=iprouting, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaRxHello=ospfAreaRxHello, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipGatewayTableMax=ipGatewayTableMax, ospfIntfTxPkts=ospfIntfTxPkts, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, dnsStats=dnsStats, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfInterface=ospfInterface, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripConfig=ripConfig, ripStats=ripStats, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, routerLSALinkID=routerLSALinkID, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipRouteInfoInterface=ipRouteInfoInterface, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpStats=vrrpStats, arpInfoEntry=arpInfoEntry, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfTotalAreas=ospfTotalAreas, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdCurCfgState=ipFwdCurCfgState, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgIntfState=ipNewCfgIntfState, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrp=vrrp, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfArea=ospfArea, ospfCumIntfLoop=ospfCumIntfLoop, arpInfoVLAN=arpInfoVLAN, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgGwMetric=ipNewCfgGwMetric)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaNbrN1way=ospfAreaNbrN1way, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfNbrInFullState=ospfNbrInFullState, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, arpStatHighWater=arpStatHighWater, ipForward=ipForward, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgGenState=vrrpNewCfgGenState, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCfg=ospfCfg, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ripStatInErrorPkts=ripStatInErrorPkts, routerLSALinkIfIndex=routerLSALinkIfIndex, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaNbrhello=ospfAreaNbrhello, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumIntfUnloop=ospfCumIntfUnloop, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfStartTime=ospfStartTime, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ripCurCfgState=ripCurCfgState, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfTableMaxSize=ospfIntfTableMaxSize, arpInfoSrcPort=arpInfoSrcPort, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, routeStatMaxEntries=routeStatMaxEntries, arpStats=arpStats, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaInfoEntry=ospfAreaInfoEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfBackup=ospfIntfBackup, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaChangeStats=ospfAreaChangeStats, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipRouteInfoGateway=ipRouteInfoGateway, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfHostTableMaxSize=ospfHostTableMaxSize, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaNbrIndex=ospfAreaNbrIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfLsTypesSupported=ospfLsTypesSupported, arpInfoTable=arpInfoTable, ipNewCfgIntfTable=ipNewCfgIntfTable, ripStatOutPkts=ripStatOutPkts, ipNewCfgGwRetry=ipNewCfgGwRetry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumNbrDown=ospfCumNbrDown, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfCountForRouter=ospfIntfCountForRouter, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgGwTable=ipCurCfgGwTable, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgGwState=ipNewCfgGwState, ospfIntfRxTxStats=ospfIntfRxTxStats, ripStatInPkts=ripStatInPkts, ospfGeneralInfo=ospfGeneralInfo, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgGwState=ipCurCfgGwState, ospfAreaNbrStart=ospfAreaNbrStart, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfNbrhello=ospfIntfNbrhello, routerLSAId=routerLSAId, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgGwArp=ipNewCfgGwArp)
