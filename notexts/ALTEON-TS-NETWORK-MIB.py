...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaInfoId=ospfAreaInfoId, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaTableMaxSize=ospfAreaTableMaxSize, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, routerLSAId=routerLSAId, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfIndex=ospfIntfIndex, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ripNewCfgSupply=ripNewCfgSupply, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfRxPkts=ospfIntfRxPkts, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfGeneral=ospfGeneral, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfUnloop=ospfIntfUnloop, ipFwdNewCfgPortState=ipFwdNewCfgPortState, dnsStats=dnsStats, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfRxlsAcks=ospfIntfRxlsAcks, routeStats=routeStats, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, arpStats=arpStats, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumNbrDown=ospfCumNbrDown, routeStatMaxEntries=routeStatMaxEntries, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrp_info=vrrp_info, arpStatHighWater=arpStatHighWater, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaTxHello=ospfAreaTxHello, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ripCurCfgSupply=ripCurCfgSupply, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaIntfHello=ospfAreaIntfHello, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipRouteInfoTag=ipRouteInfoTag, ipRouteInfoGateway=ipRouteInfoGateway, ospfArea=ospfArea, ospfIntfLoop=ospfIntfLoop, arpInfoEntry=arpInfoEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfNbrInExchState=ospfNbrInExchState, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaRxHello=ospfAreaRxHello, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipGatewayTableMax=ipGatewayTableMax, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfChangeStats=ospfIntfChangeStats, ipRouteInfoMask=ipRouteInfoMask, ospfIntfRxHello=ospfIntfRxHello, ospfCumRxDatabase=ospfCumRxDatabase, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfBackup=ospfIntfBackup, ripStats=ripStats, routerLSALinkIfIndex=routerLSALinkIfIndex, ripStatInPkts=ripStatInPkts, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumTxlsAcks=ospfCumTxlsAcks, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgGwTable=ipNewCfgGwTable, ospfTotalTransitAreas=ospfTotalTransitAreas, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgGwAddr=ipNewCfgGwAddr, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumNbrhello=ospfCumNbrhello, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ripStatInErrorPkts=ripStatInErrorPkts, ripNewCfgState=ripNewCfgState, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ripNewCfgDefListen=ripNewCfgDefListen, ospfGeneralStats=ospfGeneralStats, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgGwInterval=ipCurCfgGwInterval, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaRxTxIndex=ospfAreaRxTxIndex, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, routerLSALinkID=routerLSALinkID, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumRxTxStats=ospfCumRxTxStats, ospfProcessUptime=ospfProcessUptime, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgGwState=ipCurCfgGwState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfinfo=ospfinfo, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgGenState=vrrpCurCfgGenState, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpGeneral=vrrpGeneral, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCfg=ospfCfg, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipRouteInfoType=ipRouteInfoType, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumRxPkts=ospfCumRxPkts, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfTxHello=ospfIntfTxHello, routeStatEntries=routeStatEntries, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpOper=vrrpOper, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfStats=ospfStats)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCurCfgAreaId=ospfCurCfgAreaId, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumIntfLoop=ospfCumIntfLoop, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, routerLSALinkIndex=routerLSALinkIndex, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipRouteInfoInterface=ipRouteInfoInterface, vrrpStats=vrrpStats, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, arpStatEntries=arpStatEntries, arpInfoMacAddr=arpInfoMacAddr, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumTxPkts=ospfCumTxPkts, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfDown=ospfIntfDown, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, iprouting=iprouting, routerLSALinkData=routerLSALinkData, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgGwTable=ipCurCfgGwTable, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ripCurCfgListen=ripCurCfgListen, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripNewCfgStaticSupply=ripNewCfgStaticSupply, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumRxHello=ospfCumRxHello, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumTxHello=ospfCumTxHello, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ip_info=ip_info, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, routeStatHighWater=routeStatHighWater, arpInfoTable=arpInfoTable, ospfTimersKickOffStats=ospfTimersKickOffStats, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, arpStatMaxEntries=arpStatMaxEntries, ospfCumRxlsReqs=ospfCumRxlsReqs, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfNbrInInitState=ospfNbrInInitState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, arpInfoSrcPort=arpInfoSrcPort, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgGwArp=ipNewCfgGwArp, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfInterface=ospfInterface, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfTotalAreas=ospfTotalAreas, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfInfoTable=ospfIntfInfoTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ripConfig=ripConfig, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumIntfHello=ospfCumIntfHello, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, arpInfoVLAN=arpInfoVLAN, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaNbrStart=ospfAreaNbrStart, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfStartTime=ospfStartTime, vrrpStatInAdvers=vrrpStatInAdvers, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ripCurCfgState=ripCurCfgState, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipForward=ipForward, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfNbrhello=ospfIntfNbrhello, vrrp=vrrp, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgIntfState=ipNewCfgIntfState)
