...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfProcessUptime=ospfProcessUptime, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCfg=ospfCfg, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, arpStatEntries=arpStatEntries, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, routerLSALinkIfIndex=routerLSALinkIfIndex, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfTxHello=ospfIntfTxHello, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfNbrIndex=ospfIntfNbrIndex, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipGatewayTableMax=ipGatewayTableMax, vrrpOper=vrrpOper, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfInterface=ospfInterface, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, arpInfoSrcPort=arpInfoSrcPort, routeStatEntries=routeStatEntries, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaIntfBackup=ospfAreaIntfBackup, routeStatMaxEntries=routeStatMaxEntries, arpStatMaxEntries=arpStatMaxEntries, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipCurCfgIntfTable=ipCurCfgIntfTable, arpInfoMacAddr=arpInfoMacAddr, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, arpStats=arpStats, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfRxHello=ospfIntfRxHello, ospfAreaNbrDown=ospfAreaNbrDown, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfInfoTable=ospfIntfInfoTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumIntfDown=ospfCumIntfDown, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ripCurCfgSupply=ripCurCfgSupply, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfinfo=ospfinfo, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, dnsStats=dnsStats, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumRxPkts=ospfCumRxPkts, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumTxHello=ospfCumTxHello, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaTxHello=ospfAreaTxHello, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfUnloop=ospfIntfUnloop, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfNbrStart=ospfIntfNbrStart, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, iprouting=iprouting, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumRxTxStats=ospfCumRxTxStats, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrp=vrrp, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfArea=ospfArea, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgGwAddr=ipNewCfgGwAddr, routeStatHighWater=routeStatHighWater, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaIntfDown=ospfAreaIntfDown, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaRxHello=ospfAreaRxHello, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpGeneral=vrrpGeneral, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipRouteInfoMask=ipRouteInfoMask, ospfStartTime=ospfStartTime, ip_info=ip_info, ripConfig=ripConfig, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgIntfState=ipCurCfgIntfState, ospfGeneralInfo=ospfGeneralInfo, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, arpInfoDestIp=arpInfoDestIp, ospfIntfWaitTimer=ospfIntfWaitTimer, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgGenState=vrrpNewCfgGenState, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ripStatInPkts=ripStatInPkts, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, ripNewCfgListen=ripNewCfgListen, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfNbrChange=ospfIntfNbrChange, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfChangeStats=ospfIntfChangeStats, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, arpInfoVLAN=arpInfoVLAN, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfLoop=ospfIntfLoop, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripNewCfgVip=ripNewCfgVip, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgGwVlan=ipCurCfgGwVlan, ripStatOutPkts=ripStatOutPkts, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripStats=ripStats, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaIntfHello=ospfAreaIntfHello, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, routeStats=routeStats, ospfCumRxlsAcks=ospfCumRxlsAcks, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpStats=vrrpStats, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfNbrInInitState=ospfNbrInInitState, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipRouteInfoType=ipRouteInfoType, arpInfoTable=arpInfoTable, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfRxPkts=ospfIntfRxPkts, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, arpInfoFlag=arpInfoFlag, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipRouteInfoTable=ipRouteInfoTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipForward=ipForward, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfBackup=ospfIntfBackup, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfHello=ospfIntfHello, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfGeneral=ospfGeneral, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaChangeStats=ospfAreaChangeStats, ipNewCfgIntfState=ipNewCfgIntfState, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgGwMetric=ipNewCfgGwMetric, ripNewCfgSupply=ripNewCfgSupply, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgGwArp=ipCurCfgGwArp, ripCurCfgVip=ripCurCfgVip, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaTxPkts=ospfAreaTxPkts, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfTxDatabase=ospfIntfTxDatabase, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, arpInfoEntry=arpInfoEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaInfoId=ospfAreaInfoId, ospfCumRxHello=ospfCumRxHello, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumNbrN1way=ospfCumNbrN1way, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, arpStatHighWater=arpStatHighWater, ospfIntfNbrhello=ospfIntfNbrhello, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumNbrStart=ospfCumNbrStart, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfStats=ospfStats, ripCurCfgListen=ripCurCfgListen, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrp_info=vrrp_info, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ripNewCfgDefListen=ripNewCfgDefListen, ipCurCfgGwState=ipCurCfgGwState, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfDown=ospfIntfDown, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgIntfAddr=ipNewCfgIntfAddr, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfTotalAreas=ospfTotalAreas)
