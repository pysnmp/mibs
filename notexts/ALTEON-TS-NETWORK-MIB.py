...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaTxDatabase=ospfAreaTxDatabase, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpGeneral=vrrpGeneral, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, arpInfoVLAN=arpInfoVLAN, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumNbrRstAd=ospfCumNbrRstAd, ipRouteInfoTag=ipRouteInfoTag, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfDown=ospfIntfDown, ipRouteInfoType=ipRouteInfoType, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfinfo=ospfinfo, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpOper=vrrpOper, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripNewCfgListen=ripNewCfgListen, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaNbrhello=ospfAreaNbrhello, ospfTotalTransitAreas=ospfTotalTransitAreas, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfBackup=ospfIntfBackup, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipNewCfgGwRetry=ipNewCfgGwRetry, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfIndex=ospfIntfIndex, ospfArea=ospfArea, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaTableMaxSize=ospfAreaTableMaxSize, arpStats=arpStats, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, arpInfoTable=arpInfoTable, iprouting=iprouting, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ripStatInPkts=ripStatInPkts, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaRxHello=ospfAreaRxHello, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumTxHello=ospfCumTxHello, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaInfoId=ospfAreaInfoId, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfGeneral=ospfGeneral, ip_info=ip_info, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaTxHello=ospfAreaTxHello, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaInfoEntry=ospfAreaInfoEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrp=vrrp, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, arpStatHighWater=arpStatHighWater, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfRxHello=ospfIntfRxHello, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgGwState=ipNewCfgGwState, ipFwdNewCfgState=ipFwdNewCfgState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfNbrDown=ospfIntfNbrDown, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgIntfState=ipCurCfgIntfState, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumTxDatabase=ospfCumTxDatabase, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgBootpState=ipNewCfgBootpState, ospfGeneralInfo=ospfGeneralInfo, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, routeStatMaxEntries=routeStatMaxEntries, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfTxHello=ospfIntfTxHello, ospfStartTime=ospfStartTime, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrChange=ospfIntfNbrChange, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaIntfLoop=ospfAreaIntfLoop, routeStatEntries=routeStatEntries, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCurCfgAreaId=ospfCurCfgAreaId, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgGenState=vrrpNewCfgGenState, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgGwTable=ipNewCfgGwTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipInterfaceTableMax=ipInterfaceTableMax, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ripNewCfgVip=ripNewCfgVip, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, routerLSALinkID=routerLSALinkID, ospfCumRxPkts=ospfCumRxPkts, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpStatOutAdvers=vrrpStatOutAdvers)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumRxHello=ospfCumRxHello, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipFwdCurCfgState=ipFwdCurCfgState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCfg=ospfCfg, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ripStatOutPkts=ripStatOutPkts, ospfAreaIntfUnloop=ospfAreaIntfUnloop, routeStats=routeStats, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfCountForRouter=ospfIntfCountForRouter, ripStats=ripStats, ripCurCfgListen=ripCurCfgListen, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfHello=ospfIntfHello, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfStats=ospfStats, ospfNbrInExchState=ospfNbrInExchState, arpInfoFlag=arpInfoFlag, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaInfoTable=ospfAreaInfoTable, ipRouteInfoTable=ipRouteInfoTable, ripNewCfgSupply=ripNewCfgSupply, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaTxPkts=ospfAreaTxPkts, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumIntfLoop=ospfCumIntfLoop, ipRouteInfoInterface=ipRouteInfoInterface, routerLSALinkData=routerLSALinkData, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaNbrStart=ospfAreaNbrStart, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, arpStatMaxEntries=arpStatMaxEntries, arpStatEntries=arpStatEntries, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfTableMaxSize=ospfIntfTableMaxSize, arpInfoEntry=arpInfoEntry, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ripCurCfgVip=ripCurCfgVip, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfNbrhello=ospfIntfNbrhello, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumTxPkts=ospfCumTxPkts, ospfAreaRxPkts=ospfAreaRxPkts, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ripCurCfgSupply=ripCurCfgSupply, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ripNewCfgState=ripNewCfgState, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaInfoIndex=ospfAreaInfoIndex, routerLSALinkIndex=routerLSALinkIndex, vrrp_info=vrrp_info, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfTotalNssaAreas=ospfTotalNssaAreas, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfNbrN1way=ospfIntfNbrN1way, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfNbrInFullState=ospfNbrInFullState, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipForward=ipForward, ospfIntfTxlsAcks=ospfIntfTxlsAcks, dnsStats=dnsStats, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ripConfig=ripConfig, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipNewCfgGwInterval=ipNewCfgGwInterval, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval)
