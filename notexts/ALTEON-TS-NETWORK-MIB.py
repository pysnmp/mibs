...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCfg=ospfCfg, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIfWaitInterval=ospfIfWaitInterval, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfIndex=ospfIntfIndex, vrrpOper=vrrpOper, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipRouteInfoGateway=ipRouteInfoGateway, ospfNbrInFullState=ospfNbrInFullState, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfStartTime=ospfStartTime, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipForward=ipForward, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumRxlsAcks=ospfCumRxlsAcks, ipInterfaceTableMax=ipInterfaceTableMax, ospfGeneralStats=ospfGeneralStats, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfLoop=ospfIntfLoop, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrp=vrrp, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumTxlsAcks=ospfCumTxlsAcks, arpStatHighWater=arpStatHighWater, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, routeStats=routeStats, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumRxTxStats=ospfCumRxTxStats, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgGwIndex=ipCurCfgGwIndex, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, routeStatEntries=routeStatEntries, ospfAreaIntfDown=ospfAreaIntfDown, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfTotalAreas=ospfTotalAreas, routerLSALinkIndex=routerLSALinkIndex, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, dnsStats=dnsStats, ipRouteInfoTag=ipRouteInfoTag, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, routerLSAAreaIndex=routerLSAAreaIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaInfoEntry=ospfAreaInfoEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaTxlsReqs=ospfAreaTxlsReqs, routerLSAId=routerLSAId, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ripStatRoutesAgedOut=ripStatRoutesAgedOut, arpStats=arpStats, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfHello=ospfIntfHello, iprouting=iprouting, ospfAreaRxHello=ospfAreaRxHello, ospfCumIntfHello=ospfCumIntfHello, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfStats=ospfStats, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ripCurCfgDefListen=ripCurCfgDefListen, arpInfoFlag=arpInfoFlag, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaTxHello=ospfAreaTxHello, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaNbrIndex=ospfAreaNbrIndex, ip_info=ip_info, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ripCurCfgVip=ripCurCfgVip, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumIntfLoop=ospfCumIntfLoop, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ripNewCfgVip=ripNewCfgVip, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumIntfUnloop=ospfCumIntfUnloop, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumNbrN1way=ospfCumNbrN1way, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfArea=ospfArea, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpStats=vrrpStats, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumIntfDown=ospfCumIntfDown, arpInfoTable=arpInfoTable, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaNbrhello=ospfAreaNbrhello, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, arpStatMaxEntries=arpStatMaxEntries, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgGwState=ipNewCfgGwState, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ripStatInPkts=ripStatInPkts, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipRouteInfoType=ipRouteInfoType, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaIntfHello=ospfAreaIntfHello, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumNbrRstAd=ospfCumNbrRstAd, arpInfoMacAddr=arpInfoMacAddr, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgGwState=ipCurCfgGwState, ospfProcessUptime=ospfProcessUptime, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipNewCfgIntfState=ipNewCfgIntfState, routeStatHighWater=routeStatHighWater, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfRxTxStats=ospfIntfRxTxStats, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumNbrhello=ospfCumNbrhello, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipRouteInfoDestIp=ipRouteInfoDestIp, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfGeneralInfo=ospfGeneralInfo, ripNewCfgListen=ripNewCfgListen, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumNbrDown=ospfCumNbrDown, ripConfig=ripConfig, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgGwArp=ipCurCfgGwArp, arpInfoRefPorts=arpInfoRefPorts, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ripStatOutPkts=ripStatOutPkts, ripNewCfgState=ripNewCfgState, ipRouteInfoMask=ipRouteInfoMask, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, arpInfoSrcPort=arpInfoSrcPort, ripCurCfgState=ripCurCfgState, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaIntfBackup=ospfAreaIntfBackup, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumRxHello=ospfCumRxHello, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfTxHello=ospfIntfTxHello, ospfIntfNbrChange=ospfIntfNbrChange, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfBackup=ospfIntfBackup, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfNbrDown=ospfIntfNbrDown, ripStats=ripStats, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfUnloop=ospfIntfUnloop, arpStatEntries=arpStatEntries, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfRxPkts=ospfIntfRxPkts, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfGeneral=ospfGeneral, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumTxHello=ospfCumTxHello, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfRxHello=ospfIntfRxHello, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, routerLSALinkData=routerLSALinkData, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfinfo=ospfinfo, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgIntfState=ipCurCfgIntfState, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, routeStatMaxEntries=routeStatMaxEntries, ospfInterface=ospfInterface, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod)
