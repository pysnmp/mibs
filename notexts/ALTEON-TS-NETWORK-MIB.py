...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfTxHello=ospfIntfTxHello, ipRouteInfoInterface=ipRouteInfoInterface, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumRxDatabase=ospfCumRxDatabase, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgGwArp=ipCurCfgGwArp, arpInfoTable=arpInfoTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfStats=ospfStats, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, routeStatHighWater=routeStatHighWater, ospfGeneral=ospfGeneral, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipCurCfgGwState=ipCurCfgGwState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfLoop=ospfIntfLoop, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfRxDatabase=ospfIntfRxDatabase, routerLSALinkIndex=routerLSALinkIndex, dnsStats=dnsStats, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumTxHello=ospfCumTxHello, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ripNewCfgListen=ripNewCfgListen, ospfCumIntfDown=ospfCumIntfDown, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipRouteInfoMask=ipRouteInfoMask, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, routerLSALinkIfIndex=routerLSALinkIfIndex, ipRouteInfoIndx=ipRouteInfoIndx, ipNewCfgBootpState=ipNewCfgBootpState, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrp=vrrp, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfNbrInFullState=ospfNbrInFullState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumIntfBackup=ospfCumIntfBackup, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumIntfHello=ospfCumIntfHello, arpStatEntries=arpStatEntries, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgGwMetric=ipCurCfgGwMetric, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgGwDelete=ipNewCfgGwDelete, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, arpInfoEntry=arpInfoEntry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaIntfHello=ospfAreaIntfHello, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipForward=ipForward, ospfAreaInfoEntry=ospfAreaInfoEntry, ripStatInPkts=ripStatInPkts, ospfAreaTxHello=ospfAreaTxHello, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpOper=vrrpOper, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfNbrStart=ospfIntfNbrStart, ospfNbrInInitState=ospfNbrInInitState, routerLSAId=routerLSAId, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfHello=ospfIntfHello, arpInfoSrcPort=arpInfoSrcPort, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfRxHello=ospfIntfRxHello, ospfGeneralInfo=ospfGeneralInfo, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaInfoId=ospfAreaInfoId, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgGwArp=ipNewCfgGwArp, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripConfig=ripConfig, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipRouteInfoType=ipRouteInfoType, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfIndex=ospfIntfIndex, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, routeStatEntries=routeStatEntries, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ip_info=ip_info, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfLsTypesSupported=ospfLsTypesSupported, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgGwRetry=ipNewCfgGwRetry, ripStatOutPkts=ripStatOutPkts, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumNbrStart=ospfCumNbrStart, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfGeneralStats=ospfGeneralStats, ipInterfaceTableMax=ipInterfaceTableMax, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ripNewCfgDefListen=ripNewCfgDefListen, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, routeStats=routeStats, ripNewCfgSupply=ripNewCfgSupply)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgGwVlan=ipNewCfgGwVlan, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgIntfDelete=ipNewCfgIntfDelete, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ripCurCfgState=ripCurCfgState, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripStatInErrorPkts=ripStatInErrorPkts, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfArea=ospfArea, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfNbrDown=ospfIntfNbrDown, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ripNewCfgVip=ripNewCfgVip, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrp_info=vrrp_info, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipRouteInfoEntry=ipRouteInfoEntry, ospfCumNbrhello=ospfCumNbrhello, iprouting=iprouting, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumTxPkts=ospfCumTxPkts, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfNbrChange=ospfIntfNbrChange, ripCurCfgVip=ripCurCfgVip, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaNbrDown=ospfAreaNbrDown, ospfStartTime=ospfStartTime, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, arpStats=arpStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCfg=ospfCfg, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumRxHello=ospfCumRxHello, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfBackup=ospfIntfBackup, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfDown=ospfIntfDown, ospfInterface=ospfInterface, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, arpInfoDestIp=arpInfoDestIp, ospfIntfUnloop=ospfIntfUnloop, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfNbrN1way=ospfIntfNbrN1way, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaNbrhello=ospfAreaNbrhello, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaRxlsReqs=ospfAreaRxlsReqs, arpInfoFlag=arpInfoFlag, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, arpStatHighWater=arpStatHighWater, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ripStats=ripStats, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfChangeStats=ospfIntfChangeStats, arpInfoRefPorts=arpInfoRefPorts, ospfCumTxDatabase=ospfCumTxDatabase, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaChangeStats=ospfAreaChangeStats, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpStats=vrrpStats, ospfCumNbrN1way=ospfCumNbrN1way, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, arpInfoMacAddr=arpInfoMacAddr, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipFwdCurCfgState=ipFwdCurCfgState, vrrpGeneral=vrrpGeneral)
