...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgGwArp=ipCurCfgGwArp, vrrpGeneral=vrrpGeneral, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumNbrhello=ospfCumNbrhello, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgIntfState=ipNewCfgIntfState, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfTxHello=ospfIntfTxHello, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgBootpState=ipNewCfgBootpState, vrrpStats=vrrpStats, ospfAreaInfoId=ospfAreaInfoId, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, arpInfoDestIp=arpInfoDestIp, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCumIntfDown=ospfCumIntfDown, ospfIntfTxlsAcks=ospfIntfTxlsAcks, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, routeStats=routeStats, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ripCurCfgVip=ripCurCfgVip, arpInfoEntry=arpInfoEntry, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfStats=ospfStats, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIfWaitInterval=ospfIfWaitInterval, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripNewCfgSupply=ripNewCfgSupply, arpInfoFlag=arpInfoFlag, ipRouteInfoGateway=ipRouteInfoGateway, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipRouteInfoMask=ipRouteInfoMask, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, arpStatMaxEntries=arpStatMaxEntries, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipGatewayTableMax=ipGatewayTableMax, ospfCumIntfHello=ospfCumIntfHello, ospfinfo=ospfinfo, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfUnloop=ospfIntfUnloop, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaIntfDown=ospfAreaIntfDown, ip_info=ip_info, ospfGeneral=ospfGeneral, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumTxDatabase=ospfCumTxDatabase, routerLSALinkID=routerLSALinkID, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripStatOutPkts=ripStatOutPkts, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaRxHello=ospfAreaRxHello, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgGwMetric=ipCurCfgGwMetric, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, arpInfoRefPorts=arpInfoRefPorts, ospfNbrInFullState=ospfNbrInFullState, ospfIntfBackup=ospfIntfBackup, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, routeStatMaxEntries=routeStatMaxEntries, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, arpInfoSrcPort=arpInfoSrcPort, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgGwAddr=ipCurCfgGwAddr, ipInterfaceTableMax=ipInterfaceTableMax, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumNbrStart=ospfCumNbrStart, ipRouteInfoTag=ipRouteInfoTag, ospfCumIntfUnloop=ospfCumIntfUnloop, routerLSAAreaIndex=routerLSAAreaIndex, ospfTotalAreas=ospfTotalAreas, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumRxPkts=ospfCumRxPkts, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipForward=ipForward, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgGwIndex=ipCurCfgGwIndex, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumIntfNbrChange=ospfCumIntfNbrChange, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgIntfTable=ipCurCfgIntfTable, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipRouteInfoEntry=ipRouteInfoEntry, vrrpOper=vrrpOper, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfProcessUptime=ospfProcessUptime, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, routerLSALinkIndex=routerLSALinkIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ripStatInErrorPkts=ripStatInErrorPkts, arpInfoMacAddr=arpInfoMacAddr, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaTxHello=ospfAreaTxHello, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfWaitTimer=ospfIntfWaitTimer, ipFwdCurCfgPortState=ipFwdCurCfgPortState, routerLSALinkData=routerLSALinkData, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, iprouting=iprouting, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumTxHello=ospfCumTxHello, ipCurCfgGwTable=ipCurCfgGwTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaTxPkts=ospfAreaTxPkts, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ripStats=ripStats, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, arpInfoTable=arpInfoTable, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfArea=ospfArea, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrp_info=vrrp_info, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfHello=ospfIntfHello, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfNbrDown=ospfIntfNbrDown, ripConfig=ripConfig, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaRxPkts=ospfAreaRxPkts, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, arpStatHighWater=arpStatHighWater, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfTxPkts=ospfIntfTxPkts, ospfStartTime=ospfStartTime, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ripCurCfgSupply=ripCurCfgSupply, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfInterface=ospfInterface, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ripNewCfgListen=ripNewCfgListen, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCumTxPkts=ospfCumTxPkts, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipCurCfgGwInterval=ipCurCfgGwInterval, ripNewCfgDefListen=ripNewCfgDefListen, arpStatEntries=arpStatEntries, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, routeStatHighWater=routeStatHighWater, ospfIntfRxTxStats=ospfIntfRxTxStats, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfLoop=ospfIntfLoop, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgGwVlan=ipNewCfgGwVlan, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIfInfoIndex=ospfIfInfoIndex, arpInfoVLAN=arpInfoVLAN, arpStats=arpStats, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, routeStatEntries=routeStatEntries, dnsStats=dnsStats, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfDown=ospfIntfDown, vrrp=vrrp, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumRxDatabase=ospfCumRxDatabase, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfGeneralStats=ospfGeneralStats, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ripStatInPkts=ripStatInPkts)
