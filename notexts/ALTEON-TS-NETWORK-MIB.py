...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipRouteInfoMask=ipRouteInfoMask, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgIntfState=ipNewCfgIntfState, ipFwdNewCfgState=ipFwdNewCfgState, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfHello=ospfIntfHello, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfStartTime=ospfStartTime, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfLsTypesSupported=ospfLsTypesSupported, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, dnsStats=dnsStats, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgIntfVlan=ipCurCfgIntfVlan, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ripConfig=ripConfig, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgGwTable=ipCurCfgGwTable, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, arpStatEntries=arpStatEntries, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, arpStats=arpStats, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaNbrDown=ospfAreaNbrDown, ospfGeneral=ospfGeneral, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, routerLSAId=routerLSAId, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, arpInfoDestIp=arpInfoDestIp, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, arpInfoFlag=arpInfoFlag, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, routeStatHighWater=routeStatHighWater, ospfIntfChangeStats=ospfIntfChangeStats, ripCurCfgVip=ripCurCfgVip, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaChangeStats=ospfAreaChangeStats, ripNewCfgSupply=ripNewCfgSupply, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfArea=ospfArea, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfNbrInInitState=ospfNbrInInitState, ripCurCfgDefListen=ripCurCfgDefListen, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ripNewCfgState=ripNewCfgState, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpStatInAdvers=vrrpStatInAdvers, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumNbrDown=ospfCumNbrDown, ospfCumNbrStart=ospfCumNbrStart, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumRxHello=ospfCumRxHello, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, iprouting=iprouting, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumRxPkts=ospfCumRxPkts, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaRxHello=ospfAreaRxHello, ospfAreaIntfDown=ospfAreaIntfDown, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgGwState=ipNewCfgGwState, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumIntfHello=ospfCumIntfHello, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumIntfLoop=ospfCumIntfLoop, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfTotalNeighbours=ospfTotalNeighbours, ospfGeneralStats=ospfGeneralStats, ospfAreaNbrStart=ospfAreaNbrStart, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipRouteInfoTable=ipRouteInfoTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCumTxDatabase=ospfCumTxDatabase, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, routeStats=routeStats, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfRxHello=ospfIntfRxHello, ipRouteInfoDestIp=ipRouteInfoDestIp, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipCurCfgGwRetry=ipCurCfgGwRetry, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaIntfHello=ospfAreaIntfHello, ipForward=ipForward, ospfTotalAreas=ospfTotalAreas, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ripStats=ripStats, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgGwState=ipCurCfgGwState, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgGwTable=ipNewCfgGwTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgGwVlan=ipNewCfgGwVlan, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipNewCfgGwAddr=ipNewCfgGwAddr, ripCurCfgSupply=ripCurCfgSupply, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ripNewCfgDefListen=ripNewCfgDefListen, routerLSALinkID=routerLSALinkID, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfNbrChange=ospfIntfNbrChange, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfTotalTransitAreas=ospfTotalTransitAreas, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipRouteInfoType=ipRouteInfoType, ripNewCfgVip=ripNewCfgVip, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumNbrhello=ospfCumNbrhello, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ip_info=ip_info, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpGeneral=vrrpGeneral, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, arpInfoEntry=arpInfoEntry, ospfIntfLoop=ospfIntfLoop, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrp=vrrp, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipRouteInfoTag=ipRouteInfoTag, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCurCfgAreaId=ospfCurCfgAreaId, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, routeStatEntries=routeStatEntries, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumIntfUnloop=ospfCumIntfUnloop, arpInfoTable=arpInfoTable, ospfNbrInFullState=ospfNbrInFullState, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpOper=vrrpOper, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumRxTxStats=ospfCumRxTxStats, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, routerLSALinkIndex=routerLSALinkIndex, ospfCfg=ospfCfg, vrrp_info=vrrp_info, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, arpInfoVLAN=arpInfoVLAN, ospfIntfInfoTable=ospfIntfInfoTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipRouteInfoInterface=ipRouteInfoInterface, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgGwRetry=ipNewCfgGwRetry, ipFwdCurCfgState=ipFwdCurCfgState, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumTxHello=ospfCumTxHello, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ripStatOutPkts=ripStatOutPkts, ospfCumTxPkts=ospfCumTxPkts, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfStats=ospfStats, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfProcessUptime=ospfProcessUptime, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, routerLSAAreaIndex=routerLSAAreaIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfinfo=ospfinfo, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ripNewCfgListen=ripNewCfgListen, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ripCurCfgListen=ripCurCfgListen, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ripStatInPkts=ripStatInPkts, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfDown=ospfIntfDown, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet)
