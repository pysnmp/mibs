...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdNewCfgState=ipFwdNewCfgState, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumNbrDown=ospfCumNbrDown, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, iprouting=iprouting, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfRxHello=ospfIntfRxHello, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, arpInfoSrcPort=arpInfoSrcPort, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ripNewCfgDefListen=ripNewCfgDefListen, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgGwArp=ipCurCfgGwArp, routerLSAId=routerLSAId, ospfIntfNbrhello=ospfIntfNbrhello, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaTxHello=ospfAreaTxHello, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ripCurCfgState=ripCurCfgState, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfDown=ospfIntfDown, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipRouteInfoType=ipRouteInfoType, arpInfoMacAddr=arpInfoMacAddr, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfStats=ospfStats, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, routeStats=routeStats, ipNewCfgBootpAddr=ipNewCfgBootpAddr, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgGwState=ipCurCfgGwState, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, arpStatMaxEntries=arpStatMaxEntries, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfTotalNeighbours=ospfTotalNeighbours, arpInfoVLAN=arpInfoVLAN, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfGeneral=ospfGeneral, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumTxPkts=ospfCumTxPkts, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, dnsStats=dnsStats, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumIntfHello=ospfCumIntfHello, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaNbrStart=ospfAreaNbrStart, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfStartTime=ospfStartTime, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgIntfState=ipNewCfgIntfState, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpStats=vrrpStats, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ripCurCfgVip=ripCurCfgVip, ospfCumIntfNbrChange=ospfCumIntfNbrChange, arpStatHighWater=arpStatHighWater, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipRouteInfoMask=ipRouteInfoMask, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, routeStatMaxEntries=routeStatMaxEntries, vrrpOper=vrrpOper, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ripStatOutPkts=ripStatOutPkts, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfBackup=ospfIntfBackup, ipRouteInfoTag=ipRouteInfoTag, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, arpInfoFlag=arpInfoFlag, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgGwRetry=ipCurCfgGwRetry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfNbrInFullState=ospfNbrInFullState, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, arpStats=arpStats, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaInfoEntry=ospfAreaInfoEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfHello=ospfIntfHello, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipRouteInfoIndx=ipRouteInfoIndx, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfGeneralStats=ospfGeneralStats, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumIntfLoop=ospfCumIntfLoop, ripNewCfgVip=ripNewCfgVip, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaIntfIndex=ospfAreaIntfIndex, ripNewCfgSupply=ripNewCfgSupply, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgGwVlan=ipNewCfgGwVlan, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfCountForRouter=ospfIntfCountForRouter, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgBootpState=ipNewCfgBootpState, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ripCurCfgDefListen=ripCurCfgDefListen)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumRxPkts=ospfCumRxPkts, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, routerLSALinkData=routerLSALinkData, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgIntfMask=ipCurCfgIntfMask, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ip_info=ip_info, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumRxlsAcks=ospfCumRxlsAcks, arpInfoEntry=arpInfoEntry, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumNbrStart=ospfCumNbrStart, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ripStatInPkts=ripStatInPkts, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfGeneralInfo=ospfGeneralInfo, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipForward=ipForward, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCfg=ospfCfg, ospfCumNbrhello=ospfCumNbrhello, ospfNbrInExchState=ospfNbrInExchState, ospfinfo=ospfinfo, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfIndex=ospfIntfIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ripNewCfgListen=ripNewCfgListen, ipNewCfgGwMetric=ipNewCfgGwMetric, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfNbrChange=ospfIntfNbrChange, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpStatInAdvers=vrrpStatInAdvers, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfProcessUptime=ospfProcessUptime, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrp=vrrp, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfArea=ospfArea, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, arpInfoRefPorts=arpInfoRefPorts, vrrpGeneral=vrrpGeneral, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumTxDatabase=ospfCumTxDatabase, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, arpInfoTable=arpInfoTable, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ripConfig=ripConfig, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgGwState=ipNewCfgGwState, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaInfoTable=ospfAreaInfoTable, routerLSALinkIndex=routerLSALinkIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipCurCfgGwEntry=ipCurCfgGwEntry, ipRouteInfoTable=ipRouteInfoTable, ripStats=ripStats, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgIfTable=vrrpCurCfgIfTable, routeStatEntries=routeStatEntries, ospfIfInfoIndex=ospfIfInfoIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumTxHello=ospfCumTxHello, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgGwRetry=ipNewCfgGwRetry, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfTxPkts=ospfIntfTxPkts, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaTxDatabase=ospfAreaTxDatabase, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIfInfoIpAddress=ospfIfInfoIpAddress, arpStatEntries=arpStatEntries, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry)
