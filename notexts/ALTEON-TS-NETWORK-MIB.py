...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfNbrInExchState=ospfNbrInExchState, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipRouteInfoTable=ipRouteInfoTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfTotalAreas=ospfTotalAreas, ospfGeneralStats=ospfGeneralStats, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumIntfDown=ospfCumIntfDown, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgGwMetric=ipCurCfgGwMetric, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, arpInfoFlag=arpInfoFlag, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, arpInfoTable=arpInfoTable, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIfInfoIndex=ospfIfInfoIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, routerLSALinkID=routerLSALinkID, dnsStats=dnsStats, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfHostTableMaxSize=ospfHostTableMaxSize, arpStats=arpStats, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumIntfBackup=ospfCumIntfBackup, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumTxlsAcks=ospfCumTxlsAcks, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfBackup=ospfIntfBackup, routerLSAId=routerLSAId, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfStats=ospfStats, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipRouteInfoType=ipRouteInfoType, ospfIntfNbrDown=ospfIntfNbrDown, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgGwInterval=ipCurCfgGwInterval, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, routeStatEntries=routeStatEntries, ospfAreaNbrStart=ospfAreaNbrStart, ospfTotalTransitAreas=ospfTotalTransitAreas, routerLSAAreaIndex=routerLSAAreaIndex, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipRouteInfoGateway=ipRouteInfoGateway, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfNbrInInitState=ospfNbrInInitState, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, ipRouteInfoInterface=ipRouteInfoInterface, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ripStatInPkts=ripStatInPkts, ospfRangeTableMaxSize=ospfRangeTableMaxSize, routeStatHighWater=routeStatHighWater, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaNbrN1way=ospfAreaNbrN1way, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfTxPkts=ospfIntfTxPkts, vrrpOper=vrrpOper, ospfIntfWaitTimer=ospfIntfWaitTimer, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ripCurCfgDefListen=ripCurCfgDefListen, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ripNewCfgDefListen=ripNewCfgDefListen, ipForward=ipForward, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumTxHello=ospfCumTxHello, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfStartTime=ospfStartTime, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrp_info=vrrp_info, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumRxlsAcks=ospfCumRxlsAcks, ripNewCfgVip=ripNewCfgVip, ip_info=ip_info, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripCurCfgState=ripCurCfgState, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumNbrStart=ospfCumNbrStart, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, arpStatHighWater=arpStatHighWater, iprouting=iprouting, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfIndex=ospfIntfIndex, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgGenState=vrrpCurCfgGenState, ipGatewayTableMax=ipGatewayTableMax, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaIntfDown=ospfAreaIntfDown, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipRouteInfoDestIp=ipRouteInfoDestIp, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfGeneral=ospfGeneral, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, ipRouteInfoTag=ipRouteInfoTag, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfHello=ospfIntfHello, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ripNewCfgListen=ripNewCfgListen, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumTxPkts=ospfCumTxPkts, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrp=vrrp, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgGwState=ipCurCfgGwState, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaRxHello=ospfAreaRxHello, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ripNewCfgState=ripNewCfgState, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfTxHello=ospfIntfTxHello, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, arpInfoRefPorts=arpInfoRefPorts, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfRxHello=ospfIntfRxHello, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumIntfHello=ospfCumIntfHello, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaInfoEntry=ospfAreaInfoEntry, arpStatEntries=arpStatEntries, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, routeStatMaxEntries=routeStatMaxEntries, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgGwState=ipNewCfgGwState, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfArea=ospfArea, arpInfoDestIp=arpInfoDestIp, ospfIntfNbrChange=ospfIntfNbrChange, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfLsTypesSupported=ospfLsTypesSupported, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfProcessUptime=ospfProcessUptime, ospfinfo=ospfinfo, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaInfoId=ospfAreaInfoId, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripNewCfgSupply=ripNewCfgSupply, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfInterface=ospfInterface, ospfIntfChangeStats=ospfIntfChangeStats, vrrpStats=vrrpStats, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ripStats=ripStats, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfCountForRouter=ospfIntfCountForRouter, arpInfoVLAN=arpInfoVLAN, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipNewCfgGwVlan=ipNewCfgGwVlan, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaTxHello=ospfAreaTxHello, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, arpInfoEntry=arpInfoEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripConfig=ripConfig, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgGwTable=ipCurCfgGwTable, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpGeneral=vrrpGeneral, ospfIntfRxDatabase=ospfIntfRxDatabase, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripCurCfgSupply=ripCurCfgSupply, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, routeStats=routeStats, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfLoop=ospfIntfLoop, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfNewCfgAreaTable=ospfNewCfgAreaTable, arpInfoMacAddr=arpInfoMacAddr, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone)
