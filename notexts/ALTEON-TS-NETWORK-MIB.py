...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, Unsigned32, Counter64, NotificationType, MibIdentifier, ModuleIdentity, iso, Counter32, Gauge32, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "Unsigned32", "Counter64", "NotificationType", "MibIdentifier", "ModuleIdentity", "iso", "Counter32", "Gauge32", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaIntfDown=ospfAreaIntfDown, ripCurCfgSupply=ripCurCfgSupply, routeStatHighWater=routeStatHighWater, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, routeStats=routeStats, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfHello=ospfIntfHello, arpStatHighWater=arpStatHighWater, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCumNbrDown=ospfCumNbrDown, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ip_info=ip_info, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfinfo=ospfinfo, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaChangeStats=ospfAreaChangeStats, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, dnsStats=dnsStats, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipGatewayTableMax=ipGatewayTableMax, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumNbrStart=ospfCumNbrStart, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, arpInfoEntry=arpInfoEntry, routerLSALinkData=routerLSALinkData, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfNbrN1way=ospfIntfNbrN1way, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfGeneralStats=ospfGeneralStats, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfTotalAreas=ospfTotalAreas, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfRxHello=ospfIntfRxHello, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfUnloop=ospfIntfUnloop, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgGwState=ipNewCfgGwState, ospfAreaInfoId=ospfAreaInfoId, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ripCurCfgListen=ripCurCfgListen, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCfg=ospfCfg, ripStatInPkts=ripStatInPkts, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumNbrRstAd=ospfCumNbrRstAd, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipFwdCurCfgState=ipFwdCurCfgState, iprouting=iprouting, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, routeStatEntries=routeStatEntries, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfStats=ospfStats, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ripStats=ripStats, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaIntfHello=ospfAreaIntfHello, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipRouteInfoInterface=ipRouteInfoInterface, ospfNbrInFullState=ospfNbrInFullState, ripNewCfgListen=ripNewCfgListen, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, arpInfoFlag=arpInfoFlag, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumTxHello=ospfCumTxHello, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ripCurCfgVip=ripCurCfgVip, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfNbrStart=ospfIntfNbrStart, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfCountForRouter=ospfIntfCountForRouter, arpInfoRefPorts=arpInfoRefPorts, ripNewCfgSupply=ripNewCfgSupply, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfLsTypesSupported=ospfLsTypesSupported, vrrp=vrrp, ripStatOutPkts=ripStatOutPkts, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfArea=ospfArea, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpGeneral=vrrpGeneral, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfBackup=ospfIntfBackup, ipCurCfgIntfMask=ipCurCfgIntfMask, arpInfoDestIp=arpInfoDestIp, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripCurCfgState=ripCurCfgState, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgGwDelete=ipNewCfgGwDelete, arpInfoTable=arpInfoTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfTimersKickOffStats=ospfTimersKickOffStats, ipForward=ipForward, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfIndex=ospfIntfIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, arpStatEntries=arpStatEntries, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCumTxPkts=ospfCumTxPkts, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ripNewCfgState=ripNewCfgState, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ripNewCfgDefListen=ripNewCfgDefListen, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaRxHello=ospfAreaRxHello, ospfGeneral=ospfGeneral, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumIntfDown=ospfCumIntfDown, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaInfoTable=ospfAreaInfoTable, ospfNbrInInitState=ospfNbrInInitState, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfLoop=ospfIntfLoop, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumNbrhello=ospfCumNbrhello, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipFwdNewCfgState=ipFwdNewCfgState, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgGwArp=ipNewCfgGwArp, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaTxPkts=ospfAreaTxPkts, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipRouteInfoTag=ipRouteInfoTag, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaRxTxStats=ospfAreaRxTxStats, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripNewCfgVip=ripNewCfgVip, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfDown=ospfIntfDown, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumIntfBackup=ospfCumIntfBackup, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfGeneralInfo=ospfGeneralInfo, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipRouteInfoGateway=ipRouteInfoGateway, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumRxHello=ospfCumRxHello, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgGenState=vrrpNewCfgGenState, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, arpInfoVLAN=arpInfoVLAN, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, arpStats=arpStats, ospfInterface=ospfInterface, ipRouteInfoType=ipRouteInfoType, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfTotalNeighbours=ospfTotalNeighbours, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCumRxPkts=ospfCumRxPkts, arpInfoMacAddr=arpInfoMacAddr, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgIntfState=ipNewCfgIntfState, ripConfig=ripConfig, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, routerLSALinkID=routerLSALinkID, ospfCumTxDatabase=ospfCumTxDatabase, ospfProcessUptime=ospfProcessUptime, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState)
