...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripStatOutPkts=ripStatOutPkts, ospfTotalAreas=ospfTotalAreas, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfUnloop=ospfIntfUnloop, vrrp_info=vrrp_info, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ripNewCfgState=ripNewCfgState, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, arpInfoMacAddr=arpInfoMacAddr, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfinfo=ospfinfo, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfNbrChange=ospfIntfNbrChange, ipCurCfgIntfTable=ipCurCfgIntfTable, routerLSALinkIndex=routerLSALinkIndex, ipRouteInfoMask=ipRouteInfoMask, arpInfoRefPorts=arpInfoRefPorts, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaInfoId=ospfAreaInfoId, arpInfoTable=arpInfoTable, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaRxPkts=ospfAreaRxPkts, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgBootpState=ipCurCfgBootpState, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpGeneral=vrrpGeneral, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfRxHello=ospfIntfRxHello, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ripCurCfgListen=ripCurCfgListen, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, arpInfoDestIp=arpInfoDestIp, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpStats=vrrpStats, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipRouteInfoTable=ipRouteInfoTable, ospfCfg=ospfCfg, ospfGeneralInfo=ospfGeneralInfo, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, routeStats=routeStats, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ripCurCfgVip=ripCurCfgVip, ripNewCfgVip=ripNewCfgVip, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, dnsStats=dnsStats, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumIntfDown=ospfCumIntfDown, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpOper=vrrpOper, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, routeStatMaxEntries=routeStatMaxEntries, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, arpStatMaxEntries=arpStatMaxEntries, ospfProcessUptime=ospfProcessUptime, ospfAreaTxlsReqs=ospfAreaTxlsReqs, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaInfoIndex=ospfAreaInfoIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfBackup=ospfIntfBackup, ipForward=ipForward, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfGeneralStats=ospfGeneralStats, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumNbrStart=ospfCumNbrStart, arpInfoVLAN=arpInfoVLAN, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ripConfig=ripConfig, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfLoop=ospfIntfLoop, ipNewCfgIntfIndex=ipNewCfgIntfIndex, routeStatEntries=routeStatEntries, ospfAreaNbrStart=ospfAreaNbrStart, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumTxPkts=ospfCumTxPkts, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfTxDatabase=ospfIntfTxDatabase, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipRouteInfoIndx=ipRouteInfoIndx, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ripNewCfgListen=ripNewCfgListen, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgGwMetric=ipNewCfgGwMetric, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfNbrStart=ospfIntfNbrStart, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumIntfHello=ospfCumIntfHello, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgGwTable=ipCurCfgGwTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfChangeStats=ospfIntfChangeStats)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfNbrDown=ospfIntfNbrDown, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgGwInterval=ipCurCfgGwInterval, ipGatewayTableMax=ipGatewayTableMax, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaNbrhello=ospfAreaNbrhello, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumRxPkts=ospfCumRxPkts, ospfStats=ospfStats, ospfGeneral=ospfGeneral, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ripStatInErrorPkts=ripStatInErrorPkts, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, routerLSALinkID=routerLSALinkID, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrp=vrrp, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ripStats=ripStats, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfHello=ospfIntfHello, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfNbrInExchState=ospfNbrInExchState, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaRxHello=ospfAreaRxHello, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgGwArp=ipNewCfgGwArp, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, routerLSAAreaIndex=routerLSAAreaIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumRxHello=ospfCumRxHello, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIfWaitInterval=ospfIfWaitInterval, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfDown=ospfIntfDown, ip_info=ip_info, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, arpInfoEntry=arpInfoEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipRouteInfoInterface=ipRouteInfoInterface, arpStats=arpStats, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfArea=ospfArea, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaChangeStats=ospfAreaChangeStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfWaitTimer=ospfIntfWaitTimer, arpInfoSrcPort=arpInfoSrcPort, ospfAreaTxPkts=ospfAreaTxPkts, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfNbrInFullState=ospfNbrInFullState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfStartTime=ospfStartTime, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumTxHello=ospfCumTxHello, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, arpStatEntries=arpStatEntries, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfInfoTable=ospfIntfInfoTable, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ripNewCfgDefListen=ripNewCfgDefListen, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, routerLSALinkData=routerLSALinkData, iprouting=iprouting, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipRouteInfoType=ipRouteInfoType, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaRxTxStats=ospfAreaRxTxStats, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipRouteInfoGateway=ipRouteInfoGateway, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit)
