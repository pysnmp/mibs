...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipNewCfgBootpState=ipNewCfgBootpState, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgGenState=vrrpCurCfgGenState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfinfo=ospfinfo, ospfAreaTableMaxSize=ospfAreaTableMaxSize, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, arpStats=arpStats, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, arpInfoEntry=arpInfoEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ripCurCfgSupply=ripCurCfgSupply, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfChangeStats=ospfIntfChangeStats, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, arpInfoVLAN=arpInfoVLAN, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaTxHello=ospfAreaTxHello, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ripCurCfgState=ripCurCfgState, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumNbrBadSequence=ospfCumNbrBadSequence, arpInfoTable=arpInfoTable, ospfGeneral=ospfGeneral, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ripConfig=ripConfig, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgGwTable=ipCurCfgGwTable, routeStatMaxEntries=routeStatMaxEntries, ospfCumNbrDown=ospfCumNbrDown, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaNbrStart=ospfAreaNbrStart, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ip_info=ip_info, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaInfoTable=ospfAreaInfoTable, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ripNewCfgVip=ripNewCfgVip, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfProcessUptime=ospfProcessUptime, arpStatHighWater=arpStatHighWater, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfRxTxStats=ospfIntfRxTxStats, arpStatMaxEntries=arpStatMaxEntries, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgGwIndex=ipNewCfgGwIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfGeneralInfo=ospfGeneralInfo, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ripStats=ripStats, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ripCurCfgVip=ripCurCfgVip, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, routerLSALinkData=routerLSALinkData, ospfCumIntfHello=ospfCumIntfHello, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfUnloop=ospfIntfUnloop, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCurCfgAreaId=ospfCurCfgAreaId, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipRouteInfoMask=ipRouteInfoMask, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrDown=ospfIntfNbrDown, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpStatInAdvers=vrrpStatInAdvers, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrp=vrrp, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgGwVlan=ipCurCfgGwVlan, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, routeStatEntries=routeStatEntries, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, iprouting=iprouting, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumTxlsUpdates=ospfCumTxlsUpdates, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfBackup=ospfIntfBackup, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripStatOutPkts=ripStatOutPkts, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipRouteInfoEntry=ipRouteInfoEntry, ospfStats=ospfStats, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaIntfDown=ospfAreaIntfDown, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgIntfEntry=ipNewCfgIntfEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, arpInfoRefPorts=arpInfoRefPorts, arpInfoMacAddr=arpInfoMacAddr, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfHello=ospfIntfHello, ripNewCfgDefListen=ripNewCfgDefListen, ripNewCfgState=ripNewCfgState, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripNewCfgSupply=ripNewCfgSupply, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfGeneralStats=ospfGeneralStats, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumTxHello=ospfCumTxHello, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumTxPkts=ospfCumTxPkts, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, routeStats=routeStats, ospfArea=ospfArea, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfNbrIndex=ospfIntfNbrIndex, routerLSALinkID=routerLSALinkID, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCumNbrN1way=ospfCumNbrN1way, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfNbrInExchState=ospfNbrInExchState, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpGeneral=vrrpGeneral, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumRxHello=ospfCumRxHello, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfNbrInInitState=ospfNbrInInitState, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumIntfDown=ospfCumIntfDown, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaTxDatabase=ospfAreaTxDatabase, ipCurCfgGwMetric=ipCurCfgGwMetric, arpInfoSrcPort=arpInfoSrcPort, ripStatInPkts=ripStatInPkts, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipGatewayTableMax=ipGatewayTableMax, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, routeStatHighWater=routeStatHighWater, vrrp_info=vrrp_info, ipCurCfgIntfTable=ipCurCfgIntfTable, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIfInfoIndex=ospfIfInfoIndex, routerLSAId=routerLSAId, arpInfoDestIp=arpInfoDestIp, vrrpOper=vrrpOper, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpStats=vrrpStats, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfDown=ospfIntfDown, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfRxDatabase=ospfIntfRxDatabase, ripNewCfgListen=ripNewCfgListen, ipNewCfgGwAddr=ipNewCfgGwAddr, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipForward=ipForward, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfNbrhello=ospfIntfNbrhello, ospfStartTime=ospfStartTime, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripNewCfgStaticSupply=ripNewCfgStaticSupply, arpInfoFlag=arpInfoFlag, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, arpStatEntries=arpStatEntries, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgGwState=ipNewCfgGwState, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ripCurCfgListen=ripCurCfgListen, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfRxHello=ospfIntfRxHello, ospfIntfIndex=ospfIntfIndex, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaNbrhello=ospfAreaNbrhello, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgIntfMask=ipNewCfgIntfMask, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumIntfBackup=ospfCumIntfBackup, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipFwdCurCfgState=ipFwdCurCfgState, dnsStats=dnsStats, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgIntfState=ipNewCfgIntfState)
