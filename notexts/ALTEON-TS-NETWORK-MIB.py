...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfGeneral=ospfGeneral, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgBootpState=ipCurCfgBootpState, routerLSAId=routerLSAId, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfRxTxIndex=ospfIntfRxTxIndex, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgGwArp=ipNewCfgGwArp, ospfCfg=ospfCfg, vrrpStats=vrrpStats, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfNbrInExchState=ospfNbrInExchState, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, routeStats=routeStats, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ripStatInPkts=ripStatInPkts, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfInterface=ospfInterface, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, arpInfoFlag=arpInfoFlag, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipRouteInfoTable=ipRouteInfoTable, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdCurCfgState=ipFwdCurCfgState, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfStats=ospfStats, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumTxHello=ospfCumTxHello, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, routerLSALinkID=routerLSALinkID, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipRouteInfoType=ipRouteInfoType, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, arpInfoVLAN=arpInfoVLAN, ripCurCfgListen=ripCurCfgListen, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfNbrChange=ospfIntfNbrChange, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrp_info=vrrp_info, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfGeneralInfo=ospfGeneralInfo, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfCountForRouter=ospfIntfCountForRouter, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfRxlsAcks=ospfIntfRxlsAcks, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaRxDatabase=ospfAreaRxDatabase, ip_info=ip_info, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, routerLSALinkData=routerLSALinkData, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfTxHello=ospfIntfTxHello, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfUnloop=ospfIntfUnloop, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfNbrDown=ospfIntfNbrDown, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaInfoId=ospfAreaInfoId, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfStartTime=ospfStartTime, dnsStats=dnsStats, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, arpInfoTable=arpInfoTable, ospfIntfRxHello=ospfIntfRxHello, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ripConfig=ripConfig, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, iprouting=iprouting, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfBackup=ospfIntfBackup, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaTxHello=ospfAreaTxHello, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrp=vrrp, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, arpStatEntries=arpStatEntries, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ripNewCfgSupply=ripNewCfgSupply, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfinfo=ospfinfo, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipRouteInfoGateway=ipRouteInfoGateway, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaNbrhello=ospfAreaNbrhello, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfTotalNssaAreas=ospfTotalNssaAreas, ipRouteInfoMask=ipRouteInfoMask, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipCurCfgGwAddr=ipCurCfgGwAddr, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfGeneralStats=ospfGeneralStats, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfHello=ospfIntfHello, ospfIntfDown=ospfIntfDown, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgGwRetry=ipNewCfgGwRetry, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfIndex=ospfIntfIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCurCfgAreaId=ospfCurCfgAreaId, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfNbrStart=ospfIntfNbrStart, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfInfoEntry=ospfIntfInfoEntry, arpStats=arpStats, ipForward=ipForward, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, arpStatHighWater=arpStatHighWater, arpInfoSrcPort=arpInfoSrcPort, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfTotalNeighbours=ospfTotalNeighbours, ospfArea=ospfArea, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfLoop=ospfIntfLoop, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumIntfDown=ospfCumIntfDown, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumRxlsAcks=ospfCumRxlsAcks, ripStats=ripStats, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumRxHello=ospfCumRxHello, routeStatHighWater=routeStatHighWater, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpGeneral=vrrpGeneral, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfTotalAreas=ospfTotalAreas, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIfWaitInterval=ospfIfWaitInterval, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgIntfMask=ipNewCfgIntfMask, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaRxHello=ospfAreaRxHello, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumNbrStart=ospfCumNbrStart, ospfNbrInFullState=ospfNbrInFullState, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgGwTable=ipNewCfgGwTable, arpInfoMacAddr=arpInfoMacAddr, arpStatMaxEntries=arpStatMaxEntries, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgGwInterval=ipCurCfgGwInterval, arpInfoEntry=arpInfoEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgGwArp=ipCurCfgGwArp, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaChangeStats=ospfAreaChangeStats, ripNewCfgListen=ripNewCfgListen, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ripStatOutPkts=ripStatOutPkts, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfProcessUptime=ospfProcessUptime, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod)
