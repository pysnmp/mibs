...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCumNbrN1way=ospfCumNbrN1way, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpGeneral=vrrpGeneral, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ripCurCfgVip=ripCurCfgVip, ripNewCfgDefListen=ripNewCfgDefListen, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfCountForRouter=ospfIntfCountForRouter, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCfg=ospfCfg, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfTotalAreas=ospfTotalAreas, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, routerLSALinkIndex=routerLSALinkIndex, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipForward=ipForward, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, routeStats=routeStats, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaTxHello=ospfAreaTxHello, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipRouteInfoEntry=ipRouteInfoEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrp_info=vrrp_info, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ripNewCfgState=ripNewCfgState, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipRouteInfoTag=ipRouteInfoTag, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumTxlsReqs=ospfCumTxlsReqs, arpInfoMacAddr=arpInfoMacAddr, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaNbrhello=ospfAreaNbrhello, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfHello=ospfIntfHello, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripStats=ripStats, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ripStatOutPkts=ripStatOutPkts, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipRouteInfoDestIp=ipRouteInfoDestIp, arpInfoTable=arpInfoTable, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, arpInfoFlag=arpInfoFlag, ipCurCfgGwTable=ipCurCfgGwTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfIndex=ospfIntfIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfinfo=ospfinfo, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfArea=ospfArea, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, routeStatEntries=routeStatEntries, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, arpStatHighWater=arpStatHighWater, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCumNbrhello=ospfCumNbrhello, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipRouteInfoMask=ipRouteInfoMask, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipRouteInfoType=ipRouteInfoType, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfStats=ospfStats, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaIntfHello=ospfAreaIntfHello, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, routerLSALinkData=routerLSALinkData, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripCurCfgState=ripCurCfgState, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaInfoId=ospfAreaInfoId, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumIntfHello=ospfCumIntfHello, arpStatMaxEntries=arpStatMaxEntries, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrp=vrrp, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ripCurCfgSupply=ripCurCfgSupply, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfBackup=ospfIntfBackup, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfGeneralInfo=ospfGeneralInfo, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfChangeStats=ospfIntfChangeStats, vrrpOper=vrrpOper, ipCurCfgIntfEntry=ipCurCfgIntfEntry, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, routeStatHighWater=routeStatHighWater, ospfProcessUptime=ospfProcessUptime, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumNbrStart=ospfCumNbrStart, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ripNewCfgVip=ripNewCfgVip, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfTotalTransitAreas=ospfTotalTransitAreas, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, arpStats=arpStats, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, arpInfoVLAN=arpInfoVLAN, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgIntfMask=ipCurCfgIntfMask, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaIntfUnloop=ospfAreaIntfUnloop, arpInfoEntry=arpInfoEntry, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgGwEntry=ipCurCfgGwEntry, routerLSAId=routerLSAId, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumTxHello=ospfCumTxHello, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ripNewCfgSupply=ripNewCfgSupply, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfDown=ospfIntfDown, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfNbrInInitState=ospfNbrInInitState, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumIntfDown=ospfCumIntfDown, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfNbrInFullState=ospfNbrInFullState, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfNbrInExchState=ospfNbrInExchState, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumTxlsAcks=ospfCumTxlsAcks, routerLSALinkID=routerLSALinkID, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaRxHello=ospfAreaRxHello, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIfWaitInterval=ospfIfWaitInterval, dnsStats=dnsStats, ospfInterface=ospfInterface, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ip_info=ip_info, iprouting=iprouting, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgGwArp=ipNewCfgGwArp, routeStatMaxEntries=routeStatMaxEntries, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumNbrDown=ospfCumNbrDown, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfGeneral=ospfGeneral, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumRxDatabase=ospfCumRxDatabase, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfUnloop=ospfIntfUnloop, arpStatEntries=arpStatEntries, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfRxHello=ospfIntfRxHello, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipRouteInfoInterface=ipRouteInfoInterface, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripNewCfgListen=ripNewCfgListen, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaNbrStart=ospfAreaNbrStart, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipCurCfgGwState=ipCurCfgGwState, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, arpInfoSrcPort=arpInfoSrcPort, ospfIntfRxlsReqs=ospfIntfRxlsReqs, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgGenState=vrrpNewCfgGenState, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ripStatInPkts=ripStatInPkts, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ripConfig=ripConfig, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumRxHello=ospfCumRxHello, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipCurCfgIntfState=ipCurCfgIntfState, ospfStartTime=ospfStartTime, ipNewCfgGwAddr=ipNewCfgGwAddr)
