...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfProcessUptime=ospfProcessUptime, ripNewCfgListen=ripNewCfgListen, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipNewCfgGwMetric=ipNewCfgGwMetric, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripConfig=ripConfig, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpOper=vrrpOper, ospfCumNbrStart=ospfCumNbrStart, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaRxHello=ospfAreaRxHello, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfIndex=ospfIntfIndex, ripNewCfgDefListen=ripNewCfgDefListen, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, arpInfoMacAddr=arpInfoMacAddr, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, arpInfoDestIp=arpInfoDestIp, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumTxHello=ospfCumTxHello, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpStatInAdvers=vrrpStatInAdvers, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipRouteInfoDestIp=ipRouteInfoDestIp, ipCurCfgIntfMask=ipCurCfgIntfMask, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaInfoId=ospfAreaInfoId, routeStatMaxEntries=routeStatMaxEntries, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfGeneralInfo=ospfGeneralInfo, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, arpStats=arpStats, ospfCumTxPkts=ospfCumTxPkts, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumRxTxStats=ospfCumRxTxStats, ospfTotalAreas=ospfTotalAreas, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, arpStatMaxEntries=arpStatMaxEntries, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaTxHello=ospfAreaTxHello, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfArea=ospfArea, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, arpInfoRefPorts=arpInfoRefPorts, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaIntfBackup=ospfAreaIntfBackup, routeStats=routeStats, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpStats=vrrpStats, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, routerLSAId=routerLSAId, ripCurCfgListen=ripCurCfgListen, ripStats=ripStats, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipInterfaceTableMax=ipInterfaceTableMax, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ripStatInPkts=ripStatInPkts, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaNbrDown=ospfAreaNbrDown, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrp=vrrp, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpGeneral=vrrpGeneral, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfNbrInExchState=ospfNbrInExchState, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ip_info=ip_info, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfTxPkts=ospfIntfTxPkts, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaIntfDown=ospfAreaIntfDown, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipRouteInfoType=ipRouteInfoType, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaRxPkts=ospfAreaRxPkts, arpInfoFlag=arpInfoFlag, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfDown=ospfIntfDown, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfNbrInInitState=ospfNbrInInitState, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfRxTxStats=ospfIntfRxTxStats, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfTableMaxSize=ospfIntfTableMaxSize, routeStatHighWater=routeStatHighWater, ospfIntfRxHello=ospfIntfRxHello, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumRxHello=ospfCumRxHello, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaNbrStart=ospfAreaNbrStart, ipNewCfgGwDelete=ipNewCfgGwDelete, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ripNewCfgState=ripNewCfgState, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIfInfoIndex=ospfIfInfoIndex, ipCurCfgIntfState=ipCurCfgIntfState, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgGwArp=ipCurCfgGwArp, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumNbrDown=ospfCumNbrDown, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfTxlsReqs=ospfIntfTxlsReqs, arpInfoVLAN=arpInfoVLAN, ospfCumIntfHello=ospfCumIntfHello, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumRxPkts=ospfCumRxPkts, ospfIntfUnloop=ospfIntfUnloop, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgGwAddr=ipCurCfgGwAddr, ripCurCfgState=ripCurCfgState, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCfg=ospfCfg, arpInfoSrcPort=arpInfoSrcPort, iprouting=iprouting, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfNbrChange=ospfIntfNbrChange, routeStatEntries=routeStatEntries, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ripStatRoutesAgedOut=ripStatRoutesAgedOut, dnsStats=dnsStats, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgGwTable=ipNewCfgGwTable, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipRouteInfoMask=ipRouteInfoMask, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfBackup=ospfIntfBackup, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ripNewCfgVip=ripNewCfgVip, arpStatHighWater=arpStatHighWater, ipForward=ipForward, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipRouteInfoInterface=ipRouteInfoInterface, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfGeneralStats=ospfGeneralStats, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIfWaitInterval=ospfIfWaitInterval, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfinfo=ospfinfo, ripNewCfgSupply=ripNewCfgSupply, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripStatOutPkts=ripStatOutPkts, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaInfoIndex=ospfAreaInfoIndex, ipRouteInfoEntry=ipRouteInfoEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfNbrInFullState=ospfNbrInFullState, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgGwState=ipNewCfgGwState, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfStats=ospfStats, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumNbrRstAd=ospfCumNbrRstAd, routerLSALinkData=routerLSALinkData, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, routerLSALinkIndex=routerLSALinkIndex, ospfCumIntfDown=ospfCumIntfDown, routerLSALinkID=routerLSALinkID, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipNewCfgGwArp=ipNewCfgGwArp, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfTxHello=ospfIntfTxHello, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCurCfgAreaId=ospfCurCfgAreaId, arpInfoTable=arpInfoTable, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfHello=ospfIntfHello, ripCurCfgVip=ripCurCfgVip, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, arpStatEntries=arpStatEntries)
