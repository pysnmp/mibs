...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpStatInAdvers=vrrpStatInAdvers, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfIndex=ospfIntfIndex, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfProcessUptime=ospfProcessUptime, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumTxDatabase=ospfCumTxDatabase, routeStatHighWater=routeStatHighWater, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumTxHello=ospfCumTxHello, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipNewCfgGwState=ipNewCfgGwState, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfDown=ospfIntfDown, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumRxDatabase=ospfCumRxDatabase, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfHello=ospfIntfHello, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCumIntfLoop=ospfCumIntfLoop, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfNbrN1way=ospfIntfNbrN1way, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfNewCfgAreaId=ospfNewCfgAreaId, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaRxHello=ospfAreaRxHello, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgGwEntry=ipCurCfgGwEntry, ipForward=ipForward, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumNbrhello=ospfCumNbrhello, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfNbrDown=ospfIntfNbrDown, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfNbrInFullState=ospfNbrInFullState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, routerLSALinkID=routerLSALinkID, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgGwMetric=ipCurCfgGwMetric, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, arpStatEntries=arpStatEntries, ospfIntfNbrChange=ospfIntfNbrChange, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfBackup=ospfIntfBackup, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipGatewayTableMax=ipGatewayTableMax, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaNbrStart=ospfAreaNbrStart, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfNbrInInitState=ospfNbrInInitState, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgGwVlan=ipNewCfgGwVlan, arpInfoVLAN=arpInfoVLAN, ospfGeneralInfo=ospfGeneralInfo, ospfCumRxHello=ospfCumRxHello, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfLoop=ospfIntfLoop, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCfg=ospfCfg, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipRouteInfoType=ipRouteInfoType, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaInfoId=ospfAreaInfoId, ripStatInErrorPkts=ripStatInErrorPkts, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ripCurCfgVip=ripCurCfgVip, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfinfo=ospfinfo, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumTxlsAcks=ospfCumTxlsAcks, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, arpInfoEntry=arpInfoEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, arpInfoDestIp=arpInfoDestIp, ipNewCfgGwArp=ipNewCfgGwArp, ripConfig=ripConfig, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ip_info=ip_info, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ripStats=ripStats, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgGwArp=ipCurCfgGwArp, ospfIfInfoIndex=ospfIfInfoIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgGenState=vrrpNewCfgGenState, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfStats=ospfStats, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfTotalTransitAreas=ospfTotalTransitAreas, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripNewCfgDefListen=ripNewCfgDefListen, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfHostTableMaxSize=ospfHostTableMaxSize, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ripCurCfgListen=ripCurCfgListen, ripNewCfgListen=ripNewCfgListen, ipNewCfgGwIndex=ipNewCfgGwIndex, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfArea=ospfArea, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ripStatOutPkts=ripStatOutPkts, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfChangeStats=ospfIntfChangeStats, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, routerLSALinkData=routerLSALinkData, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, arpStatMaxEntries=arpStatMaxEntries, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfInterface=ospfInterface, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgBootpState=ipCurCfgBootpState, arpInfoTable=arpInfoTable, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, routerLSAId=routerLSAId, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrp=vrrp, ospfIntfInfoTable=ospfIntfInfoTable, vrrpGeneral=vrrpGeneral, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipCurCfgGwState=ipCurCfgGwState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfUnloop=ospfIntfUnloop, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpOper=vrrpOper, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumIntfDown=ospfCumIntfDown, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipInterfaceTableMax=ipInterfaceTableMax, arpInfoSrcPort=arpInfoSrcPort, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfStartTime=ospfStartTime, ospfIntfTxlsAcks=ospfIntfTxlsAcks, arpInfoFlag=arpInfoFlag, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumNbrDown=ospfCumNbrDown, ipRouteInfoTag=ipRouteInfoTag, routeStats=routeStats, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgIntfMask=ipCurCfgIntfMask, arpStatHighWater=arpStatHighWater, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfNewCfgAreaTable=ospfNewCfgAreaTable, arpStats=arpStats, iprouting=iprouting, dnsStats=dnsStats, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumNbrBadSequence=ospfCumNbrBadSequence, arpInfoRefPorts=arpInfoRefPorts, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpStats=vrrpStats, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ripStatInPkts=ripStatInPkts, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, routerLSAAreaIndex=routerLSAAreaIndex, ospfGeneralStats=ospfGeneralStats, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfGeneral=ospfGeneral, vrrp_info=vrrp_info, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgGwTable=ipCurCfgGwTable, ipRouteInfoGateway=ipRouteInfoGateway, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumIntfBackup=ospfCumIntfBackup, ipCurCfgGwIndex=ipCurCfgGwIndex, ripCurCfgState=ripCurCfgState, ipNewCfgGwTable=ipNewCfgGwTable, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipRouteInfoMask=ipRouteInfoMask, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfNbrStart=ospfIntfNbrStart, routeStatMaxEntries=routeStatMaxEntries, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval)
