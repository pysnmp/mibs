...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfLsTypesSupported=ospfLsTypesSupported, iprouting=iprouting, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipRouteInfoIndx=ipRouteInfoIndx, ripStats=ripStats, ipNewCfgIntfDelete=ipNewCfgIntfDelete, arpInfoVLAN=arpInfoVLAN, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumIntfHello=ospfCumIntfHello, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfTotalTransitAreas=ospfTotalTransitAreas, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaChangeStats=ospfAreaChangeStats, routerLSALinkIndex=routerLSALinkIndex, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaInfoEntry=ospfAreaInfoEntry, arpInfoTable=arpInfoTable, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaTxPkts=ospfAreaTxPkts, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaNbrhello=ospfAreaNbrhello, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipRouteInfoEntry=ipRouteInfoEntry, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, routeStatEntries=routeStatEntries, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfNbrStart=ospfIntfNbrStart, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgIfTable=vrrpCurCfgIfTable, arpStats=arpStats, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgGwInterval=ipCurCfgGwInterval, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrp=vrrp, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfProcessUptime=ospfProcessUptime, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfNbrChange=ospfIntfNbrChange, ospfGeneralStats=ospfGeneralStats, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripConfig=ripConfig, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripCurCfgState=ripCurCfgState, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumTxPkts=ospfCumTxPkts, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumTxlsAcks=ospfCumTxlsAcks, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, routerLSAAreaIndex=routerLSAAreaIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgGwEntry=ipCurCfgGwEntry, routeStatHighWater=routeStatHighWater, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfNbrN1way=ospfIntfNbrN1way, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfRxHello=ospfIntfRxHello, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipRouteInfoTable=ipRouteInfoTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfHello=ospfIntfHello, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, arpStatMaxEntries=arpStatMaxEntries, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaRxHello=ospfAreaRxHello, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfArea=ospfArea, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaIntfDown=ospfAreaIntfDown, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfLoop=ospfIntfLoop, ospfCumTxHello=ospfCumTxHello, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, arpStatHighWater=arpStatHighWater, ip_info=ip_info, vrrpOper=vrrpOper, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfDown=ospfIntfDown, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumNbrN1way=ospfCumNbrN1way, arpInfoMacAddr=arpInfoMacAddr, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripStatInPkts=ripStatInPkts, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfNbrIndex=ospfIntfNbrIndex, routerLSAId=routerLSAId, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, routeStats=routeStats, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, arpStatEntries=arpStatEntries, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpGeneral=vrrpGeneral, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfInterface=ospfInterface, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipForward=ipForward, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfBackup=ospfIntfBackup, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCfg=ospfCfg, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfGeneral=ospfGeneral, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaInfoId=ospfAreaInfoId, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ripNewCfgDefListen=ripNewCfgDefListen, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfNewCfgAreaId=ospfNewCfgAreaId, ripCurCfgSupply=ripCurCfgSupply, ripCurCfgVip=ripCurCfgVip, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfStartTime=ospfStartTime, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfStats=ospfStats, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumNbrRstAd=ospfCumNbrRstAd, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfNbrhello=ospfIntfNbrhello, vrrpStats=vrrpStats, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripNewCfgState=ripNewCfgState, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfTxDatabase=ospfIntfTxDatabase, arpInfoEntry=arpInfoEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumRxHello=ospfCumRxHello, ospfTotalAreas=ospfTotalAreas, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumRxPkts=ospfCumRxPkts, ripNewCfgListen=ripNewCfgListen, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ripStatOutPkts=ripStatOutPkts, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ripCurCfgListen=ripCurCfgListen, ospfCumNbrhello=ospfCumNbrhello, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, routerLSALinkData=routerLSALinkData, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaIntfLoop=ospfAreaIntfLoop, routerLSALinkID=routerLSALinkID, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripNewCfgSupply=ripNewCfgSupply, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipRouteInfoTag=ipRouteInfoTag, arpInfoDestIp=arpInfoDestIp, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgBootpState=ipNewCfgBootpState, vrrp_info=vrrp_info, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgIntfAddr=ipCurCfgIntfAddr, dnsStats=dnsStats)
