...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpInfoMacAddr=arpInfoMacAddr, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaTxHello=ospfAreaTxHello, ipFwdNewCfgState=ipFwdNewCfgState, ripStatInPkts=ripStatInPkts, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfNbrInExchState=ospfNbrInExchState, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfinfo=ospfinfo, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfTotalNssaAreas=ospfTotalNssaAreas, routerLSAAreaIndex=routerLSAAreaIndex, arpStats=arpStats, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCurCfgAreaId=ospfCurCfgAreaId, arpInfoTable=arpInfoTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipForward=ipForward, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfDown=ospfIntfDown, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgGwState=ipNewCfgGwState, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfArea=ospfArea, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipNewCfgIntfState=ipNewCfgIntfState, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumIntfHello=ospfCumIntfHello, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, arpStatEntries=arpStatEntries, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfStats=ospfStats, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfNbrChange=ospfIntfNbrChange, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIfWaitInterval=ospfIfWaitInterval, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ripNewCfgDefListen=ripNewCfgDefListen, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfHello=ospfIntfHello, ospfCfg=ospfCfg, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfInterface=ospfInterface, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ripCurCfgVip=ripCurCfgVip, ospfCumIntfDown=ospfCumIntfDown, ipRouteInfoTag=ipRouteInfoTag, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, routeStatHighWater=routeStatHighWater, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgIntfAddr=ipCurCfgIntfAddr, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaNbrDown=ospfAreaNbrDown, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgIntfMask=ipCurCfgIntfMask, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfTotalNeighbours=ospfTotalNeighbours, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripNewCfgSupply=ripNewCfgSupply, ipNewCfgBootpState=ipNewCfgBootpState, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfStartTime=ospfStartTime, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumTxHello=ospfCumTxHello, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaTxPkts=ospfAreaTxPkts, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripCurCfgListen=ripCurCfgListen, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfRxHello=ospfIntfRxHello, ipCurCfgGwRetry=ipCurCfgGwRetry, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfLsTypesSupported=ospfLsTypesSupported, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaChangeStats=ospfAreaChangeStats, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, routerLSALinkIfIndex=routerLSALinkIfIndex, arpStatHighWater=arpStatHighWater, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipNewCfgGwTable=ipNewCfgGwTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaInfoId=ospfAreaInfoId, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaRxHello=ospfAreaRxHello, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfTotalAreas=ospfTotalAreas, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, routeStats=routeStats, ipRouteInfoMask=ipRouteInfoMask, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, routerLSALinkID=routerLSALinkID, ipNewCfgIntfEntry=ipNewCfgIntfEntry, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, arpInfoDestIp=arpInfoDestIp, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfGeneralInfo=ospfGeneralInfo, arpInfoEntry=arpInfoEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrp_info=vrrp_info, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ripNewCfgState=ripNewCfgState, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfHostTableMaxSize=ospfHostTableMaxSize, ripNewCfgListen=ripNewCfgListen, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfBackup=ospfIntfBackup, ospfAreaNbrIndex=ospfAreaNbrIndex, routeStatEntries=routeStatEntries, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumTxPkts=ospfCumTxPkts, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfLoop=ospfIntfLoop, iprouting=iprouting, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumNbrStart=ospfCumNbrStart, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfGeneralStats=ospfGeneralStats, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaInfoEntry=ospfAreaInfoEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCumIntfLoop=ospfCumIntfLoop, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipRouteInfoEntry=ipRouteInfoEntry, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumNbrhello=ospfCumNbrhello, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfNbrInInitState=ospfNbrInInitState, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripStats=ripStats, vrrpStatInAdvers=vrrpStatInAdvers, vrrpIfTableMaxSize=vrrpIfTableMaxSize, dnsStats=dnsStats, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfRxPkts=ospfIntfRxPkts, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ip_info=ip_info, vrrp=vrrp, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumRxPkts=ospfCumRxPkts, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, arpStatMaxEntries=arpStatMaxEntries, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumRxDatabase=ospfCumRxDatabase, vrrpOper=vrrpOper, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfUnloop=ospfIntfUnloop, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaNbrhello=ospfAreaNbrhello, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumNbrN1way=ospfCumNbrN1way, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, arpInfoVLAN=arpInfoVLAN, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ripConfig=ripConfig, ospfCumRxlsReqs=ospfCumRxlsReqs, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex)
