...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripConfig=ripConfig, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, routeStatHighWater=routeStatHighWater, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgIntfMask=ipCurCfgIntfMask, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfNbrInExchState=ospfNbrInExchState, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ripNewCfgDefListen=ripNewCfgDefListen, ipForward=ipForward, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCfg=ospfCfg, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfTotalAreas=ospfTotalAreas, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, arpInfoTable=arpInfoTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaChangeStats=ospfAreaChangeStats, ospfInterface=ospfInterface, ospfIntfLoop=ospfIntfLoop, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfArea=ospfArea, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipRouteInfoType=ipRouteInfoType, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, arpInfoEntry=arpInfoEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgIntfTable=ipCurCfgIntfTable, ipRouteInfoMask=ipRouteInfoMask, routeStats=routeStats, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfChangeStats=ospfIntfChangeStats, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, arpInfoFlag=arpInfoFlag, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfBackup=ospfIntfBackup, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfNbrhello=ospfIntfNbrhello, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, arpInfoDestIp=arpInfoDestIp, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, arpStatHighWater=arpStatHighWater, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaNbrN1way=ospfAreaNbrN1way, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfProcessUptime=ospfProcessUptime, routerLSALinkIndex=routerLSALinkIndex, routeStatEntries=routeStatEntries, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ripStatOutPkts=ripStatOutPkts, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumIntfBackup=ospfCumIntfBackup, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfStartTime=ospfStartTime, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgIntfEntry=ipCurCfgIntfEntry, arpStats=arpStats, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, routerLSAId=routerLSAId, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, dnsStats=dnsStats, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripStats=ripStats, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumIntfHello=ospfCumIntfHello, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, routerLSALinkID=routerLSALinkID, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipRouteInfoDestIp=ipRouteInfoDestIp, ipCurCfgGwInterval=ipCurCfgGwInterval, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ip_info=ip_info, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgIfTable=vrrpNewCfgIfTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ripCurCfgSupply=ripCurCfgSupply, ripCurCfgState=ripCurCfgState, ipRouteInfoIndx=ipRouteInfoIndx, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrp=vrrp, ipNewCfgGwDelete=ipNewCfgGwDelete, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumRxHello=ospfCumRxHello, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, arpStatEntries=arpStatEntries, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, iprouting=iprouting, ospfAreaNbrDown=ospfAreaNbrDown, routerLSAAreaIndex=routerLSAAreaIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfGeneralInfo=ospfGeneralInfo, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripCurCfgVip=ripCurCfgVip, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpOper=vrrpOper, vrrp_info=vrrp_info, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgGwTable=ipCurCfgGwTable, routeStatMaxEntries=routeStatMaxEntries, arpInfoVLAN=arpInfoVLAN, ipCurCfgIntfState=ipCurCfgIntfState, ipRouteInfoTable=ipRouteInfoTable, ospfIntfTxHello=ospfIntfTxHello, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipRouteInfoEntry=ipRouteInfoEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaRxHello=ospfAreaRxHello, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfHello=ospfIntfHello, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfUnloop=ospfIntfUnloop, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgGenState=vrrpNewCfgGenState, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumNbrDown=ospfCumNbrDown, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ripNewCfgState=ripNewCfgState, ospfIntfNbrN1way=ospfIntfNbrN1way, routerLSALinkData=routerLSALinkData, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ripStatInPkts=ripStatInPkts, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumNbrN1way=ospfCumNbrN1way, ospfStats=ospfStats, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgGwAddr=ipCurCfgGwAddr, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgGwState=ipNewCfgGwState, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumIntfLoop=ospfCumIntfLoop, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfGeneralStats=ospfGeneralStats, vrrpGeneral=vrrpGeneral, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfGeneral=ospfGeneral, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumNbrStart=ospfCumNbrStart, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ripNewCfgVip=ripNewCfgVip, ospfIntfNbrChange=ospfIntfNbrChange, ripNewCfgSupply=ripNewCfgSupply, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumNbrRstAd=ospfCumNbrRstAd, ipGatewayTableMax=ipGatewayTableMax, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgGwState=ipCurCfgGwState, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumTxHello=ospfCumTxHello, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, arpInfoRefPorts=arpInfoRefPorts)
