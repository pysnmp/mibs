...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, arpInfoMacAddr=arpInfoMacAddr, ripNewCfgListen=ripNewCfgListen, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaIntfIndex=ospfAreaIntfIndex, ipGatewayTableMax=ipGatewayTableMax, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, routerLSAId=routerLSAId, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrp=vrrp, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipRouteInfoTag=ipRouteInfoTag, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumRxDatabase=ospfCumRxDatabase, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCumNbrStart=ospfCumNbrStart, ripStatOutPkts=ripStatOutPkts, ipNewCfgIntfVlan=ipNewCfgIntfVlan, arpStats=arpStats, vrrpOper=vrrpOper, ripCurCfgSupply=ripCurCfgSupply, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgGwTable=ipNewCfgGwTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgGwTable=ipCurCfgGwTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumRxTxStats=ospfCumRxTxStats, ripStatInErrorPkts=ripStatInErrorPkts, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, arpInfoTable=arpInfoTable, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripNewCfgState=ripNewCfgState, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumNbrN1way=ospfCumNbrN1way, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumTxPkts=ospfCumTxPkts, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfTxHello=ospfIntfTxHello, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgGwArp=ipCurCfgGwArp, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfRxHello=ospfIntfRxHello, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaTxHello=ospfAreaTxHello, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgBootpState=ipCurCfgBootpState, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfArea=ospfArea, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfNbrChange=ospfIntfNbrChange, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, arpInfoVLAN=arpInfoVLAN, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfHello=ospfIntfHello, ospfAreaInfoEntry=ospfAreaInfoEntry, ripConfig=ripConfig, ospfTotalNssaAreas=ospfTotalNssaAreas, ipRouteInfoMask=ipRouteInfoMask, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumNbrDown=ospfCumNbrDown, routerLSALinkData=routerLSALinkData, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgGwState=ipNewCfgGwState, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaRxHello=ospfAreaRxHello, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumIntfDown=ospfCumIntfDown, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrp_info=vrrp_info, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumRxlsReqs=ospfCumRxlsReqs, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfProcessUptime=ospfProcessUptime, ospfinfo=ospfinfo, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, dnsStats=dnsStats, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, arpInfoFlag=arpInfoFlag, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaNbrhello=ospfAreaNbrhello, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, routeStatEntries=routeStatEntries, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaRxPkts=ospfAreaRxPkts, arpInfoEntry=arpInfoEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfIndex=ospfIntfIndex, ospfIntfUnloop=ospfIntfUnloop, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumTxDatabase=ospfCumTxDatabase, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfGeneral=ospfGeneral, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, routerLSAAreaIndex=routerLSAAreaIndex, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumTxlsAcks=ospfCumTxlsAcks, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ip_info=ip_info, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipForward=ipForward, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ripCurCfgState=ripCurCfgState, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, routeStatMaxEntries=routeStatMaxEntries, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfTotalAreas=ospfTotalAreas, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, routeStatHighWater=routeStatHighWater, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfCountForRouter=ospfIntfCountForRouter, ipNewCfgGwVlan=ipNewCfgGwVlan, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, routerLSALinkID=routerLSALinkID, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipFwdCurCfgPortState=ipFwdCurCfgPortState, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, ripStatInPkts=ripStatInPkts, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ripStats=ripStats, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfNbrInInitState=ospfNbrInInitState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfBackup=ospfIntfBackup, iprouting=iprouting, ipCurCfgIntfState=ipCurCfgIntfState, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfStats=ospfStats, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgIntfVlan=ipCurCfgIntfVlan, arpInfoRefPorts=arpInfoRefPorts, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, routerLSALinkIndex=routerLSALinkIndex, ospfGeneralStats=ospfGeneralStats, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCfg=ospfCfg, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpStats=vrrpStats, ospfAreaNbrDown=ospfAreaNbrDown, routeStats=routeStats, ospfCumRxPkts=ospfCumRxPkts, ospfGeneralInfo=ospfGeneralInfo, arpInfoSrcPort=arpInfoSrcPort, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfStartTime=ospfStartTime, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumRxHello=ospfCumRxHello, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfDown=ospfIntfDown, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCurCfgAreaId=ospfCurCfgAreaId, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfRxTxStats=ospfIntfRxTxStats, ripNewCfgVip=ripNewCfgVip, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority)
