...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ripCurCfgVip=ripCurCfgVip, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgGwTable=ipCurCfgGwTable, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipRouteInfoIndx=ipRouteInfoIndx, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfTotalAreas=ospfTotalAreas, routerLSAId=routerLSAId, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgGwAddr=ipNewCfgGwAddr, ipCurCfgGwEntry=ipCurCfgGwEntry, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfUnloop=ospfIntfUnloop, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ripNewCfgVip=ripNewCfgVip, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaIntfIndex=ospfAreaIntfIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaInfoId=ospfAreaInfoId, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfGeneralInfo=ospfGeneralInfo, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaRxHello=ospfAreaRxHello, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipForward=ipForward, routeStatEntries=routeStatEntries, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, arpInfoTable=arpInfoTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaNbrhello=ospfAreaNbrhello, ospfCurCfgAreaId=ospfCurCfgAreaId, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrhello=ospfIntfNbrhello, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, arpInfoSrcPort=arpInfoSrcPort, ospfGeneral=ospfGeneral, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfTableMaxSize=ospfIntfTableMaxSize, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumTxHello=ospfCumTxHello, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgGwState=ipNewCfgGwState, ipCurCfgGwArp=ipCurCfgGwArp, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfIndex=ospfIntfIndex, arpStats=arpStats, ospfCumTxPkts=ospfCumTxPkts, ipCurCfgGwState=ipCurCfgGwState, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, routeStats=routeStats, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, arpInfoVLAN=arpInfoVLAN, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfRxTxIndex=ospfIntfRxTxIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfStats=ospfStats, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfTxDatabase=ospfIntfTxDatabase, ripNewCfgSupply=ripNewCfgSupply, ospfCumRxHello=ospfCumRxHello, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, routerLSALinkID=routerLSALinkID, ipNewCfgGwEntry=ipNewCfgGwEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfinfo=ospfinfo, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripNewCfgState=ripNewCfgState, ospfCumRxPkts=ospfCumRxPkts, ospfCumTxDatabase=ospfCumTxDatabase, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaIntfDown=ospfAreaIntfDown, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumNbrN1way=ospfCumNbrN1way, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrp_info=vrrp_info, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ripStats=ripStats, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumRxDatabase=ospfCumRxDatabase, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfStartTime=ospfStartTime, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfArea=ospfArea, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfNbrChange=ospfIntfNbrChange, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfRangeTableMaxSize=ospfRangeTableMaxSize, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, arpStatEntries=arpStatEntries, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgGwInterval=ipNewCfgGwInterval)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, routeStatMaxEntries=routeStatMaxEntries, vrrpOper=vrrpOper, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripConfig=ripConfig, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfDown=ospfIntfDown, ipNewCfgIntfMask=ipNewCfgIntfMask, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfLsTypesSupported=ospfLsTypesSupported, ripNewCfgListen=ripNewCfgListen, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, iprouting=iprouting, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgBootpState=ipCurCfgBootpState, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrp=vrrp, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgGwArp=ipNewCfgGwArp, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfHello=ospfIntfHello, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfLoop=ospfIntfLoop, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumIntfHello=ospfCumIntfHello, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ip_info=ip_info, routerLSALinkIndex=routerLSALinkIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ripCurCfgState=ripCurCfgState, ipNewCfgGwTable=ipNewCfgGwTable, ipRouteInfoTable=ipRouteInfoTable, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpGeneral=vrrpGeneral, ospfAreaTxPkts=ospfAreaTxPkts, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, routerLSALinkData=routerLSALinkData, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaNbrN1way=ospfAreaNbrN1way, arpInfoFlag=arpInfoFlag, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCfg=ospfCfg, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaInfoTable=ospfAreaInfoTable, ospfNewCfgAreaId=ospfNewCfgAreaId, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIfTotalNeighbours=ospfIfTotalNeighbours, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipRouteInfoMask=ipRouteInfoMask, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaTxHello=ospfAreaTxHello, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipRouteInfoType=ipRouteInfoType, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfBackup=ospfIntfBackup, ripStatInPkts=ripStatInPkts, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgIntfState=ipCurCfgIntfState, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfProcessUptime=ospfProcessUptime, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdNewCfgState=ipFwdNewCfgState, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ripNewCfgDefListen=ripNewCfgDefListen, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, dnsStats=dnsStats, ospfCumNbrhello=ospfCumNbrhello, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfNbrInInitState=ospfNbrInInitState, ospfAreaNbrDown=ospfAreaNbrDown, arpInfoMacAddr=arpInfoMacAddr, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumIntfDown=ospfCumIntfDown)
