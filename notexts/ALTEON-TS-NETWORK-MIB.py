...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", routerLSALinkIndex=routerLSALinkIndex, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ripNewCfgSupply=ripNewCfgSupply, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfStats=ospfStats, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumNbrhello=ospfCumNbrhello, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumIntfUnloop=ospfCumIntfUnloop, arpInfoTable=arpInfoTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripCurCfgSupply=ripCurCfgSupply, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, routerLSALinkData=routerLSALinkData, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumTxlsAcks=ospfCumTxlsAcks, ip_info=ip_info, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumNbrStart=ospfCumNbrStart, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumRxPkts=ospfCumRxPkts, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumRxDatabase=ospfCumRxDatabase, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgGwState=ipNewCfgGwState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaIntfHello=ospfAreaIntfHello, ospfTotalNeighbours=ospfTotalNeighbours, dnsStats=dnsStats, vrrp=vrrp, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, routeStatHighWater=routeStatHighWater, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ripNewCfgVip=ripNewCfgVip, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgGwTable=ipNewCfgGwTable, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, routerLSAId=routerLSAId, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipRouteInfoTable=ipRouteInfoTable, arpInfoFlag=arpInfoFlag, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfRxHello=ospfIntfRxHello, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipRouteInfoInterface=ipRouteInfoInterface, ospfStartTime=ospfStartTime, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgGwArp=ipNewCfgGwArp, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ripNewCfgDefListen=ripNewCfgDefListen, ipRouteInfoType=ipRouteInfoType, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfInterface=ospfInterface, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgBootpState=ipCurCfgBootpState, routeStats=routeStats, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipInterfaceTableMax=ipInterfaceTableMax, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfNbrInInitState=ospfNbrInInitState, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgGwState=ipCurCfgGwState, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipCurCfgGwAddr=ipCurCfgGwAddr, ripStatInPkts=ripStatInPkts, ipForward=ipForward, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfUnloop=ospfIntfUnloop, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpStats=vrrpStats, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumTxHello=ospfCumTxHello, arpStatHighWater=arpStatHighWater, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpGeneral=vrrpGeneral, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfTotalAreas=ospfTotalAreas, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfArea=ospfArea, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumTxPkts=ospfCumTxPkts, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfTmrsKckOffHello=ospfTmrsKckOffHello)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfLoop=ospfIntfLoop, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrp_info=vrrp_info, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfInfoEntry=ospfIntfInfoEntry, ipRouteInfoMask=ipRouteInfoMask, iprouting=iprouting, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfNbrIndex=ospfIntfNbrIndex, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, routeStatEntries=routeStatEntries, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfChangeStats=ospfIntfChangeStats, ripNewCfgState=ripNewCfgState, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaInfoIndex=ospfAreaInfoIndex, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaNbrStart=ospfAreaNbrStart, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ripStatOutPkts=ripStatOutPkts, ripStats=ripStats, ospfIntfNbrhello=ospfIntfNbrhello, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumRxHello=ospfCumRxHello, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumIntfDown=ospfCumIntfDown, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCfg=ospfCfg, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ripCurCfgVip=ripCurCfgVip, ospfGeneral=ospfGeneral, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ripCurCfgState=ripCurCfgState, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumIntfHello=ospfCumIntfHello, ospfIntfIndex=ospfIntfIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgIntfEntry=ipNewCfgIntfEntry, routeStatMaxEntries=routeStatMaxEntries, ripNewCfgListen=ripNewCfgListen, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumIntfLoop=ospfCumIntfLoop, ospfinfo=ospfinfo, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgBootpState=ipNewCfgBootpState, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfTxlsAcks=ospfIntfTxlsAcks, arpStats=arpStats, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, arpStatEntries=arpStatEntries, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfCountForRouter=ospfIntfCountForRouter, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, arpInfoVLAN=arpInfoVLAN, ripConfig=ripConfig, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfTxPkts=ospfIntfTxPkts, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfHello=ospfIntfHello, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpOper=vrrpOper, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgIntfState=ipNewCfgIntfState, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpStatInAdvers=vrrpStatInAdvers, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID)
