...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrp_info=vrrp_info, ripCurCfgState=ripCurCfgState, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripStats=ripStats, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, arpStatHighWater=arpStatHighWater, ospfIntfBackup=ospfIntfBackup, routeStatEntries=routeStatEntries, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, dnsStats=dnsStats, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ripCurCfgDefListen=ripCurCfgDefListen, ospfProcessUptime=ospfProcessUptime, ospfCumIntfHello=ospfCumIntfHello, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ripNewCfgState=ripNewCfgState, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaIntfDown=ospfAreaIntfDown, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfNbrInExchState=ospfNbrInExchState, ospfCumTxDatabase=ospfCumTxDatabase, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgGwAddr=ipNewCfgGwAddr, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfRxHello=ospfIntfRxHello, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfNbrhello=ospfIntfNbrhello, ripConfig=ripConfig, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfGeneral=ospfGeneral, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, arpInfoRefPorts=arpInfoRefPorts, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ripCurCfgSupply=ripCurCfgSupply, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaRxHello=ospfAreaRxHello, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, arpInfoSrcPort=arpInfoSrcPort, vrrpStats=vrrpStats, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCumNbrStart=ospfCumNbrStart, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipRouteInfoTable=ipRouteInfoTable, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCfg=ospfCfg, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ripStatOutPkts=ripStatOutPkts, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfTotalTransitAreas=ospfTotalTransitAreas, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgIntfMask=ipNewCfgIntfMask, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumIntfDown=ospfCumIntfDown, ospfRangeTableMaxSize=ospfRangeTableMaxSize, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfInterface=ospfInterface, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfLoop=ospfIntfLoop, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfInfoTable=ospfIntfInfoTable, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, arpInfoMacAddr=arpInfoMacAddr, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipForward=ipForward, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfIndex=ospfIntfIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, routerLSALinkData=routerLSALinkData, routeStatHighWater=routeStatHighWater, ipNewCfgGwTable=ipNewCfgGwTable, ospfStartTime=ospfStartTime, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfTxDatabase=ospfIntfTxDatabase, arpStats=arpStats, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ripNewCfgListen=ripNewCfgListen, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumNbrDown=ospfCumNbrDown, routerLSAId=routerLSAId, ipCurCfgGwInterval=ipCurCfgGwInterval, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripStatInErrorPkts=ripStatInErrorPkts, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ip_info=ip_info, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ripNewCfgVip=ripNewCfgVip, ipRouteInfoMask=ipRouteInfoMask, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumIntfUnloop=ospfCumIntfUnloop, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfCountForRouter=ospfIntfCountForRouter)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, arpInfoEntry=arpInfoEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, arpInfoTable=arpInfoTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipGatewayTableMax=ipGatewayTableMax, routerLSAAreaIndex=routerLSAAreaIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfHello=ospfIntfHello, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumRxPkts=ospfCumRxPkts, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfDown=ospfIntfDown, ripCurCfgListen=ripCurCfgListen, vrrpOper=vrrpOper, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumTxPkts=ospfCumTxPkts, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, iprouting=iprouting, ipRouteInfoTag=ipRouteInfoTag, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgGwState=ipNewCfgGwState, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgGwState=ipCurCfgGwState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfGeneralInfo=ospfGeneralInfo, ospfIntfRxPkts=ospfIntfRxPkts, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCumNbrhello=ospfCumNbrhello, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgBootpAddr=ipNewCfgBootpAddr, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaInfoId=ospfAreaInfoId, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipInterfaceTableMax=ipInterfaceTableMax, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipRouteInfoType=ipRouteInfoType, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumIntfLoop=ospfCumIntfLoop, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfTxHello=ospfIntfTxHello, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaIntfHello=ospfAreaIntfHello, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumNbrBadRequests=ospfCumNbrBadRequests, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, arpStatEntries=arpStatEntries, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumRxlsUpdates=ospfCumRxlsUpdates, arpInfoVLAN=arpInfoVLAN, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ripStatInPkts=ripStatInPkts, ospfArea=ospfArea, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumRxHello=ospfCumRxHello, ipNewCfgIntfAddr=ipNewCfgIntfAddr, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrp=vrrp, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgGwEntry=ipNewCfgGwEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgIfTable=vrrpCurCfgIfTable, routerLSALinkIndex=routerLSALinkIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfStats=ospfStats, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgGwArp=ipNewCfgGwArp, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgIntfDelete=ipNewCfgIntfDelete, routeStats=routeStats, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd)
