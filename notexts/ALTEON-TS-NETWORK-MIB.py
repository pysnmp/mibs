...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumIntfNbrChange=ospfCumIntfNbrChange, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ripCurCfgDefListen=ripCurCfgDefListen, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, routeStats=routeStats, ripCurCfgListen=ripCurCfgListen, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumIntfLoop=ospfCumIntfLoop, vrrpStatInAdvers=vrrpStatInAdvers, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ripCurCfgVip=ripCurCfgVip, ospfArea=ospfArea, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, routerLSALinkData=routerLSALinkData, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfNbrInInitState=ospfNbrInInitState, ospfIntfUnloop=ospfIntfUnloop, ip_info=ip_info, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgGwState=ipNewCfgGwState, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, arpStats=arpStats, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipGatewayTableMax=ipGatewayTableMax, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, arpInfoEntry=arpInfoEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ripCurCfgStaticSupply=ripCurCfgStaticSupply, arpStatMaxEntries=arpStatMaxEntries, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumRxlsReqs=ospfCumRxlsReqs, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfTxDatabase=ospfIntfTxDatabase, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ripNewCfgState=ripNewCfgState, dnsStats=dnsStats, iprouting=iprouting, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfGeneral=ospfGeneral, ospfCumTxHello=ospfCumTxHello, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipRouteInfoType=ipRouteInfoType, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, routeStatMaxEntries=routeStatMaxEntries, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipRouteInfoMask=ipRouteInfoMask, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, arpStatHighWater=arpStatHighWater, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, arpInfoDestIp=arpInfoDestIp, ospfAreaChangeStats=ospfAreaChangeStats, ospfStats=ospfStats, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumIntfBackup=ospfCumIntfBackup, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ripConfig=ripConfig, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCfg=ospfCfg, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCumNbrDown=ospfCumNbrDown, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, arpInfoVLAN=arpInfoVLAN, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpOper=vrrpOper, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumNbrN1way=ospfCumNbrN1way, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, arpInfoMacAddr=arpInfoMacAddr, ripNewCfgListen=ripNewCfgListen, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, routerLSALinkIndex=routerLSALinkIndex, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfIndex=ospfIntfIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaTxHello=ospfAreaTxHello, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfRxHello=ospfIntfRxHello, ospfIntfLoop=ospfIntfLoop, ipForward=ipForward, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, arpStatEntries=arpStatEntries, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumIntfDown=ospfCumIntfDown, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgGwInterval=ipNewCfgGwInterval, routerLSAId=routerLSAId, ipFwdNewCfgState=ipFwdNewCfgState, ripCurCfgState=ripCurCfgState, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfBackup=ospfIntfBackup, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfInfoTable=ospfIntfInfoTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrp=vrrp, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, routeStatHighWater=routeStatHighWater, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpGeneral=vrrpGeneral, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumRxDatabase=ospfCumRxDatabase, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgGwMetric=ipNewCfgGwMetric, ripStats=ripStats, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfinfo=ospfinfo, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipInterfaceTableMax=ipInterfaceTableMax, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfHello=ospfIntfHello, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfWaitTimer=ospfIntfWaitTimer, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgIntfTable=ipNewCfgIntfTable, ripNewCfgVip=ripNewCfgVip, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfRxPkts=ospfIntfRxPkts, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgIntfTable=ipCurCfgIntfTable, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfNbrStart=ospfIntfNbrStart, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpStats=vrrpStats, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgGwRetry=ipNewCfgGwRetry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaRxHello=ospfAreaRxHello, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumNbrhello=ospfCumNbrhello, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumIntfHello=ospfCumIntfHello, ospfInterface=ospfInterface, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, routerLSALinkID=routerLSALinkID, vrrp_info=vrrp_info, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgBootpState=ipNewCfgBootpState, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumRxHello=ospfCumRxHello, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ripStatInPkts=ripStatInPkts, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfDown=ospfIntfDown, arpInfoFlag=arpInfoFlag, ospfTotalNeighbours=ospfTotalNeighbours, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipRouteInfoGateway=ipRouteInfoGateway, ipRouteInfoTag=ipRouteInfoTag, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfTotalAreas=ospfTotalAreas, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfGeneralStats=ospfGeneralStats, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfStartTime=ospfStartTime, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgGwArp=ipCurCfgGwArp, ospfLsTypesSupported=ospfLsTypesSupported, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipRouteInfoTable=ipRouteInfoTable, arpInfoRefPorts=arpInfoRefPorts, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaRxTxIndex=ospfAreaRxTxIndex, arpInfoTable=arpInfoTable, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumRxPkts=ospfCumRxPkts, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone)
