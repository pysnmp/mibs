...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripStatInPkts=ripStatInPkts, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, dnsStats=dnsStats, ipNewCfgIntfMask=ipNewCfgIntfMask, ipForward=ipForward, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfLsTypesSupported=ospfLsTypesSupported, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumTxPkts=ospfCumTxPkts, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfRxTxStats=ospfIntfRxTxStats, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaInfoId=ospfAreaInfoId, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipRouteInfoType=ipRouteInfoType, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgIfTable=vrrpNewCfgIfTable, routerLSALinkData=routerLSALinkData, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ripNewCfgListen=ripNewCfgListen, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, arpInfoEntry=arpInfoEntry, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIfWaitInterval=ospfIfWaitInterval, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ripCurCfgVip=ripCurCfgVip, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfInfoTable=ospfIntfInfoTable, ipRouteInfoInterface=ipRouteInfoInterface, ospfCfg=ospfCfg, ospfCumIntfHello=ospfCumIntfHello, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, routeStatMaxEntries=routeStatMaxEntries, vrrp=vrrp, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipNewCfgGwInterval=ipNewCfgGwInterval, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, arpStatEntries=arpStatEntries, routerLSALinkID=routerLSALinkID, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgIntfState=ipCurCfgIntfState, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipRouteInfoTable=ipRouteInfoTable, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgBootpState=ipNewCfgBootpState, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfProcessUptime=ospfProcessUptime, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgIntfState=ipNewCfgIntfState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfVlinkCountForRouter=ospfVlinkCountForRouter, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaInfoTable=ospfAreaInfoTable, ospfGeneral=ospfGeneral, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfGeneralStats=ospfGeneralStats, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ripStatOutPkts=ripStatOutPkts, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaRxlsAcks=ospfAreaRxlsAcks, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfChangeStats=ospfIntfChangeStats, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgGwRetry=ipNewCfgGwRetry, ipCurCfgBootpState=ipCurCfgBootpState, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpStatInAdvers=vrrpStatInAdvers, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpStats=vrrpStats, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ripNewCfgState=ripNewCfgState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumNbrStart=ospfCumNbrStart, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipInterfaceTableMax=ipInterfaceTableMax, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaRxPkts=ospfAreaRxPkts, routeStats=routeStats, ripStats=ripStats, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfHello=ospfIntfHello, ipCurCfgGwIndex=ipCurCfgGwIndex, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfStats=ospfStats, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, arpInfoTable=arpInfoTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfBackup=ospfIntfBackup, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgIntfTable=ipCurCfgIntfTable, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, routerLSAId=routerLSAId, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ip_info=ip_info, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfTotalAreas=ospfTotalAreas, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumIntfBackup=ospfCumIntfBackup, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, routeStatEntries=routeStatEntries, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaIntfIndex=ospfAreaIntfIndex, ripNewCfgDefListen=ripNewCfgDefListen, ospfInterface=ospfInterface, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgGwArp=ipNewCfgGwArp, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ripConfig=ripConfig, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpOper=vrrpOper, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfUnloop=ospfIntfUnloop, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpGeneral=vrrpGeneral, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumNbrhello=ospfCumNbrhello, arpInfoVLAN=arpInfoVLAN, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfHostTableMaxSize=ospfHostTableMaxSize, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipRouteInfoDestIp=ipRouteInfoDestIp, ripNewCfgSupply=ripNewCfgSupply, arpStats=arpStats, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfTxHello=ospfIntfTxHello, ospfAreaRxHello=ospfAreaRxHello, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaTxPkts=ospfAreaTxPkts, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, routerLSALinkIndex=routerLSALinkIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, arpStatHighWater=arpStatHighWater, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, routeStatHighWater=routeStatHighWater, ospfCumRxHello=ospfCumRxHello, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ripCurCfgListen=ripCurCfgListen, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipGatewayTableMax=ipGatewayTableMax, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, iprouting=iprouting, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfStartTime=ospfStartTime, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgGwEntry=ipNewCfgGwEntry, routerLSAAreaIndex=routerLSAAreaIndex, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfRxHello=ospfIntfRxHello, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfIndex=ospfIntfIndex, vrrp_info=vrrp_info, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumTxHello=ospfCumTxHello, ospfIntfDown=ospfIntfDown, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumNbrN1way=ospfCumNbrN1way, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfNbrDown=ospfIntfNbrDown, ripNewCfgVip=ripNewCfgVip, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfArea=ospfArea, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfGeneralInfo=ospfGeneralInfo, arpInfoSrcPort=arpInfoSrcPort, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumIntfDown=ospfCumIntfDown, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgGwInterval=ipCurCfgGwInterval)
