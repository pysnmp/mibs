...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfLsTypesSupported=ospfLsTypesSupported, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfUnloop=ospfIntfUnloop, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfTxlsReqs=ospfIntfTxlsReqs, dnsStats=dnsStats, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumRxlsAcks=ospfCumRxlsAcks, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, iprouting=iprouting, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfRxPkts=ospfIntfRxPkts, ripStats=ripStats, ospfAreaTxHello=ospfAreaTxHello, arpStatHighWater=arpStatHighWater, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrp_info=vrrp_info, ospfCumTxlsAcks=ospfCumTxlsAcks, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpOper=vrrpOper, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ripNewCfgDefListen=ripNewCfgDefListen, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfBackup=ospfIntfBackup, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ripConfig=ripConfig, vrrpCurCfgGenState=vrrpCurCfgGenState, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumTxDatabase=ospfCumTxDatabase, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaIntfHello=ospfAreaIntfHello, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, arpInfoFlag=arpInfoFlag, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpGeneral=vrrpGeneral, ripCurCfgSupply=ripCurCfgSupply, ospfIntfHello=ospfIntfHello, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaNbrN1way=ospfAreaNbrN1way, ipRouteInfoIndx=ipRouteInfoIndx, arpInfoSrcPort=arpInfoSrcPort, arpInfoMacAddr=arpInfoMacAddr, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIfTotalNeighbours=ospfIfTotalNeighbours, arpInfoRefPorts=arpInfoRefPorts, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfDown=ospfIntfDown, ipRouteInfoTag=ipRouteInfoTag, arpStats=arpStats, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaChangeStats=ospfAreaChangeStats, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfInterface=ospfInterface, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfStats=ospfStats, arpStatEntries=arpStatEntries, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumIntfDown=ospfCumIntfDown, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfLoop=ospfIntfLoop, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumRxHello=ospfCumRxHello, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfChangeStats=ospfIntfChangeStats, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, routerLSALinkIndex=routerLSALinkIndex, ripNewCfgState=ripNewCfgState, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumIntfNbrChange=ospfCumIntfNbrChange, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ip_info=ip_info, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfNbrhello=ospfIntfNbrhello, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfGeneralStats=ospfGeneralStats, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, routeStatHighWater=routeStatHighWater, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgGwState=ipCurCfgGwState, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipForward=ipForward, ipNewCfgGwDelete=ipNewCfgGwDelete, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, arpInfoEntry=arpInfoEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumNbrChangeStats=ospfCumNbrChangeStats)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripCurCfgDefListen=ripCurCfgDefListen, ospfNbrInInitState=ospfNbrInInitState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfTxPkts=ospfIntfTxPkts, ospfNbrInFullState=ospfNbrInFullState, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ripStatInPkts=ripStatInPkts, ospfCumTxPkts=ospfCumTxPkts, ipCurCfgGwEntry=ipCurCfgGwEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ripStatOutPkts=ripStatOutPkts, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfRxHello=ospfIntfRxHello, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfProcessUptime=ospfProcessUptime, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipInterfaceTableMax=ipInterfaceTableMax, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpStatInAdvers=vrrpStatInAdvers, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaNbrDown=ospfAreaNbrDown, vrrp=vrrp, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdNewCfgState=ipFwdNewCfgState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipRouteInfoType=ipRouteInfoType, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgGwState=ipNewCfgGwState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ripCurCfgState=ripCurCfgState, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipFwdCurCfgState=ipFwdCurCfgState, ripCurCfgListen=ripCurCfgListen, ospfIntfInfoTable=ospfIntfInfoTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgGwIndex=ipNewCfgGwIndex, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfGeneralInfo=ospfGeneralInfo, ospfStartTime=ospfStartTime, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaRxHello=ospfAreaRxHello, ospfIntfTxHello=ospfIntfTxHello, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfTotalAreas=ospfTotalAreas, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpStats=vrrpStats, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfCountForRouter=ospfIntfCountForRouter, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgGwTable=ipNewCfgGwTable, ospfArea=ospfArea, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripNewCfgSupply=ripNewCfgSupply, routerLSAId=routerLSAId, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumNbrStart=ospfCumNbrStart, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipRouteInfoMask=ipRouteInfoMask, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumIntfHello=ospfCumIntfHello, arpStatMaxEntries=arpStatMaxEntries, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfNbrDown=ospfIntfNbrDown, routeStatEntries=routeStatEntries, routerLSALinkID=routerLSALinkID, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCfg=ospfCfg, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, routerLSAAreaIndex=routerLSAAreaIndex, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, routeStatMaxEntries=routeStatMaxEntries, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgIntfTable=ipNewCfgIntfTable, ripNewCfgListen=ripNewCfgListen, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaTxDatabase=ospfAreaTxDatabase, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipRouteInfoDestIp=ipRouteInfoDestIp, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, routeStats=routeStats, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx)
