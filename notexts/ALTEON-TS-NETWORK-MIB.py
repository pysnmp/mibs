...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfNbrInInitState=ospfNbrInInitState, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrp_info=vrrp_info, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, routeStats=routeStats, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipCurCfgGwArp=ipCurCfgGwArp, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfArea=ospfArea, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumRxPkts=ospfCumRxPkts, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfHello=ospfIntfHello, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumIntfLoop=ospfCumIntfLoop, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfRxHello=ospfIntfRxHello, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfStats=ospfStats, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaNbrStart=ospfAreaNbrStart, ripCurCfgDefListen=ripCurCfgDefListen, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaNbrhello=ospfAreaNbrhello, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfStartTime=ospfStartTime, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, arpInfoEntry=arpInfoEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumTxPkts=ospfCumTxPkts, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpStats=vrrpStats, ipCurCfgIntfEntry=ipCurCfgIntfEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaNbrN1way=ospfAreaNbrN1way, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ripCurCfgState=ripCurCfgState, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, arpInfoMacAddr=arpInfoMacAddr, ospfCumNbrhello=ospfCumNbrhello, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfNbrhello=ospfIntfNbrhello, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipRouteInfoType=ipRouteInfoType, ospfGeneralInfo=ospfGeneralInfo, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfinfo=ospfinfo, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, arpInfoRefPorts=arpInfoRefPorts, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgGwState=ipCurCfgGwState, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfTotalAreas=ospfTotalAreas, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrp=vrrp, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipFwdNewCfgState=ipFwdNewCfgState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, arpInfoTable=arpInfoTable, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaTxHello=ospfAreaTxHello, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgGwState=ipNewCfgGwState, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfGeneral=ospfGeneral, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, routerLSALinkData=routerLSALinkData, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfProcessUptime=ospfProcessUptime, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgIntfMask=ipNewCfgIntfMask, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripStatOutPkts=ripStatOutPkts, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaRxTxStats=ospfAreaRxTxStats, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, routerLSALinkIndex=routerLSALinkIndex, ospfGeneralStats=ospfGeneralStats, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipFwdCurCfgState=ipFwdCurCfgState, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfInterface=ospfInterface, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ripNewCfgSupply=ripNewCfgSupply, ipRouteInfoTag=ipRouteInfoTag, vrrpGeneral=vrrpGeneral, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, routerLSAId=routerLSAId, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfTxHello=ospfIntfTxHello, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, routeStatHighWater=routeStatHighWater, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfTimersKickOffStats=ospfTimersKickOffStats, arpStatEntries=arpStatEntries, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfChangeStats=ospfIntfChangeStats, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ip_info=ip_info, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, arpInfoVLAN=arpInfoVLAN, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCfg=ospfCfg, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripConfig=ripConfig, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfUnloop=ospfIntfUnloop, routerLSALinkID=routerLSALinkID, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfRxTxStats=ospfIntfRxTxStats, dnsStats=dnsStats, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaNbrDown=ospfAreaNbrDown, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfNbrChange=ospfIntfNbrChange, arpInfoDestIp=arpInfoDestIp, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgGwDelete=ipNewCfgGwDelete, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgGwInterval=ipNewCfgGwInterval, iprouting=iprouting, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumIntfBackup=ospfCumIntfBackup, arpStatHighWater=arpStatHighWater, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, routeStatEntries=routeStatEntries, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipForward=ipForward, routeStatMaxEntries=routeStatMaxEntries, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ripNewCfgVip=ripNewCfgVip, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgGwRetry=ipNewCfgGwRetry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumNbrStart=ospfCumNbrStart, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfNbrInFullState=ospfNbrInFullState, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgGwTable=ipNewCfgGwTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgBootpState=ipCurCfgBootpState, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipRouteInfoIndx=ipRouteInfoIndx, routerLSALinkIfIndex=routerLSALinkIfIndex, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripCurCfgListen=ripCurCfgListen, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumTxDatabase=ospfCumTxDatabase, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfNbrRstAd=ospfIntfNbrRstAd, arpStats=arpStats, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgGwVlan=ipNewCfgGwVlan, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfBackup=ospfIntfBackup, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ripStats=ripStats, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCumNbrDown=ospfCumNbrDown, arpInfoFlag=arpInfoFlag, ospfAreaIntfLoop=ospfAreaIntfLoop)
