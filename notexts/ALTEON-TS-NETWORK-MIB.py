...
Gauge32, TimeTicks, MibIdentifier, Unsigned32, iso, Bits, ModuleIdentity, Counter32, IpAddress, Integer32, ObjectIdentity, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "MibIdentifier", "Unsigned32", "iso", "Bits", "ModuleIdentity", "Counter32", "IpAddress", "Integer32", "ObjectIdentity", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgGwIndex=ipCurCfgGwIndex, ipForward=ipForward, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ripStatInErrorPkts=ripStatInErrorPkts, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgGwState=ipNewCfgGwState, vrrpOper=vrrpOper, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, routeStatEntries=routeStatEntries, vrrpGeneral=vrrpGeneral, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaRxTxIndex=ospfAreaRxTxIndex, routeStatMaxEntries=routeStatMaxEntries, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, routeStats=routeStats, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, arpInfoVLAN=arpInfoVLAN, ospfCumRxTxStats=ospfCumRxTxStats, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfNbrInFullState=ospfNbrInFullState, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfInfoEntry=ospfIntfInfoEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdCurCfgState=ipFwdCurCfgState, arpStats=arpStats, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgIntfState=ipCurCfgIntfState, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfRxPkts=ospfIntfRxPkts, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ripNewCfgVip=ripNewCfgVip, ospfIntfNbrChange=ospfIntfNbrChange, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfNbrInInitState=ospfNbrInInitState, ospfIntfRxHello=ospfIntfRxHello, ospfCfg=ospfCfg, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, arpInfoEntry=arpInfoEntry, ipRouteInfoType=ipRouteInfoType, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIfWaitInterval=ospfIfWaitInterval, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaIntfLoop=ospfAreaIntfLoop, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumRxPkts=ospfCumRxPkts, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ripNewCfgSupply=ripNewCfgSupply, ospfTimersKickOffStats=ospfTimersKickOffStats, ip_info=ip_info, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfGeneral=ospfGeneral, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ripStatOutPkts=ripStatOutPkts, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfStats=ospfStats, arpInfoTable=arpInfoTable, ipRouteInfoInterface=ipRouteInfoInterface, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, routerLSAAreaIndex=routerLSAAreaIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgGwTable=ipCurCfgGwTable, ipRouteInfoTag=ipRouteInfoTag, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumRxlsAcks=ospfCumRxlsAcks, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumTxHello=ospfCumTxHello, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ripCurCfgListen=ripCurCfgListen, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaRxlsAcks=ospfAreaRxlsAcks, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripNewCfgState=ripNewCfgState, arpInfoFlag=arpInfoFlag, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfTotalAreas=ospfTotalAreas, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaInfoTable=ospfAreaInfoTable, arpInfoDestIp=arpInfoDestIp, ospfAreaChangeStats=ospfAreaChangeStats, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipCurCfgGwVlan=ipCurCfgGwVlan, ripConfig=ripConfig, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripNewCfgListen=ripNewCfgListen, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfHello=ospfIntfHello, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumRxDatabase=ospfCumRxDatabase, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfDown=ospfIntfDown, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaInfoId=ospfAreaInfoId, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ripStats=ripStats, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipRouteInfoMask=ipRouteInfoMask, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrp_info=vrrp_info, routerLSALinkData=routerLSALinkData, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgBootpAddr=ipCurCfgBootpAddr)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaRxHello=ospfAreaRxHello, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaNbrIndex=ospfAreaNbrIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaInfoIndex=ospfAreaInfoIndex, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfLoop=ospfIntfLoop, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumTxPkts=ospfCumTxPkts, dnsStats=dnsStats, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, arpStatEntries=arpStatEntries, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfNbrhello=ospfIntfNbrhello, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaNbrhello=ospfAreaNbrhello, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfChangeStats=ospfIntfChangeStats, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrp=vrrp, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ripCurCfgDefListen=ripCurCfgDefListen, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfBackup=ospfIntfBackup, ospfNbrInExchState=ospfNbrInExchState, ospfAreaNbrStart=ospfAreaNbrStart, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfInfoTable=ospfIntfInfoTable, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfLsTypesSupported=ospfLsTypesSupported, routerLSALinkIndex=routerLSALinkIndex, ripNewCfgDefListen=ripNewCfgDefListen, ripCurCfgState=ripCurCfgState, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpStats=vrrpStats, ospfAreaNbrDown=ospfAreaNbrDown, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, iprouting=iprouting, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, arpInfoMacAddr=arpInfoMacAddr, ospfInterface=ospfInterface, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumRxHello=ospfCumRxHello, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfIndex=ospfIntfIndex, ospfAreaIntfDown=ospfAreaIntfDown, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, routerLSALinkID=routerLSALinkID, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgIntfTable=ipCurCfgIntfTable, ipGatewayTableMax=ipGatewayTableMax, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfProcessUptime=ospfProcessUptime, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIfInfoIndex=ospfIfInfoIndex, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCumNbrhello=ospfCumNbrhello, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfArea=ospfArea, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumIntfUnloop=ospfCumIntfUnloop, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaTxPkts=ospfAreaTxPkts, ospfGeneralInfo=ospfGeneralInfo, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumNbrN1way=ospfCumNbrN1way)
