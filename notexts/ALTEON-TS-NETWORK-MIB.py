...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpInfoRefPorts=arpInfoRefPorts, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfRxHello=ospfIntfRxHello, ripCurCfgVip=ripCurCfgVip, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ripNewCfgSupply=ripNewCfgSupply, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfBackup=ospfIntfBackup, ripCurCfgListen=ripCurCfgListen, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripCurCfgState=ripCurCfgState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfNbrInInitState=ospfNbrInInitState, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgGwTable=ipNewCfgGwTable, vrrpStatInAdvers=vrrpStatInAdvers, arpStats=arpStats, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, arpStatEntries=arpStatEntries, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgGwArp=ipNewCfgGwArp, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfIndex=ospfIntfIndex, vrrp=vrrp, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCfg=ospfCfg, ospfCumRxDatabase=ospfCumRxDatabase, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfGeneralInfo=ospfGeneralInfo, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripCurCfgDefListen=ripCurCfgDefListen, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfStats=ospfStats, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaRxPkts=ospfAreaRxPkts, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumTxHello=ospfCumTxHello, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfLoop=ospfIntfLoop, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfinfo=ospfinfo, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfTimersKickOffStats=ospfTimersKickOffStats, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaChangeStats=ospfAreaChangeStats, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipRouteInfoMask=ipRouteInfoMask, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, arpInfoDestIp=arpInfoDestIp, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, arpInfoFlag=arpInfoFlag, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfChangeStats=ospfIntfChangeStats, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfGeneralStats=ospfGeneralStats, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, arpInfoTable=arpInfoTable, ospfCumTxDatabase=ospfCumTxDatabase, arpInfoEntry=arpInfoEntry, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ip_info=ip_info, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipRouteInfoInterface=ipRouteInfoInterface, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumNbrBadRequests=ospfCumNbrBadRequests, arpInfoSrcPort=arpInfoSrcPort, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumIntfHello=ospfCumIntfHello, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaRxHello=ospfAreaRxHello, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfGeneral=ospfGeneral, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ripStatOutPkts=ripStatOutPkts, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaNbrDown=ospfAreaNbrDown, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripStatInPkts=ripStatInPkts, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfVlinkCountForRouter=ospfVlinkCountForRouter, routerLSAId=routerLSAId, routeStatMaxEntries=routeStatMaxEntries, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaInfoEntry=ospfAreaInfoEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, dnsStats=dnsStats, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, routeStatEntries=routeStatEntries, routeStatHighWater=routeStatHighWater, vrrpGeneral=vrrpGeneral, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgGwArp=ipCurCfgGwArp, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgGwState=ipCurCfgGwState, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumRxHello=ospfCumRxHello, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ripStats=ripStats, ipNewCfgGwState=ipNewCfgGwState, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpOper=vrrpOper, ospfAreaNbrStart=ospfAreaNbrStart, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumRxlsAcks=ospfCumRxlsAcks, ipForward=ipForward, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumRxPkts=ospfCumRxPkts, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfNbrInExchState=ospfNbrInExchState, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, routeStats=routeStats, ospfStartTime=ospfStartTime, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgGwEntry=ipCurCfgGwEntry, ipRouteInfoIndx=ipRouteInfoIndx, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrp_info=vrrp_info, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ripNewCfgVip=ripNewCfgVip, ospfIntfTxPkts=ospfIntfTxPkts, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumNbrStart=ospfCumNbrStart, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, iprouting=iprouting, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ripConfig=ripConfig, ospfAreaNbrhello=ospfAreaNbrhello, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ripNewCfgState=ripNewCfgState, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumIntfDown=ospfCumIntfDown, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCumIntfBackup=ospfCumIntfBackup, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfLsTypesSupported=ospfLsTypesSupported, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfHello=ospfIntfHello, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumNbrBadSequence=ospfCumNbrBadSequence, routerLSALinkIndex=routerLSALinkIndex, arpStatHighWater=arpStatHighWater, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfArea=ospfArea, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipCurCfgIntfState=ipCurCfgIntfState, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumRxTxStats=ospfCumRxTxStats, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaTxHello=ospfAreaTxHello, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipRouteInfoDestIp=ipRouteInfoDestIp, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumNbrhello=ospfCumNbrhello, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ripCurCfgStaticSupply=ripCurCfgStaticSupply)
