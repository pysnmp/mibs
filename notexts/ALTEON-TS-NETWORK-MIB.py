...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, Integer32, Unsigned32, ModuleIdentity, Counter64, Gauge32, MibIdentifier, Counter32, ObjectIdentity, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "Integer32", "Unsigned32", "ModuleIdentity", "Counter64", "Gauge32", "MibIdentifier", "Counter32", "ObjectIdentity", "IpAddress", "TimeTicks")
...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumIntfHello=ospfCumIntfHello, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaInfoEntry=ospfAreaInfoEntry, arpInfoFlag=arpInfoFlag, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpOper=vrrpOper, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgGwAddr=ipCurCfgGwAddr, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumIntfBackup=ospfCumIntfBackup, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfNbrInExchState=ospfNbrInExchState, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfHello=ospfIntfHello, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripConfig=ripConfig, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfBackup=ospfIntfBackup, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfNbrDown=ospfIntfNbrDown, ospfNbrInFullState=ospfNbrInFullState, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfRxPkts=ospfIntfRxPkts, ipRouteInfoTable=ipRouteInfoTable, ospfCumTxPkts=ospfCumTxPkts, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumTxHello=ospfCumTxHello, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaRxDatabase=ospfAreaRxDatabase, routerLSALinkData=routerLSALinkData, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfTotalAreas=ospfTotalAreas, ipRouteInfoIndx=ipRouteInfoIndx, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfArea=ospfArea, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ripNewCfgVip=ripNewCfgVip, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumIntfDown=ospfCumIntfDown, ospfNbrInInitState=ospfNbrInInitState, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrp_info=vrrp_info, ospfinfo=ospfinfo, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgGwIndex=ipNewCfgGwIndex, routerLSAId=routerLSAId, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipGatewayTableMax=ipGatewayTableMax, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfRxHello=ospfIntfRxHello, ripNewCfgState=ripNewCfgState, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrp=vrrp, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfLoop=ospfIntfLoop, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumRxlsAcks=ospfCumRxlsAcks, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipCurCfgBootpAddr=ipCurCfgBootpAddr, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgIntfVlan=ipNewCfgIntfVlan, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgGwState=ipNewCfgGwState, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaInfoId=ospfAreaInfoId, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaIntfHello=ospfAreaIntfHello, ripNewCfgListen=ripNewCfgListen, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfStats=ospfStats, ripNewCfgSupply=ripNewCfgSupply, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfIndex=ospfIntfIndex, ip_info=ip_info, ripStats=ripStats, arpInfoSrcPort=arpInfoSrcPort, vrrpStats=vrrpStats, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripStatOutPkts=ripStatOutPkts, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumNbrDown=ospfCumNbrDown, ospfAreaChangeStats=ospfAreaChangeStats, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfLsTypesSupported=ospfLsTypesSupported, arpStats=arpStats, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgGwState=ipCurCfgGwState, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfNbrChange=ospfIntfNbrChange, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfGeneral=ospfGeneral, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, routeStatHighWater=routeStatHighWater, ospfAreaTxHello=ospfAreaTxHello, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfStartTime=ospfStartTime, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, arpStatMaxEntries=arpStatMaxEntries, ospfIntfUnloop=ospfIntfUnloop, ospfCumRxlsReqs=ospfCumRxlsReqs, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgGwAddr=ipNewCfgGwAddr, arpStatHighWater=arpStatHighWater, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, arpInfoDestIp=arpInfoDestIp, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfNbrStart=ospfIntfNbrStart, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaRxHello=ospfAreaRxHello, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, iprouting=iprouting, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumRxPkts=ospfCumRxPkts, ospfInterface=ospfInterface, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfTotalTransitAreas=ospfTotalTransitAreas, arpInfoEntry=arpInfoEntry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfTxPkts=ospfIntfTxPkts, ipForward=ipForward, routeStatMaxEntries=routeStatMaxEntries, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumRxHello=ospfCumRxHello, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgGwArp=ipCurCfgGwArp, ripStatInPkts=ripStatInPkts, arpStatEntries=arpStatEntries, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaNbrIndex=ospfAreaNbrIndex, arpInfoVLAN=arpInfoVLAN, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, dnsStats=dnsStats, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaNbrhello=ospfAreaNbrhello, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumIntfLoop=ospfCumIntfLoop, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaIntfDown=ospfAreaIntfDown, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfDown=ospfIntfDown, routerLSALinkID=routerLSALinkID, routerLSAAreaIndex=routerLSAAreaIndex, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipRouteInfoEntry=ipRouteInfoEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ripCurCfgSupply=ripCurCfgSupply, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, routeStats=routeStats, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaIntfBackup=ospfAreaIntfBackup, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCfg=ospfCfg, ipRouteInfoMask=ipRouteInfoMask, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfTxHello=ospfIntfTxHello, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgGwEntry=ipNewCfgGwEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete)
