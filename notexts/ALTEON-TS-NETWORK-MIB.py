...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgGwVlan=ipCurCfgGwVlan, arpInfoFlag=arpInfoFlag, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, routerLSALinkIndex=routerLSALinkIndex, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumIntfDown=ospfCumIntfDown, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCfg=ospfCfg, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, arpInfoSrcPort=arpInfoSrcPort, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfDown=ospfIntfDown, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgGwMetric=ipNewCfgGwMetric, ip_info=ip_info, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, routerLSALinkData=routerLSALinkData, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipRouteInfoDestIp=ipRouteInfoDestIp, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumNbrStart=ospfCumNbrStart, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ripNewCfgSupply=ripNewCfgSupply, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfIndex=ospfIntfIndex, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, arpInfoDestIp=arpInfoDestIp, ospfCumIntfHello=ospfCumIntfHello, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipNewCfgGwVlan=ipNewCfgGwVlan, arpInfoVLAN=arpInfoVLAN, vrrpOper=vrrpOper, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipForward=ipForward, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, routeStatEntries=routeStatEntries, dnsStats=dnsStats, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipRouteInfoEntry=ipRouteInfoEntry, ipRouteInfoIndx=ipRouteInfoIndx, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfGeneral=ospfGeneral, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipRouteInfoGateway=ipRouteInfoGateway, ipRouteInfoType=ipRouteInfoType, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfHello=ospfIntfHello, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumNbrhello=ospfCumNbrhello, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, routeStats=routeStats, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaRxHello=ospfAreaRxHello, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfTotalNssaAreas=ospfTotalNssaAreas, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, arpStatHighWater=arpStatHighWater, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumNbrRstAd=ospfCumNbrRstAd, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgIntfTable=ipNewCfgIntfTable, routerLSALinkID=routerLSALinkID, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfNbrhello=ospfIntfNbrhello, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumTxHello=ospfCumTxHello, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfArea=ospfArea, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgGwArp=ipCurCfgGwArp, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumTxPkts=ospfCumTxPkts, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfRxHello=ospfIntfRxHello, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, arpInfoEntry=arpInfoEntry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripCurCfgListen=ripCurCfgListen, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaNbrhello=ospfAreaNbrhello, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpStats=vrrpStats, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgIntfMask=ipCurCfgIntfMask, ripConfig=ripConfig, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaIntfDown=ospfAreaIntfDown, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripNewCfgDefListen=ripNewCfgDefListen, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripNewCfgVip=ripNewCfgVip, ripStatInPkts=ripStatInPkts, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipNewCfgGwState=ipNewCfgGwState, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ripCurCfgVip=ripCurCfgVip, ripStats=ripStats, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, iprouting=iprouting, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfUnloop=ospfIntfUnloop, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumTxDatabase=ospfCumTxDatabase, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, routerLSAId=routerLSAId, vrrp_info=vrrp_info, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfNbrInExchState=ospfNbrInExchState, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrp=vrrp, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipNewCfgBootpState=ipNewCfgBootpState, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, arpStatMaxEntries=arpStatMaxEntries, ospfIfInfoIndex=ospfIfInfoIndex, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipCurCfgBootpState=ipCurCfgBootpState, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, arpStatEntries=arpStatEntries, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfInterface=ospfInterface, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfNbrInInitState=ospfNbrInInitState, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfProcessUptime=ospfProcessUptime, ospfTotalTransitAreas=ospfTotalTransitAreas, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfLsTypesSupported=ospfLsTypesSupported, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgIntfVlan=ipNewCfgIntfVlan, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfGeneralStats=ospfGeneralStats, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfLoop=ospfIntfLoop, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaNbrIndex=ospfAreaNbrIndex, routeStatMaxEntries=routeStatMaxEntries, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfHostTableMaxSize=ospfHostTableMaxSize, ipGatewayTableMax=ipGatewayTableMax, ospfStats=ospfStats, ospfAreaChangeStats=ospfAreaChangeStats, ipRouteInfoTable=ipRouteInfoTable, ripCurCfgSupply=ripCurCfgSupply, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripNewCfgState=ripNewCfgState, ospfStartTime=ospfStartTime, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgGwRetry=ipCurCfgGwRetry, arpInfoMacAddr=arpInfoMacAddr, ospfIntfWaitTimer=ospfIntfWaitTimer, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ripCurCfgState=ripCurCfgState, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, routeStatHighWater=routeStatHighWater, arpStats=arpStats, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfinfo=ospfinfo, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaInfoId=ospfAreaInfoId, ospfCumRxHello=ospfCumRxHello, ospfGeneralInfo=ospfGeneralInfo, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipCurCfgGwInterval=ipCurCfgGwInterval)
