...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaNbrStart=ospfAreaNbrStart, ipCurCfgIntfMask=ipCurCfgIntfMask, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaNbrRstAd=ospfAreaNbrRstAd, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ripNewCfgSupply=ripNewCfgSupply, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumRxDatabase=ospfCumRxDatabase, ripStatInPkts=ripStatInPkts, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumIntfDown=ospfCumIntfDown, vrrpStats=vrrpStats, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipRouteInfoTag=ipRouteInfoTag, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaIntfIndex=ospfAreaIntfIndex, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, routeStatMaxEntries=routeStatMaxEntries, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaInfoEntry=ospfAreaInfoEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfStartTime=ospfStartTime, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfTxDatabase=ospfIntfTxDatabase, arpInfoEntry=arpInfoEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, ripNewCfgState=ripNewCfgState, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumNbrStart=ospfCumNbrStart, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumRxTxStats=ospfCumRxTxStats, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfRxHello=ospfIntfRxHello, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripConfig=ripConfig, ospfCumIntfLoop=ospfCumIntfLoop, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrp=vrrp, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfNbrInInitState=ospfNbrInInitState, ospfStats=ospfStats, arpInfoTable=arpInfoTable, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumRxPkts=ospfCumRxPkts, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, routeStatEntries=routeStatEntries, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumIntfBackup=ospfCumIntfBackup, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ripCurCfgVip=ripCurCfgVip, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfUnloop=ospfIntfUnloop, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfTxlsAcks=ospfIntfTxlsAcks, arpInfoVLAN=arpInfoVLAN, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaInfoId=ospfAreaInfoId, arpStatHighWater=arpStatHighWater, ipCurCfgGwAddr=ipCurCfgGwAddr, ipRouteInfoIndx=ipRouteInfoIndx, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgGwArp=ipNewCfgGwArp, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfinfo=ospfinfo, ripStats=ripStats, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfArea=ospfArea, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaRxHello=ospfAreaRxHello, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipRouteInfoEntry=ipRouteInfoEntry, vrrpStatInAdvers=vrrpStatInAdvers, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfIndex=ospfIntfIndex, ripNewCfgDefListen=ripNewCfgDefListen, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgGwEntry=ipNewCfgGwEntry, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipInterfaceTableMax=ipInterfaceTableMax, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumTxlsAcks=ospfCumTxlsAcks, routeStats=routeStats, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfInterface=ospfInterface, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfNbrDown=ospfIntfNbrDown, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgGwInterval=ipNewCfgGwInterval, arpStatEntries=arpStatEntries, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfTxlsReqs=ospfIntfTxlsReqs, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfProcessUptime=ospfProcessUptime, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipRouteInfoType=ipRouteInfoType, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfTotalAreas=ospfTotalAreas, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfNbrChange=ospfIntfNbrChange, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, routerLSALinkIndex=routerLSALinkIndex, arpInfoFlag=arpInfoFlag, ospfIntfChangeStats=ospfIntfChangeStats, ip_info=ip_info, ospfAreaIntfDown=ospfAreaIntfDown, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, dnsStats=dnsStats, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfNbrInFullState=ospfNbrInFullState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, routerLSAId=routerLSAId, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfNbrN1way=ospfIntfNbrN1way, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfGeneralStats=ospfGeneralStats, ospfIntfHello=ospfIntfHello, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, arpStats=arpStats, ipNewCfgGwState=ipNewCfgGwState, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrp_info=vrrp_info, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCfg=ospfCfg, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ripNewCfgVip=ripNewCfgVip, ospfAreaNbrN1way=ospfAreaNbrN1way, arpInfoSrcPort=arpInfoSrcPort, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaTxPkts=ospfAreaTxPkts, arpInfoMacAddr=arpInfoMacAddr, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumIntfHello=ospfCumIntfHello, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipNewCfgBootpState=ipNewCfgBootpState, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfTxHello=ospfIntfTxHello, vrrpIfTableMaxSize=vrrpIfTableMaxSize, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfTotalTransitAreas=ospfTotalTransitAreas, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripStatOutPkts=ripStatOutPkts, iprouting=iprouting, ospfCumTxPkts=ospfCumTxPkts, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumNbrhello=ospfCumNbrhello, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpGeneral=vrrpGeneral, ipNewCfgIntfState=ipNewCfgIntfState, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ripCurCfgState=ripCurCfgState, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgGwState=ipCurCfgGwState, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ripNewCfgListen=ripNewCfgListen, arpStatMaxEntries=arpStatMaxEntries, arpInfoRefPorts=arpInfoRefPorts, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgIntfState=ipCurCfgIntfState, ripCurCfgListen=ripCurCfgListen, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipForward=ipForward, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType)
