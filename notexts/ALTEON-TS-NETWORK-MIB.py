...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfGeneralStats=ospfGeneralStats, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipRouteInfoInterface=ipRouteInfoInterface, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfDown=ospfIntfDown, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, arpStatHighWater=arpStatHighWater, ripNewCfgState=ripNewCfgState, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfHello=ospfIntfHello, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfLoop=ospfIntfLoop, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaNbrStart=ospfAreaNbrStart, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaRxHello=ospfAreaRxHello, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpStats=vrrpStats, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumNbrStart=ospfCumNbrStart, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgGwEntry=ipCurCfgGwEntry, ripConfig=ripConfig, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfStats=ospfStats, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipCurCfgGwMetric=ipCurCfgGwMetric, ipRouteInfoMask=ipRouteInfoMask, ospfCfg=ospfCfg, ospfIntfTxHello=ospfIntfTxHello, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaNbrhello=ospfAreaNbrhello, arpInfoSrcPort=arpInfoSrcPort, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumTxPkts=ospfCumTxPkts, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfArea=ospfArea, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgIntfState=ipNewCfgIntfState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfNewCfgAreaId=ospfNewCfgAreaId, ripStatInErrorPkts=ripStatInErrorPkts, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, arpInfoDestIp=arpInfoDestIp, ipCurCfgBootpState=ipCurCfgBootpState, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfRxPkts=ospfIntfRxPkts, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, arpStatMaxEntries=arpStatMaxEntries, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaInfoId=ospfAreaInfoId, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumTxlsUpdates=ospfCumTxlsUpdates, routeStats=routeStats, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfNbrChange=ospfIntfNbrChange, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, routeStatHighWater=routeStatHighWater, ospfAreaNbrIndex=ospfAreaNbrIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumIntfLoop=ospfCumIntfLoop, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgIntfState=ipCurCfgIntfState, vrrpGeneral=vrrpGeneral, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipForward=ipForward, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipNewCfgIntfTable=ipNewCfgIntfTable, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, arpInfoFlag=arpInfoFlag, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, arpInfoVLAN=arpInfoVLAN, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfProcessUptime=ospfProcessUptime, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfNbrInInitState=ospfNbrInInitState, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipInterfaceTableMax=ipInterfaceTableMax, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ripNewCfgDefListen=ripNewCfgDefListen, ospfStartTime=ospfStartTime, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfChangeStats=ospfIntfChangeStats, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ripCurCfgVip=ripCurCfgVip, routerLSALinkData=routerLSALinkData, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaIntfLoop=ospfAreaIntfLoop, ripStats=ripStats, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaRxlsAcks=ospfAreaRxlsAcks)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdCurCfgState=ipFwdCurCfgState, ripStatInPkts=ripStatInPkts, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfNbrInExchState=ospfNbrInExchState, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfinfo=ospfinfo, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumRxlsReqs=ospfCumRxlsReqs, arpInfoEntry=arpInfoEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, arpStatEntries=arpStatEntries, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipRouteInfoType=ipRouteInfoType, ospfCumTxDatabase=ospfCumTxDatabase, ripNewCfgSupply=ripNewCfgSupply, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, routerLSALinkID=routerLSALinkID, arpInfoRefPorts=arpInfoRefPorts, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, routeStatMaxEntries=routeStatMaxEntries, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ip_info=ip_info, ospfCumIntfBackup=ospfCumIntfBackup, arpStats=arpStats, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripNewCfgListen=ripNewCfgListen, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfNbrStart=ospfIntfNbrStart, ospfGeneralInfo=ospfGeneralInfo, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumRxHello=ospfCumRxHello, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgGwRetry=ipCurCfgGwRetry, routeStatEntries=routeStatEntries, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfInterface=ospfInterface, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfVlinkCountForRouter=ospfVlinkCountForRouter, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIfWaitInterval=ospfIfWaitInterval, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipRouteInfoGateway=ipRouteInfoGateway, ospfTotalAreas=ospfTotalAreas, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgGwMetric=ipNewCfgGwMetric, dnsStats=dnsStats, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfUnloop=ospfIntfUnloop, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, arpInfoTable=arpInfoTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, iprouting=iprouting, ospfTotalNeighbours=ospfTotalNeighbours, ripNewCfgVip=ripNewCfgVip, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumRxDatabase=ospfCumRxDatabase, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaRxTxStats=ospfAreaRxTxStats, routerLSAAreaIndex=routerLSAAreaIndex, vrrp=vrrp, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgGwVlan=ipNewCfgGwVlan, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumIntfHello=ospfCumIntfHello, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaTxHello=ospfAreaTxHello, ripStatOutPkts=ripStatOutPkts, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumNbrN1way=ospfCumNbrN1way, ospfGeneral=ospfGeneral, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgGwState=ipNewCfgGwState, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable)
