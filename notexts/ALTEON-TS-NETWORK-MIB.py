...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumRxPkts=ospfCumRxPkts, routerLSAId=routerLSAId, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfTxHello=ospfIntfTxHello, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgIntfIndex=ipNewCfgIntfIndex, routeStats=routeStats, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfHello=ospfIntfHello, ipCurCfgIntfTable=ipCurCfgIntfTable, arpInfoMacAddr=arpInfoMacAddr, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, dnsStats=dnsStats, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfUnloop=ospfIntfUnloop, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpStats=vrrpStats, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfNbrInExchState=ospfNbrInExchState, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ripNewCfgListen=ripNewCfgListen, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrp=vrrp, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumNbrBadRequests=ospfCumNbrBadRequests, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfGeneralStats=ospfGeneralStats, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfNbrInFullState=ospfNbrInFullState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfRxHello=ospfIntfRxHello, arpInfoVLAN=arpInfoVLAN, ospfAreaRxHello=ospfAreaRxHello, ipForward=ipForward, ripConfig=ripConfig, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, routerLSALinkData=routerLSALinkData, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipCurCfgGwTable=ipCurCfgGwTable, ipRouteInfoGateway=ipRouteInfoGateway, ipGatewayTableMax=ipGatewayTableMax, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaRxPkts=ospfAreaRxPkts, ospfTotalAreas=ospfTotalAreas, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumRxDatabase=ospfCumRxDatabase, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfRangeTableMaxSize=ospfRangeTableMaxSize, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, routeStatHighWater=routeStatHighWater, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, arpStats=arpStats, ospfGeneral=ospfGeneral, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, arpInfoTable=arpInfoTable, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, routerLSALinkIndex=routerLSALinkIndex, routeStatMaxEntries=routeStatMaxEntries, ospfAreaIntfIndex=ospfAreaIntfIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfLoop=ospfIntfLoop, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipRouteInfoMask=ipRouteInfoMask, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumTxPkts=ospfCumTxPkts, ospfCumIntfBackup=ospfCumIntfBackup, ripNewCfgSupply=ripNewCfgSupply, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, arpInfoSrcPort=arpInfoSrcPort, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCurCfgAreaId=ospfCurCfgAreaId, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripCurCfgListen=ripCurCfgListen, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfBackup=ospfIntfBackup, ospfIfInfoIndex=ospfIfInfoIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumNbrDown=ospfCumNbrDown, ripCurCfgVip=ripCurCfgVip, ospfIntfNbrChange=ospfIntfNbrChange, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfStartTime=ospfStartTime, vrrpOper=vrrpOper, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdNewCfgState=ipFwdNewCfgState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, routeStatEntries=routeStatEntries, ipNewCfgGwState=ipNewCfgGwState, iprouting=iprouting, ospfIntfDown=ospfIntfDown, ripNewCfgVip=ripNewCfgVip, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipFwdCurCfgPortState=ipFwdCurCfgPortState, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfTxlsAcks=ospfIntfTxlsAcks)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNbrInInitState=ospfNbrInInitState, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpGeneral=vrrpGeneral, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgGwMetric=ipCurCfgGwMetric, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfinfo=ospfinfo, ospfAreaTxHello=ospfAreaTxHello, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, arpInfoFlag=arpInfoFlag, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaRxTxStats=ospfAreaRxTxStats, ripStatInPkts=ripStatInPkts, vrrp_info=vrrp_info, ospfProcessUptime=ospfProcessUptime, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfArea=ospfArea, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgBootpAddr=ipNewCfgBootpAddr, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaIntfBackup=ospfAreaIntfBackup, arpStatHighWater=arpStatHighWater, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfInterface=ospfInterface, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaNbrStart=ospfAreaNbrStart, routerLSALinkID=routerLSALinkID, ipRouteInfoEntry=ipRouteInfoEntry, ip_info=ip_info, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfStats=ospfStats, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ripStats=ripStats, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipNewCfgGwAddr=ipNewCfgGwAddr, ripNewCfgState=ripNewCfgState, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ripCurCfgState=ripCurCfgState, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfIndex=ospfIntfIndex, ospfCfg=ospfCfg, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaTxPkts=ospfAreaTxPkts, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfTxDatabase=ospfIntfTxDatabase, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumIntfHello=ospfCumIntfHello, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumRxHello=ospfCumRxHello, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumTxHello=ospfCumTxHello, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfChangeStats=ospfIntfChangeStats, ipRouteInfoTable=ipRouteInfoTable, ipRouteInfoInterface=ipRouteInfoInterface, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, arpInfoRefPorts=arpInfoRefPorts)
