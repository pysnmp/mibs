...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaIntfLoop=ospfAreaIntfLoop, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ripStatInPkts=ripStatInPkts, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ripNewCfgListen=ripNewCfgListen, vrrp_info=vrrp_info, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfArea=ospfArea, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaNbrStart=ospfAreaNbrStart, ripNewCfgVip=ripNewCfgVip, ripStatOutPkts=ripStatOutPkts, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipRouteInfoInterface=ipRouteInfoInterface, routerLSALinkID=routerLSALinkID, vrrpStatInAdvers=vrrpStatInAdvers, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfDown=ospfIntfDown, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfRxDatabase=ospfIntfRxDatabase, ipRouteInfoTable=ipRouteInfoTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfTxHello=ospfIntfTxHello, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgGwState=ipNewCfgGwState, ipInterfaceTableMax=ipInterfaceTableMax, arpInfoFlag=arpInfoFlag, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgGwMetric=ipNewCfgGwMetric, ipCurCfgBootpState=ipCurCfgBootpState, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaTxDatabase=ospfAreaTxDatabase, routeStats=routeStats, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, routeStatEntries=routeStatEntries, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpOper=vrrpOper, ospfIntfUnloop=ospfIntfUnloop, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfChangeStats=ospfIntfChangeStats, ospfNbrInInitState=ospfNbrInInitState, ospfGeneralInfo=ospfGeneralInfo, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaIntfHello=ospfAreaIntfHello, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfNbrInExchState=ospfNbrInExchState, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCfg=ospfCfg, arpInfoEntry=arpInfoEntry, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumTxPkts=ospfCumTxPkts, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfBackup=ospfIntfBackup, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ripCurCfgListen=ripCurCfgListen, ospfIntfTxPkts=ospfIntfTxPkts, ipRouteInfoMask=ipRouteInfoMask, ripCurCfgState=ripCurCfgState, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, arpStats=arpStats, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaNbrN1way=ospfAreaNbrN1way, routerLSAId=routerLSAId, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgGwArp=ipNewCfgGwArp, ipFwdCurCfgState=ipFwdCurCfgState, iprouting=iprouting, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaNbrhello=ospfAreaNbrhello, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaRxHello=ospfAreaRxHello, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfRxPkts=ospfIntfRxPkts, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfNbrhello=ospfIntfNbrhello, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfInfoTable=ospfIntfInfoTable, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCurCfgAreaId=ospfCurCfgAreaId, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumRxDatabase=ospfCumRxDatabase, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipForward=ipForward, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipRouteInfoTag=ipRouteInfoTag, arpStatHighWater=arpStatHighWater, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgGwArp=ipCurCfgGwArp, ospfLsTypesSupported=ospfLsTypesSupported)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipRouteInfoType=ipRouteInfoType, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ripCurCfgDefListen=ripCurCfgDefListen, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfProcessUptime=ospfProcessUptime, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, arpStatEntries=arpStatEntries, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaTxHello=ospfAreaTxHello, ospfCumRxlsAcks=ospfCumRxlsAcks, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfinfo=ospfinfo, vrrp=vrrp, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfRxTxIndex=ospfIntfRxTxIndex, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCumRxHello=ospfCumRxHello, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ripConfig=ripConfig, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfIndex=ospfIntfIndex, ospfCumIntfUnloop=ospfCumIntfUnloop, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, routerLSALinkData=routerLSALinkData, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, arpInfoRefPorts=arpInfoRefPorts, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ip_info=ip_info, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, dnsStats=dnsStats, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgGwState=ipCurCfgGwState, ripNewCfgSupply=ripNewCfgSupply, ospfCumIntfDown=ospfCumIntfDown, ripStats=ripStats, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ripCurCfgStaticSupply=ripCurCfgStaticSupply, arpInfoSrcPort=arpInfoSrcPort, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumNbrDown=ospfCumNbrDown, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfStats=ospfStats, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumIntfLoop=ospfCumIntfLoop, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfInterface=ospfInterface, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipCurCfgGwRetry=ipCurCfgGwRetry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfStartTime=ospfStartTime, ospfIfInfoIndex=ospfIfInfoIndex, vrrpStats=vrrpStats, arpInfoMacAddr=arpInfoMacAddr, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipRouteInfoGateway=ipRouteInfoGateway, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCumTxHello=ospfCumTxHello, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumRxPkts=ospfCumRxPkts, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaTableMaxSize=ospfAreaTableMaxSize, routeStatHighWater=routeStatHighWater, ospfGeneral=ospfGeneral, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipRouteInfoIndx=ipRouteInfoIndx, ospfNbrInFullState=ospfNbrInFullState, vrrpGeneral=vrrpGeneral, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumIntfHello=ospfCumIntfHello, ripNewCfgState=ripNewCfgState, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfTableMaxSize=ospfIntfTableMaxSize, arpInfoTable=arpInfoTable, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfNbrN1way=ospfIntfNbrN1way, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet)
