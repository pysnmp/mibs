...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumTxHello=ospfCumTxHello, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaNbrIndex=ospfAreaNbrIndex, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipRouteInfoType=ipRouteInfoType, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, arpStatEntries=arpStatEntries, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfNbrIndex=ospfIntfNbrIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfGeneral=ospfGeneral, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaTableMaxSize=ospfAreaTableMaxSize, routerLSALinkIndex=routerLSALinkIndex, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfNbrChange=ospfIntfNbrChange, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripStatInErrorPkts=ripStatInErrorPkts, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipRouteInfoGateway=ipRouteInfoGateway, ripCurCfgSupply=ripCurCfgSupply, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ripStats=ripStats, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfDown=ospfIntfDown, vrrp_info=vrrp_info, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfRxHello=ospfIntfRxHello, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgIntfState=ipCurCfgIntfState, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgGwRetry=ipNewCfgGwRetry, ip_info=ip_info, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfNbrInExchState=ospfNbrInExchState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumRxHello=ospfCumRxHello, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfNbrhello=ospfIntfNbrhello, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ripNewCfgSupply=ripNewCfgSupply, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfUnloop=ospfIntfUnloop, vrrp=vrrp, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfTxlsReqs=ospfIntfTxlsReqs, routerLSAId=routerLSAId, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, routerLSALinkData=routerLSALinkData, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ripCurCfgState=ripCurCfgState, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumIntfLoop=ospfCumIntfLoop, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumIntfBackup=ospfCumIntfBackup, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdNewCfgState=ipFwdNewCfgState, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, arpInfoMacAddr=arpInfoMacAddr, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfStats=ospfStats, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfArea=ospfArea, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumIntfDown=ospfCumIntfDown, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ripNewCfgState=ripNewCfgState, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCfg=ospfCfg, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfHostTableMaxSize=ospfHostTableMaxSize, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCumTxPkts=ospfCumTxPkts, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfNbrInFullState=ospfNbrInFullState, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, routeStatMaxEntries=routeStatMaxEntries, ospfAreaInfoId=ospfAreaInfoId, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumIntfChangeStats=ospfCumIntfChangeStats, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfTotalNeighbours=ospfTotalNeighbours, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, dnsStats=dnsStats, ipRouteInfoMask=ipRouteInfoMask, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, arpInfoEntry=arpInfoEntry, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfHello=ospfIntfHello, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, arpInfoFlag=arpInfoFlag, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfLsTypesSupported=ospfLsTypesSupported, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumNbrhello=ospfCumNbrhello, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfNbrInInitState=ospfNbrInInitState, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfGeneralStats=ospfGeneralStats, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrDown=ospfIntfNbrDown, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipForward=ipForward, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpGeneral=vrrpGeneral, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, arpStats=arpStats, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumRxDatabase=ospfCumRxDatabase, ospfTotalTransitAreas=ospfTotalTransitAreas, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ripCurCfgListen=ripCurCfgListen, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfProcessUptime=ospfProcessUptime, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfBackup=ospfIntfBackup, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfIndex=ospfIntfIndex, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfTxPkts=ospfIntfTxPkts, routeStatEntries=routeStatEntries, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ripStatOutPkts=ripStatOutPkts, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumNbrStart=ospfCumNbrStart, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfNbrStart=ospfIntfNbrStart, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaNbrStart=ospfAreaNbrStart, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripNewCfgVip=ripNewCfgVip, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgGwState=ipCurCfgGwState, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaNbrDown=ospfAreaNbrDown, vrrpOper=vrrpOper, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipRouteInfoTag=ipRouteInfoTag, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, arpStatHighWater=arpStatHighWater, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfLoop=ospfIntfLoop, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipRouteInfoTable=ipRouteInfoTable, iprouting=iprouting, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ripConfig=ripConfig, routeStats=routeStats, ospfCumTxDatabase=ospfCumTxDatabase, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaInfoTable=ospfAreaInfoTable, ipCurCfgGwTable=ipCurCfgGwTable, routerLSALinkID=routerLSALinkID, ipFwdCurCfgPortState=ipFwdCurCfgPortState, arpInfoDestIp=arpInfoDestIp)
