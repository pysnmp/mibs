...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumNbrDown=ospfCumNbrDown, vrrp=vrrp, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaTxHello=ospfAreaTxHello, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, routeStats=routeStats, ipNewCfgIntfMask=ipNewCfgIntfMask, ip_info=ip_info, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfRxTxStats=ospfIntfRxTxStats, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumTxlsReqs=ospfCumTxlsReqs, ipForward=ipForward, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgGwEntry=ipCurCfgGwEntry, ripConfig=ripConfig, ospfIntfRxPkts=ospfIntfRxPkts, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfNbrIndex=ospfIntfNbrIndex, routerLSALinkIndex=routerLSALinkIndex, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripNewCfgListen=ripNewCfgListen, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, routeStatHighWater=routeStatHighWater, ripStats=ripStats, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfUnloop=ospfIntfUnloop, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumTxDatabase=ospfCumTxDatabase, ripStatOutPkts=ripStatOutPkts, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfTxPkts=ospfIntfTxPkts, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfTxHello=ospfIntfTxHello, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ripCurCfgState=ripCurCfgState, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipGatewayTableMax=ipGatewayTableMax, ospfAreaNbrN1way=ospfAreaNbrN1way, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaTxlsAcks=ospfAreaTxlsAcks, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfLoop=ospfIntfLoop, ospfAreaRxHello=ospfAreaRxHello, ospfAreaIntfIndex=ospfAreaIntfIndex, arpStats=arpStats, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ripStatInPkts=ripStatInPkts, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ripCurCfgDefListen=ripCurCfgDefListen, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgGwIndex=ipNewCfgGwIndex, arpInfoTable=arpInfoTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaRxlsAcks=ospfAreaRxlsAcks, arpStatHighWater=arpStatHighWater, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIfWaitInterval=ospfIfWaitInterval, ospfTotalAreas=ospfTotalAreas, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumNbrStart=ospfCumNbrStart, routerLSALinkID=routerLSALinkID, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumRxPkts=ospfCumRxPkts, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaIntfLoop=ospfAreaIntfLoop, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfNbrStart=ospfIntfNbrStart, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumTxlsUpdates=ospfCumTxlsUpdates, routeStatMaxEntries=routeStatMaxEntries, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpStatInAdvers=vrrpStatInAdvers, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipRouteInfoMask=ipRouteInfoMask, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrp_info=vrrp_info, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaIntfDown=ospfAreaIntfDown, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgGwArp=ipCurCfgGwArp, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgGwDelete=ipNewCfgGwDelete, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipRouteInfoTable=ipRouteInfoTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumTxPkts=ospfCumTxPkts, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, iprouting=iprouting, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, arpInfoDestIp=arpInfoDestIp, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgGwState=ipNewCfgGwState, arpInfoMacAddr=arpInfoMacAddr, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfNbrInFullState=ospfNbrInFullState, arpInfoFlag=arpInfoFlag, ipNewCfgGwArp=ipNewCfgGwArp, dnsStats=dnsStats, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, routeStatEntries=routeStatEntries, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, routerLSAAreaIndex=routerLSAAreaIndex, ospfArea=ospfArea, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgGwTable=ipCurCfgGwTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipRouteInfoType=ipRouteInfoType, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfNbrInExchState=ospfNbrInExchState, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfStats=ospfStats, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgIntfState=ipCurCfgIntfState, ospfStartTime=ospfStartTime, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfHello=ospfIntfHello, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumRxTxStats=ospfCumRxTxStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, routerLSALinkData=routerLSALinkData, ripNewCfgDefListen=ripNewCfgDefListen, vrrpGeneral=vrrpGeneral, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumIntfHello=ospfCumIntfHello, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfGeneral=ospfGeneral, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipInterfaceTableMax=ipInterfaceTableMax, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfNbrChange=ospfIntfNbrChange, ripCurCfgSupply=ripCurCfgSupply, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpOper=vrrpOper, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripNewCfgState=ripNewCfgState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgIntfEntry=ipCurCfgIntfEntry, arpStatEntries=arpStatEntries, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpStatOutAdvers=vrrpStatOutAdvers, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaNbrDown=ospfAreaNbrDown, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ripNewCfgVip=ripNewCfgVip, ospfIntfDown=ospfIntfDown, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, ipCurCfgGwState=ipCurCfgGwState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIfInfoIndex=ospfIfInfoIndex, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfIndex=ospfIntfIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumRxHello=ospfCumRxHello, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, arpInfoSrcPort=arpInfoSrcPort, ospfinfo=ospfinfo)
