...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ripStatInPkts=ripStatInPkts, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfNbrInExchState=ospfNbrInExchState, arpStatHighWater=arpStatHighWater, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ripStats=ripStats, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, arpInfoSrcPort=arpInfoSrcPort, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaIntfHello=ospfAreaIntfHello, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumTxPkts=ospfCumTxPkts, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfNbrInFullState=ospfNbrInFullState, vrrpStatInAdvers=vrrpStatInAdvers, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfRxHello=ospfIntfRxHello, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfNbrChange=ospfIntfNbrChange, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ripNewCfgListen=ripNewCfgListen, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaNbrDown=ospfAreaNbrDown, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfRxPkts=ospfIntfRxPkts, vrrp_info=vrrp_info, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaNbrStart=ospfAreaNbrStart, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfTotalNssaAreas=ospfTotalNssaAreas, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, arpInfoEntry=arpInfoEntry, arpStats=arpStats, ospfIntfTxHello=ospfIntfTxHello, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfTxPkts=ospfIntfTxPkts, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipCurCfgGwVlan=ipCurCfgGwVlan, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumIntfHello=ospfCumIntfHello, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgGwDelete=ipNewCfgGwDelete, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfStartTime=ospfStartTime, routeStatEntries=routeStatEntries, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfHello=ospfIntfHello, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpGeneral=vrrpGeneral, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfWaitTimer=ospfIntfWaitTimer, ipForward=ipForward, ospfStats=ospfStats, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrp=vrrp, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIfWaitInterval=ospfIfWaitInterval, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgGwArp=ipNewCfgGwArp, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpOper=vrrpOper, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfProcessUptime=ospfProcessUptime, ipCurCfgBootpState=ipCurCfgBootpState, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfGeneralStats=ospfGeneralStats, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipRouteInfoTable=ipRouteInfoTable, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaTxHello=ospfAreaTxHello, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ripNewCfgSupply=ripNewCfgSupply, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfTotalAreas=ospfTotalAreas, routerLSALinkData=routerLSALinkData, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumNbrN1way=ospfCumNbrN1way, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfLoop=ospfIntfLoop, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumRxlsReqs=ospfCumRxlsReqs, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumRxHello=ospfCumRxHello, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaChangeStats=ospfAreaChangeStats, ipNewCfgGwEntry=ipNewCfgGwEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfGeneral=ospfGeneral, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaRxDatabase=ospfAreaRxDatabase, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumTxHello=ospfCumTxHello, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpStatOutAdvers=vrrpStatOutAdvers)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, ripConfig=ripConfig, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgIntfTable=ipNewCfgIntfTable, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfBackup=ospfIntfBackup, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ip_info=ip_info, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgGwState=ipNewCfgGwState, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfGeneralInfo=ospfGeneralInfo, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgBootpState=ipNewCfgBootpState, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgGwTable=ipNewCfgGwTable, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgIfTable=vrrpCurCfgIfTable, routeStatHighWater=routeStatHighWater, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipRouteInfoType=ipRouteInfoType, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfInterface=ospfInterface, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfIndex=ospfIntfIndex, ospfIntfInfoTable=ospfIntfInfoTable, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ripCurCfgSupply=ripCurCfgSupply, iprouting=iprouting, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfArea=ospfArea, ripCurCfgStaticSupply=ripCurCfgStaticSupply, arpStatMaxEntries=arpStatMaxEntries, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgIntfState=ipNewCfgIntfState, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfTotalNeighbours=ospfTotalNeighbours, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, dnsStats=dnsStats, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, routeStats=routeStats, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, arpInfoTable=arpInfoTable, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfNbrDown=ospfIntfNbrDown, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumNbrhello=ospfCumNbrhello, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, arpInfoRefPorts=arpInfoRefPorts, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgGwMetric=ipCurCfgGwMetric, ripNewCfgDefListen=ripNewCfgDefListen, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfNbrInInitState=ospfNbrInInitState, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaRxPkts=ospfAreaRxPkts, ipGatewayTableMax=ipGatewayTableMax, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, routerLSAId=routerLSAId, ipCurCfgBootpAddr=ipCurCfgBootpAddr, routerLSALinkID=routerLSALinkID, arpStatEntries=arpStatEntries, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfUnloop=ospfIntfUnloop, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaNbrN1way=ospfAreaNbrN1way, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipRouteInfoIndx=ipRouteInfoIndx, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ripStatOutPkts=ripStatOutPkts, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ripNewCfgState=ripNewCfgState, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpStats=vrrpStats, ospfCumNbrStart=ospfCumNbrStart, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry)
