...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipRouteInfoInterface=ipRouteInfoInterface, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumTxHello=ospfCumTxHello, ospfAreaTxlsReqs=ospfAreaTxlsReqs, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumIntfDown=ospfCumIntfDown, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfLoop=ospfIntfLoop, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgBootpState=ipNewCfgBootpState, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfStartTime=ospfStartTime, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumNbrhello=ospfCumNbrhello, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, routeStatMaxEntries=routeStatMaxEntries, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumTxPkts=ospfCumTxPkts, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrp_info=vrrp_info, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaNbrDown=ospfAreaNbrDown, ipNewCfgIntfTable=ipNewCfgIntfTable, ripNewCfgVip=ripNewCfgVip, ospfCumIntfLoop=ospfCumIntfLoop, arpInfoMacAddr=arpInfoMacAddr, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfGeneralInfo=ospfGeneralInfo, ipRouteInfoTag=ipRouteInfoTag, ospfStats=ospfStats, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ripStats=ripStats, ospfAreaNbrhello=ospfAreaNbrhello, ospfNbrInFullState=ospfNbrInFullState, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfNbrInExchState=ospfNbrInExchState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, arpInfoVLAN=arpInfoVLAN, arpInfoDestIp=arpInfoDestIp, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, routerLSALinkID=routerLSALinkID, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfRxTxStats=ospfIntfRxTxStats, ipFwdCurCfgState=ipFwdCurCfgState, vrrpGeneral=vrrpGeneral, vrrpStatInAdvers=vrrpStatInAdvers, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, routeStatEntries=routeStatEntries, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipRouteInfoTable=ipRouteInfoTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfCountForRouter=ospfIntfCountForRouter, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfTotalAreas=ospfTotalAreas, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfArea=ospfArea, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfTxHello=ospfIntfTxHello, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ripStatInPkts=ripStatInPkts, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfGeneral=ospfGeneral, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfTotalNeighbours=ospfTotalNeighbours, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, arpInfoSrcPort=arpInfoSrcPort, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumRxPkts=ospfCumRxPkts, dnsStats=dnsStats, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfRxHello=ospfIntfRxHello, ospfInterface=ospfInterface, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfGeneralStats=ospfGeneralStats, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, iprouting=iprouting, ipRouteInfoMask=ipRouteInfoMask, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfBackup=ospfIntfBackup, ospfIntfIndex=ospfIntfIndex, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, arpInfoTable=arpInfoTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ripNewCfgDefListen=ripNewCfgDefListen, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumNbrDown=ospfCumNbrDown, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaNbrN1way=ospfAreaNbrN1way, ripCurCfgListen=ripCurCfgListen, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgIntfState=ipCurCfgIntfState, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipFwdCurCfgPortState=ipFwdCurCfgPortState, arpStatHighWater=arpStatHighWater, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, routerLSALinkIndex=routerLSALinkIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpStats=vrrpStats, ospfIntfChangeStats=ospfIntfChangeStats, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfRxTxIndex=ospfIntfRxTxIndex, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaRxHello=ospfAreaRxHello, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfinfo=ospfinfo, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgGwAddr=ipCurCfgGwAddr, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfNbrStart=ospfIntfNbrStart, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, routerLSAId=routerLSAId, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, arpInfoEntry=arpInfoEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfRxDatabase=ospfIntfRxDatabase, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCumIntfHello=ospfCumIntfHello, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ripCurCfgDefListen=ripCurCfgDefListen, vrrp=vrrp, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ripCurCfgVip=ripCurCfgVip, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumRxDatabase=ospfCumRxDatabase, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipForward=ipForward, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipInterfaceTableMax=ipInterfaceTableMax, ripConfig=ripConfig, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfNbrDown=ospfIntfNbrDown, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaTxHello=ospfAreaTxHello, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaInfoIndex=ospfAreaInfoIndex, routeStats=routeStats, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfDown=ospfIntfDown, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipRouteInfoEntry=ipRouteInfoEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgGwTable=ipCurCfgGwTable, ripNewCfgSupply=ripNewCfgSupply, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumRxTxStats=ospfCumRxTxStats, ipNewCfgGwRetry=ipNewCfgGwRetry, arpInfoFlag=arpInfoFlag, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ripStatOutPkts=ripStatOutPkts, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaNbrStart=ospfAreaNbrStart, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgGwInterval=ipCurCfgGwInterval, ripCurCfgState=ripCurCfgState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgIntfState=ipNewCfgIntfState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCurCfgAreaTable=ospfCurCfgAreaTable, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfUnloop=ospfIntfUnloop, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipRouteInfoType=ipRouteInfoType, ip_info=ip_info, ospfIntfHello=ospfIntfHello, ospfCumRxHello=ospfCumRxHello, routeStatHighWater=routeStatHighWater, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, arpStats=arpStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaIntfHello=ospfAreaIntfHello, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry)
