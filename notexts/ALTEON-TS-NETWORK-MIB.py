...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ripNewCfgListen=ripNewCfgListen, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumIntfDown=ospfCumIntfDown, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdCurCfgPortState=ipFwdCurCfgPortState, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaIntfHello=ospfAreaIntfHello, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, routerLSAAreaIndex=routerLSAAreaIndex, arpInfoDestIp=arpInfoDestIp, routeStats=routeStats, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ip_info=ip_info, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipRouteInfoTag=ipRouteInfoTag, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpStats=vrrpStats, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, routerLSALinkData=routerLSALinkData, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgIfTable=vrrpCurCfgIfTable, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgGwTable=ipCurCfgGwTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipInterfaceTableMax=ipInterfaceTableMax, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ripConfig=ripConfig, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumNbrDown=ospfCumNbrDown, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCfg=ospfCfg, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaIntfDown=ospfAreaIntfDown, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrp=vrrp, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripStatOutPkts=ripStatOutPkts, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIfWaitInterval=ospfIfWaitInterval, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfInterface=ospfInterface, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ripCurCfgState=ripCurCfgState, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumTxPkts=ospfCumTxPkts, ospfAreaRxHello=ospfAreaRxHello, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripCurCfgSupply=ripCurCfgSupply, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfTotalTransitAreas=ospfTotalTransitAreas, iprouting=iprouting, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgIntfState=ipCurCfgIntfState, arpInfoRefPorts=arpInfoRefPorts, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfGeneralStats=ospfGeneralStats, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfNbrInFullState=ospfNbrInFullState, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, arpInfoTable=arpInfoTable, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfLoop=ospfIntfLoop, ospfCumNbrStart=ospfCumNbrStart, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, dnsStats=dnsStats, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrp_info=vrrp_info, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfNbrStart=ospfIntfNbrStart, arpInfoEntry=arpInfoEntry, ospfCumRxHello=ospfCumRxHello, ospfIfInfoIndex=ospfIfInfoIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfNbrInExchState=ospfNbrInExchState, ospfIntfChangeStats=ospfIntfChangeStats, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ripCurCfgListen=ripCurCfgListen, ripStatInPkts=ripStatInPkts, ipCurCfgGwIndex=ipCurCfgGwIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipForward=ipForward, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, arpInfoVLAN=arpInfoVLAN, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, arpStats=arpStats, arpStatEntries=arpStatEntries, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipRouteInfoTable=ipRouteInfoTable, ipRouteInfoInterface=ipRouteInfoInterface, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfTotalAreas=ospfTotalAreas, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfProcessUptime=ospfProcessUptime, arpInfoFlag=arpInfoFlag, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgIntfMask=ipNewCfgIntfMask, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumTxHello=ospfCumTxHello, routerLSAId=routerLSAId, ospfAreaNbrDown=ospfAreaNbrDown, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfNbrChange=ospfIntfNbrChange, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfHostTableMaxSize=ospfHostTableMaxSize, routerLSALinkID=routerLSALinkID, ripNewCfgState=ripNewCfgState, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfStats=ospfStats, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, arpStatHighWater=arpStatHighWater, ospfinfo=ospfinfo, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgGwEntry=ipNewCfgGwEntry, routeStatMaxEntries=routeStatMaxEntries, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpOper=vrrpOper, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfTotalNssaAreas=ospfTotalNssaAreas, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfRxHello=ospfIntfRxHello, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfGeneral=ospfGeneral, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfArea=ospfArea, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaNbrStart=ospfAreaNbrStart, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgGwState=ipCurCfgGwState, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ripCurCfgVip=ripCurCfgVip, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgGwState=ipNewCfgGwState, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, routeStatEntries=routeStatEntries, ospfAreaChangeStats=ospfAreaChangeStats, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, routeStatHighWater=routeStatHighWater, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgIntfTable=ipCurCfgIntfTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumRxlsAcks=ospfCumRxlsAcks, ripStats=ripStats, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaTxHello=ospfAreaTxHello, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfUnloop=ospfIntfUnloop, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipRouteInfoType=ipRouteInfoType, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfDown=ospfIntfDown, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdNewCfgState=ipFwdNewCfgState, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfHello=ospfIntfHello, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry)
