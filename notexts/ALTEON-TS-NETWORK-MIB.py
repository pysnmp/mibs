...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ripStats=ripStats, vrrpOper=vrrpOper, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfRxHello=ospfIntfRxHello, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipRouteInfoType=ipRouteInfoType, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ripCurCfgState=ripCurCfgState, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumIntfLoop=ospfCumIntfLoop, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumTxPkts=ospfCumTxPkts, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipCurCfgGwEntry=ipCurCfgGwEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfTotalAreas=ospfTotalAreas, ospfAreaInfoEntry=ospfAreaInfoEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfTotalNssaAreas=ospfTotalNssaAreas, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumTxlsUpdates=ospfCumTxlsUpdates, routeStats=routeStats, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, arpInfoMacAddr=arpInfoMacAddr, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCurCfgAreaId=ospfCurCfgAreaId, dnsStats=dnsStats, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ripNewCfgState=ripNewCfgState, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCfg=ospfCfg, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfGeneralInfo=ospfGeneralInfo, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ripConfig=ripConfig, ipRouteInfoTag=ipRouteInfoTag, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgGenState=vrrpNewCfgGenState, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumTxlsAcks=ospfCumTxlsAcks, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgBootpState=ipNewCfgBootpState, routerLSAId=routerLSAId, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrp_info=vrrp_info, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfInfoTable=ospfIntfInfoTable, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaIntfDown=ospfAreaIntfDown, vrrp=vrrp, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipForward=ipForward, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfRangeTableMaxSize=ospfRangeTableMaxSize, arpInfoFlag=arpInfoFlag, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgGwArp=ipNewCfgGwArp, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfInterface=ospfInterface, routerLSALinkID=routerLSALinkID, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ripNewCfgDefListen=ripNewCfgDefListen, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, arpInfoVLAN=arpInfoVLAN, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripCurCfgVip=ripCurCfgVip, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfTableMaxSize=ospfIntfTableMaxSize, routerLSAAreaIndex=routerLSAAreaIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfinfo=ospfinfo, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgIntfTable=ipCurCfgIntfTable, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, arpInfoEntry=arpInfoEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaTxPkts=ospfAreaTxPkts, arpInfoRefPorts=arpInfoRefPorts, ospfIntfTxPkts=ospfIntfTxPkts, vrrpGeneral=vrrpGeneral, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ripNewCfgVip=ripNewCfgVip, ripStatOutPkts=ripStatOutPkts, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, arpInfoDestIp=arpInfoDestIp, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, arpStats=arpStats, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgGwArp=ipCurCfgGwArp, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfArea=ospfArea, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfLoop=ospfIntfLoop, ospfCumTxHello=ospfCumTxHello, ipInterfaceTableMax=ipInterfaceTableMax, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumRxTxStats=ospfCumRxTxStats, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfUnloop=ospfIntfUnloop, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfStartTime=ospfStartTime, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumRxHello=ospfCumRxHello, ipNewCfgGwRetry=ipNewCfgGwRetry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfNbrInFullState=ospfNbrInFullState, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfIndex=ospfIntfIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumNbrDown=ospfCumNbrDown, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, arpInfoTable=arpInfoTable, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipCurCfgGwIndex=ipCurCfgGwIndex, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipGatewayTableMax=ipGatewayTableMax, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgGwState=ipNewCfgGwState, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaNbrDown=ospfAreaNbrDown, ospfGeneral=ospfGeneral, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ripCurCfgStaticSupply=ripCurCfgStaticSupply, iprouting=iprouting, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumNbrStart=ospfCumNbrStart, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgGenState=vrrpCurCfgGenState, ipCurCfgBootpState=ipCurCfgBootpState, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ripNewCfgListen=ripNewCfgListen, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfCumRxPkts=ospfCumRxPkts, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfGeneralStats=ospfGeneralStats, routeStatHighWater=routeStatHighWater, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipCurCfgIntfMask=ipCurCfgIntfMask, ip_info=ip_info, routeStatMaxEntries=routeStatMaxEntries, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaIntfLoop=ospfAreaIntfLoop, ripNewCfgSupply=ripNewCfgSupply, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfStats=ospfStats, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, routeStatEntries=routeStatEntries, ospfCumIntfDown=ospfCumIntfDown, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, arpInfoSrcPort=arpInfoSrcPort, ospfCumIntfBackup=ospfCumIntfBackup)
