...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfNbrInExchState=ospfNbrInExchState, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipGatewayTableMax=ipGatewayTableMax, ospfStartTime=ospfStartTime, arpStats=arpStats, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfTotalNeighbours=ospfTotalNeighbours, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgGwEntry=ipCurCfgGwEntry, arpInfoEntry=arpInfoEntry, ripNewCfgListen=ripNewCfgListen, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ripNewCfgSupply=ripNewCfgSupply, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfRxHello=ospfIntfRxHello, vrrpStatInAdvers=vrrpStatInAdvers, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgGwState=ipNewCfgGwState, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaNbrhello=ospfAreaNbrhello, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipRouteInfoTag=ipRouteInfoTag, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumTxHello=ospfCumTxHello, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgGwArp=ipNewCfgGwArp, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, routerLSALinkID=routerLSALinkID, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, routerLSALinkData=routerLSALinkData, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaTxHello=ospfAreaTxHello, ospfGeneralInfo=ospfGeneralInfo, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipCurCfgGwState=ipCurCfgGwState, routeStatEntries=routeStatEntries, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgGwInterval=ipNewCfgGwInterval, routerLSALinkIndex=routerLSALinkIndex, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumTxPkts=ospfCumTxPkts, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgGwVlan=ipNewCfgGwVlan, arpInfoMacAddr=arpInfoMacAddr, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfStats=ospfStats, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfNbrInInitState=ospfNbrInInitState, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfInfoTable=ospfIntfInfoTable, arpInfoRefPorts=arpInfoRefPorts, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipCurCfgGwMetric=ipCurCfgGwMetric, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfNbrhello=ospfIntfNbrhello, ospfIfTotalNeighbours=ospfIfTotalNeighbours, routerLSAAreaIndex=routerLSAAreaIndex, routeStats=routeStats, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfArea=ospfArea, vrrp_info=vrrp_info, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, routeStatHighWater=routeStatHighWater, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, arpStatMaxEntries=arpStatMaxEntries, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, arpInfoFlag=arpInfoFlag, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaIntfDown=ospfAreaIntfDown, iprouting=iprouting, ospfTimersKickOffStats=ospfTimersKickOffStats, arpInfoTable=arpInfoTable, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgGwArp=ipCurCfgGwArp, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaInfoEntry=ospfAreaInfoEntry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumNbrStart=ospfCumNbrStart, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpOper=vrrpOper, vrrp=vrrp, dnsStats=dnsStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipFwdNewCfgState=ipFwdNewCfgState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCfg=ospfCfg, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ripConfig=ripConfig, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, routeStatMaxEntries=routeStatMaxEntries, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ripCurCfgSupply=ripCurCfgSupply, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfIndex=ospfIntfIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumIntfDown=ospfCumIntfDown, ospfIntfBackup=ospfIntfBackup, vrrpGeneral=vrrpGeneral, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipRouteInfoTable=ipRouteInfoTable, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaInfoId=ospfAreaInfoId, ripNewCfgVip=ripNewCfgVip, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgGwInterval=ipCurCfgGwInterval, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfNbrInFullState=ospfNbrInFullState, ospfinfo=ospfinfo, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfUnloop=ospfIntfUnloop, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipForward=ipForward, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfRangeTableMaxSize=ospfRangeTableMaxSize, arpInfoSrcPort=arpInfoSrcPort, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaTxlsReqs=ospfAreaTxlsReqs, arpInfoDestIp=arpInfoDestIp, arpInfoVLAN=arpInfoVLAN, ospfIfInfoIndex=ospfIfInfoIndex, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaIntfLoop=ospfAreaIntfLoop, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgGwRetry=ipNewCfgGwRetry, ip_info=ip_info, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ripStats=ripStats, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ripNewCfgState=ripNewCfgState, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfHello=ospfIntfHello, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfDown=ospfIntfDown, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfInterface=ospfInterface, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipRouteInfoType=ipRouteInfoType, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, arpStatEntries=arpStatEntries, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipInterfaceTableMax=ipInterfaceTableMax, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipNewCfgGwMetric=ipNewCfgGwMetric, ripStatOutPkts=ripStatOutPkts, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, arpStatHighWater=arpStatHighWater, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfGeneral=ospfGeneral, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpStats=vrrpStats, ospfTotalAreas=ospfTotalAreas, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ripStatInPkts=ripStatInPkts, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfNbrStart=ospfIntfNbrStart, ospfProcessUptime=ospfProcessUptime, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast)
