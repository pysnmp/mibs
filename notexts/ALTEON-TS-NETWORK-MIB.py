...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCumIntfHello=ospfCumIntfHello, ospfCumRxlsAcks=ospfCumRxlsAcks, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumIntfLoop=ospfCumIntfLoop, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, ipCurCfgIntfIndex=ipCurCfgIntfIndex, arpInfoRefPorts=arpInfoRefPorts, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfTxPkts=ospfIntfTxPkts, ospfHostTableMaxSize=ospfHostTableMaxSize, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrp=vrrp, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipGatewayTableMax=ipGatewayTableMax, ripStatInPkts=ripStatInPkts, ospfProcessUptime=ospfProcessUptime, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipForward=ipForward, ospfIntfTxlsAcks=ospfIntfTxlsAcks, routerLSALinkIndex=routerLSALinkIndex, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ripConfig=ripConfig, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfRxHello=ospfIntfRxHello, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfIndex=ospfIntfIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgIntfAddr=ipNewCfgIntfAddr, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, arpInfoTable=arpInfoTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfChangeStats=ospfIntfChangeStats, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfNbrInInitState=ospfNbrInInitState, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipRouteInfoEntry=ipRouteInfoEntry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumTxHello=ospfCumTxHello, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumRxlsReqs=ospfCumRxlsReqs, arpStatHighWater=arpStatHighWater, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaNbrN1way=ospfAreaNbrN1way, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ripNewCfgDefListen=ripNewCfgDefListen, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, routerLSAId=routerLSAId, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgGenState=vrrpCurCfgGenState, arpInfoVLAN=arpInfoVLAN, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfNbrInFullState=ospfNbrInFullState, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfArea=ospfArea, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfNbrhello=ospfIntfNbrhello, routeStatHighWater=routeStatHighWater, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumRxPkts=ospfCumRxPkts, ripCurCfgListen=ripCurCfgListen, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumTxPkts=ospfCumTxPkts, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, arpStatEntries=arpStatEntries, ospfIntfInfoTable=ospfIntfInfoTable, routerLSAAreaIndex=routerLSAAreaIndex, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ip_info=ip_info, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaTxHello=ospfAreaTxHello, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgGenState=vrrpNewCfgGenState, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaIntfBackup=ospfAreaIntfBackup, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripStats=ripStats, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipCurCfgIntfTable=ipCurCfgIntfTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfTxlsReqs=ospfIntfTxlsReqs, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfHello=ospfIntfHello, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumRxHello=ospfCumRxHello, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaNbrStart=ospfAreaNbrStart, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfUnloop=ospfIntfUnloop, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, iprouting=iprouting, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, arpInfoFlag=arpInfoFlag, arpInfoDestIp=arpInfoDestIp, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgGwState=ipNewCfgGwState, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumNbrN1way=ospfCumNbrN1way, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumIntfBackup=ospfCumIntfBackup, ospfinfo=ospfinfo, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaIntfHello=ospfAreaIntfHello, ospfStats=ospfStats, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpStatOutAdvers=vrrpStatOutAdvers)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, routerLSALinkData=routerLSALinkData, ospfIntfNbrChange=ospfIntfNbrChange, ipRouteInfoIndx=ipRouteInfoIndx, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfInterface=ospfInterface, ospfIntfBackup=ospfIntfBackup, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, routeStatEntries=routeStatEntries, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipRouteInfoType=ipRouteInfoType, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaChangeStats=ospfAreaChangeStats, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfGeneralStats=ospfGeneralStats, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfRxPkts=ospfIntfRxPkts, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ripStatInErrorPkts=ripStatInErrorPkts, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumRxDatabase=ospfCumRxDatabase, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCfg=ospfCfg, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfGeneral=ospfGeneral, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgIntfState=ipNewCfgIntfState, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfDown=ospfIntfDown, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripStatOutPkts=ripStatOutPkts, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumNbrStart=ospfCumNbrStart, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumRxTxStats=ospfCumRxTxStats, vrrp_info=vrrp_info, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ripNewCfgVip=ripNewCfgVip, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipCurCfgGwState=ipCurCfgGwState, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, dnsStats=dnsStats, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfStartTime=ospfStartTime, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipRouteInfoInterface=ipRouteInfoInterface, vrrpOper=vrrpOper, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ripCurCfgVip=ripCurCfgVip, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgGwRetry=ipCurCfgGwRetry, routerLSALinkID=routerLSALinkID, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpStats=vrrpStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaNbrhello=ospfAreaNbrhello, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumNbrDown=ospfCumNbrDown, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, routeStats=routeStats, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, arpInfoSrcPort=arpInfoSrcPort, ipNewCfgGwArp=ipNewCfgGwArp, ospfTotalAreas=ospfTotalAreas, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCurCfgAreaId=ospfCurCfgAreaId, arpStats=arpStats, ospfCumTxlsReqs=ospfCumTxlsReqs, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, routerLSALinkIfIndex=routerLSALinkIfIndex)
