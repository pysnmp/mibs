...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, arpStatEntries=arpStatEntries, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipNewCfgGwTable=ipNewCfgGwTable, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, routerLSALinkIndex=routerLSALinkIndex, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumNbrhello=ospfCumNbrhello, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgGwVlan=ipNewCfgGwVlan, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfNbrInInitState=ospfNbrInInitState, ipRouteInfoIndx=ipRouteInfoIndx, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumIntfDown=ospfCumIntfDown, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaRxTxStats=ospfAreaRxTxStats, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfChangeStats=ospfIntfChangeStats, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfCountForRouter=ospfIntfCountForRouter, routeStatHighWater=routeStatHighWater, ospfIntfRxPkts=ospfIntfRxPkts, ripNewCfgVip=ripNewCfgVip, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaTxPkts=ospfAreaTxPkts, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipNewCfgGwRetry=ipNewCfgGwRetry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCumIntfHello=ospfCumIntfHello, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCfg=ospfCfg, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfTotalNeighbours=ospfTotalNeighbours, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfNbrDown=ospfIntfNbrDown, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfRxTxStats=ospfIntfRxTxStats, arpStats=arpStats, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, arpStatHighWater=arpStatHighWater, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, arpInfoMacAddr=arpInfoMacAddr, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfNbrIndex=ospfIntfNbrIndex, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfTxHello=ospfIntfTxHello, ospfGeneral=ospfGeneral, ripCurCfgState=ripCurCfgState, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgGwTable=ipCurCfgGwTable, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgGwState=ipCurCfgGwState, ipRouteInfoTag=ipRouteInfoTag, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfInterface=ospfInterface, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, arpInfoDestIp=arpInfoDestIp, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumIntfLoop=ospfCumIntfLoop, ripCurCfgVip=ripCurCfgVip, ospfIntfNbrChange=ospfIntfNbrChange, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripNewCfgSupply=ripNewCfgSupply, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipCurCfgIntfTable=ipCurCfgIntfTable, ripCurCfgListen=ripCurCfgListen, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumNbrStart=ospfCumNbrStart, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaRxHello=ospfAreaRxHello, ipRouteInfoEntry=ipRouteInfoEntry, routerLSALinkID=routerLSALinkID, routeStatEntries=routeStatEntries, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumRxPkts=ospfCumRxPkts, ospfCumRxHello=ospfCumRxHello, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ripStats=ripStats, ipCurCfgGwArp=ipCurCfgGwArp, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, arpInfoTable=arpInfoTable, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaNbrhello=ospfAreaNbrhello, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaNbrStart=ospfAreaNbrStart, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfStats=ospfStats, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipRouteInfoTable=ipRouteInfoTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfLoop=ospfIntfLoop, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, arpInfoEntry=arpInfoEntry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ripConfig=ripConfig, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfIndex=ospfIntfIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaRxPkts=ospfAreaRxPkts, arpInfoFlag=arpInfoFlag, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumTxHello=ospfCumTxHello, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipRouteInfoInterface=ipRouteInfoInterface, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpGeneral=vrrpGeneral, iprouting=iprouting, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfProcessUptime=ospfProcessUptime, ripStatInPkts=ripStatInPkts, ospfIntfHello=ospfIntfHello, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipForward=ipForward, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpOper=vrrpOper, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpStatInAdvers=vrrpStatInAdvers, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipCurCfgBootpState=ipCurCfgBootpState, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfDown=ospfIntfDown, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipGatewayTableMax=ipGatewayTableMax, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, routeStatMaxEntries=routeStatMaxEntries, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaNbrDown=ospfAreaNbrDown, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipCurCfgIntfState=ipCurCfgIntfState, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaTxHello=ospfAreaTxHello, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfBackup=ospfIntfBackup, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumNbrN1way=ospfCumNbrN1way, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrp=vrrp, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfStartTime=ospfStartTime, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumNbrDown=ospfCumNbrDown, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrp_info=vrrp_info, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCurCfgAreaId=ospfCurCfgAreaId, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfUnloop=ospfIntfUnloop, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, routeStats=routeStats, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfNbrInExchState=ospfNbrInExchState, ip_info=ip_info, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfArea=ospfArea, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpStats=vrrpStats, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIfTotalNeighbours=ospfIfTotalNeighbours, arpStatMaxEntries=arpStatMaxEntries, dnsStats=dnsStats, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgGwInterval=ipCurCfgGwInterval, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipInterfaceTableMax=ipInterfaceTableMax, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing)
