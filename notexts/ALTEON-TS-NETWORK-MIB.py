...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpOper=vrrpOper, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ripNewCfgVip=ripNewCfgVip, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ripStatOutPkts=ripStatOutPkts, ospfIntfUnloop=ospfIntfUnloop, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripNewCfgState=ripNewCfgState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, dnsStats=dnsStats, routerLSAId=routerLSAId, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaNbrStart=ospfAreaNbrStart, ospfTotalNeighbours=ospfTotalNeighbours, ipRouteInfoMask=ipRouteInfoMask, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfNbrhello=ospfIntfNbrhello, ospfInterface=ospfInterface, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumIntfDown=ospfCumIntfDown, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ripNewCfgListen=ripNewCfgListen, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgBootpState=ipCurCfgBootpState, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, arpInfoDestIp=arpInfoDestIp, ospfGeneral=ospfGeneral, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpStats=vrrpStats, ospfIntfDown=ospfIntfDown, ipGatewayTableMax=ipGatewayTableMax, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfinfo=ospfinfo, vrrp=vrrp, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, arpInfoEntry=arpInfoEntry, ospfIntfLoop=ospfIntfLoop, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipRouteInfoEntry=ipRouteInfoEntry, ipCurCfgGwState=ipCurCfgGwState, arpInfoRefPorts=arpInfoRefPorts, arpStatEntries=arpStatEntries, ospfCumRxTxStats=ospfCumRxTxStats, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ripStats=ripStats, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrChange=ospfIntfNbrChange, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipNewCfgGwEntry=ipNewCfgGwEntry, arpStats=arpStats, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripStatInPkts=ripStatInPkts, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgGwState=ipNewCfgGwState, ospfAreaChangeStats=ospfAreaChangeStats, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumNbrN1way=ospfCumNbrN1way, ripCurCfgState=ripCurCfgState, ospfTimersKickOffStats=ospfTimersKickOffStats, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ripConfig=ripConfig, ospfIntfInfoTable=ospfIntfInfoTable, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfBackup=ospfIntfBackup, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ip_info=ip_info, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, arpStatHighWater=arpStatHighWater, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumNbrDown=ospfCumNbrDown, ospfIntfTxPkts=ospfIntfTxPkts, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaTxHello=ospfAreaTxHello, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfRxTxStats=ospfIntfRxTxStats, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfArea=ospfArea, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfNbrInInitState=ospfNbrInInitState, ospfProcessUptime=ospfProcessUptime, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaRxHello=ospfAreaRxHello, ospfAreaNbrN1way=ospfAreaNbrN1way)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumNbrhello=ospfCumNbrhello, ripStatInErrorPkts=ripStatInErrorPkts, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, arpInfoVLAN=arpInfoVLAN, ospfIntfHello=ospfIntfHello, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfTotalAreas=ospfTotalAreas, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, routeStatHighWater=routeStatHighWater, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaIntfBackup=ospfAreaIntfBackup, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumIntfHello=ospfCumIntfHello, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, routeStatMaxEntries=routeStatMaxEntries, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgGwAddr=ipCurCfgGwAddr, routerLSALinkData=routerLSALinkData, routerLSALinkID=routerLSALinkID, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpGeneral=vrrpGeneral, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCfg=ospfCfg, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfStartTime=ospfStartTime, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgGwEntry=ipCurCfgGwEntry, routerLSALinkIndex=routerLSALinkIndex, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipRouteInfoIndx=ipRouteInfoIndx, iprouting=iprouting, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ripNewCfgSupply=ripNewCfgSupply, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, routerLSALinkIfIndex=routerLSALinkIfIndex, ipRouteInfoTable=ipRouteInfoTable, ipForward=ipForward, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, arpInfoTable=arpInfoTable, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumRxPkts=ospfCumRxPkts, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ripCurCfgVip=ripCurCfgVip, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumIntfLoop=ospfCumIntfLoop, arpInfoMacAddr=arpInfoMacAddr, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfNbrRstAd=ospfIntfNbrRstAd, routeStatEntries=routeStatEntries, routeStats=routeStats, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfNbrIndex=ospfIntfNbrIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaRxPkts=ospfAreaRxPkts, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfStats=ospfStats, ripCurCfgListen=ripCurCfgListen, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipRouteInfoGateway=ipRouteInfoGateway, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrp_info=vrrp_info, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, arpStatMaxEntries=arpStatMaxEntries, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfIndex=ospfIntfIndex, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx)
