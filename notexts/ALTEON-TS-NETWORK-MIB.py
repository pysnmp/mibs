...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumTxlsAcks=ospfCumTxlsAcks, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCfg=ospfCfg, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipRouteInfoTable=ipRouteInfoTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, arpInfoSrcPort=arpInfoSrcPort, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaInfoId=ospfAreaInfoId, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfProcessUptime=ospfProcessUptime, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, routerLSALinkData=routerLSALinkData, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipRouteInfoGateway=ipRouteInfoGateway, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipRouteInfoInterface=ipRouteInfoInterface, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfRxHello=ospfIntfRxHello, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, routerLSALinkID=routerLSALinkID, ipNewCfgGwState=ipNewCfgGwState, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipRouteInfoIndx=ipRouteInfoIndx, ipFwdCurCfgState=ipFwdCurCfgState, ripConfig=ripConfig, ospfCumRxPkts=ospfCumRxPkts, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumNbrDown=ospfCumNbrDown, ospfStats=ospfStats, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumNbrStart=ospfCumNbrStart, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, arpStatHighWater=arpStatHighWater, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaNbrDown=ospfAreaNbrDown, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ripCurCfgListen=ripCurCfgListen, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfTxHello=ospfIntfTxHello, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfNbrInInitState=ospfNbrInInitState, ipGatewayTableMax=ipGatewayTableMax, ospfAreaNbrhello=ospfAreaNbrhello, ipNewCfgBootpState=ipNewCfgBootpState, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfNbrInFullState=ospfNbrInFullState, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrp_info=vrrp_info, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfHello=ospfIntfHello, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfCountForRouter=ospfIntfCountForRouter, ipRouteInfoType=ipRouteInfoType, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfinfo=ospfinfo, vrrpStats=vrrpStats, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfGeneralStats=ospfGeneralStats, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfRangeTableMaxSize=ospfRangeTableMaxSize, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaNbrStart=ospfAreaNbrStart, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipForward=ipForward, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumIntfDown=ospfCumIntfDown, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfStartTime=ospfStartTime, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ripStats=ripStats, ipCurCfgIntfState=ipCurCfgIntfState, ipInterfaceTableMax=ipInterfaceTableMax, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ripCurCfgState=ripCurCfgState, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCumRxHello=ospfCumRxHello, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, dnsStats=dnsStats, ospfIntfLoop=ospfIntfLoop, ospfCumIntfBackup=ospfCumIntfBackup, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipRouteInfoTag=ipRouteInfoTag, iprouting=iprouting, vrrp=vrrp, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpOper=vrrpOper)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, arpStats=arpStats, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaRxHello=ospfAreaRxHello, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipRouteInfoMask=ipRouteInfoMask, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfBackup=ospfIntfBackup, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIfInfoIndex=ospfIfInfoIndex, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfNbrInExchState=ospfNbrInExchState, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgGwMetric=ipNewCfgGwMetric, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ripCurCfgVip=ripCurCfgVip, ospfTotalAreas=ospfTotalAreas, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgGwMetric=ipCurCfgGwMetric, routeStatEntries=routeStatEntries, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumIntfHello=ospfCumIntfHello, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfArea=ospfArea, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripStatInPkts=ripStatInPkts, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, routeStats=routeStats, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ripCurCfgSupply=ripCurCfgSupply, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, arpInfoVLAN=arpInfoVLAN, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipNewCfgGwArp=ipNewCfgGwArp, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripStatOutPkts=ripStatOutPkts, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfTimersKickOffStats=ospfTimersKickOffStats, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ip_info=ip_info, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfNbrChange=ospfIntfNbrChange, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, arpInfoEntry=arpInfoEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, arpInfoMacAddr=arpInfoMacAddr, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfDown=ospfIntfDown, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaIntfHello=ospfAreaIntfHello, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgIntfIndex=ipCurCfgIntfIndex, arpInfoDestIp=arpInfoDestIp, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfChangeStats=ospfIntfChangeStats, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, arpStatEntries=arpStatEntries, ospfInterface=ospfInterface, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf)
