...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdNewCfgState=ipFwdNewCfgState, ripConfig=ripConfig, ospfNbrInExchState=ospfNbrInExchState, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfHello=ospfIntfHello, iprouting=iprouting, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfIndex=ospfIntfIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfLoop=ospfIntfLoop, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaNbrStart=ospfAreaNbrStart, ripCurCfgState=ripCurCfgState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgBootpState=ipCurCfgBootpState, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipNewCfgGwArp=ipNewCfgGwArp, arpStatHighWater=arpStatHighWater, ospfCumIntfBackup=ospfCumIntfBackup, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfTimersKickOffStats=ospfTimersKickOffStats, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipForward=ipForward, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, arpInfoSrcPort=arpInfoSrcPort, ospfAreaInfoIndex=ospfAreaInfoIndex, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, arpInfoFlag=arpInfoFlag, ospfAreaTxDatabase=ospfAreaTxDatabase, dnsStats=dnsStats, ospfinfo=ospfinfo, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfArea=ospfArea, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaRxDatabase=ospfAreaRxDatabase, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdCurCfgState=ipFwdCurCfgState, ospfInterface=ospfInterface, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfUnloop=ospfIntfUnloop, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgIntfTable=ipNewCfgIntfTable, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgGwTable=ipCurCfgGwTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrp_info=vrrp_info, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpOper=vrrpOper, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaTxHello=ospfAreaTxHello, ospfTotalTransitAreas=ospfTotalTransitAreas, arpInfoEntry=arpInfoEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, routerLSALinkData=routerLSALinkData, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgGwVlan=ipCurCfgGwVlan, routerLSAId=routerLSAId, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumTxDatabase=ospfCumTxDatabase, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipRouteInfoTag=ipRouteInfoTag, ospfGeneral=ospfGeneral, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfGeneralStats=ospfGeneralStats, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfTxPkts=ospfIntfTxPkts, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, arpInfoMacAddr=arpInfoMacAddr, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgBootpState=ipNewCfgBootpState, ip_info=ip_info, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgGwMetric=ipNewCfgGwMetric, ripNewCfgDefListen=ripNewCfgDefListen, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgIntfState=ipCurCfgIntfState, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCumNbrDown=ospfCumNbrDown, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaInfoEntry=ospfAreaInfoEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ripCurCfgDefListen=ripCurCfgDefListen, ripNewCfgState=ripNewCfgState, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, arpInfoVLAN=arpInfoVLAN, ripNewCfgSupply=ripNewCfgSupply, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, routeStats=routeStats, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfDown=ospfIntfDown, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgGwVlan=ipNewCfgGwVlan, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfProcessUptime=ospfProcessUptime, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgGenState=vrrpNewCfgGenState, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumNbrStart=ospfCumNbrStart, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgGwEntry=ipNewCfgGwEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumIntfHello=ospfCumIntfHello, arpStatMaxEntries=arpStatMaxEntries, vrrpGeneral=vrrpGeneral, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumNbrhello=ospfCumNbrhello, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, arpStats=arpStats, ospfTotalAreas=ospfTotalAreas, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, routeStatMaxEntries=routeStatMaxEntries, ospfCumIntfLoop=ospfCumIntfLoop, routeStatHighWater=routeStatHighWater, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumRxPkts=ospfCumRxPkts, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfTxlsAcks=ospfIntfTxlsAcks, arpInfoTable=arpInfoTable, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, routeStatEntries=routeStatEntries, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgGwArp=ipCurCfgGwArp, arpStatEntries=arpStatEntries, ipNewCfgIntfState=ipNewCfgIntfState, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, routerLSALinkIndex=routerLSALinkIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumIntfDown=ospfCumIntfDown, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipGatewayTableMax=ipGatewayTableMax, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgGwState=ipCurCfgGwState, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfNbrN1way=ospfIntfNbrN1way, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrp=vrrp, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpStatInAdvers=vrrpStatInAdvers, routerLSALinkID=routerLSALinkID, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ripCurCfgVip=ripCurCfgVip, ospfCumTxPkts=ospfCumTxPkts, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumRxHello=ospfCumRxHello, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ripNewCfgVip=ripNewCfgVip, ipCurCfgIntfTable=ipCurCfgIntfTable, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripCurCfgListen=ripCurCfgListen, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfNbrInInitState=ospfNbrInInitState, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfTxHello=ospfIntfTxHello, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipRouteInfoEntry=ipRouteInfoEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ripStatOutPkts=ripStatOutPkts, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfStats=ospfStats, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpStats=vrrpStats, ripStatInPkts=ripStatInPkts, arpInfoDestIp=arpInfoDestIp, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfGeneralInfo=ospfGeneralInfo, ripStats=ripStats, ospfCumRxTxStats=ospfCumRxTxStats, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaNbrhello=ospfAreaNbrhello)
