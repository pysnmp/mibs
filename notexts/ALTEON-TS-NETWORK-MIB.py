...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgIntfVlan=ipCurCfgIntfVlan, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaInfoIndex=ospfAreaInfoIndex, arpStats=arpStats, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgIntfTable=ipCurCfgIntfTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, routeStatHighWater=routeStatHighWater, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfTotalTransitAreas=ospfTotalTransitAreas, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripCurCfgListen=ripCurCfgListen, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, routeStatMaxEntries=routeStatMaxEntries, ospfCumNbrN1way=ospfCumNbrN1way, arpInfoMacAddr=arpInfoMacAddr, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumIntfNbrChange=ospfCumIntfNbrChange, dnsStats=dnsStats, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaNbrhello=ospfAreaNbrhello, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfNewCfgAreaId=ospfNewCfgAreaId, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ripConfig=ripConfig, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipRouteInfoMask=ipRouteInfoMask, ospfAreaIntfHello=ospfAreaIntfHello, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfProcessUptime=ospfProcessUptime, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaRxTxStats=ospfAreaRxTxStats, arpInfoDestIp=arpInfoDestIp, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipForward=ipForward, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfStats=ospfStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaRxlsReqs=ospfAreaRxlsReqs, routerLSALinkIndex=routerLSALinkIndex, ospfGeneralStats=ospfGeneralStats, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgGwState=ipNewCfgGwState, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfArea=ospfArea, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripStatInPkts=ripStatInPkts, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumIntfBackup=ospfCumIntfBackup, ospfGeneralInfo=ospfGeneralInfo, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripCurCfgDefListen=ripCurCfgDefListen, arpInfoFlag=arpInfoFlag, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumNbrBadSequence=ospfCumNbrBadSequence, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfIndex=ospfIntfIndex, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfNbrChange=ospfIntfNbrChange, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpStatInAdvers=vrrpStatInAdvers, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, arpInfoEntry=arpInfoEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfUnloop=ospfIntfUnloop, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfRxTxIndex=ospfIntfRxTxIndex, routeStats=routeStats, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpStats=vrrpStats, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfInfoTable=ospfIntfInfoTable, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgGwIndex=ipNewCfgGwIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfChangeStats=ospfIntfChangeStats, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfNbrInInitState=ospfNbrInInitState, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, arpInfoVLAN=arpInfoVLAN, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ripStats=ripStats, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaInfoId=ospfAreaInfoId, ipRouteInfoIndx=ipRouteInfoIndx, ipRouteInfoInterface=ipRouteInfoInterface, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfTxHello=ospfIntfTxHello, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgIntfMask=ipCurCfgIntfMask, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ripCurCfgVip=ripCurCfgVip, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfDown=ospfIntfDown, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, routerLSAId=routerLSAId, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumNbrStart=ospfCumNbrStart, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpOper=vrrpOper, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumIntfDown=ospfCumIntfDown, arpStatHighWater=arpStatHighWater, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, arpInfoSrcPort=arpInfoSrcPort, ospfIntfBackup=ospfIntfBackup, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumTxHello=ospfCumTxHello, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ripNewCfgSupply=ripNewCfgSupply, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIfInfoIndex=ospfIfInfoIndex, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfNbrInExchState=ospfNbrInExchState, ospfIntfLoop=ospfIntfLoop, ospfAreaTxHello=ospfAreaTxHello, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumRxPkts=ospfCumRxPkts, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgGwTable=ipCurCfgGwTable, arpInfoTable=arpInfoTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumNbrhello=ospfCumNbrhello, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ripCurCfgState=ripCurCfgState, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfInterface=ospfInterface, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrp=vrrp, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ripNewCfgListen=ripNewCfgListen, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgGwMetric=ipCurCfgGwMetric, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaRxDatabase=ospfAreaRxDatabase, routerLSALinkData=routerLSALinkData, ospfCumNbrDown=ospfCumNbrDown, ospfCumTxPkts=ospfCumTxPkts, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfHello=ospfIntfHello, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, arpStatEntries=arpStatEntries, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ripNewCfgVip=ripNewCfgVip, routerLSALinkID=routerLSALinkID, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, routerLSAAreaIndex=routerLSAAreaIndex, arpInfoRefPorts=arpInfoRefPorts, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfinfo=ospfinfo, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipRouteInfoType=ipRouteInfoType, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCfg=ospfCfg, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, iprouting=iprouting, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipFwdCurCfgState=ipFwdCurCfgState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, arpStatMaxEntries=arpStatMaxEntries, ospfLsTypesSupported=ospfLsTypesSupported, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfRxHello=ospfIntfRxHello, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, routeStatEntries=routeStatEntries, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrp_info=vrrp_info, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ip_info=ip_info, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaInfoTable=ospfAreaInfoTable, ripStatInErrorPkts=ripStatInErrorPkts, ospfGeneral=ospfGeneral, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripStatOutPkts=ripStatOutPkts, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipInterfaceTableMax=ipInterfaceTableMax, ripNewCfgState=ripNewCfgState, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable)
