...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipCurCfgGwTable=ipCurCfgGwTable, ospfStartTime=ospfStartTime, ipNewCfgIntfMask=ipNewCfgIntfMask, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfChangeStats=ospfIntfChangeStats, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgIntfDelete=ipNewCfgIntfDelete, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, arpInfoEntry=arpInfoEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ip_info=ip_info, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgIntfEntry=ipCurCfgIntfEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipRouteInfoIndx=ipRouteInfoIndx, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumIntfHello=ospfCumIntfHello, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfNbrIndex=ospfIntfNbrIndex, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaInfoTable=ospfAreaInfoTable, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgGwRetry=ipNewCfgGwRetry, ripStatInPkts=ripStatInPkts, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgGwTable=ipNewCfgGwTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfVlinkCountForRouter=ospfVlinkCountForRouter, routerLSAAreaIndex=routerLSAAreaIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ripConfig=ripConfig, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipCurCfgGwInterval=ipCurCfgGwInterval, ipRouteInfoTable=ipRouteInfoTable, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfNbrInInitState=ospfNbrInInitState, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, arpInfoDestIp=arpInfoDestIp, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpOper=vrrpOper, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfArea=ospfArea, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumTxDatabase=ospfCumTxDatabase, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipRouteInfoMask=ipRouteInfoMask, vrrpStats=vrrpStats, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, arpInfoFlag=arpInfoFlag, routerLSALinkID=routerLSALinkID, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumRxPkts=ospfCumRxPkts, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgIntfAddr=ipCurCfgIntfAddr, routeStatHighWater=routeStatHighWater, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, arpInfoRefPorts=arpInfoRefPorts, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfNbrChange=ospfIntfNbrChange, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipCurCfgGwState=ipCurCfgGwState, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ripNewCfgListen=ripNewCfgListen, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, routeStats=routeStats, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumNbrhello=ospfCumNbrhello, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrp=vrrp, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, iprouting=iprouting, routeStatMaxEntries=routeStatMaxEntries, ripStats=ripStats, ospfIntfInfoTable=ospfIntfInfoTable, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumIntfLoop=ospfCumIntfLoop, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumTxlsUpdates=ospfCumTxlsUpdates, dnsStats=dnsStats, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfTotalTransitAreas=ospfTotalTransitAreas, arpStats=arpStats, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfInterface=ospfInterface, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipInterfaceTableMax=ipInterfaceTableMax, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ripNewCfgState=ripNewCfgState, ospfIntfBackup=ospfIntfBackup, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfTotalAreas=ospfTotalAreas, routeStatEntries=routeStatEntries, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumTxHello=ospfCumTxHello, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, arpInfoMacAddr=arpInfoMacAddr, ospfAreaInfoId=ospfAreaInfoId)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipForward=ipForward, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipRouteInfoType=ipRouteInfoType, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfLoop=ospfIntfLoop, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfUnloop=ospfIntfUnloop, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ripCurCfgState=ripCurCfgState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipRouteInfoInterface=ipRouteInfoInterface, ospfGeneralStats=ospfGeneralStats, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpGeneral=vrrpGeneral, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, arpInfoVLAN=arpInfoVLAN, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfLsTypesSupported=ospfLsTypesSupported, ripNewCfgSupply=ripNewCfgSupply, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ripStatOutPkts=ripStatOutPkts, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfNbrInFullState=ospfNbrInFullState, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgGwArp=ipCurCfgGwArp, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfNbrDown=ospfIntfNbrDown, routerLSALinkIndex=routerLSALinkIndex, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfGeneral=ospfGeneral, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaTxHello=ospfAreaTxHello, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripCurCfgVip=ripCurCfgVip, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfProcessUptime=ospfProcessUptime, ripNewCfgVip=ripNewCfgVip, ospfIntfTxHello=ospfIntfTxHello, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, routerLSAId=routerLSAId, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, arpInfoSrcPort=arpInfoSrcPort, arpStatMaxEntries=arpStatMaxEntries, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfNbrStart=ospfIntfNbrStart, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfTxlsAcks=ospfIntfTxlsAcks, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaRxHello=ospfAreaRxHello, ospfCfg=ospfCfg, ospfCumRxHello=ospfCumRxHello, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumNbrStart=ospfCumNbrStart, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, arpStatEntries=arpStatEntries, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipRouteInfoEntry=ipRouteInfoEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgGwState=ipNewCfgGwState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfStats=ospfStats, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, routerLSALinkData=routerLSALinkData, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfHello=ospfIntfHello, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway)
