...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumTxlsAcks=ospfCumTxlsAcks, ripNewCfgListen=ripNewCfgListen, ipFwdNewCfgState=ipFwdNewCfgState, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, routeStatMaxEntries=routeStatMaxEntries, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumRxlsAcks=ospfCumRxlsAcks, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, arpStats=arpStats, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaRxPkts=ospfAreaRxPkts, ripNewCfgState=ripNewCfgState, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgGwRetry=ipCurCfgGwRetry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaIntfHello=ospfAreaIntfHello, ospfStats=ospfStats, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfRxlsReqs=ospfIntfRxlsReqs, routeStats=routeStats, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfArea=ospfArea, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfBackup=ospfIntfBackup, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumNbrN1way=ospfCumNbrN1way, arpInfoEntry=arpInfoEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfUnloop=ospfIntfUnloop, routerLSALinkData=routerLSALinkData, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumIntfLoop=ospfCumIntfLoop, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumIntfDown=ospfCumIntfDown, ip_info=ip_info, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumNbrStart=ospfCumNbrStart, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgGwState=ipNewCfgGwState, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipRouteInfoGateway=ipRouteInfoGateway, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfHello=ospfIntfHello, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, arpStatHighWater=arpStatHighWater, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfIndex=ospfIntfIndex, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfDown=ospfIntfDown, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaIntfBackup=ospfAreaIntfBackup, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfNbrInFullState=ospfNbrInFullState, vrrp_info=vrrp_info, vrrpCurCfgGenState=vrrpCurCfgGenState, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, arpInfoDestIp=arpInfoDestIp, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ripNewCfgSupply=ripNewCfgSupply, ospfCumNbrhello=ospfCumNbrhello, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumTxDatabase=ospfCumTxDatabase, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, routeStatHighWater=routeStatHighWater, ospfProcessUptime=ospfProcessUptime, ospfTotalAreas=ospfTotalAreas, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfinfo=ospfinfo, vrrpOper=vrrpOper, ospfInterface=ospfInterface, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfChangeStats=ospfIntfChangeStats, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIfInfoIndex=ospfIfInfoIndex, arpInfoRefPorts=arpInfoRefPorts, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaTxPkts=ospfAreaTxPkts, ospfCfg=ospfCfg, ospfAreaInfoId=ospfAreaInfoId, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, iprouting=iprouting, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgGwTable=ipNewCfgGwTable, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumRxPkts=ospfCumRxPkts, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumTxPkts=ospfCumTxPkts, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumIntfHello=ospfCumIntfHello, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, arpStatMaxEntries=arpStatMaxEntries, ospfGeneralStats=ospfGeneralStats, ospfIntfNbrChange=ospfIntfNbrChange, vrrpStatInAdvers=vrrpStatInAdvers, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpGeneral=vrrpGeneral)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripStatInPkts=ripStatInPkts, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfRxPkts=ospfIntfRxPkts, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumIntfBackup=ospfCumIntfBackup, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfTxDatabase=ospfIntfTxDatabase, ipGatewayTableMax=ipGatewayTableMax, routerLSALinkID=routerLSALinkID, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgIntfState=ipNewCfgIntfState, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfStartTime=ospfStartTime, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrp=vrrp, ipForward=ipForward, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfRxHello=ospfIntfRxHello, arpInfoFlag=arpInfoFlag, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ripCurCfgVip=ripCurCfgVip, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfLoop=ospfIntfLoop, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpStats=vrrpStats, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ripConfig=ripConfig, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, dnsStats=dnsStats, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCurCfgAreaId=ospfCurCfgAreaId, routerLSAId=routerLSAId, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfNewCfgAreaTable=ospfNewCfgAreaTable, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgBootpState=ipNewCfgBootpState, ipRouteInfoMask=ipRouteInfoMask, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ripStatOutPkts=ripStatOutPkts, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumRxHello=ospfCumRxHello, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfTxHello=ospfIntfTxHello, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaRxHello=ospfAreaRxHello, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfRxTxIndex=ospfIntfRxTxIndex, routerLSALinkIndex=routerLSALinkIndex, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgGwState=ipCurCfgGwState, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgBootpAddr=ipNewCfgBootpAddr, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ripStats=ripStats, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipRouteInfoTable=ipRouteInfoTable, ripCurCfgListen=ripCurCfgListen, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumTxlsReqs=ospfCumTxlsReqs, arpInfoSrcPort=arpInfoSrcPort, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ripCurCfgState=ripCurCfgState, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry)
