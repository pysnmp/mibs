...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfinfo=ospfinfo, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipFwdCurCfgState=ipFwdCurCfgState, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfGeneralInfo=ospfGeneralInfo, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfArea=ospfArea, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ripNewCfgState=ripNewCfgState, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumNbrStart=ospfCumNbrStart, ospfTotalNssaAreas=ospfTotalNssaAreas, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumRxlsAcks=ospfCumRxlsAcks, iprouting=iprouting, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfNbrhello=ospfIntfNbrhello, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaInfoId=ospfAreaInfoId, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfTxPkts=ospfIntfTxPkts, vrrpGeneral=vrrpGeneral, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgGwState=ipNewCfgGwState, ospfCumTxHello=ospfCumTxHello, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaNbrStart=ospfAreaNbrStart, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfLoop=ospfIntfLoop, ospfIntfInfoTable=ospfIntfInfoTable, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ripCurCfgListen=ripCurCfgListen, ipRouteInfoType=ipRouteInfoType, ospfIntfDown=ospfIntfDown, ipRouteInfoTable=ipRouteInfoTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCumIntfHello=ospfCumIntfHello, ospfCumIntfLoop=ospfCumIntfLoop, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaInfoEntry=ospfAreaInfoEntry, routerLSALinkID=routerLSALinkID, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrp_info=vrrp_info, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaNbrIndex=ospfAreaNbrIndex, ipRouteInfoGateway=ipRouteInfoGateway, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfRxHello=ospfIntfRxHello, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, ripConfig=ripConfig, ospfIntfNbrDown=ospfIntfNbrDown, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, arpStats=arpStats, ospfCfg=ospfCfg, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpOper=vrrpOper, ospfIntfNbrChange=ospfIntfNbrChange, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, arpStatMaxEntries=arpStatMaxEntries, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaInfoTable=ospfAreaInfoTable, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfTotalAreas=ospfTotalAreas, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, routeStatHighWater=routeStatHighWater, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfCumTxDatabase=ospfCumTxDatabase, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, arpInfoSrcPort=arpInfoSrcPort, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumRxHello=ospfCumRxHello, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumNbrhello=ospfCumNbrhello, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrp=vrrp, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfGeneralStats=ospfGeneralStats, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumIntfDown=ospfCumIntfDown, arpInfoFlag=arpInfoFlag, routeStatEntries=routeStatEntries, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfInterface=ospfInterface, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaRxHello=ospfAreaRxHello, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ripCurCfgVip=ripCurCfgVip, ospfIfInfoIpAddress=ospfIfInfoIpAddress, routerLSAId=routerLSAId, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumTxPkts=ospfCumTxPkts, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfProcessUptime=ospfProcessUptime, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ripNewCfgSupply=ripNewCfgSupply, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripNewCfgDefListen=ripNewCfgDefListen, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripStats=ripStats, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, arpInfoRefPorts=arpInfoRefPorts, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfNbrInInitState=ospfNbrInInitState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, arpInfoTable=arpInfoTable, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, arpStatEntries=arpStatEntries, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaTxHello=ospfAreaTxHello, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumNbrDown=ospfCumNbrDown, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfIndex=ospfIntfIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipGatewayTableMax=ipGatewayTableMax, ospfIntfNbrStart=ospfIntfNbrStart, ospfStats=ospfStats, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgGwState=ipCurCfgGwState, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipRouteInfoInterface=ipRouteInfoInterface, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfHello=ospfIntfHello, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipRouteInfoMask=ipRouteInfoMask, arpInfoVLAN=arpInfoVLAN, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, routeStats=routeStats, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgGwArp=ipCurCfgGwArp, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumRxDatabase=ospfCumRxDatabase, ipRouteInfoTag=ipRouteInfoTag, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ripCurCfgState=ripCurCfgState, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ripStatInPkts=ripStatInPkts, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpStats=vrrpStats, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumRxPkts=ospfCumRxPkts, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfTxHello=ospfIntfTxHello, ospfIntfNbrN1way=ospfIntfNbrN1way, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfTxDatabase=ospfIntfTxDatabase, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfStartTime=ospfStartTime, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgBootpState=ipNewCfgBootpState, ripNewCfgListen=ripNewCfgListen, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipForward=ipForward, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumRxTxStats=ospfCumRxTxStats, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumIntfBackup=ospfCumIntfBackup, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ripStatOutPkts=ripStatOutPkts, routerLSALinkIndex=routerLSALinkIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, routerLSAAreaIndex=routerLSAAreaIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaRxPkts=ospfAreaRxPkts, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ip_info=ip_info, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgIntfMask=ipCurCfgIntfMask, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipCurCfgGwEntry=ipCurCfgGwEntry, dnsStats=dnsStats, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry)
