...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfUnloop=ospfIntfUnloop, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfArea=ospfArea, ripCurCfgVip=ripCurCfgVip, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ripNewCfgDefListen=ripNewCfgDefListen, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgGenState=vrrpNewCfgGenState, ipForward=ipForward, ospfCumIntfChangeStats=ospfCumIntfChangeStats, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumTxlsReqs=ospfCumTxlsReqs, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfHello=ospfIntfHello, ipRouteInfoType=ipRouteInfoType, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpStatOutAdvers=vrrpStatOutAdvers, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpGeneral=vrrpGeneral, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfInfoTable=ospfIntfInfoTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, arpInfoEntry=arpInfoEntry, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaNbrStart=ospfAreaNbrStart, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumNbrhello=ospfCumNbrhello, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfRxHello=ospfIntfRxHello, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfTotalAreas=ospfTotalAreas, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgGwState=ipNewCfgGwState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, ripStatInPkts=ripStatInPkts, arpInfoSrcPort=arpInfoSrcPort, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfStartTime=ospfStartTime, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumRxPkts=ospfCumRxPkts, ipRouteInfoTag=ipRouteInfoTag, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, routeStatMaxEntries=routeStatMaxEntries, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfLsTypesSupported=ospfLsTypesSupported, ipRouteInfoDestIp=ipRouteInfoDestIp, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfTxHello=ospfIntfTxHello, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ripStatOutPkts=ripStatOutPkts, ospfAreaRxHello=ospfAreaRxHello, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfGeneral=ospfGeneral, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ripCurCfgState=ripCurCfgState, ospfIntfIndex=ospfIntfIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, arpStatMaxEntries=arpStatMaxEntries, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfWaitTimer=ospfIntfWaitTimer, ripNewCfgVip=ripNewCfgVip, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ripCurCfgSupply=ripCurCfgSupply, routeStatHighWater=routeStatHighWater, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgGwIndex=ipCurCfgGwIndex, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumRxHello=ospfCumRxHello, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaIntfUnloop=ospfAreaIntfUnloop, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrp_info=vrrp_info, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, routerLSAId=routerLSAId, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpOper=vrrpOper, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaRxPkts=ospfAreaRxPkts, ripNewCfgListen=ripNewCfgListen, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, routerLSALinkID=routerLSALinkID, ospfStats=ospfStats, ospfProcessUptime=ospfProcessUptime, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumTxHello=ospfCumTxHello, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaNbrDown=ospfAreaNbrDown, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ripNewCfgSupply=ripNewCfgSupply, ripNewCfgState=ripNewCfgState, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpStats=vrrpStats, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, arpStats=arpStats, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumTxPkts=ospfCumTxPkts)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", dnsStats=dnsStats, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumRxTxStats=ospfCumRxTxStats, ripCurCfgDefListen=ripCurCfgDefListen, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, routerLSALinkData=routerLSALinkData, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, routeStats=routeStats, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, arpInfoFlag=arpInfoFlag, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgGwRetry=ipNewCfgGwRetry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfinfo=ospfinfo, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfGeneralStats=ospfGeneralStats, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, arpInfoRefPorts=arpInfoRefPorts, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumIntfHello=ospfCumIntfHello, ipRouteInfoGateway=ipRouteInfoGateway, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumNbrBadRequests=ospfCumNbrBadRequests, arpStatEntries=arpStatEntries, ipRouteInfoMask=ipRouteInfoMask, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaInfoId=ospfAreaInfoId, ospfCumIntfBackup=ospfCumIntfBackup, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgGwTable=ipNewCfgGwTable, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ip_info=ip_info, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfNbrhello=ospfIntfNbrhello, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfInterface=ospfInterface, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipGatewayTableMax=ipGatewayTableMax, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfRxPkts=ospfIntfRxPkts, arpStatHighWater=arpStatHighWater, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgIntfAddr=ipCurCfgIntfAddr, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, routeStatEntries=routeStatEntries, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, iprouting=iprouting, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ripStats=ripStats, ipCurCfgGwInterval=ipCurCfgGwInterval, routerLSALinkIndex=routerLSALinkIndex, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaIntfIndex=ospfAreaIntfIndex, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumNbrStart=ospfCumNbrStart, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCfg=ospfCfg, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfNbrStart=ospfIntfNbrStart, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrp=vrrp, ipCurCfgGwVlan=ipCurCfgGwVlan, ripConfig=ripConfig, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgIntfVlan=ipCurCfgIntfVlan, arpInfoDestIp=arpInfoDestIp, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex)
