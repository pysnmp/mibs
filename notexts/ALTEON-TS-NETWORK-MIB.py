...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", dnsStats=dnsStats, arpStatEntries=arpStatEntries, ripNewCfgDefListen=ripNewCfgDefListen, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfHello=ospfIntfHello, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, routerLSAAreaIndex=routerLSAAreaIndex, vrrp=vrrp, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgIfTable=vrrpCurCfgIfTable, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpStatInAdvers=vrrpStatInAdvers, ipRouteInfoType=ipRouteInfoType, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumNbrN1way=ospfCumNbrN1way, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfTotalTransitAreas=ospfTotalTransitAreas, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfBackup=ospfIntfBackup, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipNewCfgIntfDelete=ipNewCfgIntfDelete, routerLSALinkData=routerLSALinkData, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumIntfDown=ospfCumIntfDown, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfProcessUptime=ospfProcessUptime, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgGwTable=ipCurCfgGwTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaRxPkts=ospfAreaRxPkts, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaInfoTable=ospfAreaInfoTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumTxHello=ospfCumTxHello, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCumRxHello=ospfCumRxHello, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, routeStatEntries=routeStatEntries, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaIntfDown=ospfAreaIntfDown, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpOper=vrrpOper, ospfAreaTxPkts=ospfAreaTxPkts, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgGwArp=ipCurCfgGwArp, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumRxPkts=ospfCumRxPkts, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, routeStatHighWater=routeStatHighWater, ipCurCfgGwState=ipCurCfgGwState, ospfStats=ospfStats, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfRxPkts=ospfIntfRxPkts, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfinfo=ospfinfo, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, ripNewCfgState=ripNewCfgState, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumNbrhello=ospfCumNbrhello, routerLSALinkID=routerLSALinkID, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfNbrInFullState=ospfNbrInFullState, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, arpInfoTable=arpInfoTable, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipGatewayTableMax=ipGatewayTableMax, ripCurCfgDefListen=ripCurCfgDefListen, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfNbrStart=ospfIntfNbrStart, ospfTimersKickOffStats=ospfTimersKickOffStats, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfArea=ospfArea, ospfGeneral=ospfGeneral, ospfIntfLoop=ospfIntfLoop, ospfTotalAreas=ospfTotalAreas, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfRxHello=ospfIntfRxHello, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ripNewCfgSupply=ripNewCfgSupply, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgBootpState=ipCurCfgBootpState, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaRxHello=ospfAreaRxHello, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripCurCfgState=ripCurCfgState, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipRouteInfoTable=ipRouteInfoTable, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIfWaitInterval=ospfIfWaitInterval, vrrpStats=vrrpStats, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumNbrDown=ospfCumNbrDown, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, arpInfoFlag=arpInfoFlag, ipNewCfgIntfIndex=ipNewCfgIntfIndex, arpStatHighWater=arpStatHighWater, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ripCurCfgListen=ripCurCfgListen, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, iprouting=iprouting, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumIntfHello=ospfCumIntfHello, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgGwArp=ipNewCfgGwArp, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCumTxDatabase=ospfCumTxDatabase, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfNbrInExchState=ospfNbrInExchState, routeStatMaxEntries=routeStatMaxEntries, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipRouteInfoMask=ipRouteInfoMask, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipRouteInfoGateway=ipRouteInfoGateway)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpInfoMacAddr=arpInfoMacAddr, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrp_info=vrrp_info, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgGwRetry=ipNewCfgGwRetry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaIntfBackup=ospfAreaIntfBackup, arpInfoEntry=arpInfoEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfTxHello=ospfIntfTxHello, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCfg=ospfCfg, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, arpInfoVLAN=arpInfoVLAN, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ip_info=ip_info, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfInfoEntry=ospfIntfInfoEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfUnloop=ospfIntfUnloop, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, routerLSAId=routerLSAId, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumNbrStart=ospfCumNbrStart, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, arpInfoDestIp=arpInfoDestIp, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaNbrDown=ospfAreaNbrDown, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaChangeStats=ospfAreaChangeStats, ipForward=ipForward, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripStatInPkts=ripStatInPkts, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpStatOutAdvers=vrrpStatOutAdvers, arpStats=arpStats, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipInterfaceTableMax=ipInterfaceTableMax, ripStatOutPkts=ripStatOutPkts, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfNbrInInitState=ospfNbrInInitState, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaIntfHello=ospfAreaIntfHello, ripNewCfgListen=ripNewCfgListen, ripNewCfgVip=ripNewCfgVip, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpGeneral=vrrpGeneral, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipFwdNewCfgState=ipFwdNewCfgState, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ripConfig=ripConfig, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ripStats=ripStats, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaRxDatabase=ospfAreaRxDatabase, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, routeStats=routeStats, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfNbrhello=ospfIntfNbrhello, ripCurCfgVip=ripCurCfgVip, ospfIntfChangeStats=ospfIntfChangeStats, ospfGeneralStats=ospfGeneralStats, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIfInfoIndex=ospfIfInfoIndex, ospfIntfDown=ospfIntfDown, ospfIntfNbrChange=ospfIntfNbrChange, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaInfoId=ospfAreaInfoId, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfInterface=ospfInterface, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaTableMaxSize=ospfAreaTableMaxSize)
