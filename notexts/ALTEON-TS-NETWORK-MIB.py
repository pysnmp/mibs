...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfArea=ospfArea, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, routerLSAId=routerLSAId, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumTxlsUpdates=ospfCumTxlsUpdates, arpInfoFlag=arpInfoFlag, ripNewCfgSupply=ripNewCfgSupply, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumTxlsAcks=ospfCumTxlsAcks, ripStatOutPkts=ripStatOutPkts, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, routerLSALinkData=routerLSALinkData, ipFwdCurCfgPortState=ipFwdCurCfgPortState, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ripStats=ripStats, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ripCurCfgDefListen=ripCurCfgDefListen, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrp_info=vrrp_info, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfHello=ospfIntfHello, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripCurCfgListen=ripCurCfgListen, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipRouteInfoTable=ipRouteInfoTable, ospfIntfIndex=ospfIntfIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipRouteInfoType=ipRouteInfoType, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumRxHello=ospfCumRxHello, arpInfoSrcPort=arpInfoSrcPort, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripNewCfgVip=ripNewCfgVip, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfTotalAreas=ospfTotalAreas, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumNbrStart=ospfCumNbrStart, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfTxHello=ospfIntfTxHello, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgGwState=ipNewCfgGwState, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumNbrChangeStats=ospfCumNbrChangeStats, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, routeStatEntries=routeStatEntries, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, arpStatEntries=arpStatEntries, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaInfoTable=ospfAreaInfoTable, vrrp=vrrp, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIfWaitInterval=ospfIfWaitInterval, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaNbrN1way=ospfAreaNbrN1way, iprouting=iprouting, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfWaitTimer=ospfIntfWaitTimer, ipGatewayTableMax=ipGatewayTableMax, ripCurCfgState=ripCurCfgState, ospfAreaRxTxStats=ospfAreaRxTxStats, dnsStats=dnsStats, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfInfoTable=ospfIntfInfoTable, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfStats=ospfStats, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipRouteInfoTag=ipRouteInfoTag, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgBootpState=ipCurCfgBootpState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfProcessUptime=ospfProcessUptime, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfDown=ospfIntfDown, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ripNewCfgState=ripNewCfgState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgGwRetry=ipNewCfgGwRetry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgGwArp=ipNewCfgGwArp, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipRouteInfoIndx=ipRouteInfoIndx, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaTxHello=ospfAreaTxHello, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfNbrhello=ospfIntfNbrhello, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ripCurCfgSupply=ripCurCfgSupply, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfNbrStart=ospfIntfNbrStart, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgGwArp=ipCurCfgGwArp, ripConfig=ripConfig, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgGwInterval=ipCurCfgGwInterval)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfUnloop=ospfIntfUnloop, ospfCumRxDatabase=ospfCumRxDatabase, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, arpInfoEntry=arpInfoEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdNewCfgState=ipFwdNewCfgState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ripStatInPkts=ripStatInPkts, ipForward=ipForward, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaChangeStats=ospfAreaChangeStats, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfNbrInExchState=ospfNbrInExchState, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCfg=ospfCfg, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, routeStats=routeStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumTxHello=ospfCumTxHello, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, ip_info=ip_info, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgIntfState=ipCurCfgIntfState, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgGwTable=ipNewCfgGwTable, arpInfoTable=arpInfoTable, arpStats=arpStats, ipNewCfgIntfTable=ipNewCfgIntfTable, ripCurCfgVip=ripCurCfgVip, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumTxPkts=ospfCumTxPkts, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumIntfBackup=ospfCumIntfBackup, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, arpStatHighWater=arpStatHighWater, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaRxHello=ospfAreaRxHello, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumIntfDown=ospfCumIntfDown, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfGeneralInfo=ospfGeneralInfo, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumTxlsReqs=ospfCumTxlsReqs, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpOper=vrrpOper, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfGeneral=ospfGeneral, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfInterface=ospfInterface, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfinfo=ospfinfo, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfGeneralStats=ospfGeneralStats, ospfCumIntfHello=ospfCumIntfHello, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, routerLSALinkIndex=routerLSALinkIndex, ospfTimersKickOffStats=ospfTimersKickOffStats, ipInterfaceTableMax=ipInterfaceTableMax, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaIntfHello=ospfAreaIntfHello, arpInfoVLAN=arpInfoVLAN, arpInfoDestIp=arpInfoDestIp, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipCurCfgGwState=ipCurCfgGwState, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, arpStatMaxEntries=arpStatMaxEntries, ipRouteInfoMask=ipRouteInfoMask, ospfCumIntfLoop=ospfCumIntfLoop, ripNewCfgListen=ripNewCfgListen, vrrpGeneral=vrrpGeneral, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfNbrInInitState=ospfNbrInInitState, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpStats=vrrpStats, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaNbrDown=ospfAreaNbrDown, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfTotalNeighbours=ospfTotalNeighbours, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaRxPkts=ospfAreaRxPkts, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex)
