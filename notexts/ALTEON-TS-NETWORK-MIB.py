...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfTotalAreas=ospfTotalAreas, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfInterface=ospfInterface, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfNbrInFullState=ospfNbrInFullState, ospfAreaInfoId=ospfAreaInfoId, ipRouteInfoType=ipRouteInfoType, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgGwTable=ipCurCfgGwTable, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumNbrStart=ospfCumNbrStart, ospfArea=ospfArea, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfNbrInExchState=ospfNbrInExchState, arpInfoTable=arpInfoTable, ospfCumRxHello=ospfCumRxHello, arpInfoFlag=arpInfoFlag, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCfg=ospfCfg, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfUnloop=ospfIntfUnloop, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumRxDatabase=ospfCumRxDatabase, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ripCurCfgListen=ripCurCfgListen, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, routerLSALinkData=routerLSALinkData, ospfGeneral=ospfGeneral, ospfAreaRxDatabase=ospfAreaRxDatabase, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfRxTxStats=ospfIntfRxTxStats, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaRxPkts=ospfAreaRxPkts, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaIntfDown=ospfAreaIntfDown, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpStats=vrrpStats, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfRxHello=ospfIntfRxHello, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrp_info=vrrp_info, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfNbrDown=ospfIntfNbrDown, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgIntfAddr=ipNewCfgIntfAddr, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumRxTxStats=ospfCumRxTxStats, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgGwAddr=ipNewCfgGwAddr, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrp=vrrp, ospfTotalNeighbours=ospfTotalNeighbours, routeStatHighWater=routeStatHighWater, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfRxPkts=ospfIntfRxPkts, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumTxHello=ospfCumTxHello, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, routerLSAId=routerLSAId, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, arpInfoVLAN=arpInfoVLAN, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpOper=vrrpOper, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumRxPkts=ospfCumRxPkts, ospfIntfBackup=ospfIntfBackup, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ripCurCfgSupply=ripCurCfgSupply, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipRouteInfoTable=ipRouteInfoTable, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgGwVlan=ipCurCfgGwVlan, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ripCurCfgState=ripCurCfgState, ospfCumIntfDown=ospfCumIntfDown, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumNbrDown=ospfCumNbrDown, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfStats=ospfStats, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfNewCfgAreaTable=ospfNewCfgAreaTable, arpInfoSrcPort=arpInfoSrcPort, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfNbrStart=ospfIntfNbrStart, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumTxPkts=ospfCumTxPkts, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, dnsStats=dnsStats, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfTxHello=ospfIntfTxHello, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipFwdCurCfgPortState=ipFwdCurCfgPortState)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpGeneral=vrrpGeneral, ospfCumNbrhello=ospfCumNbrhello, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgGwInterval=ipCurCfgGwInterval, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaRxTxStats=ospfAreaRxTxStats, ipInterfaceTableMax=ipInterfaceTableMax, arpInfoEntry=arpInfoEntry, ripNewCfgVip=ripNewCfgVip, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfIndex=ospfIntfIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, routerLSALinkIndex=routerLSALinkIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgGwMetric=ipCurCfgGwMetric, ipRouteInfoDestIp=ipRouteInfoDestIp, ripNewCfgState=ripNewCfgState, ospfIntfTxDatabase=ospfIntfTxDatabase, ipCurCfgIntfVlan=ipCurCfgIntfVlan, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfLsTypesSupported=ospfLsTypesSupported, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipNewCfgGwArp=ipNewCfgGwArp, ipForward=ipForward, ripConfig=ripConfig, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, arpInfoRefPorts=arpInfoRefPorts, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipNewCfgGwIndex=ipNewCfgGwIndex, ripStatOutPkts=ripStatOutPkts, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgIntfMask=ipNewCfgIntfMask, ripStats=ripStats, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ripStatInPkts=ripStatInPkts, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfHello=ospfIntfHello, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgBootpState=ipNewCfgBootpState, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaIntfHello=ospfAreaIntfHello, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, routeStats=routeStats, ospfStartTime=ospfStartTime, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ip_info=ip_info, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipGatewayTableMax=ipGatewayTableMax, ospfCumNbrRstAd=ospfCumNbrRstAd, ipRouteInfoTag=ipRouteInfoTag, ospfCumTxDatabase=ospfCumTxDatabase, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipFwdNewCfgState=ipFwdNewCfgState, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfGeneralStats=ospfGeneralStats, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, routerLSALinkID=routerLSALinkID, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfRxlsReqs=ospfIntfRxlsReqs, iprouting=iprouting, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfNbrInInitState=ospfNbrInInitState, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgIntfTable=ipNewCfgIntfTable, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, arpStatEntries=arpStatEntries, ospfAreaInfoEntry=ospfAreaInfoEntry, ipRouteInfoGateway=ipRouteInfoGateway, ospfGeneralInfo=ospfGeneralInfo, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaNbrhello=ospfAreaNbrhello, arpStats=arpStats, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfHostTableMaxSize=ospfHostTableMaxSize, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgGwState=ipCurCfgGwState, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv)
