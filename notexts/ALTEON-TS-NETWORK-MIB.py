...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfProcessUptime=ospfProcessUptime, ipRouteInfoType=ipRouteInfoType, ospfCumRxlsReqs=ospfCumRxlsReqs, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpOper=vrrpOper, ipNewCfgBootpState=ipNewCfgBootpState, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfRxPkts=ospfIntfRxPkts, routeStatHighWater=routeStatHighWater, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ripNewCfgListen=ripNewCfgListen, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ripNewCfgSupply=ripNewCfgSupply, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ripStatInPkts=ripStatInPkts, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ripStatInErrorPkts=ripStatInErrorPkts, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumRxHello=ospfCumRxHello, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfStartTime=ospfStartTime, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfNbrN1way=ospfIntfNbrN1way, ipGatewayTableMax=ipGatewayTableMax, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgGwState=ipCurCfgGwState, ospfIntfLoop=ospfIntfLoop, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfArea=ospfArea, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ripConfig=ripConfig, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfChangeStats=ospfIntfChangeStats, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripCurCfgDefListen=ripCurCfgDefListen, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfBackup=ospfIntfBackup, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgIntfVlan=ipCurCfgIntfVlan, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfGeneralInfo=ospfGeneralInfo, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ripNewCfgState=ripNewCfgState, ospfAreaInfoTable=ospfAreaInfoTable, ipRouteInfoMask=ipRouteInfoMask, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumIntfHello=ospfCumIntfHello, ipCurCfgGwMetric=ipCurCfgGwMetric, ipRouteInfoTag=ipRouteInfoTag, ospfInterface=ospfInterface, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumNbrhello=ospfCumNbrhello, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipInterfaceTableMax=ipInterfaceTableMax, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfinfo=ospfinfo, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipRouteInfoTable=ipRouteInfoTable, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIfInfoIndex=ospfIfInfoIndex, ospfIntfUnloop=ospfIntfUnloop, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, arpStats=arpStats, routerLSALinkID=routerLSALinkID, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, arpInfoTable=arpInfoTable, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, arpInfoMacAddr=arpInfoMacAddr, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, arpInfoRefPorts=arpInfoRefPorts, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripNewCfgVip=ripNewCfgVip, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipRouteInfoGateway=ipRouteInfoGateway, ripCurCfgState=ripCurCfgState, vrrp=vrrp, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfTxPkts=ospfIntfTxPkts, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, arpInfoVLAN=arpInfoVLAN, arpStatHighWater=arpStatHighWater, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, routerLSALinkData=routerLSALinkData, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpGeneral=vrrpGeneral, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, routerLSAId=routerLSAId, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, dnsStats=dnsStats, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ip_info=ip_info, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpStats=vrrpStats, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumRxTxStats=ospfCumRxTxStats, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgGwTable=ipNewCfgGwTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfHello=ospfIntfHello, ipNewCfgGwInterval=ipNewCfgGwInterval, routeStatMaxEntries=routeStatMaxEntries, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfNbrStart=ospfIntfNbrStart, routeStatEntries=routeStatEntries, ipForward=ipForward, ospfCumRxlsAcks=ospfCumRxlsAcks, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpStatInAdvers=vrrpStatInAdvers, ospfNbrInExchState=ospfNbrInExchState, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfNbrDown=ospfIntfNbrDown, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaInfoId=ospfAreaInfoId, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumRxPkts=ospfCumRxPkts, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumTxDatabase=ospfCumTxDatabase, ripStats=ripStats, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ripCurCfgSupply=ripCurCfgSupply, ospfIntfWaitTimer=ospfIntfWaitTimer, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumTxPkts=ospfCumTxPkts, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCfg=ospfCfg, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaRxTxIndex=ospfAreaRxTxIndex, routeStats=routeStats, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfStats=ospfStats, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaNbrDown=ospfAreaNbrDown, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipRouteInfoInterface=ipRouteInfoInterface, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgIntfAddr=ipCurCfgIntfAddr, arpStatEntries=arpStatEntries, routerLSALinkIndex=routerLSALinkIndex, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfTotalAreas=ospfTotalAreas, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfGeneral=ospfGeneral, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrp_info=vrrp_info, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumRxDatabase=ospfCumRxDatabase, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgIntfIndex=ipNewCfgIntfIndex, arpInfoEntry=arpInfoEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripCurCfgListen=ripCurCfgListen, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfIndex=ospfIntfIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, iprouting=iprouting, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCumTxHello=ospfCumTxHello, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgIntfMask=ipCurCfgIntfMask, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfDown=ospfIntfDown, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, arpInfoFlag=arpInfoFlag, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgGwMetric=ipNewCfgGwMetric)
