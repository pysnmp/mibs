...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaInfoId=ospfAreaInfoId, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfNbrDown=ospfIntfNbrDown, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, routeStats=routeStats, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIfInfoIndex=ospfIfInfoIndex, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, arpStatHighWater=arpStatHighWater, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ripCurCfgListen=ripCurCfgListen, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumIntfLoop=ospfCumIntfLoop, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgGwArp=ipNewCfgGwArp, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgGwState=ipCurCfgGwState, ospfNbrInFullState=ospfNbrInFullState, ospfIntfIndex=ospfIntfIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ripStatInErrorPkts=ripStatInErrorPkts, ospfTotalNssaAreas=ospfTotalNssaAreas, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ripCurCfgSupply=ripCurCfgSupply, ospfIntfTxHello=ospfIntfTxHello, ripCurCfgVip=ripCurCfgVip, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgIntfEntry=ipNewCfgIntfEntry, arpInfoFlag=arpInfoFlag, ipForward=ipForward, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, iprouting=iprouting, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumNbrN1way=ospfCumNbrN1way, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ripConfig=ripConfig, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipRouteInfoGateway=ipRouteInfoGateway, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfNbrChange=ospfIntfNbrChange, vrrp=vrrp, arpInfoEntry=arpInfoEntry, arpInfoSrcPort=arpInfoSrcPort, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripNewCfgListen=ripNewCfgListen, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfStats=ospfStats, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpIfTableMaxSize=vrrpIfTableMaxSize, arpInfoVLAN=arpInfoVLAN, routeStatEntries=routeStatEntries, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfDown=ospfIntfDown, arpInfoRefPorts=arpInfoRefPorts, ospfCumNbrStart=ospfCumNbrStart, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumIntfBackup=ospfCumIntfBackup, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumTxHello=ospfCumTxHello, ripCurCfgState=ripCurCfgState, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumTxDatabase=ospfCumTxDatabase, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumIntfUnloop=ospfCumIntfUnloop, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumIntfDown=ospfCumIntfDown, ipRouteInfoEntry=ipRouteInfoEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpGeneral=vrrpGeneral, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, routeStatHighWater=routeStatHighWater, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfBackup=ospfIntfBackup, ospfIntfNbrIndex=ospfIntfNbrIndex, routerLSALinkIndex=routerLSALinkIndex, ospfCumRxPkts=ospfCumRxPkts, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipRouteInfoType=ipRouteInfoType, arpInfoTable=arpInfoTable, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfNbrInExchState=ospfNbrInExchState, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgGwState=ipNewCfgGwState, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumRxHello=ospfCumRxHello, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgIntfMask=ipNewCfgIntfMask)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCfg=ospfCfg, ipGatewayTableMax=ipGatewayTableMax, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfinfo=ospfinfo, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaRxDatabase=ospfAreaRxDatabase, arpInfoDestIp=arpInfoDestIp, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumIntfHello=ospfCumIntfHello, ripStats=ripStats, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgGwTable=ipCurCfgGwTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaRxHello=ospfAreaRxHello, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfRxDatabase=ospfIntfRxDatabase, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripNewCfgVip=ripNewCfgVip, ospfLsTypesSupported=ospfLsTypesSupported, routerLSALinkID=routerLSALinkID, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgIntfState=ipNewCfgIntfState, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfLoop=ospfIntfLoop, arpStatEntries=arpStatEntries, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumTxPkts=ospfCumTxPkts, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, routerLSALinkData=routerLSALinkData, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfArea=ospfArea, ospfCumRxDatabase=ospfCumRxDatabase, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfProcessUptime=ospfProcessUptime, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfGeneralStats=ospfGeneralStats, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgGwVlan=ipCurCfgGwVlan, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfStartTime=ospfStartTime, ospfIntfUnloop=ospfIntfUnloop, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpOper=vrrpOper, ospfAreaInfoTable=ospfAreaInfoTable, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfHello=ospfIntfHello, routeStatMaxEntries=routeStatMaxEntries, ipCurCfgGwInterval=ipCurCfgGwInterval, ripNewCfgSupply=ripNewCfgSupply, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaNbrStart=ospfAreaNbrStart, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipRouteInfoTag=ipRouteInfoTag, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, dnsStats=dnsStats, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgIntfMask=ipCurCfgIntfMask, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgGwAddr=ipNewCfgGwAddr, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfGeneralInfo=ospfGeneralInfo, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, routerLSAId=routerLSAId, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfGeneral=ospfGeneral, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfTotalNeighbours=ospfTotalNeighbours, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, arpStats=arpStats, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgBootpState=ipCurCfgBootpState, ip_info=ip_info)
