...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrp_info=vrrp_info, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfTxHello=ospfIntfTxHello, ripNewCfgDefListen=ripNewCfgDefListen, ospfInterface=ospfInterface, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, arpInfoRefPorts=arpInfoRefPorts, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipRouteInfoType=ipRouteInfoType, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, arpStatHighWater=arpStatHighWater, ospfIntfRxHello=ospfIntfRxHello, ipCurCfgGwArp=ipCurCfgGwArp, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripNewCfgVip=ripNewCfgVip, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ripCurCfgListen=ripCurCfgListen, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaInfoId=ospfAreaInfoId, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgGwState=ipNewCfgGwState, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, dnsStats=dnsStats, ripCurCfgDefListen=ripCurCfgDefListen, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCumNbrStart=ospfCumNbrStart, ripCurCfgVip=ripCurCfgVip, ospfIntfUnloop=ospfIntfUnloop, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfNbrhello=ospfIntfNbrhello, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCfg=ospfCfg, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumNbrhello=ospfCumNbrhello, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumTxHello=ospfCumTxHello, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaTxHello=ospfAreaTxHello, ripConfig=ripConfig, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfInfoTable=ospfIntfInfoTable, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgGenState=vrrpNewCfgGenState, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIfWaitInterval=ospfIfWaitInterval, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumRxTxStats=ospfCumRxTxStats, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumIntfHello=ospfCumIntfHello, arpStats=arpStats, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, arpInfoFlag=arpInfoFlag, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgIntfState=ipCurCfgIntfState, ipRouteInfoMask=ipRouteInfoMask, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgGwDelete=ipNewCfgGwDelete, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgIntfTable=ipNewCfgIntfTable, arpInfoEntry=arpInfoEntry, ospfCumIntfBackup=ospfCumIntfBackup, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgIntfMask=ipCurCfgIntfMask, ripStatInPkts=ripStatInPkts, vrrpStatInAdvers=vrrpStatInAdvers, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfinfo=ospfinfo, routeStatHighWater=routeStatHighWater, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, routerLSAAreaIndex=routerLSAAreaIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfGeneral=ospfGeneral, ripNewCfgState=ripNewCfgState, ospfArea=ospfArea, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaIntfHello=ospfAreaIntfHello, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgGwState=ipCurCfgGwState, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipRouteInfoEntry=ipRouteInfoEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgBootpAddr=ipCurCfgBootpAddr, iprouting=iprouting, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, routeStatEntries=routeStatEntries, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfNbrInExchState=ospfNbrInExchState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumRxHello=ospfCumRxHello, ospfCumRxDatabase=ospfCumRxDatabase, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipRouteInfoTable=ipRouteInfoTable, ospfIntfIndex=ospfIntfIndex, ripStatOutPkts=ripStatOutPkts, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, routerLSALinkData=routerLSALinkData, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfDown=ospfIntfDown, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, arpInfoTable=arpInfoTable, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgIntfState=ipNewCfgIntfState, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfProcessUptime=ospfProcessUptime, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, routeStats=routeStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, routerLSAId=routerLSAId, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfStats=ospfStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipRouteInfoGateway=ipRouteInfoGateway, ospfStartTime=ospfStartTime, arpInfoSrcPort=arpInfoSrcPort, ospfAreaNbrIndex=ospfAreaNbrIndex, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIfInfoIndex=ospfIfInfoIndex, ipForward=ipForward, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaIntfIndex=ospfAreaIntfIndex, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfLoop=ospfIntfLoop, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfTotalAreas=ospfTotalAreas, ipRouteInfoIndx=ipRouteInfoIndx, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaRxHello=ospfAreaRxHello, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumNbrRstAd=ospfCumNbrRstAd, ripCurCfgState=ripCurCfgState, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfBackup=ospfIntfBackup, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumRxlsReqs=ospfCumRxlsReqs, ripNewCfgSupply=ripNewCfgSupply, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpGeneral=vrrpGeneral, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaTxPkts=ospfAreaTxPkts, arpStatMaxEntries=arpStatMaxEntries, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpStats=vrrpStats, routerLSALinkIndex=routerLSALinkIndex, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrp=vrrp, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ripCurCfgSupply=ripCurCfgSupply, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfHello=ospfIntfHello, ripStats=ripStats, ip_info=ip_info, arpStatEntries=arpStatEntries, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort)
