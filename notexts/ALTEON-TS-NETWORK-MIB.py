...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumIntfHello=ospfCumIntfHello, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfNbrStart=ospfIntfNbrStart, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpStats=vrrpStats, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ripStats=ripStats, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfChangeStats=ospfIntfChangeStats, ipRouteInfoDestIp=ipRouteInfoDestIp, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, arpStatMaxEntries=arpStatMaxEntries, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgGwDelete=ipNewCfgGwDelete, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ripNewCfgListen=ripNewCfgListen, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfGeneral=ospfGeneral, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipNewCfgGwArp=ipNewCfgGwArp, ospfTotalTransitAreas=ospfTotalTransitAreas, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ripCurCfgState=ripCurCfgState, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipRouteInfoMask=ipRouteInfoMask, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfInterface=ospfInterface, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfBackup=ospfIntfBackup, routerLSALinkData=routerLSALinkData, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpOper=vrrpOper, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfinfo=ospfinfo, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCurCfgAreaId=ospfCurCfgAreaId, arpInfoFlag=arpInfoFlag, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgBootpState=ipCurCfgBootpState, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgGwAddr=ipNewCfgGwAddr, ripCurCfgListen=ripCurCfgListen, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ripStatInPkts=ripStatInPkts, routerLSALinkID=routerLSALinkID, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaInfoId=ospfAreaInfoId, ripConfig=ripConfig, routeStats=routeStats, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumNbrStart=ospfCumNbrStart, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumIntfDown=ospfCumIntfDown, ospfCumTxPkts=ospfCumTxPkts, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfGeneralStats=ospfGeneralStats, ripStatInErrorPkts=ripStatInErrorPkts, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgIfTable=vrrpNewCfgIfTable, routerLSALinkIndex=routerLSALinkIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ripNewCfgVip=ripNewCfgVip, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCfg=ospfCfg, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfNbrChange=ospfIntfNbrChange, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, dnsStats=dnsStats, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfDown=ospfIntfDown, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgIntfIndex=ipCurCfgIntfIndex, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdCurCfgState=ipFwdCurCfgState, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfStartTime=ospfStartTime, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ripNewCfgSupply=ripNewCfgSupply, ospfIntfCountForRouter=ospfIntfCountForRouter, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIfInfoIndex=ospfIfInfoIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ip_info=ip_info, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfTxPkts=ospfIntfTxPkts, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumRxlsReqs=ospfCumRxlsReqs, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgIntfTable=ipCurCfgIntfTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumRxTxStats=ospfCumRxTxStats, ospfVlinkCountForRouter=ospfVlinkCountForRouter, arpInfoSrcPort=arpInfoSrcPort, routeStatMaxEntries=routeStatMaxEntries, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaRxTxStats=ospfAreaRxTxStats, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, arpInfoEntry=arpInfoEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumTxlsUpdates=ospfCumTxlsUpdates, routerLSAId=routerLSAId, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, iprouting=iprouting, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfLoop=ospfIntfLoop, routeStatEntries=routeStatEntries, vrrpGeneral=vrrpGeneral, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfNbrDown=ospfIntfNbrDown, ospfTotalAreas=ospfTotalAreas, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfArea=ospfArea, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfHello=ospfIntfHello, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipGatewayTableMax=ipGatewayTableMax, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ripNewCfgState=ripNewCfgState, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaRxHello=ospfAreaRxHello, arpInfoRefPorts=arpInfoRefPorts, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, arpStatEntries=arpStatEntries, ospfAreaNbrDown=ospfAreaNbrDown, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipRouteInfoTag=ipRouteInfoTag, ospfAreaIntfIndex=ospfAreaIntfIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfRxHello=ospfIntfRxHello, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, arpInfoTable=arpInfoTable, ospfGeneralInfo=ospfGeneralInfo, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, arpInfoVLAN=arpInfoVLAN, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgGwArp=ipCurCfgGwArp, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgIntfState=ipNewCfgIntfState, ipForward=ipForward, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfStats=ospfStats, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumNbrhello=ospfCumNbrhello, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrp_info=vrrp_info, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipRouteInfoType=ipRouteInfoType, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgGwState=ipNewCfgGwState, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrp=vrrp, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaTxHello=ospfAreaTxHello, vrrpStatInAdvers=vrrpStatInAdvers, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIfWaitInterval=ospfIfWaitInterval, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, arpInfoDestIp=arpInfoDestIp, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, arpStats=arpStats, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumTxHello=ospfCumTxHello)
