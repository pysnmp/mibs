...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfTxPkts=ospfIntfTxPkts, vrrp_info=vrrp_info, ripCurCfgListen=ripCurCfgListen, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfStats=ospfStats, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ripNewCfgSupply=ripNewCfgSupply, ospfGeneral=ospfGeneral, ospfCumRxHello=ospfCumRxHello, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaRxPkts=ospfAreaRxPkts, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfIndex=ospfIntfIndex, ripCurCfgState=ripCurCfgState, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaInfoId=ospfAreaInfoId, routerLSALinkID=routerLSALinkID, ospfAreaIntfHello=ospfAreaIntfHello, vrrp=vrrp, ospfCumIntfDown=ospfCumIntfDown, ospfCumNbrhello=ospfCumNbrhello, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumRxPkts=ospfCumRxPkts, ospfIntfHello=ospfIntfHello, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgIntfState=ipNewCfgIntfState, ipForward=ipForward, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgGwState=ipCurCfgGwState, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpOper=vrrpOper, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgIntfState=ipCurCfgIntfState, ospfCfg=ospfCfg, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgGwArp=ipNewCfgGwArp, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipGatewayTableMax=ipGatewayTableMax, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipRouteInfoTable=ipRouteInfoTable, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfNbrStart=ospfIntfNbrStart, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, arpStats=arpStats, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfArea=ospfArea, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, routerLSALinkIndex=routerLSALinkIndex, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, routerLSALinkData=routerLSALinkData, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfNbrInExchState=ospfNbrInExchState, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaIntfUnloop=ospfAreaIntfUnloop, arpInfoSrcPort=arpInfoSrcPort, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumRxTxStats=ospfCumRxTxStats, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipRouteInfoTag=ipRouteInfoTag, ipInterfaceTableMax=ipInterfaceTableMax, routeStats=routeStats, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCumNbrStart=ospfCumNbrStart, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipRouteInfoIndx=ipRouteInfoIndx, ripCurCfgSupply=ripCurCfgSupply, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgIntfTable=ipNewCfgIntfTable, arpInfoTable=arpInfoTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaRxHello=ospfAreaRxHello, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumIntfHello=ospfCumIntfHello, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, arpInfoVLAN=arpInfoVLAN, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgGwRetry=ipNewCfgGwRetry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfTxHello=ospfIntfTxHello, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, routeStatEntries=routeStatEntries, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipCurCfgGwTable=ipCurCfgGwTable, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaTxHello=ospfAreaTxHello, ospfIntfBackup=ospfIntfBackup, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfNbrInInitState=ospfNbrInInitState, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipRouteInfoDestIp=ipRouteInfoDestIp, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfRxPkts=ospfIntfRxPkts, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, iprouting=iprouting, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, routeStatHighWater=routeStatHighWater, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumIntfNbrChange=ospfCumIntfNbrChange, ripStatInPkts=ripStatInPkts, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumRxDatabase=ospfCumRxDatabase, ripStatOutPkts=ripStatOutPkts, ospfStartTime=ospfStartTime, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumNbrDown=ospfCumNbrDown, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgGwAddr=ipCurCfgGwAddr, arpStatHighWater=arpStatHighWater, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaTxPkts=ospfAreaTxPkts, ipRouteInfoGateway=ipRouteInfoGateway, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaNbrhello=ospfAreaNbrhello, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfNbrN1way=ospfIntfNbrN1way, ripCurCfgDefListen=ripCurCfgDefListen, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfInterface=ospfInterface, ripNewCfgVip=ripNewCfgVip, ipNewCfgGwState=ipNewCfgGwState, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ripNewCfgListen=ripNewCfgListen, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ripNewCfgState=ripNewCfgState, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ripStats=ripStats, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaInfoTable=ospfAreaInfoTable, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfUnloop=ospfIntfUnloop, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfChangeStats=ospfIntfChangeStats, ospfinfo=ospfinfo, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfTotalAreas=ospfTotalAreas, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumTxHello=ospfCumTxHello, dnsStats=dnsStats, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipCurCfgGwMetric=ipCurCfgGwMetric, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ip_info=ip_info, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgGenState=vrrpNewCfgGenState, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgIntfIndex=ipNewCfgIntfIndex, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, arpStatMaxEntries=arpStatMaxEntries, ipFwdCurCfgState=ipFwdCurCfgState, arpInfoMacAddr=arpInfoMacAddr, ipRouteInfoType=ipRouteInfoType, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpStats=vrrpStats, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfDown=ospfIntfDown, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfProcessUptime=ospfProcessUptime, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfGeneralStats=ospfGeneralStats, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ripConfig=ripConfig, arpStatEntries=arpStatEntries, ospfAreaNbrStart=ospfAreaNbrStart, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumRxlsAcks=ospfCumRxlsAcks)
