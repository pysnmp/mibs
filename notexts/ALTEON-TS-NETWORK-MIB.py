...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ripNewCfgListen=ripNewCfgListen, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaNbrDown=ospfAreaNbrDown, routerLSAAreaIndex=routerLSAAreaIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ripCurCfgListen=ripCurCfgListen, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfNbrInInitState=ospfNbrInInitState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIfInfoIndex=ospfIfInfoIndex, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumRxTxStats=ospfCumRxTxStats, ipNewCfgBootpState=ipNewCfgBootpState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumTxHello=ospfCumTxHello, ospfAreaRxPkts=ospfAreaRxPkts, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaRxTxStats=ospfAreaRxTxStats, arpInfoMacAddr=arpInfoMacAddr, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfProcessUptime=ospfProcessUptime, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, ripStats=ripStats, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumNbrRstAd=ospfCumNbrRstAd, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfVlinkCountForRouter=ospfVlinkCountForRouter, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipGatewayTableMax=ipGatewayTableMax, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipRouteInfoType=ipRouteInfoType, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfNbrStart=ospfIntfNbrStart, ospfTotalTransitAreas=ospfTotalTransitAreas, ipRouteInfoTable=ipRouteInfoTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIfWaitInterval=ospfIfWaitInterval, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpStats=vrrpStats, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, dnsStats=dnsStats, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfinfo=ospfinfo, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumRxDatabase=ospfCumRxDatabase, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, arpStatMaxEntries=arpStatMaxEntries, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripCurCfgState=ripCurCfgState, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ripNewCfgState=ripNewCfgState, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgGwState=ipCurCfgGwState, ripNewCfgSupply=ripNewCfgSupply, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfRxPkts=ospfIntfRxPkts, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrp_info=vrrp_info, arpInfoSrcPort=arpInfoSrcPort, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfBackup=ospfIntfBackup, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfLoop=ospfIntfLoop, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumIntfHello=ospfCumIntfHello, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, arpStats=arpStats, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfStats=ospfStats, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ripCurCfgDefListen=ripCurCfgDefListen, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ripStatInPkts=ripStatInPkts, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, routeStatEntries=routeStatEntries, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgGenState=vrrpNewCfgGenState, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipRouteInfoMask=ipRouteInfoMask, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaTxlsReqs=ospfAreaTxlsReqs, arpStatHighWater=arpStatHighWater, ospfGeneralStats=ospfGeneralStats, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgIntfState=ipCurCfgIntfState, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripNewCfgVip=ripNewCfgVip, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ip_info=ip_info)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgGwMetric=ipNewCfgGwMetric, ipForward=ipForward, arpInfoEntry=arpInfoEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaNbrRstAd=ospfAreaNbrRstAd, arpStatEntries=arpStatEntries, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfTotalAreas=ospfTotalAreas, ipRouteInfoEntry=ipRouteInfoEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipRouteInfoInterface=ipRouteInfoInterface, ospfCfg=ospfCfg, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaRxHello=ospfAreaRxHello, vrrpOper=vrrpOper, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgGenState=vrrpCurCfgGenState, ripConfig=ripConfig, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, iprouting=iprouting, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumNbrhello=ospfCumNbrhello, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgGwState=ipNewCfgGwState, ospfIntfRxTxStats=ospfIntfRxTxStats, routerLSALinkID=routerLSALinkID, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, arpInfoRefPorts=arpInfoRefPorts, vrrp=vrrp, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ripCurCfgVip=ripCurCfgVip, ipCurCfgGwAddr=ipCurCfgGwAddr, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumIntfDown=ospfCumIntfDown, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfRxHello=ospfIntfRxHello, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, arpInfoDestIp=arpInfoDestIp, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, routeStats=routeStats, ospfArea=ospfArea, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfUnloop=ospfIntfUnloop, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumRxHello=ospfCumRxHello, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, arpInfoTable=arpInfoTable, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfNbrInFullState=ospfNbrInFullState, ospfInterface=ospfInterface, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipRouteInfoTag=ipRouteInfoTag, ripNewCfgDefListen=ripNewCfgDefListen, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumNbrStart=ospfCumNbrStart, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgBootpState=ipCurCfgBootpState, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfHello=ospfIntfHello, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaNbrN1way=ospfAreaNbrN1way, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfRxDatabase=ospfIntfRxDatabase, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfNbrChange=ospfIntfNbrChange)
