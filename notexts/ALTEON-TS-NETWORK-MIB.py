...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfDown=ospfIntfDown, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpOper=vrrpOper, ipNewCfgGwDelete=ipNewCfgGwDelete, routerLSAId=routerLSAId, ipCurCfgGwMetric=ipCurCfgGwMetric, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfRxPkts=ospfIntfRxPkts, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpStats=vrrpStats, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfNbrInInitState=ospfNbrInInitState, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipGatewayTableMax=ipGatewayTableMax, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, routeStatEntries=routeStatEntries, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumNbrhello=ospfCumNbrhello, ripConfig=ripConfig, arpInfoRefPorts=arpInfoRefPorts, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfGeneralStats=ospfGeneralStats, ipNewCfgIntfVlan=ipNewCfgIntfVlan, arpInfoFlag=arpInfoFlag, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, routeStatHighWater=routeStatHighWater, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfStartTime=ospfStartTime, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgIntfMask=ipNewCfgIntfMask, arpStatMaxEntries=arpStatMaxEntries, ospfGeneralInfo=ospfGeneralInfo, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumIntfLoop=ospfCumIntfLoop, arpInfoVLAN=arpInfoVLAN, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfTxPkts=ospfIntfTxPkts, ripStatOutPkts=ripStatOutPkts, routeStatMaxEntries=routeStatMaxEntries, arpStats=arpStats, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumTxPkts=ospfCumTxPkts, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipRouteInfoIndx=ipRouteInfoIndx, ospfNbrInFullState=ospfNbrInFullState, ipFwdNewCfgState=ipFwdNewCfgState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCfg=ospfCfg, ospfRangeTableMaxSize=ospfRangeTableMaxSize, arpStatEntries=arpStatEntries, vrrpStatInAdvers=vrrpStatInAdvers, ospfInterface=ospfInterface, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfStats=ospfStats, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumTxHello=ospfCumTxHello, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfUnloop=ospfIntfUnloop, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipRouteInfoType=ipRouteInfoType, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumIntfHello=ospfCumIntfHello, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipNewCfgGwState=ipNewCfgGwState, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ripCurCfgVip=ripCurCfgVip, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfGeneral=ospfGeneral, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfTxHello=ospfIntfTxHello, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaIntfHello=ospfAreaIntfHello, arpInfoDestIp=arpInfoDestIp, ripStats=ripStats, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfLsTypesSupported=ospfLsTypesSupported, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaTxPkts=ospfAreaTxPkts, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, arpInfoSrcPort=arpInfoSrcPort, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, dnsStats=dnsStats, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumRxTxStats=ospfCumRxTxStats, ospfIfInfoIndex=ospfIfInfoIndex, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfIndex=ospfIntfIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipRouteInfoGateway=ipRouteInfoGateway, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ripStatInPkts=ripStatInPkts, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrp_info=vrrp_info)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, arpInfoEntry=arpInfoEntry, ospfTotalNeighbours=ospfTotalNeighbours, ripNewCfgListen=ripNewCfgListen, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipRouteInfoEntry=ipRouteInfoEntry, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfArea=ospfArea, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, routeStats=routeStats, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfNbrInExchState=ospfNbrInExchState, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipCurCfgBootpState=ipCurCfgBootpState, ripCurCfgState=ripCurCfgState, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumNbrStart=ospfCumNbrStart, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaTxHello=ospfAreaTxHello, ripNewCfgSupply=ripNewCfgSupply, ospfCumRxHello=ospfCumRxHello, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfProcessUptime=ospfProcessUptime, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfCountForRouter=ospfIntfCountForRouter, arpInfoTable=arpInfoTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfLoop=ospfIntfLoop, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaChangeStats=ospfAreaChangeStats, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrp=vrrp, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgGwAddr=ipNewCfgGwAddr, ipRouteInfoTag=ipRouteInfoTag, ospfIntfNbrChange=ospfIntfNbrChange, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaTxDatabase=ospfAreaTxDatabase, arpStatHighWater=arpStatHighWater, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaTxlsAcks=ospfAreaTxlsAcks, routerLSALinkID=routerLSALinkID, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumNbrDown=ospfCumNbrDown, ospfNewCfgAreaId=ospfNewCfgAreaId, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipNewCfgIntfState=ipNewCfgIntfState, iprouting=iprouting, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgGwRetry=ipNewCfgGwRetry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaRxTxStats=ospfAreaRxTxStats, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripNewCfgDefListen=ripNewCfgDefListen, ripNewCfgState=ripNewCfgState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaInfoId=ospfAreaInfoId, ripCurCfgStaticSupply=ripCurCfgStaticSupply, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipRouteInfoTable=ipRouteInfoTable, ripNewCfgVip=ripNewCfgVip, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgGwIndex=ipNewCfgGwIndex, ipForward=ipForward, ipNewCfgGwEntry=ipNewCfgGwEntry, ip_info=ip_info, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv)
