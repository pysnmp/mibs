...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipRouteInfoMask=ipRouteInfoMask, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, arpInfoRefPorts=arpInfoRefPorts, arpInfoTable=arpInfoTable, ospfAreaInfoIndex=ospfAreaInfoIndex, routeStatMaxEntries=routeStatMaxEntries, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ripStats=ripStats, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaNbrDown=ospfAreaNbrDown, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaRxlsReqs=ospfAreaRxlsReqs, arpInfoEntry=arpInfoEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfLoop=ospfIntfLoop, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfLsTypesSupported=ospfLsTypesSupported, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdCurCfgState=ipFwdCurCfgState, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfVlinkCountForRouter=ospfVlinkCountForRouter, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfProcessUptime=ospfProcessUptime, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ripConfig=ripConfig, ospfCfg=ospfCfg, ospfCumRxlsReqs=ospfCumRxlsReqs, ripCurCfgState=ripCurCfgState, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumNbrhello=ospfCumNbrhello, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, routerLSALinkData=routerLSALinkData, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaRxHello=ospfAreaRxHello, ripCurCfgSupply=ripCurCfgSupply, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIfInfoIndex=ospfIfInfoIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfDown=ospfIntfDown, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumTxDatabase=ospfCumTxDatabase, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfNbrInInitState=ospfNbrInInitState, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, arpInfoVLAN=arpInfoVLAN, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ripCurCfgListen=ripCurCfgListen, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfGeneral=ospfGeneral, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfInterface=ospfInterface, iprouting=iprouting, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ripNewCfgVip=ripNewCfgVip, arpInfoDestIp=arpInfoDestIp, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaRxPkts=ospfAreaRxPkts, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgGwRetry=ipCurCfgGwRetry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfInfoTable=ospfIntfInfoTable, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, arpStatHighWater=arpStatHighWater, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumRxPkts=ospfCumRxPkts, ospfAreaRxDatabase=ospfAreaRxDatabase, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgGwState=ipCurCfgGwState, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCumIntfBackup=ospfCumIntfBackup, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfArea=ospfArea, ospfIntfNbrChange=ospfIntfNbrChange, ipRouteInfoInterface=ipRouteInfoInterface, ospfTimersKickOffStats=ospfTimersKickOffStats, ipForward=ipForward, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfTotalNeighbours=ospfTotalNeighbours, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, arpStatMaxEntries=arpStatMaxEntries, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ripNewCfgListen=ripNewCfgListen, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumNbrDown=ospfCumNbrDown, routerLSALinkIndex=routerLSALinkIndex, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfRxTxStats=ospfIntfRxTxStats)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumNbrBadSequence=ospfCumNbrBadSequence, dnsStats=dnsStats, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgGwTable=ipCurCfgGwTable, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfRxDatabase=ospfIntfRxDatabase, routeStatEntries=routeStatEntries, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumRxDatabase=ospfCumRxDatabase, ospfGeneralInfo=ospfGeneralInfo, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgIntfState=ipCurCfgIntfState, arpInfoSrcPort=arpInfoSrcPort, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrp=vrrp, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIfWaitInterval=ospfIfWaitInterval, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfInfoEntry=ospfIntfInfoEntry, ipRouteInfoTable=ipRouteInfoTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgGwIndex=ipNewCfgGwIndex, arpStats=arpStats, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfNbrStart=ospfIntfNbrStart, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfBackup=ospfIntfBackup, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumTxHello=ospfCumTxHello, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumRxHello=ospfCumRxHello, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipRouteInfoType=ipRouteInfoType, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ripNewCfgState=ripNewCfgState, vrrp_info=vrrp_info, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaIntfDown=ospfAreaIntfDown, routeStatHighWater=routeStatHighWater, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCumTxlsReqs=ospfCumTxlsReqs, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfinfo=ospfinfo, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ripStatInPkts=ripStatInPkts, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfStartTime=ospfStartTime, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfGeneralStats=ospfGeneralStats, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfStats=ospfStats, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfRxHello=ospfIntfRxHello, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfTotalNssaAreas=ospfTotalNssaAreas, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumTxPkts=ospfCumTxPkts, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfIndex=ospfIntfIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ripNewCfgSupply=ripNewCfgSupply, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ip_info=ip_info, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, routerLSAAreaIndex=routerLSAAreaIndex, ipGatewayTableMax=ipGatewayTableMax, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ripStatInErrorPkts=ripStatInErrorPkts, vrrpStatInAdvers=vrrpStatInAdvers, routeStats=routeStats, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgGwArp=ipNewCfgGwArp, arpInfoFlag=arpInfoFlag, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpOper=vrrpOper, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumIntfLoop=ospfCumIntfLoop, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpStats=vrrpStats, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx)
