...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ripCurCfgState=ripCurCfgState, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipRouteInfoIndx=ipRouteInfoIndx, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaIntfBackup=ospfAreaIntfBackup, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrp_info=vrrp_info, ripNewCfgState=ripNewCfgState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfTxHello=ospfIntfTxHello, iprouting=iprouting, ospfinfo=ospfinfo, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrp=vrrp, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgGwState=ipCurCfgGwState, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfArea=ospfArea, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, routeStatHighWater=routeStatHighWater, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaTxHello=ospfAreaTxHello, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfGeneralInfo=ospfGeneralInfo, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipFwdCurCfgState=ipFwdCurCfgState, ripNewCfgVip=ripNewCfgVip, ospfAreaNbrDown=ospfAreaNbrDown, ripConfig=ripConfig, ospfCumNbrStart=ospfCumNbrStart, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfHello=ospfIntfHello, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfDown=ospfIntfDown, arpInfoEntry=arpInfoEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ripNewCfgSupply=ripNewCfgSupply, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ripStatInPkts=ripStatInPkts, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, arpInfoSrcPort=arpInfoSrcPort, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, arpStatHighWater=arpStatHighWater, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaIntfDown=ospfAreaIntfDown, ospfCfg=ospfCfg, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumIntfLoop=ospfCumIntfLoop, routerLSAId=routerLSAId, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ripNewCfgDefListen=ripNewCfgDefListen, ospfNbrInExchState=ospfNbrInExchState, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfInterface=ospfInterface, vrrpGeneral=vrrpGeneral, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumTxHello=ospfCumTxHello, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, arpStatMaxEntries=arpStatMaxEntries, ospfProcessUptime=ospfProcessUptime, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumIntfDown=ospfCumIntfDown, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgGwArp=ipNewCfgGwArp, routeStats=routeStats, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumRxHello=ospfCumRxHello, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, arpStatEntries=arpStatEntries, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgGwTable=ipNewCfgGwTable, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpStats=vrrpStats, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ripStats=ripStats, ipCurCfgBootpState=ipCurCfgBootpState, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgGwInterval=ipCurCfgGwInterval, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfUnloop=ospfIntfUnloop, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfNbrInInitState=ospfNbrInInitState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumNbrN1way=ospfCumNbrN1way, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfTxPkts=ospfIntfTxPkts, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ripStatOutPkts=ripStatOutPkts, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ip_info=ip_info, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, routeStatEntries=routeStatEntries, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumTxPkts=ospfCumTxPkts, ospfStats=ospfStats, ospfAreaNbrRstAd=ospfAreaNbrRstAd, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgIntfVlan=ipCurCfgIntfVlan, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgIntfEntry=ipCurCfgIntfEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfBackup=ospfIntfBackup, ospfCumIntfNbrChange=ospfCumIntfNbrChange, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfRxTxStats=ospfIntfRxTxStats, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfTotalNeighbours=ospfTotalNeighbours, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfGeneralStats=ospfGeneralStats, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfNbrhello=ospfIntfNbrhello, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfStartTime=ospfStartTime, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, routerLSALinkData=routerLSALinkData, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgGwIndex=ipNewCfgGwIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, arpInfoTable=arpInfoTable, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipGatewayTableMax=ipGatewayTableMax, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipRouteInfoTable=ipRouteInfoTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpOper=vrrpOper, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripCurCfgSupply=ripCurCfgSupply, ospfAreaTableMaxSize=ospfAreaTableMaxSize, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCumRxPkts=ospfCumRxPkts, arpStats=arpStats, ospfAreaInfoId=ospfAreaInfoId, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgGenState=vrrpCurCfgGenState, ipForward=ipForward, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgIntfState=ipCurCfgIntfState, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfRxHello=ospfIntfRxHello, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfGeneral=ospfGeneral, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfNbrDown=ospfIntfNbrDown, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, dnsStats=dnsStats, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaChangeStats=ospfAreaChangeStats, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfIndex=ospfIntfIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ripNewCfgListen=ripNewCfgListen, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, routerLSALinkIndex=routerLSALinkIndex, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfNbrStart=ospfIntfNbrStart, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgIntfMask=ipCurCfgIntfMask, arpInfoMacAddr=arpInfoMacAddr, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ripCurCfgListen=ripCurCfgListen, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfInfoTable=ospfIntfInfoTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID)
