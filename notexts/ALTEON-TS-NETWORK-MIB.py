...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfInterface=ospfInterface, arpStatMaxEntries=arpStatMaxEntries, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgIfTable=vrrpCurCfgIfTable, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaRxHello=ospfAreaRxHello, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipRouteInfoGateway=ipRouteInfoGateway, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripStatInPkts=ripStatInPkts, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, arpInfoDestIp=arpInfoDestIp, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumTxHello=ospfCumTxHello, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfDown=ospfIntfDown, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, arpInfoTable=arpInfoTable, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfHello=ospfIntfHello, routeStatEntries=routeStatEntries, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfGeneralInfo=ospfGeneralInfo, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ripCurCfgState=ripCurCfgState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgGwState=ipNewCfgGwState, ipRouteInfoMask=ipRouteInfoMask, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpStatInAdvers=vrrpStatInAdvers, ospfStats=ospfStats, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaNbrhello=ospfAreaNbrhello, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ripStatInErrorPkts=ripStatInErrorPkts, ospfStartTime=ospfStartTime, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumRxPkts=ospfCumRxPkts, ospfGeneralStats=ospfGeneralStats, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipGatewayTableMax=ipGatewayTableMax, ripNewCfgVip=ripNewCfgVip, ospfIntfBackup=ospfIntfBackup, ipCurCfgGwState=ipCurCfgGwState, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipForward=ipForward, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumIntfLoop=ospfCumIntfLoop, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ripConfig=ripConfig, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfGeneral=ospfGeneral, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, iprouting=iprouting, ospfAreaIntfIndex=ospfAreaIntfIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ripNewCfgState=ripNewCfgState, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumRxlsUpdates=ospfCumRxlsUpdates, dnsStats=dnsStats, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgIntfMask=ipCurCfgIntfMask, ipNewCfgGwIndex=ipNewCfgGwIndex, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, arpInfoVLAN=arpInfoVLAN, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfCountForRouter=ospfIntfCountForRouter, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipFwdNewCfgState=ipFwdNewCfgState, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, arpStatHighWater=arpStatHighWater, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpGeneral=vrrpGeneral, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIfWaitInterval=ospfIfWaitInterval, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfChangeStats=ospfIntfChangeStats, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ripCurCfgListen=ripCurCfgListen)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, arpStats=arpStats, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfNbrChange=ospfIntfNbrChange, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaTxHello=ospfAreaTxHello, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumRxDatabase=ospfCumRxDatabase, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfTotalNssaAreas=ospfTotalNssaAreas, arpInfoFlag=arpInfoFlag, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, routerLSALinkID=routerLSALinkID, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumIntfDown=ospfCumIntfDown, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfTxPkts=ospfIntfTxPkts, ripStatOutPkts=ripStatOutPkts, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipRouteInfoType=ipRouteInfoType, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCumIntfUnloop=ospfCumIntfUnloop, ripCurCfgDefListen=ripCurCfgDefListen, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumRxHello=ospfCumRxHello, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipNewCfgGwInterval=ipNewCfgGwInterval, routeStatMaxEntries=routeStatMaxEntries, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfArea=ospfArea, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaChangeStats=ospfAreaChangeStats, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfTotalAreas=ospfTotalAreas, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpOper=vrrpOper, routeStatHighWater=routeStatHighWater, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaRxPkts=ospfAreaRxPkts, ipCurCfgGwTable=ipCurCfgGwTable, ospfHostTableMaxSize=ospfHostTableMaxSize, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpStats=vrrpStats, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfTxHello=ospfIntfTxHello, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIfInfoIndex=ospfIfInfoIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgIntfState=ipCurCfgIntfState, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfProcessUptime=ospfProcessUptime, routeStats=routeStats, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgGwTable=ipNewCfgGwTable, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgBootpState=ipCurCfgBootpState, vrrp=vrrp, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ripNewCfgListen=ripNewCfgListen, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfTotalNeighbours=ospfTotalNeighbours, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfNbrStart=ospfIntfNbrStart, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ripCurCfgVip=ripCurCfgVip, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfinfo=ospfinfo, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ripStats=ripStats, ip_info=ip_info, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumIntfHello=ospfCumIntfHello, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfLoop=ospfIntfLoop, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, arpStatEntries=arpStatEntries, ospfNbrInExchState=ospfNbrInExchState, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfRxTxStats=ospfIntfRxTxStats, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply)
