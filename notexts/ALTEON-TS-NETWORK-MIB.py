...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumRxTxStats=ospfCumRxTxStats, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfUnloop=ospfIntfUnloop, ospfCumTxHello=ospfCumTxHello, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ripStats=ripStats, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ripNewCfgState=ripNewCfgState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumNbrhello=ospfCumNbrhello, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfTableMaxSize=ospfIntfTableMaxSize, routerLSALinkID=routerLSALinkID, ospfCumIntfHello=ospfCumIntfHello, ospfIntfTxHello=ospfIntfTxHello, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfinfo=ospfinfo, ospfAreaNbrhello=ospfAreaNbrhello, vrrpOper=vrrpOper, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfGeneralInfo=ospfGeneralInfo, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfTimersKickOffStats=ospfTimersKickOffStats, routerLSALinkIndex=routerLSALinkIndex, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaRxHello=ospfAreaRxHello, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, arpInfoRefPorts=arpInfoRefPorts, ipRouteInfoTag=ipRouteInfoTag, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ripNewCfgListen=ripNewCfgListen, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumRxPkts=ospfCumRxPkts, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfHello=ospfIntfHello, routeStatMaxEntries=routeStatMaxEntries, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, arpStatHighWater=arpStatHighWater, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrp=vrrp, ospfCumRxHello=ospfCumRxHello, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipCurCfgGwInterval=ipCurCfgGwInterval, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfProcessUptime=ospfProcessUptime, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfNbrInExchState=ospfNbrInExchState, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumNbrStart=ospfCumNbrStart, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ripCurCfgState=ripCurCfgState, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaIntfHello=ospfAreaIntfHello, ripCurCfgListen=ripCurCfgListen, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ripNewCfgSupply=ripNewCfgSupply, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfInterface=ospfInterface, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipFwdCurCfgState=ipFwdCurCfgState, ospfCurCfgAreaId=ospfCurCfgAreaId, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaTxHello=ospfAreaTxHello, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfDown=ospfIntfDown, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, arpInfoEntry=arpInfoEntry, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, arpStatEntries=arpStatEntries, arpInfoDestIp=arpInfoDestIp, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, routeStats=routeStats, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipRouteInfoType=ipRouteInfoType, ospfStartTime=ospfStartTime, ospfIfInfoIndex=ospfIfInfoIndex, ospfIntfIndex=ospfIntfIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgGwVlan=ipCurCfgGwVlan, dnsStats=dnsStats, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgIntfMask=ipCurCfgIntfMask, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ip_info=ip_info, vrrp_info=vrrp_info, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ripConfig=ripConfig, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfRxPkts=ospfIntfRxPkts, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumRxlsAcks=ospfCumRxlsAcks, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCfg=ospfCfg, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, arpStats=arpStats, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, routeStatHighWater=routeStatHighWater, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpGeneral=vrrpGeneral, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripStatInErrorPkts=ripStatInErrorPkts, ipRouteInfoIndx=ipRouteInfoIndx, ospfNewCfgAreaTable=ospfNewCfgAreaTable, iprouting=iprouting, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgGwState=ipCurCfgGwState, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumTxlsReqs=ospfCumTxlsReqs, ripCurCfgVip=ripCurCfgVip, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, arpInfoVLAN=arpInfoVLAN, ospfStats=ospfStats, ipNewCfgGwState=ipNewCfgGwState, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfInfoTable=ospfIntfInfoTable, ripNewCfgVip=ripNewCfgVip, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfLoop=ospfIntfLoop, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgGwIndex=ipCurCfgGwIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumTxlsAcks=ospfCumTxlsAcks, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, routerLSALinkData=routerLSALinkData, ripStatInPkts=ripStatInPkts, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipRouteInfoMask=ipRouteInfoMask, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ripNewCfgDefListen=ripNewCfgDefListen, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, arpInfoMacAddr=arpInfoMacAddr, routeStatEntries=routeStatEntries, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, routerLSAId=routerLSAId, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgGwTable=ipCurCfgGwTable, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaChangeStats=ospfAreaChangeStats, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipForward=ipForward, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfArea=ospfArea, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, arpInfoFlag=arpInfoFlag, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrStart=ospfIntfNbrStart, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ripCurCfgSupply=ripCurCfgSupply, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpStats=vrrpStats, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfTotalAreas=ospfTotalAreas, ospfAreaTxlsAcks=ospfAreaTxlsAcks, arpInfoTable=arpInfoTable, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumRxlsUpdates=ospfCumRxlsUpdates)
