...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfStats=ospfStats, ipCurCfgGwIndex=ipCurCfgGwIndex, ripStatOutPkts=ripStatOutPkts, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumIntfBackup=ospfCumIntfBackup, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfNbrInFullState=ospfNbrInFullState, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, arpInfoSrcPort=arpInfoSrcPort, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, routeStatEntries=routeStatEntries, arpStats=arpStats, ipGatewayTableMax=ipGatewayTableMax, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfBackup=ospfIntfBackup, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfGeneralStats=ospfGeneralStats, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpOper=vrrpOper, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, arpStatHighWater=arpStatHighWater, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ripStatInPkts=ripStatInPkts, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaInfoId=ospfAreaInfoId, ripStats=ripStats, ospfIntfCountForRouter=ospfIntfCountForRouter, ipForward=ipForward, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ripCurCfgVip=ripCurCfgVip, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, arpInfoTable=arpInfoTable, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfNbrStart=ospfIntfNbrStart, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpGeneral=vrrpGeneral, ospfCumIntfHello=ospfCumIntfHello, ospfGeneralInfo=ospfGeneralInfo, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCfg=ospfCfg, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfIndex=ospfIntfIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaChangeStats=ospfAreaChangeStats, vrrp=vrrp, ospfinfo=ospfinfo, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, arpStatEntries=arpStatEntries, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumRxHello=ospfCumRxHello, ospfCumRxlsReqs=ospfCumRxlsReqs, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaNbrStart=ospfAreaNbrStart, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumIntfDown=ospfCumIntfDown, ospfProcessUptime=ospfProcessUptime, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumTxDatabase=ospfCumTxDatabase, ripCurCfgSupply=ripCurCfgSupply, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdCurCfgState=ipFwdCurCfgState, ripNewCfgSupply=ripNewCfgSupply, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgGwInterval=ipNewCfgGwInterval, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfGeneral=ospfGeneral, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgIntfEntry=ipCurCfgIntfEntry, arpInfoMacAddr=arpInfoMacAddr, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfNbrInExchState=ospfNbrInExchState, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ripNewCfgListen=ripNewCfgListen, arpInfoEntry=arpInfoEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfStartTime=ospfStartTime, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfTotalAreas=ospfTotalAreas, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgGwState=ipNewCfgGwState, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, iprouting=iprouting, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipRouteInfoIndx=ipRouteInfoIndx, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgIntfTable=ipNewCfgIntfTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfArea=ospfArea, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipRouteInfoTable=ipRouteInfoTable, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ip_info=ip_info, ospfCumTxHello=ospfCumTxHello, ospfAreaNbrN1way=ospfAreaNbrN1way, ripConfig=ripConfig, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfWaitTimer=ospfIntfWaitTimer)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdNewCfgState=ipFwdNewCfgState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, routerLSALinkData=routerLSALinkData, ipNewCfgGwVlan=ipNewCfgGwVlan, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgGwVlan=ipCurCfgGwVlan, arpInfoDestIp=arpInfoDestIp, ipCurCfgGwAddr=ipCurCfgGwAddr, routerLSAId=routerLSAId, ospfCumRxDatabase=ospfCumRxDatabase, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipRouteInfoGateway=ipRouteInfoGateway, routeStats=routeStats, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfLsTypesSupported=ospfLsTypesSupported, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfNbrChange=ospfIntfNbrChange, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfDown=ospfIntfDown, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaIntfIndex=ospfAreaIntfIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, arpInfoRefPorts=arpInfoRefPorts, dnsStats=dnsStats, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfHello=ospfIntfHello, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaNbrDown=ospfAreaNbrDown, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ripCurCfgState=ripCurCfgState, ospfIntfLoop=ospfIntfLoop, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgBootpState=ipNewCfgBootpState, vrrpStats=vrrpStats, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfUnloop=ospfIntfUnloop, ospfCumNbrhello=ospfCumNbrhello, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, routeStatMaxEntries=routeStatMaxEntries, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfNbrInInitState=ospfNbrInInitState, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ripNewCfgVip=ripNewCfgVip, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipRouteInfoType=ipRouteInfoType, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaRxHello=ospfAreaRxHello, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfInterface=ospfInterface, arpInfoVLAN=arpInfoVLAN, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaTxHello=ospfAreaTxHello, ipRouteInfoEntry=ipRouteInfoEntry, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrp_info=vrrp_info, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfChangeStats=ospfIntfChangeStats, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfRxDatabase=ospfIntfRxDatabase, ipInterfaceTableMax=ipInterfaceTableMax, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaNbrhello=ospfAreaNbrhello, arpInfoFlag=arpInfoFlag, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete)
