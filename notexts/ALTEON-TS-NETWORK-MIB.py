...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCurCfgAreaId=ospfCurCfgAreaId, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipGatewayTableMax=ipGatewayTableMax, ospfCumNbrN1way=ospfCumNbrN1way, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfGeneralStats=ospfGeneralStats, ospfIntfNbrN1way=ospfIntfNbrN1way, ripCurCfgVip=ripCurCfgVip, arpStatHighWater=arpStatHighWater, ipRouteInfoMask=ipRouteInfoMask, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfDown=ospfIntfDown, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipRouteInfoType=ipRouteInfoType, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipRouteInfoEntry=ipRouteInfoEntry, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, routerLSALinkIndex=routerLSALinkIndex, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrp=vrrp, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfNbrDown=ospfIntfNbrDown, ospfIfInfoIndex=ospfIfInfoIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, routeStatMaxEntries=routeStatMaxEntries, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumTxDatabase=ospfCumTxDatabase, routerLSAAreaIndex=routerLSAAreaIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipForward=ipForward, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfHello=ospfIntfHello, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, dnsStats=dnsStats, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumNbrStart=ospfCumNbrStart, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ripNewCfgVip=ripNewCfgVip, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, arpStatEntries=arpStatEntries, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfNbrhello=ospfIntfNbrhello, arpStats=arpStats, ip_info=ip_info, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfArea=ospfArea, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfNbrInFullState=ospfNbrInFullState, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ripStatOutPkts=ripStatOutPkts, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaIntfDown=ospfAreaIntfDown, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipInterfaceTableMax=ipInterfaceTableMax, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaIntfBackup=ospfAreaIntfBackup, routerLSALinkIfIndex=routerLSALinkIfIndex, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ripNewCfgSupply=ripNewCfgSupply, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumRxHello=ospfCumRxHello, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ripStatInPkts=ripStatInPkts, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfRxPkts=ospfIntfRxPkts, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, routerLSALinkData=routerLSALinkData, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaInfoEntry=ospfAreaInfoEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipRouteInfoDestIp=ipRouteInfoDestIp, routeStats=routeStats, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ripCurCfgState=ripCurCfgState, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgGwState=ipNewCfgGwState, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaRxHello=ospfAreaRxHello, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumIntfLoop=ospfCumIntfLoop, iprouting=iprouting, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, routerLSALinkID=routerLSALinkID, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipRouteInfoTag=ipRouteInfoTag, ospfAreaRxDatabase=ospfAreaRxDatabase, routerLSAId=routerLSAId, routeStatHighWater=routeStatHighWater, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgGenState=vrrpNewCfgGenState, routeStatEntries=routeStatEntries, ospfAreaTableMaxSize=ospfAreaTableMaxSize, arpInfoRefPorts=arpInfoRefPorts, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgGwTable=ipCurCfgGwTable, vrrpStats=vrrpStats, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipFwdCurCfgState=ipFwdCurCfgState, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfNbrInExchState=ospfNbrInExchState, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfLoop=ospfIntfLoop, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgGwAddr=ipCurCfgGwAddr, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfUnloop=ospfIntfUnloop, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfRxDatabase=ospfIntfRxDatabase, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaIntfHello=ospfAreaIntfHello, ospfIfWaitInterval=ospfIfWaitInterval, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, arpInfoSrcPort=arpInfoSrcPort, ospfCumTxHello=ospfCumTxHello, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumIntfDown=ospfCumIntfDown, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaNbrStart=ospfAreaNbrStart, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfLsTypesSupported=ospfLsTypesSupported, arpInfoTable=arpInfoTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfGeneral=ospfGeneral, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpOper=vrrpOper, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ripStats=ripStats, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaTxHello=ospfAreaTxHello, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaInfoTable=ospfAreaInfoTable, ripNewCfgListen=ripNewCfgListen, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfStats=ospfStats, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumNbrDown=ospfCumNbrDown, ripConfig=ripConfig, arpInfoEntry=arpInfoEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfTotalTransitAreas=ospfTotalTransitAreas, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ripNewCfgState=ripNewCfgState, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfNbrInInitState=ospfNbrInInitState, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfInterface=ospfInterface, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, arpInfoMacAddr=arpInfoMacAddr, ospfTotalAreas=ospfTotalAreas, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCfg=ospfCfg, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipRouteInfoIndx=ipRouteInfoIndx, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgGwMetric=ipCurCfgGwMetric, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfStartTime=ospfStartTime, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumNbrhello=ospfCumNbrhello, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaInfoId=ospfAreaInfoId, vrrpGeneral=vrrpGeneral, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ripCurCfgSupply=ripCurCfgSupply, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfBackup=ospfIntfBackup, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumTxPkts=ospfCumTxPkts, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats)
