...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaInfoTable=ospfAreaInfoTable, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfArea=ospfArea, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, arpInfoEntry=arpInfoEntry, ripStatInPkts=ripStatInPkts, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, arpInfoTable=arpInfoTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgGwState=ipNewCfgGwState, ospfAreaRxDatabase=ospfAreaRxDatabase, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfIndex=ospfIntfIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipRouteInfoGateway=ipRouteInfoGateway, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, iprouting=iprouting, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, arpInfoSrcPort=arpInfoSrcPort, ospfInterface=ospfInterface, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCfg=ospfCfg, ospfAreaChangeStats=ospfAreaChangeStats, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumRxlsUpdates=ospfCumRxlsUpdates, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ripStats=ripStats, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfInfoTable=ospfIntfInfoTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumNbrStart=ospfCumNbrStart, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipRouteInfoInterface=ipRouteInfoInterface, ipRouteInfoIndx=ipRouteInfoIndx, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, arpInfoVLAN=arpInfoVLAN, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfStartTime=ospfStartTime, ospfNbrInInitState=ospfNbrInInitState, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgGwState=ipCurCfgGwState, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumIntfDown=ospfCumIntfDown, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ip_info=ip_info, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, arpInfoMacAddr=arpInfoMacAddr, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, routeStatEntries=routeStatEntries, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ripCurCfgState=ripCurCfgState, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgIntfState=ipCurCfgIntfState, arpStats=arpStats, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfStats=ospfStats, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipFwdNewCfgState=ipFwdNewCfgState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumIntfUnloop=ospfCumIntfUnloop, arpInfoRefPorts=arpInfoRefPorts, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgIntfEntry=ipNewCfgIntfEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaTxHello=ospfAreaTxHello, routeStats=routeStats, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfProcessUptime=ospfProcessUptime, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfGeneralInfo=ospfGeneralInfo, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipInterfaceTableMax=ipInterfaceTableMax, ipRouteInfoType=ipRouteInfoType, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumRxPkts=ospfCumRxPkts, ipRouteInfoMask=ipRouteInfoMask, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfinfo=ospfinfo, ipCurCfgGwTable=ipCurCfgGwTable, ospfNbrInExchState=ospfNbrInExchState, ospfIntfBackup=ospfIntfBackup, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrp=vrrp, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfNbrInFullState=ospfNbrInFullState, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfTotalNeighbours=ospfTotalNeighbours, arpInfoFlag=arpInfoFlag, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumRxlsAcks=ospfCumRxlsAcks, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfRxHello=ospfIntfRxHello, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfLoop=ospfIntfLoop, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, routerLSAId=routerLSAId, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrp_info=vrrp_info, ospfAreaIntfLoop=ospfAreaIntfLoop, ripCurCfgSupply=ripCurCfgSupply, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipRouteInfoTable=ipRouteInfoTable, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfTxHello=ospfIntfTxHello, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaNbrDown=ospfAreaNbrDown, ipRouteInfoDestIp=ipRouteInfoDestIp, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIfInfoIndex=ospfIfInfoIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ripConfig=ripConfig, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfChangeStats=ospfIntfChangeStats, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipCurCfgGwEntry=ipCurCfgGwEntry, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumRxHello=ospfCumRxHello, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaInfoId=ospfAreaInfoId, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ripNewCfgState=ripNewCfgState, ripCurCfgListen=ripCurCfgListen, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, arpStatHighWater=arpStatHighWater, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumTxPkts=ospfCumTxPkts, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ripNewCfgSupply=ripNewCfgSupply, ospfTotalTransitAreas=ospfTotalTransitAreas, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipFwdCurCfgState=ipFwdCurCfgState, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfTxPkts=ospfIntfTxPkts, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfNbrStart=ospfIntfNbrStart, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ripNewCfgListen=ripNewCfgListen, ipForward=ipForward, vrrpStatInAdvers=vrrpStatInAdvers, ospfGeneral=ospfGeneral, ospfIntfNbrhello=ospfIntfNbrhello, ripNewCfgVip=ripNewCfgVip, dnsStats=dnsStats, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipCurCfgGwArp=ipCurCfgGwArp, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfRxTxStats=ospfIntfRxTxStats, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgGwRetry=ipCurCfgGwRetry, routerLSALinkData=routerLSALinkData, arpStatEntries=arpStatEntries, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfHello=ospfIntfHello, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumNbrN1way=ospfCumNbrN1way, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgBootpState=ipNewCfgBootpState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaNbrIndex=ospfAreaNbrIndex, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgIntfMask=ipNewCfgIntfMask, arpInfoDestIp=arpInfoDestIp)
