...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaTxHello=ospfAreaTxHello, ospfAreaNbrhello=ospfAreaNbrhello, ospfGeneral=ospfGeneral, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, routeStatHighWater=routeStatHighWater, ospfCumIntfNbrChange=ospfCumIntfNbrChange, arpInfoDestIp=arpInfoDestIp, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipRouteInfoType=ipRouteInfoType, ipRouteInfoTag=ipRouteInfoTag, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrp=vrrp, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfRxTxStats=ospfIntfRxTxStats, arpStatEntries=arpStatEntries, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfDown=ospfIntfDown, ripNewCfgState=ripNewCfgState, ripCurCfgListen=ripCurCfgListen, ospfIntfBackup=ospfIntfBackup, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumIntfDown=ospfCumIntfDown, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgBootpAddr=ipCurCfgBootpAddr, routerLSAId=routerLSAId, vrrp_info=vrrp_info, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, arpInfoMacAddr=arpInfoMacAddr, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumRxDatabase=ospfCumRxDatabase, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgGenState=vrrpCurCfgGenState, ipCurCfgGwState=ipCurCfgGwState, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaInfoIndex=ospfAreaInfoIndex, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, arpStats=arpStats, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumNbrDown=ospfCumNbrDown, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaChangeStats=ospfAreaChangeStats, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfStats=ospfStats, ospfGeneralStats=ospfGeneralStats, ip_info=ip_info, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfLoop=ospfIntfLoop, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaTxDatabase=ospfAreaTxDatabase, ripStats=ripStats, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCurCfgAreaId=ospfCurCfgAreaId, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumNbrStart=ospfCumNbrStart, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ripCurCfgState=ripCurCfgState, routerLSALinkData=routerLSALinkData, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumIntfHello=ospfCumIntfHello, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpOper=vrrpOper, ospfCumIntfUnloop=ospfCumIntfUnloop, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgIfTable=vrrpNewCfgIfTable, arpInfoFlag=arpInfoFlag, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfNbrInExchState=ospfNbrInExchState, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfTimersKickOffStats=ospfTimersKickOffStats, routerLSALinkID=routerLSALinkID, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, arpStatHighWater=arpStatHighWater, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfProcessUptime=ospfProcessUptime, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgGwArp=ipNewCfgGwArp, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, routeStats=routeStats, ipFwdNewCfgState=ipFwdNewCfgState, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfInterface=ospfInterface, ospfIntfNbrDown=ospfIntfNbrDown, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgBootpState=ipCurCfgBootpState, vrrpStats=vrrpStats, ospfAreaRxTxIndex=ospfAreaRxTxIndex, routeStatMaxEntries=routeStatMaxEntries, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgIntfMask=ipNewCfgIntfMask, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, dnsStats=dnsStats, ipCurCfgGwRetry=ipCurCfgGwRetry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaInfoTable=ospfAreaInfoTable, ipForward=ipForward, ipNewCfgGwRetry=ipNewCfgGwRetry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, arpStatMaxEntries=arpStatMaxEntries, ripNewCfgVip=ripNewCfgVip, ripStatOutPkts=ripStatOutPkts, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfLsTypesSupported=ospfLsTypesSupported, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaInfoId=ospfAreaInfoId, ospfCumRxPkts=ospfCumRxPkts, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, arpInfoRefPorts=arpInfoRefPorts, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfTotalAreas=ospfTotalAreas, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfVlinkCountForRouter=ospfVlinkCountForRouter, ripConfig=ripConfig, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaRxHello=ospfAreaRxHello, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfNbrInFullState=ospfNbrInFullState, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, iprouting=iprouting, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfUnloop=ospfIntfUnloop, ipGatewayTableMax=ipGatewayTableMax, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumRxHello=ospfCumRxHello, routerLSALinkIndex=routerLSALinkIndex, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipInterfaceTableMax=ipInterfaceTableMax, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipRouteInfoIndx=ipRouteInfoIndx, ospfinfo=ospfinfo, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfRxHello=ospfIntfRxHello, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpGeneral=vrrpGeneral, ospfIntfNbrhello=ospfIntfNbrhello, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, arpInfoVLAN=arpInfoVLAN, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgIntfState=ipCurCfgIntfState, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumNbrhello=ospfCumNbrhello, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfArea=ospfArea, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgGwTable=ipNewCfgGwTable, ospfCfg=ospfCfg, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipNewCfgGwMetric=ipNewCfgGwMetric, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfStartTime=ospfStartTime, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipRouteInfoTable=ipRouteInfoTable, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfHello=ospfIntfHello, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, routeStatEntries=routeStatEntries, ospfAreaIntfHello=ospfAreaIntfHello, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, routerLSAAreaIndex=routerLSAAreaIndex, ospfNbrInInitState=ospfNbrInInitState, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumNbrN1way=ospfCumNbrN1way, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgGwEntry=ipNewCfgGwEntry, ripStatInPkts=ripStatInPkts, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfChangeStats=ospfIntfChangeStats, ospfGeneralInfo=ospfGeneralInfo, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipRouteInfoEntry=ipRouteInfoEntry, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, arpInfoTable=arpInfoTable, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgGwState=ipNewCfgGwState, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt)
