...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaIntfHello=ospfAreaIntfHello, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaIntfBackup=ospfAreaIntfBackup, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipRouteInfoEntry=ipRouteInfoEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaInfoIndex=ospfAreaInfoIndex, ripCurCfgSupply=ripCurCfgSupply, arpStatHighWater=arpStatHighWater, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfStats=ospfStats, routeStatEntries=routeStatEntries, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaRxHello=ospfAreaRxHello, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaNbrStart=ospfAreaNbrStart, ipNewCfgGwIndex=ipNewCfgGwIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfIndex=ospfIntfIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaIntfIndex=ospfAreaIntfIndex, ripCurCfgState=ripCurCfgState, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumTxHello=ospfCumTxHello, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumIntfLoop=ospfCumIntfLoop, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ripNewCfgListen=ripNewCfgListen, ipCurCfgIntfTable=ipCurCfgIntfTable, ripCurCfgDefListen=ripCurCfgDefListen, ripCurCfgVip=ripCurCfgVip, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripStatInPkts=ripStatInPkts, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, arpInfoFlag=arpInfoFlag, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumRxDatabase=ospfCumRxDatabase, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfInterface=ospfInterface, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrp_info=vrrp_info, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, routeStats=routeStats, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ip_info=ip_info, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumIntfDown=ospfCumIntfDown, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumIntfUnloop=ospfCumIntfUnloop, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripConfig=ripConfig, ipCurCfgGwTable=ipCurCfgGwTable, routerLSALinkIndex=routerLSALinkIndex, ripCurCfgListen=ripCurCfgListen, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfLoop=ospfIntfLoop, vrrp=vrrp, ospfIntfNbrhello=ospfIntfNbrhello, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgBootpState=ipCurCfgBootpState, routerLSALinkID=routerLSALinkID, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfinfo=ospfinfo, ospfCumNbrStart=ospfCumNbrStart, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpIfTableMaxSize=vrrpIfTableMaxSize, routeStatMaxEntries=routeStatMaxEntries, ripNewCfgState=ripNewCfgState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumRxlsUpdates=ospfCumRxlsUpdates, iprouting=iprouting, ospfStartTime=ospfStartTime, arpStatEntries=arpStatEntries, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipRouteInfoInterface=ipRouteInfoInterface, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCfg=ospfCfg, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipGatewayTableMax=ipGatewayTableMax, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpStatInAdvers=vrrpStatInAdvers, vrrpGeneral=vrrpGeneral, ospfGeneral=ospfGeneral, ospfRangeTableMaxSize=ospfRangeTableMaxSize, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripNewCfgVip=ripNewCfgVip, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumNbrDown=ospfCumNbrDown, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpOper=vrrpOper, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfRxHello=ospfIntfRxHello, arpInfoVLAN=arpInfoVLAN, ospfLsTypesSupported=ospfLsTypesSupported, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfTotalAreas=ospfTotalAreas, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaTxHello=ospfAreaTxHello, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaTxPkts=ospfAreaTxPkts)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfTxHello=ospfIntfTxHello, ospfIntfNbrN1way=ospfIntfNbrN1way, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfNbrInInitState=ospfNbrInInitState, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumNbrhello=ospfCumNbrhello, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIfWaitInterval=ospfIfWaitInterval, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfGeneralStats=ospfGeneralStats, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, arpStats=arpStats, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipNewCfgGwAddr=ipNewCfgGwAddr, ipForward=ipForward, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipRouteInfoTag=ipRouteInfoTag, ripStats=ripStats, ipNewCfgGwEntry=ipNewCfgGwEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgIntfEntry=ipNewCfgIntfEntry, arpInfoRefPorts=arpInfoRefPorts, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfRxPkts=ospfIntfRxPkts, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfDown=ospfIntfDown, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfBackup=ospfIntfBackup, ospfIntfHello=ospfIntfHello, routerLSAId=routerLSAId, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfWaitTimer=ospfIntfWaitTimer, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, arpInfoDestIp=arpInfoDestIp, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumRxHello=ospfCumRxHello, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipRouteInfoIndx=ipRouteInfoIndx, routerLSALinkData=routerLSALinkData, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgGenState=vrrpCurCfgGenState, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgGwState=ipNewCfgGwState, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfArea=ospfArea, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfUnloop=ospfIntfUnloop, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, arpInfoMacAddr=arpInfoMacAddr, dnsStats=dnsStats, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ripNewCfgDefListen=ripNewCfgDefListen, ipRouteInfoType=ipRouteInfoType, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgIntfState=ipNewCfgIntfState, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ripStatInErrorPkts=ripStatInErrorPkts, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIfInfoIndex=ospfIfInfoIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaChangeStats=ospfAreaChangeStats, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfInfoEntry=ospfIntfInfoEntry, ipInterfaceTableMax=ipInterfaceTableMax, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgGwIndex=ipCurCfgGwIndex, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfProcessUptime=ospfProcessUptime, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgGwState=ipCurCfgGwState)
