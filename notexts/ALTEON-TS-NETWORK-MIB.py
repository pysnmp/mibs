...
iso, TimeTicks, Gauge32, NotificationType, ModuleIdentity, MibIdentifier, Integer32, IpAddress, Counter64, ObjectIdentity, Bits, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "Gauge32", "NotificationType", "ModuleIdentity", "MibIdentifier", "Integer32", "IpAddress", "Counter64", "ObjectIdentity", "Bits", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfIndex=ospfIntfIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfTotalAreas=ospfTotalAreas, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfTotalNeighbours=ospfTotalNeighbours, arpStatEntries=arpStatEntries, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfUnloop=ospfIntfUnloop, vrrpStatInAdvers=vrrpStatInAdvers, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipRouteInfoGateway=ipRouteInfoGateway, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfBackup=ospfIntfBackup, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ripNewCfgListen=ripNewCfgListen, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfChangeStats=ospfIntfChangeStats, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfinfo=ospfinfo, ipCurCfgBootpState=ipCurCfgBootpState, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgIntfMask=ipNewCfgIntfMask, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, arpInfoEntry=arpInfoEntry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, arpInfoDestIp=arpInfoDestIp, ospfCurCfgAreaId=ospfCurCfgAreaId, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipRouteInfoIndx=ipRouteInfoIndx, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, routerLSAAreaIndex=routerLSAAreaIndex, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfRxPkts=ospfIntfRxPkts, ripConfig=ripConfig, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfProcessUptime=ospfProcessUptime, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, dnsStats=dnsStats, ripCurCfgSupply=ripCurCfgSupply, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfStartTime=ospfStartTime, vrrpOper=vrrpOper, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaNbrIndex=ospfAreaNbrIndex, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfNbrInFullState=ospfNbrInFullState, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrp=vrrp, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipForward=ipForward, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, arpInfoSrcPort=arpInfoSrcPort, ospfAreaInfoTable=ospfAreaInfoTable, ipRouteInfoMask=ipRouteInfoMask, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgIntfState=ipNewCfgIntfState, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCfg=ospfCfg, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgGwVlan=ipNewCfgGwVlan, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, routeStats=routeStats, ospfAreaNbrhello=ospfAreaNbrhello, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumNbrhello=ospfCumNbrhello, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfNbrInInitState=ospfNbrInInitState, ripNewCfgState=ripNewCfgState, ipCurCfgGwState=ipCurCfgGwState, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaRxHello=ospfAreaRxHello, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfInterface=ospfInterface, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripStats=ripStats, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, arpInfoRefPorts=arpInfoRefPorts, routerLSAId=routerLSAId, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ripStatOutPkts=ripStatOutPkts, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ip_info=ip_info, ipRouteInfoInterface=ipRouteInfoInterface, routerLSALinkID=routerLSALinkID, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumRxDatabase=ospfCumRxDatabase, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumTxPkts=ospfCumTxPkts, ospfAreaTxDatabase=ospfAreaTxDatabase)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgGwEntry=ipCurCfgGwEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgGwInterval=ipCurCfgGwInterval, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaIntfDown=ospfAreaIntfDown, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgGwAddr=ipCurCfgGwAddr, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, arpInfoTable=arpInfoTable, arpStats=arpStats, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrp_info=vrrp_info, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripCurCfgState=ripCurCfgState, iprouting=iprouting, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ripStatInPkts=ripStatInPkts, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfArea=ospfArea, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgGwArp=ipNewCfgGwArp, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfTableMaxSize=ospfIntfTableMaxSize, arpInfoVLAN=arpInfoVLAN, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaInfoId=ospfAreaInfoId, ospfAreaRxlsAcks=ospfAreaRxlsAcks, arpStatHighWater=arpStatHighWater, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfGeneralStats=ospfGeneralStats, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfNbrInExchState=ospfNbrInExchState, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, arpInfoMacAddr=arpInfoMacAddr, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ripCurCfgVip=ripCurCfgVip, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgGwIndex=ipNewCfgGwIndex, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpStats=vrrpStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfGeneral=ospfGeneral, ipNewCfgGwState=ipNewCfgGwState, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, arpInfoFlag=arpInfoFlag, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumRxPkts=ospfCumRxPkts, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfGeneralInfo=ospfGeneralInfo, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfStats=ospfStats, ospfAreaRxTxStats=ospfAreaRxTxStats, routerLSALinkIndex=routerLSALinkIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfRxHello=ospfIntfRxHello, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpGeneral=vrrpGeneral, ospfCumIntfDown=ospfCumIntfDown, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaChangeStats=ospfAreaChangeStats, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgGwRetry=ipNewCfgGwRetry, routerLSALinkData=routerLSALinkData, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipGatewayTableMax=ipGatewayTableMax, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipRouteInfoType=ipRouteInfoType, ospfIntfTxHello=ospfIntfTxHello, ospfIntfHello=ospfIntfHello, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry)
