...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaRxPkts=ospfAreaRxPkts, dnsStats=dnsStats, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfNbrhello=ospfIntfNbrhello, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumNbrStart=ospfCumNbrStart, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ripNewCfgSupply=ripNewCfgSupply, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgIntfState=ipNewCfgIntfState, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgGwTable=ipCurCfgGwTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIfInfoIndex=ospfIfInfoIndex, ipRouteInfoTag=ipRouteInfoTag, ripCurCfgState=ripCurCfgState, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfChangeStats=ospfIntfChangeStats, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrp_info=vrrp_info, routerLSAId=routerLSAId, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgGwEntry=ipCurCfgGwEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfGeneral=ospfGeneral, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfProcessUptime=ospfProcessUptime, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumNbrhello=ospfCumNbrhello, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgGwState=ipCurCfgGwState, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ripStatInPkts=ripStatInPkts, ospfIntfHello=ospfIntfHello, ripCurCfgVip=ripCurCfgVip, ospfCumTxPkts=ospfCumTxPkts, arpInfoFlag=arpInfoFlag, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaInfoId=ospfAreaInfoId, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, routeStats=routeStats, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgGwMetric=ipCurCfgGwMetric, ipCurCfgGwInterval=ipCurCfgGwInterval, arpInfoRefPorts=arpInfoRefPorts, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCumNbrRstAd=ospfCumNbrRstAd, arpInfoSrcPort=arpInfoSrcPort, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpOper=vrrpOper, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfUnloop=ospfIntfUnloop, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripStatOutPkts=ripStatOutPkts, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfTotalNeighbours=ospfTotalNeighbours, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumRxHello=ospfCumRxHello, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ripCurCfgSupply=ripCurCfgSupply, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCfg=ospfCfg, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfLoop=ospfIntfLoop, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaTableMaxSize=ospfAreaTableMaxSize, arpStats=arpStats, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ripStats=ripStats, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, arpStatHighWater=arpStatHighWater, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIfWaitInterval=ospfIfWaitInterval, arpInfoEntry=arpInfoEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumNbrDown=ospfCumNbrDown, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgIntfIndex=ipCurCfgIntfIndex, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipRouteInfoMask=ipRouteInfoMask, ipRouteInfoType=ipRouteInfoType, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfTxHello=ospfIntfTxHello, ipForward=ipForward, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfGeneralInfo=ospfGeneralInfo, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, routeStatMaxEntries=routeStatMaxEntries, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ripConfig=ripConfig, arpInfoTable=arpInfoTable, ospfCumIntfDown=ospfCumIntfDown, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfNbrInInitState=ospfNbrInInitState, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripCurCfgListen=ripCurCfgListen, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgBootpState=ipNewCfgBootpState, ripNewCfgVip=ripNewCfgVip, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgIntfState=ipCurCfgIntfState, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, arpInfoMacAddr=arpInfoMacAddr, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrp=vrrp, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfArea=ospfArea, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, routerLSALinkID=routerLSALinkID, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgGwTable=ipNewCfgGwTable, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpStats=vrrpStats, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaIntfIndex=ospfAreaIntfIndex, arpInfoVLAN=arpInfoVLAN, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfinfo=ospfinfo, ospfIntfBackup=ospfIntfBackup, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpStatInAdvers=vrrpStatInAdvers, ospfNbrInExchState=ospfNbrInExchState, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfRxHello=ospfIntfRxHello, ospfAreaNbrDown=ospfAreaNbrDown, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpGeneral=vrrpGeneral, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaNbrStart=ospfAreaNbrStart, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipNewCfgGwState=ipNewCfgGwState, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfCountForRouter=ospfIntfCountForRouter, routeStatEntries=routeStatEntries, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipRouteInfoDestIp=ipRouteInfoDestIp, arpStatEntries=arpStatEntries, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaIntfHello=ospfAreaIntfHello, ospfCurCfgAreaId=ospfCurCfgAreaId, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, iprouting=iprouting, ospfGeneralStats=ospfGeneralStats, ospfAreaTxHello=ospfAreaTxHello, ospfCumTxHello=ospfCumTxHello, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipRouteInfoTable=ipRouteInfoTable, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfTotalAreas=ospfTotalAreas, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfNbrChange=ospfIntfNbrChange, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, routerLSALinkData=routerLSALinkData, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ip_info=ip_info, ospfStats=ospfStats, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgGwDelete=ipNewCfgGwDelete, routeStatHighWater=routeStatHighWater, ospfAreaTxPkts=ospfAreaTxPkts, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone)
