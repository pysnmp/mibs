...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpStats=vrrpStats, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, arpStatEntries=arpStatEntries, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumIntfBackup=ospfCumIntfBackup, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfHello=ospfIntfHello, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumNbrStart=ospfCumNbrStart, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, routerLSAId=routerLSAId, arpStatMaxEntries=arpStatMaxEntries, ospfAreaRxPkts=ospfAreaRxPkts, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, iprouting=iprouting, routeStats=routeStats, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfNbrInExchState=ospfNbrInExchState, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrp_info=vrrp_info, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, arpInfoMacAddr=arpInfoMacAddr, ospfCumNbrDown=ospfCumNbrDown, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgGwRetry=ipNewCfgGwRetry, ripConfig=ripConfig, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaInfoTable=ospfAreaInfoTable, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCumNbrN1way=ospfCumNbrN1way, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgBootpState=ipCurCfgBootpState, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipForward=ipForward, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, arpInfoFlag=arpInfoFlag, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumIntfDown=ospfCumIntfDown, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfStats=ospfStats, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ripNewCfgSupply=ripNewCfgSupply, ripCurCfgListen=ripCurCfgListen, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaNbrN1way=ospfAreaNbrN1way, ripStats=ripStats, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumTxDatabase=ospfCumTxDatabase, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfTxDatabase=ospfIntfTxDatabase, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumRxTxStats=ospfCumRxTxStats, dnsStats=dnsStats, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, arpInfoEntry=arpInfoEntry, ospfIntfNbrChange=ospfIntfNbrChange, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, routeStatEntries=routeStatEntries, vrrpOper=vrrpOper, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfUnloop=ospfIntfUnloop, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfTxHello=ospfIntfTxHello, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ripStatInPkts=ripStatInPkts, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumRxPkts=ospfCumRxPkts, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumTxHello=ospfCumTxHello, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumTxPkts=ospfCumTxPkts, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaIntfDown=ospfAreaIntfDown, ospfinfo=ospfinfo, routerLSAAreaIndex=routerLSAAreaIndex, ripCurCfgSupply=ripCurCfgSupply, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgGwState=ipNewCfgGwState, ospfAreaIntfHello=ospfAreaIntfHello, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfWaitTimer=ospfIntfWaitTimer, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgGwState=ipCurCfgGwState, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfGeneralStats=ospfGeneralStats, ospfAreaChangeStats=ospfAreaChangeStats, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, routerLSALinkData=routerLSALinkData, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ripNewCfgDefListen=ripNewCfgDefListen, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ripStatInErrorPkts=ripStatInErrorPkts, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ripNewCfgListen=ripNewCfgListen, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfGeneral=ospfGeneral, ospfAreaRxHello=ospfAreaRxHello, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, arpStats=arpStats, ipRouteInfoEntry=ipRouteInfoEntry, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgIntfVlan=ipNewCfgIntfVlan, arpInfoTable=arpInfoTable, ipRouteInfoMask=ipRouteInfoMask, ospfIntfDown=ospfIntfDown, ospfCfg=ospfCfg, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfArea=ospfArea, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipFwdNewCfgState=ipFwdNewCfgState, ospfInterface=ospfInterface, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipRouteInfoTable=ipRouteInfoTable, ospfCumNbrRstAd=ospfCumNbrRstAd, routeStatHighWater=routeStatHighWater, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaTxHello=ospfAreaTxHello, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, arpInfoDestIp=arpInfoDestIp, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipRouteInfoTag=ipRouteInfoTag, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfRxHello=ospfIntfRxHello, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCumNbrhello=ospfCumNbrhello, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ip_info=ip_info, ospfIntfNbrDown=ospfIntfNbrDown, ospfStartTime=ospfStartTime, ospfIfWaitInterval=ospfIfWaitInterval, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrp=vrrp, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfTotalNeighbours=ospfTotalNeighbours, ospfProcessUptime=ospfProcessUptime, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaRxTxStats=ospfAreaRxTxStats, routeStatMaxEntries=routeStatMaxEntries, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumIntfHello=ospfCumIntfHello, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfTxPkts=ospfIntfTxPkts, ripStatOutPkts=ripStatOutPkts, ospfCumRxHello=ospfCumRxHello, ripCurCfgVip=ripCurCfgVip, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaNbrStart=ospfAreaNbrStart, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipRouteInfoType=ipRouteInfoType, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipRouteInfoIndx=ipRouteInfoIndx)
