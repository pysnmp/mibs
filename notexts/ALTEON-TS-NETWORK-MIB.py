...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfHello=ospfIntfHello, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfTotalNeighbours=ospfTotalNeighbours, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, routeStatEntries=routeStatEntries, ospfGeneral=ospfGeneral, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, iprouting=iprouting, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaChangeStats=ospfAreaChangeStats, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ripCurCfgVip=ripCurCfgVip, arpStatMaxEntries=arpStatMaxEntries, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, routeStats=routeStats, ospfGeneralInfo=ospfGeneralInfo, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfRxPkts=ospfIntfRxPkts, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, routerLSALinkData=routerLSALinkData, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfTxHello=ospfIntfTxHello, ospfIntfInfoTable=ospfIntfInfoTable, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumNbrBadRequests=ospfCumNbrBadRequests, routerLSAId=routerLSAId, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumNbrStart=ospfCumNbrStart, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ripCurCfgState=ripCurCfgState, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgIntfTable=ipNewCfgIntfTable, routeStatMaxEntries=routeStatMaxEntries, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfNbrChange=ospfIntfNbrChange, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ip_info=ip_info, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgGwState=ipNewCfgGwState, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ripCurCfgSupply=ripCurCfgSupply, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfRxHello=ospfIntfRxHello, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, arpInfoTable=arpInfoTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCumIntfHello=ospfCumIntfHello, ipRouteInfoTag=ipRouteInfoTag, ospfinfo=ospfinfo, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, arpInfoRefPorts=arpInfoRefPorts, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfTableMaxSize=ospfIntfTableMaxSize, arpInfoDestIp=arpInfoDestIp, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCumTxHello=ospfCumTxHello, ospfIntfDown=ospfIntfDown, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipNewCfgBootpAddr=ipNewCfgBootpAddr, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaRxTxStats=ospfAreaRxTxStats, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgGwState=ipCurCfgGwState, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrp=vrrp, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaIntfDown=ospfAreaIntfDown, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfInfoEntry=ospfIntfInfoEntry, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpStatInAdvers=vrrpStatInAdvers, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfInterface=ospfInterface, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, arpInfoEntry=arpInfoEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipInterfaceTableMax=ipInterfaceTableMax, ripNewCfgVip=ripNewCfgVip, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgGwIndex=ipNewCfgGwIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfNbrInFullState=ospfNbrInFullState, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipCurCfgBootpState=ipCurCfgBootpState, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, routeStatHighWater=routeStatHighWater, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ripCurCfgDefListen=ripCurCfgDefListen, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipRouteInfoTable=ipRouteInfoTable, ospfStats=ospfStats)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfBackup=ospfIntfBackup, arpStats=arpStats, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfArea=ospfArea, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfNewCfgAreaTable=ospfNewCfgAreaTable, arpStatHighWater=arpStatHighWater, ospfCumIntfLoop=ospfCumIntfLoop, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumNbrDown=ospfCumNbrDown, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ripCurCfgListen=ripCurCfgListen, ospfNbrInInitState=ospfNbrInInitState, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfLsTypesSupported=ospfLsTypesSupported, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipRouteInfoGateway=ipRouteInfoGateway, ipRouteInfoDestIp=ipRouteInfoDestIp, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrp_info=vrrp_info, ipForward=ipForward, ipRouteInfoMask=ipRouteInfoMask, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, arpInfoSrcPort=arpInfoSrcPort, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfNbrInExchState=ospfNbrInExchState, ripStatOutPkts=ripStatOutPkts, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgGwArp=ipNewCfgGwArp, routerLSALinkIndex=routerLSALinkIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ripStats=ripStats, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, dnsStats=dnsStats, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ripNewCfgState=ripNewCfgState, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaRxHello=ospfAreaRxHello, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, arpStatEntries=arpStatEntries, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCumTxlsAcks=ospfCumTxlsAcks, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, arpInfoFlag=arpInfoFlag, ospfCumTxDatabase=ospfCumTxDatabase, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumRxDatabase=ospfCumRxDatabase, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ripConfig=ripConfig, vrrpGeneral=vrrpGeneral, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfLoop=ospfIntfLoop, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaIntfHello=ospfAreaIntfHello, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumRxPkts=ospfCumRxPkts, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaNbrDown=ospfAreaNbrDown, ipGatewayTableMax=ipGatewayTableMax, ospfCumTxPkts=ospfCumTxPkts, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipRouteInfoIndx=ipRouteInfoIndx, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripNewCfgDefListen=ripNewCfgDefListen, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaNbrhello=ospfAreaNbrhello, vrrpOper=vrrpOper, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ripStatInPkts=ripStatInPkts, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgGwRetry=ipNewCfgGwRetry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx)
