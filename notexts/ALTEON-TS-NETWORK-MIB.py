...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfBackup=ospfIntfBackup, ospfProcessUptime=ospfProcessUptime, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ripNewCfgState=ripNewCfgState, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, arpInfoSrcPort=arpInfoSrcPort, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIfInfoIndex=ospfIfInfoIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, routeStatEntries=routeStatEntries, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgBootpState=ipNewCfgBootpState, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, iprouting=iprouting, ospfCumNbrStart=ospfCumNbrStart, ospfIntfChangeStats=ospfIntfChangeStats, ospfTotalAreas=ospfTotalAreas, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, routerLSAId=routerLSAId, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, routeStats=routeStats, ripNewCfgVip=ripNewCfgVip, ipRouteInfoInterface=ipRouteInfoInterface, ipCurCfgGwState=ipCurCfgGwState, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgGwAddr=ipNewCfgGwAddr, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumIntfHello=ospfCumIntfHello, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfArea=ospfArea, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfNbrInFullState=ospfNbrInFullState, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrp_info=vrrp_info, arpInfoDestIp=arpInfoDestIp, ospfCumIntfDown=ospfCumIntfDown, ripConfig=ripConfig, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripCurCfgSupply=ripCurCfgSupply, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, arpInfoRefPorts=arpInfoRefPorts, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaIntfIndex=ospfAreaIntfIndex, routerLSALinkData=routerLSALinkData, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfNbrStart=ospfIntfNbrStart, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaInfoId=ospfAreaInfoId, vrrpGeneral=vrrpGeneral, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfStartTime=ospfStartTime, ipCurCfgGwTable=ipCurCfgGwTable, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfNbrInInitState=ospfNbrInInitState, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfUnloop=ospfIntfUnloop, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ripCurCfgVip=ripCurCfgVip, ospfIntfDown=ospfIntfDown, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ripStatInPkts=ripStatInPkts, arpStatMaxEntries=arpStatMaxEntries, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfLoop=ospfIntfLoop, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipRouteInfoDestIp=ipRouteInfoDestIp, dnsStats=dnsStats, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgGwEntry=ipNewCfgGwEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgBootpState=ipCurCfgBootpState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfTxPkts=ospfIntfTxPkts, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ripStatOutPkts=ripStatOutPkts, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, arpStats=arpStats, ospfCumRxHello=ospfCumRxHello, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipForward=ipForward, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfTxDatabase=ospfIntfTxDatabase, arpStatEntries=arpStatEntries, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, routerLSALinkID=routerLSALinkID, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ripNewCfgDefListen=ripNewCfgDefListen, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipFwdCurCfgState=ipFwdCurCfgState, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripNewCfgSupply=ripNewCfgSupply, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpOper=vrrpOper, ospfNbrInExchState=ospfNbrInExchState, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfGeneralInfo=ospfGeneralInfo, ospfAreaIntfDown=ospfAreaIntfDown, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, arpInfoTable=arpInfoTable, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaIntfBackup=ospfAreaIntfBackup, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaRxPkts=ospfAreaRxPkts, ospfNewCfgAreaId=ospfNewCfgAreaId, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipRouteInfoMask=ipRouteInfoMask, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, arpInfoVLAN=arpInfoVLAN, ospfCumNbrDown=ospfCumNbrDown, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, arpStatHighWater=arpStatHighWater, ospfIntfTxHello=ospfIntfTxHello, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumTxDatabase=ospfCumTxDatabase, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipGatewayTableMax=ipGatewayTableMax, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrp=vrrp, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, arpInfoEntry=arpInfoEntry, ospfIntfHello=ospfIntfHello, ipRouteInfoTag=ipRouteInfoTag, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCfg=ospfCfg, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfGeneral=ospfGeneral, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipRouteInfoType=ipRouteInfoType, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpStatOutAdvers=vrrpStatOutAdvers, ripStats=ripStats, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCumTxPkts=ospfCumTxPkts, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIfWaitInterval=ospfIfWaitInterval, ip_info=ip_info, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfInterface=ospfInterface, ipNewCfgGwState=ipNewCfgGwState, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, ipRouteInfoTable=ipRouteInfoTable, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfStats=ospfStats, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt)
