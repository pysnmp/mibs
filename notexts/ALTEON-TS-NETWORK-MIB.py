...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpInfoSrcPort=arpInfoSrcPort, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrp=vrrp, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ripNewCfgListen=ripNewCfgListen, ipRouteInfoMask=ipRouteInfoMask, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, arpStats=arpStats, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumNbrDown=ospfCumNbrDown, ospfAreaTxHello=ospfAreaTxHello, ospfAreaNbrIndex=ospfAreaNbrIndex, routerLSAId=routerLSAId, ospfIntfTxDatabase=ospfIntfTxDatabase, ip_info=ip_info, routeStats=routeStats, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfTxlsAcks=ospfIntfTxlsAcks, iprouting=iprouting, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfNbrStart=ospfIntfNbrStart, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaRxTxStats=ospfAreaRxTxStats, arpInfoEntry=arpInfoEntry, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, arpStatHighWater=arpStatHighWater, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfTotalAreas=ospfTotalAreas, ospfNbrInExchState=ospfNbrInExchState, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumTxHello=ospfCumTxHello, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumRxHello=ospfCumRxHello, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ripCurCfgState=ripCurCfgState, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIfInfoIndex=ospfIfInfoIndex, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipRouteInfoTag=ipRouteInfoTag, routerLSALinkData=routerLSALinkData, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, routeStatHighWater=routeStatHighWater, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumTxPkts=ospfCumTxPkts, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, arpStatMaxEntries=arpStatMaxEntries, ripNewCfgSupply=ripNewCfgSupply, ripStatInPkts=ripStatInPkts, ospfCumRxTxStats=ospfCumRxTxStats, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipRouteInfoIndx=ipRouteInfoIndx, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, ripCurCfgSupply=ripCurCfgSupply, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfWaitTimer=ospfIntfWaitTimer, ipRouteInfoInterface=ipRouteInfoInterface, arpStatEntries=arpStatEntries, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ripStats=ripStats, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgIntfState=ipCurCfgIntfState, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, dnsStats=dnsStats, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaTxPkts=ospfAreaTxPkts, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfBackup=ospfIntfBackup, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumIntfDown=ospfCumIntfDown, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaInfoId=ospfAreaInfoId, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfRxDatabase=ospfIntfRxDatabase, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCfg=ospfCfg, ospfAreaIntfIndex=ospfAreaIntfIndex, routerLSALinkIndex=routerLSALinkIndex, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaChangeStats=ospfAreaChangeStats, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfUnloop=ospfIntfUnloop, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfDown=ospfIntfDown, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfArea=ospfArea, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfStats=ospfStats, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ripStatOutPkts=ripStatOutPkts, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfHello=ospfIntfHello, ipCurCfgGwAddr=ipCurCfgGwAddr, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdCurCfgPortState=ipFwdCurCfgPortState)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgGwVlan=ipCurCfgGwVlan, ospfTotalNssaAreas=ospfTotalNssaAreas, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ripConfig=ripConfig, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpStatOutAdvers=vrrpStatOutAdvers, ripCurCfgVip=ripCurCfgVip, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpStatInAdvers=vrrpStatInAdvers, ospfIfWaitInterval=ospfIfWaitInterval, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfLoop=ospfIntfLoop, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfGeneral=ospfGeneral, arpInfoFlag=arpInfoFlag, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ripNewCfgVip=ripNewCfgVip, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgGwTable=ipCurCfgGwTable, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfProcessUptime=ospfProcessUptime, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaRxPkts=ospfAreaRxPkts, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfLsTypesSupported=ospfLsTypesSupported, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumNbrBadSequence=ospfCumNbrBadSequence, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ripCurCfgListen=ripCurCfgListen, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfNbrDown=ospfIntfNbrDown, routeStatEntries=routeStatEntries, ipCurCfgGwState=ipCurCfgGwState, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfTotalNeighbours=ospfTotalNeighbours, arpInfoVLAN=arpInfoVLAN, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaNbrDown=ospfAreaNbrDown, arpInfoRefPorts=arpInfoRefPorts, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgBootpState=ipNewCfgBootpState, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaRxHello=ospfAreaRxHello, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpGeneral=vrrpGeneral, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipRouteInfoType=ipRouteInfoType, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpOper=vrrpOper, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumNbrStart=ospfCumNbrStart, ospfStartTime=ospfStartTime, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCumRxPkts=ospfCumRxPkts, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgGwArp=ipNewCfgGwArp, routerLSALinkID=routerLSALinkID, ospfInterface=ospfInterface, ospfAreaInfoTable=ospfAreaInfoTable, vrrp_info=vrrp_info, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaRxDatabase=ospfAreaRxDatabase, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfTxHello=ospfIntfTxHello, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgBootpState=ipCurCfgBootpState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumRxDatabase=ospfCumRxDatabase, ipForward=ipForward, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk)
