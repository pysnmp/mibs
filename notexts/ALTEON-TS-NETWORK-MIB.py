...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpStatMaxEntries=arpStatMaxEntries, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumTxHello=ospfCumTxHello, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgBootpState=ipCurCfgBootpState, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ip_info=ip_info, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ripConfig=ripConfig, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumTxlsUpdates=ospfCumTxlsUpdates, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfRxTxStats=ospfIntfRxTxStats, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfIndex=ospfIntfIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfLoop=ospfIntfLoop, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumIntfUnloop=ospfCumIntfUnloop, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, routeStats=routeStats, ospfTotalAreas=ospfTotalAreas, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfDown=ospfIntfDown, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ripNewCfgVip=ripNewCfgVip, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, iprouting=iprouting, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, dnsStats=dnsStats, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaTxHello=ospfAreaTxHello, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ripCurCfgState=ripCurCfgState, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaNbrDown=ospfAreaNbrDown, ipRouteInfoGateway=ipRouteInfoGateway, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, arpInfoDestIp=arpInfoDestIp, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfNbrInInitState=ospfNbrInInitState, ospfNbrInFullState=ospfNbrInFullState, arpInfoFlag=arpInfoFlag, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIfInfoIndex=ospfIfInfoIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaRxHello=ospfAreaRxHello, ospfIntfWaitTimer=ospfIntfWaitTimer, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgGwState=ipNewCfgGwState, ipRouteInfoTable=ipRouteInfoTable, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfChangeStats=ospfIntfChangeStats, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgGwVlan=ipNewCfgGwVlan, ipRouteInfoInterface=ipRouteInfoInterface, ripStatInErrorPkts=ripStatInErrorPkts, ospfInterface=ospfInterface, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipCurCfgGwRetry=ipCurCfgGwRetry, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpStats=vrrpStats, arpInfoTable=arpInfoTable, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaIntfHello=ospfAreaIntfHello, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfTxPkts=ospfIntfTxPkts, ospfArea=ospfArea, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumIntfHello=ospfCumIntfHello, ripStatOutPkts=ripStatOutPkts, vrrp_info=vrrp_info, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipRouteInfoEntry=ipRouteInfoEntry, ospfStats=ospfStats, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, routerLSALinkID=routerLSALinkID, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpGeneral=vrrpGeneral, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, routerLSALinkIndex=routerLSALinkIndex, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, arpStatEntries=arpStatEntries, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumRxlsUpdates=ospfCumRxlsUpdates)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpOper=vrrpOper, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripNewCfgState=ripNewCfgState, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfNbrInExchState=ospfNbrInExchState, ospfIntfHello=ospfIntfHello, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, routerLSALinkData=routerLSALinkData, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrp=vrrp, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfinfo=ospfinfo, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaInfoId=ospfAreaInfoId, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumRxPkts=ospfCumRxPkts, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfTxHello=ospfIntfTxHello, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfGeneral=ospfGeneral, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfNbrDown=ospfIntfNbrDown, ipGatewayTableMax=ipGatewayTableMax, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgGwAddr=ipNewCfgGwAddr, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, arpInfoEntry=arpInfoEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, routeStatEntries=routeStatEntries, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCumNbrDown=ospfCumNbrDown, ipForward=ipForward, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, arpInfoSrcPort=arpInfoSrcPort, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgGwState=ipCurCfgGwState, ripNewCfgSupply=ripNewCfgSupply, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ripStats=ripStats, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumNbrStart=ospfCumNbrStart, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfRxDatabase=ospfIntfRxDatabase, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfBackup=ospfIntfBackup, ospfCumIntfDown=ospfCumIntfDown, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgGwArp=ipCurCfgGwArp, arpInfoMacAddr=arpInfoMacAddr, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, arpStats=arpStats, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaNbrStart=ospfAreaNbrStart, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipRouteInfoTag=ipRouteInfoTag, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfUnloop=ospfIntfUnloop, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, routeStatHighWater=routeStatHighWater, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumTxlsReqs=ospfCumTxlsReqs, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipRouteInfoMask=ipRouteInfoMask, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripCurCfgVip=ripCurCfgVip, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ripCurCfgDefListen=ripCurCfgDefListen, ripStatRoutesAgedOut=ripStatRoutesAgedOut, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics)
