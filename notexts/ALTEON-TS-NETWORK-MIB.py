...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfGeneral=ospfGeneral, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipCurCfgGwArp=ipCurCfgGwArp, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumIntfLoop=ospfCumIntfLoop, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfNbrhello=ospfIntfNbrhello, ipRouteInfoTag=ipRouteInfoTag, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgGwTable=ipCurCfgGwTable, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, dnsStats=dnsStats, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgIntfState=ipNewCfgIntfState, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfGeneralInfo=ospfGeneralInfo, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgGwAddr=ipCurCfgGwAddr, ripNewCfgListen=ripNewCfgListen, ospfIntfTableMaxSize=ospfIntfTableMaxSize, routeStatHighWater=routeStatHighWater, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, arpInfoDestIp=arpInfoDestIp, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfHostTableMaxSize=ospfHostTableMaxSize, ripStatOutPkts=ripStatOutPkts, ospfIntfLoop=ospfIntfLoop, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaRxPkts=ospfAreaRxPkts, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIfWaitInterval=ospfIfWaitInterval, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfInterface=ospfInterface, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgIntfState=ipCurCfgIntfState, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpOper=vrrpOper, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ripCurCfgListen=ripCurCfgListen, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaInfoIndex=ospfAreaInfoIndex, routeStatEntries=routeStatEntries, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfDown=ospfIntfDown, ripStatInPkts=ripStatInPkts, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumRxHello=ospfCumRxHello, routerLSALinkID=routerLSALinkID, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaTxHello=ospfAreaTxHello, ospfCfg=ospfCfg, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfNbrInFullState=ospfNbrInFullState, ripNewCfgVip=ripNewCfgVip, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumTxHello=ospfCumTxHello, vrrpStatInAdvers=vrrpStatInAdvers, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumNbrDown=ospfCumNbrDown, ospfAreaNbrhello=ospfAreaNbrhello, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ripCurCfgVip=ripCurCfgVip, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfRxHello=ospfIntfRxHello, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfStats=ospfStats, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumNbrhello=ospfCumNbrhello, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfTotalAreas=ospfTotalAreas, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfinfo=ospfinfo, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfTimersKickOffStats=ospfTimersKickOffStats, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpStats=vrrpStats, ospfAreaIntfHello=ospfAreaIntfHello, iprouting=iprouting, ipCurCfgIntfMask=ipCurCfgIntfMask)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ripCurCfgState=ripCurCfgState, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, arpInfoRefPorts=arpInfoRefPorts, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfUnloop=ospfIntfUnloop, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipFwdNewCfgState=ipFwdNewCfgState, ospfNbrInInitState=ospfNbrInInitState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaInfoId=ospfAreaInfoId, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfRxTxStats=ospfIntfRxTxStats, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumIntfDown=ospfCumIntfDown, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgGwState=ipNewCfgGwState, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, arpInfoMacAddr=arpInfoMacAddr, ipForward=ipForward, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaIntfBackup=ospfAreaIntfBackup, arpInfoFlag=arpInfoFlag, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfIndex=ospfIntfIndex, ipRouteInfoIndx=ipRouteInfoIndx, routeStatMaxEntries=routeStatMaxEntries, ospfIntfTxHello=ospfIntfTxHello, ospfCumTxDatabase=ospfCumTxDatabase, ipRouteInfoType=ipRouteInfoType, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfBackup=ospfIntfBackup, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrp_info=vrrp_info, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfInfoTable=ospfIntfInfoTable, ripCurCfgSupply=ripCurCfgSupply, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaChangeStats=ospfAreaChangeStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, arpStats=arpStats, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfStartTime=ospfStartTime, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ripNewCfgSupply=ripNewCfgSupply, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumRxTxStats=ospfCumRxTxStats, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfCountForRouter=ospfIntfCountForRouter, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrp=vrrp, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, routeStats=routeStats, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipNewCfgIntfIndex=ipNewCfgIntfIndex, arpStatHighWater=arpStatHighWater, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripNewCfgState=ripNewCfgState, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, arpStatEntries=arpStatEntries, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfGeneralStats=ospfGeneralStats, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCurCfgAreaId=ospfCurCfgAreaId, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfProcessUptime=ospfProcessUptime, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfTotalNssaAreas=ospfTotalNssaAreas, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, arpInfoEntry=arpInfoEntry, arpInfoVLAN=arpInfoVLAN, ipCurCfgGwVlan=ipCurCfgGwVlan, ip_info=ip_info, ripStats=ripStats, ipNewCfgGwArp=ipNewCfgGwArp, ripCurCfgDefListen=ripCurCfgDefListen, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfArea=ospfArea, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfTxPkts=ospfIntfTxPkts, ipNewCfgIntfMask=ipNewCfgIntfMask, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, routerLSALinkIndex=routerLSALinkIndex, ripConfig=ripConfig, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone)
