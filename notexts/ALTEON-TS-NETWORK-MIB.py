...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfTotalTransitAreas=ospfTotalTransitAreas, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpOper=vrrpOper, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumTxHello=ospfCumTxHello, arpInfoTable=arpInfoTable, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfStats=ospfStats, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgGenState=vrrpNewCfgGenState, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfGeneralStats=ospfGeneralStats, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipRouteInfoGateway=ipRouteInfoGateway, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumNbrN1way=ospfCumNbrN1way, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipRouteInfoTable=ipRouteInfoTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfNbrhello=ospfIntfNbrhello, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ripStatOutPkts=ripStatOutPkts, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfHello=ospfIntfHello, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaNbrIndex=ospfAreaNbrIndex, routeStatHighWater=routeStatHighWater, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgIntfDelete=ipNewCfgIntfDelete, routerLSAId=routerLSAId, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdCurCfgState=ipFwdCurCfgState, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfIndex=ospfIntfIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrp_info=vrrp_info, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ripStatInPkts=ripStatInPkts, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfinfo=ospfinfo, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipForward=ipForward, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfDown=ospfIntfDown, ospfTotalAreas=ospfTotalAreas, ipCurCfgBootpState=ipCurCfgBootpState, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ripCurCfgVip=ripCurCfgVip, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumTxPkts=ospfCumTxPkts, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ripNewCfgState=ripNewCfgState, ipNewCfgGwState=ipNewCfgGwState, routerLSALinkID=routerLSALinkID, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipRouteInfoType=ipRouteInfoType, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaIntfHello=ospfAreaIntfHello, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfArea=ospfArea, ipNewCfgGwEntry=ipNewCfgGwEntry, ipRouteInfoMask=ipRouteInfoMask, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, arpStatEntries=arpStatEntries, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, arpInfoSrcPort=arpInfoSrcPort, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrp=vrrp, dnsStats=dnsStats, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, arpStats=arpStats, routeStatEntries=routeStatEntries, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfRxHello=ospfIntfRxHello, ipRouteInfoTag=ipRouteInfoTag, ospfIntfNbrChange=ospfIntfNbrChange, ospfProcessUptime=ospfProcessUptime, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfStartTime=ospfStartTime, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaInfoIndex=ospfAreaInfoIndex, arpStatMaxEntries=arpStatMaxEntries, ospfCumIntfChangeStats=ospfCumIntfChangeStats, routeStats=routeStats, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumNbrStart=ospfCumNbrStart, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaInfoId=ospfAreaInfoId, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfTotalNssaAreas=ospfTotalNssaAreas, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, arpInfoMacAddr=arpInfoMacAddr, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIfInfoIndex=ospfIfInfoIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripStats=ripStats, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ripNewCfgListen=ripNewCfgListen, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, arpInfoFlag=arpInfoFlag, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumRxHello=ospfCumRxHello, ripCurCfgSupply=ripCurCfgSupply, ospfGeneral=ospfGeneral, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumRxPkts=ospfCumRxPkts, ip_info=ip_info, vrrpGeneral=vrrpGeneral, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaRxHello=ospfAreaRxHello, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfInterface=ospfInterface, ipNewCfgGwRetry=ipNewCfgGwRetry, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgGwDelete=ipNewCfgGwDelete, arpInfoRefPorts=arpInfoRefPorts, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCfg=ospfCfg, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaChangeStats=ospfAreaChangeStats, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumRxTxStats=ospfCumRxTxStats, ripConfig=ripConfig, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCumTxlsAcks=ospfCumTxlsAcks, ripCurCfgState=ripCurCfgState, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgGwArp=ipNewCfgGwArp, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, iprouting=iprouting, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipCurCfgGwVlan=ipCurCfgGwVlan, routeStatMaxEntries=routeStatMaxEntries, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt)
