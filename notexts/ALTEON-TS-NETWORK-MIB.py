...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfTxHello=ospfIntfTxHello, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, routerLSAAreaIndex=routerLSAAreaIndex, arpInfoVLAN=arpInfoVLAN, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaTxHello=ospfAreaTxHello, ospfIntfInfoEntry=ospfIntfInfoEntry, arpInfoTable=arpInfoTable, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, arpStatEntries=arpStatEntries, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfArea=ospfArea, ipFwdCurCfgState=ipFwdCurCfgState, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipRouteInfoTable=ipRouteInfoTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaRxPkts=ospfAreaRxPkts, iprouting=iprouting, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumNbrStart=ospfCumNbrStart, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfBackup=ospfIntfBackup, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipRouteInfoType=ipRouteInfoType, ospfAreaNbrStart=ospfAreaNbrStart, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgGwRetry=ipNewCfgGwRetry, ipRouteInfoEntry=ipRouteInfoEntry, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfNbrDown=ospfIntfNbrDown, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrp_info=vrrp_info, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaTxPkts=ospfAreaTxPkts, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ripCurCfgListen=ripCurCfgListen, ospfCumTxHello=ospfCumTxHello, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIfInfoIndex=ospfIfInfoIndex, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfLsTypesSupported=ospfLsTypesSupported, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfStartTime=ospfStartTime, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumRxPkts=ospfCumRxPkts, ripConfig=ripConfig, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipForward=ipForward, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaNbrhello=ospfAreaNbrhello, ospfTotalNssaAreas=ospfTotalNssaAreas, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ripCurCfgState=ripCurCfgState, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgGwIndex=ipNewCfgGwIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgGwIndex=ipCurCfgGwIndex, ip_info=ip_info, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfGeneralStats=ospfGeneralStats, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipNewCfgGwArp=ipNewCfgGwArp, vrrpStats=vrrpStats, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgGwState=ipCurCfgGwState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgBootpState=ipNewCfgBootpState, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfDown=ospfIntfDown, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, arpInfoMacAddr=arpInfoMacAddr, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfTotalTransitAreas=ospfTotalTransitAreas, arpStatHighWater=arpStatHighWater, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgIfTable=vrrpCurCfgIfTable, arpStats=arpStats, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgGwArp=ipCurCfgGwArp)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpStatInAdvers=vrrpStatInAdvers, routeStatHighWater=routeStatHighWater, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ripNewCfgSupply=ripNewCfgSupply, ospfAreaRxHello=ospfAreaRxHello, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ripStatInPkts=ripStatInPkts, ospfIntfIndex=ospfIntfIndex, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumRxDatabase=ospfCumRxDatabase, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ripNewCfgState=ripNewCfgState, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, routerLSALinkData=routerLSALinkData, arpStatMaxEntries=arpStatMaxEntries, ospfIntfTxlsAcks=ospfIntfTxlsAcks, routerLSAId=routerLSAId, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrp=vrrp, routeStats=routeStats, ipRouteInfoMask=ipRouteInfoMask, arpInfoSrcPort=arpInfoSrcPort, vrrpGeneral=vrrpGeneral, ospfCumNbrDown=ospfCumNbrDown, dnsStats=dnsStats, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgGwVlan=ipNewCfgGwVlan, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfUnloop=ospfIntfUnloop, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumIntfHello=ospfCumIntfHello, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgGwTable=ipNewCfgGwTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaChangeStats=ospfAreaChangeStats, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfChangeStats=ospfIntfChangeStats, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfNbrInInitState=ospfNbrInInitState, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, routerLSALinkID=routerLSALinkID, ipCurCfgIntfVlan=ipCurCfgIntfVlan, arpInfoFlag=arpInfoFlag, ospfIntfTxPkts=ospfIntfTxPkts, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaIntfHello=ospfAreaIntfHello, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfHello=ospfIntfHello, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ripStats=ripStats, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfTxDatabase=ospfIntfTxDatabase, ripNewCfgVip=ripNewCfgVip, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, routerLSALinkIndex=routerLSALinkIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ripStatInErrorPkts=ripStatInErrorPkts, vrrpOper=vrrpOper, ipNewCfgGwAddr=ipNewCfgGwAddr, arpInfoRefPorts=arpInfoRefPorts, routeStatMaxEntries=routeStatMaxEntries, ospfCumNbrN1way=ospfCumNbrN1way, ospfIfWaitInterval=ospfIfWaitInterval, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfRxHello=ospfIntfRxHello, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, arpInfoEntry=arpInfoEntry, ospfStats=ospfStats, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfLoop=ospfIntfLoop, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripCurCfgVip=ripCurCfgVip, ripNewCfgDefListen=ripNewCfgDefListen, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCfg=ospfCfg, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfinfo=ospfinfo, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipNewCfgGwState=ipNewCfgGwState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, routeStatEntries=routeStatEntries, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumTxDatabase=ospfCumTxDatabase)
