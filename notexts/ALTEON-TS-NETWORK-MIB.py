...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpStatInAdvers=vrrpStatInAdvers, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaTxlsReqs=ospfAreaTxlsReqs, routerLSALinkID=routerLSALinkID, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ripNewCfgVip=ripNewCfgVip, ipRouteInfoType=ipRouteInfoType, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgGwState=ipNewCfgGwState, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaChangeStats=ospfAreaChangeStats, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCfg=ospfCfg, ripCurCfgVip=ripCurCfgVip, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipRouteInfoGateway=ipRouteInfoGateway, ospfProcessUptime=ospfProcessUptime, ospfTotalTransitAreas=ospfTotalTransitAreas, arpInfoSrcPort=arpInfoSrcPort, ripStats=ripStats, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrp=vrrp, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, dnsStats=dnsStats, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfUnloop=ospfIntfUnloop, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfRxHello=ospfIntfRxHello, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipGatewayTableMax=ipGatewayTableMax, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfTotalAreas=ospfTotalAreas, routeStatHighWater=routeStatHighWater, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgGenState=vrrpCurCfgGenState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ripCurCfgListen=ripCurCfgListen, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfNbrInFullState=ospfNbrInFullState, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ripCurCfgSupply=ripCurCfgSupply, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ripNewCfgState=ripNewCfgState, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfVlinkCountForRouter=ospfVlinkCountForRouter, routeStats=routeStats, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipRouteInfoTable=ipRouteInfoTable, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumNbrDown=ospfCumNbrDown, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpGeneral=vrrpGeneral, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgBootpState=ipCurCfgBootpState, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, ipRouteInfoMask=ipRouteInfoMask, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaTxHello=ospfAreaTxHello, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfInfoEntry=ospfIntfInfoEntry, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipForward=ipForward, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumRxlsUpdates=ospfCumRxlsUpdates, arpInfoRefPorts=arpInfoRefPorts, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ripNewCfgSupply=ripNewCfgSupply, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfLoop=ospfIntfLoop, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfNewCfgAreaTable=ospfNewCfgAreaTable, arpInfoFlag=arpInfoFlag, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfTxHello=ospfIntfTxHello, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfStats=ospfStats, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, arpStats=arpStats, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfArea=ospfArea, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfHello=ospfIntfHello, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfBackup=ospfIntfBackup, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, routeStatEntries=routeStatEntries, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, arpInfoDestIp=arpInfoDestIp, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ripStatInPkts=ripStatInPkts, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgIntfAddr=ipNewCfgIntfAddr)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, arpStatMaxEntries=arpStatMaxEntries, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfDown=ospfIntfDown, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipCurCfgIntfState=ipCurCfgIntfState, arpInfoVLAN=arpInfoVLAN, ospfCumTxHello=ospfCumTxHello, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfNbrChange=ospfIntfNbrChange, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfChangeStats=ospfIntfChangeStats, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgIntfTable=ipCurCfgIntfTable, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaRxHello=ospfAreaRxHello, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipInterfaceTableMax=ipInterfaceTableMax, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaNbrhello=ospfAreaNbrhello, ripCurCfgState=ripCurCfgState, vrrp_info=vrrp_info, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfGeneralInfo=ospfGeneralInfo, ip_info=ip_info, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripStatOutPkts=ripStatOutPkts, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpStats=vrrpStats, ipNewCfgGwMetric=ipNewCfgGwMetric, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgGwVlan=ipNewCfgGwVlan, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfStartTime=ospfStartTime, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfNbrDown=ospfIntfNbrDown, routerLSAAreaIndex=routerLSAAreaIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ripConfig=ripConfig, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfRxlsAcks=ospfIntfRxlsAcks, arpInfoMacAddr=arpInfoMacAddr, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumRxTxStats=ospfCumRxTxStats, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, arpStatHighWater=arpStatHighWater, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, iprouting=iprouting, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaNbrDown=ospfAreaNbrDown, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumIntfLoop=ospfCumIntfLoop, arpInfoTable=arpInfoTable, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumNbrStart=ospfCumNbrStart, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, arpInfoEntry=arpInfoEntry, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgGwState=ipCurCfgGwState, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfInterface=ospfInterface, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumRxPkts=ospfCumRxPkts, ospfCumIntfHello=ospfCumIntfHello, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfTxDatabase=ospfIntfTxDatabase, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfNbrStart=ospfIntfNbrStart, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaInfoTable=ospfAreaInfoTable, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumIntfDown=ospfCumIntfDown, ospfinfo=ospfinfo, ripNewCfgListen=ripNewCfgListen, ipFwdCurCfgPortState=ipFwdCurCfgPortState, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaInfoId=ospfAreaInfoId, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfNbrInInitState=ospfNbrInInitState, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfGeneral=ospfGeneral, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaTableMaxSize=ospfAreaTableMaxSize)
