...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, arpStats=arpStats, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaIntfIndex=ospfAreaIntfIndex, ip_info=ip_info, ospfCumIntfLoop=ospfCumIntfLoop, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, routeStatMaxEntries=routeStatMaxEntries, ospfIntfDown=ospfIntfDown, ospfIntfNbrStart=ospfIntfNbrStart, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipForward=ipForward, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, iprouting=iprouting, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, routerLSALinkIndex=routerLSALinkIndex, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgGwInterval=ipCurCfgGwInterval, arpInfoFlag=arpInfoFlag, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, routerLSALinkID=routerLSALinkID, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgGwInterval=ipNewCfgGwInterval, ripNewCfgDefListen=ripNewCfgDefListen, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfTimersKickOffStats=ospfTimersKickOffStats, ipNewCfgGwState=ipNewCfgGwState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumRxHello=ospfCumRxHello, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIfWaitInterval=ospfIfWaitInterval, vrrp=vrrp, ripNewCfgListen=ripNewCfgListen, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, routeStatEntries=routeStatEntries, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpGeneral=vrrpGeneral, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, routerLSAId=routerLSAId, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgGwTable=ipNewCfgGwTable, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrp_info=vrrp_info, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgIntfTable=ipNewCfgIntfTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfGeneral=ospfGeneral, ospfAreaRxTxStats=ospfAreaRxTxStats, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumIntfDown=ospfCumIntfDown, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, arpStatMaxEntries=arpStatMaxEntries, ospfCumNbrDown=ospfCumNbrDown, ripStats=ripStats, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ripStatInPkts=ripStatInPkts, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfStats=ospfStats, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfTxDatabase=ospfIntfTxDatabase, ipCurCfgGwState=ipCurCfgGwState, ospfProcessUptime=ospfProcessUptime, dnsStats=dnsStats, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCumIntfHello=ospfCumIntfHello, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgGwMetric=ipNewCfgGwMetric, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfTotalTransitAreas=ospfTotalTransitAreas, ripConfig=ripConfig, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ripStatOutPkts=ripStatOutPkts, ipCurCfgIntfTable=ipCurCfgIntfTable, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipRouteInfoInterface=ipRouteInfoInterface, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, arpInfoVLAN=arpInfoVLAN, ospfAreaRxHello=ospfAreaRxHello, ospfinfo=ospfinfo, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpOper=vrrpOper, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaTxDatabase=ospfAreaTxDatabase, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, arpInfoTable=arpInfoTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, arpInfoSrcPort=arpInfoSrcPort, routerLSALinkData=routerLSALinkData, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIfInfoIndex=ospfIfInfoIndex, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfChangeStats=ospfIntfChangeStats, ipFwdNewCfgState=ipFwdNewCfgState, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgBootpState=ipNewCfgBootpState, ospfCfg=ospfCfg, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfGeneralStats=ospfGeneralStats, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumNbrhello=ospfCumNbrhello, ipGatewayTableMax=ipGatewayTableMax, ospfIntfNbrChange=ospfIntfNbrChange, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ripNewCfgVip=ripNewCfgVip, ospfCumTxPkts=ospfCumTxPkts, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, routeStatHighWater=routeStatHighWater, ospfIntfBackup=ospfIntfBackup, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfTotalNssaAreas=ospfTotalNssaAreas, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumRxPkts=ospfCumRxPkts, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgIntfState=ipCurCfgIntfState, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfIndex=ospfIntfIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipRouteInfoGateway=ipRouteInfoGateway, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfRxHello=ospfIntfRxHello, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumNbrStart=ospfCumNbrStart, routeStats=routeStats, ospfAreaTxHello=ospfAreaTxHello, arpInfoRefPorts=arpInfoRefPorts, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipInterfaceTableMax=ipInterfaceTableMax, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgGwArp=ipNewCfgGwArp, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfStartTime=ospfStartTime, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipRouteInfoType=ipRouteInfoType, ospfArea=ospfArea, ospfIntfHello=ospfIntfHello, ospfIntfRxDatabase=ospfIntfRxDatabase, ripCurCfgState=ripCurCfgState, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfInfoTable=ospfIntfInfoTable, vrrpStats=vrrpStats, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumRxTxStats=ospfCumRxTxStats, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfUnloop=ospfIntfUnloop, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ripNewCfgSupply=ripNewCfgSupply, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaNbrStart=ospfAreaNbrStart, ipRouteInfoEntry=ipRouteInfoEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaInfoTable=ospfAreaInfoTable, ripNewCfgState=ripNewCfgState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfInterface=ospfInterface, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrRstAd=ospfAreaNbrRstAd)
