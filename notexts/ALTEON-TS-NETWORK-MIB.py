...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfStats=ospfStats, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpGeneral=vrrpGeneral, ripStatInPkts=ripStatInPkts, ripStats=ripStats, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ripNewCfgListen=ripNewCfgListen, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumNbrhello=ospfCumNbrhello, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, arpStatEntries=arpStatEntries, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfProcessUptime=ospfProcessUptime, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumNbrStart=ospfCumNbrStart, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumIntfDown=ospfCumIntfDown, ospfAreaNbrStart=ospfAreaNbrStart, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumTxlsUpdates=ospfCumTxlsUpdates, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdCurCfgState=ipFwdCurCfgState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfNbrInFullState=ospfNbrInFullState, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfDown=ospfIntfDown, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgGwInterval=ipCurCfgGwInterval, routeStats=routeStats, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumTxDatabase=ospfCumTxDatabase, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfHello=ospfIntfHello, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumNbrDown=ospfCumNbrDown, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ripStatInErrorPkts=ripStatInErrorPkts, ripConfig=ripConfig, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfLoop=ospfIntfLoop, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgGwState=ipCurCfgGwState, ipRouteInfoEntry=ipRouteInfoEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, iprouting=iprouting, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfBackup=ospfIntfBackup, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, arpInfoDestIp=arpInfoDestIp, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumRxTxStats=ospfCumRxTxStats, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumRxlsAcks=ospfCumRxlsAcks, ipGatewayTableMax=ipGatewayTableMax, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipCurCfgBootpState=ipCurCfgBootpState, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfNbrStart=ospfIntfNbrStart, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, arpStatHighWater=arpStatHighWater, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCumRxPkts=ospfCumRxPkts, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumTxPkts=ospfCumTxPkts, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgGwState=ipNewCfgGwState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, dnsStats=dnsStats, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfCumNbrN1way=ospfCumNbrN1way, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpStatInAdvers=vrrpStatInAdvers, ripCurCfgListen=ripCurCfgListen, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfGeneralInfo=ospfGeneralInfo, ripCurCfgVip=ripCurCfgVip, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, arpInfoFlag=arpInfoFlag, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, routeStatHighWater=routeStatHighWater, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumIntfLoop=ospfCumIntfLoop, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaInfoTable=ospfAreaInfoTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfInfoTable=ospfIntfInfoTable, ripNewCfgVip=ripNewCfgVip, routerLSAId=routerLSAId, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, arpInfoEntry=arpInfoEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipRouteInfoTable=ipRouteInfoTable, arpInfoVLAN=arpInfoVLAN, ospfAreaRxHello=ospfAreaRxHello, arpInfoMacAddr=arpInfoMacAddr, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipCurCfgIntfState=ipCurCfgIntfState, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, arpStats=arpStats, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfNbrInExchState=ospfNbrInExchState, ipFwdCurCfgPortState=ipFwdCurCfgPortState, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumRxHello=ospfCumRxHello, ospfArea=ospfArea, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfTxPkts=ospfIntfTxPkts, ospfIfInfoIndex=ospfIfInfoIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumTxHello=ospfCumTxHello, ipCurCfgGwArp=ipCurCfgGwArp, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripCurCfgDefListen=ripCurCfgDefListen, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfIndex=ospfIntfIndex, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrp_info=vrrp_info, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaTxHello=ospfAreaTxHello, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, routerLSALinkID=routerLSALinkID, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, arpInfoTable=arpInfoTable, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfInterface=ospfInterface, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfGeneral=ospfGeneral, vrrpStats=vrrpStats, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIfTotalNeighbours=ospfIfTotalNeighbours, routerLSALinkData=routerLSALinkData, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgGwTable=ipNewCfgGwTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ripCurCfgState=ripCurCfgState, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfTxHello=ospfIntfTxHello, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfUnloop=ospfIntfUnloop, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfRxHello=ospfIntfRxHello, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaIntfDown=ospfAreaIntfDown, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaTxPkts=ospfAreaTxPkts, ipForward=ipForward, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfStartTime=ospfStartTime, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgGwMetric=ipNewCfgGwMetric, ip_info=ip_info, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, arpInfoRefPorts=arpInfoRefPorts, vrrp=vrrp, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfNbrDown=ospfIntfNbrDown, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfTotalAreas=ospfTotalAreas, routerLSAAreaIndex=routerLSAAreaIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgGwArp=ipNewCfgGwArp, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgIntfState=ipNewCfgIntfState, ipRouteInfoTag=ipRouteInfoTag, ospfCumRxDatabase=ospfCumRxDatabase, vrrpOper=vrrpOper, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfRxDatabase=ospfIntfRxDatabase, arpStatMaxEntries=arpStatMaxEntries, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, routeStatEntries=routeStatEntries, ospfinfo=ospfinfo)
