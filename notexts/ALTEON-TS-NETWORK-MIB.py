...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, arpInfoMacAddr=arpInfoMacAddr, ospfIntfBackup=ospfIntfBackup, routerLSAId=routerLSAId, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipRouteInfoType=ipRouteInfoType, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, arpStatMaxEntries=arpStatMaxEntries, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ip_info=ip_info, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgBootpState=ipNewCfgBootpState, ripConfig=ripConfig, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaRxTxStats=ospfAreaRxTxStats, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipRouteInfoMask=ipRouteInfoMask, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipCurCfgIntfMask=ipCurCfgIntfMask, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfTotalNssaAreas=ospfTotalNssaAreas, arpInfoFlag=arpInfoFlag, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgGwState=ipCurCfgGwState, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfDown=ospfIntfDown, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfNbrhello=ospfIntfNbrhello, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, routeStatHighWater=routeStatHighWater, ripStats=ripStats, ospfCumRxDatabase=ospfCumRxDatabase, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCurCfgAreaId=ospfCurCfgAreaId, arpStatEntries=arpStatEntries, ospfCumNbrN1way=ospfCumNbrN1way, ospfIfWaitInterval=ospfIfWaitInterval, routerLSALinkID=routerLSALinkID, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaIntfHello=ospfAreaIntfHello, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ripCurCfgListen=ripCurCfgListen, arpInfoTable=arpInfoTable, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ripNewCfgListen=ripNewCfgListen, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfGeneralStats=ospfGeneralStats, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIfInfoIndex=ospfIfInfoIndex, ospfIntfTxHello=ospfIntfTxHello, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, arpInfoEntry=arpInfoEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumNbrhello=ospfCumNbrhello, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrp_info=vrrp_info, ospfAreaRxPkts=ospfAreaRxPkts, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfGeneral=ospfGeneral, ospfIntfNbrDown=ospfIntfNbrDown, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipFwdNewCfgState=ipFwdNewCfgState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, arpInfoRefPorts=arpInfoRefPorts, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfStats=ospfStats, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaNbrDown=ospfAreaNbrDown, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpOper=vrrpOper, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfinfo=ospfinfo, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumNbrStart=ospfCumNbrStart, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ripNewCfgState=ripNewCfgState, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgGwArp=ipNewCfgGwArp, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, routeStatEntries=routeStatEntries, ripNewCfgDefListen=ripNewCfgDefListen, ospfArea=ospfArea, routerLSALinkIndex=routerLSALinkIndex, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpStats=vrrpStats, ospfAreaIntfBackup=ospfAreaIntfBackup, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfHostTableMaxSize=ospfHostTableMaxSize, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumNbrDown=ospfCumNbrDown, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, arpStatHighWater=arpStatHighWater, ospfCumIntfNbrChange=ospfCumIntfNbrChange, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaRxHello=ospfAreaRxHello, ospfIntfInfoEntry=ospfIntfInfoEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaTxHello=ospfAreaTxHello, ospfIntfHello=ospfIntfHello, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, iprouting=iprouting, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, arpStats=arpStats, ospfCumTxHello=ospfCumTxHello, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfProcessUptime=ospfProcessUptime, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, routerLSALinkData=routerLSALinkData, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumIntfBackup=ospfCumIntfBackup, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumTxPkts=ospfCumTxPkts, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumIntfHello=ospfCumIntfHello, ripStatInPkts=ripStatInPkts, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgIntfState=ipNewCfgIntfState, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfNbrChange=ospfIntfNbrChange, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfTxDatabase=ospfIntfTxDatabase, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ripCurCfgVip=ripCurCfgVip, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfLoop=ospfIntfLoop, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ripCurCfgSupply=ripCurCfgSupply, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgBootpState=ipCurCfgBootpState, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfTotalAreas=ospfTotalAreas, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaIntfDown=ospfAreaIntfDown, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfGeneralInfo=ospfGeneralInfo, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumRxHello=ospfCumRxHello, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipGatewayTableMax=ipGatewayTableMax, vrrpGeneral=vrrpGeneral, ospfStartTime=ospfStartTime, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgGwAddr=ipNewCfgGwAddr, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgGwEntry=ipNewCfgGwEntry, ipForward=ipForward, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipRouteInfoTag=ipRouteInfoTag, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfInterface=ospfInterface, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgGwArp=ipCurCfgGwArp, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaNbrhello=ospfAreaNbrhello, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, dnsStats=dnsStats, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCfg=ospfCfg, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgIntfEntry=ipCurCfgIntfEntry, arpInfoSrcPort=arpInfoSrcPort, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrp=vrrp, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, routeStats=routeStats, ipRouteInfoInterface=ipRouteInfoInterface, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfLsTypesSupported=ospfLsTypesSupported, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, routeStatMaxEntries=routeStatMaxEntries, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfIndex=ospfIntfIndex, arpInfoVLAN=arpInfoVLAN, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfUnloop=ospfIntfUnloop, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf)
