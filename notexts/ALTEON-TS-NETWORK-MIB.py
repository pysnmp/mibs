...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpInfoSrcPort=arpInfoSrcPort, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, routerLSALinkIndex=routerLSALinkIndex, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumNbrhello=ospfCumNbrhello, ripNewCfgVip=ripNewCfgVip, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpOper=vrrpOper, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaIntfLoop=ospfAreaIntfLoop, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfinfo=ospfinfo, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipRouteInfoTable=ipRouteInfoTable, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipCurCfgGwArp=ipCurCfgGwArp, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfRxPkts=ospfIntfRxPkts, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfNewCfgAreaId=ospfNewCfgAreaId, routerLSAAreaIndex=routerLSAAreaIndex, ospfArea=ospfArea, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipNewCfgIntfTable=ipNewCfgIntfTable, routeStats=routeStats, ospfCumNbrDown=ospfCumNbrDown, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipRouteInfoGateway=ipRouteInfoGateway, ospfCurCfgAreaId=ospfCurCfgAreaId, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfRxHello=ospfIntfRxHello, ospfStartTime=ospfStartTime, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ripCurCfgSupply=ripCurCfgSupply, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfNbrChange=ospfIntfNbrChange, arpStatHighWater=arpStatHighWater, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaIntfHello=ospfAreaIntfHello, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, routerLSALinkData=routerLSALinkData, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumIntfDown=ospfCumIntfDown, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgGwState=ipNewCfgGwState, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipCurCfgGwState=ipCurCfgGwState, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfTotalNeighbours=ospfTotalNeighbours, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdCurCfgState=ipFwdCurCfgState, ospfIfInfoIndex=ospfIfInfoIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfLsTypesSupported=ospfLsTypesSupported, vrrp_info=vrrp_info, ospfStats=ospfStats, routeStatMaxEntries=routeStatMaxEntries, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfTotalAreas=ospfTotalAreas, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpGeneral=vrrpGeneral, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipNewCfgBootpState=ipNewCfgBootpState, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgIntfEntry=ipCurCfgIntfEntry, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaTxHello=ospfAreaTxHello, ospfIntfTxHello=ospfIntfTxHello, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfRxDatabase=ospfIntfRxDatabase, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, routeStatHighWater=routeStatHighWater, ipCurCfgIntfTable=ipCurCfgIntfTable, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfNbrhello=ospfIntfNbrhello, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumIntfHello=ospfCumIntfHello, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfProcessUptime=ospfProcessUptime, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfTxDatabase=ospfIntfTxDatabase, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfGeneralInfo=ospfGeneralInfo, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaInfoId=ospfAreaInfoId, ospfAreaTxPkts=ospfAreaTxPkts, arpInfoVLAN=arpInfoVLAN, ospfAreaRxPkts=ospfAreaRxPkts, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaNbrDown=ospfAreaNbrDown, vrrpStats=vrrpStats, arpStats=arpStats, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgGwMetric=ipCurCfgGwMetric, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfIndex=ospfIntfIndex, ospfIntfBackup=ospfIntfBackup, arpInfoTable=arpInfoTable, ipForward=ipForward, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfInfoTable=ospfIntfInfoTable, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, arpInfoRefPorts=arpInfoRefPorts, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ripCurCfgState=ripCurCfgState, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgGwTable=ipNewCfgGwTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfInterface=ospfInterface, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgIntfIndex=ipCurCfgIntfIndex, iprouting=iprouting, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripStatOutPkts=ripStatOutPkts, routerLSALinkID=routerLSALinkID, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ripCurCfgListen=ripCurCfgListen, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrp=vrrp, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripStatInErrorPkts=ripStatInErrorPkts, ripConfig=ripConfig, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ripStatInPkts=ripStatInPkts, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgIntfState=ipNewCfgIntfState, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, arpInfoEntry=arpInfoEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfDown=ospfIntfDown, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfHello=ospfIntfHello, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, dnsStats=dnsStats, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaChangeStats=ospfAreaChangeStats, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgGwInterval=ipCurCfgGwInterval, ip_info=ip_info, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, arpStatMaxEntries=arpStatMaxEntries, ripNewCfgListen=ripNewCfgListen, ipRouteInfoIndx=ipRouteInfoIndx, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfNbrStart=ospfIntfNbrStart, routeStatEntries=routeStatEntries, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCumRxHello=ospfCumRxHello, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumTxHello=ospfCumTxHello, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ripNewCfgState=ripNewCfgState, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfLoop=ospfIntfLoop, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaRxTxStats=ospfAreaRxTxStats, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ripNewCfgDefListen=ripNewCfgDefListen, ospfGeneralStats=ospfGeneralStats, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipRouteInfoType=ipRouteInfoType, arpInfoFlag=arpInfoFlag, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumNbrBadRequests=ospfCumNbrBadRequests, routerLSAId=routerLSAId, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaIntfBackup=ospfAreaIntfBackup, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfNbrInExchState=ospfNbrInExchState, ripStats=ripStats, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumTxlsUpdates=ospfCumTxlsUpdates)
