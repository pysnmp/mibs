...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ip_info=ip_info, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumTxDatabase=ospfCumTxDatabase, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, iprouting=iprouting, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, arpStatMaxEntries=arpStatMaxEntries, arpInfoDestIp=arpInfoDestIp, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgBootpState=ipNewCfgBootpState, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, arpInfoMacAddr=arpInfoMacAddr, ospfCfg=ospfCfg, ripCurCfgState=ripCurCfgState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipGatewayTableMax=ipGatewayTableMax, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgGwMetric=ipCurCfgGwMetric, ripNewCfgSupply=ripNewCfgSupply, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, routerLSAId=routerLSAId, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaNbrDown=ospfAreaNbrDown, ripNewCfgListen=ripNewCfgListen, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrp=vrrp, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpGeneral=vrrpGeneral, routerLSALinkIndex=routerLSALinkIndex, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumNbrDown=ospfCumNbrDown, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfStats=ospfStats, ripConfig=ripConfig, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaNbrhello=ospfAreaNbrhello, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipFwdNewCfgState=ipFwdNewCfgState, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgGwState=ipCurCfgGwState, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfInterface=ospfInterface, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ripNewCfgState=ripNewCfgState, ripCurCfgVip=ripCurCfgVip, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ripCurCfgListen=ripCurCfgListen, ipCurCfgGwEntry=ipCurCfgGwEntry, routerLSALinkID=routerLSALinkID, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfStartTime=ospfStartTime, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ripCurCfgDefListen=ripCurCfgDefListen, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfArea=ospfArea, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaRxHello=ospfAreaRxHello, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipInterfaceTableMax=ipInterfaceTableMax, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfDown=ospfIntfDown, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, routeStatHighWater=routeStatHighWater, ipRouteInfoTag=ipRouteInfoTag, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfGeneralInfo=ospfGeneralInfo, ipRouteInfoType=ipRouteInfoType, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaChangeStats=ospfAreaChangeStats)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfinfo=ospfinfo, ipForward=ipForward, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, routeStatEntries=routeStatEntries, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, routeStats=routeStats, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfTotalAreas=ospfTotalAreas, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgGwDelete=ipNewCfgGwDelete, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipNewCfgIntfMask=ipNewCfgIntfMask, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, routerLSALinkData=routerLSALinkData, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumRxTxStats=ospfCumRxTxStats, arpInfoEntry=arpInfoEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaInfoId=ospfAreaInfoId, ospfCumIntfDown=ospfCumIntfDown, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripStatInPkts=ripStatInPkts, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumNbrhello=ospfCumNbrhello, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, arpInfoSrcPort=arpInfoSrcPort, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipNewCfgGwRetry=ipNewCfgGwRetry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfTxHello=ospfIntfTxHello, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfGeneralStats=ospfGeneralStats, arpInfoFlag=arpInfoFlag, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpOper=vrrpOper, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumIntfBackup=ospfCumIntfBackup, vrrpStatInAdvers=vrrpStatInAdvers, ripStatOutPkts=ripStatOutPkts, ospfGeneral=ospfGeneral, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipCurCfgGwArp=ipCurCfgGwArp, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgGwState=ipNewCfgGwState, arpStats=arpStats, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpStats=vrrpStats, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipRouteInfoTable=ipRouteInfoTable, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumRxPkts=ospfCumRxPkts, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumTxHello=ospfCumTxHello, arpStatEntries=arpStatEntries, ipRouteInfoGateway=ipRouteInfoGateway, dnsStats=dnsStats, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfNbrStart=ospfIntfNbrStart, ospfNbrInInitState=ospfNbrInInitState, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, arpInfoTable=arpInfoTable, arpStatHighWater=arpStatHighWater, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumTxPkts=ospfCumTxPkts, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfLoop=ospfIntfLoop, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ripStats=ripStats, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgIntfEntry=ipNewCfgIntfEntry)
