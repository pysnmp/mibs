...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumNbrDown=ospfCumNbrDown, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipRouteInfoTable=ipRouteInfoTable, ipRouteInfoType=ipRouteInfoType, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumTxPkts=ospfCumTxPkts, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipForward=ipForward, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumIntfChangeStats=ospfCumIntfChangeStats, arpInfoMacAddr=arpInfoMacAddr, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, arpInfoEntry=arpInfoEntry, ospfProcessUptime=ospfProcessUptime, ripNewCfgDefListen=ripNewCfgDefListen, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgBootpState=ipNewCfgBootpState, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpOper=vrrpOper, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfinfo=ospfinfo, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipGatewayTableMax=ipGatewayTableMax, ospfStats=ospfStats, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgGwArp=ipNewCfgGwArp, ripNewCfgVip=ripNewCfgVip, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumNbrhello=ospfCumNbrhello, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripNewCfgState=ripNewCfgState, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ripCurCfgSupply=ripCurCfgSupply, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, arpStatEntries=arpStatEntries, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, arpInfoVLAN=arpInfoVLAN, ospfArea=ospfArea, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfInfoTable=ospfIntfInfoTable, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, dnsStats=dnsStats, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ripStatInErrorPkts=ripStatInErrorPkts, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfHello=ospfIntfHello, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrp=vrrp, arpInfoDestIp=arpInfoDestIp, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, routerLSAAreaIndex=routerLSAAreaIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ripCurCfgListen=ripCurCfgListen, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfBackup=ospfIntfBackup, ospfAreaNbrStart=ospfAreaNbrStart, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfGeneral=ospfGeneral, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfTotalNeighbours=ospfTotalNeighbours, arpStatMaxEntries=arpStatMaxEntries, ospfIntfDown=ospfIntfDown, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, arpInfoFlag=arpInfoFlag, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgGwState=ipCurCfgGwState, ospfCumRxPkts=ospfCumRxPkts, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrp_info=vrrp_info, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumIntfDown=ospfCumIntfDown, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, routerLSAId=routerLSAId, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipRouteInfoGateway=ipRouteInfoGateway, ripConfig=ripConfig, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgGwInterval=ipNewCfgGwInterval, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfInterface=ospfInterface, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, arpStats=arpStats, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpStats=vrrpStats, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, routeStatHighWater=routeStatHighWater, iprouting=iprouting, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, routeStatMaxEntries=routeStatMaxEntries, ospfAreaTxPkts=ospfAreaTxPkts, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumIntfLoop=ospfCumIntfLoop, arpInfoRefPorts=arpInfoRefPorts, routerLSALinkID=routerLSALinkID, ripStatOutPkts=ripStatOutPkts, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumIntfHello=ospfCumIntfHello, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfRxTxStats=ospfIntfRxTxStats, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfTxHello=ospfIntfTxHello, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfUnloop=ospfIntfUnloop, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, arpStatHighWater=arpStatHighWater, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumRxlsAcks=ospfCumRxlsAcks, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ripCurCfgDefListen=ripCurCfgDefListen, ip_info=ip_info, routeStats=routeStats, ospfIfInfoIndex=ospfIfInfoIndex, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipInterfaceTableMax=ipInterfaceTableMax, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpGeneral=vrrpGeneral, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaTxHello=ospfAreaTxHello, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfRxHello=ospfIntfRxHello, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfNbrDown=ospfIntfNbrDown, ripStats=ripStats, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfGeneralInfo=ospfGeneralInfo, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgIntfTable=ipCurCfgIntfTable, ripCurCfgState=ripCurCfgState, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfNbrN1way=ospfIntfNbrN1way, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, routeStatEntries=routeStatEntries, ospfCumRxHello=ospfCumRxHello, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaIntfHello=ospfAreaIntfHello, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfNbrStart=ospfIntfNbrStart, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfLsTypesSupported=ospfLsTypesSupported, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCfg=ospfCfg, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ripNewCfgListen=ripNewCfgListen, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfNbrIndex=ospfIntfNbrIndex, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaNbrDown=ospfAreaNbrDown, ospfStartTime=ospfStartTime, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipNewCfgIntfDelete=ipNewCfgIntfDelete, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaInfoTable=ospfAreaInfoTable, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfTxPkts=ospfIntfTxPkts, ripNewCfgSupply=ripNewCfgSupply, ospfNbrInExchState=ospfNbrInExchState, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgGwVlan=ipNewCfgGwVlan, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfLoop=ospfIntfLoop, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaInfoId=ospfAreaInfoId, ospfIntfIndex=ospfIntfIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaInfoIndex=ospfAreaInfoIndex, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaNbrIndex=ospfAreaNbrIndex, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv)
