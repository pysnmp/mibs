...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfNbrInExchState=ospfNbrInExchState, ospfAreaRxHello=ospfAreaRxHello, ripCurCfgSupply=ripCurCfgSupply, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfGeneralStats=ospfGeneralStats, ospfCumIntfLoop=ospfCumIntfLoop, ospfTotalAreas=ospfTotalAreas, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfStartTime=ospfStartTime, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipRouteInfoDestIp=ipRouteInfoDestIp, ripNewCfgVip=ripNewCfgVip, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfCountForRouter=ospfIntfCountForRouter, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfGeneralInfo=ospfGeneralInfo, ospfCumRxHello=ospfCumRxHello, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfStats=ospfStats, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ripConfig=ripConfig, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgGwState=ipNewCfgGwState, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumRxlsReqs=ospfCumRxlsReqs, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfRxPkts=ospfIntfRxPkts, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, arpInfoEntry=arpInfoEntry, iprouting=iprouting, ip_info=ip_info, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfNbrhello=ospfIntfNbrhello, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaInfoIndex=ospfAreaInfoIndex, ripStatOutPkts=ripStatOutPkts, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, arpStatMaxEntries=arpStatMaxEntries, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIfWaitInterval=ospfIfWaitInterval, routerLSALinkIndex=routerLSALinkIndex, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumNbrStart=ospfCumNbrStart, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipRouteInfoGateway=ipRouteInfoGateway, arpStatHighWater=arpStatHighWater, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfArea=ospfArea, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaIntfDown=ospfAreaIntfDown, arpInfoRefPorts=arpInfoRefPorts, ospfAreaRxlsReqs=ospfAreaRxlsReqs, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, dnsStats=dnsStats, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgGwVlan=ipNewCfgGwVlan, ipForward=ipForward, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ripCurCfgDefListen=ripCurCfgDefListen, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgIntfTable=ipNewCfgIntfTable, routerLSALinkData=routerLSALinkData, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgGwIndex=ipCurCfgGwIndex, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, routeStatMaxEntries=routeStatMaxEntries, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipInterfaceTableMax=ipInterfaceTableMax, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfLoop=ospfIntfLoop, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumRxDatabase=ospfCumRxDatabase, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ripNewCfgSupply=ripNewCfgSupply, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipRouteInfoMask=ipRouteInfoMask, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrChange=ospfIntfNbrChange, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumNbrDown=ospfCumNbrDown, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaChangeStats=ospfAreaChangeStats, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfBackup=ospfIntfBackup, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, routerLSAAreaIndex=routerLSAAreaIndex, arpInfoTable=arpInfoTable, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumIntfBackup=ospfCumIntfBackup, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, routeStatHighWater=routeStatHighWater, vrrp_info=vrrp_info, ospfAreaNbrStart=ospfAreaNbrStart, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfChangeStats=ospfIntfChangeStats, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, routeStats=routeStats, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ripStatRoutesAgedOut=ripStatRoutesAgedOut)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, arpStats=arpStats, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripNewCfgState=ripNewCfgState, ripStats=ripStats, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCfg=ospfCfg, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumTxHello=ospfCumTxHello, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumTxPkts=ospfCumTxPkts, ipCurCfgGwEntry=ipCurCfgGwEntry, routeStatEntries=routeStatEntries, ipRouteInfoTable=ipRouteInfoTable, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgGwState=ipCurCfgGwState, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, arpInfoSrcPort=arpInfoSrcPort, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpStatInAdvers=vrrpStatInAdvers, ipRouteInfoType=ipRouteInfoType, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ripStatInPkts=ripStatInPkts, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ripNewCfgDefListen=ripNewCfgDefListen, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaInfoTable=ospfAreaInfoTable, ospfTotalNeighbours=ospfTotalNeighbours, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrp=vrrp, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumIntfDown=ospfCumIntfDown, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfUnloop=ospfIntfUnloop, ripCurCfgListen=ripCurCfgListen, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfinfo=ospfinfo, ospfProcessUptime=ospfProcessUptime, ospfIntfDown=ospfIntfDown, ospfIntfRxTxStats=ospfIntfRxTxStats, ipRouteInfoTag=ipRouteInfoTag, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgBootpState=ipCurCfgBootpState, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaTxHello=ospfAreaTxHello, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgGwRetry=ipCurCfgGwRetry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, arpStatEntries=arpStatEntries, ospfNbrInInitState=ospfNbrInInitState, ospfInterface=ospfInterface, ospfCumIntfHello=ospfCumIntfHello, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, arpInfoVLAN=arpInfoVLAN, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpGeneral=vrrpGeneral, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgBootpState=ipNewCfgBootpState, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfGeneral=ospfGeneral, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfInfoEntry=ospfIntfInfoEntry, routerLSAId=routerLSAId, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgIntfState=ipNewCfgIntfState, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpOper=vrrpOper, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfLsTypesSupported=ospfLsTypesSupported, routerLSALinkIfIndex=routerLSALinkIfIndex, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaIntfHello=ospfAreaIntfHello, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfInfoTable=ospfIntfInfoTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfTxHello=ospfIntfTxHello)
