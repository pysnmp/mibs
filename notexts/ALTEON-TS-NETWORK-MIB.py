...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipCurCfgGwTable=ipCurCfgGwTable, ipForward=ipForward, ospfIntfLoop=ospfIntfLoop, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgGwInterval=ipNewCfgGwInterval, arpStatEntries=arpStatEntries, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaRxDatabase=ospfAreaRxDatabase, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgGwEntry=ipNewCfgGwEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgIfTable=vrrpCurCfgIfTable, arpInfoTable=arpInfoTable, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfNbrInFullState=ospfNbrInFullState, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaChangeStats=ospfAreaChangeStats, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCfg=ospfCfg, routeStats=routeStats, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, dnsStats=dnsStats, ospfCumNbrhello=ospfCumNbrhello, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfTotalNeighbours=ospfTotalNeighbours, ospfinfo=ospfinfo, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpStats=vrrpStats, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfNbrStart=ospfIntfNbrStart, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ripCurCfgListen=ripCurCfgListen, ospfNbrInExchState=ospfNbrInExchState, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipNewCfgGwDelete=ipNewCfgGwDelete, ripNewCfgDefListen=ripNewCfgDefListen, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaIntfDown=ospfAreaIntfDown, routeStatHighWater=routeStatHighWater, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ripConfig=ripConfig, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgGwState=ipCurCfgGwState, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgIntfState=ipCurCfgIntfState, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfStats=ospfStats, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, iprouting=iprouting, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdCurCfgState=ipFwdCurCfgState, routerLSAId=routerLSAId, ospfCumNbrDown=ospfCumNbrDown, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipRouteInfoMask=ipRouteInfoMask, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ripNewCfgListen=ripNewCfgListen, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfStartTime=ospfStartTime, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfDown=ospfIntfDown, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfNbrN1way=ospfIntfNbrN1way, routeStatMaxEntries=routeStatMaxEntries, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, arpInfoEntry=arpInfoEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, arpStatMaxEntries=arpStatMaxEntries, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpIfTableMaxSize=vrrpIfTableMaxSize, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfInterface=ospfInterface, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaTxPkts=ospfAreaTxPkts, ipRouteInfoTable=ipRouteInfoTable, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumNbrStart=ospfCumNbrStart, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripStatInPkts=ripStatInPkts, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgGwState=ipNewCfgGwState)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTotalNssaAreas=ospfTotalNssaAreas, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIfInfoIndex=ospfIfInfoIndex, ipRouteInfoType=ipRouteInfoType, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripCurCfgState=ripCurCfgState, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfArea=ospfArea, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumTxPkts=ospfCumTxPkts, routerLSALinkData=routerLSALinkData, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ripStats=ripStats, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, arpInfoVLAN=arpInfoVLAN, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipRouteInfoTag=ipRouteInfoTag, routerLSALinkID=routerLSALinkID, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaTxDatabase=ospfAreaTxDatabase, arpInfoFlag=arpInfoFlag, ripNewCfgSupply=ripNewCfgSupply, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgIntfVlan=ipNewCfgIntfVlan, arpStats=arpStats, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, routeStatEntries=routeStatEntries, ipFwdNewCfgState=ipFwdNewCfgState, ospfGeneral=ospfGeneral, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfGeneralStats=ospfGeneralStats, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaRxPkts=ospfAreaRxPkts, vrrp=vrrp, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfTotalAreas=ospfTotalAreas, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfIndex=ospfIntfIndex, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumRxPkts=ospfCumRxPkts, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfChangeStats=ospfIntfChangeStats, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ripCurCfgVip=ripCurCfgVip, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipRouteInfoEntry=ipRouteInfoEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfTxHello=ospfIntfTxHello, ripNewCfgStaticSupply=ripNewCfgStaticSupply, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipGatewayTableMax=ipGatewayTableMax, ip_info=ip_info, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumTxHello=ospfCumTxHello, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripNewCfgState=ripNewCfgState, vrrpOper=vrrpOper, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumRxHello=ospfCumRxHello, arpStatHighWater=arpStatHighWater, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpGeneral=vrrpGeneral, arpInfoRefPorts=arpInfoRefPorts, arpInfoSrcPort=arpInfoSrcPort)
