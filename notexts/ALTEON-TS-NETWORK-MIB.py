...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipRouteInfoType=ipRouteInfoType, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCfg=ospfCfg, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumRxPkts=ospfCumRxPkts, ospfGeneralInfo=ospfGeneralInfo, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfNbrInExchState=ospfNbrInExchState, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaInfoId=ospfAreaInfoId, vrrp=vrrp, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfBackup=ospfIntfBackup, ospfAreaIntfHello=ospfAreaIntfHello, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfTxPkts=ospfIntfTxPkts, ripStats=ripStats, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipGatewayTableMax=ipGatewayTableMax, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfStats=ospfStats, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfRxPkts=ospfIntfRxPkts, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, routerLSALinkData=routerLSALinkData, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ripNewCfgState=ripNewCfgState, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipRouteInfoTable=ipRouteInfoTable, ospfCumTxDatabase=ospfCumTxDatabase, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIfInfoIpAddress=ospfIfInfoIpAddress, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, arpInfoTable=arpInfoTable, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgGwState=ipCurCfgGwState, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaNbrDown=ospfAreaNbrDown, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, routerLSAId=routerLSAId, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgGwDelete=ipNewCfgGwDelete, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpStats=vrrpStats, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfInterface=ospfInterface, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, arpInfoEntry=arpInfoEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaIntfBackup=ospfAreaIntfBackup, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgGwRetry=ipNewCfgGwRetry, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrp_info=vrrp_info, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripStatInPkts=ripStatInPkts, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpStatInAdvers=vrrpStatInAdvers, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfRxHello=ospfIntfRxHello, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfStartTime=ospfStartTime, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgIntfTable=ipCurCfgIntfTable, dnsStats=dnsStats, ripCurCfgListen=ripCurCfgListen, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, arpInfoDestIp=arpInfoDestIp, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumNbrN1way=ospfCumNbrN1way, arpInfoSrcPort=arpInfoSrcPort, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaInfoTable=ospfAreaInfoTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ip_info=ip_info, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipForward=ipForward, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfTxHello=ospfIntfTxHello, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfLoop=ospfIntfLoop, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, routeStatHighWater=routeStatHighWater)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfCountForRouter=ospfIntfCountForRouter, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfInfoTable=ospfIntfInfoTable, ripStatOutPkts=ripStatOutPkts, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfHello=ospfIntfHello, ospfCumTxHello=ospfCumTxHello, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfProcessUptime=ospfProcessUptime, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaIntfDown=ospfAreaIntfDown, arpStatEntries=arpStatEntries, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfArea=ospfArea, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfDown=ospfIntfDown, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, arpStats=arpStats, arpInfoFlag=arpInfoFlag, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfUnloop=ospfIntfUnloop, ospfGeneralStats=ospfGeneralStats, ospfCumIntfDown=ospfCumIntfDown, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ripNewCfgVip=ripNewCfgVip, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgGwArp=ipNewCfgGwArp, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfinfo=ospfinfo, ipRouteInfoInterface=ipRouteInfoInterface, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ripConfig=ripConfig, ripNewCfgListen=ripNewCfgListen, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumNbrStart=ospfCumNbrStart, ospfGeneral=ospfGeneral, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumIntfHello=ospfCumIntfHello, arpInfoVLAN=arpInfoVLAN, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfTotalNeighbours=ospfTotalNeighbours, routeStats=routeStats, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaNbrN1way=ospfAreaNbrN1way, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfNbrInFullState=ospfNbrInFullState, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdCurCfgPortState=ipFwdCurCfgPortState, iprouting=iprouting, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpOper=vrrpOper, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipRouteInfoTag=ipRouteInfoTag, ospfAreaRxHello=ospfAreaRxHello, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCumNbrDown=ospfCumNbrDown, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, arpInfoMacAddr=arpInfoMacAddr, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpGeneral=vrrpGeneral, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCurCfgAreaId=ospfCurCfgAreaId, routeStatEntries=routeStatEntries, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, routerLSAAreaIndex=routerLSAAreaIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumTxPkts=ospfCumTxPkts, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfTotalAreas=ospfTotalAreas)
