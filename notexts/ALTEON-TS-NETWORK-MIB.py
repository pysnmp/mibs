...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpGeneral=vrrpGeneral, ospfProcessUptime=ospfProcessUptime, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumNbrRstAd=ospfCumNbrRstAd, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaTxHello=ospfAreaTxHello, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfBackup=ospfIntfBackup, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfIndex=ospfIntfIndex, routerLSALinkData=routerLSALinkData, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfUnloop=ospfIntfUnloop, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpStatOutAdvers=vrrpStatOutAdvers, iprouting=iprouting, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipRouteInfoTable=ipRouteInfoTable, ospfTotalTransitAreas=ospfTotalTransitAreas, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrp=vrrp, ip_info=ip_info, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipRouteInfoEntry=ipRouteInfoEntry, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfStats=ospfStats, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfLoop=ospfIntfLoop, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipForward=ipForward, ospfCumTxPkts=ospfCumTxPkts, ospfIntfTxlsAcks=ospfIntfTxlsAcks, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipRouteInfoMask=ipRouteInfoMask, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfinfo=ospfinfo, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpStats=vrrpStats, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfNbrInInitState=ospfNbrInInitState, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfArea=ospfArea, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, dnsStats=dnsStats, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipRouteInfoIndx=ipRouteInfoIndx, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgGwMetric=ipNewCfgGwMetric, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfNbrChange=ospfIntfNbrChange, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumIntfLoop=ospfCumIntfLoop, arpInfoRefPorts=arpInfoRefPorts, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgIntfState=ipNewCfgIntfState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfLsTypesSupported=ospfLsTypesSupported, ripCurCfgSupply=ripCurCfgSupply, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, arpStatHighWater=arpStatHighWater, ospfTotalAreas=ospfTotalAreas, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipInterfaceTableMax=ipInterfaceTableMax, ripCurCfgVip=ripCurCfgVip, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfNbrDown=ospfIntfNbrDown, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCfg=ospfCfg, ipCurCfgIntfState=ipCurCfgIntfState, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, routerLSALinkIndex=routerLSALinkIndex, routerLSALinkID=routerLSALinkID, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpStatInAdvers=vrrpStatInAdvers, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipRouteInfoGateway=ipRouteInfoGateway, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ripNewCfgState=ripNewCfgState, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaRxPkts=ospfAreaRxPkts, arpStats=arpStats, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ripStatInPkts=ripStatInPkts, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgIfTable=vrrpCurCfgIfTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgIntfAddr=ipNewCfgIntfAddr, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfGeneral=ospfGeneral, ospfStartTime=ospfStartTime, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaInfoEntry=ospfAreaInfoEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfInfoTable=ospfIntfInfoTable, vrrp_info=vrrp_info, ospfInterface=ospfInterface, ospfAreaTxPkts=ospfAreaTxPkts, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfNbrInExchState=ospfNbrInExchState, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfDown=ospfIntfDown, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfHello=ospfIntfHello, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumTxHello=ospfCumTxHello, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, arpInfoTable=arpInfoTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaInfoTable=ospfAreaInfoTable, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaRxHello=ospfAreaRxHello, arpInfoEntry=arpInfoEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ripStats=ripStats, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumNbrStart=ospfCumNbrStart, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgGwAddr=ipNewCfgGwAddr, ripStatOutPkts=ripStatOutPkts, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfNbrInFullState=ospfNbrInFullState, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ripConfig=ripConfig, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, arpStatMaxEntries=arpStatMaxEntries, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ripNewCfgListen=ripNewCfgListen, ospfCumIntfDown=ospfCumIntfDown, ospfIntfTxHello=ospfIntfTxHello, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripNewCfgVip=ripNewCfgVip, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfRxHello=ospfIntfRxHello, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumNbrDown=ospfCumNbrDown, routerLSAId=routerLSAId, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, routeStatEntries=routeStatEntries, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, arpInfoMacAddr=arpInfoMacAddr, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, arpInfoVLAN=arpInfoVLAN, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgGwState=ipCurCfgGwState, arpStatEntries=arpStatEntries, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgBootpState=ipNewCfgBootpState, ospfGeneralInfo=ospfGeneralInfo, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipRouteInfoType=ipRouteInfoType, routeStats=routeStats, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumTxlsUpdates=ospfCumTxlsUpdates, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipCurCfgIntfTable=ipCurCfgIntfTable, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgGwTable=ipNewCfgGwTable, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumRxPkts=ospfCumRxPkts, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, routeStatHighWater=routeStatHighWater, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaTxDatabase=ospfAreaTxDatabase)
