...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, routerLSALinkData=routerLSALinkData, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, routeStatMaxEntries=routeStatMaxEntries, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipRouteInfoTable=ipRouteInfoTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, routeStatHighWater=routeStatHighWater, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaInfoId=ospfAreaInfoId, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfRxHello=ospfIntfRxHello, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumNbrDown=ospfCumNbrDown, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, dnsStats=dnsStats, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCurCfgAreaId=ospfCurCfgAreaId, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipForward=ipForward, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfNbrInFullState=ospfNbrInFullState, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipFwdNewCfgState=ipFwdNewCfgState, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, arpInfoTable=arpInfoTable, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgBootpState=ipNewCfgBootpState, routeStatEntries=routeStatEntries, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, arpInfoEntry=arpInfoEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ripNewCfgVip=ripNewCfgVip, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdNewCfgPortState=ipFwdNewCfgPortState, arpInfoDestIp=arpInfoDestIp, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfDown=ospfIntfDown, arpInfoVLAN=arpInfoVLAN, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ripNewCfgSupply=ripNewCfgSupply, vrrpGeneral=vrrpGeneral, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrp=vrrp, ospfGeneralInfo=ospfGeneralInfo, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ripCurCfgState=ripCurCfgState, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumNbrRstAd=ospfCumNbrRstAd, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgIntfIndex=ipCurCfgIntfIndex, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfBackup=ospfIntfBackup, ospfCumRxPkts=ospfCumRxPkts, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ripConfig=ripConfig, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfArea=ospfArea, ripStatInPkts=ripStatInPkts, arpInfoSrcPort=arpInfoSrcPort, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpStats=vrrpStats, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipRouteInfoInterface=ipRouteInfoInterface, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfHostTableMaxSize=ospfHostTableMaxSize, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgGwInterval=ipNewCfgGwInterval, routeStats=routeStats, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumNbrChangeStats=ospfCumNbrChangeStats, arpInfoMacAddr=arpInfoMacAddr, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, routerLSAId=routerLSAId, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaIntfIndex=ospfAreaIntfIndex, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgGwEntry=ipNewCfgGwEntry, ripCurCfgListen=ripCurCfgListen, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, routerLSALinkID=routerLSALinkID, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, arpStatEntries=arpStatEntries, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgGwMetric=ipNewCfgGwMetric, arpStatHighWater=arpStatHighWater, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgGwState=ipNewCfgGwState, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgGwTable=ipNewCfgGwTable, ospfStartTime=ospfStartTime, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCfg=ospfCfg, ipRouteInfoTag=ipRouteInfoTag, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgGwArp=ipNewCfgGwArp, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumTxPkts=ospfCumTxPkts, ripCurCfgVip=ripCurCfgVip, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumIntfDown=ospfCumIntfDown, ospfIntfLoop=ospfIntfLoop, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfInterface=ospfInterface, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ripStats=ripStats, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpOper=vrrpOper, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, arpInfoFlag=arpInfoFlag, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ip_info=ip_info, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumTxHello=ospfCumTxHello, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfNewCfgAreaTable=ospfNewCfgAreaTable, iprouting=iprouting, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfTxPkts=ospfIntfTxPkts, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ripNewCfgListen=ripNewCfgListen, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumNbrhello=ospfCumNbrhello, ospfinfo=ospfinfo, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrChange=ospfIntfNbrChange, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfHello=ospfIntfHello, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfGeneral=ospfGeneral, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfNbrStart=ospfIntfNbrStart, arpInfoRefPorts=arpInfoRefPorts, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaIntfDown=ospfAreaIntfDown, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumIntfUnloop=ospfCumIntfUnloop, ripNewCfgState=ripNewCfgState, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, arpStats=arpStats, ospfAreaChangeStats=ospfAreaChangeStats, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfUnloop=ospfIntfUnloop, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumRxTxStats=ospfCumRxTxStats, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ripStatOutPkts=ripStatOutPkts, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfIndex=ospfIntfIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ripCurCfgSupply=ripCurCfgSupply, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaInfoTable=ospfAreaInfoTable, ospfGeneralStats=ospfGeneralStats, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfStats=ospfStats, ospfIntfTxHello=ospfIntfTxHello)
