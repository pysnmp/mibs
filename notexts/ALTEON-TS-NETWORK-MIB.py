...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ripNewCfgVip=ripNewCfgVip, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfTxHello=ospfIntfTxHello, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripNewCfgDefListen=ripNewCfgDefListen, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfNbrhello=ospfIntfNbrhello, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfIndex=ospfIntfIndex, ospfAreaIntfHello=ospfAreaIntfHello, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumNbrDown=ospfCumNbrDown, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfTxPkts=ospfIntfTxPkts, arpInfoDestIp=arpInfoDestIp, ripCurCfgStaticSupply=ripCurCfgStaticSupply, arpStatMaxEntries=arpStatMaxEntries, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipNewCfgGwArp=ipNewCfgGwArp, routerLSALinkID=routerLSALinkID, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfHello=ospfIntfHello, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfNbrInExchState=ospfNbrInExchState, ospfTotalNeighbours=ospfTotalNeighbours, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, arpInfoMacAddr=arpInfoMacAddr, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, arpInfoEntry=arpInfoEntry, ospfIntfBackup=ospfIntfBackup, ospfAreaNbrhello=ospfAreaNbrhello, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCumIntfHello=ospfCumIntfHello, ripNewCfgListen=ripNewCfgListen, routeStatMaxEntries=routeStatMaxEntries, dnsStats=dnsStats, ipForward=ipForward, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrp=vrrp, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumNbrhello=ospfCumNbrhello, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumRxDatabase=ospfCumRxDatabase, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfRxHello=ospfIntfRxHello, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumTxHello=ospfCumTxHello, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfinfo=ospfinfo, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfInterface=ospfInterface, arpInfoSrcPort=arpInfoSrcPort, arpStatHighWater=arpStatHighWater, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, iprouting=iprouting, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumNbrN1way=ospfCumNbrN1way, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfNbrInFullState=ospfNbrInFullState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgGwArp=ipCurCfgGwArp, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaTxHello=ospfAreaTxHello, ripStatOutPkts=ripStatOutPkts, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipGatewayTableMax=ipGatewayTableMax, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumTxPkts=ospfCumTxPkts, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfTotalTransitAreas=ospfTotalTransitAreas, routerLSAId=routerLSAId, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaTableMaxSize=ospfAreaTableMaxSize, routeStats=routeStats, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumIntfDown=ospfCumIntfDown, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, routeStatEntries=routeStatEntries, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, routerLSALinkIndex=routerLSALinkIndex, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfNbrChange=ospfIntfNbrChange, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipRouteInfoIndx=ipRouteInfoIndx, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdNewCfgPortState=ipFwdNewCfgPortState, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaIntfLoop=ospfAreaIntfLoop, arpInfoVLAN=arpInfoVLAN, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfNbrIndex=ospfIntfNbrIndex)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfDown=ospfIntfDown, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipRouteInfoMask=ipRouteInfoMask, ospfArea=ospfArea, ospfAreaRxTxIndex=ospfAreaRxTxIndex, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgGwTable=ipCurCfgGwTable, ripCurCfgVip=ripCurCfgVip, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ip_info=ip_info, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumNbrStart=ospfCumNbrStart, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaChangeStats=ospfAreaChangeStats, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgGwState=ipNewCfgGwState, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, routeStatHighWater=routeStatHighWater, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfNbrStart=ospfIntfNbrStart, ospfStats=ospfStats, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumRxHello=ospfCumRxHello, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgGwInterval=ipNewCfgGwInterval, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, routerLSAAreaIndex=routerLSAAreaIndex, arpStats=arpStats, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ripNewCfgState=ripNewCfgState, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaNbrStart=ospfAreaNbrStart, ripConfig=ripConfig, vrrpOper=vrrpOper, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ripCurCfgDefListen=ripCurCfgDefListen, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipRouteInfoType=ipRouteInfoType, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipRouteInfoInterface=ipRouteInfoInterface, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaNbrN1way=ospfAreaNbrN1way, ripStats=ripStats, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfGeneralStats=ospfGeneralStats, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipRouteInfoEntry=ipRouteInfoEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfTotalAreas=ospfTotalAreas, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaRxPkts=ospfAreaRxPkts, ospfStartTime=ospfStartTime, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaInfoTable=ospfAreaInfoTable, vrrpStatInAdvers=vrrpStatInAdvers, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumRxlsUpdates=ospfCumRxlsUpdates, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumIntfBackup=ospfCumIntfBackup, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumTxlsReqs=ospfCumTxlsReqs, ripCurCfgSupply=ripCurCfgSupply, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfLoop=ospfIntfLoop, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipCurCfgGwState=ipCurCfgGwState, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfNbrInInitState=ospfNbrInInitState, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ripNewCfgSupply=ripNewCfgSupply, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgGwEntry=ipCurCfgGwEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaRxHello=ospfAreaRxHello, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx)
