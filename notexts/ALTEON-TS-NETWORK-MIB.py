...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfArea=ospfArea, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCumNbrN1way=ospfCumNbrN1way, ripCurCfgState=ripCurCfgState, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaRxlsAcks=ospfAreaRxlsAcks, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgGwAddr=ipNewCfgGwAddr, ipRouteInfoType=ipRouteInfoType, arpInfoFlag=arpInfoFlag, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipRouteInfoEntry=ipRouteInfoEntry, routerLSALinkID=routerLSALinkID, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfInfoEntry=ospfIntfInfoEntry, ripCurCfgDefListen=ripCurCfgDefListen, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfIndex=ospfIntfIndex, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgGwState=ipNewCfgGwState, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfInfoTable=ospfIntfInfoTable, ipForward=ipForward, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumTxHello=ospfCumTxHello, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaRxHello=ospfAreaRxHello, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpGeneral=vrrpGeneral, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaIntfHello=ospfAreaIntfHello, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfRxHello=ospfIntfRxHello, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, arpInfoVLAN=arpInfoVLAN, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripNewCfgState=ripNewCfgState, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfNewCfgAreaId=ospfNewCfgAreaId, arpInfoEntry=arpInfoEntry, ripCurCfgVip=ripCurCfgVip, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, arpStatMaxEntries=arpStatMaxEntries, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfWaitTimer=ospfIntfWaitTimer, dnsStats=dnsStats, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfRxDatabase=ospfIntfRxDatabase, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaNbrDown=ospfAreaNbrDown, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfTxHello=ospfIntfTxHello, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumIntfUnloop=ospfCumIntfUnloop, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumRxDatabase=ospfCumRxDatabase, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ripStats=ripStats, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfGeneralInfo=ospfGeneralInfo, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfInterface=ospfInterface, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ripCurCfgListen=ripCurCfgListen, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfStats=ospfStats, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ripNewCfgVip=ripNewCfgVip, ospfNbrInInitState=ospfNbrInInitState, ospfRangeTableMaxSize=ospfRangeTableMaxSize, routerLSALinkData=routerLSALinkData, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfProcessUptime=ospfProcessUptime, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaInfoTable=ospfAreaInfoTable, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, routerLSAId=routerLSAId, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipRouteInfoInterface=ipRouteInfoInterface)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfStartTime=ospfStartTime, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfBackup=ospfIntfBackup, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpOper=vrrpOper, vrrp=vrrp, ospfCumNbrStart=ospfCumNbrStart, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfLoop=ospfIntfLoop, ospfAreaRxTxStats=ospfAreaRxTxStats, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCumTxPkts=ospfCumTxPkts, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumNbrhello=ospfCumNbrhello, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfinfo=ospfinfo, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfTimersKickOffStats=ospfTimersKickOffStats, ripNewCfgDefListen=ripNewCfgDefListen, ripNewCfgSupply=ripNewCfgSupply, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgGwArp=ipNewCfgGwArp, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumRxPkts=ospfCumRxPkts, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfNewCfgAreaTable=ospfNewCfgAreaTable, arpInfoMacAddr=arpInfoMacAddr, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaRxlsReqs=ospfAreaRxlsReqs, routeStats=routeStats, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipRouteInfoTag=ipRouteInfoTag, ospfTotalAreas=ospfTotalAreas, ospfCumIntfHello=ospfCumIntfHello, ripStatInPkts=ripStatInPkts, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ip_info=ip_info, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, arpInfoDestIp=arpInfoDestIp, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipCurCfgGwEntry=ipCurCfgGwEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaTableMaxSize=ospfAreaTableMaxSize, iprouting=iprouting, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfGeneral=ospfGeneral, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfGeneralStats=ospfGeneralStats, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripConfig=ripConfig, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaIntfIndex=ospfAreaIntfIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfNbrDown=ospfIntfNbrDown, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaNbrhello=ospfAreaNbrhello, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfHello=ospfIntfHello, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, arpInfoRefPorts=arpInfoRefPorts, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumNbrDown=ospfCumNbrDown, arpStats=arpStats, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpStatInAdvers=vrrpStatInAdvers, arpInfoTable=arpInfoTable, ospfCumRxTxStats=ospfCumRxTxStats, ipRouteInfoTable=ipRouteInfoTable, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfDown=ospfIntfDown, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCfg=ospfCfg, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIfInfoIndex=ospfIfInfoIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable)
