...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumRxDatabase=ospfCumRxDatabase, ripStatInErrorPkts=ripStatInErrorPkts, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfArea=ospfArea, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgGwAddr=ipNewCfgGwAddr, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgBootpState=ipNewCfgBootpState, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaRxHello=ospfAreaRxHello, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, routeStatHighWater=routeStatHighWater, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfinfo=ospfinfo, ripCurCfgState=ripCurCfgState, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfTxDatabase=ospfIntfTxDatabase, routerLSAAreaIndex=routerLSAAreaIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgGwArp=ipNewCfgGwArp, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumNbrStart=ospfCumNbrStart, ripNewCfgVip=ripNewCfgVip, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, arpInfoTable=arpInfoTable, ospfIntfUnloop=ospfIntfUnloop, ipForward=ipForward, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfInterface=ospfInterface, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, routeStatEntries=routeStatEntries, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpGeneral=vrrpGeneral, ripNewCfgState=ripNewCfgState, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumIntfLoop=ospfCumIntfLoop, ripStatOutPkts=ripStatOutPkts, ripNewCfgSupply=ripNewCfgSupply, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIfWaitInterval=ospfIfWaitInterval, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfDown=ospfIntfDown, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipCurCfgIntfMask=ipCurCfgIntfMask, ipRouteInfoInterface=ipRouteInfoInterface, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgIntfVlan=ipNewCfgIntfVlan, routeStats=routeStats, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumIntfDown=ospfCumIntfDown, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaRxPkts=ospfAreaRxPkts, ipGatewayTableMax=ipGatewayTableMax, arpStatMaxEntries=arpStatMaxEntries, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfTotalAreas=ospfTotalAreas, ospfCumRxlsAcks=ospfCumRxlsAcks, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaNbrDown=ospfAreaNbrDown, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfStats=ospfStats, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ripCurCfgVip=ripCurCfgVip, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfGeneral=ospfGeneral, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, dnsStats=dnsStats, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, arpStats=arpStats, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrp=vrrp, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaNbrIndex=ospfAreaNbrIndex, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpOper=vrrpOper, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, arpInfoSrcPort=arpInfoSrcPort, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripCurCfgDefListen=ripCurCfgDefListen, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ip_info=ip_info, ospfAreaInfoEntry=ospfAreaInfoEntry, ripNewCfgDefListen=ripNewCfgDefListen, arpStatHighWater=arpStatHighWater, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfNbrInExchState=ospfNbrInExchState, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgGwTable=ipNewCfgGwTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumTxPkts=ospfCumTxPkts, ospfAreaTxHello=ospfAreaTxHello, ipRouteInfoType=ipRouteInfoType, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfRxHello=ospfIntfRxHello, ospfStartTime=ospfStartTime, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaIntfHello=ospfAreaIntfHello, ipInterfaceTableMax=ipInterfaceTableMax)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipFwdCurCfgState=ipFwdCurCfgState, ripNewCfgListen=ripNewCfgListen, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumNbrDown=ospfCumNbrDown, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIfInfoIpAddress=ospfIfInfoIpAddress, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, arpInfoEntry=arpInfoEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaInfoIndex=ospfAreaInfoIndex, ipRouteInfoEntry=ipRouteInfoEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ripStatInPkts=ripStatInPkts, ospfNbrInFullState=ospfNbrInFullState, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumIntfHello=ospfCumIntfHello, ospfIntfRxPkts=ospfIntfRxPkts, iprouting=iprouting, ospfIntfCountForRouter=ospfIntfCountForRouter, routeStatMaxEntries=routeStatMaxEntries, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfLsTypesSupported=ospfLsTypesSupported, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, arpInfoDestIp=arpInfoDestIp, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCfg=ospfCfg, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipRouteInfoTable=ipRouteInfoTable, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaNbrhello=ospfAreaNbrhello, ripStats=ripStats, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumNbrhello=ospfCumNbrhello, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ripConfig=ripConfig, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfNbrInInitState=ospfNbrInInitState, ospfIntfHello=ospfIntfHello, ospfAreaRxlsAcks=ospfAreaRxlsAcks, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, routerLSALinkIndex=routerLSALinkIndex, ospfIntfNbrStart=ospfIntfNbrStart, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfGeneralStats=ospfGeneralStats, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfNbrhello=ospfIntfNbrhello, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgGwMetric=ipCurCfgGwMetric, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfNbrN1way=ospfIntfNbrN1way, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, routerLSAId=routerLSAId, ospfAreaTxPkts=ospfAreaTxPkts, ipRouteInfoTag=ipRouteInfoTag, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, arpInfoVLAN=arpInfoVLAN, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone)
