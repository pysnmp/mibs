...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpStats=arpStats, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ripNewCfgListen=ripNewCfgListen, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfGeneralStats=ospfGeneralStats, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumNbrStart=ospfCumNbrStart, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfDown=ospfIntfDown, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ripCurCfgState=ripCurCfgState, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripCurCfgVip=ripCurCfgVip, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrp_info=vrrp_info, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgIntfTable=ipCurCfgIntfTable, arpStatHighWater=arpStatHighWater, ospfAreaInfoEntry=ospfAreaInfoEntry, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgGwArp=ipNewCfgGwArp, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfStartTime=ospfStartTime, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumRxlsAcks=ospfCumRxlsAcks, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfBackup=ospfIntfBackup, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipRouteInfoGateway=ipRouteInfoGateway, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfGeneralInfo=ospfGeneralInfo, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumTxPkts=ospfCumTxPkts, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfArea=ospfArea, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ip_info=ip_info, ospfNbrInInitState=ospfNbrInInitState, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCfg=ospfCfg, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumRxPkts=ospfCumRxPkts, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, arpInfoTable=arpInfoTable, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfRxHello=ospfIntfRxHello, ospfCumNbrhello=ospfCumNbrhello, arpInfoDestIp=arpInfoDestIp, ospfGeneral=ospfGeneral, ospfAreaInfoTable=ospfAreaInfoTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaIntfHello=ospfAreaIntfHello, ospfCurCfgAreaId=ospfCurCfgAreaId, routerLSALinkID=routerLSALinkID, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ripNewCfgState=ripNewCfgState, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumIntfUnloop=ospfCumIntfUnloop, routeStatEntries=routeStatEntries, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, routerLSAAreaIndex=routerLSAAreaIndex, dnsStats=dnsStats, ospfAreaTableMaxSize=ospfAreaTableMaxSize, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, arpInfoMacAddr=arpInfoMacAddr, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, routerLSALinkData=routerLSALinkData, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfHostTableMaxSize=ospfHostTableMaxSize, ipRouteInfoMask=ipRouteInfoMask, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, arpStatEntries=arpStatEntries, ospfCumNbrN1way=ospfCumNbrN1way, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipRouteInfoTable=ipRouteInfoTable, ripStatOutPkts=ripStatOutPkts, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfInfoEntry=ospfIntfInfoEntry, routeStatHighWater=routeStatHighWater, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, routeStatMaxEntries=routeStatMaxEntries, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ripStatInErrorPkts=ripStatInErrorPkts, routerLSALinkIndex=routerLSALinkIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaNbrStart=ospfAreaNbrStart, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, iprouting=iprouting, ripStatInPkts=ripStatInPkts, arpInfoRefPorts=arpInfoRefPorts, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ripNewCfgSupply=ripNewCfgSupply, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipFwdNewCfgState=ipFwdNewCfgState, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfVlinkCountForRouter=ospfVlinkCountForRouter, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumTxHello=ospfCumTxHello, arpStatMaxEntries=arpStatMaxEntries, ospfStats=ospfStats, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumTxDatabase=ospfCumTxDatabase, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ripStats=ripStats, ospfAreaRxHello=ospfAreaRxHello, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIfInfoIndex=ospfIfInfoIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfTotalAreas=ospfTotalAreas, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ripCurCfgSupply=ripCurCfgSupply, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipNewCfgIntfMask=ipNewCfgIntfMask, ripNewCfgDefListen=ripNewCfgDefListen, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, routeStats=routeStats, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipRouteInfoType=ipRouteInfoType, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, arpInfoFlag=arpInfoFlag, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfIndex=ospfIntfIndex, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipRouteInfoIndx=ipRouteInfoIndx, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfProcessUptime=ospfProcessUptime, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfLoop=ospfIntfLoop, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaTxHello=ospfAreaTxHello, vrrpOper=vrrpOper, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpStats=vrrpStats, arpInfoEntry=arpInfoEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaInfoId=ospfAreaInfoId, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfNbrChange=ospfIntfNbrChange, ripConfig=ripConfig, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfInfoTable=ospfIntfInfoTable, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrp=vrrp, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumRxHello=ospfCumRxHello, ospfNbrInExchState=ospfNbrInExchState, ospfCumIntfDown=ospfCumIntfDown, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCumIntfHello=ospfCumIntfHello, ipFwdCurCfgState=ipFwdCurCfgState, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ripCurCfgListen=ripCurCfgListen, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgIntfMask=ipCurCfgIntfMask, ripCurCfgDefListen=ripCurCfgDefListen, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, routerLSAId=routerLSAId, ripNewCfgVip=ripNewCfgVip, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipForward=ipForward, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpGeneral=vrrpGeneral, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port)
