...
Integer32, Bits, Unsigned32, NotificationType, IpAddress, ModuleIdentity, MibIdentifier, iso, TimeTicks, Counter64, ObjectIdentity, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "Unsigned32", "NotificationType", "IpAddress", "ModuleIdentity", "MibIdentifier", "iso", "TimeTicks", "Counter64", "ObjectIdentity", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCumRxHello=ospfCumRxHello, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumIntfDown=ospfCumIntfDown, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfNbrInExchState=ospfNbrInExchState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfStartTime=ospfStartTime, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumRxlsAcks=ospfCumRxlsAcks, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, arpInfoEntry=arpInfoEntry, ipInterfaceTableMax=ipInterfaceTableMax, ospfGeneralStats=ospfGeneralStats, ospfTotalAreas=ospfTotalAreas, arpInfoDestIp=arpInfoDestIp, ospfCumIntfUnloop=ospfCumIntfUnloop, routeStatHighWater=routeStatHighWater, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgGwArp=ipNewCfgGwArp, ipRouteInfoTable=ipRouteInfoTable, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfTxHello=ospfIntfTxHello, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumIntfBackup=ospfCumIntfBackup, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrp_info=vrrp_info, ospfIfWaitInterval=ospfIfWaitInterval, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfProcessUptime=ospfProcessUptime, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumRxlsReqs=ospfCumRxlsReqs, arpStatEntries=arpStatEntries, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfArea=ospfArea, ipNewCfgGwState=ipNewCfgGwState, ipCurCfgGwArp=ipCurCfgGwArp, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumNbrhello=ospfCumNbrhello, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaRxHello=ospfAreaRxHello, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgBootpState=ipCurCfgBootpState, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpOper=vrrpOper, ipNewCfgIntfState=ipNewCfgIntfState, vrrpGeneral=vrrpGeneral, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumTxHello=ospfCumTxHello, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ripNewCfgVip=ripNewCfgVip, ipRouteInfoMask=ipRouteInfoMask, ospfCfg=ospfCfg, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfGeneralInfo=ospfGeneralInfo, ospfAreaRxPkts=ospfAreaRxPkts, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumIntfHello=ospfCumIntfHello, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfTxPkts=ospfIntfTxPkts, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ripNewCfgListen=ripNewCfgListen, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCumTxlsAcks=ospfCumTxlsAcks, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ripCurCfgVip=ripCurCfgVip, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfRxDatabase=ospfIntfRxDatabase, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, iprouting=iprouting, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaInfoId=ospfAreaInfoId, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfinfo=ospfinfo, ipCurCfgIntfTable=ipCurCfgIntfTable, ipRouteInfoType=ipRouteInfoType, ospfIntfInfoTable=ospfIntfInfoTable, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdCurCfgState=ipFwdCurCfgState, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfNbrRstAd=ospfIntfNbrRstAd, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgIntfMask=ipCurCfgIntfMask, arpStatHighWater=arpStatHighWater, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumTxPkts=ospfCumTxPkts, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumRxPkts=ospfCumRxPkts, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgGwState=ipCurCfgGwState, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpStatInAdvers=vrrpStatInAdvers, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfStats=ospfStats, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfChangeStats=ospfIntfChangeStats, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumNbrN1way=ospfCumNbrN1way, ip_info=ip_info, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpStats=vrrpStats, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipRouteInfoDestIp=ipRouteInfoDestIp, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgGwInterval=ipCurCfgGwInterval, routerLSALinkData=routerLSALinkData, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ripCurCfgSupply=ripCurCfgSupply, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripConfig=ripConfig, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaRxTxStats=ospfAreaRxTxStats, ipForward=ipForward, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ripStatOutPkts=ripStatOutPkts, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaNbrhello=ospfAreaNbrhello, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfNbrInFullState=ospfNbrInFullState, ospfIntfIndex=ospfIntfIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgGwInterval=ipNewCfgGwInterval, ripNewCfgSupply=ripNewCfgSupply, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrp=vrrp, ospfAreaNbrIndex=ospfAreaNbrIndex, routeStats=routeStats, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, routeStatEntries=routeStatEntries, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfHello=ospfIntfHello, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfDown=ospfIntfDown, arpStatMaxEntries=arpStatMaxEntries, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgGwTable=ipNewCfgGwTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipFwdNewCfgState=ipFwdNewCfgState, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaNbrStart=ospfAreaNbrStart, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfTotalNssaAreas=ospfTotalNssaAreas, dnsStats=dnsStats, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ripCurCfgState=ripCurCfgState, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfBackup=ospfIntfBackup, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, arpStats=arpStats, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, arpInfoFlag=arpInfoFlag, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripCurCfgListen=ripCurCfgListen, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfGeneral=ospfGeneral, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipRouteInfoInterface=ipRouteInfoInterface, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ripStats=ripStats, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaIntfDown=ospfAreaIntfDown, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ripStatInPkts=ripStatInPkts, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumNbrStart=ospfCumNbrStart, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, routerLSALinkID=routerLSALinkID, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaTxHello=ospfAreaTxHello)
