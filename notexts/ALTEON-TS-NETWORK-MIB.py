...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfNbrStart=ospfIntfNbrStart, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumRxlsAcks=ospfCumRxlsAcks, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, arpInfoDestIp=arpInfoDestIp, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfInterface=ospfInterface, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumIntfBackup=ospfCumIntfBackup, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgGwAddr=ipCurCfgGwAddr, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgGwEntry=ipNewCfgGwEntry, ipRouteInfoGateway=ipRouteInfoGateway, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfDown=ospfIntfDown, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ripCurCfgState=ripCurCfgState, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripNewCfgVip=ripNewCfgVip, ospfTotalTransitAreas=ospfTotalTransitAreas, ripNewCfgListen=ripNewCfgListen, arpInfoTable=arpInfoTable, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumTxlsAcks=ospfCumTxlsAcks, ripNewCfgState=ripNewCfgState, ripStatInErrorPkts=ripStatInErrorPkts, ipRouteInfoTag=ipRouteInfoTag, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipRouteInfoType=ipRouteInfoType, vrrp_info=vrrp_info, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumIntfHello=ospfCumIntfHello, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpOper=vrrpOper, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfNbrN1way=ospfIntfNbrN1way, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumRxPkts=ospfCumRxPkts, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfGeneral=ospfGeneral, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgGwTable=ipNewCfgGwTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, dnsStats=dnsStats, ospfIntfRxHello=ospfIntfRxHello, ripCurCfgSupply=ripCurCfgSupply, ripNewCfgDefListen=ripNewCfgDefListen, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpStatInAdvers=vrrpStatInAdvers, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, arpInfoVLAN=arpInfoVLAN, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ripCurCfgVip=ripCurCfgVip, ospfNbrInInitState=ospfNbrInInitState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipRouteInfoTable=ipRouteInfoTable, arpInfoSrcPort=arpInfoSrcPort, ospfNbrInExchState=ospfNbrInExchState, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfArea=ospfArea, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfNbrhello=ospfIntfNbrhello, arpInfoFlag=arpInfoFlag, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipForward=ipForward, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumNbrStart=ospfCumNbrStart, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfChangeStats=ospfIntfChangeStats, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaRxlsAcks=ospfAreaRxlsAcks, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ripCurCfgDefListen=ripCurCfgDefListen, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfNewCfgAreaId=ospfNewCfgAreaId, ripStats=ripStats, ospfCumIntfDown=ospfCumIntfDown, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfGeneralInfo=ospfGeneralInfo, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumTxHello=ospfCumTxHello, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, arpStatEntries=arpStatEntries, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIfInfoIpAddress=ospfIfInfoIpAddress, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfTimersKickOffStats=ospfTimersKickOffStats, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumRxHello=ospfCumRxHello, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgGwArp=ipCurCfgGwArp, ospfinfo=ospfinfo, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipCurCfgGwState=ipCurCfgGwState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ripConfig=ripConfig, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripStatInPkts=ripStatInPkts, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, routeStats=routeStats, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfNbrInFullState=ospfNbrInFullState, routeStatMaxEntries=routeStatMaxEntries, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaNbrDown=ospfAreaNbrDown, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfProcessUptime=ospfProcessUptime, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumTxPkts=ospfCumTxPkts, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgGwRetry=ipNewCfgGwRetry, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfTxlsReqs=ospfIntfTxlsReqs, arpInfoEntry=arpInfoEntry, routerLSALinkData=routerLSALinkData, ospfIntfNbrChange=ospfIntfNbrChange, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipRouteInfoInterface=ipRouteInfoInterface, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaInfoId=ospfAreaInfoId, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfStats=ospfStats, ospfIntfHello=ospfIntfHello, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, iprouting=iprouting, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumRxTxStats=ospfCumRxTxStats, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, arpStatHighWater=arpStatHighWater, ipNewCfgBootpState=ipNewCfgBootpState, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCfg=ospfCfg, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ripCurCfgListen=ripCurCfgListen, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaIntfDown=ospfAreaIntfDown, routerLSALinkID=routerLSALinkID, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipRouteInfoIndx=ipRouteInfoIndx, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaTxHello=ospfAreaTxHello, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfUnloop=ospfIntfUnloop, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIfInfoIndex=ospfIfInfoIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrp=vrrp, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, arpStats=arpStats, ospfAreaIntfIndex=ospfAreaIntfIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, routerLSAId=routerLSAId, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumNbrChangeStats=ospfCumNbrChangeStats, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, routerLSAAreaIndex=routerLSAAreaIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfBackup=ospfIntfBackup, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdNewCfgState=ipFwdNewCfgState, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ripStatOutPkts=ripStatOutPkts, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfStartTime=ospfStartTime, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, routeStatEntries=routeStatEntries, ospfIntfIndex=ospfIntfIndex, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ip_info=ip_info, routeStatHighWater=routeStatHighWater, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction)
