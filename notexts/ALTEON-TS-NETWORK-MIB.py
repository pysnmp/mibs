...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfLoop=ospfIntfLoop, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipGatewayTableMax=ipGatewayTableMax, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumRxDatabase=ospfCumRxDatabase, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, routeStatHighWater=routeStatHighWater, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgGwInterval=ipNewCfgGwInterval, ripStatInErrorPkts=ripStatInErrorPkts, ipRouteInfoTable=ipRouteInfoTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaTxHello=ospfAreaTxHello, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfGeneralStats=ospfGeneralStats, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumNbrStart=ospfCumNbrStart, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfBackup=ospfIntfBackup, ospfIntfRxPkts=ospfIntfRxPkts, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfHello=ospfIntfHello, ospfAreaNbrN1way=ospfAreaNbrN1way, routeStats=routeStats, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgGwIndex=ipNewCfgGwIndex, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, dnsStats=dnsStats, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfUnloop=ospfIntfUnloop, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfTotalAreas=ospfTotalAreas, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaRxHello=ospfAreaRxHello, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, arpStatEntries=arpStatEntries, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfTxHello=ospfIntfTxHello, ospfAreaNbrIndex=ospfAreaNbrIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ripNewCfgVip=ripNewCfgVip, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, iprouting=iprouting, arpInfoTable=arpInfoTable, ospfAreaIntfHello=ospfAreaIntfHello, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCfg=ospfCfg, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ripConfig=ripConfig, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ripCurCfgSupply=ripCurCfgSupply, ospfCumRxPkts=ospfCumRxPkts, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, routerLSAId=routerLSAId, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ripStatInPkts=ripStatInPkts, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgGwState=ipNewCfgGwState, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, arpInfoFlag=arpInfoFlag, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgGwInterval=ipCurCfgGwInterval, ripNewCfgListen=ripNewCfgListen, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpGeneral=vrrpGeneral, ospfCumNbrN1way=ospfCumNbrN1way, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ripCurCfgListen=ripCurCfgListen, ospfIfWaitInterval=ospfIfWaitInterval, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ripCurCfgVip=ripCurCfgVip, ospfCumIntfDown=ospfCumIntfDown, ospfAreaChangeStats=ospfAreaChangeStats, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfInfoTable=ospfIntfInfoTable, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpStatInAdvers=vrrpStatInAdvers, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfRxDatabase=ospfIntfRxDatabase, ripCurCfgState=ripCurCfgState, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfArea=ospfArea, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, arpInfoVLAN=arpInfoVLAN, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumNbrhello=ospfCumNbrhello, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfDown=ospfIntfDown, vrrpOper=vrrpOper)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgGenState=vrrpCurCfgGenState, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrp=vrrp, ospfIntfNbrChange=ospfIntfNbrChange, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ip_info=ip_info, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipCurCfgGwState=ipCurCfgGwState, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfStats=ospfStats, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfNbrhello=ospfIntfNbrhello, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, routeStatEntries=routeStatEntries, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, routerLSAAreaIndex=routerLSAAreaIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, arpInfoEntry=arpInfoEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumIntfHello=ospfCumIntfHello, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfGeneral=ospfGeneral, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumTxHello=ospfCumTxHello, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, arpInfoMacAddr=arpInfoMacAddr, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgBootpState=ipNewCfgBootpState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfStartTime=ospfStartTime, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, arpInfoRefPorts=arpInfoRefPorts, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfChangeStats=ospfIntfChangeStats, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgGwEntry=ipCurCfgGwEntry, routerLSALinkIndex=routerLSALinkIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfInterface=ospfInterface, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ripStatOutPkts=ripStatOutPkts, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumTxPkts=ospfCumTxPkts, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipInterfaceTableMax=ipInterfaceTableMax, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ripStats=ripStats, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumTxDatabase=ospfCumTxDatabase, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrp_info=vrrp_info, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgGwEntry=ipNewCfgGwEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipForward=ipForward, ospfNbrInExchState=ospfNbrInExchState, arpStats=arpStats, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, arpInfoDestIp=arpInfoDestIp, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgGwRetry=ipNewCfgGwRetry, routeStatMaxEntries=routeStatMaxEntries, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc)
