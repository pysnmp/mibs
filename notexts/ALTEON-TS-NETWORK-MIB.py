...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgGwMetric=ipCurCfgGwMetric, arpStatEntries=arpStatEntries, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgGwEntry=ipCurCfgGwEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgGwTable=ipCurCfgGwTable, ospfinfo=ospfinfo, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, arpInfoSrcPort=arpInfoSrcPort, ipRouteInfoEntry=ipRouteInfoEntry, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, arpStats=arpStats, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ripCurCfgDefListen=ripCurCfgDefListen, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpGeneral=vrrpGeneral, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfTxHello=ospfIntfTxHello, ipRouteInfoTable=ipRouteInfoTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumNbrStart=ospfCumNbrStart, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgIntfIndex=ipNewCfgIntfIndex, dnsStats=dnsStats, vrrpStats=vrrpStats, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ripCurCfgState=ripCurCfgState, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumIntfLoop=ospfCumIntfLoop, ospfProcessUptime=ospfProcessUptime, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfInterface=ospfInterface, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, routeStats=routeStats, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrp=vrrp, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfUnloop=ospfIntfUnloop, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipForward=ipForward, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, routeStatHighWater=routeStatHighWater, ospfCumTxHello=ospfCumTxHello, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumIntfHello=ospfCumIntfHello, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgGwDelete=ipNewCfgGwDelete, routerLSAId=routerLSAId, routerLSALinkID=routerLSALinkID, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, arpInfoTable=arpInfoTable, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, arpInfoFlag=arpInfoFlag, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipRouteInfoTag=ipRouteInfoTag, ospfStartTime=ospfStartTime, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipCurCfgIntfState=ipCurCfgIntfState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaRxHello=ospfAreaRxHello, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaNbrhello=ospfAreaNbrhello, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfTotalTransitAreas=ospfTotalTransitAreas, ripNewCfgDefListen=ripNewCfgDefListen, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfIndex=ospfIntfIndex, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ripStatInPkts=ripStatInPkts, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfHello=ospfIntfHello, ripNewCfgState=ripNewCfgState, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfBackup=ospfIntfBackup, arpInfoVLAN=arpInfoVLAN, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ripConfig=ripConfig, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaNbrStart=ospfAreaNbrStart, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, routerLSALinkData=routerLSALinkData, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, arpInfoDestIp=arpInfoDestIp, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipRouteInfoMask=ipRouteInfoMask, ospfAreaNbrDown=ospfAreaNbrDown, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfDown=ospfIntfDown, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCumTxPkts=ospfCumTxPkts, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfTotalAreas=ospfTotalAreas, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ripStatInErrorPkts=ripStatInErrorPkts, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpStatInAdvers=vrrpStatInAdvers, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgGwVlan=ipNewCfgGwVlan, routeStatMaxEntries=routeStatMaxEntries, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaInfoId=ospfAreaInfoId, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgIntfState=ipNewCfgIntfState, arpInfoRefPorts=arpInfoRefPorts, vrrpOper=vrrpOper, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, arpInfoEntry=arpInfoEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaTxPkts=ospfAreaTxPkts, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfNbrStart=ospfIntfNbrStart, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripCurCfgVip=ripCurCfgVip, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, routeStatEntries=routeStatEntries, ipRouteInfoGateway=ipRouteInfoGateway, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, arpStatHighWater=arpStatHighWater, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripCurCfgListen=ripCurCfgListen, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ip_info=ip_info, ospfAreaInfoTable=ospfAreaInfoTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfNbrInFullState=ospfNbrInFullState, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaRxTxStats=ospfAreaRxTxStats, routerLSALinkIndex=routerLSALinkIndex, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfArea=ospfArea, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgIfTable=vrrpCurCfgIfTable, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumRxHello=ospfCumRxHello, vrrp_info=vrrp_info, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ripCurCfgSupply=ripCurCfgSupply, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfNbrDown=ospfIntfNbrDown, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaRxDatabase=ospfAreaRxDatabase, ipRouteInfoIndx=ipRouteInfoIndx, iprouting=iprouting, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaTxHello=ospfAreaTxHello, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgGwState=ipNewCfgGwState, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ripNewCfgSupply=ripNewCfgSupply, ospfStats=ospfStats, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumIntfDown=ospfCumIntfDown, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfLoop=ospfIntfLoop, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgGenState=vrrpCurCfgGenState, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfRxPkts=ospfIntfRxPkts, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumNbrN1way=ospfCumNbrN1way, ripStats=ripStats, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ripNewCfgListen=ripNewCfgListen, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCfg=ospfCfg, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfNbrInExchState=ospfNbrInExchState)
