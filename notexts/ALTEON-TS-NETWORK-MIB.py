...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", dnsStats=dnsStats, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, routerLSALinkIfIndex=routerLSALinkIfIndex, ripNewCfgSupply=ripNewCfgSupply, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumTxHello=ospfCumTxHello, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipRouteInfoMask=ipRouteInfoMask, ospfIntfUnloop=ospfIntfUnloop, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ripStatInPkts=ripStatInPkts, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfNewCfgAreaId=ospfNewCfgAreaId, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ripCurCfgVip=ripCurCfgVip, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaInfoId=ospfAreaInfoId, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumIntfDown=ospfCumIntfDown, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, arpInfoTable=arpInfoTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumNbrhello=ospfCumNbrhello, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipNewCfgBootpAddr=ipNewCfgBootpAddr, routeStatHighWater=routeStatHighWater, routeStatMaxEntries=routeStatMaxEntries, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ripNewCfgListen=ripNewCfgListen, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ripNewCfgDefListen=ripNewCfgDefListen, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpStatInAdvers=vrrpStatInAdvers, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfTxDatabase=ospfIntfTxDatabase, ipForward=ipForward, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, arpInfoFlag=arpInfoFlag, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgIntfMask=ipCurCfgIntfMask, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfStats=ospfStats, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfNbrStart=ospfIntfNbrStart, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumRxPkts=ospfCumRxPkts, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfRxHello=ospfIntfRxHello, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrp_info=vrrp_info, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgGwState=ipNewCfgGwState, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfGeneral=ospfGeneral, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumRxHello=ospfCumRxHello, ipFwdNewCfgState=ipFwdNewCfgState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfInfoTable=ospfIntfInfoTable, ip_info=ip_info, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfLoop=ospfIntfLoop, ospfAreaTxPkts=ospfAreaTxPkts, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpGeneral=vrrpGeneral, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpStatOutAdvers=vrrpStatOutAdvers, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfIndex=ospfIntfIndex, ospfProcessUptime=ospfProcessUptime, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipRouteInfoEntry=ipRouteInfoEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpOper=vrrpOper, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfNbrInExchState=ospfNbrInExchState, ospfAreaIntfDown=ospfAreaIntfDown, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipRouteInfoTable=ipRouteInfoTable, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfRxTxStats=ospfIntfRxTxStats, routerLSALinkIndex=routerLSALinkIndex, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrp=vrrp, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipGatewayTableMax=ipGatewayTableMax, ospfCumIntfUnloop=ospfCumIntfUnloop, arpStats=arpStats, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumNbrN1way=ospfCumNbrN1way, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ripStatOutPkts=ripStatOutPkts, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfArea=ospfArea, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfBackup=ospfIntfBackup, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipNewCfgGwVlan=ipNewCfgGwVlan, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfinfo=ospfinfo, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfWaitTimer=ospfIntfWaitTimer, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipInterfaceTableMax=ipInterfaceTableMax, routeStats=routeStats, ospfNbrInInitState=ospfNbrInInitState, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpStats=vrrpStats, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipRouteInfoGateway=ipRouteInfoGateway, ipRouteInfoType=ipRouteInfoType, routerLSALinkData=routerLSALinkData, ospfIntfHello=ospfIntfHello, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCfg=ospfCfg, ripStats=ripStats, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaRxHello=ospfAreaRxHello, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumIntfLoop=ospfCumIntfLoop, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfNbrhello=ospfIntfNbrhello, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, arpInfoVLAN=arpInfoVLAN, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipCurCfgGwState=ipCurCfgGwState, arpInfoEntry=arpInfoEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfTotalAreas=ospfTotalAreas, routerLSALinkID=routerLSALinkID, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfInterface=ospfInterface, ripConfig=ripConfig, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumNbrRstAd=ospfCumNbrRstAd, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfRxDatabase=ospfIntfRxDatabase, iprouting=iprouting, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfTxHello=ospfIntfTxHello, arpInfoSrcPort=arpInfoSrcPort, ospfGeneralStats=ospfGeneralStats, ripNewCfgState=ripNewCfgState)
