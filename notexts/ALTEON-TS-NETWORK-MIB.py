...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgGenState=vrrpNewCfgGenState, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCumNbrhello=ospfCumNbrhello, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaInfoEntry=ospfAreaInfoEntry, routerLSAId=routerLSAId, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ripCurCfgVip=ripCurCfgVip, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, arpInfoFlag=arpInfoFlag, vrrpOper=vrrpOper, ospfAreaIntfBackup=ospfAreaIntfBackup, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfGeneralStats=ospfGeneralStats, ipGatewayTableMax=ipGatewayTableMax, ospfAreaInfoId=ospfAreaInfoId, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, arpInfoRefPorts=arpInfoRefPorts, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfStartTime=ospfStartTime, ipFwdNewCfgState=ipFwdNewCfgState, ospfNbrInFullState=ospfNbrInFullState, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgGwTable=ipNewCfgGwTable, ripConfig=ripConfig, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfDown=ospfIntfDown, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfStats=ospfStats, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCfg=ospfCfg, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipForward=ipForward, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipCurCfgIntfTable=ipCurCfgIntfTable, ripStats=ripStats, routerLSALinkIndex=routerLSALinkIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaIntfDown=ospfAreaIntfDown, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumTxHello=ospfCumTxHello, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgIntfMask=ipNewCfgIntfMask, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripCurCfgState=ripCurCfgState, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, routeStats=routeStats, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ripNewCfgVip=ripNewCfgVip, iprouting=iprouting, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ripStatRoutesAgedOut=ripStatRoutesAgedOut, arpInfoSrcPort=arpInfoSrcPort, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, arpInfoTable=arpInfoTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, dnsStats=dnsStats, vrrpStats=vrrpStats, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumRxHello=ospfCumRxHello, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgBootpState=ipCurCfgBootpState, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumIntfHello=ospfCumIntfHello, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfTimersKickOffStats=ospfTimersKickOffStats, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfGeneralInfo=ospfGeneralInfo, arpInfoMacAddr=arpInfoMacAddr, routeStatEntries=routeStatEntries, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfArea=ospfArea, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgGwInterval=ipCurCfgGwInterval, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfNbrStart=ospfIntfNbrStart, routerLSALinkID=routerLSALinkID, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpGeneral=vrrpGeneral, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ripStatOutPkts=ripStatOutPkts, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, routeStatMaxEntries=routeStatMaxEntries, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaNbrDown=ospfAreaNbrDown, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgGwMetric=ipNewCfgGwMetric, routerLSALinkData=routerLSALinkData, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfInterface=ospfInterface, ospfIntfIndex=ospfIntfIndex, ospfAreaIntfHello=ospfAreaIntfHello, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaNbrhello=ospfAreaNbrhello, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrp=vrrp, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfNbrInInitState=ospfNbrInInitState, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumNbrStart=ospfCumNbrStart, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, arpInfoEntry=arpInfoEntry, ospfIntfTxPkts=ospfIntfTxPkts, ipRouteInfoType=ipRouteInfoType, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ripNewCfgListen=ripNewCfgListen, ospfIntfRxHello=ospfIntfRxHello, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ripNewCfgSupply=ripNewCfgSupply, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfRxlsReqs=ospfIntfRxlsReqs, arpStatMaxEntries=arpStatMaxEntries, ospfProcessUptime=ospfProcessUptime, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfNbrChange=ospfIntfNbrChange, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfNbrhello=ospfIntfNbrhello, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfinfo=ospfinfo, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaRxlsAcks=ospfAreaRxlsAcks, arpStatEntries=arpStatEntries, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumNbrN1way=ospfCumNbrN1way, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, arpStats=arpStats, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgGwRetry=ipCurCfgGwRetry, ripCurCfgListen=ripCurCfgListen, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaIntfIndex=ospfAreaIntfIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ripStatInPkts=ripStatInPkts, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfTotalAreas=ospfTotalAreas, routeStatHighWater=routeStatHighWater, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumNbrDown=ospfCumNbrDown, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, arpInfoVLAN=arpInfoVLAN, ipNewCfgBootpState=ipNewCfgBootpState, arpInfoDestIp=arpInfoDestIp, ospfAreaTxPkts=ospfAreaTxPkts, ospfTotalNeighbours=ospfTotalNeighbours, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfNbrDown=ospfIntfNbrDown, ip_info=ip_info, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgGwState=ipNewCfgGwState, ipRouteInfoMask=ipRouteInfoMask, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipRouteInfoGateway=ipRouteInfoGateway, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast)
