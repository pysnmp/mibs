...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ripNewCfgListen=ripNewCfgListen, vrrpGeneral=vrrpGeneral, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumRxPkts=ospfCumRxPkts, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfProcessUptime=ospfProcessUptime, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaInfoId=ospfAreaInfoId, arpInfoSrcPort=arpInfoSrcPort, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipRouteInfoType=ipRouteInfoType, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumIntfBackup=ospfCumIntfBackup, arpInfoMacAddr=arpInfoMacAddr, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfTotalAreas=ospfTotalAreas, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipForward=ipForward, ospfInterface=ospfInterface, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCumNbrStart=ospfCumNbrStart, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ripStatOutPkts=ripStatOutPkts, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgIntfVlan=ipCurCfgIntfVlan, routerLSALinkData=routerLSALinkData, routeStatMaxEntries=routeStatMaxEntries, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCfg=ospfCfg, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipRouteInfoTag=ipRouteInfoTag, arpStatMaxEntries=arpStatMaxEntries, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumNbrRstAd=ospfCumNbrRstAd, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfStartTime=ospfStartTime, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrRstAd=ospfIntfNbrRstAd, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfUnloop=ospfIntfUnloop, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ripNewCfgVip=ripNewCfgVip, ripNewCfgState=ripNewCfgState, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumNbrhello=ospfCumNbrhello, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ripNewCfgStaticSupply=ripNewCfgStaticSupply, arpInfoTable=arpInfoTable, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgGwTable=ipCurCfgGwTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipRouteInfoMask=ipRouteInfoMask, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfHello=ospfIntfHello, ospfIntfRxPkts=ospfIntfRxPkts, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ripStatInPkts=ripStatInPkts, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaTxHello=ospfAreaTxHello, ospfIntfDown=ospfIntfDown, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfNbrChange=ospfIntfNbrChange, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, routeStatEntries=routeStatEntries, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ripStats=ripStats, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfBackup=ospfIntfBackup, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfArea=ospfArea, ripConfig=ripConfig, arpInfoEntry=arpInfoEntry, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpStats=vrrpStats, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipFwdNewCfgState=ipFwdNewCfgState, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumRxDatabase=ospfCumRxDatabase, ipRouteInfoInterface=ipRouteInfoInterface, ospfNbrInInitState=ospfNbrInInitState, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ripCurCfgListen=ripCurCfgListen, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumRxHello=ospfCumRxHello, ip_info=ip_info, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, iprouting=iprouting, ospfAreaIntfHello=ospfAreaIntfHello, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgIntfTable=ipCurCfgIntfTable, ipRouteInfoEntry=ipRouteInfoEntry, vrrp_info=vrrp_info, ipRouteInfoTable=ipRouteInfoTable, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrp=vrrp)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaRxHello=ospfAreaRxHello, ospfAreaNbrIndex=ospfAreaNbrIndex, ipRouteInfoGateway=ipRouteInfoGateway, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfGeneralStats=ospfGeneralStats, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpStatInAdvers=vrrpStatInAdvers, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, arpInfoFlag=arpInfoFlag, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, arpStatEntries=arpStatEntries, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, dnsStats=dnsStats, ospfAreaNbrhello=ospfAreaNbrhello, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgGwTable=ipNewCfgGwTable, ipRouteInfoIndx=ipRouteInfoIndx, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumIntfLoop=ospfCumIntfLoop, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfNbrN1way=ospfIntfNbrN1way, arpStats=arpStats, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdCurCfgState=ipFwdCurCfgState, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumIntfDown=ospfCumIntfDown, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfStats=ospfStats, ospfGeneralInfo=ospfGeneralInfo, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumTxPkts=ospfCumTxPkts, routerLSAId=routerLSAId, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaRxPkts=ospfAreaRxPkts, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfLoop=ospfIntfLoop, ospfCumIntfNbrChange=ospfCumIntfNbrChange, routeStats=routeStats, ospfGeneral=ospfGeneral, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfNewCfgAreaTable=ospfNewCfgAreaTable, routerLSALinkID=routerLSALinkID, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaChangeStats=ospfAreaChangeStats, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgBootpState=ipCurCfgBootpState, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumIntfHello=ospfCumIntfHello, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpOper=vrrpOper, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumTxHello=ospfCumTxHello, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ripNewCfgDefListen=ripNewCfgDefListen, ipCurCfgGwMetric=ipCurCfgGwMetric, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIfInfoIndex=ospfIfInfoIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ripCurCfgState=ripCurCfgState, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfIndex=ospfIntfIndex, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipGatewayTableMax=ipGatewayTableMax, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, routerLSALinkIndex=routerLSALinkIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize)
