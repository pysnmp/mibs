...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", routeStatMaxEntries=routeStatMaxEntries, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfNbrStart=ospfIntfNbrStart, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfArea=ospfArea, ospfCumRxHello=ospfCumRxHello, ipFwdCurCfgState=ipFwdCurCfgState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, arpStatMaxEntries=arpStatMaxEntries, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ripStatInErrorPkts=ripStatInErrorPkts, ospfGeneralInfo=ospfGeneralInfo, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumTxPkts=ospfCumTxPkts, routeStatHighWater=routeStatHighWater, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, dnsStats=dnsStats, ipCurCfgGwMetric=ipCurCfgGwMetric, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, arpInfoMacAddr=arpInfoMacAddr, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaRxDatabase=ospfAreaRxDatabase, routerLSALinkIndex=routerLSALinkIndex, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfIndex=ospfIntfIndex, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfLoop=ospfIntfLoop, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCfg=ospfCfg, ospfAreaRxPkts=ospfAreaRxPkts, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfStats=ospfStats, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIfInfoIndex=ospfIfInfoIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfTotalNeighbours=ospfTotalNeighbours, ripStatOutPkts=ripStatOutPkts, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, arpInfoRefPorts=arpInfoRefPorts, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfInterface=ospfInterface, ospfCumNbrhello=ospfCumNbrhello, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfChangeStats=ospfIntfChangeStats, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfHostTableMaxSize=ospfHostTableMaxSize, ipForward=ipForward, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfInfoTable=ospfIntfInfoTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfGeneral=ospfGeneral, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaIntfDown=ospfAreaIntfDown, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipRouteInfoType=ipRouteInfoType, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ripConfig=ripConfig, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaRxHello=ospfAreaRxHello, ipCurCfgGwTable=ipCurCfgGwTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpOper=vrrpOper, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipCurCfgGwState=ipCurCfgGwState, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, routerLSALinkIfIndex=routerLSALinkIfIndex, arpInfoSrcPort=arpInfoSrcPort, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfNbrInFullState=ospfNbrInFullState, ospfIntfInfoEntry=ospfIntfInfoEntry, ipRouteInfoDestIp=ipRouteInfoDestIp, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipFwdNewCfgState=ipFwdNewCfgState, routerLSALinkID=routerLSALinkID, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgBootpState=ipCurCfgBootpState, ip_info=ip_info, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, arpInfoTable=arpInfoTable, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfProcessUptime=ospfProcessUptime, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaInfoIndex=ospfAreaInfoIndex, routerLSALinkData=routerLSALinkData, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumTxDatabase=ospfCumTxDatabase, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, arpStatHighWater=arpStatHighWater, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ripStats=ripStats, ipNewCfgGwIndex=ipNewCfgGwIndex, ripCurCfgState=ripCurCfgState, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfTxHello=ospfIntfTxHello, vrrp=vrrp, ipRouteInfoInterface=ipRouteInfoInterface, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ripCurCfgListen=ripCurCfgListen, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipRouteInfoTag=ipRouteInfoTag, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ripStatInPkts=ripStatInPkts, ospfAreaRxTxStats=ospfAreaRxTxStats, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripNewCfgState=ripNewCfgState, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipRouteInfoIndx=ipRouteInfoIndx, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ripNewCfgVip=ripNewCfgVip, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfDown=ospfIntfDown, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumNbrDown=ospfCumNbrDown, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumTxHello=ospfCumTxHello, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrp_info=vrrp_info, ospfTotalAreas=ospfTotalAreas, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgIntfState=ipCurCfgIntfState, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfNbrInInitState=ospfNbrInInitState, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfUnloop=ospfIntfUnloop, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCumNbrStart=ospfCumNbrStart, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgGwState=ipNewCfgGwState, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipCurCfgGwRetry=ipCurCfgGwRetry, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ripCurCfgVip=ripCurCfgVip, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfRxDatabase=ospfIntfRxDatabase, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumRxPkts=ospfCumRxPkts, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfGeneralStats=ospfGeneralStats, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpStatInAdvers=vrrpStatInAdvers, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgGwEntry=ipCurCfgGwEntry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, iprouting=iprouting, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, arpInfoEntry=arpInfoEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumNbrChangeStats=ospfCumNbrChangeStats, arpStats=arpStats, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfinfo=ospfinfo, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaTxHello=ospfAreaTxHello, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumIntfLoop=ospfCumIntfLoop, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfBackup=ospfIntfBackup, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, arpInfoVLAN=arpInfoVLAN, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgGwVlan=ipCurCfgGwVlan, routeStats=routeStats, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfNbrN1way=ospfIntfNbrN1way)
