...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumRxPkts=ospfCumRxPkts, ospfIntfHello=ospfIntfHello, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, routerLSALinkIfIndex=routerLSALinkIfIndex, arpInfoEntry=arpInfoEntry, ip_info=ip_info, ipGatewayTableMax=ipGatewayTableMax, ospfProcessUptime=ospfProcessUptime, ripStats=ripStats, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfRxHello=ospfIntfRxHello, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfinfo=ospfinfo, ripStatOutPkts=ripStatOutPkts, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaInfoId=ospfAreaInfoId, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipForward=ipForward, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfNbrChange=ospfIntfNbrChange, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipRouteInfoIndx=ipRouteInfoIndx, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, arpStatMaxEntries=arpStatMaxEntries, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipRouteInfoMask=ipRouteInfoMask, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaTxHello=ospfAreaTxHello, ospfCumNbrhello=ospfCumNbrhello, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumIntfHello=ospfCumIntfHello, routerLSALinkData=routerLSALinkData, ripNewCfgVip=ripNewCfgVip, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgIntfTable=ipNewCfgIntfTable, arpStats=arpStats, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgIntfState=ipNewCfgIntfState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, arpInfoDestIp=arpInfoDestIp, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgGwState=ipCurCfgGwState, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfNbrDown=ospfIntfNbrDown, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfIndex=ospfIntfIndex, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ripConfig=ripConfig, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, routeStatEntries=routeStatEntries, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpGeneral=vrrpGeneral, ospfIntfTxHello=ospfIntfTxHello, ipRouteInfoTable=ipRouteInfoTable, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ripCurCfgState=ripCurCfgState, ospfAreaInfoTable=ospfAreaInfoTable, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCfg=ospfCfg, ospfCumNbrDown=ospfCumNbrDown, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumIntfBackup=ospfCumIntfBackup, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfTotalNssaAreas=ospfTotalNssaAreas, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfGeneral=ospfGeneral, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumNbrN1way=ospfCumNbrN1way, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumTxlsReqs=ospfCumTxlsReqs, arpInfoSrcPort=arpInfoSrcPort, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfInterface=ospfInterface, ospfAreaNbrIndex=ospfAreaNbrIndex, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfInfoTable=ospfIntfInfoTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumTxHello=ospfCumTxHello, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaNbrhello=ospfAreaNbrhello, ospfArea=ospfArea, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfBackup=ospfIntfBackup, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgGwAddr=ipCurCfgGwAddr, arpInfoRefPorts=arpInfoRefPorts, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, routerLSALinkID=routerLSALinkID, ipRouteInfoType=ipRouteInfoType, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumRxTxStats=ospfCumRxTxStats, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgBootpState=ipNewCfgBootpState, arpInfoFlag=arpInfoFlag, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfLoop=ospfIntfLoop, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, dnsStats=dnsStats, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumTxPkts=ospfCumTxPkts, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgGenState=vrrpCurCfgGenState, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaRxHello=ospfAreaRxHello, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfTotalAreas=ospfTotalAreas, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfDown=ospfIntfDown, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpOper=vrrpOper, ospfGeneralInfo=ospfGeneralInfo, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgGwState=ipNewCfgGwState, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrp=vrrp, ospfStats=ospfStats, routeStatHighWater=routeStatHighWater, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, iprouting=iprouting, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpStatInAdvers=vrrpStatInAdvers, ospfLsTypesSupported=ospfLsTypesSupported, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, arpStatHighWater=arpStatHighWater, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, arpInfoVLAN=arpInfoVLAN, arpStatEntries=arpStatEntries, ospfIfInfoIndex=ospfIfInfoIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, routeStats=routeStats, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumRxlsUpdates=ospfCumRxlsUpdates, arpInfoMacAddr=arpInfoMacAddr, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ripNewCfgSupply=ripNewCfgSupply, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaIntfHello=ospfAreaIntfHello, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpStats=vrrpStats, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaNbrN1way=ospfAreaNbrN1way, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ripCurCfgListen=ripCurCfgListen, ripNewCfgState=ripNewCfgState, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipRouteInfoInterface=ipRouteInfoInterface, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumIntfDown=ospfCumIntfDown, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipRouteInfoTag=ipRouteInfoTag, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfTxPkts=ospfIntfTxPkts, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, routeStatMaxEntries=routeStatMaxEntries, ospfIntfNbrhello=ospfIntfNbrhello, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfNbrInInitState=ospfNbrInInitState, ospfCumRxDatabase=ospfCumRxDatabase, routerLSALinkIndex=routerLSALinkIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry)
