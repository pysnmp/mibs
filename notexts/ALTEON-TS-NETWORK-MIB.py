...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, dnsStats=dnsStats, vrrpStats=vrrpStats, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, routeStatEntries=routeStatEntries, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, routerLSALinkData=routerLSALinkData, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgIntfState=ipNewCfgIntfState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfDown=ospfIntfDown, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumTxlsReqs=ospfCumTxlsReqs, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipRouteInfoTag=ipRouteInfoTag, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfUnloop=ospfIntfUnloop, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumRxPkts=ospfCumRxPkts, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgGwVlan=ipNewCfgGwVlan, ripCurCfgDefListen=ripCurCfgDefListen, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgGwState=ipCurCfgGwState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipRouteInfoEntry=ipRouteInfoEntry, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, arpInfoDestIp=arpInfoDestIp, ospfNbrInInitState=ospfNbrInInitState, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaIntfBackup=ospfAreaIntfBackup, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgGwArp=ipCurCfgGwArp, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfGeneralStats=ospfGeneralStats, ospfTotalNeighbours=ospfTotalNeighbours, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumRxHello=ospfCumRxHello, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgBootpState=ipCurCfgBootpState, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIfInfoIndex=ospfIfInfoIndex, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, arpInfoMacAddr=arpInfoMacAddr, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, routeStats=routeStats, arpStatEntries=arpStatEntries, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ip_info=ip_info, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ripStatInPkts=ripStatInPkts, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumTxDatabase=ospfCumTxDatabase, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaRxPkts=ospfAreaRxPkts, ospfStats=ospfStats, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfBackup=ospfIntfBackup, ripNewCfgState=ripNewCfgState, ipRouteInfoType=ipRouteInfoType, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ripNewCfgVip=ripNewCfgVip, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaTxHello=ospfAreaTxHello, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgGwState=ipNewCfgGwState, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfChangeStats=ospfIntfChangeStats, routerLSALinkID=routerLSALinkID, ripStats=ripStats, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaInfoId=ospfAreaInfoId, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, arpInfoVLAN=arpInfoVLAN, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfTotalAreas=ospfTotalAreas, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfRxHello=ospfIntfRxHello, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfArea=ospfArea, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgGwEntry=ipCurCfgGwEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNewCfgAreaId=ospfNewCfgAreaId, iprouting=iprouting, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfCountForRouter=ospfIntfCountForRouter, ipForward=ipForward, routerLSAId=routerLSAId, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfHello=ospfIntfHello, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfNbrInExchState=ospfNbrInExchState, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumTxPkts=ospfCumTxPkts, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ripStatOutPkts=ripStatOutPkts, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaNbrhello=ospfAreaNbrhello, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfNbrRstAd=ospfIntfNbrRstAd, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumIntfHello=ospfCumIntfHello, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ripStatRoutesAgedOut=ripStatRoutesAgedOut, arpInfoSrcPort=arpInfoSrcPort, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrp=vrrp, ospfIfWaitInterval=ospfIfWaitInterval, ripNewCfgListen=ripNewCfgListen, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpGeneral=vrrpGeneral, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfIndex=ospfIntfIndex, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumNbrDown=ospfCumNbrDown, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, arpInfoEntry=arpInfoEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, arpStats=arpStats, vrrpOper=vrrpOper, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ripConfig=ripConfig, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCfg=ospfCfg, arpStatMaxEntries=arpStatMaxEntries, arpInfoFlag=arpInfoFlag, ospfAreaTableMaxSize=ospfAreaTableMaxSize, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpStatInAdvers=vrrpStatInAdvers, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumNbrStart=ospfCumNbrStart, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrp_info=vrrp_info, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumNbrhello=ospfCumNbrhello, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfInfoTable=ospfIntfInfoTable, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfTxDatabase=ospfIntfTxDatabase, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, arpInfoRefPorts=arpInfoRefPorts, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfinfo=ospfinfo, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaNbrStart=ospfAreaNbrStart, ospfStartTime=ospfStartTime, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfInterface=ospfInterface, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfTxPkts=ospfIntfTxPkts, routeStatHighWater=routeStatHighWater, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaNbrDown=ospfAreaNbrDown, ipNewCfgGwTable=ipNewCfgGwTable, routeStatMaxEntries=routeStatMaxEntries, ospfCumIntfDown=ospfCumIntfDown, arpInfoTable=arpInfoTable, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates)
