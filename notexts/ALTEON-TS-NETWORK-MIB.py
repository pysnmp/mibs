...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipInterfaceTableMax=ipInterfaceTableMax, ripCurCfgState=ripCurCfgState, routeStatMaxEntries=routeStatMaxEntries, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgGwEntry=ipCurCfgGwEntry, ripConfig=ripConfig, ipRouteInfoMask=ipRouteInfoMask, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaInfoTable=ospfAreaInfoTable, arpInfoMacAddr=arpInfoMacAddr, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpStatInAdvers=vrrpStatInAdvers, arpInfoRefPorts=arpInfoRefPorts, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfUnloop=ospfIntfUnloop, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgIntfMask=ipCurCfgIntfMask, ripNewCfgListen=ripNewCfgListen, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfStats=ospfStats, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumIntfNbrChange=ospfCumIntfNbrChange, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgGwTable=ipCurCfgGwTable, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfDown=ospfIntfDown, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipForward=ipForward, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpOper=vrrpOper, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, dnsStats=dnsStats, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, routeStatHighWater=routeStatHighWater, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfHello=ospfIntfHello, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumRxDatabase=ospfCumRxDatabase, routeStats=routeStats, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaInfoEntry=ospfAreaInfoEntry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCfg=ospfCfg, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaInfoId=ospfAreaInfoId, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfNbrInFullState=ospfNbrInFullState, ipRouteInfoType=ipRouteInfoType, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumNbrRstAd=ospfCumNbrRstAd, arpInfoDestIp=arpInfoDestIp, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgIntfState=ipNewCfgIntfState, arpInfoTable=arpInfoTable, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumRxPkts=ospfCumRxPkts, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfLoop=ospfIntfLoop, ospfArea=ospfArea, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, arpInfoEntry=arpInfoEntry, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfNbrhello=ospfIntfNbrhello, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfRxPkts=ospfIntfRxPkts, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfTotalAreas=ospfTotalAreas, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumNbrN1way=ospfCumNbrN1way, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ripStats=ripStats, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfNbrDown=ospfIntfNbrDown, routerLSAId=routerLSAId, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdCurCfgState=ipFwdCurCfgState, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumRxHello=ospfCumRxHello, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumTxPkts=ospfCumTxPkts, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgIfTable=vrrpNewCfgIfTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, arpInfoVLAN=arpInfoVLAN, vrrpGeneral=vrrpGeneral, ospfIntfTxHello=ospfIntfTxHello, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumTxHello=ospfCumTxHello, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfNbrInInitState=ospfNbrInInitState, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumIntfHello=ospfCumIntfHello, ipRouteInfoTag=ipRouteInfoTag, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrp=vrrp, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfGeneral=ospfGeneral, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumRxTxStats=ospfCumRxTxStats, vrrpStats=vrrpStats, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, iprouting=iprouting, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfStartTime=ospfStartTime, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ripStatInPkts=ripStatInPkts, ipRouteInfoIndx=ipRouteInfoIndx, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaTxHello=ospfAreaTxHello, ospfAreaRxHello=ospfAreaRxHello, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfinfo=ospfinfo, ospfIntfNbrStart=ospfIntfNbrStart, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfProcessUptime=ospfProcessUptime, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ip_info=ip_info, ripCurCfgListen=ripCurCfgListen, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, routerLSALinkData=routerLSALinkData, ipCurCfgGwArp=ipCurCfgGwArp, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripStatOutPkts=ripStatOutPkts, ospfIntfBackup=ospfIntfBackup, arpInfoFlag=arpInfoFlag, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIfInfoIndex=ospfIfInfoIndex, ripNewCfgSupply=ripNewCfgSupply, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfTotalNeighbours=ospfTotalNeighbours, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrp_info=vrrp_info, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ripStatInErrorPkts=ripStatInErrorPkts, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgGwState=ipCurCfgGwState, ipRouteInfoInterface=ipRouteInfoInterface, ospfNbrInExchState=ospfNbrInExchState, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfGeneralStats=ospfGeneralStats, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipRouteInfoEntry=ipRouteInfoEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfIndex=ospfIntfIndex, ospfCumTxDatabase=ospfCumTxDatabase, routerLSALinkIndex=routerLSALinkIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumTxlsAcks=ospfCumTxlsAcks, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, routerLSALinkID=routerLSALinkID, ipGatewayTableMax=ipGatewayTableMax, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfVlinkCountForRouter=ospfVlinkCountForRouter, arpStats=arpStats, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfNewCfgAreaId=ospfNewCfgAreaId)
