...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfHello=ospfIntfHello, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaNbrhello=ospfAreaNbrhello, arpInfoMacAddr=arpInfoMacAddr, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, iprouting=iprouting, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfNbrDown=ospfIntfNbrDown, ipGatewayTableMax=ipGatewayTableMax, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ripCurCfgStaticSupply=ripCurCfgStaticSupply, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfProcessUptime=ospfProcessUptime, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripConfig=ripConfig, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfIndex=ospfIntfIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumTxHello=ospfCumTxHello, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipRouteInfoIndx=ipRouteInfoIndx, ospfInterface=ospfInterface, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ripStats=ripStats, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfArea=ospfArea, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, routeStatEntries=routeStatEntries, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaTxHello=ospfAreaTxHello, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfGeneralStats=ospfGeneralStats, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, arpStats=arpStats, ripCurCfgState=ripCurCfgState, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgGwVlan=ipCurCfgGwVlan, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipRouteInfoGateway=ipRouteInfoGateway, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfTotalAreas=ospfTotalAreas, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipRouteInfoInterface=ipRouteInfoInterface, ospfIfInfoIndex=ospfIfInfoIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumNbrDown=ospfCumNbrDown, ospfIntfBackup=ospfIntfBackup, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgGwArp=ipCurCfgGwArp, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfStartTime=ospfStartTime, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipNewCfgGwArp=ipNewCfgGwArp, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfRxTxStats=ospfIntfRxTxStats, arpInfoDestIp=arpInfoDestIp, ospfIntfCountForRouter=ospfIntfCountForRouter, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ip_info=ip_info, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, arpInfoTable=arpInfoTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaNbrDown=ospfAreaNbrDown, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgGwState=ipNewCfgGwState, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfNbrIndex=ospfIntfNbrIndex, ipRouteInfoTag=ipRouteInfoTag, ospfIntfRxHello=ospfIntfRxHello, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpStats=vrrpStats, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpOper=vrrpOper, arpInfoFlag=arpInfoFlag, ospfIntfDown=ospfIntfDown, routeStats=routeStats, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfNbrN1way=ospfIntfNbrN1way, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipRouteInfoEntry=ipRouteInfoEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripStatOutPkts=ripStatOutPkts, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaChangeStats=ospfAreaChangeStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgIntfMask=ipNewCfgIntfMask, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfLoop=ospfIntfLoop, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ripNewCfgListen=ripNewCfgListen, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfChangeStats=ospfIntfChangeStats, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipRouteInfoType=ipRouteInfoType, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ripNewCfgVip=ripNewCfgVip, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgGwMetric=ipCurCfgGwMetric, arpStatMaxEntries=arpStatMaxEntries, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumRxPkts=ospfCumRxPkts, ospfAreaRxHello=ospfAreaRxHello, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgGwIndex=ipNewCfgGwIndex, arpStatEntries=arpStatEntries, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfLsTypesSupported=ospfLsTypesSupported, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumRxHello=ospfCumRxHello, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfInfoTable=ospfIntfInfoTable, ripStatInPkts=ripStatInPkts, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaNbrRstAd=ospfAreaNbrRstAd, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, routerLSALinkData=routerLSALinkData, ospfStats=ospfStats, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfNbrInInitState=ospfNbrInInitState, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfNbrInExchState=ospfNbrInExchState, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgGwVlan=ipNewCfgGwVlan, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, routeStatHighWater=routeStatHighWater, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ripCurCfgSupply=ripCurCfgSupply, ospfGeneralInfo=ospfGeneralInfo, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, arpInfoVLAN=arpInfoVLAN, ospfCumIntfHello=ospfCumIntfHello, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ripNewCfgSupply=ripNewCfgSupply, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumNbrhello=ospfCumNbrhello, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumNbrStart=ospfCumNbrStart, ospfCumNbrChangeStats=ospfCumNbrChangeStats, arpInfoSrcPort=arpInfoSrcPort, routerLSALinkID=routerLSALinkID, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumIntfDown=ospfCumIntfDown, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipForward=ipForward, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfinfo=ospfinfo, arpInfoEntry=arpInfoEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumRxTxStats=ospfCumRxTxStats, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgGwState=ipCurCfgGwState, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfUnloop=ospfIntfUnloop, dnsStats=dnsStats, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrp=vrrp, vrrp_info=vrrp_info, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ripNewCfgDefListen=ripNewCfgDefListen, ipRouteInfoMask=ipRouteInfoMask, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumTxPkts=ospfCumTxPkts, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfGeneral=ospfGeneral, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCfg=ospfCfg, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgGwRetry=ipCurCfgGwRetry)
