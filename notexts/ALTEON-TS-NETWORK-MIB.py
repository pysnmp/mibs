...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfinfo=ospfinfo, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgGwRetry=ipNewCfgGwRetry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfTxHello=ospfIntfTxHello, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ripStatOutPkts=ripStatOutPkts, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfStartTime=ospfStartTime, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumNbrStart=ospfCumNbrStart, routerLSALinkIndex=routerLSALinkIndex, ripNewCfgState=ripNewCfgState, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfChangeStats=ospfIntfChangeStats, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgGwIndex=ipNewCfgGwIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfNbrN1way=ospfIntfNbrN1way, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfNbrInExchState=ospfNbrInExchState, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, arpInfoRefPorts=arpInfoRefPorts, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfNbrhello=ospfIntfNbrhello, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpOper=vrrpOper, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumRxHello=ospfCumRxHello, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ripStatInPkts=ripStatInPkts, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfProcessUptime=ospfProcessUptime, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaRxHello=ospfAreaRxHello, ripConfig=ripConfig, ospfCumTxlsReqs=ospfCumTxlsReqs, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgIntfMask=ipNewCfgIntfMask, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, routerLSALinkID=routerLSALinkID, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipRouteInfoType=ipRouteInfoType, vrrpGeneral=vrrpGeneral, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumTxDatabase=ospfCumTxDatabase, routeStats=routeStats, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfHello=ospfIntfHello, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumIntfBackup=ospfCumIntfBackup, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfRxDatabase=ospfIntfRxDatabase, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, arpInfoEntry=arpInfoEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, arpInfoVLAN=arpInfoVLAN, ospfIntfUnloop=ospfIntfUnloop, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpStatInAdvers=vrrpStatInAdvers, ipCurCfgGwState=ipCurCfgGwState, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgIntfDelete=ipNewCfgIntfDelete, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaIntfHello=ospfAreaIntfHello, ipRouteInfoGateway=ipRouteInfoGateway, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaRxPkts=ospfAreaRxPkts, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCfg=ospfCfg, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ripStatInErrorPkts=ripStatInErrorPkts, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, arpInfoTable=arpInfoTable, vrrpStats=vrrpStats, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, arpStatMaxEntries=arpStatMaxEntries, ipInterfaceTableMax=ipInterfaceTableMax, ospfStats=ospfStats, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipCurCfgIntfState=ipCurCfgIntfState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumNbrN1way=ospfCumNbrN1way, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfInterface=ospfInterface, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ip_info=ip_info, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfNbrInFullState=ospfNbrInFullState)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ripNewCfgSupply=ripNewCfgSupply, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ripStats=ripStats, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfGeneralStats=ospfGeneralStats, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumRxlsReqs=ospfCumRxlsReqs, ipForward=ipForward, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, iprouting=iprouting, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaNbrDown=ospfAreaNbrDown, arpStats=arpStats, ripCurCfgVip=ripCurCfgVip, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfDown=ospfIntfDown, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipRouteInfoTable=ipRouteInfoTable, ripCurCfgSupply=ripCurCfgSupply, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrp=vrrp, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ripNewCfgVip=ripNewCfgVip, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipCurCfgGwInterval=ipCurCfgGwInterval, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumTxHello=ospfCumTxHello, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaIntfDown=ospfAreaIntfDown, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfNbrChange=ospfIntfNbrChange, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, arpInfoSrcPort=arpInfoSrcPort, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgGwState=ipNewCfgGwState, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIfInfoIndex=ospfIfInfoIndex, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfTotalAreas=ospfTotalAreas, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ripCurCfgListen=ripCurCfgListen, ipNewCfgGwTable=ipNewCfgGwTable, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgIntfState=ipNewCfgIntfState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, routeStatMaxEntries=routeStatMaxEntries, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfIndex=ospfIntfIndex, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumNbrhello=ospfCumNbrhello, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, arpStatHighWater=arpStatHighWater, ipNewCfgIntfTable=ipNewCfgIntfTable, ipRouteInfoIndx=ipRouteInfoIndx, ripNewCfgListen=ripNewCfgListen, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfArea=ospfArea, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaTxHello=ospfAreaTxHello, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfRxlsAcks=ospfIntfRxlsAcks, routeStatEntries=routeStatEntries, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumIntfDown=ospfCumIntfDown, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, dnsStats=dnsStats, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, routeStatHighWater=routeStatHighWater, routerLSALinkData=routerLSALinkData, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer)
