...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgGwState=ipCurCfgGwState, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumRxHello=ospfCumRxHello, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCfg=ospfCfg, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfInfoTable=ospfIntfInfoTable, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipRouteInfoIndx=ipRouteInfoIndx, arpStatEntries=arpStatEntries, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpStatInAdvers=vrrpStatInAdvers, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, routerLSALinkID=routerLSALinkID, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfStats=ospfStats, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfHostTableMaxSize=ospfHostTableMaxSize, routeStats=routeStats, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfDown=ospfIntfDown, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, arpStatHighWater=arpStatHighWater, dnsStats=dnsStats, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgGwArp=ipCurCfgGwArp, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgIntfState=ipNewCfgIntfState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumNbrDown=ospfCumNbrDown, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfGeneralStats=ospfGeneralStats, arpInfoVLAN=arpInfoVLAN, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ripCurCfgStaticSupply=ripCurCfgStaticSupply, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfTotalAreas=ospfTotalAreas, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaIntfBackup=ospfAreaIntfBackup, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpStats=vrrpStats, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaRxPkts=ospfAreaRxPkts, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfTxHello=ospfIntfTxHello, ospfIntfRxPkts=ospfIntfRxPkts, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfGeneralInfo=ospfGeneralInfo, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, arpInfoRefPorts=arpInfoRefPorts, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaInfoId=ospfAreaInfoId, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaNbrN1way=ospfAreaNbrN1way, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ip_info=ip_info, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaIntfDown=ospfAreaIntfDown, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfRxHello=ospfIntfRxHello, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripNewCfgState=ripNewCfgState, vrrp=vrrp, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIfInfoIndex=ospfIfInfoIndex, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ripCurCfgDefListen=ripCurCfgDefListen, ospfinfo=ospfinfo, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfUnloop=ospfIntfUnloop, ospfNbrInFullState=ospfNbrInFullState, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfIndex=ospfIntfIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ripCurCfgState=ripCurCfgState, ospfInterface=ospfInterface, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfArea=ospfArea, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipRouteInfoType=ipRouteInfoType, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ripStatOutPkts=ripStatOutPkts, ospfNbrInInitState=ospfNbrInInitState, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ripStats=ripStats, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, arpInfoFlag=arpInfoFlag, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, routerLSALinkData=routerLSALinkData, ipFwdNewCfgState=ipFwdNewCfgState, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaNbrhello=ospfAreaNbrhello, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipForward=ipForward, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIfInfoIpAddress=ospfIfInfoIpAddress, routerLSALinkIndex=routerLSALinkIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfInfoEntry=ospfIntfInfoEntry, arpInfoSrcPort=arpInfoSrcPort, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, arpInfoEntry=arpInfoEntry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ripConfig=ripConfig, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaIntfHello=ospfAreaIntfHello, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipRouteInfoTag=ipRouteInfoTag, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ripCurCfgListen=ripCurCfgListen, ripNewCfgVip=ripNewCfgVip, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfHello=ospfIntfHello, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumIntfChangeStats=ospfCumIntfChangeStats, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfStartTime=ospfStartTime, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, routeStatEntries=routeStatEntries, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, arpStats=arpStats, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, routeStatHighWater=routeStatHighWater, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfNbrChange=ospfIntfNbrChange, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgGwAddr=ipCurCfgGwAddr, routeStatMaxEntries=routeStatMaxEntries, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumRxlsAcks=ospfCumRxlsAcks, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ripCurCfgSupply=ripCurCfgSupply, ospfCumIntfBackup=ospfCumIntfBackup, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfTotalTransitAreas=ospfTotalTransitAreas, ipRouteInfoGateway=ipRouteInfoGateway, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfGeneral=ospfGeneral, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCumNbrhello=ospfCumNbrhello, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipRouteInfoEntry=ipRouteInfoEntry, ospfProcessUptime=ospfProcessUptime, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipGatewayTableMax=ipGatewayTableMax, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpGeneral=vrrpGeneral, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCumIntfHello=ospfCumIntfHello, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, iprouting=iprouting, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgBootpState=ipCurCfgBootpState, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, arpInfoDestIp=arpInfoDestIp, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripNewCfgSupply=ripNewCfgSupply, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripCurCfgVip=ripCurCfgVip, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfNbrhello=ospfIntfNbrhello, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpOper=vrrpOper)
