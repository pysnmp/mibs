...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfNbrhello=ospfIntfNbrhello, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaRxDatabase=ospfAreaRxDatabase, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfArea=ospfArea, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipRouteInfoDestIp=ipRouteInfoDestIp, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaInfoId=ospfAreaInfoId, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgGwMetric=ipCurCfgGwMetric, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfLoop=ospfIntfLoop, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumRxDatabase=ospfCumRxDatabase, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfStartTime=ospfStartTime, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ripCurCfgSupply=ripCurCfgSupply, ripNewCfgListen=ripNewCfgListen, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfNbrChange=ospfIntfNbrChange, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgGwArp=ipNewCfgGwArp, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, routerLSALinkData=routerLSALinkData, ospfIntfRxHello=ospfIntfRxHello, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfDown=ospfIntfDown, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, arpInfoTable=arpInfoTable, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipRouteInfoInterface=ipRouteInfoInterface, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaTxHello=ospfAreaTxHello, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaIntfDown=ospfAreaIntfDown, ip_info=ip_info, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipForward=ipForward, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfNbrDown=ospfIntfNbrDown, arpStats=arpStats, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ripStatInPkts=ripStatInPkts, ripStats=ripStats, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpStats=vrrpStats, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaNbrStart=ospfAreaNbrStart, ripCurCfgState=ripCurCfgState, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfinfo=ospfinfo, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaInfoTable=ospfAreaInfoTable, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfInterface=ospfInterface, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfGeneralInfo=ospfGeneralInfo, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCumRxPkts=ospfCumRxPkts, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgGwMetric=ipNewCfgGwMetric, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, arpInfoEntry=arpInfoEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ripStatOutPkts=ripStatOutPkts, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfBackup=ospfIntfBackup, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfRxPkts=ospfIntfRxPkts, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIfInfoIpAddress=ospfIfInfoIpAddress, routerLSALinkID=routerLSALinkID, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfProcessUptime=ospfProcessUptime, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgGwState=ipCurCfgGwState, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ripCurCfgDefListen=ripCurCfgDefListen, ospfVlinkCountForRouter=ospfVlinkCountForRouter, routerLSALinkIndex=routerLSALinkIndex, ospfCumNbrDown=ospfCumNbrDown, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfUnloop=ospfIntfUnloop, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgBootpState=ipNewCfgBootpState, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ripStatInErrorPkts=ripStatInErrorPkts, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, routerLSAAreaIndex=routerLSAAreaIndex, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumNbrhello=ospfCumNbrhello, ospfNbrInFullState=ospfNbrInFullState, ospfCfg=ospfCfg, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ripNewCfgState=ripNewCfgState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, arpStatHighWater=arpStatHighWater, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, routeStatHighWater=routeStatHighWater, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfTotalAreas=ospfTotalAreas, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrp=vrrp, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfLsTypesSupported=ospfLsTypesSupported, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumNbrN1way=ospfCumNbrN1way, vrrpGeneral=vrrpGeneral, ripCurCfgListen=ripCurCfgListen, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfStats=ospfStats, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, routeStatEntries=routeStatEntries, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipCurCfgGwTable=ipCurCfgGwTable, arpStatEntries=arpStatEntries, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrp_info=vrrp_info, iprouting=iprouting, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipGatewayTableMax=ipGatewayTableMax, routeStats=routeStats, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfGeneral=ospfGeneral, ipRouteInfoTable=ipRouteInfoTable, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ripNewCfgVip=ripNewCfgVip, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumIntfDown=ospfCumIntfDown, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgGwIndex=ipNewCfgGwIndex, ipRouteInfoTag=ipRouteInfoTag, ripConfig=ripConfig, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumIntfHello=ospfCumIntfHello, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfChangeStats=ospfIntfChangeStats, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCumTxDatabase=ospfCumTxDatabase, ripNewCfgDefListen=ripNewCfgDefListen, ipRouteInfoMask=ipRouteInfoMask, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumNbrBadSequence=ospfCumNbrBadSequence, dnsStats=dnsStats, routerLSAId=routerLSAId, ipCurCfgGwInterval=ipCurCfgGwInterval, ipRouteInfoIndx=ipRouteInfoIndx, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaNbrDown=ospfAreaNbrDown, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpOper=vrrpOper, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, arpStatMaxEntries=arpStatMaxEntries, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgGwRetry=ipCurCfgGwRetry, arpInfoVLAN=arpInfoVLAN, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, routeStatMaxEntries=routeStatMaxEntries, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipRouteInfoType=ipRouteInfoType, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfIndex=ospfIntfIndex, arpInfoMacAddr=arpInfoMacAddr, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfRxlsReqs=ospfIntfRxlsReqs, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdCurCfgPortState=ipFwdCurCfgPortState)
