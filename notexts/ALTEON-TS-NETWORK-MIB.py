...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipNewCfgBootpState=ipNewCfgBootpState, ospfArea=ospfArea, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipRouteInfoMask=ipRouteInfoMask, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfinfo=ospfinfo, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumIntfHello=ospfCumIntfHello, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripStatInPkts=ripStatInPkts, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpStats=vrrpStats, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipRouteInfoType=ipRouteInfoType, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, routeStatMaxEntries=routeStatMaxEntries, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrp=vrrp, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, arpInfoDestIp=arpInfoDestIp, ospfIntfLoop=ospfIntfLoop, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, routerLSALinkData=routerLSALinkData, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaIntfDown=ospfAreaIntfDown, dnsStats=dnsStats, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaNbrStart=ospfAreaNbrStart, ripCurCfgSupply=ripCurCfgSupply, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfRxHello=ospfIntfRxHello, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumNbrDown=ospfCumNbrDown, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaIntfIndex=ospfAreaIntfIndex, ripCurCfgListen=ripCurCfgListen, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfTotalNeighbours=ospfTotalNeighbours, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ripNewCfgListen=ripNewCfgListen, arpInfoVLAN=arpInfoVLAN, ipCurCfgGwState=ipCurCfgGwState, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumTxDatabase=ospfCumTxDatabase, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfTmrsKckOffHello=ospfTmrsKckOffHello, arpInfoTable=arpInfoTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfGeneral=ospfGeneral, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipForward=ipForward, ospfStartTime=ospfStartTime, ripConfig=ripConfig, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ripStatOutPkts=ripStatOutPkts, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumNbrStart=ospfCumNbrStart, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, routeStatEntries=routeStatEntries, ospfNewCfgAreaId=ospfNewCfgAreaId, routeStatHighWater=routeStatHighWater, ospfCumRxTxStats=ospfCumRxTxStats, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgGwMetric=ipNewCfgGwMetric, arpInfoMacAddr=arpInfoMacAddr, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, arpInfoRefPorts=arpInfoRefPorts, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfRxDatabase=ospfIntfRxDatabase, routeStats=routeStats, arpInfoEntry=arpInfoEntry, ospfCumNbrhello=ospfCumNbrhello, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ripNewCfgState=ripNewCfgState, ospfAreaNbrhello=ospfAreaNbrhello, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfTotalAreas=ospfTotalAreas, ospfAreaIntfHello=ospfAreaIntfHello, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ripStats=ripStats)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfStats=ospfStats, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpOper=vrrpOper, ipCurCfgBootpState=ipCurCfgBootpState, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgGenState=vrrpNewCfgGenState, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrp_info=vrrp_info, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, routerLSALinkID=routerLSALinkID, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumTxPkts=ospfCumTxPkts, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfDown=ospfIntfDown, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgIfTable=vrrpCurCfgIfTable, arpStatEntries=arpStatEntries, arpInfoFlag=arpInfoFlag, ripNewCfgDefListen=ripNewCfgDefListen, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfNbrInFullState=ospfNbrInFullState, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpStatInAdvers=vrrpStatInAdvers, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfInfoTable=ospfIntfInfoTable, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfNbrDown=ospfIntfNbrDown, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpGeneral=vrrpGeneral, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumRxPkts=ospfCumRxPkts, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripCurCfgState=ripCurCfgState, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, iprouting=iprouting, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaRxPkts=ospfAreaRxPkts, ip_info=ip_info, routerLSAId=routerLSAId, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfNbrStart=ospfIntfNbrStart, ospfCfg=ospfCfg, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, ipRouteInfoTag=ipRouteInfoTag, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, arpInfoSrcPort=arpInfoSrcPort, arpStatMaxEntries=arpStatMaxEntries, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfGeneralInfo=ospfGeneralInfo, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipRouteInfoTable=ipRouteInfoTable, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfNbrChange=ospfIntfNbrChange, routerLSAAreaIndex=routerLSAAreaIndex, ipInterfaceTableMax=ipInterfaceTableMax, ospfNbrInExchState=ospfNbrInExchState, ospfGeneralStats=ospfGeneralStats, arpStats=arpStats, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfNbrInInitState=ospfNbrInInitState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipRouteInfoGateway=ipRouteInfoGateway, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgIntfMask=ipCurCfgIntfMask, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, routerLSALinkIndex=routerLSALinkIndex, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaTxPkts=ospfAreaTxPkts)
