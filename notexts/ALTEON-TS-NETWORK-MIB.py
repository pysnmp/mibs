...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaIntfIndex=ospfAreaIntfIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgGwAddr=ipCurCfgGwAddr, routeStatHighWater=routeStatHighWater, ripConfig=ripConfig, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, arpInfoVLAN=arpInfoVLAN, arpStatEntries=arpStatEntries, vrrpNewCfgGenState=vrrpNewCfgGenState, arpInfoDestIp=arpInfoDestIp, ospfIntfInfoTable=ospfIntfInfoTable, ripCurCfgVip=ripCurCfgVip, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCfg=ospfCfg, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrp_info=vrrp_info, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpOper=vrrpOper, ipNewCfgIntfDelete=ipNewCfgIntfDelete, routeStatEntries=routeStatEntries, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfNbrChange=ospfIntfNbrChange, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ripStatInErrorPkts=ripStatInErrorPkts, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumIntfDown=ospfCumIntfDown, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfRxPkts=ospfIntfRxPkts, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaNbrStart=ospfAreaNbrStart, arpInfoFlag=arpInfoFlag, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfStartTime=ospfStartTime, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumNbrhello=ospfCumNbrhello, arpInfoEntry=arpInfoEntry, ripNewCfgVip=ripNewCfgVip, ipForward=ipForward, ospfIntfNbrhello=ospfIntfNbrhello, ripCurCfgSupply=ripCurCfgSupply, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaIntfDown=ospfAreaIntfDown, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfinfo=ospfinfo, ospfIntfBackup=ospfIntfBackup, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaInfoId=ospfAreaInfoId, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, arpInfoTable=arpInfoTable, ospfAreaTxPkts=ospfAreaTxPkts, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrp=vrrp, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgGwTable=ipCurCfgGwTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumTxDatabase=ospfCumTxDatabase, routeStats=routeStats, ospfIntfTableMaxSize=ospfIntfTableMaxSize, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfProcessUptime=ospfProcessUptime, ipNewCfgGwEntry=ipNewCfgGwEntry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfGeneralInfo=ospfGeneralInfo, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ripNewCfgSupply=ripNewCfgSupply, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfHello=ospfIntfHello, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpGeneral=vrrpGeneral, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfDown=ospfIntfDown, arpInfoSrcPort=arpInfoSrcPort, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, routeStatMaxEntries=routeStatMaxEntries, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipRouteInfoEntry=ipRouteInfoEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaRxDatabase=ospfAreaRxDatabase)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumTxPkts=ospfCumTxPkts, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfNbrDown=ospfIntfNbrDown, arpInfoRefPorts=arpInfoRefPorts, ospfNbrInFullState=ospfNbrInFullState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ripStats=ripStats, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, arpStats=arpStats, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, dnsStats=dnsStats, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaTxHello=ospfAreaTxHello, ospfAreaRxPkts=ospfAreaRxPkts, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipInterfaceTableMax=ipInterfaceTableMax, ip_info=ip_info, ospfNbrInInitState=ospfNbrInInitState, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaRxHello=ospfAreaRxHello, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipRouteInfoType=ipRouteInfoType, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgGwState=ipCurCfgGwState, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpStats=vrrpStats, ospfCumRxTxStats=ospfCumRxTxStats, ospfLsTypesSupported=ospfLsTypesSupported, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaNbrDown=ospfAreaNbrDown, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumNbrDown=ospfCumNbrDown, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, routerLSALinkData=routerLSALinkData, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfNbrN1way=ospfIntfNbrN1way, iprouting=iprouting, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumIntfLoop=ospfCumIntfLoop, ospfTotalNeighbours=ospfTotalNeighbours, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgGwArp=ipCurCfgGwArp, routerLSALinkID=routerLSALinkID, routerLSALinkIndex=routerLSALinkIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfStats=ospfStats, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumNbrStart=ospfCumNbrStart, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfChangeStats=ospfIntfChangeStats, ipRouteInfoMask=ipRouteInfoMask, ospfArea=ospfArea, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ripStatInPkts=ripStatInPkts, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumRxHello=ospfCumRxHello, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipRouteInfoIndx=ipRouteInfoIndx, ipRouteInfoTag=ipRouteInfoTag, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgGwArp=ipNewCfgGwArp, ospfTotalAreas=ospfTotalAreas, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfLoop=ospfIntfLoop, routerLSAId=routerLSAId, ospfCumTxHello=ospfCumTxHello, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ripNewCfgListen=ripNewCfgListen, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfTxHello=ospfIntfTxHello, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipGatewayTableMax=ipGatewayTableMax, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgGwInterval=ipNewCfgGwInterval, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgGwRetry=ipNewCfgGwRetry, ripCurCfgState=ripCurCfgState, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipFwdCurCfgState=ipFwdCurCfgState, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfIndex=ospfIntfIndex, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfGeneral=ospfGeneral, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex)
