...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfChangeStats=ospfIntfChangeStats, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumTxPkts=ospfCumTxPkts, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaRxHello=ospfAreaRxHello, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, arpInfoRefPorts=arpInfoRefPorts, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgBootpAddr=ipCurCfgBootpAddr, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaIntfDown=ospfAreaIntfDown, ospfNewCfgAreaId=ospfNewCfgAreaId, iprouting=iprouting, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgGwRetry=ipNewCfgGwRetry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, arpInfoEntry=arpInfoEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfTotalAreas=ospfTotalAreas, ripCurCfgListen=ripCurCfgListen, ospfIntfRxPkts=ospfIntfRxPkts, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfBackup=ospfIntfBackup, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipForward=ipForward, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgGwMetric=ipCurCfgGwMetric, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfGeneralInfo=ospfGeneralInfo, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfinfo=ospfinfo, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, routeStats=routeStats, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ripNewCfgDefListen=ripNewCfgDefListen, ripStatOutPkts=ripStatOutPkts, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ip_info=ip_info, routeStatEntries=routeStatEntries, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpGeneral=vrrpGeneral, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipRouteInfoMask=ipRouteInfoMask, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfTxPkts=ospfIntfTxPkts, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, arpInfoSrcPort=arpInfoSrcPort, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgGwArp=ipNewCfgGwArp, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, routeStatHighWater=routeStatHighWater, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumTxHello=ospfCumTxHello, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfStartTime=ospfStartTime, ipRouteInfoIndx=ipRouteInfoIndx, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfStats=ospfStats, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipRouteInfoTable=ipRouteInfoTable, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, ripStatInPkts=ripStatInPkts, arpStatMaxEntries=arpStatMaxEntries, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumNbrhello=ospfCumNbrhello, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfNbrInExchState=ospfNbrInExchState, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, arpStats=arpStats, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpStats=vrrpStats, arpInfoVLAN=arpInfoVLAN, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, routeStatMaxEntries=routeStatMaxEntries, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfRxTxStats=ospfIntfRxTxStats, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, arpStatEntries=arpStatEntries, vrrpOper=vrrpOper, ospfIntfWaitTimer=ospfIntfWaitTimer, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ripNewCfgListen=ripNewCfgListen)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipRouteInfoGateway=ipRouteInfoGateway, routerLSAId=routerLSAId, ospfHostTableMaxSize=ospfHostTableMaxSize, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfGeneralStats=ospfGeneralStats, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaNbrhello=ospfAreaNbrhello, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgGwState=ipNewCfgGwState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCfg=ospfCfg, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaInfoId=ospfAreaInfoId, ipRouteInfoType=ipRouteInfoType, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, arpInfoMacAddr=arpInfoMacAddr, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgBootpState=ipNewCfgBootpState, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, routerLSALinkIndex=routerLSALinkIndex, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaTxDatabase=ospfAreaTxDatabase, ripStats=ripStats, ospfIntfRxHello=ospfIntfRxHello, ospfNbrInInitState=ospfNbrInInitState, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCumNbrDown=ospfCumNbrDown, ospfProcessUptime=ospfProcessUptime, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfNbrChange=ospfIntfNbrChange, vrrp_info=vrrp_info, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaTxPkts=ospfAreaTxPkts, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ripConfig=ripConfig, ipCurCfgGwState=ipCurCfgGwState, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfUnloop=ospfIntfUnloop, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCumRxHello=ospfCumRxHello, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrp=vrrp, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaTxHello=ospfAreaTxHello, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, arpInfoFlag=arpInfoFlag, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumRxlsAcks=ospfCumRxlsAcks, ripCurCfgSupply=ripCurCfgSupply, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfTxHello=ospfIntfTxHello, ospfCurCfgAreaTable=ospfCurCfgAreaTable, dnsStats=dnsStats, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfNbrInFullState=ospfNbrInFullState, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaNbrIndex=ospfAreaNbrIndex, routerLSALinkID=routerLSALinkID, ripNewCfgVip=ripNewCfgVip, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ripCurCfgState=ripCurCfgState, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfGeneral=ospfGeneral, ipRouteInfoDestIp=ipRouteInfoDestIp, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, arpStatHighWater=arpStatHighWater, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumIntfLoop=ospfCumIntfLoop, ospfInterface=ospfInterface, ipGatewayTableMax=ipGatewayTableMax, routerLSALinkData=routerLSALinkData, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfArea=ospfArea, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumNbrN1way=ospfCumNbrN1way, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfDown=ospfIntfDown, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, routerLSAAreaIndex=routerLSAAreaIndex)
