...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaInfoId=ospfAreaInfoId, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ripNewCfgSupply=ripNewCfgSupply, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumNbrhello=ospfCumNbrhello, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, routeStatEntries=routeStatEntries, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripCurCfgListen=ripCurCfgListen, ospfIntfNbrhello=ospfIntfNbrhello, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCumIntfDown=ospfCumIntfDown, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaIntfDown=ospfAreaIntfDown, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, arpInfoDestIp=arpInfoDestIp, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, routerLSALinkData=routerLSALinkData, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfTmrsKckOffHello=ospfTmrsKckOffHello, arpInfoMacAddr=arpInfoMacAddr, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfDown=ospfIntfDown, vrrpStats=vrrpStats, ipCurCfgIntfMask=ipCurCfgIntfMask, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfNbrStart=ospfIntfNbrStart, iprouting=iprouting, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrp_info=vrrp_info, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfLoop=ospfIntfLoop, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, arpStatHighWater=arpStatHighWater, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumIntfHello=ospfCumIntfHello, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ripStatInPkts=ripStatInPkts, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ripStatOutPkts=ripStatOutPkts, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaInfoIndex=ospfAreaInfoIndex, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipRouteInfoInterface=ipRouteInfoInterface, ipGatewayTableMax=ipGatewayTableMax, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfHello=ospfIntfHello, ospfIfWaitInterval=ospfIfWaitInterval, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfRxDatabase=ospfIntfRxDatabase, ipRouteInfoMask=ipRouteInfoMask, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfTimersKickOffStats=ospfTimersKickOffStats, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfNbrInInitState=ospfNbrInInitState, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfNbrInExchState=ospfNbrInExchState, arpInfoSrcPort=arpInfoSrcPort, ospfTotalAreas=ospfTotalAreas, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfInterface=ospfInterface, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfGeneral=ospfGeneral, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfIndex=ospfIntfIndex, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipForward=ipForward, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, arpInfoVLAN=arpInfoVLAN, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumNbrRstAd=ospfCumNbrRstAd, ipRouteInfoTable=ipRouteInfoTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ripConfig=ripConfig, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgGwTable=ipCurCfgGwTable, routerLSALinkID=routerLSALinkID, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaIntfIndex=ospfAreaIntfIndex, ripStatInErrorPkts=ripStatInErrorPkts, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaNbrN1way=ospfAreaNbrN1way, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCurCfgAreaId=ospfCurCfgAreaId, routeStatMaxEntries=routeStatMaxEntries)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfRxHello=ospfIntfRxHello, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaNbrIndex=ospfAreaNbrIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaIntfHello=ospfAreaIntfHello, routerLSALinkIndex=routerLSALinkIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaTxHello=ospfAreaTxHello, arpInfoRefPorts=arpInfoRefPorts, ospfStats=ospfStats, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgBootpState=ipCurCfgBootpState, ospfStartTime=ospfStartTime, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrp=vrrp, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgGwInterval=ipNewCfgGwInterval, ipInterfaceTableMax=ipInterfaceTableMax, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ripNewCfgVip=ripNewCfgVip, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgGwState=ipCurCfgGwState, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumRxHello=ospfCumRxHello, ospfCumRxPkts=ospfCumRxPkts, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipRouteInfoGateway=ipRouteInfoGateway, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, arpInfoTable=arpInfoTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, arpStats=arpStats, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ripStats=ripStats, ospfIntfNbrIndex=ospfIntfNbrIndex, ripCurCfgSupply=ripCurCfgSupply, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumNbrN1way=ospfCumNbrN1way, arpInfoEntry=arpInfoEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipFwdCurCfgState=ipFwdCurCfgState, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgGwMetric=ipNewCfgGwMetric, ripCurCfgState=ripCurCfgState, ospfAreaNbrDown=ospfAreaNbrDown, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCfg=ospfCfg, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgGwTable=ipNewCfgGwTable, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaTxlsAcks=ospfAreaTxlsAcks, routeStats=routeStats, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpOper=vrrpOper, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfUnloop=ospfIntfUnloop, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfRxTxStats=ospfIntfRxTxStats, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgGwIndex=ipCurCfgGwIndex, ripCurCfgVip=ripCurCfgVip, ospfCumTxPkts=ospfCumTxPkts, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaChangeStats=ospfAreaChangeStats, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpGeneral=vrrpGeneral, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgIntfTable=ipCurCfgIntfTable, arpInfoFlag=arpInfoFlag, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, arpStatMaxEntries=arpStatMaxEntries, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, dnsStats=dnsStats, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ip_info=ip_info, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfArea=ospfArea, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfGeneralStats=ospfGeneralStats)
