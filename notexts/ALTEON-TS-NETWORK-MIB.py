...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripStatInPkts=ripStatInPkts, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, routeStatHighWater=routeStatHighWater, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ripStatInErrorPkts=ripStatInErrorPkts, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaNbrhello=ospfAreaNbrhello, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, routerLSALinkID=routerLSALinkID, arpInfoRefPorts=arpInfoRefPorts, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfStartTime=ospfStartTime, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, routeStatMaxEntries=routeStatMaxEntries, ospfIntfHello=ospfIntfHello, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfUnloop=ospfIntfUnloop, ripStats=ripStats, vrrpGeneral=vrrpGeneral, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgBootpState=ipCurCfgBootpState, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, routerLSAId=routerLSAId, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, iprouting=iprouting, ospfIntfNbrDown=ospfIntfNbrDown, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipRouteInfoDestIp=ipRouteInfoDestIp, ripStatOutPkts=ripStatOutPkts, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipRouteInfoTag=ipRouteInfoTag, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaInfoId=ospfAreaInfoId, ospfIntfRxDatabase=ospfIntfRxDatabase, ripNewCfgVip=ripNewCfgVip, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaChangeStats=ospfAreaChangeStats, ospfGeneral=ospfGeneral, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgGwVlan=ipCurCfgGwVlan, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgGenState=vrrpNewCfgGenState, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumTxHello=ospfCumTxHello, ip_info=ip_info, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumRxlsReqs=ospfCumRxlsReqs, arpInfoTable=arpInfoTable, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipForward=ipForward, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgBootpState=ipNewCfgBootpState, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumTxPkts=ospfCumTxPkts, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, routeStats=routeStats, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumTxlsReqs=ospfCumTxlsReqs, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumIntfHello=ospfCumIntfHello, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaTxHello=ospfAreaTxHello, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, arpStatEntries=arpStatEntries, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, arpStats=arpStats, ospfCumRxTxStats=ospfCumRxTxStats, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIfInfoIndex=ospfIfInfoIndex, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgGwState=ipNewCfgGwState, ospfCumRxHello=ospfCumRxHello, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaRxDatabase=ospfAreaRxDatabase, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumNbrRstAd=ospfCumNbrRstAd, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpStats=vrrpStats, ipCurCfgIntfMask=ipCurCfgIntfMask, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumNbrN1way=ospfCumNbrN1way, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaRxHello=ospfAreaRxHello, ospfAreaIntfDown=ospfAreaIntfDown, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfStats=ospfStats, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgIntfState=ipNewCfgIntfState, ospfGeneralStats=ospfGeneralStats, ipRouteInfoType=ipRouteInfoType, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripCurCfgListen=ripCurCfgListen, ipCurCfgGwArp=ipCurCfgGwArp)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNbrInInitState=ospfNbrInInitState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfNbrInExchState=ospfNbrInExchState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfBackup=ospfIntfBackup, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfNbrChange=ospfIntfNbrChange, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, arpInfoVLAN=arpInfoVLAN, ospfinfo=ospfinfo, ipFwdCurCfgState=ipFwdCurCfgState, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaNbrStart=ospfAreaNbrStart, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ripNewCfgState=ripNewCfgState, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfArea=ospfArea, ospfIfTotalNeighbours=ospfIfTotalNeighbours, arpStatMaxEntries=arpStatMaxEntries, vrrpStatInAdvers=vrrpStatInAdvers, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipRouteInfoEntry=ipRouteInfoEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ripCurCfgVip=ripCurCfgVip, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfIndex=ospfIntfIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfInterface=ospfInterface, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgGwAddr=ipNewCfgGwAddr, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgGwState=ipCurCfgGwState, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, routerLSALinkData=routerLSALinkData, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumNbrhello=ospfCumNbrhello, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCfg=ospfCfg, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumIntfDown=ospfCumIntfDown, vrrp=vrrp, ospfIntfDown=ospfIntfDown, ipFwdNewCfgState=ipFwdNewCfgState, ipRouteInfoTable=ipRouteInfoTable, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumRxDatabase=ospfCumRxDatabase, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumNbrStart=ospfCumNbrStart, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripNewCfgDefListen=ripNewCfgDefListen, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripCurCfgSupply=ripCurCfgSupply, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaTxlsAcks=ospfAreaTxlsAcks, dnsStats=dnsStats, ipRouteInfoInterface=ipRouteInfoInterface, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumIntfBackup=ospfCumIntfBackup, ipGatewayTableMax=ipGatewayTableMax, ospfTotalAreas=ospfTotalAreas, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ripStatRoutesAgedOut=ripStatRoutesAgedOut, routeStatEntries=routeStatEntries, arpInfoSrcPort=arpInfoSrcPort, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripNewCfgListen=ripNewCfgListen, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfProcessUptime=ospfProcessUptime, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrp_info=vrrp_info, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripConfig=ripConfig, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID)
