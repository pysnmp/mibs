...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", routeStatEntries=routeStatEntries, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfTxDatabase=ospfIntfTxDatabase, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfRxHello=ospfIntfRxHello, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, routerLSALinkIndex=routerLSALinkIndex, ospfCumRxTxStats=ospfCumRxTxStats, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipRouteInfoTable=ipRouteInfoTable, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfGeneral=ospfGeneral, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIfInfoIpAddress=ospfIfInfoIpAddress, routeStats=routeStats, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaIntfBackup=ospfAreaIntfBackup, arpInfoSrcPort=arpInfoSrcPort, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ripStatOutPkts=ripStatOutPkts, ospfIntfDown=ospfIntfDown, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripCurCfgState=ripCurCfgState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, arpStatHighWater=arpStatHighWater, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfGeneralStats=ospfGeneralStats, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, arpInfoFlag=arpInfoFlag, ospfInterface=ospfInterface, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfIndex=ospfIntfIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, arpInfoDestIp=arpInfoDestIp, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfStartTime=ospfStartTime, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaInfoTable=ospfAreaInfoTable, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgGwTable=ipNewCfgGwTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, dnsStats=dnsStats, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, arpStats=arpStats, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfHello=ospfIntfHello, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfBackup=ospfIntfBackup, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfRxTxStats=ospfIntfRxTxStats, ipFwdNewCfgState=ipFwdNewCfgState, vrrpStatInAdvers=vrrpStatInAdvers, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaChangeStats=ospfAreaChangeStats, vrrpStats=vrrpStats, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripStats=ripStats, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaNbrStart=ospfAreaNbrStart, ripNewCfgVip=ripNewCfgVip, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCfg=ospfCfg, ospfAreaIntfHello=ospfAreaIntfHello, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaRxPkts=ospfAreaRxPkts, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgBootpState=ipNewCfgBootpState, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrp_info=vrrp_info, ipForward=ipForward, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfNbrStart=ospfIntfNbrStart, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipCurCfgIntfMask=ipCurCfgIntfMask, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfTxPkts=ospfIntfTxPkts, arpInfoTable=arpInfoTable, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfStats=ospfStats, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgGwState=ipNewCfgGwState, ipRouteInfoTag=ipRouteInfoTag, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumRxHello=ospfCumRxHello, ripStatInPkts=ripStatInPkts, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipRouteInfoEntry=ipRouteInfoEntry, ospfCumIntfHello=ospfCumIntfHello, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfUnloop=ospfIntfUnloop, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, iprouting=iprouting, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgGwState=ipCurCfgGwState, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ripCurCfgVip=ripCurCfgVip, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ripNewCfgListen=ripNewCfgListen, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripConfig=ripConfig, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipRouteInfoType=ipRouteInfoType, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ip_info=ip_info, ospfCumTxlsAcks=ospfCumTxlsAcks, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpOper=vrrpOper, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfArea=ospfArea, ripCurCfgSupply=ripCurCfgSupply, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfNbrInFullState=ospfNbrInFullState, ospfCumNbrN1way=ospfCumNbrN1way, arpStatMaxEntries=arpStatMaxEntries, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumTxHello=ospfCumTxHello, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, routerLSALinkID=routerLSALinkID, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipRouteInfoMask=ipRouteInfoMask, ospfNbrInExchState=ospfNbrInExchState, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaIntfUnloop=ospfAreaIntfUnloop, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumIntfLoop=ospfCumIntfLoop, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, arpInfoMacAddr=arpInfoMacAddr, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfRxlsReqs=ospfIntfRxlsReqs, routerLSALinkData=routerLSALinkData, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgBootpAddr=ipNewCfgBootpAddr, routeStatHighWater=routeStatHighWater, ipCurCfgGwInterval=ipCurCfgGwInterval, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrp=vrrp, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpGeneral=vrrpGeneral, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripCurCfgListen=ripCurCfgListen, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfProcessUptime=ospfProcessUptime, ospfCumNbrStart=ospfCumNbrStart, ospfCumIntfDown=ospfCumIntfDown, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaTxHello=ospfAreaTxHello, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIfWaitInterval=ospfIfWaitInterval, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaIntfIndex=ospfAreaIntfIndex, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfinfo=ospfinfo, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfTotalAreas=ospfTotalAreas, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfTotalNeighbours=ospfTotalNeighbours, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaRxTxStats=ospfAreaRxTxStats, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, arpInfoVLAN=arpInfoVLAN, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaTxPkts=ospfAreaTxPkts, ospfCurCfgAreaTable=ospfCurCfgAreaTable, routeStatMaxEntries=routeStatMaxEntries, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgGenState=vrrpCurCfgGenState)
