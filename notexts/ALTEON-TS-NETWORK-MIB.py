...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumNbrBadRequests=ospfCumNbrBadRequests, routerLSALinkData=routerLSALinkData, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfLoop=ospfIntfLoop, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ripStatInPkts=ripStatInPkts, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripStatInErrorPkts=ripStatInErrorPkts, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfTotalAreas=ospfTotalAreas, ospfCumNbrDown=ospfCumNbrDown, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgBootpState=ipCurCfgBootpState, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ip_info=ip_info, ripNewCfgListen=ripNewCfgListen, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaNbrStart=ospfAreaNbrStart, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaRxTxStats=ospfAreaRxTxStats, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, routerLSAId=routerLSAId, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaNbrDown=ospfAreaNbrDown, vrrp_info=vrrp_info, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, arpInfoMacAddr=arpInfoMacAddr, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpOper=vrrpOper, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfDown=ospfIntfDown, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripConfig=ripConfig, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipForward=ipForward, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, routerLSALinkID=routerLSALinkID, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfLsTypesSupported=ospfLsTypesSupported, ospfNewCfgAreaId=ospfNewCfgAreaId, routeStats=routeStats, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaIntfHello=ospfAreaIntfHello, arpInfoRefPorts=arpInfoRefPorts, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ripNewCfgVip=ripNewCfgVip, arpStats=arpStats, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumTxPkts=ospfCumTxPkts, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfTxHello=ospfIntfTxHello, vrrpStats=vrrpStats, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfRxlsAcks=ospfIntfRxlsAcks, arpInfoDestIp=arpInfoDestIp, ipNewCfgGwState=ipNewCfgGwState, routeStatHighWater=routeStatHighWater, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipInterfaceTableMax=ipInterfaceTableMax, arpStatHighWater=arpStatHighWater, arpStatEntries=arpStatEntries, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, iprouting=iprouting, arpInfoFlag=arpInfoFlag, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ripNewCfgSupply=ripNewCfgSupply, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumRxlsReqs=ospfCumRxlsReqs, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfNbrStart=ospfIntfNbrStart, ospfProcessUptime=ospfProcessUptime, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumRxDatabase=ospfCumRxDatabase, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaTxPkts=ospfAreaTxPkts, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfArea=ospfArea, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipNewCfgGwAddr=ipNewCfgGwAddr, routeStatMaxEntries=routeStatMaxEntries, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfNbrInFullState=ospfNbrInFullState, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfRxTxStats=ospfIntfRxTxStats, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, routerLSAAreaIndex=routerLSAAreaIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ripCurCfgListen=ripCurCfgListen, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfNbrInInitState=ospfNbrInInitState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, arpInfoSrcPort=arpInfoSrcPort, arpInfoVLAN=arpInfoVLAN, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaInfoId=ospfAreaInfoId, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipRouteInfoType=ipRouteInfoType, ospfIntfHello=ospfIntfHello, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaNbrIndex=ospfAreaNbrIndex, ripCurCfgState=ripCurCfgState, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfUnloop=ospfIntfUnloop, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfInterface=ospfInterface, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, routeStatEntries=routeStatEntries, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumNbrStart=ospfCumNbrStart, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfGeneralStats=ospfGeneralStats, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCfg=ospfCfg, ipNewCfgGwArp=ipNewCfgGwArp, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumIntfDown=ospfCumIntfDown, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgGwIndex=ipCurCfgGwIndex, ripNewCfgDefListen=ripNewCfgDefListen, dnsStats=dnsStats, ripCurCfgSupply=ripCurCfgSupply, ospfNbrInExchState=ospfNbrInExchState, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ripStats=ripStats, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIfInfoIndex=ospfIfInfoIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpGeneral=vrrpGeneral, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgIntfState=ipNewCfgIntfState, ospfStats=ospfStats, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipFwdCurCfgState=ipFwdCurCfgState, ospfGeneral=ospfGeneral, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, arpInfoTable=arpInfoTable, ospfAreaInfoTable=ospfAreaInfoTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipRouteInfoDestIp=ipRouteInfoDestIp, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumRxHello=ospfCumRxHello, ipNewCfgGwTable=ipNewCfgGwTable, vrrp=vrrp, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaIntfBackup=ospfAreaIntfBackup, ipRouteInfoTag=ipRouteInfoTag, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipRouteInfoTable=ipRouteInfoTable, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfStartTime=ospfStartTime, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ripNewCfgState=ripNewCfgState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipRouteInfoEntry=ipRouteInfoEntry, ospfCumTxDatabase=ospfCumTxDatabase, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfNbrDown=ospfIntfNbrDown, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfCountForRouter=ospfIntfCountForRouter, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripCurCfgVip=ripCurCfgVip, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgBootpState=ipNewCfgBootpState, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfNbrN1way=ospfIntfNbrN1way, ipRouteInfoGateway=ipRouteInfoGateway, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval)
