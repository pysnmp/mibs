...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpInfoVLAN=arpInfoVLAN, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipCurCfgGwRetry=ipCurCfgGwRetry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpStats=vrrpStats, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumIntfUnloop=ospfCumIntfUnloop, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipForward=ipForward, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdCurCfgState=ipFwdCurCfgState, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ripConfig=ripConfig, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumIntfLoop=ospfCumIntfLoop, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, routeStatEntries=routeStatEntries, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfHello=ospfIntfHello, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaTxHello=ospfAreaTxHello, ospfCumIntfDown=ospfCumIntfDown, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumTxPkts=ospfCumTxPkts, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, ripNewCfgDefListen=ripNewCfgDefListen, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrp=vrrp, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, arpInfoTable=arpInfoTable, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfLsTypesSupported=ospfLsTypesSupported, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfNbrDown=ospfIntfNbrDown, arpStatEntries=arpStatEntries, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfInfoEntry=ospfIntfInfoEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipRouteInfoInterface=ipRouteInfoInterface, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ip_info=ip_info, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfStats=ospfStats, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfinfo=ospfinfo, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfNbrStart=ospfIntfNbrStart, arpInfoSrcPort=arpInfoSrcPort, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipRouteInfoIndx=ipRouteInfoIndx, iprouting=iprouting, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfLoop=ospfIntfLoop, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, routeStats=routeStats, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfGeneralStats=ospfGeneralStats, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, routerLSALinkIfIndex=routerLSALinkIfIndex, ripCurCfgState=ripCurCfgState, ospfIntfDown=ospfIntfDown, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgGwInterval=ipNewCfgGwInterval, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumNbrStart=ospfCumNbrStart, ipNewCfgGwState=ipNewCfgGwState, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumRxPkts=ospfCumRxPkts, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIfInfoIpAddress=ospfIfInfoIpAddress, arpStatMaxEntries=arpStatMaxEntries, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ripCurCfgVip=ripCurCfgVip, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfArea=ospfArea, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfTotalNeighbours=ospfTotalNeighbours, ripStatOutPkts=ripStatOutPkts, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCumRxTxStats=ospfCumRxTxStats, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ripStats=ripStats, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, arpStats=arpStats, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCumRxHello=ospfCumRxHello, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgGwIndex=ipCurCfgGwIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipGatewayTableMax=ipGatewayTableMax, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaInfoTable=ospfAreaInfoTable, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfBackup=ospfIntfBackup, dnsStats=dnsStats, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfInfoTable=ospfIntfInfoTable, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumIntfHello=ospfCumIntfHello, ipRouteInfoTag=ipRouteInfoTag, ospfStartTime=ospfStartTime, ipCurCfgGwTable=ipCurCfgGwTable, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgGwState=ipCurCfgGwState, routeStatHighWater=routeStatHighWater, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaIntfHello=ospfAreaIntfHello, ripNewCfgListen=ripNewCfgListen, ipCurCfgGwEntry=ipCurCfgGwEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ripNewCfgState=ripNewCfgState, ipCurCfgGwArp=ipCurCfgGwArp, arpInfoEntry=arpInfoEntry, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaRxHello=ospfAreaRxHello, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ripNewCfgSupply=ripNewCfgSupply, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCumNbrDown=ospfCumNbrDown, ospfCumNbrhello=ospfCumNbrhello, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaTxPkts=ospfAreaTxPkts, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrp_info=vrrp_info, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfInterface=ospfInterface, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfTotalAreas=ospfTotalAreas, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfIndex=ospfIntfIndex, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ripNewCfgVip=ripNewCfgVip, ripStatInPkts=ripStatInPkts, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfTxPkts=ospfIntfTxPkts, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgIntfMask=ipNewCfgIntfMask, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaNbrN1way=ospfAreaNbrN1way, arpInfoDestIp=arpInfoDestIp, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfTxHello=ospfIntfTxHello, ospfIntfRxHello=ospfIntfRxHello, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, arpInfoRefPorts=arpInfoRefPorts, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipInterfaceTableMax=ipInterfaceTableMax, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumRxlsUpdates=ospfCumRxlsUpdates, routeStatMaxEntries=routeStatMaxEntries, ipRouteInfoType=ipRouteInfoType, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpOper=vrrpOper, ospfCumIntfBackup=ospfCumIntfBackup, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, routerLSALinkID=routerLSALinkID, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, arpStatHighWater=arpStatHighWater, vrrpGeneral=vrrpGeneral, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaTxDatabase=ospfAreaTxDatabase)
