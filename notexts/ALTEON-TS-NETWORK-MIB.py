...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumRxPkts=ospfCumRxPkts, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ripStats=ripStats, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ip_info=ip_info, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfTxPkts=ospfIntfTxPkts, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, routerLSALinkData=routerLSALinkData, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgIntfMask=ipNewCfgIntfMask, arpInfoMacAddr=arpInfoMacAddr, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaChangeStats=ospfAreaChangeStats, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgGwTable=ipCurCfgGwTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumNbrStart=ospfCumNbrStart, ospfIntfHello=ospfIntfHello, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaTxPkts=ospfAreaTxPkts, ospfCurCfgAreaId=ospfCurCfgAreaId, routeStatHighWater=routeStatHighWater, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaInfoId=ospfAreaInfoId, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfNbrChange=ospfIntfNbrChange, ipCurCfgIntfMask=ipCurCfgIntfMask, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, arpInfoFlag=arpInfoFlag, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ripConfig=ripConfig, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCfg=ospfCfg, ospfArea=ospfArea, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfNbrDown=ospfIntfNbrDown, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, arpStatEntries=arpStatEntries, ospfInterface=ospfInterface, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfTotalNeighbours=ospfTotalNeighbours, ospfGeneralStats=ospfGeneralStats, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ripCurCfgVip=ripCurCfgVip, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfIndex=ospfIntfIndex, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfNbrRstAd=ospfIntfNbrRstAd, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ripStatInErrorPkts=ripStatInErrorPkts, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpStatOutAdvers=vrrpStatOutAdvers, routeStats=routeStats, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfRxPkts=ospfIntfRxPkts, routeStatMaxEntries=routeStatMaxEntries, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfNbrStart=ospfIntfNbrStart, ospfGeneral=ospfGeneral, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipCurCfgGwVlan=ipCurCfgGwVlan, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfLoop=ospfIntfLoop, ripCurCfgState=ripCurCfgState, ripNewCfgListen=ripNewCfgListen, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumTxPkts=ospfCumTxPkts, ripNewCfgState=ripNewCfgState, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfDown=ospfIntfDown, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaIntfHello=ospfAreaIntfHello, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgGwArp=ipNewCfgGwArp, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfNbrInExchState=ospfNbrInExchState, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, routeStatEntries=routeStatEntries, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaIntfBackup=ospfAreaIntfBackup, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaRxHello=ospfAreaRxHello, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfUnloop=ospfIntfUnloop, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumIntfHello=ospfCumIntfHello, ospfCumRxlsAcks=ospfCumRxlsAcks, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ripNewCfgSupply=ripNewCfgSupply, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipRouteInfoType=ipRouteInfoType, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgGwState=ipCurCfgGwState, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumTxDatabase=ospfCumTxDatabase, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumNbrDown=ospfCumNbrDown, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumRxHello=ospfCumRxHello, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpGeneral=vrrpGeneral, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaInfoIndex=ospfAreaInfoIndex, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipFwdCurCfgState=ipFwdCurCfgState, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaNbrhello=ospfAreaNbrhello, ripStatInPkts=ripStatInPkts, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaTableMaxSize=ospfAreaTableMaxSize, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, arpStatHighWater=arpStatHighWater, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, routerLSALinkID=routerLSALinkID, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfTxlsAcks=ospfIntfTxlsAcks, arpStats=arpStats, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumIntfBackup=ospfCumIntfBackup, ipRouteInfoDestIp=ipRouteInfoDestIp, routerLSALinkIndex=routerLSALinkIndex, vrrpStats=vrrpStats, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfStats=ospfStats, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, arpInfoVLAN=arpInfoVLAN, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrp=vrrp, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfRxHello=ospfIntfRxHello, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripNewCfgVip=ripNewCfgVip, ipGatewayTableMax=ipGatewayTableMax, ospfAreaIntfIndex=ospfAreaIntfIndex, dnsStats=dnsStats, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaRxDatabase=ospfAreaRxDatabase, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaRxPkts=ospfAreaRxPkts, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgGwVlan=ipNewCfgGwVlan, iprouting=iprouting, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumTxHello=ospfCumTxHello, ospfAreaNbrN1way=ospfAreaNbrN1way, ipForward=ipForward, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgGwRetry=ipNewCfgGwRetry, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfTotalAreas=ospfTotalAreas, ipCurCfgGwRetry=ipCurCfgGwRetry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpOper=vrrpOper, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfBackup=ospfIntfBackup, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, arpInfoTable=arpInfoTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIfInfoIndex=ospfIfInfoIndex, ripCurCfgListen=ripCurCfgListen, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrp_info=vrrp_info, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer)
