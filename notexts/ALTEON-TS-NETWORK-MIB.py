...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfinfo=ospfinfo, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, routeStatHighWater=routeStatHighWater, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaRxHello=ospfAreaRxHello, ospfCumNbrDown=ospfCumNbrDown, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, routerLSALinkIfIndex=routerLSALinkIfIndex, routerLSAAreaIndex=routerLSAAreaIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumNbrhello=ospfCumNbrhello, ospfIntfNbrStart=ospfIntfNbrStart, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumIntfLoop=ospfCumIntfLoop, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfHello=ospfIntfHello, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfBackup=ospfIntfBackup, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipRouteInfoEntry=ipRouteInfoEntry, ipForward=ipForward, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, routerLSALinkData=routerLSALinkData, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, routerLSAId=routerLSAId, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrp_info=vrrp_info, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpOper=vrrpOper, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfTotalNeighbours=ospfTotalNeighbours, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, iprouting=iprouting, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfRxHello=ospfIntfRxHello, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaIntfDown=ospfAreaIntfDown, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipRouteInfoMask=ipRouteInfoMask, ospfNbrInInitState=ospfNbrInInitState, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfArea=ospfArea, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaRxPkts=ospfAreaRxPkts, ospfNewCfgAreaId=ospfNewCfgAreaId, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaRxDatabase=ospfAreaRxDatabase, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaRxTxIndex=ospfAreaRxTxIndex, arpStatEntries=arpStatEntries, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumRxHello=ospfCumRxHello, ospfCumTxHello=ospfCumTxHello, ospfAreaInfoEntry=ospfAreaInfoEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipGatewayTableMax=ipGatewayTableMax, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgGwState=ipNewCfgGwState, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, routeStatMaxEntries=routeStatMaxEntries, routerLSALinkIndex=routerLSALinkIndex, ospfAreaIntfBackup=ospfAreaIntfBackup, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ripCurCfgSupply=ripCurCfgSupply, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfChangeStats=ospfIntfChangeStats, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfTxPkts=ospfIntfTxPkts, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfStartTime=ospfStartTime, routeStats=routeStats, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipRouteInfoTag=ipRouteInfoTag, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, arpStats=arpStats, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ripCurCfgListen=ripCurCfgListen, ospfCumNbrStart=ospfCumNbrStart, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripCurCfgState=ripCurCfgState, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfInterface=ospfInterface, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ripCurCfgVip=ripCurCfgVip, ospfGeneral=ospfGeneral, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ripStats=ripStats, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrp=vrrp, ospfAreaNbrRstAd=ospfAreaNbrRstAd, arpInfoFlag=arpInfoFlag, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgGwTable=ipCurCfgGwTable, ipRouteInfoIndx=ipRouteInfoIndx, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, arpStatHighWater=arpStatHighWater, arpInfoEntry=arpInfoEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaInfoIndex=ospfAreaInfoIndex, ip_info=ip_info, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfNbrDown=ospfIntfNbrDown)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumRxlsAcks=ospfCumRxlsAcks, ripCurCfgDefListen=ripCurCfgDefListen, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, arpInfoDestIp=arpInfoDestIp, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, arpStatMaxEntries=arpStatMaxEntries, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, routeStatEntries=routeStatEntries, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgIntfState=ipNewCfgIntfState, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipRouteInfoTable=ipRouteInfoTable, ospfCfg=ospfCfg, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripStatInPkts=ripStatInPkts, ipRouteInfoDestIp=ipRouteInfoDestIp, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfLoop=ospfIntfLoop, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaTxPkts=ospfAreaTxPkts, ospfProcessUptime=ospfProcessUptime, ospfIntfNbrChange=ospfIntfNbrChange, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfUnloop=ospfIntfUnloop, ospfTotalAreas=ospfTotalAreas, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfStats=ospfStats, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumTxPkts=ospfCumTxPkts, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfTxHello=ospfIntfTxHello, ospfGeneralStats=ospfGeneralStats, arpInfoTable=arpInfoTable, ipFwdNewCfgState=ipFwdNewCfgState, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripConfig=ripConfig, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfTimersKickOffStats=ospfTimersKickOffStats, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipNewCfgGwMetric=ipNewCfgGwMetric, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCumRxPkts=ospfCumRxPkts, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpGeneral=vrrpGeneral, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpStats=vrrpStats, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ripNewCfgListen=ripNewCfgListen, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumNbrBadRequests=ospfCumNbrBadRequests, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaTxHello=ospfAreaTxHello, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipCurCfgGwState=ipCurCfgGwState, dnsStats=dnsStats, ospfIntfInfoTable=ospfIntfInfoTable, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, arpInfoVLAN=arpInfoVLAN, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaInfoId=ospfAreaInfoId, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpStatOutAdvers=vrrpStatOutAdvers, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ripNewCfgSupply=ripNewCfgSupply, ospfAreaNbrN1way=ospfAreaNbrN1way, routerLSALinkID=routerLSALinkID)
