...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfNbrInFullState=ospfNbrInFullState, ospfIntfLoop=ospfIntfLoop, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfInterface=ospfInterface, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, arpInfoTable=arpInfoTable, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumNbrStart=ospfCumNbrStart, ospfCumIntfHello=ospfCumIntfHello, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipCurCfgBootpState=ipCurCfgBootpState, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipGatewayTableMax=ipGatewayTableMax, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipRouteInfoGateway=ipRouteInfoGateway, ripNewCfgSupply=ripNewCfgSupply, ospfIntfIndex=ospfIntfIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaIntfBackup=ospfAreaIntfBackup, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIfWaitInterval=ospfIfWaitInterval, ripCurCfgListen=ripCurCfgListen, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgBootpState=ipNewCfgBootpState, ipFwdNewCfgState=ipFwdNewCfgState, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumNbrhello=ospfCumNbrhello, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, routerLSALinkData=routerLSALinkData, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, arpStatEntries=arpStatEntries, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipNewCfgGwState=ipNewCfgGwState, ospfAreaIntfHello=ospfAreaIntfHello, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCumTxlsReqs=ospfCumTxlsReqs, arpInfoFlag=arpInfoFlag, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ripNewCfgState=ripNewCfgState, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfDown=ospfIntfDown, ospfCumIntfDown=ospfCumIntfDown, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, routeStatMaxEntries=routeStatMaxEntries, ripStats=ripStats, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpGeneral=vrrpGeneral, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipNewCfgGwArp=ipNewCfgGwArp, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ripStatInPkts=ripStatInPkts, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaTxPkts=ospfAreaTxPkts, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfCountForRouter=ospfIntfCountForRouter, iprouting=iprouting, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipForward=ipForward, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgGwTable=ipNewCfgGwTable, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, routerLSAId=routerLSAId, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, arpStatHighWater=arpStatHighWater, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, routeStatEntries=routeStatEntries, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumRxPkts=ospfCumRxPkts, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaIntfDown=ospfAreaIntfDown, arpInfoMacAddr=arpInfoMacAddr, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaInfoId=ospfAreaInfoId, ospfStats=ospfStats, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, ripCurCfgVip=ripCurCfgVip, arpStatMaxEntries=arpStatMaxEntries, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfUnloop=ospfIntfUnloop, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ripConfig=ripConfig, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfNbrInExchState=ospfNbrInExchState, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, arpInfoDestIp=arpInfoDestIp, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ripStatOutPkts=ripStatOutPkts, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipNewCfgGwRetry=ipNewCfgGwRetry, routerLSALinkIfIndex=routerLSALinkIfIndex, ripNewCfgDefListen=ripNewCfgDefListen, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaNbrDown=ospfAreaNbrDown, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfGeneralStats=ospfGeneralStats, ipNewCfgGwAddr=ipNewCfgGwAddr)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfHello=ospfIntfHello, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIfInfoIndex=ospfIfInfoIndex, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipRouteInfoTable=ipRouteInfoTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfNbrhello=ospfIntfNbrhello, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipNewCfgIntfState=ipNewCfgIntfState, ospfCfg=ospfCfg, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ip_info=ip_info, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumTxPkts=ospfCumTxPkts, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaNbrhello=ospfAreaNbrhello, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipNewCfgGwDelete=ipNewCfgGwDelete, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfArea=ospfArea, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, arpInfoEntry=arpInfoEntry, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgGwInterval=ipCurCfgGwInterval, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfGeneral=ospfGeneral, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, routerLSALinkID=routerLSALinkID, arpInfoSrcPort=arpInfoSrcPort, ospfAreaTxHello=ospfAreaTxHello, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, arpInfoVLAN=arpInfoVLAN, arpStats=arpStats, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrp=vrrp, ospfIntfNbrChange=ospfIntfNbrChange, ripCurCfgSupply=ripCurCfgSupply, vrrpStats=vrrpStats, ospfCumNbrDown=ospfCumNbrDown, ipInterfaceTableMax=ipInterfaceTableMax, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgGwInterval=ipNewCfgGwInterval, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripCurCfgState=ripCurCfgState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpOper=vrrpOper, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfTotalAreas=ospfTotalAreas, ospfAreaRxPkts=ospfAreaRxPkts, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumTxHello=ospfCumTxHello, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCumIntfLoop=ospfCumIntfLoop, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgGwState=ipCurCfgGwState, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, dnsStats=dnsStats, ospfStartTime=ospfStartTime, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, routeStats=routeStats, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfinfo=ospfinfo, ospfIntfBackup=ospfIntfBackup, vrrpStatInAdvers=vrrpStatInAdvers, ipRouteInfoType=ipRouteInfoType, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc)
