...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgGwVlan=ipCurCfgGwVlan, routeStatHighWater=routeStatHighWater, ospfCumNbrStart=ospfCumNbrStart, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ripNewCfgSupply=ripNewCfgSupply, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrp_info=vrrp_info, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgGwMetric=ipNewCfgGwMetric, arpInfoVLAN=arpInfoVLAN, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfGeneralStats=ospfGeneralStats, ipNewCfgBootpState=ipNewCfgBootpState, ospfArea=ospfArea, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgGwVlan=ipNewCfgGwVlan, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaInfoTable=ospfAreaInfoTable, routerLSAId=routerLSAId, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfNbrDown=ospfIntfNbrDown, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCfg=ospfCfg, ospfNbrInFullState=ospfNbrInFullState, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgGwAddr=ipNewCfgGwAddr, ripCurCfgSupply=ripCurCfgSupply, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgGwArp=ipCurCfgGwArp, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumIntfHello=ospfCumIntfHello, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaTxHello=ospfAreaTxHello, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpStatInAdvers=vrrpStatInAdvers, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfTotalNeighbours=ospfTotalNeighbours, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgIntfAddr=ipCurCfgIntfAddr, arpInfoEntry=arpInfoEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripStatInErrorPkts=ripStatInErrorPkts, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumNbrhello=ospfCumNbrhello, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCumNbrDown=ospfCumNbrDown, arpStatHighWater=arpStatHighWater, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ripCurCfgVip=ripCurCfgVip, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaIntfHello=ospfAreaIntfHello, ripStats=ripStats, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfLsTypesSupported=ospfLsTypesSupported, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpGeneral=vrrpGeneral, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumTxPkts=ospfCumTxPkts, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaRxPkts=ospfAreaRxPkts, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpStats=vrrpStats, routerLSALinkIndex=routerLSALinkIndex, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, dnsStats=dnsStats, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipForward=ipForward, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipRouteInfoTable=ipRouteInfoTable, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, arpInfoMacAddr=arpInfoMacAddr, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfLoop=ospfIntfLoop, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumRxlsReqs=ospfCumRxlsReqs, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCurCfgAreaTable=ospfCurCfgAreaTable, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfStartTime=ospfStartTime, arpStatMaxEntries=arpStatMaxEntries, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfInterface=ospfInterface, ospfAreaInfoEntry=ospfAreaInfoEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgGwState=ipCurCfgGwState, ospfIntfTxPkts=ospfIntfTxPkts, ipNewCfgGwState=ipNewCfgGwState, ospfCumIntfDown=ospfCumIntfDown, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaNbrDown=ospfAreaNbrDown, ipInterfaceTableMax=ipInterfaceTableMax, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgGwInterval=ipCurCfgGwInterval, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, routerLSALinkID=routerLSALinkID, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfNbrInExchState=ospfNbrInExchState, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", routerLSALinkData=routerLSALinkData, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpOper=vrrpOper, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfNbrInInitState=ospfNbrInInitState, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaTxPkts=ospfAreaTxPkts, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfHello=ospfIntfHello, ospfIntfBackup=ospfIntfBackup, routerLSAAreaIndex=routerLSAAreaIndex, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfIndex=ospfIntfIndex, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ripNewCfgVip=ripNewCfgVip, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfInfoEntry=ospfIntfInfoEntry, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, iprouting=iprouting, ospfIntfNbrhello=ospfIntfNbrhello, ripNewCfgState=ripNewCfgState, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripNewCfgListen=ripNewCfgListen, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfDown=ospfIntfDown, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfRxTxIndex=ospfIntfRxTxIndex, arpInfoFlag=arpInfoFlag, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIfWaitInterval=ospfIfWaitInterval, arpInfoDestIp=arpInfoDestIp, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumRxPkts=ospfCumRxPkts, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrp=vrrp, routeStatEntries=routeStatEntries, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgGenState=vrrpNewCfgGenState, ripConfig=ripConfig, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgGwRetry=ipNewCfgGwRetry, ipGatewayTableMax=ipGatewayTableMax, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipRouteInfoGateway=ipRouteInfoGateway, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, routeStatMaxEntries=routeStatMaxEntries, ospfIntfRxPkts=ospfIntfRxPkts, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgGwTable=ipNewCfgGwTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, routeStats=routeStats, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ip_info=ip_info, arpStatEntries=arpStatEntries, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipRouteInfoIndx=ipRouteInfoIndx, ripCurCfgListen=ripCurCfgListen, ospfAreaInfoId=ospfAreaInfoId, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, arpStats=arpStats, ipRouteInfoType=ipRouteInfoType, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfStats=ospfStats, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumNbrN1way=ospfCumNbrN1way, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, arpInfoTable=arpInfoTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfGeneral=ospfGeneral, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfTotalNssaAreas=ospfTotalNssaAreas)
