...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipForward=ipForward, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaNbrDown=ospfAreaNbrDown, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIfInfoIndex=ospfIfInfoIndex, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfGeneralStats=ospfGeneralStats, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipRouteInfoTable=ipRouteInfoTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfNewCfgAreaTable=ospfNewCfgAreaTable, arpStats=arpStats, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, iprouting=iprouting, ospfStats=ospfStats, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ripCurCfgState=ripCurCfgState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdCurCfgPortState=ipFwdCurCfgPortState, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumTxHello=ospfCumTxHello, routerLSALinkData=routerLSALinkData, vrrp=vrrp, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaTxPkts=ospfAreaTxPkts, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfBackup=ospfIntfBackup, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgGwArp=ipNewCfgGwArp, ripCurCfgSupply=ripCurCfgSupply, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipRouteInfoIndx=ipRouteInfoIndx, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumNbrStart=ospfCumNbrStart, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfTxHello=ospfIntfTxHello, ospfCfg=ospfCfg, ospfCumTxPkts=ospfCumTxPkts, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgBootpState=ipCurCfgBootpState, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, arpInfoTable=arpInfoTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaInfoTable=ospfAreaInfoTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfRxHello=ospfIntfRxHello, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripNewCfgListen=ripNewCfgListen, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumIntfUnloop=ospfCumIntfUnloop, ipRouteInfoMask=ipRouteInfoMask, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgIntfState=ipNewCfgIntfState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ripStatInErrorPkts=ripStatInErrorPkts, routeStatHighWater=routeStatHighWater, ospfAreaIntfHello=ospfAreaIntfHello, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgGwArp=ipCurCfgGwArp, ospfLsTypesSupported=ospfLsTypesSupported, ospfGeneral=ospfGeneral, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgGwTable=ipCurCfgGwTable, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, dnsStats=dnsStats, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, arpInfoDestIp=arpInfoDestIp, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumIntfHello=ospfCumIntfHello, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumIntfLoop=ospfCumIntfLoop, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ripStats=ripStats, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfNbrDown=ospfIntfNbrDown, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfNbrInExchState=ospfNbrInExchState, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaNbrhello=ospfAreaNbrhello, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfInterface=ospfInterface, ospfAreaInfoId=ospfAreaInfoId, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfArea=ospfArea, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgGwIndex=ipNewCfgGwIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfRxPkts=ospfIntfRxPkts, arpInfoSrcPort=arpInfoSrcPort, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ripNewCfgState=ripNewCfgState, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaTxHello=ospfAreaTxHello, ospfCumTxlsReqs=ospfCumTxlsReqs, ipRouteInfoGateway=ipRouteInfoGateway, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfStartTime=ospfStartTime, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpGeneral=vrrpGeneral, ospfIntfUnloop=ospfIntfUnloop, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipInterfaceTableMax=ipInterfaceTableMax, vrrpOper=vrrpOper, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaRxHello=ospfAreaRxHello, ripNewCfgVip=ripNewCfgVip, ospfAreaRxlsReqs=ospfAreaRxlsReqs, arpInfoMacAddr=arpInfoMacAddr, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumRxHello=ospfCumRxHello, ripStatInPkts=ripStatInPkts, ipRouteInfoType=ipRouteInfoType, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipRouteInfoInterface=ipRouteInfoInterface, ospfTotalNeighbours=ospfTotalNeighbours, ripConfig=ripConfig, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrp_info=vrrp_info, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaRxPkts=ospfAreaRxPkts, ipCurCfgGwState=ipCurCfgGwState, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfIndex=ospfIntfIndex, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfChangeStats=ospfIntfChangeStats, ospfinfo=ospfinfo, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipRouteInfoDestIp=ipRouteInfoDestIp, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumNbrhello=ospfCumNbrhello, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfTotalAreas=ospfTotalAreas, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ripCurCfgListen=ripCurCfgListen, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, arpInfoEntry=arpInfoEntry, ripStatOutPkts=ripStatOutPkts, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfInfoTable=ospfIntfInfoTable, ipGatewayTableMax=ipGatewayTableMax, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, routerLSAId=routerLSAId, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgGwMetric=ipNewCfgGwMetric, routerLSALinkIndex=routerLSALinkIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgBootpState=ipNewCfgBootpState, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ip_info=ip_info, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpStats=vrrpStats, ipCurCfgGwInterval=ipCurCfgGwInterval, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripNewCfgDefListen=ripNewCfgDefListen, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfTmrsKckOffHello=ospfTmrsKckOffHello, arpInfoVLAN=arpInfoVLAN, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripCurCfgVip=ripCurCfgVip, ospfCumNbrDown=ospfCumNbrDown, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfNbrInInitState=ospfNbrInInitState, ospfNewCfgAreaId=ospfNewCfgAreaId, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, routeStatEntries=routeStatEntries, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfHello=ospfIntfHello, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, routeStats=routeStats, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfProcessUptime=ospfProcessUptime)
