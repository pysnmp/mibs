...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfTotalNeighbours=ospfTotalNeighbours, dnsStats=dnsStats, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, arpStatEntries=arpStatEntries, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfBackup=ospfIntfBackup, ospfIntfUnloop=ospfIntfUnloop, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdNewCfgState=ipFwdNewCfgState, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaIntfBackup=ospfAreaIntfBackup, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumRxHello=ospfCumRxHello, arpStats=arpStats, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpStats=vrrpStats, ospfIntfDown=ospfIntfDown, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumRxPkts=ospfCumRxPkts, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaRxHello=ospfAreaRxHello, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaNbrDown=ospfAreaNbrDown, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipNewCfgGwState=ipNewCfgGwState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, routerLSAAreaIndex=routerLSAAreaIndex, ip_info=ip_info, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipRouteInfoType=ipRouteInfoType, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpGeneral=vrrpGeneral, ospfIntfTxHello=ospfIntfTxHello, ospfIntfLoop=ospfIntfLoop, ipRouteInfoGateway=ipRouteInfoGateway, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfIndex=ospfIntfIndex, ipRouteInfoMask=ipRouteInfoMask, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ripStatOutPkts=ripStatOutPkts, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfNbrInFullState=ospfNbrInFullState, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgGwIndex=ipNewCfgGwIndex, arpStatHighWater=arpStatHighWater, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumTxDatabase=ospfCumTxDatabase, routerLSALinkID=routerLSALinkID, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfTxPkts=ospfIntfTxPkts, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfStartTime=ospfStartTime, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfNbrInExchState=ospfNbrInExchState, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfNbrStart=ospfIntfNbrStart, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrp=vrrp, ipGatewayTableMax=ipGatewayTableMax, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgGwMetric=ipCurCfgGwMetric, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfNbrN1way=ospfIntfNbrN1way, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaTxPkts=ospfAreaTxPkts, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCurCfgAreaId=ospfCurCfgAreaId, ipRouteInfoTag=ipRouteInfoTag, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgGwTable=ipNewCfgGwTable, routerLSALinkIndex=routerLSALinkIndex, ospfIfWaitInterval=ospfIfWaitInterval, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, arpInfoSrcPort=arpInfoSrcPort, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipRouteInfoIndx=ipRouteInfoIndx, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaRxlsAcks=ospfAreaRxlsAcks, routeStatEntries=routeStatEntries, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfRxHello=ospfIntfRxHello, ospfCumIntfHello=ospfCumIntfHello, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfArea=ospfArea, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ripNewCfgVip=ripNewCfgVip, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ripCurCfgVip=ripCurCfgVip, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripStatInErrorPkts=ripStatInErrorPkts, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaNbrStart=ospfAreaNbrStart, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumRxTxStats=ospfCumRxTxStats, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumIntfBackup=ospfCumIntfBackup, arpInfoMacAddr=arpInfoMacAddr, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaInfoIndex=ospfAreaInfoIndex, ipRouteInfoEntry=ipRouteInfoEntry, ripNewCfgDefListen=ripNewCfgDefListen, ipForward=ipForward, arpInfoEntry=arpInfoEntry, arpInfoDestIp=arpInfoDestIp, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaInfoId=ospfAreaInfoId, ripConfig=ripConfig, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfProcessUptime=ospfProcessUptime, ipCurCfgGwState=ipCurCfgGwState, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, arpInfoTable=arpInfoTable, routerLSAId=routerLSAId, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCfg=ospfCfg, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ripStatInPkts=ripStatInPkts, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ripCurCfgSupply=ripCurCfgSupply, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ripStats=ripStats, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfHello=ospfIntfHello, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfInterface=ospfInterface, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, routerLSALinkData=routerLSALinkData, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaNbrhello=ospfAreaNbrhello, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, iprouting=iprouting, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgGwInterval=ipCurCfgGwInterval, ripNewCfgSupply=ripNewCfgSupply, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipCurCfgGwEntry=ipCurCfgGwEntry, ripNewCfgState=ripNewCfgState, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfGeneral=ospfGeneral, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, routeStatHighWater=routeStatHighWater, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ripCurCfgListen=ripCurCfgListen, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumIntfDown=ospfCumIntfDown, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, arpStatMaxEntries=arpStatMaxEntries, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIfTotalNeighbours=ospfIfTotalNeighbours, arpInfoVLAN=arpInfoVLAN, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCumTxHello=ospfCumTxHello, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ripCurCfgState=ripCurCfgState, arpInfoFlag=arpInfoFlag, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, routeStats=routeStats, ospfGeneralStats=ospfGeneralStats, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgBootpState=ipNewCfgBootpState, ospfNbrInInitState=ospfNbrInInitState, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumNbrN1way=ospfCumNbrN1way, ospfStats=ospfStats, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ripNewCfgListen=ripNewCfgListen, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx)
