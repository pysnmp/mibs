...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgGwTable=ipCurCfgGwTable, vrrpOper=vrrpOper, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipRouteInfoType=ipRouteInfoType, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfBackup=ospfIntfBackup, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipFwdCurCfgState=ipFwdCurCfgState, arpStatHighWater=arpStatHighWater, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgBootpState=ipNewCfgBootpState, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfTxPkts=ospfIntfTxPkts, ospfStats=ospfStats, iprouting=iprouting, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipRouteInfoMask=ipRouteInfoMask, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ripStatInPkts=ripStatInPkts, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumIntfHello=ospfCumIntfHello, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumRxPkts=ospfCumRxPkts, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, routeStats=routeStats, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumTxPkts=ospfCumTxPkts, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ip_info=ip_info, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ripNewCfgSupply=ripNewCfgSupply, arpInfoEntry=arpInfoEntry, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, arpStatEntries=arpStatEntries, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumNbrStart=ospfCumNbrStart, ipGatewayTableMax=ipGatewayTableMax, ospfArea=ospfArea, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, routeStatHighWater=routeStatHighWater, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipRouteInfoTag=ipRouteInfoTag, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaInfoTable=ospfAreaInfoTable, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, routerLSALinkID=routerLSALinkID, ospfAreaNbrN1way=ospfAreaNbrN1way, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, arpInfoTable=arpInfoTable, ipNewCfgGwState=ipNewCfgGwState, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgGenState=vrrpNewCfgGenState, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumRxTxStats=ospfCumRxTxStats, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaTxHello=ospfAreaTxHello, ripCurCfgVip=ripCurCfgVip, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripCurCfgSupply=ripCurCfgSupply, ospfCurCfgAreaId=ospfCurCfgAreaId, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfTxlsReqs=ospfIntfTxlsReqs, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ripStatOutPkts=ripStatOutPkts, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpStatOutAdvers=vrrpStatOutAdvers, ripNewCfgVip=ripNewCfgVip, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, arpInfoVLAN=arpInfoVLAN, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgGwIndex=ipCurCfgGwIndex, ripStatRoutesAgedOut=ripStatRoutesAgedOut, routeStatEntries=routeStatEntries, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfNbrInExchState=ospfNbrInExchState, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ripStats=ripStats, vrrpStatInAdvers=vrrpStatInAdvers, ripNewCfgDefListen=ripNewCfgDefListen, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfInterface=ospfInterface, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, arpInfoDestIp=arpInfoDestIp, ospfIntfNbrStart=ospfIntfNbrStart, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCumRxHello=ospfCumRxHello, ospfGeneralStats=ospfGeneralStats)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfRxTxStats=ospfIntfRxTxStats, arpInfoFlag=arpInfoFlag, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, arpStats=arpStats, ospfIntfRxPkts=ospfIntfRxPkts, ripConfig=ripConfig, ipForward=ipForward, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaRxlsReqs=ospfAreaRxlsReqs, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumNbrDown=ospfCumNbrDown, ospfNbrInFullState=ospfNbrInFullState, ospfGeneral=ospfGeneral, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumIntfDown=ospfCumIntfDown, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripCurCfgDefListen=ripCurCfgDefListen, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, arpStatMaxEntries=arpStatMaxEntries, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgGwDelete=ipNewCfgGwDelete, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfTxHello=ospfIntfTxHello, ospfAreaInfoId=ospfAreaInfoId, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfDown=ospfIntfDown, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, routerLSAId=routerLSAId, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfChangeStats=ospfIntfChangeStats, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfGeneralInfo=ospfGeneralInfo, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, routeStatMaxEntries=routeStatMaxEntries, arpInfoMacAddr=arpInfoMacAddr, vrrp=vrrp, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ripNewCfgListen=ripNewCfgListen, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCfg=ospfCfg, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaRxHello=ospfAreaRxHello, ospfAreaNbrhello=ospfAreaNbrhello, dnsStats=dnsStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIfInfoIndex=ospfIfInfoIndex, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrp_info=vrrp_info, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaIntfDown=ospfAreaIntfDown, ipRouteInfoTable=ipRouteInfoTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipRouteInfoDestIp=ipRouteInfoDestIp, ipCurCfgGwArp=ipCurCfgGwArp, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpStats=vrrpStats, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, routerLSALinkIndex=routerLSALinkIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpGeneral=vrrpGeneral, ospfIntfLoop=ospfIntfLoop, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfNbrRstAd=ospfIntfNbrRstAd, arpInfoRefPorts=arpInfoRefPorts, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfUnloop=ospfIntfUnloop, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaTxDatabase=ospfAreaTxDatabase, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgGwState=ipCurCfgGwState, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete)
