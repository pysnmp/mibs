...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ip_info=ip_info, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgGwState=ipNewCfgGwState, ospfAreaInfoId=ospfAreaInfoId, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpOper=vrrpOper, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgGwState=ipCurCfgGwState, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpStats=vrrpStats, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfRxTxStats=ospfIntfRxTxStats, arpInfoEntry=arpInfoEntry, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, routeStatEntries=routeStatEntries, ripNewCfgSupply=ripNewCfgSupply, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCumIntfHello=ospfCumIntfHello, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipCurCfgGwMetric=ipCurCfgGwMetric, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfRxPkts=ospfIntfRxPkts, ipInterfaceTableMax=ipInterfaceTableMax, ripCurCfgDefListen=ripCurCfgDefListen, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ripCurCfgVip=ripCurCfgVip, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfTxPkts=ospfIntfTxPkts, routerLSAId=routerLSAId, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfArea=ospfArea, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfInterface=ospfInterface, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipCurCfgGwTable=ipCurCfgGwTable, vrrp_info=vrrp_info, ospfIntfWaitTimer=ospfIntfWaitTimer, arpStatMaxEntries=arpStatMaxEntries, ospfTotalNeighbours=ospfTotalNeighbours, arpInfoDestIp=arpInfoDestIp, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ripConfig=ripConfig, ipForward=ipForward, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgGwInterval=ipNewCfgGwInterval, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaIntfDown=ospfAreaIntfDown, ospfGeneral=ospfGeneral, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfinfo=ospfinfo, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIfWaitInterval=ospfIfWaitInterval, arpStatHighWater=arpStatHighWater, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, routeStatMaxEntries=routeStatMaxEntries, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, arpInfoVLAN=arpInfoVLAN, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCumRxTxStats=ospfCumRxTxStats, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, routerLSALinkID=routerLSALinkID, ospfNbrInInitState=ospfNbrInInitState, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumNbrStart=ospfCumNbrStart, ripStats=ripStats, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, arpInfoFlag=arpInfoFlag, ospfNbrInExchState=ospfNbrInExchState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfTxHello=ospfIntfTxHello, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfUnloop=ospfIntfUnloop, ospfCfg=ospfCfg, vrrp=vrrp, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfStartTime=ospfStartTime, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumTxPkts=ospfCumTxPkts, iprouting=iprouting, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaInfoTable=ospfAreaInfoTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ripCurCfgState=ripCurCfgState, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaNbrIndex=ospfAreaNbrIndex, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgGwInterval=ipCurCfgGwInterval, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfIndex=ospfIntfIndex, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfNbrChange=ospfIntfNbrChange, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfStats=ospfStats, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfLoop=ospfIntfLoop, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgIntfState=ipNewCfgIntfState, ripStatInPkts=ripStatInPkts, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaInfoIndex=ospfAreaInfoIndex, arpInfoSrcPort=arpInfoSrcPort, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgGwArp=ipCurCfgGwArp, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfTotalAreas=ospfTotalAreas, ripStatOutPkts=ripStatOutPkts, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, routeStatHighWater=routeStatHighWater, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumIntfLoop=ospfCumIntfLoop, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumRxHello=ospfCumRxHello, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgGwAddr=ipCurCfgGwAddr, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumRxPkts=ospfCumRxPkts, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ripCurCfgListen=ripCurCfgListen, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipRouteInfoType=ipRouteInfoType, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIfInfoIndex=ospfIfInfoIndex, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfDown=ospfIntfDown, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfGeneralStats=ospfGeneralStats, ospfProcessUptime=ospfProcessUptime, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumTxDatabase=ospfCumTxDatabase, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaRxPkts=ospfAreaRxPkts, ipRouteInfoTable=ipRouteInfoTable, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfRxHello=ospfIntfRxHello, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumIntfDown=ospfCumIntfDown, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, arpStatEntries=arpStatEntries, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipRouteInfoMask=ipRouteInfoMask, routeStats=routeStats, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, arpStats=arpStats, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpGeneral=vrrpGeneral, ipRouteInfoTag=ipRouteInfoTag, dnsStats=dnsStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfInfoEntry=ospfIntfInfoEntry, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfHello=ospfIntfHello, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipGatewayTableMax=ipGatewayTableMax)
