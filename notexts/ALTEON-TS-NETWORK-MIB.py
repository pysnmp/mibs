...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrp_info=vrrp_info, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ip_info=ip_info, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgGwState=ipNewCfgGwState, ripNewCfgVip=ripNewCfgVip, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, arpInfoVLAN=arpInfoVLAN, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgGwState=ipCurCfgGwState, ospfCumTxlsUpdates=ospfCumTxlsUpdates, iprouting=iprouting, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipInterfaceTableMax=ipInterfaceTableMax, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgBootpState=ipNewCfgBootpState, ripStatInErrorPkts=ripStatInErrorPkts, ipRouteInfoMask=ipRouteInfoMask, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, arpInfoTable=arpInfoTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCumRxPkts=ospfCumRxPkts, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfStartTime=ospfStartTime, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfBackup=ospfIntfBackup, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumRxTxStats=ospfCumRxTxStats, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfProcessUptime=ospfProcessUptime, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaNbrDown=ospfAreaNbrDown, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfinfo=ospfinfo, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipRouteInfoTag=ipRouteInfoTag, ospfIntfHello=ospfIntfHello, ospfAreaInfoTable=ospfAreaInfoTable, ipGatewayTableMax=ipGatewayTableMax, ipRouteInfoEntry=ipRouteInfoEntry, ospfStats=ospfStats, ripCurCfgSupply=ripCurCfgSupply, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfTxHello=ospfIntfTxHello, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ripCurCfgListen=ripCurCfgListen, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumNbrhello=ospfCumNbrhello, vrrp=vrrp, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfLoop=ospfIntfLoop, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfRxlsReqs=ospfIntfRxlsReqs, arpStatEntries=arpStatEntries, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgGwArp=ipNewCfgGwArp, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpOper=vrrpOper, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgGwRetry=ipNewCfgGwRetry, ipForward=ipForward, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, arpInfoDestIp=arpInfoDestIp, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfTotalAreas=ospfTotalAreas, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ripCurCfgDefListen=ripCurCfgDefListen, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, routeStatHighWater=routeStatHighWater, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, routerLSALinkID=routerLSALinkID, ospfGeneralStats=ospfGeneralStats, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaNbrhello=ospfAreaNbrhello, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ripNewCfgSupply=ripNewCfgSupply, ospfCumIntfDown=ospfCumIntfDown, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ripStatOutPkts=ripStatOutPkts, ospfCumNbrDown=ospfCumNbrDown, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaTxHello=ospfAreaTxHello, ripStats=ripStats, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfChangeStats=ospfIntfChangeStats, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpStats=vrrpStats, ipRouteInfoIndx=ipRouteInfoIndx, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, routeStats=routeStats, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgGwAddr=ipNewCfgGwAddr, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumTxHello=ospfCumTxHello, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, routerLSALinkData=routerLSALinkData, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, routerLSAAreaIndex=routerLSAAreaIndex, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfInfoTable=ospfIntfInfoTable, ipRouteInfoType=ipRouteInfoType)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripConfig=ripConfig, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, arpInfoEntry=arpInfoEntry, ospfArea=ospfArea, arpInfoRefPorts=arpInfoRefPorts, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgIntfVlan=ipCurCfgIntfVlan, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfInterface=ospfInterface, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumNbrStart=ospfCumNbrStart, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaRxHello=ospfAreaRxHello, arpStats=arpStats, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIfWaitInterval=ospfIfWaitInterval, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfDown=ospfIntfDown, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfWaitTimer=ospfIntfWaitTimer, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgGwTable=ipCurCfgGwTable, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfNbrInExchState=ospfNbrInExchState, ospfCumNbrBadRequests=ospfCumNbrBadRequests, arpStatHighWater=arpStatHighWater, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, routerLSAId=routerLSAId, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgIntfTable=ipNewCfgIntfTable, ripNewCfgListen=ripNewCfgListen, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumIntfHello=ospfCumIntfHello, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfGeneralInfo=ospfGeneralInfo, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ripStatInPkts=ripStatInPkts, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, routeStatEntries=routeStatEntries, ipNewCfgGwVlan=ipNewCfgGwVlan, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCfg=ospfCfg, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaRxDatabase=ospfAreaRxDatabase, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ripCurCfgState=ripCurCfgState, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfTxDatabase=ospfIntfTxDatabase, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumTxPkts=ospfCumTxPkts, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaInfoId=ospfAreaInfoId, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, dnsStats=dnsStats, ospfIntfRxTxStats=ospfIntfRxTxStats, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfNbrDown=ospfIntfNbrDown, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaRxPkts=ospfAreaRxPkts, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ripNewCfgState=ripNewCfgState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfNbrInInitState=ospfNbrInInitState, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfGeneral=ospfGeneral, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState)
