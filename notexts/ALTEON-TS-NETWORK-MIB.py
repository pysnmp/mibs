...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCfg=ospfCfg, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfInterface=ospfInterface, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfGeneralInfo=ospfGeneralInfo, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfTxHello=ospfIntfTxHello, routeStatMaxEntries=routeStatMaxEntries, ospfCumRxDatabase=ospfCumRxDatabase, routeStats=routeStats, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpStats=vrrpStats, ipGatewayTableMax=ipGatewayTableMax, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaTxHello=ospfAreaTxHello, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripStatInErrorPkts=ripStatInErrorPkts, arpStatEntries=arpStatEntries, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, arpInfoVLAN=arpInfoVLAN, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, arpInfoDestIp=arpInfoDestIp, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumTxPkts=ospfCumTxPkts, ospfIntfUnloop=ospfIntfUnloop, ospfIntfLoop=ospfIntfLoop, ospfCumRxTxStats=ospfCumRxTxStats, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipCurCfgGwState=ipCurCfgGwState, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfDown=ospfIntfDown, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgGwTable=ipNewCfgGwTable, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfChangeStats=ospfIntfChangeStats, ospfArea=ospfArea, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfInfoTable=ospfIntfInfoTable, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfStartTime=ospfStartTime, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaRxHello=ospfAreaRxHello, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgGwArp=ipCurCfgGwArp, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaIntfHello=ospfAreaIntfHello, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipRouteInfoTag=ipRouteInfoTag, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, arpInfoSrcPort=arpInfoSrcPort, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfTotalAreas=ospfTotalAreas, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaRxlsAcks=ospfAreaRxlsAcks, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaRxlsReqs=ospfAreaRxlsReqs, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaIntfDown=ospfAreaIntfDown, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCumRxHello=ospfCumRxHello, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfGeneral=ospfGeneral, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfNbrInExchState=ospfNbrInExchState, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ripConfig=ripConfig, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, dnsStats=dnsStats, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaInfoTable=ospfAreaInfoTable, ipForward=ipForward, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaTxPkts=ospfAreaTxPkts, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgBootpState=ipCurCfgBootpState, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaRxDatabase=ospfAreaRxDatabase, ripStatInPkts=ripStatInPkts, ospfAreaNbrStart=ospfAreaNbrStart, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfRxHello=ospfIntfRxHello, ospfAreaInfoEntry=ospfAreaInfoEntry, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfTxPkts=ospfIntfTxPkts, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfLsTypesSupported=ospfLsTypesSupported, arpInfoMacAddr=arpInfoMacAddr, routerLSAAreaIndex=routerLSAAreaIndex, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpOper=vrrpOper, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipRouteInfoTable=ipRouteInfoTable, ospfAreaNbrIndex=ospfAreaNbrIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ip_info=ip_info, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, arpInfoTable=arpInfoTable, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, routerLSAId=routerLSAId, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripCurCfgDefListen=ripCurCfgDefListen, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumIntfLoop=ospfCumIntfLoop, ripNewCfgListen=ripNewCfgListen, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfNbrRstAd=ospfIntfNbrRstAd, routerLSALinkIfIndex=routerLSALinkIfIndex, ripCurCfgSupply=ripCurCfgSupply, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrp=vrrp, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ripStats=ripStats, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfStats=ospfStats, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipCurCfgIntfState=ipCurCfgIntfState, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipRouteInfoInterface=ipRouteInfoInterface, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, routeStatHighWater=routeStatHighWater, ospfCumRxPkts=ospfCumRxPkts, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumIntfBackup=ospfCumIntfBackup, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipRouteInfoEntry=ipRouteInfoEntry, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpGeneral=vrrpGeneral, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, routerLSALinkID=routerLSALinkID, arpInfoEntry=arpInfoEntry, ripNewCfgSupply=ripNewCfgSupply, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ripNewCfgVip=ripNewCfgVip, ospfAreaRxPkts=ospfAreaRxPkts, iprouting=iprouting, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumIntfHello=ospfCumIntfHello, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ripCurCfgState=ripCurCfgState, ospfCumIntfUnloop=ospfCumIntfUnloop, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, arpInfoRefPorts=arpInfoRefPorts, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfinfo=ospfinfo, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumNbrhello=ospfCumNbrhello, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ripCurCfgListen=ripCurCfgListen, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipRouteInfoMask=ipRouteInfoMask, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipInterfaceTableMax=ipInterfaceTableMax, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfNbrInFullState=ospfNbrInFullState, ospfAreaTxDatabase=ospfAreaTxDatabase, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfIndex=ospfIntfIndex, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfProcessUptime=ospfProcessUptime, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIfInfoIndex=ospfIfInfoIndex, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfHostTableMaxSize=ospfHostTableMaxSize, arpStats=arpStats, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ripCurCfgVip=ripCurCfgVip, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, routerLSALinkData=routerLSALinkData, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfBackup=ospfIntfBackup, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCumNbrRstAd=ospfCumNbrRstAd)
