...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgGwTable=ipCurCfgGwTable, routeStats=routeStats, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpOper=vrrpOper, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfNbrInFullState=ospfNbrInFullState, arpInfoTable=arpInfoTable, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfTotalNssaAreas=ospfTotalNssaAreas, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, arpInfoDestIp=arpInfoDestIp, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfLoop=ospfIntfLoop, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, routeStatHighWater=routeStatHighWater, ripNewCfgVip=ripNewCfgVip, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCumIntfBackup=ospfCumIntfBackup, ipRouteInfoTag=ipRouteInfoTag, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, arpStatHighWater=arpStatHighWater, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgGwArp=ipNewCfgGwArp, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumRxTxStats=ospfCumRxTxStats, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, routeStatEntries=routeStatEntries, vrrpStatInAdvers=vrrpStatInAdvers, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCfg=ospfCfg, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumRxlsUpdates=ospfCumRxlsUpdates, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ip_info=ip_info, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipCurCfgGwMetric=ipCurCfgGwMetric, ripCurCfgListen=ripCurCfgListen, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgGwState=ipCurCfgGwState, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumRxDatabase=ospfCumRxDatabase, routerLSALinkID=routerLSALinkID, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrp_info=vrrp_info, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ripNewCfgState=ripNewCfgState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumNbrN1way=ospfCumNbrN1way, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipRouteInfoType=ipRouteInfoType, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, arpStatEntries=arpStatEntries, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, dnsStats=dnsStats, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfProcessUptime=ospfProcessUptime, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfNbrInInitState=ospfNbrInInitState, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgGwState=ipNewCfgGwState, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfTxPkts=ospfIntfTxPkts, arpInfoSrcPort=arpInfoSrcPort, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, arpInfoFlag=arpInfoFlag, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaNbrStart=ospfAreaNbrStart, arpStats=arpStats, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipInterfaceTableMax=ipInterfaceTableMax, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipRouteInfoIndx=ipRouteInfoIndx, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaRxHello=ospfAreaRxHello, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfInterface=ospfInterface, ospfAreaTxDatabase=ospfAreaTxDatabase, arpInfoVLAN=arpInfoVLAN, ospfIntfTxDatabase=ospfIntfTxDatabase, routeStatMaxEntries=routeStatMaxEntries, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfDown=ospfIntfDown, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumRxHello=ospfCumRxHello, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfRxPkts=ospfIntfRxPkts, routerLSAId=routerLSAId, ospfArea=ospfArea, ospfAreaIntfHello=ospfAreaIntfHello, ripConfig=ripConfig, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgGenState=vrrpNewCfgGenState, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfLsTypesSupported=ospfLsTypesSupported, ospfStats=ospfStats, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumNbrDown=ospfCumNbrDown, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgGwArp=ipCurCfgGwArp, ripStatRoutesAgedOut=ripStatRoutesAgedOut)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumNbrhello=ospfCumNbrhello, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipFwdCurCfgState=ipFwdCurCfgState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ripCurCfgVip=ripCurCfgVip, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipRouteInfoMask=ipRouteInfoMask, vrrp=vrrp, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ripCurCfgState=ripCurCfgState, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ripNewCfgListen=ripNewCfgListen, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, iprouting=iprouting, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfUnloop=ospfIntfUnloop, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumIntfHello=ospfCumIntfHello, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ripStatOutPkts=ripStatOutPkts, ospfCumIntfDown=ospfCumIntfDown, ospfIntfBackup=ospfIntfBackup, ospfAreaInfoId=ospfAreaInfoId, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaChangeStats=ospfAreaChangeStats, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumTxHello=ospfCumTxHello, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIfInfoIndex=ospfIfInfoIndex, ripStatInPkts=ripStatInPkts, ripStats=ripStats, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfStartTime=ospfStartTime, ospfIntfIndex=ospfIntfIndex, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpStats=vrrpStats, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipForward=ipForward, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgGwRetry=ipCurCfgGwRetry, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfTxHello=ospfIntfTxHello, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ripCurCfgSupply=ripCurCfgSupply, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumTxPkts=ospfCumTxPkts, ipRouteInfoInterface=ipRouteInfoInterface, arpInfoEntry=arpInfoEntry, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgBootpState=ipNewCfgBootpState, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipRouteInfoTable=ipRouteInfoTable, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumRxPkts=ospfCumRxPkts, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfGeneralStats=ospfGeneralStats, ospfGeneral=ospfGeneral, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfRxHello=ospfIntfRxHello, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgGwTable=ipNewCfgGwTable, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfTotalAreas=ospfTotalAreas, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgBootpAddr=ipCurCfgBootpAddr, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, routerLSALinkData=routerLSALinkData)
