...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrp=vrrp, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgGwState=ipCurCfgGwState, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfNbrChange=ospfIntfNbrChange, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgGwInterval=ipNewCfgGwInterval, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumNbrhello=ospfCumNbrhello, ipRouteInfoInterface=ipRouteInfoInterface, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfArea=ospfArea, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgIfTable=vrrpCurCfgIfTable, arpStatMaxEntries=arpStatMaxEntries, arpInfoMacAddr=arpInfoMacAddr, ripStatOutPkts=ripStatOutPkts, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumNbrStart=ospfCumNbrStart, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfRxHello=ospfIntfRxHello, ospfIntfInfoTable=ospfIntfInfoTable, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfStartTime=ospfStartTime, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaNbrStart=ospfAreaNbrStart, vrrpStatInAdvers=vrrpStatInAdvers, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, arpInfoEntry=arpInfoEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIfInfoIndex=ospfIfInfoIndex, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpStats=vrrpStats, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfBackup=ospfIntfBackup, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipGatewayTableMax=ipGatewayTableMax, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, iprouting=iprouting, ospfStats=ospfStats, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfLoop=ospfIntfLoop, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaChangeStats=ospfAreaChangeStats, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfNbrInFullState=ospfNbrInFullState, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumIntfHello=ospfCumIntfHello, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaNbrhello=ospfAreaNbrhello, ip_info=ip_info, ospfIntfHello=ospfIntfHello, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipForward=ipForward, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, routeStats=routeStats, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipRouteInfoGateway=ipRouteInfoGateway, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ripCurCfgListen=ripCurCfgListen, ospfCumTxHello=ospfCumTxHello, ipCurCfgGwEntry=ipCurCfgGwEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumRxHello=ospfCumRxHello, arpInfoDestIp=arpInfoDestIp, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumNbrN1way=ospfCumNbrN1way, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipCurCfgGwRetry=ipCurCfgGwRetry, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdNewCfgState=ipFwdNewCfgState, ospfCfg=ospfCfg, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaNbrDown=ospfAreaNbrDown, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ripNewCfgSupply=ripNewCfgSupply, ospfGeneral=ospfGeneral, ospfGeneralStats=ospfGeneralStats, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfInterface=ospfInterface, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, routerLSALinkID=routerLSALinkID, ripNewCfgDefListen=ripNewCfgDefListen, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaRxlsAcks=ospfAreaRxlsAcks, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgIntfState=ipCurCfgIntfState, arpInfoRefPorts=arpInfoRefPorts, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfProcessUptime=ospfProcessUptime, ipNewCfgIntfMask=ipNewCfgIntfMask, ripStats=ripStats, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfDown=ospfIntfDown, ipRouteInfoDestIp=ipRouteInfoDestIp, arpInfoSrcPort=arpInfoSrcPort, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfNbrIndex=ospfIntfNbrIndex)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpGeneral=vrrpGeneral, routerLSAId=routerLSAId, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipNewCfgGwState=ipNewCfgGwState, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgBootpState=ipNewCfgBootpState, arpInfoFlag=arpInfoFlag, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfNbrInExchState=ospfNbrInExchState, arpStats=arpStats, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfLsTypesSupported=ospfLsTypesSupported, ospfNbrInInitState=ospfNbrInInitState, ospfCumNbrDown=ospfCumNbrDown, ospfAreaIntfIndex=ospfAreaIntfIndex, routerLSALinkIndex=routerLSALinkIndex, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipRouteInfoEntry=ipRouteInfoEntry, ripStatInPkts=ripStatInPkts, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, routeStatEntries=routeStatEntries, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumIntfDown=ospfCumIntfDown, ospfCumRxPkts=ospfCumRxPkts, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ripCurCfgState=ripCurCfgState, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipNewCfgGwTable=ipNewCfgGwTable, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfTotalNeighbours=ospfTotalNeighbours, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgIntfState=ipNewCfgIntfState, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, dnsStats=dnsStats, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCurCfgAreaTable=ospfCurCfgAreaTable, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaTxHello=ospfAreaTxHello, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ripNewCfgListen=ripNewCfgListen, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumTxDatabase=ospfCumTxDatabase, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaRxPkts=ospfAreaRxPkts, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumTxlsAcks=ospfCumTxlsAcks, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfTotalAreas=ospfTotalAreas, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpOper=vrrpOper, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrp_info=vrrp_info, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipRouteInfoType=ipRouteInfoType, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ripConfig=ripConfig, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, routeStatHighWater=routeStatHighWater, routerLSALinkData=routerLSALinkData, ospfIntfUnloop=ospfIntfUnloop, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCurCfgAreaId=ospfCurCfgAreaId, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaInfoId=ospfAreaInfoId, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaInfoTable=ospfAreaInfoTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, routeStatMaxEntries=routeStatMaxEntries, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumTxPkts=ospfCumTxPkts, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgIntfTable=ipNewCfgIntfTable, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaTxDatabase=ospfAreaTxDatabase, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, arpInfoVLAN=arpInfoVLAN, ospfinfo=ospfinfo, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfCumRxDatabase=ospfCumRxDatabase, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer)
