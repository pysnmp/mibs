...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfTxlsAcks=ospfIntfTxlsAcks, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfNbrhello=ospfIntfNbrhello, vrrpGeneral=vrrpGeneral, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumRxHello=ospfCumRxHello, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaNbrStart=ospfAreaNbrStart, routeStatHighWater=routeStatHighWater, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumIntfUnloop=ospfCumIntfUnloop, arpInfoTable=arpInfoTable, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, routeStatMaxEntries=routeStatMaxEntries, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ripStatInErrorPkts=ripStatInErrorPkts, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgGwState=ipCurCfgGwState, ipCurCfgGwMetric=ipCurCfgGwMetric, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumRxTxStats=ospfCumRxTxStats, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, routerLSALinkData=routerLSALinkData, ospfCumTxPkts=ospfCumTxPkts, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgIntfState=ipCurCfgIntfState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaRxHello=ospfAreaRxHello, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfBackup=ospfIntfBackup, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfUnloop=ospfIntfUnloop, arpStatHighWater=arpStatHighWater, ipRouteInfoTag=ipRouteInfoTag, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfNbrChange=ospfIntfNbrChange, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgGwMetric=ipNewCfgGwMetric, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaChangeStats=ospfAreaChangeStats, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfRxHello=ospfIntfRxHello, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfNbrDown=ospfIntfNbrDown, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumNbrDown=ospfCumNbrDown, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfLoop=ospfIntfLoop, arpInfoMacAddr=arpInfoMacAddr, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaTxHello=ospfAreaTxHello, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumNbrRstAd=ospfCumNbrRstAd, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfArea=ospfArea, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, arpInfoFlag=arpInfoFlag, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCfg=ospfCfg, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, arpInfoRefPorts=arpInfoRefPorts, ospfIntfRxPkts=ospfIntfRxPkts, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, arpInfoVLAN=arpInfoVLAN, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaInfoId=ospfAreaInfoId, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaNbrDown=ospfAreaNbrDown, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipForward=ipForward, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfNbrStart=ospfIntfNbrStart, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgGwTable=ipCurCfgGwTable, ipGatewayTableMax=ipGatewayTableMax, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumTxDatabase=ospfCumTxDatabase, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ripStatInPkts=ripStatInPkts, ripConfig=ripConfig, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgGwTable=ipNewCfgGwTable, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfNewCfgAreaId=ospfNewCfgAreaId, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, routerLSALinkID=routerLSALinkID, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, iprouting=iprouting)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfRxlsReqs=ospfIntfRxlsReqs, routeStatEntries=routeStatEntries, ospfinfo=ospfinfo, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ripStatOutPkts=ripStatOutPkts, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrp=vrrp, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, arpInfoDestIp=arpInfoDestIp, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgGwState=ipNewCfgGwState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipRouteInfoInterface=ipRouteInfoInterface, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfHello=ospfIntfHello, ospfGeneralStats=ospfGeneralStats, ospfNbrInExchState=ospfNbrInExchState, ip_info=ip_info, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgGwAddr=ipCurCfgGwAddr, arpStatMaxEntries=arpStatMaxEntries, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfChangeStats=ospfIntfChangeStats, ripCurCfgVip=ripCurCfgVip, ospfIntfTxHello=ospfIntfTxHello, ospfAreaRxPkts=ospfAreaRxPkts, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgGwIndex=ipCurCfgGwIndex, routeStats=routeStats, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCumNbrhello=ospfCumNbrhello, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpOper=vrrpOper, dnsStats=dnsStats, ipNewCfgBootpState=ipNewCfgBootpState, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfStats=ospfStats, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipRouteInfoType=ipRouteInfoType, ospfNbrInInitState=ospfNbrInInitState, ospfTotalAreas=ospfTotalAreas, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfProcessUptime=ospfProcessUptime, ipRouteInfoTable=ipRouteInfoTable, arpStats=arpStats, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgGwVlan=ipCurCfgGwVlan, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripStats=ripStats, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfStartTime=ospfStartTime, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaInfoEntry=ospfAreaInfoEntry, ipRouteInfoMask=ipRouteInfoMask, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIfInfoIndex=ospfIfInfoIndex, ospfInterface=ospfInterface, vrrpStats=vrrpStats, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumNbrStart=ospfCumNbrStart, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfNbrInFullState=ospfNbrInFullState, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ripNewCfgListen=ripNewCfgListen, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, arpStatEntries=arpStatEntries, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumRxPkts=ospfCumRxPkts, ospfIntfIndex=ospfIntfIndex, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ripCurCfgListen=ripCurCfgListen, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfGeneral=ospfGeneral, ospfIntfTxDatabase=ospfIntfTxDatabase, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, arpInfoEntry=arpInfoEntry, ipCurCfgGwArp=ipCurCfgGwArp, ospfIfWaitInterval=ospfIfWaitInterval)
