...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumRxHello=ospfCumRxHello, routerLSALinkIfIndex=routerLSALinkIfIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpStats=vrrpStats, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumIntfDown=ospfCumIntfDown, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfNbrN1way=ospfIntfNbrN1way, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfNbrInExchState=ospfNbrInExchState, routerLSAAreaIndex=routerLSAAreaIndex, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, routeStatEntries=routeStatEntries, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfLsTypesSupported=ospfLsTypesSupported, ripConfig=ripConfig, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfBackup=ospfIntfBackup, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfIndex=ospfIntfIndex, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumRxPkts=ospfCumRxPkts, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ripNewCfgDefListen=ripNewCfgDefListen, ipCurCfgIntfMask=ipCurCfgIntfMask, ipNewCfgBootpState=ipNewCfgBootpState, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumNbrDown=ospfCumNbrDown, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, routerLSALinkData=routerLSALinkData, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfInfoTable=ospfIntfInfoTable, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgIntfState=ipNewCfgIntfState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfArea=ospfArea, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgGwInterval=ipCurCfgGwInterval, arpInfoVLAN=arpInfoVLAN, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ripNewCfgState=ripNewCfgState, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCfg=ospfCfg, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipFwdCurCfgState=ipFwdCurCfgState, arpInfoDestIp=arpInfoDestIp, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfTotalAreas=ospfTotalAreas, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipCurCfgGwTable=ipCurCfgGwTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfHello=ospfIntfHello, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ripCurCfgListen=ripCurCfgListen, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, iprouting=iprouting, arpStats=arpStats, arpInfoTable=arpInfoTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaTxHello=ospfAreaTxHello, vrrp=vrrp, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipRouteInfoEntry=ipRouteInfoEntry, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripStatInPkts=ripStatInPkts, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIfTotalNeighbours=ospfIfTotalNeighbours, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaRxHello=ospfAreaRxHello, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCumTxHello=ospfCumTxHello, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ripNewCfgSupply=ripNewCfgSupply, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumIntfLoop=ospfCumIntfLoop, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgGwState=ipCurCfgGwState)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, arpInfoRefPorts=arpInfoRefPorts, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, arpStatEntries=arpStatEntries, ospfStats=ospfStats, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgGwState=ipNewCfgGwState, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipRouteInfoTable=ipRouteInfoTable, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaNbrN1way=ospfAreaNbrN1way, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfGeneral=ospfGeneral, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipCurCfgGwArp=ipCurCfgGwArp, vrrpOper=vrrpOper, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgGwIndex=ipNewCfgGwIndex, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, arpStatMaxEntries=arpStatMaxEntries, ospfIfWaitInterval=ospfIfWaitInterval, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfGeneralStats=ospfGeneralStats, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpGeneral=vrrpGeneral, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrp_info=vrrp_info, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, routerLSAId=routerLSAId, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfTxHello=ospfIntfTxHello, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, arpInfoFlag=arpInfoFlag, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, dnsStats=dnsStats, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, routeStats=routeStats, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfNbrhello=ospfIntfNbrhello, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ripStats=ripStats, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipRouteInfoType=ipRouteInfoType, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumTxlsAcks=ospfCumTxlsAcks, arpInfoEntry=arpInfoEntry, ospfCumIntfBackup=ospfCumIntfBackup, ripNewCfgListen=ripNewCfgListen, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumNbrRstAd=ospfCumNbrRstAd, ripNewCfgVip=ripNewCfgVip, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, arpStatHighWater=arpStatHighWater, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfinfo=ospfinfo, ripCurCfgSupply=ripCurCfgSupply, ospfCumNbrStart=ospfCumNbrStart, ospfInterface=ospfInterface, ipForward=ipForward, ipRouteInfoIndx=ipRouteInfoIndx, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfRxHello=ospfIntfRxHello, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumNbrhello=ospfCumNbrhello, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ip_info=ip_info, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaInfoTable=ospfAreaInfoTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaInfoEntry=ospfAreaInfoEntry)
