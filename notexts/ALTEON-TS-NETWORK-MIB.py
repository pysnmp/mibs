...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, arpInfoTable=arpInfoTable, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgGwMetric=ipCurCfgGwMetric, ripStatInPkts=ripStatInPkts, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfWaitTimer=ospfIntfWaitTimer, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfHello=ospfIntfHello, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpStats=vrrpStats, ospfAreaInfoId=ospfAreaInfoId, ipRouteInfoMask=ipRouteInfoMask, ospfAreaNbrhello=ospfAreaNbrhello, ipRouteInfoIndx=ipRouteInfoIndx, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumRxDatabase=ospfCumRxDatabase, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgIntfState=ipCurCfgIntfState, ospfNbrInFullState=ospfNbrInFullState, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaNbrN1way=ospfAreaNbrN1way, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgIfTable=vrrpCurCfgIfTable, routerLSALinkID=routerLSALinkID, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ripCurCfgDefListen=ripCurCfgDefListen, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ripCurCfgState=ripCurCfgState, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, arpStatEntries=arpStatEntries, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumRxPkts=ospfCumRxPkts, ipCurCfgGwState=ipCurCfgGwState, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfUnloop=ospfIntfUnloop, arpInfoSrcPort=arpInfoSrcPort, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgGwTable=ipNewCfgGwTable, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfStartTime=ospfStartTime, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfNbrN1way=ospfIntfNbrN1way, routeStats=routeStats, ospfCumRxlsUpdates=ospfCumRxlsUpdates, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumTxHello=ospfCumTxHello, ripCurCfgListen=ripCurCfgListen, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, arpStats=arpStats, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipForward=ipForward, ospfAreaNbrDown=ospfAreaNbrDown, arpInfoMacAddr=arpInfoMacAddr, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfinfo=ospfinfo, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaTxPkts=ospfAreaTxPkts, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaRxHello=ospfAreaRxHello, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, arpInfoVLAN=arpInfoVLAN, vrrpIfTableMaxSize=vrrpIfTableMaxSize, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfBackup=ospfIntfBackup, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ripNewCfgListen=ripNewCfgListen, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfTxPkts=ospfIntfTxPkts, ipGatewayTableMax=ipGatewayTableMax, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, dnsStats=dnsStats, ospfArea=ospfArea, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgGwEntry=ipCurCfgGwEntry, arpInfoRefPorts=arpInfoRefPorts, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpGeneral=vrrpGeneral, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaInfoEntry=ospfAreaInfoEntry, ripConfig=ripConfig, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrp=vrrp, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ripNewCfgSupply=ripNewCfgSupply, ipNewCfgGwIndex=ipNewCfgGwIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfGeneralInfo=ospfGeneralInfo, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfNbrInInitState=ospfNbrInInitState, ospfTotalTransitAreas=ospfTotalTransitAreas, routerLSALinkData=routerLSALinkData, ospfStats=ospfStats, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfNbrStart=ospfIntfNbrStart, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpOper=vrrpOper, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumNbrDown=ospfCumNbrDown, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgGenState=vrrpCurCfgGenState)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumRxTxStats=ospfCumRxTxStats, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfGeneralStats=ospfGeneralStats, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumIntfBackup=ospfCumIntfBackup, arpStatHighWater=arpStatHighWater, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumNbrhello=ospfCumNbrhello, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaInfoTable=ospfAreaInfoTable, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgGwRetry=ipNewCfgGwRetry, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, arpInfoFlag=arpInfoFlag, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgGwMetric=ipNewCfgGwMetric, iprouting=iprouting, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ripStats=ripStats, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCfg=ospfCfg, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ripNewCfgVip=ripNewCfgVip, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumIntfHello=ospfCumIntfHello, ospfIntfInfoTable=ospfIntfInfoTable, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumTxlsReqs=ospfCumTxlsReqs, routeStatMaxEntries=routeStatMaxEntries, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumRxHello=ospfCumRxHello, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripNewCfgState=ripNewCfgState, vrrpNewCfgGenState=vrrpNewCfgGenState, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumNbrN1way=ospfCumNbrN1way, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ip_info=ip_info, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ripCurCfgVip=ripCurCfgVip, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, routeStatEntries=routeStatEntries, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfLoop=ospfIntfLoop, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, routerLSAId=routerLSAId, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfDown=ospfIntfDown, ospfIntfRxHello=ospfIntfRxHello, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaRxPkts=ospfAreaRxPkts, ripStatOutPkts=ripStatOutPkts, ospfProcessUptime=ospfProcessUptime, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaChangeStats=ospfAreaChangeStats, ipNewCfgIntfMask=ipNewCfgIntfMask, routeStatHighWater=routeStatHighWater, ospfInterface=ospfInterface, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfRangeTableMaxSize=ospfRangeTableMaxSize)
