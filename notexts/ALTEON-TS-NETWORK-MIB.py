...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfStats=ospfStats, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, arpInfoMacAddr=arpInfoMacAddr, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipRouteInfoEntry=ipRouteInfoEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumRxHello=ospfCumRxHello, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfNbrInExchState=ospfNbrInExchState, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, arpInfoSrcPort=arpInfoSrcPort, vrrp_info=vrrp_info, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfLoop=ospfIntfLoop, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ripStats=ripStats, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumRxPkts=ospfCumRxPkts, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, routerLSALinkID=routerLSALinkID, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaNbrStart=ospfAreaNbrStart, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfDown=ospfIntfDown, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumIntfDown=ospfCumIntfDown, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfTxPkts=ospfIntfTxPkts, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumTxPkts=ospfCumTxPkts, ospfNbrInInitState=ospfNbrInInitState, ospfCumNbrStart=ospfCumNbrStart, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, arpStatHighWater=arpStatHighWater, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ripNewCfgSupply=ripNewCfgSupply, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrp=vrrp, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipRouteInfoDestIp=ipRouteInfoDestIp, ipGatewayTableMax=ipGatewayTableMax, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, routeStatMaxEntries=routeStatMaxEntries, ospfAreaRxHello=ospfAreaRxHello, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfHello=ospfIntfHello, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgGwState=ipCurCfgGwState, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpGeneral=vrrpGeneral, ipRouteInfoIndx=ipRouteInfoIndx, ospfGeneral=ospfGeneral, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, routeStats=routeStats, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfRxHello=ospfIntfRxHello, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, routerLSAId=routerLSAId, arpStats=arpStats, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaNbrDown=ospfAreaNbrDown, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgGenState=vrrpNewCfgGenState, arpInfoFlag=arpInfoFlag, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, iprouting=iprouting, ripNewCfgListen=ripNewCfgListen, ospfCumRxTxStats=ospfCumRxTxStats, ripStatInPkts=ripStatInPkts, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfGeneralInfo=ospfGeneralInfo, ospfIntfNbrhello=ospfIntfNbrhello, vrrpStats=vrrpStats, ipCurCfgGwEntry=ipCurCfgGwEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipRouteInfoMask=ipRouteInfoMask, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, routeStatEntries=routeStatEntries, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripCurCfgListen=ripCurCfgListen, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCfg=ospfCfg, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumRxDatabase=ospfCumRxDatabase, arpInfoDestIp=arpInfoDestIp, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumIntfLoop=ospfCumIntfLoop, ipForward=ipForward, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaInfoId=ospfAreaInfoId, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgIntfState=ipNewCfgIntfState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfRxPkts=ospfIntfRxPkts, ospfIfInfoIndex=ospfIfInfoIndex, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfUnloop=ospfIntfUnloop, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumIntfBackup=ospfCumIntfBackup, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, dnsStats=dnsStats, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfStartTime=ospfStartTime, ipCurCfgGwMetric=ipCurCfgGwMetric, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgIntfMask=ipNewCfgIntfMask, arpInfoRefPorts=arpInfoRefPorts, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdNewCfgState=ipFwdNewCfgState, ipRouteInfoTable=ipRouteInfoTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfTxHello=ospfIntfTxHello, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumTxDatabase=ospfCumTxDatabase, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpOper=vrrpOper, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipNewCfgIntfEntry=ipNewCfgIntfEntry, arpInfoTable=arpInfoTable, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgGwArp=ipCurCfgGwArp, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ripCurCfgSupply=ripCurCfgSupply, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfTxDatabase=ospfIntfTxDatabase, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfProcessUptime=ospfProcessUptime, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfArea=ospfArea, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfIndex=ospfIntfIndex, arpInfoVLAN=arpInfoVLAN, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipFwdCurCfgPortState=ipFwdCurCfgPortState, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumTxHello=ospfCumTxHello, arpInfoEntry=arpInfoEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ripNewCfgVip=ripNewCfgVip, ospfinfo=ospfinfo, ripCurCfgVip=ripCurCfgVip, ipRouteInfoTag=ipRouteInfoTag, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ip_info=ip_info, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfTotalAreas=ospfTotalAreas, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCumNbrhello=ospfCumNbrhello, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ripCurCfgState=ripCurCfgState, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaIntfHello=ospfAreaIntfHello, ospfTotalNssaAreas=ospfTotalNssaAreas, ripConfig=ripConfig, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipRouteInfoGateway=ipRouteInfoGateway, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipCurCfgIntfMask=ipCurCfgIntfMask, ipNewCfgIntfTable=ipNewCfgIntfTable)
