...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpGeneral=vrrpGeneral, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgIntfState=ipNewCfgIntfState, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfTxDatabase=ospfIntfTxDatabase, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfGeneral=ospfGeneral, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfNewCfgAreaTable=ospfNewCfgAreaTable, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipRouteInfoMask=ipRouteInfoMask, routerLSALinkIndex=routerLSALinkIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, arpInfoEntry=arpInfoEntry, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgGwState=ipNewCfgGwState, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgIntfState=ipCurCfgIntfState, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfIndex=ospfIntfIndex, ospfCumNbrDown=ospfCumNbrDown, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaIntfHello=ospfAreaIntfHello, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, routerLSAId=routerLSAId, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, routeStatHighWater=routeStatHighWater, ripCurCfgState=ripCurCfgState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrp_info=vrrp_info, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaChangeStats=ospfAreaChangeStats, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdCurCfgState=ipFwdCurCfgState, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumRxDatabase=ospfCumRxDatabase, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCurCfgAreaTable=ospfCurCfgAreaTable, routerLSALinkData=routerLSALinkData, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, arpStatMaxEntries=arpStatMaxEntries, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCfg=ospfCfg, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaIntfIndex=ospfAreaIntfIndex, ip_info=ip_info, ipCurCfgGwState=ipCurCfgGwState, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfUnloop=ospfIntfUnloop, ospfIntfTxPkts=ospfIntfTxPkts, arpInfoFlag=arpInfoFlag, ospfCumTxPkts=ospfCumTxPkts, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, arpStatEntries=arpStatEntries, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumIntfHello=ospfCumIntfHello, arpInfoTable=arpInfoTable, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgBootpState=ipNewCfgBootpState, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipInterfaceTableMax=ipInterfaceTableMax, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfStartTime=ospfStartTime, ipCurCfgGwEntry=ipCurCfgGwEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaNbrhello=ospfAreaNbrhello, ipForward=ipForward, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIfInfoIndex=ospfIfInfoIndex, ospfArea=ospfArea, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgGwRetry=ipCurCfgGwRetry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ripCurCfgListen=ripCurCfgListen, arpInfoMacAddr=arpInfoMacAddr, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfNbrInFullState=ospfNbrInFullState, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ripNewCfgListen=ripNewCfgListen, arpStatHighWater=arpStatHighWater, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipFwdNewCfgState=ipFwdNewCfgState, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ripCurCfgSupply=ripCurCfgSupply, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfHello=ospfIntfHello, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfWaitTimer=ospfIntfWaitTimer, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ripNewCfgDefListen=ripNewCfgDefListen, ospfGeneralStats=ospfGeneralStats, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ripStats=ripStats)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipRouteInfoTag=ipRouteInfoTag, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfRxPkts=ospfIntfRxPkts, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfLoop=ospfIntfLoop, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ripNewCfgState=ripNewCfgState, ipRouteInfoType=ipRouteInfoType, dnsStats=dnsStats, vrrpStats=vrrpStats, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfNbrStart=ospfIntfNbrStart, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaInfoId=ospfAreaInfoId, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaRxDatabase=ospfAreaRxDatabase, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumRxPkts=ospfCumRxPkts, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, iprouting=iprouting, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfTotalAreas=ospfTotalAreas, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaTxDatabase=ospfAreaTxDatabase, routeStats=routeStats, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaNbrIndex=ospfAreaNbrIndex, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgGwRetry=ipNewCfgGwRetry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgGwArp=ipNewCfgGwArp, ripStatInPkts=ripStatInPkts, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfGeneralInfo=ospfGeneralInfo, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ripStatInErrorPkts=ripStatInErrorPkts, ospfStats=ospfStats, ospfIntfRxTxStats=ospfIntfRxTxStats, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumNbrhello=ospfCumNbrhello, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaInfoEntry=ospfAreaInfoEntry, routerLSALinkID=routerLSALinkID, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCumRxlsAcks=ospfCumRxlsAcks, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpOper=vrrpOper, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumIntfUnloop=ospfCumIntfUnloop, ipGatewayTableMax=ipGatewayTableMax, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfDown=ospfIntfDown, vrrp=vrrp, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgGwVlan=ipCurCfgGwVlan, ripStatOutPkts=ripStatOutPkts, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfRxHello=ospfIntfRxHello, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipRouteInfoTable=ipRouteInfoTable, routeStatEntries=routeStatEntries, ospfIntfNbrChange=ospfIntfNbrChange, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfinfo=ospfinfo, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, arpStats=arpStats, ripConfig=ripConfig, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaRxTxStats=ospfAreaRxTxStats)
