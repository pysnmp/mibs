...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfWaitTimer=ospfIntfWaitTimer, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfStats=ospfStats, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpStats=vrrpStats, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumIntfBackup=ospfCumIntfBackup, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ripNewCfgSupply=ripNewCfgSupply, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfTxHello=ospfIntfTxHello, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfGeneral=ospfGeneral, ospfArea=ospfArea, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripStatInErrorPkts=ripStatInErrorPkts, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ripStats=ripStats, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, arpInfoMacAddr=arpInfoMacAddr, ospfCumRxPkts=ospfCumRxPkts, ospfAreaRxHello=ospfAreaRxHello, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfCountForRouter=ospfIntfCountForRouter, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrp_info=vrrp_info, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipRouteInfoTag=ipRouteInfoTag, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, arpStatMaxEntries=arpStatMaxEntries, ospfIntfUnloop=ospfIntfUnloop, vrrp=vrrp, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfLsTypesSupported=ospfLsTypesSupported, ospfNbrInFullState=ospfNbrInFullState, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaIntfHello=ospfAreaIntfHello, ripCurCfgVip=ripCurCfgVip, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaRxlsAcks=ospfAreaRxlsAcks, arpInfoFlag=arpInfoFlag, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfTxPkts=ospfIntfTxPkts, routerLSAId=routerLSAId, ospfIntfDown=ospfIntfDown, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgGwState=ipNewCfgGwState, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipForward=ipForward, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfLoop=ospfIntfLoop, ipRouteInfoDestIp=ipRouteInfoDestIp, ripCurCfgDefListen=ripCurCfgDefListen, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgGwState=ipCurCfgGwState, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgGwArp=ipNewCfgGwArp, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, ipGatewayTableMax=ipGatewayTableMax, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ripCurCfgState=ripCurCfgState, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ripNewCfgState=ripNewCfgState, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCumTxPkts=ospfCumTxPkts, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfNewCfgAreaId=ospfNewCfgAreaId, ripConfig=ripConfig, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumTxHello=ospfCumTxHello, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumIntfNbrChange=ospfCumIntfNbrChange, arpStats=arpStats, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripCurCfgListen=ripCurCfgListen, routeStatMaxEntries=routeStatMaxEntries, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgIntfMask=ipNewCfgIntfMask, ipNewCfgGwInterval=ipNewCfgGwInterval, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfHello=ospfIntfHello, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdNewCfgState=ipFwdNewCfgState, ipInterfaceTableMax=ipInterfaceTableMax, routeStatHighWater=routeStatHighWater, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaIntfLoop=ospfAreaIntfLoop, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipRouteInfoGateway=ipRouteInfoGateway, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgGwArp=ipCurCfgGwArp)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripStatInPkts=ripStatInPkts, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfNbrRstAd=ospfIntfNbrRstAd, routerLSALinkID=routerLSALinkID, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgBootpState=ipNewCfgBootpState, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfNbrChange=ospfIntfNbrChange, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumNbrDown=ospfCumNbrDown, ospfGeneralInfo=ospfGeneralInfo, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfRxHello=ospfIntfRxHello, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ip_info=ip_info, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfNbrInExchState=ospfNbrInExchState, routerLSAAreaIndex=routerLSAAreaIndex, routeStats=routeStats, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfBackup=ospfIntfBackup, vrrpOper=vrrpOper, vrrpCurCfgGenState=vrrpCurCfgGenState, arpInfoRefPorts=arpInfoRefPorts, ospfCumNbrStart=ospfCumNbrStart, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaIntfDown=ospfAreaIntfDown, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, iprouting=iprouting, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfRxPkts=ospfIntfRxPkts, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgGwAddr=ipNewCfgGwAddr, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, arpInfoTable=arpInfoTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaTxHello=ospfAreaTxHello, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfTotalAreas=ospfTotalAreas, ospfInterface=ospfInterface, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumNbrhello=ospfCumNbrhello, routerLSALinkData=routerLSALinkData, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, arpInfoVLAN=arpInfoVLAN, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipNewCfgGwEntry=ipNewCfgGwEntry, dnsStats=dnsStats, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ripStatOutPkts=ripStatOutPkts, ospfCfg=ospfCfg, arpStatHighWater=arpStatHighWater, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfTxDatabase=ospfIntfTxDatabase, ipRouteInfoInterface=ipRouteInfoInterface, ospfinfo=ospfinfo, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfNbrDown=ospfIntfNbrDown, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpGeneral=vrrpGeneral, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaRxTxStats=ospfAreaRxTxStats, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumRxHello=ospfCumRxHello, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ripNewCfgListen=ripNewCfgListen, routeStatEntries=routeStatEntries, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfProcessUptime=ospfProcessUptime, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ripNewCfgVip=ripNewCfgVip, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, arpStatEntries=arpStatEntries, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex)
