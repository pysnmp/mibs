...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgGwIndex=ipNewCfgGwIndex, ipRouteInfoTable=ipRouteInfoTable, arpInfoTable=arpInfoTable, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgIntfMask=ipNewCfgIntfMask, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgIntfVlan=ipNewCfgIntfVlan, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumTxlsReqs=ospfCumTxlsReqs, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripCurCfgState=ripCurCfgState, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipRouteInfoMask=ipRouteInfoMask, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, routeStatMaxEntries=routeStatMaxEntries, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfDown=ospfIntfDown, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCfg=ospfCfg, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumIntfDown=ospfCumIntfDown, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, arpInfoVLAN=arpInfoVLAN, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaInfoId=ospfAreaInfoId, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgGwVlan=ipCurCfgGwVlan, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ripCurCfgSupply=ripCurCfgSupply, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ripNewCfgSupply=ripNewCfgSupply, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, arpStatEntries=arpStatEntries, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIfWaitInterval=ospfIfWaitInterval, vrrpOper=vrrpOper, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfStats=ospfStats, ospfCumNbrStart=ospfCumNbrStart, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaRxTxStats=ospfAreaRxTxStats, ipRouteInfoType=ipRouteInfoType, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ripNewCfgDefListen=ripNewCfgDefListen, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfNbrhello=ospfIntfNbrhello, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfUnloop=ospfIntfUnloop, ospfCumTxHello=ospfCumTxHello, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgGwDelete=ipNewCfgGwDelete, routeStatHighWater=routeStatHighWater, ospfNbrInExchState=ospfNbrInExchState, ospfIntfLoop=ospfIntfLoop, arpInfoFlag=arpInfoFlag, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfBackup=ospfIntfBackup, ospfGeneralInfo=ospfGeneralInfo, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgIntfState=ipCurCfgIntfState, routerLSALinkData=routerLSALinkData, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpStats=vrrpStats, ospfNewCfgAreaId=ospfNewCfgAreaId, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfIndex=ospfIntfIndex, ripCurCfgListen=ripCurCfgListen, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripNewCfgVip=ripNewCfgVip, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrp_info=vrrp_info, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripStats=ripStats, ospfIntfChangeStats=ospfIntfChangeStats, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfProcessUptime=ospfProcessUptime, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaChangeStats=ospfAreaChangeStats, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfNbrInFullState=ospfNbrInFullState, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgGwArp=ipCurCfgGwArp, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfGeneral=ospfGeneral, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumIntfBackup=ospfCumIntfBackup, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumNbrhello=ospfCumNbrhello, ospfAreaIntfBackup=ospfAreaIntfBackup, ip_info=ip_info, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaTableMaxSize=ospfAreaTableMaxSize, routerLSAId=routerLSAId, ospfArea=ospfArea, ripNewCfgState=ripNewCfgState, arpInfoDestIp=arpInfoDestIp, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumRxTxStats=ospfCumRxTxStats, ipNewCfgGwMetric=ipNewCfgGwMetric, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumNbrRstAd=ospfCumNbrRstAd, arpStatHighWater=arpStatHighWater, ospfCumNbrDown=ospfCumNbrDown, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, routeStatEntries=routeStatEntries, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgGwEntry=ipNewCfgGwEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfRxPkts=ospfIntfRxPkts)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrp=vrrp, ipRouteInfoGateway=ipRouteInfoGateway, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, arpInfoEntry=arpInfoEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumRxHello=ospfCumRxHello, dnsStats=dnsStats, ospfIntfCountForRouter=ospfIntfCountForRouter, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfRxHello=ospfIntfRxHello, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripStatOutPkts=ripStatOutPkts, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, iprouting=iprouting, ripCurCfgVip=ripCurCfgVip, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfGeneralStats=ospfGeneralStats, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfTotalNssaAreas=ospfTotalNssaAreas, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, routerLSALinkIndex=routerLSALinkIndex, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfTotalAreas=ospfTotalAreas, ipForward=ipForward, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgGwState=ipCurCfgGwState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, routerLSALinkID=routerLSALinkID, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, routeStats=routeStats, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumTxPkts=ospfCumTxPkts, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfinfo=ospfinfo, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumTxDatabase=ospfCumTxDatabase, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, arpInfoMacAddr=arpInfoMacAddr, arpStats=arpStats, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIfInfoIndex=ospfIfInfoIndex, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfStartTime=ospfStartTime, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ripStatInPkts=ripStatInPkts, ipRouteInfoEntry=ipRouteInfoEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgGwTable=ipNewCfgGwTable, ripNewCfgListen=ripNewCfgListen, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfInfoEntry=ospfIntfInfoEntry, ripConfig=ripConfig, ospfAreaInfoEntry=ospfAreaInfoEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc)
