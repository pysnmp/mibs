...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", routerLSALinkData=routerLSALinkData, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ripNewCfgListen=ripNewCfgListen, ospfTotalTransitAreas=ospfTotalTransitAreas, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumTxPkts=ospfCumTxPkts, ospfIntfCountForRouter=ospfIntfCountForRouter, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ripCurCfgState=ripCurCfgState, ospfStats=ospfStats, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, arpInfoMacAddr=arpInfoMacAddr, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumTxHello=ospfCumTxHello, ospfCumNbrStart=ospfCumNbrStart, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, arpInfoEntry=arpInfoEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, routeStatEntries=routeStatEntries, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumIntfHello=ospfCumIntfHello, routerLSAId=routerLSAId, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, routeStats=routeStats, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripCurCfgStaticSupply=ripCurCfgStaticSupply, dnsStats=dnsStats, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ripNewCfgState=ripNewCfgState, ospfStartTime=ospfStartTime, ospfIntfBackup=ospfIntfBackup, ip_info=ip_info, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ripStats=ripStats, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, routeStatHighWater=routeStatHighWater, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfIndex=ospfIntfIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipRouteInfoGateway=ipRouteInfoGateway, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ripCurCfgVip=ripCurCfgVip, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumRxPkts=ospfCumRxPkts, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaNbrRstAd=ospfAreaNbrRstAd, arpInfoVLAN=arpInfoVLAN, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfGeneral=ospfGeneral, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ripStatInPkts=ripStatInPkts, arpInfoRefPorts=arpInfoRefPorts, arpStats=arpStats, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, arpStatEntries=arpStatEntries, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfInfoTable=ospfIntfInfoTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipRouteInfoInterface=ipRouteInfoInterface, vrrpOper=vrrpOper, iprouting=iprouting, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgGwState=ipCurCfgGwState, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrp=vrrp, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumIntfBackup=ospfCumIntfBackup, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfDown=ospfIntfDown, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfProcessUptime=ospfProcessUptime, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaIntfDown=ospfAreaIntfDown, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, routerLSALinkID=routerLSALinkID, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgGwArp=ipCurCfgGwArp, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgGwVlan=ipCurCfgGwVlan, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfArea=ospfArea, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfGeneralStats=ospfGeneralStats, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, arpInfoSrcPort=arpInfoSrcPort, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipRouteInfoMask=ipRouteInfoMask, ospfAreaInfoId=ospfAreaInfoId, ospfCumIntfLoop=ospfCumIntfLoop)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfNbrInExchState=ospfNbrInExchState, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpStats=vrrpStats, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, arpInfoFlag=arpInfoFlag, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, routerLSALinkIndex=routerLSALinkIndex, vrrpStatInAdvers=vrrpStatInAdvers, arpInfoTable=arpInfoTable, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfinfo=ospfinfo, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgGwState=ipNewCfgGwState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumNbrBadSequence=ospfCumNbrBadSequence, arpStatHighWater=arpStatHighWater, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgGwAddr=ipCurCfgGwAddr, ipRouteInfoType=ipRouteInfoType, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfNbrChange=ospfIntfNbrChange, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrp_info=vrrp_info, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumTxDatabase=ospfCumTxDatabase, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaNbrhello=ospfAreaNbrhello, routerLSAAreaIndex=routerLSAAreaIndex, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCfg=ospfCfg, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfNbrStart=ospfIntfNbrStart, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfGeneralInfo=ospfGeneralInfo, ospfIntfHello=ospfIntfHello, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumIntfDown=ospfCumIntfDown, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipForward=ipForward, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpGeneral=vrrpGeneral, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripNewCfgDefListen=ripNewCfgDefListen, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaTxPkts=ospfAreaTxPkts, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumNbrDown=ospfCumNbrDown, ripConfig=ripConfig, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipRouteInfoIndx=ipRouteInfoIndx, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfUnloop=ospfIntfUnloop, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ripStatOutPkts=ripStatOutPkts, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCurCfgAreaId=ospfCurCfgAreaId)
