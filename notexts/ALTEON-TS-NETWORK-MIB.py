...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCfg=ospfCfg, ripCurCfgListen=ripCurCfgListen, vrrpStats=vrrpStats, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaTxHello=ospfAreaTxHello, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfRxPkts=ospfIntfRxPkts, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripCurCfgState=ripCurCfgState, ospfAreaRxPkts=ospfAreaRxPkts, arpStatMaxEntries=arpStatMaxEntries, iprouting=iprouting, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumRxHello=ospfCumRxHello, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, routerLSALinkIndex=routerLSALinkIndex, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipFwdCurCfgState=ipFwdCurCfgState, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgGwState=ipNewCfgGwState, vrrpOper=vrrpOper, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgGwArp=ipNewCfgGwArp, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ripNewCfgListen=ripNewCfgListen, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaNbrStart=ospfAreaNbrStart, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfArea=ospfArea, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfNbrChange=ospfIntfNbrChange, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfUnloop=ospfIntfUnloop, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaRxHello=ospfAreaRxHello, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfDown=ospfIntfDown, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgIfTable=vrrpNewCfgIfTable, routeStatHighWater=routeStatHighWater, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfinfo=ospfinfo, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumNbrDown=ospfCumNbrDown, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaChangeStats=ospfAreaChangeStats, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, routerLSAId=routerLSAId, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ripConfig=ripConfig, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ripCurCfgVip=ripCurCfgVip, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfStats=ospfStats, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfBackup=ospfIntfBackup, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumNbrStart=ospfCumNbrStart, ospfIfInfoIndex=ospfIfInfoIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumTxlsUpdates=ospfCumTxlsUpdates, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfNewCfgAreaId=ospfNewCfgAreaId, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfInfoTable=ospfIntfInfoTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipRouteInfoDestIp=ipRouteInfoDestIp, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfNbrInInitState=ospfNbrInInitState, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ripNewCfgSupply=ripNewCfgSupply, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfInterface=ospfInterface, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, arpInfoFlag=arpInfoFlag, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgGwRetry=ipNewCfgGwRetry, dnsStats=dnsStats, ospfAreaIntfDown=ospfAreaIntfDown, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, routerLSALinkData=routerLSALinkData, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, arpInfoDestIp=arpInfoDestIp, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgGwMetric=ipNewCfgGwMetric, routeStats=routeStats, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ripNewCfgVip=ripNewCfgVip, ripCurCfgDefListen=ripCurCfgDefListen, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ripStatOutPkts=ripStatOutPkts, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ripStats=ripStats, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfTxHello=ospfIntfTxHello, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripStatInPkts=ripStatInPkts, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, routerLSALinkID=routerLSALinkID, ospfIntfLoop=ospfIntfLoop, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipNewCfgIntfDelete=ipNewCfgIntfDelete)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumIntfHello=ospfCumIntfHello, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgGwEntry=ipNewCfgGwEntry, arpInfoEntry=arpInfoEntry, ospfCumTxHello=ospfCumTxHello, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipForward=ipForward, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfNbrInExchState=ospfNbrInExchState, ospfIntfHello=ospfIntfHello, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrp=vrrp, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, routeStatMaxEntries=routeStatMaxEntries, ripNewCfgState=ripNewCfgState, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipRouteInfoType=ipRouteInfoType, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaIntfHello=ospfAreaIntfHello, vrrpGeneral=vrrpGeneral, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumRxDatabase=ospfCumRxDatabase, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, arpInfoSrcPort=arpInfoSrcPort, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaInfoId=ospfAreaInfoId, ospfGeneralStats=ospfGeneralStats, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgBootpState=ipCurCfgBootpState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, arpInfoRefPorts=arpInfoRefPorts, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfNbrDown=ospfIntfNbrDown, ipGatewayTableMax=ipGatewayTableMax, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgIntfState=ipNewCfgIntfState, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaInfoTable=ospfAreaInfoTable, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipRouteInfoEntry=ipRouteInfoEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumRxPkts=ospfCumRxPkts, ospfAreaNbrDown=ospfAreaNbrDown, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgIntfTable=ipCurCfgIntfTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCumTxPkts=ospfCumTxPkts, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrp_info=vrrp_info, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ip_info=ip_info, ospfGeneral=ospfGeneral, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumNbrN1way=ospfCumNbrN1way, arpStats=arpStats, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, arpInfoMacAddr=arpInfoMacAddr, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, arpStatEntries=arpStatEntries, ospfCumTxlsAcks=ospfCumTxlsAcks, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumTxDatabase=ospfCumTxDatabase, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfGeneralInfo=ospfGeneralInfo, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgGwTable=ipCurCfgGwTable, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgGwAddr=ipNewCfgGwAddr, arpStatHighWater=arpStatHighWater, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfStartTime=ospfStartTime, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgIntfState=ipCurCfgIntfState, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgGwVlan=ipNewCfgGwVlan, ipRouteInfoGateway=ipRouteInfoGateway, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipRouteInfoTable=ipRouteInfoTable, ripNewCfgDefListen=ripNewCfgDefListen, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfIndex=ospfIntfIndex, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse)
