...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaRxPkts=ospfAreaRxPkts, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfTotalNeighbours=ospfTotalNeighbours, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaRxTxIndex=ospfAreaRxTxIndex, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumNbrStart=ospfCumNbrStart, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfInterface=ospfInterface, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, arpStatEntries=arpStatEntries, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumIntfHello=ospfCumIntfHello, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfTotalAreas=ospfTotalAreas, ripNewCfgState=ripNewCfgState, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfChangeStats=ospfIntfChangeStats, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumNbrRstAd=ospfCumNbrRstAd, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, arpInfoDestIp=arpInfoDestIp, ospfCumNbrhello=ospfCumNbrhello, routeStatMaxEntries=routeStatMaxEntries, ipForward=ipForward, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfUnloop=ospfIntfUnloop, ripCurCfgState=ripCurCfgState, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpStats=vrrpStats, ipGatewayTableMax=ipGatewayTableMax, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumTxPkts=ospfCumTxPkts, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgGwState=ipCurCfgGwState, ospfCumRxlsUpdates=ospfCumRxlsUpdates, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfProcessUptime=ospfProcessUptime, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ripCurCfgListen=ripCurCfgListen, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpOper=vrrpOper, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfHello=ospfIntfHello, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIfInfoIndex=ospfIfInfoIndex, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgIntfTable=ipNewCfgIntfTable, arpStatHighWater=arpStatHighWater, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfBackup=ospfIntfBackup, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipCurCfgIntfIndex=ipCurCfgIntfIndex, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfArea=ospfArea, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfStartTime=ospfStartTime, ipNewCfgGwState=ipNewCfgGwState, ospfAreaInfoId=ospfAreaInfoId, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfTotalNssaAreas=ospfTotalNssaAreas, ipRouteInfoEntry=ipRouteInfoEntry, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumTxlsReqs=ospfCumTxlsReqs, arpStats=arpStats, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaInfoTable=ospfAreaInfoTable, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaIntfIndex=ospfAreaIntfIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, arpStatMaxEntries=arpStatMaxEntries, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, routeStats=routeStats, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrp=vrrp, ospfCumNbrDown=ospfCumNbrDown, ospfAreaNbrhello=ospfAreaNbrhello, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripConfig=ripConfig, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipRouteInfoMask=ipRouteInfoMask, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaNbrStart=ospfAreaNbrStart, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumTxHello=ospfCumTxHello, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCumRxTxStats=ospfCumRxTxStats, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCurCfgAreaTable=ospfCurCfgAreaTable, arpInfoFlag=arpInfoFlag, routerLSAId=routerLSAId, ripCurCfgDefListen=ripCurCfgDefListen, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgIntfState=ipNewCfgIntfState)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfDown=ospfIntfDown, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipInterfaceTableMax=ipInterfaceTableMax, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfGeneral=ospfGeneral, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, iprouting=iprouting, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfNbrInInitState=ospfNbrInInitState, arpInfoEntry=arpInfoEntry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, routerLSALinkData=routerLSALinkData, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfInfoTable=ospfIntfInfoTable, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumTxDatabase=ospfCumTxDatabase, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaTxlsReqs=ospfAreaTxlsReqs, arpInfoRefPorts=arpInfoRefPorts, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfNbrChange=ospfIntfNbrChange, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpGeneral=vrrpGeneral, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ip_info=ip_info, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaRxHello=ospfAreaRxHello, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfTxHello=ospfIntfTxHello, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfNbrInFullState=ospfNbrInFullState, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumTxlsAcks=ospfCumTxlsAcks, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfGeneralInfo=ospfGeneralInfo, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripStatInErrorPkts=ripStatInErrorPkts, ripStats=ripStats, ipNewCfgGwEntry=ipNewCfgGwEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripNewCfgListen=ripNewCfgListen, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaNbrDown=ospfAreaNbrDown, ospfCfg=ospfCfg, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, arpInfoVLAN=arpInfoVLAN, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumNbrN1way=ospfCumNbrN1way, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgGwTable=ipCurCfgGwTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipNewCfgGwDelete=ipNewCfgGwDelete, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfIndex=ospfIntfIndex, ipNewCfgGwArp=ipNewCfgGwArp, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfNbrInExchState=ospfNbrInExchState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgIntfMask=ipNewCfgIntfMask, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfStats=ospfStats, ospfIntfRxHello=ospfIntfRxHello, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ripStatInPkts=ripStatInPkts, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripNewCfgVip=ripNewCfgVip, ipCurCfgBootpAddr=ipCurCfgBootpAddr, dnsStats=dnsStats, ipCurCfgIntfState=ipCurCfgIntfState, routeStatHighWater=routeStatHighWater, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrp_info=vrrp_info, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumIntfDown=ospfCumIntfDown, ipRouteInfoType=ipRouteInfoType, ripCurCfgSupply=ripCurCfgSupply, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone)
