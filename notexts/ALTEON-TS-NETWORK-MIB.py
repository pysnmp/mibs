...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpGeneral=vrrpGeneral, ipCurCfgIntfTable=ipCurCfgIntfTable, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ripNewCfgState=ripNewCfgState, ipForward=ipForward, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumIntfHello=ospfCumIntfHello, ospfStats=ospfStats, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfGeneral=ospfGeneral, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgBootpState=ipCurCfgBootpState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, arpInfoEntry=arpInfoEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ip_info=ip_info, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumRxDatabase=ospfCumRxDatabase, arpInfoDestIp=arpInfoDestIp, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgGwState=ipCurCfgGwState, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, routerLSAId=routerLSAId, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, routeStatHighWater=routeStatHighWater, ospfAreaInfoTable=ospfAreaInfoTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfStartTime=ospfStartTime, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCurCfgAreaTable=ospfCurCfgAreaTable, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfTimersKickOffStats=ospfTimersKickOffStats, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfBackup=ospfIntfBackup, ripStatInErrorPkts=ripStatInErrorPkts, routerLSALinkIndex=routerLSALinkIndex, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfTotalTransitAreas=ospfTotalTransitAreas, ipRouteInfoType=ipRouteInfoType, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumNbrhello=ospfCumNbrhello, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIfInfoIndex=ospfIfInfoIndex, ripCurCfgListen=ripCurCfgListen, ripNewCfgListen=ripNewCfgListen, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgGwInterval=ipCurCfgGwInterval, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgGwArp=ipCurCfgGwArp, ripConfig=ripConfig, vrrpStats=vrrpStats, ipRouteInfoTag=ipRouteInfoTag, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfUnloop=ospfIntfUnloop, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripStatInPkts=ripStatInPkts, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaNbrStart=ospfAreaNbrStart, ripCurCfgState=ripCurCfgState, ospfAreaRxPkts=ospfAreaRxPkts, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgIntfState=ipCurCfgIntfState, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipRouteInfoIndx=ipRouteInfoIndx, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgGwEntry=ipCurCfgGwEntry, ripCurCfgSupply=ripCurCfgSupply, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfIndex=ospfIntfIndex, ospfGeneralInfo=ospfGeneralInfo, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipRouteInfoEntry=ipRouteInfoEntry, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgGwMetric=ipNewCfgGwMetric, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ripStats=ripStats, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumIntfLoop=ospfCumIntfLoop, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfNbrChange=ospfIntfNbrChange, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, iprouting=iprouting, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfTotalNeighbours=ospfTotalNeighbours, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumNbrBadRequests=ospfCumNbrBadRequests)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaInfoId=ospfAreaInfoId, ospfCumIntfDown=ospfCumIntfDown, ospfIntfNbrhello=ospfIntfNbrhello, vrrpStatInAdvers=vrrpStatInAdvers, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumRxTxStats=ospfCumRxTxStats, arpInfoMacAddr=arpInfoMacAddr, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfInfoEntry=ospfIntfInfoEntry, ipRouteInfoTable=ipRouteInfoTable, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, arpStatEntries=arpStatEntries, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfCumRxHello=ospfCumRxHello, ospfLsTypesSupported=ospfLsTypesSupported, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, routerLSALinkData=routerLSALinkData, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaTxHello=ospfAreaTxHello, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrp=vrrp, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, arpStatHighWater=arpStatHighWater, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfArea=ospfArea, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaNbrhello=ospfAreaNbrhello, arpInfoVLAN=arpInfoVLAN, arpInfoRefPorts=arpInfoRefPorts, ospfCumRxlsAcks=ospfCumRxlsAcks, arpInfoFlag=arpInfoFlag, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgGwState=ipNewCfgGwState, routerLSALinkID=routerLSALinkID, ripNewCfgVip=ripNewCfgVip, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ripCurCfgVip=ripCurCfgVip, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaIntfHello=ospfAreaIntfHello, routeStats=routeStats, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCfg=ospfCfg, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumRxPkts=ospfCumRxPkts, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfNbrInInitState=ospfNbrInInitState, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ripStatOutPkts=ripStatOutPkts, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfTxHello=ospfIntfTxHello, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipCurCfgGwVlan=ipCurCfgGwVlan, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaIntfDown=ospfAreaIntfDown, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgGwTable=ipCurCfgGwTable, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfRxPkts=ospfIntfRxPkts, dnsStats=dnsStats, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfInterface=ospfInterface, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, arpStats=arpStats, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpOper=vrrpOper, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgIntfState=ipNewCfgIntfState, vrrp_info=vrrp_info, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, routeStatEntries=routeStatEntries, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck)
