...
ModuleIdentity, TimeTicks, Counter32, Counter64, ObjectIdentity, Unsigned32, iso, IpAddress, Bits, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "Counter32", "Counter64", "ObjectIdentity", "Unsigned32", "iso", "IpAddress", "Bits", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfTotalAreas=ospfTotalAreas, ospfCumTxlsAcks=ospfCumTxlsAcks, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, ipRouteInfoGateway=ipRouteInfoGateway, ospfNbrInFullState=ospfNbrInFullState, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgGwRetry=ipNewCfgGwRetry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, routeStatEntries=routeStatEntries, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCumTxDatabase=ospfCumTxDatabase, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgGwTable=ipCurCfgGwTable, ipRouteInfoTable=ipRouteInfoTable, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipRouteInfoType=ipRouteInfoType, ipRouteInfoIndx=ipRouteInfoIndx, ospfArea=ospfArea, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipRouteInfoEntry=ipRouteInfoEntry, ripCurCfgVip=ripCurCfgVip, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaTxHello=ospfAreaTxHello, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCfg=ospfCfg, ospfIntfRxPkts=ospfIntfRxPkts, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaRxTxIndex=ospfAreaRxTxIndex, arpStats=arpStats, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ripNewCfgVip=ripNewCfgVip, ospfAreaIntfHello=ospfAreaIntfHello, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgGenState=vrrpCurCfgGenState, routerLSALinkData=routerLSALinkData, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumRxlsAcks=ospfCumRxlsAcks, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfIndex=ospfIntfIndex, routerLSALinkID=routerLSALinkID, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ripStatInPkts=ripStatInPkts, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfHello=ospfIntfHello, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaInfoIndex=ospfAreaInfoIndex, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfRxTxIndex=ospfIntfRxTxIndex, arpInfoFlag=arpInfoFlag, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ripStatOutPkts=ripStatOutPkts, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfinfo=ospfinfo, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, arpInfoTable=arpInfoTable, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaIntfDown=ospfAreaIntfDown, ospfNbrInExchState=ospfNbrInExchState, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumIntfBackup=ospfCumIntfBackup, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumRxTxStats=ospfCumRxTxStats, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumRxDatabase=ospfCumRxDatabase, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, arpStatHighWater=arpStatHighWater, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgGwInterval=ipNewCfgGwInterval, ripConfig=ripConfig, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipRouteInfoTag=ipRouteInfoTag, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipCurCfgGwInterval=ipCurCfgGwInterval, ipGatewayTableMax=ipGatewayTableMax, iprouting=iprouting, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, arpStatEntries=arpStatEntries, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumTxHello=ospfCumTxHello, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ip_info=ip_info, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ripCurCfgStaticSupply=ripCurCfgStaticSupply, routeStatHighWater=routeStatHighWater, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfNbrN1way=ospfIntfNbrN1way, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpOper=vrrpOper, arpInfoMacAddr=arpInfoMacAddr, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaRxPkts=ospfAreaRxPkts, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumNbrStart=ospfCumNbrStart, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaInfoTable=ospfAreaInfoTable, ospfLsTypesSupported=ospfLsTypesSupported, dnsStats=dnsStats, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfRxTxStats=ospfIntfRxTxStats, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumNbrhello=ospfCumNbrhello, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgGenState=vrrpNewCfgGenState, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpStats=vrrpStats, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgIntfMask=ipNewCfgIntfMask, routeStats=routeStats, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfGeneral=ospfGeneral, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaIntfBackup=ospfAreaIntfBackup, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgIntfState=ipNewCfgIntfState, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrp=vrrp, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfRxHello=ospfIntfRxHello, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripNewCfgState=ripNewCfgState, ospfIntfUnloop=ospfIntfUnloop, ospfIntfInfoTable=ospfIntfInfoTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumTxPkts=ospfCumTxPkts, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfWaitTimer=ospfIntfWaitTimer, arpInfoVLAN=arpInfoVLAN, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfStats=ospfStats, ospfGeneralStats=ospfGeneralStats, arpInfoDestIp=arpInfoDestIp, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, arpInfoSrcPort=arpInfoSrcPort, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumIntfDown=ospfCumIntfDown, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumRxHello=ospfCumRxHello, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipForward=ipForward, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfNbrChange=ospfIntfNbrChange, vrrpGeneral=vrrpGeneral, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipFwdNewCfgState=ipFwdNewCfgState, ripStats=ripStats, arpInfoEntry=arpInfoEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfChangeStats=ospfIntfChangeStats, ripCurCfgListen=ripCurCfgListen, routerLSALinkIndex=routerLSALinkIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumIntfHello=ospfCumIntfHello, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfProcessUptime=ospfProcessUptime, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfLoop=ospfIntfLoop, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaNbrN1way=ospfAreaNbrN1way, ripCurCfgState=ripCurCfgState, ospfAreaRxHello=ospfAreaRxHello, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfRxlsAcks=ospfIntfRxlsAcks, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumRxPkts=ospfCumRxPkts, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgGwArp=ipNewCfgGwArp)
