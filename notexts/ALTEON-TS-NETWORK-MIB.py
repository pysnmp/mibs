...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfInfoTable=ospfIntfInfoTable, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ip_info=ip_info, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipRouteInfoInterface=ipRouteInfoInterface, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgGwInterval=ipCurCfgGwInterval, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfTxPkts=ospfIntfTxPkts, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ripConfig=ripConfig, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfStats=ospfStats, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumIntfHello=ospfCumIntfHello, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumNbrDown=ospfCumNbrDown, ipInterfaceTableMax=ipInterfaceTableMax, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumTxlsAcks=ospfCumTxlsAcks, routeStats=routeStats, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, arpStatEntries=arpStatEntries, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfGeneralStats=ospfGeneralStats, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfNewCfgAreaId=ospfNewCfgAreaId, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, ipRouteInfoMask=ipRouteInfoMask, ospfNbrInExchState=ospfNbrInExchState, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCumTxDatabase=ospfCumTxDatabase, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaNbrhello=ospfAreaNbrhello, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfCountForRouter=ospfIntfCountForRouter, ripNewCfgListen=ripNewCfgListen, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, arpInfoFlag=arpInfoFlag, ripNewCfgDefListen=ripNewCfgDefListen, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfProcessUptime=ospfProcessUptime, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgGwIndex=ipNewCfgGwIndex, ripStatInPkts=ripStatInPkts, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, dnsStats=dnsStats, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, routeStatMaxEntries=routeStatMaxEntries, ipCurCfgIntfState=ipCurCfgIntfState, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaNbrRstAd=ospfAreaNbrRstAd, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaTxHello=ospfAreaTxHello, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ripNewCfgState=ripNewCfgState, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumNbrStart=ospfCumNbrStart, iprouting=iprouting, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfTotalAreas=ospfTotalAreas, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfNbrInFullState=ospfNbrInFullState, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfinfo=ospfinfo, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaChangeStats=ospfAreaChangeStats, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumRxHello=ospfCumRxHello, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, arpInfoEntry=arpInfoEntry, ospfTotalNeighbours=ospfTotalNeighbours, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpGeneral=vrrpGeneral, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfRxHello=ospfIntfRxHello, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ripCurCfgState=ripCurCfgState, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfTimersKickOffStats=ospfTimersKickOffStats, ipRouteInfoType=ipRouteInfoType, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaInfoId=ospfAreaInfoId, vrrpOper=vrrpOper)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumRxDatabase=ospfCumRxDatabase, vrrpStats=vrrpStats, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrp=vrrp, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, routerLSALinkIndex=routerLSALinkIndex, ripNewCfgVip=ripNewCfgVip, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipRouteInfoEntry=ipRouteInfoEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, routerLSAId=routerLSAId, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumTxHello=ospfCumTxHello, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, routerLSALinkID=routerLSALinkID, ospfAreaIntfDown=ospfAreaIntfDown, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ripStats=ripStats, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfHello=ospfIntfHello, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, arpInfoVLAN=arpInfoVLAN, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, routeStatEntries=routeStatEntries, ipNewCfgGwRetry=ipNewCfgGwRetry, arpInfoRefPorts=arpInfoRefPorts, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, arpInfoDestIp=arpInfoDestIp, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipForward=ipForward, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgGwState=ipCurCfgGwState, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaTableMaxSize=ospfAreaTableMaxSize, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumIntfDown=ospfCumIntfDown, routeStatHighWater=routeStatHighWater, routerLSALinkData=routerLSALinkData, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfDown=ospfIntfDown, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfStartTime=ospfStartTime, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ripCurCfgListen=ripCurCfgListen, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCfg=ospfCfg, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumRxPkts=ospfCumRxPkts, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaInfoTable=ospfAreaInfoTable, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ripCurCfgSupply=ripCurCfgSupply, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfArea=ospfArea, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIfTotalNeighbours=ospfIfTotalNeighbours, arpStats=arpStats, routerLSAAreaIndex=routerLSAAreaIndex, ipFwdCurCfgState=ipFwdCurCfgState, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumTxPkts=ospfCumTxPkts, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfLoop=ospfIntfLoop, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize)
