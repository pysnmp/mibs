...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfHello=ospfIntfHello, routeStatMaxEntries=routeStatMaxEntries, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpOper=vrrpOper, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumRxHello=ospfCumRxHello, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgGwMetric=ipNewCfgGwMetric, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ripStatOutPkts=ripStatOutPkts, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfNbrStart=ospfIntfNbrStart, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfNbrN1way=ospfIntfNbrN1way, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, arpInfoDestIp=arpInfoDestIp, routerLSALinkData=routerLSALinkData, ospfIntfInfoEntry=ospfIntfInfoEntry, arpInfoFlag=arpInfoFlag, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, ipRouteInfoInterface=ipRouteInfoInterface, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaInfoIndex=ospfAreaInfoIndex, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipRouteInfoIndx=ipRouteInfoIndx, ripStatInPkts=ripStatInPkts, ipNewCfgGwState=ipNewCfgGwState, ipGatewayTableMax=ipGatewayTableMax, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrp_info=vrrp_info, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfNbrInInitState=ospfNbrInInitState, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumIntfLoop=ospfCumIntfLoop, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfCountForRouter=ospfIntfCountForRouter, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfStartTime=ospfStartTime, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, iprouting=iprouting, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfLsTypesSupported=ospfLsTypesSupported, ripNewCfgState=ripNewCfgState, ipRouteInfoEntry=ipRouteInfoEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, arpStatEntries=arpStatEntries, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumRxPkts=ospfCumRxPkts, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumRxlsAcks=ospfCumRxlsAcks, arpInfoSrcPort=arpInfoSrcPort, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaRxTxStats=ospfAreaRxTxStats, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, arpInfoRefPorts=arpInfoRefPorts, ospfNbrInFullState=ospfNbrInFullState, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfRxlsReqs=ospfIntfRxlsReqs, arpInfoTable=arpInfoTable, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, routeStats=routeStats, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaNbrhello=ospfAreaNbrhello, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumRxDatabase=ospfCumRxDatabase, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumIntfHello=ospfCumIntfHello, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaNbrIndex=ospfAreaNbrIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, arpInfoEntry=arpInfoEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, routerLSAId=routerLSAId, ipFwdCurCfgState=ipFwdCurCfgState, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipForward=ipForward, vrrpGeneral=vrrpGeneral, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCfg=ospfCfg, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfChangeStats=ospfIntfChangeStats, ospfArea=ospfArea, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfNbrhello=ospfIntfNbrhello, ripStats=ripStats, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumIntfBackup=ospfCumIntfBackup, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumNbrhello=ospfCumNbrhello, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, arpStats=arpStats, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaNbrStart=ospfAreaNbrStart, ospfGeneral=ospfGeneral)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumNbrRstAd=ospfCumNbrRstAd, routeStatEntries=routeStatEntries, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumTxPkts=ospfCumTxPkts, ospfAreaTxHello=ospfAreaTxHello, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipRouteInfoType=ipRouteInfoType, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfNbrDown=ospfIntfNbrDown, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfinfo=ospfinfo, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ip_info=ip_info, ospfIntfUnloop=ospfIntfUnloop, routerLSALinkID=routerLSALinkID, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipInterfaceTableMax=ipInterfaceTableMax, ipRouteInfoDestIp=ipRouteInfoDestIp, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaRxTxIndex=ospfAreaRxTxIndex, routerLSALinkIndex=routerLSALinkIndex, ospfAreaIntfHello=ospfAreaIntfHello, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfGeneralStats=ospfGeneralStats, vrrp=vrrp, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfBackup=ospfIntfBackup, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumTxDatabase=ospfCumTxDatabase, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, arpStatHighWater=arpStatHighWater, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgGwTable=ipNewCfgGwTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfRxHello=ospfIntfRxHello, ospfTotalAreas=ospfTotalAreas, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, arpInfoVLAN=arpInfoVLAN, ospfCumTxHello=ospfCumTxHello, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, arpStatMaxEntries=arpStatMaxEntries, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfInterface=ospfInterface, ospfIntfDown=ospfIntfDown, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ripNewCfgSupply=ripNewCfgSupply, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpStats=vrrpStats, ripCurCfgState=ripCurCfgState, ripConfig=ripConfig, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfStats=ospfStats, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, dnsStats=dnsStats, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgGwRetry=ipCurCfgGwRetry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ripNewCfgVip=ripNewCfgVip, ripCurCfgSupply=ripCurCfgSupply, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfWaitTimer=ospfIntfWaitTimer, ripCurCfgListen=ripCurCfgListen, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk)
