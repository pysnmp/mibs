...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpStats=vrrpStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, arpStatHighWater=arpStatHighWater, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumNbrDown=ospfCumNbrDown, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpStatInAdvers=vrrpStatInAdvers, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ip_info=ip_info, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfHostTableMaxSize=ospfHostTableMaxSize, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfWaitTimer=ospfIntfWaitTimer, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfNbrChange=ospfIntfNbrChange, ospfStats=ospfStats, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgIntfState=ipNewCfgIntfState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfinfo=ospfinfo, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgIntfState=ipCurCfgIntfState, arpInfoVLAN=arpInfoVLAN, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipRouteInfoInterface=ipRouteInfoInterface, vrrpGeneral=vrrpGeneral, ospfAreaChangeStats=ospfAreaChangeStats, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfDown=ospfIntfDown, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ripConfig=ripConfig, ripCurCfgVip=ripCurCfgVip, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfGeneralStats=ospfGeneralStats, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ripCurCfgState=ripCurCfgState, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaNbrDown=ospfAreaNbrDown, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ripStats=ripStats, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCurCfgAreaId=ospfCurCfgAreaId, ipRouteInfoDestIp=ipRouteInfoDestIp, ripStatInErrorPkts=ripStatInErrorPkts, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumRxTxStats=ospfCumRxTxStats, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrp=vrrp, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipRouteInfoType=ipRouteInfoType, ripNewCfgState=ripNewCfgState, ospfAreaInfoId=ospfAreaInfoId, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfUnloop=ospfIntfUnloop, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCumRxDatabase=ospfCumRxDatabase, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, routerLSAId=routerLSAId, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfNbrInFullState=ospfNbrInFullState, ospfIntfTxDatabase=ospfIntfTxDatabase, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, routerLSALinkID=routerLSALinkID, ospfIfWaitInterval=ospfIfWaitInterval, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipGatewayTableMax=ipGatewayTableMax, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfTxHello=ospfIntfTxHello, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripNewCfgVip=ripNewCfgVip, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgGwState=ipNewCfgGwState, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfInfoTable=ospfIntfInfoTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfTotalNeighbours=ospfTotalNeighbours, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, routerLSALinkData=routerLSALinkData, ipNewCfgGwInterval=ipNewCfgGwInterval, routeStatEntries=routeStatEntries, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumIntfHello=ospfCumIntfHello, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumNbrStart=ospfCumNbrStart, vrrpIfTableMaxSize=vrrpIfTableMaxSize)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaTxDatabase=ospfAreaTxDatabase, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgGenState=vrrpCurCfgGenState, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumTxHello=ospfCumTxHello, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfProcessUptime=ospfProcessUptime, ospfIntfNbrStart=ospfIntfNbrStart, ipInterfaceTableMax=ipInterfaceTableMax, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfInterface=ospfInterface, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaRxPkts=ospfAreaRxPkts, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfChangeStats=ospfIntfChangeStats, dnsStats=dnsStats, ipRouteInfoMask=ipRouteInfoMask, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaNbrIndex=ospfAreaNbrIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfBackup=ospfIntfBackup, arpStatEntries=arpStatEntries, ospfIntfRxTxStats=ospfIntfRxTxStats, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaRxHello=ospfAreaRxHello, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfNbrInInitState=ospfNbrInInitState, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfGeneral=ospfGeneral, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfIndex=ospfIntfIndex, ipFwdNewCfgState=ipFwdNewCfgState, routeStatMaxEntries=routeStatMaxEntries, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipCurCfgGwVlan=ipCurCfgGwVlan, iprouting=iprouting, vrrpOper=vrrpOper, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfTxPkts=ospfIntfTxPkts, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumTxPkts=ospfCumTxPkts, ospfArea=ospfArea, ospfCumRxPkts=ospfCumRxPkts, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipRouteInfoTable=ipRouteInfoTable, arpStats=arpStats, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipForward=ipForward, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, routeStatHighWater=routeStatHighWater, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, arpStatMaxEntries=arpStatMaxEntries, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgGwTable=ipNewCfgGwTable, routeStats=routeStats, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdCurCfgState=ipFwdCurCfgState, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaIntfHello=ospfAreaIntfHello, ripCurCfgSupply=ripCurCfgSupply, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfNbrN1way=ospfIntfNbrN1way, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfHello=ospfIntfHello, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrp_info=vrrp_info, arpInfoEntry=arpInfoEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgGwState=ipCurCfgGwState, arpInfoSrcPort=arpInfoSrcPort, ripNewCfgSupply=ripNewCfgSupply, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumTxlsAcks=ospfCumTxlsAcks, ipCurCfgIntfMask=ipCurCfgIntfMask, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, arpInfoTable=arpInfoTable, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfStartTime=ospfStartTime, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ripStatOutPkts=ripStatOutPkts, ospfCumIntfBackup=ospfCumIntfBackup, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfTotalAreas=ospfTotalAreas, arpInfoFlag=arpInfoFlag, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfNbrRstAd=ospfIntfNbrRstAd)
