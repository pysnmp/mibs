...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaRxTxStats=ospfAreaRxTxStats, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfArea=ospfArea, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfStartTime=ospfStartTime, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrp=vrrp, vrrpOper=vrrpOper, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrp_info=vrrp_info, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, iprouting=iprouting, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumRxPkts=ospfCumRxPkts, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfStats=ospfStats, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgGwIndex=ipNewCfgGwIndex, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripNewCfgState=ripNewCfgState, ospfCumIntfBackup=ospfCumIntfBackup, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaTableMaxSize=ospfAreaTableMaxSize, routeStats=routeStats, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaRxHello=ospfAreaRxHello, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ripStatOutPkts=ripStatOutPkts, ipFwdNewCfgState=ipFwdNewCfgState, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumRxHello=ospfCumRxHello, routerLSALinkID=routerLSALinkID, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ip_info=ip_info, routeStatHighWater=routeStatHighWater, ipNewCfgGwMetric=ipNewCfgGwMetric, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaTxlsReqs=ospfAreaTxlsReqs, arpInfoDestIp=arpInfoDestIp, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgGwTable=ipNewCfgGwTable, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumNbrStart=ospfCumNbrStart, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaTxPkts=ospfAreaTxPkts, ipForward=ipForward, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, dnsStats=dnsStats, ipCurCfgGwState=ipCurCfgGwState, ospfinfo=ospfinfo, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfNbrInFullState=ospfNbrInFullState, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfTotalAreas=ospfTotalAreas, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipRouteInfoType=ipRouteInfoType, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, routeStatMaxEntries=routeStatMaxEntries, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumNbrhello=ospfCumNbrhello, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfInterface=ospfInterface, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumIntfHello=ospfCumIntfHello, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumNbrN1way=ospfCumNbrN1way, arpInfoEntry=arpInfoEntry, routerLSALinkData=routerLSALinkData, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfGeneral=ospfGeneral, ipNewCfgGwState=ipNewCfgGwState, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfBackup=ospfIntfBackup, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfWaitTimer=ospfIntfWaitTimer, ripStats=ripStats, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaRxlsReqs=ospfAreaRxlsReqs, arpStatHighWater=arpStatHighWater, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumRxTxStats=ospfCumRxTxStats, ripCurCfgDefListen=ripCurCfgDefListen, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaNbrStart=ospfAreaNbrStart, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, arpStats=arpStats, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipInterfaceTableMax=ipInterfaceTableMax, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfIndex=ospfIntfIndex, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ripCurCfgVip=ripCurCfgVip, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfDown=ospfIntfDown, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumTxPkts=ospfCumTxPkts, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, routerLSAId=routerLSAId, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumNbrDown=ospfCumNbrDown, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, arpInfoRefPorts=arpInfoRefPorts, ripNewCfgVip=ripNewCfgVip, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipRouteInfoMask=ipRouteInfoMask, ospfProcessUptime=ospfProcessUptime, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ripStatInErrorPkts=ripStatInErrorPkts, ipRouteInfoIndx=ipRouteInfoIndx, arpInfoVLAN=arpInfoVLAN, ipGatewayTableMax=ipGatewayTableMax, vrrpStats=vrrpStats, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaNbrhello=ospfAreaNbrhello, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgGwRetry=ipNewCfgGwRetry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfInfoEntry=ospfIntfInfoEntry, ripCurCfgListen=ripCurCfgListen, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfUnloop=ospfIntfUnloop, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumTxDatabase=ospfCumTxDatabase, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, arpInfoTable=arpInfoTable, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripStatRoutesAgedOut=ripStatRoutesAgedOut, routerLSALinkIndex=routerLSALinkIndex, ospfIntfInfoTable=ospfIntfInfoTable, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgIntfTable=ipNewCfgIntfTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIfWaitInterval=ospfIfWaitInterval, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfLoop=ospfIntfLoop, ospfIntfHello=ospfIntfHello, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaIntfDown=ospfAreaIntfDown, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ripConfig=ripConfig, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaTxHello=ospfAreaTxHello, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgIntfState=ipNewCfgIntfState, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaIntfHello=ospfAreaIntfHello, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaRxPkts=ospfAreaRxPkts, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfNbrDown=ospfIntfNbrDown, ripStatInPkts=ripStatInPkts, ipRouteInfoTable=ipRouteInfoTable, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfTxlsReqs=ospfIntfTxlsReqs, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ripNewCfgSupply=ripNewCfgSupply, ospfAreaRxTxIndex=ospfAreaRxTxIndex)
