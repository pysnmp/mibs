...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, arpInfoFlag=arpInfoFlag, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfHello=ospfIntfHello, ipCurCfgGwArp=ipCurCfgGwArp, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfVlinkCountForRouter=ospfVlinkCountForRouter, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfStats=ospfStats, ospfIntfBackup=ospfIntfBackup, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, routerLSALinkIfIndex=routerLSALinkIfIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, routerLSALinkID=routerLSALinkID, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfRxHello=ospfIntfRxHello, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfUnloop=ospfIntfUnloop, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, arpStatMaxEntries=arpStatMaxEntries, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaNbrDown=ospfAreaNbrDown, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, arpInfoTable=arpInfoTable, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripCurCfgVip=ripCurCfgVip, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgGwInterval=ipNewCfgGwInterval, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfNbrStart=ospfIntfNbrStart, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripCurCfgListen=ripCurCfgListen, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumRxPkts=ospfCumRxPkts, ospfAreaTxHello=ospfAreaTxHello, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumRxTxStats=ospfCumRxTxStats, ospfInterface=ospfInterface, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfArea=ospfArea, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ripStatInPkts=ripStatInPkts, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfTotalAreas=ospfTotalAreas, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripNewCfgDefListen=ripNewCfgDefListen, ipRouteInfoType=ipRouteInfoType, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumTxHello=ospfCumTxHello, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, arpInfoMacAddr=arpInfoMacAddr, routeStatEntries=routeStatEntries, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumIntfDown=ospfCumIntfDown, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgGwState=ipNewCfgGwState, arpInfoRefPorts=arpInfoRefPorts, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, routerLSAId=routerLSAId, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfTxHello=ospfIntfTxHello, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfinfo=ospfinfo, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfNbrInExchState=ospfNbrInExchState, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumTxDatabase=ospfCumTxDatabase, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIfWaitInterval=ospfIfWaitInterval, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfTxDatabase=ospfIntfTxDatabase, arpInfoVLAN=arpInfoVLAN, ip_info=ip_info, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfRxTxStats=ospfIntfRxTxStats, dnsStats=dnsStats, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumTxPkts=ospfCumTxPkts, ospfCumNbrStart=ospfCumNbrStart, vrrpStats=vrrpStats, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpGeneral=vrrpGeneral, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfRxPkts=ospfIntfRxPkts, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgGwIndex=ipNewCfgGwIndex, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaNbrStart=ospfAreaNbrStart, ipForward=ipForward, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfProcessUptime=ospfProcessUptime, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfStartTime=ospfStartTime, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ripStatInErrorPkts=ripStatInErrorPkts, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrp=vrrp, ospfIntfRxDatabase=ospfIntfRxDatabase, iprouting=iprouting, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgGwState=ipCurCfgGwState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumIntfLoop=ospfCumIntfLoop)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfWaitTimer=ospfIntfWaitTimer, ipRouteInfoGateway=ipRouteInfoGateway, ripConfig=ripConfig, ipRouteInfoMask=ipRouteInfoMask, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfNbrChange=ospfIntfNbrChange, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, arpInfoDestIp=arpInfoDestIp, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaInfoTable=ospfAreaInfoTable, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfTableMaxSize=ospfIntfTableMaxSize, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaNbrhello=ospfAreaNbrhello, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfLoop=ospfIntfLoop, arpInfoSrcPort=arpInfoSrcPort, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, routeStatHighWater=routeStatHighWater, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumRxDatabase=ospfCumRxDatabase, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaRxPkts=ospfAreaRxPkts, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ripCurCfgState=ripCurCfgState, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipFwdCurCfgState=ipFwdCurCfgState, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, arpInfoEntry=arpInfoEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumNbrN1way=ospfCumNbrN1way, vrrp_info=vrrp_info, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpOper=vrrpOper, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, routeStats=routeStats, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgIntfTable=ipCurCfgIntfTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipCurCfgIntfMask=ipCurCfgIntfMask, ripStatOutPkts=ripStatOutPkts, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, arpStats=arpStats, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpStatInAdvers=vrrpStatInAdvers, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumIntfHello=ospfCumIntfHello, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ripNewCfgListen=ripNewCfgListen, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgIntfState=ipCurCfgIntfState, ripStats=ripStats, ospfGeneral=ospfGeneral, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ripNewCfgVip=ripNewCfgVip, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfNbrInInitState=ospfNbrInInitState, routeStatMaxEntries=routeStatMaxEntries, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ripNewCfgState=ripNewCfgState, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumIntfBackup=ospfCumIntfBackup, routerLSALinkData=routerLSALinkData, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfIndex=ospfIntfIndex)
