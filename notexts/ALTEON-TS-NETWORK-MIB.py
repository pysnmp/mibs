...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumTxHello=ospfCumTxHello, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumRxlsAcks=ospfCumRxlsAcks, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumTxDatabase=ospfCumTxDatabase, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfArea=ospfArea, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaIntfBackup=ospfAreaIntfBackup, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfRxHello=ospfIntfRxHello, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfProcessUptime=ospfProcessUptime, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfGeneralInfo=ospfGeneralInfo, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumNbrhello=ospfCumNbrhello, ospfNbrInExchState=ospfNbrInExchState, ospfAreaNbrN1way=ospfAreaNbrN1way, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgGwVlan=ipCurCfgGwVlan, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgIntfMask=ipCurCfgIntfMask, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumIntfLoop=ospfCumIntfLoop, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfStartTime=ospfStartTime, ripStatOutPkts=ripStatOutPkts, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfinfo=ospfinfo, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaRxTxStats=ospfAreaRxTxStats, ripCurCfgState=ripCurCfgState, ospfAreaIntfHello=ospfAreaIntfHello, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipCurCfgGwState=ipCurCfgGwState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumIntfBackup=ospfCumIntfBackup, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, arpStats=arpStats, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfDown=ospfIntfDown, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfStats=ospfStats, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfGeneral=ospfGeneral, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, arpInfoVLAN=arpInfoVLAN, ipRouteInfoMask=ipRouteInfoMask, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfTxHello=ospfIntfTxHello, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpStatOutAdvers=vrrpStatOutAdvers, arpInfoDestIp=arpInfoDestIp, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfNbrDown=ospfIntfNbrDown, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCfg=ospfCfg, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, arpInfoFlag=arpInfoFlag, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfHello=ospfIntfHello, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumRxDatabase=ospfCumRxDatabase, ospfGeneralStats=ospfGeneralStats, ospfIntfNbrRstAd=ospfIntfNbrRstAd, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfLoop=ospfIntfLoop, ospfCumIntfHello=ospfCumIntfHello, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfTotalAreas=ospfTotalAreas, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgGwEntry=ipNewCfgGwEntry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, routerLSALinkID=routerLSALinkID, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripCurCfgListen=ripCurCfgListen, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, routerLSAId=routerLSAId, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaChangeStats=ospfAreaChangeStats, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgGwTable=ipCurCfgGwTable, ipGatewayTableMax=ipGatewayTableMax, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumNbrN1way=ospfCumNbrN1way, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrp=vrrp, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipForward=ipForward, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfNbrStart=ospfIntfNbrStart, vrrp_info=vrrp_info, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfUnloop=ospfIntfUnloop, ospfAreaTableMaxSize=ospfAreaTableMaxSize, dnsStats=dnsStats, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, arpStatHighWater=arpStatHighWater, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumRxPkts=ospfCumRxPkts, ospfIfInfoIpAddress=ospfIfInfoIpAddress, arpInfoTable=arpInfoTable, arpInfoEntry=arpInfoEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipRouteInfoGateway=ipRouteInfoGateway, ipCurCfgIntfTable=ipCurCfgIntfTable, ipRouteInfoInterface=ipRouteInfoInterface, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpOper=vrrpOper, routeStatHighWater=routeStatHighWater, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaRxPkts=ospfAreaRxPkts, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumRxTxStats=ospfCumRxTxStats, ipNewCfgGwState=ipNewCfgGwState, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaTxDatabase=ospfAreaTxDatabase, ripNewCfgSupply=ripNewCfgSupply, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaNbrRstAd=ospfAreaNbrRstAd, arpInfoRefPorts=arpInfoRefPorts, iprouting=iprouting, ospfTotalNssaAreas=ospfTotalNssaAreas, ip_info=ip_info, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipRouteInfoTag=ipRouteInfoTag, ospfIntfTxPkts=ospfIntfTxPkts, routerLSALinkIfIndex=routerLSALinkIfIndex, arpStatEntries=arpStatEntries, ripNewCfgListen=ripNewCfgListen, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpGeneral=vrrpGeneral, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, routeStats=routeStats, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaRxTxIndex=ospfAreaRxTxIndex, routeStatMaxEntries=routeStatMaxEntries, ripStatInPkts=ripStatInPkts, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumNbrDown=ospfCumNbrDown, ospfIntfBackup=ospfIntfBackup, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, routeStatEntries=routeStatEntries, ospfIntfInfoTable=ospfIntfInfoTable, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumTxPkts=ospfCumTxPkts, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdNewCfgState=ipFwdNewCfgState, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripConfig=ripConfig, ipNewCfgGwTable=ipNewCfgGwTable, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ripStats=ripStats, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipFwdCurCfgState=ipFwdCurCfgState, ipInterfaceTableMax=ipInterfaceTableMax, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ripNewCfgVip=ripNewCfgVip, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfInterface=ospfInterface, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfNbrhello=ospfIntfNbrhello, arpInfoSrcPort=arpInfoSrcPort, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaTxHello=ospfAreaTxHello)
