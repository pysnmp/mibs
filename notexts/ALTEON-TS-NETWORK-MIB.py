...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgGwTable=ipNewCfgGwTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfRxPkts=ospfIntfRxPkts, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfNbrhello=ospfIntfNbrhello, ripStatInPkts=ripStatInPkts, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, arpStats=arpStats, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaTxHello=ospfAreaTxHello, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumTxHello=ospfCumTxHello, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrp=vrrp, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfNbrInInitState=ospfNbrInInitState, ospfInterface=ospfInterface, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfStats=ospfStats, ripConfig=ripConfig, ospfAreaNbrStart=ospfAreaNbrStart, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipGatewayTableMax=ipGatewayTableMax, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, routerLSALinkIndex=routerLSALinkIndex, ospfCumTxDatabase=ospfCumTxDatabase, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfArea=ospfArea, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpStatInAdvers=vrrpStatInAdvers, ip_info=ip_info, arpInfoTable=arpInfoTable, routeStats=routeStats, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ripStatOutPkts=ripStatOutPkts, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpGeneral=vrrpGeneral, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfUnloop=ospfIntfUnloop, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ripNewCfgState=ripNewCfgState, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ripNewCfgDefListen=ripNewCfgDefListen, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumIntfChangeStats=ospfCumIntfChangeStats, arpStatMaxEntries=arpStatMaxEntries, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ripStats=ripStats, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgGwState=ipNewCfgGwState, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumNbrDown=ospfCumNbrDown, ospfIntfNbrDown=ospfIntfNbrDown, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaTxDatabase=ospfAreaTxDatabase, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaIntfDown=ospfAreaIntfDown, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgGenState=vrrpNewCfgGenState, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfTotalAreas=ospfTotalAreas, ospfinfo=ospfinfo, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfHello=ospfIntfHello, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfTxPkts=ospfIntfTxPkts, ipNewCfgGwIndex=ipNewCfgGwIndex, ripStatInErrorPkts=ripStatInErrorPkts, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipRouteInfoMask=ipRouteInfoMask, ospfIntfRxlsAcks=ospfIntfRxlsAcks, arpInfoVLAN=arpInfoVLAN, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrp_info=vrrp_info, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfGeneralStats=ospfGeneralStats, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgGwInterval=ipCurCfgGwInterval, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ripCurCfgSupply=ripCurCfgSupply, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, iprouting=iprouting, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfGeneral=ospfGeneral)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgBootpState=ipNewCfgBootpState, arpStatEntries=arpStatEntries, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipNewCfgIntfState=ipNewCfgIntfState, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaNbrDown=ospfAreaNbrDown, routerLSALinkData=routerLSALinkData, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, dnsStats=dnsStats, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumRxPkts=ospfCumRxPkts, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, routeStatEntries=routeStatEntries, ospfCumIntfHello=ospfCumIntfHello, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ripCurCfgVip=ripCurCfgVip, ipCurCfgGwState=ipCurCfgGwState, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, routeStatHighWater=routeStatHighWater, ripCurCfgListen=ripCurCfgListen, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, arpInfoDestIp=arpInfoDestIp, ospfAreaChangeStats=ospfAreaChangeStats, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpOper=vrrpOper, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCumIntfDown=ospfCumIntfDown, ospfAreaRxPkts=ospfAreaRxPkts, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfGeneralInfo=ospfGeneralInfo, ripNewCfgSupply=ripNewCfgSupply, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfDown=ospfIntfDown, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpStats=vrrpStats, ipForward=ipForward, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, arpStatHighWater=arpStatHighWater, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfLoop=ospfIntfLoop, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfRxHello=ospfIntfRxHello, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, arpInfoFlag=arpInfoFlag, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumNbrStart=ospfCumNbrStart, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumTxPkts=ospfCumTxPkts, ospfCfg=ospfCfg, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumRxDatabase=ospfCumRxDatabase, arpInfoEntry=arpInfoEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, arpInfoSrcPort=arpInfoSrcPort, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipRouteInfoGateway=ipRouteInfoGateway, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry)
