...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, ripCurCfgState=ripCurCfgState, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaTxHello=ospfAreaTxHello, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfStartTime=ospfStartTime, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, arpStatHighWater=arpStatHighWater, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgIntfState=ipCurCfgIntfState, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCumIntfHello=ospfCumIntfHello, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfLoop=ospfIntfLoop, ipRouteInfoMask=ipRouteInfoMask, iprouting=iprouting, ospfAreaInfoEntry=ospfAreaInfoEntry, arpInfoDestIp=arpInfoDestIp, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumNbrStart=ospfCumNbrStart, ripNewCfgVip=ripNewCfgVip, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipRouteInfoIndx=ipRouteInfoIndx, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ripCurCfgDefListen=ripCurCfgDefListen, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfNbrDown=ospfIntfNbrDown, ospfIfInfoIndex=ospfIfInfoIndex, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfGeneralInfo=ospfGeneralInfo, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ripStatInErrorPkts=ripStatInErrorPkts, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfNbrStart=ospfIntfNbrStart, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgGwEntry=ipNewCfgGwEntry, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCfg=ospfCfg, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfTotalNssaAreas=ospfTotalNssaAreas, routerLSALinkID=routerLSALinkID, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumRxlsReqs=ospfCumRxlsReqs, arpInfoFlag=arpInfoFlag, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpOper=vrrpOper, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfNbrChange=ospfIntfNbrChange, ripStatInPkts=ripStatInPkts, ipNewCfgIntfMask=ipNewCfgIntfMask, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipRouteInfoTag=ipRouteInfoTag, routerLSALinkData=routerLSALinkData, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfNbrIndex=ospfIntfNbrIndex, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfCumNbrDown=ospfCumNbrDown, ospfIntfBackup=ospfIntfBackup, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaIntfIndex=ospfAreaIntfIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, arpInfoVLAN=arpInfoVLAN, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfTotalTransitAreas=ospfTotalTransitAreas, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfStats=ospfStats, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfGeneral=ospfGeneral, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfinfo=ospfinfo, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumIntfBackup=ospfCumIntfBackup, ipRouteInfoEntry=ipRouteInfoEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaNbrDown=ospfAreaNbrDown, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgGwState=ipNewCfgGwState, ospfAreaNbrhello=ospfAreaNbrhello, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgGenState=vrrpCurCfgGenState, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumNbrN1way=ospfCumNbrN1way, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfTotalAreas=ospfTotalAreas, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfArea=ospfArea, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipRouteInfoTable=ipRouteInfoTable, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCumIntfDown=ospfCumIntfDown, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfGeneralStats=ospfGeneralStats, ospfIntfTxlsReqs=ospfIntfTxlsReqs)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ip_info=ip_info, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaIntfLoop=ospfAreaIntfLoop, routeStats=routeStats, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, arpInfoEntry=arpInfoEntry, ospfIntfUnloop=ospfIntfUnloop, ospfIntfHello=ospfIntfHello, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpStats=vrrpStats, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrp=vrrp, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdCurCfgState=ipFwdCurCfgState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpGeneral=vrrpGeneral, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipCurCfgGwEntry=ipCurCfgGwEntry, routeStatEntries=routeStatEntries, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripStats=ripStats, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfIndex=ospfIntfIndex, vrrp_info=vrrp_info, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ripStatOutPkts=ripStatOutPkts, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfRxHello=ospfIntfRxHello, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaIntfBackup=ospfAreaIntfBackup, ripConfig=ripConfig, arpStats=arpStats, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaTableMaxSize=ospfAreaTableMaxSize, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgGwTable=ipNewCfgGwTable, ripNewCfgState=ripNewCfgState, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumIntfUnloop=ospfCumIntfUnloop, ripCurCfgListen=ripCurCfgListen, ipRouteInfoType=ipRouteInfoType, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfProcessUptime=ospfProcessUptime, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumRxDatabase=ospfCumRxDatabase, routeStatHighWater=routeStatHighWater, ospfAreaRxTxStats=ospfAreaRxTxStats, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripNewCfgListen=ripNewCfgListen, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpStatInAdvers=vrrpStatInAdvers, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaInfoId=ospfAreaInfoId, ipForward=ipForward, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgGwRetry=ipCurCfgGwRetry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfInterface=ospfInterface, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipInterfaceTableMax=ipInterfaceTableMax, ripCurCfgSupply=ripCurCfgSupply, ospfAreaRxPkts=ospfAreaRxPkts, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfDown=ospfIntfDown, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, dnsStats=dnsStats, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumRxPkts=ospfCumRxPkts, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaRxHello=ospfAreaRxHello, ospfCumTxHello=ospfCumTxHello, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast)
