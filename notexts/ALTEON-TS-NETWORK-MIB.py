...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipRouteInfoTag=ipRouteInfoTag, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ripCurCfgSupply=ripCurCfgSupply, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, arpStatEntries=arpStatEntries, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfStartTime=ospfStartTime, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCfg=ospfCfg, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaTxHello=ospfAreaTxHello, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpOper=vrrpOper, arpInfoFlag=arpInfoFlag, ipForward=ipForward, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, routeStatMaxEntries=routeStatMaxEntries, ospfCumTxDatabase=ospfCumTxDatabase, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumNbrN1way=ospfCumNbrN1way, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfNbrIndex=ospfIntfNbrIndex, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfinfo=ospfinfo, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipCurCfgIntfMask=ipCurCfgIntfMask, ripNewCfgSupply=ripNewCfgSupply, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, dnsStats=dnsStats, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfStats=ospfStats, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, arpInfoSrcPort=arpInfoSrcPort, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, routerLSAId=routerLSAId, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumRxPkts=ospfCumRxPkts, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipRouteInfoType=ipRouteInfoType, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumIntfLoop=ospfCumIntfLoop, routerLSALinkID=routerLSALinkID, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfTxHello=ospfIntfTxHello, ipRouteInfoTable=ipRouteInfoTable, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumNbrStart=ospfCumNbrStart, ospfAreaIntfHello=ospfAreaIntfHello, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ip_info=ip_info, ospfArea=ospfArea, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ripNewCfgListen=ripNewCfgListen, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumNbrhello=ospfCumNbrhello, vrrpStats=vrrpStats, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumIntfDown=ospfCumIntfDown, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ripCurCfgListen=ripCurCfgListen, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfInterface=ospfInterface, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, arpInfoTable=arpInfoTable, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfHello=ospfIntfHello, ospfIntfUnloop=ospfIntfUnloop, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfDown=ospfIntfDown, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumTxPkts=ospfCumTxPkts, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaChangeStats=ospfAreaChangeStats, vrrpGeneral=vrrpGeneral, routeStats=routeStats, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpInfoDestIp=arpInfoDestIp, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripConfig=ripConfig, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfBackup=ospfIntfBackup, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumIntfHello=ospfCumIntfHello, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ripStats=ripStats, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgGwVlan=ipNewCfgGwVlan, arpStatHighWater=arpStatHighWater, ospfNbrInFullState=ospfNbrInFullState, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfGeneralStats=ospfGeneralStats, ospfCumRxHello=ospfCumRxHello, ospfAreaRxHello=ospfAreaRxHello, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumTxHello=ospfCumTxHello, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgGwTable=ipNewCfgGwTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgGwArp=ipCurCfgGwArp, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaNbrRstAd=ospfAreaNbrRstAd, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, iprouting=iprouting, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIfInfoIndex=ospfIfInfoIndex, ripStatInPkts=ripStatInPkts, vrrpStatInAdvers=vrrpStatInAdvers, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, arpInfoMacAddr=arpInfoMacAddr, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ripCurCfgVip=ripCurCfgVip, ospfIntfNbrStart=ospfIntfNbrStart, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, routeStatEntries=routeStatEntries, ripCurCfgDefListen=ripCurCfgDefListen, ipInterfaceTableMax=ipInterfaceTableMax, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrp=vrrp, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ripCurCfgState=ripCurCfgState, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfRxHello=ospfIntfRxHello, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIfWaitInterval=ospfIfWaitInterval, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaInfoId=ospfAreaInfoId, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, arpStats=arpStats, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrp_info=vrrp_info, ripStatOutPkts=ripStatOutPkts, ipNewCfgGwState=ipNewCfgGwState, arpInfoVLAN=arpInfoVLAN, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ripNewCfgState=ripNewCfgState, ospfGeneral=ospfGeneral, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgGwEntry=ipNewCfgGwEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaIntfIndex=ospfAreaIntfIndex, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipRouteInfoInterface=ipRouteInfoInterface, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable)
