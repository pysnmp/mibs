...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfProcessUptime=ospfProcessUptime, routeStatHighWater=routeStatHighWater, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, arpInfoEntry=arpInfoEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipNewCfgGwTable=ipNewCfgGwTable, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumRxPkts=ospfCumRxPkts, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfinfo=ospfinfo, ripNewCfgListen=ripNewCfgListen, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfBackup=ospfIntfBackup, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, arpInfoSrcPort=arpInfoSrcPort, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfNbrInExchState=ospfNbrInExchState, ripCurCfgListen=ripCurCfgListen, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumIntfLoop=ospfCumIntfLoop, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, arpInfoMacAddr=arpInfoMacAddr, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaChangeStats=ospfAreaChangeStats, ospfArea=ospfArea, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfLsTypesSupported=ospfLsTypesSupported, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ripNewCfgSupply=ripNewCfgSupply, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfStats=ospfStats, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgGwVlan=ipNewCfgGwVlan, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, arpStats=arpStats, ipCurCfgGwInterval=ipCurCfgGwInterval, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumTxPkts=ospfCumTxPkts, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfGeneralInfo=ospfGeneralInfo, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCfg=ospfCfg, ospfCumRxlsAcks=ospfCumRxlsAcks, routerLSALinkData=routerLSALinkData, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipForward=ipForward, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfGeneral=ospfGeneral, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfChangeStats=ospfIntfChangeStats, ripCurCfgState=ripCurCfgState, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ripCurCfgSupply=ripCurCfgSupply, ospfIfInfoIndex=ospfIfInfoIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ripStatOutPkts=ripStatOutPkts, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, arpStatHighWater=arpStatHighWater, ospfCumRxTxStats=ospfCumRxTxStats, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ripNewCfgState=ripNewCfgState, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumTxHello=ospfCumTxHello, ospfIntfRxTxIndex=ospfIntfRxTxIndex, routeStats=routeStats, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfStartTime=ospfStartTime, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ripCurCfgVip=ripCurCfgVip, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, arpInfoTable=arpInfoTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfCountForRouter=ospfIntfCountForRouter, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfInfoEntry=ospfIntfInfoEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTotalAreas=ospfTotalAreas, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaTxHello=ospfAreaTxHello, dnsStats=dnsStats, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumIntfDown=ospfCumIntfDown, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripConfig=ripConfig, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfNbrInInitState=ospfNbrInInitState, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaInfoTable=ospfAreaInfoTable, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumNbrDown=ospfCumNbrDown, arpInfoFlag=arpInfoFlag, routerLSALinkID=routerLSALinkID, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipRouteInfoTag=ipRouteInfoTag, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipRouteInfoType=ipRouteInfoType, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgGwState=ipCurCfgGwState, ripStatInPkts=ripStatInPkts, ripNewCfgVip=ripNewCfgVip, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumIntfUnloop=ospfCumIntfUnloop, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipInterfaceTableMax=ipInterfaceTableMax, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfRxPkts=ospfIntfRxPkts, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfUnloop=ospfIntfUnloop, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpOper=vrrpOper, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ripStatInErrorPkts=ripStatInErrorPkts, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipCurCfgIntfAddr=ipCurCfgIntfAddr, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipRouteInfoDestIp=ipRouteInfoDestIp, ipCurCfgBootpState=ipCurCfgBootpState, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, arpStatEntries=arpStatEntries, ospfAreaTxlsReqs=ospfAreaTxlsReqs, routeStatEntries=routeStatEntries, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfIndex=ospfIntfIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, arpInfoVLAN=arpInfoVLAN, ipGatewayTableMax=ipGatewayTableMax, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrp=vrrp, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfDown=ospfIntfDown, ospfAreaNbrIndex=ospfAreaNbrIndex, ripStats=ripStats, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaTxDatabase=ospfAreaTxDatabase, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfTxPkts=ospfIntfTxPkts, iprouting=iprouting, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, routeStatMaxEntries=routeStatMaxEntries, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgGwMetric=ipCurCfgGwMetric, ip_info=ip_info, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpGeneral=vrrpGeneral, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumNbrStart=ospfCumNbrStart, ospfAreaRxDatabase=ospfAreaRxDatabase, ipRouteInfoTable=ipRouteInfoTable, ospfInterface=ospfInterface, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfTxHello=ospfIntfTxHello, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumRxHello=ospfCumRxHello, ipNewCfgBootpState=ipNewCfgBootpState, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipRouteInfoMask=ipRouteInfoMask, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumIntfHello=ospfCumIntfHello, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgGwArp=ipCurCfgGwArp, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaRxHello=ospfAreaRxHello, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc)
