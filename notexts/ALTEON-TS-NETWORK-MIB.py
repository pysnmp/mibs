...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaIntfBackup=ospfAreaIntfBackup, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfStats=ospfStats, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumRxTxStats=ospfCumRxTxStats, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpStatInAdvers=vrrpStatInAdvers, ospfNbrInExchState=ospfNbrInExchState, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpGeneral=vrrpGeneral, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, arpInfoEntry=arpInfoEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, iprouting=iprouting, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumIntfHello=ospfCumIntfHello, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfinfo=ospfinfo, ripStatOutPkts=ripStatOutPkts, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumTxlsAcks=ospfCumTxlsAcks, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIfWaitInterval=ospfIfWaitInterval, ripCurCfgSupply=ripCurCfgSupply, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgIntfState=ipNewCfgIntfState, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ripNewCfgSupply=ripNewCfgSupply, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpOper=vrrpOper, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfTxHello=ospfIntfTxHello, ospfIntfTxPkts=ospfIntfTxPkts, arpInfoSrcPort=arpInfoSrcPort, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfInfoEntry=ospfIntfInfoEntry, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIfInfoIpAddress=ospfIfInfoIpAddress, arpStats=arpStats, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfTotalAreas=ospfTotalAreas, ipCurCfgGwArp=ipCurCfgGwArp, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfStartTime=ospfStartTime, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaTxHello=ospfAreaTxHello, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfProcessUptime=ospfProcessUptime, ripNewCfgVip=ripNewCfgVip, vrrpStats=vrrpStats, ipGatewayTableMax=ipGatewayTableMax, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgIntfTable=ipCurCfgIntfTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfUnloop=ospfIntfUnloop, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumTxPkts=ospfCumTxPkts, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaInfoId=ospfAreaInfoId, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ripStats=ripStats, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripCurCfgDefListen=ripCurCfgDefListen, ospfHostTableMaxSize=ospfHostTableMaxSize, routerLSALinkData=routerLSALinkData, ospfAreaRxHello=ospfAreaRxHello, vrrp=vrrp, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ripCurCfgState=ripCurCfgState, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfRxHello=ospfIntfRxHello, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, arpInfoDestIp=arpInfoDestIp, ospfGeneralStats=ospfGeneralStats, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ripConfig=ripConfig, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCfg=ospfCfg, ospfGeneralInfo=ospfGeneralInfo, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfWaitTimer=ospfIntfWaitTimer, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgGwAddr=ipNewCfgGwAddr, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipRouteInfoTable=ipRouteInfoTable, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, arpInfoMacAddr=arpInfoMacAddr, arpStatMaxEntries=arpStatMaxEntries, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, dnsStats=dnsStats, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipRouteInfoTag=ipRouteInfoTag, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ripNewCfgState=ripNewCfgState)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfInterface=ospfInterface, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfLoop=ospfIntfLoop, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumNbrhello=ospfCumNbrhello, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, arpInfoTable=arpInfoTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIfInfoIndex=ospfIfInfoIndex, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, routerLSAId=routerLSAId, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumRxDatabase=ospfCumRxDatabase, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfGeneral=ospfGeneral, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ripStatInPkts=ripStatInPkts, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, routeStatMaxEntries=routeStatMaxEntries, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumIntfBackup=ospfCumIntfBackup, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaNbrDown=ospfAreaNbrDown, ospfArea=ospfArea, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipRouteInfoType=ipRouteInfoType, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfIndex=ospfIntfIndex, ospfCumTxHello=ospfCumTxHello, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ripNewCfgListen=ripNewCfgListen, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, arpInfoRefPorts=arpInfoRefPorts, ripCurCfgVip=ripCurCfgVip, ipForward=ipForward, ospfIntfHello=ospfIntfHello, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumRxHello=ospfCumRxHello, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumNbrBadRequests=ospfCumNbrBadRequests, arpInfoVLAN=arpInfoVLAN, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgGwIndex=ipCurCfgGwIndex, arpStatEntries=arpStatEntries, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, arpInfoFlag=arpInfoFlag, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipCurCfgGwTable=ipCurCfgGwTable, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfNbrStart=ospfIntfNbrStart, ip_info=ip_info, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, routeStats=routeStats, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, arpStatHighWater=arpStatHighWater, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdCurCfgState=ipFwdCurCfgState, ipRouteInfoIndx=ipRouteInfoIndx, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripNewCfgDefListen=ripNewCfgDefListen, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumTxlsReqs=ospfCumTxlsReqs, ripCurCfgListen=ripCurCfgListen, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority)
