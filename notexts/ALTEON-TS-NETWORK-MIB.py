...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIfWaitInterval=ospfIfWaitInterval, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, arpStats=arpStats, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfIndex=ospfIntfIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfArea=ospfArea, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ripNewCfgVip=ripNewCfgVip, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumRxHello=ospfCumRxHello, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgIntfIndex=ipCurCfgIntfIndex, routerLSAId=routerLSAId, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgGwArp=ipCurCfgGwArp, ipRouteInfoMask=ipRouteInfoMask, ospfIntfRxTxStats=ospfIntfRxTxStats, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfChangeStats=ospfIntfChangeStats, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfDown=ospfIntfDown, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumNbrRstAd=ospfCumNbrRstAd, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaInfoTable=ospfAreaInfoTable, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, routerLSALinkID=routerLSALinkID, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfVlinkCountForRouter=ospfVlinkCountForRouter, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfStats=ospfStats, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumIntfHello=ospfCumIntfHello, routerLSAAreaIndex=routerLSAAreaIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumNbrhello=ospfCumNbrhello, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgIntfIndex=ipNewCfgIntfIndex, arpStatHighWater=arpStatHighWater, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfNbrInFullState=ospfNbrInFullState, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, iprouting=iprouting, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpGeneral=vrrpGeneral, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgGwState=ipNewCfgGwState, ospfCumRxPkts=ospfCumRxPkts, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfGeneralInfo=ospfGeneralInfo, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumNbrStart=ospfCumNbrStart, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgGwDelete=ipNewCfgGwDelete, ripNewCfgSupply=ripNewCfgSupply, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ip_info=ip_info, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaChangeStats=ospfAreaChangeStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipRouteInfoGateway=ipRouteInfoGateway, vrrp=vrrp, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfProcessUptime=ospfProcessUptime, vrrp_info=vrrp_info, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaRxHello=ospfAreaRxHello, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipFwdCurCfgState=ipFwdCurCfgState, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, arpInfoDestIp=arpInfoDestIp, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpOper=vrrpOper, arpStatMaxEntries=arpStatMaxEntries, ipForward=ipForward, routerLSALinkIndex=routerLSALinkIndex, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, routeStatMaxEntries=routeStatMaxEntries, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfNbrStart=ospfIntfNbrStart, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ripStatInPkts=ripStatInPkts, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumIntfDown=ospfCumIntfDown, ospfNbrInInitState=ospfNbrInInitState, ospfIntfTxHello=ospfIntfTxHello, arpInfoVLAN=arpInfoVLAN, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgGenState=vrrpNewCfgGenState, routeStats=routeStats, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumTxlsReqs=ospfCumTxlsReqs, ipGatewayTableMax=ipGatewayTableMax, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfTotalNssaAreas=ospfTotalNssaAreas, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfGeneral=ospfGeneral, ripCurCfgListen=ripCurCfgListen, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, arpInfoMacAddr=arpInfoMacAddr, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ripCurCfgSupply=ripCurCfgSupply, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfinfo=ospfinfo, ospfAreaTxPkts=ospfAreaTxPkts, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, dnsStats=dnsStats, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgGwEntry=ipNewCfgGwEntry, ripConfig=ripConfig, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfGeneralStats=ospfGeneralStats, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumTxHello=ospfCumTxHello, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaInfoId=ospfAreaInfoId, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfNewCfgAreaId=ospfNewCfgAreaId, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripStatInErrorPkts=ripStatInErrorPkts, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfInterface=ospfInterface, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfRxHello=ospfIntfRxHello, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgIntfState=ipNewCfgIntfState, ripStats=ripStats, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfNbrInExchState=ospfNbrInExchState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, routeStatHighWater=routeStatHighWater, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpStats=vrrpStats, ripStatOutPkts=ripStatOutPkts, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfBackup=ospfIntfBackup, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfLoop=ospfIntfLoop, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaRxPkts=ospfAreaRxPkts, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfNbrChange=ospfIntfNbrChange, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfNbrIndex=ospfIntfNbrIndex, ripNewCfgState=ripNewCfgState, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfStartTime=ospfStartTime, routeStatEntries=routeStatEntries, ospfIfInfoIndex=ospfIfInfoIndex, arpInfoEntry=arpInfoEntry, ripNewCfgListen=ripNewCfgListen, ripCurCfgVip=ripCurCfgVip, ospfTotalAreas=ospfTotalAreas, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgGwRetry=ipCurCfgGwRetry, ripCurCfgState=ripCurCfgState, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID)
