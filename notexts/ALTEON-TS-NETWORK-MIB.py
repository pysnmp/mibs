...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfTxHello=ospfIntfTxHello, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfDown=ospfIntfDown, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCumRxPkts=ospfCumRxPkts, ripNewCfgListen=ripNewCfgListen, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, routeStatMaxEntries=routeStatMaxEntries, ospfAreaIntfHello=ospfAreaIntfHello, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgBootpState=ipNewCfgBootpState, ripCurCfgState=ripCurCfgState, ospfIntfRxHello=ospfIntfRxHello, ospfTmrsKckOffHello=ospfTmrsKckOffHello, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumTxPkts=ospfCumTxPkts, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfRxTxStats=ospfIntfRxTxStats, routeStatEntries=routeStatEntries, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumTxHello=ospfCumTxHello, ospfAreaIntfDown=ospfAreaIntfDown, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, arpStats=arpStats, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipRouteInfoGateway=ipRouteInfoGateway, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfStartTime=ospfStartTime, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ripNewCfgVip=ripNewCfgVip, ospfAreaInfoId=ospfAreaInfoId, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, routerLSALinkIndex=routerLSALinkIndex, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfIndex=ospfIntfIndex, ospfIntfUnloop=ospfIntfUnloop, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaIntfIndex=ospfAreaIntfIndex, ripStatOutPkts=ripStatOutPkts, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaNbrStart=ospfAreaNbrStart, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumNbrDown=ospfCumNbrDown, arpInfoSrcPort=arpInfoSrcPort, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ripStatInPkts=ripStatInPkts, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, arpStatEntries=arpStatEntries, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfStats=ospfStats, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfNbrInInitState=ospfNbrInInitState, ospfNbrInFullState=ospfNbrInFullState, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumRxHello=ospfCumRxHello, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfBackup=ospfIntfBackup, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfInterface=ospfInterface, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, iprouting=iprouting, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, arpInfoDestIp=arpInfoDestIp, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipRouteInfoIndx=ipRouteInfoIndx, ospfGeneralStats=ospfGeneralStats, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, arpInfoRefPorts=arpInfoRefPorts, ip_info=ip_info, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, routerLSALinkData=routerLSALinkData, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrp_info=vrrp_info, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpOper=vrrpOper, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumRxTxStats=ospfCumRxTxStats, vrrp=vrrp, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, dnsStats=dnsStats, ripCurCfgSupply=ripCurCfgSupply, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumTxDatabase=ospfCumTxDatabase, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripStatInErrorPkts=ripStatInErrorPkts, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfTotalAreas=ospfTotalAreas, ospfProcessUptime=ospfProcessUptime, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumNbrStart=ospfCumNbrStart, ospfIfInfoIndex=ospfIfInfoIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ripNewCfgDefListen=ripNewCfgDefListen, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfArea=ospfArea, ipForward=ipForward, ospfNbrInExchState=ospfNbrInExchState, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumIntfHello=ospfCumIntfHello, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaRxPkts=ospfAreaRxPkts, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdNewCfgState=ipFwdNewCfgState, arpInfoFlag=arpInfoFlag, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpStats=vrrpStats, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipCurCfgGwArp=ipCurCfgGwArp, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfinfo=ospfinfo, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipRouteInfoTag=ipRouteInfoTag, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipGatewayTableMax=ipGatewayTableMax, arpInfoVLAN=arpInfoVLAN, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, arpInfoTable=arpInfoTable, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgGwEntry=ipCurCfgGwEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfLoop=ospfIntfLoop, ipCurCfgGwInterval=ipCurCfgGwInterval, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ripStats=ripStats, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfTableMaxSize=ospfIntfTableMaxSize, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaRxTxStats=ospfAreaRxTxStats, ipRouteInfoTable=ipRouteInfoTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipRouteInfoInterface=ipRouteInfoInterface, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, arpInfoMacAddr=arpInfoMacAddr, ripConfig=ripConfig, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, routerLSALinkID=routerLSALinkID, vrrpStatInAdvers=vrrpStatInAdvers, routeStats=routeStats, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipRouteInfoType=ipRouteInfoType, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, routeStatHighWater=routeStatHighWater, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipCurCfgGwIndex=ipCurCfgGwIndex, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumNbrhello=ospfCumNbrhello, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgGwState=ipNewCfgGwState, ospfIntfNbrChange=ospfIntfNbrChange, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCfg=ospfCfg, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfGeneralInfo=ospfGeneralInfo, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex)
