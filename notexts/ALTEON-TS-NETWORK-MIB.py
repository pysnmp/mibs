...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIfWaitInterval=ospfIfWaitInterval, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpOper=vrrpOper, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, arpStatHighWater=arpStatHighWater, ripNewCfgSupply=ripNewCfgSupply, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumRxPkts=ospfCumRxPkts, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumRxHello=ospfCumRxHello, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaChangeStats=ospfAreaChangeStats, routerLSALinkData=routerLSALinkData, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrp_info=vrrp_info, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfTxPkts=ospfIntfTxPkts, vrrpGeneral=vrrpGeneral, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCfg=ospfCfg, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ripNewCfgState=ripNewCfgState, arpStats=arpStats, arpInfoMacAddr=arpInfoMacAddr, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, arpStatMaxEntries=arpStatMaxEntries, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ripConfig=ripConfig, routerLSAId=routerLSAId, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgGwState=ipNewCfgGwState, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, routerLSALinkIndex=routerLSALinkIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, routeStatMaxEntries=routeStatMaxEntries, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgGwState=ipCurCfgGwState, ospfNbrInExchState=ospfNbrInExchState, ripStatOutPkts=ripStatOutPkts, ipNewCfgGwRetry=ipNewCfgGwRetry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipRouteInfoMask=ipRouteInfoMask, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfNbrN1way=ospfIntfNbrN1way, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, routeStatHighWater=routeStatHighWater, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfStartTime=ospfStartTime, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, arpInfoSrcPort=arpInfoSrcPort, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfinfo=ospfinfo, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumNbrStart=ospfCumNbrStart, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipCurCfgGwVlan=ipCurCfgGwVlan, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfNewCfgAreaId=ospfNewCfgAreaId, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrp=vrrp, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfTxHello=ospfIntfTxHello, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfRxHello=ospfIntfRxHello, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipRouteInfoGateway=ipRouteInfoGateway, ospfArea=ospfArea, ripNewCfgVip=ripNewCfgVip, ospfTotalAreas=ospfTotalAreas, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaNbrStart=ospfAreaNbrStart, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, arpInfoTable=arpInfoTable, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, arpInfoVLAN=arpInfoVLAN, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ripCurCfgDefListen=ripCurCfgDefListen, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipRouteInfoDestIp=ipRouteInfoDestIp, routeStatEntries=routeStatEntries, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, routerLSALinkID=routerLSALinkID, ipNewCfgGwArp=ipNewCfgGwArp, ospfIfInfoIndex=ospfIfInfoIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfGeneral=ospfGeneral, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ripStatInPkts=ripStatInPkts, ospfTotalTransitAreas=ospfTotalTransitAreas, iprouting=iprouting, ospfAreaTxHello=ospfAreaTxHello, ospfCumRxDatabase=ospfCumRxDatabase)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripNewCfgDefListen=ripNewCfgDefListen, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipRouteInfoType=ipRouteInfoType, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfRxTxStats=ospfIntfRxTxStats, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ripStats=ripStats, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpStats=vrrpStats, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfInterface=ospfInterface, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgBootpState=ipCurCfgBootpState, ipRouteInfoInterface=ipRouteInfoInterface, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumTxDatabase=ospfCumTxDatabase, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfUnloop=ospfIntfUnloop, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipRouteInfoIndx=ipRouteInfoIndx, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipForward=ipForward, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpStatInAdvers=vrrpStatInAdvers, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfRxDatabase=ospfIntfRxDatabase, dnsStats=dnsStats, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfNbrChange=ospfIntfNbrChange, routeStats=routeStats, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfStats=ospfStats, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ripCurCfgListen=ripCurCfgListen, ipFwdNewCfgState=ipFwdNewCfgState, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumNbrN1way=ospfCumNbrN1way, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumTxHello=ospfCumTxHello, ospfGeneralInfo=ospfGeneralInfo, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, arpStatEntries=arpStatEntries, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ip_info=ip_info, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaInfoId=ospfAreaInfoId, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, arpInfoEntry=arpInfoEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumIntfDown=ospfCumIntfDown, ospfIntfIndex=ospfIntfIndex, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgIntfMask=ipNewCfgIntfMask, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipInterfaceTableMax=ipInterfaceTableMax)
