...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfTotalNeighbours=ospfTotalNeighbours, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipRouteInfoMask=ipRouteInfoMask, ospfIntfInfoEntry=ospfIntfInfoEntry, ipRouteInfoIndx=ipRouteInfoIndx, ipRouteInfoDestIp=ipRouteInfoDestIp, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, iprouting=iprouting, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCumRxDatabase=ospfCumRxDatabase, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfGeneralInfo=ospfGeneralInfo, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, arpStatHighWater=arpStatHighWater, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfRxPkts=ospfIntfRxPkts, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipCurCfgGwState=ipCurCfgGwState, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaInfoTable=ospfAreaInfoTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfRxTxStats=ospfIntfRxTxStats, ipForward=ipForward, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfHello=ospfIntfHello, ospfNbrInExchState=ospfNbrInExchState, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ripNewCfgVip=ripNewCfgVip, ospfCumTxHello=ospfCumTxHello, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ripCurCfgState=ripCurCfgState, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumTxPkts=ospfCumTxPkts, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, routerLSALinkData=routerLSALinkData, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpStatOutAdvers=vrrpStatOutAdvers, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumIntfLoop=ospfCumIntfLoop, ripNewCfgListen=ripNewCfgListen, ospfIntfNbrhello=ospfIntfNbrhello, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfUnloop=ospfIntfUnloop, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, routeStatHighWater=routeStatHighWater, ospfIntfCountForRouter=ospfIntfCountForRouter, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ripConfig=ripConfig, ospfIntfTxlsReqs=ospfIntfTxlsReqs, routerLSALinkIndex=routerLSALinkIndex, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, routeStatMaxEntries=routeStatMaxEntries, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ip_info=ip_info, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfNbrStart=ospfIntfNbrStart, ospfProcessUptime=ospfProcessUptime, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaRxlsReqs=ospfAreaRxlsReqs, dnsStats=dnsStats, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumIntfDown=ospfCumIntfDown, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfDown=ospfIntfDown, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgIntfTable=ipCurCfgIntfTable, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaChangeStats=ospfAreaChangeStats, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ripStatOutPkts=ripStatOutPkts, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCumRxHello=ospfCumRxHello, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ripCurCfgVip=ripCurCfgVip, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfBackup=ospfIntfBackup, ipRouteInfoTable=ipRouteInfoTable, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfNbrChange=ospfIntfNbrChange, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfStartTime=ospfStartTime, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, arpInfoMacAddr=arpInfoMacAddr)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, routeStats=routeStats, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaInfoId=ospfAreaInfoId, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipCurCfgIntfState=ipCurCfgIntfState, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumIntfHello=ospfCumIntfHello, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, arpStatMaxEntries=arpStatMaxEntries, ospfGeneral=ospfGeneral, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ripStatInPkts=ripStatInPkts, ospfAreaRxTxStats=ospfAreaRxTxStats, routeStatEntries=routeStatEntries, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipRouteInfoType=ipRouteInfoType, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgBootpState=ipNewCfgBootpState, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrp_info=vrrp_info, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfInterface=ospfInterface, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaNbrhello=ospfAreaNbrhello, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgGenState=vrrpNewCfgGenState, ripStats=ripStats, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaTxHello=ospfAreaTxHello, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfTxHello=ospfIntfTxHello, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipCurCfgGwIndex=ipCurCfgGwIndex, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaNbrDown=ospfAreaNbrDown, vrrpGeneral=vrrpGeneral, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaTxPkts=ospfAreaTxPkts, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfNbrInFullState=ospfNbrInFullState, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCumRxTxStats=ospfCumRxTxStats, ospfCfg=ospfCfg, ospfGeneralStats=ospfGeneralStats, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfArea=ospfArea, ospfIntfLoop=ospfIntfLoop, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ripCurCfgListen=ripCurCfgListen, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumNbrStart=ospfCumNbrStart, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumNbrRstAd=ospfCumNbrRstAd, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumNbrDown=ospfCumNbrDown, ospfCumTxDatabase=ospfCumTxDatabase, arpStats=arpStats, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfinfo=ospfinfo, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, routerLSAId=routerLSAId, arpInfoFlag=arpInfoFlag, routerLSALinkID=routerLSALinkID, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgGwVlan=ipNewCfgGwVlan, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpStats=vrrpStats, ospfAreaNbrStart=ospfAreaNbrStart, vrrp=vrrp, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, arpStatEntries=arpStatEntries, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfStats=ospfStats, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgGwEntry=ipNewCfgGwEntry, ipRouteInfoEntry=ipRouteInfoEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics)
