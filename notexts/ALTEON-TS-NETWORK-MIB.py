...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfRxHello=ospfIntfRxHello, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, routeStats=routeStats, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfDown=ospfIntfDown, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, dnsStats=dnsStats, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaNbrDown=ospfAreaNbrDown, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ip_info=ip_info, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ripCurCfgVip=ripCurCfgVip, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, arpInfoTable=arpInfoTable, ospfIntfIndex=ospfIntfIndex, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfNbrChange=ospfIntfNbrChange, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCfg=ospfCfg, ospfAreaTxlsReqs=ospfAreaTxlsReqs, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgGwTable=ipNewCfgGwTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, arpInfoEntry=arpInfoEntry, routeStatMaxEntries=routeStatMaxEntries, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfStartTime=ospfStartTime, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipInterfaceTableMax=ipInterfaceTableMax, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, arpInfoSrcPort=arpInfoSrcPort, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgIntfTable=ipCurCfgIntfTable, arpInfoVLAN=arpInfoVLAN, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfStats=ospfStats, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfHello=ospfIntfHello, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ripNewCfgState=ripNewCfgState, ospfIntfBackup=ospfIntfBackup, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfGeneralStats=ospfGeneralStats, ospfCumRxHello=ospfCumRxHello, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfUnloop=ospfIntfUnloop, arpStatEntries=arpStatEntries, routerLSAId=routerLSAId, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ripStatInPkts=ripStatInPkts, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpStats=vrrpStats, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgBootpState=ipNewCfgBootpState, ripStats=ripStats, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrp_info=vrrp_info, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaRxlsReqs=ospfAreaRxlsReqs, routeStatEntries=routeStatEntries, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, routeStatHighWater=routeStatHighWater, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaInfoId=ospfAreaInfoId, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgGwRetry=ipNewCfgGwRetry, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipRouteInfoTag=ipRouteInfoTag, ripCurCfgListen=ripCurCfgListen, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfProcessUptime=ospfProcessUptime, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, arpInfoMacAddr=arpInfoMacAddr, ospfAreaIntfIndex=ospfAreaIntfIndex, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ripNewCfgVip=ripNewCfgVip, ospfIntfTxHello=ospfIntfTxHello, vrrpOper=vrrpOper, arpInfoFlag=arpInfoFlag, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfNbrDown=ospfIntfNbrDown, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaRxPkts=ospfAreaRxPkts, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumIntfNbrChange=ospfCumIntfNbrChange, arpStats=arpStats, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgIntfEntry=ipCurCfgIntfEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, iprouting=iprouting, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipRouteInfoType=ipRouteInfoType, ospfAreaNbrN1way=ospfAreaNbrN1way, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaIntfBackup=ospfAreaIntfBackup, ripConfig=ripConfig, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrp=vrrp, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipForward=ipForward, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgGwState=ipNewCfgGwState, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumTxPkts=ospfCumTxPkts, ripNewCfgListen=ripNewCfgListen, ospfArea=ospfArea, ipNewCfgGwInterval=ipNewCfgGwInterval, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfNbrInFullState=ospfNbrInFullState, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfLoop=ospfIntfLoop, ospfCumRxTxStats=ospfCumRxTxStats, ripCurCfgState=ripCurCfgState, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCumTxDatabase=ospfCumTxDatabase, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaIntfHello=ospfAreaIntfHello, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumIntfHello=ospfCumIntfHello, ospfAreaChangeStats=ospfAreaChangeStats, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumTxHello=ospfCumTxHello, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumNbrhello=ospfCumNbrhello, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfChangeStats=ospfIntfChangeStats, ospfCurCfgAreaId=ospfCurCfgAreaId, routerLSALinkIndex=routerLSALinkIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumNbrDown=ospfCumNbrDown, routerLSALinkData=routerLSALinkData, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, arpStatHighWater=arpStatHighWater, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgGwInterval=ipCurCfgGwInterval, ipRouteInfoTable=ipRouteInfoTable, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaNbrhello=ospfAreaNbrhello, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumIntfDown=ospfCumIntfDown, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ripNewCfgDefListen=ripNewCfgDefListen, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfInfoTable=ospfIntfInfoTable, ospfinfo=ospfinfo, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpStatInAdvers=vrrpStatInAdvers, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask)
