...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaIntfHello=ospfAreaIntfHello, ripNewCfgState=ripNewCfgState, ospfCumTxHello=ospfCumTxHello, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfRxHello=ospfIntfRxHello, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgGwRetry=ipCurCfgGwRetry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfNbrInFullState=ospfNbrInFullState, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfTxPkts=ospfIntfTxPkts, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipRouteInfoTag=ipRouteInfoTag, ospfIntfDown=ospfIntfDown, ospfAreaTxDatabase=ospfAreaTxDatabase, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaRxHello=ospfAreaRxHello, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumNbrhello=ospfCumNbrhello, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfTxHello=ospfIntfTxHello, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrp=vrrp, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumNbrStart=ospfCumNbrStart, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfTxDatabase=ospfIntfTxDatabase, ripStatInPkts=ripStatInPkts, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfinfo=ospfinfo, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgIntfMask=ipNewCfgIntfMask, arpStatHighWater=arpStatHighWater, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipInterfaceTableMax=ipInterfaceTableMax, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, arpStats=arpStats, ripNewCfgSupply=ripNewCfgSupply, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpOper=vrrpOper, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpStats=vrrpStats, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, arpInfoMacAddr=arpInfoMacAddr, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfNbrDown=ospfIntfNbrDown, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIfInfoIndex=ospfIfInfoIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, routerLSALinkID=routerLSALinkID, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, iprouting=iprouting, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, routerLSALinkData=routerLSALinkData, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCfg=ospfCfg, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgGwState=ipNewCfgGwState, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipForward=ipForward, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumIntfHello=ospfCumIntfHello, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumTxlsAcks=ospfCumTxlsAcks, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, routerLSALinkIndex=routerLSALinkIndex, ospfIntfLoop=ospfIntfLoop, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumIntfDown=ospfCumIntfDown, ripStatOutPkts=ripStatOutPkts, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, ipRouteInfoGateway=ipRouteInfoGateway, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, routeStatMaxEntries=routeStatMaxEntries, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrp_info=vrrp_info, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumRxPkts=ospfCumRxPkts, ipCurCfgGwIndex=ipCurCfgGwIndex, ripStats=ripStats, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipCurCfgGwArp=ipCurCfgGwArp, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfTotalNeighbours=ospfTotalNeighbours, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfTotalNssaAreas=ospfTotalNssaAreas, routeStats=routeStats, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaRxDatabase=ospfAreaRxDatabase, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfArea=ospfArea)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpStatInAdvers=vrrpStatInAdvers, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumTxlsUpdates=ospfCumTxlsUpdates, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipRouteInfoType=ipRouteInfoType, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfHello=ospfIntfHello, dnsStats=dnsStats, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, arpStatEntries=arpStatEntries, ripNewCfgListen=ripNewCfgListen, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfGeneralStats=ospfGeneralStats, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ripCurCfgState=ripCurCfgState, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipRouteInfoIndx=ipRouteInfoIndx, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfInterface=ospfInterface, ospfIntfRxTxStats=ospfIntfRxTxStats, arpInfoTable=arpInfoTable, ipCurCfgGwAddr=ipCurCfgGwAddr, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfUnloop=ospfIntfUnloop, arpInfoVLAN=arpInfoVLAN, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgBootpState=ipNewCfgBootpState, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipRouteInfoTable=ipRouteInfoTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaChangeStats=ospfAreaChangeStats, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgGwArp=ipNewCfgGwArp, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaNbrhello=ospfAreaNbrhello, ripConfig=ripConfig, ospfProcessUptime=ospfProcessUptime, ripCurCfgVip=ripCurCfgVip, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfIndex=ospfIntfIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfNbrChange=ospfIntfNbrChange, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ripCurCfgListen=ripCurCfgListen, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipRouteInfoMask=ipRouteInfoMask, ospfCumRxDatabase=ospfCumRxDatabase, routerLSAId=routerLSAId, ospfStartTime=ospfStartTime, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, arpInfoSrcPort=arpInfoSrcPort, ospfGeneral=ospfGeneral, ip_info=ip_info, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfStats=ospfStats, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumTxPkts=ospfCumTxPkts, ospfNbrInInitState=ospfNbrInInitState, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgBootpAddr=ipNewCfgBootpAddr, arpStatMaxEntries=arpStatMaxEntries, vrrpGeneral=vrrpGeneral, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, routeStatHighWater=routeStatHighWater, ipCurCfgIntfTable=ipCurCfgIntfTable, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfWaitTimer=ospfIntfWaitTimer, routeStatEntries=routeStatEntries, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumNbrN1way=ospfCumNbrN1way, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfTotalAreas=ospfTotalAreas, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfGeneralInfo=ospfGeneralInfo, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc)
