...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumNbrRstAd=ospfCumNbrRstAd, arpStats=arpStats, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumIntfHello=ospfCumIntfHello, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ripCurCfgListen=ripCurCfgListen, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrp_info=vrrp_info, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfTotalTransitAreas=ospfTotalTransitAreas, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipRouteInfoIndx=ipRouteInfoIndx, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ripNewCfgSupply=ripNewCfgSupply, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, arpInfoEntry=arpInfoEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfTxHello=ospfIntfTxHello, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipCurCfgGwState=ipCurCfgGwState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfGeneralInfo=ospfGeneralInfo, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdCurCfgState=ipFwdCurCfgState, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfNbrStart=ospfIntfNbrStart, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, arpStatEntries=arpStatEntries, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumIntfBackup=ospfCumIntfBackup, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipRouteInfoTag=ipRouteInfoTag, ospfNbrInFullState=ospfNbrInFullState, ospfCumRxDatabase=ospfCumRxDatabase, iprouting=iprouting, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfTotalNeighbours=ospfTotalNeighbours, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIfWaitInterval=ospfIfWaitInterval, ripStatOutPkts=ripStatOutPkts, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaTxHello=ospfAreaTxHello, dnsStats=dnsStats, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgGwIndex=ipCurCfgGwIndex, ripConfig=ripConfig, ipCurCfgBootpState=ipCurCfgBootpState, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgIntfMask=ipCurCfgIntfMask, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfLoop=ospfIntfLoop, ripCurCfgState=ripCurCfgState, ospfAreaIntfBackup=ospfAreaIntfBackup, routerLSALinkID=routerLSALinkID, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfNbrInExchState=ospfNbrInExchState, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumNbrN1way=ospfCumNbrN1way, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, routeStatMaxEntries=routeStatMaxEntries, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipRouteInfoGateway=ipRouteInfoGateway, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfNbrInInitState=ospfNbrInInitState, ospfIntfIndex=ospfIntfIndex, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfArea=ospfArea, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumNbrStart=ospfCumNbrStart, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfRxHello=ospfIntfRxHello, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaInfoTable=ospfAreaInfoTable, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfHello=ospfIntfHello, ipCurCfgIntfState=ipCurCfgIntfState, ospfInterface=ospfInterface, ipCurCfgGwAddr=ipCurCfgGwAddr, ipRouteInfoTable=ipRouteInfoTable, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgGwVlan=ipNewCfgGwVlan, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfTotalAreas=ospfTotalAreas, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaIntfDown=ospfAreaIntfDown, ripStats=ripStats, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaNbrStart=ospfAreaNbrStart, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumTxPkts=ospfCumTxPkts, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipRouteInfoEntry=ipRouteInfoEntry, ipRouteInfoMask=ipRouteInfoMask, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, routeStats=routeStats, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrp=vrrp, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ripCurCfgDefListen=ripCurCfgDefListen, ospfProcessUptime=ospfProcessUptime, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, arpStatHighWater=arpStatHighWater, routeStatHighWater=routeStatHighWater, ospfGeneral=ospfGeneral, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfNbrDown=ospfIntfNbrDown, ripStatInPkts=ripStatInPkts, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfTimersKickOffStats=ospfTimersKickOffStats, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpStatInAdvers=vrrpStatInAdvers, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgGwState=ipNewCfgGwState, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumIntfDown=ospfCumIntfDown, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpOper=vrrpOper, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfStats=ospfStats, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumNbrDown=ospfCumNbrDown, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfUnloop=ospfIntfUnloop, ip_info=ip_info, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, routerLSALinkData=routerLSALinkData, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgIntfAddr=ipNewCfgIntfAddr, arpInfoTable=arpInfoTable, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, arpInfoFlag=arpInfoFlag, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfNbrChange=ospfIntfNbrChange, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumRxHello=ospfCumRxHello, ospfCumRxPkts=ospfCumRxPkts, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipForward=ipForward, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCumTxDatabase=ospfCumTxDatabase, arpInfoVLAN=arpInfoVLAN, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipRouteInfoType=ipRouteInfoType, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipInterfaceTableMax=ipInterfaceTableMax, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfStartTime=ospfStartTime, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfinfo=ospfinfo, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaRxDatabase=ospfAreaRxDatabase, ripNewCfgListen=ripNewCfgListen, ospfCumTxHello=ospfCumTxHello, ipNewCfgBootpState=ipNewCfgBootpState, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, routerLSALinkIndex=routerLSALinkIndex, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumNbrhello=ospfCumNbrhello, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ripNewCfgDefListen=ripNewCfgDefListen, vrrpStats=vrrpStats, ospfLsTypesSupported=ospfLsTypesSupported, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaTxDatabase=ospfAreaTxDatabase, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, routeStatEntries=routeStatEntries, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaRxHello=ospfAreaRxHello)
