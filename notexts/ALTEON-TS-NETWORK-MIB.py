...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipRouteInfoDestIp=ipRouteInfoDestIp, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumNbrDown=ospfCumNbrDown, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ripCurCfgListen=ripCurCfgListen, ipNewCfgGwTable=ipNewCfgGwTable, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaTxHello=ospfAreaTxHello, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ip_info=ip_info, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumNbrhello=ospfCumNbrhello, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfTxHello=ospfIntfTxHello, ospfGeneral=ospfGeneral, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpStatOutAdvers=vrrpStatOutAdvers, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfTxDatabase=ospfIntfTxDatabase, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaRxlsAcks=ospfAreaRxlsAcks, arpInfoDestIp=arpInfoDestIp, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ripStats=ripStats, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaNbrStart=ospfAreaNbrStart, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfStats=ospfStats, arpInfoMacAddr=arpInfoMacAddr, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpOper=vrrpOper, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, routeStatMaxEntries=routeStatMaxEntries, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfLoop=ospfIntfLoop, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfGeneralStats=ospfGeneralStats, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ripNewCfgListen=ripNewCfgListen, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfArea=ospfArea, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipRouteInfoMask=ipRouteInfoMask, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfNbrInExchState=ospfNbrInExchState, ospfIntfRxHello=ospfIntfRxHello, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipRouteInfoType=ipRouteInfoType, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaRxHello=ospfAreaRxHello, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrp=vrrp, ipCurCfgGwEntry=ipCurCfgGwEntry, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipNewCfgGwState=ipNewCfgGwState, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfTxPkts=ospfIntfTxPkts, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripStatOutPkts=ripStatOutPkts, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipRouteInfoTable=ipRouteInfoTable, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumTxPkts=ospfCumTxPkts, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumTxDatabase=ospfCumTxDatabase, ospfNbrInInitState=ospfNbrInInitState, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfRxPkts=ospfIntfRxPkts, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumIntfDown=ospfCumIntfDown, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfInfoTable=ospfIntfInfoTable, ipInterfaceTableMax=ipInterfaceTableMax, ripNewCfgState=ripNewCfgState, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, routerLSAId=routerLSAId, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfStartTime=ospfStartTime, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpStatInAdvers=vrrpStatInAdvers, vrrpStats=vrrpStats, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripNewCfgSupply=ripNewCfgSupply, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfIndex=ospfIntfIndex, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgGwRetry=ipNewCfgGwRetry, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, routeStatEntries=routeStatEntries, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfRxDatabase=ospfIntfRxDatabase, arpStatEntries=arpStatEntries, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgBootpState=ipCurCfgBootpState, ospfInterface=ospfInterface, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ripStatInPkts=ripStatInPkts, arpInfoEntry=arpInfoEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumRxHello=ospfCumRxHello, arpStatHighWater=arpStatHighWater, ospfAreaIntfLoop=ospfAreaIntfLoop, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ripCurCfgState=ripCurCfgState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumRxPkts=ospfCumRxPkts, ospfCfg=ospfCfg, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfNbrhello=ospfIntfNbrhello, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipRouteInfoIndx=ipRouteInfoIndx, vrrpGeneral=vrrpGeneral, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, routeStats=routeStats, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumNbrStart=ospfCumNbrStart, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgIntfMask=ipNewCfgIntfMask, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfTotalNeighbours=ospfTotalNeighbours, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgGwState=ipCurCfgGwState, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, arpInfoSrcPort=arpInfoSrcPort, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaInfoId=ospfAreaInfoId, arpInfoVLAN=arpInfoVLAN, ospfIntfHello=ospfIntfHello, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, routerLSALinkIndex=routerLSALinkIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfNbrChange=ospfIntfNbrChange, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaIntfIndex=ospfAreaIntfIndex, ripNewCfgVip=ripNewCfgVip, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, iprouting=iprouting, arpStats=arpStats, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaIntfDown=ospfAreaIntfDown, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipForward=ipForward, routerLSALinkID=routerLSALinkID, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ripCurCfgVip=ripCurCfgVip, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfNbrInFullState=ospfNbrInFullState, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, arpStatMaxEntries=arpStatMaxEntries, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgGwDelete=ipNewCfgGwDelete, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfinfo=ospfinfo, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgIntfState=ipCurCfgIntfState, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfProcessUptime=ospfProcessUptime, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ripConfig=ripConfig, dnsStats=dnsStats, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, arpInfoTable=arpInfoTable, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipRouteInfoTag=ipRouteInfoTag, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfDown=ospfIntfDown, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrp_info=vrrp_info, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, arpInfoFlag=arpInfoFlag, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port)
