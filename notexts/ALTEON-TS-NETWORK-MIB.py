...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaIntfLoop=ospfAreaIntfLoop, routerLSALinkData=routerLSALinkData, ospfIntfRxHello=ospfIntfRxHello, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, arpStats=arpStats, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfNbrInFullState=ospfNbrInFullState, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfChangeStats=ospfIntfChangeStats, ipRouteInfoType=ipRouteInfoType, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ripStatOutPkts=ripStatOutPkts, routeStatHighWater=routeStatHighWater, vrrp_info=vrrp_info, ripNewCfgDefListen=ripNewCfgDefListen, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, arpStatHighWater=arpStatHighWater, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipNewCfgGwMetric=ipNewCfgGwMetric, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIfWaitInterval=ospfIfWaitInterval, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ripNewCfgSupply=ripNewCfgSupply, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumNbrDown=ospfCumNbrDown, routerLSAId=routerLSAId, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgGenState=vrrpCurCfgGenState, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipRouteInfoGateway=ipRouteInfoGateway, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgGwTable=ipCurCfgGwTable, iprouting=iprouting, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgGwDelete=ipNewCfgGwDelete, arpInfoRefPorts=arpInfoRefPorts, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaNbrDown=ospfAreaNbrDown, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumRxPkts=ospfCumRxPkts, vrrpStatInAdvers=vrrpStatInAdvers, dnsStats=dnsStats, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfStats=ospfStats, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ripNewCfgState=ripNewCfgState, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ripCurCfgListen=ripCurCfgListen, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfIndex=ospfIntfIndex, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipForward=ipForward, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ripCurCfgVip=ripCurCfgVip, ospfNbrInInitState=ospfNbrInInitState, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfStartTime=ospfStartTime, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, arpInfoSrcPort=arpInfoSrcPort, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgGenState=vrrpNewCfgGenState, ipCurCfgIntfState=ipCurCfgIntfState, ospfProcessUptime=ospfProcessUptime, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ripNewCfgListen=ripNewCfgListen, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumNbrBadRequests=ospfCumNbrBadRequests, routerLSAAreaIndex=routerLSAAreaIndex, ripConfig=ripConfig, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfLsTypesSupported=ospfLsTypesSupported, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ripCurCfgSupply=ripCurCfgSupply, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpOper=vrrpOper, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpIfTableMaxSize=vrrpIfTableMaxSize, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaInfoId=ospfAreaInfoId, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ripCurCfgState=ripCurCfgState, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgGwAddr=ipNewCfgGwAddr, ipRouteInfoTable=ipRouteInfoTable, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfInfoTable=ospfIntfInfoTable, ospfTotalAreas=ospfTotalAreas, ipCurCfgGwEntry=ipCurCfgGwEntry, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgGwState=ipCurCfgGwState, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfGeneralStats=ospfGeneralStats, ipCurCfgGwIndex=ipCurCfgGwIndex, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaRxTxIndex=ospfAreaRxTxIndex)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipGatewayTableMax=ipGatewayTableMax, ipRouteInfoMask=ipRouteInfoMask, arpInfoFlag=arpInfoFlag, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdCurCfgState=ipFwdCurCfgState, ripStats=ripStats, ospfIntfUnloop=ospfIntfUnloop, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipRouteInfoInterface=ipRouteInfoInterface, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, routeStatMaxEntries=routeStatMaxEntries, vrrpStats=vrrpStats, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpGeneral=vrrpGeneral, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfHello=ospfIntfHello, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfinfo=ospfinfo, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfWaitTimer=ospfIntfWaitTimer, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIfInfoIndex=ospfIfInfoIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumNbrhello=ospfCumNbrhello, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgGwArp=ipNewCfgGwArp, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaNbrhello=ospfAreaNbrhello, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, routeStats=routeStats, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, arpStatEntries=arpStatEntries, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipInterfaceTableMax=ipInterfaceTableMax, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumRxTxStats=ospfCumRxTxStats, ospfArea=ospfArea, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripNewCfgVip=ripNewCfgVip, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipRouteInfoTag=ipRouteInfoTag, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgGwArp=ipCurCfgGwArp, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumRxHello=ospfCumRxHello, ospfAreaChangeStats=ospfAreaChangeStats, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgGwInterval=ipNewCfgGwInterval, routerLSALinkID=routerLSALinkID, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgIntfState=ipNewCfgIntfState, vrrp=vrrp, ip_info=ip_info, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumIntfDown=ospfCumIntfDown, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfGeneralInfo=ospfGeneralInfo, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfGeneral=ospfGeneral, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaRxHello=ospfAreaRxHello, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, routeStatEntries=routeStatEntries, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfInterface=ospfInterface, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumRxDatabase=ospfCumRxDatabase, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCfg=ospfCfg, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfDown=ospfIntfDown, ripStatInPkts=ripStatInPkts, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgGwTable=ipNewCfgGwTable, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumTxHello=ospfCumTxHello, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumNbrStart=ospfCumNbrStart, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfNbrInExchState=ospfNbrInExchState, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort)
