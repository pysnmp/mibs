...
Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, MibIdentifier, Integer32, TimeTicks, ObjectIdentity, Unsigned32, NotificationType, Gauge32, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "MibIdentifier", "Integer32", "TimeTicks", "ObjectIdentity", "Unsigned32", "NotificationType", "Gauge32", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpStatHighWater=arpStatHighWater, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, ripCurCfgState=ripCurCfgState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumNbrN1way=ospfCumNbrN1way, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfDown=ospfIntfDown, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipInterfaceTableMax=ipInterfaceTableMax, ipCurCfgIntfState=ipCurCfgIntfState, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgGwAddr=ipNewCfgGwAddr, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpOper=vrrpOper, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ripNewCfgListen=ripNewCfgListen, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripStatInPkts=ripStatInPkts, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrp=vrrp, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumIntfUnloop=ospfCumIntfUnloop, ripCurCfgListen=ripCurCfgListen, ripStatOutPkts=ripStatOutPkts, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, iprouting=iprouting, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, arpInfoSrcPort=arpInfoSrcPort, vrrpStats=vrrpStats, arpInfoFlag=arpInfoFlag, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, arpStats=arpStats, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaNbrIndex=ospfAreaNbrIndex, ipRouteInfoType=ipRouteInfoType, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgIntfIndex=ipCurCfgIntfIndex, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfRxHello=ospfIntfRxHello, ospfAreaIntfLoop=ospfAreaIntfLoop, routerLSAId=routerLSAId, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaTxHello=ospfAreaTxHello, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipNewCfgGwEntry=ipNewCfgGwEntry, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumNbrDown=ospfCumNbrDown, ospfNbrInFullState=ospfNbrInFullState, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaRxHello=ospfAreaRxHello, ripNewCfgVip=ripNewCfgVip, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ip_info=ip_info, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfStartTime=ospfStartTime, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, routeStatMaxEntries=routeStatMaxEntries, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfStats=ospfStats, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, arpStatMaxEntries=arpStatMaxEntries, vrrp_info=vrrp_info, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfinfo=ospfinfo, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumIntfLoop=ospfCumIntfLoop, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumRxHello=ospfCumRxHello, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaNbrhello=ospfAreaNbrhello, ripCurCfgVip=ripCurCfgVip, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, routeStats=routeStats, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCumIntfDown=ospfCumIntfDown, ospfNbrInExchState=ospfNbrInExchState, ospfIntfNbrDown=ospfIntfNbrDown)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, arpInfoEntry=arpInfoEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfLoop=ospfIntfLoop, dnsStats=dnsStats, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaIntfHello=ospfAreaIntfHello, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfHello=ospfIntfHello, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaNbrDown=ospfAreaNbrDown, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfUnloop=ospfIntfUnloop, arpInfoDestIp=arpInfoDestIp, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfBackup=ospfIntfBackup, ipNewCfgGwVlan=ipNewCfgGwVlan, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfTxlsAcks=ospfIntfTxlsAcks, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaInfoId=ospfAreaInfoId, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfTotalAreas=ospfTotalAreas, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumRxDatabase=ospfCumRxDatabase, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfArea=ospfArea, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaRxPkts=ospfAreaRxPkts, ospfNbrInInitState=ospfNbrInInitState, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgIntfState=ipNewCfgIntfState, vrrpGeneral=vrrpGeneral, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgBootpAddr=ipNewCfgBootpAddr, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfInterface=ospfInterface, ripNewCfgState=ripNewCfgState, ipRouteInfoTable=ipRouteInfoTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, arpStatEntries=arpStatEntries, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipForward=ipForward, ipCurCfgGwVlan=ipCurCfgGwVlan, ripStatInErrorPkts=ripStatInErrorPkts, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumRxPkts=ospfCumRxPkts, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumRxlsReqs=ospfCumRxlsReqs, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, routerLSALinkData=routerLSALinkData, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfGeneralInfo=ospfGeneralInfo, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ripConfig=ripConfig, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipRouteInfoTag=ipRouteInfoTag, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipRouteInfoDestIp=ipRouteInfoDestIp, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumIntfHello=ospfCumIntfHello, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ripStats=ripStats, routeStatHighWater=routeStatHighWater, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfTotalNeighbours=ospfTotalNeighbours, routerLSALinkIndex=routerLSALinkIndex, ospfIntfTxHello=ospfIntfTxHello, ospfCfg=ospfCfg)
