...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipGatewayTableMax=ipGatewayTableMax, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, routeStatEntries=routeStatEntries, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgIntfTable=ipNewCfgIntfTable, routerLSALinkData=routerLSALinkData, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipRouteInfoTable=ipRouteInfoTable, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfDown=ospfIntfDown, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfNbrInInitState=ospfNbrInInitState, dnsStats=dnsStats, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, arpStatMaxEntries=arpStatMaxEntries, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfGeneralStats=ospfGeneralStats, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, routeStats=routeStats, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfInfoTable=ospfIntfInfoTable, ospfTimersKickOffStats=ospfTimersKickOffStats, routerLSALinkID=routerLSALinkID, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumNbrStart=ospfCumNbrStart, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCfg=ospfCfg, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfRxHello=ospfIntfRxHello, arpInfoSrcPort=arpInfoSrcPort, ospfAreaRxHello=ospfAreaRxHello, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumTxHello=ospfCumTxHello, ripStatInPkts=ripStatInPkts, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ripConfig=ripConfig, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgIntfIndex=ipCurCfgIntfIndex, iprouting=iprouting, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, arpInfoVLAN=arpInfoVLAN, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumRxDatabase=ospfCumRxDatabase, ospfNewCfgAreaId=ospfNewCfgAreaId, arpInfoFlag=arpInfoFlag, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaInfoTable=ospfAreaInfoTable, ospfInterface=ospfInterface, routeStatHighWater=routeStatHighWater, ipRouteInfoType=ipRouteInfoType, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipRouteInfoIndx=ipRouteInfoIndx, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgGwTable=ipNewCfgGwTable, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfLoop=ospfIntfLoop, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfStartTime=ospfStartTime, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpStatInAdvers=vrrpStatInAdvers, arpStats=arpStats, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripNewCfgListen=ripNewCfgListen, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipCurCfgGwState=ipCurCfgGwState, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfIndex=ospfIntfIndex, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfNbrStart=ospfIntfNbrStart, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfUnloop=ospfIntfUnloop, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrp_info=vrrp_info, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCumNbrDown=ospfCumNbrDown, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ip_info=ip_info, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfNbrInExchState=ospfNbrInExchState, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumRxHello=ospfCumRxHello, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfTotalNeighbours=ospfTotalNeighbours, arpInfoRefPorts=arpInfoRefPorts)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrDown=ospfIntfNbrDown, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfTxPkts=ospfIntfTxPkts, vrrpOper=vrrpOper, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, routeStatMaxEntries=routeStatMaxEntries, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfTotalNssaAreas=ospfTotalNssaAreas, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, arpInfoEntry=arpInfoEntry, ospfCumTxDatabase=ospfCumTxDatabase, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdCurCfgState=ipFwdCurCfgState, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfBackup=ospfIntfBackup, ospfAreaInfoId=ospfAreaInfoId, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripStatOutPkts=ripStatOutPkts, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfTotalAreas=ospfTotalAreas, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, arpStatHighWater=arpStatHighWater, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfStats=ospfStats, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgGwRetry=ipCurCfgGwRetry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIfInfoIndex=ospfIfInfoIndex, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaIntfBackup=ospfAreaIntfBackup, ipRouteInfoGateway=ipRouteInfoGateway, ripStatInErrorPkts=ripStatInErrorPkts, ospfGeneral=ospfGeneral, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ripNewCfgSupply=ripNewCfgSupply, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfHello=ospfIntfHello, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrp=vrrp, ospfAreaRxTxStats=ospfAreaRxTxStats, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripStats=ripStats, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumTxPkts=ospfCumTxPkts, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumIntfDown=ospfCumIntfDown, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipFwdNewCfgPortState=ipFwdNewCfgPortState, routerLSAId=routerLSAId, ipForward=ipForward, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumRxTxStats=ospfCumRxTxStats, arpInfoMacAddr=arpInfoMacAddr, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ripNewCfgState=ripNewCfgState, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipRouteInfoMask=ipRouteInfoMask, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfinfo=ospfinfo, ospfAreaRxDatabase=ospfAreaRxDatabase, arpStatEntries=arpStatEntries, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfArea=ospfArea, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpStats=vrrpStats, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIfWaitInterval=ospfIfWaitInterval, ripCurCfgDefListen=ripCurCfgDefListen, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgGwState=ipNewCfgGwState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgGwArp=ipNewCfgGwArp, ipRouteInfoTag=ipRouteInfoTag, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority)
