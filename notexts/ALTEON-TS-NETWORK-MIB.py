...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumNbrStart=ospfCumNbrStart, ospfIntfNbrhello=ospfIntfNbrhello, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfNbrInFullState=ospfNbrInFullState, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfLsTypesSupported=ospfLsTypesSupported, ipRouteInfoMask=ipRouteInfoMask, routeStatMaxEntries=routeStatMaxEntries, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumIntfBackup=ospfCumIntfBackup, routeStats=routeStats, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, arpInfoVLAN=arpInfoVLAN, ip_info=ip_info, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, arpInfoFlag=arpInfoFlag, ospfCumRxPkts=ospfCumRxPkts, ospfIntfUnloop=ospfIntfUnloop, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ripNewCfgSupply=ripNewCfgSupply, ospfAreaIntfIndex=ospfAreaIntfIndex, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpGeneral=vrrpGeneral, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ripCurCfgVip=ripCurCfgVip, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ripStatOutPkts=ripStatOutPkts, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumNbrhello=ospfCumNbrhello, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfInfoTable=ospfIntfInfoTable, dnsStats=dnsStats, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipRouteInfoType=ipRouteInfoType, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipInterfaceTableMax=ipInterfaceTableMax, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ripNewCfgListen=ripNewCfgListen, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumIntfLoop=ospfCumIntfLoop, arpStats=arpStats, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfBackup=ospfIntfBackup, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipFwdNewCfgState=ipFwdNewCfgState, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, routerLSALinkIndex=routerLSALinkIndex, ripConfig=ripConfig, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, routeStatHighWater=routeStatHighWater, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ripCurCfgListen=ripCurCfgListen, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrp=vrrp, ipRouteInfoIndx=ipRouteInfoIndx, iprouting=iprouting, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpStats=vrrpStats, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaIntfBackup=ospfAreaIntfBackup, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfTxDatabase=ospfIntfTxDatabase, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ripStatInPkts=ripStatInPkts, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaRxHello=ospfAreaRxHello, ospfCumIntfUnloop=ospfCumIntfUnloop, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgGwState=ipCurCfgGwState, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaChangeStats=ospfAreaChangeStats, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfTxlsReqs=ospfIntfTxlsReqs, routeStatEntries=routeStatEntries, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgGwState=ipNewCfgGwState, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfTotalAreas=ospfTotalAreas, ospfCumIntfHello=ospfCumIntfHello, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfStats=ospfStats, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, arpInfoRefPorts=arpInfoRefPorts, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfGeneralStats=ospfGeneralStats, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipRouteInfoTag=ipRouteInfoTag, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfLoop=ospfIntfLoop, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfinfo=ospfinfo, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumIntfDown=ospfCumIntfDown, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumRxHello=ospfCumRxHello, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaRxPkts=ospfAreaRxPkts, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ripStats=ripStats, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaInfoId=ospfAreaInfoId, arpInfoTable=arpInfoTable, ospfInterface=ospfInterface, ospfIntfIndex=ospfIntfIndex, arpInfoEntry=arpInfoEntry, ripNewCfgDefListen=ripNewCfgDefListen, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfCountForRouter=ospfIntfCountForRouter, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgIntfMask=ipNewCfgIntfMask, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfArea=ospfArea, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, routerLSALinkData=routerLSALinkData, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIfWaitInterval=ospfIfWaitInterval, ospfProcessUptime=ospfProcessUptime, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCfg=ospfCfg, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCumTxHello=ospfCumTxHello, ripNewCfgState=ripNewCfgState, routerLSAId=routerLSAId, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipForward=ipForward, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaIntfDown=ospfAreaIntfDown, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpOper=vrrpOper, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, arpStatEntries=arpStatEntries, ipCurCfgGwArp=ipCurCfgGwArp, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfRxHello=ospfIntfRxHello, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumNbrDown=ospfCumNbrDown, ospfStartTime=ospfStartTime, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfNbrDown=ospfIntfNbrDown, ipRouteInfoEntry=ipRouteInfoEntry, ipRouteInfoInterface=ipRouteInfoInterface, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet)
