...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumIntfBackup=ospfCumIntfBackup, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumRxHello=ospfCumRxHello, ipNewCfgGwState=ipNewCfgGwState, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, arpInfoTable=arpInfoTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgGwTable=ipNewCfgGwTable, ipRouteInfoType=ipRouteInfoType, arpStatMaxEntries=arpStatMaxEntries, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, arpInfoRefPorts=arpInfoRefPorts, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, routeStatEntries=routeStatEntries, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ripCurCfgListen=ripCurCfgListen, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumIntfDown=ospfCumIntfDown, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfGeneralStats=ospfGeneralStats, ospfIntfUnloop=ospfIntfUnloop, ospfStats=ospfStats, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, arpStatHighWater=arpStatHighWater, ospfGeneralInfo=ospfGeneralInfo, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumRxPkts=ospfCumRxPkts, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgGwTable=ipCurCfgGwTable, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaRxPkts=ospfAreaRxPkts, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgIntfMask=ipNewCfgIntfMask, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIfInfoIndex=ospfIfInfoIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgBootpState=ipNewCfgBootpState, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfNbrInFullState=ospfNbrInFullState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ip_info=ip_info, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumNbrN1way=ospfCumNbrN1way, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumTxlsUpdates=ospfCumTxlsUpdates, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumRxTxStats=ospfCumRxTxStats, ospfArea=ospfArea, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfLoop=ospfIntfLoop, ospfinfo=ospfinfo, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, routeStatMaxEntries=routeStatMaxEntries, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfRxTxStats=ospfIntfRxTxStats, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipRouteInfoTable=ipRouteInfoTable, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumTxHello=ospfCumTxHello, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaNbrStart=ospfAreaNbrStart, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfInterface=ospfInterface, ospfIntfHello=ospfIntfHello, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ripCurCfgState=ripCurCfgState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, iprouting=iprouting, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumTxlsReqs=ospfCumTxlsReqs, ipRouteInfoIndx=ipRouteInfoIndx, arpInfoFlag=arpInfoFlag, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCumIntfLoop=ospfCumIntfLoop, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaInfoId=ospfAreaInfoId, ospfNbrInInitState=ospfNbrInInitState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCumNbrDown=ospfCumNbrDown, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfHostTableMaxSize=ospfHostTableMaxSize)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, routeStats=routeStats, arpInfoDestIp=arpInfoDestIp, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaChangeStats=ospfAreaChangeStats, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfNbrhello=ospfIntfNbrhello, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ripConfig=ripConfig, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ripNewCfgDefListen=ripNewCfgDefListen, vrrp_info=vrrp_info, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaTableMaxSize=ospfAreaTableMaxSize, arpStats=arpStats, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfTableMaxSize=ospfIntfTableMaxSize, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipForward=ipForward, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipRouteInfoMask=ipRouteInfoMask, ospfIntfDown=ospfIntfDown, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfBackup=ospfIntfBackup, ospfGeneral=ospfGeneral, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipNewCfgGwEntry=ipNewCfgGwEntry, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfTotalNeighbours=ospfTotalNeighbours, ripStatOutPkts=ripStatOutPkts, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ripStats=ripStats, vrrp=vrrp, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumIntfHello=ospfCumIntfHello, routerLSALinkID=routerLSALinkID, ospfAreaNbrDown=ospfAreaNbrDown, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgGwEntry=ipCurCfgGwEntry, arpStatEntries=arpStatEntries, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipRouteInfoTag=ipRouteInfoTag, ospfAreaIntfHello=ospfAreaIntfHello, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCfg=ospfCfg, ospfCumRxlsAcks=ospfCumRxlsAcks, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaTxHello=ospfAreaTxHello, ospfIntfNbrStart=ospfIntfNbrStart, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfTotalAreas=ospfTotalAreas, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, dnsStats=dnsStats, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, routerLSALinkData=routerLSALinkData, ospfStartTime=ospfStartTime, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ripCurCfgVip=ripCurCfgVip, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgIntfState=ipCurCfgIntfState, vrrpStats=vrrpStats, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfRxHello=ospfIntfRxHello, ospfIntfNbrChange=ospfIntfNbrChange, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripStatInPkts=ripStatInPkts, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaRxHello=ospfAreaRxHello, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, arpInfoVLAN=arpInfoVLAN, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumRxDatabase=ospfCumRxDatabase, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfRxDatabase=ospfIntfRxDatabase, arpInfoEntry=arpInfoEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripStatInErrorPkts=ripStatInErrorPkts, vrrpOper=vrrpOper)
