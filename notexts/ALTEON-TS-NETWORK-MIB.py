...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, arpInfoMacAddr=arpInfoMacAddr, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, arpInfoVLAN=arpInfoVLAN, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaIntfHello=ospfAreaIntfHello, routerLSALinkIndex=routerLSALinkIndex, ospfStats=ospfStats, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, routeStats=routeStats, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, routerLSAAreaIndex=routerLSAAreaIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfDown=ospfIntfDown, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, arpStatHighWater=arpStatHighWater, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgGwState=ipNewCfgGwState, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, routerLSALinkID=routerLSALinkID, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipRouteInfoEntry=ipRouteInfoEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfUnloop=ospfIntfUnloop, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfNbrStart=ospfIntfNbrStart, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpGeneral=vrrpGeneral, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfNewCfgAreaId=ospfNewCfgAreaId, ripCurCfgSupply=ripCurCfgSupply, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ripNewCfgSupply=ripNewCfgSupply, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, ripCurCfgVip=ripCurCfgVip, ipGatewayTableMax=ipGatewayTableMax, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaTxHello=ospfAreaTxHello, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumNbrN1way=ospfCumNbrN1way, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgIntfTable=ipCurCfgIntfTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpStats=vrrpStats, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, arpStatMaxEntries=arpStatMaxEntries, ospfIntfHello=ospfIntfHello, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCfg=ospfCfg, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipRouteInfoMask=ipRouteInfoMask, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdCurCfgState=ipFwdCurCfgState, iprouting=iprouting, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfTxHello=ospfIntfTxHello, ospfTotalAreas=ospfTotalAreas, ospfCumNbrBadSequence=ospfCumNbrBadSequence, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ripNewCfgListen=ripNewCfgListen, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipCurCfgGwEntry=ipCurCfgGwEntry, dnsStats=dnsStats, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgIntfState=ipNewCfgIntfState, arpStats=arpStats, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfRxDatabase=ospfIntfRxDatabase, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumIntfUnloop=ospfCumIntfUnloop, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ripStats=ripStats, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumTxHello=ospfCumTxHello, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfGeneralInfo=ospfGeneralInfo, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaRxPkts=ospfAreaRxPkts, ripCurCfgDefListen=ripCurCfgDefListen, ripStatInPkts=ripStatInPkts, vrrp_info=vrrp_info, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfIndex=ospfIntfIndex, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumTxPkts=ospfCumTxPkts, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgIfTable=vrrpNewCfgIfTable, arpStatEntries=arpStatEntries, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ripStatOutPkts=ripStatOutPkts, ospfCumRxTxStats=ospfCumRxTxStats, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfNbrN1way=ospfIntfNbrN1way, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaRxTxStats=ospfAreaRxTxStats, ipRouteInfoTag=ipRouteInfoTag, ospfIntfLoop=ospfIntfLoop, ospfinfo=ospfinfo, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ripConfig=ripConfig, vrrp=vrrp, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfNbrInFullState=ospfNbrInFullState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfBackup=ospfIntfBackup, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfStartTime=ospfStartTime, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaChangeStats=ospfAreaChangeStats, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpStatInAdvers=vrrpStatInAdvers, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgIntfIndex=ipNewCfgIntfIndex, arpInfoDestIp=arpInfoDestIp, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ripNewCfgState=ripNewCfgState, arpInfoSrcPort=arpInfoSrcPort, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgGwTable=ipNewCfgGwTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, arpInfoRefPorts=arpInfoRefPorts, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaRxHello=ospfAreaRxHello, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaIntfBackup=ospfAreaIntfBackup, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfArea=ospfArea, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipRouteInfoGateway=ipRouteInfoGateway, ipRouteInfoTable=ipRouteInfoTable, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumRxDatabase=ospfCumRxDatabase, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ripCurCfgListen=ripCurCfgListen, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfRxHello=ospfIntfRxHello, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumRxPkts=ospfCumRxPkts, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ip_info=ip_info, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, arpInfoEntry=arpInfoEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfNbrChange=ospfIntfNbrChange, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, routeStatMaxEntries=routeStatMaxEntries, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, routeStatEntries=routeStatEntries, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaNbrStart=ospfAreaNbrStart, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumNbrDown=ospfCumNbrDown, ospfTotalTransitAreas=ospfTotalTransitAreas, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumNbrhello=ospfCumNbrhello, ospfProcessUptime=ospfProcessUptime, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ripNewCfgDefListen=ripNewCfgDefListen, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, routerLSALinkData=routerLSALinkData, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumIntfHello=ospfCumIntfHello, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfRxTxIndex=ospfIntfRxTxIndex, routeStatHighWater=routeStatHighWater, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipForward=ipForward, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgGwState=ipCurCfgGwState, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipCurCfgBootpState=ipCurCfgBootpState, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates)
