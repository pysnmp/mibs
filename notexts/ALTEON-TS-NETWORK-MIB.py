...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumNbrDown=ospfCumNbrDown, ospfAreaRxlsAcks=ospfAreaRxlsAcks, routerLSALinkIndex=routerLSALinkIndex, routeStats=routeStats, ripCurCfgSupply=ripCurCfgSupply, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ripCurCfgListen=ripCurCfgListen, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaNbrStart=ospfAreaNbrStart, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfHello=ospfIntfHello, ospfNbrInFullState=ospfNbrInFullState, ospfCumRxPkts=ospfCumRxPkts, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaIntfBackup=ospfAreaIntfBackup, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, arpStatMaxEntries=arpStatMaxEntries, ospfCumTxDatabase=ospfCumTxDatabase, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaTxPkts=ospfAreaTxPkts, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ripStats=ripStats, routeStatEntries=routeStatEntries, ospfCfg=ospfCfg, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, arpInfoRefPorts=arpInfoRefPorts, routeStatHighWater=routeStatHighWater, vrrp_info=vrrp_info, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgGwRetry=ipCurCfgGwRetry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpGeneral=vrrpGeneral, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripStatOutPkts=ripStatOutPkts, ipRouteInfoTable=ipRouteInfoTable, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipRouteInfoEntry=ipRouteInfoEntry, ospfCumNbrhello=ospfCumNbrhello, arpStats=arpStats, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, routerLSALinkData=routerLSALinkData, arpInfoMacAddr=arpInfoMacAddr, routerLSALinkID=routerLSALinkID, routeStatMaxEntries=routeStatMaxEntries, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ip_info=ip_info, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumTxHello=ospfCumTxHello, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaInfoEntry=ospfAreaInfoEntry, routerLSAId=routerLSAId, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfIndex=ospfIntfIndex, ipRouteInfoTag=ipRouteInfoTag, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ripCurCfgState=ripCurCfgState, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfTxHello=ospfIntfTxHello, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, arpStatHighWater=arpStatHighWater, arpInfoDestIp=arpInfoDestIp, ripCurCfgVip=ripCurCfgVip, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfNbrInInitState=ospfNbrInInitState, ipRouteInfoType=ipRouteInfoType, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipRouteInfoMask=ipRouteInfoMask, ospfCumNbrStart=ospfCumNbrStart, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfNbrInExchState=ospfNbrInExchState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfStats=ospfStats, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgGenState=vrrpCurCfgGenState, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpStats=vrrpStats, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdCurCfgState=ipFwdCurCfgState, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ripNewCfgState=ripNewCfgState, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCurCfgAreaId=ospfCurCfgAreaId, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgIfTable=vrrpNewCfgIfTable, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfInterface=ospfInterface, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfProcessUptime=ospfProcessUptime, ospfIntfTxPkts=ospfIntfTxPkts, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfGeneralInfo=ospfGeneralInfo, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgGwIndex=ipCurCfgGwIndex, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgIntfState=ipCurCfgIntfState)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfTotalTransitAreas=ospfTotalTransitAreas, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ripStatInPkts=ripStatInPkts, ospfCumIntfUnloop=ospfCumIntfUnloop, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, arpInfoFlag=arpInfoFlag, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipRouteInfoGateway=ipRouteInfoGateway, ospfArea=ospfArea, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaNbrN1way=ospfAreaNbrN1way, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ripNewCfgVip=ripNewCfgVip, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgIntfTable=ipCurCfgIntfTable, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaInfoId=ospfAreaInfoId, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrp=vrrp, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaRxHello=ospfAreaRxHello, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, iprouting=iprouting, arpInfoEntry=arpInfoEntry, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ripConfig=ripConfig, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipCurCfgGwTable=ipCurCfgGwTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumRxDatabase=ospfCumRxDatabase, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpOper=vrrpOper, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfStartTime=ospfStartTime, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipForward=ipForward, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumRxHello=ospfCumRxHello, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumIntfBackup=ospfCumIntfBackup, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfRxHello=ospfIntfRxHello, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipInterfaceTableMax=ipInterfaceTableMax, ospfLsTypesSupported=ospfLsTypesSupported, dnsStats=dnsStats, ospfIntfCountForRouter=ospfIntfCountForRouter, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfTotalAreas=ospfTotalAreas, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfBackup=ospfIntfBackup, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfInfoTable=ospfIntfInfoTable, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfDown=ospfIntfDown, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaNbrDown=ospfAreaNbrDown, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx)
