...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipRouteInfoTag=ipRouteInfoTag, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ripStatInPkts=ripStatInPkts, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, arpInfoEntry=arpInfoEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipInterfaceTableMax=ipInterfaceTableMax, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipNewCfgGwArp=ipNewCfgGwArp, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumIntfLoop=ospfCumIntfLoop, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipCurCfgGwState=ipCurCfgGwState, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrp=vrrp, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ripNewCfgVip=ripNewCfgVip, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfRxHello=ospfIntfRxHello, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaTxPkts=ospfAreaTxPkts, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfNewCfgAreaId=ospfNewCfgAreaId, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumRxPkts=ospfCumRxPkts, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, routerLSALinkIndex=routerLSALinkIndex, ospfIntfIndex=ospfIntfIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfChangeStats=ospfIntfChangeStats, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaInfoIndex=ospfAreaInfoIndex, ripStats=ripStats, routeStatEntries=routeStatEntries, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipRouteInfoInterface=ipRouteInfoInterface, arpStatMaxEntries=arpStatMaxEntries, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ripNewCfgListen=ripNewCfgListen, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgIntfMask=ipCurCfgIntfMask, arpInfoTable=arpInfoTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaInfoId=ospfAreaInfoId, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumNbrDown=ospfCumNbrDown, routerLSAId=routerLSAId, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ripCurCfgState=ripCurCfgState, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfHello=ospfIntfHello, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaRxHello=ospfAreaRxHello, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfNbrInExchState=ospfNbrInExchState, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, dnsStats=dnsStats, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipRouteInfoGateway=ipRouteInfoGateway, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgBootpState=ipNewCfgBootpState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfLoop=ospfIntfLoop, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfTxHello=ospfIntfTxHello, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaTxHello=ospfAreaTxHello, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIfInfoIndex=ospfIfInfoIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfRxlsAcks=ospfIntfRxlsAcks, arpStats=arpStats, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaIntfHello=ospfAreaIntfHello, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgIntfState=ipNewCfgIntfState, ospfStartTime=ospfStartTime, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpOper=vrrpOper, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCfg=ospfCfg, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ripNewCfgSupply=ripNewCfgSupply, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripCurCfgListen=ripCurCfgListen, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ripCurCfgVip=ripCurCfgVip, ripConfig=ripConfig, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfProcessUptime=ospfProcessUptime, ipRouteInfoTable=ipRouteInfoTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfNbrChange=ospfIntfNbrChange, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfHostTableMaxSize=ospfHostTableMaxSize, arpInfoVLAN=arpInfoVLAN, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, arpStatHighWater=arpStatHighWater, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ip_info=ip_info, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ripCurCfgSupply=ripCurCfgSupply, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipRouteInfoMask=ipRouteInfoMask, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumNbrhello=ospfCumNbrhello, arpInfoMacAddr=arpInfoMacAddr, iprouting=iprouting, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfArea=ospfArea, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ripNewCfgDefListen=ripNewCfgDefListen, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, routeStatHighWater=routeStatHighWater, arpInfoDestIp=arpInfoDestIp, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, arpInfoSrcPort=arpInfoSrcPort, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumIntfBackup=ospfCumIntfBackup, arpStatEntries=arpStatEntries, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ripNewCfgState=ripNewCfgState, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, arpInfoRefPorts=arpInfoRefPorts, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumNbrN1way=ospfCumNbrN1way, ospfStats=ospfStats, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumRxHello=ospfCumRxHello, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipGatewayTableMax=ipGatewayTableMax, vrrp_info=vrrp_info, routerLSALinkData=routerLSALinkData, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ripStatOutPkts=ripStatOutPkts, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumTxHello=ospfCumTxHello, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, routerLSALinkID=routerLSALinkID, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, ipForward=ipForward, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfGeneralInfo=ospfGeneralInfo, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpStats=vrrpStats, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfInfoTable=ospfIntfInfoTable, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, arpInfoFlag=arpInfoFlag, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumNbrBadRequests=ospfCumNbrBadRequests, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgIntfTable=ipNewCfgIntfTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, routeStatMaxEntries=routeStatMaxEntries, ospfAreaRxPkts=ospfAreaRxPkts, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfInterface=ospfInterface, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfinfo=ospfinfo, ospfIntfUnloop=ospfIntfUnloop, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumTxPkts=ospfCumTxPkts, ipRouteInfoType=ipRouteInfoType, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumIntfDown=ospfCumIntfDown, vrrpStatInAdvers=vrrpStatInAdvers, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, routeStats=routeStats, ipFwdCurCfgState=ipFwdCurCfgState, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgGwAddr=ipCurCfgGwAddr, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfBackup=ospfIntfBackup, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfNbrInFullState=ospfNbrInFullState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfGeneral=ospfGeneral, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfTotalAreas=ospfTotalAreas, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumNbrStart=ospfCumNbrStart, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port)
