...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfProcessUptime=ospfProcessUptime, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, arpStats=arpStats, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, routerLSALinkIndex=routerLSALinkIndex, ripConfig=ripConfig, ospfAreaNbrhello=ospfAreaNbrhello, ipCurCfgGwInterval=ipCurCfgGwInterval, ipInterfaceTableMax=ipInterfaceTableMax, ospfCfg=ospfCfg, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfHostTableMaxSize=ospfHostTableMaxSize, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIfInfoIndex=ospfIfInfoIndex, ospfGeneralInfo=ospfGeneralInfo, ospfIntfHello=ospfIntfHello, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIfWaitInterval=ospfIfWaitInterval, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, iprouting=iprouting, dnsStats=dnsStats, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipForward=ipForward, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumNbrStart=ospfCumNbrStart, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, arpStatEntries=arpStatEntries, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ip_info=ip_info, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgIntfMask=ipNewCfgIntfMask, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpOper=vrrpOper, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaIntfHello=ospfAreaIntfHello, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfChangeStats=ospfIntfChangeStats, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfIndex=ospfIntfIndex, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgGwArp=ipCurCfgGwArp, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipCurCfgGwRetry=ipCurCfgGwRetry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumIntfHello=ospfCumIntfHello, arpInfoDestIp=arpInfoDestIp, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfGeneralStats=ospfGeneralStats, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, routerLSALinkData=routerLSALinkData, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgGwVlan=ipNewCfgGwVlan, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumIntfDown=ospfCumIntfDown, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfNbrInFullState=ospfNbrInFullState, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ripNewCfgListen=ripNewCfgListen, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, routeStatEntries=routeStatEntries, ospfStats=ospfStats, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipGatewayTableMax=ipGatewayTableMax, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ripCurCfgVip=ripCurCfgVip, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaNbrStart=ospfAreaNbrStart, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfNbrInExchState=ospfNbrInExchState, arpStatHighWater=arpStatHighWater, ospfNewCfgAreaTable=ospfNewCfgAreaTable, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumRxHello=ospfCumRxHello, ripCurCfgState=ripCurCfgState, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipCurCfgGwState=ipCurCfgGwState, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfUnloop=ospfIntfUnloop)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpInfoVLAN=arpInfoVLAN, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgBootpState=ipNewCfgBootpState, ripStatInPkts=ripStatInPkts, ospfIntfTxPkts=ospfIntfTxPkts, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfTxHello=ospfIntfTxHello, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfNbrChange=ospfIntfNbrChange, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgGwState=ipNewCfgGwState, ospfIntfCountForRouter=ospfIntfCountForRouter, arpInfoTable=arpInfoTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipRouteInfoType=ipRouteInfoType, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpGeneral=vrrpGeneral, ospfStartTime=ospfStartTime, ospfIntfDown=ospfIntfDown, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ripCurCfgSupply=ripCurCfgSupply, ripNewCfgSupply=ripNewCfgSupply, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfNbrInInitState=ospfNbrInInitState, routerLSALinkID=routerLSALinkID, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, routerLSAId=routerLSAId, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ripStatRoutesAgedOut=ripStatRoutesAgedOut, arpInfoFlag=arpInfoFlag, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumRxTxStats=ospfCumRxTxStats, ospfInterface=ospfInterface, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipCurCfgGwTable=ipCurCfgGwTable, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipRouteInfoEntry=ipRouteInfoEntry, arpStatMaxEntries=arpStatMaxEntries, ospfIntfLoop=ospfIntfLoop, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipRouteInfoTag=ipRouteInfoTag, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaInfoIndex=ospfAreaInfoIndex, routeStats=routeStats, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumNbrDown=ospfCumNbrDown, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipRouteInfoIndx=ipRouteInfoIndx, ripStats=ripStats, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ripNewCfgState=ripNewCfgState, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfNbrStart=ospfIntfNbrStart, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaRxHello=ospfAreaRxHello, ospfAreaTxHello=ospfAreaTxHello, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdCurCfgState=ipFwdCurCfgState, ipRouteInfoMask=ipRouteInfoMask, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ripStatOutPkts=ripStatOutPkts, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumTxDatabase=ospfCumTxDatabase, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfRxHello=ospfIntfRxHello, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ripCurCfgDefListen=ripCurCfgDefListen, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgIntfState=ipNewCfgIntfState, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfBackup=ospfIntfBackup, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfArea=ospfArea, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipCurCfgBootpState=ipCurCfgBootpState, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrp=vrrp, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfNewCfgAreaId=ospfNewCfgAreaId)
