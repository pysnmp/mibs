...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumRxPkts=ospfCumRxPkts, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipRouteInfoMask=ipRouteInfoMask, ospfCumNbrStart=ospfCumNbrStart, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfGeneral=ospfGeneral, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpOper=vrrpOper, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgIntfMask=ipNewCfgIntfMask, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfStartTime=ospfStartTime, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ripCurCfgListen=ripCurCfgListen, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipFwdCurCfgState=ipFwdCurCfgState, ripConfig=ripConfig, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrp=vrrp, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, arpInfoDestIp=arpInfoDestIp, ripStatOutPkts=ripStatOutPkts, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfRangeTableMaxSize=ospfRangeTableMaxSize, arpStatHighWater=arpStatHighWater, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumIntfLoop=ospfCumIntfLoop, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ripStatInPkts=ripStatInPkts, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumNbrDown=ospfCumNbrDown, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ripCurCfgSupply=ripCurCfgSupply, ospfCumNbrN1way=ospfCumNbrN1way, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfHello=ospfIntfHello, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipRouteInfoType=ipRouteInfoType, ospfAreaInfoTable=ospfAreaInfoTable, ospfArea=ospfArea, ipCurCfgIntfState=ipCurCfgIntfState, ospfStats=ospfStats, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumTxHello=ospfCumTxHello, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ripStats=ripStats, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumIntfHello=ospfCumIntfHello, ripNewCfgVip=ripNewCfgVip, routerLSAAreaIndex=routerLSAAreaIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaInfoIndex=ospfAreaInfoIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCfg=ospfCfg, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, routerLSAId=routerLSAId, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfBackup=ospfIntfBackup, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpGeneral=vrrpGeneral, ospfIntfRxHello=ospfIntfRxHello, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfProcessUptime=ospfProcessUptime, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaNbrN1way=ospfAreaNbrN1way, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripCurCfgVip=ripCurCfgVip, ospfIntfTxDatabase=ospfIntfTxDatabase, ipGatewayTableMax=ipGatewayTableMax, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfLsTypesSupported=ospfLsTypesSupported, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgGwArp=ipNewCfgGwArp, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfChangeStats=ospfIntfChangeStats, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, arpStatMaxEntries=arpStatMaxEntries, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrp_info=vrrp_info, ospfinfo=ospfinfo, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfLoop=ospfIntfLoop, ripStatRoutesAgedOut=ripStatRoutesAgedOut, arpStatEntries=arpStatEntries, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ripNewCfgListen=ripNewCfgListen, ospfNbrInFullState=ospfNbrInFullState, ripNewCfgState=ripNewCfgState, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ip_info=ip_info, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, routerLSALinkID=routerLSALinkID, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfRxDatabase=ospfIntfRxDatabase, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripStatInErrorPkts=ripStatInErrorPkts, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, iprouting=iprouting, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaTxHello=ospfAreaTxHello, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfNbrInInitState=ospfNbrInInitState, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumIntfBackup=ospfCumIntfBackup, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgIntfMask=ipCurCfgIntfMask, arpInfoRefPorts=arpInfoRefPorts, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumNbrhello=ospfCumNbrhello, arpInfoSrcPort=arpInfoSrcPort, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, routeStatMaxEntries=routeStatMaxEntries, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, arpStats=arpStats, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIfInfoIndex=ospfIfInfoIndex, ospfIntfRxTxIndex=ospfIntfRxTxIndex, arpInfoTable=arpInfoTable, arpInfoVLAN=arpInfoVLAN, ospfIntfTxHello=ospfIntfTxHello, ospfIntfDown=ospfIntfDown, ospfTotalNeighbours=ospfTotalNeighbours, ospfGeneralStats=ospfGeneralStats, ospfIntfInfoEntry=ospfIntfInfoEntry, routerLSALinkIndex=routerLSALinkIndex, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, arpInfoEntry=arpInfoEntry, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaNbrDown=ospfAreaNbrDown, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, routerLSALinkData=routerLSALinkData, ospfHostTableMaxSize=ospfHostTableMaxSize, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, routeStats=routeStats, routeStatHighWater=routeStatHighWater, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaChangeStats=ospfAreaChangeStats, ripCurCfgState=ripCurCfgState, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaNbrStart=ospfAreaNbrStart, ripNewCfgSupply=ripNewCfgSupply, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaInfoEntry=ospfAreaInfoEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpStats=vrrpStats, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, dnsStats=dnsStats, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipForward=ipForward, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgGwAddr=ipCurCfgGwAddr, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfNewCfgAreaId=ospfNewCfgAreaId, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgGwState=ipCurCfgGwState, arpInfoFlag=arpInfoFlag, ipRouteInfoTable=ipRouteInfoTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize)
