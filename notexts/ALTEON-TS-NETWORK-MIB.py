...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpStats=vrrpStats, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ripCurCfgVip=ripCurCfgVip, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumNbrhello=ospfCumNbrhello, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfBackup=ospfIntfBackup, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaNbrDown=ospfAreaNbrDown, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumRxTxStats=ospfCumRxTxStats, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, routeStats=routeStats, ospfCumNbrStart=ospfCumNbrStart, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfDown=ospfIntfDown, ripCurCfgListen=ripCurCfgListen, ipNewCfgGwRetry=ipNewCfgGwRetry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfGeneralStats=ospfGeneralStats, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgGwInterval=ipCurCfgGwInterval, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfTxHello=ospfIntfTxHello, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaIntfBackup=ospfAreaIntfBackup, routeStatEntries=routeStatEntries, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfStats=ospfStats, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgGwInterval=ipNewCfgGwInterval, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIfWaitInterval=ospfIfWaitInterval, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfLoop=ospfIntfLoop, iprouting=iprouting, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgIntfState=ipNewCfgIntfState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfTotalAreas=ospfTotalAreas, ospfCumTxPkts=ospfCumTxPkts, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ripNewCfgVip=ripNewCfgVip, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpOper=vrrpOper, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumNbrRstAd=ospfCumNbrRstAd, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgBootpState=ipNewCfgBootpState, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfRxTxStats=ospfIntfRxTxStats, dnsStats=dnsStats, ipRouteInfoIndx=ipRouteInfoIndx, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaChangeStats=ospfAreaChangeStats, ospfCfg=ospfCfg, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, arpInfoMacAddr=arpInfoMacAddr, arpInfoTable=arpInfoTable, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumRxHello=ospfCumRxHello, arpStats=arpStats, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfRxTxIndex=ospfIntfRxTxIndex, arpStatEntries=arpStatEntries, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, routerLSALinkID=routerLSALinkID, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumTxlsAcks=ospfCumTxlsAcks, ripCurCfgSupply=ripCurCfgSupply, ripNewCfgState=ripNewCfgState, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfInfoEntry=ospfIntfInfoEntry, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ip_info=ip_info, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ripCurCfgDefListen=ripCurCfgDefListen, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfNbrInExchState=ospfNbrInExchState, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfArea=ospfArea, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaIntfHello=ospfAreaIntfHello, routerLSAId=routerLSAId, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrp=vrrp, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaIntfDown=ospfAreaIntfDown, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, arpInfoVLAN=arpInfoVLAN, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaIntfIndex=ospfAreaIntfIndex, ripCurCfgState=ripCurCfgState, ospfIntfNbrChange=ospfIntfNbrChange, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipRouteInfoInterface=ipRouteInfoInterface, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaInfoEntry=ospfAreaInfoEntry, ipRouteInfoTag=ipRouteInfoTag, ospfAreaInfoId=ospfAreaInfoId, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipForward=ipForward, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfGeneral=ospfGeneral, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpStatInAdvers=vrrpStatInAdvers, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfTxlsAcks=ospfIntfTxlsAcks, arpInfoFlag=arpInfoFlag, vrrpGeneral=vrrpGeneral, routeStatHighWater=routeStatHighWater, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaNbrStart=ospfAreaNbrStart, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ripStatOutPkts=ripStatOutPkts, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfInterface=ospfInterface, ospfIfInfoIndex=ospfIfInfoIndex, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripConfig=ripConfig, ospfStartTime=ospfStartTime, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrp_info=vrrp_info, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ripStatInPkts=ripStatInPkts, ospfNbrInInitState=ospfNbrInInitState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripNewCfgListen=ripNewCfgListen, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, routerLSALinkData=routerLSALinkData, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipRouteInfoMask=ipRouteInfoMask, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaIntfLoop=ospfAreaIntfLoop, ripStats=ripStats, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaRxTxStats=ospfAreaRxTxStats, arpInfoSrcPort=arpInfoSrcPort, ospfCumIntfHello=ospfCumIntfHello, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfRxHello=ospfIntfRxHello, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaNbrhello=ospfAreaNbrhello, ripNewCfgSupply=ripNewCfgSupply, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfGeneralInfo=ospfGeneralInfo, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfLsTypesSupported=ospfLsTypesSupported, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, ipRouteInfoTable=ipRouteInfoTable, ospfAreaTxDatabase=ospfAreaTxDatabase, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfIndex=ospfIntfIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipRouteInfoGateway=ipRouteInfoGateway, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfinfo=ospfinfo, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipRouteInfoType=ipRouteInfoType, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfHello=ospfIntfHello, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, routeStatMaxEntries=routeStatMaxEntries, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgIntfTable=ipNewCfgIntfTable, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgGwState=ipCurCfgGwState, ospfProcessUptime=ospfProcessUptime)
