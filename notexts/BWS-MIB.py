...
Bits, MibIdentifier, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Integer32, IpAddress, Gauge32, Counter64, Counter32, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Integer32", "IpAddress", "Gauge32", "Counter64", "Counter32", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("BWS-MIB", ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, webCacheProtocol=webCacheProtocol, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpProxyServerReq=httpProxyServerReq, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, systemFanSpeed=systemFanSpeed, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, webCacheLongHdrs=webCacheLongHdrs, totalServers=totalServers, httpProxyOutBytes=httpProxyOutBytes, webCmprAddress=webCmprAddress, ipsReqLimitPort=ipsReqLimitPort, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsHdrAclHits=ipsHdrAclHits, serviceAddress=serviceAddress, dataPathStatus=dataPathStatus, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsUrlNormAddressType=ipsUrlNormAddressType, httpSrvrSrvcAddress=httpSrvrSrvcAddress, totalAttacks=totalAttacks, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsRCAddressType=ipsRCAddressType, httpProxyTotalConn=httpProxyTotalConn, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsMessage=bwsMessage, webCacheStale=webCacheStale, sslSrvrTotReqActive=sslSrvrTotReqActive, logStorage=logStorage, httpSrvrAddressType=httpSrvrAddressType, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsHdrAclAddress=ipsHdrAclAddress, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpProxyActiveConn=httpProxyActiveConn, httpProxyServerErr=httpProxyServerErr, bwsMIBGroups=bwsMIBGroups, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslSrvrState=sslSrvrState, webCacheCacheableRes=webCacheCacheableRes, virusDefUpdates=virusDefUpdates, httpProxyAddress=httpProxyAddress, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpSrvrSrvcPort=httpSrvrSrvcPort, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, webCacheCachedObjects=webCacheCachedObjects, bwsTrapGroup=bwsTrapGroup, linkStatus=linkStatus, httpSrvrTotRefused=httpSrvrTotRefused, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, uptime=uptime, ipsRCTimeStamp=ipsRCTimeStamp, httpProxyPort=httpProxyPort, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpProxyInBytes=httpProxyInBytes, servicePort=servicePort, bwsMIBConformance=bwsMIBConformance, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, peerUp=peerUp, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsUrlAclReserved=ipsUrlAclReserved, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsUrlNormPort=ipsUrlNormPort, energizeUpdateExpire=energizeUpdateExpire, bws=bws, sslProxyOutBytes=sslProxyOutBytes, ipsRCTotQueued=ipsRCTotQueued, serverUp=serverUp, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslProxyBadDNCErr=sslProxyBadDNCErr, dataPortLinkDown=dataPortLinkDown, sslSrvrAddressType=sslSrvrAddressType, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, serviceName=serviceName, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, activeServers=activeServers, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsCookieSecAddressType=ipsCookieSecAddressType, memoryUsageHigh=memoryUsageHigh, sslProxyCurrentConn=sslProxyCurrentConn, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsRCPort=ipsRCPort, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrPort=httpSrvrPort, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, systemLoad=systemLoad, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsAccessCtrlPort=ipsAccessCtrlPort, sharedSecretKeyExpired=sharedSecretKeyExpired, sslSrvrMinResTime=sslSrvrMinResTime, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpProxyTotalReq=httpProxyTotalReq, httpSrvrMinResTime=httpSrvrMinResTime, smNumUserSessions=smNumUserSessions, sslProxyAddressType=sslProxyAddressType, totalMem=totalMem, smAgentName=smAgentName, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslProxyCacheMiss=sslProxyCacheMiss, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, webCacheAddress=webCacheAddress, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslProxyTotalReq=sslProxyTotalReq, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, tempCritical=tempCritical, webCacheAddressType=webCacheAddressType, ipsReqSrvcPort=ipsReqSrvcPort, dataPortLinkUp=dataPortLinkUp, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, switchingToMaintMode=switchingToMaintMode, sslSrvrNumConn=sslSrvrNumConn, ipsUrlNormAddress=ipsUrlNormAddress, bwsMIBCompliances=bwsMIBCompliances, processCountHigh=processCountHigh, httpSrvrOutBytes=httpSrvrOutBytes, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslProxyActiveConn=sslProxyActiveConn, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpProxySessionTimeOut=httpProxySessionTimeOut, webCmprAddressType=webCmprAddressType, httpSrvrTotTimedout=httpSrvrTotTimedout, sslProxyPort=sslProxyPort, fanDead=fanDead, sslSrvrTotRefused=sslSrvrTotRefused, currentFirmwareVersion=currentFirmwareVersion, webCachePort=webCachePort, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsCacheStatsTable=bwsCacheStatsTable, webCacheMiss=webCacheMiss, ipsRCAddress=ipsRCAddress, httpSrvrAvgResTime=httpSrvrAvgResTime, smRealmName=smRealmName, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwstraps=bwstraps, httpProxyParseErr=httpProxyParseErr, systemFailOver=systemFailOver, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrPort=sslSrvrPort, logStorageHigh=logStorageHigh, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsStats=bwsStats, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, switchingToBypassMode=switchingToBypassMode, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpSrvrTotResponse=httpSrvrTotResponse, ipsHdrAclPort=ipsHdrAclPort, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsCookieSecTampered=ipsCookieSecTampered, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslSrvrInBytes=sslSrvrInBytes, systemFailure=systemFailure, sslSrvrOutBytes=sslSrvrOutBytes, firmwareStorage=firmwareStorage, sslProxyAddress=sslProxyAddress, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpSrvrState=httpSrvrState, sslSrvrAddress=sslSrvrAddress, webCmprProtocol=webCmprProtocol, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsUrlAclPort=ipsUrlAclPort, httpProxyAddressType=httpProxyAddressType, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsCompressionStatsTable=bwsCompressionStatsTable, sslSrvrMaxResTime=sslSrvrMaxResTime, firmwareStorageHigh=firmwareStorageHigh, cpuTemperature=cpuTemperature, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, totalBandwidth=totalBandwidth, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, systemSerialNumber=systemSerialNumber, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsStatsGroup=bwsStatsGroup, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsReqLimitAddress=ipsReqLimitAddress, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslProxyErrPms=sslProxyErrPms, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpProxyServerAbrt=httpProxyServerAbrt, cpuFanSpeed=cpuFanSpeed, httpSrvrAddress=httpSrvrAddress, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsCookieSecPort=ipsCookieSecPort, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslProxyCacheHits=sslProxyCacheHits, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrTotReqRejected=sslSrvrTotReqRejected, tempHigh=tempHigh, raidDegrading=raidDegrading, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, peerDown=peerDown, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrInBytes=httpSrvrInBytes, httpSrvrNumConn=httpSrvrNumConn, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, operationalMode=operationalMode, PYSNMP_MODULE_ID=bws, cpuUtilization=cpuUtilization)
mibBuilder.exportSymbols("BWS-MIB", totalApplications=totalApplications, freeMem=freeMem, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslProxyTotalConn=sslProxyTotalConn, firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsRCTotDropped=ipsRCTotDropped, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsMIBCompliance=bwsMIBCompliance, vipStatus=vipStatus, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsServiceStatusEntry=bwsServiceStatusEntry, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, webCacheBytesOut=webCacheBytesOut, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, activeApplications=activeApplications, memUtilization=memUtilization, webCacheHits=webCacheHits, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsUrlAclAddress=ipsUrlAclAddress, webCacheReq=webCacheReq, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsCookieSecAddress=ipsCookieSecAddress, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, highAvailabilityStatus=highAvailabilityStatus, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsRCTotServed=ipsRCTotServed, serviceStatus=serviceStatus, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, switchingToInlineMode=switchingToInlineMode, securityDefUpdates=securityDefUpdates, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, webCmprPort=webCmprPort, srvcName=srvcName, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsCompressionStatsEntry=bwsCompressionStatsEntry, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrTotResponse=sslSrvrTotResponse, sslProxyInBytes=sslProxyInBytes, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, serverDown=serverDown, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpProxyWAFWarnings=httpProxyWAFWarnings, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure)
