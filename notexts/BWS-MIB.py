...
Gauge32, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, Unsigned32, Counter32, MibIdentifier, Integer32, Counter64, TimeTicks, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "Unsigned32", "Counter32", "MibIdentifier", "Integer32", "Counter64", "TimeTicks", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", webCacheCacheableRes=webCacheCacheableRes, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrMinResTime=sslSrvrMinResTime, serviceAddress=serviceAddress, webCacheReq=webCacheReq, httpProxyServerAbrt=httpProxyServerAbrt, totalServers=totalServers, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, firmwareStorage=firmwareStorage, tempHigh=tempHigh, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, peerDown=peerDown, webCacheAddress=webCacheAddress, operationalMode=operationalMode, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, uptime=uptime, httpSrvrInBytes=httpSrvrInBytes, sslProxyErrPms=sslProxyErrPms, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, systemFailOver=systemFailOver, bwsMIBCompliance=bwsMIBCompliance, totalApplications=totalApplications, httpProxyUnknownRsp=httpProxyUnknownRsp, sslSrvrSrvcPort=sslSrvrSrvcPort, systemSerialNumber=systemSerialNumber, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslProxyCacheMiss=sslProxyCacheMiss, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, totalAttacks=totalAttacks, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrSrvcAddress=sslSrvrSrvcAddress, srvcName=srvcName, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsStats=bwsStats, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsHdrAclPort=ipsHdrAclPort, memUtilization=memUtilization, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, currentFirmwareVersion=currentFirmwareVersion, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsMessage=bwsMessage, serviceName=serviceName, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, systemFailure=systemFailure, switchingToBypassMode=switchingToBypassMode, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrTotReqActive=httpSrvrTotReqActive, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, energizeUpdateExpire=energizeUpdateExpire, logStorage=logStorage, serverUp=serverUp, sslSrvrTotResponse=sslSrvrTotResponse, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, webCmprPort=webCmprPort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpProxyInBytes=httpProxyInBytes, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bws=bws, httpProxyAddressType=httpProxyAddressType, sslProxyTotalReq=sslProxyTotalReq, httpSrvrTotRefused=httpSrvrTotRefused, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsCookieSecAddressType=ipsCookieSecAddressType, smAgentName=smAgentName, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, smRealmName=smRealmName, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpSrvrSrvcPort=httpSrvrSrvcPort, linkStatus=linkStatus, PYSNMP_MODULE_ID=bws, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sharedSecretKeyExpired=sharedSecretKeyExpired, activeApplications=activeApplications, webCachePort=webCachePort, sslSrvrTotRefused=sslSrvrTotRefused, bwstraps=bwstraps, raidDegrading=raidDegrading, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, serviceStatus=serviceStatus, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, systemFanSpeed=systemFanSpeed, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsHdrAclHits=ipsHdrAclHits, bwsServiceStatusEntry=bwsServiceStatusEntry, sslSrvrTotTimedout=sslSrvrTotTimedout, logStorageHigh=logStorageHigh, sslSrvrAddressType=sslSrvrAddressType, ipsRCTimeStamp=ipsRCTimeStamp, ipsReqLimitAddress=ipsReqLimitAddress, sslSrvrTotSuccess=sslSrvrTotSuccess, httpSrvrAddress=httpSrvrAddress, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrAvgResTime=httpSrvrAvgResTime, freeMem=freeMem, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpProxyOutBytes=httpProxyOutBytes, totalMem=totalMem, tempCritical=tempCritical, httpProxyServerReq=httpProxyServerReq, sslSrvrInBytes=sslSrvrInBytes, httpSrvrMaxResTime=httpSrvrMaxResTime, httpProxyTotalReq=httpProxyTotalReq, ipsReqSrvcAddress=ipsReqSrvcAddress, webCacheProtocol=webCacheProtocol, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsRCTotServed=ipsRCTotServed, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, dataPortLinkDown=dataPortLinkDown, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, webCmprCompressedDataSize=webCmprCompressedDataSize, fanDead=fanDead, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsStatsGroup=bwsStatsGroup, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpProxyTotalConn=httpProxyTotalConn, securityDefUpdates=securityDefUpdates, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsMIBCompliances=bwsMIBCompliances, sslSrvrState=sslSrvrState, sslProxyActiveConn=sslProxyActiveConn, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsRCAddress=ipsRCAddress, webCacheStale=webCacheStale, vipStatus=vipStatus, ipsUrlNormPort=ipsUrlNormPort, sslProxyTotalConn=sslProxyTotalConn, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsUrlAclReserved=ipsUrlAclReserved, httpSrvrMinResTime=httpSrvrMinResTime, httpProxyAddress=httpProxyAddress, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpSrvrState=httpSrvrState, sslSrvrNumConn=sslSrvrNumConn, webCacheMiss=webCacheMiss, ipsRCPort=ipsRCPort, ipsRCAddressType=ipsRCAddressType, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsCookieSecAddress=ipsCookieSecAddress, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsLrnSrvcAddress=ipsLrnSrvcAddress, webCmprProtocol=webCmprProtocol, sslProxyCacheHits=sslProxyCacheHits, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, virusDefUpdates=virusDefUpdates, serverDown=serverDown, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslProxyCurrentConn=sslProxyCurrentConn, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrNumConn=httpSrvrNumConn, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, smNumUserSessions=smNumUserSessions, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, processCountHigh=processCountHigh, activeServers=activeServers, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpSrvrPort=httpSrvrPort, bwsMIBConformance=bwsMIBConformance, highAvailabilityStatus=highAvailabilityStatus, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, webCacheAddressType=webCacheAddressType, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrPort=sslSrvrPort, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrTotReqRejected=httpSrvrTotReqRejected, dataPathStatus=dataPathStatus, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, webCacheBytesOut=webCacheBytesOut, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, firmwareStorageHigh=firmwareStorageHigh, webCacheHits=webCacheHits, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsHdrAclAddress=ipsHdrAclAddress, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsCookieSecPort=ipsCookieSecPort, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsLrnSrvcPort=ipsLrnSrvcPort, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsWebAddrTransPort=ipsWebAddrTransPort, httpSrvrOutBytes=httpSrvrOutBytes, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpProxyActiveConn=httpProxyActiveConn, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsTrapGroup=bwsTrapGroup, httpSrvrAddressType=httpSrvrAddressType, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, webCacheLongHdrs=webCacheLongHdrs, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslSrvrTotReqActive=sslSrvrTotReqActive, sslProxyBadDNCErr=sslProxyBadDNCErr, httpProxyParseErr=httpProxyParseErr, cpuTemperature=cpuTemperature, bwsMIBGroups=bwsMIBGroups, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr)
mibBuilder.exportSymbols("BWS-MIB", ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, webCmprCompressibleDataSize=webCmprCompressibleDataSize, webCacheCachedObjects=webCacheCachedObjects, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsReqLimitPort=ipsReqLimitPort, ipsUrlAclAddressType=ipsUrlAclAddressType, cpuFanSpeed=cpuFanSpeed, ipsReqSrvcPort=ipsReqSrvcPort, bwsServiceStatusTable=bwsServiceStatusTable, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, memoryUsageHigh=memoryUsageHigh, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslProxyPort=sslProxyPort, httpSrvrTotResponse=httpSrvrTotResponse, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, cpuUtilization=cpuUtilization, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, servicePort=servicePort, webCmprAddressType=webCmprAddressType, systemLoad=systemLoad, sslProxyAddress=sslProxyAddress, sslSrvrAddress=sslSrvrAddress, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslProxyFullHandshakes=sslProxyFullHandshakes, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, totalBandwidth=totalBandwidth, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlAclAddress=ipsUrlAclAddress, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpProxyClientAbrt=httpProxyClientAbrt, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsCookieSecTampered=ipsCookieSecTampered, dataPortLinkUp=dataPortLinkUp, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslProxyBadCRLErr=sslProxyBadCRLErr, sslProxyAddressType=sslProxyAddressType, ipsRCTotQueued=ipsRCTotQueued, ipsUrlAclPort=ipsUrlAclPort, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslProxyInBytes=sslProxyInBytes, peerUp=peerUp, firmwareUpdateAvailable=firmwareUpdateAvailable, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsRCTotDropped=ipsRCTotDropped, sslProxyOutBytes=sslProxyOutBytes, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpProxyPort=httpProxyPort, sslSrvrOutBytes=sslSrvrOutBytes, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpProxyServerErr=httpProxyServerErr, switchingToMaintMode=switchingToMaintMode, webCmprAddress=webCmprAddress, switchingToInlineMode=switchingToInlineMode)
