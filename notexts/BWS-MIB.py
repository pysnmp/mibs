...
Gauge32, Unsigned32, TimeTicks, Counter64, Bits, iso, NotificationType, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "TimeTicks", "Counter64", "Bits", "iso", "NotificationType", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", sslProxyInBytes=sslProxyInBytes, httpProxySessionTimeOut=httpProxySessionTimeOut, firmwareStorageHigh=firmwareStorageHigh, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrOutBytes=httpSrvrOutBytes, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlAclAddress=ipsUrlAclAddress, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsStats=bwsStats, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsCompressionStatsTable=bwsCompressionStatsTable, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslProxyCacheMiss=sslProxyCacheMiss, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsMIBConformance=bwsMIBConformance, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsReqLimitAddress=ipsReqLimitAddress, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslProxyErrPms=sslProxyErrPms, bws=bws, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsHdrAclAddress=ipsHdrAclAddress, activeApplications=activeApplications, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, serviceName=serviceName, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, memoryUsageHigh=memoryUsageHigh, ipsCookieSecAddress=ipsCookieSecAddress, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, switchingToMaintMode=switchingToMaintMode, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpSrvrTotReqActive=httpSrvrTotReqActive, sslProxyTotalConn=sslProxyTotalConn, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, freeMem=freeMem, webCacheCachedObjects=webCacheCachedObjects, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsMIBGroups=bwsMIBGroups, sslProxyActiveConn=sslProxyActiveConn, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslProxyOutBytes=sslProxyOutBytes, ipsUrlNormPort=ipsUrlNormPort, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsCookieSecTampered=ipsCookieSecTampered, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpProxyServerReq=httpProxyServerReq, sslSrvrAddressType=sslSrvrAddressType, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, vipStatus=vipStatus, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, servicePort=servicePort, sslProxyAddressType=sslProxyAddressType, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslProxyAddress=sslProxyAddress, serverDown=serverDown, totalBandwidth=totalBandwidth, ipsLrnSrvcAddress=ipsLrnSrvcAddress, securityDefUpdates=securityDefUpdates, sslProxyCurrentConn=sslProxyCurrentConn, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslSrvrTotTimedout=sslSrvrTotTimedout, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, webCacheMiss=webCacheMiss, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsHdrAclHits=ipsHdrAclHits, cpuTemperature=cpuTemperature, httpSrvrTotResponse=httpSrvrTotResponse, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, systemLoad=systemLoad, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsMessage=bwsMessage, bwsServiceStatusTable=bwsServiceStatusTable, ipsUrlPolicyPort=ipsUrlPolicyPort, webCmprAddress=webCmprAddress, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpProxyAddressType=httpProxyAddressType, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrAddress=sslSrvrAddress, httpProxyInBytes=httpProxyInBytes, sslProxyCacheTimeouts=sslProxyCacheTimeouts, tempHigh=tempHigh, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, totalAttacks=totalAttacks, fanDead=fanDead, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sharedSecretKeyExpired=sharedSecretKeyExpired, httpProxyOutBytes=httpProxyOutBytes, systemFailure=systemFailure, operationalMode=operationalMode, ipsUrlPolicyAddress=ipsUrlPolicyAddress, webCacheAddressType=webCacheAddressType, sslSrvrTotReqActive=sslSrvrTotReqActive, systemSerialNumber=systemSerialNumber, httpSrvrState=httpSrvrState, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsReqSrvcPort=ipsReqSrvcPort, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsRCTotServed=ipsRCTotServed, logStorageHigh=logStorageHigh, serviceStatus=serviceStatus, httpProxyParseErr=httpProxyParseErr, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslSrvrTotResponse=sslSrvrTotResponse, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslSrvrMaxResTime=sslSrvrMaxResTime, httpSrvrSrvcAddress=httpSrvrSrvcAddress, serverUp=serverUp, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, webCmprProtocol=webCmprProtocol, ipsUrlAclPort=ipsUrlAclPort, srvcName=srvcName, sslSrvrNumConn=sslSrvrNumConn, ipsUrlAclReserved=ipsUrlAclReserved, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrTotReqRejected=sslSrvrTotReqRejected, webCacheAddress=webCacheAddress, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslProxyPort=sslProxyPort, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsReqLimitAddressType=ipsReqLimitAddressType, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsRCTotDropped=ipsRCTotDropped, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, smNumUserSessions=smNumUserSessions, httpSrvrPort=httpSrvrPort, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, webCachePort=webCachePort, httpProxyServerErr=httpProxyServerErr, httpSrvrSrvcPort=httpSrvrSrvcPort, switchingToBypassMode=switchingToBypassMode, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, dataPortLinkDown=dataPortLinkDown, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, cpuFanSpeed=cpuFanSpeed, webCacheLongHdrs=webCacheLongHdrs, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsUrlAclAddressType=ipsUrlAclAddressType, webCmprPort=webCmprPort, logStorage=logStorage, httpProxyAddress=httpProxyAddress, webCacheBytesOut=webCacheBytesOut, httpProxyTotalReq=httpProxyTotalReq, webCacheReq=webCacheReq, httpProxyPort=httpProxyPort, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, dataPortLinkUp=dataPortLinkUp, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslSrvrInBytes=sslSrvrInBytes, systemFailOver=systemFailOver, webCacheHits=webCacheHits, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, webCacheStale=webCacheStale, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsRCTotQueued=ipsRCTotQueued, ipsUrlNormAddress=ipsUrlNormAddress, sslSrvrTotRefused=sslSrvrTotRefused, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsMIBCompliances=bwsMIBCompliances, peerDown=peerDown, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrPort=sslSrvrPort, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, linkStatus=linkStatus, ipsRCAddressType=ipsRCAddressType, highAvailabilityStatus=highAvailabilityStatus, httpProxyServerAbrt=httpProxyServerAbrt, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, uptime=uptime, PYSNMP_MODULE_ID=bws, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, totalServers=totalServers, memUtilization=memUtilization, bwsMIBCompliance=bwsMIBCompliance, cpuUtilization=cpuUtilization, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsReqLimitPort=ipsReqLimitPort, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsCacheStatsEntry=bwsCacheStatsEntry, sslSrvrOutBytes=sslSrvrOutBytes, webCmprAddressType=webCmprAddressType, bwsCacheStatsTable=bwsCacheStatsTable, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsCookieSecAddressType=ipsCookieSecAddressType, energizeUpdateExpire=energizeUpdateExpire, httpSrvrAddressType=httpSrvrAddressType, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, switchingToInlineMode=switchingToInlineMode, httpSrvrNumFreeConn=httpSrvrNumFreeConn, webCmprCompressedDataSize=webCmprCompressedDataSize, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrInBytes=httpSrvrInBytes, raidDegrading=raidDegrading)
mibBuilder.exportSymbols("BWS-MIB", bwsTrapGroup=bwsTrapGroup, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsServiceStatusEntry=bwsServiceStatusEntry, peerUp=peerUp, sslProxyCacheHits=sslProxyCacheHits, ipsUrlNormAddressType=ipsUrlNormAddressType, httpProxyTotalConn=httpProxyTotalConn, ipsHdrAclPort=ipsHdrAclPort, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslProxyTotalReq=sslProxyTotalReq, processCountHigh=processCountHigh, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpProxyClientAbrt=httpProxyClientAbrt, httpSrvrAddress=httpSrvrAddress, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpProxyActiveConn=httpProxyActiveConn, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, serviceAddress=serviceAddress, activeServers=activeServers, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, tempCritical=tempCritical, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslProxyBadCRLErr=sslProxyBadCRLErr, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, smAgentName=smAgentName, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpProxyWAFWarnings=httpProxyWAFWarnings, currentFirmwareVersion=currentFirmwareVersion, ipsRCPort=ipsRCPort, bwstraps=bwstraps, ipsRCAddress=ipsRCAddress, ipsRCTimeStamp=ipsRCTimeStamp, systemFanSpeed=systemFanSpeed, dataPathStatus=dataPathStatus, sslSrvrState=sslSrvrState, totalMem=totalMem, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsStatsGroup=bwsStatsGroup, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrMinResTime=httpSrvrMinResTime, virusDefUpdates=virusDefUpdates, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsCookieSecPort=ipsCookieSecPort, httpSrvrNumConn=httpSrvrNumConn, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, totalApplications=totalApplications, firmwareStorage=firmwareStorage, sslSrvrSrvcPort=sslSrvrSrvcPort, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, webCacheProtocol=webCacheProtocol, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, webCacheCacheableRes=webCacheCacheableRes, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, smRealmName=smRealmName)
