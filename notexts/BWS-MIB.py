...
ModuleIdentity, Bits, NotificationType, Counter32, ObjectIdentity, IpAddress, TimeTicks, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, Gauge32, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "NotificationType", "Counter32", "ObjectIdentity", "IpAddress", "TimeTicks", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "Gauge32", "iso", "Integer32")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrNumConn=httpSrvrNumConn, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, webCmprAddress=webCmprAddress, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, webCacheCacheableRes=webCacheCacheableRes, raidDegrading=raidDegrading, systemFanSpeed=systemFanSpeed, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsReqLimitAddress=ipsReqLimitAddress, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpProxyActiveConn=httpProxyActiveConn, sslProxyAddressType=sslProxyAddressType, serviceAddress=serviceAddress, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsHdrAclPort=ipsHdrAclPort, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslSrvrTotResponse=sslSrvrTotResponse, activeApplications=activeApplications, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, serviceName=serviceName, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsReqSrvcAddressType=ipsReqSrvcAddressType, systemLoad=systemLoad, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, firmwareUpdateAvailable=firmwareUpdateAvailable, logStorageHigh=logStorageHigh, ipsRCTotQueued=ipsRCTotQueued, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsRCTotServed=ipsRCTotServed, ipsCookieSecPort=ipsCookieSecPort, sslSrvrTotReqRejected=sslSrvrTotReqRejected, systemFailure=systemFailure, logStorage=logStorage, sslSrvrOutBytes=sslSrvrOutBytes, httpSrvrInBytes=httpSrvrInBytes, webCmprPort=webCmprPort, ipsRCAddress=ipsRCAddress, peerUp=peerUp, webCacheReq=webCacheReq, tempHigh=tempHigh, sslSrvrAddressType=sslSrvrAddressType, sslProxyCacheTimeouts=sslProxyCacheTimeouts, activeServers=activeServers, ipsRCAddressType=ipsRCAddressType, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpProxyTotalConn=httpProxyTotalConn, bwsSMUserSessionEntry=bwsSMUserSessionEntry, servicePort=servicePort, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsUrlAclReserved=ipsUrlAclReserved, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, smRealmName=smRealmName, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpProxyServerErr=httpProxyServerErr, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpSrvrPort=httpSrvrPort, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwstraps=bwstraps, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, totalApplications=totalApplications, cpuFanSpeed=cpuFanSpeed, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpSrvrTotReqRejected=httpSrvrTotReqRejected, totalBandwidth=totalBandwidth, dataPortLinkUp=dataPortLinkUp, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslProxyCacheHits=sslProxyCacheHits, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsUrlAclAddress=ipsUrlAclAddress, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpSrvrTotRefused=httpSrvrTotRefused, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, smNumUserSessions=smNumUserSessions, sslProxyCacheMiss=sslProxyCacheMiss, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpProxyPort=httpProxyPort, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslProxyTotalReq=sslProxyTotalReq, httpProxyParseErr=httpProxyParseErr, bwsMIBGroups=bwsMIBGroups, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, firmwareStorageHigh=firmwareStorageHigh, sslSrvrInBytes=sslSrvrInBytes, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslSrvrState=sslSrvrState, PYSNMP_MODULE_ID=bws, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslSrvrMinResTime=sslSrvrMinResTime, httpSrvrAddressType=httpSrvrAddressType, webCacheBytesOut=webCacheBytesOut, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpProxyAddressType=httpProxyAddressType, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslProxyPort=sslProxyPort, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpProxyTotalReq=httpProxyTotalReq, currentFirmwareVersion=currentFirmwareVersion, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsReqLimitPort=ipsReqLimitPort, httpProxyAddress=httpProxyAddress, sslSrvrNumConn=sslSrvrNumConn, sslProxyCurrentConn=sslProxyCurrentConn, webCachePort=webCachePort, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, dataPortLinkDown=dataPortLinkDown, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslSrvrAddress=sslSrvrAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsRCPort=ipsRCPort, operationalMode=operationalMode, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsUrlAclPort=ipsUrlAclPort, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsHdrAclAddress=ipsHdrAclAddress, sslProxyFullHandshakes=sslProxyFullHandshakes, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsCookieSecTampered=ipsCookieSecTampered, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpSrvrMinResTime=httpSrvrMinResTime, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpProxyInBytes=httpProxyInBytes, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, totalAttacks=totalAttacks, httpProxyClientAbrt=httpProxyClientAbrt, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslProxyInBytes=sslProxyInBytes, webCacheCachedObjects=webCacheCachedObjects, sslSrvrTotReqActive=sslSrvrTotReqActive, webCmprCompressedDataSize=webCmprCompressedDataSize, linkStatus=linkStatus, ipsCookieSecAddress=ipsCookieSecAddress, firmwareStorage=firmwareStorage, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, srvcName=srvcName, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsHdrAclAddressType=ipsHdrAclAddressType, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsHdrAclHits=ipsHdrAclHits, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, totalMem=totalMem, webCacheLongHdrs=webCacheLongHdrs, httpSrvrState=httpSrvrState, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, vipStatus=vipStatus, ipsReqSrvcPort=ipsReqSrvcPort, sslProxyActiveConn=sslProxyActiveConn, processCountHigh=processCountHigh, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsStatsGroup=bwsStatsGroup, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpProxyServerAbrt=httpProxyServerAbrt, serviceStatus=serviceStatus, virusDefUpdates=virusDefUpdates, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, tempCritical=tempCritical, httpSrvrSrvcPort=httpSrvrSrvcPort, dataPathStatus=dataPathStatus, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, switchingToInlineMode=switchingToInlineMode, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpProxyOutBytes=httpProxyOutBytes, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, smAgentName=smAgentName, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsCacheStatsEntry=bwsCacheStatsEntry, webCacheStale=webCacheStale, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsRCTotDropped=ipsRCTotDropped, bwsMIBCompliance=bwsMIBCompliance, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsStats=bwsStats, freeMem=freeMem, ipsWebAddrTransPort=ipsWebAddrTransPort, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsCacheStatsTable=bwsCacheStatsTable, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsServiceStatusTable=bwsServiceStatusTable, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, uptime=uptime, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpSrvrTotResponse=httpSrvrTotResponse, securityDefUpdates=securityDefUpdates, bwsMessage=bwsMessage, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsMIBConformance=bwsMIBConformance, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrOutBytes=httpSrvrOutBytes, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, peerDown=peerDown, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, switchingToBypassMode=switchingToBypassMode, cpuTemperature=cpuTemperature, energizeUpdateExpire=energizeUpdateExpire, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, switchingToMaintMode=switchingToMaintMode, webCacheProtocol=webCacheProtocol)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrNumFreeConn=sslSrvrNumFreeConn, webCmprProtocol=webCmprProtocol, memoryUsageHigh=memoryUsageHigh, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsUrlNormAddress=ipsUrlNormAddress, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpProxyServerReq=httpProxyServerReq, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, newAttackDefinitionInstalled=newAttackDefinitionInstalled, systemSerialNumber=systemSerialNumber, webCacheAddressType=webCacheAddressType, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, webCacheMiss=webCacheMiss, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, serverDown=serverDown, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, memUtilization=memUtilization, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsMIBCompliances=bwsMIBCompliances, serverUp=serverUp, bwsCompressionStatsTable=bwsCompressionStatsTable, webCacheHits=webCacheHits, ipsLrnSrvcPort=ipsLrnSrvcPort, sslProxyOutBytes=sslProxyOutBytes, sslSrvrTotSuccess=sslSrvrTotSuccess, webCacheAddress=webCacheAddress, bwsTrapGroup=bwsTrapGroup, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslSrvrPort=sslSrvrPort, highAvailabilityStatus=highAvailabilityStatus, ipsUrlNormAddressType=ipsUrlNormAddressType, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsUrlNormPort=ipsUrlNormPort, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, totalServers=totalServers, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, fanDead=fanDead, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslSrvrTotRefused=sslSrvrTotRefused, httpSrvrAddress=httpSrvrAddress, sslProxyBadCRLErr=sslProxyBadCRLErr, cpuUtilization=cpuUtilization, sslProxyAddress=sslProxyAddress, httpProxyUnknownRsp=httpProxyUnknownRsp, sslProxyErrPms=sslProxyErrPms, ipsRCTimeStamp=ipsRCTimeStamp, webCmprAddressType=webCmprAddressType, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpProxySessionTimeOut=httpProxySessionTimeOut, bws=bws, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslProxyTotalConn=sslProxyTotalConn, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, systemFailOver=systemFailOver, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr)
