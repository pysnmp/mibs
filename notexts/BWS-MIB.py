...
Gauge32, Unsigned32, NotificationType, TimeTicks, Bits, MibIdentifier, Counter64, iso, ModuleIdentity, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "NotificationType", "TimeTicks", "Bits", "MibIdentifier", "Counter64", "iso", "ModuleIdentity", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("BWS-MIB", bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslSrvrMinResTime=sslSrvrMinResTime, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpSrvrTotReqActive=httpSrvrTotReqActive, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrNumConn=sslSrvrNumConn, smNumUserSessions=smNumUserSessions, PYSNMP_MODULE_ID=bws, webCmprPort=webCmprPort, tempHigh=tempHigh, sslProxyOutBytes=sslProxyOutBytes, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsCookieSecAddress=ipsCookieSecAddress, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, totalApplications=totalApplications, sslProxyBadDNCErr=sslProxyBadDNCErr, systemSerialNumber=systemSerialNumber, bwsMIBCompliances=bwsMIBCompliances, vipStatus=vipStatus, httpProxyServerAbrt=httpProxyServerAbrt, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, srvcName=srvcName, ipsReqLimitPort=ipsReqLimitPort, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, virusDefUpdates=virusDefUpdates, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsCacheStatsEntry=bwsCacheStatsEntry, switchingToMaintMode=switchingToMaintMode, httpSrvrAddress=httpSrvrAddress, logStorage=logStorage, cpuFanSpeed=cpuFanSpeed, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsUrlAclPort=ipsUrlAclPort, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, smAgentName=smAgentName, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpSrvrMaxResTime=httpSrvrMaxResTime, webCmprAddress=webCmprAddress, webCacheAddress=webCacheAddress, httpProxyTotalReq=httpProxyTotalReq, systemFailure=systemFailure, sslProxyAddressType=sslProxyAddressType, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, activeApplications=activeApplications, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, firmwareStorageHigh=firmwareStorageHigh, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, serverDown=serverDown, totalBandwidth=totalBandwidth, httpProxyClientAbrt=httpProxyClientAbrt, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrMaxResTime=sslSrvrMaxResTime, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslProxyTotalConn=sslProxyTotalConn, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlNormAddress=ipsUrlNormAddress, webCmprProtocol=webCmprProtocol, bwsStatsGroup=bwsStatsGroup, ipsRCTotServed=ipsRCTotServed, ipsRCPort=ipsRCPort, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, systemFailOver=systemFailOver, httpSrvrOutBytes=httpSrvrOutBytes, bwsMessage=bwsMessage, httpProxyAddress=httpProxyAddress, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sharedSecretKeyExpired=sharedSecretKeyExpired, webCacheLongHdrs=webCacheLongHdrs, firmwareStorage=firmwareStorage, switchingToBypassMode=switchingToBypassMode, servicePort=servicePort, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpSrvrTotRefused=httpSrvrTotRefused, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpProxyOutBytes=httpProxyOutBytes, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsLrnSrvcAddress=ipsLrnSrvcAddress, serverUp=serverUp, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrTotSuccess=sslSrvrTotSuccess, fanDead=fanDead, ipsUrlPolicyAddress=ipsUrlPolicyAddress, memUtilization=memUtilization, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, switchingToInlineMode=switchingToInlineMode, webCacheAddressType=webCacheAddressType, webCachePort=webCachePort, sslSrvrPort=sslSrvrPort, ipsReqSrvcAddress=ipsReqSrvcAddress, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, cpuUtilization=cpuUtilization, processCountHigh=processCountHigh, httpProxyActiveConn=httpProxyActiveConn, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpSrvrTotSuccess=httpSrvrTotSuccess, memoryUsageHigh=memoryUsageHigh, ipsHdrAclHits=ipsHdrAclHits, logStorageHigh=logStorageHigh, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrTotRefused=sslSrvrTotRefused, dataPortLinkUp=dataPortLinkUp, sslProxyInBytes=sslProxyInBytes, smRealmName=smRealmName, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, freeMem=freeMem, httpSrvrState=httpSrvrState, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, uptime=uptime, bwsMIBConformance=bwsMIBConformance, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsReqSrvcPort=ipsReqSrvcPort, bws=bws, httpSrvrMinResTime=httpSrvrMinResTime, sslSrvrOutBytes=sslSrvrOutBytes, totalServers=totalServers, energizeUpdateExpire=energizeUpdateExpire, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpProxyPort=httpProxyPort, ipsHdrAclAddress=ipsHdrAclAddress, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, tempCritical=tempCritical, systemFanSpeed=systemFanSpeed, sslSrvrInBytes=sslSrvrInBytes, webCacheReq=webCacheReq, httpProxyParseErr=httpProxyParseErr, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, webCacheCachedObjects=webCacheCachedObjects, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, webCacheHits=webCacheHits, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrAddressType=httpSrvrAddressType, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsRCTimeStamp=ipsRCTimeStamp, securityDefUpdates=securityDefUpdates, httpSrvrSrvcAddress=httpSrvrSrvcAddress, currentFirmwareVersion=currentFirmwareVersion, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, raidDegrading=raidDegrading, bwsTrapGroup=bwsTrapGroup, ipsReqLimitAddressType=ipsReqLimitAddressType, httpProxyTotalConn=httpProxyTotalConn, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpSrvrNumConn=httpSrvrNumConn, activeServers=activeServers, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsCookieSecPort=ipsCookieSecPort, ipsRCAddress=ipsRCAddress, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslProxyTotalReq=sslProxyTotalReq, httpProxyInBytes=httpProxyInBytes, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, webCacheProtocol=webCacheProtocol, bwsStats=bwsStats, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpSrvrPort=httpSrvrPort, webCacheMiss=webCacheMiss, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpProxyUnknownRsp=httpProxyUnknownRsp, totalMem=totalMem, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwstraps=bwstraps, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsUrlNormPort=ipsUrlNormPort, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslProxyCacheMiss=sslProxyCacheMiss, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, systemLoad=systemLoad, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, webCacheBytesOut=webCacheBytesOut, ipsCookieSecEncrypted=ipsCookieSecEncrypted, webCacheStale=webCacheStale, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, serviceAddress=serviceAddress, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslProxyAddress=sslProxyAddress, httpProxyServerReq=httpProxyServerReq, sslSrvrAddress=sslSrvrAddress, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslSrvrAddressType=sslSrvrAddressType, dataPortLinkDown=dataPortLinkDown, ipsUrlNormAddressType=ipsUrlNormAddressType, httpProxyServerErr=httpProxyServerErr, bwsMIBCompliance=bwsMIBCompliance, ipsRCTotQueued=ipsRCTotQueued, sslProxyActiveConn=sslProxyActiveConn, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrSrvcPort=httpSrvrSrvcPort, dataPathStatus=dataPathStatus, webCacheCacheableRes=webCacheCacheableRes)
mibBuilder.exportSymbols("BWS-MIB", bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsRCTotDropped=ipsRCTotDropped, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslProxyCurrentConn=sslProxyCurrentConn, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsMIBGroups=bwsMIBGroups, ipsCookieSecTampered=ipsCookieSecTampered, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, linkStatus=linkStatus, ipsHdrAclPort=ipsHdrAclPort, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, highAvailabilityStatus=highAvailabilityStatus, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, peerDown=peerDown, ipsUrlAclAddressType=ipsUrlAclAddressType, sslSrvrState=sslSrvrState, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrTotResponse=sslSrvrTotResponse, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsUrlAclAddress=ipsUrlAclAddress, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, totalAttacks=totalAttacks, httpProxySessionTimeOut=httpProxySessionTimeOut, cpuTemperature=cpuTemperature, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslProxyPort=sslProxyPort, httpSrvrInBytes=httpSrvrInBytes, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsUrlPolicyPort=ipsUrlPolicyPort, serviceName=serviceName, serviceStatus=serviceStatus, ipsRCAddressType=ipsRCAddressType, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrTotResponse=httpSrvrTotResponse, operationalMode=operationalMode, sslSrvrTotTimedout=sslSrvrTotTimedout, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, webCmprAddressType=webCmprAddressType, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsReqLimitAddress=ipsReqLimitAddress, sslProxyErrPms=sslProxyErrPms, peerUp=peerUp, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpProxyAddressType=httpProxyAddressType, sslProxyCacheHits=sslProxyCacheHits, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource)
