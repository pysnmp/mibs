...
Integer32, iso, TimeTicks, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, MibIdentifier, Counter64, IpAddress, ObjectIdentity, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "TimeTicks", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "MibIdentifier", "Counter64", "IpAddress", "ObjectIdentity", "Counter32", "Bits")
...
mibBuilder.exportSymbols("BWS-MIB", bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, webCacheBytesOut=webCacheBytesOut, freeMem=freeMem, ipsUrlAclAddress=ipsUrlAclAddress, httpProxyTotalConn=httpProxyTotalConn, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsServiceStatusTable=bwsServiceStatusTable, ipsUrlNormPort=ipsUrlNormPort, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslProxyErrPms=sslProxyErrPms, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsReqLimitAddressType=ipsReqLimitAddressType, bwstraps=bwstraps, ipsReqLimitAddress=ipsReqLimitAddress, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsSMUserSessionTable=bwsSMUserSessionTable, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrOutBytes=sslSrvrOutBytes, sslProxyCacheHits=sslProxyCacheHits, sslSrvrMinResTime=sslSrvrMinResTime, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsRCAddress=ipsRCAddress, PYSNMP_MODULE_ID=bws, sslSrvrState=sslSrvrState, bws=bws, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsRCTotServed=ipsRCTotServed, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpProxyServerAbrt=httpProxyServerAbrt, operationalMode=operationalMode, httpProxyInBytes=httpProxyInBytes, httpSrvrOutBytes=httpSrvrOutBytes, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, fanDead=fanDead, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, systemFailOver=systemFailOver, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslSrvrTotResponse=sslSrvrTotResponse, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, peerDown=peerDown, ipsReqLimitPort=ipsReqLimitPort, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsRCTimeStamp=ipsRCTimeStamp, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsMIBCompliances=bwsMIBCompliances, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpProxySessionTimeOut=httpProxySessionTimeOut, smNumUserSessions=smNumUserSessions, httpSrvrAvgResTime=httpSrvrAvgResTime, systemFailure=systemFailure, ipsRCTotOutOfResource=ipsRCTotOutOfResource, webCmprAddressType=webCmprAddressType, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrTotSuccess=sslSrvrTotSuccess, webCacheReq=webCacheReq, sslProxyCacheTimeouts=sslProxyCacheTimeouts, smRealmName=smRealmName, webCacheMiss=webCacheMiss, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, uptime=uptime, httpSrvrPort=httpSrvrPort, sslProxyActiveConn=sslProxyActiveConn, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslSrvrAddress=sslSrvrAddress, httpProxyServerReq=httpProxyServerReq, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, webCacheLongHdrs=webCacheLongHdrs, sslProxyOutBytes=sslProxyOutBytes, sslSrvrTotRefused=sslSrvrTotRefused, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslProxyCurrentConn=sslProxyCurrentConn, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, activeServers=activeServers, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsReqSrvcAddress=ipsReqSrvcAddress, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, totalServers=totalServers, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpProxyActiveConn=httpProxyActiveConn, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpProxyPort=httpProxyPort, webCmprAddress=webCmprAddress, ipsCookieSecAddress=ipsCookieSecAddress, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrTotRefused=httpSrvrTotRefused, webCacheCachedObjects=webCacheCachedObjects, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, linkStatus=linkStatus, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpSrvrMinResTime=httpSrvrMinResTime, httpSrvrTotResponse=httpSrvrTotResponse, httpProxyOutBytes=httpProxyOutBytes, bwsStats=bwsStats, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, peerUp=peerUp, memoryUsageHigh=memoryUsageHigh, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsHdrAclAddress=ipsHdrAclAddress, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslProxyTotalConn=sslProxyTotalConn, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, serverDown=serverDown, dataPortLinkUp=dataPortLinkUp, cpuTemperature=cpuTemperature, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsUrlPolicyPort=ipsUrlPolicyPort, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslSrvrAddressType=sslSrvrAddressType, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpProxyWAFWarnings=httpProxyWAFWarnings, serviceName=serviceName, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslProxyTotalReq=sslProxyTotalReq, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsMIBGroups=bwsMIBGroups, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsRCPort=ipsRCPort, highAvailabilityStatus=highAvailabilityStatus, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, memUtilization=memUtilization, processCountHigh=processCountHigh, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrAddress=httpSrvrAddress, tempCritical=tempCritical, dataPathStatus=dataPathStatus, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsHdrAclHits=ipsHdrAclHits, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslSrvrPort=sslSrvrPort, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsUrlAclReserved=ipsUrlAclReserved, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, logStorage=logStorage, webCacheCacheableRes=webCacheCacheableRes, ipsRCTotDropped=ipsRCTotDropped, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, totalAttacks=totalAttacks, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsCookieSecTampered=ipsCookieSecTampered, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, webCacheAddress=webCacheAddress, httpProxyParseErr=httpProxyParseErr, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, firmwareStorageHigh=firmwareStorageHigh, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrTotReqActive=sslSrvrTotReqActive, sslProxyAddressType=sslProxyAddressType, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsLrnSrvcPort=ipsLrnSrvcPort, httpProxyAddress=httpProxyAddress, bwsMIBConformance=bwsMIBConformance, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsReqSrvcPort=ipsReqSrvcPort, tempHigh=tempHigh, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsUrlNormAddress=ipsUrlNormAddress, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sharedSecretKeyExpired=sharedSecretKeyExpired, vipStatus=vipStatus, httpSrvrSrvcPort=httpSrvrSrvcPort, serviceStatus=serviceStatus, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpSrvrMaxResTime=httpSrvrMaxResTime, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrState=httpSrvrState, bwsTrapGroup=bwsTrapGroup, servicePort=servicePort, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrInBytes=httpSrvrInBytes, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsMessage=bwsMessage, firmwareStorage=firmwareStorage, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, totalBandwidth=totalBandwidth, webCmprProtocol=webCmprProtocol, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslSrvrNumConn=sslSrvrNumConn, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, systemFanSpeed=systemFanSpeed, httpProxyServerErr=httpProxyServerErr, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, webCacheAddressType=webCacheAddressType, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsCookieSecPort=ipsCookieSecPort)
mibBuilder.exportSymbols("BWS-MIB", activeApplications=activeApplications, httpSrvrNumConn=httpSrvrNumConn, cpuFanSpeed=cpuFanSpeed, httpProxyTotalReq=httpProxyTotalReq, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, smAgentName=smAgentName, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpSrvrTotSuccess=httpSrvrTotSuccess, sslSrvrNumFreeConn=sslSrvrNumFreeConn, serverUp=serverUp, webCmprPort=webCmprPort, sslSrvrInBytes=sslSrvrInBytes, dataPortLinkDown=dataPortLinkDown, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, serviceAddress=serviceAddress, totalMem=totalMem, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsStatsGroup=bwsStatsGroup, systemSerialNumber=systemSerialNumber, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, firmwareUpdateAvailable=firmwareUpdateAvailable, logStorageHigh=logStorageHigh, ipsUrlAclAddressType=ipsUrlAclAddressType, httpProxyClientAbrt=httpProxyClientAbrt, ipsRCTotQueued=ipsRCTotQueued, ipsHdrAclPort=ipsHdrAclPort, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, cpuUtilization=cpuUtilization, sslProxyCacheMiss=sslProxyCacheMiss, switchingToInlineMode=switchingToInlineMode, httpProxyAddressType=httpProxyAddressType, currentFirmwareVersion=currentFirmwareVersion, systemLoad=systemLoad, httpSrvrTotReqActive=httpSrvrTotReqActive, switchingToMaintMode=switchingToMaintMode, ipsRCAddressType=ipsRCAddressType, bwsMIBCompliance=bwsMIBCompliance, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsUrlAclPort=ipsUrlAclPort, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, webCmprCompressedDataSize=webCmprCompressedDataSize, webCacheProtocol=webCacheProtocol, raidDegrading=raidDegrading, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, energizeUpdateExpire=energizeUpdateExpire, sslProxyAddress=sslProxyAddress, totalApplications=totalApplications, webCacheStale=webCacheStale, httpSrvrAddressType=httpSrvrAddressType, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, webCachePort=webCachePort, sslProxyPort=sslProxyPort, securityDefUpdates=securityDefUpdates, webCacheHits=webCacheHits, sslProxyInBytes=sslProxyInBytes, virusDefUpdates=virusDefUpdates, srvcName=srvcName, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslProxyBadDNCErr=sslProxyBadDNCErr, switchingToBypassMode=switchingToBypassMode, httpSrvrTotTimedout=httpSrvrTotTimedout)
