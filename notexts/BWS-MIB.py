...
IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, Bits, NotificationType, ModuleIdentity, Unsigned32, Counter32, MibIdentifier, TimeTicks, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "Bits", "NotificationType", "ModuleIdentity", "Unsigned32", "Counter32", "MibIdentifier", "TimeTicks", "iso", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", ipsReqLimitAddressType=ipsReqLimitAddressType, dataPortLinkDown=dataPortLinkDown, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, webCacheCachedObjects=webCacheCachedObjects, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslSrvrTotRefused=sslSrvrTotRefused, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsCookieSecPort=ipsCookieSecPort, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, securityDefUpdates=securityDefUpdates, bwstraps=bwstraps, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrTotTimedout=httpSrvrTotTimedout, memoryUsageHigh=memoryUsageHigh, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsMessage=bwsMessage, httpProxyClientAbrt=httpProxyClientAbrt, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsRCTotQueued=ipsRCTotQueued, sslSrvrTotSuccess=sslSrvrTotSuccess, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslProxyAddressType=sslProxyAddressType, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsHdrAclHits=ipsHdrAclHits, srvcName=srvcName, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsRCTotDropped=ipsRCTotDropped, operationalMode=operationalMode, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrTotTimedout=sslSrvrTotTimedout, firmwareStorageHigh=firmwareStorageHigh, httpProxyTotalConn=httpProxyTotalConn, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslProxyCacheMiss=sslProxyCacheMiss, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, highAvailabilityStatus=highAvailabilityStatus, ipsHdrAclAddress=ipsHdrAclAddress, ipsCookieSecAddress=ipsCookieSecAddress, bwsCompressionStatsEntry=bwsCompressionStatsEntry, webCacheProtocol=webCacheProtocol, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, energizeUpdateExpire=energizeUpdateExpire, httpProxyTotalReq=httpProxyTotalReq, webCacheBytesOut=webCacheBytesOut, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, webCmprAddress=webCmprAddress, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, systemFailure=systemFailure, sslProxyAddress=sslProxyAddress, ipsUrlNormAddressType=ipsUrlNormAddressType, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, webCmprPort=webCmprPort, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslProxyInBytes=sslProxyInBytes, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, tempHigh=tempHigh, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, webCacheCacheableRes=webCacheCacheableRes, processCountHigh=processCountHigh, memUtilization=memUtilization, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpProxyServerErr=httpProxyServerErr, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, linkStatus=linkStatus, raidDegrading=raidDegrading, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsReqLimitAddress=ipsReqLimitAddress, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, currentFirmwareVersion=currentFirmwareVersion, webCacheAddressType=webCacheAddressType, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsMIBCompliances=bwsMIBCompliances, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, peerUp=peerUp, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslSrvrState=sslSrvrState, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpProxyInBytes=httpProxyInBytes, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslSrvrTotResponse=sslSrvrTotResponse, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsUrlAclAddress=ipsUrlAclAddress, httpProxyActiveConn=httpProxyActiveConn, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, switchingToInlineMode=switchingToInlineMode, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, webCacheReq=webCacheReq, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, totalApplications=totalApplications, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrOutBytes=httpSrvrOutBytes, virusDefUpdates=virusDefUpdates, httpSrvrMinResTime=httpSrvrMinResTime, httpProxyParseErr=httpProxyParseErr, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsSMUserSessionTable=bwsSMUserSessionTable, sslSrvrNumConn=sslSrvrNumConn, ipsReqSrvcPort=ipsReqSrvcPort, systemFanSpeed=systemFanSpeed, httpSrvrAddress=httpSrvrAddress, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, webCacheHits=webCacheHits, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpSrvrTotSuccess=httpSrvrTotSuccess, cpuFanSpeed=cpuFanSpeed, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsRCPort=ipsRCPort, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsUrlNormPort=ipsUrlNormPort, sslProxyTotalConn=sslProxyTotalConn, httpSrvrTotResponse=httpSrvrTotResponse, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, smRealmName=smRealmName, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, serverUp=serverUp, bwsSMUserSessionEntry=bwsSMUserSessionEntry, totalServers=totalServers, bwsMIBConformance=bwsMIBConformance, sslSrvrAddress=sslSrvrAddress, firmwareStorage=firmwareStorage, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrTotReqActive=httpSrvrTotReqActive, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsUrlNormAddress=ipsUrlNormAddress, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrSrvcPort=httpSrvrSrvcPort, webCacheStale=webCacheStale, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, freeMem=freeMem, bwsServiceStatusTable=bwsServiceStatusTable, systemSerialNumber=systemSerialNumber, ipsReqLimitPort=ipsReqLimitPort, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsUrlAclPort=ipsUrlAclPort, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsCookieSecTampered=ipsCookieSecTampered, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, PYSNMP_MODULE_ID=bws, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, dataPathStatus=dataPathStatus, sslSrvrInBytes=sslSrvrInBytes, sslSrvrOutBytes=sslSrvrOutBytes, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, serviceName=serviceName, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, switchingToBypassMode=switchingToBypassMode, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslSrvrAddressType=sslSrvrAddressType, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, webCmprProtocol=webCmprProtocol, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsRCTotOutOfResource=ipsRCTotOutOfResource, peerDown=peerDown, totalAttacks=totalAttacks, sslProxyTotalReq=sslProxyTotalReq, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpProxySessionTimeOut=httpProxySessionTimeOut, smNumUserSessions=smNumUserSessions, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpProxyServerReq=httpProxyServerReq, httpSrvrPort=httpSrvrPort, switchingToMaintMode=switchingToMaintMode, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsHdrAclAddressType=ipsHdrAclAddressType, httpProxyOutBytes=httpProxyOutBytes, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, totalBandwidth=totalBandwidth, fanDead=fanDead, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, serviceStatus=serviceStatus, bwsCacheStatsTable=bwsCacheStatsTable, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsRCAddressType=ipsRCAddressType, sslSrvrMinResTime=sslSrvrMinResTime, httpSrvrTotRefused=httpSrvrTotRefused, httpSrvrInBytes=httpSrvrInBytes, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsStats=bwsStats, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpProxyPort=httpProxyPort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslSrvrTotReqActive=sslSrvrTotReqActive, httpProxyUnknownRsp=httpProxyUnknownRsp, webCacheAddress=webCacheAddress, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, dataPortLinkUp=dataPortLinkUp, httpSrvrAddressType=httpSrvrAddressType, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslProxyErrPms=sslProxyErrPms, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsStatsGroup=bwsStatsGroup, totalMem=totalMem, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, logStorage=logStorage, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, serviceAddress=serviceAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsMIBGroups=bwsMIBGroups, httpSrvrNumConn=httpSrvrNumConn, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits)
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, smAgentName=smAgentName, webCmprCompressibleDataSize=webCmprCompressibleDataSize, webCacheLongHdrs=webCacheLongHdrs, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bws=bws, httpSrvrMaxResTime=httpSrvrMaxResTime, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsTrapGroup=bwsTrapGroup, sslProxyOutBytes=sslProxyOutBytes, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, activeApplications=activeApplications, sslSrvrMaxResTime=sslSrvrMaxResTime, serverDown=serverDown, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsRCTotServed=ipsRCTotServed, vipStatus=vipStatus, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsMIBCompliance=bwsMIBCompliance, ipsWebAddrTransPort=ipsWebAddrTransPort, cpuUtilization=cpuUtilization, servicePort=servicePort, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpProxyAddress=httpProxyAddress, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, webCacheMiss=webCacheMiss, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsRCAddress=ipsRCAddress, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, cpuTemperature=cpuTemperature, sslProxyActiveConn=sslProxyActiveConn, systemLoad=systemLoad, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpProxyServerAbrt=httpProxyServerAbrt, sslProxyCacheHits=sslProxyCacheHits, httpSrvrState=httpSrvrState, sslSrvrAvgResTime=sslSrvrAvgResTime, sslSrvrSrvcPort=sslSrvrSrvcPort, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, logStorageHigh=logStorageHigh, webCachePort=webCachePort, activeServers=activeServers, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, webCmprAddressType=webCmprAddressType, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsRCTimeStamp=ipsRCTimeStamp, systemFailOver=systemFailOver, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrPort=sslSrvrPort, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslProxyCurrentConn=sslProxyCurrentConn, sslProxyPort=sslProxyPort, uptime=uptime, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsHdrAclPort=ipsHdrAclPort, tempCritical=tempCritical, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpProxyAddressType=httpProxyAddressType)
