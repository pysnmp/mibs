...
NotificationType, TimeTicks, Counter32, Bits, Gauge32, ModuleIdentity, Integer32, iso, IpAddress, Unsigned32, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "Counter32", "Bits", "Gauge32", "ModuleIdentity", "Integer32", "iso", "IpAddress", "Unsigned32", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, webCacheAddress=webCacheAddress, bwsSMUserSessionEntry=bwsSMUserSessionEntry, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslProxyCacheMiss=sslProxyCacheMiss, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, serverUp=serverUp, bwsServiceStatusTable=bwsServiceStatusTable, totalMem=totalMem, raidDegrading=raidDegrading, memoryUsageHigh=memoryUsageHigh, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsHdrAclHits=ipsHdrAclHits, httpProxyServerReq=httpProxyServerReq, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrMaxResTime=httpSrvrMaxResTime, activeServers=activeServers, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsCookieSecTampered=ipsCookieSecTampered, bws=bws, srvcName=srvcName, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsRCTotQueued=ipsRCTotQueued, cpuUtilization=cpuUtilization, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsUrlNormAddress=ipsUrlNormAddress, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslProxyErrPms=sslProxyErrPms, systemFailure=systemFailure, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsUrlAclPort=ipsUrlAclPort, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, totalBandwidth=totalBandwidth, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrOutBytes=sslSrvrOutBytes, sslSrvrPort=sslSrvrPort, httpProxyOutBytes=httpProxyOutBytes, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, webCacheReq=webCacheReq, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsUrlNormAddressType=ipsUrlNormAddressType, highAvailabilityStatus=highAvailabilityStatus, sslSrvrTotRefused=sslSrvrTotRefused, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, totalAttacks=totalAttacks, webCmprPort=webCmprPort, ipsHdrAclAddress=ipsHdrAclAddress, ipsHdrAclAddressType=ipsHdrAclAddressType, webCachePort=webCachePort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsCookieSecAddress=ipsCookieSecAddress, PYSNMP_MODULE_ID=bws, httpSrvrTotRefused=httpSrvrTotRefused, sslProxyOutBytes=sslProxyOutBytes, smAgentName=smAgentName, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslSrvrAvgResTime=sslSrvrAvgResTime, httpSrvrInBytes=httpSrvrInBytes, dataPortLinkDown=dataPortLinkDown, sslProxyAddressType=sslProxyAddressType, webCacheProtocol=webCacheProtocol, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpProxyAddressType=httpProxyAddressType, sslSrvrNumConn=sslSrvrNumConn, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, systemFanSpeed=systemFanSpeed, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrOutBytes=httpSrvrOutBytes, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, totalServers=totalServers, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, tempCritical=tempCritical, systemLoad=systemLoad, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpProxyServerErr=httpProxyServerErr, httpSrvrNumConn=httpSrvrNumConn, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsMIBCompliance=bwsMIBCompliance, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, webCacheAddressType=webCacheAddressType, smNumUserSessions=smNumUserSessions, httpProxyAddress=httpProxyAddress, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpSrvrState=httpSrvrState, httpProxyServerAbrt=httpProxyServerAbrt, webCacheBytesOut=webCacheBytesOut, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsReqSrvcPort=ipsReqSrvcPort, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpSrvrMinResTime=httpSrvrMinResTime, httpSrvrTotSuccess=httpSrvrTotSuccess, httpProxyWAFWarnings=httpProxyWAFWarnings, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsHdrAclPort=ipsHdrAclPort, httpProxyUnknownRsp=httpProxyUnknownRsp, firmwareUpdateAvailable=firmwareUpdateAvailable, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsMIBCompliances=bwsMIBCompliances, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, peerUp=peerUp, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsRCTimeStamp=ipsRCTimeStamp, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsStatsGroup=bwsStatsGroup, sslProxyActiveConn=sslProxyActiveConn, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpProxyTotalReq=httpProxyTotalReq, ipsReqSrvcAddressType=ipsReqSrvcAddressType, webCmprProtocol=webCmprProtocol, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, logStorageHigh=logStorageHigh, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlNormPort=ipsUrlNormPort, uptime=uptime, cpuFanSpeed=cpuFanSpeed, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsCookieSecAddressType=ipsCookieSecAddressType, sslProxyInBytes=sslProxyInBytes, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, dataPathStatus=dataPathStatus, httpSrvrAddressType=httpSrvrAddressType, sslSrvrAddressType=sslSrvrAddressType, ipsUrlAclReserved=ipsUrlAclReserved, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, webCacheStale=webCacheStale, switchingToMaintMode=switchingToMaintMode, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpProxyPort=httpProxyPort, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, energizeUpdateExpire=energizeUpdateExpire, webCacheHits=webCacheHits, ipsCookieSecEncrypted=ipsCookieSecEncrypted, webCacheLongHdrs=webCacheLongHdrs, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslSrvrTotSuccess=sslSrvrTotSuccess, servicePort=servicePort, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsCookieSecPort=ipsCookieSecPort, serviceName=serviceName, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsMIBGroups=bwsMIBGroups, sslProxyCacheHits=sslProxyCacheHits, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, fanDead=fanDead, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, peerDown=peerDown, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrAddress=sslSrvrAddress, sslProxyCurrentConn=sslProxyCurrentConn, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpProxyTotalConn=httpProxyTotalConn, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsWebAddrTransAddress=ipsWebAddrTransAddress, activeApplications=activeApplications, firmwareStorage=firmwareStorage, httpSrvrPort=httpSrvrPort, totalApplications=totalApplications, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, webCacheCachedObjects=webCacheCachedObjects, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, tempHigh=tempHigh, webCmprAddress=webCmprAddress, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpProxyInBytes=httpProxyInBytes, switchingToInlineMode=switchingToInlineMode, sslProxyBadDNCErr=sslProxyBadDNCErr, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsReqLimitAddress=ipsReqLimitAddress, httpSrvrTotReqActive=httpSrvrTotReqActive, systemFailOver=systemFailOver, serviceAddress=serviceAddress, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, webCmprAddressType=webCmprAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, smRealmName=smRealmName, httpProxyClientAbrt=httpProxyClientAbrt, ipsRCAddressType=ipsRCAddressType, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, memUtilization=memUtilization, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsCacheStatsTable=bwsCacheStatsTable, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, dataPortLinkUp=dataPortLinkUp, virusDefUpdates=virusDefUpdates, processCountHigh=processCountHigh, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsLrnSrvcPort=ipsLrnSrvcPort, vipStatus=vipStatus, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, serverDown=serverDown, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsRCTotServed=ipsRCTotServed, httpSrvrTotResponse=httpSrvrTotResponse, bwsServiceStatusEntry=bwsServiceStatusEntry, securityDefUpdates=securityDefUpdates)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslProxyAddress=sslProxyAddress, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, switchingToBypassMode=switchingToBypassMode, cpuTemperature=cpuTemperature, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, linkStatus=linkStatus, bwsMIBConformance=bwsMIBConformance, logStorage=logStorage, bwsCacheStatsEntry=bwsCacheStatsEntry, sslProxyTotalConn=sslProxyTotalConn, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsTrapGroup=bwsTrapGroup, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, freeMem=freeMem, bwsMessage=bwsMessage, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsReqLimitPort=ipsReqLimitPort, sslSrvrInBytes=sslSrvrInBytes, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslProxyTotalReq=sslProxyTotalReq, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsRCPort=ipsRCPort, sslSrvrSrvcPort=sslSrvrSrvcPort, currentFirmwareVersion=currentFirmwareVersion, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, webCacheMiss=webCacheMiss, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslSrvrState=sslSrvrState, ipsRCTotDropped=ipsRCTotDropped, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsStats=bwsStats, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, firmwareStorageHigh=firmwareStorageHigh, webCacheCacheableRes=webCacheCacheableRes, httpProxyParseErr=httpProxyParseErr, sslSrvrTotResponse=sslSrvrTotResponse, httpSrvrAddress=httpSrvrAddress, bwstraps=bwstraps, ipsRCAddress=ipsRCAddress, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslProxyPort=sslProxyPort, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslSrvrMinResTime=sslSrvrMinResTime, operationalMode=operationalMode, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, systemSerialNumber=systemSerialNumber, httpProxyActiveConn=httpProxyActiveConn, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, serviceStatus=serviceStatus)
