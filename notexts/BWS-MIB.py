...
# Produced by pysmi-1.1.8 at Fri Sep  8 11:02:52 2023
...
Counter32, TimeTicks, Unsigned32, Gauge32, Integer32, MibIdentifier, NotificationType, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "Unsigned32", "Gauge32", "Integer32", "MibIdentifier", "NotificationType", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "Bits", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, systemFailure=systemFailure, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsRCAddress=ipsRCAddress, httpProxyServerAbrt=httpProxyServerAbrt, peerUp=peerUp, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsRCPort=ipsRCPort, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, webCacheCachedObjects=webCacheCachedObjects, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, logStorageHigh=logStorageHigh, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrTotSuccess=httpSrvrTotSuccess, httpProxyClientAbrt=httpProxyClientAbrt, bwsMIBGroups=bwsMIBGroups, sslProxyCacheMiss=sslProxyCacheMiss, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, serviceAddress=serviceAddress, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsMIBConformance=bwsMIBConformance, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, PYSNMP_MODULE_ID=bws, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, processCountHigh=processCountHigh, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsCookieSecAddressType=ipsCookieSecAddressType, firmwareStorage=firmwareStorage, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsMIBCompliance=bwsMIBCompliance, bwsServiceStatusEntry=bwsServiceStatusEntry, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bws=bws, dataPathStatus=dataPathStatus, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpProxyParseErr=httpProxyParseErr, webCacheMiss=webCacheMiss, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsUrlAclAddress=ipsUrlAclAddress, firmwareUpdateAvailable=firmwareUpdateAvailable, webCmprProtocol=webCmprProtocol, serviceName=serviceName, sslSrvrSrvcPort=sslSrvrSrvcPort, fanDead=fanDead, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslProxyPort=sslProxyPort, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlNormPort=ipsUrlNormPort, firmwareStorageHigh=firmwareStorageHigh, sslSrvrInBytes=sslSrvrInBytes, ipsReqLimitAddress=ipsReqLimitAddress, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrInBytes=httpSrvrInBytes, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpSrvrMinResTime=httpSrvrMinResTime, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsUrlNormAddress=ipsUrlNormAddress, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrTotRefused=httpSrvrTotRefused, tempCritical=tempCritical, logStorage=logStorage, httpProxyAddress=httpProxyAddress, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, switchingToMaintMode=switchingToMaintMode, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsRCTotQueued=ipsRCTotQueued, sslProxyAddressType=sslProxyAddressType, httpProxyTotalReq=httpProxyTotalReq, httpProxyInBytes=httpProxyInBytes, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrTotResponse=httpSrvrTotResponse, ipsCookieSecPort=ipsCookieSecPort, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, systemLoad=systemLoad, sslProxyCacheTimeouts=sslProxyCacheTimeouts, currentFirmwareVersion=currentFirmwareVersion, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsTrapGroup=bwsTrapGroup, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslProxyCacheHits=sslProxyCacheHits, ipsUrlPolicyPort=ipsUrlPolicyPort, cpuFanSpeed=cpuFanSpeed, ipsReqLimitPort=ipsReqLimitPort, sslSrvrTotReqActive=sslSrvrTotReqActive, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslProxyOutBytes=sslProxyOutBytes, httpProxyTotalConn=httpProxyTotalConn, sslProxyActiveConn=sslProxyActiveConn, httpSrvrNumConn=httpSrvrNumConn, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslProxyInBytes=sslProxyInBytes, httpSrvrTotReqActive=httpSrvrTotReqActive, servicePort=servicePort, webCmprAddress=webCmprAddress, sslSrvrTotResponse=sslSrvrTotResponse, sslSrvrState=sslSrvrState, bwstraps=bwstraps, sslSrvrMinResTime=sslSrvrMinResTime, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, cpuUtilization=cpuUtilization, memUtilization=memUtilization, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, totalApplications=totalApplications, ipsRCTotServed=ipsRCTotServed, dataPortLinkUp=dataPortLinkUp, totalBandwidth=totalBandwidth, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsMIBCompliances=bwsMIBCompliances, ipsHdrAclPort=ipsHdrAclPort, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpProxyOutBytes=httpProxyOutBytes, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, totalAttacks=totalAttacks, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, webCacheHits=webCacheHits, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, smNumUserSessions=smNumUserSessions, ipsUrlNormAddressType=ipsUrlNormAddressType, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsMessage=bwsMessage, sslProxyTotalConn=sslProxyTotalConn, freeMem=freeMem, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrNumConn=sslSrvrNumConn, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsSslProxyStatsTable=bwsSslProxyStatsTable, webCacheBytesOut=webCacheBytesOut, sslSrvrAddressType=sslSrvrAddressType, serverDown=serverDown, memoryUsageHigh=memoryUsageHigh, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlAclReserved=ipsUrlAclReserved, ipsHdrAclAddress=ipsHdrAclAddress, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsRCTimeStamp=ipsRCTimeStamp, switchingToBypassMode=switchingToBypassMode, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpProxyPort=httpProxyPort, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, securityDefUpdates=securityDefUpdates, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpSrvrAddressType=httpSrvrAddressType, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpProxyAddressType=httpProxyAddressType, webCacheCacheableRes=webCacheCacheableRes, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrAddress=httpSrvrAddress, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsServiceStatusTable=bwsServiceStatusTable, smAgentName=smAgentName, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, systemFailOver=systemFailOver, webCachePort=webCachePort, linkStatus=linkStatus, httpSrvrState=httpSrvrState, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsCookieSecAddress=ipsCookieSecAddress, energizeUpdateExpire=energizeUpdateExpire, systemSerialNumber=systemSerialNumber, serviceStatus=serviceStatus, totalServers=totalServers, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslSrvrTotSuccess=sslSrvrTotSuccess, highAvailabilityStatus=highAvailabilityStatus, smRealmName=smRealmName, ipsRCTotDropped=ipsRCTotDropped, ipsRCAddressType=ipsRCAddressType, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslSrvrOutBytes=sslSrvrOutBytes, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, webCmprAddressType=webCmprAddressType, cpuTemperature=cpuTemperature, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsCookieSecTampered=ipsCookieSecTampered, sslSrvrNumFreeConn=sslSrvrNumFreeConn, dataPortLinkDown=dataPortLinkDown, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, peerDown=peerDown, sslProxyErrPms=sslProxyErrPms, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrPort=httpSrvrPort, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, totalMem=totalMem, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslProxyTotalReq=sslProxyTotalReq, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, activeServers=activeServers, webCacheReq=webCacheReq, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, switchingToInlineMode=switchingToInlineMode, activeApplications=activeApplications, tempHigh=tempHigh, bwsStats=bwsStats, ipsReqSrvcPort=ipsReqSrvcPort, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, webCacheLongHdrs=webCacheLongHdrs, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, uptime=uptime, httpProxyServerReq=httpProxyServerReq, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, webCmprPort=webCmprPort, httpSrvrOutBytes=httpSrvrOutBytes, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsCookieSecEncrypted=ipsCookieSecEncrypted, vipStatus=vipStatus, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsHdrAclHits=ipsHdrAclHits, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrTotTimedout=sslSrvrTotTimedout, sslSrvrTotRefused=sslSrvrTotRefused, serverUp=serverUp, sslProxyFullHandshakes=sslProxyFullHandshakes, sslSrvrPort=sslSrvrPort, bwsStatsGroup=bwsStatsGroup, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslSrvrMaxResTime=sslSrvrMaxResTime, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, webCacheStale=webCacheStale, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpProxyServerErr=httpProxyServerErr, operationalMode=operationalMode, ipsWebAddrTransPort=ipsWebAddrTransPort, webCacheAddress=webCacheAddress, webCacheProtocol=webCacheProtocol, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslSrvrAddress=sslSrvrAddress, httpProxyUnknownRsp=httpProxyUnknownRsp, raidDegrading=raidDegrading, virusDefUpdates=virusDefUpdates, sslSrvrAvgResTime=sslSrvrAvgResTime, sslProxyAddress=sslProxyAddress, ipsUrlAclPort=ipsUrlAclPort, systemFanSpeed=systemFanSpeed, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, webCacheAddressType=webCacheAddressType, httpProxyActiveConn=httpProxyActiveConn, srvcName=srvcName)
