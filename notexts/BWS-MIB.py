...
ModuleIdentity, ObjectIdentity, Integer32, Gauge32, Counter64, Counter32, iso, MibIdentifier, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "Integer32", "Gauge32", "Counter64", "Counter32", "iso", "MibIdentifier", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("BWS-MIB", serviceAddress=serviceAddress, tempHigh=tempHigh, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsCookieSecAddress=ipsCookieSecAddress, linkStatus=linkStatus, webCmprAddressType=webCmprAddressType, raidDegrading=raidDegrading, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrPort=httpSrvrPort, totalMem=totalMem, ipsRCTotDropped=ipsRCTotDropped, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, webCacheAddress=webCacheAddress, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslSrvrTotSuccess=sslSrvrTotSuccess, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrMinResTime=httpSrvrMinResTime, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsRCTimeStamp=ipsRCTimeStamp, switchingToBypassMode=switchingToBypassMode, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsCacheStatsEntry=bwsCacheStatsEntry, httpProxyTotalReq=httpProxyTotalReq, systemLoad=systemLoad, totalBandwidth=totalBandwidth, sslProxyPort=sslProxyPort, ipsUrlNormPort=ipsUrlNormPort, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, logStorage=logStorage, sslProxyTotalReq=sslProxyTotalReq, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, webCmprCompressedDataSize=webCmprCompressedDataSize, smAgentName=smAgentName, ipsHdrAclAddress=ipsHdrAclAddress, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpSrvrState=httpSrvrState, sslProxyBadDNCErr=sslProxyBadDNCErr, webCacheBytesOut=webCacheBytesOut, httpProxyUnknownRsp=httpProxyUnknownRsp, httpSrvrInBytes=httpSrvrInBytes, ipsReqLimitPort=ipsReqLimitPort, ipsUrlAclAddressType=ipsUrlAclAddressType, systemSerialNumber=systemSerialNumber, servicePort=servicePort, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslSrvrNumConn=sslSrvrNumConn, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, firmwareStorageHigh=firmwareStorageHigh, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpSrvrTotResponse=httpSrvrTotResponse, sslSrvrTotRefused=sslSrvrTotRefused, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsMIBGroups=bwsMIBGroups, processCountHigh=processCountHigh, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpProxyAddressType=httpProxyAddressType, systemFanSpeed=systemFanSpeed, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrMaxResTime=sslSrvrMaxResTime, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsMIBConformance=bwsMIBConformance, httpProxyParseErr=httpProxyParseErr, sslSrvrTotTimedout=sslSrvrTotTimedout, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, uptime=uptime, webCmprAddress=webCmprAddress, bwsServiceStatusTable=bwsServiceStatusTable, smRealmName=smRealmName, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, webCmprPort=webCmprPort, webCacheMiss=webCacheMiss, httpSrvrAvgResTime=httpSrvrAvgResTime, activeServers=activeServers, httpSrvrTotRefused=httpSrvrTotRefused, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpProxyOutBytes=httpProxyOutBytes, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsMIBCompliance=bwsMIBCompliance, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, dataPortLinkUp=dataPortLinkUp, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, dataPathStatus=dataPathStatus, httpProxyInBytes=httpProxyInBytes, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpProxyServerErr=httpProxyServerErr, httpSrvrOutBytes=httpSrvrOutBytes, freeMem=freeMem, bwsMIBCompliances=bwsMIBCompliances, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslProxyAddressType=sslProxyAddressType, httpSrvrAddress=httpSrvrAddress, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, currentFirmwareVersion=currentFirmwareVersion, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrNumFreeConn=sslSrvrNumFreeConn, firmwareStorage=firmwareStorage, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrAddressType=httpSrvrAddressType, sslSrvrAddress=sslSrvrAddress, cpuFanSpeed=cpuFanSpeed, tempCritical=tempCritical, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslProxyCurrentConn=sslProxyCurrentConn, bwsStatsGroup=bwsStatsGroup, httpProxyClientAbrt=httpProxyClientAbrt, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsMessage=bwsMessage, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslProxyCacheHits=sslProxyCacheHits, cpuUtilization=cpuUtilization, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpProxyTotalConn=httpProxyTotalConn, serviceStatus=serviceStatus, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, dataPortLinkDown=dataPortLinkDown, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrMinResTime=sslSrvrMinResTime, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrTotSuccess=httpSrvrTotSuccess, totalAttacks=totalAttacks, webCacheCachedObjects=webCacheCachedObjects, highAvailabilityStatus=highAvailabilityStatus, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, webCacheReq=webCacheReq, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsTrapGroup=bwsTrapGroup, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, webCacheCacheableRes=webCacheCacheableRes, securityDefUpdates=securityDefUpdates, sslSrvrInBytes=sslSrvrInBytes, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, totalApplications=totalApplications, ipsReqLimitAddress=ipsReqLimitAddress, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsUrlNormAddress=ipsUrlNormAddress, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsUrlAclReserved=ipsUrlAclReserved, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsReqLimitAddressType=ipsReqLimitAddressType, virusDefUpdates=virusDefUpdates, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, cpuTemperature=cpuTemperature, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, activeApplications=activeApplications, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpSrvrNumConn=httpSrvrNumConn, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpProxyServerReq=httpProxyServerReq, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslProxyAddress=sslProxyAddress, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslSrvrState=sslSrvrState, peerUp=peerUp, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, switchingToMaintMode=switchingToMaintMode, webCacheProtocol=webCacheProtocol, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsHdrAclHits=ipsHdrAclHits, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, fanDead=fanDead, bwsServiceStatusEntry=bwsServiceStatusEntry, vipStatus=vipStatus, ipsReqSrvcPort=ipsReqSrvcPort, httpSrvrTotReqActive=httpSrvrTotReqActive, sslProxyErrPms=sslProxyErrPms, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsCookieSecTampered=ipsCookieSecTampered, smNumUserSessions=smNumUserSessions, srvcName=srvcName, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsRCTotQueued=ipsRCTotQueued, sslSrvrAddressType=sslSrvrAddressType, ipsRCPort=ipsRCPort, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, operationalMode=operationalMode, webCmprProtocol=webCmprProtocol, webCachePort=webCachePort, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, webCacheLongHdrs=webCacheLongHdrs, sslProxyInBytes=sslProxyInBytes, sslSrvrTotResponse=sslSrvrTotResponse, webCacheHits=webCacheHits, ipsRCAddressType=ipsRCAddressType)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrMaxResTime=httpSrvrMaxResTime, ipsHdrAclPort=ipsHdrAclPort, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsUrlAclPort=ipsUrlAclPort, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslSrvrOutBytes=sslSrvrOutBytes, webCacheStale=webCacheStale, ipsRCTotOutOfResource=ipsRCTotOutOfResource, memoryUsageHigh=memoryUsageHigh, httpProxyServerAbrt=httpProxyServerAbrt, sslProxyActiveConn=sslProxyActiveConn, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsCookieSecPort=ipsCookieSecPort, logStorageHigh=logStorageHigh, totalServers=totalServers, ipsHdrAclAddressType=ipsHdrAclAddressType, PYSNMP_MODULE_ID=bws, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, serverUp=serverUp, ipsUrlAclAddress=ipsUrlAclAddress, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlNormAddressType=ipsUrlNormAddressType, serviceName=serviceName, systemFailOver=systemFailOver, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsAccessCtrlPort=ipsAccessCtrlPort, sslProxyTotalConn=sslProxyTotalConn, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslSrvrSrvcPort=sslSrvrSrvcPort, sslProxyCacheMiss=sslProxyCacheMiss, sslSrvrPort=sslSrvrPort, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsRCAddress=ipsRCAddress, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslProxyOutBytes=sslProxyOutBytes, bwsStats=bwsStats, energizeUpdateExpire=energizeUpdateExpire, systemFailure=systemFailure, ipsRCTotServed=ipsRCTotServed, bwsCacheStatsTable=bwsCacheStatsTable, httpProxyAddress=httpProxyAddress, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwstraps=bwstraps, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, memUtilization=memUtilization, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpProxyPort=httpProxyPort, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bws=bws, serverDown=serverDown, switchingToInlineMode=switchingToInlineMode, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, webCacheAddressType=webCacheAddressType, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, peerDown=peerDown, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpProxyActiveConn=httpProxyActiveConn)
