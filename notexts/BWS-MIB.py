...
ModuleIdentity, Integer32, IpAddress, Bits, Gauge32, NotificationType, Counter32, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "IpAddress", "Bits", "Gauge32", "NotificationType", "Counter32", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("BWS-MIB", webCacheCacheableRes=webCacheCacheableRes, totalApplications=totalApplications, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, logStorage=logStorage, sslSrvrSrvcAddress=sslSrvrSrvcAddress, serverDown=serverDown, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsRCTotServed=ipsRCTotServed, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpSrvrNumConn=httpSrvrNumConn, sslSrvrOutBytes=sslSrvrOutBytes, sslProxyPort=sslProxyPort, webCacheAddress=webCacheAddress, ipsUrlPolicyPort=ipsUrlPolicyPort, firmwareStorageHigh=firmwareStorageHigh, ipsReqLimitPort=ipsReqLimitPort, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpSrvrAvgResTime=httpSrvrAvgResTime, webCacheBytesOut=webCacheBytesOut, totalBandwidth=totalBandwidth, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslProxyBadDNCErr=sslProxyBadDNCErr, switchingToBypassMode=switchingToBypassMode, logStorageHigh=logStorageHigh, ipsHdrAclHits=ipsHdrAclHits, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, srvcName=srvcName, peerDown=peerDown, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpProxyUnknownRsp=httpProxyUnknownRsp, webCachePort=webCachePort, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsAccessCtrlAddress=ipsAccessCtrlAddress, smAgentName=smAgentName, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsReqSrvcPort=ipsReqSrvcPort, ipsLrnSrvcAddress=ipsLrnSrvcAddress, tempCritical=tempCritical, httpProxyTotalConn=httpProxyTotalConn, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, dataPortLinkUp=dataPortLinkUp, processCountHigh=processCountHigh, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrAddressType=httpSrvrAddressType, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsUrlAclAddressType=ipsUrlAclAddressType, sslProxyTotalConn=sslProxyTotalConn, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpProxyOutBytes=httpProxyOutBytes, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, activeApplications=activeApplications, webCacheMiss=webCacheMiss, systemSerialNumber=systemSerialNumber, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, webCmprProtocol=webCmprProtocol, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpProxyAddressType=httpProxyAddressType, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsSMUserSessionTable=bwsSMUserSessionTable, sslSrvrTotRefused=sslSrvrTotRefused, sslSrvrMaxResTime=sslSrvrMaxResTime, sslSrvrState=sslSrvrState, fanDead=fanDead, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpProxyInBytes=httpProxyInBytes, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, activeServers=activeServers, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsRCPort=ipsRCPort, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, tempHigh=tempHigh, ipsReqLimitAddress=ipsReqLimitAddress, webCacheAddressType=webCacheAddressType, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsRCTimeStamp=ipsRCTimeStamp, httpProxyClientAbrt=httpProxyClientAbrt, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsRCAddressType=ipsRCAddressType, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsCookieSecAddress=ipsCookieSecAddress, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, cpuTemperature=cpuTemperature, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpSrvrOutBytes=httpSrvrOutBytes, ipsUrlPolicyAddress=ipsUrlPolicyAddress, vipStatus=vipStatus, ipsRCTotQueued=ipsRCTotQueued, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslSrvrInBytes=sslSrvrInBytes, sslProxyAddressType=sslProxyAddressType, ipsRCAddress=ipsRCAddress, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, smNumUserSessions=smNumUserSessions, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, PYSNMP_MODULE_ID=bws, systemFailOver=systemFailOver, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpSrvrSrvcAddress=httpSrvrSrvcAddress, dataPortLinkDown=dataPortLinkDown, ipsCookieSecPort=ipsCookieSecPort, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrAvgResTime=sslSrvrAvgResTime, httpSrvrInBytes=httpSrvrInBytes, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, switchingToMaintMode=switchingToMaintMode, sslProxyErrPms=sslProxyErrPms, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsRCTotDropped=ipsRCTotDropped, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, cpuFanSpeed=cpuFanSpeed, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, peerUp=peerUp, currentFirmwareVersion=currentFirmwareVersion, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrTotRefused=httpSrvrTotRefused, systemLoad=systemLoad, sslSrvrAddressType=sslSrvrAddressType, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslSrvrSrvcPort=sslSrvrSrvcPort, raidDegrading=raidDegrading, serviceName=serviceName, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, webCacheStale=webCacheStale, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrTotResponse=httpSrvrTotResponse, webCmprAddressType=webCmprAddressType, webCmprCompressedDataSize=webCmprCompressedDataSize, httpProxyServerReq=httpProxyServerReq, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsCookieSecTampered=ipsCookieSecTampered, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrNumConn=sslSrvrNumConn, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrState=httpSrvrState, serviceAddress=serviceAddress, sslProxyActiveConn=sslProxyActiveConn, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, totalServers=totalServers, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, webCacheProtocol=webCacheProtocol, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwstraps=bwstraps, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslProxyCurrentConn=sslProxyCurrentConn, ipsWebAddrTransPort=ipsWebAddrTransPort, webCacheHits=webCacheHits, bwsMessage=bwsMessage, ipsUrlNormPort=ipsUrlNormPort, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpProxyParseErr=httpProxyParseErr, webCmprPort=webCmprPort, webCacheLongHdrs=webCacheLongHdrs, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsMIBGroups=bwsMIBGroups, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpProxyAddress=httpProxyAddress, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, memUtilization=memUtilization, sslProxyCacheHits=sslProxyCacheHits, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, memoryUsageHigh=memoryUsageHigh, sslSrvrPort=sslSrvrPort, ipsUrlAclPort=ipsUrlAclPort, ipsReqSrvcAddress=ipsReqSrvcAddress, linkStatus=linkStatus, webCacheCachedObjects=webCacheCachedObjects, systemFanSpeed=systemFanSpeed, serviceStatus=serviceStatus, httpSrvrPort=httpSrvrPort, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsUrlAclAddress=ipsUrlAclAddress, webCmprAddress=webCmprAddress, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrMinResTime=httpSrvrMinResTime, switchingToInlineMode=switchingToInlineMode, httpProxyPort=httpProxyPort, energizeUpdateExpire=energizeUpdateExpire, sslSrvrAddress=sslSrvrAddress, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsHdrAclPort=ipsHdrAclPort, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsReqLimitAddressType=ipsReqLimitAddressType, httpProxyServerErr=httpProxyServerErr, sslProxyTotalReq=sslProxyTotalReq, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn)
mibBuilder.exportSymbols("BWS-MIB", ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslProxyInBytes=sslProxyInBytes, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslSrvrTotTimedout=sslSrvrTotTimedout, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsStats=bwsStats, httpProxyActiveConn=httpProxyActiveConn, operationalMode=operationalMode, ipsUrlNormAddress=ipsUrlNormAddress, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpSrvrAddress=httpSrvrAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, totalAttacks=totalAttacks, httpSrvrMaxResTime=httpSrvrMaxResTime, httpProxyTotalReq=httpProxyTotalReq, servicePort=servicePort, systemFailure=systemFailure, sslProxyOutBytes=sslProxyOutBytes, uptime=uptime, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslProxyAddress=sslProxyAddress, dataPathStatus=dataPathStatus, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, securityDefUpdates=securityDefUpdates, freeMem=freeMem, bwsCacheStatsEntry=bwsCacheStatsEntry, highAvailabilityStatus=highAvailabilityStatus, bwsServiceStatusEntry=bwsServiceStatusEntry, sslProxyCacheMiss=sslProxyCacheMiss, httpProxyServerAbrt=httpProxyServerAbrt, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bws=bws, newAttackDefinitionInstalled=newAttackDefinitionInstalled, virusDefUpdates=virusDefUpdates, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, webCacheReq=webCacheReq, smRealmName=smRealmName, cpuUtilization=cpuUtilization, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsUrlAclReserved=ipsUrlAclReserved, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrTotResponse=sslSrvrTotResponse, totalMem=totalMem, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsTrapGroup=bwsTrapGroup, bwsServiceStatusTable=bwsServiceStatusTable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsMIBCompliance=bwsMIBCompliance, firmwareStorage=firmwareStorage, serverUp=serverUp, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsMIBConformance=bwsMIBConformance, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsStatsGroup=bwsStatsGroup, ipsHdrAclAddress=ipsHdrAclAddress, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsMIBCompliances=bwsMIBCompliances, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr)
