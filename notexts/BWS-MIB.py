...
IpAddress, NotificationType, Bits, ModuleIdentity, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, MibIdentifier, Counter32, iso, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "Bits", "ModuleIdentity", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "MibIdentifier", "Counter32", "iso", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpSrvrTotSuccess=httpSrvrTotSuccess, httpProxyPort=httpProxyPort, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, srvcName=srvcName, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsMessage=bwsMessage, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, systemSerialNumber=systemSerialNumber, dataPathStatus=dataPathStatus, serverDown=serverDown, sslProxyCurrentConn=sslProxyCurrentConn, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, cpuTemperature=cpuTemperature, ipsRCTotQueued=ipsRCTotQueued, sslProxyTotalConn=sslProxyTotalConn, sslSrvrSrvcAddress=sslSrvrSrvcAddress, smRealmName=smRealmName, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsUrlNormPort=ipsUrlNormPort, sslSrvrState=sslSrvrState, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, webCmprProtocol=webCmprProtocol, sslProxyTotalReq=sslProxyTotalReq, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, webCmprPort=webCmprPort, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsUrlAclAddress=ipsUrlAclAddress, servicePort=servicePort, logStorage=logStorage, ipsReqSrvcPort=ipsReqSrvcPort, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpProxyTotalReq=httpProxyTotalReq, httpProxyServerErr=httpProxyServerErr, webCmprAddress=webCmprAddress, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpProxyAddressType=httpProxyAddressType, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, serverUp=serverUp, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrAddressType=sslSrvrAddressType, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, webCacheStale=webCacheStale, httpSrvrTotResponse=httpSrvrTotResponse, serviceStatus=serviceStatus, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, webCacheAddress=webCacheAddress, httpSrvrNumFreeConn=httpSrvrNumFreeConn, webCacheReq=webCacheReq, httpSrvrState=httpSrvrState, currentFirmwareVersion=currentFirmwareVersion, sslSrvrAvgResTime=sslSrvrAvgResTime, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpSrvrMinResTime=httpSrvrMinResTime, ipsCookieSecAddressType=ipsCookieSecAddressType, sslProxyCacheHits=sslProxyCacheHits, webCacheHits=webCacheHits, sslProxyErrPms=sslProxyErrPms, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsStats=bwsStats, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsMIBConformance=bwsMIBConformance, ipsUrlNormAddressType=ipsUrlNormAddressType, bwstraps=bwstraps, operationalMode=operationalMode, ipsLrnSrvcPort=ipsLrnSrvcPort, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, raidDegrading=raidDegrading, bwsMIBCompliance=bwsMIBCompliance, httpSrvrSrvcPort=httpSrvrSrvcPort, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlAclPort=ipsUrlAclPort, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsCookieSecTampered=ipsCookieSecTampered, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, tempHigh=tempHigh, sslProxyPort=sslProxyPort, httpSrvrAddress=httpSrvrAddress, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, fanDead=fanDead, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslSrvrTotRefused=sslSrvrTotRefused, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, totalServers=totalServers, freeMem=freeMem, ipsRCAddress=ipsRCAddress, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, webCacheBytesOut=webCacheBytesOut, activeServers=activeServers, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslProxyCacheMiss=sslProxyCacheMiss, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpSrvrOutBytes=httpSrvrOutBytes, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, energizeUpdateExpire=energizeUpdateExpire, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, securityDefUpdates=securityDefUpdates, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsHdrAclAddress=ipsHdrAclAddress, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, serviceName=serviceName, httpProxyClientAbrt=httpProxyClientAbrt, peerDown=peerDown, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, vipStatus=vipStatus, dataPortLinkUp=dataPortLinkUp, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslProxyBadCRLErr=sslProxyBadCRLErr, httpProxyInBytes=httpProxyInBytes, systemFanSpeed=systemFanSpeed, firmwareStorageHigh=firmwareStorageHigh, cpuFanSpeed=cpuFanSpeed, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, webCacheMiss=webCacheMiss, totalAttacks=totalAttacks, sslSrvrOutBytes=sslSrvrOutBytes, httpProxyTotalConn=httpProxyTotalConn, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslProxyInBytes=sslProxyInBytes, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, totalMem=totalMem, httpProxyServerReq=httpProxyServerReq, webCmprAddressType=webCmprAddressType, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, highAvailabilityStatus=highAvailabilityStatus, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, serviceAddress=serviceAddress, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsRCTotDropped=ipsRCTotDropped, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, switchingToInlineMode=switchingToInlineMode, ipsHdrAclHits=ipsHdrAclHits, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsSMUserSessionTable=bwsSMUserSessionTable, webCacheCacheableRes=webCacheCacheableRes, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, activeApplications=activeApplications, sslProxyActiveConn=sslProxyActiveConn, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, webCachePort=webCachePort, httpSrvrTotRefused=httpSrvrTotRefused, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrAddress=sslSrvrAddress, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpProxyActiveConn=httpProxyActiveConn, sslSrvrPort=sslSrvrPort, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsAccessCtrlAddress=ipsAccessCtrlAddress, totalBandwidth=totalBandwidth, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlPolicyPort=ipsUrlPolicyPort, totalApplications=totalApplications, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsTrapGroup=bwsTrapGroup, bwsServiceStatusTable=bwsServiceStatusTable, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpSrvrNumConn=httpSrvrNumConn, bwsMIBGroups=bwsMIBGroups, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrNumConn=sslSrvrNumConn, ipsRCTotServed=ipsRCTotServed, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsReqLimitAddress=ipsReqLimitAddress, memoryUsageHigh=memoryUsageHigh, webCacheAddressType=webCacheAddressType, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, firmwareStorage=firmwareStorage, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, smNumUserSessions=smNumUserSessions, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, uptime=uptime, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bws=bws, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpSrvrAddressType=httpSrvrAddressType, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, virusDefUpdates=virusDefUpdates, httpSrvrInBytes=httpSrvrInBytes, sslProxyOutBytes=sslProxyOutBytes, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, memUtilization=memUtilization, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslSrvrInBytes=sslSrvrInBytes, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsUrlAclAddressType=ipsUrlAclAddressType, httpSrvrPort=httpSrvrPort, logStorageHigh=logStorageHigh, smAgentName=smAgentName, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslSrvrTotResponse=sslSrvrTotResponse, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsStatsGroup=bwsStatsGroup, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsMIBCompliances=bwsMIBCompliances, dataPortLinkDown=dataPortLinkDown, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslSrvrTotTimedout=sslSrvrTotTimedout, PYSNMP_MODULE_ID=bws, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrMinResTime=sslSrvrMinResTime, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsCacheStatsEntry=bwsCacheStatsEntry, httpProxyServerAbrt=httpProxyServerAbrt, cpuUtilization=cpuUtilization, switchingToMaintMode=switchingToMaintMode, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsServiceStatusEntry=bwsServiceStatusEntry, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsCookieSecAddress=ipsCookieSecAddress, webCacheProtocol=webCacheProtocol, ipsRCAddressType=ipsRCAddressType, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, systemFailure=systemFailure, systemFailOver=systemFailOver, webCacheCachedObjects=webCacheCachedObjects, tempCritical=tempCritical, ipsRCPort=ipsRCPort, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, processCountHigh=processCountHigh, httpProxyOutBytes=httpProxyOutBytes, sslProxyAddress=sslProxyAddress, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsCookieSecPort=ipsCookieSecPort, ipsHdrAclAddressType=ipsHdrAclAddressType, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslProxyAddressType=sslProxyAddressType, ipsReqLimitPort=ipsReqLimitPort, systemLoad=systemLoad, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsRCTimeStamp=ipsRCTimeStamp, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpProxySessionTimeOut=httpProxySessionTimeOut, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, linkStatus=linkStatus, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsUrlNormAddress=ipsUrlNormAddress, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpSrvrTotReqActive=httpSrvrTotReqActive, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsHdrAclPort=ipsHdrAclPort, bwsCacheStatsTable=bwsCacheStatsTable, switchingToBypassMode=switchingToBypassMode, httpProxyParseErr=httpProxyParseErr, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, webCacheLongHdrs=webCacheLongHdrs, httpProxyAddress=httpProxyAddress, peerUp=peerUp, ipsWebAddrTransAddress=ipsWebAddrTransAddress)
