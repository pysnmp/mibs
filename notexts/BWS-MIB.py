...
MibIdentifier, Counter64, ObjectIdentity, Integer32, Gauge32, TimeTicks, IpAddress, NotificationType, Unsigned32, iso, Bits, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "ObjectIdentity", "Integer32", "Gauge32", "TimeTicks", "IpAddress", "NotificationType", "Unsigned32", "iso", "Bits", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("BWS-MIB", sslSrvrMaxResTime=sslSrvrMaxResTime, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsHdrAclHits=ipsHdrAclHits, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsReqLimitAddress=ipsReqLimitAddress, dataPortLinkUp=dataPortLinkUp, sslSrvrMinResTime=sslSrvrMinResTime, smRealmName=smRealmName, sslProxyAddressType=sslProxyAddressType, httpProxyInBytes=httpProxyInBytes, srvcName=srvcName, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsIpsRCStatsTable=bwsIpsRCStatsTable, cpuFanSpeed=cpuFanSpeed, energizeUpdateExpire=energizeUpdateExpire, serviceAddress=serviceAddress, systemSerialNumber=systemSerialNumber, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsRCTimeStamp=ipsRCTimeStamp, webCacheBytesOut=webCacheBytesOut, sslProxyBadCRLErr=sslProxyBadCRLErr, httpProxyActiveConn=httpProxyActiveConn, sslProxyOutBytes=sslProxyOutBytes, httpProxyServerReq=httpProxyServerReq, bws=bws, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpSrvrTotResponse=httpSrvrTotResponse, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslProxyActiveConn=sslProxyActiveConn, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrAddress=sslSrvrAddress, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, tempHigh=tempHigh, httpSrvrMinResTime=httpSrvrMinResTime, sslProxyBadDNCErr=sslProxyBadDNCErr, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, activeApplications=activeApplications, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, serviceName=serviceName, switchingToInlineMode=switchingToInlineMode, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsRCTotQueued=ipsRCTotQueued, webCachePort=webCachePort, systemLoad=systemLoad, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrTotResponse=sslSrvrTotResponse, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwstraps=bwstraps, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslProxyAddress=sslProxyAddress, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslProxyCacheHits=sslProxyCacheHits, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpProxyServerAbrt=httpProxyServerAbrt, totalBandwidth=totalBandwidth, httpProxyServerErr=httpProxyServerErr, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, firmwareUpdateAvailable=firmwareUpdateAvailable, sslProxyInBytes=sslProxyInBytes, ipsLrnSrvcPort=ipsLrnSrvcPort, virusDefUpdates=virusDefUpdates, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslSrvrInBytes=sslSrvrInBytes, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslProxyPort=sslProxyPort, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, webCmprCompressedDataSize=webCmprCompressedDataSize, webCacheLongHdrs=webCacheLongHdrs, highAvailabilityStatus=highAvailabilityStatus, ipsHdrAclAddress=ipsHdrAclAddress, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrOutBytes=httpSrvrOutBytes, tempCritical=tempCritical, systemFanSpeed=systemFanSpeed, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, uptime=uptime, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsCookieSecTampered=ipsCookieSecTampered, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsServiceStatusTable=bwsServiceStatusTable, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrNumConn=sslSrvrNumConn, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, memoryUsageHigh=memoryUsageHigh, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslProxyCurrentConn=sslProxyCurrentConn, bwsStatsGroup=bwsStatsGroup, firmwareStorage=firmwareStorage, ipsUrlAclPort=ipsUrlAclPort, httpProxyOutBytes=httpProxyOutBytes, peerUp=peerUp, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrAddressType=httpSrvrAddressType, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsRCPort=ipsRCPort, sslSrvrTotRefused=sslSrvrTotRefused, securityDefUpdates=securityDefUpdates, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsMIBGroups=bwsMIBGroups, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, cpuTemperature=cpuTemperature, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, dataPortLinkDown=dataPortLinkDown, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, webCacheAddressType=webCacheAddressType, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, totalApplications=totalApplications, sslProxyErrPms=sslProxyErrPms, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, memUtilization=memUtilization, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsRCTotServed=ipsRCTotServed, httpProxyAddressType=httpProxyAddressType, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, processCountHigh=processCountHigh, vipStatus=vipStatus, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsHdrAclPort=ipsHdrAclPort, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, systemFailure=systemFailure, sslSrvrTotReqActive=sslSrvrTotReqActive, smAgentName=smAgentName, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpSrvrAddress=httpSrvrAddress, httpProxyParseErr=httpProxyParseErr, ipsRCAddress=ipsRCAddress, sslProxyCacheMiss=sslProxyCacheMiss, sslSrvrAddressType=sslSrvrAddressType, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, webCacheHits=webCacheHits, httpProxyWAFWarnings=httpProxyWAFWarnings, sharedSecretKeyExpired=sharedSecretKeyExpired, raidDegrading=raidDegrading, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, webCacheAddress=webCacheAddress, systemFailOver=systemFailOver, PYSNMP_MODULE_ID=bws, ipsReqSrvcPort=ipsReqSrvcPort, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, activeServers=activeServers, httpSrvrInBytes=httpSrvrInBytes, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsRCTotDropped=ipsRCTotDropped, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsMIBConformance=bwsMIBConformance, sslProxyTotalReq=sslProxyTotalReq, sslProxyTotalConn=sslProxyTotalConn, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, switchingToMaintMode=switchingToMaintMode, httpSrvrState=httpSrvrState, bwsMIBCompliance=bwsMIBCompliance, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsCookieSecAddress=ipsCookieSecAddress, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsMIBCompliances=bwsMIBCompliances, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, linkStatus=linkStatus, serverUp=serverUp, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpSrvrTotTimedout=httpSrvrTotTimedout, logStorageHigh=logStorageHigh, totalAttacks=totalAttacks, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsWebAddrTransPort=ipsWebAddrTransPort, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslSrvrSrvcAddress=sslSrvrSrvcAddress, cpuUtilization=cpuUtilization, ipsUrlNormAddress=ipsUrlNormAddress, httpProxyClientAbrt=httpProxyClientAbrt, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsCacheStatsEntry=bwsCacheStatsEntry, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, serverDown=serverDown, newAttackDefinitionInstalled=newAttackDefinitionInstalled, webCacheReq=webCacheReq, httpProxyTotalReq=httpProxyTotalReq, httpSrvrTotReqActive=httpSrvrTotReqActive, totalMem=totalMem, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrTotTimedout=sslSrvrTotTimedout, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsTrapGroup=bwsTrapGroup, httpProxyPort=httpProxyPort, totalServers=totalServers, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, currentFirmwareVersion=currentFirmwareVersion, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslSrvrPort=sslSrvrPort, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, fanDead=fanDead, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, webCmprPort=webCmprPort)
mibBuilder.exportSymbols("BWS-MIB", freeMem=freeMem, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsMessage=bwsMessage, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrNumConn=httpSrvrNumConn, webCacheMiss=webCacheMiss, smNumUserSessions=smNumUserSessions, peerDown=peerDown, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, webCacheCacheableRes=webCacheCacheableRes, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, operationalMode=operationalMode, servicePort=servicePort, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, webCmprProtocol=webCmprProtocol, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsRCAddressType=ipsRCAddressType, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpProxyAddress=httpProxyAddress, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsCacheStatsTable=bwsCacheStatsTable, ipsUrlNormPort=ipsUrlNormPort, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslSrvrOutBytes=sslSrvrOutBytes, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, dataPathStatus=dataPathStatus, httpProxyUnknownRsp=httpProxyUnknownRsp, firmwareStorageHigh=firmwareStorageHigh, webCmprAddress=webCmprAddress, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, webCacheProtocol=webCacheProtocol, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, serviceStatus=serviceStatus, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsCookieSecPort=ipsCookieSecPort, bwsStats=bwsStats, sslSrvrState=sslSrvrState, webCacheCachedObjects=webCacheCachedObjects, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsReqLimitPort=ipsReqLimitPort, webCmprAddressType=webCmprAddressType, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpProxySessionTimeOut=httpProxySessionTimeOut, httpProxyTotalConn=httpProxyTotalConn, webCacheStale=webCacheStale, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, switchingToBypassMode=switchingToBypassMode, logStorage=logStorage, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpSrvrPort=httpSrvrPort)
