...
Counter32, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, iso, Unsigned32, IpAddress, NotificationType, MibIdentifier, Counter64, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "iso", "Unsigned32", "IpAddress", "NotificationType", "MibIdentifier", "Counter64", "Integer32", "ObjectIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", systemSerialNumber=systemSerialNumber, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslProxyAddress=sslProxyAddress, httpSrvrMaxResTime=httpSrvrMaxResTime, smRealmName=smRealmName, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrOutBytes=sslSrvrOutBytes, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, webCacheCachedObjects=webCacheCachedObjects, webCacheReq=webCacheReq, totalServers=totalServers, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslProxyOutBytes=sslProxyOutBytes, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpProxyUnknownRsp=httpProxyUnknownRsp, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpSrvrTotResponse=httpSrvrTotResponse, PYSNMP_MODULE_ID=bws, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, systemFailOver=systemFailOver, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, firmwareStorage=firmwareStorage, bwsTrapGroup=bwsTrapGroup, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsRCTotQueued=ipsRCTotQueued, httpProxyOutBytes=httpProxyOutBytes, sslSrvrMaxResTime=sslSrvrMaxResTime, peerUp=peerUp, sslSrvrTotSuccess=sslSrvrTotSuccess, webCachePort=webCachePort, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, peerDown=peerDown, operationalMode=operationalMode, ipsRCPort=ipsRCPort, httpSrvrTotRefused=httpSrvrTotRefused, webCacheStale=webCacheStale, httpSrvrInBytes=httpSrvrInBytes, httpProxyTotalReq=httpProxyTotalReq, webCacheMiss=webCacheMiss, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsHdrAclHits=ipsHdrAclHits, tempHigh=tempHigh, webCacheProtocol=webCacheProtocol, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslProxyPort=sslProxyPort, webCacheAddress=webCacheAddress, sslSrvrInBytes=sslSrvrInBytes, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, uptime=uptime, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsWebAddrTransPort=ipsWebAddrTransPort, activeApplications=activeApplications, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslSrvrPort=sslSrvrPort, bwsStats=bwsStats, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrAddress=sslSrvrAddress, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsMessage=bwsMessage, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsMIBGroups=bwsMIBGroups, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsLrnSrvcAddress=ipsLrnSrvcAddress, webCacheCacheableRes=webCacheCacheableRes, processCountHigh=processCountHigh, linkStatus=linkStatus, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsCookieSecTampered=ipsCookieSecTampered, httpProxyAddress=httpProxyAddress, bwsMIBConformance=bwsMIBConformance, sslSrvrState=sslSrvrState, sslSrvrTotRefused=sslSrvrTotRefused, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrOutBytes=httpSrvrOutBytes, httpProxyInBytes=httpProxyInBytes, dataPortLinkDown=dataPortLinkDown, bwsSMUserSessionTable=bwsSMUserSessionTable, webCmprCompressedDataSize=webCmprCompressedDataSize, sslSrvrAddressType=sslSrvrAddressType, ipsRCTotDropped=ipsRCTotDropped, systemFanSpeed=systemFanSpeed, webCmprAddressType=webCmprAddressType, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsUrlNormAddress=ipsUrlNormAddress, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, webCacheAddressType=webCacheAddressType, raidDegrading=raidDegrading, sslProxyFullHandshakes=sslProxyFullHandshakes, switchingToBypassMode=switchingToBypassMode, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsCookieSecPort=ipsCookieSecPort, serviceName=serviceName, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, vipStatus=vipStatus, totalApplications=totalApplications, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpProxyServerErr=httpProxyServerErr, bwsCacheStatsEntry=bwsCacheStatsEntry, logStorageHigh=logStorageHigh, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsUrlAclAddress=ipsUrlAclAddress, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslProxyTotalReq=sslProxyTotalReq, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslProxyCacheMiss=sslProxyCacheMiss, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpProxyPort=httpProxyPort, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsCompressionStatsEntry=bwsCompressionStatsEntry, totalBandwidth=totalBandwidth, httpSrvrSrvcAddress=httpSrvrSrvcAddress, logStorage=logStorage, httpProxyServerReq=httpProxyServerReq, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, firmwareStorageHigh=firmwareStorageHigh, ipsUrlNormPort=ipsUrlNormPort, totalMem=totalMem, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrState=httpSrvrState, cpuTemperature=cpuTemperature, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, serverDown=serverDown, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, httpProxyParseErr=httpProxyParseErr, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpSrvrNumConn=httpSrvrNumConn, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, smNumUserSessions=smNumUserSessions, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsUrlAclPort=ipsUrlAclPort, sslProxyInBytes=sslProxyInBytes, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsHdrAclPort=ipsHdrAclPort, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslSrvrTotReqActive=sslSrvrTotReqActive, energizeUpdateExpire=energizeUpdateExpire, dataPathStatus=dataPathStatus, sslProxyBadDNCErr=sslProxyBadDNCErr, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrAddressType=httpSrvrAddressType, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsRCAddressType=ipsRCAddressType, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsCookieSecEncrypted=ipsCookieSecEncrypted, serviceStatus=serviceStatus, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsReqSrvcPort=ipsReqSrvcPort, cpuUtilization=cpuUtilization, switchingToInlineMode=switchingToInlineMode, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsReqLimitAddress=ipsReqLimitAddress, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpProxyAddressType=httpProxyAddressType, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsStatsGroup=bwsStatsGroup, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, webCmprPort=webCmprPort, ipsReqLimitPort=ipsReqLimitPort, highAvailabilityStatus=highAvailabilityStatus, currentFirmwareVersion=currentFirmwareVersion, sslProxyTotalConn=sslProxyTotalConn, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, serviceAddress=serviceAddress, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsRCAddress=ipsRCAddress, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, systemLoad=systemLoad, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslProxyCacheHits=sslProxyCacheHits, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpProxyServerAbrt=httpProxyServerAbrt, bwsCacheStatsTable=bwsCacheStatsTable, securityDefUpdates=securityDefUpdates, bwsServiceStatusTable=bwsServiceStatusTable, sslSrvrTotResponse=sslSrvrTotResponse, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, dataPortLinkUp=dataPortLinkUp, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, webCmprAddress=webCmprAddress, sslProxyActiveConn=sslProxyActiveConn, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslProxyCurrentConn=sslProxyCurrentConn, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrTotReqActive=httpSrvrTotReqActive, sharedSecretKeyExpired=sharedSecretKeyExpired)
mibBuilder.exportSymbols("BWS-MIB", webCacheLongHdrs=webCacheLongHdrs, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpProxyActiveConn=httpProxyActiveConn, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, switchingToMaintMode=switchingToMaintMode, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslProxyAddressType=sslProxyAddressType, memUtilization=memUtilization, webCacheHits=webCacheHits, webCacheBytesOut=webCacheBytesOut, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwstraps=bwstraps, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, virusDefUpdates=virusDefUpdates, sslSrvrNumConn=sslSrvrNumConn, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsCookieSecAddress=ipsCookieSecAddress, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, serverUp=serverUp, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, freeMem=freeMem, webCmprProtocol=webCmprProtocol, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpProxyClientAbrt=httpProxyClientAbrt, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, servicePort=servicePort, smAgentName=smAgentName, ipsHdrAclAddress=ipsHdrAclAddress, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, fanDead=fanDead, memoryUsageHigh=memoryUsageHigh, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, cpuFanSpeed=cpuFanSpeed, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsRCTotServed=ipsRCTotServed, httpProxyTotalConn=httpProxyTotalConn, systemFailure=systemFailure, bws=bws, bwsMIBCompliances=bwsMIBCompliances, ipsRCTimeStamp=ipsRCTimeStamp, tempCritical=tempCritical, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, activeServers=activeServers, sslProxyErrPms=sslProxyErrPms, httpSrvrAddress=httpSrvrAddress, sslSrvrMinResTime=sslSrvrMinResTime, httpSrvrPort=httpSrvrPort, bwsSMUserSessionEntry=bwsSMUserSessionEntry, totalAttacks=totalAttacks, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrMinResTime=httpSrvrMinResTime, bwsCompressionStatsTable=bwsCompressionStatsTable, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, srvcName=srvcName, bwsMIBCompliance=bwsMIBCompliance, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslProxyCacheTimeouts=sslProxyCacheTimeouts)
