...
ObjectIdentity, Counter64, Bits, Unsigned32, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, Counter32, TimeTicks, Gauge32, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "Bits", "Unsigned32", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "Counter32", "TimeTicks", "Gauge32", "NotificationType", "iso")
...
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, tempHigh=tempHigh, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlNormAddressType=ipsUrlNormAddressType, httpProxyAddress=httpProxyAddress, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, securityDefUpdates=securityDefUpdates, totalMem=totalMem, webCacheCachedObjects=webCacheCachedObjects, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsUrlAclPort=ipsUrlAclPort, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, webCacheAddress=webCacheAddress, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslProxyTotalReq=sslProxyTotalReq, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpProxyActiveConn=httpProxyActiveConn, sslProxyAddressType=sslProxyAddressType, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpSrvrState=httpSrvrState, httpSrvrInBytes=httpSrvrInBytes, serverDown=serverDown, smNumUserSessions=smNumUserSessions, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslProxyTotalConn=sslProxyTotalConn, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, logStorageHigh=logStorageHigh, cpuTemperature=cpuTemperature, ipsRCPort=ipsRCPort, bwstraps=bwstraps, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsUrlAclAddress=ipsUrlAclAddress, activeServers=activeServers, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpSrvrTotRefused=httpSrvrTotRefused, sslProxyCurrentConn=sslProxyCurrentConn, httpProxySessionTimeOut=httpProxySessionTimeOut, sslSrvrNumFreeConn=sslSrvrNumFreeConn, tempCritical=tempCritical, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslSrvrAddressType=sslSrvrAddressType, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, servicePort=servicePort, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, peerUp=peerUp, ipsWebAddrTransAddress=ipsWebAddrTransAddress, serviceName=serviceName, dataPortLinkDown=dataPortLinkDown, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, uptime=uptime, httpProxyParseErr=httpProxyParseErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsCookieSecPort=ipsCookieSecPort, memoryUsageHigh=memoryUsageHigh, bws=bws, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslSrvrAvgResTime=sslSrvrAvgResTime, httpProxyServerAbrt=httpProxyServerAbrt, highAvailabilityStatus=highAvailabilityStatus, ipsReqSrvcAddressType=ipsReqSrvcAddressType, memUtilization=memUtilization, ipsReqSrvcPort=ipsReqSrvcPort, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpProxyTotalReq=httpProxyTotalReq, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, webCacheLongHdrs=webCacheLongHdrs, ipsRCAddressType=ipsRCAddressType, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, totalBandwidth=totalBandwidth, sslProxyInBytes=sslProxyInBytes, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, cpuFanSpeed=cpuFanSpeed, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, dataPathStatus=dataPathStatus, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsCookieSecAddress=ipsCookieSecAddress, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, firmwareStorage=firmwareStorage, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpProxyOutBytes=httpProxyOutBytes, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, freeMem=freeMem, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrTotReqActive=httpSrvrTotReqActive, raidDegrading=raidDegrading, totalAttacks=totalAttacks, processCountHigh=processCountHigh, activeApplications=activeApplications, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslProxyOutBytes=sslProxyOutBytes, bwsMIBGroups=bwsMIBGroups, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, serviceStatus=serviceStatus, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsRCTimeStamp=ipsRCTimeStamp, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, PYSNMP_MODULE_ID=bws, dataPortLinkUp=dataPortLinkUp, smRealmName=smRealmName, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, fanDead=fanDead, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsRCTotServed=ipsRCTotServed, httpProxyServerReq=httpProxyServerReq, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrAddress=sslSrvrAddress, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrTotRefused=sslSrvrTotRefused, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, switchingToInlineMode=switchingToInlineMode, sslSrvrPort=sslSrvrPort, sslSrvrTotResponse=sslSrvrTotResponse, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, systemFailure=systemFailure, httpProxyServerErr=httpProxyServerErr, sslProxyAddress=sslProxyAddress, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, webCmprProtocol=webCmprProtocol, ipsUrlAclAddressType=ipsUrlAclAddressType, operationalMode=operationalMode, sslProxyErrPms=sslProxyErrPms, totalApplications=totalApplications, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpSrvrNumConn=httpSrvrNumConn, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, webCacheProtocol=webCacheProtocol, peerDown=peerDown, httpSrvrPort=httpSrvrPort, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpProxyTotalConn=httpProxyTotalConn, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsCookieSecTampered=ipsCookieSecTampered, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsRCTotOutOfResource=ipsRCTotOutOfResource, webCmprAddress=webCmprAddress, bwsTrapGroup=bwsTrapGroup, bwsMIBCompliances=bwsMIBCompliances, smAgentName=smAgentName, systemLoad=systemLoad, energizeUpdateExpire=energizeUpdateExpire, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslSrvrInBytes=sslSrvrInBytes, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, switchingToBypassMode=switchingToBypassMode, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpSrvrTotResponse=httpSrvrTotResponse, sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslSrvrMinResTime=sslSrvrMinResTime, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsMIBConformance=bwsMIBConformance, sslProxyPort=sslProxyPort, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, logStorage=logStorage, ipsReqSrvcAddress=ipsReqSrvcAddress, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrMaxResTime=sslSrvrMaxResTime, webCacheHits=webCacheHits, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, linkStatus=linkStatus, webCmprAddressType=webCmprAddressType, bwsMessage=bwsMessage, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, webCacheBytesOut=webCacheBytesOut, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsReqLimitPort=ipsReqLimitPort, sslSrvrTotSuccess=sslSrvrTotSuccess, httpProxyInBytes=httpProxyInBytes, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslProxyActiveConn=sslProxyActiveConn, ipsRCAddress=ipsRCAddress, sslSrvrState=sslSrvrState, sslProxyCacheHits=sslProxyCacheHits, systemSerialNumber=systemSerialNumber, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, webCacheStale=webCacheStale, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, currentFirmwareVersion=currentFirmwareVersion, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, webCmprPort=webCmprPort, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsRCTotQueued=ipsRCTotQueued, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsServiceStatusTable=bwsServiceStatusTable, bwsMIBCompliance=bwsMIBCompliance, httpSrvrAddress=httpSrvrAddress, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, webCachePort=webCachePort, httpSrvrMinResTime=httpSrvrMinResTime, ipsReqLimitAddress=ipsReqLimitAddress, vipStatus=vipStatus, systemFailOver=systemFailOver, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsHdrAclHits=ipsHdrAclHits, sslSrvrNumConn=sslSrvrNumConn, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpProxyPort=httpProxyPort, webCacheCacheableRes=webCacheCacheableRes)
mibBuilder.exportSymbols("BWS-MIB", bwsCompressionStatsTable=bwsCompressionStatsTable, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslSrvrOutBytes=sslSrvrOutBytes, httpSrvrOutBytes=httpSrvrOutBytes, ipsUrlAclReserved=ipsUrlAclReserved, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, webCmprCompressibleDataSize=webCmprCompressibleDataSize, switchingToMaintMode=switchingToMaintMode, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsHdrAclPort=ipsHdrAclPort, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsUrlNormAddress=ipsUrlNormAddress, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsHdrAclAddressType=ipsHdrAclAddressType, webCacheMiss=webCacheMiss, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, totalServers=totalServers, srvcName=srvcName, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsRCTotDropped=ipsRCTotDropped, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, systemFanSpeed=systemFanSpeed, httpProxyClientAbrt=httpProxyClientAbrt, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsHdrAclAddress=ipsHdrAclAddress, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpSrvrTotTimedout=httpSrvrTotTimedout, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrAddressType=httpSrvrAddressType, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsServiceStatusEntry=bwsServiceStatusEntry, httpSrvrTotSuccess=httpSrvrTotSuccess, webCacheAddressType=webCacheAddressType, httpSrvrAvgResTime=httpSrvrAvgResTime, cpuUtilization=cpuUtilization, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslSrvrTotReqActive=sslSrvrTotReqActive, serviceAddress=serviceAddress, serverUp=serverUp, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrSrvcAddress=httpSrvrSrvcAddress, webCacheReq=webCacheReq, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, virusDefUpdates=virusDefUpdates, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpProxyAddressType=httpProxyAddressType, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsUrlNormPort=ipsUrlNormPort, firmwareStorageHigh=firmwareStorageHigh, bwsStats=bwsStats, bwsStatsGroup=bwsStatsGroup, bwsCacheStatsTable=bwsCacheStatsTable)
