...
TimeTicks, ModuleIdentity, Integer32, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, ObjectIdentity, Bits, IpAddress, Counter64, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "Integer32", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "ObjectIdentity", "Bits", "IpAddress", "Counter64", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("BWS-MIB", ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, peerDown=peerDown, sslSrvrTotResponse=sslSrvrTotResponse, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, webCacheAddressType=webCacheAddressType, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, totalServers=totalServers, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, energizeUpdateExpire=energizeUpdateExpire, ipsUrlAclReserved=ipsUrlAclReserved, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, serverDown=serverDown, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, peerUp=peerUp, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, firmwareStorage=firmwareStorage, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpSrvrTotRefused=httpSrvrTotRefused, sslSrvrTotRefused=sslSrvrTotRefused, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, linkStatus=linkStatus, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpProxyTotalConn=httpProxyTotalConn, smAgentName=smAgentName, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, smRealmName=smRealmName, httpProxyInBytes=httpProxyInBytes, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, currentFirmwareVersion=currentFirmwareVersion, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrOutBytes=sslSrvrOutBytes, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslSrvrTotReqRejected=sslSrvrTotReqRejected, serviceName=serviceName, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslProxyAddressType=sslProxyAddressType, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, dataPortLinkDown=dataPortLinkDown, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslProxyTotalReq=sslProxyTotalReq, sslSrvrPort=sslSrvrPort, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, firmwareStorageHigh=firmwareStorageHigh, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsHdrAclHits=ipsHdrAclHits, sslProxyCacheMiss=sslProxyCacheMiss, ipsRCTotQueued=ipsRCTotQueued, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsUrlAclAddressType=ipsUrlAclAddressType, serviceAddress=serviceAddress, ipsReqLimitPort=ipsReqLimitPort, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsRCTotOutOfResource=ipsRCTotOutOfResource, totalBandwidth=totalBandwidth, bwsServiceStatusTable=bwsServiceStatusTable, httpProxyPort=httpProxyPort, ipsReqSrvcPort=ipsReqSrvcPort, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsCookieSecAddressType=ipsCookieSecAddressType, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, activeApplications=activeApplications, ipsUrlAclPort=ipsUrlAclPort, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, systemFailure=systemFailure, bwsTrapGroup=bwsTrapGroup, webCacheCachedObjects=webCacheCachedObjects, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsStats=bwsStats, switchingToMaintMode=switchingToMaintMode, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpProxyServerErr=httpProxyServerErr, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsReqLimitAddress=ipsReqLimitAddress, webCacheStale=webCacheStale, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, securityDefUpdates=securityDefUpdates, webCmprProtocol=webCmprProtocol, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, serverUp=serverUp, ipsCookieSecPort=ipsCookieSecPort, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, tempHigh=tempHigh, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, systemSerialNumber=systemSerialNumber, httpSrvrMaxResTime=httpSrvrMaxResTime, freeMem=freeMem, sslSrvrAddress=sslSrvrAddress, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslProxyErrPms=sslProxyErrPms, cpuTemperature=cpuTemperature, ipsUrlNormAddress=ipsUrlNormAddress, httpProxyAddress=httpProxyAddress, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, webCacheBytesOut=webCacheBytesOut, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, totalAttacks=totalAttacks, totalApplications=totalApplications, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, switchingToInlineMode=switchingToInlineMode, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsRCAddress=ipsRCAddress, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsMIBCompliance=bwsMIBCompliance, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpProxyAddressType=httpProxyAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, raidDegrading=raidDegrading, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, webCmprPort=webCmprPort, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsMIBCompliances=bwsMIBCompliances, sslSrvrState=sslSrvrState, ipsReqSrvcAddressType=ipsReqSrvcAddressType, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslProxyActiveConn=sslProxyActiveConn, vipStatus=vipStatus, sslSrvrInBytes=sslSrvrInBytes, webCacheHits=webCacheHits, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslProxyPort=sslProxyPort, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsHdrAclAddress=ipsHdrAclAddress, ipsRCPort=ipsRCPort, webCmprCompressedDataSize=webCmprCompressedDataSize, activeServers=activeServers, webCmprAddress=webCmprAddress, httpSrvrPort=httpSrvrPort, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslProxyCacheTimeouts=sslProxyCacheTimeouts, uptime=uptime, processCountHigh=processCountHigh, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsMIBGroups=bwsMIBGroups, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsRCTimeStamp=ipsRCTimeStamp, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsUrlNormPort=ipsUrlNormPort, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpSrvrAddress=httpSrvrAddress, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrNumConn=sslSrvrNumConn, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, memUtilization=memUtilization, webCmprAddressType=webCmprAddressType, httpSrvrTotReqRejected=httpSrvrTotReqRejected, operationalMode=operationalMode, sslSrvrTotTimedout=sslSrvrTotTimedout, sslProxyInBytes=sslProxyInBytes, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslProxyAddress=sslProxyAddress, webCacheReq=webCacheReq, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpProxyParseErr=httpProxyParseErr, srvcName=srvcName, ipsRCAddressType=ipsRCAddressType, httpSrvrOutBytes=httpSrvrOutBytes, dataPathStatus=dataPathStatus, bwsCacheStatsTable=bwsCacheStatsTable, webCacheCacheableRes=webCacheCacheableRes, systemLoad=systemLoad, ipsRCTotServed=ipsRCTotServed, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpProxyClientAbrt=httpProxyClientAbrt, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsUrlAclAddress=ipsUrlAclAddress, webCachePort=webCachePort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpProxyServerAbrt=httpProxyServerAbrt, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslProxyOutBytes=sslProxyOutBytes, systemFailOver=systemFailOver, dataPortLinkUp=dataPortLinkUp, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, cpuFanSpeed=cpuFanSpeed, serviceStatus=serviceStatus, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpSrvrAddressType=httpSrvrAddressType, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslProxyCurrentConn=sslProxyCurrentConn, switchingToBypassMode=switchingToBypassMode, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sharedSecretKeyExpired=sharedSecretKeyExpired, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, servicePort=servicePort, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslProxyCacheHits=sslProxyCacheHits, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpSrvrInBytes=httpSrvrInBytes, logStorage=logStorage, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, webCacheAddress=webCacheAddress, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslSrvrAvgResTime=sslSrvrAvgResTime, httpProxyActiveConn=httpProxyActiveConn, webCacheLongHdrs=webCacheLongHdrs, cpuUtilization=cpuUtilization, httpSrvrTotResponse=httpSrvrTotResponse)
mibBuilder.exportSymbols("BWS-MIB", webCacheProtocol=webCacheProtocol, firmwareUpdateAvailable=firmwareUpdateAvailable, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwstraps=bwstraps, PYSNMP_MODULE_ID=bws, bwsMessage=bwsMessage, httpProxyWAFWarnings=httpProxyWAFWarnings, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, systemFanSpeed=systemFanSpeed, httpSrvrState=httpSrvrState, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsCookieSecTampered=ipsCookieSecTampered, ipsReqSrvcAddress=ipsReqSrvcAddress, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bws=bws, ipsHdrAclPort=ipsHdrAclPort, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpSrvrMinResTime=httpSrvrMinResTime, highAvailabilityStatus=highAvailabilityStatus, httpProxyTotalReq=httpProxyTotalReq, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsMIBConformance=bwsMIBConformance, httpSrvrNumConn=httpSrvrNumConn, sslProxyTotalConn=sslProxyTotalConn, sslSrvrMinResTime=sslSrvrMinResTime, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, smNumUserSessions=smNumUserSessions, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, fanDead=fanDead, bwsStatsGroup=bwsStatsGroup, webCacheMiss=webCacheMiss, ipsWebAddrTransPort=ipsWebAddrTransPort, memoryUsageHigh=memoryUsageHigh, httpProxyOutBytes=httpProxyOutBytes, tempCritical=tempCritical, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpProxyServerReq=httpProxyServerReq, totalMem=totalMem, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, logStorageHigh=logStorageHigh, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, virusDefUpdates=virusDefUpdates, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpSrvrTotTimedout=httpSrvrTotTimedout, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslSrvrAddressType=sslSrvrAddressType, ipsRCTotDropped=ipsRCTotDropped, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsCacheStatsEntry=bwsCacheStatsEntry)
