...
ObjectIdentity, iso, TimeTicks, IpAddress, Bits, Unsigned32, Counter32, Gauge32, NotificationType, Counter64, MibIdentifier, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "TimeTicks", "IpAddress", "Bits", "Unsigned32", "Counter32", "Gauge32", "NotificationType", "Counter64", "MibIdentifier", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("BWS-MIB", httpProxyInBytes=httpProxyInBytes, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, fanDead=fanDead, bwsServiceStatusTable=bwsServiceStatusTable, webCacheAddressType=webCacheAddressType, sslSrvrTotResponse=sslSrvrTotResponse, webCmprPort=webCmprPort, sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsUrlNormAddress=ipsUrlNormAddress, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, smAgentName=smAgentName, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslProxyTotalReq=sslProxyTotalReq, ipsHdrAclAddress=ipsHdrAclAddress, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, totalMem=totalMem, webCmprAddress=webCmprAddress, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsUrlNormPort=ipsUrlNormPort, httpSrvrAddressType=httpSrvrAddressType, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpSrvrTotReqActive=httpSrvrTotReqActive, httpProxyTotalReq=httpProxyTotalReq, bwsMIBGroups=bwsMIBGroups, PYSNMP_MODULE_ID=bws, webCacheStale=webCacheStale, webCacheCachedObjects=webCacheCachedObjects, sslProxyPort=sslProxyPort, cpuUtilization=cpuUtilization, httpProxyActiveConn=httpProxyActiveConn, bwsTrapGroup=bwsTrapGroup, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, switchingToBypassMode=switchingToBypassMode, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, firmwareStorageHigh=firmwareStorageHigh, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpProxyServerErr=httpProxyServerErr, bwsCacheStatsTable=bwsCacheStatsTable, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrPort=httpSrvrPort, sslSrvrNumConn=sslSrvrNumConn, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwstraps=bwstraps, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsUrlAclPort=ipsUrlAclPort, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, webCacheCacheableRes=webCacheCacheableRes, bwsStatsGroup=bwsStatsGroup, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpSrvrNumConn=httpSrvrNumConn, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpSrvrOutBytes=httpSrvrOutBytes, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslSrvrAddress=sslSrvrAddress, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsLrnSrvcPort=ipsLrnSrvcPort, webCachePort=webCachePort, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, activeApplications=activeApplications, systemSerialNumber=systemSerialNumber, ipsRCAddressType=ipsRCAddressType, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslProxyFullHandshakes=sslProxyFullHandshakes, systemLoad=systemLoad, ipsRCTimeStamp=ipsRCTimeStamp, ipsRCTotServed=ipsRCTotServed, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpProxyTotalConn=httpProxyTotalConn, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsMessage=bwsMessage, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsReqSrvcPort=ipsReqSrvcPort, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, serviceAddress=serviceAddress, totalApplications=totalApplications, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpSrvrState=httpSrvrState, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslSrvrState=sslSrvrState, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, logStorage=logStorage, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpProxyAddressType=httpProxyAddressType, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsRCTotDropped=ipsRCTotDropped, httpProxyPort=httpProxyPort, memoryUsageHigh=memoryUsageHigh, freeMem=freeMem, firmwareUpdateAvailable=firmwareUpdateAvailable, systemFailure=systemFailure, ipsRCAddress=ipsRCAddress, httpProxyOutBytes=httpProxyOutBytes, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpProxyAddress=httpProxyAddress, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrNumFreeConn=httpSrvrNumFreeConn, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsUrlAclReserved=ipsUrlAclReserved, sslProxyActiveConn=sslProxyActiveConn, totalBandwidth=totalBandwidth, peerDown=peerDown, dataPortLinkUp=dataPortLinkUp, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslProxyTotalConn=sslProxyTotalConn, httpSrvrMinResTime=httpSrvrMinResTime, activeServers=activeServers, memUtilization=memUtilization, httpProxyServerReq=httpProxyServerReq, serverUp=serverUp, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsMIBConformance=bwsMIBConformance, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, servicePort=servicePort, energizeUpdateExpire=energizeUpdateExpire, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslSrvrSrvcPort=sslSrvrSrvcPort, serviceName=serviceName, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrMaxResTime=sslSrvrMaxResTime, httpSrvrSrvcPort=httpSrvrSrvcPort, cpuTemperature=cpuTemperature, ipsUrlAclAddressType=ipsUrlAclAddressType, bws=bws, sslProxyCacheHits=sslProxyCacheHits, webCacheProtocol=webCacheProtocol, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpProxyParseErr=httpProxyParseErr, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsMIBCompliances=bwsMIBCompliances, httpSrvrTotRefused=httpSrvrTotRefused, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, webCacheHits=webCacheHits, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsCookieSecPort=ipsCookieSecPort, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, logStorageHigh=logStorageHigh, webCacheMiss=webCacheMiss, webCacheLongHdrs=webCacheLongHdrs, ipsUrlPolicyPort=ipsUrlPolicyPort, sslProxyOutBytes=sslProxyOutBytes, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, firmwareStorage=firmwareStorage, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsReqLimitPort=ipsReqLimitPort, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslProxyAddress=sslProxyAddress, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpProxyServerAbrt=httpProxyServerAbrt, vipStatus=vipStatus, peerUp=peerUp, ipsReqLimitAddress=ipsReqLimitAddress, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, webCacheBytesOut=webCacheBytesOut, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, raidDegrading=raidDegrading, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, srvcName=srvcName, sslSrvrInBytes=sslSrvrInBytes, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsMIBCompliance=bwsMIBCompliance, dataPathStatus=dataPathStatus, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslProxyAddressType=sslProxyAddressType, currentFirmwareVersion=currentFirmwareVersion, systemFailOver=systemFailOver, sslSrvrOutBytes=sslSrvrOutBytes, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslProxyBadCRLErr=sslProxyBadCRLErr, smRealmName=smRealmName, serviceStatus=serviceStatus, httpProxyWAFWarnings=httpProxyWAFWarnings, uptime=uptime, sslProxyInBytes=sslProxyInBytes, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpSrvrAddress=httpSrvrAddress, sslSrvrPort=sslSrvrPort, securityDefUpdates=securityDefUpdates, webCacheAddress=webCacheAddress, switchingToMaintMode=switchingToMaintMode, tempHigh=tempHigh, sslSrvrAddressType=sslSrvrAddressType, sslProxyCurrentConn=sslProxyCurrentConn, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, cpuFanSpeed=cpuFanSpeed, bwsCacheStatsEntry=bwsCacheStatsEntry)
mibBuilder.exportSymbols("BWS-MIB", ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsHdrAclHits=ipsHdrAclHits, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslSrvrTotRefused=sslSrvrTotRefused, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsHdrAclPort=ipsHdrAclPort, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrTotReqRejected=sslSrvrTotReqRejected, dataPortLinkDown=dataPortLinkDown, ipsUrlAclAddress=ipsUrlAclAddress, tempCritical=tempCritical, totalAttacks=totalAttacks, httpSrvrInBytes=httpSrvrInBytes, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, serverDown=serverDown, sslSrvrTotSuccess=sslSrvrTotSuccess, smNumUserSessions=smNumUserSessions, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, linkStatus=linkStatus, ipsCookieSecAddress=ipsCookieSecAddress, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, highAvailabilityStatus=highAvailabilityStatus, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrTotTimedout=sslSrvrTotTimedout, operationalMode=operationalMode, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, systemFanSpeed=systemFanSpeed, ipsRCPort=ipsRCPort, webCacheReq=webCacheReq, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, webCmprCompressedDataSize=webCmprCompressedDataSize, virusDefUpdates=virusDefUpdates, totalServers=totalServers, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, webCmprAddressType=webCmprAddressType, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrTotResponse=httpSrvrTotResponse, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsRCTotQueued=ipsRCTotQueued, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsStats=bwsStats, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, processCountHigh=processCountHigh, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsCookieSecTampered=ipsCookieSecTampered, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslProxyErrPms=sslProxyErrPms, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, switchingToInlineMode=switchingToInlineMode, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, webCmprProtocol=webCmprProtocol, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp)
