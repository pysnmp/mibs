...
Counter32, IpAddress, Counter64, TimeTicks, ModuleIdentity, ObjectIdentity, Unsigned32, Bits, NotificationType, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "Counter64", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "Bits", "NotificationType", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("BWS-MIB", httpProxyTotalReq=httpProxyTotalReq, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, memUtilization=memUtilization, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwstraps=bwstraps, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsHdrAclHits=ipsHdrAclHits, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, webCacheCachedObjects=webCacheCachedObjects, ipsRCTotDropped=ipsRCTotDropped, serviceAddress=serviceAddress, bwsStatsGroup=bwsStatsGroup, httpProxyInBytes=httpProxyInBytes, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsRCTotQueued=ipsRCTotQueued, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsUrlPolicyAddress=ipsUrlPolicyAddress, logStorageHigh=logStorageHigh, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsRCAddressType=ipsRCAddressType, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsUrlNormPort=ipsUrlNormPort, ipsUrlAclPort=ipsUrlAclPort, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsMIBGroups=bwsMIBGroups, httpSrvrMinResTime=httpSrvrMinResTime, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrAddressType=httpSrvrAddressType, webCmprAddressType=webCmprAddressType, sslSrvrTotRefused=sslSrvrTotRefused, logStorage=logStorage, newAttackDefinitionInstalled=newAttackDefinitionInstalled, smAgentName=smAgentName, webCmprProtocol=webCmprProtocol, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsTrapGroup=bwsTrapGroup, bwsMIBCompliance=bwsMIBCompliance, sslProxyActiveConn=sslProxyActiveConn, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, totalApplications=totalApplications, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, webCacheLongHdrs=webCacheLongHdrs, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpSrvrTotResponse=httpSrvrTotResponse, sslSrvrAvgResTime=sslSrvrAvgResTime, serverUp=serverUp, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, peerUp=peerUp, webCachePort=webCachePort, raidDegrading=raidDegrading, ipsUrlAclReserved=ipsUrlAclReserved, httpProxyServerAbrt=httpProxyServerAbrt, webCacheMiss=webCacheMiss, ipsUrlAclAddressType=ipsUrlAclAddressType, httpProxySessionTimeOut=httpProxySessionTimeOut, sslProxyAddress=sslProxyAddress, bwsMIBConformance=bwsMIBConformance, httpProxyActiveConn=httpProxyActiveConn, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrMaxResTime=httpSrvrMaxResTime, processCountHigh=processCountHigh, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslProxyPort=sslProxyPort, httpProxyServerReq=httpProxyServerReq, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsAccessCtrlPort=ipsAccessCtrlPort, sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrMinResTime=sslSrvrMinResTime, dataPathStatus=dataPathStatus, switchingToInlineMode=switchingToInlineMode, vipStatus=vipStatus, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrAddress=sslSrvrAddress, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslSrvrInBytes=sslSrvrInBytes, sslSrvrTotTimedout=sslSrvrTotTimedout, freeMem=freeMem, sslSrvrState=sslSrvrState, ipsCookieSecTampered=ipsCookieSecTampered, ipsHdrAclAddress=ipsHdrAclAddress, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsSMUserSessionTable=bwsSMUserSessionTable, tempHigh=tempHigh, uptime=uptime, dataPortLinkUp=dataPortLinkUp, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpProxyOutBytes=httpProxyOutBytes, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, smRealmName=smRealmName, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, systemLoad=systemLoad, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslProxyCacheHits=sslProxyCacheHits, servicePort=servicePort, highAvailabilityStatus=highAvailabilityStatus, httpProxyWAFWarnings=httpProxyWAFWarnings, webCacheStale=webCacheStale, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsReqLimitPort=ipsReqLimitPort, bwsServiceStatusTable=bwsServiceStatusTable, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsMessage=bwsMessage, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpProxyAddress=httpProxyAddress, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsUrlAclAddress=ipsUrlAclAddress, fanDead=fanDead, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsRCAddress=ipsRCAddress, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, totalBandwidth=totalBandwidth, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, switchingToBypassMode=switchingToBypassMode, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, webCmprAddress=webCmprAddress, httpSrvrTotRefused=httpSrvrTotRefused, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrTotReqActive=httpSrvrTotReqActive, cpuUtilization=cpuUtilization, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsCookieSecEncrypted=ipsCookieSecEncrypted, virusDefUpdates=virusDefUpdates, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslProxyOutBytes=sslProxyOutBytes, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, systemFanSpeed=systemFanSpeed, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, webCacheHits=webCacheHits, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslProxyFullHandshakes=sslProxyFullHandshakes, httpProxyParseErr=httpProxyParseErr, httpSrvrPort=httpSrvrPort, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, PYSNMP_MODULE_ID=bws, dataPortLinkDown=dataPortLinkDown, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsCacheStatsEntry=bwsCacheStatsEntry, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpSrvrTotReqRejected=httpSrvrTotReqRejected, operationalMode=operationalMode, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrTotReqRejected=sslSrvrTotReqRejected, memoryUsageHigh=memoryUsageHigh, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslSrvrNumConn=sslSrvrNumConn, currentFirmwareVersion=currentFirmwareVersion, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, energizeUpdateExpire=energizeUpdateExpire, httpProxyClientAbrt=httpProxyClientAbrt, smNumUserSessions=smNumUserSessions, sslSrvrTotResponse=sslSrvrTotResponse, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, activeServers=activeServers, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsUrlNormAddress=ipsUrlNormAddress, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslProxyTotalReq=sslProxyTotalReq, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, webCmprPort=webCmprPort, ipsReqLimitAddress=ipsReqLimitAddress, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, webCacheBytesOut=webCacheBytesOut, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsCacheStatsTable=bwsCacheStatsTable, webCacheProtocol=webCacheProtocol, cpuFanSpeed=cpuFanSpeed, systemFailure=systemFailure, httpSrvrNumConn=httpSrvrNumConn, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpSrvrAddress=httpSrvrAddress, ipsRCPort=ipsRCPort, httpProxyAddressType=httpProxyAddressType, httpSrvrTotTimedout=httpSrvrTotTimedout, activeApplications=activeApplications, ipsReqSrvcAddress=ipsReqSrvcAddress, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, securityDefUpdates=securityDefUpdates, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrOutBytes=sslSrvrOutBytes, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, serviceName=serviceName, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, webCacheReq=webCacheReq, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsStats=bwsStats, ipsHdrAclPort=ipsHdrAclPort, httpSrvrState=httpSrvrState, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslProxyInBytes=sslProxyInBytes, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpProxyTotalConn=httpProxyTotalConn, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsLrnSrvcPort=ipsLrnSrvcPort, totalMem=totalMem, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, cpuTemperature=cpuTemperature, sslProxyErrPms=sslProxyErrPms, sslProxyTotalConn=sslProxyTotalConn)
mibBuilder.exportSymbols("BWS-MIB", tempCritical=tempCritical, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsRCTotServed=ipsRCTotServed, systemSerialNumber=systemSerialNumber, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpProxyPort=httpProxyPort, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, peerDown=peerDown, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, switchingToMaintMode=switchingToMaintMode, ipsCookieSecPort=ipsCookieSecPort, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsReqLimitAddressType=ipsReqLimitAddressType, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslSrvrAddressType=sslSrvrAddressType, bwsServiceStatusEntry=bwsServiceStatusEntry, srvcName=srvcName, totalServers=totalServers, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsMIBCompliances=bwsMIBCompliances, httpSrvrOutBytes=httpSrvrOutBytes, webCacheCacheableRes=webCacheCacheableRes, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpProxyServerErr=httpProxyServerErr, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslProxyAddressType=sslProxyAddressType, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, totalAttacks=totalAttacks, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslSrvrMaxResTime=sslSrvrMaxResTime, firmwareStorage=firmwareStorage, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, serverDown=serverDown, ipsRCTimeStamp=ipsRCTimeStamp, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, firmwareStorageHigh=firmwareStorageHigh, httpSrvrSrvcPort=httpSrvrSrvcPort, systemFailOver=systemFailOver, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsReqSrvcPort=ipsReqSrvcPort, bws=bws, httpSrvrInBytes=httpSrvrInBytes, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, serviceStatus=serviceStatus, httpProxyUnknownRsp=httpProxyUnknownRsp, sslSrvrPort=sslSrvrPort, webCacheAddress=webCacheAddress, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, webCacheAddressType=webCacheAddressType, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, linkStatus=linkStatus, httpSrvrTotSuccess=httpSrvrTotSuccess)
