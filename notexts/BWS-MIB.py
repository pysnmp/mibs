...
Bits, NotificationType, iso, Counter32, Gauge32, Counter64, IpAddress, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Unsigned32, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "iso", "Counter32", "Gauge32", "Counter64", "IpAddress", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Unsigned32", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, switchingToInlineMode=switchingToInlineMode, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsUrlAclAddressType=ipsUrlAclAddressType, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, linkStatus=linkStatus, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, dataPathStatus=dataPathStatus, httpProxyWAFWarnings=httpProxyWAFWarnings, smAgentName=smAgentName, totalAttacks=totalAttacks, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsRCPort=ipsRCPort, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrOutBytes=httpSrvrOutBytes, ipsRCTotQueued=ipsRCTotQueued, ipsRCTimeStamp=ipsRCTimeStamp, ipsHdrAclAddress=ipsHdrAclAddress, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, systemFailure=systemFailure, cpuFanSpeed=cpuFanSpeed, totalMem=totalMem, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, dataPortLinkDown=dataPortLinkDown, memUtilization=memUtilization, sslSrvrSrvcPort=sslSrvrSrvcPort, sslProxyOutBytes=sslProxyOutBytes, highAvailabilityStatus=highAvailabilityStatus, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, activeApplications=activeApplications, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, dataPortLinkUp=dataPortLinkUp, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsRCTotServed=ipsRCTotServed, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpProxyActiveConn=httpProxyActiveConn, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, switchingToBypassMode=switchingToBypassMode, ipsReqLimitAddress=ipsReqLimitAddress, virusDefUpdates=virusDefUpdates, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, webCacheMiss=webCacheMiss, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpSrvrTotReqActive=httpSrvrTotReqActive, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrMaxResTime=sslSrvrMaxResTime, webCacheAddress=webCacheAddress, memoryUsageHigh=memoryUsageHigh, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpProxyInBytes=httpProxyInBytes, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, raidDegrading=raidDegrading, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, processCountHigh=processCountHigh, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, webCacheCacheableRes=webCacheCacheableRes, sslSrvrTotReqActive=sslSrvrTotReqActive, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsCookieSecPort=ipsCookieSecPort, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsMIBGroups=bwsMIBGroups, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, webCachePort=webCachePort, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpProxyClientAbrt=httpProxyClientAbrt, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslProxyTotalReq=sslProxyTotalReq, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, logStorage=logStorage, sslProxyAddress=sslProxyAddress, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, servicePort=servicePort, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsMIBConformance=bwsMIBConformance, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslSrvrInBytes=sslSrvrInBytes, httpSrvrTotTimedout=httpSrvrTotTimedout, activeServers=activeServers, sslProxyCacheHits=sslProxyCacheHits, sslSrvrMinResTime=sslSrvrMinResTime, logStorageHigh=logStorageHigh, firmwareStorage=firmwareStorage, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslSrvrNumFreeConn=sslSrvrNumFreeConn, operationalMode=operationalMode, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpSrvrTotResponse=httpSrvrTotResponse, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, smRealmName=smRealmName, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslProxyTotalConn=sslProxyTotalConn, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslSrvrTotTimedout=sslSrvrTotTimedout, sslSrvrTotResponse=sslSrvrTotResponse, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, systemFanSpeed=systemFanSpeed, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsSMUserSessionEntry=bwsSMUserSessionEntry, currentFirmwareVersion=currentFirmwareVersion, cpuUtilization=cpuUtilization, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrAvgResTime=httpSrvrAvgResTime, bwstraps=bwstraps, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpProxyTotalConn=httpProxyTotalConn, httpProxyServerErr=httpProxyServerErr, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, webCmprProtocol=webCmprProtocol, ipsRCAddress=ipsRCAddress, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, securityDefUpdates=securityDefUpdates, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, webCacheCachedObjects=webCacheCachedObjects, bwsTrapGroup=bwsTrapGroup, tempHigh=tempHigh, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsReqSrvcPort=ipsReqSrvcPort, sslSrvrPort=sslSrvrPort, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrAddress=sslSrvrAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsHdrAclHits=ipsHdrAclHits, ipsUrlAclReserved=ipsUrlAclReserved, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsMessage=bwsMessage, ipsReqSrvcAddress=ipsReqSrvcAddress, serverDown=serverDown, httpProxyTotalReq=httpProxyTotalReq, ipsReqLimitPort=ipsReqLimitPort, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslSrvrNumConn=sslSrvrNumConn, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, freeMem=freeMem, tempCritical=tempCritical, ipsCookieSecAddress=ipsCookieSecAddress, httpSrvrAddress=httpSrvrAddress, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrState=httpSrvrState, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslProxyPort=sslProxyPort, httpSrvrMaxResTime=httpSrvrMaxResTime, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, webCacheAddressType=webCacheAddressType, httpProxyServerAbrt=httpProxyServerAbrt, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslProxyCacheMiss=sslProxyCacheMiss, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, webCmprPort=webCmprPort, peerDown=peerDown, vipStatus=vipStatus, bwsMIBCompliance=bwsMIBCompliance, systemLoad=systemLoad, energizeUpdateExpire=energizeUpdateExpire, systemFailOver=systemFailOver, sslSrvrAddressType=sslSrvrAddressType, bwsStats=bwsStats, firmwareStorageHigh=firmwareStorageHigh, webCacheHits=webCacheHits, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslProxyBadDNCErr=sslProxyBadDNCErr, totalBandwidth=totalBandwidth, serviceName=serviceName, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpSrvrNumConn=httpSrvrNumConn, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslProxyCurrentConn=sslProxyCurrentConn, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, switchingToMaintMode=switchingToMaintMode, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, fanDead=fanDead, ipsAccessCtrlPort=ipsAccessCtrlPort, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, serviceAddress=serviceAddress, sslSrvrOutBytes=sslSrvrOutBytes, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlPolicyPort=ipsUrlPolicyPort, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsMIBCompliances=bwsMIBCompliances, bwsCacheStatsTable=bwsCacheStatsTable, ipsRCTotDropped=ipsRCTotDropped, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsRCAddressType=ipsRCAddressType, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, cpuTemperature=cpuTemperature, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, webCacheReq=webCacheReq, ipsHdrAclPort=ipsHdrAclPort, webCacheLongHdrs=webCacheLongHdrs, bws=bws, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, serverUp=serverUp, webCacheBytesOut=webCacheBytesOut, bwsStatsGroup=bwsStatsGroup, httpProxyServerReq=httpProxyServerReq, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss)
mibBuilder.exportSymbols("BWS-MIB", ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, totalServers=totalServers, webCacheProtocol=webCacheProtocol, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpProxyAddressType=httpProxyAddressType, sslProxyInBytes=sslProxyInBytes, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsHdrAclAddressType=ipsHdrAclAddressType, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrPort=httpSrvrPort, httpProxyPort=httpProxyPort, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpSrvrAddressType=httpSrvrAddressType, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, peerUp=peerUp, sslSrvrState=sslSrvrState, httpProxyOutBytes=httpProxyOutBytes, sslProxyFullHandshakes=sslProxyFullHandshakes, sslProxyErrPms=sslProxyErrPms, httpProxyParseErr=httpProxyParseErr, systemSerialNumber=systemSerialNumber, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslProxyAddressType=sslProxyAddressType, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, PYSNMP_MODULE_ID=bws, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpSrvrInBytes=httpSrvrInBytes, webCmprAddress=webCmprAddress, ipsUrlAclPort=ipsUrlAclPort, ipsCookieSecTampered=ipsCookieSecTampered, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, smNumUserSessions=smNumUserSessions, serviceStatus=serviceStatus, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, webCacheStale=webCacheStale, httpSrvrMinResTime=httpSrvrMinResTime, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsUrlNormPort=ipsUrlNormPort, sslProxyActiveConn=sslProxyActiveConn, ipsUrlNormAddressType=ipsUrlNormAddressType, httpProxyAddress=httpProxyAddress, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, totalApplications=totalApplications, srvcName=srvcName, sslSrvrAvgResTime=sslSrvrAvgResTime, webCmprAddressType=webCmprAddressType, uptime=uptime, httpProxySessionTimeOut=httpProxySessionTimeOut, sslSrvrTotRefused=sslSrvrTotRefused)
