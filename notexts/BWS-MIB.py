...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, ModuleIdentity, NotificationType, IpAddress, MibIdentifier, TimeTicks, Counter32, iso, Counter64, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "ModuleIdentity", "NotificationType", "IpAddress", "MibIdentifier", "TimeTicks", "Counter32", "iso", "Counter64", "Integer32", "ObjectIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrTotResponse=httpSrvrTotResponse, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sharedSecretKeyExpired=sharedSecretKeyExpired, httpProxyParseErr=httpProxyParseErr, ipsReqLimitPort=ipsReqLimitPort, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwstraps=bwstraps, virusDefUpdates=virusDefUpdates, ipsRCAddressType=ipsRCAddressType, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslProxyErrPms=sslProxyErrPms, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpProxyActiveConn=httpProxyActiveConn, bwsMIBConformance=bwsMIBConformance, ipsReqLimitAddress=ipsReqLimitAddress, webCacheAddress=webCacheAddress, sslProxyInBytes=sslProxyInBytes, sslSrvrSrvcPort=sslSrvrSrvcPort, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, energizeUpdateExpire=energizeUpdateExpire, webCacheProtocol=webCacheProtocol, sslProxyOutBytes=sslProxyOutBytes, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsServiceStatusEntry=bwsServiceStatusEntry, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrNumConn=sslSrvrNumConn, httpProxyTotalConn=httpProxyTotalConn, activeApplications=activeApplications, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, currentFirmwareVersion=currentFirmwareVersion, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrAddressType=sslSrvrAddressType, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, webCacheAddressType=webCacheAddressType, serviceStatus=serviceStatus, systemSerialNumber=systemSerialNumber, sslProxyPort=sslProxyPort, systemLoad=systemLoad, sslSrvrPort=sslSrvrPort, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsRCPort=ipsRCPort, httpSrvrTotTimedout=httpSrvrTotTimedout, freeMem=freeMem, bwsCompressionStatsTable=bwsCompressionStatsTable, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslProxyTotalConn=sslProxyTotalConn, systemFailOver=systemFailOver, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslProxyCacheMiss=sslProxyCacheMiss, bws=bws, ipsHdrAclAddress=ipsHdrAclAddress, dataPortLinkDown=dataPortLinkDown, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrAddress=sslSrvrAddress, httpProxyServerErr=httpProxyServerErr, linkStatus=linkStatus, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, operationalMode=operationalMode, ipsCookieSecEncrypted=ipsCookieSecEncrypted, smAgentName=smAgentName, logStorageHigh=logStorageHigh, dataPathStatus=dataPathStatus, webCmprAddressType=webCmprAddressType, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, webCmprCompressibleDataSize=webCmprCompressibleDataSize, memUtilization=memUtilization, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, webCmprProtocol=webCmprProtocol, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsRCTotServed=ipsRCTotServed, bwsStatsGroup=bwsStatsGroup, uptime=uptime, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, serverDown=serverDown, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, webCmprAddress=webCmprAddress, sslSrvrInBytes=sslSrvrInBytes, httpProxyAddressType=httpProxyAddressType, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsStats=bwsStats, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslProxyBadDNCErr=sslProxyBadDNCErr, servicePort=servicePort, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, webCachePort=webCachePort, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpSrvrNumConn=httpSrvrNumConn, httpProxyOutBytes=httpProxyOutBytes, ipsUrlNormAddressType=ipsUrlNormAddressType, memoryUsageHigh=memoryUsageHigh, switchingToInlineMode=switchingToInlineMode, sslProxyCurrentConn=sslProxyCurrentConn, ipsLrnSrvcAddress=ipsLrnSrvcAddress, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsRCTimeStamp=ipsRCTimeStamp, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, totalMem=totalMem, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlAclAddress=ipsUrlAclAddress, sslSrvrTotRefused=sslSrvrTotRefused, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, serviceName=serviceName, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslSrvrTotSuccess=sslSrvrTotSuccess, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsReqSrvcPort=ipsReqSrvcPort, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrOutBytes=sslSrvrOutBytes, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, totalAttacks=totalAttacks, tempCritical=tempCritical, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsLrnSrvcPort=ipsLrnSrvcPort, cpuTemperature=cpuTemperature, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, totalServers=totalServers, ipsAccessCtrlPort=ipsAccessCtrlPort, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsUrlNormAddress=ipsUrlNormAddress, httpProxySessionTimeOut=httpProxySessionTimeOut, webCacheStale=webCacheStale, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, firmwareStorageHigh=firmwareStorageHigh, webCacheLongHdrs=webCacheLongHdrs, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, logStorage=logStorage, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsSMUserSessionTable=bwsSMUserSessionTable, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsHdrAclPort=ipsHdrAclPort, httpSrvrTotRefused=httpSrvrTotRefused, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsCookieSecTampered=ipsCookieSecTampered, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, webCacheCacheableRes=webCacheCacheableRes, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsMIBGroups=bwsMIBGroups, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, webCacheBytesOut=webCacheBytesOut, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, PYSNMP_MODULE_ID=bws, webCacheMiss=webCacheMiss, processCountHigh=processCountHigh, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrInBytes=httpSrvrInBytes, bwsServiceStatusTable=bwsServiceStatusTable, sslProxyCacheHits=sslProxyCacheHits, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, vipStatus=vipStatus, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, webCacheHits=webCacheHits, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, smRealmName=smRealmName, httpSrvrSrvcPort=httpSrvrSrvcPort, httpProxyServerAbrt=httpProxyServerAbrt, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrNumFreeConn=httpSrvrNumFreeConn, totalBandwidth=totalBandwidth, httpSrvrAddress=httpSrvrAddress, httpSrvrPort=httpSrvrPort, sslProxyTotalReq=sslProxyTotalReq, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsRCAddress=ipsRCAddress, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsCookieSecPort=ipsCookieSecPort, securityDefUpdates=securityDefUpdates, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslProxyActiveConn=sslProxyActiveConn, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, cpuFanSpeed=cpuFanSpeed, sslProxyAddress=sslProxyAddress, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, totalApplications=totalApplications, activeServers=activeServers, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, switchingToBypassMode=switchingToBypassMode, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, systemFanSpeed=systemFanSpeed, highAvailabilityStatus=highAvailabilityStatus, serverUp=serverUp, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsRCTotDropped=ipsRCTotDropped, webCacheCachedObjects=webCacheCachedObjects, ipsCookieSecAddress=ipsCookieSecAddress, serviceAddress=serviceAddress, ipsUrlNormPort=ipsUrlNormPort, raidDegrading=raidDegrading, sslProxyAddressType=sslProxyAddressType, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsUrlAclReserved=ipsUrlAclReserved, cpuUtilization=cpuUtilization, ipsUrlAclPort=ipsUrlAclPort, systemFailure=systemFailure, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsHdrAclHits=ipsHdrAclHits, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, tempHigh=tempHigh, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, webCmprPort=webCmprPort, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsTrapGroup=bwsTrapGroup, fanDead=fanDead, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpSrvrState=httpSrvrState, ipsUrlAclAddressType=ipsUrlAclAddressType, srvcName=srvcName, switchingToMaintMode=switchingToMaintMode, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsRCTotQueued=ipsRCTotQueued, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslSrvrState=sslSrvrState, ipsCookieSecAddressType=ipsCookieSecAddressType, peerDown=peerDown, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrAddressType=httpSrvrAddressType, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpProxyTotalReq=httpProxyTotalReq, sslSrvrMinResTime=sslSrvrMinResTime, bwsMIBCompliances=bwsMIBCompliances, firmwareUpdateAvailable=firmwareUpdateAvailable, peerUp=peerUp, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, smNumUserSessions=smNumUserSessions, httpProxyInBytes=httpProxyInBytes, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpProxyPort=httpProxyPort, httpProxyClientAbrt=httpProxyClientAbrt, httpProxyServerReq=httpProxyServerReq, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsMessage=bwsMessage, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpProxyAddress=httpProxyAddress, sslSrvrTotResponse=sslSrvrTotResponse, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, webCacheReq=webCacheReq, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpSrvrMinResTime=httpSrvrMinResTime, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsMIBCompliance=bwsMIBCompliance, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsCacheStatsTable=bwsCacheStatsTable, ipsReqSrvcAddress=ipsReqSrvcAddress, firmwareStorage=firmwareStorage, httpSrvrTotSuccess=httpSrvrTotSuccess, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, dataPortLinkUp=dataPortLinkUp, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp)
