...
TimeTicks, MibIdentifier, Bits, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Unsigned32, IpAddress, ObjectIdentity, Integer32, iso, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "Bits", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Unsigned32", "IpAddress", "ObjectIdentity", "Integer32", "iso", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", sslSrvrInBytes=sslSrvrInBytes, logStorage=logStorage, sslSrvrNumConn=sslSrvrNumConn, httpSrvrPort=httpSrvrPort, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpSrvrTotReqActive=httpSrvrTotReqActive, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpProxyTotalConn=httpProxyTotalConn, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, webCacheBytesOut=webCacheBytesOut, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsAccessCtrlAddress=ipsAccessCtrlAddress, firmwareStorageHigh=firmwareStorageHigh, httpSrvrState=httpSrvrState, sslProxyBadDNCErr=sslProxyBadDNCErr, httpProxyAddressType=httpProxyAddressType, httpProxyServerReq=httpProxyServerReq, systemFailure=systemFailure, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpProxyAddress=httpProxyAddress, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsUrlAclPort=ipsUrlAclPort, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, webCacheStale=webCacheStale, totalMem=totalMem, sslSrvrAvgResTime=sslSrvrAvgResTime, memUtilization=memUtilization, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, webCacheAddressType=webCacheAddressType, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpProxyOutBytes=httpProxyOutBytes, switchingToInlineMode=switchingToInlineMode, httpProxyClientAbrt=httpProxyClientAbrt, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, systemSerialNumber=systemSerialNumber, httpProxyInBytes=httpProxyInBytes, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsUrlNormAddressType=ipsUrlNormAddressType, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsRCTotQueued=ipsRCTotQueued, webCacheHits=webCacheHits, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlNormPort=ipsUrlNormPort, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsReqSrvcAddressType=ipsReqSrvcAddressType, systemFailOver=systemFailOver, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslProxyCurrentConn=sslProxyCurrentConn, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslSrvrTotRefused=sslSrvrTotRefused, ipsHdrAclPort=ipsHdrAclPort, energizeUpdateExpire=energizeUpdateExpire, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpSrvrTotResponse=httpSrvrTotResponse, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsReqLimitPort=ipsReqLimitPort, smNumUserSessions=smNumUserSessions, sslProxyAddress=sslProxyAddress, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsUrlAclAddress=ipsUrlAclAddress, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, serviceAddress=serviceAddress, ipsRCPort=ipsRCPort, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, firmwareStorage=firmwareStorage, bwsCacheStatsTable=bwsCacheStatsTable, ipsReqSrvcAddress=ipsReqSrvcAddress, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsMIBCompliance=bwsMIBCompliance, freeMem=freeMem, sslProxyErrPms=sslProxyErrPms, sslSrvrAddressType=sslSrvrAddressType, tempHigh=tempHigh, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsMIBConformance=bwsMIBConformance, systemFanSpeed=systemFanSpeed, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, newAttackDefinitionInstalled=newAttackDefinitionInstalled, totalServers=totalServers, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsReqLimitAddress=ipsReqLimitAddress, sslProxyActiveConn=sslProxyActiveConn, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsRCTotDropped=ipsRCTotDropped, bwsCacheStatsEntry=bwsCacheStatsEntry, webCacheReq=webCacheReq, bwsMIBGroups=bwsMIBGroups, ipsUrlAclAddressType=ipsUrlAclAddressType, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsUrlAclReserved=ipsUrlAclReserved, webCacheAddress=webCacheAddress, serviceName=serviceName, bwsTrapGroup=bwsTrapGroup, raidDegrading=raidDegrading, httpProxyUnknownRsp=httpProxyUnknownRsp, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpSrvrAddressType=httpSrvrAddressType, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsUrlPolicyPort=ipsUrlPolicyPort, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsHdrAclAddressType=ipsHdrAclAddressType, cpuUtilization=cpuUtilization, sslProxyTotalConn=sslProxyTotalConn, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsCookieSecTampered=ipsCookieSecTampered, sslProxyBadCRLErr=sslProxyBadCRLErr, processCountHigh=processCountHigh, peerDown=peerDown, webCmprAddress=webCmprAddress, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsCookieSecAddress=ipsCookieSecAddress, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, linkStatus=linkStatus, highAvailabilityStatus=highAvailabilityStatus, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, cpuTemperature=cpuTemperature, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, uptime=uptime, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, webCacheLongHdrs=webCacheLongHdrs, totalApplications=totalApplications, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, systemLoad=systemLoad, serverDown=serverDown, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, fanDead=fanDead, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, webCacheCachedObjects=webCacheCachedObjects, vipStatus=vipStatus, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpProxyParseErr=httpProxyParseErr, operationalMode=operationalMode, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, smAgentName=smAgentName, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsHdrAclHits=ipsHdrAclHits, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslProxyCacheHits=sslProxyCacheHits, serverUp=serverUp, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslSrvrAddress=sslSrvrAddress, bwsMessage=bwsMessage, activeApplications=activeApplications, sslProxyCacheMiss=sslProxyCacheMiss, ipsRCTimeStamp=ipsRCTimeStamp, httpSrvrMaxResTime=httpSrvrMaxResTime, sslProxyTotalReq=sslProxyTotalReq, sslSrvrPort=sslSrvrPort, memoryUsageHigh=memoryUsageHigh, serviceStatus=serviceStatus, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, switchingToBypassMode=switchingToBypassMode, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrState=sslSrvrState, httpProxyServerAbrt=httpProxyServerAbrt, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpSrvrInBytes=httpSrvrInBytes, sslSrvrMaxResTime=sslSrvrMaxResTime, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslProxyPort=sslProxyPort, peerUp=peerUp, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrSrvcPort=sslSrvrSrvcPort, bws=bws, ipsLrnSrvcAddress=ipsLrnSrvcAddress, PYSNMP_MODULE_ID=bws, httpProxyServerErr=httpProxyServerErr, bwstraps=bwstraps, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrTotRefused=httpSrvrTotRefused, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsRCAddress=ipsRCAddress, httpSrvrOutBytes=httpSrvrOutBytes, logStorageHigh=logStorageHigh, webCacheProtocol=webCacheProtocol, httpSrvrNumConn=httpSrvrNumConn, bwsServiceStatusTable=bwsServiceStatusTable, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslProxyInBytes=sslProxyInBytes, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsHdrAclAddress=ipsHdrAclAddress, activeServers=activeServers, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, cpuFanSpeed=cpuFanSpeed, servicePort=servicePort, webCacheMiss=webCacheMiss, bwsSMUserSessionTable=bwsSMUserSessionTable)
mibBuilder.exportSymbols("BWS-MIB", bwsCompressionStatsTable=bwsCompressionStatsTable, totalBandwidth=totalBandwidth, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsCookieSecPort=ipsCookieSecPort, httpProxyPort=httpProxyPort, sslProxyOutBytes=sslProxyOutBytes, httpSrvrAddress=httpSrvrAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, dataPortLinkDown=dataPortLinkDown, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, dataPortLinkUp=dataPortLinkUp, dataPathStatus=dataPathStatus, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsServiceStatusEntry=bwsServiceStatusEntry, httpProxyTotalReq=httpProxyTotalReq, ipsRCTotServed=ipsRCTotServed, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, switchingToMaintMode=switchingToMaintMode, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslSrvrTotResponse=sslSrvrTotResponse, sslSrvrOutBytes=sslSrvrOutBytes, webCachePort=webCachePort, httpSrvrMinResTime=httpSrvrMinResTime, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsStatsGroup=bwsStatsGroup, bwsStats=bwsStats, ipsRCAddressType=ipsRCAddressType, tempCritical=tempCritical, currentFirmwareVersion=currentFirmwareVersion, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, webCmprPort=webCmprPort, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, srvcName=srvcName, sslSrvrMinResTime=sslSrvrMinResTime, sslProxyAddressType=sslProxyAddressType, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsMIBCompliances=bwsMIBCompliances, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, smRealmName=smRealmName, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsReqSrvcPort=ipsReqSrvcPort, securityDefUpdates=securityDefUpdates, webCacheCacheableRes=webCacheCacheableRes, virusDefUpdates=virusDefUpdates, webCmprAddressType=webCmprAddressType, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslSrvrTotTimedout=sslSrvrTotTimedout, totalAttacks=totalAttacks, webCmprProtocol=webCmprProtocol, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpProxyActiveConn=httpProxyActiveConn, httpSrvrTotSuccess=httpSrvrTotSuccess)
