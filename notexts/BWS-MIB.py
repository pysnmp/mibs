...
Gauge32, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, iso, Unsigned32, IpAddress, Counter64, MibIdentifier, Bits, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "iso", "Unsigned32", "IpAddress", "Counter64", "MibIdentifier", "Bits", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("BWS-MIB", ipsReqSrvcAddressType=ipsReqSrvcAddressType, peerDown=peerDown, uptime=uptime, ipsCookieSecTampered=ipsCookieSecTampered, sslProxyCurrentConn=sslProxyCurrentConn, ipsRCPort=ipsRCPort, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, energizeUpdateExpire=energizeUpdateExpire, firmwareUpdateAvailable=firmwareUpdateAvailable, sslSrvrNumConn=sslSrvrNumConn, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslSrvrTotSuccess=sslSrvrTotSuccess, httpSrvrAddressType=httpSrvrAddressType, sslSrvrTotResponse=sslSrvrTotResponse, webCachePort=webCachePort, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsRCTotServed=ipsRCTotServed, bwsMIBCompliances=bwsMIBCompliances, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, smNumUserSessions=smNumUserSessions, sslProxyTotalReq=sslProxyTotalReq, smAgentName=smAgentName, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrInBytes=httpSrvrInBytes, bwsMIBCompliance=bwsMIBCompliance, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, logStorageHigh=logStorageHigh, firmwareStorage=firmwareStorage, httpSrvrSrvcPort=httpSrvrSrvcPort, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, tempCritical=tempCritical, ipsUrlAclPort=ipsUrlAclPort, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsAccessCtrlPort=ipsAccessCtrlPort, memoryUsageHigh=memoryUsageHigh, systemFailure=systemFailure, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsUrlAclAddress=ipsUrlAclAddress, systemFanSpeed=systemFanSpeed, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslProxyTotalConn=sslProxyTotalConn, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, PYSNMP_MODULE_ID=bws, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, webCacheMiss=webCacheMiss, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, webCmprPort=webCmprPort, raidDegrading=raidDegrading, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, serverDown=serverDown, sslSrvrPort=sslSrvrPort, httpSrvrTotReqActive=httpSrvrTotReqActive, webCmprAddressType=webCmprAddressType, ipsUrlNormAddress=ipsUrlNormAddress, httpProxyPort=httpProxyPort, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, webCacheHits=webCacheHits, ipsUrlNormPort=ipsUrlNormPort, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, systemSerialNumber=systemSerialNumber, ipsWebAddrTransPort=ipsWebAddrTransPort, bwstraps=bwstraps, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslSrvrNumFreeConn=sslSrvrNumFreeConn, freeMem=freeMem, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, cpuUtilization=cpuUtilization, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslProxyCacheMiss=sslProxyCacheMiss, webCacheCachedObjects=webCacheCachedObjects, webCacheProtocol=webCacheProtocol, httpProxyServerReq=httpProxyServerReq, ipsCookieSecAddress=ipsCookieSecAddress, totalBandwidth=totalBandwidth, sslProxyOutBytes=sslProxyOutBytes, sslProxyCacheTimeouts=sslProxyCacheTimeouts, webCacheBytesOut=webCacheBytesOut, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, activeApplications=activeApplications, ipsHdrAclHits=ipsHdrAclHits, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpProxyAddress=httpProxyAddress, sslSrvrMinResTime=sslSrvrMinResTime, dataPortLinkDown=dataPortLinkDown, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpProxyAddressType=httpProxyAddressType, ipsHdrAclPort=ipsHdrAclPort, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, switchingToBypassMode=switchingToBypassMode, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsRCAddressType=ipsRCAddressType, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpProxyServerAbrt=httpProxyServerAbrt, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpSrvrState=httpSrvrState, bwsCompressionStatsEntry=bwsCompressionStatsEntry, srvcName=srvcName, ipsReqLimitAddress=ipsReqLimitAddress, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpProxyOutBytes=httpProxyOutBytes, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpSrvrPort=httpSrvrPort, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsUrlAclAddressType=ipsUrlAclAddressType, sslProxyInBytes=sslProxyInBytes, sslSrvrAddress=sslSrvrAddress, httpProxyParseErr=httpProxyParseErr, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, smRealmName=smRealmName, currentFirmwareVersion=currentFirmwareVersion, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslProxyAddressType=sslProxyAddressType, httpProxyClientAbrt=httpProxyClientAbrt, httpSrvrTotRefused=httpSrvrTotRefused, dataPortLinkUp=dataPortLinkUp, dataPathStatus=dataPathStatus, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, cpuFanSpeed=cpuFanSpeed, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsRCTotDropped=ipsRCTotDropped, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslProxyPort=sslProxyPort, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsSMUserSessionTable=bwsSMUserSessionTable, httpProxyActiveConn=httpProxyActiveConn, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsLrnSrvcAddress=ipsLrnSrvcAddress, serviceAddress=serviceAddress, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, firmwareStorageHigh=firmwareStorageHigh, cpuTemperature=cpuTemperature, vipStatus=vipStatus, serviceName=serviceName, processCountHigh=processCountHigh, webCacheStale=webCacheStale, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsServiceStatusTable=bwsServiceStatusTable, activeServers=activeServers, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpSrvrOutBytes=httpSrvrOutBytes, webCacheCacheableRes=webCacheCacheableRes, sslSrvrInBytes=sslSrvrInBytes, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, operationalMode=operationalMode, bwsTrapGroup=bwsTrapGroup, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsReqLimitPort=ipsReqLimitPort, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, webCacheAddress=webCacheAddress, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, totalServers=totalServers, bwsMIBGroups=bwsMIBGroups, totalAttacks=totalAttacks, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, tempHigh=tempHigh, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpProxyWAFWarnings=httpProxyWAFWarnings, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, webCmprCompressedDataSize=webCmprCompressedDataSize, sslSrvrTotRefused=sslSrvrTotRefused, sslProxyActiveConn=sslProxyActiveConn, sslProxyErrPms=sslProxyErrPms, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpSrvrTotResponse=httpSrvrTotResponse, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsMessage=bwsMessage, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsRCAddress=ipsRCAddress, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsUrlPolicyAddress=ipsUrlPolicyAddress, webCacheReq=webCacheReq, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrAddress=httpSrvrAddress, fanDead=fanDead, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, logStorage=logStorage, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsHdrAclAddress=ipsHdrAclAddress, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, systemLoad=systemLoad, httpSrvrNumConn=httpSrvrNumConn, virusDefUpdates=virusDefUpdates, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpSrvrMinResTime=httpSrvrMinResTime, sslSrvrOutBytes=sslSrvrOutBytes, bwsStatsGroup=bwsStatsGroup, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrTotTimedout=sslSrvrTotTimedout, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsRCTotQueued=ipsRCTotQueued, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr)
mibBuilder.exportSymbols("BWS-MIB", ipsUrlAclReserved=ipsUrlAclReserved, sharedSecretKeyExpired=sharedSecretKeyExpired, sslProxyAddress=sslProxyAddress, bwsStats=bwsStats, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, serverUp=serverUp, bws=bws, sslProxyBadDNCErr=sslProxyBadDNCErr, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslSrvrState=sslSrvrState, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslSrvrMaxResTime=sslSrvrMaxResTime, webCmprProtocol=webCmprProtocol, systemFailOver=systemFailOver, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpProxyTotalConn=httpProxyTotalConn, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsMIBConformance=bwsMIBConformance, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, memUtilization=memUtilization, switchingToMaintMode=switchingToMaintMode, securityDefUpdates=securityDefUpdates, ipsReqSrvcPort=ipsReqSrvcPort, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsCookieSecPort=ipsCookieSecPort, bwsCacheStatsTable=bwsCacheStatsTable, httpProxyTotalReq=httpProxyTotalReq, ipsRCTimeStamp=ipsRCTimeStamp, sslProxyCacheHits=sslProxyCacheHits, httpProxyInBytes=httpProxyInBytes, linkStatus=linkStatus, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, switchingToInlineMode=switchingToInlineMode, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, highAvailabilityStatus=highAvailabilityStatus, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsServiceStatusEntry=bwsServiceStatusEntry, httpProxyServerErr=httpProxyServerErr, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, totalMem=totalMem, webCmprAddress=webCmprAddress, webCacheLongHdrs=webCacheLongHdrs, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, totalApplications=totalApplications, sslSrvrAddressType=sslSrvrAddressType, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsReqLimitAddressType=ipsReqLimitAddressType, webCacheAddressType=webCacheAddressType, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, peerUp=peerUp, servicePort=servicePort, serviceStatus=serviceStatus)
