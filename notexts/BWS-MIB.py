...
ModuleIdentity, Unsigned32, Integer32, NotificationType, ObjectIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, IpAddress, Counter32, iso, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "Integer32", "NotificationType", "ObjectIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "IpAddress", "Counter32", "iso", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrOutBytes=httpSrvrOutBytes, ipsRCPort=ipsRCPort, raidDegrading=raidDegrading, httpSrvrInBytes=httpSrvrInBytes, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrTotReqActive=sslSrvrTotReqActive, httpProxyOutBytes=httpProxyOutBytes, operationalMode=operationalMode, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, currentFirmwareVersion=currentFirmwareVersion, sslProxyOutBytes=sslProxyOutBytes, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsCacheStatsEntry=bwsCacheStatsEntry, httpProxyWAFWarnings=httpProxyWAFWarnings, dataPathStatus=dataPathStatus, httpProxyClientAbrt=httpProxyClientAbrt, systemLoad=systemLoad, bwsStats=bwsStats, webCacheReq=webCacheReq, httpSrvrTotResponse=httpSrvrTotResponse, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsMIBCompliances=bwsMIBCompliances, bwsCacheStatsTable=bwsCacheStatsTable, httpProxyTotalReq=httpProxyTotalReq, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrAddressType=httpSrvrAddressType, ipsRCAddress=ipsRCAddress, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpProxyAddress=httpProxyAddress, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsServiceStatusTable=bwsServiceStatusTable, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, processCountHigh=processCountHigh, totalAttacks=totalAttacks, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrTotRefused=httpSrvrTotRefused, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrTotRefused=sslSrvrTotRefused, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, cpuFanSpeed=cpuFanSpeed, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpSrvrState=httpSrvrState, switchingToBypassMode=switchingToBypassMode, switchingToMaintMode=switchingToMaintMode, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrSrvcPort=httpSrvrSrvcPort, httpProxyTotalConn=httpProxyTotalConn, webCacheStale=webCacheStale, bws=bws, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, fanDead=fanDead, sslProxyTotalReq=sslProxyTotalReq, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, webCacheMiss=webCacheMiss, ipsReqLimitAddress=ipsReqLimitAddress, memUtilization=memUtilization, webCmprPort=webCmprPort, sslSrvrMinResTime=sslSrvrMinResTime, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, servicePort=servicePort, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, systemFanSpeed=systemFanSpeed, sslSrvrPort=sslSrvrPort, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpProxyServerAbrt=httpProxyServerAbrt, httpProxyServerReq=httpProxyServerReq, httpSrvrNumConn=httpSrvrNumConn, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, systemFailure=systemFailure, sslProxyErrPms=sslProxyErrPms, webCmprAddressType=webCmprAddressType, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, webCacheCachedObjects=webCacheCachedObjects, bwsMessage=bwsMessage, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, systemFailOver=systemFailOver, serverDown=serverDown, webCacheLongHdrs=webCacheLongHdrs, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, srvcName=srvcName, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, totalBandwidth=totalBandwidth, httpSrvrAddress=httpSrvrAddress, ipsHdrAclAddress=ipsHdrAclAddress, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsTrapGroup=bwsTrapGroup, bwsMIBGroups=bwsMIBGroups, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, PYSNMP_MODULE_ID=bws, webCacheProtocol=webCacheProtocol, serverUp=serverUp, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwstraps=bwstraps, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpSrvrMinResTime=httpSrvrMinResTime, energizeUpdateExpire=energizeUpdateExpire, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslProxyActiveConn=sslProxyActiveConn, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpProxyInBytes=httpProxyInBytes, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, serviceStatus=serviceStatus, webCacheBytesOut=webCacheBytesOut, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsRCTotQueued=ipsRCTotQueued, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, smNumUserSessions=smNumUserSessions, ipsHdrAclHits=ipsHdrAclHits, securityDefUpdates=securityDefUpdates, webCmprProtocol=webCmprProtocol, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsCookieSecPort=ipsCookieSecPort, sslProxyAddressType=sslProxyAddressType, serviceName=serviceName, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsIpsRCStatsTable=bwsIpsRCStatsTable, systemSerialNumber=systemSerialNumber, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpProxyActiveConn=httpProxyActiveConn, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpProxyPort=httpProxyPort, totalMem=totalMem, memoryUsageHigh=memoryUsageHigh, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, webCmprCompressedDataSize=webCmprCompressedDataSize, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslProxyCurrentConn=sslProxyCurrentConn, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslSrvrTotResponse=sslSrvrTotResponse, firmwareStorage=firmwareStorage, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpSrvrTotSuccess=httpSrvrTotSuccess, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, webCachePort=webCachePort, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, webCacheAddress=webCacheAddress, sslSrvrNumConn=sslSrvrNumConn, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsAccessCtrlPort=ipsAccessCtrlPort, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, virusDefUpdates=virusDefUpdates, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsUrlAclReserved=ipsUrlAclReserved, cpuTemperature=cpuTemperature, sslSrvrAddress=sslSrvrAddress, ipsRCAddressType=ipsRCAddressType, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsServiceStatusEntry=bwsServiceStatusEntry, dataPortLinkUp=dataPortLinkUp, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, smAgentName=smAgentName, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsCookieSecAddressType=ipsCookieSecAddressType, sslProxyPort=sslProxyPort, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, uptime=uptime, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, webCacheCacheableRes=webCacheCacheableRes, ipsUrlNormPort=ipsUrlNormPort, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsRCTotDropped=ipsRCTotDropped, ipsUrlAclPort=ipsUrlAclPort, tempHigh=tempHigh, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrAddressType=sslSrvrAddressType, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpProxyServerErr=httpProxyServerErr, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslSrvrMaxResTime=sslSrvrMaxResTime, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsHdrAclAddressType=ipsHdrAclAddressType, logStorage=logStorage, sslProxyAddress=sslProxyAddress, sslSrvrTotTimedout=sslSrvrTotTimedout, httpSrvrTotReqRejected=httpSrvrTotReqRejected, smRealmName=smRealmName, activeApplications=activeApplications, cpuUtilization=cpuUtilization, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlPolicyPort=ipsUrlPolicyPort, httpProxyUnknownRsp=httpProxyUnknownRsp, sslProxyCacheMiss=sslProxyCacheMiss, bwsSMUserSessionTable=bwsSMUserSessionTable, webCacheAddressType=webCacheAddressType, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslSrvrInBytes=sslSrvrInBytes, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsUrlPolicyAddress=ipsUrlPolicyAddress, tempCritical=tempCritical, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsRCTimeStamp=ipsRCTimeStamp)
mibBuilder.exportSymbols("BWS-MIB", vipStatus=vipStatus, bwsStatsGroup=bwsStatsGroup, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, switchingToInlineMode=switchingToInlineMode, logStorageHigh=logStorageHigh, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpProxyAddressType=httpProxyAddressType, sslSrvrAvgResTime=sslSrvrAvgResTime, webCacheHits=webCacheHits, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, serviceAddress=serviceAddress, bwsMIBCompliance=bwsMIBCompliance, bwsMIBConformance=bwsMIBConformance, linkStatus=linkStatus, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsHdrAclPort=ipsHdrAclPort, peerDown=peerDown, totalApplications=totalApplications, peerUp=peerUp, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslProxyCacheHits=sslProxyCacheHits, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, highAvailabilityStatus=highAvailabilityStatus, sslProxyInBytes=sslProxyInBytes, ipsReqLimitPort=ipsReqLimitPort, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslProxyBadDNCErr=sslProxyBadDNCErr, totalServers=totalServers, httpSrvrPort=httpSrvrPort, freeMem=freeMem, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsReqSrvcPort=ipsReqSrvcPort, firmwareStorageHigh=firmwareStorageHigh, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrState=sslSrvrState, sslSrvrOutBytes=sslSrvrOutBytes, httpProxyParseErr=httpProxyParseErr, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsRCTotServed=ipsRCTotServed, sslProxyTotalConn=sslProxyTotalConn, webCmprAddress=webCmprAddress, activeServers=activeServers, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsCookieSecTampered=ipsCookieSecTampered, dataPortLinkDown=dataPortLinkDown, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn)
