...
IpAddress, ModuleIdentity, Counter32, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, Integer32, Counter64, MibIdentifier, Gauge32, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "Counter32", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "Integer32", "Counter64", "MibIdentifier", "Gauge32", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("BWS-MIB", webCacheProtocol=webCacheProtocol, ipsUrlNormAddress=ipsUrlNormAddress, ipsRCTotDropped=ipsRCTotDropped, httpProxyAddressType=httpProxyAddressType, webCmprCompressibleDataSize=webCmprCompressibleDataSize, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, webCacheAddress=webCacheAddress, tempCritical=tempCritical, sharedSecretKeyExpired=sharedSecretKeyExpired, raidDegrading=raidDegrading, sslSrvrAddress=sslSrvrAddress, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslProxyCacheMiss=sslProxyCacheMiss, sslSrvrSrvcAddress=sslSrvrSrvcAddress, operationalMode=operationalMode, switchingToInlineMode=switchingToInlineMode, sslProxyInBytes=sslProxyInBytes, cpuUtilization=cpuUtilization, firmwareUpdateAvailable=firmwareUpdateAvailable, highAvailabilityStatus=highAvailabilityStatus, httpProxySessionTimeOut=httpProxySessionTimeOut, firmwareStorageHigh=firmwareStorageHigh, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, servicePort=servicePort, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, serviceAddress=serviceAddress, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsCookieSecAddress=ipsCookieSecAddress, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslSrvrInBytes=sslSrvrInBytes, httpSrvrMinResTime=httpSrvrMinResTime, freeMem=freeMem, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsHdrAclAddress=ipsHdrAclAddress, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsMIBCompliances=bwsMIBCompliances, httpProxyTotalReq=httpProxyTotalReq, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsMIBConformance=bwsMIBConformance, httpProxyOutBytes=httpProxyOutBytes, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsReqLimitPort=ipsReqLimitPort, sslProxyBadDNCErr=sslProxyBadDNCErr, memUtilization=memUtilization, httpSrvrOutBytes=httpSrvrOutBytes, memoryUsageHigh=memoryUsageHigh, httpProxyActiveConn=httpProxyActiveConn, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsReqLimitAddress=ipsReqLimitAddress, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, switchingToBypassMode=switchingToBypassMode, systemSerialNumber=systemSerialNumber, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsMIBCompliance=bwsMIBCompliance, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsUrlPolicyPort=ipsUrlPolicyPort, serverDown=serverDown, totalAttacks=totalAttacks, systemFailure=systemFailure, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpProxyPort=httpProxyPort, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsMessage=bwsMessage, httpSrvrInBytes=httpSrvrInBytes, webCmprPort=webCmprPort, ipsUrlAclPort=ipsUrlAclPort, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsHdrAclPort=ipsHdrAclPort, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpProxyServerAbrt=httpProxyServerAbrt, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, cpuFanSpeed=cpuFanSpeed, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsUrlNormPort=ipsUrlNormPort, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, dataPortLinkUp=dataPortLinkUp, systemFanSpeed=systemFanSpeed, httpSrvrState=httpSrvrState, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, linkStatus=linkStatus, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslProxyPort=sslProxyPort, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsServiceStatusEntry=bwsServiceStatusEntry, sslProxyAddressType=sslProxyAddressType, ipsRCAddress=ipsRCAddress, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsCookieSecPort=ipsCookieSecPort, httpProxyInBytes=httpProxyInBytes, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsStats=bwsStats, totalBandwidth=totalBandwidth, httpProxyParseErr=httpProxyParseErr, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslSrvrTotReqActive=sslSrvrTotReqActive, sslProxyOutBytes=sslProxyOutBytes, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsServiceStatusTable=bwsServiceStatusTable, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsRCPort=ipsRCPort, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, serverUp=serverUp, fanDead=fanDead, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslSrvrTotResponse=sslSrvrTotResponse, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwstraps=bwstraps, activeApplications=activeApplications, sslProxyTotalConn=sslProxyTotalConn, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrPort=sslSrvrPort, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpProxyServerReq=httpProxyServerReq, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslSrvrTotRefused=sslSrvrTotRefused, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsCacheStatsEntry=bwsCacheStatsEntry, sslProxyCacheHits=sslProxyCacheHits, serviceName=serviceName, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, webCmprProtocol=webCmprProtocol, httpSrvrAddress=httpSrvrAddress, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrState=sslSrvrState, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpProxyAddress=httpProxyAddress, ipsReqSrvcAddress=ipsReqSrvcAddress, totalServers=totalServers, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsReqSrvcPort=ipsReqSrvcPort, peerUp=peerUp, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrNumFreeConn=sslSrvrNumFreeConn, webCmprAddressType=webCmprAddressType, smAgentName=smAgentName, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, systemLoad=systemLoad, bwsStatsGroup=bwsStatsGroup, httpSrvrAddressType=httpSrvrAddressType, webCmprAddress=webCmprAddress, httpProxyServerErr=httpProxyServerErr, httpSrvrPort=httpSrvrPort, webCacheCacheableRes=webCacheCacheableRes, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslSrvrTotReqRejected=sslSrvrTotReqRejected, dataPortLinkDown=dataPortLinkDown, totalMem=totalMem, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, totalApplications=totalApplications, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslSrvrNumConn=sslSrvrNumConn, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrMinResTime=sslSrvrMinResTime, bwsTrapGroup=bwsTrapGroup, ipsHdrAclHits=ipsHdrAclHits, logStorageHigh=logStorageHigh, ipsRCAddressType=ipsRCAddressType, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, energizeUpdateExpire=energizeUpdateExpire, sslSrvrTotSuccess=sslSrvrTotSuccess, sslProxyTotalReq=sslProxyTotalReq, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsRCTimeStamp=ipsRCTimeStamp, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsHdrAclAddressType=ipsHdrAclAddressType, switchingToMaintMode=switchingToMaintMode, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, cpuTemperature=cpuTemperature, securityDefUpdates=securityDefUpdates, ipsCookieSecTampered=ipsCookieSecTampered, serviceStatus=serviceStatus, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, webCacheAddressType=webCacheAddressType, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, logStorage=logStorage, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslProxyActiveConn=sslProxyActiveConn, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsCacheStatsTable=bwsCacheStatsTable, webCacheHits=webCacheHits, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsUrlAclAddress=ipsUrlAclAddress, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, tempHigh=tempHigh, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, uptime=uptime, dataPathStatus=dataPathStatus, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpProxyTotalConn=httpProxyTotalConn, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable)
mibBuilder.exportSymbols("BWS-MIB", ipsRCTotServed=ipsRCTotServed, ipsAccessCtrlPort=ipsAccessCtrlPort, sslProxyErrPms=sslProxyErrPms, webCacheLongHdrs=webCacheLongHdrs, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, systemFailOver=systemFailOver, virusDefUpdates=virusDefUpdates, webCacheCachedObjects=webCacheCachedObjects, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsUrlAclReserved=ipsUrlAclReserved, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, webCachePort=webCachePort, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrAddressType=sslSrvrAddressType, vipStatus=vipStatus, httpSrvrNumConn=httpSrvrNumConn, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrAvgResTime=sslSrvrAvgResTime, sslProxyCurrentConn=sslProxyCurrentConn, activeServers=activeServers, bws=bws, ipsAccessCtrlAddress=ipsAccessCtrlAddress, srvcName=srvcName, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, firmwareStorage=firmwareStorage, sslProxyFullHandshakes=sslProxyFullHandshakes, peerDown=peerDown, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, PYSNMP_MODULE_ID=bws, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsRCTotQueued=ipsRCTotQueued, sslProxyBadCRLErr=sslProxyBadCRLErr, webCacheStale=webCacheStale, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrOutBytes=sslSrvrOutBytes, webCacheBytesOut=webCacheBytesOut, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, smNumUserSessions=smNumUserSessions, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslProxyAddress=sslProxyAddress, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, webCacheReq=webCacheReq, processCountHigh=processCountHigh, bwsMIBGroups=bwsMIBGroups, ipsLrnSrvcPort=ipsLrnSrvcPort, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsSMUserSessionEntry=bwsSMUserSessionEntry, smRealmName=smRealmName, webCacheMiss=webCacheMiss, currentFirmwareVersion=currentFirmwareVersion, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans)
