...
ModuleIdentity, Counter64, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, IpAddress, Bits, Integer32, NotificationType, Counter32, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "IpAddress", "Bits", "Integer32", "NotificationType", "Counter32", "iso", "Gauge32")
...
mibBuilder.exportSymbols("BWS-MIB", ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsMIBGroups=bwsMIBGroups, webCmprCompressedDataSize=webCmprCompressedDataSize, httpProxyClientAbrt=httpProxyClientAbrt, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsRCTotDropped=ipsRCTotDropped, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrAddressType=sslSrvrAddressType, webCmprAddressType=webCmprAddressType, webCacheAddress=webCacheAddress, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpSrvrTotTimedout=httpSrvrTotTimedout, sslProxyInBytes=sslProxyInBytes, ipsHdrAclHits=ipsHdrAclHits, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpProxyWAFWarnings=httpProxyWAFWarnings, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsMessage=bwsMessage, sslProxyTotalReq=sslProxyTotalReq, activeApplications=activeApplications, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsTrapGroup=bwsTrapGroup, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsLrnSrvcAddress=ipsLrnSrvcAddress, smAgentName=smAgentName, ipsCookieSecTampered=ipsCookieSecTampered, sslProxyAddressType=sslProxyAddressType, httpProxyAddressType=httpProxyAddressType, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsMIBCompliance=bwsMIBCompliance, webCacheMiss=webCacheMiss, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsMIBCompliances=bwsMIBCompliances, serverDown=serverDown, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslProxyTotalConn=sslProxyTotalConn, sslSrvrNumConn=sslSrvrNumConn, sslSrvrTotTimedout=sslSrvrTotTimedout, serviceStatus=serviceStatus, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, highAvailabilityStatus=highAvailabilityStatus, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslProxyErrPms=sslProxyErrPms, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, webCmprPort=webCmprPort, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, processCountHigh=processCountHigh, ipsRCTotServed=ipsRCTotServed, firmwareStorageHigh=firmwareStorageHigh, currentFirmwareVersion=currentFirmwareVersion, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsRCTimeStamp=ipsRCTimeStamp, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsStatsGroup=bwsStatsGroup, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, switchingToBypassMode=switchingToBypassMode, serverUp=serverUp, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, firmwareStorage=firmwareStorage, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, peerUp=peerUp, cpuUtilization=cpuUtilization, webCachePort=webCachePort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslProxyOutBytes=sslProxyOutBytes, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsCookieSecPort=ipsCookieSecPort, sslSrvrState=sslSrvrState, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, totalBandwidth=totalBandwidth, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpProxyInBytes=httpProxyInBytes, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, webCacheAddressType=webCacheAddressType, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsUrlAclPort=ipsUrlAclPort, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrNumFreeConn=httpSrvrNumFreeConn, systemSerialNumber=systemSerialNumber, sslSrvrMaxResTime=sslSrvrMaxResTime, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpProxyParseErr=httpProxyParseErr, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, totalServers=totalServers, memUtilization=memUtilization, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsUrlNormAddressType=ipsUrlNormAddressType, logStorageHigh=logStorageHigh, totalMem=totalMem, cpuFanSpeed=cpuFanSpeed, sslSrvrAddress=sslSrvrAddress, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpProxyPort=httpProxyPort, bwsCompressionStatsTable=bwsCompressionStatsTable, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, webCmprAddress=webCmprAddress, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpSrvrNumConn=httpSrvrNumConn, webCacheCacheableRes=webCacheCacheableRes, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bws=bws, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsUrlAclAddressType=ipsUrlAclAddressType, sslProxyAddress=sslProxyAddress, sslProxyBadDNCErr=sslProxyBadDNCErr, webCmprProtocol=webCmprProtocol, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsServiceStatusTable=bwsServiceStatusTable, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsUrlNormPort=ipsUrlNormPort, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwstraps=bwstraps, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrPort=httpSrvrPort, webCacheLongHdrs=webCacheLongHdrs, sslSrvrTotReqRejected=sslSrvrTotReqRejected, smRealmName=smRealmName, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpSrvrTotReqRejected=httpSrvrTotReqRejected, linkStatus=linkStatus, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsRCTotQueued=ipsRCTotQueued, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsRCAddress=ipsRCAddress, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, activeServers=activeServers, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrTotReqActive=httpSrvrTotReqActive, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, totalApplications=totalApplications, sslSrvrSrvcAddress=sslSrvrSrvcAddress, serviceName=serviceName, ipsReqLimitAddress=ipsReqLimitAddress, httpSrvrTotResponse=httpSrvrTotResponse, cpuTemperature=cpuTemperature, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, peerDown=peerDown, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslProxyCacheMiss=sslProxyCacheMiss, ipsUrlAclReserved=ipsUrlAclReserved, tempCritical=tempCritical, httpProxyTotalConn=httpProxyTotalConn, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, webCacheHits=webCacheHits, systemFanSpeed=systemFanSpeed, httpProxyAddress=httpProxyAddress, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslSrvrOutBytes=sslSrvrOutBytes, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, serviceAddress=serviceAddress, totalAttacks=totalAttacks, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, systemFailure=systemFailure, sslProxyCurrentConn=sslProxyCurrentConn, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpProxyOutBytes=httpProxyOutBytes, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, webCacheCachedObjects=webCacheCachedObjects, sslProxyPort=sslProxyPort, sslSrvrAvgResTime=sslSrvrAvgResTime, uptime=uptime, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpSrvrTotRefused=httpSrvrTotRefused, sslSrvrTotResponse=sslSrvrTotResponse, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrState=httpSrvrState, ipsUrlPolicyAddress=ipsUrlPolicyAddress, virusDefUpdates=virusDefUpdates, switchingToInlineMode=switchingToInlineMode, energizeUpdateExpire=energizeUpdateExpire, ipsUrlAclAddress=ipsUrlAclAddress, sslSrvrInBytes=sslSrvrInBytes, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsHdrAclPort=ipsHdrAclPort, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsReqSrvcAddress=ipsReqSrvcAddress, httpProxyActiveConn=httpProxyActiveConn, tempHigh=tempHigh, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, fanDead=fanDead, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpProxyServerReq=httpProxyServerReq, ipsReqSrvcPort=ipsReqSrvcPort, switchingToMaintMode=switchingToMaintMode, sslSrvrMinResTime=sslSrvrMinResTime, httpProxyTotalReq=httpProxyTotalReq, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, dataPortLinkDown=dataPortLinkDown, sharedSecretKeyExpired=sharedSecretKeyExpired, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, freeMem=freeMem, bwsServiceStatusEntry=bwsServiceStatusEntry, dataPathStatus=dataPathStatus, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsStats=bwsStats, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie)
mibBuilder.exportSymbols("BWS-MIB", raidDegrading=raidDegrading, ipsAccessCtrlPort=ipsAccessCtrlPort, securityDefUpdates=securityDefUpdates, firmwareUpdateAvailable=firmwareUpdateAvailable, webCacheProtocol=webCacheProtocol, vipStatus=vipStatus, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsHdrAclAddress=ipsHdrAclAddress, webCacheStale=webCacheStale, httpSrvrOutBytes=httpSrvrOutBytes, sslProxyCacheTimeouts=sslProxyCacheTimeouts, systemFailOver=systemFailOver, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslProxyCacheHits=sslProxyCacheHits, ipsRCAddressType=ipsRCAddressType, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsCookieSecAddress=ipsCookieSecAddress, logStorage=logStorage, smNumUserSessions=smNumUserSessions, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsReqLimitPort=ipsReqLimitPort, sslSrvrPort=sslSrvrPort, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlNormAddress=ipsUrlNormAddress, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpSrvrAddressType=httpSrvrAddressType, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, dataPortLinkUp=dataPortLinkUp, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpSrvrInBytes=httpSrvrInBytes, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslProxyActiveConn=sslProxyActiveConn, webCacheBytesOut=webCacheBytesOut, httpSrvrTotSuccess=httpSrvrTotSuccess, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, srvcName=srvcName, systemLoad=systemLoad, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslSrvrSrvcPort=sslSrvrSrvcPort, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, servicePort=servicePort, httpSrvrMinResTime=httpSrvrMinResTime, httpSrvrAddress=httpSrvrAddress, bwsMIBConformance=bwsMIBConformance, httpProxyServerAbrt=httpProxyServerAbrt, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, memoryUsageHigh=memoryUsageHigh, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsRCPort=ipsRCPort, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, operationalMode=operationalMode, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, PYSNMP_MODULE_ID=bws, httpProxyServerErr=httpProxyServerErr, webCacheReq=webCacheReq, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsCacheStatsTable=bwsCacheStatsTable, httpProxySessionTimeOut=httpProxySessionTimeOut, sslSrvrTotRefused=sslSrvrTotRefused)
