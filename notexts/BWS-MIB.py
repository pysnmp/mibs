...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, Bits, Integer32, iso, NotificationType, Unsigned32, TimeTicks, MibIdentifier, Counter32, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "Bits", "Integer32", "iso", "NotificationType", "Unsigned32", "TimeTicks", "MibIdentifier", "Counter32", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, serviceName=serviceName, virusDefUpdates=virusDefUpdates, webCacheLongHdrs=webCacheLongHdrs, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpProxyTotalConn=httpProxyTotalConn, systemFailOver=systemFailOver, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpSrvrAddressType=httpSrvrAddressType, sslSrvrMinResTime=sslSrvrMinResTime, webCacheMiss=webCacheMiss, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslProxyErrPms=sslProxyErrPms, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsUrlNormAddressType=ipsUrlNormAddressType, httpProxyServerErr=httpProxyServerErr, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsTrapGroup=bwsTrapGroup, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpProxySessionTimeOut=httpProxySessionTimeOut, sslSrvrNumConn=sslSrvrNumConn, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsRCTotServed=ipsRCTotServed, sslProxyBadDNCErr=sslProxyBadDNCErr, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, smRealmName=smRealmName, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, logStorage=logStorage, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsMIBCompliances=bwsMIBCompliances, sslSrvrTotTimedout=sslSrvrTotTimedout, bwsSMUserSessionEntry=bwsSMUserSessionEntry, serviceStatus=serviceStatus, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslProxyAddressType=sslProxyAddressType, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, webCmprAddress=webCmprAddress, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, webCmprProtocol=webCmprProtocol, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsCacheStatsEntry=bwsCacheStatsEntry, sslProxyInBytes=sslProxyInBytes, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrNumFreeConn=sslSrvrNumFreeConn, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrAddress=httpSrvrAddress, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, uptime=uptime, ipsRCPort=ipsRCPort, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsStatsGroup=bwsStatsGroup, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpSrvrPort=httpSrvrPort, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsUrlNormAddress=ipsUrlNormAddress, webCmprPort=webCmprPort, bwsCacheStatsTable=bwsCacheStatsTable, ipsAccessCtrlAddress=ipsAccessCtrlAddress, peerUp=peerUp, ipsUrlAclPort=ipsUrlAclPort, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, dataPortLinkDown=dataPortLinkDown, serverUp=serverUp, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, cpuUtilization=cpuUtilization, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bws=bws, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, tempCritical=tempCritical, webCachePort=webCachePort, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpProxyActiveConn=httpProxyActiveConn, ipsLrnSrvcPort=ipsLrnSrvcPort, memUtilization=memUtilization, httpSrvrTotRefused=httpSrvrTotRefused, firmwareStorage=firmwareStorage, sslProxyCacheHits=sslProxyCacheHits, ipsCookieSecAddress=ipsCookieSecAddress, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, webCacheStale=webCacheStale, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslSrvrTotReqActive=sslSrvrTotReqActive, raidDegrading=raidDegrading, totalMem=totalMem, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsHdrAclHits=ipsHdrAclHits, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsReqLimitPort=ipsReqLimitPort, httpProxyOutBytes=httpProxyOutBytes, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsRCTimeStamp=ipsRCTimeStamp, httpSrvrSrvcPort=httpSrvrSrvcPort, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrPort=sslSrvrPort, ipsHdrAclAddress=ipsHdrAclAddress, ipsRCAddressType=ipsRCAddressType, sslSrvrAddressType=sslSrvrAddressType, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, switchingToBypassMode=switchingToBypassMode, sslProxyOutBytes=sslProxyOutBytes, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpProxyPort=httpProxyPort, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslSrvrAvgResTime=sslSrvrAvgResTime, sslProxyActiveConn=sslProxyActiveConn, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsHdrAclPort=ipsHdrAclPort, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, activeServers=activeServers, highAvailabilityStatus=highAvailabilityStatus, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsRCTotQueued=ipsRCTotQueued, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, totalBandwidth=totalBandwidth, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwstraps=bwstraps, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpProxyClientAbrt=httpProxyClientAbrt, ipsCookieSecTampered=ipsCookieSecTampered, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslProxyCacheTimeouts=sslProxyCacheTimeouts, webCacheProtocol=webCacheProtocol, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, securityDefUpdates=securityDefUpdates, webCacheBytesOut=webCacheBytesOut, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsHdrAclAddressType=ipsHdrAclAddressType, totalServers=totalServers, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsStats=bwsStats, sslProxyCacheMiss=sslProxyCacheMiss, webCacheCacheableRes=webCacheCacheableRes, ipsReqSrvcAddress=ipsReqSrvcAddress, totalApplications=totalApplications, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, operationalMode=operationalMode, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslProxyAddress=sslProxyAddress, httpSrvrOutBytes=httpSrvrOutBytes, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, srvcName=srvcName, processCountHigh=processCountHigh, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsWebAddrTransPort=ipsWebAddrTransPort, httpSrvrTotTimedout=httpSrvrTotTimedout, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, servicePort=servicePort, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, smNumUserSessions=smNumUserSessions, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslProxyCurrentConn=sslProxyCurrentConn, ipsUrlNormPort=ipsUrlNormPort, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, fanDead=fanDead, tempHigh=tempHigh, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, webCacheReq=webCacheReq, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, systemSerialNumber=systemSerialNumber, sslSrvrAddress=sslSrvrAddress, bwsServiceStatusTable=bwsServiceStatusTable, dataPathStatus=dataPathStatus, totalAttacks=totalAttacks, sslProxyTotalConn=sslProxyTotalConn, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsCookieSecPort=ipsCookieSecPort, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, webCmprAddressType=webCmprAddressType, cpuTemperature=cpuTemperature, serverDown=serverDown, webCacheAddress=webCacheAddress, switchingToInlineMode=switchingToInlineMode, vipStatus=vipStatus, httpProxyServerReq=httpProxyServerReq, httpProxyAddress=httpProxyAddress, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrState=sslSrvrState, peerDown=peerDown, PYSNMP_MODULE_ID=bws, httpSrvrMinResTime=httpSrvrMinResTime, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, smAgentName=smAgentName, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpProxyInBytes=httpProxyInBytes, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, webCacheHits=webCacheHits, ipsRCAddress=ipsRCAddress, httpSrvrTotReqActive=httpSrvrTotReqActive, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpSrvrNumConn=httpSrvrNumConn, httpSrvrState=httpSrvrState, activeApplications=activeApplications, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, serviceAddress=serviceAddress, bwsMIBGroups=bwsMIBGroups, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsMessage=bwsMessage)
mibBuilder.exportSymbols("BWS-MIB", webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, systemFanSpeed=systemFanSpeed, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsUrlAclAddressType=ipsUrlAclAddressType, firmwareStorageHigh=firmwareStorageHigh, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslProxyPort=sslProxyPort, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, cpuFanSpeed=cpuFanSpeed, ipsReqLimitAddress=ipsReqLimitAddress, freeMem=freeMem, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrTotResponse=sslSrvrTotResponse, logStorageHigh=logStorageHigh, ipsUrlAclAddress=ipsUrlAclAddress, sslProxyTotalReq=sslProxyTotalReq, webCacheCachedObjects=webCacheCachedObjects, bwsMIBConformance=bwsMIBConformance, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsMIBCompliance=bwsMIBCompliance, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpSrvrTotResponse=httpSrvrTotResponse, linkStatus=linkStatus, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrInBytes=sslSrvrInBytes, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslProxyFullHandshakes=sslProxyFullHandshakes, memoryUsageHigh=memoryUsageHigh, httpSrvrInBytes=httpSrvrInBytes, httpProxyUnknownRsp=httpProxyUnknownRsp, sslSrvrTotRefused=sslSrvrTotRefused, dataPortLinkUp=dataPortLinkUp, switchingToMaintMode=switchingToMaintMode, ipsUrlAclReserved=ipsUrlAclReserved, ipsReqSrvcPort=ipsReqSrvcPort, httpSrvrMaxResTime=httpSrvrMaxResTime, energizeUpdateExpire=energizeUpdateExpire, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, systemLoad=systemLoad, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, systemFailure=systemFailure, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsUrlPolicyPort=ipsUrlPolicyPort, webCacheAddressType=webCacheAddressType, httpProxyServerAbrt=httpProxyServerAbrt, httpProxyTotalReq=httpProxyTotalReq, sslSrvrOutBytes=sslSrvrOutBytes, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, currentFirmwareVersion=currentFirmwareVersion, httpProxyAddressType=httpProxyAddressType, httpProxyWAFWarnings=httpProxyWAFWarnings, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsRCTotDropped=ipsRCTotDropped, httpProxyParseErr=httpProxyParseErr, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped)
