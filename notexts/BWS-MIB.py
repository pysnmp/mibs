...
NotificationType, Counter64, Unsigned32, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, MibIdentifier, Counter32, Gauge32, TimeTicks, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "Unsigned32", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "MibIdentifier", "Counter32", "Gauge32", "TimeTicks", "iso", "ObjectIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpSrvrNumFreeConn=httpSrvrNumFreeConn, logStorageHigh=logStorageHigh, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, systemFailOver=systemFailOver, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrOutBytes=httpSrvrOutBytes, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsHdrAclPort=ipsHdrAclPort, activeApplications=activeApplications, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, webCmprAddressType=webCmprAddressType, httpSrvrTotRefused=httpSrvrTotRefused, webCacheMiss=webCacheMiss, httpSrvrAvgResTime=httpSrvrAvgResTime, httpProxyServerErr=httpProxyServerErr, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, currentFirmwareVersion=currentFirmwareVersion, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsSslProxyStatsTable=bwsSslProxyStatsTable, webCachePort=webCachePort, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsRCAddressType=ipsRCAddressType, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, vipStatus=vipStatus, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, switchingToInlineMode=switchingToInlineMode, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, webCmprCompressedDataSize=webCmprCompressedDataSize, systemLoad=systemLoad, ipsRCTotQueued=ipsRCTotQueued, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, webCacheAddress=webCacheAddress, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsRCTotDropped=ipsRCTotDropped, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsUrlNormPort=ipsUrlNormPort, ipsHdrAclHits=ipsHdrAclHits, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsIpsRCStatsTable=bwsIpsRCStatsTable, dataPathStatus=dataPathStatus, httpProxyOutBytes=httpProxyOutBytes, sslProxyPort=sslProxyPort, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwstraps=bwstraps, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, PYSNMP_MODULE_ID=bws, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsMIBCompliance=bwsMIBCompliance, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpSrvrTotSuccess=httpSrvrTotSuccess, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpSrvrAddressType=httpSrvrAddressType, systemSerialNumber=systemSerialNumber, bwsStats=bwsStats, uptime=uptime, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslSrvrAddressType=sslSrvrAddressType, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, raidDegrading=raidDegrading, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslProxyActiveConn=sslProxyActiveConn, httpProxyPort=httpProxyPort, cpuFanSpeed=cpuFanSpeed, httpSrvrSrvcPort=httpSrvrSrvcPort, energizeUpdateExpire=energizeUpdateExpire, cpuUtilization=cpuUtilization, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsMIBGroups=bwsMIBGroups, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslProxyErrPms=sslProxyErrPms, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrTotTimedout=sslSrvrTotTimedout, serviceStatus=serviceStatus, systemFailure=systemFailure, ipsCookieSecPort=ipsCookieSecPort, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsCookieSecAddress=ipsCookieSecAddress, webCacheAddressType=webCacheAddressType, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, webCacheLongHdrs=webCacheLongHdrs, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, firmwareStorage=firmwareStorage, ipsCookieSecAddressType=ipsCookieSecAddressType, cpuTemperature=cpuTemperature, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslSrvrTotResponse=sslSrvrTotResponse, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, tempHigh=tempHigh, bwsMessage=bwsMessage, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, memoryUsageHigh=memoryUsageHigh, highAvailabilityStatus=highAvailabilityStatus, webCmprPort=webCmprPort, sslSrvrNumConn=sslSrvrNumConn, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, peerUp=peerUp, httpProxyServerAbrt=httpProxyServerAbrt, httpProxyServerReq=httpProxyServerReq, ipsCookieSecTampered=ipsCookieSecTampered, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsServiceStatusEntry=bwsServiceStatusEntry, totalServers=totalServers, httpProxyClientAbrt=httpProxyClientAbrt, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, securityDefUpdates=securityDefUpdates, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrInBytes=sslSrvrInBytes, systemFanSpeed=systemFanSpeed, sslProxyCurrentConn=sslProxyCurrentConn, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsReqLimitPort=ipsReqLimitPort, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsServiceStatusTable=bwsServiceStatusTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, logStorage=logStorage, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, smNumUserSessions=smNumUserSessions, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrTotReqActive=sslSrvrTotReqActive, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrPort=httpSrvrPort, dataPortLinkUp=dataPortLinkUp, sslSrvrTotReqRejected=sslSrvrTotReqRejected, linkStatus=linkStatus, httpProxyAddress=httpProxyAddress, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsReqLimitAddress=ipsReqLimitAddress, bwsTrapGroup=bwsTrapGroup, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, totalBandwidth=totalBandwidth, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, webCacheHits=webCacheHits, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpProxyUnknownRsp=httpProxyUnknownRsp, freeMem=freeMem, httpProxyTotalConn=httpProxyTotalConn, httpSrvrMinResTime=httpSrvrMinResTime, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, switchingToMaintMode=switchingToMaintMode, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslProxyAddress=sslProxyAddress, activeServers=activeServers, ipsUrlAclAddress=ipsUrlAclAddress, httpProxyTotalReq=httpProxyTotalReq, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsHdrAclAddress=ipsHdrAclAddress, sslProxyTotalReq=sslProxyTotalReq, memUtilization=memUtilization, sslSrvrMinResTime=sslSrvrMinResTime, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsRCTimeStamp=ipsRCTimeStamp, ipsAccessCtrlPort=ipsAccessCtrlPort, httpSrvrAddress=httpSrvrAddress, sslSrvrAvgResTime=sslSrvrAvgResTime, sslSrvrOutBytes=sslSrvrOutBytes, ipsUrlAclReserved=ipsUrlAclReserved, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslProxyInBytes=sslProxyInBytes, bws=bws, dataPortLinkDown=dataPortLinkDown, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsReqSrvcPort=ipsReqSrvcPort, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpProxyAddressType=httpProxyAddressType, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, smRealmName=smRealmName, totalApplications=totalApplications, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslProxyCacheTimeouts=sslProxyCacheTimeouts, webCacheBytesOut=webCacheBytesOut, serverUp=serverUp, servicePort=servicePort, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlAclAddressType=ipsUrlAclAddressType, sslSrvrTotRefused=sslSrvrTotRefused, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsCacheStatsTable=bwsCacheStatsTable, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, firmwareUpdateAvailable=firmwareUpdateAvailable, sslSrvrSrvcPort=sslSrvrSrvcPort, webCacheProtocol=webCacheProtocol, virusDefUpdates=virusDefUpdates, webCacheReq=webCacheReq, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslProxyCacheMiss=sslProxyCacheMiss, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, fanDead=fanDead, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, webCmprAddress=webCmprAddress)
mibBuilder.exportSymbols("BWS-MIB", serviceAddress=serviceAddress, ipsRCAddress=ipsRCAddress, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslProxyBadCRLErr=sslProxyBadCRLErr, operationalMode=operationalMode, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslProxyTotalConn=sslProxyTotalConn, sslProxyAddressType=sslProxyAddressType, bwsMIBConformance=bwsMIBConformance, sslSrvrAddress=sslSrvrAddress, sslSrvrState=sslSrvrState, ipsUrlAclPort=ipsUrlAclPort, webCacheStale=webCacheStale, httpSrvrTotResponse=httpSrvrTotResponse, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpProxyInBytes=httpProxyInBytes, httpProxyActiveConn=httpProxyActiveConn, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpSrvrNumConn=httpSrvrNumConn, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, webCacheCachedObjects=webCacheCachedObjects, webCmprProtocol=webCmprProtocol, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsRCTotServed=ipsRCTotServed, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, totalMem=totalMem, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsRCPort=ipsRCPort, serviceName=serviceName, totalAttacks=totalAttacks, sslProxyCacheHits=sslProxyCacheHits, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, serverDown=serverDown, httpProxyParseErr=httpProxyParseErr, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, firmwareStorageHigh=firmwareStorageHigh, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrPort=sslSrvrPort, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpSrvrState=httpSrvrState, bwsMIBCompliances=bwsMIBCompliances, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, processCountHigh=processCountHigh, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrInBytes=httpSrvrInBytes, srvcName=srvcName, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, tempCritical=tempCritical, ipsWebAddrTransPort=ipsWebAddrTransPort, switchingToBypassMode=switchingToBypassMode, smAgentName=smAgentName, sslProxyOutBytes=sslProxyOutBytes, peerDown=peerDown, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsStatsGroup=bwsStatsGroup, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, webCacheCacheableRes=webCacheCacheableRes)
