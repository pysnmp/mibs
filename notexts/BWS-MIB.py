...
iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, Unsigned32, Counter64, MibIdentifier, Counter32, IpAddress, Gauge32, NotificationType, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "Unsigned32", "Counter64", "MibIdentifier", "Counter32", "IpAddress", "Gauge32", "NotificationType", "Integer32", "ObjectIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, totalMem=totalMem, webCacheAddress=webCacheAddress, serverUp=serverUp, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpProxyClientAbrt=httpProxyClientAbrt, smRealmName=smRealmName, cpuUtilization=cpuUtilization, webCacheProtocol=webCacheProtocol, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrAddress=sslSrvrAddress, bwsServiceStatusTable=bwsServiceStatusTable, memUtilization=memUtilization, ipsUrlNormAddress=ipsUrlNormAddress, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, srvcName=srvcName, webCacheReq=webCacheReq, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, peerDown=peerDown, processCountHigh=processCountHigh, sslProxyOutBytes=sslProxyOutBytes, ipsUrlAclPort=ipsUrlAclPort, webCachePort=webCachePort, ipsRCTotServed=ipsRCTotServed, sslProxyBadDNCErr=sslProxyBadDNCErr, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsTrapGroup=bwsTrapGroup, webCacheAddressType=webCacheAddressType, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, webCacheStale=webCacheStale, freeMem=freeMem, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpSrvrMinResTime=httpSrvrMinResTime, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, webCacheMiss=webCacheMiss, switchingToInlineMode=switchingToInlineMode, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsUrlNormPort=ipsUrlNormPort, firmwareStorage=firmwareStorage, httpProxyAddress=httpProxyAddress, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrInBytes=httpSrvrInBytes, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, totalApplications=totalApplications, webCmprPort=webCmprPort, ipsHdrAclAddress=ipsHdrAclAddress, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslProxyActiveConn=sslProxyActiveConn, systemLoad=systemLoad, sslProxyPort=sslProxyPort, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsRCTimeStamp=ipsRCTimeStamp, httpProxyPort=httpProxyPort, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsMIBConformance=bwsMIBConformance, energizeUpdateExpire=energizeUpdateExpire, ipsHdrAclPort=ipsHdrAclPort, totalServers=totalServers, serviceAddress=serviceAddress, virusDefUpdates=virusDefUpdates, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, switchingToBypassMode=switchingToBypassMode, logStorage=logStorage, sslSrvrAvgResTime=sslSrvrAvgResTime, systemFailOver=systemFailOver, ipsHdrAclHits=ipsHdrAclHits, firmwareStorageHigh=firmwareStorageHigh, httpSrvrState=httpSrvrState, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslSrvrNumFreeConn=sslSrvrNumFreeConn, activeServers=activeServers, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsMIBCompliances=bwsMIBCompliances, ipsUrlPolicyPort=ipsUrlPolicyPort, serviceStatus=serviceStatus, httpProxySessionTimeOut=httpProxySessionTimeOut, systemSerialNumber=systemSerialNumber, sslSrvrPort=sslSrvrPort, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsRCAddress=ipsRCAddress, PYSNMP_MODULE_ID=bws, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, webCmprProtocol=webCmprProtocol, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsMIBGroups=bwsMIBGroups, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, systemFanSpeed=systemFanSpeed, ipsRCAddressType=ipsRCAddressType, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, totalBandwidth=totalBandwidth, httpSrvrOutBytes=httpSrvrOutBytes, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslSrvrTotReqActive=sslSrvrTotReqActive, webCacheHits=webCacheHits, servicePort=servicePort, httpSrvrTotReqActive=httpSrvrTotReqActive, sslProxyErrPms=sslProxyErrPms, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslProxyInBytes=sslProxyInBytes, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpProxyActiveConn=httpProxyActiveConn, sslSrvrNumConn=sslSrvrNumConn, httpProxyOutBytes=httpProxyOutBytes, ipsReqLimitPort=ipsReqLimitPort, httpSrvrTotResponse=httpSrvrTotResponse, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslSrvrMinResTime=sslSrvrMinResTime, sslProxyCacheHits=sslProxyCacheHits, bwsMessage=bwsMessage, linkStatus=linkStatus, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, activeApplications=activeApplications, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, smAgentName=smAgentName, dataPathStatus=dataPathStatus, dataPortLinkUp=dataPortLinkUp, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bws=bws, operationalMode=operationalMode, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsMIBCompliance=bwsMIBCompliance, httpSrvrSrvcPort=httpSrvrSrvcPort, sslProxyCacheMiss=sslProxyCacheMiss, webCacheCachedObjects=webCacheCachedObjects, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, webCacheCacheableRes=webCacheCacheableRes, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, cpuTemperature=cpuTemperature, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, uptime=uptime, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpSrvrNumConn=httpSrvrNumConn, httpProxyTotalConn=httpProxyTotalConn, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, peerUp=peerUp, httpProxyParseErr=httpProxyParseErr, highAvailabilityStatus=highAvailabilityStatus, cpuFanSpeed=cpuFanSpeed, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrTotRefused=httpSrvrTotRefused, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpProxyInBytes=httpProxyInBytes, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, switchingToMaintMode=switchingToMaintMode, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, fanDead=fanDead, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, memoryUsageHigh=memoryUsageHigh, bwsStats=bwsStats, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, tempHigh=tempHigh, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslSrvrTotSuccess=sslSrvrTotSuccess, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsUrlAclReserved=ipsUrlAclReserved, totalAttacks=totalAttacks, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, smNumUserSessions=smNumUserSessions, ipsAccessCtrlAddress=ipsAccessCtrlAddress, webCacheLongHdrs=webCacheLongHdrs, newAttackDefinitionInstalled=newAttackDefinitionInstalled, webCmprAddressType=webCmprAddressType, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, logStorageHigh=logStorageHigh, systemFailure=systemFailure, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslProxyTotalReq=sslProxyTotalReq, httpSrvrAddressType=httpSrvrAddressType, ipsReqLimitAddress=ipsReqLimitAddress, ipsReqSrvcPort=ipsReqSrvcPort, raidDegrading=raidDegrading, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrPort=httpSrvrPort, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsStatsGroup=bwsStatsGroup, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslSrvrOutBytes=sslSrvrOutBytes, sslProxyCurrentConn=sslProxyCurrentConn, webCmprAddress=webCmprAddress, sslProxyAddressType=sslProxyAddressType, httpSrvrAddress=httpSrvrAddress, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsCompressionStatsTable=bwsCompressionStatsTable, bwstraps=bwstraps, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrSrvcAddress=sslSrvrSrvcAddress)
mibBuilder.exportSymbols("BWS-MIB", sharedSecretKeyExpired=sharedSecretKeyExpired, serviceName=serviceName, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpProxyServerErr=httpProxyServerErr, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslProxyTotalConn=sslProxyTotalConn, httpProxyServerAbrt=httpProxyServerAbrt, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, currentFirmwareVersion=currentFirmwareVersion, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsRCTotDropped=ipsRCTotDropped, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslProxyAddress=sslProxyAddress, httpSrvrAvgResTime=httpSrvrAvgResTime, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslSrvrAddressType=sslSrvrAddressType, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, webCacheBytesOut=webCacheBytesOut, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpProxyTotalReq=httpProxyTotalReq, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpProxyUnknownRsp=httpProxyUnknownRsp, tempCritical=tempCritical, dataPortLinkDown=dataPortLinkDown, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, serverDown=serverDown, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrMaxResTime=sslSrvrMaxResTime, httpProxyServerReq=httpProxyServerReq, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslSrvrTotRefused=sslSrvrTotRefused, sslSrvrState=sslSrvrState, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslSrvrTotResponse=sslSrvrTotResponse, vipStatus=vipStatus, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, securityDefUpdates=securityDefUpdates, httpProxyAddressType=httpProxyAddressType, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsCookieSecPort=ipsCookieSecPort, ipsRCPort=ipsRCPort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsRCTotQueued=ipsRCTotQueued, webCmprCompressedDataSize=webCmprCompressedDataSize, sslSrvrInBytes=sslSrvrInBytes, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled)
