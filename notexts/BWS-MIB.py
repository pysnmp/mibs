...
TimeTicks, Counter32, IpAddress, Bits, ObjectIdentity, Gauge32, Unsigned32, Counter64, NotificationType, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "IpAddress", "Bits", "ObjectIdentity", "Gauge32", "Unsigned32", "Counter64", "NotificationType", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", sslSrvrState=sslSrvrState, serviceAddress=serviceAddress, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsUrlAclReserved=ipsUrlAclReserved, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslProxyErrPms=sslProxyErrPms, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwstraps=bwstraps, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, serverUp=serverUp, highAvailabilityStatus=highAvailabilityStatus, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrTotResponse=httpSrvrTotResponse, sslProxyPort=sslProxyPort, bwsMIBConformance=bwsMIBConformance, smRealmName=smRealmName, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, freeMem=freeMem, cpuTemperature=cpuTemperature, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsHdrAclPort=ipsHdrAclPort, sslSrvrInBytes=sslSrvrInBytes, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpSrvrInBytes=httpSrvrInBytes, totalApplications=totalApplications, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrTotReqActive=httpSrvrTotReqActive, totalAttacks=totalAttacks, sslSrvrMaxResTime=sslSrvrMaxResTime, totalMem=totalMem, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, newAttackDefinitionInstalled=newAttackDefinitionInstalled, PYSNMP_MODULE_ID=bws, cpuUtilization=cpuUtilization, sslProxyInBytes=sslProxyInBytes, sslProxyActiveConn=sslProxyActiveConn, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsCookieSecTampered=ipsCookieSecTampered, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrAddressType=sslSrvrAddressType, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, dataPortLinkUp=dataPortLinkUp, logStorageHigh=logStorageHigh, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsCacheStatsEntry=bwsCacheStatsEntry, webCacheBytesOut=webCacheBytesOut, bwsCacheStatsTable=bwsCacheStatsTable, webCmprCompressedDataSize=webCmprCompressedDataSize, uptime=uptime, sslProxyAddress=sslProxyAddress, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsHdrAclHits=ipsHdrAclHits, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, serverDown=serverDown, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, systemFailure=systemFailure, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, fanDead=fanDead, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsStatsGroup=bwsStatsGroup, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrAddress=httpSrvrAddress, dataPathStatus=dataPathStatus, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, serviceStatus=serviceStatus, sharedSecretKeyExpired=sharedSecretKeyExpired, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrPort=sslSrvrPort, httpProxyTotalReq=httpProxyTotalReq, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslProxyOutBytes=sslProxyOutBytes, httpProxyAddress=httpProxyAddress, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrMaxResTime=httpSrvrMaxResTime, sslSrvrMinResTime=sslSrvrMinResTime, webCacheReq=webCacheReq, webCacheCachedObjects=webCacheCachedObjects, bwsServiceStatusEntry=bwsServiceStatusEntry, vipStatus=vipStatus, httpSrvrOutBytes=httpSrvrOutBytes, cpuFanSpeed=cpuFanSpeed, activeApplications=activeApplications, httpSrvrTotRefused=httpSrvrTotRefused, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpSrvrNumConn=httpSrvrNumConn, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, systemSerialNumber=systemSerialNumber, switchingToInlineMode=switchingToInlineMode, webCacheStale=webCacheStale, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, raidDegrading=raidDegrading, ipsRCAddress=ipsRCAddress, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpSrvrPort=httpSrvrPort, ipsReqLimitAddress=ipsReqLimitAddress, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, webCacheProtocol=webCacheProtocol, sslSrvrAddress=sslSrvrAddress, bwsMIBCompliances=bwsMIBCompliances, httpProxyServerReq=httpProxyServerReq, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsRCTotServed=ipsRCTotServed, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsCookieSecAddress=ipsCookieSecAddress, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpProxyClientAbrt=httpProxyClientAbrt, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpProxyUnknownRsp=httpProxyUnknownRsp, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, webCmprPort=webCmprPort, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsRCTotDropped=ipsRCTotDropped, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, tempCritical=tempCritical, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, processCountHigh=processCountHigh, ipsUrlNormAddress=ipsUrlNormAddress, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, securityDefUpdates=securityDefUpdates, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, webCacheMiss=webCacheMiss, ipsReqLimitPort=ipsReqLimitPort, dataPortLinkDown=dataPortLinkDown, ipsUrlPolicyPort=ipsUrlPolicyPort, tempHigh=tempHigh, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsTrapGroup=bwsTrapGroup, linkStatus=linkStatus, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsUrlPolicyAddress=ipsUrlPolicyAddress, energizeUpdateExpire=energizeUpdateExpire, httpProxyParseErr=httpProxyParseErr, activeServers=activeServers, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsMIBCompliance=bwsMIBCompliance, webCacheHits=webCacheHits, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsReqSrvcAddress=ipsReqSrvcAddress, httpSrvrSrvcPort=httpSrvrSrvcPort, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslSrvrTotRefused=sslSrvrTotRefused, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, logStorage=logStorage, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpProxyInBytes=httpProxyInBytes, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, peerDown=peerDown, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslProxyTotalReq=sslProxyTotalReq, memUtilization=memUtilization, sslProxyCurrentConn=sslProxyCurrentConn, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpProxyServerAbrt=httpProxyServerAbrt, ipsRCPort=ipsRCPort, ipsRCTotOutOfResource=ipsRCTotOutOfResource, systemFanSpeed=systemFanSpeed, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpSrvrState=httpSrvrState, webCacheCacheableRes=webCacheCacheableRes, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, webCmprAddressType=webCmprAddressType, switchingToMaintMode=switchingToMaintMode, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpProxyServerErr=httpProxyServerErr, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsUrlAclPort=ipsUrlAclPort, ipsUrlNormPort=ipsUrlNormPort, sslProxyTotalConn=sslProxyTotalConn, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, peerUp=peerUp, bwsMessage=bwsMessage, httpSrvrAddressType=httpSrvrAddressType, webCmprProtocol=webCmprProtocol, bwsServiceStatusTable=bwsServiceStatusTable, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpProxyWAFWarnings=httpProxyWAFWarnings, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslProxyCacheHits=sslProxyCacheHits, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsCookieSecPort=ipsCookieSecPort, ipsReqSrvcPort=ipsReqSrvcPort, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsUrlNormAddressType=ipsUrlNormAddressType, operationalMode=operationalMode, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsHdrAclAddress=ipsHdrAclAddress, ipsRCTimeStamp=ipsRCTimeStamp, httpSrvrMinResTime=httpSrvrMinResTime, systemLoad=systemLoad, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, totalBandwidth=totalBandwidth, totalServers=totalServers, httpProxyActiveConn=httpProxyActiveConn, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpProxyAddressType=httpProxyAddressType, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslProxyBadDNCErr=sslProxyBadDNCErr, firmwareStorage=firmwareStorage)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrTotReqRejected=httpSrvrTotReqRejected, memoryUsageHigh=memoryUsageHigh, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsSMUserSessionTable=bwsSMUserSessionTable, webCmprAddress=webCmprAddress, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsStats=bwsStats, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, webCacheAddress=webCacheAddress, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrTotResponse=sslSrvrTotResponse, bwsMIBGroups=bwsMIBGroups, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpProxySessionTimeOut=httpProxySessionTimeOut, serviceName=serviceName, smAgentName=smAgentName, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpProxyOutBytes=httpProxyOutBytes, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsLrnSrvcPort=ipsLrnSrvcPort, webCachePort=webCachePort, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsRCAddressType=ipsRCAddressType, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsAccessCtrlPort=ipsAccessCtrlPort, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, firmwareStorageHigh=firmwareStorageHigh, currentFirmwareVersion=currentFirmwareVersion, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslSrvrOutBytes=sslSrvrOutBytes, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, switchingToBypassMode=switchingToBypassMode, smNumUserSessions=smNumUserSessions, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, webCacheLongHdrs=webCacheLongHdrs, httpProxyPort=httpProxyPort, ipsUrlAclAddressType=ipsUrlAclAddressType, systemFailOver=systemFailOver, webCacheAddressType=webCacheAddressType, bwsCompressionStatsTable=bwsCompressionStatsTable, bws=bws, sslProxyAddressType=sslProxyAddressType, sslSrvrTotSuccess=sslSrvrTotSuccess, srvcName=srvcName, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, virusDefUpdates=virusDefUpdates, httpProxyTotalConn=httpProxyTotalConn, sslProxyCacheMiss=sslProxyCacheMiss, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsHdrAclAddressType=ipsHdrAclAddressType, sslProxyFullHandshakes=sslProxyFullHandshakes, servicePort=servicePort, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsRCTotQueued=ipsRCTotQueued, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslSrvrNumConn=sslSrvrNumConn)
