...
iso, Integer32, Counter64, ModuleIdentity, ObjectIdentity, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, Unsigned32, Bits, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "Counter64", "ModuleIdentity", "ObjectIdentity", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "Unsigned32", "Bits", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sharedSecretKeyExpired=sharedSecretKeyExpired, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, webCmprAddressType=webCmprAddressType, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsCookieSecPort=ipsCookieSecPort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, memUtilization=memUtilization, bwsMIBGroups=bwsMIBGroups, httpProxyClientAbrt=httpProxyClientAbrt, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, systemSerialNumber=systemSerialNumber, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsReqSrvcPort=ipsReqSrvcPort, ipsReqLimitPort=ipsReqLimitPort, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsMIBCompliance=bwsMIBCompliance, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsRCAddress=ipsRCAddress, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpSrvrMinResTime=httpSrvrMinResTime, ipsUrlAclPort=ipsUrlAclPort, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrPort=httpSrvrPort, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsWebAddrTransPort=ipsWebAddrTransPort, activeApplications=activeApplications, httpProxyParseErr=httpProxyParseErr, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsMIBCompliances=bwsMIBCompliances, httpProxyTotalConn=httpProxyTotalConn, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsMIBConformance=bwsMIBConformance, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, PYSNMP_MODULE_ID=bws, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, dataPortLinkDown=dataPortLinkDown, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsStatsGroup=bwsStatsGroup, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslProxyCacheMiss=sslProxyCacheMiss, webCmprProtocol=webCmprProtocol, bwsSslProxyStatsTable=bwsSslProxyStatsTable, uptime=uptime, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, highAvailabilityStatus=highAvailabilityStatus, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslSrvrMaxResTime=sslSrvrMaxResTime, currentFirmwareVersion=currentFirmwareVersion, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslSrvrInBytes=sslSrvrInBytes, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, operationalMode=operationalMode, sslSrvrOutBytes=sslSrvrOutBytes, sslSrvrTotReqRejected=sslSrvrTotReqRejected, logStorageHigh=logStorageHigh, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslSrvrTotResponse=sslSrvrTotResponse, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, webCacheCacheableRes=webCacheCacheableRes, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpSrvrTotRefused=httpSrvrTotRefused, sslSrvrAddress=sslSrvrAddress, httpSrvrTotTimedout=httpSrvrTotTimedout, webCacheBytesOut=webCacheBytesOut, sslSrvrTotRefused=sslSrvrTotRefused, sslProxyBadDNCErr=sslProxyBadDNCErr, httpSrvrMaxResTime=httpSrvrMaxResTime, webCmprPort=webCmprPort, dataPortLinkUp=dataPortLinkUp, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, webCacheReq=webCacheReq, sslProxyErrPms=sslProxyErrPms, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, freeMem=freeMem, serviceStatus=serviceStatus, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, energizeUpdateExpire=energizeUpdateExpire, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpProxyActiveConn=httpProxyActiveConn, servicePort=servicePort, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, dataPathStatus=dataPathStatus, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, serverUp=serverUp, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpProxyServerErr=httpProxyServerErr, ipsUrlNormAddressType=ipsUrlNormAddressType, webCmprCompressibleDataSize=webCmprCompressibleDataSize, cpuFanSpeed=cpuFanSpeed, virusDefUpdates=virusDefUpdates, serviceAddress=serviceAddress, processCountHigh=processCountHigh, firmwareStorage=firmwareStorage, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsCookieSecAddressType=ipsCookieSecAddressType, webCacheAddressType=webCacheAddressType, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpProxyWAFWarnings=httpProxyWAFWarnings, sslProxyTotalConn=sslProxyTotalConn, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsCookieSecTampered=ipsCookieSecTampered, sslSrvrAddressType=sslSrvrAddressType, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslProxyFullHandshakes=sslProxyFullHandshakes, linkStatus=linkStatus, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsSMUserSessionTable=bwsSMUserSessionTable, cpuTemperature=cpuTemperature, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, webCachePort=webCachePort, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsHdrAclAddressType=ipsHdrAclAddressType, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpSrvrAddress=httpSrvrAddress, sslProxyPort=sslProxyPort, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsHdrAclHits=ipsHdrAclHits, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, serverDown=serverDown, httpProxyAddress=httpProxyAddress, totalMem=totalMem, bwstraps=bwstraps, sslProxyAddressType=sslProxyAddressType, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrTotTimedout=sslSrvrTotTimedout, webCacheStale=webCacheStale, sslProxyCacheHits=sslProxyCacheHits, httpProxyServerReq=httpProxyServerReq, firmwareStorageHigh=firmwareStorageHigh, httpSrvrNumConn=httpSrvrNumConn, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsUrlAclReserved=ipsUrlAclReserved, sslProxyAddress=sslProxyAddress, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, switchingToMaintMode=switchingToMaintMode, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsReqLimitAddress=ipsReqLimitAddress, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsTrapGroup=bwsTrapGroup, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslProxyOutBytes=sslProxyOutBytes, ipsHdrAclPort=ipsHdrAclPort, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrTotReqActive=httpSrvrTotReqActive, cpuUtilization=cpuUtilization, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bws=bws, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, webCacheLongHdrs=webCacheLongHdrs, sslProxyTotalReq=sslProxyTotalReq, serviceName=serviceName, fanDead=fanDead, httpProxyAddressType=httpProxyAddressType, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, totalBandwidth=totalBandwidth, ipsUrlNormAddress=ipsUrlNormAddress, ipsHdrAclAddress=ipsHdrAclAddress, totalAttacks=totalAttacks, smAgentName=smAgentName, peerUp=peerUp, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsReqSrvcAddressType=ipsReqSrvcAddressType, webCacheHits=webCacheHits, sslProxyActiveConn=sslProxyActiveConn, sslProxyCurrentConn=sslProxyCurrentConn, ipsRCTotDropped=ipsRCTotDropped, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, memoryUsageHigh=memoryUsageHigh, systemFanSpeed=systemFanSpeed, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpSrvrTotResponse=httpSrvrTotResponse, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsCookieSecAddress=ipsCookieSecAddress, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrOutBytes=httpSrvrOutBytes, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsRCAddressType=ipsRCAddressType, sslSrvrTotReqActive=sslSrvrTotReqActive, httpProxyPort=httpProxyPort, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpProxyInBytes=httpProxyInBytes, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, totalServers=totalServers, switchingToBypassMode=switchingToBypassMode, httpSrvrState=httpSrvrState, tempHigh=tempHigh, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, webCacheMiss=webCacheMiss, ipsRCTotQueued=ipsRCTotQueued, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, raidDegrading=raidDegrading, httpProxyOutBytes=httpProxyOutBytes, activeServers=activeServers, webCacheProtocol=webCacheProtocol, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsMessage=bwsMessage)
mibBuilder.exportSymbols("BWS-MIB", ipsRCTimeStamp=ipsRCTimeStamp, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsUrlNormPort=ipsUrlNormPort, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslProxyInBytes=sslProxyInBytes, smNumUserSessions=smNumUserSessions, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrNumFreeConn=sslSrvrNumFreeConn, smRealmName=smRealmName, vipStatus=vipStatus, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslSrvrNumConn=sslSrvrNumConn, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsRCPort=ipsRCPort, httpProxyServerAbrt=httpProxyServerAbrt, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, peerDown=peerDown, webCacheCachedObjects=webCacheCachedObjects, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsUrlAclAddress=ipsUrlAclAddress, webCmprAddress=webCmprAddress, logStorage=logStorage, systemLoad=systemLoad, ipsRCTotServed=ipsRCTotServed, systemFailure=systemFailure, bwsCacheStatsTable=bwsCacheStatsTable, securityDefUpdates=securityDefUpdates, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, srvcName=srvcName, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpSrvrInBytes=httpSrvrInBytes, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, systemFailOver=systemFailOver, tempCritical=tempCritical, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrMinResTime=sslSrvrMinResTime, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, switchingToInlineMode=switchingToInlineMode, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpProxyTotalReq=httpProxyTotalReq, sslSrvrPort=sslSrvrPort, bwsStats=bwsStats, webCacheAddress=webCacheAddress, webCmprCompressedDataSize=webCmprCompressedDataSize, sslSrvrState=sslSrvrState, httpSrvrAddressType=httpSrvrAddressType, totalApplications=totalApplications)
