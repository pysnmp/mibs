...
Integer32, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, TimeTicks, ModuleIdentity, ObjectIdentity, IpAddress, Unsigned32, Gauge32, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "IpAddress", "Unsigned32", "Gauge32", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("BWS-MIB", httpProxyClientAbrt=httpProxyClientAbrt, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, serviceStatus=serviceStatus, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpSrvrTotTimedout=httpSrvrTotTimedout, systemFailure=systemFailure, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, systemLoad=systemLoad, ipsUrlAclAddressType=ipsUrlAclAddressType, peerUp=peerUp, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, switchingToMaintMode=switchingToMaintMode, httpProxyPort=httpProxyPort, sslSrvrPort=sslSrvrPort, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsTrapGroup=bwsTrapGroup, httpSrvrTotReqRejected=httpSrvrTotReqRejected, activeApplications=activeApplications, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpProxyUnknownRsp=httpProxyUnknownRsp, cpuFanSpeed=cpuFanSpeed, sslSrvrMinResTime=sslSrvrMinResTime, bwsMIBConformance=bwsMIBConformance, sslProxyTotalConn=sslProxyTotalConn, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsMIBGroups=bwsMIBGroups, httpSrvrSrvcAddress=httpSrvrSrvcAddress, servicePort=servicePort, raidDegrading=raidDegrading, webCacheAddressType=webCacheAddressType, httpProxyOutBytes=httpProxyOutBytes, httpSrvrNumConn=httpSrvrNumConn, ipsHdrAclAddressType=ipsHdrAclAddressType, webCacheBytesOut=webCacheBytesOut, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, serverUp=serverUp, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsStatsGroup=bwsStatsGroup, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwstraps=bwstraps, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, webCacheStale=webCacheStale, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsRCAddressType=ipsRCAddressType, tempCritical=tempCritical, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, uptime=uptime, ipsReqLimitPort=ipsReqLimitPort, ipsUrlNormPort=ipsUrlNormPort, sslSrvrMaxResTime=sslSrvrMaxResTime, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsUrlAclAddress=ipsUrlAclAddress, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, logStorageHigh=logStorageHigh, ipsCookieSecAddressType=ipsCookieSecAddressType, webCmprAddressType=webCmprAddressType, ipsRCAddress=ipsRCAddress, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslProxyErrPms=sslProxyErrPms, webCmprPort=webCmprPort, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsHdrAclPort=ipsHdrAclPort, httpSrvrTotRefused=httpSrvrTotRefused, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsMIBCompliance=bwsMIBCompliance, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, tempHigh=tempHigh, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, linkStatus=linkStatus, systemSerialNumber=systemSerialNumber, sslSrvrOutBytes=sslSrvrOutBytes, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrState=httpSrvrState, webCmprProtocol=webCmprProtocol, ipsHdrAclAddress=ipsHdrAclAddress, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpSrvrPort=httpSrvrPort, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslProxyAddress=sslProxyAddress, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, webCacheCachedObjects=webCacheCachedObjects, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrTotSuccess=httpSrvrTotSuccess, httpProxyAddress=httpProxyAddress, webCacheHits=webCacheHits, operationalMode=operationalMode, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsLrnSrvcAddress=ipsLrnSrvcAddress, peerDown=peerDown, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, srvcName=srvcName, systemFailOver=systemFailOver, securityDefUpdates=securityDefUpdates, activeServers=activeServers, httpProxyTotalConn=httpProxyTotalConn, sslProxyBadCRLErr=sslProxyBadCRLErr, httpProxyActiveConn=httpProxyActiveConn, newAttackDefinitionInstalled=newAttackDefinitionInstalled, fanDead=fanDead, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpProxyAddressType=httpProxyAddressType, ipsReqLimitAddressType=ipsReqLimitAddressType, memUtilization=memUtilization, currentFirmwareVersion=currentFirmwareVersion, sslSrvrSrvcPort=sslSrvrSrvcPort, httpSrvrInBytes=httpSrvrInBytes, smNumUserSessions=smNumUserSessions, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, cpuTemperature=cpuTemperature, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsRCTotServed=ipsRCTotServed, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, serverDown=serverDown, httpProxyServerReq=httpProxyServerReq, sslProxyCacheTimeouts=sslProxyCacheTimeouts, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpSrvrAddressType=httpSrvrAddressType, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, serviceName=serviceName, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpProxyParseErr=httpProxyParseErr, httpSrvrAddress=httpSrvrAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpProxySessionTimeOut=httpProxySessionTimeOut, httpProxyServerErr=httpProxyServerErr, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, webCacheProtocol=webCacheProtocol, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, totalApplications=totalApplications, ipsReqLimitAddress=ipsReqLimitAddress, sslSrvrTotTimedout=sslSrvrTotTimedout, vipStatus=vipStatus, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, smRealmName=smRealmName, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsRCPort=ipsRCPort, webCacheMiss=webCacheMiss, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsMessage=bwsMessage, sslProxyCurrentConn=sslProxyCurrentConn, ipsCookieSecTampered=ipsCookieSecTampered, httpProxyTotalReq=httpProxyTotalReq, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsRCTotDropped=ipsRCTotDropped, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, processCountHigh=processCountHigh, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsReqSrvcPort=ipsReqSrvcPort, switchingToBypassMode=switchingToBypassMode, ipsCookieSecPort=ipsCookieSecPort, PYSNMP_MODULE_ID=bws, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslProxyOutBytes=sslProxyOutBytes, systemFanSpeed=systemFanSpeed, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsAccessCtrlAddress=ipsAccessCtrlAddress, webCacheLongHdrs=webCacheLongHdrs, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, firmwareStorageHigh=firmwareStorageHigh, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, highAvailabilityStatus=highAvailabilityStatus, webCacheReq=webCacheReq, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsIpsRCStatsTable=bwsIpsRCStatsTable, freeMem=freeMem, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, totalAttacks=totalAttacks, smAgentName=smAgentName, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsMIBCompliances=bwsMIBCompliances, sslSrvrState=sslSrvrState, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, webCacheAddress=webCacheAddress, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpSrvrTotResponse=httpSrvrTotResponse, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrMinResTime=httpSrvrMinResTime, bwsStats=bwsStats, sslProxyAddressType=sslProxyAddressType, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslSrvrTotReqRejected=sslSrvrTotReqRejected, serviceAddress=serviceAddress, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, webCacheCacheableRes=webCacheCacheableRes, dataPortLinkDown=dataPortLinkDown, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, dataPortLinkUp=dataPortLinkUp, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, switchingToInlineMode=switchingToInlineMode, memoryUsageHigh=memoryUsageHigh, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsCacheStatsTable=bwsCacheStatsTable, sslProxyActiveConn=sslProxyActiveConn)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrAddressType=sslSrvrAddressType, ipsUrlAclPort=ipsUrlAclPort, bws=bws, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsUrlAclReserved=ipsUrlAclReserved, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslProxyPort=sslProxyPort, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsUrlNormAddressType=ipsUrlNormAddressType, webCmprAddress=webCmprAddress, energizeUpdateExpire=energizeUpdateExpire, sslSrvrTotRefused=sslSrvrTotRefused, firmwareStorage=firmwareStorage, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsUrlNormAddress=ipsUrlNormAddress, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpProxyInBytes=httpProxyInBytes, sslProxyCacheHits=sslProxyCacheHits, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, dataPathStatus=dataPathStatus, sslProxyInBytes=sslProxyInBytes, sslSrvrTotResponse=sslSrvrTotResponse, ipsRCTimeStamp=ipsRCTimeStamp, virusDefUpdates=virusDefUpdates, cpuUtilization=cpuUtilization, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslSrvrNumConn=sslSrvrNumConn, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrAvgResTime=sslSrvrAvgResTime, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, logStorage=logStorage, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, totalBandwidth=totalBandwidth, httpSrvrOutBytes=httpSrvrOutBytes, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslSrvrAddress=sslSrvrAddress, webCachePort=webCachePort, ipsRCTotQueued=ipsRCTotQueued, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslSrvrInBytes=sslSrvrInBytes, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, totalMem=totalMem, httpProxyServerAbrt=httpProxyServerAbrt, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsCookieSecAddress=ipsCookieSecAddress, ipsHdrAclHits=ipsHdrAclHits, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslProxyTotalReq=sslProxyTotalReq, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, totalServers=totalServers, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr)
