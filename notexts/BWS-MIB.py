...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, Counter64, iso, MibIdentifier, Bits, Gauge32, NotificationType, ObjectIdentity, Unsigned32, Integer32, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "Counter64", "iso", "MibIdentifier", "Bits", "Gauge32", "NotificationType", "ObjectIdentity", "Unsigned32", "Integer32", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", raidDegrading=raidDegrading, httpProxyActiveConn=httpProxyActiveConn, bwsTrapGroup=bwsTrapGroup, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, virusDefUpdates=virusDefUpdates, httpProxyPort=httpProxyPort, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpSrvrPort=httpSrvrPort, serverDown=serverDown, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsMIBGroups=bwsMIBGroups, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsUrlAclAddress=ipsUrlAclAddress, ipsRCTimeStamp=ipsRCTimeStamp, webCmprAddress=webCmprAddress, servicePort=servicePort, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, logStorage=logStorage, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, fanDead=fanDead, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsUrlAclReserved=ipsUrlAclReserved, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, smNumUserSessions=smNumUserSessions, sslSrvrTotReqActive=sslSrvrTotReqActive, webCacheStale=webCacheStale, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, webCacheCachedObjects=webCacheCachedObjects, sslSrvrAddressType=sslSrvrAddressType, serviceAddress=serviceAddress, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrPort=sslSrvrPort, ipsRCTotOutOfResource=ipsRCTotOutOfResource, vipStatus=vipStatus, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, activeApplications=activeApplications, httpProxyServerReq=httpProxyServerReq, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, srvcName=srvcName, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, webCacheCacheableRes=webCacheCacheableRes, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslSrvrState=sslSrvrState, activeServers=activeServers, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsStats=bwsStats, httpProxyParseErr=httpProxyParseErr, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslSrvrNumFreeConn=sslSrvrNumFreeConn, processCountHigh=processCountHigh, webCmprProtocol=webCmprProtocol, httpSrvrNumConn=httpSrvrNumConn, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpProxyServerErr=httpProxyServerErr, sslProxyTotalReq=sslProxyTotalReq, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, cpuTemperature=cpuTemperature, ipsHdrAclAddress=ipsHdrAclAddress, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsReqSrvcAddress=ipsReqSrvcAddress, totalApplications=totalApplications, webCmprAddressType=webCmprAddressType, sslSrvrNumConn=sslSrvrNumConn, dataPortLinkUp=dataPortLinkUp, ipsCookieSecPort=ipsCookieSecPort, ipsRCTotServed=ipsRCTotServed, webCacheProtocol=webCacheProtocol, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslProxyFullHandshakes=sslProxyFullHandshakes, serviceName=serviceName, PYSNMP_MODULE_ID=bws, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsRCTotDropped=ipsRCTotDropped, totalAttacks=totalAttacks, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsLrnSrvcPort=ipsLrnSrvcPort, totalMem=totalMem, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, systemFanSpeed=systemFanSpeed, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, uptime=uptime, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslProxyAddress=sslProxyAddress, ipsHdrAclPort=ipsHdrAclPort, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsRCTotQueued=ipsRCTotQueued, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, cpuUtilization=cpuUtilization, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslProxyBadDNCErr=sslProxyBadDNCErr, smRealmName=smRealmName, ipsUrlNormPort=ipsUrlNormPort, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsMIBCompliances=bwsMIBCompliances, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, systemFailOver=systemFailOver, sslProxyCacheTimeouts=sslProxyCacheTimeouts, logStorageHigh=logStorageHigh, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsCacheStatsTable=bwsCacheStatsTable, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslProxyTotalConn=sslProxyTotalConn, systemSerialNumber=systemSerialNumber, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlAclAddressType=ipsUrlAclAddressType, sslSrvrMinResTime=sslSrvrMinResTime, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrTotRefused=sslSrvrTotRefused, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, firmwareUpdateAvailable=firmwareUpdateAvailable, webCmprPort=webCmprPort, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsReqLimitPort=ipsReqLimitPort, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsSMUserSessionTable=bwsSMUserSessionTable, totalBandwidth=totalBandwidth, httpProxyTotalReq=httpProxyTotalReq, sslSrvrAddress=sslSrvrAddress, httpProxyWAFWarnings=httpProxyWAFWarnings, webCacheLongHdrs=webCacheLongHdrs, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, totalServers=totalServers, httpSrvrMinResTime=httpSrvrMinResTime, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsUrlPolicyPort=ipsUrlPolicyPort, linkStatus=linkStatus, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpProxyInBytes=httpProxyInBytes, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslProxyCurrentConn=sslProxyCurrentConn, sslProxyBadCRLErr=sslProxyBadCRLErr, switchingToBypassMode=switchingToBypassMode, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, firmwareStorage=firmwareStorage, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrAddressType=httpSrvrAddressType, sslProxyCacheHits=sslProxyCacheHits, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsReqSrvcPort=ipsReqSrvcPort, energizeUpdateExpire=energizeUpdateExpire, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpProxyAddressType=httpProxyAddressType, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsRCPort=ipsRCPort, ipsReqLimitAddressType=ipsReqLimitAddressType, httpSrvrInBytes=httpSrvrInBytes, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpProxyUnknownRsp=httpProxyUnknownRsp, tempHigh=tempHigh, ipsWebAddrTransPort=ipsWebAddrTransPort, dataPortLinkDown=dataPortLinkDown, switchingToInlineMode=switchingToInlineMode, bwsStatsGroup=bwsStatsGroup, httpProxyClientAbrt=httpProxyClientAbrt, bwsServiceStatusEntry=bwsServiceStatusEntry, securityDefUpdates=securityDefUpdates, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrInBytes=sslSrvrInBytes, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwstraps=bwstraps, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpProxyTotalConn=httpProxyTotalConn, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsServiceStatusTable=bwsServiceStatusTable, systemFailure=systemFailure, sslSrvrOutBytes=sslSrvrOutBytes, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsRCAddress=ipsRCAddress, sslProxyActiveConn=sslProxyActiveConn, ipsAccessCtrlPort=ipsAccessCtrlPort, httpSrvrAddress=httpSrvrAddress, peerDown=peerDown, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrTotResponse=sslSrvrTotResponse, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsCookieSecTampered=ipsCookieSecTampered, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrMaxResTime=httpSrvrMaxResTime, sslProxyInBytes=sslProxyInBytes, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsRCAddressType=ipsRCAddressType, webCacheHits=webCacheHits, serverUp=serverUp, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bws=bws, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, tempCritical=tempCritical, webCacheAddressType=webCacheAddressType, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslProxyOutBytes=sslProxyOutBytes, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsHdrAclAddressType=ipsHdrAclAddressType, httpProxyAddress=httpProxyAddress, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsMIBCompliance=bwsMIBCompliance, ipsUrlAclPort=ipsUrlAclPort)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, highAvailabilityStatus=highAvailabilityStatus, bwsMIBConformance=bwsMIBConformance, httpProxyServerAbrt=httpProxyServerAbrt, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, dataPathStatus=dataPathStatus, memUtilization=memUtilization, memoryUsageHigh=memoryUsageHigh, sslSrvrTotTimedout=sslSrvrTotTimedout, peerUp=peerUp, ipsHdrAclHits=ipsHdrAclHits, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrState=httpSrvrState, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrOutBytes=httpSrvrOutBytes, httpProxyOutBytes=httpProxyOutBytes, serviceStatus=serviceStatus, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslProxyPort=sslProxyPort, smAgentName=smAgentName, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, currentFirmwareVersion=currentFirmwareVersion, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpSrvrTotRefused=httpSrvrTotRefused, firmwareStorageHigh=firmwareStorageHigh, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsCookieSecAddress=ipsCookieSecAddress, sslProxyAddressType=sslProxyAddressType, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, webCacheAddress=webCacheAddress, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, webCacheBytesOut=webCacheBytesOut, freeMem=freeMem, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, operationalMode=operationalMode, bwsMessage=bwsMessage, httpSrvrTotResponse=httpSrvrTotResponse, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, webCachePort=webCachePort, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, systemLoad=systemLoad, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsReqLimitAddress=ipsReqLimitAddress, webCacheMiss=webCacheMiss, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sharedSecretKeyExpired=sharedSecretKeyExpired, sslSrvrSrvcPort=sslSrvrSrvcPort, sslProxyErrPms=sslProxyErrPms, cpuFanSpeed=cpuFanSpeed, webCacheReq=webCacheReq, switchingToMaintMode=switchingToMaintMode, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrTotReqActive=httpSrvrTotReqActive, httpProxySessionTimeOut=httpProxySessionTimeOut)
