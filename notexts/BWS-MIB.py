...
# Produced by pysmi-1.1.8 at Fri Dec  2 16:40:32 2022
...
IpAddress, Gauge32, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, Bits, ModuleIdentity, TimeTicks, Unsigned32, ObjectIdentity, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "Bits", "ModuleIdentity", "TimeTicks", "Unsigned32", "ObjectIdentity", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, serviceStatus=serviceStatus, systemFailOver=systemFailOver, serviceName=serviceName, webCmprPort=webCmprPort, cpuFanSpeed=cpuFanSpeed, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslProxyTotalConn=sslProxyTotalConn, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, webCacheHits=webCacheHits, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsRCAddress=ipsRCAddress, ipsUrlAclAddress=ipsUrlAclAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, totalMem=totalMem, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrAddressType=httpSrvrAddressType, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsRCTotQueued=ipsRCTotQueued, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpProxyServerReq=httpProxyServerReq, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsReqLimitPort=ipsReqLimitPort, httpProxyTotalConn=httpProxyTotalConn, serviceAddress=serviceAddress, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsCacheStatsTable=bwsCacheStatsTable, bwsStatsGroup=bwsStatsGroup, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpProxyUnknownRsp=httpProxyUnknownRsp, systemLoad=systemLoad, webCmprProtocol=webCmprProtocol, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, webCacheCacheableRes=webCacheCacheableRes, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, systemFanSpeed=systemFanSpeed, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, memoryUsageHigh=memoryUsageHigh, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, webCacheLongHdrs=webCacheLongHdrs, ipsLrnSrvcPort=ipsLrnSrvcPort, httpProxyServerErr=httpProxyServerErr, bwsCompressionStatsTable=bwsCompressionStatsTable, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bws=bws, bwsServiceStatusTable=bwsServiceStatusTable, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsHdrAclAddressType=ipsHdrAclAddressType, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, webCacheProtocol=webCacheProtocol, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, cpuTemperature=cpuTemperature, cpuUtilization=cpuUtilization, ipsHdrAclHits=ipsHdrAclHits, httpSrvrNumConn=httpSrvrNumConn, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsMessage=bwsMessage, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, memUtilization=memUtilization, ipsWebAddrTransAddress=ipsWebAddrTransAddress, tempCritical=tempCritical, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, processCountHigh=processCountHigh, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, dataPortLinkUp=dataPortLinkUp, smNumUserSessions=smNumUserSessions, sslSrvrTotRefused=sslSrvrTotRefused, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpSrvrAddress=httpSrvrAddress, httpProxyAddress=httpProxyAddress, switchingToInlineMode=switchingToInlineMode, bwsTrapGroup=bwsTrapGroup, energizeUpdateExpire=energizeUpdateExpire, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslProxyPort=sslProxyPort, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, switchingToMaintMode=switchingToMaintMode, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsUrlAclPort=ipsUrlAclPort, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrOutBytes=httpSrvrOutBytes, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, PYSNMP_MODULE_ID=bws, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwstraps=bwstraps, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslSrvrMinResTime=sslSrvrMinResTime, systemSerialNumber=systemSerialNumber, servicePort=servicePort, srvcName=srvcName, ipsHdrAclPort=ipsHdrAclPort, httpSrvrInBytes=httpSrvrInBytes, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpProxyParseErr=httpProxyParseErr, securityDefUpdates=securityDefUpdates, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, serverUp=serverUp, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsMIBCompliances=bwsMIBCompliances, sslSrvrTotTimedout=sslSrvrTotTimedout, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, linkStatus=linkStatus, sslSrvrNumConn=sslSrvrNumConn, sslSrvrAddress=sslSrvrAddress, logStorageHigh=logStorageHigh, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpProxyTotalReq=httpProxyTotalReq, httpProxyAddressType=httpProxyAddressType, sslProxyTotalReq=sslProxyTotalReq, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, peerDown=peerDown, sslSrvrTotResponse=sslSrvrTotResponse, webCmprAddress=webCmprAddress, sslProxyAddressType=sslProxyAddressType, webCacheBytesOut=webCacheBytesOut, httpProxyClientAbrt=httpProxyClientAbrt, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsCookieSecPort=ipsCookieSecPort, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsRCTotServed=ipsRCTotServed, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrTotRefused=httpSrvrTotRefused, dataPortLinkDown=dataPortLinkDown, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpSrvrState=httpSrvrState, webCachePort=webCachePort, highAvailabilityStatus=highAvailabilityStatus, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsStats=bwsStats, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsUrlNormPort=ipsUrlNormPort, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, webCacheStale=webCacheStale, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpProxyOutBytes=httpProxyOutBytes, virusDefUpdates=virusDefUpdates, totalApplications=totalApplications, uptime=uptime, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsRCTotDropped=ipsRCTotDropped, ipsHdrAclAddress=ipsHdrAclAddress, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslSrvrAddressType=sslSrvrAddressType, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpProxyInBytes=httpProxyInBytes, sslSrvrInBytes=sslSrvrInBytes, sslProxyErrPms=sslProxyErrPms, httpProxySessionTimeOut=httpProxySessionTimeOut, peerUp=peerUp, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrPort=sslSrvrPort, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsReqLimitAddress=ipsReqLimitAddress, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpProxyActiveConn=httpProxyActiveConn, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, serverDown=serverDown, currentFirmwareVersion=currentFirmwareVersion, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, webCacheMiss=webCacheMiss, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, webCacheAddress=webCacheAddress, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, webCacheCachedObjects=webCacheCachedObjects, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslProxyInBytes=sslProxyInBytes, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsUrlAclReserved=ipsUrlAclReserved, webCmprAddressType=webCmprAddressType, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsCookieSecAddress=ipsCookieSecAddress, bwsMIBConformance=bwsMIBConformance, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, totalBandwidth=totalBandwidth, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsRCTimeStamp=ipsRCTimeStamp, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, smRealmName=smRealmName, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsRCPort=ipsRCPort, httpSrvrTotReqActive=httpSrvrTotReqActive, activeServers=activeServers, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, activeApplications=activeApplications, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsMIBCompliance=bwsMIBCompliance, dataPathStatus=dataPathStatus, smAgentName=smAgentName, sslProxyCurrentConn=sslProxyCurrentConn, totalAttacks=totalAttacks, sslSrvrSrvcAddress=sslSrvrSrvcAddress, systemFailure=systemFailure, fanDead=fanDead, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, totalServers=totalServers, httpProxyWAFWarnings=httpProxyWAFWarnings, sslSrvrOutBytes=sslSrvrOutBytes, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsRCAddressType=ipsRCAddressType, tempHigh=tempHigh, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled)
mibBuilder.exportSymbols("BWS-MIB", ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslProxyAddress=sslProxyAddress, firmwareStorage=firmwareStorage, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, operationalMode=operationalMode, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, webCacheReq=webCacheReq, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslProxyActiveConn=sslProxyActiveConn, httpSrvrTotTimedout=httpSrvrTotTimedout, firmwareStorageHigh=firmwareStorageHigh, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsCookieSecTampered=ipsCookieSecTampered, httpProxyServerAbrt=httpProxyServerAbrt, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsReqSrvcPort=ipsReqSrvcPort, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslSrvrState=sslSrvrState, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, webCacheAddressType=webCacheAddressType, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlAclAddressType=ipsUrlAclAddressType, sslSrvrAvgResTime=sslSrvrAvgResTime, logStorage=logStorage, ipsReqLimitAddressType=ipsReqLimitAddressType, sslProxyOutBytes=sslProxyOutBytes, freeMem=freeMem, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsSMUserSessionTable=bwsSMUserSessionTable, switchingToBypassMode=switchingToBypassMode, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslProxyCacheMiss=sslProxyCacheMiss, sslProxyCacheHits=sslProxyCacheHits, httpProxyPort=httpProxyPort, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsMIBGroups=bwsMIBGroups, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsCacheStatsEntry=bwsCacheStatsEntry, vipStatus=vipStatus, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, raidDegrading=raidDegrading, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpSrvrPort=httpSrvrPort, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpSrvrMinResTime=httpSrvrMinResTime, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry)
