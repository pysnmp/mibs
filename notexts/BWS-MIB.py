...
ObjectIdentity, TimeTicks, ModuleIdentity, IpAddress, Integer32, Gauge32, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, Bits, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "ModuleIdentity", "IpAddress", "Integer32", "Gauge32", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "Bits", "NotificationType", "iso")
...
mibBuilder.exportSymbols("BWS-MIB", bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpSrvrState=httpSrvrState, httpProxyServerErr=httpProxyServerErr, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, currentFirmwareVersion=currentFirmwareVersion, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, smRealmName=smRealmName, firmwareStorageHigh=firmwareStorageHigh, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, webCmprAddress=webCmprAddress, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, vipStatus=vipStatus, sslSrvrSrvcPort=sslSrvrSrvcPort, virusDefUpdates=virusDefUpdates, bws=bws, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpSrvrInBytes=httpSrvrInBytes, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, webCacheCachedObjects=webCacheCachedObjects, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsStats=bwsStats, ipsUrlAclAddress=ipsUrlAclAddress, httpProxyOutBytes=httpProxyOutBytes, systemFanSpeed=systemFanSpeed, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, peerUp=peerUp, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, webCacheHits=webCacheHits, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsServiceStatusEntry=bwsServiceStatusEntry, firmwareStorage=firmwareStorage, ipsReqLimitAddressType=ipsReqLimitAddressType, webCacheCacheableRes=webCacheCacheableRes, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, serverUp=serverUp, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, tempHigh=tempHigh, sslProxyCurrentConn=sslProxyCurrentConn, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsUrlAclPort=ipsUrlAclPort, ipsCookieSecEncrypted=ipsCookieSecEncrypted, processCountHigh=processCountHigh, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpSrvrPort=httpSrvrPort, sslProxyOutBytes=sslProxyOutBytes, switchingToInlineMode=switchingToInlineMode, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsRCPort=ipsRCPort, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, switchingToMaintMode=switchingToMaintMode, webCachePort=webCachePort, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, httpSrvrAddress=httpSrvrAddress, totalBandwidth=totalBandwidth, memUtilization=memUtilization, webCacheProtocol=webCacheProtocol, sslSrvrInBytes=sslSrvrInBytes, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, cpuUtilization=cpuUtilization, serviceName=serviceName, bwsMIBConformance=bwsMIBConformance, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, webCmprAddressType=webCmprAddressType, ipsLrnSrvcAddress=ipsLrnSrvcAddress, systemFailOver=systemFailOver, bwsMIBCompliance=bwsMIBCompliance, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsReqLimitPort=ipsReqLimitPort, bwsCompressionStatsTable=bwsCompressionStatsTable, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslProxyBadDNCErr=sslProxyBadDNCErr, webCmprPort=webCmprPort, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslProxyAddress=sslProxyAddress, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslSrvrPort=sslSrvrPort, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpProxyTotalConn=httpProxyTotalConn, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsRCAddressType=ipsRCAddressType, ipsHdrAclHits=ipsHdrAclHits, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsMIBCompliances=bwsMIBCompliances, dataPortLinkDown=dataPortLinkDown, ipsUrlNormPort=ipsUrlNormPort, bwsTrapGroup=bwsTrapGroup, sslSrvrOutBytes=sslSrvrOutBytes, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsUrlAclReserved=ipsUrlAclReserved, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpSrvrAddressType=httpSrvrAddressType, httpSrvrNumConn=httpSrvrNumConn, webCacheBytesOut=webCacheBytesOut, httpProxyServerReq=httpProxyServerReq, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, freeMem=freeMem, peerDown=peerDown, webCacheLongHdrs=webCacheLongHdrs, PYSNMP_MODULE_ID=bws, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, linkStatus=linkStatus, sslProxyCacheMiss=sslProxyCacheMiss, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpSrvrMinResTime=httpSrvrMinResTime, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsRCTotDropped=ipsRCTotDropped, bwsCacheStatsEntry=bwsCacheStatsEntry, webCmprProtocol=webCmprProtocol, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, serverDown=serverDown, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpProxySessionTimeOut=httpProxySessionTimeOut, systemFailure=systemFailure, activeApplications=activeApplications, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslSrvrAddress=sslSrvrAddress, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, totalApplications=totalApplications, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsCookieSecTampered=ipsCookieSecTampered, logStorageHigh=logStorageHigh, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, webCacheAddress=webCacheAddress, logStorage=logStorage, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, smNumUserSessions=smNumUserSessions, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrTotRefused=sslSrvrTotRefused, ipsReqSrvcPort=ipsReqSrvcPort, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrTotResponse=httpSrvrTotResponse, systemLoad=systemLoad, ipsUrlNormAddress=ipsUrlNormAddress, securityDefUpdates=securityDefUpdates, ipsHdrAclAddress=ipsHdrAclAddress, sslSrvrNumConn=sslSrvrNumConn, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, serviceStatus=serviceStatus, ipsRCTotQueued=ipsRCTotQueued, bwsStatsGroup=bwsStatsGroup, webCacheStale=webCacheStale, sslProxyTotalReq=sslProxyTotalReq, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslSrvrMinResTime=sslSrvrMinResTime, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpProxyPort=httpProxyPort, totalAttacks=totalAttacks, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpProxyActiveConn=httpProxyActiveConn, webCacheMiss=webCacheMiss, sslSrvrTotTimedout=sslSrvrTotTimedout, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslSrvrTotResponse=sslSrvrTotResponse, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsCookieSecAddressType=ipsCookieSecAddressType, dataPortLinkUp=dataPortLinkUp, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, srvcName=srvcName, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslSrvrState=sslSrvrState, bwsCacheStatsTable=bwsCacheStatsTable, httpProxyServerAbrt=httpProxyServerAbrt, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpSrvrOutBytes=httpSrvrOutBytes, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, systemSerialNumber=systemSerialNumber, httpProxyTotalReq=httpProxyTotalReq, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsRCTimeStamp=ipsRCTimeStamp, cpuTemperature=cpuTemperature, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslProxyCacheHits=sslProxyCacheHits, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslProxyInBytes=sslProxyInBytes, sslSrvrAddressType=sslSrvrAddressType, sslProxyAddressType=sslProxyAddressType, sslProxyActiveConn=sslProxyActiveConn, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, memoryUsageHigh=memoryUsageHigh, smAgentName=smAgentName, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsMIBGroups=bwsMIBGroups, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsCookieSecPort=ipsCookieSecPort, httpSrvrTotRefused=httpSrvrTotRefused, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslProxyFullHandshakes=sslProxyFullHandshakes, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, highAvailabilityStatus=highAvailabilityStatus, sslProxyTotalConn=sslProxyTotalConn, httpProxyParseErr=httpProxyParseErr, ipsAccessCtrlAddress=ipsAccessCtrlAddress, uptime=uptime, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsReqLimitAddress=ipsReqLimitAddress)
mibBuilder.exportSymbols("BWS-MIB", sslProxyErrPms=sslProxyErrPms, ipsRCTotServed=ipsRCTotServed, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsServiceStatusTable=bwsServiceStatusTable, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, totalMem=totalMem, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, switchingToBypassMode=switchingToBypassMode, httpProxyClientAbrt=httpProxyClientAbrt, ipsHdrAclPort=ipsHdrAclPort, httpProxyInBytes=httpProxyInBytes, cpuFanSpeed=cpuFanSpeed, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, totalServers=totalServers, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, raidDegrading=raidDegrading, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpProxyAddress=httpProxyAddress, bwstraps=bwstraps, servicePort=servicePort, fanDead=fanDead, bwsSslProxyStatsTable=bwsSslProxyStatsTable, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsLrnSrvcPort=ipsLrnSrvcPort, sslSrvrTotReqActive=sslSrvrTotReqActive, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsIpsRCStatsTable=bwsIpsRCStatsTable, webCacheAddressType=webCacheAddressType, ipsReqSrvcAddress=ipsReqSrvcAddress, serviceAddress=serviceAddress, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsReqSrvcAddressType=ipsReqSrvcAddressType, tempCritical=tempCritical, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, energizeUpdateExpire=energizeUpdateExpire, sslProxyCacheTimeouts=sslProxyCacheTimeouts, webCacheReq=webCacheReq, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslProxyPort=sslProxyPort, dataPathStatus=dataPathStatus, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsMessage=bwsMessage, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsRCAddress=ipsRCAddress, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpProxyAddressType=httpProxyAddressType, sslProxyBadCRLErr=sslProxyBadCRLErr, activeServers=activeServers, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, operationalMode=operationalMode, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes)
