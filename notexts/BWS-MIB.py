...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, MibIdentifier, iso, Counter64, Counter32, Unsigned32, Bits, ModuleIdentity, NotificationType, Integer32, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "MibIdentifier", "iso", "Counter64", "Counter32", "Unsigned32", "Bits", "ModuleIdentity", "NotificationType", "Integer32", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("BWS-MIB", peerUp=peerUp, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsReqLimitAddress=ipsReqLimitAddress, bwsSMUserSessionEntry=bwsSMUserSessionEntry, totalBandwidth=totalBandwidth, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsReqSrvcPort=ipsReqSrvcPort, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrTotRefused=sslSrvrTotRefused, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, webCacheAddress=webCacheAddress, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsReqLimitAddressType=ipsReqLimitAddressType, totalServers=totalServers, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslProxyCacheHits=sslProxyCacheHits, sslProxyBadDNCErr=sslProxyBadDNCErr, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpProxyServerAbrt=httpProxyServerAbrt, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsTrapGroup=bwsTrapGroup, webCacheStale=webCacheStale, httpProxyServerErr=httpProxyServerErr, memUtilization=memUtilization, ipsUrlAclReserved=ipsUrlAclReserved, tempHigh=tempHigh, vipStatus=vipStatus, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, switchingToBypassMode=switchingToBypassMode, smRealmName=smRealmName, serverDown=serverDown, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, firmwareStorage=firmwareStorage, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsUrlNormPort=ipsUrlNormPort, webCacheCachedObjects=webCacheCachedObjects, httpSrvrPort=httpSrvrPort, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsMIBCompliances=bwsMIBCompliances, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsRCTimeStamp=ipsRCTimeStamp, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, totalMem=totalMem, httpProxyOutBytes=httpProxyOutBytes, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsCookieSecPort=ipsCookieSecPort, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsRCTotServed=ipsRCTotServed, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsUrlNormAddressType=ipsUrlNormAddressType, webCacheBytesOut=webCacheBytesOut, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslSrvrTotTimedout=sslSrvrTotTimedout, sharedSecretKeyExpired=sharedSecretKeyExpired, httpProxyClientAbrt=httpProxyClientAbrt, httpProxySessionTimeOut=httpProxySessionTimeOut, firmwareStorageHigh=firmwareStorageHigh, systemFailOver=systemFailOver, dataPortLinkDown=dataPortLinkDown, webCacheMiss=webCacheMiss, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, PYSNMP_MODULE_ID=bws, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsWebAddrTransPort=ipsWebAddrTransPort, webCacheReq=webCacheReq, sslProxyActiveConn=sslProxyActiveConn, ipsHdrAclAddressType=ipsHdrAclAddressType, systemSerialNumber=systemSerialNumber, firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrAvgResTime=httpSrvrAvgResTime, operationalMode=operationalMode, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpProxyTotalConn=httpProxyTotalConn, httpProxyWAFWarnings=httpProxyWAFWarnings, sslProxyAddressType=sslProxyAddressType, httpProxyTotalReq=httpProxyTotalReq, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsRCPort=ipsRCPort, ipsHdrAclHits=ipsHdrAclHits, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsMessage=bwsMessage, bwsStats=bwsStats, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsCookieSecAddress=ipsCookieSecAddress, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrOutBytes=sslSrvrOutBytes, bwsMIBCompliance=bwsMIBCompliance, processCountHigh=processCountHigh, activeServers=activeServers, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, webCacheAddressType=webCacheAddressType, totalApplications=totalApplications, switchingToMaintMode=switchingToMaintMode, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpSrvrTotRefused=httpSrvrTotRefused, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslProxyCacheTimeouts=sslProxyCacheTimeouts, cpuUtilization=cpuUtilization, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrInBytes=httpSrvrInBytes, sslProxyOutBytes=sslProxyOutBytes, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, webCmprCompressibleDataSize=webCmprCompressibleDataSize, webCacheHits=webCacheHits, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, cpuTemperature=cpuTemperature, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslSrvrTotResponse=sslSrvrTotResponse, bwsStatsGroup=bwsStatsGroup, serviceName=serviceName, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsRCAddressType=ipsRCAddressType, systemFanSpeed=systemFanSpeed, bwsMIBGroups=bwsMIBGroups, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslSrvrAvgResTime=sslSrvrAvgResTime, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpProxyAddress=httpProxyAddress, webCacheLongHdrs=webCacheLongHdrs, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, dataPortLinkUp=dataPortLinkUp, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, webCacheCacheableRes=webCacheCacheableRes, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrAddressType=httpSrvrAddressType, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, memoryUsageHigh=memoryUsageHigh, sslProxyAddress=sslProxyAddress, sslSrvrState=sslSrvrState, uptime=uptime, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsRCTotQueued=ipsRCTotQueued, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, webCmprProtocol=webCmprProtocol, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsUrlNormAddress=ipsUrlNormAddress, linkStatus=linkStatus, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpProxyServerReq=httpProxyServerReq, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrInBytes=sslSrvrInBytes, httpSrvrAddress=httpSrvrAddress, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpProxyInBytes=httpProxyInBytes, serviceAddress=serviceAddress, sslSrvrNumConn=sslSrvrNumConn, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpSrvrState=httpSrvrState, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrAddress=sslSrvrAddress, bwsCacheStatsTable=bwsCacheStatsTable, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, peerDown=peerDown, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, cpuFanSpeed=cpuFanSpeed, systemLoad=systemLoad, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, logStorageHigh=logStorageHigh, sslSrvrSrvcPort=sslSrvrSrvcPort, smNumUserSessions=smNumUserSessions, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrMinResTime=httpSrvrMinResTime, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, switchingToInlineMode=switchingToInlineMode, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, activeApplications=activeApplications, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlPolicyPort=ipsUrlPolicyPort, servicePort=servicePort, serviceStatus=serviceStatus, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslProxyCacheMiss=sslProxyCacheMiss, bwsServiceStatusEntry=bwsServiceStatusEntry, httpSrvrTotResponse=httpSrvrTotResponse, securityDefUpdates=securityDefUpdates, sslProxyTotalConn=sslProxyTotalConn, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwstraps=bwstraps, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpProxyAddressType=httpProxyAddressType, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, energizeUpdateExpire=energizeUpdateExpire, highAvailabilityStatus=highAvailabilityStatus, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsRCTotDropped=ipsRCTotDropped, ipsReqLimitPort=ipsReqLimitPort, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsUrlAclAddress=ipsUrlAclAddress, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, tempCritical=tempCritical, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, webCachePort=webCachePort, ipsHdrAclAddress=ipsHdrAclAddress)
mibBuilder.exportSymbols("BWS-MIB", bwsCompressionStatsTable=bwsCompressionStatsTable, fanDead=fanDead, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bws=bws, logStorage=logStorage, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, currentFirmwareVersion=currentFirmwareVersion, virusDefUpdates=virusDefUpdates, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, webCmprPort=webCmprPort, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsMIBConformance=bwsMIBConformance, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslProxyTotalReq=sslProxyTotalReq, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsUrlAclPort=ipsUrlAclPort, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, systemFailure=systemFailure, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslProxyPort=sslProxyPort, freeMem=freeMem, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsHdrAclPort=ipsHdrAclPort, webCmprAddress=webCmprAddress, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpProxyActiveConn=httpProxyActiveConn, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, raidDegrading=raidDegrading, httpSrvrSrvcPort=httpSrvrSrvcPort, totalAttacks=totalAttacks, sslSrvrAddressType=sslSrvrAddressType, webCmprAddressType=webCmprAddressType, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsCookieSecTampered=ipsCookieSecTampered, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslProxyErrPms=sslProxyErrPms, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslProxyInBytes=sslProxyInBytes, webCacheProtocol=webCacheProtocol, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrNumConn=httpSrvrNumConn, smAgentName=smAgentName, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, dataPathStatus=dataPathStatus, httpProxyPort=httpProxyPort, srvcName=srvcName, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpProxyParseErr=httpProxyParseErr, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, serverUp=serverUp, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslSrvrPort=sslSrvrPort, ipsRCAddress=ipsRCAddress, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslProxyCurrentConn=sslProxyCurrentConn, sslSrvrNumFreeConn=sslSrvrNumFreeConn)
