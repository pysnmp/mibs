...
IpAddress, TimeTicks, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, Unsigned32, NotificationType, ObjectIdentity, Integer32, iso, ModuleIdentity, MibIdentifier, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "Unsigned32", "NotificationType", "ObjectIdentity", "Integer32", "iso", "ModuleIdentity", "MibIdentifier", "Bits")
...
mibBuilder.exportSymbols("BWS-MIB", cpuUtilization=cpuUtilization, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslSrvrPort=sslSrvrPort, webCacheLongHdrs=webCacheLongHdrs, webCachePort=webCachePort, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrInBytes=httpSrvrInBytes, ipsLrnSrvcAddress=ipsLrnSrvcAddress, newAttackDefinitionInstalled=newAttackDefinitionInstalled, webCacheCacheableRes=webCacheCacheableRes, bwsMIBCompliances=bwsMIBCompliances, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bws=bws, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, processCountHigh=processCountHigh, webCacheReq=webCacheReq, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpSrvrAddressType=httpSrvrAddressType, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsRCAddress=ipsRCAddress, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsRCTotQueued=ipsRCTotQueued, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwstraps=bwstraps, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsMIBGroups=bwsMIBGroups, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrTotRefused=httpSrvrTotRefused, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpSrvrState=httpSrvrState, bwsMessage=bwsMessage, bwsCacheStatsTable=bwsCacheStatsTable, dataPortLinkUp=dataPortLinkUp, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsReqLimitAddress=ipsReqLimitAddress, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrTotResponse=httpSrvrTotResponse, httpProxyTotalReq=httpProxyTotalReq, httpProxyActiveConn=httpProxyActiveConn, ipsCookieSecPort=ipsCookieSecPort, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsUrlNormAddress=ipsUrlNormAddress, webCmprAddressType=webCmprAddressType, totalMem=totalMem, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, serviceName=serviceName, systemFailOver=systemFailOver, sslProxyCurrentConn=sslProxyCurrentConn, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, logStorageHigh=logStorageHigh, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpProxyTotalConn=httpProxyTotalConn, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, vipStatus=vipStatus, activeApplications=activeApplications, sslSrvrState=sslSrvrState, ipsReqSrvcPort=ipsReqSrvcPort, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsUrlAclReserved=ipsUrlAclReserved, bwsMIBConformance=bwsMIBConformance, ipsAccessCtrlPort=ipsAccessCtrlPort, currentFirmwareVersion=currentFirmwareVersion, dataPathStatus=dataPathStatus, totalAttacks=totalAttacks, smAgentName=smAgentName, smRealmName=smRealmName, sslProxyActiveConn=sslProxyActiveConn, ipsUrlNormAddressType=ipsUrlNormAddressType, httpProxyAddressType=httpProxyAddressType, sslSrvrTotRefused=sslSrvrTotRefused, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsServiceStatusTable=bwsServiceStatusTable, ipsUrlNormPort=ipsUrlNormPort, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sharedSecretKeyExpired=sharedSecretKeyExpired, operationalMode=operationalMode, smNumUserSessions=smNumUserSessions, memoryUsageHigh=memoryUsageHigh, highAvailabilityStatus=highAvailabilityStatus, sslSrvrAddress=sslSrvrAddress, sslSrvrTotResponse=sslSrvrTotResponse, httpSrvrTotTimedout=httpSrvrTotTimedout, httpProxyServerReq=httpProxyServerReq, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpSrvrMinResTime=httpSrvrMinResTime, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsRCPort=ipsRCPort, ipsRCAddressType=ipsRCAddressType, sslProxyOutBytes=sslProxyOutBytes, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrSrvcPort=sslSrvrSrvcPort, webCacheAddress=webCacheAddress, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsRCTimeStamp=ipsRCTimeStamp, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrTotSuccess=httpSrvrTotSuccess, serverDown=serverDown, tempCritical=tempCritical, PYSNMP_MODULE_ID=bws, httpSrvrOutBytes=httpSrvrOutBytes, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpSrvrPort=httpSrvrPort, sslProxyCacheMiss=sslProxyCacheMiss, bwsStats=bwsStats, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, fanDead=fanDead, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsUrlAclPort=ipsUrlAclPort, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslSrvrNumConn=sslSrvrNumConn, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsLrnSrvcPort=ipsLrnSrvcPort, sslSrvrNumFreeConn=sslSrvrNumFreeConn, switchingToBypassMode=switchingToBypassMode, tempHigh=tempHigh, raidDegrading=raidDegrading, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrMaxResTime=sslSrvrMaxResTime, httpProxySessionTimeOut=httpProxySessionTimeOut, httpProxyAddress=httpProxyAddress, httpSrvrSrvcPort=httpSrvrSrvcPort, webCacheHits=webCacheHits, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsUrlAclAddress=ipsUrlAclAddress, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsReqLimitAddressType=ipsReqLimitAddressType, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslProxyBadDNCErr=sslProxyBadDNCErr, sslProxyFullHandshakes=sslProxyFullHandshakes, sslProxyAddressType=sslProxyAddressType, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslSrvrOutBytes=sslSrvrOutBytes, freeMem=freeMem, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, totalApplications=totalApplications, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, webCmprPort=webCmprPort, ipsAccessCtrlAddress=ipsAccessCtrlAddress, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsUrlAclAddressType=ipsUrlAclAddressType, firmwareStorageHigh=firmwareStorageHigh, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, webCacheStale=webCacheStale, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, systemSerialNumber=systemSerialNumber, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, systemFailure=systemFailure, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsHdrAclAddress=ipsHdrAclAddress, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, cpuTemperature=cpuTemperature, firmwareStorage=firmwareStorage, cpuFanSpeed=cpuFanSpeed, webCacheCachedObjects=webCacheCachedObjects, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, webCacheMiss=webCacheMiss, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrAddress=httpSrvrAddress, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsReqLimitPort=ipsReqLimitPort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsSMUserSessionEntry=bwsSMUserSessionEntry, securityDefUpdates=securityDefUpdates, httpProxyOutBytes=httpProxyOutBytes, servicePort=servicePort, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpProxyParseErr=httpProxyParseErr, peerUp=peerUp, sslProxyErrPms=sslProxyErrPms, webCacheBytesOut=webCacheBytesOut, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, serviceAddress=serviceAddress, sslProxyCacheHits=sslProxyCacheHits, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, activeServers=activeServers, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsHdrAclHits=ipsHdrAclHits, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpProxyClientAbrt=httpProxyClientAbrt, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, switchingToMaintMode=switchingToMaintMode, httpProxyServerAbrt=httpProxyServerAbrt, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, serviceStatus=serviceStatus, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsStatsGroup=bwsStatsGroup, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpSrvrTotReqActive=httpSrvrTotReqActive, httpProxyInBytes=httpProxyInBytes, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslSrvrTotTimedout=sslSrvrTotTimedout, webCmprProtocol=webCmprProtocol, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslSrvrMinResTime=sslSrvrMinResTime, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, logStorage=logStorage, bwsMIBCompliance=bwsMIBCompliance, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry)
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpSrvrNumConn=httpSrvrNumConn, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslSrvrInBytes=sslSrvrInBytes, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsCookieSecAddress=ipsCookieSecAddress, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, energizeUpdateExpire=energizeUpdateExpire, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrAddressType=sslSrvrAddressType, bwsCacheStatsEntry=bwsCacheStatsEntry, sslProxyTotalConn=sslProxyTotalConn, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslProxyPort=sslProxyPort, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsReqSrvcAddress=ipsReqSrvcAddress, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslProxyTotalReq=sslProxyTotalReq, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpProxyServerErr=httpProxyServerErr, virusDefUpdates=virusDefUpdates, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, totalBandwidth=totalBandwidth, bwsTrapGroup=bwsTrapGroup, systemLoad=systemLoad, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrAvgResTime=httpSrvrAvgResTime, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsRCTotOutOfResource=ipsRCTotOutOfResource, dataPortLinkDown=dataPortLinkDown, ipsRCTotServed=ipsRCTotServed, sslProxyInBytes=sslProxyInBytes, systemFanSpeed=systemFanSpeed, ipsRCTotDropped=ipsRCTotDropped, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, totalServers=totalServers, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, serverUp=serverUp, srvcName=srvcName, webCacheProtocol=webCacheProtocol, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslSrvrTotSuccess=sslSrvrTotSuccess, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpProxyPort=httpProxyPort, linkStatus=linkStatus, peerDown=peerDown, webCmprAddress=webCmprAddress, sslProxyAddress=sslProxyAddress, webCacheAddressType=webCacheAddressType, memUtilization=memUtilization, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsHdrAclPort=ipsHdrAclPort, uptime=uptime, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, switchingToInlineMode=switchingToInlineMode, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry)
