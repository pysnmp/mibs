...
Counter32, Gauge32, ObjectIdentity, Integer32, MibIdentifier, IpAddress, ModuleIdentity, Bits, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "ObjectIdentity", "Integer32", "MibIdentifier", "IpAddress", "ModuleIdentity", "Bits", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "iso")
...
mibBuilder.exportSymbols("BWS-MIB", ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, serviceStatus=serviceStatus, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, cpuFanSpeed=cpuFanSpeed, switchingToBypassMode=switchingToBypassMode, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, webCacheAddress=webCacheAddress, activeApplications=activeApplications, totalMem=totalMem, systemFailure=systemFailure, httpSrvrMaxResTime=httpSrvrMaxResTime, freeMem=freeMem, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslProxyInBytes=sslProxyInBytes, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, webCacheMiss=webCacheMiss, httpProxyAddress=httpProxyAddress, httpProxySessionTimeOut=httpProxySessionTimeOut, sslProxyFullHandshakes=sslProxyFullHandshakes, httpProxyUnknownRsp=httpProxyUnknownRsp, httpProxyInBytes=httpProxyInBytes, ipsRCAddress=ipsRCAddress, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslProxyOutBytes=sslProxyOutBytes, sharedSecretKeyExpired=sharedSecretKeyExpired, firmwareStorageHigh=firmwareStorageHigh, serviceName=serviceName, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrSrvcPort=sslSrvrSrvcPort, srvcName=srvcName, sslProxyTotalConn=sslProxyTotalConn, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsRCPort=ipsRCPort, ipsUrlAclPort=ipsUrlAclPort, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpProxyOutBytes=httpProxyOutBytes, bwsStats=bwsStats, httpSrvrAddress=httpSrvrAddress, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsCookieSecAddressType=ipsCookieSecAddressType, processCountHigh=processCountHigh, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, dataPortLinkUp=dataPortLinkUp, ipsReqLimitPort=ipsReqLimitPort, ipsRCTotDropped=ipsRCTotDropped, bwsMIBConformance=bwsMIBConformance, httpProxyServerAbrt=httpProxyServerAbrt, dataPortLinkDown=dataPortLinkDown, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslSrvrAddress=sslSrvrAddress, webCachePort=webCachePort, bwsSMUserSessionTable=bwsSMUserSessionTable, serverDown=serverDown, ipsCookieSecAddress=ipsCookieSecAddress, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, smRealmName=smRealmName, sslSrvrTotResponse=sslSrvrTotResponse, httpSrvrState=httpSrvrState, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslProxyPort=sslProxyPort, dataPathStatus=dataPathStatus, webCacheProtocol=webCacheProtocol, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, serviceAddress=serviceAddress, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsHdrAclAddressType=ipsHdrAclAddressType, httpProxyTotalConn=httpProxyTotalConn, activeServers=activeServers, raidDegrading=raidDegrading, httpProxyAddressType=httpProxyAddressType, webCacheStale=webCacheStale, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, webCmprAddress=webCmprAddress, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsMIBGroups=bwsMIBGroups, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, totalServers=totalServers, fanDead=fanDead, highAvailabilityStatus=highAvailabilityStatus, httpSrvrPort=httpSrvrPort, ipsRCTotQueued=ipsRCTotQueued, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslSrvrState=sslSrvrState, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, peerDown=peerDown, ipsUrlAclAddress=ipsUrlAclAddress, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, vipStatus=vipStatus, sslProxyBadDNCErr=sslProxyBadDNCErr, sslSrvrAvgResTime=sslSrvrAvgResTime, sslSrvrTotRefused=sslSrvrTotRefused, servicePort=servicePort, ipsUrlAclReserved=ipsUrlAclReserved, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrAddressType=sslSrvrAddressType, PYSNMP_MODULE_ID=bws, httpSrvrMinResTime=httpSrvrMinResTime, systemLoad=systemLoad, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, peerUp=peerUp, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, firmwareUpdateAvailable=firmwareUpdateAvailable, tempCritical=tempCritical, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsUrlNormPort=ipsUrlNormPort, systemFailOver=systemFailOver, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpProxyParseErr=httpProxyParseErr, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpProxyServerErr=httpProxyServerErr, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwstraps=bwstraps, totalAttacks=totalAttacks, ipsUrlNormAddressType=ipsUrlNormAddressType, memUtilization=memUtilization, sslProxyCacheMiss=sslProxyCacheMiss, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslProxyActiveConn=sslProxyActiveConn, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsSslProxyStatsTable=bwsSslProxyStatsTable, totalBandwidth=totalBandwidth, linkStatus=linkStatus, httpSrvrInBytes=httpSrvrInBytes, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpSrvrTotRefused=httpSrvrTotRefused, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsMIBCompliances=bwsMIBCompliances, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsUrlNormAddress=ipsUrlNormAddress, webCmprAddressType=webCmprAddressType, webCacheCacheableRes=webCacheCacheableRes, logStorage=logStorage, ipsHdrAclAddress=ipsHdrAclAddress, ipsUrlPolicyPort=ipsUrlPolicyPort, httpProxyActiveConn=httpProxyActiveConn, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, logStorageHigh=logStorageHigh, sslSrvrNumConn=sslSrvrNumConn, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsServiceStatusTable=bwsServiceStatusTable, sslSrvrInBytes=sslSrvrInBytes, httpSrvrAddressType=httpSrvrAddressType, webCacheBytesOut=webCacheBytesOut, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslSrvrMinResTime=sslSrvrMinResTime, webCacheHits=webCacheHits, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsCookieSecPort=ipsCookieSecPort, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, smNumUserSessions=smNumUserSessions, sslSrvrTotSuccess=sslSrvrTotSuccess, firmwareStorage=firmwareStorage, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsHdrAclPort=ipsHdrAclPort, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bws=bws, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsCacheStatsTable=bwsCacheStatsTable, cpuUtilization=cpuUtilization, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsMessage=bwsMessage, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, uptime=uptime, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrNumConn=httpSrvrNumConn, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, smAgentName=smAgentName, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpProxyClientAbrt=httpProxyClientAbrt, sslProxyErrPms=sslProxyErrPms, energizeUpdateExpire=energizeUpdateExpire, switchingToMaintMode=switchingToMaintMode, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsRCTotServed=ipsRCTotServed, sslProxyCurrentConn=sslProxyCurrentConn, ipsUrlPolicyAddress=ipsUrlPolicyAddress, systemFanSpeed=systemFanSpeed, switchingToInlineMode=switchingToInlineMode, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsStatsGroup=bwsStatsGroup, sslSrvrTotTimedout=sslSrvrTotTimedout, memoryUsageHigh=memoryUsageHigh, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, securityDefUpdates=securityDefUpdates, httpSrvrSrvcPort=httpSrvrSrvcPort, sslProxyCacheHits=sslProxyCacheHits, ipsReqSrvcPort=ipsReqSrvcPort)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, serverUp=serverUp, webCmprProtocol=webCmprProtocol, sslProxyTotalReq=sslProxyTotalReq, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsCookieSecTampered=ipsCookieSecTampered, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsLrnSrvcPort=ipsLrnSrvcPort, httpProxyTotalReq=httpProxyTotalReq, webCacheReq=webCacheReq, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrTotTimedout=httpSrvrTotTimedout, totalApplications=totalApplications, webCacheCachedObjects=webCacheCachedObjects, sslProxyAddressType=sslProxyAddressType, ipsReqLimitAddress=ipsReqLimitAddress, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, virusDefUpdates=virusDefUpdates, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsRCAddressType=ipsRCAddressType, cpuTemperature=cpuTemperature, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, webCacheAddressType=webCacheAddressType, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, systemSerialNumber=systemSerialNumber, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpProxyServerReq=httpProxyServerReq, operationalMode=operationalMode, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsMIBCompliance=bwsMIBCompliance, currentFirmwareVersion=currentFirmwareVersion, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpSrvrTotResponse=httpSrvrTotResponse, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsHdrAclHits=ipsHdrAclHits, sslSrvrPort=sslSrvrPort, webCacheLongHdrs=webCacheLongHdrs, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, httpProxyPort=httpProxyPort, tempHigh=tempHigh, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrOutBytes=sslSrvrOutBytes, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsRCTimeStamp=ipsRCTimeStamp, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, webCmprPort=webCmprPort, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsTrapGroup=bwsTrapGroup, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslProxyAddress=sslProxyAddress, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp)
