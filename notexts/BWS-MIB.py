...
ObjectIdentity, Bits, TimeTicks, Gauge32, IpAddress, ModuleIdentity, Counter64, Unsigned32, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "TimeTicks", "Gauge32", "IpAddress", "ModuleIdentity", "Counter64", "Unsigned32", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32", "iso")
...
mibBuilder.exportSymbols("BWS-MIB", ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslSrvrTotTimedout=sslSrvrTotTimedout, sslProxyAddressType=sslProxyAddressType, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsReqLimitPort=ipsReqLimitPort, httpProxyServerReq=httpProxyServerReq, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsWebAddrTransAddress=ipsWebAddrTransAddress, totalMem=totalMem, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, PYSNMP_MODULE_ID=bws, webCmprPort=webCmprPort, ipsUrlAclPort=ipsUrlAclPort, peerDown=peerDown, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, webCacheBytesOut=webCacheBytesOut, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, smRealmName=smRealmName, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsReqSrvcPort=ipsReqSrvcPort, webCacheHits=webCacheHits, sslSrvrTotRefused=sslSrvrTotRefused, sslSrvrInBytes=sslSrvrInBytes, webCmprProtocol=webCmprProtocol, ipsRCTotDropped=ipsRCTotDropped, tempHigh=tempHigh, sslProxyAddress=sslProxyAddress, systemLoad=systemLoad, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrAddress=httpSrvrAddress, httpSrvrMinResTime=httpSrvrMinResTime, systemFanSpeed=systemFanSpeed, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsStatsGroup=bwsStatsGroup, sslProxyActiveConn=sslProxyActiveConn, switchingToBypassMode=switchingToBypassMode, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslProxyCurrentConn=sslProxyCurrentConn, ipsUrlAclAddressType=ipsUrlAclAddressType, sslSrvrNumConn=sslSrvrNumConn, serverDown=serverDown, uptime=uptime, totalAttacks=totalAttacks, httpSrvrTotTimedout=httpSrvrTotTimedout, sslProxyCacheMiss=sslProxyCacheMiss, sslSrvrTotSuccess=sslSrvrTotSuccess, switchingToInlineMode=switchingToInlineMode, vipStatus=vipStatus, bwsMIBConformance=bwsMIBConformance, operationalMode=operationalMode, ipsRCPort=ipsRCPort, systemSerialNumber=systemSerialNumber, bwsSslProxyStatsTable=bwsSslProxyStatsTable, webCmprAddressType=webCmprAddressType, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, srvcName=srvcName, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrOutBytes=sslSrvrOutBytes, webCmprAddress=webCmprAddress, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsUrlAclReserved=ipsUrlAclReserved, sharedSecretKeyExpired=sharedSecretKeyExpired, httpSrvrPort=httpSrvrPort, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsMessage=bwsMessage, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsReqLimitAddress=ipsReqLimitAddress, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsMIBCompliance=bwsMIBCompliance, bwsMIBCompliances=bwsMIBCompliances, webCacheProtocol=webCacheProtocol, totalServers=totalServers, bwsMIBGroups=bwsMIBGroups, memoryUsageHigh=memoryUsageHigh, ipsCookieSecAddress=ipsCookieSecAddress, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpProxyClientAbrt=httpProxyClientAbrt, httpSrvrSrvcPort=httpSrvrSrvcPort, sslProxyBadDNCErr=sslProxyBadDNCErr, httpProxyOutBytes=httpProxyOutBytes, sslSrvrTotReqActive=sslSrvrTotReqActive, raidDegrading=raidDegrading, ipsHdrAclHits=ipsHdrAclHits, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsUrlNormAddress=ipsUrlNormAddress, currentFirmwareVersion=currentFirmwareVersion, servicePort=servicePort, sslProxyErrPms=sslProxyErrPms, sslProxyTotalConn=sslProxyTotalConn, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsRCAddressType=ipsRCAddressType, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, securityDefUpdates=securityDefUpdates, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsRCAddress=ipsRCAddress, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, dataPathStatus=dataPathStatus, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsRCTimeStamp=ipsRCTimeStamp, webCacheReq=webCacheReq, httpSrvrState=httpSrvrState, sslSrvrPort=sslSrvrPort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsCompressionStatsTable=bwsCompressionStatsTable, sslProxyOutBytes=sslProxyOutBytes, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslProxyInBytes=sslProxyInBytes, peerUp=peerUp, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsHdrAclAddress=ipsHdrAclAddress, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, cpuTemperature=cpuTemperature, httpSrvrNumConn=httpSrvrNumConn, tempCritical=tempCritical, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, firmwareUpdateAvailable=firmwareUpdateAvailable, sslSrvrAvgResTime=sslSrvrAvgResTime, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrTotResponse=sslSrvrTotResponse, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, dataPortLinkDown=dataPortLinkDown, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, logStorageHigh=logStorageHigh, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, fanDead=fanDead, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslProxyCacheHits=sslProxyCacheHits, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, systemFailure=systemFailure, ipsUrlAclAddress=ipsUrlAclAddress, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, highAvailabilityStatus=highAvailabilityStatus, processCountHigh=processCountHigh, ipsReqLimitAddressType=ipsReqLimitAddressType, httpProxyServerAbrt=httpProxyServerAbrt, httpProxyWAFWarnings=httpProxyWAFWarnings, sslSrvrMinResTime=sslSrvrMinResTime, sslProxyPort=sslProxyPort, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpProxyAddress=httpProxyAddress, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, activeApplications=activeApplications, sslSrvrState=sslSrvrState, httpSrvrInBytes=httpSrvrInBytes, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsLrnSrvcAddress=ipsLrnSrvcAddress, virusDefUpdates=virusDefUpdates, httpProxyAddressType=httpProxyAddressType, httpProxyTotalConn=httpProxyTotalConn, bwstraps=bwstraps, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsHdrAclAddressType=ipsHdrAclAddressType, logStorage=logStorage, serviceAddress=serviceAddress, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bws=bws, cpuUtilization=cpuUtilization, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsCacheStatsTable=bwsCacheStatsTable, ipsRCTotOutOfResource=ipsRCTotOutOfResource, webCachePort=webCachePort, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsUrlPolicyAddress=ipsUrlPolicyAddress, firmwareStorage=firmwareStorage, ipsCookieSecTampered=ipsCookieSecTampered, webCacheAddressType=webCacheAddressType, ipsUrlNormPort=ipsUrlNormPort, linkStatus=linkStatus, bwsTrapGroup=bwsTrapGroup, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsWebAddrTransPort=ipsWebAddrTransPort, smAgentName=smAgentName, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, energizeUpdateExpire=energizeUpdateExpire, dataPortLinkUp=dataPortLinkUp, webCacheAddress=webCacheAddress, httpProxySessionTimeOut=httpProxySessionTimeOut, webCacheCachedObjects=webCacheCachedObjects, httpProxyUnknownRsp=httpProxyUnknownRsp, serviceStatus=serviceStatus, httpSrvrMaxResTime=httpSrvrMaxResTime, httpProxyParseErr=httpProxyParseErr, bwsStats=bwsStats, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrAddressType=sslSrvrAddressType, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsUrlNormAddressType=ipsUrlNormAddressType, httpProxyServerErr=httpProxyServerErr, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsRCTotServed=ipsRCTotServed, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpProxyActiveConn=httpProxyActiveConn, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpSrvrOutBytes=httpSrvrOutBytes, httpSrvrTotSuccess=httpSrvrTotSuccess, sslProxyFullHandshakes=sslProxyFullHandshakes, totalApplications=totalApplications, httpProxyTotalReq=httpProxyTotalReq, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, serverUp=serverUp, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet)
mibBuilder.exportSymbols("BWS-MIB", memUtilization=memUtilization, httpSrvrAddressType=httpSrvrAddressType, sslSrvrAddress=sslSrvrAddress, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, webCacheLongHdrs=webCacheLongHdrs, bwsServiceStatusTable=bwsServiceStatusTable, ipsCookieSecPort=ipsCookieSecPort, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, freeMem=freeMem, cpuFanSpeed=cpuFanSpeed, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, activeServers=activeServers, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, smNumUserSessions=smNumUserSessions, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslProxyTotalReq=sslProxyTotalReq, totalBandwidth=totalBandwidth, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpProxyInBytes=httpProxyInBytes, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsHdrAclPort=ipsHdrAclPort, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, serviceName=serviceName, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrSrvcPort=sslSrvrSrvcPort, firmwareStorageHigh=firmwareStorageHigh, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsRCTotQueued=ipsRCTotQueued, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrTotRefused=httpSrvrTotRefused, httpSrvrSrvcAddress=httpSrvrSrvcAddress, webCacheCacheableRes=webCacheCacheableRes, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, webCacheMiss=webCacheMiss, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpSrvrTotReqActive=httpSrvrTotReqActive, switchingToMaintMode=switchingToMaintMode, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, webCacheStale=webCacheStale, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, systemFailOver=systemFailOver, httpProxyPort=httpProxyPort, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsIpsRCStatsTable=bwsIpsRCStatsTable)
