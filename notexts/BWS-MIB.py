...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, IpAddress, Integer32, NotificationType, Bits, TimeTicks, Unsigned32, ModuleIdentity, MibIdentifier, ObjectIdentity, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "IpAddress", "Integer32", "NotificationType", "Bits", "TimeTicks", "Unsigned32", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("BWS-MIB", ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsSMUserSessionTable=bwsSMUserSessionTable, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsReqLimitPort=ipsReqLimitPort, sslSrvrInBytes=sslSrvrInBytes, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsCompressionStatsEntry=bwsCompressionStatsEntry, webCacheReq=webCacheReq, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslSrvrOutBytes=sslSrvrOutBytes, sslProxyTotalReq=sslProxyTotalReq, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, cpuFanSpeed=cpuFanSpeed, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, activeServers=activeServers, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, memUtilization=memUtilization, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpProxyParseErr=httpProxyParseErr, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sharedSecretKeyExpired=sharedSecretKeyExpired, sslSrvrTotSuccess=sslSrvrTotSuccess, vipStatus=vipStatus, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsWebAddrTransAddress=ipsWebAddrTransAddress, freeMem=freeMem, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsStatsGroup=bwsStatsGroup, peerUp=peerUp, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpProxyPort=httpProxyPort, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, webCacheHits=webCacheHits, sslSrvrNumConn=sslSrvrNumConn, totalApplications=totalApplications, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsUrlAclAddressType=ipsUrlAclAddressType, sslProxyCacheMiss=sslProxyCacheMiss, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, peerDown=peerDown, sslSrvrAddress=sslSrvrAddress, bwsStats=bwsStats, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, systemSerialNumber=systemSerialNumber, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpProxyServerAbrt=httpProxyServerAbrt, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslProxyErrPms=sslProxyErrPms, switchingToInlineMode=switchingToInlineMode, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpSrvrPort=httpSrvrPort, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, firmwareStorageHigh=firmwareStorageHigh, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsLrnSrvcPort=ipsLrnSrvcPort, webCacheStale=webCacheStale, ipsRCTotServed=ipsRCTotServed, fanDead=fanDead, httpSrvrAddressType=httpSrvrAddressType, smRealmName=smRealmName, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsRCTotQueued=ipsRCTotQueued, dataPortLinkUp=dataPortLinkUp, httpSrvrOutBytes=httpSrvrOutBytes, sslProxyCacheTimeouts=sslProxyCacheTimeouts, linkStatus=linkStatus, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, webCacheProtocol=webCacheProtocol, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrInBytes=httpSrvrInBytes, bwsMIBGroups=bwsMIBGroups, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsCacheStatsEntry=bwsCacheStatsEntry, tempCritical=tempCritical, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpProxyAddressType=httpProxyAddressType, httpProxyActiveConn=httpProxyActiveConn, logStorageHigh=logStorageHigh, webCmprAddressType=webCmprAddressType, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsServiceStatusTable=bwsServiceStatusTable, sslProxyBadDNCErr=sslProxyBadDNCErr, httpSrvrState=httpSrvrState, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsHdrAclAddress=ipsHdrAclAddress, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, srvcName=srvcName, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, highAvailabilityStatus=highAvailabilityStatus, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsLrnSrvcAddress=ipsLrnSrvcAddress, webCmprPort=webCmprPort, serviceName=serviceName, tempHigh=tempHigh, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsCacheStatsTable=bwsCacheStatsTable, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpSrvrTotTimedout=httpSrvrTotTimedout, webCacheCachedObjects=webCacheCachedObjects, dataPathStatus=dataPathStatus, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrNumConn=httpSrvrNumConn, httpSrvrAddress=httpSrvrAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpProxyInBytes=httpProxyInBytes, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, processCountHigh=processCountHigh, switchingToBypassMode=switchingToBypassMode, bws=bws, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpProxyServerReq=httpProxyServerReq, ipsRCTotDropped=ipsRCTotDropped, switchingToMaintMode=switchingToMaintMode, bwsTrapGroup=bwsTrapGroup, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsCookieSecPort=ipsCookieSecPort, activeApplications=activeApplications, webCacheMiss=webCacheMiss, ipsHdrAclPort=ipsHdrAclPort, httpProxyAddress=httpProxyAddress, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslProxyActiveConn=sslProxyActiveConn, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsServiceStatusEntry=bwsServiceStatusEntry, sslSrvrTotRefused=sslSrvrTotRefused, httpProxyUnknownRsp=httpProxyUnknownRsp, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsCookieSecAddress=ipsCookieSecAddress, energizeUpdateExpire=energizeUpdateExpire, sslSrvrTotTimedout=sslSrvrTotTimedout, sslSrvrTotReqRejected=sslSrvrTotReqRejected, systemFailOver=systemFailOver, serviceStatus=serviceStatus, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, webCacheAddressType=webCacheAddressType, httpSrvrMinResTime=httpSrvrMinResTime, ipsReqLimitAddress=ipsReqLimitAddress, smNumUserSessions=smNumUserSessions, totalAttacks=totalAttacks, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslSrvrState=sslSrvrState, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, totalServers=totalServers, logStorage=logStorage, ipsRCPort=ipsRCPort, httpProxyTotalReq=httpProxyTotalReq, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, servicePort=servicePort, firmwareStorage=firmwareStorage, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, webCacheAddress=webCacheAddress, ipsUrlAclReserved=ipsUrlAclReserved, sslProxyCurrentConn=sslProxyCurrentConn, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslProxyPort=sslProxyPort, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsMIBConformance=bwsMIBConformance, systemLoad=systemLoad, ipsReqSrvcPort=ipsReqSrvcPort, ipsUrlAclPort=ipsUrlAclPort, sslSrvrPort=sslSrvrPort, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslSrvrAddressType=sslSrvrAddressType, serviceAddress=serviceAddress, sslProxyOutBytes=sslProxyOutBytes, sslSrvrMaxResTime=sslSrvrMaxResTime, serverUp=serverUp, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsUrlNormPort=ipsUrlNormPort, totalBandwidth=totalBandwidth, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpProxyTotalConn=httpProxyTotalConn, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, PYSNMP_MODULE_ID=bws, uptime=uptime, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, serverDown=serverDown, operationalMode=operationalMode, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, securityDefUpdates=securityDefUpdates, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, webCacheCacheableRes=webCacheCacheableRes, webCachePort=webCachePort, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslSrvrTotResponse=sslSrvrTotResponse, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, firmwareUpdateAvailable=firmwareUpdateAvailable, httpProxyWAFWarnings=httpProxyWAFWarnings, sslProxyAddress=sslProxyAddress, httpProxyOutBytes=httpProxyOutBytes, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsReqSrvcAddressType=ipsReqSrvcAddressType, cpuTemperature=cpuTemperature, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslProxyAddressType=sslProxyAddressType, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsRCTimeStamp=ipsRCTimeStamp, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsMIBCompliance=bwsMIBCompliance)
mibBuilder.exportSymbols("BWS-MIB", currentFirmwareVersion=currentFirmwareVersion, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsCookieSecTampered=ipsCookieSecTampered, sslProxyInBytes=sslProxyInBytes, ipsRCAddressType=ipsRCAddressType, bwsMIBCompliances=bwsMIBCompliances, sslProxyCacheHits=sslProxyCacheHits, systemFailure=systemFailure, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, raidDegrading=raidDegrading, bwsMessage=bwsMessage, httpSrvrNumFreeConn=httpSrvrNumFreeConn, webCmprAddress=webCmprAddress, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, systemFanSpeed=systemFanSpeed, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsHdrAclHits=ipsHdrAclHits, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, virusDefUpdates=virusDefUpdates, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsHdrAclAddressType=ipsHdrAclAddressType, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, totalMem=totalMem, webCacheLongHdrs=webCacheLongHdrs, smAgentName=smAgentName, httpProxyServerErr=httpProxyServerErr, sslSrvrSrvcPort=sslSrvrSrvcPort, cpuUtilization=cpuUtilization, webCacheBytesOut=webCacheBytesOut, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, memoryUsageHigh=memoryUsageHigh, ipsRCAddress=ipsRCAddress, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwstraps=bwstraps, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsCookieSecEncrypted=ipsCookieSecEncrypted, dataPortLinkDown=dataPortLinkDown, sslSrvrMinResTime=sslSrvrMinResTime, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslProxyTotalConn=sslProxyTotalConn, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsUrlNormAddress=ipsUrlNormAddress, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslSrvrAvgResTime=sslSrvrAvgResTime, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrSrvcPort=httpSrvrSrvcPort, webCmprProtocol=webCmprProtocol, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol)
