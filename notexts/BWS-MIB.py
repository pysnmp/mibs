...
Bits, ModuleIdentity, MibIdentifier, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, Gauge32, Integer32, Counter64, NotificationType, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "MibIdentifier", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "Gauge32", "Integer32", "Counter64", "NotificationType", "IpAddress", "Unsigned32")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrTotSuccess=httpSrvrTotSuccess, operationalMode=operationalMode, bws=bws, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrTotResponse=sslSrvrTotResponse, ipsRCTotDropped=ipsRCTotDropped, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslProxyBadCRLErr=sslProxyBadCRLErr, sslProxyCurrentConn=sslProxyCurrentConn, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, tempHigh=tempHigh, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsMIBCompliance=bwsMIBCompliance, logStorageHigh=logStorageHigh, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlNormAddress=ipsUrlNormAddress, webCacheCacheableRes=webCacheCacheableRes, fanDead=fanDead, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, webCmprAddress=webCmprAddress, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, cpuFanSpeed=cpuFanSpeed, sslProxyOutBytes=sslProxyOutBytes, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, smNumUserSessions=smNumUserSessions, httpSrvrInBytes=httpSrvrInBytes, webCacheBytesOut=webCacheBytesOut, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslProxyActiveConn=sslProxyActiveConn, bwsServiceStatusEntry=bwsServiceStatusEntry, firmwareStorage=firmwareStorage, webCacheAddress=webCacheAddress, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpProxyInBytes=httpProxyInBytes, sslProxyInBytes=sslProxyInBytes, serverUp=serverUp, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsCookieSecTampered=ipsCookieSecTampered, bwsMIBCompliances=bwsMIBCompliances, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpSrvrTotRefused=httpSrvrTotRefused, activeServers=activeServers, ipsReqLimitAddressType=ipsReqLimitAddressType, switchingToMaintMode=switchingToMaintMode, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpSrvrMinResTime=httpSrvrMinResTime, systemFailure=systemFailure, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, webCmprAddressType=webCmprAddressType, ipsReqSrvcAddressType=ipsReqSrvcAddressType, webCacheStale=webCacheStale, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, PYSNMP_MODULE_ID=bws, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslProxyErrPms=sslProxyErrPms, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, smAgentName=smAgentName, cpuTemperature=cpuTemperature, sslProxyTotalReq=sslProxyTotalReq, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, tempCritical=tempCritical, processCountHigh=processCountHigh, totalAttacks=totalAttacks, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, switchingToBypassMode=switchingToBypassMode, bwsCompressionStatsEntry=bwsCompressionStatsEntry, dataPathStatus=dataPathStatus, httpProxyUnknownRsp=httpProxyUnknownRsp, firmwareStorageHigh=firmwareStorageHigh, webCmprCompressedDataSize=webCmprCompressedDataSize, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, totalApplications=totalApplications, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpSrvrState=httpSrvrState, ipsRCTimeStamp=ipsRCTimeStamp, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, energizeUpdateExpire=energizeUpdateExpire, sslProxyCacheHits=sslProxyCacheHits, httpSrvrTotResponse=httpSrvrTotResponse, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslProxyTotalConn=sslProxyTotalConn, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsServiceStatusTable=bwsServiceStatusTable, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, dataPortLinkDown=dataPortLinkDown, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, highAvailabilityStatus=highAvailabilityStatus, httpProxyServerReq=httpProxyServerReq, httpProxyAddress=httpProxyAddress, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsAccessCtrlAddress=ipsAccessCtrlAddress, virusDefUpdates=virusDefUpdates, bwsStats=bwsStats, ipsRCAddress=ipsRCAddress, webCacheLongHdrs=webCacheLongHdrs, ipsHdrAclAddress=ipsHdrAclAddress, ipsUrlAclAddressType=ipsUrlAclAddressType, webCachePort=webCachePort, securityDefUpdates=securityDefUpdates, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslProxyPort=sslProxyPort, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, webCacheMiss=webCacheMiss, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlPolicyPort=ipsUrlPolicyPort, sslSrvrTotRefused=sslSrvrTotRefused, smRealmName=smRealmName, sslSrvrPort=sslSrvrPort, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, systemFanSpeed=systemFanSpeed, serviceAddress=serviceAddress, httpProxyTotalReq=httpProxyTotalReq, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpProxySessionTimeOut=httpProxySessionTimeOut, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrSrvcAddress=sslSrvrSrvcAddress, webCacheAddressType=webCacheAddressType, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, switchingToInlineMode=switchingToInlineMode, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, memoryUsageHigh=memoryUsageHigh, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, activeApplications=activeApplications, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsTrapGroup=bwsTrapGroup, ipsRCTotServed=ipsRCTotServed, totalBandwidth=totalBandwidth, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsUrlNormAddressType=ipsUrlNormAddressType, sslProxyCacheMiss=sslProxyCacheMiss, totalMem=totalMem, dataPortLinkUp=dataPortLinkUp, servicePort=servicePort, httpSrvrAddressType=httpSrvrAddressType, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, peerUp=peerUp, sslSrvrState=sslSrvrState, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsHdrAclAddressType=ipsHdrAclAddressType, newAttackDefinitionInstalled=newAttackDefinitionInstalled, linkStatus=linkStatus, currentFirmwareVersion=currentFirmwareVersion, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsWebAddrTransAddress=ipsWebAddrTransAddress, memUtilization=memUtilization, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsStatsGroup=bwsStatsGroup, webCacheReq=webCacheReq, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsMIBConformance=bwsMIBConformance, bwsCacheStatsEntry=bwsCacheStatsEntry, systemLoad=systemLoad, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, uptime=uptime, httpSrvrNumConn=httpSrvrNumConn, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlAclPort=ipsUrlAclPort, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, serviceName=serviceName, webCmprProtocol=webCmprProtocol, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpProxyServerAbrt=httpProxyServerAbrt, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsReqLimitAddress=ipsReqLimitAddress, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpProxyActiveConn=httpProxyActiveConn, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpSrvrOutBytes=httpSrvrOutBytes, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsReqSrvcPort=ipsReqSrvcPort, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsUrlAclReserved=ipsUrlAclReserved, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpProxyServerErr=httpProxyServerErr, vipStatus=vipStatus, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsCookieSecPort=ipsCookieSecPort, sslProxyAddressType=sslProxyAddressType, httpSrvrPort=httpSrvrPort, bwsCompressionStatsTable=bwsCompressionStatsTable, bwstraps=bwstraps, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, systemSerialNumber=systemSerialNumber, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrOutBytes=sslSrvrOutBytes, webCacheCachedObjects=webCacheCachedObjects, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsMIBGroups=bwsMIBGroups, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, logStorage=logStorage, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry)
mibBuilder.exportSymbols("BWS-MIB", firmwareUpdateAvailable=firmwareUpdateAvailable, ipsRCTotQueued=ipsRCTotQueued, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, systemFailOver=systemFailOver, httpProxyPort=httpProxyPort, webCacheProtocol=webCacheProtocol, ipsUrlNormPort=ipsUrlNormPort, webCmprPort=webCmprPort, serviceStatus=serviceStatus, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, peerDown=peerDown, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslProxyBadDNCErr=sslProxyBadDNCErr, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpProxyTotalConn=httpProxyTotalConn, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsReqLimitPort=ipsReqLimitPort, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, webCacheHits=webCacheHits, bwsMessage=bwsMessage, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslProxyFullHandshakes=sslProxyFullHandshakes, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpProxyAddressType=httpProxyAddressType, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslSrvrAddressType=sslSrvrAddressType, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, freeMem=freeMem, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslProxyAddress=sslProxyAddress, ipsCookieSecAddress=ipsCookieSecAddress, cpuUtilization=cpuUtilization, totalServers=totalServers, ipsHdrAclPort=ipsHdrAclPort, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpProxyOutBytes=httpProxyOutBytes, httpSrvrAddress=httpSrvrAddress, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsRCPort=ipsRCPort, sslSrvrNumConn=sslSrvrNumConn, ipsRCAddressType=ipsRCAddressType, ipsUrlAclAddress=ipsUrlAclAddress, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsHdrAclHits=ipsHdrAclHits, serverDown=serverDown, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsSMUserSessionTable=bwsSMUserSessionTable, sslSrvrInBytes=sslSrvrInBytes, srvcName=srvcName, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpProxyParseErr=httpProxyParseErr, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrAddress=sslSrvrAddress, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, raidDegrading=raidDegrading)
