...
Unsigned32, Counter32, Counter64, NotificationType, iso, ObjectIdentity, Gauge32, ModuleIdentity, MibIdentifier, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "Counter64", "NotificationType", "iso", "ObjectIdentity", "Gauge32", "ModuleIdentity", "MibIdentifier", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits")
...
mibBuilder.exportSymbols("BWS-MIB", ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, totalServers=totalServers, httpProxyClientAbrt=httpProxyClientAbrt, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsHdrAclAddress=ipsHdrAclAddress, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslProxyInBytes=sslProxyInBytes, bwsCompressionStatsEntry=bwsCompressionStatsEntry, raidDegrading=raidDegrading, sslProxyActiveConn=sslProxyActiveConn, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, dataPortLinkDown=dataPortLinkDown, webCacheBytesOut=webCacheBytesOut, httpSrvrAddress=httpSrvrAddress, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, smAgentName=smAgentName, ipsReqLimitPort=ipsReqLimitPort, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsReqLimitAddress=ipsReqLimitAddress, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, peerUp=peerUp, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrTotSuccess=sslSrvrTotSuccess, webCacheReq=webCacheReq, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpProxyActiveConn=httpProxyActiveConn, switchingToBypassMode=switchingToBypassMode, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslProxyCacheHits=sslProxyCacheHits, webCacheStale=webCacheStale, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, energizeUpdateExpire=energizeUpdateExpire, httpProxyServerReq=httpProxyServerReq, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslProxyBadDNCErr=sslProxyBadDNCErr, httpSrvrNumConn=httpSrvrNumConn, ipsRCTotServed=ipsRCTotServed, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslSrvrAddressType=sslSrvrAddressType, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslSrvrState=sslSrvrState, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, webCacheLongHdrs=webCacheLongHdrs, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsStatsGroup=bwsStatsGroup, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, fanDead=fanDead, sslSrvrInBytes=sslSrvrInBytes, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, webCacheAddress=webCacheAddress, sslSrvrOutBytes=sslSrvrOutBytes, httpProxyPort=httpProxyPort, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsHdrAclAddressType=ipsHdrAclAddressType, serverDown=serverDown, httpProxyWAFWarnings=httpProxyWAFWarnings, sslProxyErrPms=sslProxyErrPms, systemFanSpeed=systemFanSpeed, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, uptime=uptime, highAvailabilityStatus=highAvailabilityStatus, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsSMUserSessionTable=bwsSMUserSessionTable, switchingToMaintMode=switchingToMaintMode, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslProxyTotalReq=sslProxyTotalReq, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslSrvrTotResponse=sslSrvrTotResponse, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslProxyOutBytes=sslProxyOutBytes, bwsMessage=bwsMessage, ipsUrlNormPort=ipsUrlNormPort, sslProxyTotalConn=sslProxyTotalConn, ipsUrlAclReserved=ipsUrlAclReserved, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsCookieSecAddress=ipsCookieSecAddress, sslProxyCacheMiss=sslProxyCacheMiss, serviceStatus=serviceStatus, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, systemFailure=systemFailure, currentFirmwareVersion=currentFirmwareVersion, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, webCmprPort=webCmprPort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsAccessCtrlPort=ipsAccessCtrlPort, cpuUtilization=cpuUtilization, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslProxyCurrentConn=sslProxyCurrentConn, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, cpuFanSpeed=cpuFanSpeed, ipsRCAddressType=ipsRCAddressType, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsMIBGroups=bwsMIBGroups, bwsMIBCompliances=bwsMIBCompliances, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpSrvrMinResTime=httpSrvrMinResTime, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsUrlNormAddress=ipsUrlNormAddress, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpProxyUnknownRsp=httpProxyUnknownRsp, httpProxyServerErr=httpProxyServerErr, freeMem=freeMem, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, vipStatus=vipStatus, serviceAddress=serviceAddress, ipsRCTotQueued=ipsRCTotQueued, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, processCountHigh=processCountHigh, bwsSslProxyStatsTable=bwsSslProxyStatsTable, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslSrvrTotTimedout=sslSrvrTotTimedout, memoryUsageHigh=memoryUsageHigh, ipsHdrAclHits=ipsHdrAclHits, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrTotRefused=httpSrvrTotRefused, tempHigh=tempHigh, bwsMIBConformance=bwsMIBConformance, webCacheCacheableRes=webCacheCacheableRes, firmwareStorageHigh=firmwareStorageHigh, sslSrvrTotReqActive=sslSrvrTotReqActive, servicePort=servicePort, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, webCmprAddressType=webCmprAddressType, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpSrvrInBytes=httpSrvrInBytes, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsReqLimitAddressType=ipsReqLimitAddressType, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, tempCritical=tempCritical, totalAttacks=totalAttacks, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslSrvrNumConn=sslSrvrNumConn, serverUp=serverUp, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsMIBCompliance=bwsMIBCompliance, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, webCmprAddress=webCmprAddress, ipsRCTotDropped=ipsRCTotDropped, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, peerDown=peerDown, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, systemSerialNumber=systemSerialNumber, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, systemFailOver=systemFailOver, httpProxyOutBytes=httpProxyOutBytes, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, virusDefUpdates=virusDefUpdates, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrOutBytes=httpSrvrOutBytes, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslSrvrTotRefused=sslSrvrTotRefused, dataPortLinkUp=dataPortLinkUp, linkStatus=linkStatus, ipsWebAddrTransPort=ipsWebAddrTransPort, webCacheMiss=webCacheMiss, httpSrvrTotReqActive=httpSrvrTotReqActive, webCacheHits=webCacheHits, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, srvcName=srvcName, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, cpuTemperature=cpuTemperature, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, webCacheAddressType=webCacheAddressType, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpProxyServerAbrt=httpProxyServerAbrt, bwsTrapGroup=bwsTrapGroup, logStorageHigh=logStorageHigh, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwstraps=bwstraps, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslProxyAddressType=sslProxyAddressType, ipsReqSrvcPort=ipsReqSrvcPort, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, logStorage=logStorage, httpProxyInBytes=httpProxyInBytes, bwsStats=bwsStats, httpSrvrAvgResTime=httpSrvrAvgResTime, smRealmName=smRealmName, operationalMode=operationalMode, httpProxyTotalConn=httpProxyTotalConn, sslSrvrMinResTime=sslSrvrMinResTime, ipsRCAddress=ipsRCAddress, httpSrvrTotReqRejected=httpSrvrTotReqRejected, totalBandwidth=totalBandwidth, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpProxyAddressType=httpProxyAddressType, serviceName=serviceName, sslProxyAddress=sslProxyAddress, activeServers=activeServers, httpProxyParseErr=httpProxyParseErr, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslSrvrSrvcAddress=sslSrvrSrvcAddress)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, newAttackDefinitionInstalled=newAttackDefinitionInstalled, smNumUserSessions=smNumUserSessions, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, webCmprProtocol=webCmprProtocol, systemLoad=systemLoad, httpProxyAddress=httpProxyAddress, totalApplications=totalApplications, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, PYSNMP_MODULE_ID=bws, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsServiceStatusTable=bwsServiceStatusTable, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsHdrAclPort=ipsHdrAclPort, ipsReqSrvcAddress=ipsReqSrvcAddress, memUtilization=memUtilization, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, firmwareStorage=firmwareStorage, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, switchingToInlineMode=switchingToInlineMode, bws=bws, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpSrvrAddressType=httpSrvrAddressType, securityDefUpdates=securityDefUpdates, sslSrvrPort=sslSrvrPort, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sharedSecretKeyExpired=sharedSecretKeyExpired, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, webCacheProtocol=webCacheProtocol, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsRCTimeStamp=ipsRCTimeStamp, totalMem=totalMem, ipsUrlAclAddress=ipsUrlAclAddress, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsCacheStatsTable=bwsCacheStatsTable, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpProxyTotalReq=httpProxyTotalReq, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsCookieSecPort=ipsCookieSecPort, activeApplications=activeApplications, webCachePort=webCachePort, sslSrvrAddress=sslSrvrAddress, ipsRCPort=ipsRCPort, webCacheCachedObjects=webCacheCachedObjects, httpSrvrPort=httpSrvrPort, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsUrlPolicyPort=ipsUrlPolicyPort, sslProxyPort=sslProxyPort, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, dataPathStatus=dataPathStatus, httpSrvrState=httpSrvrState, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsUrlAclPort=ipsUrlAclPort, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry)
