...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, Gauge32, Unsigned32, TimeTicks, ModuleIdentity, Counter32, MibIdentifier, Bits, NotificationType, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "Gauge32", "Unsigned32", "TimeTicks", "ModuleIdentity", "Counter32", "MibIdentifier", "Bits", "NotificationType", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("BWS-MIB", httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpProxyPort=httpProxyPort, logStorage=logStorage, bwsServiceStatusTable=bwsServiceStatusTable, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, raidDegrading=raidDegrading, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsStatsGroup=bwsStatsGroup, bwsServiceStatusEntry=bwsServiceStatusEntry, totalAttacks=totalAttacks, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsSslProxyStatsTable=bwsSslProxyStatsTable, smAgentName=smAgentName, ipsCookieSecPort=ipsCookieSecPort, httpSrvrState=httpSrvrState, freeMem=freeMem, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsReqLimitAddress=ipsReqLimitAddress, ipsReqSrvcAddressType=ipsReqSrvcAddressType, systemFailOver=systemFailOver, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, systemFailure=systemFailure, webCacheProtocol=webCacheProtocol, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpSrvrTotResponse=httpSrvrTotResponse, cpuFanSpeed=cpuFanSpeed, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, currentFirmwareVersion=currentFirmwareVersion, httpProxyAddressType=httpProxyAddressType, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, operationalMode=operationalMode, ipsCookieSecAddress=ipsCookieSecAddress, httpSrvrOutBytes=httpSrvrOutBytes, switchingToInlineMode=switchingToInlineMode, webCacheHits=webCacheHits, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, systemSerialNumber=systemSerialNumber, srvcName=srvcName, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, webCacheBytesOut=webCacheBytesOut, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, logStorageHigh=logStorageHigh, bwsCompressionStatsTable=bwsCompressionStatsTable, activeApplications=activeApplications, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsCookieSecTampered=ipsCookieSecTampered, switchingToBypassMode=switchingToBypassMode, bwsMessage=bwsMessage, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sharedSecretKeyExpired=sharedSecretKeyExpired, servicePort=servicePort, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsCacheStatsEntry=bwsCacheStatsEntry, sslProxyCurrentConn=sslProxyCurrentConn, sslProxyInBytes=sslProxyInBytes, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrTotRefused=sslSrvrTotRefused, webCacheAddressType=webCacheAddressType, ipsUrlAclReserved=ipsUrlAclReserved, bwsCacheStatsTable=bwsCacheStatsTable, systemFanSpeed=systemFanSpeed, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, memUtilization=memUtilization, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, dataPortLinkDown=dataPortLinkDown, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, webCmprPort=webCmprPort, sslProxyErrPms=sslProxyErrPms, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, peerDown=peerDown, httpSrvrInBytes=httpSrvrInBytes, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, virusDefUpdates=virusDefUpdates, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpProxyUnknownRsp=httpProxyUnknownRsp, webCmprCompressedDataSize=webCmprCompressedDataSize, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrTotSuccess=httpSrvrTotSuccess, httpProxyAddress=httpProxyAddress, ipsRCTotDropped=ipsRCTotDropped, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslSrvrAddressType=sslSrvrAddressType, sslProxyCacheMiss=sslProxyCacheMiss, bwsCompressionStatsEntry=bwsCompressionStatsEntry, webCacheReq=webCacheReq, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpProxyActiveConn=httpProxyActiveConn, sslProxyPort=sslProxyPort, cpuTemperature=cpuTemperature, bwsStats=bwsStats, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsReqLimitAddressType=ipsReqLimitAddressType, webCacheStale=webCacheStale, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsRCAddressType=ipsRCAddressType, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, energizeUpdateExpire=energizeUpdateExpire, sslProxyTotalConn=sslProxyTotalConn, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslProxyAddressType=sslProxyAddressType, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, serviceStatus=serviceStatus, webCmprAddressType=webCmprAddressType, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpProxyOutBytes=httpProxyOutBytes, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslSrvrInBytes=sslSrvrInBytes, bwstraps=bwstraps, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsAccessCtrlAddress=ipsAccessCtrlAddress, webCmprProtocol=webCmprProtocol, ipsRCTimeStamp=ipsRCTimeStamp, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsRCAddress=ipsRCAddress, firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, dataPortLinkUp=dataPortLinkUp, webCmprAddress=webCmprAddress, ipsUrlAclPort=ipsUrlAclPort, sslSrvrTotTimedout=sslSrvrTotTimedout, sslProxyOutBytes=sslProxyOutBytes, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, smRealmName=smRealmName, httpSrvrSrvcPort=httpSrvrSrvcPort, httpSrvrTotReqActive=httpSrvrTotReqActive, httpSrvrTotTimedout=httpSrvrTotTimedout, serviceAddress=serviceAddress, tempHigh=tempHigh, webCacheMiss=webCacheMiss, sslProxyAddress=sslProxyAddress, ipsReqLimitPort=ipsReqLimitPort, firmwareStorage=firmwareStorage, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslSrvrPort=sslSrvrPort, httpSrvrAddress=httpSrvrAddress, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlPolicyPort=ipsUrlPolicyPort, processCountHigh=processCountHigh, httpProxyServerErr=httpProxyServerErr, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, totalMem=totalMem, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslSrvrMinResTime=sslSrvrMinResTime, bwsTrapGroup=bwsTrapGroup, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, fanDead=fanDead, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bws=bws, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, webCacheLongHdrs=webCacheLongHdrs, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslProxyCacheHits=sslProxyCacheHits, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslSrvrSrvcPort=sslSrvrSrvcPort, httpProxyTotalReq=httpProxyTotalReq, systemLoad=systemLoad, httpProxyTotalConn=httpProxyTotalConn, sslProxyFullHandshakes=sslProxyFullHandshakes, tempCritical=tempCritical, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpSrvrPort=httpSrvrPort, bwsMIBGroups=bwsMIBGroups, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsMIBCompliances=bwsMIBCompliances, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsIpsRCStatsTable=bwsIpsRCStatsTable, memoryUsageHigh=memoryUsageHigh, httpSrvrTotRefused=httpSrvrTotRefused, highAvailabilityStatus=highAvailabilityStatus, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsHdrAclPort=ipsHdrAclPort, bwsMIBCompliance=bwsMIBCompliance, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, webCacheCacheableRes=webCacheCacheableRes, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpSrvrMinResTime=httpSrvrMinResTime, switchingToMaintMode=switchingToMaintMode, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslProxyActiveConn=sslProxyActiveConn, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, totalApplications=totalApplications, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsCookieSecAddressType=ipsCookieSecAddressType, PYSNMP_MODULE_ID=bws, uptime=uptime, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsUrlAclAddress=ipsUrlAclAddress, httpProxyInBytes=httpProxyInBytes, sslSrvrAddress=sslSrvrAddress, webCachePort=webCachePort, serverDown=serverDown, httpSrvrAddressType=httpSrvrAddressType, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq)
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, linkStatus=linkStatus, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsRCTotQueued=ipsRCTotQueued, totalBandwidth=totalBandwidth, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsUrlNormAddress=ipsUrlNormAddress, ipsReqSrvcAddress=ipsReqSrvcAddress, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpProxyWAFWarnings=httpProxyWAFWarnings, vipStatus=vipStatus, ipsHdrAclAddress=ipsHdrAclAddress, smNumUserSessions=smNumUserSessions, dataPathStatus=dataPathStatus, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, securityDefUpdates=securityDefUpdates, bwsMIBConformance=bwsMIBConformance, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, webCacheCachedObjects=webCacheCachedObjects, firmwareStorageHigh=firmwareStorageHigh, serverUp=serverUp, activeServers=activeServers, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, webCacheAddress=webCacheAddress, cpuUtilization=cpuUtilization, httpProxyClientAbrt=httpProxyClientAbrt, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrMaxResTime=httpSrvrMaxResTime, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsHdrAclHits=ipsHdrAclHits, ipsRCTotServed=ipsRCTotServed, bwsSMUserSessionTable=bwsSMUserSessionTable, peerUp=peerUp, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpProxyServerAbrt=httpProxyServerAbrt, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslSrvrTotResponse=sslSrvrTotResponse, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpProxyParseErr=httpProxyParseErr, sslProxyTotalReq=sslProxyTotalReq, httpSrvrNumConn=httpSrvrNumConn, totalServers=totalServers, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlNormPort=ipsUrlNormPort, ipsUrlAclAddressType=ipsUrlAclAddressType, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsRCPort=ipsRCPort, serviceName=serviceName, ipsReqSrvcPort=ipsReqSrvcPort, httpProxyServerReq=httpProxyServerReq, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslSrvrNumConn=sslSrvrNumConn, sslSrvrState=sslSrvrState, sslSrvrOutBytes=sslSrvrOutBytes)
