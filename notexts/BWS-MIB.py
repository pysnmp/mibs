...
Counter64, Counter32, ModuleIdentity, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, MibIdentifier, Gauge32, Integer32, ObjectIdentity, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Counter32", "ModuleIdentity", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "MibIdentifier", "Gauge32", "Integer32", "ObjectIdentity", "Bits", "Unsigned32")
...
mibBuilder.exportSymbols("BWS-MIB", bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpProxyPort=httpProxyPort, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bws=bws, ipsAccessCtrlAddress=ipsAccessCtrlAddress, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, firmwareStorage=firmwareStorage, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpSrvrAddress=httpSrvrAddress, bwstraps=bwstraps, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, webCacheCachedObjects=webCacheCachedObjects, httpProxyParseErr=httpProxyParseErr, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpProxyActiveConn=httpProxyActiveConn, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, webCacheReq=webCacheReq, sslProxyFullHandshakes=sslProxyFullHandshakes, sslSrvrNumFreeConn=sslSrvrNumFreeConn, logStorageHigh=logStorageHigh, raidDegrading=raidDegrading, ipsUrlAclAddressType=ipsUrlAclAddressType, httpProxyWAFWarnings=httpProxyWAFWarnings, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, webCacheMiss=webCacheMiss, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpSrvrAddressType=httpSrvrAddressType, ipsRCTotDropped=ipsRCTotDropped, httpProxyInBytes=httpProxyInBytes, bwsMIBCompliances=bwsMIBCompliances, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsReqSrvcPort=ipsReqSrvcPort, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, webCacheBytesOut=webCacheBytesOut, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlNormAddressType=ipsUrlNormAddressType, httpProxyTotalConn=httpProxyTotalConn, activeApplications=activeApplications, ipsCookieSecAddressType=ipsCookieSecAddressType, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslProxyErrPms=sslProxyErrPms, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, totalApplications=totalApplications, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, webCmprPort=webCmprPort, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslSrvrAddress=sslSrvrAddress, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, fanDead=fanDead, ipsRCPort=ipsRCPort, httpProxyAddress=httpProxyAddress, bwsTrapGroup=bwsTrapGroup, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, webCachePort=webCachePort, sslProxyTotalConn=sslProxyTotalConn, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslSrvrAvgResTime=sslSrvrAvgResTime, highAvailabilityStatus=highAvailabilityStatus, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslProxyTotalReq=sslProxyTotalReq, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsUrlAclReserved=ipsUrlAclReserved, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsHdrAclHits=ipsHdrAclHits, ipsReqLimitAddressType=ipsReqLimitAddressType, totalMem=totalMem, ipsUrlAclPort=ipsUrlAclPort, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslSrvrMaxResTime=sslSrvrMaxResTime, operationalMode=operationalMode, virusDefUpdates=virusDefUpdates, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, webCacheAddressType=webCacheAddressType, sslSrvrTotSuccess=sslSrvrTotSuccess, PYSNMP_MODULE_ID=bws, logStorage=logStorage, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, cpuTemperature=cpuTemperature, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, serverDown=serverDown, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsMessage=bwsMessage, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrTotTimedout=httpSrvrTotTimedout, webCacheHits=webCacheHits, systemFailure=systemFailure, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpSrvrTotResponse=httpSrvrTotResponse, peerUp=peerUp, bwsStats=bwsStats, systemFanSpeed=systemFanSpeed, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, processCountHigh=processCountHigh, httpSrvrNumConn=httpSrvrNumConn, ipsHdrAclPort=ipsHdrAclPort, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, securityDefUpdates=securityDefUpdates, systemLoad=systemLoad, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpSrvrOutBytes=httpSrvrOutBytes, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrTotReqRejected=sslSrvrTotReqRejected, srvcName=srvcName, ipsReqSrvcAddressType=ipsReqSrvcAddressType, memUtilization=memUtilization, servicePort=servicePort, totalBandwidth=totalBandwidth, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsUrlAclAddress=ipsUrlAclAddress, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, activeServers=activeServers, sslProxyAddressType=sslProxyAddressType, httpProxyServerErr=httpProxyServerErr, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsUrlNormPort=ipsUrlNormPort, bwsIpsRCStatsTable=bwsIpsRCStatsTable, webCacheProtocol=webCacheProtocol, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, smNumUserSessions=smNumUserSessions, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsCookieSecPort=ipsCookieSecPort, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslSrvrSrvcPort=sslSrvrSrvcPort, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrState=httpSrvrState, bwsCacheStatsEntry=bwsCacheStatsEntry, peerDown=peerDown, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, energizeUpdateExpire=energizeUpdateExpire, serverUp=serverUp, switchingToInlineMode=switchingToInlineMode, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsHdrAclAddressType=ipsHdrAclAddressType, webCacheAddress=webCacheAddress, sslProxyCacheMiss=sslProxyCacheMiss, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpProxyServerAbrt=httpProxyServerAbrt, httpProxyOutBytes=httpProxyOutBytes, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsReqLimitPort=ipsReqLimitPort, ipsRCTimeStamp=ipsRCTimeStamp, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, totalServers=totalServers, ipsUrlNormAddress=ipsUrlNormAddress, dataPortLinkUp=dataPortLinkUp, sslSrvrPort=sslSrvrPort, bwsMIBGroups=bwsMIBGroups, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslSrvrTotRefused=sslSrvrTotRefused, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsCookieSecTampered=ipsCookieSecTampered, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpProxyServerReq=httpProxyServerReq, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsLrnSrvcPort=ipsLrnSrvcPort, sslSrvrInBytes=sslSrvrInBytes, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslProxyPort=sslProxyPort, webCmprAddress=webCmprAddress, ipsRCTotQueued=ipsRCTotQueued, webCacheLongHdrs=webCacheLongHdrs, sslSrvrNumConn=sslSrvrNumConn, cpuFanSpeed=cpuFanSpeed, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrInBytes=httpSrvrInBytes, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsServiceStatusEntry=bwsServiceStatusEntry, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpProxyTotalReq=httpProxyTotalReq, uptime=uptime, httpProxyAddressType=httpProxyAddressType, tempHigh=tempHigh, dataPortLinkDown=dataPortLinkDown, firmwareStorageHigh=firmwareStorageHigh, bwsMIBConformance=bwsMIBConformance, totalAttacks=totalAttacks, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, smRealmName=smRealmName, ipsCookieSecAddress=ipsCookieSecAddress, bwsServiceStatusTable=bwsServiceStatusTable, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpProxyClientAbrt=httpProxyClientAbrt, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, linkStatus=linkStatus, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsStatsGroup=bwsStatsGroup, switchingToBypassMode=switchingToBypassMode, webCmprProtocol=webCmprProtocol, sslSrvrState=sslSrvrState, tempCritical=tempCritical, ipsRCAddress=ipsRCAddress, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslProxyBadCRLErr=sslProxyBadCRLErr, sslProxyAddress=sslProxyAddress, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType)
mibBuilder.exportSymbols("BWS-MIB", httpProxyUnknownRsp=httpProxyUnknownRsp, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslSrvrTotResponse=sslSrvrTotResponse, sslProxyInBytes=sslProxyInBytes, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrOutBytes=sslSrvrOutBytes, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslProxyActiveConn=sslProxyActiveConn, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, switchingToMaintMode=switchingToMaintMode, systemSerialNumber=systemSerialNumber, bwsMIBCompliance=bwsMIBCompliance, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, systemFailOver=systemFailOver, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslSrvrAddressType=sslSrvrAddressType, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpSrvrTotRefused=httpSrvrTotRefused, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrMinResTime=httpSrvrMinResTime, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsRCTotServed=ipsRCTotServed, smAgentName=smAgentName, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, webCmprAddressType=webCmprAddressType, webCacheCacheableRes=webCacheCacheableRes, webCacheStale=webCacheStale, vipStatus=vipStatus, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrMinResTime=sslSrvrMinResTime, ipsHdrAclAddress=ipsHdrAclAddress, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsUrlPolicyAddress=ipsUrlPolicyAddress, serviceName=serviceName, ipsRCAddressType=ipsRCAddressType, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsCacheStatsTable=bwsCacheStatsTable, currentFirmwareVersion=currentFirmwareVersion, serviceAddress=serviceAddress, dataPathStatus=dataPathStatus, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslProxyOutBytes=sslProxyOutBytes, memoryUsageHigh=memoryUsageHigh, httpSrvrPort=httpSrvrPort, ipsReqLimitAddress=ipsReqLimitAddress, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslProxyCacheHits=sslProxyCacheHits, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, cpuUtilization=cpuUtilization, webCmprCompressedDataSize=webCmprCompressedDataSize, freeMem=freeMem, serviceStatus=serviceStatus, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted)
