...
Integer32, iso, MibIdentifier, Gauge32, IpAddress, Counter32, Unsigned32, NotificationType, Counter64, ModuleIdentity, Bits, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "MibIdentifier", "Gauge32", "IpAddress", "Counter32", "Unsigned32", "NotificationType", "Counter64", "ModuleIdentity", "Bits", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("BWS-MIB", memoryUsageHigh=memoryUsageHigh, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, totalServers=totalServers, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, highAvailabilityStatus=highAvailabilityStatus, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslProxyInBytes=sslProxyInBytes, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, serverUp=serverUp, virusDefUpdates=virusDefUpdates, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsUrlNormAddress=ipsUrlNormAddress, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsRCTotServed=ipsRCTotServed, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, systemLoad=systemLoad, serverDown=serverDown, linkStatus=linkStatus, webCachePort=webCachePort, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrAddressType=httpSrvrAddressType, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpSrvrMinResTime=httpSrvrMinResTime, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpProxyParseErr=httpProxyParseErr, httpProxyUnknownRsp=httpProxyUnknownRsp, cpuUtilization=cpuUtilization, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsAccessCtrlPort=ipsAccessCtrlPort, httpProxyServerAbrt=httpProxyServerAbrt, httpSrvrTotRefused=httpSrvrTotRefused, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, cpuTemperature=cpuTemperature, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsReqSrvcAddressType=ipsReqSrvcAddressType, serviceStatus=serviceStatus, ipsRCTimeStamp=ipsRCTimeStamp, bwsCacheStatsTable=bwsCacheStatsTable, tempCritical=tempCritical, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpSrvrState=httpSrvrState, ipsCookieSecPort=ipsCookieSecPort, firmwareStorage=firmwareStorage, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, webCacheMiss=webCacheMiss, webCmprProtocol=webCmprProtocol, webCacheProtocol=webCacheProtocol, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, totalBandwidth=totalBandwidth, bws=bws, sslProxyBadCRLErr=sslProxyBadCRLErr, webCacheCachedObjects=webCacheCachedObjects, sslProxyTotalConn=sslProxyTotalConn, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslProxyPort=sslProxyPort, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsMessage=bwsMessage, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, smAgentName=smAgentName, bwsTrapGroup=bwsTrapGroup, energizeUpdateExpire=energizeUpdateExpire, httpSrvrTotSuccess=httpSrvrTotSuccess, systemSerialNumber=systemSerialNumber, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslProxyCurrentConn=sslProxyCurrentConn, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsRCPort=ipsRCPort, bwsMIBCompliance=bwsMIBCompliance, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpProxyPort=httpProxyPort, httpSrvrInBytes=httpSrvrInBytes, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslSrvrMaxResTime=sslSrvrMaxResTime, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, peerDown=peerDown, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsCookieSecAddress=ipsCookieSecAddress, cpuFanSpeed=cpuFanSpeed, ipsUrlAclAddressType=ipsUrlAclAddressType, webCmprPort=webCmprPort, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsStats=bwsStats, freeMem=freeMem, smNumUserSessions=smNumUserSessions, logStorageHigh=logStorageHigh, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, totalMem=totalMem, webCmprAddressType=webCmprAddressType, sslSrvrTotSuccess=sslSrvrTotSuccess, httpSrvrAddress=httpSrvrAddress, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, tempHigh=tempHigh, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, PYSNMP_MODULE_ID=bws, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, processCountHigh=processCountHigh, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsCookieSecTampered=ipsCookieSecTampered, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsReqSrvcPort=ipsReqSrvcPort, bwsCacheStatsEntry=bwsCacheStatsEntry, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsRCTotQueued=ipsRCTotQueued, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, webCacheAddress=webCacheAddress, peerUp=peerUp, ipsHdrAclPort=ipsHdrAclPort, bwsStatsGroup=bwsStatsGroup, switchingToInlineMode=switchingToInlineMode, webCmprAddress=webCmprAddress, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, raidDegrading=raidDegrading, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpProxyServerErr=httpProxyServerErr, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, switchingToBypassMode=switchingToBypassMode, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwstraps=bwstraps, sslSrvrState=sslSrvrState, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlAclPort=ipsUrlAclPort, httpProxyTotalReq=httpProxyTotalReq, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslSrvrAvgResTime=sslSrvrAvgResTime, sslSrvrTotReqActive=sslSrvrTotReqActive, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpSrvrPort=httpSrvrPort, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsUrlAclReserved=ipsUrlAclReserved, ipsReqLimitPort=ipsReqLimitPort, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslSrvrNumConn=sslSrvrNumConn, sslProxyCacheMiss=sslProxyCacheMiss, operationalMode=operationalMode, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsMIBCompliances=bwsMIBCompliances, ipsHdrAclHits=ipsHdrAclHits, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsRCTotDropped=ipsRCTotDropped, webCacheStale=webCacheStale, sslSrvrAddress=sslSrvrAddress, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslSrvrOutBytes=sslSrvrOutBytes, sslProxyErrPms=sslProxyErrPms, memUtilization=memUtilization, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpSrvrNumConn=httpSrvrNumConn, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, srvcName=srvcName, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsRCAddressType=ipsRCAddressType, sslProxyOutBytes=sslProxyOutBytes, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, firmwareUpdateAvailable=firmwareUpdateAvailable, sslSrvrTotRefused=sslSrvrTotRefused, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, webCacheHits=webCacheHits, uptime=uptime, httpProxyInBytes=httpProxyInBytes, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslProxyAddressType=sslProxyAddressType, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpProxyActiveConn=httpProxyActiveConn, webCacheCacheableRes=webCacheCacheableRes, vipStatus=vipStatus, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsHdrAclAddressType=ipsHdrAclAddressType, sslSrvrInBytes=sslSrvrInBytes, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, smRealmName=smRealmName, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, serviceName=serviceName, activeServers=activeServers, dataPortLinkUp=dataPortLinkUp, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsUrlPolicyPort=ipsUrlPolicyPort, httpProxySessionTimeOut=httpProxySessionTimeOut, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, fanDead=fanDead, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrTotResponse=httpSrvrTotResponse, firmwareStorageHigh=firmwareStorageHigh, httpProxyAddress=httpProxyAddress, httpProxyServerReq=httpProxyServerReq, activeApplications=activeApplications, ipsUrlNormPort=ipsUrlNormPort, dataPortLinkDown=dataPortLinkDown, sslProxyTotalReq=sslProxyTotalReq, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsRCAddress=ipsRCAddress, webCacheLongHdrs=webCacheLongHdrs, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, webCacheBytesOut=webCacheBytesOut, sslProxyActiveConn=sslProxyActiveConn, dataPathStatus=dataPathStatus, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled)
mibBuilder.exportSymbols("BWS-MIB", sharedSecretKeyExpired=sharedSecretKeyExpired, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsReqLimitAddress=ipsReqLimitAddress, sslSrvrAddressType=sslSrvrAddressType, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsMIBGroups=bwsMIBGroups, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpProxyClientAbrt=httpProxyClientAbrt, totalAttacks=totalAttacks, httpSrvrOutBytes=httpSrvrOutBytes, currentFirmwareVersion=currentFirmwareVersion, ipsCookieSecAddressType=ipsCookieSecAddressType, switchingToMaintMode=switchingToMaintMode, sslProxyAddress=sslProxyAddress, securityDefUpdates=securityDefUpdates, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsAccessCtrlAddress=ipsAccessCtrlAddress, servicePort=servicePort, httpProxyOutBytes=httpProxyOutBytes, sslSrvrTotResponse=sslSrvrTotResponse, systemFailure=systemFailure, httpProxyTotalConn=httpProxyTotalConn, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsUrlNormAddressType=ipsUrlNormAddressType, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, systemFanSpeed=systemFanSpeed, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsServiceStatusTable=bwsServiceStatusTable, ipsHdrAclAddress=ipsHdrAclAddress, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, totalApplications=totalApplications, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslProxyCacheHits=sslProxyCacheHits, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsCompressionStatsEntry=bwsCompressionStatsEntry, logStorage=logStorage, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslSrvrPort=sslSrvrPort, bwsMIBConformance=bwsMIBConformance, httpProxyAddressType=httpProxyAddressType, webCacheAddressType=webCacheAddressType, systemFailOver=systemFailOver, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, serviceAddress=serviceAddress, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, webCacheReq=webCacheReq, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrMinResTime=sslSrvrMinResTime)
