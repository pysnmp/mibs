...
ModuleIdentity, Counter64, Integer32, iso, ObjectIdentity, Unsigned32, TimeTicks, Gauge32, MibIdentifier, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Integer32", "iso", "ObjectIdentity", "Unsigned32", "TimeTicks", "Gauge32", "MibIdentifier", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("BWS-MIB", webCacheMiss=webCacheMiss, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsMIBCompliances=bwsMIBCompliances, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpProxyPort=httpProxyPort, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpProxyAddressType=httpProxyAddressType, sslSrvrState=sslSrvrState, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsLrnSrvcAddress=ipsLrnSrvcAddress, switchingToMaintMode=switchingToMaintMode, serviceAddress=serviceAddress, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, webCacheAddress=webCacheAddress, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, processCountHigh=processCountHigh, httpSrvrTotReqActive=httpSrvrTotReqActive, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, vipStatus=vipStatus, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsTrapGroup=bwsTrapGroup, ipsUrlPolicyPort=ipsUrlPolicyPort, webCacheLongHdrs=webCacheLongHdrs, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslProxyActiveConn=sslProxyActiveConn, httpSrvrTotRefused=httpSrvrTotRefused, totalApplications=totalApplications, httpSrvrMaxResTime=httpSrvrMaxResTime, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsStatsGroup=bwsStatsGroup, sslProxyCacheHits=sslProxyCacheHits, switchingToInlineMode=switchingToInlineMode, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrTotResponse=httpSrvrTotResponse, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslProxyCacheTimeouts=sslProxyCacheTimeouts, cpuFanSpeed=cpuFanSpeed, sslProxyCacheMiss=sslProxyCacheMiss, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, firmwareStorageHigh=firmwareStorageHigh, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrOutBytes=httpSrvrOutBytes, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsUrlAclReserved=ipsUrlAclReserved, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslProxyAddress=sslProxyAddress, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, srvcName=srvcName, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsUrlPolicyAddress=ipsUrlPolicyAddress, dataPortLinkDown=dataPortLinkDown, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslSrvrPort=sslSrvrPort, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsHdrAclPort=ipsHdrAclPort, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslProxyOutBytes=sslProxyOutBytes, PYSNMP_MODULE_ID=bws, systemFailOver=systemFailOver, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, peerUp=peerUp, sslSrvrTotRefused=sslSrvrTotRefused, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, serverUp=serverUp, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsRCTotDropped=ipsRCTotDropped, httpProxyParseErr=httpProxyParseErr, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, switchingToBypassMode=switchingToBypassMode, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, tempCritical=tempCritical, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsServiceStatusEntry=bwsServiceStatusEntry, firmwareStorage=firmwareStorage, httpSrvrMinResTime=httpSrvrMinResTime, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsSslProxyStatsTable=bwsSslProxyStatsTable, memUtilization=memUtilization, httpProxyServerErr=httpProxyServerErr, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsHdrAclHits=ipsHdrAclHits, httpProxyServerReq=httpProxyServerReq, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrTotResponse=sslSrvrTotResponse, energizeUpdateExpire=energizeUpdateExpire, httpProxyTotalConn=httpProxyTotalConn, serviceStatus=serviceStatus, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, webCmprAddressType=webCmprAddressType, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, activeServers=activeServers, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsUrlAclPort=ipsUrlAclPort, webCacheProtocol=webCacheProtocol, webCmprPort=webCmprPort, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsRCTotServed=ipsRCTotServed, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpSrvrPort=httpSrvrPort, securityDefUpdates=securityDefUpdates, sslProxyPort=sslProxyPort, sslSrvrSrvcAddress=sslSrvrSrvcAddress, highAvailabilityStatus=highAvailabilityStatus, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, totalServers=totalServers, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, webCacheAddressType=webCacheAddressType, webCacheCachedObjects=webCacheCachedObjects, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, newAttackDefinitionInstalled=newAttackDefinitionInstalled, totalMem=totalMem, ipsRCAddressType=ipsRCAddressType, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsRCPort=ipsRCPort, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, webCacheCacheableRes=webCacheCacheableRes, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrAddress=sslSrvrAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsMIBConformance=bwsMIBConformance, serverDown=serverDown, webCmprProtocol=webCmprProtocol, fanDead=fanDead, systemFanSpeed=systemFanSpeed, sslSrvrInBytes=sslSrvrInBytes, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, webCmprAddress=webCmprAddress, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslProxyTotalConn=sslProxyTotalConn, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bws=bws, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsRCTotQueued=ipsRCTotQueued, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpProxyOutBytes=httpProxyOutBytes, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpSrvrState=httpSrvrState, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsMIBGroups=bwsMIBGroups, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, uptime=uptime, ipsUrlNormPort=ipsUrlNormPort, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsCacheStatsTable=bwsCacheStatsTable, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, systemLoad=systemLoad, smAgentName=smAgentName, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, activeApplications=activeApplications, webCachePort=webCachePort, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, webCacheHits=webCacheHits, cpuUtilization=cpuUtilization, memoryUsageHigh=memoryUsageHigh, peerDown=peerDown, cpuTemperature=cpuTemperature, ipsCookieSecAddressType=ipsCookieSecAddressType, bwstraps=bwstraps, dataPathStatus=dataPathStatus, ipsCookieSecPort=ipsCookieSecPort, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslProxyCurrentConn=sslProxyCurrentConn, servicePort=servicePort, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, logStorage=logStorage, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsUrlAclAddress=ipsUrlAclAddress, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpProxyActiveConn=httpProxyActiveConn, raidDegrading=raidDegrading, httpSrvrAddress=httpSrvrAddress, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsAccessCtrlPort=ipsAccessCtrlPort, linkStatus=linkStatus, httpSrvrAddressType=httpSrvrAddressType, ipsReqLimitAddress=ipsReqLimitAddress, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrNumConn=sslSrvrNumConn, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn)
mibBuilder.exportSymbols("BWS-MIB", bwsServiceStatusTable=bwsServiceStatusTable, smRealmName=smRealmName, currentFirmwareVersion=currentFirmwareVersion, sslProxyInBytes=sslProxyInBytes, operationalMode=operationalMode, systemSerialNumber=systemSerialNumber, sslProxyErrPms=sslProxyErrPms, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsReqLimitPort=ipsReqLimitPort, ipsReqSrvcPort=ipsReqSrvcPort, webCacheStale=webCacheStale, sslSrvrTotSuccess=sslSrvrTotSuccess, httpProxyAddress=httpProxyAddress, bwsMIBCompliance=bwsMIBCompliance, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrTotReqActive=sslSrvrTotReqActive, webCacheBytesOut=webCacheBytesOut, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsRCAddress=ipsRCAddress, sslProxyAddressType=sslProxyAddressType, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpProxyServerAbrt=httpProxyServerAbrt, totalAttacks=totalAttacks, logStorageHigh=logStorageHigh, virusDefUpdates=virusDefUpdates, smNumUserSessions=smNumUserSessions, httpSrvrInBytes=httpSrvrInBytes, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlAclAddressType=ipsUrlAclAddressType, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsCookieSecTampered=ipsCookieSecTampered, webCacheReq=webCacheReq, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, dataPortLinkUp=dataPortLinkUp, httpProxyClientAbrt=httpProxyClientAbrt, systemFailure=systemFailure, bwsMessage=bwsMessage, freeMem=freeMem, ipsRCTimeStamp=ipsRCTimeStamp, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, tempHigh=tempHigh, httpProxyInBytes=httpProxyInBytes, sslSrvrAddressType=sslSrvrAddressType, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrOutBytes=sslSrvrOutBytes, totalBandwidth=totalBandwidth, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, serviceName=serviceName, bwsStats=bwsStats, sslProxyTotalReq=sslProxyTotalReq, httpSrvrNumConn=httpSrvrNumConn, ipsCookieSecAddress=ipsCookieSecAddress, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpProxyTotalReq=httpProxyTotalReq, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsHdrAclAddress=ipsHdrAclAddress, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr)
