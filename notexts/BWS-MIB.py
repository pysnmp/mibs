...
NotificationType, IpAddress, Gauge32, Counter32, Counter64, iso, Bits, MibIdentifier, TimeTicks, ObjectIdentity, ModuleIdentity, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "Gauge32", "Counter32", "Counter64", "iso", "Bits", "MibIdentifier", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("BWS-MIB", systemSerialNumber=systemSerialNumber, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, energizeUpdateExpire=energizeUpdateExpire, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, webCmprProtocol=webCmprProtocol, serverDown=serverDown, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslProxyInBytes=sslProxyInBytes, memoryUsageHigh=memoryUsageHigh, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpProxyOutBytes=httpProxyOutBytes, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlAclPort=ipsUrlAclPort, systemFailOver=systemFailOver, cpuTemperature=cpuTemperature, fanDead=fanDead, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsHdrAclAddressType=ipsHdrAclAddressType, httpSrvrInBytes=httpSrvrInBytes, bwsStats=bwsStats, sslProxyOutBytes=sslProxyOutBytes, bwsServiceStatusTable=bwsServiceStatusTable, httpProxyClientAbrt=httpProxyClientAbrt, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, webCacheStale=webCacheStale, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsTrapGroup=bwsTrapGroup, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, serverUp=serverUp, bwsCompressionStatsTable=bwsCompressionStatsTable, httpProxyTotalReq=httpProxyTotalReq, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, firmwareStorageHigh=firmwareStorageHigh, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslProxyBadCRLErr=sslProxyBadCRLErr, sslProxyActiveConn=sslProxyActiveConn, sslProxyCacheHits=sslProxyCacheHits, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrInBytes=sslSrvrInBytes, raidDegrading=raidDegrading, ipsRCTimeStamp=ipsRCTimeStamp, sslSrvrAvgResTime=sslSrvrAvgResTime, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsMIBCompliance=bwsMIBCompliance, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, peerDown=peerDown, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsRCAddress=ipsRCAddress, sslProxyAddressType=sslProxyAddressType, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpSrvrAvgResTime=httpSrvrAvgResTime, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, securityDefUpdates=securityDefUpdates, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrTotRefused=sslSrvrTotRefused, ipsRCTotQueued=ipsRCTotQueued, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, tempHigh=tempHigh, sslProxyBadDNCErr=sslProxyBadDNCErr, httpProxyAddress=httpProxyAddress, ipsUrlNormAddress=ipsUrlNormAddress, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsReqSrvcPort=ipsReqSrvcPort, httpProxyTotalConn=httpProxyTotalConn, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, switchingToMaintMode=switchingToMaintMode, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, activeServers=activeServers, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslProxyTotalReq=sslProxyTotalReq, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrNumConn=httpSrvrNumConn, webCacheCacheableRes=webCacheCacheableRes, dataPathStatus=dataPathStatus, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsStatsGroup=bwsStatsGroup, httpSrvrTotReqRejected=httpSrvrTotReqRejected, highAvailabilityStatus=highAvailabilityStatus, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslSrvrMaxResTime=sslSrvrMaxResTime, smAgentName=smAgentName, ipsHdrAclHits=ipsHdrAclHits, httpProxyServerAbrt=httpProxyServerAbrt, freeMem=freeMem, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsRCTotServed=ipsRCTotServed, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsWebAddrTransPort=ipsWebAddrTransPort, logStorageHigh=logStorageHigh, totalAttacks=totalAttacks, sslSrvrAddressType=sslSrvrAddressType, bwstraps=bwstraps, webCmprAddressType=webCmprAddressType, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, smRealmName=smRealmName, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpSrvrTotRefused=httpSrvrTotRefused, ipsRCTotDropped=ipsRCTotDropped, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsMIBConformance=bwsMIBConformance, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsHdrAclPort=ipsHdrAclPort, httpSrvrSrvcAddress=httpSrvrSrvcAddress, vipStatus=vipStatus, ipsReqSrvcAddress=ipsReqSrvcAddress, sslSrvrPort=sslSrvrPort, httpProxyServerReq=httpProxyServerReq, webCmprPort=webCmprPort, uptime=uptime, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, tempCritical=tempCritical, bwsCacheStatsTable=bwsCacheStatsTable, firmwareStorage=firmwareStorage, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, webCacheAddressType=webCacheAddressType, ipsCookieSecTampered=ipsCookieSecTampered, servicePort=servicePort, bws=bws, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, webCacheReq=webCacheReq, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, activeApplications=activeApplications, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, dataPortLinkDown=dataPortLinkDown, serviceName=serviceName, switchingToInlineMode=switchingToInlineMode, ipsUrlNormPort=ipsUrlNormPort, currentFirmwareVersion=currentFirmwareVersion, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, webCacheMiss=webCacheMiss, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, webCachePort=webCachePort, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, totalBandwidth=totalBandwidth, webCacheProtocol=webCacheProtocol, systemFanSpeed=systemFanSpeed, PYSNMP_MODULE_ID=bws, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslProxyAddress=sslProxyAddress, webCmprAddress=webCmprAddress, totalApplications=totalApplications, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslProxyTotalConn=sslProxyTotalConn, ipsReqLimitAddress=ipsReqLimitAddress, httpSrvrPort=httpSrvrPort, httpProxyServerErr=httpProxyServerErr, sslProxyCurrentConn=sslProxyCurrentConn, sslSrvrAddress=sslSrvrAddress, cpuUtilization=cpuUtilization, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrOutBytes=httpSrvrOutBytes, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpProxyUnknownRsp=httpProxyUnknownRsp, sslSrvrMinResTime=sslSrvrMinResTime, httpSrvrAddress=httpSrvrAddress, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, serviceAddress=serviceAddress, serviceStatus=serviceStatus, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslProxyErrPms=sslProxyErrPms, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpSrvrState=httpSrvrState, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, webCacheBytesOut=webCacheBytesOut, bwsMIBGroups=bwsMIBGroups, dataPortLinkUp=dataPortLinkUp, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, webCmprCompressedDataSize=webCmprCompressedDataSize, sslSrvrNumConn=sslSrvrNumConn, bwsMIBCompliances=bwsMIBCompliances, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsRCAddressType=ipsRCAddressType, cpuFanSpeed=cpuFanSpeed, ipsCookieSecPort=ipsCookieSecPort, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsCookieSecAddress=ipsCookieSecAddress, switchingToBypassMode=switchingToBypassMode, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsLrnSrvcAddress=ipsLrnSrvcAddress, webCacheLongHdrs=webCacheLongHdrs, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpSrvrNumFreeConn=httpSrvrNumFreeConn, webCacheCachedObjects=webCacheCachedObjects, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, memUtilization=memUtilization, totalMem=totalMem, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsMessage=bwsMessage, sslSrvrTotResponse=sslSrvrTotResponse, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsHdrAclAddress=ipsHdrAclAddress, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlPolicyPort=ipsUrlPolicyPort, sslSrvrTotReqActive=sslSrvrTotReqActive, logStorage=logStorage, operationalMode=operationalMode, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpProxyPort=httpProxyPort, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType)
mibBuilder.exportSymbols("BWS-MIB", ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, srvcName=srvcName, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsUrlAclReserved=ipsUrlAclReserved, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpSrvrMinResTime=httpSrvrMinResTime, processCountHigh=processCountHigh, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsUrlAclAddress=ipsUrlAclAddress, linkStatus=linkStatus, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, peerUp=peerUp, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, totalServers=totalServers, systemLoad=systemLoad, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslProxyPort=sslProxyPort, sslSrvrState=sslSrvrState, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsRCPort=ipsRCPort, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, virusDefUpdates=virusDefUpdates, ipsLrnSrvcPort=ipsLrnSrvcPort, systemFailure=systemFailure, sslSrvrTotSuccess=sslSrvrTotSuccess, httpProxyInBytes=httpProxyInBytes, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpProxyParseErr=httpProxyParseErr, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpSrvrAddressType=httpSrvrAddressType, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpSrvrTotResponse=httpSrvrTotResponse, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsServiceStatusEntry=bwsServiceStatusEntry, webCacheAddress=webCacheAddress, sslSrvrOutBytes=sslSrvrOutBytes, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsReqLimitPort=ipsReqLimitPort, ipsUrlNormAddressType=ipsUrlNormAddressType, httpProxyActiveConn=httpProxyActiveConn, smNumUserSessions=smNumUserSessions, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpProxyAddressType=httpProxyAddressType, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, webCacheHits=webCacheHits, sslProxyCacheMiss=sslProxyCacheMiss, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled)
