...
Bits, Counter32, IpAddress, NotificationType, Integer32, TimeTicks, ModuleIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ObjectIdentity, Gauge32, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "IpAddress", "NotificationType", "Integer32", "TimeTicks", "ModuleIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ObjectIdentity", "Gauge32", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("BWS-MIB", smRealmName=smRealmName, bwsServiceStatusTable=bwsServiceStatusTable, serviceName=serviceName, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsStatsGroup=bwsStatsGroup, ipsLrnSrvcPort=ipsLrnSrvcPort, sslSrvrTotSuccess=sslSrvrTotSuccess, totalMem=totalMem, sslProxyPort=sslProxyPort, httpProxyTotalReq=httpProxyTotalReq, sslSrvrPort=sslSrvrPort, serviceAddress=serviceAddress, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsCookieSecAddress=ipsCookieSecAddress, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, dataPortLinkDown=dataPortLinkDown, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, memoryUsageHigh=memoryUsageHigh, sslSrvrNumConn=sslSrvrNumConn, sslProxyActiveConn=sslProxyActiveConn, ipsCookieSecTampered=ipsCookieSecTampered, ipsReqLimitPort=ipsReqLimitPort, httpProxyOutBytes=httpProxyOutBytes, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, totalApplications=totalApplications, systemFanSpeed=systemFanSpeed, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrAvgResTime=sslSrvrAvgResTime, dataPortLinkUp=dataPortLinkUp, ipsReqSrvcPort=ipsReqSrvcPort, smAgentName=smAgentName, bwsCompressionStatsEntry=bwsCompressionStatsEntry, systemFailOver=systemFailOver, ipsHdrAclAddress=ipsHdrAclAddress, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslSrvrInBytes=sslSrvrInBytes, smNumUserSessions=smNumUserSessions, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsRCTotDropped=ipsRCTotDropped, webCacheCacheableRes=webCacheCacheableRes, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsMessage=bwsMessage, webCmprAddress=webCmprAddress, ipsUrlAclReserved=ipsUrlAclReserved, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, operationalMode=operationalMode, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpProxyAddress=httpProxyAddress, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, peerUp=peerUp, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, webCacheHits=webCacheHits, ipsHdrAclHits=ipsHdrAclHits, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsUrlNormAddress=ipsUrlNormAddress, ipsUrlAclAddressType=ipsUrlAclAddressType, sslSrvrTotReqActive=sslSrvrTotReqActive, fanDead=fanDead, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, switchingToInlineMode=switchingToInlineMode, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpSrvrPort=httpSrvrPort, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsRCTotQueued=ipsRCTotQueued, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, tempHigh=tempHigh, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpSrvrAddressType=httpSrvrAddressType, bwsMIBGroups=bwsMIBGroups, sslProxyBadDNCErr=sslProxyBadDNCErr, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, webCacheReq=webCacheReq, httpProxyServerReq=httpProxyServerReq, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsUrlNormAddressType=ipsUrlNormAddressType, totalServers=totalServers, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, uptime=uptime, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, webCacheStale=webCacheStale, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsMIBCompliance=bwsMIBCompliance, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, activeApplications=activeApplications, peerDown=peerDown, httpProxyWAFWarnings=httpProxyWAFWarnings, serverDown=serverDown, cpuTemperature=cpuTemperature, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsRCTimeStamp=ipsRCTimeStamp, sslSrvrOutBytes=sslSrvrOutBytes, ipsRCAddressType=ipsRCAddressType, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsReqLimitAddress=ipsReqLimitAddress, sslSrvrTotResponse=sslSrvrTotResponse, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, totalAttacks=totalAttacks, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, logStorage=logStorage, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, securityDefUpdates=securityDefUpdates, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsRCAddress=ipsRCAddress, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslSrvrTotRefused=sslSrvrTotRefused, sslSrvrTotReqRejected=sslSrvrTotReqRejected, cpuUtilization=cpuUtilization, systemFailure=systemFailure, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpProxyServerAbrt=httpProxyServerAbrt, webCachePort=webCachePort, httpSrvrMaxResTime=httpSrvrMaxResTime, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsCookieSecPort=ipsCookieSecPort, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, activeServers=activeServers, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlAclPort=ipsUrlAclPort, webCacheCachedObjects=webCacheCachedObjects, systemLoad=systemLoad, sslSrvrMaxResTime=sslSrvrMaxResTime, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, virusDefUpdates=virusDefUpdates, sslSrvrTotTimedout=sslSrvrTotTimedout, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrTotSuccess=httpSrvrTotSuccess, firmwareStorage=firmwareStorage, httpProxyServerErr=httpProxyServerErr, srvcName=srvcName, bwsStats=bwsStats, webCmprAddressType=webCmprAddressType, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsUrlAclAddress=ipsUrlAclAddress, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslProxyBadCRLErr=sslProxyBadCRLErr, webCacheAddress=webCacheAddress, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsCacheStatsTable=bwsCacheStatsTable, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrState=httpSrvrState, ipsUrlPolicyAddress=ipsUrlPolicyAddress, webCmprProtocol=webCmprProtocol, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpSrvrSrvcAddress=httpSrvrSrvcAddress, firmwareUpdateAvailable=firmwareUpdateAvailable, serverUp=serverUp, sslProxyCacheHits=sslProxyCacheHits, sslProxyAddressType=sslProxyAddressType, httpProxyPort=httpProxyPort, sslProxyAddress=sslProxyAddress, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslSrvrState=sslSrvrState, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpProxyTotalConn=httpProxyTotalConn, sslSrvrAddressType=sslSrvrAddressType, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpProxyInBytes=httpProxyInBytes, httpSrvrMinResTime=httpSrvrMinResTime, cpuFanSpeed=cpuFanSpeed, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, currentFirmwareVersion=currentFirmwareVersion, bwstraps=bwstraps, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, linkStatus=linkStatus, httpProxyActiveConn=httpProxyActiveConn, webCmprPort=webCmprPort, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, vipStatus=vipStatus, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrNumConn=httpSrvrNumConn, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslSrvrAddress=sslSrvrAddress, bwsMIBCompliances=bwsMIBCompliances, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, httpProxyAddressType=httpProxyAddressType, memUtilization=memUtilization, httpProxyClientAbrt=httpProxyClientAbrt, firmwareStorageHigh=firmwareStorageHigh, switchingToBypassMode=switchingToBypassMode, httpSrvrAddress=httpSrvrAddress, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsTrapGroup=bwsTrapGroup, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, totalBandwidth=totalBandwidth, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, webCacheMiss=webCacheMiss)
mibBuilder.exportSymbols("BWS-MIB", highAvailabilityStatus=highAvailabilityStatus, sslProxyTotalConn=sslProxyTotalConn, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrSrvcPort=httpSrvrSrvcPort, httpSrvrTotRefused=httpSrvrTotRefused, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsHdrAclPort=ipsHdrAclPort, ipsWebAddrTransPort=ipsWebAddrTransPort, webCacheAddressType=webCacheAddressType, sslProxyOutBytes=sslProxyOutBytes, processCountHigh=processCountHigh, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsRCTotServed=ipsRCTotServed, tempCritical=tempCritical, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsCookieSecAddressType=ipsCookieSecAddressType, sslProxyErrPms=sslProxyErrPms, httpSrvrTotResponse=httpSrvrTotResponse, switchingToMaintMode=switchingToMaintMode, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, systemSerialNumber=systemSerialNumber, sslSrvrNumFreeConn=sslSrvrNumFreeConn, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsRCPort=ipsRCPort, dataPathStatus=dataPathStatus, httpSrvrInBytes=httpSrvrInBytes, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsMIBConformance=bwsMIBConformance, sslSrvrMinResTime=sslSrvrMinResTime, freeMem=freeMem, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, logStorageHigh=logStorageHigh, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, servicePort=servicePort, ipsUrlNormPort=ipsUrlNormPort, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bws=bws, webCacheBytesOut=webCacheBytesOut, PYSNMP_MODULE_ID=bws, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsReqLimitAddressType=ipsReqLimitAddressType, httpProxyParseErr=httpProxyParseErr, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, webCacheProtocol=webCacheProtocol, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpProxySessionTimeOut=httpProxySessionTimeOut, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, webCacheLongHdrs=webCacheLongHdrs, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, energizeUpdateExpire=energizeUpdateExpire, serviceStatus=serviceStatus, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslProxyTotalReq=sslProxyTotalReq, sslProxyCacheMiss=sslProxyCacheMiss, raidDegrading=raidDegrading, sslProxyInBytes=sslProxyInBytes)
