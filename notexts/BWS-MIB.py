...
ObjectIdentity, TimeTicks, Counter32, Gauge32, IpAddress, MibIdentifier, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, Bits, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "Counter32", "Gauge32", "IpAddress", "MibIdentifier", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "Bits", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("BWS-MIB", ipsWebAddrTransAddress=ipsWebAddrTransAddress, systemSerialNumber=systemSerialNumber, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrSrvcPort=httpSrvrSrvcPort, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, webCacheBytesOut=webCacheBytesOut, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpProxyAddress=httpProxyAddress, uptime=uptime, sslProxyPort=sslProxyPort, sslSrvrState=sslSrvrState, bwsStatsGroup=bwsStatsGroup, sslProxyCacheMiss=sslProxyCacheMiss, vipStatus=vipStatus, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpProxyOutBytes=httpProxyOutBytes, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, serverUp=serverUp, sslProxyTotalConn=sslProxyTotalConn, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, raidDegrading=raidDegrading, sslSrvrMinResTime=sslSrvrMinResTime, ipsRCTotOutOfResource=ipsRCTotOutOfResource, webCacheCachedObjects=webCacheCachedObjects, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsRCAddressType=ipsRCAddressType, switchingToMaintMode=switchingToMaintMode, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpSrvrMinResTime=httpSrvrMinResTime, httpSrvrPort=httpSrvrPort, ipsRCTotQueued=ipsRCTotQueued, smRealmName=smRealmName, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, firmwareStorage=firmwareStorage, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsWebAddrTransPort=ipsWebAddrTransPort, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrTotResponse=httpSrvrTotResponse, ipsReqSrvcPort=ipsReqSrvcPort, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslSrvrAddress=sslSrvrAddress, PYSNMP_MODULE_ID=bws, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpProxyAddressType=httpProxyAddressType, ipsUrlAclAddressType=ipsUrlAclAddressType, sslProxyInBytes=sslProxyInBytes, httpSrvrNumConn=httpSrvrNumConn, ipsRCAddress=ipsRCAddress, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, logStorage=logStorage, securityDefUpdates=securityDefUpdates, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, systemLoad=systemLoad, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslProxyErrPms=sslProxyErrPms, httpSrvrOutBytes=httpSrvrOutBytes, serviceStatus=serviceStatus, bws=bws, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, virusDefUpdates=virusDefUpdates, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, switchingToBypassMode=switchingToBypassMode, totalApplications=totalApplications, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsLrnSrvcAddress=ipsLrnSrvcAddress, fanDead=fanDead, cpuUtilization=cpuUtilization, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsTrapGroup=bwsTrapGroup, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsCookieSecPort=ipsCookieSecPort, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, webCmprProtocol=webCmprProtocol, ipsRCTotServed=ipsRCTotServed, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrTotTimedout=httpSrvrTotTimedout, serviceName=serviceName, switchingToInlineMode=switchingToInlineMode, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, dataPortLinkUp=dataPortLinkUp, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsMIBGroups=bwsMIBGroups, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrPort=sslSrvrPort, httpSrvrTotReqActive=httpSrvrTotReqActive, highAvailabilityStatus=highAvailabilityStatus, bwstraps=bwstraps, operationalMode=operationalMode, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, activeApplications=activeApplications, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, memUtilization=memUtilization, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, freeMem=freeMem, httpProxyTotalReq=httpProxyTotalReq, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, webCachePort=webCachePort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, activeServers=activeServers, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, systemFailOver=systemFailOver, sslProxyAddress=sslProxyAddress, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrState=httpSrvrState, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsRCTotDropped=ipsRCTotDropped, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsMIBCompliances=bwsMIBCompliances, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, webCacheCacheableRes=webCacheCacheableRes, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsMIBConformance=bwsMIBConformance, webCacheProtocol=webCacheProtocol, webCacheLongHdrs=webCacheLongHdrs, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpProxyActiveConn=httpProxyActiveConn, bwsMIBCompliance=bwsMIBCompliance, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpProxyClientAbrt=httpProxyClientAbrt, systemFanSpeed=systemFanSpeed, webCmprPort=webCmprPort, ipsUrlAclPort=ipsUrlAclPort, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, energizeUpdateExpire=energizeUpdateExpire, sslProxyOutBytes=sslProxyOutBytes, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpProxyUnknownRsp=httpProxyUnknownRsp, sslProxyAddressType=sslProxyAddressType, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, dataPortLinkDown=dataPortLinkDown, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrAddressType=httpSrvrAddressType, webCacheReq=webCacheReq, httpSrvrMaxResTime=httpSrvrMaxResTime, totalBandwidth=totalBandwidth, smNumUserSessions=smNumUserSessions, httpProxyTotalConn=httpProxyTotalConn, webCmprCompressedDataSize=webCmprCompressedDataSize, sslSrvrSrvcPort=sslSrvrSrvcPort, cpuFanSpeed=cpuFanSpeed, bwsStats=bwsStats, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, newAttackDefinitionInstalled=newAttackDefinitionInstalled, linkStatus=linkStatus, peerDown=peerDown, sslSrvrMaxResTime=sslSrvrMaxResTime, sslProxyCurrentConn=sslProxyCurrentConn, webCacheHits=webCacheHits, httpProxyServerReq=httpProxyServerReq, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, tempHigh=tempHigh, firmwareStorageHigh=firmwareStorageHigh, ipsUrlAclAddress=ipsUrlAclAddress, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpSrvrTotRefused=httpSrvrTotRefused, ipsRCPort=ipsRCPort, servicePort=servicePort, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsReqLimitAddress=ipsReqLimitAddress, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsUrlNormAddress=ipsUrlNormAddress, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslProxyActiveConn=sslProxyActiveConn, ipsHdrAclHits=ipsHdrAclHits, sslSrvrAddressType=sslSrvrAddressType, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsHdrAclAddress=ipsHdrAclAddress, sslSrvrTotSuccess=sslSrvrTotSuccess, httpProxyServerAbrt=httpProxyServerAbrt, bwsCompressionStatsTable=bwsCompressionStatsTable, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslSrvrTotResponse=sslSrvrTotResponse, webCacheStale=webCacheStale, processCountHigh=processCountHigh, totalAttacks=totalAttacks, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpProxyServerErr=httpProxyServerErr, sslSrvrTotRefused=sslSrvrTotRefused, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpProxySessionTimeOut=httpProxySessionTimeOut, sslSrvrOutBytes=sslSrvrOutBytes, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpProxyPort=httpProxyPort, sslProxyCacheHits=sslProxyCacheHits, httpSrvrInBytes=httpSrvrInBytes, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpProxyWAFWarnings=httpProxyWAFWarnings, serverDown=serverDown, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, totalMem=totalMem, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrNumConn=sslSrvrNumConn, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, dataPathStatus=dataPathStatus, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsServiceStatusTable=bwsServiceStatusTable, ipsRCTimeStamp=ipsRCTimeStamp, bwsMessage=bwsMessage, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, smAgentName=smAgentName, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsUrlNormPort=ipsUrlNormPort, ipsUrlAclReserved=ipsUrlAclReserved, sharedSecretKeyExpired=sharedSecretKeyExpired, sslSrvrSrvcAddress=sslSrvrSrvcAddress, webCacheAddress=webCacheAddress, webCacheAddressType=webCacheAddressType, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, tempCritical=tempCritical, currentFirmwareVersion=currentFirmwareVersion, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpSrvrAddress=httpSrvrAddress, systemFailure=systemFailure, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpProxyInBytes=httpProxyInBytes, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsCacheStatsEntry=bwsCacheStatsEntry, logStorageHigh=logStorageHigh, srvcName=srvcName, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, webCmprAddress=webCmprAddress, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslSrvrInBytes=sslSrvrInBytes, totalServers=totalServers, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, peerUp=peerUp, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsCookieSecTampered=ipsCookieSecTampered, webCmprAddressType=webCmprAddressType, ipsHdrAclPort=ipsHdrAclPort, httpProxyParseErr=httpProxyParseErr, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, memoryUsageHigh=memoryUsageHigh, sslProxyTotalReq=sslProxyTotalReq, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsReqLimitPort=ipsReqLimitPort, webCacheMiss=webCacheMiss, cpuTemperature=cpuTemperature, serviceAddress=serviceAddress, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsCookieSecAddress=ipsCookieSecAddress, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable)
