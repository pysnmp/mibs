...
Gauge32, NotificationType, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, Integer32, ModuleIdentity, TimeTicks, Unsigned32, ObjectIdentity, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "Integer32", "ModuleIdentity", "TimeTicks", "Unsigned32", "ObjectIdentity", "Bits", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", activeApplications=activeApplications, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, switchingToBypassMode=switchingToBypassMode, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, tempHigh=tempHigh, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsUrlNormAddressType=ipsUrlNormAddressType, serviceName=serviceName, httpSrvrTotReqActive=httpSrvrTotReqActive, uptime=uptime, processCountHigh=processCountHigh, bwsMIBCompliances=bwsMIBCompliances, cpuFanSpeed=cpuFanSpeed, bwsMessage=bwsMessage, firmwareStorage=firmwareStorage, webCmprCompressedDataSize=webCmprCompressedDataSize, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsHdrAclPort=ipsHdrAclPort, ipsUrlPolicyAddress=ipsUrlPolicyAddress, operationalMode=operationalMode, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrInBytes=sslSrvrInBytes, httpProxyClientAbrt=httpProxyClientAbrt, ipsReqLimitAddress=ipsReqLimitAddress, PYSNMP_MODULE_ID=bws, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsReqLimitPort=ipsReqLimitPort, sslSrvrAvgResTime=sslSrvrAvgResTime, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwstraps=bwstraps, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpProxyInBytes=httpProxyInBytes, switchingToInlineMode=switchingToInlineMode, ipsHdrAclHits=ipsHdrAclHits, peerDown=peerDown, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, highAvailabilityStatus=highAvailabilityStatus, securityDefUpdates=securityDefUpdates, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrState=httpSrvrState, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslSrvrOutBytes=sslSrvrOutBytes, httpSrvrTotSuccess=httpSrvrTotSuccess, webCacheStale=webCacheStale, sslSrvrState=sslSrvrState, virusDefUpdates=virusDefUpdates, cpuTemperature=cpuTemperature, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsCookieSecAddress=ipsCookieSecAddress, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsMIBCompliance=bwsMIBCompliance, httpProxyAddressType=httpProxyAddressType, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsRCTotServed=ipsRCTotServed, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslProxyCacheMiss=sslProxyCacheMiss, serverDown=serverDown, vipStatus=vipStatus, sslProxyAddress=sslProxyAddress, ipsAccessCtrlAddress=ipsAccessCtrlAddress, memoryUsageHigh=memoryUsageHigh, httpSrvrMinResTime=httpSrvrMinResTime, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, webCacheAddress=webCacheAddress, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslProxyCurrentConn=sslProxyCurrentConn, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslProxyErrPms=sslProxyErrPms, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, serviceAddress=serviceAddress, firmwareUpdateAvailable=firmwareUpdateAvailable, smAgentName=smAgentName, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslSrvrTotResponse=sslSrvrTotResponse, httpProxyPort=httpProxyPort, serviceStatus=serviceStatus, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsMIBConformance=bwsMIBConformance, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsUrlAclPort=ipsUrlAclPort, ipsRCTotDropped=ipsRCTotDropped, logStorage=logStorage, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsReqSrvcPort=ipsReqSrvcPort, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpSrvrAddressType=httpSrvrAddressType, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsRCPort=ipsRCPort, httpProxyServerReq=httpProxyServerReq, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, webCmprAddressType=webCmprAddressType, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, webCacheProtocol=webCacheProtocol, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsAccessCtrlPort=ipsAccessCtrlPort, httpProxyUnknownRsp=httpProxyUnknownRsp, linkStatus=linkStatus, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslProxyOutBytes=sslProxyOutBytes, ipsRCTimeStamp=ipsRCTimeStamp, sslProxyInBytes=sslProxyInBytes, firmwareStorageHigh=firmwareStorageHigh, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsRCTotQueued=ipsRCTotQueued, webCacheBytesOut=webCacheBytesOut, sslSrvrTotRefused=sslSrvrTotRefused, sharedSecretKeyExpired=sharedSecretKeyExpired, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, totalBandwidth=totalBandwidth, smNumUserSessions=smNumUserSessions, httpProxyParseErr=httpProxyParseErr, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, memUtilization=memUtilization, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, totalServers=totalServers, ipsUrlNormAddress=ipsUrlNormAddress, bwsTrapGroup=bwsTrapGroup, httpProxyActiveConn=httpProxyActiveConn, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrNumConn=sslSrvrNumConn, totalAttacks=totalAttacks, servicePort=servicePort, webCacheReq=webCacheReq, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, webCacheCacheableRes=webCacheCacheableRes, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsSMUserSessionTable=bwsSMUserSessionTable, webCachePort=webCachePort, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpSrvrTotRefused=httpSrvrTotRefused, httpSrvrAddress=httpSrvrAddress, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsHdrAclAddress=ipsHdrAclAddress, webCacheHits=webCacheHits, ipsRCAddressType=ipsRCAddressType, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslSrvrTotTimedout=sslSrvrTotTimedout, totalApplications=totalApplications, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsStatsGroup=bwsStatsGroup, dataPortLinkDown=dataPortLinkDown, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, webCmprAddress=webCmprAddress, cpuUtilization=cpuUtilization, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, dataPathStatus=dataPathStatus, systemFailure=systemFailure, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpProxyTotalReq=httpProxyTotalReq, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslSrvrTotSuccess=sslSrvrTotSuccess, webCacheCachedObjects=webCacheCachedObjects, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslProxyTotalReq=sslProxyTotalReq, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrMinResTime=sslSrvrMinResTime, bwsSMUserSessionEntry=bwsSMUserSessionEntry, tempCritical=tempCritical, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslProxyActiveConn=sslProxyActiveConn, webCacheLongHdrs=webCacheLongHdrs, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, systemSerialNumber=systemSerialNumber, smRealmName=smRealmName, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, dataPortLinkUp=dataPortLinkUp, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpProxyServerAbrt=httpProxyServerAbrt, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, activeServers=activeServers, httpSrvrSrvcPort=httpSrvrSrvcPort, httpProxyWAFWarnings=httpProxyWAFWarnings, webCmprPort=webCmprPort, sslProxyPort=sslProxyPort, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsCacheStatsTable=bwsCacheStatsTable, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, currentFirmwareVersion=currentFirmwareVersion, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpProxyTotalConn=httpProxyTotalConn, energizeUpdateExpire=energizeUpdateExpire, ipsRCAddress=ipsRCAddress, logStorageHigh=logStorageHigh, ipsCookieSecTampered=ipsCookieSecTampered, sslSrvrPort=sslSrvrPort, systemFailOver=systemFailOver, bwsServiceStatusEntry=bwsServiceStatusEntry, totalMem=totalMem, bws=bws, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, webCacheMiss=webCacheMiss)
mibBuilder.exportSymbols("BWS-MIB", fanDead=fanDead, raidDegrading=raidDegrading, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, switchingToMaintMode=switchingToMaintMode, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, peerUp=peerUp, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslSrvrAddressType=sslSrvrAddressType, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsWebAddrTransPort=ipsWebAddrTransPort, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrNumConn=httpSrvrNumConn, sslProxyCacheHits=sslProxyCacheHits, serverUp=serverUp, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslProxyTotalConn=sslProxyTotalConn, sslSrvrNumFreeConn=sslSrvrNumFreeConn, srvcName=srvcName, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, webCacheAddressType=webCacheAddressType, httpProxyAddress=httpProxyAddress, systemLoad=systemLoad, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslSrvrAddress=sslSrvrAddress, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsCookieSecPort=ipsCookieSecPort, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpSrvrTotResponse=httpSrvrTotResponse, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpSrvrInBytes=httpSrvrInBytes, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, systemFanSpeed=systemFanSpeed, httpProxyServerErr=httpProxyServerErr, bwsServiceStatusTable=bwsServiceStatusTable, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsStats=bwsStats, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslProxyAddressType=sslProxyAddressType, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpSrvrPort=httpSrvrPort, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsUrlNormPort=ipsUrlNormPort, freeMem=freeMem, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpProxyOutBytes=httpProxyOutBytes, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsMIBGroups=bwsMIBGroups, webCmprProtocol=webCmprProtocol, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr)
