...
ObjectIdentity, IpAddress, MibIdentifier, NotificationType, Bits, Unsigned32, Gauge32, Counter64, Integer32, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "MibIdentifier", "NotificationType", "Bits", "Unsigned32", "Gauge32", "Counter64", "Integer32", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, dataPathStatus=dataPathStatus, sslProxyCacheMiss=sslProxyCacheMiss, sslSrvrNumConn=sslSrvrNumConn, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, processCountHigh=processCountHigh, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, tempHigh=tempHigh, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsRCTimeStamp=ipsRCTimeStamp, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, fanDead=fanDead, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsRCAddress=ipsRCAddress, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsStatsGroup=bwsStatsGroup, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslProxyTotalConn=sslProxyTotalConn, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslProxyErrPms=sslProxyErrPms, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpProxyPort=httpProxyPort, totalServers=totalServers, httpSrvrMaxResTime=httpSrvrMaxResTime, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, activeApplications=activeApplications, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bws=bws, totalBandwidth=totalBandwidth, sslSrvrAvgResTime=sslSrvrAvgResTime, serverUp=serverUp, ipsRCPort=ipsRCPort, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, dataPortLinkDown=dataPortLinkDown, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrAddress=httpSrvrAddress, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, freeMem=freeMem, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpProxyOutBytes=httpProxyOutBytes, httpSrvrNumConn=httpSrvrNumConn, switchingToInlineMode=switchingToInlineMode, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsTrapGroup=bwsTrapGroup, logStorageHigh=logStorageHigh, sslSrvrTotResponse=sslSrvrTotResponse, httpSrvrMinResTime=httpSrvrMinResTime, webCacheAddressType=webCacheAddressType, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, peerDown=peerDown, webCacheCacheableRes=webCacheCacheableRes, peerUp=peerUp, uptime=uptime, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, systemSerialNumber=systemSerialNumber, serviceName=serviceName, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsHdrAclAddress=ipsHdrAclAddress, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslProxyOutBytes=sslProxyOutBytes, currentFirmwareVersion=currentFirmwareVersion, sslSrvrSrvcPort=sslSrvrSrvcPort, smAgentName=smAgentName, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, firmwareStorageHigh=firmwareStorageHigh, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sharedSecretKeyExpired=sharedSecretKeyExpired, httpProxyTotalReq=httpProxyTotalReq, httpProxyTotalConn=httpProxyTotalConn, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, memUtilization=memUtilization, ipsRCTotQueued=ipsRCTotQueued, PYSNMP_MODULE_ID=bws, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, webCacheBytesOut=webCacheBytesOut, bwsMessage=bwsMessage, vipStatus=vipStatus, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslSrvrMinResTime=sslSrvrMinResTime, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, linkStatus=linkStatus, httpProxyAddress=httpProxyAddress, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, systemFailure=systemFailure, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpSrvrState=httpSrvrState, webCacheMiss=webCacheMiss, sslProxyCacheHits=sslProxyCacheHits, ipsUrlAclPort=ipsUrlAclPort, ipsReqLimitPort=ipsReqLimitPort, ipsHdrAclPort=ipsHdrAclPort, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpSrvrInBytes=httpSrvrInBytes, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, memoryUsageHigh=memoryUsageHigh, webCacheLongHdrs=webCacheLongHdrs, ipsReqLimitAddress=ipsReqLimitAddress, httpProxySessionTimeOut=httpProxySessionTimeOut, sslSrvrTotRefused=sslSrvrTotRefused, sslSrvrPort=sslSrvrPort, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlNormAddress=ipsUrlNormAddress, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, highAvailabilityStatus=highAvailabilityStatus, cpuFanSpeed=cpuFanSpeed, cpuUtilization=cpuUtilization, sslProxyPort=sslProxyPort, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwstraps=bwstraps, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsMIBGroups=bwsMIBGroups, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrState=sslSrvrState, raidDegrading=raidDegrading, securityDefUpdates=securityDefUpdates, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrTotTimedout=sslSrvrTotTimedout, sslSrvrAddressType=sslSrvrAddressType, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrAddressType=httpSrvrAddressType, sslProxyCurrentConn=sslProxyCurrentConn, ipsUrlPolicyAddress=ipsUrlPolicyAddress, webCmprAddress=webCmprAddress, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, operationalMode=operationalMode, totalApplications=totalApplications, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsUrlAclReserved=ipsUrlAclReserved, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsUrlNormPort=ipsUrlNormPort, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, switchingToMaintMode=switchingToMaintMode, webCacheAddress=webCacheAddress, webCacheHits=webCacheHits, ipsRCTotDropped=ipsRCTotDropped, systemLoad=systemLoad, sslSrvrInBytes=sslSrvrInBytes, logStorage=logStorage, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsCacheStatsEntry=bwsCacheStatsEntry, sslProxyFullHandshakes=sslProxyFullHandshakes, servicePort=servicePort, ipsRCAddressType=ipsRCAddressType, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, smRealmName=smRealmName, sslProxyAddress=sslProxyAddress, ipsUrlAclAddress=ipsUrlAclAddress, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsCookieSecAddress=ipsCookieSecAddress, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsStats=bwsStats, sslProxyAddressType=sslProxyAddressType, webCmprPort=webCmprPort, totalMem=totalMem, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, webCacheCachedObjects=webCacheCachedObjects, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsSMUserSessionTable=bwsSMUserSessionTable, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrPort=httpSrvrPort, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsReqSrvcPort=ipsReqSrvcPort, httpProxyServerReq=httpProxyServerReq, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslProxyInBytes=sslProxyInBytes, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslProxyActiveConn=sslProxyActiveConn, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsHdrAclHits=ipsHdrAclHits, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslProxyBadDNCErr=sslProxyBadDNCErr, cpuTemperature=cpuTemperature, bwsMIBConformance=bwsMIBConformance, httpProxyInBytes=httpProxyInBytes, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, energizeUpdateExpire=energizeUpdateExpire, switchingToBypassMode=switchingToBypassMode, dataPortLinkUp=dataPortLinkUp, ipsCookieSecPort=ipsCookieSecPort, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsServiceStatusEntry=bwsServiceStatusEntry, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, webCmprCompressedDataSize=webCmprCompressedDataSize, sslProxyTotalReq=sslProxyTotalReq, virusDefUpdates=virusDefUpdates, httpProxyServerErr=httpProxyServerErr, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, webCacheProtocol=webCacheProtocol, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsRCTotServed=ipsRCTotServed, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpProxyUnknownRsp=httpProxyUnknownRsp, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, systemFanSpeed=systemFanSpeed, httpProxyClientAbrt=httpProxyClientAbrt, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsAccessCtrlAddress=ipsAccessCtrlAddress)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, serviceStatus=serviceStatus, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, serviceAddress=serviceAddress, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, webCmprProtocol=webCmprProtocol, webCacheStale=webCacheStale, sslSrvrOutBytes=sslSrvrOutBytes, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, webCmprAddressType=webCmprAddressType, httpProxyAddressType=httpProxyAddressType, httpProxyActiveConn=httpProxyActiveConn, totalAttacks=totalAttacks, httpSrvrTotResponse=httpSrvrTotResponse, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, firmwareStorage=firmwareStorage, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, activeServers=activeServers, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpProxyWAFWarnings=httpProxyWAFWarnings, webCachePort=webCachePort, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, tempCritical=tempCritical, webCacheReq=webCacheReq, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpProxyParseErr=httpProxyParseErr, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, serverDown=serverDown, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpProxyServerAbrt=httpProxyServerAbrt, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsMIBCompliances=bwsMIBCompliances, bwsMIBCompliance=bwsMIBCompliance, srvcName=srvcName, sslSrvrTotReqActive=sslSrvrTotReqActive, smNumUserSessions=smNumUserSessions, bwsServiceStatusTable=bwsServiceStatusTable, httpSrvrTotReqActive=httpSrvrTotReqActive, sslSrvrAddress=sslSrvrAddress, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsCacheStatsTable=bwsCacheStatsTable, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, systemFailOver=systemFailOver, httpSrvrOutBytes=httpSrvrOutBytes, ipsCookieSecEncrypted=ipsCookieSecEncrypted)
