...
ModuleIdentity, Integer32, MibIdentifier, Counter64, NotificationType, IpAddress, Bits, Unsigned32, Counter32, ObjectIdentity, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "MibIdentifier", "Counter64", "NotificationType", "IpAddress", "Bits", "Unsigned32", "Counter32", "ObjectIdentity", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("BWS-MIB", sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, serviceAddress=serviceAddress, ipsUrlAclPort=ipsUrlAclPort, logStorage=logStorage, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrTotRefused=httpSrvrTotRefused, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpProxyServerErr=httpProxyServerErr, httpSrvrNumConn=httpSrvrNumConn, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslProxyErrPms=sslProxyErrPms, bwsStats=bwsStats, freeMem=freeMem, sslSrvrOutBytes=sslSrvrOutBytes, activeApplications=activeApplications, bwsServiceStatusTable=bwsServiceStatusTable, linkStatus=linkStatus, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpProxyAddressType=httpProxyAddressType, switchingToInlineMode=switchingToInlineMode, ipsCookieSecAddress=ipsCookieSecAddress, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, smNumUserSessions=smNumUserSessions, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, webCmprAddressType=webCmprAddressType, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsHdrAclPort=ipsHdrAclPort, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, smAgentName=smAgentName, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, webCacheLongHdrs=webCacheLongHdrs, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpProxyTotalConn=httpProxyTotalConn, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, totalApplications=totalApplications, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsCookieSecPort=ipsCookieSecPort, sslSrvrAddress=sslSrvrAddress, ipsHdrAclHits=ipsHdrAclHits, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, raidDegrading=raidDegrading, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, serviceStatus=serviceStatus, httpSrvrInBytes=httpSrvrInBytes, energizeUpdateExpire=energizeUpdateExpire, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sharedSecretKeyExpired=sharedSecretKeyExpired, webCacheAddressType=webCacheAddressType, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, srvcName=srvcName, systemLoad=systemLoad, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpProxyServerReq=httpProxyServerReq, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsReqLimitAddressType=ipsReqLimitAddressType, webCacheStale=webCacheStale, memUtilization=memUtilization, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsCookieSecAddressType=ipsCookieSecAddressType, switchingToMaintMode=switchingToMaintMode, httpProxyPort=httpProxyPort, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, currentFirmwareVersion=currentFirmwareVersion, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, vipStatus=vipStatus, sslSrvrTotTimedout=sslSrvrTotTimedout, firmwareStorage=firmwareStorage, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, tempCritical=tempCritical, serviceName=serviceName, bwsServiceStatusEntry=bwsServiceStatusEntry, sslSrvrPort=sslSrvrPort, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsRCTotQueued=ipsRCTotQueued, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslProxyAddress=sslProxyAddress, ipsAccessCtrlAddress=ipsAccessCtrlAddress, webCachePort=webCachePort, httpProxyTotalReq=httpProxyTotalReq, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlAclAddress=ipsUrlAclAddress, firmwareUpdateAvailable=firmwareUpdateAvailable, sslProxyCacheTimeouts=sslProxyCacheTimeouts, operationalMode=operationalMode, systemFailOver=systemFailOver, smRealmName=smRealmName, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpProxyAddress=httpProxyAddress, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslProxyCurrentConn=sslProxyCurrentConn, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsCompressionStatsTable=bwsCompressionStatsTable, totalAttacks=totalAttacks, webCacheBytesOut=webCacheBytesOut, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, dataPathStatus=dataPathStatus, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, webCmprCompressibleDataSize=webCmprCompressibleDataSize, activeServers=activeServers, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsRCAddress=ipsRCAddress, systemFanSpeed=systemFanSpeed, systemSerialNumber=systemSerialNumber, memoryUsageHigh=memoryUsageHigh, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrAddress=httpSrvrAddress, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslProxyActiveConn=sslProxyActiveConn, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, webCacheCachedObjects=webCacheCachedObjects, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, virusDefUpdates=virusDefUpdates, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslSrvrMinResTime=sslSrvrMinResTime, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpSrvrOutBytes=httpSrvrOutBytes, tempHigh=tempHigh, sslProxyCacheMiss=sslProxyCacheMiss, webCacheAddress=webCacheAddress, uptime=uptime, webCacheReq=webCacheReq, totalServers=totalServers, sslProxyCacheHits=sslProxyCacheHits, ipsUrlNormPort=ipsUrlNormPort, peerDown=peerDown, sslProxyTotalConn=sslProxyTotalConn, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsReqLimitPort=ipsReqLimitPort, cpuFanSpeed=cpuFanSpeed, dataPortLinkUp=dataPortLinkUp, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwstraps=bwstraps, processCountHigh=processCountHigh, securityDefUpdates=securityDefUpdates, ipsCookieSecTampered=ipsCookieSecTampered, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsWebAddrTransAddress=ipsWebAddrTransAddress, totalBandwidth=totalBandwidth, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsStatsGroup=bwsStatsGroup, httpSrvrState=httpSrvrState, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrTotResponse=sslSrvrTotResponse, sslProxyInBytes=sslProxyInBytes, cpuUtilization=cpuUtilization, ipsUrlPolicyPort=ipsUrlPolicyPort, webCacheHits=webCacheHits, logStorageHigh=logStorageHigh, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpProxyParseErr=httpProxyParseErr, ipsReqLimitAddress=ipsReqLimitAddress, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsMIBConformance=bwsMIBConformance, webCacheCacheableRes=webCacheCacheableRes, sslSrvrTotRefused=sslSrvrTotRefused, systemFailure=systemFailure, httpSrvrPort=httpSrvrPort, bwsTrapGroup=bwsTrapGroup, PYSNMP_MODULE_ID=bws, ipsRCTotServed=ipsRCTotServed, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpProxyActiveConn=httpProxyActiveConn, totalMem=totalMem, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsUrlNormAddressType=ipsUrlNormAddressType, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, webCacheProtocol=webCacheProtocol, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, firmwareStorageHigh=firmwareStorageHigh, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsUrlAclReserved=ipsUrlAclReserved, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslSrvrNumConn=sslSrvrNumConn, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslSrvrState=sslSrvrState, ipsRCTimeStamp=ipsRCTimeStamp, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslProxyTotalReq=sslProxyTotalReq, webCmprAddress=webCmprAddress, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpProxyUnknownRsp=httpProxyUnknownRsp, httpSrvrAddressType=httpSrvrAddressType, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpSrvrTotReqActive=httpSrvrTotReqActive, sslSrvrInBytes=sslSrvrInBytes, serverDown=serverDown, cpuTemperature=cpuTemperature, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlNormAddress=ipsUrlNormAddress, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, webCmprProtocol=webCmprProtocol, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, peerUp=peerUp, sslSrvrAddressType=sslSrvrAddressType)
mibBuilder.exportSymbols("BWS-MIB", ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsReqSrvcPort=ipsReqSrvcPort, bwsMessage=bwsMessage, switchingToBypassMode=switchingToBypassMode, httpProxyServerAbrt=httpProxyServerAbrt, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsHdrAclAddress=ipsHdrAclAddress, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, webCacheMiss=webCacheMiss, ipsRCPort=ipsRCPort, httpSrvrTotResponse=httpSrvrTotResponse, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsRCTotDropped=ipsRCTotDropped, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslProxyBadDNCErr=sslProxyBadDNCErr, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, serverUp=serverUp, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslProxyAddressType=sslProxyAddressType, httpSrvrMinResTime=httpSrvrMinResTime, sslSrvrTotReqActive=sslSrvrTotReqActive, fanDead=fanDead, ipsRCAddressType=ipsRCAddressType, highAvailabilityStatus=highAvailabilityStatus, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpProxyOutBytes=httpProxyOutBytes, httpProxyClientAbrt=httpProxyClientAbrt, webCmprPort=webCmprPort, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, servicePort=servicePort, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsMIBGroups=bwsMIBGroups, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsMIBCompliances=bwsMIBCompliances, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslProxyOutBytes=sslProxyOutBytes, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslProxyPort=sslProxyPort, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsMIBCompliance=bwsMIBCompliance, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrMaxResTime=sslSrvrMaxResTime, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, dataPortLinkDown=dataPortLinkDown, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpProxyInBytes=httpProxyInBytes, bws=bws, ipsWebAddrTransPort=ipsWebAddrTransPort)
