...
Gauge32, Unsigned32, IpAddress, Counter32, iso, Counter64, ModuleIdentity, Bits, ObjectIdentity, TimeTicks, MibIdentifier, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "IpAddress", "Counter32", "iso", "Counter64", "ModuleIdentity", "Bits", "ObjectIdentity", "TimeTicks", "MibIdentifier", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("BWS-MIB", systemSerialNumber=systemSerialNumber, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpSrvrTotResponse=httpSrvrTotResponse, fanDead=fanDead, webCmprPort=webCmprPort, totalServers=totalServers, ipsCookieSecEncrypted=ipsCookieSecEncrypted, logStorageHigh=logStorageHigh, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, uptime=uptime, httpSrvrTotRefused=httpSrvrTotRefused, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsCookieSecAddressType=ipsCookieSecAddressType, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, webCmprAddress=webCmprAddress, ipsCookieSecTampered=ipsCookieSecTampered, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrSrvcAddress=httpSrvrSrvcAddress, serverUp=serverUp, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, systemLoad=systemLoad, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, processCountHigh=processCountHigh, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsRCTotQueued=ipsRCTotQueued, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, peerDown=peerDown, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpSrvrPort=httpSrvrPort, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpSrvrOutBytes=httpSrvrOutBytes, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpSrvrTotTimedout=httpSrvrTotTimedout, dataPortLinkDown=dataPortLinkDown, ipsRCTotDropped=ipsRCTotDropped, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, smAgentName=smAgentName, switchingToBypassMode=switchingToBypassMode, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsUrlAclPort=ipsUrlAclPort, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslProxyCurrentConn=sslProxyCurrentConn, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsRCPort=ipsRCPort, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpProxyServerReq=httpProxyServerReq, sslProxyAddress=sslProxyAddress, bwsMIBCompliance=bwsMIBCompliance, bwsServiceStatusEntry=bwsServiceStatusEntry, firmwareStorage=firmwareStorage, webCacheAddress=webCacheAddress, ipsReqLimitPort=ipsReqLimitPort, cpuFanSpeed=cpuFanSpeed, ipsReqSrvcPort=ipsReqSrvcPort, sslSrvrTotReqActive=sslSrvrTotReqActive, webCacheLongHdrs=webCacheLongHdrs, currentFirmwareVersion=currentFirmwareVersion, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpSrvrTotSuccess=httpSrvrTotSuccess, freeMem=freeMem, highAvailabilityStatus=highAvailabilityStatus, serviceStatus=serviceStatus, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, virusDefUpdates=virusDefUpdates, totalApplications=totalApplications, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, memoryUsageHigh=memoryUsageHigh, serviceAddress=serviceAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, energizeUpdateExpire=energizeUpdateExpire, serviceName=serviceName, httpProxyClientAbrt=httpProxyClientAbrt, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, switchingToMaintMode=switchingToMaintMode, ipsHdrAclHits=ipsHdrAclHits, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, webCmprAddressType=webCmprAddressType, ipsRCTotServed=ipsRCTotServed, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, PYSNMP_MODULE_ID=bws, webCacheAddressType=webCacheAddressType, bwsMessage=bwsMessage, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsMIBGroups=bwsMIBGroups, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsHdrAclPort=ipsHdrAclPort, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrInBytes=sslSrvrInBytes, sslProxyTotalReq=sslProxyTotalReq, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsReqLimitAddressType=ipsReqLimitAddressType, webCacheHits=webCacheHits, bwsStatsGroup=bwsStatsGroup, totalBandwidth=totalBandwidth, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslProxyCacheMiss=sslProxyCacheMiss, webCacheReq=webCacheReq, raidDegrading=raidDegrading, webCacheMiss=webCacheMiss, systemFailure=systemFailure, httpProxyAddressType=httpProxyAddressType, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslProxyErrPms=sslProxyErrPms, sslProxyTotalConn=sslProxyTotalConn, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslSrvrTotReqRejected=sslSrvrTotReqRejected, operationalMode=operationalMode, srvcName=srvcName, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, webCacheBytesOut=webCacheBytesOut, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsUrlAclAddress=ipsUrlAclAddress, bwsServiceStatusTable=bwsServiceStatusTable, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsCacheStatsTable=bwsCacheStatsTable, httpProxyWAFWarnings=httpProxyWAFWarnings, sslSrvrOutBytes=sslSrvrOutBytes, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, cpuUtilization=cpuUtilization, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslProxyInBytes=sslProxyInBytes, httpSrvrMinResTime=httpSrvrMinResTime, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, tempHigh=tempHigh, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsCompressionStatsTable=bwsCompressionStatsTable, webCacheCacheableRes=webCacheCacheableRes, sslSrvrNumConn=sslSrvrNumConn, sslProxyOutBytes=sslProxyOutBytes, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpProxyServerErr=httpProxyServerErr, ipsWebAddrTransAddress=ipsWebAddrTransAddress, dataPortLinkUp=dataPortLinkUp, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsUrlNormAddressType=ipsUrlNormAddressType, webCacheCachedObjects=webCacheCachedObjects, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsUrlNormPort=ipsUrlNormPort, activeApplications=activeApplications, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, firmwareStorageHigh=firmwareStorageHigh, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsTrapGroup=bwsTrapGroup, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrInBytes=httpSrvrInBytes, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, systemFanSpeed=systemFanSpeed, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsUrlNormAddress=ipsUrlNormAddress, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsReqLimitAddress=ipsReqLimitAddress, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrNumConn=httpSrvrNumConn, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsMIBConformance=bwsMIBConformance, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslSrvrPort=sslSrvrPort, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, serverDown=serverDown, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, linkStatus=linkStatus, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsRCAddressType=ipsRCAddressType, peerUp=peerUp, ipsCookieSecAddress=ipsCookieSecAddress, totalAttacks=totalAttacks, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpProxyInBytes=httpProxyInBytes, httpProxyPort=httpProxyPort, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, webCmprProtocol=webCmprProtocol, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, tempCritical=tempCritical, sslSrvrMinResTime=sslSrvrMinResTime, httpProxyAddress=httpProxyAddress, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpSrvrAddress=httpSrvrAddress, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsRCTimeStamp=ipsRCTimeStamp, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, smNumUserSessions=smNumUserSessions, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpProxyTotalReq=httpProxyTotalReq, ipsRCAddress=ipsRCAddress, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrSrvcPort=httpSrvrSrvcPort, sslProxyActiveConn=sslProxyActiveConn, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpProxyServerAbrt=httpProxyServerAbrt)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrMaxResTime=sslSrvrMaxResTime, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrState=httpSrvrState, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, activeServers=activeServers, sslSrvrTotResponse=sslSrvrTotResponse, httpProxyParseErr=httpProxyParseErr, sslSrvrAddressType=sslSrvrAddressType, httpProxyActiveConn=httpProxyActiveConn, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, dataPathStatus=dataPathStatus, httpProxyTotalConn=httpProxyTotalConn, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslProxyBadDNCErr=sslProxyBadDNCErr, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslSrvrState=sslSrvrState, webCachePort=webCachePort, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, securityDefUpdates=securityDefUpdates, sslSrvrTotRefused=sslSrvrTotRefused, smRealmName=smRealmName, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrAddressType=httpSrvrAddressType, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsCookieSecPort=ipsCookieSecPort, sslProxyPort=sslProxyPort, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, memUtilization=memUtilization, bwsStats=bwsStats, bws=bws, cpuTemperature=cpuTemperature, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpProxyOutBytes=httpProxyOutBytes, ipsRCTotOutOfResource=ipsRCTotOutOfResource, switchingToInlineMode=switchingToInlineMode, webCacheProtocol=webCacheProtocol, bwstraps=bwstraps, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslSrvrAddress=sslSrvrAddress, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, vipStatus=vipStatus, sslProxyAddressType=sslProxyAddressType, webCacheStale=webCacheStale, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, systemFailOver=systemFailOver, logStorage=logStorage, sslProxyCacheHits=sslProxyCacheHits, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, servicePort=servicePort, ipsHdrAclAddress=ipsHdrAclAddress, totalMem=totalMem, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsMIBCompliances=bwsMIBCompliances)
