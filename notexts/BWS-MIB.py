...
Integer32, IpAddress, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, Counter64, NotificationType, iso, Counter32, Bits, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "Counter64", "NotificationType", "iso", "Counter32", "Bits", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("BWS-MIB", tempHigh=tempHigh, httpSrvrPort=httpSrvrPort, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsStats=bwsStats, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsRCTotQueued=ipsRCTotQueued, dataPathStatus=dataPathStatus, linkStatus=linkStatus, peerUp=peerUp, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, webCacheBytesOut=webCacheBytesOut, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsUrlAclReserved=ipsUrlAclReserved, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, totalBandwidth=totalBandwidth, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, totalMem=totalMem, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpProxyAddress=httpProxyAddress, energizeUpdateExpire=energizeUpdateExpire, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpProxyServerErr=httpProxyServerErr, httpProxyTotalReq=httpProxyTotalReq, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpProxyParseErr=httpProxyParseErr, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, currentFirmwareVersion=currentFirmwareVersion, sslProxyPort=sslProxyPort, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsUrlAclPort=ipsUrlAclPort, httpSrvrTotResponse=httpSrvrTotResponse, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, smRealmName=smRealmName, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, activeApplications=activeApplications, ipsRCAddressType=ipsRCAddressType, systemFailOver=systemFailOver, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrSrvcAddress=sslSrvrSrvcAddress, cpuUtilization=cpuUtilization, totalAttacks=totalAttacks, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, memoryUsageHigh=memoryUsageHigh, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, processCountHigh=processCountHigh, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpSrvrTotReqRejected=httpSrvrTotReqRejected, serviceName=serviceName, ipsUrlNormAddress=ipsUrlNormAddress, vipStatus=vipStatus, activeServers=activeServers, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, totalServers=totalServers, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, systemFanSpeed=systemFanSpeed, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsReqSrvcAddress=ipsReqSrvcAddress, fanDead=fanDead, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsRCPort=ipsRCPort, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpSrvrOutBytes=httpSrvrOutBytes, ipsUrlAclAddress=ipsUrlAclAddress, freeMem=freeMem, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpProxyActiveConn=httpProxyActiveConn, webCacheStale=webCacheStale, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsHdrAclAddress=ipsHdrAclAddress, httpProxyWAFWarnings=httpProxyWAFWarnings, cpuTemperature=cpuTemperature, ipsRCAddress=ipsRCAddress, webCacheProtocol=webCacheProtocol, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, webCmprCompressibleDataSize=webCmprCompressibleDataSize, systemFailure=systemFailure, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslProxyErrPms=sslProxyErrPms, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, highAvailabilityStatus=highAvailabilityStatus, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrTotResponse=sslSrvrTotResponse, httpSrvrTotTimedout=httpSrvrTotTimedout, httpProxyOutBytes=httpProxyOutBytes, ipsRCTotServed=ipsRCTotServed, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslProxyBadDNCErr=sslProxyBadDNCErr, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslProxyActiveConn=sslProxyActiveConn, httpSrvrMinResTime=httpSrvrMinResTime, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpSrvrNumConn=httpSrvrNumConn, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsMIBCompliances=bwsMIBCompliances, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, webCacheAddressType=webCacheAddressType, securityDefUpdates=securityDefUpdates, httpProxyInBytes=httpProxyInBytes, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsMIBGroups=bwsMIBGroups, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, switchingToMaintMode=switchingToMaintMode, dataPortLinkUp=dataPortLinkUp, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, serverDown=serverDown, operationalMode=operationalMode, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsSMUserSessionTable=bwsSMUserSessionTable, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bws=bws, ipsReqSrvcPort=ipsReqSrvcPort, tempCritical=tempCritical, servicePort=servicePort, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, cpuFanSpeed=cpuFanSpeed, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, switchingToBypassMode=switchingToBypassMode, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpSrvrTotSuccess=httpSrvrTotSuccess, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslProxyFullHandshakes=sslProxyFullHandshakes, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsMIBConformance=bwsMIBConformance, bwstraps=bwstraps, PYSNMP_MODULE_ID=bws, sslProxyAddress=sslProxyAddress, webCacheReq=webCacheReq, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, logStorage=logStorage, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, systemSerialNumber=systemSerialNumber, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, totalApplications=totalApplications, bwsServiceStatusTable=bwsServiceStatusTable, ipsCookieSecTampered=ipsCookieSecTampered, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, uptime=uptime, ipsRCTimeStamp=ipsRCTimeStamp, httpSrvrAddress=httpSrvrAddress, webCmprPort=webCmprPort, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, smAgentName=smAgentName, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslSrvrInBytes=sslSrvrInBytes, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, webCmprCompressedDataSize=webCmprCompressedDataSize, sslSrvrTotRefused=sslSrvrTotRefused, serviceAddress=serviceAddress, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, webCachePort=webCachePort, httpSrvrMaxResTime=httpSrvrMaxResTime, switchingToInlineMode=switchingToInlineMode, httpSrvrSrvcPort=httpSrvrSrvcPort, webCmprAddressType=webCmprAddressType, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrState=httpSrvrState, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpProxyTotalConn=httpProxyTotalConn, sslSrvrAddressType=sslSrvrAddressType, sslProxyOutBytes=sslProxyOutBytes, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsHdrAclHits=ipsHdrAclHits, webCacheLongHdrs=webCacheLongHdrs, logStorageHigh=logStorageHigh, sslProxyTotalConn=sslProxyTotalConn, ipsReqLimitPort=ipsReqLimitPort, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslProxyAddressType=sslProxyAddressType, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, webCacheHits=webCacheHits, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, systemLoad=systemLoad, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpSrvrAddressType=httpSrvrAddressType, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, webCacheCachedObjects=webCacheCachedObjects, sslSrvrPort=sslSrvrPort, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrMinResTime=sslSrvrMinResTime, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpProxyAddressType=httpProxyAddressType, sslProxyCurrentConn=sslProxyCurrentConn, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslProxyInBytes=sslProxyInBytes, webCmprAddress=webCmprAddress, httpProxyClientAbrt=httpProxyClientAbrt, webCacheAddress=webCacheAddress, sharedSecretKeyExpired=sharedSecretKeyExpired, firmwareStorageHigh=firmwareStorageHigh, sslSrvrState=sslSrvrState, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsMessage=bwsMessage, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure)
mibBuilder.exportSymbols("BWS-MIB", ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, raidDegrading=raidDegrading, webCacheMiss=webCacheMiss, ipsCookieSecPort=ipsCookieSecPort, httpProxyPort=httpProxyPort, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlPolicyAddress=ipsUrlPolicyAddress, webCmprProtocol=webCmprProtocol, peerDown=peerDown, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslSrvrNumConn=sslSrvrNumConn, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslSrvrOutBytes=sslSrvrOutBytes, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpSrvrInBytes=httpSrvrInBytes, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsReqLimitAddress=ipsReqLimitAddress, memUtilization=memUtilization, bwsMIBCompliance=bwsMIBCompliance, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, dataPortLinkDown=dataPortLinkDown, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslProxyBadCRLErr=sslProxyBadCRLErr, httpProxyServerReq=httpProxyServerReq, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, serviceStatus=serviceStatus, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslSrvrAddress=sslSrvrAddress, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsHdrAclPort=ipsHdrAclPort, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsReqLimitAddressType=ipsReqLimitAddressType, sslProxyCacheMiss=sslProxyCacheMiss, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsStatsGroup=bwsStatsGroup, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsUrlNormPort=ipsUrlNormPort, ipsCookieSecAddress=ipsCookieSecAddress, virusDefUpdates=virusDefUpdates, bwsTrapGroup=bwsTrapGroup, httpProxyServerAbrt=httpProxyServerAbrt, serverUp=serverUp, ipsHdrAclAddressType=ipsHdrAclAddressType, smNumUserSessions=smNumUserSessions, sslProxyCacheHits=sslProxyCacheHits, sslProxyTotalReq=sslProxyTotalReq, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, firmwareStorage=firmwareStorage, ipsRCTotDropped=ipsRCTotDropped, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, srvcName=srvcName, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, webCacheCacheableRes=webCacheCacheableRes, sslSrvrSrvcPort=sslSrvrSrvcPort)
