...
ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, Unsigned32, IpAddress, iso, ModuleIdentity, NotificationType, Bits, MibIdentifier, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "Unsigned32", "IpAddress", "iso", "ModuleIdentity", "NotificationType", "Bits", "MibIdentifier", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("BWS-MIB", bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpSrvrAddress=httpSrvrAddress, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrOutBytes=httpSrvrOutBytes, webCacheHits=webCacheHits, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpProxyTotalReq=httpProxyTotalReq, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, serverUp=serverUp, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsCompressionStatsEntry=bwsCompressionStatsEntry, peerUp=peerUp, webCacheLongHdrs=webCacheLongHdrs, bwstraps=bwstraps, virusDefUpdates=virusDefUpdates, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslProxyErrPms=sslProxyErrPms, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsUrlPolicyPort=ipsUrlPolicyPort, operationalMode=operationalMode, securityDefUpdates=securityDefUpdates, sslProxyBadDNCErr=sslProxyBadDNCErr, webCacheAddress=webCacheAddress, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrTotSuccess=httpSrvrTotSuccess, webCacheStale=webCacheStale, energizeUpdateExpire=energizeUpdateExpire, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsUrlAclAddress=ipsUrlAclAddress, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, serviceName=serviceName, bwsMIBConformance=bwsMIBConformance, sslProxyTotalReq=sslProxyTotalReq, webCacheProtocol=webCacheProtocol, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpSrvrInBytes=httpSrvrInBytes, ipsReqSrvcPort=ipsReqSrvcPort, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslProxyCacheTimeouts=sslProxyCacheTimeouts, vipStatus=vipStatus, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsHdrAclAddress=ipsHdrAclAddress, memoryUsageHigh=memoryUsageHigh, sslSrvrState=sslSrvrState, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslProxyAddressType=sslProxyAddressType, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sharedSecretKeyExpired=sharedSecretKeyExpired, httpProxyServerErr=httpProxyServerErr, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsSMUserSessionTable=bwsSMUserSessionTable, cpuTemperature=cpuTemperature, cpuUtilization=cpuUtilization, srvcName=srvcName, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, serviceAddress=serviceAddress, ipsHdrAclAddressType=ipsHdrAclAddressType, sslSrvrInBytes=sslSrvrInBytes, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsCookieSecTampered=ipsCookieSecTampered, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsServiceStatusTable=bwsServiceStatusTable, sslProxyCacheHits=sslProxyCacheHits, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslProxyCacheMiss=sslProxyCacheMiss, sslSrvrMinResTime=sslSrvrMinResTime, ipsRCTotOutOfResource=ipsRCTotOutOfResource, smRealmName=smRealmName, sslProxyInBytes=sslProxyInBytes, sslSrvrPort=sslSrvrPort, systemLoad=systemLoad, httpProxyServerAbrt=httpProxyServerAbrt, logStorage=logStorage, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, webCacheReq=webCacheReq, serverDown=serverDown, sslSrvrAddress=sslSrvrAddress, firmwareUpdateAvailable=firmwareUpdateAvailable, tempHigh=tempHigh, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsMIBCompliances=bwsMIBCompliances, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrTotSuccess=sslSrvrTotSuccess, httpProxyActiveConn=httpProxyActiveConn, servicePort=servicePort, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, logStorageHigh=logStorageHigh, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, smAgentName=smAgentName, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, firmwareStorage=firmwareStorage, sslProxyActiveConn=sslProxyActiveConn, switchingToBypassMode=switchingToBypassMode, totalAttacks=totalAttacks, highAvailabilityStatus=highAvailabilityStatus, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslSrvrOutBytes=sslSrvrOutBytes, peerDown=peerDown, ipsRCTotDropped=ipsRCTotDropped, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsRCTotServed=ipsRCTotServed, processCountHigh=processCountHigh, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, linkStatus=linkStatus, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpSrvrMaxResTime=httpSrvrMaxResTime, freeMem=freeMem, currentFirmwareVersion=currentFirmwareVersion, raidDegrading=raidDegrading, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpProxyOutBytes=httpProxyOutBytes, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpSrvrNumConn=httpSrvrNumConn, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslProxyTotalConn=sslProxyTotalConn, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsRCTimeStamp=ipsRCTimeStamp, memUtilization=memUtilization, sslSrvrTotReqRejected=sslSrvrTotReqRejected, webCmprAddress=webCmprAddress, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrMaxResTime=sslSrvrMaxResTime, totalMem=totalMem, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, fanDead=fanDead, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, totalApplications=totalApplications, ipsCookieSecAddress=ipsCookieSecAddress, webCmprAddressType=webCmprAddressType, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsMessage=bwsMessage, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, webCacheCachedObjects=webCacheCachedObjects, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsHdrAclHits=ipsHdrAclHits, httpProxyParseErr=httpProxyParseErr, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsMIBGroups=bwsMIBGroups, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, webCacheCacheableRes=webCacheCacheableRes, httpProxyPort=httpProxyPort, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslSrvrNumConn=sslSrvrNumConn, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, webCmprProtocol=webCmprProtocol, sslSrvrTotResponse=sslSrvrTotResponse, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, uptime=uptime, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpProxyClientAbrt=httpProxyClientAbrt, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpSrvrTotRefused=httpSrvrTotRefused, systemFailure=systemFailure, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsTrapGroup=bwsTrapGroup, totalServers=totalServers, sslSrvrTotRefused=sslSrvrTotRefused, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsHdrAclPort=ipsHdrAclPort, ipsRCTotQueued=ipsRCTotQueued, ipsReqLimitPort=ipsReqLimitPort, httpSrvrMinResTime=httpSrvrMinResTime, httpSrvrTotResponse=httpSrvrTotResponse, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsUrlAclPort=ipsUrlAclPort, webCachePort=webCachePort, ipsReqLimitAddress=ipsReqLimitAddress, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, totalBandwidth=totalBandwidth, bwsMIBCompliance=bwsMIBCompliance, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bws=bws, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, activeApplications=activeApplications, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpProxyTotalConn=httpProxyTotalConn, switchingToMaintMode=switchingToMaintMode, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, webCacheBytesOut=webCacheBytesOut, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslProxyOutBytes=sslProxyOutBytes, sslSrvrAddressType=sslSrvrAddressType, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsCacheStatsEntry=bwsCacheStatsEntry, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, switchingToInlineMode=switchingToInlineMode, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpProxyAddressType=httpProxyAddressType, smNumUserSessions=smNumUserSessions, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpProxyServerReq=httpProxyServerReq, tempCritical=tempCritical, httpSrvrPort=httpSrvrPort, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpProxyAddress=httpProxyAddress, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable)
mibBuilder.exportSymbols("BWS-MIB", systemFailOver=systemFailOver, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, dataPortLinkDown=dataPortLinkDown, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlAclReserved=ipsUrlAclReserved, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, activeServers=activeServers, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, webCacheAddressType=webCacheAddressType, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsRCAddressType=ipsRCAddressType, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, systemFanSpeed=systemFanSpeed, dataPathStatus=dataPathStatus, httpProxyInBytes=httpProxyInBytes, httpSrvrState=httpSrvrState, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsStats=bwsStats, serviceStatus=serviceStatus, sslProxyPort=sslProxyPort, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsRCAddress=ipsRCAddress, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslProxyAddress=sslProxyAddress, bwsCacheStatsTable=bwsCacheStatsTable, systemSerialNumber=systemSerialNumber, bwsStatsGroup=bwsStatsGroup, webCmprPort=webCmprPort, httpSrvrAddressType=httpSrvrAddressType, cpuFanSpeed=cpuFanSpeed, webCacheMiss=webCacheMiss, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslSrvrTotReqActive=sslSrvrTotReqActive, firmwareStorageHigh=firmwareStorageHigh, ipsCookieSecPort=ipsCookieSecPort, sslSrvrTotTimedout=sslSrvrTotTimedout, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, dataPortLinkUp=dataPortLinkUp, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsRCPort=ipsRCPort, PYSNMP_MODULE_ID=bws, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsUrlNormPort=ipsUrlNormPort, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslProxyCurrentConn=sslProxyCurrentConn, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpProxyUnknownRsp=httpProxyUnknownRsp, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsServiceStatusEntry=bwsServiceStatusEntry)
