...
Integer32, Unsigned32, Counter64, Bits, IpAddress, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, MibIdentifier, Gauge32, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "Counter64", "Bits", "IpAddress", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "Gauge32", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("BWS-MIB", httpProxyActiveConn=httpProxyActiveConn, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, operationalMode=operationalMode, cpuUtilization=cpuUtilization, httpProxyServerErr=httpProxyServerErr, sslSrvrTotRefused=sslSrvrTotRefused, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsReqLimitPort=ipsReqLimitPort, httpProxyServerAbrt=httpProxyServerAbrt, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsStatsGroup=bwsStatsGroup, webCacheAddressType=webCacheAddressType, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrMaxResTime=httpSrvrMaxResTime, webCacheMiss=webCacheMiss, bwsCompressionStatsTable=bwsCompressionStatsTable, sslSrvrMinResTime=sslSrvrMinResTime, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, highAvailabilityStatus=highAvailabilityStatus, ipsUrlAclPort=ipsUrlAclPort, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslProxyCacheHits=sslProxyCacheHits, webCmprCompressedDataSize=webCmprCompressedDataSize, vipStatus=vipStatus, httpProxyTotalConn=httpProxyTotalConn, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsCookieSecPort=ipsCookieSecPort, dataPathStatus=dataPathStatus, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, serverUp=serverUp, serviceStatus=serviceStatus, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslSrvrAvgResTime=sslSrvrAvgResTime, httpProxyOutBytes=httpProxyOutBytes, ipsRCTotQueued=ipsRCTotQueued, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrTotReqRejected=sslSrvrTotReqRejected, totalMem=totalMem, fanDead=fanDead, httpProxyAddress=httpProxyAddress, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, smRealmName=smRealmName, dataPortLinkUp=dataPortLinkUp, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, serviceName=serviceName, webCacheCacheableRes=webCacheCacheableRes, httpProxyTotalReq=httpProxyTotalReq, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, webCacheHits=webCacheHits, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslSrvrOutBytes=sslSrvrOutBytes, bwsSMUserSessionEntry=bwsSMUserSessionEntry, firmwareStorageHigh=firmwareStorageHigh, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, srvcName=srvcName, bwsCacheStatsTable=bwsCacheStatsTable, sslProxyPort=sslProxyPort, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, webCacheStale=webCacheStale, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpProxyUnknownRsp=httpProxyUnknownRsp, processCountHigh=processCountHigh, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpProxySessionTimeOut=httpProxySessionTimeOut, totalServers=totalServers, sslSrvrNumConn=sslSrvrNumConn, webCmprPort=webCmprPort, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsStats=bwsStats, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsHdrAclAddress=ipsHdrAclAddress, httpProxyPort=httpProxyPort, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, dataPortLinkDown=dataPortLinkDown, peerUp=peerUp, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslProxyTotalConn=sslProxyTotalConn, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, logStorageHigh=logStorageHigh, ipsUrlNormPort=ipsUrlNormPort, sslProxyBadDNCErr=sslProxyBadDNCErr, peerDown=peerDown, bwsMessage=bwsMessage, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, securityDefUpdates=securityDefUpdates, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, switchingToInlineMode=switchingToInlineMode, bwsServiceStatusEntry=bwsServiceStatusEntry, uptime=uptime, httpSrvrTotReqActive=httpSrvrTotReqActive, firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrOutBytes=httpSrvrOutBytes, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, webCacheBytesOut=webCacheBytesOut, webCachePort=webCachePort, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, activeServers=activeServers, sslSrvrMaxResTime=sslSrvrMaxResTime, httpSrvrAddressType=httpSrvrAddressType, sslProxyErrPms=sslProxyErrPms, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsRCTotDropped=ipsRCTotDropped, webCacheReq=webCacheReq, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpSrvrAddress=httpSrvrAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, webCacheLongHdrs=webCacheLongHdrs, sslProxyInBytes=sslProxyInBytes, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, webCmprAddress=webCmprAddress, totalAttacks=totalAttacks, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpSrvrMinResTime=httpSrvrMinResTime, virusDefUpdates=virusDefUpdates, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsReqLimitAddress=ipsReqLimitAddress, ipsRCPort=ipsRCPort, linkStatus=linkStatus, memUtilization=memUtilization, tempCritical=tempCritical, smNumUserSessions=smNumUserSessions, systemLoad=systemLoad, sslProxyAddress=sslProxyAddress, httpSrvrTotRefused=httpSrvrTotRefused, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslProxyFullHandshakes=sslProxyFullHandshakes, sharedSecretKeyExpired=sharedSecretKeyExpired, servicePort=servicePort, sslProxyAddressType=sslProxyAddressType, bwsMIBCompliances=bwsMIBCompliances, cpuTemperature=cpuTemperature, ipsCookieSecAddress=ipsCookieSecAddress, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, webCacheAddress=webCacheAddress, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsUrlNormAddressType=ipsUrlNormAddressType, systemSerialNumber=systemSerialNumber, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsRCTotServed=ipsRCTotServed, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslProxyCurrentConn=sslProxyCurrentConn, ipsRCAddressType=ipsRCAddressType, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslSrvrInBytes=sslSrvrInBytes, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpSrvrTotResponse=httpSrvrTotResponse, totalBandwidth=totalBandwidth, freeMem=freeMem, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpSrvrSrvcPort=httpSrvrSrvcPort, smAgentName=smAgentName, httpSrvrTotSuccess=httpSrvrTotSuccess, sslSrvrState=sslSrvrState, bwstraps=bwstraps, firmwareStorage=firmwareStorage, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, systemFailure=systemFailure, ipsReqSrvcAddress=ipsReqSrvcAddress, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrAddress=sslSrvrAddress, ipsRCTimeStamp=ipsRCTimeStamp, activeApplications=activeApplications, logStorage=logStorage, bwsMIBGroups=bwsMIBGroups, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpProxyAddressType=httpProxyAddressType, sslSrvrPort=sslSrvrPort, webCacheProtocol=webCacheProtocol, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsLrnSrvcAddress=ipsLrnSrvcAddress, memoryUsageHigh=memoryUsageHigh, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpProxyInBytes=httpProxyInBytes, sslProxyActiveConn=sslProxyActiveConn, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsCookieSecTampered=ipsCookieSecTampered, systemFanSpeed=systemFanSpeed, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, systemFailOver=systemFailOver, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, PYSNMP_MODULE_ID=bws, ipsHdrAclHits=ipsHdrAclHits, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable)
mibBuilder.exportSymbols("BWS-MIB", ipsUrlNormAddress=ipsUrlNormAddress, bwsCompressionStatsEntry=bwsCompressionStatsEntry, serviceAddress=serviceAddress, raidDegrading=raidDegrading, bwsMIBCompliance=bwsMIBCompliance, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, webCmprAddressType=webCmprAddressType, sslProxyTotalReq=sslProxyTotalReq, energizeUpdateExpire=energizeUpdateExpire, totalApplications=totalApplications, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, cpuFanSpeed=cpuFanSpeed, bwsServiceStatusTable=bwsServiceStatusTable, ipsReqSrvcPort=ipsReqSrvcPort, switchingToBypassMode=switchingToBypassMode, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpProxyParseErr=httpProxyParseErr, ipsHdrAclPort=ipsHdrAclPort, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsRCAddress=ipsRCAddress, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bws=bws, tempHigh=tempHigh, sslSrvrTotResponse=sslSrvrTotResponse, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, webCmprProtocol=webCmprProtocol, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, serverDown=serverDown, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrState=httpSrvrState, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpSrvrNumConn=httpSrvrNumConn, httpSrvrPort=httpSrvrPort, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsUrlAclAddress=ipsUrlAclAddress, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsTrapGroup=bwsTrapGroup, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrTotReqActive=sslSrvrTotReqActive, currentFirmwareVersion=currentFirmwareVersion, sslProxyCacheMiss=sslProxyCacheMiss, bwsMIBConformance=bwsMIBConformance, httpProxyServerReq=httpProxyServerReq, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, switchingToMaintMode=switchingToMaintMode, ipsCookieSecAddressType=ipsCookieSecAddressType, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, webCacheCachedObjects=webCacheCachedObjects, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslSrvrAddressType=sslSrvrAddressType, httpSrvrInBytes=httpSrvrInBytes, ipsUrlAclReserved=ipsUrlAclReserved, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslProxyOutBytes=sslProxyOutBytes)
