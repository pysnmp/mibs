...
iso, NotificationType, ModuleIdentity, Integer32, Unsigned32, IpAddress, TimeTicks, Counter32, ObjectIdentity, MibIdentifier, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "ModuleIdentity", "Integer32", "Unsigned32", "IpAddress", "TimeTicks", "Counter32", "ObjectIdentity", "MibIdentifier", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpSrvrNumConn=httpSrvrNumConn, activeApplications=activeApplications, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpProxySessionTimeOut=httpProxySessionTimeOut, sslSrvrInBytes=sslSrvrInBytes, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, srvcName=srvcName, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, serviceStatus=serviceStatus, sslProxyErrPms=sslProxyErrPms, bwstraps=bwstraps, activeServers=activeServers, webCachePort=webCachePort, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslSrvrOutBytes=sslSrvrOutBytes, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, totalServers=totalServers, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, servicePort=servicePort, httpSrvrSrvcPort=httpSrvrSrvcPort, httpProxyOutBytes=httpProxyOutBytes, sslProxyAddress=sslProxyAddress, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpProxyUnknownRsp=httpProxyUnknownRsp, systemFailure=systemFailure, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrMaxResTime=httpSrvrMaxResTime, sslSrvrTotTimedout=sslSrvrTotTimedout, httpProxyPort=httpProxyPort, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, uptime=uptime, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, firmwareStorage=firmwareStorage, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, firmwareStorageHigh=firmwareStorageHigh, sslProxyTotalReq=sslProxyTotalReq, smRealmName=smRealmName, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, webCacheReq=webCacheReq, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsUrlNormPort=ipsUrlNormPort, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrMaxResTime=sslSrvrMaxResTime, PYSNMP_MODULE_ID=bws, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslProxyInBytes=sslProxyInBytes, logStorage=logStorage, dataPathStatus=dataPathStatus, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsServiceStatusTable=bwsServiceStatusTable, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, webCmprAddress=webCmprAddress, serverDown=serverDown, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsUrlPolicyAddress=ipsUrlPolicyAddress, serviceName=serviceName, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrNumConn=sslSrvrNumConn, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, energizeUpdateExpire=energizeUpdateExpire, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpSrvrAddressType=httpSrvrAddressType, systemSerialNumber=systemSerialNumber, sslProxyAddressType=sslProxyAddressType, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, webCacheCachedObjects=webCacheCachedObjects, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpSrvrTotRefused=httpSrvrTotRefused, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, operationalMode=operationalMode, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, memUtilization=memUtilization, bwsStats=bwsStats, serviceAddress=serviceAddress, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsRCAddress=ipsRCAddress, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, raidDegrading=raidDegrading, sslSrvrTotRefused=sslSrvrTotRefused, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, totalBandwidth=totalBandwidth, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsCookieSecAddress=ipsCookieSecAddress, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsCookieSecPort=ipsCookieSecPort, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpProxyAddress=httpProxyAddress, bwsStatsGroup=bwsStatsGroup, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsIpsRCStatsTable=bwsIpsRCStatsTable, webCacheCacheableRes=webCacheCacheableRes, httpProxyParseErr=httpProxyParseErr, switchingToMaintMode=switchingToMaintMode, tempCritical=tempCritical, systemFanSpeed=systemFanSpeed, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, webCmprPort=webCmprPort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsReqSrvcAddress=ipsReqSrvcAddress, httpProxyTotalConn=httpProxyTotalConn, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, switchingToBypassMode=switchingToBypassMode, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsAccessCtrlAddress=ipsAccessCtrlAddress, switchingToInlineMode=switchingToInlineMode, bwsMIBGroups=bwsMIBGroups, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslProxyOutBytes=sslProxyOutBytes, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrTotResponse=httpSrvrTotResponse, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsHdrAclAddressType=ipsHdrAclAddressType, webCacheAddress=webCacheAddress, sslProxyActiveConn=sslProxyActiveConn, webCacheProtocol=webCacheProtocol, webCacheBytesOut=webCacheBytesOut, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrAddress=sslSrvrAddress, sslSrvrAddressType=sslSrvrAddressType, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, tempHigh=tempHigh, ipsRCAddressType=ipsRCAddressType, dataPortLinkDown=dataPortLinkDown, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrState=sslSrvrState, httpProxyWAFWarnings=httpProxyWAFWarnings, cpuFanSpeed=cpuFanSpeed, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrTotResponse=sslSrvrTotResponse, httpSrvrState=httpSrvrState, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, webCmprProtocol=webCmprProtocol, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, systemFailOver=systemFailOver, webCmprAddressType=webCmprAddressType, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsHdrAclHits=ipsHdrAclHits, bwsCompressionStatsEntry=bwsCompressionStatsEntry, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsCookieSecTampered=ipsCookieSecTampered, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsMIBCompliances=bwsMIBCompliances, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, linkStatus=linkStatus, webCacheStale=webCacheStale, httpSrvrAddress=httpSrvrAddress, webCacheHits=webCacheHits, httpProxyServerReq=httpProxyServerReq, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslProxyPort=sslProxyPort, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, processCountHigh=processCountHigh, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, peerDown=peerDown, dataPortLinkUp=dataPortLinkUp, totalApplications=totalApplications, smAgentName=smAgentName, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, logStorageHigh=logStorageHigh, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslSrvrSrvcAddress=sslSrvrSrvcAddress, webCacheAddressType=webCacheAddressType, sslProxyCacheMiss=sslProxyCacheMiss, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsUrlNormAddress=ipsUrlNormAddress, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, totalMem=totalMem, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, serverUp=serverUp, bwsMIBConformance=bwsMIBConformance, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsRCTimeStamp=ipsRCTimeStamp, httpProxyInBytes=httpProxyInBytes, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpProxyAddressType=httpProxyAddressType, ipsRCTotQueued=ipsRCTotQueued, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, systemLoad=systemLoad, httpSrvrPort=httpSrvrPort, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsTrapGroup=bwsTrapGroup, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrPort=sslSrvrPort, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, cpuUtilization=cpuUtilization, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsMIBCompliance=bwsMIBCompliance, smNumUserSessions=smNumUserSessions)
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsUrlAclPort=ipsUrlAclPort, ipsReqSrvcPort=ipsReqSrvcPort, sslProxyTotalConn=sslProxyTotalConn, ipsRCTotDropped=ipsRCTotDropped, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslProxyCurrentConn=sslProxyCurrentConn, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, firmwareUpdateAvailable=firmwareUpdateAvailable, highAvailabilityStatus=highAvailabilityStatus, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsUrlPolicyPort=ipsUrlPolicyPort, memoryUsageHigh=memoryUsageHigh, sslSrvrTotReqRejected=sslSrvrTotReqRejected, securityDefUpdates=securityDefUpdates, sslProxyCacheTimeouts=sslProxyCacheTimeouts, freeMem=freeMem, webCacheMiss=webCacheMiss, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslSrvrAvgResTime=sslSrvrAvgResTime, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrInBytes=httpSrvrInBytes, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bws=bws, cpuTemperature=cpuTemperature, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, virusDefUpdates=virusDefUpdates, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslProxyCacheHits=sslProxyCacheHits, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, peerUp=peerUp, httpProxyServerErr=httpProxyServerErr, ipsAccessCtrlPort=ipsAccessCtrlPort, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsReqLimitAddress=ipsReqLimitAddress, fanDead=fanDead, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, totalAttacks=totalAttacks, httpProxyServerAbrt=httpProxyServerAbrt, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpProxyActiveConn=httpProxyActiveConn, webCacheLongHdrs=webCacheLongHdrs, httpProxyTotalReq=httpProxyTotalReq, ipsReqLimitPort=ipsReqLimitPort, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsUrlAclReserved=ipsUrlAclReserved, ipsRCTotServed=ipsRCTotServed, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, vipStatus=vipStatus, ipsWebAddrTransPort=ipsWebAddrTransPort, currentFirmwareVersion=currentFirmwareVersion, httpSrvrMinResTime=httpSrvrMinResTime, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsHdrAclAddress=ipsHdrAclAddress, bwsServiceStatusEntry=bwsServiceStatusEntry, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsHdrAclPort=ipsHdrAclPort, bwsMessage=bwsMessage, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsRCPort=ipsRCPort, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsWebAddrTransAddress=ipsWebAddrTransAddress)
