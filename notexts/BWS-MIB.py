...
NotificationType, Counter64, Integer32, IpAddress, ObjectIdentity, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, ModuleIdentity, iso, TimeTicks, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "Integer32", "IpAddress", "ObjectIdentity", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "ModuleIdentity", "iso", "TimeTicks", "Bits")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrTotSuccess=httpSrvrTotSuccess, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpSrvrAddress=httpSrvrAddress, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpProxyServerReq=httpProxyServerReq, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpProxyParseErr=httpProxyParseErr, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpSrvrPort=httpSrvrPort, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpSrvrTotRefused=httpSrvrTotRefused, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, firmwareStorageHigh=firmwareStorageHigh, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslProxyPort=sslProxyPort, webCacheProtocol=webCacheProtocol, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpProxyTotalReq=httpProxyTotalReq, sslProxyTotalConn=sslProxyTotalConn, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsRCTotDropped=ipsRCTotDropped, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, serviceStatus=serviceStatus, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, webCacheLongHdrs=webCacheLongHdrs, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsRCTotServed=ipsRCTotServed, PYSNMP_MODULE_ID=bws, httpProxyTotalConn=httpProxyTotalConn, linkStatus=linkStatus, ipsUrlPolicyAddress=ipsUrlPolicyAddress, highAvailabilityStatus=highAvailabilityStatus, httpProxyServerErr=httpProxyServerErr, dataPortLinkUp=dataPortLinkUp, bwsServiceStatusEntry=bwsServiceStatusEntry, totalAttacks=totalAttacks, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, switchingToBypassMode=switchingToBypassMode, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, freeMem=freeMem, activeApplications=activeApplications, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrInBytes=httpSrvrInBytes, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsReqLimitPort=ipsReqLimitPort, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslSrvrAddress=sslSrvrAddress, ipsCookieSecTampered=ipsCookieSecTampered, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsCacheStatsEntry=bwsCacheStatsEntry, currentFirmwareVersion=currentFirmwareVersion, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, totalServers=totalServers, dataPathStatus=dataPathStatus, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsStatsGroup=bwsStatsGroup, totalMem=totalMem, webCachePort=webCachePort, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpSrvrState=httpSrvrState, bwsMessage=bwsMessage, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslSrvrTotRefused=sslSrvrTotRefused, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, logStorage=logStorage, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwstraps=bwstraps, ipsUrlAclReserved=ipsUrlAclReserved, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, totalBandwidth=totalBandwidth, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslProxyOutBytes=sslProxyOutBytes, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, tempCritical=tempCritical, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslProxyAddressType=sslProxyAddressType, webCacheStale=webCacheStale, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpProxyActiveConn=httpProxyActiveConn, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, systemFanSpeed=systemFanSpeed, webCacheHits=webCacheHits, httpProxyAddress=httpProxyAddress, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, serviceName=serviceName, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpSrvrTotResponse=httpSrvrTotResponse, peerDown=peerDown, httpSrvrMinResTime=httpSrvrMinResTime, webCacheBytesOut=webCacheBytesOut, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, smAgentName=smAgentName, firmwareUpdateAvailable=firmwareUpdateAvailable, firmwareStorage=firmwareStorage, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlAclPort=ipsUrlAclPort, httpProxyInBytes=httpProxyInBytes, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, tempHigh=tempHigh, ipsUrlNormAddress=ipsUrlNormAddress, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslSrvrNumFreeConn=sslSrvrNumFreeConn, serverUp=serverUp, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, activeServers=activeServers, sslSrvrPort=sslSrvrPort, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, memUtilization=memUtilization, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, dataPortLinkDown=dataPortLinkDown, webCacheCachedObjects=webCacheCachedObjects, sslProxyCurrentConn=sslProxyCurrentConn, totalApplications=totalApplications, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsRCPort=ipsRCPort, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsCompressionStatsTable=bwsCompressionStatsTable, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslSrvrTotResponse=sslSrvrTotResponse, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsCookieSecPort=ipsCookieSecPort, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslProxyActiveConn=sslProxyActiveConn, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, systemFailure=systemFailure, httpProxySessionTimeOut=httpProxySessionTimeOut, serverDown=serverDown, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslSrvrTotSuccess=sslSrvrTotSuccess, cpuUtilization=cpuUtilization, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslSrvrAddressType=sslSrvrAddressType, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsRCTotQueued=ipsRCTotQueued, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bws=bws, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrOutBytes=httpSrvrOutBytes, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, servicePort=servicePort, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslSrvrSrvcPort=sslSrvrSrvcPort, switchingToMaintMode=switchingToMaintMode, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, webCacheMiss=webCacheMiss, bwsTrapGroup=bwsTrapGroup, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsMIBCompliances=bwsMIBCompliances, logStorageHigh=logStorageHigh, sharedSecretKeyExpired=sharedSecretKeyExpired, operationalMode=operationalMode, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrInBytes=sslSrvrInBytes, switchingToInlineMode=switchingToInlineMode, systemFailOver=systemFailOver, bwsMIBGroups=bwsMIBGroups, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsReqSrvcPort=ipsReqSrvcPort, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsUrlNormPort=ipsUrlNormPort, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpProxyOutBytes=httpProxyOutBytes, ipsRCAddress=ipsRCAddress, ipsHdrAclAddress=ipsHdrAclAddress, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsHdrAclPort=ipsHdrAclPort, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpSrvrAvgResTime=httpSrvrAvgResTime, cpuTemperature=cpuTemperature, webCmprProtocol=webCmprProtocol, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpProxyServerAbrt=httpProxyServerAbrt, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpProxyPort=httpProxyPort, uptime=uptime, bwsCacheStatsTable=bwsCacheStatsTable, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsReqSrvcAddress=ipsReqSrvcAddress, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsCookieSecAddress=ipsCookieSecAddress, webCmprAddressType=webCmprAddressType, httpSrvrNumConn=httpSrvrNumConn, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, smRealmName=smRealmName, ipsUrlAclAddress=ipsUrlAclAddress, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsStats=bwsStats, sslSrvrMaxResTime=sslSrvrMaxResTime, virusDefUpdates=virusDefUpdates, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsMIBConformance=bwsMIBConformance, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, systemSerialNumber=systemSerialNumber, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsWebAddrTransPort=ipsWebAddrTransPort, raidDegrading=raidDegrading, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, energizeUpdateExpire=energizeUpdateExpire, ipsRCTimeStamp=ipsRCTimeStamp, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpProxyUnknownRsp=httpProxyUnknownRsp)
mibBuilder.exportSymbols("BWS-MIB", bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrNumConn=sslSrvrNumConn, peerUp=peerUp, bwsServiceStatusTable=bwsServiceStatusTable, bwsMIBCompliance=bwsMIBCompliance, cpuFanSpeed=cpuFanSpeed, webCmprPort=webCmprPort, ipsWebAddrTransAddress=ipsWebAddrTransAddress, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsReqLimitAddressType=ipsReqLimitAddressType, serviceAddress=serviceAddress, ipsRCAddressType=ipsRCAddressType, ipsLrnSrvcPort=ipsLrnSrvcPort, sslProxyCacheHits=sslProxyCacheHits, srvcName=srvcName, sslSrvrOutBytes=sslSrvrOutBytes, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsReqLimitAddress=ipsReqLimitAddress, sslProxyErrPms=sslProxyErrPms, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslProxyBadCRLErr=sslProxyBadCRLErr, httpProxyAddressType=httpProxyAddressType, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, webCmprAddress=webCmprAddress, webCacheReq=webCacheReq, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, vipStatus=vipStatus, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslProxyTotalReq=sslProxyTotalReq, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrState=sslSrvrState, processCountHigh=processCountHigh, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, securityDefUpdates=securityDefUpdates, smNumUserSessions=smNumUserSessions, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsHdrAclHits=ipsHdrAclHits, memoryUsageHigh=memoryUsageHigh, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsUrlNormAddressType=ipsUrlNormAddressType, webCacheAddress=webCacheAddress, httpSrvrAddressType=httpSrvrAddressType, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslProxyInBytes=sslProxyInBytes, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslProxyBadDNCErr=sslProxyBadDNCErr, webCacheAddressType=webCacheAddressType, httpSrvrSrvcAddress=httpSrvrSrvcAddress, systemLoad=systemLoad, sslProxyAddress=sslProxyAddress, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, webCacheCacheableRes=webCacheCacheableRes, fanDead=fanDead, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType)
