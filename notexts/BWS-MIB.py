...
IpAddress, NotificationType, Gauge32, ModuleIdentity, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, Counter32, Counter64, ObjectIdentity, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "Gauge32", "ModuleIdentity", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "Counter32", "Counter64", "ObjectIdentity", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("BWS-MIB", activeServers=activeServers, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, webCacheHits=webCacheHits, sslSrvrSrvcPort=sslSrvrSrvcPort, totalApplications=totalApplications, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, serviceAddress=serviceAddress, httpSrvrTotTimedout=httpSrvrTotTimedout, serverUp=serverUp, httpProxyServerErr=httpProxyServerErr, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsWebAddrTransAddress=ipsWebAddrTransAddress, tempCritical=tempCritical, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsLrnSrvcPort=ipsLrnSrvcPort, energizeUpdateExpire=energizeUpdateExpire, bwsMIBCompliance=bwsMIBCompliance, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, srvcName=srvcName, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrState=sslSrvrState, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, memUtilization=memUtilization, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, webCacheAddressType=webCacheAddressType, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, totalBandwidth=totalBandwidth, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrInBytes=sslSrvrInBytes, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslSrvrOutBytes=sslSrvrOutBytes, memoryUsageHigh=memoryUsageHigh, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsLrnSrvcAddress=ipsLrnSrvcAddress, cpuFanSpeed=cpuFanSpeed, webCacheBytesOut=webCacheBytesOut, smAgentName=smAgentName, webCmprPort=webCmprPort, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrAddressType=httpSrvrAddressType, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsSMUserSessionTable=bwsSMUserSessionTable, cpuTemperature=cpuTemperature, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, peerUp=peerUp, operationalMode=operationalMode, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, servicePort=servicePort, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslProxyErrPms=sslProxyErrPms, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpSrvrTotResponse=httpSrvrTotResponse, webCacheStale=webCacheStale, httpProxyTotalReq=httpProxyTotalReq, dataPathStatus=dataPathStatus, httpProxyActiveConn=httpProxyActiveConn, webCacheReq=webCacheReq, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslProxyCacheHits=sslProxyCacheHits, ipsHdrAclHits=ipsHdrAclHits, sslSrvrMinResTime=sslSrvrMinResTime, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, webCacheCachedObjects=webCacheCachedObjects, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsRCAddress=ipsRCAddress, httpSrvrMinResTime=httpSrvrMinResTime, httpProxyInBytes=httpProxyInBytes, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, dataPortLinkDown=dataPortLinkDown, firmwareUpdateAvailable=firmwareUpdateAvailable, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpSrvrPort=httpSrvrPort, firmwareStorage=firmwareStorage, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, webCacheCacheableRes=webCacheCacheableRes, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsHdrAclAddressType=ipsHdrAclAddressType, totalMem=totalMem, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpProxyServerAbrt=httpProxyServerAbrt, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsMIBCompliances=bwsMIBCompliances, systemLoad=systemLoad, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsMessage=bwsMessage, bws=bws, switchingToMaintMode=switchingToMaintMode, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsWebAddrTransPort=ipsWebAddrTransPort, uptime=uptime, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpSrvrTotRefused=httpSrvrTotRefused, sslProxyInBytes=sslProxyInBytes, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, dataPortLinkUp=dataPortLinkUp, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, highAvailabilityStatus=highAvailabilityStatus, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsReqSrvcPort=ipsReqSrvcPort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpProxyTotalConn=httpProxyTotalConn, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, activeApplications=activeApplications, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, serviceName=serviceName, securityDefUpdates=securityDefUpdates, systemSerialNumber=systemSerialNumber, logStorage=logStorage, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslProxyBadDNCErr=sslProxyBadDNCErr, httpProxySessionTimeOut=httpProxySessionTimeOut, peerDown=peerDown, sslProxyAddress=sslProxyAddress, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsCacheStatsTable=bwsCacheStatsTable, sslProxyCurrentConn=sslProxyCurrentConn, ipsCookieSecAddress=ipsCookieSecAddress, sslProxyAddressType=sslProxyAddressType, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsRCTotDropped=ipsRCTotDropped, freeMem=freeMem, ipsUrlNormPort=ipsUrlNormPort, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsRCAddressType=ipsRCAddressType, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsRCTotQueued=ipsRCTotQueued, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsUrlAclPort=ipsUrlAclPort, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, serviceStatus=serviceStatus, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsServiceStatusTable=bwsServiceStatusTable, logStorageHigh=logStorageHigh, PYSNMP_MODULE_ID=bws, linkStatus=linkStatus, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslProxyTotalConn=sslProxyTotalConn, totalAttacks=totalAttacks, ipsHdrAclPort=ipsHdrAclPort, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslSrvrAddress=sslSrvrAddress, ipsHdrAclAddress=ipsHdrAclAddress, sslSrvrNumConn=sslSrvrNumConn, ipsRCTotServed=ipsRCTotServed, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsRCTotOutOfResource=ipsRCTotOutOfResource, switchingToBypassMode=switchingToBypassMode, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrPort=sslSrvrPort, httpSrvrAddress=httpSrvrAddress, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, switchingToInlineMode=switchingToInlineMode, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsReqLimitAddress=ipsReqLimitAddress, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpSrvrAvgResTime=httpSrvrAvgResTime, totalServers=totalServers, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslProxyCacheTimeouts=sslProxyCacheTimeouts, webCmprAddressType=webCmprAddressType, httpProxyPort=httpProxyPort, httpSrvrOutBytes=httpSrvrOutBytes, ipsRCTimeStamp=ipsRCTimeStamp, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, webCacheLongHdrs=webCacheLongHdrs, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsTrapGroup=bwsTrapGroup, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, webCacheProtocol=webCacheProtocol, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpProxyOutBytes=httpProxyOutBytes, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrTotResponse=sslSrvrTotResponse, vipStatus=vipStatus, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsMIBGroups=bwsMIBGroups, bwsStatsGroup=bwsStatsGroup, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsSslProxyStatsTable=bwsSslProxyStatsTable, serverDown=serverDown, systemFailure=systemFailure, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, webCmprAddress=webCmprAddress, sslProxyCacheMiss=sslProxyCacheMiss, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslSrvrAddressType=sslSrvrAddressType, bwsStats=bwsStats, ipsUrlNormAddress=ipsUrlNormAddress, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpProxyServerReq=httpProxyServerReq, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsAccessCtrlPort=ipsAccessCtrlPort, raidDegrading=raidDegrading, tempHigh=tempHigh, httpSrvrNumConn=httpSrvrNumConn, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpProxyAddressType=httpProxyAddressType, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsRCPort=ipsRCPort, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated)
mibBuilder.exportSymbols("BWS-MIB", processCountHigh=processCountHigh, webCacheMiss=webCacheMiss, sslProxyTotalReq=sslProxyTotalReq, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsCookieSecPort=ipsCookieSecPort, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslProxyOutBytes=sslProxyOutBytes, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsUrlAclAddress=ipsUrlAclAddress, webCmprProtocol=webCmprProtocol, bwsMIBConformance=bwsMIBConformance, firmwareStorageHigh=firmwareStorageHigh, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpSrvrState=httpSrvrState, sslSrvrTotTimedout=sslSrvrTotTimedout, httpProxyClientAbrt=httpProxyClientAbrt, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, systemFanSpeed=systemFanSpeed, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpProxyParseErr=httpProxyParseErr, virusDefUpdates=virusDefUpdates, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpSrvrInBytes=httpSrvrInBytes, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, smNumUserSessions=smNumUserSessions, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslProxyActiveConn=sslProxyActiveConn, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrTotRefused=sslSrvrTotRefused, webCacheAddress=webCacheAddress, smRealmName=smRealmName, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, currentFirmwareVersion=currentFirmwareVersion, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwstraps=bwstraps, cpuUtilization=cpuUtilization, webCachePort=webCachePort, sharedSecretKeyExpired=sharedSecretKeyExpired, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsReqLimitPort=ipsReqLimitPort, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslProxyPort=sslProxyPort, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpProxyAddress=httpProxyAddress, webCmprCompressibleDataSize=webCmprCompressibleDataSize, systemFailOver=systemFailOver, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsCookieSecTampered=ipsCookieSecTampered, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, fanDead=fanDead)
