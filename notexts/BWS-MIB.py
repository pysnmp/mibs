...
MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, TimeTicks, IpAddress, ObjectIdentity, Counter32, ModuleIdentity, Counter64, Integer32, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "TimeTicks", "IpAddress", "ObjectIdentity", "Counter32", "ModuleIdentity", "Counter64", "Integer32", "Gauge32", "iso")
...
mibBuilder.exportSymbols("BWS-MIB", ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslProxyAddressType=sslProxyAddressType, sslProxyActiveConn=sslProxyActiveConn, httpSrvrAddress=httpSrvrAddress, fanDead=fanDead, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslSrvrTotTimedout=sslSrvrTotTimedout, totalServers=totalServers, httpProxyAddress=httpProxyAddress, webCacheHits=webCacheHits, peerUp=peerUp, tempCritical=tempCritical, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, dataPortLinkDown=dataPortLinkDown, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, operationalMode=operationalMode, sslSrvrPort=sslSrvrPort, systemFanSpeed=systemFanSpeed, httpSrvrMinResTime=httpSrvrMinResTime, currentFirmwareVersion=currentFirmwareVersion, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, firmwareStorage=firmwareStorage, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrOutBytes=httpSrvrOutBytes, totalApplications=totalApplications, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsReqLimitAddressType=ipsReqLimitAddressType, switchingToMaintMode=switchingToMaintMode, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, cpuFanSpeed=cpuFanSpeed, smNumUserSessions=smNumUserSessions, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, PYSNMP_MODULE_ID=bws, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, cpuTemperature=cpuTemperature, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsRCAddressType=ipsRCAddressType, dataPathStatus=dataPathStatus, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpProxyAddressType=httpProxyAddressType, serviceName=serviceName, freeMem=freeMem, ipsCookieSecTampered=ipsCookieSecTampered, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsServiceStatusTable=bwsServiceStatusTable, bwsMessage=bwsMessage, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpSrvrTotReqRejected=httpSrvrTotReqRejected, totalAttacks=totalAttacks, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, webCmprAddressType=webCmprAddressType, systemFailure=systemFailure, firmwareStorageHigh=firmwareStorageHigh, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, webCacheProtocol=webCacheProtocol, smRealmName=smRealmName, ipsRCPort=ipsRCPort, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsHdrAclPort=ipsHdrAclPort, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsRCAddress=ipsRCAddress, sslProxyCacheHits=sslProxyCacheHits, httpSrvrInBytes=httpSrvrInBytes, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsReqLimitAddress=ipsReqLimitAddress, bwsTrapGroup=bwsTrapGroup, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, totalBandwidth=totalBandwidth, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslProxyCurrentConn=sslProxyCurrentConn, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, activeApplications=activeApplications, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, webCacheStale=webCacheStale, httpProxyOutBytes=httpProxyOutBytes, httpSrvrPort=httpSrvrPort, ipsUrlAclReserved=ipsUrlAclReserved, webCacheMiss=webCacheMiss, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslSrvrInBytes=sslSrvrInBytes, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, webCacheBytesOut=webCacheBytesOut, linkStatus=linkStatus, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsUrlAclPort=ipsUrlAclPort, bwsSMUserSessionEntry=bwsSMUserSessionEntry, srvcName=srvcName, sslSrvrMinResTime=sslSrvrMinResTime, webCacheAddressType=webCacheAddressType, bwsMIBConformance=bwsMIBConformance, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, servicePort=servicePort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, smAgentName=smAgentName, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsMIBCompliances=bwsMIBCompliances, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlAclAddress=ipsUrlAclAddress, sslSrvrTotResponse=sslSrvrTotResponse, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrTotRefused=sslSrvrTotRefused, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsUrlNormPort=ipsUrlNormPort, httpSrvrAvgResTime=httpSrvrAvgResTime, httpProxyClientAbrt=httpProxyClientAbrt, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, processCountHigh=processCountHigh, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpSrvrState=httpSrvrState, serviceStatus=serviceStatus, logStorage=logStorage, sslSrvrSrvcPort=sslSrvrSrvcPort, httpSrvrTotRefused=httpSrvrTotRefused, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpProxyServerErr=httpProxyServerErr, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, logStorageHigh=logStorageHigh, systemSerialNumber=systemSerialNumber, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslSrvrOutBytes=sslSrvrOutBytes, sslProxyPort=sslProxyPort, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, securityDefUpdates=securityDefUpdates, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, switchingToInlineMode=switchingToInlineMode, httpProxyInBytes=httpProxyInBytes, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsHdrAclAddressType=ipsHdrAclAddressType, sslProxyErrPms=sslProxyErrPms, systemFailOver=systemFailOver, bwsMIBGroups=bwsMIBGroups, switchingToBypassMode=switchingToBypassMode, ipsHdrAclAddress=ipsHdrAclAddress, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslProxyBadCRLErr=sslProxyBadCRLErr, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, webCachePort=webCachePort, httpSrvrAddressType=httpSrvrAddressType, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, webCacheCacheableRes=webCacheCacheableRes, sslSrvrState=sslSrvrState, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwstraps=bwstraps, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpProxyTotalConn=httpProxyTotalConn, ipsRCTotQueued=ipsRCTotQueued, ipsUrlPolicyPort=ipsUrlPolicyPort, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sharedSecretKeyExpired=sharedSecretKeyExpired, energizeUpdateExpire=energizeUpdateExpire, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, peerDown=peerDown, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, webCmprPort=webCmprPort, httpProxyActiveConn=httpProxyActiveConn, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, webCacheLongHdrs=webCacheLongHdrs, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpSrvrSrvcPort=httpSrvrSrvcPort, webCacheCachedObjects=webCacheCachedObjects, tempHigh=tempHigh, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, highAvailabilityStatus=highAvailabilityStatus, ipsReqSrvcPort=ipsReqSrvcPort, cpuUtilization=cpuUtilization, bwsStatsGroup=bwsStatsGroup, virusDefUpdates=virusDefUpdates, uptime=uptime, systemLoad=systemLoad, httpProxyPort=httpProxyPort, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslProxyInBytes=sslProxyInBytes, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrAddressType=sslSrvrAddressType, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpProxyWAFWarnings=httpProxyWAFWarnings, totalMem=totalMem, sslProxyCacheMiss=sslProxyCacheMiss, bwsMIBCompliance=bwsMIBCompliance, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrTotTimedout=httpSrvrTotTimedout, httpProxyParseErr=httpProxyParseErr)
mibBuilder.exportSymbols("BWS-MIB", raidDegrading=raidDegrading, sslProxyTotalConn=sslProxyTotalConn, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpProxyTotalReq=httpProxyTotalReq, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpProxyServerReq=httpProxyServerReq, webCacheAddress=webCacheAddress, serverUp=serverUp, bwsStats=bwsStats, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslSrvrAddress=sslSrvrAddress, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, serverDown=serverDown, httpSrvrNumConn=httpSrvrNumConn, ipsCookieSecPort=ipsCookieSecPort, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsRCTimeStamp=ipsRCTimeStamp, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrSrvcAddress=httpSrvrSrvcAddress, activeServers=activeServers, vipStatus=vipStatus, httpProxyUnknownRsp=httpProxyUnknownRsp, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsAccessCtrlPort=ipsAccessCtrlPort, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, webCmprProtocol=webCmprProtocol, ipsCookieSecAddress=ipsCookieSecAddress, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrAvgResTime=sslSrvrAvgResTime, httpProxyServerAbrt=httpProxyServerAbrt, webCmprAddress=webCmprAddress, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsRCTotDropped=ipsRCTotDropped, sslProxyAddress=sslProxyAddress, bws=bws, webCacheReq=webCacheReq, memUtilization=memUtilization, ipsRCTotServed=ipsRCTotServed, memoryUsageHigh=memoryUsageHigh, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, serviceAddress=serviceAddress, sslProxyTotalReq=sslProxyTotalReq, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsHdrAclHits=ipsHdrAclHits, sslSrvrNumConn=sslSrvrNumConn, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, dataPortLinkUp=dataPortLinkUp, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsReqLimitPort=ipsReqLimitPort, sslProxyOutBytes=sslProxyOutBytes, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr)
