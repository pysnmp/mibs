...
TimeTicks, Bits, Integer32, ObjectIdentity, Counter32, ModuleIdentity, iso, IpAddress, NotificationType, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "Integer32", "ObjectIdentity", "Counter32", "ModuleIdentity", "iso", "IpAddress", "NotificationType", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("BWS-MIB", bws=bws, sslProxyPort=sslProxyPort, tempCritical=tempCritical, peerUp=peerUp, httpSrvrNumConn=httpSrvrNumConn, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, webCmprAddress=webCmprAddress, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsCookieSecPort=ipsCookieSecPort, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, totalServers=totalServers, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, totalBandwidth=totalBandwidth, sslProxyActiveConn=sslProxyActiveConn, smAgentName=smAgentName, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, totalAttacks=totalAttacks, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsCacheStatsEntry=bwsCacheStatsEntry, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsMIBConformance=bwsMIBConformance, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, dataPortLinkDown=dataPortLinkDown, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, webCacheProtocol=webCacheProtocol, serviceName=serviceName, firmwareUpdateAvailable=firmwareUpdateAvailable, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsMIBCompliance=bwsMIBCompliance, bwsMIBGroups=bwsMIBGroups, sslSrvrMaxResTime=sslSrvrMaxResTime, systemSerialNumber=systemSerialNumber, ipsUrlNormPort=ipsUrlNormPort, sslSrvrTotResponse=sslSrvrTotResponse, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrTotRefused=httpSrvrTotRefused, memUtilization=memUtilization, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpSrvrAddressType=httpSrvrAddressType, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslSrvrNumConn=sslSrvrNumConn, ipsRCAddress=ipsRCAddress, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpProxyClientAbrt=httpProxyClientAbrt, peerDown=peerDown, webCmprPort=webCmprPort, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsServiceStatusTable=bwsServiceStatusTable, httpSrvrNumFreeConn=httpSrvrNumFreeConn, fanDead=fanDead, webCacheCachedObjects=webCacheCachedObjects, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsReqSrvcAddressType=ipsReqSrvcAddressType, switchingToBypassMode=switchingToBypassMode, httpSrvrPort=httpSrvrPort, sslProxyAddress=sslProxyAddress, logStorageHigh=logStorageHigh, totalMem=totalMem, httpProxyUnknownRsp=httpProxyUnknownRsp, serviceStatus=serviceStatus, httpProxyServerAbrt=httpProxyServerAbrt, ipsHdrAclPort=ipsHdrAclPort, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, dataPathStatus=dataPathStatus, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsReqSrvcAddress=ipsReqSrvcAddress, currentFirmwareVersion=currentFirmwareVersion, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, webCacheLongHdrs=webCacheLongHdrs, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsStatsGroup=bwsStatsGroup, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, cpuUtilization=cpuUtilization, bwsMessage=bwsMessage, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, webCacheHits=webCacheHits, httpProxyServerReq=httpProxyServerReq, ipsUrlNormAddress=ipsUrlNormAddress, sslSrvrSrvcPort=sslSrvrSrvcPort, httpSrvrState=httpSrvrState, operationalMode=operationalMode, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslSrvrPort=sslSrvrPort, firmwareStorageHigh=firmwareStorageHigh, ipsHdrAclAddress=ipsHdrAclAddress, serverDown=serverDown, firmwareStorage=firmwareStorage, sslSrvrState=sslSrvrState, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpProxyTotalReq=httpProxyTotalReq, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, smRealmName=smRealmName, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, totalApplications=totalApplications, servicePort=servicePort, activeApplications=activeApplications, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, webCacheReq=webCacheReq, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsReqSrvcPort=ipsReqSrvcPort, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslProxyCurrentConn=sslProxyCurrentConn, sslSrvrOutBytes=sslSrvrOutBytes, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpProxyAddress=httpProxyAddress, webCachePort=webCachePort, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, activeServers=activeServers, sslSrvrAddress=sslSrvrAddress, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslProxyOutBytes=sslProxyOutBytes, ipsRCTimeStamp=ipsRCTimeStamp, processCountHigh=processCountHigh, freeMem=freeMem, httpProxyOutBytes=httpProxyOutBytes, httpSrvrInBytes=httpSrvrInBytes, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsIpsRCStatsTable=bwsIpsRCStatsTable, dataPortLinkUp=dataPortLinkUp, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpProxyPort=httpProxyPort, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrTotReqRejected=sslSrvrTotReqRejected, raidDegrading=raidDegrading, httpProxyParseErr=httpProxyParseErr, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslSrvrAddressType=sslSrvrAddressType, sslProxyBadCRLErr=sslProxyBadCRLErr, systemFailOver=systemFailOver, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsRCTotQueued=ipsRCTotQueued, uptime=uptime, ipsUrlAclReserved=ipsUrlAclReserved, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsRCTotDropped=ipsRCTotDropped, bwsCacheStatsTable=bwsCacheStatsTable, energizeUpdateExpire=energizeUpdateExpire, PYSNMP_MODULE_ID=bws, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpSrvrAddress=httpSrvrAddress, linkStatus=linkStatus, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsReqLimitAddress=ipsReqLimitAddress, httpProxyTotalConn=httpProxyTotalConn, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsRCTotServed=ipsRCTotServed, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, systemFanSpeed=systemFanSpeed, httpSrvrAvgResTime=httpSrvrAvgResTime, webCacheBytesOut=webCacheBytesOut, virusDefUpdates=virusDefUpdates, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, webCmprAddressType=webCmprAddressType, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, webCacheStale=webCacheStale, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, webCacheAddress=webCacheAddress, httpProxyAddressType=httpProxyAddressType, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrTotRefused=sslSrvrTotRefused, srvcName=srvcName, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, systemLoad=systemLoad, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpProxyActiveConn=httpProxyActiveConn, bwsTrapGroup=bwsTrapGroup, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslProxyTotalReq=sslProxyTotalReq, httpSrvrMinResTime=httpSrvrMinResTime, httpSrvrOutBytes=httpSrvrOutBytes, sslProxyCacheMiss=sslProxyCacheMiss, cpuTemperature=cpuTemperature, webCacheCacheableRes=webCacheCacheableRes, serverUp=serverUp, logStorage=logStorage, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsCookieSecAddress=ipsCookieSecAddress)
mibBuilder.exportSymbols("BWS-MIB", webCacheAddressType=webCacheAddressType, sslSrvrInBytes=sslSrvrInBytes, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsReqLimitPort=ipsReqLimitPort, switchingToInlineMode=switchingToInlineMode, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslProxyTotalConn=sslProxyTotalConn, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsStats=bwsStats, switchingToMaintMode=switchingToMaintMode, httpProxyWAFWarnings=httpProxyWAFWarnings, sslProxyErrPms=sslProxyErrPms, ipsRCAddressType=ipsRCAddressType, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, smNumUserSessions=smNumUserSessions, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslProxyAddressType=sslProxyAddressType, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsAccessCtrlPort=ipsAccessCtrlPort, webCmprProtocol=webCmprProtocol, ipsUrlNormAddressType=ipsUrlNormAddressType, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrTotReqRejected=httpSrvrTotReqRejected, cpuFanSpeed=cpuFanSpeed, ipsRCPort=ipsRCPort, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsHdrAclHits=ipsHdrAclHits, tempHigh=tempHigh, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, serviceAddress=serviceAddress, memoryUsageHigh=memoryUsageHigh, ipsCookieSecAddressType=ipsCookieSecAddressType, httpProxyInBytes=httpProxyInBytes, httpSrvrTotResponse=httpSrvrTotResponse, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsUrlAclAddress=ipsUrlAclAddress, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrMinResTime=sslSrvrMinResTime, webCacheMiss=webCacheMiss, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, systemFailure=systemFailure, ipsUrlAclAddressType=ipsUrlAclAddressType, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsMIBCompliances=bwsMIBCompliances, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, highAvailabilityStatus=highAvailabilityStatus, ipsUrlAclPort=ipsUrlAclPort, bwstraps=bwstraps, ipsCookieSecTampered=ipsCookieSecTampered, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslProxyCacheHits=sslProxyCacheHits, sslProxyInBytes=sslProxyInBytes, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpProxyServerErr=httpProxyServerErr, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, vipStatus=vipStatus, securityDefUpdates=securityDefUpdates)
