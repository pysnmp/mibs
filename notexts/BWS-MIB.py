...
Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, Counter64, Unsigned32, TimeTicks, Integer32, MibIdentifier, ModuleIdentity, IpAddress, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "Counter64", "Unsigned32", "TimeTicks", "Integer32", "MibIdentifier", "ModuleIdentity", "IpAddress", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", bwsStatsGroup=bwsStatsGroup, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, totalApplications=totalApplications, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, tempHigh=tempHigh, webCacheCacheableRes=webCacheCacheableRes, httpSrvrTotRefused=httpSrvrTotRefused, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsWebAddrTransPort=ipsWebAddrTransPort, webCacheBytesOut=webCacheBytesOut, sslProxyInBytes=sslProxyInBytes, ipsUrlAclReserved=ipsUrlAclReserved, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrTotReqRejected=httpSrvrTotReqRejected, webCacheProtocol=webCacheProtocol, httpSrvrInBytes=httpSrvrInBytes, webCacheCachedObjects=webCacheCachedObjects, vipStatus=vipStatus, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsCookieSecAddressType=ipsCookieSecAddressType, linkStatus=linkStatus, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, totalServers=totalServers, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, PYSNMP_MODULE_ID=bws, switchingToMaintMode=switchingToMaintMode, bwsServiceStatusTable=bwsServiceStatusTable, fanDead=fanDead, httpSrvrNumConn=httpSrvrNumConn, sslSrvrMaxResTime=sslSrvrMaxResTime, webCachePort=webCachePort, bwsCacheStatsTable=bwsCacheStatsTable, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsCacheStatsEntry=bwsCacheStatsEntry, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, serviceName=serviceName, bwsStats=bwsStats, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrMaxResTime=httpSrvrMaxResTime, sslSrvrOutBytes=sslSrvrOutBytes, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, cpuFanSpeed=cpuFanSpeed, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, switchingToBypassMode=switchingToBypassMode, httpProxyAddress=httpProxyAddress, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, webCacheLongHdrs=webCacheLongHdrs, httpProxyTotalConn=httpProxyTotalConn, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsRCTimeStamp=ipsRCTimeStamp, ipsReqLimitPort=ipsReqLimitPort, sslProxyCacheHits=sslProxyCacheHits, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bws=bws, ipsAccessCtrlAddress=ipsAccessCtrlAddress, logStorage=logStorage, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, systemSerialNumber=systemSerialNumber, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpSrvrTotResponse=httpSrvrTotResponse, webCacheAddressType=webCacheAddressType, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpProxyPort=httpProxyPort, httpSrvrPort=httpSrvrPort, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslProxyTotalReq=sslProxyTotalReq, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsHdrAclPort=ipsHdrAclPort, serviceAddress=serviceAddress, ipsCookieSecPort=ipsCookieSecPort, ipsRCTotServed=ipsRCTotServed, ipsRCTotDropped=ipsRCTotDropped, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsUrlNormPort=ipsUrlNormPort, webCacheStale=webCacheStale, httpProxyTotalReq=httpProxyTotalReq, totalMem=totalMem, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsRCAddress=ipsRCAddress, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, webCmprProtocol=webCmprProtocol, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpProxyWAFWarnings=httpProxyWAFWarnings, serviceStatus=serviceStatus, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsRCPort=ipsRCPort, raidDegrading=raidDegrading, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrAddressType=sslSrvrAddressType, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrTotReqActive=httpSrvrTotReqActive, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpProxyUnknownRsp=httpProxyUnknownRsp, systemFailOver=systemFailOver, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, systemFanSpeed=systemFanSpeed, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, energizeUpdateExpire=energizeUpdateExpire, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, smRealmName=smRealmName, httpProxySessionTimeOut=httpProxySessionTimeOut, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsTrapGroup=bwsTrapGroup, totalBandwidth=totalBandwidth, sslProxyTotalConn=sslProxyTotalConn, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsReqSrvcPort=ipsReqSrvcPort, sslSrvrInBytes=sslSrvrInBytes, httpSrvrTotTimedout=httpSrvrTotTimedout, smNumUserSessions=smNumUserSessions, dataPathStatus=dataPathStatus, httpProxyInBytes=httpProxyInBytes, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, serverDown=serverDown, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpProxyOutBytes=httpProxyOutBytes, freeMem=freeMem, ipsUrlAclAddress=ipsUrlAclAddress, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrPort=sslSrvrPort, uptime=uptime, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrAddressType=httpSrvrAddressType, bwsMIBGroups=bwsMIBGroups, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, dataPortLinkUp=dataPortLinkUp, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, webCmprPort=webCmprPort, ipsUrlNormAddress=ipsUrlNormAddress, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsHdrAclAddressType=ipsHdrAclAddressType, sslProxyActiveConn=sslProxyActiveConn, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, systemFailure=systemFailure, peerDown=peerDown, dataPortLinkDown=dataPortLinkDown, activeApplications=activeApplications, bwsIpsRCStatsTable=bwsIpsRCStatsTable, virusDefUpdates=virusDefUpdates, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpProxyActiveConn=httpProxyActiveConn, ipsUrlAclPort=ipsUrlAclPort, webCmprAddress=webCmprAddress, httpProxyParseErr=httpProxyParseErr, httpSrvrMinResTime=httpSrvrMinResTime, webCacheAddress=webCacheAddress, webCacheHits=webCacheHits, bwsMIBConformance=bwsMIBConformance, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslSrvrNumConn=sslSrvrNumConn, systemLoad=systemLoad, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpProxyClientAbrt=httpProxyClientAbrt, sslProxyAddress=sslProxyAddress, memoryUsageHigh=memoryUsageHigh, tempCritical=tempCritical, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwstraps=bwstraps, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, serverUp=serverUp, ipsRCAddressType=ipsRCAddressType, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsReqLimitAddress=ipsReqLimitAddress, processCountHigh=processCountHigh, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslProxyAddressType=sslProxyAddressType, firmwareStorage=firmwareStorage, ipsReqSrvcAddressType=ipsReqSrvcAddressType, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsReqLimitAddressType=ipsReqLimitAddressType, sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrAddress=httpSrvrAddress, sslProxyPort=sslProxyPort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, smAgentName=smAgentName, sslSrvrState=sslSrvrState, sslProxyCurrentConn=sslProxyCurrentConn, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsAccessCtrlPort=ipsAccessCtrlPort, sslProxyOutBytes=sslProxyOutBytes, webCacheMiss=webCacheMiss, sslSrvrTotTimedout=sslSrvrTotTimedout, bwsMIBCompliances=bwsMIBCompliances, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsSMUserSessionTable=bwsSMUserSessionTable, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled)
mibBuilder.exportSymbols("BWS-MIB", bwsMessage=bwsMessage, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslProxyBadDNCErr=sslProxyBadDNCErr, httpSrvrState=httpSrvrState, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, highAvailabilityStatus=highAvailabilityStatus, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, switchingToInlineMode=switchingToInlineMode, sslSrvrAddress=sslSrvrAddress, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, logStorageHigh=logStorageHigh, ipsHdrAclAddress=ipsHdrAclAddress, webCmprAddressType=webCmprAddressType, sslProxyErrPms=sslProxyErrPms, ipsUrlPolicyAddress=ipsUrlPolicyAddress, peerUp=peerUp, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpProxyServerAbrt=httpProxyServerAbrt, httpProxyServerErr=httpProxyServerErr, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, totalAttacks=totalAttacks, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, servicePort=servicePort, activeServers=activeServers, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsHdrAclHits=ipsHdrAclHits, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslSrvrTotRefused=sslSrvrTotRefused, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsMIBCompliance=bwsMIBCompliance, currentFirmwareVersion=currentFirmwareVersion, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, cpuTemperature=cpuTemperature, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, memUtilization=memUtilization, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, cpuUtilization=cpuUtilization, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpSrvrOutBytes=httpSrvrOutBytes, ipsRCTotQueued=ipsRCTotQueued, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, operationalMode=operationalMode, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrTotResponse=sslSrvrTotResponse, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, firmwareStorageHigh=firmwareStorageHigh, webCacheReq=webCacheReq, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpProxyAddressType=httpProxyAddressType, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrTotSuccess=sslSrvrTotSuccess, httpProxyServerReq=httpProxyServerReq, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, securityDefUpdates=securityDefUpdates, srvcName=srvcName, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslSrvrAvgResTime=sslSrvrAvgResTime)
