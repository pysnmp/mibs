...
Unsigned32, MibIdentifier, Counter32, Integer32, Gauge32, ModuleIdentity, Counter64, Bits, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibIdentifier", "Counter32", "Integer32", "Gauge32", "ModuleIdentity", "Counter64", "Bits", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("BWS-MIB", webCacheMiss=webCacheMiss, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, servicePort=servicePort, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, webCmprPort=webCmprPort, httpProxyTotalReq=httpProxyTotalReq, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, webCmprCompressedDataSize=webCmprCompressedDataSize, serviceStatus=serviceStatus, httpProxyClientAbrt=httpProxyClientAbrt, httpSrvrMaxResTime=httpSrvrMaxResTime, activeApplications=activeApplications, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, systemSerialNumber=systemSerialNumber, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslProxyTotalReq=sslProxyTotalReq, memoryUsageHigh=memoryUsageHigh, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsRCPort=ipsRCPort, httpSrvrAddressType=httpSrvrAddressType, sslProxyCacheHits=sslProxyCacheHits, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsAccessCtrlPort=ipsAccessCtrlPort, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslProxyBadDNCErr=sslProxyBadDNCErr, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsUrlNormPort=ipsUrlNormPort, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, processCountHigh=processCountHigh, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpProxyTotalConn=httpProxyTotalConn, firmwareStorage=firmwareStorage, highAvailabilityStatus=highAvailabilityStatus, httpProxyAddress=httpProxyAddress, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpProxyInBytes=httpProxyInBytes, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, currentFirmwareVersion=currentFirmwareVersion, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrPort=httpSrvrPort, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsCacheStatsEntry=bwsCacheStatsEntry, sslSrvrMinResTime=sslSrvrMinResTime, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, securityDefUpdates=securityDefUpdates, httpProxyServerReq=httpProxyServerReq, ipsRCTimeStamp=ipsRCTimeStamp, webCacheReq=webCacheReq, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, systemFanSpeed=systemFanSpeed, httpProxyServerAbrt=httpProxyServerAbrt, httpSrvrTotTimedout=httpSrvrTotTimedout, webCacheStale=webCacheStale, switchingToMaintMode=switchingToMaintMode, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsStats=bwsStats, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsUrlAclPort=ipsUrlAclPort, ipsRCTotDropped=ipsRCTotDropped, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, systemFailOver=systemFailOver, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsHdrAclHits=ipsHdrAclHits, sslSrvrAvgResTime=sslSrvrAvgResTime, sslSrvrTotRefused=sslSrvrTotRefused, ipsUrlNormAddress=ipsUrlNormAddress, bwsMIBGroups=bwsMIBGroups, sslProxyAddress=sslProxyAddress, httpProxyActiveConn=httpProxyActiveConn, sslProxyActiveConn=sslProxyActiveConn, PYSNMP_MODULE_ID=bws, serverUp=serverUp, sslSrvrInBytes=sslSrvrInBytes, sslProxyErrPms=sslProxyErrPms, sslSrvrState=sslSrvrState, fanDead=fanDead, virusDefUpdates=virusDefUpdates, httpSrvrMinResTime=httpSrvrMinResTime, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslSrvrOutBytes=sslSrvrOutBytes, sslProxyPort=sslProxyPort, ipsRCTotQueued=ipsRCTotQueued, activeServers=activeServers, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsReqLimitPort=ipsReqLimitPort, sslProxyCurrentConn=sslProxyCurrentConn, bwsMIBConformance=bwsMIBConformance, ipsReqLimitAddress=ipsReqLimitAddress, sslSrvrPort=sslSrvrPort, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsUrlAclAddressType=ipsUrlAclAddressType, switchingToBypassMode=switchingToBypassMode, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsRCTotServed=ipsRCTotServed, bwsMIBCompliances=bwsMIBCompliances, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, systemLoad=systemLoad, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, smRealmName=smRealmName, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrTotTimedout=sslSrvrTotTimedout, cpuTemperature=cpuTemperature, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, webCmprProtocol=webCmprProtocol, httpSrvrState=httpSrvrState, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, webCmprAddress=webCmprAddress, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, webCacheCachedObjects=webCacheCachedObjects, bwsTrapGroup=bwsTrapGroup, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsMIBCompliance=bwsMIBCompliance, webCacheHits=webCacheHits, bwstraps=bwstraps, bwsStatsGroup=bwsStatsGroup, httpSrvrOutBytes=httpSrvrOutBytes, bws=bws, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, totalBandwidth=totalBandwidth, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsCookieSecPort=ipsCookieSecPort, httpSrvrNumConn=httpSrvrNumConn, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslSrvrTotResponse=sslSrvrTotResponse, tempCritical=tempCritical, bwsMessage=bwsMessage, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, webCacheAddressType=webCacheAddressType, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsRCAddress=ipsRCAddress, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, operationalMode=operationalMode, sslSrvrNumConn=sslSrvrNumConn, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, totalMem=totalMem, ipsHdrAclAddress=ipsHdrAclAddress, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, systemFailure=systemFailure, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, firmwareStorageHigh=firmwareStorageHigh, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpProxyPort=httpProxyPort, cpuFanSpeed=cpuFanSpeed, webCachePort=webCachePort, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, smAgentName=smAgentName, dataPathStatus=dataPathStatus, linkStatus=linkStatus, logStorageHigh=logStorageHigh, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, totalApplications=totalApplications, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrAddress=sslSrvrAddress, peerUp=peerUp, sslProxyOutBytes=sslProxyOutBytes, energizeUpdateExpire=energizeUpdateExpire, ipsHdrAclPort=ipsHdrAclPort, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, webCmprAddressType=webCmprAddressType, smNumUserSessions=smNumUserSessions, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, logStorage=logStorage, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, webCacheProtocol=webCacheProtocol, sslSrvrMaxResTime=sslSrvrMaxResTime, sslSrvrAddressType=sslSrvrAddressType, httpSrvrTotReqRejected=httpSrvrTotReqRejected, raidDegrading=raidDegrading, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpSrvrAddress=httpSrvrAddress, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, srvcName=srvcName, peerDown=peerDown, vipStatus=vipStatus, bwsSMUserSessionTable=bwsSMUserSessionTable, httpProxyAddressType=httpProxyAddressType, webCacheAddress=webCacheAddress, ipsUrlNormAddressType=ipsUrlNormAddressType, httpSrvrInBytes=httpSrvrInBytes, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsReqSrvcPort=ipsReqSrvcPort, ipsCookieSecTampered=ipsCookieSecTampered, ipsUrlAclReserved=ipsUrlAclReserved, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsCompressionStatsTable=bwsCompressionStatsTable, uptime=uptime, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, dataPortLinkUp=dataPortLinkUp)
mibBuilder.exportSymbols("BWS-MIB", ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, cpuUtilization=cpuUtilization, httpSrvrTotSuccess=httpSrvrTotSuccess, memUtilization=memUtilization, webCacheLongHdrs=webCacheLongHdrs, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, totalAttacks=totalAttacks, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, serviceAddress=serviceAddress, webCacheBytesOut=webCacheBytesOut, sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsSMUserSessionEntry=bwsSMUserSessionEntry, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsUrlAclAddress=ipsUrlAclAddress, httpProxyOutBytes=httpProxyOutBytes, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, tempHigh=tempHigh, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, serviceName=serviceName, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsServiceStatusTable=bwsServiceStatusTable, serverDown=serverDown, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpProxyParseErr=httpProxyParseErr, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslSrvrTotSuccess=sslSrvrTotSuccess, sslProxyTotalConn=sslProxyTotalConn, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsRCAddressType=ipsRCAddressType, dataPortLinkDown=dataPortLinkDown, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, webCacheCacheableRes=webCacheCacheableRes, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, switchingToInlineMode=switchingToInlineMode, ipsCookieSecAddress=ipsCookieSecAddress, httpSrvrTotResponse=httpSrvrTotResponse, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslProxyBadCRLErr=sslProxyBadCRLErr, sharedSecretKeyExpired=sharedSecretKeyExpired, httpProxyServerErr=httpProxyServerErr, totalServers=totalServers, httpSrvrTotReqActive=httpSrvrTotReqActive, sslProxyInBytes=sslProxyInBytes, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslProxyAddressType=sslProxyAddressType, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, freeMem=freeMem, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr)
