...
Unsigned32, Integer32, ModuleIdentity, TimeTicks, NotificationType, iso, Counter32, ObjectIdentity, IpAddress, Counter64, MibIdentifier, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "ModuleIdentity", "TimeTicks", "NotificationType", "iso", "Counter32", "ObjectIdentity", "IpAddress", "Counter64", "MibIdentifier", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("BWS-MIB", ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpProxyInBytes=httpProxyInBytes, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpSrvrTotSuccess=httpSrvrTotSuccess, securityDefUpdates=securityDefUpdates, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslProxyTotalReq=sslProxyTotalReq, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrOutBytes=sslSrvrOutBytes, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslSrvrNumConn=sslSrvrNumConn, bwsTrapGroup=bwsTrapGroup, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsRCTimeStamp=ipsRCTimeStamp, webCacheLongHdrs=webCacheLongHdrs, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, firmwareUpdateAvailable=firmwareUpdateAvailable, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, raidDegrading=raidDegrading, totalBandwidth=totalBandwidth, httpSrvrPort=httpSrvrPort, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpSrvrMinResTime=httpSrvrMinResTime, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslSrvrPort=sslSrvrPort, totalServers=totalServers, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpProxyWAFWarnings=httpProxyWAFWarnings, httpProxyAddressType=httpProxyAddressType, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrState=httpSrvrState, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, cpuUtilization=cpuUtilization, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslSrvrTotTimedout=sslSrvrTotTimedout, freeMem=freeMem, switchingToBypassMode=switchingToBypassMode, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, webCacheReq=webCacheReq, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, smRealmName=smRealmName, currentFirmwareVersion=currentFirmwareVersion, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsReqSrvcPort=ipsReqSrvcPort, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslProxyCacheMiss=sslProxyCacheMiss, ipsUrlPolicyPort=ipsUrlPolicyPort, virusDefUpdates=virusDefUpdates, sslSrvrState=sslSrvrState, sslProxyBadCRLErr=sslProxyBadCRLErr, vipStatus=vipStatus, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrAddress=httpSrvrAddress, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrTotReqActive=httpSrvrTotReqActive, cpuTemperature=cpuTemperature, cpuFanSpeed=cpuFanSpeed, highAvailabilityStatus=highAvailabilityStatus, ipsRCTotOutOfResource=ipsRCTotOutOfResource, peerUp=peerUp, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslProxyTotalConn=sslProxyTotalConn, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsMIBCompliances=bwsMIBCompliances, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsRCTotQueued=ipsRCTotQueued, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsStats=bwsStats, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpProxyOutBytes=httpProxyOutBytes, webCacheAddressType=webCacheAddressType, bwsMIBGroups=bwsMIBGroups, httpSrvrAddressType=httpSrvrAddressType, dataPortLinkUp=dataPortLinkUp, systemLoad=systemLoad, ipsRCAddress=ipsRCAddress, sslSrvrAddressType=sslSrvrAddressType, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, serverUp=serverUp, ipsReqLimitPort=ipsReqLimitPort, ipsRCAddressType=ipsRCAddressType, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsRCTotDropped=ipsRCTotDropped, ipsAccessCtrlPort=ipsAccessCtrlPort, httpProxyServerReq=httpProxyServerReq, webCacheHits=webCacheHits, ipsReqSrvcAddress=ipsReqSrvcAddress, processCountHigh=processCountHigh, bwsStatsGroup=bwsStatsGroup, energizeUpdateExpire=energizeUpdateExpire, memUtilization=memUtilization, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsCookieSecAddress=ipsCookieSecAddress, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsHdrAclPort=ipsHdrAclPort, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, peerDown=peerDown, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpProxyTotalConn=httpProxyTotalConn, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsUrlAclAddress=ipsUrlAclAddress, bwsMessage=bwsMessage, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsUrlNormAddress=ipsUrlNormAddress, sslProxyPort=sslProxyPort, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, serviceAddress=serviceAddress, bwsCacheStatsEntry=bwsCacheStatsEntry, webCacheProtocol=webCacheProtocol, systemFailOver=systemFailOver, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsCacheStatsTable=bwsCacheStatsTable, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, firmwareStorageHigh=firmwareStorageHigh, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, smNumUserSessions=smNumUserSessions, tempCritical=tempCritical, activeApplications=activeApplications, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpSrvrTotResponse=httpSrvrTotResponse, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, webCacheCacheableRes=webCacheCacheableRes, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, serviceName=serviceName, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslProxyOutBytes=sslProxyOutBytes, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsMIBConformance=bwsMIBConformance, bwsServiceStatusEntry=bwsServiceStatusEntry, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpProxyActiveConn=httpProxyActiveConn, webCacheCachedObjects=webCacheCachedObjects, ipsReqLimitAddress=ipsReqLimitAddress, httpProxyParseErr=httpProxyParseErr, ipsHdrAclAddress=ipsHdrAclAddress, ipsRCPort=ipsRCPort, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpProxyPort=httpProxyPort, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsCookieSecAddressType=ipsCookieSecAddressType, totalAttacks=totalAttacks, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, dataPortLinkDown=dataPortLinkDown, ipsUrlAclReserved=ipsUrlAclReserved, httpProxyTotalReq=httpProxyTotalReq, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, webCmprProtocol=webCmprProtocol, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsMIBCompliance=bwsMIBCompliance, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, logStorageHigh=logStorageHigh, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, webCacheBytesOut=webCacheBytesOut, httpSrvrInBytes=httpSrvrInBytes, httpSrvrOutBytes=httpSrvrOutBytes, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpProxyAddress=httpProxyAddress, serviceStatus=serviceStatus, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslProxyCurrentConn=sslProxyCurrentConn, srvcName=srvcName, sharedSecretKeyExpired=sharedSecretKeyExpired, httpProxyClientAbrt=httpProxyClientAbrt, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, systemFanSpeed=systemFanSpeed, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsUrlAclPort=ipsUrlAclPort, ipsCookieSecPort=ipsCookieSecPort, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslProxyBadDNCErr=sslProxyBadDNCErr, sslSrvrTotRefused=sslSrvrTotRefused, activeServers=activeServers, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, tempHigh=tempHigh, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, servicePort=servicePort, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwstraps=bwstraps, webCachePort=webCachePort, webCacheAddress=webCacheAddress, fanDead=fanDead, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, operationalMode=operationalMode, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, serverDown=serverDown, uptime=uptime, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, webCmprCompressibleDataSize=webCmprCompressibleDataSize, totalApplications=totalApplications)
mibBuilder.exportSymbols("BWS-MIB", linkStatus=linkStatus, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, webCacheMiss=webCacheMiss, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, systemFailure=systemFailure, sslSrvrAddress=sslSrvrAddress, sslProxyAddress=sslProxyAddress, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpProxyServerAbrt=httpProxyServerAbrt, webCmprAddressType=webCmprAddressType, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, memoryUsageHigh=memoryUsageHigh, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslSrvrAvgResTime=sslSrvrAvgResTime, sslProxyCacheHits=sslProxyCacheHits, httpProxyServerErr=httpProxyServerErr, ipsHdrAclAddressType=ipsHdrAclAddressType, sslProxyActiveConn=sslProxyActiveConn, sslProxyErrPms=sslProxyErrPms, webCmprPort=webCmprPort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, switchingToMaintMode=switchingToMaintMode, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsSMUserSessionTable=bwsSMUserSessionTable, dataPathStatus=dataPathStatus, sslProxyAddressType=sslProxyAddressType, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsHdrAclHits=ipsHdrAclHits, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslSrvrTotResponse=sslSrvrTotResponse, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, firmwareStorage=firmwareStorage, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrInBytes=sslSrvrInBytes, logStorage=logStorage, ipsCookieSecTampered=ipsCookieSecTampered, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, PYSNMP_MODULE_ID=bws, totalMem=totalMem, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, webCmprAddress=webCmprAddress, smAgentName=smAgentName, ipsUrlNormPort=ipsUrlNormPort, ipsRCTotServed=ipsRCTotServed, switchingToInlineMode=switchingToInlineMode, sslProxyInBytes=sslProxyInBytes, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, webCacheStale=webCacheStale, systemSerialNumber=systemSerialNumber, httpSrvrTotRefused=httpSrvrTotRefused, httpSrvrNumConn=httpSrvrNumConn, bws=bws)
