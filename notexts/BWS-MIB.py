...
NotificationType, Counter32, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, ModuleIdentity, MibIdentifier, ObjectIdentity, Unsigned32, iso, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "Unsigned32", "iso", "Gauge32", "Bits")
...
mibBuilder.exportSymbols("BWS-MIB", ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsTrapGroup=bwsTrapGroup, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslSrvrAddress=sslSrvrAddress, serviceStatus=serviceStatus, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, webCacheBytesOut=webCacheBytesOut, firmwareStorageHigh=firmwareStorageHigh, sslSrvrMinResTime=sslSrvrMinResTime, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, totalMem=totalMem, bwsCompressionStatsTable=bwsCompressionStatsTable, bws=bws, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslProxyAddress=sslProxyAddress, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsUrlNormAddressType=ipsUrlNormAddressType, sslProxyCurrentConn=sslProxyCurrentConn, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslProxyTotalReq=sslProxyTotalReq, sslSrvrTotResponse=sslSrvrTotResponse, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsRCTotServed=ipsRCTotServed, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsCacheStatsTable=bwsCacheStatsTable, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsUrlNormPort=ipsUrlNormPort, PYSNMP_MODULE_ID=bws, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsIpsRCStatsTable=bwsIpsRCStatsTable, peerDown=peerDown, bwstraps=bwstraps, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsRCTotDropped=ipsRCTotDropped, sslSrvrInBytes=sslSrvrInBytes, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsServiceStatusEntry=bwsServiceStatusEntry, serviceAddress=serviceAddress, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslSrvrPort=sslSrvrPort, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsRCTotOutOfResource=ipsRCTotOutOfResource, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrSrvcAddress=sslSrvrSrvcAddress, servicePort=servicePort, ipsCookieSecTampered=ipsCookieSecTampered, systemFailOver=systemFailOver, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslProxyCacheHits=sslProxyCacheHits, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpProxyServerErr=httpProxyServerErr, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, switchingToBypassMode=switchingToBypassMode, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, securityDefUpdates=securityDefUpdates, srvcName=srvcName, virusDefUpdates=virusDefUpdates, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, fanDead=fanDead, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, webCacheStale=webCacheStale, tempCritical=tempCritical, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, systemFailure=systemFailure, webCacheReq=webCacheReq, ipsRCAddressType=ipsRCAddressType, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsSMUserSessionTable=bwsSMUserSessionTable, energizeUpdateExpire=energizeUpdateExpire, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpProxyParseErr=httpProxyParseErr, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrInBytes=httpSrvrInBytes, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrNumConn=httpSrvrNumConn, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslProxyTotalConn=sslProxyTotalConn, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrState=sslSrvrState, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsRCTimeStamp=ipsRCTimeStamp, activeServers=activeServers, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpProxyServerReq=httpProxyServerReq, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpSrvrPort=httpSrvrPort, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, logStorageHigh=logStorageHigh, httpSrvrTotReqRejected=httpSrvrTotReqRejected, logStorage=logStorage, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpSrvrTotReqActive=httpSrvrTotReqActive, totalApplications=totalApplications, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsHdrAclAddress=ipsHdrAclAddress, totalServers=totalServers, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsHdrAclHits=ipsHdrAclHits, ipsCookieSecPort=ipsCookieSecPort, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpProxyActiveConn=httpProxyActiveConn, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslSrvrNumConn=sslSrvrNumConn, webCacheAddressType=webCacheAddressType, webCacheLongHdrs=webCacheLongHdrs, highAvailabilityStatus=highAvailabilityStatus, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, systemFanSpeed=systemFanSpeed, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, operationalMode=operationalMode, sslProxyCacheMiss=sslProxyCacheMiss, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpSrvrTotTimedout=httpSrvrTotTimedout, sslProxyPort=sslProxyPort, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrMaxResTime=sslSrvrMaxResTime, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, webCacheCachedObjects=webCacheCachedObjects, sslProxyInBytes=sslProxyInBytes, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, linkStatus=linkStatus, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslProxyActiveConn=sslProxyActiveConn, webCacheCacheableRes=webCacheCacheableRes, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsReqSrvcAddress=ipsReqSrvcAddress, webCacheProtocol=webCacheProtocol, httpProxyPort=httpProxyPort, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpSrvrSrvcAddress=httpSrvrSrvcAddress, webCachePort=webCachePort, smAgentName=smAgentName, webCacheAddress=webCacheAddress, systemSerialNumber=systemSerialNumber, sslSrvrTotReqRejected=sslSrvrTotReqRejected, webCacheMiss=webCacheMiss, webCmprProtocol=webCmprProtocol, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, tempHigh=tempHigh, ipsReqSrvcPort=ipsReqSrvcPort, bwsServiceStatusTable=bwsServiceStatusTable, activeApplications=activeApplications, bwsMIBCompliances=bwsMIBCompliances, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, memUtilization=memUtilization, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, memoryUsageHigh=memoryUsageHigh, httpSrvrAddress=httpSrvrAddress, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpProxyWAFWarnings=httpProxyWAFWarnings, smRealmName=smRealmName, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, firmwareStorage=firmwareStorage, sslSrvrAvgResTime=sslSrvrAvgResTime, httpProxyOutBytes=httpProxyOutBytes, sslSrvrOutBytes=sslSrvrOutBytes, ipsReqLimitPort=ipsReqLimitPort, httpProxyAddress=httpProxyAddress, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpSrvrOutBytes=httpSrvrOutBytes, cpuFanSpeed=cpuFanSpeed, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslSrvrTotRefused=sslSrvrTotRefused, sslProxyAddressType=sslProxyAddressType, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsMIBConformance=bwsMIBConformance, processCountHigh=processCountHigh, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsHdrAclPort=ipsHdrAclPort, ipsRCPort=ipsRCPort, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, systemLoad=systemLoad, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, switchingToMaintMode=switchingToMaintMode, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, raidDegrading=raidDegrading, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpProxyUnknownRsp=httpProxyUnknownRsp, serviceName=serviceName, webCacheHits=webCacheHits, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsStatsGroup=bwsStatsGroup, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpProxyClientAbrt=httpProxyClientAbrt, ipsReqLimitAddress=ipsReqLimitAddress, httpProxyServerAbrt=httpProxyServerAbrt, httpSrvrAddressType=httpSrvrAddressType, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpProxyAddressType=httpProxyAddressType, serverDown=serverDown, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslProxyOutBytes=sslProxyOutBytes, sslProxyErrPms=sslProxyErrPms, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable)
mibBuilder.exportSymbols("BWS-MIB", bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsUrlAclReserved=ipsUrlAclReserved, ipsWebAddrTransPort=ipsWebAddrTransPort, httpProxyInBytes=httpProxyInBytes, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, dataPortLinkDown=dataPortLinkDown, cpuUtilization=cpuUtilization, ipsRCAddress=ipsRCAddress, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrMinResTime=httpSrvrMinResTime, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpSrvrState=httpSrvrState, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, webCmprPort=webCmprPort, bwsMIBCompliance=bwsMIBCompliance, currentFirmwareVersion=currentFirmwareVersion, ipsCookieSecAddress=ipsCookieSecAddress, httpProxyTotalConn=httpProxyTotalConn, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsRCTotQueued=ipsRCTotQueued, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, webCmprAddressType=webCmprAddressType, httpSrvrAvgResTime=httpSrvrAvgResTime, serverUp=serverUp, ipsUrlAclPort=ipsUrlAclPort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslProxyCacheTimeouts=sslProxyCacheTimeouts, uptime=uptime, httpSrvrTotResponse=httpSrvrTotResponse, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsMIBGroups=bwsMIBGroups, dataPortLinkUp=dataPortLinkUp, ipsWebAddrTransAddress=ipsWebAddrTransAddress, freeMem=freeMem, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsMessage=bwsMessage, webCmprAddress=webCmprAddress, ipsUrlNormAddress=ipsUrlNormAddress, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpSrvrTotRefused=httpSrvrTotRefused, peerUp=peerUp, switchingToInlineMode=switchingToInlineMode, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslSrvrAddressType=sslSrvrAddressType, bwsStats=bwsStats, dataPathStatus=dataPathStatus, firmwareUpdateAvailable=firmwareUpdateAvailable, vipStatus=vipStatus, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, smNumUserSessions=smNumUserSessions, httpProxyTotalReq=httpProxyTotalReq, cpuTemperature=cpuTemperature, sslSrvrSrvcPort=sslSrvrSrvcPort, totalBandwidth=totalBandwidth, totalAttacks=totalAttacks, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled)
