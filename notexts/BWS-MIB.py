...
iso, TimeTicks, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, Counter64, MibIdentifier, Bits, ObjectIdentity, Counter32, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "Counter64", "MibIdentifier", "Bits", "ObjectIdentity", "Counter32", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsCookieSecPort=ipsCookieSecPort, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsRCTotServed=ipsRCTotServed, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, srvcName=srvcName, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsMIBGroups=bwsMIBGroups, serverDown=serverDown, sslSrvrSrvcPort=sslSrvrSrvcPort, httpSrvrTotTimedout=httpSrvrTotTimedout, sslProxyPort=sslProxyPort, sslSrvrMinResTime=sslSrvrMinResTime, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslProxyInBytes=sslProxyInBytes, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpProxyServerAbrt=httpProxyServerAbrt, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsReqSrvcPort=ipsReqSrvcPort, webCacheAddressType=webCacheAddressType, sslSrvrSrvcAddress=sslSrvrSrvcAddress, tempCritical=tempCritical, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsSMUserSessionTable=bwsSMUserSessionTable, serviceStatus=serviceStatus, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, webCacheProtocol=webCacheProtocol, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, processCountHigh=processCountHigh, bwsCacheStatsTable=bwsCacheStatsTable, ipsCookieSecAddress=ipsCookieSecAddress, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsStats=bwsStats, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsWebAddrTransAddress=ipsWebAddrTransAddress, smAgentName=smAgentName, httpSrvrOutBytes=httpSrvrOutBytes, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, linkStatus=linkStatus, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpProxyTotalConn=httpProxyTotalConn, sslProxyTotalReq=sslProxyTotalReq, highAvailabilityStatus=highAvailabilityStatus, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpProxyPort=httpProxyPort, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrAddress=sslSrvrAddress, webCacheCacheableRes=webCacheCacheableRes, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, webCmprAddress=webCmprAddress, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, securityDefUpdates=securityDefUpdates, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpSrvrState=httpSrvrState, systemFanSpeed=systemFanSpeed, sslProxyCacheMiss=sslProxyCacheMiss, virusDefUpdates=virusDefUpdates, sslSrvrTotResponse=sslSrvrTotResponse, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsTrapGroup=bwsTrapGroup, freeMem=freeMem, currentFirmwareVersion=currentFirmwareVersion, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, webCachePort=webCachePort, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslSrvrAddressType=sslSrvrAddressType, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsReqLimitPort=ipsReqLimitPort, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsMessage=bwsMessage, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpProxyServerReq=httpProxyServerReq, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, memoryUsageHigh=memoryUsageHigh, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, smRealmName=smRealmName, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsStatsGroup=bwsStatsGroup, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsUrlNormPort=ipsUrlNormPort, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, totalServers=totalServers, ipsHdrAclHits=ipsHdrAclHits, raidDegrading=raidDegrading, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, systemFailOver=systemFailOver, switchingToMaintMode=switchingToMaintMode, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, dataPortLinkDown=dataPortLinkDown, ipsReqLimitAddress=ipsReqLimitAddress, switchingToInlineMode=switchingToInlineMode, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsCookieSecTampered=ipsCookieSecTampered, webCacheReq=webCacheReq, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, memUtilization=memUtilization, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslSrvrAvgResTime=sslSrvrAvgResTime, sslProxyAddressType=sslProxyAddressType, httpSrvrSrvcAddress=httpSrvrSrvcAddress, webCmprCompressibleDataSize=webCmprCompressibleDataSize, dataPathStatus=dataPathStatus, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, totalBandwidth=totalBandwidth, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, totalAttacks=totalAttacks, cpuFanSpeed=cpuFanSpeed, sslProxyActiveConn=sslProxyActiveConn, activeServers=activeServers, tempHigh=tempHigh, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsMIBCompliances=bwsMIBCompliances, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, serviceAddress=serviceAddress, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, serviceName=serviceName, ipsRCTimeStamp=ipsRCTimeStamp, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpSrvrNumConn=httpSrvrNumConn, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, servicePort=servicePort, bws=bws, httpProxyTotalReq=httpProxyTotalReq, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsRCPort=ipsRCPort, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsUrlAclAddress=ipsUrlAclAddress, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpProxyOutBytes=httpProxyOutBytes, bwsMIBConformance=bwsMIBConformance, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpSrvrMaxResTime=httpSrvrMaxResTime, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsUrlAclAddressType=ipsUrlAclAddressType, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, cpuTemperature=cpuTemperature, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, webCacheLongHdrs=webCacheLongHdrs, httpSrvrMinResTime=httpSrvrMinResTime, ipsLrnSrvcPort=ipsLrnSrvcPort, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsUrlPolicyPort=ipsUrlPolicyPort, webCacheAddress=webCacheAddress, energizeUpdateExpire=energizeUpdateExpire, httpSrvrSrvcPort=httpSrvrSrvcPort, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslSrvrTotTimedout=sslSrvrTotTimedout, sslSrvrPort=sslSrvrPort, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpProxyInBytes=httpProxyInBytes, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrTotResponse=httpSrvrTotResponse, sslProxyBadDNCErr=sslProxyBadDNCErr, httpProxyAddressType=httpProxyAddressType, operationalMode=operationalMode, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwstraps=bwstraps, ipsRCAddressType=ipsRCAddressType, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsServiceStatusEntry=bwsServiceStatusEntry, sslProxyCurrentConn=sslProxyCurrentConn, ipsUrlAclPort=ipsUrlAclPort, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, systemSerialNumber=systemSerialNumber, ipsUrlNormAddressType=ipsUrlNormAddressType, httpSrvrAddressType=httpSrvrAddressType, webCacheMiss=webCacheMiss, httpSrvrInBytes=httpSrvrInBytes, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslProxyAddress=sslProxyAddress, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsHdrAclPort=ipsHdrAclPort, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslSrvrTotSuccess=sslSrvrTotSuccess, webCacheBytesOut=webCacheBytesOut, sslProxyOutBytes=sslProxyOutBytes, httpProxyServerErr=httpProxyServerErr, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsRCTotDropped=ipsRCTotDropped, cpuUtilization=cpuUtilization, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslProxyCacheHits=sslProxyCacheHits, totalMem=totalMem, firmwareStorage=firmwareStorage, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, totalApplications=totalApplications, ipsUrlNormAddress=ipsUrlNormAddress, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, webCacheStale=webCacheStale, switchingToBypassMode=switchingToBypassMode, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, webCacheCachedObjects=webCacheCachedObjects, httpProxyParseErr=httpProxyParseErr, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslSrvrOutBytes=sslSrvrOutBytes, httpProxyClientAbrt=httpProxyClientAbrt, vipStatus=vipStatus, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsWebAddrTransPort=ipsWebAddrTransPort, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, peerUp=peerUp)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrAddress=httpSrvrAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrMaxResTime=sslSrvrMaxResTime, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, dataPortLinkUp=dataPortLinkUp, firmwareStorageHigh=firmwareStorageHigh, ipsRCTotQueued=ipsRCTotQueued, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrState=sslSrvrState, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrInBytes=sslSrvrInBytes, firmwareUpdateAvailable=firmwareUpdateAvailable, webCmprPort=webCmprPort, httpSrvrPort=httpSrvrPort, webCmprProtocol=webCmprProtocol, smNumUserSessions=smNumUserSessions, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, serverUp=serverUp, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpProxyAddress=httpProxyAddress, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslProxyErrPms=sslProxyErrPms, logStorage=logStorage, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsHdrAclAddress=ipsHdrAclAddress, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsRCAddress=ipsRCAddress, sslSrvrTotRefused=sslSrvrTotRefused, webCmprAddressType=webCmprAddressType, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, fanDead=fanDead, systemFailure=systemFailure, httpProxyActiveConn=httpProxyActiveConn, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsMIBCompliance=bwsMIBCompliance, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrTotRefused=httpSrvrTotRefused, PYSNMP_MODULE_ID=bws, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, logStorageHigh=logStorageHigh, uptime=uptime, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, systemLoad=systemLoad, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsCompressionStatsTable=bwsCompressionStatsTable, webCacheHits=webCacheHits, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslProxyTotalConn=sslProxyTotalConn, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, activeApplications=activeApplications, peerDown=peerDown, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrNumConn=sslSrvrNumConn)
