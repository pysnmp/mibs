...
Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, Counter64, iso, NotificationType, IpAddress, ObjectIdentity, TimeTicks, ModuleIdentity, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "Counter64", "iso", "NotificationType", "IpAddress", "ObjectIdentity", "TimeTicks", "ModuleIdentity", "Counter32", "Unsigned32")
...
mibBuilder.exportSymbols("BWS-MIB", bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, webCacheBytesOut=webCacheBytesOut, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslSrvrState=sslSrvrState, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpSrvrNumConn=httpSrvrNumConn, ipsAccessCtrlPort=ipsAccessCtrlPort, operationalMode=operationalMode, bwsCompressionStatsEntry=bwsCompressionStatsEntry, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, smNumUserSessions=smNumUserSessions, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, webCacheAddress=webCacheAddress, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrState=httpSrvrState, cpuUtilization=cpuUtilization, sslSrvrAvgResTime=sslSrvrAvgResTime, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrTotSuccess=sslSrvrTotSuccess, totalMem=totalMem, switchingToMaintMode=switchingToMaintMode, peerUp=peerUp, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, dataPortLinkUp=dataPortLinkUp, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrAddressType=sslSrvrAddressType, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpSrvrPort=httpSrvrPort, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslProxyPort=sslProxyPort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsStats=bwsStats, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsUrlNormPort=ipsUrlNormPort, srvcName=srvcName, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, smAgentName=smAgentName, memoryUsageHigh=memoryUsageHigh, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, webCmprCompressedDataSize=webCmprCompressedDataSize, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, webCacheLongHdrs=webCacheLongHdrs, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslProxyFullHandshakes=sslProxyFullHandshakes, switchingToInlineMode=switchingToInlineMode, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrOutBytes=httpSrvrOutBytes, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, uptime=uptime, serverDown=serverDown, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsRCAddressType=ipsRCAddressType, bwsStatsGroup=bwsStatsGroup, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsMessage=bwsMessage, webCachePort=webCachePort, httpProxyActiveConn=httpProxyActiveConn, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, freeMem=freeMem, serverUp=serverUp, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, systemLoad=systemLoad, bwsMIBConformance=bwsMIBConformance, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpProxyClientAbrt=httpProxyClientAbrt, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, webCacheCachedObjects=webCacheCachedObjects, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslProxyActiveConn=sslProxyActiveConn, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsMIBGroups=bwsMIBGroups, ipsHdrAclAddressType=ipsHdrAclAddressType, sslProxyOutBytes=sslProxyOutBytes, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrTotReqActive=sslSrvrTotReqActive, httpProxyInBytes=httpProxyInBytes, ipsCookieSecPort=ipsCookieSecPort, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, vipStatus=vipStatus, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsUrlAclAddress=ipsUrlAclAddress, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpProxyPort=httpProxyPort, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, dataPortLinkDown=dataPortLinkDown, sslProxyAddress=sslProxyAddress, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpProxyParseErr=httpProxyParseErr, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrTotReqActive=httpSrvrTotReqActive, webCmprAddress=webCmprAddress, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpProxyServerErr=httpProxyServerErr, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, switchingToBypassMode=switchingToBypassMode, cpuTemperature=cpuTemperature, sslProxyTotalReq=sslProxyTotalReq, sslSrvrOutBytes=sslSrvrOutBytes, totalAttacks=totalAttacks, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, peerDown=peerDown, httpSrvrAddress=httpSrvrAddress, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, serviceAddress=serviceAddress, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpSrvrMinResTime=httpSrvrMinResTime, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsCookieSecAddress=ipsCookieSecAddress, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsRCPort=ipsRCPort, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, systemFanSpeed=systemFanSpeed, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsRCTotServed=ipsRCTotServed, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, webCacheProtocol=webCacheProtocol, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, linkStatus=linkStatus, firmwareStorage=firmwareStorage, sslProxyBadDNCErr=sslProxyBadDNCErr, httpProxyTotalConn=httpProxyTotalConn, totalApplications=totalApplications, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, serviceName=serviceName, sslSrvrTotTimedout=sslSrvrTotTimedout, tempHigh=tempHigh, httpSrvrTotTimedout=httpSrvrTotTimedout, logStorageHigh=logStorageHigh, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, systemSerialNumber=systemSerialNumber, webCacheStale=webCacheStale, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsWebAddrTransPort=ipsWebAddrTransPort, httpProxyUnknownRsp=httpProxyUnknownRsp, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, serviceStatus=serviceStatus, webCacheCacheableRes=webCacheCacheableRes, ipsReqLimitAddress=ipsReqLimitAddress, sslSrvrAddress=sslSrvrAddress, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, fanDead=fanDead, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsRCTotDropped=ipsRCTotDropped, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpSrvrAddressType=httpSrvrAddressType, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslSrvrTotResponse=sslSrvrTotResponse, ipsCookieSecTampered=ipsCookieSecTampered, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, activeApplications=activeApplications, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslProxyTotalConn=sslProxyTotalConn, ipsUrlAclReserved=ipsUrlAclReserved, ipsRCTimeStamp=ipsRCTimeStamp, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrMaxResTime=httpSrvrMaxResTime, httpProxyOutBytes=httpProxyOutBytes, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, processCountHigh=processCountHigh, sslProxyAddressType=sslProxyAddressType, webCacheAddressType=webCacheAddressType, sslSrvrInBytes=sslSrvrInBytes, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslSrvrMinResTime=sslSrvrMinResTime, currentFirmwareVersion=currentFirmwareVersion, securityDefUpdates=securityDefUpdates, ipsHdrAclHits=ipsHdrAclHits, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsUrlAclPort=ipsUrlAclPort, totalBandwidth=totalBandwidth, raidDegrading=raidDegrading, bwsMIBCompliances=bwsMIBCompliances, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, webCacheReq=webCacheReq, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsUrlNormAddressType=ipsUrlNormAddressType, httpSrvrTotResponse=httpSrvrTotResponse, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslProxyErrPms=sslProxyErrPms, ipsReqLimitPort=ipsReqLimitPort, httpSrvrInBytes=httpSrvrInBytes, sslSrvrSrvcPort=sslSrvrSrvcPort, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bws=bws, httpProxyTotalReq=httpProxyTotalReq, totalServers=totalServers, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, cpuFanSpeed=cpuFanSpeed, ipsReqSrvcPort=ipsReqSrvcPort)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrAvgResTime=httpSrvrAvgResTime, webCmprProtocol=webCmprProtocol, sslSrvrMaxResTime=sslSrvrMaxResTime, httpProxyServerAbrt=httpProxyServerAbrt, httpSrvrTotRefused=httpSrvrTotRefused, activeServers=activeServers, dataPathStatus=dataPathStatus, memUtilization=memUtilization, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, PYSNMP_MODULE_ID=bws, servicePort=servicePort, firmwareUpdateAvailable=firmwareUpdateAvailable, firmwareStorageHigh=firmwareStorageHigh, httpProxyAddress=httpProxyAddress, systemFailOver=systemFailOver, ipsRCAddress=ipsRCAddress, bwsServiceStatusEntry=bwsServiceStatusEntry, webCacheHits=webCacheHits, ipsWebAddrTransAddress=ipsWebAddrTransAddress, systemFailure=systemFailure, httpProxyServerReq=httpProxyServerReq, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, tempCritical=tempCritical, webCmprAddressType=webCmprAddressType, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsTrapGroup=bwsTrapGroup, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, webCmprPort=webCmprPort, bwsCacheStatsTable=bwsCacheStatsTable, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpProxyAddressType=httpProxyAddressType, ipsHdrAclAddress=ipsHdrAclAddress, bwsServiceStatusTable=bwsServiceStatusTable, ipsHdrAclPort=ipsHdrAclPort, sslSrvrNumConn=sslSrvrNumConn, sslSrvrTotReqRejected=sslSrvrTotReqRejected, virusDefUpdates=virusDefUpdates, sslProxyCurrentConn=sslProxyCurrentConn, ipsAccessCtrlAddress=ipsAccessCtrlAddress, smRealmName=smRealmName, ipsLrnSrvcAddress=ipsLrnSrvcAddress, highAvailabilityStatus=highAvailabilityStatus, ipsRCTotQueued=ipsRCTotQueued, sslProxyCacheMiss=sslProxyCacheMiss, bwstraps=bwstraps, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, logStorage=logStorage, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslProxyInBytes=sslProxyInBytes, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslSrvrPort=sslSrvrPort, webCacheMiss=webCacheMiss, sslProxyCacheHits=sslProxyCacheHits, sslSrvrTotRefused=sslSrvrTotRefused, sharedSecretKeyExpired=sharedSecretKeyExpired, energizeUpdateExpire=energizeUpdateExpire, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsMIBCompliance=bwsMIBCompliance)
