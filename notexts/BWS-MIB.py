...
NotificationType, Gauge32, Unsigned32, ModuleIdentity, IpAddress, iso, Counter32, Counter64, MibIdentifier, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "Unsigned32", "ModuleIdentity", "IpAddress", "iso", "Counter32", "Counter64", "MibIdentifier", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits")
...
mibBuilder.exportSymbols("BWS-MIB", ipsUrlNormPort=ipsUrlNormPort, servicePort=servicePort, tempHigh=tempHigh, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, webCacheLongHdrs=webCacheLongHdrs, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, firmwareUpdateAvailable=firmwareUpdateAvailable, webCacheReq=webCacheReq, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslSrvrAddressType=sslSrvrAddressType, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, serviceStatus=serviceStatus, webCmprProtocol=webCmprProtocol, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpSrvrTotResponse=httpSrvrTotResponse, sslSrvrNumConn=sslSrvrNumConn, sslSrvrAddress=sslSrvrAddress, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpProxyParseErr=httpProxyParseErr, bwsCompressionStatsTable=bwsCompressionStatsTable, processCountHigh=processCountHigh, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsUrlPolicyAddress=ipsUrlPolicyAddress, webCacheProtocol=webCacheProtocol, sslSrvrTotResponse=sslSrvrTotResponse, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslProxyInBytes=sslProxyInBytes, ipsReqLimitAddressType=ipsReqLimitAddressType, cpuFanSpeed=cpuFanSpeed, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, webCacheAddressType=webCacheAddressType, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, webCachePort=webCachePort, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslProxyTotalConn=sslProxyTotalConn, sslProxyTotalReq=sslProxyTotalReq, httpProxyActiveConn=httpProxyActiveConn, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsMessage=bwsMessage, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, memoryUsageHigh=memoryUsageHigh, firmwareStorage=firmwareStorage, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsRCTimeStamp=ipsRCTimeStamp, bwsTrapGroup=bwsTrapGroup, httpSrvrTotRefused=httpSrvrTotRefused, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, sharedSecretKeyExpired=sharedSecretKeyExpired, sslSrvrTotTimedout=sslSrvrTotTimedout, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, energizeUpdateExpire=energizeUpdateExpire, srvcName=srvcName, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsStatsGroup=bwsStatsGroup, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrAddress=httpSrvrAddress, ipsReqSrvcAddressType=ipsReqSrvcAddressType, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwstraps=bwstraps, switchingToInlineMode=switchingToInlineMode, currentFirmwareVersion=currentFirmwareVersion, ipsUrlNormAddress=ipsUrlNormAddress, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpSrvrNumConn=httpSrvrNumConn, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslSrvrOutBytes=sslSrvrOutBytes, bwsMIBCompliance=bwsMIBCompliance, ipsRCPort=ipsRCPort, systemLoad=systemLoad, httpProxyTotalConn=httpProxyTotalConn, ipsUrlAclReserved=ipsUrlAclReserved, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslProxyActiveConn=sslProxyActiveConn, systemFailOver=systemFailOver, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsReqSrvcPort=ipsReqSrvcPort, ipsHdrAclPort=ipsHdrAclPort, httpSrvrTotReqActive=httpSrvrTotReqActive, memUtilization=memUtilization, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, operationalMode=operationalMode, switchingToBypassMode=switchingToBypassMode, ipsHdrAclAddress=ipsHdrAclAddress, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, systemFailure=systemFailure, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, uptime=uptime, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, peerDown=peerDown, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, serviceAddress=serviceAddress, webCacheAddress=webCacheAddress, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlAclAddressType=ipsUrlAclAddressType, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsMIBGroups=bwsMIBGroups, activeServers=activeServers, sslProxyCurrentConn=sslProxyCurrentConn, serverUp=serverUp, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, logStorage=logStorage, activeApplications=activeApplications, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, dataPortLinkUp=dataPortLinkUp, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsMIBConformance=bwsMIBConformance, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpSrvrOutBytes=httpSrvrOutBytes, raidDegrading=raidDegrading, webCmprCompressedDataSize=webCmprCompressedDataSize, tempCritical=tempCritical, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, webCmprPort=webCmprPort, httpProxyServerAbrt=httpProxyServerAbrt, sslProxyOutBytes=sslProxyOutBytes, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsMIBCompliances=bwsMIBCompliances, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, switchingToMaintMode=switchingToMaintMode, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsReqLimitAddress=ipsReqLimitAddress, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, firmwareStorageHigh=firmwareStorageHigh, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, PYSNMP_MODULE_ID=bws, sslProxyAddress=sslProxyAddress, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, webCacheCacheableRes=webCacheCacheableRes, systemSerialNumber=systemSerialNumber, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpProxyInBytes=httpProxyInBytes, httpSrvrTotReqRejected=httpSrvrTotReqRejected, totalMem=totalMem, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, serviceName=serviceName, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslSrvrTotRefused=sslSrvrTotRefused, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsHdrAclHits=ipsHdrAclHits, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, httpProxyTotalReq=httpProxyTotalReq, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsStats=bwsStats, sslSrvrState=sslSrvrState, ipsUrlAclPort=ipsUrlAclPort, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, webCmprAddressType=webCmprAddressType, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpSrvrPort=httpSrvrPort, sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpSrvrAddressType=httpSrvrAddressType, sslProxyCacheHits=sslProxyCacheHits, logStorageHigh=logStorageHigh, linkStatus=linkStatus, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrMaxResTime=httpSrvrMaxResTime, webCacheMiss=webCacheMiss, ipsRCAddressType=ipsRCAddressType, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpSrvrInBytes=httpSrvrInBytes, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsReqLimitPort=ipsReqLimitPort, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, fanDead=fanDead, sslProxyErrPms=sslProxyErrPms, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpProxyUnknownRsp=httpProxyUnknownRsp, webCacheBytesOut=webCacheBytesOut, sslSrvrMinResTime=sslSrvrMinResTime, bws=bws, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsCacheStatsEntry=bwsCacheStatsEntry, securityDefUpdates=securityDefUpdates, bwsServiceStatusTable=bwsServiceStatusTable, cpuTemperature=cpuTemperature, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsCookieSecEncrypted=ipsCookieSecEncrypted, totalApplications=totalApplications, serverDown=serverDown, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, peerUp=peerUp, totalAttacks=totalAttacks, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrInBytes=sslSrvrInBytes, httpProxyAddress=httpProxyAddress, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslProxyPort=sslProxyPort, httpSrvrSrvcPort=httpSrvrSrvcPort, totalServers=totalServers, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpProxyAddressType=httpProxyAddressType, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpProxyClientAbrt=httpProxyClientAbrt, ipsLrnSrvcPort=ipsLrnSrvcPort, sslProxyAddressType=sslProxyAddressType, systemFanSpeed=systemFanSpeed, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, smRealmName=smRealmName, httpProxyServerReq=httpProxyServerReq)
mibBuilder.exportSymbols("BWS-MIB", smNumUserSessions=smNumUserSessions, httpSrvrMinResTime=httpSrvrMinResTime, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsRCTotQueued=ipsRCTotQueued, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, freeMem=freeMem, bwsServiceStatusEntry=bwsServiceStatusEntry, webCmprAddress=webCmprAddress, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsCookieSecTampered=ipsCookieSecTampered, sslSrvrPort=sslSrvrPort, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, dataPortLinkDown=dataPortLinkDown, smAgentName=smAgentName, webCacheStale=webCacheStale, ipsUrlNormAddressType=ipsUrlNormAddressType, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, totalBandwidth=totalBandwidth, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsRCAddress=ipsRCAddress, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, highAvailabilityStatus=highAvailabilityStatus, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpProxyServerErr=httpProxyServerErr, vipStatus=vipStatus, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, virusDefUpdates=virusDefUpdates, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpProxyPort=httpProxyPort, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpSrvrState=httpSrvrState, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsRCTotServed=ipsRCTotServed, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsSMUserSessionTable=bwsSMUserSessionTable, dataPathStatus=dataPathStatus, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, webCacheHits=webCacheHits, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsRCTotDropped=ipsRCTotDropped, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpProxyOutBytes=httpProxyOutBytes, ipsCookieSecPort=ipsCookieSecPort, cpuUtilization=cpuUtilization, bwsCacheStatsTable=bwsCacheStatsTable, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsCookieSecAddress=ipsCookieSecAddress, webCacheCachedObjects=webCacheCachedObjects, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry)
