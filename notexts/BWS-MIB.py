...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, NotificationType, Gauge32, Counter64, ObjectIdentity, Integer32, Counter32, Bits, iso, MibIdentifier, ModuleIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "NotificationType", "Gauge32", "Counter64", "ObjectIdentity", "Integer32", "Counter32", "Bits", "iso", "MibIdentifier", "ModuleIdentity", "IpAddress")
...
mibBuilder.exportSymbols("BWS-MIB", currentFirmwareVersion=currentFirmwareVersion, tempHigh=tempHigh, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, tempCritical=tempCritical, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsUrlNormAddress=ipsUrlNormAddress, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrTotRefused=httpSrvrTotRefused, smNumUserSessions=smNumUserSessions, sslProxyCurrentConn=sslProxyCurrentConn, ipsHdrAclHits=ipsHdrAclHits, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslProxyBadCRLErr=sslProxyBadCRLErr, httpProxyOutBytes=httpProxyOutBytes, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslProxyPort=sslProxyPort, ipsRCAddressType=ipsRCAddressType, systemFailOver=systemFailOver, activeApplications=activeApplications, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, securityDefUpdates=securityDefUpdates, sslProxyActiveConn=sslProxyActiveConn, httpProxyAddress=httpProxyAddress, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsReqSrvcAddress=ipsReqSrvcAddress, virusDefUpdates=virusDefUpdates, highAvailabilityStatus=highAvailabilityStatus, serviceAddress=serviceAddress, httpProxyClientAbrt=httpProxyClientAbrt, httpSrvrSrvcPort=httpSrvrSrvcPort, peerUp=peerUp, httpSrvrAddress=httpSrvrAddress, ipsHdrAclPort=ipsHdrAclPort, peerDown=peerDown, bwsMIBConformance=bwsMIBConformance, cpuFanSpeed=cpuFanSpeed, httpSrvrState=httpSrvrState, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsRCTotQueued=ipsRCTotQueued, ipsRCTotServed=ipsRCTotServed, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, totalServers=totalServers, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslProxyInBytes=sslProxyInBytes, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsRCTimeStamp=ipsRCTimeStamp, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslSrvrMinResTime=sslSrvrMinResTime, linkStatus=linkStatus, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsMIBCompliance=bwsMIBCompliance, ipsRCTotDropped=ipsRCTotDropped, ipsWebAddrTransAddress=ipsWebAddrTransAddress, dataPortLinkDown=dataPortLinkDown, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bws=bws, logStorageHigh=logStorageHigh, totalAttacks=totalAttacks, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, cpuTemperature=cpuTemperature, sslProxyTotalConn=sslProxyTotalConn, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsServiceStatusTable=bwsServiceStatusTable, bwsMessage=bwsMessage, dataPortLinkUp=dataPortLinkUp, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslSrvrState=sslSrvrState, ipsRCAddress=ipsRCAddress, firmwareStorage=firmwareStorage, sslSrvrTotResponse=sslSrvrTotResponse, webCacheAddress=webCacheAddress, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpProxyServerAbrt=httpProxyServerAbrt, sslSrvrNumConn=sslSrvrNumConn, systemSerialNumber=systemSerialNumber, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsCacheStatsTable=bwsCacheStatsTable, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsLrnSrvcPort=ipsLrnSrvcPort, sslProxyTotalReq=sslProxyTotalReq, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, switchingToInlineMode=switchingToInlineMode, serviceName=serviceName, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, smAgentName=smAgentName, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, energizeUpdateExpire=energizeUpdateExpire, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpProxyPort=httpProxyPort, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, servicePort=servicePort, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, systemLoad=systemLoad, webCmprAddressType=webCmprAddressType, ipsCookieSecTampered=ipsCookieSecTampered, httpProxyActiveConn=httpProxyActiveConn, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsCookieSecEncrypted=ipsCookieSecEncrypted, processCountHigh=processCountHigh, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrTotSuccess=sslSrvrTotSuccess, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsReqLimitAddress=ipsReqLimitAddress, PYSNMP_MODULE_ID=bws, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsRCPort=ipsRCPort, serverDown=serverDown, firmwareStorageHigh=firmwareStorageHigh, operationalMode=operationalMode, memUtilization=memUtilization, webCmprProtocol=webCmprProtocol, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsStatsGroup=bwsStatsGroup, uptime=uptime, sslSrvrMaxResTime=sslSrvrMaxResTime, httpSrvrAddressType=httpSrvrAddressType, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, activeServers=activeServers, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslProxyCacheMiss=sslProxyCacheMiss, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslSrvrInBytes=sslSrvrInBytes, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsCacheStatsEntry=bwsCacheStatsEntry, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslSrvrTotRefused=sslSrvrTotRefused, vipStatus=vipStatus, ipsReqSrvcPort=ipsReqSrvcPort, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsUrlAclAddress=ipsUrlAclAddress, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrOutBytes=httpSrvrOutBytes, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsAccessCtrlAddress=ipsAccessCtrlAddress, totalMem=totalMem, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslProxyCacheHits=sslProxyCacheHits, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrMinResTime=httpSrvrMinResTime, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, cpuUtilization=cpuUtilization, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, webCacheMiss=webCacheMiss, srvcName=srvcName, sslSrvrPort=sslSrvrPort, httpSrvrAvgResTime=httpSrvrAvgResTime, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpProxyServerErr=httpProxyServerErr, sslProxyAddressType=sslProxyAddressType, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslSrvrAddressType=sslSrvrAddressType, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, webCacheHits=webCacheHits, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpProxyParseErr=httpProxyParseErr, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsServiceStatusEntry=bwsServiceStatusEntry, webCacheReq=webCacheReq, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsCookieSecPort=ipsCookieSecPort, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrInBytes=httpSrvrInBytes, systemFailure=systemFailure, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsReqLimitPort=ipsReqLimitPort, httpProxyTotalConn=httpProxyTotalConn, totalBandwidth=totalBandwidth, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, fanDead=fanDead, ipsUrlAclPort=ipsUrlAclPort, webCacheLongHdrs=webCacheLongHdrs, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, logStorage=logStorage, httpSrvrPort=httpSrvrPort, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, dataPathStatus=dataPathStatus, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, serviceStatus=serviceStatus, sslProxyOutBytes=sslProxyOutBytes, sslProxyBadDNCErr=sslProxyBadDNCErr, sslSrvrOutBytes=sslSrvrOutBytes, ipsUrlAclReserved=ipsUrlAclReserved, memoryUsageHigh=memoryUsageHigh, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsHdrAclAddress=ipsHdrAclAddress, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, smRealmName=smRealmName, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpProxyInBytes=httpProxyInBytes, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsUrlNormAddressType=ipsUrlNormAddressType, httpSrvrTotResponse=httpSrvrTotResponse, systemFanSpeed=systemFanSpeed, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslProxyErrPms=sslProxyErrPms, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType)
mibBuilder.exportSymbols("BWS-MIB", ipsCookieSecAddress=ipsCookieSecAddress, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, webCacheBytesOut=webCacheBytesOut, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrAddress=sslSrvrAddress, switchingToBypassMode=switchingToBypassMode, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, webCacheStale=webCacheStale, httpProxyTotalReq=httpProxyTotalReq, sslProxyAddress=sslProxyAddress, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpProxyAddressType=httpProxyAddressType, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsStats=bwsStats, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, totalApplications=totalApplications, httpProxyServerReq=httpProxyServerReq, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrTotReqActive=sslSrvrTotReqActive, serverUp=serverUp, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsTrapGroup=bwsTrapGroup, webCachePort=webCachePort, webCacheCacheableRes=webCacheCacheableRes, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, webCmprAddress=webCmprAddress, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsMIBGroups=bwsMIBGroups, ipsUrlNormPort=ipsUrlNormPort, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsMIBCompliances=bwsMIBCompliances, bwstraps=bwstraps, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, webCacheProtocol=webCacheProtocol, httpSrvrTotReqActive=httpSrvrTotReqActive, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, webCacheCachedObjects=webCacheCachedObjects, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, webCacheAddressType=webCacheAddressType, freeMem=freeMem, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrNumConn=httpSrvrNumConn, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, raidDegrading=raidDegrading, webCmprPort=webCmprPort, switchingToMaintMode=switchingToMaintMode, ipsWebAddrTransPort=ipsWebAddrTransPort)
