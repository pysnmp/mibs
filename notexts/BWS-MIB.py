...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, Counter64, Gauge32, NotificationType, ModuleIdentity, TimeTicks, ObjectIdentity, MibIdentifier, Bits, Integer32, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "Counter64", "Gauge32", "NotificationType", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "MibIdentifier", "Bits", "Integer32", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("BWS-MIB", ipsReqSrvcPort=ipsReqSrvcPort, sslSrvrAddressType=sslSrvrAddressType, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsCacheStatsEntry=bwsCacheStatsEntry, PYSNMP_MODULE_ID=bws, httpSrvrTotRefused=httpSrvrTotRefused, webCacheLongHdrs=webCacheLongHdrs, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslProxyPort=sslProxyPort, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsRCTotQueued=ipsRCTotQueued, logStorageHigh=logStorageHigh, httpSrvrTotTimedout=httpSrvrTotTimedout, dataPathStatus=dataPathStatus, serviceStatus=serviceStatus, sslSrvrTotTimedout=sslSrvrTotTimedout, bwsStatsGroup=bwsStatsGroup, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsSMUserSessionEntry=bwsSMUserSessionEntry, uptime=uptime, webCachePort=webCachePort, ipsCookieSecPort=ipsCookieSecPort, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, webCacheStale=webCacheStale, httpProxyAddress=httpProxyAddress, webCacheBytesOut=webCacheBytesOut, ipsLrnSrvcAddress=ipsLrnSrvcAddress, srvcName=srvcName, sslSrvrAddress=sslSrvrAddress, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, serverDown=serverDown, sslSrvrMinResTime=sslSrvrMinResTime, dataPortLinkUp=dataPortLinkUp, vipStatus=vipStatus, switchingToInlineMode=switchingToInlineMode, firmwareUpdateAvailable=firmwareUpdateAvailable, systemFailure=systemFailure, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsRCPort=ipsRCPort, httpProxyAddressType=httpProxyAddressType, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpProxyOutBytes=httpProxyOutBytes, smRealmName=smRealmName, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, activeServers=activeServers, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsHdrAclPort=ipsHdrAclPort, ipsWebAddrTransPort=ipsWebAddrTransPort, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsUrlNormAddressType=ipsUrlNormAddressType, sslProxyCacheTimeouts=sslProxyCacheTimeouts, webCacheCacheableRes=webCacheCacheableRes, httpProxyServerErr=httpProxyServerErr, sslProxyActiveConn=sslProxyActiveConn, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpProxyTotalReq=httpProxyTotalReq, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsReqLimitAddressType=ipsReqLimitAddressType, totalServers=totalServers, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, firmwareStorageHigh=firmwareStorageHigh, webCacheCachedObjects=webCacheCachedObjects, webCmprPort=webCmprPort, httpSrvrInBytes=httpSrvrInBytes, operationalMode=operationalMode, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsTrapGroup=bwsTrapGroup, httpSrvrNumConn=httpSrvrNumConn, bws=bws, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslSrvrMaxResTime=sslSrvrMaxResTime, sslProxyOutBytes=sslProxyOutBytes, webCmprAddressType=webCmprAddressType, memUtilization=memUtilization, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpProxyParseErr=httpProxyParseErr, ipsRCTotDropped=ipsRCTotDropped, memoryUsageHigh=memoryUsageHigh, ipsHdrAclHits=ipsHdrAclHits, smAgentName=smAgentName, switchingToMaintMode=switchingToMaintMode, sslProxyTotalConn=sslProxyTotalConn, bwsMIBConformance=bwsMIBConformance, sslSrvrPort=sslSrvrPort, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrPort=httpSrvrPort, systemFailOver=systemFailOver, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsCookieSecTampered=ipsCookieSecTampered, activeApplications=activeApplications, webCacheHits=webCacheHits, totalBandwidth=totalBandwidth, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, logStorage=logStorage, httpProxyServerAbrt=httpProxyServerAbrt, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlNormAddress=ipsUrlNormAddress, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, dataPortLinkDown=dataPortLinkDown, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsRCTimeStamp=ipsRCTimeStamp, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsAccessCtrlPort=ipsAccessCtrlPort, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwstraps=bwstraps, sslProxyBadDNCErr=sslProxyBadDNCErr, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslProxyErrPms=sslProxyErrPms, processCountHigh=processCountHigh, sslProxyInBytes=sslProxyInBytes, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsUrlAclAddress=ipsUrlAclAddress, ipsReqSrvcAddressType=ipsReqSrvcAddressType, raidDegrading=raidDegrading, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrInBytes=sslSrvrInBytes, fanDead=fanDead, sslSrvrSrvcPort=sslSrvrSrvcPort, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsServiceStatusTable=bwsServiceStatusTable, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsMIBGroups=bwsMIBGroups, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, switchingToBypassMode=switchingToBypassMode, highAvailabilityStatus=highAvailabilityStatus, bwsMIBCompliance=bwsMIBCompliance, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, serverUp=serverUp, sslProxyAddress=sslProxyAddress, systemSerialNumber=systemSerialNumber, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsSslProxyStatsTable=bwsSslProxyStatsTable, securityDefUpdates=securityDefUpdates, sslProxyCacheMiss=sslProxyCacheMiss, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsUrlAclReserved=ipsUrlAclReserved, webCacheAddressType=webCacheAddressType, ipsRCAddress=ipsRCAddress, bwsIpsRCStatsTable=bwsIpsRCStatsTable, peerDown=peerDown, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsReqLimitPort=ipsReqLimitPort, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsCompressionStatsTable=bwsCompressionStatsTable, serviceAddress=serviceAddress, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, systemLoad=systemLoad, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsCookieSecAddress=ipsCookieSecAddress, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpSrvrTotReqRejected=httpSrvrTotReqRejected, firmwareStorage=firmwareStorage, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsHdrAclAddress=ipsHdrAclAddress, bwsCacheStatsTable=bwsCacheStatsTable, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, cpuUtilization=cpuUtilization, linkStatus=linkStatus, sslSrvrState=sslSrvrState, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrOutBytes=sslSrvrOutBytes, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, webCmprAddress=webCmprAddress, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, cpuTemperature=cpuTemperature, energizeUpdateExpire=energizeUpdateExpire, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslSrvrTotRefused=sslSrvrTotRefused, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, smNumUserSessions=smNumUserSessions, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, webCacheProtocol=webCacheProtocol, totalMem=totalMem, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrAddress=httpSrvrAddress, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, cpuFanSpeed=cpuFanSpeed, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, tempHigh=tempHigh, webCmprProtocol=webCmprProtocol, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, freeMem=freeMem, virusDefUpdates=virusDefUpdates, sslSrvrTotResponse=sslSrvrTotResponse, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, serviceName=serviceName, httpSrvrTotResponse=httpSrvrTotResponse, httpProxyClientAbrt=httpProxyClientAbrt, servicePort=servicePort, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpSrvrMinResTime=httpSrvrMinResTime, bwsMessage=bwsMessage, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpProxyTotalConn=httpProxyTotalConn, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsRCTotOutOfResource=ipsRCTotOutOfResource)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsRCAddressType=ipsRCAddressType, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslSrvrNumConn=sslSrvrNumConn, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsUrlNormPort=ipsUrlNormPort, sslProxyCacheHits=sslProxyCacheHits, ipsCookieSecAddressType=ipsCookieSecAddressType, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpSrvrState=httpSrvrState, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpSrvrAddressType=httpSrvrAddressType, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslProxyAddressType=sslProxyAddressType, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpProxyServerReq=httpProxyServerReq, systemFanSpeed=systemFanSpeed, sslProxyCurrentConn=sslProxyCurrentConn, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpProxyInBytes=httpProxyInBytes, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, tempCritical=tempCritical, httpProxyPort=httpProxyPort, totalApplications=totalApplications, sslProxyTotalReq=sslProxyTotalReq, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsStats=bwsStats, httpProxyActiveConn=httpProxyActiveConn, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsReqLimitAddress=ipsReqLimitAddress, sharedSecretKeyExpired=sharedSecretKeyExpired, webCacheMiss=webCacheMiss, httpSrvrSrvcAddress=httpSrvrSrvcAddress, webCacheReq=webCacheReq, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpSrvrTotReqActive=httpSrvrTotReqActive, webCacheAddress=webCacheAddress, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpSrvrOutBytes=httpSrvrOutBytes, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, peerUp=peerUp, httpProxyUnknownRsp=httpProxyUnknownRsp, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsRCTotServed=ipsRCTotServed, bwsMIBCompliances=bwsMIBCompliances, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, currentFirmwareVersion=currentFirmwareVersion, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, totalAttacks=totalAttacks, ipsUrlAclPort=ipsUrlAclPort, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry)
