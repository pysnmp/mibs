...
iso, Gauge32, ObjectIdentity, Integer32, NotificationType, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, Bits, Unsigned32, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "ObjectIdentity", "Integer32", "NotificationType", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "Bits", "Unsigned32", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", ipsUrlNormPort=ipsUrlNormPort, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpProxyParseErr=httpProxyParseErr, sslSrvrSrvcAddress=sslSrvrSrvcAddress, cpuFanSpeed=cpuFanSpeed, httpSrvrMaxResTime=httpSrvrMaxResTime, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslSrvrInBytes=sslSrvrInBytes, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, securityDefUpdates=securityDefUpdates, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, srvcName=srvcName, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrNumConn=sslSrvrNumConn, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, webCmprAddressType=webCmprAddressType, webCacheBytesOut=webCacheBytesOut, httpProxyInBytes=httpProxyInBytes, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsRCTotQueued=ipsRCTotQueued, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslSrvrTotTimedout=sslSrvrTotTimedout, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, PYSNMP_MODULE_ID=bws, httpSrvrNumConn=httpSrvrNumConn, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, raidDegrading=raidDegrading, ipsReqLimitPort=ipsReqLimitPort, systemFailOver=systemFailOver, serviceStatus=serviceStatus, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, processCountHigh=processCountHigh, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsMIBGroups=bwsMIBGroups, ipsRCAddress=ipsRCAddress, ipsHdrAclHits=ipsHdrAclHits, ipsRCAddressType=ipsRCAddressType, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsRCTotDropped=ipsRCTotDropped, highAvailabilityStatus=highAvailabilityStatus, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpProxyServerErr=httpProxyServerErr, bwsServiceStatusTable=bwsServiceStatusTable, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsSMUserSessionTable=bwsSMUserSessionTable, sslSrvrMaxResTime=sslSrvrMaxResTime, sslSrvrPort=sslSrvrPort, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpProxySessionTimeOut=httpProxySessionTimeOut, sharedSecretKeyExpired=sharedSecretKeyExpired, httpSrvrAvgResTime=httpSrvrAvgResTime, sslProxyCurrentConn=sslProxyCurrentConn, switchingToInlineMode=switchingToInlineMode, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, peerUp=peerUp, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrAddress=sslSrvrAddress, operationalMode=operationalMode, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsUrlPolicyPort=ipsUrlPolicyPort, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslProxyTotalConn=sslProxyTotalConn, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, currentFirmwareVersion=currentFirmwareVersion, webCmprCompressibleDataSize=webCmprCompressibleDataSize, totalServers=totalServers, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsCookieSecPort=ipsCookieSecPort, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, webCacheStale=webCacheStale, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsMIBConformance=bwsMIBConformance, memoryUsageHigh=memoryUsageHigh, bwstraps=bwstraps, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpProxyServerAbrt=httpProxyServerAbrt, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpProxyPort=httpProxyPort, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, switchingToMaintMode=switchingToMaintMode, totalBandwidth=totalBandwidth, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, logStorageHigh=logStorageHigh, ipsRCTimeStamp=ipsRCTimeStamp, webCmprProtocol=webCmprProtocol, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, activeServers=activeServers, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, webCacheAddressType=webCacheAddressType, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, httpProxyActiveConn=httpProxyActiveConn, ipsRCTotServed=ipsRCTotServed, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, webCacheReq=webCacheReq, tempHigh=tempHigh, serviceAddress=serviceAddress, sslProxyTotalReq=sslProxyTotalReq, dataPathStatus=dataPathStatus, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsReqSrvcPort=ipsReqSrvcPort, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, dataPortLinkUp=dataPortLinkUp, ipsReqLimitAddress=ipsReqLimitAddress, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslProxyErrPms=sslProxyErrPms, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, tempCritical=tempCritical, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpProxyWAFWarnings=httpProxyWAFWarnings, sslProxyCacheMiss=sslProxyCacheMiss, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrTotSuccess=sslSrvrTotSuccess, webCacheProtocol=webCacheProtocol, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslProxyPort=sslProxyPort, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, totalMem=totalMem, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, totalAttacks=totalAttacks, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, totalApplications=totalApplications, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsMIBCompliance=bwsMIBCompliance, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrAddressType=sslSrvrAddressType, httpProxyServerReq=httpProxyServerReq, peerDown=peerDown, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsUrlNormAddressType=ipsUrlNormAddressType, httpSrvrPort=httpSrvrPort, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, energizeUpdateExpire=energizeUpdateExpire, virusDefUpdates=virusDefUpdates, httpSrvrAddressType=httpSrvrAddressType, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsMIBCompliances=bwsMIBCompliances, sslProxyActiveConn=sslProxyActiveConn, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, linkStatus=linkStatus, systemSerialNumber=systemSerialNumber, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsCookieSecTampered=ipsCookieSecTampered, bwsStats=bwsStats, smAgentName=smAgentName, httpProxyUnknownRsp=httpProxyUnknownRsp, httpSrvrTotRefused=httpSrvrTotRefused, httpSrvrInBytes=httpSrvrInBytes, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrTotReqActive=httpSrvrTotReqActive, webCacheLongHdrs=webCacheLongHdrs, sslSrvrTotResponse=sslSrvrTotResponse, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslSrvrState=sslSrvrState, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslProxyAddress=sslProxyAddress, firmwareStorage=firmwareStorage, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsTrapGroup=bwsTrapGroup, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, serviceName=serviceName, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsCookieSecEncrypted=ipsCookieSecEncrypted, webCacheCachedObjects=webCacheCachedObjects, webCmprAddress=webCmprAddress, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, vipStatus=vipStatus, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, switchingToBypassMode=switchingToBypassMode, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsHdrAclPort=ipsHdrAclPort, webCachePort=webCachePort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, smNumUserSessions=smNumUserSessions, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, systemFanSpeed=systemFanSpeed, ipsUrlAclPort=ipsUrlAclPort, servicePort=servicePort, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpProxyAddress=httpProxyAddress, activeApplications=activeApplications, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslProxyOutBytes=sslProxyOutBytes, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpSrvrMinResTime=httpSrvrMinResTime, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, webCmprPort=webCmprPort)
mibBuilder.exportSymbols("BWS-MIB", bwsCacheStatsEntry=bwsCacheStatsEntry, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, serverUp=serverUp, sslSrvrOutBytes=sslSrvrOutBytes, freeMem=freeMem, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsCookieSecAddress=ipsCookieSecAddress, bwsStatsGroup=bwsStatsGroup, ipsReqLimitAddressType=ipsReqLimitAddressType, cpuTemperature=cpuTemperature, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpProxyTotalReq=httpProxyTotalReq, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, webCacheMiss=webCacheMiss, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslProxyAddressType=sslProxyAddressType, sslProxyInBytes=sslProxyInBytes, bwsMessage=bwsMessage, httpProxyOutBytes=httpProxyOutBytes, sslSrvrMinResTime=sslSrvrMinResTime, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, smRealmName=smRealmName, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslSrvrTotRefused=sslSrvrTotRefused, memUtilization=memUtilization, bws=bws, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslSrvrTotReqActive=sslSrvrTotReqActive, webCacheHits=webCacheHits, ipsRCPort=ipsRCPort, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrNumFreeConn=sslSrvrNumFreeConn, fanDead=fanDead, webCacheAddress=webCacheAddress, httpSrvrSrvcAddress=httpSrvrSrvcAddress, cpuUtilization=cpuUtilization, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrState=httpSrvrState, dataPortLinkDown=dataPortLinkDown, webCacheCacheableRes=webCacheCacheableRes, ipsUrlAclAddress=ipsUrlAclAddress, httpProxyAddressType=httpProxyAddressType, systemFailure=systemFailure, systemLoad=systemLoad, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslProxyCacheHits=sslProxyCacheHits, httpSrvrAddress=httpSrvrAddress, ipsCookieSecAddressType=ipsCookieSecAddressType, uptime=uptime, logStorage=logStorage, firmwareStorageHigh=firmwareStorageHigh, serverDown=serverDown, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsUrlNormAddress=ipsUrlNormAddress, ipsHdrAclAddress=ipsHdrAclAddress, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpProxyTotalConn=httpProxyTotalConn)
