...
NotificationType, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, TimeTicks, Integer32, MibIdentifier, ModuleIdentity, Bits, iso, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "TimeTicks", "Integer32", "MibIdentifier", "ModuleIdentity", "Bits", "iso", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("BWS-MIB", bwsMIBConformance=bwsMIBConformance, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, memoryUsageHigh=memoryUsageHigh, systemSerialNumber=systemSerialNumber, virusDefUpdates=virusDefUpdates, peerUp=peerUp, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpProxyOutBytes=httpProxyOutBytes, totalMem=totalMem, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslProxyOutBytes=sslProxyOutBytes, PYSNMP_MODULE_ID=bws, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsHdrAclHits=ipsHdrAclHits, webCmprAddressType=webCmprAddressType, vipStatus=vipStatus, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpProxyAddress=httpProxyAddress, bwsSMUserSessionTable=bwsSMUserSessionTable, webCacheCacheableRes=webCacheCacheableRes, switchingToMaintMode=switchingToMaintMode, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, webCacheAddress=webCacheAddress, ipsReqSrvcPort=ipsReqSrvcPort, sslSrvrAvgResTime=sslSrvrAvgResTime, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, tempCritical=tempCritical, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, webCacheMiss=webCacheMiss, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, smAgentName=smAgentName, webCacheProtocol=webCacheProtocol, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslProxyInBytes=sslProxyInBytes, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsHdrAclAddress=ipsHdrAclAddress, systemFailure=systemFailure, bwstraps=bwstraps, httpProxySessionTimeOut=httpProxySessionTimeOut, sslProxyFullHandshakes=sslProxyFullHandshakes, switchingToBypassMode=switchingToBypassMode, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsUrlAclAddress=ipsUrlAclAddress, smNumUserSessions=smNumUserSessions, firmwareUpdateAvailable=firmwareUpdateAvailable, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, fanDead=fanDead, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, dataPortLinkUp=dataPortLinkUp, httpSrvrTotRefused=httpSrvrTotRefused, webCacheBytesOut=webCacheBytesOut, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslProxyTotalReq=sslProxyTotalReq, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsMIBCompliance=bwsMIBCompliance, bwsStatsGroup=bwsStatsGroup, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslProxyBadCRLErr=sslProxyBadCRLErr, uptime=uptime, cpuUtilization=cpuUtilization, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslProxyCurrentConn=sslProxyCurrentConn, serviceAddress=serviceAddress, sslSrvrOutBytes=sslSrvrOutBytes, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsUrlAclReserved=ipsUrlAclReserved, sslProxyTotalConn=sslProxyTotalConn, webCmprPort=webCmprPort, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrTotResponse=sslSrvrTotResponse, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, activeApplications=activeApplications, peerDown=peerDown, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsRCTotServed=ipsRCTotServed, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslSrvrAddressType=sslSrvrAddressType, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpSrvrTotResponse=httpSrvrTotResponse, httpProxyTotalReq=httpProxyTotalReq, linkStatus=linkStatus, sslSrvrSrvcPort=sslSrvrSrvcPort, webCacheLongHdrs=webCacheLongHdrs, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsServiceStatusTable=bwsServiceStatusTable, tempHigh=tempHigh, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsWebAddrTransPort=ipsWebAddrTransPort, activeServers=activeServers, httpSrvrNumConn=httpSrvrNumConn, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrTotTimedout=sslSrvrTotTimedout, sslSrvrInBytes=sslSrvrInBytes, totalAttacks=totalAttacks, httpProxyServerReq=httpProxyServerReq, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrAddressType=httpSrvrAddressType, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, totalServers=totalServers, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, webCmprProtocol=webCmprProtocol, webCacheReq=webCacheReq, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, smRealmName=smRealmName, servicePort=servicePort, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, webCmprAddress=webCmprAddress, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrTotRefused=sslSrvrTotRefused, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsUrlNormPort=ipsUrlNormPort, webCmprCompressibleDataSize=webCmprCompressibleDataSize, serverUp=serverUp, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpProxyParseErr=httpProxyParseErr, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpProxyTotalConn=httpProxyTotalConn, dataPathStatus=dataPathStatus, firmwareStorageHigh=firmwareStorageHigh, sslSrvrNumConn=sslSrvrNumConn, httpProxyClientAbrt=httpProxyClientAbrt, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsMIBCompliances=bwsMIBCompliances, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, totalApplications=totalApplications, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsStats=bwsStats, ipsReqLimitPort=ipsReqLimitPort, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslProxyCacheTimeouts=sslProxyCacheTimeouts, switchingToInlineMode=switchingToInlineMode, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpProxyServerErr=httpProxyServerErr, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsTrapGroup=bwsTrapGroup, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsMessage=bwsMessage, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, currentFirmwareVersion=currentFirmwareVersion, ipsRCAddress=ipsRCAddress, webCacheHits=webCacheHits, sslSrvrPort=sslSrvrPort, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpProxyAddressType=httpProxyAddressType, ipsRCPort=ipsRCPort, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, webCachePort=webCachePort, logStorage=logStorage, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrMinResTime=sslSrvrMinResTime, ipsRCAddressType=ipsRCAddressType, webCacheAddressType=webCacheAddressType, ipsHdrAclPort=ipsHdrAclPort, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslProxyAddress=sslProxyAddress, httpSrvrMinResTime=httpSrvrMinResTime, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslProxyErrPms=sslProxyErrPms, httpSrvrState=httpSrvrState, energizeUpdateExpire=energizeUpdateExpire, systemFailOver=systemFailOver, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslSrvrState=sslSrvrState, bwsCacheStatsTable=bwsCacheStatsTable, sslProxyAddressType=sslProxyAddressType, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsMIBGroups=bwsMIBGroups, httpSrvrPort=httpSrvrPort, ipsUrlNormAddress=ipsUrlNormAddress, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsCookieSecTampered=ipsCookieSecTampered, serviceStatus=serviceStatus, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpSrvrTotReqActive=httpSrvrTotReqActive, srvcName=srvcName, highAvailabilityStatus=highAvailabilityStatus, httpSrvrAvgResTime=httpSrvrAvgResTime, webCacheCachedObjects=webCacheCachedObjects, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsReqSrvcAddress=ipsReqSrvcAddress, processCountHigh=processCountHigh, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpProxyPort=httpProxyPort, sslProxyCacheMiss=sslProxyCacheMiss, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, totalBandwidth=totalBandwidth)
mibBuilder.exportSymbols("BWS-MIB", ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, securityDefUpdates=securityDefUpdates, freeMem=freeMem, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, cpuTemperature=cpuTemperature, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpProxyServerAbrt=httpProxyServerAbrt, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslProxyCacheHits=sslProxyCacheHits, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsRCTotQueued=ipsRCTotQueued, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsUrlAclPort=ipsUrlAclPort, sslProxyActiveConn=sslProxyActiveConn, memUtilization=memUtilization, bws=bws, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, operationalMode=operationalMode, httpSrvrAddress=httpSrvrAddress, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsCookieSecAddressType=ipsCookieSecAddressType, sslSrvrAddress=sslSrvrAddress, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsRCTotDropped=ipsRCTotDropped, httpProxyActiveConn=httpProxyActiveConn, serverDown=serverDown, httpProxyInBytes=httpProxyInBytes, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpSrvrTotTimedout=httpSrvrTotTimedout, systemFanSpeed=systemFanSpeed, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpSrvrInBytes=httpSrvrInBytes, ipsCookieSecPort=ipsCookieSecPort, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, firmwareStorage=firmwareStorage, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsHdrAclAddressType=ipsHdrAclAddressType, dataPortLinkDown=dataPortLinkDown, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, systemLoad=systemLoad, sslProxyPort=sslProxyPort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, raidDegrading=raidDegrading, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsRCTimeStamp=ipsRCTimeStamp, ipsReqLimitAddress=ipsReqLimitAddress, cpuFanSpeed=cpuFanSpeed, webCacheStale=webCacheStale, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, logStorageHigh=logStorageHigh, serviceName=serviceName, ipsReqLimitAddressType=ipsReqLimitAddressType)
