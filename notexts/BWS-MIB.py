...
ModuleIdentity, MibIdentifier, NotificationType, Integer32, Unsigned32, Counter64, Gauge32, Bits, ObjectIdentity, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "NotificationType", "Integer32", "Unsigned32", "Counter64", "Gauge32", "Bits", "ObjectIdentity", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("BWS-MIB", bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrTotRefused=sslSrvrTotRefused, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpSrvrPort=httpSrvrPort, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsUrlAclPort=ipsUrlAclPort, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpProxyTotalConn=httpProxyTotalConn, bwsCacheStatsTable=bwsCacheStatsTable, peerDown=peerDown, operationalMode=operationalMode, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsLrnSrvcPort=ipsLrnSrvcPort, httpProxyUnknownRsp=httpProxyUnknownRsp, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, securityDefUpdates=securityDefUpdates, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, logStorageHigh=logStorageHigh, raidDegrading=raidDegrading, activeApplications=activeApplications, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, totalMem=totalMem, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, dataPortLinkUp=dataPortLinkUp, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlAclAddressType=ipsUrlAclAddressType, totalAttacks=totalAttacks, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sharedSecretKeyExpired=sharedSecretKeyExpired, httpProxyServerErr=httpProxyServerErr, webCmprAddressType=webCmprAddressType, activeServers=activeServers, uptime=uptime, serviceName=serviceName, ipsUrlNormAddress=ipsUrlNormAddress, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslSrvrMaxResTime=sslSrvrMaxResTime, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsRCTotQueued=ipsRCTotQueued, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpProxyAddress=httpProxyAddress, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsMIBCompliances=bwsMIBCompliances, webCacheAddress=webCacheAddress, sslSrvrTotSuccess=sslSrvrTotSuccess, webCmprCompressedDataSize=webCmprCompressedDataSize, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, currentFirmwareVersion=currentFirmwareVersion, ipsHdrAclPort=ipsHdrAclPort, ipsReqLimitPort=ipsReqLimitPort, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslSrvrAddress=sslSrvrAddress, bwsMIBConformance=bwsMIBConformance, smRealmName=smRealmName, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, energizeUpdateExpire=energizeUpdateExpire, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpSrvrTotResponse=httpSrvrTotResponse, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, webCacheAddressType=webCacheAddressType, dataPortLinkDown=dataPortLinkDown, webCacheReq=webCacheReq, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, webCacheMiss=webCacheMiss, systemSerialNumber=systemSerialNumber, virusDefUpdates=virusDefUpdates, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, webCacheHits=webCacheHits, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, firmwareStorage=firmwareStorage, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsCookieSecAddress=ipsCookieSecAddress, webCmprProtocol=webCmprProtocol, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslProxyCacheHits=sslProxyCacheHits, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslSrvrTotTimedout=sslSrvrTotTimedout, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslProxyOutBytes=sslProxyOutBytes, sslProxyErrPms=sslProxyErrPms, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, firmwareUpdateAvailable=firmwareUpdateAvailable, cpuUtilization=cpuUtilization, ipsReqLimitAddressType=ipsReqLimitAddressType, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, serverDown=serverDown, sslSrvrAddressType=sslSrvrAddressType, bwsTrapGroup=bwsTrapGroup, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpSrvrInBytes=httpSrvrInBytes, sslSrvrNumConn=sslSrvrNumConn, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpProxyAddressType=httpProxyAddressType, httpProxyClientAbrt=httpProxyClientAbrt, systemFanSpeed=systemFanSpeed, ipsRCAddress=ipsRCAddress, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, logStorage=logStorage, httpProxyInBytes=httpProxyInBytes, httpSrvrTotSuccess=httpSrvrTotSuccess, freeMem=freeMem, PYSNMP_MODULE_ID=bws, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, webCacheBytesOut=webCacheBytesOut, httpProxyTotalReq=httpProxyTotalReq, srvcName=srvcName, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, cpuFanSpeed=cpuFanSpeed, cpuTemperature=cpuTemperature, systemLoad=systemLoad, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpProxyOutBytes=httpProxyOutBytes, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrAddress=httpSrvrAddress, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslSrvrMinResTime=sslSrvrMinResTime, httpSrvrAddressType=httpSrvrAddressType, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, tempHigh=tempHigh, totalApplications=totalApplications, sslProxyTotalConn=sslProxyTotalConn, sslSrvrOutBytes=sslSrvrOutBytes, bwsMIBCompliance=bwsMIBCompliance, ipsRCPort=ipsRCPort, serverUp=serverUp, bws=bws, ipsWebAddrTransPort=ipsWebAddrTransPort, tempCritical=tempCritical, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, peerUp=peerUp, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwstraps=bwstraps, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsIpsRCStatsTable=bwsIpsRCStatsTable, systemFailure=systemFailure, bwsSMUserSessionEntry=bwsSMUserSessionEntry, linkStatus=linkStatus, sslSrvrSrvcAddress=sslSrvrSrvcAddress, systemFailOver=systemFailOver, httpProxyPort=httpProxyPort, sslProxyAddressType=sslProxyAddressType, ipsUrlNormAddressType=ipsUrlNormAddressType, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrMinResTime=httpSrvrMinResTime, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpProxyActiveConn=httpProxyActiveConn, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, webCacheStale=webCacheStale, switchingToBypassMode=switchingToBypassMode, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, fanDead=fanDead, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsReqSrvcPort=ipsReqSrvcPort, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, servicePort=servicePort, sslProxyCacheMiss=sslProxyCacheMiss, totalBandwidth=totalBandwidth, ipsReqLimitAddress=ipsReqLimitAddress, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, smNumUserSessions=smNumUserSessions, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, dataPathStatus=dataPathStatus, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, switchingToMaintMode=switchingToMaintMode, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsStatsGroup=bwsStatsGroup, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsRCAddressType=ipsRCAddressType, httpProxyParseErr=httpProxyParseErr, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpProxyServerReq=httpProxyServerReq, sslSrvrPort=sslSrvrPort, totalServers=totalServers, ipsHdrAclHits=ipsHdrAclHits, ipsRCTotDropped=ipsRCTotDropped, memUtilization=memUtilization, switchingToInlineMode=switchingToInlineMode, sslProxyActiveConn=sslProxyActiveConn, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpProxySessionTimeOut=httpProxySessionTimeOut, highAvailabilityStatus=highAvailabilityStatus)
mibBuilder.exportSymbols("BWS-MIB", webCmprPort=webCmprPort, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslProxyTotalReq=sslProxyTotalReq, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, firmwareStorageHigh=firmwareStorageHigh, sslSrvrInBytes=sslSrvrInBytes, processCountHigh=processCountHigh, serviceAddress=serviceAddress, httpSrvrOutBytes=httpSrvrOutBytes, sslProxyAddress=sslProxyAddress, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpProxyServerAbrt=httpProxyServerAbrt, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsCookieSecPort=ipsCookieSecPort, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslSrvrAvgResTime=sslSrvrAvgResTime, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslProxyInBytes=sslProxyInBytes, webCacheProtocol=webCacheProtocol, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsMIBGroups=bwsMIBGroups, sslProxyCurrentConn=sslProxyCurrentConn, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlNormPort=ipsUrlNormPort, ipsWebAddrTransAddress=ipsWebAddrTransAddress, memoryUsageHigh=memoryUsageHigh, ipsHdrAclAddress=ipsHdrAclAddress, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsCookieSecTampered=ipsCookieSecTampered, sslSrvrTotResponse=sslSrvrTotResponse, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, serviceStatus=serviceStatus, webCmprAddress=webCmprAddress, bwsMessage=bwsMessage, smAgentName=smAgentName, bwsStats=bwsStats, sslSrvrState=sslSrvrState, sslProxyPort=sslProxyPort, ipsRCTotServed=ipsRCTotServed, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, webCacheLongHdrs=webCacheLongHdrs, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrState=httpSrvrState, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, webCacheCachedObjects=webCacheCachedObjects, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, webCacheCacheableRes=webCacheCacheableRes, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, vipStatus=vipStatus, httpSrvrNumConn=httpSrvrNumConn, ipsUrlAclReserved=ipsUrlAclReserved, webCachePort=webCachePort, ipsRCTimeStamp=ipsRCTimeStamp)
