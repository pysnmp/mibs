...
TimeTicks, Gauge32, MibIdentifier, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, ModuleIdentity, iso, ObjectIdentity, NotificationType, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "MibIdentifier", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "ModuleIdentity", "iso", "ObjectIdentity", "NotificationType", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpSrvrPort=httpSrvrPort, httpSrvrAddress=httpSrvrAddress, cpuTemperature=cpuTemperature, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsWebAddrTransPort=ipsWebAddrTransPort, httpSrvrAddressType=httpSrvrAddressType, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, smRealmName=smRealmName, bwsServiceStatusTable=bwsServiceStatusTable, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrMinResTime=httpSrvrMinResTime, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, webCacheHits=webCacheHits, virusDefUpdates=virusDefUpdates, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrNumConn=sslSrvrNumConn, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, activeServers=activeServers, httpSrvrTotTimedout=httpSrvrTotTimedout, srvcName=srvcName, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, smNumUserSessions=smNumUserSessions, ipsRCAddressType=ipsRCAddressType, dataPortLinkDown=dataPortLinkDown, ipsUrlNormPort=ipsUrlNormPort, ipsUrlNormAddressType=ipsUrlNormAddressType, bwstraps=bwstraps, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, dataPortLinkUp=dataPortLinkUp, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, memoryUsageHigh=memoryUsageHigh, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslSrvrMaxResTime=sslSrvrMaxResTime, webCacheCachedObjects=webCacheCachedObjects, sslSrvrInBytes=sslSrvrInBytes, sslProxyCacheMiss=sslProxyCacheMiss, httpProxyAddressType=httpProxyAddressType, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, serviceName=serviceName, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrState=sslSrvrState, webCacheBytesOut=webCacheBytesOut, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsMIBConformance=bwsMIBConformance, ipsRCTotServed=ipsRCTotServed, systemFailure=systemFailure, totalApplications=totalApplications, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpSrvrTotResponse=httpSrvrTotResponse, webCacheMiss=webCacheMiss, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsLrnSrvcPort=ipsLrnSrvcPort, webCacheCacheableRes=webCacheCacheableRes, webCacheLongHdrs=webCacheLongHdrs, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, serverUp=serverUp, httpProxyServerAbrt=httpProxyServerAbrt, ipsHdrAclAddress=ipsHdrAclAddress, sslProxyOutBytes=sslProxyOutBytes, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, fanDead=fanDead, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrTotRefused=sslSrvrTotRefused, ipsAccessCtrlAddress=ipsAccessCtrlAddress, switchingToMaintMode=switchingToMaintMode, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsUrlAclReserved=ipsUrlAclReserved, serviceAddress=serviceAddress, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpProxyServerErr=httpProxyServerErr, ipsReqSrvcAddress=ipsReqSrvcAddress, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, webCmprProtocol=webCmprProtocol, uptime=uptime, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, tempCritical=tempCritical, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslSrvrAddress=sslSrvrAddress, systemLoad=systemLoad, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrNumConn=httpSrvrNumConn, ipsHdrAclPort=ipsHdrAclPort, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, webCacheReq=webCacheReq, httpSrvrTotRefused=httpSrvrTotRefused, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsCacheStatsEntry=bwsCacheStatsEntry, memUtilization=memUtilization, switchingToBypassMode=switchingToBypassMode, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpSrvrAvgResTime=httpSrvrAvgResTime, energizeUpdateExpire=energizeUpdateExpire, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, logStorageHigh=logStorageHigh, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpProxyWAFWarnings=httpProxyWAFWarnings, httpProxyServerReq=httpProxyServerReq, ipsRCTotQueued=ipsRCTotQueued, webCmprCompressedDataSize=webCmprCompressedDataSize, vipStatus=vipStatus, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsReqLimitPort=ipsReqLimitPort, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpProxyActiveConn=httpProxyActiveConn, totalMem=totalMem, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, webCmprAddress=webCmprAddress, servicePort=servicePort, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsMIBCompliances=bwsMIBCompliances, httpSrvrTotSuccess=httpSrvrTotSuccess, processCountHigh=processCountHigh, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrOutBytes=httpSrvrOutBytes, bwsMIBGroups=bwsMIBGroups, securityDefUpdates=securityDefUpdates, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrInBytes=httpSrvrInBytes, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsUrlAclAddress=ipsUrlAclAddress, sslProxyBadDNCErr=sslProxyBadDNCErr, peerUp=peerUp, httpProxyInBytes=httpProxyInBytes, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslProxyCurrentConn=sslProxyCurrentConn, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsHdrAclAddressType=ipsHdrAclAddressType, systemSerialNumber=systemSerialNumber, ipsRCTotOutOfResource=ipsRCTotOutOfResource, serviceStatus=serviceStatus, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, tempHigh=tempHigh, cpuUtilization=cpuUtilization, systemFanSpeed=systemFanSpeed, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsRCPort=ipsRCPort, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslProxyActiveConn=sslProxyActiveConn, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, webCacheProtocol=webCacheProtocol, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslProxyTotalReq=sslProxyTotalReq, bwsServiceStatusEntry=bwsServiceStatusEntry, sslProxyInBytes=sslProxyInBytes, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, freeMem=freeMem, sslProxyTotalConn=sslProxyTotalConn, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsMIBCompliance=bwsMIBCompliance, webCacheAddress=webCacheAddress, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslSrvrAddressType=sslSrvrAddressType, ipsCookieSecPort=ipsCookieSecPort, ipsUrlPolicyAddress=ipsUrlPolicyAddress, serverDown=serverDown, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, webCachePort=webCachePort, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslProxyAddress=sslProxyAddress, peerDown=peerDown, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpProxyOutBytes=httpProxyOutBytes, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, switchingToInlineMode=switchingToInlineMode, sslProxyCacheHits=sslProxyCacheHits, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, operationalMode=operationalMode, activeApplications=activeApplications, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslProxyCacheTimeouts=sslProxyCacheTimeouts, logStorage=logStorage, ipsReqSrvcPort=ipsReqSrvcPort, bwsSMUserSessionTable=bwsSMUserSessionTable, bws=bws, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslProxyErrPms=sslProxyErrPms, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, raidDegrading=raidDegrading, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, cpuFanSpeed=cpuFanSpeed, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsRCTotDropped=ipsRCTotDropped, totalAttacks=totalAttacks, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsStats=bwsStats, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslProxyAddressType=sslProxyAddressType, httpProxyParseErr=httpProxyParseErr, dataPathStatus=dataPathStatus, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsLrnSrvcAddress=ipsLrnSrvcAddress, totalBandwidth=totalBandwidth, webCmprAddressType=webCmprAddressType, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslSrvrPort=sslSrvrPort, totalServers=totalServers, PYSNMP_MODULE_ID=bws, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, firmwareStorage=firmwareStorage)
mibBuilder.exportSymbols("BWS-MIB", bwsStatsGroup=bwsStatsGroup, smAgentName=smAgentName, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsTrapGroup=bwsTrapGroup, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsRCAddress=ipsRCAddress, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, webCacheStale=webCacheStale, ipsHdrAclHits=ipsHdrAclHits, systemFailOver=systemFailOver, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslSrvrTotReqActive=sslSrvrTotReqActive, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsReqLimitAddress=ipsReqLimitAddress, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsUrlNormAddress=ipsUrlNormAddress, sslSrvrTotResponse=sslSrvrTotResponse, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsUrlAclPort=ipsUrlAclPort, httpProxyTotalReq=httpProxyTotalReq, httpProxyAddress=httpProxyAddress, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrState=httpSrvrState, linkStatus=linkStatus, highAvailabilityStatus=highAvailabilityStatus, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpProxyTotalConn=httpProxyTotalConn, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslSrvrMinResTime=sslSrvrMinResTime, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsMessage=bwsMessage, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslProxyPort=sslProxyPort, httpProxyPort=httpProxyPort, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslSrvrSrvcPort=sslSrvrSrvcPort, webCacheAddressType=webCacheAddressType, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsRCTimeStamp=ipsRCTimeStamp, firmwareStorageHigh=firmwareStorageHigh, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrOutBytes=sslSrvrOutBytes, ipsCookieSecAddress=ipsCookieSecAddress, webCmprPort=webCmprPort, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpProxyUnknownRsp=httpProxyUnknownRsp, currentFirmwareVersion=currentFirmwareVersion)
