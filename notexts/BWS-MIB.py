...
iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, Unsigned32, NotificationType, Counter64, MibIdentifier, Gauge32, Counter32, TimeTicks, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "Unsigned32", "NotificationType", "Counter64", "MibIdentifier", "Gauge32", "Counter32", "TimeTicks", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("BWS-MIB", ipsHdrAclAddress=ipsHdrAclAddress, ipsUrlPolicyPort=ipsUrlPolicyPort, memUtilization=memUtilization, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, webCacheReq=webCacheReq, sslSrvrTotResponse=sslSrvrTotResponse, serverDown=serverDown, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, smRealmName=smRealmName, httpSrvrState=httpSrvrState, energizeUpdateExpire=energizeUpdateExpire, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsHdrAclPort=ipsHdrAclPort, dataPortLinkDown=dataPortLinkDown, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslProxyOutBytes=sslProxyOutBytes, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpSrvrTotResponse=httpSrvrTotResponse, bwsIpsRCStatsTable=bwsIpsRCStatsTable, totalApplications=totalApplications, bwsCacheStatsTable=bwsCacheStatsTable, bws=bws, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsMIBGroups=bwsMIBGroups, bwsCompressionStatsEntry=bwsCompressionStatsEntry, cpuUtilization=cpuUtilization, ipsUrlAclReserved=ipsUrlAclReserved, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, freeMem=freeMem, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslProxyCurrentConn=sslProxyCurrentConn, serviceAddress=serviceAddress, currentFirmwareVersion=currentFirmwareVersion, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpProxyActiveConn=httpProxyActiveConn, firmwareStorageHigh=firmwareStorageHigh, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsUrlNormAddress=ipsUrlNormAddress, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsUrlAclPort=ipsUrlAclPort, sslProxyErrPms=sslProxyErrPms, operationalMode=operationalMode, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsHdrAclAddressType=ipsHdrAclAddressType, httpSrvrNumConn=httpSrvrNumConn, sslProxyCacheHits=sslProxyCacheHits, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsUrlAclAddressType=ipsUrlAclAddressType, sslProxyTotalConn=sslProxyTotalConn, cpuFanSpeed=cpuFanSpeed, webCacheBytesOut=webCacheBytesOut, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, memoryUsageHigh=memoryUsageHigh, httpProxyServerReq=httpProxyServerReq, webCacheCacheableRes=webCacheCacheableRes, httpProxyParseErr=httpProxyParseErr, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsUrlNormPort=ipsUrlNormPort, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, switchingToMaintMode=switchingToMaintMode, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsSMUserSessionTable=bwsSMUserSessionTable, sslSrvrSrvcAddress=sslSrvrSrvcAddress, peerDown=peerDown, ipsUrlPolicyAddress=ipsUrlPolicyAddress, webCacheProtocol=webCacheProtocol, uptime=uptime, totalAttacks=totalAttacks, sslSrvrTotRefused=sslSrvrTotRefused, sslSrvrTotReqActive=sslSrvrTotReqActive, highAvailabilityStatus=highAvailabilityStatus, ipsReqSrvcPort=ipsReqSrvcPort, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpProxyClientAbrt=httpProxyClientAbrt, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslProxyActiveConn=sslProxyActiveConn, httpProxyAddressType=httpProxyAddressType, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslProxyInBytes=sslProxyInBytes, firmwareUpdateAvailable=firmwareUpdateAvailable, sslSrvrAddressType=sslSrvrAddressType, httpSrvrMinResTime=httpSrvrMinResTime, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsLrnSrvcPort=ipsLrnSrvcPort, raidDegrading=raidDegrading, sslProxyPort=sslProxyPort, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsRCTotDropped=ipsRCTotDropped, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslProxyAddress=sslProxyAddress, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsMessage=bwsMessage, switchingToBypassMode=switchingToBypassMode, virusDefUpdates=virusDefUpdates, webCmprProtocol=webCmprProtocol, bwsMIBConformance=bwsMIBConformance, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpProxyServerErr=httpProxyServerErr, sslSrvrTotReqRejected=sslSrvrTotReqRejected, webCacheMiss=webCacheMiss, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, linkStatus=linkStatus, ipsRCAddress=ipsRCAddress, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslSrvrAddress=sslSrvrAddress, bwsSMUserSessionEntry=bwsSMUserSessionEntry, totalServers=totalServers, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsRCAddressType=ipsRCAddressType, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpSrvrTotSuccess=httpSrvrTotSuccess, totalMem=totalMem, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpSrvrOutBytes=httpSrvrOutBytes, bwsTrapGroup=bwsTrapGroup, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrInBytes=httpSrvrInBytes, webCmprPort=webCmprPort, httpProxyTotalReq=httpProxyTotalReq, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, vipStatus=vipStatus, httpProxyServerAbrt=httpProxyServerAbrt, webCacheStale=webCacheStale, securityDefUpdates=securityDefUpdates, ipsRCPort=ipsRCPort, webCacheCachedObjects=webCacheCachedObjects, httpSrvrAddress=httpSrvrAddress, sslSrvrPort=sslSrvrPort, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsStats=bwsStats, tempCritical=tempCritical, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, totalBandwidth=totalBandwidth, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsRCTotOutOfResource=ipsRCTotOutOfResource, smAgentName=smAgentName, servicePort=servicePort, bwstraps=bwstraps, sslProxyAddressType=sslProxyAddressType, sslSrvrInBytes=sslSrvrInBytes, activeApplications=activeApplications, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, systemFailure=systemFailure, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsRCTimeStamp=ipsRCTimeStamp, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, newAttackDefinitionInstalled=newAttackDefinitionInstalled, systemSerialNumber=systemSerialNumber, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, webCacheLongHdrs=webCacheLongHdrs, httpSrvrTotRefused=httpSrvrTotRefused, switchingToInlineMode=switchingToInlineMode, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsReqLimitPort=ipsReqLimitPort, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsRCTotServed=ipsRCTotServed, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslProxyTotalReq=sslProxyTotalReq, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpProxyOutBytes=httpProxyOutBytes, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsHdrAclHits=ipsHdrAclHits, serviceName=serviceName, serverUp=serverUp, sslSrvrMinResTime=sslSrvrMinResTime, ipsRCTotQueued=ipsRCTotQueued, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslProxyCacheMiss=sslProxyCacheMiss, firmwareStorage=firmwareStorage, httpSrvrTotReqActive=httpSrvrTotReqActive, srvcName=srvcName, sslProxyBadDNCErr=sslProxyBadDNCErr, webCacheAddress=webCacheAddress, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsMIBCompliances=bwsMIBCompliances, ipsReqLimitAddress=ipsReqLimitAddress, tempHigh=tempHigh, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, fanDead=fanDead, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsStatsGroup=bwsStatsGroup, ipsUrlNormAddressType=ipsUrlNormAddressType, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpSrvrPort=httpSrvrPort, dataPathStatus=dataPathStatus, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslProxyFullHandshakes=sslProxyFullHandshakes, smNumUserSessions=smNumUserSessions, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrMaxResTime=sslSrvrMaxResTime, httpSrvrAddressType=httpSrvrAddressType, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, webCmprAddress=webCmprAddress, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslSrvrTotTimedout=sslSrvrTotTimedout, systemLoad=systemLoad, webCacheHits=webCacheHits, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsCookieSecTampered=ipsCookieSecTampered, httpProxyAddress=httpProxyAddress, logStorageHigh=logStorageHigh, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslSrvrOutBytes=sslSrvrOutBytes, bwsMIBCompliance=bwsMIBCompliance, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsCookieSecAddressType=ipsCookieSecAddressType, cpuTemperature=cpuTemperature, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, webCmprAddressType=webCmprAddressType, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsUrlAclAddress=ipsUrlAclAddress, ipsCookieSecPort=ipsCookieSecPort, ipsCookieSecAddress=ipsCookieSecAddress, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpProxyWAFWarnings=httpProxyWAFWarnings, dataPortLinkUp=dataPortLinkUp, webCacheAddressType=webCacheAddressType, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpProxyPort=httpProxyPort, serviceStatus=serviceStatus, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrState=sslSrvrState, httpProxyTotalConn=httpProxyTotalConn, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, systemFailOver=systemFailOver, httpProxyInBytes=httpProxyInBytes, PYSNMP_MODULE_ID=bws, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, peerUp=peerUp, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, processCountHigh=processCountHigh, webCachePort=webCachePort, sslSrvrNumConn=sslSrvrNumConn, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, systemFanSpeed=systemFanSpeed, logStorage=logStorage, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, activeServers=activeServers, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsServiceStatusTable=bwsServiceStatusTable)
