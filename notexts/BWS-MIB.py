...
Gauge32, ObjectIdentity, MibIdentifier, NotificationType, TimeTicks, Counter64, iso, Unsigned32, Integer32, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "MibIdentifier", "NotificationType", "TimeTicks", "Counter64", "iso", "Unsigned32", "Integer32", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("BWS-MIB", httpProxySessionTimeOut=httpProxySessionTimeOut, sslProxyTotalReq=sslProxyTotalReq, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, freeMem=freeMem, sslProxyTotalConn=sslProxyTotalConn, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpProxyTotalConn=httpProxyTotalConn, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, processCountHigh=processCountHigh, firmwareStorage=firmwareStorage, webCmprProtocol=webCmprProtocol, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, cpuTemperature=cpuTemperature, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrTotResponse=sslSrvrTotResponse, sslProxyBadDNCErr=sslProxyBadDNCErr, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, webCmprAddressType=webCmprAddressType, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpProxyTotalReq=httpProxyTotalReq, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, switchingToInlineMode=switchingToInlineMode, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, peerUp=peerUp, sslProxyCacheMiss=sslProxyCacheMiss, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, virusDefUpdates=virusDefUpdates, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, raidDegrading=raidDegrading, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsAccessCtrlAddress=ipsAccessCtrlAddress, webCmprAddress=webCmprAddress, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, webCachePort=webCachePort, sslSrvrNumConn=sslSrvrNumConn, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, currentFirmwareVersion=currentFirmwareVersion, httpSrvrNumFreeConn=httpSrvrNumFreeConn, logStorage=logStorage, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpProxyWAFWarnings=httpProxyWAFWarnings, httpProxyActiveConn=httpProxyActiveConn, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsUrlNormAddress=ipsUrlNormAddress, sslProxyErrPms=sslProxyErrPms, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrState=httpSrvrState, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, smRealmName=smRealmName, sslProxyAddressType=sslProxyAddressType, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsRCAddressType=ipsRCAddressType, sslSrvrTotReqRejected=sslSrvrTotReqRejected, activeApplications=activeApplications, bwsMessage=bwsMessage, totalAttacks=totalAttacks, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsReqLimitAddress=ipsReqLimitAddress, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpProxyClientAbrt=httpProxyClientAbrt, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslProxyAddress=sslProxyAddress, serviceName=serviceName, bwsMIBCompliance=bwsMIBCompliance, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, switchingToBypassMode=switchingToBypassMode, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsReqLimitPort=ipsReqLimitPort, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, systemFailOver=systemFailOver, ipsRCTotServed=ipsRCTotServed, httpProxyAddress=httpProxyAddress, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsCookieSecAddressType=ipsCookieSecAddressType, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrMinResTime=sslSrvrMinResTime, httpSrvrTotResponse=httpSrvrTotResponse, bwsStats=bwsStats, serverUp=serverUp, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsRCPort=ipsRCPort, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, memUtilization=memUtilization, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, smAgentName=smAgentName, httpSrvrAddress=httpSrvrAddress, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, securityDefUpdates=securityDefUpdates, firmwareStorageHigh=firmwareStorageHigh, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, smNumUserSessions=smNumUserSessions, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, serviceAddress=serviceAddress, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsReqSrvcAddress=ipsReqSrvcAddress, systemSerialNumber=systemSerialNumber, newAttackDefinitionInstalled=newAttackDefinitionInstalled, tempCritical=tempCritical, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, webCacheMiss=webCacheMiss, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslProxyOutBytes=sslProxyOutBytes, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, highAvailabilityStatus=highAvailabilityStatus, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, linkStatus=linkStatus, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsMIBCompliances=bwsMIBCompliances, bwstraps=bwstraps, systemLoad=systemLoad, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsTrapGroup=bwsTrapGroup, sslSrvrState=sslSrvrState, sslSrvrInBytes=sslSrvrInBytes, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlAclReserved=ipsUrlAclReserved, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpSrvrOutBytes=httpSrvrOutBytes, totalBandwidth=totalBandwidth, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslProxyCacheHits=sslProxyCacheHits, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrTotRefused=sslSrvrTotRefused, bwsMIBConformance=bwsMIBConformance, ipsWebAddrTransPort=ipsWebAddrTransPort, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, servicePort=servicePort, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslSrvrAddressType=sslSrvrAddressType, totalServers=totalServers, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, serverDown=serverDown, ipsReqSrvcAddressType=ipsReqSrvcAddressType, tempHigh=tempHigh, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsMIBGroups=bwsMIBGroups, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bws=bws, ipsRCTotDropped=ipsRCTotDropped, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslProxyPort=sslProxyPort, energizeUpdateExpire=energizeUpdateExpire, webCacheLongHdrs=webCacheLongHdrs, dataPortLinkDown=dataPortLinkDown, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsCookieSecAddress=ipsCookieSecAddress, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, fanDead=fanDead, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, systemFanSpeed=systemFanSpeed, httpSrvrNumConn=httpSrvrNumConn, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslProxyInBytes=sslProxyInBytes, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, webCacheStale=webCacheStale, ipsCookieSecTampered=ipsCookieSecTampered, cpuUtilization=cpuUtilization, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsCompressionStatsEntry=bwsCompressionStatsEntry, operationalMode=operationalMode, httpProxyParseErr=httpProxyParseErr, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpProxyOutBytes=httpProxyOutBytes, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, webCacheCacheableRes=webCacheCacheableRes, activeServers=activeServers, ipsRCAddress=ipsRCAddress, ipsRCTimeStamp=ipsRCTimeStamp, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrInBytes=httpSrvrInBytes, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, srvcName=srvcName, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsReqSrvcPort=ipsReqSrvcPort, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslSrvrPort=sslSrvrPort, serviceStatus=serviceStatus, httpProxyServerErr=httpProxyServerErr, bwsServiceStatusEntry=bwsServiceStatusEntry, sslSrvrOutBytes=sslSrvrOutBytes, httpSrvrPort=httpSrvrPort, PYSNMP_MODULE_ID=bws, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, peerDown=peerDown, ipsHdrAclAddress=ipsHdrAclAddress, ipsRCTotQueued=ipsRCTotQueued, totalApplications=totalApplications, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, switchingToMaintMode=switchingToMaintMode, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpSrvrAddressType=httpSrvrAddressType, firmwareUpdateAvailable=firmwareUpdateAvailable, webCacheCachedObjects=webCacheCachedObjects, systemFailure=systemFailure, webCacheAddressType=webCacheAddressType, sharedSecretKeyExpired=sharedSecretKeyExpired, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrMinResTime=httpSrvrMinResTime, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsCookieSecPort=ipsCookieSecPort, cpuFanSpeed=cpuFanSpeed, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsHdrAclPort=ipsHdrAclPort, ipsUrlAclAddress=ipsUrlAclAddress, vipStatus=vipStatus, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslSrvrAddress=sslSrvrAddress, logStorageHigh=logStorageHigh, httpProxyAddressType=httpProxyAddressType, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsStatsGroup=bwsStatsGroup, httpSrvrTotRefused=httpSrvrTotRefused, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, webCmprCompressibleDataSize=webCmprCompressibleDataSize, uptime=uptime, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, totalMem=totalMem, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslProxyCurrentConn=sslProxyCurrentConn, ipsUrlAclPort=ipsUrlAclPort, memoryUsageHigh=memoryUsageHigh, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpProxyServerReq=httpProxyServerReq, sslSrvrTotTimedout=sslSrvrTotTimedout, sslProxyActiveConn=sslProxyActiveConn, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, webCacheBytesOut=webCacheBytesOut, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsServiceStatusTable=bwsServiceStatusTable, httpProxyPort=httpProxyPort, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsHdrAclHits=ipsHdrAclHits, ipsUrlPolicyPort=ipsUrlPolicyPort, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsCompressionStatsTable=bwsCompressionStatsTable, webCacheReq=webCacheReq, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, dataPathStatus=dataPathStatus, httpProxyServerAbrt=httpProxyServerAbrt, httpProxyInBytes=httpProxyInBytes, ipsWebAddrTransAddress=ipsWebAddrTransAddress, webCacheAddress=webCacheAddress, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, webCmprPort=webCmprPort, httpSrvrMaxResTime=httpSrvrMaxResTime, dataPortLinkUp=dataPortLinkUp, webCacheProtocol=webCacheProtocol, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsUrlNormPort=ipsUrlNormPort, webCacheHits=webCacheHits, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime)
