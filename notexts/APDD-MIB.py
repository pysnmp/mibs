...
mibBuilder.exportSymbols("APDD-MIB", apDDNotifObjects=apDDNotifObjects, apDdDnsCacheHitsRecent=apDdDnsCacheHitsRecent, apDdMsgTypeClientRetransTotal=apDdMsgTypeClientRetransTotal, apDdNoRouteFoundTotal=apDdNoRouteFoundTotal, apDdMsgTypeClientThrottledPerMax=apDdMsgTypeClientThrottledPerMax, apDdAgentMsgTypeServerRetransPerMax=apDdAgentMsgTypeServerRetransPerMax, apDDNotifObjectsGroup=apDDNotifObjectsGroup, apDdMsgTypeClientThrottledRecent=apDdMsgTypeClientThrottledRecent, apDdAgentGenConnectsCPActive=apDdAgentGenConnectsCPActive, apDdAgentRealmName=apDdAgentRealmName, apDDMIBTabularObjects=apDDMIBTabularObjects, apDdMsgStatsReturnCodeGroup=apDdMsgStatsReturnCodeGroup, apDdAgentStatsTable=apDdAgentStatsTable, apDdAgentGeneralGroup=apDdAgentGeneralGroup, apDdMalformedMsgTotal=apDdMalformedMsgTotal, apDdDnsCacheHitsTotal=apDdDnsCacheHitsTotal, apDdMsgStatsReturnCodeTable=apDdMsgStatsReturnCodeTable, apDdServerTransLTTotal=apDdServerTransLTTotal, apDdSessionLifeHigh=apDdSessionLifeHigh, apDdAgentGenConnectsCPTotal=apDdAgentGenConnectsCPTotal, apDdPolicyHitPeriodActive=apDdPolicyHitPeriodActive, apDdServerTransLTHigh=apDdServerTransLTHigh, apDdAgentMalformedMsgPerMax=apDdAgentMalformedMsgPerMax, apDdAgentDnsCacheHitsTotal=apDdAgentDnsCacheHitsTotal, apDdDiameterAgentOriginHostName=apDdDiameterAgentOriginHostName, apDdDnsQueriesPerMax=apDdDnsQueriesPerMax, apDdUnsubscribeLifeTotal=apDdUnsubscribeLifeTotal, apDdMsgTypeClientTimeoutRecent=apDdMsgTypeClientTimeoutRecent, apDdInterfaceRealmName=apDdInterfaceRealmName, apDdAgentMsgTypeServerReqRecent=apDdAgentMsgTypeServerReqRecent, apDDSCTPNotifObjectsGroup=apDDSCTPNotifObjectsGroup, ApDdStatusOptions=ApDdStatusOptions, apDdGenSocketsLTTotal=apDdGenSocketsLTTotal, apDdMsgReturnCodeServerPerMax=apDdMsgReturnCodeServerPerMax, apDdAgentMsgReturnCodeServerTotal=apDdAgentMsgReturnCodeServerTotal, apDdAgentDnsCacheMissesRecent=apDdAgentDnsCacheMissesRecent, apDdInterfaceStatus=apDdInterfaceStatus, apDdInboundConstraintsRecent=apDdInboundConstraintsRecent, apDdLowTransRate=apDdLowTransRate, apDdSessTerminatedPeriodTotal=apDdSessTerminatedPeriodTotal, apDdSCTPPathFailureClearTrap=apDdSCTPPathFailureClearTrap, apDdSessionLifeTotal=apDdSessionLifeTotal, apDdMsgReturnCodeName=apDdMsgReturnCodeName, apDdAgentMsgTypeServerReqTotal=apDdAgentMsgTypeServerReqTotal, apDdAgentDnsClientErrorsTotal=apDdAgentDnsClientErrorsTotal, apDdAgentStatsEntry=apDdAgentStatsEntry, apDDSCTPNotificationsGroup=apDDSCTPNotificationsGroup, apDdUnsubscribePeriodActive=apDdUnsubscribePeriodActive, apDdAgentClientTransCPTotal=apDdAgentClientTransCPTotal, apDdAgentMsgTypeClientRetransTotal=apDdAgentMsgTypeClientRetransTotal, apDdDiameterRemoteIPPort=apDdDiameterRemoteIPPort, apDdGenConnectsLTPerMax=apDdGenConnectsLTPerMax, apDdClientTransLTTotal=apDdClientTransLTTotal, apDdAgentMsgTypeServerRespRetransPerMax=apDdAgentMsgTypeServerRespRetransPerMax, apDdMsgTypeServerRespRetransRecent=apDdMsgTypeServerRespRetransRecent, apDdDroppedMsgRecent=apDdDroppedMsgRecent, apDdPolicyMissPeriodHigh=apDdPolicyMissPeriodHigh, apDdSessEstablishedLifeTotal=apDdSessEstablishedLifeTotal, PYSNMP_MODULE_ID=apDDModule, apDdMsgTypeMsgName=apDdMsgTypeMsgName, apDdMsgTypeClientRespRetransPerMax=apDdMsgTypeClientRespRetransPerMax, apDdSessionPeriodHigh=apDdSessionPeriodHigh, apDdMsgStatsReturnCodeEntry=apDdMsgStatsReturnCodeEntry, apDdSessionSubscriberGeneralGroup=apDdSessionSubscriberGeneralGroup, apDdDiameterIPPort=apDdDiameterIPPort, apDdDiameterAgentOriginRealmName=apDdDiameterAgentOriginRealmName, apDdSubscriberMissPeriodTotal=apDdSubscriberMissPeriodTotal, apDdAgentGenSocketsLTTotal=apDdAgentGenSocketsLTTotal, apDdDnsResponsesRecent=apDdDnsResponsesRecent, apDdMsgTypeStatsTable=apDdMsgTypeStatsTable, apDDObjectGroups=apDDObjectGroups, apDdHighTransRate=apDdHighTransRate, apDdSessEstablishedPeriodHigh=apDdSessEstablishedPeriodHigh, apDdMsgTypeInfoTable=apDdMsgTypeInfoTable, apDdAgentInboundConstraintsPerMax=apDdAgentInboundConstraintsPerMax, apDdServerTransCPHigh=apDdServerTransCPHigh, apDdAgentMsgTypeClientRetransRecent=apDdAgentMsgTypeClientRetransRecent, apDdAgentDnsStatsEntry=apDdAgentDnsStatsEntry, apDdSessErrorsLifePerMax=apDdSessErrorsLifePerMax, apDdAgentMsgTypeClientRespRetransRecent=apDdAgentMsgTypeClientRespRetransRecent, apDdMsgTypeClientRetransPerMax=apDdMsgTypeClientRetransPerMax, apDdAgentServerTransLTPerMax=apDdAgentServerTransLTPerMax, apDdAgentDroppedMsgRecent=apDdAgentDroppedMsgRecent, apDdSubscriberLifePerMax=apDdSubscriberLifePerMax, apDdAgentGenSocketsCPActive=apDdAgentGenSocketsCPActive, apDdMsgTypeClientTimeoutTotal=apDdMsgTypeClientTimeoutTotal, apDdAgentGenConnectsLTHigh=apDdAgentGenConnectsLTHigh, apDdPolicyMissPeriodActive=apDdPolicyMissPeriodActive, apDdMalformedMsgPerMax=apDdMalformedMsgPerMax, apDdMsgTypeClientReqPerMax=apDdMsgTypeClientReqPerMax, apDdErrorStatusTable=apDdErrorStatusTable, apDdConnectionFailureClearTrap=apDdConnectionFailureClearTrap, apDdDiameterAgentHostName=apDdDiameterAgentHostName, apDdAgentServerTransCPTotal=apDdAgentServerTransCPTotal, apDdGenConnectsCPActive=apDdGenConnectsCPActive, apDdMsgReturnCodeClientRecent=apDdMsgReturnCodeClientRecent, apDdAgentInboundConstraintsRecent=apDdAgentInboundConstraintsRecent, apDdServerTransCPTotal=apDdServerTransCPTotal, apDdAgentServerTransLTTotal=apDdAgentServerTransLTTotal, apDdSessTimeoutLifeTotal=apDdSessTimeoutLifeTotal, apDdSessErrorsPeriodTotal=apDdSessErrorsPeriodTotal, apDDModule=apDDModule, apDdClientTransCPHigh=apDdClientTransCPHigh, apDdAgentDnsCacheHitsPerMax=apDdAgentDnsCacheHitsPerMax, apDdSessEstablishedPeriodActive=apDdSessEstablishedPeriodActive, apDdAgentDnsResponsesRecent=apDdAgentDnsResponsesRecent, apDdAgentNoRouteFoundRecent=apDdAgentNoRouteFoundRecent, apDdAgentErrorStatusTable=apDdAgentErrorStatusTable, apDdSessEstablishedLifePerMax=apDdSessEstablishedLifePerMax, apDdSessEstablishedLifeHigh=apDdSessEstablishedLifeHigh, apDDNotificationGroups=apDDNotificationGroups, apDdAgentServerTransCPActive=apDdAgentServerTransCPActive, apDdMsgTypeServerRespRetransPerMax=apDdMsgTypeServerRespRetransPerMax, apDdDnsCacheHitsPerMax=apDdDnsCacheHitsPerMax, apDdAgentNoRouteFoundTotal=apDdAgentNoRouteFoundTotal, apDdDnsQueriesRecent=apDdDnsQueriesRecent, apDdAgentMalformedMsgTotal=apDdAgentMalformedMsgTotal, apDdMsgTypeAverageLatency=apDdMsgTypeAverageLatency, apDDNotificationsGroup=apDDNotificationsGroup, apDdAgentClientTransLTTotal=apDdAgentClientTransLTTotal, apDdPolicyHitLifePerMax=apDdPolicyHitLifePerMax, apDdNoRouteFoundRecent=apDdNoRouteFoundRecent, apDdClientTransLTHigh=apDdClientTransLTHigh, apDdSubscribeLifePerMax=apDdSubscribeLifePerMax, apDdMsgTypeInfoEntry=apDdMsgTypeInfoEntry, apDdGenSocketsCPActive=apDdGenSocketsCPActive, apDdDnsResponsesTotal=apDdDnsResponsesTotal, apDdSessMissPeriodTotal=apDdSessMissPeriodTotal, apDdCurrentTransRate=apDdCurrentTransRate, apDdAgentGenSocketsLTHigh=apDdAgentGenSocketsLTHigh, apDdAgentGenConnectsLTPerMax=apDdAgentGenConnectsLTPerMax, apDdAgentMsgTypeClientThrottledPerMax=apDdAgentMsgTypeClientThrottledPerMax, apDdSubscriberMissLifeTotal=apDdSubscriberMissLifeTotal, apDdAgentDnsCacheMissesPerMax=apDdAgentDnsCacheMissesPerMax, apDdAgentMsgTypeServerRetransTotal=apDdAgentMsgTypeServerRetransTotal, apDdMsgTypeClientReqTotal=apDdMsgTypeClientReqTotal, apDdAgentNoRouteFoundPerMax=apDdAgentNoRouteFoundPerMax, apDdAgentMsgTypeClientThrottledTotal=apDdAgentMsgTypeClientThrottledTotal, apDdSessTerminatedLifeHigh=apDdSessTerminatedLifeHigh, apDdMsgReturnCodeServerTotal=apDdMsgReturnCodeServerTotal, apDdClientTransCPTotal=apDdClientTransCPTotal, apDdAgentGenSocketsLTPerMax=apDdAgentGenSocketsLTPerMax, apDdInterfaceStatsGroup=apDdInterfaceStatsGroup, apDdSessInitPeriodActive=apDdSessInitPeriodActive, apDdAgentMsgReturnCodeClientRecent=apDdAgentMsgReturnCodeClientRecent, apDdDnsClientErrorsTotal=apDdDnsClientErrorsTotal, apDdAgentMalformedMsgRecent=apDdAgentMalformedMsgRecent, apDdAgentRejectedMsgRecent=apDdAgentRejectedMsgRecent, apDdSessErrorsLifeTotal=apDdSessErrorsLifeTotal, apDdAgentMsgStatsReturnCodeGroup=apDdAgentMsgStatsReturnCodeGroup, apDdSessInitLifePerMax=apDdSessInitLifePerMax, apDDNotifPrefix=apDDNotifPrefix, apDdAgentMsgTypeServerRespRetransRecent=apDdAgentMsgTypeServerRespRetransRecent, apDdAgentGenSocketsCPTotal=apDdAgentGenSocketsCPTotal, apDdAgentDroppedMsgPerMax=apDdAgentDroppedMsgPerMax, apDdMsgTypeClientRespRetransRecent=apDdMsgTypeClientRespRetransRecent, apDdDroppedMsgPerMax=apDdDroppedMsgPerMax, apDdMsgTypeClientRespRetransTotal=apDdMsgTypeClientRespRetransTotal, apDdAgentInboundConstraintsTotal=apDdAgentInboundConstraintsTotal, apDdMsgReturnCodeInfoEntry=apDdMsgReturnCodeInfoEntry, apDdSubscribeLifeTotal=apDdSubscribeLifeTotal, apDdAgentOutboundConstraintsRecent=apDdAgentOutboundConstraintsRecent, apDdAgentDnsCacheMissesTotal=apDdAgentDnsCacheMissesTotal, apDdDroppedMsgTotal=apDdDroppedMsgTotal, apDdPolicyMissPeriodTotal=apDdPolicyMissPeriodTotal, apDdMsgReturnCodeIndex=apDdMsgReturnCodeIndex, apDdAgentDnsServerErrorsTotal=apDdAgentDnsServerErrorsTotal, apDdAgentStatus=apDdAgentStatus, apDdAgentGenConnectsCPHigh=apDdAgentGenConnectsCPHigh, apDdAgentErrorStatusEntry=apDdAgentErrorStatusEntry, apDdUnsubscribeLifePerMax=apDdUnsubscribeLifePerMax, apDdGenSocketsLTPerMax=apDdGenSocketsLTPerMax, apDdGenSocketsCPHigh=apDdGenSocketsCPHigh, apDdMsgTypeClientReqRecent=apDdMsgTypeClientReqRecent, apDdAgentRejectedMsgPerMax=apDdAgentRejectedMsgPerMax, apDdSessMissLifeTotal=apDdSessMissLifeTotal, apDDNotificationObjects=apDDNotificationObjects, apDdUnsubscribePeriodHigh=apDdUnsubscribePeriodHigh, apDdAgentMsgTypeServerRetransRecent=apDdAgentMsgTypeServerRetransRecent, apDdDnsCacheMissesTotal=apDdDnsCacheMissesTotal, apDdAgentMsgTypeLatencyWindow=apDdAgentMsgTypeLatencyWindow, apDDConformance=apDDConformance, apDdAgentDnsCacheHitsRecent=apDdAgentDnsCacheHitsRecent, apDdRejectedMsgTotal=apDdRejectedMsgTotal, apDdInboundConstraintsPerMax=apDdInboundConstraintsPerMax, apDdAgentMsgTypeClientRespRetransPerMax=apDdAgentMsgTypeClientRespRetransPerMax, apDdMsgTypeStatsEntry=apDdMsgTypeStatsEntry, apDdDnsServerErrorsPerMax=apDdDnsServerErrorsPerMax, apDdAgentDnsClientErrorsRecent=apDdAgentDnsClientErrorsRecent, apDDNotifications=apDDNotifications, apDdAgentMsgReturnCodeClientPerMax=apDdAgentMsgReturnCodeClientPerMax, apDdIntfErrorStatusGroup=apDdIntfErrorStatusGroup, apDdAgentServerTransCPHigh=apDdAgentServerTransCPHigh, apDdInterfaceStatusReason=apDdInterfaceStatusReason, apDdOutboundConstraintsRecent=apDdOutboundConstraintsRecent, apDdSessTimeoutPeriodTotal=apDdSessTimeoutPeriodTotal, apDdAgentDnsResponsesPerMax=apDdAgentDnsResponsesPerMax, apDdMsgReturnCodeServerRecent=apDdMsgReturnCodeServerRecent, apDdMsgTypeClientThrottledTotal=apDdMsgTypeClientThrottledTotal, apDdAgentStatsGroup=apDdAgentStatsGroup, apDdSessTerminatedLifePerMax=apDdSessTerminatedLifePerMax, apDdAgentMsgTypeStatsEntry=apDdAgentMsgTypeStatsEntry, apDdAgentMsgTypeClientReqRecent=apDdAgentMsgTypeClientReqRecent, apDdPolicyHitLifeTotal=apDdPolicyHitLifeTotal, apDdInterfaceNumber=apDdInterfaceNumber, apDdAgentClientTransLTPerMax=apDdAgentClientTransLTPerMax, apDdClientTransCPActive=apDdClientTransCPActive, apDdAgentDnsQueriesTotal=apDdAgentDnsQueriesTotal, apDdServerTransCPActive=apDdServerTransCPActive, apDdOutboundConstraintsPerMax=apDdOutboundConstraintsPerMax, apDdAgentDnsQueriesRecent=apDdAgentDnsQueriesRecent, apDdSessInitPeriodTotal=apDdSessInitPeriodTotal, apDdPolicyHitPeriodHigh=apDdPolicyHitPeriodHigh, apDdSessTimeoutLifePerMax=apDdSessTimeoutLifePerMax, apDdSessInitPeriodHigh=apDdSessInitPeriodHigh, apDdGenConnectsCPTotal=apDdGenConnectsCPTotal, apDdMsgTypeServerRetransRecent=apDdMsgTypeServerRetransRecent, apDdMsgReturnCodeClientTotal=apDdMsgReturnCodeClientTotal, apDdMsgTypeClientRetransRecent=apDdMsgTypeClientRetransRecent, apDdOutboundConstraintsTotal=apDdOutboundConstraintsTotal, apDdDnsCacheMissesRecent=apDdDnsCacheMissesRecent, apDdNoRouteFoundPerMax=apDdNoRouteFoundPerMax, apDdMsgTypeServerRetransPerMax=apDdMsgTypeServerRetransPerMax, apDdUnsubscribeLifeHigh=apDdUnsubscribeLifeHigh, apDdMsgTypeStatsGroup=apDdMsgTypeStatsGroup, apDdDnsClientErrorsRecent=apDdDnsClientErrorsRecent, apDdSessEstablishedPeriodTotal=apDdSessEstablishedPeriodTotal, apDdInterfaceStatsEntry=apDdInterfaceStatsEntry, apDdMsgTypeClientTimeoutPerMax=apDdMsgTypeClientTimeoutPerMax, apDdAgentDnsResponsesTotal=apDdAgentDnsResponsesTotal, apDdPolicyHitLifeHigh=apDdPolicyHitLifeHigh, apDdGenConnectsCPHigh=apDdGenConnectsCPHigh, apDdAgentMsgReturnCodeServerPerMax=apDdAgentMsgReturnCodeServerPerMax, apDdUnsubscribePeriodTotal=apDdUnsubscribePeriodTotal, apDdAgentMsgTypeClientTimeoutTotal=apDdAgentMsgTypeClientTimeoutTotal, apDdAgentMsgTypeStatsTable=apDdAgentMsgTypeStatsTable, apDdAgentMsgReturnCodeClientTotal=apDdAgentMsgReturnCodeClientTotal, apDdSubscriberPeriodActive=apDdSubscriberPeriodActive, apDdAgentOutboundConstraintsTotal=apDdAgentOutboundConstraintsTotal, apDdAgentMsgTypeStatsGroup=apDdAgentMsgTypeStatsGroup, apDdMsgTypeIndex=apDdMsgTypeIndex, apDdDnsServerErrorsTotal=apDdDnsServerErrorsTotal, apDdSubscriberLifeHigh=apDdSubscriberLifeHigh, apDdAgentServerTransLTHigh=apDdAgentServerTransLTHigh, apDdAgentMsgTypeClientTimeoutRecent=apDdAgentMsgTypeClientTimeoutRecent, apDdAgentMsgTypeServerRespRetransTotal=apDdAgentMsgTypeServerRespRetransTotal, apDdDnsCacheMissesPerMax=apDdDnsCacheMissesPerMax, apDdGenSocketsLTHigh=apDdGenSocketsLTHigh, apDdGenConnectsLTHigh=apDdGenConnectsLTHigh, apDdGenConnectsLTTotal=apDdGenConnectsLTTotal, apDdAgentIndex=apDdAgentIndex, apDdMsgTypeServerReqRecent=apDdMsgTypeServerReqRecent, apDdAgentNumber=apDdAgentNumber, apDdAgentClientTransCPHigh=apDdAgentClientTransCPHigh)
mibBuilder.exportSymbols("APDD-MIB", apDdSubscriberMissLifePerMax=apDdSubscriberMissLifePerMax, apDdErrorStatusGroup=apDdErrorStatusGroup, apDdAgentOutboundConstraintsPerMax=apDdAgentOutboundConstraintsPerMax, apDdDnsStatsEntryGroup=apDdDnsStatsEntryGroup, apDdAgentMsgTypeClientThrottledRecent=apDdAgentMsgTypeClientThrottledRecent, apDdDnsQueriesTotal=apDdDnsQueriesTotal, apDdSubscribeLifeHigh=apDdSubscribeLifeHigh, apDdAgentDnsStatsEntryGroup=apDdAgentDnsStatsEntryGroup, apDdAgentMsgTypeAverageLatency=apDdAgentMsgTypeAverageLatency, apDdSCTPIsPrimaryPath=apDdSCTPIsPrimaryPath, apDdSubscriberPeriodTotal=apDdSubscriberPeriodTotal, apDdAgentDnsServerErrorsPerMax=apDdAgentDnsServerErrorsPerMax, apDdAgentMsgStatsReturnCodeEntry=apDdAgentMsgStatsReturnCodeEntry, apDdInboundConstraintsTotal=apDdInboundConstraintsTotal, apDdAgentMsgTypeClientReqPerMax=apDdAgentMsgTypeClientReqPerMax, apDdSCTPPathFailureTrap=apDdSCTPPathFailureTrap, apDdPolicyMissLifeTotal=apDdPolicyMissLifeTotal, apDdServerTransLTPerMax=apDdServerTransLTPerMax, apDdAgentMsgTypeClientReqTotal=apDdAgentMsgTypeClientReqTotal, apDdAgentDnsQueriesPerMax=apDdAgentDnsQueriesPerMax, apDdAgentRejectedMsgTotal=apDdAgentRejectedMsgTotal, apDdAgentDnsClientErrorsPerMax=apDdAgentDnsClientErrorsPerMax, apDdAgentDroppedMsgTotal=apDdAgentDroppedMsgTotal, apDdSubscriberPeriodHigh=apDdSubscriberPeriodHigh, apDdAgentMsgTypeClientRespRetransTotal=apDdAgentMsgTypeClientRespRetransTotal, apDdSessionLifePerMax=apDdSessionLifePerMax, apDdDnsServerErrorsRecent=apDdDnsServerErrorsRecent, apDdRejectedMsgRecent=apDdRejectedMsgRecent, apDdAgentClientTransCPActive=apDdAgentClientTransCPActive, apDdAgentErrorStatusGroup=apDdAgentErrorStatusGroup, apDdInterfaceStatsTable=apDdInterfaceStatsTable, apDdAgentDnsServerErrorsRecent=apDdAgentDnsServerErrorsRecent, apDdClientTransLTPerMax=apDdClientTransLTPerMax, apDdSessInitLifeHigh=apDdSessInitLifeHigh, apDdSessInitLifeTotal=apDdSessInitLifeTotal, apDdDnsStatsTable=apDdDnsStatsTable, apDdMsgTypeServerReqPerMax=apDdMsgTypeServerReqPerMax, apDdAgentGenSocketsCPHigh=apDdAgentGenSocketsCPHigh, apDdSessTerminatedPeriodHigh=apDdSessTerminatedPeriodHigh, apDdAgentMsgTypeClientTimeoutPerMax=apDdAgentMsgTypeClientTimeoutPerMax, apDdAgentMsgReturnCodeServerRecent=apDdAgentMsgReturnCodeServerRecent, apDdErrorStatusEntry=apDdErrorStatusEntry, apDdMsgTypeMaximumLatency=apDdMsgTypeMaximumLatency, apDdMsgReturnCodeClientPerMax=apDdMsgReturnCodeClientPerMax, apDdAgentMsgTypeMaximumLatency=apDdAgentMsgTypeMaximumLatency, apDDMIBObjects=apDDMIBObjects, apDdSessTerminatedLifeTotal=apDdSessTerminatedLifeTotal, apDdSubscribePeriodActive=apDdSubscribePeriodActive, apDdSubscriberLifeTotal=apDdSubscriberLifeTotal, apDdDnsClientErrorsPerMax=apDdDnsClientErrorsPerMax, apDdMsgTypeLatencyWindow=apDdMsgTypeLatencyWindow, apDdSCTPAssociationID=apDdSCTPAssociationID, apDDMIBGeneralObjects=apDDMIBGeneralObjects, apDdRejectedMsgPerMax=apDdRejectedMsgPerMax, apDdPolicyHitPeriodTotal=apDdPolicyHitPeriodTotal, apDdTransportType=apDdTransportType, apDdGenSocketsCPTotal=apDdGenSocketsCPTotal, apDdAgentMsgTypeServerReqPerMax=apDdAgentMsgTypeServerReqPerMax, apDdSessionPeriodTotal=apDdSessionPeriodTotal, apDdConnectionFailureTrap=apDdConnectionFailureTrap, apDdSessTerminatedPeriodActive=apDdSessTerminatedPeriodActive, apDdMsgTypeServerReqTotal=apDdMsgTypeServerReqTotal, apDdDnsResponsesPerMax=apDdDnsResponsesPerMax, apDdAgentMsgStatsReturnCodeTable=apDdAgentMsgStatsReturnCodeTable, apDdSessionPeriodActive=apDdSessionPeriodActive, apDdInterfaceIndex=apDdInterfaceIndex, apDdPolicyMissLifeHigh=apDdPolicyMissLifeHigh, apDdMalformedMsgRecent=apDdMalformedMsgRecent, apDdSessMissLifePerMax=apDdSessMissLifePerMax, apDdPolicyMissLifePerMax=apDdPolicyMissLifePerMax, apDdDnsStatsEntry=apDdDnsStatsEntry, apDdMsgReturnCodeInfoTable=apDdMsgReturnCodeInfoTable, apDdSubscribePeriodTotal=apDdSubscribePeriodTotal, apDdAgentGenConnectsLTTotal=apDdAgentGenConnectsLTTotal, apDdGeneralGroup=apDdGeneralGroup, apDdMsgTypeServerRespRetransTotal=apDdMsgTypeServerRespRetransTotal, apDdAgentMsgTypeClientRetransPerMax=apDdAgentMsgTypeClientRetransPerMax, apDdAgentDnsStatsTable=apDdAgentDnsStatsTable, apDdMsgTypeServerRetransTotal=apDdMsgTypeServerRetransTotal, apDdSubscribePeriodHigh=apDdSubscribePeriodHigh, apDdAgentClientTransLTHigh=apDdAgentClientTransLTHigh)
