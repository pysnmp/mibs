...
mibBuilder.exportSymbols("APDD-MIB", apDdAgentErrorStatusGroup=apDdAgentErrorStatusGroup, apDdMsgTypeClientTimeoutRecent=apDdMsgTypeClientTimeoutRecent, apDdDroppedMsgTotal=apDdDroppedMsgTotal, apDdAgentNumber=apDdAgentNumber, apDdGeneralGroup=apDdGeneralGroup, apDdDnsResponsesRecent=apDdDnsResponsesRecent, apDdMsgTypeClientRespRetransPerMax=apDdMsgTypeClientRespRetransPerMax, apDdSessTerminatedLifeHigh=apDdSessTerminatedLifeHigh, apDdInboundConstraintsPerMax=apDdInboundConstraintsPerMax, apDdServerTransLTPerMax=apDdServerTransLTPerMax, apDdAgentDnsResponsesPerMax=apDdAgentDnsResponsesPerMax, apDdPolicyHitLifeHigh=apDdPolicyHitLifeHigh, apDdTransportType=apDdTransportType, apDdMsgTypeServerRetransPerMax=apDdMsgTypeServerRetransPerMax, apDdServerTransCPActive=apDdServerTransCPActive, apDdDnsCacheHitsTotal=apDdDnsCacheHitsTotal, apDdDnsCacheMissesRecent=apDdDnsCacheMissesRecent, apDdMsgTypeInfoTable=apDdMsgTypeInfoTable, apDdMsgStatsReturnCodeTable=apDdMsgStatsReturnCodeTable, apDdAgentGenConnectsCPTotal=apDdAgentGenConnectsCPTotal, apDdDiameterIPPort=apDdDiameterIPPort, apDdPolicyMissPeriodActive=apDdPolicyMissPeriodActive, apDdAgentNoRouteFoundPerMax=apDdAgentNoRouteFoundPerMax, apDdDnsServerErrorsTotal=apDdDnsServerErrorsTotal, apDdAgentMsgReturnCodeServerRecent=apDdAgentMsgReturnCodeServerRecent, apDdGenSocketsCPActive=apDdGenSocketsCPActive, apDdAgentOutboundConstraintsRecent=apDdAgentOutboundConstraintsRecent, apDdDnsCacheMissesPerMax=apDdDnsCacheMissesPerMax, apDdDnsStatsTable=apDdDnsStatsTable, apDdAgentDnsClientErrorsRecent=apDdAgentDnsClientErrorsRecent, apDdAgentGeneralGroup=apDdAgentGeneralGroup, apDdDnsResponsesPerMax=apDdDnsResponsesPerMax, apDdAgentClientTransCPActive=apDdAgentClientTransCPActive, apDdAgentDnsQueriesPerMax=apDdAgentDnsQueriesPerMax, apDdMsgTypeAverageLatency=apDdMsgTypeAverageLatency, apDdAgentServerTransLTPerMax=apDdAgentServerTransLTPerMax, apDdAgentMsgTypeLatencyWindow=apDdAgentMsgTypeLatencyWindow, apDdMsgReturnCodeName=apDdMsgReturnCodeName, apDdAgentMsgTypeMaximumLatency=apDdAgentMsgTypeMaximumLatency, apDdDnsQueriesTotal=apDdDnsQueriesTotal, apDdIntfErrorStatusGroup=apDdIntfErrorStatusGroup, apDdSessTerminatedPeriodHigh=apDdSessTerminatedPeriodHigh, apDdAgentMsgTypeServerRespRetransPerMax=apDdAgentMsgTypeServerRespRetransPerMax, apDdServerTransCPTotal=apDdServerTransCPTotal, apDdSessErrorsLifeTotal=apDdSessErrorsLifeTotal, apDDNotifObjectsGroup=apDDNotifObjectsGroup, apDdGenSocketsLTTotal=apDdGenSocketsLTTotal, apDdSessionPeriodActive=apDdSessionPeriodActive, apDdAgentNoRouteFoundTotal=apDdAgentNoRouteFoundTotal, apDdSCTPPathFailureTrap=apDdSCTPPathFailureTrap, apDdPolicyMissLifePerMax=apDdPolicyMissLifePerMax, apDdSubscribePeriodHigh=apDdSubscribePeriodHigh, apDDObjectGroups=apDDObjectGroups, apDdAgentMsgTypeServerReqPerMax=apDdAgentMsgTypeServerReqPerMax, apDdAgentDroppedMsgPerMax=apDdAgentDroppedMsgPerMax, apDdDnsCacheHitsRecent=apDdDnsCacheHitsRecent, apDdMsgTypeClientRetransRecent=apDdMsgTypeClientRetransRecent, apDdUnsubscribePeriodTotal=apDdUnsubscribePeriodTotal, apDdMsgTypeClientRespRetransTotal=apDdMsgTypeClientRespRetransTotal, apDDMIBTabularObjects=apDDMIBTabularObjects, apDdAgentMsgTypeClientThrottledRecent=apDdAgentMsgTypeClientThrottledRecent, apDdAgentGenSocketsCPHigh=apDdAgentGenSocketsCPHigh, apDdPolicyMissLifeTotal=apDdPolicyMissLifeTotal, apDdAgentClientTransCPTotal=apDdAgentClientTransCPTotal, apDdSCTPAssociationID=apDdSCTPAssociationID, apDdCurrentTransRate=apDdCurrentTransRate, apDdSessEstablishedPeriodHigh=apDdSessEstablishedPeriodHigh, apDdAgentGenConnectsLTHigh=apDdAgentGenConnectsLTHigh, apDdRejectedMsgTotal=apDdRejectedMsgTotal, apDdMsgTypeServerRetransTotal=apDdMsgTypeServerRetransTotal, apDdAgentDnsCacheMissesTotal=apDdAgentDnsCacheMissesTotal, apDdSessInitPeriodActive=apDdSessInitPeriodActive, apDdInterfaceStatsEntry=apDdInterfaceStatsEntry, apDdServerTransLTTotal=apDdServerTransLTTotal, apDdMsgTypeIndex=apDdMsgTypeIndex, apDdAgentClientTransLTHigh=apDdAgentClientTransLTHigh, apDdInterfaceStatusReason=apDdInterfaceStatusReason, apDdMsgTypeServerRespRetransTotal=apDdMsgTypeServerRespRetransTotal, apDdClientTransLTHigh=apDdClientTransLTHigh, apDdMsgTypeClientThrottledTotal=apDdMsgTypeClientThrottledTotal, apDdMalformedMsgTotal=apDdMalformedMsgTotal, apDdMsgTypeClientThrottledPerMax=apDdMsgTypeClientThrottledPerMax, apDdRejectedMsgRecent=apDdRejectedMsgRecent, apDdAgentMsgTypeAverageLatency=apDdAgentMsgTypeAverageLatency, apDdAgentDroppedMsgRecent=apDdAgentDroppedMsgRecent, apDdAgentMsgTypeServerRetransRecent=apDdAgentMsgTypeServerRetransRecent, apDdGenConnectsCPActive=apDdGenConnectsCPActive, apDdServerTransLTHigh=apDdServerTransLTHigh, apDdMsgTypeClientReqPerMax=apDdMsgTypeClientReqPerMax, apDdAgentMsgTypeServerRetransPerMax=apDdAgentMsgTypeServerRetransPerMax, apDdPolicyMissLifeHigh=apDdPolicyMissLifeHigh, apDdDnsStatsEntry=apDdDnsStatsEntry, apDdAgentMsgTypeClientRespRetransPerMax=apDdAgentMsgTypeClientRespRetransPerMax, apDdDnsCacheHitsPerMax=apDdDnsCacheHitsPerMax, apDdAgentMsgReturnCodeClientPerMax=apDdAgentMsgReturnCodeClientPerMax, apDdGenConnectsLTPerMax=apDdGenConnectsLTPerMax, apDdNoRouteFoundTotal=apDdNoRouteFoundTotal, apDdMsgTypeClientReqTotal=apDdMsgTypeClientReqTotal, apDdInterfaceStatsTable=apDdInterfaceStatsTable, apDdPolicyHitPeriodActive=apDdPolicyHitPeriodActive, apDdSubscribeLifePerMax=apDdSubscribeLifePerMax, apDdMalformedMsgRecent=apDdMalformedMsgRecent, apDdMsgReturnCodeIndex=apDdMsgReturnCodeIndex, apDdMsgTypeServerRespRetransPerMax=apDdMsgTypeServerRespRetransPerMax, apDdSessTerminatedLifeTotal=apDdSessTerminatedLifeTotal, apDdAgentInboundConstraintsPerMax=apDdAgentInboundConstraintsPerMax, apDdAgentMsgTypeServerReqTotal=apDdAgentMsgTypeServerReqTotal, apDdAgentMsgTypeClientThrottledPerMax=apDdAgentMsgTypeClientThrottledPerMax, apDdMsgTypeServerReqTotal=apDdMsgTypeServerReqTotal, apDdSessTerminatedPeriodActive=apDdSessTerminatedPeriodActive, apDdAgentMalformedMsgTotal=apDdAgentMalformedMsgTotal, apDdAgentGenSocketsCPTotal=apDdAgentGenSocketsCPTotal, apDDNotifPrefix=apDDNotifPrefix, apDdAgentDnsStatsEntry=apDdAgentDnsStatsEntry, apDdMsgTypeMsgName=apDdMsgTypeMsgName, apDdAgentMsgTypeClientTimeoutTotal=apDdAgentMsgTypeClientTimeoutTotal, apDdSessTerminatedPeriodTotal=apDdSessTerminatedPeriodTotal, apDdNoRouteFoundPerMax=apDdNoRouteFoundPerMax, apDdAgentMsgTypeClientRetransRecent=apDdAgentMsgTypeClientRetransRecent, apDdMsgTypeClientTimeoutTotal=apDdMsgTypeClientTimeoutTotal, apDdSubscriberMissPeriodTotal=apDdSubscriberMissPeriodTotal, apDdSubscribePeriodActive=apDdSubscribePeriodActive, apDdClientTransCPTotal=apDdClientTransCPTotal, apDdAgentStatsTable=apDdAgentStatsTable, apDdAgentDnsResponsesTotal=apDdAgentDnsResponsesTotal, apDdMsgReturnCodeServerPerMax=apDdMsgReturnCodeServerPerMax, apDdMsgReturnCodeInfoTable=apDdMsgReturnCodeInfoTable, apDdSubscribeLifeTotal=apDdSubscribeLifeTotal, apDdAgentIndex=apDdAgentIndex, apDdOutboundConstraintsPerMax=apDdOutboundConstraintsPerMax, apDdAgentMsgTypeClientTimeoutPerMax=apDdAgentMsgTypeClientTimeoutPerMax, apDdAgentMsgStatsReturnCodeGroup=apDdAgentMsgStatsReturnCodeGroup, apDdSessEstablishedLifePerMax=apDdSessEstablishedLifePerMax, apDdPolicyMissPeriodTotal=apDdPolicyMissPeriodTotal, apDdOutboundConstraintsTotal=apDdOutboundConstraintsTotal, apDdAgentOutboundConstraintsPerMax=apDdAgentOutboundConstraintsPerMax, apDdGenConnectsLTTotal=apDdGenConnectsLTTotal, apDDMIBGeneralObjects=apDDMIBGeneralObjects, apDdMsgTypeClientRespRetransRecent=apDdMsgTypeClientRespRetransRecent, apDdAgentMsgTypeClientRespRetransRecent=apDdAgentMsgTypeClientRespRetransRecent, apDdAgentDnsCacheHitsRecent=apDdAgentDnsCacheHitsRecent, apDdAgentDnsCacheHitsPerMax=apDdAgentDnsCacheHitsPerMax, apDdDnsCacheMissesTotal=apDdDnsCacheMissesTotal, apDdErrorStatusTable=apDdErrorStatusTable, apDdAgentGenConnectsLTTotal=apDdAgentGenConnectsLTTotal, apDdAgentMsgTypeClientReqRecent=apDdAgentMsgTypeClientReqRecent, apDdUnsubscribePeriodActive=apDdUnsubscribePeriodActive, apDdUnsubscribeLifeTotal=apDdUnsubscribeLifeTotal, apDdDnsQueriesRecent=apDdDnsQueriesRecent, apDDModule=apDDModule, apDdSessEstablishedPeriodTotal=apDdSessEstablishedPeriodTotal, apDdGenConnectsCPHigh=apDdGenConnectsCPHigh, apDDMIBObjects=apDDMIBObjects, apDdAgentDnsServerErrorsRecent=apDdAgentDnsServerErrorsRecent, apDdGenSocketsCPTotal=apDdGenSocketsCPTotal, apDdSessMissPeriodTotal=apDdSessMissPeriodTotal, apDdAgentGenSocketsCPActive=apDdAgentGenSocketsCPActive, apDdAgentServerTransCPHigh=apDdAgentServerTransCPHigh, apDdSubscribePeriodTotal=apDdSubscribePeriodTotal, apDdPolicyHitLifeTotal=apDdPolicyHitLifeTotal, apDdMsgTypeMaximumLatency=apDdMsgTypeMaximumLatency, apDdAgentDnsServerErrorsTotal=apDdAgentDnsServerErrorsTotal, apDDConformance=apDDConformance, apDdAgentClientTransCPHigh=apDdAgentClientTransCPHigh, apDdConnectionFailureClearTrap=apDdConnectionFailureClearTrap, apDdMsgTypeClientReqRecent=apDdMsgTypeClientReqRecent, apDdSessTimeoutLifePerMax=apDdSessTimeoutLifePerMax, apDdMsgTypeServerReqPerMax=apDdMsgTypeServerReqPerMax, apDdAgentServerTransCPActive=apDdAgentServerTransCPActive, apDdMsgTypeServerRetransRecent=apDdMsgTypeServerRetransRecent, apDdGenSocketsLTPerMax=apDdGenSocketsLTPerMax, apDdNoRouteFoundRecent=apDdNoRouteFoundRecent, apDdAgentErrorStatusEntry=apDdAgentErrorStatusEntry, apDdSubscriberMissLifePerMax=apDdSubscriberMissLifePerMax, apDdAgentMsgTypeStatsEntry=apDdAgentMsgTypeStatsEntry, apDdAgentDnsClientErrorsTotal=apDdAgentDnsClientErrorsTotal, PYSNMP_MODULE_ID=apDDModule, ApDdStatusOptions=ApDdStatusOptions, apDdAgentRejectedMsgRecent=apDdAgentRejectedMsgRecent, apDDNotificationGroups=apDDNotificationGroups, apDdSessInitLifeTotal=apDdSessInitLifeTotal, apDdSessMissLifePerMax=apDdSessMissLifePerMax, apDdDnsClientErrorsPerMax=apDdDnsClientErrorsPerMax, apDdSessEstablishedLifeHigh=apDdSessEstablishedLifeHigh, apDdMsgReturnCodeClientRecent=apDdMsgReturnCodeClientRecent, apDdSessInitPeriodTotal=apDdSessInitPeriodTotal, apDdSubscriberMissLifeTotal=apDdSubscriberMissLifeTotal, apDdLowTransRate=apDdLowTransRate, apDdAgentStatsGroup=apDdAgentStatsGroup, apDdAgentMsgReturnCodeServerPerMax=apDdAgentMsgReturnCodeServerPerMax, apDDNotifObjects=apDDNotifObjects, apDdPolicyHitPeriodTotal=apDdPolicyHitPeriodTotal, apDdClientTransCPHigh=apDdClientTransCPHigh, apDdServerTransCPHigh=apDdServerTransCPHigh, apDdSessInitPeriodHigh=apDdSessInitPeriodHigh, apDdAgentDnsCacheHitsTotal=apDdAgentDnsCacheHitsTotal, apDdAgentMsgTypeServerReqRecent=apDdAgentMsgTypeServerReqRecent, apDdSessTimeoutPeriodTotal=apDdSessTimeoutPeriodTotal, apDdMsgTypeLatencyWindow=apDdMsgTypeLatencyWindow, apDdAgentMsgTypeServerRespRetransTotal=apDdAgentMsgTypeServerRespRetransTotal, apDdSessErrorsLifePerMax=apDdSessErrorsLifePerMax, apDdMsgTypeClientThrottledRecent=apDdMsgTypeClientThrottledRecent, apDdSubscriberLifeHigh=apDdSubscriberLifeHigh, apDdDnsQueriesPerMax=apDdDnsQueriesPerMax, apDdSessEstablishedPeriodActive=apDdSessEstablishedPeriodActive, apDdDroppedMsgPerMax=apDdDroppedMsgPerMax, apDdAgentMsgTypeClientReqPerMax=apDdAgentMsgTypeClientReqPerMax, apDdGenSocketsCPHigh=apDdGenSocketsCPHigh, apDdAgentMalformedMsgRecent=apDdAgentMalformedMsgRecent, apDdSessTimeoutLifeTotal=apDdSessTimeoutLifeTotal, apDdUnsubscribeLifeHigh=apDdUnsubscribeLifeHigh, apDdAgentMsgTypeServerRespRetransRecent=apDdAgentMsgTypeServerRespRetransRecent, apDdDnsServerErrorsPerMax=apDdDnsServerErrorsPerMax, apDdSessionLifeHigh=apDdSessionLifeHigh, apDdAgentMsgTypeStatsTable=apDdAgentMsgTypeStatsTable, apDdSessionPeriodTotal=apDdSessionPeriodTotal, apDdAgentMsgStatsReturnCodeEntry=apDdAgentMsgStatsReturnCodeEntry, apDdUnsubscribeLifePerMax=apDdUnsubscribeLifePerMax, apDdAgentGenConnectsCPHigh=apDdAgentGenConnectsCPHigh, apDdMsgTypeServerReqRecent=apDdMsgTypeServerReqRecent, apDdAgentClientTransLTPerMax=apDdAgentClientTransLTPerMax, apDdAgentRejectedMsgTotal=apDdAgentRejectedMsgTotal, apDdSubscriberLifePerMax=apDdSubscriberLifePerMax, apDdAgentMsgTypeClientRespRetransTotal=apDdAgentMsgTypeClientRespRetransTotal, apDdRejectedMsgPerMax=apDdRejectedMsgPerMax, apDdMsgStatsReturnCodeEntry=apDdMsgStatsReturnCodeEntry, apDdMsgTypeClientTimeoutPerMax=apDdMsgTypeClientTimeoutPerMax, apDdOutboundConstraintsRecent=apDdOutboundConstraintsRecent, apDdMsgTypeStatsGroup=apDdMsgTypeStatsGroup, apDdGenConnectsLTHigh=apDdGenConnectsLTHigh, apDDNotifications=apDDNotifications, apDdErrorStatusEntry=apDdErrorStatusEntry, apDdSCTPIsPrimaryPath=apDdSCTPIsPrimaryPath, apDdSubscriberPeriodTotal=apDdSubscriberPeriodTotal, apDdAgentDnsClientErrorsPerMax=apDdAgentDnsClientErrorsPerMax, apDdAgentDnsStatsEntryGroup=apDdAgentDnsStatsEntryGroup, apDdAgentClientTransLTTotal=apDdAgentClientTransLTTotal, apDdMsgTypeClientRetransPerMax=apDdMsgTypeClientRetransPerMax, apDdAgentMsgTypeStatsGroup=apDdAgentMsgTypeStatsGroup, apDdAgentOutboundConstraintsTotal=apDdAgentOutboundConstraintsTotal, apDDNotificationsGroup=apDDNotificationsGroup, apDdInboundConstraintsTotal=apDdInboundConstraintsTotal, apDdHighTransRate=apDdHighTransRate, apDdMsgReturnCodeServerRecent=apDdMsgReturnCodeServerRecent, apDdAgentInboundConstraintsRecent=apDdAgentInboundConstraintsRecent, apDdMsgReturnCodeClientPerMax=apDdMsgReturnCodeClientPerMax, apDdMsgStatsReturnCodeGroup=apDdMsgStatsReturnCodeGroup, apDdUnsubscribePeriodHigh=apDdUnsubscribePeriodHigh, apDdAgentMsgTypeClientTimeoutRecent=apDdAgentMsgTypeClientTimeoutRecent, apDdSessEstablishedLifeTotal=apDdSessEstablishedLifeTotal, apDdClientTransLTPerMax=apDdClientTransLTPerMax, apDdSessInitLifePerMax=apDdSessInitLifePerMax, apDdSubscriberPeriodActive=apDdSubscriberPeriodActive, apDdAgentMsgTypeClientRetransTotal=apDdAgentMsgTypeClientRetransTotal)
mibBuilder.exportSymbols("APDD-MIB", apDdInterfaceStatsGroup=apDdInterfaceStatsGroup, apDdAgentGenSocketsLTPerMax=apDdAgentGenSocketsLTPerMax, apDdDiameterAgentHostName=apDdDiameterAgentHostName, apDDSCTPNotificationsGroup=apDDSCTPNotificationsGroup, apDdAgentMsgReturnCodeClientRecent=apDdAgentMsgReturnCodeClientRecent, apDdInboundConstraintsRecent=apDdInboundConstraintsRecent, apDDSCTPNotifObjectsGroup=apDDSCTPNotifObjectsGroup, apDdSessErrorsPeriodTotal=apDdSessErrorsPeriodTotal, apDdMsgReturnCodeClientTotal=apDdMsgReturnCodeClientTotal, apDdDnsServerErrorsRecent=apDdDnsServerErrorsRecent, apDdErrorStatusGroup=apDdErrorStatusGroup, apDdAgentErrorStatusTable=apDdAgentErrorStatusTable, apDdSessionLifePerMax=apDdSessionLifePerMax, apDdSessMissLifeTotal=apDdSessMissLifeTotal, apDdPolicyHitLifePerMax=apDdPolicyHitLifePerMax, apDdAgentRealmName=apDdAgentRealmName, apDdSubscribeLifeHigh=apDdSubscribeLifeHigh, apDdAgentMsgStatsReturnCodeTable=apDdAgentMsgStatsReturnCodeTable, apDdMsgTypeStatsEntry=apDdMsgTypeStatsEntry, apDdAgentServerTransLTHigh=apDdAgentServerTransLTHigh, apDdSessTerminatedLifePerMax=apDdSessTerminatedLifePerMax, apDdDiameterAgentOriginRealmName=apDdDiameterAgentOriginRealmName, apDdAgentInboundConstraintsTotal=apDdAgentInboundConstraintsTotal, apDdAgentGenConnectsCPActive=apDdAgentGenConnectsCPActive, apDdClientTransLTTotal=apDdClientTransLTTotal, apDdAgentDnsCacheMissesRecent=apDdAgentDnsCacheMissesRecent, apDdMsgTypeServerRespRetransRecent=apDdMsgTypeServerRespRetransRecent, apDdAgentMalformedMsgPerMax=apDdAgentMalformedMsgPerMax, apDdAgentStatsEntry=apDdAgentStatsEntry, apDdSubscriberLifeTotal=apDdSubscriberLifeTotal, apDdAgentDnsQueriesRecent=apDdAgentDnsQueriesRecent, apDdDroppedMsgRecent=apDdDroppedMsgRecent, apDdMsgReturnCodeServerTotal=apDdMsgReturnCodeServerTotal, apDdSubscriberPeriodHigh=apDdSubscriberPeriodHigh, apDdGenConnectsCPTotal=apDdGenConnectsCPTotal, apDdAgentDroppedMsgTotal=apDdAgentDroppedMsgTotal, apDdAgentDnsResponsesRecent=apDdAgentDnsResponsesRecent, apDdAgentMsgTypeClientReqTotal=apDdAgentMsgTypeClientReqTotal, apDdMsgTypeStatsTable=apDdMsgTypeStatsTable, apDdAgentMsgTypeClientRetransPerMax=apDdAgentMsgTypeClientRetransPerMax, apDdAgentMsgReturnCodeClientTotal=apDdAgentMsgReturnCodeClientTotal, apDdMalformedMsgPerMax=apDdMalformedMsgPerMax, apDdSessInitLifeHigh=apDdSessInitLifeHigh, apDdInterfaceRealmName=apDdInterfaceRealmName, apDdMsgTypeClientRetransTotal=apDdMsgTypeClientRetransTotal, apDdAgentServerTransLTTotal=apDdAgentServerTransLTTotal, apDdAgentStatus=apDdAgentStatus, apDdAgentGenConnectsLTPerMax=apDdAgentGenConnectsLTPerMax, apDDNotificationObjects=apDDNotificationObjects, apDdAgentDnsServerErrorsPerMax=apDdAgentDnsServerErrorsPerMax, apDdAgentMsgReturnCodeServerTotal=apDdAgentMsgReturnCodeServerTotal, apDdAgentGenSocketsLTHigh=apDdAgentGenSocketsLTHigh, apDdAgentRejectedMsgPerMax=apDdAgentRejectedMsgPerMax, apDdClientTransCPActive=apDdClientTransCPActive, apDdAgentDnsStatsTable=apDdAgentDnsStatsTable, apDdGenSocketsLTHigh=apDdGenSocketsLTHigh, apDdAgentDnsQueriesTotal=apDdAgentDnsQueriesTotal, apDdPolicyMissPeriodHigh=apDdPolicyMissPeriodHigh, apDdAgentNoRouteFoundRecent=apDdAgentNoRouteFoundRecent, apDdSCTPPathFailureClearTrap=apDdSCTPPathFailureClearTrap, apDdAgentDnsCacheMissesPerMax=apDdAgentDnsCacheMissesPerMax, apDdInterfaceStatus=apDdInterfaceStatus, apDdAgentGenSocketsLTTotal=apDdAgentGenSocketsLTTotal, apDdSessionLifeTotal=apDdSessionLifeTotal, apDdDnsResponsesTotal=apDdDnsResponsesTotal, apDdMsgReturnCodeInfoEntry=apDdMsgReturnCodeInfoEntry, apDdSessionSubscriberGeneralGroup=apDdSessionSubscriberGeneralGroup, apDdConnectionFailureTrap=apDdConnectionFailureTrap, apDdAgentMsgTypeServerRetransTotal=apDdAgentMsgTypeServerRetransTotal, apDdInterfaceIndex=apDdInterfaceIndex, apDdDnsClientErrorsTotal=apDdDnsClientErrorsTotal, apDdInterfaceNumber=apDdInterfaceNumber, apDdMsgTypeInfoEntry=apDdMsgTypeInfoEntry, apDdDiameterAgentOriginHostName=apDdDiameterAgentOriginHostName, apDdDnsClientErrorsRecent=apDdDnsClientErrorsRecent, apDdAgentServerTransCPTotal=apDdAgentServerTransCPTotal, apDdSessionPeriodHigh=apDdSessionPeriodHigh, apDdPolicyHitPeriodHigh=apDdPolicyHitPeriodHigh, apDdDiameterRemoteIPPort=apDdDiameterRemoteIPPort, apDdDnsStatsEntryGroup=apDdDnsStatsEntryGroup, apDdAgentMsgTypeClientThrottledTotal=apDdAgentMsgTypeClientThrottledTotal)
