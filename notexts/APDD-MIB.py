...
mibBuilder.exportSymbols("APDD-MIB", apDdServerTransCPTotal=apDdServerTransCPTotal, apDdAgentDnsResponsesPerMax=apDdAgentDnsResponsesPerMax, apDdAgentDnsStatsEntry=apDdAgentDnsStatsEntry, apDdSessInitPeriodHigh=apDdSessInitPeriodHigh, apDdClientTransLTTotal=apDdClientTransLTTotal, apDdUnsubscribePeriodTotal=apDdUnsubscribePeriodTotal, apDdPolicyMissLifeHigh=apDdPolicyMissLifeHigh, apDdAgentMsgTypeServerReqTotal=apDdAgentMsgTypeServerReqTotal, apDdAgentServerTransLTTotal=apDdAgentServerTransLTTotal, apDdDnsServerErrorsPerMax=apDdDnsServerErrorsPerMax, apDdAgentMalformedMsgTotal=apDdAgentMalformedMsgTotal, apDdAgentNoRouteFoundPerMax=apDdAgentNoRouteFoundPerMax, apDdMsgTypeServerRespRetransPerMax=apDdMsgTypeServerRespRetransPerMax, apDdAgentNumber=apDdAgentNumber, apDdAgentMsgStatsReturnCodeEntry=apDdAgentMsgStatsReturnCodeEntry, apDdAgentNoRouteFoundTotal=apDdAgentNoRouteFoundTotal, apDdInboundConstraintsTotal=apDdInboundConstraintsTotal, apDdMsgTypeMaximumLatency=apDdMsgTypeMaximumLatency, apDdSubscribeLifeHigh=apDdSubscribeLifeHigh, apDdUnsubscribePeriodActive=apDdUnsubscribePeriodActive, apDdDnsServerErrorsTotal=apDdDnsServerErrorsTotal, apDdAgentErrorStatusGroup=apDdAgentErrorStatusGroup, apDdDnsClientErrorsPerMax=apDdDnsClientErrorsPerMax, apDdLowTransRate=apDdLowTransRate, apDdAgentInboundConstraintsTotal=apDdAgentInboundConstraintsTotal, apDdMsgTypeMsgName=apDdMsgTypeMsgName, apDdSubscriberMissLifeTotal=apDdSubscriberMissLifeTotal, apDDNotifObjects=apDDNotifObjects, apDdSessInitPeriodActive=apDdSessInitPeriodActive, apDdInboundConstraintsPerMax=apDdInboundConstraintsPerMax, apDdAgentMsgTypeClientThrottledPerMax=apDdAgentMsgTypeClientThrottledPerMax, apDdUnsubscribePeriodHigh=apDdUnsubscribePeriodHigh, apDdSessTimeoutLifePerMax=apDdSessTimeoutLifePerMax, apDdSessTerminatedLifeTotal=apDdSessTerminatedLifeTotal, apDdAgentMsgTypeClientRetransRecent=apDdAgentMsgTypeClientRetransRecent, apDdAgentMsgTypeServerReqPerMax=apDdAgentMsgTypeServerReqPerMax, apDdMsgReturnCodeClientPerMax=apDdMsgReturnCodeClientPerMax, apDdTransportType=apDdTransportType, apDdAgentMsgTypeClientThrottledTotal=apDdAgentMsgTypeClientThrottledTotal, apDdAgentMsgTypeServerRespRetransTotal=apDdAgentMsgTypeServerRespRetransTotal, apDdRejectedMsgRecent=apDdRejectedMsgRecent, apDdAgentMsgReturnCodeClientRecent=apDdAgentMsgReturnCodeClientRecent, apDdClientTransCPActive=apDdClientTransCPActive, apDdSessTerminatedPeriodHigh=apDdSessTerminatedPeriodHigh, apDdAgentClientTransCPActive=apDdAgentClientTransCPActive, apDdPolicyHitPeriodHigh=apDdPolicyHitPeriodHigh, apDdDiameterAgentOriginRealmName=apDdDiameterAgentOriginRealmName, apDdAgentGenConnectsLTHigh=apDdAgentGenConnectsLTHigh, apDdSubscribePeriodActive=apDdSubscribePeriodActive, apDdGenSocketsCPHigh=apDdGenSocketsCPHigh, apDdSessMissPeriodTotal=apDdSessMissPeriodTotal, apDdAgentErrorStatusTable=apDdAgentErrorStatusTable, apDdAgentGenSocketsCPHigh=apDdAgentGenSocketsCPHigh, apDdMsgTypeIndex=apDdMsgTypeIndex, apDdDnsResponsesPerMax=apDdDnsResponsesPerMax, apDdAgentMsgTypeServerRetransRecent=apDdAgentMsgTypeServerRetransRecent, apDdGenConnectsCPTotal=apDdGenConnectsCPTotal, apDdRejectedMsgPerMax=apDdRejectedMsgPerMax, apDdAgentMsgReturnCodeClientPerMax=apDdAgentMsgReturnCodeClientPerMax, apDdAgentMsgTypeStatsGroup=apDdAgentMsgTypeStatsGroup, apDdAgentMsgStatsReturnCodeGroup=apDdAgentMsgStatsReturnCodeGroup, apDdGenSocketsLTHigh=apDdGenSocketsLTHigh, apDdSubscribeLifeTotal=apDdSubscribeLifeTotal, apDdAgentServerTransCPHigh=apDdAgentServerTransCPHigh, apDdMsgTypeClientTimeoutTotal=apDdMsgTypeClientTimeoutTotal, apDdClientTransCPHigh=apDdClientTransCPHigh, apDdServerTransLTHigh=apDdServerTransLTHigh, apDdAgentMsgReturnCodeServerRecent=apDdAgentMsgReturnCodeServerRecent, apDdAgentGeneralGroup=apDdAgentGeneralGroup, apDdSessEstablishedLifeHigh=apDdSessEstablishedLifeHigh, apDdAgentDroppedMsgRecent=apDdAgentDroppedMsgRecent, apDdAgentMsgTypeClientReqRecent=apDdAgentMsgTypeClientReqRecent, apDdAgentDnsStatsTable=apDdAgentDnsStatsTable, apDdMsgTypeClientRespRetransRecent=apDdMsgTypeClientRespRetransRecent, apDdDnsCacheMissesRecent=apDdDnsCacheMissesRecent, apDdSessionPeriodTotal=apDdSessionPeriodTotal, apDdGenSocketsLTTotal=apDdGenSocketsLTTotal, apDdInterfaceStatus=apDdInterfaceStatus, apDdMsgTypeStatsTable=apDdMsgTypeStatsTable, apDdAgentMsgStatsReturnCodeTable=apDdAgentMsgStatsReturnCodeTable, apDDSCTPNotificationsGroup=apDDSCTPNotificationsGroup, apDdGenSocketsCPActive=apDdGenSocketsCPActive, apDdDnsQueriesTotal=apDdDnsQueriesTotal, apDdAgentMsgTypeClientTimeoutRecent=apDdAgentMsgTypeClientTimeoutRecent, apDdAgentGenConnectsCPTotal=apDdAgentGenConnectsCPTotal, apDdMsgTypeClientReqRecent=apDdMsgTypeClientReqRecent, apDdDiameterIPPort=apDdDiameterIPPort, apDdMsgStatsReturnCodeGroup=apDdMsgStatsReturnCodeGroup, apDdMsgTypeServerRetransTotal=apDdMsgTypeServerRetransTotal, apDdPolicyMissPeriodHigh=apDdPolicyMissPeriodHigh, apDdMsgReturnCodeServerTotal=apDdMsgReturnCodeServerTotal, apDdMsgTypeStatsEntry=apDdMsgTypeStatsEntry, apDdNoRouteFoundPerMax=apDdNoRouteFoundPerMax, apDdDroppedMsgRecent=apDdDroppedMsgRecent, apDdGenConnectsLTTotal=apDdGenConnectsLTTotal, apDdUnsubscribeLifePerMax=apDdUnsubscribeLifePerMax, apDdMsgTypeClientThrottledRecent=apDdMsgTypeClientThrottledRecent, apDDNotificationsGroup=apDDNotificationsGroup, apDdServerTransCPHigh=apDdServerTransCPHigh, apDdAgentServerTransCPTotal=apDdAgentServerTransCPTotal, apDdAgentMsgTypeServerRetransPerMax=apDdAgentMsgTypeServerRetransPerMax, apDDNotifications=apDDNotifications, apDDNotificationObjects=apDDNotificationObjects, apDdMsgTypeServerReqTotal=apDdMsgTypeServerReqTotal, apDdAgentStatus=apDdAgentStatus, apDdSubscriberPeriodActive=apDdSubscriberPeriodActive, apDdSessInitLifePerMax=apDdSessInitLifePerMax, apDdAgentMsgTypeStatsTable=apDdAgentMsgTypeStatsTable, apDdSessErrorsPeriodTotal=apDdSessErrorsPeriodTotal, apDdMsgReturnCodeClientTotal=apDdMsgReturnCodeClientTotal, apDdSessTimeoutPeriodTotal=apDdSessTimeoutPeriodTotal, apDdSubscribePeriodHigh=apDdSubscribePeriodHigh, apDdMsgTypeInfoTable=apDdMsgTypeInfoTable, apDdUnsubscribeLifeTotal=apDdUnsubscribeLifeTotal, apDdMalformedMsgPerMax=apDdMalformedMsgPerMax, apDdSCTPPathFailureClearTrap=apDdSCTPPathFailureClearTrap, apDdAgentOutboundConstraintsPerMax=apDdAgentOutboundConstraintsPerMax, apDdDnsCacheMissesTotal=apDdDnsCacheMissesTotal, apDdDiameterAgentHostName=apDdDiameterAgentHostName, apDdAgentRejectedMsgTotal=apDdAgentRejectedMsgTotal, apDdAgentDnsCacheHitsPerMax=apDdAgentDnsCacheHitsPerMax, apDdMsgReturnCodeIndex=apDdMsgReturnCodeIndex, apDdAgentDroppedMsgTotal=apDdAgentDroppedMsgTotal, apDdAgentDnsCacheMissesPerMax=apDdAgentDnsCacheMissesPerMax, apDDMIBObjects=apDDMIBObjects, apDDMIBGeneralObjects=apDDMIBGeneralObjects, apDdMsgTypeServerRetransPerMax=apDdMsgTypeServerRetransPerMax, apDdSubscriberMissPeriodTotal=apDdSubscriberMissPeriodTotal, apDdAgentDnsServerErrorsTotal=apDdAgentDnsServerErrorsTotal, apDdClientTransCPTotal=apDdClientTransCPTotal, apDdSessionPeriodActive=apDdSessionPeriodActive, apDdAgentServerTransCPActive=apDdAgentServerTransCPActive, apDdGeneralGroup=apDdGeneralGroup, apDdAgentGenSocketsLTHigh=apDdAgentGenSocketsLTHigh, apDdAgentClientTransLTPerMax=apDdAgentClientTransLTPerMax, apDdAgentStatsTable=apDdAgentStatsTable, apDdInterfaceStatsTable=apDdInterfaceStatsTable, apDdAgentMsgTypeClientThrottledRecent=apDdAgentMsgTypeClientThrottledRecent, apDdDiameterRemoteIPPort=apDdDiameterRemoteIPPort, apDdAgentStatsGroup=apDdAgentStatsGroup, apDdSessTerminatedPeriodActive=apDdSessTerminatedPeriodActive, apDdAgentClientTransCPHigh=apDdAgentClientTransCPHigh, apDdAgentInboundConstraintsPerMax=apDdAgentInboundConstraintsPerMax, PYSNMP_MODULE_ID=apDDModule, apDdServerTransLTTotal=apDdServerTransLTTotal, apDdMsgTypeLatencyWindow=apDdMsgTypeLatencyWindow, apDdInterfaceRealmName=apDdInterfaceRealmName, apDdSessErrorsLifeTotal=apDdSessErrorsLifeTotal, apDdDnsStatsEntryGroup=apDdDnsStatsEntryGroup, apDdSubscribePeriodTotal=apDdSubscribePeriodTotal, apDdMsgTypeClientThrottledPerMax=apDdMsgTypeClientThrottledPerMax, apDdAgentMsgTypeServerReqRecent=apDdAgentMsgTypeServerReqRecent, apDdAgentInboundConstraintsRecent=apDdAgentInboundConstraintsRecent, apDdClientTransLTHigh=apDdClientTransLTHigh, apDdSubscriberLifePerMax=apDdSubscriberLifePerMax, apDdAgentGenSocketsCPTotal=apDdAgentGenSocketsCPTotal, apDdAgentDnsResponsesRecent=apDdAgentDnsResponsesRecent, apDdAgentMsgTypeStatsEntry=apDdAgentMsgTypeStatsEntry, apDdMsgStatsReturnCodeTable=apDdMsgStatsReturnCodeTable, apDdAgentMsgTypeAverageLatency=apDdAgentMsgTypeAverageLatency, apDdMsgTypeClientReqTotal=apDdMsgTypeClientReqTotal, apDdAgentMsgTypeServerRespRetransPerMax=apDdAgentMsgTypeServerRespRetransPerMax, ApDdStatusOptions=ApDdStatusOptions, apDdAgentMsgReturnCodeServerTotal=apDdAgentMsgReturnCodeServerTotal, apDdPolicyMissLifePerMax=apDdPolicyMissLifePerMax, apDdAgentMsgTypeMaximumLatency=apDdAgentMsgTypeMaximumLatency, apDdDnsServerErrorsRecent=apDdDnsServerErrorsRecent, apDdSessEstablishedLifePerMax=apDdSessEstablishedLifePerMax, apDdAgentGenConnectsCPActive=apDdAgentGenConnectsCPActive, apDdGenConnectsLTPerMax=apDdGenConnectsLTPerMax, apDdAgentClientTransCPTotal=apDdAgentClientTransCPTotal, apDdDnsCacheHitsPerMax=apDdDnsCacheHitsPerMax, apDdMsgReturnCodeClientRecent=apDdMsgReturnCodeClientRecent, apDdMsgStatsReturnCodeEntry=apDdMsgStatsReturnCodeEntry, apDdSubscriberMissLifePerMax=apDdSubscriberMissLifePerMax, apDdMsgTypeClientThrottledTotal=apDdMsgTypeClientThrottledTotal, apDdAgentGenConnectsCPHigh=apDdAgentGenConnectsCPHigh, apDdAgentMsgTypeClientReqTotal=apDdAgentMsgTypeClientReqTotal, apDdDnsCacheHitsTotal=apDdDnsCacheHitsTotal, apDdDnsCacheHitsRecent=apDdDnsCacheHitsRecent, apDdSessMissLifePerMax=apDdSessMissLifePerMax, apDdSessTerminatedLifePerMax=apDdSessTerminatedLifePerMax, apDdDnsStatsTable=apDdDnsStatsTable, apDdMsgTypeClientTimeoutRecent=apDdMsgTypeClientTimeoutRecent, apDdAgentDnsResponsesTotal=apDdAgentDnsResponsesTotal, apDdAgentClientTransLTTotal=apDdAgentClientTransLTTotal, apDdGenSocketsCPTotal=apDdGenSocketsCPTotal, apDdAgentMsgTypeClientReqPerMax=apDdAgentMsgTypeClientReqPerMax, apDdInterfaceStatusReason=apDdInterfaceStatusReason, apDdCurrentTransRate=apDdCurrentTransRate, apDdAgentDnsClientErrorsTotal=apDdAgentDnsClientErrorsTotal, apDdDnsQueriesPerMax=apDdDnsQueriesPerMax, apDdSubscriberPeriodHigh=apDdSubscriberPeriodHigh, apDdSessInitLifeTotal=apDdSessInitLifeTotal, apDdPolicyMissPeriodActive=apDdPolicyMissPeriodActive, apDdSessionSubscriberGeneralGroup=apDdSessionSubscriberGeneralGroup, apDdMalformedMsgRecent=apDdMalformedMsgRecent, apDdSCTPPathFailureTrap=apDdSCTPPathFailureTrap, apDdAgentMsgTypeClientRespRetransPerMax=apDdAgentMsgTypeClientRespRetransPerMax, apDdAgentMalformedMsgPerMax=apDdAgentMalformedMsgPerMax, apDdErrorStatusGroup=apDdErrorStatusGroup, apDdAgentMsgTypeClientTimeoutTotal=apDdAgentMsgTypeClientTimeoutTotal, apDdMsgTypeClientRespRetransPerMax=apDdMsgTypeClientRespRetransPerMax, apDdOutboundConstraintsTotal=apDdOutboundConstraintsTotal, apDdAgentMsgTypeServerRetransTotal=apDdAgentMsgTypeServerRetransTotal, apDdErrorStatusEntry=apDdErrorStatusEntry, apDdDroppedMsgPerMax=apDdDroppedMsgPerMax, apDdSessTimeoutLifeTotal=apDdSessTimeoutLifeTotal, apDDNotifObjectsGroup=apDDNotifObjectsGroup, apDdDnsQueriesRecent=apDdDnsQueriesRecent, apDdAgentDnsCacheMissesTotal=apDdAgentDnsCacheMissesTotal, apDdAgentServerTransLTPerMax=apDdAgentServerTransLTPerMax, apDdGenConnectsLTHigh=apDdGenConnectsLTHigh, apDdAgentMsgTypeClientTimeoutPerMax=apDdAgentMsgTypeClientTimeoutPerMax, apDdErrorStatusTable=apDdErrorStatusTable, apDdAgentDnsCacheMissesRecent=apDdAgentDnsCacheMissesRecent, apDdAgentDnsCacheHitsTotal=apDdAgentDnsCacheHitsTotal, apDdMsgReturnCodeInfoTable=apDdMsgReturnCodeInfoTable, apDdAgentIndex=apDdAgentIndex, apDdAgentOutboundConstraintsRecent=apDdAgentOutboundConstraintsRecent, apDdAgentDroppedMsgPerMax=apDdAgentDroppedMsgPerMax, apDdDroppedMsgTotal=apDdDroppedMsgTotal, apDdInterfaceNumber=apDdInterfaceNumber, apDdMsgTypeClientTimeoutPerMax=apDdMsgTypeClientTimeoutPerMax, apDdServerTransLTPerMax=apDdServerTransLTPerMax, apDdMsgTypeClientRespRetransTotal=apDdMsgTypeClientRespRetransTotal, apDdInterfaceIndex=apDdInterfaceIndex, apDdAgentMsgTypeLatencyWindow=apDdAgentMsgTypeLatencyWindow, apDdSessionLifeTotal=apDdSessionLifeTotal, apDdDnsResponsesTotal=apDdDnsResponsesTotal, apDdSessionLifePerMax=apDdSessionLifePerMax, apDdAgentMsgTypeClientRespRetransTotal=apDdAgentMsgTypeClientRespRetransTotal, apDdDnsClientErrorsRecent=apDdDnsClientErrorsRecent, apDdAgentGenSocketsLTTotal=apDdAgentGenSocketsLTTotal, apDDSCTPNotifObjectsGroup=apDDSCTPNotifObjectsGroup, apDdClientTransLTPerMax=apDdClientTransLTPerMax, apDdAgentDnsQueriesTotal=apDdAgentDnsQueriesTotal, apDdPolicyHitLifeTotal=apDdPolicyHitLifeTotal, apDdAgentMalformedMsgRecent=apDdAgentMalformedMsgRecent, apDdInterfaceStatsGroup=apDdInterfaceStatsGroup, apDdSessionLifeHigh=apDdSessionLifeHigh, apDdAgentClientTransLTHigh=apDdAgentClientTransLTHigh, apDdAgentMsgTypeServerRespRetransRecent=apDdAgentMsgTypeServerRespRetransRecent, apDdAgentRejectedMsgPerMax=apDdAgentRejectedMsgPerMax, apDdAgentDnsQueriesPerMax=apDdAgentDnsQueriesPerMax, apDdDnsClientErrorsTotal=apDdDnsClientErrorsTotal, apDdPolicyHitLifeHigh=apDdPolicyHitLifeHigh, apDdMsgTypeServerRespRetransRecent=apDdMsgTypeServerRespRetransRecent, apDdMsgTypeClientRetransRecent=apDdMsgTypeClientRetransRecent, apDdSessInitLifeHigh=apDdSessInitLifeHigh, apDdAgentMsgReturnCodeClientTotal=apDdAgentMsgReturnCodeClientTotal, apDdHighTransRate=apDdHighTransRate, apDdAgentRejectedMsgRecent=apDdAgentRejectedMsgRecent, apDdAgentNoRouteFoundRecent=apDdAgentNoRouteFoundRecent)
mibBuilder.exportSymbols("APDD-MIB", apDdSessTerminatedPeriodTotal=apDdSessTerminatedPeriodTotal, apDdAgentDnsCacheHitsRecent=apDdAgentDnsCacheHitsRecent, apDdMsgReturnCodeServerPerMax=apDdMsgReturnCodeServerPerMax, apDdSCTPAssociationID=apDdSCTPAssociationID, apDDMIBTabularObjects=apDDMIBTabularObjects, apDdMsgTypeInfoEntry=apDdMsgTypeInfoEntry, apDdAgentGenConnectsLTTotal=apDdAgentGenConnectsLTTotal, apDdGenConnectsCPActive=apDdGenConnectsCPActive, apDdInterfaceStatsEntry=apDdInterfaceStatsEntry, apDdMsgReturnCodeName=apDdMsgReturnCodeName, apDdPolicyHitLifePerMax=apDdPolicyHitLifePerMax, apDdOutboundConstraintsPerMax=apDdOutboundConstraintsPerMax, apDdSessEstablishedLifeTotal=apDdSessEstablishedLifeTotal, apDdPolicyHitPeriodActive=apDdPolicyHitPeriodActive, apDdAgentDnsClientErrorsRecent=apDdAgentDnsClientErrorsRecent, apDDModule=apDDModule, apDdSessionPeriodHigh=apDdSessionPeriodHigh, apDdMsgTypeClientRetransTotal=apDdMsgTypeClientRetransTotal, apDdMsgTypeAverageLatency=apDdMsgTypeAverageLatency, apDdConnectionFailureTrap=apDdConnectionFailureTrap, apDdAgentOutboundConstraintsTotal=apDdAgentOutboundConstraintsTotal, apDdInboundConstraintsRecent=apDdInboundConstraintsRecent, apDdSessEstablishedPeriodTotal=apDdSessEstablishedPeriodTotal, apDdNoRouteFoundTotal=apDdNoRouteFoundTotal, apDdMsgTypeServerRespRetransTotal=apDdMsgTypeServerRespRetransTotal, apDdSessErrorsLifePerMax=apDdSessErrorsLifePerMax, apDdDiameterAgentOriginHostName=apDdDiameterAgentOriginHostName, apDdSessTerminatedLifeHigh=apDdSessTerminatedLifeHigh, apDdMsgTypeServerReqRecent=apDdMsgTypeServerReqRecent, apDdNoRouteFoundRecent=apDdNoRouteFoundRecent, apDdSessEstablishedPeriodHigh=apDdSessEstablishedPeriodHigh, apDdAgentErrorStatusEntry=apDdAgentErrorStatusEntry, apDdPolicyMissPeriodTotal=apDdPolicyMissPeriodTotal, apDdAgentDnsServerErrorsPerMax=apDdAgentDnsServerErrorsPerMax, apDdAgentMsgTypeClientRespRetransRecent=apDdAgentMsgTypeClientRespRetransRecent, apDdRejectedMsgTotal=apDdRejectedMsgTotal, apDdMsgReturnCodeInfoEntry=apDdMsgReturnCodeInfoEntry, apDdIntfErrorStatusGroup=apDdIntfErrorStatusGroup, apDdSubscriberLifeTotal=apDdSubscriberLifeTotal, apDdSubscriberLifeHigh=apDdSubscriberLifeHigh, apDdMsgTypeClientReqPerMax=apDdMsgTypeClientReqPerMax, apDdSessInitPeriodTotal=apDdSessInitPeriodTotal, apDdMsgTypeServerReqPerMax=apDdMsgTypeServerReqPerMax, apDDObjectGroups=apDDObjectGroups, apDdSessMissLifeTotal=apDdSessMissLifeTotal, apDDNotificationGroups=apDDNotificationGroups, apDdPolicyMissLifeTotal=apDdPolicyMissLifeTotal, apDdSessEstablishedPeriodActive=apDdSessEstablishedPeriodActive, apDdDnsResponsesRecent=apDdDnsResponsesRecent, apDdMsgTypeClientRetransPerMax=apDdMsgTypeClientRetransPerMax, apDdMsgTypeServerRetransRecent=apDdMsgTypeServerRetransRecent, apDdAgentMsgTypeClientRetransTotal=apDdAgentMsgTypeClientRetransTotal, apDdOutboundConstraintsRecent=apDdOutboundConstraintsRecent, apDdAgentDnsClientErrorsPerMax=apDdAgentDnsClientErrorsPerMax, apDdAgentGenSocketsCPActive=apDdAgentGenSocketsCPActive, apDdSubscriberPeriodTotal=apDdSubscriberPeriodTotal, apDDNotifPrefix=apDDNotifPrefix, apDdAgentGenSocketsLTPerMax=apDdAgentGenSocketsLTPerMax, apDdSubscribeLifePerMax=apDdSubscribeLifePerMax, apDdConnectionFailureClearTrap=apDdConnectionFailureClearTrap, apDdMsgReturnCodeServerRecent=apDdMsgReturnCodeServerRecent, apDdMalformedMsgTotal=apDdMalformedMsgTotal, apDdMsgTypeStatsGroup=apDdMsgTypeStatsGroup, apDdDnsCacheMissesPerMax=apDdDnsCacheMissesPerMax, apDDConformance=apDDConformance, apDdAgentMsgTypeClientRetransPerMax=apDdAgentMsgTypeClientRetransPerMax, apDdGenSocketsLTPerMax=apDdGenSocketsLTPerMax, apDdAgentDnsServerErrorsRecent=apDdAgentDnsServerErrorsRecent, apDdDnsStatsEntry=apDdDnsStatsEntry, apDdUnsubscribeLifeHigh=apDdUnsubscribeLifeHigh, apDdAgentStatsEntry=apDdAgentStatsEntry, apDdAgentDnsQueriesRecent=apDdAgentDnsQueriesRecent, apDdAgentDnsStatsEntryGroup=apDdAgentDnsStatsEntryGroup, apDdAgentMsgReturnCodeServerPerMax=apDdAgentMsgReturnCodeServerPerMax, apDdSCTPIsPrimaryPath=apDdSCTPIsPrimaryPath, apDdAgentGenConnectsLTPerMax=apDdAgentGenConnectsLTPerMax, apDdGenConnectsCPHigh=apDdGenConnectsCPHigh, apDdAgentServerTransLTHigh=apDdAgentServerTransLTHigh, apDdAgentRealmName=apDdAgentRealmName, apDdServerTransCPActive=apDdServerTransCPActive, apDdPolicyHitPeriodTotal=apDdPolicyHitPeriodTotal)
