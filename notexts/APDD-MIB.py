...
mibBuilder.exportSymbols("APDD-MIB", apDDSCTPNotificationsGroup=apDDSCTPNotificationsGroup, apDdAgentClientTransLTHigh=apDdAgentClientTransLTHigh, apDdSessEstablishedPeriodActive=apDdSessEstablishedPeriodActive, apDdErrorStatusEntry=apDdErrorStatusEntry, apDdGenConnectsLTPerMax=apDdGenConnectsLTPerMax, apDdAgentServerTransCPHigh=apDdAgentServerTransCPHigh, apDdSessTerminatedLifePerMax=apDdSessTerminatedLifePerMax, apDdClientTransCPActive=apDdClientTransCPActive, apDdAgentMsgTypeServerRetransPerMax=apDdAgentMsgTypeServerRetransPerMax, apDdUnsubscribePeriodActive=apDdUnsubscribePeriodActive, apDdSessionPeriodHigh=apDdSessionPeriodHigh, apDdOutboundConstraintsPerMax=apDdOutboundConstraintsPerMax, apDdRejectedMsgRecent=apDdRejectedMsgRecent, apDdOutboundConstraintsTotal=apDdOutboundConstraintsTotal, apDdAgentMsgTypeStatsEntry=apDdAgentMsgTypeStatsEntry, apDdPolicyHitLifeHigh=apDdPolicyHitLifeHigh, apDdAgentRejectedMsgPerMax=apDdAgentRejectedMsgPerMax, apDdAgentGenSocketsCPActive=apDdAgentGenSocketsCPActive, apDdDiameterIPPort=apDdDiameterIPPort, apDdMsgStatsReturnCodeTable=apDdMsgStatsReturnCodeTable, apDdAgentDnsStatsTable=apDdAgentDnsStatsTable, apDdAgentMsgTypeClientRetransRecent=apDdAgentMsgTypeClientRetransRecent, apDdAgentErrorStatusTable=apDdAgentErrorStatusTable, apDdMsgTypeAverageLatency=apDdMsgTypeAverageLatency, apDdUnsubscribeLifeTotal=apDdUnsubscribeLifeTotal, apDdDnsServerErrorsRecent=apDdDnsServerErrorsRecent, apDdAgentInboundConstraintsRecent=apDdAgentInboundConstraintsRecent, apDdAgentMsgStatsReturnCodeTable=apDdAgentMsgStatsReturnCodeTable, apDdMsgReturnCodeServerTotal=apDdMsgReturnCodeServerTotal, apDdSCTPAssociationID=apDdSCTPAssociationID, apDdMsgTypeStatsGroup=apDdMsgTypeStatsGroup, apDdUnsubscribePeriodTotal=apDdUnsubscribePeriodTotal, apDdAgentRejectedMsgTotal=apDdAgentRejectedMsgTotal, apDdCurrentTransRate=apDdCurrentTransRate, apDdSessTerminatedLifeHigh=apDdSessTerminatedLifeHigh, apDdAgentRealmName=apDdAgentRealmName, apDdAgentMsgTypeClientReqRecent=apDdAgentMsgTypeClientReqRecent, apDdSessTerminatedLifeTotal=apDdSessTerminatedLifeTotal, apDdMsgTypeClientRespRetransPerMax=apDdMsgTypeClientRespRetransPerMax, apDdSCTPPathFailureTrap=apDdSCTPPathFailureTrap, apDdAgentMsgTypeAverageLatency=apDdAgentMsgTypeAverageLatency, apDdAgentMsgTypeClientThrottledRecent=apDdAgentMsgTypeClientThrottledRecent, apDdInterfaceStatsGroup=apDdInterfaceStatsGroup, apDdMsgReturnCodeServerPerMax=apDdMsgReturnCodeServerPerMax, apDdSCTPIsPrimaryPath=apDdSCTPIsPrimaryPath, apDdSubscriberLifeHigh=apDdSubscriberLifeHigh, apDdSubscribeLifeHigh=apDdSubscribeLifeHigh, apDdSessEstablishedLifeHigh=apDdSessEstablishedLifeHigh, apDdDiameterAgentOriginHostName=apDdDiameterAgentOriginHostName, apDdAgentDnsClientErrorsPerMax=apDdAgentDnsClientErrorsPerMax, apDdAgentDroppedMsgPerMax=apDdAgentDroppedMsgPerMax, apDdAgentStatsTable=apDdAgentStatsTable, apDdPolicyHitPeriodActive=apDdPolicyHitPeriodActive, apDdDnsQueriesTotal=apDdDnsQueriesTotal, apDdDiameterAgentOriginRealmName=apDdDiameterAgentOriginRealmName, apDdGeneralGroup=apDdGeneralGroup, apDDNotifObjects=apDDNotifObjects, apDdAgentRejectedMsgRecent=apDdAgentRejectedMsgRecent, apDDNotifObjectsGroup=apDDNotifObjectsGroup, apDdSubscriberLifePerMax=apDdSubscriberLifePerMax, apDdMsgTypeServerRetransRecent=apDdMsgTypeServerRetransRecent, apDdGenConnectsLTTotal=apDdGenConnectsLTTotal, apDdAgentServerTransLTTotal=apDdAgentServerTransLTTotal, apDdMsgTypeClientRespRetransRecent=apDdMsgTypeClientRespRetransRecent, apDdSCTPPathFailureClearTrap=apDdSCTPPathFailureClearTrap, apDdAgentDnsCacheMissesPerMax=apDdAgentDnsCacheMissesPerMax, apDdConnectionFailureTrap=apDdConnectionFailureTrap, apDdAgentMsgReturnCodeServerTotal=apDdAgentMsgReturnCodeServerTotal, apDdMsgTypeInfoEntry=apDdMsgTypeInfoEntry, apDdAgentMsgTypeStatsGroup=apDdAgentMsgTypeStatsGroup, apDdUnsubscribeLifeHigh=apDdUnsubscribeLifeHigh, apDdAgentDnsCacheHitsTotal=apDdAgentDnsCacheHitsTotal, apDDModule=apDDModule, apDdAgentMsgTypeServerReqRecent=apDdAgentMsgTypeServerReqRecent, apDDNotificationObjects=apDDNotificationObjects, apDdMsgTypeIndex=apDdMsgTypeIndex, apDdAgentNumber=apDdAgentNumber, apDdAgentMsgTypeClientThrottledTotal=apDdAgentMsgTypeClientThrottledTotal, apDdAgentNoRouteFoundPerMax=apDdAgentNoRouteFoundPerMax, apDdMsgTypeStatsTable=apDdMsgTypeStatsTable, apDdServerTransLTHigh=apDdServerTransLTHigh, apDdSessEstablishedLifePerMax=apDdSessEstablishedLifePerMax, apDDConformance=apDDConformance, apDdPolicyMissPeriodTotal=apDdPolicyMissPeriodTotal, apDdDnsServerErrorsTotal=apDdDnsServerErrorsTotal, apDdAgentDnsClientErrorsRecent=apDdAgentDnsClientErrorsRecent, apDdGenSocketsLTHigh=apDdGenSocketsLTHigh, apDdAgentMsgReturnCodeServerRecent=apDdAgentMsgReturnCodeServerRecent, apDdServerTransLTTotal=apDdServerTransLTTotal, apDdAgentMsgTypeServerRespRetransPerMax=apDdAgentMsgTypeServerRespRetransPerMax, apDdAgentDnsStatsEntry=apDdAgentDnsStatsEntry, apDdSubscriberLifeTotal=apDdSubscriberLifeTotal, apDdDiameterAgentHostName=apDdDiameterAgentHostName, apDdSubscriberMissPeriodTotal=apDdSubscriberMissPeriodTotal, apDdMsgStatsReturnCodeEntry=apDdMsgStatsReturnCodeEntry, apDdMsgTypeClientRetransTotal=apDdMsgTypeClientRetransTotal, apDdConnectionFailureClearTrap=apDdConnectionFailureClearTrap, apDdPolicyHitLifeTotal=apDdPolicyHitLifeTotal, apDdPolicyHitPeriodHigh=apDdPolicyHitPeriodHigh, apDdAgentGenConnectsLTHigh=apDdAgentGenConnectsLTHigh, apDdSubscribePeriodTotal=apDdSubscribePeriodTotal, apDdMsgTypeClientTimeoutRecent=apDdMsgTypeClientTimeoutRecent, apDdMsgReturnCodeClientTotal=apDdMsgReturnCodeClientTotal, apDdAgentGenConnectsLTPerMax=apDdAgentGenConnectsLTPerMax, apDdInterfaceStatus=apDdInterfaceStatus, apDdSubscribeLifeTotal=apDdSubscribeLifeTotal, apDdPolicyHitPeriodTotal=apDdPolicyHitPeriodTotal, apDdMalformedMsgTotal=apDdMalformedMsgTotal, apDdAgentDnsQueriesRecent=apDdAgentDnsQueriesRecent, apDdGenSocketsCPHigh=apDdGenSocketsCPHigh, apDdAgentStatus=apDdAgentStatus, apDDMIBObjects=apDDMIBObjects, apDDNotificationGroups=apDDNotificationGroups, apDdSessTimeoutLifeTotal=apDdSessTimeoutLifeTotal, apDdAgentGeneralGroup=apDdAgentGeneralGroup, apDdMsgTypeClientReqRecent=apDdMsgTypeClientReqRecent, apDdAgentDnsCacheMissesRecent=apDdAgentDnsCacheMissesRecent, apDdRejectedMsgPerMax=apDdRejectedMsgPerMax, apDdAgentGenSocketsLTHigh=apDdAgentGenSocketsLTHigh, apDdMsgTypeClientThrottledTotal=apDdMsgTypeClientThrottledTotal, apDdErrorStatusTable=apDdErrorStatusTable, apDdAgentMsgTypeServerRetransRecent=apDdAgentMsgTypeServerRetransRecent, apDdAgentClientTransCPActive=apDdAgentClientTransCPActive, apDdAgentClientTransCPHigh=apDdAgentClientTransCPHigh, apDdPolicyHitLifePerMax=apDdPolicyHitLifePerMax, apDdSessTerminatedPeriodHigh=apDdSessTerminatedPeriodHigh, apDdAgentOutboundConstraintsPerMax=apDdAgentOutboundConstraintsPerMax, apDdAgentGenSocketsLTPerMax=apDdAgentGenSocketsLTPerMax, apDdAgentMsgTypeMaximumLatency=apDdAgentMsgTypeMaximumLatency, apDdMsgTypeMaximumLatency=apDdMsgTypeMaximumLatency, apDdPolicyMissLifePerMax=apDdPolicyMissLifePerMax, apDdAgentMsgReturnCodeServerPerMax=apDdAgentMsgReturnCodeServerPerMax, apDdAgentMsgTypeClientThrottledPerMax=apDdAgentMsgTypeClientThrottledPerMax, apDdAgentDnsCacheHitsRecent=apDdAgentDnsCacheHitsRecent, apDDSCTPNotifObjectsGroup=apDDSCTPNotifObjectsGroup, apDdInterfaceStatusReason=apDdInterfaceStatusReason, apDdDroppedMsgTotal=apDdDroppedMsgTotal, apDdDnsCacheMissesTotal=apDdDnsCacheMissesTotal, apDdSubscriberMissLifePerMax=apDdSubscriberMissLifePerMax, apDdAgentGenConnectsCPHigh=apDdAgentGenConnectsCPHigh, apDDNotifPrefix=apDDNotifPrefix, apDdUnsubscribeLifePerMax=apDdUnsubscribeLifePerMax, apDdGenSocketsLTTotal=apDdGenSocketsLTTotal, apDdAgentGenConnectsLTTotal=apDdAgentGenConnectsLTTotal, apDdDnsClientErrorsPerMax=apDdDnsClientErrorsPerMax, apDdDnsStatsEntry=apDdDnsStatsEntry, apDdAgentDnsResponsesRecent=apDdAgentDnsResponsesRecent, apDdHighTransRate=apDdHighTransRate, apDdSessTerminatedPeriodActive=apDdSessTerminatedPeriodActive, apDdAgentDnsServerErrorsPerMax=apDdAgentDnsServerErrorsPerMax, apDdSessionSubscriberGeneralGroup=apDdSessionSubscriberGeneralGroup, apDdAgentMsgStatsReturnCodeGroup=apDdAgentMsgStatsReturnCodeGroup, apDdGenConnectsCPTotal=apDdGenConnectsCPTotal, apDdAgentMsgTypeClientRespRetransPerMax=apDdAgentMsgTypeClientRespRetransPerMax, apDdClientTransCPHigh=apDdClientTransCPHigh, apDdAgentGenConnectsCPActive=apDdAgentGenConnectsCPActive, apDdAgentDroppedMsgRecent=apDdAgentDroppedMsgRecent, apDdMsgTypeMsgName=apDdMsgTypeMsgName, apDdMsgTypeClientReqTotal=apDdMsgTypeClientReqTotal, apDdAgentNoRouteFoundRecent=apDdAgentNoRouteFoundRecent, apDdPolicyMissLifeHigh=apDdPolicyMissLifeHigh, apDdAgentMsgTypeClientRespRetransRecent=apDdAgentMsgTypeClientRespRetransRecent, apDdAgentMsgTypeClientTimeoutRecent=apDdAgentMsgTypeClientTimeoutRecent, apDdAgentDroppedMsgTotal=apDdAgentDroppedMsgTotal, apDdSessionLifeHigh=apDdSessionLifeHigh, apDDMIBGeneralObjects=apDDMIBGeneralObjects, apDdAgentStatsEntry=apDdAgentStatsEntry, apDdAgentDnsCacheMissesTotal=apDdAgentDnsCacheMissesTotal, apDdDnsStatsTable=apDdDnsStatsTable, apDDNotificationsGroup=apDDNotificationsGroup, apDdLowTransRate=apDdLowTransRate, apDdMsgReturnCodeServerRecent=apDdMsgReturnCodeServerRecent, apDdErrorStatusGroup=apDdErrorStatusGroup, apDdAgentMalformedMsgPerMax=apDdAgentMalformedMsgPerMax, apDdAgentMsgTypeClientTimeoutPerMax=apDdAgentMsgTypeClientTimeoutPerMax, apDdAgentDnsQueriesTotal=apDdAgentDnsQueriesTotal, apDdMsgTypeInfoTable=apDdMsgTypeInfoTable, apDdAgentClientTransLTTotal=apDdAgentClientTransLTTotal, apDdNoRouteFoundRecent=apDdNoRouteFoundRecent, apDdDiameterRemoteIPPort=apDdDiameterRemoteIPPort, apDdMsgTypeServerRespRetransRecent=apDdMsgTypeServerRespRetransRecent, apDdSessTerminatedPeriodTotal=apDdSessTerminatedPeriodTotal, apDdAgentMsgTypeClientRetransPerMax=apDdAgentMsgTypeClientRetransPerMax, apDdPolicyMissPeriodHigh=apDdPolicyMissPeriodHigh, apDdServerTransCPHigh=apDdServerTransCPHigh, apDdAgentMsgTypeClientRespRetransTotal=apDdAgentMsgTypeClientRespRetransTotal, apDdAgentClientTransLTPerMax=apDdAgentClientTransLTPerMax, apDdServerTransLTPerMax=apDdServerTransLTPerMax, apDdDnsCacheHitsPerMax=apDdDnsCacheHitsPerMax, apDdSessMissLifeTotal=apDdSessMissLifeTotal, apDdClientTransLTHigh=apDdClientTransLTHigh, apDdAgentGenSocketsCPHigh=apDdAgentGenSocketsCPHigh, apDdAgentServerTransCPActive=apDdAgentServerTransCPActive, apDdSessionLifeTotal=apDdSessionLifeTotal, apDdAgentMsgTypeLatencyWindow=apDdAgentMsgTypeLatencyWindow, apDdClientTransLTTotal=apDdClientTransLTTotal, apDdPolicyMissLifeTotal=apDdPolicyMissLifeTotal, apDdMsgReturnCodeIndex=apDdMsgReturnCodeIndex, apDdAgentMsgTypeServerReqTotal=apDdAgentMsgTypeServerReqTotal, apDdSessErrorsLifeTotal=apDdSessErrorsLifeTotal, apDdAgentErrorStatusEntry=apDdAgentErrorStatusEntry, apDdGenSocketsLTPerMax=apDdGenSocketsLTPerMax, apDdSessionPeriodTotal=apDdSessionPeriodTotal, apDdGenSocketsCPActive=apDdGenSocketsCPActive, apDdSessInitPeriodHigh=apDdSessInitPeriodHigh, apDdSubscriberPeriodTotal=apDdSubscriberPeriodTotal, apDdSessEstablishedPeriodHigh=apDdSessEstablishedPeriodHigh, apDdMsgTypeServerRespRetransPerMax=apDdMsgTypeServerRespRetransPerMax, apDdSessMissLifePerMax=apDdSessMissLifePerMax, apDdMsgTypeServerRetransTotal=apDdMsgTypeServerRetransTotal, apDdInterfaceRealmName=apDdInterfaceRealmName, apDdDroppedMsgRecent=apDdDroppedMsgRecent, apDdAgentInboundConstraintsPerMax=apDdAgentInboundConstraintsPerMax, apDdSessErrorsLifePerMax=apDdSessErrorsLifePerMax, apDdSessTimeoutLifePerMax=apDdSessTimeoutLifePerMax, apDdDroppedMsgPerMax=apDdDroppedMsgPerMax, apDdSessionPeriodActive=apDdSessionPeriodActive, apDdMsgTypeClientRetransRecent=apDdMsgTypeClientRetransRecent, apDdDnsCacheHitsTotal=apDdDnsCacheHitsTotal, apDdNoRouteFoundPerMax=apDdNoRouteFoundPerMax, apDdDnsResponsesRecent=apDdDnsResponsesRecent, apDdSessInitPeriodActive=apDdSessInitPeriodActive, apDdAgentMsgTypeServerRespRetransRecent=apDdAgentMsgTypeServerRespRetransRecent, apDdAgentOutboundConstraintsRecent=apDdAgentOutboundConstraintsRecent, apDdSubscribePeriodHigh=apDdSubscribePeriodHigh, apDdMsgTypeClientTimeoutTotal=apDdMsgTypeClientTimeoutTotal, apDdSessInitPeriodTotal=apDdSessInitPeriodTotal, apDdAgentInboundConstraintsTotal=apDdAgentInboundConstraintsTotal, apDdAgentDnsServerErrorsTotal=apDdAgentDnsServerErrorsTotal, apDdAgentMalformedMsgRecent=apDdAgentMalformedMsgRecent, apDdAgentServerTransCPTotal=apDdAgentServerTransCPTotal, apDdMsgTypeServerReqPerMax=apDdMsgTypeServerReqPerMax, apDdAgentServerTransLTPerMax=apDdAgentServerTransLTPerMax, apDdAgentMsgTypeServerRespRetransTotal=apDdAgentMsgTypeServerRespRetransTotal, apDdMsgReturnCodeClientRecent=apDdMsgReturnCodeClientRecent, apDdAgentMsgTypeServerRetransTotal=apDdAgentMsgTypeServerRetransTotal, apDdDnsClientErrorsTotal=apDdDnsClientErrorsTotal, apDdMsgTypeClientReqPerMax=apDdMsgTypeClientReqPerMax, apDdMalformedMsgRecent=apDdMalformedMsgRecent, apDdMsgTypeClientThrottledPerMax=apDdMsgTypeClientThrottledPerMax, apDdMsgReturnCodeInfoEntry=apDdMsgReturnCodeInfoEntry, apDdDnsClientErrorsRecent=apDdDnsClientErrorsRecent, apDdGenConnectsCPActive=apDdGenConnectsCPActive, apDdAgentErrorStatusGroup=apDdAgentErrorStatusGroup, apDdSessInitLifeTotal=apDdSessInitLifeTotal, apDdInterfaceStatsEntry=apDdInterfaceStatsEntry, apDdSessTimeoutPeriodTotal=apDdSessTimeoutPeriodTotal, apDdPolicyMissPeriodActive=apDdPolicyMissPeriodActive, apDdAgentGenConnectsCPTotal=apDdAgentGenConnectsCPTotal, apDDObjectGroups=apDDObjectGroups, apDdDnsResponsesTotal=apDdDnsResponsesTotal, apDdInterfaceIndex=apDdInterfaceIndex, apDdAgentStatsGroup=apDdAgentStatsGroup, apDdGenConnectsLTHigh=apDdGenConnectsLTHigh)
mibBuilder.exportSymbols("APDD-MIB", apDdInboundConstraintsPerMax=apDdInboundConstraintsPerMax, apDdAgentMsgTypeClientReqPerMax=apDdAgentMsgTypeClientReqPerMax, apDdSessEstablishedPeriodTotal=apDdSessEstablishedPeriodTotal, apDdDnsCacheHitsRecent=apDdDnsCacheHitsRecent, apDdAgentMsgReturnCodeClientPerMax=apDdAgentMsgReturnCodeClientPerMax, apDdGenSocketsCPTotal=apDdGenSocketsCPTotal, apDdMsgReturnCodeClientPerMax=apDdMsgReturnCodeClientPerMax, apDdAgentMsgTypeClientTimeoutTotal=apDdAgentMsgTypeClientTimeoutTotal, apDdAgentDnsQueriesPerMax=apDdAgentDnsQueriesPerMax, apDdMalformedMsgPerMax=apDdMalformedMsgPerMax, apDdTransportType=apDdTransportType, apDdDnsServerErrorsPerMax=apDdDnsServerErrorsPerMax, apDdMsgTypeClientRespRetransTotal=apDdMsgTypeClientRespRetransTotal, apDdSubscribeLifePerMax=apDdSubscribeLifePerMax, apDdInboundConstraintsRecent=apDdInboundConstraintsRecent, apDdServerTransCPTotal=apDdServerTransCPTotal, apDdMsgTypeStatsEntry=apDdMsgTypeStatsEntry, apDDNotifications=apDDNotifications, apDdMsgTypeClientRetransPerMax=apDdMsgTypeClientRetransPerMax, apDdAgentNoRouteFoundTotal=apDdAgentNoRouteFoundTotal, apDdDnsStatsEntryGroup=apDdDnsStatsEntryGroup, apDdAgentMsgTypeClientRetransTotal=apDdAgentMsgTypeClientRetransTotal, apDdNoRouteFoundTotal=apDdNoRouteFoundTotal, apDdInboundConstraintsTotal=apDdInboundConstraintsTotal, apDdRejectedMsgTotal=apDdRejectedMsgTotal, apDdDnsQueriesRecent=apDdDnsQueriesRecent, apDdClientTransCPTotal=apDdClientTransCPTotal, apDdSessInitLifePerMax=apDdSessInitLifePerMax, apDdAgentDnsCacheHitsPerMax=apDdAgentDnsCacheHitsPerMax, apDdServerTransCPActive=apDdServerTransCPActive, apDdMsgTypeServerReqTotal=apDdMsgTypeServerReqTotal, apDdMsgTypeLatencyWindow=apDdMsgTypeLatencyWindow, apDdAgentMsgTypeClientReqTotal=apDdAgentMsgTypeClientReqTotal, ApDdStatusOptions=ApDdStatusOptions, apDdMsgTypeClientTimeoutPerMax=apDdMsgTypeClientTimeoutPerMax, apDdAgentMalformedMsgTotal=apDdAgentMalformedMsgTotal, apDdSessErrorsPeriodTotal=apDdSessErrorsPeriodTotal, apDdSubscriberPeriodActive=apDdSubscriberPeriodActive, apDdDnsCacheMissesPerMax=apDdDnsCacheMissesPerMax, apDdAgentMsgTypeServerReqPerMax=apDdAgentMsgTypeServerReqPerMax, apDdAgentDnsServerErrorsRecent=apDdAgentDnsServerErrorsRecent, apDdAgentGenSocketsLTTotal=apDdAgentGenSocketsLTTotal, apDdDnsResponsesPerMax=apDdDnsResponsesPerMax, apDdSessEstablishedLifeTotal=apDdSessEstablishedLifeTotal, apDdMsgTypeClientThrottledRecent=apDdMsgTypeClientThrottledRecent, apDdSubscriberPeriodHigh=apDdSubscriberPeriodHigh, apDdMsgReturnCodeInfoTable=apDdMsgReturnCodeInfoTable, apDdAgentDnsStatsEntryGroup=apDdAgentDnsStatsEntryGroup, apDdAgentMsgStatsReturnCodeEntry=apDdAgentMsgStatsReturnCodeEntry, apDdAgentDnsResponsesTotal=apDdAgentDnsResponsesTotal, apDdSessInitLifeHigh=apDdSessInitLifeHigh, apDdClientTransLTPerMax=apDdClientTransLTPerMax, apDdOutboundConstraintsRecent=apDdOutboundConstraintsRecent, apDdAgentDnsClientErrorsTotal=apDdAgentDnsClientErrorsTotal, apDdMsgTypeServerReqRecent=apDdMsgTypeServerReqRecent, apDdInterfaceNumber=apDdInterfaceNumber, apDdAgentMsgTypeStatsTable=apDdAgentMsgTypeStatsTable, apDdSessionLifePerMax=apDdSessionLifePerMax, apDdSubscriberMissLifeTotal=apDdSubscriberMissLifeTotal, PYSNMP_MODULE_ID=apDDModule, apDdDnsQueriesPerMax=apDdDnsQueriesPerMax, apDdSubscribePeriodActive=apDdSubscribePeriodActive, apDDMIBTabularObjects=apDDMIBTabularObjects, apDdInterfaceStatsTable=apDdInterfaceStatsTable, apDdIntfErrorStatusGroup=apDdIntfErrorStatusGroup, apDdUnsubscribePeriodHigh=apDdUnsubscribePeriodHigh, apDdAgentGenSocketsCPTotal=apDdAgentGenSocketsCPTotal, apDdAgentIndex=apDdAgentIndex, apDdAgentClientTransCPTotal=apDdAgentClientTransCPTotal, apDdSessMissPeriodTotal=apDdSessMissPeriodTotal, apDdMsgStatsReturnCodeGroup=apDdMsgStatsReturnCodeGroup, apDdAgentDnsResponsesPerMax=apDdAgentDnsResponsesPerMax, apDdAgentMsgReturnCodeClientRecent=apDdAgentMsgReturnCodeClientRecent, apDdDnsCacheMissesRecent=apDdDnsCacheMissesRecent, apDdMsgTypeServerRetransPerMax=apDdMsgTypeServerRetransPerMax, apDdAgentOutboundConstraintsTotal=apDdAgentOutboundConstraintsTotal, apDdAgentServerTransLTHigh=apDdAgentServerTransLTHigh, apDdMsgReturnCodeName=apDdMsgReturnCodeName, apDdGenConnectsCPHigh=apDdGenConnectsCPHigh, apDdMsgTypeServerRespRetransTotal=apDdMsgTypeServerRespRetransTotal, apDdAgentMsgReturnCodeClientTotal=apDdAgentMsgReturnCodeClientTotal)
