...
mibBuilder.exportSymbols("APDD-MIB", apDDNotifPrefix=apDDNotifPrefix, apDdDnsStatsTable=apDdDnsStatsTable, apDdDnsResponsesRecent=apDdDnsResponsesRecent, apDDMIBTabularObjects=apDDMIBTabularObjects, apDdSubscribeLifeHigh=apDdSubscribeLifeHigh, apDdSessMissPeriodTotal=apDdSessMissPeriodTotal, apDdMsgTypeServerRetransTotal=apDdMsgTypeServerRetransTotal, apDdAgentStatus=apDdAgentStatus, apDdAgentMsgTypeClientTimeoutTotal=apDdAgentMsgTypeClientTimeoutTotal, apDdMsgTypeClientRetransPerMax=apDdMsgTypeClientRetransPerMax, apDdAgentDroppedMsgRecent=apDdAgentDroppedMsgRecent, apDdAgentNumber=apDdAgentNumber, apDdAgentDnsResponsesTotal=apDdAgentDnsResponsesTotal, apDdMsgStatsReturnCodeEntry=apDdMsgStatsReturnCodeEntry, apDdAgentMsgTypeStatsGroup=apDdAgentMsgTypeStatsGroup, apDdGenSocketsCPActive=apDdGenSocketsCPActive, apDDSCTPNotifObjectsGroup=apDDSCTPNotifObjectsGroup, apDdGenSocketsLTHigh=apDdGenSocketsLTHigh, apDdMsgTypeServerReqPerMax=apDdMsgTypeServerReqPerMax, apDDConformance=apDDConformance, apDdSCTPPathFailureClearTrap=apDdSCTPPathFailureClearTrap, apDdMsgTypeClientRespRetransPerMax=apDdMsgTypeClientRespRetransPerMax, apDdAgentInboundConstraintsTotal=apDdAgentInboundConstraintsTotal, apDDObjectGroups=apDDObjectGroups, apDdAgentDnsClientErrorsTotal=apDdAgentDnsClientErrorsTotal, apDdAgentDnsQueriesTotal=apDdAgentDnsQueriesTotal, apDdPolicyMissLifePerMax=apDdPolicyMissLifePerMax, apDdAgentMsgTypeClientThrottledTotal=apDdAgentMsgTypeClientThrottledTotal, apDdRejectedMsgPerMax=apDdRejectedMsgPerMax, apDdMsgTypeClientRespRetransTotal=apDdMsgTypeClientRespRetransTotal, apDdMsgReturnCodeClientPerMax=apDdMsgReturnCodeClientPerMax, apDdAgentMsgReturnCodeClientPerMax=apDdAgentMsgReturnCodeClientPerMax, apDdSessEstablishedLifeTotal=apDdSessEstablishedLifeTotal, apDdSessionPeriodTotal=apDdSessionPeriodTotal, apDdSessMissLifeTotal=apDdSessMissLifeTotal, apDdSessInitLifePerMax=apDdSessInitLifePerMax, apDdAgentErrorStatusTable=apDdAgentErrorStatusTable, apDdAgentMalformedMsgPerMax=apDdAgentMalformedMsgPerMax, apDdAgentServerTransCPActive=apDdAgentServerTransCPActive, apDdAgentMsgReturnCodeClientTotal=apDdAgentMsgReturnCodeClientTotal, apDdSessionLifePerMax=apDdSessionLifePerMax, apDdMsgReturnCodeClientRecent=apDdMsgReturnCodeClientRecent, apDdServerTransLTHigh=apDdServerTransLTHigh, apDdAgentStatsEntry=apDdAgentStatsEntry, apDdMsgTypeAverageLatency=apDdMsgTypeAverageLatency, apDdServerTransLTTotal=apDdServerTransLTTotal, apDdPolicyMissLifeHigh=apDdPolicyMissLifeHigh, apDdDnsClientErrorsTotal=apDdDnsClientErrorsTotal, apDdAgentMsgReturnCodeServerTotal=apDdAgentMsgReturnCodeServerTotal, apDdAgentDnsCacheHitsRecent=apDdAgentDnsCacheHitsRecent, apDdAgentGenConnectsLTPerMax=apDdAgentGenConnectsLTPerMax, apDdSubscriberMissPeriodTotal=apDdSubscriberMissPeriodTotal, apDdMsgReturnCodeServerTotal=apDdMsgReturnCodeServerTotal, apDdSessTimeoutPeriodTotal=apDdSessTimeoutPeriodTotal, apDdMsgReturnCodeServerPerMax=apDdMsgReturnCodeServerPerMax, apDdAgentMsgTypeClientRetransRecent=apDdAgentMsgTypeClientRetransRecent, apDdSessTimeoutLifeTotal=apDdSessTimeoutLifeTotal, apDdMsgTypeStatsGroup=apDdMsgTypeStatsGroup, apDdLowTransRate=apDdLowTransRate, apDdSubscriberPeriodTotal=apDdSubscriberPeriodTotal, apDdAgentOutboundConstraintsTotal=apDdAgentOutboundConstraintsTotal, apDdSessionPeriodHigh=apDdSessionPeriodHigh, apDdAgentServerTransLTPerMax=apDdAgentServerTransLTPerMax, apDDNotifObjects=apDDNotifObjects, apDdAgentMsgReturnCodeServerPerMax=apDdAgentMsgReturnCodeServerPerMax, apDdAgentMsgTypeStatsTable=apDdAgentMsgTypeStatsTable, apDdSubscriberLifeHigh=apDdSubscriberLifeHigh, apDdMsgTypeMsgName=apDdMsgTypeMsgName, apDdSessInitPeriodHigh=apDdSessInitPeriodHigh, apDdClientTransCPTotal=apDdClientTransCPTotal, apDdMsgTypeServerRespRetransRecent=apDdMsgTypeServerRespRetransRecent, apDdDnsStatsEntryGroup=apDdDnsStatsEntryGroup, apDdMsgTypeServerRespRetransPerMax=apDdMsgTypeServerRespRetransPerMax, apDdAgentMsgTypeClientReqPerMax=apDdAgentMsgTypeClientReqPerMax, apDdMsgTypeClientReqPerMax=apDdMsgTypeClientReqPerMax, apDdAgentRealmName=apDdAgentRealmName, apDdGenConnectsCPTotal=apDdGenConnectsCPTotal, apDdGenConnectsLTPerMax=apDdGenConnectsLTPerMax, apDdInterfaceRealmName=apDdInterfaceRealmName, apDdErrorStatusGroup=apDdErrorStatusGroup, apDdPolicyHitLifePerMax=apDdPolicyHitLifePerMax, apDdDroppedMsgTotal=apDdDroppedMsgTotal, apDdAgentMsgStatsReturnCodeEntry=apDdAgentMsgStatsReturnCodeEntry, apDdAgentDnsStatsTable=apDdAgentDnsStatsTable, apDdInterfaceStatsEntry=apDdInterfaceStatsEntry, apDdAgentRejectedMsgRecent=apDdAgentRejectedMsgRecent, apDdMsgTypeInfoTable=apDdMsgTypeInfoTable, apDdSessErrorsLifePerMax=apDdSessErrorsLifePerMax, apDdSessTerminatedPeriodHigh=apDdSessTerminatedPeriodHigh, apDdUnsubscribeLifeTotal=apDdUnsubscribeLifeTotal, apDdDiameterRemoteIPPort=apDdDiameterRemoteIPPort, apDdTransportType=apDdTransportType, apDdServerTransCPHigh=apDdServerTransCPHigh, apDdAgentGenConnectsCPTotal=apDdAgentGenConnectsCPTotal, apDdMsgReturnCodeName=apDdMsgReturnCodeName, apDdSubscribeLifeTotal=apDdSubscribeLifeTotal, apDdDnsResponsesTotal=apDdDnsResponsesTotal, apDdAgentServerTransLTTotal=apDdAgentServerTransLTTotal, apDdAgentMsgTypeServerRetransTotal=apDdAgentMsgTypeServerRetransTotal, apDdAgentDnsResponsesPerMax=apDdAgentDnsResponsesPerMax, apDdAgentMsgTypeLatencyWindow=apDdAgentMsgTypeLatencyWindow, apDdAgentStatsGroup=apDdAgentStatsGroup, apDdAgentMsgTypeServerReqPerMax=apDdAgentMsgTypeServerReqPerMax, apDdAgentDnsClientErrorsPerMax=apDdAgentDnsClientErrorsPerMax, apDdPolicyMissPeriodHigh=apDdPolicyMissPeriodHigh, apDdDroppedMsgRecent=apDdDroppedMsgRecent, apDdAgentDnsStatsEntry=apDdAgentDnsStatsEntry, apDdDnsStatsEntry=apDdDnsStatsEntry, apDdMsgTypeServerRetransRecent=apDdMsgTypeServerRetransRecent, apDdDnsQueriesPerMax=apDdDnsQueriesPerMax, apDdInterfaceStatsGroup=apDdInterfaceStatsGroup, apDdAgentInboundConstraintsRecent=apDdAgentInboundConstraintsRecent, apDdAgentMsgTypeServerReqRecent=apDdAgentMsgTypeServerReqRecent, apDdAgentDnsCacheHitsTotal=apDdAgentDnsCacheHitsTotal, apDdClientTransLTPerMax=apDdClientTransLTPerMax, apDdInterfaceStatsTable=apDdInterfaceStatsTable, apDdAgentDnsClientErrorsRecent=apDdAgentDnsClientErrorsRecent, apDdMsgTypeClientTimeoutPerMax=apDdMsgTypeClientTimeoutPerMax, apDdAgentOutboundConstraintsPerMax=apDdAgentOutboundConstraintsPerMax, apDdAgentMalformedMsgTotal=apDdAgentMalformedMsgTotal, apDdAgentServerTransLTHigh=apDdAgentServerTransLTHigh, apDdAgentDnsCacheMissesRecent=apDdAgentDnsCacheMissesRecent, apDdInboundConstraintsRecent=apDdInboundConstraintsRecent, apDdCurrentTransRate=apDdCurrentTransRate, apDdAgentDnsStatsEntryGroup=apDdAgentDnsStatsEntryGroup, apDdClientTransCPHigh=apDdClientTransCPHigh, apDdDnsCacheMissesPerMax=apDdDnsCacheMissesPerMax, apDdGenConnectsLTHigh=apDdGenConnectsLTHigh, apDdOutboundConstraintsTotal=apDdOutboundConstraintsTotal, apDdRejectedMsgRecent=apDdRejectedMsgRecent, apDdMsgTypeMaximumLatency=apDdMsgTypeMaximumLatency, apDdSubscribePeriodHigh=apDdSubscribePeriodHigh, apDdAgentClientTransLTHigh=apDdAgentClientTransLTHigh, apDdInterfaceNumber=apDdInterfaceNumber, apDdAgentGenSocketsLTPerMax=apDdAgentGenSocketsLTPerMax, apDdMsgTypeClientThrottledRecent=apDdMsgTypeClientThrottledRecent, apDdAgentMsgTypeClientThrottledPerMax=apDdAgentMsgTypeClientThrottledPerMax, apDdAgentMsgTypeClientTimeoutPerMax=apDdAgentMsgTypeClientTimeoutPerMax, apDdSessTerminatedPeriodActive=apDdSessTerminatedPeriodActive, apDdAgentMsgTypeClientReqRecent=apDdAgentMsgTypeClientReqRecent, apDdAgentGenSocketsLTTotal=apDdAgentGenSocketsLTTotal, apDdMsgTypeServerReqTotal=apDdMsgTypeServerReqTotal, apDDSCTPNotificationsGroup=apDDSCTPNotificationsGroup, apDdErrorStatusEntry=apDdErrorStatusEntry, apDdNoRouteFoundRecent=apDdNoRouteFoundRecent, apDdMsgTypeClientReqTotal=apDdMsgTypeClientReqTotal, apDdAgentMsgTypeServerRespRetransRecent=apDdAgentMsgTypeServerRespRetransRecent, apDdInboundConstraintsTotal=apDdInboundConstraintsTotal, apDdErrorStatusTable=apDdErrorStatusTable, apDdAgentErrorStatusGroup=apDdAgentErrorStatusGroup, apDdMsgTypeServerRetransPerMax=apDdMsgTypeServerRetransPerMax, apDDMIBObjects=apDDMIBObjects, apDdAgentClientTransCPActive=apDdAgentClientTransCPActive, apDDMIBGeneralObjects=apDDMIBGeneralObjects, apDDNotificationObjects=apDDNotificationObjects, apDdInterfaceStatusReason=apDdInterfaceStatusReason, apDdNoRouteFoundPerMax=apDdNoRouteFoundPerMax, apDdMalformedMsgRecent=apDdMalformedMsgRecent, apDdAgentMsgTypeServerRetransPerMax=apDdAgentMsgTypeServerRetransPerMax, apDdSubscribePeriodActive=apDdSubscribePeriodActive, apDdAgentMsgTypeClientRetransPerMax=apDdAgentMsgTypeClientRetransPerMax, apDdNoRouteFoundTotal=apDdNoRouteFoundTotal, apDdOutboundConstraintsRecent=apDdOutboundConstraintsRecent, apDdDroppedMsgPerMax=apDdDroppedMsgPerMax, apDdAgentMsgTypeClientThrottledRecent=apDdAgentMsgTypeClientThrottledRecent, apDdAgentMsgTypeStatsEntry=apDdAgentMsgTypeStatsEntry, apDdAgentGenSocketsCPTotal=apDdAgentGenSocketsCPTotal, apDdAgentClientTransLTPerMax=apDdAgentClientTransLTPerMax, apDdPolicyMissPeriodTotal=apDdPolicyMissPeriodTotal, apDdUnsubscribeLifeHigh=apDdUnsubscribeLifeHigh, apDdDiameterAgentOriginRealmName=apDdDiameterAgentOriginRealmName, apDdSubscriberMissLifePerMax=apDdSubscriberMissLifePerMax, apDdGenSocketsLTPerMax=apDdGenSocketsLTPerMax, apDdSessEstablishedPeriodActive=apDdSessEstablishedPeriodActive, apDdAgentNoRouteFoundPerMax=apDdAgentNoRouteFoundPerMax, apDdMsgTypeInfoEntry=apDdMsgTypeInfoEntry, apDdAgentMalformedMsgRecent=apDdAgentMalformedMsgRecent, apDdAgentErrorStatusEntry=apDdAgentErrorStatusEntry, apDdAgentGenConnectsLTTotal=apDdAgentGenConnectsLTTotal, apDdSessionLifeHigh=apDdSessionLifeHigh, apDdAgentMsgTypeClientRespRetransPerMax=apDdAgentMsgTypeClientRespRetransPerMax, apDdAgentGenSocketsCPActive=apDdAgentGenSocketsCPActive, apDdUnsubscribePeriodTotal=apDdUnsubscribePeriodTotal, apDdMsgTypeClientThrottledPerMax=apDdMsgTypeClientThrottledPerMax, apDdIntfErrorStatusGroup=apDdIntfErrorStatusGroup, apDdSubscriberPeriodHigh=apDdSubscriberPeriodHigh, apDdMsgTypeStatsEntry=apDdMsgTypeStatsEntry, apDdPolicyMissLifeTotal=apDdPolicyMissLifeTotal, apDdAgentMsgStatsReturnCodeTable=apDdAgentMsgStatsReturnCodeTable, apDdSessionLifeTotal=apDdSessionLifeTotal, apDdDnsServerErrorsTotal=apDdDnsServerErrorsTotal, apDdSCTPAssociationID=apDdSCTPAssociationID, apDdConnectionFailureTrap=apDdConnectionFailureTrap, apDdAgentDnsServerErrorsRecent=apDdAgentDnsServerErrorsRecent, apDdSessionSubscriberGeneralGroup=apDdSessionSubscriberGeneralGroup, apDdUnsubscribePeriodHigh=apDdUnsubscribePeriodHigh, apDdGenSocketsLTTotal=apDdGenSocketsLTTotal, apDdSubscriberPeriodActive=apDdSubscriberPeriodActive, apDdRejectedMsgTotal=apDdRejectedMsgTotal, apDdClientTransCPActive=apDdClientTransCPActive, apDdDiameterIPPort=apDdDiameterIPPort, apDdSessTerminatedLifeTotal=apDdSessTerminatedLifeTotal, apDdSessTerminatedPeriodTotal=apDdSessTerminatedPeriodTotal, apDdAgentOutboundConstraintsRecent=apDdAgentOutboundConstraintsRecent, apDdSubscribePeriodTotal=apDdSubscribePeriodTotal, apDdAgentGenConnectsCPActive=apDdAgentGenConnectsCPActive, apDdDnsClientErrorsRecent=apDdDnsClientErrorsRecent, apDdDnsQueriesRecent=apDdDnsQueriesRecent, apDdDiameterAgentHostName=apDdDiameterAgentHostName, apDdMsgTypeClientTimeoutTotal=apDdMsgTypeClientTimeoutTotal, apDdGenConnectsCPActive=apDdGenConnectsCPActive, apDdHighTransRate=apDdHighTransRate, apDdGenConnectsCPHigh=apDdGenConnectsCPHigh, apDdPolicyHitLifeHigh=apDdPolicyHitLifeHigh, apDdDnsCacheMissesTotal=apDdDnsCacheMissesTotal, apDdAgentMsgTypeClientReqTotal=apDdAgentMsgTypeClientReqTotal, apDdSessTerminatedLifePerMax=apDdSessTerminatedLifePerMax, apDdAgentGenSocketsCPHigh=apDdAgentGenSocketsCPHigh, apDdAgentMsgReturnCodeClientRecent=apDdAgentMsgReturnCodeClientRecent, apDdMsgReturnCodeInfoTable=apDdMsgReturnCodeInfoTable, apDdAgentMsgTypeClientRespRetransRecent=apDdAgentMsgTypeClientRespRetransRecent, apDdDnsResponsesPerMax=apDdDnsResponsesPerMax, apDdDnsClientErrorsPerMax=apDdDnsClientErrorsPerMax, apDdSubscriberLifePerMax=apDdSubscriberLifePerMax, apDdSessErrorsLifeTotal=apDdSessErrorsLifeTotal, apDdAgentClientTransCPTotal=apDdAgentClientTransCPTotal, apDDNotifObjectsGroup=apDDNotifObjectsGroup, apDdMsgTypeStatsTable=apDdMsgTypeStatsTable, apDdAgentIndex=apDdAgentIndex, apDdSessInitPeriodTotal=apDdSessInitPeriodTotal, apDdMsgTypeClientRetransRecent=apDdMsgTypeClientRetransRecent, apDdAgentMsgTypeAverageLatency=apDdAgentMsgTypeAverageLatency, apDdSessTimeoutLifePerMax=apDdSessTimeoutLifePerMax, apDdAgentServerTransCPTotal=apDdAgentServerTransCPTotal, apDdMsgTypeClientReqRecent=apDdMsgTypeClientReqRecent, apDdMalformedMsgPerMax=apDdMalformedMsgPerMax, apDdAgentMsgTypeClientRespRetransTotal=apDdAgentMsgTypeClientRespRetransTotal, apDdAgentInboundConstraintsPerMax=apDdAgentInboundConstraintsPerMax, apDdAgentDnsCacheMissesPerMax=apDdAgentDnsCacheMissesPerMax, apDdClientTransLTTotal=apDdClientTransLTTotal, apDdMsgReturnCodeInfoEntry=apDdMsgReturnCodeInfoEntry, apDdSCTPPathFailureTrap=apDdSCTPPathFailureTrap, apDdMsgTypeLatencyWindow=apDdMsgTypeLatencyWindow, apDdMsgStatsReturnCodeTable=apDdMsgStatsReturnCodeTable, apDdMsgTypeClientThrottledTotal=apDdMsgTypeClientThrottledTotal, apDdAgentNoRouteFoundTotal=apDdAgentNoRouteFoundTotal, apDdMsgTypeClientRetransTotal=apDdMsgTypeClientRetransTotal, apDdDnsCacheHitsPerMax=apDdDnsCacheHitsPerMax, apDdAgentDroppedMsgTotal=apDdAgentDroppedMsgTotal, apDdAgentMsgTypeMaximumLatency=apDdAgentMsgTypeMaximumLatency, apDdMsgStatsReturnCodeGroup=apDdMsgStatsReturnCodeGroup, apDdAgentGenConnectsCPHigh=apDdAgentGenConnectsCPHigh, apDdAgentServerTransCPHigh=apDdAgentServerTransCPHigh, apDdServerTransCPTotal=apDdServerTransCPTotal)
mibBuilder.exportSymbols("APDD-MIB", apDdAgentGenSocketsLTHigh=apDdAgentGenSocketsLTHigh, apDdMsgTypeServerRespRetransTotal=apDdMsgTypeServerRespRetransTotal, apDdDnsServerErrorsPerMax=apDdDnsServerErrorsPerMax, apDdGeneralGroup=apDdGeneralGroup, apDDNotifications=apDDNotifications, apDdAgentClientTransCPHigh=apDdAgentClientTransCPHigh, apDdAgentMsgTypeServerRespRetransPerMax=apDdAgentMsgTypeServerRespRetransPerMax, apDdSubscriberMissLifeTotal=apDdSubscriberMissLifeTotal, apDdMsgReturnCodeServerRecent=apDdMsgReturnCodeServerRecent, apDdMsgReturnCodeIndex=apDdMsgReturnCodeIndex, apDdAgentDnsServerErrorsTotal=apDdAgentDnsServerErrorsTotal, apDdAgentDnsQueriesRecent=apDdAgentDnsQueriesRecent, apDdMalformedMsgTotal=apDdMalformedMsgTotal, apDdInboundConstraintsPerMax=apDdInboundConstraintsPerMax, apDdAgentMsgTypeClientRetransTotal=apDdAgentMsgTypeClientRetransTotal, apDdAgentMsgTypeClientTimeoutRecent=apDdAgentMsgTypeClientTimeoutRecent, apDdSubscribeLifePerMax=apDdSubscribeLifePerMax, apDdUnsubscribeLifePerMax=apDdUnsubscribeLifePerMax, apDdAgentGeneralGroup=apDdAgentGeneralGroup, apDDNotificationsGroup=apDDNotificationsGroup, apDdSessInitPeriodActive=apDdSessInitPeriodActive, apDdMsgTypeIndex=apDdMsgTypeIndex, apDdAgentMsgStatsReturnCodeGroup=apDdAgentMsgStatsReturnCodeGroup, apDdMsgTypeServerReqRecent=apDdMsgTypeServerReqRecent, apDdAgentDnsCacheHitsPerMax=apDdAgentDnsCacheHitsPerMax, apDdAgentMsgTypeServerRespRetransTotal=apDdAgentMsgTypeServerRespRetransTotal, apDdSessInitLifeHigh=apDdSessInitLifeHigh, apDdAgentDnsQueriesPerMax=apDdAgentDnsQueriesPerMax, apDdAgentRejectedMsgTotal=apDdAgentRejectedMsgTotal, apDdSessionPeriodActive=apDdSessionPeriodActive, apDdMsgTypeClientTimeoutRecent=apDdMsgTypeClientTimeoutRecent, apDdSessInitLifeTotal=apDdSessInitLifeTotal, apDdAgentNoRouteFoundRecent=apDdAgentNoRouteFoundRecent, apDdMsgTypeClientRespRetransRecent=apDdMsgTypeClientRespRetransRecent, ApDdStatusOptions=ApDdStatusOptions, apDdSessTerminatedLifeHigh=apDdSessTerminatedLifeHigh, apDdSessEstablishedLifePerMax=apDdSessEstablishedLifePerMax, apDdPolicyHitPeriodTotal=apDdPolicyHitPeriodTotal, apDdSubscriberLifeTotal=apDdSubscriberLifeTotal, apDdAgentDroppedMsgPerMax=apDdAgentDroppedMsgPerMax, apDdGenSocketsCPTotal=apDdGenSocketsCPTotal, apDdGenConnectsLTTotal=apDdGenConnectsLTTotal, apDdConnectionFailureClearTrap=apDdConnectionFailureClearTrap, PYSNMP_MODULE_ID=apDDModule, apDdDiameterAgentOriginHostName=apDdDiameterAgentOriginHostName, apDdServerTransCPActive=apDdServerTransCPActive, apDdAgentDnsResponsesRecent=apDdAgentDnsResponsesRecent, apDDNotificationGroups=apDDNotificationGroups, apDdAgentDnsServerErrorsPerMax=apDdAgentDnsServerErrorsPerMax, apDdSessEstablishedPeriodTotal=apDdSessEstablishedPeriodTotal, apDdUnsubscribePeriodActive=apDdUnsubscribePeriodActive, apDdSessMissLifePerMax=apDdSessMissLifePerMax, apDDModule=apDDModule, apDdSessEstablishedPeriodHigh=apDdSessEstablishedPeriodHigh, apDdDnsQueriesTotal=apDdDnsQueriesTotal, apDdDnsCacheHitsTotal=apDdDnsCacheHitsTotal, apDdInterfaceIndex=apDdInterfaceIndex, apDdPolicyHitPeriodActive=apDdPolicyHitPeriodActive, apDdSessEstablishedLifeHigh=apDdSessEstablishedLifeHigh, apDdMsgReturnCodeClientTotal=apDdMsgReturnCodeClientTotal, apDdDnsServerErrorsRecent=apDdDnsServerErrorsRecent, apDdAgentMsgReturnCodeServerRecent=apDdAgentMsgReturnCodeServerRecent, apDdServerTransLTPerMax=apDdServerTransLTPerMax, apDdSessErrorsPeriodTotal=apDdSessErrorsPeriodTotal, apDdDnsCacheMissesRecent=apDdDnsCacheMissesRecent, apDdAgentMsgTypeServerRetransRecent=apDdAgentMsgTypeServerRetransRecent, apDdClientTransLTHigh=apDdClientTransLTHigh, apDdDnsCacheHitsRecent=apDdDnsCacheHitsRecent, apDdAgentRejectedMsgPerMax=apDdAgentRejectedMsgPerMax, apDdAgentMsgTypeServerReqTotal=apDdAgentMsgTypeServerReqTotal, apDdPolicyMissPeriodActive=apDdPolicyMissPeriodActive, apDdInterfaceStatus=apDdInterfaceStatus, apDdAgentGenConnectsLTHigh=apDdAgentGenConnectsLTHigh, apDdGenSocketsCPHigh=apDdGenSocketsCPHigh, apDdSCTPIsPrimaryPath=apDdSCTPIsPrimaryPath, apDdPolicyHitLifeTotal=apDdPolicyHitLifeTotal, apDdOutboundConstraintsPerMax=apDdOutboundConstraintsPerMax, apDdAgentDnsCacheMissesTotal=apDdAgentDnsCacheMissesTotal, apDdPolicyHitPeriodHigh=apDdPolicyHitPeriodHigh, apDdAgentStatsTable=apDdAgentStatsTable, apDdAgentClientTransLTTotal=apDdAgentClientTransLTTotal)
