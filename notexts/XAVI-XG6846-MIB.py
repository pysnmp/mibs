...
Gauge32, NotificationType, Bits, snmpModules, Unsigned32, Counter32, iso, Counter64, TimeTicks, Integer32, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, enterprises, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "Bits", "snmpModules", "Unsigned32", "Counter32", "iso", "Counter64", "TimeTicks", "Integer32", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "enterprises", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", primaryDns=primaryDns, staticIpSubMask=staticIpSubMask, lan1=lan1, groupid=groupid, jumblan3=jumblan3, portName=portName, jumblan2=jumblan2, tftp=tftp, jumb=jumb, wanType=wanType, jumblan1=jumblan1, operStatus=operStatus, xg6846=xg6846, secondaryDns=secondaryDns, lanportspeed=lanportspeed, unicastsTransmitted=unicastsTransmitted, vendorRev=vendorRev, lanportTable=lanportTable, hostname=hostname, action=action, broadcastsTransmitted=broadcastsTransmitted, lan3=lan3, fileType=fileType, lan2=lan2, vlan=vlan, portIndex=portIndex, pauseReceived=pauseReceived, statisticTable=statisticTable, speed=speed, staticIpAddr=staticIpAddr, voltage=voltage, txPower=txPower, wan=wan, staticIpDomainName=staticIpDomainName, vendorOui=vendorOui, portPower=portPower, priority=priority, staticIpGateway=staticIpGateway, lan4=lan4, port3=port3, port2=port2, multicastsReceived=multicastsReceived, qmapping=qmapping, port1=port1, lanportIndex=lanportIndex, portStatEntry=portStatEntry, statIndex=statIndex, fcsErrorTransmitted=fcsErrorTransmitted, portmode=portmode, vlanid=vlanid, serialnum=serialnum, lanportpause=lanportpause, domainame=domainame, groupEntry=groupEntry, multicastsTransmitted=multicastsTransmitted, temperature=temperature, portEntry=portEntry, portTable=portTable, vendorPn=vendorPn, ddminfo=ddminfo, catvEnable=catvEnable, bias=bias, port4=port4, reboot=reboot, rebootEnable=rebootEnable, qmode=qmode, qosEntry=qosEntry, catv=catv, deviceinfo=deviceinfo, staticDns=staticDns, dscpEnable=dscpEnable, staticIpPrimaryDns=staticIpPrimaryDns, vendorName=vendorName, unicastsReceived=unicastsReceived, rxPower=rxPower, fcsErrorReceived=fcsErrorReceived, broadcastsReceived=broadcastsReceived, lanportName=lanportName, pauseTransmitted=pauseTransmitted, staticIpHostName=staticIpHostName, fileName=fileName, staticIpSecondaryDns=staticIpSecondaryDns, qos=qos, portStatistic=portStatistic, groupIndex=groupIndex, jumblan4=jumblan4, vlangroupTable=vlangroupTable, internetPort=internetPort, adminStatus=adminStatus, qosTable=qosTable, modeEntry=modeEntry, jumbwan=jumbwan, qosIndex=qosIndex, tftpSevIp=tftpSevIp)
