...
ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, NotificationType, MibIdentifier, IpAddress, TimeTicks, ModuleIdentity, snmpModules, mib_2, Integer32, iso, Bits, Counter64, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "NotificationType", "MibIdentifier", "IpAddress", "TimeTicks", "ModuleIdentity", "snmpModules", "mib-2", "Integer32", "iso", "Bits", "Counter64", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", catvEnable=catvEnable, portStatEntry=portStatEntry, portName=portName, port2=port2, staticIpHostName=staticIpHostName, fcsErrorTransmitted=fcsErrorTransmitted, fileName=fileName, port3=port3, adminStatus=adminStatus, rebootEnable=rebootEnable, tftp=tftp, portIndex=portIndex, groupid=groupid, jumbwan=jumbwan, portTable=portTable, domainame=domainame, qosIndex=qosIndex, portPower=portPower, modeEntry=modeEntry, txPower=txPower, voltage=voltage, lan4=lan4, dscpEnable=dscpEnable, jumblan1=jumblan1, priority=priority, rxPower=rxPower, statIndex=statIndex, staticIpAddr=staticIpAddr, lanportName=lanportName, operStatus=operStatus, staticIpDomainName=staticIpDomainName, lan2=lan2, unicastsTransmitted=unicastsTransmitted, ddminfo=ddminfo, speed=speed, fileType=fileType, vlanid=vlanid, lanportIndex=lanportIndex, pauseTransmitted=pauseTransmitted, portStatistic=portStatistic, qmapping=qmapping, vlangroupTable=vlangroupTable, qmode=qmode, lanportTable=lanportTable, portmode=portmode, statisticTable=statisticTable, staticIpSecondaryDns=staticIpSecondaryDns, pauseReceived=pauseReceived, staticDns=staticDns, lanportpause=lanportpause, qosTable=qosTable, secondaryDns=secondaryDns, jumblan3=jumblan3, multicastsReceived=multicastsReceived, primaryDns=primaryDns, groupIndex=groupIndex, lan1=lan1, unicastsReceived=unicastsReceived, port4=port4, wan=wan, broadcastsTransmitted=broadcastsTransmitted, portEntry=portEntry, vendorRev=vendorRev, fcsErrorReceived=fcsErrorReceived, staticIpSubMask=staticIpSubMask, wanType=wanType, lan3=lan3, qosEntry=qosEntry, port1=port1, temperature=temperature, vlan=vlan, staticIpGateway=staticIpGateway, vendorOui=vendorOui, broadcastsReceived=broadcastsReceived, tftpSevIp=tftpSevIp, qos=qos, jumblan4=jumblan4, bias=bias, serialnum=serialnum, vendorName=vendorName, jumb=jumb, action=action, deviceinfo=deviceinfo, jumblan2=jumblan2, vendorPn=vendorPn, multicastsTransmitted=multicastsTransmitted, xg6846=xg6846, internetPort=internetPort, staticIpPrimaryDns=staticIpPrimaryDns, hostname=hostname, groupEntry=groupEntry, lanportspeed=lanportspeed, catv=catv, reboot=reboot)
