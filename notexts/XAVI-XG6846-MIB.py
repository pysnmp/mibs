...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, MibIdentifier, TimeTicks, Gauge32, Counter32, Bits, ObjectIdentity, iso, NotificationType, snmpModules, mib_2, IpAddress, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "MibIdentifier", "TimeTicks", "Gauge32", "Counter32", "Bits", "ObjectIdentity", "iso", "NotificationType", "snmpModules", "mib-2", "IpAddress", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qosTable=qosTable, staticIpSubMask=staticIpSubMask, dscpEnable=dscpEnable, pauseTransmitted=pauseTransmitted, serialnum=serialnum, portEntry=portEntry, action=action, pauseReceived=pauseReceived, tftp=tftp, staticIpHostName=staticIpHostName, port1=port1, lanportspeed=lanportspeed, staticIpPrimaryDns=staticIpPrimaryDns, lanportpause=lanportpause, vlangroupTable=vlangroupTable, portStatistic=portStatistic, fcsErrorReceived=fcsErrorReceived, jumblan1=jumblan1, staticDns=staticDns, qosEntry=qosEntry, qmapping=qmapping, priority=priority, vendorRev=vendorRev, wan=wan, wanType=wanType, adminStatus=adminStatus, lanportName=lanportName, reboot=reboot, portTable=portTable, modeEntry=modeEntry, lanportTable=lanportTable, domainame=domainame, staticIpDomainName=staticIpDomainName, vlan=vlan, statisticTable=statisticTable, vendorPn=vendorPn, lan2=lan2, voltage=voltage, catvEnable=catvEnable, groupid=groupid, hostname=hostname, portmode=portmode, rebootEnable=rebootEnable, internetPort=internetPort, rxPower=rxPower, lan4=lan4, portStatEntry=portStatEntry, vendorName=vendorName, deviceinfo=deviceinfo, qos=qos, broadcastsTransmitted=broadcastsTransmitted, bias=bias, unicastsReceived=unicastsReceived, multicastsReceived=multicastsReceived, groupEntry=groupEntry, lanportIndex=lanportIndex, jumblan2=jumblan2, tftpSevIp=tftpSevIp, port4=port4, fileName=fileName, primaryDns=primaryDns, vlanid=vlanid, portName=portName, secondaryDns=secondaryDns, port3=port3, jumbwan=jumbwan, xg6846=xg6846, lan1=lan1, operStatus=operStatus, speed=speed, unicastsTransmitted=unicastsTransmitted, statIndex=statIndex, multicastsTransmitted=multicastsTransmitted, qosIndex=qosIndex, catv=catv, qmode=qmode, vendorOui=vendorOui, lan3=lan3, staticIpSecondaryDns=staticIpSecondaryDns, fileType=fileType, staticIpAddr=staticIpAddr, ddminfo=ddminfo, staticIpGateway=staticIpGateway, groupIndex=groupIndex, jumblan4=jumblan4, txPower=txPower, jumblan3=jumblan3, portIndex=portIndex, broadcastsReceived=broadcastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, temperature=temperature, portPower=portPower, port2=port2, jumb=jumb)
