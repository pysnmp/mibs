...
Counter64, TimeTicks, snmpModules, enterprises, iso, ObjectIdentity, ModuleIdentity, Gauge32, Unsigned32, MibIdentifier, mib_2, IpAddress, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "snmpModules", "enterprises", "iso", "ObjectIdentity", "ModuleIdentity", "Gauge32", "Unsigned32", "MibIdentifier", "mib-2", "IpAddress", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticDns=staticDns, qosIndex=qosIndex, portPower=portPower, speed=speed, tftpSevIp=tftpSevIp, portTable=portTable, voltage=voltage, serialnum=serialnum, lanportIndex=lanportIndex, adminStatus=adminStatus, secondaryDns=secondaryDns, vlan=vlan, txPower=txPower, dscpEnable=dscpEnable, pauseReceived=pauseReceived, staticIpPrimaryDns=staticIpPrimaryDns, staticIpSecondaryDns=staticIpSecondaryDns, fileName=fileName, qmapping=qmapping, lan4=lan4, unicastsReceived=unicastsReceived, wanType=wanType, vlangroupTable=vlangroupTable, multicastsTransmitted=multicastsTransmitted, pauseTransmitted=pauseTransmitted, staticIpAddr=staticIpAddr, priority=priority, fileType=fileType, vendorRev=vendorRev, portStatEntry=portStatEntry, domainame=domainame, temperature=temperature, jumblan3=jumblan3, portEntry=portEntry, lan3=lan3, primaryDns=primaryDns, vlanid=vlanid, lanportTable=lanportTable, groupEntry=groupEntry, jumblan1=jumblan1, wan=wan, lanportpause=lanportpause, staticIpSubMask=staticIpSubMask, broadcastsReceived=broadcastsReceived, vendorOui=vendorOui, rxPower=rxPower, tftp=tftp, portIndex=portIndex, statisticTable=statisticTable, multicastsReceived=multicastsReceived, port4=port4, unicastsTransmitted=unicastsTransmitted, lan1=lan1, modeEntry=modeEntry, jumblan2=jumblan2, groupIndex=groupIndex, operStatus=operStatus, staticIpGateway=staticIpGateway, staticIpDomainName=staticIpDomainName, jumb=jumb, jumblan4=jumblan4, lanportspeed=lanportspeed, broadcastsTransmitted=broadcastsTransmitted, portName=portName, action=action, fcsErrorTransmitted=fcsErrorTransmitted, vendorPn=vendorPn, qosEntry=qosEntry, reboot=reboot, ddminfo=ddminfo, qos=qos, qmode=qmode, deviceinfo=deviceinfo, rebootEnable=rebootEnable, qosTable=qosTable, catv=catv, portStatistic=portStatistic, internetPort=internetPort, jumbwan=jumbwan, bias=bias, port1=port1, portmode=portmode, lanportName=lanportName, vendorName=vendorName, catvEnable=catvEnable, fcsErrorReceived=fcsErrorReceived, lan2=lan2, port2=port2, staticIpHostName=staticIpHostName, statIndex=statIndex, groupid=groupid, xg6846=xg6846, hostname=hostname, port3=port3)
