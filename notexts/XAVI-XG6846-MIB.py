...
Counter32, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, Unsigned32, Gauge32, ObjectIdentity, mib_2, ModuleIdentity, Bits, snmpModules, TimeTicks, Integer32, enterprises, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "Unsigned32", "Gauge32", "ObjectIdentity", "mib-2", "ModuleIdentity", "Bits", "snmpModules", "TimeTicks", "Integer32", "enterprises", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", domainame=domainame, lan1=lan1, tftp=tftp, qmapping=qmapping, priority=priority, secondaryDns=secondaryDns, jumblan4=jumblan4, staticDns=staticDns, lanportTable=lanportTable, qosIndex=qosIndex, groupid=groupid, staticIpSubMask=staticIpSubMask, hostname=hostname, adminStatus=adminStatus, lanportIndex=lanportIndex, vlangroupTable=vlangroupTable, portPower=portPower, tftpSevIp=tftpSevIp, portStatEntry=portStatEntry, fcsErrorTransmitted=fcsErrorTransmitted, deviceinfo=deviceinfo, multicastsTransmitted=multicastsTransmitted, wanType=wanType, internetPort=internetPort, lan2=lan2, qosTable=qosTable, action=action, lanportspeed=lanportspeed, xg6846=xg6846, qosEntry=qosEntry, vendorName=vendorName, fileType=fileType, jumb=jumb, lan4=lan4, staticIpHostName=staticIpHostName, modeEntry=modeEntry, vendorRev=vendorRev, groupIndex=groupIndex, statisticTable=statisticTable, portName=portName, unicastsReceived=unicastsReceived, pauseReceived=pauseReceived, portmode=portmode, catvEnable=catvEnable, fcsErrorReceived=fcsErrorReceived, rxPower=rxPower, port3=port3, speed=speed, bias=bias, staticIpGateway=staticIpGateway, port4=port4, vlan=vlan, groupEntry=groupEntry, lanportName=lanportName, operStatus=operStatus, dscpEnable=dscpEnable, wan=wan, qmode=qmode, portTable=portTable, reboot=reboot, port1=port1, catv=catv, jumbwan=jumbwan, staticIpAddr=staticIpAddr, jumblan1=jumblan1, unicastsTransmitted=unicastsTransmitted, voltage=voltage, temperature=temperature, serialnum=serialnum, portStatistic=portStatistic, multicastsReceived=multicastsReceived, ddminfo=ddminfo, broadcastsReceived=broadcastsReceived, txPower=txPower, jumblan2=jumblan2, lanportpause=lanportpause, statIndex=statIndex, rebootEnable=rebootEnable, pauseTransmitted=pauseTransmitted, vlanid=vlanid, port2=port2, staticIpPrimaryDns=staticIpPrimaryDns, qos=qos, portIndex=portIndex, vendorOui=vendorOui, fileName=fileName, broadcastsTransmitted=broadcastsTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, lan3=lan3, portEntry=portEntry, jumblan3=jumblan3, vendorPn=vendorPn, primaryDns=primaryDns, staticIpDomainName=staticIpDomainName)
