...
iso, enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, Integer32, NotificationType, Counter32, Bits, Gauge32, snmpModules, Counter64, ObjectIdentity, Unsigned32, IpAddress, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "Integer32", "NotificationType", "Counter32", "Bits", "Gauge32", "snmpModules", "Counter64", "ObjectIdentity", "Unsigned32", "IpAddress", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", catv=catv, qosEntry=qosEntry, lanportIndex=lanportIndex, jumb=jumb, pauseReceived=pauseReceived, staticIpSubMask=staticIpSubMask, tftpSevIp=tftpSevIp, deviceinfo=deviceinfo, fcsErrorReceived=fcsErrorReceived, vlan=vlan, rxPower=rxPower, portEntry=portEntry, unicastsReceived=unicastsReceived, vendorRev=vendorRev, fileName=fileName, qmapping=qmapping, jumblan3=jumblan3, priority=priority, qmode=qmode, qosTable=qosTable, portPower=portPower, hostname=hostname, qos=qos, portStatEntry=portStatEntry, vendorOui=vendorOui, staticIpSecondaryDns=staticIpSecondaryDns, staticIpDomainName=staticIpDomainName, xg6846=xg6846, staticIpAddr=staticIpAddr, staticIpPrimaryDns=staticIpPrimaryDns, temperature=temperature, port1=port1, ddminfo=ddminfo, internetPort=internetPort, unicastsTransmitted=unicastsTransmitted, rebootEnable=rebootEnable, lanportTable=lanportTable, wan=wan, portmode=portmode, staticIpHostName=staticIpHostName, fcsErrorTransmitted=fcsErrorTransmitted, tftp=tftp, portIndex=portIndex, speed=speed, lan4=lan4, portName=portName, serialnum=serialnum, broadcastsTransmitted=broadcastsTransmitted, statisticTable=statisticTable, vlangroupTable=vlangroupTable, groupIndex=groupIndex, voltage=voltage, modeEntry=modeEntry, jumbwan=jumbwan, jumblan4=jumblan4, pauseTransmitted=pauseTransmitted, lanportspeed=lanportspeed, port3=port3, multicastsTransmitted=multicastsTransmitted, secondaryDns=secondaryDns, portTable=portTable, txPower=txPower, groupid=groupid, lan3=lan3, catvEnable=catvEnable, vendorName=vendorName, domainame=domainame, portStatistic=portStatistic, reboot=reboot, multicastsReceived=multicastsReceived, port2=port2, broadcastsReceived=broadcastsReceived, statIndex=statIndex, staticDns=staticDns, adminStatus=adminStatus, lanportpause=lanportpause, vendorPn=vendorPn, jumblan2=jumblan2, jumblan1=jumblan1, operStatus=operStatus, primaryDns=primaryDns, dscpEnable=dscpEnable, fileType=fileType, port4=port4, bias=bias, groupEntry=groupEntry, wanType=wanType, staticIpGateway=staticIpGateway, vlanid=vlanid, lanportName=lanportName, lan1=lan1, action=action, lan2=lan2, qosIndex=qosIndex)
