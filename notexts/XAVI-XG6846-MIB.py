...
Counter32, Counter64, NotificationType, TimeTicks, mib_2, ObjectIdentity, MibIdentifier, snmpModules, Unsigned32, Bits, ModuleIdentity, IpAddress, enterprises, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "NotificationType", "TimeTicks", "mib-2", "ObjectIdentity", "MibIdentifier", "snmpModules", "Unsigned32", "Bits", "ModuleIdentity", "IpAddress", "enterprises", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", pauseTransmitted=pauseTransmitted, xg6846=xg6846, lan2=lan2, lanportName=lanportName, primaryDns=primaryDns, vendorName=vendorName, staticIpDomainName=staticIpDomainName, lanportspeed=lanportspeed, pauseReceived=pauseReceived, deviceinfo=deviceinfo, serialnum=serialnum, portStatistic=portStatistic, wan=wan, staticIpAddr=staticIpAddr, fileName=fileName, wanType=wanType, jumblan2=jumblan2, domainame=domainame, vendorPn=vendorPn, modeEntry=modeEntry, fcsErrorTransmitted=fcsErrorTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, vlan=vlan, multicastsReceived=multicastsReceived, unicastsTransmitted=unicastsTransmitted, lanportTable=lanportTable, port2=port2, bias=bias, staticDns=staticDns, hostname=hostname, temperature=temperature, lanportpause=lanportpause, secondaryDns=secondaryDns, lanportIndex=lanportIndex, jumblan4=jumblan4, port3=port3, staticIpHostName=staticIpHostName, groupEntry=groupEntry, jumb=jumb, portIndex=portIndex, rxPower=rxPower, tftp=tftp, jumblan3=jumblan3, fcsErrorReceived=fcsErrorReceived, dscpEnable=dscpEnable, ddminfo=ddminfo, fileType=fileType, action=action, jumblan1=jumblan1, rebootEnable=rebootEnable, lan1=lan1, portEntry=portEntry, internetPort=internetPort, reboot=reboot, catv=catv, broadcastsTransmitted=broadcastsTransmitted, catvEnable=catvEnable, multicastsTransmitted=multicastsTransmitted, portName=portName, voltage=voltage, qosTable=qosTable, broadcastsReceived=broadcastsReceived, lan4=lan4, port4=port4, tftpSevIp=tftpSevIp, portTable=portTable, groupIndex=groupIndex, qosEntry=qosEntry, staticIpGateway=staticIpGateway, statisticTable=statisticTable, vlangroupTable=vlangroupTable, vendorOui=vendorOui, qos=qos, priority=priority, txPower=txPower, qosIndex=qosIndex, unicastsReceived=unicastsReceived, speed=speed, statIndex=statIndex, portStatEntry=portStatEntry, adminStatus=adminStatus, qmode=qmode, vlanid=vlanid, operStatus=operStatus, jumbwan=jumbwan, port1=port1, portPower=portPower, staticIpSubMask=staticIpSubMask, portmode=portmode, staticIpSecondaryDns=staticIpSecondaryDns, qmapping=qmapping, vendorRev=vendorRev, groupid=groupid, lan3=lan3)
