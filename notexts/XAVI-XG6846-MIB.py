...
# Produced by pysmi-1.1.8 at Thu Oct 26 10:17:12 2023
...
TimeTicks, IpAddress, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, Unsigned32, Integer32, ObjectIdentity, ModuleIdentity, enterprises, Gauge32, Counter64, mib_2, iso, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "Unsigned32", "Integer32", "ObjectIdentity", "ModuleIdentity", "enterprises", "Gauge32", "Counter64", "mib-2", "iso", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", priority=priority, temperature=temperature, groupIndex=groupIndex, pauseReceived=pauseReceived, lan4=lan4, jumb=jumb, vendorPn=vendorPn, port1=port1, port3=port3, groupid=groupid, statisticTable=statisticTable, lan1=lan1, broadcastsTransmitted=broadcastsTransmitted, vendorOui=vendorOui, voltage=voltage, vlan=vlan, portStatistic=portStatistic, tftp=tftp, jumblan3=jumblan3, portmode=portmode, multicastsTransmitted=multicastsTransmitted, broadcastsReceived=broadcastsReceived, lanportTable=lanportTable, groupEntry=groupEntry, staticIpSecondaryDns=staticIpSecondaryDns, portStatEntry=portStatEntry, adminStatus=adminStatus, domainame=domainame, portEntry=portEntry, deviceinfo=deviceinfo, lan3=lan3, portName=portName, unicastsReceived=unicastsReceived, qmapping=qmapping, staticIpGateway=staticIpGateway, qosEntry=qosEntry, rebootEnable=rebootEnable, unicastsTransmitted=unicastsTransmitted, xg6846=xg6846, port4=port4, bias=bias, hostname=hostname, serialnum=serialnum, lanportpause=lanportpause, qos=qos, secondaryDns=secondaryDns, tftpSevIp=tftpSevIp, staticDns=staticDns, reboot=reboot, staticIpDomainName=staticIpDomainName, jumblan1=jumblan1, primaryDns=primaryDns, statIndex=statIndex, fileType=fileType, qmode=qmode, vlangroupTable=vlangroupTable, dscpEnable=dscpEnable, multicastsReceived=multicastsReceived, operStatus=operStatus, rxPower=rxPower, jumblan4=jumblan4, action=action, jumbwan=jumbwan, vendorName=vendorName, port2=port2, jumblan2=jumblan2, catvEnable=catvEnable, portPower=portPower, qosTable=qosTable, vendorRev=vendorRev, fileName=fileName, fcsErrorTransmitted=fcsErrorTransmitted, staticIpAddr=staticIpAddr, catv=catv, portIndex=portIndex, pauseTransmitted=pauseTransmitted, speed=speed, modeEntry=modeEntry, qosIndex=qosIndex, wan=wan, lanportName=lanportName, fcsErrorReceived=fcsErrorReceived, internetPort=internetPort, portTable=portTable, staticIpSubMask=staticIpSubMask, staticIpHostName=staticIpHostName, vlanid=vlanid, staticIpPrimaryDns=staticIpPrimaryDns, lanportspeed=lanportspeed, txPower=txPower, ddminfo=ddminfo, lan2=lan2, wanType=wanType, lanportIndex=lanportIndex)
