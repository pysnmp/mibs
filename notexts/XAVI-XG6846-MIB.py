...
TimeTicks, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, IpAddress, ObjectIdentity, MibIdentifier, Bits, mib_2, Counter64, enterprises, Unsigned32, ModuleIdentity, Counter32, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "IpAddress", "ObjectIdentity", "MibIdentifier", "Bits", "mib-2", "Counter64", "enterprises", "Unsigned32", "ModuleIdentity", "Counter32", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", unicastsReceived=unicastsReceived, reboot=reboot, bias=bias, catv=catv, temperature=temperature, jumblan4=jumblan4, portStatistic=portStatistic, secondaryDns=secondaryDns, vlanid=vlanid, vendorPn=vendorPn, txPower=txPower, pauseTransmitted=pauseTransmitted, vendorOui=vendorOui, vlan=vlan, statisticTable=statisticTable, unicastsTransmitted=unicastsTransmitted, portTable=portTable, port2=port2, deviceinfo=deviceinfo, xg6846=xg6846, portPower=portPower, groupid=groupid, jumbwan=jumbwan, qosIndex=qosIndex, fileType=fileType, adminStatus=adminStatus, ddminfo=ddminfo, staticIpSecondaryDns=staticIpSecondaryDns, lan2=lan2, broadcastsTransmitted=broadcastsTransmitted, statIndex=statIndex, jumb=jumb, jumblan2=jumblan2, rxPower=rxPower, port1=port1, lan1=lan1, fcsErrorTransmitted=fcsErrorTransmitted, portEntry=portEntry, qmapping=qmapping, action=action, groupEntry=groupEntry, portName=portName, portIndex=portIndex, operStatus=operStatus, port3=port3, priority=priority, wan=wan, lanportpause=lanportpause, wanType=wanType, lan4=lan4, modeEntry=modeEntry, multicastsReceived=multicastsReceived, serialnum=serialnum, staticDns=staticDns, staticIpGateway=staticIpGateway, primaryDns=primaryDns, internetPort=internetPort, tftpSevIp=tftpSevIp, lan3=lan3, fileName=fileName, groupIndex=groupIndex, portmode=portmode, tftp=tftp, qosEntry=qosEntry, lanportIndex=lanportIndex, lanportspeed=lanportspeed, vendorName=vendorName, staticIpPrimaryDns=staticIpPrimaryDns, speed=speed, multicastsTransmitted=multicastsTransmitted, qos=qos, vendorRev=vendorRev, jumblan3=jumblan3, catvEnable=catvEnable, lanportTable=lanportTable, staticIpSubMask=staticIpSubMask, jumblan1=jumblan1, port4=port4, broadcastsReceived=broadcastsReceived, staticIpHostName=staticIpHostName, voltage=voltage, staticIpDomainName=staticIpDomainName, staticIpAddr=staticIpAddr, qmode=qmode, fcsErrorReceived=fcsErrorReceived, hostname=hostname, domainame=domainame, pauseReceived=pauseReceived, dscpEnable=dscpEnable, portStatEntry=portStatEntry, vlangroupTable=vlangroupTable, lanportName=lanportName, rebootEnable=rebootEnable, qosTable=qosTable)
