...
# Produced by pysmi-1.1.8 at Fri Jan  7 16:15:25 2022
...
NotificationType, iso, IpAddress, MibIdentifier, TimeTicks, Gauge32, ObjectIdentity, Unsigned32, Counter64, enterprises, Counter32, mib_2, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "IpAddress", "MibIdentifier", "TimeTicks", "Gauge32", "ObjectIdentity", "Unsigned32", "Counter64", "enterprises", "Counter32", "mib-2", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", tftpSevIp=tftpSevIp, staticIpSubMask=staticIpSubMask, jumblan4=jumblan4, rebootEnable=rebootEnable, jumb=jumb, vendorOui=vendorOui, wan=wan, fileName=fileName, portStatistic=portStatistic, pauseTransmitted=pauseTransmitted, qos=qos, lanportIndex=lanportIndex, vlanid=vlanid, rxPower=rxPower, groupIndex=groupIndex, groupEntry=groupEntry, catv=catv, broadcastsReceived=broadcastsReceived, serialnum=serialnum, xg6846=xg6846, vendorRev=vendorRev, vlan=vlan, modeEntry=modeEntry, voltage=voltage, jumblan1=jumblan1, fileType=fileType, primaryDns=primaryDns, qosEntry=qosEntry, staticIpPrimaryDns=staticIpPrimaryDns, vendorPn=vendorPn, multicastsReceived=multicastsReceived, jumblan2=jumblan2, wanType=wanType, lan4=lan4, priority=priority, domainame=domainame, internetPort=internetPort, portPower=portPower, portTable=portTable, port1=port1, portEntry=portEntry, tftp=tftp, lan3=lan3, statIndex=statIndex, fcsErrorTransmitted=fcsErrorTransmitted, vendorName=vendorName, fcsErrorReceived=fcsErrorReceived, unicastsReceived=unicastsReceived, groupid=groupid, bias=bias, catvEnable=catvEnable, speed=speed, portmode=portmode, broadcastsTransmitted=broadcastsTransmitted, unicastsTransmitted=unicastsTransmitted, operStatus=operStatus, lanportName=lanportName, multicastsTransmitted=multicastsTransmitted, staticIpHostName=staticIpHostName, qosIndex=qosIndex, lan1=lan1, lan2=lan2, qosTable=qosTable, portStatEntry=portStatEntry, portName=portName, lanportpause=lanportpause, staticIpDomainName=staticIpDomainName, lanportTable=lanportTable, vlangroupTable=vlangroupTable, jumbwan=jumbwan, deviceinfo=deviceinfo, reboot=reboot, staticIpGateway=staticIpGateway, staticDns=staticDns, adminStatus=adminStatus, hostname=hostname, ddminfo=ddminfo, staticIpAddr=staticIpAddr, temperature=temperature, dscpEnable=dscpEnable, action=action, port2=port2, lanportspeed=lanportspeed, port4=port4, qmapping=qmapping, portIndex=portIndex, txPower=txPower, jumblan3=jumblan3, staticIpSecondaryDns=staticIpSecondaryDns, pauseReceived=pauseReceived, port3=port3, statisticTable=statisticTable, qmode=qmode, secondaryDns=secondaryDns)
