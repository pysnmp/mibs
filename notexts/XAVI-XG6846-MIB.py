...
enterprises, iso, MibIdentifier, Counter64, ObjectIdentity, Bits, ModuleIdentity, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, mib_2, snmpModules, IpAddress, Unsigned32, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "iso", "MibIdentifier", "Counter64", "ObjectIdentity", "Bits", "ModuleIdentity", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "mib-2", "snmpModules", "IpAddress", "Unsigned32", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", reboot=reboot, deviceinfo=deviceinfo, staticIpSubMask=staticIpSubMask, unicastsReceived=unicastsReceived, txPower=txPower, staticIpPrimaryDns=staticIpPrimaryDns, jumblan2=jumblan2, lanportspeed=lanportspeed, adminStatus=adminStatus, lan2=lan2, fileType=fileType, portName=portName, priority=priority, fcsErrorReceived=fcsErrorReceived, staticDns=staticDns, qosEntry=qosEntry, staticIpHostName=staticIpHostName, lanportTable=lanportTable, secondaryDns=secondaryDns, lanportIndex=lanportIndex, groupEntry=groupEntry, tftp=tftp, voltage=voltage, lan4=lan4, xg6846=xg6846, pauseTransmitted=pauseTransmitted, qmapping=qmapping, portStatistic=portStatistic, statisticTable=statisticTable, wanType=wanType, vlan=vlan, internetPort=internetPort, jumblan4=jumblan4, staticIpAddr=staticIpAddr, rebootEnable=rebootEnable, fileName=fileName, catvEnable=catvEnable, staticIpGateway=staticIpGateway, lanportpause=lanportpause, primaryDns=primaryDns, fcsErrorTransmitted=fcsErrorTransmitted, vendorOui=vendorOui, multicastsReceived=multicastsReceived, qosIndex=qosIndex, tftpSevIp=tftpSevIp, rxPower=rxPower, qosTable=qosTable, temperature=temperature, jumb=jumb, bias=bias, portStatEntry=portStatEntry, statIndex=statIndex, vendorPn=vendorPn, portPower=portPower, action=action, jumblan3=jumblan3, staticIpDomainName=staticIpDomainName, broadcastsReceived=broadcastsReceived, lanportName=lanportName, groupIndex=groupIndex, lan3=lan3, portIndex=portIndex, broadcastsTransmitted=broadcastsTransmitted, wan=wan, multicastsTransmitted=multicastsTransmitted, qos=qos, hostname=hostname, port2=port2, qmode=qmode, vendorName=vendorName, operStatus=operStatus, ddminfo=ddminfo, vlangroupTable=vlangroupTable, portTable=portTable, portmode=portmode, modeEntry=modeEntry, port3=port3, dscpEnable=dscpEnable, portEntry=portEntry, port4=port4, staticIpSecondaryDns=staticIpSecondaryDns, serialnum=serialnum, catv=catv, port1=port1, lan1=lan1, vendorRev=vendorRev, vlanid=vlanid, jumbwan=jumbwan, unicastsTransmitted=unicastsTransmitted, speed=speed, jumblan1=jumblan1, groupid=groupid, domainame=domainame, pauseReceived=pauseReceived)
