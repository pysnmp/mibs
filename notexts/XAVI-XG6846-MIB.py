...
# Produced by pysmi-1.1.12 at Wed Dec  4 21:17:02 2024
...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Integer32, Bits, snmpModules, ModuleIdentity, ObjectIdentity, MibIdentifier, TimeTicks, IpAddress, Counter32, NotificationType, Counter64, Gauge32, Unsigned32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Integer32", "Bits", "snmpModules", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "TimeTicks", "IpAddress", "Counter32", "NotificationType", "Counter64", "Gauge32", "Unsigned32", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", broadcastsTransmitted=broadcastsTransmitted, vendorName=vendorName, ddminfo=ddminfo, jumbwan=jumbwan, fcsErrorReceived=fcsErrorReceived, multicastsTransmitted=multicastsTransmitted, portEntry=portEntry, secondaryDns=secondaryDns, xg6846=xg6846, groupEntry=groupEntry, groupid=groupid, jumblan4=jumblan4, dscpEnable=dscpEnable, reboot=reboot, qmode=qmode, statIndex=statIndex, vendorRev=vendorRev, staticIpHostName=staticIpHostName, vendorOui=vendorOui, portStatEntry=portStatEntry, lanportspeed=lanportspeed, vendorPn=vendorPn, vlanid=vlanid, staticIpPrimaryDns=staticIpPrimaryDns, wan=wan, tftp=tftp, port2=port2, qmapping=qmapping, pauseTransmitted=pauseTransmitted, portPower=portPower, internetPort=internetPort, bias=bias, lan3=lan3, catv=catv, serialnum=serialnum, groupIndex=groupIndex, deviceinfo=deviceinfo, fileType=fileType, portIndex=portIndex, port4=port4, tftpSevIp=tftpSevIp, portTable=portTable, portName=portName, vlan=vlan, modeEntry=modeEntry, lan1=lan1, operStatus=operStatus, jumblan3=jumblan3, priority=priority, lan2=lan2, lan4=lan4, action=action, jumblan1=jumblan1, staticIpAddr=staticIpAddr, lanportIndex=lanportIndex, multicastsReceived=multicastsReceived, unicastsTransmitted=unicastsTransmitted, primaryDns=primaryDns, rxPower=rxPower, portStatistic=portStatistic, fileName=fileName, domainame=domainame, statisticTable=statisticTable, qosTable=qosTable, temperature=temperature, broadcastsReceived=broadcastsReceived, portmode=portmode, staticDns=staticDns, vlangroupTable=vlangroupTable, fcsErrorTransmitted=fcsErrorTransmitted, jumblan2=jumblan2, staticIpSecondaryDns=staticIpSecondaryDns, pauseReceived=pauseReceived, hostname=hostname, lanportTable=lanportTable, qosIndex=qosIndex, qos=qos, unicastsReceived=unicastsReceived, staticIpGateway=staticIpGateway, staticIpSubMask=staticIpSubMask, staticIpDomainName=staticIpDomainName, rebootEnable=rebootEnable, wanType=wanType, qosEntry=qosEntry, txPower=txPower, catvEnable=catvEnable, port1=port1, jumb=jumb, adminStatus=adminStatus, lanportpause=lanportpause, lanportName=lanportName, voltage=voltage, port3=port3, speed=speed)
