...
ModuleIdentity, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, Bits, NotificationType, IpAddress, Integer32, Gauge32, ObjectIdentity, mib_2, iso, snmpModules, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "Bits", "NotificationType", "IpAddress", "Integer32", "Gauge32", "ObjectIdentity", "mib-2", "iso", "snmpModules", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", internetPort=internetPort, catvEnable=catvEnable, priority=priority, secondaryDns=secondaryDns, rxPower=rxPower, multicastsTransmitted=multicastsTransmitted, portTable=portTable, lan4=lan4, domainame=domainame, lanportIndex=lanportIndex, lanportTable=lanportTable, bias=bias, portPower=portPower, portStatistic=portStatistic, pauseReceived=pauseReceived, port2=port2, wan=wan, adminStatus=adminStatus, multicastsReceived=multicastsReceived, action=action, portStatEntry=portStatEntry, groupid=groupid, staticIpDomainName=staticIpDomainName, staticIpSubMask=staticIpSubMask, primaryDns=primaryDns, vendorRev=vendorRev, qmode=qmode, lan2=lan2, port3=port3, jumblan1=jumblan1, serialnum=serialnum, operStatus=operStatus, wanType=wanType, unicastsTransmitted=unicastsTransmitted, portName=portName, fcsErrorReceived=fcsErrorReceived, lan1=lan1, lanportspeed=lanportspeed, hostname=hostname, lan3=lan3, lanportpause=lanportpause, reboot=reboot, voltage=voltage, staticIpPrimaryDns=staticIpPrimaryDns, fcsErrorTransmitted=fcsErrorTransmitted, qos=qos, statisticTable=statisticTable, staticIpHostName=staticIpHostName, fileName=fileName, groupEntry=groupEntry, port1=port1, deviceinfo=deviceinfo, unicastsReceived=unicastsReceived, vendorOui=vendorOui, qmapping=qmapping, speed=speed, port4=port4, qosEntry=qosEntry, jumb=jumb, catv=catv, staticIpAddr=staticIpAddr, statIndex=statIndex, broadcastsReceived=broadcastsReceived, txPower=txPower, xg6846=xg6846, modeEntry=modeEntry, dscpEnable=dscpEnable, tftp=tftp, portIndex=portIndex, pauseTransmitted=pauseTransmitted, jumblan3=jumblan3, staticDns=staticDns, vendorPn=vendorPn, portEntry=portEntry, qosIndex=qosIndex, vlangroupTable=vlangroupTable, vlan=vlan, temperature=temperature, tftpSevIp=tftpSevIp, jumblan2=jumblan2, vlanid=vlanid, staticIpGateway=staticIpGateway, vendorName=vendorName, rebootEnable=rebootEnable, ddminfo=ddminfo, jumblan4=jumblan4, lanportName=lanportName, fileType=fileType, qosTable=qosTable, portmode=portmode, groupIndex=groupIndex, jumbwan=jumbwan, broadcastsTransmitted=broadcastsTransmitted, staticIpSecondaryDns=staticIpSecondaryDns)
