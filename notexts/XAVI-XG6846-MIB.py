...
# Produced by pysmi-1.1.3 at Wed Dec  8 17:23:48 2021
...
mib_2, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, Bits, MibIdentifier, ModuleIdentity, snmpModules, IpAddress, Counter32, Integer32, iso, Unsigned32, Counter64, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "Bits", "MibIdentifier", "ModuleIdentity", "snmpModules", "IpAddress", "Counter32", "Integer32", "iso", "Unsigned32", "Counter64", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", groupIndex=groupIndex, fcsErrorTransmitted=fcsErrorTransmitted, tftpSevIp=tftpSevIp, reboot=reboot, vendorName=vendorName, action=action, rebootEnable=rebootEnable, qmapping=qmapping, staticIpSubMask=staticIpSubMask, lanportName=lanportName, portStatistic=portStatistic, pauseTransmitted=pauseTransmitted, ddminfo=ddminfo, lanportpause=lanportpause, vlanid=vlanid, portName=portName, vendorRev=vendorRev, lan2=lan2, vendorOui=vendorOui, lan4=lan4, hostname=hostname, staticIpPrimaryDns=staticIpPrimaryDns, qosIndex=qosIndex, lanportIndex=lanportIndex, domainame=domainame, modeEntry=modeEntry, groupid=groupid, deviceinfo=deviceinfo, qosTable=qosTable, portTable=portTable, lan3=lan3, port1=port1, portEntry=portEntry, staticIpSecondaryDns=staticIpSecondaryDns, txPower=txPower, tftp=tftp, xg6846=xg6846, portmode=portmode, portStatEntry=portStatEntry, lanportspeed=lanportspeed, operStatus=operStatus, jumb=jumb, jumblan3=jumblan3, jumblan4=jumblan4, qmode=qmode, unicastsReceived=unicastsReceived, staticIpHostName=staticIpHostName, wanType=wanType, port3=port3, groupEntry=groupEntry, statisticTable=statisticTable, speed=speed, fileName=fileName, bias=bias, wan=wan, catv=catv, multicastsReceived=multicastsReceived, pauseReceived=pauseReceived, staticIpAddr=staticIpAddr, staticIpDomainName=staticIpDomainName, lanportTable=lanportTable, jumbwan=jumbwan, unicastsTransmitted=unicastsTransmitted, portIndex=portIndex, portPower=portPower, jumblan1=jumblan1, vlan=vlan, rxPower=rxPower, fcsErrorReceived=fcsErrorReceived, secondaryDns=secondaryDns, port2=port2, qosEntry=qosEntry, primaryDns=primaryDns, staticIpGateway=staticIpGateway, dscpEnable=dscpEnable, voltage=voltage, priority=priority, vendorPn=vendorPn, serialnum=serialnum, staticDns=staticDns, broadcastsReceived=broadcastsReceived, qos=qos, broadcastsTransmitted=broadcastsTransmitted, fileType=fileType, multicastsTransmitted=multicastsTransmitted, lan1=lan1, catvEnable=catvEnable, statIndex=statIndex, port4=port4, jumblan2=jumblan2, adminStatus=adminStatus, temperature=temperature, internetPort=internetPort, vlangroupTable=vlangroupTable)
