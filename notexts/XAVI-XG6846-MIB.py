...
# Produced by pysmi-1.1.8 at Thu Apr 27 09:20:19 2023
...
iso, MibIdentifier, Bits, Counter64, Unsigned32, IpAddress, ModuleIdentity, enterprises, snmpModules, Integer32, NotificationType, Gauge32, TimeTicks, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "Bits", "Counter64", "Unsigned32", "IpAddress", "ModuleIdentity", "enterprises", "snmpModules", "Integer32", "NotificationType", "Gauge32", "TimeTicks", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorOui=vendorOui, modeEntry=modeEntry, groupIndex=groupIndex, jumblan2=jumblan2, vlan=vlan, vlanid=vlanid, jumbwan=jumbwan, staticIpSecondaryDns=staticIpSecondaryDns, unicastsReceived=unicastsReceived, vendorRev=vendorRev, port4=port4, lanportspeed=lanportspeed, lanportpause=lanportpause, staticIpPrimaryDns=staticIpPrimaryDns, statisticTable=statisticTable, txPower=txPower, jumblan1=jumblan1, pauseReceived=pauseReceived, fileName=fileName, lan4=lan4, portName=portName, hostname=hostname, jumblan4=jumblan4, pauseTransmitted=pauseTransmitted, staticDns=staticDns, staticIpDomainName=staticIpDomainName, operStatus=operStatus, port3=port3, staticIpSubMask=staticIpSubMask, lan1=lan1, fcsErrorTransmitted=fcsErrorTransmitted, domainame=domainame, voltage=voltage, multicastsReceived=multicastsReceived, portPower=portPower, lanportIndex=lanportIndex, xg6846=xg6846, qosIndex=qosIndex, qmapping=qmapping, bias=bias, deviceinfo=deviceinfo, fcsErrorReceived=fcsErrorReceived, fileType=fileType, portStatistic=portStatistic, wanType=wanType, port1=port1, multicastsTransmitted=multicastsTransmitted, rebootEnable=rebootEnable, lan3=lan3, tftp=tftp, qmode=qmode, broadcastsReceived=broadcastsReceived, catv=catv, portmode=portmode, rxPower=rxPower, portEntry=portEntry, vlangroupTable=vlangroupTable, portTable=portTable, jumblan3=jumblan3, groupid=groupid, broadcastsTransmitted=broadcastsTransmitted, serialnum=serialnum, priority=priority, temperature=temperature, internetPort=internetPort, tftpSevIp=tftpSevIp, wan=wan, qosTable=qosTable, dscpEnable=dscpEnable, lanportTable=lanportTable, speed=speed, qosEntry=qosEntry, vendorPn=vendorPn, statIndex=statIndex, ddminfo=ddminfo, unicastsTransmitted=unicastsTransmitted, action=action, port2=port2, lanportName=lanportName, groupEntry=groupEntry, staticIpAddr=staticIpAddr, reboot=reboot, adminStatus=adminStatus, staticIpGateway=staticIpGateway, vendorName=vendorName, staticIpHostName=staticIpHostName, primaryDns=primaryDns, portIndex=portIndex, lan2=lan2, secondaryDns=secondaryDns, jumb=jumb, portStatEntry=portStatEntry, qos=qos, catvEnable=catvEnable)
