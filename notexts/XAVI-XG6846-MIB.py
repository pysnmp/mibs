...
Bits, Unsigned32, Counter64, NotificationType, snmpModules, iso, enterprises, TimeTicks, Integer32, ObjectIdentity, MibIdentifier, Gauge32, mib_2, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "Counter64", "NotificationType", "snmpModules", "iso", "enterprises", "TimeTicks", "Integer32", "ObjectIdentity", "MibIdentifier", "Gauge32", "mib-2", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", wan=wan, secondaryDns=secondaryDns, port2=port2, dscpEnable=dscpEnable, port4=port4, jumblan3=jumblan3, speed=speed, vendorOui=vendorOui, portIndex=portIndex, lanportpause=lanportpause, vlanid=vlanid, qosEntry=qosEntry, catvEnable=catvEnable, operStatus=operStatus, jumbwan=jumbwan, port1=port1, qosIndex=qosIndex, temperature=temperature, portmode=portmode, staticIpSecondaryDns=staticIpSecondaryDns, qmapping=qmapping, xg6846=xg6846, lanportIndex=lanportIndex, modeEntry=modeEntry, hostname=hostname, voltage=voltage, rebootEnable=rebootEnable, lanportTable=lanportTable, vlan=vlan, groupid=groupid, fcsErrorTransmitted=fcsErrorTransmitted, staticIpGateway=staticIpGateway, unicastsTransmitted=unicastsTransmitted, multicastsTransmitted=multicastsTransmitted, qosTable=qosTable, groupIndex=groupIndex, rxPower=rxPower, lan1=lan1, statisticTable=statisticTable, portPower=portPower, staticDns=staticDns, staticIpAddr=staticIpAddr, portEntry=portEntry, jumblan2=jumblan2, tftpSevIp=tftpSevIp, vendorRev=vendorRev, bias=bias, pauseReceived=pauseReceived, portStatistic=portStatistic, jumblan1=jumblan1, ddminfo=ddminfo, lanportName=lanportName, domainame=domainame, priority=priority, deviceinfo=deviceinfo, broadcastsReceived=broadcastsReceived, fcsErrorReceived=fcsErrorReceived, catv=catv, pauseTransmitted=pauseTransmitted, wanType=wanType, internetPort=internetPort, lan4=lan4, lan2=lan2, reboot=reboot, broadcastsTransmitted=broadcastsTransmitted, serialnum=serialnum, txPower=txPower, qos=qos, lan3=lan3, portTable=portTable, adminStatus=adminStatus, qmode=qmode, fileType=fileType, unicastsReceived=unicastsReceived, vendorName=vendorName, vendorPn=vendorPn, primaryDns=primaryDns, jumblan4=jumblan4, lanportspeed=lanportspeed, portStatEntry=portStatEntry, fileName=fileName, action=action, portName=portName, multicastsReceived=multicastsReceived, staticIpHostName=staticIpHostName, staticIpSubMask=staticIpSubMask, vlangroupTable=vlangroupTable, groupEntry=groupEntry, staticIpDomainName=staticIpDomainName, port3=port3, tftp=tftp, jumb=jumb, statIndex=statIndex, staticIpPrimaryDns=staticIpPrimaryDns)
