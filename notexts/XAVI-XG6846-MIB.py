...
TimeTicks, IpAddress, enterprises, Integer32, Bits, Gauge32, NotificationType, Unsigned32, snmpModules, MibIdentifier, Counter32, Counter64, ModuleIdentity, ObjectIdentity, mib_2, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "enterprises", "Integer32", "Bits", "Gauge32", "NotificationType", "Unsigned32", "snmpModules", "MibIdentifier", "Counter32", "Counter64", "ModuleIdentity", "ObjectIdentity", "mib-2", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpSubMask=staticIpSubMask, vlan=vlan, catv=catv, portStatistic=portStatistic, catvEnable=catvEnable, qmapping=qmapping, tftp=tftp, deviceinfo=deviceinfo, bias=bias, lan3=lan3, wanType=wanType, multicastsTransmitted=multicastsTransmitted, lan4=lan4, jumblan1=jumblan1, portStatEntry=portStatEntry, vendorPn=vendorPn, fcsErrorReceived=fcsErrorReceived, speed=speed, port3=port3, jumblan2=jumblan2, hostname=hostname, lan2=lan2, portEntry=portEntry, qosTable=qosTable, priority=priority, voltage=voltage, staticIpDomainName=staticIpDomainName, statIndex=statIndex, lanportIndex=lanportIndex, adminStatus=adminStatus, action=action, staticIpGateway=staticIpGateway, operStatus=operStatus, serialnum=serialnum, jumbwan=jumbwan, tftpSevIp=tftpSevIp, multicastsReceived=multicastsReceived, vlanid=vlanid, staticDns=staticDns, statisticTable=statisticTable, secondaryDns=secondaryDns, rebootEnable=rebootEnable, unicastsReceived=unicastsReceived, port2=port2, qosEntry=qosEntry, reboot=reboot, vendorName=vendorName, temperature=temperature, port1=port1, unicastsTransmitted=unicastsTransmitted, fileType=fileType, portName=portName, lanportpause=lanportpause, lanportspeed=lanportspeed, vendorRev=vendorRev, lanportName=lanportName, xg6846=xg6846, fileName=fileName, broadcastsTransmitted=broadcastsTransmitted, domainame=domainame, qmode=qmode, jumb=jumb, primaryDns=primaryDns, staticIpHostName=staticIpHostName, pauseReceived=pauseReceived, txPower=txPower, fcsErrorTransmitted=fcsErrorTransmitted, lanportTable=lanportTable, dscpEnable=dscpEnable, jumblan3=jumblan3, groupEntry=groupEntry, jumblan4=jumblan4, lan1=lan1, portIndex=portIndex, vendorOui=vendorOui, portPower=portPower, vlangroupTable=vlangroupTable, broadcastsReceived=broadcastsReceived, pauseTransmitted=pauseTransmitted, ddminfo=ddminfo, modeEntry=modeEntry, portTable=portTable, groupIndex=groupIndex, qos=qos, wan=wan, staticIpPrimaryDns=staticIpPrimaryDns, qosIndex=qosIndex, port4=port4, rxPower=rxPower, portmode=portmode, staticIpAddr=staticIpAddr, internetPort=internetPort, groupid=groupid, staticIpSecondaryDns=staticIpSecondaryDns)
