...
# Produced by pysmi-1.1.8 at Tue Jul 26 16:20:04 2022
...
Gauge32, enterprises, MibIdentifier, TimeTicks, mib_2, iso, Bits, ModuleIdentity, Integer32, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, snmpModules, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "MibIdentifier", "TimeTicks", "mib-2", "iso", "Bits", "ModuleIdentity", "Integer32", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "snmpModules", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portPower=portPower, staticIpSubMask=staticIpSubMask, vlangroupTable=vlangroupTable, unicastsReceived=unicastsReceived, statisticTable=statisticTable, tftpSevIp=tftpSevIp, vendorPn=vendorPn, jumblan4=jumblan4, wanType=wanType, lanportTable=lanportTable, xg6846=xg6846, ddminfo=ddminfo, port1=port1, lanportName=lanportName, voltage=voltage, port2=port2, unicastsTransmitted=unicastsTransmitted, groupIndex=groupIndex, vlanid=vlanid, temperature=temperature, fcsErrorTransmitted=fcsErrorTransmitted, txPower=txPower, portmode=portmode, staticIpSecondaryDns=staticIpSecondaryDns, jumblan2=jumblan2, primaryDns=primaryDns, multicastsTransmitted=multicastsTransmitted, broadcastsTransmitted=broadcastsTransmitted, qmapping=qmapping, lan4=lan4, portName=portName, broadcastsReceived=broadcastsReceived, lan1=lan1, vendorRev=vendorRev, pauseReceived=pauseReceived, jumblan3=jumblan3, staticIpAddr=staticIpAddr, adminStatus=adminStatus, wan=wan, bias=bias, vlan=vlan, qosIndex=qosIndex, lan2=lan2, multicastsReceived=multicastsReceived, vendorName=vendorName, qosEntry=qosEntry, internetPort=internetPort, rebootEnable=rebootEnable, tftp=tftp, port4=port4, staticIpPrimaryDns=staticIpPrimaryDns, serialnum=serialnum, port3=port3, jumblan1=jumblan1, staticIpDomainName=staticIpDomainName, fcsErrorReceived=fcsErrorReceived, speed=speed, lan3=lan3, lanportspeed=lanportspeed, rxPower=rxPower, operStatus=operStatus, priority=priority, statIndex=statIndex, modeEntry=modeEntry, vendorOui=vendorOui, portEntry=portEntry, action=action, staticIpHostName=staticIpHostName, hostname=hostname, catvEnable=catvEnable, portTable=portTable, staticIpGateway=staticIpGateway, jumb=jumb, domainame=domainame, groupEntry=groupEntry, staticDns=staticDns, jumbwan=jumbwan, qmode=qmode, reboot=reboot, portIndex=portIndex, pauseTransmitted=pauseTransmitted, secondaryDns=secondaryDns, lanportpause=lanportpause, dscpEnable=dscpEnable, fileType=fileType, groupid=groupid, deviceinfo=deviceinfo, portStatEntry=portStatEntry, lanportIndex=lanportIndex, catv=catv, qos=qos, fileName=fileName, portStatistic=portStatistic, qosTable=qosTable)
