...
Counter32, Bits, mib_2, Gauge32, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, iso, ModuleIdentity, ObjectIdentity, snmpModules, Unsigned32, MibIdentifier, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "mib-2", "Gauge32", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "iso", "ModuleIdentity", "ObjectIdentity", "snmpModules", "Unsigned32", "MibIdentifier", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorRev=vendorRev, tftpSevIp=tftpSevIp, bias=bias, staticIpSecondaryDns=staticIpSecondaryDns, fcsErrorTransmitted=fcsErrorTransmitted, priority=priority, action=action, port3=port3, lan4=lan4, statIndex=statIndex, qosIndex=qosIndex, rxPower=rxPower, voltage=voltage, adminStatus=adminStatus, catv=catv, qos=qos, pauseTransmitted=pauseTransmitted, portPower=portPower, dscpEnable=dscpEnable, lanportIndex=lanportIndex, portEntry=portEntry, lanportspeed=lanportspeed, groupid=groupid, hostname=hostname, pauseReceived=pauseReceived, qmapping=qmapping, multicastsTransmitted=multicastsTransmitted, internetPort=internetPort, domainame=domainame, temperature=temperature, staticIpPrimaryDns=staticIpPrimaryDns, vlanid=vlanid, wanType=wanType, xg6846=xg6846, jumblan4=jumblan4, fcsErrorReceived=fcsErrorReceived, fileName=fileName, reboot=reboot, speed=speed, port2=port2, catvEnable=catvEnable, lanportName=lanportName, staticDns=staticDns, vendorOui=vendorOui, lan2=lan2, portStatEntry=portStatEntry, jumb=jumb, primaryDns=primaryDns, portmode=portmode, unicastsTransmitted=unicastsTransmitted, qosTable=qosTable, modeEntry=modeEntry, groupIndex=groupIndex, staticIpGateway=staticIpGateway, port1=port1, lanportTable=lanportTable, txPower=txPower, deviceinfo=deviceinfo, port4=port4, rebootEnable=rebootEnable, vendorName=vendorName, portIndex=portIndex, qmode=qmode, vlan=vlan, jumblan1=jumblan1, portStatistic=portStatistic, staticIpDomainName=staticIpDomainName, staticIpAddr=staticIpAddr, serialnum=serialnum, staticIpSubMask=staticIpSubMask, wan=wan, broadcastsReceived=broadcastsReceived, qosEntry=qosEntry, lanportpause=lanportpause, lan1=lan1, jumblan2=jumblan2, tftp=tftp, vendorPn=vendorPn, portTable=portTable, groupEntry=groupEntry, statisticTable=statisticTable, portName=portName, fileType=fileType, jumblan3=jumblan3, ddminfo=ddminfo, unicastsReceived=unicastsReceived, broadcastsTransmitted=broadcastsTransmitted, vlangroupTable=vlangroupTable, multicastsReceived=multicastsReceived, staticIpHostName=staticIpHostName, operStatus=operStatus, lan3=lan3, secondaryDns=secondaryDns, jumbwan=jumbwan)
