...
IpAddress, TimeTicks, Counter64, Gauge32, ObjectIdentity, Counter32, NotificationType, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, Unsigned32, ModuleIdentity, Bits, mib_2, Integer32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "Counter64", "Gauge32", "ObjectIdentity", "Counter32", "NotificationType", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "Unsigned32", "ModuleIdentity", "Bits", "mib-2", "Integer32", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portEntry=portEntry, groupIndex=groupIndex, staticIpSecondaryDns=staticIpSecondaryDns, qmapping=qmapping, fcsErrorTransmitted=fcsErrorTransmitted, lanportTable=lanportTable, jumblan3=jumblan3, staticDns=staticDns, lan4=lan4, vlan=vlan, lan3=lan3, vlanid=vlanid, voltage=voltage, portIndex=portIndex, lanportspeed=lanportspeed, groupEntry=groupEntry, ddminfo=ddminfo, broadcastsReceived=broadcastsReceived, jumblan4=jumblan4, staticIpPrimaryDns=staticIpPrimaryDns, tftpSevIp=tftpSevIp, operStatus=operStatus, deviceinfo=deviceinfo, bias=bias, qosEntry=qosEntry, reboot=reboot, fileType=fileType, jumblan2=jumblan2, qosIndex=qosIndex, domainame=domainame, groupid=groupid, unicastsTransmitted=unicastsTransmitted, vendorRev=vendorRev, unicastsReceived=unicastsReceived, staticIpSubMask=staticIpSubMask, lanportIndex=lanportIndex, broadcastsTransmitted=broadcastsTransmitted, serialnum=serialnum, action=action, pauseTransmitted=pauseTransmitted, statIndex=statIndex, primaryDns=primaryDns, vlangroupTable=vlangroupTable, lan1=lan1, portPower=portPower, catv=catv, jumb=jumb, staticIpGateway=staticIpGateway, portmode=portmode, port3=port3, dscpEnable=dscpEnable, temperature=temperature, portTable=portTable, staticIpHostName=staticIpHostName, catvEnable=catvEnable, rebootEnable=rebootEnable, lanportName=lanportName, multicastsReceived=multicastsReceived, speed=speed, lanportpause=lanportpause, port4=port4, internetPort=internetPort, txPower=txPower, pauseReceived=pauseReceived, wan=wan, port2=port2, staticIpAddr=staticIpAddr, portStatistic=portStatistic, lan2=lan2, modeEntry=modeEntry, priority=priority, fcsErrorReceived=fcsErrorReceived, port1=port1, vendorName=vendorName, rxPower=rxPower, fileName=fileName, adminStatus=adminStatus, jumbwan=jumbwan, tftp=tftp, jumblan1=jumblan1, qos=qos, secondaryDns=secondaryDns, portStatEntry=portStatEntry, statisticTable=statisticTable, vendorOui=vendorOui, portName=portName, vendorPn=vendorPn, staticIpDomainName=staticIpDomainName, wanType=wanType, hostname=hostname, xg6846=xg6846, qosTable=qosTable, qmode=qmode, multicastsTransmitted=multicastsTransmitted)
