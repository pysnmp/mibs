...
# Produced by pysmi-1.1.12 at Tue May 21 06:58:02 2024
...
snmpModules, IpAddress, Integer32, TimeTicks, ModuleIdentity, mib_2, Counter64, NotificationType, enterprises, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ObjectIdentity, Bits, iso, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "IpAddress", "Integer32", "TimeTicks", "ModuleIdentity", "mib-2", "Counter64", "NotificationType", "enterprises", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ObjectIdentity", "Bits", "iso", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", pauseTransmitted=pauseTransmitted, pauseReceived=pauseReceived, port4=port4, portTable=portTable, multicastsReceived=multicastsReceived, staticIpPrimaryDns=staticIpPrimaryDns, vendorRev=vendorRev, qosIndex=qosIndex, portEntry=portEntry, jumblan3=jumblan3, modeEntry=modeEntry, fcsErrorReceived=fcsErrorReceived, jumb=jumb, statisticTable=statisticTable, fcsErrorTransmitted=fcsErrorTransmitted, staticIpAddr=staticIpAddr, vlanid=vlanid, broadcastsReceived=broadcastsReceived, groupIndex=groupIndex, qmapping=qmapping, dscpEnable=dscpEnable, ddminfo=ddminfo, speed=speed, staticIpGateway=staticIpGateway, deviceinfo=deviceinfo, staticDns=staticDns, jumblan2=jumblan2, lan4=lan4, rebootEnable=rebootEnable, jumblan4=jumblan4, lanportTable=lanportTable, domainame=domainame, tftpSevIp=tftpSevIp, lanportspeed=lanportspeed, lan1=lan1, reboot=reboot, qos=qos, xg6846=xg6846, priority=priority, fileName=fileName, broadcastsTransmitted=broadcastsTransmitted, lanportIndex=lanportIndex, port3=port3, staticIpHostName=staticIpHostName, qosEntry=qosEntry, port2=port2, adminStatus=adminStatus, staticIpDomainName=staticIpDomainName, port1=port1, primaryDns=primaryDns, portStatistic=portStatistic, vendorName=vendorName, portIndex=portIndex, bias=bias, jumblan1=jumblan1, qmode=qmode, portmode=portmode, catvEnable=catvEnable, portStatEntry=portStatEntry, unicastsReceived=unicastsReceived, staticIpSubMask=staticIpSubMask, multicastsTransmitted=multicastsTransmitted, groupid=groupid, tftp=tftp, vendorPn=vendorPn, secondaryDns=secondaryDns, staticIpSecondaryDns=staticIpSecondaryDns, qosTable=qosTable, vlan=vlan, internetPort=internetPort, groupEntry=groupEntry, serialnum=serialnum, temperature=temperature, vendorOui=vendorOui, action=action, txPower=txPower, voltage=voltage, catv=catv, hostname=hostname, lan2=lan2, lanportpause=lanportpause, unicastsTransmitted=unicastsTransmitted, rxPower=rxPower, statIndex=statIndex, lanportName=lanportName, wanType=wanType, vlangroupTable=vlangroupTable, fileType=fileType, jumbwan=jumbwan, wan=wan, lan3=lan3, operStatus=operStatus, portPower=portPower, portName=portName)
