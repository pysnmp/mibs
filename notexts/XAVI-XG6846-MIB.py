...
# Produced by pysmi-1.1.12 at Wed Jul  3 09:13:37 2024
...
mib_2, Counter32, ModuleIdentity, TimeTicks, IpAddress, snmpModules, Counter64, ObjectIdentity, Integer32, Bits, enterprises, Gauge32, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Counter32", "ModuleIdentity", "TimeTicks", "IpAddress", "snmpModules", "Counter64", "ObjectIdentity", "Integer32", "Bits", "enterprises", "Gauge32", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpDomainName=staticIpDomainName, lan1=lan1, multicastsTransmitted=multicastsTransmitted, groupid=groupid, groupEntry=groupEntry, tftpSevIp=tftpSevIp, portEntry=portEntry, qosEntry=qosEntry, wanType=wanType, bias=bias, staticDns=staticDns, lanportTable=lanportTable, portStatEntry=portStatEntry, priority=priority, reboot=reboot, temperature=temperature, deviceinfo=deviceinfo, speed=speed, domainame=domainame, qos=qos, staticIpAddr=staticIpAddr, pauseReceived=pauseReceived, portStatistic=portStatistic, qosIndex=qosIndex, unicastsTransmitted=unicastsTransmitted, lan3=lan3, lanportIndex=lanportIndex, catvEnable=catvEnable, rebootEnable=rebootEnable, unicastsReceived=unicastsReceived, primaryDns=primaryDns, lan2=lan2, jumblan1=jumblan1, staticIpSecondaryDns=staticIpSecondaryDns, multicastsReceived=multicastsReceived, groupIndex=groupIndex, pauseTransmitted=pauseTransmitted, vendorName=vendorName, modeEntry=modeEntry, secondaryDns=secondaryDns, port2=port2, jumb=jumb, portPower=portPower, vendorOui=vendorOui, txPower=txPower, internetPort=internetPort, jumbwan=jumbwan, serialnum=serialnum, vlanid=vlanid, statIndex=statIndex, xg6846=xg6846, voltage=voltage, broadcastsTransmitted=broadcastsTransmitted, qmode=qmode, jumblan4=jumblan4, qosTable=qosTable, tftp=tftp, staticIpGateway=staticIpGateway, statisticTable=statisticTable, vlan=vlan, fcsErrorReceived=fcsErrorReceived, fcsErrorTransmitted=fcsErrorTransmitted, adminStatus=adminStatus, qmapping=qmapping, portIndex=portIndex, broadcastsReceived=broadcastsReceived, port4=port4, staticIpHostName=staticIpHostName, operStatus=operStatus, lanportspeed=lanportspeed, fileName=fileName, portTable=portTable, staticIpPrimaryDns=staticIpPrimaryDns, hostname=hostname, lanportName=lanportName, vendorRev=vendorRev, fileType=fileType, ddminfo=ddminfo, portName=portName, port1=port1, port3=port3, portmode=portmode, lanportpause=lanportpause, jumblan2=jumblan2, vlangroupTable=vlangroupTable, rxPower=rxPower, dscpEnable=dscpEnable, lan4=lan4, vendorPn=vendorPn, action=action, wan=wan, staticIpSubMask=staticIpSubMask, catv=catv, jumblan3=jumblan3)
