...
# Produced by pysmi-1.1.12 at Tue Jun 18 02:36:47 2024
...
mib_2, IpAddress, Unsigned32, Integer32, Counter64, iso, snmpModules, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, enterprises, NotificationType, Bits, TimeTicks, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "IpAddress", "Unsigned32", "Integer32", "Counter64", "iso", "snmpModules", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "enterprises", "NotificationType", "Bits", "TimeTicks", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpDomainName=staticIpDomainName, fcsErrorReceived=fcsErrorReceived, ddminfo=ddminfo, domainame=domainame, fileType=fileType, unicastsTransmitted=unicastsTransmitted, dscpEnable=dscpEnable, portName=portName, jumblan1=jumblan1, action=action, multicastsTransmitted=multicastsTransmitted, vendorName=vendorName, xg6846=xg6846, lan1=lan1, internetPort=internetPort, vendorPn=vendorPn, port1=port1, lanportIndex=lanportIndex, port2=port2, staticIpSecondaryDns=staticIpSecondaryDns, wanType=wanType, staticDns=staticDns, portIndex=portIndex, staticIpGateway=staticIpGateway, voltage=voltage, lan4=lan4, portTable=portTable, tftpSevIp=tftpSevIp, staticIpPrimaryDns=staticIpPrimaryDns, rxPower=rxPower, portPower=portPower, jumb=jumb, bias=bias, fileName=fileName, port4=port4, tftp=tftp, hostname=hostname, unicastsReceived=unicastsReceived, catvEnable=catvEnable, lan3=lan3, catv=catv, groupEntry=groupEntry, statisticTable=statisticTable, portStatEntry=portStatEntry, portStatistic=portStatistic, wan=wan, rebootEnable=rebootEnable, lanportName=lanportName, jumblan4=jumblan4, staticIpAddr=staticIpAddr, lan2=lan2, priority=priority, broadcastsTransmitted=broadcastsTransmitted, statIndex=statIndex, fcsErrorTransmitted=fcsErrorTransmitted, adminStatus=adminStatus, serialnum=serialnum, vendorRev=vendorRev, temperature=temperature, staticIpHostName=staticIpHostName, qosIndex=qosIndex, operStatus=operStatus, deviceinfo=deviceinfo, vlanid=vlanid, portEntry=portEntry, qosTable=qosTable, lanportpause=lanportpause, jumbwan=jumbwan, pauseTransmitted=pauseTransmitted, modeEntry=modeEntry, jumblan2=jumblan2, speed=speed, secondaryDns=secondaryDns, qos=qos, vlangroupTable=vlangroupTable, broadcastsReceived=broadcastsReceived, port3=port3, lanportspeed=lanportspeed, groupIndex=groupIndex, vlan=vlan, groupid=groupid, lanportTable=lanportTable, qosEntry=qosEntry, txPower=txPower, multicastsReceived=multicastsReceived, jumblan3=jumblan3, primaryDns=primaryDns, portmode=portmode, staticIpSubMask=staticIpSubMask, pauseReceived=pauseReceived, vendorOui=vendorOui, reboot=reboot, qmode=qmode, qmapping=qmapping)
