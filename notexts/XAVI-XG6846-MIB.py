...
Counter32, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, Bits, MibIdentifier, Counter64, TimeTicks, Unsigned32, enterprises, mib_2, ObjectIdentity, IpAddress, snmpModules, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "Bits", "MibIdentifier", "Counter64", "TimeTicks", "Unsigned32", "enterprises", "mib-2", "ObjectIdentity", "IpAddress", "snmpModules", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portPower=portPower, qmode=qmode, staticIpHostName=staticIpHostName, staticIpSecondaryDns=staticIpSecondaryDns, bias=bias, vendorRev=vendorRev, groupEntry=groupEntry, fcsErrorReceived=fcsErrorReceived, statisticTable=statisticTable, jumblan4=jumblan4, unicastsTransmitted=unicastsTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, fileType=fileType, action=action, lan4=lan4, jumb=jumb, voltage=voltage, hostname=hostname, broadcastsTransmitted=broadcastsTransmitted, pauseReceived=pauseReceived, qosEntry=qosEntry, tftp=tftp, wan=wan, portStatEntry=portStatEntry, vendorPn=vendorPn, catv=catv, port3=port3, multicastsTransmitted=multicastsTransmitted, serialnum=serialnum, groupIndex=groupIndex, groupid=groupid, fileName=fileName, port2=port2, portIndex=portIndex, jumblan2=jumblan2, jumbwan=jumbwan, jumblan1=jumblan1, vendorName=vendorName, xg6846=xg6846, qosTable=qosTable, fcsErrorTransmitted=fcsErrorTransmitted, catvEnable=catvEnable, speed=speed, priority=priority, portTable=portTable, reboot=reboot, ddminfo=ddminfo, staticDns=staticDns, rebootEnable=rebootEnable, lanportIndex=lanportIndex, lanportpause=lanportpause, broadcastsReceived=broadcastsReceived, wanType=wanType, staticIpDomainName=staticIpDomainName, operStatus=operStatus, tftpSevIp=tftpSevIp, vlan=vlan, staticIpGateway=staticIpGateway, vlangroupTable=vlangroupTable, txPower=txPower, jumblan3=jumblan3, modeEntry=modeEntry, internetPort=internetPort, portmode=portmode, port1=port1, portName=portName, portEntry=portEntry, temperature=temperature, qos=qos, adminStatus=adminStatus, portStatistic=portStatistic, lanportspeed=lanportspeed, unicastsReceived=unicastsReceived, lanportTable=lanportTable, primaryDns=primaryDns, lan1=lan1, deviceinfo=deviceinfo, secondaryDns=secondaryDns, domainame=domainame, lan2=lan2, pauseTransmitted=pauseTransmitted, vendorOui=vendorOui, lan3=lan3, vlanid=vlanid, statIndex=statIndex, rxPower=rxPower, staticIpSubMask=staticIpSubMask, qosIndex=qosIndex, staticIpAddr=staticIpAddr, dscpEnable=dscpEnable, qmapping=qmapping, port4=port4, multicastsReceived=multicastsReceived, lanportName=lanportName)
