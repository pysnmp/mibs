...
# Produced by pysmi-1.1.3 at Wed Dec  8 19:47:02 2021
...
Counter64, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, Counter32, mib_2, Gauge32, IpAddress, Bits, TimeTicks, ModuleIdentity, ObjectIdentity, MibIdentifier, enterprises, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "Counter32", "mib-2", "Gauge32", "IpAddress", "Bits", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "enterprises", "iso", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", rebootEnable=rebootEnable, action=action, lanportTable=lanportTable, qosIndex=qosIndex, qos=qos, statIndex=statIndex, dscpEnable=dscpEnable, lan4=lan4, multicastsTransmitted=multicastsTransmitted, deviceinfo=deviceinfo, lanportpause=lanportpause, temperature=temperature, staticIpSubMask=staticIpSubMask, lan3=lan3, fileName=fileName, staticIpHostName=staticIpHostName, lanportName=lanportName, adminStatus=adminStatus, catvEnable=catvEnable, vlanid=vlanid, primaryDns=primaryDns, wan=wan, portPower=portPower, portStatistic=portStatistic, portTable=portTable, port1=port1, internetPort=internetPort, staticDns=staticDns, broadcastsReceived=broadcastsReceived, groupid=groupid, hostname=hostname, portEntry=portEntry, domainame=domainame, vendorRev=vendorRev, port2=port2, jumbwan=jumbwan, jumblan1=jumblan1, lan1=lan1, vendorPn=vendorPn, port4=port4, groupEntry=groupEntry, txPower=txPower, catv=catv, wanType=wanType, jumblan4=jumblan4, fileType=fileType, ddminfo=ddminfo, qosTable=qosTable, qmapping=qmapping, fcsErrorReceived=fcsErrorReceived, qosEntry=qosEntry, port3=port3, jumblan2=jumblan2, unicastsReceived=unicastsReceived, unicastsTransmitted=unicastsTransmitted, portIndex=portIndex, speed=speed, staticIpGateway=staticIpGateway, groupIndex=groupIndex, multicastsReceived=multicastsReceived, modeEntry=modeEntry, qmode=qmode, reboot=reboot, bias=bias, secondaryDns=secondaryDns, staticIpDomainName=staticIpDomainName, staticIpSecondaryDns=staticIpSecondaryDns, vendorOui=vendorOui, voltage=voltage, statisticTable=statisticTable, pauseReceived=pauseReceived, staticIpPrimaryDns=staticIpPrimaryDns, tftp=tftp, serialnum=serialnum, pauseTransmitted=pauseTransmitted, vendorName=vendorName, portStatEntry=portStatEntry, rxPower=rxPower, jumb=jumb, lanportIndex=lanportIndex, fcsErrorTransmitted=fcsErrorTransmitted, xg6846=xg6846, portName=portName, priority=priority, vlan=vlan, operStatus=operStatus, broadcastsTransmitted=broadcastsTransmitted, staticIpAddr=staticIpAddr, lanportspeed=lanportspeed, vlangroupTable=vlangroupTable, lan2=lan2, jumblan3=jumblan3, tftpSevIp=tftpSevIp, portmode=portmode)
