...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:57:50 2022
...
snmpModules, IpAddress, ModuleIdentity, iso, Gauge32, MibIdentifier, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, Integer32, Counter64, Unsigned32, mib_2, Counter32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "IpAddress", "ModuleIdentity", "iso", "Gauge32", "MibIdentifier", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "Integer32", "Counter64", "Unsigned32", "mib-2", "Counter32", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", groupEntry=groupEntry, fileType=fileType, portName=portName, vendorPn=vendorPn, staticDns=staticDns, reboot=reboot, operStatus=operStatus, tftp=tftp, multicastsReceived=multicastsReceived, qosTable=qosTable, port2=port2, vendorRev=vendorRev, lan4=lan4, bias=bias, fcsErrorTransmitted=fcsErrorTransmitted, qosEntry=qosEntry, multicastsTransmitted=multicastsTransmitted, secondaryDns=secondaryDns, lan3=lan3, primaryDns=primaryDns, portTable=portTable, pauseTransmitted=pauseTransmitted, qosIndex=qosIndex, domainame=domainame, qos=qos, broadcastsTransmitted=broadcastsTransmitted, jumbwan=jumbwan, portmode=portmode, jumb=jumb, groupid=groupid, staticIpSecondaryDns=staticIpSecondaryDns, voltage=voltage, deviceinfo=deviceinfo, broadcastsReceived=broadcastsReceived, serialnum=serialnum, internetPort=internetPort, jumblan2=jumblan2, catvEnable=catvEnable, xg6846=xg6846, catv=catv, lanportpause=lanportpause, jumblan3=jumblan3, lanportName=lanportName, statisticTable=statisticTable, wan=wan, unicastsTransmitted=unicastsTransmitted, lanportspeed=lanportspeed, tftpSevIp=tftpSevIp, jumblan1=jumblan1, rxPower=rxPower, dscpEnable=dscpEnable, vlan=vlan, qmode=qmode, adminStatus=adminStatus, fcsErrorReceived=fcsErrorReceived, fileName=fileName, portStatEntry=portStatEntry, txPower=txPower, portPower=portPower, vlanid=vlanid, staticIpHostName=staticIpHostName, staticIpPrimaryDns=staticIpPrimaryDns, vendorName=vendorName, temperature=temperature, ddminfo=ddminfo, lan1=lan1, groupIndex=groupIndex, modeEntry=modeEntry, jumblan4=jumblan4, staticIpSubMask=staticIpSubMask, port4=port4, vendorOui=vendorOui, hostname=hostname, lanportTable=lanportTable, portEntry=portEntry, port1=port1, priority=priority, staticIpAddr=staticIpAddr, lan2=lan2, qmapping=qmapping, staticIpGateway=staticIpGateway, vlangroupTable=vlangroupTable, port3=port3, rebootEnable=rebootEnable, portStatistic=portStatistic, unicastsReceived=unicastsReceived, action=action, wanType=wanType, statIndex=statIndex, speed=speed, pauseReceived=pauseReceived, staticIpDomainName=staticIpDomainName, portIndex=portIndex, lanportIndex=lanportIndex)
