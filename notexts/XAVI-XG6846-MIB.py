...
Integer32, Gauge32, enterprises, IpAddress, NotificationType, Counter64, Bits, mib_2, TimeTicks, MibIdentifier, snmpModules, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "enterprises", "IpAddress", "NotificationType", "Counter64", "Bits", "mib-2", "TimeTicks", "MibIdentifier", "snmpModules", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportTable=lanportTable, staticIpGateway=staticIpGateway, portIndex=portIndex, deviceinfo=deviceinfo, staticIpSubMask=staticIpSubMask, jumbwan=jumbwan, port1=port1, lanportName=lanportName, tftp=tftp, pauseReceived=pauseReceived, qosTable=qosTable, lan4=lan4, qos=qos, portStatEntry=portStatEntry, pauseTransmitted=pauseTransmitted, port4=port4, rxPower=rxPower, tftpSevIp=tftpSevIp, port2=port2, vendorName=vendorName, jumblan4=jumblan4, vendorRev=vendorRev, vlangroupTable=vlangroupTable, action=action, xg6846=xg6846, reboot=reboot, jumb=jumb, wan=wan, portPower=portPower, domainame=domainame, ddminfo=ddminfo, vlan=vlan, modeEntry=modeEntry, lan3=lan3, portStatistic=portStatistic, lanportIndex=lanportIndex, wanType=wanType, operStatus=operStatus, bias=bias, statisticTable=statisticTable, staticIpHostName=staticIpHostName, portmode=portmode, groupEntry=groupEntry, fileName=fileName, groupIndex=groupIndex, txPower=txPower, staticIpDomainName=staticIpDomainName, portName=portName, staticIpPrimaryDns=staticIpPrimaryDns, jumblan2=jumblan2, lanportpause=lanportpause, multicastsTransmitted=multicastsTransmitted, broadcastsTransmitted=broadcastsTransmitted, primaryDns=primaryDns, rebootEnable=rebootEnable, lanportspeed=lanportspeed, staticDns=staticDns, adminStatus=adminStatus, vendorPn=vendorPn, unicastsTransmitted=unicastsTransmitted, qosEntry=qosEntry, catv=catv, vendorOui=vendorOui, qmode=qmode, internetPort=internetPort, broadcastsReceived=broadcastsReceived, staticIpAddr=staticIpAddr, fcsErrorTransmitted=fcsErrorTransmitted, groupid=groupid, lan1=lan1, unicastsReceived=unicastsReceived, dscpEnable=dscpEnable, serialnum=serialnum, portEntry=portEntry, secondaryDns=secondaryDns, catvEnable=catvEnable, multicastsReceived=multicastsReceived, lan2=lan2, jumblan1=jumblan1, qmapping=qmapping, fcsErrorReceived=fcsErrorReceived, jumblan3=jumblan3, voltage=voltage, statIndex=statIndex, priority=priority, portTable=portTable, fileType=fileType, speed=speed, qosIndex=qosIndex, staticIpSecondaryDns=staticIpSecondaryDns, vlanid=vlanid, temperature=temperature, port3=port3, hostname=hostname)
