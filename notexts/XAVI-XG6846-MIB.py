...
# Produced by pysmi-1.1.8 at Thu Jan  5 10:23:45 2023
...
TimeTicks, mib_2, Counter64, enterprises, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, Counter32, ModuleIdentity, Integer32, IpAddress, iso, MibIdentifier, snmpModules, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "mib-2", "Counter64", "enterprises", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "Counter32", "ModuleIdentity", "Integer32", "IpAddress", "iso", "MibIdentifier", "snmpModules", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", priority=priority, staticIpPrimaryDns=staticIpPrimaryDns, staticIpGateway=staticIpGateway, unicastsTransmitted=unicastsTransmitted, portStatEntry=portStatEntry, portStatistic=portStatistic, pauseTransmitted=pauseTransmitted, jumblan3=jumblan3, jumblan4=jumblan4, catvEnable=catvEnable, qosIndex=qosIndex, xg6846=xg6846, lanportTable=lanportTable, domainame=domainame, vlan=vlan, lan3=lan3, staticDns=staticDns, qosEntry=qosEntry, speed=speed, portName=portName, multicastsTransmitted=multicastsTransmitted, unicastsReceived=unicastsReceived, lan4=lan4, lanportIndex=lanportIndex, lan2=lan2, fcsErrorTransmitted=fcsErrorTransmitted, broadcastsTransmitted=broadcastsTransmitted, internetPort=internetPort, port2=port2, portPower=portPower, deviceinfo=deviceinfo, voltage=voltage, ddminfo=ddminfo, port3=port3, rebootEnable=rebootEnable, fileType=fileType, staticIpSecondaryDns=staticIpSecondaryDns, vendorPn=vendorPn, lanportName=lanportName, dscpEnable=dscpEnable, vlangroupTable=vlangroupTable, operStatus=operStatus, primaryDns=primaryDns, serialnum=serialnum, statIndex=statIndex, port1=port1, txPower=txPower, qmapping=qmapping, jumb=jumb, action=action, staticIpAddr=staticIpAddr, temperature=temperature, tftp=tftp, wan=wan, jumblan2=jumblan2, qmode=qmode, multicastsReceived=multicastsReceived, wanType=wanType, vendorRev=vendorRev, portmode=portmode, pauseReceived=pauseReceived, tftpSevIp=tftpSevIp, port4=port4, groupIndex=groupIndex, groupid=groupid, lanportspeed=lanportspeed, adminStatus=adminStatus, qos=qos, bias=bias, portTable=portTable, jumbwan=jumbwan, vendorOui=vendorOui, vlanid=vlanid, catv=catv, qosTable=qosTable, hostname=hostname, portEntry=portEntry, staticIpDomainName=staticIpDomainName, broadcastsReceived=broadcastsReceived, vendorName=vendorName, reboot=reboot, staticIpSubMask=staticIpSubMask, rxPower=rxPower, jumblan1=jumblan1, secondaryDns=secondaryDns, fileName=fileName, modeEntry=modeEntry, fcsErrorReceived=fcsErrorReceived, portIndex=portIndex, staticIpHostName=staticIpHostName, statisticTable=statisticTable, lanportpause=lanportpause, lan1=lan1, groupEntry=groupEntry)
