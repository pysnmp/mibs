...
Integer32, Gauge32, iso, Counter64, NotificationType, snmpModules, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, mib_2, MibIdentifier, TimeTicks, Bits, ObjectIdentity, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "iso", "Counter64", "NotificationType", "snmpModules", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "mib-2", "MibIdentifier", "TimeTicks", "Bits", "ObjectIdentity", "IpAddress", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpGateway=staticIpGateway, vendorRev=vendorRev, adminStatus=adminStatus, port3=port3, pauseReceived=pauseReceived, unicastsReceived=unicastsReceived, port2=port2, vlanid=vlanid, lanportTable=lanportTable, statIndex=statIndex, qosIndex=qosIndex, wanType=wanType, fcsErrorTransmitted=fcsErrorTransmitted, vlangroupTable=vlangroupTable, lan2=lan2, deviceinfo=deviceinfo, dscpEnable=dscpEnable, operStatus=operStatus, staticIpSecondaryDns=staticIpSecondaryDns, qmapping=qmapping, jumbwan=jumbwan, portmode=portmode, multicastsReceived=multicastsReceived, vlan=vlan, tftp=tftp, lanportName=lanportName, fileName=fileName, tftpSevIp=tftpSevIp, lan1=lan1, port4=port4, portStatistic=portStatistic, groupid=groupid, temperature=temperature, primaryDns=primaryDns, reboot=reboot, staticIpDomainName=staticIpDomainName, broadcastsReceived=broadcastsReceived, bias=bias, vendorPn=vendorPn, catv=catv, catvEnable=catvEnable, wan=wan, staticIpHostName=staticIpHostName, internetPort=internetPort, lanportpause=lanportpause, vendorOui=vendorOui, voltage=voltage, staticIpSubMask=staticIpSubMask, portStatEntry=portStatEntry, staticDns=staticDns, jumblan3=jumblan3, groupEntry=groupEntry, qosTable=qosTable, action=action, lanportspeed=lanportspeed, qmode=qmode, qos=qos, portName=portName, lan4=lan4, qosEntry=qosEntry, lan3=lan3, broadcastsTransmitted=broadcastsTransmitted, hostname=hostname, fcsErrorReceived=fcsErrorReceived, portEntry=portEntry, jumb=jumb, jumblan2=jumblan2, lanportIndex=lanportIndex, fileType=fileType, pauseTransmitted=pauseTransmitted, serialnum=serialnum, multicastsTransmitted=multicastsTransmitted, portPower=portPower, domainame=domainame, staticIpAddr=staticIpAddr, priority=priority, modeEntry=modeEntry, staticIpPrimaryDns=staticIpPrimaryDns, portIndex=portIndex, speed=speed, port1=port1, portTable=portTable, secondaryDns=secondaryDns, vendorName=vendorName, jumblan1=jumblan1, statisticTable=statisticTable, ddminfo=ddminfo, groupIndex=groupIndex, xg6846=xg6846, txPower=txPower, unicastsTransmitted=unicastsTransmitted, jumblan4=jumblan4, rxPower=rxPower, rebootEnable=rebootEnable)
