...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, Bits, NotificationType, ObjectIdentity, mib_2, Gauge32, enterprises, TimeTicks, iso, Integer32, Counter64, Unsigned32, IpAddress, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "Bits", "NotificationType", "ObjectIdentity", "mib-2", "Gauge32", "enterprises", "TimeTicks", "iso", "Integer32", "Counter64", "Unsigned32", "IpAddress", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", pauseTransmitted=pauseTransmitted, hostname=hostname, vlan=vlan, lanportpause=lanportpause, internetPort=internetPort, vendorOui=vendorOui, operStatus=operStatus, staticIpAddr=staticIpAddr, port4=port4, primaryDns=primaryDns, vendorPn=vendorPn, modeEntry=modeEntry, secondaryDns=secondaryDns, action=action, statisticTable=statisticTable, fcsErrorReceived=fcsErrorReceived, xg6846=xg6846, catv=catv, vlanid=vlanid, vendorRev=vendorRev, ddminfo=ddminfo, portName=portName, port3=port3, portEntry=portEntry, lanportTable=lanportTable, jumblan3=jumblan3, port1=port1, reboot=reboot, lanportspeed=lanportspeed, broadcastsTransmitted=broadcastsTransmitted, speed=speed, qosIndex=qosIndex, portStatEntry=portStatEntry, vlangroupTable=vlangroupTable, rebootEnable=rebootEnable, port2=port2, staticIpPrimaryDns=staticIpPrimaryDns, unicastsTransmitted=unicastsTransmitted, temperature=temperature, fileType=fileType, staticIpSecondaryDns=staticIpSecondaryDns, unicastsReceived=unicastsReceived, bias=bias, groupid=groupid, jumbwan=jumbwan, portPower=portPower, staticIpSubMask=staticIpSubMask, qosTable=qosTable, lan2=lan2, groupIndex=groupIndex, multicastsTransmitted=multicastsTransmitted, broadcastsReceived=broadcastsReceived, qos=qos, qmapping=qmapping, rxPower=rxPower, lanportName=lanportName, multicastsReceived=multicastsReceived, txPower=txPower, portTable=portTable, lan1=lan1, vendorName=vendorName, staticDns=staticDns, qosEntry=qosEntry, tftpSevIp=tftpSevIp, pauseReceived=pauseReceived, staticIpHostName=staticIpHostName, dscpEnable=dscpEnable, lan3=lan3, staticIpGateway=staticIpGateway, jumb=jumb, tftp=tftp, portStatistic=portStatistic, qmode=qmode, statIndex=statIndex, jumblan4=jumblan4, portmode=portmode, voltage=voltage, fcsErrorTransmitted=fcsErrorTransmitted, lanportIndex=lanportIndex, wan=wan, jumblan1=jumblan1, staticIpDomainName=staticIpDomainName, serialnum=serialnum, priority=priority, domainame=domainame, deviceinfo=deviceinfo, jumblan2=jumblan2, wanType=wanType, fileName=fileName, adminStatus=adminStatus, groupEntry=groupEntry, portIndex=portIndex, catvEnable=catvEnable, lan4=lan4)
