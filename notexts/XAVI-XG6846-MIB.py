...
# Produced by pysmi-1.1.8 at Tue Sep 12 13:37:05 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, Counter32, TimeTicks, snmpModules, ModuleIdentity, enterprises, Unsigned32, iso, mib_2, Integer32, ObjectIdentity, Bits, NotificationType, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "Counter32", "TimeTicks", "snmpModules", "ModuleIdentity", "enterprises", "Unsigned32", "iso", "mib-2", "Integer32", "ObjectIdentity", "Bits", "NotificationType", "Counter64", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", txPower=txPower, priority=priority, domainame=domainame, bias=bias, rebootEnable=rebootEnable, groupEntry=groupEntry, portStatEntry=portStatEntry, unicastsReceived=unicastsReceived, lanportTable=lanportTable, groupid=groupid, staticIpDomainName=staticIpDomainName, qosEntry=qosEntry, multicastsTransmitted=multicastsTransmitted, voltage=voltage, serialnum=serialnum, fileName=fileName, operStatus=operStatus, jumblan4=jumblan4, port3=port3, fcsErrorReceived=fcsErrorReceived, lan3=lan3, vlanid=vlanid, portIndex=portIndex, qmapping=qmapping, fileType=fileType, jumblan3=jumblan3, qos=qos, xg6846=xg6846, staticIpAddr=staticIpAddr, broadcastsTransmitted=broadcastsTransmitted, portEntry=portEntry, tftpSevIp=tftpSevIp, catv=catv, reboot=reboot, adminStatus=adminStatus, port1=port1, deviceinfo=deviceinfo, qmode=qmode, lanportName=lanportName, lan4=lan4, staticIpGateway=staticIpGateway, qosTable=qosTable, fcsErrorTransmitted=fcsErrorTransmitted, statIndex=statIndex, vlan=vlan, vendorPn=vendorPn, wan=wan, port2=port2, portStatistic=portStatistic, rxPower=rxPower, dscpEnable=dscpEnable, vendorOui=vendorOui, secondaryDns=secondaryDns, jumblan2=jumblan2, portPower=portPower, portmode=portmode, staticIpSubMask=staticIpSubMask, hostname=hostname, staticIpHostName=staticIpHostName, groupIndex=groupIndex, portName=portName, vendorName=vendorName, action=action, temperature=temperature, jumbwan=jumbwan, lanportspeed=lanportspeed, catvEnable=catvEnable, staticIpPrimaryDns=staticIpPrimaryDns, staticIpSecondaryDns=staticIpSecondaryDns, port4=port4, pauseReceived=pauseReceived, jumb=jumb, modeEntry=modeEntry, speed=speed, primaryDns=primaryDns, jumblan1=jumblan1, tftp=tftp, lan2=lan2, wanType=wanType, vendorRev=vendorRev, lanportpause=lanportpause, lan1=lan1, multicastsReceived=multicastsReceived, qosIndex=qosIndex, unicastsTransmitted=unicastsTransmitted, lanportIndex=lanportIndex, ddminfo=ddminfo, portTable=portTable, internetPort=internetPort, vlangroupTable=vlangroupTable, staticDns=staticDns, broadcastsReceived=broadcastsReceived, pauseTransmitted=pauseTransmitted, statisticTable=statisticTable)
