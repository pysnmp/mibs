...
# Produced by pysmi-1.1.8 at Sat Jan 15 04:47:07 2022
...
snmpModules, IpAddress, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, enterprises, mib_2, Unsigned32, TimeTicks, Integer32, NotificationType, MibIdentifier, Bits, Counter64, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "IpAddress", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "enterprises", "mib-2", "Unsigned32", "TimeTicks", "Integer32", "NotificationType", "MibIdentifier", "Bits", "Counter64", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", broadcastsTransmitted=broadcastsTransmitted, xg6846=xg6846, modeEntry=modeEntry, domainame=domainame, groupEntry=groupEntry, tftp=tftp, broadcastsReceived=broadcastsReceived, multicastsReceived=multicastsReceived, lan4=lan4, lan1=lan1, portTable=portTable, adminStatus=adminStatus, portStatistic=portStatistic, catvEnable=catvEnable, portmode=portmode, groupIndex=groupIndex, lanportName=lanportName, staticDns=staticDns, vlanid=vlanid, txPower=txPower, internetPort=internetPort, staticIpDomainName=staticIpDomainName, hostname=hostname, speed=speed, qosIndex=qosIndex, bias=bias, jumbwan=jumbwan, action=action, lanportTable=lanportTable, staticIpPrimaryDns=staticIpPrimaryDns, reboot=reboot, lan3=lan3, staticIpSubMask=staticIpSubMask, wan=wan, pauseTransmitted=pauseTransmitted, vlangroupTable=vlangroupTable, rebootEnable=rebootEnable, lanportIndex=lanportIndex, qosEntry=qosEntry, secondaryDns=secondaryDns, wanType=wanType, qmapping=qmapping, statisticTable=statisticTable, qmode=qmode, vendorOui=vendorOui, qosTable=qosTable, portIndex=portIndex, priority=priority, lanportpause=lanportpause, ddminfo=ddminfo, port1=port1, jumblan4=jumblan4, vlan=vlan, portEntry=portEntry, catv=catv, port2=port2, temperature=temperature, fileName=fileName, portName=portName, staticIpHostName=staticIpHostName, port3=port3, rxPower=rxPower, qos=qos, voltage=voltage, lanportspeed=lanportspeed, fcsErrorTransmitted=fcsErrorTransmitted, jumblan3=jumblan3, portStatEntry=portStatEntry, operStatus=operStatus, groupid=groupid, multicastsTransmitted=multicastsTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, tftpSevIp=tftpSevIp, serialnum=serialnum, lan2=lan2, jumblan1=jumblan1, primaryDns=primaryDns, staticIpAddr=staticIpAddr, unicastsTransmitted=unicastsTransmitted, fileType=fileType, port4=port4, deviceinfo=deviceinfo, fcsErrorReceived=fcsErrorReceived, jumblan2=jumblan2, dscpEnable=dscpEnable, unicastsReceived=unicastsReceived, pauseReceived=pauseReceived, staticIpGateway=staticIpGateway, vendorRev=vendorRev, statIndex=statIndex, vendorPn=vendorPn, vendorName=vendorName, jumb=jumb, portPower=portPower)
