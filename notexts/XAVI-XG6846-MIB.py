...
# Produced by pysmi-1.1.3 at Wed Dec  8 20:19:04 2021
...
enterprises, Gauge32, iso, Unsigned32, TimeTicks, Counter32, NotificationType, snmpModules, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, mib_2, ObjectIdentity, Integer32, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "iso", "Unsigned32", "TimeTicks", "Counter32", "NotificationType", "snmpModules", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "mib-2", "ObjectIdentity", "Integer32", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qosIndex=qosIndex, pauseReceived=pauseReceived, lan3=lan3, staticDns=staticDns, broadcastsTransmitted=broadcastsTransmitted, temperature=temperature, jumbwan=jumbwan, catvEnable=catvEnable, primaryDns=primaryDns, jumblan2=jumblan2, wan=wan, wanType=wanType, rebootEnable=rebootEnable, groupEntry=groupEntry, statisticTable=statisticTable, multicastsReceived=multicastsReceived, speed=speed, portTable=portTable, lanportTable=lanportTable, jumblan4=jumblan4, broadcastsReceived=broadcastsReceived, jumblan1=jumblan1, portmode=portmode, serialnum=serialnum, voltage=voltage, domainame=domainame, modeEntry=modeEntry, operStatus=operStatus, jumb=jumb, secondaryDns=secondaryDns, vendorRev=vendorRev, portStatistic=portStatistic, action=action, portIndex=portIndex, portStatEntry=portStatEntry, lan4=lan4, reboot=reboot, vlangroupTable=vlangroupTable, rxPower=rxPower, adminStatus=adminStatus, portEntry=portEntry, qosTable=qosTable, fileType=fileType, portName=portName, port3=port3, bias=bias, tftp=tftp, staticIpGateway=staticIpGateway, vendorName=vendorName, unicastsReceived=unicastsReceived, multicastsTransmitted=multicastsTransmitted, xg6846=xg6846, vlan=vlan, lanportspeed=lanportspeed, qmapping=qmapping, unicastsTransmitted=unicastsTransmitted, qosEntry=qosEntry, fileName=fileName, catv=catv, qos=qos, lanportpause=lanportpause, qmode=qmode, groupIndex=groupIndex, vendorPn=vendorPn, lan1=lan1, tftpSevIp=tftpSevIp, port1=port1, staticIpSecondaryDns=staticIpSecondaryDns, portPower=portPower, pauseTransmitted=pauseTransmitted, ddminfo=ddminfo, dscpEnable=dscpEnable, staticIpSubMask=staticIpSubMask, staticIpAddr=staticIpAddr, port4=port4, staticIpPrimaryDns=staticIpPrimaryDns, statIndex=statIndex, fcsErrorTransmitted=fcsErrorTransmitted, port2=port2, priority=priority, fcsErrorReceived=fcsErrorReceived, jumblan3=jumblan3, staticIpHostName=staticIpHostName, groupid=groupid, vlanid=vlanid, lanportIndex=lanportIndex, txPower=txPower, lanportName=lanportName, vendorOui=vendorOui, internetPort=internetPort, lan2=lan2, deviceinfo=deviceinfo, hostname=hostname, staticIpDomainName=staticIpDomainName)
