...
MibIdentifier, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, snmpModules, Unsigned32, Integer32, Counter32, NotificationType, mib_2, IpAddress, Bits, Gauge32, ObjectIdentity, enterprises, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "snmpModules", "Unsigned32", "Integer32", "Counter32", "NotificationType", "mib-2", "IpAddress", "Bits", "Gauge32", "ObjectIdentity", "enterprises", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", unicastsReceived=unicastsReceived, action=action, staticIpGateway=staticIpGateway, portPower=portPower, voltage=voltage, statisticTable=statisticTable, domainame=domainame, staticIpAddr=staticIpAddr, priority=priority, pauseTransmitted=pauseTransmitted, vlangroupTable=vlangroupTable, staticIpSubMask=staticIpSubMask, lan1=lan1, operStatus=operStatus, wanType=wanType, vendorName=vendorName, portStatEntry=portStatEntry, jumblan1=jumblan1, bias=bias, lan2=lan2, hostname=hostname, temperature=temperature, multicastsReceived=multicastsReceived, port4=port4, jumblan4=jumblan4, staticIpDomainName=staticIpDomainName, speed=speed, tftpSevIp=tftpSevIp, deviceinfo=deviceinfo, xg6846=xg6846, internetPort=internetPort, broadcastsReceived=broadcastsReceived, qmode=qmode, wan=wan, qosIndex=qosIndex, adminStatus=adminStatus, portEntry=portEntry, multicastsTransmitted=multicastsTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, staticIpSecondaryDns=staticIpSecondaryDns, port2=port2, groupIndex=groupIndex, primaryDns=primaryDns, jumb=jumb, broadcastsTransmitted=broadcastsTransmitted, qosEntry=qosEntry, port1=port1, lanportName=lanportName, lan4=lan4, lanportspeed=lanportspeed, fcsErrorReceived=fcsErrorReceived, rxPower=rxPower, lanportpause=lanportpause, qosTable=qosTable, jumblan3=jumblan3, portTable=portTable, qos=qos, lanportIndex=lanportIndex, unicastsTransmitted=unicastsTransmitted, dscpEnable=dscpEnable, pauseReceived=pauseReceived, txPower=txPower, tftp=tftp, statIndex=statIndex, fileType=fileType, reboot=reboot, port3=port3, qmapping=qmapping, modeEntry=modeEntry, vendorPn=vendorPn, groupEntry=groupEntry, fileName=fileName, portmode=portmode, vendorOui=vendorOui, staticDns=staticDns, lanportTable=lanportTable, catv=catv, lan3=lan3, vendorRev=vendorRev, fcsErrorTransmitted=fcsErrorTransmitted, ddminfo=ddminfo, jumbwan=jumbwan, staticIpHostName=staticIpHostName, jumblan2=jumblan2, portIndex=portIndex, serialnum=serialnum, portStatistic=portStatistic, rebootEnable=rebootEnable, portName=portName, vlanid=vlanid, groupid=groupid, vlan=vlan, secondaryDns=secondaryDns, catvEnable=catvEnable)
