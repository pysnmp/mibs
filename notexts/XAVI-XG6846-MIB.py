...
Bits, mib_2, ObjectIdentity, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, Counter64, IpAddress, TimeTicks, Integer32, snmpModules, iso, Gauge32, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "mib-2", "ObjectIdentity", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "Counter64", "IpAddress", "TimeTicks", "Integer32", "snmpModules", "iso", "Gauge32", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorOui=vendorOui, bias=bias, vlanid=vlanid, unicastsTransmitted=unicastsTransmitted, serialnum=serialnum, temperature=temperature, catv=catv, qmapping=qmapping, primaryDns=primaryDns, fcsErrorReceived=fcsErrorReceived, internetPort=internetPort, port4=port4, qosTable=qosTable, pauseTransmitted=pauseTransmitted, wanType=wanType, groupIndex=groupIndex, rebootEnable=rebootEnable, port1=port1, qosEntry=qosEntry, rxPower=rxPower, action=action, priority=priority, staticIpAddr=staticIpAddr, modeEntry=modeEntry, jumblan3=jumblan3, portTable=portTable, port3=port3, ddminfo=ddminfo, staticIpSubMask=staticIpSubMask, groupid=groupid, portmode=portmode, vendorRev=vendorRev, domainame=domainame, txPower=txPower, lan2=lan2, hostname=hostname, jumblan1=jumblan1, vlangroupTable=vlangroupTable, tftp=tftp, jumblan4=jumblan4, vendorPn=vendorPn, tftpSevIp=tftpSevIp, portPower=portPower, portStatEntry=portStatEntry, dscpEnable=dscpEnable, vendorName=vendorName, voltage=voltage, lanportName=lanportName, staticDns=staticDns, jumbwan=jumbwan, port2=port2, staticIpSecondaryDns=staticIpSecondaryDns, portName=portName, multicastsTransmitted=multicastsTransmitted, vlan=vlan, adminStatus=adminStatus, broadcastsReceived=broadcastsReceived, unicastsReceived=unicastsReceived, reboot=reboot, qmode=qmode, qos=qos, xg6846=xg6846, lan4=lan4, portEntry=portEntry, statisticTable=statisticTable, lan1=lan1, catvEnable=catvEnable, staticIpDomainName=staticIpDomainName, fileType=fileType, multicastsReceived=multicastsReceived, speed=speed, statIndex=statIndex, portStatistic=portStatistic, staticIpPrimaryDns=staticIpPrimaryDns, groupEntry=groupEntry, secondaryDns=secondaryDns, lanportIndex=lanportIndex, lanportspeed=lanportspeed, deviceinfo=deviceinfo, staticIpGateway=staticIpGateway, jumb=jumb, lan3=lan3, qosIndex=qosIndex, lanportpause=lanportpause, portIndex=portIndex, staticIpHostName=staticIpHostName, operStatus=operStatus, pauseReceived=pauseReceived, broadcastsTransmitted=broadcastsTransmitted, jumblan2=jumblan2, lanportTable=lanportTable, fileName=fileName, wan=wan, fcsErrorTransmitted=fcsErrorTransmitted)
