...
# Produced by pysmi-1.1.8 at Tue Jan 18 14:09:40 2022
...
MibIdentifier, mib_2, Counter32, NotificationType, Integer32, ObjectIdentity, IpAddress, iso, Unsigned32, TimeTicks, ModuleIdentity, snmpModules, Counter64, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "mib-2", "Counter32", "NotificationType", "Integer32", "ObjectIdentity", "IpAddress", "iso", "Unsigned32", "TimeTicks", "ModuleIdentity", "snmpModules", "Counter64", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpAddr=staticIpAddr, operStatus=operStatus, wanType=wanType, portPower=portPower, hostname=hostname, vendorOui=vendorOui, staticIpGateway=staticIpGateway, vlangroupTable=vlangroupTable, xg6846=xg6846, lan2=lan2, staticDns=staticDns, statisticTable=statisticTable, lanportspeed=lanportspeed, pauseTransmitted=pauseTransmitted, port1=port1, qos=qos, staticIpSecondaryDns=staticIpSecondaryDns, staticIpSubMask=staticIpSubMask, qosTable=qosTable, vendorPn=vendorPn, jumblan4=jumblan4, multicastsReceived=multicastsReceived, internetPort=internetPort, wan=wan, statIndex=statIndex, port2=port2, priority=priority, serialnum=serialnum, speed=speed, portmode=portmode, temperature=temperature, rebootEnable=rebootEnable, tftpSevIp=tftpSevIp, lanportName=lanportName, vlan=vlan, fcsErrorTransmitted=fcsErrorTransmitted, lanportTable=lanportTable, lan1=lan1, lan3=lan3, bias=bias, port4=port4, reboot=reboot, dscpEnable=dscpEnable, adminStatus=adminStatus, unicastsTransmitted=unicastsTransmitted, staticIpDomainName=staticIpDomainName, lanportpause=lanportpause, ddminfo=ddminfo, portEntry=portEntry, fcsErrorReceived=fcsErrorReceived, secondaryDns=secondaryDns, jumblan1=jumblan1, port3=port3, portIndex=portIndex, modeEntry=modeEntry, pauseReceived=pauseReceived, jumblan3=jumblan3, vendorRev=vendorRev, domainame=domainame, tftp=tftp, qmapping=qmapping, portStatistic=portStatistic, primaryDns=primaryDns, fileName=fileName, deviceinfo=deviceinfo, groupIndex=groupIndex, qosIndex=qosIndex, portTable=portTable, groupid=groupid, action=action, vendorName=vendorName, broadcastsTransmitted=broadcastsTransmitted, portStatEntry=portStatEntry, multicastsTransmitted=multicastsTransmitted, portName=portName, staticIpHostName=staticIpHostName, vlanid=vlanid, lan4=lan4, qmode=qmode, jumbwan=jumbwan, lanportIndex=lanportIndex, staticIpPrimaryDns=staticIpPrimaryDns, unicastsReceived=unicastsReceived, catv=catv, jumblan2=jumblan2, catvEnable=catvEnable, jumb=jumb, broadcastsReceived=broadcastsReceived, txPower=txPower, fileType=fileType, rxPower=rxPower, groupEntry=groupEntry, qosEntry=qosEntry, voltage=voltage)
