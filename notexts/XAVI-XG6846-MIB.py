...
mib_2, IpAddress, Gauge32, NotificationType, ObjectIdentity, MibIdentifier, enterprises, Counter64, Counter32, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, snmpModules, TimeTicks, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "IpAddress", "Gauge32", "NotificationType", "ObjectIdentity", "MibIdentifier", "enterprises", "Counter64", "Counter32", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "snmpModules", "TimeTicks", "Integer32", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", adminStatus=adminStatus, bias=bias, qmode=qmode, staticIpSecondaryDns=staticIpSecondaryDns, port1=port1, lan4=lan4, portIndex=portIndex, staticIpSubMask=staticIpSubMask, qosEntry=qosEntry, reboot=reboot, catv=catv, fcsErrorTransmitted=fcsErrorTransmitted, rxPower=rxPower, jumblan1=jumblan1, staticDns=staticDns, port4=port4, portName=portName, secondaryDns=secondaryDns, modeEntry=modeEntry, serialnum=serialnum, wanType=wanType, vlanid=vlanid, pauseReceived=pauseReceived, portmode=portmode, tftp=tftp, rebootEnable=rebootEnable, lanportName=lanportName, fileName=fileName, multicastsTransmitted=multicastsTransmitted, deviceinfo=deviceinfo, unicastsReceived=unicastsReceived, vendorName=vendorName, vendorOui=vendorOui, dscpEnable=dscpEnable, txPower=txPower, portStatistic=portStatistic, portEntry=portEntry, vlan=vlan, jumblan2=jumblan2, domainame=domainame, vlangroupTable=vlangroupTable, lan1=lan1, tftpSevIp=tftpSevIp, ddminfo=ddminfo, jumblan3=jumblan3, staticIpDomainName=staticIpDomainName, qos=qos, groupid=groupid, action=action, temperature=temperature, portPower=portPower, portStatEntry=portStatEntry, lanportTable=lanportTable, broadcastsTransmitted=broadcastsTransmitted, portTable=portTable, lan3=lan3, multicastsReceived=multicastsReceived, hostname=hostname, staticIpHostName=staticIpHostName, staticIpAddr=staticIpAddr, port2=port2, pauseTransmitted=pauseTransmitted, xg6846=xg6846, lanportIndex=lanportIndex, broadcastsReceived=broadcastsReceived, statIndex=statIndex, vendorRev=vendorRev, catvEnable=catvEnable, wan=wan, unicastsTransmitted=unicastsTransmitted, internetPort=internetPort, groupIndex=groupIndex, jumblan4=jumblan4, jumb=jumb, vendorPn=vendorPn, primaryDns=primaryDns, fcsErrorReceived=fcsErrorReceived, groupEntry=groupEntry, fileType=fileType, port3=port3, jumbwan=jumbwan, lanportspeed=lanportspeed, qosTable=qosTable, speed=speed, qmapping=qmapping, lan2=lan2, lanportpause=lanportpause, operStatus=operStatus, statisticTable=statisticTable, qosIndex=qosIndex, priority=priority, staticIpPrimaryDns=staticIpPrimaryDns, staticIpGateway=staticIpGateway, voltage=voltage)
