...
# Produced by pysmi-1.1.3 at Tue Dec  7 17:01:38 2021
...
iso, TimeTicks, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, ModuleIdentity, Integer32, Counter64, Unsigned32, Counter32, enterprises, snmpModules, ObjectIdentity, Bits, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "ModuleIdentity", "Integer32", "Counter64", "Unsigned32", "Counter32", "enterprises", "snmpModules", "ObjectIdentity", "Bits", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportTable=lanportTable, port4=port4, rxPower=rxPower, portIndex=portIndex, serialnum=serialnum, wanType=wanType, staticDns=staticDns, unicastsTransmitted=unicastsTransmitted, lan2=lan2, portPower=portPower, primaryDns=primaryDns, lan3=lan3, catv=catv, action=action, rebootEnable=rebootEnable, secondaryDns=secondaryDns, staticIpAddr=staticIpAddr, domainame=domainame, jumblan1=jumblan1, jumb=jumb, groupEntry=groupEntry, lan1=lan1, lan4=lan4, staticIpSubMask=staticIpSubMask, jumbwan=jumbwan, portStatEntry=portStatEntry, jumblan3=jumblan3, lanportspeed=lanportspeed, staticIpPrimaryDns=staticIpPrimaryDns, port2=port2, reboot=reboot, hostname=hostname, temperature=temperature, qos=qos, portName=portName, pauseReceived=pauseReceived, broadcastsTransmitted=broadcastsTransmitted, unicastsReceived=unicastsReceived, groupIndex=groupIndex, multicastsTransmitted=multicastsTransmitted, vendorRev=vendorRev, staticIpSecondaryDns=staticIpSecondaryDns, qmode=qmode, port3=port3, vlan=vlan, wan=wan, statIndex=statIndex, fcsErrorTransmitted=fcsErrorTransmitted, portStatistic=portStatistic, vendorOui=vendorOui, qmapping=qmapping, vlangroupTable=vlangroupTable, broadcastsReceived=broadcastsReceived, pauseTransmitted=pauseTransmitted, port1=port1, fileType=fileType, txPower=txPower, deviceinfo=deviceinfo, priority=priority, statisticTable=statisticTable, bias=bias, modeEntry=modeEntry, multicastsReceived=multicastsReceived, lanportpause=lanportpause, ddminfo=ddminfo, voltage=voltage, groupid=groupid, internetPort=internetPort, staticIpHostName=staticIpHostName, dscpEnable=dscpEnable, jumblan4=jumblan4, lanportName=lanportName, qosTable=qosTable, staticIpGateway=staticIpGateway, jumblan2=jumblan2, adminStatus=adminStatus, portmode=portmode, operStatus=operStatus, tftpSevIp=tftpSevIp, qosIndex=qosIndex, qosEntry=qosEntry, vendorName=vendorName, portTable=portTable, vendorPn=vendorPn, vlanid=vlanid, fileName=fileName, speed=speed, lanportIndex=lanportIndex, portEntry=portEntry, tftp=tftp, xg6846=xg6846, fcsErrorReceived=fcsErrorReceived, staticIpDomainName=staticIpDomainName, catvEnable=catvEnable)
