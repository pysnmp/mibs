...
# Produced by pysmi-1.1.8 at Thu Sep 29 13:13:06 2022
...
TimeTicks, snmpModules, MibIdentifier, Counter64, Counter32, mib_2, ModuleIdentity, Bits, enterprises, NotificationType, Gauge32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "snmpModules", "MibIdentifier", "Counter64", "Counter32", "mib-2", "ModuleIdentity", "Bits", "enterprises", "NotificationType", "Gauge32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portStatEntry=portStatEntry, vlan=vlan, reboot=reboot, fcsErrorTransmitted=fcsErrorTransmitted, staticIpDomainName=staticIpDomainName, jumblan2=jumblan2, unicastsReceived=unicastsReceived, wan=wan, staticDns=staticDns, lanportIndex=lanportIndex, vendorRev=vendorRev, deviceinfo=deviceinfo, catv=catv, staticIpSecondaryDns=staticIpSecondaryDns, portEntry=portEntry, groupid=groupid, domainame=domainame, portStatistic=portStatistic, internetPort=internetPort, dscpEnable=dscpEnable, lan4=lan4, broadcastsReceived=broadcastsReceived, jumblan3=jumblan3, broadcastsTransmitted=broadcastsTransmitted, hostname=hostname, qos=qos, port2=port2, multicastsTransmitted=multicastsTransmitted, adminStatus=adminStatus, unicastsTransmitted=unicastsTransmitted, tftp=tftp, operStatus=operStatus, qmode=qmode, groupIndex=groupIndex, statisticTable=statisticTable, lan3=lan3, priority=priority, speed=speed, action=action, pauseTransmitted=pauseTransmitted, lanportName=lanportName, vendorOui=vendorOui, rebootEnable=rebootEnable, xg6846=xg6846, qmapping=qmapping, staticIpGateway=staticIpGateway, rxPower=rxPower, fileName=fileName, qosTable=qosTable, modeEntry=modeEntry, staticIpPrimaryDns=staticIpPrimaryDns, portName=portName, vlangroupTable=vlangroupTable, portPower=portPower, pauseReceived=pauseReceived, port1=port1, qosEntry=qosEntry, vlanid=vlanid, staticIpAddr=staticIpAddr, port3=port3, groupEntry=groupEntry, lanportTable=lanportTable, staticIpSubMask=staticIpSubMask, statIndex=statIndex, jumb=jumb, staticIpHostName=staticIpHostName, vendorName=vendorName, catvEnable=catvEnable, jumbwan=jumbwan, secondaryDns=secondaryDns, lanportpause=lanportpause, vendorPn=vendorPn, qosIndex=qosIndex, ddminfo=ddminfo, portTable=portTable, lan2=lan2, jumblan4=jumblan4, portmode=portmode, txPower=txPower, fileType=fileType, jumblan1=jumblan1, tftpSevIp=tftpSevIp, serialnum=serialnum, wanType=wanType, primaryDns=primaryDns, temperature=temperature, lanportspeed=lanportspeed, port4=port4, lan1=lan1, voltage=voltage, bias=bias, multicastsReceived=multicastsReceived, portIndex=portIndex, fcsErrorReceived=fcsErrorReceived)
