...
# Produced by pysmi-1.1.12 at Tue Sep 17 12:59:20 2024
...
NotificationType, mib_2, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, Unsigned32, ObjectIdentity, enterprises, Counter32, ModuleIdentity, snmpModules, iso, Bits, Integer32, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "mib-2", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "Unsigned32", "ObjectIdentity", "enterprises", "Counter32", "ModuleIdentity", "snmpModules", "iso", "Bits", "Integer32", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portStatistic=portStatistic, pauseTransmitted=pauseTransmitted, speed=speed, port3=port3, dscpEnable=dscpEnable, jumbwan=jumbwan, vlangroupTable=vlangroupTable, port2=port2, rebootEnable=rebootEnable, lanportIndex=lanportIndex, port4=port4, fcsErrorReceived=fcsErrorReceived, broadcastsReceived=broadcastsReceived, serialnum=serialnum, qmode=qmode, internetPort=internetPort, lan2=lan2, adminStatus=adminStatus, jumb=jumb, secondaryDns=secondaryDns, statisticTable=statisticTable, jumblan2=jumblan2, lanportpause=lanportpause, lan4=lan4, qosTable=qosTable, vendorRev=vendorRev, staticIpGateway=staticIpGateway, unicastsReceived=unicastsReceived, fileName=fileName, bias=bias, vendorPn=vendorPn, groupid=groupid, vlan=vlan, pauseReceived=pauseReceived, wan=wan, portmode=portmode, staticIpDomainName=staticIpDomainName, portEntry=portEntry, staticIpSubMask=staticIpSubMask, fileType=fileType, broadcastsTransmitted=broadcastsTransmitted, portName=portName, lanportspeed=lanportspeed, deviceinfo=deviceinfo, vlanid=vlanid, tftp=tftp, xg6846=xg6846, wanType=wanType, rxPower=rxPower, portStatEntry=portStatEntry, staticIpSecondaryDns=staticIpSecondaryDns, lanportTable=lanportTable, modeEntry=modeEntry, staticIpHostName=staticIpHostName, jumblan1=jumblan1, unicastsTransmitted=unicastsTransmitted, groupEntry=groupEntry, lan3=lan3, reboot=reboot, qosEntry=qosEntry, hostname=hostname, txPower=txPower, portTable=portTable, priority=priority, catvEnable=catvEnable, groupIndex=groupIndex, catv=catv, ddminfo=ddminfo, lan1=lan1, primaryDns=primaryDns, tftpSevIp=tftpSevIp, fcsErrorTransmitted=fcsErrorTransmitted, staticIpAddr=staticIpAddr, vendorName=vendorName, staticDns=staticDns, portIndex=portIndex, vendorOui=vendorOui, portPower=portPower, voltage=voltage, staticIpPrimaryDns=staticIpPrimaryDns, qosIndex=qosIndex, multicastsTransmitted=multicastsTransmitted, jumblan4=jumblan4, qos=qos, operStatus=operStatus, jumblan3=jumblan3, multicastsReceived=multicastsReceived, domainame=domainame, statIndex=statIndex, lanportName=lanportName, qmapping=qmapping, port1=port1, action=action, temperature=temperature)
