...
snmpModules, Integer32, Unsigned32, Bits, IpAddress, mib_2, ModuleIdentity, iso, Gauge32, Counter64, enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "Integer32", "Unsigned32", "Bits", "IpAddress", "mib-2", "ModuleIdentity", "iso", "Gauge32", "Counter64", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticDns=staticDns, qosIndex=qosIndex, broadcastsTransmitted=broadcastsTransmitted, broadcastsReceived=broadcastsReceived, vlanid=vlanid, port3=port3, jumblan2=jumblan2, multicastsTransmitted=multicastsTransmitted, lanportIndex=lanportIndex, adminStatus=adminStatus, temperature=temperature, staticIpHostName=staticIpHostName, vlan=vlan, staticIpDomainName=staticIpDomainName, jumblan4=jumblan4, jumb=jumb, speed=speed, secondaryDns=secondaryDns, ddminfo=ddminfo, groupid=groupid, portTable=portTable, catv=catv, lanportpause=lanportpause, jumblan3=jumblan3, jumbwan=jumbwan, qmode=qmode, wan=wan, portStatistic=portStatistic, modeEntry=modeEntry, internetPort=internetPort, tftpSevIp=tftpSevIp, port4=port4, staticIpGateway=staticIpGateway, groupIndex=groupIndex, statIndex=statIndex, vendorName=vendorName, unicastsTransmitted=unicastsTransmitted, bias=bias, serialnum=serialnum, priority=priority, vlangroupTable=vlangroupTable, primaryDns=primaryDns, deviceinfo=deviceinfo, fileName=fileName, portIndex=portIndex, staticIpSubMask=staticIpSubMask, fileType=fileType, tftp=tftp, lanportspeed=lanportspeed, wanType=wanType, rxPower=rxPower, lan2=lan2, staticIpSecondaryDns=staticIpSecondaryDns, action=action, xg6846=xg6846, lanportTable=lanportTable, groupEntry=groupEntry, jumblan1=jumblan1, staticIpPrimaryDns=staticIpPrimaryDns, rebootEnable=rebootEnable, staticIpAddr=staticIpAddr, fcsErrorReceived=fcsErrorReceived, reboot=reboot, lan4=lan4, unicastsReceived=unicastsReceived, lan3=lan3, statisticTable=statisticTable, catvEnable=catvEnable, pauseTransmitted=pauseTransmitted, portStatEntry=portStatEntry, port2=port2, port1=port1, hostname=hostname, voltage=voltage, qos=qos, vendorPn=vendorPn, qmapping=qmapping, fcsErrorTransmitted=fcsErrorTransmitted, portName=portName, lanportName=lanportName, domainame=domainame, dscpEnable=dscpEnable, pauseReceived=pauseReceived, txPower=txPower, lan1=lan1, portEntry=portEntry, portPower=portPower, qosTable=qosTable, multicastsReceived=multicastsReceived, qosEntry=qosEntry, operStatus=operStatus, vendorOui=vendorOui, portmode=portmode, vendorRev=vendorRev)
