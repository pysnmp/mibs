...
# Produced by pysmi-1.1.8 at Wed Sep 13 02:50:01 2023
...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, snmpModules, Gauge32, ModuleIdentity, Integer32, Bits, MibIdentifier, enterprises, Counter64, TimeTicks, Unsigned32, ObjectIdentity, iso, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "snmpModules", "Gauge32", "ModuleIdentity", "Integer32", "Bits", "MibIdentifier", "enterprises", "Counter64", "TimeTicks", "Unsigned32", "ObjectIdentity", "iso", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpPrimaryDns=staticIpPrimaryDns, lan3=lan3, unicastsReceived=unicastsReceived, broadcastsTransmitted=broadcastsTransmitted, fileType=fileType, secondaryDns=secondaryDns, priority=priority, portStatEntry=portStatEntry, lanportTable=lanportTable, wanType=wanType, statIndex=statIndex, rebootEnable=rebootEnable, reboot=reboot, tftp=tftp, port4=port4, pauseReceived=pauseReceived, fcsErrorTransmitted=fcsErrorTransmitted, modeEntry=modeEntry, lanportName=lanportName, xg6846=xg6846, action=action, deviceinfo=deviceinfo, dscpEnable=dscpEnable, vendorPn=vendorPn, pauseTransmitted=pauseTransmitted, temperature=temperature, ddminfo=ddminfo, jumbwan=jumbwan, portmode=portmode, fcsErrorReceived=fcsErrorReceived, voltage=voltage, portIndex=portIndex, groupIndex=groupIndex, unicastsTransmitted=unicastsTransmitted, vendorOui=vendorOui, staticIpSubMask=staticIpSubMask, qosEntry=qosEntry, vendorRev=vendorRev, domainame=domainame, hostname=hostname, vlangroupTable=vlangroupTable, operStatus=operStatus, broadcastsReceived=broadcastsReceived, portStatistic=portStatistic, multicastsTransmitted=multicastsTransmitted, serialnum=serialnum, staticDns=staticDns, statisticTable=statisticTable, fileName=fileName, groupid=groupid, lanportspeed=lanportspeed, qosTable=qosTable, lan4=lan4, jumblan3=jumblan3, catvEnable=catvEnable, portPower=portPower, qmode=qmode, qosIndex=qosIndex, lan1=lan1, qmapping=qmapping, groupEntry=groupEntry, internetPort=internetPort, staticIpHostName=staticIpHostName, multicastsReceived=multicastsReceived, rxPower=rxPower, lanportpause=lanportpause, wan=wan, staticIpSecondaryDns=staticIpSecondaryDns, port1=port1, speed=speed, vendorName=vendorName, port2=port2, staticIpDomainName=staticIpDomainName, txPower=txPower, jumblan1=jumblan1, lanportIndex=lanportIndex, jumblan2=jumblan2, portEntry=portEntry, port3=port3, vlan=vlan, catv=catv, jumblan4=jumblan4, lan2=lan2, primaryDns=primaryDns, portTable=portTable, staticIpAddr=staticIpAddr, staticIpGateway=staticIpGateway, portName=portName, tftpSevIp=tftpSevIp, jumb=jumb, qos=qos, adminStatus=adminStatus, bias=bias, vlanid=vlanid)
