...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:30:02 2022
...
snmpModules, Gauge32, Counter64, MibIdentifier, Bits, IpAddress, mib_2, Integer32, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks, Unsigned32, enterprises, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "Gauge32", "Counter64", "MibIdentifier", "Bits", "IpAddress", "mib-2", "Integer32", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks", "Unsigned32", "enterprises", "ModuleIdentity", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", hostname=hostname, port4=port4, groupid=groupid, jumblan1=jumblan1, tftp=tftp, qosEntry=qosEntry, catvEnable=catvEnable, fcsErrorReceived=fcsErrorReceived, primaryDns=primaryDns, serialnum=serialnum, lanportTable=lanportTable, dscpEnable=dscpEnable, statIndex=statIndex, staticDns=staticDns, groupIndex=groupIndex, qmapping=qmapping, vlan=vlan, vlanid=vlanid, staticIpAddr=staticIpAddr, broadcastsTransmitted=broadcastsTransmitted, xg6846=xg6846, voltage=voltage, portmode=portmode, unicastsTransmitted=unicastsTransmitted, lan1=lan1, ddminfo=ddminfo, portPower=portPower, lanportName=lanportName, tftpSevIp=tftpSevIp, internetPort=internetPort, qosTable=qosTable, operStatus=operStatus, lan2=lan2, portEntry=portEntry, staticIpPrimaryDns=staticIpPrimaryDns, fileName=fileName, lanportspeed=lanportspeed, statisticTable=statisticTable, wanType=wanType, vlangroupTable=vlangroupTable, vendorRev=vendorRev, vendorOui=vendorOui, domainame=domainame, staticIpHostName=staticIpHostName, rebootEnable=rebootEnable, rxPower=rxPower, portStatEntry=portStatEntry, unicastsReceived=unicastsReceived, lanportIndex=lanportIndex, modeEntry=modeEntry, fileType=fileType, temperature=temperature, deviceinfo=deviceinfo, jumblan2=jumblan2, adminStatus=adminStatus, port1=port1, staticIpSecondaryDns=staticIpSecondaryDns, port3=port3, jumbwan=jumbwan, jumblan4=jumblan4, action=action, wan=wan, catv=catv, jumblan3=jumblan3, jumb=jumb, reboot=reboot, priority=priority, vendorPn=vendorPn, fcsErrorTransmitted=fcsErrorTransmitted, vendorName=vendorName, lan4=lan4, bias=bias, staticIpSubMask=staticIpSubMask, staticIpDomainName=staticIpDomainName, pauseTransmitted=pauseTransmitted, secondaryDns=secondaryDns, broadcastsReceived=broadcastsReceived, qmode=qmode, portStatistic=portStatistic, qos=qos, staticIpGateway=staticIpGateway, groupEntry=groupEntry, lanportpause=lanportpause, qosIndex=qosIndex, speed=speed, pauseReceived=pauseReceived, multicastsReceived=multicastsReceived, txPower=txPower, portTable=portTable, port2=port2, portIndex=portIndex, portName=portName, lan3=lan3, multicastsTransmitted=multicastsTransmitted)
