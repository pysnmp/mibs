...
# Produced by pysmi-1.1.8 at Fri Sep  8 08:03:33 2023
...
iso, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, enterprises, ObjectIdentity, TimeTicks, NotificationType, IpAddress, Integer32, Bits, ModuleIdentity, Counter64, snmpModules, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "enterprises", "ObjectIdentity", "TimeTicks", "NotificationType", "IpAddress", "Integer32", "Bits", "ModuleIdentity", "Counter64", "snmpModules", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", modeEntry=modeEntry, jumb=jumb, portEntry=portEntry, domainame=domainame, lanportTable=lanportTable, lanportName=lanportName, voltage=voltage, action=action, broadcastsTransmitted=broadcastsTransmitted, ddminfo=ddminfo, reboot=reboot, bias=bias, lanportpause=lanportpause, rebootEnable=rebootEnable, temperature=temperature, operStatus=operStatus, deviceinfo=deviceinfo, port2=port2, secondaryDns=secondaryDns, multicastsTransmitted=multicastsTransmitted, wan=wan, groupEntry=groupEntry, vlan=vlan, adminStatus=adminStatus, port1=port1, unicastsReceived=unicastsReceived, speed=speed, jumblan2=jumblan2, qmode=qmode, vendorOui=vendorOui, staticIpSubMask=staticIpSubMask, unicastsTransmitted=unicastsTransmitted, fcsErrorReceived=fcsErrorReceived, port4=port4, statisticTable=statisticTable, xg6846=xg6846, tftpSevIp=tftpSevIp, catv=catv, internetPort=internetPort, portmode=portmode, priority=priority, qosIndex=qosIndex, lan2=lan2, staticIpGateway=staticIpGateway, portTable=portTable, statIndex=statIndex, broadcastsReceived=broadcastsReceived, vlangroupTable=vlangroupTable, fileType=fileType, lanportIndex=lanportIndex, lan3=lan3, dscpEnable=dscpEnable, staticIpSecondaryDns=staticIpSecondaryDns, staticIpDomainName=staticIpDomainName, pauseReceived=pauseReceived, lanportspeed=lanportspeed, qmapping=qmapping, staticIpAddr=staticIpAddr, rxPower=rxPower, staticIpPrimaryDns=staticIpPrimaryDns, jumblan4=jumblan4, staticDns=staticDns, fcsErrorTransmitted=fcsErrorTransmitted, pauseTransmitted=pauseTransmitted, tftp=tftp, vlanid=vlanid, qosEntry=qosEntry, groupIndex=groupIndex, portIndex=portIndex, lan1=lan1, vendorPn=vendorPn, catvEnable=catvEnable, serialnum=serialnum, jumbwan=jumbwan, jumblan1=jumblan1, wanType=wanType, multicastsReceived=multicastsReceived, port3=port3, vendorName=vendorName, hostname=hostname, portName=portName, lan4=lan4, qos=qos, qosTable=qosTable, portStatistic=portStatistic, jumblan3=jumblan3, staticIpHostName=staticIpHostName, vendorRev=vendorRev, groupid=groupid, portPower=portPower, txPower=txPower, primaryDns=primaryDns, portStatEntry=portStatEntry, fileName=fileName)
