...
# Produced by pysmi-1.1.12 at Thu Apr  4 10:13:55 2024
...
MibIdentifier, Integer32, iso, Unsigned32, ModuleIdentity, IpAddress, Gauge32, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, mib_2, Counter64, NotificationType, enterprises, snmpModules, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "iso", "Unsigned32", "ModuleIdentity", "IpAddress", "Gauge32", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "mib-2", "Counter64", "NotificationType", "enterprises", "snmpModules", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpHostName=staticIpHostName, xg6846=xg6846, primaryDns=primaryDns, temperature=temperature, portName=portName, staticIpSecondaryDns=staticIpSecondaryDns, port2=port2, portmode=portmode, jumbwan=jumbwan, dscpEnable=dscpEnable, portStatEntry=portStatEntry, fileType=fileType, fcsErrorReceived=fcsErrorReceived, vendorPn=vendorPn, broadcastsReceived=broadcastsReceived, adminStatus=adminStatus, catv=catv, staticIpSubMask=staticIpSubMask, qosEntry=qosEntry, multicastsReceived=multicastsReceived, staticIpDomainName=staticIpDomainName, vendorName=vendorName, jumblan3=jumblan3, port4=port4, internetPort=internetPort, voltage=voltage, wan=wan, staticDns=staticDns, rxPower=rxPower, operStatus=operStatus, vendorRev=vendorRev, jumblan2=jumblan2, modeEntry=modeEntry, statisticTable=statisticTable, domainame=domainame, port1=port1, groupIndex=groupIndex, action=action, groupid=groupid, catvEnable=catvEnable, tftp=tftp, lan4=lan4, lan1=lan1, secondaryDns=secondaryDns, pauseTransmitted=pauseTransmitted, pauseReceived=pauseReceived, portStatistic=portStatistic, qos=qos, jumb=jumb, qmode=qmode, rebootEnable=rebootEnable, qmapping=qmapping, serialnum=serialnum, unicastsReceived=unicastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, staticIpAddr=staticIpAddr, bias=bias, vlangroupTable=vlangroupTable, ddminfo=ddminfo, speed=speed, priority=priority, lanportIndex=lanportIndex, deviceinfo=deviceinfo, vlanid=vlanid, portIndex=portIndex, lan2=lan2, portEntry=portEntry, groupEntry=groupEntry, broadcastsTransmitted=broadcastsTransmitted, fileName=fileName, tftpSevIp=tftpSevIp, port3=port3, jumblan1=jumblan1, lanportspeed=lanportspeed, staticIpGateway=staticIpGateway, portTable=portTable, lanportName=lanportName, multicastsTransmitted=multicastsTransmitted, hostname=hostname, qosIndex=qosIndex, staticIpPrimaryDns=staticIpPrimaryDns, jumblan4=jumblan4, vendorOui=vendorOui, reboot=reboot, lanportTable=lanportTable, portPower=portPower, txPower=txPower, lanportpause=lanportpause, unicastsTransmitted=unicastsTransmitted, vlan=vlan, qosTable=qosTable, lan3=lan3, statIndex=statIndex, wanType=wanType)
