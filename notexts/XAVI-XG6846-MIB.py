...
TimeTicks, Counter32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Unsigned32, NotificationType, Integer32, IpAddress, iso, Bits, Gauge32, ObjectIdentity, MibIdentifier, snmpModules, ModuleIdentity, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Unsigned32", "NotificationType", "Integer32", "IpAddress", "iso", "Bits", "Gauge32", "ObjectIdentity", "MibIdentifier", "snmpModules", "ModuleIdentity", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", unicastsReceived=unicastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, vendorRev=vendorRev, portTable=portTable, portIndex=portIndex, portStatEntry=portStatEntry, action=action, staticIpSubMask=staticIpSubMask, fileName=fileName, statIndex=statIndex, voltage=voltage, vlanid=vlanid, internetPort=internetPort, dscpEnable=dscpEnable, jumblan4=jumblan4, vlan=vlan, hostname=hostname, speed=speed, qosIndex=qosIndex, groupEntry=groupEntry, port1=port1, lan1=lan1, port3=port3, fcsErrorReceived=fcsErrorReceived, groupIndex=groupIndex, broadcastsReceived=broadcastsReceived, catvEnable=catvEnable, qosEntry=qosEntry, pauseReceived=pauseReceived, operStatus=operStatus, staticIpGateway=staticIpGateway, lanportpause=lanportpause, reboot=reboot, portPower=portPower, qmode=qmode, temperature=temperature, pauseTransmitted=pauseTransmitted, domainame=domainame, wan=wan, multicastsReceived=multicastsReceived, portName=portName, lanportspeed=lanportspeed, staticDns=staticDns, multicastsTransmitted=multicastsTransmitted, staticIpAddr=staticIpAddr, wanType=wanType, portmode=portmode, lan2=lan2, vendorOui=vendorOui, priority=priority, qos=qos, lan4=lan4, port2=port2, statisticTable=statisticTable, modeEntry=modeEntry, jumb=jumb, staticIpPrimaryDns=staticIpPrimaryDns, vendorName=vendorName, vendorPn=vendorPn, secondaryDns=secondaryDns, jumbwan=jumbwan, ddminfo=ddminfo, staticIpDomainName=staticIpDomainName, unicastsTransmitted=unicastsTransmitted, tftpSevIp=tftpSevIp, staticIpSecondaryDns=staticIpSecondaryDns, portEntry=portEntry, fileType=fileType, jumblan1=jumblan1, port4=port4, catv=catv, qosTable=qosTable, groupid=groupid, vlangroupTable=vlangroupTable, txPower=txPower, deviceinfo=deviceinfo, jumblan2=jumblan2, lanportIndex=lanportIndex, lan3=lan3, xg6846=xg6846, portStatistic=portStatistic, rxPower=rxPower, adminStatus=adminStatus, lanportTable=lanportTable, lanportName=lanportName, rebootEnable=rebootEnable, primaryDns=primaryDns, jumblan3=jumblan3, broadcastsTransmitted=broadcastsTransmitted, tftp=tftp, serialnum=serialnum, qmapping=qmapping, staticIpHostName=staticIpHostName, bias=bias)
