...
MibIdentifier, enterprises, Unsigned32, Counter32, Gauge32, TimeTicks, ObjectIdentity, snmpModules, ModuleIdentity, iso, Integer32, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, mib_2, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "enterprises", "Unsigned32", "Counter32", "Gauge32", "TimeTicks", "ObjectIdentity", "snmpModules", "ModuleIdentity", "iso", "Integer32", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "mib-2", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portName=portName, staticIpHostName=staticIpHostName, lanportTable=lanportTable, staticIpPrimaryDns=staticIpPrimaryDns, bias=bias, portPower=portPower, lan4=lan4, portmode=portmode, multicastsReceived=multicastsReceived, staticIpDomainName=staticIpDomainName, voltage=voltage, groupid=groupid, lanportName=lanportName, secondaryDns=secondaryDns, lan1=lan1, qmode=qmode, fileType=fileType, staticIpAddr=staticIpAddr, txPower=txPower, rebootEnable=rebootEnable, portEntry=portEntry, broadcastsReceived=broadcastsReceived, vendorOui=vendorOui, tftp=tftp, hostname=hostname, staticIpSubMask=staticIpSubMask, jumbwan=jumbwan, multicastsTransmitted=multicastsTransmitted, rxPower=rxPower, port3=port3, jumblan3=jumblan3, fileName=fileName, vendorPn=vendorPn, adminStatus=adminStatus, groupEntry=groupEntry, lan2=lan2, priority=priority, unicastsReceived=unicastsReceived, fcsErrorReceived=fcsErrorReceived, lan3=lan3, reboot=reboot, jumblan2=jumblan2, portIndex=portIndex, tftpSevIp=tftpSevIp, vendorName=vendorName, pauseReceived=pauseReceived, temperature=temperature, deviceinfo=deviceinfo, wan=wan, vlangroupTable=vlangroupTable, lanportpause=lanportpause, vendorRev=vendorRev, xg6846=xg6846, qosEntry=qosEntry, jumb=jumb, wanType=wanType, qosIndex=qosIndex, unicastsTransmitted=unicastsTransmitted, port4=port4, jumblan1=jumblan1, primaryDns=primaryDns, jumblan4=jumblan4, fcsErrorTransmitted=fcsErrorTransmitted, catvEnable=catvEnable, vlanid=vlanid, domainame=domainame, qmapping=qmapping, port1=port1, modeEntry=modeEntry, port2=port2, portStatistic=portStatistic, broadcastsTransmitted=broadcastsTransmitted, portStatEntry=portStatEntry, vlan=vlan, qos=qos, portTable=portTable, statisticTable=statisticTable, operStatus=operStatus, statIndex=statIndex, lanportspeed=lanportspeed, staticIpSecondaryDns=staticIpSecondaryDns, dscpEnable=dscpEnable, ddminfo=ddminfo, staticDns=staticDns, lanportIndex=lanportIndex, staticIpGateway=staticIpGateway, internetPort=internetPort, catv=catv, serialnum=serialnum, qosTable=qosTable, action=action, groupIndex=groupIndex, pauseTransmitted=pauseTransmitted, speed=speed)
