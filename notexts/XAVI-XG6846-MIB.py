...
Counter64, Unsigned32, Integer32, snmpModules, Bits, Gauge32, enterprises, ModuleIdentity, NotificationType, ObjectIdentity, Counter32, MibIdentifier, IpAddress, mib_2, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Unsigned32", "Integer32", "snmpModules", "Bits", "Gauge32", "enterprises", "ModuleIdentity", "NotificationType", "ObjectIdentity", "Counter32", "MibIdentifier", "IpAddress", "mib-2", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", adminStatus=adminStatus, portStatistic=portStatistic, reboot=reboot, serialnum=serialnum, port1=port1, jumblan4=jumblan4, statisticTable=statisticTable, jumbwan=jumbwan, port2=port2, unicastsReceived=unicastsReceived, tftpSevIp=tftpSevIp, staticIpSubMask=staticIpSubMask, staticIpAddr=staticIpAddr, modeEntry=modeEntry, lan1=lan1, txPower=txPower, qosIndex=qosIndex, jumblan1=jumblan1, wan=wan, portStatEntry=portStatEntry, lan2=lan2, vendorName=vendorName, vendorOui=vendorOui, xg6846=xg6846, lanportIndex=lanportIndex, pauseTransmitted=pauseTransmitted, portName=portName, broadcastsReceived=broadcastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, vlangroupTable=vlangroupTable, multicastsReceived=multicastsReceived, portIndex=portIndex, speed=speed, staticIpGateway=staticIpGateway, secondaryDns=secondaryDns, staticIpHostName=staticIpHostName, fileType=fileType, lanportName=lanportName, operStatus=operStatus, vendorRev=vendorRev, statIndex=statIndex, staticIpSecondaryDns=staticIpSecondaryDns, primaryDns=primaryDns, rebootEnable=rebootEnable, temperature=temperature, qos=qos, action=action, catvEnable=catvEnable, staticDns=staticDns, jumblan2=jumblan2, qmode=qmode, groupIndex=groupIndex, voltage=voltage, port4=port4, portPower=portPower, jumblan3=jumblan3, broadcastsTransmitted=broadcastsTransmitted, catv=catv, pauseReceived=pauseReceived, rxPower=rxPower, lan4=lan4, staticIpPrimaryDns=staticIpPrimaryDns, deviceinfo=deviceinfo, tftp=tftp, vendorPn=vendorPn, portTable=portTable, port3=port3, lanportspeed=lanportspeed, qosEntry=qosEntry, hostname=hostname, jumb=jumb, qmapping=qmapping, groupid=groupid, portmode=portmode, priority=priority, internetPort=internetPort, portEntry=portEntry, lan3=lan3, fileName=fileName, multicastsTransmitted=multicastsTransmitted, unicastsTransmitted=unicastsTransmitted, vlan=vlan, lanportpause=lanportpause, ddminfo=ddminfo, wanType=wanType, dscpEnable=dscpEnable, staticIpDomainName=staticIpDomainName, vlanid=vlanid, qosTable=qosTable, groupEntry=groupEntry, domainame=domainame, fcsErrorReceived=fcsErrorReceived, bias=bias, lanportTable=lanportTable)
