...
# Produced by pysmi-1.1.12 at Wed Jul  3 10:48:17 2024
...
IpAddress, Bits, mib_2, Counter32, TimeTicks, NotificationType, Counter64, Gauge32, enterprises, Unsigned32, snmpModules, iso, ObjectIdentity, MibIdentifier, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "mib-2", "Counter32", "TimeTicks", "NotificationType", "Counter64", "Gauge32", "enterprises", "Unsigned32", "snmpModules", "iso", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", bias=bias, txPower=txPower, portName=portName, temperature=temperature, deviceinfo=deviceinfo, fcsErrorReceived=fcsErrorReceived, staticIpPrimaryDns=staticIpPrimaryDns, speed=speed, qosTable=qosTable, xg6846=xg6846, operStatus=operStatus, lanportTable=lanportTable, port3=port3, internetPort=internetPort, pauseTransmitted=pauseTransmitted, groupIndex=groupIndex, rxPower=rxPower, staticIpAddr=staticIpAddr, lan3=lan3, vlanid=vlanid, staticDns=staticDns, broadcastsTransmitted=broadcastsTransmitted, vlan=vlan, port4=port4, qmode=qmode, fileType=fileType, tftp=tftp, lanportpause=lanportpause, lan1=lan1, unicastsTransmitted=unicastsTransmitted, adminStatus=adminStatus, wan=wan, jumblan4=jumblan4, jumb=jumb, qmapping=qmapping, hostname=hostname, ddminfo=ddminfo, portmode=portmode, lanportspeed=lanportspeed, qosIndex=qosIndex, voltage=voltage, modeEntry=modeEntry, groupid=groupid, portIndex=portIndex, action=action, staticIpSubMask=staticIpSubMask, portStatistic=portStatistic, domainame=domainame, multicastsReceived=multicastsReceived, catv=catv, jumblan1=jumblan1, qos=qos, broadcastsReceived=broadcastsReceived, portPower=portPower, dscpEnable=dscpEnable, vendorOui=vendorOui, reboot=reboot, lanportName=lanportName, jumbwan=jumbwan, groupEntry=groupEntry, serialnum=serialnum, wanType=wanType, portTable=portTable, rebootEnable=rebootEnable, statIndex=statIndex, catvEnable=catvEnable, lanportIndex=lanportIndex, staticIpHostName=staticIpHostName, multicastsTransmitted=multicastsTransmitted, vlangroupTable=vlangroupTable, qosEntry=qosEntry, portStatEntry=portStatEntry, vendorName=vendorName, pauseReceived=pauseReceived, statisticTable=statisticTable, portEntry=portEntry, staticIpDomainName=staticIpDomainName, port2=port2, fcsErrorTransmitted=fcsErrorTransmitted, tftpSevIp=tftpSevIp, secondaryDns=secondaryDns, jumblan3=jumblan3, vendorPn=vendorPn, port1=port1, jumblan2=jumblan2, staticIpGateway=staticIpGateway, primaryDns=primaryDns, lan4=lan4, unicastsReceived=unicastsReceived, vendorRev=vendorRev, lan2=lan2, priority=priority, staticIpSecondaryDns=staticIpSecondaryDns, fileName=fileName)
