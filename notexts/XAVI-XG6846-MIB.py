...
Counter32, NotificationType, ModuleIdentity, IpAddress, Bits, MibIdentifier, snmpModules, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, enterprises, ObjectIdentity, Counter64, iso, Gauge32, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "ModuleIdentity", "IpAddress", "Bits", "MibIdentifier", "snmpModules", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "enterprises", "ObjectIdentity", "Counter64", "iso", "Gauge32", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportTable=lanportTable, lan2=lan2, secondaryDns=secondaryDns, staticIpGateway=staticIpGateway, broadcastsTransmitted=broadcastsTransmitted, voltage=voltage, serialnum=serialnum, qosIndex=qosIndex, qosTable=qosTable, dscpEnable=dscpEnable, domainame=domainame, txPower=txPower, staticIpHostName=staticIpHostName, vendorOui=vendorOui, adminStatus=adminStatus, unicastsReceived=unicastsReceived, portIndex=portIndex, fcsErrorReceived=fcsErrorReceived, action=action, hostname=hostname, catvEnable=catvEnable, groupEntry=groupEntry, portPower=portPower, jumblan3=jumblan3, port3=port3, rxPower=rxPower, multicastsReceived=multicastsReceived, temperature=temperature, port1=port1, primaryDns=primaryDns, qmapping=qmapping, pauseReceived=pauseReceived, portEntry=portEntry, wanType=wanType, statIndex=statIndex, statisticTable=statisticTable, vlanid=vlanid, operStatus=operStatus, jumb=jumb, groupid=groupid, lan3=lan3, lanportIndex=lanportIndex, jumblan1=jumblan1, vlan=vlan, jumblan2=jumblan2, catv=catv, groupIndex=groupIndex, xg6846=xg6846, portName=portName, staticIpSubMask=staticIpSubMask, staticIpPrimaryDns=staticIpPrimaryDns, qosEntry=qosEntry, priority=priority, port2=port2, speed=speed, staticIpDomainName=staticIpDomainName, port4=port4, unicastsTransmitted=unicastsTransmitted, broadcastsReceived=broadcastsReceived, portStatEntry=portStatEntry, multicastsTransmitted=multicastsTransmitted, bias=bias, internetPort=internetPort, tftp=tftp, staticIpAddr=staticIpAddr, fileType=fileType, portTable=portTable, jumbwan=jumbwan, lan1=lan1, staticIpSecondaryDns=staticIpSecondaryDns, jumblan4=jumblan4, ddminfo=ddminfo, portmode=portmode, tftpSevIp=tftpSevIp, staticDns=staticDns, pauseTransmitted=pauseTransmitted, fileName=fileName, deviceinfo=deviceinfo, lanportspeed=lanportspeed, qmode=qmode, vlangroupTable=vlangroupTable, vendorName=vendorName, qos=qos, lanportpause=lanportpause, rebootEnable=rebootEnable, reboot=reboot, lanportName=lanportName, portStatistic=portStatistic, lan4=lan4, vendorPn=vendorPn, modeEntry=modeEntry, wan=wan, vendorRev=vendorRev, fcsErrorTransmitted=fcsErrorTransmitted)
