...
iso, NotificationType, enterprises, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Unsigned32, Bits, Integer32, TimeTicks, Gauge32, MibIdentifier, IpAddress, Counter32, ModuleIdentity, ObjectIdentity, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "enterprises", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Unsigned32", "Bits", "Integer32", "TimeTicks", "Gauge32", "MibIdentifier", "IpAddress", "Counter32", "ModuleIdentity", "ObjectIdentity", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", tftpSevIp=tftpSevIp, lan2=lan2, lanportName=lanportName, speed=speed, portStatistic=portStatistic, portStatEntry=portStatEntry, staticIpAddr=staticIpAddr, groupIndex=groupIndex, statisticTable=statisticTable, unicastsReceived=unicastsReceived, temperature=temperature, lan4=lan4, jumblan2=jumblan2, jumblan3=jumblan3, unicastsTransmitted=unicastsTransmitted, statIndex=statIndex, catv=catv, vendorOui=vendorOui, secondaryDns=secondaryDns, multicastsReceived=multicastsReceived, portEntry=portEntry, staticIpSecondaryDns=staticIpSecondaryDns, lan1=lan1, qos=qos, portTable=portTable, qosIndex=qosIndex, staticIpGateway=staticIpGateway, port2=port2, lanportIndex=lanportIndex, staticIpDomainName=staticIpDomainName, groupid=groupid, dscpEnable=dscpEnable, deviceinfo=deviceinfo, internetPort=internetPort, staticDns=staticDns, operStatus=operStatus, qosEntry=qosEntry, fileName=fileName, portName=portName, primaryDns=primaryDns, catvEnable=catvEnable, vendorPn=vendorPn, tftp=tftp, adminStatus=adminStatus, lan3=lan3, vendorRev=vendorRev, broadcastsReceived=broadcastsReceived, vlanid=vlanid, staticIpPrimaryDns=staticIpPrimaryDns, staticIpSubMask=staticIpSubMask, qmapping=qmapping, xg6846=xg6846, rebootEnable=rebootEnable, reboot=reboot, ddminfo=ddminfo, fcsErrorReceived=fcsErrorReceived, wanType=wanType, bias=bias, lanportspeed=lanportspeed, jumblan1=jumblan1, vlangroupTable=vlangroupTable, hostname=hostname, modeEntry=modeEntry, wan=wan, rxPower=rxPower, fcsErrorTransmitted=fcsErrorTransmitted, portPower=portPower, vendorName=vendorName, groupEntry=groupEntry, qmode=qmode, serialnum=serialnum, jumbwan=jumbwan, broadcastsTransmitted=broadcastsTransmitted, multicastsTransmitted=multicastsTransmitted, portIndex=portIndex, priority=priority, staticIpHostName=staticIpHostName, lanportpause=lanportpause, action=action, voltage=voltage, pauseReceived=pauseReceived, qosTable=qosTable, vlan=vlan, port4=port4, port1=port1, jumblan4=jumblan4, pauseTransmitted=pauseTransmitted, fileType=fileType, port3=port3, portmode=portmode, txPower=txPower, lanportTable=lanportTable, jumb=jumb, domainame=domainame)
