...
# Produced by pysmi-1.1.12 at Mon Jun  3 11:17:36 2024
...
Counter32, IpAddress, NotificationType, mib_2, Counter64, ModuleIdentity, MibIdentifier, Bits, Gauge32, Unsigned32, snmpModules, Integer32, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "NotificationType", "mib-2", "Counter64", "ModuleIdentity", "MibIdentifier", "Bits", "Gauge32", "Unsigned32", "snmpModules", "Integer32", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpPrimaryDns=staticIpPrimaryDns, staticIpHostName=staticIpHostName, xg6846=xg6846, hostname=hostname, groupEntry=groupEntry, qmode=qmode, catv=catv, adminStatus=adminStatus, fileName=fileName, txPower=txPower, lan2=lan2, jumblan1=jumblan1, domainame=domainame, portEntry=portEntry, jumb=jumb, staticIpDomainName=staticIpDomainName, action=action, unicastsTransmitted=unicastsTransmitted, staticIpSubMask=staticIpSubMask, fileType=fileType, bias=bias, tftp=tftp, multicastsTransmitted=multicastsTransmitted, port3=port3, qosEntry=qosEntry, statIndex=statIndex, reboot=reboot, vendorPn=vendorPn, portPower=portPower, vlangroupTable=vlangroupTable, jumbwan=jumbwan, staticDns=staticDns, rebootEnable=rebootEnable, lanportpause=lanportpause, portName=portName, broadcastsReceived=broadcastsReceived, vlan=vlan, modeEntry=modeEntry, unicastsReceived=unicastsReceived, serialnum=serialnum, temperature=temperature, deviceinfo=deviceinfo, speed=speed, qmapping=qmapping, vlanid=vlanid, port4=port4, qos=qos, portIndex=portIndex, operStatus=operStatus, qosIndex=qosIndex, vendorRev=vendorRev, pauseReceived=pauseReceived, catvEnable=catvEnable, jumblan4=jumblan4, fcsErrorTransmitted=fcsErrorTransmitted, vendorName=vendorName, tftpSevIp=tftpSevIp, lanportName=lanportName, fcsErrorReceived=fcsErrorReceived, secondaryDns=secondaryDns, port2=port2, statisticTable=statisticTable, broadcastsTransmitted=broadcastsTransmitted, internetPort=internetPort, portTable=portTable, jumblan2=jumblan2, staticIpGateway=staticIpGateway, multicastsReceived=multicastsReceived, ddminfo=ddminfo, groupIndex=groupIndex, lanportspeed=lanportspeed, voltage=voltage, lanportIndex=lanportIndex, dscpEnable=dscpEnable, staticIpAddr=staticIpAddr, lanportTable=lanportTable, wanType=wanType, port1=port1, primaryDns=primaryDns, portStatistic=portStatistic, vendorOui=vendorOui, staticIpSecondaryDns=staticIpSecondaryDns, lan4=lan4, wan=wan, pauseTransmitted=pauseTransmitted, lan1=lan1, portmode=portmode, portStatEntry=portStatEntry, rxPower=rxPower, jumblan3=jumblan3, priority=priority, lan3=lan3, groupid=groupid, qosTable=qosTable)
