...
# Produced by pysmi-1.1.8 at Wed Sep 13 07:28:22 2023
...
Bits, Gauge32, MibIdentifier, ObjectIdentity, Unsigned32, Integer32, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks, IpAddress, snmpModules, mib_2, Counter64, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "MibIdentifier", "ObjectIdentity", "Unsigned32", "Integer32", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks", "IpAddress", "snmpModules", "mib-2", "Counter64", "iso", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qmode=qmode, staticDns=staticDns, vendorOui=vendorOui, bias=bias, voltage=voltage, port2=port2, portStatEntry=portStatEntry, portmode=portmode, jumblan4=jumblan4, internetPort=internetPort, staticIpAddr=staticIpAddr, portPower=portPower, lanportpause=lanportpause, vlan=vlan, port1=port1, qosIndex=qosIndex, staticIpGateway=staticIpGateway, rebootEnable=rebootEnable, tftp=tftp, jumb=jumb, pauseTransmitted=pauseTransmitted, secondaryDns=secondaryDns, lan4=lan4, modeEntry=modeEntry, wan=wan, groupEntry=groupEntry, lanportName=lanportName, dscpEnable=dscpEnable, hostname=hostname, lan2=lan2, broadcastsTransmitted=broadcastsTransmitted, qmapping=qmapping, lanportspeed=lanportspeed, catv=catv, lanportTable=lanportTable, groupIndex=groupIndex, lanportIndex=lanportIndex, statisticTable=statisticTable, primaryDns=primaryDns, unicastsReceived=unicastsReceived, staticIpHostName=staticIpHostName, fileName=fileName, port4=port4, groupid=groupid, reboot=reboot, ddminfo=ddminfo, tftpSevIp=tftpSevIp, deviceinfo=deviceinfo, lan3=lan3, staticIpSubMask=staticIpSubMask, portName=portName, vlanid=vlanid, jumblan3=jumblan3, vendorPn=vendorPn, fileType=fileType, temperature=temperature, wanType=wanType, vendorName=vendorName, staticIpSecondaryDns=staticIpSecondaryDns, rxPower=rxPower, serialnum=serialnum, portEntry=portEntry, lan1=lan1, operStatus=operStatus, priority=priority, staticIpDomainName=staticIpDomainName, multicastsTransmitted=multicastsTransmitted, qosEntry=qosEntry, port3=port3, multicastsReceived=multicastsReceived, jumblan1=jumblan1, broadcastsReceived=broadcastsReceived, vlangroupTable=vlangroupTable, action=action, xg6846=xg6846, qosTable=qosTable, catvEnable=catvEnable, portStatistic=portStatistic, statIndex=statIndex, pauseReceived=pauseReceived, jumblan2=jumblan2, portIndex=portIndex, portTable=portTable, unicastsTransmitted=unicastsTransmitted, adminStatus=adminStatus, vendorRev=vendorRev, staticIpPrimaryDns=staticIpPrimaryDns, speed=speed, qos=qos, fcsErrorReceived=fcsErrorReceived, domainame=domainame, jumbwan=jumbwan, txPower=txPower, fcsErrorTransmitted=fcsErrorTransmitted)
