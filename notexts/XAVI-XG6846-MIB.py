...
Integer32, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, TimeTicks, Gauge32, mib_2, Unsigned32, NotificationType, snmpModules, enterprises, ModuleIdentity, Counter32, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "TimeTicks", "Gauge32", "mib-2", "Unsigned32", "NotificationType", "snmpModules", "enterprises", "ModuleIdentity", "Counter32", "Bits", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorPn=vendorPn, modeEntry=modeEntry, port3=port3, groupEntry=groupEntry, txPower=txPower, qmode=qmode, qos=qos, vendorRev=vendorRev, port4=port4, priority=priority, lan4=lan4, lanportName=lanportName, staticIpAddr=staticIpAddr, staticIpGateway=staticIpGateway, staticIpSubMask=staticIpSubMask, lanportTable=lanportTable, portmode=portmode, deviceinfo=deviceinfo, lanportpause=lanportpause, groupIndex=groupIndex, statIndex=statIndex, staticIpHostName=staticIpHostName, xg6846=xg6846, reboot=reboot, broadcastsReceived=broadcastsReceived, portName=portName, jumbwan=jumbwan, internetPort=internetPort, fcsErrorTransmitted=fcsErrorTransmitted, port2=port2, fcsErrorReceived=fcsErrorReceived, tftp=tftp, vendorOui=vendorOui, pauseReceived=pauseReceived, tftpSevIp=tftpSevIp, fileName=fileName, unicastsReceived=unicastsReceived, unicastsTransmitted=unicastsTransmitted, jumblan1=jumblan1, voltage=voltage, hostname=hostname, statisticTable=statisticTable, catv=catv, staticIpDomainName=staticIpDomainName, wanType=wanType, pauseTransmitted=pauseTransmitted, speed=speed, qosIndex=qosIndex, lanportIndex=lanportIndex, qosEntry=qosEntry, portStatEntry=portStatEntry, port1=port1, vendorName=vendorName, temperature=temperature, vlanid=vlanid, serialnum=serialnum, lanportspeed=lanportspeed, portIndex=portIndex, bias=bias, jumblan3=jumblan3, ddminfo=ddminfo, qmapping=qmapping, staticIpPrimaryDns=staticIpPrimaryDns, portStatistic=portStatistic, vlangroupTable=vlangroupTable, vlan=vlan, portTable=portTable, secondaryDns=secondaryDns, portPower=portPower, fileType=fileType, lan1=lan1, jumblan4=jumblan4, jumb=jumb, rxPower=rxPower, rebootEnable=rebootEnable, catvEnable=catvEnable, lan2=lan2, lan3=lan3, jumblan2=jumblan2, action=action, primaryDns=primaryDns, multicastsReceived=multicastsReceived, qosTable=qosTable, domainame=domainame, wan=wan, broadcastsTransmitted=broadcastsTransmitted, multicastsTransmitted=multicastsTransmitted, adminStatus=adminStatus, groupid=groupid, portEntry=portEntry, staticIpSecondaryDns=staticIpSecondaryDns, staticDns=staticDns, operStatus=operStatus, dscpEnable=dscpEnable)
