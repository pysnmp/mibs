...
# Produced by pysmi-1.1.8 at Thu Dec 15 08:29:05 2022
...
NotificationType, ObjectIdentity, iso, snmpModules, MibIdentifier, Gauge32, enterprises, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, mib_2, Bits, Counter64, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "iso", "snmpModules", "MibIdentifier", "Gauge32", "enterprises", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "mib-2", "Bits", "Counter64", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", adminStatus=adminStatus, rebootEnable=rebootEnable, primaryDns=primaryDns, pauseReceived=pauseReceived, groupid=groupid, jumblan2=jumblan2, vendorOui=vendorOui, lan4=lan4, portTable=portTable, wan=wan, xg6846=xg6846, lanportIndex=lanportIndex, lanportName=lanportName, statisticTable=statisticTable, modeEntry=modeEntry, vendorPn=vendorPn, staticIpSubMask=staticIpSubMask, dscpEnable=dscpEnable, operStatus=operStatus, deviceinfo=deviceinfo, domainame=domainame, lan3=lan3, groupIndex=groupIndex, broadcastsReceived=broadcastsReceived, hostname=hostname, vendorName=vendorName, lan2=lan2, staticIpHostName=staticIpHostName, staticIpDomainName=staticIpDomainName, qmode=qmode, port3=port3, staticIpAddr=staticIpAddr, unicastsTransmitted=unicastsTransmitted, fcsErrorTransmitted=fcsErrorTransmitted, pauseTransmitted=pauseTransmitted, port1=port1, fileName=fileName, secondaryDns=secondaryDns, broadcastsTransmitted=broadcastsTransmitted, ddminfo=ddminfo, portIndex=portIndex, qos=qos, txPower=txPower, portEntry=portEntry, vlangroupTable=vlangroupTable, portStatistic=portStatistic, jumblan3=jumblan3, lanportTable=lanportTable, temperature=temperature, tftpSevIp=tftpSevIp, fcsErrorReceived=fcsErrorReceived, serialnum=serialnum, action=action, vlanid=vlanid, catv=catv, reboot=reboot, portmode=portmode, bias=bias, rxPower=rxPower, staticIpGateway=staticIpGateway, vlan=vlan, staticDns=staticDns, multicastsTransmitted=multicastsTransmitted, multicastsReceived=multicastsReceived, staticIpPrimaryDns=staticIpPrimaryDns, jumb=jumb, unicastsReceived=unicastsReceived, statIndex=statIndex, port4=port4, groupEntry=groupEntry, qosTable=qosTable, tftp=tftp, qosEntry=qosEntry, staticIpSecondaryDns=staticIpSecondaryDns, jumblan4=jumblan4, qosIndex=qosIndex, catvEnable=catvEnable, jumblan1=jumblan1, priority=priority, fileType=fileType, portStatEntry=portStatEntry, jumbwan=jumbwan, portPower=portPower, vendorRev=vendorRev, wanType=wanType, port2=port2, lan1=lan1, portName=portName, qmapping=qmapping, internetPort=internetPort, voltage=voltage, lanportspeed=lanportspeed, speed=speed, lanportpause=lanportpause)
