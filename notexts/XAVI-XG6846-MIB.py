...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:36:53 2021
...
mib_2, Counter64, iso, Bits, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, TimeTicks, Counter32, NotificationType, IpAddress, snmpModules, ObjectIdentity, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Counter64", "iso", "Bits", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "TimeTicks", "Counter32", "NotificationType", "IpAddress", "snmpModules", "ObjectIdentity", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portPower=portPower, staticIpGateway=staticIpGateway, unicastsReceived=unicastsReceived, jumblan3=jumblan3, lanportIndex=lanportIndex, deviceinfo=deviceinfo, fileName=fileName, lanportTable=lanportTable, portStatEntry=portStatEntry, port4=port4, xg6846=xg6846, vlanid=vlanid, pauseReceived=pauseReceived, fcsErrorReceived=fcsErrorReceived, lan2=lan2, groupid=groupid, action=action, lanportspeed=lanportspeed, catv=catv, portName=portName, wan=wan, qosIndex=qosIndex, adminStatus=adminStatus, operStatus=operStatus, internetPort=internetPort, qmapping=qmapping, lanportpause=lanportpause, groupEntry=groupEntry, txPower=txPower, staticIpDomainName=staticIpDomainName, port1=port1, primaryDns=primaryDns, modeEntry=modeEntry, staticIpPrimaryDns=staticIpPrimaryDns, lanportName=lanportName, temperature=temperature, port3=port3, vlangroupTable=vlangroupTable, speed=speed, fcsErrorTransmitted=fcsErrorTransmitted, multicastsReceived=multicastsReceived, broadcastsReceived=broadcastsReceived, qmode=qmode, statIndex=statIndex, secondaryDns=secondaryDns, hostname=hostname, priority=priority, statisticTable=statisticTable, lan3=lan3, portStatistic=portStatistic, voltage=voltage, portIndex=portIndex, dscpEnable=dscpEnable, vendorName=vendorName, vendorPn=vendorPn, ddminfo=ddminfo, vendorOui=vendorOui, qosTable=qosTable, staticIpAddr=staticIpAddr, portEntry=portEntry, serialnum=serialnum, rxPower=rxPower, tftp=tftp, port2=port2, staticIpHostName=staticIpHostName, broadcastsTransmitted=broadcastsTransmitted, jumblan4=jumblan4, rebootEnable=rebootEnable, staticDns=staticDns, catvEnable=catvEnable, staticIpSecondaryDns=staticIpSecondaryDns, tftpSevIp=tftpSevIp, bias=bias, pauseTransmitted=pauseTransmitted, jumb=jumb, unicastsTransmitted=unicastsTransmitted, jumblan1=jumblan1, lan4=lan4, vendorRev=vendorRev, jumbwan=jumbwan, qos=qos, multicastsTransmitted=multicastsTransmitted, fileType=fileType, staticIpSubMask=staticIpSubMask, jumblan2=jumblan2, qosEntry=qosEntry, wanType=wanType, domainame=domainame, reboot=reboot, portmode=portmode, lan1=lan1, groupIndex=groupIndex, portTable=portTable, vlan=vlan)
