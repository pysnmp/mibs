...
# Produced by pysmi-1.1.3 at Tue Nov 30 03:03:33 2021
...
iso, Unsigned32, snmpModules, Counter64, NotificationType, TimeTicks, mib_2, enterprises, IpAddress, Counter32, Integer32, ObjectIdentity, Gauge32, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "snmpModules", "Counter64", "NotificationType", "TimeTicks", "mib-2", "enterprises", "IpAddress", "Counter32", "Integer32", "ObjectIdentity", "Gauge32", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", port4=port4, lanportName=lanportName, jumblan4=jumblan4, vlan=vlan, lanportTable=lanportTable, speed=speed, xg6846=xg6846, rxPower=rxPower, vendorName=vendorName, jumblan3=jumblan3, groupIndex=groupIndex, temperature=temperature, portmode=portmode, fcsErrorTransmitted=fcsErrorTransmitted, wan=wan, tftpSevIp=tftpSevIp, jumblan2=jumblan2, staticIpGateway=staticIpGateway, modeEntry=modeEntry, wanType=wanType, jumbwan=jumbwan, lan4=lan4, multicastsReceived=multicastsReceived, unicastsTransmitted=unicastsTransmitted, portStatEntry=portStatEntry, fileType=fileType, portEntry=portEntry, lanportspeed=lanportspeed, fcsErrorReceived=fcsErrorReceived, qos=qos, statIndex=statIndex, domainame=domainame, serialnum=serialnum, internetPort=internetPort, port3=port3, jumb=jumb, vlangroupTable=vlangroupTable, vendorOui=vendorOui, operStatus=operStatus, multicastsTransmitted=multicastsTransmitted, portTable=portTable, pauseReceived=pauseReceived, rebootEnable=rebootEnable, fileName=fileName, qmode=qmode, port2=port2, broadcastsReceived=broadcastsReceived, portIndex=portIndex, vlanid=vlanid, primaryDns=primaryDns, adminStatus=adminStatus, bias=bias, tftp=tftp, unicastsReceived=unicastsReceived, lanportpause=lanportpause, dscpEnable=dscpEnable, qmapping=qmapping, vendorPn=vendorPn, lan1=lan1, lanportIndex=lanportIndex, portName=portName, qosEntry=qosEntry, pauseTransmitted=pauseTransmitted, action=action, staticIpSubMask=staticIpSubMask, port1=port1, lan2=lan2, txPower=txPower, staticIpSecondaryDns=staticIpSecondaryDns, lan3=lan3, portPower=portPower, voltage=voltage, groupEntry=groupEntry, catv=catv, catvEnable=catvEnable, broadcastsTransmitted=broadcastsTransmitted, portStatistic=portStatistic, ddminfo=ddminfo, reboot=reboot, staticIpPrimaryDns=staticIpPrimaryDns, qosIndex=qosIndex, jumblan1=jumblan1, qosTable=qosTable, staticDns=staticDns, statisticTable=statisticTable, vendorRev=vendorRev, staticIpHostName=staticIpHostName, deviceinfo=deviceinfo, priority=priority, secondaryDns=secondaryDns, staticIpDomainName=staticIpDomainName, staticIpAddr=staticIpAddr, hostname=hostname, groupid=groupid)
