...
ObjectIdentity, snmpModules, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, mib_2, enterprises, Integer32, Counter32, Gauge32, NotificationType, TimeTicks, MibIdentifier, IpAddress, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "snmpModules", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "mib-2", "enterprises", "Integer32", "Counter32", "Gauge32", "NotificationType", "TimeTicks", "MibIdentifier", "IpAddress", "iso", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan2=lan2, portStatEntry=portStatEntry, qosTable=qosTable, portPower=portPower, lan3=lan3, port3=port3, lanportIndex=lanportIndex, statIndex=statIndex, temperature=temperature, groupid=groupid, operStatus=operStatus, priority=priority, hostname=hostname, port4=port4, lan1=lan1, unicastsReceived=unicastsReceived, modeEntry=modeEntry, lanportName=lanportName, portEntry=portEntry, vlanid=vlanid, broadcastsReceived=broadcastsReceived, secondaryDns=secondaryDns, bias=bias, staticIpPrimaryDns=staticIpPrimaryDns, qmapping=qmapping, wanType=wanType, portIndex=portIndex, portmode=portmode, staticIpSecondaryDns=staticIpSecondaryDns, fcsErrorTransmitted=fcsErrorTransmitted, groupEntry=groupEntry, statisticTable=statisticTable, pauseReceived=pauseReceived, vendorName=vendorName, tftp=tftp, vendorPn=vendorPn, vlangroupTable=vlangroupTable, wan=wan, jumblan4=jumblan4, lanportTable=lanportTable, lanportpause=lanportpause, lan4=lan4, groupIndex=groupIndex, ddminfo=ddminfo, qosIndex=qosIndex, qos=qos, speed=speed, jumb=jumb, port2=port2, dscpEnable=dscpEnable, portName=portName, staticIpDomainName=staticIpDomainName, fileName=fileName, domainame=domainame, jumbwan=jumbwan, multicastsReceived=multicastsReceived, reboot=reboot, jumblan3=jumblan3, action=action, pauseTransmitted=pauseTransmitted, vendorOui=vendorOui, deviceinfo=deviceinfo, jumblan2=jumblan2, internetPort=internetPort, tftpSevIp=tftpSevIp, staticIpAddr=staticIpAddr, jumblan1=jumblan1, lanportspeed=lanportspeed, qosEntry=qosEntry, port1=port1, catv=catv, staticIpSubMask=staticIpSubMask, unicastsTransmitted=unicastsTransmitted, portTable=portTable, serialnum=serialnum, portStatistic=portStatistic, fileType=fileType, vendorRev=vendorRev, broadcastsTransmitted=broadcastsTransmitted, primaryDns=primaryDns, staticIpHostName=staticIpHostName, staticDns=staticDns, multicastsTransmitted=multicastsTransmitted, fcsErrorReceived=fcsErrorReceived, adminStatus=adminStatus, staticIpGateway=staticIpGateway, vlan=vlan, qmode=qmode, voltage=voltage, txPower=txPower, catvEnable=catvEnable, rebootEnable=rebootEnable, xg6846=xg6846, rxPower=rxPower)
