...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:04:45 2022
...
Unsigned32, NotificationType, mib_2, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, enterprises, MibIdentifier, Counter64, Integer32, ObjectIdentity, Gauge32, ModuleIdentity, TimeTicks, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "mib-2", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "enterprises", "MibIdentifier", "Counter64", "Integer32", "ObjectIdentity", "Gauge32", "ModuleIdentity", "TimeTicks", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qmapping=qmapping, fileType=fileType, operStatus=operStatus, vlan=vlan, multicastsReceived=multicastsReceived, lanportpause=lanportpause, tftp=tftp, txPower=txPower, jumbwan=jumbwan, broadcastsTransmitted=broadcastsTransmitted, portName=portName, vlangroupTable=vlangroupTable, wan=wan, qosIndex=qosIndex, multicastsTransmitted=multicastsTransmitted, rebootEnable=rebootEnable, pauseTransmitted=pauseTransmitted, vendorPn=vendorPn, statisticTable=statisticTable, unicastsTransmitted=unicastsTransmitted, staticIpHostName=staticIpHostName, lanportName=lanportName, wanType=wanType, lanportTable=lanportTable, port3=port3, staticIpSubMask=staticIpSubMask, ddminfo=ddminfo, jumblan3=jumblan3, fcsErrorReceived=fcsErrorReceived, xg6846=xg6846, jumb=jumb, vendorOui=vendorOui, fcsErrorTransmitted=fcsErrorTransmitted, domainame=domainame, portmode=portmode, catvEnable=catvEnable, tftpSevIp=tftpSevIp, jumblan1=jumblan1, fileName=fileName, dscpEnable=dscpEnable, qos=qos, voltage=voltage, vendorRev=vendorRev, temperature=temperature, port1=port1, pauseReceived=pauseReceived, portStatEntry=portStatEntry, vlanid=vlanid, staticIpGateway=staticIpGateway, staticIpSecondaryDns=staticIpSecondaryDns, lan3=lan3, lanportIndex=lanportIndex, portEntry=portEntry, modeEntry=modeEntry, lan4=lan4, staticIpPrimaryDns=staticIpPrimaryDns, portPower=portPower, jumblan2=jumblan2, port2=port2, bias=bias, lan1=lan1, qmode=qmode, staticIpAddr=staticIpAddr, port4=port4, portStatistic=portStatistic, vendorName=vendorName, statIndex=statIndex, adminStatus=adminStatus, portIndex=portIndex, staticDns=staticDns, groupEntry=groupEntry, action=action, serialnum=serialnum, groupIndex=groupIndex, qosEntry=qosEntry, qosTable=qosTable, internetPort=internetPort, secondaryDns=secondaryDns, broadcastsReceived=broadcastsReceived, priority=priority, catv=catv, staticIpDomainName=staticIpDomainName, hostname=hostname, lanportspeed=lanportspeed, portTable=portTable, lan2=lan2, deviceinfo=deviceinfo, reboot=reboot, unicastsReceived=unicastsReceived, groupid=groupid, rxPower=rxPower, primaryDns=primaryDns, speed=speed, jumblan4=jumblan4)
