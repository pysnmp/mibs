...
# Produced by pysmi-1.1.8 at Mon Jan  9 11:05:57 2023
...
snmpModules, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, IpAddress, iso, Gauge32, Unsigned32, Bits, ObjectIdentity, Integer32, ModuleIdentity, MibIdentifier, Counter32, enterprises, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "IpAddress", "iso", "Gauge32", "Unsigned32", "Bits", "ObjectIdentity", "Integer32", "ModuleIdentity", "MibIdentifier", "Counter32", "enterprises", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", bias=bias, fcsErrorReceived=fcsErrorReceived, vendorOui=vendorOui, portName=portName, portTable=portTable, unicastsTransmitted=unicastsTransmitted, broadcastsReceived=broadcastsReceived, multicastsReceived=multicastsReceived, voltage=voltage, catvEnable=catvEnable, port1=port1, jumblan2=jumblan2, lanportpause=lanportpause, temperature=temperature, portStatistic=portStatistic, fcsErrorTransmitted=fcsErrorTransmitted, wanType=wanType, qosEntry=qosEntry, tftp=tftp, portEntry=portEntry, staticIpHostName=staticIpHostName, reboot=reboot, rebootEnable=rebootEnable, serialnum=serialnum, secondaryDns=secondaryDns, staticIpSubMask=staticIpSubMask, staticIpDomainName=staticIpDomainName, groupEntry=groupEntry, hostname=hostname, vlan=vlan, port2=port2, staticIpGateway=staticIpGateway, qmode=qmode, lan4=lan4, lanportName=lanportName, port3=port3, qosTable=qosTable, vlanid=vlanid, fileType=fileType, wan=wan, unicastsReceived=unicastsReceived, staticDns=staticDns, jumblan3=jumblan3, lan2=lan2, fileName=fileName, operStatus=operStatus, multicastsTransmitted=multicastsTransmitted, domainame=domainame, internetPort=internetPort, lanportIndex=lanportIndex, qmapping=qmapping, portPower=portPower, modeEntry=modeEntry, pauseReceived=pauseReceived, primaryDns=primaryDns, lan3=lan3, jumblan4=jumblan4, portStatEntry=portStatEntry, dscpEnable=dscpEnable, vendorName=vendorName, catv=catv, vlangroupTable=vlangroupTable, portIndex=portIndex, priority=priority, pauseTransmitted=pauseTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, ddminfo=ddminfo, speed=speed, deviceinfo=deviceinfo, vendorRev=vendorRev, jumblan1=jumblan1, vendorPn=vendorPn, jumbwan=jumbwan, broadcastsTransmitted=broadcastsTransmitted, txPower=txPower, statisticTable=statisticTable, lanportspeed=lanportspeed, xg6846=xg6846, staticIpAddr=staticIpAddr, rxPower=rxPower, groupIndex=groupIndex, statIndex=statIndex, tftpSevIp=tftpSevIp, port4=port4, lanportTable=lanportTable, qos=qos, adminStatus=adminStatus, lan1=lan1, qosIndex=qosIndex, jumb=jumb, staticIpPrimaryDns=staticIpPrimaryDns, portmode=portmode, action=action, groupid=groupid)
