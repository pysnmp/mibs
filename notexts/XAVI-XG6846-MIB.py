...
# Produced by pysmi-1.1.8 at Fri Jan  7 17:54:45 2022
...
iso, MibIdentifier, Unsigned32, ObjectIdentity, snmpModules, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, Bits, ModuleIdentity, enterprises, mib_2, Counter64, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "Unsigned32", "ObjectIdentity", "snmpModules", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "Bits", "ModuleIdentity", "enterprises", "mib-2", "Counter64", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", tftp=tftp, vlan=vlan, catv=catv, action=action, staticIpSubMask=staticIpSubMask, staticDns=staticDns, fcsErrorReceived=fcsErrorReceived, groupid=groupid, fileType=fileType, vendorPn=vendorPn, internetPort=internetPort, bias=bias, port2=port2, lan1=lan1, qos=qos, ddminfo=ddminfo, rxPower=rxPower, portStatEntry=portStatEntry, lan3=lan3, modeEntry=modeEntry, fileName=fileName, lan2=lan2, lanportpause=lanportpause, priority=priority, unicastsTransmitted=unicastsTransmitted, portStatistic=portStatistic, lan4=lan4, staticIpGateway=staticIpGateway, qosIndex=qosIndex, vlangroupTable=vlangroupTable, adminStatus=adminStatus, staticIpHostName=staticIpHostName, deviceinfo=deviceinfo, staticIpPrimaryDns=staticIpPrimaryDns, catvEnable=catvEnable, qmode=qmode, broadcastsTransmitted=broadcastsTransmitted, portmode=portmode, pauseReceived=pauseReceived, staticIpDomainName=staticIpDomainName, serialnum=serialnum, primaryDns=primaryDns, portTable=portTable, staticIpAddr=staticIpAddr, groupEntry=groupEntry, hostname=hostname, pauseTransmitted=pauseTransmitted, jumblan1=jumblan1, portIndex=portIndex, staticIpSecondaryDns=staticIpSecondaryDns, jumblan2=jumblan2, multicastsReceived=multicastsReceived, vlanid=vlanid, jumblan3=jumblan3, portEntry=portEntry, lanportIndex=lanportIndex, unicastsReceived=unicastsReceived, speed=speed, qosEntry=qosEntry, multicastsTransmitted=multicastsTransmitted, broadcastsReceived=broadcastsReceived, jumb=jumb, dscpEnable=dscpEnable, portPower=portPower, vendorOui=vendorOui, voltage=voltage, qosTable=qosTable, port4=port4, statisticTable=statisticTable, statIndex=statIndex, tftpSevIp=tftpSevIp, vendorName=vendorName, rebootEnable=rebootEnable, reboot=reboot, portName=portName, lanportspeed=lanportspeed, wanType=wanType, operStatus=operStatus, jumbwan=jumbwan, secondaryDns=secondaryDns, groupIndex=groupIndex, xg6846=xg6846, port3=port3, qmapping=qmapping, lanportName=lanportName, lanportTable=lanportTable, domainame=domainame, temperature=temperature, vendorRev=vendorRev, jumblan4=jumblan4, wan=wan, fcsErrorTransmitted=fcsErrorTransmitted, txPower=txPower, port1=port1)
