...
# Produced by pysmi-1.1.8 at Fri Sep  8 07:41:44 2023
...
Counter64, mib_2, Unsigned32, Gauge32, IpAddress, Integer32, Bits, ModuleIdentity, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, MibIdentifier, Counter32, ObjectIdentity, TimeTicks, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "mib-2", "Unsigned32", "Gauge32", "IpAddress", "Integer32", "Bits", "ModuleIdentity", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "MibIdentifier", "Counter32", "ObjectIdentity", "TimeTicks", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", groupIndex=groupIndex, temperature=temperature, bias=bias, portEntry=portEntry, broadcastsReceived=broadcastsReceived, adminStatus=adminStatus, domainame=domainame, staticDns=staticDns, dscpEnable=dscpEnable, portmode=portmode, portIndex=portIndex, catv=catv, fcsErrorReceived=fcsErrorReceived, vendorRev=vendorRev, staticIpPrimaryDns=staticIpPrimaryDns, jumblan2=jumblan2, portStatistic=portStatistic, vlangroupTable=vlangroupTable, multicastsReceived=multicastsReceived, jumblan1=jumblan1, broadcastsTransmitted=broadcastsTransmitted, reboot=reboot, jumblan4=jumblan4, tftp=tftp, voltage=voltage, groupEntry=groupEntry, staticIpSubMask=staticIpSubMask, deviceinfo=deviceinfo, action=action, modeEntry=modeEntry, portPower=portPower, lanportspeed=lanportspeed, staticIpHostName=staticIpHostName, internetPort=internetPort, serialnum=serialnum, port1=port1, lanportTable=lanportTable, ddminfo=ddminfo, rebootEnable=rebootEnable, tftpSevIp=tftpSevIp, lan2=lan2, wanType=wanType, vendorOui=vendorOui, jumbwan=jumbwan, vlan=vlan, fcsErrorTransmitted=fcsErrorTransmitted, port4=port4, statIndex=statIndex, pauseTransmitted=pauseTransmitted, catvEnable=catvEnable, jumblan3=jumblan3, speed=speed, staticIpSecondaryDns=staticIpSecondaryDns, lanportIndex=lanportIndex, xg6846=xg6846, lan4=lan4, staticIpDomainName=staticIpDomainName, primaryDns=primaryDns, lanportpause=lanportpause, qmapping=qmapping, lan3=lan3, hostname=hostname, vendorPn=vendorPn, lan1=lan1, qos=qos, vendorName=vendorName, qosEntry=qosEntry, portName=portName, qmode=qmode, port3=port3, fileName=fileName, statisticTable=statisticTable, txPower=txPower, jumb=jumb, vlanid=vlanid, groupid=groupid, staticIpAddr=staticIpAddr, unicastsTransmitted=unicastsTransmitted, staticIpGateway=staticIpGateway, fileType=fileType, pauseReceived=pauseReceived, operStatus=operStatus, portTable=portTable, secondaryDns=secondaryDns, qosTable=qosTable, priority=priority, multicastsTransmitted=multicastsTransmitted, portStatEntry=portStatEntry, unicastsReceived=unicastsReceived, lanportName=lanportName, rxPower=rxPower, port2=port2, qosIndex=qosIndex, wan=wan)
