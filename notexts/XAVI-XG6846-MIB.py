...
# Produced by pysmi-1.1.3 at Sun Nov 21 13:27:50 2021
...
TimeTicks, Counter32, Counter64, NotificationType, Integer32, Bits, iso, mib_2, enterprises, snmpModules, Unsigned32, IpAddress, Gauge32, MibIdentifier, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "Counter64", "NotificationType", "Integer32", "Bits", "iso", "mib-2", "enterprises", "snmpModules", "Unsigned32", "IpAddress", "Gauge32", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", unicastsReceived=unicastsReceived, txPower=txPower, domainame=domainame, staticIpDomainName=staticIpDomainName, serialnum=serialnum, dscpEnable=dscpEnable, qosIndex=qosIndex, staticIpHostName=staticIpHostName, catv=catv, fileName=fileName, lan2=lan2, lanportIndex=lanportIndex, modeEntry=modeEntry, jumbwan=jumbwan, staticIpSubMask=staticIpSubMask, hostname=hostname, jumblan2=jumblan2, qos=qos, priority=priority, secondaryDns=secondaryDns, broadcastsTransmitted=broadcastsTransmitted, groupEntry=groupEntry, portStatistic=portStatistic, adminStatus=adminStatus, broadcastsReceived=broadcastsReceived, tftpSevIp=tftpSevIp, lanportTable=lanportTable, jumblan3=jumblan3, lan4=lan4, catvEnable=catvEnable, port1=port1, portStatEntry=portStatEntry, qosTable=qosTable, ddminfo=ddminfo, portTable=portTable, multicastsReceived=multicastsReceived, reboot=reboot, voltage=voltage, staticDns=staticDns, action=action, lanportName=lanportName, statisticTable=statisticTable, jumblan1=jumblan1, rxPower=rxPower, deviceinfo=deviceinfo, rebootEnable=rebootEnable, pauseTransmitted=pauseTransmitted, portPower=portPower, lanportspeed=lanportspeed, statIndex=statIndex, portName=portName, qosEntry=qosEntry, lanportpause=lanportpause, groupid=groupid, temperature=temperature, internetPort=internetPort, wan=wan, vlangroupTable=vlangroupTable, wanType=wanType, vendorRev=vendorRev, fcsErrorReceived=fcsErrorReceived, fcsErrorTransmitted=fcsErrorTransmitted, vendorOui=vendorOui, lan1=lan1, multicastsTransmitted=multicastsTransmitted, staticIpGateway=staticIpGateway, groupIndex=groupIndex, port4=port4, staticIpPrimaryDns=staticIpPrimaryDns, staticIpSecondaryDns=staticIpSecondaryDns, bias=bias, qmode=qmode, speed=speed, jumb=jumb, vendorPn=vendorPn, portmode=portmode, qmapping=qmapping, unicastsTransmitted=unicastsTransmitted, vlanid=vlanid, port2=port2, vendorName=vendorName, staticIpAddr=staticIpAddr, portIndex=portIndex, tftp=tftp, lan3=lan3, vlan=vlan, operStatus=operStatus, xg6846=xg6846, pauseReceived=pauseReceived, jumblan4=jumblan4, port3=port3, fileType=fileType, portEntry=portEntry, primaryDns=primaryDns)
