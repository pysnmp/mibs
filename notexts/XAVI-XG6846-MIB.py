...
# Produced by pysmi-1.1.3 at Mon Nov 22 11:49:04 2021
...
TimeTicks, snmpModules, ModuleIdentity, mib_2, NotificationType, Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, ObjectIdentity, enterprises, Integer32, Gauge32, IpAddress, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "snmpModules", "ModuleIdentity", "mib-2", "NotificationType", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "ObjectIdentity", "enterprises", "Integer32", "Gauge32", "IpAddress", "Counter32", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", voltage=voltage, portEntry=portEntry, jumblan1=jumblan1, staticIpAddr=staticIpAddr, rebootEnable=rebootEnable, fileType=fileType, multicastsTransmitted=multicastsTransmitted, port3=port3, staticIpHostName=staticIpHostName, txPower=txPower, secondaryDns=secondaryDns, groupEntry=groupEntry, vendorRev=vendorRev, multicastsReceived=multicastsReceived, pauseTransmitted=pauseTransmitted, hostname=hostname, portTable=portTable, unicastsReceived=unicastsReceived, speed=speed, lanportName=lanportName, lan1=lan1, fcsErrorTransmitted=fcsErrorTransmitted, vlan=vlan, priority=priority, domainame=domainame, lan2=lan2, jumblan3=jumblan3, wan=wan, vendorName=vendorName, portStatEntry=portStatEntry, port1=port1, qmode=qmode, jumbwan=jumbwan, qmapping=qmapping, staticIpSecondaryDns=staticIpSecondaryDns, groupIndex=groupIndex, broadcastsTransmitted=broadcastsTransmitted, lanportpause=lanportpause, portName=portName, serialnum=serialnum, lanportTable=lanportTable, ddminfo=ddminfo, catvEnable=catvEnable, dscpEnable=dscpEnable, port4=port4, primaryDns=primaryDns, xg6846=xg6846, operStatus=operStatus, qosEntry=qosEntry, modeEntry=modeEntry, staticDns=staticDns, staticIpDomainName=staticIpDomainName, lan3=lan3, staticIpSubMask=staticIpSubMask, lanportIndex=lanportIndex, portPower=portPower, lanportspeed=lanportspeed, vlangroupTable=vlangroupTable, statIndex=statIndex, adminStatus=adminStatus, lan4=lan4, unicastsTransmitted=unicastsTransmitted, wanType=wanType, tftp=tftp, jumblan4=jumblan4, jumb=jumb, vendorOui=vendorOui, staticIpGateway=staticIpGateway, catv=catv, portIndex=portIndex, fileName=fileName, groupid=groupid, internetPort=internetPort, qosIndex=qosIndex, portmode=portmode, rxPower=rxPower, fcsErrorReceived=fcsErrorReceived, port2=port2, statisticTable=statisticTable, deviceinfo=deviceinfo, pauseReceived=pauseReceived, jumblan2=jumblan2, tftpSevIp=tftpSevIp, portStatistic=portStatistic, qosTable=qosTable, reboot=reboot, bias=bias, vendorPn=vendorPn, vlanid=vlanid, broadcastsReceived=broadcastsReceived, staticIpPrimaryDns=staticIpPrimaryDns, action=action, temperature=temperature, qos=qos)
