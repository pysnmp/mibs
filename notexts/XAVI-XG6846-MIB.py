...
Integer32, Unsigned32, mib_2, enterprises, iso, ObjectIdentity, IpAddress, MibIdentifier, Counter64, ModuleIdentity, NotificationType, TimeTicks, Gauge32, Bits, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "mib-2", "enterprises", "iso", "ObjectIdentity", "IpAddress", "MibIdentifier", "Counter64", "ModuleIdentity", "NotificationType", "TimeTicks", "Gauge32", "Bits", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", groupEntry=groupEntry, unicastsReceived=unicastsReceived, lanportName=lanportName, statisticTable=statisticTable, jumb=jumb, lan2=lan2, vendorPn=vendorPn, rebootEnable=rebootEnable, jumbwan=jumbwan, tftp=tftp, jumblan4=jumblan4, portName=portName, portTable=portTable, lanportpause=lanportpause, priority=priority, qos=qos, lanportTable=lanportTable, pauseReceived=pauseReceived, vendorRev=vendorRev, lan4=lan4, jumblan1=jumblan1, multicastsReceived=multicastsReceived, speed=speed, wan=wan, port4=port4, fileName=fileName, jumblan2=jumblan2, dscpEnable=dscpEnable, vendorName=vendorName, portStatistic=portStatistic, staticIpSubMask=staticIpSubMask, qosTable=qosTable, staticIpSecondaryDns=staticIpSecondaryDns, primaryDns=primaryDns, staticIpGateway=staticIpGateway, catvEnable=catvEnable, vendorOui=vendorOui, staticIpAddr=staticIpAddr, pauseTransmitted=pauseTransmitted, jumblan3=jumblan3, lanportIndex=lanportIndex, temperature=temperature, port2=port2, tftpSevIp=tftpSevIp, xg6846=xg6846, hostname=hostname, txPower=txPower, wanType=wanType, domainame=domainame, broadcastsTransmitted=broadcastsTransmitted, fileType=fileType, groupid=groupid, fcsErrorTransmitted=fcsErrorTransmitted, unicastsTransmitted=unicastsTransmitted, vlan=vlan, adminStatus=adminStatus, port3=port3, internetPort=internetPort, portEntry=portEntry, groupIndex=groupIndex, vlanid=vlanid, vlangroupTable=vlangroupTable, multicastsTransmitted=multicastsTransmitted, catv=catv, portmode=portmode, qmapping=qmapping, portIndex=portIndex, staticIpPrimaryDns=staticIpPrimaryDns, action=action, voltage=voltage, bias=bias, operStatus=operStatus, staticIpDomainName=staticIpDomainName, lan1=lan1, qmode=qmode, lanportspeed=lanportspeed, rxPower=rxPower, port1=port1, modeEntry=modeEntry, secondaryDns=secondaryDns, reboot=reboot, qosIndex=qosIndex, qosEntry=qosEntry, broadcastsReceived=broadcastsReceived, staticDns=staticDns, deviceinfo=deviceinfo, fcsErrorReceived=fcsErrorReceived, lan3=lan3, portStatEntry=portStatEntry, portPower=portPower, serialnum=serialnum, statIndex=statIndex, ddminfo=ddminfo, staticIpHostName=staticIpHostName)
