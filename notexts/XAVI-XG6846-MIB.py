...
IpAddress, NotificationType, Gauge32, iso, mib_2, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, MibIdentifier, enterprises, Counter32, ModuleIdentity, Unsigned32, Integer32, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "Gauge32", "iso", "mib-2", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "MibIdentifier", "enterprises", "Counter32", "ModuleIdentity", "Unsigned32", "Integer32", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumbwan=jumbwan, vendorRev=vendorRev, speed=speed, staticDns=staticDns, unicastsTransmitted=unicastsTransmitted, lanportspeed=lanportspeed, broadcastsTransmitted=broadcastsTransmitted, staticIpDomainName=staticIpDomainName, qmode=qmode, fcsErrorReceived=fcsErrorReceived, voltage=voltage, portEntry=portEntry, portStatistic=portStatistic, groupIndex=groupIndex, fcsErrorTransmitted=fcsErrorTransmitted, groupEntry=groupEntry, vlanid=vlanid, lanportTable=lanportTable, qosIndex=qosIndex, qos=qos, pauseReceived=pauseReceived, catv=catv, portName=portName, staticIpSubMask=staticIpSubMask, action=action, multicastsTransmitted=multicastsTransmitted, vlangroupTable=vlangroupTable, lanportName=lanportName, qosEntry=qosEntry, lan4=lan4, staticIpHostName=staticIpHostName, jumblan1=jumblan1, port2=port2, xg6846=xg6846, adminStatus=adminStatus, jumblan3=jumblan3, wanType=wanType, portPower=portPower, lan2=lan2, dscpEnable=dscpEnable, reboot=reboot, hostname=hostname, domainame=domainame, tftpSevIp=tftpSevIp, priority=priority, statIndex=statIndex, fileType=fileType, portIndex=portIndex, lanportpause=lanportpause, operStatus=operStatus, qmapping=qmapping, vendorPn=vendorPn, portStatEntry=portStatEntry, serialnum=serialnum, rebootEnable=rebootEnable, ddminfo=ddminfo, port3=port3, jumb=jumb, jumblan2=jumblan2, staticIpSecondaryDns=staticIpSecondaryDns, unicastsReceived=unicastsReceived, portmode=portmode, qosTable=qosTable, statisticTable=statisticTable, staticIpAddr=staticIpAddr, primaryDns=primaryDns, pauseTransmitted=pauseTransmitted, temperature=temperature, vlan=vlan, modeEntry=modeEntry, wan=wan, vendorName=vendorName, fileName=fileName, internetPort=internetPort, staticIpPrimaryDns=staticIpPrimaryDns, tftp=tftp, txPower=txPower, catvEnable=catvEnable, lanportIndex=lanportIndex, lan1=lan1, multicastsReceived=multicastsReceived, groupid=groupid, staticIpGateway=staticIpGateway, rxPower=rxPower, port4=port4, portTable=portTable, lan3=lan3, bias=bias, port1=port1, vendorOui=vendorOui, secondaryDns=secondaryDns, jumblan4=jumblan4, deviceinfo=deviceinfo, broadcastsReceived=broadcastsReceived)
