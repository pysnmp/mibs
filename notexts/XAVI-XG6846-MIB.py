...
# Produced by pysmi-1.1.8 at Fri Dec  2 15:56:45 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, snmpModules, iso, IpAddress, Counter32, Counter64, MibIdentifier, Unsigned32, ModuleIdentity, mib_2, NotificationType, ObjectIdentity, enterprises, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "snmpModules", "iso", "IpAddress", "Counter32", "Counter64", "MibIdentifier", "Unsigned32", "ModuleIdentity", "mib-2", "NotificationType", "ObjectIdentity", "enterprises", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", statIndex=statIndex, rxPower=rxPower, action=action, port3=port3, groupIndex=groupIndex, broadcastsTransmitted=broadcastsTransmitted, jumb=jumb, vendorOui=vendorOui, voltage=voltage, qos=qos, wan=wan, temperature=temperature, domainame=domainame, statisticTable=statisticTable, portName=portName, jumblan2=jumblan2, vendorPn=vendorPn, portTable=portTable, primaryDns=primaryDns, qosIndex=qosIndex, modeEntry=modeEntry, broadcastsReceived=broadcastsReceived, vendorName=vendorName, ddminfo=ddminfo, serialnum=serialnum, staticIpGateway=staticIpGateway, xg6846=xg6846, catvEnable=catvEnable, rebootEnable=rebootEnable, tftpSevIp=tftpSevIp, lan3=lan3, lan1=lan1, unicastsReceived=unicastsReceived, multicastsTransmitted=multicastsTransmitted, qosTable=qosTable, staticIpHostName=staticIpHostName, lanportName=lanportName, lanportpause=lanportpause, internetPort=internetPort, port1=port1, unicastsTransmitted=unicastsTransmitted, portIndex=portIndex, fileName=fileName, vlangroupTable=vlangroupTable, groupEntry=groupEntry, groupid=groupid, staticIpDomainName=staticIpDomainName, hostname=hostname, priority=priority, speed=speed, jumbwan=jumbwan, staticIpAddr=staticIpAddr, vendorRev=vendorRev, tftp=tftp, bias=bias, secondaryDns=secondaryDns, jumblan4=jumblan4, staticIpPrimaryDns=staticIpPrimaryDns, lanportTable=lanportTable, lan2=lan2, lanportIndex=lanportIndex, vlanid=vlanid, portEntry=portEntry, deviceinfo=deviceinfo, port4=port4, staticIpSubMask=staticIpSubMask, portmode=portmode, pauseTransmitted=pauseTransmitted, catv=catv, dscpEnable=dscpEnable, wanType=wanType, staticDns=staticDns, qosEntry=qosEntry, portPower=portPower, lanportspeed=lanportspeed, qmode=qmode, operStatus=operStatus, jumblan3=jumblan3, staticIpSecondaryDns=staticIpSecondaryDns, portStatEntry=portStatEntry, jumblan1=jumblan1, reboot=reboot, port2=port2, fcsErrorTransmitted=fcsErrorTransmitted, vlan=vlan, fileType=fileType, multicastsReceived=multicastsReceived, qmapping=qmapping, portStatistic=portStatistic, adminStatus=adminStatus, txPower=txPower, lan4=lan4, fcsErrorReceived=fcsErrorReceived, pauseReceived=pauseReceived)
