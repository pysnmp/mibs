...
# Produced by pysmi-1.1.3 at Tue Nov 30 13:50:42 2021
...
ObjectIdentity, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, mib_2, Integer32, Counter64, snmpModules, Gauge32, Counter32, ModuleIdentity, iso, Unsigned32, enterprises, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "mib-2", "Integer32", "Counter64", "snmpModules", "Gauge32", "Counter32", "ModuleIdentity", "iso", "Unsigned32", "enterprises", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportName=lanportName, groupid=groupid, port4=port4, lanportspeed=lanportspeed, dscpEnable=dscpEnable, vendorRev=vendorRev, deviceinfo=deviceinfo, portmode=portmode, qmapping=qmapping, rxPower=rxPower, vlangroupTable=vlangroupTable, vendorName=vendorName, vendorOui=vendorOui, groupIndex=groupIndex, serialnum=serialnum, catv=catv, lanportTable=lanportTable, staticIpSecondaryDns=staticIpSecondaryDns, internetPort=internetPort, staticIpPrimaryDns=staticIpPrimaryDns, jumblan2=jumblan2, jumblan1=jumblan1, qmode=qmode, ddminfo=ddminfo, portTable=portTable, staticIpSubMask=staticIpSubMask, secondaryDns=secondaryDns, wanType=wanType, portName=portName, jumblan4=jumblan4, txPower=txPower, staticIpHostName=staticIpHostName, vlan=vlan, staticIpGateway=staticIpGateway, hostname=hostname, action=action, fcsErrorTransmitted=fcsErrorTransmitted, rebootEnable=rebootEnable, pauseReceived=pauseReceived, qosIndex=qosIndex, portIndex=portIndex, speed=speed, tftp=tftp, domainame=domainame, portEntry=portEntry, unicastsTransmitted=unicastsTransmitted, tftpSevIp=tftpSevIp, staticIpDomainName=staticIpDomainName, lanportIndex=lanportIndex, broadcastsTransmitted=broadcastsTransmitted, adminStatus=adminStatus, broadcastsReceived=broadcastsReceived, jumb=jumb, port3=port3, operStatus=operStatus, jumblan3=jumblan3, catvEnable=catvEnable, staticDns=staticDns, xg6846=xg6846, multicastsReceived=multicastsReceived, port2=port2, portStatEntry=portStatEntry, reboot=reboot, vendorPn=vendorPn, jumbwan=jumbwan, vlanid=vlanid, statIndex=statIndex, qosTable=qosTable, lan3=lan3, staticIpAddr=staticIpAddr, fileName=fileName, unicastsReceived=unicastsReceived, port1=port1, lanportpause=lanportpause, portStatistic=portStatistic, qos=qos, temperature=temperature, modeEntry=modeEntry, qosEntry=qosEntry, portPower=portPower, fileType=fileType, lan2=lan2, primaryDns=primaryDns, lan1=lan1, statisticTable=statisticTable, voltage=voltage, priority=priority, wan=wan, multicastsTransmitted=multicastsTransmitted, fcsErrorReceived=fcsErrorReceived, pauseTransmitted=pauseTransmitted, bias=bias, lan4=lan4, groupEntry=groupEntry)
