...
# Produced by pysmi-1.1.8 at Thu Feb  9 13:27:02 2023
...
Gauge32, Bits, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, NotificationType, snmpModules, MibIdentifier, IpAddress, Unsigned32, enterprises, mib_2, Counter32, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "NotificationType", "snmpModules", "MibIdentifier", "IpAddress", "Unsigned32", "enterprises", "mib-2", "Counter32", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumblan4=jumblan4, txPower=txPower, rxPower=rxPower, priority=priority, staticIpSubMask=staticIpSubMask, fileType=fileType, staticIpPrimaryDns=staticIpPrimaryDns, portPower=portPower, statisticTable=statisticTable, speed=speed, voltage=voltage, staticIpSecondaryDns=staticIpSecondaryDns, groupid=groupid, staticDns=staticDns, port2=port2, jumbwan=jumbwan, deviceinfo=deviceinfo, port1=port1, rebootEnable=rebootEnable, groupEntry=groupEntry, action=action, broadcastsTransmitted=broadcastsTransmitted, unicastsTransmitted=unicastsTransmitted, primaryDns=primaryDns, lanportName=lanportName, fcsErrorTransmitted=fcsErrorTransmitted, jumb=jumb, port4=port4, staticIpDomainName=staticIpDomainName, hostname=hostname, domainame=domainame, dscpEnable=dscpEnable, portTable=portTable, jumblan3=jumblan3, qosEntry=qosEntry, staticIpHostName=staticIpHostName, portName=portName, portStatEntry=portStatEntry, unicastsReceived=unicastsReceived, jumblan2=jumblan2, vlan=vlan, operStatus=operStatus, lanportIndex=lanportIndex, qmode=qmode, tftp=tftp, lan1=lan1, ddminfo=ddminfo, fcsErrorReceived=fcsErrorReceived, pauseTransmitted=pauseTransmitted, fileName=fileName, lan2=lan2, jumblan1=jumblan1, portIndex=portIndex, port3=port3, lanportspeed=lanportspeed, lan3=lan3, qosTable=qosTable, multicastsTransmitted=multicastsTransmitted, staticIpGateway=staticIpGateway, vlanid=vlanid, portStatistic=portStatistic, reboot=reboot, pauseReceived=pauseReceived, statIndex=statIndex, xg6846=xg6846, qosIndex=qosIndex, wanType=wanType, secondaryDns=secondaryDns, adminStatus=adminStatus, portEntry=portEntry, vendorOui=vendorOui, tftpSevIp=tftpSevIp, vlangroupTable=vlangroupTable, vendorName=vendorName, portmode=portmode, modeEntry=modeEntry, wan=wan, bias=bias, groupIndex=groupIndex, vendorPn=vendorPn, staticIpAddr=staticIpAddr, internetPort=internetPort, lanportTable=lanportTable, qmapping=qmapping, broadcastsReceived=broadcastsReceived, lanportpause=lanportpause, qos=qos, catvEnable=catvEnable, catv=catv, multicastsReceived=multicastsReceived, lan4=lan4, vendorRev=vendorRev, temperature=temperature, serialnum=serialnum)
