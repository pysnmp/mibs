...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:38:55 2023
...
Unsigned32, Counter32, IpAddress, Integer32, iso, mib_2, enterprises, Bits, TimeTicks, ObjectIdentity, snmpModules, Counter64, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "IpAddress", "Integer32", "iso", "mib-2", "enterprises", "Bits", "TimeTicks", "ObjectIdentity", "snmpModules", "Counter64", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpGateway=staticIpGateway, deviceinfo=deviceinfo, staticIpPrimaryDns=staticIpPrimaryDns, vlan=vlan, vlanid=vlanid, domainame=domainame, port2=port2, vendorOui=vendorOui, staticIpSubMask=staticIpSubMask, portIndex=portIndex, serialnum=serialnum, vendorName=vendorName, broadcastsReceived=broadcastsReceived, portStatEntry=portStatEntry, vlangroupTable=vlangroupTable, txPower=txPower, reboot=reboot, multicastsReceived=multicastsReceived, portTable=portTable, lanportIndex=lanportIndex, portName=portName, portPower=portPower, port1=port1, qmode=qmode, action=action, operStatus=operStatus, ddminfo=ddminfo, lan2=lan2, internetPort=internetPort, port4=port4, broadcastsTransmitted=broadcastsTransmitted, vendorRev=vendorRev, temperature=temperature, jumblan1=jumblan1, staticIpAddr=staticIpAddr, lanportpause=lanportpause, qosTable=qosTable, lan1=lan1, staticIpSecondaryDns=staticIpSecondaryDns, qosIndex=qosIndex, multicastsTransmitted=multicastsTransmitted, lanportTable=lanportTable, statIndex=statIndex, groupEntry=groupEntry, fileType=fileType, rebootEnable=rebootEnable, modeEntry=modeEntry, pauseReceived=pauseReceived, rxPower=rxPower, lan3=lan3, speed=speed, groupid=groupid, wan=wan, portmode=portmode, statisticTable=statisticTable, bias=bias, port3=port3, staticDns=staticDns, catvEnable=catvEnable, lanportspeed=lanportspeed, fileName=fileName, qmapping=qmapping, catv=catv, lanportName=lanportName, jumbwan=jumbwan, dscpEnable=dscpEnable, voltage=voltage, qosEntry=qosEntry, staticIpDomainName=staticIpDomainName, fcsErrorReceived=fcsErrorReceived, jumblan3=jumblan3, fcsErrorTransmitted=fcsErrorTransmitted, lan4=lan4, jumb=jumb, pauseTransmitted=pauseTransmitted, xg6846=xg6846, unicastsReceived=unicastsReceived, portStatistic=portStatistic, priority=priority, secondaryDns=secondaryDns, jumblan4=jumblan4, staticIpHostName=staticIpHostName, jumblan2=jumblan2, tftp=tftp, groupIndex=groupIndex, primaryDns=primaryDns, adminStatus=adminStatus, vendorPn=vendorPn, wanType=wanType, hostname=hostname, qos=qos, portEntry=portEntry, tftpSevIp=tftpSevIp, unicastsTransmitted=unicastsTransmitted)
