...
# Produced by pysmi-1.1.8 at Thu Apr 27 11:36:28 2023
...
TimeTicks, Bits, Unsigned32, Counter32, IpAddress, Integer32, ModuleIdentity, mib_2, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, snmpModules, Gauge32, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "Unsigned32", "Counter32", "IpAddress", "Integer32", "ModuleIdentity", "mib-2", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "snmpModules", "Gauge32", "Counter64", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", speed=speed, jumblan4=jumblan4, portStatistic=portStatistic, jumblan2=jumblan2, rxPower=rxPower, pauseReceived=pauseReceived, unicastsReceived=unicastsReceived, statisticTable=statisticTable, staticIpDomainName=staticIpDomainName, internetPort=internetPort, broadcastsTransmitted=broadcastsTransmitted, fileName=fileName, staticIpSecondaryDns=staticIpSecondaryDns, multicastsReceived=multicastsReceived, vendorName=vendorName, fcsErrorReceived=fcsErrorReceived, jumblan3=jumblan3, wanType=wanType, qmode=qmode, lan1=lan1, action=action, adminStatus=adminStatus, lanportspeed=lanportspeed, staticIpPrimaryDns=staticIpPrimaryDns, port3=port3, catv=catv, priority=priority, lanportTable=lanportTable, secondaryDns=secondaryDns, unicastsTransmitted=unicastsTransmitted, deviceinfo=deviceinfo, portTable=portTable, tftpSevIp=tftpSevIp, vendorOui=vendorOui, catvEnable=catvEnable, temperature=temperature, lan2=lan2, reboot=reboot, bias=bias, lanportName=lanportName, portName=portName, vendorRev=vendorRev, jumbwan=jumbwan, ddminfo=ddminfo, portIndex=portIndex, portEntry=portEntry, txPower=txPower, rebootEnable=rebootEnable, wan=wan, qosEntry=qosEntry, groupIndex=groupIndex, serialnum=serialnum, vlangroupTable=vlangroupTable, qosIndex=qosIndex, staticIpSubMask=staticIpSubMask, operStatus=operStatus, lanportIndex=lanportIndex, modeEntry=modeEntry, qos=qos, qmapping=qmapping, lanportpause=lanportpause, fileType=fileType, port2=port2, tftp=tftp, jumb=jumb, broadcastsReceived=broadcastsReceived, xg6846=xg6846, domainame=domainame, groupid=groupid, dscpEnable=dscpEnable, jumblan1=jumblan1, staticDns=staticDns, multicastsTransmitted=multicastsTransmitted, port4=port4, staticIpGateway=staticIpGateway, statIndex=statIndex, vlan=vlan, lan4=lan4, primaryDns=primaryDns, qosTable=qosTable, portPower=portPower, voltage=voltage, staticIpAddr=staticIpAddr, vendorPn=vendorPn, port1=port1, portStatEntry=portStatEntry, vlanid=vlanid, lan3=lan3, pauseTransmitted=pauseTransmitted, groupEntry=groupEntry, hostname=hostname, fcsErrorTransmitted=fcsErrorTransmitted, staticIpHostName=staticIpHostName, portmode=portmode)
