...
# Produced by pysmi-1.1.3 at Tue Dec  7 13:59:19 2021
...
Integer32, Gauge32, Bits, enterprises, iso, snmpModules, Counter32, IpAddress, Counter64, NotificationType, mib_2, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "Bits", "enterprises", "iso", "snmpModules", "Counter32", "IpAddress", "Counter64", "NotificationType", "mib-2", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", rebootEnable=rebootEnable, unicastsTransmitted=unicastsTransmitted, port1=port1, ddminfo=ddminfo, priority=priority, port3=port3, jumblan2=jumblan2, speed=speed, jumblan4=jumblan4, lanportspeed=lanportspeed, vendorRev=vendorRev, catvEnable=catvEnable, txPower=txPower, statisticTable=statisticTable, portmode=portmode, temperature=temperature, staticIpAddr=staticIpAddr, bias=bias, vendorPn=vendorPn, multicastsReceived=multicastsReceived, operStatus=operStatus, statIndex=statIndex, pauseTransmitted=pauseTransmitted, vlanid=vlanid, pauseReceived=pauseReceived, portStatistic=portStatistic, staticIpGateway=staticIpGateway, reboot=reboot, qmapping=qmapping, jumbwan=jumbwan, fileName=fileName, unicastsReceived=unicastsReceived, action=action, lan1=lan1, lanportTable=lanportTable, lanportName=lanportName, fileType=fileType, xg6846=xg6846, qosTable=qosTable, vlangroupTable=vlangroupTable, multicastsTransmitted=multicastsTransmitted, qos=qos, lan2=lan2, voltage=voltage, portEntry=portEntry, internetPort=internetPort, broadcastsTransmitted=broadcastsTransmitted, portTable=portTable, lanportIndex=lanportIndex, vlan=vlan, fcsErrorTransmitted=fcsErrorTransmitted, qosEntry=qosEntry, staticIpDomainName=staticIpDomainName, vendorName=vendorName, fcsErrorReceived=fcsErrorReceived, tftp=tftp, portName=portName, portPower=portPower, tftpSevIp=tftpSevIp, lanportpause=lanportpause, groupid=groupid, portIndex=portIndex, staticIpPrimaryDns=staticIpPrimaryDns, port4=port4, jumb=jumb, broadcastsReceived=broadcastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, primaryDns=primaryDns, modeEntry=modeEntry, staticDns=staticDns, secondaryDns=secondaryDns, dscpEnable=dscpEnable, groupEntry=groupEntry, lan4=lan4, hostname=hostname, wan=wan, qosIndex=qosIndex, rxPower=rxPower, catv=catv, groupIndex=groupIndex, staticIpHostName=staticIpHostName, vendorOui=vendorOui, portStatEntry=portStatEntry, wanType=wanType, domainame=domainame, jumblan1=jumblan1, serialnum=serialnum, qmode=qmode, staticIpSubMask=staticIpSubMask, port2=port2, jumblan3=jumblan3, lan3=lan3, deviceinfo=deviceinfo, adminStatus=adminStatus)
