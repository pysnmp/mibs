...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:24:04 2022
...
NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, snmpModules, Unsigned32, ModuleIdentity, Bits, Counter32, mib_2, Counter64, TimeTicks, MibIdentifier, enterprises, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "snmpModules", "Unsigned32", "ModuleIdentity", "Bits", "Counter32", "mib-2", "Counter64", "TimeTicks", "MibIdentifier", "enterprises", "Gauge32", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorPn=vendorPn, rxPower=rxPower, modeEntry=modeEntry, staticIpSubMask=staticIpSubMask, qmapping=qmapping, qosIndex=qosIndex, portTable=portTable, fileType=fileType, broadcastsTransmitted=broadcastsTransmitted, lan4=lan4, groupEntry=groupEntry, qosEntry=qosEntry, tftp=tftp, portEntry=portEntry, unicastsTransmitted=unicastsTransmitted, reboot=reboot, primaryDns=primaryDns, jumbwan=jumbwan, port4=port4, voltage=voltage, ddminfo=ddminfo, wanType=wanType, jumb=jumb, qosTable=qosTable, lan1=lan1, jumblan2=jumblan2, fileName=fileName, vendorRev=vendorRev, fcsErrorReceived=fcsErrorReceived, qos=qos, pauseReceived=pauseReceived, lanportName=lanportName, groupid=groupid, groupIndex=groupIndex, speed=speed, serialnum=serialnum, unicastsReceived=unicastsReceived, statIndex=statIndex, deviceinfo=deviceinfo, vlanid=vlanid, operStatus=operStatus, staticIpHostName=staticIpHostName, port3=port3, catv=catv, fcsErrorTransmitted=fcsErrorTransmitted, jumblan3=jumblan3, portStatEntry=portStatEntry, staticIpPrimaryDns=staticIpPrimaryDns, action=action, lan2=lan2, dscpEnable=dscpEnable, xg6846=xg6846, vlangroupTable=vlangroupTable, staticIpSecondaryDns=staticIpSecondaryDns, portmode=portmode, multicastsReceived=multicastsReceived, staticIpAddr=staticIpAddr, secondaryDns=secondaryDns, catvEnable=catvEnable, vendorOui=vendorOui, staticIpGateway=staticIpGateway, statisticTable=statisticTable, portPower=portPower, staticIpDomainName=staticIpDomainName, rebootEnable=rebootEnable, lanportpause=lanportpause, adminStatus=adminStatus, qmode=qmode, internetPort=internetPort, lan3=lan3, portStatistic=portStatistic, vendorName=vendorName, temperature=temperature, staticDns=staticDns, bias=bias, domainame=domainame, portName=portName, lanportspeed=lanportspeed, wan=wan, hostname=hostname, multicastsTransmitted=multicastsTransmitted, jumblan1=jumblan1, lanportTable=lanportTable, broadcastsReceived=broadcastsReceived, port2=port2, priority=priority, port1=port1, portIndex=portIndex, pauseTransmitted=pauseTransmitted, vlan=vlan, jumblan4=jumblan4, lanportIndex=lanportIndex, txPower=txPower, tftpSevIp=tftpSevIp)
