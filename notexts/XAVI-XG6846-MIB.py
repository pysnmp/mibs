...
# Produced by pysmi-1.1.8 at Fri Jan  7 15:28:51 2022
...
MibIdentifier, ModuleIdentity, Counter64, TimeTicks, Bits, NotificationType, iso, Gauge32, ObjectIdentity, Unsigned32, mib_2, enterprises, IpAddress, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "Counter64", "TimeTicks", "Bits", "NotificationType", "iso", "Gauge32", "ObjectIdentity", "Unsigned32", "mib-2", "enterprises", "IpAddress", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portName=portName, portIndex=portIndex, hostname=hostname, primaryDns=primaryDns, qosEntry=qosEntry, deviceinfo=deviceinfo, jumblan2=jumblan2, qosIndex=qosIndex, secondaryDns=secondaryDns, ddminfo=ddminfo, portPower=portPower, jumbwan=jumbwan, dscpEnable=dscpEnable, staticIpSecondaryDns=staticIpSecondaryDns, staticIpAddr=staticIpAddr, internetPort=internetPort, vendorRev=vendorRev, wanType=wanType, port3=port3, wan=wan, jumblan4=jumblan4, vendorPn=vendorPn, priority=priority, multicastsReceived=multicastsReceived, portTable=portTable, vlanid=vlanid, multicastsTransmitted=multicastsTransmitted, staticIpGateway=staticIpGateway, qmapping=qmapping, operStatus=operStatus, vlangroupTable=vlangroupTable, broadcastsTransmitted=broadcastsTransmitted, modeEntry=modeEntry, action=action, vlan=vlan, serialnum=serialnum, xg6846=xg6846, staticIpHostName=staticIpHostName, staticIpDomainName=staticIpDomainName, portEntry=portEntry, lan4=lan4, port1=port1, fileType=fileType, vendorName=vendorName, lan2=lan2, statisticTable=statisticTable, lanportTable=lanportTable, portStatEntry=portStatEntry, tftp=tftp, catv=catv, fileName=fileName, qosTable=qosTable, bias=bias, pauseTransmitted=pauseTransmitted, voltage=voltage, portmode=portmode, lanportspeed=lanportspeed, rebootEnable=rebootEnable, groupIndex=groupIndex, fcsErrorTransmitted=fcsErrorTransmitted, domainame=domainame, unicastsTransmitted=unicastsTransmitted, groupEntry=groupEntry, groupid=groupid, unicastsReceived=unicastsReceived, broadcastsReceived=broadcastsReceived, lanportName=lanportName, txPower=txPower, fcsErrorReceived=fcsErrorReceived, qos=qos, reboot=reboot, catvEnable=catvEnable, lan3=lan3, portStatistic=portStatistic, pauseReceived=pauseReceived, port2=port2, temperature=temperature, jumblan3=jumblan3, staticIpPrimaryDns=staticIpPrimaryDns, staticIpSubMask=staticIpSubMask, statIndex=statIndex, rxPower=rxPower, lan1=lan1, speed=speed, tftpSevIp=tftpSevIp, port4=port4, staticDns=staticDns, jumb=jumb, lanportIndex=lanportIndex, vendorOui=vendorOui, lanportpause=lanportpause, adminStatus=adminStatus, qmode=qmode, jumblan1=jumblan1)
