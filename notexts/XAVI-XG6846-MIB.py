...
MibIdentifier, TimeTicks, enterprises, ModuleIdentity, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, mib_2, IpAddress, snmpModules, NotificationType, Unsigned32, Gauge32, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "enterprises", "ModuleIdentity", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "mib-2", "IpAddress", "snmpModules", "NotificationType", "Unsigned32", "Gauge32", "Bits", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportIndex=lanportIndex, qosIndex=qosIndex, port4=port4, reboot=reboot, primaryDns=primaryDns, internetPort=internetPort, lanportspeed=lanportspeed, bias=bias, priority=priority, xg6846=xg6846, voltage=voltage, qmapping=qmapping, modeEntry=modeEntry, rebootEnable=rebootEnable, temperature=temperature, staticIpHostName=staticIpHostName, qosTable=qosTable, wanType=wanType, adminStatus=adminStatus, domainame=domainame, port2=port2, rxPower=rxPower, vlangroupTable=vlangroupTable, staticIpAddr=staticIpAddr, lanportTable=lanportTable, staticIpDomainName=staticIpDomainName, staticIpGateway=staticIpGateway, deviceinfo=deviceinfo, wan=wan, portIndex=portIndex, speed=speed, jumblan4=jumblan4, tftp=tftp, jumblan1=jumblan1, lanportpause=lanportpause, port3=port3, unicastsReceived=unicastsReceived, portName=portName, portTable=portTable, dscpEnable=dscpEnable, qmode=qmode, tftpSevIp=tftpSevIp, unicastsTransmitted=unicastsTransmitted, jumb=jumb, fcsErrorReceived=fcsErrorReceived, fileType=fileType, catv=catv, statisticTable=statisticTable, lan2=lan2, pauseReceived=pauseReceived, operStatus=operStatus, broadcastsReceived=broadcastsReceived, broadcastsTransmitted=broadcastsTransmitted, qosEntry=qosEntry, jumbwan=jumbwan, staticIpSubMask=staticIpSubMask, lan1=lan1, port1=port1, qos=qos, portPower=portPower, lan3=lan3, fcsErrorTransmitted=fcsErrorTransmitted, secondaryDns=secondaryDns, action=action, vendorRev=vendorRev, staticDns=staticDns, statIndex=statIndex, staticIpPrimaryDns=staticIpPrimaryDns, vlanid=vlanid, groupEntry=groupEntry, vlan=vlan, fileName=fileName, portEntry=portEntry, ddminfo=ddminfo, portStatistic=portStatistic, staticIpSecondaryDns=staticIpSecondaryDns, serialnum=serialnum, multicastsTransmitted=multicastsTransmitted, vendorName=vendorName, vendorPn=vendorPn, portStatEntry=portStatEntry, lan4=lan4, portmode=portmode, jumblan3=jumblan3, jumblan2=jumblan2, groupid=groupid, catvEnable=catvEnable, lanportName=lanportName, groupIndex=groupIndex, multicastsReceived=multicastsReceived, pauseTransmitted=pauseTransmitted, hostname=hostname, txPower=txPower, vendorOui=vendorOui)
