...
TimeTicks, Counter64, Integer32, enterprises, Bits, NotificationType, ModuleIdentity, Gauge32, ObjectIdentity, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, MibIdentifier, mib_2, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "Integer32", "enterprises", "Bits", "NotificationType", "ModuleIdentity", "Gauge32", "ObjectIdentity", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "MibIdentifier", "mib-2", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portStatistic=portStatistic, bias=bias, vendorName=vendorName, catvEnable=catvEnable, staticIpSecondaryDns=staticIpSecondaryDns, lan3=lan3, portStatEntry=portStatEntry, vendorPn=vendorPn, statIndex=statIndex, xg6846=xg6846, portmode=portmode, tftpSevIp=tftpSevIp, staticIpAddr=staticIpAddr, lanportName=lanportName, modeEntry=modeEntry, txPower=txPower, tftp=tftp, portName=portName, reboot=reboot, pauseTransmitted=pauseTransmitted, port1=port1, jumblan4=jumblan4, jumb=jumb, fcsErrorTransmitted=fcsErrorTransmitted, staticIpSubMask=staticIpSubMask, port2=port2, speed=speed, deviceinfo=deviceinfo, catv=catv, statisticTable=statisticTable, portIndex=portIndex, qosEntry=qosEntry, jumblan1=jumblan1, groupIndex=groupIndex, portPower=portPower, qmode=qmode, temperature=temperature, primaryDns=primaryDns, staticDns=staticDns, portEntry=portEntry, action=action, domainame=domainame, port4=port4, pauseReceived=pauseReceived, lanportpause=lanportpause, qosTable=qosTable, lan1=lan1, voltage=voltage, vendorOui=vendorOui, staticIpHostName=staticIpHostName, vlangroupTable=vlangroupTable, qos=qos, staticIpGateway=staticIpGateway, lan4=lan4, jumbwan=jumbwan, wan=wan, port3=port3, ddminfo=ddminfo, jumblan2=jumblan2, rebootEnable=rebootEnable, lanportspeed=lanportspeed, hostname=hostname, jumblan3=jumblan3, wanType=wanType, vlanid=vlanid, fileType=fileType, adminStatus=adminStatus, broadcastsReceived=broadcastsReceived, broadcastsTransmitted=broadcastsTransmitted, serialnum=serialnum, operStatus=operStatus, unicastsTransmitted=unicastsTransmitted, secondaryDns=secondaryDns, dscpEnable=dscpEnable, multicastsReceived=multicastsReceived, lan2=lan2, qosIndex=qosIndex, qmapping=qmapping, unicastsReceived=unicastsReceived, groupid=groupid, fcsErrorReceived=fcsErrorReceived, vendorRev=vendorRev, lanportTable=lanportTable, groupEntry=groupEntry, multicastsTransmitted=multicastsTransmitted, lanportIndex=lanportIndex, portTable=portTable, internetPort=internetPort, staticIpPrimaryDns=staticIpPrimaryDns, rxPower=rxPower, staticIpDomainName=staticIpDomainName, vlan=vlan, priority=priority, fileName=fileName)
