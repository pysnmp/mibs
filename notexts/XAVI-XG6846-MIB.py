...
NotificationType, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, snmpModules, Bits, ObjectIdentity, Gauge32, enterprises, IpAddress, iso, TimeTicks, Integer32, Unsigned32, ModuleIdentity, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "snmpModules", "Bits", "ObjectIdentity", "Gauge32", "enterprises", "IpAddress", "iso", "TimeTicks", "Integer32", "Unsigned32", "ModuleIdentity", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", tftpSevIp=tftpSevIp, ddminfo=ddminfo, lanportIndex=lanportIndex, lan2=lan2, port3=port3, portTable=portTable, portEntry=portEntry, wan=wan, broadcastsReceived=broadcastsReceived, primaryDns=primaryDns, temperature=temperature, qmapping=qmapping, pauseTransmitted=pauseTransmitted, staticIpGateway=staticIpGateway, rebootEnable=rebootEnable, vendorPn=vendorPn, catvEnable=catvEnable, modeEntry=modeEntry, portStatEntry=portStatEntry, multicastsTransmitted=multicastsTransmitted, qosIndex=qosIndex, statisticTable=statisticTable, internetPort=internetPort, catv=catv, lan4=lan4, portIndex=portIndex, lanportpause=lanportpause, portmode=portmode, vlan=vlan, vendorRev=vendorRev, txPower=txPower, qmode=qmode, port4=port4, staticIpSubMask=staticIpSubMask, operStatus=operStatus, vendorOui=vendorOui, pauseReceived=pauseReceived, lan1=lan1, jumblan2=jumblan2, port1=port1, groupid=groupid, lanportspeed=lanportspeed, unicastsReceived=unicastsReceived, lanportName=lanportName, serialnum=serialnum, priority=priority, reboot=reboot, voltage=voltage, secondaryDns=secondaryDns, staticIpSecondaryDns=staticIpSecondaryDns, fcsErrorReceived=fcsErrorReceived, rxPower=rxPower, hostname=hostname, jumblan3=jumblan3, action=action, statIndex=statIndex, wanType=wanType, staticIpDomainName=staticIpDomainName, qos=qos, groupIndex=groupIndex, staticIpHostName=staticIpHostName, xg6846=xg6846, portPower=portPower, jumb=jumb, lanportTable=lanportTable, vlanid=vlanid, lan3=lan3, jumblan4=jumblan4, staticIpPrimaryDns=staticIpPrimaryDns, portStatistic=portStatistic, port2=port2, fcsErrorTransmitted=fcsErrorTransmitted, portName=portName, adminStatus=adminStatus, qosTable=qosTable, unicastsTransmitted=unicastsTransmitted, bias=bias, broadcastsTransmitted=broadcastsTransmitted, groupEntry=groupEntry, domainame=domainame, vlangroupTable=vlangroupTable, staticIpAddr=staticIpAddr, deviceinfo=deviceinfo, multicastsReceived=multicastsReceived, vendorName=vendorName, jumbwan=jumbwan, tftp=tftp, fileName=fileName, staticDns=staticDns, qosEntry=qosEntry, dscpEnable=dscpEnable, speed=speed, fileType=fileType, jumblan1=jumblan1)
