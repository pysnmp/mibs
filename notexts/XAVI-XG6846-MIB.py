...
# Produced by pysmi-1.1.8 at Fri Jan 27 14:17:37 2023
...
snmpModules, mib_2, Gauge32, NotificationType, IpAddress, Integer32, Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, Unsigned32, enterprises, Counter32, MibIdentifier, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "mib-2", "Gauge32", "NotificationType", "IpAddress", "Integer32", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "Unsigned32", "enterprises", "Counter32", "MibIdentifier", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", tftpSevIp=tftpSevIp, broadcastsReceived=broadcastsReceived, operStatus=operStatus, modeEntry=modeEntry, fileName=fileName, staticIpAddr=staticIpAddr, fcsErrorTransmitted=fcsErrorTransmitted, vendorOui=vendorOui, rxPower=rxPower, temperature=temperature, staticIpSecondaryDns=staticIpSecondaryDns, lanportspeed=lanportspeed, ddminfo=ddminfo, qos=qos, portStatEntry=portStatEntry, groupEntry=groupEntry, secondaryDns=secondaryDns, statisticTable=statisticTable, port2=port2, xg6846=xg6846, qosTable=qosTable, speed=speed, rebootEnable=rebootEnable, portPower=portPower, jumblan4=jumblan4, broadcastsTransmitted=broadcastsTransmitted, staticIpSubMask=staticIpSubMask, lanportTable=lanportTable, qmode=qmode, multicastsTransmitted=multicastsTransmitted, wan=wan, txPower=txPower, staticDns=staticDns, qosEntry=qosEntry, pauseReceived=pauseReceived, jumb=jumb, vendorRev=vendorRev, lan3=lan3, vendorPn=vendorPn, catvEnable=catvEnable, action=action, statIndex=statIndex, lan2=lan2, fileType=fileType, jumblan3=jumblan3, lan4=lan4, vendorName=vendorName, portName=portName, reboot=reboot, portmode=portmode, unicastsReceived=unicastsReceived, serialnum=serialnum, unicastsTransmitted=unicastsTransmitted, priority=priority, portTable=portTable, hostname=hostname, vlan=vlan, portStatistic=portStatistic, jumblan2=jumblan2, port4=port4, jumblan1=jumblan1, staticIpDomainName=staticIpDomainName, portIndex=portIndex, wanType=wanType, port3=port3, staticIpGateway=staticIpGateway, port1=port1, portEntry=portEntry, internetPort=internetPort, primaryDns=primaryDns, qosIndex=qosIndex, groupid=groupid, tftp=tftp, adminStatus=adminStatus, lan1=lan1, jumbwan=jumbwan, vlanid=vlanid, deviceinfo=deviceinfo, catv=catv, lanportIndex=lanportIndex, qmapping=qmapping, bias=bias, domainame=domainame, voltage=voltage, staticIpHostName=staticIpHostName, multicastsReceived=multicastsReceived, pauseTransmitted=pauseTransmitted, groupIndex=groupIndex, vlangroupTable=vlangroupTable, dscpEnable=dscpEnable, fcsErrorReceived=fcsErrorReceived, lanportName=lanportName, staticIpPrimaryDns=staticIpPrimaryDns, lanportpause=lanportpause)
