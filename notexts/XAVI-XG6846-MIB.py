...
# Produced by pysmi-1.1.8 at Mon Jan 17 15:00:50 2022
...
TimeTicks, snmpModules, Integer32, iso, IpAddress, Bits, NotificationType, MibIdentifier, Counter64, enterprises, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, mib_2, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "snmpModules", "Integer32", "iso", "IpAddress", "Bits", "NotificationType", "MibIdentifier", "Counter64", "enterprises", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "mib-2", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpSecondaryDns=staticIpSecondaryDns, port3=port3, staticIpDomainName=staticIpDomainName, lanportTable=lanportTable, jumb=jumb, temperature=temperature, jumblan2=jumblan2, catvEnable=catvEnable, internetPort=internetPort, staticIpGateway=staticIpGateway, vlanid=vlanid, portStatEntry=portStatEntry, serialnum=serialnum, portPower=portPower, multicastsTransmitted=multicastsTransmitted, deviceinfo=deviceinfo, wan=wan, statIndex=statIndex, lanportIndex=lanportIndex, action=action, secondaryDns=secondaryDns, lan2=lan2, lan4=lan4, pauseReceived=pauseReceived, tftp=tftp, vendorOui=vendorOui, lanportpause=lanportpause, unicastsReceived=unicastsReceived, jumblan4=jumblan4, vlangroupTable=vlangroupTable, wanType=wanType, domainame=domainame, adminStatus=adminStatus, reboot=reboot, voltage=voltage, staticDns=staticDns, statisticTable=statisticTable, portIndex=portIndex, fcsErrorTransmitted=fcsErrorTransmitted, multicastsReceived=multicastsReceived, jumblan1=jumblan1, rxPower=rxPower, staticIpAddr=staticIpAddr, jumblan3=jumblan3, fileType=fileType, portTable=portTable, hostname=hostname, staticIpHostName=staticIpHostName, qmode=qmode, port1=port1, portStatistic=portStatistic, bias=bias, rebootEnable=rebootEnable, speed=speed, tftpSevIp=tftpSevIp, staticIpSubMask=staticIpSubMask, primaryDns=primaryDns, groupEntry=groupEntry, broadcastsReceived=broadcastsReceived, lan3=lan3, vendorName=vendorName, pauseTransmitted=pauseTransmitted, portmode=portmode, lanportspeed=lanportspeed, groupid=groupid, fileName=fileName, portEntry=portEntry, qmapping=qmapping, qos=qos, port2=port2, unicastsTransmitted=unicastsTransmitted, port4=port4, fcsErrorReceived=fcsErrorReceived, vendorRev=vendorRev, vendorPn=vendorPn, groupIndex=groupIndex, broadcastsTransmitted=broadcastsTransmitted, qosIndex=qosIndex, portName=portName, qosTable=qosTable, catv=catv, qosEntry=qosEntry, operStatus=operStatus, vlan=vlan, txPower=txPower, lan1=lan1, lanportName=lanportName, staticIpPrimaryDns=staticIpPrimaryDns, priority=priority, modeEntry=modeEntry, dscpEnable=dscpEnable, ddminfo=ddminfo, jumbwan=jumbwan, xg6846=xg6846)
