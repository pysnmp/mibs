...
# Produced by pysmi-1.1.3 at Wed Dec  8 17:56:29 2021
...
snmpModules, mib_2, NotificationType, Integer32, iso, Counter32, Gauge32, MibIdentifier, ModuleIdentity, Bits, ObjectIdentity, Unsigned32, enterprises, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "mib-2", "NotificationType", "Integer32", "iso", "Counter32", "Gauge32", "MibIdentifier", "ModuleIdentity", "Bits", "ObjectIdentity", "Unsigned32", "enterprises", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", priority=priority, qosIndex=qosIndex, vlangroupTable=vlangroupTable, domainame=domainame, staticIpPrimaryDns=staticIpPrimaryDns, jumblan2=jumblan2, staticIpGateway=staticIpGateway, dscpEnable=dscpEnable, vendorName=vendorName, port3=port3, multicastsTransmitted=multicastsTransmitted, adminStatus=adminStatus, broadcastsReceived=broadcastsReceived, temperature=temperature, fileType=fileType, modeEntry=modeEntry, jumblan4=jumblan4, lanportspeed=lanportspeed, lan2=lan2, fcsErrorTransmitted=fcsErrorTransmitted, portStatistic=portStatistic, groupid=groupid, statisticTable=statisticTable, unicastsTransmitted=unicastsTransmitted, catvEnable=catvEnable, pauseReceived=pauseReceived, lanportIndex=lanportIndex, staticIpSecondaryDns=staticIpSecondaryDns, reboot=reboot, staticIpSubMask=staticIpSubMask, operStatus=operStatus, internetPort=internetPort, lan1=lan1, portIndex=portIndex, hostname=hostname, ddminfo=ddminfo, secondaryDns=secondaryDns, txPower=txPower, pauseTransmitted=pauseTransmitted, qosTable=qosTable, speed=speed, fcsErrorReceived=fcsErrorReceived, lanportTable=lanportTable, rebootEnable=rebootEnable, portPower=portPower, qos=qos, serialnum=serialnum, vendorRev=vendorRev, vlanid=vlanid, lan3=lan3, vendorOui=vendorOui, tftpSevIp=tftpSevIp, lanportName=lanportName, lan4=lan4, tftp=tftp, jumbwan=jumbwan, wanType=wanType, port4=port4, port1=port1, staticIpDomainName=staticIpDomainName, catv=catv, unicastsReceived=unicastsReceived, vlan=vlan, port2=port2, staticIpHostName=staticIpHostName, groupIndex=groupIndex, voltage=voltage, multicastsReceived=multicastsReceived, bias=bias, portEntry=portEntry, statIndex=statIndex, jumblan3=jumblan3, jumblan1=jumblan1, qosEntry=qosEntry, rxPower=rxPower, xg6846=xg6846, portStatEntry=portStatEntry, wan=wan, qmode=qmode, deviceinfo=deviceinfo, vendorPn=vendorPn, jumb=jumb, staticIpAddr=staticIpAddr, portmode=portmode, lanportpause=lanportpause, portTable=portTable, broadcastsTransmitted=broadcastsTransmitted, groupEntry=groupEntry, primaryDns=primaryDns, action=action, staticDns=staticDns, qmapping=qmapping, fileName=fileName, portName=portName)
