...
# Produced by pysmi-1.1.3 at Sun Nov 28 21:18:39 2021
...
TimeTicks, snmpModules, Unsigned32, ObjectIdentity, Bits, mib_2, iso, enterprises, Counter64, NotificationType, Integer32, ModuleIdentity, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "snmpModules", "Unsigned32", "ObjectIdentity", "Bits", "mib-2", "iso", "enterprises", "Counter64", "NotificationType", "Integer32", "ModuleIdentity", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorOui=vendorOui, broadcastsTransmitted=broadcastsTransmitted, qmode=qmode, portStatistic=portStatistic, groupIndex=groupIndex, vlanid=vlanid, reboot=reboot, portStatEntry=portStatEntry, fileType=fileType, qmapping=qmapping, jumblan4=jumblan4, portName=portName, fcsErrorTransmitted=fcsErrorTransmitted, qosEntry=qosEntry, portmode=portmode, rebootEnable=rebootEnable, port4=port4, port1=port1, rxPower=rxPower, jumb=jumb, fileName=fileName, secondaryDns=secondaryDns, lanportIndex=lanportIndex, action=action, lan3=lan3, xg6846=xg6846, portTable=portTable, vendorPn=vendorPn, unicastsTransmitted=unicastsTransmitted, groupid=groupid, jumblan3=jumblan3, jumbwan=jumbwan, deviceinfo=deviceinfo, statIndex=statIndex, broadcastsReceived=broadcastsReceived, vendorName=vendorName, staticIpGateway=staticIpGateway, catv=catv, fcsErrorReceived=fcsErrorReceived, tftpSevIp=tftpSevIp, staticIpSubMask=staticIpSubMask, lanportName=lanportName, staticIpDomainName=staticIpDomainName, unicastsReceived=unicastsReceived, multicastsTransmitted=multicastsTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, priority=priority, modeEntry=modeEntry, operStatus=operStatus, speed=speed, staticDns=staticDns, statisticTable=statisticTable, vlangroupTable=vlangroupTable, hostname=hostname, port2=port2, txPower=txPower, staticIpAddr=staticIpAddr, bias=bias, pauseReceived=pauseReceived, catvEnable=catvEnable, wanType=wanType, staticIpHostName=staticIpHostName, ddminfo=ddminfo, lan2=lan2, port3=port3, jumblan1=jumblan1, qos=qos, domainame=domainame, dscpEnable=dscpEnable, portIndex=portIndex, lanportpause=lanportpause, vlan=vlan, jumblan2=jumblan2, wan=wan, qosTable=qosTable, multicastsReceived=multicastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, portPower=portPower, voltage=voltage, primaryDns=primaryDns, serialnum=serialnum, temperature=temperature, portEntry=portEntry, lanportspeed=lanportspeed, groupEntry=groupEntry, internetPort=internetPort, pauseTransmitted=pauseTransmitted, lanportTable=lanportTable, adminStatus=adminStatus, vendorRev=vendorRev, lan4=lan4, lan1=lan1, tftp=tftp, qosIndex=qosIndex)
