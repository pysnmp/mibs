...
Gauge32, ModuleIdentity, Counter32, snmpModules, enterprises, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, MibIdentifier, ObjectIdentity, Unsigned32, Counter64, iso, mib_2, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "Counter32", "snmpModules", "enterprises", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "MibIdentifier", "ObjectIdentity", "Unsigned32", "Counter64", "iso", "mib-2", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", catvEnable=catvEnable, lan2=lan2, jumb=jumb, vendorOui=vendorOui, vendorName=vendorName, bias=bias, modeEntry=modeEntry, lanportpause=lanportpause, staticIpPrimaryDns=staticIpPrimaryDns, multicastsTransmitted=multicastsTransmitted, reboot=reboot, staticIpSecondaryDns=staticIpSecondaryDns, jumblan3=jumblan3, priority=priority, fileType=fileType, broadcastsTransmitted=broadcastsTransmitted, portName=portName, wanType=wanType, portStatistic=portStatistic, staticIpHostName=staticIpHostName, fcsErrorReceived=fcsErrorReceived, operStatus=operStatus, vendorPn=vendorPn, groupEntry=groupEntry, lanportspeed=lanportspeed, port2=port2, unicastsReceived=unicastsReceived, staticIpGateway=staticIpGateway, qosTable=qosTable, action=action, lan4=lan4, pauseTransmitted=pauseTransmitted, lan1=lan1, fileName=fileName, staticDns=staticDns, serialnum=serialnum, broadcastsReceived=broadcastsReceived, domainame=domainame, vendorRev=vendorRev, temperature=temperature, vlan=vlan, rxPower=rxPower, primaryDns=primaryDns, port4=port4, deviceinfo=deviceinfo, ddminfo=ddminfo, internetPort=internetPort, tftp=tftp, portmode=portmode, portPower=portPower, staticIpAddr=staticIpAddr, txPower=txPower, qos=qos, dscpEnable=dscpEnable, hostname=hostname, vlanid=vlanid, statisticTable=statisticTable, lanportIndex=lanportIndex, port1=port1, staticIpDomainName=staticIpDomainName, jumblan2=jumblan2, qosEntry=qosEntry, lanportName=lanportName, speed=speed, jumblan4=jumblan4, qmode=qmode, qosIndex=qosIndex, portIndex=portIndex, groupid=groupid, voltage=voltage, qmapping=qmapping, lanportTable=lanportTable, secondaryDns=secondaryDns, rebootEnable=rebootEnable, vlangroupTable=vlangroupTable, portEntry=portEntry, xg6846=xg6846, lan3=lan3, port3=port3, portStatEntry=portStatEntry, adminStatus=adminStatus, portTable=portTable, jumbwan=jumbwan, statIndex=statIndex, tftpSevIp=tftpSevIp, groupIndex=groupIndex, jumblan1=jumblan1, unicastsTransmitted=unicastsTransmitted, staticIpSubMask=staticIpSubMask, multicastsReceived=multicastsReceived, pauseReceived=pauseReceived, fcsErrorTransmitted=fcsErrorTransmitted, wan=wan, catv=catv)
