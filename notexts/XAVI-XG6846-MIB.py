...
Integer32, ObjectIdentity, MibIdentifier, Counter32, TimeTicks, enterprises, snmpModules, Bits, NotificationType, IpAddress, Unsigned32, ModuleIdentity, Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "MibIdentifier", "Counter32", "TimeTicks", "enterprises", "snmpModules", "Bits", "NotificationType", "IpAddress", "Unsigned32", "ModuleIdentity", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan2=lan2, jumblan1=jumblan1, jumblan2=jumblan2, jumbwan=jumbwan, qos=qos, portName=portName, vendorName=vendorName, portStatistic=portStatistic, catvEnable=catvEnable, qmapping=qmapping, vendorOui=vendorOui, qmode=qmode, port3=port3, portTable=portTable, portIndex=portIndex, fcsErrorTransmitted=fcsErrorTransmitted, action=action, jumb=jumb, staticDns=staticDns, modeEntry=modeEntry, xg6846=xg6846, broadcastsTransmitted=broadcastsTransmitted, domainame=domainame, secondaryDns=secondaryDns, tftpSevIp=tftpSevIp, speed=speed, lanportspeed=lanportspeed, qosTable=qosTable, port1=port1, port2=port2, jumblan4=jumblan4, lanportpause=lanportpause, primaryDns=primaryDns, statIndex=statIndex, reboot=reboot, lan4=lan4, groupid=groupid, staticIpSubMask=staticIpSubMask, staticIpAddr=staticIpAddr, fileType=fileType, lan3=lan3, vlangroupTable=vlangroupTable, groupIndex=groupIndex, fileName=fileName, wan=wan, operStatus=operStatus, multicastsTransmitted=multicastsTransmitted, groupEntry=groupEntry, hostname=hostname, deviceinfo=deviceinfo, jumblan3=jumblan3, lanportName=lanportName, dscpEnable=dscpEnable, ddminfo=ddminfo, pauseReceived=pauseReceived, pauseTransmitted=pauseTransmitted, unicastsTransmitted=unicastsTransmitted, voltage=voltage, txPower=txPower, bias=bias, priority=priority, rxPower=rxPower, unicastsReceived=unicastsReceived, vlan=vlan, catv=catv, port4=port4, qosIndex=qosIndex, staticIpDomainName=staticIpDomainName, lanportTable=lanportTable, vlanid=vlanid, wanType=wanType, broadcastsReceived=broadcastsReceived, portStatEntry=portStatEntry, serialnum=serialnum, vendorPn=vendorPn, portmode=portmode, tftp=tftp, portEntry=portEntry, portPower=portPower, adminStatus=adminStatus, internetPort=internetPort, vendorRev=vendorRev, fcsErrorReceived=fcsErrorReceived, staticIpPrimaryDns=staticIpPrimaryDns, temperature=temperature, staticIpSecondaryDns=staticIpSecondaryDns, staticIpGateway=staticIpGateway, qosEntry=qosEntry, multicastsReceived=multicastsReceived, statisticTable=statisticTable, rebootEnable=rebootEnable, staticIpHostName=staticIpHostName, lanportIndex=lanportIndex, lan1=lan1)
