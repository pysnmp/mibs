...
# Produced by pysmi-1.1.8 at Fri Jan 27 14:09:02 2023
...
ObjectIdentity, enterprises, NotificationType, IpAddress, Gauge32, ModuleIdentity, Unsigned32, Counter32, mib_2, MibIdentifier, Bits, Counter64, Integer32, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "enterprises", "NotificationType", "IpAddress", "Gauge32", "ModuleIdentity", "Unsigned32", "Counter32", "mib-2", "MibIdentifier", "Bits", "Counter64", "Integer32", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan4=lan4, jumb=jumb, lanportTable=lanportTable, xg6846=xg6846, rebootEnable=rebootEnable, staticIpSubMask=staticIpSubMask, priority=priority, portPower=portPower, multicastsTransmitted=multicastsTransmitted, groupEntry=groupEntry, temperature=temperature, vlan=vlan, voltage=voltage, tftp=tftp, fcsErrorTransmitted=fcsErrorTransmitted, vendorPn=vendorPn, dscpEnable=dscpEnable, lanportspeed=lanportspeed, vlanid=vlanid, groupid=groupid, portEntry=portEntry, secondaryDns=secondaryDns, serialnum=serialnum, lanportIndex=lanportIndex, staticIpGateway=staticIpGateway, fileName=fileName, portStatEntry=portStatEntry, lan3=lan3, txPower=txPower, speed=speed, deviceinfo=deviceinfo, unicastsTransmitted=unicastsTransmitted, portTable=portTable, statisticTable=statisticTable, vendorOui=vendorOui, lanportpause=lanportpause, jumblan2=jumblan2, port1=port1, fcsErrorReceived=fcsErrorReceived, tftpSevIp=tftpSevIp, operStatus=operStatus, modeEntry=modeEntry, reboot=reboot, fileType=fileType, port3=port3, unicastsReceived=unicastsReceived, catv=catv, staticIpSecondaryDns=staticIpSecondaryDns, bias=bias, qmapping=qmapping, catvEnable=catvEnable, rxPower=rxPower, multicastsReceived=multicastsReceived, vendorName=vendorName, jumblan1=jumblan1, qmode=qmode, wan=wan, jumbwan=jumbwan, vlangroupTable=vlangroupTable, vendorRev=vendorRev, portStatistic=portStatistic, hostname=hostname, port2=port2, jumblan3=jumblan3, portIndex=portIndex, wanType=wanType, action=action, qosTable=qosTable, port4=port4, portmode=portmode, staticIpPrimaryDns=staticIpPrimaryDns, lanportName=lanportName, lan2=lan2, staticIpDomainName=staticIpDomainName, qosIndex=qosIndex, adminStatus=adminStatus, staticIpHostName=staticIpHostName, qosEntry=qosEntry, jumblan4=jumblan4, broadcastsReceived=broadcastsReceived, ddminfo=ddminfo, internetPort=internetPort, qos=qos, primaryDns=primaryDns, staticIpAddr=staticIpAddr, portName=portName, statIndex=statIndex, lan1=lan1, pauseTransmitted=pauseTransmitted, domainame=domainame, staticDns=staticDns, broadcastsTransmitted=broadcastsTransmitted, groupIndex=groupIndex, pauseReceived=pauseReceived)
