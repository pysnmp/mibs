...
# Produced by pysmi-1.1.8 at Wed Sep 13 12:54:20 2023
...
Integer32, ObjectIdentity, TimeTicks, snmpModules, Unsigned32, enterprises, iso, mib_2, IpAddress, MibIdentifier, Counter64, Counter32, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "TimeTicks", "snmpModules", "Unsigned32", "enterprises", "iso", "mib-2", "IpAddress", "MibIdentifier", "Counter64", "Counter32", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", internetPort=internetPort, staticIpDomainName=staticIpDomainName, multicastsReceived=multicastsReceived, tftpSevIp=tftpSevIp, jumblan3=jumblan3, pauseReceived=pauseReceived, unicastsTransmitted=unicastsTransmitted, lan4=lan4, jumbwan=jumbwan, fcsErrorReceived=fcsErrorReceived, rebootEnable=rebootEnable, jumb=jumb, lanportIndex=lanportIndex, qmapping=qmapping, groupIndex=groupIndex, portStatEntry=portStatEntry, statIndex=statIndex, portTable=portTable, port2=port2, rxPower=rxPower, port4=port4, txPower=txPower, vlan=vlan, primaryDns=primaryDns, qosEntry=qosEntry, jumblan2=jumblan2, staticIpSubMask=staticIpSubMask, jumblan1=jumblan1, ddminfo=ddminfo, xg6846=xg6846, wanType=wanType, portStatistic=portStatistic, staticDns=staticDns, staticIpPrimaryDns=staticIpPrimaryDns, reboot=reboot, portPower=portPower, lan3=lan3, port1=port1, adminStatus=adminStatus, dscpEnable=dscpEnable, secondaryDns=secondaryDns, catvEnable=catvEnable, lan1=lan1, staticIpHostName=staticIpHostName, portmode=portmode, vlanid=vlanid, groupid=groupid, statisticTable=statisticTable, modeEntry=modeEntry, bias=bias, domainame=domainame, lanportpause=lanportpause, portEntry=portEntry, qmode=qmode, broadcastsTransmitted=broadcastsTransmitted, serialnum=serialnum, staticIpAddr=staticIpAddr, lanportspeed=lanportspeed, voltage=voltage, hostname=hostname, staticIpSecondaryDns=staticIpSecondaryDns, lanportTable=lanportTable, vendorRev=vendorRev, vlangroupTable=vlangroupTable, qos=qos, staticIpGateway=staticIpGateway, fileType=fileType, qosIndex=qosIndex, pauseTransmitted=pauseTransmitted, fcsErrorTransmitted=fcsErrorTransmitted, fileName=fileName, vendorPn=vendorPn, speed=speed, port3=port3, vendorOui=vendorOui, portName=portName, deviceinfo=deviceinfo, vendorName=vendorName, broadcastsReceived=broadcastsReceived, jumblan4=jumblan4, wan=wan, lan2=lan2, groupEntry=groupEntry, operStatus=operStatus, unicastsReceived=unicastsReceived, action=action, catv=catv, tftp=tftp, temperature=temperature, priority=priority, lanportName=lanportName, multicastsTransmitted=multicastsTransmitted, qosTable=qosTable, portIndex=portIndex)
