...
# Produced by pysmi-1.1.0 at Tue Nov 16 11:52:05 2021
...
mib_2, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, snmpModules, IpAddress, TimeTicks, enterprises, ObjectIdentity, Counter32, MibIdentifier, ModuleIdentity, Bits, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "snmpModules", "IpAddress", "TimeTicks", "enterprises", "ObjectIdentity", "Counter32", "MibIdentifier", "ModuleIdentity", "Bits", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", wan=wan, qos=qos, lanportIndex=lanportIndex, portEntry=portEntry, vlangroupTable=vlangroupTable, staticDns=staticDns, statisticTable=statisticTable, adminStatus=adminStatus, secondaryDns=secondaryDns, vendorRev=vendorRev, qmode=qmode, lanportspeed=lanportspeed, lanportName=lanportName, staticIpPrimaryDns=staticIpPrimaryDns, vendorName=vendorName, wanType=wanType, broadcastsTransmitted=broadcastsTransmitted, fcsErrorReceived=fcsErrorReceived, pauseTransmitted=pauseTransmitted, vendorPn=vendorPn, txPower=txPower, unicastsTransmitted=unicastsTransmitted, tftp=tftp, jumb=jumb, vlan=vlan, fileName=fileName, operStatus=operStatus, qosEntry=qosEntry, deviceinfo=deviceinfo, staticIpAddr=staticIpAddr, staticIpDomainName=staticIpDomainName, action=action, portStatistic=portStatistic, multicastsReceived=multicastsReceived, unicastsReceived=unicastsReceived, domainame=domainame, catvEnable=catvEnable, portmode=portmode, priority=priority, portIndex=portIndex, groupIndex=groupIndex, statIndex=statIndex, broadcastsReceived=broadcastsReceived, multicastsTransmitted=multicastsTransmitted, dscpEnable=dscpEnable, lan3=lan3, fcsErrorTransmitted=fcsErrorTransmitted, voltage=voltage, staticIpSecondaryDns=staticIpSecondaryDns, lanportTable=lanportTable, qmapping=qmapping, portStatEntry=portStatEntry, port4=port4, port2=port2, rxPower=rxPower, staticIpHostName=staticIpHostName, jumblan3=jumblan3, lan1=lan1, lan2=lan2, fileType=fileType, jumbwan=jumbwan, primaryDns=primaryDns, vlanid=vlanid, ddminfo=ddminfo, portName=portName, xg6846=xg6846, vendorOui=vendorOui, groupid=groupid, rebootEnable=rebootEnable, tftpSevIp=tftpSevIp, lanportpause=lanportpause, portTable=portTable, portPower=portPower, port3=port3, jumblan1=jumblan1, jumblan4=jumblan4, staticIpSubMask=staticIpSubMask, reboot=reboot, catv=catv, modeEntry=modeEntry, port1=port1, qosIndex=qosIndex, bias=bias, speed=speed, groupEntry=groupEntry, staticIpGateway=staticIpGateway, internetPort=internetPort, pauseReceived=pauseReceived, temperature=temperature, serialnum=serialnum, lan4=lan4, jumblan2=jumblan2, hostname=hostname, qosTable=qosTable)
