...
TimeTicks, Counter32, enterprises, iso, NotificationType, Counter64, Unsigned32, Gauge32, MibIdentifier, mib_2, Integer32, Bits, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "enterprises", "iso", "NotificationType", "Counter64", "Unsigned32", "Gauge32", "MibIdentifier", "mib-2", "Integer32", "Bits", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", reboot=reboot, qos=qos, staticIpGateway=staticIpGateway, jumblan1=jumblan1, multicastsTransmitted=multicastsTransmitted, xg6846=xg6846, modeEntry=modeEntry, lanportspeed=lanportspeed, staticIpAddr=staticIpAddr, txPower=txPower, serialnum=serialnum, portEntry=portEntry, staticIpSecondaryDns=staticIpSecondaryDns, tftpSevIp=tftpSevIp, jumblan4=jumblan4, staticIpPrimaryDns=staticIpPrimaryDns, secondaryDns=secondaryDns, portStatistic=portStatistic, lan1=lan1, lanportName=lanportName, qosTable=qosTable, lan2=lan2, speed=speed, priority=priority, port1=port1, groupIndex=groupIndex, lanportpause=lanportpause, temperature=temperature, jumblan3=jumblan3, ddminfo=ddminfo, catv=catv, rxPower=rxPower, portmode=portmode, dscpEnable=dscpEnable, unicastsReceived=unicastsReceived, portStatEntry=portStatEntry, portIndex=portIndex, vlan=vlan, qosEntry=qosEntry, staticIpHostName=staticIpHostName, vendorName=vendorName, broadcastsTransmitted=broadcastsTransmitted, qmapping=qmapping, groupid=groupid, staticDns=staticDns, rebootEnable=rebootEnable, internetPort=internetPort, bias=bias, deviceinfo=deviceinfo, domainame=domainame, groupEntry=groupEntry, vendorRev=vendorRev, lan3=lan3, pauseReceived=pauseReceived, portName=portName, fileName=fileName, adminStatus=adminStatus, operStatus=operStatus, vlanid=vlanid, port3=port3, jumblan2=jumblan2, qmode=qmode, portPower=portPower, voltage=voltage, port4=port4, hostname=hostname, fcsErrorReceived=fcsErrorReceived, pauseTransmitted=pauseTransmitted, lanportTable=lanportTable, statisticTable=statisticTable, fcsErrorTransmitted=fcsErrorTransmitted, lanportIndex=lanportIndex, primaryDns=primaryDns, qosIndex=qosIndex, broadcastsReceived=broadcastsReceived, tftp=tftp, vlangroupTable=vlangroupTable, statIndex=statIndex, staticIpDomainName=staticIpDomainName, portTable=portTable, jumbwan=jumbwan, multicastsReceived=multicastsReceived, wanType=wanType, unicastsTransmitted=unicastsTransmitted, action=action, vendorPn=vendorPn, lan4=lan4, staticIpSubMask=staticIpSubMask, wan=wan, catvEnable=catvEnable, jumb=jumb, port2=port2, vendorOui=vendorOui, fileType=fileType)
