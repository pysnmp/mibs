...
# Produced by pysmi-1.1.8 at Fri Dec  2 16:47:30 2022
...
iso, ModuleIdentity, Unsigned32, MibIdentifier, TimeTicks, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, snmpModules, IpAddress, Integer32, NotificationType, Counter64, ObjectIdentity, mib_2, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "Unsigned32", "MibIdentifier", "TimeTicks", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "snmpModules", "IpAddress", "Integer32", "NotificationType", "Counter64", "ObjectIdentity", "mib-2", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportpause=lanportpause, hostname=hostname, adminStatus=adminStatus, vendorOui=vendorOui, action=action, jumbwan=jumbwan, qos=qos, portPower=portPower, fcsErrorTransmitted=fcsErrorTransmitted, jumblan4=jumblan4, broadcastsReceived=broadcastsReceived, lan3=lan3, multicastsReceived=multicastsReceived, operStatus=operStatus, txPower=txPower, rebootEnable=rebootEnable, statisticTable=statisticTable, rxPower=rxPower, staticIpSecondaryDns=staticIpSecondaryDns, port3=port3, jumblan1=jumblan1, lanportIndex=lanportIndex, pauseTransmitted=pauseTransmitted, staticIpDomainName=staticIpDomainName, secondaryDns=secondaryDns, reboot=reboot, vendorName=vendorName, vendorRev=vendorRev, fileType=fileType, domainame=domainame, lan1=lan1, speed=speed, bias=bias, primaryDns=primaryDns, broadcastsTransmitted=broadcastsTransmitted, ddminfo=ddminfo, modeEntry=modeEntry, jumblan3=jumblan3, staticIpAddr=staticIpAddr, port1=port1, portStatistic=portStatistic, staticIpHostName=staticIpHostName, vendorPn=vendorPn, fileName=fileName, portEntry=portEntry, vlan=vlan, staticIpSubMask=staticIpSubMask, serialnum=serialnum, portName=portName, staticIpPrimaryDns=staticIpPrimaryDns, qmapping=qmapping, xg6846=xg6846, vlanid=vlanid, groupEntry=groupEntry, lan2=lan2, tftp=tftp, unicastsReceived=unicastsReceived, staticDns=staticDns, lanportTable=lanportTable, fcsErrorReceived=fcsErrorReceived, deviceinfo=deviceinfo, dscpEnable=dscpEnable, port4=port4, internetPort=internetPort, temperature=temperature, portTable=portTable, jumblan2=jumblan2, portmode=portmode, voltage=voltage, qmode=qmode, unicastsTransmitted=unicastsTransmitted, tftpSevIp=tftpSevIp, catv=catv, priority=priority, portIndex=portIndex, lanportName=lanportName, port2=port2, catvEnable=catvEnable, qosIndex=qosIndex, jumb=jumb, groupid=groupid, wanType=wanType, lanportspeed=lanportspeed, wan=wan, portStatEntry=portStatEntry, lan4=lan4, staticIpGateway=staticIpGateway, statIndex=statIndex, pauseReceived=pauseReceived, vlangroupTable=vlangroupTable, multicastsTransmitted=multicastsTransmitted, qosEntry=qosEntry, qosTable=qosTable, groupIndex=groupIndex)
