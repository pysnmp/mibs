...
# Produced by pysmi-1.1.8 at Fri Sep  8 07:36:05 2023
...
TimeTicks, Integer32, Counter32, NotificationType, MibIdentifier, iso, enterprises, IpAddress, mib_2, ObjectIdentity, Unsigned32, snmpModules, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "Counter32", "NotificationType", "MibIdentifier", "iso", "enterprises", "IpAddress", "mib-2", "ObjectIdentity", "Unsigned32", "snmpModules", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", statIndex=statIndex, multicastsTransmitted=multicastsTransmitted, jumbwan=jumbwan, lanportIndex=lanportIndex, ddminfo=ddminfo, portName=portName, jumb=jumb, portTable=portTable, broadcastsTransmitted=broadcastsTransmitted, groupid=groupid, fcsErrorTransmitted=fcsErrorTransmitted, qos=qos, lanportpause=lanportpause, catv=catv, tftp=tftp, port2=port2, unicastsReceived=unicastsReceived, wanType=wanType, jumblan3=jumblan3, temperature=temperature, qosTable=qosTable, reboot=reboot, jumblan1=jumblan1, portStatistic=portStatistic, multicastsReceived=multicastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, vendorName=vendorName, rxPower=rxPower, portPower=portPower, staticIpSubMask=staticIpSubMask, vlanid=vlanid, internetPort=internetPort, pauseReceived=pauseReceived, tftpSevIp=tftpSevIp, staticDns=staticDns, rebootEnable=rebootEnable, lanportspeed=lanportspeed, portEntry=portEntry, serialnum=serialnum, adminStatus=adminStatus, staticIpPrimaryDns=staticIpPrimaryDns, jumblan4=jumblan4, lan2=lan2, fileType=fileType, hostname=hostname, port1=port1, jumblan2=jumblan2, lan4=lan4, txPower=txPower, qosIndex=qosIndex, lan1=lan1, vlangroupTable=vlangroupTable, portStatEntry=portStatEntry, secondaryDns=secondaryDns, fileName=fileName, lanportTable=lanportTable, operStatus=operStatus, broadcastsReceived=broadcastsReceived, fcsErrorReceived=fcsErrorReceived, staticIpHostName=staticIpHostName, qmapping=qmapping, bias=bias, modeEntry=modeEntry, domainame=domainame, xg6846=xg6846, catvEnable=catvEnable, staticIpDomainName=staticIpDomainName, vendorOui=vendorOui, lanportName=lanportName, vlan=vlan, qosEntry=qosEntry, dscpEnable=dscpEnable, groupIndex=groupIndex, voltage=voltage, pauseTransmitted=pauseTransmitted, qmode=qmode, speed=speed, portIndex=portIndex, port4=port4, action=action, deviceinfo=deviceinfo, vendorRev=vendorRev, statisticTable=statisticTable, portmode=portmode, groupEntry=groupEntry, wan=wan, lan3=lan3, staticIpGateway=staticIpGateway, port3=port3, staticIpAddr=staticIpAddr, priority=priority, primaryDns=primaryDns, unicastsTransmitted=unicastsTransmitted, vendorPn=vendorPn)
