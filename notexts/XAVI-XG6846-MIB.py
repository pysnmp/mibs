...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, mib_2, Bits, TimeTicks, Counter32, IpAddress, MibIdentifier, snmpModules, Gauge32, iso, enterprises, ObjectIdentity, Integer32, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "mib-2", "Bits", "TimeTicks", "Counter32", "IpAddress", "MibIdentifier", "snmpModules", "Gauge32", "iso", "enterprises", "ObjectIdentity", "Integer32", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", unicastsReceived=unicastsReceived, qmode=qmode, voltage=voltage, multicastsTransmitted=multicastsTransmitted, qosIndex=qosIndex, primaryDns=primaryDns, jumbwan=jumbwan, broadcastsReceived=broadcastsReceived, portmode=portmode, adminStatus=adminStatus, groupid=groupid, fcsErrorReceived=fcsErrorReceived, bias=bias, hostname=hostname, vlangroupTable=vlangroupTable, speed=speed, lan2=lan2, qosTable=qosTable, qosEntry=qosEntry, lanportspeed=lanportspeed, portName=portName, portStatistic=portStatistic, tftp=tftp, staticIpPrimaryDns=staticIpPrimaryDns, jumblan1=jumblan1, priority=priority, temperature=temperature, ddminfo=ddminfo, catvEnable=catvEnable, vlan=vlan, staticIpHostName=staticIpHostName, dscpEnable=dscpEnable, fileName=fileName, operStatus=operStatus, tftpSevIp=tftpSevIp, staticIpSecondaryDns=staticIpSecondaryDns, lan4=lan4, port3=port3, portEntry=portEntry, lanportIndex=lanportIndex, modeEntry=modeEntry, jumblan2=jumblan2, statIndex=statIndex, catv=catv, lan1=lan1, staticIpAddr=staticIpAddr, reboot=reboot, port4=port4, vendorRev=vendorRev, vendorName=vendorName, domainame=domainame, staticIpDomainName=staticIpDomainName, unicastsTransmitted=unicastsTransmitted, qmapping=qmapping, jumblan4=jumblan4, internetPort=internetPort, jumb=jumb, qos=qos, groupEntry=groupEntry, lan3=lan3, port1=port1, staticIpSubMask=staticIpSubMask, vendorOui=vendorOui, groupIndex=groupIndex, action=action, serialnum=serialnum, fcsErrorTransmitted=fcsErrorTransmitted, jumblan3=jumblan3, xg6846=xg6846, pauseTransmitted=pauseTransmitted, rxPower=rxPower, pauseReceived=pauseReceived, vendorPn=vendorPn, staticIpGateway=staticIpGateway, rebootEnable=rebootEnable, secondaryDns=secondaryDns, multicastsReceived=multicastsReceived, port2=port2, lanportpause=lanportpause, portStatEntry=portStatEntry, lanportName=lanportName, statisticTable=statisticTable, portTable=portTable, wan=wan, vlanid=vlanid, fileType=fileType, portIndex=portIndex, lanportTable=lanportTable, deviceinfo=deviceinfo, txPower=txPower, wanType=wanType, broadcastsTransmitted=broadcastsTransmitted, staticDns=staticDns, portPower=portPower)
