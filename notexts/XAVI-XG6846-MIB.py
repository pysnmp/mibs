...
# Produced by pysmi-1.1.10 at Fri Oct 27 12:15:26 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, enterprises, Gauge32, Bits, Counter32, NotificationType, Counter64, TimeTicks, mib_2, iso, ObjectIdentity, Integer32, IpAddress, ModuleIdentity, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "enterprises", "Gauge32", "Bits", "Counter32", "NotificationType", "Counter64", "TimeTicks", "mib-2", "iso", "ObjectIdentity", "Integer32", "IpAddress", "ModuleIdentity", "Unsigned32", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan1=lan1, statIndex=statIndex, port3=port3, fcsErrorTransmitted=fcsErrorTransmitted, lan3=lan3, lanportspeed=lanportspeed, primaryDns=primaryDns, fcsErrorReceived=fcsErrorReceived, staticDns=staticDns, broadcastsTransmitted=broadcastsTransmitted, groupEntry=groupEntry, groupIndex=groupIndex, lanportTable=lanportTable, portPower=portPower, qmapping=qmapping, port1=port1, adminStatus=adminStatus, txPower=txPower, lanportpause=lanportpause, vendorPn=vendorPn, groupid=groupid, rxPower=rxPower, speed=speed, fileType=fileType, portEntry=portEntry, broadcastsReceived=broadcastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, tftpSevIp=tftpSevIp, ddminfo=ddminfo, vlan=vlan, portStatistic=portStatistic, staticIpPrimaryDns=staticIpPrimaryDns, wan=wan, qosTable=qosTable, xg6846=xg6846, lanportIndex=lanportIndex, qosEntry=qosEntry, portmode=portmode, staticIpDomainName=staticIpDomainName, unicastsReceived=unicastsReceived, jumb=jumb, vlangroupTable=vlangroupTable, serialnum=serialnum, modeEntry=modeEntry, hostname=hostname, jumblan2=jumblan2, deviceinfo=deviceinfo, statisticTable=statisticTable, jumblan1=jumblan1, secondaryDns=secondaryDns, staticIpSubMask=staticIpSubMask, jumblan4=jumblan4, qmode=qmode, vendorOui=vendorOui, unicastsTransmitted=unicastsTransmitted, catv=catv, portStatEntry=portStatEntry, internetPort=internetPort, lan4=lan4, qosIndex=qosIndex, operStatus=operStatus, port4=port4, staticIpHostName=staticIpHostName, staticIpAddr=staticIpAddr, dscpEnable=dscpEnable, catvEnable=catvEnable, bias=bias, vendorName=vendorName, staticIpGateway=staticIpGateway, jumblan3=jumblan3, portName=portName, tftp=tftp, port2=port2, multicastsReceived=multicastsReceived, multicastsTransmitted=multicastsTransmitted, qos=qos, pauseReceived=pauseReceived, portIndex=portIndex, reboot=reboot, action=action, wanType=wanType, priority=priority, temperature=temperature, fileName=fileName, domainame=domainame, portTable=portTable, lanportName=lanportName, lan2=lan2, jumbwan=jumbwan, vendorRev=vendorRev, rebootEnable=rebootEnable, pauseTransmitted=pauseTransmitted, vlanid=vlanid, voltage=voltage)
