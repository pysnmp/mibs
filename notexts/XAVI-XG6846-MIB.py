...
Counter64, MibIdentifier, ModuleIdentity, enterprises, TimeTicks, iso, IpAddress, Integer32, Gauge32, Unsigned32, Bits, NotificationType, mib_2, snmpModules, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibIdentifier", "ModuleIdentity", "enterprises", "TimeTicks", "iso", "IpAddress", "Integer32", "Gauge32", "Unsigned32", "Bits", "NotificationType", "mib-2", "snmpModules", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", serialnum=serialnum, ddminfo=ddminfo, portmode=portmode, port3=port3, temperature=temperature, internetPort=internetPort, statIndex=statIndex, multicastsReceived=multicastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, secondaryDns=secondaryDns, dscpEnable=dscpEnable, portTable=portTable, vlangroupTable=vlangroupTable, groupid=groupid, groupEntry=groupEntry, jumblan2=jumblan2, voltage=voltage, modeEntry=modeEntry, staticIpHostName=staticIpHostName, portIndex=portIndex, qmapping=qmapping, bias=bias, broadcastsTransmitted=broadcastsTransmitted, qosTable=qosTable, multicastsTransmitted=multicastsTransmitted, fileName=fileName, lan4=lan4, wanType=wanType, reboot=reboot, lanportspeed=lanportspeed, unicastsTransmitted=unicastsTransmitted, statisticTable=statisticTable, rebootEnable=rebootEnable, rxPower=rxPower, vlanid=vlanid, priority=priority, adminStatus=adminStatus, jumbwan=jumbwan, catv=catv, vendorRev=vendorRev, port2=port2, jumb=jumb, lan2=lan2, primaryDns=primaryDns, port1=port1, wan=wan, vendorPn=vendorPn, action=action, staticIpGateway=staticIpGateway, portEntry=portEntry, vendorName=vendorName, qmode=qmode, vendorOui=vendorOui, portStatistic=portStatistic, tftp=tftp, lan3=lan3, tftpSevIp=tftpSevIp, unicastsReceived=unicastsReceived, staticDns=staticDns, lanportIndex=lanportIndex, pauseReceived=pauseReceived, speed=speed, qosEntry=qosEntry, lanportName=lanportName, portStatEntry=portStatEntry, deviceinfo=deviceinfo, lanportpause=lanportpause, domainame=domainame, staticIpPrimaryDns=staticIpPrimaryDns, xg6846=xg6846, broadcastsReceived=broadcastsReceived, portPower=portPower, portName=portName, lanportTable=lanportTable, operStatus=operStatus, txPower=txPower, vlan=vlan, fcsErrorReceived=fcsErrorReceived, staticIpSubMask=staticIpSubMask, jumblan3=jumblan3, qosIndex=qosIndex, port4=port4, pauseTransmitted=pauseTransmitted, qos=qos, lan1=lan1, catvEnable=catvEnable, jumblan4=jumblan4, fcsErrorTransmitted=fcsErrorTransmitted, staticIpAddr=staticIpAddr, fileType=fileType, groupIndex=groupIndex, jumblan1=jumblan1, staticIpDomainName=staticIpDomainName, hostname=hostname)
