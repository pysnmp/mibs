...
Unsigned32, ModuleIdentity, snmpModules, enterprises, mib_2, TimeTicks, IpAddress, NotificationType, Counter64, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, Bits, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "snmpModules", "enterprises", "mib-2", "TimeTicks", "IpAddress", "NotificationType", "Counter64", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "Bits", "Integer32", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", port1=port1, vlan=vlan, tftp=tftp, staticIpGateway=staticIpGateway, port2=port2, vendorRev=vendorRev, adminStatus=adminStatus, xg6846=xg6846, action=action, fileType=fileType, voltage=voltage, qmapping=qmapping, staticIpAddr=staticIpAddr, bias=bias, portIndex=portIndex, pauseTransmitted=pauseTransmitted, operStatus=operStatus, speed=speed, statisticTable=statisticTable, domainame=domainame, serialnum=serialnum, qos=qos, lanportName=lanportName, vlanid=vlanid, portmode=portmode, hostname=hostname, jumbwan=jumbwan, jumblan1=jumblan1, jumblan3=jumblan3, qosIndex=qosIndex, lanportspeed=lanportspeed, deviceinfo=deviceinfo, groupid=groupid, port4=port4, vendorOui=vendorOui, catvEnable=catvEnable, lan3=lan3, fcsErrorTransmitted=fcsErrorTransmitted, jumblan2=jumblan2, unicastsTransmitted=unicastsTransmitted, portEntry=portEntry, jumblan4=jumblan4, staticIpPrimaryDns=staticIpPrimaryDns, jumb=jumb, reboot=reboot, wan=wan, rebootEnable=rebootEnable, staticDns=staticDns, vendorName=vendorName, secondaryDns=secondaryDns, internetPort=internetPort, port3=port3, pauseReceived=pauseReceived, tftpSevIp=tftpSevIp, staticIpSubMask=staticIpSubMask, lan1=lan1, temperature=temperature, primaryDns=primaryDns, lan2=lan2, fileName=fileName, lanportIndex=lanportIndex, lanportpause=lanportpause, qmode=qmode, statIndex=statIndex, vlangroupTable=vlangroupTable, dscpEnable=dscpEnable, groupEntry=groupEntry, broadcastsTransmitted=broadcastsTransmitted, qosTable=qosTable, broadcastsReceived=broadcastsReceived, lan4=lan4, staticIpDomainName=staticIpDomainName, qosEntry=qosEntry, lanportTable=lanportTable, txPower=txPower, rxPower=rxPower, portStatEntry=portStatEntry, portPower=portPower, multicastsReceived=multicastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, modeEntry=modeEntry, portTable=portTable, ddminfo=ddminfo, portName=portName, wanType=wanType, fcsErrorReceived=fcsErrorReceived, staticIpHostName=staticIpHostName, unicastsReceived=unicastsReceived, portStatistic=portStatistic, groupIndex=groupIndex, priority=priority, vendorPn=vendorPn, catv=catv, multicastsTransmitted=multicastsTransmitted)
