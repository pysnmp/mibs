...
# Produced by pysmi-1.1.3 at Wed Dec  8 20:56:23 2021
...
Integer32, ObjectIdentity, IpAddress, Gauge32, Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, ModuleIdentity, mib_2, snmpModules, Bits, MibIdentifier, Unsigned32, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "IpAddress", "Gauge32", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "ModuleIdentity", "mib-2", "snmpModules", "Bits", "MibIdentifier", "Unsigned32", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", unicastsTransmitted=unicastsTransmitted, qmapping=qmapping, vlanid=vlanid, wanType=wanType, jumblan2=jumblan2, fileType=fileType, vendorOui=vendorOui, portTable=portTable, internetPort=internetPort, primaryDns=primaryDns, staticIpAddr=staticIpAddr, fileName=fileName, reboot=reboot, broadcastsTransmitted=broadcastsTransmitted, qosIndex=qosIndex, txPower=txPower, statisticTable=statisticTable, tftp=tftp, catv=catv, portPower=portPower, priority=priority, qmode=qmode, lanportName=lanportName, staticIpDomainName=staticIpDomainName, groupIndex=groupIndex, catvEnable=catvEnable, portIndex=portIndex, deviceinfo=deviceinfo, dscpEnable=dscpEnable, groupEntry=groupEntry, portmode=portmode, lanportTable=lanportTable, multicastsTransmitted=multicastsTransmitted, serialnum=serialnum, qos=qos, portStatistic=portStatistic, portStatEntry=portStatEntry, port1=port1, pauseTransmitted=pauseTransmitted, statIndex=statIndex, qosTable=qosTable, fcsErrorReceived=fcsErrorReceived, rxPower=rxPower, action=action, port2=port2, staticDns=staticDns, staticIpPrimaryDns=staticIpPrimaryDns, hostname=hostname, staticIpGateway=staticIpGateway, port4=port4, lanportpause=lanportpause, staticIpSubMask=staticIpSubMask, bias=bias, lanportspeed=lanportspeed, jumbwan=jumbwan, xg6846=xg6846, portEntry=portEntry, jumb=jumb, vendorPn=vendorPn, lan1=lan1, temperature=temperature, staticIpSecondaryDns=staticIpSecondaryDns, vlan=vlan, lan4=lan4, lan2=lan2, lan3=lan3, port3=port3, domainame=domainame, broadcastsReceived=broadcastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, wan=wan, operStatus=operStatus, vendorName=vendorName, adminStatus=adminStatus, qosEntry=qosEntry, modeEntry=modeEntry, ddminfo=ddminfo, multicastsReceived=multicastsReceived, voltage=voltage, rebootEnable=rebootEnable, speed=speed, lanportIndex=lanportIndex, vlangroupTable=vlangroupTable, tftpSevIp=tftpSevIp, secondaryDns=secondaryDns, staticIpHostName=staticIpHostName, jumblan3=jumblan3, jumblan4=jumblan4, jumblan1=jumblan1, portName=portName, unicastsReceived=unicastsReceived, groupid=groupid, vendorRev=vendorRev, pauseReceived=pauseReceived)
