...
# Produced by pysmi-1.1.10 at Thu Oct 26 13:09:42 2023
...
Gauge32, Unsigned32, snmpModules, Counter64, enterprises, IpAddress, Integer32, Bits, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, ModuleIdentity, mib_2, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "snmpModules", "Counter64", "enterprises", "IpAddress", "Integer32", "Bits", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "ModuleIdentity", "mib-2", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorOui=vendorOui, jumblan1=jumblan1, lanportTable=lanportTable, fcsErrorTransmitted=fcsErrorTransmitted, groupEntry=groupEntry, deviceinfo=deviceinfo, qosEntry=qosEntry, internetPort=internetPort, staticIpHostName=staticIpHostName, lanportpause=lanportpause, vlanid=vlanid, vendorName=vendorName, portStatEntry=portStatEntry, port1=port1, statisticTable=statisticTable, primaryDns=primaryDns, qmode=qmode, staticIpGateway=staticIpGateway, multicastsReceived=multicastsReceived, portPower=portPower, jumblan2=jumblan2, qosIndex=qosIndex, serialnum=serialnum, broadcastsReceived=broadcastsReceived, port2=port2, portTable=portTable, broadcastsTransmitted=broadcastsTransmitted, portmode=portmode, pauseReceived=pauseReceived, ddminfo=ddminfo, catvEnable=catvEnable, jumblan4=jumblan4, vendorRev=vendorRev, qmapping=qmapping, tftpSevIp=tftpSevIp, groupid=groupid, tftp=tftp, hostname=hostname, lanportIndex=lanportIndex, reboot=reboot, staticIpSecondaryDns=staticIpSecondaryDns, jumblan3=jumblan3, lanportspeed=lanportspeed, txPower=txPower, vlangroupTable=vlangroupTable, wanType=wanType, catv=catv, staticIpAddr=staticIpAddr, lan4=lan4, voltage=voltage, pauseTransmitted=pauseTransmitted, jumb=jumb, vlan=vlan, staticDns=staticDns, unicastsReceived=unicastsReceived, wan=wan, dscpEnable=dscpEnable, portEntry=portEntry, xg6846=xg6846, qos=qos, staticIpSubMask=staticIpSubMask, staticIpPrimaryDns=staticIpPrimaryDns, portStatistic=portStatistic, port4=port4, statIndex=statIndex, modeEntry=modeEntry, fcsErrorReceived=fcsErrorReceived, groupIndex=groupIndex, secondaryDns=secondaryDns, speed=speed, staticIpDomainName=staticIpDomainName, bias=bias, vendorPn=vendorPn, fileType=fileType, rxPower=rxPower, portName=portName, portIndex=portIndex, fileName=fileName, operStatus=operStatus, port3=port3, adminStatus=adminStatus, lanportName=lanportName, lan2=lan2, qosTable=qosTable, jumbwan=jumbwan, domainame=domainame, action=action, multicastsTransmitted=multicastsTransmitted, lan1=lan1, lan3=lan3, temperature=temperature, priority=priority, unicastsTransmitted=unicastsTransmitted, rebootEnable=rebootEnable)
