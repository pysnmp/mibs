...
# Produced by pysmi-1.1.8 at Thu Jan  5 09:59:36 2023
...
Unsigned32, TimeTicks, IpAddress, Integer32, ObjectIdentity, Counter64, snmpModules, ModuleIdentity, Bits, enterprises, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, iso, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "TimeTicks", "IpAddress", "Integer32", "ObjectIdentity", "Counter64", "snmpModules", "ModuleIdentity", "Bits", "enterprises", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "iso", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpHostName=staticIpHostName, portName=portName, portPower=portPower, staticDns=staticDns, dscpEnable=dscpEnable, unicastsTransmitted=unicastsTransmitted, voltage=voltage, port1=port1, statisticTable=statisticTable, port2=port2, speed=speed, portEntry=portEntry, port3=port3, operStatus=operStatus, vlanid=vlanid, xg6846=xg6846, fileName=fileName, groupEntry=groupEntry, portStatEntry=portStatEntry, hostname=hostname, qosIndex=qosIndex, catvEnable=catvEnable, lanportTable=lanportTable, vlan=vlan, jumblan1=jumblan1, broadcastsTransmitted=broadcastsTransmitted, unicastsReceived=unicastsReceived, temperature=temperature, wanType=wanType, statIndex=statIndex, groupIndex=groupIndex, qos=qos, lan3=lan3, qosEntry=qosEntry, vendorRev=vendorRev, staticIpGateway=staticIpGateway, lan2=lan2, staticIpSecondaryDns=staticIpSecondaryDns, txPower=txPower, multicastsReceived=multicastsReceived, jumblan2=jumblan2, staticIpDomainName=staticIpDomainName, lan1=lan1, jumblan3=jumblan3, lanportIndex=lanportIndex, portTable=portTable, fcsErrorReceived=fcsErrorReceived, vlangroupTable=vlangroupTable, wan=wan, catv=catv, ddminfo=ddminfo, adminStatus=adminStatus, port4=port4, qmapping=qmapping, pauseReceived=pauseReceived, portIndex=portIndex, reboot=reboot, qmode=qmode, staticIpSubMask=staticIpSubMask, priority=priority, staticIpPrimaryDns=staticIpPrimaryDns, secondaryDns=secondaryDns, groupid=groupid, fcsErrorTransmitted=fcsErrorTransmitted, jumblan4=jumblan4, action=action, modeEntry=modeEntry, lanportpause=lanportpause, portmode=portmode, rxPower=rxPower, serialnum=serialnum, pauseTransmitted=pauseTransmitted, vendorName=vendorName, multicastsTransmitted=multicastsTransmitted, deviceinfo=deviceinfo, lanportName=lanportName, qosTable=qosTable, vendorPn=vendorPn, staticIpAddr=staticIpAddr, rebootEnable=rebootEnable, portStatistic=portStatistic, tftpSevIp=tftpSevIp, jumbwan=jumbwan, jumb=jumb, domainame=domainame, tftp=tftp, fileType=fileType, bias=bias, lanportspeed=lanportspeed, lan4=lan4, internetPort=internetPort, broadcastsReceived=broadcastsReceived, vendorOui=vendorOui, primaryDns=primaryDns)
