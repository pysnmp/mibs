...
Gauge32, MibIdentifier, Bits, iso, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ObjectIdentity, ModuleIdentity, mib_2, NotificationType, snmpModules, Integer32, Counter32, IpAddress, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "Bits", "iso", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ObjectIdentity", "ModuleIdentity", "mib-2", "NotificationType", "snmpModules", "Integer32", "Counter32", "IpAddress", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", adminStatus=adminStatus, lan4=lan4, portTable=portTable, qosTable=qosTable, serialnum=serialnum, jumblan4=jumblan4, vlangroupTable=vlangroupTable, jumblan3=jumblan3, portPower=portPower, lan1=lan1, tftp=tftp, reboot=reboot, vendorName=vendorName, temperature=temperature, vlanid=vlanid, unicastsTransmitted=unicastsTransmitted, bias=bias, portEntry=portEntry, port2=port2, lan3=lan3, portName=portName, vlan=vlan, groupEntry=groupEntry, voltage=voltage, unicastsReceived=unicastsReceived, qmapping=qmapping, qosEntry=qosEntry, staticIpDomainName=staticIpDomainName, lanportpause=lanportpause, internetPort=internetPort, jumbwan=jumbwan, qosIndex=qosIndex, qmode=qmode, vendorRev=vendorRev, multicastsReceived=multicastsReceived, multicastsTransmitted=multicastsTransmitted, hostname=hostname, fileType=fileType, lanportIndex=lanportIndex, catv=catv, groupIndex=groupIndex, fcsErrorTransmitted=fcsErrorTransmitted, dscpEnable=dscpEnable, priority=priority, groupid=groupid, staticIpSecondaryDns=staticIpSecondaryDns, port4=port4, catvEnable=catvEnable, wanType=wanType, fileName=fileName, primaryDns=primaryDns, staticIpAddr=staticIpAddr, pauseReceived=pauseReceived, portIndex=portIndex, port3=port3, jumblan2=jumblan2, staticIpPrimaryDns=staticIpPrimaryDns, lanportTable=lanportTable, portStatistic=portStatistic, tftpSevIp=tftpSevIp, pauseTransmitted=pauseTransmitted, fcsErrorReceived=fcsErrorReceived, secondaryDns=secondaryDns, wan=wan, vendorPn=vendorPn, jumb=jumb, port1=port1, txPower=txPower, domainame=domainame, jumblan1=jumblan1, staticDns=staticDns, deviceinfo=deviceinfo, rxPower=rxPower, action=action, xg6846=xg6846, staticIpSubMask=staticIpSubMask, portmode=portmode, ddminfo=ddminfo, broadcastsReceived=broadcastsReceived, portStatEntry=portStatEntry, statisticTable=statisticTable, staticIpHostName=staticIpHostName, modeEntry=modeEntry, broadcastsTransmitted=broadcastsTransmitted, speed=speed, rebootEnable=rebootEnable, qos=qos, staticIpGateway=staticIpGateway, lanportName=lanportName, statIndex=statIndex, vendorOui=vendorOui, operStatus=operStatus, lanportspeed=lanportspeed, lan2=lan2)
