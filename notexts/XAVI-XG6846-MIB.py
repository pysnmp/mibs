...
# Produced by pysmi-1.1.8 at Fri Jul  8 09:22:53 2022
...
iso, TimeTicks, Bits, Counter64, mib_2, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, Unsigned32, snmpModules, enterprises, MibIdentifier, IpAddress, ModuleIdentity, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "Bits", "Counter64", "mib-2", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "Unsigned32", "snmpModules", "enterprises", "MibIdentifier", "IpAddress", "ModuleIdentity", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportName=lanportName, speed=speed, groupIndex=groupIndex, fcsErrorReceived=fcsErrorReceived, serialnum=serialnum, rebootEnable=rebootEnable, broadcastsTransmitted=broadcastsTransmitted, lanportspeed=lanportspeed, broadcastsReceived=broadcastsReceived, qmapping=qmapping, temperature=temperature, qosEntry=qosEntry, reboot=reboot, wan=wan, operStatus=operStatus, deviceinfo=deviceinfo, groupEntry=groupEntry, catv=catv, port2=port2, domainame=domainame, xg6846=xg6846, staticIpAddr=staticIpAddr, fcsErrorTransmitted=fcsErrorTransmitted, jumblan1=jumblan1, hostname=hostname, vlangroupTable=vlangroupTable, lanportTable=lanportTable, groupid=groupid, vlan=vlan, unicastsTransmitted=unicastsTransmitted, vendorRev=vendorRev, jumbwan=jumbwan, priority=priority, jumblan2=jumblan2, qosTable=qosTable, lanportIndex=lanportIndex, staticIpGateway=staticIpGateway, jumblan3=jumblan3, tftpSevIp=tftpSevIp, staticIpHostName=staticIpHostName, tftp=tftp, vendorPn=vendorPn, qmode=qmode, qosIndex=qosIndex, lan3=lan3, fileName=fileName, vendorOui=vendorOui, dscpEnable=dscpEnable, staticIpSubMask=staticIpSubMask, vlanid=vlanid, action=action, qos=qos, primaryDns=primaryDns, portStatistic=portStatistic, portName=portName, port3=port3, rxPower=rxPower, txPower=txPower, pauseReceived=pauseReceived, multicastsTransmitted=multicastsTransmitted, fileType=fileType, multicastsReceived=multicastsReceived, unicastsReceived=unicastsReceived, portPower=portPower, portIndex=portIndex, statIndex=statIndex, staticIpDomainName=staticIpDomainName, lanportpause=lanportpause, ddminfo=ddminfo, wanType=wanType, staticIpSecondaryDns=staticIpSecondaryDns, staticIpPrimaryDns=staticIpPrimaryDns, vendorName=vendorName, pauseTransmitted=pauseTransmitted, portmode=portmode, lan2=lan2, port1=port1, lan1=lan1, port4=port4, catvEnable=catvEnable, modeEntry=modeEntry, adminStatus=adminStatus, jumb=jumb, portStatEntry=portStatEntry, bias=bias, staticDns=staticDns, portTable=portTable, voltage=voltage, internetPort=internetPort, lan4=lan4, statisticTable=statisticTable, jumblan4=jumblan4, secondaryDns=secondaryDns, portEntry=portEntry)
