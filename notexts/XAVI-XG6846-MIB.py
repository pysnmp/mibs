...
# Produced by pysmi-1.1.12 at Tue May 28 13:38:32 2024
...
Counter64, iso, Unsigned32, snmpModules, ObjectIdentity, Bits, IpAddress, ModuleIdentity, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, enterprises, mib_2, TimeTicks, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "Unsigned32", "snmpModules", "ObjectIdentity", "Bits", "IpAddress", "ModuleIdentity", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "enterprises", "mib-2", "TimeTicks", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qmapping=qmapping, deviceinfo=deviceinfo, fileName=fileName, serialnum=serialnum, staticDns=staticDns, lan4=lan4, catvEnable=catvEnable, jumblan4=jumblan4, reboot=reboot, portmode=portmode, multicastsReceived=multicastsReceived, dscpEnable=dscpEnable, jumblan3=jumblan3, voltage=voltage, groupEntry=groupEntry, xg6846=xg6846, ddminfo=ddminfo, lanportpause=lanportpause, portTable=portTable, jumblan2=jumblan2, domainame=domainame, groupIndex=groupIndex, unicastsReceived=unicastsReceived, vendorPn=vendorPn, staticIpSubMask=staticIpSubMask, rebootEnable=rebootEnable, portStatEntry=portStatEntry, staticIpDomainName=staticIpDomainName, staticIpAddr=staticIpAddr, jumblan1=jumblan1, hostname=hostname, port1=port1, pauseReceived=pauseReceived, tftp=tftp, portStatistic=portStatistic, jumb=jumb, catv=catv, groupid=groupid, portName=portName, modeEntry=modeEntry, staticIpGateway=staticIpGateway, vlanid=vlanid, speed=speed, vendorName=vendorName, fileType=fileType, temperature=temperature, fcsErrorReceived=fcsErrorReceived, action=action, staticIpHostName=staticIpHostName, qosEntry=qosEntry, qos=qos, lan3=lan3, qosTable=qosTable, lan2=lan2, portPower=portPower, lan1=lan1, vlangroupTable=vlangroupTable, statIndex=statIndex, primaryDns=primaryDns, broadcastsTransmitted=broadcastsTransmitted, portIndex=portIndex, staticIpSecondaryDns=staticIpSecondaryDns, txPower=txPower, lanportspeed=lanportspeed, portEntry=portEntry, rxPower=rxPower, multicastsTransmitted=multicastsTransmitted, vendorRev=vendorRev, broadcastsReceived=broadcastsReceived, operStatus=operStatus, port4=port4, secondaryDns=secondaryDns, port2=port2, fcsErrorTransmitted=fcsErrorTransmitted, vlan=vlan, wan=wan, lanportIndex=lanportIndex, adminStatus=adminStatus, unicastsTransmitted=unicastsTransmitted, pauseTransmitted=pauseTransmitted, jumbwan=jumbwan, statisticTable=statisticTable, lanportTable=lanportTable, port3=port3, vendorOui=vendorOui, wanType=wanType, internetPort=internetPort, staticIpPrimaryDns=staticIpPrimaryDns, priority=priority, bias=bias, qmode=qmode, tftpSevIp=tftpSevIp, lanportName=lanportName, qosIndex=qosIndex)
