...
# Produced by pysmi-1.1.8 at Fri Jan  7 16:10:04 2022
...
snmpModules, ModuleIdentity, Bits, mib_2, Counter32, IpAddress, NotificationType, Unsigned32, iso, MibIdentifier, Counter64, ObjectIdentity, TimeTicks, Gauge32, enterprises, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "ModuleIdentity", "Bits", "mib-2", "Counter32", "IpAddress", "NotificationType", "Unsigned32", "iso", "MibIdentifier", "Counter64", "ObjectIdentity", "TimeTicks", "Gauge32", "enterprises", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portPower=portPower, catv=catv, staticIpSubMask=staticIpSubMask, txPower=txPower, vlan=vlan, multicastsTransmitted=multicastsTransmitted, tftpSevIp=tftpSevIp, domainame=domainame, staticIpSecondaryDns=staticIpSecondaryDns, action=action, priority=priority, staticIpPrimaryDns=staticIpPrimaryDns, portTable=portTable, unicastsReceived=unicastsReceived, adminStatus=adminStatus, fileName=fileName, wanType=wanType, rebootEnable=rebootEnable, multicastsReceived=multicastsReceived, dscpEnable=dscpEnable, qos=qos, staticIpDomainName=staticIpDomainName, staticIpAddr=staticIpAddr, jumblan4=jumblan4, port3=port3, statisticTable=statisticTable, rxPower=rxPower, portmode=portmode, groupIndex=groupIndex, bias=bias, broadcastsTransmitted=broadcastsTransmitted, qosIndex=qosIndex, lanportpause=lanportpause, pauseTransmitted=pauseTransmitted, staticIpGateway=staticIpGateway, primaryDns=primaryDns, serialnum=serialnum, lanportTable=lanportTable, fileType=fileType, jumbwan=jumbwan, ddminfo=ddminfo, unicastsTransmitted=unicastsTransmitted, modeEntry=modeEntry, staticDns=staticDns, jumblan3=jumblan3, port1=port1, operStatus=operStatus, lan4=lan4, portIndex=portIndex, secondaryDns=secondaryDns, broadcastsReceived=broadcastsReceived, temperature=temperature, jumb=jumb, catvEnable=catvEnable, portStatEntry=portStatEntry, groupEntry=groupEntry, vendorOui=vendorOui, qosEntry=qosEntry, qmapping=qmapping, qosTable=qosTable, voltage=voltage, vendorName=vendorName, jumblan1=jumblan1, lan1=lan1, tftp=tftp, vlanid=vlanid, vendorRev=vendorRev, statIndex=statIndex, hostname=hostname, port4=port4, vlangroupTable=vlangroupTable, jumblan2=jumblan2, staticIpHostName=staticIpHostName, wan=wan, lan2=lan2, fcsErrorReceived=fcsErrorReceived, xg6846=xg6846, groupid=groupid, internetPort=internetPort, speed=speed, lanportspeed=lanportspeed, reboot=reboot, lan3=lan3, deviceinfo=deviceinfo, lanportName=lanportName, portEntry=portEntry, pauseReceived=pauseReceived, fcsErrorTransmitted=fcsErrorTransmitted, port2=port2, portStatistic=portStatistic, lanportIndex=lanportIndex, portName=portName, qmode=qmode, vendorPn=vendorPn)
