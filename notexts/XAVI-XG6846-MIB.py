...
Gauge32, Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, ModuleIdentity, ObjectIdentity, Unsigned32, TimeTicks, iso, mib_2, Counter32, MibIdentifier, IpAddress, snmpModules, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "TimeTicks", "iso", "mib-2", "Counter32", "MibIdentifier", "IpAddress", "snmpModules", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorName=vendorName, fileName=fileName, groupIndex=groupIndex, qos=qos, port1=port1, hostname=hostname, speed=speed, port3=port3, jumblan2=jumblan2, broadcastsReceived=broadcastsReceived, portName=portName, catvEnable=catvEnable, port4=port4, portmode=portmode, qmapping=qmapping, portStatEntry=portStatEntry, statisticTable=statisticTable, vlan=vlan, operStatus=operStatus, vendorOui=vendorOui, staticIpPrimaryDns=staticIpPrimaryDns, portIndex=portIndex, reboot=reboot, staticDns=staticDns, staticIpGateway=staticIpGateway, bias=bias, groupEntry=groupEntry, qosEntry=qosEntry, groupid=groupid, portPower=portPower, internetPort=internetPort, jumbwan=jumbwan, jumblan4=jumblan4, unicastsTransmitted=unicastsTransmitted, multicastsReceived=multicastsReceived, modeEntry=modeEntry, tftp=tftp, port2=port2, pauseReceived=pauseReceived, dscpEnable=dscpEnable, tftpSevIp=tftpSevIp, jumblan1=jumblan1, portEntry=portEntry, jumb=jumb, action=action, vendorPn=vendorPn, secondaryDns=secondaryDns, lanportName=lanportName, lan3=lan3, serialnum=serialnum, wanType=wanType, staticIpSubMask=staticIpSubMask, staticIpSecondaryDns=staticIpSecondaryDns, fileType=fileType, lanportIndex=lanportIndex, qosTable=qosTable, ddminfo=ddminfo, unicastsReceived=unicastsReceived, multicastsTransmitted=multicastsTransmitted, deviceinfo=deviceinfo, lanportTable=lanportTable, lanportspeed=lanportspeed, vlanid=vlanid, fcsErrorTransmitted=fcsErrorTransmitted, jumblan3=jumblan3, adminStatus=adminStatus, vendorRev=vendorRev, lan1=lan1, catv=catv, txPower=txPower, lan4=lan4, rebootEnable=rebootEnable, domainame=domainame, vlangroupTable=vlangroupTable, portTable=portTable, staticIpAddr=staticIpAddr, lanportpause=lanportpause, fcsErrorReceived=fcsErrorReceived, primaryDns=primaryDns, temperature=temperature, wan=wan, lan2=lan2, xg6846=xg6846, broadcastsTransmitted=broadcastsTransmitted, voltage=voltage, pauseTransmitted=pauseTransmitted, priority=priority, qosIndex=qosIndex, qmode=qmode, staticIpDomainName=staticIpDomainName, statIndex=statIndex, rxPower=rxPower, staticIpHostName=staticIpHostName, portStatistic=portStatistic)
