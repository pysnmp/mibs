...
# Produced by pysmi-1.1.8 at Fri Oct 13 14:07:28 2023
...
Counter64, ModuleIdentity, Counter32, TimeTicks, NotificationType, snmpModules, mib_2, Bits, IpAddress, ObjectIdentity, Gauge32, enterprises, iso, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "Counter32", "TimeTicks", "NotificationType", "snmpModules", "mib-2", "Bits", "IpAddress", "ObjectIdentity", "Gauge32", "enterprises", "iso", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpDomainName=staticIpDomainName, qosIndex=qosIndex, catv=catv, internetPort=internetPort, qmapping=qmapping, speed=speed, multicastsTransmitted=multicastsTransmitted, portStatEntry=portStatEntry, jumb=jumb, rebootEnable=rebootEnable, vendorName=vendorName, serialnum=serialnum, tftp=tftp, primaryDns=primaryDns, unicastsReceived=unicastsReceived, catvEnable=catvEnable, lan2=lan2, lanportpause=lanportpause, hostname=hostname, portStatistic=portStatistic, vendorRev=vendorRev, staticIpHostName=staticIpHostName, lanportTable=lanportTable, reboot=reboot, port3=port3, pauseTransmitted=pauseTransmitted, port1=port1, lanportspeed=lanportspeed, broadcastsTransmitted=broadcastsTransmitted, lan3=lan3, staticIpPrimaryDns=staticIpPrimaryDns, vlangroupTable=vlangroupTable, dscpEnable=dscpEnable, groupEntry=groupEntry, adminStatus=adminStatus, groupIndex=groupIndex, secondaryDns=secondaryDns, vendorOui=vendorOui, staticIpAddr=staticIpAddr, bias=bias, statIndex=statIndex, portName=portName, qmode=qmode, qos=qos, broadcastsReceived=broadcastsReceived, domainame=domainame, operStatus=operStatus, groupid=groupid, port2=port2, lan4=lan4, portIndex=portIndex, pauseReceived=pauseReceived, fileType=fileType, multicastsReceived=multicastsReceived, lanportName=lanportName, lanportIndex=lanportIndex, wanType=wanType, jumbwan=jumbwan, qosTable=qosTable, fileName=fileName, deviceinfo=deviceinfo, jumblan1=jumblan1, jumblan3=jumblan3, jumblan2=jumblan2, unicastsTransmitted=unicastsTransmitted, staticIpGateway=staticIpGateway, portPower=portPower, wan=wan, port4=port4, portEntry=portEntry, temperature=temperature, vlan=vlan, statisticTable=statisticTable, xg6846=xg6846, staticDns=staticDns, txPower=txPower, lan1=lan1, staticIpSubMask=staticIpSubMask, vendorPn=vendorPn, staticIpSecondaryDns=staticIpSecondaryDns, fcsErrorTransmitted=fcsErrorTransmitted, tftpSevIp=tftpSevIp, qosEntry=qosEntry, portmode=portmode, fcsErrorReceived=fcsErrorReceived, rxPower=rxPower, action=action, voltage=voltage, ddminfo=ddminfo, portTable=portTable, modeEntry=modeEntry, vlanid=vlanid, priority=priority, jumblan4=jumblan4)
