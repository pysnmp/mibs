...
snmpModules, mib_2, Counter64, Bits, Gauge32, ModuleIdentity, NotificationType, TimeTicks, IpAddress, ObjectIdentity, Integer32, enterprises, MibIdentifier, iso, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "mib-2", "Counter64", "Bits", "Gauge32", "ModuleIdentity", "NotificationType", "TimeTicks", "IpAddress", "ObjectIdentity", "Integer32", "enterprises", "MibIdentifier", "iso", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qosTable=qosTable, multicastsTransmitted=multicastsTransmitted, wan=wan, port2=port2, pauseTransmitted=pauseTransmitted, portTable=portTable, broadcastsTransmitted=broadcastsTransmitted, statisticTable=statisticTable, qosEntry=qosEntry, fileType=fileType, secondaryDns=secondaryDns, statIndex=statIndex, tftpSevIp=tftpSevIp, operStatus=operStatus, tftp=tftp, staticIpSubMask=staticIpSubMask, qmapping=qmapping, qmode=qmode, groupIndex=groupIndex, jumb=jumb, vlanid=vlanid, portStatEntry=portStatEntry, qos=qos, lanportName=lanportName, portStatistic=portStatistic, action=action, lan4=lan4, reboot=reboot, vlan=vlan, fcsErrorReceived=fcsErrorReceived, serialnum=serialnum, wanType=wanType, jumblan2=jumblan2, voltage=voltage, lan2=lan2, staticIpDomainName=staticIpDomainName, bias=bias, deviceinfo=deviceinfo, lan1=lan1, lanportTable=lanportTable, primaryDns=primaryDns, speed=speed, priority=priority, dscpEnable=dscpEnable, lanportIndex=lanportIndex, txPower=txPower, vendorName=vendorName, staticIpHostName=staticIpHostName, qosIndex=qosIndex, vendorOui=vendorOui, groupid=groupid, lan3=lan3, jumblan1=jumblan1, modeEntry=modeEntry, hostname=hostname, adminStatus=adminStatus, vendorRev=vendorRev, multicastsReceived=multicastsReceived, port3=port3, vendorPn=vendorPn, fileName=fileName, temperature=temperature, rebootEnable=rebootEnable, jumbwan=jumbwan, lanportpause=lanportpause, ddminfo=ddminfo, staticIpAddr=staticIpAddr, fcsErrorTransmitted=fcsErrorTransmitted, portmode=portmode, vlangroupTable=vlangroupTable, staticDns=staticDns, catv=catv, xg6846=xg6846, lanportspeed=lanportspeed, pauseReceived=pauseReceived, portPower=portPower, staticIpGateway=staticIpGateway, staticIpSecondaryDns=staticIpSecondaryDns, internetPort=internetPort, staticIpPrimaryDns=staticIpPrimaryDns, unicastsReceived=unicastsReceived, port1=port1, groupEntry=groupEntry, jumblan4=jumblan4, broadcastsReceived=broadcastsReceived, portEntry=portEntry, portIndex=portIndex, jumblan3=jumblan3, portName=portName, unicastsTransmitted=unicastsTransmitted, domainame=domainame, catvEnable=catvEnable, rxPower=rxPower, port4=port4)
