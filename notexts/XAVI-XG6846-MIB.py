...
# Produced by pysmi-1.1.8 at Thu Sep  7 11:45:47 2023
...
TimeTicks, IpAddress, Counter32, Bits, enterprises, snmpModules, mib_2, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32, ObjectIdentity, NotificationType, ModuleIdentity, Unsigned32, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "Counter32", "Bits", "enterprises", "snmpModules", "mib-2", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Unsigned32", "Integer32", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", action=action, portmode=portmode, fcsErrorTransmitted=fcsErrorTransmitted, port4=port4, internetPort=internetPort, unicastsTransmitted=unicastsTransmitted, staticIpGateway=staticIpGateway, qosEntry=qosEntry, secondaryDns=secondaryDns, lan4=lan4, dscpEnable=dscpEnable, jumblan2=jumblan2, jumblan3=jumblan3, pauseReceived=pauseReceived, vlan=vlan, lanportIndex=lanportIndex, lan2=lan2, wan=wan, groupIndex=groupIndex, lan1=lan1, fileType=fileType, broadcastsReceived=broadcastsReceived, speed=speed, staticIpAddr=staticIpAddr, vendorRev=vendorRev, staticIpSecondaryDns=staticIpSecondaryDns, statIndex=statIndex, jumb=jumb, vlangroupTable=vlangroupTable, priority=priority, lanportpause=lanportpause, portStatEntry=portStatEntry, tftp=tftp, qos=qos, groupEntry=groupEntry, jumblan4=jumblan4, qosIndex=qosIndex, qmapping=qmapping, portEntry=portEntry, staticIpPrimaryDns=staticIpPrimaryDns, catvEnable=catvEnable, fcsErrorReceived=fcsErrorReceived, reboot=reboot, domainame=domainame, tftpSevIp=tftpSevIp, lanportTable=lanportTable, catv=catv, deviceinfo=deviceinfo, groupid=groupid, fileName=fileName, staticIpSubMask=staticIpSubMask, unicastsReceived=unicastsReceived, statisticTable=statisticTable, port1=port1, xg6846=xg6846, pauseTransmitted=pauseTransmitted, staticIpDomainName=staticIpDomainName, portPower=portPower, vendorOui=vendorOui, vlanid=vlanid, operStatus=operStatus, ddminfo=ddminfo, hostname=hostname, primaryDns=primaryDns, rebootEnable=rebootEnable, wanType=wanType, port2=port2, portName=portName, lanportspeed=lanportspeed, staticIpHostName=staticIpHostName, lanportName=lanportName, portStatistic=portStatistic, multicastsReceived=multicastsReceived, portIndex=portIndex, serialnum=serialnum, port3=port3, jumbwan=jumbwan, jumblan1=jumblan1, vendorPn=vendorPn, voltage=voltage, txPower=txPower, lan3=lan3, rxPower=rxPower, multicastsTransmitted=multicastsTransmitted, temperature=temperature, vendorName=vendorName, portTable=portTable, qosTable=qosTable, staticDns=staticDns, bias=bias, modeEntry=modeEntry, qmode=qmode, broadcastsTransmitted=broadcastsTransmitted, adminStatus=adminStatus)
