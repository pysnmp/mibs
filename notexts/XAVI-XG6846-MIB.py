...
# Produced by pysmi-1.1.8 at Sat Jan 15 05:33:07 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, ModuleIdentity, IpAddress, snmpModules, Counter32, ObjectIdentity, MibIdentifier, NotificationType, Integer32, Bits, TimeTicks, mib_2, iso, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "ModuleIdentity", "IpAddress", "snmpModules", "Counter32", "ObjectIdentity", "MibIdentifier", "NotificationType", "Integer32", "Bits", "TimeTicks", "mib-2", "iso", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portPower=portPower, dscpEnable=dscpEnable, lanportName=lanportName, vlanid=vlanid, temperature=temperature, staticDns=staticDns, vendorOui=vendorOui, port2=port2, xg6846=xg6846, primaryDns=primaryDns, qmapping=qmapping, lanportspeed=lanportspeed, portmode=portmode, statisticTable=statisticTable, speed=speed, broadcastsTransmitted=broadcastsTransmitted, pauseReceived=pauseReceived, txPower=txPower, wan=wan, port1=port1, qos=qos, ddminfo=ddminfo, lanportpause=lanportpause, rxPower=rxPower, fileName=fileName, vendorName=vendorName, groupIndex=groupIndex, unicastsTransmitted=unicastsTransmitted, fcsErrorTransmitted=fcsErrorTransmitted, catv=catv, action=action, multicastsTransmitted=multicastsTransmitted, jumb=jumb, lan2=lan2, modeEntry=modeEntry, lan3=lan3, jumblan3=jumblan3, jumblan2=jumblan2, qmode=qmode, lanportTable=lanportTable, rebootEnable=rebootEnable, domainame=domainame, staticIpAddr=staticIpAddr, portEntry=portEntry, bias=bias, staticIpDomainName=staticIpDomainName, lan1=lan1, jumbwan=jumbwan, vlangroupTable=vlangroupTable, qosTable=qosTable, wanType=wanType, secondaryDns=secondaryDns, groupEntry=groupEntry, priority=priority, staticIpHostName=staticIpHostName, pauseTransmitted=pauseTransmitted, fileType=fileType, port3=port3, internetPort=internetPort, adminStatus=adminStatus, qosEntry=qosEntry, portTable=portTable, tftpSevIp=tftpSevIp, operStatus=operStatus, vendorRev=vendorRev, catvEnable=catvEnable, jumblan1=jumblan1, groupid=groupid, portStatEntry=portStatEntry, vendorPn=vendorPn, portName=portName, hostname=hostname, tftp=tftp, jumblan4=jumblan4, lan4=lan4, vlan=vlan, staticIpSecondaryDns=staticIpSecondaryDns, portStatistic=portStatistic, staticIpGateway=staticIpGateway, qosIndex=qosIndex, statIndex=statIndex, staticIpSubMask=staticIpSubMask, serialnum=serialnum, broadcastsReceived=broadcastsReceived, staticIpPrimaryDns=staticIpPrimaryDns, unicastsReceived=unicastsReceived, deviceinfo=deviceinfo, reboot=reboot, lanportIndex=lanportIndex, voltage=voltage, portIndex=portIndex, port4=port4, fcsErrorReceived=fcsErrorReceived, multicastsReceived=multicastsReceived)
