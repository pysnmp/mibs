...
TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, Counter32, MibIdentifier, Bits, mib_2, IpAddress, NotificationType, Gauge32, Integer32, snmpModules, Counter64, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "Counter32", "MibIdentifier", "Bits", "mib-2", "IpAddress", "NotificationType", "Gauge32", "Integer32", "snmpModules", "Counter64", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qosTable=qosTable, action=action, rebootEnable=rebootEnable, groupIndex=groupIndex, wan=wan, staticIpPrimaryDns=staticIpPrimaryDns, speed=speed, lanportIndex=lanportIndex, pauseReceived=pauseReceived, portmode=portmode, deviceinfo=deviceinfo, lanportpause=lanportpause, staticIpHostName=staticIpHostName, bias=bias, lanportName=lanportName, lan1=lan1, vlangroupTable=vlangroupTable, modeEntry=modeEntry, staticIpSecondaryDns=staticIpSecondaryDns, portStatEntry=portStatEntry, multicastsTransmitted=multicastsTransmitted, broadcastsReceived=broadcastsReceived, vlanid=vlanid, unicastsTransmitted=unicastsTransmitted, vendorRev=vendorRev, portTable=portTable, jumb=jumb, port4=port4, staticIpSubMask=staticIpSubMask, statisticTable=statisticTable, staticDns=staticDns, jumbwan=jumbwan, jumblan1=jumblan1, tftpSevIp=tftpSevIp, voltage=voltage, portStatistic=portStatistic, lanportTable=lanportTable, portEntry=portEntry, lan4=lan4, txPower=txPower, jumblan4=jumblan4, portName=portName, reboot=reboot, groupEntry=groupEntry, fcsErrorTransmitted=fcsErrorTransmitted, secondaryDns=secondaryDns, portPower=portPower, broadcastsTransmitted=broadcastsTransmitted, fileType=fileType, serialnum=serialnum, staticIpDomainName=staticIpDomainName, lan2=lan2, operStatus=operStatus, adminStatus=adminStatus, port3=port3, pauseTransmitted=pauseTransmitted, hostname=hostname, lan3=lan3, fcsErrorReceived=fcsErrorReceived, qosIndex=qosIndex, fileName=fileName, vendorPn=vendorPn, catv=catv, internetPort=internetPort, groupid=groupid, statIndex=statIndex, lanportspeed=lanportspeed, vendorName=vendorName, staticIpAddr=staticIpAddr, wanType=wanType, primaryDns=primaryDns, qosEntry=qosEntry, domainame=domainame, staticIpGateway=staticIpGateway, port2=port2, vendorOui=vendorOui, vlan=vlan, priority=priority, unicastsReceived=unicastsReceived, portIndex=portIndex, qmapping=qmapping, catvEnable=catvEnable, rxPower=rxPower, ddminfo=ddminfo, qmode=qmode, port1=port1, jumblan3=jumblan3, qos=qos, dscpEnable=dscpEnable, jumblan2=jumblan2, tftp=tftp, multicastsReceived=multicastsReceived, temperature=temperature, xg6846=xg6846)
