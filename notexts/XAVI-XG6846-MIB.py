...
# Produced by pysmi-1.1.8 at Thu Sep 29 08:54:14 2022
...
mib_2, snmpModules, MibIdentifier, ObjectIdentity, Counter64, Bits, Counter32, ModuleIdentity, Unsigned32, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, NotificationType, enterprises, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "snmpModules", "MibIdentifier", "ObjectIdentity", "Counter64", "Bits", "Counter32", "ModuleIdentity", "Unsigned32", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "NotificationType", "enterprises", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", groupEntry=groupEntry, fcsErrorTransmitted=fcsErrorTransmitted, rxPower=rxPower, port1=port1, lan4=lan4, serialnum=serialnum, broadcastsTransmitted=broadcastsTransmitted, port2=port2, portPower=portPower, xg6846=xg6846, portEntry=portEntry, modeEntry=modeEntry, operStatus=operStatus, temperature=temperature, vendorRev=vendorRev, catv=catv, hostname=hostname, fcsErrorReceived=fcsErrorReceived, qosTable=qosTable, adminStatus=adminStatus, wan=wan, lanportTable=lanportTable, unicastsReceived=unicastsReceived, portIndex=portIndex, jumb=jumb, portTable=portTable, staticIpGateway=staticIpGateway, broadcastsReceived=broadcastsReceived, catvEnable=catvEnable, jumblan4=jumblan4, txPower=txPower, jumblan2=jumblan2, statisticTable=statisticTable, deviceinfo=deviceinfo, action=action, multicastsReceived=multicastsReceived, jumblan1=jumblan1, vlangroupTable=vlangroupTable, voltage=voltage, groupIndex=groupIndex, jumbwan=jumbwan, pauseTransmitted=pauseTransmitted, speed=speed, staticIpAddr=staticIpAddr, qmapping=qmapping, staticIpSubMask=staticIpSubMask, vendorName=vendorName, fileName=fileName, vendorOui=vendorOui, dscpEnable=dscpEnable, pauseReceived=pauseReceived, statIndex=statIndex, tftpSevIp=tftpSevIp, portName=portName, port4=port4, portmode=portmode, portStatEntry=portStatEntry, multicastsTransmitted=multicastsTransmitted, staticIpDomainName=staticIpDomainName, internetPort=internetPort, fileType=fileType, lan1=lan1, lanportIndex=lanportIndex, ddminfo=ddminfo, portStatistic=portStatistic, tftp=tftp, staticIpHostName=staticIpHostName, staticIpPrimaryDns=staticIpPrimaryDns, bias=bias, groupid=groupid, priority=priority, lanportpause=lanportpause, vlan=vlan, vlanid=vlanid, rebootEnable=rebootEnable, wanType=wanType, lan2=lan2, unicastsTransmitted=unicastsTransmitted, lanportspeed=lanportspeed, jumblan3=jumblan3, qosIndex=qosIndex, port3=port3, lan3=lan3, qos=qos, qosEntry=qosEntry, reboot=reboot, vendorPn=vendorPn, secondaryDns=secondaryDns, domainame=domainame, lanportName=lanportName, staticDns=staticDns, primaryDns=primaryDns, staticIpSecondaryDns=staticIpSecondaryDns, qmode=qmode)
