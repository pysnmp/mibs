...
# Produced by pysmi-1.1.8 at Wed Oct 11 09:30:07 2023
...
IpAddress, MibIdentifier, enterprises, Integer32, TimeTicks, ObjectIdentity, Unsigned32, Counter32, iso, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32, ModuleIdentity, Bits, NotificationType, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibIdentifier", "enterprises", "Integer32", "TimeTicks", "ObjectIdentity", "Unsigned32", "Counter32", "iso", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32", "ModuleIdentity", "Bits", "NotificationType", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vlangroupTable=vlangroupTable, hostname=hostname, port4=port4, port2=port2, portStatEntry=portStatEntry, broadcastsTransmitted=broadcastsTransmitted, statIndex=statIndex, fcsErrorReceived=fcsErrorReceived, unicastsTransmitted=unicastsTransmitted, staticDns=staticDns, groupEntry=groupEntry, tftp=tftp, fcsErrorTransmitted=fcsErrorTransmitted, jumblan3=jumblan3, lanportName=lanportName, staticIpSecondaryDns=staticIpSecondaryDns, xg6846=xg6846, vendorOui=vendorOui, vlanid=vlanid, serialnum=serialnum, portStatistic=portStatistic, fileType=fileType, wan=wan, rebootEnable=rebootEnable, qmode=qmode, bias=bias, portIndex=portIndex, ddminfo=ddminfo, fileName=fileName, portmode=portmode, pauseTransmitted=pauseTransmitted, txPower=txPower, lan3=lan3, jumbwan=jumbwan, primaryDns=primaryDns, jumb=jumb, lanportTable=lanportTable, multicastsReceived=multicastsReceived, qos=qos, staticIpAddr=staticIpAddr, secondaryDns=secondaryDns, temperature=temperature, catvEnable=catvEnable, multicastsTransmitted=multicastsTransmitted, catv=catv, deviceinfo=deviceinfo, vendorRev=vendorRev, qosTable=qosTable, portName=portName, wanType=wanType, staticIpSubMask=staticIpSubMask, lan4=lan4, reboot=reboot, speed=speed, qosIndex=qosIndex, adminStatus=adminStatus, staticIpHostName=staticIpHostName, portEntry=portEntry, lan1=lan1, operStatus=operStatus, pauseReceived=pauseReceived, jumblan4=jumblan4, broadcastsReceived=broadcastsReceived, internetPort=internetPort, vendorPn=vendorPn, priority=priority, lanportIndex=lanportIndex, rxPower=rxPower, port3=port3, groupid=groupid, staticIpPrimaryDns=staticIpPrimaryDns, staticIpGateway=staticIpGateway, groupIndex=groupIndex, staticIpDomainName=staticIpDomainName, lan2=lan2, vendorName=vendorName, port1=port1, unicastsReceived=unicastsReceived, jumblan1=jumblan1, jumblan2=jumblan2, voltage=voltage, portPower=portPower, statisticTable=statisticTable, qosEntry=qosEntry, modeEntry=modeEntry, lanportpause=lanportpause, vlan=vlan, qmapping=qmapping, action=action, dscpEnable=dscpEnable, domainame=domainame, lanportspeed=lanportspeed, portTable=portTable, tftpSevIp=tftpSevIp)
