...
# Produced by pysmi-1.1.8 at Wed Jun 29 15:11:07 2022
...
Unsigned32, mib_2, MibIdentifier, snmpModules, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, ModuleIdentity, TimeTicks, IpAddress, ObjectIdentity, Integer32, NotificationType, Bits, enterprises, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "mib-2", "MibIdentifier", "snmpModules", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "ModuleIdentity", "TimeTicks", "IpAddress", "ObjectIdentity", "Integer32", "NotificationType", "Bits", "enterprises", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", statisticTable=statisticTable, multicastsTransmitted=multicastsTransmitted, broadcastsReceived=broadcastsReceived, vendorPn=vendorPn, temperature=temperature, staticIpPrimaryDns=staticIpPrimaryDns, lanportspeed=lanportspeed, rebootEnable=rebootEnable, bias=bias, jumbwan=jumbwan, portStatistic=portStatistic, fcsErrorTransmitted=fcsErrorTransmitted, internetPort=internetPort, unicastsTransmitted=unicastsTransmitted, groupid=groupid, jumblan3=jumblan3, vendorName=vendorName, lan1=lan1, lan4=lan4, lan2=lan2, lanportTable=lanportTable, vlan=vlan, vendorRev=vendorRev, speed=speed, wanType=wanType, multicastsReceived=multicastsReceived, groupIndex=groupIndex, port2=port2, staticIpGateway=staticIpGateway, portTable=portTable, serialnum=serialnum, qosIndex=qosIndex, lanportIndex=lanportIndex, lanportName=lanportName, voltage=voltage, catvEnable=catvEnable, staticIpSubMask=staticIpSubMask, ddminfo=ddminfo, catv=catv, unicastsReceived=unicastsReceived, qmode=qmode, operStatus=operStatus, staticIpAddr=staticIpAddr, lanportpause=lanportpause, txPower=txPower, jumblan2=jumblan2, tftpSevIp=tftpSevIp, xg6846=xg6846, hostname=hostname, primaryDns=primaryDns, qos=qos, rxPower=rxPower, port1=port1, jumblan4=jumblan4, secondaryDns=secondaryDns, staticIpHostName=staticIpHostName, staticIpDomainName=staticIpDomainName, portIndex=portIndex, statIndex=statIndex, staticDns=staticDns, vendorOui=vendorOui, vlangroupTable=vlangroupTable, wan=wan, portPower=portPower, portmode=portmode, groupEntry=groupEntry, jumblan1=jumblan1, pauseReceived=pauseReceived, portEntry=portEntry, jumb=jumb, qmapping=qmapping, action=action, fcsErrorReceived=fcsErrorReceived, deviceinfo=deviceinfo, port3=port3, domainame=domainame, qosEntry=qosEntry, portStatEntry=portStatEntry, qosTable=qosTable, vlanid=vlanid, broadcastsTransmitted=broadcastsTransmitted, portName=portName, tftp=tftp, modeEntry=modeEntry, staticIpSecondaryDns=staticIpSecondaryDns, port4=port4, adminStatus=adminStatus, reboot=reboot, lan3=lan3, priority=priority, pauseTransmitted=pauseTransmitted, fileName=fileName, dscpEnable=dscpEnable, fileType=fileType)
