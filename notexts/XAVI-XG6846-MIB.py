...
# Produced by pysmi-1.1.8 at Thu Oct 26 09:06:05 2023
...
Bits, mib_2, ModuleIdentity, Counter64, Gauge32, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, snmpModules, enterprises, IpAddress, TimeTicks, MibIdentifier, Unsigned32, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "mib-2", "ModuleIdentity", "Counter64", "Gauge32", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "snmpModules", "enterprises", "IpAddress", "TimeTicks", "MibIdentifier", "Unsigned32", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpSecondaryDns=staticIpSecondaryDns, jumblan4=jumblan4, fileType=fileType, qmode=qmode, primaryDns=primaryDns, vendorOui=vendorOui, speed=speed, groupIndex=groupIndex, staticIpHostName=staticIpHostName, modeEntry=modeEntry, bias=bias, lanportIndex=lanportIndex, xg6846=xg6846, multicastsReceived=multicastsReceived, staticIpDomainName=staticIpDomainName, port3=port3, portStatistic=portStatistic, priority=priority, statIndex=statIndex, secondaryDns=secondaryDns, internetPort=internetPort, qosTable=qosTable, broadcastsReceived=broadcastsReceived, ddminfo=ddminfo, qosEntry=qosEntry, serialnum=serialnum, vendorName=vendorName, temperature=temperature, lanportpause=lanportpause, reboot=reboot, rxPower=rxPower, tftp=tftp, hostname=hostname, jumblan2=jumblan2, portPower=portPower, lanportName=lanportName, deviceinfo=deviceinfo, lanportTable=lanportTable, lanportspeed=lanportspeed, vlan=vlan, fcsErrorTransmitted=fcsErrorTransmitted, portName=portName, qos=qos, tftpSevIp=tftpSevIp, pauseReceived=pauseReceived, action=action, portEntry=portEntry, port1=port1, jumbwan=jumbwan, vendorRev=vendorRev, lan3=lan3, statisticTable=statisticTable, lan4=lan4, broadcastsTransmitted=broadcastsTransmitted, staticIpAddr=staticIpAddr, txPower=txPower, portTable=portTable, staticIpGateway=staticIpGateway, vendorPn=vendorPn, staticIpSubMask=staticIpSubMask, vlanid=vlanid, groupid=groupid, lan2=lan2, portmode=portmode, unicastsReceived=unicastsReceived, staticDns=staticDns, lan1=lan1, domainame=domainame, groupEntry=groupEntry, jumb=jumb, fcsErrorReceived=fcsErrorReceived, qosIndex=qosIndex, vlangroupTable=vlangroupTable, voltage=voltage, wan=wan, catv=catv, port2=port2, jumblan1=jumblan1, portStatEntry=portStatEntry, pauseTransmitted=pauseTransmitted, wanType=wanType, staticIpPrimaryDns=staticIpPrimaryDns, unicastsTransmitted=unicastsTransmitted, multicastsTransmitted=multicastsTransmitted, dscpEnable=dscpEnable, rebootEnable=rebootEnable, adminStatus=adminStatus, port4=port4, fileName=fileName, qmapping=qmapping, portIndex=portIndex, catvEnable=catvEnable, operStatus=operStatus, jumblan3=jumblan3)
