...
NotificationType, TimeTicks, mib_2, Bits, MibIdentifier, Counter32, IpAddress, ObjectIdentity, Integer32, ModuleIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, Unsigned32, snmpModules, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "mib-2", "Bits", "MibIdentifier", "Counter32", "IpAddress", "ObjectIdentity", "Integer32", "ModuleIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "Unsigned32", "snmpModules", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan4=lan4, staticIpAddr=staticIpAddr, port2=port2, multicastsReceived=multicastsReceived, port3=port3, jumb=jumb, internetPort=internetPort, lanportspeed=lanportspeed, voltage=voltage, vendorPn=vendorPn, jumblan1=jumblan1, groupid=groupid, rebootEnable=rebootEnable, catvEnable=catvEnable, xg6846=xg6846, jumblan4=jumblan4, groupIndex=groupIndex, unicastsTransmitted=unicastsTransmitted, txPower=txPower, lanportIndex=lanportIndex, staticIpHostName=staticIpHostName, portTable=portTable, secondaryDns=secondaryDns, tftpSevIp=tftpSevIp, vendorName=vendorName, dscpEnable=dscpEnable, vendorOui=vendorOui, serialnum=serialnum, bias=bias, lanportpause=lanportpause, deviceinfo=deviceinfo, rxPower=rxPower, tftp=tftp, staticIpPrimaryDns=staticIpPrimaryDns, fcsErrorTransmitted=fcsErrorTransmitted, jumbwan=jumbwan, broadcastsTransmitted=broadcastsTransmitted, wanType=wanType, adminStatus=adminStatus, portStatistic=portStatistic, qosTable=qosTable, catv=catv, lanportTable=lanportTable, staticIpGateway=staticIpGateway, pauseTransmitted=pauseTransmitted, port1=port1, staticIpSecondaryDns=staticIpSecondaryDns, speed=speed, port4=port4, portEntry=portEntry, qmode=qmode, qmapping=qmapping, pauseReceived=pauseReceived, staticIpDomainName=staticIpDomainName, hostname=hostname, broadcastsReceived=broadcastsReceived, primaryDns=primaryDns, temperature=temperature, multicastsTransmitted=multicastsTransmitted, fcsErrorReceived=fcsErrorReceived, modeEntry=modeEntry, lan1=lan1, portName=portName, vlan=vlan, portPower=portPower, statIndex=statIndex, staticDns=staticDns, lan3=lan3, groupEntry=groupEntry, action=action, portStatEntry=portStatEntry, vlangroupTable=vlangroupTable, wan=wan, qosEntry=qosEntry, qosIndex=qosIndex, qos=qos, jumblan3=jumblan3, jumblan2=jumblan2, reboot=reboot, lan2=lan2, vlanid=vlanid, staticIpSubMask=staticIpSubMask, lanportName=lanportName, unicastsReceived=unicastsReceived, domainame=domainame, vendorRev=vendorRev, portmode=portmode, operStatus=operStatus, statisticTable=statisticTable, priority=priority, fileType=fileType, ddminfo=ddminfo, portIndex=portIndex, fileName=fileName)
