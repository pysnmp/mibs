...
# Produced by pysmi-1.1.8 at Mon Jan  2 13:24:35 2023
...
Counter64, ModuleIdentity, Bits, iso, Unsigned32, mib_2, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, IpAddress, TimeTicks, ObjectIdentity, snmpModules, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "Bits", "iso", "Unsigned32", "mib-2", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "IpAddress", "TimeTicks", "ObjectIdentity", "snmpModules", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", groupIndex=groupIndex, multicastsReceived=multicastsReceived, speed=speed, statisticTable=statisticTable, qmode=qmode, portmode=portmode, xg6846=xg6846, vlangroupTable=vlangroupTable, portStatistic=portStatistic, internetPort=internetPort, lanportName=lanportName, vendorName=vendorName, secondaryDns=secondaryDns, vlan=vlan, tftpSevIp=tftpSevIp, qosTable=qosTable, jumbwan=jumbwan, lan2=lan2, unicastsReceived=unicastsReceived, broadcastsReceived=broadcastsReceived, unicastsTransmitted=unicastsTransmitted, multicastsTransmitted=multicastsTransmitted, port1=port1, staticIpSubMask=staticIpSubMask, catv=catv, dscpEnable=dscpEnable, lanportIndex=lanportIndex, modeEntry=modeEntry, portStatEntry=portStatEntry, action=action, vlanid=vlanid, staticIpAddr=staticIpAddr, statIndex=statIndex, pauseTransmitted=pauseTransmitted, tftp=tftp, operStatus=operStatus, temperature=temperature, jumblan3=jumblan3, reboot=reboot, fileName=fileName, wanType=wanType, vendorRev=vendorRev, port4=port4, catvEnable=catvEnable, deviceinfo=deviceinfo, jumblan4=jumblan4, rxPower=rxPower, groupid=groupid, qosIndex=qosIndex, txPower=txPower, portIndex=portIndex, vendorPn=vendorPn, wan=wan, jumblan2=jumblan2, lanportspeed=lanportspeed, lan1=lan1, fcsErrorTransmitted=fcsErrorTransmitted, rebootEnable=rebootEnable, portTable=portTable, portPower=portPower, lanportTable=lanportTable, priority=priority, port3=port3, fcsErrorReceived=fcsErrorReceived, lan3=lan3, bias=bias, pauseReceived=pauseReceived, staticIpPrimaryDns=staticIpPrimaryDns, lanportpause=lanportpause, serialnum=serialnum, primaryDns=primaryDns, portName=portName, port2=port2, qmapping=qmapping, staticIpHostName=staticIpHostName, domainame=domainame, staticDns=staticDns, jumb=jumb, fileType=fileType, qosEntry=qosEntry, staticIpSecondaryDns=staticIpSecondaryDns, ddminfo=ddminfo, lan4=lan4, vendorOui=vendorOui, staticIpGateway=staticIpGateway, groupEntry=groupEntry, voltage=voltage, staticIpDomainName=staticIpDomainName, qos=qos, portEntry=portEntry, hostname=hostname, jumblan1=jumblan1, broadcastsTransmitted=broadcastsTransmitted, adminStatus=adminStatus)
