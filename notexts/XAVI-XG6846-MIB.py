...
# Produced by pysmi-1.1.10 at Fri Oct 27 07:04:31 2023
...
Counter32, MibIdentifier, iso, enterprises, ModuleIdentity, ObjectIdentity, Integer32, TimeTicks, mib_2, Unsigned32, snmpModules, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "iso", "enterprises", "ModuleIdentity", "ObjectIdentity", "Integer32", "TimeTicks", "mib-2", "Unsigned32", "snmpModules", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", rxPower=rxPower, lanportspeed=lanportspeed, catv=catv, priority=priority, jumblan2=jumblan2, deviceinfo=deviceinfo, port3=port3, ddminfo=ddminfo, statisticTable=statisticTable, staticDns=staticDns, vendorName=vendorName, broadcastsTransmitted=broadcastsTransmitted, portIndex=portIndex, serialnum=serialnum, lan2=lan2, wan=wan, qosEntry=qosEntry, portEntry=portEntry, lanportpause=lanportpause, qosIndex=qosIndex, vendorRev=vendorRev, qosTable=qosTable, bias=bias, statIndex=statIndex, port4=port4, modeEntry=modeEntry, staticIpHostName=staticIpHostName, lanportName=lanportName, jumb=jumb, groupEntry=groupEntry, lan3=lan3, multicastsReceived=multicastsReceived, txPower=txPower, portName=portName, fcsErrorTransmitted=fcsErrorTransmitted, tftp=tftp, operStatus=operStatus, broadcastsReceived=broadcastsReceived, qmapping=qmapping, staticIpSecondaryDns=staticIpSecondaryDns, domainame=domainame, staticIpAddr=staticIpAddr, jumblan1=jumblan1, rebootEnable=rebootEnable, tftpSevIp=tftpSevIp, lan4=lan4, hostname=hostname, action=action, vlangroupTable=vlangroupTable, vlan=vlan, portStatistic=portStatistic, vendorOui=vendorOui, jumblan4=jumblan4, pauseTransmitted=pauseTransmitted, portmode=portmode, wanType=wanType, pauseReceived=pauseReceived, speed=speed, portStatEntry=portStatEntry, lanportTable=lanportTable, lanportIndex=lanportIndex, jumbwan=jumbwan, qmode=qmode, fileType=fileType, groupIndex=groupIndex, adminStatus=adminStatus, temperature=temperature, catvEnable=catvEnable, port2=port2, groupid=groupid, jumblan3=jumblan3, voltage=voltage, fileName=fileName, reboot=reboot, multicastsTransmitted=multicastsTransmitted, dscpEnable=dscpEnable, staticIpDomainName=staticIpDomainName, qos=qos, portPower=portPower, vlanid=vlanid, primaryDns=primaryDns, secondaryDns=secondaryDns, internetPort=internetPort, staticIpSubMask=staticIpSubMask, staticIpPrimaryDns=staticIpPrimaryDns, vendorPn=vendorPn, fcsErrorReceived=fcsErrorReceived, staticIpGateway=staticIpGateway, unicastsReceived=unicastsReceived, port1=port1, xg6846=xg6846, portTable=portTable, unicastsTransmitted=unicastsTransmitted, lan1=lan1)
