...
# Produced by pysmi-1.1.3 at Sun Nov 28 19:55:00 2021
...
ObjectIdentity, iso, Bits, Unsigned32, Integer32, Counter32, Counter64, snmpModules, Gauge32, MibIdentifier, ModuleIdentity, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, mib_2, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "Bits", "Unsigned32", "Integer32", "Counter32", "Counter64", "snmpModules", "Gauge32", "MibIdentifier", "ModuleIdentity", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "mib-2", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portTable=portTable, unicastsTransmitted=unicastsTransmitted, vendorRev=vendorRev, txPower=txPower, action=action, rxPower=rxPower, wan=wan, pauseReceived=pauseReceived, portmode=portmode, lanportTable=lanportTable, speed=speed, bias=bias, secondaryDns=secondaryDns, fileType=fileType, fcsErrorTransmitted=fcsErrorTransmitted, multicastsTransmitted=multicastsTransmitted, lan2=lan2, portEntry=portEntry, staticIpSubMask=staticIpSubMask, qosTable=qosTable, statIndex=statIndex, port4=port4, staticDns=staticDns, hostname=hostname, groupid=groupid, temperature=temperature, jumblan3=jumblan3, portIndex=portIndex, catvEnable=catvEnable, lan4=lan4, operStatus=operStatus, internetPort=internetPort, staticIpDomainName=staticIpDomainName, lanportspeed=lanportspeed, adminStatus=adminStatus, qosEntry=qosEntry, vendorPn=vendorPn, groupEntry=groupEntry, portName=portName, port1=port1, portStatistic=portStatistic, qosIndex=qosIndex, portStatEntry=portStatEntry, modeEntry=modeEntry, lan3=lan3, groupIndex=groupIndex, serialnum=serialnum, qmode=qmode, pauseTransmitted=pauseTransmitted, lanportIndex=lanportIndex, tftp=tftp, deviceinfo=deviceinfo, vendorName=vendorName, port3=port3, jumblan2=jumblan2, unicastsReceived=unicastsReceived, vlan=vlan, vlanid=vlanid, broadcastsTransmitted=broadcastsTransmitted, statisticTable=statisticTable, vlangroupTable=vlangroupTable, voltage=voltage, domainame=domainame, jumbwan=jumbwan, jumblan4=jumblan4, catv=catv, portPower=portPower, wanType=wanType, jumblan1=jumblan1, tftpSevIp=tftpSevIp, lanportpause=lanportpause, fileName=fileName, staticIpAddr=staticIpAddr, staticIpGateway=staticIpGateway, multicastsReceived=multicastsReceived, dscpEnable=dscpEnable, reboot=reboot, lan1=lan1, fcsErrorReceived=fcsErrorReceived, qos=qos, port2=port2, jumb=jumb, broadcastsReceived=broadcastsReceived, primaryDns=primaryDns, rebootEnable=rebootEnable, staticIpSecondaryDns=staticIpSecondaryDns, ddminfo=ddminfo, lanportName=lanportName, staticIpPrimaryDns=staticIpPrimaryDns, qmapping=qmapping, priority=priority, vendorOui=vendorOui, staticIpHostName=staticIpHostName, xg6846=xg6846)
