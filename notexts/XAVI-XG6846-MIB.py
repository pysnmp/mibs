...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumblan2=jumblan2, primaryDns=primaryDns, operStatus=operStatus, vlan=vlan, qosTable=qosTable, lan3=lan3, bias=bias, wan=wan, groupEntry=groupEntry, unicastsTransmitted=unicastsTransmitted, vlanid=vlanid, ddminfo=ddminfo, vendorPn=vendorPn, jumblan4=jumblan4, serialnum=serialnum, jumblan1=jumblan1, fcsErrorReceived=fcsErrorReceived, speed=speed, staticIpGateway=staticIpGateway, temperature=temperature, portIndex=portIndex, vlangroupTable=vlangroupTable, jumb=jumb, lanportIndex=lanportIndex, lanportTable=lanportTable, lan2=lan2, deviceinfo=deviceinfo, fileName=fileName, portName=portName, catvEnable=catvEnable, qmode=qmode, vendorOui=vendorOui, portmode=portmode, internetPort=internetPort, staticIpDomainName=staticIpDomainName, multicastsTransmitted=multicastsTransmitted, xg6846=xg6846, lanportspeed=lanportspeed, jumblan3=jumblan3, pauseReceived=pauseReceived, vendorRev=vendorRev, wanType=wanType, lan1=lan1, staticIpHostName=staticIpHostName, broadcastsTransmitted=broadcastsTransmitted, rxPower=rxPower, reboot=reboot, dscpEnable=dscpEnable, qmapping=qmapping, modeEntry=modeEntry, fcsErrorTransmitted=fcsErrorTransmitted, lanportName=lanportName, staticIpSecondaryDns=staticIpSecondaryDns, catv=catv, action=action, groupid=groupid, statisticTable=statisticTable, txPower=txPower, adminStatus=adminStatus, lan4=lan4, unicastsReceived=unicastsReceived, portPower=portPower, secondaryDns=secondaryDns, groupIndex=groupIndex, staticIpPrimaryDns=staticIpPrimaryDns, staticIpAddr=staticIpAddr, port1=port1, portStatistic=portStatistic, statIndex=statIndex, pauseTransmitted=pauseTransmitted, domainame=domainame, fileType=fileType, lanportpause=lanportpause, qosEntry=qosEntry, multicastsReceived=multicastsReceived, port4=port4, portEntry=portEntry, broadcastsReceived=broadcastsReceived, port2=port2, qos=qos, portStatEntry=portStatEntry, port3=port3, jumbwan=jumbwan, hostname=hostname, staticDns=staticDns, vendorName=vendorName, qosIndex=qosIndex, portTable=portTable, tftpSevIp=tftpSevIp, voltage=voltage, priority=priority, staticIpSubMask=staticIpSubMask, rebootEnable=rebootEnable, tftp=tftp)
