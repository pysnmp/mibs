...
iso, NotificationType, Bits, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter32, ModuleIdentity, TimeTicks, IpAddress, ObjectIdentity, snmpModules, Integer32, MibIdentifier, mib_2, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Bits", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter32", "ModuleIdentity", "TimeTicks", "IpAddress", "ObjectIdentity", "snmpModules", "Integer32", "MibIdentifier", "mib-2", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", domainame=domainame, ddminfo=ddminfo, qosIndex=qosIndex, lanportName=lanportName, hostname=hostname, modeEntry=modeEntry, portStatistic=portStatistic, tftpSevIp=tftpSevIp, vendorOui=vendorOui, staticIpAddr=staticIpAddr, lanportpause=lanportpause, unicastsReceived=unicastsReceived, secondaryDns=secondaryDns, staticIpGateway=staticIpGateway, jumb=jumb, jumblan3=jumblan3, qmode=qmode, fcsErrorTransmitted=fcsErrorTransmitted, speed=speed, lan2=lan2, staticIpSecondaryDns=staticIpSecondaryDns, portName=portName, staticIpHostName=staticIpHostName, qmapping=qmapping, wanType=wanType, pauseTransmitted=pauseTransmitted, statIndex=statIndex, lan3=lan3, staticIpSubMask=staticIpSubMask, lan4=lan4, port2=port2, portTable=portTable, multicastsTransmitted=multicastsTransmitted, deviceinfo=deviceinfo, rxPower=rxPower, groupid=groupid, vlanid=vlanid, jumblan4=jumblan4, qosEntry=qosEntry, portIndex=portIndex, bias=bias, jumblan2=jumblan2, broadcastsReceived=broadcastsReceived, wan=wan, vlan=vlan, primaryDns=primaryDns, dscpEnable=dscpEnable, port1=port1, xg6846=xg6846, portPower=portPower, serialnum=serialnum, lanportTable=lanportTable, unicastsTransmitted=unicastsTransmitted, multicastsReceived=multicastsReceived, broadcastsTransmitted=broadcastsTransmitted, pauseReceived=pauseReceived, portStatEntry=portStatEntry, fileType=fileType, lan1=lan1, vendorPn=vendorPn, vendorRev=vendorRev, staticIpPrimaryDns=staticIpPrimaryDns, internetPort=internetPort, staticIpDomainName=staticIpDomainName, qosTable=qosTable, port3=port3, lanportspeed=lanportspeed, tftp=tftp, qos=qos, groupIndex=groupIndex, portEntry=portEntry, statisticTable=statisticTable, jumbwan=jumbwan, txPower=txPower, operStatus=operStatus, catvEnable=catvEnable, vlangroupTable=vlangroupTable, catv=catv, adminStatus=adminStatus, action=action, temperature=temperature, vendorName=vendorName, rebootEnable=rebootEnable, fileName=fileName, jumblan1=jumblan1, voltage=voltage, fcsErrorReceived=fcsErrorReceived, lanportIndex=lanportIndex, portmode=portmode, staticDns=staticDns, port4=port4, reboot=reboot, priority=priority, groupEntry=groupEntry)
