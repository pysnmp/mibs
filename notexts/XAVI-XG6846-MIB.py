...
mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, NotificationType, IpAddress, ModuleIdentity, enterprises, Bits, ObjectIdentity, MibIdentifier, Counter32, Integer32, Unsigned32, TimeTicks, snmpModules, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "NotificationType", "IpAddress", "ModuleIdentity", "enterprises", "Bits", "ObjectIdentity", "MibIdentifier", "Counter32", "Integer32", "Unsigned32", "TimeTicks", "snmpModules", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", tftpSevIp=tftpSevIp, statIndex=statIndex, port4=port4, vlangroupTable=vlangroupTable, lanportspeed=lanportspeed, rxPower=rxPower, staticIpSecondaryDns=staticIpSecondaryDns, broadcastsTransmitted=broadcastsTransmitted, groupid=groupid, qmode=qmode, multicastsTransmitted=multicastsTransmitted, lan2=lan2, staticIpSubMask=staticIpSubMask, vendorName=vendorName, jumbwan=jumbwan, domainame=domainame, portTable=portTable, catv=catv, portmode=portmode, lanportName=lanportName, lanportTable=lanportTable, fcsErrorReceived=fcsErrorReceived, qmapping=qmapping, lan3=lan3, wanType=wanType, staticIpHostName=staticIpHostName, jumblan4=jumblan4, vlan=vlan, qosEntry=qosEntry, portName=portName, jumblan1=jumblan1, secondaryDns=secondaryDns, fileType=fileType, internetPort=internetPort, jumb=jumb, portEntry=portEntry, pauseTransmitted=pauseTransmitted, wan=wan, vendorPn=vendorPn, unicastsTransmitted=unicastsTransmitted, qosTable=qosTable, vlanid=vlanid, unicastsReceived=unicastsReceived, reboot=reboot, ddminfo=ddminfo, portPower=portPower, temperature=temperature, speed=speed, xg6846=xg6846, lan4=lan4, port1=port1, port2=port2, staticIpDomainName=staticIpDomainName, tftp=tftp, vendorOui=vendorOui, portStatistic=portStatistic, bias=bias, action=action, vendorRev=vendorRev, fileName=fileName, deviceinfo=deviceinfo, voltage=voltage, jumblan2=jumblan2, staticDns=staticDns, adminStatus=adminStatus, txPower=txPower, staticIpGateway=staticIpGateway, primaryDns=primaryDns, lan1=lan1, staticIpAddr=staticIpAddr, lanportpause=lanportpause, modeEntry=modeEntry, hostname=hostname, fcsErrorTransmitted=fcsErrorTransmitted, jumblan3=jumblan3, groupEntry=groupEntry, serialnum=serialnum, lanportIndex=lanportIndex, groupIndex=groupIndex, qos=qos, operStatus=operStatus, multicastsReceived=multicastsReceived, pauseReceived=pauseReceived, portStatEntry=portStatEntry, port3=port3, catvEnable=catvEnable, priority=priority, statisticTable=statisticTable, broadcastsReceived=broadcastsReceived, dscpEnable=dscpEnable, qosIndex=qosIndex, staticIpPrimaryDns=staticIpPrimaryDns, portIndex=portIndex, rebootEnable=rebootEnable)
