...
# Produced by pysmi-1.1.10 at Fri Feb 16 02:38:25 2024
...
TimeTicks, Counter32, ObjectIdentity, Integer32, ModuleIdentity, IpAddress, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, iso, Unsigned32, snmpModules, enterprises, mib_2, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "ObjectIdentity", "Integer32", "ModuleIdentity", "IpAddress", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "iso", "Unsigned32", "snmpModules", "enterprises", "mib-2", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorName=vendorName, groupEntry=groupEntry, statisticTable=statisticTable, portPower=portPower, secondaryDns=secondaryDns, staticIpGateway=staticIpGateway, lan4=lan4, rxPower=rxPower, jumb=jumb, port1=port1, temperature=temperature, portStatEntry=portStatEntry, staticIpHostName=staticIpHostName, jumblan2=jumblan2, modeEntry=modeEntry, staticIpPrimaryDns=staticIpPrimaryDns, statIndex=statIndex, qosEntry=qosEntry, lan3=lan3, tftp=tftp, portIndex=portIndex, domainame=domainame, hostname=hostname, lanportName=lanportName, groupid=groupid, ddminfo=ddminfo, internetPort=internetPort, tftpSevIp=tftpSevIp, broadcastsReceived=broadcastsReceived, speed=speed, rebootEnable=rebootEnable, multicastsTransmitted=multicastsTransmitted, lanportIndex=lanportIndex, portEntry=portEntry, priority=priority, jumbwan=jumbwan, primaryDns=primaryDns, jumblan4=jumblan4, port2=port2, port4=port4, multicastsReceived=multicastsReceived, vlan=vlan, bias=bias, broadcastsTransmitted=broadcastsTransmitted, catvEnable=catvEnable, wan=wan, pauseReceived=pauseReceived, txPower=txPower, reboot=reboot, fcsErrorTransmitted=fcsErrorTransmitted, staticIpSubMask=staticIpSubMask, vendorOui=vendorOui, qmapping=qmapping, port3=port3, qosIndex=qosIndex, vendorRev=vendorRev, vlanid=vlanid, wanType=wanType, staticDns=staticDns, deviceinfo=deviceinfo, dscpEnable=dscpEnable, staticIpAddr=staticIpAddr, lanportpause=lanportpause, staticIpDomainName=staticIpDomainName, qosTable=qosTable, lanportTable=lanportTable, qmode=qmode, lan1=lan1, serialnum=serialnum, unicastsReceived=unicastsReceived, action=action, fileName=fileName, jumblan1=jumblan1, lan2=lan2, lanportspeed=lanportspeed, fileType=fileType, portStatistic=portStatistic, vendorPn=vendorPn, staticIpSecondaryDns=staticIpSecondaryDns, groupIndex=groupIndex, voltage=voltage, vlangroupTable=vlangroupTable, portTable=portTable, jumblan3=jumblan3, operStatus=operStatus, qos=qos, portmode=portmode, unicastsTransmitted=unicastsTransmitted, pauseTransmitted=pauseTransmitted, xg6846=xg6846, catv=catv, fcsErrorReceived=fcsErrorReceived, adminStatus=adminStatus, portName=portName)
