...
ObjectIdentity, Unsigned32, ModuleIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, enterprises, Gauge32, TimeTicks, Integer32, Bits, MibIdentifier, mib_2, IpAddress, Counter32, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "enterprises", "Gauge32", "TimeTicks", "Integer32", "Bits", "MibIdentifier", "mib-2", "IpAddress", "Counter32", "NotificationType", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan2=lan2, staticIpGateway=staticIpGateway, vlanid=vlanid, catvEnable=catvEnable, fileName=fileName, qosIndex=qosIndex, voltage=voltage, domainame=domainame, serialnum=serialnum, rxPower=rxPower, jumblan4=jumblan4, lanportName=lanportName, port1=port1, reboot=reboot, broadcastsReceived=broadcastsReceived, action=action, vendorOui=vendorOui, secondaryDns=secondaryDns, jumblan3=jumblan3, staticIpAddr=staticIpAddr, port3=port3, jumbwan=jumbwan, vlangroupTable=vlangroupTable, portTable=portTable, qmapping=qmapping, hostname=hostname, operStatus=operStatus, jumblan1=jumblan1, dscpEnable=dscpEnable, port2=port2, tftp=tftp, modeEntry=modeEntry, groupEntry=groupEntry, vendorName=vendorName, staticIpDomainName=staticIpDomainName, txPower=txPower, primaryDns=primaryDns, staticIpSecondaryDns=staticIpSecondaryDns, portIndex=portIndex, lan4=lan4, jumblan2=jumblan2, lanportTable=lanportTable, qosTable=qosTable, deviceinfo=deviceinfo, vendorRev=vendorRev, staticIpHostName=staticIpHostName, portName=portName, pauseReceived=pauseReceived, vlan=vlan, qosEntry=qosEntry, speed=speed, temperature=temperature, fcsErrorReceived=fcsErrorReceived, staticIpPrimaryDns=staticIpPrimaryDns, portmode=portmode, staticDns=staticDns, portPower=portPower, qmode=qmode, fcsErrorTransmitted=fcsErrorTransmitted, fileType=fileType, pauseTransmitted=pauseTransmitted, wanType=wanType, multicastsReceived=multicastsReceived, groupIndex=groupIndex, wan=wan, portStatEntry=portStatEntry, port4=port4, portStatistic=portStatistic, tftpSevIp=tftpSevIp, lanportspeed=lanportspeed, staticIpSubMask=staticIpSubMask, statIndex=statIndex, catv=catv, lanportIndex=lanportIndex, groupid=groupid, jumb=jumb, ddminfo=ddminfo, priority=priority, bias=bias, lan3=lan3, vendorPn=vendorPn, internetPort=internetPort, statisticTable=statisticTable, broadcastsTransmitted=broadcastsTransmitted, portEntry=portEntry, multicastsTransmitted=multicastsTransmitted, lan1=lan1, adminStatus=adminStatus, lanportpause=lanportpause, xg6846=xg6846, rebootEnable=rebootEnable, unicastsReceived=unicastsReceived, qos=qos, unicastsTransmitted=unicastsTransmitted)
