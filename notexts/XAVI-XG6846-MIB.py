...
enterprises, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, Counter64, snmpModules, Gauge32, NotificationType, Unsigned32, Bits, TimeTicks, Counter32, MibIdentifier, IpAddress, mib_2, iso = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "Counter64", "snmpModules", "Gauge32", "NotificationType", "Unsigned32", "Bits", "TimeTicks", "Counter32", "MibIdentifier", "IpAddress", "mib-2", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", unicastsTransmitted=unicastsTransmitted, rebootEnable=rebootEnable, qosEntry=qosEntry, multicastsReceived=multicastsReceived, jumblan2=jumblan2, lan1=lan1, staticIpDomainName=staticIpDomainName, staticDns=staticDns, broadcastsTransmitted=broadcastsTransmitted, jumblan3=jumblan3, lanportName=lanportName, groupIndex=groupIndex, unicastsReceived=unicastsReceived, fileType=fileType, wanType=wanType, staticIpPrimaryDns=staticIpPrimaryDns, ddminfo=ddminfo, voltage=voltage, vlanid=vlanid, pauseReceived=pauseReceived, vendorName=vendorName, portIndex=portIndex, hostname=hostname, priority=priority, vendorRev=vendorRev, portStatEntry=portStatEntry, pauseTransmitted=pauseTransmitted, qosTable=qosTable, bias=bias, statisticTable=statisticTable, staticIpAddr=staticIpAddr, staticIpGateway=staticIpGateway, lanportspeed=lanportspeed, vendorOui=vendorOui, lan4=lan4, xg6846=xg6846, lanportTable=lanportTable, portEntry=portEntry, deviceinfo=deviceinfo, adminStatus=adminStatus, port1=port1, modeEntry=modeEntry, jumblan4=jumblan4, broadcastsReceived=broadcastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, lanportpause=lanportpause, primaryDns=primaryDns, catv=catv, dscpEnable=dscpEnable, portName=portName, tftpSevIp=tftpSevIp, qmapping=qmapping, portStatistic=portStatistic, rxPower=rxPower, groupid=groupid, jumb=jumb, qosIndex=qosIndex, staticIpHostName=staticIpHostName, multicastsTransmitted=multicastsTransmitted, port3=port3, lan2=lan2, jumblan1=jumblan1, portPower=portPower, lan3=lan3, port2=port2, vlan=vlan, domainame=domainame, qmode=qmode, lanportIndex=lanportIndex, catvEnable=catvEnable, tftp=tftp, vendorPn=vendorPn, temperature=temperature, serialnum=serialnum, txPower=txPower, internetPort=internetPort, portTable=portTable, fcsErrorTransmitted=fcsErrorTransmitted, fileName=fileName, jumbwan=jumbwan, qos=qos, wan=wan, operStatus=operStatus, port4=port4, speed=speed, groupEntry=groupEntry, reboot=reboot, fcsErrorReceived=fcsErrorReceived, vlangroupTable=vlangroupTable, action=action, staticIpSubMask=staticIpSubMask, statIndex=statIndex, secondaryDns=secondaryDns, portmode=portmode)
