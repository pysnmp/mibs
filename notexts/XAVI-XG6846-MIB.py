...
# Produced by pysmi-1.1.3 at Sun Nov 21 00:40:05 2021
...
snmpModules, mib_2, Gauge32, ObjectIdentity, MibIdentifier, TimeTicks, NotificationType, enterprises, IpAddress, ModuleIdentity, iso, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "mib-2", "Gauge32", "ObjectIdentity", "MibIdentifier", "TimeTicks", "NotificationType", "enterprises", "IpAddress", "ModuleIdentity", "iso", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", wan=wan, statisticTable=statisticTable, staticIpHostName=staticIpHostName, portPower=portPower, fileType=fileType, lanportIndex=lanportIndex, qos=qos, primaryDns=primaryDns, action=action, portmode=portmode, qosIndex=qosIndex, fcsErrorReceived=fcsErrorReceived, port3=port3, jumblan4=jumblan4, priority=priority, lanportpause=lanportpause, vlan=vlan, port2=port2, portEntry=portEntry, fcsErrorTransmitted=fcsErrorTransmitted, pauseTransmitted=pauseTransmitted, vendorOui=vendorOui, staticDns=staticDns, broadcastsReceived=broadcastsReceived, portIndex=portIndex, deviceinfo=deviceinfo, jumblan2=jumblan2, jumbwan=jumbwan, wanType=wanType, port4=port4, unicastsReceived=unicastsReceived, qmapping=qmapping, reboot=reboot, jumblan1=jumblan1, groupEntry=groupEntry, lan1=lan1, catv=catv, staticIpAddr=staticIpAddr, tftp=tftp, hostname=hostname, staticIpDomainName=staticIpDomainName, statIndex=statIndex, staticIpSubMask=staticIpSubMask, bias=bias, portTable=portTable, catvEnable=catvEnable, unicastsTransmitted=unicastsTransmitted, domainame=domainame, vlangroupTable=vlangroupTable, portName=portName, port1=port1, lan3=lan3, vlanid=vlanid, modeEntry=modeEntry, groupIndex=groupIndex, speed=speed, vendorPn=vendorPn, staticIpPrimaryDns=staticIpPrimaryDns, portStatistic=portStatistic, lanportspeed=lanportspeed, lanportTable=lanportTable, rebootEnable=rebootEnable, jumblan3=jumblan3, pauseReceived=pauseReceived, groupid=groupid, serialnum=serialnum, internetPort=internetPort, txPower=txPower, broadcastsTransmitted=broadcastsTransmitted, lanportName=lanportName, dscpEnable=dscpEnable, temperature=temperature, portStatEntry=portStatEntry, voltage=voltage, jumb=jumb, xg6846=xg6846, operStatus=operStatus, multicastsReceived=multicastsReceived, staticIpGateway=staticIpGateway, rxPower=rxPower, qosTable=qosTable, qmode=qmode, vendorName=vendorName, lan4=lan4, adminStatus=adminStatus, lan2=lan2, ddminfo=ddminfo, vendorRev=vendorRev, multicastsTransmitted=multicastsTransmitted, qosEntry=qosEntry, staticIpSecondaryDns=staticIpSecondaryDns, secondaryDns=secondaryDns, fileName=fileName, tftpSevIp=tftpSevIp)
