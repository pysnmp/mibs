...
# Produced by pysmi-1.1.12 at Thu Apr  4 09:20:14 2024
...
Integer32, ModuleIdentity, snmpModules, enterprises, NotificationType, Counter32, mib_2, Bits, Counter64, TimeTicks, Gauge32, ObjectIdentity, Unsigned32, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "snmpModules", "enterprises", "NotificationType", "Counter32", "mib-2", "Bits", "Counter64", "TimeTicks", "Gauge32", "ObjectIdentity", "Unsigned32", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fileType=fileType, port3=port3, deviceinfo=deviceinfo, staticIpAddr=staticIpAddr, fileName=fileName, vendorPn=vendorPn, qmapping=qmapping, primaryDns=primaryDns, jumblan4=jumblan4, unicastsTransmitted=unicastsTransmitted, fcsErrorReceived=fcsErrorReceived, broadcastsTransmitted=broadcastsTransmitted, internetPort=internetPort, operStatus=operStatus, pauseReceived=pauseReceived, multicastsTransmitted=multicastsTransmitted, jumbwan=jumbwan, groupid=groupid, temperature=temperature, lanportpause=lanportpause, portmode=portmode, vendorOui=vendorOui, reboot=reboot, xg6846=xg6846, lanportIndex=lanportIndex, secondaryDns=secondaryDns, catv=catv, groupEntry=groupEntry, portPower=portPower, hostname=hostname, lan2=lan2, statisticTable=statisticTable, staticIpPrimaryDns=staticIpPrimaryDns, action=action, rxPower=rxPower, portIndex=portIndex, txPower=txPower, staticIpHostName=staticIpHostName, ddminfo=ddminfo, jumb=jumb, modeEntry=modeEntry, wan=wan, domainame=domainame, bias=bias, rebootEnable=rebootEnable, portStatistic=portStatistic, portTable=portTable, lanportName=lanportName, staticDns=staticDns, speed=speed, vlangroupTable=vlangroupTable, lan4=lan4, portStatEntry=portStatEntry, jumblan1=jumblan1, lanportTable=lanportTable, portEntry=portEntry, statIndex=statIndex, qmode=qmode, qosTable=qosTable, staticIpSecondaryDns=staticIpSecondaryDns, dscpEnable=dscpEnable, jumblan3=jumblan3, qosEntry=qosEntry, tftpSevIp=tftpSevIp, lanportspeed=lanportspeed, lan3=lan3, portName=portName, multicastsReceived=multicastsReceived, priority=priority, jumblan2=jumblan2, qos=qos, qosIndex=qosIndex, vendorName=vendorName, vlanid=vlanid, catvEnable=catvEnable, staticIpDomainName=staticIpDomainName, vlan=vlan, port2=port2, serialnum=serialnum, groupIndex=groupIndex, port1=port1, unicastsReceived=unicastsReceived, staticIpGateway=staticIpGateway, tftp=tftp, vendorRev=vendorRev, fcsErrorTransmitted=fcsErrorTransmitted, port4=port4, staticIpSubMask=staticIpSubMask, adminStatus=adminStatus, pauseTransmitted=pauseTransmitted, voltage=voltage, wanType=wanType, lan1=lan1, broadcastsReceived=broadcastsReceived)
