...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, MibIdentifier, Counter32, NotificationType, Integer32, ObjectIdentity, Counter64, snmpModules, Bits, IpAddress, TimeTicks, enterprises, mib_2, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "MibIdentifier", "Counter32", "NotificationType", "Integer32", "ObjectIdentity", "Counter64", "snmpModules", "Bits", "IpAddress", "TimeTicks", "enterprises", "mib-2", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", port4=port4, portIndex=portIndex, portStatEntry=portStatEntry, staticIpSubMask=staticIpSubMask, vendorRev=vendorRev, portPower=portPower, lanportIndex=lanportIndex, groupEntry=groupEntry, secondaryDns=secondaryDns, lanportspeed=lanportspeed, bias=bias, unicastsTransmitted=unicastsTransmitted, vendorName=vendorName, lanportpause=lanportpause, qos=qos, jumblan2=jumblan2, staticIpHostName=staticIpHostName, vendorPn=vendorPn, vlan=vlan, multicastsReceived=multicastsReceived, voltage=voltage, jumblan3=jumblan3, rebootEnable=rebootEnable, staticIpPrimaryDns=staticIpPrimaryDns, lan2=lan2, port1=port1, operStatus=operStatus, qosTable=qosTable, xg6846=xg6846, wan=wan, portName=portName, port2=port2, serialnum=serialnum, vendorOui=vendorOui, speed=speed, staticIpDomainName=staticIpDomainName, vlangroupTable=vlangroupTable, lanportTable=lanportTable, hostname=hostname, staticDns=staticDns, temperature=temperature, vlanid=vlanid, catv=catv, txPower=txPower, catvEnable=catvEnable, portmode=portmode, multicastsTransmitted=multicastsTransmitted, lan1=lan1, fileName=fileName, statisticTable=statisticTable, ddminfo=ddminfo, staticIpGateway=staticIpGateway, adminStatus=adminStatus, wanType=wanType, groupid=groupid, reboot=reboot, unicastsReceived=unicastsReceived, qmode=qmode, broadcastsReceived=broadcastsReceived, jumbwan=jumbwan, staticIpSecondaryDns=staticIpSecondaryDns, deviceinfo=deviceinfo, qmapping=qmapping, rxPower=rxPower, qosEntry=qosEntry, primaryDns=primaryDns, action=action, qosIndex=qosIndex, statIndex=statIndex, fileType=fileType, priority=priority, fcsErrorReceived=fcsErrorReceived, staticIpAddr=staticIpAddr, fcsErrorTransmitted=fcsErrorTransmitted, lan4=lan4, pauseReceived=pauseReceived, groupIndex=groupIndex, tftpSevIp=tftpSevIp, internetPort=internetPort, port3=port3, tftp=tftp, dscpEnable=dscpEnable, portStatistic=portStatistic, jumblan1=jumblan1, modeEntry=modeEntry, portTable=portTable, jumblan4=jumblan4, jumb=jumb, lan3=lan3, domainame=domainame, pauseTransmitted=pauseTransmitted, broadcastsTransmitted=broadcastsTransmitted, lanportName=lanportName, portEntry=portEntry)
