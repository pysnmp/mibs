...
# Produced by pysmi-1.1.3 at Thu Dec  9 15:04:18 2021
...
mib_2, Integer32, snmpModules, IpAddress, Bits, Counter64, TimeTicks, ModuleIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ObjectIdentity, Counter32, iso, Unsigned32, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Integer32", "snmpModules", "IpAddress", "Bits", "Counter64", "TimeTicks", "ModuleIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ObjectIdentity", "Counter32", "iso", "Unsigned32", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", action=action, internetPort=internetPort, broadcastsTransmitted=broadcastsTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, qosIndex=qosIndex, qosTable=qosTable, primaryDns=primaryDns, staticIpHostName=staticIpHostName, secondaryDns=secondaryDns, jumb=jumb, staticIpDomainName=staticIpDomainName, wanType=wanType, groupIndex=groupIndex, jumblan2=jumblan2, vendorName=vendorName, serialnum=serialnum, portIndex=portIndex, statisticTable=statisticTable, port2=port2, port4=port4, modeEntry=modeEntry, lanportIndex=lanportIndex, adminStatus=adminStatus, priority=priority, pauseTransmitted=pauseTransmitted, portStatistic=portStatistic, qosEntry=qosEntry, groupid=groupid, domainame=domainame, dscpEnable=dscpEnable, temperature=temperature, bias=bias, statIndex=statIndex, fcsErrorTransmitted=fcsErrorTransmitted, portEntry=portEntry, jumblan4=jumblan4, catv=catv, speed=speed, operStatus=operStatus, jumblan1=jumblan1, staticIpSecondaryDns=staticIpSecondaryDns, jumblan3=jumblan3, reboot=reboot, unicastsReceived=unicastsReceived, fileType=fileType, jumbwan=jumbwan, fcsErrorReceived=fcsErrorReceived, lan3=lan3, port3=port3, portPower=portPower, lanportName=lanportName, qos=qos, staticDns=staticDns, ddminfo=ddminfo, groupEntry=groupEntry, multicastsTransmitted=multicastsTransmitted, tftpSevIp=tftpSevIp, catvEnable=catvEnable, vendorPn=vendorPn, staticIpGateway=staticIpGateway, lan4=lan4, portTable=portTable, vlanid=vlanid, deviceinfo=deviceinfo, multicastsReceived=multicastsReceived, lan2=lan2, vendorOui=vendorOui, portStatEntry=portStatEntry, vlangroupTable=vlangroupTable, staticIpSubMask=staticIpSubMask, vendorRev=vendorRev, xg6846=xg6846, broadcastsReceived=broadcastsReceived, pauseReceived=pauseReceived, rxPower=rxPower, txPower=txPower, qmapping=qmapping, qmode=qmode, hostname=hostname, tftp=tftp, portmode=portmode, wan=wan, rebootEnable=rebootEnable, staticIpAddr=staticIpAddr, voltage=voltage, lan1=lan1, lanportTable=lanportTable, portName=portName, vlan=vlan, fileName=fileName, unicastsTransmitted=unicastsTransmitted, lanportspeed=lanportspeed, lanportpause=lanportpause, port1=port1)
