...
iso, ObjectIdentity, snmpModules, Unsigned32, TimeTicks, enterprises, Integer32, mib_2, MibIdentifier, NotificationType, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "snmpModules", "Unsigned32", "TimeTicks", "enterprises", "Integer32", "mib-2", "MibIdentifier", "NotificationType", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", port3=port3, tftp=tftp, fcsErrorTransmitted=fcsErrorTransmitted, deviceinfo=deviceinfo, priority=priority, jumblan4=jumblan4, groupIndex=groupIndex, groupid=groupid, vendorRev=vendorRev, statIndex=statIndex, lanportName=lanportName, port1=port1, rebootEnable=rebootEnable, staticIpSecondaryDns=staticIpSecondaryDns, jumb=jumb, staticIpDomainName=staticIpDomainName, unicastsReceived=unicastsReceived, xg6846=xg6846, adminStatus=adminStatus, lanportIndex=lanportIndex, staticIpAddr=staticIpAddr, lan2=lan2, qos=qos, wan=wan, broadcastsTransmitted=broadcastsTransmitted, internetPort=internetPort, multicastsTransmitted=multicastsTransmitted, jumbwan=jumbwan, voltage=voltage, portPower=portPower, portTable=portTable, tftpSevIp=tftpSevIp, portEntry=portEntry, reboot=reboot, portStatistic=portStatistic, ddminfo=ddminfo, qosIndex=qosIndex, secondaryDns=secondaryDns, vlan=vlan, primaryDns=primaryDns, wanType=wanType, statisticTable=statisticTable, jumblan3=jumblan3, groupEntry=groupEntry, temperature=temperature, portName=portName, qmode=qmode, lan4=lan4, jumblan1=jumblan1, pauseTransmitted=pauseTransmitted, lan3=lan3, jumblan2=jumblan2, port4=port4, vlangroupTable=vlangroupTable, staticIpGateway=staticIpGateway, modeEntry=modeEntry, multicastsReceived=multicastsReceived, operStatus=operStatus, catv=catv, lanportpause=lanportpause, catvEnable=catvEnable, qosTable=qosTable, broadcastsReceived=broadcastsReceived, staticIpPrimaryDns=staticIpPrimaryDns, portStatEntry=portStatEntry, unicastsTransmitted=unicastsTransmitted, txPower=txPower, hostname=hostname, domainame=domainame, staticIpHostName=staticIpHostName, portmode=portmode, bias=bias, vlanid=vlanid, staticIpSubMask=staticIpSubMask, dscpEnable=dscpEnable, portIndex=portIndex, staticDns=staticDns, port2=port2, vendorPn=vendorPn, qmapping=qmapping, fileType=fileType, serialnum=serialnum, lanportTable=lanportTable, fcsErrorReceived=fcsErrorReceived, fileName=fileName, vendorOui=vendorOui, rxPower=rxPower, lanportspeed=lanportspeed, qosEntry=qosEntry, pauseReceived=pauseReceived, vendorName=vendorName, action=action, lan1=lan1, speed=speed)
