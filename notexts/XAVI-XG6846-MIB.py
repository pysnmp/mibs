...
# Produced by pysmi-1.1.8 at Thu Feb  3 21:08:37 2022
...
Counter32, iso, ObjectIdentity, Gauge32, MibIdentifier, Bits, Integer32, IpAddress, ModuleIdentity, Unsigned32, NotificationType, snmpModules, Counter64, TimeTicks, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "ObjectIdentity", "Gauge32", "MibIdentifier", "Bits", "Integer32", "IpAddress", "ModuleIdentity", "Unsigned32", "NotificationType", "snmpModules", "Counter64", "TimeTicks", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpSubMask=staticIpSubMask, qosTable=qosTable, vlangroupTable=vlangroupTable, voltage=voltage, domainame=domainame, qosIndex=qosIndex, qosEntry=qosEntry, portTable=portTable, ddminfo=ddminfo, staticIpPrimaryDns=staticIpPrimaryDns, port1=port1, txPower=txPower, unicastsTransmitted=unicastsTransmitted, port2=port2, portmode=portmode, groupEntry=groupEntry, action=action, adminStatus=adminStatus, staticIpDomainName=staticIpDomainName, jumblan4=jumblan4, unicastsReceived=unicastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, vendorName=vendorName, qos=qos, wan=wan, multicastsTransmitted=multicastsTransmitted, rxPower=rxPower, lan4=lan4, pauseReceived=pauseReceived, portEntry=portEntry, groupIndex=groupIndex, jumblan1=jumblan1, lanportTable=lanportTable, jumbwan=jumbwan, portName=portName, lan1=lan1, fileType=fileType, vendorPn=vendorPn, hostname=hostname, jumblan2=jumblan2, bias=bias, operStatus=operStatus, jumb=jumb, speed=speed, deviceinfo=deviceinfo, port4=port4, primaryDns=primaryDns, staticIpGateway=staticIpGateway, catv=catv, vlanid=vlanid, qmode=qmode, jumblan3=jumblan3, broadcastsTransmitted=broadcastsTransmitted, portIndex=portIndex, xg6846=xg6846, internetPort=internetPort, multicastsReceived=multicastsReceived, portPower=portPower, lan2=lan2, staticIpAddr=staticIpAddr, port3=port3, dscpEnable=dscpEnable, vlan=vlan, vendorOui=vendorOui, lanportIndex=lanportIndex, tftpSevIp=tftpSevIp, lanportspeed=lanportspeed, lan3=lan3, wanType=wanType, tftp=tftp, lanportName=lanportName, modeEntry=modeEntry, serialnum=serialnum, pauseTransmitted=pauseTransmitted, reboot=reboot, priority=priority, fileName=fileName, staticIpSecondaryDns=staticIpSecondaryDns, lanportpause=lanportpause, catvEnable=catvEnable, fcsErrorReceived=fcsErrorReceived, statisticTable=statisticTable, staticDns=staticDns, portStatistic=portStatistic, portStatEntry=portStatEntry, broadcastsReceived=broadcastsReceived, rebootEnable=rebootEnable, groupid=groupid, temperature=temperature, staticIpHostName=staticIpHostName, secondaryDns=secondaryDns, statIndex=statIndex, qmapping=qmapping, vendorRev=vendorRev)
