...
# Produced by pysmi-1.1.8 at Thu Jan 13 23:51:42 2022
...
ModuleIdentity, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, Unsigned32, mib_2, ObjectIdentity, TimeTicks, snmpModules, Counter64, enterprises, MibIdentifier, IpAddress, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "Unsigned32", "mib-2", "ObjectIdentity", "TimeTicks", "snmpModules", "Counter64", "enterprises", "MibIdentifier", "IpAddress", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", multicastsTransmitted=multicastsTransmitted, tftp=tftp, operStatus=operStatus, voltage=voltage, lan2=lan2, ddminfo=ddminfo, deviceinfo=deviceinfo, groupIndex=groupIndex, catvEnable=catvEnable, jumb=jumb, speed=speed, statisticTable=statisticTable, rxPower=rxPower, action=action, jumblan4=jumblan4, lanportIndex=lanportIndex, reboot=reboot, staticIpDomainName=staticIpDomainName, staticIpPrimaryDns=staticIpPrimaryDns, port3=port3, lanportspeed=lanportspeed, vlan=vlan, pauseReceived=pauseReceived, wan=wan, vendorPn=vendorPn, portTable=portTable, lanportTable=lanportTable, unicastsTransmitted=unicastsTransmitted, priority=priority, wanType=wanType, broadcastsReceived=broadcastsReceived, portmode=portmode, temperature=temperature, vendorOui=vendorOui, tftpSevIp=tftpSevIp, staticIpHostName=staticIpHostName, portStatistic=portStatistic, domainame=domainame, xg6846=xg6846, pauseTransmitted=pauseTransmitted, groupEntry=groupEntry, staticDns=staticDns, primaryDns=primaryDns, qmode=qmode, catv=catv, qmapping=qmapping, port1=port1, vendorName=vendorName, lanportName=lanportName, bias=bias, jumblan2=jumblan2, hostname=hostname, port4=port4, staticIpGateway=staticIpGateway, portPower=portPower, portIndex=portIndex, staticIpSecondaryDns=staticIpSecondaryDns, portEntry=portEntry, serialnum=serialnum, jumblan3=jumblan3, portStatEntry=portStatEntry, unicastsReceived=unicastsReceived, portName=portName, broadcastsTransmitted=broadcastsTransmitted, qosEntry=qosEntry, groupid=groupid, staticIpSubMask=staticIpSubMask, vendorRev=vendorRev, vlanid=vlanid, fileName=fileName, internetPort=internetPort, rebootEnable=rebootEnable, jumblan1=jumblan1, port2=port2, modeEntry=modeEntry, jumbwan=jumbwan, lan1=lan1, dscpEnable=dscpEnable, statIndex=statIndex, lanportpause=lanportpause, qosIndex=qosIndex, lan4=lan4, adminStatus=adminStatus, multicastsReceived=multicastsReceived, fileType=fileType, vlangroupTable=vlangroupTable, secondaryDns=secondaryDns, lan3=lan3, staticIpAddr=staticIpAddr, qos=qos, txPower=txPower, fcsErrorTransmitted=fcsErrorTransmitted, fcsErrorReceived=fcsErrorReceived, qosTable=qosTable)
