...
# Produced by pysmi-1.1.8 at Wed Feb  2 19:31:38 2022
...
enterprises, Gauge32, Unsigned32, IpAddress, ObjectIdentity, NotificationType, Bits, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Counter32, mib_2, snmpModules, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "Unsigned32", "IpAddress", "ObjectIdentity", "NotificationType", "Bits", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Counter32", "mib-2", "snmpModules", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", bias=bias, lan4=lan4, reboot=reboot, qosIndex=qosIndex, hostname=hostname, qosTable=qosTable, tftpSevIp=tftpSevIp, deviceinfo=deviceinfo, qmapping=qmapping, portName=portName, primaryDns=primaryDns, port3=port3, adminStatus=adminStatus, qos=qos, jumblan4=jumblan4, domainame=domainame, port4=port4, staticIpPrimaryDns=staticIpPrimaryDns, staticIpDomainName=staticIpDomainName, pauseTransmitted=pauseTransmitted, rxPower=rxPower, wanType=wanType, lan3=lan3, portmode=portmode, modeEntry=modeEntry, internetPort=internetPort, broadcastsReceived=broadcastsReceived, speed=speed, vendorPn=vendorPn, operStatus=operStatus, voltage=voltage, port1=port1, jumb=jumb, wan=wan, jumblan2=jumblan2, fileType=fileType, staticIpAddr=staticIpAddr, ddminfo=ddminfo, rebootEnable=rebootEnable, lan2=lan2, unicastsReceived=unicastsReceived, txPower=txPower, lanportpause=lanportpause, jumbwan=jumbwan, portEntry=portEntry, vendorOui=vendorOui, secondaryDns=secondaryDns, staticIpSubMask=staticIpSubMask, lanportspeed=lanportspeed, portStatEntry=portStatEntry, action=action, vlanid=vlanid, multicastsReceived=multicastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, statisticTable=statisticTable, vlan=vlan, portStatistic=portStatistic, priority=priority, portPower=portPower, groupEntry=groupEntry, xg6846=xg6846, lan1=lan1, staticIpSecondaryDns=staticIpSecondaryDns, unicastsTransmitted=unicastsTransmitted, jumblan3=jumblan3, serialnum=serialnum, vendorName=vendorName, lanportName=lanportName, multicastsTransmitted=multicastsTransmitted, lanportTable=lanportTable, pauseReceived=pauseReceived, broadcastsTransmitted=broadcastsTransmitted, portIndex=portIndex, fcsErrorReceived=fcsErrorReceived, tftp=tftp, lanportIndex=lanportIndex, dscpEnable=dscpEnable, qosEntry=qosEntry, vlangroupTable=vlangroupTable, vendorRev=vendorRev, fileName=fileName, catv=catv, portTable=portTable, staticDns=staticDns, jumblan1=jumblan1, groupIndex=groupIndex, temperature=temperature, staticIpHostName=staticIpHostName, qmode=qmode, statIndex=statIndex, staticIpGateway=staticIpGateway, catvEnable=catvEnable, groupid=groupid, port2=port2)
