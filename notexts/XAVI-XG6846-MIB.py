...
snmpModules, Gauge32, ModuleIdentity, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, enterprises, Integer32, NotificationType, Bits, IpAddress, Counter32, TimeTicks, Counter64, mib_2, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "Gauge32", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "enterprises", "Integer32", "NotificationType", "Bits", "IpAddress", "Counter32", "TimeTicks", "Counter64", "mib-2", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fileType=fileType, reboot=reboot, vlangroupTable=vlangroupTable, portTable=portTable, lan4=lan4, portStatEntry=portStatEntry, vlan=vlan, staticIpPrimaryDns=staticIpPrimaryDns, voltage=voltage, statIndex=statIndex, rxPower=rxPower, lanportpause=lanportpause, speed=speed, jumblan4=jumblan4, lanportIndex=lanportIndex, rebootEnable=rebootEnable, qosIndex=qosIndex, tftp=tftp, operStatus=operStatus, qmapping=qmapping, staticIpHostName=staticIpHostName, statisticTable=statisticTable, groupid=groupid, ddminfo=ddminfo, vlanid=vlanid, port3=port3, vendorRev=vendorRev, fcsErrorTransmitted=fcsErrorTransmitted, port4=port4, multicastsTransmitted=multicastsTransmitted, catvEnable=catvEnable, staticIpAddr=staticIpAddr, qmode=qmode, broadcastsReceived=broadcastsReceived, jumblan1=jumblan1, temperature=temperature, lan2=lan2, portIndex=portIndex, qosEntry=qosEntry, primaryDns=primaryDns, modeEntry=modeEntry, qosTable=qosTable, staticIpSecondaryDns=staticIpSecondaryDns, port2=port2, staticIpGateway=staticIpGateway, staticIpSubMask=staticIpSubMask, priority=priority, xg6846=xg6846, vendorOui=vendorOui, domainame=domainame, wan=wan, wanType=wanType, portEntry=portEntry, lanportTable=lanportTable, catv=catv, broadcastsTransmitted=broadcastsTransmitted, tftpSevIp=tftpSevIp, portmode=portmode, hostname=hostname, deviceinfo=deviceinfo, portName=portName, multicastsReceived=multicastsReceived, pauseReceived=pauseReceived, secondaryDns=secondaryDns, pauseTransmitted=pauseTransmitted, groupIndex=groupIndex, lan1=lan1, serialnum=serialnum, unicastsReceived=unicastsReceived, groupEntry=groupEntry, txPower=txPower, jumblan2=jumblan2, jumblan3=jumblan3, fcsErrorReceived=fcsErrorReceived, vendorPn=vendorPn, staticIpDomainName=staticIpDomainName, internetPort=internetPort, vendorName=vendorName, jumbwan=jumbwan, lanportspeed=lanportspeed, unicastsTransmitted=unicastsTransmitted, lan3=lan3, portStatistic=portStatistic, bias=bias, portPower=portPower, port1=port1, staticDns=staticDns, jumb=jumb, qos=qos, lanportName=lanportName, dscpEnable=dscpEnable, fileName=fileName, action=action, adminStatus=adminStatus)
