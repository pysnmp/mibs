...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32, Counter32, ObjectIdentity, enterprises, Unsigned32, mib_2, iso, ModuleIdentity, Integer32, NotificationType, Bits, snmpModules, TimeTicks, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32", "Counter32", "ObjectIdentity", "enterprises", "Unsigned32", "mib-2", "iso", "ModuleIdentity", "Integer32", "NotificationType", "Bits", "snmpModules", "TimeTicks", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumb=jumb, portEntry=portEntry, groupEntry=groupEntry, tftp=tftp, rxPower=rxPower, primaryDns=primaryDns, port2=port2, portPower=portPower, statIndex=statIndex, action=action, speed=speed, lan3=lan3, lan4=lan4, staticIpPrimaryDns=staticIpPrimaryDns, lanportspeed=lanportspeed, lanportName=lanportName, adminStatus=adminStatus, jumblan4=jumblan4, wanType=wanType, groupIndex=groupIndex, vendorPn=vendorPn, rebootEnable=rebootEnable, fileType=fileType, deviceinfo=deviceinfo, staticDns=staticDns, internetPort=internetPort, xg6846=xg6846, lan1=lan1, lan2=lan2, lanportIndex=lanportIndex, jumblan2=jumblan2, unicastsTransmitted=unicastsTransmitted, dscpEnable=dscpEnable, hostname=hostname, staticIpAddr=staticIpAddr, operStatus=operStatus, broadcastsTransmitted=broadcastsTransmitted, jumblan1=jumblan1, portStatEntry=portStatEntry, domainame=domainame, vendorName=vendorName, qmapping=qmapping, multicastsTransmitted=multicastsTransmitted, port1=port1, portStatistic=portStatistic, ddminfo=ddminfo, multicastsReceived=multicastsReceived, serialnum=serialnum, pauseReceived=pauseReceived, jumblan3=jumblan3, voltage=voltage, fcsErrorTransmitted=fcsErrorTransmitted, temperature=temperature, txPower=txPower, qosIndex=qosIndex, priority=priority, tftpSevIp=tftpSevIp, pauseTransmitted=pauseTransmitted, fcsErrorReceived=fcsErrorReceived, portName=portName, portmode=portmode, lanportpause=lanportpause, qosEntry=qosEntry, reboot=reboot, port4=port4, catv=catv, qosTable=qosTable, portTable=portTable, secondaryDns=secondaryDns, bias=bias, portIndex=portIndex, broadcastsReceived=broadcastsReceived, vendorOui=vendorOui, statisticTable=statisticTable, wan=wan, unicastsReceived=unicastsReceived, staticIpHostName=staticIpHostName, groupid=groupid, vlangroupTable=vlangroupTable, staticIpDomainName=staticIpDomainName, vlan=vlan, staticIpSubMask=staticIpSubMask, qmode=qmode, lanportTable=lanportTable, catvEnable=catvEnable, vlanid=vlanid, qos=qos, modeEntry=modeEntry, fileName=fileName, jumbwan=jumbwan, staticIpSecondaryDns=staticIpSecondaryDns, vendorRev=vendorRev, staticIpGateway=staticIpGateway, port3=port3)
