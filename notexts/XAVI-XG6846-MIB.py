...
# Produced by pysmi-1.1.3 at Thu Dec  9 15:04:52 2021
...
Gauge32, Integer32, ObjectIdentity, MibIdentifier, enterprises, Bits, NotificationType, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, snmpModules, Counter64, Unsigned32, mib_2, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "ObjectIdentity", "MibIdentifier", "enterprises", "Bits", "NotificationType", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "snmpModules", "Counter64", "Unsigned32", "mib-2", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portStatEntry=portStatEntry, multicastsTransmitted=multicastsTransmitted, vendorOui=vendorOui, qosIndex=qosIndex, broadcastsReceived=broadcastsReceived, portPower=portPower, staticIpHostName=staticIpHostName, jumb=jumb, fileName=fileName, fcsErrorReceived=fcsErrorReceived, portmode=portmode, fcsErrorTransmitted=fcsErrorTransmitted, jumblan1=jumblan1, staticIpDomainName=staticIpDomainName, wanType=wanType, tftpSevIp=tftpSevIp, port2=port2, staticIpSecondaryDns=staticIpSecondaryDns, broadcastsTransmitted=broadcastsTransmitted, pauseReceived=pauseReceived, staticIpAddr=staticIpAddr, qmapping=qmapping, adminStatus=adminStatus, vendorRev=vendorRev, qos=qos, speed=speed, action=action, lanportpause=lanportpause, statIndex=statIndex, unicastsReceived=unicastsReceived, port1=port1, temperature=temperature, lan3=lan3, primaryDns=primaryDns, bias=bias, reboot=reboot, xg6846=xg6846, qmode=qmode, rebootEnable=rebootEnable, fileType=fileType, jumblan4=jumblan4, catvEnable=catvEnable, domainame=domainame, portIndex=portIndex, rxPower=rxPower, dscpEnable=dscpEnable, secondaryDns=secondaryDns, internetPort=internetPort, vendorPn=vendorPn, deviceinfo=deviceinfo, groupid=groupid, pauseTransmitted=pauseTransmitted, statisticTable=statisticTable, portTable=portTable, lanportIndex=lanportIndex, txPower=txPower, staticIpPrimaryDns=staticIpPrimaryDns, lan4=lan4, lanportspeed=lanportspeed, lan2=lan2, qosTable=qosTable, portStatistic=portStatistic, hostname=hostname, jumblan3=jumblan3, serialnum=serialnum, portEntry=portEntry, lanportName=lanportName, lanportTable=lanportTable, port4=port4, multicastsReceived=multicastsReceived, staticDns=staticDns, vlanid=vlanid, priority=priority, staticIpGateway=staticIpGateway, ddminfo=ddminfo, catv=catv, lan1=lan1, port3=port3, tftp=tftp, wan=wan, groupIndex=groupIndex, vlan=vlan, unicastsTransmitted=unicastsTransmitted, portName=portName, voltage=voltage, jumbwan=jumbwan, qosEntry=qosEntry, jumblan2=jumblan2, vlangroupTable=vlangroupTable, modeEntry=modeEntry, groupEntry=groupEntry, operStatus=operStatus, vendorName=vendorName, staticIpSubMask=staticIpSubMask)
