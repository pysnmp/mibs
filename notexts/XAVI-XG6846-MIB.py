...
mib_2, IpAddress, Counter64, Unsigned32, TimeTicks, Counter32, Bits, MibIdentifier, snmpModules, enterprises, ModuleIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "IpAddress", "Counter64", "Unsigned32", "TimeTicks", "Counter32", "Bits", "MibIdentifier", "snmpModules", "enterprises", "ModuleIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", groupid=groupid, jumblan3=jumblan3, groupIndex=groupIndex, txPower=txPower, primaryDns=primaryDns, domainame=domainame, qosEntry=qosEntry, portName=portName, qosIndex=qosIndex, operStatus=operStatus, jumbwan=jumbwan, fileType=fileType, statIndex=statIndex, hostname=hostname, unicastsReceived=unicastsReceived, port2=port2, lan1=lan1, staticIpDomainName=staticIpDomainName, fileName=fileName, portEntry=portEntry, staticIpHostName=staticIpHostName, jumblan4=jumblan4, catv=catv, reboot=reboot, lanportName=lanportName, action=action, wanType=wanType, fcsErrorReceived=fcsErrorReceived, qosTable=qosTable, groupEntry=groupEntry, priority=priority, fcsErrorTransmitted=fcsErrorTransmitted, lanportIndex=lanportIndex, port4=port4, bias=bias, modeEntry=modeEntry, vlanid=vlanid, statisticTable=statisticTable, lan3=lan3, vendorOui=vendorOui, staticIpPrimaryDns=staticIpPrimaryDns, xg6846=xg6846, serialnum=serialnum, lan4=lan4, deviceinfo=deviceinfo, pauseReceived=pauseReceived, adminStatus=adminStatus, vendorName=vendorName, lanportspeed=lanportspeed, jumb=jumb, multicastsReceived=multicastsReceived, secondaryDns=secondaryDns, lanportpause=lanportpause, jumblan2=jumblan2, speed=speed, multicastsTransmitted=multicastsTransmitted, lan2=lan2, vendorPn=vendorPn, temperature=temperature, staticIpGateway=staticIpGateway, wan=wan, tftp=tftp, staticIpSubMask=staticIpSubMask, qmode=qmode, dscpEnable=dscpEnable, broadcastsTransmitted=broadcastsTransmitted, internetPort=internetPort, staticDns=staticDns, catvEnable=catvEnable, portStatistic=portStatistic, portStatEntry=portStatEntry, lanportTable=lanportTable, qmapping=qmapping, jumblan1=jumblan1, portmode=portmode, vlan=vlan, portIndex=portIndex, voltage=voltage, staticIpAddr=staticIpAddr, ddminfo=ddminfo, pauseTransmitted=pauseTransmitted, unicastsTransmitted=unicastsTransmitted, tftpSevIp=tftpSevIp, vendorRev=vendorRev, port3=port3, broadcastsReceived=broadcastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, rxPower=rxPower, portTable=portTable, vlangroupTable=vlangroupTable, rebootEnable=rebootEnable, portPower=portPower, port1=port1, qos=qos)
