...
# Produced by pysmi-1.1.8 at Thu Oct 12 08:59:07 2023
...
iso, Unsigned32, enterprises, Counter64, ObjectIdentity, NotificationType, snmpModules, Integer32, MibIdentifier, Gauge32, mib_2, Bits, Counter32, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "enterprises", "Counter64", "ObjectIdentity", "NotificationType", "snmpModules", "Integer32", "MibIdentifier", "Gauge32", "mib-2", "Bits", "Counter32", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", operStatus=operStatus, broadcastsReceived=broadcastsReceived, tftpSevIp=tftpSevIp, jumblan1=jumblan1, qosTable=qosTable, portName=portName, port3=port3, groupIndex=groupIndex, vlan=vlan, fcsErrorReceived=fcsErrorReceived, qosEntry=qosEntry, staticIpAddr=staticIpAddr, ddminfo=ddminfo, portEntry=portEntry, vendorName=vendorName, jumbwan=jumbwan, tftp=tftp, priority=priority, secondaryDns=secondaryDns, serialnum=serialnum, lan2=lan2, qmapping=qmapping, jumblan3=jumblan3, staticIpHostName=staticIpHostName, txPower=txPower, lan1=lan1, catvEnable=catvEnable, action=action, voltage=voltage, portTable=portTable, pauseReceived=pauseReceived, domainame=domainame, statIndex=statIndex, lanportpause=lanportpause, vendorOui=vendorOui, qos=qos, staticIpDomainName=staticIpDomainName, groupid=groupid, lanportspeed=lanportspeed, rebootEnable=rebootEnable, internetPort=internetPort, wan=wan, vendorRev=vendorRev, pauseTransmitted=pauseTransmitted, modeEntry=modeEntry, staticIpSubMask=staticIpSubMask, port2=port2, vlanid=vlanid, portIndex=portIndex, portPower=portPower, qmode=qmode, dscpEnable=dscpEnable, portmode=portmode, staticIpSecondaryDns=staticIpSecondaryDns, statisticTable=statisticTable, multicastsReceived=multicastsReceived, broadcastsTransmitted=broadcastsTransmitted, speed=speed, port1=port1, jumblan4=jumblan4, rxPower=rxPower, adminStatus=adminStatus, jumb=jumb, deviceinfo=deviceinfo, hostname=hostname, staticIpPrimaryDns=staticIpPrimaryDns, staticDns=staticDns, lan4=lan4, jumblan2=jumblan2, unicastsReceived=unicastsReceived, bias=bias, temperature=temperature, reboot=reboot, fileType=fileType, lanportIndex=lanportIndex, groupEntry=groupEntry, staticIpGateway=staticIpGateway, qosIndex=qosIndex, fcsErrorTransmitted=fcsErrorTransmitted, vendorPn=vendorPn, portStatistic=portStatistic, port4=port4, multicastsTransmitted=multicastsTransmitted, catv=catv, wanType=wanType, xg6846=xg6846, unicastsTransmitted=unicastsTransmitted, lanportName=lanportName, fileName=fileName, lanportTable=lanportTable, lan3=lan3, portStatEntry=portStatEntry, primaryDns=primaryDns, vlangroupTable=vlangroupTable)
