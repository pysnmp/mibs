...
# Produced by pysmi-1.1.10 at Thu Oct 26 12:32:42 2023
...
Counter32, Integer32, Bits, Gauge32, MibIdentifier, Unsigned32, enterprises, ModuleIdentity, mib_2, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, snmpModules, IpAddress, NotificationType, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "Bits", "Gauge32", "MibIdentifier", "Unsigned32", "enterprises", "ModuleIdentity", "mib-2", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "snmpModules", "IpAddress", "NotificationType", "iso", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", modeEntry=modeEntry, fileName=fileName, statisticTable=statisticTable, lanportTable=lanportTable, internetPort=internetPort, jumblan3=jumblan3, fcsErrorTransmitted=fcsErrorTransmitted, jumb=jumb, staticIpAddr=staticIpAddr, jumblan2=jumblan2, serialnum=serialnum, rebootEnable=rebootEnable, operStatus=operStatus, vendorOui=vendorOui, deviceinfo=deviceinfo, vlangroupTable=vlangroupTable, hostname=hostname, lan1=lan1, lan4=lan4, multicastsTransmitted=multicastsTransmitted, qos=qos, action=action, groupid=groupid, staticIpPrimaryDns=staticIpPrimaryDns, priority=priority, reboot=reboot, adminStatus=adminStatus, pauseReceived=pauseReceived, pauseTransmitted=pauseTransmitted, portTable=portTable, xg6846=xg6846, temperature=temperature, staticIpSecondaryDns=staticIpSecondaryDns, lan2=lan2, qosEntry=qosEntry, port1=port1, qmapping=qmapping, staticIpGateway=staticIpGateway, portmode=portmode, dscpEnable=dscpEnable, port4=port4, staticIpDomainName=staticIpDomainName, broadcastsTransmitted=broadcastsTransmitted, lanportspeed=lanportspeed, staticIpHostName=staticIpHostName, fileType=fileType, lanportIndex=lanportIndex, lanportName=lanportName, portName=portName, portPower=portPower, jumblan4=jumblan4, groupIndex=groupIndex, portIndex=portIndex, wanType=wanType, portEntry=portEntry, unicastsTransmitted=unicastsTransmitted, txPower=txPower, unicastsReceived=unicastsReceived, wan=wan, tftpSevIp=tftpSevIp, speed=speed, primaryDns=primaryDns, qmode=qmode, qosIndex=qosIndex, vlan=vlan, portStatEntry=portStatEntry, vendorName=vendorName, vendorPn=vendorPn, staticDns=staticDns, broadcastsReceived=broadcastsReceived, statIndex=statIndex, lanportpause=lanportpause, tftp=tftp, jumbwan=jumbwan, fcsErrorReceived=fcsErrorReceived, voltage=voltage, qosTable=qosTable, ddminfo=ddminfo, port3=port3, lan3=lan3, vendorRev=vendorRev, secondaryDns=secondaryDns, jumblan1=jumblan1, groupEntry=groupEntry, multicastsReceived=multicastsReceived, rxPower=rxPower, catv=catv, staticIpSubMask=staticIpSubMask, port2=port2, portStatistic=portStatistic, vlanid=vlanid, domainame=domainame, bias=bias, catvEnable=catvEnable)
