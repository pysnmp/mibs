...
# Produced by pysmi-1.1.8 at Thu Oct 12 09:09:34 2023
...
Counter32, MibIdentifier, iso, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, Unsigned32, snmpModules, NotificationType, Bits, mib_2, ModuleIdentity, Integer32, Counter64, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "iso", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "Unsigned32", "snmpModules", "NotificationType", "Bits", "mib-2", "ModuleIdentity", "Integer32", "Counter64", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", modeEntry=modeEntry, vlan=vlan, bias=bias, staticIpHostName=staticIpHostName, vendorRev=vendorRev, groupIndex=groupIndex, multicastsTransmitted=multicastsTransmitted, lanportIndex=lanportIndex, jumblan1=jumblan1, portName=portName, action=action, qmapping=qmapping, broadcastsReceived=broadcastsReceived, serialnum=serialnum, port2=port2, rebootEnable=rebootEnable, jumblan2=jumblan2, catv=catv, port1=port1, fcsErrorTransmitted=fcsErrorTransmitted, statIndex=statIndex, jumblan3=jumblan3, voltage=voltage, operStatus=operStatus, jumb=jumb, port3=port3, deviceinfo=deviceinfo, portTable=portTable, catvEnable=catvEnable, dscpEnable=dscpEnable, fileType=fileType, portStatistic=portStatistic, lanportName=lanportName, tftp=tftp, pauseTransmitted=pauseTransmitted, portIndex=portIndex, jumblan4=jumblan4, lan4=lan4, primaryDns=primaryDns, wan=wan, ddminfo=ddminfo, groupid=groupid, portStatEntry=portStatEntry, wanType=wanType, fileName=fileName, portEntry=portEntry, staticIpSubMask=staticIpSubMask, unicastsTransmitted=unicastsTransmitted, statisticTable=statisticTable, lanportpause=lanportpause, broadcastsTransmitted=broadcastsTransmitted, unicastsReceived=unicastsReceived, secondaryDns=secondaryDns, txPower=txPower, staticIpDomainName=staticIpDomainName, lanportTable=lanportTable, vendorPn=vendorPn, groupEntry=groupEntry, staticIpGateway=staticIpGateway, lan3=lan3, reboot=reboot, portPower=portPower, staticIpSecondaryDns=staticIpSecondaryDns, hostname=hostname, fcsErrorReceived=fcsErrorReceived, lan2=lan2, priority=priority, pauseReceived=pauseReceived, qosEntry=qosEntry, qosIndex=qosIndex, lanportspeed=lanportspeed, tftpSevIp=tftpSevIp, vlangroupTable=vlangroupTable, temperature=temperature, multicastsReceived=multicastsReceived, adminStatus=adminStatus, domainame=domainame, port4=port4, jumbwan=jumbwan, qmode=qmode, lan1=lan1, internetPort=internetPort, vlanid=vlanid, qosTable=qosTable, portmode=portmode, vendorOui=vendorOui, qos=qos, rxPower=rxPower, vendorName=vendorName, xg6846=xg6846, staticDns=staticDns, staticIpAddr=staticIpAddr, staticIpPrimaryDns=staticIpPrimaryDns, speed=speed)
