...
# Produced by pysmi-1.1.12 at Mon Sep 16 14:57:05 2024
...
Counter64, ObjectIdentity, enterprises, ModuleIdentity, iso, TimeTicks, IpAddress, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, Unsigned32, Bits, snmpModules, MibIdentifier, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "enterprises", "ModuleIdentity", "iso", "TimeTicks", "IpAddress", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "Unsigned32", "Bits", "snmpModules", "MibIdentifier", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portStatEntry=portStatEntry, vlan=vlan, groupEntry=groupEntry, pauseReceived=pauseReceived, jumb=jumb, voltage=voltage, priority=priority, port2=port2, portStatistic=portStatistic, staticIpHostName=staticIpHostName, operStatus=operStatus, lan2=lan2, vendorName=vendorName, statIndex=statIndex, groupid=groupid, unicastsTransmitted=unicastsTransmitted, wan=wan, jumblan1=jumblan1, staticIpSecondaryDns=staticIpSecondaryDns, qosTable=qosTable, domainame=domainame, portTable=portTable, tftp=tftp, qos=qos, catvEnable=catvEnable, lanportIndex=lanportIndex, unicastsReceived=unicastsReceived, internetPort=internetPort, vendorOui=vendorOui, staticDns=staticDns, tftpSevIp=tftpSevIp, temperature=temperature, fileType=fileType, serialnum=serialnum, jumblan2=jumblan2, groupIndex=groupIndex, staticIpSubMask=staticIpSubMask, action=action, bias=bias, portmode=portmode, lanportName=lanportName, deviceinfo=deviceinfo, fileName=fileName, xg6846=xg6846, fcsErrorReceived=fcsErrorReceived, ddminfo=ddminfo, jumbwan=jumbwan, fcsErrorTransmitted=fcsErrorTransmitted, portPower=portPower, port1=port1, lanportspeed=lanportspeed, hostname=hostname, catv=catv, qosIndex=qosIndex, vendorRev=vendorRev, vlanid=vlanid, lan3=lan3, reboot=reboot, vendorPn=vendorPn, primaryDns=primaryDns, multicastsReceived=multicastsReceived, broadcastsTransmitted=broadcastsTransmitted, qosEntry=qosEntry, modeEntry=modeEntry, speed=speed, portIndex=portIndex, adminStatus=adminStatus, jumblan4=jumblan4, statisticTable=statisticTable, lan4=lan4, staticIpGateway=staticIpGateway, vlangroupTable=vlangroupTable, portName=portName, lanportpause=lanportpause, wanType=wanType, rxPower=rxPower, secondaryDns=secondaryDns, port3=port3, txPower=txPower, qmapping=qmapping, lan1=lan1, broadcastsReceived=broadcastsReceived, multicastsTransmitted=multicastsTransmitted, dscpEnable=dscpEnable, port4=port4, portEntry=portEntry, staticIpPrimaryDns=staticIpPrimaryDns, rebootEnable=rebootEnable, jumblan3=jumblan3, pauseTransmitted=pauseTransmitted, qmode=qmode, lanportTable=lanportTable, staticIpDomainName=staticIpDomainName, staticIpAddr=staticIpAddr)
