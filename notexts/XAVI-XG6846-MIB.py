...
ModuleIdentity, snmpModules, TimeTicks, Gauge32, MibIdentifier, Integer32, Counter32, ObjectIdentity, mib_2, Bits, IpAddress, enterprises, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "snmpModules", "TimeTicks", "Gauge32", "MibIdentifier", "Integer32", "Counter32", "ObjectIdentity", "mib-2", "Bits", "IpAddress", "enterprises", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vlan=vlan, rebootEnable=rebootEnable, portName=portName, jumblan3=jumblan3, vlangroupTable=vlangroupTable, temperature=temperature, jumblan1=jumblan1, jumbwan=jumbwan, speed=speed, tftpSevIp=tftpSevIp, lanportName=lanportName, fcsErrorReceived=fcsErrorReceived, lan2=lan2, portEntry=portEntry, staticIpHostName=staticIpHostName, deviceinfo=deviceinfo, groupIndex=groupIndex, qosTable=qosTable, txPower=txPower, staticIpSecondaryDns=staticIpSecondaryDns, secondaryDns=secondaryDns, staticIpPrimaryDns=staticIpPrimaryDns, staticIpDomainName=staticIpDomainName, operStatus=operStatus, domainame=domainame, tftp=tftp, vendorRev=vendorRev, statIndex=statIndex, port1=port1, lan4=lan4, qosIndex=qosIndex, groupid=groupid, portPower=portPower, rxPower=rxPower, port2=port2, staticIpGateway=staticIpGateway, broadcastsReceived=broadcastsReceived, port3=port3, internetPort=internetPort, multicastsReceived=multicastsReceived, vendorOui=vendorOui, modeEntry=modeEntry, pauseTransmitted=pauseTransmitted, wanType=wanType, fcsErrorTransmitted=fcsErrorTransmitted, qos=qos, priority=priority, hostname=hostname, portStatistic=portStatistic, staticIpAddr=staticIpAddr, portIndex=portIndex, qmapping=qmapping, unicastsReceived=unicastsReceived, voltage=voltage, lanportIndex=lanportIndex, pauseReceived=pauseReceived, dscpEnable=dscpEnable, serialnum=serialnum, vendorPn=vendorPn, statisticTable=statisticTable, reboot=reboot, lan3=lan3, lan1=lan1, vendorName=vendorName, portStatEntry=portStatEntry, adminStatus=adminStatus, unicastsTransmitted=unicastsTransmitted, xg6846=xg6846, qmode=qmode, fileType=fileType, catvEnable=catvEnable, fileName=fileName, primaryDns=primaryDns, bias=bias, action=action, staticIpSubMask=staticIpSubMask, multicastsTransmitted=multicastsTransmitted, groupEntry=groupEntry, vlanid=vlanid, lanportpause=lanportpause, portTable=portTable, staticDns=staticDns, portmode=portmode, jumb=jumb, lanportTable=lanportTable, catv=catv, ddminfo=ddminfo, port4=port4, qosEntry=qosEntry, broadcastsTransmitted=broadcastsTransmitted, wan=wan, jumblan2=jumblan2, lanportspeed=lanportspeed, jumblan4=jumblan4)
