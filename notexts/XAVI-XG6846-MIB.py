...
Gauge32, IpAddress, mib_2, enterprises, Integer32, Bits, Counter32, ModuleIdentity, NotificationType, iso, ObjectIdentity, Unsigned32, snmpModules, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "IpAddress", "mib-2", "enterprises", "Integer32", "Bits", "Counter32", "ModuleIdentity", "NotificationType", "iso", "ObjectIdentity", "Unsigned32", "snmpModules", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fcsErrorTransmitted=fcsErrorTransmitted, unicastsTransmitted=unicastsTransmitted, lan3=lan3, portStatistic=portStatistic, fileName=fileName, qmode=qmode, vendorName=vendorName, jumblan4=jumblan4, catvEnable=catvEnable, portName=portName, port4=port4, voltage=voltage, ddminfo=ddminfo, adminStatus=adminStatus, temperature=temperature, staticIpSecondaryDns=staticIpSecondaryDns, portTable=portTable, lanportpause=lanportpause, broadcastsReceived=broadcastsReceived, tftpSevIp=tftpSevIp, groupEntry=groupEntry, lanportIndex=lanportIndex, jumb=jumb, staticIpSubMask=staticIpSubMask, vlangroupTable=vlangroupTable, statisticTable=statisticTable, hostname=hostname, vendorPn=vendorPn, speed=speed, wanType=wanType, port1=port1, staticIpAddr=staticIpAddr, vlan=vlan, vlanid=vlanid, staticIpPrimaryDns=staticIpPrimaryDns, qos=qos, fileType=fileType, broadcastsTransmitted=broadcastsTransmitted, statIndex=statIndex, jumblan1=jumblan1, operStatus=operStatus, lanportspeed=lanportspeed, bias=bias, portStatEntry=portStatEntry, vendorOui=vendorOui, reboot=reboot, modeEntry=modeEntry, portEntry=portEntry, jumblan2=jumblan2, staticIpGateway=staticIpGateway, lan2=lan2, groupIndex=groupIndex, rebootEnable=rebootEnable, rxPower=rxPower, action=action, staticIpDomainName=staticIpDomainName, qmapping=qmapping, multicastsTransmitted=multicastsTransmitted, tftp=tftp, jumbwan=jumbwan, port2=port2, staticDns=staticDns, dscpEnable=dscpEnable, lanportName=lanportName, wan=wan, multicastsReceived=multicastsReceived, secondaryDns=secondaryDns, primaryDns=primaryDns, portPower=portPower, portmode=portmode, lan4=lan4, qosEntry=qosEntry, vendorRev=vendorRev, staticIpHostName=staticIpHostName, unicastsReceived=unicastsReceived, port3=port3, lanportTable=lanportTable, xg6846=xg6846, qosIndex=qosIndex, catv=catv, internetPort=internetPort, pauseReceived=pauseReceived, lan1=lan1, fcsErrorReceived=fcsErrorReceived, qosTable=qosTable, priority=priority, domainame=domainame, deviceinfo=deviceinfo, pauseTransmitted=pauseTransmitted, serialnum=serialnum, jumblan3=jumblan3, portIndex=portIndex, txPower=txPower, groupid=groupid)
