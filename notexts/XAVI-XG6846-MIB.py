...
# Produced by pysmi-1.1.8 at Fri Jan  7 00:27:51 2022
...
Counter64, enterprises, Gauge32, NotificationType, mib_2, Unsigned32, IpAddress, ModuleIdentity, Counter32, TimeTicks, Integer32, snmpModules, Bits, ObjectIdentity, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "enterprises", "Gauge32", "NotificationType", "mib-2", "Unsigned32", "IpAddress", "ModuleIdentity", "Counter32", "TimeTicks", "Integer32", "snmpModules", "Bits", "ObjectIdentity", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", pauseReceived=pauseReceived, staticIpDomainName=staticIpDomainName, multicastsTransmitted=multicastsTransmitted, port2=port2, qmapping=qmapping, primaryDns=primaryDns, speed=speed, jumbwan=jumbwan, broadcastsTransmitted=broadcastsTransmitted, lanportIndex=lanportIndex, port1=port1, fileName=fileName, dscpEnable=dscpEnable, unicastsReceived=unicastsReceived, serialnum=serialnum, lanportName=lanportName, portmode=portmode, statIndex=statIndex, operStatus=operStatus, jumblan2=jumblan2, lan3=lan3, staticIpAddr=staticIpAddr, qos=qos, action=action, groupIndex=groupIndex, staticIpSubMask=staticIpSubMask, vlan=vlan, rebootEnable=rebootEnable, vendorRev=vendorRev, port3=port3, lan4=lan4, tftpSevIp=tftpSevIp, modeEntry=modeEntry, voltage=voltage, groupid=groupid, fcsErrorTransmitted=fcsErrorTransmitted, portStatistic=portStatistic, temperature=temperature, unicastsTransmitted=unicastsTransmitted, fileType=fileType, deviceinfo=deviceinfo, catvEnable=catvEnable, vendorPn=vendorPn, groupEntry=groupEntry, catv=catv, qosEntry=qosEntry, reboot=reboot, rxPower=rxPower, priority=priority, staticIpPrimaryDns=staticIpPrimaryDns, portIndex=portIndex, domainame=domainame, tftp=tftp, jumblan4=jumblan4, wan=wan, xg6846=xg6846, hostname=hostname, staticIpSecondaryDns=staticIpSecondaryDns, multicastsReceived=multicastsReceived, portTable=portTable, jumblan3=jumblan3, portStatEntry=portStatEntry, portEntry=portEntry, ddminfo=ddminfo, qmode=qmode, staticIpHostName=staticIpHostName, portPower=portPower, qosIndex=qosIndex, vlangroupTable=vlangroupTable, broadcastsReceived=broadcastsReceived, vlanid=vlanid, adminStatus=adminStatus, port4=port4, bias=bias, secondaryDns=secondaryDns, lanportpause=lanportpause, jumblan1=jumblan1, portName=portName, lanportspeed=lanportspeed, fcsErrorReceived=fcsErrorReceived, staticIpGateway=staticIpGateway, vendorName=vendorName, lan2=lan2, txPower=txPower, jumb=jumb, pauseTransmitted=pauseTransmitted, vendorOui=vendorOui, statisticTable=statisticTable, wanType=wanType, lan1=lan1, staticDns=staticDns, lanportTable=lanportTable, internetPort=internetPort, qosTable=qosTable)
