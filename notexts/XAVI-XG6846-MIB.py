...
# Produced by pysmi-1.1.8 at Wed Sep  6 13:33:53 2023
...
ModuleIdentity, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Integer32, Counter64, ObjectIdentity, IpAddress, Unsigned32, MibIdentifier, NotificationType, mib_2, iso, TimeTicks, Bits, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Integer32", "Counter64", "ObjectIdentity", "IpAddress", "Unsigned32", "MibIdentifier", "NotificationType", "mib-2", "iso", "TimeTicks", "Bits", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", broadcastsTransmitted=broadcastsTransmitted, vlan=vlan, modeEntry=modeEntry, jumblan3=jumblan3, port4=port4, portName=portName, pauseTransmitted=pauseTransmitted, lan1=lan1, staticIpHostName=staticIpHostName, priority=priority, internetPort=internetPort, lanportpause=lanportpause, txPower=txPower, portPower=portPower, tftp=tftp, portmode=portmode, lanportTable=lanportTable, catvEnable=catvEnable, groupid=groupid, ddminfo=ddminfo, speed=speed, unicastsReceived=unicastsReceived, groupEntry=groupEntry, lan4=lan4, jumb=jumb, port3=port3, portTable=portTable, multicastsReceived=multicastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, secondaryDns=secondaryDns, serialnum=serialnum, lan2=lan2, broadcastsReceived=broadcastsReceived, unicastsTransmitted=unicastsTransmitted, staticDns=staticDns, lan3=lan3, statIndex=statIndex, catv=catv, jumblan2=jumblan2, port1=port1, jumbwan=jumbwan, vendorName=vendorName, jumblan4=jumblan4, portStatistic=portStatistic, fileType=fileType, operStatus=operStatus, bias=bias, qosTable=qosTable, staticIpSecondaryDns=staticIpSecondaryDns, vendorPn=vendorPn, pauseReceived=pauseReceived, vendorOui=vendorOui, temperature=temperature, wanType=wanType, rxPower=rxPower, tftpSevIp=tftpSevIp, staticIpSubMask=staticIpSubMask, lanportspeed=lanportspeed, port2=port2, portStatEntry=portStatEntry, qosEntry=qosEntry, qmode=qmode, qos=qos, deviceinfo=deviceinfo, wan=wan, portEntry=portEntry, staticIpGateway=staticIpGateway, vendorRev=vendorRev, vlanid=vlanid, fileName=fileName, hostname=hostname, rebootEnable=rebootEnable, qmapping=qmapping, primaryDns=primaryDns, xg6846=xg6846, dscpEnable=dscpEnable, qosIndex=qosIndex, reboot=reboot, lanportIndex=lanportIndex, groupIndex=groupIndex, adminStatus=adminStatus, domainame=domainame, lanportName=lanportName, portIndex=portIndex, staticIpAddr=staticIpAddr, vlangroupTable=vlangroupTable, fcsErrorReceived=fcsErrorReceived, voltage=voltage, action=action, staticIpDomainName=staticIpDomainName, multicastsTransmitted=multicastsTransmitted, statisticTable=statisticTable, jumblan1=jumblan1)
