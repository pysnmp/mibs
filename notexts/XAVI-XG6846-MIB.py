...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:06:14 2023
...
ModuleIdentity, Integer32, NotificationType, snmpModules, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, enterprises, Gauge32, Counter32, iso, Unsigned32, Counter64, TimeTicks, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "NotificationType", "snmpModules", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "enterprises", "Gauge32", "Counter32", "iso", "Unsigned32", "Counter64", "TimeTicks", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fileType=fileType, jumblan4=jumblan4, multicastsTransmitted=multicastsTransmitted, temperature=temperature, reboot=reboot, xg6846=xg6846, vendorName=vendorName, portmode=portmode, lanportpause=lanportpause, portIndex=portIndex, lanportName=lanportName, lan1=lan1, vlanid=vlanid, speed=speed, adminStatus=adminStatus, lanportTable=lanportTable, catv=catv, vendorOui=vendorOui, lan3=lan3, operStatus=operStatus, hostname=hostname, groupEntry=groupEntry, groupid=groupid, unicastsTransmitted=unicastsTransmitted, jumblan1=jumblan1, txPower=txPower, portEntry=portEntry, staticIpGateway=staticIpGateway, qosIndex=qosIndex, groupIndex=groupIndex, fcsErrorTransmitted=fcsErrorTransmitted, tftp=tftp, unicastsReceived=unicastsReceived, portName=portName, staticDns=staticDns, portTable=portTable, qmapping=qmapping, lanportIndex=lanportIndex, priority=priority, statisticTable=statisticTable, portStatEntry=portStatEntry, staticIpHostName=staticIpHostName, domainame=domainame, port1=port1, lan4=lan4, action=action, secondaryDns=secondaryDns, port4=port4, qosTable=qosTable, deviceinfo=deviceinfo, jumblan3=jumblan3, primaryDns=primaryDns, qosEntry=qosEntry, multicastsReceived=multicastsReceived, broadcastsTransmitted=broadcastsTransmitted, jumblan2=jumblan2, qos=qos, pauseTransmitted=pauseTransmitted, rxPower=rxPower, vlangroupTable=vlangroupTable, staticIpPrimaryDns=staticIpPrimaryDns, ddminfo=ddminfo, internetPort=internetPort, tftpSevIp=tftpSevIp, staticIpDomainName=staticIpDomainName, fileName=fileName, broadcastsReceived=broadcastsReceived, pauseReceived=pauseReceived, staticIpSecondaryDns=staticIpSecondaryDns, wanType=wanType, statIndex=statIndex, fcsErrorReceived=fcsErrorReceived, staticIpSubMask=staticIpSubMask, port3=port3, rebootEnable=rebootEnable, jumb=jumb, qmode=qmode, vlan=vlan, lanportspeed=lanportspeed, staticIpAddr=staticIpAddr, vendorPn=vendorPn, portPower=portPower, port2=port2, portStatistic=portStatistic, modeEntry=modeEntry, lan2=lan2, serialnum=serialnum, bias=bias, dscpEnable=dscpEnable, jumbwan=jumbwan, catvEnable=catvEnable, voltage=voltage, wan=wan, vendorRev=vendorRev)
