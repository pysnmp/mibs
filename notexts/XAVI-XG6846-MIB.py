...
Counter64, ObjectIdentity, Unsigned32, iso, NotificationType, snmpModules, IpAddress, enterprises, Bits, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, ModuleIdentity, Counter32, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "Unsigned32", "iso", "NotificationType", "snmpModules", "IpAddress", "enterprises", "Bits", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "ModuleIdentity", "Counter32", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fcsErrorTransmitted=fcsErrorTransmitted, secondaryDns=secondaryDns, staticIpSecondaryDns=staticIpSecondaryDns, multicastsTransmitted=multicastsTransmitted, lan2=lan2, vendorPn=vendorPn, port2=port2, modeEntry=modeEntry, qosIndex=qosIndex, vlan=vlan, wanType=wanType, portName=portName, statisticTable=statisticTable, adminStatus=adminStatus, unicastsReceived=unicastsReceived, hostname=hostname, priority=priority, portStatEntry=portStatEntry, staticDns=staticDns, rebootEnable=rebootEnable, broadcastsReceived=broadcastsReceived, staticIpHostName=staticIpHostName, vendorName=vendorName, xg6846=xg6846, domainame=domainame, lanportIndex=lanportIndex, voltage=voltage, ddminfo=ddminfo, lanportName=lanportName, jumblan3=jumblan3, jumblan2=jumblan2, qmode=qmode, statIndex=statIndex, fileName=fileName, broadcastsTransmitted=broadcastsTransmitted, lanportpause=lanportpause, portTable=portTable, pauseReceived=pauseReceived, port1=port1, port4=port4, portEntry=portEntry, pauseTransmitted=pauseTransmitted, fcsErrorReceived=fcsErrorReceived, catvEnable=catvEnable, tftp=tftp, groupEntry=groupEntry, multicastsReceived=multicastsReceived, jumbwan=jumbwan, temperature=temperature, staticIpAddr=staticIpAddr, vlanid=vlanid, portPower=portPower, wan=wan, speed=speed, lanportTable=lanportTable, jumb=jumb, unicastsTransmitted=unicastsTransmitted, staticIpGateway=staticIpGateway, jumblan4=jumblan4, reboot=reboot, dscpEnable=dscpEnable, qmapping=qmapping, staticIpSubMask=staticIpSubMask, catv=catv, lan3=lan3, portStatistic=portStatistic, vendorOui=vendorOui, operStatus=operStatus, port3=port3, lanportspeed=lanportspeed, qosEntry=qosEntry, staticIpDomainName=staticIpDomainName, rxPower=rxPower, qosTable=qosTable, action=action, vlangroupTable=vlangroupTable, tftpSevIp=tftpSevIp, serialnum=serialnum, portmode=portmode, txPower=txPower, lan4=lan4, groupIndex=groupIndex, staticIpPrimaryDns=staticIpPrimaryDns, jumblan1=jumblan1, portIndex=portIndex, fileType=fileType, primaryDns=primaryDns, qos=qos, groupid=groupid, bias=bias, vendorRev=vendorRev, internetPort=internetPort, lan1=lan1, deviceinfo=deviceinfo)
