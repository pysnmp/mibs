...
# Produced by pysmi-1.1.12 at Mon Jun  3 14:04:36 2024
...
Gauge32, Counter32, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, IpAddress, ModuleIdentity, snmpModules, Integer32, mib_2, Bits, ObjectIdentity, enterprises, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "IpAddress", "ModuleIdentity", "snmpModules", "Integer32", "mib-2", "Bits", "ObjectIdentity", "enterprises", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumblan2=jumblan2, staticIpPrimaryDns=staticIpPrimaryDns, reboot=reboot, tftp=tftp, qosTable=qosTable, qmode=qmode, secondaryDns=secondaryDns, portTable=portTable, portPower=portPower, lan2=lan2, tftpSevIp=tftpSevIp, jumb=jumb, multicastsTransmitted=multicastsTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, bias=bias, catvEnable=catvEnable, jumblan1=jumblan1, jumblan4=jumblan4, temperature=temperature, serialnum=serialnum, speed=speed, primaryDns=primaryDns, staticIpSubMask=staticIpSubMask, vlan=vlan, port2=port2, ddminfo=ddminfo, groupid=groupid, fcsErrorReceived=fcsErrorReceived, deviceinfo=deviceinfo, portmode=portmode, statIndex=statIndex, vlanid=vlanid, operStatus=operStatus, unicastsTransmitted=unicastsTransmitted, wanType=wanType, broadcastsReceived=broadcastsReceived, voltage=voltage, xg6846=xg6846, staticIpAddr=staticIpAddr, hostname=hostname, pauseReceived=pauseReceived, staticIpGateway=staticIpGateway, port4=port4, vendorName=vendorName, port1=port1, wan=wan, staticIpHostName=staticIpHostName, fileName=fileName, groupEntry=groupEntry, fcsErrorTransmitted=fcsErrorTransmitted, lanportTable=lanportTable, internetPort=internetPort, jumblan3=jumblan3, priority=priority, unicastsReceived=unicastsReceived, vendorRev=vendorRev, qos=qos, rxPower=rxPower, portEntry=portEntry, portIndex=portIndex, groupIndex=groupIndex, vlangroupTable=vlangroupTable, vendorOui=vendorOui, lanportName=lanportName, adminStatus=adminStatus, broadcastsTransmitted=broadcastsTransmitted, rebootEnable=rebootEnable, port3=port3, pauseTransmitted=pauseTransmitted, domainame=domainame, lan3=lan3, portStatEntry=portStatEntry, qmapping=qmapping, statisticTable=statisticTable, lan1=lan1, portName=portName, catv=catv, jumbwan=jumbwan, modeEntry=modeEntry, dscpEnable=dscpEnable, txPower=txPower, multicastsReceived=multicastsReceived, staticDns=staticDns, vendorPn=vendorPn, qosEntry=qosEntry, fileType=fileType, action=action, lanportpause=lanportpause, lanportIndex=lanportIndex, qosIndex=qosIndex, lanportspeed=lanportspeed, lan4=lan4, portStatistic=portStatistic, staticIpDomainName=staticIpDomainName)
