...
# Produced by pysmi-1.1.3 at Sun Nov 28 19:24:29 2021
...
Counter64, NotificationType, ObjectIdentity, Unsigned32, Integer32, MibIdentifier, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, snmpModules, ModuleIdentity, Bits, IpAddress, enterprises, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "ObjectIdentity", "Unsigned32", "Integer32", "MibIdentifier", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "snmpModules", "ModuleIdentity", "Bits", "IpAddress", "enterprises", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", broadcastsReceived=broadcastsReceived, rebootEnable=rebootEnable, vendorName=vendorName, qmapping=qmapping, jumblan4=jumblan4, jumblan1=jumblan1, fcsErrorReceived=fcsErrorReceived, lan2=lan2, staticIpDomainName=staticIpDomainName, portIndex=portIndex, lanportpause=lanportpause, staticIpPrimaryDns=staticIpPrimaryDns, primaryDns=primaryDns, lan1=lan1, fileName=fileName, bias=bias, portStatistic=portStatistic, domainame=domainame, serialnum=serialnum, portEntry=portEntry, fileType=fileType, adminStatus=adminStatus, ddminfo=ddminfo, speed=speed, jumblan2=jumblan2, modeEntry=modeEntry, pauseTransmitted=pauseTransmitted, portName=portName, secondaryDns=secondaryDns, txPower=txPower, jumbwan=jumbwan, lanportName=lanportName, fcsErrorTransmitted=fcsErrorTransmitted, portmode=portmode, unicastsReceived=unicastsReceived, tftp=tftp, qmode=qmode, lan4=lan4, port2=port2, action=action, lan3=lan3, deviceinfo=deviceinfo, priority=priority, statIndex=statIndex, operStatus=operStatus, qosEntry=qosEntry, hostname=hostname, portStatEntry=portStatEntry, xg6846=xg6846, multicastsTransmitted=multicastsTransmitted, vendorPn=vendorPn, tftpSevIp=tftpSevIp, portTable=portTable, groupEntry=groupEntry, vlangroupTable=vlangroupTable, jumblan3=jumblan3, vendorOui=vendorOui, rxPower=rxPower, vlan=vlan, staticIpGateway=staticIpGateway, groupid=groupid, jumb=jumb, staticIpSecondaryDns=staticIpSecondaryDns, wan=wan, vendorRev=vendorRev, lanportIndex=lanportIndex, wanType=wanType, statisticTable=statisticTable, qos=qos, staticIpAddr=staticIpAddr, internetPort=internetPort, temperature=temperature, unicastsTransmitted=unicastsTransmitted, qosIndex=qosIndex, voltage=voltage, lanportspeed=lanportspeed, staticIpHostName=staticIpHostName, groupIndex=groupIndex, reboot=reboot, port4=port4, catvEnable=catvEnable, multicastsReceived=multicastsReceived, staticDns=staticDns, pauseReceived=pauseReceived, lanportTable=lanportTable, qosTable=qosTable, portPower=portPower, vlanid=vlanid, catv=catv, staticIpSubMask=staticIpSubMask, broadcastsTransmitted=broadcastsTransmitted, port1=port1, port3=port3, dscpEnable=dscpEnable)
