...
# Produced by pysmi-1.1.12 at Tue May 28 12:37:04 2024
...
ModuleIdentity, enterprises, Counter64, Gauge32, Counter32, ObjectIdentity, IpAddress, mib_2, iso, snmpModules, Integer32, MibIdentifier, NotificationType, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "Counter64", "Gauge32", "Counter32", "ObjectIdentity", "IpAddress", "mib-2", "iso", "snmpModules", "Integer32", "MibIdentifier", "NotificationType", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", reboot=reboot, qmode=qmode, staticIpPrimaryDns=staticIpPrimaryDns, qmapping=qmapping, port2=port2, jumblan4=jumblan4, catv=catv, lan4=lan4, lan3=lan3, operStatus=operStatus, vendorOui=vendorOui, xg6846=xg6846, txPower=txPower, qosEntry=qosEntry, statIndex=statIndex, broadcastsReceived=broadcastsReceived, groupIndex=groupIndex, groupid=groupid, rxPower=rxPower, rebootEnable=rebootEnable, temperature=temperature, lan2=lan2, vendorPn=vendorPn, wanType=wanType, jumblan2=jumblan2, port1=port1, serialnum=serialnum, jumbwan=jumbwan, staticIpDomainName=staticIpDomainName, portmode=portmode, broadcastsTransmitted=broadcastsTransmitted, tftpSevIp=tftpSevIp, staticIpSecondaryDns=staticIpSecondaryDns, portStatEntry=portStatEntry, priority=priority, vlangroupTable=vlangroupTable, lan1=lan1, unicastsReceived=unicastsReceived, jumblan3=jumblan3, portIndex=portIndex, voltage=voltage, lanportspeed=lanportspeed, port4=port4, domainame=domainame, portTable=portTable, statisticTable=statisticTable, staticIpHostName=staticIpHostName, bias=bias, staticIpGateway=staticIpGateway, secondaryDns=secondaryDns, vlan=vlan, portName=portName, lanportIndex=lanportIndex, staticIpAddr=staticIpAddr, lanportName=lanportName, jumblan1=jumblan1, port3=port3, lanportTable=lanportTable, groupEntry=groupEntry, lanportpause=lanportpause, vlanid=vlanid, jumb=jumb, pauseTransmitted=pauseTransmitted, fcsErrorReceived=fcsErrorReceived, unicastsTransmitted=unicastsTransmitted, fileName=fileName, fileType=fileType, tftp=tftp, vendorName=vendorName, action=action, catvEnable=catvEnable, speed=speed, adminStatus=adminStatus, portPower=portPower, primaryDns=primaryDns, pauseReceived=pauseReceived, staticIpSubMask=staticIpSubMask, deviceinfo=deviceinfo, multicastsReceived=multicastsReceived, qosIndex=qosIndex, modeEntry=modeEntry, dscpEnable=dscpEnable, staticDns=staticDns, vendorRev=vendorRev, qos=qos, hostname=hostname, multicastsTransmitted=multicastsTransmitted, fcsErrorTransmitted=fcsErrorTransmitted, internetPort=internetPort, wan=wan, portStatistic=portStatistic, qosTable=qosTable, portEntry=portEntry, ddminfo=ddminfo)
