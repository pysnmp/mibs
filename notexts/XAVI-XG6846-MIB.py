...
# Produced by pysmi-1.1.3 at Wed Dec  1 16:31:50 2021
...
NotificationType, Gauge32, mib_2, ObjectIdentity, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, snmpModules, iso, TimeTicks, Counter32, Integer32, ModuleIdentity, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "mib-2", "ObjectIdentity", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "snmpModules", "iso", "TimeTicks", "Counter32", "Integer32", "ModuleIdentity", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", secondaryDns=secondaryDns, lan1=lan1, jumb=jumb, port3=port3, portName=portName, pauseReceived=pauseReceived, fcsErrorTransmitted=fcsErrorTransmitted, catv=catv, vendorPn=vendorPn, lanportpause=lanportpause, lan2=lan2, portStatistic=portStatistic, vlangroupTable=vlangroupTable, txPower=txPower, vendorName=vendorName, fileType=fileType, tftp=tftp, action=action, unicastsTransmitted=unicastsTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, staticIpSubMask=staticIpSubMask, ddminfo=ddminfo, jumblan2=jumblan2, bias=bias, jumblan3=jumblan3, lan4=lan4, multicastsReceived=multicastsReceived, wanType=wanType, staticIpGateway=staticIpGateway, statisticTable=statisticTable, reboot=reboot, catvEnable=catvEnable, portPower=portPower, staticIpDomainName=staticIpDomainName, fcsErrorReceived=fcsErrorReceived, pauseTransmitted=pauseTransmitted, port4=port4, vlan=vlan, broadcastsTransmitted=broadcastsTransmitted, groupEntry=groupEntry, unicastsReceived=unicastsReceived, portIndex=portIndex, primaryDns=primaryDns, rebootEnable=rebootEnable, lanportIndex=lanportIndex, priority=priority, fileName=fileName, speed=speed, qosTable=qosTable, vendorOui=vendorOui, portmode=portmode, jumblan1=jumblan1, lanportName=lanportName, portStatEntry=portStatEntry, jumbwan=jumbwan, staticIpAddr=staticIpAddr, jumblan4=jumblan4, staticIpSecondaryDns=staticIpSecondaryDns, rxPower=rxPower, qosEntry=qosEntry, deviceinfo=deviceinfo, groupIndex=groupIndex, multicastsTransmitted=multicastsTransmitted, qmapping=qmapping, portTable=portTable, adminStatus=adminStatus, voltage=voltage, lanportTable=lanportTable, domainame=domainame, lan3=lan3, dscpEnable=dscpEnable, staticIpHostName=staticIpHostName, wan=wan, xg6846=xg6846, temperature=temperature, hostname=hostname, vendorRev=vendorRev, operStatus=operStatus, serialnum=serialnum, qmode=qmode, qos=qos, broadcastsReceived=broadcastsReceived, port1=port1, portEntry=portEntry, vlanid=vlanid, port2=port2, qosIndex=qosIndex, lanportspeed=lanportspeed, modeEntry=modeEntry, statIndex=statIndex, tftpSevIp=tftpSevIp, internetPort=internetPort, groupid=groupid, staticDns=staticDns)
