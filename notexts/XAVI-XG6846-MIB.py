...
# Produced by pysmi-1.1.8 at Thu Sep  7 10:18:30 2023
...
Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, ModuleIdentity, Gauge32, Counter32, Integer32, enterprises, ObjectIdentity, iso, NotificationType, snmpModules, TimeTicks, MibIdentifier, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "ModuleIdentity", "Gauge32", "Counter32", "Integer32", "enterprises", "ObjectIdentity", "iso", "NotificationType", "snmpModules", "TimeTicks", "MibIdentifier", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumblan1=jumblan1, priority=priority, portmode=portmode, internetPort=internetPort, operStatus=operStatus, broadcastsReceived=broadcastsReceived, unicastsReceived=unicastsReceived, port2=port2, broadcastsTransmitted=broadcastsTransmitted, tftpSevIp=tftpSevIp, temperature=temperature, dscpEnable=dscpEnable, staticIpDomainName=staticIpDomainName, jumbwan=jumbwan, lan2=lan2, domainame=domainame, multicastsTransmitted=multicastsTransmitted, rebootEnable=rebootEnable, vendorOui=vendorOui, vendorRev=vendorRev, jumblan4=jumblan4, lan4=lan4, catv=catv, lan1=lan1, groupIndex=groupIndex, staticIpSubMask=staticIpSubMask, vlangroupTable=vlangroupTable, primaryDns=primaryDns, ddminfo=ddminfo, lanportpause=lanportpause, portStatEntry=portStatEntry, staticDns=staticDns, port4=port4, lanportspeed=lanportspeed, deviceinfo=deviceinfo, port3=port3, fileName=fileName, wan=wan, vlanid=vlanid, vendorPn=vendorPn, reboot=reboot, fcsErrorTransmitted=fcsErrorTransmitted, bias=bias, qosEntry=qosEntry, jumblan2=jumblan2, qmode=qmode, secondaryDns=secondaryDns, lanportTable=lanportTable, groupid=groupid, statIndex=statIndex, speed=speed, staticIpGateway=staticIpGateway, qosTable=qosTable, groupEntry=groupEntry, xg6846=xg6846, txPower=txPower, portEntry=portEntry, staticIpSecondaryDns=staticIpSecondaryDns, fileType=fileType, statisticTable=statisticTable, port1=port1, staticIpPrimaryDns=staticIpPrimaryDns, lan3=lan3, serialnum=serialnum, vlan=vlan, fcsErrorReceived=fcsErrorReceived, multicastsReceived=multicastsReceived, modeEntry=modeEntry, lanportName=lanportName, portIndex=portIndex, rxPower=rxPower, wanType=wanType, voltage=voltage, jumblan3=jumblan3, qosIndex=qosIndex, catvEnable=catvEnable, qos=qos, jumb=jumb, portTable=portTable, qmapping=qmapping, hostname=hostname, staticIpHostName=staticIpHostName, action=action, staticIpAddr=staticIpAddr, pauseTransmitted=pauseTransmitted, adminStatus=adminStatus, portStatistic=portStatistic, tftp=tftp, lanportIndex=lanportIndex, pauseReceived=pauseReceived, vendorName=vendorName, portName=portName, unicastsTransmitted=unicastsTransmitted, portPower=portPower)
