...
snmpModules, Bits, ObjectIdentity, TimeTicks, NotificationType, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, Counter64, Unsigned32, enterprises, Gauge32, Counter32, mib_2, iso = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "Bits", "ObjectIdentity", "TimeTicks", "NotificationType", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "Counter64", "Unsigned32", "enterprises", "Gauge32", "Counter32", "mib-2", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", statisticTable=statisticTable, staticIpPrimaryDns=staticIpPrimaryDns, operStatus=operStatus, hostname=hostname, jumb=jumb, lan3=lan3, multicastsTransmitted=multicastsTransmitted, staticIpDomainName=staticIpDomainName, lan1=lan1, port1=port1, staticIpGateway=staticIpGateway, jumblan4=jumblan4, multicastsReceived=multicastsReceived, qosEntry=qosEntry, dscpEnable=dscpEnable, jumbwan=jumbwan, portmode=portmode, deviceinfo=deviceinfo, vlan=vlan, speed=speed, vlanid=vlanid, staticIpSubMask=staticIpSubMask, port3=port3, txPower=txPower, catv=catv, action=action, vendorName=vendorName, lanportTable=lanportTable, vendorPn=vendorPn, portStatistic=portStatistic, ddminfo=ddminfo, vlangroupTable=vlangroupTable, tftp=tftp, rebootEnable=rebootEnable, fcsErrorReceived=fcsErrorReceived, primaryDns=primaryDns, portIndex=portIndex, voltage=voltage, lan4=lan4, catvEnable=catvEnable, wan=wan, portStatEntry=portStatEntry, port2=port2, port4=port4, modeEntry=modeEntry, lanportspeed=lanportspeed, wanType=wanType, staticDns=staticDns, bias=bias, groupEntry=groupEntry, xg6846=xg6846, portName=portName, domainame=domainame, broadcastsTransmitted=broadcastsTransmitted, portTable=portTable, fileName=fileName, adminStatus=adminStatus, unicastsTransmitted=unicastsTransmitted, reboot=reboot, qmode=qmode, fileType=fileType, pauseReceived=pauseReceived, unicastsReceived=unicastsReceived, jumblan3=jumblan3, statIndex=statIndex, jumblan1=jumblan1, portPower=portPower, jumblan2=jumblan2, internetPort=internetPort, lanportIndex=lanportIndex, portEntry=portEntry, lanportName=lanportName, pauseTransmitted=pauseTransmitted, lan2=lan2, tftpSevIp=tftpSevIp, serialnum=serialnum, groupIndex=groupIndex, fcsErrorTransmitted=fcsErrorTransmitted, vendorOui=vendorOui, staticIpSecondaryDns=staticIpSecondaryDns, broadcastsReceived=broadcastsReceived, qos=qos, qosTable=qosTable, groupid=groupid, secondaryDns=secondaryDns, lanportpause=lanportpause, qosIndex=qosIndex, qmapping=qmapping, staticIpAddr=staticIpAddr, temperature=temperature, vendorRev=vendorRev, priority=priority, staticIpHostName=staticIpHostName, rxPower=rxPower)
