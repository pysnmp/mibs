...
Gauge32, enterprises, mib_2, Integer32, TimeTicks, NotificationType, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, snmpModules, iso, Bits, ModuleIdentity, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "mib-2", "Integer32", "TimeTicks", "NotificationType", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "snmpModules", "iso", "Bits", "ModuleIdentity", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", catv=catv, multicastsTransmitted=multicastsTransmitted, deviceinfo=deviceinfo, jumb=jumb, dscpEnable=dscpEnable, jumblan3=jumblan3, unicastsReceived=unicastsReceived, txPower=txPower, staticIpHostName=staticIpHostName, staticIpDomainName=staticIpDomainName, qosTable=qosTable, tftp=tftp, operStatus=operStatus, fileName=fileName, fileType=fileType, lanportName=lanportName, vendorRev=vendorRev, groupIndex=groupIndex, pauseReceived=pauseReceived, internetPort=internetPort, jumblan2=jumblan2, vlangroupTable=vlangroupTable, action=action, lan1=lan1, portEntry=portEntry, staticDns=staticDns, staticIpPrimaryDns=staticIpPrimaryDns, multicastsReceived=multicastsReceived, qosIndex=qosIndex, catvEnable=catvEnable, port3=port3, adminStatus=adminStatus, lan2=lan2, reboot=reboot, portmode=portmode, vlanid=vlanid, groupEntry=groupEntry, broadcastsTransmitted=broadcastsTransmitted, qmapping=qmapping, serialnum=serialnum, vendorPn=vendorPn, rxPower=rxPower, lanportspeed=lanportspeed, unicastsTransmitted=unicastsTransmitted, speed=speed, bias=bias, lan4=lan4, port4=port4, portIndex=portIndex, staticIpGateway=staticIpGateway, broadcastsReceived=broadcastsReceived, staticIpAddr=staticIpAddr, voltage=voltage, lanportTable=lanportTable, lanportIndex=lanportIndex, portName=portName, port1=port1, wanType=wanType, portTable=portTable, fcsErrorTransmitted=fcsErrorTransmitted, hostname=hostname, wan=wan, vendorOui=vendorOui, portStatistic=portStatistic, qos=qos, portStatEntry=portStatEntry, priority=priority, pauseTransmitted=pauseTransmitted, xg6846=xg6846, qmode=qmode, statIndex=statIndex, jumbwan=jumbwan, tftpSevIp=tftpSevIp, lan3=lan3, temperature=temperature, vendorName=vendorName, staticIpSecondaryDns=staticIpSecondaryDns, secondaryDns=secondaryDns, primaryDns=primaryDns, portPower=portPower, statisticTable=statisticTable, port2=port2, rebootEnable=rebootEnable, ddminfo=ddminfo, staticIpSubMask=staticIpSubMask, jumblan4=jumblan4, jumblan1=jumblan1, lanportpause=lanportpause, domainame=domainame, fcsErrorReceived=fcsErrorReceived, modeEntry=modeEntry, vlan=vlan, groupid=groupid, qosEntry=qosEntry)
