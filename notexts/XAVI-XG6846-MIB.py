...
Counter32, Counter64, snmpModules, Integer32, mib_2, NotificationType, iso, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Bits, IpAddress, Unsigned32, TimeTicks, enterprises, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "snmpModules", "Integer32", "mib-2", "NotificationType", "iso", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Bits", "IpAddress", "Unsigned32", "TimeTicks", "enterprises", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fileType=fileType, action=action, jumblan3=jumblan3, temperature=temperature, lan1=lan1, domainame=domainame, lanportIndex=lanportIndex, unicastsReceived=unicastsReceived, staticIpAddr=staticIpAddr, portName=portName, deviceinfo=deviceinfo, modeEntry=modeEntry, portmode=portmode, voltage=voltage, vendorPn=vendorPn, fcsErrorTransmitted=fcsErrorTransmitted, qosTable=qosTable, portStatistic=portStatistic, lanportTable=lanportTable, qosIndex=qosIndex, fcsErrorReceived=fcsErrorReceived, unicastsTransmitted=unicastsTransmitted, qos=qos, groupEntry=groupEntry, adminStatus=adminStatus, port3=port3, lan4=lan4, tftp=tftp, bias=bias, staticIpDomainName=staticIpDomainName, portStatEntry=portStatEntry, operStatus=operStatus, txPower=txPower, hostname=hostname, jumb=jumb, vlanid=vlanid, staticIpSecondaryDns=staticIpSecondaryDns, qmode=qmode, qosEntry=qosEntry, lanportpause=lanportpause, rebootEnable=rebootEnable, staticIpGateway=staticIpGateway, portTable=portTable, serialnum=serialnum, groupid=groupid, port1=port1, portEntry=portEntry, multicastsTransmitted=multicastsTransmitted, portPower=portPower, wan=wan, vendorName=vendorName, tftpSevIp=tftpSevIp, priority=priority, ddminfo=ddminfo, port2=port2, fileName=fileName, primaryDns=primaryDns, jumblan4=jumblan4, reboot=reboot, jumblan2=jumblan2, qmapping=qmapping, xg6846=xg6846, internetPort=internetPort, lanportspeed=lanportspeed, vendorRev=vendorRev, pauseReceived=pauseReceived, speed=speed, staticIpSubMask=staticIpSubMask, staticDns=staticDns, statisticTable=statisticTable, port4=port4, catvEnable=catvEnable, rxPower=rxPower, wanType=wanType, multicastsReceived=multicastsReceived, catv=catv, jumblan1=jumblan1, vlan=vlan, portIndex=portIndex, groupIndex=groupIndex, secondaryDns=secondaryDns, staticIpHostName=staticIpHostName, vlangroupTable=vlangroupTable, lan2=lan2, statIndex=statIndex, broadcastsTransmitted=broadcastsTransmitted, lan3=lan3, pauseTransmitted=pauseTransmitted, lanportName=lanportName, broadcastsReceived=broadcastsReceived, dscpEnable=dscpEnable, jumbwan=jumbwan, vendorOui=vendorOui, staticIpPrimaryDns=staticIpPrimaryDns)
