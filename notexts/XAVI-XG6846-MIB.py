...
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Integer32, snmpModules, mib_2, Bits, NotificationType, Gauge32, iso, MibIdentifier, ObjectIdentity, ModuleIdentity, Counter32, IpAddress, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Integer32", "snmpModules", "mib-2", "Bits", "NotificationType", "Gauge32", "iso", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "Counter32", "IpAddress", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", modeEntry=modeEntry, xg6846=xg6846, statisticTable=statisticTable, port4=port4, dscpEnable=dscpEnable, staticIpDomainName=staticIpDomainName, adminStatus=adminStatus, catvEnable=catvEnable, pauseReceived=pauseReceived, port3=port3, qosIndex=qosIndex, priority=priority, qmapping=qmapping, fcsErrorTransmitted=fcsErrorTransmitted, lan2=lan2, action=action, tftp=tftp, fcsErrorReceived=fcsErrorReceived, multicastsReceived=multicastsReceived, bias=bias, lanportIndex=lanportIndex, qosEntry=qosEntry, broadcastsTransmitted=broadcastsTransmitted, portName=portName, portIndex=portIndex, lanportspeed=lanportspeed, domainame=domainame, vlangroupTable=vlangroupTable, internetPort=internetPort, staticDns=staticDns, port2=port2, hostname=hostname, jumb=jumb, wan=wan, port1=port1, unicastsTransmitted=unicastsTransmitted, portStatEntry=portStatEntry, ddminfo=ddminfo, jumblan4=jumblan4, qos=qos, statIndex=statIndex, deviceinfo=deviceinfo, jumblan1=jumblan1, wanType=wanType, staticIpPrimaryDns=staticIpPrimaryDns, staticIpSubMask=staticIpSubMask, speed=speed, lan1=lan1, secondaryDns=secondaryDns, qosTable=qosTable, lan4=lan4, fileName=fileName, qmode=qmode, operStatus=operStatus, vendorOui=vendorOui, groupIndex=groupIndex, staticIpGateway=staticIpGateway, portmode=portmode, txPower=txPower, lanportTable=lanportTable, tftpSevIp=tftpSevIp, serialnum=serialnum, groupEntry=groupEntry, primaryDns=primaryDns, portTable=portTable, reboot=reboot, vendorName=vendorName, lan3=lan3, portStatistic=portStatistic, rebootEnable=rebootEnable, portEntry=portEntry, temperature=temperature, voltage=voltage, multicastsTransmitted=multicastsTransmitted, jumbwan=jumbwan, vendorPn=vendorPn, staticIpHostName=staticIpHostName, vendorRev=vendorRev, lanportName=lanportName, catv=catv, broadcastsReceived=broadcastsReceived, jumblan3=jumblan3, rxPower=rxPower, staticIpAddr=staticIpAddr, staticIpSecondaryDns=staticIpSecondaryDns, vlanid=vlanid, groupid=groupid, vlan=vlan, portPower=portPower, unicastsReceived=unicastsReceived, jumblan2=jumblan2, fileType=fileType, lanportpause=lanportpause, pauseTransmitted=pauseTransmitted)
