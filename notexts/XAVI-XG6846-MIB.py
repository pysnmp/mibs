...
# Produced by pysmi-1.1.8 at Mon Feb  7 15:52:47 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, Counter64, TimeTicks, iso, IpAddress, NotificationType, Integer32, mib_2, Counter32, ModuleIdentity, enterprises, Bits, snmpModules, MibIdentifier, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "Counter64", "TimeTicks", "iso", "IpAddress", "NotificationType", "Integer32", "mib-2", "Counter32", "ModuleIdentity", "enterprises", "Bits", "snmpModules", "MibIdentifier", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", secondaryDns=secondaryDns, vlanid=vlanid, dscpEnable=dscpEnable, vendorRev=vendorRev, groupid=groupid, bias=bias, statisticTable=statisticTable, operStatus=operStatus, port1=port1, lanportpause=lanportpause, txPower=txPower, staticIpDomainName=staticIpDomainName, port2=port2, vlangroupTable=vlangroupTable, ddminfo=ddminfo, portStatEntry=portStatEntry, jumblan1=jumblan1, multicastsTransmitted=multicastsTransmitted, pauseTransmitted=pauseTransmitted, staticIpSubMask=staticIpSubMask, fileType=fileType, fcsErrorTransmitted=fcsErrorTransmitted, xg6846=xg6846, action=action, fcsErrorReceived=fcsErrorReceived, vlan=vlan, jumbwan=jumbwan, adminStatus=adminStatus, lan1=lan1, groupEntry=groupEntry, qosTable=qosTable, speed=speed, portIndex=portIndex, qmapping=qmapping, wanType=wanType, staticIpAddr=staticIpAddr, staticIpHostName=staticIpHostName, jumblan4=jumblan4, primaryDns=primaryDns, staticIpSecondaryDns=staticIpSecondaryDns, multicastsReceived=multicastsReceived, lanportspeed=lanportspeed, rxPower=rxPower, lan2=lan2, vendorOui=vendorOui, temperature=temperature, jumb=jumb, portPower=portPower, domainame=domainame, catv=catv, lanportName=lanportName, lanportTable=lanportTable, hostname=hostname, voltage=voltage, reboot=reboot, portmode=portmode, jumblan3=jumblan3, pauseReceived=pauseReceived, staticIpPrimaryDns=staticIpPrimaryDns, broadcastsTransmitted=broadcastsTransmitted, staticDns=staticDns, deviceinfo=deviceinfo, portStatistic=portStatistic, staticIpGateway=staticIpGateway, portTable=portTable, port3=port3, qmode=qmode, vendorName=vendorName, qos=qos, statIndex=statIndex, tftp=tftp, portEntry=portEntry, fileName=fileName, portName=portName, vendorPn=vendorPn, tftpSevIp=tftpSevIp, qosIndex=qosIndex, port4=port4, broadcastsReceived=broadcastsReceived, jumblan2=jumblan2, internetPort=internetPort, qosEntry=qosEntry, lan3=lan3, serialnum=serialnum, wan=wan, rebootEnable=rebootEnable, modeEntry=modeEntry, lanportIndex=lanportIndex, unicastsTransmitted=unicastsTransmitted, groupIndex=groupIndex, catvEnable=catvEnable, unicastsReceived=unicastsReceived, lan4=lan4, priority=priority)
