...
TimeTicks, Integer32, NotificationType, mib_2, IpAddress, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, Counter32, ObjectIdentity, Counter64, Unsigned32, ModuleIdentity, snmpModules, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "NotificationType", "mib-2", "IpAddress", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "Counter32", "ObjectIdentity", "Counter64", "Unsigned32", "ModuleIdentity", "snmpModules", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", multicastsTransmitted=multicastsTransmitted, txPower=txPower, portPower=portPower, hostname=hostname, jumblan2=jumblan2, qmode=qmode, groupEntry=groupEntry, priority=priority, portStatEntry=portStatEntry, jumbwan=jumbwan, rebootEnable=rebootEnable, operStatus=operStatus, domainame=domainame, speed=speed, lanportpause=lanportpause, staticIpAddr=staticIpAddr, pauseTransmitted=pauseTransmitted, wan=wan, broadcastsTransmitted=broadcastsTransmitted, staticIpHostName=staticIpHostName, groupIndex=groupIndex, tftp=tftp, qosEntry=qosEntry, statIndex=statIndex, portStatistic=portStatistic, portmode=portmode, vendorRev=vendorRev, xg6846=xg6846, lanportspeed=lanportspeed, lan2=lan2, unicastsReceived=unicastsReceived, staticIpPrimaryDns=staticIpPrimaryDns, staticIpGateway=staticIpGateway, vendorName=vendorName, tftpSevIp=tftpSevIp, temperature=temperature, dscpEnable=dscpEnable, staticIpSecondaryDns=staticIpSecondaryDns, fileName=fileName, port3=port3, fcsErrorReceived=fcsErrorReceived, staticDns=staticDns, port1=port1, port4=port4, port2=port2, staticIpDomainName=staticIpDomainName, unicastsTransmitted=unicastsTransmitted, vlan=vlan, lanportTable=lanportTable, reboot=reboot, wanType=wanType, lan4=lan4, statisticTable=statisticTable, fcsErrorTransmitted=fcsErrorTransmitted, primaryDns=primaryDns, jumblan4=jumblan4, multicastsReceived=multicastsReceived, vendorPn=vendorPn, portIndex=portIndex, portTable=portTable, bias=bias, qos=qos, staticIpSubMask=staticIpSubMask, adminStatus=adminStatus, pauseReceived=pauseReceived, portEntry=portEntry, catvEnable=catvEnable, lan3=lan3, fileType=fileType, action=action, lanportIndex=lanportIndex, rxPower=rxPower, broadcastsReceived=broadcastsReceived, qmapping=qmapping, lan1=lan1, jumblan1=jumblan1, vlanid=vlanid, groupid=groupid, vendorOui=vendorOui, jumblan3=jumblan3, lanportName=lanportName, modeEntry=modeEntry, internetPort=internetPort, qosIndex=qosIndex, ddminfo=ddminfo, secondaryDns=secondaryDns, serialnum=serialnum, deviceinfo=deviceinfo, portName=portName, vlangroupTable=vlangroupTable, catv=catv, jumb=jumb, voltage=voltage, qosTable=qosTable)
