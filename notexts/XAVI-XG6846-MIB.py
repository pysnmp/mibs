...
# Produced by pysmi-1.1.3 at Sun Nov 28 20:40:24 2021
...
Bits, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, ObjectIdentity, iso, TimeTicks, snmpModules, Counter64, Integer32, NotificationType, mib_2, enterprises, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "ObjectIdentity", "iso", "TimeTicks", "snmpModules", "Counter64", "Integer32", "NotificationType", "mib-2", "enterprises", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", tftpSevIp=tftpSevIp, lanportIndex=lanportIndex, reboot=reboot, portmode=portmode, pauseReceived=pauseReceived, staticIpAddr=staticIpAddr, portPower=portPower, multicastsReceived=multicastsReceived, staticIpHostName=staticIpHostName, qmapping=qmapping, catv=catv, vendorRev=vendorRev, staticIpSecondaryDns=staticIpSecondaryDns, rebootEnable=rebootEnable, lanportName=lanportName, portStatistic=portStatistic, lanportTable=lanportTable, lanportspeed=lanportspeed, fileName=fileName, portIndex=portIndex, portTable=portTable, fcsErrorTransmitted=fcsErrorTransmitted, staticIpGateway=staticIpGateway, jumblan1=jumblan1, bias=bias, domainame=domainame, dscpEnable=dscpEnable, action=action, lanportpause=lanportpause, multicastsTransmitted=multicastsTransmitted, qos=qos, qosEntry=qosEntry, groupIndex=groupIndex, port3=port3, jumblan4=jumblan4, qmode=qmode, txPower=txPower, portName=portName, ddminfo=ddminfo, vlangroupTable=vlangroupTable, staticIpPrimaryDns=staticIpPrimaryDns, jumbwan=jumbwan, rxPower=rxPower, voltage=voltage, groupEntry=groupEntry, vendorPn=vendorPn, qosIndex=qosIndex, port2=port2, unicastsReceived=unicastsReceived, staticIpDomainName=staticIpDomainName, qosTable=qosTable, jumblan3=jumblan3, serialnum=serialnum, broadcastsTransmitted=broadcastsTransmitted, groupid=groupid, staticIpSubMask=staticIpSubMask, jumblan2=jumblan2, wanType=wanType, statisticTable=statisticTable, secondaryDns=secondaryDns, modeEntry=modeEntry, lan2=lan2, fcsErrorReceived=fcsErrorReceived, broadcastsReceived=broadcastsReceived, fileType=fileType, staticDns=staticDns, primaryDns=primaryDns, lan4=lan4, xg6846=xg6846, lan3=lan3, priority=priority, deviceinfo=deviceinfo, adminStatus=adminStatus, portEntry=portEntry, statIndex=statIndex, unicastsTransmitted=unicastsTransmitted, operStatus=operStatus, vlanid=vlanid, port1=port1, portStatEntry=portStatEntry, hostname=hostname, jumb=jumb, vendorOui=vendorOui, catvEnable=catvEnable, vendorName=vendorName, lan1=lan1, internetPort=internetPort, temperature=temperature, vlan=vlan, tftp=tftp, wan=wan, pauseTransmitted=pauseTransmitted, port4=port4, speed=speed)
