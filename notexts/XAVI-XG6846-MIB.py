...
Gauge32, snmpModules, Counter64, Integer32, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Unsigned32, TimeTicks, IpAddress, ObjectIdentity, Bits, enterprises, NotificationType, MibIdentifier, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "snmpModules", "Counter64", "Integer32", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Unsigned32", "TimeTicks", "IpAddress", "ObjectIdentity", "Bits", "enterprises", "NotificationType", "MibIdentifier", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qosEntry=qosEntry, voltage=voltage, port1=port1, qos=qos, rxPower=rxPower, domainame=domainame, groupIndex=groupIndex, staticDns=staticDns, serialnum=serialnum, statisticTable=statisticTable, lan4=lan4, vlanid=vlanid, secondaryDns=secondaryDns, operStatus=operStatus, jumblan4=jumblan4, multicastsReceived=multicastsReceived, fileName=fileName, tftpSevIp=tftpSevIp, jumblan3=jumblan3, portName=portName, primaryDns=primaryDns, staticIpGateway=staticIpGateway, lanportTable=lanportTable, temperature=temperature, fileType=fileType, vendorName=vendorName, ddminfo=ddminfo, fcsErrorReceived=fcsErrorReceived, qmode=qmode, vlan=vlan, catv=catv, lan3=lan3, staticIpPrimaryDns=staticIpPrimaryDns, modeEntry=modeEntry, portStatEntry=portStatEntry, vendorRev=vendorRev, groupid=groupid, staticIpDomainName=staticIpDomainName, vendorPn=vendorPn, lanportIndex=lanportIndex, reboot=reboot, pauseTransmitted=pauseTransmitted, jumbwan=jumbwan, lanportpause=lanportpause, vlangroupTable=vlangroupTable, wanType=wanType, speed=speed, portStatistic=portStatistic, wan=wan, lanportspeed=lanportspeed, vendorOui=vendorOui, bias=bias, portPower=portPower, qosIndex=qosIndex, port2=port2, staticIpSecondaryDns=staticIpSecondaryDns, deviceinfo=deviceinfo, port4=port4, qosTable=qosTable, staticIpSubMask=staticIpSubMask, catvEnable=catvEnable, adminStatus=adminStatus, dscpEnable=dscpEnable, lan2=lan2, lanportName=lanportName, fcsErrorTransmitted=fcsErrorTransmitted, portTable=portTable, tftp=tftp, staticIpHostName=staticIpHostName, unicastsReceived=unicastsReceived, broadcastsTransmitted=broadcastsTransmitted, jumblan1=jumblan1, qmapping=qmapping, lan1=lan1, jumblan2=jumblan2, portIndex=portIndex, portmode=portmode, multicastsTransmitted=multicastsTransmitted, action=action, portEntry=portEntry, internetPort=internetPort, port3=port3, staticIpAddr=staticIpAddr, rebootEnable=rebootEnable, jumb=jumb, statIndex=statIndex, unicastsTransmitted=unicastsTransmitted, hostname=hostname, xg6846=xg6846, groupEntry=groupEntry, priority=priority, pauseReceived=pauseReceived, broadcastsReceived=broadcastsReceived, txPower=txPower)
