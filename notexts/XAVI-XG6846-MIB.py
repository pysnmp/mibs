...
ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, enterprises, Integer32, Bits, NotificationType, IpAddress, Unsigned32, TimeTicks, MibIdentifier, Gauge32, ObjectIdentity, Counter32, Counter64, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "enterprises", "Integer32", "Bits", "NotificationType", "IpAddress", "Unsigned32", "TimeTicks", "MibIdentifier", "Gauge32", "ObjectIdentity", "Counter32", "Counter64", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorPn=vendorPn, internetPort=internetPort, port4=port4, fcsErrorTransmitted=fcsErrorTransmitted, bias=bias, staticIpAddr=staticIpAddr, unicastsReceived=unicastsReceived, catv=catv, fileType=fileType, qosEntry=qosEntry, portPower=portPower, lanportIndex=lanportIndex, staticIpSubMask=staticIpSubMask, vendorOui=vendorOui, staticIpGateway=staticIpGateway, jumblan1=jumblan1, voltage=voltage, reboot=reboot, rxPower=rxPower, modeEntry=modeEntry, qosIndex=qosIndex, serialnum=serialnum, lanportTable=lanportTable, txPower=txPower, portName=portName, vlanid=vlanid, groupid=groupid, catvEnable=catvEnable, jumblan2=jumblan2, broadcastsReceived=broadcastsReceived, tftpSevIp=tftpSevIp, rebootEnable=rebootEnable, port3=port3, jumblan4=jumblan4, wan=wan, hostname=hostname, ddminfo=ddminfo, vendorRev=vendorRev, multicastsTransmitted=multicastsTransmitted, qosTable=qosTable, dscpEnable=dscpEnable, jumblan3=jumblan3, portEntry=portEntry, primaryDns=primaryDns, pauseReceived=pauseReceived, staticIpSecondaryDns=staticIpSecondaryDns, deviceinfo=deviceinfo, adminStatus=adminStatus, staticDns=staticDns, qmapping=qmapping, fcsErrorReceived=fcsErrorReceived, port2=port2, xg6846=xg6846, portTable=portTable, portIndex=portIndex, lan4=lan4, multicastsReceived=multicastsReceived, portmode=portmode, vendorName=vendorName, port1=port1, secondaryDns=secondaryDns, lanportpause=lanportpause, operStatus=operStatus, statisticTable=statisticTable, tftp=tftp, lan3=lan3, action=action, staticIpDomainName=staticIpDomainName, vlangroupTable=vlangroupTable, lan1=lan1, speed=speed, staticIpPrimaryDns=staticIpPrimaryDns, jumb=jumb, priority=priority, qmode=qmode, statIndex=statIndex, wanType=wanType, qos=qos, unicastsTransmitted=unicastsTransmitted, lan2=lan2, domainame=domainame, pauseTransmitted=pauseTransmitted, groupIndex=groupIndex, staticIpHostName=staticIpHostName, lanportspeed=lanportspeed, jumbwan=jumbwan, groupEntry=groupEntry, portStatEntry=portStatEntry, lanportName=lanportName, vlan=vlan, temperature=temperature, fileName=fileName, portStatistic=portStatistic, broadcastsTransmitted=broadcastsTransmitted)
