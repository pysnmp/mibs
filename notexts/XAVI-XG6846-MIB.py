...
MibIdentifier, Bits, Counter32, Gauge32, Integer32, iso, TimeTicks, Unsigned32, snmpModules, enterprises, ModuleIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, mib_2, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "Counter32", "Gauge32", "Integer32", "iso", "TimeTicks", "Unsigned32", "snmpModules", "enterprises", "ModuleIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "mib-2", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", groupid=groupid, lanportspeed=lanportspeed, voltage=voltage, lanportTable=lanportTable, temperature=temperature, qosTable=qosTable, action=action, vendorRev=vendorRev, xg6846=xg6846, bias=bias, lanportIndex=lanportIndex, unicastsTransmitted=unicastsTransmitted, rxPower=rxPower, vendorName=vendorName, txPower=txPower, lan2=lan2, port4=port4, tftpSevIp=tftpSevIp, wan=wan, hostname=hostname, qmapping=qmapping, statisticTable=statisticTable, priority=priority, qmode=qmode, vlanid=vlanid, port3=port3, portPower=portPower, fcsErrorReceived=fcsErrorReceived, jumblan3=jumblan3, lan4=lan4, staticDns=staticDns, tftp=tftp, broadcastsTransmitted=broadcastsTransmitted, ddminfo=ddminfo, port2=port2, staticIpPrimaryDns=staticIpPrimaryDns, portStatistic=portStatistic, groupEntry=groupEntry, secondaryDns=secondaryDns, statIndex=statIndex, vlangroupTable=vlangroupTable, lanportName=lanportName, lanportpause=lanportpause, serialnum=serialnum, pauseReceived=pauseReceived, portName=portName, staticIpAddr=staticIpAddr, adminStatus=adminStatus, internetPort=internetPort, portmode=portmode, vlan=vlan, staticIpSecondaryDns=staticIpSecondaryDns, multicastsTransmitted=multicastsTransmitted, wanType=wanType, fileType=fileType, catv=catv, staticIpGateway=staticIpGateway, port1=port1, groupIndex=groupIndex, deviceinfo=deviceinfo, jumb=jumb, reboot=reboot, portStatEntry=portStatEntry, portEntry=portEntry, speed=speed, rebootEnable=rebootEnable, fileName=fileName, qos=qos, staticIpSubMask=staticIpSubMask, jumblan1=jumblan1, jumbwan=jumbwan, catvEnable=catvEnable, operStatus=operStatus, vendorOui=vendorOui, modeEntry=modeEntry, domainame=domainame, jumblan4=jumblan4, multicastsReceived=multicastsReceived, primaryDns=primaryDns, lan1=lan1, staticIpHostName=staticIpHostName, staticIpDomainName=staticIpDomainName, jumblan2=jumblan2, portTable=portTable, vendorPn=vendorPn, qosEntry=qosEntry, broadcastsReceived=broadcastsReceived, dscpEnable=dscpEnable, lan3=lan3, fcsErrorTransmitted=fcsErrorTransmitted, pauseTransmitted=pauseTransmitted, qosIndex=qosIndex, portIndex=portIndex, unicastsReceived=unicastsReceived)
