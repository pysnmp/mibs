...
# Produced by pysmi-1.1.3 at Sun Nov 28 14:26:39 2021
...
Gauge32, enterprises, ObjectIdentity, Unsigned32, NotificationType, IpAddress, ModuleIdentity, MibIdentifier, Bits, mib_2, Integer32, iso, Counter32, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "ObjectIdentity", "Unsigned32", "NotificationType", "IpAddress", "ModuleIdentity", "MibIdentifier", "Bits", "mib-2", "Integer32", "iso", "Counter32", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", modeEntry=modeEntry, broadcastsReceived=broadcastsReceived, vlanid=vlanid, qosEntry=qosEntry, rebootEnable=rebootEnable, jumblan4=jumblan4, fcsErrorReceived=fcsErrorReceived, groupid=groupid, catv=catv, port3=port3, ddminfo=ddminfo, domainame=domainame, staticDns=staticDns, primaryDns=primaryDns, unicastsTransmitted=unicastsTransmitted, jumblan3=jumblan3, xg6846=xg6846, portStatistic=portStatistic, internetPort=internetPort, staticIpSubMask=staticIpSubMask, rxPower=rxPower, staticIpHostName=staticIpHostName, catvEnable=catvEnable, statisticTable=statisticTable, txPower=txPower, lanportspeed=lanportspeed, broadcastsTransmitted=broadcastsTransmitted, vendorName=vendorName, portEntry=portEntry, fileName=fileName, lanportIndex=lanportIndex, vendorOui=vendorOui, bias=bias, portTable=portTable, wan=wan, vlangroupTable=vlangroupTable, portName=portName, vlan=vlan, dscpEnable=dscpEnable, multicastsTransmitted=multicastsTransmitted, lan2=lan2, vendorPn=vendorPn, groupEntry=groupEntry, jumbwan=jumbwan, lan1=lan1, serialnum=serialnum, statIndex=statIndex, jumb=jumb, hostname=hostname, lan3=lan3, staticIpDomainName=staticIpDomainName, tftp=tftp, staticIpPrimaryDns=staticIpPrimaryDns, secondaryDns=secondaryDns, adminStatus=adminStatus, fcsErrorTransmitted=fcsErrorTransmitted, qmode=qmode, pauseReceived=pauseReceived, port1=port1, qosIndex=qosIndex, qos=qos, reboot=reboot, temperature=temperature, port4=port4, portIndex=portIndex, tftpSevIp=tftpSevIp, qmapping=qmapping, lan4=lan4, action=action, wanType=wanType, port2=port2, staticIpAddr=staticIpAddr, vendorRev=vendorRev, priority=priority, fileType=fileType, qosTable=qosTable, portmode=portmode, jumblan2=jumblan2, lanportName=lanportName, speed=speed, staticIpSecondaryDns=staticIpSecondaryDns, portStatEntry=portStatEntry, pauseTransmitted=pauseTransmitted, multicastsReceived=multicastsReceived, staticIpGateway=staticIpGateway, operStatus=operStatus, unicastsReceived=unicastsReceived, jumblan1=jumblan1, groupIndex=groupIndex, voltage=voltage, lanportTable=lanportTable, portPower=portPower, deviceinfo=deviceinfo, lanportpause=lanportpause)
