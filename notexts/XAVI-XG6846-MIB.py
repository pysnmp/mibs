...
# Produced by pysmi-1.1.8 at Thu Sep  7 14:27:11 2023
...
NotificationType, IpAddress, Bits, snmpModules, enterprises, Gauge32, MibIdentifier, ObjectIdentity, iso, ModuleIdentity, mib_2, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "Bits", "snmpModules", "enterprises", "Gauge32", "MibIdentifier", "ObjectIdentity", "iso", "ModuleIdentity", "mib-2", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", ddminfo=ddminfo, catv=catv, qosEntry=qosEntry, voltage=voltage, qosTable=qosTable, lanportpause=lanportpause, portStatistic=portStatistic, adminStatus=adminStatus, rebootEnable=rebootEnable, qosIndex=qosIndex, temperature=temperature, lan3=lan3, bias=bias, speed=speed, reboot=reboot, unicastsReceived=unicastsReceived, broadcastsReceived=broadcastsReceived, unicastsTransmitted=unicastsTransmitted, modeEntry=modeEntry, primaryDns=primaryDns, vendorRev=vendorRev, statIndex=statIndex, internetPort=internetPort, serialnum=serialnum, qmapping=qmapping, fileName=fileName, catvEnable=catvEnable, broadcastsTransmitted=broadcastsTransmitted, port1=port1, jumblan2=jumblan2, port4=port4, vendorName=vendorName, port3=port3, xg6846=xg6846, tftp=tftp, wanType=wanType, jumbwan=jumbwan, lan1=lan1, operStatus=operStatus, staticIpDomainName=staticIpDomainName, jumb=jumb, jumblan4=jumblan4, hostname=hostname, lanportIndex=lanportIndex, staticIpSubMask=staticIpSubMask, portIndex=portIndex, groupIndex=groupIndex, wan=wan, lan4=lan4, fcsErrorTransmitted=fcsErrorTransmitted, rxPower=rxPower, fcsErrorReceived=fcsErrorReceived, lanportTable=lanportTable, vlan=vlan, multicastsTransmitted=multicastsTransmitted, groupEntry=groupEntry, portEntry=portEntry, jumblan3=jumblan3, staticIpHostName=staticIpHostName, lan2=lan2, vendorOui=vendorOui, portPower=portPower, vlangroupTable=vlangroupTable, portTable=portTable, portStatEntry=portStatEntry, qmode=qmode, lanportspeed=lanportspeed, qos=qos, fileType=fileType, portName=portName, jumblan1=jumblan1, portmode=portmode, domainame=domainame, tftpSevIp=tftpSevIp, deviceinfo=deviceinfo, lanportName=lanportName, pauseReceived=pauseReceived, staticDns=staticDns, statisticTable=statisticTable, staticIpAddr=staticIpAddr, action=action, multicastsReceived=multicastsReceived, txPower=txPower, staticIpPrimaryDns=staticIpPrimaryDns, vlanid=vlanid, secondaryDns=secondaryDns, port2=port2, dscpEnable=dscpEnable, staticIpGateway=staticIpGateway, priority=priority, staticIpSecondaryDns=staticIpSecondaryDns, vendorPn=vendorPn, groupid=groupid, pauseTransmitted=pauseTransmitted)
