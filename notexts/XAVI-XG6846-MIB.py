...
# Produced by pysmi-1.1.8 at Sat Jan 15 23:51:36 2022
...
Integer32, mib_2, ModuleIdentity, IpAddress, ObjectIdentity, Unsigned32, Counter32, snmpModules, Bits, TimeTicks, enterprises, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "mib-2", "ModuleIdentity", "IpAddress", "ObjectIdentity", "Unsigned32", "Counter32", "snmpModules", "Bits", "TimeTicks", "enterprises", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticDns=staticDns, staticIpAddr=staticIpAddr, port4=port4, portEntry=portEntry, lan2=lan2, wanType=wanType, priority=priority, groupid=groupid, internetPort=internetPort, vendorRev=vendorRev, qos=qos, pauseReceived=pauseReceived, statisticTable=statisticTable, jumblan1=jumblan1, vlangroupTable=vlangroupTable, groupIndex=groupIndex, multicastsReceived=multicastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, groupEntry=groupEntry, portName=portName, port1=port1, dscpEnable=dscpEnable, speed=speed, jumb=jumb, action=action, vendorPn=vendorPn, qosEntry=qosEntry, bias=bias, staticIpDomainName=staticIpDomainName, lanportspeed=lanportspeed, fileType=fileType, txPower=txPower, jumbwan=jumbwan, qmapping=qmapping, staticIpSubMask=staticIpSubMask, catv=catv, port3=port3, lanportpause=lanportpause, domainame=domainame, portmode=portmode, portIndex=portIndex, tftp=tftp, vendorName=vendorName, rebootEnable=rebootEnable, statIndex=statIndex, hostname=hostname, jumblan3=jumblan3, jumblan2=jumblan2, qmode=qmode, vlan=vlan, qosTable=qosTable, lan4=lan4, primaryDns=primaryDns, pauseTransmitted=pauseTransmitted, portStatistic=portStatistic, portStatEntry=portStatEntry, unicastsReceived=unicastsReceived, modeEntry=modeEntry, lanportTable=lanportTable, deviceinfo=deviceinfo, lan1=lan1, operStatus=operStatus, lan3=lan3, portPower=portPower, voltage=voltage, temperature=temperature, staticIpPrimaryDns=staticIpPrimaryDns, reboot=reboot, fcsErrorReceived=fcsErrorReceived, staticIpSecondaryDns=staticIpSecondaryDns, vlanid=vlanid, adminStatus=adminStatus, fileName=fileName, broadcastsTransmitted=broadcastsTransmitted, unicastsTransmitted=unicastsTransmitted, xg6846=xg6846, staticIpGateway=staticIpGateway, port2=port2, wan=wan, ddminfo=ddminfo, rxPower=rxPower, lanportIndex=lanportIndex, lanportName=lanportName, broadcastsReceived=broadcastsReceived, tftpSevIp=tftpSevIp, multicastsTransmitted=multicastsTransmitted, portTable=portTable, staticIpHostName=staticIpHostName, vendorOui=vendorOui, serialnum=serialnum, catvEnable=catvEnable, qosIndex=qosIndex, secondaryDns=secondaryDns, jumblan4=jumblan4)
