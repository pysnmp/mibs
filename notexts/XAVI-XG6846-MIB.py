...
# Produced by pysmi-1.1.8 at Mon Jan  2 13:54:54 2023
...
Counter32, enterprises, Unsigned32, iso, ModuleIdentity, Gauge32, ObjectIdentity, Bits, TimeTicks, mib_2, Counter64, IpAddress, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "enterprises", "Unsigned32", "iso", "ModuleIdentity", "Gauge32", "ObjectIdentity", "Bits", "TimeTicks", "mib-2", "Counter64", "IpAddress", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportspeed=lanportspeed, qos=qos, lan2=lan2, port3=port3, jumblan3=jumblan3, fileName=fileName, action=action, catv=catv, multicastsTransmitted=multicastsTransmitted, hostname=hostname, staticDns=staticDns, staticIpSubMask=staticIpSubMask, reboot=reboot, fcsErrorReceived=fcsErrorReceived, portName=portName, lanportIndex=lanportIndex, vlan=vlan, statIndex=statIndex, port2=port2, staticIpPrimaryDns=staticIpPrimaryDns, port4=port4, ddminfo=ddminfo, portIndex=portIndex, portPower=portPower, vendorName=vendorName, domainame=domainame, bias=bias, qosEntry=qosEntry, broadcastsReceived=broadcastsReceived, wanType=wanType, catvEnable=catvEnable, jumblan4=jumblan4, priority=priority, vlanid=vlanid, pauseReceived=pauseReceived, multicastsReceived=multicastsReceived, lanportTable=lanportTable, xg6846=xg6846, portStatEntry=portStatEntry, txPower=txPower, lan4=lan4, speed=speed, voltage=voltage, staticIpDomainName=staticIpDomainName, qosTable=qosTable, jumbwan=jumbwan, fileType=fileType, portmode=portmode, vlangroupTable=vlangroupTable, modeEntry=modeEntry, jumblan1=jumblan1, deviceinfo=deviceinfo, lan3=lan3, jumblan2=jumblan2, adminStatus=adminStatus, fcsErrorTransmitted=fcsErrorTransmitted, primaryDns=primaryDns, groupIndex=groupIndex, dscpEnable=dscpEnable, qmode=qmode, staticIpHostName=staticIpHostName, lanportName=lanportName, vendorRev=vendorRev, internetPort=internetPort, tftpSevIp=tftpSevIp, broadcastsTransmitted=broadcastsTransmitted, qosIndex=qosIndex, lanportpause=lanportpause, portTable=portTable, rebootEnable=rebootEnable, portEntry=portEntry, statisticTable=statisticTable, rxPower=rxPower, portStatistic=portStatistic, tftp=tftp, groupid=groupid, staticIpAddr=staticIpAddr, jumb=jumb, port1=port1, vendorPn=vendorPn, staticIpGateway=staticIpGateway, secondaryDns=secondaryDns, pauseTransmitted=pauseTransmitted, qmapping=qmapping, lan1=lan1, serialnum=serialnum, unicastsReceived=unicastsReceived, groupEntry=groupEntry, wan=wan, staticIpSecondaryDns=staticIpSecondaryDns, operStatus=operStatus, temperature=temperature, unicastsTransmitted=unicastsTransmitted, vendorOui=vendorOui)
