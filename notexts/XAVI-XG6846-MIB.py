...
# Produced by pysmi-1.1.3 at Mon Nov 22 20:00:32 2021
...
Integer32, iso, Gauge32, NotificationType, mib_2, ObjectIdentity, IpAddress, ModuleIdentity, Counter32, Unsigned32, MibIdentifier, snmpModules, enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "Gauge32", "NotificationType", "mib-2", "ObjectIdentity", "IpAddress", "ModuleIdentity", "Counter32", "Unsigned32", "MibIdentifier", "snmpModules", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portIndex=portIndex, lan3=lan3, speed=speed, serialnum=serialnum, portmode=portmode, qosIndex=qosIndex, catv=catv, lanportspeed=lanportspeed, vlan=vlan, jumblan2=jumblan2, groupIndex=groupIndex, unicastsTransmitted=unicastsTransmitted, portEntry=portEntry, vendorPn=vendorPn, internetPort=internetPort, domainame=domainame, jumblan4=jumblan4, reboot=reboot, wanType=wanType, modeEntry=modeEntry, portTable=portTable, lanportpause=lanportpause, qmode=qmode, txPower=txPower, priority=priority, portStatEntry=portStatEntry, portStatistic=portStatistic, port2=port2, broadcastsReceived=broadcastsReceived, ddminfo=ddminfo, fileName=fileName, vendorOui=vendorOui, staticIpGateway=staticIpGateway, staticIpHostName=staticIpHostName, portName=portName, qos=qos, rebootEnable=rebootEnable, vendorName=vendorName, port3=port3, staticDns=staticDns, lan1=lan1, port1=port1, statIndex=statIndex, staticIpPrimaryDns=staticIpPrimaryDns, port4=port4, multicastsTransmitted=multicastsTransmitted, tftp=tftp, multicastsReceived=multicastsReceived, lanportTable=lanportTable, jumblan1=jumblan1, catvEnable=catvEnable, hostname=hostname, broadcastsTransmitted=broadcastsTransmitted, temperature=temperature, vlanid=vlanid, groupid=groupid, staticIpSecondaryDns=staticIpSecondaryDns, staticIpSubMask=staticIpSubMask, secondaryDns=secondaryDns, lanportIndex=lanportIndex, deviceinfo=deviceinfo, fcsErrorReceived=fcsErrorReceived, statisticTable=statisticTable, lan2=lan2, vendorRev=vendorRev, groupEntry=groupEntry, voltage=voltage, operStatus=operStatus, portPower=portPower, pauseTransmitted=pauseTransmitted, dscpEnable=dscpEnable, jumb=jumb, staticIpDomainName=staticIpDomainName, lanportName=lanportName, action=action, jumbwan=jumbwan, xg6846=xg6846, unicastsReceived=unicastsReceived, tftpSevIp=tftpSevIp, rxPower=rxPower, qosEntry=qosEntry, vlangroupTable=vlangroupTable, fileType=fileType, qosTable=qosTable, qmapping=qmapping, primaryDns=primaryDns, jumblan3=jumblan3, wan=wan, fcsErrorTransmitted=fcsErrorTransmitted, pauseReceived=pauseReceived, staticIpAddr=staticIpAddr, lan4=lan4, bias=bias, adminStatus=adminStatus)
