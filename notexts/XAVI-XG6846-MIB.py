...
# Produced by pysmi-1.1.8 at Wed Oct 11 11:31:51 2023
...
mib_2, Unsigned32, iso, Counter32, MibIdentifier, ModuleIdentity, IpAddress, Integer32, Bits, TimeTicks, Gauge32, NotificationType, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, snmpModules, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Unsigned32", "iso", "Counter32", "MibIdentifier", "ModuleIdentity", "IpAddress", "Integer32", "Bits", "TimeTicks", "Gauge32", "NotificationType", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "snmpModules", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportpause=lanportpause, staticIpPrimaryDns=staticIpPrimaryDns, port3=port3, lanportspeed=lanportspeed, staticIpAddr=staticIpAddr, catvEnable=catvEnable, qosTable=qosTable, action=action, internetPort=internetPort, modeEntry=modeEntry, port4=port4, speed=speed, serialnum=serialnum, jumblan4=jumblan4, operStatus=operStatus, reboot=reboot, qosIndex=qosIndex, pauseReceived=pauseReceived, statisticTable=statisticTable, txPower=txPower, primaryDns=primaryDns, lanportTable=lanportTable, jumblan2=jumblan2, jumb=jumb, staticIpHostName=staticIpHostName, lan2=lan2, vlangroupTable=vlangroupTable, portName=portName, fcsErrorReceived=fcsErrorReceived, vendorRev=vendorRev, vlan=vlan, vendorPn=vendorPn, deviceinfo=deviceinfo, domainame=domainame, jumblan1=jumblan1, unicastsTransmitted=unicastsTransmitted, port2=port2, tftp=tftp, staticDns=staticDns, dscpEnable=dscpEnable, rxPower=rxPower, multicastsTransmitted=multicastsTransmitted, wan=wan, pauseTransmitted=pauseTransmitted, unicastsReceived=unicastsReceived, vlanid=vlanid, portPower=portPower, portmode=portmode, fcsErrorTransmitted=fcsErrorTransmitted, staticIpSubMask=staticIpSubMask, lan1=lan1, portIndex=portIndex, groupEntry=groupEntry, qosEntry=qosEntry, port1=port1, xg6846=xg6846, portEntry=portEntry, rebootEnable=rebootEnable, broadcastsReceived=broadcastsReceived, vendorName=vendorName, secondaryDns=secondaryDns, adminStatus=adminStatus, jumbwan=jumbwan, staticIpDomainName=staticIpDomainName, portTable=portTable, voltage=voltage, broadcastsTransmitted=broadcastsTransmitted, lan4=lan4, staticIpGateway=staticIpGateway, fileName=fileName, portStatEntry=portStatEntry, multicastsReceived=multicastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, bias=bias, priority=priority, portStatistic=portStatistic, statIndex=statIndex, groupid=groupid, lan3=lan3, lanportName=lanportName, temperature=temperature, ddminfo=ddminfo, hostname=hostname, tftpSevIp=tftpSevIp, wanType=wanType, vendorOui=vendorOui, qos=qos, fileType=fileType, groupIndex=groupIndex, catv=catv, qmode=qmode, qmapping=qmapping, jumblan3=jumblan3, lanportIndex=lanportIndex)
