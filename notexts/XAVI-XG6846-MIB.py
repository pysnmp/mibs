...
# Produced by pysmi-1.1.3 at Mon Nov 22 12:16:08 2021
...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, IpAddress, MibIdentifier, snmpModules, Counter64, Bits, ModuleIdentity, NotificationType, Gauge32, TimeTicks, Counter32, mib_2, ObjectIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "IpAddress", "MibIdentifier", "snmpModules", "Counter64", "Bits", "ModuleIdentity", "NotificationType", "Gauge32", "TimeTicks", "Counter32", "mib-2", "ObjectIdentity", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumblan2=jumblan2, tftp=tftp, domainame=domainame, port3=port3, staticIpHostName=staticIpHostName, lanportspeed=lanportspeed, staticIpSubMask=staticIpSubMask, pauseTransmitted=pauseTransmitted, portIndex=portIndex, unicastsTransmitted=unicastsTransmitted, qosTable=qosTable, qmode=qmode, reboot=reboot, ddminfo=ddminfo, catv=catv, vendorOui=vendorOui, staticIpSecondaryDns=staticIpSecondaryDns, wan=wan, statIndex=statIndex, staticIpAddr=staticIpAddr, adminStatus=adminStatus, jumblan4=jumblan4, priority=priority, groupEntry=groupEntry, vendorPn=vendorPn, lan2=lan2, serialnum=serialnum, port1=port1, action=action, lanportTable=lanportTable, groupid=groupid, catvEnable=catvEnable, tftpSevIp=tftpSevIp, broadcastsTransmitted=broadcastsTransmitted, rxPower=rxPower, vendorRev=vendorRev, qmapping=qmapping, wanType=wanType, pauseReceived=pauseReceived, deviceinfo=deviceinfo, lanportpause=lanportpause, operStatus=operStatus, vendorName=vendorName, fcsErrorReceived=fcsErrorReceived, statisticTable=statisticTable, port4=port4, staticIpGateway=staticIpGateway, staticDns=staticDns, lan4=lan4, unicastsReceived=unicastsReceived, secondaryDns=secondaryDns, qos=qos, speed=speed, txPower=txPower, portStatistic=portStatistic, primaryDns=primaryDns, bias=bias, staticIpDomainName=staticIpDomainName, qosIndex=qosIndex, jumbwan=jumbwan, fileType=fileType, lanportName=lanportName, multicastsReceived=multicastsReceived, vlan=vlan, xg6846=xg6846, dscpEnable=dscpEnable, port2=port2, lanportIndex=lanportIndex, fileName=fileName, portTable=portTable, portEntry=portEntry, portPower=portPower, qosEntry=qosEntry, broadcastsReceived=broadcastsReceived, portmode=portmode, portStatEntry=portStatEntry, jumb=jumb, lan1=lan1, vlanid=vlanid, portName=portName, lan3=lan3, hostname=hostname, internetPort=internetPort, fcsErrorTransmitted=fcsErrorTransmitted, multicastsTransmitted=multicastsTransmitted, temperature=temperature, staticIpPrimaryDns=staticIpPrimaryDns, rebootEnable=rebootEnable, jumblan1=jumblan1, groupIndex=groupIndex, vlangroupTable=vlangroupTable, jumblan3=jumblan3, voltage=voltage, modeEntry=modeEntry)
