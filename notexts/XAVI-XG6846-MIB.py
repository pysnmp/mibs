...
# Produced by pysmi-1.1.8 at Wed Oct 11 10:10:31 2023
...
enterprises, Counter64, Unsigned32, ObjectIdentity, MibIdentifier, iso, snmpModules, NotificationType, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Bits, Counter32, ModuleIdentity, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter64", "Unsigned32", "ObjectIdentity", "MibIdentifier", "iso", "snmpModules", "NotificationType", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Bits", "Counter32", "ModuleIdentity", "IpAddress", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", port4=port4, fileName=fileName, serialnum=serialnum, secondaryDns=secondaryDns, staticIpSubMask=staticIpSubMask, jumblan1=jumblan1, portStatistic=portStatistic, jumbwan=jumbwan, fcsErrorTransmitted=fcsErrorTransmitted, priority=priority, lanportspeed=lanportspeed, speed=speed, hostname=hostname, action=action, groupEntry=groupEntry, qosEntry=qosEntry, jumblan3=jumblan3, lan3=lan3, staticIpDomainName=staticIpDomainName, vendorPn=vendorPn, voltage=voltage, qmode=qmode, wan=wan, statisticTable=statisticTable, lanportTable=lanportTable, groupIndex=groupIndex, xg6846=xg6846, tftp=tftp, portStatEntry=portStatEntry, port3=port3, qosTable=qosTable, multicastsTransmitted=multicastsTransmitted, bias=bias, deviceinfo=deviceinfo, staticIpAddr=staticIpAddr, pauseTransmitted=pauseTransmitted, modeEntry=modeEntry, staticIpSecondaryDns=staticIpSecondaryDns, jumb=jumb, pauseReceived=pauseReceived, lanportpause=lanportpause, txPower=txPower, portEntry=portEntry, lan1=lan1, fcsErrorReceived=fcsErrorReceived, tftpSevIp=tftpSevIp, port1=port1, wanType=wanType, qmapping=qmapping, internetPort=internetPort, temperature=temperature, portName=portName, lanportIndex=lanportIndex, qos=qos, reboot=reboot, vendorOui=vendorOui, multicastsReceived=multicastsReceived, rxPower=rxPower, statIndex=statIndex, jumblan2=jumblan2, port2=port2, portPower=portPower, broadcastsTransmitted=broadcastsTransmitted, lanportName=lanportName, staticDns=staticDns, unicastsTransmitted=unicastsTransmitted, vlanid=vlanid, adminStatus=adminStatus, vlan=vlan, operStatus=operStatus, lan4=lan4, portIndex=portIndex, ddminfo=ddminfo, rebootEnable=rebootEnable, catv=catv, groupid=groupid, domainame=domainame, fileType=fileType, qosIndex=qosIndex, portTable=portTable, vlangroupTable=vlangroupTable, dscpEnable=dscpEnable, vendorRev=vendorRev, portmode=portmode, jumblan4=jumblan4, vendorName=vendorName, primaryDns=primaryDns, lan2=lan2, staticIpGateway=staticIpGateway, catvEnable=catvEnable, staticIpHostName=staticIpHostName, unicastsReceived=unicastsReceived, broadcastsReceived=broadcastsReceived, staticIpPrimaryDns=staticIpPrimaryDns)
