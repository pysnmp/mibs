...
# Produced by pysmi-1.1.0 at Mon Nov 15 19:55:41 2021
...
iso, ModuleIdentity, MibIdentifier, Bits, IpAddress, Gauge32, Unsigned32, enterprises, Counter32, NotificationType, mib_2, Integer32, ObjectIdentity, Counter64, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "MibIdentifier", "Bits", "IpAddress", "Gauge32", "Unsigned32", "enterprises", "Counter32", "NotificationType", "mib-2", "Integer32", "ObjectIdentity", "Counter64", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", tftpSevIp=tftpSevIp, jumblan1=jumblan1, statisticTable=statisticTable, xg6846=xg6846, staticIpGateway=staticIpGateway, speed=speed, wan=wan, jumblan4=jumblan4, portmode=portmode, lan3=lan3, multicastsReceived=multicastsReceived, action=action, pauseTransmitted=pauseTransmitted, vendorPn=vendorPn, bias=bias, fileType=fileType, portPower=portPower, adminStatus=adminStatus, unicastsTransmitted=unicastsTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, groupid=groupid, port4=port4, qos=qos, serialnum=serialnum, domainame=domainame, portName=portName, staticIpAddr=staticIpAddr, lanportspeed=lanportspeed, portIndex=portIndex, qmapping=qmapping, modeEntry=modeEntry, vlan=vlan, pauseReceived=pauseReceived, port1=port1, lan4=lan4, port3=port3, lan2=lan2, txPower=txPower, staticIpPrimaryDns=staticIpPrimaryDns, broadcastsReceived=broadcastsReceived, broadcastsTransmitted=broadcastsTransmitted, portStatistic=portStatistic, staticIpHostName=staticIpHostName, jumblan2=jumblan2, fileName=fileName, rxPower=rxPower, qosEntry=qosEntry, tftp=tftp, qmode=qmode, groupEntry=groupEntry, lanportpause=lanportpause, hostname=hostname, fcsErrorReceived=fcsErrorReceived, jumblan3=jumblan3, jumb=jumb, unicastsReceived=unicastsReceived, qosTable=qosTable, staticDns=staticDns, rebootEnable=rebootEnable, lanportTable=lanportTable, catv=catv, portStatEntry=portStatEntry, staticIpSubMask=staticIpSubMask, port2=port2, portEntry=portEntry, vlanid=vlanid, qosIndex=qosIndex, lanportName=lanportName, reboot=reboot, internetPort=internetPort, priority=priority, fcsErrorTransmitted=fcsErrorTransmitted, temperature=temperature, ddminfo=ddminfo, vendorRev=vendorRev, statIndex=statIndex, staticIpDomainName=staticIpDomainName, voltage=voltage, lan1=lan1, dscpEnable=dscpEnable, vlangroupTable=vlangroupTable, vendorOui=vendorOui, multicastsTransmitted=multicastsTransmitted, primaryDns=primaryDns, groupIndex=groupIndex, vendorName=vendorName, deviceinfo=deviceinfo, wanType=wanType, operStatus=operStatus, lanportIndex=lanportIndex, secondaryDns=secondaryDns, portTable=portTable, jumbwan=jumbwan, catvEnable=catvEnable)
