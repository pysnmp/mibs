...
# Produced by pysmi-1.1.8 at Mon Jan 17 10:04:34 2022
...
NotificationType, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, IpAddress, mib_2, Counter32, Counter64, TimeTicks, Gauge32, Unsigned32, Integer32, ObjectIdentity, MibIdentifier, iso, snmpModules, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "IpAddress", "mib-2", "Counter32", "Counter64", "TimeTicks", "Gauge32", "Unsigned32", "Integer32", "ObjectIdentity", "MibIdentifier", "iso", "snmpModules", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qmapping=qmapping, broadcastsReceived=broadcastsReceived, qos=qos, qosEntry=qosEntry, serialnum=serialnum, deviceinfo=deviceinfo, portTable=portTable, internetPort=internetPort, staticIpDomainName=staticIpDomainName, rxPower=rxPower, groupIndex=groupIndex, staticIpGateway=staticIpGateway, xg6846=xg6846, qosIndex=qosIndex, lanportIndex=lanportIndex, staticDns=staticDns, jumblan1=jumblan1, multicastsReceived=multicastsReceived, reboot=reboot, operStatus=operStatus, qosTable=qosTable, statIndex=statIndex, pauseReceived=pauseReceived, ddminfo=ddminfo, temperature=temperature, portPower=portPower, priority=priority, vendorPn=vendorPn, portStatistic=portStatistic, portmode=portmode, fcsErrorTransmitted=fcsErrorTransmitted, qmode=qmode, pauseTransmitted=pauseTransmitted, rebootEnable=rebootEnable, vendorOui=vendorOui, portName=portName, catvEnable=catvEnable, lan1=lan1, jumbwan=jumbwan, primaryDns=primaryDns, vendorRev=vendorRev, tftp=tftp, domainame=domainame, port4=port4, secondaryDns=secondaryDns, staticIpAddr=staticIpAddr, staticIpPrimaryDns=staticIpPrimaryDns, voltage=voltage, wanType=wanType, broadcastsTransmitted=broadcastsTransmitted, jumblan2=jumblan2, vlanid=vlanid, portEntry=portEntry, modeEntry=modeEntry, lan2=lan2, tftpSevIp=tftpSevIp, port2=port2, lanportpause=lanportpause, fcsErrorReceived=fcsErrorReceived, speed=speed, action=action, lan4=lan4, catv=catv, wan=wan, dscpEnable=dscpEnable, fileName=fileName, bias=bias, lanportspeed=lanportspeed, vlan=vlan, txPower=txPower, unicastsTransmitted=unicastsTransmitted, lanportTable=lanportTable, unicastsReceived=unicastsReceived, groupEntry=groupEntry, portIndex=portIndex, jumblan3=jumblan3, port3=port3, port1=port1, vendorName=vendorName, staticIpSecondaryDns=staticIpSecondaryDns, adminStatus=adminStatus, multicastsTransmitted=multicastsTransmitted, portStatEntry=portStatEntry, jumb=jumb, statisticTable=statisticTable, staticIpHostName=staticIpHostName, fileType=fileType, vlangroupTable=vlangroupTable, hostname=hostname, lanportName=lanportName, lan3=lan3, staticIpSubMask=staticIpSubMask, jumblan4=jumblan4, groupid=groupid)
