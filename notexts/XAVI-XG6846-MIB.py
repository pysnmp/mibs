...
NotificationType, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, mib_2, Counter64, Gauge32, enterprises, iso, Integer32, ObjectIdentity, IpAddress, ModuleIdentity, Counter32, Unsigned32, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "mib-2", "Counter64", "Gauge32", "enterprises", "iso", "Integer32", "ObjectIdentity", "IpAddress", "ModuleIdentity", "Counter32", "Unsigned32", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", statIndex=statIndex, ddminfo=ddminfo, bias=bias, txPower=txPower, jumblan4=jumblan4, pauseTransmitted=pauseTransmitted, fcsErrorReceived=fcsErrorReceived, groupEntry=groupEntry, action=action, statisticTable=statisticTable, domainame=domainame, catvEnable=catvEnable, lanportIndex=lanportIndex, staticIpHostName=staticIpHostName, portmode=portmode, dscpEnable=dscpEnable, lan3=lan3, secondaryDns=secondaryDns, qmapping=qmapping, rxPower=rxPower, jumblan2=jumblan2, broadcastsReceived=broadcastsReceived, qos=qos, qmode=qmode, serialnum=serialnum, port2=port2, tftp=tftp, vendorPn=vendorPn, vendorRev=vendorRev, jumblan3=jumblan3, jumblan1=jumblan1, portEntry=portEntry, groupid=groupid, jumbwan=jumbwan, port1=port1, qosIndex=qosIndex, reboot=reboot, multicastsReceived=multicastsReceived, staticIpAddr=staticIpAddr, qosTable=qosTable, staticDns=staticDns, lanportTable=lanportTable, priority=priority, speed=speed, multicastsTransmitted=multicastsTransmitted, vlangroupTable=vlangroupTable, portStatistic=portStatistic, primaryDns=primaryDns, fileType=fileType, staticIpSubMask=staticIpSubMask, qosEntry=qosEntry, lan4=lan4, vlan=vlan, tftpSevIp=tftpSevIp, vendorOui=vendorOui, lanportpause=lanportpause, internetPort=internetPort, staticIpPrimaryDns=staticIpPrimaryDns, catv=catv, portName=portName, vlanid=vlanid, pauseReceived=pauseReceived, portPower=portPower, vendorName=vendorName, jumb=jumb, groupIndex=groupIndex, portTable=portTable, unicastsTransmitted=unicastsTransmitted, broadcastsTransmitted=broadcastsTransmitted, portStatEntry=portStatEntry, staticIpGateway=staticIpGateway, rebootEnable=rebootEnable, lan1=lan1, fcsErrorTransmitted=fcsErrorTransmitted, portIndex=portIndex, voltage=voltage, port4=port4, lan2=lan2, staticIpSecondaryDns=staticIpSecondaryDns, xg6846=xg6846, operStatus=operStatus, fileName=fileName, staticIpDomainName=staticIpDomainName, temperature=temperature, modeEntry=modeEntry, wanType=wanType, port3=port3, deviceinfo=deviceinfo, unicastsReceived=unicastsReceived, hostname=hostname, adminStatus=adminStatus, lanportspeed=lanportspeed, lanportName=lanportName, wan=wan)
