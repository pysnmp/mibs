...
# Produced by pysmi-1.1.10 at Thu Oct 26 13:43:57 2023
...
ObjectIdentity, iso, Counter32, Unsigned32, ModuleIdentity, Integer32, Bits, mib_2, Counter64, MibIdentifier, TimeTicks, NotificationType, Gauge32, IpAddress, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "Counter32", "Unsigned32", "ModuleIdentity", "Integer32", "Bits", "mib-2", "Counter64", "MibIdentifier", "TimeTicks", "NotificationType", "Gauge32", "IpAddress", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", ddminfo=ddminfo, rebootEnable=rebootEnable, hostname=hostname, staticIpDomainName=staticIpDomainName, staticIpHostName=staticIpHostName, staticIpGateway=staticIpGateway, modeEntry=modeEntry, broadcastsTransmitted=broadcastsTransmitted, lan2=lan2, xg6846=xg6846, jumblan4=jumblan4, portName=portName, fileType=fileType, lanportpause=lanportpause, jumb=jumb, dscpEnable=dscpEnable, catvEnable=catvEnable, pauseReceived=pauseReceived, staticIpPrimaryDns=staticIpPrimaryDns, staticIpSubMask=staticIpSubMask, txPower=txPower, statIndex=statIndex, operStatus=operStatus, reboot=reboot, pauseTransmitted=pauseTransmitted, primaryDns=primaryDns, unicastsReceived=unicastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, lan3=lan3, port4=port4, jumbwan=jumbwan, fileName=fileName, vendorRev=vendorRev, serialnum=serialnum, portEntry=portEntry, catv=catv, lanportName=lanportName, lanportTable=lanportTable, portmode=portmode, groupid=groupid, bias=bias, portPower=portPower, deviceinfo=deviceinfo, action=action, qosEntry=qosEntry, vendorName=vendorName, voltage=voltage, vlanid=vlanid, tftpSevIp=tftpSevIp, jumblan3=jumblan3, vendorPn=vendorPn, port1=port1, priority=priority, portStatistic=portStatistic, statisticTable=statisticTable, port2=port2, vlangroupTable=vlangroupTable, vlan=vlan, tftp=tftp, qmode=qmode, rxPower=rxPower, speed=speed, lanportspeed=lanportspeed, groupEntry=groupEntry, multicastsTransmitted=multicastsTransmitted, secondaryDns=secondaryDns, port3=port3, jumblan2=jumblan2, qmapping=qmapping, lan4=lan4, multicastsReceived=multicastsReceived, qos=qos, domainame=domainame, temperature=temperature, staticDns=staticDns, qosIndex=qosIndex, portIndex=portIndex, portStatEntry=portStatEntry, staticIpAddr=staticIpAddr, adminStatus=adminStatus, portTable=portTable, fcsErrorTransmitted=fcsErrorTransmitted, jumblan1=jumblan1, groupIndex=groupIndex, wan=wan, vendorOui=vendorOui, lanportIndex=lanportIndex, broadcastsReceived=broadcastsReceived, lan1=lan1, fcsErrorReceived=fcsErrorReceived, qosTable=qosTable, wanType=wanType, internetPort=internetPort, unicastsTransmitted=unicastsTransmitted)
