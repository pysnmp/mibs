...
mib_2, Integer32, Counter32, enterprises, Counter64, TimeTicks, iso, ObjectIdentity, ModuleIdentity, NotificationType, MibIdentifier, Bits, Gauge32, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Integer32", "Counter32", "enterprises", "Counter64", "TimeTicks", "iso", "ObjectIdentity", "ModuleIdentity", "NotificationType", "MibIdentifier", "Bits", "Gauge32", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", broadcastsTransmitted=broadcastsTransmitted, multicastsReceived=multicastsReceived, lan3=lan3, priority=priority, staticIpGateway=staticIpGateway, qosIndex=qosIndex, staticIpSubMask=staticIpSubMask, staticIpPrimaryDns=staticIpPrimaryDns, fcsErrorTransmitted=fcsErrorTransmitted, qos=qos, rxPower=rxPower, port4=port4, catv=catv, staticIpAddr=staticIpAddr, serialnum=serialnum, portEntry=portEntry, domainame=domainame, lan1=lan1, internetPort=internetPort, lan4=lan4, vendorOui=vendorOui, hostname=hostname, operStatus=operStatus, qmode=qmode, qosEntry=qosEntry, portmode=portmode, fileType=fileType, bias=bias, staticIpSecondaryDns=staticIpSecondaryDns, vlan=vlan, wanType=wanType, portTable=portTable, lanportName=lanportName, vlanid=vlanid, dscpEnable=dscpEnable, adminStatus=adminStatus, port2=port2, lanportIndex=lanportIndex, rebootEnable=rebootEnable, lanportTable=lanportTable, groupid=groupid, jumblan3=jumblan3, lanportspeed=lanportspeed, qosTable=qosTable, catvEnable=catvEnable, fcsErrorReceived=fcsErrorReceived, staticIpHostName=staticIpHostName, secondaryDns=secondaryDns, pauseReceived=pauseReceived, port1=port1, action=action, jumbwan=jumbwan, pauseTransmitted=pauseTransmitted, statIndex=statIndex, jumb=jumb, groupEntry=groupEntry, vendorPn=vendorPn, jumblan1=jumblan1, lanportpause=lanportpause, voltage=voltage, broadcastsReceived=broadcastsReceived, tftpSevIp=tftpSevIp, fileName=fileName, tftp=tftp, staticIpDomainName=staticIpDomainName, lan2=lan2, vendorName=vendorName, xg6846=xg6846, unicastsReceived=unicastsReceived, statisticTable=statisticTable, portStatEntry=portStatEntry, speed=speed, txPower=txPower, ddminfo=ddminfo, temperature=temperature, deviceinfo=deviceinfo, jumblan4=jumblan4, qmapping=qmapping, reboot=reboot, portStatistic=portStatistic, vendorRev=vendorRev, staticDns=staticDns, modeEntry=modeEntry, groupIndex=groupIndex, port3=port3, vlangroupTable=vlangroupTable, unicastsTransmitted=unicastsTransmitted, primaryDns=primaryDns, multicastsTransmitted=multicastsTransmitted, portIndex=portIndex, portName=portName, portPower=portPower, jumblan2=jumblan2, wan=wan)
