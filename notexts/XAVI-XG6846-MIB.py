...
# Produced by pysmi-1.1.8 at Thu Sep 15 10:10:34 2022
...
TimeTicks, IpAddress, NotificationType, Integer32, enterprises, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, snmpModules, Counter64, Gauge32, ObjectIdentity, Unsigned32, mib_2, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "NotificationType", "Integer32", "enterprises", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "snmpModules", "Counter64", "Gauge32", "ObjectIdentity", "Unsigned32", "mib-2", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpAddr=staticIpAddr, dscpEnable=dscpEnable, qosEntry=qosEntry, lanportIndex=lanportIndex, broadcastsTransmitted=broadcastsTransmitted, pauseTransmitted=pauseTransmitted, catvEnable=catvEnable, statIndex=statIndex, broadcastsReceived=broadcastsReceived, secondaryDns=secondaryDns, vendorOui=vendorOui, qosTable=qosTable, xg6846=xg6846, jumblan2=jumblan2, bias=bias, groupid=groupid, speed=speed, rebootEnable=rebootEnable, statisticTable=statisticTable, wan=wan, jumblan1=jumblan1, pauseReceived=pauseReceived, port3=port3, tftp=tftp, jumbwan=jumbwan, groupEntry=groupEntry, portTable=portTable, hostname=hostname, portEntry=portEntry, portStatistic=portStatistic, vlangroupTable=vlangroupTable, serialnum=serialnum, staticIpPrimaryDns=staticIpPrimaryDns, rxPower=rxPower, qmapping=qmapping, action=action, multicastsTransmitted=multicastsTransmitted, reboot=reboot, lanportTable=lanportTable, portName=portName, vendorPn=vendorPn, staticIpSubMask=staticIpSubMask, staticIpHostName=staticIpHostName, portStatEntry=portStatEntry, port4=port4, fcsErrorReceived=fcsErrorReceived, jumblan3=jumblan3, port2=port2, internetPort=internetPort, ddminfo=ddminfo, fileType=fileType, jumb=jumb, qos=qos, lan1=lan1, jumblan4=jumblan4, lan3=lan3, lan4=lan4, vlanid=vlanid, groupIndex=groupIndex, primaryDns=primaryDns, portPower=portPower, catv=catv, fcsErrorTransmitted=fcsErrorTransmitted, vendorRev=vendorRev, domainame=domainame, lanportName=lanportName, unicastsReceived=unicastsReceived, voltage=voltage, staticIpGateway=staticIpGateway, txPower=txPower, deviceinfo=deviceinfo, portIndex=portIndex, priority=priority, operStatus=operStatus, temperature=temperature, modeEntry=modeEntry, multicastsReceived=multicastsReceived, tftpSevIp=tftpSevIp, lan2=lan2, wanType=wanType, vlan=vlan, qosIndex=qosIndex, lanportspeed=lanportspeed, portmode=portmode, staticIpDomainName=staticIpDomainName, lanportpause=lanportpause, vendorName=vendorName, qmode=qmode, port1=port1, fileName=fileName, unicastsTransmitted=unicastsTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, adminStatus=adminStatus, staticDns=staticDns)
