...
Counter32, IpAddress, iso, mib_2, snmpModules, ModuleIdentity, enterprises, Gauge32, Integer32, ObjectIdentity, MibIdentifier, NotificationType, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "iso", "mib-2", "snmpModules", "ModuleIdentity", "enterprises", "Gauge32", "Integer32", "ObjectIdentity", "MibIdentifier", "NotificationType", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan2=lan2, lan3=lan3, speed=speed, staticIpSubMask=staticIpSubMask, portEntry=portEntry, jumblan2=jumblan2, fcsErrorReceived=fcsErrorReceived, primaryDns=primaryDns, port3=port3, portName=portName, secondaryDns=secondaryDns, qmapping=qmapping, multicastsReceived=multicastsReceived, bias=bias, serialnum=serialnum, qosEntry=qosEntry, portStatistic=portStatistic, lan4=lan4, txPower=txPower, tftp=tftp, reboot=reboot, portmode=portmode, priority=priority, qosIndex=qosIndex, ddminfo=ddminfo, qosTable=qosTable, staticIpDomainName=staticIpDomainName, domainame=domainame, staticIpHostName=staticIpHostName, statisticTable=statisticTable, fcsErrorTransmitted=fcsErrorTransmitted, lanportIndex=lanportIndex, jumblan1=jumblan1, vendorName=vendorName, qos=qos, portIndex=portIndex, lanportspeed=lanportspeed, voltage=voltage, dscpEnable=dscpEnable, vlangroupTable=vlangroupTable, vlanid=vlanid, jumblan3=jumblan3, operStatus=operStatus, action=action, fileName=fileName, lan1=lan1, jumbwan=jumbwan, temperature=temperature, groupIndex=groupIndex, broadcastsTransmitted=broadcastsTransmitted, statIndex=statIndex, staticDns=staticDns, staticIpSecondaryDns=staticIpSecondaryDns, groupEntry=groupEntry, rxPower=rxPower, vendorPn=vendorPn, deviceinfo=deviceinfo, lanportpause=lanportpause, groupid=groupid, modeEntry=modeEntry, portTable=portTable, jumb=jumb, pauseReceived=pauseReceived, internetPort=internetPort, multicastsTransmitted=multicastsTransmitted, portPower=portPower, vendorRev=vendorRev, staticIpGateway=staticIpGateway, unicastsTransmitted=unicastsTransmitted, adminStatus=adminStatus, port2=port2, jumblan4=jumblan4, broadcastsReceived=broadcastsReceived, qmode=qmode, port4=port4, wanType=wanType, fileType=fileType, staticIpPrimaryDns=staticIpPrimaryDns, portStatEntry=portStatEntry, catv=catv, vlan=vlan, catvEnable=catvEnable, unicastsReceived=unicastsReceived, tftpSevIp=tftpSevIp, hostname=hostname, lanportTable=lanportTable, vendorOui=vendorOui, port1=port1, pauseTransmitted=pauseTransmitted, xg6846=xg6846, rebootEnable=rebootEnable, staticIpAddr=staticIpAddr, lanportName=lanportName, wan=wan)
